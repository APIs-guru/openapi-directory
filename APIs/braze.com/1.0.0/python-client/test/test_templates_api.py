...
class TestTemplatesApi(unittest.TestCase):
    ...
    def test_list_available_content_blocks(self) -> None:
    ...
    def test_list_available_email_templates(self) -> None:
    ...
    def test_see_content_block_information(self) -> None:
    ...
    def test_see_email_template_information(self) -> None:
