...
class TestScheduleApiTriggeredCanvasesRequest(unittest.TestCase):
    """ScheduleApiTriggeredCanvasesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleApiTriggeredCanvasesRequest:
        """Test ScheduleApiTriggeredCanvasesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleApiTriggeredCanvasesRequest`
        """
        model = ScheduleApiTriggeredCanvasesRequest()
        if include_optional:
            return ScheduleApiTriggeredCanvasesRequest(
                audience = openapi_client.models.schedule_api_triggered_canvases_request_audience.scheduleApiTriggeredCanvases_request_audience(
                    and = [
                        openapi_client.models.schedule_api_triggered_canvases_request_audience_and_inner.scheduleApiTriggeredCanvases_request_audience_AND_inner(
                            custom_attribute = openapi_client.models.schedule_api_triggered_canvases_request_audience_and_inner_custom_attribute.scheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute(
                                comparison = 'equals', 
                ...
                recipients = [
                    openapi_client.models.schedule_api_triggered_canvases_request_recipients_inner.scheduleApiTriggeredCanvases_request_recipients_inner(
                        canvas_entry_properties = openapi_client.models.canvas_entry_properties.canvas_entry_properties(), 
                        external_user_id = 'external_user_identifier', 
                        trigger_properties = '', 
                        user_alias = 'example_alias', )
                    ],
                schedule = openapi_client.models.schedule_api_triggered_canvases_request_schedule.scheduleApiTriggeredCanvases_request_schedule(
    ...
    def testScheduleApiTriggeredCanvasesRequest(self):
        """Test ScheduleApiTriggeredCanvasesRequest"""
