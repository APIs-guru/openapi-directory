...
from openapi_client.api.segment_api import SegmentApi
...
class TestSegmentApi(unittest.TestCase):
    ...
    def test_segment_analytics_0(self) -> None:
    ...
    def test_segment_details_0(self) -> None:
    ...
    def test_segment_list_0(self) -> None:
