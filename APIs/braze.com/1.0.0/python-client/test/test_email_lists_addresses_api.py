...
from openapi_client.api.email_lists_addresses_api import EmailListsAddressesApi


class TestEmailListsAddressesApi(unittest.TestCase):
    """EmailListsAddressesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EmailListsAddressesApi()

    def tearDown(self) -> None:
        pass

    def test_query_hard_bounced_emails(self) -> None:
    ...
    def test_query_list_of_unsubscribed_email_addresses(self) -> None:
