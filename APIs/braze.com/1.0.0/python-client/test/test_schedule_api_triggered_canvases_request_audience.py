...
class TestScheduleApiTriggeredCanvasesRequestAudience(unittest.TestCase):
    """ScheduleApiTriggeredCanvasesRequestAudience unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleApiTriggeredCanvasesRequestAudience:
        """Test ScheduleApiTriggeredCanvasesRequestAudience
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleApiTriggeredCanvasesRequestAudience`
        """
        model = ScheduleApiTriggeredCanvasesRequestAudience()
        if include_optional:
            return ScheduleApiTriggeredCanvasesRequestAudience(
                var_and = [
    ...
    def testScheduleApiTriggeredCanvasesRequestAudience(self):
        """Test ScheduleApiTriggeredCanvasesRequestAudience"""
