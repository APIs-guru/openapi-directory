...
class TestScheduleApiTriggeredCanvasesRequestSchedule(unittest.TestCase):
    """ScheduleApiTriggeredCanvasesRequestSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleApiTriggeredCanvasesRequestSchedule:
        """Test ScheduleApiTriggeredCanvasesRequestSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleApiTriggeredCanvasesRequestSchedule`
        """
        model = ScheduleApiTriggeredCanvasesRequestSchedule()
        if include_optional:
            return ScheduleApiTriggeredCanvasesRequestSchedule(
    ...
    def testScheduleApiTriggeredCanvasesRequestSchedule(self):
        """Test ScheduleApiTriggeredCanvasesRequestSchedule"""
