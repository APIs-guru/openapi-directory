...
from openapi_client.api.news_feed_api import NewsFeedApi
...
class TestNewsFeedApi(unittest.TestCase):
    ...
    def test_news_feed_card_analytics_0(self) -> None:
    ...
    def test_news_feed_cards_details_0(self) -> None:
    ...
    def test_news_feed_cards_list_0(self) -> None:
