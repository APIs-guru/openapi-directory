...
from openapi_client.api.session_analytics_api import SessionAnalyticsApi


class TestSessionAnalyticsApi(unittest.TestCase):
    """SessionAnalyticsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SessionAnalyticsApi()

    def tearDown(self) -> None:
        pass

    def test_app_sessions_by_time_0(self) -> None:
