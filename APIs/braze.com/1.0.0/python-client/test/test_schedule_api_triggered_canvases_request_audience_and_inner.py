...
from openapi_client.models.schedule_api_triggered_canvases_request_audience_and_inner import ScheduleApiTriggeredCanvasesRequestAudienceANDInner

class TestScheduleApiTriggeredCanvasesRequestAudienceANDInner(unittest.TestCase):
    """ScheduleApiTriggeredCanvasesRequestAudienceANDInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleApiTriggeredCanvasesRequestAudienceANDInner:
        """Test ScheduleApiTriggeredCanvasesRequestAudienceANDInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleApiTriggeredCanvasesRequestAudienceANDInner`
        """
        model = ScheduleApiTriggeredCanvasesRequestAudienceANDInner()
        if include_optional:
            return ScheduleApiTriggeredCanvasesRequestAudienceANDInner(
    ...
    def testScheduleApiTriggeredCanvasesRequestAudienceANDInner(self):
        """Test ScheduleApiTriggeredCanvasesRequestAudienceANDInner"""
