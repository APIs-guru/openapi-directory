...
from openapi_client.api.schedule_mesages_api import ScheduleMesagesApi


class TestScheduleMesagesApi(unittest.TestCase):
    """ScheduleMesagesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ScheduleMesagesApi()

    def tearDown(self) -> None:
        pass

    def test_get_upcoming_scheduled_campaigns_and_canvases_0(self) -> None:
        """Test case for get_upcoming_scheduled_campaigns_and_canvases_0

        Get Upcoming Scheduled Campaigns and Canvases
        """
        pass

    def test_schedule_api_triggered_canvases_0(self) -> None:
        """Test case for schedule_api_triggered_canvases_0
