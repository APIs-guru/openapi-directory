...
class TestKPIApi(unittest.TestCase):
    ...
    def test_daily_active_users_by_date_0(self) -> None:
    ...
    def test_daily_new_users_by_date_0(self) -> None:
    ...
    def test_kp_is_for_daily_app_uninstalls_by_date_0(self) -> None:
    ...
    def test_monthly_active_users_for_last30_days_0(self) -> None:
