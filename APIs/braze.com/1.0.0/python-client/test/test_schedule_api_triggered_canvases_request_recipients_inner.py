...
class TestScheduleApiTriggeredCanvasesRequestRecipientsInner(unittest.TestCase):
    """ScheduleApiTriggeredCanvasesRequestRecipientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleApiTriggeredCanvasesRequestRecipientsInner:
        """Test ScheduleApiTriggeredCanvasesRequestRecipientsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleApiTriggeredCanvasesRequestRecipientsInner`
        """
        model = ScheduleApiTriggeredCanvasesRequestRecipientsInner()
        if include_optional:
            return ScheduleApiTriggeredCanvasesRequestRecipientsInner(
    ...
    def testScheduleApiTriggeredCanvasesRequestRecipientsInner(self):
        """Test ScheduleApiTriggeredCanvasesRequestRecipientsInner"""
