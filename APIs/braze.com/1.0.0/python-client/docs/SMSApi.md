...
------------- | ------------- | -------------
[**list_users_subscription_group_sms_0**](SMSApi.md#list_users_subscription_group_sms_0) | **GET** /subscription/user/status | List User&#39;s Subscription Group - SMS
[**list_users_subscription_group_status_sms_0**](SMSApi.md#list_users_subscription_group_status_sms_0) | **GET** /subscription/status/get | List User&#39;s  Subscription Group Status - SMS


# **list_users_subscription_group_sms_0**
> list_users_subscription_group_sms_0(external_id=external_id, limit=limit, offset=offset, phone=phone)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List User's Subscription Group - SMS
        api_instance.list_users_subscription_group_sms_0(external_id=external_id, limit=limit, offset=offset, phone=phone)
    except Exception as e:
        print("Exception when calling SMSApi->list_users_subscription_group_sms_0: %s\n" % e)
```
...
# **list_users_subscription_group_status_sms_0**
> list_users_subscription_group_status_sms_0(subscription_group_id=subscription_group_id, external_id=external_id, phone=phone)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List User's  Subscription Group Status - SMS
        api_instance.list_users_subscription_group_status_sms_0(subscription_group_id=subscription_group_id, external_id=external_id, phone=phone)
    except Exception as e:
        print("Exception when calling SMSApi->list_users_subscription_group_status_sms_0: %s\n" % e)
```
