# openapi_client.ScheduleMesagesApi

All URIs are relative to *https://rest.iad-01.braze.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_upcoming_scheduled_campaigns_and_canvases_0**](ScheduleMesagesApi.md#get_upcoming_scheduled_campaigns_and_canvases_0) | **GET** /messages/scheduled_broadcasts | Get Upcoming Scheduled Campaigns and Canvases
[**schedule_api_triggered_canvases_0**](ScheduleMesagesApi.md#schedule_api_triggered_canvases_0) | **POST** /canvas/trigger/schedule/create | Schedule API Triggered Canvases


# **get_upcoming_scheduled_campaigns_and_canvases_0**
> get_upcoming_scheduled_campaigns_and_canvases_0(end_time=end_time)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ScheduleMesagesApi(api_client)
    ...
    try:
        # Get Upcoming Scheduled Campaigns and Canvases
        api_instance.get_upcoming_scheduled_campaigns_and_canvases_0(end_time=end_time)
    except Exception as e:
        print("Exception when calling ScheduleMesagesApi->get_upcoming_scheduled_campaigns_and_canvases_0: %s\n" % e)
```
...
# **schedule_api_triggered_canvases_0**
> schedule_api_triggered_canvases_0(schedule_api_triggered_canvases_request=schedule_api_triggered_canvases_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Schedule API Triggered Canvases
        api_instance.schedule_api_triggered_canvases_0(schedule_api_triggered_canvases_request=schedule_api_triggered_canvases_request)
    except Exception as e:
        print("Exception when calling ScheduleMesagesApi->schedule_api_triggered_canvases_0: %s\n" % e)
```
