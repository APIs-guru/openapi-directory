# openapi_client.ContentBlocksApi

All URIs are relative to *https://rest.iad-01.braze.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_available_content_blocks_0**](ContentBlocksApi.md#list_available_content_blocks_0) | **GET** /content_blocks/list | List Available Content Blocks
[**see_content_block_information_0**](ContentBlocksApi.md#see_content_block_information_0) | **GET** /content_blocks/info | See Content Block Information


# **list_available_content_blocks_0**
> list_available_content_blocks_0(modified_after=modified_after, modified_before=modified_before, limit=limit, offset=offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ContentBlocksApi(api_client)
    ...
    try:
        # List Available Content Blocks
        api_instance.list_available_content_blocks_0(modified_after=modified_after, modified_before=modified_before, limit=limit, offset=offset)
    except Exception as e:
        print("Exception when calling ContentBlocksApi->list_available_content_blocks_0: %s\n" % e)
```
...
# **see_content_block_information_0**
> see_content_block_information_0(content_block_id=content_block_id, include_inclusion_data=include_inclusion_data)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # See Content Block Information
        api_instance.see_content_block_information_0(content_block_id=content_block_id, include_inclusion_data=include_inclusion_data)
    except Exception as e:
        print("Exception when calling ContentBlocksApi->see_content_block_information_0: %s\n" % e)
```
