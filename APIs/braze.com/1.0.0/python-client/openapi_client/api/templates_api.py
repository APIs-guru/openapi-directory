...
class TemplatesApi:
    ...
    @validate_call
    def list_available_content_blocks(
        self,
        ...
        _param = self._list_available_content_blocks_serialize(
    ...
    @validate_call
    def list_available_content_blocks_with_http_info(
        self,
        modified_after: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only content blocks updated at or after the given time.")] = None,
        modified_before: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only content blocks updated at or before the given time.")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="(Optional) Positive Number  Maximum number of content blocks to retrieve, default to 100 if not provided, maximum acceptable value is 1000.")] = None,
    ...
    @validate_call
    def list_available_content_blocks_without_preload_content(
        self,
        modified_after: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only content blocks updated at or after the given time.")] = None,
        modified_before: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only content blocks updated at or before the given time.")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="(Optional) Positive Number  Maximum number of content blocks to retrieve, default to 100 if not provided, maximum acceptable value is 1000.")] = None,
    ...
    def _list_available_content_blocks_serialize(
        self,
        modified_after,
        modified_before,
        limit,
    ...
    @validate_call
    def list_available_email_templates(
        self,
        ...
        _param = self._list_available_email_templates_serialize(
            modified_after=modified_after,
            modified_before=modified_before,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def list_available_email_templates_with_http_info(
        self,
        modified_after: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only templates updated at or after the given time.")] = None,
        modified_before: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only templates updated at or before the given time")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="(Optional) Positive Number  Maximum number of templates to retrieve, default to 100 if not provided, maximum acceptable value is 1000.")] = None,
    ...
    @validate_call
    def list_available_email_templates_without_preload_content(
        self,
        modified_after: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only templates updated at or after the given time.")] = None,
        modified_before: Annotated[Optional[StrictStr], Field(description="(Optional) String in ISO 8601  Retrieve only templates updated at or before the given time")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="(Optional) Positive Number  Maximum number of templates to retrieve, default to 100 if not provided, maximum acceptable value is 1000.")] = None,
    ...
    def _list_available_email_templates_serialize(
        self,
        modified_after,
        modified_before,
        limit,
    ...
    @validate_call
    def see_content_block_information(
        self,
        ...
        _param = self._see_content_block_information_serialize(
    ...
    @validate_call
    def see_content_block_information_with_http_info(
        self,
        content_block_id: Annotated[Optional[StrictStr], Field(description="(Required) String  The Content Block ID. This can be found by either listing Content Block information or going to the Developer Console, then API Settings, then scrolling to the bottom and searching for your Content Block API Identifier.")] = None,
        include_inclusion_data: Annotated[Optional[StrictStr], Field(description="(Optional) Boolean  When set to ‘true’, the API returns back the Message Variation API ID of Campaigns and Canvases where this content block is included, to be used in subsequent calls. The results exclude archived or deleted Campaigns or Canvases.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def see_content_block_information_without_preload_content(
        self,
        content_block_id: Annotated[Optional[StrictStr], Field(description="(Required) String  The Content Block ID. This can be found by either listing Content Block information or going to the Developer Console, then API Settings, then scrolling to the bottom and searching for your Content Block API Identifier.")] = None,
        include_inclusion_data: Annotated[Optional[StrictStr], Field(description="(Optional) Boolean  When set to ‘true’, the API returns back the Message Variation API ID of Campaigns and Canvases where this content block is included, to be used in subsequent calls. The results exclude archived or deleted Campaigns or Canvases.")] = None,
        _request_timeout: Union[
    ...
    def _see_content_block_information_serialize(
        self,
        content_block_id,
        include_inclusion_data,
        _request_auth,
    ...
    @validate_call
    def see_email_template_information(
        self,
        ...
        _param = self._see_email_template_information_serialize(
    ...
    @validate_call
    def see_email_template_information_with_http_info(
        self,
        email_template_id: Annotated[Optional[StrictStr], Field(description="(Required) String  Your email template's API Identifier.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def see_email_template_information_without_preload_content(
        self,
        email_template_id: Annotated[Optional[StrictStr], Field(description="(Required) String  Your email template's API Identifier.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _see_email_template_information_serialize(
        self,
        email_template_id,
        _request_auth,
        _content_type,
