...
class ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute(BaseModel):
    """
    ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute
    """ # noqa: E501
    comparison: Optional[StrictStr] = None
    custom_attribute_name: Optional[StrictStr] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["comparison", "custom_attribute_name", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "custom_attribute_name": obj.get("custom_attribute_name"),
            "value": obj.get("value")
        })
        return _obj
