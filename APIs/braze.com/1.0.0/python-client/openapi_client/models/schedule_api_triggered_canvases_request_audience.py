...
class ScheduleApiTriggeredCanvasesRequestAudience(BaseModel):
    """
    ScheduleApiTriggeredCanvasesRequestAudience
    """ # noqa: E501
    var_and: Optional[List[ScheduleApiTriggeredCanvasesRequestAudienceANDInner]] = Field(default=None, alias="AND")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleApiTriggeredCanvasesRequestAudience from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleApiTriggeredCanvasesRequestAudience from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AND": [ScheduleApiTriggeredCanvasesRequestAudienceANDInner.from_dict(_item) for _item in obj["AND"]] if obj.get("AND") is not None else None
        })
        return _obj
