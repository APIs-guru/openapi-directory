...
class ScheduleApiTriggeredCanvasesRequestSchedule(BaseModel):
    """
    ScheduleApiTriggeredCanvasesRequestSchedule
    """ # noqa: E501
    at_optimal_time: Optional[StrictBool] = None
    in_local_time: Optional[StrictBool] = None
    time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["at_optimal_time", "in_local_time", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "at_optimal_time": obj.get("at_optimal_time"),
            "in_local_time": obj.get("in_local_time"),
            "time": obj.get("time")
        })
        return _obj
