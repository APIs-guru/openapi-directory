...
class ScheduleApiTriggeredCanvasesRequestAudienceANDInner(BaseModel):
    """
    ScheduleApiTriggeredCanvasesRequestAudienceANDInner
    """ # noqa: E501
    custom_attribute: Optional[ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute] = None
    __properties: ClassVar[List[str]] = ["custom_attribute"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleApiTriggeredCanvasesRequestAudienceANDInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of custom_attribute
        if self.custom_attribute:
            _dict['custom_attribute'] = self.custom_attribute.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleApiTriggeredCanvasesRequestAudienceANDInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "custom_attribute": ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.from_dict(obj["custom_attribute"]) if obj.get("custom_attribute") is not None else None
        })
        return _obj
