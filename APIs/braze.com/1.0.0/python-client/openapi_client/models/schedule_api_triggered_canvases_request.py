...
from openapi_client.models.schedule_api_triggered_canvases_request_audience import ScheduleApiTriggeredCanvasesRequestAudience
from openapi_client.models.schedule_api_triggered_canvases_request_recipients_inner import ScheduleApiTriggeredCanvasesRequestRecipientsInner
...
class ScheduleApiTriggeredCanvasesRequest(BaseModel):
    """
    ScheduleApiTriggeredCanvasesRequest
    """ # noqa: E501
    audience: Optional[ScheduleApiTriggeredCanvasesRequestAudience] = None
    broadcast: Optional[StrictBool] = None
    canvas_entry_properties: Optional[Dict[str, Any]] = None
    canvas_id: Optional[StrictStr] = None
    recipients: Optional[List[ScheduleApiTriggeredCanvasesRequestRecipientsInner]] = None
    schedule: Optional[ScheduleApiTriggeredCanvasesRequestSchedule] = None
    __properties: ClassVar[List[str]] = ["audience", "broadcast", "canvas_entry_properties", "canvas_id", "recipients", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audience": ScheduleApiTriggeredCanvasesRequestAudience.from_dict(obj["audience"]) if obj.get("audience") is not None else None,
            "broadcast": obj.get("broadcast"),
            "canvas_entry_properties": obj.get("canvas_entry_properties"),
            "canvas_id": obj.get("canvas_id"),
            "recipients": [ScheduleApiTriggeredCanvasesRequestRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None,
            "schedule": ScheduleApiTriggeredCanvasesRequestSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
