...
class GetPhotoSizesByID200Response(BaseModel):
    """
    GetPhotoSizesByID200Response
    """ # noqa: E501
    sizes: Optional[GetPhotoSizesByID200ResponseSizes] = None
    stat: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["sizes", "stat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sizes": GetPhotoSizesByID200ResponseSizes.from_dict(obj["sizes"]) if obj.get("sizes") is not None else None,
            "stat": obj.get("stat")
        })
        return _obj
