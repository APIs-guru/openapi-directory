...
class GetPhotoSizesByID200ResponseSizes(BaseModel):
    """
    GetPhotoSizesByID200ResponseSizes
    """ # noqa: E501
    canblog: Optional[Union[StrictFloat, StrictInt]] = None
    candownload: Optional[Union[StrictFloat, StrictInt]] = None
    canprint: Optional[Union[StrictFloat, StrictInt]] = None
    sizes: Optional[List[Size]] = None
    __properties: ClassVar[List[str]] = ["canblog", "candownload", "canprint", "sizes"]
