        ...
        if include_optional:
            return Group(
                ...
                members = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', ),
                name = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', ),
                path_alias = '',
                pool_count = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', ),
                pool_rows = 56,
                privacy = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', ),
                ...
                roles = openapi_client.models.group_roles.Group_roles(
                    ...
                    member = '', 
                    moderator = '', ),
                rules = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', ),
                throttle = openapi_client.models.group_throttle.Group_throttle(
                    count = 56, 
                    mode = '', 
                    remaining = '', ),
                topic_count = openapi_client.models.get_favorites_context_by_id_200_response_count.getFavoritesContextByID_200_response_count(
                    _content = '', )
            )
        else:
            return Group(
