...
class WebhooksListResponseInner(BaseModel):
    """
    WebhooksListResponseInner
    """ # noqa: E501
    auth_key: Optional[StrictStr] = None
    batches_sent: Optional[StrictInt] = None
    created_at: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    events: Optional[List[StrictStr]] = None
    events_sent: Optional[StrictInt] = None
    id: Optional[StrictInt] = None
    last_error: Optional[StrictStr] = None
    last_sent_at: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["auth_key", "batches_sent", "created_at", "description", "events", "events_sent", "id", "last_error", "last_sent_at", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "batches_sent": obj.get("batches_sent"),
            "created_at": obj.get("created_at"),
            "description": obj.get("description"),
            "events": obj.get("events"),
            "events_sent": obj.get("events_sent"),
            "id": obj.get("id"),
