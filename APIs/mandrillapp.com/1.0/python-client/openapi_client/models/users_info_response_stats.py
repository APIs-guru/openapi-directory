...
class UsersInfoResponseStats(BaseModel):
    """
    UsersInfoResponseStats
    """ # noqa: E501
    all_time: Optional[SendersInfoResponseStatsLast30Days] = None
    ...
    __properties: ClassVar[List[str]] = ["all_time", "last_30_days", "last_60_days", "last_7_days", "last_90_days", "today"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of all_time
        if self.all_time:
            _dict['all_time'] = self.all_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all_time": SendersInfoResponseStatsLast30Days.from_dict(obj["all_time"]) if obj.get("all_time") is not None else None,
