...
class MessagesSearchResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "clicks", "clicks_detail", "email", "metadata", "opens", "opens_detail", "sender", "state", "subject", "tags", "template", "ts"]
