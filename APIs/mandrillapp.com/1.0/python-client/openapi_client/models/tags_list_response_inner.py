...
class TagsListResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clicks", "complaints", "hard_bounces", "opens", "rejects", "reputation", "sent", "soft_bounces", "tag", "unique_clicks", "unique_opens", "unsubs"]
