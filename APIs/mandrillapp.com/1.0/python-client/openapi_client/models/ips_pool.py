...
class IpsPool(BaseModel):
    """
    IpsPool
    """ # noqa: E501
    created_at: Optional[StrictStr] = None
    ips: Optional[List[IpsListPoolsResponseInnerIpsInner]] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "ips", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ips": [IpsListPoolsResponseInnerIpsInner.from_dict(_item) for _item in obj["ips"]] if obj.get("ips") is not None else None,
            "name": obj.get("name")
        })
        return _obj
