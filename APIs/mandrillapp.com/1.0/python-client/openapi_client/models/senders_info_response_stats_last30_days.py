...
class SendersInfoResponseStatsLast30Days(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clicks", "complaints", "hard_bounces", "opens", "rejects", "sent", "soft_bounces", "unique_clicks", "unique_opens", "unsubs"]
