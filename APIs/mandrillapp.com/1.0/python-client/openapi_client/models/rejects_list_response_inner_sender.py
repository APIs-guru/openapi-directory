...
class RejectsListResponseInnerSender(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "clicks", "complaints", "created_at", "hard_bounces", "opens", "rejects", "sent", "soft_bounces", "unique_clicks", "unique_opens", "unsubs"]
