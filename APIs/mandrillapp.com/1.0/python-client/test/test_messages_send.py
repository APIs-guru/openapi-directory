...
class TestMessagesSend(unittest.TestCase):
    """MessagesSend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessagesSend:
        """Test MessagesSend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessagesSend`
        """
        model = MessagesSend()
        if include_optional:
            return MessagesSend(
