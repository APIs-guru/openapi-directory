...
class TestSendersInfoResponseStats(unittest.TestCase):
    """SendersInfoResponseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendersInfoResponseStats:
        """Test SendersInfoResponseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendersInfoResponseStats`
        """
        model = SendersInfoResponseStats()
        if include_optional:
            return SendersInfoResponseStats(
    ...
    def testSendersInfoResponseStats(self):
        """Test SendersInfoResponseStats"""
