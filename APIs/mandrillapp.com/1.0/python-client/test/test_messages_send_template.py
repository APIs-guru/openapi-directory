...
class TestMessagesSendTemplate(unittest.TestCase):
    """MessagesSendTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessagesSendTemplate:
        """Test MessagesSendTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessagesSendTemplate`
        """
        model = MessagesSendTemplate()
        if include_optional:
            return MessagesSendTemplate(
                var_async = True,
                ip_pool = '',
                key = '',
                message = openapi_client.models.messages_send_message.messages_send_message(
                    attachments = [
    ...
    def testMessagesSendTemplate(self):
        """Test MessagesSendTemplate"""
