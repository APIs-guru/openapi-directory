...
class ResponseTimestamp(BaseModel):
    ...
    ResponseTimestamp
    """ # noqa: E501
    created_http: Optional[StrictStr] = None
    created_unix: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_http", "created_unix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "created_http": obj.get("created_http"),
