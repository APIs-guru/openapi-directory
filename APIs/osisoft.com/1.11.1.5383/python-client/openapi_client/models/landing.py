...
class Landing(BaseModel):
    ...
    Landing
    """ # noqa: E501
    links: Optional[LandingLinks] = Field(default=None, alias="Links")
    web_exception: Optional[WebException] = Field(default=None, alias="WebException")
    __properties: ClassVar[List[str]] = ["Links", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Links": LandingLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
