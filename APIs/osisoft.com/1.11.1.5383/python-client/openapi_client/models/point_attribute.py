...
class PointAttribute(BaseModel):
    """
    PointAttribute
    """ # noqa: E501
    links: Optional[PointAttributeLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Links", "Name", "Value", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Links": PointAttributeLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Value": obj.get("Value"),
