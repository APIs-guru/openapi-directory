...
class SecurityIdentity(BaseModel):
    ...
    links: Optional[SecurityIdentityLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Description", "Id", "IsEnabled", "Links", "Name", "Path", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Links": SecurityIdentityLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
