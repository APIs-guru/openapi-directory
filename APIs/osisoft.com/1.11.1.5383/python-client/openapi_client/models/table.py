...
class Table(BaseModel):
    ...
    convert_to_local_time: Optional[StrictBool] = Field(default=None, alias="ConvertToLocalTime")
    description: Optional[StrictStr] = Field(default=None, alias="Description")
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    links: Optional[TableLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["CategoryNames", "ConvertToLocalTime", "Description", "Id", "Links", "Name", "Path", "TimeZone", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ConvertToLocalTime": obj.get("ConvertToLocalTime"),
            "Description": obj.get("Description"),
            "Id": obj.get("Id"),
            "Links": TableLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
