...
class PointLinks(BaseModel):
    """
    PointLinks
    """ # noqa: E501
    attributes: Optional[StrictStr] = Field(default=None, alias="Attributes")
    data_server: Optional[StrictStr] = Field(default=None, alias="DataServer")
    ...
    __properties: ClassVar[List[str]] = ["Attributes", "DataServer", "EndValue", "InterpolatedData", "PlotData", "RecordedData", "Self", "SummaryData", "Value"]
