...
class ExtendedTimedValues(BaseModel):
    """
    ExtendedTimedValues
    """ # noqa: E501
    items: Optional[List[ExtendedTimedValue]] = Field(default=None, alias="Items")
    ...
    __properties: ClassVar[List[str]] = ["Items", "UnitsAbbreviation", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [ExtendedTimedValue.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
