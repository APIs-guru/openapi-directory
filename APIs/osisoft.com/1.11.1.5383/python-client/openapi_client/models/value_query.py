...
class ValueQuery(BaseModel):
    ...
    attribute_uom: Optional[StrictStr] = Field(default=None, alias="AttributeUOM")
    attribute_value: Optional[Dict[str, Any]] = Field(default=None, alias="AttributeValue")
    ...
    __properties: ClassVar[List[str]] = ["AttributeName", "AttributeUOM", "AttributeValue", "SearchOperator", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AttributeUOM": obj.get("AttributeUOM"),
