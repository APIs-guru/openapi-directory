...
class StreamSummaries(BaseModel):
    """
    StreamSummaries
    """ # noqa: E501
    items: Optional[List[SummaryValue]] = Field(default=None, alias="Items")
    links: Optional[StreamSummariesLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Items", "Links", "Name", "Path", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Links": StreamSummariesLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
