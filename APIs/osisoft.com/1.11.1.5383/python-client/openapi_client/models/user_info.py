...
class UserInfo(BaseModel):
    ...
    impersonation_level: Optional[StrictStr] = Field(default=None, alias="ImpersonationLevel")
    is_authenticated: Optional[StrictBool] = Field(default=None, alias="IsAuthenticated")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    sid: Optional[StrictStr] = Field(default=None, alias="SID")
    web_exception: Optional[WebException] = Field(default=None, alias="WebException")
    __properties: ClassVar[List[str]] = ["IdentityType", "ImpersonationLevel", "IsAuthenticated", "Name", "SID", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ImpersonationLevel": obj.get("ImpersonationLevel"),
