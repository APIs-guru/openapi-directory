...
class Element(BaseModel):
    ...
    links: Optional[ElementLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["CategoryNames", "Description", "Errors", "ExtendedProperties", "HasChildren", "Id", "Links", "Name", "Path", "Paths", "TemplateName", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Links": ElementLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
            "Paths": obj.get("Paths"),
