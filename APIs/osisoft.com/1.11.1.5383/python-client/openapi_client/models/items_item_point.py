...
class ItemsItemPoint(BaseModel):
    """
    ItemsItemPoint
    """ # noqa: E501
    items: Optional[List[ItemPoint]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [ItemPoint.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
