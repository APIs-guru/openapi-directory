...
class AttributeLinks(BaseModel):
    """
    AttributeLinks
    """ # noqa: E501
    ...
    element: Optional[StrictStr] = Field(default=None, alias="Element")
    end_value: Optional[StrictStr] = Field(default=None, alias="EndValue")
    enumeration_set: Optional[StrictStr] = Field(default=None, alias="EnumerationSet")
    enumeration_values: Optional[StrictStr] = Field(default=None, alias="EnumerationValues")
    event_frame: Optional[StrictStr] = Field(default=None, alias="EventFrame")
    ...
    point: Optional[StrictStr] = Field(default=None, alias="Point")
    ...
    trait: Optional[StrictStr] = Field(default=None, alias="Trait")
    value: Optional[StrictStr] = Field(default=None, alias="Value")
    __properties: ClassVar[List[str]] = ["Attributes", "Categories", "Element", "EndValue", "EnumerationSet", "EnumerationValues", "EventFrame", "InterpolatedData", "Parent", "PlotData", "Point", "RecordedData", "Self", "SummaryData", "Template", "Trait", "Value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "EnumerationSet": obj.get("EnumerationSet"),
            "EnumerationValues": obj.get("EnumerationValues"),
            "EventFrame": obj.get("EventFrame"),
