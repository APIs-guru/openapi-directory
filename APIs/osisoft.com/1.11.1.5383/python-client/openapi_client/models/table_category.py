...
class TableCategory(BaseModel):
    ...
    links: Optional[TableCategoryLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Description", "Id", "Links", "Name", "Path", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Links": TableCategoryLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
