...
class TableData(BaseModel):
    ...
    TableData
    """ # noqa: E501
    columns: Optional[Dict[str, StrictStr]] = Field(default=None, alias="Columns")
    rows: Optional[List[Dict[str, Dict[str, Any]]]] = Field(default=None, alias="Rows")
    web_exception: Optional[WebException] = Field(default=None, alias="WebException")
    __properties: ClassVar[List[str]] = ["Columns", "Rows", "WebException"]
