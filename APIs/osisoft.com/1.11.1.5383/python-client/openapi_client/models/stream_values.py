...
class StreamValues(BaseModel):
    ...
    StreamValues
    """ # noqa: E501
    items: Optional[List[TimedValue]] = Field(default=None, alias="Items")
    links: Optional[StreamValuesLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Items", "Links", "Name", "Path", "UnitsAbbreviation", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [TimedValue.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Links": StreamValuesLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
