...
class SecurityMapping(BaseModel):
    ...
    SecurityMapping
    """ # noqa: E501
    account: Optional[StrictStr] = Field(default=None, alias="Account")
    description: Optional[StrictStr] = Field(default=None, alias="Description")
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    links: Optional[SecurityMappingLinks] = Field(default=None, alias="Links")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    path: Optional[StrictStr] = Field(default=None, alias="Path")
    security_identity_web_id: Optional[StrictStr] = Field(default=None, alias="SecurityIdentityWebId")
    ...
    __properties: ClassVar[List[str]] = ["Account", "Description", "Id", "Links", "Name", "Path", "SecurityIdentityWebId", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Links": SecurityMappingLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
            "SecurityIdentityWebId": obj.get("SecurityIdentityWebId"),
