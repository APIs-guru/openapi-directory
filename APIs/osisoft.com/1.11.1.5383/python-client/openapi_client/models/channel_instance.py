...
class ChannelInstance(BaseModel):
    ...
    last_message_sent_time: Optional[StrictStr] = Field(default=None, alias="LastMessageSentTime")
    sent_message_count: Optional[StrictInt] = Field(default=None, alias="SentMessageCount")
    ...
    __properties: ClassVar[List[str]] = ["Id", "LastMessageSentTime", "SentMessageCount", "StartTime", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "LastMessageSentTime": obj.get("LastMessageSentTime"),
            "SentMessageCount": obj.get("SentMessageCount"),
