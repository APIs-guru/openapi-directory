...
class AnalysisCategory(BaseModel):
    ...
    links: Optional[AnalysisCategoryLinks] = Field(default=None, alias="Links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Links": AnalysisCategoryLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
