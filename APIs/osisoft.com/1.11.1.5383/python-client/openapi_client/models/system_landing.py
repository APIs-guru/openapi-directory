...
class SystemLanding(BaseModel):
    """
    SystemLanding
    """ # noqa: E501
    links: Optional[SystemLandingLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["Links", "ProductTitle", "ProductVersion", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Links": SystemLandingLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
