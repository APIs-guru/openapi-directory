...
class Version(BaseModel):
    ...
    Version
    """ # noqa: E501
    build: Optional[StrictStr] = Field(default=None, alias="Build")
    full_version: Optional[StrictStr] = Field(default=None, alias="FullVersion")
    major_minor_revision: Optional[StrictStr] = Field(default=None, alias="MajorMinorRevision")
    web_exception: Optional[WebException] = Field(default=None, alias="WebException")
    __properties: ClassVar[List[str]] = ["Build", "FullVersion", "MajorMinorRevision", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MajorMinorRevision": obj.get("MajorMinorRevision"),
