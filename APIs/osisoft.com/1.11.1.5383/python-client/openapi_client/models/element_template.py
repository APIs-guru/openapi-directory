...
class ElementTemplate(BaseModel):
    ...
    ElementTemplate
    """ # noqa: E501
    allow_element_to_extend: Optional[StrictBool] = Field(default=None, alias="AllowElementToExtend")
    ...
    links: Optional[ElementTemplateLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["AllowElementToExtend", "BaseTemplate", "CanBeAcknowledged", "CategoryNames", "Description", "ExtendedProperties", "Id", "InstanceType", "Links", "Name", "NamingPattern", "Path", "Severity", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AllowElementToExtend": obj.get("AllowElementToExtend"),
            ...
            "Links": ElementTemplateLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
