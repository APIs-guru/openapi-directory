...
class DataServerLicense(BaseModel):
    """
    DataServerLicense
    """ # noqa: E501
    amount_left: Optional[StrictStr] = Field(default=None, alias="AmountLeft")
    amount_used: Optional[StrictStr] = Field(default=None, alias="AmountUsed")
    links: Optional[DataServerLicenseLinks] = Field(default=None, alias="Links")
    ...
    __properties: ClassVar[List[str]] = ["AmountLeft", "AmountUsed", "Links", "Name", "TotalAmount", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AmountLeft": obj.get("AmountLeft"),
            "AmountUsed": obj.get("AmountUsed"),
            "Links": DataServerLicenseLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
