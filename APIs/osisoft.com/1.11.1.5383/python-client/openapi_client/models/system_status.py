...
class SystemStatus(BaseModel):
    ...
    SystemStatus
    """ # noqa: E501
    cache_instances: Optional[StrictInt] = Field(default=None, alias="CacheInstances")
    server_time: Optional[datetime] = Field(default=None, alias="ServerTime")
    state: Optional[StrictStr] = Field(default=None, alias="State")
    up_time_in_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="UpTimeInMinutes")
    web_exception: Optional[WebException] = Field(default=None, alias="WebException")
    __properties: ClassVar[List[str]] = ["CacheInstances", "ServerTime", "State", "UpTimeInMinutes", "WebException"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CacheInstances": obj.get("CacheInstances"),
            "ServerTime": obj.get("ServerTime"),
            "State": obj.get("State"),
            "UpTimeInMinutes": obj.get("UpTimeInMinutes"),
