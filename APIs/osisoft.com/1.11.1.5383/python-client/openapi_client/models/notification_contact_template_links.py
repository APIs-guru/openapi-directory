...
class NotificationContactTemplateLinks(BaseModel):
    """
    ...
    notification_plug_in: Optional[StrictStr] = Field(default=None, alias="NotificationPlugIn")
    ...
    __properties: ClassVar[List[str]] = ["AssetServer", "NotificationContactTemplates", "NotificationPlugIn", "Security", "SecurityEntries", "Self"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "NotificationPlugIn": obj.get("NotificationPlugIn"),
