...
class NotificationRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["AutoCreated", "CategoryNames", "Criteria", "Description", "Id", "MultiTriggerEventOption", "Name", "NonrepetitionInterval", "Path", "ResendInterval", "Status", "TemplateName", "WebException", "WebId"]
