...
class StreamValue(BaseModel):
    ...
    StreamValue
    """ # noqa: E501
    links: Optional[StreamValueLinks] = Field(default=None, alias="Links")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    path: Optional[StrictStr] = Field(default=None, alias="Path")
    value: Optional[TimedValue] = Field(default=None, alias="Value")
    ...
    __properties: ClassVar[List[str]] = ["Links", "Name", "Path", "Value", "WebException", "WebId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Links": StreamValueLinks.from_dict(obj["Links"]) if obj.get("Links") is not None else None,
            "Name": obj.get("Name"),
            "Path": obj.get("Path"),
            "Value": TimedValue.from_dict(obj["Value"]) if obj.get("Value") is not None else None,
