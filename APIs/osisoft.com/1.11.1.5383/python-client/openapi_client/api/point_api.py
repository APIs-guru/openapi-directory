...
class PointApi:
    ...
    def point_delete(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        ...
        :param web_id: The ID of the point. (required)
        :type web_id: str
        ...
        _param = self._point_delete_serialize(
            web_id=web_id,
    ...
    @validate_call
    def point_delete_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def point_delete_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        _request_timeout: Union[
            None,
    ...
    def point_get(
        ...
        _param = self._point_get_serialize(
            web_id=web_id,
    ...
    @validate_call
    def point_get_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def point_get_attribute_by_name(
        self,
        name: Annotated[StrictStr, Field(description="The name of the attribute.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
        ...
        _param = self._point_get_attribute_by_name_serialize(
            name=name,
            web_id=web_id,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
    ...
    @validate_call
    def point_get_attribute_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the attribute.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    @validate_call
    def point_get_attribute_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the attribute.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    def _point_get_attribute_by_name_serialize(
        self,
        name,
        web_id,
        selected_fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/points/{webId}/attributes/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def point_get_attributes(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        name: Annotated[Optional[List[StrictStr]], Field(description="The name of a point attribute to be returned. Multiple attributes may be specified with multiple instances of the parameter.")] = None,
        name_filter: Annotated[Optional[StrictStr], Field(description="The filter to the names of the list of point attributes to be returned. The default is no filter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._point_get_attributes_serialize(
            web_id=web_id,
            name=name,
    ...
    @validate_call
    def point_get_attributes_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        name: Annotated[Optional[List[StrictStr]], Field(description="The name of a point attribute to be returned. Multiple attributes may be specified with multiple instances of the parameter.")] = None,
        name_filter: Annotated[Optional[StrictStr], Field(description="The filter to the names of the list of point attributes to be returned. The default is no filter.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ItemsPointAttribute]:
        """Get point attributes.
    ...
    @validate_call
    def point_get_attributes_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        name: Annotated[Optional[List[StrictStr]], Field(description="The name of a point attribute to be returned. Multiple attributes may be specified with multiple instances of the parameter.")] = None,
        name_filter: Annotated[Optional[StrictStr], Field(description="The filter to the names of the list of point attributes to be returned. The default is no filter.")] = None,
    ...
    def _point_get_attributes_serialize(
        self,
        web_id,
        name,
        name_filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/points/{webId}/attributes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def point_get_by_path(
        self,
        path: Annotated[StrictStr, Field(description="The path to the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._point_get_by_path_serialize(
            path=path,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def point_get_by_path_with_http_info(
        self,
        path: Annotated[StrictStr, Field(description="The path to the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def point_get_by_path_without_preload_content(
        self,
        path: Annotated[StrictStr, Field(description="The path to the point.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _point_get_by_path_serialize(
        self,
        path,
        selected_fields,
        web_id_type,
    ...
    @validate_call
    def point_get_multiple(
        self,
        as_parallel: Annotated[Optional[StrictBool], Field(description="Specifies if the retrieval processes should be run in parallel on the server. This may improve the response time for large amounts of requested points. The default is 'false'.")] = None,
        include_mode: Annotated[Optional[StrictStr], Field(description="The include mode for the return list. The default is 'All'.")] = None,
        path: Annotated[Optional[List[StrictStr]], Field(description="The path of a point. Multiple points may be specified with multiple instances of the parameter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id: Annotated[Optional[List[StrictStr]], Field(description="The ID of a point. Multiple points may be specified with multiple instances of the parameter.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._point_get_multiple_serialize(
    ...
    @validate_call
    def point_get_multiple_with_http_info(
        self,
        as_parallel: Annotated[Optional[StrictBool], Field(description="Specifies if the retrieval processes should be run in parallel on the server. This may improve the response time for large amounts of requested points. The default is 'false'.")] = None,
        include_mode: Annotated[Optional[StrictStr], Field(description="The include mode for the return list. The default is 'All'.")] = None,
        path: Annotated[Optional[List[StrictStr]], Field(description="The path of a point. Multiple points may be specified with multiple instances of the parameter.")] = None,
    ...
    @validate_call
    def point_get_multiple_without_preload_content(
        self,
        as_parallel: Annotated[Optional[StrictBool], Field(description="Specifies if the retrieval processes should be run in parallel on the server. This may improve the response time for large amounts of requested points. The default is 'false'.")] = None,
        include_mode: Annotated[Optional[StrictStr], Field(description="The include mode for the return list. The default is 'All'.")] = None,
        path: Annotated[Optional[List[StrictStr]], Field(description="The path of a point. Multiple points may be specified with multiple instances of the parameter.")] = None,
    ...
    def _point_get_multiple_serialize(
        self,
        as_parallel,
        include_mode,
        path,
    ...
    def point_update(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        point_dto: Annotated[Point, Field(description="A partial point containing the desired changes.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param web_id: The ID of the point. (required)
        :type web_id: str
        :param point_dto: A partial point containing the desired changes. (required)
        ...
        _param = self._point_update_serialize(
            web_id=web_id,
            point_dto=point_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def point_update_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        point_dto: Annotated[Point, Field(description="A partial point containing the desired changes.")],
        _request_timeout: Union[
    ...
    @validate_call
    def point_update_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the point.")],
        point_dto: Annotated[Point, Field(description="A partial point containing the desired changes.")],
        _request_timeout: Union[
