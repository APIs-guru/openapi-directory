...
class NotificationPlugInApi:
    ...
    @validate_call
    def notification_plug_in_get(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the notification plugin.")],
        ...
        :param web_id: The ID of the notification plugin. (required)
        :type web_id: str
        ...
        _param = self._notification_plug_in_get_serialize(
            web_id=web_id,
    ...
    @validate_call
    def notification_plug_in_get_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the notification plugin.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NotificationPlugIn]:
        """Retrieve a notification plugin.
    ...
    @validate_call
    def notification_plug_in_get_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the notification plugin.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _notification_plug_in_get_serialize(
        self,
        web_id,
        selected_fields,
        web_id_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/notificationplugins/{webId}',
    ...
    @validate_call
    def notification_plug_in_get_by_path(
        self,
        path: Annotated[StrictStr, Field(description="The path to the notification plugin.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        :param path: The path to the notification plugin. (required)
        :type path: str
        :param selected_fields: List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
        :type selected_fields: str
        :param web_id_type: Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
        ...
        _param = self._notification_plug_in_get_by_path_serialize(
            path=path,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def notification_plug_in_get_by_path_with_http_info(
        self,
        path: Annotated[StrictStr, Field(description="The path to the notification plugin.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def notification_plug_in_get_by_path_without_preload_content(
        self,
        path: Annotated[StrictStr, Field(description="The path to the notification plugin.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _notification_plug_in_get_by_path_serialize(
        self,
        path,
        selected_fields,
        web_id_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/notificationplugIns',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
