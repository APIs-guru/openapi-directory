...
class TimeRuleApi:
    ...
    @validate_call
    def time_rule_delete(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        ...
        :param web_id: The ID of the Time Rule. (required)
        :type web_id: str
        ...
        _param = self._time_rule_delete_serialize(
            web_id=web_id,
    ...
    @validate_call
    def time_rule_delete_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def time_rule_delete_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        _request_timeout: Union[
            None,
    ...
    def _time_rule_delete_serialize(
        self,
        web_id,
        _request_auth,
        _content_type,
    ...
    def time_rule_get(
        ...
        _param = self._time_rule_get_serialize(
            web_id=web_id,
    ...
    @validate_call
    def time_rule_get_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def time_rule_get_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def time_rule_get_by_path(
        self,
        path: Annotated[StrictStr, Field(description="The path to the Time Rule.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._time_rule_get_by_path_serialize(
            path=path,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def time_rule_get_by_path_with_http_info(
        self,
        path: Annotated[StrictStr, Field(description="The path to the Time Rule.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def time_rule_get_by_path_without_preload_content(
        self,
        path: Annotated[StrictStr, Field(description="The path to the Time Rule.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _time_rule_get_by_path_serialize(
        self,
        path,
        selected_fields,
        web_id_type,
    ...
    @validate_call
    def time_rule_update(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        time_rule: Annotated[TimeRule, Field(description="A partial Time Rule containing the desired changes.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param web_id: The ID of the Time Rule. (required)
        :type web_id: str
        :param time_rule: A partial Time Rule containing the desired changes. (required)
        ...
        _param = self._time_rule_update_serialize(
            web_id=web_id,
            time_rule=time_rule,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def time_rule_update_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        time_rule: Annotated[TimeRule, Field(description="A partial Time Rule containing the desired changes.")],
        _request_timeout: Union[
    ...
    @validate_call
    def time_rule_update_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the Time Rule.")],
        time_rule: Annotated[TimeRule, Field(description="A partial Time Rule containing the desired changes.")],
        _request_timeout: Union[
    ...
    def _time_rule_update_serialize(
        self,
        web_id,
        time_rule,
        _request_auth,
