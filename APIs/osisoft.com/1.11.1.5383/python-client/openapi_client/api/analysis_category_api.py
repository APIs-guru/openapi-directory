...
class AnalysisCategoryApi:
    ...
    @validate_call
    def analysis_category_create_security_entry(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be created.")],
        ...
        :param web_id: The ID of the analysis category, where the security entry will be created. (required)
        :type web_id: str
        ...
        _param = self._analysis_category_create_security_entry_serialize(
            web_id=web_id,
    ...
    @validate_call
    def analysis_category_create_security_entry_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be created.")],
        security_entry: Annotated[SecurityEntry, Field(description="The new security entry definition. The full list of allow and deny rights must be supplied.")],
        apply_to_children: Annotated[Optional[StrictBool], Field(description="If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.")] = None,
    ...
    @validate_call
    def analysis_category_create_security_entry_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be created.")],
        security_entry: Annotated[SecurityEntry, Field(description="The new security entry definition. The full list of allow and deny rights must be supplied.")],
        apply_to_children: Annotated[Optional[StrictBool], Field(description="If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.")] = None,
    ...
    def _analysis_category_create_security_entry_serialize(
        self,
        web_id,
        security_entry,
        apply_to_children,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/analysiscategories/{webId}/securityentries',
    ...
    @validate_call
    def analysis_category_delete(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param web_id: The ID of the analysis category to delete. (required)
        :type web_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._analysis_category_delete_serialize(
            web_id=web_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def analysis_category_delete_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def analysis_category_delete_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _analysis_category_delete_serialize(
        self,
        web_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/analysiscategories/{webId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def analysis_category_delete_security_entry(
        self,
        ...
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be deleted.")],
        apply_to_children: Annotated[Optional[StrictBool], Field(description="If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type name: str
        :param web_id: The ID of the analysis category, where the security entry will be deleted. (required)
        :type web_id: str
        :param apply_to_children: If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
        :type apply_to_children: bool
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._analysis_category_delete_security_entry_serialize(
            name=name,
            web_id=web_id,
            apply_to_children=apply_to_children,
            _request_auth=_request_auth,
    ...
    @validate_call
    def analysis_category_delete_security_entry_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be deleted.")],
        apply_to_children: Annotated[Optional[StrictBool], Field(description="If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.")] = None,
    ...
    @validate_call
    def analysis_category_delete_security_entry_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be deleted.")],
        apply_to_children: Annotated[Optional[StrictBool], Field(description="If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.")] = None,
    ...
    def _analysis_category_delete_security_entry_serialize(
        self,
        name,
        web_id,
        apply_to_children,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/analysiscategories/{webId}/securityentries/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def analysis_category_get(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        ...
        :param web_id: The ID of the analysis category. (required)
        :type web_id: str
        ...
        _param = self._analysis_category_get_serialize(
            web_id=web_id,
    ...
    @validate_call
    def analysis_category_get_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def analysis_category_get_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _analysis_category_get_serialize(
        self,
        web_id,
        selected_fields,
        web_id_type,
    ...
    @validate_call
    def analysis_category_get_by_path(
        self,
        path: Annotated[StrictStr, Field(description="The path to the target analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._analysis_category_get_by_path_serialize(
            path=path,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def analysis_category_get_by_path_with_http_info(
        self,
        path: Annotated[StrictStr, Field(description="The path to the target analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def analysis_category_get_by_path_without_preload_content(
        self,
        path: Annotated[StrictStr, Field(description="The path to the target analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _analysis_category_get_by_path_serialize(
        self,
        path,
        selected_fields,
        web_id_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/analysiscategories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def analysis_category_get_security(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category for the security to be checked.")],
        ...
        :param web_id: The ID of the analysis category for the security to be checked. (required)
        :type web_id: str
        ...
        _param = self._analysis_category_get_security_serialize(
            web_id=web_id,
    ...
    @validate_call
    def analysis_category_get_security_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category for the security to be checked.")],
        user_identity: Annotated[List[StrictStr], Field(description="The user identity for the security information to be checked. Multiple security identities may be specified with multiple instances of the parameter. If the parameter is not specified, only the current user's security rights will be returned.")],
        force_refresh: Annotated[Optional[StrictBool], Field(description="Indicates if the security cache should be refreshed before getting security information. The default is 'false'.")] = None,
    ...
    @validate_call
    def analysis_category_get_security_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category for the security to be checked.")],
        user_identity: Annotated[List[StrictStr], Field(description="The user identity for the security information to be checked. Multiple security identities may be specified with multiple instances of the parameter. If the parameter is not specified, only the current user's security rights will be returned.")],
        force_refresh: Annotated[Optional[StrictBool], Field(description="Indicates if the security cache should be refreshed before getting security information. The default is 'false'.")] = None,
    ...
    def _analysis_category_get_security_serialize(
        self,
        web_id,
        user_identity,
        force_refresh,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/analysiscategories/{webId}/security',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def analysis_category_get_security_entries(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        ...
        _param = self._analysis_category_get_security_entries_serialize(
            web_id=web_id,
    ...
    @validate_call
    def analysis_category_get_security_entries_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        name_filter: Annotated[Optional[StrictStr], Field(description="The name query string used for filtering security entries. The default is no filter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    @validate_call
    def analysis_category_get_security_entries_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        name_filter: Annotated[Optional[StrictStr], Field(description="The name query string used for filtering security entries. The default is no filter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    def _analysis_category_get_security_entries_serialize(
        self,
        web_id,
        name_filter,
        selected_fields,
    ...
    @validate_call
    def analysis_category_get_security_entry_by_name(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        ...
        _param = self._analysis_category_get_security_entry_by_name_serialize(
            name=name,
            web_id=web_id,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
    ...
    @validate_call
    def analysis_category_get_security_entry_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    @validate_call
    def analysis_category_get_security_entry_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    def _analysis_category_get_security_entry_by_name_serialize(
        self,
        name,
        web_id,
        selected_fields,
    ...
    @validate_call
    def analysis_category_update(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to update.")],
        category: Annotated[AnalysisCategory, Field(description="A partial analysis category containing the desired changes.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param web_id: The ID of the analysis category to update. (required)
        :type web_id: str
        :param category: A partial analysis category containing the desired changes. (required)
        :type category: AnalysisCategory
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._analysis_category_update_serialize(
            web_id=web_id,
            category=category,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def analysis_category_update_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to update.")],
        category: Annotated[AnalysisCategory, Field(description="A partial analysis category containing the desired changes.")],
        _request_timeout: Union[
    ...
    @validate_call
    def analysis_category_update_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category to update.")],
        category: Annotated[AnalysisCategory, Field(description="A partial analysis category containing the desired changes.")],
        _request_timeout: Union[
    ...
    def _analysis_category_update_serialize(
        self,
        web_id,
        category,
        _request_auth,
    ...
    @validate_call
    def analysis_category_update_security_entry(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be updated.")],
        ...
        :type name: str
        :param web_id: The ID of the analysis category, where the security entry will be updated. (required)
        :type web_id: str
        ...
        _param = self._analysis_category_update_security_entry_serialize(
            name=name,
            web_id=web_id,
            security_entry=security_entry,
            apply_to_children=apply_to_children,
    ...
    @validate_call
    def analysis_category_update_security_entry_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be updated.")],
        security_entry: Annotated[SecurityEntry, Field(description="The new security entry definition. The full list of allow and deny rights must be supplied or they will be removed.")],
    ...
    @validate_call
    def analysis_category_update_security_entry_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the analysis category, where the security entry will be updated.")],
        security_entry: Annotated[SecurityEntry, Field(description="The new security entry definition. The full list of allow and deny rights must be supplied or they will be removed.")],
    ...
    def _analysis_category_update_security_entry_serialize(
        self,
        name,
        web_id,
        security_entry,
