...
class SecurityIdentityApi:
    ...
    @validate_call
    def security_identity_delete(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        ...
        :param web_id: The ID of the security identity. (required)
        :type web_id: str
        ...
        _param = self._security_identity_delete_serialize(
            web_id=web_id,
    ...
    @validate_call
    def security_identity_delete_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def security_identity_delete_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        _request_timeout: Union[
            None,
    ...
    def _security_identity_delete_serialize(
        self,
        web_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/securityidentities/{webId}',
    ...
    def security_identity_get(
        ...
        _param = self._security_identity_get_serialize(
            web_id=web_id,
    ...
    @validate_call
    def security_identity_get_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def security_identity_get_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _security_identity_get_serialize(
        self,
        web_id,
        selected_fields,
        web_id_type,
    ...
    @validate_call
    def security_identity_get_by_path(
        self,
        path: Annotated[StrictStr, Field(description="The path to the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._security_identity_get_by_path_serialize(
            path=path,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def security_identity_get_by_path_with_http_info(
        self,
        path: Annotated[StrictStr, Field(description="The path to the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def security_identity_get_by_path_without_preload_content(
        self,
        path: Annotated[StrictStr, Field(description="The path to the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _security_identity_get_by_path_serialize(
        self,
        path,
        selected_fields,
        web_id_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/securityidentities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def security_identity_get_security(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity for the security to be checked.")],
        ...
        :param web_id: The ID of the security identity for the security to be checked. (required)
        :type web_id: str
        ...
        _param = self._security_identity_get_security_serialize(
            web_id=web_id,
    ...
    @validate_call
    def security_identity_get_security_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity for the security to be checked.")],
        user_identity: Annotated[List[StrictStr], Field(description="The user identity for the security information to be checked. Multiple security identities may be specified with multiple instances of the parameter. If the parameter is not specified, only the current user's security rights will be returned.")],
        force_refresh: Annotated[Optional[StrictBool], Field(description="Indicates if the security cache should be refreshed before getting security information. The default is 'false'.")] = None,
    ...
    @validate_call
    def security_identity_get_security_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity for the security to be checked.")],
        user_identity: Annotated[List[StrictStr], Field(description="The user identity for the security information to be checked. Multiple security identities may be specified with multiple instances of the parameter. If the parameter is not specified, only the current user's security rights will be returned.")],
        force_refresh: Annotated[Optional[StrictBool], Field(description="Indicates if the security cache should be refreshed before getting security information. The default is 'false'.")] = None,
    ...
    def _security_identity_get_security_serialize(
        self,
        web_id,
        user_identity,
        force_refresh,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/securityidentities/{webId}/security',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def security_identity_get_security_entries(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        ...
        _param = self._security_identity_get_security_entries_serialize(
            web_id=web_id,
    ...
    @validate_call
    def security_identity_get_security_entries_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        name_filter: Annotated[Optional[StrictStr], Field(description="The name query string used for filtering security entries. The default is no filter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    @validate_call
    def security_identity_get_security_entries_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        name_filter: Annotated[Optional[StrictStr], Field(description="The name query string used for filtering security entries. The default is no filter.")] = None,
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    def _security_identity_get_security_entries_serialize(
        self,
        web_id,
        name_filter,
        selected_fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/securityidentities/{webId}/securityentries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def security_identity_get_security_entry_by_name(
        self,
        ...
        _param = self._security_identity_get_security_entry_by_name_serialize(
            name=name,
            web_id=web_id,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
    ...
    @validate_call
    def security_identity_get_security_entry_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    @validate_call
    def security_identity_get_security_entry_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the security entry. For every backslash character (\\) in the security entry name, replace with asterisk (*). As an example, use domain*username instead of domain\\username.")],
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
    ...
    def _security_identity_get_security_entry_by_name_serialize(
        self,
        name,
        web_id,
        selected_fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/securityidentities/{webId}/securityentries/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def security_identity_get_security_mappings(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
        ...
        _param = self._security_identity_get_security_mappings_serialize(
            web_id=web_id,
            selected_fields=selected_fields,
            web_id_type=web_id_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def security_identity_get_security_mappings_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    @validate_call
    def security_identity_get_security_mappings_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        selected_fields: Annotated[Optional[StrictStr], Field(description="List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.")] = None,
        web_id_type: Annotated[Optional[StrictStr], Field(description="Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".")] = None,
    ...
    def _security_identity_get_security_mappings_serialize(
        self,
        web_id,
        selected_fields,
        web_id_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/securityidentities/{webId}/securitymappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def security_identity_update(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        security_identity: Annotated[SecurityIdentity, Field(description="A partial security identity containing the desired changes.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param web_id: The ID of the security identity. (required)
        :type web_id: str
        :param security_identity: A partial security identity containing the desired changes. (required)
        ...
        _param = self._security_identity_update_serialize(
            web_id=web_id,
    ...
    @validate_call
    def security_identity_update_with_http_info(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        security_identity: Annotated[SecurityIdentity, Field(description="A partial security identity containing the desired changes.")],
        _request_timeout: Union[
    ...
    @validate_call
    def security_identity_update_without_preload_content(
        self,
        web_id: Annotated[StrictStr, Field(description="The ID of the security identity.")],
        security_identity: Annotated[SecurityIdentity, Field(description="A partial security identity containing the desired changes.")],
        _request_timeout: Union[
    ...
    def _security_identity_update_serialize(
        self,
        web_id,
        security_identity,
        _request_auth,
