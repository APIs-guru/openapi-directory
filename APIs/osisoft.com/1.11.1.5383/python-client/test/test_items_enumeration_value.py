...
class TestItemsEnumerationValue(unittest.TestCase):
    """ItemsEnumerationValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsEnumerationValue:
        """Test ItemsEnumerationValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsEnumerationValue`
        """
        model = ItemsEnumerationValue()
        if include_optional:
            return ItemsEnumerationValue(
                items = [
                    openapi_client.models.enumeration_value.EnumerationValue(
    ...
    def testItemsEnumerationValue(self):
        """Test ItemsEnumerationValue"""
