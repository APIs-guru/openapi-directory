...
class TestItemsItemAttribute(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ItemsItemAttribute:
        """Test ItemsItemAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsItemAttribute`
        """
        model = ItemsItemAttribute()
        if include_optional:
            return ItemsItemAttribute(
                items = [
                    openapi_client.models.item[attribute].Item[Attribute](
                        exception = openapi_client.models.errors.Errors(
                            errors = [An error has occurred.], ), 
                        identifier = '\\server\path', 
                        identifier_type = 'Path', 
                        object = openapi_client.models.attribute.Attribute(
