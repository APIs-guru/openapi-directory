...
class TestItemElement(unittest.TestCase):
    """ItemElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemElement:
        """Test ItemElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemElement`
        """
        model = ItemElement()
        if include_optional:
            return ItemElement(
