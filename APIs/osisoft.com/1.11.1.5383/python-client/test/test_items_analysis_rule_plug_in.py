...
class TestItemsAnalysisRulePlugIn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ItemsAnalysisRulePlugIn:
        """Test ItemsAnalysisRulePlugIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsAnalysisRulePlugIn`
        """
        model = ItemsAnalysisRulePlugIn()
        if include_optional:
            return ItemsAnalysisRulePlugIn(
                items = [
                    openapi_client.models.analysis_rule_plug_in.AnalysisRulePlugIn(
