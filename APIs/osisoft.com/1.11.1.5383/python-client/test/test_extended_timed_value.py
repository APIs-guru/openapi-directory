...
class TestExtendedTimedValue(unittest.TestCase):
    """ExtendedTimedValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedTimedValue:
        """Test ExtendedTimedValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedTimedValue`
        """
        model = ExtendedTimedValue()
        if include_optional:
    ...
    def testExtendedTimedValue(self):
        """Test ExtendedTimedValue"""
