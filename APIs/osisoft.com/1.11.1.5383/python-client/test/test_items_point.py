...
class TestItemsPoint(unittest.TestCase):
    """ItemsPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsPoint:
        """Test ItemsPoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsPoint`
        """
        model = ItemsPoint()
        if include_optional:
            return ItemsPoint(
