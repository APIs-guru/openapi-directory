...
class TestItemsAttributeTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ItemsAttributeTemplate:
        """Test ItemsAttributeTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsAttributeTemplate`
        """
        model = ItemsAttributeTemplate()
        if include_optional:
            return ItemsAttributeTemplate(
                items = [
                    openapi_client.models.attribute_template.AttributeTemplate(
