...
class TestItemsElement(unittest.TestCase):
    """ItemsElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsElement:
        """Test ItemsElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsElement`
        """
        model = ItemsElement()
        if include_optional:
            return ItemsElement(
