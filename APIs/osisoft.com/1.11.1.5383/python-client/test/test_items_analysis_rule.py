...
class TestItemsAnalysisRule(unittest.TestCase):
    """ItemsAnalysisRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsAnalysisRule:
        """Test ItemsAnalysisRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsAnalysisRule`
        """
        model = ItemsAnalysisRule()
        if include_optional:
            return ItemsAnalysisRule(
                items = [
                    openapi_client.models.analysis_rule.AnalysisRule(
    ...
    def testItemsAnalysisRule(self):
        """Test ItemsAnalysisRule"""
