...
class TestItemsAttribute(unittest.TestCase):
    """ItemsAttribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsAttribute:
        """Test ItemsAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsAttribute`
        """
        model = ItemsAttribute()
        if include_optional:
