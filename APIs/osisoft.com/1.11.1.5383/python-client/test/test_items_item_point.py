...
class TestItemsItemPoint(unittest.TestCase):
    """ItemsItemPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsItemPoint:
        """Test ItemsItemPoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsItemPoint`
        """
        model = ItemsItemPoint()
        if include_optional:
            return ItemsItemPoint(
                items = [
                    openapi_client.models.item[point].Item[Point](
