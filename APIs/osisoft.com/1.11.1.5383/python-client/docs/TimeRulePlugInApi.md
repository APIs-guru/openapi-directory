# openapi_client.TimeRulePlugInApi
...
> TimeRulePlugIn time_rule_plug_in_get(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TimeRulePlugInApi(api_client)
    ...
    try:
        # Retrieve a Time Rule Plug-in.
        api_response = api_instance.time_rule_plug_in_get(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of TimeRulePlugInApi->time_rule_plug_in_get:\n")
        pprint(api_response)
...
> TimeRulePlugIn time_rule_plug_in_get_by_path(path, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a Time Rule Plug-in by path.
        api_response = api_instance.time_rule_plug_in_get_by_path(path, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of TimeRulePlugInApi->time_rule_plug_in_get_by_path:\n")
        pprint(api_response)
    except Exception as e:
