...
[**analysis_get_analyses_query**](AnalysisApi.md#analysis_get_analyses_query) | **GET** /analyses/search | Retrieve analyses based on the specified conditions. By default, returns all analyses.
...
> analysis_create_security_entry(web_id, security_entry, apply_to_children=apply_to_children, web_id_type=web_id_type)
...
# **analysis_get**
> Analysis analysis_get(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve an Analysis.
        api_response = api_instance.analysis_get(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get:\n")
        pprint(api_response)
    except Exception as e:
...
# **analysis_get_analyses_query**
> ItemsAnalysis analysis_get_analyses_query(database_web_id=database_web_id, max_count=max_count, query=query, selected_fields=selected_fields, start_index=start_index, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    query = 'query_example' # str | The query string is a list of filters used to perform an AFSearch for the analyses in the asset database. An example would be: \"query= Name:=MyAnalysis1* Template:=AnalysisTemplate\". (optional)
    selected_fields = 'selected_fields_example' # str | List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned. (optional)
    ...
    try:
        # Retrieve analyses based on the specified conditions. By default, returns all analyses.
        api_response = api_instance.analysis_get_analyses_query(database_web_id=database_web_id, max_count=max_count, query=query, selected_fields=selected_fields, start_index=start_index, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_analyses_query:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnalysisApi->analysis_get_analyses_query: %s\n" % e)
```
...
> Analysis analysis_get_by_path(path, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve an Analysis by path.
        api_response = api_instance.analysis_get_by_path(path, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_by_path:\n")
        pprint(api_response)
    except Exception as e:
...
> ItemsAnalysisCategory analysis_get_categories(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an Analysis' categories.
        api_response = api_instance.analysis_get_categories(web_id, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_categories:\n")
        pprint(api_response)
    except Exception as e:
...
> ItemsSecurityRights analysis_get_security(web_id, user_identity, force_refresh=force_refresh, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the security information of the specified security item associated with the Analysis for a specified user.
        api_response = api_instance.analysis_get_security(web_id, user_identity, force_refresh=force_refresh, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_security:\n")
        pprint(api_response)
    except Exception as e:
...
> ItemsSecurityEntry analysis_get_security_entries(web_id, name_filter=name_filter, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve the security entries associated with the analysis based on the specified criteria. By default, all security entries for this analysis are returned.
        api_response = api_instance.analysis_get_security_entries(web_id, name_filter=name_filter, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_security_entries:\n")
        pprint(api_response)
    except Exception as e:
...
> SecurityEntry analysis_get_security_entry_by_name(name, web_id, selected_fields=selected_fields, web_id_type=web_id_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve the security entry associated with the analysis with the specified name.
        api_response = api_instance.analysis_get_security_entry_by_name(name, web_id, selected_fields=selected_fields, web_id_type=web_id_type)
        print("The response of AnalysisApi->analysis_get_security_entry_by_name:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    analysis = openapi_client.Analysis() # Analysis | A partial Analysis containing the desired changes.
