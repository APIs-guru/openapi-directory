...
class PolicySchedule(BaseModel):
    ...
    PolicySchedule
    """ # noqa: E501
    overrides: Optional[List[OnCallOverride]] = None
    policy: Optional[EscalationPolicy] = None
    schedule: Optional[List[OnCallEntry]] = None
    __properties: ClassVar[List[str]] = ["overrides", "policy", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overrides": [OnCallOverride.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None,
            "policy": EscalationPolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "schedule": [OnCallEntry.from_dict(_item) for _item in obj["schedule"]] if obj.get("schedule") is not None else None
        })
        return _obj
