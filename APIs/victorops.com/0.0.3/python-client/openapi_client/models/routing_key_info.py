...
class RoutingKeyInfo(BaseModel):
    ...
    routing_key: Optional[StrictStr] = Field(default=None, alias="routingKey")
    targets: Optional[List[RoutingKeyTarget]] = None
    __properties: ClassVar[List[str]] = ["isDefault", "routingKey", "targets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targets": [RoutingKeyTarget.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
