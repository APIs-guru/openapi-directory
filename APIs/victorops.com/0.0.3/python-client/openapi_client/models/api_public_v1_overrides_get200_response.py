...
class ApiPublicV1OverridesGet200Response(BaseModel):
    """
    ApiPublicV1OverridesGet200Response
    """ # noqa: E501
    self_url: Optional[StrictStr] = Field(default=None, alias="_selfUrl")
    overrides: Optional[List[ScheduledOverride]] = None
    __properties: ClassVar[List[str]] = ["_selfUrl", "overrides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overrides": [ScheduledOverride.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
