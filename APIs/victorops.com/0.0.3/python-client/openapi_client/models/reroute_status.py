...
class RerouteStatus(BaseModel):
    """
    RerouteStatus
    """ # noqa: E501
    incident_number: StrictStr = Field(alias="incidentNumber")
    message: Optional[StrictStr] = None
    success: StrictBool
    target_status: List[RerouteTargetStatus] = Field(alias="targetStatus")
    __properties: ClassVar[List[str]] = ["incidentNumber", "message", "success", "targetStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetStatus": [RerouteTargetStatus.from_dict(_item) for _item in obj["targetStatus"]] if obj.get("targetStatus") is not None else None
        })
        return _obj
