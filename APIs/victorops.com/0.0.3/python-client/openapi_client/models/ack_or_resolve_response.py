...
class AckOrResolveResponse(BaseModel):
    """
    The results of ack/resolve for each incident
    """ # noqa: E501
    results: Optional[List[AckOrResolveResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AckOrResolveResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
