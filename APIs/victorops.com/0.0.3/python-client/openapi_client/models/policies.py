...
class Policies(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[List[PagingPolicy]] = None
    user_id: Optional[StrictInt] = Field(default=None, alias="userId")
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["policies", "userId", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [PagingPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
