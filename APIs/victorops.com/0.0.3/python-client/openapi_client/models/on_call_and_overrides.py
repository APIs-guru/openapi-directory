...
class OnCallAndOverrides(BaseModel):
    """
    OnCallAndOverrides
    """ # noqa: E501
    overrides: Optional[List[TeamScheduleOverlayResource]] = None
    schedule: Optional[List[TeamScheduleResource]] = None
    team: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["overrides", "schedule", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overrides": [TeamScheduleOverlayResource.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None,
            "schedule": [TeamScheduleResource.from_dict(_item) for _item in obj["schedule"]] if obj.get("schedule") is not None else None,
            "team": obj.get("team")
        })
        return _obj
