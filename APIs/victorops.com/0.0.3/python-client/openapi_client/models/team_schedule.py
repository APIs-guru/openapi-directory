...
class TeamSchedule(BaseModel):
    ...
    TeamSchedule
    """ # noqa: E501
    schedules: Optional[List[PolicySchedule]] = None
    team: Optional[Team] = None
    __properties: ClassVar[List[str]] = ["schedules", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schedules": [PolicySchedule.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None,
