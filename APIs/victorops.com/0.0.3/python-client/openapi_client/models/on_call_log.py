...
class OnCallLog(BaseModel):
    """
    OnCallLog
    """ # noqa: E501
    end: Optional[datetime] = None
    start: Optional[datetime] = None
    team_slug: Optional[StrictStr] = Field(default=None, alias="teamSlug")
    user_logs: Optional[List[UserLog]] = Field(default=None, alias="userLogs")
    __properties: ClassVar[List[str]] = ["end", "start", "teamSlug", "userLogs"]
