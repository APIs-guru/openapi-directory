...
class ApiPublicV1ProfileUsernamePoliciesGet200Response(BaseModel):
    """
    ApiPublicV1ProfileUsernamePoliciesGet200Response
    """ # noqa: E501
    self_url: Optional[StrictStr] = Field(default=None, alias="_selfUrl")
    steps: Optional[List[PagingPolicyStep]] = None
    __properties: ClassVar[List[str]] = ["_selfUrl", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [PagingPolicyStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
