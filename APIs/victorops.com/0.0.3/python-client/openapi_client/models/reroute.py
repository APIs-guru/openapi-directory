...
class Reroute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["incidentNumber", "targets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targets": [IncidentTarget.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
