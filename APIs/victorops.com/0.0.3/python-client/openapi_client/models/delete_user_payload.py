...
class DeleteUserPayload(BaseModel):
    ...
    """ # noqa: E501
    replacement: Optional[StrictStr] = Field(default=None, description="The user to take the place of the deleted user in escalations")
    __properties: ClassVar[List[str]] = ["replacement"]
