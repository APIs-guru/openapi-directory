...
class ActiveIncidentList(BaseModel):
    ...
    """ # noqa: E501
    incidents: Optional[List[ActiveIncidentInfo]] = Field(default=None, description="The incident data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "incidents": [ActiveIncidentInfo.from_dict(_item) for _item in obj["incidents"]] if obj.get("incidents") is not None else None
        })
        return _obj
