...
class CreatedIncident(BaseModel):
    """
    CreatedIncident
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="An error message")
    incident_number: Optional[StrictStr] = Field(default=None, description="The VictorOps incident number", alias="incidentNumber")
    __properties: ClassVar[List[str]] = ["error", "incidentNumber"]
