...
class RoutingKeysApi:
    ...
    @validate_call
    def api_public_v1_org_routing_keys_get(
        self,
        ...
        _param = self._api_public_v1_org_routing_keys_get_serialize(
    ...
    @validate_call
    def api_public_v1_org_routing_keys_get_with_http_info(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListRoutingKeysResponse]:
        """List routing keys with associated teams
    ...
    @validate_call
    def api_public_v1_org_routing_keys_get_without_preload_content(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        _request_timeout: Union[
    ...
    def _api_public_v1_org_routing_keys_get_serialize(
        self,
        x_vo_api_id,
        x_vo_api_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api-public/v1/org/routing-keys',
