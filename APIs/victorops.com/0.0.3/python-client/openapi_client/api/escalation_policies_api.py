...
class EscalationPoliciesApi:
    ...
    @validate_call
    def api_public_v1_policies_get(
        self,
        ...
        _param = self._api_public_v1_policies_get_serialize(
    ...
    @validate_call
    def api_public_v1_policies_get_with_http_info(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EscalationPolicyInfoList]:
        """Get escalation policy info
    ...
    @validate_call
    def api_public_v1_policies_get_without_preload_content(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        _request_timeout: Union[
    ...
    def _api_public_v1_policies_get_serialize(
        self,
        x_vo_api_id,
        x_vo_api_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api-public/v1/policies',
    ...
    @validate_call
    def api_public_v1_team_team_policies_get(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        team: Annotated[StrictStr, Field(description="The VictorOps team to fetch")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_public_v1_team_team_policies_get_serialize(
            x_vo_api_id=x_vo_api_id,
            x_vo_api_key=x_vo_api_key,
            team=team,
            _request_auth=_request_auth,
    ...
    @validate_call
    def api_public_v1_team_team_policies_get_with_http_info(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        team: Annotated[StrictStr, Field(description="The VictorOps team to fetch")],
    ...
    @validate_call
    def api_public_v1_team_team_policies_get_without_preload_content(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        team: Annotated[StrictStr, Field(description="The VictorOps team to fetch")],
    ...
    def _api_public_v1_team_team_policies_get_serialize(
        self,
        x_vo_api_id,
        x_vo_api_key,
        team,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api-public/v1/team/{team}/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
