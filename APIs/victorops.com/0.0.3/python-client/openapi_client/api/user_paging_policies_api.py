...
class UserPagingPoliciesApi:
    ...
    @validate_call
    def api_public_v1_user_user_policies_get(
        self,
        ...
        _param = self._api_public_v1_user_user_policies_get_serialize(
    ...
    @validate_call
    def api_public_v1_user_user_policies_get_with_http_info(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        user: Annotated[StrictStr, Field(description="The VictorOps user ID")],
    ...
    @validate_call
    def api_public_v1_user_user_policies_get_without_preload_content(
        self,
        x_vo_api_id: Annotated[StrictStr, Field(description="Your API ID")],
        x_vo_api_key: Annotated[StrictStr, Field(description="Your API Key")],
        user: Annotated[StrictStr, Field(description="The VictorOps user ID")],
    ...
    def _api_public_v1_user_user_policies_get_serialize(
        self,
        x_vo_api_id,
        x_vo_api_key,
        user,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api-public/v1/user/{user}/policies',
