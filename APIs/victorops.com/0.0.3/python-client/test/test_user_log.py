...
class TestUserLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserLog:
        """Test UserLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserLog`
        """
        model = UserLog()
        if include_optional:
            return UserLog(
                ...
                total = openapi_client.models.on_call_interval_duration.OnCallInterval_duration(
                    hours = 1.337, 
                    minutes = 1.337, ),
                user_id = ''
            )
