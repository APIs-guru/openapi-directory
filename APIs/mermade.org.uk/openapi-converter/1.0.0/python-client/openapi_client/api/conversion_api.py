...
class ConversionApi:
    ...
    def convert(
        self,
        filename: Annotated[Optional[StrictStr], Field(description="The file to upload and convert")] = None,
        source: Annotated[Optional[StrictStr], Field(description="The text of a Swagger 2.0 definition to convert")] = None,
        validate: Optional[StrictStr] = None,
    ...
    def convert_url(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 2.0 definition from")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._convert_url_serialize(
            url=url,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def convert_url_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 2.0 definition from")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def convert_url_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 2.0 definition from")],
        _request_timeout: Union[
            None,
