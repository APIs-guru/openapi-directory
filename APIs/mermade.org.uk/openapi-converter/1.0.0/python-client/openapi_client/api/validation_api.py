...
class ValidationApi:
    ...
    def get_badge(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 3.0.x definition from")],
        ...
        _param = self._get_badge_serialize(
            url=url,
    ...
    @validate_call
    def get_badge_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 3.0.x definition from")],
        _request_timeout: Union[
            None,
    ...
    def validate(
        self,
        filename: Annotated[Optional[StrictStr], Field(description="The file to upload and validate")] = None,
        source: Annotated[Optional[StrictStr], Field(description="The text of an OpenAPI 3.0.x definition to validate")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def validate_url(
        ...
        _param = self._validate_url_serialize(
            url=url,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def validate_url_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 3.0.x definition from")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def validate_url_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="The URL to retrieve the OpenAPI 3.0.x definition from")],
        _request_timeout: Union[
            None,
