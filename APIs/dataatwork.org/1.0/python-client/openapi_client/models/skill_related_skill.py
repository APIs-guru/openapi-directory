...
class SkillRelatedSkill(BaseModel):
    """
    SkillRelatedSkill
    """ # noqa: E501
    skill_name: Optional[StrictStr] = Field(default=None, description="Skill name")
    uuid: Optional[StrictStr] = Field(default=None, description="Universally Unique Identifier for the skill")
    __properties: ClassVar[List[str]] = ["skill_name", "uuid"]
