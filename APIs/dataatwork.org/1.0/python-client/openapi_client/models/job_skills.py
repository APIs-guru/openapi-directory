...
class JobSkills(BaseModel):
    ...
    JobSkills
    """ # noqa: E501
    job_title: Optional[StrictStr] = Field(default=None, description="Title of the job associated with the UUID")
    ...
    skills: Optional[List[SkillJob]] = None
    __properties: ClassVar[List[str]] = ["job_title", "job_uuid", "normalized_job_title", "skills"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skills": [SkillJob.from_dict(_item) for _item in obj["skills"]] if obj.get("skills") is not None else None
        })
        return _obj
