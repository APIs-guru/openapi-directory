...
class NormalizedSkill(BaseModel):
    ...
    NormalizedSkill
    """ # noqa: E501
    skill_name: Optional[StrictStr] = Field(default=None, description="Canonical skill name")
    uuid: Optional[StrictStr] = Field(default=None, description="Universally Unique Identifier for the canonical skill name")
