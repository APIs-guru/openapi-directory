...
class ShippingAddress(BaseModel):
    ...
    instructions: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Additional text about how to handle the shipment at this address. ")
    __properties: ClassVar[List[str]] = ["address_line1", "address_line2", "address_line3", "address_residential_indicator", "city_locality", "company_name", "country_code", "email", "name", "phone", "postal_code", "state_province", "instructions"]
