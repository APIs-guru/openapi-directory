...
class CreateWebhookResponseBody(BaseModel):
    ...
    """ # noqa: E501
    event: WebhookEvent
    url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The url that the webhook sends the request to")
    webhook_id: Annotated[str, Field(min_length=1, strict=True, max_length=25)] = Field(description="A string that uniquely identifies the webhook")
