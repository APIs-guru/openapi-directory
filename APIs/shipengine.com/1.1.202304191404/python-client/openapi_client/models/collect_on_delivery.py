...
class CollectOnDelivery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payment_amount", "payment_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.payment_amount:
            _dict['payment_amount'] = self.payment_amount.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payment_amount": PaymentAmount.from_dict(obj["payment_amount"]) if obj.get("payment_amount") is not None else None,
