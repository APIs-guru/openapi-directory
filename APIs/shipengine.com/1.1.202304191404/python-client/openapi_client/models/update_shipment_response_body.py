...
class UpdateShipmentResponseBody(BaseModel):
    """
    ...
    address_validation: AddressValidationResult = Field(description="The address validation")
    errors: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="An array of errors that occurred while creating shipment.")
    __properties: ClassVar[List[str]] = ["advanced_options", "carrier_id", "confirmation", "created_at", "customs", "external_order_id", "external_shipment_id", "insurance_provider", "is_return", "items", "modified_at", "order_source_code", "origin_type", "packages", "return_to", "service_code", "ship_date", "ship_from", "ship_to", "shipment_id", "shipment_number", "shipment_status", "tags", "tax_identifiers", "total_weight", "warehouse_id", "address_validation", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateShipmentResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateShipmentResponseBody from a dict"""
        if obj is None:
            return None
