...
class GetServicePointByIdResponseBody(BaseModel):
    ...
    """ # noqa: E501
    service_point: Optional[GetServicePointByIdResponseBodyServicePoint] = None
    __properties: ClassVar[List[str]] = ["service_point"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of service_point
        if self.service_point:
            _dict['service_point'] = self.service_point.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service_point": GetServicePointByIdResponseBodyServicePoint.from_dict(obj["service_point"]) if obj.get("service_point") is not None else None
        })
        return _obj
