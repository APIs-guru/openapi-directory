...
class ListShipmentsResponseBody(BaseModel):
    ...
    pages: Annotated[int, Field(strict=True, ge=1)]
    shipments: List[Shipment] = Field(description="The list of shipments returned by the api call")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of shipments returned by the api call")
    __properties: ClassVar[List[str]] = ["links", "page", "pages", "shipments", "total"]
