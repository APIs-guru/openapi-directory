...
class ListBatchesResponseBody(BaseModel):
    ...
    """ # noqa: E501
    batches: Annotated[List[Batch], Field(min_length=0)] = Field(description="Batch List")
    links: PaginationLink
    page: Annotated[int, Field(strict=True, ge=1)] = Field(description="The page that is currently being read")
    pages: Annotated[int, Field(strict=True, ge=1)] = Field(description="The total number of batch pages the API call returned")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="The total number of batches the API call returned")
    __properties: ClassVar[List[str]] = ["batches", "links", "page", "pages", "total"]
