...
class Error(BaseModel):
    ...
    message: Annotated[str, Field(min_length=1, strict=True)] = Field(description="An error message associated with the failed API call")
    __properties: ClassVar[List[str]] = ["error_code", "error_source", "error_type", "message"]
