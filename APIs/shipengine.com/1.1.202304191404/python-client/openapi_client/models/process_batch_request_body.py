...
class ProcessBatchRequestBody(BaseModel):
    ...
    ship_date: Optional[datetime] = Field(default=None, description="The Ship date the batch is being processed for")
    __properties: ClassVar[List[str]] = ["display_scheme", "label_format", "label_layout", "ship_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label_layout": obj.get("label_layout") if obj.get("label_layout") is not None else &#39;4x6&#39;,
