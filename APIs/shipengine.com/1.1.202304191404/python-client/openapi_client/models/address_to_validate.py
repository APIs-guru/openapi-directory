...
class AddressToValidate(BaseModel):
    """
    ...
    address_residential_indicator: Optional[AddressResidentialIndicator] = Field(default=None, description="Indicates whether this is a residential address.")
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The name of a contact person at this address.  This field may be set instead of - or in addition to - the `company_name` field. ")
    phone: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The phone number of a contact person at this address.  The format of this phone number varies depending on the country. ")
    postal_code: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="postal code")
