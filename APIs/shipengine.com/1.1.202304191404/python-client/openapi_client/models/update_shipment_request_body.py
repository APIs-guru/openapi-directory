...
class UpdateShipmentRequestBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["advanced_options", "carrier_id", "confirmation", "created_at", "customs", "external_order_id", "external_shipment_id", "insurance_provider", "is_return", "items", "modified_at", "order_source_code", "origin_type", "packages", "return_to", "service_code", "ship_date", "ship_from", "ship_to", "shipment_id", "shipment_number", "shipment_status", "tags", "tax_identifiers", "total_weight", "warehouse_id", "validate_address"]
