...
class GetServicePointsRequestBodyProvidersInner(BaseModel):
    """
    GetServicePointsRequestBodyProvidersInner
    """ # noqa: E501
    carrier_id: Optional[StrictStr] = Field(default=None, description="Uniquely identifies a carrier connection")
    service_code: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["carrier_id", "service_code"]
