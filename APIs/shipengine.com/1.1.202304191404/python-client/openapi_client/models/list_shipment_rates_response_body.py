...
class ListShipmentRatesResponseBody(BaseModel):
    ...
    """ # noqa: E501
    created_at: Annotated[str, Field(min_length=1, strict=True, max_length=25)] = Field(description="When the rate was created")
    errors: List[Error]
    invalid_rates: List[Rate] = Field(description="An array of invalid shipment rates")
