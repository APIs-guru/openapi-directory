...
class ListBatchErrorsResponseBody(BaseModel):
    ...
    """ # noqa: E501
    errors: List[BatchResponseError] = Field(description="The errors currently associated with the batch")
    links: PaginationLink
    __properties: ClassVar[List[str]] = ["errors", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [BatchResponseError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
