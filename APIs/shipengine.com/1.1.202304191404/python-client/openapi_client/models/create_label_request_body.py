...
class CreateLabelRequestBody(BaseModel):
    ...
    """ # noqa: E501
    ship_from_service_point_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for a carrier drop off point where a merchant plans to deliver packages. This will take precedence over a shipment's ship from address.")
    ship_to_service_point_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for a carrier service point where the shipment will be delivered by the carrier. This will take precedence over a shipment's ship to address.")
    ...
    batch_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(default=None, description="If this label was created as part of a [batch](https://www.shipengine.com/docs/labels/bulk/), then this is the unique ID of that batch. ")
    carrier_code: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The [shipping carrier](https://www.shipengine.com/docs/carriers/setup/) who will ship the package, such as `fedex`, `dhl_express`, `stamps_com`, etc. ")
    carrier_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(default=None, description="The unique ID of the [carrier account](https://www.shipengine.com/docs/carriers/setup/) that was used to create this label ")
    charge_event: Optional[LabelChargeEvent] = Field(default=None, description="The label charge event. ")
    created_at: Optional[datetime] = Field(default=None, description="The date and time that the label was created in ShipEngine.")
    ...
    form_download: Optional[Link] = Field(default=None, description="The link to download the customs form (a.k.a. commercial invoice) for this shipment, if any.  Forms are in PDF format. This field is null if the shipment does not require a customs form, or if the carrier does not support it. ")
    insurance_claim: Optional[Link] = Field(default=None, description="The link to submit an insurance claim for the shipment.  This field is null if the shipment is not insured or if the insurance provider does not support online claim submission. ")
    insurance_cost: Optional[MonetaryValue] = Field(default=None, description="The insurance cost for this package.  Add this to the `shipment_cost` field to get the total cost. ")
    is_international: Optional[StrictBool] = Field(default=None, description="Indicates whether this is an international shipment.  That is, the originating country and destination country are different. ")
    is_return_label: Optional[StrictBool] = Field(default=None, description="Indicates whether this is a return label.  You may also want to set the `rma_number` so you know what is being returned. ")
    ...
    label_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(default=None, description="A string that uniquely identifies the label. This ID is generated by ShipEngine when the label is created. ")
    ...
    packages: Optional[List[Package]] = Field(default=None, description="The label's package(s).  > **Note:** Some carriers only allow one package per label.  If you attempt to create a multi-package label for a carrier that doesn't allow it, an error will be returned. ")
    rma_number: Optional[StrictStr] = Field(default=None, description="An optional Return Merchandise Authorization number.  This field is useful for return labels.  You can set it to any string value. ")
    service_code: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The [carrier service](https://www.shipengine.com/docs/shipping/use-a-carrier-service/) used to ship the package, such as `fedex_ground`, `usps_first_class_mail`, `flat_rate_envelope`, etc. ")
    ship_date: Optional[datetime] = Field(default=None, description="The date that the package was (or will be) shippped.  ShipEngine will take the day of week into consideration. For example, if the carrier does not operate on Sundays, then a package that would have shipped on Sunday will ship on Monday instead. ")
    shipment: Shipment = Field(description="The shipment information used to generate the label")
    shipment_cost: Optional[MonetaryValue] = Field(default=None, description="The cost of shipping, delivery confirmation, and other carrier charges.  This amount **does not** include insurance costs. ")
    shipment_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(default=None, description="The shipment that this label is for.  ShipEngine can create a shipment for you automatically when you [create a label](https://www.shipengine.com/docs/labels/create-a-label/), or you can [create your own shipment](https://www.shipengine.com/docs/shipping/create-a-shipment/) and then [use it to print a label](https://www.shipengine.com/docs/labels/create-from-shipment/) ")
    ...
    trackable: Optional[StrictBool] = Field(default=None, description="Indicates whether the shipment is trackable, in which case the `tracking_status` field will reflect the current status and each package will have a `tracking_number`. ")
    tracking_number: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The tracking number for the package. Tracking number formats vary across carriers.")
    tracking_status: Optional[TrackingStatus] = Field(default=None, description="The current status of the package, such as `in_transit` or `delivered`")
    validate_address: Optional[ValidateAddress] = None
    voided: Optional[StrictBool] = Field(default=None, description="Indicates whether the label has been [voided](https://www.shipengine.com/docs/labels/voiding/) ")
    voided_at: Optional[datetime] = Field(default=None, description="The date and time that the label was [voided](https://www.shipengine.com/docs/labels/voiding/), or `null` if the label has not been voided ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateLabelRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateLabelRequestBody from a dict"""
        if obj is None:
            return None
