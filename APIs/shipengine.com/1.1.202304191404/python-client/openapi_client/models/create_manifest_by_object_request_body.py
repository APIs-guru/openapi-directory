...
class CreateManifestByObjectRequestBody(BaseModel):
    ...
    excluded_label_ids: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=25)]]] = Field(default=None, description="The list of label ids to exclude from the manifest")
    label_ids: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=25)]]] = Field(default=None, description="The list of label ids to include for the manifest")
    ship_date: datetime = Field(description="The ship date that the shipment will be sent out on")
    ...
    __properties: ClassVar[List[str]] = ["carrier_id", "excluded_label_ids", "label_ids", "ship_date", "warehouse_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excluded_label_ids": obj.get("excluded_label_ids"),
