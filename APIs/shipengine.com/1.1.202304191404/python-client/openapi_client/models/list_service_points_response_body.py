...
class ListServicePointsResponseBody(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[Error]] = Field(default=None, description="The errors associated with the failed API call")
    lat: Optional[Union[StrictFloat, StrictInt]] = None
    long: Optional[Union[StrictFloat, StrictInt]] = None
    service_points: Optional[List[ListServicePointsResponseBodyServicePointsInner]] = None
    __properties: ClassVar[List[str]] = ["errors", "lat", "long", "service_points"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.service_points:
            for _item_service_points in self.service_points:
                if _item_service_points:
                    _items.append(_item_service_points.to_dict())
            _dict['service_points'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lat": obj.get("lat"),
            "long": obj.get("long"),
            "service_points": [ListServicePointsResponseBodyServicePointsInner.from_dict(_item) for _item in obj["service_points"]] if obj.get("service_points") is not None else None
        })
        return _obj
