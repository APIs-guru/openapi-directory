...
class ConnectInsurerRequestBody(BaseModel):
    ...
    """ # noqa: E501
    email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="An email address.")
    policy_id: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["email", "policy_id"]
