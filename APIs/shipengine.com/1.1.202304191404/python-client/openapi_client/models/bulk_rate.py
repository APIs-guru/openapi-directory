...
class BulkRate(BaseModel):
    ...
    A bulk rate
    """ # noqa: E501
    created_at: datetime = Field(description="An [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) string that represents a date and time. ")
    errors: List[Error] = Field(description="An array of errors that were returned while retrieving the bulk rate")
    rate_request_id: Annotated[str, Field(min_length=1, strict=True, max_length=25)] = Field(description="A string that uniquely identifies the rate request")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "errors", "rate_request_id", "shipment_id", "status"]
