...
class GetServicePointsRequestBodyAddress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address_line1", "address_line2", "address_line3", "city_locality", "country_code", "postal_code", "state_province"]
