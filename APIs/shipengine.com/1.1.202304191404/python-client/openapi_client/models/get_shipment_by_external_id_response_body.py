...
class GetShipmentByExternalIdResponseBody(BaseModel):
    ...
    warehouse_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(description="The [warehouse](https://www.shipengine.com/docs/shipping/ship-from-a-warehouse/) that the shipment is being shipped from.  Either `warehouse_id` or `ship_from` must be specified. ")
    __properties: ClassVar[List[str]] = ["advanced_options", "carrier_id", "confirmation", "created_at", "customs", "external_order_id", "external_shipment_id", "insurance_provider", "is_return", "items", "modified_at", "order_source_code", "origin_type", "packages", "return_to", "service_code", "ship_date", "ship_from", "ship_to", "shipment_id", "shipment_number", "shipment_status", "tags", "tax_identifiers", "total_weight", "warehouse_id"]
