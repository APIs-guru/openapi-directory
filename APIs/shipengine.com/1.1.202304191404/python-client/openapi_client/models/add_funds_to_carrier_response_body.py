...
class AddFundsToCarrierResponseBody(BaseModel):
    ...
    """ # noqa: E501
    balance: MonetaryValue = Field(description="The current balance of the account")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balance": MonetaryValue.from_dict(obj["balance"]) if obj.get("balance") is not None else None
        })
        return _obj
