...
class TokensGetEphemeralTokenResponseBodyYaml(BaseModel):
    ...
    """ # noqa: E501
    redirect_url: Optional[StrictStr] = Field(default=None, description="The redirect url formatted with the requested token.")
    token: Optional[StrictStr] = Field(default=None, description="The requested token that expires in 10 seconds.")
    __properties: ClassVar[List[str]] = ["redirect_url", "token"]
