...
class CreateManifestLabelIdsRequestBody(BaseModel):
    ...
    """ # noqa: E501
    label_ids: List[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(description="The list of label ids to include in the manifest")
    __properties: ClassVar[List[str]] = ["label_ids"]
