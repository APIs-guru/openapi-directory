...
class GetPackageTypeByIdResponseBody(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Provides a helpful description for the custom package.")
    dimensions: Optional[Dimensions] = Field(default=None, description="The custom dimensions for the package.")
    name: Annotated[str, Field(min_length=1, strict=True)]
    package_code: Annotated[str, Field(strict=True)] = Field(description="A [package type](https://www.shipengine.com/docs/reference/list-carrier-packages/), such as `thick_envelope`, `small_flat_rate_box`, `large_package`, etc.  Use the code `package` for custom or unknown package types. ")
    package_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=25)]] = Field(default=None, description="A string that uniquely identifies the package.")
    __properties: ClassVar[List[str]] = ["description", "dimensions", "name", "package_code", "package_id"]
