...
class WebhooksApi:
    ...
    def create_webhook(
        self,
        create_webhook_request_body: CreateWebhookRequestBody,
        ...
        :param create_webhook_request_body: (required)
        :type create_webhook_request_body: CreateWebhookRequestBody
        ...
        _param = self._create_webhook_serialize(
            create_webhook_request_body=create_webhook_request_body,
    ...
    def create_webhook_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateWebhookResponseBody]:
        """Create a Webhook
    ...
    def _create_webhook_serialize(
        ...
        if create_webhook_request_body is not None:
            _body_params = create_webhook_request_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/environment/webhooks',
    ...
    def delete_webhook(
        self,
        webhook_id: Annotated[str, Field(min_length=1, strict=True, max_length=25, description="Webhook ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/environment/webhooks/{webhook_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_webhook_by_id(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetWebhookByIdResponseBody",
            '400': "ErrorResponseBody",
            '404': "ErrorResponseBody",
            '500': "ErrorResponseBody",
        }
    ...
    def get_webhook_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWebhookByIdResponseBody]:
        """Get Webhook By ID
    ...
    def update_webhook(
        self,
        webhook_id: Annotated[str, Field(min_length=1, strict=True, max_length=25, description="Webhook ID")],
        update_webhook_request_body: UpdateWebhookRequestBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhook_id: Webhook ID (required)
        :type webhook_id: str
        :param update_webhook_request_body: (required)
