...
json = "{}"
# create an instance of GetLabelByExternalShipmentIdResponseBody from a JSON string
get_label_by_external_shipment_id_response_body_instance = GetLabelByExternalShipmentIdResponseBody.from_json(json)
# print the JSON string representation of the object
print(GetLabelByExternalShipmentIdResponseBody.to_json())

# convert the object into a dict
get_label_by_external_shipment_id_response_body_dict = get_label_by_external_shipment_id_response_body_instance.to_dict()
# create an instance of GetLabelByExternalShipmentIdResponseBody from a dict
get_label_by_external_shipment_id_response_body_from_dict = GetLabelByExternalShipmentIdResponseBody.from_dict(get_label_by_external_shipment_id_response_body_dict)
```
