...
json = "{}"
# create an instance of GetShipmentByIdResponseBody from a JSON string
get_shipment_by_id_response_body_instance = GetShipmentByIdResponseBody.from_json(json)
# print the JSON string representation of the object
print(GetShipmentByIdResponseBody.to_json())

# convert the object into a dict
get_shipment_by_id_response_body_dict = get_shipment_by_id_response_body_instance.to_dict()
# create an instance of GetShipmentByIdResponseBody from a dict
get_shipment_by_id_response_body_from_dict = GetShipmentByIdResponseBody.from_dict(get_shipment_by_id_response_body_dict)
```
