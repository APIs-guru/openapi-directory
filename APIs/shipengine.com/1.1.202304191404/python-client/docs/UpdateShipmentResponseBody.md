...
**errors** | **List[str]** | An array of errors that occurred while creating shipment. | [readonly] 
...
update_shipment_response_body_instance = UpdateShipmentResponseBody.from_json(json)
# print the JSON string representation of the object
print(UpdateShipmentResponseBody.to_json())

# convert the object into a dict
update_shipment_response_body_dict = update_shipment_response_body_instance.to_dict()
# create an instance of UpdateShipmentResponseBody from a dict
update_shipment_response_body_from_dict = UpdateShipmentResponseBody.from_dict(update_shipment_response_body_dict)
```
