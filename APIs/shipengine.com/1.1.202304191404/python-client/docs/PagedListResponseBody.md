...
paged_list_response_body_instance = PagedListResponseBody.from_json(json)
# print the JSON string representation of the object
print(PagedListResponseBody.to_json())

# convert the object into a dict
paged_list_response_body_dict = paged_list_response_body_instance.to_dict()
# create an instance of PagedListResponseBody from a dict
paged_list_response_body_from_dict = PagedListResponseBody.from_dict(paged_list_response_body_dict)
```
