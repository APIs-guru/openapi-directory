...
json = "{}"
# create an instance of CreateLabelFromShipmentResponseBody from a JSON string
create_label_from_shipment_response_body_instance = CreateLabelFromShipmentResponseBody.from_json(json)
# print the JSON string representation of the object
print(CreateLabelFromShipmentResponseBody.to_json())

# convert the object into a dict
create_label_from_shipment_response_body_dict = create_label_from_shipment_response_body_instance.to_dict()
# create an instance of CreateLabelFromShipmentResponseBody from a dict
create_label_from_shipment_response_body_from_dict = CreateLabelFromShipmentResponseBody.from_dict(create_label_from_shipment_response_body_dict)
```
