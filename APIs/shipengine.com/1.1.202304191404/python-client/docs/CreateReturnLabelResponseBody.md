...
create_return_label_response_body_instance = CreateReturnLabelResponseBody.from_json(json)
# print the JSON string representation of the object
print(CreateReturnLabelResponseBody.to_json())

# convert the object into a dict
create_return_label_response_body_dict = create_return_label_response_body_instance.to_dict()
# create an instance of CreateReturnLabelResponseBody from a dict
create_return_label_response_body_from_dict = CreateReturnLabelResponseBody.from_dict(create_return_label_response_body_dict)
```
