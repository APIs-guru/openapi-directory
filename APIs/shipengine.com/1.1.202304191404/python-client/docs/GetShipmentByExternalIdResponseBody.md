...
**carrier_id** | **str** | The carrier account that is billed for the shipping charges | 
...
**return_to** | [**ShippingAddress**](ShippingAddress.md) | The return address for this shipment.  Defaults to the &#x60;ship_from&#x60; address.  | 
**service_code** | **str** | The [carrier service](https://www.shipengine.com/docs/shipping/use-a-carrier-service/) used to ship the package, such as &#x60;fedex_ground&#x60;, &#x60;usps_first_class_mail&#x60;, &#x60;flat_rate_envelope&#x60;, etc.  | 
...
**tags** | [**List[Tag]**](Tag.md) | Arbitrary tags associated with this shipment.  Tags can be used to categorize shipments, and shipments can be queried by their tags.  | [readonly] [default to []]
...
**warehouse_id** | **str** | The [warehouse](https://www.shipengine.com/docs/shipping/ship-from-a-warehouse/) that the shipment is being shipped from.  Either &#x60;warehouse_id&#x60; or &#x60;ship_from&#x60; must be specified.  | 
...
json = "{}"
# create an instance of GetShipmentByExternalIdResponseBody from a JSON string
get_shipment_by_external_id_response_body_instance = GetShipmentByExternalIdResponseBody.from_json(json)
# print the JSON string representation of the object
print(GetShipmentByExternalIdResponseBody.to_json())

# convert the object into a dict
get_shipment_by_external_id_response_body_dict = get_shipment_by_external_id_response_body_instance.to_dict()
# create an instance of GetShipmentByExternalIdResponseBody from a dict
get_shipment_by_external_id_response_body_from_dict = GetShipmentByExternalIdResponseBody.from_dict(get_shipment_by_external_id_response_body_dict)
```
