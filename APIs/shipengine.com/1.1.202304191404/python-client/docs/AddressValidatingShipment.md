...
address_validating_shipment_instance = AddressValidatingShipment.from_json(json)
# print the JSON string representation of the object
print(AddressValidatingShipment.to_json())

# convert the object into a dict
address_validating_shipment_dict = address_validating_shipment_instance.to_dict()
# create an instance of AddressValidatingShipment from a dict
address_validating_shipment_from_dict = AddressValidatingShipment.from_dict(address_validating_shipment_dict)
```
