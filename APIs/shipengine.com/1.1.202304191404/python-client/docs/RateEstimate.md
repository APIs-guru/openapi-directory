...
rate_estimate_instance = RateEstimate.from_json(json)
# print the JSON string representation of the object
print(RateEstimate.to_json())

# convert the object into a dict
rate_estimate_dict = rate_estimate_instance.to_dict()
# create an instance of RateEstimate from a dict
rate_estimate_from_dict = RateEstimate.from_dict(rate_estimate_dict)
```
