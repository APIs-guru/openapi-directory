...
calculate_rates_response_body_instance = CalculateRatesResponseBody.from_json(json)
# print the JSON string representation of the object
print(CalculateRatesResponseBody.to_json())

# convert the object into a dict
calculate_rates_response_body_dict = calculate_rates_response_body_instance.to_dict()
# create an instance of CalculateRatesResponseBody from a dict
calculate_rates_response_body_from_dict = CalculateRatesResponseBody.from_dict(calculate_rates_response_body_dict)
```
