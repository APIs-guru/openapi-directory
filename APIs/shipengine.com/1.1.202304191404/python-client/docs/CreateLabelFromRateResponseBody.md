...
create_label_from_rate_response_body_instance = CreateLabelFromRateResponseBody.from_json(json)
# print the JSON string representation of the object
print(CreateLabelFromRateResponseBody.to_json())

# convert the object into a dict
create_label_from_rate_response_body_dict = create_label_from_rate_response_body_instance.to_dict()
# create an instance of CreateLabelFromRateResponseBody from a dict
create_label_from_rate_response_body_from_dict = CreateLabelFromRateResponseBody.from_dict(create_label_from_rate_response_body_dict)
```
