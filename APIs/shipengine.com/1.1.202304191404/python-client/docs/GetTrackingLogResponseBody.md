...
**carrier_code** | **str** | A [shipping carrier](https://www.shipengine.com/docs/carriers/setup/), such as &#x60;fedex&#x60;, &#x60;dhl_express&#x60;, &#x60;stamps_com&#x60;, etc.  | 
**carrier_detail_code** | **str** | Carrier detail code | [readonly] 
**carrier_id** | **str** | A string that uniquely identifies a ShipEngine resource, such as a carrier, label, shipment, etc. | 
...
**tracking_url** | **str** | Carrier Tracking Url, if available | [readonly] 
...
json = "{}"
# create an instance of GetTrackingLogResponseBody from a JSON string
get_tracking_log_response_body_instance = GetTrackingLogResponseBody.from_json(json)
# print the JSON string representation of the object
print(GetTrackingLogResponseBody.to_json())

# convert the object into a dict
get_tracking_log_response_body_dict = get_tracking_log_response_body_instance.to_dict()
# create an instance of GetTrackingLogResponseBody from a dict
get_tracking_log_response_body_from_dict = GetTrackingLogResponseBody.from_dict(get_tracking_log_response_body_dict)
```
