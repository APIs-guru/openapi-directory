...
json = "{}"
# create an instance of CreatePackageTypeResponseBody from a JSON string
create_package_type_response_body_instance = CreatePackageTypeResponseBody.from_json(json)
# print the JSON string representation of the object
print(CreatePackageTypeResponseBody.to_json())

# convert the object into a dict
create_package_type_response_body_dict = create_package_type_response_body_instance.to_dict()
# create an instance of CreatePackageTypeResponseBody from a dict
create_package_type_response_body_from_dict = CreatePackageTypeResponseBody.from_dict(create_package_type_response_body_dict)
```
