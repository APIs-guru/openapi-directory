...
json = "{}"
# create an instance of PartialShipment from a JSON string
partial_shipment_instance = PartialShipment.from_json(json)
# print the JSON string representation of the object
print(PartialShipment.to_json())

# convert the object into a dict
partial_shipment_dict = partial_shipment_instance.to_dict()
# create an instance of PartialShipment from a dict
partial_shipment_from_dict = PartialShipment.from_dict(partial_shipment_dict)
```
