...
get_label_by_id_response_body_instance = GetLabelByIdResponseBody.from_json(json)
# print the JSON string representation of the object
print(GetLabelByIdResponseBody.to_json())

# convert the object into a dict
get_label_by_id_response_body_dict = get_label_by_id_response_body_instance.to_dict()
# create an instance of GetLabelByIdResponseBody from a dict
get_label_by_id_response_body_from_dict = GetLabelByIdResponseBody.from_dict(get_label_by_id_response_body_dict)
```
