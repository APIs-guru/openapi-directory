...
class TestUpsSettingsResponseBody(unittest.TestCase):
    """UpsSettingsResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsSettingsResponseBody:
        """Test UpsSettingsResponseBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsSettingsResponseBody`
        """
        model = UpsSettingsResponseBody()
        if include_optional:
            return UpsSettingsResponseBody(
                account_postal_code = '01234',
    ...
    def testUpsSettingsResponseBody(self):
        """Test UpsSettingsResponseBody"""
