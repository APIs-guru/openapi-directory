...
class TestUpdateCarrierSettingsRequestBody(unittest.TestCase):
    """UpdateCarrierSettingsRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCarrierSettingsRequestBody:
        """Test UpdateCarrierSettingsRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCarrierSettingsRequestBody`
        """
        model = UpdateCarrierSettingsRequestBody()
        if include_optional:
    ...
    def testUpdateCarrierSettingsRequestBody(self):
        """Test UpdateCarrierSettingsRequestBody"""
