...
class TestGetCarrierSettingsResponseBody(unittest.TestCase):
    """GetCarrierSettingsResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCarrierSettingsResponseBody:
        """Test GetCarrierSettingsResponseBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCarrierSettingsResponseBody`
        """
        model = GetCarrierSettingsResponseBody()
        if include_optional:
    ...
    def testGetCarrierSettingsResponseBody(self):
        """Test GetCarrierSettingsResponseBody"""
