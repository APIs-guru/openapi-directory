...
class TestGetCarrierByIdResponseBody(unittest.TestCase):
    """GetCarrierByIdResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCarrierByIdResponseBody:
        """Test GetCarrierByIdResponseBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCarrierByIdResponseBody`
        """
        model = GetCarrierByIdResponseBody()
        if include_optional:
    ...
    def testGetCarrierByIdResponseBody(self):
        """Test GetCarrierByIdResponseBody"""
