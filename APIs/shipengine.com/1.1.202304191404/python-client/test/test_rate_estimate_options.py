...
class TestRateEstimateOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RateEstimateOptions:
        """Test RateEstimateOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateEstimateOptions`
        """
        model = RateEstimateOptions()
        if include_optional:
    ...
    def testRateEstimateOptions(self):
        """Test RateEstimateOptions"""
