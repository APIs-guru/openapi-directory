...
class TestUpdateUpsSettingsRequestBody(unittest.TestCase):
    """UpdateUpsSettingsRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUpsSettingsRequestBody:
        """Test UpdateUpsSettingsRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateUpsSettingsRequestBody`
        """
        model = UpdateUpsSettingsRequestBody()
        if include_optional:
    ...
    def testUpdateUpsSettingsRequestBody(self):
        """Test UpdateUpsSettingsRequestBody"""
