...
class TestCreateAccountSettingsImageRequestBody(unittest.TestCase):
    """CreateAccountSettingsImageRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAccountSettingsImageRequestBody:
        """Test CreateAccountSettingsImageRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAccountSettingsImageRequestBody`
        """
        model = CreateAccountSettingsImageRequestBody()
        if include_optional:
            return CreateAccountSettingsImageRequestBody(
    ...
    def testCreateAccountSettingsImageRequestBody(self):
        """Test CreateAccountSettingsImageRequestBody"""
