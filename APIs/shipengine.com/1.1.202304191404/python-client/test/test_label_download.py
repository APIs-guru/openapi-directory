...
class TestLabelDownload(unittest.TestCase):
    """LabelDownload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelDownload:
        """Test LabelDownload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelDownload`
        """
        model = LabelDownload()
        if include_optional:
