...
class TestInsuranceApi(unittest.TestCase):
    ...
    def test_add_funds_to_insurance(self) -> None:
    ...
    def test_connect_insurer(self) -> None:
    ...
    def test_disconnect_insurer(self) -> None:
    ...
    def test_get_insurance_balance(self) -> None:
