...
class TestEstimateRatesRequestBody(unittest.TestCase):
    """EstimateRatesRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateRatesRequestBody:
        """Test EstimateRatesRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateRatesRequestBody`
        """
        model = EstimateRatesRequestBody()
        if include_optional:
    ...
    def testEstimateRatesRequestBody(self):
        """Test EstimateRatesRequestBody"""
