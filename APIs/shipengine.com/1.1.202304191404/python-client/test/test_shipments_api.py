...
class TestShipmentsApi(unittest.TestCase):
    ...
    def test_cancel_shipments(self) -> None:
    ...
    def test_get_shipment_by_external_id(self) -> None:
    ...
    def test_get_shipment_by_id(self) -> None:
    ...
    def test_list_shipment_rates(self) -> None:
    ...
    def test_parse_shipment(self) -> None:
    ...
    def test_tag_shipment(self) -> None:
    ...
    def test_untag_shipment(self) -> None:
