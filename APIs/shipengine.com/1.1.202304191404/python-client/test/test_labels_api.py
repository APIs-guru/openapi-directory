...
class TestLabelsApi(unittest.TestCase):
    ...
    def test_create_label_from_rate(self) -> None:
    ...
    def test_get_label_by_external_shipment_id(self) -> None:
    ...
    def test_get_tracking_log_from_label(self) -> None:
