...
class ApiV2ListFederationsGet404Response(BaseModel):
    """
    ApiV2ListFederationsGet404Response
    """ # noqa: E501
    errors: Optional[List[ApiV2ListFederationsGet404ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ApiV2ListFederationsGet404ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
