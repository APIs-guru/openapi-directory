...
class ApiV2PerformanceStatsGet200ResponseDataDetailsLast14Days(BaseModel):
    """
    ApiV2PerformanceStatsGet200ResponseDataDetailsLast14Days
    """ # noqa: E501
    lost: Optional[StrictInt] = None
    pending: Optional[StrictInt] = None
    postponed: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    won: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["lost", "pending", "postponed", "total", "won"]
