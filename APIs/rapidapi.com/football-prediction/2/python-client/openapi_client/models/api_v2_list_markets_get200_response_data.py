...
class ApiV2ListMarketsGet200ResponseData(BaseModel):
    """
    ApiV2ListMarketsGet200ResponseData
    """ # noqa: E501
    all: Optional[List[StrictStr]] = None
    allowed_for_your_subscription: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["all", "allowed_for_your_subscription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all": obj.get("all"),
            "allowed_for_your_subscription": obj.get("allowed_for_your_subscription")
        })
        return _obj
