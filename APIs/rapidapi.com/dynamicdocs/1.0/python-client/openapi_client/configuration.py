...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://dynamicdocs.p.rapidapi.com" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'Adv-Security-Token' in self.api_key:
            auth['Adv-Security-Token'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'ADVICEment API Key',
                'value': self.get_api_key_with_prefix(
                    'Adv-Security-Token',
                ),
            }
        if 'X-RapidAPI-Key' in self.api_key:
            auth['X-RapidAPI-Key'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'RapidAPI.com API Key',
                'value': self.get_api_key_with_prefix(
                    'X-RapidAPI-Key',
                ),
            }
