...
class TestProperties3(unittest.TestCase):
    """Properties3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Properties3:
        """Test Properties3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Properties3`
        """
        model = Properties3()
        if include_optional:
            return Properties3(
