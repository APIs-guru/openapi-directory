...
class TestFetchAdministrativeRegionsusingLatLng(unittest.TestCase):
    """FetchAdministrativeRegionsusingLatLng unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchAdministrativeRegionsusingLatLng:
        """Test FetchAdministrativeRegionsusingLatLng
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchAdministrativeRegionsusingLatLng`
        """
        model = FetchAdministrativeRegionsusingLatLng()
        if include_optional:
            return FetchAdministrativeRegionsusingLatLng(
                data = [
                    openapi_client.models.data2.Data2(
    ...
    def testFetchAdministrativeRegionsusingLatLng(self):
        """Test FetchAdministrativeRegionsusingLatLng"""
