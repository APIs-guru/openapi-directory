...
class TestRoadsegment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Roadsegment:
        """Test Roadsegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Roadsegment`
        """
        model = Roadsegment()
        if include_optional:
            return Roadsegment(
