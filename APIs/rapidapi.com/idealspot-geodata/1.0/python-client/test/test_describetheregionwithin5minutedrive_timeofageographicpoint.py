...
class TestDescribetheregionwithin5minutedriveTimeofageographicpoint(unittest.TestCase):
    """Describetheregionwithin5minutedriveTimeofageographicpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Describetheregionwithin5minutedriveTimeofageographicpoint:
        """Test Describetheregionwithin5minutedriveTimeofageographicpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Describetheregionwithin5minutedriveTimeofageographicpoint`
        """
        model = Describetheregionwithin5minutedriveTimeofageographicpoint()
        if include_optional:
            return Describetheregionwithin5minutedriveTimeofageographicpoint(
                data = openapi_client.models.data3.Data3(
                    features = [
                        openapi_client.models.feature.Feature(
                            geometry = openapi_client.models.geometry.Geometry(
                                ...
                                type = '', ), 
                            properties = {"calculated_area_sq_meters":2.744705707613631E7,"location":{"areatype":"drivetime","latitude":30.264757,"longitude":-97.7356077,"radius":"5","type":"buffer","units":"minutes"},"status":200}, 
                            type = '', )
                        ], 
                    type = '', )
            )
    ...
    def testDescribetheregionwithin5minutedriveTimeofageographicpoint(self):
        """Test Describetheregionwithin5minutedriveTimeofageographicpoint"""
