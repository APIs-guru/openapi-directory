...
class TestProperties2(unittest.TestCase):
    """Properties2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Properties2:
        """Test Properties2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Properties2`
        """
        model = Properties2()
        if include_optional:
            return Properties2(
                calculated_area_sq_meters = 1.337,
                location = {"areatype":"drivetime","latitude":30.264757,"longitude":-97.7356077,"radius":"5","type":"buffer","units":"minutes"},
                status = 56
            )
        else:
            return Properties2(
