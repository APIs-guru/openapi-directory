...
class TestListAllLocalInsights(unittest.TestCase):
    """ListAllLocalInsights unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAllLocalInsights:
        """Test ListAllLocalInsights
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAllLocalInsights`
        """
        model = ListAllLocalInsights()
        if include_optional:
            return ListAllLocalInsights(
                data = [
                    {"description":"Median age and age brackets by gender.","id":"age","name":"Age","version":"v2"}
                    ]
            )
        else:
            return ListAllLocalInsights(
    ...
    def testListAllLocalInsights(self):
        """Test ListAllLocalInsights"""
