...
class TestTrafficCountAPIApi(unittest.TestCase):
    """TrafficCountAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TrafficCountAPIApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_nearest_road_segments(self) -> None:
    ...
    def test_vehicle_traffic_countsfor_road_segment(self) -> None:
