...
class TestLocationArray(unittest.TestCase):
    """LocationArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationArray:
        """Test LocationArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationArray`
        """
        model = LocationArray()
        if include_optional:
