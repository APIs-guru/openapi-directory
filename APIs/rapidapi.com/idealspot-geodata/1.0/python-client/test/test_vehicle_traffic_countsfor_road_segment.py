...
class TestVehicleTrafficCountsforRoadSegment(unittest.TestCase):
    """VehicleTrafficCountsforRoadSegment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VehicleTrafficCountsforRoadSegment:
        """Test VehicleTrafficCountsforRoadSegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehicleTrafficCountsforRoadSegment`
        """
        model = VehicleTrafficCountsforRoadSegment()
        if include_optional:
            return VehicleTrafficCountsforRoadSegment(
                data = [
                    {"data":[[81,56,35,26,28,48,86,130,182,240,292,334,360,360,357,353,339,307,266,222,188,158,125,102],[34,35,30,33,55,153,371,494,402,327,336,369,390,386,402,423,419,379,303,243,200,163,118,69],[34,35,30,33,55,153,371,494,402,327,336,369,390,386,402,423,419,379,303,243,200,163,118,69],[34,35,30,33,55,153,371,494,402,327,336,369,390,386,402,423,419,379,303,243,200,163,118,69],[34,35,30,33,55,153,371,494,402,327,336,369,390,386,402,423,419,379,303,243,200,163,118,69],[37,37,32,35,59,160,388,518,421,343,352,387,409,406,422,443,439,396,318,255,210,171,122,73],[91,62,40,28,31,55,98,146,204,271,330,377,404,404,404,398,381,346,298,250,212,178,141,114]],"metadata":{"bearing":"W","columns":["12:00am","01:00am","02:00am","03:00am","04:00am","05:00am","06:00am","07:00am","08:00am","09:00am","10:00am","11:00am","12:00pm","01:00pm","02:00pm","03:00pm","04:00pm","05:00pm","06:00pm","07:00pm","08:00pm","09:00pm","10:00pm","11:00pm"],"name":"East 6th Street","rows":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"segment_id":"1595369397","state":"Texas"},"roadsegment":{"coordinates":[[-97.734165,30.265642000000014],[-97.734314,30.265693999999996],[-97.734409,30.265727999999996],[-97.7345332,30.265769000000006],[-97.7346688,30.265802199999996],[-97.7349238,30.2658816],[-97.7350156,30.265904199999994]],"type":"LineString"},"stats":{"aadt":5843}}
                    ]
            )
        else:
            return VehicleTrafficCountsforRoadSegment(
    ...
    def testVehicleTrafficCountsforRoadSegment(self):
        """Test VehicleTrafficCountsforRoadSegment"""
