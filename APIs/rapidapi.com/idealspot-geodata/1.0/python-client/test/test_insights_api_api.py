...
class TestInsightsAPIApi(unittest.TestCase):
    """InsightsAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InsightsAPIApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_available_insights(self) -> None:
    ...
    def test_fetch_insight_query_parameters(self) -> None:
    ...
    def test_query_insightat_location(self) -> None:
