...
class TestFeature1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Feature1:
        """Test Feature1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Feature1`
        """
        model = Feature1()
        if include_optional:
            return Feature1(
                geometry = openapi_client.models.geometry.Geometry(
                    ...
                    type = '', ),
                properties = {"bearing":"N","roadname":"North Interstate Highway 35 Service Road","segment_id":"1595171804","state":"Texas"},
                type = ''
            )
        else:
            return Feature1(
