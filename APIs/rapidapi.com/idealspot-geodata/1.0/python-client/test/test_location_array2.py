...
class TestLocationArray2(unittest.TestCase):
    """LocationArray2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationArray2:
        """Test LocationArray2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationArray2`
        """
        model = LocationArray2()
        if include_optional:
