...
class TestGeometriesAPIApi(unittest.TestCase):
    """GeometriesAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GeometriesAPIApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_administrative_regionsusing_lat_lng(self) -> None:
    ...
    def test_fetch_geometries(self) -> None:
