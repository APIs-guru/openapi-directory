...
class TestProperties4(unittest.TestCase):
    """Properties4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Properties4:
        """Test Properties4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Properties4`
        """
        model = Properties4()
        if include_optional:
            return Properties4(
