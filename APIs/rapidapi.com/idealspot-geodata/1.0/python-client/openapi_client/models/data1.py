...
class Data1(BaseModel):
    ...
    Data1
    """ # noqa: E501
    data: List[List[StrictStr]]
    location: Location1
    location_index: StrictInt
    metadata: Metadata
    __properties: ClassVar[List[str]] = ["data", "location", "location_index", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location_index": obj.get("location_index"),
