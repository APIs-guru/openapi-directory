...
class Properties(BaseModel):
    ...
    Properties
    """ # noqa: E501
    properties: Properties1 = Field(alias="_properties")
    altname: StrictStr
    autocomplete: Autocomplete
    calculated_area_sq_meters: Union[StrictFloat, StrictInt]
    name: StrictStr
    region_id: StrictStr
    regiontype: StrictStr
    state_code: StrictStr
    timestamp: StrictStr
    __properties: ClassVar[List[str]] = ["_properties", "altname", "autocomplete", "calculated_area_sq_meters", "name", "region_id", "regiontype", "state_code", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.properties:
            _dict['_properties'] = self.properties.to_dict()
        # override the default output from pydantic by calling `to_dict()` of autocomplete
        if self.autocomplete:
            _dict['autocomplete'] = self.autocomplete.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_properties": Properties1.from_dict(obj["_properties"]) if obj.get("_properties") is not None else None,
            "altname": obj.get("altname"),
            "autocomplete": Autocomplete.from_dict(obj["autocomplete"]) if obj.get("autocomplete") is not None else None,
            "calculated_area_sq_meters": obj.get("calculated_area_sq_meters"),
            "name": obj.get("name"),
