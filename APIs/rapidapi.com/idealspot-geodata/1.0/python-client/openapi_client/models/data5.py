...
class Data5(BaseModel):
    ...
    Data5
    """ # noqa: E501
    data: List[List[StrictInt]]
    metadata: Metadata1
    roadsegment: Roadsegment
    stats: Stats
    __properties: ClassVar[List[str]] = ["data", "metadata", "roadsegment", "stats"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of roadsegment
        if self.roadsegment:
            _dict['roadsegment'] = self.roadsegment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "metadata": Metadata1.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "roadsegment": Roadsegment.from_dict(obj["roadsegment"]) if obj.get("roadsegment") is not None else None,
