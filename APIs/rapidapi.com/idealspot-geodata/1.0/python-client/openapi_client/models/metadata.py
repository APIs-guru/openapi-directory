...
class Metadata(BaseModel):
    ...
    Metadata
    """ # noqa: E501
    datetime: List[List[StrictStr]]
    display_groups: List[List[StrictStr]]
    units: Units
    __properties: ClassVar[List[str]] = ["datetime", "display_groups", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "display_groups": obj.get("display_groups"),
