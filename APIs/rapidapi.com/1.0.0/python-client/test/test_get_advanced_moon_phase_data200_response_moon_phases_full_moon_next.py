...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext"""
