...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext"""
