...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter"""
