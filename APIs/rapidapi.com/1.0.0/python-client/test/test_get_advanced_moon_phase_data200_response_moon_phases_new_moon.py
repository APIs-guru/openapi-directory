...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon"""
