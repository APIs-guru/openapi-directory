...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter"""
