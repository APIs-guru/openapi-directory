...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon"""
