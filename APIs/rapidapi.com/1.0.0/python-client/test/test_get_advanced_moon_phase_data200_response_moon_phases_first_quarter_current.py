...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent"""
