...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent"""
