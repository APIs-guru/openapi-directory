...
class TestGetAdvancedMoonPhaseData200ResponseSun(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseSun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseSun:
        """Test GetAdvancedMoonPhaseData200ResponseSun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseSun`
        """
        model = GetAdvancedMoonPhaseData200ResponseSun()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseSun(
                day_length = '978',
                solar_noon = '777',
    ...
    def testGetAdvancedMoonPhaseData200ResponseSun(self):
        """Test GetAdvancedMoonPhaseData200ResponseSun"""
