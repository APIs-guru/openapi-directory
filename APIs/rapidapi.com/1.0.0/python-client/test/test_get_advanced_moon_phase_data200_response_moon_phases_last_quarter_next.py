...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext"""
