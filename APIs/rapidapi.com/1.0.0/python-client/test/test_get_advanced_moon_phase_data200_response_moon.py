...
class TestGetAdvancedMoonPhaseData200ResponseMoon(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoon:
        """Test GetAdvancedMoonPhaseData200ResponseMoon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoon`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoon()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoon(
                age_days = 12,
                emoji = '🌔',
                illumination = '88%',
                lunar_cycle = '38.97%',
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoon(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoon"""
