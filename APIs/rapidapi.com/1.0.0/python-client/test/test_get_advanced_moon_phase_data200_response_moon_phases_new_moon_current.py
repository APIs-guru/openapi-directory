...
class TestGetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent(unittest.TestCase):
    """GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent:
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent`
        """
        model = GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent()
        if include_optional:
            return GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent(
    ...
    def testGetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent(self):
        """Test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent"""
