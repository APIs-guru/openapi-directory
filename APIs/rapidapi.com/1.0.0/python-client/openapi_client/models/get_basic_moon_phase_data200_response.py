...
class GetBasicMoonPhaseData200Response(BaseModel):
    """
    GetBasicMoonPhaseData200Response
    """ # noqa: E501
    days_until_next_full_moon: Optional[Union[StrictFloat, StrictInt]] = None
    days_until_next_new_moon: Optional[Union[StrictFloat, StrictInt]] = None
    phase_name: Optional[StrictStr] = None
    stage: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["days_until_next_full_moon", "days_until_next_new_moon", "phase_name", "stage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days_until_next_full_moon": obj.get("days_until_next_full_moon"),
            "days_until_next_new_moon": obj.get("days_until_next_new_moon"),
