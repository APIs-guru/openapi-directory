...
class GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent(BaseModel):
    """
    GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent
    """ # noqa: E501
    datestamp: Optional[StrictStr] = None
    days_ago: Optional[Union[StrictFloat, StrictInt]] = None
    timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["datestamp", "days_ago", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent from a dict"""
        if obj is None:
            return None
