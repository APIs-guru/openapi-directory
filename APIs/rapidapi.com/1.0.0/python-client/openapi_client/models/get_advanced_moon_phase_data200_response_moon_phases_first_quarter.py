...
class GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter(BaseModel):
    """
    GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter
    """ # noqa: E501
    current: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent] = None
    next: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "next": GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext.from_dict(obj["next"]) if obj.get("next") is not None else None
        })
        return _obj
