...
class GetAdvancedMoonPhaseData200ResponseSun(BaseModel):
    """
    ...
    sunrise_timestamp: Optional[StrictStr] = None
    sunset: Optional[Union[StrictFloat, StrictInt]] = None
    sunset_timestamp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["day_length", "solar_noon", "sun_altitude", "sun_azimuth", "sun_distance", "sunrise", "sunrise_timestamp", "sunset", "sunset_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sunrise_timestamp": obj.get("sunrise_timestamp"),
            "sunset": obj.get("sunset"),
            "sunset_timestamp": obj.get("sunset_timestamp")
        })
        return _obj
