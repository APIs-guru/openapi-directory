...
class GetAdvancedMoonPhaseData200Response(BaseModel):
    """
    GetAdvancedMoonPhaseData200Response
    """ # noqa: E501
    datestamp: Optional[StrictStr] = None
    moon: Optional[GetAdvancedMoonPhaseData200ResponseMoon] = None
    moon_phases: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhases] = None
    sun: Optional[GetAdvancedMoonPhaseData200ResponseSun] = None
    timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["datestamp", "moon", "moon_phases", "sun", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of moon_phases
        if self.moon_phases:
            _dict['moon_phases'] = self.moon_phases.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "moon": GetAdvancedMoonPhaseData200ResponseMoon.from_dict(obj["moon"]) if obj.get("moon") is not None else None,
            "moon_phases": GetAdvancedMoonPhaseData200ResponseMoonPhases.from_dict(obj["moon_phases"]) if obj.get("moon_phases") is not None else None,
            "sun": GetAdvancedMoonPhaseData200ResponseSun.from_dict(obj["sun"]) if obj.get("sun") is not None else None,
