...
class GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon(BaseModel):
    """
    GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon
    """ # noqa: E501
    current: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent] = None
    next: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "next": GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext.from_dict(obj["next"]) if obj.get("next") is not None else None
        })
        return _obj
