...
class GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter(BaseModel):
    """
    GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter
    """ # noqa: E501
    current: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent] = None
    next: Optional[GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "next": GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext.from_dict(obj["next"]) if obj.get("next") is not None else None
        })
        return _obj
