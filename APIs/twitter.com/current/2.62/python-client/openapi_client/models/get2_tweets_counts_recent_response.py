...
class Get2TweetsCountsRecentResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SearchCount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "errors": [Problem.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "meta": Get2TweetsCountsAllResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
