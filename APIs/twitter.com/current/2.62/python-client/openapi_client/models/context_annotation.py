...
class ContextAnnotation(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domain": ContextAnnotationDomainFields.from_dict(obj["domain"]) if obj.get("domain") is not None else None,
            "entity": ContextAnnotationEntityFields.from_dict(obj["entity"]) if obj.get("entity") is not None else None
        })
        return _obj
