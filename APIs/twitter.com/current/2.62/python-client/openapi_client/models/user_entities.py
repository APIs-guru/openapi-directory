...
class UserEntities(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "description": FullTextEntities.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "url": UserEntitiesUrl.from_dict(obj["url"]) if obj.get("url") is not None else None
        })
        return _obj
