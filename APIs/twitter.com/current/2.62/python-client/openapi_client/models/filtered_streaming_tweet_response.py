...
class FilteredStreamingTweetResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matching_rules": [FilteredStreamingTweetResponseMatchingRulesInner.from_dict(_item) for _item in obj["matching_rules"]] if obj.get("matching_rules") is not None else None
        })
        return _obj
