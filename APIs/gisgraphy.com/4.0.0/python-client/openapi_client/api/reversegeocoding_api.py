...
class ReversegeocodingApi:
    ...
    def reversegeocode(
        ...
        _param = self._reversegeocode_serialize(
            lat=lat,
            lng=lng,
            format=format,
            var_from=var_from,
    ...
    @validate_call
    def reversegeocode_with_http_info(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="The latitude (north-south) for the location point to search around. The value is a floating number, between -90 and +90. It uses GPS coordinates")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="TThe longitude (east-West) for the location point to search around. The value is a floating number between -180 and +180. It uses GPS coordinates.")],
        format: Annotated[Optional[StrictStr], Field(description="The output format.")] = None,
    ...
    @validate_call
    def reversegeocode_without_preload_content(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="The latitude (north-south) for the location point to search around. The value is a floating number, between -90 and +90. It uses GPS coordinates")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="TThe longitude (east-West) for the location point to search around. The value is a floating number between -180 and +180. It uses GPS coordinates.")],
        format: Annotated[Optional[StrictStr], Field(description="The output format.")] = None,
    ...
    def _reversegeocode_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reversegeocoding/reversegeocode',
