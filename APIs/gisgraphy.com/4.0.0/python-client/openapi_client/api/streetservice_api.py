...
class StreetserviceApi:
    ...
    def streetsearch(
        ...
        oneway: Annotated[Optional[StrictBool], Field(description="whether the street should be a oneWay street (optional) : limit the search to the street that are one way street. If you use a checkbox in a form to indent the results, the value will be 'on' or 'off', so to simplify the use : the value for the web service can be 'true' or 'on'")] = None,
        ...
        streettype: Annotated[Optional[StrictStr], Field(description="filter search with a stret type")] = None,
        ...
        indent: Annotated[Optional[StrictBool], Field(description="indents the results. Possible values are true or false (or on when used with the rest service. If you use a checkbox in a web form, to indent the results, the value will be 'on' or 'off', so for a simple use : the value of indent can be 'true' or 'on'")] = None,
        ...
        _param = self._streetsearch_serialize(
            lat=lat,
            lng=lng,
            radius=radius,
            oneway=oneway,
    ...
    @validate_call
    def streetsearch_with_http_info(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="The latitude (north-south) for the location point to search around. The value is a floating number, between -90 and +90. It uses GPS coordinates")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="TThe longitude (east-West) for the location point to search around. The value is a floating number between -180 and +180. It uses GPS coordinates.")],
        radius: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="distance from the location point in meters we'd like to search around. The value is a number > 0 if it is not specify or incorrect.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StreetSearchResultsDto]:
        """Geocode an address
    ...
    @validate_call
    def streetsearch_without_preload_content(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="The latitude (north-south) for the location point to search around. The value is a floating number, between -90 and +90. It uses GPS coordinates")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="TThe longitude (east-West) for the location point to search around. The value is a floating number between -180 and +180. It uses GPS coordinates.")],
        radius: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="distance from the location point in meters we'd like to search around. The value is a number > 0 if it is not specify or incorrect.")] = None,
    ...
    def _streetsearch_serialize(
        ...
        if oneway is not None:
            ...
            _query_params.append(('oneway', oneway))
        ...
        if streettype is not None:
            ...
            _query_params.append(('streettype', streettype))
