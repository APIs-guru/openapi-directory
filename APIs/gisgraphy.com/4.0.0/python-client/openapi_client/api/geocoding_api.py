...
class GeocodingApi:
    ...
    def geocode(
        self,
        address: Annotated[StrictStr, Field(description="A postal address, structured or not, a street, a city, a postal code, a country, or a combination.")],
        country: Annotated[Optional[StrictStr], Field(description="The country where the place/address is. It is used to determine the postal address format and to improve performance. It will probably be optional in next version to ease the usability. The value must be the ISO 3166 Alpha 2 code of the country.")] = None,
        postal: Annotated[Optional[StrictStr], Field(description="Whether the given address is a postal address. default to false. In other words, if the address follow the specification or if it is a well-formed address as it was written on an envelope. This parameter will enable the parsing of the address by the address parser before geocoding, this way, the relevance will be better because because if parsing is successful, we will know the meaning of each word. Note that you can also specify each field if you already know them.")] = None,
    ...
    def _geocode_serialize(
        ...
        if postal is not None:
            ...
            _query_params.append(('postal', postal))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/geocoding/geocode',
