...
class TestAddressparserStandardizerApi(unittest.TestCase):
    """AddressparserStandardizerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AddressparserStandardizerApi()

    def tearDown(self) -> None:
        pass

    def test_addressparsing(self) -> None:
