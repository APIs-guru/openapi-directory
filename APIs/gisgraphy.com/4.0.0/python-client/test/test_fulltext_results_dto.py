...
class TestFulltextResultsDto(unittest.TestCase):
    """FulltextResultsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FulltextResultsDto:
        """Test FulltextResultsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FulltextResultsDto`
        """
        model = FulltextResultsDto()
        if include_optional:
            return FulltextResultsDto(
                ...
                num_found = 56,
                result = [
                    openapi_client.models.solr_response_dto.SolrResponseDto(
                        adm1_code = '', 
                        adm1_name = '', 
    ...
    def testFulltextResultsDto(self):
        """Test FulltextResultsDto"""
