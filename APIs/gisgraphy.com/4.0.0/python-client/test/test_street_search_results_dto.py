...
class TestStreetSearchResultsDto(unittest.TestCase):
    """StreetSearchResultsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreetSearchResultsDto:
        """Test StreetSearchResultsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreetSearchResultsDto`
        """
        model = StreetSearchResultsDto()
        if include_optional:
            return StreetSearchResultsDto(
                ...
                num_found = 56,
                result = [
                    openapi_client.models.street_distance.StreetDistance(
                        country_code = '', 
                        distance = 1.337, 
    ...
    def testStreetSearchResultsDto(self):
        """Test StreetSearchResultsDto"""
