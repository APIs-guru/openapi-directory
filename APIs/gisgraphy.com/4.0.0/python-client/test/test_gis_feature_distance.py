...
class TestGisFeatureDistance(unittest.TestCase):
    """GisFeatureDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GisFeatureDistance:
        """Test GisFeatureDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GisFeatureDistance`
        """
        model = GisFeatureDistance()
        if include_optional:
    ...
    def testGisFeatureDistance(self):
        """Test GisFeatureDistance"""
