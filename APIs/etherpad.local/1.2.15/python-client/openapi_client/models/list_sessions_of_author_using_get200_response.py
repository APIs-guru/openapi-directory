...
class ListSessionsOfAuthorUsingGET200Response(BaseModel):
    """
    ListSessionsOfAuthorUsingGET200Response
    """ # noqa: E501
    code: Optional[StrictInt] = None
    data: Optional[ListSessionsOfAuthorUsingGET200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": ListSessionsOfAuthorUsingGET200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
