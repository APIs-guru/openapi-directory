...
class TestApplicationStatusGet500Response(unittest.TestCase):
    """ApplicationStatusGet500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationStatusGet500Response:
        """Test ApplicationStatusGet500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationStatusGet500Response`
        """
        model = ApplicationStatusGet500Response()
        if include_optional:
            return ApplicationStatusGet500Response(
    ...
    def testApplicationStatusGet500Response(self):
        """Test ApplicationStatusGet500Response"""
