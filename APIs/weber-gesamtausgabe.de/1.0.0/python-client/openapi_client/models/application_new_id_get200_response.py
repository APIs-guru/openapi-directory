...
class ApplicationNewIDGet200Response(BaseModel):
    """
    ApplicationNewIDGet200Response
    """ # noqa: E501
    doc_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The WeGA ID", alias="docID")
    doc_type: Optional[StrictStr] = Field(default=None, description="The WeGA document type", alias="docType")
    __properties: ClassVar[List[str]] = ["docID", "docType"]

    @field_validator('doc_id')
    def doc_id_validate_regular_expression(cls, value):
