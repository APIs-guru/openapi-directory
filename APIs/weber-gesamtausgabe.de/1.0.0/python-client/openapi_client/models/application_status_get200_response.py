...
class ApplicationStatusGet200Response(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default='healthy', description="Status (healthy|unhealthy) of the currently running WeGA-WebApp")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationStatusGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationStatusGet200Response from a dict"""
        if obj is None:
            return None
