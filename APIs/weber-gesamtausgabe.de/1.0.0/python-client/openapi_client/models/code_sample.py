...
class CodeSample(BaseModel):
    ...
    CodeSample
    """ # noqa: E501
    code_sample: Optional[StrictStr] = Field(default=None, description="The code snippet", alias="codeSample")
    ...
    __properties: ClassVar[List[str]] = ["codeSample", "docID", "uri"]
