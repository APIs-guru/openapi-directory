...
class FacetsApi:
    ...
    @validate_call
    def facets_facet_get(
        self,
        facet: Annotated[StrictStr, Field(description="The facet to search for")],
        scope: Annotated[str, Field(strict=True, description="The scope of the result set, i.e. 'indices' or a WeGA ID")],
        doc_type: Annotated[List[StrictStr], Field(description="The WeGA document type")],
        term: Annotated[Optional[StrictStr], Field(description="The search term to be looked for in the facet's label")] = None,
        ...
        _param = self._facets_facet_get_serialize(
            facet=facet,
            scope=scope,
            doc_type=doc_type,
            term=term,
    ...
    @validate_call
    def facets_facet_get_with_http_info(
        self,
        facet: Annotated[StrictStr, Field(description="The facet to search for")],
        scope: Annotated[str, Field(strict=True, description="The scope of the result set, i.e. 'indices' or a WeGA ID")],
        doc_type: Annotated[List[StrictStr], Field(description="The WeGA document type")],
    ...
    @validate_call
    def facets_facet_get_without_preload_content(
        self,
        facet: Annotated[StrictStr, Field(description="The facet to search for")],
        scope: Annotated[str, Field(strict=True, description="The scope of the result set, i.e. 'indices' or a WeGA ID")],
        doc_type: Annotated[List[StrictStr], Field(description="The WeGA document type")],
    ...
    def _facets_facet_get_serialize(
        self,
        facet,
        scope,
        doc_type,
