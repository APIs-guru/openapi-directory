...
class SearchApi:
    ...
    def search_entity_get(
        ...
        q: Annotated[Optional[StrictStr], Field(description="The query string")] = None,
        ...
        _param = self._search_entity_get_serialize(
            doc_type=doc_type,
            q=q,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    def search_entity_get_with_http_info(
        self,
        doc_type: Annotated[Optional[List[StrictStr]], Field(description="The WeGA document type")] = None,
        q: Annotated[Optional[StrictStr], Field(description="The query string")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Position of first item to retrieve (starting from 1)")] = None,
    ...
    @validate_call
    def search_entity_get_without_preload_content(
        self,
        doc_type: Annotated[Optional[List[StrictStr]], Field(description="The WeGA document type")] = None,
        q: Annotated[Optional[StrictStr], Field(description="The query string")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Position of first item to retrieve (starting from 1)")] = None,
    ...
    def _search_entity_get_serialize(
        self,
        doc_type,
        q,
        offset,
