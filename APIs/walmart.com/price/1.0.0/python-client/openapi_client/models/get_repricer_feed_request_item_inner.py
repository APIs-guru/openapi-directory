...
class GetRepricerFeedRequestItemInner(BaseModel):
    """
    GetRepricerFeedRequestItemInner
    """ # noqa: E501
    strategy: Optional[GetRepricerFeedRequestItemInnerStrategy] = Field(default=None, alias="Strategy")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRepricerFeedRequestItemInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRepricerFeedRequestItemInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Strategy": GetRepricerFeedRequestItemInnerStrategy.from_dict(obj["Strategy"]) if obj.get("Strategy") is not None else None
        })
        return _obj
