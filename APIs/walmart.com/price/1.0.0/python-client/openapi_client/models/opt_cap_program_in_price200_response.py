...
class OptCapProgramInPrice200Response(BaseModel):
    """
    OptCapProgramInPrice200Response
    """ # noqa: E501
    mart_id: Optional[StrictStr] = Field(default=None, description="A unique ID that a user or seller uses for a marketplace.", alias="martId")
    status_info: Optional[OptCapProgramInPriceRequest] = Field(default=None, alias="statusInfo")
    __properties: ClassVar[List[str]] = ["martId", "statusInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "martId": obj.get("martId"),
            "statusInfo": OptCapProgramInPriceRequest.from_dict(obj["statusInfo"]) if obj.get("statusInfo") is not None else None
        })
        return _obj
