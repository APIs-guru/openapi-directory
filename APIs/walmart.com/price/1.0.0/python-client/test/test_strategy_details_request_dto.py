...
class TestStrategyDetailsRequestDTO(unittest.TestCase):
    """StrategyDetailsRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StrategyDetailsRequestDTO:
        """Test StrategyDetailsRequestDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StrategyDetailsRequestDTO`
        """
        model = StrategyDetailsRequestDTO()
        if include_optional:
            return StrategyDetailsRequestDTO(
    ...
    def testStrategyDetailsRequestDTO(self):
        """Test StrategyDetailsRequestDTO"""
