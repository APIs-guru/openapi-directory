...
class TestUpdatePriceRequestPricingInner(unittest.TestCase):
    """UpdatePriceRequestPricingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePriceRequestPricingInner:
        """Test UpdatePriceRequestPricingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePriceRequestPricingInner`
        """
        model = UpdatePriceRequestPricingInner()
        if include_optional:
            return UpdatePriceRequestPricingInner(
    ...
    def testUpdatePriceRequestPricingInner(self):
        """Test UpdatePriceRequestPricingInner"""
