...
class TestFeedUploadRequestDTO(unittest.TestCase):
    """FeedUploadRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedUploadRequestDTO:
        """Test FeedUploadRequestDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedUploadRequestDTO`
        """
        model = FeedUploadRequestDTO()
        if include_optional:
            return FeedUploadRequestDTO(
                item = [
    ...
    def testFeedUploadRequestDTO(self):
        """Test FeedUploadRequestDTO"""
