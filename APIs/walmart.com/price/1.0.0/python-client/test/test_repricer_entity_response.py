...
class TestRepricerEntityResponse(unittest.TestCase):
    """RepricerEntityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepricerEntityResponse:
        """Test RepricerEntityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepricerEntityResponse`
        """
        model = RepricerEntityResponse()
        if include_optional:
            return RepricerEntityResponse(
    ...
    def testRepricerEntityResponse(self):
        """Test RepricerEntityResponse"""
