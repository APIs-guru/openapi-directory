...
class GetInventory200Response(BaseModel):
    """
    ...
    sku: StrictStr = Field(description="A seller-provided Product ID. Response will have decoded value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quantity": GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInnerReservedQty.from_dict(obj["quantity"]) if obj.get("quantity") is not None else None,
            "sku": obj.get("sku")
        })
        return _obj
