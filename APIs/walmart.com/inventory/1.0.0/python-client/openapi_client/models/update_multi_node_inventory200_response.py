...
class UpdateMultiNodeInventory200Response(BaseModel):
    """
    UpdateMultiNodeInventory200Response
    """ # noqa: E501
    nodes: Optional[List[UpdateMultiNodeInventory200ResponseNodesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [UpdateMultiNodeInventory200ResponseNodesInner.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "sku": obj.get("sku")
        })
        return _obj
