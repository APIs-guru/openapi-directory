...
class UpdateMultiNodeInventoryRequest(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inventories
        if self.inventories:
            _dict['inventories'] = self.inventories.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventories": UpdateMultiNodeInventoryRequestInventories.from_dict(obj["inventories"]) if obj.get("inventories") is not None else None
        })
        return _obj
