...
class Elements(BaseModel):
    ...
    Elements
    """ # noqa: E501
    inventories: Optional[List[GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner]] = None
    __properties: ClassVar[List[str]] = ["inventories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventories": [GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner.from_dict(_item) for _item in obj["inventories"]] if obj.get("inventories") is not None else None
        })
        return _obj
