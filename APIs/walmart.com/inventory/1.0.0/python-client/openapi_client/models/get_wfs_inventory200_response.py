...
class GetWFSInventory200Response(BaseModel):
    """
    GetWFSInventory200Response
    """ # noqa: E501
    headers: Optional[GetWFSInventory200ResponseHeaders] = None
    payload: Optional[GetWFSInventory200ResponsePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": GetWFSInventory200ResponseHeaders.from_dict(obj["headers"]) if obj.get("headers") is not None else None,
            "payload": GetWFSInventory200ResponsePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
