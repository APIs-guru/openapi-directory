...
class GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner(BaseModel):
    """
    GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner
    """ # noqa: E501
    nodes: Optional[List[GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["nodes", "sku"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInnerNodesInner.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "sku": obj.get("sku")
        })
        return _obj
