...
class GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseMeta(BaseModel):
    """
    GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseMeta
    """ # noqa: E501
    next_cursor: Optional[StrictStr] = Field(default=None, description="Used for pagination to fetch the next set of items.", alias="nextCursor")
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of Skus of the Seller. Example: '235'", alias="totalCount")
    __properties: ClassVar[List[str]] = ["nextCursor", "totalCount"]
