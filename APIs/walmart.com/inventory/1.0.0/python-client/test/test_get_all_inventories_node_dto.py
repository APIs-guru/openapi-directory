...
class TestGetAllInventoriesNodeDTO(unittest.TestCase):
    """GetAllInventoriesNodeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllInventoriesNodeDTO:
        """Test GetAllInventoriesNodeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllInventoriesNodeDTO`
        """
        model = GetAllInventoriesNodeDTO()
        if include_optional:
            return GetAllInventoriesNodeDTO(
    ...
    def testGetAllInventoriesNodeDTO(self):
        """Test GetAllInventoriesNodeDTO"""
