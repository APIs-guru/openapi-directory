...
class TestGetAllInventoriesDTO(unittest.TestCase):
    """GetAllInventoriesDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllInventoriesDTO:
        """Test GetAllInventoriesDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllInventoriesDTO`
        """
        model = GetAllInventoriesDTO()
        if include_optional:
            return GetAllInventoriesDTO(
                nodes = [
    ...
    def testGetAllInventoriesDTO(self):
        """Test GetAllInventoriesDTO"""
