...
class TestInputQty(unittest.TestCase):
    """InputQty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputQty:
        """Test InputQty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputQty`
        """
        model = InputQty()
        if include_optional:
            return InputQty(
