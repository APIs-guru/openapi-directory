...
class TestInventoriesDTO(unittest.TestCase):
    """InventoriesDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoriesDTO:
        """Test InventoriesDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoriesDTO`
        """
        model = InventoriesDTO()
        if include_optional:
