...
class TestGetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner(unittest.TestCase):
    """GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner:
        """Test GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner`
        """
        model = GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner()
        if include_optional:
            return GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner(
                nodes = [
    ...
    def testGetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner(self):
        """Test GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseElementsInventoriesInner"""
