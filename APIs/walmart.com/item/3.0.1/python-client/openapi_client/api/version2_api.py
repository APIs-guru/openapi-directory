...
class Version2Api:
    ...
    def v2do_post_multi_part(
        ...
        _param = self._v2do_post_multi_part_serialize(
    ...
    @validate_call
    def v2do_post_multi_part_with_http_info(
        self,
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
        wm_sec_timestamp: Annotated[StrictStr, Field(description="Epoch timestamp")],
    ...
    @validate_call
    def v2do_post_multi_part_without_preload_content(
        self,
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
        wm_sec_timestamp: Annotated[StrictStr, Field(description="Epoch timestamp")],
    ...
    def _v2do_post_multi_part_serialize(
        self,
    ...
    def v2get_all_items_status(
        ...
        _param = self._v2get_all_items_status_serialize(
            feed_id=feed_id,
            wm_consumer_channel_type=wm_consumer_channel_type,
            wm_consumer_id=wm_consumer_id,
            wm_sec_timestamp=wm_sec_timestamp,
    ...
    @validate_call
    def v2get_all_items_status_with_http_info(
        self,
        feed_id: Annotated[StrictStr, Field(description="The feed ID")],
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
    ...
    @validate_call
    def v2get_all_items_status_without_preload_content(
        self,
        feed_id: Annotated[StrictStr, Field(description="The feed ID")],
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
    ...
    def _v2get_all_items_status_serialize(
        self,
        feed_id,
        wm_consumer_channel_type,
        wm_consumer_id,
    ...
    def v2get_feed_item_status(
        ...
        _param = self._v2get_feed_item_status_serialize(
            wm_consumer_channel_type=wm_consumer_channel_type,
            wm_consumer_id=wm_consumer_id,
            wm_sec_timestamp=wm_sec_timestamp,
            wm_sec_auth_signature=wm_sec_auth_signature,
    ...
    @validate_call
    def v2get_feed_item_status_with_http_info(
        self,
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
        wm_sec_timestamp: Annotated[StrictStr, Field(description="Epoch timestamp")],
    ...
    @validate_call
    def v2get_feed_item_status_without_preload_content(
        self,
        wm_consumer_channel_type: Annotated[StrictStr, Field(description="Channel Type")],
        wm_consumer_id: Annotated[StrictStr, Field(description="Your Consumer ID")],
        wm_sec_timestamp: Annotated[StrictStr, Field(description="Epoch timestamp")],
    ...
    def _v2get_feed_item_status_serialize(
        self,
        wm_consumer_channel_type,
        wm_consumer_id,
        wm_sec_timestamp,
