...
writable_power_outlet_instance = WritablePowerOutlet.from_json(json)
# print the JSON string representation of the object
print(WritablePowerOutlet.to_json())

# convert the object into a dict
writable_power_outlet_dict = writable_power_outlet_instance.to_dict()
# create an instance of WritablePowerOutlet from a dict
writable_power_outlet_from_dict = WritablePowerOutlet.from_dict(writable_power_outlet_dict)
```
