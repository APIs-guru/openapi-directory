...
writable_console_port_instance = WritableConsolePort.from_json(json)
# print the JSON string representation of the object
print(WritableConsolePort.to_json())

# convert the object into a dict
writable_console_port_dict = writable_console_port_instance.to_dict()
# create an instance of WritableConsolePort from a dict
writable_console_port_from_dict = WritableConsolePort.from_dict(writable_console_port_dict)
```
