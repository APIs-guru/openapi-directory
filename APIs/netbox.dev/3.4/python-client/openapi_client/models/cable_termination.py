...
class CableTermination(BaseModel):
    ...
    termination_id: Annotated[int, Field(le=-9223372036854775616, strict=True, ge=0)]
    termination_type: StrictStr
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cable", "cable_end", "display", "id", "termination", "termination_id", "termination_type", "url"]

    @field_validator('cable_end')
    def cable_end_validate_enum(cls, value):
        """Validates the enum"""
