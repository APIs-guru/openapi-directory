...
class WritableWirelessLANGroup(BaseModel):
    ...
    wirelesslan_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_depth", "created", "custom_fields", "description", "display", "id", "last_updated", "name", "parent", "slug", "tags", "url", "wirelesslan_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "wirelesslan_count": obj.get("wirelesslan_count")
        })
        return _obj
