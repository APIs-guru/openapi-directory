...
class VLAN(BaseModel):
    ...
    vid: Annotated[int, Field(le=4094, strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["comments", "created", "custom_fields", "description", "display", "group", "id", "l2vpn_termination", "last_updated", "name", "prefix_count", "role", "site", "status", "tags", "tenant", "url", "vid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group": NestedVLANGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "id": obj.get("id"),
