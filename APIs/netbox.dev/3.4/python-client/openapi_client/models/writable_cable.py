...
class WritableCable(BaseModel):
    ...
    length_unit: Optional[StrictStr] = None
    ...
    def length_unit_validate_enum(cls, value):
        ...
        if value not in set(['km', 'm', 'cm', 'mi', 'ft', 'in']):
            raise ValueError("must be one of enum values ('km', 'm', 'cm', 'mi', 'ft', 'in')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "length_unit": obj.get("length_unit"),
