...
class RackReservation(BaseModel):
    ...
    rack: Optional[NestedRack]
    tags: Optional[List[NestedTag]] = None
    tenant: Optional[NestedTenant] = None
    units: List[Annotated[int, Field(le=32767, strict=True, ge=0)]]
    url: Optional[StrictStr] = None
    user: NestedUser
    __properties: ClassVar[List[str]] = ["comments", "created", "custom_fields", "description", "display", "id", "last_updated", "rack", "tags", "tenant", "units", "url", "user"]
