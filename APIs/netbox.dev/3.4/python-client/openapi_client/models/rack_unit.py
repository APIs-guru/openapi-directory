...
class RackUnit(BaseModel):
    ...
    face: Optional[Face1] = None
    id: Optional[Union[StrictFloat, StrictInt]] = None
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    occupied: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["device", "display", "face", "id", "name", "occupied"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "face": Face1.from_dict(obj["face"]) if obj.get("face") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
