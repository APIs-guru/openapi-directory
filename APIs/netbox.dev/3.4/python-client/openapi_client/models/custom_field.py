...
class CustomField(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of filter_logic
        if self.filter_logic:
            _dict['filter_logic'] = self.filter_logic.to_dict()
        # override the default output from pydantic by calling `to_dict()` of type
        if self.type:
            _dict['type'] = self.type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ui_visibility
        if self.ui_visibility:
            _dict['ui_visibility'] = self.ui_visibility.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filter_logic": FilterLogic.from_dict(obj["filter_logic"]) if obj.get("filter_logic") is not None else None,
            ...
            "ui_visibility": UiVisibility.from_dict(obj["ui_visibility"]) if obj.get("ui_visibility") is not None else None,
            "url": obj.get("url"),
