...
class ConsolePort(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_occupied", "cable", "cable_end", "connected_endpoints", "connected_endpoints_reachable", "connected_endpoints_type", "created", "custom_fields", "description", "device", "display", "id", "label", "last_updated", "link_peers", "link_peers_type", "mark_connected", "module", "name", "speed", "tags", "type", "url"]
