...
class NestedModuleBay(BaseModel):
    ...
    module: Optional[NestedModule] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=64)]
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["display", "id", "module", "name", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "module": NestedModule.from_dict(obj["module"]) if obj.get("module") is not None else None,
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
