...
class ProviderNetwork(BaseModel):
    ...
    service_id: Optional[Annotated[str, Field(strict=True, max_length=100)]] = None
    tags: Optional[List[NestedTag]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["comments", "created", "custom_fields", "description", "display", "id", "last_updated", "name", "provider", "service_id", "tags", "url"]
