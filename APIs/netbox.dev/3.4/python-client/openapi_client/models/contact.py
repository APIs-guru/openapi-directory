...
class Contact(BaseModel):
    ...
    Contact
    """ # noqa: E501
    address: Optional[Annotated[str, Field(strict=True, max_length=200)]] = None
    ...
    link: Optional[Annotated[str, Field(strict=True, max_length=200)]] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    phone: Optional[Annotated[str, Field(strict=True, max_length=50)]] = None
    tags: Optional[List[NestedTag]] = None
    title: Optional[Annotated[str, Field(strict=True, max_length=100)]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["address", "comments", "created", "custom_fields", "description", "display", "email", "group", "id", "last_updated", "link", "name", "phone", "tags", "title", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "group": NestedContactGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "id": obj.get("id"),
