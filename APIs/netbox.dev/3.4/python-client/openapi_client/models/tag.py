...
class Tag(BaseModel):
    ...
    tagged_items: Optional[StrictInt] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["color", "created", "description", "display", "id", "last_updated", "name", "slug", "tagged_items", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "slug": obj.get("slug"),
            "tagged_items": obj.get("tagged_items"),
            "url": obj.get("url")
        })
        return _obj
