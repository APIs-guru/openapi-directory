...
class WritableConsolePort(BaseModel):
    ...
    speed: Optional[StrictInt] = Field(default=None, description="Port speed in bits per second")
    ...
    def speed_validate_enum(cls, value):
        ...
        if value not in set([1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200]):
            raise ValueError("must be one of enum values (1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200)")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WritableConsolePort from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WritableConsolePort from a dict"""
        if obj is None:
            return None
