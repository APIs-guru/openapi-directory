...
class FHRPGroup(BaseModel):
    ...
    FHRPGroup
    """ # noqa: E501
    auth_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    ...
    __properties: ClassVar[List[str]] = ["auth_key", "auth_type", "comments", "created", "custom_fields", "description", "display", "group_id", "id", "ip_addresses", "last_updated", "name", "protocol", "tags", "url"]
    ...
    def auth_type_validate_enum(cls, value):
        ...
        if value not in set(['plaintext', 'md5']):
            raise ValueError("must be one of enum values ('plaintext', 'md5')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "ip_addresses": [NestedIPAddress.from_dict(_item) for _item in obj["ip_addresses"]] if obj.get("ip_addresses") is not None else None,
