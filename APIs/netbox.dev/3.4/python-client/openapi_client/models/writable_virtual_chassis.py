...
class WritableVirtualChassis(BaseModel):
    ...
    domain: Optional[Annotated[str, Field(strict=True, max_length=30)]] = None
    id: Optional[StrictInt] = None
    last_updated: Optional[datetime] = None
    master: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["comments", "created", "custom_fields", "description", "display", "domain", "id", "last_updated", "master", "member_count", "name", "tags", "url"]
