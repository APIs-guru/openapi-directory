...
class Module(BaseModel):
    ...
    module_type: Optional[NestedModuleType]
    ...
    __properties: ClassVar[List[str]] = ["asset_tag", "comments", "created", "custom_fields", "description", "device", "display", "id", "last_updated", "module_bay", "module_type", "serial", "status", "tags", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "module_bay": NestedModuleBay.from_dict(obj["module_bay"]) if obj.get("module_bay") is not None else None,
