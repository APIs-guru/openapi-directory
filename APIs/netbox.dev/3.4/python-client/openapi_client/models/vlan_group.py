...
class VLANGroup(BaseModel):
    ...
    max_vid: Optional[Annotated[int, Field(le=4094, strict=True, ge=1)]] = Field(default=None, description="Highest permissible ID of a child VLAN")
    min_vid: Optional[Annotated[int, Field(le=4094, strict=True, ge=1)]] = Field(default=None, description="Lowest permissible ID of a child VLAN")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    scope: Optional[Dict[str, Any]] = None
    scope_id: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["created", "custom_fields", "description", "display", "id", "last_updated", "max_vid", "min_vid", "name", "scope", "scope_id", "scope_type", "slug", "tags", "url", "vlan_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_vid": obj.get("max_vid"),
            "min_vid": obj.get("min_vid"),
            "name": obj.get("name"),
            "scope": obj.get("scope"),
