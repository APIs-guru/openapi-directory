...
class DeviceBay(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of installed_device
        if self.installed_device:
            _dict['installed_device'] = self.installed_device.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "installed_device": NestedDevice.from_dict(obj["installed_device"]) if obj.get("installed_device") is not None else None,
            "label": obj.get("label"),
