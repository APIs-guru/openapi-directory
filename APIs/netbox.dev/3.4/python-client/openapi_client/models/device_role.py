...
class DeviceRole(BaseModel):
    ...
    DeviceRole
    """ # noqa: E501
    color: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=6)]] = None
    ...
    vm_role: Optional[StrictBool] = Field(default=None, description="Virtual machines may be assigned to this role")
    __properties: ClassVar[List[str]] = ["color", "created", "custom_fields", "description", "device_count", "display", "id", "last_updated", "name", "slug", "tags", "url", "virtualmachine_count", "vm_role"]
