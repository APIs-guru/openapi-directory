...
class WritableDeviceBay(BaseModel):
    ...
    installed_device: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["created", "custom_fields", "description", "device", "display", "id", "installed_device", "label", "last_updated", "name", "tags", "url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if installed_device (nullable) is None
        # and model_fields_set contains the field
        if self.installed_device is None and "installed_device" in self.model_fields_set:
            _dict['installed_device'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "installed_device": obj.get("installed_device"),
            "label": obj.get("label"),
