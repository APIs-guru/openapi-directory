...
class TenantGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_depth", "created", "custom_fields", "description", "display", "id", "last_updated", "name", "parent", "slug", "tags", "tenant_count", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parent": NestedTenantGroup.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "slug": obj.get("slug"),
