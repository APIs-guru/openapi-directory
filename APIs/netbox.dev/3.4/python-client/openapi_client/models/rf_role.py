...
class RfRole(BaseModel):
    ...
    def label_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Access point', 'Station']):
            raise ValueError("must be one of enum values ('Access point', 'Station')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RfRole from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RfRole from a dict"""
        if obj is None:
            return None
