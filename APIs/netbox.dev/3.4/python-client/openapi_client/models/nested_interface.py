...
class NestedInterface(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_occupied", "cable", "device", "display", "id", "name", "url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if cable (nullable) is None
        # and model_fields_set contains the field
        if self.cable is None and "cable" in self.model_fields_set:
            _dict['cable'] = None
