...
class WritablePowerFeed(BaseModel):
    ...
    amperage: Optional[Annotated[int, Field(le=32767, strict=True, ge=1)]] = None
    ...
    max_utilization: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=None, description="Maximum permissible draw (percentage)")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    phase: Optional[StrictStr] = None
    power_panel: StrictInt
    rack: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    supply: Optional[StrictStr] = None
    tags: Optional[List[NestedTag]] = None
    type: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    voltage: Optional[Annotated[int, Field(le=32767, strict=True, ge=-32768)]] = None
    __properties: ClassVar[List[str]] = ["_occupied", "amperage", "cable", "cable_end", "comments", "connected_endpoints", "connected_endpoints_reachable", "connected_endpoints_type", "created", "custom_fields", "description", "display", "id", "last_updated", "link_peers", "link_peers_type", "mark_connected", "max_utilization", "name", "phase", "power_panel", "rack", "status", "supply", "tags", "type", "url", "voltage"]
    ...
    def phase_validate_enum(cls, value):
        ...
        if value not in set(['single-phase', 'three-phase']):
            raise ValueError("must be one of enum values ('single-phase', 'three-phase')")
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['offline', 'active', 'planned', 'failed']):
            raise ValueError("must be one of enum values ('offline', 'active', 'planned', 'failed')")
        return value

    @field_validator('supply')
    def supply_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "phase": obj.get("phase"),
            "power_panel": obj.get("power_panel"),
            "rack": obj.get("rack"),
