...
class JournalEntry(BaseModel):
    ...
    assigned_object_id: Annotated[int, Field(le=-9223372036854775616, strict=True, ge=0)]
    assigned_object_type: StrictStr
    comments: Annotated[str, Field(min_length=1, strict=True)]
    ...
    __properties: ClassVar[List[str]] = ["assigned_object", "assigned_object_id", "assigned_object_type", "comments", "created", "created_by", "custom_fields", "display", "id", "kind", "last_updated", "tags", "url"]
