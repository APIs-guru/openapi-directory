...
class Location(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parent": NestedLocation.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "rack_count": obj.get("rack_count"),
            "site": NestedSite.from_dict(obj["site"]) if obj.get("site") is not None else None,
            "slug": obj.get("slug"),
            "status": Status7.from_dict(obj["status"]) if obj.get("status") is not None else None,
