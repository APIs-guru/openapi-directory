...
class NestedVirtualChassis(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["display", "id", "master", "member_count", "name", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "master": NestedDevice.from_dict(obj["master"]) if obj.get("master") is not None else None,
