...
class Type1(BaseModel):
    ...
    def label_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Text', 'Text (long)', 'Integer', 'Decimal', 'Boolean (true/false)', 'Date', 'URL', 'JSON', 'Selection', 'Multiple selection', 'Object', 'Multiple objects']):
            raise ValueError("must be one of enum values ('Text', 'Text (long)', 'Integer', 'Decimal', 'Boolean (true/false)', 'Date', 'URL', 'JSON', 'Selection', 'Multiple selection', 'Object', 'Multiple objects')")
        return value
