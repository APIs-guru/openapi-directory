...
class Site(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group": NestedSiteGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "id": obj.get("id"),
            ...
            "region": NestedRegion.from_dict(obj["region"]) if obj.get("region") is not None else None,
