...
class PowerFeed(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of power_panel
        if self.power_panel:
            _dict['power_panel'] = self.power_panel.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of supply
        if self.supply:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "phase": Phase.from_dict(obj["phase"]) if obj.get("phase") is not None else None,
            "power_panel": NestedPowerPanel.from_dict(obj["power_panel"]) if obj.get("power_panel") is not None else None,
            "rack": NestedRack.from_dict(obj["rack"]) if obj.get("rack") is not None else None,
            "status": Status9.from_dict(obj["status"]) if obj.get("status") is not None else None,
            ...
            "type": Type5.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "url": obj.get("url"),
