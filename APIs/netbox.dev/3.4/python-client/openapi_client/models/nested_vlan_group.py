...
class NestedVLANGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["display", "id", "name", "slug", "url", "vlan_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NestedVLANGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NestedVLANGroup from a dict"""
        if obj is None:
            return None
