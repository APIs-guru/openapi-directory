...
class ModuleBay(BaseModel):
    ...
    installed_module: Optional[ModuleBayNestedModule] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of installed_module
        if self.installed_module:
            _dict['installed_module'] = self.installed_module.to_dict()
        ...
        # set to None if installed_module (nullable) is None
        # and model_fields_set contains the field
        if self.installed_module is None and "installed_module" in self.model_fields_set:
            _dict['installed_module'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "installed_module": ModuleBayNestedModule.from_dict(obj["installed_module"]) if obj.get("installed_module") is not None else None,
            "label": obj.get("label"),
