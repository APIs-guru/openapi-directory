...
class WritableProvider(BaseModel):
    """
    WritableProvider
    """ # noqa: E501
    account: Optional[Annotated[str, Field(strict=True, max_length=30)]] = None
    ...
    __properties: ClassVar[List[str]] = ["account", "asns", "circuit_count", "comments", "created", "custom_fields", "description", "display", "id", "last_updated", "name", "slug", "tags", "url"]
