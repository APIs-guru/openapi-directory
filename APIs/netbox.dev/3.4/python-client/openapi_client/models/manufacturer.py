...
class Manufacturer(BaseModel):
    ...
    devicetype_count: Optional[StrictInt] = None
    display: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    inventoryitem_count: Optional[StrictInt] = None
    last_updated: Optional[datetime] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    platform_count: Optional[StrictInt] = None
    slug: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    tags: Optional[List[NestedTag]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created", "custom_fields", "description", "devicetype_count", "display", "id", "inventoryitem_count", "last_updated", "name", "platform_count", "slug", "tags", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "devicetype_count": obj.get("devicetype_count"),
            "display": obj.get("display"),
            "id": obj.get("id"),
            "inventoryitem_count": obj.get("inventoryitem_count"),
            "last_updated": obj.get("last_updated"),
            "name": obj.get("name"),
            "platform_count": obj.get("platform_count"),
            "slug": obj.get("slug"),
