...
class WritableL2VPNTermination(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assigned_object", "assigned_object_id", "assigned_object_type", "created", "custom_fields", "display", "id", "l2vpn", "last_updated", "tags", "url"]
