...
class RIR(BaseModel):
    ...
    RIR
    """ # noqa: E501
    aggregate_count: Optional[StrictInt] = None
    ...
    is_private: Optional[StrictBool] = Field(default=None, description="IP space managed by this RIR is considered private")
    ...
    __properties: ClassVar[List[str]] = ["aggregate_count", "created", "custom_fields", "description", "display", "id", "is_private", "last_updated", "name", "slug", "tags", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregate_count": obj.get("aggregate_count"),
