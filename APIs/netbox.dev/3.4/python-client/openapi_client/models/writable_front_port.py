...
class WritableFrontPort(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_occupied", "cable", "cable_end", "color", "created", "custom_fields", "description", "device", "display", "id", "label", "last_updated", "link_peers", "link_peers_type", "mark_connected", "module", "name", "rear_port", "rear_port_position", "tags", "type", "url"]
