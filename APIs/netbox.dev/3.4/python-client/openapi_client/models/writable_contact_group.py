...
class WritableContactGroup(BaseModel):
    ...
    contact_count: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["_depth", "contact_count", "created", "custom_fields", "description", "display", "id", "last_updated", "name", "parent", "slug", "tags", "url"]
