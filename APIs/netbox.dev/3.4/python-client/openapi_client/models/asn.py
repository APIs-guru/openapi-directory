...
class ASN(BaseModel):
    ...
    provider_count: Optional[StrictInt] = None
    rir: StrictInt
    site_count: Optional[StrictInt] = None
    tags: Optional[List[NestedTag]] = None
    tenant: Optional[NestedTenant] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["asn", "comments", "created", "custom_fields", "description", "display", "id", "last_updated", "provider_count", "rir", "site_count", "tags", "tenant", "url"]
