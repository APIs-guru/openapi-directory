...
class TestWirelessLink(unittest.TestCase):
    """WirelessLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WirelessLink:
        """Test WirelessLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WirelessLink`
        """
        model = WirelessLink()
        if include_optional:
            return WirelessLink(
