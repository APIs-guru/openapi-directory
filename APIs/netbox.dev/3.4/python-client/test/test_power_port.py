...
class TestPowerPort(unittest.TestCase):
    """PowerPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerPort:
        """Test PowerPort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerPort`
        """
        model = PowerPort()
        if include_optional:
            return PowerPort(
