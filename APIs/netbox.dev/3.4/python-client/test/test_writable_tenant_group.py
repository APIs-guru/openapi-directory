...
class TestWritableTenantGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WritableTenantGroup:
        """Test WritableTenantGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WritableTenantGroup`
        """
        model = WritableTenantGroup()
        if include_optional:
            return WritableTenantGroup(
                depth = 56,
