...
class TestVMInterface(unittest.TestCase):
    """VMInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VMInterface:
        """Test VMInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VMInterface`
        """
        model = VMInterface()
        if include_optional:
            return VMInterface(
