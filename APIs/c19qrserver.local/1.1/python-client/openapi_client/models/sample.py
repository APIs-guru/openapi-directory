...
class Sample(BaseModel):
    ...
    Sample
    """ # noqa: E501
    old_password: Optional[StrictStr] = Field(default=None, description="The old (current) password")
    password: Optional[StrictStr] = Field(default=None, description="The new password")
    __properties: ClassVar[List[str]] = ["old_password", "password"]
