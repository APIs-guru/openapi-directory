...
class TestVulnerableComponent(unittest.TestCase):
    """VulnerableComponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VulnerableComponent:
        """Test VulnerableComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VulnerableComponent`
        """
        ...
        if include_optional:
            return VulnerableComponent(
                ...
                version = '',
                vulnerabilities = [
                    openapi_client.models.vulnerability.Vulnerability(
                        cve_id = '', 
                        cvss = 1.337, )
                    ]
            )
    ...
    def testVulnerableComponent(self):
        """Test VulnerableComponent"""
