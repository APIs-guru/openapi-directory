...
class TestConfigIssue(unittest.TestCase):
    """ConfigIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigIssue:
        """Test ConfigIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigIssue`
        """
        model = ConfigIssue()
        if include_optional:
            return ConfigIssue(
