...
class DeviceApi:
    ...
    def detect_device(
        ...
        :param device_features: (required)
        :type device_features: DeviceFeatures
        ...
        _param = self._detect_device_serialize(
    ...
    @validate_call
    def detect_device_with_http_info(
        self,
        device_features: DeviceFeatures,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def detect_device_without_preload_content(
        self,
        device_features: DeviceFeatures,
        _request_timeout: Union[
            None,
