...
class WeakCert(BaseModel):
    ...
    sign_algorithm: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["file_hash", "file_name", "sign_algorithm", "subject_name", "thumb_print", "valid_from", "valid_to"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sign_algorithm (nullable) is None
        # and model_fields_set contains the field
        if self.sign_algorithm is None and "sign_algorithm" in self.model_fields_set:
            _dict['sign_algorithm'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sign_algorithm": obj.get("sign_algorithm"),
