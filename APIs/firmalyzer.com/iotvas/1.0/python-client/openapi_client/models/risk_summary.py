...
class RiskSummary(BaseModel):
    ...
    RiskSummary
    """ # noqa: E501
    client_tools_risk: Optional[StrictStr] = None
    crypto_risk: Optional[StrictStr] = None
    kernel_risk: Optional[StrictStr] = None
    net_services_risk: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["client_tools_risk", "crypto_risk", "kernel_risk", "net_services_risk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client_tools_risk": obj.get("client_tools_risk"),
            "crypto_risk": obj.get("crypto_risk"),
            "kernel_risk": obj.get("kernel_risk"),
            "net_services_risk": obj.get("net_services_risk")
        })
        return _obj
