...
class CryptoKey(BaseModel):
    ...
    pem_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["algorithm", "bits", "file_hash", "file_name", "pem_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pem_type (nullable) is None
        # and model_fields_set contains the field
        if self.pem_type is None and "pem_type" in self.model_fields_set:
            _dict['pem_type'] = None
