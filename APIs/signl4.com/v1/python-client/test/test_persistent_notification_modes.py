...
class TestPersistentNotificationModes(unittest.TestCase):
    """PersistentNotificationModes unit test stubs"""
    ...
    def testPersistentNotificationModes(self):
        """Test PersistentNotificationModes"""
        # inst = PersistentNotificationModes()
