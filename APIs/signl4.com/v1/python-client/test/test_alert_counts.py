...
class TestAlertCounts(unittest.TestCase):
    """AlertCounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertCounts:
        """Test AlertCounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertCounts`
        """
        model = AlertCounts()
        if include_optional:
            return AlertCounts(
