...
class TestOverviewEvent(unittest.TestCase):
    """OverviewEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverviewEvent:
        """Test OverviewEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverviewEvent`
        """
        model = OverviewEvent()
        if include_optional:
