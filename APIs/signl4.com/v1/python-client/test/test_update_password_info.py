...
class TestUpdatePasswordInfo(unittest.TestCase):
    """UpdatePasswordInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePasswordInfo:
        """Test UpdatePasswordInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePasswordInfo`
        """
    ...
    def testUpdatePasswordInfo(self):
        """Test UpdatePasswordInfo"""
