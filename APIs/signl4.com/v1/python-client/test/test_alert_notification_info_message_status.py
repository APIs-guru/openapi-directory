...
class TestAlertNotificationInfoMessageStatus(unittest.TestCase):
    """AlertNotificationInfoMessageStatus unit test stubs"""
    ...
    def testAlertNotificationInfoMessageStatus(self):
        """Test AlertNotificationInfoMessageStatus"""
        # inst = AlertNotificationInfoMessageStatus()
