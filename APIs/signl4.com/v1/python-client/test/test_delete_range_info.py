...
class TestDeleteRangeInfo(unittest.TestCase):
    """DeleteRangeInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteRangeInfo:
        """Test DeleteRangeInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteRangeInfo`
        """
        model = DeleteRangeInfo()
        if include_optional:
