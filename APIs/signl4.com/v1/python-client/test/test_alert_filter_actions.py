...
class TestAlertFilterActions(unittest.TestCase):
    """AlertFilterActions unit test stubs"""
    ...
    def testAlertFilterActions(self):
        """Test AlertFilterActions"""
        # inst = AlertFilterActions()
