...
class TestUserDutyInfo(unittest.TestCase):
    """UserDutyInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserDutyInfo:
        """Test UserDutyInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserDutyInfo`
        """
        model = UserDutyInfo()
        if include_optional:
            return UserDutyInfo(
