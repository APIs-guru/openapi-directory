    ...
    def make_instance(self, include_optional) -> UserInfo:
        ...
        if include_optional:
            return UserInfo(
                color_index = 56,
                contact_addresses = [
                    openapi_client.models.contact_address_info.ContactAddressInfo(
                        address = '', 
                        channel = 0, 
                ...
                duty_info = openapi_client.models.user_duty_info.UserDutyInfo(
                ...
                subscription_id = '',
                time_zone = '',
                user_image_last_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return UserInfo(
        )
