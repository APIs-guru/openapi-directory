...
class TestTeamCategoryOptOutModes(unittest.TestCase):
    """TeamCategoryOptOutModes unit test stubs"""
    ...
    def testTeamCategoryOptOutModes(self):
        """Test TeamCategoryOptOutModes"""
        # inst = TeamCategoryOptOutModes()
