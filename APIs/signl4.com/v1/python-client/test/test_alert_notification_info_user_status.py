...
class TestAlertNotificationInfoUserStatus(unittest.TestCase):
    """AlertNotificationInfoUserStatus unit test stubs"""
    ...
    def testAlertNotificationInfoUserStatus(self):
        """Test AlertNotificationInfoUserStatus"""
        # inst = AlertNotificationInfoUserStatus()
