...
class TestAlertResponseModes(unittest.TestCase):
    """AlertResponseModes unit test stubs"""
    ...
    def testAlertResponseModes(self):
        """Test AlertResponseModes"""
        # inst = AlertResponseModes()
