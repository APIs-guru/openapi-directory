...
class TestChangeAlertStatusFilterInfo(unittest.TestCase):
    """ChangeAlertStatusFilterInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangeAlertStatusFilterInfo:
        """Test ChangeAlertStatusFilterInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeAlertStatusFilterInfo`
        """
        model = ChangeAlertStatusFilterInfo()
        if include_optional:
    ...
    def testChangeAlertStatusFilterInfo(self):
        """Test ChangeAlertStatusFilterInfo"""
