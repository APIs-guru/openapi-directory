...
class UserImage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content", "contentDisposition", "contentEncoding", "contentType", "lastModified", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if content_disposition (nullable) is None
        # and model_fields_set contains the field
        if self.content_disposition is None and "content_disposition" in self.model_fields_set:
            _dict['contentDisposition'] = None
