...
class EventSourceEndpointInfo(BaseModel):
    ...
    last_event_raised: Optional[datetime] = Field(default=None, alias="lastEventRaised")
    ...
    __properties: ClassVar[List[str]] = ["address", "groupId", "lastEventRaised", "subscriptionId", "teamId", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_event_raised (nullable) is None
        # and model_fields_set contains the field
        if self.last_event_raised is None and "last_event_raised" in self.model_fields_set:
            _dict['lastEventRaised'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastEventRaised": obj.get("lastEventRaised"),
