...
class CategoryMetrics(BaseModel):
    ...
    last24_hours: Optional[StrictInt] = Field(default=None, alias="last24Hours")
    last_alert: Optional[datetime] = Field(default=None, alias="lastAlert")
    subscriber_count: Optional[StrictInt] = Field(default=None, alias="subscriberCount")
    __properties: ClassVar[List[str]] = ["categoryId", "last24Hours", "lastAlert", "subscriberCount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_alert (nullable) is None
        # and model_fields_set contains the field
        if self.last_alert is None and "last_alert" in self.model_fields_set:
            _dict['lastAlert'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last24Hours": obj.get("last24Hours"),
            "lastAlert": obj.get("lastAlert"),
