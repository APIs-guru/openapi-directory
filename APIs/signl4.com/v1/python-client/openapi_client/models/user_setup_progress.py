...
class UserSetupProgress(BaseModel):
    ...
    UserSetupProgress
    """ # noqa: E501
    completed_steps: Optional[List[StrictStr]] = Field(default=None, alias="completedSteps")
    timestamp: Optional[datetime] = None
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    __properties: ClassVar[List[str]] = ["completedSteps", "timestamp", "userId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completedSteps": obj.get("completedSteps"),
