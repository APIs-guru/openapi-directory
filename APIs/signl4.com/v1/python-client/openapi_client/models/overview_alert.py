...
class OverviewAlert(BaseModel):
    ...
    OverviewAlert
    """ # noqa: E501
    alert_delivery_status: Optional[AlertDeliveryStatusInfo] = Field(default=None, alias="alertDeliveryStatus")
    ...
    history_detailed: Optional[AlertHistoryInfoDetailed] = Field(default=None, alias="historyDetailed")
    id: Optional[StrictStr] = None
    last_modified: Optional[datetime] = Field(default=None, alias="lastModified")
    required_acknowledgements: Optional[StrictInt] = Field(default=None, alias="requiredAcknowledgements")
    ...
    __properties: ClassVar[List[str]] = ["alertDeliveryStatus", "annotations", "categoryId", "eventId", "flags", "historyDetailed", "id", "lastModified", "requiredAcknowledgements", "status", "subscriptionId", "teamId", "text", "title"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of alert_delivery_status
        if self.alert_delivery_status:
            _dict['alertDeliveryStatus'] = self.alert_delivery_status.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of history_detailed
        if self.history_detailed:
            _dict['historyDetailed'] = self.history_detailed.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alertDeliveryStatus": AlertDeliveryStatusInfo.from_dict(obj["alertDeliveryStatus"]) if obj.get("alertDeliveryStatus") is not None else None,
            ...
            "flags": obj.get("flags"),
            "historyDetailed": AlertHistoryInfoDetailed.from_dict(obj["historyDetailed"]) if obj.get("historyDetailed") is not None else None,
            "id": obj.get("id"),
            "lastModified": obj.get("lastModified"),
            "requiredAcknowledgements": obj.get("requiredAcknowledgements"),
