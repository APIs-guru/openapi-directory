...
class UserInvitationInfo(BaseModel):
    ...
    user_mail: Optional[StrictStr] = Field(default=None, alias="userMail")
    __properties: ClassVar[List[str]] = ["inviterId", "userMail"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if user_mail (nullable) is None
        # and model_fields_set contains the field
        if self.user_mail is None and "user_mail" in self.model_fields_set:
            _dict['userMail'] = None
