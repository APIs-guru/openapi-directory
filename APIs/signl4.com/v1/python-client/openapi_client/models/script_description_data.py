...
class ScriptDescriptionData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "name", "scriptType", "shortDescription"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if script_type (nullable) is None
        # and model_fields_set contains the field
        if self.script_type is None and "script_type" in self.model_fields_set:
            _dict['scriptType'] = None
