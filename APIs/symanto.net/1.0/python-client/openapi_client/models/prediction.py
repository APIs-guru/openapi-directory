...
class Prediction(BaseModel):
    ...
    Prediction
    """ # noqa: E501
    prediction: StrictStr = Field(description="the predicted label.")
    probability: Union[StrictFloat, StrictInt] = Field(description="the probability of the predicted label.")
    __properties: ClassVar[List[str]] = ["prediction", "probability"]
