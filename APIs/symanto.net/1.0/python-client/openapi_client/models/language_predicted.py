...
class LanguagePredicted(BaseModel):
    ...
    LanguagePredicted
    """ # noqa: E501
    detected_language: StrictStr = Field(description="the detected language_code corresponding to the input text.")
    id: Optional[StrictStr] = Field(default=None, description="id of the post.")
    __properties: ClassVar[List[str]] = ["detected_language", "id"]
