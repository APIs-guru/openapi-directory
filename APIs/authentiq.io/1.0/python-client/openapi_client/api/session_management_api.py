...
class SessionManagementApi:
    ...
    def authorize_iframe(
        ...
        _param = self._authorize_iframe_serialize(
            client_id=client_id,
    ...
    @validate_call
    def authorize_iframe_with_http_info(
        self,
        client_id: Annotated[StrictStr, Field(description="Client identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def authorize_iframe_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="Client identifier")],
        _request_timeout: Union[
            None,
    ...
    def _authorize_iframe_serialize(
        self,
        client_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{client_id}/iframe',
