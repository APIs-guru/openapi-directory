...
class PowerModulesApi:
    ...
    @validate_call
    def get_organization_devices_power_modules_statuses_by_device_2(
        self,
        ...
        _param = self._get_organization_devices_power_modules_statuses_by_device_2_serialize(
    ...
    @validate_call
    def get_organization_devices_power_modules_statuses_by_device_2_with_http_info(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    @validate_call
    def get_organization_devices_power_modules_statuses_by_device_2_without_preload_content(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    def _get_organization_devices_power_modules_statuses_by_device_2_serialize(
        self,
        organization_id,
        per_page,
        starting_after,
