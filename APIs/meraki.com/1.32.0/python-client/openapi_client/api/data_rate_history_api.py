...
class DataRateHistoryApi:
    ...
    @validate_call
    def get_network_wireless_data_rate_history_1(
        self,
        ...
        _param = self._get_network_wireless_data_rate_history_1_serialize(
    ...
    @validate_call
    def get_network_wireless_data_rate_history_1_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    @validate_call
    def get_network_wireless_data_rate_history_1_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    def _get_network_wireless_data_rate_history_1_serialize(
        self,
        network_id,
        t0,
        t1,
