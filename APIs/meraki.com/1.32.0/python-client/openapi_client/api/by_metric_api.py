...
class ByMetricApi:
    ...
    @validate_call
    def get_network_sensor_alerts_current_overview_by_metric_4(
        self,
        ...
        _param = self._get_network_sensor_alerts_current_overview_by_metric_4_serialize(
    ...
    @validate_call
    def get_network_sensor_alerts_current_overview_by_metric_4_with_http_info(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_network_sensor_alerts_current_overview_by_metric_4_without_preload_content(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_network_sensor_alerts_current_overview_by_metric_4_serialize(
        self,
        network_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_network_sensor_alerts_overview_by_metric_3(
        self,
        network_id: StrictStr,
        ...
        _param = self._get_network_sensor_alerts_overview_by_metric_3_serialize(
            network_id=network_id,
            t0=t0,
            t1=t1,
            timespan=timespan,
    ...
    @validate_call
    def get_network_sensor_alerts_overview_by_metric_3_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    @validate_call
    def get_network_sensor_alerts_overview_by_metric_3_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    def _get_network_sensor_alerts_overview_by_metric_3_serialize(
        self,
        network_id,
        t0,
        t1,
