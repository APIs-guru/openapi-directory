...
class ChannelUtilizationApi:
    ...
    @validate_call
    def get_network_network_health_channel_utilization_2(
        self,
        ...
        resolution: Annotated[Optional[StrictInt], Field(description="The time resolution in seconds for returned data. The valid resolutions are: 600. The default is 600.")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 100. Default is 10.")] = None,
        ...
        _param = self._get_network_network_health_channel_utilization_2_serialize(
    ...
    @validate_call
    def get_network_network_health_channel_utilization_2_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    @validate_call
    def get_network_network_health_channel_utilization_2_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    def _get_network_network_health_channel_utilization_2_serialize(
        self,
        network_id,
        t0,
        t1,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/networks/{networkId}/networkHealth/channelUtilization',
