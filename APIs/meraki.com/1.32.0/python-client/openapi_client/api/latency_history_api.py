...
class LatencyHistoryApi:
    ...
    @validate_call
    def get_network_wireless_client_latency_history_2(
        self,
        ...
        _param = self._get_network_wireless_client_latency_history_2_serialize(
    ...
    @validate_call
    def get_network_wireless_client_latency_history_2_with_http_info(
        self,
        network_id: StrictStr,
        client_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 791 days from today.")] = None,
    ...
    @validate_call
    def get_network_wireless_client_latency_history_2_without_preload_content(
        self,
        network_id: StrictStr,
        client_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 791 days from today.")] = None,
    ...
    def _get_network_wireless_client_latency_history_2_serialize(
        self,
        network_id,
        client_id,
        t0,
    ...
    @validate_call
    def get_network_wireless_latency_history_1(
        self,
        network_id: StrictStr,
        ...
        _param = self._get_network_wireless_latency_history_1_serialize(
            network_id=network_id,
            t0=t0,
            t1=t1,
            timespan=timespan,
    ...
    @validate_call
    def get_network_wireless_latency_history_1_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    @validate_call
    def get_network_wireless_latency_history_1_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    def _get_network_wireless_latency_history_1_serialize(
        self,
        network_id,
        t0,
        t1,
