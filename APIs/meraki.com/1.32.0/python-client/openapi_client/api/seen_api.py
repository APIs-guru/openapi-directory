...
class SeenApi:
    ...
    @validate_call
    def get_network_switch_dhcp_v4_servers_seen_4(
        self,
        ...
        _param = self._get_network_switch_dhcp_v4_servers_seen_4_serialize(
    ...
    @validate_call
    def get_network_switch_dhcp_v4_servers_seen_4_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        timespan: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 1 day.")] = None,
    ...
    @validate_call
    def get_network_switch_dhcp_v4_servers_seen_4_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 31 days from today.")] = None,
        timespan: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 1 day.")] = None,
    ...
    def _get_network_switch_dhcp_v4_servers_seen_4_serialize(
        self,
        network_id,
        t0,
        timespan,
