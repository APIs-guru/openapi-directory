...
class BillingApi:
    ...
    @validate_call
    def get_network_wireless_billing_1(
        self,
        ...
        _param = self._get_network_wireless_billing_1_serialize(
    ...
    @validate_call
    def get_network_wireless_billing_1_with_http_info(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_network_wireless_billing_1_without_preload_content(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_network_wireless_billing_1_serialize(
        self,
        network_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def update_network_wireless_billing_1(
        self,
        network_id: StrictStr,
        ...
        _param = self._update_network_wireless_billing_1_serialize(
            network_id=network_id,
    ...
    @validate_call
    def update_network_wireless_billing_1_with_http_info(
        self,
        network_id: StrictStr,
        update_network_wireless_billing_request: Optional[UpdateNetworkWirelessBillingRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_network_wireless_billing_1_without_preload_content(
        self,
        network_id: StrictStr,
        update_network_wireless_billing_request: Optional[UpdateNetworkWirelessBillingRequest] = None,
        _request_timeout: Union[
    ...
    def _update_network_wireless_billing_1_serialize(
        self,
        network_id,
