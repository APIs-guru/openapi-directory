...
class ByUtilizationApi:
    ...
    @validate_call
    def get_organization_summary_top_appliances_by_utilization_4(
        self,
        ...
        _param = self._get_organization_summary_top_appliances_by_utilization_4_serialize(
    ...
    @validate_call
    def get_organization_summary_top_appliances_by_utilization_4_with_http_info(
        self,
        organization_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    @validate_call
    def get_organization_summary_top_appliances_by_utilization_4_without_preload_content(
        self,
        organization_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 31 days after t0.")] = None,
    ...
    def _get_organization_summary_top_appliances_by_utilization_4_serialize(
        self,
        organization_id,
        t0,
        t1,
