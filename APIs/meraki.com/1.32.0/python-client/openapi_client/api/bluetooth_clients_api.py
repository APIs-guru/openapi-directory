...
class BluetoothClientsApi:
    ...
    @validate_call
    def get_network_bluetooth_client_1(
        self,
        ...
        _param = self._get_network_bluetooth_client_1_serialize(
    ...
    @validate_call
    def get_network_bluetooth_client_1_with_http_info(
        self,
        network_id: StrictStr,
        bluetooth_client_id: StrictStr,
        include_connectivity_history: Annotated[Optional[StrictBool], Field(description="Include the connectivity history for this client")] = None,
    ...
    @validate_call
    def get_network_bluetooth_client_1_without_preload_content(
        self,
        network_id: StrictStr,
        bluetooth_client_id: StrictStr,
        include_connectivity_history: Annotated[Optional[StrictBool], Field(description="Include the connectivity history for this client")] = None,
    ...
    def _get_network_bluetooth_client_1_serialize(
        self,
        network_id,
        bluetooth_client_id,
    ...
    @validate_call
    def get_network_bluetooth_clients_1(
        self,
        network_id: StrictStr,
        ...
        _param = self._get_network_bluetooth_clients_1_serialize(
            network_id=network_id,
            t0=t0,
            timespan=timespan,
            per_page=per_page,
    ...
    @validate_call
    def get_network_bluetooth_clients_1_with_http_info(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 7 days from today.")] = None,
        timespan: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 7 days. The default is 1 day.")] = None,
    ...
    @validate_call
    def get_network_bluetooth_clients_1_without_preload_content(
        self,
        network_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 7 days from today.")] = None,
        timespan: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 7 days. The default is 1 day.")] = None,
    ...
    def _get_network_bluetooth_clients_1_serialize(
        self,
        network_id,
        t0,
        timespan,
