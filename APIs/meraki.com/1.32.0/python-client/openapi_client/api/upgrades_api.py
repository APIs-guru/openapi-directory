...
class UpgradesApi:
    ...
    @validate_call
    def get_organization_firmware_upgrades_2(
        self,
        ...
        _param = self._get_organization_firmware_upgrades_2_serialize(
    ...
    @validate_call
    def get_organization_firmware_upgrades_2_with_http_info(
        self,
        organization_id: StrictStr,
        status: Annotated[Optional[List[StrictStr]], Field(description="The status of an upgrade ")] = None,
        product_type: Annotated[Optional[List[StrictStr]], Field(description="The product type in a given upgrade ID")] = None,
    ...
    @validate_call
    def get_organization_firmware_upgrades_2_without_preload_content(
        self,
        organization_id: StrictStr,
        status: Annotated[Optional[List[StrictStr]], Field(description="The status of an upgrade ")] = None,
        product_type: Annotated[Optional[List[StrictStr]], Field(description="The product type in a given upgrade ID")] = None,
    ...
    def _get_organization_firmware_upgrades_2_serialize(
        self,
        organization_id,
        status,
        product_type,
    ...
    @validate_call
    def get_organization_firmware_upgrades_by_device_2(
        self,
        organization_id: StrictStr,
        ...
        _param = self._get_organization_firmware_upgrades_by_device_2_serialize(
            organization_id=organization_id,
            per_page=per_page,
    ...
    @validate_call
    def get_organization_firmware_upgrades_by_device_2_with_http_info(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 50. Default is 50.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    @validate_call
    def get_organization_firmware_upgrades_by_device_2_without_preload_content(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 50. Default is 50.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    def _get_organization_firmware_upgrades_by_device_2_serialize(
        self,
        organization_id,
        per_page,
        starting_after,
