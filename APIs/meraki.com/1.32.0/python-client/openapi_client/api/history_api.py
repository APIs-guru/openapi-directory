...
class HistoryApi:
    ...
    @validate_call
    def get_device_camera_analytics_zone_history_3(
        self,
        serial: StrictStr,
        zone_id: StrictStr,
        ...
        _param = self._get_device_camera_analytics_zone_history_3_serialize(
            serial=serial,
            zone_id=zone_id,
            t0=t0,
            t1=t1,
    ...
    @validate_call
    def get_device_camera_analytics_zone_history_3_with_http_info(
        self,
        serial: StrictStr,
        zone_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
    ...
    @validate_call
    def get_device_camera_analytics_zone_history_3_without_preload_content(
        self,
        serial: StrictStr,
        zone_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
    ...
    def _get_device_camera_analytics_zone_history_3_serialize(
        self,
        serial,
        zone_id,
        t0,
    ...
    @validate_call
    def get_network_alerts_history_2(
        self,
        ...
        _param = self._get_network_alerts_history_2_serialize(
    ...
    @validate_call
    def get_network_alerts_history_2_with_http_info(
        self,
        network_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 100.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    @validate_call
    def get_network_alerts_history_2_without_preload_content(
        self,
        network_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 100.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    def _get_network_alerts_history_2_serialize(
        self,
        network_id,
        per_page,
        starting_after,
    ...
    @validate_call
    def get_organization_sensor_readings_history_2(
        self,
        ...
        _param = self._get_organization_sensor_readings_history_2_serialize(
    ...
    @validate_call
    def get_organization_sensor_readings_history_2_with_http_info(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    @validate_call
    def get_organization_sensor_readings_history_2_without_preload_content(
        self,
        organization_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000. Default is 1000.")] = None,
        starting_after: Annotated[Optional[StrictStr], Field(description="A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.")] = None,
    ...
    def _get_organization_sensor_readings_history_2_serialize(
        self,
        organization_id,
        per_page,
        starting_after,
