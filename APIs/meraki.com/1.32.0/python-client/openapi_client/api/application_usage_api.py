...
class ApplicationUsageApi:
    ...
    @validate_call
    def get_network_clients_application_usage_2(
        self,
        ...
        _param = self._get_network_clients_application_usage_2_serialize(
    ...
    @validate_call
    def get_network_clients_application_usage_2_with_http_info(
        self,
        network_id: StrictStr,
        clients: Annotated[StrictStr, Field(description="A list of client keys, MACs or IPs separated by comma.")],
        ssid_number: Annotated[Optional[StrictInt], Field(description="An SSID number to include. If not specified, eveusage histories application usagents for all SSIDs will be returned.")] = None,
    ...
    @validate_call
    def get_network_clients_application_usage_2_without_preload_content(
        self,
        network_id: StrictStr,
        clients: Annotated[StrictStr, Field(description="A list of client keys, MACs or IPs separated by comma.")],
        ssid_number: Annotated[Optional[StrictInt], Field(description="An SSID number to include. If not specified, eveusage histories application usagents for all SSIDs will be returned.")] = None,
    ...
    def _get_network_clients_application_usage_2_serialize(
        self,
        network_id,
        clients,
        ssid_number,
