...
class DeviceTypeGroupPoliciesApi:
    ...
    @validate_call
    def get_network_wireless_ssid_device_type_group_policies_2(
        self,
        ...
        _param = self._get_network_wireless_ssid_device_type_group_policies_2_serialize(
    ...
    @validate_call
    def get_network_wireless_ssid_device_type_group_policies_2_with_http_info(
        self,
        network_id: StrictStr,
        number: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_network_wireless_ssid_device_type_group_policies_2_without_preload_content(
        self,
        network_id: StrictStr,
        number: StrictStr,
        _request_timeout: Union[
    ...
    def _get_network_wireless_ssid_device_type_group_policies_2_serialize(
        self,
        network_id,
        number,
        _request_auth,
    ...
    @validate_call
    def update_network_wireless_ssid_device_type_group_policies_2(
        self,
        network_id: StrictStr,
        number: StrictStr,
        ...
        _param = self._update_network_wireless_ssid_device_type_group_policies_2_serialize(
            network_id=network_id,
            number=number,
    ...
    @validate_call
    def update_network_wireless_ssid_device_type_group_policies_2_with_http_info(
        self,
        network_id: StrictStr,
        number: StrictStr,
        update_network_wireless_ssid_device_type_group_policies_request: Optional[UpdateNetworkWirelessSsidDeviceTypeGroupPoliciesRequest] = None,
    ...
    @validate_call
    def update_network_wireless_ssid_device_type_group_policies_2_without_preload_content(
        self,
        network_id: StrictStr,
        number: StrictStr,
        update_network_wireless_ssid_device_type_group_policies_request: Optional[UpdateNetworkWirelessSsidDeviceTypeGroupPoliciesRequest] = None,
    ...
    def _update_network_wireless_ssid_device_type_group_policies_2_serialize(
        self,
        network_id,
        number,
