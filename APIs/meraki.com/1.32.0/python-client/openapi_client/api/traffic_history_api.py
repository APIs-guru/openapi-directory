...
class TrafficHistoryApi:
    ...
    @validate_call
    def get_network_client_traffic_history_2(
        self,
        ...
        _param = self._get_network_client_traffic_history_2_serialize(
    ...
    @validate_call
    def get_network_client_traffic_history_2_with_http_info(
        self,
        network_id: StrictStr,
        client_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000.")] = None,
    ...
    @validate_call
    def get_network_client_traffic_history_2_without_preload_content(
        self,
        network_id: StrictStr,
        client_id: StrictStr,
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 1000.")] = None,
    ...
    def _get_network_client_traffic_history_2_serialize(
        self,
        network_id,
        client_id,
        per_page,
