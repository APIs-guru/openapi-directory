...
class SearchApi:
    ...
    @validate_call
    def get_organization_clients_search_2(
        self,
        ...
        _param = self._get_organization_clients_search_2_serialize(
    ...
    @validate_call
    def get_organization_clients_search_2_with_http_info(
        self,
        organization_id: StrictStr,
        mac: Annotated[StrictStr, Field(description="The MAC address of the client. Required.")],
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 5. Default is 5.")] = None,
    ...
    @validate_call
    def get_organization_clients_search_2_without_preload_content(
        self,
        organization_id: StrictStr,
        mac: Annotated[StrictStr, Field(description="The MAC address of the client. Required.")],
        per_page: Annotated[Optional[StrictInt], Field(description="The number of entries per page returned. Acceptable range is 3 - 5. Default is 5.")] = None,
    ...
    def _get_organization_clients_search_2_serialize(
        self,
        organization_id,
        mac,
        per_page,
