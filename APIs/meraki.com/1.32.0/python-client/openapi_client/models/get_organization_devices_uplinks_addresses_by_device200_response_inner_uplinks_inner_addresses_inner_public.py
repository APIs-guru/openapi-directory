...
class GetOrganizationDevicesUplinksAddressesByDevice200ResponseInnerUplinksInnerAddressesInnerPublic(BaseModel):
    """
    Public interface information.
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The device uplink public IP address.")
