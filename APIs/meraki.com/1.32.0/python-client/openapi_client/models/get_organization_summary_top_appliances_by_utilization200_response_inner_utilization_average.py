...
class GetOrganizationSummaryTopAppliancesByUtilization200ResponseInnerUtilizationAverage(BaseModel):
    """
    Average utilization of the appliance
    """ # noqa: E501
    percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average percentage utilization of the appliance")
