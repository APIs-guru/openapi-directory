...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastAck(BaseModel):
    """
    Attributes of the server's last ack.
    """ # noqa: E501
    ipv4: Optional[GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastAckIpv4] = None
    ts: Optional[datetime] = Field(default=None, description="Last time the server was acked.")
    __properties: ClassVar[List[str]] = ["ipv4", "ts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastAckIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ts": obj.get("ts")
        })
        return _obj
