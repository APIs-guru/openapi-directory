...
class GetNetworkWirelessLatencyHistory200ResponseInner(BaseModel):
    """
    GetNetworkWirelessLatencyHistory200ResponseInner
    """ # noqa: E501
    avg_latency_ms: Optional[StrictInt] = Field(default=None, description="Average latency in milliseconds", alias="avgLatencyMs")
    ...
    __properties: ClassVar[List[str]] = ["avgLatencyMs", "endTs", "startTs"]
