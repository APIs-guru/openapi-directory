...
class GetOrganizationWirelessDevicesEthernetStatuses200ResponseInnerPowerPoe(BaseModel):
    """
    PoE power details object
    """ # noqa: E501
    is_connected: Optional[StrictBool] = Field(default=None, description="PoE power connected", alias="isConnected")
    __properties: ClassVar[List[str]] = ["isConnected"]
