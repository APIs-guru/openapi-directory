...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastAckIpv4(BaseModel):
    """
    IPv4 attributes of the last ack.
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="IPv4 address of the last ack.")
