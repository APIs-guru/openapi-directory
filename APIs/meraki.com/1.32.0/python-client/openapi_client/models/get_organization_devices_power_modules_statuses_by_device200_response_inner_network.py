...
class GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInnerNetwork(BaseModel):
    """
    Network info.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID for the network that the device is associated with.")
