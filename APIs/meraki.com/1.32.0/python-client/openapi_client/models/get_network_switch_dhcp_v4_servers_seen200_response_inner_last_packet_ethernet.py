...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastPacketEthernet(BaseModel):
    """
    Additional ethernet attributes of the packet.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Ethernet type of the packet.")
