...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerDeviceInterface(BaseModel):
    """
    Interface attributes of the server. Only for configured servers.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Interface name.")
    url: Optional[StrictStr] = Field(default=None, description="Url link to interface.")
