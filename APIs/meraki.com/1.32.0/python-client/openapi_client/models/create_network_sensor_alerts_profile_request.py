...
class CreateNetworkSensorAlertsProfileRequest(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the sensor alert profile.")
    recipients: Optional[GetNetworkSensorAlertsProfiles200ResponseInnerRecipients] = None
    schedule: Optional[CreateNetworkSensorAlertsProfileRequestSchedule] = None
    ...
    __properties: ClassVar[List[str]] = ["conditions", "name", "recipients", "schedule", "serials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": CreateNetworkSensorAlertsProfileRequestSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None,
