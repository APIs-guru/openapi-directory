...
class UpdateNetworkWirelessSsidRequestLdapServersInner(BaseModel):
    """
    UpdateNetworkWirelessSsidRequestLdapServersInner
    """ # noqa: E501
    host: StrictStr = Field(description="IP address of your LDAP server.")
    port: StrictInt = Field(description="UDP port the LDAP server listens on.")
