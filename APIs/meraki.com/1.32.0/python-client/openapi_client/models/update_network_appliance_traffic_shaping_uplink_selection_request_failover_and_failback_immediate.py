...
class UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestFailoverAndFailbackImmediate(BaseModel):
    """
    Immediate WAN transition terminates all flows (new and existing) on current WAN when it is deemed unreliable.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Toggle for enabling or disabling immediate WAN failover and failback")
