...
class GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThresholdDoor(BaseModel):
    """
    Door open threshold. 'open' must be provided and set to true.
    """ # noqa: E501
    open: StrictBool = Field(description="Alerting threshold for a door open event. Must be set to true.")
