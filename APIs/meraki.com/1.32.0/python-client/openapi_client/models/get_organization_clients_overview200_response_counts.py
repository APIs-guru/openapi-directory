...
class GetOrganizationClientsOverview200ResponseCounts(BaseModel):
    """
    Client count information
    """ # noqa: E501
    total: Optional[StrictInt] = Field(default=None, description="Total number of clients with data usage in organization")
