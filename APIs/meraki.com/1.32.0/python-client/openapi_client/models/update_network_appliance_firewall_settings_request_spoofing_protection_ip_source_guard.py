...
class UpdateNetworkApplianceFirewallSettingsRequestSpoofingProtectionIpSourceGuard(BaseModel):
    """
    IP source address spoofing settings
    """ # noqa: E501
    mode: Optional[StrictStr] = Field(default=None, description="Mode of protection")
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['block', 'log']):
            raise ValueError("must be one of enum values ('block', 'log')")
        return value
