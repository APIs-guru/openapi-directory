...
class UpdateNetworkFirmwareUpgradesRequestProductsAppliance(BaseModel):
    """
    The network device to be updated
    """ # noqa: E501
    next_upgrade: Optional[UpdateNetworkFirmwareUpgradesRequestProductsApplianceNextUpgrade] = Field(default=None, alias="nextUpgrade")
    ...
    __properties: ClassVar[List[str]] = ["nextUpgrade", "participateInNextBetaRelease"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nextUpgrade": UpdateNetworkFirmwareUpgradesRequestProductsApplianceNextUpgrade.from_dict(obj["nextUpgrade"]) if obj.get("nextUpgrade") is not None else None,
