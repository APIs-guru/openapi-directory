...
class GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner(BaseModel):
    """
    ...
    model: Optional[StrictStr] = Field(default=None, description="Uplink model")
    ...
    __properties: ClassVar[List[str]] = ["apn", "connectionType", "dns1", "dns2", "gateway", "iccid", "interface", "ip", "model", "provider", "publicIp", "signalStat", "signalType", "status"]
