...
class UpdateNetworkSwitchDhcpServerPolicyRequestArpInspection(BaseModel):
    """
    Dynamic ARP Inspection settings
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Enable or disable Dynamic ARP Inspection on the network. Default value is false.")
