...
class MoveOrganizationLicensingCotermLicensesRequestLicensesInnerCountsInner(BaseModel):
    """
    MoveOrganizationLicensingCotermLicensesRequestLicensesInnerCountsInner
    """ # noqa: E501
    count: StrictInt = Field(description="The number of counts to move")
    model: StrictStr = Field(description="The license model type to move counts of")
