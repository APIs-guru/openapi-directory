...
class GetOrganizationInsightApplications200ResponseInnerThresholdsByNetworkInner(BaseModel):
    """
    GetOrganizationInsightApplications200ResponseInnerThresholdsByNetworkInner
    """ # noqa: E501
    goodput: Optional[StrictInt] = Field(default=None, description="Number of useful information bits delivered over a network per unit of time")
    ...
    __properties: ClassVar[List[str]] = ["goodput", "networkId", "responseDuration"]
