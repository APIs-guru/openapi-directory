...
class GetNetworkApplianceTrafficShapingUplinkSelection200ResponseWanTrafficUplinkPreferencesInnerTrafficFiltersInnerValue(BaseModel):
    """
    ...
    protocol: Optional[StrictStr] = Field(default=None, description="Protocol of 'custom' type traffic filter. Must be one of: 'tcp', 'udp', 'icmp6' or 'any'")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": GetNetworkApplianceTrafficShapingUplinkSelection200ResponseWanTrafficUplinkPreferencesInnerTrafficFiltersInnerValueDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            "protocol": obj.get("protocol"),
            "source": GetNetworkApplianceTrafficShapingUplinkSelection200ResponseWanTrafficUplinkPreferencesInnerTrafficFiltersInnerValueSource.from_dict(obj["source"]) if obj.get("source") is not None else None
        })
        return _obj
