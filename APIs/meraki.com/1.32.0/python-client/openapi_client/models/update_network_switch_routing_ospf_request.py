...
class UpdateNetworkSwitchRoutingOspfRequest(BaseModel):
    """
    UpdateNetworkSwitchRoutingOspfRequest
    """ # noqa: E501
    areas: Optional[List[UpdateNetworkSwitchRoutingOspfRequestAreasInner]] = Field(default=None, description="OSPF areas")
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Boolean value to enable or disable OSPF routing. OSPF routing is disabled by default.")
    ...
    md5_authentication_enabled: Optional[StrictBool] = Field(default=None, description="Boolean value to enable or disable MD5 authentication. MD5 authentication is disabled by default.", alias="md5AuthenticationEnabled")
    md5_authentication_key: Optional[UpdateNetworkSwitchRoutingOspfRequestMd5AuthenticationKey] = Field(default=None, alias="md5AuthenticationKey")
    v3: Optional[UpdateNetworkSwitchRoutingOspfRequestV3] = None
    __properties: ClassVar[List[str]] = ["areas", "deadTimerInSeconds", "enabled", "helloTimerInSeconds", "md5AuthenticationEnabled", "md5AuthenticationKey", "v3"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.areas:
            ...
            _dict['areas'] = _items
        # override the default output from pydantic by calling `to_dict()` of md5_authentication_key
        if self.md5_authentication_key:
            _dict['md5AuthenticationKey'] = self.md5_authentication_key.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "md5AuthenticationEnabled": obj.get("md5AuthenticationEnabled"),
            "md5AuthenticationKey": UpdateNetworkSwitchRoutingOspfRequestMd5AuthenticationKey.from_dict(obj["md5AuthenticationKey"]) if obj.get("md5AuthenticationKey") is not None else None,
            "v3": UpdateNetworkSwitchRoutingOspfRequestV3.from_dict(obj["v3"]) if obj.get("v3") is not None else None
        })
        return _obj
