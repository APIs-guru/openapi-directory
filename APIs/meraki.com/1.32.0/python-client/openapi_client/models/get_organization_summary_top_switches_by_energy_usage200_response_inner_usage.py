...
class GetOrganizationSummaryTopSwitchesByEnergyUsage200ResponseInnerUsage(BaseModel):
    """
    Energy usage of the switch
    """ # noqa: E501
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total energy usage of the switch")
