...
class UpdateNetworkWirelessSsidRequestActiveDirectoryCredentials(BaseModel):
    """
    ...
    """ # noqa: E501
    logon_name: Optional[StrictStr] = Field(default=None, description="The logon name of the Active Directory account.", alias="logonName")
    password: Optional[StrictStr] = Field(default=None, description="The password to the Active Directory user account.")
    __properties: ClassVar[List[str]] = ["logonName", "password"]
