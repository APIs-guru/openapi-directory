...
class UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequestIpv4(BaseModel):
    """
    The updated IPv4 attributes of the trusted server
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The updated IPv4 address of the trusted server")
