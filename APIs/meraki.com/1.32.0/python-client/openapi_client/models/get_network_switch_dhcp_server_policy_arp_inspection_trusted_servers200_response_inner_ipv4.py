...
class GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServers200ResponseInnerIpv4(BaseModel):
    """
    IPv4 attributes of the trusted server.
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="IPv4 address of the trusted server.")
