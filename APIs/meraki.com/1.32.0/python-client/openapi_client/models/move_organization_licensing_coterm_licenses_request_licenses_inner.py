...
class MoveOrganizationLicensingCotermLicensesRequestLicensesInner(BaseModel):
    """
    MoveOrganizationLicensingCotermLicensesRequestLicensesInner
    """ # noqa: E501
    counts: List[MoveOrganizationLicensingCotermLicensesRequestLicensesInnerCountsInner] = Field(description="The counts to move from the license by model type")
    key: StrictStr = Field(description="The license key to move counts from")
    __properties: ClassVar[List[str]] = ["counts", "key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [MoveOrganizationLicensingCotermLicensesRequestLicensesInnerCountsInner.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None,
            "key": obj.get("key")
        })
        return _obj
