...
class GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClients(BaseModel):
    """
    Clients info of the SSID
    """ # noqa: E501
    counts: Optional[GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClientsCounts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClientsCounts.from_dict(obj["counts"]) if obj.get("counts") is not None else None
        })
        return _obj
