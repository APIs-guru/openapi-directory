...
class GetNetworkSensorAlertsOverviewByMetric200ResponseInnerCountsNoise(BaseModel):
    """
    Object containing the number of sensor alerts that occurred due to noise readings
    """ # noqa: E501
    ambient: Optional[StrictInt] = Field(default=None, description="Number of sensor alerts that occurred due to ambient noise readings")
