...
class UpdateNetworkApplianceConnectivityMonitoringDestinationsRequest(BaseModel):
    """
    UpdateNetworkApplianceConnectivityMonitoringDestinationsRequest
    """ # noqa: E501
    destinations: Optional[List[UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestDestinationsInner]] = Field(default=None, description="The list of connectivity monitoring destinations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destinations": [UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestDestinationsInner.from_dict(_item) for _item in obj["destinations"]] if obj.get("destinations") is not None else None
        })
        return _obj
