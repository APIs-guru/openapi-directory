...
class GetOrganizationClientsOverview200ResponseUsage(BaseModel):
    """
    Usage information of all clients across organization
    """ # noqa: E501
    average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average data usage (in kb) of each client in organization")
    overall: Optional[GetOrganizationClientsOverview200ResponseUsageOverall] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overall": GetOrganizationClientsOverview200ResponseUsageOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None
        })
        return _obj
