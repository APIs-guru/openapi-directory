...
class UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInnerMilestones(BaseModel):
    """
    The Staged Upgrade Milestones for the specific stage
    """ # noqa: E501
    scheduled_for: StrictStr = Field(description="The start time of the staged upgrade stage. (In ISO-8601 format, in the time zone of the network.)", alias="scheduledFor")
    __properties: ClassVar[List[str]] = ["scheduledFor"]
