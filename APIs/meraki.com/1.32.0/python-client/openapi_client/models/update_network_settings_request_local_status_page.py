...
class UpdateNetworkSettingsRequestLocalStatusPage(BaseModel):
    """
    A hash of Local Status page(s)' authentication options applied to the Network.
    """ # noqa: E501
    authentication: Optional[UpdateNetworkSettingsRequestLocalStatusPageAuthentication] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authentication": UpdateNetworkSettingsRequestLocalStatusPageAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
        return _obj
