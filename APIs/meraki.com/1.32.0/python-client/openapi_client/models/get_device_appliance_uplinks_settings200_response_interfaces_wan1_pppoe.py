...
class GetDeviceApplianceUplinksSettings200ResponseInterfacesWan1Pppoe(BaseModel):
    """
    Configuration options for PPPoE.
    """ # noqa: E501
    authentication: Optional[GetDeviceApplianceUplinksSettings200ResponseInterfacesWan1PppoeAuthentication] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authentication": GetDeviceApplianceUplinksSettings200ResponseInterfacesWan1PppoeAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None,
