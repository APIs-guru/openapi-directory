...
class GetNetworkSensorAlertsCurrentOverviewByMetric200ResponseCountsNoise(BaseModel):
    """
    Object containing the number of sensors that are currently alerting due to noise readings
    """ # noqa: E501
    ambient: Optional[StrictInt] = Field(default=None, description="Number of sensors that are currently alerting due to ambient noise readings")
    __properties: ClassVar[List[str]] = ["ambient"]
