...
class UpdateNetworkApplianceSsidRequestDhcpEnforcedDeauthentication(BaseModel):
    """
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Enable DCHP Enforced Deauthentication on the SSID.")
