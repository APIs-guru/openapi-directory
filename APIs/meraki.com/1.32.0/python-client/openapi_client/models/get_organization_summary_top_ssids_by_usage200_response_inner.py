...
class GetOrganizationSummaryTopSsidsByUsage200ResponseInner(BaseModel):
    """
    GetOrganizationSummaryTopSsidsByUsage200ResponseInner
    """ # noqa: E501
    clients: Optional[GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClients] = None
    name: Optional[StrictStr] = Field(default=None, description="Name of the SSID")
    usage: Optional[GetOrganizationSummaryTopSsidsByUsage200ResponseInnerUsage] = None
    __properties: ClassVar[List[str]] = ["clients", "name", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clients": GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClients.from_dict(obj["clients"]) if obj.get("clients") is not None else None,
            "name": obj.get("name"),
            "usage": GetOrganizationSummaryTopSsidsByUsage200ResponseInnerUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
