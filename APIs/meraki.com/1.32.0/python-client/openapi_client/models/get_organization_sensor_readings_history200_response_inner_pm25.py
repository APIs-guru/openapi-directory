...
class GetOrganizationSensorReadingsHistory200ResponseInnerPm25(BaseModel):
    """
    Reading for the 'pm25' metric. This will only be present if the 'metric' property equals 'pm25'.
    """ # noqa: E501
    concentration: Optional[StrictInt] = Field(default=None, description="PM2.5 reading in micrograms per cubic meter.")
