...
class CreateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequestIpv4(BaseModel):
    """
    The IPv4 attributes of the trusted server being added
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The IPv4 address of the trusted server being added")
