...
class GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeStagedGroup(BaseModel):
    """
    The staged upgrade group
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id of the staged upgrade group")
