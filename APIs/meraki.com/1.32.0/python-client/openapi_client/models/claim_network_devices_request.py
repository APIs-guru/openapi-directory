...
class ClaimNetworkDevicesRequest(BaseModel):
    """
    ClaimNetworkDevicesRequest
    """ # noqa: E501
    serials: List[StrictStr] = Field(description="A list of serials of devices to claim")
    __properties: ClassVar[List[str]] = ["serials"]
