...
class GetOrganizationInventoryOnboardingCloudMonitoringImports200ResponseInner(BaseModel):
    """
    GetOrganizationInventoryOnboardingCloudMonitoringImports200ResponseInner
    """ # noqa: E501
    device: Optional[GetOrganizationInventoryOnboardingCloudMonitoringImports200ResponseInnerDevice] = None
    import_id: Optional[StrictStr] = Field(default=None, description="Database ID for the new entity entry.", alias="importId")
    __properties: ClassVar[List[str]] = ["device", "importId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": GetOrganizationInventoryOnboardingCloudMonitoringImports200ResponseInnerDevice.from_dict(obj["device"]) if obj.get("device") is not None else None,
