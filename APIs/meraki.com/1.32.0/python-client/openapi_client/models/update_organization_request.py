...
class UpdateOrganizationRequest(BaseModel):
    ...
    """ # noqa: E501
    api: Optional[UpdateOrganizationRequestApi] = None
    ...
    __properties: ClassVar[List[str]] = ["api", "management", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": UpdateOrganizationRequestApi.from_dict(obj["api"]) if obj.get("api") is not None else None,
