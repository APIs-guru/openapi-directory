...
class UpdateNetworkWirelessSsidRequestOauth(BaseModel):
    """
    The OAuth settings of this SSID. Only valid if splashPage is 'Google OAuth'.
    """ # noqa: E501
    allowed_domains: Optional[List[StrictStr]] = Field(default=None, description="(Optional) The list of domains allowed access to the network.", alias="allowedDomains")
    __properties: ClassVar[List[str]] = ["allowedDomains"]
