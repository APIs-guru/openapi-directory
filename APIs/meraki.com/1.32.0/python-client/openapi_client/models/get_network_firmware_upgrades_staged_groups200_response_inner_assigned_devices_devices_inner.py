...
class GetNetworkFirmwareUpgradesStagedGroups200ResponseInnerAssignedDevicesDevicesInner(BaseModel):
    """
    ...
    serial: Optional[StrictStr] = Field(default=None, description="Serial of the device")
    __properties: ClassVar[List[str]] = ["name", "serial"]
