...
class GetNetworkWebhooksPayloadTemplates200ResponseInnerHeadersInner(BaseModel):
    """
    GetNetworkWebhooksPayloadTemplates200ResponseInnerHeadersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the header attribute")
    template: Optional[StrictStr] = Field(default=None, description="The value returned in the header attribute, in liquid template")
