...
class CreateNetworkFirmwareUpgradesStagedEventRequest(BaseModel):
    """
    CreateNetworkFirmwareUpgradesStagedEventRequest
    """ # noqa: E501
    products: Optional[CreateNetworkFirmwareUpgradesStagedEventRequestProducts] = None
    stages: List[UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInner] = Field(description="All firmware upgrade stages in the network with their start time.")
    __properties: ClassVar[List[str]] = ["products", "stages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": CreateNetworkFirmwareUpgradesStagedEventRequestProducts.from_dict(obj["products"]) if obj.get("products") is not None else None,
