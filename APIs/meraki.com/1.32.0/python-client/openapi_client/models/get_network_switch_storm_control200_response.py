...
class GetNetworkSwitchStormControl200Response(BaseModel):
    """
    GetNetworkSwitchStormControl200Response
    """ # noqa: E501
    broadcast_threshold: Optional[StrictInt] = Field(default=None, description="Broadcast threshold.", alias="broadcastThreshold")
    multicast_threshold: Optional[StrictInt] = Field(default=None, description="Multicast threshold.", alias="multicastThreshold")
    unknown_unicast_threshold: Optional[StrictInt] = Field(default=None, description="Unknown Unicast threshold.", alias="unknownUnicastThreshold")
