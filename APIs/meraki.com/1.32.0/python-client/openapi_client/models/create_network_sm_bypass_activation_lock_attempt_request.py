...
class CreateNetworkSmBypassActivationLockAttemptRequest(BaseModel):
    """
    CreateNetworkSmBypassActivationLockAttemptRequest
    """ # noqa: E501
    ids: List[StrictStr] = Field(description="The ids of the devices to attempt activation lock bypass.")
