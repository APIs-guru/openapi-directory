...
class CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV21MV71(BaseModel):
    """
    ...
    resolution: StrictStr = Field(description="Resolution of the camera. Can be one of '1280x720'.")
    ...
    def resolution_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['1280x720']):
            raise ValueError("must be one of enum values ('1280x720')")
        return value
