...
class CreateNetworkWirelessRfProfileRequestTransmission(BaseModel):
    """
    Settings related to radio transmission.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Toggle for radio transmission. When false, radios will not transmit at all.")
