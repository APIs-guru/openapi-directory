...
class CreateNetworkSwitchAccessPolicyRequest(BaseModel):
    """
    ...
    host_mode: StrictStr = Field(description="Choose the Host Mode for the access policy.", alias="hostMode")
    ...
    name: StrictStr = Field(description="Name of the access policy")
    radius: Optional[GetNetworkSwitchAccessPolicies200ResponseInnerRadius] = None
    radius_accounting_enabled: StrictBool = Field(description="Enable to send start, interim-update and stop messages to a configured RADIUS accounting server for tracking connected clients", alias="radiusAccountingEnabled")
    ...
    radius_coa_support_enabled: StrictBool = Field(description="Change of authentication for RADIUS re-authentication and disconnection", alias="radiusCoaSupportEnabled")
    ...
    radius_servers: List[CreateNetworkSwitchAccessPolicyRequestRadiusServersInner] = Field(description="List of RADIUS servers to require connecting devices to authenticate against before granting network access", alias="radiusServers")
    radius_testing_enabled: StrictBool = Field(description="If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers", alias="radiusTestingEnabled")
    url_redirect_walled_garden_enabled: StrictBool = Field(description="Enable to restrict access for clients to a specific set of IP addresses or hostnames prior to authentication", alias="urlRedirectWalledGardenEnabled")
