...
class GetOrganizationSensorReadingsHistory200ResponseInnerIndoorAirQuality(BaseModel):
    """
    Reading for the 'indoorAirQuality' metric. This will only be present if the 'metric' property equals 'indoorAirQuality'.
    """ # noqa: E501
    score: Optional[StrictInt] = Field(default=None, description="Indoor air quality score between 0 and 100.")
