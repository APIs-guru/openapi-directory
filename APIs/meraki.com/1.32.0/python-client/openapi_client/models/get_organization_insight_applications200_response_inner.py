...
class GetOrganizationInsightApplications200ResponseInner(BaseModel):
    """
    GetOrganizationInsightApplications200ResponseInner
    """ # noqa: E501
    application_id: Optional[StrictStr] = Field(default=None, description="Application identifier", alias="applicationId")
    name: Optional[StrictStr] = Field(default=None, description="Application name")
    thresholds: Optional[GetOrganizationInsightApplications200ResponseInnerThresholds] = None
    __properties: ClassVar[List[str]] = ["applicationId", "name", "thresholds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "thresholds": GetOrganizationInsightApplications200ResponseInnerThresholds.from_dict(obj["thresholds"]) if obj.get("thresholds") is not None else None
        })
        return _obj
