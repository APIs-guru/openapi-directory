...
class UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestVpnTrafficUplinkPreferencesInnerTrafficFiltersInner(BaseModel):
    """
    UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestVpnTrafficUplinkPreferencesInnerTrafficFiltersInner
    """ # noqa: E501
    type: StrictStr = Field(description="Type of this traffic filter. Must be one of: 'applicationCategory', 'application' or 'custom'")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "value": UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestVpnTrafficUplinkPreferencesInnerTrafficFiltersInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
