...
class CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV13(BaseModel):
    """
    ...
    resolution: StrictStr = Field(description="Resolution of the camera. Can be one of '1080x1080' or '2688x1512'.")
    ...
    def resolution_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['1080x1080', '2688x1512']):
            raise ValueError("must be one of enum values ('1080x1080', '2688x1512')")
        return value
