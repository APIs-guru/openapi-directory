...
class GetOrganizationSummaryTopDevicesByUsage200ResponseInner(BaseModel):
    """
    GetOrganizationSummaryTopDevicesByUsage200ResponseInner
    """ # noqa: E501
    clients: Optional[GetOrganizationSummaryTopDevicesByUsage200ResponseInnerClients] = None
    ...
    usage: Optional[GetOrganizationSummaryTopDevicesByUsage200ResponseInnerUsage] = None
    __properties: ClassVar[List[str]] = ["clients", "mac", "model", "name", "network", "productType", "serial", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clients": GetOrganizationSummaryTopDevicesByUsage200ResponseInnerClients.from_dict(obj["clients"]) if obj.get("clients") is not None else None,
            "mac": obj.get("mac"),
            "model": obj.get("model"),
            "name": obj.get("name"),
            ...
            "usage": GetOrganizationSummaryTopDevicesByUsage200ResponseInnerUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
