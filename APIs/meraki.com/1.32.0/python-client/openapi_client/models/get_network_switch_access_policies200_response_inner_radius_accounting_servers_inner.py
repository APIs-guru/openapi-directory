...
class GetNetworkSwitchAccessPolicies200ResponseInnerRadiusAccountingServersInner(BaseModel):
    """
    GetNetworkSwitchAccessPolicies200ResponseInnerRadiusAccountingServersInner
    """ # noqa: E501
    host: Optional[StrictStr] = Field(default=None, description="Public IP address of the RADIUS accounting server")
    port: Optional[StrictInt] = Field(default=None, description="UDP port that the RADIUS Accounting server listens on for access requests")
