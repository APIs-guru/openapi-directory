...
class GetOrganizationSmApnsCert200Response(BaseModel):
    """
    GetOrganizationSmApnsCert200Response
    """ # noqa: E501
    certificate: Optional[StrictStr] = Field(default=None, description="Organization APNS Certificate used by devices to communication with Apple")
