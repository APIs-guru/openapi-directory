...
class UpdateNetworkApplianceStaticRouteRequest(BaseModel):
    """
    ...
    gateway_vlan_id: Optional[StrictStr] = Field(default=None, description="The gateway IP (next hop) VLAN ID of the static route", alias="gatewayVlanId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the static route")
    reserved_ip_ranges: Optional[List[UpdateNetworkApplianceStaticRouteRequestReservedIpRangesInner]] = Field(default=None, description="The DHCP reserved IP ranges on the static route", alias="reservedIpRanges")
    subnet: Optional[StrictStr] = Field(default=None, description="The subnet of the static route")
    __properties: ClassVar[List[str]] = ["enabled", "fixedIpAssignments", "gatewayIp", "gatewayVlanId", "name", "reservedIpRanges", "subnet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gatewayVlanId": obj.get("gatewayVlanId"),
            "name": obj.get("name"),
