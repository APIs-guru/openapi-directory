...
class GetOrganizationSensorReadingsHistory200ResponseInnerTvoc(BaseModel):
    """
    Reading for the 'tvoc' metric. This will only be present if the 'metric' property equals 'tvoc'.
    """ # noqa: E501
    concentration: Optional[StrictInt] = Field(default=None, description="TVOC reading in micrograms per cubic meter.")
    __properties: ClassVar[List[str]] = ["concentration"]
