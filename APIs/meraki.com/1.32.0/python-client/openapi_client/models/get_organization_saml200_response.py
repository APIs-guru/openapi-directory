...
class GetOrganizationSaml200Response(BaseModel):
    """
    GetOrganizationSaml200Response
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Toggle depicting if SAML SSO settings are enabled")
