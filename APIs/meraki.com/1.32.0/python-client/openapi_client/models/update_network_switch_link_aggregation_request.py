...
class UpdateNetworkSwitchLinkAggregationRequest(BaseModel):
    """
    UpdateNetworkSwitchLinkAggregationRequest
    """ # noqa: E501
    switch_ports: Optional[List[CreateNetworkSwitchLinkAggregationRequestSwitchPortsInner]] = Field(default=None, description="Array of switch or stack ports for updating aggregation group. Minimum 2 and maximum 8 ports are supported.", alias="switchPorts")
    switch_profile_ports: Optional[List[CreateNetworkSwitchLinkAggregationRequestSwitchProfilePortsInner]] = Field(default=None, description="Array of switch profile ports for updating aggregation group. Minimum 2 and maximum 8 ports are supported.", alias="switchProfilePorts")
