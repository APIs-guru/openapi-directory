...
class GetNetworkApplianceVpnSiteToSiteVpn200Response(BaseModel):
    """
    GetNetworkApplianceVpnSiteToSiteVpn200Response
    """ # noqa: E501
    hubs: Optional[List[GetNetworkApplianceVpnSiteToSiteVpn200ResponseHubsInner]] = Field(default=None, description="The list of VPN hubs, in order of preference.")
    mode: Optional[StrictStr] = Field(default=None, description="The site-to-site VPN mode.")
    subnets: Optional[List[GetNetworkApplianceVpnSiteToSiteVpn200ResponseSubnetsInner]] = Field(default=None, description="The list of subnets and their VPN presence.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hubs": [GetNetworkApplianceVpnSiteToSiteVpn200ResponseHubsInner.from_dict(_item) for _item in obj["hubs"]] if obj.get("hubs") is not None else None,
            "mode": obj.get("mode"),
            "subnets": [GetNetworkApplianceVpnSiteToSiteVpn200ResponseSubnetsInner.from_dict(_item) for _item in obj["subnets"]] if obj.get("subnets") is not None else None
        })
        return _obj
