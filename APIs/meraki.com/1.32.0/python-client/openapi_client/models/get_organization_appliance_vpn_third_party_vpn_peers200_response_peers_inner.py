...
class GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the VPN peer")
    ...
    private_subnets: Optional[List[StrictStr]] = Field(default=None, description="The list of the private subnets of the VPN peer", alias="privateSubnets")
    ...
    secret: Optional[StrictStr] = Field(default=None, description="The shared secret with the VPN peer")
