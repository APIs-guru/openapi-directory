...
class UpdateNetworkWirelessSsidSplashSettingsRequestSentryEnrollmentSystemsManagerNetwork(BaseModel):
    """
    Systems Manager network targeted for sentry enrollment.
    """ # noqa: E501
    id: StrictStr = Field(description="The network ID of the Systems Manager network.")
