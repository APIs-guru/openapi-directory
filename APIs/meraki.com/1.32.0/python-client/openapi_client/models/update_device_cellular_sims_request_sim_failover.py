...
class UpdateDeviceCellularSimsRequestSimFailover(BaseModel):
    """
    SIM Failover settings.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Failover to secondary SIM (optional)")
