...
class GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner(BaseModel):
    """
    ...
    link_negotiation_capabilities: Optional[List[StrictStr]] = Field(default=None, description="Available link speeds for the switch profile port.", alias="linkNegotiationCapabilities")
    ...
    port_id: Optional[StrictStr] = Field(default=None, description="The identifier of the switch profile port.", alias="portId")
    ...
    __properties: ClassVar[List[str]] = ["accessPolicyNumber", "accessPolicyType", "allowedVlans", "daiTrusted", "enabled", "flexibleStackingEnabled", "isolationEnabled", "linkNegotiation", "linkNegotiationCapabilities", "macAllowList", "name", "poeEnabled", "portId", "portScheduleId", "profile", "rstpEnabled", "stickyMacAllowList", "stickyMacAllowListLimit", "stormControlEnabled", "stpGuard", "tags", "type", "udld", "vlan", "voiceVlan"]
