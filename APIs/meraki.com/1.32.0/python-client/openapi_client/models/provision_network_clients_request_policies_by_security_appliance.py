...
class ProvisionNetworkClientsRequestPoliciesBySecurityAppliance(BaseModel):
    ...
    """ # noqa: E501
    device_policy: Optional[StrictStr] = Field(default=None, description="The policy to apply to the specified client. Can be 'Allowed', 'Blocked' or 'Normal'. Required.", alias="devicePolicy")
    ...
    def device_policy_validate_enum(cls, value):
        ...
        if value not in set(['Allowed', 'Blocked', 'Normal']):
            raise ValueError("must be one of enum values ('Allowed', 'Blocked', 'Normal')")
        return value
