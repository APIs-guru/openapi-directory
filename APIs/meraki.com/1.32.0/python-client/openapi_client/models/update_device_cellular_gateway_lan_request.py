...
class UpdateDeviceCellularGatewayLanRequest(BaseModel):
    """
    UpdateDeviceCellularGatewayLanRequest
    """ # noqa: E501
    fixed_ip_assignments: Optional[List[UpdateDeviceCellularGatewayLanRequestFixedIpAssignmentsInner]] = Field(default=None, description="list of all fixed IP assignments for a single MG", alias="fixedIpAssignments")
    reserved_ip_ranges: Optional[List[UpdateDeviceCellularGatewayLanRequestReservedIpRangesInner]] = Field(default=None, description="list of all reserved IP ranges for a single MG", alias="reservedIpRanges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fixedIpAssignments": [UpdateDeviceCellularGatewayLanRequestFixedIpAssignmentsInner.from_dict(_item) for _item in obj["fixedIpAssignments"]] if obj.get("fixedIpAssignments") is not None else None,
            "reservedIpRanges": [UpdateDeviceCellularGatewayLanRequestReservedIpRangesInner.from_dict(_item) for _item in obj["reservedIpRanges"]] if obj.get("reservedIpRanges") is not None else None
        })
        return _obj
