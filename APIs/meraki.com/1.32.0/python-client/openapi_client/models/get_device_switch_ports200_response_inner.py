...
class GetDeviceSwitchPorts200ResponseInner(BaseModel):
    """
    GetDeviceSwitchPorts200ResponseInner
    """ # noqa: E501
    access_policy_number: Optional[StrictInt] = Field(default=None, description="The number of a custom access policy to configure on the switch port. Only applicable when 'accessPolicyType' is 'Custom access policy'.", alias="accessPolicyNumber")
    ...
    adaptive_policy_group_id: Optional[StrictStr] = Field(default=None, description="The adaptive policy group ID that will be used to tag traffic through this switch port. This ID must pre-exist during the configuration, else needs to be created using adaptivePolicy/groups API. Cannot be applied to a port on a switch bound to profile.", alias="adaptivePolicyGroupId")
    ...
    isolation_enabled: Optional[StrictBool] = Field(default=None, description="The isolation status of the switch port.", alias="isolationEnabled")
    ...
    link_negotiation_capabilities: Optional[List[StrictStr]] = Field(default=None, description="Available link speeds for the switch port.", alias="linkNegotiationCapabilities")
    ...
    peer_sgt_capable: Optional[StrictBool] = Field(default=None, description="If true, Peer SGT is enabled for traffic through this switch port. Applicable to trunk port only, not access port. Cannot be applied to a port on a switch bound to profile.", alias="peerSgtCapable")
    ...
    storm_control_enabled: Optional[StrictBool] = Field(default=None, description="The storm control status of the switch port.", alias="stormControlEnabled")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceSwitchPorts200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceSwitchPorts200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "adaptivePolicyGroupId": obj.get("adaptivePolicyGroupId"),
            ...
            "linkNegotiationCapabilities": obj.get("linkNegotiationCapabilities"),
            "macAllowList": obj.get("macAllowList"),
            "name": obj.get("name"),
            "peerSgtCapable": obj.get("peerSgtCapable"),
