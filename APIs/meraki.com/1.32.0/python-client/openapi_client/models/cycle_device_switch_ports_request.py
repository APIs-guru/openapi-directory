...
class CycleDeviceSwitchPortsRequest(BaseModel):
    """
    CycleDeviceSwitchPortsRequest
    """ # noqa: E501
    ports: List[StrictStr] = Field(description="List of switch ports. Example: [1, 2-5, 1_MA-MOD-8X10G_1, 1_MA-MOD-8X10G_2-1_MA-MOD-8X10G_8]")
