...
class GetNetworkWirelessSsidSplashSettings200ResponseSentryEnrollmentSystemsManagerNetwork(BaseModel):
    """
    Systems Manager network targeted for sentry enrollment.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The network ID of the Systems Manager network.")
