...
class GetNetworkSwitchAccessPolicies200ResponseInnerRadiusServersInner(BaseModel):
    """
    GetNetworkSwitchAccessPolicies200ResponseInnerRadiusServersInner
    """ # noqa: E501
    host: Optional[StrictStr] = Field(default=None, description="Public IP address of the RADIUS server")
    port: Optional[StrictInt] = Field(default=None, description="UDP port that the RADIUS server listens on for access requests")
