...
class GetOrganizationSensorReadingsHistory200ResponseInnerWater(BaseModel):
    """
    Reading for the 'water' metric. This will only be present if the 'metric' property equals 'water'.
    """ # noqa: E501
    present: Optional[StrictBool] = Field(default=None, description="True if water is detected.")
