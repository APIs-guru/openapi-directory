...
class CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequest(BaseModel):
    """
    CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequest
    """ # noqa: E501
    devices: List[CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequestDevicesInner] = Field(description="A set of devices to import (or update)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequestDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
