...
class GetNetworkClient200Response(BaseModel):
    """
    GetNetworkClient200Response
    """ # noqa: E501
    cdp: Optional[List[List[StrictStr]]] = Field(default=None, description="The Cisco discover protocol settings for the client")
    client_vpn_connections: Optional[List[GetNetworkClient200ResponseClientVpnConnectionsInner]] = Field(default=None, description="VPN connections associated with the client", alias="clientVpnConnections")
    ...
    lldp: Optional[List[List[StrictStr]]] = Field(default=None, description="The link layer discover protocol settings for the client")
    ...
    wireless_capabilities: Optional[StrictStr] = Field(default=None, description="Wireless capabilities of the client", alias="wirelessCapabilities")
    __properties: ClassVar[List[str]] = ["cdp", "clientVpnConnections", "description", "firstSeen", "id", "ip", "ip6", "lastSeen", "lldp", "mac", "manufacturer", "os", "recentDeviceMac", "smInstalled", "ssid", "status", "switchport", "user", "vlan", "wirelessCapabilities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in client_vpn_connections (list)
        _items = []
        if self.client_vpn_connections:
            for _item_client_vpn_connections in self.client_vpn_connections:
                if _item_client_vpn_connections:
                    _items.append(_item_client_vpn_connections.to_dict())
            _dict['clientVpnConnections'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cdp": obj.get("cdp"),
            "clientVpnConnections": [GetNetworkClient200ResponseClientVpnConnectionsInner.from_dict(_item) for _item in obj["clientVpnConnections"]] if obj.get("clientVpnConnections") is not None else None,
            ...
            "user": obj.get("user"),
            "vlan": obj.get("vlan"),
            "wirelessCapabilities": obj.get("wirelessCapabilities")
        })
        return _obj
