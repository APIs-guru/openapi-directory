...
class CreateNetworkSwitchStackRoutingInterfaceRequest(BaseModel):
    """
    ...
    ipv6: Optional[CreateNetworkSwitchStackRoutingInterfaceRequestIpv6] = None
    ...
    name: StrictStr = Field(description="A friendly name or description for the interface or VLAN.")
    ospf_settings: Optional[CreateNetworkSwitchStackRoutingInterfaceRequestOspfSettings] = Field(default=None, alias="ospfSettings")
    ...
    vlan_id: StrictInt = Field(description="The VLAN this routed interface is on. VLAN must be between 1 and 4094.", alias="vlanId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipv6": CreateNetworkSwitchStackRoutingInterfaceRequestIpv6.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None,
            "multicastRouting": obj.get("multicastRouting"),
            "name": obj.get("name"),
            "ospfSettings": CreateNetworkSwitchStackRoutingInterfaceRequestOspfSettings.from_dict(obj["ospfSettings"]) if obj.get("ospfSettings") is not None else None,
