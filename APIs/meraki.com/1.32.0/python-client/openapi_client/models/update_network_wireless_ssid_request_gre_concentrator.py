...
class UpdateNetworkWirelessSsidRequestGreConcentrator(BaseModel):
    """
    The EoGRE concentrator's settings
    """ # noqa: E501
    host: StrictStr = Field(description="The EoGRE concentrator's IP or FQDN. This param is required when ipAssignmentMode is 'Ethernet over GRE'.")
