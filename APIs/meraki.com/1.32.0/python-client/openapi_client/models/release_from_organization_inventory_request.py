...
class ReleaseFromOrganizationInventoryRequest(BaseModel):
    """
    ReleaseFromOrganizationInventoryRequest
    """ # noqa: E501
    serials: Optional[List[StrictStr]] = Field(default=None, description="Serials of the devices that should be released")
