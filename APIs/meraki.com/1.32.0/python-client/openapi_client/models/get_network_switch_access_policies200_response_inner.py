...
class GetNetworkSwitchAccessPolicies200ResponseInner(BaseModel):
    """
    ...
    radius_accounting_servers: Optional[List[GetNetworkSwitchAccessPolicies200ResponseInnerRadiusAccountingServersInner]] = Field(default=None, description="List of RADIUS accounting servers to require connecting devices to authenticate against before granting network access", alias="radiusAccountingServers")
    ...
    radius_servers: Optional[List[GetNetworkSwitchAccessPolicies200ResponseInnerRadiusServersInner]] = Field(default=None, description="List of RADIUS servers to require connecting devices to authenticate against before granting network access", alias="radiusServers")
    ...
    url_redirect_walled_garden_enabled: Optional[StrictBool] = Field(default=None, description="Enable to restrict access for clients to a response_objectific set of IP addresses or hostnames prior to authentication", alias="urlRedirectWalledGardenEnabled")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "radiusAccountingServers": [GetNetworkSwitchAccessPolicies200ResponseInnerRadiusAccountingServersInner.from_dict(_item) for _item in obj["radiusAccountingServers"]] if obj.get("radiusAccountingServers") is not None else None,
            "radiusCoaSupportEnabled": obj.get("radiusCoaSupportEnabled"),
            "radiusGroupAttribute": obj.get("radiusGroupAttribute"),
            "radiusServers": [GetNetworkSwitchAccessPolicies200ResponseInnerRadiusServersInner.from_dict(_item) for _item in obj["radiusServers"]] if obj.get("radiusServers") is not None else None,
