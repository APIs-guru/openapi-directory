...
class UpdateNetworkWirelessSsidRequestActiveDirectoryServersInner(BaseModel):
    """
    UpdateNetworkWirelessSsidRequestActiveDirectoryServersInner
    """ # noqa: E501
    host: StrictStr = Field(description="IP address of your Active Directory server.")
    port: Optional[StrictInt] = Field(default=None, description="(Optional) UDP port the Active Directory server listens on. By default, uses port 3268.")
