...
class UpdateNetworkWirelessSsidSchedulesRequestRangesInSecondsInner(BaseModel):
    """
    UpdateNetworkWirelessSsidSchedulesRequestRangesInSecondsInner
    """ # noqa: E501
    end: StrictInt = Field(description="Seconds since Sunday at midnight when that outage range ends.")
    start: StrictInt = Field(description="Seconds since Sunday at midnight when the outage range starts.")
