...
class GetNetworkSettings200ResponseSecurePort(BaseModel):
    """
    A hash of SecureConnect options applied to the Network.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Enables / disables SecureConnect on the network. Optional.")
