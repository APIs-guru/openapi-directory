...
class GetOrganizationWirelessDevicesEthernetStatuses200ResponseInnerPowerAc(BaseModel):
    """
    AC power details object
    """ # noqa: E501
    is_connected: Optional[StrictBool] = Field(default=None, description="AC power connected", alias="isConnected")
