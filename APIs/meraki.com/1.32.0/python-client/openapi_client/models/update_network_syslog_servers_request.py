...
class UpdateNetworkSyslogServersRequest(BaseModel):
    """
    UpdateNetworkSyslogServersRequest
    """ # noqa: E501
    servers: List[UpdateNetworkSyslogServersRequestServersInner] = Field(description="A list of the syslog servers for this network")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "servers": [UpdateNetworkSyslogServersRequestServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
        return _obj
