...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerDevice(BaseModel):
    """
    Attributes of the server when it's a device.
    """ # noqa: E501
    interface: Optional[GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerDeviceInterface] = None
    name: Optional[StrictStr] = Field(default=None, description="Device name.")
    serial: Optional[StrictStr] = Field(default=None, description="Device serial.")
    url: Optional[StrictStr] = Field(default=None, description="Url link to device.")
    __properties: ClassVar[List[str]] = ["interface", "name", "serial", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerDeviceInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "name": obj.get("name"),
