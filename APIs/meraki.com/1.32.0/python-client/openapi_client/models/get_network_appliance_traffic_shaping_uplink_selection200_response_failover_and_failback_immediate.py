...
class GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate(BaseModel):
    """
    Immediate WAN failover and failback
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether immediate WAN failover and failback is enabled")
