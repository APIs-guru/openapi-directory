...
class UpdateNetworkApplianceFirewallOneToOneNatRulesRequestRulesInner(BaseModel):
    """
    UpdateNetworkApplianceFirewallOneToOneNatRulesRequestRulesInner
    """ # noqa: E501
    allowed_inbound: Optional[List[UpdateNetworkApplianceFirewallOneToOneNatRulesRequestRulesInnerAllowedInboundInner]] = Field(default=None, description="The ports this mapping will provide access on, and the remote IPs that will be allowed access to the resource", alias="allowedInbound")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowedInbound": [UpdateNetworkApplianceFirewallOneToOneNatRulesRequestRulesInnerAllowedInboundInner.from_dict(_item) for _item in obj["allowedInbound"]] if obj.get("allowedInbound") is not None else None,
            "lanIp": obj.get("lanIp"),
            "name": obj.get("name"),
