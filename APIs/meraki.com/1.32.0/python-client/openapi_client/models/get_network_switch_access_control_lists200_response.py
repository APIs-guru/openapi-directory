...
class GetNetworkSwitchAccessControlLists200Response(BaseModel):
    """
    GetNetworkSwitchAccessControlLists200Response
    """ # noqa: E501
    rules: Optional[List[GetNetworkSwitchAccessControlLists200ResponseRulesInner]] = Field(default=None, description="An ordered array of the access control list rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [GetNetworkSwitchAccessControlLists200ResponseRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
