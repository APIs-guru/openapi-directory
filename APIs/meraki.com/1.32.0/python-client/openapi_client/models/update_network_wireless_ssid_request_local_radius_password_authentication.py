...
class UpdateNetworkWirelessSsidRequestLocalRadiusPasswordAuthentication(BaseModel):
    """
    The current setting for password-based authentication.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether or not to use EAP-TTLS/PAP or PEAP-GTC password-based authentication via LDAP lookup.")
