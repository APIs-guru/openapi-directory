...
class UpdateNetworkApplianceFirewallL7FirewallRulesRequest(BaseModel):
    """
    UpdateNetworkApplianceFirewallL7FirewallRulesRequest
    """ # noqa: E501
    rules: Optional[List[UpdateNetworkApplianceFirewallL7FirewallRulesRequestRulesInner]] = Field(default=None, description="An ordered array of the MX L7 firewall rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [UpdateNetworkApplianceFirewallL7FirewallRulesRequestRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
