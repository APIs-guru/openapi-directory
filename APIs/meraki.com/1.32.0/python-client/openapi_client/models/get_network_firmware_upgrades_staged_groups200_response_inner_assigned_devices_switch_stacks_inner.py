...
class GetNetworkFirmwareUpgradesStagedGroups200ResponseInnerAssignedDevicesSwitchStacksInner(BaseModel):
    """
    GetNetworkFirmwareUpgradesStagedGroups200ResponseInnerAssignedDevicesSwitchStacksInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the Switch Stack")
    name: Optional[StrictStr] = Field(default=None, description="Name of the Switch Stack")
