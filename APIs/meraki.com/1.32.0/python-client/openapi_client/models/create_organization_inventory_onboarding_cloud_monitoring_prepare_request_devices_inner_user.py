...
class CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequestDevicesInnerUser(BaseModel):
    """
    User parameters
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="The name of the device user for Meraki monitoring")
