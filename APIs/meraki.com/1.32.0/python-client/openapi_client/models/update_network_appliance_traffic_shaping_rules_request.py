...
class UpdateNetworkApplianceTrafficShapingRulesRequest(BaseModel):
    """
    ...
    rules: Optional[List[UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner]] = Field(default=None, description="    An array of traffic shaping rules. Rules are applied in the order that     they are specified in. An empty list (or null) means no rules. Note that     you are allowed a maximum of 8 rules. ")
    __properties: ClassVar[List[str]] = ["defaultRulesEnabled", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
