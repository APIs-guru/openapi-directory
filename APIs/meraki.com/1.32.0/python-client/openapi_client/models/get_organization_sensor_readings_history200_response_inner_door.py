...
class GetOrganizationSensorReadingsHistory200ResponseInnerDoor(BaseModel):
    """
    Reading for the 'door' metric. This will only be present if the 'metric' property equals 'door'.
    """ # noqa: E501
    open: Optional[StrictBool] = Field(default=None, description="True if the door is open.")
    __properties: ClassVar[List[str]] = ["open"]
