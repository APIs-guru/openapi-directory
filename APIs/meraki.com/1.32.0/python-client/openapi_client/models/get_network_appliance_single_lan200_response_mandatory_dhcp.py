...
class GetNetworkApplianceSingleLan200ResponseMandatoryDhcp(BaseModel):
    """
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Enable Mandatory DHCP on single LAN.")
