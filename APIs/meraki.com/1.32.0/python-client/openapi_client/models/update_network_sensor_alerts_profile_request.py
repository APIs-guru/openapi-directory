...
class UpdateNetworkSensorAlertsProfileRequest(BaseModel):
    """
    UpdateNetworkSensorAlertsProfileRequest
    """ # noqa: E501
    conditions: Optional[List[GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInner]] = Field(default=None, description="List of conditions that will cause the profile to send an alert.")
