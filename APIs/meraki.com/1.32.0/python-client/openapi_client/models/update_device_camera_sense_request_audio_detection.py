...
class UpdateDeviceCameraSenseRequestAudioDetection(BaseModel):
    """
    The details of the audio detection config.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Boolean indicating if audio detection is enabled(true) or disabled(false) on the camera")
