...
class GetOrganizationClientsOverview200Response(BaseModel):
    """
    GetOrganizationClientsOverview200Response
    """ # noqa: E501
    counts: Optional[GetOrganizationClientsOverview200ResponseCounts] = None
    usage: Optional[GetOrganizationClientsOverview200ResponseUsage] = None
    __properties: ClassVar[List[str]] = ["counts", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": GetOrganizationClientsOverview200ResponseCounts.from_dict(obj["counts"]) if obj.get("counts") is not None else None,
            "usage": GetOrganizationClientsOverview200ResponseUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
