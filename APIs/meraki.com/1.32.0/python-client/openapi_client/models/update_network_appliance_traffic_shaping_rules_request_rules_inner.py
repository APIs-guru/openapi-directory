...
class UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["definitions", "dscpTagValue", "perClientBandwidthLimits", "priority"]
