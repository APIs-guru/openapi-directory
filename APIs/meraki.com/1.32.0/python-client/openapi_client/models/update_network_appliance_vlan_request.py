...
class UpdateNetworkApplianceVlanRequest(BaseModel):
    """
    ...
    reserved_ip_ranges: Optional[List[UpdateNetworkApplianceStaticRouteRequestReservedIpRangesInner]] = Field(default=None, description="The DHCP reserved IP ranges on the VLAN", alias="reservedIpRanges")
    subnet: Optional[StrictStr] = Field(default=None, description="The subnet of the VLAN")
    template_vlan_type: Optional[StrictStr] = Field(default=None, description="Type of subnetting of the VLAN. Applicable only for template network.", alias="templateVlanType")
    ...
    __properties: ClassVar[List[str]] = ["applianceIp", "cidr", "dhcpBootFilename", "dhcpBootNextServer", "dhcpBootOptionsEnabled", "dhcpHandling", "dhcpLeaseTime", "dhcpOptions", "dhcpRelayServerIps", "dnsNameservers", "fixedIpAssignments", "groupPolicyId", "ipv6", "mandatoryDhcp", "mask", "name", "reservedIpRanges", "subnet", "templateVlanType", "vpnNatSubnet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mask": obj.get("mask"),
            "name": obj.get("name"),
            "reservedIpRanges": [UpdateNetworkApplianceStaticRouteRequestReservedIpRangesInner.from_dict(_item) for _item in obj["reservedIpRanges"]] if obj.get("reservedIpRanges") is not None else None,
            "subnet": obj.get("subnet"),
            "templateVlanType": obj.get("templateVlanType"),
