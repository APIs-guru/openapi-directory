...
class UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["definitions", "dscpTagValue", "pcpTagValue", "perClientBandwidthLimits"]
