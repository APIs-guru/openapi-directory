...
class GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThresholdWater(BaseModel):
    """
    Water detection threshold. 'present' must be provided and set to true.
    """ # noqa: E501
    present: StrictBool = Field(description="Alerting threshold for a water detection event. Must be set to true.")
