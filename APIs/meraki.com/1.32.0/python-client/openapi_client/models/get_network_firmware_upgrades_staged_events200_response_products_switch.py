...
class GetNetworkFirmwareUpgradesStagedEvents200ResponseProductsSwitch(BaseModel):
    """
    The Switch network to be updated
    """ # noqa: E501
    next_upgrade: Optional[GetNetworkFirmwareUpgradesStagedEvents200ResponseProductsSwitchNextUpgrade] = Field(default=None, alias="nextUpgrade")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nextUpgrade": GetNetworkFirmwareUpgradesStagedEvents200ResponseProductsSwitchNextUpgrade.from_dict(obj["nextUpgrade"]) if obj.get("nextUpgrade") is not None else None
        })
        return _obj
