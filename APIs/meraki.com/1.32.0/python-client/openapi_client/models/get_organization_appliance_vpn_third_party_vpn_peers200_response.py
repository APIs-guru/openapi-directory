...
class GetOrganizationApplianceVpnThirdPartyVPNPeers200Response(BaseModel):
    """
    GetOrganizationApplianceVpnThirdPartyVPNPeers200Response
    """ # noqa: E501
    peers: Optional[List[GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner]] = Field(default=None, description="The list of VPN peers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "peers": [GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.from_dict(_item) for _item in obj["peers"]] if obj.get("peers") is not None else None
        })
        return _obj
