...
class GetNetworkSettings200ResponseLocalStatusPage(BaseModel):
    """
    A hash of Local Status page(s)' authentication options applied to the Network.
    """ # noqa: E501
    authentication: Optional[GetNetworkSettings200ResponseLocalStatusPageAuthentication] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authentication": GetNetworkSettings200ResponseLocalStatusPageAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
        return _obj
