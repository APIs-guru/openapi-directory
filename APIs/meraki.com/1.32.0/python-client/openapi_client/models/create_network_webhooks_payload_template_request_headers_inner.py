...
class CreateNetworkWebhooksPayloadTemplateRequestHeadersInner(BaseModel):
    """
    CreateNetworkWebhooksPayloadTemplateRequestHeadersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the header template")
    template: Optional[StrictStr] = Field(default=None, description="The liquid template for the headers")
