...
class UpdateNetworkSwitchDhcpServerPolicyRequestAlertsEmail(BaseModel):
    """
    Email alert settings for DHCP servers
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="When enabled, send an email if a new DHCP server is seen. Default value is false.")
