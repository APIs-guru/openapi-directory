...
class GetOrganizationBrandingPolicies200ResponseInnerCustomLogoImage(BaseModel):
    """
    Properties of the image.
    """ # noqa: E501
    preview: Optional[GetOrganizationBrandingPolicies200ResponseInnerCustomLogoImagePreview] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preview": GetOrganizationBrandingPolicies200ResponseInnerCustomLogoImagePreview.from_dict(obj["preview"]) if obj.get("preview") is not None else None
        })
        return _obj
