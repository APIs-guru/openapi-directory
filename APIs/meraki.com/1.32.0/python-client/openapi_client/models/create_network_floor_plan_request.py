...
class CreateNetworkFloorPlanRequest(BaseModel):
    """
    ...
    center: Optional[CreateNetworkFloorPlanRequestCenter] = None
    image_contents: Union[StrictBytes, StrictStr] = Field(description="The file contents (a base 64 encoded string) of your image. Supported formats are PNG, GIF, and JPG. Note that all images are saved as PNG files, regardless of the format they are uploaded in.", alias="imageContents")
    name: StrictStr = Field(description="The name of your floor plan.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "center": CreateNetworkFloorPlanRequestCenter.from_dict(obj["center"]) if obj.get("center") is not None else None,
