...
class CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitch(BaseModel):
    """
    Version information for the switch network being upgraded
    """ # noqa: E501
    next_upgrade: Optional[CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitchNextUpgrade] = Field(default=None, alias="nextUpgrade")
    __properties: ClassVar[List[str]] = ["nextUpgrade"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nextUpgrade": CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitchNextUpgrade.from_dict(obj["nextUpgrade"]) if obj.get("nextUpgrade") is not None else None
        })
        return _obj
