...
class CreateNetworkGroupPolicyRequestVlanTagging(BaseModel):
    """
    The VLAN tagging settings for your group policy. Only available if your network has a wireless configuration.
    """ # noqa: E501
    settings: Optional[StrictStr] = Field(default=None, description="How VLAN tagging is applied. Can be 'network default', 'ignore' or 'custom'.")
    vlan_id: Optional[StrictStr] = Field(default=None, description="The ID of the vlan you want to tag. This only applies if 'settings' is set to 'custom'.", alias="vlanId")
    __properties: ClassVar[List[str]] = ["settings", "vlanId"]
