...
class UpdateOrganizationSamlRequest(BaseModel):
    """
    UpdateOrganizationSamlRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Boolean for updating SAML SSO enabled settings.")
