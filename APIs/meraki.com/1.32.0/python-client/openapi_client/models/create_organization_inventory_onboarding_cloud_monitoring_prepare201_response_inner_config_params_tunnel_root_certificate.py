...
class CreateOrganizationInventoryOnboardingCloudMonitoringPrepare201ResponseInnerConfigParamsTunnelRootCertificate(BaseModel):
    """
    Root certificate information
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="Public certificate value")
    name: Optional[StrictStr] = Field(default=None, description="The name of the server protected by the certificate")
