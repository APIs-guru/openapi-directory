...
class GetOrganizationSummaryTopSsidsByUsage200ResponseInnerClientsCounts(BaseModel):
    """
    Counts of the clients
    """ # noqa: E501
    total: Optional[StrictInt] = Field(default=None, description="Total counts of the clients")
