...
class RollbacksNetworkFirmwareUpgradesStagedEventsRequest(BaseModel):
    """
    RollbacksNetworkFirmwareUpgradesStagedEventsRequest
    """ # noqa: E501
    reasons: Optional[List[CreateNetworkFirmwareUpgradesRollbackRequestReasonsInner]] = Field(default=None, description="The reason for rolling back the staged upgrade")
    stages: List[UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInner] = Field(description="All completed or in-progress stages in the network with their new start times. All pending stages will be canceled")
    __properties: ClassVar[List[str]] = ["reasons", "stages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stages": [UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInner.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None
        })
        return _obj
