...
class GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThresholdNoise(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ambient": GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThresholdNoiseAmbient.from_dict(obj["ambient"]) if obj.get("ambient") is not None else None
        })
        return _obj
