...
class GetOrganizationWirelessDevicesEthernetStatuses200ResponseInnerPortsInnerPoe(BaseModel):
    """
    PoE details object for the port
    """ # noqa: E501
    standard: Optional[StrictStr] = Field(default=None, description="The PoE Standard for the port. Can be '802.3at', '802.3af', '802.3bt', or null")
    __properties: ClassVar[List[str]] = ["standard"]
