...
class CreateNetworkWirelessRfProfileRequest(BaseModel):
    """
    CreateNetworkWirelessRfProfileRequest
    """ # noqa: E501
    ap_band_settings: Optional[CreateNetworkWirelessRfProfileRequestApBandSettings] = Field(default=None, alias="apBandSettings")
    band_selection_type: StrictStr = Field(description="Band selection can be set to either 'ssid' or 'ap'. This param is required on creation.", alias="bandSelectionType")
    ...
    name: StrictStr = Field(description="The name of the new profile. Must be unique. This param is required on creation.")
    per_ssid_settings: Optional[CreateNetworkWirelessRfProfileRequestPerSsidSettings] = Field(default=None, alias="perSsidSettings")
    ...
    __properties: ClassVar[List[str]] = ["apBandSettings", "bandSelectionType", "clientBalancingEnabled", "fiveGhzSettings", "minBitrateType", "name", "perSsidSettings", "transmission", "twoFourGhzSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apBandSettings": CreateNetworkWirelessRfProfileRequestApBandSettings.from_dict(obj["apBandSettings"]) if obj.get("apBandSettings") is not None else None,
            ...
            "name": obj.get("name"),
            "perSsidSettings": CreateNetworkWirelessRfProfileRequestPerSsidSettings.from_dict(obj["perSsidSettings"]) if obj.get("perSsidSettings") is not None else None,
