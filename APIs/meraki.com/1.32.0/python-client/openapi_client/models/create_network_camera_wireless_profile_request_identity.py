...
class CreateNetworkCameraWirelessProfileRequestIdentity(BaseModel):
    """
    The identity of the wireless profile. Required for creating wireless profiles in 8021x-radius auth mode.
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="The password of the identity.")
    username: Optional[StrictStr] = Field(default=None, description="The username of the identity.")
