...
class GetOrganizationSensorReadingsHistory200ResponseInnerBattery(BaseModel):
    """
    Reading for the 'battery' metric. This will only be present if the 'metric' property equals 'battery'.
    """ # noqa: E501
    percentage: Optional[StrictInt] = Field(default=None, description="Remaining battery life.")
