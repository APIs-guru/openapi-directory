...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastPacketSourceIpv4(BaseModel):
    """
    Source ipv4 attributes of the packet.
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Source ipv4 address of the packet.")
