...
class UpdateNetworkWirelessSsidRequestLdapServerCaCertificate(BaseModel):
    """
    The CA certificate used to sign the LDAP server's key.
    """ # noqa: E501
    contents: Optional[StrictStr] = Field(default=None, description="The contents of the CA certificate. Must be in PEM or DER format.")
