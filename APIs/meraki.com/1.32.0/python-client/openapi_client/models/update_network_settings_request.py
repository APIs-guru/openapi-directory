...
class UpdateNetworkSettingsRequest(BaseModel):
    """
    UpdateNetworkSettingsRequest
    """ # noqa: E501
    local_status_page: Optional[UpdateNetworkSettingsRequestLocalStatusPage] = Field(default=None, alias="localStatusPage")
    ...
    __properties: ClassVar[List[str]] = ["localStatusPage", "localStatusPageEnabled", "remoteStatusPageEnabled", "securePort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localStatusPage": UpdateNetworkSettingsRequestLocalStatusPage.from_dict(obj["localStatusPage"]) if obj.get("localStatusPage") is not None else None,
