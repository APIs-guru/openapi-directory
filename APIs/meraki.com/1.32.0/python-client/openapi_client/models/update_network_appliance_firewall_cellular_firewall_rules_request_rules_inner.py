...
class UpdateNetworkApplianceFirewallCellularFirewallRulesRequestRulesInner(BaseModel):
    """
    ...
    dest_cidr: StrictStr = Field(description="Comma-separated list of destination IP address(es) (in IP or CIDR notation), fully-qualified domain names (FQDN) or 'any'", alias="destCidr")
    ...
    src_cidr: StrictStr = Field(description="Comma-separated list of source IP address(es) (in IP or CIDR notation), or 'any' (note: FQDN not supported for source addresses)", alias="srcCidr")
