...
class GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeStaged(BaseModel):
    """
    Staged upgrade
    """ # noqa: E501
    group: Optional[GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeStagedGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeStagedGroup.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
