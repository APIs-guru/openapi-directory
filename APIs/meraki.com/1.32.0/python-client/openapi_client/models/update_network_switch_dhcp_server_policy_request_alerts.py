...
class UpdateNetworkSwitchDhcpServerPolicyRequestAlerts(BaseModel):
    """
    Alert settings for DHCP servers
    """ # noqa: E501
    email: Optional[UpdateNetworkSwitchDhcpServerPolicyRequestAlertsEmail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": UpdateNetworkSwitchDhcpServerPolicyRequestAlertsEmail.from_dict(obj["email"]) if obj.get("email") is not None else None
        })
        return _obj
