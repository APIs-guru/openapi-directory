...
class CreateNetworkFirmwareUpgradesStagedEventRequestProducts(BaseModel):
    """
    Contains firmware upgrade version information
    """ # noqa: E501
    switch: Optional[CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitch] = None
    __properties: ClassVar[List[str]] = ["switch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "switch": CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitch.from_dict(obj["switch"]) if obj.get("switch") is not None else None
        })
        return _obj
