...
class CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitchNextUpgrade(BaseModel):
    """
    The next upgrade version for the switch network
    """ # noqa: E501
    to_version: Optional[CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitchNextUpgradeToVersion] = Field(default=None, alias="toVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "toVersion": CreateNetworkFirmwareUpgradesStagedEventRequestProductsSwitchNextUpgradeToVersion.from_dict(obj["toVersion"]) if obj.get("toVersion") is not None else None
        })
        return _obj
