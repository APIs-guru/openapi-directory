...
class GetNetworkWirelessSettings200Response(BaseModel):
    """
    ...
    named_vlans: Optional[GetNetworkWirelessSettings200ResponseNamedVlans] = Field(default=None, alias="namedVlans")
    ...
    __properties: ClassVar[List[str]] = ["ipv6BridgeEnabled", "ledLightsOn", "locationAnalyticsEnabled", "meshingEnabled", "namedVlans", "upgradeStrategy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "namedVlans": GetNetworkWirelessSettings200ResponseNamedVlans.from_dict(obj["namedVlans"]) if obj.get("namedVlans") is not None else None,
