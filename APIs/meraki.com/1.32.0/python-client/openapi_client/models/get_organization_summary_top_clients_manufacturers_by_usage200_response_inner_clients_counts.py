...
class GetOrganizationSummaryTopClientsManufacturersByUsage200ResponseInnerClientsCounts(BaseModel):
    """
    Counts of clients
    """ # noqa: E501
    total: Optional[StrictInt] = Field(default=None, description="Total counts of clients")
