...
class GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerLastPacketDestinationIpv4(BaseModel):
    """
    Destination ipv4 attributes of the packet.
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Destination ipv4 address of the packet.")
