...
class GetDeviceApplianceUplinksSettings200ResponseInterfacesWan1SvisIpv4Nameservers(BaseModel):
    """
    The nameserver settings for this SVI.
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(default=None, description="Up to 2 nameserver addresses to use, ordered in priority from highest to lowest priority.")
