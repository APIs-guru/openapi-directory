...
class GetNetworkClients200Response(BaseModel):
    ...
    """ # noqa: E501
    adaptive_policy_group: Optional[StrictStr] = Field(default=None, description="The adaptive policy group of the client", alias="adaptivePolicyGroup")
    description: Optional[StrictStr] = Field(default=None, description="Short description of the client")
    device_type_prediction: Optional[StrictStr] = Field(default=None, description="Prediction of the client's device type", alias="deviceTypePrediction")
    ...
    named_vlan: Optional[StrictStr] = Field(default=None, description="Named VLAN of the client", alias="namedVlan")
    ...
    recent_device_connection: Optional[StrictStr] = Field(default=None, description="Client's most recent connection type", alias="recentDeviceConnection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adaptivePolicyGroup": obj.get("adaptivePolicyGroup"),
            "description": obj.get("description"),
            "deviceTypePrediction": obj.get("deviceTypePrediction"),
            ...
            "namedVlan": obj.get("namedVlan"),
            "notes": obj.get("notes"),
            "os": obj.get("os"),
            "recentDeviceConnection": obj.get("recentDeviceConnection"),
