...
class UpdateNetworkSwitchDscpToCosMappingsRequest(BaseModel):
    """
    UpdateNetworkSwitchDscpToCosMappingsRequest
    """ # noqa: E501
    mappings: List[UpdateNetworkSwitchDscpToCosMappingsRequestMappingsInner] = Field(description="An array of DSCP to CoS mappings. An empty array will reset the mappings to default.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [UpdateNetworkSwitchDscpToCosMappingsRequestMappingsInner.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
