...
class GetOrganizationSensorReadingsHistory200ResponseInnerHumidity(BaseModel):
    """
    Reading for the 'humidity' metric. This will only be present if the 'metric' property equals 'humidity'.
    """ # noqa: E501
    relative_percentage: Optional[StrictInt] = Field(default=None, description="Humidity reading in %RH.", alias="relativePercentage")
    __properties: ClassVar[List[str]] = ["relativePercentage"]
