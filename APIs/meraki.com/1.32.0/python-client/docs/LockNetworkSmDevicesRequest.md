...
------------ | ------------- | ------------- | -------------
**ids** | **List[str]** | The ids of the devices to be locked. | [optional] 
**pin** | **int** | The pin number for locking macOS devices (a six digit number). Required only for macOS devices. | [optional] 
**scope** | **List[str]** | The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be wiped. | [optional] 
**serials** | **List[str]** | The serials of the devices to be locked. | [optional] 
**wifi_macs** | **List[str]** | The wifiMacs of the devices to be locked. | [optional] 
