# openapi_client.PerformanceHistoryApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_sm_device_performance_history_2**](PerformanceHistoryApi.md#get_network_sm_device_performance_history_2) | **GET** /networks/{networkId}/sm/devices/{deviceId}/performanceHistory | Return historical records of various Systems Manager client metrics for desktop devices.


# **get_network_sm_device_performance_history_2**
> List[GetNetworkSmDevicePerformanceHistory200ResponseInner] get_network_sm_device_performance_history_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PerformanceHistoryApi(api_client)
    ...
    try:
        # Return historical records of various Systems Manager client metrics for desktop devices.
        api_response = api_instance.get_network_sm_device_performance_history_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of PerformanceHistoryApi->get_network_sm_device_performance_history_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PerformanceHistoryApi->get_network_sm_device_performance_history_2: %s\n" % e)
```
