...
------------- | ------------- | -------------
[**get_organization_clients_search_2**](SearchApi.md#get_organization_clients_search_2) | **GET** /organizations/{organizationId}/clients/search | Return the client details in an organization


# **get_organization_clients_search_2**
> object get_organization_clients_search_2(organization_id, mac, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return the client details in an organization
        api_response = api_instance.get_organization_clients_search_2(organization_id, mac, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of SearchApi->get_organization_clients_search_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SearchApi->get_organization_clients_search_2: %s\n" % e)
```
