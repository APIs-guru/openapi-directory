...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ByIntervalApi(api_client)
    ...
    try:
        # Tracks organizations' API requests by response code across a given time period
        api_response = api_instance.get_organization_api_requests_overview_response_codes_by_interval_4(organization_id, t0=t0, t1=t1, timespan=timespan, interval=interval, version=version, operation_ids=operation_ids, source_ips=source_ips, admin_ids=admin_ids, user_agent=user_agent)
        print("The response of ByIntervalApi->get_organization_api_requests_overview_response_codes_by_interval_4:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ByIntervalApi->get_organization_api_requests_overview_response_codes_by_interval_4: %s\n" % e)
```
