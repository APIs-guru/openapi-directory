...
update_organization_appliance_vpn_third_party_vpn_peers_request_peers_inner_instance = UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner.from_json(json)
# print the JSON string representation of the object
print(UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner.to_json())

# convert the object into a dict
update_organization_appliance_vpn_third_party_vpn_peers_request_peers_inner_dict = update_organization_appliance_vpn_third_party_vpn_peers_request_peers_inner_instance.to_dict()
# create an instance of UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner from a dict
update_organization_appliance_vpn_third_party_vpn_peers_request_peers_inner_from_dict = UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner.from_dict(update_organization_appliance_vpn_third_party_vpn_peers_request_peers_inner_dict)
```
