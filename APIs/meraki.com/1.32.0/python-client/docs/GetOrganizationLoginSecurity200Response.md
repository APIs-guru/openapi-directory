...
get_organization_login_security200_response_instance = GetOrganizationLoginSecurity200Response.from_json(json)
# print the JSON string representation of the object
print(GetOrganizationLoginSecurity200Response.to_json())

# convert the object into a dict
get_organization_login_security200_response_dict = get_organization_login_security200_response_instance.to_dict()
# create an instance of GetOrganizationLoginSecurity200Response from a dict
get_organization_login_security200_response_from_dict = GetOrganizationLoginSecurity200Response.from_dict(get_organization_login_security200_response_dict)
```
