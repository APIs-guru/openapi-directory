# openapi_client.ConnectivityApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_sm_device_connectivity_2**](ConnectivityApi.md#get_network_sm_device_connectivity_2) | **GET** /networks/{networkId}/sm/devices/{deviceId}/connectivity | Returns historical connectivity data (whether a device is regularly checking in to Dashboard).


# **get_network_sm_device_connectivity_2**
> List[GetNetworkSmDeviceConnectivity200ResponseInner] get_network_sm_device_connectivity_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConnectivityApi(api_client)
    ...
    try:
        # Returns historical connectivity data (whether a device is regularly checking in to Dashboard).
        api_response = api_instance.get_network_sm_device_connectivity_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of ConnectivityApi->get_network_sm_device_connectivity_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConnectivityApi->get_network_sm_device_connectivity_2: %s\n" % e)
```
