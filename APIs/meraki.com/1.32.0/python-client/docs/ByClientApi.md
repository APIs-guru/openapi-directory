# openapi_client.ByClientApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_policies_by_client_2**](ByClientApi.md#get_network_policies_by_client_2) | **GET** /networks/{networkId}/policies/byClient | Get policies for all clients with policies


# **get_network_policies_by_client_2**
> List[GetNetworkPoliciesByClient200ResponseInner] get_network_policies_by_client_2(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ByClientApi(api_client)
    ...
    try:
        # Get policies for all clients with policies
        api_response = api_instance.get_network_policies_by_client_2(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, timespan=timespan)
        print("The response of ByClientApi->get_network_policies_by_client_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ByClientApi->get_network_policies_by_client_2: %s\n" % e)
```
