# openapi_client.UsageHistoriesApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_clients_usage_histories_2**](UsageHistoriesApi.md#get_network_clients_usage_histories_2) | **GET** /networks/{networkId}/clients/usageHistories | Return the usage histories for clients


# **get_network_clients_usage_histories_2**
> List[object] get_network_clients_usage_histories_2(network_id, clients, ssid_number=ssid_number, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.UsageHistoriesApi(api_client)
    ...
    try:
        # Return the usage histories for clients
        api_response = api_instance.get_network_clients_usage_histories_2(network_id, clients, ssid_number=ssid_number, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan)
        print("The response of UsageHistoriesApi->get_network_clients_usage_histories_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsageHistoriesApi->get_network_clients_usage_histories_2: %s\n" % e)
```
