# openapi_client.ApplicationUsageApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_clients_application_usage_2**](ApplicationUsageApi.md#get_network_clients_application_usage_2) | **GET** /networks/{networkId}/clients/applicationUsage | Return the application usage data for clients


# **get_network_clients_application_usage_2**
> List[object] get_network_clients_application_usage_2(network_id, clients, ssid_number=ssid_number, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApplicationUsageApi(api_client)
    ...
    try:
        # Return the application usage data for clients
        api_response = api_instance.get_network_clients_application_usage_2(network_id, clients, ssid_number=ssid_number, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan)
        print("The response of ApplicationUsageApi->get_network_clients_application_usage_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApplicationUsageApi->get_network_clients_application_usage_2: %s\n" % e)
```
