...
json = "{}"
# create an instance of CreateNetworkSwitchQosRuleRequest from a JSON string
create_network_switch_qos_rule_request_instance = CreateNetworkSwitchQosRuleRequest.from_json(json)
# print the JSON string representation of the object
print(CreateNetworkSwitchQosRuleRequest.to_json())

# convert the object into a dict
create_network_switch_qos_rule_request_dict = create_network_switch_qos_rule_request_instance.to_dict()
# create an instance of CreateNetworkSwitchQosRuleRequest from a dict
create_network_switch_qos_rule_request_from_dict = CreateNetworkSwitchQosRuleRequest.from_dict(create_network_switch_qos_rule_request_dict)
```
