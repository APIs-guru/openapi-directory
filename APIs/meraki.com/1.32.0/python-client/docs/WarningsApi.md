# openapi_client.WarningsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3**](WarningsApi.md#get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3) | **GET** /networks/{networkId}/switch/dhcpServerPolicy/arpInspection/warnings/byDevice | Return the devices that have a Dynamic ARP Inspection warning and their warnings


# **get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3**
> List[GetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice200ResponseInner] get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WarningsApi(api_client)
    ...
    try:
        # Return the devices that have a Dynamic ARP Inspection warning and their warnings
        api_response = api_instance.get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of WarningsApi->get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WarningsApi->get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_3: %s\n" % e)
```
