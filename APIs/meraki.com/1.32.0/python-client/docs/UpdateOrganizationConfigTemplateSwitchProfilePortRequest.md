...
update_organization_config_template_switch_profile_port_request_instance = UpdateOrganizationConfigTemplateSwitchProfilePortRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateOrganizationConfigTemplateSwitchProfilePortRequest.to_json())

# convert the object into a dict
update_organization_config_template_switch_profile_port_request_dict = update_organization_config_template_switch_profile_port_request_instance.to_dict()
# create an instance of UpdateOrganizationConfigTemplateSwitchProfilePortRequest from a dict
update_organization_config_template_switch_profile_port_request_from_dict = UpdateOrganizationConfigTemplateSwitchProfilePortRequest.from_dict(update_organization_config_template_switch_profile_port_request_dict)
```
