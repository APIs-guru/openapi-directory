# openapi_client.TrustedAccessConfigsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_sm_trusted_access_configs_1**](TrustedAccessConfigsApi.md#get_network_sm_trusted_access_configs_1) | **GET** /networks/{networkId}/sm/trustedAccessConfigs | List Trusted Access Configs


# **get_network_sm_trusted_access_configs_1**
> List[GetNetworkSmTrustedAccessConfigs200ResponseInner] get_network_sm_trusted_access_configs_1(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TrustedAccessConfigsApi(api_client)
    ...
    try:
        # List Trusted Access Configs
        api_response = api_instance.get_network_sm_trusted_access_configs_1(network_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of TrustedAccessConfigsApi->get_network_sm_trusted_access_configs_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TrustedAccessConfigsApi->get_network_sm_trusted_access_configs_1: %s\n" % e)
```
