# openapi_client.V4Api

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_switch_dhcp_v4_servers_seen_2**](V4Api.md#get_network_switch_dhcp_v4_servers_seen_2) | **GET** /networks/{networkId}/switch/dhcp/v4/servers/seen | Return the network&#39;s DHCPv4 servers seen within the selected timeframe (default 1 day)


# **get_network_switch_dhcp_v4_servers_seen_2**
> List[GetNetworkSwitchDhcpV4ServersSeen200ResponseInner] get_network_switch_dhcp_v4_servers_seen_2(network_id, t0=t0, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.V4Api(api_client)
    ...
    try:
        # Return the network's DHCPv4 servers seen within the selected timeframe (default 1 day)
        api_response = api_instance.get_network_switch_dhcp_v4_servers_seen_2(network_id, t0=t0, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of V4Api->get_network_switch_dhcp_v4_servers_seen_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V4Api->get_network_switch_dhcp_v4_servers_seen_2: %s\n" % e)
```
