# openapi_client.ManufacturersApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_organization_summary_top_clients_manufacturers_by_usage_4**](ManufacturersApi.md#get_organization_summary_top_clients_manufacturers_by_usage_4) | **GET** /organizations/{organizationId}/summary/top/clients/manufacturers/byUsage | Return metrics for organization&#39;s top clients by data usage (in mb) over given time range, grouped by manufacturer.


# **get_organization_summary_top_clients_manufacturers_by_usage_4**
> List[GetOrganizationSummaryTopClientsManufacturersByUsage200ResponseInner] get_organization_summary_top_clients_manufacturers_by_usage_4(organization_id, t0=t0, t1=t1, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ManufacturersApi(api_client)
    ...
    try:
        # Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.
        api_response = api_instance.get_organization_summary_top_clients_manufacturers_by_usage_4(organization_id, t0=t0, t1=t1, timespan=timespan)
        print("The response of ManufacturersApi->get_organization_summary_top_clients_manufacturers_by_usage_4:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ManufacturersApi->get_organization_summary_top_clients_manufacturers_by_usage_4: %s\n" % e)
```
