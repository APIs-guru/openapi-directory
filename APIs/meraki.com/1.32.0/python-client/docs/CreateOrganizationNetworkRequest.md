...
**notes** | **str** | Add any notes or additional information about this network here. | [optional] 
**product_types** | **List[str]** | The product type(s) of the new network. If more than one type is included, the network will be a combined network. | 
**tags** | **List[str]** | A list of tags to be applied to the network | [optional] 
