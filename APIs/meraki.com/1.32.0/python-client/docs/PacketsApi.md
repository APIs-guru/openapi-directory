# openapi_client.PacketsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_device_switch_ports_statuses_packets_3**](PacketsApi.md#get_device_switch_ports_statuses_packets_3) | **GET** /devices/{serial}/switch/ports/statuses/packets | Return the packet counters for all the ports of a switch


# **get_device_switch_ports_statuses_packets_3**
> List[object] get_device_switch_ports_statuses_packets_3(serial, t0=t0, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PacketsApi(api_client)
    ...
    try:
        # Return the packet counters for all the ports of a switch
        api_response = api_instance.get_device_switch_ports_statuses_packets_3(serial, t0=t0, timespan=timespan)
        print("The response of PacketsApi->get_device_switch_ports_statuses_packets_3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PacketsApi->get_device_switch_ports_statuses_packets_3: %s\n" % e)
```
