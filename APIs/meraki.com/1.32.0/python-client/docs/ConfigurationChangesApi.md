# openapi_client.ConfigurationChangesApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_organization_configuration_changes_1**](ConfigurationChangesApi.md#get_organization_configuration_changes_1) | **GET** /organizations/{organizationId}/configurationChanges | View the Change Log for your organization


# **get_organization_configuration_changes_1**
> List[object] get_organization_configuration_changes_1(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, network_id=network_id, admin_id=admin_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ConfigurationChangesApi(api_client)
    ...
    try:
        # View the Change Log for your organization
        api_response = api_instance.get_organization_configuration_changes_1(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, network_id=network_id, admin_id=admin_id)
        print("The response of ConfigurationChangesApi->get_organization_configuration_changes_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConfigurationChangesApi->get_organization_configuration_changes_1: %s\n" % e)
```
