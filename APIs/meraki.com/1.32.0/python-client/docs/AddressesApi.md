...
------------- | ------------- | -------------
[**get_organization_devices_uplinks_addresses_by_device_3**](AddressesApi.md#get_organization_devices_uplinks_addresses_by_device_3) | **GET** /organizations/{organizationId}/devices/uplinks/addresses/byDevice | List the current uplink addresses for devices in an organization.


# **get_organization_devices_uplinks_addresses_by_device_3**
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List the current uplink addresses for devices in an organization.
        api_response = api_instance.get_organization_devices_uplinks_addresses_by_device_3(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, network_ids=network_ids, product_types=product_types, serials=serials, tags=tags, tags_filter_type=tags_filter_type)
        print("The response of AddressesApi->get_organization_devices_uplinks_addresses_by_device_3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AddressesApi->get_organization_devices_uplinks_addresses_by_device_3: %s\n" % e)
```
