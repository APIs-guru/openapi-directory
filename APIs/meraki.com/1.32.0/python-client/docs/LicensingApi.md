...
------------- | ------------- | -------------
[**get_organization_licensing_coterm_licenses**](LicensingApi.md#get_organization_licensing_coterm_licenses) | **GET** /organizations/{organizationId}/licensing/coterm/licenses | List the licenses in a coterm organization
[**move_organization_licensing_coterm_licenses**](LicensingApi.md#move_organization_licensing_coterm_licenses) | **POST** /organizations/{organizationId}/licensing/coterm/licenses/move | Moves a license to a different organization (coterm only)


# **get_organization_licensing_coterm_licenses**
> List[GetOrganizationLicensingCotermLicenses200ResponseInner] get_organization_licensing_coterm_licenses(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, invalidated=invalidated, expired=expired)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List the licenses in a coterm organization
        api_response = api_instance.get_organization_licensing_coterm_licenses(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, invalidated=invalidated, expired=expired)
        print("The response of LicensingApi->get_organization_licensing_coterm_licenses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->get_organization_licensing_coterm_licenses: %s\n" % e)
```
...
> MoveOrganizationLicensingCotermLicenses200Response move_organization_licensing_coterm_licenses(organization_id, move_organization_licensing_coterm_licenses_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Moves a license to a different organization (coterm only)
        api_response = api_instance.move_organization_licensing_coterm_licenses(organization_id, move_organization_licensing_coterm_licenses_request)
        print("The response of LicensingApi->move_organization_licensing_coterm_licenses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->move_organization_licensing_coterm_licenses: %s\n" % e)
```
