...
json = "{}"
# create an instance of UpdateNetworkSwitchQosRuleRequest from a JSON string
update_network_switch_qos_rule_request_instance = UpdateNetworkSwitchQosRuleRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateNetworkSwitchQosRuleRequest.to_json())

# convert the object into a dict
update_network_switch_qos_rule_request_dict = update_network_switch_qos_rule_request_instance.to_dict()
# create an instance of UpdateNetworkSwitchQosRuleRequest from a dict
update_network_switch_qos_rule_request_from_dict = UpdateNetworkSwitchQosRuleRequest.from_dict(update_network_switch_qos_rule_request_dict)
```
