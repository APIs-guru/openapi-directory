...
------------- | ------------- | -------------
[**get_organization_sensor_readings_history_1**](ReadingsApi.md#get_organization_sensor_readings_history_1) | **GET** /organizations/{organizationId}/sensor/readings/history | Return all reported readings from sensors in a given timespan, sorted by timestamp
[**get_organization_sensor_readings_latest_1**](ReadingsApi.md#get_organization_sensor_readings_latest_1) | **GET** /organizations/{organizationId}/sensor/readings/latest | Return the latest available reading for each metric from each sensor, sorted by sensor serial


# **get_organization_sensor_readings_history_1**
> List[GetOrganizationSensorReadingsHistory200ResponseInner] get_organization_sensor_readings_history_1(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan, network_ids=network_ids, serials=serials, metrics=metrics)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return all reported readings from sensors in a given timespan, sorted by timestamp
        api_response = api_instance.get_organization_sensor_readings_history_1(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, t0=t0, t1=t1, timespan=timespan, network_ids=network_ids, serials=serials, metrics=metrics)
        print("The response of ReadingsApi->get_organization_sensor_readings_history_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReadingsApi->get_organization_sensor_readings_history_1: %s\n" % e)
```
...
# **get_organization_sensor_readings_latest_1**
> List[GetOrganizationSensorReadingsLatest200ResponseInner] get_organization_sensor_readings_latest_1(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, network_ids=network_ids, serials=serials, metrics=metrics)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return the latest available reading for each metric from each sensor, sorted by sensor serial
        api_response = api_instance.get_organization_sensor_readings_latest_1(organization_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before, network_ids=network_ids, serials=serials, metrics=metrics)
        print("The response of ReadingsApi->get_organization_sensor_readings_latest_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReadingsApi->get_organization_sensor_readings_latest_1: %s\n" % e)
```
