# openapi_client.ApiRequestsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_organization_api_requests_1**](ApiRequestsApi.md#get_organization_api_requests_1) | **GET** /organizations/{organizationId}/apiRequests | List the API requests made by an organization
[**get_organization_api_requests_overview_1**](ApiRequestsApi.md#get_organization_api_requests_overview_1) | **GET** /organizations/{organizationId}/apiRequests/overview | Return an aggregated overview of API requests data
[**get_organization_api_requests_overview_response_codes_by_interval_1**](ApiRequestsApi.md#get_organization_api_requests_overview_response_codes_by_interval_1) | **GET** /organizations/{organizationId}/apiRequests/overview/responseCodes/byInterval | Tracks organizations&#39; API requests by response code across a given time period


# **get_organization_api_requests_1**
> List[GetOrganizationApiRequests200ResponseInner] get_organization_api_requests_1(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, admin_id=admin_id, path=path, method=method, response_code=response_code, source_ip=source_ip, user_agent=user_agent, version=version, operation_ids=operation_ids)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApiRequestsApi(api_client)
    ...
    try:
        # List the API requests made by an organization
        api_response = api_instance.get_organization_api_requests_1(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, admin_id=admin_id, path=path, method=method, response_code=response_code, source_ip=source_ip, user_agent=user_agent, version=version, operation_ids=operation_ids)
        print("The response of ApiRequestsApi->get_organization_api_requests_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiRequestsApi->get_organization_api_requests_1: %s\n" % e)
```
...
# **get_organization_api_requests_overview_1**
> object get_organization_api_requests_overview_1(organization_id, t0=t0, t1=t1, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return an aggregated overview of API requests data
        api_response = api_instance.get_organization_api_requests_overview_1(organization_id, t0=t0, t1=t1, timespan=timespan)
        print("The response of ApiRequestsApi->get_organization_api_requests_overview_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiRequestsApi->get_organization_api_requests_overview_1: %s\n" % e)
```
...
# **get_organization_api_requests_overview_response_codes_by_interval_1**
> List[GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner] get_organization_api_requests_overview_response_codes_by_interval_1(organization_id, t0=t0, t1=t1, timespan=timespan, interval=interval, version=version, operation_ids=operation_ids, source_ips=source_ips, admin_ids=admin_ids, user_agent=user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Tracks organizations' API requests by response code across a given time period
        api_response = api_instance.get_organization_api_requests_overview_response_codes_by_interval_1(organization_id, t0=t0, t1=t1, timespan=timespan, interval=interval, version=version, operation_ids=operation_ids, source_ips=source_ips, admin_ids=admin_ids, user_agent=user_agent)
        print("The response of ApiRequestsApi->get_organization_api_requests_overview_response_codes_by_interval_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiRequestsApi->get_organization_api_requests_overview_response_codes_by_interval_1: %s\n" % e)
```
