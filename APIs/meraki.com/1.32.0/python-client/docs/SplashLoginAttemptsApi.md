...
------------- | ------------- | -------------
[**get_network_splash_login_attempts_1**](SplashLoginAttemptsApi.md#get_network_splash_login_attempts_1) | **GET** /networks/{networkId}/splashLoginAttempts | List the splash login attempts for a network


# **get_network_splash_login_attempts_1**
> List[object] get_network_splash_login_attempts_1(network_id, ssid_number=ssid_number, login_identifier=login_identifier, timespan=timespan)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List the splash login attempts for a network
        api_response = api_instance.get_network_splash_login_attempts_1(network_id, ssid_number=ssid_number, login_identifier=login_identifier, timespan=timespan)
        print("The response of SplashLoginAttemptsApi->get_network_splash_login_attempts_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SplashLoginAttemptsApi->get_network_splash_login_attempts_1: %s\n" % e)
```
