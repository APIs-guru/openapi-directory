# openapi_client.DesktopLogsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_sm_device_desktop_logs_2**](DesktopLogsApi.md#get_network_sm_device_desktop_logs_2) | **GET** /networks/{networkId}/sm/devices/{deviceId}/desktopLogs | Return historical records of various Systems Manager network connection details for desktop devices.


# **get_network_sm_device_desktop_logs_2**
> List[GetNetworkSmDeviceDesktopLogs200ResponseInner] get_network_sm_device_desktop_logs_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DesktopLogsApi(api_client)
    ...
    try:
        # Return historical records of various Systems Manager network connection details for desktop devices.
        api_response = api_instance.get_network_sm_device_desktop_logs_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of DesktopLogsApi->get_network_sm_device_desktop_logs_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DesktopLogsApi->get_network_sm_device_desktop_logs_2: %s\n" % e)
```
