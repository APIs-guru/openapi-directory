...
------------- | ------------- | -------------
[**get_organization_webhooks_logs_2**](LogsApi.md#get_organization_webhooks_logs_2) | **GET** /organizations/{organizationId}/webhooks/logs | Return the log of webhook POSTs sent


# **get_organization_webhooks_logs_2**
> List[GetOrganizationWebhooksLogs200ResponseInner] get_organization_webhooks_logs_2(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, url=url)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return the log of webhook POSTs sent
        api_response = api_instance.get_organization_webhooks_logs_2(organization_id, t0=t0, t1=t1, timespan=timespan, per_page=per_page, starting_after=starting_after, ending_before=ending_before, url=url)
        print("The response of LogsApi->get_organization_webhooks_logs_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LogsApi->get_organization_webhooks_logs_2: %s\n" % e)
```
