# openapi_client.ChannelUtilizationApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_network_health_channel_utilization_2**](ChannelUtilizationApi.md#get_network_network_health_channel_utilization_2) | **GET** /networks/{networkId}/networkHealth/channelUtilization | Get the channel utilization over each radio for all APs in a network.


# **get_network_network_health_channel_utilization_2**
> List[object] get_network_network_health_channel_utilization_2(network_id, t0=t0, t1=t1, timespan=timespan, resolution=resolution, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ChannelUtilizationApi(api_client)
    ...
    try:
        # Get the channel utilization over each radio for all APs in a network.
        api_response = api_instance.get_network_network_health_channel_utilization_2(network_id, t0=t0, t1=t1, timespan=timespan, resolution=resolution, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of ChannelUtilizationApi->get_network_network_health_channel_utilization_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChannelUtilizationApi->get_network_network_health_channel_utilization_2: %s\n" % e)
```
