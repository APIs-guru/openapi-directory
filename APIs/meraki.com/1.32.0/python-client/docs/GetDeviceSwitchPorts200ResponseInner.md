...
**link_negotiation_capabilities** | **List[str]** | Available link speeds for the switch port. | [optional] 
...
get_device_switch_ports200_response_inner_instance = GetDeviceSwitchPorts200ResponseInner.from_json(json)
# print the JSON string representation of the object
print(GetDeviceSwitchPorts200ResponseInner.to_json())

# convert the object into a dict
get_device_switch_ports200_response_inner_dict = get_device_switch_ports200_response_inner_instance.to_dict()
# create an instance of GetDeviceSwitchPorts200ResponseInner from a dict
get_device_switch_ports200_response_inner_from_dict = GetDeviceSwitchPorts200ResponseInner.from_dict(get_device_switch_ports200_response_inner_dict)
```
