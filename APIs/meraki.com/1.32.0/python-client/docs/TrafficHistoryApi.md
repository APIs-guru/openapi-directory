# openapi_client.TrafficHistoryApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_client_traffic_history_2**](TrafficHistoryApi.md#get_network_client_traffic_history_2) | **GET** /networks/{networkId}/clients/{clientId}/trafficHistory | Return the client&#39;s network traffic data over time


# **get_network_client_traffic_history_2**
> List[object] get_network_client_traffic_history_2(network_id, client_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TrafficHistoryApi(api_client)
    ...
    try:
        # Return the client's network traffic data over time
        api_response = api_instance.get_network_client_traffic_history_2(network_id, client_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of TrafficHistoryApi->get_network_client_traffic_history_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TrafficHistoryApi->get_network_client_traffic_history_2: %s\n" % e)
```
