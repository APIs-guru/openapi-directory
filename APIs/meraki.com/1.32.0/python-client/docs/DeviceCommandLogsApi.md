# openapi_client.DeviceCommandLogsApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_sm_device_device_command_logs_2**](DeviceCommandLogsApi.md#get_network_sm_device_device_command_logs_2) | **GET** /networks/{networkId}/sm/devices/{deviceId}/deviceCommandLogs | Return historical records of commands sent to Systems Manager devices


# **get_network_sm_device_device_command_logs_2**
> List[GetNetworkSmDeviceDeviceCommandLogs200ResponseInner] get_network_sm_device_device_command_logs_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DeviceCommandLogsApi(api_client)
    ...
    try:
        # Return historical records of commands sent to Systems Manager devices
        api_response = api_instance.get_network_sm_device_device_command_logs_2(network_id, device_id, per_page=per_page, starting_after=starting_after, ending_before=ending_before)
        print("The response of DeviceCommandLogsApi->get_network_sm_device_device_command_logs_2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeviceCommandLogsApi->get_network_sm_device_device_command_logs_2: %s\n" % e)
```
