...
class TestSchedulesApi(unittest.TestCase):
    ...
    def test_get_network_camera_schedules_1(self) -> None:
    ...
    def test_get_network_wireless_ssid_schedules_2(self) -> None:
    ...
    def test_update_network_wireless_ssid_schedules_2(self) -> None:
