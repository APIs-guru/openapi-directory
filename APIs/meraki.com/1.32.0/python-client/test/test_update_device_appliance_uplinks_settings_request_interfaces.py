...
class TestUpdateDeviceApplianceUplinksSettingsRequestInterfaces(unittest.TestCase):
    """UpdateDeviceApplianceUplinksSettingsRequestInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDeviceApplianceUplinksSettingsRequestInterfaces:
        """Test UpdateDeviceApplianceUplinksSettingsRequestInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDeviceApplianceUplinksSettingsRequestInterfaces`
        """
        model = UpdateDeviceApplianceUplinksSettingsRequestInterfaces()
        if include_optional:
            return UpdateDeviceApplianceUplinksSettingsRequestInterfaces(
    ...
    def testUpdateDeviceApplianceUplinksSettingsRequestInterfaces(self):
        """Test UpdateDeviceApplianceUplinksSettingsRequestInterfaces"""
