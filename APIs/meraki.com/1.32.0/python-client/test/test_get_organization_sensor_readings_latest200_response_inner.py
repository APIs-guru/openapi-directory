...
class TestGetOrganizationSensorReadingsLatest200ResponseInner(unittest.TestCase):
    """GetOrganizationSensorReadingsLatest200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationSensorReadingsLatest200ResponseInner:
        """Test GetOrganizationSensorReadingsLatest200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationSensorReadingsLatest200ResponseInner`
        """
        model = GetOrganizationSensorReadingsLatest200ResponseInner()
        if include_optional:
            return GetOrganizationSensorReadingsLatest200ResponseInner(
                network = openapi_client.models.get_organization_sensor_readings_history_200_response_inner_network.getOrganizationSensorReadingsHistory_200_response_inner_network(
                    ...
                    name = '', ),
                readings = [
                    openapi_client.models.get_organization_sensor_readings_latest_200_response_inner_readings_inner.getOrganizationSensorReadingsLatest_200_response_inner_readings_inner(
    ...
    def testGetOrganizationSensorReadingsLatest200ResponseInner(self):
        """Test GetOrganizationSensorReadingsLatest200ResponseInner"""
