...
class TestGetNetworkFirmwareUpgrades200ResponseProducts(unittest.TestCase):
    """GetNetworkFirmwareUpgrades200ResponseProducts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkFirmwareUpgrades200ResponseProducts:
        """Test GetNetworkFirmwareUpgrades200ResponseProducts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkFirmwareUpgrades200ResponseProducts`
        """
        model = GetNetworkFirmwareUpgrades200ResponseProducts()
        if include_optional:
            return GetNetworkFirmwareUpgrades200ResponseProducts(
                ...
                camera = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance.getNetworkFirmwareUpgrades_200_response_products_appliance(
                    ...
                    next_upgrade = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_next_upgrade.getNetworkFirmwareUpgrades_200_response_products_appliance_nextUpgrade(
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    participate_in_next_beta_release = True, ),
                cellular_gateway = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance.getNetworkFirmwareUpgrades_200_response_products_appliance(
                    available_versions = [
                        openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_available_versions_inner.getNetworkFirmwareUpgrades_200_response_products_appliance_availableVersions_inner(
                            firmware = '', 
                            id = '', 
                    ...
                    next_upgrade = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_next_upgrade.getNetworkFirmwareUpgrades_200_response_products_appliance_nextUpgrade(
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    participate_in_next_beta_release = True, ),
                sensor = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance.getNetworkFirmwareUpgrades_200_response_products_appliance(
                    available_versions = [
                        openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_available_versions_inner.getNetworkFirmwareUpgrades_200_response_products_appliance_availableVersions_inner(
                            firmware = '', 
                            id = '', 
                    ...
                    next_upgrade = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_next_upgrade.getNetworkFirmwareUpgrades_200_response_products_appliance_nextUpgrade(
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    participate_in_next_beta_release = True, ),
                switch = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance.getNetworkFirmwareUpgrades_200_response_products_appliance(
                    available_versions = [
                        openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_available_versions_inner.getNetworkFirmwareUpgrades_200_response_products_appliance_availableVersions_inner(
                            firmware = '', 
                            id = '', 
                    ...
                    next_upgrade = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_next_upgrade.getNetworkFirmwareUpgrades_200_response_products_appliance_nextUpgrade(
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    participate_in_next_beta_release = True, ),
                wireless = openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance.getNetworkFirmwareUpgrades_200_response_products_appliance(
                    available_versions = [
                        openapi_client.models.get_network_firmware_upgrades_200_response_products_appliance_available_versions_inner.getNetworkFirmwareUpgrades_200_response_products_appliance_availableVersions_inner(
                            firmware = '', 
                            id = '', 
    ...
    def testGetNetworkFirmwareUpgrades200ResponseProducts(self):
        """Test GetNetworkFirmwareUpgrades200ResponseProducts"""
