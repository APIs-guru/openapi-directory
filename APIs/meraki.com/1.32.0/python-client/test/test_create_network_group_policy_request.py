...
class TestCreateNetworkGroupPolicyRequest(unittest.TestCase):
    """CreateNetworkGroupPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNetworkGroupPolicyRequest:
        """Test CreateNetworkGroupPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNetworkGroupPolicyRequest`
        """
        model = CreateNetworkGroupPolicyRequest()
        if include_optional:
    ...
    def testCreateNetworkGroupPolicyRequest(self):
        """Test CreateNetworkGroupPolicyRequest"""
