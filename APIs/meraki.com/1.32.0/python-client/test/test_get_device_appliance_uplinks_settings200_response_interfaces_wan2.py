...
class TestGetDeviceApplianceUplinksSettings200ResponseInterfacesWan2(unittest.TestCase):
    """GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2:
        """Test GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2`
        """
        model = GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2()
        if include_optional:
            return GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2(
                enabled = True,
    ...
    def testGetDeviceApplianceUplinksSettings200ResponseInterfacesWan2(self):
        """Test GetDeviceApplianceUplinksSettings200ResponseInterfacesWan2"""
