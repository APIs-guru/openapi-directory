...
class TestCreateOrganizationBrandingPolicyRequest(unittest.TestCase):
    """CreateOrganizationBrandingPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrganizationBrandingPolicyRequest:
        """Test CreateOrganizationBrandingPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrganizationBrandingPolicyRequest`
        """
        model = CreateOrganizationBrandingPolicyRequest()
        if include_optional:
    ...
    def testCreateOrganizationBrandingPolicyRequest(self):
        """Test CreateOrganizationBrandingPolicyRequest"""
