...
class TestUpdateNetworkApplianceTrafficShapingRulesRequest(unittest.TestCase):
    """UpdateNetworkApplianceTrafficShapingRulesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkApplianceTrafficShapingRulesRequest:
        """Test UpdateNetworkApplianceTrafficShapingRulesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkApplianceTrafficShapingRulesRequest`
        """
        model = UpdateNetworkApplianceTrafficShapingRulesRequest()
        if include_optional:
            return UpdateNetworkApplianceTrafficShapingRulesRequest(
                default_rules_enabled = True,
                rules = [
                    openapi_client.models.update_network_appliance_traffic_shaping_rules_request_rules_inner.updateNetworkApplianceTrafficShapingRules_request_rules_inner(
                        definitions = [
    ...
    def testUpdateNetworkApplianceTrafficShapingRulesRequest(self):
        """Test UpdateNetworkApplianceTrafficShapingRulesRequest"""
