...
class TestUpdateNetworkApplianceTrafficShapingRulesRequestRulesInner(unittest.TestCase):
    """UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner:
        """Test UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner`
        """
        model = UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner()
        if include_optional:
            return UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner(
                definitions = [
    ...
    def testUpdateNetworkApplianceTrafficShapingRulesRequestRulesInner(self):
        """Test UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner"""
