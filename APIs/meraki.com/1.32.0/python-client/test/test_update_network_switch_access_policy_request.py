...
class TestUpdateNetworkSwitchAccessPolicyRequest(unittest.TestCase):
    """UpdateNetworkSwitchAccessPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkSwitchAccessPolicyRequest:
        """Test UpdateNetworkSwitchAccessPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkSwitchAccessPolicyRequest`
        """
        model = UpdateNetworkSwitchAccessPolicyRequest()
        if include_optional:
    ...
    def testUpdateNetworkSwitchAccessPolicyRequest(self):
        """Test UpdateNetworkSwitchAccessPolicyRequest"""
