...
class TestCreateNetworkGroupPolicyRequestFirewallAndTrafficShaping(unittest.TestCase):
    """CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping:
        """Test CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping`
        """
        model = CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping()
        if include_optional:
            return CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping(
                l3_firewall_rules = [
    ...
    def testCreateNetworkGroupPolicyRequestFirewallAndTrafficShaping(self):
        """Test CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping"""
