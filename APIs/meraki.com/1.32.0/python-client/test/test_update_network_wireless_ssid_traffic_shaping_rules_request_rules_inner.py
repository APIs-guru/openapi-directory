...
class TestUpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner(unittest.TestCase):
    """UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner:
        """Test UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner`
        """
        model = UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner()
        if include_optional:
            return UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner(
                definitions = [
    ...
    def testUpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner(self):
        """Test UpdateNetworkWirelessSsidTrafficShapingRulesRequestRulesInner"""
