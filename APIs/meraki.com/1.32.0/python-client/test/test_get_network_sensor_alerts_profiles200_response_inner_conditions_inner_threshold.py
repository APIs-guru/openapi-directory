...
class TestGetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold(unittest.TestCase):
    """GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold:
        """Test GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold`
        """
        model = GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold()
        if include_optional:
            return GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold(
    ...
    def testGetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold(self):
        """Test GetNetworkSensorAlertsProfiles200ResponseInnerConditionsInnerThreshold"""
