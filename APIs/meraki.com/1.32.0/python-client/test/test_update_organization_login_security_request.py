...
class TestUpdateOrganizationLoginSecurityRequest(unittest.TestCase):
    """UpdateOrganizationLoginSecurityRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrganizationLoginSecurityRequest:
        """Test UpdateOrganizationLoginSecurityRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrganizationLoginSecurityRequest`
        """
        model = UpdateOrganizationLoginSecurityRequest()
        if include_optional:
    ...
    def testUpdateOrganizationLoginSecurityRequest(self):
        """Test UpdateOrganizationLoginSecurityRequest"""
