...
class TestCreateNetworkFirmwareUpgradesStagedEventRequestProducts(unittest.TestCase):
    """CreateNetworkFirmwareUpgradesStagedEventRequestProducts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNetworkFirmwareUpgradesStagedEventRequestProducts:
        """Test CreateNetworkFirmwareUpgradesStagedEventRequestProducts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNetworkFirmwareUpgradesStagedEventRequestProducts`
        """
        model = CreateNetworkFirmwareUpgradesStagedEventRequestProducts()
        if include_optional:
            return CreateNetworkFirmwareUpgradesStagedEventRequestProducts(
    ...
    def testCreateNetworkFirmwareUpgradesStagedEventRequestProducts(self):
        """Test CreateNetworkFirmwareUpgradesStagedEventRequestProducts"""
