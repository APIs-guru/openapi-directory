...
class TestGetNetworkFirmwareUpgrades200ResponseProductsAppliance(unittest.TestCase):
    """GetNetworkFirmwareUpgrades200ResponseProductsAppliance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkFirmwareUpgrades200ResponseProductsAppliance:
        """Test GetNetworkFirmwareUpgrades200ResponseProductsAppliance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkFirmwareUpgrades200ResponseProductsAppliance`
        """
        model = GetNetworkFirmwareUpgrades200ResponseProductsAppliance()
        if include_optional:
            return GetNetworkFirmwareUpgrades200ResponseProductsAppliance(
                available_versions = [
    ...
    def testGetNetworkFirmwareUpgrades200ResponseProductsAppliance(self):
        """Test GetNetworkFirmwareUpgrades200ResponseProductsAppliance"""
