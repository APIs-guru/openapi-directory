...
class TestUpdateNetworkSensorAlertsProfileRequest(unittest.TestCase):
    """UpdateNetworkSensorAlertsProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkSensorAlertsProfileRequest:
        """Test UpdateNetworkSensorAlertsProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkSensorAlertsProfileRequest`
        """
        model = UpdateNetworkSensorAlertsProfileRequest()
        if include_optional:
    ...
    def testUpdateNetworkSensorAlertsProfileRequest(self):
        """Test UpdateNetworkSensorAlertsProfileRequest"""
