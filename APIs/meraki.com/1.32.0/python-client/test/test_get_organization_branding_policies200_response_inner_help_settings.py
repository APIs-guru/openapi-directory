...
class TestGetOrganizationBrandingPolicies200ResponseInnerHelpSettings(unittest.TestCase):
    """GetOrganizationBrandingPolicies200ResponseInnerHelpSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationBrandingPolicies200ResponseInnerHelpSettings:
        """Test GetOrganizationBrandingPolicies200ResponseInnerHelpSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationBrandingPolicies200ResponseInnerHelpSettings`
        """
        model = GetOrganizationBrandingPolicies200ResponseInnerHelpSettings()
        if include_optional:
            return GetOrganizationBrandingPolicies200ResponseInnerHelpSettings(
    ...
    def testGetOrganizationBrandingPolicies200ResponseInnerHelpSettings(self):
        """Test GetOrganizationBrandingPolicies200ResponseInnerHelpSettings"""
