...
class BluetoothSettingsApi:
    ...
    @validate_call
    def get_network_bluetooth_settings(
        self,
        ...
        _param = self._get_network_bluetooth_settings_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetNetworkBluetoothSettings200Response",
        }
    ...
    @validate_call
    def get_network_bluetooth_settings_with_http_info(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetNetworkBluetoothSettings200Response]:
        """Return the Bluetooth settings for a network. <a href=\"https://documentation.meraki.com/MR/Bluetooth/Bluetooth_Low_Energy_(BLE)\">Bluetooth settings</a> must be enabled on the network.
    ...
    @validate_call
    def get_network_bluetooth_settings_without_preload_content(
        self,
        network_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_network_bluetooth_settings_serialize(
        self,
        network_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/networks/{networkId}/bluetoothSettings',
    ...
    def update_device_wireless_bluetooth_settings(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateDeviceWirelessBluetoothSettings200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def update_device_wireless_bluetooth_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateDeviceWirelessBluetoothSettings200Response]:
        """Update the bluetooth settings for a wireless device
    ...
    def update_network_bluetooth_settings(
        self,
        network_id: StrictStr,
        update_network_bluetooth_settings_request: Optional[UpdateNetworkBluetoothSettingsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param network_id: (required)
        :type network_id: str
        :param update_network_bluetooth_settings_request:
        :type update_network_bluetooth_settings_request: UpdateNetworkBluetoothSettingsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_network_bluetooth_settings_serialize(
            network_id=network_id,
            update_network_bluetooth_settings_request=update_network_bluetooth_settings_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_network_bluetooth_settings_with_http_info(
        self,
        network_id: StrictStr,
        update_network_bluetooth_settings_request: Optional[UpdateNetworkBluetoothSettingsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_network_bluetooth_settings_without_preload_content(
        self,
        network_id: StrictStr,
        update_network_bluetooth_settings_request: Optional[UpdateNetworkBluetoothSettingsRequest] = None,
        _request_timeout: Union[
    ...
    def _update_network_bluetooth_settings_serialize(
        self,
        network_id,
        update_network_bluetooth_settings_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_network_bluetooth_settings_request is not None:
            _body_params = update_network_bluetooth_settings_request
