...
class ChangeLogApi:
    ...
    def get_organization_configuration_changes(
        ...
        _param = self._get_organization_configuration_changes_serialize(
    ...
    @validate_call
    def get_organization_configuration_changes_with_http_info(
        self,
        organization_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 365 days after t0.")] = None,
    ...
    @validate_call
    def get_organization_configuration_changes_without_preload_content(
        self,
        organization_id: StrictStr,
        t0: Annotated[Optional[StrictStr], Field(description="The beginning of the timespan for the data. The maximum lookback period is 365 days from today.")] = None,
        t1: Annotated[Optional[StrictStr], Field(description="The end of the timespan for the data. t1 can be a maximum of 365 days after t0.")] = None,
    ...
    def _get_organization_configuration_changes_serialize(
        self,
        organization_id,
        t0,
        t1,
