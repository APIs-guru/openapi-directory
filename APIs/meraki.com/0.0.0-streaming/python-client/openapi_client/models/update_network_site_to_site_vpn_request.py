...
class UpdateNetworkSiteToSiteVpnRequest(BaseModel):
    """
    UpdateNetworkSiteToSiteVpnRequest
    """ # noqa: E501
    hubs: Optional[List[UpdateNetworkSiteToSiteVpnRequestHubsInner]] = Field(default=None, description="The list of VPN hubs, in order of preference. In spoke mode, at least 1 hub is required.")
    mode: StrictStr = Field(description="The site-to-site VPN mode. Can be one of 'none', 'spoke' or 'hub'")
    subnets: Optional[List[UpdateNetworkSiteToSiteVpnRequestSubnetsInner]] = Field(default=None, description="The list of subnets and their VPN presence.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hubs": [UpdateNetworkSiteToSiteVpnRequestHubsInner.from_dict(_item) for _item in obj["hubs"]] if obj.get("hubs") is not None else None,
            "mode": obj.get("mode"),
            "subnets": [UpdateNetworkSiteToSiteVpnRequestSubnetsInner.from_dict(_item) for _item in obj["subnets"]] if obj.get("subnets") is not None else None
        })
        return _obj
