...
class CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63(BaseModel):
    """
    ...
    resolution: StrictStr = Field(description="Resolution of the camera. Can be one of '1920x1080' or '2688x1512'.")
    ...
    def resolution_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['1920x1080', '2688x1512']):
            raise ValueError("must be one of enum values ('1920x1080', '2688x1512')")
        return value
