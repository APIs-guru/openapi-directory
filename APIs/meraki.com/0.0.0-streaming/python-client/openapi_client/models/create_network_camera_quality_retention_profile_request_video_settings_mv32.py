...
class CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV32(BaseModel):
    """
    ...
    resolution: StrictStr = Field(description="Resolution of the camera. Can be one of '1080x1080' or '2058x2058'.")
    ...
    def resolution_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['1080x1080', '2058x2058']):
            raise ValueError("must be one of enum values ('1080x1080', '2058x2058')")
        return value
