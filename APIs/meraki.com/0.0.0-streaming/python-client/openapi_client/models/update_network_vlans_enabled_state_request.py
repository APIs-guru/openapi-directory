...
class UpdateNetworkVlansEnabledStateRequest(BaseModel):
    """
    UpdateNetworkVlansEnabledStateRequest
    """ # noqa: E501
    enabled: StrictBool = Field(description="Boolean indicating whether to enable (true) or disable (false) VLANs for the network")
