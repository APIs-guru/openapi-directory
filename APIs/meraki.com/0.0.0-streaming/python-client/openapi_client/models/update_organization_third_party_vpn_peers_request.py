...
class UpdateOrganizationThirdPartyVPNPeersRequest(BaseModel):
    """
    UpdateOrganizationThirdPartyVPNPeersRequest
    """ # noqa: E501
    peers: List[UpdateOrganizationThirdPartyVPNPeersRequestPeersInner] = Field(description="The list of VPN peers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "peers": [UpdateOrganizationThirdPartyVPNPeersRequestPeersInner.from_dict(_item) for _item in obj["peers"]] if obj.get("peers") is not None else None
        })
        return _obj
