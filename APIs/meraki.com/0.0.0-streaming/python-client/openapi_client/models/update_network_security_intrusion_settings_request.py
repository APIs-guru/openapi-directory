...
class UpdateNetworkSecurityIntrusionSettingsRequest(BaseModel):
    """
    ...
    protected_networks: Optional[UpdateNetworkSecurityIntrusionSettingsRequestProtectedNetworks] = Field(default=None, alias="protectedNetworks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "protectedNetworks": UpdateNetworkSecurityIntrusionSettingsRequestProtectedNetworks.from_dict(obj["protectedNetworks"]) if obj.get("protectedNetworks") is not None else None
        })
        return _obj
