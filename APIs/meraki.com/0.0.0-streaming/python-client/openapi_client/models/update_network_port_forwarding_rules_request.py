...
class UpdateNetworkPortForwardingRulesRequest(BaseModel):
    """
    UpdateNetworkPortForwardingRulesRequest
    """ # noqa: E501
    rules: List[UpdateNetworkPortForwardingRulesRequestRulesInner] = Field(description="An array of port forwarding params")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [UpdateNetworkPortForwardingRulesRequestRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
