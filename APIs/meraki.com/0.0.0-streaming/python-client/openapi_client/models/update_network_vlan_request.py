...
class UpdateNetworkVlanRequest(BaseModel):
    """
    ...
    dhcp_options: Optional[List[UpdateNetworkVlanRequestDhcpOptionsInner]] = Field(default=None, description="The list of DHCP options that will be included in DHCP responses. Each object in the list should have \"code\", \"type\", and \"value\" properties.", alias="dhcpOptions")
    ...
    reserved_ip_ranges: Optional[List[UpdateNetworkStaticRouteRequestReservedIpRangesInner]] = Field(default=None, description="The DHCP reserved IP ranges on the VLAN", alias="reservedIpRanges")
    ...
    __properties: ClassVar[List[str]] = ["applianceIp", "dhcpBootFilename", "dhcpBootNextServer", "dhcpBootOptionsEnabled", "dhcpHandling", "dhcpLeaseTime", "dhcpOptions", "dhcpRelayServerIps", "dnsNameservers", "fixedIpAssignments", "groupPolicyId", "name", "reservedIpRanges", "subnet", "vpnNatSubnet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dhcpOptions": [UpdateNetworkVlanRequestDhcpOptionsInner.from_dict(_item) for _item in obj["dhcpOptions"]] if obj.get("dhcpOptions") is not None else None,
