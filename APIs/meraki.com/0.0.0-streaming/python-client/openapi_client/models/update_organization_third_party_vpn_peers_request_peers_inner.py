...
class UpdateOrganizationThirdPartyVPNPeersRequestPeersInner(BaseModel):
    """
    ...
    ipsec_policies: Optional[UpdateOrganizationThirdPartyVPNPeersRequestPeersInnerIpsecPolicies] = Field(default=None, alias="ipsecPolicies")
    ...
    public_ip: StrictStr = Field(description="The public IP of the VPN peer", alias="publicIp")
    ...
    __properties: ClassVar[List[str]] = ["ikeVersion", "ipsecPolicies", "ipsecPoliciesPreset", "name", "networkTags", "privateSubnets", "publicIp", "remoteId", "secret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipsecPolicies": UpdateOrganizationThirdPartyVPNPeersRequestPeersInnerIpsecPolicies.from_dict(obj["ipsecPolicies"]) if obj.get("ipsecPolicies") is not None else None,
