...
class UpdateNetworkOneToOneNatRulesRequest(BaseModel):
    """
    UpdateNetworkOneToOneNatRulesRequest
    """ # noqa: E501
    rules: List[UpdateNetworkOneToOneNatRulesRequestRulesInner] = Field(description="An array of 1:1 nat rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [UpdateNetworkOneToOneNatRulesRequestRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
