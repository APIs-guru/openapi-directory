...
class ProvisionNetworkClientsRequestPoliciesBySecurityAppliance(BaseModel):
    """
    ...
    """ # noqa: E501
    device_policy: Optional[StrictStr] = Field(default=None, description="The policy to apply to the specified client. Can be 'Whitelisted', 'Blocked' or 'Normal'. Required.", alias="devicePolicy")
    __properties: ClassVar[List[str]] = ["devicePolicy"]
    ...
    def device_policy_validate_enum(cls, value):
        ...
        if value not in set(['Blocked', 'Normal', 'Whitelisted']):
            raise ValueError("must be one of enum values ('Blocked', 'Normal', 'Whitelisted')")
        return value
