...
class UpdateNetworkOneToManyNatRulesRequest(BaseModel):
    """
    UpdateNetworkOneToManyNatRulesRequest
    """ # noqa: E501
    rules: List[UpdateNetworkOneToManyNatRulesRequestRulesInner] = Field(description="An array of 1:Many nat rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [UpdateNetworkOneToManyNatRulesRequestRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
