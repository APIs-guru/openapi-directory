...
class TestUpdateNetworkUplinkSettingsRequest(unittest.TestCase):
    """UpdateNetworkUplinkSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkUplinkSettingsRequest:
        """Test UpdateNetworkUplinkSettingsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkUplinkSettingsRequest`
        """
        model = UpdateNetworkUplinkSettingsRequest()
        if include_optional:
            return UpdateNetworkUplinkSettingsRequest(
                bandwidth_limits = openapi_client.models.update_network_uplink_settings_request_bandwidth_limits.updateNetworkUplinkSettings_request_bandwidthLimits(
    ...
    def testUpdateNetworkUplinkSettingsRequest(self):
        """Test UpdateNetworkUplinkSettingsRequest"""
