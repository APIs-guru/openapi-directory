...
class TestUpdateNetworkCameraQualityRetentionProfileRequest(unittest.TestCase):
    """UpdateNetworkCameraQualityRetentionProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNetworkCameraQualityRetentionProfileRequest:
        """Test UpdateNetworkCameraQualityRetentionProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNetworkCameraQualityRetentionProfileRequest`
        """
        model = UpdateNetworkCameraQualityRetentionProfileRequest()
        if include_optional:
    ...
    def testUpdateNetworkCameraQualityRetentionProfileRequest(self):
        """Test UpdateNetworkCameraQualityRetentionProfileRequest"""
