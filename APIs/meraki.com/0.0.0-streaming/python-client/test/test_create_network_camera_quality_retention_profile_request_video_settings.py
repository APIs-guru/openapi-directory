...
class TestCreateNetworkCameraQualityRetentionProfileRequestVideoSettings(unittest.TestCase):
    """CreateNetworkCameraQualityRetentionProfileRequestVideoSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNetworkCameraQualityRetentionProfileRequestVideoSettings:
        """Test CreateNetworkCameraQualityRetentionProfileRequestVideoSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNetworkCameraQualityRetentionProfileRequestVideoSettings`
        """
        model = CreateNetworkCameraQualityRetentionProfileRequestVideoSettings()
        if include_optional:
            return CreateNetworkCameraQualityRetentionProfileRequestVideoSettings(
                mv12_mv22_mv72 = openapi_client.models.create_network_camera_quality_retention_profile_request_video_settings_mv12_mv22_mv72.createNetworkCameraQualityRetentionProfile_request_videoSettings_MV12_MV22_MV72(
                    quality = 'Enhanced', 
                    resolution = '1280x720', ),
                ...
                mv21_mv71 = openapi_client.models.create_network_camera_quality_retention_profile_request_video_settings_mv21_mv71.createNetworkCameraQualityRetentionProfile_request_videoSettings_MV21_MV71(
                    quality = 'Enhanced', 
                    resolution = '1280x720', ),
                mv22_x_mv72_x = openapi_client.models.create_network_camera_quality_retention_profile_request_video_settings_mv22_x_mv72_x.createNetworkCameraQualityRetentionProfile_request_videoSettings_MV22X_MV72X(
                    quality = 'Enhanced', 
                    resolution = '1280x720', ),
    ...
    def testCreateNetworkCameraQualityRetentionProfileRequestVideoSettings(self):
        """Test CreateNetworkCameraQualityRetentionProfileRequestVideoSettings"""
