# openapi_client.MXL3InboundFirewallApi

All URIs are relative to *https://api.meraki.com/api/v0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_network_appliance_firewall_inbound_firewall_rules**](MXL3InboundFirewallApi.md#get_network_appliance_firewall_inbound_firewall_rules) | **GET** /networks/{networkId}/appliance/firewall/inboundFirewallRules | Return the inbound firewall rules for an MX network
[**update_network_appliance_firewall_inbound_firewall_rules**](MXL3InboundFirewallApi.md#update_network_appliance_firewall_inbound_firewall_rules) | **PUT** /networks/{networkId}/appliance/firewall/inboundFirewallRules | Update the inbound firewall rules of an MX network
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.MXL3InboundFirewallApi(api_client)
    network_id = 'network_id_example' # str | 

    try:
        # Return the inbound firewall rules for an MX network
        api_response = api_instance.get_network_appliance_firewall_inbound_firewall_rules(network_id)
        print("The response of MXL3InboundFirewallApi->get_network_appliance_firewall_inbound_firewall_rules:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MXL3InboundFirewallApi->get_network_appliance_firewall_inbound_firewall_rules: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MXL3InboundFirewallApi->update_network_appliance_firewall_inbound_firewall_rules:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MXL3InboundFirewallApi->update_network_appliance_firewall_inbound_firewall_rules: %s\n" % e)
```
