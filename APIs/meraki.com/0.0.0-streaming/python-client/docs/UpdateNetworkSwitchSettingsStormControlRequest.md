...
update_network_switch_settings_storm_control_request_instance = UpdateNetworkSwitchSettingsStormControlRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateNetworkSwitchSettingsStormControlRequest.to_json())

# convert the object into a dict
update_network_switch_settings_storm_control_request_dict = update_network_switch_settings_storm_control_request_instance.to_dict()
# create an instance of UpdateNetworkSwitchSettingsStormControlRequest from a dict
update_network_switch_settings_storm_control_request_from_dict = UpdateNetworkSwitchSettingsStormControlRequest.from_dict(update_network_switch_settings_storm_control_request_dict)
```
