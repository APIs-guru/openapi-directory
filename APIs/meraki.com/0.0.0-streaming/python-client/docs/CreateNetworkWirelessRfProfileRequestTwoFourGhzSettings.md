...
**valid_auto_channels** | **List[int]** | Sets valid auto channels for 2.4Ghz band. Can be one of &#39;1&#39;, &#39;6&#39; or &#39;11&#39;. Defaults to [1, 6, 11]. | [optional] 
...
create_network_wireless_rf_profile_request_two_four_ghz_settings_instance = CreateNetworkWirelessRfProfileRequestTwoFourGhzSettings.from_json(json)
# print the JSON string representation of the object
print(CreateNetworkWirelessRfProfileRequestTwoFourGhzSettings.to_json())

# convert the object into a dict
create_network_wireless_rf_profile_request_two_four_ghz_settings_dict = create_network_wireless_rf_profile_request_two_four_ghz_settings_instance.to_dict()
# create an instance of CreateNetworkWirelessRfProfileRequestTwoFourGhzSettings from a dict
create_network_wireless_rf_profile_request_two_four_ghz_settings_from_dict = CreateNetworkWirelessRfProfileRequestTwoFourGhzSettings.from_dict(create_network_wireless_rf_profile_request_two_four_ghz_settings_dict)
```
