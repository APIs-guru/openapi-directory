# openapi_client.NamedTagScopeApi

All URIs are relative to *https://api.meraki.com/api/v0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_network_sm_target_group**](NamedTagScopeApi.md#create_network_sm_target_group) | **POST** /networks/{networkId}/sm/targetGroups | Add a target group
[**delete_network_sm_target_group**](NamedTagScopeApi.md#delete_network_sm_target_group) | **DELETE** /networks/{networkId}/sm/targetGroups/{targetGroupId} | Delete a target group from a network
[**get_network_sm_target_group**](NamedTagScopeApi.md#get_network_sm_target_group) | **GET** /networks/{networkId}/sm/targetGroups/{targetGroupId} | Return a target group
[**get_network_sm_target_groups**](NamedTagScopeApi.md#get_network_sm_target_groups) | **GET** /networks/{networkId}/sm/targetGroups | List the target groups in this network
[**update_network_sm_target_group**](NamedTagScopeApi.md#update_network_sm_target_group) | **PUT** /networks/{networkId}/sm/targetGroups/{targetGroupId} | Update a target group
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.NamedTagScopeApi(api_client)
    ...
    try:
        ...
        print("The response of NamedTagScopeApi->create_network_sm_target_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NamedTagScopeApi->create_network_sm_target_group: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NamedTagScopeApi->delete_network_sm_target_group: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NamedTagScopeApi->get_network_sm_target_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NamedTagScopeApi->get_network_sm_target_group: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NamedTagScopeApi->get_network_sm_target_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NamedTagScopeApi->get_network_sm_target_groups: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NamedTagScopeApi->update_network_sm_target_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NamedTagScopeApi->update_network_sm_target_group: %s\n" % e)
```
