...
class BasicSearchResult(BaseModel):
    ...
    BasicSearchResult
    """ # noqa: E501
    spaces: Optional[List[Space]] = Field(default=None, description="List of spaces")
    status: Optional[StrictStr] = Field(default=None, description="The status of the search (NORESULT, ERROR, TIMEOUT, MORERESULT)")
    __properties: ClassVar[List[str]] = ["spaces", "status"]
