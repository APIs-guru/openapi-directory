...
class AddParticipantsSearchResult(BaseModel):
    ...
    is_member: Optional[StrictBool] = Field(default=None, description="is the participant a member, true or false", alias="isMember")
    job_title: Optional[StrictStr] = Field(default=None, description="The job title of the participant", alias="jobTitle")
    ...
    __properties: ClassVar[List[str]] = ["department", "firstName", "isMember", "jobTitle", "lastName", "smallImageUri", "tenantId", "userId"]
