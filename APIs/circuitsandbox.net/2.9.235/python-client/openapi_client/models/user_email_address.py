...
class UserEmailAddress(BaseModel):
    ...
    UserEmailAddress
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="the email address")
    type: Optional[StrictStr] = Field(default=None, description="the type of the email address")
