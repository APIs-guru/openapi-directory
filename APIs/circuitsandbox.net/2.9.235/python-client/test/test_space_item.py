...
class TestSpaceItem(unittest.TestCase):
    """SpaceItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceItem:
        """Test SpaceItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceItem`
        """
        model = SpaceItem()
        if include_optional:
            return SpaceItem(
