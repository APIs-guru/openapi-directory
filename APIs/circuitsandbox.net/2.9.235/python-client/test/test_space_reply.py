...
class TestSpaceReply(unittest.TestCase):
    """SpaceReply unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceReply:
        """Test SpaceReply
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceReply`
        """
        model = SpaceReply()
        if include_optional:
            return SpaceReply(
