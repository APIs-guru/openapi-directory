...
class TestSpaceTopic(unittest.TestCase):
    """SpaceTopic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceTopic:
        """Test SpaceTopic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceTopic`
        """
        model = SpaceTopic()
        if include_optional:
            return SpaceTopic(
                ...
                pinned = True,
                space_item = openapi_client.models.space_item.SpaceItem(
                    status = '', 
                    attachments = [
