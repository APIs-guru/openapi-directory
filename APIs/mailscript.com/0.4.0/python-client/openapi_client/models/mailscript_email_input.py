...
class MailscriptEmailInput(BaseModel):
    ...
    owner: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["address", "createdAt", "createdBy", "id", "name", "owner", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mailescript-email']):
            raise ValueError("must be one of enum values ('mailescript-email')")
        return value
