...
class AddActionDaemonRequest(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['daemon']):
            raise ValueError("must be one of enum values ('daemon')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AddActionDaemonRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
