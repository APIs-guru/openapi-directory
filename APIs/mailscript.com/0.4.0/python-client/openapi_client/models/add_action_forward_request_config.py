...
class AddActionForwardRequestConfig(BaseModel):
    """
    ...
    key: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["forward", "from", "key", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['forward']):
            raise ValueError("must be one of enum values ('forward')")
        return value
