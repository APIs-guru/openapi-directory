...
class AddActionSendRequestConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["from", "html", "key", "subject", "text", "to", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['send']):
            raise ValueError("must be one of enum values ('send')")
        return value
