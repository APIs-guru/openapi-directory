...
------------- | ------------- | -------------
[**get_authenticated_user**](UserApi.md#get_authenticated_user) | **GET** /user | Get the authenticated user
[**update_user**](UserApi.md#update_user) | **PUT** /user | Update a user
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    update_user_request = openapi_client.UpdateUserRequest() # UpdateUserRequest | User body

    try:
        # Update a user
        api_instance.update_user(update_user_request)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **update_user_request** | [**UpdateUserRequest**](UpdateUserRequest.md)| User body | 
