...
class DefaultApi:
    ...
    def root_get(
        self,
        domain: Annotated[StrictStr, Field(description="Domain name for lookup purpose.")],
        key: Annotated[StrictStr, Field(description="API key.")],
        format: Annotated[Optional[StrictStr], Field(description="Returns the API response in json (default) or xml format.")] = None,
