...
class QueryResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["query", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": obj.get("query"),
            "results": [DocumentChunkWithScore.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
