...
class DocumentChunkWithScore(BaseModel):
    ...
    text: StrictStr
    __properties: ClassVar[List[str]] = ["embedding", "id", "metadata", "score", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metadata": DocumentChunkMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "score": obj.get("score"),
            "text": obj.get("text")
        })
        return _obj
