...
class Query(BaseModel):
    ...
    query: StrictStr
    top_k: Optional[StrictInt] = 3
    __properties: ClassVar[List[str]] = ["filter", "query", "top_k"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": DocumentMetadataFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "query": obj.get("query"),
