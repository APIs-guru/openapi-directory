...
class GoogleCloudDataplexV1DataProfileResultProfile(BaseModel):
    ...
    """ # noqa: E501
    fields: Optional[List[GoogleCloudDataplexV1DataProfileResultProfileField]] = Field(default=None, description="List of fields with structural and profile information for each field.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [GoogleCloudDataplexV1DataProfileResultProfileField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
