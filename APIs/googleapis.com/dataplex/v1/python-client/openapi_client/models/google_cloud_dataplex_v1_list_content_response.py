...
class GoogleCloudDataplexV1ListContentResponse(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[List[GoogleCloudDataplexV1Content]] = Field(default=None, description="Content under the given parent lake.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [GoogleCloudDataplexV1Content.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
