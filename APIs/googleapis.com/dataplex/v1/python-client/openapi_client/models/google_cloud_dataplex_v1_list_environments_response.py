...
class GoogleCloudDataplexV1ListEnvironmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    environments: Optional[List[GoogleCloudDataplexV1Environment]] = Field(default=None, description="Environments under the given parent lake.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environments": [GoogleCloudDataplexV1Environment.from_dict(_item) for _item in obj["environments"]] if obj.get("environments") is not None else None,
