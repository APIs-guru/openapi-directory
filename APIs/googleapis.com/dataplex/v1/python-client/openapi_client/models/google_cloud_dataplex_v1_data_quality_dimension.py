...
class GoogleCloudDataplexV1DataQualityDimension(BaseModel):
    """
    A dimension captures data quality intent about a defined subset of the rules specified.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The dimension name a rule belongs to. Supported dimensions are \"COMPLETENESS\", \"ACCURACY\", \"CONSISTENCY\", \"VALIDITY\", \"UNIQUENESS\", \"INTEGRITY\"")
