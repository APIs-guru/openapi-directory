...
class GoogleCloudDataplexV1ListDataScansResponse(BaseModel):
    ...
    """ # noqa: E501
    data_scans: Optional[List[GoogleCloudDataplexV1DataScan]] = Field(default=None, description="DataScans (BASIC view only) under the given parent location.", alias="dataScans")
    ...
    __properties: ClassVar[List[str]] = ["dataScans", "nextPageToken", "unreachable"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in data_scans (list)
        _items = []
        if self.data_scans:
            for _item_data_scans in self.data_scans:
                if _item_data_scans:
                    _items.append(_item_data_scans.to_dict())
            _dict['dataScans'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataScans": [GoogleCloudDataplexV1DataScan.from_dict(_item) for _item in obj["dataScans"]] if obj.get("dataScans") is not None else None,
