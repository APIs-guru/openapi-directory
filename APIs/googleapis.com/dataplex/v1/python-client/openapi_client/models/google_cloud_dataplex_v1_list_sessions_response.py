...
class GoogleCloudDataplexV1ListSessionsResponse(BaseModel):
    ...
    sessions: Optional[List[GoogleCloudDataplexV1Session]] = Field(default=None, description="Sessions under a given environment.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "sessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessions": [GoogleCloudDataplexV1Session.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
