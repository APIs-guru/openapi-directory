...
class GoogleCloudDataplexV1ActionFailedSecurityPolicyApply(BaseModel):
    ...
    """ # noqa: E501
    asset: Optional[StrictStr] = Field(default=None, description="Resource name of one of the assets with failing security policy application. Populated for a lake or zone resource only.")
