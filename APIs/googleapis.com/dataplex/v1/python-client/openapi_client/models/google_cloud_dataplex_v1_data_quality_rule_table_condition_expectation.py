...
class GoogleCloudDataplexV1DataQualityRuleTableConditionExpectation(BaseModel):
    ...
    """ # noqa: E501
    sql_expression: Optional[StrictStr] = Field(default=None, description="Optional. The SQL expression.", alias="sqlExpression")
    __properties: ClassVar[List[str]] = ["sqlExpression"]
