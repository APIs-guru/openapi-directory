...
class GoogleCloudDataplexV1StorageFormatIcebergOptions(BaseModel):
    ...
    """ # noqa: E501
    metadata_location: Optional[StrictStr] = Field(default=None, description="Optional. The location of where the iceberg metadata is present, must be within the table path", alias="metadataLocation")
    __properties: ClassVar[List[str]] = ["metadataLocation"]
