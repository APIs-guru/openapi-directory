...
class GoogleCloudDataplexV1EnvironmentEndpoints(BaseModel):
    ...
    """ # noqa: E501
    notebooks: Optional[StrictStr] = Field(default=None, description="Output only. URI to serve notebook APIs")
    sql: Optional[StrictStr] = Field(default=None, description="Output only. URI to serve SQL APIs")
    __properties: ClassVar[List[str]] = ["notebooks", "sql"]
