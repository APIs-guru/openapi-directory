...
class GoogleCloudDataplexV1ListZonesResponse(BaseModel):
    ...
    zones: Optional[List[GoogleCloudDataplexV1Zone]] = Field(default=None, description="Zones under the given parent lake.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "zones"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDataplexV1ListZonesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDataplexV1ListZonesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "zones": [GoogleCloudDataplexV1Zone.from_dict(_item) for _item in obj["zones"]] if obj.get("zones") is not None else None
        })
        return _obj
