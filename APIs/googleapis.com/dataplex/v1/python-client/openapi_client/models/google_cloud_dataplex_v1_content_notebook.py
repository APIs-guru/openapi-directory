...
class GoogleCloudDataplexV1ContentNotebook(BaseModel):
    ...
    """ # noqa: E501
    kernel_type: Optional[StrictStr] = Field(default=None, description="Required. Kernel Type of the notebook.", alias="kernelType")
    __properties: ClassVar[List[str]] = ["kernelType"]
    ...
    def kernel_type_validate_enum(cls, value):
        ...
        if value not in set(['KERNEL_TYPE_UNSPECIFIED', 'PYTHON3']):
            raise ValueError("must be one of enum values ('KERNEL_TYPE_UNSPECIFIED', 'PYTHON3')")
        return value
