...
class GoogleCloudDataplexV1RunTaskResponse(BaseModel):
    ...
    """ # noqa: E501
    job: Optional[GoogleCloudDataplexV1Job] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDataplexV1RunTaskResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDataplexV1RunTaskResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "job": GoogleCloudDataplexV1Job.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
