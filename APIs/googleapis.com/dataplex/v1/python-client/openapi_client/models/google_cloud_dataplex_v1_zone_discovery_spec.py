...
class GoogleCloudDataplexV1ZoneDiscoverySpec(BaseModel):
    ...
    """ # noqa: E501
    csv_options: Optional[GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions] = Field(default=None, alias="csvOptions")
    enabled: Optional[StrictBool] = Field(default=None, description="Required. Whether discovery is enabled.")
    ...
    json_options: Optional[GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptions] = Field(default=None, alias="jsonOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "csvOptions": GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions.from_dict(obj["csvOptions"]) if obj.get("csvOptions") is not None else None,
            "enabled": obj.get("enabled"),
            "excludePatterns": obj.get("excludePatterns"),
            "includePatterns": obj.get("includePatterns"),
            "jsonOptions": GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptions.from_dict(obj["jsonOptions"]) if obj.get("jsonOptions") is not None else None,
