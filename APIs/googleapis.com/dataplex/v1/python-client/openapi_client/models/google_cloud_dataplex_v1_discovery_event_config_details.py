...
class GoogleCloudDataplexV1DiscoveryEventConfigDetails(BaseModel):
    ...
    """ # noqa: E501
    parameters: Optional[Dict[str, StrictStr]] = Field(default=None, description="A list of discovery configuration parameters in effect. The keys are the field paths within DiscoverySpec. Eg. includePatterns, excludePatterns, csvOptions.disableTypeInference, etc.")
