...
class GoogleCloudDataplexV1ListActionsResponse(BaseModel):
    ...
    """ # noqa: E501
    actions: Optional[List[GoogleCloudDataplexV1Action]] = Field(default=None, description="Actions under the given parent lake/zone/asset.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [GoogleCloudDataplexV1Action.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None,
