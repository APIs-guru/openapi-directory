...
class GoogleCloudDataplexV1EnvironmentSessionStatus(BaseModel):
    ...
    """ # noqa: E501
    active: Optional[StrictBool] = Field(default=None, description="Output only. Queries over sessions to mark whether the environment is currently active or not")
