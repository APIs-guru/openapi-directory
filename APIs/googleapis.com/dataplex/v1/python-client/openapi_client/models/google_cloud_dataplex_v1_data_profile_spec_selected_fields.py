...
class GoogleCloudDataplexV1DataProfileSpecSelectedFields(BaseModel):
    """
    The specification for fields to include or exclude in data profile scan.
    """ # noqa: E501
    field_names: Optional[List[StrictStr]] = Field(default=None, description="Optional. Expected input is a list of fully qualified names of fields as in the schema.Only top-level field names for nested fields are supported. For instance, if 'x' is of nested field type, listing 'x' is supported but 'x.y.z' is not supported. Here 'y' and 'y.z' are nested fields of 'x'.", alias="fieldNames")
    __properties: ClassVar[List[str]] = ["fieldNames"]
