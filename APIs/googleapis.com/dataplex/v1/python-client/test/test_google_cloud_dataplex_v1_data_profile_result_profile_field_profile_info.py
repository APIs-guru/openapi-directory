...
class TestGoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo(unittest.TestCase):
    """GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo:
        """Test GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo`
        """
        model = GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo()
        if include_optional:
    ...
    def testGoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo(self):
        """Test GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo"""
