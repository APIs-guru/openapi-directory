...
class TestGoogleCloudDataplexV1ListDataScanJobsResponse(unittest.TestCase):
    """GoogleCloudDataplexV1ListDataScanJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDataplexV1ListDataScanJobsResponse:
        """Test GoogleCloudDataplexV1ListDataScanJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDataplexV1ListDataScanJobsResponse`
        """
        model = GoogleCloudDataplexV1ListDataScanJobsResponse()
        if include_optional:
            return GoogleCloudDataplexV1ListDataScanJobsResponse(
                data_scan_jobs = [
                    openapi_client.models.google_cloud_dataplex_v1_data_scan_job.GoogleCloudDataplexV1DataScanJob(
    ...
    def testGoogleCloudDataplexV1ListDataScanJobsResponse(self):
        """Test GoogleCloudDataplexV1ListDataScanJobsResponse"""
