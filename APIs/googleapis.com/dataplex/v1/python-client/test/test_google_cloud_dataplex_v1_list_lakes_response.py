...
class TestGoogleCloudDataplexV1ListLakesResponse(unittest.TestCase):
    """GoogleCloudDataplexV1ListLakesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDataplexV1ListLakesResponse:
        """Test GoogleCloudDataplexV1ListLakesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDataplexV1ListLakesResponse`
        """
        model = GoogleCloudDataplexV1ListLakesResponse()
        if include_optional:
            return GoogleCloudDataplexV1ListLakesResponse(
                lakes = [
                    openapi_client.models.google_cloud_dataplex_v1_lake.GoogleCloudDataplexV1Lake(
    ...
    def testGoogleCloudDataplexV1ListLakesResponse(self):
        """Test GoogleCloudDataplexV1ListLakesResponse"""
