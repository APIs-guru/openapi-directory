...
class TestGoogleCloudDataplexV1DataQualityRuleResult(unittest.TestCase):
    """GoogleCloudDataplexV1DataQualityRuleResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDataplexV1DataQualityRuleResult:
        """Test GoogleCloudDataplexV1DataQualityRuleResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDataplexV1DataQualityRuleResult`
        """
        model = GoogleCloudDataplexV1DataQualityRuleResult()
        if include_optional:
    ...
    def testGoogleCloudDataplexV1DataQualityRuleResult(self):
        """Test GoogleCloudDataplexV1DataQualityRuleResult"""
