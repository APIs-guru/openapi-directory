...
class GetEffectiveOrgPolicyRequest(BaseModel):
    ...
    """ # noqa: E501
    constraint: Optional[StrictStr] = Field(default=None, description="The name of the `Constraint` to compute the effective `Policy`.")
    __properties: ClassVar[List[str]] = ["constraint"]
