...
class SearchOrganizationsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token to be used to retrieve the next page of results. If the result is too large to fit within the page size specified in the request, this field will be set with a token that can be used to fetch the next page of results. If this field is empty, it indicates that this response contains the last page of results.", alias="nextPageToken")
    organizations: Optional[List[Organization]] = Field(default=None, description="The list of Organizations that matched the search query, possibly paginated.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "organizations"]
