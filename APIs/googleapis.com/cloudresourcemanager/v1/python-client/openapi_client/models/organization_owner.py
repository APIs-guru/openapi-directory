...
class OrganizationOwner(BaseModel):
    ...
    """ # noqa: E501
    directory_customer_id: Optional[StrictStr] = Field(default=None, description="The G Suite customer id used in the Directory API.", alias="directoryCustomerId")
    __properties: ClassVar[List[str]] = ["directoryCustomerId"]
