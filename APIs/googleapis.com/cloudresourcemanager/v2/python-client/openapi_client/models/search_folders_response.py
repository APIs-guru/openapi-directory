...
class SearchFoldersResponse(BaseModel):
    ...
    """ # noqa: E501
    folders: Optional[List[Folder]] = Field(default=None, description="A possibly paginated folder search results. the specified parent resource.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token returned from a previous call to `SearchFolders` that indicates from where searching should continue.", alias="nextPageToken")
