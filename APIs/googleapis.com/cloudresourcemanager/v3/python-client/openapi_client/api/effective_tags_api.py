...
class EffectiveTagsApi:
    ...
    def cloudresourcemanager_effective_tags_list(
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of effective tags to return in the response. The server allows a maximum of 300 effective tags to return in a single page. If unspecified, the server will use 100 as the default.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. A pagination token returned from a previous call to `ListEffectiveTags` that indicates from where this listing should continue.")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="Required. The full resource name of a resource for which you want to list the effective tags. E.g. \"//cloudresourcemanager.googleapis.com/projects/123\"")] = None,
        ...
        _param = self._cloudresourcemanager_effective_tags_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def cloudresourcemanager_effective_tags_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListEffectiveTagsResponse]:
        """cloudresourcemanager_effective_tags_list
    ...
    @validate_call
    def cloudresourcemanager_effective_tags_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudresourcemanager_effective_tags_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/effectiveTags',
