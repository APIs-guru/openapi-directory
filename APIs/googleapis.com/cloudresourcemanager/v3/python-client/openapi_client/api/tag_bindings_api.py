...
class TagBindingsApi:
    ...
    def cloudresourcemanager_tag_bindings_create(
        ...
        tag_binding: Optional[TagBinding] = None,
        ...
        _param = self._cloudresourcemanager_tag_bindings_create_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def cloudresourcemanager_tag_bindings_create_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def cloudresourcemanager_tag_bindings_create_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudresourcemanager_tag_bindings_create_serialize(
        self,
        xgafv,
        access_token,
        alt,
    ...
    def cloudresourcemanager_tag_bindings_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of TagBindings to return in the response. The server allows a maximum of 300 TagBindings to return. If unspecified, the server will use 100 as the default.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. A pagination token returned from a previous call to `ListTagBindings` that indicates where this listing should continue from.")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="Required. The full resource name of a resource for which you want to list existing TagBindings. E.g. \"//cloudresourcemanager.googleapis.com/projects/123\"")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._cloudresourcemanager_tag_bindings_list_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def cloudresourcemanager_tag_bindings_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListTagBindingsResponse]:
        """cloudresourcemanager_tag_bindings_list
    ...
    @validate_call
    def cloudresourcemanager_tag_bindings_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudresourcemanager_tag_bindings_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
