...
class ListLiensResponse(BaseModel):
    ...
    """ # noqa: E501
    liens: Optional[List[Lien]] = Field(default=None, description="A list of Liens.")
    ...
    __properties: ClassVar[List[str]] = ["liens", "nextPageToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in liens (list)
        _items = []
        if self.liens:
            for _item_liens in self.liens:
                if _item_liens:
                    _items.append(_item_liens.to_dict())
            _dict['liens'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "liens": [Lien.from_dict(_item) for _item in obj["liens"]] if obj.get("liens") is not None else None,
