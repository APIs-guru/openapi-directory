...
class Organization(BaseModel):
    ...
    organization_id: Optional[StrictStr] = Field(default=None, description="An immutable id for the Organization that is assigned on creation. This should be omitted when creating a new Organization. This field is read-only.", alias="organizationId")
    owner: Optional[OrganizationOwner] = None
    __properties: ClassVar[List[str]] = ["creationTime", "displayName", "lifecycleState", "name", "organizationId", "owner"]
