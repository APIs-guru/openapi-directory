...
class GoogleHomeEnterpriseSdmV1ListDevicesResponse(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[GoogleHomeEnterpriseSdmV1Device]] = Field(default=None, description="The list of devices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [GoogleHomeEnterpriseSdmV1Device.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
