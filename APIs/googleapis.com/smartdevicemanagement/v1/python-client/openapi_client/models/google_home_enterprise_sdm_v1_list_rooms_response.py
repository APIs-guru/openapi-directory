...
class GoogleHomeEnterpriseSdmV1ListRoomsResponse(BaseModel):
    ...
    """ # noqa: E501
    rooms: Optional[List[GoogleHomeEnterpriseSdmV1Room]] = Field(default=None, description="The list of rooms.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rooms": [GoogleHomeEnterpriseSdmV1Room.from_dict(_item) for _item in obj["rooms"]] if obj.get("rooms") is not None else None
        })
        return _obj
