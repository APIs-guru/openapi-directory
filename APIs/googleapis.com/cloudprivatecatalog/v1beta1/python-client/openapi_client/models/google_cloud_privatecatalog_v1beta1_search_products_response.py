...
class GoogleCloudPrivatecatalogV1beta1SearchProductsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token returned from a previous call to SearchProducts that indicates from where listing should continue. This field is optional.", alias="nextPageToken")
    products: Optional[List[GoogleCloudPrivatecatalogV1beta1Product]] = Field(default=None, description="The `Product` resources computed from the resource context.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [GoogleCloudPrivatecatalogV1beta1Product.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
