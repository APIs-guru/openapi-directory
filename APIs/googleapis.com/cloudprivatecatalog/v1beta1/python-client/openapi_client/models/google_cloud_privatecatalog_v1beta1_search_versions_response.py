...
class GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token returned from a previous call to SearchVersions that indicates from where the listing should continue. This field is optional.", alias="nextPageToken")
    versions: Optional[List[GoogleCloudPrivatecatalogV1beta1Version]] = Field(default=None, description="The `Version` resources computed from the resource context.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [GoogleCloudPrivatecatalogV1beta1Version.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
