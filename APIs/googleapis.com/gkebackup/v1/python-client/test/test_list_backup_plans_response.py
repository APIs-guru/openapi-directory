...
class TestListBackupPlansResponse(unittest.TestCase):
    """ListBackupPlansResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBackupPlansResponse:
        """Test ListBackupPlansResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBackupPlansResponse`
        """
        model = ListBackupPlansResponse()
        if include_optional:
            return ListBackupPlansResponse(
                backup_plans = [
                    openapi_client.models.backup_plan.BackupPlan(
    ...
    def testListBackupPlansResponse(self):
        """Test ListBackupPlansResponse"""
