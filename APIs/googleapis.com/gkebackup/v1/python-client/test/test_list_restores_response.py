...
class TestListRestoresResponse(unittest.TestCase):
    """ListRestoresResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRestoresResponse:
        """Test ListRestoresResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRestoresResponse`
        """
        model = ListRestoresResponse()
        if include_optional:
            return ListRestoresResponse(
                ...
                restores = [
                    openapi_client.models.restore.Restore(
                        ...
                        name = '', 
                        resources_excluded_count = 56, 
                        resources_failed_count = 56, 
                        resources_restored_count = 56, 
    ...
    def testListRestoresResponse(self):
        """Test ListRestoresResponse"""
