...
------------ | ------------- | ------------- | -------------
**code** | **str** | Global error code. Deprecated and ignored. Set custom error codes in ErrorProto.domain and ErrorProto.code instead. | [optional] 
**error** | [**List[ErrorProto]**](ErrorProto.md) | Specific error description and codes | [optional] 
**request_id** | **str** | Request identifier generated by the service, which can be used to identify the error in the logs | [optional] 
