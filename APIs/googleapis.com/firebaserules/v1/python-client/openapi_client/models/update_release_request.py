...
class UpdateReleaseRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Specifies which fields to update.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["release", "updateMask"]
