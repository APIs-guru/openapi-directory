...
class TestTestRulesetRequest(unittest.TestCase):
    """TestRulesetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestRulesetRequest:
        """Test TestRulesetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestRulesetRequest`
        """
        model = TestRulesetRequest()
        if include_optional:
    ...
    def testTestRulesetRequest(self):
        """Test TestRulesetRequest"""
