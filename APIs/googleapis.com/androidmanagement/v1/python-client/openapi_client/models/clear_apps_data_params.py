...
class ClearAppsDataParams(BaseModel):
    ...
    """ # noqa: E501
    package_names: Optional[List[StrictStr]] = Field(default=None, description="The package names of the apps whose data will be cleared when the command is executed.", alias="packageNames")
