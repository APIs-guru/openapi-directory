...
class LostModeLocationEvent(BaseModel):
    """
    A lost mode event containing the device location and battery level as a percentage.
    """ # noqa: E501
    battery_level: Optional[StrictInt] = Field(default=None, description="The battery level as a number between 0 and 100 inclusive", alias="batteryLevel")
    location: Optional[Location] = None
    __properties: ClassVar[List[str]] = ["batteryLevel", "location"]
