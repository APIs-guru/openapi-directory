...
class PersonalApplicationPolicy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["installType", "packageName"]
    ...
    def install_type_validate_enum(cls, value):
        ...
        if value not in set(['INSTALL_TYPE_UNSPECIFIED', 'BLOCKED', 'AVAILABLE']):
            raise ValueError("must be one of enum values ('INSTALL_TYPE_UNSPECIFIED', 'BLOCKED', 'AVAILABLE')")
        return value
