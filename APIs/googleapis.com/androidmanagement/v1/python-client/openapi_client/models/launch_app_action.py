...
class LaunchAppAction(BaseModel):
    ...
    """ # noqa: E501
    package_name: Optional[StrictStr] = Field(default=None, description="Package name of app to be launched", alias="packageName")
    __properties: ClassVar[List[str]] = ["packageName"]
