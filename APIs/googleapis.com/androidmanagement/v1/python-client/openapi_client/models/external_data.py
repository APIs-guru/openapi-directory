...
class ExternalData(BaseModel):
    ...
    """ # noqa: E501
    sha256_hash: Optional[StrictStr] = Field(default=None, description="The base-64 encoded SHA-256 hash of the content hosted at url. If the content doesn't match this hash, Android Device Policy won't use the data.", alias="sha256Hash")
    url: Optional[StrictStr] = Field(default=None, description="The absolute URL to the data, which must use either the http or https scheme. Android Device Policy doesn't provide any credentials in the GET request, so the URL must be publicly accessible. Including a long, random component in the URL may be used to prevent attackers from discovering the URL.")
    __properties: ClassVar[List[str]] = ["sha256Hash", "url"]
