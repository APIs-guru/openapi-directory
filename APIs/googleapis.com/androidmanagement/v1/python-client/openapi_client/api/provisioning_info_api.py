...
class ProvisioningInfoApi:
    ...
    @validate_call
    def androidmanagement_provisioning_info_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. The identifier that Android Device Policy passes to the 3P sign-in page in the form of provisioningInfo/{provisioning_info}.")],
        ...
        """androidmanagement_provisioning_info_get

        Get the device provisioning information by the identifier provided in the sign-in url.

        :param name: Required. The identifier that Android Device Policy passes to the 3P sign-in page in the form of provisioningInfo/{provisioning_info}. (required)
        :type name: str
        ...
        _param = self._androidmanagement_provisioning_info_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def androidmanagement_provisioning_info_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The identifier that Android Device Policy passes to the 3P sign-in page in the form of provisioningInfo/{provisioning_info}.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def androidmanagement_provisioning_info_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The identifier that Android Device Policy passes to the 3P sign-in page in the form of provisioningInfo/{provisioning_info}.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _androidmanagement_provisioning_info_get_serialize(
        self,
        name,
        xgafv,
        access_token,
