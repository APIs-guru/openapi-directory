...
class MediaApi:
    ...
    def chat_media_download(
        ...
        _param = self._chat_media_download_serialize(
    ...
    @validate_call
    def chat_media_download_with_http_info(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def chat_media_download_without_preload_content(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _chat_media_download_serialize(
        self,
        resource_name,
        xgafv,
        access_token,
    ...
    def chat_media_upload(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Resource name of the Chat space in which the attachment is uploaded. Format \"spaces/{space}\".")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        upload_attachment_request: Optional[UploadAttachmentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param upload_attachment_request:
        :type upload_attachment_request: UploadAttachmentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._chat_media_upload_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def chat_media_upload_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Resource name of the Chat space in which the attachment is uploaded. Format \"spaces/{space}\".")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def chat_media_upload_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Resource name of the Chat space in which the attachment is uploaded. Format \"spaces/{space}\".")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _chat_media_upload_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if upload_attachment_request is not None:
            _body_params = upload_attachment_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{parent}/attachments:upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
