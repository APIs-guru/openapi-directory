...
class TimeZone(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The [IANA TZ](https://www.iana.org/time-zones) time zone database code, such as \"America/Toronto\".")
    offset: Optional[StrictInt] = Field(default=None, description="The user timezone offset, in milliseconds, from Coordinated Universal Time (UTC).")
    __properties: ClassVar[List[str]] = ["id", "offset"]
