...
class Reaction(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the reaction. Format: `spaces/{space}/messages/{message}/reactions/{reaction}`")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["emoji", "name", "user"]
