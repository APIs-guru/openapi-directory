...
class GoogleAppsCardV1SuggestionItem(BaseModel):
    ...
    """ # noqa: E501
    text: Optional[StrictStr] = Field(default=None, description="The value of a suggested input to a text input field. This is equivalent to what users enter themselves.")
