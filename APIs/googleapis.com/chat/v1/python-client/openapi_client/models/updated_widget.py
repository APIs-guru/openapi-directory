...
class UpdatedWidget(BaseModel):
    """
    The response of the updated widget. Used to provide autocomplete options for a widget.
    """ # noqa: E501
    suggestions: Optional[SelectionItems] = None
    widget: Optional[StrictStr] = Field(default=None, description="The ID of the updated widget. The ID must match the one for the widget that triggered the update request.")
    __properties: ClassVar[List[str]] = ["suggestions", "widget"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suggestions": SelectionItems.from_dict(obj["suggestions"]) if obj.get("suggestions") is not None else None,
