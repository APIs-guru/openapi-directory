...
class GoogleAppsCardV1Suggestions(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[GoogleAppsCardV1SuggestionItem]] = Field(default=None, description="A list of suggestions used for autocomplete recommendations in text input fields.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [GoogleAppsCardV1SuggestionItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
