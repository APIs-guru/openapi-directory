...
class DialogAction(BaseModel):
    ...
    """ # noqa: E501
    action_status: Optional[ActionStatus] = Field(default=None, alias="actionStatus")
    dialog: Optional[Dialog] = None
    __properties: ClassVar[List[str]] = ["actionStatus", "dialog"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dialog
        if self.dialog:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionStatus": ActionStatus.from_dict(obj["actionStatus"]) if obj.get("actionStatus") is not None else None,
            "dialog": Dialog.from_dict(obj["dialog"]) if obj.get("dialog") is not None else None
        })
        return _obj
