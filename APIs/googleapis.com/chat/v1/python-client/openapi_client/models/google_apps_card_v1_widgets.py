...
class GoogleAppsCardV1Widgets(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["buttonList", "dateTimePicker", "decoratedText", "image", "selectionInput", "textInput", "textParagraph"]
...
GoogleAppsCardV1Widgets.model_rebuild(raise_errors=False)
