...
class ListSpacesResponse(BaseModel):
    ...
    spaces: Optional[List[Space]] = Field(default=None, description="List of spaces in the requested (or first) page.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "spaces"]
