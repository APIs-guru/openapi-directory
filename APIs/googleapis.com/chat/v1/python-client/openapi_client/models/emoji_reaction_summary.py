...
class EmojiReactionSummary(BaseModel):
    ...
    reaction_count: Optional[StrictInt] = Field(default=None, description="The total number of reactions using the associated emoji.", alias="reactionCount")
    __properties: ClassVar[List[str]] = ["emoji", "reactionCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reactionCount": obj.get("reactionCount")
        })
        return _obj
