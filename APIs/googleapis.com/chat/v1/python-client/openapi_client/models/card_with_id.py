...
class CardWithId(BaseModel):
    ...
    card_id: Optional[StrictStr] = Field(default=None, description="Required if the message contains multiple cards. A unique identifier for a card in a message.", alias="cardId")
    __properties: ClassVar[List[str]] = ["card", "cardId"]
