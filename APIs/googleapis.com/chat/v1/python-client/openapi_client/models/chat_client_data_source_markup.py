...
class ChatClientDataSourceMarkup(BaseModel):
    """
    ...
    """ # noqa: E501
    space_data_source: Optional[SpaceDataSource] = Field(default=None, alias="spaceDataSource")
    __properties: ClassVar[List[str]] = ["spaceDataSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of space_data_source
        if self.space_data_source:
            _dict['spaceDataSource'] = self.space_data_source.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spaceDataSource": SpaceDataSource.from_dict(obj["spaceDataSource"]) if obj.get("spaceDataSource") is not None else None
        })
        return _obj
