...
**cjis_settings** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings**](GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.md) |  | [optional] 
**compliance_regime** | **str** | Required. Immutable. Compliance Regime associated with this workload. | [optional] 
**compliance_status** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatus**](GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatus.md) |  | [optional] 
...
**ekm_provisioning_response** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponse**](GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponse.md) |  | [optional] 
...
**fedramp_high_settings** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings**](GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.md) |  | [optional] 
**fedramp_moderate_settings** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings**](GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.md) |  | [optional] 
**il4_settings** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings**](GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.md) |  | [optional] 
...
**partner_permissions** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions**](GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.md) |  | [optional] 
...
**resource_settings** | [**List[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings]**](GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.md) | Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional. | [optional] 
**resources** | [**List[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo]**](GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo.md) | Output only. The resources associated with this workload. These resources will be created when creating the workload. If any of the projects already exist, the workload creation will fail. Always read only. | [optional] [readonly] 
**saa_enrollment_response** | [**GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse**](GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAssuredworkloadsV1beta1Workload from a JSON string
google_cloud_assuredworkloads_v1beta1_workload_instance = GoogleCloudAssuredworkloadsV1beta1Workload.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAssuredworkloadsV1beta1Workload.to_json())

# convert the object into a dict
google_cloud_assuredworkloads_v1beta1_workload_dict = google_cloud_assuredworkloads_v1beta1_workload_instance.to_dict()
# create an instance of GoogleCloudAssuredworkloadsV1beta1Workload from a dict
google_cloud_assuredworkloads_v1beta1_workload_from_dict = GoogleCloudAssuredworkloadsV1beta1Workload.from_dict(google_cloud_assuredworkloads_v1beta1_workload_dict)
```
