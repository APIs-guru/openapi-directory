...
class GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings(BaseModel):
    ...
    """ # noqa: E501
    kms_settings: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings] = Field(default=None, alias="kmsSettings")
    __properties: ClassVar[List[str]] = ["kmsSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kmsSettings": GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings.from_dict(obj["kmsSettings"]) if obj.get("kmsSettings") is not None else None
        })
        return _obj
