...
class GoogleCloudAssuredworkloadsV1beta1Violation(BaseModel):
    ...
    exception_contexts: Optional[List[GoogleCloudAssuredworkloadsV1beta1ViolationExceptionContext]] = Field(default=None, description="Output only. List of all the exception detail added for the violation.", alias="exceptionContexts")
    ...
    remediation: Optional[GoogleCloudAssuredworkloadsV1beta1ViolationRemediation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exceptionContexts": [GoogleCloudAssuredworkloadsV1beta1ViolationExceptionContext.from_dict(_item) for _item in obj["exceptionContexts"]] if obj.get("exceptionContexts") is not None else None,
            "name": obj.get("name"),
            ...
            "remediation": GoogleCloudAssuredworkloadsV1beta1ViolationRemediation.from_dict(obj["remediation"]) if obj.get("remediation") is not None else None,
