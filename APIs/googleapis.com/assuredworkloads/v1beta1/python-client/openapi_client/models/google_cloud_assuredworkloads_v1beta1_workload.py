...
class GoogleCloudAssuredworkloadsV1beta1Workload(BaseModel):
    ...
    cjis_settings: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings] = Field(default=None, alias="cjisSettings")
    ...
    compliance_status: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatus] = Field(default=None, alias="complianceStatus")
    ...
    ekm_provisioning_response: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponse] = Field(default=None, alias="ekmProvisioningResponse")
    ...
    fedramp_high_settings: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings] = Field(default=None, alias="fedrampHighSettings")
    fedramp_moderate_settings: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings] = Field(default=None, alias="fedrampModerateSettings")
    il4_settings: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings] = Field(default=None, alias="il4Settings")
    ...
    partner_permissions: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions] = Field(default=None, alias="partnerPermissions")
    ...
    resource_settings: Optional[List[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings]] = Field(default=None, description="Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional.", alias="resourceSettings")
    resources: Optional[List[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo]] = Field(default=None, description="Output only. The resources associated with this workload. These resources will be created when creating the workload. If any of the projects already exist, the workload creation will fail. Always read only.")
    saa_enrollment_response: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse] = Field(default=None, alias="saaEnrollmentResponse")
    ...
    __properties: ClassVar[List[str]] = ["billingAccount", "cjisSettings", "complianceRegime", "complianceStatus", "compliantButDisallowedServices", "createTime", "displayName", "ekmProvisioningResponse", "enableSovereignControls", "etag", "fedrampHighSettings", "fedrampModerateSettings", "il4Settings", "kajEnrollmentState", "kmsSettings", "labels", "name", "partner", "partnerPermissions", "provisionedResourcesParent", "resourceMonitoringEnabled", "resourceSettings", "resources", "saaEnrollmentResponse", "violationNotificationsEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of cjis_settings
        if self.cjis_settings:
            _dict['cjisSettings'] = self.cjis_settings.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of fedramp_high_settings
        if self.fedramp_high_settings:
            _dict['fedrampHighSettings'] = self.fedramp_high_settings.to_dict()
        # override the default output from pydantic by calling `to_dict()` of fedramp_moderate_settings
        if self.fedramp_moderate_settings:
            _dict['fedrampModerateSettings'] = self.fedramp_moderate_settings.to_dict()
        # override the default output from pydantic by calling `to_dict()` of il4_settings
        if self.il4_settings:
            _dict['il4Settings'] = self.il4_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cjisSettings": GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.from_dict(obj["cjisSettings"]) if obj.get("cjisSettings") is not None else None,
            "complianceRegime": obj.get("complianceRegime"),
            "complianceStatus": GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatus.from_dict(obj["complianceStatus"]) if obj.get("complianceStatus") is not None else None,
            "compliantButDisallowedServices": obj.get("compliantButDisallowedServices"),
            "createTime": obj.get("createTime"),
            "displayName": obj.get("displayName"),
            "ekmProvisioningResponse": GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponse.from_dict(obj["ekmProvisioningResponse"]) if obj.get("ekmProvisioningResponse") is not None else None,
            "enableSovereignControls": obj.get("enableSovereignControls"),
            "etag": obj.get("etag"),
            "fedrampHighSettings": GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.from_dict(obj["fedrampHighSettings"]) if obj.get("fedrampHighSettings") is not None else None,
            "fedrampModerateSettings": GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.from_dict(obj["fedrampModerateSettings"]) if obj.get("fedrampModerateSettings") is not None else None,
            "il4Settings": GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.from_dict(obj["il4Settings"]) if obj.get("il4Settings") is not None else None,
            ...
            "partnerPermissions": GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.from_dict(obj["partnerPermissions"]) if obj.get("partnerPermissions") is not None else None,
            ...
            "resources": [GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
            "saaEnrollmentResponse": GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse.from_dict(obj["saaEnrollmentResponse"]) if obj.get("saaEnrollmentResponse") is not None else None,
