...
class GoogleCloudAssuredworkloadsV1beta1ViolationRemediation(BaseModel):
    ...
    instructions: Optional[GoogleCloudAssuredworkloadsV1beta1ViolationRemediationInstructions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instructions": GoogleCloudAssuredworkloadsV1beta1ViolationRemediationInstructions.from_dict(obj["instructions"]) if obj.get("instructions") is not None else None,
