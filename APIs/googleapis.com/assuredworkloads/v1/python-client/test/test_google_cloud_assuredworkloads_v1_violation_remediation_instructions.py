...
class TestGoogleCloudAssuredworkloadsV1ViolationRemediationInstructions(unittest.TestCase):
    """GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions:
        """Test GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions`
        """
        model = GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions()
        if include_optional:
    ...
    def testGoogleCloudAssuredworkloadsV1ViolationRemediationInstructions(self):
        """Test GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions"""
