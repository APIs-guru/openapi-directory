...
class GoogleCloudAssuredworkloadsV1MoveAnalysisGroup(BaseModel):
    """
    ...
    """ # noqa: E501
    analysis_result: Optional[GoogleCloudAssuredworkloadsV1MoveAnalysisResult] = Field(default=None, alias="analysisResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analysisResult": GoogleCloudAssuredworkloadsV1MoveAnalysisResult.from_dict(obj["analysisResult"]) if obj.get("analysisResult") is not None else None,
