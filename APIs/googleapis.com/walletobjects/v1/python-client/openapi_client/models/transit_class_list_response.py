...
class TransitClassListResponse(BaseModel):
    """
    TransitClassListResponse
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    resources: Optional[List[TransitClass]] = Field(default=None, description="Resources corresponding to the list request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [TransitClass.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
