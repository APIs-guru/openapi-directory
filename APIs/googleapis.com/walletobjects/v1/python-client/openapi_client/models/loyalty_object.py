...
class LoyaltyObject(BaseModel):
    ...
    LoyaltyObject
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="The loyalty account identifier. Recommended maximum length is 20 characters.", alias="accountId")
    account_name: Optional[StrictStr] = Field(default=None, description="The loyalty account holder name, such as \"John Smith.\" Recommended maximum length is 20 characters to ensure full string is displayed on smaller screens.", alias="accountName")
    ...
    class_reference: Optional[LoyaltyClass] = Field(default=None, alias="classReference")
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#loyaltyObject\"`.")
    linked_offer_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of offer objects linked to this loyalty card. The offer objects must already exist. Offer object IDs should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you.", alias="linkedOfferIds")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of secondary_loyalty_points
        if self.secondary_loyalty_points:
            _dict['secondaryLoyaltyPoints'] = self.secondary_loyalty_points.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "classReference": LoyaltyClass.from_dict(obj["classReference"]) if obj.get("classReference") is not None else None,
            ...
            "kind": obj.get("kind"),
            "linkedOfferIds": obj.get("linkedOfferIds"),
            ...
            "secondaryLoyaltyPoints": LoyaltyPoints.from_dict(obj["secondaryLoyaltyPoints"]) if obj.get("secondaryLoyaltyPoints") is not None else None,
