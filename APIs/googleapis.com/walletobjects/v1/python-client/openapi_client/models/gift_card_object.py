...
class GiftCardObject(BaseModel):
    ...
    balance_update_time: Optional[datetime] = Field(default=None, alias="balanceUpdateTime")
    barcode: Optional[Barcode] = None
    card_number: Optional[StrictStr] = Field(default=None, description="Required. The card's number.", alias="cardNumber")
    ...
    class_reference: Optional[GiftCardClass] = Field(default=None, alias="classReference")
    ...
    event_number: Optional[StrictStr] = Field(default=None, description="The card's event number, an optional field used by some gift cards.", alias="eventNumber")
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#giftCardObject\"`.")
    ...
    pin: Optional[StrictStr] = Field(default=None, description="The card's PIN.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balance": Money.from_dict(obj["balance"]) if obj.get("balance") is not None else None,
            "balanceUpdateTime": obj.get("balanceUpdateTime"),
            ...
            "classReference": GiftCardClass.from_dict(obj["classReference"]) if obj.get("classReference") is not None else None,
            "disableExpirationNotification": obj.get("disableExpirationNotification"),
            "eventNumber": obj.get("eventNumber"),
