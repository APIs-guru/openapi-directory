...
class OfferClass(BaseModel):
    ...
    details: Optional[StrictStr] = Field(default=None, description="The details of the offer.")
    ...
    fine_print: Optional[StrictStr] = Field(default=None, description="The fine print or terms of the offer, such as \"20% off any t-shirt at Adam's Apparel.\"", alias="finePrint")
    help_uri: Optional[Uri] = Field(default=None, alias="helpUri")
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#offerClass\"`.")
    links_module_data: Optional[LinksModuleData] = Field(default=None, alias="linksModuleData")
    localized_details: Optional[LocalizedString] = Field(default=None, alias="localizedDetails")
    localized_fine_print: Optional[LocalizedString] = Field(default=None, alias="localizedFinePrint")
    localized_issuer_name: Optional[LocalizedString] = Field(default=None, alias="localizedIssuerName")
    localized_provider: Optional[LocalizedString] = Field(default=None, alias="localizedProvider")
    localized_short_title: Optional[LocalizedString] = Field(default=None, alias="localizedShortTitle")
    localized_title: Optional[LocalizedString] = Field(default=None, alias="localizedTitle")
    ...
    provider: Optional[StrictStr] = Field(default=None, description="Required. The offer provider (either the aggregator name or merchant name). Recommended maximum length is 12 characters to ensure full string is displayed on smaller screens.")
    redemption_channel: Optional[StrictStr] = Field(default=None, description="Required. The redemption channels applicable to this offer.", alias="redemptionChannel")
    ...
    short_title: Optional[StrictStr] = Field(default=None, description="A shortened version of the title of the offer, such as \"20% off,\" shown to users as a quick reference to the offer contents. Recommended maximum length is 20 characters.", alias="shortTitle")
    ...
    title: Optional[StrictStr] = Field(default=None, description="Required. The title of the offer, such as \"20% off any t-shirt.\" Recommended maximum length is 60 characters to ensure full string is displayed on smaller screens.")
    title_image: Optional[Image] = Field(default=None, alias="titleImage")
    version: Optional[StrictStr] = Field(default=None, description="Deprecated")
    view_unlock_requirement: Optional[StrictStr] = Field(default=None, description="View Unlock Requirement options for the offer.", alias="viewUnlockRequirement")
    wide_title_image: Optional[Image] = Field(default=None, alias="wideTitleImage")
    word_mark: Optional[Image] = Field(default=None, alias="wordMark")
    __properties: ClassVar[List[str]] = ["allowMultipleUsersPerObject", "callbackOptions", "classTemplateInfo", "countryCode", "details", "enableSmartTap", "finePrint", "helpUri", "heroImage", "hexBackgroundColor", "homepageUri", "id", "imageModulesData", "infoModuleData", "issuerName", "kind", "linksModuleData", "localizedDetails", "localizedFinePrint", "localizedIssuerName", "localizedProvider", "localizedShortTitle", "localizedTitle", "locations", "messages", "multipleDevicesAndHoldersAllowedStatus", "provider", "redemptionChannel", "redemptionIssuers", "review", "reviewStatus", "securityAnimation", "shortTitle", "textModulesData", "title", "titleImage", "version", "viewUnlockRequirement", "wideTitleImage", "wordMark"]
    ...
    def redemption_channel_validate_enum(cls, value):
        ...
        if value not in set(['REDEMPTION_CHANNEL_UNSPECIFIED', 'INSTORE', 'instore', 'ONLINE', 'online', 'BOTH', 'both', 'TEMPORARY_PRICE_REDUCTION', 'temporaryPriceReduction']):
            raise ValueError("must be one of enum values ('REDEMPTION_CHANNEL_UNSPECIFIED', 'INSTORE', 'instore', 'ONLINE', 'online', 'BOTH', 'both', 'TEMPORARY_PRICE_REDUCTION', 'temporaryPriceReduction')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of help_uri
        if self.help_uri:
            _dict['helpUri'] = self.help_uri.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of localized_details
        if self.localized_details:
            _dict['localizedDetails'] = self.localized_details.to_dict()
        # override the default output from pydantic by calling `to_dict()` of localized_fine_print
        if self.localized_fine_print:
            _dict['localizedFinePrint'] = self.localized_fine_print.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of localized_provider
        if self.localized_provider:
            _dict['localizedProvider'] = self.localized_provider.to_dict()
        # override the default output from pydantic by calling `to_dict()` of localized_short_title
        if self.localized_short_title:
            _dict['localizedShortTitle'] = self.localized_short_title.to_dict()
        # override the default output from pydantic by calling `to_dict()` of localized_title
        if self.localized_title:
            _dict['localizedTitle'] = self.localized_title.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of title_image
        if self.title_image:
            _dict['titleImage'] = self.title_image.to_dict()
        # override the default output from pydantic by calling `to_dict()` of wide_title_image
        if self.wide_title_image:
            _dict['wideTitleImage'] = self.wide_title_image.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "helpUri": Uri.from_dict(obj["helpUri"]) if obj.get("helpUri") is not None else None,
            ...
            "localizedDetails": LocalizedString.from_dict(obj["localizedDetails"]) if obj.get("localizedDetails") is not None else None,
            "localizedFinePrint": LocalizedString.from_dict(obj["localizedFinePrint"]) if obj.get("localizedFinePrint") is not None else None,
            ...
            "localizedProvider": LocalizedString.from_dict(obj["localizedProvider"]) if obj.get("localizedProvider") is not None else None,
            "localizedShortTitle": LocalizedString.from_dict(obj["localizedShortTitle"]) if obj.get("localizedShortTitle") is not None else None,
            "localizedTitle": LocalizedString.from_dict(obj["localizedTitle"]) if obj.get("localizedTitle") is not None else None,
            ...
            "title": obj.get("title"),
            "titleImage": Image.from_dict(obj["titleImage"]) if obj.get("titleImage") is not None else None,
            "version": obj.get("version"),
            "viewUnlockRequirement": obj.get("viewUnlockRequirement"),
            "wideTitleImage": Image.from_dict(obj["wideTitleImage"]) if obj.get("wideTitleImage") is not None else None,
