...
class ImageUri(BaseModel):
    ...
    ImageUri
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Additional information about the image, which is unused and retained only for backward compatibility.")
    localized_description: Optional[LocalizedString] = Field(default=None, alias="localizedDescription")
    uri: Optional[StrictStr] = Field(default=None, description="The location of the image. URIs must have a scheme.")
    __properties: ClassVar[List[str]] = ["description", "localizedDescription", "uri"]
