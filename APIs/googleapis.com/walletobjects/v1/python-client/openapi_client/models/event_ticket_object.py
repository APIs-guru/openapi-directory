...
class EventTicketObject(BaseModel):
    ...
    class_reference: Optional[EventTicketClass] = Field(default=None, alias="classReference")
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#eventTicketObject\"`.")
    linked_offer_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of offer objects linked to this event ticket. The offer objects must already exist. Offer object IDs should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you.", alias="linkedOfferIds")
    ...
    reservation_info: Optional[EventReservationInfo] = Field(default=None, alias="reservationInfo")
    rotating_barcode: Optional[RotatingBarcode] = Field(default=None, alias="rotatingBarcode")
    seat_info: Optional[EventSeat] = Field(default=None, alias="seatInfo")
    ...
    ticket_holder_name: Optional[StrictStr] = Field(default=None, description="Name of the ticket holder, if the ticket is assigned to a person. E.g. \"John Doe\" or \"Jane Doe\".", alias="ticketHolderName")
    ticket_number: Optional[StrictStr] = Field(default=None, description="The number of the ticket. This can be a unique identifier across all tickets in an issuer's system, all tickets for the event (e.g. XYZ1234512345), or all tickets in the order (1, 2, 3, etc.).", alias="ticketNumber")
    ticket_type: Optional[LocalizedString] = Field(default=None, alias="ticketType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seat_info
        if self.seat_info:
            _dict['seatInfo'] = self.seat_info.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of ticket_type
        if self.ticket_type:
            _dict['ticketType'] = self.ticket_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "classReference": EventTicketClass.from_dict(obj["classReference"]) if obj.get("classReference") is not None else None,
            ...
            "reservationInfo": EventReservationInfo.from_dict(obj["reservationInfo"]) if obj.get("reservationInfo") is not None else None,
            "rotatingBarcode": RotatingBarcode.from_dict(obj["rotatingBarcode"]) if obj.get("rotatingBarcode") is not None else None,
            "seatInfo": EventSeat.from_dict(obj["seatInfo"]) if obj.get("seatInfo") is not None else None,
            ...
            "ticketHolderName": obj.get("ticketHolderName"),
            "ticketNumber": obj.get("ticketNumber"),
            "ticketType": LocalizedString.from_dict(obj["ticketType"]) if obj.get("ticketType") is not None else None,
