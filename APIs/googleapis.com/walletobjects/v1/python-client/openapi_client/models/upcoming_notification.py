...
class UpcomingNotification(BaseModel):
    ...
    """ # noqa: E501
    enable_notification: Optional[StrictBool] = Field(default=None, description="Indicates if the object needs to have upcoming notification enabled.", alias="enableNotification")
    __properties: ClassVar[List[str]] = ["enableNotification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enableNotification": obj.get("enableNotification")
        })
        return _obj
