...
class Barcode(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#barcode\"`.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of barcode.")
    value: Optional[StrictStr] = Field(default=None, description="The value encoded in the barcode.")
    __properties: ClassVar[List[str]] = ["alternateText", "kind", "renderEncoding", "showCodeText", "type", "value"]
