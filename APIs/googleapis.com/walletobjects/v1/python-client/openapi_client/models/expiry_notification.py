...
class ExpiryNotification(BaseModel):
    ...
    """ # noqa: E501
    enable_notification: Optional[StrictBool] = Field(default=None, description="Indicates if the object needs to have expiry notification enabled.", alias="enableNotification")
