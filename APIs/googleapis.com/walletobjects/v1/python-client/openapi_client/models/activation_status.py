...
class ActivationStatus(BaseModel):
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['UNKNOWN_STATE', 'NOT_ACTIVATED', 'not_activated', 'ACTIVATED', 'activated']):
            raise ValueError("must be one of enum values ('UNKNOWN_STATE', 'NOT_ACTIVATED', 'not_activated', 'ACTIVATED', 'activated')")
        return value
