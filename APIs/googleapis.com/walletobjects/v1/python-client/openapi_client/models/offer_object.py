...
class OfferObject(BaseModel):
    ...
    class_reference: Optional[OfferClass] = Field(default=None, alias="classReference")
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string `\"walletobjects#offerObject\"`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "classReference": OfferClass.from_dict(obj["classReference"]) if obj.get("classReference") is not None else None,
