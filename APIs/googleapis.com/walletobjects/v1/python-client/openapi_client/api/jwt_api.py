...
class JwtApi:
    ...
    def walletobjects_jwt_insert(
        ...
        jwt_resource: Optional[JwtResource] = None,
        ...
        _param = self._walletobjects_jwt_insert_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def walletobjects_jwt_insert_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def walletobjects_jwt_insert_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _walletobjects_jwt_insert_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if jwt_resource is not None:
            _body_params = jwt_resource
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/walletobjects/v1/jwt',
