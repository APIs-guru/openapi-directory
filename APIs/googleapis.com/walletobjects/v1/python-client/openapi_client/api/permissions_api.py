...
class PermissionsApi:
    ...
    @validate_call
    def walletobjects_permissions_get(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        ...
        :param resource_id: The unique identifier for an issuer. This ID must be unique across all issuers. (required)
        ...
        _param = self._walletobjects_permissions_get_serialize(
    ...
    @validate_call
    def walletobjects_permissions_get_with_http_info(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def walletobjects_permissions_get_without_preload_content(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _walletobjects_permissions_get_serialize(
        self,
        resource_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/walletobjects/v1/permissions/{resourceId}',
    ...
    @validate_call
    def walletobjects_permissions_update(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _param = self._walletobjects_permissions_update_serialize(
            resource_id=resource_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def walletobjects_permissions_update_with_http_info(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def walletobjects_permissions_update_without_preload_content(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an issuer. This ID must be unique across all issuers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _walletobjects_permissions_update_serialize(
        self,
        resource_id,
        xgafv,
        access_token,
