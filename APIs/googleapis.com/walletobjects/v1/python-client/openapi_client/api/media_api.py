...
class MediaApi:
    ...
    @validate_call
    def walletobjects_media_download(
        self,
        ...
        _param = self._walletobjects_media_download_serialize(
    ...
    @validate_call
    def walletobjects_media_download_with_http_info(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an object. This ID must be unique across all objects from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def walletobjects_media_download_without_preload_content(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an object. This ID must be unique across all objects from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _walletobjects_media_download_serialize(
        self,
        resource_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/walletobjects/v1/transitObject/{resourceId}/downloadRotatingBarcodeValues',
    ...
    @validate_call
    def walletobjects_media_upload(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an object. This ID must be unique across all objects from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        transit_object_upload_rotating_barcode_values_request: Optional[TransitObjectUploadRotatingBarcodeValuesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param transit_object_upload_rotating_barcode_values_request:
        :type transit_object_upload_rotating_barcode_values_request: TransitObjectUploadRotatingBarcodeValuesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._walletobjects_media_upload_serialize(
            resource_id=resource_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            transit_object_upload_rotating_barcode_values_request=transit_object_upload_rotating_barcode_values_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def walletobjects_media_upload_with_http_info(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an object. This ID must be unique across all objects from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def walletobjects_media_upload_without_preload_content(
        self,
        resource_id: Annotated[StrictStr, Field(description="The unique identifier for an object. This ID must be unique across all objects from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _walletobjects_media_upload_serialize(
        self,
        resource_id,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if transit_object_upload_rotating_barcode_values_request is not None:
            _body_params = transit_object_upload_rotating_barcode_values_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/walletobjects/v1/transitObject/{resourceId}/uploadRotatingBarcodeValues',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
