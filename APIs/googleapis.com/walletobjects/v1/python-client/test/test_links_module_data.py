...
class TestLinksModuleData(unittest.TestCase):
    """LinksModuleData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinksModuleData:
        """Test LinksModuleData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinksModuleData`
        """
        model = LinksModuleData()
        if include_optional:
