...
class TestAirportInfo(unittest.TestCase):
    """AirportInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirportInfo:
        """Test AirportInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirportInfo`
        """
        model = AirportInfo()
        if include_optional:
            return AirportInfo(
