...
class TestGiftCardObjectAddMessageResponse(unittest.TestCase):
    """GiftCardObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftCardObjectAddMessageResponse:
        """Test GiftCardObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftCardObjectAddMessageResponse`
        """
        model = GiftCardObjectAddMessageResponse()
        if include_optional:
            return GiftCardObjectAddMessageResponse(
                resource = openapi_client.models.gift_card_object.GiftCardObject(
    ...
    def testGiftCardObjectAddMessageResponse(self):
        """Test GiftCardObjectAddMessageResponse"""
