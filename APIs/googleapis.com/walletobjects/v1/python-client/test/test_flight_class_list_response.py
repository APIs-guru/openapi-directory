...
class TestFlightClassListResponse(unittest.TestCase):
    """FlightClassListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlightClassListResponse:
        """Test FlightClassListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlightClassListResponse`
        """
        model = FlightClassListResponse()
        if include_optional:
    ...
    def testFlightClassListResponse(self):
        """Test FlightClassListResponse"""
