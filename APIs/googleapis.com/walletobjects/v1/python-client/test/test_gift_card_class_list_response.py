...
class TestGiftCardClassListResponse(unittest.TestCase):
    """GiftCardClassListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftCardClassListResponse:
        """Test GiftCardClassListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftCardClassListResponse`
        """
        model = GiftCardClassListResponse()
        if include_optional:
    ...
    def testGiftCardClassListResponse(self):
        """Test GiftCardClassListResponse"""
