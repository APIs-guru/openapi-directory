...
class TestEventTicketObject(unittest.TestCase):
    """EventTicketObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventTicketObject:
        """Test EventTicketObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventTicketObject`
        """
        model = EventTicketObject()
        if include_optional:
            return EventTicketObject(
                ...
                ticket_holder_name = '',
                ticket_number = '',
                ticket_type = openapi_client.models.localized_string.LocalizedString(
                    default_value = openapi_client.models.translated_string.TranslatedString(
                        kind = '', 
                        language = '', 
                        value = '', ), 
    ...
    def testEventTicketObject(self):
        """Test EventTicketObject"""
