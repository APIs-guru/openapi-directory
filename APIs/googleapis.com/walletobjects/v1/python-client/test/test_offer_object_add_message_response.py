...
class TestOfferObjectAddMessageResponse(unittest.TestCase):
    """OfferObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferObjectAddMessageResponse:
        """Test OfferObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferObjectAddMessageResponse`
        """
        model = OfferObjectAddMessageResponse()
        if include_optional:
            return OfferObjectAddMessageResponse(
                resource = openapi_client.models.offer_object.OfferObject(
    ...
    def testOfferObjectAddMessageResponse(self):
        """Test OfferObjectAddMessageResponse"""
