...
class TestFlightClassAddMessageResponse(unittest.TestCase):
    """FlightClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlightClassAddMessageResponse:
        """Test FlightClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlightClassAddMessageResponse`
        """
        model = FlightClassAddMessageResponse()
        if include_optional:
            return FlightClassAddMessageResponse(
                resource = openapi_client.models.flight_class.FlightClass(
    ...
    def testFlightClassAddMessageResponse(self):
        """Test FlightClassAddMessageResponse"""
