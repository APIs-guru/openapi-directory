...
class TestLoyaltyClassAddMessageResponse(unittest.TestCase):
    """LoyaltyClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoyaltyClassAddMessageResponse:
        """Test LoyaltyClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyClassAddMessageResponse`
        """
        model = LoyaltyClassAddMessageResponse()
        if include_optional:
            return LoyaltyClassAddMessageResponse(
                resource = openapi_client.models.loyalty_class.LoyaltyClass(
                    account_id_label = '', 
                    account_name_label = '', 
    ...
    def testLoyaltyClassAddMessageResponse(self):
        """Test LoyaltyClassAddMessageResponse"""
