...
class TestGenericClassAddMessageResponse(unittest.TestCase):
    """GenericClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenericClassAddMessageResponse:
        """Test GenericClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericClassAddMessageResponse`
        """
        model = GenericClassAddMessageResponse()
        if include_optional:
            return GenericClassAddMessageResponse(
                resource = openapi_client.models.generic_class.GenericClass(
    ...
    def testGenericClassAddMessageResponse(self):
        """Test GenericClassAddMessageResponse"""
