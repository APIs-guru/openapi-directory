...
class TestLoyaltyObjectListResponse(unittest.TestCase):
    """LoyaltyObjectListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoyaltyObjectListResponse:
        """Test LoyaltyObjectListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyObjectListResponse`
        """
        model = LoyaltyObjectListResponse()
        if include_optional:
    ...
    def testLoyaltyObjectListResponse(self):
        """Test LoyaltyObjectListResponse"""
