...
class TestCompositeMedia(unittest.TestCase):
    """CompositeMedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeMedia:
        """Test CompositeMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeMedia`
        """
        model = CompositeMedia()
        if include_optional:
