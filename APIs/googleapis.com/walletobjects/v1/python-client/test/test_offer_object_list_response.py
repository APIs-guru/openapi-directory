...
class TestOfferObjectListResponse(unittest.TestCase):
    """OfferObjectListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferObjectListResponse:
        """Test OfferObjectListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferObjectListResponse`
        """
        model = OfferObjectListResponse()
        if include_optional:
    ...
    def testOfferObjectListResponse(self):
        """Test OfferObjectListResponse"""
