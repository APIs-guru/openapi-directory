...
class TestTransitObjectAddMessageResponse(unittest.TestCase):
    """TransitObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitObjectAddMessageResponse:
        """Test TransitObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitObjectAddMessageResponse`
        """
        model = TransitObjectAddMessageResponse()
        if include_optional:
            return TransitObjectAddMessageResponse(
                resource = openapi_client.models.transit_object.TransitObject(
    ...
    def testTransitObjectAddMessageResponse(self):
        """Test TransitObjectAddMessageResponse"""
