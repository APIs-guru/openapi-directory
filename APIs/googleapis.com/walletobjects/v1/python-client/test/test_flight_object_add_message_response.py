...
class TestFlightObjectAddMessageResponse(unittest.TestCase):
    """FlightObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlightObjectAddMessageResponse:
        """Test FlightObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlightObjectAddMessageResponse`
        """
        model = FlightObjectAddMessageResponse()
        if include_optional:
            return FlightObjectAddMessageResponse(
                resource = openapi_client.models.flight_object.FlightObject(
    ...
    def testFlightObjectAddMessageResponse(self):
        """Test FlightObjectAddMessageResponse"""
