...
class TestTransitClassAddMessageResponse(unittest.TestCase):
    """TransitClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitClassAddMessageResponse:
        """Test TransitClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitClassAddMessageResponse`
        """
        model = TransitClassAddMessageResponse()
        if include_optional:
            return TransitClassAddMessageResponse(
                resource = openapi_client.models.transit_class.TransitClass(
    ...
    def testTransitClassAddMessageResponse(self):
        """Test TransitClassAddMessageResponse"""
