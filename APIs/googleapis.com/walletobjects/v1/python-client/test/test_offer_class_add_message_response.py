...
class TestOfferClassAddMessageResponse(unittest.TestCase):
    """OfferClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferClassAddMessageResponse:
        """Test OfferClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferClassAddMessageResponse`
        """
        model = OfferClassAddMessageResponse()
        if include_optional:
            return OfferClassAddMessageResponse(
                resource = openapi_client.models.offer_class.OfferClass(
    ...
    def testOfferClassAddMessageResponse(self):
        """Test OfferClassAddMessageResponse"""
