...
class TestTicketSeat(unittest.TestCase):
    """TicketSeat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketSeat:
        """Test TicketSeat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketSeat`
        """
        model = TicketSeat()
        if include_optional:
            return TicketSeat(
