...
class TestFrequentFlyerInfo(unittest.TestCase):
    """FrequentFlyerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FrequentFlyerInfo:
        """Test FrequentFlyerInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FrequentFlyerInfo`
        """
        model = FrequentFlyerInfo()
        if include_optional:
    ...
    def testFrequentFlyerInfo(self):
        """Test FrequentFlyerInfo"""
