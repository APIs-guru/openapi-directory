...
class TestEventTicketClassListResponse(unittest.TestCase):
    """EventTicketClassListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventTicketClassListResponse:
        """Test EventTicketClassListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventTicketClassListResponse`
        """
        model = EventTicketClassListResponse()
        if include_optional:
    ...
    def testEventTicketClassListResponse(self):
        """Test EventTicketClassListResponse"""
