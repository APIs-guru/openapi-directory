...
class TestLoyaltyObject(unittest.TestCase):
    """LoyaltyObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoyaltyObject:
        """Test LoyaltyObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyObject`
        """
        model = LoyaltyObject()
        if include_optional:
