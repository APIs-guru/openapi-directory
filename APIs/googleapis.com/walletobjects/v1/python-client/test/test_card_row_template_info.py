...
class TestCardRowTemplateInfo(unittest.TestCase):
    """CardRowTemplateInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardRowTemplateInfo:
        """Test CardRowTemplateInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardRowTemplateInfo`
        """
        model = CardRowTemplateInfo()
        if include_optional:
    ...
    def testCardRowTemplateInfo(self):
        """Test CardRowTemplateInfo"""
