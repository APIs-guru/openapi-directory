...
class TestOfferClassListResponse(unittest.TestCase):
    """OfferClassListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferClassListResponse:
        """Test OfferClassListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferClassListResponse`
        """
        model = OfferClassListResponse()
        if include_optional:
    ...
    def testOfferClassListResponse(self):
        """Test OfferClassListResponse"""
