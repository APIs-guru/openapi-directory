...
class TestFlightObjectListResponse(unittest.TestCase):
    """FlightObjectListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlightObjectListResponse:
        """Test FlightObjectListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlightObjectListResponse`
        """
        model = FlightObjectListResponse()
        if include_optional:
    ...
    def testFlightObjectListResponse(self):
        """Test FlightObjectListResponse"""
