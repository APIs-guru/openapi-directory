...
class TestTransitObjectListResponse(unittest.TestCase):
    """TransitObjectListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitObjectListResponse:
        """Test TransitObjectListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitObjectListResponse`
        """
        model = TransitObjectListResponse()
        if include_optional:
    ...
    def testTransitObjectListResponse(self):
        """Test TransitObjectListResponse"""
