...
class TestGenericObjectAddMessageResponse(unittest.TestCase):
    """GenericObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenericObjectAddMessageResponse:
        """Test GenericObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericObjectAddMessageResponse`
        """
        model = GenericObjectAddMessageResponse()
        if include_optional:
            return GenericObjectAddMessageResponse(
                resource = openapi_client.models.generic_object.GenericObject(
    ...
    def testGenericObjectAddMessageResponse(self):
        """Test GenericObjectAddMessageResponse"""
