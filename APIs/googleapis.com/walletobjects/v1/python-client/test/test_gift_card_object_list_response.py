...
class TestGiftCardObjectListResponse(unittest.TestCase):
    """GiftCardObjectListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftCardObjectListResponse:
        """Test GiftCardObjectListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftCardObjectListResponse`
        """
        model = GiftCardObjectListResponse()
        if include_optional:
    ...
    def testGiftCardObjectListResponse(self):
        """Test GiftCardObjectListResponse"""
