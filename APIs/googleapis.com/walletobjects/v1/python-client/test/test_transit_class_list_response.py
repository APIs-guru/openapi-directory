...
class TestTransitClassListResponse(unittest.TestCase):
    """TransitClassListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitClassListResponse:
        """Test TransitClassListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitClassListResponse`
        """
        model = TransitClassListResponse()
        if include_optional:
    ...
    def testTransitClassListResponse(self):
        """Test TransitClassListResponse"""
