...
class TestGiftCardClassAddMessageResponse(unittest.TestCase):
    """GiftCardClassAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftCardClassAddMessageResponse:
        """Test GiftCardClassAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftCardClassAddMessageResponse`
        """
        model = GiftCardClassAddMessageResponse()
        if include_optional:
            return GiftCardClassAddMessageResponse(
                resource = openapi_client.models.gift_card_class.GiftCardClass(
    ...
    def testGiftCardClassAddMessageResponse(self):
        """Test GiftCardClassAddMessageResponse"""
