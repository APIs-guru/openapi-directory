...
class TestEventTicketObjectAddMessageResponse(unittest.TestCase):
    """EventTicketObjectAddMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventTicketObjectAddMessageResponse:
        """Test EventTicketObjectAddMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventTicketObjectAddMessageResponse`
        """
        model = EventTicketObjectAddMessageResponse()
        if include_optional:
            return EventTicketObjectAddMessageResponse(
                resource = openapi_client.models.event_ticket_object.EventTicketObject(
    ...
    def testEventTicketObjectAddMessageResponse(self):
        """Test EventTicketObjectAddMessageResponse"""
