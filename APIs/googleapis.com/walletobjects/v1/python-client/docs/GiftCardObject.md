...
**balance_update_time** | **datetime** |  | [optional] 
**barcode** | [**Barcode**](Barcode.md) |  | [optional] 
**card_number** | **str** | Required. The card&#39;s number. | [optional] 
...
**class_reference** | [**GiftCardClass**](GiftCardClass.md) |  | [optional] 
...
**event_number** | **str** | The card&#39;s event number, an optional field used by some gift cards. | [optional] 
...
**kind** | **str** | Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;walletobjects#giftCardObject\&quot;&#x60;. | [optional] 
...
**pin** | **str** | The card&#39;s PIN. | [optional] 
...
json = "{}"
# create an instance of GiftCardObject from a JSON string
gift_card_object_instance = GiftCardObject.from_json(json)
# print the JSON string representation of the object
print(GiftCardObject.to_json())

# convert the object into a dict
gift_card_object_dict = gift_card_object_instance.to_dict()
# create an instance of GiftCardObject from a dict
gift_card_object_from_dict = GiftCardObject.from_dict(gift_card_object_dict)
```
