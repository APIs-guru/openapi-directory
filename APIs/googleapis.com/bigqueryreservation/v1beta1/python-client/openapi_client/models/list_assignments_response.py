...
class ListAssignmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    assignments: Optional[List[Assignment]] = Field(default=None, description="List of assignments visible to the user.")
    ...
    __properties: ClassVar[List[str]] = ["assignments", "nextPageToken"]
