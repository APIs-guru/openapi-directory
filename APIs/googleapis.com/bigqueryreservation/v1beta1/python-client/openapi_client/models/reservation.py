...
class Reservation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["concurrency", "creationTime", "ignoreIdleSlots", "multiRegionAuxiliary", "name", "slotCapacity", "updateTime"]
