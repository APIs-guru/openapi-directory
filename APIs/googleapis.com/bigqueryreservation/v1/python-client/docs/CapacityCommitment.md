...
**edition** | **str** | Edition of the capacity commitment. | [optional] 
**failure_status** | [**Status**](Status.md) |  | [optional] 
**is_flat_rate** | **bool** | Output only. If true, the commitment is a flat-rate commitment, otherwise, it&#39;s an edition commitment. | [optional] [readonly] 
...
**renewal_plan** | **str** | The plan this capacity commitment is converted to after commitment_end_time passes. Once the plan is changed, committed period is extended according to commitment plan. Only applicable for ANNUAL and TRIAL commitments. | [optional] 
