...
class SplitCapacityCommitmentResponse(BaseModel):
    ...
    """ # noqa: E501
    first: Optional[CapacityCommitment] = None
    second: Optional[CapacityCommitment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first": CapacityCommitment.from_dict(obj["first"]) if obj.get("first") is not None else None,
            "second": CapacityCommitment.from_dict(obj["second"]) if obj.get("second") is not None else None
        })
        return _obj
