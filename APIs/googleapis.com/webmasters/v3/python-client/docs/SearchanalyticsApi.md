...
------------- | ------------- | -------------
[**webmasters_searchanalytics_query**](SearchanalyticsApi.md#webmasters_searchanalytics_query) | **POST** /sites/{siteUrl}/searchAnalytics/query | 


# **webmasters_searchanalytics_query**
> SearchAnalyticsQueryResponse webmasters_searchanalytics_query(site_url, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, search_analytics_query_request=search_analytics_query_request)
