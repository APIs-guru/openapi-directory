...
class WmxSitemap(BaseModel):
    ...
    last_downloaded: Optional[datetime] = Field(default=None, description="Date & time in which this sitemap was last downloaded. Date format is in RFC 3339 format (yyyy-mm-dd).", alias="lastDownloaded")
    last_submitted: Optional[datetime] = Field(default=None, description="Date & time in which this sitemap was submitted. Date format is in RFC 3339 format (yyyy-mm-dd).", alias="lastSubmitted")
