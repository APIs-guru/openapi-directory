...
class EntityType(BaseModel):
    ...
    """ # noqa: E501
    fields: Optional[List[ModelField]] = Field(default=None, description="List containing metadata information about each field of the entity type.")
    ...
    __properties: ClassVar[List[str]] = ["fields", "jsonSchema", "name"]
