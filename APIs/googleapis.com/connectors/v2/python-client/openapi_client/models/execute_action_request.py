...
class ExecuteActionRequest(BaseModel):
    ...
    """ # noqa: E501
    parameters: Optional[Dict[str, Any]] = Field(default=None, description="Parameters for executing the action. The parameters can be key/value pairs or nested structs.")
