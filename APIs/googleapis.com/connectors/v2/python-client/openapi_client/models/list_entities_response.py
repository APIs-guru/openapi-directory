...
class ListEntitiesResponse(BaseModel):
    ...
    """ # noqa: E501
    entities: Optional[List[Entity]] = Field(default=None, description="List containing entity rows.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Next page token if more records are available.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["entities", "nextPageToken"]
