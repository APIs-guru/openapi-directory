...
class NodeSloMetadata(BaseModel):
    """
    ...
    per_sli_eligibility: Optional[PerSliSloEligibility] = Field(default=None, alias="perSliEligibility")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "perSliEligibility": PerSliSloEligibility.from_dict(obj["perSliEligibility"]) if obj.get("perSliEligibility") is not None else None
        })
        return _obj
