...
class TestEgressControlConfig(unittest.TestCase):
    """EgressControlConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EgressControlConfig:
        """Test EgressControlConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EgressControlConfig`
        """
        model = EgressControlConfig()
        if include_optional:
    ...
    def testEgressControlConfig(self):
        """Test EgressControlConfig"""
