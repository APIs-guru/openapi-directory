...
class TestConnectorInfraConfig(unittest.TestCase):
    """ConnectorInfraConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorInfraConfig:
        """Test ConnectorInfraConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorInfraConfig`
        """
        model = ConnectorInfraConfig()
        if include_optional:
    ...
    def testConnectorInfraConfig(self):
        """Test ConnectorInfraConfig"""
