...
class TestFieldComparison(unittest.TestCase):
    """FieldComparison unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FieldComparison:
        """Test FieldComparison
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FieldComparison`
        """
