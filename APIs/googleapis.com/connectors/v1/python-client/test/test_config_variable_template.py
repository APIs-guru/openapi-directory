...
class TestConfigVariableTemplate(unittest.TestCase):
    """ConfigVariableTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigVariableTemplate:
        """Test ConfigVariableTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigVariableTemplate`
        """
        model = ConfigVariableTemplate()
        if include_optional:
    ...
    def testConfigVariableTemplate(self):
        """Test ConfigVariableTemplate"""
