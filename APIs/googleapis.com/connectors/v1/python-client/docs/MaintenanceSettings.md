...
maintenance_settings_instance = MaintenanceSettings.from_json(json)
# print the JSON string representation of the object
print(MaintenanceSettings.to_json())

# convert the object into a dict
maintenance_settings_dict = maintenance_settings_instance.to_dict()
# create an instance of MaintenanceSettings from a dict
maintenance_settings_from_dict = MaintenanceSettings.from_dict(maintenance_settings_dict)
```
