...
class EndpointAttachment(BaseModel):
    ...
    endpoint_ip: Optional[StrictStr] = Field(default=None, description="Output only. The Private Service Connect connection endpoint ip", alias="endpointIp")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. Resource name of the Endpoint Attachment. Format: projects/{project}/locations/{location}/endpointAttachments/{endpoint_attachment}")
    service_attachment: Optional[StrictStr] = Field(default=None, description="Required. The path of the service attachment", alias="serviceAttachment")
    update_time: Optional[StrictStr] = Field(default=None, description="Output only. Updated time.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["createTime", "description", "endpointIp", "labels", "name", "serviceAttachment", "updateTime"]
