...
class ListEntityTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    entity_types: Optional[List[RuntimeEntitySchema]] = Field(default=None, description="list of entity types", alias="entityTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityTypes": [RuntimeEntitySchema.from_dict(_item) for _item in obj["entityTypes"]] if obj.get("entityTypes") is not None else None,
