...
class EndPoint(BaseModel):
    ...
    """ # noqa: E501
    endpoint_uri: Optional[StrictStr] = Field(default=None, description="The URI of the Endpoint.", alias="endpointUri")
    headers: Optional[List[Header]] = Field(default=None, description="List of Header to be added to the Endpoint.")
    __properties: ClassVar[List[str]] = ["endpointUri", "headers"]
