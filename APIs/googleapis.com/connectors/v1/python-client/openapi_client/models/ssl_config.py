...
class SslConfig(BaseModel):
    ...
    """ # noqa: E501
    additional_variables: Optional[List[ConfigVariable]] = Field(default=None, description="Additional SSL related field values", alias="additionalVariables")
    client_cert_type: Optional[StrictStr] = Field(default=None, description="Type of Client Cert (PEM/JKS/.. etc.)", alias="clientCertType")
    client_certificate: Optional[Secret] = Field(default=None, alias="clientCertificate")
    client_private_key: Optional[Secret] = Field(default=None, alias="clientPrivateKey")
    client_private_key_pass: Optional[Secret] = Field(default=None, alias="clientPrivateKeyPass")
    private_server_certificate: Optional[Secret] = Field(default=None, alias="privateServerCertificate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clientCertificate": Secret.from_dict(obj["clientCertificate"]) if obj.get("clientCertificate") is not None else None,
            "clientPrivateKey": Secret.from_dict(obj["clientPrivateKey"]) if obj.get("clientPrivateKey") is not None else None,
            "clientPrivateKeyPass": Secret.from_dict(obj["clientPrivateKeyPass"]) if obj.get("clientPrivateKeyPass") is not None else None,
            "privateServerCertificate": Secret.from_dict(obj["privateServerCertificate"]) if obj.get("privateServerCertificate") is not None else None,
