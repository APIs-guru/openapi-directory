...
class ConnectorInfraConfig(BaseModel):
    """
    This cofiguration provides infra configs like rate limit threshold which need to be configurable for every connector version
    """ # noqa: E501
    connection_ratelimit_window_seconds: Optional[StrictStr] = Field(default=None, description="The window used for ratelimiting runtime requests to connections.", alias="connectionRatelimitWindowSeconds")
    deployment_model: Optional[StrictStr] = Field(default=None, description="Indicate whether connector is deployed on GKE/CloudRun", alias="deploymentModel")
    hpa_config: Optional[HPAConfig] = Field(default=None, alias="hpaConfig")
    internalclient_ratelimit_threshold: Optional[StrictStr] = Field(default=None, description="Max QPS supported for internal requests originating from Connd.", alias="internalclientRatelimitThreshold")
    ratelimit_threshold: Optional[StrictStr] = Field(default=None, description="Max QPS supported by the connector version before throttling of requests.", alias="ratelimitThreshold")
    ...
    shared_deployment: Optional[StrictStr] = Field(default=None, description="The name of shared connector deployment.", alias="sharedDeployment")
