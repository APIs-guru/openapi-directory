...
class ListEventSubscriptionsResponse(BaseModel):
    ...
    """ # noqa: E501
    event_subscriptions: Optional[List[EventSubscription]] = Field(default=None, description="Subscriptions.", alias="eventSubscriptions")
    ...
    __properties: ClassVar[List[str]] = ["eventSubscriptions", "nextPageToken", "unreachable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventSubscriptions": [EventSubscription.from_dict(_item) for _item in obj["eventSubscriptions"]] if obj.get("eventSubscriptions") is not None else None,
