...
class ListEventTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    event_types: Optional[List[EventType]] = Field(default=None, description="A list of connector versions.", alias="eventTypes")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Next page token.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["eventTypes", "nextPageToken"]
