...
class InputParameter(BaseModel):
    ...
    default_value: Optional[Any] = Field(default=None, description="The following field specifies the default value of the Parameter provided by the external system if a value is not provided.", alias="defaultValue")
    description: Optional[StrictStr] = Field(default=None, description="A brief description of the Parameter.")
    ...
    parameter: Optional[StrictStr] = Field(default=None, description="Name of the Parameter.")
    __properties: ClassVar[List[str]] = ["dataType", "defaultValue", "description", "jsonSchema", "nullable", "parameter"]
