...
class RuntimeEntitySchema(BaseModel):
    """
    Schema of a runtime entity.
    """ # noqa: E501
    entity: Optional[StrictStr] = Field(default=None, description="Output only. Name of the entity.")
    fields: Optional[List[ModelField]] = Field(default=None, description="Output only. List of fields in the entity.")
    json_schema: Optional[JsonSchema] = Field(default=None, alias="jsonSchema")
    __properties: ClassVar[List[str]] = ["entity", "fields", "jsonSchema"]
