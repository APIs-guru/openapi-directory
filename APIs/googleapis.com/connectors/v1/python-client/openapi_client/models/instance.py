...
class Instance(BaseModel):
    ...
    maintenance_schedules: Optional[Dict[str, MaintenanceSchedule]] = Field(default=None, description="The MaintenanceSchedule contains the scheduling information of published maintenance schedule with same key as software_versions.", alias="maintenanceSchedules")
    maintenance_settings: Optional[MaintenanceSettings] = Field(default=None, alias="maintenanceSettings")
    ...
    provisioned_resources: Optional[List[ProvisionedResource]] = Field(default=None, description="Output only. The list of data plane resources provisioned for this instance, e.g. compute VMs. See go/get-instance-metadata.", alias="provisionedResources")
    ...
    slo_metadata: Optional[SloMetadata] = Field(default=None, alias="sloMetadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maintenanceSchedules": dict(
                (_k, MaintenanceSchedule.from_dict(_v))
                for _k, _v in obj["maintenanceSchedules"].items()
            )
            if obj.get("maintenanceSchedules") is not None
            else None,
            "maintenanceSettings": MaintenanceSettings.from_dict(obj["maintenanceSettings"]) if obj.get("maintenanceSettings") is not None else None,
            "name": obj.get("name"),
            "notificationParameters": dict(
                (_k, NotificationParameter.from_dict(_v))
            ...
            "provisionedResources": [ProvisionedResource.from_dict(_item) for _item in obj["provisionedResources"]] if obj.get("provisionedResources") is not None else None,
            "slmInstanceTemplate": obj.get("slmInstanceTemplate"),
            "sloMetadata": SloMetadata.from_dict(obj["sloMetadata"]) if obj.get("sloMetadata") is not None else None,
