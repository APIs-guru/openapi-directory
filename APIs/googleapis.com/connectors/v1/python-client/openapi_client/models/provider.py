...
class Provider(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. Resource name of the Provider. Format: projects/{project}/locations/{location}/providers/{provider} Only global location is supported for Provider resource.")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "description", "displayName", "documentationUri", "externalUri", "labels", "launchStage", "name", "updateTime", "webAssetsLocation"]
