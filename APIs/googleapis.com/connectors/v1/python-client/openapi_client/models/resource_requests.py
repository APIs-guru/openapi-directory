...
class ResourceRequests(BaseModel):
    ...
    """ # noqa: E501
    cpu: Optional[StrictStr] = Field(default=None, description="Output only. CPU request.")
    memory: Optional[StrictStr] = Field(default=None, description="Output only. Memory request.")
