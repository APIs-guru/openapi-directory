...
class AuthConfig(BaseModel):
    ...
    """ # noqa: E501
    additional_variables: Optional[List[ConfigVariable]] = Field(default=None, description="List containing additional auth configs.", alias="additionalVariables")
    ...
    oauth2_auth_code_flow: Optional[Oauth2AuthCodeFlow] = Field(default=None, alias="oauth2AuthCodeFlow")
    oauth2_client_credentials: Optional[Oauth2ClientCredentials] = Field(default=None, alias="oauth2ClientCredentials")
    oauth2_jwt_bearer: Optional[Oauth2JwtBearer] = Field(default=None, alias="oauth2JwtBearer")
    ssh_public_key: Optional[SshPublicKey] = Field(default=None, alias="sshPublicKey")
    user_password: Optional[UserPassword] = Field(default=None, alias="userPassword")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oauth2AuthCodeFlow": Oauth2AuthCodeFlow.from_dict(obj["oauth2AuthCodeFlow"]) if obj.get("oauth2AuthCodeFlow") is not None else None,
            "oauth2ClientCredentials": Oauth2ClientCredentials.from_dict(obj["oauth2ClientCredentials"]) if obj.get("oauth2ClientCredentials") is not None else None,
            "oauth2JwtBearer": Oauth2JwtBearer.from_dict(obj["oauth2JwtBearer"]) if obj.get("oauth2JwtBearer") is not None else None,
            "sshPublicKey": SshPublicKey.from_dict(obj["sshPublicKey"]) if obj.get("sshPublicKey") is not None else None,
            "userPassword": UserPassword.from_dict(obj["userPassword"]) if obj.get("userPassword") is not None else None
        })
        return _obj
