...
class TestOrdersCustomBatchRequest(unittest.TestCase):
    """OrdersCustomBatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersCustomBatchRequest:
        """Test OrdersCustomBatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersCustomBatchRequest`
        """
        model = OrdersCustomBatchRequest()
        if include_optional:
            return OrdersCustomBatchRequest(
                entries = [
                    openapi_client.models.orders_custom_batch_request_entry.OrdersCustomBatchRequestEntry(
                        batch_id = 56, 
    ...
    def testOrdersCustomBatchRequest(self):
        """Test OrdersCustomBatchRequest"""
