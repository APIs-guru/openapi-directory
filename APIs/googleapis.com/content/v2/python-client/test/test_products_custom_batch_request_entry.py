...
class TestProductsCustomBatchRequestEntry(unittest.TestCase):
    """ProductsCustomBatchRequestEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsCustomBatchRequestEntry:
        """Test ProductsCustomBatchRequestEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsCustomBatchRequestEntry`
        """
        model = ProductsCustomBatchRequestEntry()
        if include_optional:
    ...
    def testProductsCustomBatchRequestEntry(self):
        """Test ProductsCustomBatchRequestEntry"""
