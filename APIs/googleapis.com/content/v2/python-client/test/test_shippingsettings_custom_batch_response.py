...
class TestShippingsettingsCustomBatchResponse(unittest.TestCase):
    """ShippingsettingsCustomBatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingsettingsCustomBatchResponse:
        """Test ShippingsettingsCustomBatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingsettingsCustomBatchResponse`
        """
        model = ShippingsettingsCustomBatchResponse()
        if include_optional:
            return ShippingsettingsCustomBatchResponse(
                entries = [
                    openapi_client.models.shippingsettings_custom_batch_response_entry.ShippingsettingsCustomBatchResponseEntry(
                        batch_id = 56, 
    ...
    def testShippingsettingsCustomBatchResponse(self):
        """Test ShippingsettingsCustomBatchResponse"""
