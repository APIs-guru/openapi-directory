...
class TestProductsCustomBatchResponse(unittest.TestCase):
    """ProductsCustomBatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsCustomBatchResponse:
        """Test ProductsCustomBatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsCustomBatchResponse`
        """
        model = ProductsCustomBatchResponse()
        if include_optional:
            return ProductsCustomBatchResponse(
                entries = [
                    openapi_client.models.products_custom_batch_response_entry.ProductsCustomBatchResponseEntry(
                        batch_id = 56, 
    ...
    def testProductsCustomBatchResponse(self):
        """Test ProductsCustomBatchResponse"""
