...
json = "{}"
# create an instance of OrdersCustomBatchRequestEntryRefund from a JSON string
orders_custom_batch_request_entry_refund_instance = OrdersCustomBatchRequestEntryRefund.from_json(json)
# print the JSON string representation of the object
print(OrdersCustomBatchRequestEntryRefund.to_json())

# convert the object into a dict
orders_custom_batch_request_entry_refund_dict = orders_custom_batch_request_entry_refund_instance.to_dict()
# create an instance of OrdersCustomBatchRequestEntryRefund from a dict
orders_custom_batch_request_entry_refund_from_dict = OrdersCustomBatchRequestEntryRefund.from_dict(orders_custom_batch_request_entry_refund_dict)
```
