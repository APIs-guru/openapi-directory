...
orders_custom_batch_request_entry_return_refund_line_item_instance = OrdersCustomBatchRequestEntryReturnRefundLineItem.from_json(json)
# print the JSON string representation of the object
print(OrdersCustomBatchRequestEntryReturnRefundLineItem.to_json())

# convert the object into a dict
orders_custom_batch_request_entry_return_refund_line_item_dict = orders_custom_batch_request_entry_return_refund_line_item_instance.to_dict()
# create an instance of OrdersCustomBatchRequestEntryReturnRefundLineItem from a dict
orders_custom_batch_request_entry_return_refund_line_item_from_dict = OrdersCustomBatchRequestEntryReturnRefundLineItem.from_dict(orders_custom_batch_request_entry_return_refund_line_item_dict)
```
