...
orders_return_line_item_request_instance = OrdersReturnLineItemRequest.from_json(json)
# print the JSON string representation of the object
print(OrdersReturnLineItemRequest.to_json())

# convert the object into a dict
orders_return_line_item_request_dict = orders_return_line_item_request_instance.to_dict()
# create an instance of OrdersReturnLineItemRequest from a dict
orders_return_line_item_request_from_dict = OrdersReturnLineItemRequest.from_dict(orders_return_line_item_request_dict)
```
