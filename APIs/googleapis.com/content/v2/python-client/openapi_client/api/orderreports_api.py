...
class OrderreportsApi:
    ...
    def content_orderreports_listdisbursements(
        ...
        disbursement_end_date: Annotated[Optional[StrictStr], Field(description="The last date which disbursements occurred. In ISO 8601 format. Default: current date.")] = None,
        disbursement_start_date: Annotated[Optional[StrictStr], Field(description="The first date which disbursements occurred. In ISO 8601 format.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of disbursements to return in the response, used for paging.")] = None,
        ...
        _param = self._content_orderreports_listdisbursements_serialize(
            ...
            disbursement_end_date=disbursement_end_date,
            disbursement_start_date=disbursement_start_date,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderreportsListDisbursementsResponse",
        }
    ...
    @validate_call
    def content_orderreports_listdisbursements_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderreportsListDisbursementsResponse]:
        """content_orderreports_listdisbursements
    ...
    @validate_call
    def content_orderreports_listdisbursements_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_orderreports_listdisbursements_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        if disbursement_end_date is not None:
            
            _query_params.append(('disbursementEndDate', disbursement_end_date))
            
        if disbursement_start_date is not None:
            
            _query_params.append(('disbursementStartDate', disbursement_start_date))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/orderreports/disbursements',
    ...
    def content_orderreports_listtransactions(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        disbursement_id: Annotated[StrictStr, Field(description="The Google-provided ID of the disbursement (found in Wallet).")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of disbursements to return in the response, used for paging.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="The token returned by the previous request.")] = None,
        transaction_end_date: Annotated[Optional[StrictStr], Field(description="The last date in which transaction occurred. In ISO 8601 format. Default: current date.")] = None,
        transaction_start_date: Annotated[Optional[StrictStr], Field(description="The first date in which transaction occurred. In ISO 8601 format.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param merchant_id: The ID of the account that manages the order. This cannot be a multi-client account. (required)
        :type merchant_id: str
        :param disbursement_id: The Google-provided ID of the disbursement (found in Wallet). (required)
        ...
        _param = self._content_orderreports_listtransactions_serialize(
            merchant_id=merchant_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderreportsListTransactionsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def content_orderreports_listtransactions_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        disbursement_id: Annotated[StrictStr, Field(description="The Google-provided ID of the disbursement (found in Wallet).")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderreportsListTransactionsResponse]:
        """content_orderreports_listtransactions
    ...
    @validate_call
    def content_orderreports_listtransactions_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        disbursement_id: Annotated[StrictStr, Field(description="The Google-provided ID of the disbursement (found in Wallet).")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_orderreports_listtransactions_serialize(
        self,
        merchant_id,
        disbursement_id,
        xgafv,
        ...
        if transaction_end_date is not None:
            ...
            _query_params.append(('transactionEndDate', transaction_end_date))
            
        if transaction_start_date is not None:
            
            _query_params.append(('transactionStartDate', transaction_start_date))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/orderreports/disbursements/{disbursementId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
