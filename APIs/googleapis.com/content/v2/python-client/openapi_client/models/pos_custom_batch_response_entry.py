...
class PosCustomBatchResponseEntry(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#posCustomBatchResponseEntry`\"")
    sale: Optional[PosSale] = None
    store: Optional[PosStore] = None
    __properties: ClassVar[List[str]] = ["batchId", "errors", "inventory", "kind", "sale", "store"]
