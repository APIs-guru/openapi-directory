...
class Service(BaseModel):
    ...
    shipment_type: Optional[StrictStr] = Field(default=None, description="Type of locations this service ships orders to. Acceptable values are: - \"`delivery`\" - \"`pickup`\" ", alias="shipmentType")
    __properties: ClassVar[List[str]] = ["active", "currency", "deliveryCountry", "deliveryTime", "eligibility", "minimumOrderValue", "minimumOrderValueTable", "name", "pickupService", "rateGroups", "shipmentType"]
