...
class OrderLineItemProduct(BaseModel):
    ...
    channel: Optional[StrictStr] = Field(default=None, description="The item's channel (online or local). Acceptable values are: - \"`local`\" - \"`online`\" ")
    ...
    __properties: ClassVar[List[str]] = ["brand", "channel", "condition", "contentLanguage", "fees", "gtin", "id", "imageLink", "itemGroupId", "mpn", "offerId", "price", "shownImage", "targetCountry", "title", "variantAttributes"]
