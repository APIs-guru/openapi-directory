...
class LiasettingsCustomBatchRequestEntry(BaseModel):
    ...
    gmb_email: Optional[StrictStr] = Field(default=None, description="The GMB account. Required only for RequestGmbAccess.", alias="gmbEmail")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "batchId", "contactEmail", "contactName", "country", "gmbEmail", "liaSettings", "merchantId", "method", "posDataProviderId", "posExternalAccountId"]
