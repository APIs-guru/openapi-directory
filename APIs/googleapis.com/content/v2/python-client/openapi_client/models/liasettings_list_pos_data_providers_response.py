...
class LiasettingsListPosDataProvidersResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"content#liasettingsListPosDataProvidersResponse\".")
    pos_data_providers: Optional[List[PosDataProviders]] = Field(default=None, description="The list of POS data providers for each eligible country", alias="posDataProviders")
    __properties: ClassVar[List[str]] = ["kind", "posDataProviders"]
