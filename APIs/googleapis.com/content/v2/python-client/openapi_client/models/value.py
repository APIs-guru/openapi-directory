...
class Value(BaseModel):
    ...
    price_percentage: Optional[StrictStr] = Field(default=None, description="A percentage of the price represented as a number in decimal notation (e.g., `\"5.4\"`). Can only be set if all other fields are not set.", alias="pricePercentage")
    subtable_name: Optional[StrictStr] = Field(default=None, description="The name of a subtable. Can only be set in table cells (i.e., not for single values), and only if all other fields are not set.", alias="subtableName")
