...
class OrderAddress(BaseModel):
    ...
    OrderAddress
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="CLDR country code (e.g. \"US\").")
    ...
    street_address: Optional[List[StrictStr]] = Field(default=None, description="Street-level part of the address.", alias="streetAddress")
