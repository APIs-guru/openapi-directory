...
class ProductShipping(BaseModel):
    ...
    location_id: Optional[StrictStr] = Field(default=None, description="The numeric ID of a location that the shipping rate applies to as defined in the AdWords API.", alias="locationId")
    ...
    __properties: ClassVar[List[str]] = ["country", "locationGroupName", "locationId", "postalCode", "price", "region", "service"]
