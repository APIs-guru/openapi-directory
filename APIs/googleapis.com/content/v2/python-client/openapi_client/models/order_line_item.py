...
class OrderLineItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annotations", "cancellations", "id", "price", "product", "quantityCanceled", "quantityDelivered", "quantityOrdered", "quantityPending", "quantityReadyForPickup", "quantityReturned", "quantityShipped", "returnInfo", "returns", "shippingDetails", "tax"]
