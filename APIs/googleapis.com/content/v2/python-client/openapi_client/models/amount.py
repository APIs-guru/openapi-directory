...
class Amount(BaseModel):
    ...
    Amount
    """ # noqa: E501
    pretax: Optional[Price] = None
    tax: Optional[Price] = None
    __properties: ClassVar[List[str]] = ["pretax", "tax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pretax
        if self.pretax:
            _dict['pretax'] = self.pretax.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pretax": Price.from_dict(obj["pretax"]) if obj.get("pretax") is not None else None,
