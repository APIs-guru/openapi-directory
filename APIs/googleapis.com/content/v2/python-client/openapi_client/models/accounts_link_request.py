...
class AccountsLinkRequest(BaseModel):
    ...
    link_type: Optional[StrictStr] = Field(default=None, description="Type of the link between the two accounts. Acceptable values are: - \"`channelPartner`\" - \"`eCommercePlatform`\" ", alias="linkType")
    linked_account_id: Optional[StrictStr] = Field(default=None, description="The ID of the linked account.", alias="linkedAccountId")
    __properties: ClassVar[List[str]] = ["action", "linkType", "linkedAccountId"]
