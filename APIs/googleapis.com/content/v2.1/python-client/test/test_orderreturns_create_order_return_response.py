...
class TestOrderreturnsCreateOrderReturnResponse(unittest.TestCase):
    """OrderreturnsCreateOrderReturnResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderreturnsCreateOrderReturnResponse:
        """Test OrderreturnsCreateOrderReturnResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderreturnsCreateOrderReturnResponse`
        """
        model = OrderreturnsCreateOrderReturnResponse()
        if include_optional:
            return OrderreturnsCreateOrderReturnResponse(
                execution_status = '',
                kind = '',
                order_return = openapi_client.models.merchant_order_return.MerchantOrderReturn(
                    creation_date = '', 
                    merchant_order_id = '', 
                    order_id = '', 
                    order_return_id = '', 
    ...
    def testOrderreturnsCreateOrderReturnResponse(self):
        """Test OrderreturnsCreateOrderReturnResponse"""
