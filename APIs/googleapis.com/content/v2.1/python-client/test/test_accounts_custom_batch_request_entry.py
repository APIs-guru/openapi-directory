...
class TestAccountsCustomBatchRequestEntry(unittest.TestCase):
    """AccountsCustomBatchRequestEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountsCustomBatchRequestEntry:
        """Test AccountsCustomBatchRequestEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountsCustomBatchRequestEntry`
        """
        model = AccountsCustomBatchRequestEntry()
        if include_optional:
    ...
    def testAccountsCustomBatchRequestEntry(self):
        """Test AccountsCustomBatchRequestEntry"""
