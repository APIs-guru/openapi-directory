        ...
        if include_optional:
            return Promotion(
                ...
                limit_value = openapi_client.models.price_amount.PriceAmount(
                    ...
                    value = '', ),
                long_title = '',
                minimum_purchase_amount = openapi_client.models.price_amount.PriceAmount(
                    currency = '', 
                    value = '', ),
                minimum_purchase_quantity = 56,
                money_budget = openapi_client.models.price_amount.PriceAmount(
                    currency = '', 
                    value = '', ),
                money_off_amount = openapi_client.models.price_amount.PriceAmount(
                    currency = '', 
                    value = '', ),
