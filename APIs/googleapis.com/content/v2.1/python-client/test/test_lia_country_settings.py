...
class TestLiaCountrySettings(unittest.TestCase):
    """LiaCountrySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiaCountrySettings:
        """Test LiaCountrySettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiaCountrySettings`
        """
        model = LiaCountrySettings()
        if include_optional:
    ...
    def testLiaCountrySettings(self):
        """Test LiaCountrySettings"""
