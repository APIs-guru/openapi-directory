...
class TestOrdersGetByMerchantOrderIdResponse(unittest.TestCase):
    """OrdersGetByMerchantOrderIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersGetByMerchantOrderIdResponse:
        """Test OrdersGetByMerchantOrderIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersGetByMerchantOrderIdResponse`
        """
        model = OrdersGetByMerchantOrderIdResponse()
        if include_optional:
    ...
    def testOrdersGetByMerchantOrderIdResponse(self):
        """Test OrdersGetByMerchantOrderIdResponse"""
