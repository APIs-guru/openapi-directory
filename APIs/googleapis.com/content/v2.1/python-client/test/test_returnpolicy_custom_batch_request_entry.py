...
class TestReturnpolicyCustomBatchRequestEntry(unittest.TestCase):
    """ReturnpolicyCustomBatchRequestEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnpolicyCustomBatchRequestEntry:
        """Test ReturnpolicyCustomBatchRequestEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnpolicyCustomBatchRequestEntry`
        """
        model = ReturnpolicyCustomBatchRequestEntry()
        if include_optional:
    ...
    def testReturnpolicyCustomBatchRequestEntry(self):
        """Test ReturnpolicyCustomBatchRequestEntry"""
