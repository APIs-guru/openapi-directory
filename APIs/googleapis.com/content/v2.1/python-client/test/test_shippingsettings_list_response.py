...
class TestShippingsettingsListResponse(unittest.TestCase):
    """ShippingsettingsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingsettingsListResponse:
        """Test ShippingsettingsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingsettingsListResponse`
        """
        model = ShippingsettingsListResponse()
        if include_optional:
            return ShippingsettingsListResponse(
                kind = '',
                next_page_token = '',
                resources = [
                    openapi_client.models.shipping_settings.ShippingSettings(
                        account_id = '', 
                        postal_code_groups = [
    ...
    def testShippingsettingsListResponse(self):
        """Test ShippingsettingsListResponse"""
