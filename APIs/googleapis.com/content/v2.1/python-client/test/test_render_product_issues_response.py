...
class TestRenderProductIssuesResponse(unittest.TestCase):
    """RenderProductIssuesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenderProductIssuesResponse:
        """Test RenderProductIssuesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenderProductIssuesResponse`
        """
        model = RenderProductIssuesResponse()
        if include_optional:
            return RenderProductIssuesResponse(
                alternate_dispute_resolution = openapi_client.models.alternate_dispute_resolution.AlternateDisputeResolution(
                    ...
                    uri = '', ),
                issues = [
                    openapi_client.models.product_issue.ProductIssue(
                        actions = [
    ...
    def testRenderProductIssuesResponse(self):
        """Test RenderProductIssuesResponse"""
