...
class TestLiasettingsCustomBatchRequestEntry(unittest.TestCase):
    """LiasettingsCustomBatchRequestEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiasettingsCustomBatchRequestEntry:
        """Test LiasettingsCustomBatchRequestEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiasettingsCustomBatchRequestEntry`
        """
        model = LiasettingsCustomBatchRequestEntry()
        if include_optional:
    ...
    def testLiasettingsCustomBatchRequestEntry(self):
        """Test LiasettingsCustomBatchRequestEntry"""
