...
class TestAccountstatusesCustomBatchResponse(unittest.TestCase):
    """AccountstatusesCustomBatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountstatusesCustomBatchResponse:
        """Test AccountstatusesCustomBatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountstatusesCustomBatchResponse`
        """
        model = AccountstatusesCustomBatchResponse()
        if include_optional:
            return AccountstatusesCustomBatchResponse(
                entries = [
                    openapi_client.models.accountstatuses_custom_batch_response_entry.AccountstatusesCustomBatchResponseEntry(
    ...
    def testAccountstatusesCustomBatchResponse(self):
        """Test AccountstatusesCustomBatchResponse"""
