...
class TestProductIssue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProductIssue:
        """Test ProductIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductIssue`
        """
        model = ProductIssue()
        if include_optional:
            return ProductIssue(
                ...
                impact = openapi_client.models.product_issue_impact.ProductIssueImpact(
                    breakdowns = [
