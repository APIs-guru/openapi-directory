...
class AccountsCustomBatchRequestEntry(BaseModel):
    ...
    view: Optional[StrictStr] = Field(default=None, description="Controls which fields are visible. Only applicable if the method is 'get'.")
    __properties: ClassVar[List[str]] = ["account", "accountId", "batchId", "force", "labelIds", "linkRequest", "merchantId", "method", "overwrite", "view"]
