...
class RequestPhoneVerificationResponse(BaseModel):
    ...
    """ # noqa: E501
    verification_id: Optional[StrictStr] = Field(default=None, description="The verification ID to use in subsequent calls to `verifyphonenumber`.", alias="verificationId")
