...
class OrderReportDisbursement(BaseModel):
    ...
    disbursement_creation_date: Optional[StrictStr] = Field(default=None, description="The disbursement date, in ISO 8601 format.", alias="disbursementCreationDate")
    ...
    __properties: ClassVar[List[str]] = ["disbursementAmount", "disbursementCreationDate", "disbursementDate", "disbursementId", "merchantId"]
