...
class GenerateRecommendationsResponse(BaseModel):
    ...
    """ # noqa: E501
    recommendations: Optional[List[Recommendation]] = Field(default=None, description="Recommendations generated for a request.")
    response_token: Optional[StrictStr] = Field(default=None, description="Output only. Response token is a string created for each `GenerateRecommendationsResponse`. This token doesn't expire, and is globally unique. This token must be used when reporting interactions for recommendations.", alias="responseToken")
    __properties: ClassVar[List[str]] = ["recommendations", "responseToken"]
