...
class OrderReportTransaction(BaseModel):
    ...
    product_amount: Optional[ProductAmount] = Field(default=None, alias="productAmount")
    ...
    __properties: ClassVar[List[str]] = ["disbursementAmount", "disbursementCreationDate", "disbursementDate", "disbursementId", "merchantId", "merchantOrderId", "orderId", "productAmount", "transactionDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productAmount": ProductAmount.from_dict(obj["productAmount"]) if obj.get("productAmount") is not None else None,
