...
class ListCollectionStatusesResponse(BaseModel):
    """
    ...
    resources: Optional[List[CollectionStatus]] = Field(default=None, description="The collectionstatuses listed.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [CollectionStatus.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
