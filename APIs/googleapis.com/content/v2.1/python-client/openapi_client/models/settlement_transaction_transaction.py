...
class SettlementTransactionTransaction(BaseModel):
    """
    SettlementTransactionTransaction
    """ # noqa: E501
    post_date: Optional[StrictStr] = Field(default=None, description="The time on which the event occurred in ISO 8601 format.", alias="postDate")
    type: Optional[StrictStr] = Field(default=None, description="The type of the transaction that occurred. Acceptable values are: - \"`order`\" - \"`reversal`\" - \"`orderRefund`\" - \"`reversalRefund`\" - \"`issueRelatedRefundAndReplacement`\" - \"`returnLabelShippingFeeTransaction`\" - \"`reversalIssueRelatedRefundAndReplacement`\" - \"`reversalReturnLabelShippingFeeTransaction`\" - \"`lumpSumCorrectionTransaction`\" ")
    __properties: ClassVar[List[str]] = ["postDate", "type"]
