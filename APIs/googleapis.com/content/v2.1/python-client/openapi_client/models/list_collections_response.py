...
class ListCollectionsResponse(BaseModel):
    ...
    resources: Optional[List[Collection]] = Field(default=None, description="The collections listed.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": [Collection.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
