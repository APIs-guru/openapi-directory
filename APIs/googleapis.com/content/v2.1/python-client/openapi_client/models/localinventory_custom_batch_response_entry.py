...
class LocalinventoryCustomBatchResponseEntry(BaseModel):
    """
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#localinventoryCustomBatchResponseEntry`\"")
    __properties: ClassVar[List[str]] = ["batchId", "errors", "kind"]
