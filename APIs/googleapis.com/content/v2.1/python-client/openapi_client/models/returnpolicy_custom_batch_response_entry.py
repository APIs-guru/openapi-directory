...
class ReturnpolicyCustomBatchResponseEntry(BaseModel):
    """
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#returnpolicyCustomBatchResponseEntry`\"")
    return_policy: Optional[ReturnPolicy] = Field(default=None, alias="returnPolicy")
    __properties: ClassVar[List[str]] = ["batchId", "errors", "kind", "returnPolicy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of return_policy
        if self.return_policy:
            _dict['returnPolicy'] = self.return_policy.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "returnPolicy": ReturnPolicy.from_dict(obj["returnPolicy"]) if obj.get("returnPolicy") is not None else None
        })
        return _obj
