...
class InvoiceSummaryAdditionalChargeSummary(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="[required] Type of the additional charge. Acceptable values are: - \"`shipping`\" ")
    __properties: ClassVar[List[str]] = ["totalAmount", "type"]
