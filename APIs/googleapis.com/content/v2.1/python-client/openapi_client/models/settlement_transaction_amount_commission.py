...
class SettlementTransactionAmountCommission(BaseModel):
    """
    ...
    rate: Optional[StrictStr] = Field(default=None, description="Rate of the commission in percentage.")
    __properties: ClassVar[List[str]] = ["category", "rate"]
