...
class MerchantOrderReturn(BaseModel):
    ...
    return_pricing_info: Optional[ReturnPricingInfo] = Field(default=None, alias="returnPricingInfo")
    ...
    __properties: ClassVar[List[str]] = ["creationDate", "merchantOrderId", "orderId", "orderReturnId", "returnItems", "returnPricingInfo", "returnShipments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of return_pricing_info
        if self.return_pricing_info:
            _dict['returnPricingInfo'] = self.return_pricing_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "returnPricingInfo": ReturnPricingInfo.from_dict(obj["returnPricingInfo"]) if obj.get("returnPricingInfo") is not None else None,
