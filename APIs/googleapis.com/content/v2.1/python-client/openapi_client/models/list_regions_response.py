...
class ListRegionsResponse(BaseModel):
    ...
    regions: Optional[List[Region]] = Field(default=None, description="The regions from the specified merchant.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "regions"]
