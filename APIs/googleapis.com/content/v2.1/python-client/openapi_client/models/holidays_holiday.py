...
class HolidaysHoliday(BaseModel):
    ...
    HolidaysHoliday
    """ # noqa: E501
    country_code: Optional[StrictStr] = Field(default=None, description="The CLDR territory code of the country in which the holiday is available. For example, \"US\", \"DE\", \"GB\". A holiday cutoff can only be configured in a shipping settings service with matching delivery country. Always present.", alias="countryCode")
    var_date: Optional[StrictStr] = Field(default=None, description="Date of the holiday, in ISO 8601 format. For example, \"2016-12-25\" for Christmas 2016. Always present.", alias="date")
    delivery_guarantee_date: Optional[StrictStr] = Field(default=None, description="Date on which the order has to arrive at the customer's, in ISO 8601 format. For example, \"2016-12-24\" for 24th December 2016. Always present.", alias="deliveryGuaranteeDate")
