...
class ListReturnPolicyOnlineResponse(BaseModel):
    """
    Response message for the `ListReturnPolicyOnline` method.
    """ # noqa: E501
    return_policies: Optional[List[ReturnPolicyOnline]] = Field(default=None, description="The retrieved return policies.", alias="returnPolicies")
    __properties: ClassVar[List[str]] = ["returnPolicies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "returnPolicies": [ReturnPolicyOnline.from_dict(_item) for _item in obj["returnPolicies"]] if obj.get("returnPolicies") is not None else None
        })
        return _obj
