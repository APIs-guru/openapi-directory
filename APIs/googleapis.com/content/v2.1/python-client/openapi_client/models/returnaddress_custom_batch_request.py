...
class ReturnaddressCustomBatchRequest(BaseModel):
    """
    ReturnaddressCustomBatchRequest
    """ # noqa: E501
    entries: Optional[List[ReturnaddressCustomBatchRequestEntry]] = Field(default=None, description="The request entries to be processed in the batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ReturnaddressCustomBatchRequestEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
