...
class LiaCountrySettings(BaseModel):
    ...
    country: Optional[StrictStr] = Field(default=None, description="Required. CLDR country code (for example, \"US\").")
    ...
    __properties: ClassVar[List[str]] = ["about", "country", "hostedLocalStorefrontActive", "inventory", "omnichannelExperience", "onDisplayToOrder", "posDataProvider", "storePickupActive"]
