...
class OrderShipment(BaseModel):
    ...
    shipment_group_id: Optional[StrictStr] = Field(default=None, description="The shipment group ID of the shipment. This is set in shiplineitems request.", alias="shipmentGroupId")
    ...
    __properties: ClassVar[List[str]] = ["carrier", "creationDate", "deliveryDate", "id", "lineItems", "scheduledDeliveryDetails", "shipmentGroupId", "status", "trackingId"]
