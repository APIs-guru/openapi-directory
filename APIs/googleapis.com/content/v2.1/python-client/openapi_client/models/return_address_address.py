...
class ReturnAddressAddress(BaseModel):
    """
    ...
    recipient_name: Optional[StrictStr] = Field(default=None, description="Name of the recipient to address returns to.", alias="recipientName")
    ...
    street_address: Optional[List[StrictStr]] = Field(default=None, description="Street-level part of the address. May be up to two lines, each line specified as an array element.", alias="streetAddress")
    __properties: ClassVar[List[str]] = ["country", "locality", "postalCode", "recipientName", "region", "streetAddress"]
