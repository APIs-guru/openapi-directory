...
class DeliveryTime(BaseModel):
    ...
    max_transit_time_in_days: Optional[StrictInt] = Field(default=None, description="Maximum number of business days that are spent in transit. 0 means same day delivery, 1 means next day delivery. Must be greater than or equal to `minTransitTimeInDays`.", alias="maxTransitTimeInDays")
    ...
    min_transit_time_in_days: Optional[StrictInt] = Field(default=None, description="Minimum number of business days that are spent in transit. 0 means same day delivery, 1 means next day delivery. Either `{min,max}TransitTimeInDays` or `transitTimeTable` must be set, but not both.", alias="minTransitTimeInDays")
