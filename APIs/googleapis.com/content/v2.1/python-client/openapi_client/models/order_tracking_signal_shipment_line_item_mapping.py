...
class OrderTrackingSignalShipmentLineItemMapping(BaseModel):
    """
    Represents how many items are in the shipment for the given shipment_id and line_item_id.
    """ # noqa: E501
    line_item_id: Optional[StrictStr] = Field(default=None, description="Required. The line item ID.", alias="lineItemId")
    quantity: Optional[StrictStr] = Field(default=None, description="The line item quantity in the shipment.")
    ...
    __properties: ClassVar[List[str]] = ["lineItemId", "quantity", "shipmentId"]
