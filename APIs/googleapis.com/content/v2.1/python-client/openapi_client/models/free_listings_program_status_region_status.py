...
class FreeListingsProgramStatusRegionStatus(BaseModel):
    """
    ...
    eligibility_status: Optional[StrictStr] = Field(default=None, description="Eligibility status of the standard free listing program.", alias="eligibilityStatus")
    ...
    review_ineligibility_reason_details: Optional[FreeListingsProgramStatusReviewIneligibilityReasonDetails] = Field(default=None, alias="reviewIneligibilityReasonDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviewIneligibilityReasonDetails": FreeListingsProgramStatusReviewIneligibilityReasonDetails.from_dict(obj["reviewIneligibilityReasonDetails"]) if obj.get("reviewIneligibilityReasonDetails") is not None else None,
