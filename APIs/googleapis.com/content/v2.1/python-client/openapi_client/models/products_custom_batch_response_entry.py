...
class ProductsCustomBatchResponseEntry(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#productsCustomBatchResponseEntry`\"")
    product: Optional[Product] = None
    __properties: ClassVar[List[str]] = ["batchId", "errors", "kind", "product"]
