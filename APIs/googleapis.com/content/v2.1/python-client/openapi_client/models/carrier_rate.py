...
class CarrierRate(BaseModel):
    ...
    CarrierRate
    """ # noqa: E501
    carrier_name: Optional[StrictStr] = Field(default=None, description="Carrier service, such as `\"UPS\"` or `\"Fedex\"`. The list of supported carriers can be retrieved through the `getSupportedCarriers` method. Required.", alias="carrierName")
    carrier_service: Optional[StrictStr] = Field(default=None, description="Carrier service, such as `\"ground\"` or `\"2 days\"`. The list of supported services for a carrier can be retrieved through the `getSupportedCarriers` method. Required.", alias="carrierService")
