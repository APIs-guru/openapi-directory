...
class ReturnaddressCustomBatchResponseEntry(BaseModel):
    """
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#returnaddressCustomBatchResponseEntry`\"")
    return_address: Optional[ReturnAddress] = Field(default=None, alias="returnAddress")
    __properties: ClassVar[List[str]] = ["batchId", "errors", "kind", "returnAddress"]
