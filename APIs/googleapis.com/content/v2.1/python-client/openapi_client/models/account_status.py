...
class AccountStatus(BaseModel):
    ...
    account_management: Optional[StrictStr] = Field(default=None, description="How the account is managed. Acceptable values are: - \"`manual`\" - \"`automatic`\" ", alias="accountManagement")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "accountLevelIssues", "accountManagement", "kind", "products", "websiteClaimed"]
