...
class DatafeedStatus(BaseModel):
    ...
    feed_label: Optional[StrictStr] = Field(default=None, description="The feed label status is reported for.", alias="feedLabel")
    ...
    __properties: ClassVar[List[str]] = ["country", "datafeedId", "errors", "feedLabel", "itemsTotal", "itemsValid", "kind", "language", "lastUploadDate", "processingStatus", "warnings"]
