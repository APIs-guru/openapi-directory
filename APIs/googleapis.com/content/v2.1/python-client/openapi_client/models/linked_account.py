...
class LinkedAccount(BaseModel):
    ...
    services: Optional[List[LinkService]] = Field(default=None, description="List of provided services.")
    __properties: ClassVar[List[str]] = ["linkedAccountId", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [LinkService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
