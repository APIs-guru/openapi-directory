...
class AccountstatusesApi:
    ...
    def content_accountstatuses_custombatch(
        ...
        accountstatuses_custom_batch_request: Optional[AccountstatusesCustomBatchRequest] = None,
        ...
        :param accountstatuses_custom_batch_request:
        :type accountstatuses_custom_batch_request: AccountstatusesCustomBatchRequest
        ...
        _param = self._content_accountstatuses_custombatch_serialize(
            xgafv=xgafv,
            ...
            accountstatuses_custom_batch_request=accountstatuses_custom_batch_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountstatusesCustomBatchResponse",
        }
    ...
    @validate_call
    def content_accountstatuses_custombatch_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def content_accountstatuses_custombatch_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _content_accountstatuses_custombatch_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if accountstatuses_custom_batch_request is not None:
            _body_params = accountstatuses_custom_batch_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accountstatuses/batch',
    ...
    def content_accountstatuses_get(
        ...
        _param = self._content_accountstatuses_get_serialize(
    ...
    @validate_call
    def content_accountstatuses_get_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the managing account. If this parameter is not the same as accountId, then this account must be a multi-client account and `accountId` must be the ID of a sub-account of this account.")],
        account_id: Annotated[StrictStr, Field(description="The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def content_accountstatuses_get_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the managing account. If this parameter is not the same as accountId, then this account must be a multi-client account and `accountId` must be the ID of a sub-account of this account.")],
        account_id: Annotated[StrictStr, Field(description="The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_accountstatuses_get_serialize(
        self,
        merchant_id,
        account_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/accountstatuses/{accountId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def content_accountstatuses_list(
        ...
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        destinations: Annotated[Optional[List[StrictStr]], Field(description="If set, only issues for the specified destinations are returned, otherwise only issues for the Shopping destination.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of account statuses to return in the response, used for paging.")] = None,
        ...
        _param = self._content_accountstatuses_list_serialize(
            merchant_id=merchant_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountstatusesListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def content_accountstatuses_list_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the managing account. This must be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountstatusesListResponse]:
        """content_accountstatuses_list
    ...
    @validate_call
    def content_accountstatuses_list_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the managing account. This must be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_accountstatuses_list_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/accountstatuses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
