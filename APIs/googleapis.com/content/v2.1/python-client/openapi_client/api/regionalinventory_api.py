...
class RegionalinventoryApi:
    ...
    @validate_call
    def content_regionalinventory_custombatch(
        self,
        ...
        regionalinventory_custom_batch_request: Optional[RegionalinventoryCustomBatchRequest] = None,
        ...
        :param regionalinventory_custom_batch_request:
        :type regionalinventory_custom_batch_request: RegionalinventoryCustomBatchRequest
        ...
        _param = self._content_regionalinventory_custombatch_serialize(
            xgafv=xgafv,
            ...
            regionalinventory_custom_batch_request=regionalinventory_custom_batch_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RegionalinventoryCustomBatchResponse",
        }
    ...
    @validate_call
    def content_regionalinventory_custombatch_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def content_regionalinventory_custombatch_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _content_regionalinventory_custombatch_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if regionalinventory_custom_batch_request is not None:
            _body_params = regionalinventory_custom_batch_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/regionalinventory/batch',
    ...
    def content_regionalinventory_insert(
        ...
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update the regional inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        regional_inventory: Optional[RegionalInventory] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param product_id: The REST ID of the product for which to update the regional inventory. (required)
        :type product_id: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        _param = self._content_regionalinventory_insert_serialize(
    ...
    @validate_call
    def content_regionalinventory_insert_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that contains the product. This account cannot be a multi-client account.")],
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update the regional inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def content_regionalinventory_insert_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that contains the product. This account cannot be a multi-client account.")],
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update the regional inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_regionalinventory_insert_serialize(
        self,
        merchant_id,
        product_id,
        xgafv,
        ...
        # process the form parameters
        # process the body parameter
        if regional_inventory is not None:
            _body_params = regional_inventory
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/products/{productId}/regionalinventory',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
