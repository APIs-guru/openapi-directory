...
class MerchantsupportApi:
    ...
    def content_merchantsupport_renderaccountissues(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account to fetch issues for.")],
        ...
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The [IETF BCP-47](https://tools.ietf.org/html/bcp47) language code used to localize support content. If not set, the result will be in default language `en-US`.")] = None,
        time_zone: Annotated[Optional[StrictStr], Field(description="Optional. The [IANA](https://www.iana.org/time-zones) timezone used to localize times in support content. For example 'America/Los_Angeles'. If not set, results will use as a default UTC.")] = None,
        render_account_issues_request_payload: Optional[RenderAccountIssuesRequestPayload] = None,
        ...
        :param merchant_id: Required. The ID of the account to fetch issues for. (required)
        ...
        :type time_zone: str
        :param render_account_issues_request_payload:
        :type render_account_issues_request_payload: RenderAccountIssuesRequestPayload
        ...
        _param = self._content_merchantsupport_renderaccountissues_serialize(
            ...
            time_zone=time_zone,
            render_account_issues_request_payload=render_account_issues_request_payload,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RenderAccountIssuesResponse",
        }
    ...
    @validate_call
    def content_merchantsupport_renderaccountissues_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account to fetch issues for.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RenderAccountIssuesResponse]:
        """content_merchantsupport_renderaccountissues
    ...
    @validate_call
    def content_merchantsupport_renderaccountissues_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account to fetch issues for.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_merchantsupport_renderaccountissues_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        language_code,
        time_zone,
        render_account_issues_request_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if render_account_issues_request_payload is not None:
            _body_params = render_account_issues_request_payload
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/merchantsupport/renderaccountissues',
    ...
    def content_merchantsupport_renderproductissues(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the product.")],
        product_id: Annotated[StrictStr, Field(description="Required. The [REST_ID](https://developers.google.com/shopping-content/reference/rest/v2.1/products#Product.FIELDS.id) of the product to fetch issues for.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The [IETF BCP-47](https://tools.ietf.org/html/bcp47) language code used to localize support content. If not set, the result will be in default language `en-US`.")] = None,
        time_zone: Annotated[Optional[StrictStr], Field(description="Optional. The [IANA](https://www.iana.org/time-zones) timezone used to localize times in support content. For example 'America/Los_Angeles'. If not set, results will use as a default UTC.")] = None,
        render_product_issues_request_payload: Optional[RenderProductIssuesRequestPayload] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param merchant_id: Required. The ID of the account that contains the product. (required)
        :type merchant_id: str
        :param product_id: Required. The [REST_ID](https://developers.google.com/shopping-content/reference/rest/v2.1/products#Product.FIELDS.id) of the product to fetch issues for. (required)
        :type product_id: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        :param time_zone: Optional. The [IANA](https://www.iana.org/time-zones) timezone used to localize times in support content. For example 'America/Los_Angeles'. If not set, results will use as a default UTC.
        :type time_zone: str
        :param render_product_issues_request_payload:
        :type render_product_issues_request_payload: RenderProductIssuesRequestPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._content_merchantsupport_renderproductissues_serialize(
            merchant_id=merchant_id,
            ...
            language_code=language_code,
            time_zone=time_zone,
            render_product_issues_request_payload=render_product_issues_request_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RenderProductIssuesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def content_merchantsupport_renderproductissues_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the product.")],
        product_id: Annotated[StrictStr, Field(description="Required. The [REST_ID](https://developers.google.com/shopping-content/reference/rest/v2.1/products#Product.FIELDS.id) of the product to fetch issues for.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RenderProductIssuesResponse]:
        """content_merchantsupport_renderproductissues
    ...
    @validate_call
    def content_merchantsupport_renderproductissues_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the product.")],
        product_id: Annotated[StrictStr, Field(description="Required. The [REST_ID](https://developers.google.com/shopping-content/reference/rest/v2.1/products#Product.FIELDS.id) of the product to fetch issues for.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_merchantsupport_renderproductissues_serialize(
        self,
        merchant_id,
        product_id,
        xgafv,
        ...
        language_code,
        time_zone,
        render_product_issues_request_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if render_product_issues_request_payload is not None:
            _body_params = render_product_issues_request_payload
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/merchantsupport/renderproductissues/{productId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
