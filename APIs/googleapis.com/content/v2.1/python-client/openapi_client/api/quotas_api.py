...
class QuotasApi:
    ...
    @validate_call
    def content_quotas_list(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that has quota. This account must be an admin.")],
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of quotas to return in the response, used for paging. Defaults to 500; values above 1000 will be coerced to 1000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Token (if provided) to retrieve the subsequent page. All other parameters must match the original call that provided the page token.")] = None,
        ...
        :param merchant_id: Required. The ID of the account that has quota. This account must be an admin. (required)
        ...
        _param = self._content_quotas_list_serialize(
    ...
    @validate_call
    def content_quotas_list_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that has quota. This account must be an admin.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListMethodQuotasResponse]:
        """content_quotas_list
    ...
    @validate_call
    def content_quotas_list_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that has quota. This account must be an admin.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_quotas_list_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/quotas',
