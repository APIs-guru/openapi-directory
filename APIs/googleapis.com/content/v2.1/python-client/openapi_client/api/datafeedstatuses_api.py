...
class DatafeedstatusesApi:
    ...
    def content_datafeedstatuses_get(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        country: Annotated[Optional[StrictStr], Field(description="Deprecated. Use `feedLabel` instead. The country to get the datafeed status for. If this parameter is provided then `language` must also be provided. Note that this parameter is required for feeds targeting multiple countries and languages, since a feed may have a different status for each target.")] = None,
        feed_label: Annotated[Optional[StrictStr], Field(description="The feed label to get the datafeed status for. If this parameter is provided then `language` must also be provided. Note that this parameter is required for feeds targeting multiple countries and languages, since a feed may have a different status for each target.")] = None,
        language: Annotated[Optional[StrictStr], Field(description="The language to get the datafeed status for. If this parameter is provided then `country` must also be provided. Note that this parameter is required for feeds targeting multiple countries and languages, since a feed may have a different status for each target.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _content_datafeedstatuses_get_serialize(
        ...
        if feed_label is not None:
            ...
            _query_params.append(('feedLabel', feed_label))
