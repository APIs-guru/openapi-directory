...
class PromotionsApi:
    ...
    @validate_call
    def content_promotions_create(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        ...
        :param merchant_id: Required. The ID of the account that contains the collection. (required)
        ...
        _param = self._content_promotions_create_serialize(
    ...
    @validate_call
    def content_promotions_create_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def content_promotions_create_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_promotions_create_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/promotions',
    ...
    @validate_call
    def content_promotions_get(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        id: Annotated[StrictStr, Field(description="Required. REST ID of the promotion to retrieve.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        _param = self._content_promotions_get_serialize(
            merchant_id=merchant_id,
            id=id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def content_promotions_get_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        id: Annotated[StrictStr, Field(description="Required. REST ID of the promotion to retrieve.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def content_promotions_get_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        id: Annotated[StrictStr, Field(description="Required. REST ID of the promotion to retrieve.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_promotions_get_serialize(
        self,
        merchant_id,
        id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/promotions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def content_promotions_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        country_code: Annotated[Optional[StrictStr], Field(description="[CLDR country code](http://www.unicode.org/repos/cldr/tags/latest/common/main/en.xml) (for example, \"US\"), used as a filter on promotions target country.")] = None,
        language_code: Annotated[Optional[StrictStr], Field(description="The two-letter ISO 639-1 language code associated with the promotions, used as a filter.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of promotions to return. The service may return fewer than this value. If unspecified, at most 50 labels will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A page token, received from a previous `ListPromotion` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListPromotion` must match the call that provided the page token.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._content_promotions_list_serialize(
            merchant_id=merchant_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def content_promotions_list_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListPromotionResponse]:
        """content_promotions_list
    ...
    @validate_call
    def content_promotions_list_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_promotions_list_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
