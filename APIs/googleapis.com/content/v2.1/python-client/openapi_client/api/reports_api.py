...
class ReportsApi:
    ...
    @validate_call
    def content_reports_search(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. Id of the merchant making the call. Must be a standalone account or an MCA subaccount.")],
        ...
        :param merchant_id: Required. Id of the merchant making the call. Must be a standalone account or an MCA subaccount. (required)
        ...
        _param = self._content_reports_search_serialize(
    ...
    @validate_call
    def content_reports_search_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. Id of the merchant making the call. Must be a standalone account or an MCA subaccount.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def content_reports_search_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. Id of the merchant making the call. Must be a standalone account or an MCA subaccount.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_reports_search_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/reports/search',
