...
class CollectionstatusesApi:
    ...
    def content_collectionstatuses_get(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        collection_id: Annotated[StrictStr, Field(description="Required. The collectionId of the collection. CollectionId is the same as the REST ID of the collection.")],
        ...
        :param merchant_id: Required. The ID of the account that contains the collection. This account cannot be a multi-client account. (required)
        :type merchant_id: str
        :param collection_id: Required. The collectionId of the collection. CollectionId is the same as the REST ID of the collection. (required)
        ...
        _param = self._content_collectionstatuses_get_serialize(
    ...
    @validate_call
    def content_collectionstatuses_get_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        collection_id: Annotated[StrictStr, Field(description="Required. The collectionId of the collection. CollectionId is the same as the REST ID of the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def content_collectionstatuses_get_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        collection_id: Annotated[StrictStr, Field(description="Required. The collectionId of the collection. CollectionId is the same as the REST ID of the collection.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_collectionstatuses_get_serialize(
        self,
        merchant_id,
        collection_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/collectionstatuses/{collectionId}',
    ...
    @validate_call
    def content_collectionstatuses_list(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of collection statuses to return in the response, used for paging. Defaults to 50; values above 1000 will be coerced to 1000.")] = None,
        ...
        _param = self._content_collectionstatuses_list_serialize(
            merchant_id=merchant_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCollectionStatusesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def content_collectionstatuses_list_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListCollectionStatusesResponse]:
        """content_collectionstatuses_list
    ...
    @validate_call
    def content_collectionstatuses_list_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account that contains the collection. This account cannot be a multi-client account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_collectionstatuses_list_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/collectionstatuses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
