...
class SettlementtransactionsApi:
    ...
    def content_settlementtransactions_list(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The Merchant Center account to list transactions for.")],
        ...
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of transactions to return in the response, used for paging. The default value is 200 transactions per page, and the maximum allowed value is 5000 transactions per page.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="The token returned by the previous request.")] = None,
        transaction_ids: Annotated[Optional[List[StrictStr]], Field(description="The list of transactions to return. If not set, all transactions will be returned.")] = None,
        ...
        :param merchant_id: The Merchant Center account to list transactions for. (required)
        ...
        _param = self._content_settlementtransactions_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SettlementtransactionsListResponse",
        }
    ...
    @validate_call
    def content_settlementtransactions_list_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The Merchant Center account to list transactions for.")],
        settlement_id: Annotated[StrictStr, Field(description="The Google-provided ID of the settlement.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SettlementtransactionsListResponse]:
        """content_settlementtransactions_list
    ...
    @validate_call
    def content_settlementtransactions_list_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The Merchant Center account to list transactions for.")],
        settlement_id: Annotated[StrictStr, Field(description="The Google-provided ID of the settlement.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_settlementtransactions_list_serialize(
        self,
        merchant_id,
        settlement_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/settlementreports/{settlementId}/transactions',
