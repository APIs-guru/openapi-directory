...
class LocalinventoryApi:
    ...
    @validate_call
    def content_localinventory_custombatch(
        self,
        ...
        localinventory_custom_batch_request: Optional[LocalinventoryCustomBatchRequest] = None,
        ...
        :param localinventory_custom_batch_request:
        :type localinventory_custom_batch_request: LocalinventoryCustomBatchRequest
        ...
        _param = self._content_localinventory_custombatch_serialize(
            xgafv=xgafv,
            ...
            localinventory_custom_batch_request=localinventory_custom_batch_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LocalinventoryCustomBatchResponse",
        }
    ...
    @validate_call
    def content_localinventory_custombatch_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocalinventoryCustomBatchResponse]:
        """content_localinventory_custombatch
    ...
    @validate_call
    def content_localinventory_custombatch_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _content_localinventory_custombatch_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        upload_protocol,
        upload_type,
        localinventory_custom_batch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if localinventory_custom_batch_request is not None:
            _body_params = localinventory_custom_batch_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/localinventory/batch',
    ...
    def content_localinventory_insert(
        ...
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update local inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        local_inventory: Optional[LocalInventory] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param product_id: The REST ID of the product for which to update local inventory. (required)
        :type product_id: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        _param = self._content_localinventory_insert_serialize(
    ...
    @validate_call
    def content_localinventory_insert_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that contains the product. This account cannot be a multi-client account.")],
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update local inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def content_localinventory_insert_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that contains the product. This account cannot be a multi-client account.")],
        product_id: Annotated[StrictStr, Field(description="The REST ID of the product for which to update local inventory.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_localinventory_insert_serialize(
        self,
        merchant_id,
        product_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/products/{productId}/localinventory',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
