...
class ShoppingadsprogramApi:
    ...
    @validate_call
    def content_shoppingadsprogram_get(
        self,
        ...
        _param = self._content_shoppingadsprogram_get_serialize(
    ...
    @validate_call
    def content_shoppingadsprogram_get_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShoppingAdsProgramStatus]:
        """content_shoppingadsprogram_get
    ...
    @validate_call
    def content_shoppingadsprogram_get_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_shoppingadsprogram_get_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{merchantId}/shoppingadsprogram',
    ...
    def content_shoppingadsprogram_requestreview(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        request_review_shopping_ads_request: Optional[RequestReviewShoppingAdsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param request_review_shopping_ads_request:
        :type request_review_shopping_ads_request: RequestReviewShoppingAdsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._content_shoppingadsprogram_requestreview_serialize(
            merchant_id=merchant_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            request_review_shopping_ads_request=request_review_shopping_ads_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def content_shoppingadsprogram_requestreview_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def content_shoppingadsprogram_requestreview_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="Required. The ID of the account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_shoppingadsprogram_requestreview_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if request_review_shopping_ads_request is not None:
            _body_params = request_review_shopping_ads_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/shoppingadsprogram/requestreview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
