...
class OrdertrackingsignalsApi:
    ...
    def content_ordertrackingsignals_create(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the merchant for which the order signal is created.")],
        ...
        order_tracking_signal: Optional[OrderTrackingSignal] = None,
        ...
        :param merchant_id: The ID of the merchant for which the order signal is created. (required)
        ...
        :param order_tracking_signal:
        :type order_tracking_signal: OrderTrackingSignal
        ...
        _param = self._content_ordertrackingsignals_create_serialize(
    ...
    @validate_call
    def content_ordertrackingsignals_create_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the merchant for which the order signal is created.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderTrackingSignal]:
        """content_ordertrackingsignals_create
    ...
    @validate_call
    def content_ordertrackingsignals_create_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the merchant for which the order signal is created.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _content_ordertrackingsignals_create_serialize(
        self,
        merchant_id,
        xgafv,
        access_token,
        ...
        if order_tracking_signal is not None:
            _body_params = order_tracking_signal
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/ordertrackingsignals',
