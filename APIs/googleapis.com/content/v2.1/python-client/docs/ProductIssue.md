...
**impact** | [**ProductIssueImpact**](ProductIssueImpact.md) |  | [optional] 
...
product_issue_instance = ProductIssue.from_json(json)
# print the JSON string representation of the object
print(ProductIssue.to_json())

# convert the object into a dict
product_issue_dict = product_issue_instance.to_dict()
# create an instance of ProductIssue from a dict
product_issue_from_dict = ProductIssue.from_dict(product_issue_dict)
```
