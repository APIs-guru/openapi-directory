...
test_order_address_instance = TestOrderAddress.from_json(json)
# print the JSON string representation of the object
print(TestOrderAddress.to_json())

# convert the object into a dict
test_order_address_dict = test_order_address_instance.to_dict()
# create an instance of TestOrderAddress from a dict
test_order_address_from_dict = TestOrderAddress.from_dict(test_order_address_dict)
```
