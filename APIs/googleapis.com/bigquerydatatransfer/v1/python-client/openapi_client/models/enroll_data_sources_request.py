...
class EnrollDataSourcesRequest(BaseModel):
    ...
    """ # noqa: E501
    data_source_ids: Optional[List[StrictStr]] = Field(default=None, description="Data sources that are enrolled. It is required to provide at least one data source id.", alias="dataSourceIds")
