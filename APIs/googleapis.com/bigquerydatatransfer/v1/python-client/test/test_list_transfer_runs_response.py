...
class TestListTransferRunsResponse(unittest.TestCase):
    """ListTransferRunsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTransferRunsResponse:
        """Test ListTransferRunsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTransferRunsResponse`
        """
        model = ListTransferRunsResponse()
        if include_optional:
    ...
    def testListTransferRunsResponse(self):
        """Test ListTransferRunsResponse"""
