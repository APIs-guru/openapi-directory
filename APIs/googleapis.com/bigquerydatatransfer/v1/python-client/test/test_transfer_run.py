...
class TestTransferRun(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransferRun:
        """Test TransferRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferRun`
        """
        model = TransferRun()
        if include_optional:
            return TransferRun(
