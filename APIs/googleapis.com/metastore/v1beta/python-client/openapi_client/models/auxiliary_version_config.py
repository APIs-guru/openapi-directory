...
class AuxiliaryVersionConfig(BaseModel):
    ...
    """ # noqa: E501
    config_overrides: Optional[Dict[str, StrictStr]] = Field(default=None, description="A mapping of Hive metastore configuration key-value pairs to apply to the auxiliary Hive metastore (configured in hive-site.xml) in addition to the primary version's overrides. If keys are present in both the auxiliary version's overrides and the primary version's overrides, the value from the auxiliary version's overrides takes precedence.", alias="configOverrides")
    network_config: Optional[NetworkConfig] = Field(default=None, alias="networkConfig")
    version: Optional[StrictStr] = Field(default=None, description="The Hive metastore version of the auxiliary service. It must be less than the primary Hive metastore service's version.")
    __properties: ClassVar[List[str]] = ["configOverrides", "networkConfig", "version"]
