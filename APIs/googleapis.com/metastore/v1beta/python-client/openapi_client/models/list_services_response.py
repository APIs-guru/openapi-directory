...
class ListServicesResponse(BaseModel):
    ...
    services: Optional[List[Service]] = Field(default=None, description="The services in the specified location.")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations that could not be reached.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "services", "unreachable"]
