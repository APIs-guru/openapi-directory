...
class TestProjectsApi(unittest.TestCase):
    ...
    def test_metastore_projects_locations_services_backups_get_iam_policy(self) -> None:
    ...
    def test_metastore_projects_locations_services_backups_set_iam_policy(self) -> None:
    ...
    def test_metastore_projects_locations_services_test_iam_permissions(self) -> None:
