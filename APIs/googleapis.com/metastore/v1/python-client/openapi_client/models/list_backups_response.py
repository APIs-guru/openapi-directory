...
class ListBackupsResponse(BaseModel):
    ...
    """ # noqa: E501
    backups: Optional[List[Backup]] = Field(default=None, description="The backups of the specified service.")
    ...
    __properties: ClassVar[List[str]] = ["backups", "nextPageToken", "unreachable"]
