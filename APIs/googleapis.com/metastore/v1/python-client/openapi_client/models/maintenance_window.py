...
class MaintenanceWindow(BaseModel):
    ...
    """ # noqa: E501
    day_of_week: Optional[StrictStr] = Field(default=None, description="The day of week, when the window starts.", alias="dayOfWeek")
    hour_of_day: Optional[StrictInt] = Field(default=None, description="The hour of day (0-23) when the window starts.", alias="hourOfDay")
