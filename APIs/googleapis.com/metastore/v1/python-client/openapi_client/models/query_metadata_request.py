...
class QueryMetadataRequest(BaseModel):
    ...
    """ # noqa: E501
    query: Optional[StrictStr] = Field(default=None, description="Required. A read-only SQL query to execute against the metadata database. The query cannot change or mutate the data.")
