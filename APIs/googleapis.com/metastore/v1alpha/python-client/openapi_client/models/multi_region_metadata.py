...
class MultiRegionMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    constituent_regions: Optional[List[StrictStr]] = Field(default=None, description="The regions constituting the multi-region.", alias="constituentRegions")
    __properties: ClassVar[List[str]] = ["constituentRegions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "constituentRegions": obj.get("constituentRegions")
        })
        return _obj
