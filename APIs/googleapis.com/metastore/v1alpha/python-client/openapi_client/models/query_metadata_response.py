...
class QueryMetadataResponse(BaseModel):
    ...
    """ # noqa: E501
    result_manifest_uri: Optional[StrictStr] = Field(default=None, description="The manifest URI is link to a JSON instance in Cloud Storage. This instance manifests immediately along with QueryMetadataResponse. The content of the URI is not retriable until the long-running operation query against the metadata finishes.", alias="resultManifestUri")
    __properties: ClassVar[List[str]] = ["resultManifestUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resultManifestUri": obj.get("resultManifestUri")
        })
        return _obj
