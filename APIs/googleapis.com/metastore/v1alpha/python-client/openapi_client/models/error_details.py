...
class ErrorDetails(BaseModel):
    ...
    """ # noqa: E501
    details: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional structured details about this error.Keys define the failure items. Value describes the exception or details of the item.")
