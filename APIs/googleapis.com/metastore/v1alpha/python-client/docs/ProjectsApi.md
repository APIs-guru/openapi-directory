...
------------- | ------------- | -------------
[**metastore_projects_locations_federations_create**](ProjectsApi.md#metastore_projects_locations_federations_create) | **POST** /v1alpha/{parent}/federations | 
[**metastore_projects_locations_federations_list**](ProjectsApi.md#metastore_projects_locations_federations_list) | **GET** /v1alpha/{parent}/federations | 
[**metastore_projects_locations_list**](ProjectsApi.md#metastore_projects_locations_list) | **GET** /v1alpha/{name}/locations | 
[**metastore_projects_locations_operations_cancel**](ProjectsApi.md#metastore_projects_locations_operations_cancel) | **POST** /v1alpha/{name}:cancel | 
[**metastore_projects_locations_operations_list**](ProjectsApi.md#metastore_projects_locations_operations_list) | **GET** /v1alpha/{name}/operations | 
[**metastore_projects_locations_services_alter_location**](ProjectsApi.md#metastore_projects_locations_services_alter_location) | **POST** /v1alpha/{service}:alterLocation | 
[**metastore_projects_locations_services_alter_table_properties**](ProjectsApi.md#metastore_projects_locations_services_alter_table_properties) | **POST** /v1alpha/{service}:alterTableProperties | 
[**metastore_projects_locations_services_backups_create**](ProjectsApi.md#metastore_projects_locations_services_backups_create) | **POST** /v1alpha/{parent}/backups | 
[**metastore_projects_locations_services_backups_list**](ProjectsApi.md#metastore_projects_locations_services_backups_list) | **GET** /v1alpha/{parent}/backups | 
[**metastore_projects_locations_services_create**](ProjectsApi.md#metastore_projects_locations_services_create) | **POST** /v1alpha/{parent}/services | 
[**metastore_projects_locations_services_databases_tables_get_iam_policy**](ProjectsApi.md#metastore_projects_locations_services_databases_tables_get_iam_policy) | **GET** /v1alpha/{resource}:getIamPolicy | 
[**metastore_projects_locations_services_databases_tables_set_iam_policy**](ProjectsApi.md#metastore_projects_locations_services_databases_tables_set_iam_policy) | **POST** /v1alpha/{resource}:setIamPolicy | 
[**metastore_projects_locations_services_databases_tables_test_iam_permissions**](ProjectsApi.md#metastore_projects_locations_services_databases_tables_test_iam_permissions) | **POST** /v1alpha/{resource}:testIamPermissions | 
[**metastore_projects_locations_services_export_metadata**](ProjectsApi.md#metastore_projects_locations_services_export_metadata) | **POST** /v1alpha/{service}:exportMetadata | 
[**metastore_projects_locations_services_list**](ProjectsApi.md#metastore_projects_locations_services_list) | **GET** /v1alpha/{parent}/services | 
[**metastore_projects_locations_services_metadata_imports_create**](ProjectsApi.md#metastore_projects_locations_services_metadata_imports_create) | **POST** /v1alpha/{parent}/metadataImports | 
[**metastore_projects_locations_services_metadata_imports_get**](ProjectsApi.md#metastore_projects_locations_services_metadata_imports_get) | **GET** /v1alpha/{name} | 
[**metastore_projects_locations_services_metadata_imports_list**](ProjectsApi.md#metastore_projects_locations_services_metadata_imports_list) | **GET** /v1alpha/{parent}/metadataImports | 
[**metastore_projects_locations_services_metadata_imports_patch**](ProjectsApi.md#metastore_projects_locations_services_metadata_imports_patch) | **PATCH** /v1alpha/{name} | 
[**metastore_projects_locations_services_migration_executions_delete**](ProjectsApi.md#metastore_projects_locations_services_migration_executions_delete) | **DELETE** /v1alpha/{name} | 
[**metastore_projects_locations_services_move_table_to_database**](ProjectsApi.md#metastore_projects_locations_services_move_table_to_database) | **POST** /v1alpha/{service}:moveTableToDatabase | 
[**metastore_projects_locations_services_query_metadata**](ProjectsApi.md#metastore_projects_locations_services_query_metadata) | **POST** /v1alpha/{service}:queryMetadata | 
[**metastore_projects_locations_services_remove_iam_policy**](ProjectsApi.md#metastore_projects_locations_services_remove_iam_policy) | **POST** /v1alpha/{resource}:removeIamPolicy | 
[**metastore_projects_locations_services_restore**](ProjectsApi.md#metastore_projects_locations_services_restore) | **POST** /v1alpha/{service}:restore | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.metastore_projects_locations_services_databases_tables_get_iam_policy(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, options_requested_policy_version=options_requested_policy_version)
        print("The response of ProjectsApi->metastore_projects_locations_services_databases_tables_get_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->metastore_projects_locations_services_databases_tables_get_iam_policy: %s\n" % e)
```
...
> Policy metastore_projects_locations_services_databases_tables_set_iam_policy(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, set_iam_policy_request=set_iam_policy_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.metastore_projects_locations_services_databases_tables_set_iam_policy(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, set_iam_policy_request=set_iam_policy_request)
        print("The response of ProjectsApi->metastore_projects_locations_services_databases_tables_set_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->metastore_projects_locations_services_databases_tables_set_iam_policy: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.metastore_projects_locations_services_databases_tables_test_iam_permissions(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, test_iam_permissions_request=test_iam_permissions_request)
        print("The response of ProjectsApi->metastore_projects_locations_services_databases_tables_test_iam_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->metastore_projects_locations_services_databases_tables_test_iam_permissions: %s\n" % e)
```
...
> RemoveIamPolicyResponse metastore_projects_locations_services_remove_iam_policy(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, remove_iam_policy_request=remove_iam_policy_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    remove_iam_policy_request = openapi_client.RemoveIamPolicyRequest() # RemoveIamPolicyRequest |  (optional)

    try:
        api_response = api_instance.metastore_projects_locations_services_remove_iam_policy(resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, remove_iam_policy_request=remove_iam_policy_request)
        print("The response of ProjectsApi->metastore_projects_locations_services_remove_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->metastore_projects_locations_services_remove_iam_policy: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **resource** | **str**| Required. The relative resource name of the dataplane resource to remove IAM policy, in the following form:projects/{project_id}/locations/{location_id}/services/{service_id}/databases/{database_id} or projects/{project_id}/locations/{location_id}/services/{service_id}/databases/{database_id}/tables/{table_id}. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **remove_iam_policy_request** | [**RemoveIamPolicyRequest**](RemoveIamPolicyRequest.md)|  | [optional] 
