...
class ListApplicationsResponse(BaseModel):
    ...
    """ # noqa: E501
    applications: Optional[List[Application]] = Field(default=None, description="List of Applications.")
    ...
    __properties: ClassVar[List[str]] = ["applications", "nextPageToken", "unreachable"]
