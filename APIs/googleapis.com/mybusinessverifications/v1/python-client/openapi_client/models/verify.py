...
class Verify(BaseModel):
    ...
    """ # noqa: E501
    has_pending_verification: Optional[StrictBool] = Field(default=None, description="Indicates whether a verification process has already started, and can be completed by the location.", alias="hasPendingVerification")
    __properties: ClassVar[List[str]] = ["hasPendingVerification"]
