...
------------ | ------------- | ------------- | -------------
**domain** | **str** | Domain name in the email address. e.g. \&quot;gmail.com\&quot; in foo@gmail.com | [optional] 
**is_user_name_editable** | **bool** | Whether client is allowed to provide a different user name. | [optional] 
**user** | **str** | User name in the email address. e.g. \&quot;foo\&quot; in foo@gmail.com | [optional] 
