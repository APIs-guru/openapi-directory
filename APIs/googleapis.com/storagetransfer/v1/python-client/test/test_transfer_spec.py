...
class TestTransferSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransferSpec:
        """Test TransferSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferSpec`
        """
        model = TransferSpec()
        if include_optional:
            return TransferSpec(
                ...
                gcs_data_source = openapi_client.models.gcs_data.GcsData(
                    ...
                    managed_folder_transfer_enabled = True, 
                    path = '', ),
                gcs_intermediate_data_location = openapi_client.models.gcs_data.GcsData(
                    bucket_name = '', 
                    managed_folder_transfer_enabled = True, 
                    path = '', ),
