...
class TestUpdateTransferJobRequest(unittest.TestCase):
    """UpdateTransferJobRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTransferJobRequest:
        """Test UpdateTransferJobRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransferJobRequest`
        """
        model = UpdateTransferJobRequest()
        if include_optional:
            return UpdateTransferJobRequest(
                project_id = '',
                transfer_job = openapi_client.models.transfer_job.TransferJob(
                    creation_time = '', 
                    deletion_time = '', 
                    description = '', 
    ...
    def testUpdateTransferJobRequest(self):
        """Test UpdateTransferJobRequest"""
