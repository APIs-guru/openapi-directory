...
class TestListTransferJobsResponse(unittest.TestCase):
    """ListTransferJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTransferJobsResponse:
        """Test ListTransferJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTransferJobsResponse`
        """
        model = ListTransferJobsResponse()
        if include_optional:
            return ListTransferJobsResponse(
                next_page_token = '',
                transfer_jobs = [
                    openapi_client.models.transfer_job.TransferJob(
                        creation_time = '', 
                        deletion_time = '', 
                        description = '', 
    ...
    def testListTransferJobsResponse(self):
        """Test ListTransferJobsResponse"""
