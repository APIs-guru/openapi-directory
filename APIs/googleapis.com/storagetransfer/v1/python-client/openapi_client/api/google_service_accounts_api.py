...
class GoogleServiceAccountsApi:
    ...
    def storagetransfer_google_service_accounts_get(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. The ID of the Google Cloud project that the Google service account is associated with.")],
        ...
        :param project_id: Required. The ID of the Google Cloud project that the Google service account is associated with. (required)
        :type project_id: str
        ...
        _param = self._storagetransfer_google_service_accounts_get_serialize(
    ...
    @validate_call
    def storagetransfer_google_service_accounts_get_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. The ID of the Google Cloud project that the Google service account is associated with.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleServiceAccount]:
        """storagetransfer_google_service_accounts_get
    ...
    @validate_call
    def storagetransfer_google_service_accounts_get_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. The ID of the Google Cloud project that the Google service account is associated with.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _storagetransfer_google_service_accounts_get_serialize(
        self,
        project_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/googleServiceAccounts/{projectId}',
