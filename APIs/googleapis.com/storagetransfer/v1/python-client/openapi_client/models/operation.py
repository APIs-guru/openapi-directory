...
class Operation(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Represents the transfer operation object. To request a TransferOperation object, use transferOperations.get.")
    name: Optional[StrictStr] = Field(default=None, description="The server-assigned unique name. The format of `name` is `transferOperations/some/unique/name`.")
