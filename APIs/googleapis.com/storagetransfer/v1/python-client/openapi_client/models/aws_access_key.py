...
class AwsAccessKey(BaseModel):
    ...
    """ # noqa: E501
    access_key_id: Optional[StrictStr] = Field(default=None, description="Required. AWS access key ID.", alias="accessKeyId")
    secret_access_key: Optional[StrictStr] = Field(default=None, description="Required. AWS secret access key. This field is not returned in RPC responses.", alias="secretAccessKey")
