...
**price_range** | [**GoogleCloudRetailV2alphaPriceInfoPriceRange**](GoogleCloudRetailV2alphaPriceInfoPriceRange.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2alphaPriceInfo from a JSON string
google_cloud_retail_v2alpha_price_info_instance = GoogleCloudRetailV2alphaPriceInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2alphaPriceInfo.to_json())

# convert the object into a dict
google_cloud_retail_v2alpha_price_info_dict = google_cloud_retail_v2alpha_price_info_instance.to_dict()
# create an instance of GoogleCloudRetailV2alphaPriceInfo from a dict
google_cloud_retail_v2alpha_price_info_from_dict = GoogleCloudRetailV2alphaPriceInfo.from_dict(google_cloud_retail_v2alpha_price_info_dict)
```
