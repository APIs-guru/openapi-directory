...
**facet_spec** | [**GoogleCloudRetailV2alphaSearchRequestFacetSpec**](GoogleCloudRetailV2alphaSearchRequestFacetSpec.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2alphaControl from a JSON string
google_cloud_retail_v2alpha_control_instance = GoogleCloudRetailV2alphaControl.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2alphaControl.to_json())

# convert the object into a dict
google_cloud_retail_v2alpha_control_dict = google_cloud_retail_v2alpha_control_instance.to_dict()
# create an instance of GoogleCloudRetailV2alphaControl from a dict
google_cloud_retail_v2alpha_control_from_dict = GoogleCloudRetailV2alphaControl.from_dict(google_cloud_retail_v2alpha_control_dict)
```
