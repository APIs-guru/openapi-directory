...
**user_event** | [**GoogleCloudRetailV2alphaUserEvent**](GoogleCloudRetailV2alphaUserEvent.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2alphaPredictRequest from a JSON string
google_cloud_retail_v2alpha_predict_request_instance = GoogleCloudRetailV2alphaPredictRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2alphaPredictRequest.to_json())

# convert the object into a dict
google_cloud_retail_v2alpha_predict_request_dict = google_cloud_retail_v2alpha_predict_request_instance.to_dict()
# create an instance of GoogleCloudRetailV2alphaPredictRequest from a dict
google_cloud_retail_v2alpha_predict_request_from_dict = GoogleCloudRetailV2alphaPredictRequest.from_dict(google_cloud_retail_v2alpha_predict_request_dict)
```
