...
class GoogleCloudRetailV2alphaControl(BaseModel):
    """
    ...
    facet_spec: Optional[GoogleCloudRetailV2alphaSearchRequestFacetSpec] = Field(default=None, alias="facetSpec")
    ...
    rule: Optional[GoogleCloudRetailV2alphaRule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facetSpec": GoogleCloudRetailV2alphaSearchRequestFacetSpec.from_dict(obj["facetSpec"]) if obj.get("facetSpec") is not None else None,
            "name": obj.get("name"),
            "rule": GoogleCloudRetailV2alphaRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
