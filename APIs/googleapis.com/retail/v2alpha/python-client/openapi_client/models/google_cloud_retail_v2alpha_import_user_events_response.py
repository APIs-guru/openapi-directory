...
class GoogleCloudRetailV2alphaImportUserEventsResponse(BaseModel):
    """
    ...
    import_summary: Optional[GoogleCloudRetailV2alphaUserEventImportSummary] = Field(default=None, alias="importSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "importSummary": GoogleCloudRetailV2alphaUserEventImportSummary.from_dict(obj["importSummary"]) if obj.get("importSummary") is not None else None
        })
        return _obj
