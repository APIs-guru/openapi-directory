...
class GoogleCloudRetailV2alphaOutputConfig(BaseModel):
    """
    The output configuration setting.
    """ # noqa: E501
    bigquery_destination: Optional[GoogleCloudRetailV2alphaOutputConfigBigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    gcs_destination: Optional[GoogleCloudRetailV2alphaOutputConfigGcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryDestination": GoogleCloudRetailV2alphaOutputConfigBigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None,
            "gcsDestination": GoogleCloudRetailV2alphaOutputConfigGcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None
        })
        return _obj
