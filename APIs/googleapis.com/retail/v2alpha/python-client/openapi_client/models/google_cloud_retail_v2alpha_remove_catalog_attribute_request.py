...
class GoogleCloudRetailV2alphaRemoveCatalogAttributeRequest(BaseModel):
    """
    Request for CatalogService.RemoveCatalogAttribute method.
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Required. The attribute name key of the CatalogAttribute to remove.")
