...
class GoogleCloudRetailV2alphaImportProductsRequest(BaseModel):
    """
    Request message for Import methods.
    """ # noqa: E501
    errors_config: Optional[GoogleCloudRetailV2alphaImportErrorsConfig] = Field(default=None, alias="errorsConfig")
    input_config: Optional[GoogleCloudRetailV2alphaProductInputConfig] = Field(default=None, alias="inputConfig")
    ...
    skip_default_branch_protection: Optional[StrictBool] = Field(default=None, description="If true, this performs the FULL import even if it would delete a large proportion of the products in the default branch, which could potentially cause outages if you have live predict/search traffic. Only supported when ImportProductsRequest.reconciliation_mode is set to `FULL`.", alias="skipDefaultBranchProtection")
    ...
    __properties: ClassVar[List[str]] = ["errorsConfig", "inputConfig", "notificationPubsubTopic", "reconciliationMode", "requestId", "skipDefaultBranchProtection", "updateMask"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputConfig": GoogleCloudRetailV2alphaProductInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None,
            "notificationPubsubTopic": obj.get("notificationPubsubTopic"),
            "reconciliationMode": obj.get("reconciliationMode"),
            "requestId": obj.get("requestId"),
            "skipDefaultBranchProtection": obj.get("skipDefaultBranchProtection"),
