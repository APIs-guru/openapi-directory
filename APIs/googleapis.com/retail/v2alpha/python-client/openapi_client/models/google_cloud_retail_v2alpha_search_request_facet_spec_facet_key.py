...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intervals": [GoogleCloudRetailV2alphaInterval.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None,
            "key": obj.get("key"),
