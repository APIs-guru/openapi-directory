...
class GoogleCloudRetailV2alphaCatalogAttribute(BaseModel):
    """
    ...
    facet_config: Optional[GoogleCloudRetailV2alphaCatalogAttributeFacetConfig] = Field(default=None, alias="facetConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facetConfig": GoogleCloudRetailV2alphaCatalogAttributeFacetConfig.from_dict(obj["facetConfig"]) if obj.get("facetConfig") is not None else None,
            "inUse": obj.get("inUse"),
