...
class GoogleCloudRetailV2alphaListEnrolledSolutionsResponse(BaseModel):
    """
    Response for ListEnrolledSolutions method.
    """ # noqa: E501
    enrolled_solutions: Optional[List[StrictStr]] = Field(default=None, description="Retail API solutions that the project has enrolled.", alias="enrolledSolutions")
    __properties: ClassVar[List[str]] = ["enrolledSolutions"]
