...
class GoogleCloudRetailV2alphaListServingConfigsResponse(BaseModel):
    ...
    serving_configs: Optional[List[GoogleCloudRetailV2alphaServingConfig]] = Field(default=None, description="All the ServingConfigs for a given catalog.", alias="servingConfigs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servingConfigs": [GoogleCloudRetailV2alphaServingConfig.from_dict(_item) for _item in obj["servingConfigs"]] if obj.get("servingConfigs") is not None else None
        })
        return _obj
