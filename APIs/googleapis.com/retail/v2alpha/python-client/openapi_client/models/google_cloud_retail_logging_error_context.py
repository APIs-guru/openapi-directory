...
class GoogleCloudRetailLoggingErrorContext(BaseModel):
    ...
    """ # noqa: E501
    http_request: Optional[GoogleCloudRetailLoggingHttpRequestContext] = Field(default=None, alias="httpRequest")
    report_location: Optional[GoogleCloudRetailLoggingSourceLocation] = Field(default=None, alias="reportLocation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "httpRequest": GoogleCloudRetailLoggingHttpRequestContext.from_dict(obj["httpRequest"]) if obj.get("httpRequest") is not None else None,
            "reportLocation": GoogleCloudRetailLoggingSourceLocation.from_dict(obj["reportLocation"]) if obj.get("reportLocation") is not None else None
        })
        return _obj
