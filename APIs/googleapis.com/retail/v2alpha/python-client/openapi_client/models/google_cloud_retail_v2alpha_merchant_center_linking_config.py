...
class GoogleCloudRetailV2alphaMerchantCenterLinkingConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    links: Optional[List[GoogleCloudRetailV2alphaMerchantCenterLink]] = Field(default=None, description="Links between Merchant Center accounts and branches.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [GoogleCloudRetailV2alphaMerchantCenterLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
        return _obj
