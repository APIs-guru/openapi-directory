...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidate(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "servingConfigId": obj.get("servingConfigId")
        })
        return _obj
