...
class GoogleCloudRetailV2alphaCompletionConfig(BaseModel):
    """
    Catalog level autocomplete config for customers to customize autocomplete feature's settings.
    """ # noqa: E501
    allowlist_input_config: Optional[GoogleCloudRetailV2alphaCompletionDataInputConfig] = Field(default=None, alias="allowlistInputConfig")
    ...
    denylist_input_config: Optional[GoogleCloudRetailV2alphaCompletionDataInputConfig] = Field(default=None, alias="denylistInputConfig")
    ...
    suggestions_input_config: Optional[GoogleCloudRetailV2alphaCompletionDataInputConfig] = Field(default=None, alias="suggestionsInputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowlistInputConfig": GoogleCloudRetailV2alphaCompletionDataInputConfig.from_dict(obj["allowlistInputConfig"]) if obj.get("allowlistInputConfig") is not None else None,
            "autoLearning": obj.get("autoLearning"),
            "denylistInputConfig": GoogleCloudRetailV2alphaCompletionDataInputConfig.from_dict(obj["denylistInputConfig"]) if obj.get("denylistInputConfig") is not None else None,
            ...
            "name": obj.get("name"),
            "suggestionsInputConfig": GoogleCloudRetailV2alphaCompletionDataInputConfig.from_dict(obj["suggestionsInputConfig"]) if obj.get("suggestionsInputConfig") is not None else None
        })
        return _obj
