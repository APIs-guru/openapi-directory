...
class GoogleCloudRetailV2alphaPriceInfo(BaseModel):
    """
    ...
    price_range: Optional[GoogleCloudRetailV2alphaPriceInfoPriceRange] = Field(default=None, alias="priceRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceRange": GoogleCloudRetailV2alphaPriceInfoPriceRange.from_dict(obj["priceRange"]) if obj.get("priceRange") is not None else None
        })
        return _obj
