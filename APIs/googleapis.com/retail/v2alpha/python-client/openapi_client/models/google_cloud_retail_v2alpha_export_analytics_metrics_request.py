...
class GoogleCloudRetailV2alphaExportAnalyticsMetricsRequest(BaseModel):
    """
    ...
    output_config: Optional[GoogleCloudRetailV2alphaOutputConfig] = Field(default=None, alias="outputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputConfig": GoogleCloudRetailV2alphaOutputConfig.from_dict(obj["outputConfig"]) if obj.get("outputConfig") is not None else None
        })
        return _obj
