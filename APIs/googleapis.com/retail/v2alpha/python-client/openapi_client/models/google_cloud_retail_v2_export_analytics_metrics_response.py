...
class GoogleCloudRetailV2ExportAnalyticsMetricsResponse(BaseModel):
    """
    ...
    errors_config: Optional[GoogleCloudRetailV2ExportErrorsConfig] = Field(default=None, alias="errorsConfig")
    output_result: Optional[GoogleCloudRetailV2OutputResult] = Field(default=None, alias="outputResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errorsConfig": GoogleCloudRetailV2ExportErrorsConfig.from_dict(obj["errorsConfig"]) if obj.get("errorsConfig") is not None else None,
            "outputResult": GoogleCloudRetailV2OutputResult.from_dict(obj["outputResult"]) if obj.get("outputResult") is not None else None
        })
        return _obj
