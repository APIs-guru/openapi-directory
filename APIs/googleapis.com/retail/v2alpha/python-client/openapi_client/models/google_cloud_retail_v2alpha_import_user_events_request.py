...
class GoogleCloudRetailV2alphaImportUserEventsRequest(BaseModel):
    """
    Request message for the ImportUserEvents request.
    """ # noqa: E501
    errors_config: Optional[GoogleCloudRetailV2alphaImportErrorsConfig] = Field(default=None, alias="errorsConfig")
    input_config: Optional[GoogleCloudRetailV2alphaUserEventInputConfig] = Field(default=None, alias="inputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errorsConfig": GoogleCloudRetailV2alphaImportErrorsConfig.from_dict(obj["errorsConfig"]) if obj.get("errorsConfig") is not None else None,
            "inputConfig": GoogleCloudRetailV2alphaUserEventInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None
        })
        return _obj
