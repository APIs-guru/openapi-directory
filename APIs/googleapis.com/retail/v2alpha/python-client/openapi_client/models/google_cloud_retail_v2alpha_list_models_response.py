...
class GoogleCloudRetailV2alphaListModelsResponse(BaseModel):
    """
    Response to a ListModelRequest.
    """ # noqa: E501
    models: Optional[List[GoogleCloudRetailV2alphaModel]] = Field(default=None, description="List of Models.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [GoogleCloudRetailV2alphaModel.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
