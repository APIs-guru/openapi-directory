...
class GoogleCloudRetailV2CompletionConfig(BaseModel):
    """
    Catalog level autocomplete config for customers to customize autocomplete feature's settings.
    """ # noqa: E501
    allowlist_input_config: Optional[GoogleCloudRetailV2CompletionDataInputConfig] = Field(default=None, alias="allowlistInputConfig")
    ...
    denylist_input_config: Optional[GoogleCloudRetailV2CompletionDataInputConfig] = Field(default=None, alias="denylistInputConfig")
    ...
    suggestions_input_config: Optional[GoogleCloudRetailV2CompletionDataInputConfig] = Field(default=None, alias="suggestionsInputConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2CompletionConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2CompletionConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "allowlistInputConfig": GoogleCloudRetailV2CompletionDataInputConfig.from_dict(obj["allowlistInputConfig"]) if obj.get("allowlistInputConfig") is not None else None,
            "autoLearning": obj.get("autoLearning"),
            "denylistInputConfig": GoogleCloudRetailV2CompletionDataInputConfig.from_dict(obj["denylistInputConfig"]) if obj.get("denylistInputConfig") is not None else None,
            ...
            "name": obj.get("name"),
            "suggestionsInputConfig": GoogleCloudRetailV2CompletionDataInputConfig.from_dict(obj["suggestionsInputConfig"]) if obj.get("suggestionsInputConfig") is not None else None
        })
        return _obj
