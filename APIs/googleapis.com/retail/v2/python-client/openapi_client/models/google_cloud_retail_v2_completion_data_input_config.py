...
class GoogleCloudRetailV2CompletionDataInputConfig(BaseModel):
    """
    The input config source for completion data.
    """ # noqa: E501
    big_query_source: Optional[GoogleCloudRetailV2BigQuerySource] = Field(default=None, alias="bigQuerySource")
    __properties: ClassVar[List[str]] = ["bigQuerySource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigQuerySource": GoogleCloudRetailV2BigQuerySource.from_dict(obj["bigQuerySource"]) if obj.get("bigQuerySource") is not None else None
        })
        return _obj
