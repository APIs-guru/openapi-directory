...
class GoogleCloudRetailV2betaMerchantCenterAccountLink(BaseModel):
    """
    ...
    feed_filters: Optional[List[GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter]] = Field(default=None, description="Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.", alias="feedFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feedFilters": [GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter.from_dict(_item) for _item in obj["feedFilters"]] if obj.get("feedFilters") is not None else None,
