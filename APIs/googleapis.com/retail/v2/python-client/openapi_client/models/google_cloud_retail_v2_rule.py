...
class GoogleCloudRetailV2Rule(BaseModel):
    """
    A rule is a condition-action pair * A condition defines when a rule is to be triggered. * An action specifies what occurs on that trigger. Currently rules only work for controls with SOLUTION_TYPE_SEARCH.
    """ # noqa: E501
    boost_action: Optional[GoogleCloudRetailV2RuleBoostAction] = Field(default=None, alias="boostAction")
    condition: Optional[GoogleCloudRetailV2Condition] = None
    do_not_associate_action: Optional[GoogleCloudRetailV2RuleDoNotAssociateAction] = Field(default=None, alias="doNotAssociateAction")
    filter_action: Optional[GoogleCloudRetailV2RuleFilterAction] = Field(default=None, alias="filterAction")
    force_return_facet_action: Optional[GoogleCloudRetailV2RuleForceReturnFacetAction] = Field(default=None, alias="forceReturnFacetAction")
    ignore_action: Optional[GoogleCloudRetailV2RuleIgnoreAction] = Field(default=None, alias="ignoreAction")
    oneway_synonyms_action: Optional[GoogleCloudRetailV2RuleOnewaySynonymsAction] = Field(default=None, alias="onewaySynonymsAction")
    redirect_action: Optional[GoogleCloudRetailV2RuleRedirectAction] = Field(default=None, alias="redirectAction")
    remove_facet_action: Optional[GoogleCloudRetailV2RuleRemoveFacetAction] = Field(default=None, alias="removeFacetAction")
    replacement_action: Optional[GoogleCloudRetailV2RuleReplacementAction] = Field(default=None, alias="replacementAction")
    twoway_synonyms_action: Optional[GoogleCloudRetailV2RuleTwowaySynonymsAction] = Field(default=None, alias="twowaySynonymsAction")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boostAction": GoogleCloudRetailV2RuleBoostAction.from_dict(obj["boostAction"]) if obj.get("boostAction") is not None else None,
            "condition": GoogleCloudRetailV2Condition.from_dict(obj["condition"]) if obj.get("condition") is not None else None,
            "doNotAssociateAction": GoogleCloudRetailV2RuleDoNotAssociateAction.from_dict(obj["doNotAssociateAction"]) if obj.get("doNotAssociateAction") is not None else None,
            "filterAction": GoogleCloudRetailV2RuleFilterAction.from_dict(obj["filterAction"]) if obj.get("filterAction") is not None else None,
            "forceReturnFacetAction": GoogleCloudRetailV2RuleForceReturnFacetAction.from_dict(obj["forceReturnFacetAction"]) if obj.get("forceReturnFacetAction") is not None else None,
            "ignoreAction": GoogleCloudRetailV2RuleIgnoreAction.from_dict(obj["ignoreAction"]) if obj.get("ignoreAction") is not None else None,
            "onewaySynonymsAction": GoogleCloudRetailV2RuleOnewaySynonymsAction.from_dict(obj["onewaySynonymsAction"]) if obj.get("onewaySynonymsAction") is not None else None,
            "redirectAction": GoogleCloudRetailV2RuleRedirectAction.from_dict(obj["redirectAction"]) if obj.get("redirectAction") is not None else None,
            "removeFacetAction": GoogleCloudRetailV2RuleRemoveFacetAction.from_dict(obj["removeFacetAction"]) if obj.get("removeFacetAction") is not None else None,
            "replacementAction": GoogleCloudRetailV2RuleReplacementAction.from_dict(obj["replacementAction"]) if obj.get("replacementAction") is not None else None,
            "twowaySynonymsAction": GoogleCloudRetailV2RuleTwowaySynonymsAction.from_dict(obj["twowaySynonymsAction"]) if obj.get("twowaySynonymsAction") is not None else None
        })
        return _obj
