...
class GoogleCloudRetailV2CatalogAttribute(BaseModel):
    """
    ...
    facet_config: Optional[GoogleCloudRetailV2CatalogAttributeFacetConfig] = Field(default=None, alias="facetConfig")
    ...
    __properties: ClassVar[List[str]] = ["dynamicFacetableOption", "exactSearchableOption", "facetConfig", "inUse", "indexableOption", "key", "retrievableOption", "searchableOption", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facetConfig": GoogleCloudRetailV2CatalogAttributeFacetConfig.from_dict(obj["facetConfig"]) if obj.get("facetConfig") is not None else None,
            "inUse": obj.get("inUse"),
