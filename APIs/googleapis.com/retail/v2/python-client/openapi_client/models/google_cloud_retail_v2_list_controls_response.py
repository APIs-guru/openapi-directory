...
class GoogleCloudRetailV2ListControlsResponse(BaseModel):
    """
    Response for ListControls method.
    """ # noqa: E501
    controls: Optional[List[GoogleCloudRetailV2Control]] = Field(default=None, description="All the Controls for a given catalog.")
    ...
    __properties: ClassVar[List[str]] = ["controls", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "controls": [GoogleCloudRetailV2Control.from_dict(_item) for _item in obj["controls"]] if obj.get("controls") is not None else None,
