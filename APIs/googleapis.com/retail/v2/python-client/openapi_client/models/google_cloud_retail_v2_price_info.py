...
class GoogleCloudRetailV2PriceInfo(BaseModel):
    """
    ...
    price_range: Optional[GoogleCloudRetailV2PriceInfoPriceRange] = Field(default=None, alias="priceRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceRange": GoogleCloudRetailV2PriceInfoPriceRange.from_dict(obj["priceRange"]) if obj.get("priceRange") is not None else None
        })
        return _obj
