...
class GoogleCloudRetailV2betaPurgeProductsMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "failureCount", "successCount", "updateTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaPurgeProductsMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaPurgeProductsMetadata from a dict"""
        if obj is None:
            return None
