...
class GoogleCloudRetailV2CatalogAttributeFacetConfig(BaseModel):
    ...
    rerank_config: Optional[GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig] = Field(default=None, alias="rerankConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2CatalogAttributeFacetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2CatalogAttributeFacetConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "facetIntervals": [GoogleCloudRetailV2Interval.from_dict(_item) for _item in obj["facetIntervals"]] if obj.get("facetIntervals") is not None else None,
            "ignoredFacetValues": [GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues.from_dict(_item) for _item in obj["ignoredFacetValues"]] if obj.get("ignoredFacetValues") is not None else None,
            "mergedFacet": GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacet.from_dict(obj["mergedFacet"]) if obj.get("mergedFacet") is not None else None,
            ...
            "rerankConfig": GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig.from_dict(obj["rerankConfig"]) if obj.get("rerankConfig") is not None else None
        })
        return _obj
