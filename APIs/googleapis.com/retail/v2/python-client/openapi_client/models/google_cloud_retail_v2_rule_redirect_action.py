...
class GoogleCloudRetailV2RuleRedirectAction(BaseModel):
    """
    Redirects a shopper to a specific page. * Rule Condition: Must specify Condition.query_terms. * Action Input: Request Query * Action Result: Redirects shopper to provided uri.
    """ # noqa: E501
    redirect_uri: Optional[StrictStr] = Field(default=None, description="URL must have length equal or less than 2000 characters.", alias="redirectUri")
