...
class GoogleCloudRetailV2ImportUserEventsRequest(BaseModel):
    """
    Request message for the ImportUserEvents request.
    """ # noqa: E501
    errors_config: Optional[GoogleCloudRetailV2ImportErrorsConfig] = Field(default=None, alias="errorsConfig")
    input_config: Optional[GoogleCloudRetailV2UserEventInputConfig] = Field(default=None, alias="inputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputConfig": GoogleCloudRetailV2UserEventInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None
        })
        return _obj
