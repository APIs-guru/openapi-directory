...
class GoogleCloudRetailV2Control(BaseModel):
    """
    ...
    rule: Optional[GoogleCloudRetailV2Rule] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedServingConfigIds", "displayName", "name", "rule", "searchSolutionUseCase", "solutionTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rule": GoogleCloudRetailV2Rule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
