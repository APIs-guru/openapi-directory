...
class GoogleCloudRetailV2RuleForceReturnFacetAction(BaseModel):
    """
    ...
    """ # noqa: E501
    facet_position_adjustments: Optional[List[GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment]] = Field(default=None, description="Each instance corresponds to a force return attribute for the given condition. There can't be more 3 instances here.", alias="facetPositionAdjustments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "facetPositionAdjustments": [GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment.from_dict(_item) for _item in obj["facetPositionAdjustments"]] if obj.get("facetPositionAdjustments") is not None else None
        })
        return _obj
