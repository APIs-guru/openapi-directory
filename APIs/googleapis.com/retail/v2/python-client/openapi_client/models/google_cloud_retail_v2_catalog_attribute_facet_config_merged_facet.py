...
class GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacet(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mergedFacetValues": [GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacetValue.from_dict(_item) for _item in obj["mergedFacetValues"]] if obj.get("mergedFacetValues") is not None else None
        })
        return _obj
