...
class GoogleCloudRetailV2betaModel(BaseModel):
    """
    ...
    model_features_config: Optional[GoogleCloudRetailV2betaModelModelFeaturesConfig] = Field(default=None, alias="modelFeaturesConfig")
    ...
    serving_config_lists: Optional[List[GoogleCloudRetailV2betaModelServingConfigList]] = Field(default=None, description="Output only. The list of valid serving configs associated with the PageOptimizationConfig.", alias="servingConfigLists")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modelFeaturesConfig": GoogleCloudRetailV2betaModelModelFeaturesConfig.from_dict(obj["modelFeaturesConfig"]) if obj.get("modelFeaturesConfig") is not None else None,
            "name": obj.get("name"),
            "optimizationObjective": obj.get("optimizationObjective"),
            "periodicTuningState": obj.get("periodicTuningState"),
            "servingConfigLists": [GoogleCloudRetailV2betaModelServingConfigList.from_dict(_item) for _item in obj["servingConfigLists"]] if obj.get("servingConfigLists") is not None else None,
