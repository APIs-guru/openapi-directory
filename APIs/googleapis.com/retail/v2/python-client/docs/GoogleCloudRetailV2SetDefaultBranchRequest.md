...
google_cloud_retail_v2_set_default_branch_request_instance = GoogleCloudRetailV2SetDefaultBranchRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2SetDefaultBranchRequest.to_json())

# convert the object into a dict
google_cloud_retail_v2_set_default_branch_request_dict = google_cloud_retail_v2_set_default_branch_request_instance.to_dict()
# create an instance of GoogleCloudRetailV2SetDefaultBranchRequest from a dict
google_cloud_retail_v2_set_default_branch_request_from_dict = GoogleCloudRetailV2SetDefaultBranchRequest.from_dict(google_cloud_retail_v2_set_default_branch_request_dict)
```
