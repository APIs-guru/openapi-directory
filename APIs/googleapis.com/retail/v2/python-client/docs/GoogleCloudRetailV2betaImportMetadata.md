...
json = "{}"
# create an instance of GoogleCloudRetailV2betaImportMetadata from a JSON string
google_cloud_retail_v2beta_import_metadata_instance = GoogleCloudRetailV2betaImportMetadata.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2betaImportMetadata.to_json())

# convert the object into a dict
google_cloud_retail_v2beta_import_metadata_dict = google_cloud_retail_v2beta_import_metadata_instance.to_dict()
# create an instance of GoogleCloudRetailV2betaImportMetadata from a dict
google_cloud_retail_v2beta_import_metadata_from_dict = GoogleCloudRetailV2betaImportMetadata.from_dict(google_cloud_retail_v2beta_import_metadata_dict)
```
