...
google_cloud_retail_v2_user_info_instance = GoogleCloudRetailV2UserInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2UserInfo.to_json())

# convert the object into a dict
google_cloud_retail_v2_user_info_dict = google_cloud_retail_v2_user_info_instance.to_dict()
# create an instance of GoogleCloudRetailV2UserInfo from a dict
google_cloud_retail_v2_user_info_from_dict = GoogleCloudRetailV2UserInfo.from_dict(google_cloud_retail_v2_user_info_dict)
```
