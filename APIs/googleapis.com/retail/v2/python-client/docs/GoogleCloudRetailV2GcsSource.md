...
google_cloud_retail_v2_gcs_source_instance = GoogleCloudRetailV2GcsSource.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2GcsSource.to_json())

# convert the object into a dict
google_cloud_retail_v2_gcs_source_dict = google_cloud_retail_v2_gcs_source_instance.to_dict()
# create an instance of GoogleCloudRetailV2GcsSource from a dict
google_cloud_retail_v2_gcs_source_from_dict = GoogleCloudRetailV2GcsSource.from_dict(google_cloud_retail_v2_gcs_source_dict)
```
