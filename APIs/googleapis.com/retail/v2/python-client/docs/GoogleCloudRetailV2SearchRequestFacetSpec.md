...
**facet_key** | [**GoogleCloudRetailV2SearchRequestFacetSpecFacetKey**](GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.md) |  | [optional] 
...
google_cloud_retail_v2_search_request_facet_spec_instance = GoogleCloudRetailV2SearchRequestFacetSpec.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2SearchRequestFacetSpec.to_json())

# convert the object into a dict
google_cloud_retail_v2_search_request_facet_spec_dict = google_cloud_retail_v2_search_request_facet_spec_instance.to_dict()
# create an instance of GoogleCloudRetailV2SearchRequestFacetSpec from a dict
google_cloud_retail_v2_search_request_facet_spec_from_dict = GoogleCloudRetailV2SearchRequestFacetSpec.from_dict(google_cloud_retail_v2_search_request_facet_spec_dict)
```
