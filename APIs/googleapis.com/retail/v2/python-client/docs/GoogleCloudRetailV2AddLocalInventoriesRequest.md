...
**local_inventories** | [**List[GoogleCloudRetailV2LocalInventory]**](GoogleCloudRetailV2LocalInventory.md) | Required. A list of inventory information at difference places. Each place is identified by its place ID. At most 3000 inventories are allowed per request. | [optional] 
...
google_cloud_retail_v2_add_local_inventories_request_instance = GoogleCloudRetailV2AddLocalInventoriesRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2AddLocalInventoriesRequest.to_json())

# convert the object into a dict
google_cloud_retail_v2_add_local_inventories_request_dict = google_cloud_retail_v2_add_local_inventories_request_instance.to_dict()
# create an instance of GoogleCloudRetailV2AddLocalInventoriesRequest from a dict
google_cloud_retail_v2_add_local_inventories_request_from_dict = GoogleCloudRetailV2AddLocalInventoriesRequest.from_dict(google_cloud_retail_v2_add_local_inventories_request_dict)
```
