...
------------ | ------------- | ------------- | -------------
**allowlist_input_config** | [**GoogleCloudRetailV2CompletionDataInputConfig**](GoogleCloudRetailV2CompletionDataInputConfig.md) |  | [optional] 
...
**denylist_input_config** | [**GoogleCloudRetailV2CompletionDataInputConfig**](GoogleCloudRetailV2CompletionDataInputConfig.md) |  | [optional] 
...
**suggestions_input_config** | [**GoogleCloudRetailV2CompletionDataInputConfig**](GoogleCloudRetailV2CompletionDataInputConfig.md) |  | [optional] 
...
google_cloud_retail_v2_completion_config_instance = GoogleCloudRetailV2CompletionConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2CompletionConfig.to_json())

# convert the object into a dict
google_cloud_retail_v2_completion_config_dict = google_cloud_retail_v2_completion_config_instance.to_dict()
# create an instance of GoogleCloudRetailV2CompletionConfig from a dict
google_cloud_retail_v2_completion_config_from_dict = GoogleCloudRetailV2CompletionConfig.from_dict(google_cloud_retail_v2_completion_config_dict)
```
