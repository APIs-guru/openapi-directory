...
**model_features_config** | [**GoogleCloudRetailV2ModelModelFeaturesConfig**](GoogleCloudRetailV2ModelModelFeaturesConfig.md) |  | [optional] 
...
**serving_config_lists** | [**List[GoogleCloudRetailV2ModelServingConfigList]**](GoogleCloudRetailV2ModelServingConfigList.md) | Output only. The list of valid serving configs associated with the PageOptimizationConfig. | [optional] [readonly] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2Model from a JSON string
google_cloud_retail_v2_model_instance = GoogleCloudRetailV2Model.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2Model.to_json())

# convert the object into a dict
google_cloud_retail_v2_model_dict = google_cloud_retail_v2_model_instance.to_dict()
# create an instance of GoogleCloudRetailV2Model from a dict
google_cloud_retail_v2_model_from_dict = GoogleCloudRetailV2Model.from_dict(google_cloud_retail_v2_model_dict)
```
