...
google_cloud_retail_v2_rule_remove_facet_action_instance = GoogleCloudRetailV2RuleRemoveFacetAction.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2RuleRemoveFacetAction.to_json())

# convert the object into a dict
google_cloud_retail_v2_rule_remove_facet_action_dict = google_cloud_retail_v2_rule_remove_facet_action_instance.to_dict()
# create an instance of GoogleCloudRetailV2RuleRemoveFacetAction from a dict
google_cloud_retail_v2_rule_remove_facet_action_from_dict = GoogleCloudRetailV2RuleRemoveFacetAction.from_dict(google_cloud_retail_v2_rule_remove_facet_action_dict)
```
