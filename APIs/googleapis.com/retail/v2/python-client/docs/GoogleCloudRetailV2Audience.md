...
google_cloud_retail_v2_audience_instance = GoogleCloudRetailV2Audience.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2Audience.to_json())

# convert the object into a dict
google_cloud_retail_v2_audience_dict = google_cloud_retail_v2_audience_instance.to_dict()
# create an instance of GoogleCloudRetailV2Audience from a dict
google_cloud_retail_v2_audience_from_dict = GoogleCloudRetailV2Audience.from_dict(google_cloud_retail_v2_audience_dict)
```
