...
**input_config** | [**GoogleCloudRetailV2ProductInputConfig**](GoogleCloudRetailV2ProductInputConfig.md) |  | [optional] 
...
google_cloud_retail_v2_import_products_request_instance = GoogleCloudRetailV2ImportProductsRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2ImportProductsRequest.to_json())

# convert the object into a dict
google_cloud_retail_v2_import_products_request_dict = google_cloud_retail_v2_import_products_request_instance.to_dict()
# create an instance of GoogleCloudRetailV2ImportProductsRequest from a dict
google_cloud_retail_v2_import_products_request_from_dict = GoogleCloudRetailV2ImportProductsRequest.from_dict(google_cloud_retail_v2_import_products_request_dict)
```
