...
**price_info** | [**GoogleCloudRetailV2PriceInfo**](GoogleCloudRetailV2PriceInfo.md) |  | [optional] 
...
google_cloud_retail_v2_local_inventory_instance = GoogleCloudRetailV2LocalInventory.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2LocalInventory.to_json())

# convert the object into a dict
google_cloud_retail_v2_local_inventory_dict = google_cloud_retail_v2_local_inventory_instance.to_dict()
# create an instance of GoogleCloudRetailV2LocalInventory from a dict
google_cloud_retail_v2_local_inventory_from_dict = GoogleCloudRetailV2LocalInventory.from_dict(google_cloud_retail_v2_local_inventory_dict)
```
