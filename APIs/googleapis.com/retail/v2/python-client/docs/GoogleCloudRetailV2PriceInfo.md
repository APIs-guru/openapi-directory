...
**price_range** | [**GoogleCloudRetailV2PriceInfoPriceRange**](GoogleCloudRetailV2PriceInfoPriceRange.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2PriceInfo from a JSON string
google_cloud_retail_v2_price_info_instance = GoogleCloudRetailV2PriceInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2PriceInfo.to_json())

# convert the object into a dict
google_cloud_retail_v2_price_info_dict = google_cloud_retail_v2_price_info_instance.to_dict()
# create an instance of GoogleCloudRetailV2PriceInfo from a dict
google_cloud_retail_v2_price_info_from_dict = GoogleCloudRetailV2PriceInfo.from_dict(google_cloud_retail_v2_price_info_dict)
```
