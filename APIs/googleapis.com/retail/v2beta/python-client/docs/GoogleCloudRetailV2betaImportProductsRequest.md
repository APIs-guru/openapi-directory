...
**input_config** | [**GoogleCloudRetailV2betaProductInputConfig**](GoogleCloudRetailV2betaProductInputConfig.md) |  | [optional] 
...
google_cloud_retail_v2beta_import_products_request_instance = GoogleCloudRetailV2betaImportProductsRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2betaImportProductsRequest.to_json())

# convert the object into a dict
google_cloud_retail_v2beta_import_products_request_dict = google_cloud_retail_v2beta_import_products_request_instance.to_dict()
# create an instance of GoogleCloudRetailV2betaImportProductsRequest from a dict
google_cloud_retail_v2beta_import_products_request_from_dict = GoogleCloudRetailV2betaImportProductsRequest.from_dict(google_cloud_retail_v2beta_import_products_request_dict)
```
