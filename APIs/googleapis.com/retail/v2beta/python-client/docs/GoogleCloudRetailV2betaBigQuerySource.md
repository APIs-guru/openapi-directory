...
google_cloud_retail_v2beta_big_query_source_instance = GoogleCloudRetailV2betaBigQuerySource.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2betaBigQuerySource.to_json())

# convert the object into a dict
google_cloud_retail_v2beta_big_query_source_dict = google_cloud_retail_v2beta_big_query_source_instance.to_dict()
# create an instance of GoogleCloudRetailV2betaBigQuerySource from a dict
google_cloud_retail_v2beta_big_query_source_from_dict = GoogleCloudRetailV2betaBigQuerySource.from_dict(google_cloud_retail_v2beta_big_query_source_dict)
```
