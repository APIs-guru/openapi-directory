...
**feeds** | [**List[GoogleCloudRetailV2betaMerchantCenterFeedFilter]**](GoogleCloudRetailV2betaMerchantCenterFeedFilter.md) | Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds. | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRetailV2betaMerchantCenterLink from a JSON string
google_cloud_retail_v2beta_merchant_center_link_instance = GoogleCloudRetailV2betaMerchantCenterLink.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2betaMerchantCenterLink.to_json())

# convert the object into a dict
google_cloud_retail_v2beta_merchant_center_link_dict = google_cloud_retail_v2beta_merchant_center_link_instance.to_dict()
# create an instance of GoogleCloudRetailV2betaMerchantCenterLink from a dict
google_cloud_retail_v2beta_merchant_center_link_from_dict = GoogleCloudRetailV2betaMerchantCenterLink.from_dict(google_cloud_retail_v2beta_merchant_center_link_dict)
```
