...
google_cloud_retail_v2beta_serving_config_instance = GoogleCloudRetailV2betaServingConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRetailV2betaServingConfig.to_json())

# convert the object into a dict
google_cloud_retail_v2beta_serving_config_dict = google_cloud_retail_v2beta_serving_config_instance.to_dict()
# create an instance of GoogleCloudRetailV2betaServingConfig from a dict
google_cloud_retail_v2beta_serving_config_from_dict = GoogleCloudRetailV2betaServingConfig.from_dict(google_cloud_retail_v2beta_serving_config_dict)
```
