...
class GoogleCloudRetailV2betaListControlsResponse(BaseModel):
    """
    Response for ListControls method.
    """ # noqa: E501
    controls: Optional[List[GoogleCloudRetailV2betaControl]] = Field(default=None, description="All the Controls for a given catalog.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "controls": [GoogleCloudRetailV2betaControl.from_dict(_item) for _item in obj["controls"]] if obj.get("controls") is not None else None,
