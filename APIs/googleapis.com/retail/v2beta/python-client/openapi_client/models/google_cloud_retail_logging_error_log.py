...
class GoogleCloudRetailLoggingErrorLog(BaseModel):
    """
    ...
    service_context: Optional[GoogleCloudRetailLoggingServiceContext] = Field(default=None, alias="serviceContext")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "context": GoogleCloudRetailLoggingErrorContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "importPayload": GoogleCloudRetailLoggingImportErrorContext.from_dict(obj["importPayload"]) if obj.get("importPayload") is not None else None,
            "message": obj.get("message"),
            "requestPayload": obj.get("requestPayload"),
            "responsePayload": obj.get("responsePayload"),
            "serviceContext": GoogleCloudRetailLoggingServiceContext.from_dict(obj["serviceContext"]) if obj.get("serviceContext") is not None else None,
