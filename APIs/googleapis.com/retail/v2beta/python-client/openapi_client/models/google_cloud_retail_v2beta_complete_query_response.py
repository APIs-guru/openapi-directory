...
class GoogleCloudRetailV2betaCompleteQueryResponse(BaseModel):
    """
    ...
    completion_results: Optional[List[GoogleCloudRetailV2betaCompleteQueryResponseCompletionResult]] = Field(default=None, description="Results of the matching suggestions. The result list is ordered and the first result is top suggestion.", alias="completionResults")
    recent_search_results: Optional[List[GoogleCloudRetailV2betaCompleteQueryResponseRecentSearchResult]] = Field(default=None, description="Deprecated. Matched recent searches of this user. The maximum number of recent searches is 10. This field is a restricted feature. If you want to enable it, contact Retail Search support. This feature is only available when CompleteQueryRequest.visitor_id field is set and UserEvent is imported. The recent searches satisfy the follow rules: * They are ordered from latest to oldest. * They are matched with CompleteQueryRequest.query case insensitively. * They are transformed to lower case. * They are UTF-8 safe. Recent searches are deduplicated. More recent searches will be reserved when duplication happens.", alias="recentSearchResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completionResults": [GoogleCloudRetailV2betaCompleteQueryResponseCompletionResult.from_dict(_item) for _item in obj["completionResults"]] if obj.get("completionResults") is not None else None,
            "recentSearchResults": [GoogleCloudRetailV2betaCompleteQueryResponseRecentSearchResult.from_dict(_item) for _item in obj["recentSearchResults"]] if obj.get("recentSearchResults") is not None else None
        })
        return _obj
