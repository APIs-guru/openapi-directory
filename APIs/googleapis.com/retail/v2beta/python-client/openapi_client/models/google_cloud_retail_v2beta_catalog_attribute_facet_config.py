...
class GoogleCloudRetailV2betaCatalogAttributeFacetConfig(BaseModel):
    ...
    rerank_config: Optional[GoogleCloudRetailV2betaCatalogAttributeFacetConfigRerankConfig] = Field(default=None, alias="rerankConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaCatalogAttributeFacetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaCatalogAttributeFacetConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "facetIntervals": [GoogleCloudRetailV2betaInterval.from_dict(_item) for _item in obj["facetIntervals"]] if obj.get("facetIntervals") is not None else None,
            "ignoredFacetValues": [GoogleCloudRetailV2betaCatalogAttributeFacetConfigIgnoredFacetValues.from_dict(_item) for _item in obj["ignoredFacetValues"]] if obj.get("ignoredFacetValues") is not None else None,
            "mergedFacet": GoogleCloudRetailV2betaCatalogAttributeFacetConfigMergedFacet.from_dict(obj["mergedFacet"]) if obj.get("mergedFacet") is not None else None,
            ...
            "rerankConfig": GoogleCloudRetailV2betaCatalogAttributeFacetConfigRerankConfig.from_dict(obj["rerankConfig"]) if obj.get("rerankConfig") is not None else None
        })
        return _obj
