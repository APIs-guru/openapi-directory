...
class GoogleCloudRetailV2betaImportProductsRequest(BaseModel):
    """
    Request message for Import methods.
    """ # noqa: E501
    errors_config: Optional[GoogleCloudRetailV2betaImportErrorsConfig] = Field(default=None, alias="errorsConfig")
    input_config: Optional[GoogleCloudRetailV2betaProductInputConfig] = Field(default=None, alias="inputConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaImportProductsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudRetailV2betaImportProductsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inputConfig": GoogleCloudRetailV2betaProductInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None,
