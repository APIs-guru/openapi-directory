...
class GoogleCloudRetailLoggingServiceContext(BaseModel):
    """
    Describes a running service that sends errors.
    """ # noqa: E501
    service: Optional[StrictStr] = Field(default=None, description="An identifier of the service. For example, \"retail.googleapis.com\".")
