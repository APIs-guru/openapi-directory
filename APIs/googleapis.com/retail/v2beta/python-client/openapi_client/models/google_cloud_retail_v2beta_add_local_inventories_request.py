...
class GoogleCloudRetailV2betaAddLocalInventoriesRequest(BaseModel):
    """
    ...
    local_inventories: Optional[List[GoogleCloudRetailV2betaLocalInventory]] = Field(default=None, description="Required. A list of inventory information at difference places. Each place is identified by its place ID. At most 3000 inventories are allowed per request.", alias="localInventories")
