...
class GoogleCloudRetailV2betaMerchantCenterLink(BaseModel):
    """
    ...
    feeds: Optional[List[GoogleCloudRetailV2betaMerchantCenterFeedFilter]] = Field(default=None, description="Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feeds": [GoogleCloudRetailV2betaMerchantCenterFeedFilter.from_dict(_item) for _item in obj["feeds"]] if obj.get("feeds") is not None else None,
