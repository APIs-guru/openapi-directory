...
class GoogleCloudRetailV2betaPredictResponse(BaseModel):
    """
    ...
    results: Optional[List[GoogleCloudRetailV2betaPredictResponsePredictionResult]] = Field(default=None, description="A list of recommended products. The order represents the ranking (from the most relevant product to the least).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GoogleCloudRetailV2betaPredictResponsePredictionResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
