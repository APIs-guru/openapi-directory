...
class TestListBlockchainNodesResponse(unittest.TestCase):
    """ListBlockchainNodesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBlockchainNodesResponse:
        """Test ListBlockchainNodesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBlockchainNodesResponse`
        """
        model = ListBlockchainNodesResponse()
        if include_optional:
            return ListBlockchainNodesResponse(
                blockchain_nodes = [
                    openapi_client.models.blockchain_node.BlockchainNode(
    ...
    def testListBlockchainNodesResponse(self):
        """Test ListBlockchainNodesResponse"""
