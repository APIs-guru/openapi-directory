...
class TestWorkflowInvocation(unittest.TestCase):
    """WorkflowInvocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowInvocation:
        """Test WorkflowInvocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowInvocation`
        """
    ...
    def testWorkflowInvocation(self):
        """Test WorkflowInvocation"""
