...
class SearchResult(BaseModel):
    ...
    """ # noqa: E501
    directory: Optional[DirectorySearchResult] = None
    file: Optional[FileSearchResult] = None
    __properties: ClassVar[List[str]] = ["directory", "file"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "directory": DirectorySearchResult.from_dict(obj["directory"]) if obj.get("directory") is not None else None,
            "file": FileSearchResult.from_dict(obj["file"]) if obj.get("file") is not None else None
        })
        return _obj
