...
class ListRepositoriesResponse(BaseModel):
    ...
    repositories: Optional[List[Repository]] = Field(default=None, description="List of repositories.")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations which could not be reached.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "repositories", "unreachable"]
