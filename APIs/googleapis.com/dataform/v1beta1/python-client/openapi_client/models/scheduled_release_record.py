...
class ScheduledReleaseRecord(BaseModel):
    ...
    """ # noqa: E501
    compilation_result: Optional[StrictStr] = Field(default=None, description="The name of the created compilation result, if one was successfully created. Must be in the format `projects/*/locations/*/repositories/*/compilationResults/*`.", alias="compilationResult")
    error_status: Optional[Status] = Field(default=None, alias="errorStatus")
    release_time: Optional[StrictStr] = Field(default=None, description="The timestamp of this release attempt.", alias="releaseTime")
    __properties: ClassVar[List[str]] = ["compilationResult", "errorStatus", "releaseTime"]
