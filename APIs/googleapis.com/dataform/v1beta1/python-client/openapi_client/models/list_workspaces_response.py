...
class ListWorkspacesResponse(BaseModel):
    ...
    workspaces: Optional[List[Workspace]] = Field(default=None, description="List of workspaces.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "unreachable", "workspaces"]
