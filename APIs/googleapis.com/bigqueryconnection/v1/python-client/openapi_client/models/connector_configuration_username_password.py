...
class ConnectorConfigurationUsernamePassword(BaseModel):
    """
    Username and Password authentication.
    """ # noqa: E501
    password: Optional[ConnectorConfigurationSecret] = None
    username: Optional[StrictStr] = Field(default=None, description="Required. Username.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "password": ConnectorConfigurationSecret.from_dict(obj["password"]) if obj.get("password") is not None else None,
