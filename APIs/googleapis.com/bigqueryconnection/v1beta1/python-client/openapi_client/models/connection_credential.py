...
class ConnectionCredential(BaseModel):
    ...
    """ # noqa: E501
    cloud_sql: Optional[CloudSqlCredential] = Field(default=None, alias="cloudSql")
    __properties: ClassVar[List[str]] = ["cloudSql"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloudSql": CloudSqlCredential.from_dict(obj["cloudSql"]) if obj.get("cloudSql") is not None else None
        })
        return _obj
