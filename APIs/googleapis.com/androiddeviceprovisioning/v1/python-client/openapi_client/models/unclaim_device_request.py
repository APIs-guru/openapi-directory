...
class UnclaimDeviceRequest(BaseModel):
    ...
    """ # noqa: E501
    device_id: Optional[StrictStr] = Field(default=None, description="Required. The device ID returned by `ClaimDevice`.", alias="deviceId")
    ...
    vacation_mode_days: Optional[StrictInt] = Field(default=None, description="The duration of the vacation unlock starting from when the request is processed. (1 day is treated as 24 hours)", alias="vacationModeDays")
    vacation_mode_expire_time: Optional[StrictStr] = Field(default=None, description="The expiration time of the vacation unlock.", alias="vacationModeExpireTime")
