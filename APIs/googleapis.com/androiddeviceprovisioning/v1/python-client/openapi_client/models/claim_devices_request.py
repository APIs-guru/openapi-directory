...
class ClaimDevicesRequest(BaseModel):
    ...
    """ # noqa: E501
    claims: Optional[List[PartnerClaim]] = Field(default=None, description="Required. A list of device claims.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "claims": [PartnerClaim.from_dict(_item) for _item in obj["claims"]] if obj.get("claims") is not None else None
        })
        return _obj
