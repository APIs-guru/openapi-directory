...
class UpdateDeviceMetadataInBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    updates: Optional[List[UpdateMetadataArguments]] = Field(default=None, description="Required. The list of metadata updates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [UpdateMetadataArguments.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
