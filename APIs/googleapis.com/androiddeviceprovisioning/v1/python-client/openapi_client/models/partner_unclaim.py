...
class PartnerUnclaim(BaseModel):
    ...
    """ # noqa: E501
    device_id: Optional[StrictStr] = Field(default=None, description="Required. Device ID of the device.", alias="deviceId")
    ...
    vacation_mode_days: Optional[StrictInt] = Field(default=None, description="Optional. The duration of the vacation unlock starting from when the request is processed. (1 day is treated as 24 hours)", alias="vacationModeDays")
    vacation_mode_expire_time: Optional[StrictStr] = Field(default=None, description="Optional. The expiration time of the vacation unlock.", alias="vacationModeExpireTime")
    __properties: ClassVar[List[str]] = ["deviceId", "deviceIdentifier", "sectionType", "vacationModeDays", "vacationModeExpireTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vacationModeDays": obj.get("vacationModeDays"),
