...
class TestFindDevicesByOwnerResponse(unittest.TestCase):
    """FindDevicesByOwnerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindDevicesByOwnerResponse:
        """Test FindDevicesByOwnerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindDevicesByOwnerResponse`
        """
        model = FindDevicesByOwnerResponse()
        if include_optional:
    ...
    def testFindDevicesByOwnerResponse(self):
        """Test FindDevicesByOwnerResponse"""
