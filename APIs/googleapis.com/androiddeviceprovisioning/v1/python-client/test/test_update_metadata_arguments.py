...
class TestUpdateMetadataArguments(unittest.TestCase):
    """UpdateMetadataArguments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMetadataArguments:
        """Test UpdateMetadataArguments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMetadataArguments`
        """
        model = UpdateMetadataArguments()
        if include_optional:
    ...
    def testUpdateMetadataArguments(self):
        """Test UpdateMetadataArguments"""
