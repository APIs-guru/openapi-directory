...
class TestPartnerUnclaim(unittest.TestCase):
    """PartnerUnclaim unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartnerUnclaim:
        """Test PartnerUnclaim
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartnerUnclaim`
        """
        model = PartnerUnclaim()
        if include_optional:
