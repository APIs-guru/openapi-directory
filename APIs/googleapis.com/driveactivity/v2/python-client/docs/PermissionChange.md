...
------------ | ------------- | ------------- | -------------
**added_permissions** | [**List[Permission]**](Permission.md) | The set of permissions added by this change. | [optional] 
**removed_permissions** | [**List[Permission]**](Permission.md) | The set of permissions removed by this change. | [optional] 
