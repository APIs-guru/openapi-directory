...
class TextList(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[Text]] = Field(default=None, description="Text values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [Text.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
