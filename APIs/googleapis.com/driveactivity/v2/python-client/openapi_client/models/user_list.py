...
class UserList(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[SingleUser]] = Field(default=None, description="User values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [SingleUser.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
