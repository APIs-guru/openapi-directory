...
class SelectionList(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[Selection]] = Field(default=None, description="Selection values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [Selection.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
