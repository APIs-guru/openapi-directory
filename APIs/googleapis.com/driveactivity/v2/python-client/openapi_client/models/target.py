...
class Target(BaseModel):
    ...
    drive_item: Optional[DriveItem] = Field(default=None, alias="driveItem")
    file_comment: Optional[FileComment] = Field(default=None, alias="fileComment")
    team_drive: Optional[TeamDrive] = Field(default=None, alias="teamDrive")
    __properties: ClassVar[List[str]] = ["drive", "driveItem", "fileComment", "teamDrive"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of file_comment
        if self.file_comment:
            _dict['fileComment'] = self.file_comment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "driveItem": DriveItem.from_dict(obj["driveItem"]) if obj.get("driveItem") is not None else None,
            "fileComment": FileComment.from_dict(obj["fileComment"]) if obj.get("fileComment") is not None else None,
