...
class DriveItem(BaseModel):
    ...
    mime_type: Optional[StrictStr] = Field(default=None, description="The MIME type of the Drive item. See https://developers.google.com/drive/v3/web/mime-types.", alias="mimeType")
    ...
    __properties: ClassVar[List[str]] = ["driveFile", "driveFolder", "file", "folder", "mimeType", "name", "owner", "title"]
