...
class QueryDriveActivityResponse(BaseModel):
    ...
    """ # noqa: E501
    activities: Optional[List[DriveActivity]] = Field(default=None, description="List of activity requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activities": [DriveActivity.from_dict(_item) for _item in obj["activities"]] if obj.get("activities") is not None else None,
