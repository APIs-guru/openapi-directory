...
class AppliedLabelChange(BaseModel):
    ...
    """ # noqa: E501
    changes: Optional[List[AppliedLabelChangeDetail]] = Field(default=None, description="Changes that were made to the Label on the Target.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": [AppliedLabelChangeDetail.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
