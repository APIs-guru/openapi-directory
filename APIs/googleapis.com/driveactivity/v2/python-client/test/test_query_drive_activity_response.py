...
class TestQueryDriveActivityResponse(unittest.TestCase):
    """QueryDriveActivityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryDriveActivityResponse:
        """Test QueryDriveActivityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryDriveActivityResponse`
        """
        model = QueryDriveActivityResponse()
        if include_optional:
            return QueryDriveActivityResponse(
                activities = [
                    openapi_client.models.drive_activity.DriveActivity(
                        actions = [
    ...
    def testQueryDriveActivityResponse(self):
        """Test QueryDriveActivityResponse"""
