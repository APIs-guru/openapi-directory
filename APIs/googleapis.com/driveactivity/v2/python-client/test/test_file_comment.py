...
class TestFileComment(unittest.TestCase):
    """FileComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileComment:
        """Test FileComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileComment`
        """
        model = FileComment()
        if include_optional:
            return FileComment(
