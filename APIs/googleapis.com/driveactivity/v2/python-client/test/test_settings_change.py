...
class TestSettingsChange(unittest.TestCase):
    """SettingsChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SettingsChange:
        """Test SettingsChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingsChange`
        """
