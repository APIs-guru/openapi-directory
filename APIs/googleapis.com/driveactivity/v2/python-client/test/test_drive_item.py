...
class TestDriveItem(unittest.TestCase):
    """DriveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DriveItem:
        """Test DriveItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DriveItem`
        """
        model = DriveItem()
        if include_optional:
            return DriveItem(
