...
class UserDeletionApi:
    ...
    def analytics_user_deletion_user_deletion_request_upsert(
        ...
        user_deletion_request: Optional[UserDeletionRequest] = None,
        ...
        :type user_ip: str
        :param user_deletion_request:
        :type user_deletion_request: UserDeletionRequest
        ...
        _param = self._analytics_user_deletion_user_deletion_request_upsert_serialize(
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def analytics_user_deletion_user_deletion_request_upsert_with_http_info(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def analytics_user_deletion_user_deletion_request_upsert_without_preload_content(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _analytics_user_deletion_user_deletion_request_upsert_serialize(
        self,
        alt,
        fields,
        key,
        ...
        if user_deletion_request is not None:
            _body_params = user_deletion_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userDeletion/userDeletionRequests:upsert',
