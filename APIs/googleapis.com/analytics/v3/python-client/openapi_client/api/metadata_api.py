...
class MetadataApi:
    ...
    def analytics_metadata_columns_list(
        self,
        report_type: Annotated[StrictStr, Field(description="Report type. Allowed Values: 'ga'. Where 'ga' corresponds to the Core Reporting API")],
        ...
        :param report_type: Report type. Allowed Values: 'ga'. Where 'ga' corresponds to the Core Reporting API (required)
        ...
        _param = self._analytics_metadata_columns_list_serialize(
    ...
    @validate_call
    def analytics_metadata_columns_list_with_http_info(
        self,
        report_type: Annotated[StrictStr, Field(description="Report type. Allowed Values: 'ga'. Where 'ga' corresponds to the Core Reporting API")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def analytics_metadata_columns_list_without_preload_content(
        self,
        report_type: Annotated[StrictStr, Field(description="Report type. Allowed Values: 'ga'. Where 'ga' corresponds to the Core Reporting API")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _analytics_metadata_columns_list_serialize(
        self,
        report_type,
        alt,
        fields,
        ...
        if report_type is not None:
            _path_params['reportType'] = report_type
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/metadata/{reportType}/columns',
