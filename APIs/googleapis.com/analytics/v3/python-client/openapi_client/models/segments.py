...
class Segments(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Segment]] = Field(default=None, description="A list of segments.")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#segments', description="Collection type for segments.")
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page for this segment collection.", alias="nextLink")
    previous_link: Optional[StrictStr] = Field(default=None, description="Link to previous page for this segment collection.", alias="previousLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Segment.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#segments',
