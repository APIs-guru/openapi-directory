...
class RemarketingAudiences(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[RemarketingAudience]] = Field(default=None, description="A list of remarketing audiences.")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#remarketingAudiences', description="Collection type.")
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page for this remarketing audience collection.", alias="nextLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [RemarketingAudience.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#remarketingAudiences',
