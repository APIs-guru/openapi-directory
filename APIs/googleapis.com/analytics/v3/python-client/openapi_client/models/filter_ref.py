...
class FilterRef(BaseModel):
    ...
    href: Optional[StrictStr] = Field(default=None, description="Link for this filter.")
    id: Optional[StrictStr] = Field(default=None, description="Filter ID.")
    kind: Optional[StrictStr] = Field(default='analytics#filterRef', description="Kind value for filter reference.")
    name: Optional[StrictStr] = Field(default=None, description="Name of this filter.")
    __properties: ClassVar[List[str]] = ["accountId", "href", "id", "kind", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "href": obj.get("href"),
            "id": obj.get("id"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#filterRef',
            "name": obj.get("name")
        })
        return _obj
