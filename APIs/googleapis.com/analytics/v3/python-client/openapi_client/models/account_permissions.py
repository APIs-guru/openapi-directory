...
class AccountPermissions(BaseModel):
    ...
    """ # noqa: E501
    effective: Optional[List[StrictStr]] = Field(default=None, description="All the permissions that the user has for this account. These include any implied permissions (e.g., EDIT implies VIEW).")
