...
class Profiles(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Profile]] = Field(default=None, description="A list of views (profiles).")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#profiles', description="Collection type.")
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page for this view (profile) collection.", alias="nextLink")
    previous_link: Optional[StrictStr] = Field(default=None, description="Link to previous page for this view (profile) collection.", alias="previousLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Profile.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#profiles',
