...
class ProfileFilterLinks(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[ProfileFilterLink]] = Field(default=None, description="A list of profile filter links.")
    items_per_page: Optional[StrictInt] = Field(default=None, description="The maximum number of resources the response can contain, regardless of the actual number of resources returned. Its value ranges from 1 to 1,000 with a value of 1000 by default, or otherwise specified by the max-results query parameter.", alias="itemsPerPage")
    kind: Optional[StrictStr] = Field(default='analytics#profileFilterLinks', description="Collection type.")
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page for this profile filter link collection.", alias="nextLink")
    previous_link: Optional[StrictStr] = Field(default=None, description="Link to previous page for this profile filter link collection.", alias="previousLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ProfileFilterLink.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#profileFilterLinks',
