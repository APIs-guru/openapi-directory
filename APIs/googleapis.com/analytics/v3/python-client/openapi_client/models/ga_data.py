...
class GaData(BaseModel):
    ...
    contains_sampled_data: Optional[StrictBool] = Field(default=None, description="Determines if Analytics data contains samples.", alias="containsSampledData")
    data_last_refreshed: Optional[StrictStr] = Field(default=None, description="The last refreshed time in seconds for Analytics data.", alias="dataLastRefreshed")
    data_table: Optional[GaDataDataTable] = Field(default=None, alias="dataTable")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#gaData', description="Resource type.")
    ...
    rows: Optional[List[List[StrictStr]]] = Field(default=None, description="Analytics data rows, where each row contains a list of dimension values followed by the metric values. The order of dimensions and metrics is same as specified in the request.")
    ...
    __properties: ClassVar[List[str]] = ["columnHeaders", "containsSampledData", "dataLastRefreshed", "dataTable", "id", "itemsPerPage", "kind", "nextLink", "previousLink", "profileInfo", "query", "rows", "sampleSize", "sampleSpace", "selfLink", "totalResults", "totalsForAllResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataTable": GaDataDataTable.from_dict(obj["dataTable"]) if obj.get("dataTable") is not None else None,
            "id": obj.get("id"),
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#gaData',
