...
class WebPropertyRef(BaseModel):
    ...
    href: Optional[StrictStr] = Field(default=None, description="Link for this web property.")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#webPropertyRef', description="Analytics web property reference.")
    name: Optional[StrictStr] = Field(default=None, description="Name of this web property.")
    __properties: ClassVar[List[str]] = ["accountId", "href", "id", "internalWebPropertyId", "kind", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#webPropertyRef',
            "name": obj.get("name")
        })
        return _obj
