...
class AccountTreeResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='analytics#accountTreeResponse', description="Resource type for account ticket.")
    profile: Optional[Profile] = None
    webproperty: Optional[Webproperty] = None
    __properties: ClassVar[List[str]] = ["account", "kind", "profile", "webproperty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#accountTreeResponse',
