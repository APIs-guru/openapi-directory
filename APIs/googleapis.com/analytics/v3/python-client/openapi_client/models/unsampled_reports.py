...
class UnsampledReports(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[UnsampledReport]] = Field(default=None, description="A list of unsampled reports.")
    ...
    kind: Optional[StrictStr] = Field(default='analytics#unsampledReports', description="Collection type.")
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page for this unsampled report collection.", alias="nextLink")
    previous_link: Optional[StrictStr] = Field(default=None, description="Link to previous page for this unsampled report collection.", alias="previousLink")
    ...
    total_results: Optional[StrictInt] = Field(default=None, description="The total number of results for the query, regardless of the number of resources in the result.", alias="totalResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [UnsampledReport.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "itemsPerPage": obj.get("itemsPerPage"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'analytics#unsampledReports',
