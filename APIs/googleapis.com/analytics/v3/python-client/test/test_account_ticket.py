...
class TestAccountTicket(unittest.TestCase):
    """AccountTicket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountTicket:
        """Test AccountTicket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountTicket`
        """
        model = AccountTicket()
        if include_optional:
