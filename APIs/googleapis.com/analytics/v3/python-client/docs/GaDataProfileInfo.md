...
json = "{}"
# create an instance of GaDataProfileInfo from a JSON string
ga_data_profile_info_instance = GaDataProfileInfo.from_json(json)
# print the JSON string representation of the object
print(GaDataProfileInfo.to_json())

# convert the object into a dict
ga_data_profile_info_dict = ga_data_profile_info_instance.to_dict()
# create an instance of GaDataProfileInfo from a dict
ga_data_profile_info_from_dict = GaDataProfileInfo.from_dict(ga_data_profile_info_dict)
```
