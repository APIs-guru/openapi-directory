...
class EventWorkingLocationPropertiesCustomLocation(BaseModel):
    """
    If present, specifies that the user is working from a custom location.
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="An optional extra label for additional information.")
