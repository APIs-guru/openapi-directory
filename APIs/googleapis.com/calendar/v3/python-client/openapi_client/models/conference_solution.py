...
class ConferenceSolution(BaseModel):
    ...
    ConferenceSolution
    """ # noqa: E501
    icon_uri: Optional[StrictStr] = Field(default=None, description="The user-visible icon for this solution.", alias="iconUri")
    key: Optional[ConferenceSolutionKey] = None
    name: Optional[StrictStr] = Field(default=None, description="The user-visible name of this solution. Not localized.")
    __properties: ClassVar[List[str]] = ["iconUri", "key", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key": ConferenceSolutionKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "name": obj.get("name")
        })
        return _obj
