...
class CalendarList(BaseModel):
    ...
    items: Optional[List[CalendarListEntry]] = Field(default=None, description="Calendars that are present on the user's calendar list.")
    kind: Optional[StrictStr] = Field(default='calendar#calendarList', description="Type of the collection (\"calendar#calendarList\").")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etag": obj.get("etag"),
            "items": [CalendarListEntry.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind") if obj.get("kind") is not None else 'calendar#calendarList',
