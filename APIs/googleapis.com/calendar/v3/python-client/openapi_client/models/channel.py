...
class Channel(BaseModel):
    ...
    params: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional parameters controlling delivery channel behavior. Optional.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of delivery mechanism used for this channel. Valid values are \"web_hook\" (or \"webhook\"). Both values refer to a channel where Http requests are used to deliver messages.")
