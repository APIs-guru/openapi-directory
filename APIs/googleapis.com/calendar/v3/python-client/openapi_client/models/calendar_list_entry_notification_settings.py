...
class CalendarListEntryNotificationSettings(BaseModel):
    ...
    """ # noqa: E501
    notifications: Optional[List[CalendarNotification]] = Field(default=None, description="The list of notifications set for this calendar.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notifications": [CalendarNotification.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
