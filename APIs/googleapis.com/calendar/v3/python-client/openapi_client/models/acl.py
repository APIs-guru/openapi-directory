...
class Acl(BaseModel):
    ...
    items: Optional[List[AclRule]] = Field(default=None, description="List of rules on the access control list.")
    kind: Optional[StrictStr] = Field(default='calendar#acl', description="Type of the collection (\"calendar#acl\").")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etag": obj.get("etag"),
            "items": [AclRule.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind") if obj.get("kind") is not None else 'calendar#acl',
