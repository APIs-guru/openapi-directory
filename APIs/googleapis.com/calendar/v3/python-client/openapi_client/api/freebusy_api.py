...
class FreebusyApi:
    ...
    def calendar_freebusy_query(
        ...
        free_busy_request: Optional[FreeBusyRequest] = None,
        ...
        :type user_ip: str
        :param free_busy_request:
        :type free_busy_request: FreeBusyRequest
        ...
        _param = self._calendar_freebusy_query_serialize(
            alt=alt,
            fields=fields,
            key=key,
            ...
            user_ip=user_ip,
            free_busy_request=free_busy_request,
    ...
    @validate_call
    def calendar_freebusy_query_with_http_info(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def calendar_freebusy_query_without_preload_content(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _calendar_freebusy_query_serialize(
        self,
        alt,
        fields,
        key,
        ...
        if free_busy_request is not None:
            _body_params = free_busy_request
