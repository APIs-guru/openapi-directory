...
class AclApi:
    ...
    def calendar_acl_delete(
        ...
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        ...
        :param rule_id: ACL rule identifier. (required)
        :type rule_id: str
        ...
        _param = self._calendar_acl_delete_serialize(
    ...
    @validate_call
    def calendar_acl_delete_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def calendar_acl_delete_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _calendar_acl_delete_serialize(
        self,
        calendar_id,
        rule_id,
        alt,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/calendars/{calendarId}/acl/{ruleId}',
    ...
    def calendar_acl_get(
        ...
        _param = self._calendar_acl_get_serialize(
            calendar_id=calendar_id,
            rule_id=rule_id,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def calendar_acl_get_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def calendar_acl_get_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _calendar_acl_get_serialize(
        self,
        calendar_id,
        rule_id,
        alt,
    ...
    def calendar_acl_insert(
        ...
        quota_user: Annotated[Optional[StrictStr], Field(description="An opaque string that represents a user for quota purposes. Must not exceed 40 characters.")] = None,
        user_ip: Annotated[Optional[StrictStr], Field(description="Deprecated. Please use quotaUser instead.")] = None,
        send_notifications: Annotated[Optional[StrictBool], Field(description="Whether to send notifications about the calendar sharing change. Optional. The default is True.")] = None,
        acl_rule: Optional[AclRule] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._calendar_acl_insert_serialize(
            calendar_id=calendar_id,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def calendar_acl_insert_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def calendar_acl_insert_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _calendar_acl_insert_serialize(
        self,
        calendar_id,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/calendars/{calendarId}/acl',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def calendar_acl_list(
        ...
        show_deleted: Annotated[Optional[StrictBool], Field(description="Whether to include deleted ACLs in the result. Deleted ACLs are represented by role equal to \"none\". Deleted ACLs will always be included if syncToken is provided. Optional. The default is False.")] = None,
        ...
        _param = self._calendar_acl_list_serialize(
            calendar_id=calendar_id,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def calendar_acl_list_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def calendar_acl_list_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _calendar_acl_list_serialize(
        self,
        calendar_id,
        alt,
        fields,
    ...
    def calendar_acl_patch(
        ...
        quota_user: Annotated[Optional[StrictStr], Field(description="An opaque string that represents a user for quota purposes. Must not exceed 40 characters.")] = None,
        user_ip: Annotated[Optional[StrictStr], Field(description="Deprecated. Please use quotaUser instead.")] = None,
        send_notifications: Annotated[Optional[StrictBool], Field(description="Whether to send notifications about the calendar sharing change. Note that there are no notifications on access removal. Optional. The default is True.")] = None,
        acl_rule: Optional[AclRule] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._calendar_acl_patch_serialize(
            calendar_id=calendar_id,
            rule_id=rule_id,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def calendar_acl_patch_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def calendar_acl_patch_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _calendar_acl_patch_serialize(
        self,
        calendar_id,
        rule_id,
        alt,
    ...
    def calendar_acl_update(
        ...
        _param = self._calendar_acl_update_serialize(
            calendar_id=calendar_id,
            rule_id=rule_id,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def calendar_acl_update_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def calendar_acl_update_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        rule_id: Annotated[StrictStr, Field(description="ACL rule identifier.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _calendar_acl_update_serialize(
        self,
        calendar_id,
        rule_id,
        alt,
    ...
    def calendar_acl_watch(
        ...
        _param = self._calendar_acl_watch_serialize(
            calendar_id=calendar_id,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def calendar_acl_watch_with_http_info(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def calendar_acl_watch_without_preload_content(
        self,
        calendar_id: Annotated[StrictStr, Field(description="Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user, use the \"primary\" keyword.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _calendar_acl_watch_serialize(
        self,
        calendar_id,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/calendars/{calendarId}/acl/watch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
