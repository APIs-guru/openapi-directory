...
------------- | ------------- | -------------
[**calendar_channels_stop**](ChannelsApi.md#calendar_channels_stop) | **POST** /channels/stop | 


# **calendar_channels_stop**
> calendar_channels_stop(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, channel=channel)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.calendar_channels_stop(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, channel=channel)
    except Exception as e:
        print("Exception when calling ChannelsApi->calendar_channels_stop: %s\n" % e)
```
