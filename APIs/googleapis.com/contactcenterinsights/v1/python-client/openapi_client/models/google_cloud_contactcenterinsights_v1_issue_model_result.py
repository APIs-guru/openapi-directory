...
class GoogleCloudContactcenterinsightsV1IssueModelResult(BaseModel):
    ...
    """ # noqa: E501
    issue_model: Optional[StrictStr] = Field(default=None, description="Issue model that generates the result. Format: projects/{project}/locations/{location}/issueModels/{issue_model}", alias="issueModel")
    issues: Optional[List[GoogleCloudContactcenterinsightsV1IssueAssignment]] = Field(default=None, description="All the matched issues.")
    __properties: ClassVar[List[str]] = ["issueModel", "issues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issueModel": obj.get("issueModel"),
            "issues": [GoogleCloudContactcenterinsightsV1IssueAssignment.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
