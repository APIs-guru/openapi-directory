...
class GoogleCloudContactcenterinsightsV1ExportIssueModelMetadata(BaseModel):
    """
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1ExportIssueModelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1ExportIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
