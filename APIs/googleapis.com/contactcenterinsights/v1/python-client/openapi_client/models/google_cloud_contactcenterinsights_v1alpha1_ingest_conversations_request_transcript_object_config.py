...
class GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestTranscriptObjectConfig(BaseModel):
    """
    Configuration for processing transcript objects.
    """ # noqa: E501
    medium: Optional[StrictStr] = Field(default=None, description="Required. The medium transcript objects represent.")
    __properties: ClassVar[List[str]] = ["medium"]
