...
class GoogleCloudContactcenterinsightsV1ListConversationsResponse(BaseModel):
    ...
    """ # noqa: E501
    conversations: Optional[List[GoogleCloudContactcenterinsightsV1Conversation]] = Field(default=None, description="The conversations that match the request.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token which can be sent as `page_token` to retrieve the next page. If this field is set, it means there is another page available. If it is not set, it means no other pages are available.", alias="nextPageToken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [GoogleCloudContactcenterinsightsV1Conversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
