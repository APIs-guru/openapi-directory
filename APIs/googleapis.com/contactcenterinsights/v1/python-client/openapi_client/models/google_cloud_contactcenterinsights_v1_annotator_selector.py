...
class GoogleCloudContactcenterinsightsV1AnnotatorSelector(BaseModel):
    ...
    summarization_config: Optional[GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig] = Field(default=None, alias="summarizationConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summarizationConfig": GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig.from_dict(obj["summarizationConfig"]) if obj.get("summarizationConfig") is not None else None
        })
        return _obj
