...
class GoogleCloudContactcenterinsightsV1alpha1CreateIssueModelRequest(BaseModel):
    ...
    """ # noqa: E501
    issue_model: Optional[GoogleCloudContactcenterinsightsV1alpha1IssueModel] = Field(default=None, alias="issueModel")
    parent: Optional[StrictStr] = Field(default=None, description="Required. The parent resource of the issue model.")
    __properties: ClassVar[List[str]] = ["issueModel", "parent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of issue_model
        if self.issue_model:
            _dict['issueModel'] = self.issue_model.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issueModel": GoogleCloudContactcenterinsightsV1alpha1IssueModel.from_dict(obj["issueModel"]) if obj.get("issueModel") is not None else None,
