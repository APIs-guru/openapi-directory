...
class GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelMetadata(BaseModel):
    """
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
