...
class GoogleCloudContactcenterinsightsV1alpha1ExportIssueModelMetadata(BaseModel):
    """
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1alpha1ExportIssueModelRequest] = None
    __properties: ClassVar[List[str]] = ["createTime", "endTime", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1alpha1ExportIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
