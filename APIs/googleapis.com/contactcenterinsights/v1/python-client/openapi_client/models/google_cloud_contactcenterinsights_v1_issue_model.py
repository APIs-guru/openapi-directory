...
class GoogleCloudContactcenterinsightsV1IssueModel(BaseModel):
    ...
    input_data_config: Optional[GoogleCloudContactcenterinsightsV1IssueModelInputDataConfig] = Field(default=None, alias="inputDataConfig")
    ...
    training_stats: Optional[GoogleCloudContactcenterinsightsV1IssueModelLabelStats] = Field(default=None, alias="trainingStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputDataConfig": GoogleCloudContactcenterinsightsV1IssueModelInputDataConfig.from_dict(obj["inputDataConfig"]) if obj.get("inputDataConfig") is not None else None,
            "issueCount": obj.get("issueCount"),
            "languageCode": obj.get("languageCode"),
            "modelType": obj.get("modelType"),
            "name": obj.get("name"),
            "state": obj.get("state"),
            "trainingStats": GoogleCloudContactcenterinsightsV1IssueModelLabelStats.from_dict(obj["trainingStats"]) if obj.get("trainingStats") is not None else None,
