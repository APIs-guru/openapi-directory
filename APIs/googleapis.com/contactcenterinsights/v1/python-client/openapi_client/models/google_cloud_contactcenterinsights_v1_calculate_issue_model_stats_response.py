...
class GoogleCloudContactcenterinsightsV1CalculateIssueModelStatsResponse(BaseModel):
    ...
    """ # noqa: E501
    current_stats: Optional[GoogleCloudContactcenterinsightsV1IssueModelLabelStats] = Field(default=None, alias="currentStats")
    __properties: ClassVar[List[str]] = ["currentStats"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of current_stats
        if self.current_stats:
            _dict['currentStats'] = self.current_stats.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentStats": GoogleCloudContactcenterinsightsV1IssueModelLabelStats.from_dict(obj["currentStats"]) if obj.get("currentStats") is not None else None
        })
        return _obj
