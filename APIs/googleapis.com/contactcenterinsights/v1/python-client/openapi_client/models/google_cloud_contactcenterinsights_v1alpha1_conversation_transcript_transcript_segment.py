...
class GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegment(BaseModel):
    """
    ...
    dialogflow_segment_metadata: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegmentDialogflowSegmentMetadata] = Field(default=None, alias="dialogflowSegmentMetadata")
    ...
    segment_participant: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationParticipant] = Field(default=None, alias="segmentParticipant")
    ...
    words: Optional[List[GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegmentWordInfo]] = Field(default=None, description="A list of the word-specific information for each word in the segment.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dialogflowSegmentMetadata": GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegmentDialogflowSegmentMetadata.from_dict(obj["dialogflowSegmentMetadata"]) if obj.get("dialogflowSegmentMetadata") is not None else None,
            "languageCode": obj.get("languageCode"),
            "messageTime": obj.get("messageTime"),
            "segmentParticipant": GoogleCloudContactcenterinsightsV1alpha1ConversationParticipant.from_dict(obj["segmentParticipant"]) if obj.get("segmentParticipant") is not None else None,
            ...
            "text": obj.get("text"),
            "words": [GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegmentWordInfo.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
