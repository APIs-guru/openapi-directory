...
class GoogleCloudContactcenterinsightsV1alpha1PhraseMatchData(BaseModel):
    ...
    phrase_matcher: Optional[StrictStr] = Field(default=None, description="The unique identifier (the resource name) of the phrase matcher.", alias="phraseMatcher")
    __properties: ClassVar[List[str]] = ["displayName", "phraseMatcher"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phraseMatcher": obj.get("phraseMatcher")
        })
        return _obj
