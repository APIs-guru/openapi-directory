...
class GoogleCloudContactcenterinsightsV1ListViewsResponse(BaseModel):
    ...
    views: Optional[List[GoogleCloudContactcenterinsightsV1View]] = Field(default=None, description="The views that match the request.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "views"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "views": [GoogleCloudContactcenterinsightsV1View.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
