...
class GoogleCloudContactcenterinsightsV1BulkDeleteConversationsMetadata(BaseModel):
    """
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1BulkDeleteConversationsRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1BulkDeleteConversationsRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
