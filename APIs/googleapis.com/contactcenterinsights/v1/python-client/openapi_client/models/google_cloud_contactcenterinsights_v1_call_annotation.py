...
class GoogleCloudContactcenterinsightsV1CallAnnotation(BaseModel):
    ...
    """ # noqa: E501
    annotation_end_boundary: Optional[GoogleCloudContactcenterinsightsV1AnnotationBoundary] = Field(default=None, alias="annotationEndBoundary")
    annotation_start_boundary: Optional[GoogleCloudContactcenterinsightsV1AnnotationBoundary] = Field(default=None, alias="annotationStartBoundary")
    ...
    entity_mention_data: Optional[GoogleCloudContactcenterinsightsV1EntityMentionData] = Field(default=None, alias="entityMentionData")
    hold_data: Optional[Dict[str, Any]] = Field(default=None, description="The data for a hold annotation.", alias="holdData")
    intent_match_data: Optional[GoogleCloudContactcenterinsightsV1IntentMatchData] = Field(default=None, alias="intentMatchData")
    ...
    issue_match_data: Optional[GoogleCloudContactcenterinsightsV1IssueMatchData] = Field(default=None, alias="issueMatchData")
    phrase_match_data: Optional[GoogleCloudContactcenterinsightsV1PhraseMatchData] = Field(default=None, alias="phraseMatchData")
    sentiment_data: Optional[GoogleCloudContactcenterinsightsV1SentimentData] = Field(default=None, alias="sentimentData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationEndBoundary": GoogleCloudContactcenterinsightsV1AnnotationBoundary.from_dict(obj["annotationEndBoundary"]) if obj.get("annotationEndBoundary") is not None else None,
            "annotationStartBoundary": GoogleCloudContactcenterinsightsV1AnnotationBoundary.from_dict(obj["annotationStartBoundary"]) if obj.get("annotationStartBoundary") is not None else None,
            "channelTag": obj.get("channelTag"),
            "entityMentionData": GoogleCloudContactcenterinsightsV1EntityMentionData.from_dict(obj["entityMentionData"]) if obj.get("entityMentionData") is not None else None,
            "holdData": obj.get("holdData"),
            "intentMatchData": GoogleCloudContactcenterinsightsV1IntentMatchData.from_dict(obj["intentMatchData"]) if obj.get("intentMatchData") is not None else None,
            "interruptionData": obj.get("interruptionData"),
            "issueMatchData": GoogleCloudContactcenterinsightsV1IssueMatchData.from_dict(obj["issueMatchData"]) if obj.get("issueMatchData") is not None else None,
            "phraseMatchData": GoogleCloudContactcenterinsightsV1PhraseMatchData.from_dict(obj["phraseMatchData"]) if obj.get("phraseMatchData") is not None else None,
            "sentimentData": GoogleCloudContactcenterinsightsV1SentimentData.from_dict(obj["sentimentData"]) if obj.get("sentimentData") is not None else None,
