...
class GoogleCloudContactcenterinsightsV1alpha1IssueModelResult(BaseModel):
    ...
    issues: Optional[List[GoogleCloudContactcenterinsightsV1alpha1IssueAssignment]] = Field(default=None, description="All the matched issues.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issues": [GoogleCloudContactcenterinsightsV1alpha1IssueAssignment.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
