...
class GoogleCloudContactcenterinsightsV1CreateIssueModelRequest(BaseModel):
    ...
    """ # noqa: E501
    issue_model: Optional[GoogleCloudContactcenterinsightsV1IssueModel] = Field(default=None, alias="issueModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issueModel": GoogleCloudContactcenterinsightsV1IssueModel.from_dict(obj["issueModel"]) if obj.get("issueModel") is not None else None,
