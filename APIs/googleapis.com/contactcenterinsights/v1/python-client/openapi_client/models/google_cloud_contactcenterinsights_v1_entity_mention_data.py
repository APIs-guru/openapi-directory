...
class GoogleCloudContactcenterinsightsV1EntityMentionData(BaseModel):
    ...
    """ # noqa: E501
    entity_unique_id: Optional[StrictStr] = Field(default=None, description="The key of this entity in conversation entities. Can be used to retrieve the exact `Entity` this mention is attached to.", alias="entityUniqueId")
    sentiment: Optional[GoogleCloudContactcenterinsightsV1SentimentData] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of the entity mention.")
    __properties: ClassVar[List[str]] = ["entityUniqueId", "sentiment", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MENTION_TYPE_UNSPECIFIED', 'PROPER', 'COMMON']):
            raise ValueError("must be one of enum values ('MENTION_TYPE_UNSPECIFIED', 'PROPER', 'COMMON')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityUniqueId": obj.get("entityUniqueId"),
