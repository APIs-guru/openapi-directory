...
class GoogleCloudContactcenterinsightsV1alpha1Entity(BaseModel):
    ...
    sentiment: Optional[GoogleCloudContactcenterinsightsV1alpha1SentimentData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sentiment": GoogleCloudContactcenterinsightsV1alpha1SentimentData.from_dict(obj["sentiment"]) if obj.get("sentiment") is not None else None,
            "type": obj.get("type")
        })
        return _obj
