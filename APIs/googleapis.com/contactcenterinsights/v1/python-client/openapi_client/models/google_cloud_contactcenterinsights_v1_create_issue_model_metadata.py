...
class GoogleCloudContactcenterinsightsV1CreateIssueModelMetadata(BaseModel):
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1CreateIssueModelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1CreateIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
