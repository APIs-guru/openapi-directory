...
class GoogleCloudContactcenterinsightsV1alpha1Conversation(BaseModel):
    ...
    call_metadata: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationCallMetadata] = Field(default=None, alias="callMetadata")
    ...
    data_source: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationDataSource] = Field(default=None, alias="dataSource")
    dialogflow_intents: Optional[Dict[str, GoogleCloudContactcenterinsightsV1alpha1DialogflowIntent]] = Field(default=None, description="Output only. All the matched Dialogflow intents in the call. The key corresponds to a Dialogflow intent, format: projects/{project}/agent/{agent}/intents/{intent}", alias="dialogflowIntents")
    ...
    latest_analysis: Optional[GoogleCloudContactcenterinsightsV1alpha1Analysis] = Field(default=None, alias="latestAnalysis")
    latest_summary: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationSummarizationSuggestionData] = Field(default=None, alias="latestSummary")
    ...
    quality_metadata: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationQualityMetadata] = Field(default=None, alias="qualityMetadata")
    runtime_annotations: Optional[List[GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotation]] = Field(default=None, description="Output only. The annotations that were generated during the customer and agent interaction.", alias="runtimeAnnotations")
    start_time: Optional[StrictStr] = Field(default=None, description="The time at which the conversation started.", alias="startTime")
    transcript: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationTranscript] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callMetadata": GoogleCloudContactcenterinsightsV1alpha1ConversationCallMetadata.from_dict(obj["callMetadata"]) if obj.get("callMetadata") is not None else None,
            "createTime": obj.get("createTime"),
            "dataSource": GoogleCloudContactcenterinsightsV1alpha1ConversationDataSource.from_dict(obj["dataSource"]) if obj.get("dataSource") is not None else None,
            "dialogflowIntents": dict(
                (_k, GoogleCloudContactcenterinsightsV1alpha1DialogflowIntent.from_dict(_v))
            ...
            "latestAnalysis": GoogleCloudContactcenterinsightsV1alpha1Analysis.from_dict(obj["latestAnalysis"]) if obj.get("latestAnalysis") is not None else None,
            "latestSummary": GoogleCloudContactcenterinsightsV1alpha1ConversationSummarizationSuggestionData.from_dict(obj["latestSummary"]) if obj.get("latestSummary") is not None else None,
            "medium": obj.get("medium"),
            "name": obj.get("name"),
            "obfuscatedUserId": obj.get("obfuscatedUserId"),
            "qualityMetadata": GoogleCloudContactcenterinsightsV1alpha1ConversationQualityMetadata.from_dict(obj["qualityMetadata"]) if obj.get("qualityMetadata") is not None else None,
            "runtimeAnnotations": [GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotation.from_dict(_item) for _item in obj["runtimeAnnotations"]] if obj.get("runtimeAnnotations") is not None else None,
            "startTime": obj.get("startTime"),
            "transcript": GoogleCloudContactcenterinsightsV1alpha1ConversationTranscript.from_dict(obj["transcript"]) if obj.get("transcript") is not None else None,
            "ttl": obj.get("ttl"),
