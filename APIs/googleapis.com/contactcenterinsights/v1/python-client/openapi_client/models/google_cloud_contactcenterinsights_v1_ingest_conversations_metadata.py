...
class GoogleCloudContactcenterinsightsV1IngestConversationsMetadata(BaseModel):
    ...
    ingest_conversations_stats: Optional[GoogleCloudContactcenterinsightsV1IngestConversationsMetadataIngestConversationsStats] = Field(default=None, alias="ingestConversationsStats")
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1IngestConversationsRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingestConversationsStats": GoogleCloudContactcenterinsightsV1IngestConversationsMetadataIngestConversationsStats.from_dict(obj["ingestConversationsStats"]) if obj.get("ingestConversationsStats") is not None else None,
            ...
            "request": GoogleCloudContactcenterinsightsV1IngestConversationsRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
