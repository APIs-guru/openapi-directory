...
class GoogleCloudContactcenterinsightsV1DeployIssueModelMetadata(BaseModel):
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1DeployIssueModelRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudContactcenterinsightsV1DeployIssueModelMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudContactcenterinsightsV1DeployIssueModelMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1DeployIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
