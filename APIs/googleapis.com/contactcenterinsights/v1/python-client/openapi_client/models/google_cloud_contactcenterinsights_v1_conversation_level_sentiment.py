...
class GoogleCloudContactcenterinsightsV1ConversationLevelSentiment(BaseModel):
    ...
    """ # noqa: E501
    channel_tag: Optional[StrictInt] = Field(default=None, description="The channel of the audio that the data applies to.", alias="channelTag")
    sentiment_data: Optional[GoogleCloudContactcenterinsightsV1SentimentData] = Field(default=None, alias="sentimentData")
    __properties: ClassVar[List[str]] = ["channelTag", "sentimentData"]
