...
class GoogleCloudContactcenterinsightsV1IngestConversationsRequest(BaseModel):
    ...
    """ # noqa: E501
    conversation_config: Optional[GoogleCloudContactcenterinsightsV1IngestConversationsRequestConversationConfig] = Field(default=None, alias="conversationConfig")
    gcs_source: Optional[GoogleCloudContactcenterinsightsV1IngestConversationsRequestGcsSource] = Field(default=None, alias="gcsSource")
    ...
    transcript_object_config: Optional[GoogleCloudContactcenterinsightsV1IngestConversationsRequestTranscriptObjectConfig] = Field(default=None, alias="transcriptObjectConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversationConfig": GoogleCloudContactcenterinsightsV1IngestConversationsRequestConversationConfig.from_dict(obj["conversationConfig"]) if obj.get("conversationConfig") is not None else None,
            "gcsSource": GoogleCloudContactcenterinsightsV1IngestConversationsRequestGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None,
            ...
            "transcriptObjectConfig": GoogleCloudContactcenterinsightsV1IngestConversationsRequestTranscriptObjectConfig.from_dict(obj["transcriptObjectConfig"]) if obj.get("transcriptObjectConfig") is not None else None
        })
        return _obj
