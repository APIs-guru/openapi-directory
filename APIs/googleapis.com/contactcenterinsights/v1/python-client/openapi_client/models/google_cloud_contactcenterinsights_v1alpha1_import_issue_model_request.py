...
class GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelRequest(BaseModel):
    """
    ...
    gcs_source: Optional[GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelRequestGcsSource] = Field(default=None, alias="gcsSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsSource": GoogleCloudContactcenterinsightsV1alpha1ImportIssueModelRequestGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None,
