...
class GoogleCloudContactcenterinsightsV1alpha1DeployIssueModelMetadata(BaseModel):
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1alpha1DeployIssueModelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1alpha1DeployIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
