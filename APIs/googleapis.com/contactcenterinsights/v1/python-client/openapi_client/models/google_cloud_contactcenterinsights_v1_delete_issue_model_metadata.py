...
class GoogleCloudContactcenterinsightsV1DeleteIssueModelMetadata(BaseModel):
    ...
    request: Optional[GoogleCloudContactcenterinsightsV1DeleteIssueModelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1DeleteIssueModelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
