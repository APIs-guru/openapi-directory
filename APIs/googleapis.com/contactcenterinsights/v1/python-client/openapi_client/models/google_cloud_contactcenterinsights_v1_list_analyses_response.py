...
class GoogleCloudContactcenterinsightsV1ListAnalysesResponse(BaseModel):
    ...
    """ # noqa: E501
    analyses: Optional[List[GoogleCloudContactcenterinsightsV1Analysis]] = Field(default=None, description="The analyses that match the request.")
    ...
    __properties: ClassVar[List[str]] = ["analyses", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analyses": [GoogleCloudContactcenterinsightsV1Analysis.from_dict(_item) for _item in obj["analyses"]] if obj.get("analyses") is not None else None,
