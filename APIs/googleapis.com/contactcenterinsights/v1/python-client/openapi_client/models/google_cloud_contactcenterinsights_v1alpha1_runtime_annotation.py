...
class GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotation(BaseModel):
    ...
    answer_feedback: Optional[GoogleCloudContactcenterinsightsV1alpha1AnswerFeedback] = Field(default=None, alias="answerFeedback")
    article_suggestion: Optional[GoogleCloudContactcenterinsightsV1alpha1ArticleSuggestionData] = Field(default=None, alias="articleSuggestion")
    conversation_summarization_suggestion: Optional[GoogleCloudContactcenterinsightsV1alpha1ConversationSummarizationSuggestionData] = Field(default=None, alias="conversationSummarizationSuggestion")
    ...
    dialogflow_interaction: Optional[GoogleCloudContactcenterinsightsV1alpha1DialogflowInteractionData] = Field(default=None, alias="dialogflowInteraction")
    end_boundary: Optional[GoogleCloudContactcenterinsightsV1alpha1AnnotationBoundary] = Field(default=None, alias="endBoundary")
    faq_answer: Optional[GoogleCloudContactcenterinsightsV1alpha1FaqAnswerData] = Field(default=None, alias="faqAnswer")
    smart_compose_suggestion: Optional[GoogleCloudContactcenterinsightsV1alpha1SmartComposeSuggestionData] = Field(default=None, alias="smartComposeSuggestion")
    smart_reply: Optional[GoogleCloudContactcenterinsightsV1alpha1SmartReplyData] = Field(default=None, alias="smartReply")
    start_boundary: Optional[GoogleCloudContactcenterinsightsV1alpha1AnnotationBoundary] = Field(default=None, alias="startBoundary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "answerFeedback": GoogleCloudContactcenterinsightsV1alpha1AnswerFeedback.from_dict(obj["answerFeedback"]) if obj.get("answerFeedback") is not None else None,
            "articleSuggestion": GoogleCloudContactcenterinsightsV1alpha1ArticleSuggestionData.from_dict(obj["articleSuggestion"]) if obj.get("articleSuggestion") is not None else None,
            "conversationSummarizationSuggestion": GoogleCloudContactcenterinsightsV1alpha1ConversationSummarizationSuggestionData.from_dict(obj["conversationSummarizationSuggestion"]) if obj.get("conversationSummarizationSuggestion") is not None else None,
            "createTime": obj.get("createTime"),
            "dialogflowInteraction": GoogleCloudContactcenterinsightsV1alpha1DialogflowInteractionData.from_dict(obj["dialogflowInteraction"]) if obj.get("dialogflowInteraction") is not None else None,
            "endBoundary": GoogleCloudContactcenterinsightsV1alpha1AnnotationBoundary.from_dict(obj["endBoundary"]) if obj.get("endBoundary") is not None else None,
            "faqAnswer": GoogleCloudContactcenterinsightsV1alpha1FaqAnswerData.from_dict(obj["faqAnswer"]) if obj.get("faqAnswer") is not None else None,
            "smartComposeSuggestion": GoogleCloudContactcenterinsightsV1alpha1SmartComposeSuggestionData.from_dict(obj["smartComposeSuggestion"]) if obj.get("smartComposeSuggestion") is not None else None,
            "smartReply": GoogleCloudContactcenterinsightsV1alpha1SmartReplyData.from_dict(obj["smartReply"]) if obj.get("smartReply") is not None else None,
            "startBoundary": GoogleCloudContactcenterinsightsV1alpha1AnnotationBoundary.from_dict(obj["startBoundary"]) if obj.get("startBoundary") is not None else None
        })
        return _obj
