...
class GoogleCloudContactcenterinsightsV1ExportIssueModelRequest(BaseModel):
    """
    Request to export an issue model.
    """ # noqa: E501
    gcs_destination: Optional[GoogleCloudContactcenterinsightsV1ExportIssueModelRequestGcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gcsDestination": GoogleCloudContactcenterinsightsV1ExportIssueModelRequestGcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None,
            "name": obj.get("name")
        })
        return _obj
