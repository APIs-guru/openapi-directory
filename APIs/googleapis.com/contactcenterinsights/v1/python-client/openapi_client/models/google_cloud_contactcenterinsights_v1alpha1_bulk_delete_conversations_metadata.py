...
class GoogleCloudContactcenterinsightsV1alpha1BulkDeleteConversationsMetadata(BaseModel):
    """
    ...
    partial_errors: Optional[List[GoogleRpcStatus]] = Field(default=None, description="Partial errors during bulk delete conversations operation that might cause the operation output to be incomplete.", alias="partialErrors")
    request: Optional[GoogleCloudContactcenterinsightsV1alpha1BulkDeleteConversationsRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": GoogleCloudContactcenterinsightsV1alpha1BulkDeleteConversationsRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
