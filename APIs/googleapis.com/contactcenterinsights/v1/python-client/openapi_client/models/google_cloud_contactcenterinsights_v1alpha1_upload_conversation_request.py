...
class GoogleCloudContactcenterinsightsV1alpha1UploadConversationRequest(BaseModel):
    ...
    """ # noqa: E501
    conversation: Optional[GoogleCloudContactcenterinsightsV1alpha1Conversation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversation": GoogleCloudContactcenterinsightsV1alpha1Conversation.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None,
