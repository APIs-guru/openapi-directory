...
class TestGoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata:
        """Test GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata`
        """
        model = GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata()
        if include_optional:
    ...
    def testGoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata(self):
        """Test GoogleCloudContactcenterinsightsV1AnalysisResultCallAnalysisMetadata"""
