...
class TestGoogleCloudContactcenterinsightsV1IngestConversationsRequest(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1IngestConversationsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1IngestConversationsRequest:
        """Test GoogleCloudContactcenterinsightsV1IngestConversationsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1IngestConversationsRequest`
        """
        model = GoogleCloudContactcenterinsightsV1IngestConversationsRequest()
        if include_optional:
    ...
    def testGoogleCloudContactcenterinsightsV1IngestConversationsRequest(self):
        """Test GoogleCloudContactcenterinsightsV1IngestConversationsRequest"""
