...
class TestGoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest:
        """Test GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest`
        """
        model = GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest()
        if include_optional:
    ...
    def testGoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest(self):
        """Test GoogleCloudContactcenterinsightsV1BulkAnalyzeConversationsRequest"""
