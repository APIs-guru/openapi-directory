...
class TestGoogleCloudContactcenterinsightsV1AnnotatorSelector(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1AnnotatorSelector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1AnnotatorSelector:
        """Test GoogleCloudContactcenterinsightsV1AnnotatorSelector
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1AnnotatorSelector`
        """
        model = GoogleCloudContactcenterinsightsV1AnnotatorSelector()
        if include_optional:
    ...
    def testGoogleCloudContactcenterinsightsV1AnnotatorSelector(self):
        """Test GoogleCloudContactcenterinsightsV1AnnotatorSelector"""
