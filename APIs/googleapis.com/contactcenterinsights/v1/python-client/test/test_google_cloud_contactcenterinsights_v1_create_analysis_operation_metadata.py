...
class TestGoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata:
        """Test GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata`
        """
        model = GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata()
        if include_optional:
            return GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata(
    ...
    def testGoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata(self):
        """Test GoogleCloudContactcenterinsightsV1CreateAnalysisOperationMetadata"""
