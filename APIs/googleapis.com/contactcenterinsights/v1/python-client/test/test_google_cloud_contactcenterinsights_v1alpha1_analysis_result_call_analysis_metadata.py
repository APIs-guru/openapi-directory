...
class TestGoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata:
        """Test GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata`
        """
        model = GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata()
        if include_optional:
    ...
    def testGoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata(self):
        """Test GoogleCloudContactcenterinsightsV1alpha1AnalysisResultCallAnalysisMetadata"""
