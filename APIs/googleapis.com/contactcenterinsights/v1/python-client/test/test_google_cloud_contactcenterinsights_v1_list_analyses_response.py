...
class TestGoogleCloudContactcenterinsightsV1ListAnalysesResponse(unittest.TestCase):
    """GoogleCloudContactcenterinsightsV1ListAnalysesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudContactcenterinsightsV1ListAnalysesResponse:
        """Test GoogleCloudContactcenterinsightsV1ListAnalysesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudContactcenterinsightsV1ListAnalysesResponse`
        """
        model = GoogleCloudContactcenterinsightsV1ListAnalysesResponse()
        if include_optional:
            return GoogleCloudContactcenterinsightsV1ListAnalysesResponse(
                analyses = [
                    openapi_client.models.google_cloud_contactcenterinsights_v1_analysis.GoogleCloudContactcenterinsightsV1Analysis(
    ...
    def testGoogleCloudContactcenterinsightsV1ListAnalysesResponse(self):
        """Test GoogleCloudContactcenterinsightsV1ListAnalysesResponse"""
