...
class TestListConfigsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfigsResponse:
        """Test ListConfigsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListConfigsResponse`
        """
        model = ListConfigsResponse()
        if include_optional:
            return ListConfigsResponse(
                configs = [
                    openapi_client.models.runtime_config.RuntimeConfig(
                        description = '', 
                        name = '', )
                    ],
                next_page_token = ''
