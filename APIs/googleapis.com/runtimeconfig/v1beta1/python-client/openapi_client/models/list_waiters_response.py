...
class ListWaitersResponse(BaseModel):
    ...
    waiters: Optional[List[Waiter]] = Field(default=None, description="Found waiters in the project.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "waiters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in waiters (list)
        _items = []
        if self.waiters:
            for _item_waiters in self.waiters:
                if _item_waiters:
                    _items.append(_item_waiters.to_dict())
            _dict['waiters'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "waiters": [Waiter.from_dict(_item) for _item in obj["waiters"]] if obj.get("waiters") is not None else None
        })
        return _obj
