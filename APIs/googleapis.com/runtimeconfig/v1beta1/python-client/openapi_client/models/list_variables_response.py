...
class ListVariablesResponse(BaseModel):
    ...
    variables: Optional[List[Variable]] = Field(default=None, description="A list of variables and their values. The order of returned variable objects is arbitrary.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "variables"]
