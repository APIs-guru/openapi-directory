...
class GoogleAdsHomeservicesLocalservicesV1AggregatorInfo(BaseModel):
    ...
    """ # noqa: E501
    aggregator_provider_id: Optional[StrictStr] = Field(default=None, description="Provider id (listed in aggregator system) which maps to a account id in GLS system.", alias="aggregatorProviderId")
    __properties: ClassVar[List[str]] = ["aggregatorProviderId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregatorProviderId": obj.get("aggregatorProviderId")
        })
        return _obj
