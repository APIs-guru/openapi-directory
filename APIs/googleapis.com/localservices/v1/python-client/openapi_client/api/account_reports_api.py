...
class AccountReportsApi:
    ...
    def localservices_account_reports_search(
        ...
        page_token: Annotated[Optional[StrictStr], Field(description="The `next_page_token` value returned from a previous request to SearchAccountReports that indicates where listing should continue. Optional.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="A query string for searching for account reports. Caller must provide a customer id of their MCC account with an associated Gaia Mint that allows read permission on their linked accounts. Search expressions are case insensitive. Example query: | Query | Description | |-------------------------|-----------------------------------------------| | manager_customer_id:123 | Get Account Report for Manager with id 123. | Required.")] = None,
        ...
        :type page_size: int
        :param page_token: The `next_page_token` value returned from a previous request to SearchAccountReports that indicates where listing should continue. Optional.
        :type page_token: str
        ...
        _param = self._localservices_account_reports_search_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleAdsHomeservicesLocalservicesV1SearchAccountReportsResponse",
        }
    ...
    @validate_call
    def localservices_account_reports_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def localservices_account_reports_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _localservices_account_reports_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/accountReports:search',
