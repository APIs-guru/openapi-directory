...
class HashesApi:
    ...
    def webrisk_hashes_search(
        ...
        hash_prefix: Annotated[Optional[StrictStr], Field(description="A hash prefix, consisting of the most significant 4-32 bytes of a SHA256 hash. For JSON requests, this field is base64-encoded. Note that if this parameter is provided by a URI, it must be encoded using the web safe base64 variant (RFC 4648).")] = None,
        ...
        :param hash_prefix: A hash prefix, consisting of the most significant 4-32 bytes of a SHA256 hash. For JSON requests, this field is base64-encoded. Note that if this parameter is provided by a URI, it must be encoded using the web safe base64 variant (RFC 4648).
        ...
        _param = self._webrisk_hashes_search_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudWebriskV1SearchHashesResponse",
        }
    ...
    @validate_call
    def webrisk_hashes_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def webrisk_hashes_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _webrisk_hashes_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if hash_prefix is not None:
            ...
            _query_params.append(('hashPrefix', hash_prefix))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/hashes:search',
