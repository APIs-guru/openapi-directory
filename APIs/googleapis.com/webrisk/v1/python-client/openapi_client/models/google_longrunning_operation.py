...
class GoogleLongrunningOperation(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Contains a `SubmitUriMetadata` object.")
    name: Optional[StrictStr] = Field(default=None, description="Matches the `/v1/{project-name}/operations/{operation-id}` pattern.")
