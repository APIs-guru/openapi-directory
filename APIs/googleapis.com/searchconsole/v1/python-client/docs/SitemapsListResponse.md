...
------------ | ------------- | ------------- | -------------
**sitemap** | [**List[WmxSitemap]**](WmxSitemap.md) | Contains detailed information about a specific URL submitted as a [sitemap](https://support.google.com/webmasters/answer/156184). | [optional] 
