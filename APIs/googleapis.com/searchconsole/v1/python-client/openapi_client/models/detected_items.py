...
class DetectedItems(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Item]] = Field(default=None, description="List of Rich Results items.")
    rich_result_type: Optional[StrictStr] = Field(default=None, description="Rich Results type", alias="richResultType")
    __properties: ClassVar[List[str]] = ["items", "richResultType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "richResultType": obj.get("richResultType")
        })
        return _obj
