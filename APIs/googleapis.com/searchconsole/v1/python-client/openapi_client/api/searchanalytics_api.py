...
class SearchanalyticsApi:
    ...
    def webmasters_searchanalytics_query(
        ...
        search_analytics_query_request: Optional[SearchAnalyticsQueryRequest] = None,
        ...
        :param search_analytics_query_request:
        :type search_analytics_query_request: SearchAnalyticsQueryRequest
        ...
        _param = self._webmasters_searchanalytics_query_serialize(
            site_url=site_url,
            xgafv=xgafv,
            ...
            search_analytics_query_request=search_analytics_query_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchAnalyticsQueryResponse",
        }
    ...
    @validate_call
    def webmasters_searchanalytics_query_with_http_info(
        self,
        site_url: Annotated[StrictStr, Field(description="The site's URL, including protocol. For example: `http://www.example.com/`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchAnalyticsQueryResponse]:
        """webmasters_searchanalytics_query
    ...
    @validate_call
    def webmasters_searchanalytics_query_without_preload_content(
        self,
        site_url: Annotated[StrictStr, Field(description="The site's URL, including protocol. For example: `http://www.example.com/`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _webmasters_searchanalytics_query_serialize(
        self,
        site_url,
        xgafv,
        access_token,
        ...
        if search_analytics_query_request is not None:
            _body_params = search_analytics_query_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webmasters/v3/sites/{siteUrl}/searchAnalytics/query',
