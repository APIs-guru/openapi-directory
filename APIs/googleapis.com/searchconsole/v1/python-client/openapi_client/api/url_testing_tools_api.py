...
class UrlTestingToolsApi:
    ...
    def searchconsole_url_testing_tools_mobile_friendly_test_run(
        ...
        run_mobile_friendly_test_request: Optional[RunMobileFriendlyTestRequest] = None,
        ...
        """searchconsole_url_testing_tools_mobile_friendly_test_run
        ...
        :param run_mobile_friendly_test_request:
        :type run_mobile_friendly_test_request: RunMobileFriendlyTestRequest
        ...
        _param = self._searchconsole_url_testing_tools_mobile_friendly_test_run_serialize(
            xgafv=xgafv,
            ...
            run_mobile_friendly_test_request=run_mobile_friendly_test_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RunMobileFriendlyTestResponse",
        }
    ...
    @validate_call
    def searchconsole_url_testing_tools_mobile_friendly_test_run_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RunMobileFriendlyTestResponse]:
        """searchconsole_url_testing_tools_mobile_friendly_test_run
    ...
    @validate_call
    def searchconsole_url_testing_tools_mobile_friendly_test_run_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _searchconsole_url_testing_tools_mobile_friendly_test_run_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        upload_protocol,
        upload_type,
        run_mobile_friendly_test_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if run_mobile_friendly_test_request is not None:
            _body_params = run_mobile_friendly_test_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/urlTestingTools/mobileFriendlyTest:run',
