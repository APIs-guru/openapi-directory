...
class SitesApi:
    ...
    def _webmasters_sites_add_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/webmasters/v3/sites/{siteUrl}',
    ...
    def webmasters_sites_delete(
        self,
        site_url: Annotated[StrictStr, Field(description="The URI of the property as defined in Search Console. **Examples:** `http://www.example.com/` or `sc-domain:example.com`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        :param site_url: The URI of the property as defined in Search Console. **Examples:** `http://www.example.com/` or `sc-domain:example.com`. (required)
        :type site_url: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
    ...
    def _webmasters_sites_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webmasters/v3/sites',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
