...
class V2GetKeyStringResponse(BaseModel):
    ...
    """ # noqa: E501
    key_string: Optional[StrictStr] = Field(default=None, description="An encrypted and signed value of the key.", alias="keyString")
    __properties: ClassVar[List[str]] = ["keyString"]
