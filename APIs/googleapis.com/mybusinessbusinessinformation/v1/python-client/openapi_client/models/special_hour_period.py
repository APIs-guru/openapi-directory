...
class SpecialHourPeriod(BaseModel):
    ...
    closed: Optional[StrictBool] = Field(default=None, description="Optional. If true, `end_date`, `open_time`, and `close_time` are ignored, and the date specified in `start_date` is treated as the location being closed for the entire day.")
    ...
    __properties: ClassVar[List[str]] = ["closeTime", "closed", "endDate", "openTime", "startDate"]
