...
class SearchGoogleLocationsResponse(BaseModel):
    ...
    """ # noqa: E501
    google_locations: Optional[List[GoogleLocation]] = Field(default=None, description="A collection of GoogleLocations that are potential matches to the specified request, listed in order from most to least accuracy.", alias="googleLocations")
    __properties: ClassVar[List[str]] = ["googleLocations"]
