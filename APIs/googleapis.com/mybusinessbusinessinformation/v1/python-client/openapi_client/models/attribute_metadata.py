...
class AttributeMetadata(BaseModel):
    ...
    """ # noqa: E501
    deprecated: Optional[StrictBool] = Field(default=None, description="If true, the attribute is deprecated and should no longer be used. If deprecated, updating this attribute will not result in an error, but updates will not be saved. At some point after being deprecated, the attribute will be removed entirely and it will become an error.")
    ...
    parent: Optional[StrictStr] = Field(default=None, description="The unique identifier for the attribute.")
    repeatable: Optional[StrictBool] = Field(default=None, description="If true, the attribute supports multiple values. If false, only a single value should be provided.")
    ...
    __properties: ClassVar[List[str]] = ["deprecated", "displayName", "groupDisplayName", "parent", "repeatable", "valueMetadata", "valueType"]
