...
class BatchGetCategoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    categories: Optional[List[Category]] = Field(default=None, description="Categories that match the GConcept ids provided in the request. They will not come in the same order as category ids in the request.")
