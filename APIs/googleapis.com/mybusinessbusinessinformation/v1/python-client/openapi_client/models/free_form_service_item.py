...
class FreeFormServiceItem(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Required. This field represents the category name (i.e. the category's stable ID). The `category` and `service_type_id` should match the possible combinations provided in the `Category` message.")
    label: Optional[Label] = None
    __properties: ClassVar[List[str]] = ["category", "label"]
