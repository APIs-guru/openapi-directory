...
class GoogleLocation(BaseModel):
    ...
    request_admin_rights_uri: Optional[StrictStr] = Field(default=None, description="A URL that will redirect the user to the request admin rights UI. This field is only present if the location has already been claimed by any user, including the current user.", alias="requestAdminRightsUri")
    __properties: ClassVar[List[str]] = ["location", "name", "requestAdminRightsUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "requestAdminRightsUri": obj.get("requestAdminRightsUri")
        })
        return _obj
