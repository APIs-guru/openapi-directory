...
class AttributesApi:
    ...
    def mybusinessbusinessinformation_attributes_list(
        ...
        category_name: Annotated[Optional[StrictStr], Field(description="The primary category stable ID to find available attributes. Must be of the format categories/{category_id}.")] = None,
        ...
        page_token: Annotated[Optional[StrictStr], Field(description="If specified, the next page of attribute metadata is retrieved.")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="Resource name of the location to look up available attributes. If this field is set, category_name, region_code, language_code and show_all are not required and must not be set.")] = None,
        region_code: Annotated[Optional[StrictStr], Field(description="The ISO 3166-1 alpha-2 country code to find available attributes.")] = None,
        show_all: Annotated[Optional[StrictBool], Field(description="Metadata for all available attributes are returned when this field is set to true, disregarding parent and category_name fields. language_code and region_code are required when show_all is set to true.")] = None,
        ...
        _param = self._mybusinessbusinessinformation_attributes_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def mybusinessbusinessinformation_attributes_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def mybusinessbusinessinformation_attributes_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _mybusinessbusinessinformation_attributes_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
