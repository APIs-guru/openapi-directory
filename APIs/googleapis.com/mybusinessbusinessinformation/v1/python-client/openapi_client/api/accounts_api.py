...
class AccountsApi:
    ...
    def mybusinessbusinessinformation_accounts_locations_create(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the account in which to create this location.")],
        ...
        request_id: Annotated[Optional[StrictStr], Field(description="Optional. A unique request ID for the server to detect duplicated requests. We recommend using UUIDs. Max length is 50 characters.")] = None,
        validate_only: Annotated[Optional[StrictBool], Field(description="Optional. If true, the request is validated without actually creating the location.")] = None,
        ...
        _param = self._mybusinessbusinessinformation_accounts_locations_create_serialize(
            parent=parent,
            xgafv=xgafv,
    ...
    @validate_call
    def mybusinessbusinessinformation_accounts_locations_create_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the account in which to create this location.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusinessbusinessinformation_accounts_locations_create_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the account in which to create this location.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusinessbusinessinformation_accounts_locations_create_serialize(
        self,
        parent,
        xgafv,
        access_token,
    ...
    def mybusinessbusinessinformation_accounts_locations_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Optional. A filter constraining the locations to return. The response includes only entries that match the filter. If `filter` is empty, then constraints are applied and all locations (paginated) are retrieved for the requested account. For more information about valid fields and example usage, see [Work with Location Data Guide](https://developers.google.com/my-business/content/location-data#filter_results_when_you_list_locations).")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Optional. Sorting order for the request. Multiple fields should be comma-separated, following SQL syntax. The default sorting order is ascending. To specify descending order, a suffix \" desc\" should be added. Valid fields to order_by are title and store_code. For example: \"title, store_code desc\" or \"title\" or \"store_code desc\"")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. How many locations to fetch per page. Default value is 10 if not set. Minimum is 1, and maximum page size is 100.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. If specified, it fetches the next `page` of locations. The page token is returned by previous calls to `ListLocations` when there were more locations than could fit in the requested page size.")] = None,
        ...
        _param = self._mybusinessbusinessinformation_accounts_locations_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def mybusinessbusinessinformation_accounts_locations_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the account to fetch locations from. If the parent Account is of AccountType PERSONAL, only Locations that are directly owned by the Account are returned, otherwise it will return all accessible locations from the Account, either directly or indirectly.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusinessbusinessinformation_accounts_locations_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the account to fetch locations from. If the parent Account is of AccountType PERSONAL, only Locations that are directly owned by the Account are returned, otherwise it will return all accessible locations from the Account, either directly or indirectly.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusinessbusinessinformation_accounts_locations_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
