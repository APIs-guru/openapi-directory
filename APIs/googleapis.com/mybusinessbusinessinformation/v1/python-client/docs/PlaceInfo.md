...
------------ | ------------- | ------------- | -------------
**place_id** | **str** | Required. The ID of the place. Must correspond to a region. (https://developers.google.com/places/web-service/supported_types#table3) | [optional] 
**place_name** | **str** | Required. The localized name of the place. For example, &#x60;Scottsdale, AZ&#x60;. | [optional] 
