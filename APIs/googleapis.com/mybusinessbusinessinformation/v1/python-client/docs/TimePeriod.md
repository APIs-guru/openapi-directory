...
------------ | ------------- | ------------- | -------------
**close_day** | **str** | Required. Indicates the day of the week this period ends on. | [optional] 
**close_time** | [**TimeOfDay**](TimeOfDay.md) |  | [optional] 
**open_day** | **str** | Required. Indicates the day of the week this period starts on. | [optional] 
