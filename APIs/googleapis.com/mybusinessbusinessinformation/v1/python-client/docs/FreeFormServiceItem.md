...
------------ | ------------- | ------------- | -------------
**category** | **str** | Required. This field represents the category name (i.e. the category&#39;s stable ID). The &#x60;category&#x60; and &#x60;service_type_id&#x60; should match the possible combinations provided in the &#x60;Category&#x60; message. | [optional] 
