...
------------ | ------------- | ------------- | -------------
**can_reopen** | **bool** | Output only. Indicates whether this business is eligible for re-open. | [optional] [readonly] 
**opening_date** | [**ModelDate**](ModelDate.md) |  | [optional] 
**status** | **str** | Required. Indicates whether or not the Location is currently open for business. All locations are open by default, unless updated to be closed. | [optional] 
