...
class SearchAds360FieldsApi:
    ...
    def searchads360_search_ads360_fields_get(
        self,
        resource_name: Annotated[StrictStr, Field(description="Required. The resource name of the field to get.")],
        ...
        :param resource_name: Required. The resource name of the field to get. (required)
        ...
        _param = self._searchads360_search_ads360_fields_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleAdsSearchads360V0ResourcesSearchAds360Field",
        }
    ...
    @validate_call
    def searchads360_search_ads360_fields_get_with_http_info(
        self,
        resource_name: Annotated[StrictStr, Field(description="Required. The resource name of the field to get.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def searchads360_search_ads360_fields_get_without_preload_content(
        self,
        resource_name: Annotated[StrictStr, Field(description="Required. The resource name of the field to get.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _searchads360_search_ads360_fields_get_serialize(
        self,
        resource_name,
        xgafv,
        access_token,
    ...
    def searchads360_search_ads360_fields_search(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        google_ads_searchads360_v0_services_search_search_ads360_fields_request: Optional[GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param google_ads_searchads360_v0_services_search_search_ads360_fields_request:
        :type google_ads_searchads360_v0_services_search_search_ads360_fields_request: GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._searchads360_search_ads360_fields_search_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            google_ads_searchads360_v0_services_search_search_ads360_fields_request=google_ads_searchads360_v0_services_search_search_ads360_fields_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def searchads360_search_ads360_fields_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def searchads360_search_ads360_fields_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _searchads360_search_ads360_fields_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        # process the form parameters
        # process the body parameter
        if google_ads_searchads360_v0_services_search_search_ads360_fields_request is not None:
            _body_params = google_ads_searchads360_v0_services_search_search_ads360_fields_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v0/searchAds360Fields:search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
