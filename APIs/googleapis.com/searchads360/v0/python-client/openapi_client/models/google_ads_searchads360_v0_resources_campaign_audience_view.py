...
class GoogleAdsSearchads360V0ResourcesCampaignAudienceView(BaseModel):
    ...
    """ # noqa: E501
    resource_name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the campaign audience view. Campaign audience view resource names have the form: `customers/{customer_id}/campaignAudienceViews/{campaign_id}~{criterion_id}`", alias="resourceName")
