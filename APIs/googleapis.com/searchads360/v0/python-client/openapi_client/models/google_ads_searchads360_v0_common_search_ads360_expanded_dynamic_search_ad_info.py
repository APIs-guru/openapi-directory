...
class GoogleAdsSearchads360V0CommonSearchAds360ExpandedDynamicSearchAdInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adTrackingId", "description1", "description2"]
