...
class GoogleAdsSearchads360V0CommonCustomParameter(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key matching the parameter tag name.")
    value: Optional[StrictStr] = Field(default=None, description="The value to be substituted.")
