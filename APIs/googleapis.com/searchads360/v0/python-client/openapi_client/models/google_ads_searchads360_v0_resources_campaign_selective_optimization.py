...
class GoogleAdsSearchads360V0ResourcesCampaignSelectiveOptimization(BaseModel):
    ...
    """ # noqa: E501
    conversion_actions: Optional[List[StrictStr]] = Field(default=None, description="The selected set of conversion actions for optimizing this campaign.", alias="conversionActions")
    __properties: ClassVar[List[str]] = ["conversionActions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversionActions": obj.get("conversionActions")
        })
        return _obj
