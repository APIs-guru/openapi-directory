...
class GoogleAdsSearchads360V0ServicesListCustomColumnsResponse(BaseModel):
    ...
    """ # noqa: E501
    custom_columns: Optional[List[GoogleAdsSearchads360V0ResourcesCustomColumn]] = Field(default=None, description="The CustomColumns owned by the provided customer.", alias="customColumns")
    __properties: ClassVar[List[str]] = ["customColumns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customColumns": [GoogleAdsSearchads360V0ResourcesCustomColumn.from_dict(_item) for _item in obj["customColumns"]] if obj.get("customColumns") is not None else None
        })
        return _obj
