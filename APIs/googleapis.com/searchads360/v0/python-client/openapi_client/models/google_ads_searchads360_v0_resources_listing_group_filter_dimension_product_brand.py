...
class GoogleAdsSearchads360V0ResourcesListingGroupFilterDimensionProductBrand(BaseModel):
    """
    Brand of the product.
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="String value of the product brand.")
