...
class GoogleAdsSearchads360V0ResourcesAdGroupAudienceView(BaseModel):
    ...
    """ # noqa: E501
    resource_name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the ad group audience view. Ad group audience view resource names have the form: `customers/{customer_id}/adGroupAudienceViews/{ad_group_id}~{criterion_id}`", alias="resourceName")
