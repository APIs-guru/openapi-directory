...
class TestGoogleCloudMlV1ListVersionsResponse(unittest.TestCase):
    """GoogleCloudMlV1ListVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudMlV1ListVersionsResponse:
        """Test GoogleCloudMlV1ListVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudMlV1ListVersionsResponse`
        """
        model = GoogleCloudMlV1ListVersionsResponse()
        if include_optional:
            return GoogleCloudMlV1ListVersionsResponse(
                next_page_token = '',
                versions = [
                    openapi_client.models.google_cloud_ml_v1__version.GoogleCloudMlV1__Version(
    ...
    def testGoogleCloudMlV1ListVersionsResponse(self):
        """Test GoogleCloudMlV1ListVersionsResponse"""
