...
class TestGoogleCloudMlV1ListJobsResponse(unittest.TestCase):
    """GoogleCloudMlV1ListJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudMlV1ListJobsResponse:
        """Test GoogleCloudMlV1ListJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudMlV1ListJobsResponse`
        """
        model = GoogleCloudMlV1ListJobsResponse()
        if include_optional:
            return GoogleCloudMlV1ListJobsResponse(
                jobs = [
                    openapi_client.models.google_cloud_ml_v1__job.GoogleCloudMlV1__Job(
                        create_time = '', 
                        end_time = '', 
                        error_message = '', 
                        etag = 'YQ==', 
    ...
    def testGoogleCloudMlV1ListJobsResponse(self):
        """Test GoogleCloudMlV1ListJobsResponse"""
