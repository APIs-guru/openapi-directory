...
class GoogleCloudMlV1StudyConfigMetricSpec(BaseModel):
    """
    Represents a metric to optimize.
    """ # noqa: E501
    goal: Optional[StrictStr] = Field(default=None, description="Required. The optimization goal of the metric.")
    metric: Optional[StrictStr] = Field(default=None, description="Required. The name of the metric.")
    __properties: ClassVar[List[str]] = ["goal", "metric"]
