...
class GoogleCloudMlV1StudyConfigParameterSpecCategoricalValueSpec(BaseModel):
    """
    GoogleCloudMlV1StudyConfigParameterSpecCategoricalValueSpec
    """ # noqa: E501
    values: Optional[List[StrictStr]] = Field(default=None, description="Must be specified if type is `CATEGORICAL`. The list of possible categories.")
