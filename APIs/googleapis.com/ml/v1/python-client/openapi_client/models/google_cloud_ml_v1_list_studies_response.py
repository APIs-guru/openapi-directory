...
class GoogleCloudMlV1ListStudiesResponse(BaseModel):
    """
    GoogleCloudMlV1ListStudiesResponse
    """ # noqa: E501
    studies: Optional[List[GoogleCloudMlV1Study]] = Field(default=None, description="The studies associated with the project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "studies": [GoogleCloudMlV1Study.from_dict(_item) for _item in obj["studies"]] if obj.get("studies") is not None else None
        })
        return _obj
