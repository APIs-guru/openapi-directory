...
class GoogleCloudMlV1CheckTrialEarlyStoppingStateResponse(BaseModel):
    """
    ...
    should_stop: Optional[StrictBool] = Field(default=None, description="True if the Trial should stop.", alias="shouldStop")
    start_time: Optional[StrictStr] = Field(default=None, description="The time at which the operation was started.", alias="startTime")
    __properties: ClassVar[List[str]] = ["endTime", "shouldStop", "startTime"]
