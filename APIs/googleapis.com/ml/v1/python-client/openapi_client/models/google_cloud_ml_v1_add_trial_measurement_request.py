...
class GoogleCloudMlV1AddTrialMeasurementRequest(BaseModel):
    """
    The request message for the AddTrialMeasurement service method.
    """ # noqa: E501
    measurement: Optional[GoogleCloudMlV1Measurement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "measurement": GoogleCloudMlV1Measurement.from_dict(obj["measurement"]) if obj.get("measurement") is not None else None
        })
        return _obj
