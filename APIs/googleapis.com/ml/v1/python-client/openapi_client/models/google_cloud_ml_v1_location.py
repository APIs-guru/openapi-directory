...
class GoogleCloudMlV1Location(BaseModel):
    """
    GoogleCloudMlV1Location
    """ # noqa: E501
    capabilities: Optional[List[GoogleCloudMlV1Capability]] = Field(default=None, description="Capabilities available in the location.")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["capabilities", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": [GoogleCloudMlV1Capability.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None,
            "name": obj.get("name")
        })
        return _obj
