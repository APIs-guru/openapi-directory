...
class Key(BaseModel):
    ...
    """ # noqa: E501
    effective_connection_type: Optional[StrictStr] = Field(default=None, description="The effective connection type is the general connection class that all users experienced for this record. This field uses the values [\"offline\", \"slow-2G\", \"2G\", \"3G\", \"4G\"] as specified in: https://wicg.github.io/netinfo/#effective-connection-types If the effective connection type is unspecified, then aggregated data over all effective connection types will be returned.", alias="effectiveConnectionType")
    ...
    url: Optional[StrictStr] = Field(default=None, description="Url specifies a specific url that this record is for. Note: When specifying a \"url\" only data for that specific url will be aggregated.")
    __properties: ClassVar[List[str]] = ["effectiveConnectionType", "formFactor", "origin", "url"]
