...
class TestMultiDailyMetricTimeSeries(unittest.TestCase):
    """MultiDailyMetricTimeSeries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiDailyMetricTimeSeries:
        """Test MultiDailyMetricTimeSeries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiDailyMetricTimeSeries`
        """
        model = MultiDailyMetricTimeSeries()
        if include_optional:
    ...
    def testMultiDailyMetricTimeSeries(self):
        """Test MultiDailyMetricTimeSeries"""
