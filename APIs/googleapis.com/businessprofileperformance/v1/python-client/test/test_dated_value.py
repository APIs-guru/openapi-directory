...
class TestDatedValue(unittest.TestCase):
    """DatedValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatedValue:
        """Test DatedValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatedValue`
        """
        model = DatedValue()
        if include_optional:
            return DatedValue(
