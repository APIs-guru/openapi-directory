...
class TestGetDailyMetricsTimeSeriesResponse(unittest.TestCase):
    """GetDailyMetricsTimeSeriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDailyMetricsTimeSeriesResponse:
        """Test GetDailyMetricsTimeSeriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDailyMetricsTimeSeriesResponse`
        """
        model = GetDailyMetricsTimeSeriesResponse()
        if include_optional:
    ...
    def testGetDailyMetricsTimeSeriesResponse(self):
        """Test GetDailyMetricsTimeSeriesResponse"""
