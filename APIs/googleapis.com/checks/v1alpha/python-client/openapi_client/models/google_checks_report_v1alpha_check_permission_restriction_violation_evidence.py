...
class GoogleChecksReportV1alphaCheckPermissionRestrictionViolationEvidence(BaseModel):
    """
    Evidence collected from permission restriction violation analysis.
    """ # noqa: E501
    permission_details: Optional[List[GoogleChecksReportV1alphaCheckPermissionRestrictionViolationEvidencePermissionDetails]] = Field(default=None, description="Permissions in violation.", alias="permissionDetails")
    __properties: ClassVar[List[str]] = ["permissionDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissionDetails": [GoogleChecksReportV1alphaCheckPermissionRestrictionViolationEvidencePermissionDetails.from_dict(_item) for _item in obj["permissionDetails"]] if obj.get("permissionDetails") is not None else None
        })
        return _obj
