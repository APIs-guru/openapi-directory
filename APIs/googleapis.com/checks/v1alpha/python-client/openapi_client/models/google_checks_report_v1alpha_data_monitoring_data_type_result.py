...
class GoogleChecksReportV1alphaDataMonitoringDataTypeResult(BaseModel):
    """
    Information about a data type that was found in your app.
    """ # noqa: E501
    data_type: Optional[StrictStr] = Field(default=None, description="The data type that was shared or collected by your app.", alias="dataType")
    data_type_evidence: Optional[GoogleChecksReportV1alphaDataTypeEvidence] = Field(default=None, alias="dataTypeEvidence")
    metadata: Optional[GoogleChecksReportV1alphaDataMonitoringResultMetadata] = None
    __properties: ClassVar[List[str]] = ["dataType", "dataTypeEvidence", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": GoogleChecksReportV1alphaDataMonitoringResultMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
