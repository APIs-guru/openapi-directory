...
class TestGoogleChecksReportV1alphaDataMonitoringDataTypeResult(unittest.TestCase):
    """GoogleChecksReportV1alphaDataMonitoringDataTypeResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleChecksReportV1alphaDataMonitoringDataTypeResult:
        """Test GoogleChecksReportV1alphaDataMonitoringDataTypeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleChecksReportV1alphaDataMonitoringDataTypeResult`
        """
        model = GoogleChecksReportV1alphaDataMonitoringDataTypeResult()
        if include_optional:
    ...
    def testGoogleChecksReportV1alphaDataMonitoringDataTypeResult(self):
        """Test GoogleChecksReportV1alphaDataMonitoringDataTypeResult"""
