...
class TestGoogleChecksReportV1alphaDataTypeEvidence(unittest.TestCase):
    """GoogleChecksReportV1alphaDataTypeEvidence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleChecksReportV1alphaDataTypeEvidence:
        """Test GoogleChecksReportV1alphaDataTypeEvidence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleChecksReportV1alphaDataTypeEvidence`
        """
        model = GoogleChecksReportV1alphaDataTypeEvidence()
        if include_optional:
    ...
    def testGoogleChecksReportV1alphaDataTypeEvidence(self):
        """Test GoogleChecksReportV1alphaDataTypeEvidence"""
