...
class TestGoogleChecksReportV1alphaDataTypeEndpointEvidence(unittest.TestCase):
    """GoogleChecksReportV1alphaDataTypeEndpointEvidence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleChecksReportV1alphaDataTypeEndpointEvidence:
        """Test GoogleChecksReportV1alphaDataTypeEndpointEvidence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleChecksReportV1alphaDataTypeEndpointEvidence`
        """
        model = GoogleChecksReportV1alphaDataTypeEndpointEvidence()
        if include_optional:
    ...
    def testGoogleChecksReportV1alphaDataTypeEndpointEvidence(self):
        """Test GoogleChecksReportV1alphaDataTypeEndpointEvidence"""
