...
google_cloud_discoveryengine_v1alpha_big_query_source_instance = GoogleCloudDiscoveryengineV1alphaBigQuerySource.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDiscoveryengineV1alphaBigQuerySource.to_json())

# convert the object into a dict
google_cloud_discoveryengine_v1alpha_big_query_source_dict = google_cloud_discoveryengine_v1alpha_big_query_source_instance.to_dict()
# create an instance of GoogleCloudDiscoveryengineV1alphaBigQuerySource from a dict
google_cloud_discoveryengine_v1alpha_big_query_source_from_dict = GoogleCloudDiscoveryengineV1alphaBigQuerySource.from_dict(google_cloud_discoveryengine_v1alpha_big_query_source_dict)
```
