...
**user_event** | [**GoogleCloudDiscoveryengineV1alphaUserEvent**](GoogleCloudDiscoveryengineV1alphaUserEvent.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudDiscoveryengineV1alphaRecommendRequest from a JSON string
google_cloud_discoveryengine_v1alpha_recommend_request_instance = GoogleCloudDiscoveryengineV1alphaRecommendRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDiscoveryengineV1alphaRecommendRequest.to_json())

# convert the object into a dict
google_cloud_discoveryengine_v1alpha_recommend_request_dict = google_cloud_discoveryengine_v1alpha_recommend_request_instance.to_dict()
# create an instance of GoogleCloudDiscoveryengineV1alphaRecommendRequest from a dict
google_cloud_discoveryengine_v1alpha_recommend_request_from_dict = GoogleCloudDiscoveryengineV1alphaRecommendRequest.from_dict(google_cloud_discoveryengine_v1alpha_recommend_request_dict)
```
