...
class TestGoogleCloudDiscoveryengineV1alphaUserEvent(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaUserEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaUserEvent:
        """Test GoogleCloudDiscoveryengineV1alphaUserEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaUserEvent`
        """
        model = GoogleCloudDiscoveryengineV1alphaUserEvent()
        if include_optional:
    ...
    def testGoogleCloudDiscoveryengineV1alphaUserEvent(self):
        """Test GoogleCloudDiscoveryengineV1alphaUserEvent"""
