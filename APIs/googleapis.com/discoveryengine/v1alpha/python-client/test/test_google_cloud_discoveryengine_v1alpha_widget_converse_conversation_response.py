...
class TestGoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse:
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse`
        """
        model = GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse(
                conversation_id = '',
                converse_conversation_response = openapi_client.models.google_cloud_discoveryengine_v1alpha_converse_conversation_response.GoogleCloudDiscoveryengineV1alphaConverseConversationResponse(
    ...
    def testGoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse(self):
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationResponse"""
