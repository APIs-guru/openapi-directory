...
class TestGoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec:
        """Test GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec`
        """
        model = GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec()
        if include_optional:
    ...
    def testGoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec(self):
        """Test GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec"""
