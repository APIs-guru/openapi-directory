...
class TestGoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource:
        """Test GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource`
        """
        model = GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource()
        if include_optional:
    ...
    def testGoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource(self):
        """Test GoogleCloudDiscoveryengineV1alphaImportUserEventsRequestInlineSource"""
