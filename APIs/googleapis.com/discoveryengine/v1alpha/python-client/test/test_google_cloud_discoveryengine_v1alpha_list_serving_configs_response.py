...
class TestGoogleCloudDiscoveryengineV1alphaListServingConfigsResponse(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse:
        """Test GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse`
        """
        model = GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse(
                next_page_token = '',
                serving_configs = [
                    openapi_client.models.google_cloud_discoveryengine_v1alpha_serving_config.GoogleCloudDiscoveryengineV1alphaServingConfig(
                        boost_control_ids = [
                            ''
                            ], 
                        create_time = '', 
    ...
    def testGoogleCloudDiscoveryengineV1alphaListServingConfigsResponse(self):
        """Test GoogleCloudDiscoveryengineV1alphaListServingConfigsResponse"""
