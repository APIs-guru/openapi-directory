...
class TestGoogleCloudDiscoveryengineV1alphaListDataStoresResponse(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaListDataStoresResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaListDataStoresResponse:
        """Test GoogleCloudDiscoveryengineV1alphaListDataStoresResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaListDataStoresResponse`
        """
        model = GoogleCloudDiscoveryengineV1alphaListDataStoresResponse()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaListDataStoresResponse(
                data_stores = [
                    openapi_client.models.google_cloud_discoveryengine_v1alpha_data_store.GoogleCloudDiscoveryengineV1alphaDataStore(
                        acl_enabled = True, 
    ...
    def testGoogleCloudDiscoveryengineV1alphaListDataStoresResponse(self):
        """Test GoogleCloudDiscoveryengineV1alphaListDataStoresResponse"""
