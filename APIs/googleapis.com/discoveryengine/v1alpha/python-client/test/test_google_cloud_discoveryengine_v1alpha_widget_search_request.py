...
class TestGoogleCloudDiscoveryengineV1alphaWidgetSearchRequest(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest:
        """Test GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest`
        """
        model = GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest(
                additional_params = openapi_client.models.google_cloud_discoveryengine_v1alpha_additional_params.GoogleCloudDiscoveryengineV1alphaAdditionalParams(
                    token = '', ),
                config_id = '',
                search_request = openapi_client.models.google_cloud_discoveryengine_v1alpha_search_request.GoogleCloudDiscoveryengineV1alphaSearchRequest(
    ...
    def testGoogleCloudDiscoveryengineV1alphaWidgetSearchRequest(self):
        """Test GoogleCloudDiscoveryengineV1alphaWidgetSearchRequest"""
