...
class TestGoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest:
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest`
        """
        model = GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest(
                ...
                config_id = '',
                conversation_id = '',
                converse_conversation_request = openapi_client.models.google_cloud_discoveryengine_v1alpha_converse_conversation_request.GoogleCloudDiscoveryengineV1alphaConverseConversationRequest(
    ...
    def testGoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest(self):
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConverseConversationRequest"""
