...
class TestGoogleCloudDiscoveryengineV1alphaWidgetConfig(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaWidgetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaWidgetConfig:
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaWidgetConfig`
        """
        model = GoogleCloudDiscoveryengineV1alphaWidgetConfig()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaWidgetConfig(
    ...
    def testGoogleCloudDiscoveryengineV1alphaWidgetConfig(self):
        """Test GoogleCloudDiscoveryengineV1alphaWidgetConfig"""
