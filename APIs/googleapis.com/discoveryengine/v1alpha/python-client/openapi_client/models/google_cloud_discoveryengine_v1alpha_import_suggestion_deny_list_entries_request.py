...
class GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesRequest(BaseModel):
    """
    ...
    inline_source: Optional[GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesRequestInlineSource] = Field(default=None, alias="inlineSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inlineSource": GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesRequestInlineSource.from_dict(obj["inlineSource"]) if obj.get("inlineSource") is not None else None
        })
        return _obj
