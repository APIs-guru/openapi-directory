...
class GoogleCloudDiscoveryengineV1alphaEstimateDataSizeResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    data_size_bytes: Optional[StrictStr] = Field(default=None, description="Data size in terms of bytes.", alias="dataSizeBytes")
    document_count: Optional[StrictStr] = Field(default=None, description="Total number of documents.", alias="documentCount")
    __properties: ClassVar[List[str]] = ["dataSizeBytes", "documentCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataSizeBytes": obj.get("dataSizeBytes"),
