...
class GoogleCloudDiscoveryengineV1DocumentProcessingConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    default_parsing_config: Optional[GoogleCloudDiscoveryengineV1DocumentProcessingConfigParsingConfig] = Field(default=None, alias="defaultParsingConfig")
    ...
    parsing_config_overrides: Optional[Dict[str, GoogleCloudDiscoveryengineV1DocumentProcessingConfigParsingConfig]] = Field(default=None, description="Map from file type to override the default parsing configuration based on the file type. Supported keys: * `pdf`: Override parsing config for PDF files, either digital parsing, ocr parsing or layout parsing is supported. * `html`: Override parsing config for HTML files, only digital parsing and or layout parsing are supported. * `docx`: Override parsing config for DOCX files, only digital parsing and or layout parsing are supported.", alias="parsingConfigOverrides")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultParsingConfig": GoogleCloudDiscoveryengineV1DocumentProcessingConfigParsingConfig.from_dict(obj["defaultParsingConfig"]) if obj.get("defaultParsingConfig") is not None else None,
            "name": obj.get("name"),
            "parsingConfigOverrides": dict(
                (_k, GoogleCloudDiscoveryengineV1DocumentProcessingConfigParsingConfig.from_dict(_v))
