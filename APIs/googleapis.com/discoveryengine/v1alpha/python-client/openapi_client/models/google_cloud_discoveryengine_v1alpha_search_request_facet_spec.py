...
class GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpec(BaseModel):
    """
    ...
    facet_key: Optional[GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey] = Field(default=None, alias="facetKey")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facetKey": GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.from_dict(obj["facetKey"]) if obj.get("facetKey") is not None else None,
            "limit": obj.get("limit")
        })
        return _obj
