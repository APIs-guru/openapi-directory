...
class GoogleCloudDiscoveryengineV1alphaSearchResponse(BaseModel):
    """
    ...
    facets: Optional[List[GoogleCloudDiscoveryengineV1alphaSearchResponseFacet]] = Field(default=None, description="Results of facets requested by user.")
    geo_search_debug_info: Optional[List[GoogleCloudDiscoveryengineV1alphaSearchResponseGeoSearchDebugInfo]] = Field(default=None, alias="geoSearchDebugInfo")
    guided_search_result: Optional[GoogleCloudDiscoveryengineV1alphaSearchResponseGuidedSearchResult] = Field(default=None, alias="guidedSearchResult")
    ...
    query_expansion_info: Optional[GoogleCloudDiscoveryengineV1alphaSearchResponseQueryExpansionInfo] = Field(default=None, alias="queryExpansionInfo")
    ...
    results: Optional[List[GoogleCloudDiscoveryengineV1alphaSearchResponseSearchResult]] = Field(default=None, description="A list of matched documents. The order represents the ranking.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facets": [GoogleCloudDiscoveryengineV1alphaSearchResponseFacet.from_dict(_item) for _item in obj["facets"]] if obj.get("facets") is not None else None,
            "geoSearchDebugInfo": [GoogleCloudDiscoveryengineV1alphaSearchResponseGeoSearchDebugInfo.from_dict(_item) for _item in obj["geoSearchDebugInfo"]] if obj.get("geoSearchDebugInfo") is not None else None,
            "guidedSearchResult": GoogleCloudDiscoveryengineV1alphaSearchResponseGuidedSearchResult.from_dict(obj["guidedSearchResult"]) if obj.get("guidedSearchResult") is not None else None,
            "nextPageToken": obj.get("nextPageToken"),
            "queryExpansionInfo": GoogleCloudDiscoveryengineV1alphaSearchResponseQueryExpansionInfo.from_dict(obj["queryExpansionInfo"]) if obj.get("queryExpansionInfo") is not None else None,
            "redirectUri": obj.get("redirectUri"),
            "results": [GoogleCloudDiscoveryengineV1alphaSearchResponseSearchResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
