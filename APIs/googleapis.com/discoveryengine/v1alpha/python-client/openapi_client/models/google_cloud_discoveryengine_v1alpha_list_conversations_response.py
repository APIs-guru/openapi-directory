...
class GoogleCloudDiscoveryengineV1alphaListConversationsResponse(BaseModel):
    """
    Response for ListConversations method.
    """ # noqa: E501
    conversations: Optional[List[GoogleCloudDiscoveryengineV1alphaConversation]] = Field(default=None, description="All the Conversations for a given data store.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [GoogleCloudDiscoveryengineV1alphaConversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
