...
class GoogleCloudDiscoveryengineV1DataStore(BaseModel):
    """
    ...
    document_processing_config: Optional[GoogleCloudDiscoveryengineV1DocumentProcessingConfig] = Field(default=None, alias="documentProcessingConfig")
    ...
    starting_schema: Optional[GoogleCloudDiscoveryengineV1Schema] = Field(default=None, alias="startingSchema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentProcessingConfig": GoogleCloudDiscoveryengineV1DocumentProcessingConfig.from_dict(obj["documentProcessingConfig"]) if obj.get("documentProcessingConfig") is not None else None,
            "industryVertical": obj.get("industryVertical"),
            "name": obj.get("name"),
            "solutionTypes": obj.get("solutionTypes"),
            "startingSchema": GoogleCloudDiscoveryengineV1Schema.from_dict(obj["startingSchema"]) if obj.get("startingSchema") is not None else None
        })
        return _obj
