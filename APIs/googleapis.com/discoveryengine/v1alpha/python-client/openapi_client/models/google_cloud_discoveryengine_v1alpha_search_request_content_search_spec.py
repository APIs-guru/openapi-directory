...
class GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpec(BaseModel):
    """
    A specification for configuring the behavior of content search.
    """ # noqa: E501
    extractive_content_spec: Optional[GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpecExtractiveContentSpec] = Field(default=None, alias="extractiveContentSpec")
    snippet_spec: Optional[GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpecSnippetSpec] = Field(default=None, alias="snippetSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extractiveContentSpec": GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpecExtractiveContentSpec.from_dict(obj["extractiveContentSpec"]) if obj.get("extractiveContentSpec") is not None else None,
            "snippetSpec": GoogleCloudDiscoveryengineV1alphaSearchRequestContentSearchSpecSnippetSpec.from_dict(obj["snippetSpec"]) if obj.get("snippetSpec") is not None else None,
