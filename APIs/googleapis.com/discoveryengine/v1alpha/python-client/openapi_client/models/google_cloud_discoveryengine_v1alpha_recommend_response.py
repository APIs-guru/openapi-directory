...
class GoogleCloudDiscoveryengineV1alphaRecommendResponse(BaseModel):
    """
    ...
    missing_ids: Optional[List[StrictStr]] = Field(default=None, description="IDs of documents in the request that were missing from the default Branch associated with the requested ServingConfig.", alias="missingIds")
    results: Optional[List[GoogleCloudDiscoveryengineV1alphaRecommendResponseRecommendationResult]] = Field(default=None, description="A list of recommended Documents. The order represents the ranking (from the most relevant Document to the least).")
    validate_only: Optional[StrictBool] = Field(default=None, description="True if RecommendRequest.validate_only was set.", alias="validateOnly")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GoogleCloudDiscoveryengineV1alphaRecommendResponseRecommendationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
