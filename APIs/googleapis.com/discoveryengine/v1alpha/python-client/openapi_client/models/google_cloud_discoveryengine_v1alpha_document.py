...
class GoogleCloudDiscoveryengineV1alphaDocument(BaseModel):
    """
    Document captures all raw metadata information of items to be recommended or searched.
    """ # noqa: E501
    acl_info: Optional[GoogleCloudDiscoveryengineV1alphaDocumentAclInfo] = Field(default=None, alias="aclInfo")
    content: Optional[GoogleCloudDiscoveryengineV1alphaDocumentContent] = None
    ...
    __properties: ClassVar[List[str]] = ["aclInfo", "content", "derivedStructData", "id", "indexTime", "jsonData", "name", "parentDocumentId", "schemaId", "structData"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of acl_info
        if self.acl_info:
            _dict['aclInfo'] = self.acl_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aclInfo": GoogleCloudDiscoveryengineV1alphaDocumentAclInfo.from_dict(obj["aclInfo"]) if obj.get("aclInfo") is not None else None,
            "content": GoogleCloudDiscoveryengineV1alphaDocumentContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
