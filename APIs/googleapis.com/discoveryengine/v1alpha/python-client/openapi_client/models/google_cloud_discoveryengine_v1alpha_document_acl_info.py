...
class GoogleCloudDiscoveryengineV1alphaDocumentAclInfo(BaseModel):
    """
    ACL Information of the Document.
    """ # noqa: E501
    readers: Optional[List[GoogleCloudDiscoveryengineV1alphaDocumentAclInfoAccessRestriction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "readers": [GoogleCloudDiscoveryengineV1alphaDocumentAclInfoAccessRestriction.from_dict(_item) for _item in obj["readers"]] if obj.get("readers") is not None else None
        })
        return _obj
