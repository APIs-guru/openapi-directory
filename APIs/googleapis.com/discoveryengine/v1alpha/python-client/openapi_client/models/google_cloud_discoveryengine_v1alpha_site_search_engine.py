...
class GoogleCloudDiscoveryengineV1alphaSiteSearchEngine(BaseModel):
    """
    SiteSearchEngine captures DataStore level site search persisting configurations. It is a singleton value per data store.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The fully qualified resource name of the site search engine. Format: `projects/*/locations/*/dataStores/*/siteSearchEngine`")
