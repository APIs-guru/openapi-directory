...
class GoogleCloudDiscoveryengineV1alphaConverseConversationResponse(BaseModel):
    """
    ...
    search_results: Optional[List[GoogleCloudDiscoveryengineV1alphaSearchResponseSearchResult]] = Field(default=None, description="Search Results.", alias="searchResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchResults": [GoogleCloudDiscoveryengineV1alphaSearchResponseSearchResult.from_dict(_item) for _item in obj["searchResults"]] if obj.get("searchResults") is not None else None
        })
        return _obj
