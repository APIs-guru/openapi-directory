...
class GoogleCloudDiscoveryengineV1ImportSuggestionDenyListEntriesResponse(BaseModel):
    """
    ...
    failed_entries_count: Optional[StrictStr] = Field(default=None, description="Count of deny list entries that failed to be imported.", alias="failedEntriesCount")
    imported_entries_count: Optional[StrictStr] = Field(default=None, description="Count of deny list entries successfully imported.", alias="importedEntriesCount")
    __properties: ClassVar[List[str]] = ["errorSamples", "failedEntriesCount", "importedEntriesCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failedEntriesCount": obj.get("failedEntriesCount"),
            "importedEntriesCount": obj.get("importedEntriesCount")
        })
        return _obj
