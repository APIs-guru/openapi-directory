...
class GoogleCloudDiscoveryengineV1alphaTargetSite(BaseModel):
    """
    ...
    failure_reason: Optional[GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason] = Field(default=None, alias="failureReason")
    ...
    site_verification_info: Optional[GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo] = Field(default=None, alias="siteVerificationInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failureReason": GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason.from_dict(obj["failureReason"]) if obj.get("failureReason") is not None else None,
            ...
            "siteVerificationInfo": GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo.from_dict(obj["siteVerificationInfo"]) if obj.get("siteVerificationInfo") is not None else None,
            "type": obj.get("type"),
