...
class GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey(BaseModel):
    """
    ...
    intervals: Optional[List[GoogleCloudDiscoveryengineV1betaInterval]] = Field(default=None, description="Set only if values should be bucketed into intervals. Must be set for facets with numerical values. Must not be set for facet with text values. Maximum number of intervals is 30.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intervals": [GoogleCloudDiscoveryengineV1betaInterval.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None,
            "key": obj.get("key"),
