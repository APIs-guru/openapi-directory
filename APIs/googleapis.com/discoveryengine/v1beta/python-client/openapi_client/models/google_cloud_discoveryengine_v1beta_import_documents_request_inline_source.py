...
class GoogleCloudDiscoveryengineV1betaImportDocumentsRequestInlineSource(BaseModel):
    ...
    """ # noqa: E501
    documents: Optional[List[GoogleCloudDiscoveryengineV1betaDocument]] = Field(default=None, description="Required. A list of documents to update/create. Each document must have a valid Document.id. Recommended max of 100 items.")
