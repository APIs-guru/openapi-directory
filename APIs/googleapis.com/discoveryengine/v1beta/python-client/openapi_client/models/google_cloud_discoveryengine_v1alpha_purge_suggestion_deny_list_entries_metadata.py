...
class GoogleCloudDiscoveryengineV1alphaPurgeSuggestionDenyListEntriesMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "updateTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDiscoveryengineV1alphaPurgeSuggestionDenyListEntriesMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDiscoveryengineV1alphaPurgeSuggestionDenyListEntriesMetadata from a dict"""
        if obj is None:
            return None
