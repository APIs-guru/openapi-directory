...
class GoogleCloudDiscoveryengineV1Engine(BaseModel):
    """
    Metadata that describes the training and serving parameters of an Engine.
    """ # noqa: E501
    chat_engine_config: Optional[GoogleCloudDiscoveryengineV1EngineChatEngineConfig] = Field(default=None, alias="chatEngineConfig")
    chat_engine_metadata: Optional[GoogleCloudDiscoveryengineV1EngineChatEngineMetadata] = Field(default=None, alias="chatEngineMetadata")
    common_config: Optional[GoogleCloudDiscoveryengineV1EngineCommonConfig] = Field(default=None, alias="commonConfig")
    ...
    search_engine_config: Optional[GoogleCloudDiscoveryengineV1EngineSearchEngineConfig] = Field(default=None, alias="searchEngineConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chatEngineConfig": GoogleCloudDiscoveryengineV1EngineChatEngineConfig.from_dict(obj["chatEngineConfig"]) if obj.get("chatEngineConfig") is not None else None,
            "chatEngineMetadata": GoogleCloudDiscoveryengineV1EngineChatEngineMetadata.from_dict(obj["chatEngineMetadata"]) if obj.get("chatEngineMetadata") is not None else None,
            "commonConfig": GoogleCloudDiscoveryengineV1EngineCommonConfig.from_dict(obj["commonConfig"]) if obj.get("commonConfig") is not None else None,
            "createTime": obj.get("createTime"),
            "dataStoreIds": obj.get("dataStoreIds"),
            "displayName": obj.get("displayName"),
            "industryVertical": obj.get("industryVertical"),
            "name": obj.get("name"),
            "searchEngineConfig": GoogleCloudDiscoveryengineV1EngineSearchEngineConfig.from_dict(obj["searchEngineConfig"]) if obj.get("searchEngineConfig") is not None else None,
