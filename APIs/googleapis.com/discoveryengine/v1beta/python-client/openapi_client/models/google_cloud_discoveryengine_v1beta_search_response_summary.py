...
class GoogleCloudDiscoveryengineV1betaSearchResponseSummary(BaseModel):
    """
    Summary of the top N search result specified by the summary spec.
    """ # noqa: E501
    safety_attributes: Optional[GoogleCloudDiscoveryengineV1betaSearchResponseSummarySafetyAttributes] = Field(default=None, alias="safetyAttributes")
    ...
    summary_with_metadata: Optional[GoogleCloudDiscoveryengineV1betaSearchResponseSummarySummaryWithMetadata] = Field(default=None, alias="summaryWithMetadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "safetyAttributes": GoogleCloudDiscoveryengineV1betaSearchResponseSummarySafetyAttributes.from_dict(obj["safetyAttributes"]) if obj.get("safetyAttributes") is not None else None,
            "summarySkippedReasons": obj.get("summarySkippedReasons"),
            "summaryText": obj.get("summaryText"),
            "summaryWithMetadata": GoogleCloudDiscoveryengineV1betaSearchResponseSummarySummaryWithMetadata.from_dict(obj["summaryWithMetadata"]) if obj.get("summaryWithMetadata") is not None else None
        })
        return _obj
