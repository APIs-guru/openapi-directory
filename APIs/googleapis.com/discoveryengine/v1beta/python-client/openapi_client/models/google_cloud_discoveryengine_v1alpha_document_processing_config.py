...
class GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    default_parsing_config: Optional[GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfigParsingConfig] = Field(default=None, alias="defaultParsingConfig")
    ...
    ocr_config: Optional[GoogleCloudDiscoveryengineV1alphaOcrConfig] = Field(default=None, alias="ocrConfig")
    parsing_config_overrides: Optional[Dict[str, GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfigParsingConfig]] = Field(default=None, description="Map from file type to override the default parsing configuration based on the file type. Supported keys: * `pdf`: Override parsing config for PDF files, either digital parsing, ocr parsing or layout parsing is supported. * `html`: Override parsing config for HTML files, only digital parsing and or layout parsing are supported. * `docx`: Override parsing config for DOCX files, only digital parsing and or layout parsing are supported.", alias="parsingConfigOverrides")
    __properties: ClassVar[List[str]] = ["defaultParsingConfig", "name", "ocrConfig", "parsingConfigOverrides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultParsingConfig": GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfigParsingConfig.from_dict(obj["defaultParsingConfig"]) if obj.get("defaultParsingConfig") is not None else None,
            "name": obj.get("name"),
            "ocrConfig": GoogleCloudDiscoveryengineV1alphaOcrConfig.from_dict(obj["ocrConfig"]) if obj.get("ocrConfig") is not None else None,
            "parsingConfigOverrides": dict(
                (_k, GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfigParsingConfig.from_dict(_v))
