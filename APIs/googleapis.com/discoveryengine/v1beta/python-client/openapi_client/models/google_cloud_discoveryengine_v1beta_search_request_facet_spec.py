...
class GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpec(BaseModel):
    ...
    facet_key: Optional[GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey] = Field(default=None, alias="facetKey")
    limit: Optional[StrictInt] = Field(default=None, description="Maximum of facet values that should be returned for this facet. If unspecified, defaults to 20. The maximum allowed value is 300. Values above 300 are coerced to 300. If this field is negative, an `INVALID_ARGUMENT` is returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "facetKey": GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey.from_dict(obj["facetKey"]) if obj.get("facetKey") is not None else None,
            "limit": obj.get("limit")
        })
        return _obj
