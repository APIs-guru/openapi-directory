...
class GoogleCloudDiscoveryengineV1betaReply(BaseModel):
    """
    Defines a reply message to user.
    """ # noqa: E501
    references: Optional[List[GoogleCloudDiscoveryengineV1betaReplyReference]] = Field(default=None, description="References in the reply.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "references": [GoogleCloudDiscoveryengineV1betaReplyReference.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None,
            "reply": obj.get("reply"),
