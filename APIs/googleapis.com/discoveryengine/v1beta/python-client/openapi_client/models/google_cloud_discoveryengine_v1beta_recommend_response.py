...
class GoogleCloudDiscoveryengineV1betaRecommendResponse(BaseModel):
    ...
    results: Optional[List[GoogleCloudDiscoveryengineV1betaRecommendResponseRecommendationResult]] = Field(default=None, description="A list of recommended Documents. The order represents the ranking (from the most relevant Document to the least).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GoogleCloudDiscoveryengineV1betaRecommendResponseRecommendationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
