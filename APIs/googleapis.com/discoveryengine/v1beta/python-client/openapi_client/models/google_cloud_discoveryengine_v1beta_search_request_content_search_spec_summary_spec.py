...
class GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpecSummarySpec(BaseModel):
    """
    ...
    model_prompt_spec: Optional[GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpecSummarySpecModelPromptSpec] = Field(default=None, alias="modelPromptSpec")
    model_spec: Optional[GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpecSummarySpecModelSpec] = Field(default=None, alias="modelSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modelPromptSpec": GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpecSummarySpecModelPromptSpec.from_dict(obj["modelPromptSpec"]) if obj.get("modelPromptSpec") is not None else None,
            "modelSpec": GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpecSummarySpecModelSpec.from_dict(obj["modelSpec"]) if obj.get("modelSpec") is not None else None,
