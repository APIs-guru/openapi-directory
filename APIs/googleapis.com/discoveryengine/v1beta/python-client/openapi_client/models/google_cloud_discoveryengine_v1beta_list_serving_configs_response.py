...
class GoogleCloudDiscoveryengineV1betaListServingConfigsResponse(BaseModel):
    """
    ...
    serving_configs: Optional[List[GoogleCloudDiscoveryengineV1betaServingConfig]] = Field(default=None, description="All the ServingConfigs for a given dataStore.", alias="servingConfigs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servingConfigs": [GoogleCloudDiscoveryengineV1betaServingConfig.from_dict(_item) for _item in obj["servingConfigs"]] if obj.get("servingConfigs") is not None else None
        })
        return _obj
