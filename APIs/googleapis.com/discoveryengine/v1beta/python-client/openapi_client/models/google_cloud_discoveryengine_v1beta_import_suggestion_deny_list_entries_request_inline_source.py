...
class GoogleCloudDiscoveryengineV1betaImportSuggestionDenyListEntriesRequestInlineSource(BaseModel):
    """
    The inline source for SuggestionDenyListEntry.
    """ # noqa: E501
    entries: Optional[List[GoogleCloudDiscoveryengineV1betaSuggestionDenyListEntry]] = Field(default=None, description="Required. A list of all denylist entries to import. Max of 1000 items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GoogleCloudDiscoveryengineV1betaSuggestionDenyListEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
