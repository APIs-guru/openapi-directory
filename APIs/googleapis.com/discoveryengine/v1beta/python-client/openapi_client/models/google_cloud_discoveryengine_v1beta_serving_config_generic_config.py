...
class GoogleCloudDiscoveryengineV1betaServingConfigGenericConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    content_search_spec: Optional[GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpec] = Field(default=None, alias="contentSearchSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contentSearchSpec": GoogleCloudDiscoveryengineV1betaSearchRequestContentSearchSpec.from_dict(obj["contentSearchSpec"]) if obj.get("contentSearchSpec") is not None else None
        })
        return _obj
