...
class GoogleCloudDiscoveryengineV1betaConverseConversationRequest(BaseModel):
    """
    Request message for ConversationalSearchService.ConverseConversation method.
    """ # noqa: E501
    boost_spec: Optional[GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpec] = Field(default=None, alias="boostSpec")
    ...
    query: Optional[GoogleCloudDiscoveryengineV1betaTextInput] = None
    ...
    __properties: ClassVar[List[str]] = ["boostSpec", "conversation", "filter", "query", "safeSearch", "servingConfig", "summarySpec", "userLabels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boostSpec": GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpec.from_dict(obj["boostSpec"]) if obj.get("boostSpec") is not None else None,
            ...
            "query": GoogleCloudDiscoveryengineV1betaTextInput.from_dict(obj["query"]) if obj.get("query") is not None else None,
