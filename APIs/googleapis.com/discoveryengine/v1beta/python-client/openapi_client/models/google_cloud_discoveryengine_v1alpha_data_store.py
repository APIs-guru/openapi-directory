...
class GoogleCloudDiscoveryengineV1alphaDataStore(BaseModel):
    """
    DataStore captures global settings and configs at the DataStore level.
    """ # noqa: E501
    acl_enabled: Optional[StrictBool] = Field(default=None, description="Immutable. Whether data in the DataStore has ACL information. If set to `true`, the source data must have ACL. ACL will be ingested when data is ingested by DocumentService.ImportDocuments methods. When ACL is enabled for the DataStore, Document can't be accessed by calling DocumentService.GetDocument or DocumentService.ListDocuments. Currently ACL is only supported in `GENERIC` industry vertical with non-`PUBLIC_WEBSITE` content config.", alias="aclEnabled")
    ...
    document_processing_config: Optional[GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfig] = Field(default=None, alias="documentProcessingConfig")
    ...
    starting_schema: Optional[GoogleCloudDiscoveryengineV1alphaSchema] = Field(default=None, alias="startingSchema")
    __properties: ClassVar[List[str]] = ["aclEnabled", "contentConfig", "createTime", "defaultSchemaId", "displayName", "documentProcessingConfig", "idpConfig", "industryVertical", "name", "solutionTypes", "startingSchema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentProcessingConfig": GoogleCloudDiscoveryengineV1alphaDocumentProcessingConfig.from_dict(obj["documentProcessingConfig"]) if obj.get("documentProcessingConfig") is not None else None,
            ...
            "startingSchema": GoogleCloudDiscoveryengineV1alphaSchema.from_dict(obj["startingSchema"]) if obj.get("startingSchema") is not None else None
        })
        return _obj
