...
class GoogleCloudDiscoveryengineLoggingSourceLocation(BaseModel):
    ...
    """ # noqa: E501
    function_name: Optional[StrictStr] = Field(default=None, description="Human-readable name of a function or method—for example, `google.cloud.discoveryengine.v1alpha.RecommendationService.Recommend`.", alias="functionName")
