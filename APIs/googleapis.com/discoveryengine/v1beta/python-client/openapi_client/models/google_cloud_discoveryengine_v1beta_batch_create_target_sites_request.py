...
class GoogleCloudDiscoveryengineV1betaBatchCreateTargetSitesRequest(BaseModel):
    """
    Request message for SiteSearchEngineService.BatchCreateTargetSites method.
    """ # noqa: E501
    requests: Optional[List[GoogleCloudDiscoveryengineV1betaCreateTargetSiteRequest]] = Field(default=None, description="Required. The request message specifying the resources to create. A maximum of 20 TargetSites can be created in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudDiscoveryengineV1betaCreateTargetSiteRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
