...
class GoogleCloudDiscoveryengineV1betaSearchResponseSummaryCitationMetadata(BaseModel):
    """
    Citation metadata.
    """ # noqa: E501
    citations: Optional[List[GoogleCloudDiscoveryengineV1betaSearchResponseSummaryCitation]] = Field(default=None, description="Citations for segments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "citations": [GoogleCloudDiscoveryengineV1betaSearchResponseSummaryCitation.from_dict(_item) for _item in obj["citations"]] if obj.get("citations") is not None else None
        })
        return _obj
