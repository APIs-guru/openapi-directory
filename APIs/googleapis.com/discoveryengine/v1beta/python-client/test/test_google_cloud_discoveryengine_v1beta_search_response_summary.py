...
class TestGoogleCloudDiscoveryengineV1betaSearchResponseSummary(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1betaSearchResponseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1betaSearchResponseSummary:
        """Test GoogleCloudDiscoveryengineV1betaSearchResponseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1betaSearchResponseSummary`
        """
        model = GoogleCloudDiscoveryengineV1betaSearchResponseSummary()
        if include_optional:
    ...
    def testGoogleCloudDiscoveryengineV1betaSearchResponseSummary(self):
        """Test GoogleCloudDiscoveryengineV1betaSearchResponseSummary"""
