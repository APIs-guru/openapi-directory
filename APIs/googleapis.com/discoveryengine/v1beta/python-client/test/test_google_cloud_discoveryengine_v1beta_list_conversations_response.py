...
class TestGoogleCloudDiscoveryengineV1betaListConversationsResponse(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1betaListConversationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1betaListConversationsResponse:
        """Test GoogleCloudDiscoveryengineV1betaListConversationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1betaListConversationsResponse`
        """
        model = GoogleCloudDiscoveryengineV1betaListConversationsResponse()
        if include_optional:
            return GoogleCloudDiscoveryengineV1betaListConversationsResponse(
                conversations = [
                    openapi_client.models.google_cloud_discoveryengine_v1beta_conversation.GoogleCloudDiscoveryengineV1betaConversation(
                        end_time = '', 
                        messages = [
    ...
    def testGoogleCloudDiscoveryengineV1betaListConversationsResponse(self):
        """Test GoogleCloudDiscoveryengineV1betaListConversationsResponse"""
