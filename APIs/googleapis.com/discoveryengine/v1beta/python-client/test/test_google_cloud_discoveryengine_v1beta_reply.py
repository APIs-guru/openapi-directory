...
class TestGoogleCloudDiscoveryengineV1betaReply(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1betaReply unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1betaReply:
        """Test GoogleCloudDiscoveryengineV1betaReply
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1betaReply`
        """
        model = GoogleCloudDiscoveryengineV1betaReply()
        if include_optional:
    ...
    def testGoogleCloudDiscoveryengineV1betaReply(self):
        """Test GoogleCloudDiscoveryengineV1betaReply"""
