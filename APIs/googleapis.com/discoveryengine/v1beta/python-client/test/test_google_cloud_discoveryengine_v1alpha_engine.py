...
class TestGoogleCloudDiscoveryengineV1alphaEngine(unittest.TestCase):
    """GoogleCloudDiscoveryengineV1alphaEngine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDiscoveryengineV1alphaEngine:
        """Test GoogleCloudDiscoveryengineV1alphaEngine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDiscoveryengineV1alphaEngine`
        """
        model = GoogleCloudDiscoveryengineV1alphaEngine()
        if include_optional:
            return GoogleCloudDiscoveryengineV1alphaEngine(
    ...
    def testGoogleCloudDiscoveryengineV1alphaEngine(self):
        """Test GoogleCloudDiscoveryengineV1alphaEngine"""
