...
**failure_reason** | [**GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason**](GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason.md) |  | [optional] 
...
**site_verification_info** | [**GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo**](GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudDiscoveryengineV1alphaTargetSite from a JSON string
google_cloud_discoveryengine_v1alpha_target_site_instance = GoogleCloudDiscoveryengineV1alphaTargetSite.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDiscoveryengineV1alphaTargetSite.to_json())

# convert the object into a dict
google_cloud_discoveryengine_v1alpha_target_site_dict = google_cloud_discoveryengine_v1alpha_target_site_instance.to_dict()
# create an instance of GoogleCloudDiscoveryengineV1alphaTargetSite from a dict
google_cloud_discoveryengine_v1alpha_target_site_from_dict = GoogleCloudDiscoveryengineV1alphaTargetSite.from_dict(google_cloud_discoveryengine_v1alpha_target_site_dict)
```
