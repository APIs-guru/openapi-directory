...
class SitesApi:
    ...
    def adexperiencereport_sites_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the site whose summary to get, e.g. `sites/http%3A%2F%2Fwww.google.com%2F`. Format: `sites/{site}`")],
        ...
        _param = self._adexperiencereport_sites_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def adexperiencereport_sites_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the site whose summary to get, e.g. `sites/http%3A%2F%2Fwww.google.com%2F`. Format: `sites/{site}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SiteSummaryResponse]:
        """adexperiencereport_sites_get
    ...
    @validate_call
    def adexperiencereport_sites_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the site whose summary to get, e.g. `sites/http%3A%2F%2Fwww.google.com%2F`. Format: `sites/{site}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _adexperiencereport_sites_get_serialize(
        self,
        name,
        xgafv,
        access_token,
