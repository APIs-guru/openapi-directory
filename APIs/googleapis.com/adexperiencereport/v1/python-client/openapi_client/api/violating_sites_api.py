...
class ViolatingSitesApi:
    ...
    def adexperiencereport_violating_sites_list(
        ...
        _param = self._adexperiencereport_violating_sites_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def adexperiencereport_violating_sites_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def adexperiencereport_violating_sites_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _adexperiencereport_violating_sites_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
