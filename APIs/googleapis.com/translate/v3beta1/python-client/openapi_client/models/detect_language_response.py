...
class DetectLanguageResponse(BaseModel):
    ...
    """ # noqa: E501
    languages: Optional[List[DetectedLanguage]] = Field(default=None, description="A list of detected languages sorted by detection confidence in descending order. The most probable language first.")
