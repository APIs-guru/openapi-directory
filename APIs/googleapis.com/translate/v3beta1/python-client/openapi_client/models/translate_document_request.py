...
class TranslateDocumentRequest(BaseModel):
    ...
    target_language_code: Optional[StrictStr] = Field(default=None, description="Required. The BCP-47 language code to use for translation of the input document, set to one of the language codes listed in Language Support.", alias="targetLanguageCode")
