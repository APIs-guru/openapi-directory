...
class TranslateTextRequest(BaseModel):
    ...
    """ # noqa: E501
    contents: Optional[List[StrictStr]] = Field(default=None, description="Required. The content of the input in string format. We recommend the total content be less than 30,000 codepoints. The max length of this field is 1024. Use BatchTranslateText for larger text.")
    ...
    target_language_code: Optional[StrictStr] = Field(default=None, description="Required. The ISO-639 language code to use for translation of the input text, set to one of the language codes listed in Language Support.", alias="targetLanguageCode")
    transliteration_config: Optional[TransliterationConfig] = Field(default=None, alias="transliterationConfig")
    __properties: ClassVar[List[str]] = ["contents", "glossaryConfig", "labels", "mimeType", "model", "sourceLanguageCode", "targetLanguageCode", "transliterationConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of transliteration_config
        if self.transliteration_config:
            _dict['transliterationConfig'] = self.transliteration_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transliterationConfig": TransliterationConfig.from_dict(obj["transliterationConfig"]) if obj.get("transliterationConfig") is not None else None
        })
        return _obj
