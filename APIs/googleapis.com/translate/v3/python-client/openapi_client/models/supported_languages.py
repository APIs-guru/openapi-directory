...
class SupportedLanguages(BaseModel):
    ...
    """ # noqa: E501
    languages: Optional[List[SupportedLanguage]] = Field(default=None, description="A list of supported language responses. This list contains an entry for each language the Translation API supports.")
