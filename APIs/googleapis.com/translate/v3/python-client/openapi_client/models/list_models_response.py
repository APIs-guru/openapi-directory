...
class ListModelsResponse(BaseModel):
    ...
    """ # noqa: E501
    models: Optional[List[Model]] = Field(default=None, description="The models read.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve next page of results. Pass this token to the page_token field in the ListModelsRequest to obtain the corresponding page.", alias="nextPageToken")
