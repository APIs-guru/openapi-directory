...
class DatasetInputConfig(BaseModel):
    ...
    """ # noqa: E501
    input_files: Optional[List[InputFile]] = Field(default=None, description="Files containing the sentence pairs to be imported to the dataset.", alias="inputFiles")
    __properties: ClassVar[List[str]] = ["inputFiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputFiles": [InputFile.from_dict(_item) for _item in obj["inputFiles"]] if obj.get("inputFiles") is not None else None
        })
        return _obj
