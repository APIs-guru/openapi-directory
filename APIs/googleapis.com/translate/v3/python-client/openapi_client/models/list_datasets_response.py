...
class ListDatasetsResponse(BaseModel):
    ...
    """ # noqa: E501
    datasets: Optional[List[Dataset]] = Field(default=None, description="The datasets read.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve next page of results. Pass this token to the page_token field in the ListDatasetsRequest to obtain the corresponding page.", alias="nextPageToken")
