...
class LanguagesApi:
    ...
    def language_languages_list(
        ...
        model: Annotated[Optional[StrictStr], Field(description="The model type for which supported languages should be returned.")] = None,
        target: Annotated[Optional[StrictStr], Field(description="The language to use to return localized, human readable names of supported languages.")] = None,
        ...
        :param model: The model type for which supported languages should be returned.
        :type model: str
        :param target: The language to use to return localized, human readable names of supported languages.
        :type target: str
        ...
        _param = self._language_languages_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def language_languages_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def language_languages_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _language_languages_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
