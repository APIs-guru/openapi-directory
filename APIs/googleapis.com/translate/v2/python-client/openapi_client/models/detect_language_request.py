...
class DetectLanguageRequest(BaseModel):
    ...
    """ # noqa: E501
    q: Optional[List[StrictStr]] = Field(default=None, description="The input text upon which to perform language detection. Repeat this parameter to perform language detection on multiple text inputs.")
