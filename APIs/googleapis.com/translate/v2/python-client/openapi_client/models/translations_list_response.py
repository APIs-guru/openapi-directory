...
class TranslationsListResponse(BaseModel):
    ...
    """ # noqa: E501
    translations: Optional[List[TranslationsResource]] = Field(default=None, description="Translations contains list of translation results of given text")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "translations": [TranslationsResource.from_dict(_item) for _item in obj["translations"]] if obj.get("translations") is not None else None
        })
        return _obj
