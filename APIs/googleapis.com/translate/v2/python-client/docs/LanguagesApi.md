...
------------- | ------------- | -------------
[**language_languages_list**](LanguagesApi.md#language_languages_list) | **GET** /v2/languages | 


# **language_languages_list**
> LanguagesListResponse language_languages_list(xgafv=xgafv, access_token=access_token, alt=alt, bearer_token=bearer_token, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pp=pp, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, model=model, target=target)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    model = 'model_example' # str | The model type for which supported languages should be returned. (optional)
    target = 'target_example' # str | The language to use to return localized, human readable names of supported languages. (optional)

    try:
        api_response = api_instance.language_languages_list(xgafv=xgafv, access_token=access_token, alt=alt, bearer_token=bearer_token, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pp=pp, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, model=model, target=target)
        print("The response of LanguagesApi->language_languages_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LanguagesApi->language_languages_list: %s\n" % e)
```
 ...
 **model** | **str**| The model type for which supported languages should be returned. | [optional] 
