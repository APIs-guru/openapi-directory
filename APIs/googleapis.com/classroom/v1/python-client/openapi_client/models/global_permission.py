...
class GlobalPermission(BaseModel):
    ...
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default=None, description="Permission value.")
    ...
    def permission_validate_enum(cls, value):
        ...
        if value not in set(['PERMISSION_UNSPECIFIED', 'CREATE_COURSE']):
            raise ValueError("must be one of enum values ('PERMISSION_UNSPECIFIED', 'CREATE_COURSE')")
        return value
