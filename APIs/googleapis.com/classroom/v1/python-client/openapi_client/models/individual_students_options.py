...
class IndividualStudentsOptions(BaseModel):
    ...
    """ # noqa: E501
    student_ids: Optional[List[StrictStr]] = Field(default=None, description="Identifiers for the students that have access to the coursework/announcement.", alias="studentIds")
    __properties: ClassVar[List[str]] = ["studentIds"]
