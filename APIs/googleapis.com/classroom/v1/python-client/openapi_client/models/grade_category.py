...
class GradeCategory(BaseModel):
    ...
    """ # noqa: E501
    default_grade_denominator: Optional[StrictInt] = Field(default=None, description="Default value of denominator. Only applicable when grade calculation type is TOTAL_POINTS.", alias="defaultGradeDenominator")
    id: Optional[StrictStr] = Field(default=None, description="ID of the grade category.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the grade category.")
    weight: Optional[StrictInt] = Field(default=None, description="The weight of the category average as part of overall average. A weight of 12.34% is represented as 123400 (100% is 1,000,000). The last two digits should always be zero since we use two decimal precision. Only applicable when grade calculation type is WEIGHTED_CATEGORIES.")
    __properties: ClassVar[List[str]] = ["defaultGradeDenominator", "id", "name", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultGradeDenominator": obj.get("defaultGradeDenominator"),
            "id": obj.get("id"),
            "name": obj.get("name"),
