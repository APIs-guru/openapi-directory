...
class CloudPubsubTopic(BaseModel):
    ...
    """ # noqa: E501
    topic_name: Optional[StrictStr] = Field(default=None, description="The `name` field of a Cloud Pub/Sub [Topic](https://cloud.google.com/pubsub/docs/reference/rest/v1/projects.topics#Topic).", alias="topicName")
