...
class Material(BaseModel):
    ...
    """ # noqa: E501
    drive_file: Optional[SharedDriveFile] = Field(default=None, alias="driveFile")
    form: Optional[Form] = None
    link: Optional[Link] = None
    youtube_video: Optional[YouTubeVideo] = Field(default=None, alias="youtubeVideo")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of youtube_video
        if self.youtube_video:
            _dict['youtubeVideo'] = self.youtube_video.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "driveFile": SharedDriveFile.from_dict(obj["driveFile"]) if obj.get("driveFile") is not None else None,
