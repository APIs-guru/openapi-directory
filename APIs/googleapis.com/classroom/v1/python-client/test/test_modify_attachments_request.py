...
class TestModifyAttachmentsRequest(unittest.TestCase):
    """ModifyAttachmentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModifyAttachmentsRequest:
        """Test ModifyAttachmentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModifyAttachmentsRequest`
        """
        model = ModifyAttachmentsRequest()
        if include_optional:
    ...
    def testModifyAttachmentsRequest(self):
        """Test ModifyAttachmentsRequest"""
