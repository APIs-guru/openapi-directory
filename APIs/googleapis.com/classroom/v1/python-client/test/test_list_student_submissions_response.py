...
class TestListStudentSubmissionsResponse(unittest.TestCase):
    """ListStudentSubmissionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListStudentSubmissionsResponse:
        """Test ListStudentSubmissionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListStudentSubmissionsResponse`
        """
        model = ListStudentSubmissionsResponse()
        if include_optional:
            return ListStudentSubmissionsResponse(
                next_page_token = '',
                student_submissions = [
                    openapi_client.models.student_submission.StudentSubmission(
                        alternate_link = '', 
    ...
    def testListStudentSubmissionsResponse(self):
        """Test ListStudentSubmissionsResponse"""
