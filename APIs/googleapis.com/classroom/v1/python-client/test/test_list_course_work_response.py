...
class TestListCourseWorkResponse(unittest.TestCase):
    """ListCourseWorkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCourseWorkResponse:
        """Test ListCourseWorkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCourseWorkResponse`
        """
        model = ListCourseWorkResponse()
        if include_optional:
            return ListCourseWorkResponse(
                course_work = [
                    openapi_client.models.course_work.CourseWork(
                        alternate_link = '', 
    ...
    def testListCourseWorkResponse(self):
        """Test ListCourseWorkResponse"""
