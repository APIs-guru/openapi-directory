...
class TestListCourseWorkMaterialResponse(unittest.TestCase):
    """ListCourseWorkMaterialResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCourseWorkMaterialResponse:
        """Test ListCourseWorkMaterialResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCourseWorkMaterialResponse`
        """
        model = ListCourseWorkMaterialResponse()
        if include_optional:
            return ListCourseWorkMaterialResponse(
                course_work_material = [
                    openapi_client.models.course_work_material.CourseWorkMaterial(
                        alternate_link = '', 
    ...
    def testListCourseWorkMaterialResponse(self):
        """Test ListCourseWorkMaterialResponse"""
