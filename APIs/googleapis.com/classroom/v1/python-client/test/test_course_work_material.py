...
class TestCourseWorkMaterial(unittest.TestCase):
    """CourseWorkMaterial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CourseWorkMaterial:
        """Test CourseWorkMaterial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CourseWorkMaterial`
        """
        model = CourseWorkMaterial()
        if include_optional:
    ...
    def testCourseWorkMaterial(self):
        """Test CourseWorkMaterial"""
