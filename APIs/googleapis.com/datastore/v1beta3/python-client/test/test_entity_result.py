...
class TestEntityResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EntityResult:
        """Test EntityResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityResult`
        """
        model = EntityResult()
        if include_optional:
            return EntityResult(
