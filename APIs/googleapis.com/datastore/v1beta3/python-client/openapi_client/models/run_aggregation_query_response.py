...
class RunAggregationQueryResponse(BaseModel):
    ...
    """ # noqa: E501
    batch: Optional[AggregationResultBatch] = None
    query: Optional[AggregationQuery] = None
    __properties: ClassVar[List[str]] = ["batch", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batch": AggregationResultBatch.from_dict(obj["batch"]) if obj.get("batch") is not None else None,
            "query": AggregationQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
