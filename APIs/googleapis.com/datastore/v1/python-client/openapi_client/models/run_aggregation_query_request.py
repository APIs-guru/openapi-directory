...
class RunAggregationQueryRequest(BaseModel):
    ...
    """ # noqa: E501
    aggregation_query: Optional[AggregationQuery] = Field(default=None, alias="aggregationQuery")
    ...
    __properties: ClassVar[List[str]] = ["aggregationQuery", "databaseId", "gqlQuery", "partitionId", "readOptions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of aggregation_query
        if self.aggregation_query:
            _dict['aggregationQuery'] = self.aggregation_query.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregationQuery": AggregationQuery.from_dict(obj["aggregationQuery"]) if obj.get("aggregationQuery") is not None else None,
