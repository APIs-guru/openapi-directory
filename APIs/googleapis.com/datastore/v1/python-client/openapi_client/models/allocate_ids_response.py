...
class AllocateIdsResponse(BaseModel):
    """
    The response for Datastore.AllocateIds.
    """ # noqa: E501
    keys: Optional[List[Key]] = Field(default=None, description="The keys specified in the request (in the same order), each with its key path completed with a newly allocated ID.")
