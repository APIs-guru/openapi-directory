...
class ArrayValue(BaseModel):
    ...
    An array value.
    """ # noqa: E501
    values: Optional[List[Value]] = Field(default=None, description="Values in the array. The order of values in an array is preserved as long as all values have identical settings for 'exclude_from_indexes'.")
