...
class LookupResponse(BaseModel):
    ...
    transaction: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="The identifier of the transaction that was started as part of this Lookup request. Set only when ReadOptions.new_transaction was set in LookupRequest.read_options.")
    __properties: ClassVar[List[str]] = ["deferred", "found", "missing", "readTime", "transaction"]
