...
------------ | ------------- | ------------- | -------------
**aggregate_properties** | [**Dict[str, Value]**](Value.md) | The result of the aggregation functions, ex: &#x60;COUNT(*) AS total_entities&#x60;. The key is the alias assigned to the aggregation function on input and the size of this map equals the number of aggregation functions in the query. | [optional] 
