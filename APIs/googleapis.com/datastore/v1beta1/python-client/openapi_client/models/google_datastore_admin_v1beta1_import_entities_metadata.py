...
class GoogleDatastoreAdminV1beta1ImportEntitiesMetadata(BaseModel):
    ...
    input_url: Optional[StrictStr] = Field(default=None, description="The location of the import metadata file. This will be the same value as the google.datastore.admin.v1beta1.ExportEntitiesResponse.output_url field.", alias="inputUrl")
