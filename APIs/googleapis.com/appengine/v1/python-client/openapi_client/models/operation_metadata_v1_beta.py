...
class OperationMetadataV1Beta(BaseModel):
    ...
    """ # noqa: E501
    create_version_metadata: Optional[CreateVersionMetadataV1Beta] = Field(default=None, alias="createVersionMetadata")
    ...
    method: Optional[StrictStr] = Field(default=None, description="API method that initiated this operation. Example: google.appengine.v1beta.Versions.CreateVersion.@OutputOnly")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createVersionMetadata": CreateVersionMetadataV1Beta.from_dict(obj["createVersionMetadata"]) if obj.get("createVersionMetadata") is not None else None,
