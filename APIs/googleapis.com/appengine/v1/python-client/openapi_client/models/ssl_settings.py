...
class SslSettings(BaseModel):
    ...
    def ssl_management_type_validate_enum(cls, value):
        ...
        if value not in set(['SSL_MANAGEMENT_TYPE_UNSPECIFIED', 'AUTOMATIC', 'MANUAL']):
            raise ValueError("must be one of enum values ('SSL_MANAGEMENT_TYPE_UNSPECIFIED', 'AUTOMATIC', 'MANUAL')")
        return value
