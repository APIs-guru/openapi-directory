...
class OperationMetadataV1(BaseModel):
    ...
    """ # noqa: E501
    create_version_metadata: Optional[CreateVersionMetadataV1] = Field(default=None, alias="createVersionMetadata")
    ...
    method: Optional[StrictStr] = Field(default=None, description="API method that initiated this operation. Example: google.appengine.v1.Versions.CreateVersion.@OutputOnly")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createVersionMetadata": CreateVersionMetadataV1.from_dict(obj["createVersionMetadata"]) if obj.get("createVersionMetadata") is not None else None,
