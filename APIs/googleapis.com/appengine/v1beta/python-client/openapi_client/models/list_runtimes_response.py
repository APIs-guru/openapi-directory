...
class ListRuntimesResponse(BaseModel):
    ...
    runtimes: Optional[List[Runtime]] = Field(default=None, description="The runtimes available to the requested application.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "runtimes"]
