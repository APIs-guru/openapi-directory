...
class AutomaticScaling(BaseModel):
    ...
    custom_metrics: Optional[List[CustomMetric]] = Field(default=None, description="Target scaling by user-provided metrics. Only applicable in the App Engine flexible environment.", alias="customMetrics")
    ...
    __properties: ClassVar[List[str]] = ["coolDownPeriod", "cpuUtilization", "customMetrics", "diskUtilization", "maxConcurrentRequests", "maxIdleInstances", "maxPendingLatency", "maxTotalInstances", "minIdleInstances", "minPendingLatency", "minTotalInstances", "networkUtilization", "requestUtilization", "standardSchedulerSettings"]
