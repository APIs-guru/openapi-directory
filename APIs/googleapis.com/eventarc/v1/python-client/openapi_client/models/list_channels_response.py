...
class ListChannelsResponse(BaseModel):
    ...
    """ # noqa: E501
    channels: Optional[List[Channel]] = Field(default=None, description="The requested channels, up to the number specified in `page_size`.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A page token that can be sent to `ListChannels` to request the next page. If this is empty, then there are no more pages.", alias="nextPageToken")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Unreachable resources, if any.")
    __properties: ClassVar[List[str]] = ["channels", "nextPageToken", "unreachable"]
