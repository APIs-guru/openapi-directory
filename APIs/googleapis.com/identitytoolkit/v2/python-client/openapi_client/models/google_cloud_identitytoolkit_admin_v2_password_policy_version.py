...
class GoogleCloudIdentitytoolkitAdminV2PasswordPolicyVersion(BaseModel):
    """
    The strength attributes for the password policy on the project.
    """ # noqa: E501
    custom_strength_options: Optional[GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions] = Field(default=None, alias="customStrengthOptions")
    ...
    __properties: ClassVar[List[str]] = ["customStrengthOptions", "schemaVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customStrengthOptions": GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions.from_dict(obj["customStrengthOptions"]) if obj.get("customStrengthOptions") is not None else None,
