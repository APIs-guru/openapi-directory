...
class GoogleCloudIdentitytoolkitAdminV2ForwardInboundCredentials(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[StrictBool] = Field(default=None, description="Whether to pass the user's OAuth identity provider's access token.", alias="accessToken")
    id_token: Optional[StrictBool] = Field(default=None, description="Whether to pass the user's OIDC identity provider's ID token.", alias="idToken")
    refresh_token: Optional[StrictBool] = Field(default=None, description="Whether to pass the user's OAuth identity provider's refresh token.", alias="refreshToken")
