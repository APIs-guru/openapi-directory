...
class GoogleCloudIdentitytoolkitAdminV2TotpMfaProviderConfig(BaseModel):
    ...
    """ # noqa: E501
    adjacent_intervals: Optional[StrictInt] = Field(default=None, description="The allowed number of adjacent intervals that will be used for verification to avoid clock skew.", alias="adjacentIntervals")
    __properties: ClassVar[List[str]] = ["adjacentIntervals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adjacentIntervals": obj.get("adjacentIntervals")
        })
        return _obj
