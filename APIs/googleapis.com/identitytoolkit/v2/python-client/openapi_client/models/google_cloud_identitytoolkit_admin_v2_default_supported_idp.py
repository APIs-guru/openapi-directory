...
class GoogleCloudIdentitytoolkitAdminV2DefaultSupportedIdp(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the Idp")
    idp_id: Optional[StrictStr] = Field(default=None, description="Id the of Idp", alias="idpId")
    __properties: ClassVar[List[str]] = ["description", "idpId"]
