...
class GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token to get the next page of results.", alias="nextPageToken")
    tenants: Optional[List[GoogleCloudIdentitytoolkitAdminV2Tenant]] = Field(default=None, description="A list of tenants under the given agent project.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "tenants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenants": [GoogleCloudIdentitytoolkitAdminV2Tenant.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
