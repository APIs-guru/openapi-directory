...
class GoogleCloudIdentitytoolkitV2FinalizeMfaTotpEnrollmentRequestInfo(BaseModel):
    ...
    verification_code: Optional[StrictStr] = Field(default=None, description="User-entered verification code.", alias="verificationCode")
    __properties: ClassVar[List[str]] = ["sessionInfo", "verificationCode"]
