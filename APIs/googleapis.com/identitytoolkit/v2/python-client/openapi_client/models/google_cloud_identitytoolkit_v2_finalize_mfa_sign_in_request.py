...
class GoogleCloudIdentitytoolkitV2FinalizeMfaSignInRequest(BaseModel):
    ...
    """ # noqa: E501
    mfa_enrollment_id: Optional[StrictStr] = Field(default=None, description="The MFA enrollment ID from the user's list of current MFA enrollments.", alias="mfaEnrollmentId")
    ...
    totp_verification_info: Optional[GoogleCloudIdentitytoolkitV2MfaTotpSignInRequestInfo] = Field(default=None, alias="totpVerificationInfo")
    __properties: ClassVar[List[str]] = ["mfaEnrollmentId", "mfaPendingCredential", "phoneVerificationInfo", "tenantId", "totpVerificationInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totpVerificationInfo": GoogleCloudIdentitytoolkitV2MfaTotpSignInRequestInfo.from_dict(obj["totpVerificationInfo"]) if obj.get("totpVerificationInfo") is not None else None
        })
        return _obj
