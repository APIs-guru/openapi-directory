...
class GoogleCloudIdentitytoolkitAdminV2RecaptchaKey(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The reCAPTCHA Enterprise key resource name, e.g. \"projects/{project}/keys/{key}\"")
    type: Optional[StrictStr] = Field(default=None, description="The client's platform type.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CLIENT_TYPE_UNSPECIFIED', 'WEB', 'IOS', 'ANDROID']):
            raise ValueError("must be one of enum values ('CLIENT_TYPE_UNSPECIFIED', 'WEB', 'IOS', 'ANDROID')")
        return value
