...
class GoogleCloudIdentitytoolkitAdminV2Inheritance(BaseModel):
    ...
    """ # noqa: E501
    email_sending_config: Optional[StrictBool] = Field(default=None, description="Whether to allow the tenant to inherit custom domains, email templates, and custom SMTP settings. If true, email sent from tenant will follow the project level email sending configurations. If false (by default), emails will go with the default settings with no customizations.", alias="emailSendingConfig")
    __properties: ClassVar[List[str]] = ["emailSendingConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailSendingConfig": obj.get("emailSendingConfig")
        })
        return _obj
