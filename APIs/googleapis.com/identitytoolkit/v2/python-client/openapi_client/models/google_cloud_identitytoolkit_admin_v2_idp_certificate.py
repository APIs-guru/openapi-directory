...
class GoogleCloudIdentitytoolkitAdminV2IdpCertificate(BaseModel):
    ...
    """ # noqa: E501
    x509_certificate: Optional[StrictStr] = Field(default=None, description="The x509 certificate", alias="x509Certificate")
    __properties: ClassVar[List[str]] = ["x509Certificate"]
