...
google_iam_v1_get_policy_options_instance = GoogleIamV1GetPolicyOptions.from_json(json)
# print the JSON string representation of the object
print(GoogleIamV1GetPolicyOptions.to_json())

# convert the object into a dict
google_iam_v1_get_policy_options_dict = google_iam_v1_get_policy_options_instance.to_dict()
# create an instance of GoogleIamV1GetPolicyOptions from a dict
google_iam_v1_get_policy_options_from_dict = GoogleIamV1GetPolicyOptions.from_dict(google_iam_v1_get_policy_options_dict)
```
