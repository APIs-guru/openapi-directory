...
class TestGoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig(unittest.TestCase):
    """GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig:
        """Test GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig`
        """
        model = GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig()
        if include_optional:
    ...
    def testGoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig(self):
        """Test GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig"""
