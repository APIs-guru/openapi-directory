...
class TestGoogleCloudIdentitytoolkitAdminV2ListTenantsResponse(unittest.TestCase):
    """GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse:
        """Test GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse`
        """
        model = GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse()
        if include_optional:
            return GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse(
                next_page_token = '',
                tenants = [
                    openapi_client.models.google_cloud_identitytoolkit_admin_v2_tenant.GoogleCloudIdentitytoolkitAdminV2Tenant(
    ...
    def testGoogleCloudIdentitytoolkitAdminV2ListTenantsResponse(self):
        """Test GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse"""
