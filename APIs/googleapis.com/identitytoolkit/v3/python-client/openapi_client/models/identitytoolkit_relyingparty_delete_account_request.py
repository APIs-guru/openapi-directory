...
class IdentitytoolkitRelyingpartyDeleteAccountRequest(BaseModel):
    """
    ...
    id_token: Optional[StrictStr] = Field(default=None, description="The GITKit token or STS id token of the authenticated user.", alias="idToken")
    local_id: Optional[StrictStr] = Field(default=None, description="The local ID of the user.", alias="localId")
    __properties: ClassVar[List[str]] = ["delegatedProjectNumber", "idToken", "localId"]
