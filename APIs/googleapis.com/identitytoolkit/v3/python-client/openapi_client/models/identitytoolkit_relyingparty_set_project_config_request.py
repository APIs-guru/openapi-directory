...
class IdentitytoolkitRelyingpartySetProjectConfigRequest(BaseModel):
    """
    ...
    authorized_domains: Optional[List[StrictStr]] = Field(default=None, description="Authorized domains for widget redirect.", alias="authorizedDomains")
    ...
    enable_anonymous_user: Optional[StrictBool] = Field(default=None, description="Whether to enable anonymous user.", alias="enableAnonymousUser")
    ...
    __properties: ClassVar[List[str]] = ["allowPasswordUser", "apiKey", "authorizedDomains", "changeEmailTemplate", "delegatedProjectNumber", "enableAnonymousUser", "idpConfig", "legacyResetPasswordTemplate", "resetPasswordTemplate", "useEmailSending", "verifyEmailTemplate"]
