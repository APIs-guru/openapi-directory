...
class IdentitytoolkitRelyingpartyVerifyCustomTokenRequest(BaseModel):
    """
    ...
    token: Optional[StrictStr] = Field(default=None, description="The custom token to verify")
    __properties: ClassVar[List[str]] = ["delegatedProjectNumber", "instanceId", "returnSecureToken", "token"]
