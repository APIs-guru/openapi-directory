...
class TestHttpRouteRouteAction(unittest.TestCase):
    """HttpRouteRouteAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HttpRouteRouteAction:
        """Test HttpRouteRouteAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HttpRouteRouteAction`
        """
        model = HttpRouteRouteAction()
        if include_optional:
    ...
    def testHttpRouteRouteAction(self):
        """Test HttpRouteRouteAction"""
