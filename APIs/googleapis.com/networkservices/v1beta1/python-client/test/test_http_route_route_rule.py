...
class TestHttpRouteRouteRule(unittest.TestCase):
    """HttpRouteRouteRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HttpRouteRouteRule:
        """Test HttpRouteRouteRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HttpRouteRouteRule`
        """
        model = HttpRouteRouteRule()
        if include_optional:
    ...
    def testHttpRouteRouteRule(self):
        """Test HttpRouteRouteRule"""
