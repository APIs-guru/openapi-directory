...
class TlsRouteRouteRule(BaseModel):
    ...
    """ # noqa: E501
    action: Optional[TlsRouteRouteAction] = None
    matches: Optional[List[TlsRouteRouteMatch]] = Field(default=None, description="Required. RouteMatch defines the predicate used to match requests to a given action. Multiple match types are \"OR\"ed for evaluation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": TlsRouteRouteAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "matches": [TlsRouteRouteMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
