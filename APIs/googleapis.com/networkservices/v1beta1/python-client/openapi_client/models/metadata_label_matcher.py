...
class MetadataLabelMatcher(BaseModel):
    ...
    metadata_labels: Optional[List[MetadataLabels]] = Field(default=None, description="The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria This list can have at most 64 entries. The list can be empty if the match criteria is MATCH_ANY, to specify a wildcard match (i.e this matches any client).", alias="metadataLabels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadataLabels": [MetadataLabels.from_dict(_item) for _item in obj["metadataLabels"]] if obj.get("metadataLabels") is not None else None
        })
        return _obj
