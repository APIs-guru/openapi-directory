...
class GrpcRouteFaultInjectionPolicy(BaseModel):
    ...
    """ # noqa: E501
    abort: Optional[GrpcRouteFaultInjectionPolicyAbort] = None
    delay: Optional[GrpcRouteFaultInjectionPolicyDelay] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abort": GrpcRouteFaultInjectionPolicyAbort.from_dict(obj["abort"]) if obj.get("abort") is not None else None,
            "delay": GrpcRouteFaultInjectionPolicyDelay.from_dict(obj["delay"]) if obj.get("delay") is not None else None
        })
        return _obj
