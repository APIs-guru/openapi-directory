...
class TestListGrpcRoutesResponse(unittest.TestCase):
    """ListGrpcRoutesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGrpcRoutesResponse:
        """Test ListGrpcRoutesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGrpcRoutesResponse`
        """
        model = ListGrpcRoutesResponse()
        if include_optional:
            return ListGrpcRoutesResponse(
                grpc_routes = [
                    openapi_client.models.grpc_route.GrpcRoute(
                        create_time = '', 
                        description = '', 
                        gateways = [
                            ''
                        ...
                        name = '', 
                        rules = [
                            openapi_client.models.grpc_route_route_rule.GrpcRouteRouteRule(
    ...
    def testListGrpcRoutesResponse(self):
        """Test ListGrpcRoutesResponse"""
