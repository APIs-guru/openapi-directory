...
class TestGrpcRoute(unittest.TestCase):
    """GrpcRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrpcRoute:
        """Test GrpcRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrpcRoute`
        """
        model = GrpcRoute()
        if include_optional:
            return GrpcRoute(
