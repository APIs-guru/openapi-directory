...
class TestHttpRouteRequestMirrorPolicy(unittest.TestCase):
    """HttpRouteRequestMirrorPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HttpRouteRequestMirrorPolicy:
        """Test HttpRouteRequestMirrorPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HttpRouteRequestMirrorPolicy`
        """
        model = HttpRouteRequestMirrorPolicy()
        if include_optional:
    ...
    def testHttpRouteRequestMirrorPolicy(self):
        """Test HttpRouteRequestMirrorPolicy"""
