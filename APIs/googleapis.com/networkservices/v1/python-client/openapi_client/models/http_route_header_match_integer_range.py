...
class HttpRouteHeaderMatchIntegerRange(BaseModel):
    ...
    """ # noqa: E501
    end: Optional[StrictInt] = Field(default=None, description="End of the range (exclusive)")
    start: Optional[StrictInt] = Field(default=None, description="Start of the range (inclusive)")
