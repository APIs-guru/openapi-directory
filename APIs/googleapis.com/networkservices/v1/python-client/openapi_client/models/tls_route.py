...
class TlsRoute(BaseModel):
    ...
    gateways: Optional[List[StrictStr]] = Field(default=None, description="Optional. Gateways defines a list of gateways this TlsRoute is attached to, as one of the routing rules to route the requests served by the gateway. Each gateway reference should match the pattern: `projects/*/locations/global/gateways/`")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Optional. Set of label tags associated with the TlsRoute resource.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Name of the TlsRoute resource. It matches pattern `projects/*/locations/global/tlsRoutes/tls_route_name>`.")
    rules: Optional[List[TlsRouteRouteRule]] = Field(default=None, description="Required. Rules that define how traffic is routed and handled. At least one RouteRule must be supplied. If there are multiple rules then the action taken will be the first rule to match.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rules": [TlsRouteRouteRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
