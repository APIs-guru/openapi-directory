...
class Lodging(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Google identifier for this location in the form: `locations/{location_id}/lodging`")
    ...
    __properties: ClassVar[List[str]] = ["accessibility", "activities", "allUnits", "business", "commonLivingArea", "connectivity", "families", "foodAndDrink", "guestUnits", "healthAndSafety", "housekeeping", "metadata", "name", "parking", "pets", "policies", "pools", "property", "services", "someUnits", "sustainability", "transportation", "wellness"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sustainability": Sustainability.from_dict(obj["sustainability"]) if obj.get("sustainability") is not None else None,
