...
class GoogleChromeManagementV1TelemetryNetworkConnectionStateChangeEvent(BaseModel):
    """
    ...
    """ # noqa: E501
    connection_state: Optional[StrictStr] = Field(default=None, description="Current connection state of the network.", alias="connectionState")
    guid: Optional[StrictStr] = Field(default=None, description="Unique identifier of the network.")
    __properties: ClassVar[List[str]] = ["connectionState", "guid"]
