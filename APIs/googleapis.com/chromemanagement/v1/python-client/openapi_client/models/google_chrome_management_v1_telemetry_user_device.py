...
class GoogleChromeManagementV1TelemetryUserDevice(BaseModel):
    ...
    device_activity_report: Optional[List[GoogleChromeManagementV1DeviceActivityReport]] = Field(default=None, description="Output only. Device activity reports collected periodically sorted in a decreasing order of report_time.", alias="deviceActivityReport")
    device_id: Optional[StrictStr] = Field(default=None, description="The unique Directory API ID of the device. This value is the same as the Admin Console's Directory API ID in the ChromeOS Devices tab.", alias="deviceId")
    ...
    __properties: ClassVar[List[str]] = ["audioStatusReport", "deviceActivityReport", "deviceId", "networkBandwidthReport", "peripheralsReport"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in device_activity_report (list)
        _items = []
        if self.device_activity_report:
            for _item_device_activity_report in self.device_activity_report:
                if _item_device_activity_report:
                    _items.append(_item_device_activity_report.to_dict())
            _dict['deviceActivityReport'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceActivityReport": [GoogleChromeManagementV1DeviceActivityReport.from_dict(_item) for _item in obj["deviceActivityReport"]] if obj.get("deviceActivityReport") is not None else None,
