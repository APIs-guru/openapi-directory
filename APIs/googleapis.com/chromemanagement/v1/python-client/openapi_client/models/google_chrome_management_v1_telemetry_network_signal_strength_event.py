...
class GoogleChromeManagementV1TelemetryNetworkSignalStrengthEvent(BaseModel):
    """
    ...
    signal_strength_dbm: Optional[StrictInt] = Field(default=None, description="Signal strength RSSI value.", alias="signalStrengthDbm")
    __properties: ClassVar[List[str]] = ["guid", "signalStrengthDbm"]
