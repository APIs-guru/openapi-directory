...
class GoogleChromeManagementV1TelemetryUserInfo(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Output only. User's email.")
    org_unit_id: Optional[StrictStr] = Field(default=None, description="Output only. Organization unit ID of the user.", alias="orgUnitId")
    __properties: ClassVar[List[str]] = ["email", "orgUnitId"]
