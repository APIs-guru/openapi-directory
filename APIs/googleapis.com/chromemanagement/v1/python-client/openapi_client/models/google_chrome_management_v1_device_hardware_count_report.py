...
class GoogleChromeManagementV1DeviceHardwareCountReport(BaseModel):
    ...
    """ # noqa: E501
    bucket: Optional[StrictStr] = Field(default=None, description="Public name of the hardware specification.")
    count: Optional[StrictStr] = Field(default=None, description="Count of devices with a unique hardware specification.")
