...
class GoogleChromeManagementV1TouchScreenInfo(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[GoogleChromeManagementV1TouchScreenDevice]] = Field(default=None, description="Output only. List of the internal touch screen devices.")
    touchpad_library: Optional[StrictStr] = Field(default=None, description="Output only. Touchpad library name used by the input stack.", alias="touchpadLibrary")
    __properties: ClassVar[List[str]] = ["devices", "touchpadLibrary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [GoogleChromeManagementV1TouchScreenDevice.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
            "touchpadLibrary": obj.get("touchpadLibrary")
        })
        return _obj
