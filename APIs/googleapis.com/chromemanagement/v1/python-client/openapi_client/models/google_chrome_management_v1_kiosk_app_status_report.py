...
class GoogleChromeManagementV1KioskAppStatusReport(BaseModel):
    """
    ...
    """ # noqa: E501
    app_id: Optional[StrictStr] = Field(default=None, description="App id of kiosk app for example \"mdmkkicfmmkgmpkmkdikhlbggogpicma\"", alias="appId")
    app_version: Optional[StrictStr] = Field(default=None, description="App version number of kiosk app for example \"1.10.118\"", alias="appVersion")
    report_time: Optional[StrictStr] = Field(default=None, description="Timestamp of when report was collected", alias="reportTime")
    __properties: ClassVar[List[str]] = ["appId", "appVersion", "reportTime"]
