...
class GoogleChromeManagementV1ListTelemetryDevicesResponse(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[GoogleChromeManagementV1TelemetryDevice]] = Field(default=None, description="Telemetry devices returned in the response.")
    ...
    __properties: ClassVar[List[str]] = ["devices", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [GoogleChromeManagementV1TelemetryDevice.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
