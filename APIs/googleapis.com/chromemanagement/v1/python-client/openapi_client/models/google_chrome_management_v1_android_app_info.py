...
class GoogleChromeManagementV1AndroidAppInfo(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[GoogleChromeManagementV1AndroidAppPermission]] = Field(default=None, description="Output only. Permissions requested by an Android app.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [GoogleChromeManagementV1AndroidAppPermission.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
