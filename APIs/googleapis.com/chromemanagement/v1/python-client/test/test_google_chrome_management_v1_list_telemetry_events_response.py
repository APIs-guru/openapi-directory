...
class TestGoogleChromeManagementV1ListTelemetryEventsResponse(unittest.TestCase):
    """GoogleChromeManagementV1ListTelemetryEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleChromeManagementV1ListTelemetryEventsResponse:
        """Test GoogleChromeManagementV1ListTelemetryEventsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleChromeManagementV1ListTelemetryEventsResponse`
        """
        model = GoogleChromeManagementV1ListTelemetryEventsResponse()
        if include_optional:
            return GoogleChromeManagementV1ListTelemetryEventsResponse(
                next_page_token = '',
                telemetry_events = [
                    openapi_client.models.google_chrome_management_v1_telemetry_event.GoogleChromeManagementV1TelemetryEvent(
    ...
    def testGoogleChromeManagementV1ListTelemetryEventsResponse(self):
        """Test GoogleChromeManagementV1ListTelemetryEventsResponse"""
