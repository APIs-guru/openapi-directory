...
class TestGoogleChromeManagementV1TelemetryDevice(unittest.TestCase):
    """GoogleChromeManagementV1TelemetryDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleChromeManagementV1TelemetryDevice:
        """Test GoogleChromeManagementV1TelemetryDevice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleChromeManagementV1TelemetryDevice`
        """
        model = GoogleChromeManagementV1TelemetryDevice()
        if include_optional:
    ...
    def testGoogleChromeManagementV1TelemetryDevice(self):
        """Test GoogleChromeManagementV1TelemetryDevice"""
