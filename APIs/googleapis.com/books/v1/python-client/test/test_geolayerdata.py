...
class TestGeolayerdata(unittest.TestCase):
    """Geolayerdata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Geolayerdata:
        """Test Geolayerdata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Geolayerdata`
        """
        model = Geolayerdata()
        if include_optional:
            return Geolayerdata(
