...
class TestDictionaryAnnotationdata(unittest.TestCase):
    """DictionaryAnnotationdata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DictionaryAnnotationdata:
        """Test DictionaryAnnotationdata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DictionaryAnnotationdata`
        """
        model = DictionaryAnnotationdata()
        if include_optional:
            return DictionaryAnnotationdata(
                annotation_type = '',
                data = openapi_client.models.dictlayerdata.Dictlayerdata(
    ...
    def testDictionaryAnnotationdata(self):
        """Test DictionaryAnnotationdata"""
