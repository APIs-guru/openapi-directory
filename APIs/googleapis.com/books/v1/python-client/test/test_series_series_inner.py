...
class TestSeriesSeriesInner(unittest.TestCase):
    """SeriesSeriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesSeriesInner:
        """Test SeriesSeriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesSeriesInner`
        """
        model = SeriesSeriesInner()
        if include_optional:
            return SeriesSeriesInner(
                banner_image_url = '',
    ...
    def testSeriesSeriesInner(self):
        """Test SeriesSeriesInner"""
