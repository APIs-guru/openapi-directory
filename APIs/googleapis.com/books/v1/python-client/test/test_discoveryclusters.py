...
class TestDiscoveryclusters(unittest.TestCase):
    """Discoveryclusters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Discoveryclusters:
        """Test Discoveryclusters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Discoveryclusters`
        """
        model = Discoveryclusters()
        if include_optional:
            return Discoveryclusters(
                clusters = [
                    openapi_client.models.discoveryclusters_clusters_inner.Discoveryclusters_clusters_inner(
                        banner_with_content_container = openapi_client.models.discoveryclusters_clusters_inner_banner_with_content_container.Discoveryclusters_clusters_inner_banner_with_content_container(
                            fill_color_argb = '', 
                            image_url = '', 
                            mask_color_argb = '', 
                            more_button_text = '', 
    ...
    def testDiscoveryclusters(self):
        """Test Discoveryclusters"""
