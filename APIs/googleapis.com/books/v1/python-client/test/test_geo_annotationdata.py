...
class TestGeoAnnotationdata(unittest.TestCase):
    """GeoAnnotationdata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoAnnotationdata:
        """Test GeoAnnotationdata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoAnnotationdata`
        """
        model = GeoAnnotationdata()
        if include_optional:
    ...
    def testGeoAnnotationdata(self):
        """Test GeoAnnotationdata"""
