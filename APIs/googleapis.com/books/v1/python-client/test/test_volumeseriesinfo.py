...
class TestVolumeseriesinfo(unittest.TestCase):
    """Volumeseriesinfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Volumeseriesinfo:
        """Test Volumeseriesinfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Volumeseriesinfo`
        """
        model = Volumeseriesinfo()
        if include_optional:
