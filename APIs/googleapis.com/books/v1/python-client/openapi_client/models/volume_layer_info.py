...
class VolumeLayerInfo(BaseModel):
    """
    What layers exist in this volume and high level information about them.
    """ # noqa: E501
    layers: Optional[List[VolumeLayerInfoLayersInner]] = Field(default=None, description="A layer should appear here if and only if the layer exists for this book.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "layers": [VolumeLayerInfoLayersInner.from_dict(_item) for _item in obj["layers"]] if obj.get("layers") is not None else None
        })
        return _obj
