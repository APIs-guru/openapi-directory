...
class Offers(BaseModel):
    ...
    Offers
    """ # noqa: E501
    items: Optional[List[OffersItemsInner]] = Field(default=None, description="A list of offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [OffersItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind")
        })
        return _obj
