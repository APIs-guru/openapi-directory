...
class Bookshelves(BaseModel):
    ...
    Bookshelves
    """ # noqa: E501
    items: Optional[List[Bookshelf]] = Field(default=None, description="A list of bookshelves.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Bookshelf.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind")
        })
        return _obj
