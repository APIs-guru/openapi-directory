...
class Geolayerdata(BaseModel):
    """
    Geolayerdata
    """ # noqa: E501
    common: Optional[GeolayerdataCommon] = None
    geo: Optional[GeolayerdataGeo] = None
    kind: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["common", "geo", "kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "common": GeolayerdataCommon.from_dict(obj["common"]) if obj.get("common") is not None else None,
            "geo": GeolayerdataGeo.from_dict(obj["geo"]) if obj.get("geo") is not None else None,
            "kind": obj.get("kind")
        })
        return _obj
