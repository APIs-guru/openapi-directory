...
class MetadataItemsInner(BaseModel):
    """
    MetadataItemsInner
    """ # noqa: E501
    download_url: Optional[StrictStr] = None
    encrypted_key: Optional[StrictStr] = None
    language: Optional[StrictStr] = None
    size: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["download_url", "encrypted_key", "language", "size", "version"]
