...
class Series(BaseModel):
    ...
    series: Optional[List[SeriesSeriesInner]] = None
    __properties: ClassVar[List[str]] = ["kind", "series"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "series": [SeriesSeriesInner.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
        return _obj
