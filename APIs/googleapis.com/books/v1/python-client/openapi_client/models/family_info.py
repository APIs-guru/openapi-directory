...
class FamilyInfo(BaseModel):
    ...
    membership: Optional[FamilyInfoMembership] = None
    __properties: ClassVar[List[str]] = ["kind", "membership"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "membership": FamilyInfoMembership.from_dict(obj["membership"]) if obj.get("membership") is not None else None
        })
        return _obj
