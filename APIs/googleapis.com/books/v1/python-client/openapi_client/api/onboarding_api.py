...
class OnboardingApi:
    ...
    @validate_call
    def books_onboarding_list_categories(
        self,
        ...
        locale: Annotated[Optional[StrictStr], Field(description="ISO-639-1 language and ISO-3166-1 country code. Default is en-US if unset.")] = None,
        ...
        :param locale: ISO-639-1 language and ISO-3166-1 country code. Default is en-US if unset.
        :type locale: str
        ...
        _param = self._books_onboarding_list_categories_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def books_onboarding_list_categories_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def books_onboarding_list_categories_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _books_onboarding_list_categories_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/books/v1/onboarding/listCategories',
    ...
    @validate_call
    def books_onboarding_list_category_volumes(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        category_id: Annotated[Optional[List[StrictStr]], Field(description="List of category ids requested.")] = None,
        locale: Annotated[Optional[StrictStr], Field(description="ISO-639-1 language and ISO-3166-1 country code. Default is en-US if unset.")] = None,
        max_allowed_maturity_rating: Annotated[Optional[StrictStr], Field(description="The maximum allowed maturity rating of returned volumes. Books with a higher maturity rating are filtered out.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of maximum results per page to be included in the response.")] = None,
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param category_id: List of category ids requested.
        :type category_id: List[str]
        :param locale: ISO-639-1 language and ISO-3166-1 country code. Default is en-US if unset.
        :type locale: str
        :param max_allowed_maturity_rating: The maximum allowed maturity rating of returned volumes. Books with a higher maturity rating are filtered out.
        :type max_allowed_maturity_rating: str
        :param page_size: Number of maximum results per page to be included in the response.
        :type page_size: int
        ...
        _param = self._books_onboarding_list_category_volumes_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def books_onboarding_list_category_volumes_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def books_onboarding_list_category_volumes_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _books_onboarding_list_category_volumes_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/books/v1/onboarding/listCategoryVolumes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
