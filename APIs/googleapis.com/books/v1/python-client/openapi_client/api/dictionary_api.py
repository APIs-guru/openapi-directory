...
class DictionaryApi:
    ...
    def books_dictionary_list_offline_metadata(
        self,
        cpksver: Annotated[StrictStr, Field(description="The device/version ID from which to request the data.")],
        ...
        :param cpksver: The device/version ID from which to request the data. (required)
        :type cpksver: str
        ...
        _param = self._books_dictionary_list_offline_metadata_serialize(
            cpksver=cpksver,
            xgafv=xgafv,
    ...
    @validate_call
    def books_dictionary_list_offline_metadata_with_http_info(
        self,
        cpksver: Annotated[StrictStr, Field(description="The device/version ID from which to request the data.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def books_dictionary_list_offline_metadata_without_preload_content(
        self,
        cpksver: Annotated[StrictStr, Field(description="The device/version ID from which to request the data.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _books_dictionary_list_offline_metadata_serialize(
        self,
        cpksver,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/books/v1/dictionary/listOfflineMetadata',
