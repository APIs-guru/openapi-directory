...
class Question(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Immutable. The unique name for the question. locations/*/questions/* This field will be ignored if set during question creation.")
    text: Optional[StrictStr] = Field(default=None, description="Required. The text of the question. It should contain at least three words and the total length should be greater than or equal to 10 characters. The maximum length is 4096 characters.")
