...
class TestListImageImportsResponse(unittest.TestCase):
    """ListImageImportsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListImageImportsResponse:
        """Test ListImageImportsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListImageImportsResponse`
        """
        model = ListImageImportsResponse()
        if include_optional:
            return ListImageImportsResponse(
                image_imports = [
                    openapi_client.models.image_import.ImageImport(
                        cloud_storage_uri = '', 
                        create_time = '', 
    ...
    def testListImageImportsResponse(self):
        """Test ListImageImportsResponse"""
