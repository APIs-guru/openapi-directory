...
class TestComputeEngineTargetDefaults(unittest.TestCase):
    """ComputeEngineTargetDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeEngineTargetDefaults:
        """Test ComputeEngineTargetDefaults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeEngineTargetDefaults`
        """
        model = ComputeEngineTargetDefaults()
        if include_optional:
    ...
    def testComputeEngineTargetDefaults(self):
        """Test ComputeEngineTargetDefaults"""
