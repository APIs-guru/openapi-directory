...
class TestListDatacenterConnectorsResponse(unittest.TestCase):
    """ListDatacenterConnectorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDatacenterConnectorsResponse:
        """Test ListDatacenterConnectorsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDatacenterConnectorsResponse`
        """
        model = ListDatacenterConnectorsResponse()
        if include_optional:
            return ListDatacenterConnectorsResponse(
                datacenter_connectors = [
                    openapi_client.models.datacenter_connector.DatacenterConnector(
    ...
    def testListDatacenterConnectorsResponse(self):
        """Test ListDatacenterConnectorsResponse"""
