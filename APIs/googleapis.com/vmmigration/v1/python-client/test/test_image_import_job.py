...
class TestImageImportJob(unittest.TestCase):
    """ImageImportJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageImportJob:
        """Test ImageImportJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageImportJob`
        """
