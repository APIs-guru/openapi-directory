...
class TestListUtilizationReportsResponse(unittest.TestCase):
    """ListUtilizationReportsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListUtilizationReportsResponse:
        """Test ListUtilizationReportsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListUtilizationReportsResponse`
        """
        model = ListUtilizationReportsResponse()
        if include_optional:
            return ListUtilizationReportsResponse(
                ...
                utilization_reports = [
                    openapi_client.models.utilization_report.UtilizationReport(
                        create_time = '', 
                        display_name = '', 
    ...
    def testListUtilizationReportsResponse(self):
        """Test ListUtilizationReportsResponse"""
