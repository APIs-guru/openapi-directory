...
class CloneStep(BaseModel):
    ...
    """ # noqa: E501
    adapting_os: Optional[Dict[str, Any]] = Field(default=None, description="AdaptingOSStep contains specific step details.", alias="adaptingOs")
    ...
    __properties: ClassVar[List[str]] = ["adaptingOs", "endTime", "instantiatingMigratedVm", "preparingVmDisks", "startTime"]
