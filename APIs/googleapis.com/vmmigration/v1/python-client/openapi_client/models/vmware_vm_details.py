...
class VmwareVmDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bootOption", "committedStorageMb", "cpuCount", "datacenterDescription", "datacenterId", "diskCount", "displayName", "guestDescription", "memoryMb", "powerState", "uuid", "vmId"]
