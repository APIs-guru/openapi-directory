...
class AzureVmsDetails(BaseModel):
    """
    AzureVmsDetails describes VMs in Azure.
    """ # noqa: E501
    details: Optional[List[AzureVmDetails]] = Field(default=None, description="The details of the Azure VMs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [AzureVmDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
