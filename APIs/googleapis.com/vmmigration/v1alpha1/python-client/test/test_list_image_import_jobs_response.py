...
class TestListImageImportJobsResponse(unittest.TestCase):
    """ListImageImportJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListImageImportJobsResponse:
        """Test ListImageImportJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListImageImportJobsResponse`
        """
        model = ListImageImportJobsResponse()
        if include_optional:
    ...
    def testListImageImportJobsResponse(self):
        """Test ListImageImportJobsResponse"""
