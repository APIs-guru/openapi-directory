...
class TestComputeEngineTargetDetails(unittest.TestCase):
    """ComputeEngineTargetDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeEngineTargetDetails:
        """Test ComputeEngineTargetDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeEngineTargetDetails`
        """
        model = ComputeEngineTargetDetails()
        if include_optional:
    ...
    def testComputeEngineTargetDetails(self):
        """Test ComputeEngineTargetDetails"""
