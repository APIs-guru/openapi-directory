...
class TestAzureVmsDetails(unittest.TestCase):
    """AzureVmsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AzureVmsDetails:
        """Test AzureVmsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AzureVmsDetails`
        """
        model = AzureVmsDetails()
        if include_optional:
