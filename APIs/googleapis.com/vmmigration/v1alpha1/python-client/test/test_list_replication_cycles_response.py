...
class TestListReplicationCyclesResponse(unittest.TestCase):
    """ListReplicationCyclesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListReplicationCyclesResponse:
        """Test ListReplicationCyclesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListReplicationCyclesResponse`
        """
        model = ListReplicationCyclesResponse()
        if include_optional:
            return ListReplicationCyclesResponse(
                next_page_token = '',
                replication_cycles = [
                    openapi_client.models.replication_cycle.ReplicationCycle(
                        cycle_number = 56, 
                        end_time = '', 
    ...
    def testListReplicationCyclesResponse(self):
        """Test ListReplicationCyclesResponse"""
