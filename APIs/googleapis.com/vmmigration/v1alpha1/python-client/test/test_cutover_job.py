...
class TestCutoverJob(unittest.TestCase):
    """CutoverJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CutoverJob:
        """Test CutoverJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CutoverJob`
        """
        model = CutoverJob()
        if include_optional:
            return CutoverJob(
