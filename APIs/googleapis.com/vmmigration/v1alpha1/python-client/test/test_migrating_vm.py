...
class TestMigratingVm(unittest.TestCase):
    """MigratingVm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MigratingVm:
        """Test MigratingVm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MigratingVm`
        """
        model = MigratingVm()
        if include_optional:
            return MigratingVm(
                ...
                state = 'STATE_UNSPECIFIED',
                state_time = '',
                target_defaults = openapi_client.models.target_vm_details.TargetVMDetails(
                    applied_license = openapi_client.models.applied_license.AppliedLicense(
                        os_license = '', 
                        type = 'TYPE_UNSPECIFIED', ), 
                    boot_option = 'BOOT_OPTION_UNSPECIFIED', 
