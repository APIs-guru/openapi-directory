...
class TestListCutoverJobsResponse(unittest.TestCase):
    """ListCutoverJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCutoverJobsResponse:
        """Test ListCutoverJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCutoverJobsResponse`
        """
        model = ListCutoverJobsResponse()
        if include_optional:
            return ListCutoverJobsResponse(
                cutover_jobs = [
                    openapi_client.models.cutover_job.CutoverJob(
                        ...
                        state_time = '', 
                        steps = [
                            openapi_client.models.cutover_step.CutoverStep(
                                end_time = '', 
                        ...
                        target_details = openapi_client.models.target_vm_details.TargetVMDetails(
                            boot_option = 'BOOT_OPTION_UNSPECIFIED', 
                            disk_type = 'DISK_TYPE_UNSPECIFIED', 
                            external_ip = '', 
                            internal_ip = '', 
    ...
    def testListCutoverJobsResponse(self):
        """Test ListCutoverJobsResponse"""
