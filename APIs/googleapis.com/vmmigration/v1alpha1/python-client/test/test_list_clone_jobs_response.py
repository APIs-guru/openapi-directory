...
class TestListCloneJobsResponse(unittest.TestCase):
    """ListCloneJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCloneJobsResponse:
        """Test ListCloneJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCloneJobsResponse`
        """
        model = ListCloneJobsResponse()
        if include_optional:
    ...
    def testListCloneJobsResponse(self):
        """Test ListCloneJobsResponse"""
