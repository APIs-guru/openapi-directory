...
class MigratingVm(BaseModel):
    ...
    compute_engine_vm_defaults: Optional[TargetVMDetails] = Field(default=None, alias="computeEngineVmDefaults")
    ...
    target_defaults: Optional[TargetVMDetails] = Field(default=None, alias="targetDefaults")
    ...
    __properties: ClassVar[List[str]] = ["awsSourceVmDetails", "azureSourceVmDetails", "computeEngineDisksTargetDefaults", "computeEngineTargetDefaults", "computeEngineVmDefaults", "createTime", "currentSyncInfo", "cutoverForecast", "description", "displayName", "error", "group", "labels", "lastReplicationCycle", "lastSync", "name", "policy", "recentCloneJobs", "recentCutoverJobs", "sourceVmId", "state", "stateTime", "targetDefaults", "updateTime", "vmwareSourceVmDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of compute_engine_vm_defaults
        if self.compute_engine_vm_defaults:
            _dict['computeEngineVmDefaults'] = self.compute_engine_vm_defaults.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of target_defaults
        if self.target_defaults:
            _dict['targetDefaults'] = self.target_defaults.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "computeEngineVmDefaults": TargetVMDetails.from_dict(obj["computeEngineVmDefaults"]) if obj.get("computeEngineVmDefaults") is not None else None,
            ...
            "targetDefaults": TargetVMDetails.from_dict(obj["targetDefaults"]) if obj.get("targetDefaults") is not None else None,
