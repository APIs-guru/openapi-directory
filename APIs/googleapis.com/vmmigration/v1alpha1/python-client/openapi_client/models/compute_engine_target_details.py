...
class ComputeEngineTargetDetails(BaseModel):
    ...
    boot_option: Optional[StrictStr] = Field(default=None, description="The VM Boot Option, as set in the source VM.", alias="bootOption")
    ...
    project: Optional[StrictStr] = Field(default=None, description="The Google Cloud target project ID or project name.")
    ...
    __properties: ClassVar[List[str]] = ["additionalLicenses", "appliedLicense", "bootOption", "computeScheduling", "diskType", "encryption", "hostname", "labels", "licenseType", "machineType", "machineTypeSeries", "metadata", "networkInterfaces", "networkTags", "project", "secureBoot", "serviceAccount", "vmName", "zone"]
