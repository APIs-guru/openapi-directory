...
class AwsVmsDetails(BaseModel):
    ...
    """ # noqa: E501
    details: Optional[List[AwsVmDetails]] = Field(default=None, description="The details of the AWS VMs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [AwsVmDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
