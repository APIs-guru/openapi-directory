...
class CutoverJob(BaseModel):
    ...
    progress: Optional[StrictInt] = Field(default=None, description="Output only. The current progress in percentage of the cutover job.")
    ...
    __properties: ClassVar[List[str]] = ["computeEngineDisksTargetDetails", "computeEngineTargetDetails", "computeEngineVmDetails", "createTime", "endTime", "error", "name", "progress", "progressPercent", "state", "stateMessage", "stateTime", "steps", "targetDetails"]
