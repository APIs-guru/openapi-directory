...
class UtilizationReport(BaseModel):
    ...
    vms_count: Optional[StrictInt] = Field(default=None, description="Output only. Total number of VMs included in the report.", alias="vmsCount")
    __properties: ClassVar[List[str]] = ["createTime", "displayName", "error", "frameEndTime", "name", "state", "stateTime", "timeFrame", "vmCount", "vms", "vmsCount"]
