...
class PlayersApi:
    ...
    def games_players_get(
        ...
        player_id_consistency_token: Annotated[Optional[StrictStr], Field(description="Consistency token of the player id. The call returns a 'not found' result when the token is present and invalid. Empty value is ignored. See also GlobalPlayerIdConsistencyTokenProto")] = None,
        ...
        _param = self._games_players_get_serialize(
            player_id=player_id,
            xgafv=xgafv,
            ...
            language=language,
            player_id_consistency_token=player_id_consistency_token,
    ...
    @validate_call
    def games_players_get_with_http_info(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def games_players_get_without_preload_content(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_players_get_serialize(
        self,
        player_id,
        xgafv,
        access_token,
        ...
        if player_id_consistency_token is not None:
            
            _query_params.append(('playerIdConsistencyToken', player_id_consistency_token))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/{playerId}',
    ...
    def games_players_get_multiple_application_player_ids(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        application_ids: Annotated[Optional[List[StrictStr]], Field(description="Required. The application IDs from the Google Play developer console for the games to return scoped ids for.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._games_players_get_multiple_application_player_ids_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetMultipleApplicationPlayerIdsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def games_players_get_multiple_application_player_ids_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def games_players_get_multiple_application_player_ids_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _games_players_get_multiple_application_player_ids_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/me/multipleApplicationPlayerIds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def games_players_get_scoped_player_ids(
        ...
        _param = self._games_players_get_scoped_player_ids_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def games_players_get_scoped_player_ids_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def games_players_get_scoped_player_ids_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _games_players_get_scoped_player_ids_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/me/scopedIds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def games_players_list(
        self,
        collection: Annotated[StrictStr, Field(description="Collection of players being retrieved")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        _param = self._games_players_list_serialize(
    ...
    @validate_call
    def games_players_list_with_http_info(
        self,
        collection: Annotated[StrictStr, Field(description="Collection of players being retrieved")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def games_players_list_without_preload_content(
        self,
        collection: Annotated[StrictStr, Field(description="Collection of players being retrieved")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_players_list_serialize(
        self,
        collection,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/me/players/{collection}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
