...
class RevisionsApi:
    ...
    def games_revisions_check(
        ...
        :param client_revision: Required. The revision of the client SDK used by your application. Format: `[PLATFORM_TYPE]:[VERSION_NUMBER]`. Possible values of `PLATFORM_TYPE` are: * `ANDROID` - Client is running the Android SDK. * `IOS` - Client is running the iOS SDK. * `WEB_APP` - Client is running as a Web App. (required)
        :type client_revision: str
        ...
        _param = self._games_revisions_check_serialize(
    ...
    @validate_call
    def games_revisions_check_with_http_info(
        self,
        client_revision: Annotated[StrictStr, Field(description="Required. The revision of the client SDK used by your application. Format: `[PLATFORM_TYPE]:[VERSION_NUMBER]`. Possible values of `PLATFORM_TYPE` are: * `ANDROID` - Client is running the Android SDK. * `IOS` - Client is running the iOS SDK. * `WEB_APP` - Client is running as a Web App.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RevisionCheckResponse]:
        """games_revisions_check
    ...
    @validate_call
    def games_revisions_check_without_preload_content(
        self,
        client_revision: Annotated[StrictStr, Field(description="Required. The revision of the client SDK used by your application. Format: `[PLATFORM_TYPE]:[VERSION_NUMBER]`. Possible values of `PLATFORM_TYPE` are: * `ANDROID` - Client is running the Android SDK. * `IOS` - Client is running the iOS SDK. * `WEB_APP` - Client is running as a Web App.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_revisions_check_serialize(
        self,
        client_revision,
        xgafv,
        access_token,
        ...
        if client_revision is not None:
            ...
            _query_params.append(('clientRevision', client_revision))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/revisions/check',
