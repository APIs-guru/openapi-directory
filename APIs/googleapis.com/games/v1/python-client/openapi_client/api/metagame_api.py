...
class MetagameApi:
    ...
    def games_metagame_get_metagame_config(
        ...
        _param = self._games_metagame_get_metagame_config_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def games_metagame_get_metagame_config_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def games_metagame_get_metagame_config_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _games_metagame_get_metagame_config_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/metagameConfig',
    ...
    def games_metagame_list_categories_by_player(
        ...
        collection: Annotated[StrictStr, Field(description="The collection of categories for which data will be returned.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of category resources to return in the response, used for paging. For any response, the actual number of category resources returned may be less than the specified `maxResults`.")] = None,
        ...
        _param = self._games_metagame_list_categories_by_player_serialize(
            player_id=player_id,
    ...
    @validate_call
    def games_metagame_list_categories_by_player_with_http_info(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        collection: Annotated[StrictStr, Field(description="The collection of categories for which data will be returned.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def games_metagame_list_categories_by_player_without_preload_content(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        collection: Annotated[StrictStr, Field(description="The collection of categories for which data will be returned.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _games_metagame_list_categories_by_player_serialize(
        self,
        player_id,
        collection,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/{playerId}/categories/{collection}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
