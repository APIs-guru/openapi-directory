...
class SnapshotsApi:
    ...
    def games_snapshots_get(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="The ID of the snapshot.")],
        ...
        :param snapshot_id: The ID of the snapshot. (required)
        ...
        _param = self._games_snapshots_get_serialize(
    ...
    @validate_call
    def games_snapshots_get_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="The ID of the snapshot.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def games_snapshots_get_without_preload_content(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="The ID of the snapshot.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_snapshots_get_serialize(
        self,
        snapshot_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/snapshots/{snapshotId}',
    ...
    def games_snapshots_list(
        ...
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        language: Annotated[Optional[StrictStr], Field(description="The preferred language to use for strings returned by this method.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of snapshot resources to return in the response, used for paging. For any response, the actual number of snapshot resources returned may be less than the specified `maxResults`.")] = None,
        ...
        _param = self._games_snapshots_list_serialize(
            player_id=player_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def games_snapshots_list_with_http_info(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def games_snapshots_list_without_preload_content(
        self,
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_snapshots_list_serialize(
        self,
        player_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1/players/{playerId}/snapshots',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
