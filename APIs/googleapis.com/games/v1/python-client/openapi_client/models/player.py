...
class Player(BaseModel):
    ...
    experience_info: Optional[PlayerExperienceInfo] = Field(default=None, alias="experienceInfo")
    friend_status: Optional[StrictStr] = Field(default=None, description="The friend status of the given player, relative to the requester. This is unset if the player is not sharing their friends list with the game.", alias="friendStatus")
    game_player_id: Optional[StrictStr] = Field(default=None, description="Per-application unique player identifier.", alias="gamePlayerId")
    kind: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the type of this resource. Value is always the fixed string `games#player`")
    ...
    __properties: ClassVar[List[str]] = ["avatarImageUrl", "bannerUrlLandscape", "bannerUrlPortrait", "displayName", "experienceInfo", "friendStatus", "gamePlayerId", "kind", "name", "originalPlayerId", "playerId", "profileSettings", "title"]

    @field_validator('friend_status')
    def friend_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['NO_RELATIONSHIP', 'FRIEND']):
            raise ValueError("must be one of enum values ('NO_RELATIONSHIP', 'FRIEND')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "experienceInfo": PlayerExperienceInfo.from_dict(obj["experienceInfo"]) if obj.get("experienceInfo") is not None else None,
            "friendStatus": obj.get("friendStatus"),
            "gamePlayerId": obj.get("gamePlayerId"),
            "kind": obj.get("kind"),
