...
class UnlinkPersonaRequest(BaseModel):
    """
    ...
    token: Optional[StrictStr] = Field(default=None, description="Value of the Recall token as it was provided by the client in LinkPersona RPC")
    __properties: ClassVar[List[str]] = ["persona", "sessionId", "token"]
