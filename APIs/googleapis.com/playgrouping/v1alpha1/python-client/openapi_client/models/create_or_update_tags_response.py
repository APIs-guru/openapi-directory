...
class CreateOrUpdateTagsResponse(BaseModel):
    """
    Response message for CreateOrUpdateTags.
    """ # noqa: E501
    tags: Optional[List[Tag]] = Field(default=None, description="All requested tags are returned, including pre-existing ones.")
