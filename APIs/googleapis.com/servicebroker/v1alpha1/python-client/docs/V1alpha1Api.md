...
------------- | ------------- | -------------
[**servicebroker_get_iam_policy**](V1alpha1Api.md#servicebroker_get_iam_policy) | **GET** /v1alpha1/{resource}:getIamPolicy | 
[**servicebroker_set_iam_policy**](V1alpha1Api.md#servicebroker_set_iam_policy) | **POST** /v1alpha1/{resource}:setIamPolicy | 
[**servicebroker_test_iam_permissions**](V1alpha1Api.md#servicebroker_test_iam_permissions) | **POST** /v1alpha1/{resource}:testIamPermissions | 


# **servicebroker_get_iam_policy**
> GoogleIamV1Policy servicebroker_get_iam_policy(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, options_requested_policy_version=options_requested_policy_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_get_iam_policy(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, options_requested_policy_version=options_requested_policy_version)
        print("The response of V1alpha1Api->servicebroker_get_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1alpha1Api->servicebroker_get_iam_policy: %s\n" % e)
```
...
> GoogleIamV1Policy servicebroker_set_iam_policy(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, google_iam_v1_set_iam_policy_request=google_iam_v1_set_iam_policy_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_set_iam_policy(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, google_iam_v1_set_iam_policy_request=google_iam_v1_set_iam_policy_request)
        print("The response of V1alpha1Api->servicebroker_set_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1alpha1Api->servicebroker_set_iam_policy: %s\n" % e)
```
...
> GoogleIamV1TestIamPermissionsResponse servicebroker_test_iam_permissions(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, google_iam_v1_test_iam_permissions_request=google_iam_v1_test_iam_permissions_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_test_iam_permissions(resource, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, upload_type=upload_type, fields=fields, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, key=key, access_token=access_token, google_iam_v1_test_iam_permissions_request=google_iam_v1_test_iam_permissions_request)
        print("The response of V1alpha1Api->servicebroker_test_iam_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1alpha1Api->servicebroker_test_iam_permissions: %s\n" % e)
```
