...
class GoogleCloudServicebrokerV1alpha1CreateBindingResponse(BaseModel):
    """
    ...
    operation: Optional[StrictStr] = Field(default=None, description="If broker executes operation asynchronously, this is the operation ID that can be polled to check the completion status of said operation. This broker always executes all create/delete operations asynchronously.")
    ...
    __properties: ClassVar[List[str]] = ["credentials", "description", "operation", "route_service_url", "syslog_drain_url", "volume_mounts"]
