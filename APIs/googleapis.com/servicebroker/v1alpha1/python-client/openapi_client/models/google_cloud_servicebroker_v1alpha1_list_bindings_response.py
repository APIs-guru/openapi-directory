...
class GoogleCloudServicebrokerV1alpha1ListBindingsResponse(BaseModel):
    """
    The response for the `ListBindings()` method.
    """ # noqa: E501
    bindings: Optional[List[GoogleCloudServicebrokerV1alpha1Binding]] = Field(default=None, description="The list of the bindings in the instance.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bindings": [GoogleCloudServicebrokerV1alpha1Binding.from_dict(_item) for _item in obj["bindings"]] if obj.get("bindings") is not None else None,
