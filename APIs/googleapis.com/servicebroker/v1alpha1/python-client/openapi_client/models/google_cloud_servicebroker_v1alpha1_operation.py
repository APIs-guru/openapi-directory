...
class GoogleCloudServicebrokerV1alpha1Operation(BaseModel):
    """
    Describes a long running operation, which conforms to OpenService API.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Optional description of the Operation state.")
    state: Optional[StrictStr] = Field(default=None, description="The state of the operation. Valid values are: \"in progress\", \"succeeded\", and \"failed\".")
