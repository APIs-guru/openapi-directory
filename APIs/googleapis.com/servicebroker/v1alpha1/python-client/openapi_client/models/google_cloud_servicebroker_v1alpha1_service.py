...
class GoogleCloudServicebrokerV1alpha1Service(BaseModel):
    """
    ...
    dashboard_client: Optional[GoogleCloudServicebrokerV1alpha1DashboardClient] = None
    ...
    instance_retrievable: Optional[StrictBool] = Field(default=None, description="Whether the service provides an endpoint to get service instances.")
    ...
    plans: Optional[List[GoogleCloudServicebrokerV1alpha1Plan]] = Field(default=None, description="A list of plans for this service. At least one plan is required.")
    ...
    __properties: ClassVar[List[str]] = ["bindable", "binding_retrievable", "dashboard_client", "description", "id", "instance_retrievable", "metadata", "name", "plan_updateable", "plans", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dashboard_client": GoogleCloudServicebrokerV1alpha1DashboardClient.from_dict(obj["dashboard_client"]) if obj.get("dashboard_client") is not None else None,
            "description": obj.get("description"),
            "id": obj.get("id"),
            "instance_retrievable": obj.get("instance_retrievable"),
            "metadata": obj.get("metadata"),
            "name": obj.get("name"),
            "plan_updateable": obj.get("plan_updateable"),
            "plans": [GoogleCloudServicebrokerV1alpha1Plan.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
