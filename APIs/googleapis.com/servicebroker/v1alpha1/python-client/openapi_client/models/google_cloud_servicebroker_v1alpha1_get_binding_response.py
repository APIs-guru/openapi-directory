...
class GoogleCloudServicebrokerV1alpha1GetBindingResponse(BaseModel):
    """
    ...
    volume_mounts: Optional[List[Dict[str, Any]]] = Field(default=None, description="An array of configuration for mounting volumes.")
    __properties: ClassVar[List[str]] = ["credentials", "description", "route_service_url", "syslog_drain_url", "volume_mounts"]
