...
class GoogleCloudServicebrokerV1alpha1ListCatalogResponse(BaseModel):
    """
    ...
    services: Optional[List[GoogleCloudServicebrokerV1alpha1Service]] = Field(default=None, description="The services available for the requested GCP project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [GoogleCloudServicebrokerV1alpha1Service.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
