...
class GoogleCloudServicebrokerV1alpha1Binding(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bind_resource", "binding_id", "createTime", "parameters", "plan_id", "service_id"]
