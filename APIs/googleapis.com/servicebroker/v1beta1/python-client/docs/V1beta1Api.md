...
------------- | ------------- | -------------
[**servicebroker_get_iam_policy**](V1beta1Api.md#servicebroker_get_iam_policy) | **GET** /v1beta1/{resource}:getIamPolicy | 
[**servicebroker_set_iam_policy**](V1beta1Api.md#servicebroker_set_iam_policy) | **POST** /v1beta1/{resource}:setIamPolicy | 
[**servicebroker_test_iam_permissions**](V1beta1Api.md#servicebroker_test_iam_permissions) | **POST** /v1beta1/{resource}:testIamPermissions | 


# **servicebroker_get_iam_policy**
> GoogleIamV1Policy servicebroker_get_iam_policy(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, options_requested_policy_version=options_requested_policy_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_get_iam_policy(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, options_requested_policy_version=options_requested_policy_version)
        print("The response of V1beta1Api->servicebroker_get_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1beta1Api->servicebroker_get_iam_policy: %s\n" % e)
```
...
> GoogleIamV1Policy servicebroker_set_iam_policy(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, google_iam_v1_set_iam_policy_request=google_iam_v1_set_iam_policy_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_set_iam_policy(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, google_iam_v1_set_iam_policy_request=google_iam_v1_set_iam_policy_request)
        print("The response of V1beta1Api->servicebroker_set_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1beta1Api->servicebroker_set_iam_policy: %s\n" % e)
```
...
> GoogleIamV1TestIamPermissionsResponse servicebroker_test_iam_permissions(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, google_iam_v1_test_iam_permissions_request=google_iam_v1_test_iam_permissions_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servicebroker_test_iam_permissions(resource, fields=fields, upload_type=upload_type, param_callback=param_callback, oauth_token=oauth_token, xgafv=xgafv, alt=alt, access_token=access_token, key=key, upload_protocol=upload_protocol, quota_user=quota_user, pretty_print=pretty_print, google_iam_v1_test_iam_permissions_request=google_iam_v1_test_iam_permissions_request)
        print("The response of V1beta1Api->servicebroker_test_iam_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1beta1Api->servicebroker_test_iam_permissions: %s\n" % e)
```
