...
class GoogleCloudServicebrokerV1beta1ListBrokersResponse(BaseModel):
    ...
    """ # noqa: E501
    brokers: Optional[List[GoogleCloudServicebrokerV1beta1Broker]] = Field(default=None, description="The list of brokers in the container.")
    ...
    __properties: ClassVar[List[str]] = ["brokers", "nextPageToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.brokers:
            for _item_brokers in self.brokers:
                if _item_brokers:
                    _items.append(_item_brokers.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brokers": [GoogleCloudServicebrokerV1beta1Broker.from_dict(_item) for _item in obj["brokers"]] if obj.get("brokers") is not None else None,
