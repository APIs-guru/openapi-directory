...
class GoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse from a dict"""
        if obj is None:
            return None
