...
class GoogleCloudServicebrokerV1beta1ListServiceInstancesResponse(BaseModel):
    ...
    instances: Optional[List[GoogleCloudServicebrokerV1beta1ServiceInstance]] = Field(default=None, description="The list of instances in the broker.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudServicebrokerV1beta1ListServiceInstancesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudServicebrokerV1beta1ListServiceInstancesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "instances": [GoogleCloudServicebrokerV1beta1ServiceInstance.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
