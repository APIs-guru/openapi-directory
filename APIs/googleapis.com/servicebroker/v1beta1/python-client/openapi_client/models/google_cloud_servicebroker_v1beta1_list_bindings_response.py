...
class GoogleCloudServicebrokerV1beta1ListBindingsResponse(BaseModel):
    ...
    """ # noqa: E501
    bindings: Optional[List[GoogleCloudServicebrokerV1beta1Binding]] = Field(default=None, description="The list of bindings in the instance.")
    ...
    __properties: ClassVar[List[str]] = ["bindings", "description", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bindings": [GoogleCloudServicebrokerV1beta1Binding.from_dict(_item) for _item in obj["bindings"]] if obj.get("bindings") is not None else None,
