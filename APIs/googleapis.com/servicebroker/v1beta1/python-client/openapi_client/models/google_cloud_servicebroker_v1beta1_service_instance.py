...
class GoogleCloudServicebrokerV1beta1ServiceInstance(BaseModel):
    ...
    deployment_name: Optional[StrictStr] = Field(default=None, description="Output only. String containing the Deployment Manager deployment name that was created for this instance,", alias="deploymentName")
    description: Optional[StrictStr] = Field(default=None, description="To return errors when GetInstance call is done via HTTP to be unified with other methods.")
    ...
    __properties: ClassVar[List[str]] = ["context", "createTime", "deploymentName", "description", "instance_id", "organization_guid", "parameters", "plan_id", "previous_values", "resourceName", "service_id", "space_guid"]
