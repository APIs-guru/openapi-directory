...
class SiteVerificationWebResourceListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[SiteVerificationWebResourceResource]] = Field(default=None, description="The list of sites that are owned by the authenticated user.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SiteVerificationWebResourceResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
