...
class TestGoogleCloudDatacatalogV1FilesetSpec(unittest.TestCase):
    """GoogleCloudDatacatalogV1FilesetSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatacatalogV1FilesetSpec:
        """Test GoogleCloudDatacatalogV1FilesetSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatacatalogV1FilesetSpec`
        """
        model = GoogleCloudDatacatalogV1FilesetSpec()
        if include_optional:
    ...
    def testGoogleCloudDatacatalogV1FilesetSpec(self):
        """Test GoogleCloudDatacatalogV1FilesetSpec"""
