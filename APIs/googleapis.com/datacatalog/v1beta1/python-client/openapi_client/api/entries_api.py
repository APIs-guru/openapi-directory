...
class EntriesApi:
    ...
    def datacatalog_entries_lookup(
        ...
        linked_resource: Annotated[Optional[StrictStr], Field(description="The full name of the Google Cloud Platform resource the Data Catalog entry represents. See: https://cloud.google.com/apis/design/resource_names#full_resource_name. Full names are case-sensitive. Examples: * //bigquery.googleapis.com/projects/projectId/datasets/datasetId/tables/tableId * //pubsub.googleapis.com/projects/projectId/topics/topicId")] = None,
        sql_resource: Annotated[Optional[StrictStr], Field(description="The SQL name of the entry. SQL names are case-sensitive. Examples: * `pubsub.project_id.topic_id` * ``pubsub.project_id.`topic.id.with.dots` `` * `bigquery.table.project_id.dataset_id.table_id` * `bigquery.dataset.project_id.dataset_id` * `datacatalog.entry.project_id.location_id.entry_group_id.entry_id` `*_id`s should satisfy the standard SQL rules for identifiers. https://cloud.google.com/bigquery/docs/reference/standard-sql/lexical.")] = None,
    ...
    def _datacatalog_entries_lookup_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta1/entries:lookup',
