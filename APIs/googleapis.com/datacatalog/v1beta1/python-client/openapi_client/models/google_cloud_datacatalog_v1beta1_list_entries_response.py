...
class GoogleCloudDatacatalogV1beta1ListEntriesResponse(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[GoogleCloudDatacatalogV1beta1Entry]] = Field(default=None, description="Entry details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GoogleCloudDatacatalogV1beta1Entry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
