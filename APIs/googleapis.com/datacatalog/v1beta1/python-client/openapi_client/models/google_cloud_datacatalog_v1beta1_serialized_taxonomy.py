...
class GoogleCloudDatacatalogV1beta1SerializedTaxonomy(BaseModel):
    ...
    """ # noqa: E501
    activated_policy_types: Optional[List[StrictStr]] = Field(default=None, description="A list of policy types that are activated for a taxonomy.", alias="activatedPolicyTypes")
    description: Optional[StrictStr] = Field(default=None, description="Description of the serialized taxonomy. The length of the description is limited to 2000 bytes when encoded in UTF-8. If not set, defaults to an empty description.")
    display_name: Optional[StrictStr] = Field(default=None, description="Required. Display name of the taxonomy. Max 200 bytes when encoded in UTF-8.", alias="displayName")
    policy_tags: Optional[List[GoogleCloudDatacatalogV1beta1SerializedPolicyTag]] = Field(default=None, description="Top level policy tags associated with the taxonomy if any.", alias="policyTags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyTags": [GoogleCloudDatacatalogV1beta1SerializedPolicyTag.from_dict(_item) for _item in obj["policyTags"]] if obj.get("policyTags") is not None else None
        })
        return _obj
