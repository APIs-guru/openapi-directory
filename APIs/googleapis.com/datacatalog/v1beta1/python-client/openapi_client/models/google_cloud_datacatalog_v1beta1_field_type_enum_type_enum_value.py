...
class GoogleCloudDatacatalogV1beta1FieldTypeEnumTypeEnumValue(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Required. The display name of the enum value. Must not be an empty string.", alias="displayName")
