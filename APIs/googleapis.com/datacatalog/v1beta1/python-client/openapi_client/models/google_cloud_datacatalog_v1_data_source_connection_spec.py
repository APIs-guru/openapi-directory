...
class GoogleCloudDatacatalogV1DataSourceConnectionSpec(BaseModel):
    ...
    """ # noqa: E501
    bigquery_connection_spec: Optional[GoogleCloudDatacatalogV1BigQueryConnectionSpec] = Field(default=None, alias="bigqueryConnectionSpec")
    __properties: ClassVar[List[str]] = ["bigqueryConnectionSpec"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bigquery_connection_spec
        if self.bigquery_connection_spec:
            _dict['bigqueryConnectionSpec'] = self.bigquery_connection_spec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryConnectionSpec": GoogleCloudDatacatalogV1BigQueryConnectionSpec.from_dict(obj["bigqueryConnectionSpec"]) if obj.get("bigqueryConnectionSpec") is not None else None
        })
        return _obj
