...
class GoogleCloudDatacatalogV1beta1BigQueryTableSpec(BaseModel):
    ...
    table_spec: Optional[GoogleCloudDatacatalogV1beta1TableSpec] = Field(default=None, alias="tableSpec")
    view_spec: Optional[GoogleCloudDatacatalogV1beta1ViewSpec] = Field(default=None, alias="viewSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tableSpec": GoogleCloudDatacatalogV1beta1TableSpec.from_dict(obj["tableSpec"]) if obj.get("tableSpec") is not None else None,
            "viewSpec": GoogleCloudDatacatalogV1beta1ViewSpec.from_dict(obj["viewSpec"]) if obj.get("viewSpec") is not None else None
        })
        return _obj
