...
class GoogleCloudDatacatalogV1beta1Schema(BaseModel):
    ...
    """ # noqa: E501
    columns: Optional[List[GoogleCloudDatacatalogV1beta1ColumnSchema]] = Field(default=None, description="Required. Schema of columns. A maximum of 10,000 columns and sub-columns can be specified.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [GoogleCloudDatacatalogV1beta1ColumnSchema.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
