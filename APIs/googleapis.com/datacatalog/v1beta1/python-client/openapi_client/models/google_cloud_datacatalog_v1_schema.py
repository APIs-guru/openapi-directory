...
class GoogleCloudDatacatalogV1Schema(BaseModel):
    ...
    """ # noqa: E501
    columns: Optional[List[GoogleCloudDatacatalogV1ColumnSchema]] = Field(default=None, description="The unified GoogleSQL-like schema of columns. The overall maximum number of columns and nested columns is 10,000. The maximum nested depth is 15 levels.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [GoogleCloudDatacatalogV1ColumnSchema.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
