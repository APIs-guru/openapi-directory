...
class GoogleCloudDatacatalogV1beta1ExportTaxonomiesResponse(BaseModel):
    ...
    """ # noqa: E501
    taxonomies: Optional[List[GoogleCloudDatacatalogV1beta1SerializedTaxonomy]] = Field(default=None, description="List of taxonomies and policy tags in a tree structure.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxonomies": [GoogleCloudDatacatalogV1beta1SerializedTaxonomy.from_dict(_item) for _item in obj["taxonomies"]] if obj.get("taxonomies") is not None else None
        })
        return _obj
