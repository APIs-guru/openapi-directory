...
class GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest(BaseModel):
    ...
    """ # noqa: E501
    inline_source: Optional[GoogleCloudDatacatalogV1beta1InlineSource] = Field(default=None, alias="inlineSource")
    __properties: ClassVar[List[str]] = ["inlineSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inlineSource": GoogleCloudDatacatalogV1beta1InlineSource.from_dict(obj["inlineSource"]) if obj.get("inlineSource") is not None else None
        })
        return _obj
