...
class GoogleCloudDatacatalogV1beta1EntryGroup(BaseModel):
    ...
    """ # noqa: E501
    data_catalog_timestamps: Optional[GoogleCloudDatacatalogV1beta1SystemTimestamps] = Field(default=None, alias="dataCatalogTimestamps")
    description: Optional[StrictStr] = Field(default=None, description="Entry group description, which can consist of several sentences or paragraphs that describe entry group contents. Default value is an empty string.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the entry group in URL format. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id} Note that this EntryGroup and its child resources may not actually be stored in the location in this name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataCatalogTimestamps": GoogleCloudDatacatalogV1beta1SystemTimestamps.from_dict(obj["dataCatalogTimestamps"]) if obj.get("dataCatalogTimestamps") is not None else None,
