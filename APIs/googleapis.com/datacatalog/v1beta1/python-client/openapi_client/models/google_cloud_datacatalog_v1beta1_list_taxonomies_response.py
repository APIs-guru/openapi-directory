...
class GoogleCloudDatacatalogV1beta1ListTaxonomiesResponse(BaseModel):
    ...
    taxonomies: Optional[List[GoogleCloudDatacatalogV1beta1Taxonomy]] = Field(default=None, description="Taxonomies that the project contains.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "taxonomies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxonomies": [GoogleCloudDatacatalogV1beta1Taxonomy.from_dict(_item) for _item in obj["taxonomies"]] if obj.get("taxonomies") is not None else None
        })
        return _obj
