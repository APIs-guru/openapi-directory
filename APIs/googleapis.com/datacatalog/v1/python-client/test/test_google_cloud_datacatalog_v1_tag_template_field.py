...
class TestGoogleCloudDatacatalogV1TagTemplateField(unittest.TestCase):
    """GoogleCloudDatacatalogV1TagTemplateField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatacatalogV1TagTemplateField:
        """Test GoogleCloudDatacatalogV1TagTemplateField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatacatalogV1TagTemplateField`
        """
        model = GoogleCloudDatacatalogV1TagTemplateField()
        if include_optional:
    ...
    def testGoogleCloudDatacatalogV1TagTemplateField(self):
        """Test GoogleCloudDatacatalogV1TagTemplateField"""
