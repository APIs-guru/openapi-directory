...
class TestGoogleCloudDatacatalogV1Tag(unittest.TestCase):
    """GoogleCloudDatacatalogV1Tag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatacatalogV1Tag:
        """Test GoogleCloudDatacatalogV1Tag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatacatalogV1Tag`
        """
        model = GoogleCloudDatacatalogV1Tag()
        if include_optional:
    ...
    def testGoogleCloudDatacatalogV1Tag(self):
        """Test GoogleCloudDatacatalogV1Tag"""
