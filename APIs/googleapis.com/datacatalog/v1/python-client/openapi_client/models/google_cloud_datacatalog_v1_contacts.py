...
class GoogleCloudDatacatalogV1Contacts(BaseModel):
    ...
    """ # noqa: E501
    people: Optional[List[GoogleCloudDatacatalogV1ContactsPerson]] = Field(default=None, description="The list of contact people for the entry.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "people": [GoogleCloudDatacatalogV1ContactsPerson.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None
        })
        return _obj
