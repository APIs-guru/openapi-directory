...
class GoogleCloudDatacatalogV1ImportTaxonomiesResponse(BaseModel):
    """
    Response message for ImportTaxonomies.
    """ # noqa: E501
    taxonomies: Optional[List[GoogleCloudDatacatalogV1Taxonomy]] = Field(default=None, description="Imported taxonomies.")
