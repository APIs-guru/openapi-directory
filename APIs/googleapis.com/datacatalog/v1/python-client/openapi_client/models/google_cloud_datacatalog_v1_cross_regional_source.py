...
class GoogleCloudDatacatalogV1CrossRegionalSource(BaseModel):
    """
    Cross-regional source used to import an existing taxonomy into a different region.
    """ # noqa: E501
    taxonomy: Optional[StrictStr] = Field(default=None, description="Required. The resource name of the source taxonomy to import.")
