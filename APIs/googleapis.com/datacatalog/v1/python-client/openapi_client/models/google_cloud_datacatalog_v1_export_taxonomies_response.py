...
class GoogleCloudDatacatalogV1ExportTaxonomiesResponse(BaseModel):
    """
    Response message for ExportTaxonomies.
    """ # noqa: E501
    taxonomies: Optional[List[GoogleCloudDatacatalogV1SerializedTaxonomy]] = Field(default=None, description="List of taxonomies and policy tags as nested protocol buffers.")
    __properties: ClassVar[List[str]] = ["taxonomies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxonomies": [GoogleCloudDatacatalogV1SerializedTaxonomy.from_dict(_item) for _item in obj["taxonomies"]] if obj.get("taxonomies") is not None else None
        })
        return _obj
