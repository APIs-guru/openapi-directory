...
class GoogleCloudDatacatalogV1CloudBigtableSystemSpec(BaseModel):
    ...
    """ # noqa: E501
    instance_display_name: Optional[StrictStr] = Field(default=None, description="Display name of the Instance. This is user specified and different from the resource name.", alias="instanceDisplayName")
    __properties: ClassVar[List[str]] = ["instanceDisplayName"]
