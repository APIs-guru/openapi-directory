...
class GoogleCloudDatacatalogV1ListEntriesResponse(BaseModel):
    """
    Response message for ListEntries.
    """ # noqa: E501
    entries: Optional[List[GoogleCloudDatacatalogV1Entry]] = Field(default=None, description="Entry details.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Pagination token of the next results page. Empty if there are no more items in results.", alias="nextPageToken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GoogleCloudDatacatalogV1Entry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
