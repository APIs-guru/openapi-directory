...
class GoogleCloudDatacatalogV1InlineSource(BaseModel):
    """
    Inline source containing taxonomies to import.
    """ # noqa: E501
    taxonomies: Optional[List[GoogleCloudDatacatalogV1SerializedTaxonomy]] = Field(default=None, description="Required. Taxonomies to import.")
