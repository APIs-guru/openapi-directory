...
class ListEndpointsResponse(BaseModel):
    ...
    """ # noqa: E501
    endpoints: Optional[List[Endpoint]] = Field(default=None, description="The list of endpoints response.")
    ...
    __properties: ClassVar[List[str]] = ["endpoints", "nextPageToken", "unreachable"]
