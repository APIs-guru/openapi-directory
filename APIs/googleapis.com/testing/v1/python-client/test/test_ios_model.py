...
class TestIosModel(unittest.TestCase):
    """IosModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IosModel:
        """Test IosModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IosModel`
        """
        model = IosModel()
        if include_optional:
            return IosModel(
