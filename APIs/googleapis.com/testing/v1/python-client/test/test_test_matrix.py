...
class TestTestMatrix(unittest.TestCase):
    """TestMatrix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestMatrix:
        """Test TestMatrix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestMatrix`
        """
        model = TestMatrix()
        if include_optional:
            return TestMatrix(
                client_info = openapi_client.models.client_info.ClientInfo(
                    client_info_details = [
                    ...
                    name = '', ),
                environment_matrix = openapi_client.models.environment_matrix.EnvironmentMatrix(
                ...
                extended_invalid_matrix_details = [
                    openapi_client.models.matrix_error_detail.MatrixErrorDetail(
                        message = '', 
                        reason = '', )
                    ],
                fail_fast = True,
                flaky_test_attempts = 56,
                invalid_matrix_details = 'INVALID_MATRIX_DETAILS_UNSPECIFIED',
                outcome_summary = 'OUTCOME_SUMMARY_UNSPECIFIED',
                project_id = '',
                result_storage = openapi_client.models.result_storage.ResultStorage(
                ...
                test_executions = [
                    openapi_client.models.test_execution.TestExecution(
