...
class Environment(BaseModel):
    ...
    ios_device: Optional[IosDevice] = Field(default=None, alias="iosDevice")
    __properties: ClassVar[List[str]] = ["androidDevice", "iosDevice"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ios_device
        if self.ios_device:
            _dict['iosDevice'] = self.ios_device.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iosDevice": IosDevice.from_dict(obj["iosDevice"]) if obj.get("iosDevice") is not None else None
        })
        return _obj
