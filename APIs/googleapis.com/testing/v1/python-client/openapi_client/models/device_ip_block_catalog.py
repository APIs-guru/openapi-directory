...
class DeviceIpBlockCatalog(BaseModel):
    ...
    """ # noqa: E501
    ip_blocks: Optional[List[DeviceIpBlock]] = Field(default=None, description="The device IP blocks used by Firebase Test Lab", alias="ipBlocks")
    __properties: ClassVar[List[str]] = ["ipBlocks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipBlocks": [DeviceIpBlock.from_dict(_item) for _item in obj["ipBlocks"]] if obj.get("ipBlocks") is not None else None
        })
        return _obj
