...
class PerIosVersionInfo(BaseModel):
    ...
    """ # noqa: E501
    device_capacity: Optional[StrictStr] = Field(default=None, description="The number of online devices for an iOS version.", alias="deviceCapacity")
    version_id: Optional[StrictStr] = Field(default=None, description="An iOS version.", alias="versionId")
    __properties: ClassVar[List[str]] = ["deviceCapacity", "versionId"]
