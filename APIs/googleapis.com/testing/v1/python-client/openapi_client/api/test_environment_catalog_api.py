...
class TestEnvironmentCatalogApi:
    ...
    def testing_test_environment_catalog_get(
        self,
        environment_type: Annotated[StrictStr, Field(description="Required. The type of environment that should be listed.")],
        ...
        project_id: Annotated[Optional[StrictStr], Field(description="For authorization, the cloud project requesting the TestEnvironmentCatalog.")] = None,
        ...
        :param environment_type: Required. The type of environment that should be listed. (required)
        ...
        _param = self._testing_test_environment_catalog_get_serialize(
    ...
    @validate_call
    def testing_test_environment_catalog_get_with_http_info(
        self,
        environment_type: Annotated[StrictStr, Field(description="Required. The type of environment that should be listed.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TestEnvironmentCatalog]:
        """testing_test_environment_catalog_get
    ...
    @validate_call
    def testing_test_environment_catalog_get_without_preload_content(
        self,
        environment_type: Annotated[StrictStr, Field(description="Required. The type of environment that should be listed.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _testing_test_environment_catalog_get_serialize(
        self,
        environment_type,
        xgafv,
        access_token,
        ...
        if environment_type is not None:
            _path_params['environmentType'] = environment_type
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/testEnvironmentCatalog/{environmentType}',
