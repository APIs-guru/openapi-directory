...
------------ | ------------- | ------------- | -------------
**mysql_columns** | [**List[MysqlColumn]**](MysqlColumn.md) | MySQL columns in the database. When unspecified as part of include/exclude objects, includes/excludes everything. | [optional] 
