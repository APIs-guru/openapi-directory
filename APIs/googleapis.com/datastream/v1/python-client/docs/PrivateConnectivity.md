...
------------ | ------------- | ------------- | -------------
**private_connection** | **str** | Required. A reference to a private connection resource. Format: &#x60;projects/{project}/locations/{location}/privateConnections/{name}&#x60; | [optional] 
