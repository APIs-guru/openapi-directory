...
class OperationMetadata(BaseModel):
    ...
    validation_result: Optional[ValidationResult] = Field(default=None, alias="validationResult")
    verb: Optional[StrictStr] = Field(default=None, description="Output only. Name of the verb executed by the operation.")
    __properties: ClassVar[List[str]] = ["apiVersion", "createTime", "endTime", "requestedCancellation", "statusMessage", "target", "validationResult", "verb"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validationResult": ValidationResult.from_dict(obj["validationResult"]) if obj.get("validationResult") is not None else None,
            "verb": obj.get("verb")
        })
        return _obj
