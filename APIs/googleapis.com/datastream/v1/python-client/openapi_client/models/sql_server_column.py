...
class SqlServerColumn(BaseModel):
    """
    SQLServer Column.
    """ # noqa: E501
    column: Optional[StrictStr] = Field(default=None, description="Column name.")
    data_type: Optional[StrictStr] = Field(default=None, description="The SQLServer data type.", alias="dataType")
    ...
    __properties: ClassVar[List[str]] = ["column", "dataType", "length", "nullable", "ordinalPosition", "precision", "primaryKey", "scale"]
