...
class SqlServerRdbms(BaseModel):
    """
    SQLServer database structure.
    """ # noqa: E501
    schemas: Optional[List[SqlServerSchema]] = Field(default=None, description="SQLServer schemas in the database server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schemas": [SqlServerSchema.from_dict(_item) for _item in obj["schemas"]] if obj.get("schemas") is not None else None
        })
        return _obj
