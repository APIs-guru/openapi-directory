...
class OracleColumn(BaseModel):
    ...
    data_type: Optional[StrictStr] = Field(default=None, description="The Oracle data type.", alias="dataType")
    encoding: Optional[StrictStr] = Field(default=None, description="Column encoding.")
    ...
    __properties: ClassVar[List[str]] = ["column", "dataType", "encoding", "length", "nullable", "ordinalPosition", "precision", "primaryKey", "scale"]
