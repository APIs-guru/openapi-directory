...
class OracleSslConfig(BaseModel):
    """
    ...
    ca_certificate_set: Optional[StrictBool] = Field(default=None, description="Output only. Indicates whether the ca_certificate field has been set for this Connection-Profile.", alias="caCertificateSet")
    __properties: ClassVar[List[str]] = ["caCertificate", "caCertificateSet"]
