...
class ValidationResult(BaseModel):
    ...
    """ # noqa: E501
    validations: Optional[List[Validation]] = Field(default=None, description="A list of validations (includes both executed as well as not executed validations).")
    __properties: ClassVar[List[str]] = ["validations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validations": [Validation.from_dict(_item) for _item in obj["validations"]] if obj.get("validations") is not None else None
        })
        return _obj
