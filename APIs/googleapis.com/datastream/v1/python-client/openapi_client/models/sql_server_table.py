...
class SqlServerTable(BaseModel):
    ...
    SQLServer table.
    """ # noqa: E501
    columns: Optional[List[SqlServerColumn]] = Field(default=None, description="SQLServer columns in the schema. When unspecified as part of include/exclude objects, includes/excludes everything.")
    table: Optional[StrictStr] = Field(default=None, description="Table name.")
    __properties: ClassVar[List[str]] = ["columns", "table"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [SqlServerColumn.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            "table": obj.get("table")
        })
        return _obj
