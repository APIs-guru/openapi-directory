...
class DiscoverConnectionProfileRequest(BaseModel):
    ...
    connection_profile_name: Optional[StrictStr] = Field(default=None, description="A reference to an existing connection profile.", alias="connectionProfileName")
    full_hierarchy: Optional[StrictBool] = Field(default=None, description="Whether to retrieve the full hierarchy of data objects (TRUE) or only the current level (FALSE).", alias="fullHierarchy")
    hierarchy_depth: Optional[StrictInt] = Field(default=None, description="The number of hierarchy levels below the current level to be retrieved.", alias="hierarchyDepth")
    ...
    __properties: ClassVar[List[str]] = ["connectionProfile", "connectionProfileName", "fullHierarchy", "hierarchyDepth", "mysqlRdbms", "oracleRdbms", "postgresqlRdbms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fullHierarchy": obj.get("fullHierarchy"),
            "hierarchyDepth": obj.get("hierarchyDepth"),
