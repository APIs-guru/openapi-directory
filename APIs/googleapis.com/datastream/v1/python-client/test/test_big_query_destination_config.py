...
class TestBigQueryDestinationConfig(unittest.TestCase):
    """BigQueryDestinationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigQueryDestinationConfig:
        """Test BigQueryDestinationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigQueryDestinationConfig`
        """
        model = BigQueryDestinationConfig()
        if include_optional:
    ...
    def testBigQueryDestinationConfig(self):
        """Test BigQueryDestinationConfig"""
