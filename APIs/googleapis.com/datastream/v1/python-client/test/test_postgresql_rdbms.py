...
class TestPostgresqlRdbms(unittest.TestCase):
    """PostgresqlRdbms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostgresqlRdbms:
        """Test PostgresqlRdbms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostgresqlRdbms`
        """
        model = PostgresqlRdbms()
        if include_optional:
