...
class ConnectionProfile(BaseModel):
    ...
    no_connectivity: Optional[Dict[str, Any]] = Field(default=None, description="No connectivity settings.", alias="noConnectivity")
    ...
    static_service_ip_connectivity: Optional[Dict[str, Any]] = Field(default=None, description="Static IP address connectivity.", alias="staticServiceIpConnectivity")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "displayName", "forwardSshConnectivity", "gcsProfile", "labels", "mysqlProfile", "name", "noConnectivity", "oracleProfile", "privateConnectivity", "staticServiceIpConnectivity", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "noConnectivity": obj.get("noConnectivity"),
