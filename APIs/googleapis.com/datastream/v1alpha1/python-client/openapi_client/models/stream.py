...
class Stream(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backfillAll", "backfillNone", "createTime", "customerManagedEncryptionKey", "destinationConfig", "displayName", "errors", "labels", "name", "sourceConfig", "state", "updateTime"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['STATE_UNSPECIFIED', 'CREATED', 'RUNNING', 'PAUSED', 'MAINTENANCE', 'FAILED', 'FAILED_PERMANENTLY', 'STARTING', 'DRAINING']):
            raise ValueError("must be one of enum values ('STATE_UNSPECIFIED', 'CREATED', 'RUNNING', 'PAUSED', 'MAINTENANCE', 'FAILED', 'FAILED_PERMANENTLY', 'STARTING', 'DRAINING')")
        return value
