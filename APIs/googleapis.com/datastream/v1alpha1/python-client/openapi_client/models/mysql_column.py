...
class MysqlColumn(BaseModel):
    ...
    column_name: Optional[StrictStr] = Field(default=None, description="Column name.", alias="columnName")
    ...
    __properties: ClassVar[List[str]] = ["collation", "columnName", "dataType", "length", "nullable", "ordinalPosition", "primaryKey"]
