...
class TestStopBackfillJobResponse(unittest.TestCase):
    """StopBackfillJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StopBackfillJobResponse:
        """Test StopBackfillJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StopBackfillJobResponse`
        """
        model = StopBackfillJobResponse()
        if include_optional:
    ...
    def testStopBackfillJobResponse(self):
        """Test StopBackfillJobResponse"""
