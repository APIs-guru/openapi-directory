...
------------ | ------------- | ------------- | -------------
**oracle_columns** | [**List[OracleColumn]**](OracleColumn.md) | Oracle columns in the schema. When unspecified as part of inclue/exclude lists, includes/excludes everything. | [optional] 
