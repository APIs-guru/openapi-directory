...
**file_rotation_interval** | **str** | The maximum duration for which new events are added before a file is closed and a new file is created. | [optional] 
**file_rotation_mb** | **int** | The maximum file size to be saved in the bucket. | [optional] 
**gcs_file_format** | **str** | File format that data should be written in. Deprecated field (b/169501737) - use file_format instead. | [optional] 
