...
------------- | ------------- | -------------
[**migrationcenter_projects_locations_assets_aggregate_values**](ProjectsApi.md#migrationcenter_projects_locations_assets_aggregate_values) | **POST** /v1/{parent}/assets:aggregateValues | 
[**migrationcenter_projects_locations_assets_batch_delete**](ProjectsApi.md#migrationcenter_projects_locations_assets_batch_delete) | **POST** /v1/{parent}/assets:batchDelete | 
[**migrationcenter_projects_locations_assets_batch_update**](ProjectsApi.md#migrationcenter_projects_locations_assets_batch_update) | **POST** /v1/{parent}/assets:batchUpdate | 
[**migrationcenter_projects_locations_assets_list**](ProjectsApi.md#migrationcenter_projects_locations_assets_list) | **GET** /v1/{parent}/assets | 
[**migrationcenter_projects_locations_assets_report_asset_frames**](ProjectsApi.md#migrationcenter_projects_locations_assets_report_asset_frames) | **POST** /v1/{parent}/assets:reportAssetFrames | 
[**migrationcenter_projects_locations_groups_add_assets**](ProjectsApi.md#migrationcenter_projects_locations_groups_add_assets) | **POST** /v1/{group}:addAssets | 
[**migrationcenter_projects_locations_groups_create**](ProjectsApi.md#migrationcenter_projects_locations_groups_create) | **POST** /v1/{parent}/groups | 
[**migrationcenter_projects_locations_groups_list**](ProjectsApi.md#migrationcenter_projects_locations_groups_list) | **GET** /v1/{parent}/groups | 
[**migrationcenter_projects_locations_groups_remove_assets**](ProjectsApi.md#migrationcenter_projects_locations_groups_remove_assets) | **POST** /v1/{group}:removeAssets | 
[**migrationcenter_projects_locations_import_jobs_create**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_create) | **POST** /v1/{parent}/importJobs | 
[**migrationcenter_projects_locations_import_jobs_import_data_files_create**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_import_data_files_create) | **POST** /v1/{parent}/importDataFiles | 
[**migrationcenter_projects_locations_import_jobs_import_data_files_list**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_import_data_files_list) | **GET** /v1/{parent}/importDataFiles | 
[**migrationcenter_projects_locations_import_jobs_list**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_list) | **GET** /v1/{parent}/importJobs | 
[**migrationcenter_projects_locations_import_jobs_run**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_run) | **POST** /v1/{name}:run | 
[**migrationcenter_projects_locations_import_jobs_validate**](ProjectsApi.md#migrationcenter_projects_locations_import_jobs_validate) | **POST** /v1/{name}:validate | 
[**migrationcenter_projects_locations_list**](ProjectsApi.md#migrationcenter_projects_locations_list) | **GET** /v1/{name}/locations | 
[**migrationcenter_projects_locations_operations_cancel**](ProjectsApi.md#migrationcenter_projects_locations_operations_cancel) | **POST** /v1/{name}:cancel | 
[**migrationcenter_projects_locations_operations_list**](ProjectsApi.md#migrationcenter_projects_locations_operations_list) | **GET** /v1/{name}/operations | 
[**migrationcenter_projects_locations_preference_sets_create**](ProjectsApi.md#migrationcenter_projects_locations_preference_sets_create) | **POST** /v1/{parent}/preferenceSets | 
[**migrationcenter_projects_locations_preference_sets_list**](ProjectsApi.md#migrationcenter_projects_locations_preference_sets_list) | **GET** /v1/{parent}/preferenceSets | 
[**migrationcenter_projects_locations_report_configs_create**](ProjectsApi.md#migrationcenter_projects_locations_report_configs_create) | **POST** /v1/{parent}/reportConfigs | 
[**migrationcenter_projects_locations_report_configs_list**](ProjectsApi.md#migrationcenter_projects_locations_report_configs_list) | **GET** /v1/{parent}/reportConfigs | 
[**migrationcenter_projects_locations_report_configs_reports_create**](ProjectsApi.md#migrationcenter_projects_locations_report_configs_reports_create) | **POST** /v1/{parent}/reports | 
[**migrationcenter_projects_locations_report_configs_reports_list**](ProjectsApi.md#migrationcenter_projects_locations_report_configs_reports_list) | **GET** /v1/{parent}/reports | 
[**migrationcenter_projects_locations_sources_create**](ProjectsApi.md#migrationcenter_projects_locations_sources_create) | **POST** /v1/{parent}/sources | 
[**migrationcenter_projects_locations_sources_delete**](ProjectsApi.md#migrationcenter_projects_locations_sources_delete) | **DELETE** /v1/{name} | 
[**migrationcenter_projects_locations_sources_error_frames_get**](ProjectsApi.md#migrationcenter_projects_locations_sources_error_frames_get) | **GET** /v1/{name} | 
[**migrationcenter_projects_locations_sources_error_frames_list**](ProjectsApi.md#migrationcenter_projects_locations_sources_error_frames_list) | **GET** /v1/{parent}/errorFrames | 
[**migrationcenter_projects_locations_sources_list**](ProjectsApi.md#migrationcenter_projects_locations_sources_list) | **GET** /v1/{parent}/sources | 
[**migrationcenter_projects_locations_sources_patch**](ProjectsApi.md#migrationcenter_projects_locations_sources_patch) | **PATCH** /v1/{name} | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    preference_set_id = 'preference_set_id_example' # str | Required. User specified ID for the preference set. It will become the last component of the preference set name. The ID must be unique within the project, must conform with RFC-1034, is restricted to lower-cased letters, and has a maximum length of 63 characters. The ID must match the regular expression `[a-z]([a-z0-9-]{0,61}[a-z0-9])?`. (optional)
    request_id = 'request_id_example' # str | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **preference_set_id** | **str**| Required. User specified ID for the preference set. It will become the last component of the preference set name. The ID must be unique within the project, must conform with RFC-1034, is restricted to lower-cased letters, and has a maximum length of 63 characters. The ID must match the regular expression &#x60;[a-z]([a-z0-9-]{0,61}[a-z0-9])?&#x60;. | [optional] 
 **request_id** | **str**| Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). | [optional] 
