...
------------ | ------------- | ------------- | -------------
**bios_name** | **str** | BIOS name. This fields is deprecated. Please use the &#x60;id&#x60; field instead. | [optional] 
**id** | **str** | BIOS ID. | [optional] 
**manufacturer** | **str** | BIOS manufacturer. | [optional] 
