...
class GuestInstalledApplicationList(BaseModel):
    """
    Guest installed application list.
    """ # noqa: E501
    entries: Optional[List[GuestInstalledApplication]] = Field(default=None, description="Application entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GuestInstalledApplication.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
