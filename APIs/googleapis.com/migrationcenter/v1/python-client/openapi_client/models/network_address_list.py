...
class NetworkAddressList(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[NetworkAddress]] = Field(default=None, description="Network address entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [NetworkAddress.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
