...
class VirtualMachinePreferences(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commitmentPlan", "computeEnginePreferences", "regionPreferences", "sizingOptimizationStrategy", "soleTenancyPreferences", "targetProduct", "vmwareEnginePreferences"]
