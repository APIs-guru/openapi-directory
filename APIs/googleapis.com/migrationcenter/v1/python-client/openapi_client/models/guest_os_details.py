...
class GuestOsDetails(BaseModel):
    ...
    family: Optional[StrictStr] = Field(default=None, description="What family the OS belong to, if known.")
    os_name: Optional[StrictStr] = Field(default=None, description="The name of the operating system.", alias="osName")
    ...
    __properties: ClassVar[List[str]] = ["config", "family", "osName", "runtime", "version"]
