...
class DiskEntry(BaseModel):
    ...
    Single disk entry.
    """ # noqa: E501
    capacity_bytes: Optional[StrictStr] = Field(default=None, description="Disk capacity.", alias="capacityBytes")
    ...
    free_bytes: Optional[StrictStr] = Field(default=None, description="Disk free space.", alias="freeBytes")
    hw_address: Optional[StrictStr] = Field(default=None, description="Disk hardware address (e.g. 0:1 for SCSI).", alias="hwAddress")
    interface_type: Optional[StrictStr] = Field(default=None, description="Disks interface type.", alias="interfaceType")
    partitions: Optional[DiskPartitionList] = None
    vmware: Optional[VmwareDiskConfig] = None
    __properties: ClassVar[List[str]] = ["capacityBytes", "diskLabel", "diskLabelType", "freeBytes", "hwAddress", "interfaceType", "partitions", "vmware"]
    ...
    def interface_type_validate_enum(cls, value):
        ...
        if value not in set(['INTERFACE_TYPE_UNSPECIFIED', 'IDE', 'SATA', 'SAS', 'SCSI', 'NVME', 'FC', 'ISCSI']):
            raise ValueError("must be one of enum values ('INTERFACE_TYPE_UNSPECIFIED', 'IDE', 'SATA', 'SAS', 'SCSI', 'NVME', 'FC', 'ISCSI')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vmware": VmwareDiskConfig.from_dict(obj["vmware"]) if obj.get("vmware") is not None else None
        })
        return _obj
