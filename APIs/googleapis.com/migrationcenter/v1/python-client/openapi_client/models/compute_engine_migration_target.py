...
class ComputeEngineMigrationTarget(BaseModel):
    """
    Compute engine migration target.
    """ # noqa: E501
    shape: Optional[ComputeEngineShapeDescriptor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shape": ComputeEngineShapeDescriptor.from_dict(obj["shape"]) if obj.get("shape") is not None else None
        })
        return _obj
