...
class ReportSummaryChartData(BaseModel):
    """
    Describes a collection of data points rendered as a Chart.
    """ # noqa: E501
    data_points: Optional[List[ReportSummaryChartDataDataPoint]] = Field(default=None, description="Each data point in the chart is represented as a name-value pair with the name being the x-axis label, and the value being the y-axis value.", alias="dataPoints")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataPoints": [ReportSummaryChartDataDataPoint.from_dict(_item) for _item in obj["dataPoints"]] if obj.get("dataPoints") is not None else None
        })
        return _obj
