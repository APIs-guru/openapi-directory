...
class OpenFileList(BaseModel):
    """
    Open file list.
    """ # noqa: E501
    entries: Optional[List[OpenFileDetails]] = Field(default=None, description="Open file details entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [OpenFileDetails.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
