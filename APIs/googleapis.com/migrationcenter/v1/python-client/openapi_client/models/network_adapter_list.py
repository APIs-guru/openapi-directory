...
class NetworkAdapterList(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[NetworkAdapterDetails]] = Field(default=None, description="Network adapter entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [NetworkAdapterDetails.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
