...
class Source(BaseModel):
    ...
    managed: Optional[StrictBool] = Field(default=None, description="If `true`, the source is managed by other service(s).")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "description", "displayName", "errorFrameCount", "managed", "name", "pendingFrameCount", "priority", "state", "type", "updateTime"]
