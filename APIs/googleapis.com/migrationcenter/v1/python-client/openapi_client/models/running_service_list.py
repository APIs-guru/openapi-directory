...
class RunningServiceList(BaseModel):
    """
    List of running guest OS services.
    """ # noqa: E501
    entries: Optional[List[RunningService]] = Field(default=None, description="Running service entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [RunningService.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
