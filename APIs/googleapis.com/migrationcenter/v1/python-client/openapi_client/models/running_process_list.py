...
class RunningProcessList(BaseModel):
    """
    List of running guest OS processes.
    """ # noqa: E501
    entries: Optional[List[RunningProcess]] = Field(default=None, description="Running process entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [RunningProcess.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
