...
class ReportSummaryAssetAggregateStats(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coreCountHistogram", "memoryBytesHistogram", "memoryUtilizationChart", "operatingSystem", "storageBytesHistogram", "storageUtilizationChart", "totalAssets", "totalCores", "totalMemoryBytes", "totalStorageBytes"]
