...
class NetworkAddressList(BaseModel):
    """
    List of allocated/assigned network addresses.
    """ # noqa: E501
    addresses: Optional[List[NetworkAddress]] = Field(default=None, description="Network address entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [NetworkAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None
        })
        return _obj
