...
class ImportJob(BaseModel):
    ...
    gcs_payload: Optional[GCSPayloadInfo] = Field(default=None, alias="gcsPayload")
    inline_payload: Optional[InlinePayloadInfo] = Field(default=None, alias="inlinePayload")
    ...
    __properties: ClassVar[List[str]] = ["assetSource", "completeTime", "createTime", "displayName", "executionReport", "gcsPayload", "inlinePayload", "labels", "name", "state", "updateTime", "validationReport"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of gcs_payload
        if self.gcs_payload:
            _dict['gcsPayload'] = self.gcs_payload.to_dict()
        # override the default output from pydantic by calling `to_dict()` of inline_payload
        if self.inline_payload:
            _dict['inlinePayload'] = self.inline_payload.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsPayload": GCSPayloadInfo.from_dict(obj["gcsPayload"]) if obj.get("gcsPayload") is not None else None,
            "inlinePayload": InlinePayloadInfo.from_dict(obj["inlinePayload"]) if obj.get("inlinePayload") is not None else None,
