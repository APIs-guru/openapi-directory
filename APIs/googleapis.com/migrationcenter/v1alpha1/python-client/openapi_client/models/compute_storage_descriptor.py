...
class ComputeStorageDescriptor(BaseModel):
    """
    Compute Engine storage option descriptor.
    """ # noqa: E501
    size_gb: Optional[StrictInt] = Field(default=None, description="Disk size in GiB.", alias="sizeGb")
    type: Optional[StrictStr] = Field(default=None, description="Disk type backing the storage.")
    __properties: ClassVar[List[str]] = ["sizeGb", "type"]
