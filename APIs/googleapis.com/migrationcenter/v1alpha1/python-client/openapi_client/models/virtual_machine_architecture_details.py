...
class VirtualMachineArchitectureDetails(BaseModel):
    """
    ...
    cpu_manufacturer: Optional[StrictStr] = Field(default=None, description="CPU manufacturer, e.g., \"Intel\", \"AMD\".", alias="cpuManufacturer")
    ...
    firmware: Optional[StrictStr] = Field(default=None, description="Firmware (BIOS/efi).")
    hyperthreading: Optional[StrictStr] = Field(default=None, description="CPU hyperthreading support.")
    vendor: Optional[StrictStr] = Field(default=None, description="Hardware vendor.")
    __properties: ClassVar[List[str]] = ["bios", "cpuArchitecture", "cpuManufacturer", "cpuName", "cpuSocketCount", "cpuThreadCount", "firmware", "hyperthreading", "vendor"]
    ...
    def hyperthreading_validate_enum(cls, value):
        ...
        if value not in set(['HYPER_THREADING_UNSPECIFIED', 'HYPER_THREADING_DISABLED', 'HYPER_THREADING_ENABLED']):
            raise ValueError("must be one of enum values ('HYPER_THREADING_UNSPECIFIED', 'HYPER_THREADING_DISABLED', 'HYPER_THREADING_ENABLED')")
        return value
