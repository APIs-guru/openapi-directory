...
class HostsEntryList(BaseModel):
    """
    Hosts content.
    """ # noqa: E501
    entries: Optional[List[HostsEntry]] = Field(default=None, description="Hosts entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [HostsEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
