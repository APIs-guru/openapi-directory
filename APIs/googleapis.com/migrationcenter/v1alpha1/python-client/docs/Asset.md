...
**hidden** | **bool** | Optional. Indicates if the asset is hidden. | [optional] 
**hide_reason** | **str** | Optional. An optional reason for marking this asset as hidden. | [optional] 
**hide_time** | **str** | Output only. The timestamp when the asset was marked as hidden. | [optional] [readonly] 
