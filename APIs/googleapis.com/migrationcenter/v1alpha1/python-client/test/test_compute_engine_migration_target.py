...
class TestComputeEngineMigrationTarget(unittest.TestCase):
    """ComputeEngineMigrationTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeEngineMigrationTarget:
        """Test ComputeEngineMigrationTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeEngineMigrationTarget`
        """
        model = ComputeEngineMigrationTarget()
        if include_optional:
    ...
    def testComputeEngineMigrationTarget(self):
        """Test ComputeEngineMigrationTarget"""
