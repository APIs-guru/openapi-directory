...
class TestCreateShortDynamicLinkRequest(unittest.TestCase):
    """CreateShortDynamicLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateShortDynamicLinkRequest:
        """Test CreateShortDynamicLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShortDynamicLinkRequest`
        """
        model = CreateShortDynamicLinkRequest()
        if include_optional:
    ...
    def testCreateShortDynamicLinkRequest(self):
        """Test CreateShortDynamicLinkRequest"""
