...
class TestManagedShortLink(unittest.TestCase):
    """ManagedShortLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedShortLink:
        """Test ManagedShortLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedShortLink`
        """
        model = ManagedShortLink()
        if include_optional:
