...
class TestCreateManagedShortLinkResponse(unittest.TestCase):
    """CreateManagedShortLinkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateManagedShortLinkResponse:
        """Test CreateManagedShortLinkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateManagedShortLinkResponse`
        """
        model = CreateManagedShortLinkResponse()
        if include_optional:
            return CreateManagedShortLinkResponse(
                managed_short_link = openapi_client.models.managed_short_link.ManagedShortLink(
                    creation_time = '', 
                    flagged_attribute = [
                        'UNSPECIFIED_ATTRIBUTE'
                        ], 
                    info = openapi_client.models.dynamic_link_info.DynamicLinkInfo(
                    ...
                    link = '', 
                    link_name = '', 
                    visibility = 'UNSPECIFIED_VISIBILITY', ),
                preview_link = '',
                warning = [
    ...
    def testCreateManagedShortLinkResponse(self):
        """Test CreateManagedShortLinkResponse"""
