...
class ShortLinksApi:
    ...
    def firebasedynamiclinks_short_links_create(
        ...
        create_short_dynamic_link_request: Optional[CreateShortDynamicLinkRequest] = None,
        ...
        :param create_short_dynamic_link_request:
        :type create_short_dynamic_link_request: CreateShortDynamicLinkRequest
        ...
        _param = self._firebasedynamiclinks_short_links_create_serialize(
            xgafv=xgafv,
            ...
            create_short_dynamic_link_request=create_short_dynamic_link_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateShortDynamicLinkResponse",
        }
    ...
    @validate_call
    def firebasedynamiclinks_short_links_create_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateShortDynamicLinkResponse]:
        """firebasedynamiclinks_short_links_create
    ...
    @validate_call
    def firebasedynamiclinks_short_links_create_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _firebasedynamiclinks_short_links_create_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        upload_protocol,
        upload_type,
        create_short_dynamic_link_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_short_dynamic_link_request is not None:
            _body_params = create_short_dynamic_link_request
