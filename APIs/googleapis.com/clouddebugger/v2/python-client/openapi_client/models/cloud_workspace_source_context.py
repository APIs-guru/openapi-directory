...
class CloudWorkspaceSourceContext(BaseModel):
    """
    A CloudWorkspaceSourceContext denotes a workspace at a particular snapshot.
    """ # noqa: E501
    snapshot_id: Optional[StrictStr] = Field(default=None, description="The ID of the snapshot. An empty snapshot_id refers to the most recent snapshot.", alias="snapshotId")
    workspace_id: Optional[CloudWorkspaceId] = Field(default=None, alias="workspaceId")
    __properties: ClassVar[List[str]] = ["snapshotId", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workspaceId": CloudWorkspaceId.from_dict(obj["workspaceId"]) if obj.get("workspaceId") is not None else None
        })
        return _obj
