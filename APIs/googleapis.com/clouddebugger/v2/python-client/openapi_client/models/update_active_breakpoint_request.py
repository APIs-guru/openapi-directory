...
class UpdateActiveBreakpointRequest(BaseModel):
    """
    Request to update an active breakpoint.
    """ # noqa: E501
    breakpoint: Optional[Breakpoint] = None
    __properties: ClassVar[List[str]] = ["breakpoint"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of breakpoint
        if self.breakpoint:
            _dict['breakpoint'] = self.breakpoint.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakpoint": Breakpoint.from_dict(obj["breakpoint"]) if obj.get("breakpoint") is not None else None
        })
        return _obj
