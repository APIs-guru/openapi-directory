...
class TestRegisterDebuggeeResponse(unittest.TestCase):
    """RegisterDebuggeeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterDebuggeeResponse:
        """Test RegisterDebuggeeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterDebuggeeResponse`
        """
        model = RegisterDebuggeeResponse()
        if include_optional:
            return RegisterDebuggeeResponse(
                agent_id = '',
                debuggee = openapi_client.models.debuggee.Debuggee(
                    agent_version = '', 
    ...
    def testRegisterDebuggeeResponse(self):
        """Test RegisterDebuggeeResponse"""
