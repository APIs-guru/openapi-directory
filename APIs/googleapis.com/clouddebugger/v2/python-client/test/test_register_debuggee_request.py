...
class TestRegisterDebuggeeRequest(unittest.TestCase):
    """RegisterDebuggeeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterDebuggeeRequest:
        """Test RegisterDebuggeeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterDebuggeeRequest`
        """
        model = RegisterDebuggeeRequest()
        if include_optional:
    ...
    def testRegisterDebuggeeRequest(self):
        """Test RegisterDebuggeeRequest"""
