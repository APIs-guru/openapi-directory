...
class TestListDebuggeesResponse(unittest.TestCase):
    """ListDebuggeesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDebuggeesResponse:
        """Test ListDebuggeesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDebuggeesResponse`
        """
        model = ListDebuggeesResponse()
        if include_optional:
            return ListDebuggeesResponse(
                debuggees = [
                    openapi_client.models.debuggee.Debuggee(
                        agent_version = '', 
    ...
    def testListDebuggeesResponse(self):
        """Test ListDebuggeesResponse"""
