...
class GoogleCloudKmsV1CryptoKey(BaseModel):
    ...
    primary: Optional[GoogleCloudKmsV1CryptoKeyVersion] = None
    ...
    version_template: Optional[GoogleCloudKmsV1CryptoKeyVersionTemplate] = Field(default=None, alias="versionTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primary": GoogleCloudKmsV1CryptoKeyVersion.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "purpose": obj.get("purpose"),
            "rotationPeriod": obj.get("rotationPeriod"),
            "versionTemplate": GoogleCloudKmsV1CryptoKeyVersionTemplate.from_dict(obj["versionTemplate"]) if obj.get("versionTemplate") is not None else None
        })
        return _obj
