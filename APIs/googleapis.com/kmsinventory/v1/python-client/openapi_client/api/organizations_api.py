...
class OrganizationsApi:
    ...
    def kmsinventory_organizations_protected_resources_search(
        self,
        scope: Annotated[StrictStr, Field(description="Required. Resource name of the organization. Example: organizations/123")],
        ...
        crypto_key: Annotated[Optional[StrictStr], Field(description="Required. The resource name of the CryptoKey.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of resources to return. The service may return fewer than this value. If unspecified, at most 500 resources will be returned. The maximum value is 500; values above 500 will be coerced to 500.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A page token, received from a previous KeyTrackingService.SearchProtectedResources call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to KeyTrackingService.SearchProtectedResources must match the call that provided the page token.")] = None,
        resource_types: Annotated[Optional[List[StrictStr]], Field(description="Optional. A list of resource types that this request searches for. If empty, it will search all the [trackable resource types](https://cloud.google.com/kms/docs/view-key-usage#tracked-resource-types). Regular expressions are also supported. For example: * `compute.googleapis.com.*` snapshots resources whose type starts with `compute.googleapis.com`. * `.*Image` snapshots resources whose type ends with `Image`. * `.*Image.*` snapshots resources whose type contains `Image`. See [RE2](https://github.com/google/re2/wiki/Syntax) for all supported regular expression syntax. If the regular expression does not match any supported resource type, an INVALID_ARGUMENT error will be returned.")] = None,
        ...
        _param = self._kmsinventory_organizations_protected_resources_search_serialize(
            scope=scope,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudKmsInventoryV1SearchProtectedResourcesResponse",
        }
    ...
    @validate_call
    def kmsinventory_organizations_protected_resources_search_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="Required. Resource name of the organization. Example: organizations/123")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def kmsinventory_organizations_protected_resources_search_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="Required. Resource name of the organization. Example: organizations/123")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _kmsinventory_organizations_protected_resources_search_serialize(
        self,
        scope,
        xgafv,
        access_token,
        ...
        if crypto_key is not None:
            ...
            _query_params.append(('cryptoKey', crypto_key))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/{scope}/protectedResources:search',
