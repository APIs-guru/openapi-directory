...
class ProjectsApi:
    ...
    def kmsinventory_projects_crypto_keys_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The Google Cloud project for which to retrieve key metadata, in the format `projects/*`")],
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of keys to return. The service may return fewer than this value. If unspecified, at most 1000 keys will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. Pass this into a subsequent request in order to receive the next page of results.")] = None,
        ...
        :param parent: Required. The Google Cloud project for which to retrieve key metadata, in the format `projects/*` (required)
        :type parent: str
        ...
        _param = self._kmsinventory_projects_crypto_keys_list_serialize(
            parent=parent,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudKmsInventoryV1ListCryptoKeysResponse",
        }
    ...
    @validate_call
    def kmsinventory_projects_crypto_keys_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The Google Cloud project for which to retrieve key metadata, in the format `projects/*`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def kmsinventory_projects_crypto_keys_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The Google Cloud project for which to retrieve key metadata, in the format `projects/*`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _kmsinventory_projects_crypto_keys_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
    ...
    def kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the CryptoKey.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        _param = self._kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudKmsInventoryV1ProtectedResourcesSummary",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the CryptoKey.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the CryptoKey.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary_serialize(
        self,
        name,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/{name}/protectedResourcesSummary',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
