...
class SetDataValidationRequest(BaseModel):
    ...
    rule: Optional[DataValidationRule] = None
    __properties: ClassVar[List[str]] = ["range", "rule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rule": DataValidationRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None
        })
        return _obj
