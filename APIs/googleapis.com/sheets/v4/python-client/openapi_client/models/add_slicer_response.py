...
class AddSlicerResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["slicer"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of slicer
        if self.slicer:
            _dict['slicer'] = self.slicer.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "slicer": Slicer.from_dict(obj["slicer"]) if obj.get("slicer") is not None else None
        })
        return _obj
