...
class InterpolationPoint(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="How the value should be interpreted.")
    value: Optional[StrictStr] = Field(default=None, description="The value this interpolation point uses. May be a formula. Unused if type is MIN or MAX.")
    __properties: ClassVar[List[str]] = ["color", "colorStyle", "type", "value"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['INTERPOLATION_POINT_TYPE_UNSPECIFIED', 'MIN', 'MAX', 'NUMBER', 'PERCENT', 'PERCENTILE']):
            raise ValueError("must be one of enum values ('INTERPOLATION_POINT_TYPE_UNSPECIFIED', 'MIN', 'MAX', 'NUMBER', 'PERCENT', 'PERCENTILE')")
        return value
