...
class UpdateDeveloperMetadataResponse(BaseModel):
    ...
    """ # noqa: E501
    developer_metadata: Optional[List[DeveloperMetadata]] = Field(default=None, description="The updated developer metadata.", alias="developerMetadata")
    __properties: ClassVar[List[str]] = ["developerMetadata"]
