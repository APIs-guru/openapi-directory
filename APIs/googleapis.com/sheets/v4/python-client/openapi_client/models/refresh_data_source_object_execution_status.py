...
class RefreshDataSourceObjectExecutionStatus(BaseModel):
    ...
    reference: Optional[DataSourceObjectReference] = None
    __properties: ClassVar[List[str]] = ["dataExecutionStatus", "reference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reference": DataSourceObjectReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None
        })
        return _obj
