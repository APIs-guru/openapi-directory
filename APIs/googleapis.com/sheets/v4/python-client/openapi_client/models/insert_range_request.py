...
class InsertRangeRequest(BaseModel):
    ...
    shift_dimension: Optional[StrictStr] = Field(default=None, description="The dimension which will be shifted when inserting cells. If ROWS, existing cells will be shifted down. If COLUMNS, existing cells will be shifted right.", alias="shiftDimension")
