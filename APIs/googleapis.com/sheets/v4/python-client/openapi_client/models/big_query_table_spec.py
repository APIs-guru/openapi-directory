...
class BigQueryTableSpec(BaseModel):
    ...
    table_project_id: Optional[StrictStr] = Field(default=None, description="The ID of a BigQuery project the table belongs to. If not specified, the project_id is assumed.", alias="tableProjectId")
    __properties: ClassVar[List[str]] = ["datasetId", "tableId", "tableProjectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tableProjectId": obj.get("tableProjectId")
        })
        return _obj
