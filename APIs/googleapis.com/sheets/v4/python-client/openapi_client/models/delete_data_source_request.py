...
class DeleteDataSourceRequest(BaseModel):
    ...
    """ # noqa: E501
    data_source_id: Optional[StrictStr] = Field(default=None, description="The ID of the data source to delete.", alias="dataSourceId")
    __properties: ClassVar[List[str]] = ["dataSourceId"]
