...
class SearchDeveloperMetadataRequest(BaseModel):
    ...
    """ # noqa: E501
    data_filters: Optional[List[DataFilter]] = Field(default=None, description="The data filters describing the criteria used to determine which DeveloperMetadata entries to return. DeveloperMetadata matching any of the specified filters are included in the response.", alias="dataFilters")
    __properties: ClassVar[List[str]] = ["dataFilters"]
