...
class RowData(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[CellData]] = Field(default=None, description="The values in the row, one per column.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [CellData.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
