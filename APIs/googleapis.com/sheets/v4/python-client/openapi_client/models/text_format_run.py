...
class TextFormatRun(BaseModel):
    ...
    start_index: Optional[StrictInt] = Field(default=None, description="The zero-based character index where this run starts, in UTF-16 code units.", alias="startIndex")
    __properties: ClassVar[List[str]] = ["format", "startIndex"]
