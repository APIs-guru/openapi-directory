...
class GetSpreadsheetByDataFilterRequest(BaseModel):
    ...
    """ # noqa: E501
    data_filters: Optional[List[DataFilter]] = Field(default=None, description="The DataFilters used to select which ranges to retrieve from the spreadsheet.", alias="dataFilters")
    include_grid_data: Optional[StrictBool] = Field(default=None, description="True if grid data should be returned. This parameter is ignored if a field mask was set in the request.", alias="includeGridData")
    __properties: ClassVar[List[str]] = ["dataFilters", "includeGridData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeGridData": obj.get("includeGridData")
        })
        return _obj
