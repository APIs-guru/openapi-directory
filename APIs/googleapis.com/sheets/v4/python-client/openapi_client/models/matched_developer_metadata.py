...
class MatchedDeveloperMetadata(BaseModel):
    ...
    """ # noqa: E501
    data_filters: Optional[List[DataFilter]] = Field(default=None, description="All filters matching the returned developer metadata.", alias="dataFilters")
    developer_metadata: Optional[DeveloperMetadata] = Field(default=None, alias="developerMetadata")
    __properties: ClassVar[List[str]] = ["dataFilters", "developerMetadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of developer_metadata
        if self.developer_metadata:
            _dict['developerMetadata'] = self.developer_metadata.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "developerMetadata": DeveloperMetadata.from_dict(obj["developerMetadata"]) if obj.get("developerMetadata") is not None else None
        })
        return _obj
