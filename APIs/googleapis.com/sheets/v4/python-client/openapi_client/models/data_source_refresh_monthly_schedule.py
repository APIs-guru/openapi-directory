...
class DataSourceRefreshMonthlySchedule(BaseModel):
    ...
    """ # noqa: E501
    days_of_month: Optional[List[StrictInt]] = Field(default=None, description="Days of the month to refresh. Only 1-28 are supported, mapping to the 1st to the 28th day. At least one day must be specified.", alias="daysOfMonth")
    start_time: Optional[TimeOfDay] = Field(default=None, alias="startTime")
    __properties: ClassVar[List[str]] = ["daysOfMonth", "startTime"]
