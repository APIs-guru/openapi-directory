...
class AddConditionalFormatRuleRequest(BaseModel):
    ...
    """ # noqa: E501
    index: Optional[StrictInt] = Field(default=None, description="The zero-based index where the rule should be inserted.")
    rule: Optional[ConditionalFormatRule] = None
    __properties: ClassVar[List[str]] = ["index", "rule"]
