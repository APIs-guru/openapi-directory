...
class DataSourceObjectReferences(BaseModel):
    ...
    """ # noqa: E501
    references: Optional[List[DataSourceObjectReference]] = Field(default=None, description="The references.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "references": [DataSourceObjectReference.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None
        })
        return _obj
