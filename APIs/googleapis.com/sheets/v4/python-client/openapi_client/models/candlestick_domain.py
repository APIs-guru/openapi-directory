...
class CandlestickDomain(BaseModel):
    ...
    reversed: Optional[StrictBool] = Field(default=None, description="True to reverse the order of the domain values (horizontal axis).")
    __properties: ClassVar[List[str]] = ["data", "reversed"]
