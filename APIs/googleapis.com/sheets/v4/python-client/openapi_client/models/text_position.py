...
class TextPosition(BaseModel):
    ...
    """ # noqa: E501
    horizontal_alignment: Optional[StrictStr] = Field(default=None, description="Horizontal alignment setting for the piece of text.", alias="horizontalAlignment")
    __properties: ClassVar[List[str]] = ["horizontalAlignment"]
