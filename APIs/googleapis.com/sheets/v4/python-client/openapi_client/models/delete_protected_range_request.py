...
class DeleteProtectedRangeRequest(BaseModel):
    ...
    """ # noqa: E501
    protected_range_id: Optional[StrictInt] = Field(default=None, description="The ID of the protected range to delete.", alias="protectedRangeId")
    __properties: ClassVar[List[str]] = ["protectedRangeId"]
