...
class BatchUpdateValuesRequest(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[ValueRange]] = Field(default=None, description="The new values to apply to the spreadsheet.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ValueRange.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
