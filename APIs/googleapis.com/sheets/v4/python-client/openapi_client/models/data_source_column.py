...
class DataSourceColumn(BaseModel):
    ...
    """ # noqa: E501
    formula: Optional[StrictStr] = Field(default=None, description="The formula of the calculated column.")
    reference: Optional[DataSourceColumnReference] = None
    __properties: ClassVar[List[str]] = ["formula", "reference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reference": DataSourceColumnReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None
        })
        return _obj
