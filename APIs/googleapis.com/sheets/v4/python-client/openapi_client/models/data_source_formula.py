...
class DataSourceFormula(BaseModel):
    ...
    data_source_id: Optional[StrictStr] = Field(default=None, description="The ID of the data source the formula is associated with.", alias="dataSourceId")
    __properties: ClassVar[List[str]] = ["dataExecutionStatus", "dataSourceId"]
