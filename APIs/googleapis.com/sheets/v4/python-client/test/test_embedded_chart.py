...
class TestEmbeddedChart(unittest.TestCase):
    """EmbeddedChart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmbeddedChart:
        """Test EmbeddedChart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmbeddedChart`
        """
        model = EmbeddedChart()
        if include_optional:
