...
class TestAddProtectedRangeRequest(unittest.TestCase):
    """AddProtectedRangeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddProtectedRangeRequest:
        """Test AddProtectedRangeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddProtectedRangeRequest`
        """
        model = AddProtectedRangeRequest()
        if include_optional:
    ...
    def testAddProtectedRangeRequest(self):
        """Test AddProtectedRangeRequest"""
