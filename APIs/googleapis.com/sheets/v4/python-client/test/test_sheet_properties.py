...
class TestSheetProperties(unittest.TestCase):
    """SheetProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SheetProperties:
        """Test SheetProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SheetProperties`
        """
        model = SheetProperties()
        if include_optional:
