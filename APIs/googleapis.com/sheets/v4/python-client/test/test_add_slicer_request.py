...
class TestAddSlicerRequest(unittest.TestCase):
    """AddSlicerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddSlicerRequest:
        """Test AddSlicerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddSlicerRequest`
        """
        model = AddSlicerRequest()
        if include_optional:
