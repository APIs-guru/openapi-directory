...
class TestBatchClearValuesByDataFilterRequest(unittest.TestCase):
    """BatchClearValuesByDataFilterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchClearValuesByDataFilterRequest:
        """Test BatchClearValuesByDataFilterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchClearValuesByDataFilterRequest`
        """
        model = BatchClearValuesByDataFilterRequest()
        if include_optional:
    ...
    def testBatchClearValuesByDataFilterRequest(self):
        """Test BatchClearValuesByDataFilterRequest"""
