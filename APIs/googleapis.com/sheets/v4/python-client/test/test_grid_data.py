...
class TestGridData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GridData:
        """Test GridData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridData`
        """
        model = GridData()
        if include_optional:
            return GridData(
                ...
                row_data = [
                    openapi_client.models.row_data.RowData(
                        values = [
                            openapi_client.models.cell_data.CellData(
