...
class TestDuplicateFilterViewResponse(unittest.TestCase):
    """DuplicateFilterViewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DuplicateFilterViewResponse:
        """Test DuplicateFilterViewResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DuplicateFilterViewResponse`
        """
        model = DuplicateFilterViewResponse()
        if include_optional:
    ...
    def testDuplicateFilterViewResponse(self):
        """Test DuplicateFilterViewResponse"""
