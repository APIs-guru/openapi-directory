...
class TestAddSheetRequest(unittest.TestCase):
    """AddSheetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddSheetRequest:
        """Test AddSheetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddSheetRequest`
        """
        model = AddSheetRequest()
        if include_optional:
