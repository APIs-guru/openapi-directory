...
class TestUpdateChartSpecRequest(unittest.TestCase):
    """UpdateChartSpecRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateChartSpecRequest:
        """Test UpdateChartSpecRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateChartSpecRequest`
        """
        model = UpdateChartSpecRequest()
        if include_optional:
    ...
    def testUpdateChartSpecRequest(self):
        """Test UpdateChartSpecRequest"""
