...
class TestAddFilterViewRequest(unittest.TestCase):
    """AddFilterViewRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddFilterViewRequest:
        """Test AddFilterViewRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddFilterViewRequest`
        """
        model = AddFilterViewRequest()
        if include_optional:
    ...
    def testAddFilterViewRequest(self):
        """Test AddFilterViewRequest"""
