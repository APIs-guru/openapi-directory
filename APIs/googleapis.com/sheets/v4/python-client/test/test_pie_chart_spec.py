...
class TestPieChartSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PieChartSpec:
        """Test PieChartSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PieChartSpec`
        """
        model = PieChartSpec()
        if include_optional:
            return PieChartSpec(
