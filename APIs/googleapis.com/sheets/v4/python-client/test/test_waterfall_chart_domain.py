...
class TestWaterfallChartDomain(unittest.TestCase):
    """WaterfallChartDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaterfallChartDomain:
        """Test WaterfallChartDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaterfallChartDomain`
        """
        model = WaterfallChartDomain()
        if include_optional:
    ...
    def testWaterfallChartDomain(self):
        """Test WaterfallChartDomain"""
