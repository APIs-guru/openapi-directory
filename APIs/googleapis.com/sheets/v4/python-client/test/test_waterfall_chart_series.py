...
class TestWaterfallChartSeries(unittest.TestCase):
    """WaterfallChartSeries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaterfallChartSeries:
        """Test WaterfallChartSeries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaterfallChartSeries`
        """
        model = WaterfallChartSeries()
        if include_optional:
            return WaterfallChartSeries(
                ...
                positive_columns_style = openapi_client.models.waterfall_chart_column_style.WaterfallChartColumnStyle(
                    ...
                    color_style = openapi_client.models.color_style.ColorStyle(
                        ...
                        theme_color = 'THEME_COLOR_TYPE_UNSPECIFIED', ), 
                    label = '', ),
                subtotal_columns_style = openapi_client.models.waterfall_chart_column_style.WaterfallChartColumnStyle(
                    color = openapi_client.models.color.Color(
                        alpha = 1.337, 
                        blue = 1.337, 
                        green = 1.337, 
    ...
    def testWaterfallChartSeries(self):
        """Test WaterfallChartSeries"""
