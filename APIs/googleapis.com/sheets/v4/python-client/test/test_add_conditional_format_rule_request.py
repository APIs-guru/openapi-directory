...
class TestAddConditionalFormatRuleRequest(unittest.TestCase):
    """AddConditionalFormatRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddConditionalFormatRuleRequest:
        """Test AddConditionalFormatRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddConditionalFormatRuleRequest`
        """
        model = AddConditionalFormatRuleRequest()
        if include_optional:
    ...
    def testAddConditionalFormatRuleRequest(self):
        """Test AddConditionalFormatRuleRequest"""
