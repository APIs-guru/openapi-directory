...
class TestAddBandingResponse(unittest.TestCase):
    """AddBandingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddBandingResponse:
        """Test AddBandingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddBandingResponse`
        """
        model = AddBandingResponse()
        if include_optional:
    ...
    def testAddBandingResponse(self):
        """Test AddBandingResponse"""
