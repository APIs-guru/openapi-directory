...
class TestBasicChartDomain(unittest.TestCase):
    """BasicChartDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicChartDomain:
        """Test BasicChartDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicChartDomain`
        """
        model = BasicChartDomain()
        if include_optional:
