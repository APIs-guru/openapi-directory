...
class TestPivotGroupRule(unittest.TestCase):
    """PivotGroupRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PivotGroupRule:
        """Test PivotGroupRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PivotGroupRule`
        """
        model = PivotGroupRule()
        if include_optional:
