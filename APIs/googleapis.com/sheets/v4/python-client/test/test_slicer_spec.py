...
class TestSlicerSpec(unittest.TestCase):
    """SlicerSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlicerSpec:
        """Test SlicerSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlicerSpec`
        """
        model = SlicerSpec()
        if include_optional:
            return SlicerSpec(
