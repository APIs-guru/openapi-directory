...
class TestBasicChartSeries(unittest.TestCase):
    """BasicChartSeries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicChartSeries:
        """Test BasicChartSeries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicChartSeries`
        """
        model = BasicChartSeries()
        if include_optional:
