...
class TestMatchedDeveloperMetadata(unittest.TestCase):
    """MatchedDeveloperMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchedDeveloperMetadata:
        """Test MatchedDeveloperMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchedDeveloperMetadata`
        """
        model = MatchedDeveloperMetadata()
        if include_optional:
    ...
    def testMatchedDeveloperMetadata(self):
        """Test MatchedDeveloperMetadata"""
