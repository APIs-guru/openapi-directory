...
class TestAddSheetResponse(unittest.TestCase):
    """AddSheetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddSheetResponse:
        """Test AddSheetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddSheetResponse`
        """
        model = AddSheetResponse()
        if include_optional:
