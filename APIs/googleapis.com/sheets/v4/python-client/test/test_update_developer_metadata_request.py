...
class TestUpdateDeveloperMetadataRequest(unittest.TestCase):
    """UpdateDeveloperMetadataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDeveloperMetadataRequest:
        """Test UpdateDeveloperMetadataRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDeveloperMetadataRequest`
        """
        model = UpdateDeveloperMetadataRequest()
        if include_optional:
    ...
    def testUpdateDeveloperMetadataRequest(self):
        """Test UpdateDeveloperMetadataRequest"""
