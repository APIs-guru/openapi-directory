...
class TestBatchUpdateValuesByDataFilterResponse(unittest.TestCase):
    """BatchUpdateValuesByDataFilterResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateValuesByDataFilterResponse:
        """Test BatchUpdateValuesByDataFilterResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateValuesByDataFilterResponse`
        """
        model = BatchUpdateValuesByDataFilterResponse()
        if include_optional:
            return BatchUpdateValuesByDataFilterResponse(
                responses = [
                    openapi_client.models.update_values_by_data_filter_response.UpdateValuesByDataFilterResponse(
                ...
                spreadsheet_id = '',
                total_updated_cells = 56,
                total_updated_columns = 56,
                total_updated_rows = 56,
                total_updated_sheets = 56
            )
        else:
            return BatchUpdateValuesByDataFilterResponse(
        )
    ...
    def testBatchUpdateValuesByDataFilterResponse(self):
        """Test BatchUpdateValuesByDataFilterResponse"""
