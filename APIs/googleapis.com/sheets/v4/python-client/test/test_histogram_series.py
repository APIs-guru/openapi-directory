...
class TestHistogramSeries(unittest.TestCase):
    """HistogramSeries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistogramSeries:
        """Test HistogramSeries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistogramSeries`
        """
        model = HistogramSeries()
        if include_optional:
