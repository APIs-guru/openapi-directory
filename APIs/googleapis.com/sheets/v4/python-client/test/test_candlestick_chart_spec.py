...
class TestCandlestickChartSpec(unittest.TestCase):
    """CandlestickChartSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CandlestickChartSpec:
        """Test CandlestickChartSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandlestickChartSpec`
        """
        model = CandlestickChartSpec()
        if include_optional:
    ...
    def testCandlestickChartSpec(self):
        """Test CandlestickChartSpec"""
