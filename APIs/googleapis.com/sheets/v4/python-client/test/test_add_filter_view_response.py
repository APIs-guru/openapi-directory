...
class TestAddFilterViewResponse(unittest.TestCase):
    """AddFilterViewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddFilterViewResponse:
        """Test AddFilterViewResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddFilterViewResponse`
        """
        model = AddFilterViewResponse()
        if include_optional:
    ...
    def testAddFilterViewResponse(self):
        """Test AddFilterViewResponse"""
