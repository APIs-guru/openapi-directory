...
class TestAddChartRequest(unittest.TestCase):
    """AddChartRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddChartRequest:
        """Test AddChartRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddChartRequest`
        """
        model = AddChartRequest()
        if include_optional:
