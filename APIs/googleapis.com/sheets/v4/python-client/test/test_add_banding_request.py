...
class TestAddBandingRequest(unittest.TestCase):
    """AddBandingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddBandingRequest:
        """Test AddBandingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddBandingRequest`
        """
        model = AddBandingRequest()
        if include_optional:
    ...
    def testAddBandingRequest(self):
        """Test AddBandingRequest"""
