...
class TestDimensionRange(unittest.TestCase):
    """DimensionRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DimensionRange:
        """Test DimensionRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DimensionRange`
        """
        model = DimensionRange()
        if include_optional:
