...
class TestCreateDeveloperMetadataRequest(unittest.TestCase):
    """CreateDeveloperMetadataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDeveloperMetadataRequest:
        """Test CreateDeveloperMetadataRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDeveloperMetadataRequest`
        """
        model = CreateDeveloperMetadataRequest()
        if include_optional:
    ...
    def testCreateDeveloperMetadataRequest(self):
        """Test CreateDeveloperMetadataRequest"""
