...
class TestAddChartResponse(unittest.TestCase):
    """AddChartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddChartResponse:
        """Test AddChartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddChartResponse`
        """
        model = AddChartResponse()
        if include_optional:
