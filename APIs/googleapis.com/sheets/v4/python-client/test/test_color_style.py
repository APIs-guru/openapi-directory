...
class TestColorStyle(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ColorStyle:
        """Test ColorStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ColorStyle`
        """
        model = ColorStyle()
        if include_optional:
            return ColorStyle(
