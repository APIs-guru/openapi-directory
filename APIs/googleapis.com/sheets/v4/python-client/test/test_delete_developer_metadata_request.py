...
class TestDeleteDeveloperMetadataRequest(unittest.TestCase):
    """DeleteDeveloperMetadataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteDeveloperMetadataRequest:
        """Test DeleteDeveloperMetadataRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteDeveloperMetadataRequest`
        """
        model = DeleteDeveloperMetadataRequest()
        if include_optional:
    ...
    def testDeleteDeveloperMetadataRequest(self):
        """Test DeleteDeveloperMetadataRequest"""
