...
class TestUpdateCellsRequest(unittest.TestCase):
    """UpdateCellsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCellsRequest:
        """Test UpdateCellsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCellsRequest`
        """
        model = UpdateCellsRequest()
        if include_optional:
            return UpdateCellsRequest(
                ...
                start = openapi_client.models.grid_coordinate.GridCoordinate(
                    column_index = 56, 
                    row_index = 56, 
                    sheet_id = 56, )
            )
    ...
    def testUpdateCellsRequest(self):
        """Test UpdateCellsRequest"""
