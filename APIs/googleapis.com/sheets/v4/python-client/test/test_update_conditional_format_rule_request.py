...
class TestUpdateConditionalFormatRuleRequest(unittest.TestCase):
    """UpdateConditionalFormatRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateConditionalFormatRuleRequest:
        """Test UpdateConditionalFormatRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateConditionalFormatRuleRequest`
        """
        model = UpdateConditionalFormatRuleRequest()
        if include_optional:
    ...
    def testUpdateConditionalFormatRuleRequest(self):
        """Test UpdateConditionalFormatRuleRequest"""
