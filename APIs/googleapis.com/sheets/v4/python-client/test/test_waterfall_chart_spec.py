...
class TestWaterfallChartSpec(unittest.TestCase):
    """WaterfallChartSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaterfallChartSpec:
        """Test WaterfallChartSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaterfallChartSpec`
        """
        model = WaterfallChartSpec()
        if include_optional:
    ...
    def testWaterfallChartSpec(self):
        """Test WaterfallChartSpec"""
