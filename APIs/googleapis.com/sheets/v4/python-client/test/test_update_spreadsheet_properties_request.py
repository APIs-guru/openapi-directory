...
class TestUpdateSpreadsheetPropertiesRequest(unittest.TestCase):
    """UpdateSpreadsheetPropertiesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpreadsheetPropertiesRequest:
        """Test UpdateSpreadsheetPropertiesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpreadsheetPropertiesRequest`
        """
        model = UpdateSpreadsheetPropertiesRequest()
        if include_optional:
    ...
    def testUpdateSpreadsheetPropertiesRequest(self):
        """Test UpdateSpreadsheetPropertiesRequest"""
