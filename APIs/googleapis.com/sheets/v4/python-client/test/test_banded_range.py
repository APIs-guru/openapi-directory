...
class TestBandedRange(unittest.TestCase):
    """BandedRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BandedRange:
        """Test BandedRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BandedRange`
        """
        model = BandedRange()
        if include_optional:
            return BandedRange(
