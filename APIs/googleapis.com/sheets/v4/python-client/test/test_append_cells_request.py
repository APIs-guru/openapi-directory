...
class TestAppendCellsRequest(unittest.TestCase):
    """AppendCellsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendCellsRequest:
        """Test AppendCellsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendCellsRequest`
        """
        model = AppendCellsRequest()
        if include_optional:
    ...
    def testAppendCellsRequest(self):
        """Test AppendCellsRequest"""
