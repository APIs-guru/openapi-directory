...
class TestUpdateDeveloperMetadataResponse(unittest.TestCase):
    """UpdateDeveloperMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDeveloperMetadataResponse:
        """Test UpdateDeveloperMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDeveloperMetadataResponse`
        """
        model = UpdateDeveloperMetadataResponse()
        if include_optional:
    ...
    def testUpdateDeveloperMetadataResponse(self):
        """Test UpdateDeveloperMetadataResponse"""
