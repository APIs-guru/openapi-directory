...
class TestDeleteDeveloperMetadataResponse(unittest.TestCase):
    """DeleteDeveloperMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteDeveloperMetadataResponse:
        """Test DeleteDeveloperMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteDeveloperMetadataResponse`
        """
        model = DeleteDeveloperMetadataResponse()
        if include_optional:
    ...
    def testDeleteDeveloperMetadataResponse(self):
        """Test DeleteDeveloperMetadataResponse"""
