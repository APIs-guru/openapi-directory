...
class TestRepeatCellRequest(unittest.TestCase):
    """RepeatCellRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepeatCellRequest:
        """Test RepeatCellRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepeatCellRequest`
        """
        model = RepeatCellRequest()
        if include_optional:
    ...
    def testRepeatCellRequest(self):
        """Test RepeatCellRequest"""
