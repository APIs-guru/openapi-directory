...
class TestUpdateFilterViewRequest(unittest.TestCase):
    """UpdateFilterViewRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFilterViewRequest:
        """Test UpdateFilterViewRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFilterViewRequest`
        """
        model = UpdateFilterViewRequest()
        if include_optional:
    ...
    def testUpdateFilterViewRequest(self):
        """Test UpdateFilterViewRequest"""
