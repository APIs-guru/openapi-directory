...
class TestGetSpreadsheetByDataFilterRequest(unittest.TestCase):
    """GetSpreadsheetByDataFilterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpreadsheetByDataFilterRequest:
        """Test GetSpreadsheetByDataFilterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpreadsheetByDataFilterRequest`
        """
        model = GetSpreadsheetByDataFilterRequest()
        if include_optional:
    ...
    def testGetSpreadsheetByDataFilterRequest(self):
        """Test GetSpreadsheetByDataFilterRequest"""
