...
class TestBatchUpdateValuesByDataFilterRequest(unittest.TestCase):
    """BatchUpdateValuesByDataFilterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateValuesByDataFilterRequest:
        """Test BatchUpdateValuesByDataFilterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateValuesByDataFilterRequest`
        """
        model = BatchUpdateValuesByDataFilterRequest()
        if include_optional:
            return BatchUpdateValuesByDataFilterRequest(
                data = [
                    openapi_client.models.data_filter_value_range.DataFilterValueRange(
    ...
    def testBatchUpdateValuesByDataFilterRequest(self):
        """Test BatchUpdateValuesByDataFilterRequest"""
