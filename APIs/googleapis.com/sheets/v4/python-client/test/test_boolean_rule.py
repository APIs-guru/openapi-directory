...
class TestBooleanRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BooleanRule:
        """Test BooleanRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanRule`
        """
        model = BooleanRule()
        if include_optional:
            return BooleanRule(
