...
class TestRefreshDataSourceResponse(unittest.TestCase):
    """RefreshDataSourceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefreshDataSourceResponse:
        """Test RefreshDataSourceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefreshDataSourceResponse`
        """
        model = RefreshDataSourceResponse()
        if include_optional:
    ...
    def testRefreshDataSourceResponse(self):
        """Test RefreshDataSourceResponse"""
