...
class GoogleCloudVisionV1p3beta1ReferenceImage(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boundingPolys": [GoogleCloudVisionV1p3beta1BoundingPoly.from_dict(_item) for _item in obj["boundingPolys"]] if obj.get("boundingPolys") is not None else None,
            "name": obj.get("name"),
            "uri": obj.get("uri")
        })
        return _obj
