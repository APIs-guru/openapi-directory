...
class ImportProductSetsRequest(BaseModel):
    """
    Request message for the `ImportProductSets` method.
    """ # noqa: E501
    input_config: Optional[ImportProductSetsInputConfig] = Field(default=None, alias="inputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputConfig": ImportProductSetsInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None
        })
        return _obj
