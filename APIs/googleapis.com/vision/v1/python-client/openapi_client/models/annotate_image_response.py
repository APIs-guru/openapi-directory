...
class AnnotateImageResponse(BaseModel):
    ...
    """ # noqa: E501
    context: Optional[ImageAnnotationContext] = None
    crop_hints_annotation: Optional[CropHintsAnnotation] = Field(default=None, alias="cropHintsAnnotation")
    error: Optional[Status] = None
    face_annotations: Optional[List[FaceAnnotation]] = Field(default=None, description="If present, face detection has completed successfully.", alias="faceAnnotations")
    full_text_annotation: Optional[TextAnnotation] = Field(default=None, alias="fullTextAnnotation")
    image_properties_annotation: Optional[ImageProperties] = Field(default=None, alias="imagePropertiesAnnotation")
    label_annotations: Optional[List[EntityAnnotation]] = Field(default=None, description="If present, label detection has completed successfully.", alias="labelAnnotations")
    landmark_annotations: Optional[List[EntityAnnotation]] = Field(default=None, description="If present, landmark detection has completed successfully.", alias="landmarkAnnotations")
    localized_object_annotations: Optional[List[LocalizedObjectAnnotation]] = Field(default=None, description="If present, localized object detection has completed successfully. This will be sorted descending by confidence score.", alias="localizedObjectAnnotations")
    logo_annotations: Optional[List[EntityAnnotation]] = Field(default=None, description="If present, logo detection has completed successfully.", alias="logoAnnotations")
    product_search_results: Optional[ProductSearchResults] = Field(default=None, alias="productSearchResults")
    safe_search_annotation: Optional[SafeSearchAnnotation] = Field(default=None, alias="safeSearchAnnotation")
    text_annotations: Optional[List[EntityAnnotation]] = Field(default=None, description="If present, text (OCR) detection has completed successfully.", alias="textAnnotations")
    web_detection: Optional[WebDetection] = Field(default=None, alias="webDetection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "context": ImageAnnotationContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "cropHintsAnnotation": CropHintsAnnotation.from_dict(obj["cropHintsAnnotation"]) if obj.get("cropHintsAnnotation") is not None else None,
            "error": Status.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "faceAnnotations": [FaceAnnotation.from_dict(_item) for _item in obj["faceAnnotations"]] if obj.get("faceAnnotations") is not None else None,
            "fullTextAnnotation": TextAnnotation.from_dict(obj["fullTextAnnotation"]) if obj.get("fullTextAnnotation") is not None else None,
            "imagePropertiesAnnotation": ImageProperties.from_dict(obj["imagePropertiesAnnotation"]) if obj.get("imagePropertiesAnnotation") is not None else None,
            "labelAnnotations": [EntityAnnotation.from_dict(_item) for _item in obj["labelAnnotations"]] if obj.get("labelAnnotations") is not None else None,
            "landmarkAnnotations": [EntityAnnotation.from_dict(_item) for _item in obj["landmarkAnnotations"]] if obj.get("landmarkAnnotations") is not None else None,
            "localizedObjectAnnotations": [LocalizedObjectAnnotation.from_dict(_item) for _item in obj["localizedObjectAnnotations"]] if obj.get("localizedObjectAnnotations") is not None else None,
            "logoAnnotations": [EntityAnnotation.from_dict(_item) for _item in obj["logoAnnotations"]] if obj.get("logoAnnotations") is not None else None,
            "productSearchResults": ProductSearchResults.from_dict(obj["productSearchResults"]) if obj.get("productSearchResults") is not None else None,
            "safeSearchAnnotation": SafeSearchAnnotation.from_dict(obj["safeSearchAnnotation"]) if obj.get("safeSearchAnnotation") is not None else None,
            "textAnnotations": [EntityAnnotation.from_dict(_item) for _item in obj["textAnnotations"]] if obj.get("textAnnotations") is not None else None,
            "webDetection": WebDetection.from_dict(obj["webDetection"]) if obj.get("webDetection") is not None else None
        })
        return _obj
