...
class GoogleCloudVisionV1p4beta1Symbol(BaseModel):
    ...
    """ # noqa: E501
    bounding_box: Optional[GoogleCloudVisionV1p4beta1BoundingPoly] = Field(default=None, alias="boundingBox")
    ...
    var_property: Optional[GoogleCloudVisionV1p4beta1TextAnnotationTextProperty] = Field(default=None, alias="property")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1Symbol from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1Symbol from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "boundingBox": GoogleCloudVisionV1p4beta1BoundingPoly.from_dict(obj["boundingBox"]) if obj.get("boundingBox") is not None else None,
            "confidence": obj.get("confidence"),
            "property": GoogleCloudVisionV1p4beta1TextAnnotationTextProperty.from_dict(obj["property"]) if obj.get("property") is not None else None,
            "text": obj.get("text")
        })
        return _obj
