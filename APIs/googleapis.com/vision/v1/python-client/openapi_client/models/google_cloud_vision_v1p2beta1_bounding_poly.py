...
class GoogleCloudVisionV1p2beta1BoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    normalized_vertices: Optional[List[GoogleCloudVisionV1p2beta1NormalizedVertex]] = Field(default=None, description="The bounding polygon normalized vertices.", alias="normalizedVertices")
    vertices: Optional[List[GoogleCloudVisionV1p2beta1Vertex]] = Field(default=None, description="The bounding polygon vertices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedVertices": [GoogleCloudVisionV1p2beta1NormalizedVertex.from_dict(_item) for _item in obj["normalizedVertices"]] if obj.get("normalizedVertices") is not None else None,
            "vertices": [GoogleCloudVisionV1p2beta1Vertex.from_dict(_item) for _item in obj["vertices"]] if obj.get("vertices") is not None else None
        })
        return _obj
