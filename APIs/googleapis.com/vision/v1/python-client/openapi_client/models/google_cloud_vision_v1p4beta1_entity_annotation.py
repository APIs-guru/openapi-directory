...
class GoogleCloudVisionV1p4beta1EntityAnnotation(BaseModel):
    ...
    properties: Optional[List[GoogleCloudVisionV1p4beta1Property]] = Field(default=None, description="Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "locations": [GoogleCloudVisionV1p4beta1LocationInfo.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
            "mid": obj.get("mid"),
            "properties": [GoogleCloudVisionV1p4beta1Property.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            "score": obj.get("score"),
