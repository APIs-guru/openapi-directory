...
class GoogleCloudVisionV1p2beta1LocationInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["latLng"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1LocationInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1LocationInfo from a dict"""
        if obj is None:
            return None
