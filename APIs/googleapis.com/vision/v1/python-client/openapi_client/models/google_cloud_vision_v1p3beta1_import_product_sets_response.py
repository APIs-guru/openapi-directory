...
class GoogleCloudVisionV1p3beta1ImportProductSetsResponse(BaseModel):
    ...
    """ # noqa: E501
    reference_images: Optional[List[GoogleCloudVisionV1p3beta1ReferenceImage]] = Field(default=None, description="The list of reference_images that are imported successfully.", alias="referenceImages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "referenceImages": [GoogleCloudVisionV1p3beta1ReferenceImage.from_dict(_item) for _item in obj["referenceImages"]] if obj.get("referenceImages") is not None else None,
