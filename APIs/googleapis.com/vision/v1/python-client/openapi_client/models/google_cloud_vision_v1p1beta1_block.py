...
class GoogleCloudVisionV1p1beta1Block(BaseModel):
    ...
    paragraphs: Optional[List[GoogleCloudVisionV1p1beta1Paragraph]] = Field(default=None, description="List of paragraphs in this block (if this blocks is of type text).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paragraphs": [GoogleCloudVisionV1p1beta1Paragraph.from_dict(_item) for _item in obj["paragraphs"]] if obj.get("paragraphs") is not None else None,
