...
class ImportProductSetsInputConfig(BaseModel):
    """
    The input content for the `ImportProductSets` method.
    """ # noqa: E501
    gcs_source: Optional[ImportProductSetsGcsSource] = Field(default=None, alias="gcsSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gcsSource": ImportProductSetsGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None
        })
        return _obj
