...
class GoogleCloudVisionV1p3beta1WebDetectionWebPage(BaseModel):
    ...
    """ # noqa: E501
    full_matching_images: Optional[List[GoogleCloudVisionV1p3beta1WebDetectionWebImage]] = Field(default=None, description="Fully matching images on the page. Can include resized copies of the query image.", alias="fullMatchingImages")
