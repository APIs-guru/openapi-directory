...
class BatchAnnotateFilesRequest(BaseModel):
    """
    ...
    requests: Optional[List[AnnotateFileRequest]] = Field(default=None, description="Required. The list of file annotation requests. Right now we support only one AnnotateFileRequest in BatchAnnotateFilesRequest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [AnnotateFileRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
