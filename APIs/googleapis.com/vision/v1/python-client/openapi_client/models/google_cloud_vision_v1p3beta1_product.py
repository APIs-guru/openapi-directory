...
class GoogleCloudVisionV1p3beta1Product(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productLabels": [GoogleCloudVisionV1p3beta1ProductKeyValue.from_dict(_item) for _item in obj["productLabels"]] if obj.get("productLabels") is not None else None
        })
        return _obj
