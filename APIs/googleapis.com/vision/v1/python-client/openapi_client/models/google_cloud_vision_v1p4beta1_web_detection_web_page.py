...
class GoogleCloudVisionV1p4beta1WebDetectionWebPage(BaseModel):
    ...
    """ # noqa: E501
    full_matching_images: Optional[List[GoogleCloudVisionV1p4beta1WebDetectionWebImage]] = Field(default=None, description="Fully matching images on the page. Can include resized copies of the query image.", alias="fullMatchingImages")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1WebDetectionWebPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1WebDetectionWebPage from a dict"""
        if obj is None:
            return None
