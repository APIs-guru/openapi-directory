...
product_search_params_instance = ProductSearchParams.from_json(json)
# print the JSON string representation of the object
print(ProductSearchParams.to_json())

# convert the object into a dict
product_search_params_dict = product_search_params_instance.to_dict()
# create an instance of ProductSearchParams from a dict
product_search_params_from_dict = ProductSearchParams.from_dict(product_search_params_dict)
```
