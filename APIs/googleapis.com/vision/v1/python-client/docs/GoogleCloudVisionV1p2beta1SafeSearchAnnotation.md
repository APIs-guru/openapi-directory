...
google_cloud_vision_v1p2beta1_safe_search_annotation_instance = GoogleCloudVisionV1p2beta1SafeSearchAnnotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p2beta1SafeSearchAnnotation.to_json())

# convert the object into a dict
google_cloud_vision_v1p2beta1_safe_search_annotation_dict = google_cloud_vision_v1p2beta1_safe_search_annotation_instance.to_dict()
# create an instance of GoogleCloudVisionV1p2beta1SafeSearchAnnotation from a dict
google_cloud_vision_v1p2beta1_safe_search_annotation_from_dict = GoogleCloudVisionV1p2beta1SafeSearchAnnotation.from_dict(google_cloud_vision_v1p2beta1_safe_search_annotation_dict)
```
