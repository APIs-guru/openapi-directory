...
google_cloud_vision_v1p4beta1_reference_image_instance = GoogleCloudVisionV1p4beta1ReferenceImage.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p4beta1ReferenceImage.to_json())

# convert the object into a dict
google_cloud_vision_v1p4beta1_reference_image_dict = google_cloud_vision_v1p4beta1_reference_image_instance.to_dict()
# create an instance of GoogleCloudVisionV1p4beta1ReferenceImage from a dict
google_cloud_vision_v1p4beta1_reference_image_from_dict = GoogleCloudVisionV1p4beta1ReferenceImage.from_dict(google_cloud_vision_v1p4beta1_reference_image_dict)
```
