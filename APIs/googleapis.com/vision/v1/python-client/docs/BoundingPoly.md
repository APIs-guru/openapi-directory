...
------------ | ------------- | ------------- | -------------
**normalized_vertices** | [**List[NormalizedVertex]**](NormalizedVertex.md) | The bounding polygon normalized vertices. | [optional] 
**vertices** | [**List[Vertex]**](Vertex.md) | The bounding polygon vertices. | [optional] 
