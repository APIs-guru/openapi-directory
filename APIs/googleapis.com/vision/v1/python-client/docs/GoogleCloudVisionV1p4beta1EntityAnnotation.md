...
json = "{}"
# create an instance of GoogleCloudVisionV1p4beta1EntityAnnotation from a JSON string
google_cloud_vision_v1p4beta1_entity_annotation_instance = GoogleCloudVisionV1p4beta1EntityAnnotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p4beta1EntityAnnotation.to_json())

# convert the object into a dict
google_cloud_vision_v1p4beta1_entity_annotation_dict = google_cloud_vision_v1p4beta1_entity_annotation_instance.to_dict()
# create an instance of GoogleCloudVisionV1p4beta1EntityAnnotation from a dict
google_cloud_vision_v1p4beta1_entity_annotation_from_dict = GoogleCloudVisionV1p4beta1EntityAnnotation.from_dict(google_cloud_vision_v1p4beta1_entity_annotation_dict)
```
