...
class TestGoogleCloudVisionV1p2beta1CropHint(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1CropHint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1CropHint:
        """Test GoogleCloudVisionV1p2beta1CropHint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1CropHint`
        """
        model = GoogleCloudVisionV1p2beta1CropHint()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p2beta1CropHint(self):
        """Test GoogleCloudVisionV1p2beta1CropHint"""
