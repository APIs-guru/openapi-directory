...
json = "{}"
# create an instance of GoogleCloudVisionV1p2beta1ProductSearchParams from a JSON string
google_cloud_vision_v1p2beta1_product_search_params_instance = GoogleCloudVisionV1p2beta1ProductSearchParams.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p2beta1ProductSearchParams.to_json())

# convert the object into a dict
google_cloud_vision_v1p2beta1_product_search_params_dict = google_cloud_vision_v1p2beta1_product_search_params_instance.to_dict()
# create an instance of GoogleCloudVisionV1p2beta1ProductSearchParams from a dict
google_cloud_vision_v1p2beta1_product_search_params_from_dict = GoogleCloudVisionV1p2beta1ProductSearchParams.from_dict(google_cloud_vision_v1p2beta1_product_search_params_dict)
```
