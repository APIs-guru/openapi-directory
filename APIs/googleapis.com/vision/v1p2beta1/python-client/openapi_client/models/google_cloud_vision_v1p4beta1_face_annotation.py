...
class GoogleCloudVisionV1p4beta1FaceAnnotation(BaseModel):
    ...
    bounding_poly: Optional[GoogleCloudVisionV1p4beta1BoundingPoly] = Field(default=None, alias="boundingPoly")
    ...
    fd_bounding_poly: Optional[GoogleCloudVisionV1p4beta1BoundingPoly] = Field(default=None, alias="fdBoundingPoly")
    ...
    landmarks: Optional[List[GoogleCloudVisionV1p4beta1FaceAnnotationLandmark]] = Field(default=None, description="Detected face landmarks.")
    ...
    recognition_result: Optional[List[GoogleCloudVisionV1p4beta1FaceRecognitionResult]] = Field(default=None, description="Additional recognition information. Only computed if image_context.face_recognition_params is provided, **and** a match is found to a Celebrity in the input CelebritySet. This field is sorted in order of decreasing confidence values.", alias="recognitionResult")
    ...
    __properties: ClassVar[List[str]] = ["angerLikelihood", "blurredLikelihood", "boundingPoly", "detectionConfidence", "fdBoundingPoly", "headwearLikelihood", "joyLikelihood", "landmarkingConfidence", "landmarks", "panAngle", "recognitionResult", "rollAngle", "sorrowLikelihood", "surpriseLikelihood", "tiltAngle", "underExposedLikelihood"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in recognition_result (list)
        _items = []
        if self.recognition_result:
            for _item_recognition_result in self.recognition_result:
                if _item_recognition_result:
                    _items.append(_item_recognition_result.to_dict())
            _dict['recognitionResult'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boundingPoly": GoogleCloudVisionV1p4beta1BoundingPoly.from_dict(obj["boundingPoly"]) if obj.get("boundingPoly") is not None else None,
            "detectionConfidence": obj.get("detectionConfidence"),
            "fdBoundingPoly": GoogleCloudVisionV1p4beta1BoundingPoly.from_dict(obj["fdBoundingPoly"]) if obj.get("fdBoundingPoly") is not None else None,
            ...
            "landmarks": [GoogleCloudVisionV1p4beta1FaceAnnotationLandmark.from_dict(_item) for _item in obj["landmarks"]] if obj.get("landmarks") is not None else None,
            "panAngle": obj.get("panAngle"),
            "recognitionResult": [GoogleCloudVisionV1p4beta1FaceRecognitionResult.from_dict(_item) for _item in obj["recognitionResult"]] if obj.get("recognitionResult") is not None else None,
