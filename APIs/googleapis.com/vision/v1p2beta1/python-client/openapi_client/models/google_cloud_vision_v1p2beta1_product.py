...
class GoogleCloudVisionV1p2beta1Product(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1Product from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1Product from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "productLabels": [GoogleCloudVisionV1p2beta1ProductKeyValue.from_dict(_item) for _item in obj["productLabels"]] if obj.get("productLabels") is not None else None
        })
        return _obj
