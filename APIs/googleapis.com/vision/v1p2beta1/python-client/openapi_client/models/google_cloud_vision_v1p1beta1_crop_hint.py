...
class GoogleCloudVisionV1p1beta1CropHint(BaseModel):
    ...
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence of this being a salient region. Range [0, 1].")
    importance_fraction: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fraction of importance of this salient region with respect to the original image.", alias="importanceFraction")
    __properties: ClassVar[List[str]] = ["boundingPoly", "confidence", "importanceFraction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "importanceFraction": obj.get("importanceFraction")
        })
        return _obj
