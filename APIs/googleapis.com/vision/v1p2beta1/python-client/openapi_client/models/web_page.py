...
class WebPage(BaseModel):
    ...
    """ # noqa: E501
    full_matching_images: Optional[List[WebImage]] = Field(default=None, description="Fully matching images on the page. Can include resized copies of the query image.", alias="fullMatchingImages")
    ...
    partial_matching_images: Optional[List[WebImage]] = Field(default=None, description="Partial matching images on the page. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.", alias="partialMatchingImages")
