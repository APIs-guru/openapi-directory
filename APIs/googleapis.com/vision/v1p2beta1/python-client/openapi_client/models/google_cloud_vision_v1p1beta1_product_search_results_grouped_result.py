...
class GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult(BaseModel):
    ...
    object_annotations: Optional[List[GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation]] = Field(default=None, description="List of generic predictions for the object in the bounding box.", alias="objectAnnotations")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "objectAnnotations": [GoogleCloudVisionV1p1beta1ProductSearchResultsObjectAnnotation.from_dict(_item) for _item in obj["objectAnnotations"]] if obj.get("objectAnnotations") is not None else None,
