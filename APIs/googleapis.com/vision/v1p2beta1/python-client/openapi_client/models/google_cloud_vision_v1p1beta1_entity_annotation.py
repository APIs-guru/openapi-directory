...
class GoogleCloudVisionV1p1beta1EntityAnnotation(BaseModel):
    ...
    locations: Optional[List[GoogleCloudVisionV1p1beta1LocationInfo]] = Field(default=None, description="The location information for the detected entity. Multiple `LocationInfo` elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks.")
    ...
    properties: Optional[List[GoogleCloudVisionV1p1beta1Property]] = Field(default=None, description="Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "locations": [GoogleCloudVisionV1p1beta1LocationInfo.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
            "mid": obj.get("mid"),
            "properties": [GoogleCloudVisionV1p1beta1Property.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            "score": obj.get("score"),
