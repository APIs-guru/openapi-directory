...
class GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest(BaseModel):
    """
    ...
    requests: Optional[List[GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest]] = Field(default=None, description="Required. Individual async file annotation requests for this batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
