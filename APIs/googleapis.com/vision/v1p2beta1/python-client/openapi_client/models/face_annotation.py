...
class FaceAnnotation(BaseModel):
    ...
    fd_bounding_poly: Optional[BoundingPoly] = Field(default=None, alias="fdBoundingPoly")
    ...
    landmarks: Optional[List[Landmark]] = Field(default=None, description="Detected face landmarks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fdBoundingPoly": BoundingPoly.from_dict(obj["fdBoundingPoly"]) if obj.get("fdBoundingPoly") is not None else None,
            ...
            "landmarks": [Landmark.from_dict(_item) for _item in obj["landmarks"]] if obj.get("landmarks") is not None else None,
