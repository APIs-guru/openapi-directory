...
class GoogleCloudVisionV1p2beta1AnnotateImageRequest(BaseModel):
    """
    Request for performing Google Cloud Vision API tasks over a user-provided image, with user-requested features, and with context information.
    """ # noqa: E501
    features: Optional[List[GoogleCloudVisionV1p2beta1Feature]] = Field(default=None, description="Requested features.")
    image: Optional[GoogleCloudVisionV1p2beta1Image] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": GoogleCloudVisionV1p2beta1Image.from_dict(obj["image"]) if obj.get("image") is not None else None,
