...
class GoogleCloudVisionV1p3beta1LocationInfo(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p3beta1LocationInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p3beta1LocationInfo from a dict"""
        if obj is None:
            return None
