...
class BoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    normalized_vertices: Optional[List[NormalizedVertex]] = Field(default=None, description="The bounding polygon normalized vertices.", alias="normalizedVertices")
    vertices: Optional[List[Vertex]] = Field(default=None, description="The bounding polygon vertices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedVertices": [NormalizedVertex.from_dict(_item) for _item in obj["normalizedVertices"]] if obj.get("normalizedVertices") is not None else None,
            "vertices": [Vertex.from_dict(_item) for _item in obj["vertices"]] if obj.get("vertices") is not None else None
        })
        return _obj
