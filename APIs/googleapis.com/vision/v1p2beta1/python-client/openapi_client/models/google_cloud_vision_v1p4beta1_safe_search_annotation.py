...
class GoogleCloudVisionV1p4beta1SafeSearchAnnotation(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1SafeSearchAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1SafeSearchAnnotation from a dict"""
        if obj is None:
            return None
