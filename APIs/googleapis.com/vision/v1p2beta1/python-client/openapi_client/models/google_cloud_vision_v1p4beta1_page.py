...
class GoogleCloudVisionV1p4beta1Page(BaseModel):
    ...
    """ # noqa: E501
    blocks: Optional[List[GoogleCloudVisionV1p4beta1Block]] = Field(default=None, description="List of blocks of text, images etc on this page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [GoogleCloudVisionV1p4beta1Block.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None,
