...
class GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse(BaseModel):
    """
    Response to a batch image annotation request.
    """ # noqa: E501
    responses: Optional[List[GoogleCloudVisionV1p2beta1AnnotateImageResponse]] = Field(default=None, description="Individual responses to image annotation requests within the batch.")
