...
class GoogleCloudVisionV1p2beta1TextAnnotation(BaseModel):
    ...
    """ # noqa: E501
    pages: Optional[List[GoogleCloudVisionV1p2beta1Page]] = Field(default=None, description="List of pages detected by OCR.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pages": [GoogleCloudVisionV1p2beta1Page.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "text": obj.get("text")
        })
        return _obj
