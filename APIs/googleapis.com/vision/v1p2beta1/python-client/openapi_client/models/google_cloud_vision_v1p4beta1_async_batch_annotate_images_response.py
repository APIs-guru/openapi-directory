...
class GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse(BaseModel):
    ...
    """ # noqa: E501
    output_config: Optional[GoogleCloudVisionV1p4beta1OutputConfig] = Field(default=None, alias="outputConfig")
    __properties: ClassVar[List[str]] = ["outputConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputConfig": GoogleCloudVisionV1p4beta1OutputConfig.from_dict(obj["outputConfig"]) if obj.get("outputConfig") is not None else None
        })
        return _obj
