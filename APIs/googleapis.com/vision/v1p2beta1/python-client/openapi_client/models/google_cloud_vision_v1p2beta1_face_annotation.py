...
class GoogleCloudVisionV1p2beta1FaceAnnotation(BaseModel):
    ...
    fd_bounding_poly: Optional[GoogleCloudVisionV1p2beta1BoundingPoly] = Field(default=None, alias="fdBoundingPoly")
    ...
    landmarks: Optional[List[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]] = Field(default=None, description="Detected face landmarks.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1FaceAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p2beta1FaceAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fdBoundingPoly": GoogleCloudVisionV1p2beta1BoundingPoly.from_dict(obj["fdBoundingPoly"]) if obj.get("fdBoundingPoly") is not None else None,
            ...
            "landmarks": [GoogleCloudVisionV1p2beta1FaceAnnotationLandmark.from_dict(_item) for _item in obj["landmarks"]] if obj.get("landmarks") is not None else None,
