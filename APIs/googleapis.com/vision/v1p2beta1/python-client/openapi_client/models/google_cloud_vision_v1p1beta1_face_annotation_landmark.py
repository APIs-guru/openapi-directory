...
class GoogleCloudVisionV1p1beta1FaceAnnotationLandmark(BaseModel):
    ...
    """ # noqa: E501
    position: Optional[GoogleCloudVisionV1p1beta1Position] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "position": GoogleCloudVisionV1p1beta1Position.from_dict(obj["position"]) if obj.get("position") is not None else None,
            "type": obj.get("type")
        })
        return _obj
