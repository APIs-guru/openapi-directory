...
class TestGoogleCloudVisionV1p3beta1Page(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1Page unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1Page:
        """Test GoogleCloudVisionV1p3beta1Page
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1Page`
        """
        model = GoogleCloudVisionV1p3beta1Page()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1Page(self):
        """Test GoogleCloudVisionV1p3beta1Page"""
