...
class TestGoogleCloudVisionV1p3beta1Paragraph(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1Paragraph unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1Paragraph:
        """Test GoogleCloudVisionV1p3beta1Paragraph
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1Paragraph`
        """
        model = GoogleCloudVisionV1p3beta1Paragraph()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1Paragraph(self):
        """Test GoogleCloudVisionV1p3beta1Paragraph"""
