...
class TestGoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest:
        """Test GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest`
        """
        model = GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest()
        if include_optional:
            return GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest(
                ...
                parent = '',
                requests = [
                    openapi_client.models.google_cloud_vision_v1p2beta1_annotate_image_request.GoogleCloudVisionV1p2beta1AnnotateImageRequest(
                        features = [
                        ...
                        image = openapi_client.models.google_cloud_vision_v1p2beta1_image.GoogleCloudVisionV1p2beta1Image(
                            content = 'YQ==', 
                            source = openapi_client.models.google_cloud_vision_v1p2beta1_image_source.GoogleCloudVisionV1p2beta1ImageSource(
                                gcs_image_uri = '', 
                                image_uri = '', ), ), 
    ...
    def testGoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest(self):
        """Test GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest"""
