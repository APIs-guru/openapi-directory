...
class TestGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult:
        """Test GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult`
        """
        model = GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult(self):
        """Test GoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult"""
