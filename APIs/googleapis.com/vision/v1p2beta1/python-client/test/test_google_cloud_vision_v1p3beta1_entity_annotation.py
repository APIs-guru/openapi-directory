...
class TestGoogleCloudVisionV1p3beta1EntityAnnotation(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1EntityAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1EntityAnnotation:
        """Test GoogleCloudVisionV1p3beta1EntityAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1EntityAnnotation`
        """
        model = GoogleCloudVisionV1p3beta1EntityAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1EntityAnnotation(self):
        """Test GoogleCloudVisionV1p3beta1EntityAnnotation"""
