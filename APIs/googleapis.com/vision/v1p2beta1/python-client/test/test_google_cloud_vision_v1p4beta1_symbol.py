...
class TestGoogleCloudVisionV1p4beta1Symbol(unittest.TestCase):
    """GoogleCloudVisionV1p4beta1Symbol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p4beta1Symbol:
        """Test GoogleCloudVisionV1p4beta1Symbol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p4beta1Symbol`
        """
        model = GoogleCloudVisionV1p4beta1Symbol()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p4beta1Symbol(self):
        """Test GoogleCloudVisionV1p4beta1Symbol"""
