...
class TestGoogleCloudVisionV1p4beta1Word(unittest.TestCase):
    """GoogleCloudVisionV1p4beta1Word unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p4beta1Word:
        """Test GoogleCloudVisionV1p4beta1Word
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p4beta1Word`
        """
        model = GoogleCloudVisionV1p4beta1Word()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p4beta1Word(self):
        """Test GoogleCloudVisionV1p4beta1Word"""
