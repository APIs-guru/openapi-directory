...
class TestGoogleCloudVisionV1p2beta1AnnotateFileRequest(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1AnnotateFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1AnnotateFileRequest:
        """Test GoogleCloudVisionV1p2beta1AnnotateFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1AnnotateFileRequest`
        """
        model = GoogleCloudVisionV1p2beta1AnnotateFileRequest()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p2beta1AnnotateFileRequest(self):
        """Test GoogleCloudVisionV1p2beta1AnnotateFileRequest"""
