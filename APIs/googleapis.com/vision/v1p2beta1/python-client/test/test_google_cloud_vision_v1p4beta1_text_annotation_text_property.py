...
class TestGoogleCloudVisionV1p4beta1TextAnnotationTextProperty(unittest.TestCase):
    """GoogleCloudVisionV1p4beta1TextAnnotationTextProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p4beta1TextAnnotationTextProperty:
        """Test GoogleCloudVisionV1p4beta1TextAnnotationTextProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p4beta1TextAnnotationTextProperty`
        """
        model = GoogleCloudVisionV1p4beta1TextAnnotationTextProperty()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p4beta1TextAnnotationTextProperty(self):
        """Test GoogleCloudVisionV1p4beta1TextAnnotationTextProperty"""
