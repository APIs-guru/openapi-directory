...
class TestGoogleCloudVisionV1p2beta1AnnotateImageRequest(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1AnnotateImageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1AnnotateImageRequest:
        """Test GoogleCloudVisionV1p2beta1AnnotateImageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1AnnotateImageRequest`
        """
        model = GoogleCloudVisionV1p2beta1AnnotateImageRequest()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p2beta1AnnotateImageRequest(self):
        """Test GoogleCloudVisionV1p2beta1AnnotateImageRequest"""
