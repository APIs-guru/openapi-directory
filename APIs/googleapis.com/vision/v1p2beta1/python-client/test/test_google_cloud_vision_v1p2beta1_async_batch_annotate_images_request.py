...
class TestGoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest:
        """Test GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest`
        """
        model = GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest()
        if include_optional:
            return GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest(
                labels = {
                    'key' : ''
                    },
    ...
    def testGoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest(self):
        """Test GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest"""
