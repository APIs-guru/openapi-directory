...
class TestGoogleCloudVisionV1p2beta1ImageContext(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1ImageContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1ImageContext:
        """Test GoogleCloudVisionV1p2beta1ImageContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1ImageContext`
        """
        model = GoogleCloudVisionV1p2beta1ImageContext()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p2beta1ImageContext(self):
        """Test GoogleCloudVisionV1p2beta1ImageContext"""
