...
class TestGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest(unittest.TestCase):
    """GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest:
        """Test GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest`
        """
        model = GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest(self):
        """Test GoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest"""
