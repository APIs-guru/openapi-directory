...
class GoogleCloudVisionV1p3beta1FaceAnnotation(BaseModel):
    ...
    fd_bounding_poly: Optional[GoogleCloudVisionV1p3beta1BoundingPoly] = Field(default=None, alias="fdBoundingPoly")
    ...
    landmarks: Optional[List[GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]] = Field(default=None, description="Detected face landmarks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fdBoundingPoly": GoogleCloudVisionV1p3beta1BoundingPoly.from_dict(obj["fdBoundingPoly"]) if obj.get("fdBoundingPoly") is not None else None,
            ...
            "landmarks": [GoogleCloudVisionV1p3beta1FaceAnnotationLandmark.from_dict(_item) for _item in obj["landmarks"]] if obj.get("landmarks") is not None else None,
