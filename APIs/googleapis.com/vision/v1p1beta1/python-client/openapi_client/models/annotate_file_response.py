...
class AnnotateFileResponse(BaseModel):
    ...
    responses: Optional[List[AnnotateImageResponse]] = Field(default=None, description="Individual responses to images found within the file. This field will be empty if the `error` field is set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [AnnotateImageResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
