...
class GoogleCloudVisionV1p3beta1Block(BaseModel):
    ...
    bounding_box: Optional[GoogleCloudVisionV1p3beta1BoundingPoly] = Field(default=None, alias="boundingBox")
    ...
    paragraphs: Optional[List[GoogleCloudVisionV1p3beta1Paragraph]] = Field(default=None, description="List of paragraphs in this block (if this blocks is of type text).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boundingBox": GoogleCloudVisionV1p3beta1BoundingPoly.from_dict(obj["boundingBox"]) if obj.get("boundingBox") is not None else None,
            "confidence": obj.get("confidence"),
            "paragraphs": [GoogleCloudVisionV1p3beta1Paragraph.from_dict(_item) for _item in obj["paragraphs"]] if obj.get("paragraphs") is not None else None,
