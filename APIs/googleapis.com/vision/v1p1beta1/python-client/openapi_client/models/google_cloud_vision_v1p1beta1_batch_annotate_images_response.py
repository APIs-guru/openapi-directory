...
class GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[GoogleCloudVisionV1p1beta1AnnotateImageResponse]] = Field(default=None, description="Individual responses to image annotation requests within the batch.")
