...
class GoogleCloudVisionV1p1beta1Paragraph(BaseModel):
    ...
    words: Optional[List[GoogleCloudVisionV1p1beta1Word]] = Field(default=None, description="List of all words in this paragraph.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "words": [GoogleCloudVisionV1p1beta1Word.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
