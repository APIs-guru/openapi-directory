...
class GoogleCloudVisionV1p2beta1AnnotateFileResponse(BaseModel):
    ...
    input_config: Optional[GoogleCloudVisionV1p2beta1InputConfig] = Field(default=None, alias="inputConfig")
    responses: Optional[List[GoogleCloudVisionV1p2beta1AnnotateImageResponse]] = Field(default=None, description="Individual responses to images found within the file. This field will be empty if the `error` field is set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputConfig": GoogleCloudVisionV1p2beta1InputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None,
            "responses": [GoogleCloudVisionV1p2beta1AnnotateImageResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
