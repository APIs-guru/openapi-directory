...
class ProductSearchResults(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productGroupedResults": [GroupedResult.from_dict(_item) for _item in obj["productGroupedResults"]] if obj.get("productGroupedResults") is not None else None,
