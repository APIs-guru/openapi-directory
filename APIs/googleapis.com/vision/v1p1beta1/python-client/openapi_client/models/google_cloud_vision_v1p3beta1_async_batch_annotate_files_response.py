...
class GoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse]] = Field(default=None, description="The list of file annotation responses, one for each request in AsyncBatchAnnotateFilesRequest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
