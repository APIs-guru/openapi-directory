...
class TextProperty(BaseModel):
    ...
    """ # noqa: E501
    detected_break: Optional[DetectedBreak] = Field(default=None, alias="detectedBreak")
    detected_languages: Optional[List[DetectedLanguage]] = Field(default=None, description="A list of detected languages together with confidence.", alias="detectedLanguages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detectedBreak": DetectedBreak.from_dict(obj["detectedBreak"]) if obj.get("detectedBreak") is not None else None,
            "detectedLanguages": [DetectedLanguage.from_dict(_item) for _item in obj["detectedLanguages"]] if obj.get("detectedLanguages") is not None else None
        })
        return _obj
