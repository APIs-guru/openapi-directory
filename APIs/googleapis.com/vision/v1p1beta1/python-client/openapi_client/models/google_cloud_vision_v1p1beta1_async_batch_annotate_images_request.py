...
class GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest(BaseModel):
    ...
    requests: Optional[List[GoogleCloudVisionV1p1beta1AnnotateImageRequest]] = Field(default=None, description="Required. Individual image annotation requests for this batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [GoogleCloudVisionV1p1beta1AnnotateImageRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
