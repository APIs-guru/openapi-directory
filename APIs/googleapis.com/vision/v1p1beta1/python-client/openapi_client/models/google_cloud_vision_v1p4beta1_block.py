...
class GoogleCloudVisionV1p4beta1Block(BaseModel):
    ...
    paragraphs: Optional[List[GoogleCloudVisionV1p4beta1Paragraph]] = Field(default=None, description="List of paragraphs in this block (if this blocks is of type text).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1Block from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVisionV1p4beta1Block from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "paragraphs": [GoogleCloudVisionV1p4beta1Paragraph.from_dict(_item) for _item in obj["paragraphs"]] if obj.get("paragraphs") is not None else None,
