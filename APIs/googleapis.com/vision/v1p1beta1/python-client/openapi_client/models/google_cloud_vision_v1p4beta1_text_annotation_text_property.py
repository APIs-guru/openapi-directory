...
class GoogleCloudVisionV1p4beta1TextAnnotationTextProperty(BaseModel):
    ...
    """ # noqa: E501
    detected_break: Optional[GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak] = Field(default=None, alias="detectedBreak")
    detected_languages: Optional[List[GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage]] = Field(default=None, description="A list of detected languages together with confidence.", alias="detectedLanguages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detectedBreak": GoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak.from_dict(obj["detectedBreak"]) if obj.get("detectedBreak") is not None else None,
            "detectedLanguages": [GoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage.from_dict(_item) for _item in obj["detectedLanguages"]] if obj.get("detectedLanguages") is not None else None
        })
        return _obj
