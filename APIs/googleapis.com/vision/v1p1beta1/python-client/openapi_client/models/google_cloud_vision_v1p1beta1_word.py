...
class GoogleCloudVisionV1p1beta1Word(BaseModel):
    ...
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence of the OCR results for the word. Range [0, 1].")
    var_property: Optional[GoogleCloudVisionV1p1beta1TextAnnotationTextProperty] = Field(default=None, alias="property")
    symbols: Optional[List[GoogleCloudVisionV1p1beta1Symbol]] = Field(default=None, description="List of symbols in the word. The order of the symbols follows the natural reading order.")
    __properties: ClassVar[List[str]] = ["boundingBox", "confidence", "property", "symbols"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "symbols": [GoogleCloudVisionV1p1beta1Symbol.from_dict(_item) for _item in obj["symbols"]] if obj.get("symbols") is not None else None
        })
        return _obj
