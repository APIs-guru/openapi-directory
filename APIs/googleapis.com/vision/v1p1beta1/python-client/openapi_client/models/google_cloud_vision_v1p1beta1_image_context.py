...
class GoogleCloudVisionV1p1beta1ImageContext(BaseModel):
    ...
    """ # noqa: E501
    crop_hints_params: Optional[GoogleCloudVisionV1p1beta1CropHintsParams] = Field(default=None, alias="cropHintsParams")
    ...
    lat_long_rect: Optional[GoogleCloudVisionV1p1beta1LatLongRect] = Field(default=None, alias="latLongRect")
    product_search_params: Optional[GoogleCloudVisionV1p1beta1ProductSearchParams] = Field(default=None, alias="productSearchParams")
    text_detection_params: Optional[GoogleCloudVisionV1p1beta1TextDetectionParams] = Field(default=None, alias="textDetectionParams")
    web_detection_params: Optional[GoogleCloudVisionV1p1beta1WebDetectionParams] = Field(default=None, alias="webDetectionParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cropHintsParams": GoogleCloudVisionV1p1beta1CropHintsParams.from_dict(obj["cropHintsParams"]) if obj.get("cropHintsParams") is not None else None,
            "languageHints": obj.get("languageHints"),
            "latLongRect": GoogleCloudVisionV1p1beta1LatLongRect.from_dict(obj["latLongRect"]) if obj.get("latLongRect") is not None else None,
            "productSearchParams": GoogleCloudVisionV1p1beta1ProductSearchParams.from_dict(obj["productSearchParams"]) if obj.get("productSearchParams") is not None else None,
            "textDetectionParams": GoogleCloudVisionV1p1beta1TextDetectionParams.from_dict(obj["textDetectionParams"]) if obj.get("textDetectionParams") is not None else None,
            "webDetectionParams": GoogleCloudVisionV1p1beta1WebDetectionParams.from_dict(obj["webDetectionParams"]) if obj.get("webDetectionParams") is not None else None
        })
        return _obj
