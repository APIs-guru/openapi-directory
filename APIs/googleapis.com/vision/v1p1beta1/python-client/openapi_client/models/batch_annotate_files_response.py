...
class BatchAnnotateFilesResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[AnnotateFileResponse]] = Field(default=None, description="The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [AnnotateFileResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
