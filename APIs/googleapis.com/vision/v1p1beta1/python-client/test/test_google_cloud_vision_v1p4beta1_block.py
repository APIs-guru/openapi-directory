...
class TestGoogleCloudVisionV1p4beta1Block(unittest.TestCase):
    """GoogleCloudVisionV1p4beta1Block unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p4beta1Block:
        """Test GoogleCloudVisionV1p4beta1Block
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p4beta1Block`
        """
        model = GoogleCloudVisionV1p4beta1Block()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p4beta1Block(self):
        """Test GoogleCloudVisionV1p4beta1Block"""
