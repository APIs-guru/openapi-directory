...
class TestGoogleCloudVisionV1p3beta1FaceAnnotation(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1FaceAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1FaceAnnotation:
        """Test GoogleCloudVisionV1p3beta1FaceAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1FaceAnnotation`
        """
        model = GoogleCloudVisionV1p3beta1FaceAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1FaceAnnotation(self):
        """Test GoogleCloudVisionV1p3beta1FaceAnnotation"""
