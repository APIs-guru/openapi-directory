...
class TestGoogleCloudVisionV1p3beta1WebDetection(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1WebDetection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1WebDetection:
        """Test GoogleCloudVisionV1p3beta1WebDetection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1WebDetection`
        """
        model = GoogleCloudVisionV1p3beta1WebDetection()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1WebDetection(self):
        """Test GoogleCloudVisionV1p3beta1WebDetection"""
