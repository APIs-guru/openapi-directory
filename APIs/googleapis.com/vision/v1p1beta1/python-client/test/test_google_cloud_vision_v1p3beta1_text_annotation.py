...
class TestGoogleCloudVisionV1p3beta1TextAnnotation(unittest.TestCase):
    """GoogleCloudVisionV1p3beta1TextAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVisionV1p3beta1TextAnnotation:
        """Test GoogleCloudVisionV1p3beta1TextAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVisionV1p3beta1TextAnnotation`
        """
        model = GoogleCloudVisionV1p3beta1TextAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVisionV1p3beta1TextAnnotation(self):
        """Test GoogleCloudVisionV1p3beta1TextAnnotation"""
