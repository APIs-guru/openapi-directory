...
**fd_bounding_poly** | [**GoogleCloudVisionV1p3beta1BoundingPoly**](GoogleCloudVisionV1p3beta1BoundingPoly.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudVisionV1p3beta1FaceAnnotation from a JSON string
google_cloud_vision_v1p3beta1_face_annotation_instance = GoogleCloudVisionV1p3beta1FaceAnnotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p3beta1FaceAnnotation.to_json())

# convert the object into a dict
google_cloud_vision_v1p3beta1_face_annotation_dict = google_cloud_vision_v1p3beta1_face_annotation_instance.to_dict()
# create an instance of GoogleCloudVisionV1p3beta1FaceAnnotation from a dict
google_cloud_vision_v1p3beta1_face_annotation_from_dict = GoogleCloudVisionV1p3beta1FaceAnnotation.from_dict(google_cloud_vision_v1p3beta1_face_annotation_dict)
```
