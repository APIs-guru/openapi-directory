...
**fd_bounding_poly** | [**GoogleCloudVisionV1p2beta1BoundingPoly**](GoogleCloudVisionV1p2beta1BoundingPoly.md) |  | [optional] 
...
**landmarks** | [**List[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]**](GoogleCloudVisionV1p2beta1FaceAnnotationLandmark.md) | Detected face landmarks. | [optional] 
...
google_cloud_vision_v1p2beta1_face_annotation_instance = GoogleCloudVisionV1p2beta1FaceAnnotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p2beta1FaceAnnotation.to_json())

# convert the object into a dict
google_cloud_vision_v1p2beta1_face_annotation_dict = google_cloud_vision_v1p2beta1_face_annotation_instance.to_dict()
# create an instance of GoogleCloudVisionV1p2beta1FaceAnnotation from a dict
google_cloud_vision_v1p2beta1_face_annotation_from_dict = GoogleCloudVisionV1p2beta1FaceAnnotation.from_dict(google_cloud_vision_v1p2beta1_face_annotation_dict)
```
