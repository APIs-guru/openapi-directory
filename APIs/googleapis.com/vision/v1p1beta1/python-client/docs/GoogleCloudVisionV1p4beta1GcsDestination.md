...
google_cloud_vision_v1p4beta1_gcs_destination_instance = GoogleCloudVisionV1p4beta1GcsDestination.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVisionV1p4beta1GcsDestination.to_json())

# convert the object into a dict
google_cloud_vision_v1p4beta1_gcs_destination_dict = google_cloud_vision_v1p4beta1_gcs_destination_instance.to_dict()
# create an instance of GoogleCloudVisionV1p4beta1GcsDestination from a dict
google_cloud_vision_v1p4beta1_gcs_destination_from_dict = GoogleCloudVisionV1p4beta1GcsDestination.from_dict(google_cloud_vision_v1p4beta1_gcs_destination_dict)
```
