...
class ProjectsApi:
    ...
    def publicca_projects_locations_external_account_keys_create(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The parent resource where this external_account_key will be created. Format: projects/[project_id]/locations/[location]. At present only the \"global\" location is supported.")],
        ...
        external_account_key: Optional[ExternalAccountKey] = None,
        ...
        """publicca_projects_locations_external_account_keys_create

        Creates a new ExternalAccountKey bound to the project.

        :param parent: Required. The parent resource where this external_account_key will be created. Format: projects/[project_id]/locations/[location]. At present only the \"global\" location is supported. (required)
        :type parent: str
        ...
        :param external_account_key:
        :type external_account_key: ExternalAccountKey
        ...
        _param = self._publicca_projects_locations_external_account_keys_create_serialize(
            parent=parent,
            xgafv=xgafv,
    ...
    @validate_call
    def publicca_projects_locations_external_account_keys_create_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The parent resource where this external_account_key will be created. Format: projects/[project_id]/locations/[location]. At present only the \"global\" location is supported.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExternalAccountKey]:
        """publicca_projects_locations_external_account_keys_create
    ...
    @validate_call
    def publicca_projects_locations_external_account_keys_create_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The parent resource where this external_account_key will be created. Format: projects/[project_id]/locations/[location]. At present only the \"global\" location is supported.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _publicca_projects_locations_external_account_keys_create_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        if external_account_key is not None:
            _body_params = external_account_key
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1alpha1/{parent}/externalAccountKeys',
