...
class AccountsApi:
    ...
    def playcustomapp_accounts_custom_apps_create(
        self,
        account: Annotated[StrictStr, Field(description="Developer account ID.")],
        ...
        custom_app: Optional[CustomApp] = None,
        ...
        :param account: Developer account ID. (required)
        :type account: str
        ...
        _param = self._playcustomapp_accounts_custom_apps_create_serialize(
            account=account,
            xgafv=xgafv,
    ...
    @validate_call
    def playcustomapp_accounts_custom_apps_create_with_http_info(
        self,
        account: Annotated[StrictStr, Field(description="Developer account ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def playcustomapp_accounts_custom_apps_create_without_preload_content(
        self,
        account: Annotated[StrictStr, Field(description="Developer account ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _playcustomapp_accounts_custom_apps_create_serialize(
        self,
        account,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/playcustomapp/v1/accounts/{account}/customApps',
