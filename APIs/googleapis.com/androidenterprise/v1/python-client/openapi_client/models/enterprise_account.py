...
class EnterpriseAccount(BaseModel):
    ...
    """ # noqa: E501
    account_email: Optional[StrictStr] = Field(default=None, description="The email address of the service account.", alias="accountEmail")
    __properties: ClassVar[List[str]] = ["accountEmail"]
