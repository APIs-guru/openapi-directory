...
class VariableSet(BaseModel):
    ...
    """ # noqa: E501
    placeholder: Optional[StrictStr] = Field(default=None, description="The placeholder string; defined by EMM.")
    user_value: Optional[StrictStr] = Field(default=None, description="The value of the placeholder, specific to the user.", alias="userValue")
    __properties: ClassVar[List[str]] = ["placeholder", "userValue"]
