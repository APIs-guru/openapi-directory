...
class ProductVisibility(BaseModel):
    ...
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="The product ID to make visible to the user. Required for each item in the productVisibility list.", alias="productId")
    track_ids: Optional[List[StrictStr]] = Field(default=None, description="Grants the user visibility to the specified product track(s), identified by trackIds.", alias="trackIds")
    tracks: Optional[List[StrictStr]] = Field(default=None, description="Deprecated. Use trackIds instead.")
    __properties: ClassVar[List[str]] = ["productId", "trackIds", "tracks"]
