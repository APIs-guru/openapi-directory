...
class CreateEnrollmentTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    enrollment_token: Optional[StrictStr] = Field(default=None, description="Enrollment token.", alias="enrollmentToken")
    __properties: ClassVar[List[str]] = ["enrollmentToken"]
