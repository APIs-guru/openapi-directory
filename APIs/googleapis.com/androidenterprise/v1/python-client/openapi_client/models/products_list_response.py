...
class ProductsListResponse(BaseModel):
    ...
    product: Optional[List[Product]] = Field(default=None, description="Information about a product (e.g. an app) in the Google Play store, for display to an enterprise admin.")
    token_pagination: Optional[TokenPagination] = Field(default=None, alias="tokenPagination")
    __properties: ClassVar[List[str]] = ["pageInfo", "product", "tokenPagination"]
