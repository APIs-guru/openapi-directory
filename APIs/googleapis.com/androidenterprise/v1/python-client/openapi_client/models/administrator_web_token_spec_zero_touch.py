...
class AdministratorWebTokenSpecZeroTouch(BaseModel):
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether zero-touch embedded UI is usable with this token. If enabled, the admin can link zero-touch customers to this enterprise.")
