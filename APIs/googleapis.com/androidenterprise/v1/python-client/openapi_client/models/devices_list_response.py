...
class DevicesListResponse(BaseModel):
    ...
    DevicesListResponse
    """ # noqa: E501
    device: Optional[List[Device]] = Field(default=None, description="A managed device.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": [Device.from_dict(_item) for _item in obj["device"]] if obj.get("device") is not None else None
        })
        return _obj
