...
class ProductPermission(BaseModel):
    ...
    """ # noqa: E501
    permission_id: Optional[StrictStr] = Field(default=None, description="An opaque string uniquely identifying the permission.", alias="permissionId")
    state: Optional[StrictStr] = Field(default=None, description="Whether the permission has been accepted or not.")
    __properties: ClassVar[List[str]] = ["permissionId", "state"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['required', 'accepted']):
            raise ValueError("must be one of enum values ('required', 'accepted')")
        return value
