...
class ServiceAccount(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[ServiceAccountKey] = None
    name: Optional[StrictStr] = Field(default=None, description="The account name of the service account, in the form of an email address. Assigned by the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": ServiceAccountKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "name": obj.get("name")
        })
        return _obj
