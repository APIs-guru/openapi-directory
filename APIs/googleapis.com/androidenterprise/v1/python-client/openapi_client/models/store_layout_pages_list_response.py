...
class StoreLayoutPagesListResponse(BaseModel):
    ...
    """ # noqa: E501
    page: Optional[List[StorePage]] = Field(default=None, description="A store page of an enterprise.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": [StorePage.from_dict(_item) for _item in obj["page"]] if obj.get("page") is not None else None
        })
        return _obj
