...
class ManagedconfigurationssettingsApi:
    ...
    def androidenterprise_managedconfigurationssettings_list(
        ...
        product_id: Annotated[StrictStr, Field(description="The ID of the product for which the managed configurations settings applies to.")],
        ...
        :param product_id: The ID of the product for which the managed configurations settings applies to. (required)
        :type product_id: str
        ...
        _param = self._androidenterprise_managedconfigurationssettings_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagedConfigurationsSettingsListResponse",
        }
    ...
    @validate_call
    def androidenterprise_managedconfigurationssettings_list_with_http_info(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        product_id: Annotated[StrictStr, Field(description="The ID of the product for which the managed configurations settings applies to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def androidenterprise_managedconfigurationssettings_list_without_preload_content(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        product_id: Annotated[StrictStr, Field(description="The ID of the product for which the managed configurations settings applies to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _androidenterprise_managedconfigurationssettings_list_serialize(
        self,
        enterprise_id,
        product_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/androidenterprise/v1/enterprises/{enterpriseId}/products/{productId}/managedConfigurationsSettings',
