...
class ServiceaccountkeysApi:
    ...
    def androidenterprise_serviceaccountkeys_delete(
        ...
        _param = self._androidenterprise_serviceaccountkeys_delete_serialize(
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_delete_with_http_info(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        key_id: Annotated[StrictStr, Field(description="The ID of the key.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_delete_without_preload_content(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        key_id: Annotated[StrictStr, Field(description="The ID of the key.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _androidenterprise_serviceaccountkeys_delete_serialize(
        self,
        enterprise_id,
        key_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/androidenterprise/v1/enterprises/{enterpriseId}/serviceAccountKeys/{keyId}',
    ...
    def androidenterprise_serviceaccountkeys_insert(
        ...
        :type service_account_key: ServiceAccountKey
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._androidenterprise_serviceaccountkeys_insert_serialize(
            enterprise_id=enterprise_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_insert_with_http_info(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_insert_without_preload_content(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _androidenterprise_serviceaccountkeys_insert_serialize(
        self,
        enterprise_id,
        xgafv,
        access_token,
        ...
        if service_account_key is not None:
            _body_params = service_account_key
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/androidenterprise/v1/enterprises/{enterpriseId}/serviceAccountKeys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def androidenterprise_serviceaccountkeys_list(
        ...
        _param = self._androidenterprise_serviceaccountkeys_list_serialize(
            enterprise_id=enterprise_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ServiceAccountKeysListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_list_with_http_info(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceAccountKeysListResponse]:
        """androidenterprise_serviceaccountkeys_list
    ...
    @validate_call
    def androidenterprise_serviceaccountkeys_list_without_preload_content(
        self,
        enterprise_id: Annotated[StrictStr, Field(description="The ID of the enterprise.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _androidenterprise_serviceaccountkeys_list_serialize(
        self,
        enterprise_id,
        xgafv,
        access_token,
