...
class TestDevicesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DevicesListResponse:
        """Test DevicesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicesListResponse`
        """
    ...
    def testDevicesListResponse(self):
        """Test DevicesListResponse"""
