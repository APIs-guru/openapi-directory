...
class TestAppRestrictionsSchemaRestriction(unittest.TestCase):
    """AppRestrictionsSchemaRestriction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppRestrictionsSchemaRestriction:
        """Test AppRestrictionsSchemaRestriction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppRestrictionsSchemaRestriction`
        """
        model = AppRestrictionsSchemaRestriction()
        if include_optional:
    ...
    def testAppRestrictionsSchemaRestriction(self):
        """Test AppRestrictionsSchemaRestriction"""
