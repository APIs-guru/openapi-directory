...
class TestProductPolicy(unittest.TestCase):
    """ProductPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductPolicy:
        """Test ProductPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductPolicy`
        """
        model = ProductPolicy()
        if include_optional:
