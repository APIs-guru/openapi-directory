...
class TestConfigurationVariables(unittest.TestCase):
    """ConfigurationVariables unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationVariables:
        """Test ConfigurationVariables
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationVariables`
        """
    ...
    def testConfigurationVariables(self):
        """Test ConfigurationVariables"""
