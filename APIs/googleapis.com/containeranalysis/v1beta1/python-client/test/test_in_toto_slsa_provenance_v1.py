...
class TestInTotoSlsaProvenanceV1(unittest.TestCase):
    """InTotoSlsaProvenanceV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InTotoSlsaProvenanceV1:
        """Test InTotoSlsaProvenanceV1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InTotoSlsaProvenanceV1`
        """
        model = InTotoSlsaProvenanceV1()
        if include_optional:
    ...
    def testInTotoSlsaProvenanceV1(self):
        """Test InTotoSlsaProvenanceV1"""
