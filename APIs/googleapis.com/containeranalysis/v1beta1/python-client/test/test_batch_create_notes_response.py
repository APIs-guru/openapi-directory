...
class TestBatchCreateNotesResponse(unittest.TestCase):
    """BatchCreateNotesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateNotesResponse:
        """Test BatchCreateNotesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateNotesResponse`
        """
        model = BatchCreateNotesResponse()
        if include_optional:
    ...
    def testBatchCreateNotesResponse(self):
        """Test BatchCreateNotesResponse"""
