...
**signature** | **bytearray** | Required. Signature of the related &#x60;BuildProvenance&#x60;. In JSON, this is base-64 encoded. | [optional] 
...
build_signature_instance = BuildSignature.from_json(json)
# print the JSON string representation of the object
print(BuildSignature.to_json())

# convert the object into a dict
build_signature_dict = build_signature_instance.to_dict()
# create an instance of BuildSignature from a dict
build_signature_from_dict = BuildSignature.from_dict(build_signature_dict)
```
