...
------------ | ------------- | ------------- | -------------
**discovery_occurrence_id** | **str** | The name of the discovery occurrence in the form \&quot;projects/{project_id}/occurrences/{OCCURRENCE_ID} It can be used to track the progression of the SBOM export. | [optional] 
