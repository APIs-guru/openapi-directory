...
class ByProducts(BaseModel):
    ...
    """ # noqa: E501
    custom_values: Optional[Dict[str, StrictStr]] = Field(default=None, alias="customValues")
    __properties: ClassVar[List[str]] = ["customValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customValues": obj.get("customValues")
        })
        return _obj
