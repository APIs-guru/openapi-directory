...
class PackageIssue(BaseModel):
    ...
    severity_name: Optional[StrictStr] = Field(default=None, description="Deprecated, use Details.effective_severity instead The severity (e.g., distro assigned severity) for this vulnerability.", alias="severityName")
