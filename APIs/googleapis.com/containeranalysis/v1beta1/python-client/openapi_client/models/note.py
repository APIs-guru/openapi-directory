...
class Note(BaseModel):
    ...
    """ # noqa: E501
    attestation_authority: Optional[Authority] = Field(default=None, alias="attestationAuthority")
    ...
    __properties: ClassVar[List[str]] = ["attestationAuthority", "baseImage", "build", "createTime", "deployable", "discovery", "expirationTime", "intoto", "kind", "longDescription", "name", "package", "relatedNoteNames", "relatedUrl", "sbom", "sbomReference", "shortDescription", "spdxFile", "spdxPackage", "spdxRelationship", "updateTime", "vulnerability", "vulnerabilityAssessment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attestationAuthority": Authority.from_dict(obj["attestationAuthority"]) if obj.get("attestationAuthority") is not None else None,
            ...
            "intoto": InToto.from_dict(obj["intoto"]) if obj.get("intoto") is not None else None,
            "kind": obj.get("kind"),
