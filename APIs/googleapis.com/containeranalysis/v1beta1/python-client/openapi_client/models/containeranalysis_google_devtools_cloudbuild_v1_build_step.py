...
class ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep(BaseModel):
    ...
    pull_timing: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan] = Field(default=None, alias="pullTiming")
    ...
    volumes: Optional[List[ContaineranalysisGoogleDevtoolsCloudbuildV1Volume]] = Field(default=None, description="List of volumes to mount into the build step. Each volume is created as an empty volume prior to execution of the build step. Upon completion of the build, volumes and their contents are discarded. Using a named volume in only one step is not valid as it is indicative of a build request with an incorrect configuration.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "pullTiming": ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan.from_dict(obj["pullTiming"]) if obj.get("pullTiming") is not None else None,
