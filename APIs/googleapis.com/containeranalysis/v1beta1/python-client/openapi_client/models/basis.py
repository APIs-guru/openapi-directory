...
class Basis(BaseModel):
    ...
    resource_url: Optional[StrictStr] = Field(default=None, description="Required. Immutable. The resource_url for the resource representing the basis of associated occurrence images.", alias="resourceUrl")
    __properties: ClassVar[List[str]] = ["fingerprint", "resourceUrl"]
