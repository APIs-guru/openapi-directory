...
class GrafeasV1beta1IntotoDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signatures": [GrafeasV1beta1IntotoSignature.from_dict(_item) for _item in obj["signatures"]] if obj.get("signatures") is not None else None,
            "signed": Link.from_dict(obj["signed"]) if obj.get("signed") is not None else None
        })
        return _obj
