...
class Discovered(BaseModel):
    ...
    last_analysis_time: Optional[StrictStr] = Field(default=None, description="The last time continuous analysis was done for this resource. Deprecated, do not use.", alias="lastAnalysisTime")
    ...
    __properties: ClassVar[List[str]] = ["analysisCompleted", "analysisError", "analysisStatus", "analysisStatusError", "continuousAnalysis", "lastAnalysisTime", "lastScanTime", "sbomStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastAnalysisTime": obj.get("lastAnalysisTime"),
