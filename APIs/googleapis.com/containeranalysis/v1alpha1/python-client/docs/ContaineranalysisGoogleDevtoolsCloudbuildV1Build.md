...
**available_secrets** | [**ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets**](ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets.md) |  | [optional] 
...
**failure_info** | [**ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo**](ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo.md) |  | [optional] 
...
**logs_bucket** | **str** | Cloud Storage bucket where logs should be written (see [Bucket Name Requirements](https://cloud.google.com/storage/docs/bucket-naming#requirements)). Logs file names will be of the format &#x60;${logs_bucket}/log-${build_id}.txt&#x60;. | [optional] 
...
**source_provenance** | [**ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance**](ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance.md) |  | [optional] 
...
containeranalysis_google_devtools_cloudbuild_v1_build_instance = ContaineranalysisGoogleDevtoolsCloudbuildV1Build.from_json(json)
# print the JSON string representation of the object
print(ContaineranalysisGoogleDevtoolsCloudbuildV1Build.to_json())

# convert the object into a dict
containeranalysis_google_devtools_cloudbuild_v1_build_dict = containeranalysis_google_devtools_cloudbuild_v1_build_instance.to_dict()
# create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1Build from a dict
containeranalysis_google_devtools_cloudbuild_v1_build_from_dict = ContaineranalysisGoogleDevtoolsCloudbuildV1Build.from_dict(containeranalysis_google_devtools_cloudbuild_v1_build_dict)
```
