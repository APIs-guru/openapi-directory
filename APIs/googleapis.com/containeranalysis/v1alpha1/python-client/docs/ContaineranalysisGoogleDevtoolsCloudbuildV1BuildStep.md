...
**automap_substitutions** | **bool** | Option to include built-in and custom substitutions as env variables for this build step. This option will override the global option in BuildOption. | [optional] 
...
**pull_timing** | [**ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan**](ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan.md) |  | [optional] 
...
json = "{}"
# create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep from a JSON string
containeranalysis_google_devtools_cloudbuild_v1_build_step_instance = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep.from_json(json)
# print the JSON string representation of the object
print(ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep.to_json())

# convert the object into a dict
containeranalysis_google_devtools_cloudbuild_v1_build_step_dict = containeranalysis_google_devtools_cloudbuild_v1_build_step_instance.to_dict()
# create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep from a dict
containeranalysis_google_devtools_cloudbuild_v1_build_step_from_dict = ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep.from_dict(containeranalysis_google_devtools_cloudbuild_v1_build_step_dict)
```
