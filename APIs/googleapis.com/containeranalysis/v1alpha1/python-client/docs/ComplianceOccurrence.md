...
------------ | ------------- | ------------- | -------------
**non_compliance_reason** | **str** | The reason for non compliance of these files. | [optional] 
**non_compliant_files** | [**List[NonCompliantFile]**](NonCompliantFile.md) | A list of files which are violating compliance checks. | [optional] 
