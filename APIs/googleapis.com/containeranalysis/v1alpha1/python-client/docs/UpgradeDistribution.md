...
------------ | ------------- | ------------- | -------------
**classification** | **str** | The operating system classification of this Upgrade, as specified by the upstream operating system upgrade feed. | [optional] 
...
**cve** | **List[str]** | The cve that would be resolved by this upgrade. | [optional] 
