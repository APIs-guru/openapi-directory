...
------------ | ------------- | ------------- | -------------
**error** | **str** | Output only. If there was an error generating an SBOM, this will indicate what that error was. | [optional] [readonly] 
**sbom_state** | **str** | Output only. The progress of the SBOM generation. | [optional] [readonly] 
