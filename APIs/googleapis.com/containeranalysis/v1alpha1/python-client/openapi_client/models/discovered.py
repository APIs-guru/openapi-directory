...
class Discovered(BaseModel):
    ...
    archive_time: Optional[StrictStr] = Field(default=None, description="The time occurrences related to this discovery occurrence were archived.", alias="archiveTime")
    ...
    __properties: ClassVar[List[str]] = ["analysisCompleted", "analysisError", "analysisStatus", "analysisStatusError", "archiveTime", "continuousAnalysis", "cpe", "lastScanTime", "operation", "sbomStatus"]
    ...
    def analysis_status_validate_enum(cls, value):
        ...
        if value not in set(['ANALYSIS_STATUS_UNSPECIFIED', 'PENDING', 'SCANNING', 'COMPLETE', 'FINISHED_SUCCESS', 'FINISHED_FAILED', 'FINISHED_UNSUPPORTED']):
            raise ValueError("must be one of enum values ('ANALYSIS_STATUS_UNSPECIFIED', 'PENDING', 'SCANNING', 'COMPLETE', 'FINISHED_SUCCESS', 'FINISHED_FAILED', 'FINISHED_UNSUPPORTED')")
        return value
