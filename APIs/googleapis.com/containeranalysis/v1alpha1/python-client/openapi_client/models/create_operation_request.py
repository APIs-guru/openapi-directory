...
class CreateOperationRequest(BaseModel):
    ...
    operation_id: Optional[StrictStr] = Field(default=None, description="The ID to use for this operation.", alias="operationId")
    __properties: ClassVar[List[str]] = ["operation", "operationId"]
