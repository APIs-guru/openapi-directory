...
class Basis(BaseModel):
    ...
    resource_url: Optional[StrictStr] = Field(default=None, description="The resource_url for the resource representing the basis of associated occurrence images.", alias="resourceUrl")
