...
class GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder(BaseModel):
    """
    Identifies the entity that executed the recipe, which is trusted to have correctly performed the operation and populated this provenance.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="URI indicating the builder’s identity.")
