...
class BuildStep(BaseModel):
    ...
    automap_substitutions: Optional[StrictBool] = Field(default=None, description="Option to include built-in and custom substitutions as env variables for this build step. This option will override the global option in BuildOption.", alias="automapSubstitutions")
    ...
    __properties: ClassVar[List[str]] = ["allowExitCodes", "allowFailure", "args", "automapSubstitutions", "dir", "entrypoint", "env", "exitCode", "id", "name", "pullTiming", "script", "secretEnv", "status", "timeout", "timing", "volumes", "waitFor"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['STATUS_UNKNOWN', 'PENDING', 'QUEUING', 'QUEUED', 'WORKING', 'SUCCESS', 'FAILURE', 'INTERNAL_ERROR', 'TIMEOUT', 'CANCELLED', 'EXPIRED']):
            raise ValueError("must be one of enum values ('STATUS_UNKNOWN', 'PENDING', 'QUEUING', 'QUEUED', 'WORKING', 'SUCCESS', 'FAILURE', 'INTERNAL_ERROR', 'TIMEOUT', 'CANCELLED', 'EXPIRED')")
        return value
