...
class SeverityCount(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictStr] = Field(default=None, description="The number of occurrences with the severity.")
    severity: Optional[StrictStr] = Field(default=None, description="The severity of the occurrences.")
    __properties: ClassVar[List[str]] = ["count", "severity"]
