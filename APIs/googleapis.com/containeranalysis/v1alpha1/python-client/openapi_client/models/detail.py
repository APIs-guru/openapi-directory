...
class Detail(BaseModel):
    ...
    """ # noqa: E501
    cpe_uri: Optional[StrictStr] = Field(default=None, description="The cpe_uri in [cpe format] (https://cpe.mitre.org/specification/) in which the vulnerability manifests. Examples include distro or storage location for vulnerable jar. This field can be used as a filter in list requests.", alias="cpeUri")
    ...
    package: Optional[StrictStr] = Field(default=None, description="The name of the package where the vulnerability was found. This field can be used as a filter in list requests.")
    ...
    vendor: Optional[StrictStr] = Field(default=None, description="The vendor of the product. e.g. \"google\"")
    __properties: ClassVar[List[str]] = ["cpeUri", "description", "fixedLocation", "isObsolete", "maxAffectedVersion", "minAffectedVersion", "package", "packageType", "severityName", "source", "vendor"]
