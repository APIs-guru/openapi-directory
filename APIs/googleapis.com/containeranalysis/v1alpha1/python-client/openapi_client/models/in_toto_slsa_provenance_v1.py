...
class InTotoSlsaProvenanceV1(BaseModel):
    """
    InTotoSlsaProvenanceV1
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="InToto spec defined at https://github.com/in-toto/attestation/tree/main/spec#statement", alias="_type")
    predicate: Optional[SlsaProvenanceV1] = None
    predicate_type: Optional[StrictStr] = Field(default=None, alias="predicateType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type"),
            "predicate": SlsaProvenanceV1.from_dict(obj["predicate"]) if obj.get("predicate") is not None else None,
