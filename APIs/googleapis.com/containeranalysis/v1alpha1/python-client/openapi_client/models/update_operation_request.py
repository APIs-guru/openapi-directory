...
class UpdateOperationRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="The fields to update.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["operation", "updateMask"]
