...
class Deployment(BaseModel):
    ...
    deploy_time: Optional[StrictStr] = Field(default=None, description="Beginning of the lifetime of this deployment.", alias="deployTime")
    platform: Optional[StrictStr] = Field(default=None, description="Platform hosting this deployment.")
    resource_uri: Optional[List[StrictStr]] = Field(default=None, description="Resource URI for the artifact being deployed taken from the deployable field with the same name.", alias="resourceUri")
