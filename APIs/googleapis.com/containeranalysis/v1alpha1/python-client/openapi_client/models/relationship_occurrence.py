...
class RelationshipOccurrence(BaseModel):
    ...
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="A place for the SPDX file creator to record any general comments about the relationship")
    source: Optional[StrictStr] = Field(default=None, description="Also referred to as SPDXRef-A The source SPDX element (file, package, etc)")
    target: Optional[StrictStr] = Field(default=None, description="Also referred to as SPDXRef-B The target SPDC element (file, package, etc) In cases where there are \"known unknowns\", the use of the keyword NOASSERTION can be used The keywords NONE can be used to indicate that an SPDX element (package/file/snippet) has no other elements connected by some relationship to it")
    type: Optional[StrictStr] = Field(default=None, description="Output only. The type of relationship between the source and target SPDX elements")
    __properties: ClassVar[List[str]] = ["comment", "source", "target", "type"]
