...
class SourceContext(BaseModel):
    ...
    """ # noqa: E501
    cloud_repo: Optional[CloudRepoSourceContext] = Field(default=None, alias="cloudRepo")
    gerrit: Optional[GerritSourceContext] = None
    git: Optional[GitSourceContext] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloudRepo": CloudRepoSourceContext.from_dict(obj["cloudRepo"]) if obj.get("cloudRepo") is not None else None,
            "gerrit": GerritSourceContext.from_dict(obj["gerrit"]) if obj.get("gerrit") is not None else None,
            "git": GitSourceContext.from_dict(obj["git"]) if obj.get("git") is not None else None,
