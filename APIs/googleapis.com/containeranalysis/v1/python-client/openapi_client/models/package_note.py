...
class PackageNote(BaseModel):
    ...
    distribution: Optional[List[Distribution]] = Field(default=None, description="Deprecated. The various channels by which a package is distributed.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Immutable. The name of the package.")
