...
class ContaineranalysisGoogleDevtoolsCloudbuildV1Build(BaseModel):
    ...
    """ # noqa: E501
    approval: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval] = None
    artifacts: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts] = None
    available_secrets: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets] = Field(default=None, alias="availableSecrets")
    ...
    failure_info: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo] = Field(default=None, alias="failureInfo")
    ...
    logs_bucket: Optional[StrictStr] = Field(default=None, description="Cloud Storage bucket where logs should be written (see [Bucket Name Requirements](https://cloud.google.com/storage/docs/bucket-naming#requirements)). Logs file names will be of the format `${logs_bucket}/log-${build_id}.txt`.", alias="logsBucket")
    ...
    options: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions] = None
    ...
    results: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1Results] = None
    secrets: Optional[List[ContaineranalysisGoogleDevtoolsCloudbuildV1Secret]] = Field(default=None, description="Secrets to decrypt using Cloud Key Management Service. Note: Secret Manager is the recommended technique for managing sensitive data with Cloud Build. Use `available_secrets` to configure builds to access secrets from Secret Manager. For instructions, see: https://cloud.google.com/cloud-build/docs/securing-builds/use-secrets")
    ...
    source: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1Source] = None
    source_provenance: Optional[ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance] = Field(default=None, alias="sourceProvenance")
    ...
    steps: Optional[List[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep]] = Field(default=None, description="Required. The operations to be performed on the workspace.")
    ...
    timing: Optional[Dict[str, ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan]] = Field(default=None, description="Output only. Stores timing information for phases of the build. Valid keys are: * BUILD: time to execute all build steps. * PUSH: time to push all artifacts including docker images and non docker artifacts. * FETCHSOURCE: time to fetch source. * SETUPBUILD: time to set up build. If the build does not specify source or images, these keys will not be included.")
    warnings: Optional[List[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning]] = Field(default=None, description="Output only. Non-fatal problems encountered during the execution of the build.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1Build from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1Build from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "approval": ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval.from_dict(obj["approval"]) if obj.get("approval") is not None else None,
            "artifacts": ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts.from_dict(obj["artifacts"]) if obj.get("artifacts") is not None else None,
            "availableSecrets": ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets.from_dict(obj["availableSecrets"]) if obj.get("availableSecrets") is not None else None,
            "buildTriggerId": obj.get("buildTriggerId"),
            "createTime": obj.get("createTime"),
            "failureInfo": ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo.from_dict(obj["failureInfo"]) if obj.get("failureInfo") is not None else None,
            ...
            "name": obj.get("name"),
            "options": ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "projectId": obj.get("projectId"),
            "queueTtl": obj.get("queueTtl"),
            "results": ContaineranalysisGoogleDevtoolsCloudbuildV1Results.from_dict(obj["results"]) if obj.get("results") is not None else None,
            "secrets": [ContaineranalysisGoogleDevtoolsCloudbuildV1Secret.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None,
            "serviceAccount": obj.get("serviceAccount"),
            "source": ContaineranalysisGoogleDevtoolsCloudbuildV1Source.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "sourceProvenance": ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance.from_dict(obj["sourceProvenance"]) if obj.get("sourceProvenance") is not None else None,
            "startTime": obj.get("startTime"),
            "status": obj.get("status"),
            "statusDetail": obj.get("statusDetail"),
            "steps": [ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
            "substitutions": obj.get("substitutions"),
            "tags": obj.get("tags"),
            "timeout": obj.get("timeout"),
            "timing": dict(
                (_k, ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan.from_dict(_v))
                for _k, _v in obj["timing"].items()
            )
            if obj.get("timing") is not None
            else None,
            "warnings": [ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
