...
class TestBatchCreateNotesRequest(unittest.TestCase):
    """BatchCreateNotesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateNotesRequest:
        """Test BatchCreateNotesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateNotesRequest`
        """
        model = BatchCreateNotesRequest()
        if include_optional:
    ...
    def testBatchCreateNotesRequest(self):
        """Test BatchCreateNotesRequest"""
