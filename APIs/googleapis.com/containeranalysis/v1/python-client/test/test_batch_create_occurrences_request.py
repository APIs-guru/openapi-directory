...
class TestBatchCreateOccurrencesRequest(unittest.TestCase):
    """BatchCreateOccurrencesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateOccurrencesRequest:
        """Test BatchCreateOccurrencesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateOccurrencesRequest`
        """
        model = BatchCreateOccurrencesRequest()
        if include_optional:
    ...
    def testBatchCreateOccurrencesRequest(self):
        """Test BatchCreateOccurrencesRequest"""
