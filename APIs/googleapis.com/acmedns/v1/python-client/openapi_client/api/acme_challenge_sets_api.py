...
class AcmeChallengeSetsApi:
    ...
    @validate_call
    def acmedns_acme_challenge_sets_get(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to list challenges. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        ...
        :param root_domain: Required. SLD + TLD domain name to list challenges. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode. (required)
        ...
        _param = self._acmedns_acme_challenge_sets_get_serialize(
    ...
    @validate_call
    def acmedns_acme_challenge_sets_get_with_http_info(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to list challenges. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def acmedns_acme_challenge_sets_get_without_preload_content(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to list challenges. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _acmedns_acme_challenge_sets_get_serialize(
        self,
        root_domain,
        xgafv,
        access_token,
        ...
        if root_domain is not None:
            _path_params['rootDomain'] = root_domain
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/acmeChallengeSets/{rootDomain}',
    ...
    def acmedns_acme_challenge_sets_rotate_challenges(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to update records for. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        rotate_challenges_request: Optional[RotateChallengesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param root_domain: Required. SLD + TLD domain name to update records for. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode. (required)
        :type root_domain: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param rotate_challenges_request:
        :type rotate_challenges_request: RotateChallengesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._acmedns_acme_challenge_sets_rotate_challenges_serialize(
            root_domain=root_domain,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            rotate_challenges_request=rotate_challenges_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def acmedns_acme_challenge_sets_rotate_challenges_with_http_info(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to update records for. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def acmedns_acme_challenge_sets_rotate_challenges_without_preload_content(
        self,
        root_domain: Annotated[StrictStr, Field(description="Required. SLD + TLD domain name to update records for. For example, this would be \"google.com\" for any FQDN under \"google.com\". That includes challenges for \"subdomain.google.com\". This MAY be Unicode or Punycode.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _acmedns_acme_challenge_sets_rotate_challenges_serialize(
        self,
        root_domain,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if rotate_challenges_request is not None:
            _body_params = rotate_challenges_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/acmeChallengeSets/{rootDomain}:rotateChallenges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
