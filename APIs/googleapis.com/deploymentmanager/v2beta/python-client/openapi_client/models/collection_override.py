...
class CollectionOverride(BaseModel):
    ...
    """ # noqa: E501
    collection: Optional[StrictStr] = Field(default=None, description="The collection that identifies this resource within its service.")
    options: Optional[Options] = None
    __properties: ClassVar[List[str]] = ["collection", "options"]
