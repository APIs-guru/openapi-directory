...
class TypeProvidersListTypesResponse(BaseModel):
    ...
    types: Optional[List[TypeInfo]] = Field(default=None, description="Output only. A list of resource type info.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "types": [TypeInfo.from_dict(_item) for _item in obj["types"]] if obj.get("types") is not None else None
        })
        return _obj
