...
class BaseType(BaseModel):
    ...
    descriptor_url: Optional[StrictStr] = Field(default=None, description="Descriptor Url for the this type.", alias="descriptorUrl")
    options: Optional[Options] = None
    __properties: ClassVar[List[str]] = ["collectionOverrides", "credential", "descriptorUrl", "options"]
