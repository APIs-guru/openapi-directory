...
class TypesListResponse(BaseModel):
    ...
    types: Optional[List[Type]] = Field(default=None, description="Output only. A list of resource types supported by Deployment Manager.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "types"]
