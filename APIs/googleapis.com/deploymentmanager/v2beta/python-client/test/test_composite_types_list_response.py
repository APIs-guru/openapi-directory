...
class TestCompositeTypesListResponse(unittest.TestCase):
    """CompositeTypesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeTypesListResponse:
        """Test CompositeTypesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeTypesListResponse`
        """
        model = CompositeTypesListResponse()
        if include_optional:
            return CompositeTypesListResponse(
                composite_types = [
                    openapi_client.models.composite_type.CompositeType(
                        description = '', 
                        id = '', 
                        insert_time = '', 
                        labels = [
    ...
    def testCompositeTypesListResponse(self):
        """Test CompositeTypesListResponse"""
