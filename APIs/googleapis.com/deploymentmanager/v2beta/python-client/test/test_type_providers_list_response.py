...
class TestTypeProvidersListResponse(unittest.TestCase):
    """TypeProvidersListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeProvidersListResponse:
        """Test TypeProvidersListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeProvidersListResponse`
        """
        model = TypeProvidersListResponse()
        if include_optional:
            return TypeProvidersListResponse(
                next_page_token = '',
                type_providers = [
                    openapi_client.models.type_provider.TypeProvider(
    ...
    def testTypeProvidersListResponse(self):
        """Test TypeProvidersListResponse"""
