...
------------- | ------------- | -------------
[**deploymentmanager_resources_get**](ResourcesApi.md#deploymentmanager_resources_get) | **GET** /deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/resources/{resource} | 
[**deploymentmanager_resources_list**](ResourcesApi.md#deploymentmanager_resources_list) | **GET** /deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/resources | 


# **deploymentmanager_resources_get**
> Resource deploymentmanager_resources_get(project, deployment, resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource = 'resource_example' # str | The name of the resource for this request.
    ...
    try:
        api_response = api_instance.deploymentmanager_resources_get(project, deployment, resource, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
        print("The response of ResourcesApi->deploymentmanager_resources_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcesApi->deploymentmanager_resources_get: %s\n" % e)
```
 ...
 **resource** | **str**| The name of the resource for this request. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.deploymentmanager_resources_list(project, deployment, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, max_results=max_results, order_by=order_by, page_token=page_token)
        print("The response of ResourcesApi->deploymentmanager_resources_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcesApi->deploymentmanager_resources_list: %s\n" % e)
```
...
[**ResourcesListResponse**](ResourcesListResponse.md)
