...
------------- | ------------- | -------------
[**deploymentmanager_manifests_get**](ManifestsApi.md#deploymentmanager_manifests_get) | **GET** /deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/manifests/{manifest} | 
[**deploymentmanager_manifests_list**](ManifestsApi.md#deploymentmanager_manifests_list) | **GET** /deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/manifests | 


# **deploymentmanager_manifests_get**
> Manifest deploymentmanager_manifests_get(project, deployment, manifest, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    manifest = 'manifest_example' # str | The name of the manifest for this request.
    ...
    try:
        api_response = api_instance.deploymentmanager_manifests_get(project, deployment, manifest, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
        print("The response of ManifestsApi->deploymentmanager_manifests_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ManifestsApi->deploymentmanager_manifests_get: %s\n" % e)
```
 ...
 **manifest** | **str**| The name of the manifest for this request. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.deploymentmanager_manifests_list(project, deployment, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, max_results=max_results, order_by=order_by, page_token=page_token)
        print("The response of ManifestsApi->deploymentmanager_manifests_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ManifestsApi->deploymentmanager_manifests_list: %s\n" % e)
```
