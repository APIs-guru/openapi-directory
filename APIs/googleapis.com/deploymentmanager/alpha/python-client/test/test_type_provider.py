...
class TestTypeProvider(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TypeProvider:
        """Test TypeProvider
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeProvider`
        """
        model = TypeProvider()
        if include_optional:
            return TypeProvider(
                ...
                insert_time = '',
                labels = [
                    openapi_client.models.type_provider_label_entry.TypeProviderLabelEntry(
                        key = '', 
                        value = '', )
                    ],
                name = '',
