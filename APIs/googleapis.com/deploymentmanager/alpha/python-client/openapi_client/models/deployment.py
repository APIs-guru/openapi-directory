...
class Deployment(BaseModel):
    ...
    outputs: Optional[List[DeploymentOutputEntry]] = Field(default=None, description="Output only. List of outputs from the last manifest that deployed successfully.")
    ...
    __properties: ClassVar[List[str]] = ["credential", "description", "fingerprint", "id", "insertTime", "labels", "manifest", "name", "operation", "outputs", "selfLink", "target", "update", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputs": [DeploymentOutputEntry.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None,
