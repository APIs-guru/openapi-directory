...
class Resource(BaseModel):
    ...
    last_used_credential: Optional[Credential] = Field(default=None, alias="lastUsedCredential")
    ...
    runtime_policies: Optional[List[StrictStr]] = Field(default=None, description="Output only. In case this is an action, it will show the runtimePolicies on which this action will run in the deployment", alias="runtimePolicies")
    ...
    __properties: ClassVar[List[str]] = ["accessControl", "finalProperties", "id", "insertTime", "lastUsedCredential", "manifest", "name", "properties", "runtimePolicies", "type", "update", "updateTime", "url", "warnings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_used_credential
        if self.last_used_credential:
            _dict['lastUsedCredential'] = self.last_used_credential.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastUsedCredential": Credential.from_dict(obj["lastUsedCredential"]) if obj.get("lastUsedCredential") is not None else None,
