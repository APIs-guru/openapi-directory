...
class TestPermissionsRequest(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[StrictStr]] = Field(default=None, description="The set of permissions to check for the 'resource'. Permissions with wildcards (such as '*' or 'storage.*') are not allowed.")
