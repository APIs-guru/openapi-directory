...
------------- | ------------- | -------------
[**deploymentmanager_types_get**](TypesApi.md#deploymentmanager_types_get) | **GET** /deploymentmanager/alpha/projects/{project}/global/types/{type} | 
[**deploymentmanager_types_list**](TypesApi.md#deploymentmanager_types_list) | **GET** /deploymentmanager/alpha/projects/{project}/global/types | 


# **deploymentmanager_types_get**
> Type deploymentmanager_types_get(project, type, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    type = 'type_example' # str | The name of the type for this request.
    ...
    try:
        api_response = api_instance.deploymentmanager_types_get(project, type, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
        print("The response of TypesApi->deploymentmanager_types_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TypesApi->deploymentmanager_types_get: %s\n" % e)
```
 ...
 **type** | **str**| The name of the type for this request. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.deploymentmanager_types_list(project, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, max_results=max_results, order_by=order_by, page_token=page_token)
        print("The response of TypesApi->deploymentmanager_types_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TypesApi->deploymentmanager_types_list: %s\n" % e)
```
...
[**TypesListResponse**](TypesListResponse.md)
