...
**last_used_credential** | [**Credential**](Credential.md) |  | [optional] 
...
**runtime_policies** | **List[str]** | Output only. In case this is an action, it will show the runtimePolicies on which this action will run in the deployment | [optional] 
