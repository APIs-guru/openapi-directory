...
class TransfersApi:
    ...
    @validate_call
    def datatransfer_transfers_get(
        self,
        data_transfer_id: Annotated[StrictStr, Field(description="ID of the resource to be retrieved. This is returned in the response from the insert method.")],
        ...
        :param data_transfer_id: ID of the resource to be retrieved. This is returned in the response from the insert method. (required)
        ...
        _param = self._datatransfer_transfers_get_serialize(
    ...
    @validate_call
    def datatransfer_transfers_get_with_http_info(
        self,
        data_transfer_id: Annotated[StrictStr, Field(description="ID of the resource to be retrieved. This is returned in the response from the insert method.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def datatransfer_transfers_get_without_preload_content(
        self,
        data_transfer_id: Annotated[StrictStr, Field(description="ID of the resource to be retrieved. This is returned in the response from the insert method.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _datatransfer_transfers_get_serialize(
        self,
        data_transfer_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/datatransfer/v1/transfers/{dataTransferId}',
    ...
    @validate_call
    def datatransfer_transfers_insert(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        :type upload_type: str
        :param data_transfer:
        :type data_transfer: DataTransfer
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._datatransfer_transfers_insert_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def datatransfer_transfers_insert_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def datatransfer_transfers_insert_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _datatransfer_transfers_insert_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/datatransfer/v1/transfers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def datatransfer_transfers_list(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        new_owner_user_id: Annotated[Optional[StrictStr], Field(description="Destination user's profile ID.")] = None,
        old_owner_user_id: Annotated[Optional[StrictStr], Field(description="Source user's profile ID.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Token to specify the next page in the list.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Status of the transfer.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param new_owner_user_id: Destination user's profile ID.
        :type new_owner_user_id: str
        :param old_owner_user_id: Source user's profile ID.
        :type old_owner_user_id: str
        ...
        _param = self._datatransfer_transfers_list_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def datatransfer_transfers_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataTransfersListResponse]:
        """datatransfer_transfers_list
    ...
    @validate_call
    def datatransfer_transfers_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _datatransfer_transfers_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if new_owner_user_id is not None:
            ...
            _query_params.append(('newOwnerUserId', new_owner_user_id))
            
        if old_owner_user_id is not None:
            
            _query_params.append(('oldOwnerUserId', old_owner_user_id))
