...
**params** | **Dict[str, str]** | Additional parameters controlling delivery channel behavior. Optional. For example, &#x60;params.ttl&#x60; specifies the time-to-live in seconds for the notification channel, where the default is 2 hours and the maximum TTL is 2 days. | [optional] 
...
**type** | **str** | The type of delivery mechanism used for this channel. | [optional] 
