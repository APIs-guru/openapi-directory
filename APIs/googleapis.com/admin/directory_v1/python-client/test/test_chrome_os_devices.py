...
class TestChromeOsDevices(unittest.TestCase):
    """ChromeOsDevices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChromeOsDevices:
        """Test ChromeOsDevices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChromeOsDevices`
        """
        model = ChromeOsDevices()
        if include_optional:
            return ChromeOsDevices(
                chromeosdevices = [
                    openapi_client.models.chrome_os_device.ChromeOsDevice(
                        active_time_ranges = [
