...
class TestChromeOsDeviceCpuStatusReportsInner(unittest.TestCase):
    """ChromeOsDeviceCpuStatusReportsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChromeOsDeviceCpuStatusReportsInner:
        """Test ChromeOsDeviceCpuStatusReportsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChromeOsDeviceCpuStatusReportsInner`
        """
        model = ChromeOsDeviceCpuStatusReportsInner()
        if include_optional:
            return ChromeOsDeviceCpuStatusReportsInner(
    ...
    def testChromeOsDeviceCpuStatusReportsInner(self):
        """Test ChromeOsDeviceCpuStatusReportsInner"""
