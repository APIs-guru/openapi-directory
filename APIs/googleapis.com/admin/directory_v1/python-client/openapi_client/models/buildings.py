...
class Buildings(BaseModel):
    ...
    """ # noqa: E501
    buildings: Optional[List[Building]] = Field(default=None, description="The Buildings in this page of results.")
    etag: Optional[StrictStr] = Field(default=None, description="ETag of the resource.")
    kind: Optional[StrictStr] = Field(default='admin#directory#resources#buildings#buildingsList', description="Kind of resource this is.")
    ...
    __properties: ClassVar[List[str]] = ["buildings", "etag", "kind", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buildings": [Building.from_dict(_item) for _item in obj["buildings"]] if obj.get("buildings") is not None else None,
            "etag": obj.get("etag"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'admin#directory#resources#buildings#buildingsList',
