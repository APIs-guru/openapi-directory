...
class ChangeChromeOsDeviceStatusResult(BaseModel):
    ...
    """ # noqa: E501
    device_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the ChromeOS device.", alias="deviceId")
    error: Optional[Status] = None
    response: Optional[Dict[str, Any]] = Field(default=None, description="Response for a successful ChromeOS device status change.")
    __properties: ClassVar[List[str]] = ["deviceId", "error", "response"]
