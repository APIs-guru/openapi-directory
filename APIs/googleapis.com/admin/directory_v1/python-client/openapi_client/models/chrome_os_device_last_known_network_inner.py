...
class ChromeOsDeviceLastKnownNetworkInner(BaseModel):
    """
    Information for an ip address.
    """ # noqa: E501
    ip_address: Optional[StrictStr] = Field(default=None, description="The IP address.", alias="ipAddress")
    wan_ip_address: Optional[StrictStr] = Field(default=None, description="The WAN IP address.", alias="wanIpAddress")
    __properties: ClassVar[List[str]] = ["ipAddress", "wanIpAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "wanIpAddress": obj.get("wanIpAddress")
        })
        return _obj
