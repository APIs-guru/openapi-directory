...
class Schemas(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='admin#directory#schemas', description="Kind of resource this is.")
    schemas: Optional[List[ModelSchema]] = Field(default=None, description="A list of UserSchema objects.")
    __properties: ClassVar[List[str]] = ["etag", "kind", "schemas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etag": obj.get("etag"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'admin#directory#schemas',
