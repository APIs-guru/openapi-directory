...
class UserPhone(BaseModel):
    ...
    primary: Optional[StrictBool] = Field(default=None, description="If this is user's primary phone or not.")
    ...
    value: Optional[StrictStr] = Field(default=None, description="Phone number.")
