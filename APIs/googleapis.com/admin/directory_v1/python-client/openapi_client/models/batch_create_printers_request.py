...
class BatchCreatePrintersRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[CreatePrinterRequest]] = Field(default=None, description="A list of Printers to be created. Max 50 at a time.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreatePrinterRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
