...
class FailureInfo(BaseModel):
    ...
    printer_id: Optional[StrictStr] = Field(default=None, description="Id of a failed printer.", alias="printerId")
    __properties: ClassVar[List[str]] = ["errorCode", "errorMessage", "printer", "printerId"]
