...
class ChromeOsDeviceCpuStatusReportsInnerCpuTemperatureInfoInner(BaseModel):
    """
    ChromeOsDeviceCpuStatusReportsInnerCpuTemperatureInfoInner
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="CPU label")
    temperature: Optional[StrictInt] = Field(default=None, description="Temperature in Celsius degrees.")
    __properties: ClassVar[List[str]] = ["label", "temperature"]
