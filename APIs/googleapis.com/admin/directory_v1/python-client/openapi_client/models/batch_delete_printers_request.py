...
class BatchDeletePrintersRequest(BaseModel):
    ...
    """ # noqa: E501
    printer_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of Printer.id that should be deleted. Max 100 at a time.", alias="printerIds")
    __properties: ClassVar[List[str]] = ["printerIds"]
