...
class ChromeOsDeviceCpuInfoInnerLogicalCpusInnerCStatesInner(BaseModel):
    """
    Status of a single C-state. C-states are various modes the CPU can transition to in order to use more or less power.
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Name of the state.", alias="displayName")
    session_duration: Optional[StrictStr] = Field(default=None, description="Time spent in the state since the last reboot.", alias="sessionDuration")
    __properties: ClassVar[List[str]] = ["displayName", "sessionDuration"]
