...
class Aliases(BaseModel):
    ...
    kind: Optional[StrictStr] = 'admin#directory#aliases'
    __properties: ClassVar[List[str]] = ["aliases", "etag", "kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'admin#directory#aliases'
        })
        return _obj
