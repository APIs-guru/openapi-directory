...
class ListPrintersResponse(BaseModel):
    ...
    printers: Optional[List[Printer]] = Field(default=None, description="List of printers. If `org_unit_id` was given in the request, then only printers visible for this OU will be returned. If `org_unit_id` was not given in the request, then all printers will be returned.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "printers"]
