...
class Features(BaseModel):
    ...
    features: Optional[List[Feature]] = Field(default=None, description="The Features in this page of results.")
    kind: Optional[StrictStr] = Field(default='admin#directory#resources#features#featuresList', description="Kind of resource this is.")
    ...
    __properties: ClassVar[List[str]] = ["etag", "features", "kind", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'admin#directory#resources#features#featuresList',
