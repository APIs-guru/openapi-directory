...
class BatchDeletePrintServersRequest(BaseModel):
    ...
    """ # noqa: E501
    print_server_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of print server IDs that should be deleted (max `100` per batch).", alias="printServerIds")
    __properties: ClassVar[List[str]] = ["printServerIds"]
