...
class DirectoryChromeosdevicesIssueCommandResponse(BaseModel):
    ...
    """ # noqa: E501
    command_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the issued command, used to retrieve the command status.", alias="commandId")
    __properties: ClassVar[List[str]] = ["commandId"]
