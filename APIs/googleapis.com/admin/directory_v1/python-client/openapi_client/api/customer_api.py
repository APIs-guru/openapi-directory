...
class CustomerApi:
    ...
    def admin_customer_devices_chromeos_batch_change_status(
        self,
        customer_id: Annotated[StrictStr, Field(description="Required. Immutable ID of the Google Workspace account.")],
        ...
        batch_change_chrome_os_device_status_request: Optional[BatchChangeChromeOsDeviceStatusRequest] = None,
        ...
        :param customer_id: Required. Immutable ID of the Google Workspace account. (required)
        ...
        :param batch_change_chrome_os_device_status_request:
        :type batch_change_chrome_os_device_status_request: BatchChangeChromeOsDeviceStatusRequest
        ...
        _param = self._admin_customer_devices_chromeos_batch_change_status_serialize(
            ...
            batch_change_chrome_os_device_status_request=batch_change_chrome_os_device_status_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BatchChangeChromeOsDeviceStatusResponse",
        }
    ...
    @validate_call
    def admin_customer_devices_chromeos_batch_change_status_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="Required. Immutable ID of the Google Workspace account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchChangeChromeOsDeviceStatusResponse]:
        """admin_customer_devices_chromeos_batch_change_status
    ...
    @validate_call
    def admin_customer_devices_chromeos_batch_change_status_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="Required. Immutable ID of the Google Workspace account.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _admin_customer_devices_chromeos_batch_change_status_serialize(
        self,
        customer_id,
        xgafv,
        access_token,
        ...
        if batch_change_chrome_os_device_status_request is not None:
            _body_params = batch_change_chrome_os_device_status_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/directory/v1/customer/{customerId}/devices/chromeos:batchChangeStatus',
    ...
    def admin_customer_devices_chromeos_commands_get(
        ...
        device_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device.")],
        command_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device Command.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        :type customer_id: str
        :param device_id: Immutable. ID of Chrome OS Device. (required)
        :type device_id: str
        :param command_id: Immutable. ID of Chrome OS Device Command. (required)
        :type command_id: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        _param = self._admin_customer_devices_chromeos_commands_get_serialize(
            customer_id=customer_id,
            device_id=device_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DirectoryChromeosdevicesCommand",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def admin_customer_devices_chromeos_commands_get_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="Immutable. ID of the Google Workspace account.")],
        device_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device.")],
        command_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device Command.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DirectoryChromeosdevicesCommand]:
        """admin_customer_devices_chromeos_commands_get
    ...
    @validate_call
    def admin_customer_devices_chromeos_commands_get_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="Immutable. ID of the Google Workspace account.")],
        device_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device.")],
        command_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device Command.")],
    ...
    def _admin_customer_devices_chromeos_commands_get_serialize(
        self,
        customer_id,
        device_id,
        command_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/directory/v1/customer/{customerId}/devices/chromeos/{deviceId}/commands/{commandId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def admin_customer_devices_chromeos_issue_command(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        directory_chromeosdevices_issue_command_request: Optional[DirectoryChromeosdevicesIssueCommandRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param directory_chromeosdevices_issue_command_request:
        :type directory_chromeosdevices_issue_command_request: DirectoryChromeosdevicesIssueCommandRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._admin_customer_devices_chromeos_issue_command_serialize(
            customer_id=customer_id,
            device_id=device_id,
            xgafv=xgafv,
            access_token=access_token,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            directory_chromeosdevices_issue_command_request=directory_chromeosdevices_issue_command_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DirectoryChromeosdevicesIssueCommandResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def admin_customer_devices_chromeos_issue_command_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="Immutable. ID of the Google Workspace account.")],
        device_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DirectoryChromeosdevicesIssueCommandResponse]:
        """admin_customer_devices_chromeos_issue_command
    ...
    @validate_call
    def admin_customer_devices_chromeos_issue_command_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="Immutable. ID of the Google Workspace account.")],
        device_id: Annotated[StrictStr, Field(description="Immutable. ID of Chrome OS Device.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _admin_customer_devices_chromeos_issue_command_serialize(
        self,
        customer_id,
        device_id,
        xgafv,
        ...
        # process the form parameters
        # process the body parameter
        if directory_chromeosdevices_issue_command_request is not None:
            _body_params = directory_chromeosdevices_issue_command_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/directory/v1/customer/{customerId}/devices/chromeos/{deviceId}:issueCommand',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
