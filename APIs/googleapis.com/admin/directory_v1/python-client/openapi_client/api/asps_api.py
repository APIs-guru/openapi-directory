...
class AspsApi:
    ...
    def directory_asps_delete(
        ...
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP to be deleted.")],
        ...
        :type user_key: str
        :param code_id: The unique ID of the ASP to be deleted. (required)
        :type code_id: int
        ...
        _param = self._directory_asps_delete_serialize(
            user_key=user_key,
            code_id=code_id,
            xgafv=xgafv,
    ...
    @validate_call
    def directory_asps_delete_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP to be deleted.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def directory_asps_delete_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP to be deleted.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _directory_asps_delete_serialize(
        self,
        user_key,
        code_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/directory/v1/users/{userKey}/asps/{codeId}',
    ...
    def directory_asps_get(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        :param user_key: Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID. (required)
        :type user_key: str
        :param code_id: The unique ID of the ASP. (required)
        :type code_id: int
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        _param = self._directory_asps_get_serialize(
            user_key=user_key,
            code_id=code_id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def directory_asps_get_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def directory_asps_get_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        code_id: Annotated[StrictInt, Field(description="The unique ID of the ASP.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _directory_asps_get_serialize(
        self,
        user_key,
        code_id,
        xgafv,
    ...
    def directory_asps_list(
        ...
        _param = self._directory_asps_list_serialize(
            user_key=user_key,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def directory_asps_list_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def directory_asps_list_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _directory_asps_list_serialize(
        self,
        user_key,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/directory/v1/users/{userKey}/asps',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
