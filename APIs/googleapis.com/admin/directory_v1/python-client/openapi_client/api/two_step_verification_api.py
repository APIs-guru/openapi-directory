...
class TwoStepVerificationApi:
    ...
    def directory_two_step_verification_turn_off(
        ...
        """directory_two_step_verification_turn_off
        ...
        _param = self._directory_two_step_verification_turn_off_serialize(
            user_key=user_key,
            xgafv=xgafv,
    ...
    @validate_call
    def directory_two_step_verification_turn_off_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def directory_two_step_verification_turn_off_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _directory_two_step_verification_turn_off_serialize(
        self,
        user_key,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/directory/v1/users/{userKey}/twoStepVerification/turnOff',
