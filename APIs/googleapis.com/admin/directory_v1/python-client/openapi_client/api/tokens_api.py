...
class TokensApi:
    ...
    def directory_tokens_delete(
        ...
        client_id: Annotated[StrictStr, Field(description="The Client ID of the application the token is issued to.")],
        ...
        :type user_key: str
        :param client_id: The Client ID of the application the token is issued to. (required)
        :type client_id: str
        ...
        _param = self._directory_tokens_delete_serialize(
            user_key=user_key,
            client_id=client_id,
            xgafv=xgafv,
    ...
    @validate_call
    def directory_tokens_delete_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        client_id: Annotated[StrictStr, Field(description="The Client ID of the application the token is issued to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def directory_tokens_delete_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        client_id: Annotated[StrictStr, Field(description="The Client ID of the application the token is issued to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _directory_tokens_delete_serialize(
        self,
        user_key,
        client_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/directory/v1/users/{userKey}/tokens/{clientId}',
    ...
    def directory_tokens_get(
        ...
        _param = self._directory_tokens_get_serialize(
            user_key=user_key,
            client_id=client_id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def directory_tokens_get_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        client_id: Annotated[StrictStr, Field(description="The Client ID of the application the token is issued to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def directory_tokens_get_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        client_id: Annotated[StrictStr, Field(description="The Client ID of the application the token is issued to.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _directory_tokens_get_serialize(
        self,
        user_key,
        client_id,
        xgafv,
    ...
    def directory_tokens_list(
        ...
        _param = self._directory_tokens_list_serialize(
            user_key=user_key,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def directory_tokens_list_with_http_info(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def directory_tokens_list_without_preload_content(
        self,
        user_key: Annotated[StrictStr, Field(description="Identifies the user in the API request. The value can be the user's primary email address, alias email address, or unique user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _directory_tokens_list_serialize(
        self,
        user_key,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/directory/v1/users/{userKey}/tokens',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
