...
class CustomerUsageReportsApi:
    ...
    @validate_call
    def reports_customer_usage_reports_get(
        self,
        ...
        page_token: Annotated[Optional[StrictStr], Field(description="Token to specify next page. A report with multiple pages has a `nextPageToken` property in the response. For your follow-on requests getting all of the report's pages, enter the `nextPageToken` value in the `pageToken` query string.")] = None,
        ...
        :param page_token: Token to specify next page. A report with multiple pages has a `nextPageToken` property in the response. For your follow-on requests getting all of the report's pages, enter the `nextPageToken` value in the `pageToken` query string.
        :type page_token: str
        ...
        _param = self._reports_customer_usage_reports_get_serialize(
            var_date=var_date,
            xgafv=xgafv,
    ...
    @validate_call
    def reports_customer_usage_reports_get_with_http_info(
        self,
        var_date: Annotated[StrictStr, Field(description="Represents the date the usage occurred, based on UTC-8:00 (Pacific Standard Time). The timestamp is in the [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601), `yyyy-mm-dd`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def reports_customer_usage_reports_get_without_preload_content(
        self,
        var_date: Annotated[StrictStr, Field(description="Represents the date the usage occurred, based on UTC-8:00 (Pacific Standard Time). The timestamp is in the [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601), `yyyy-mm-dd`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _reports_customer_usage_reports_get_serialize(
        self,
        var_date,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/reports/v1/usage/dates/{date}',
