...
**payload** | **bool** | A Boolean value to indicate whether payload is wanted. A payload is data that is sent in the body of an HTTP POST, PUT, or PATCH message and contains important information about the request. Optional. | [optional] 
...
**type** | **str** | The type of delivery mechanism used for this channel. The value should be set to &#x60;\&quot;web_hook\&quot;&#x60;. | [optional] 
