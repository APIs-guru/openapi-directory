...
class ListWorkspacesResponse(BaseModel):
    ...
    workspace: Optional[List[Workspace]] = Field(default=None, description="All Workspaces of a GTM Container.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "workspace"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.workspace:
            for _item_workspace in self.workspace:
                if _item_workspace:
                    _items.append(_item_workspace.to_dict())
