...
class ListVariablesResponse(BaseModel):
    ...
    variable: Optional[List[Variable]] = Field(default=None, description="All GTM Variables of a GTM Container.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "variable"]
