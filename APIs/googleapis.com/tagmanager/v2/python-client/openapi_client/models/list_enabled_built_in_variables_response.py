...
class ListEnabledBuiltInVariablesResponse(BaseModel):
    ...
    """ # noqa: E501
    built_in_variable: Optional[List[BuiltInVariable]] = Field(default=None, description="All GTM BuiltInVariables of a GTM container.", alias="builtInVariable")
    ...
    __properties: ClassVar[List[str]] = ["builtInVariable", "nextPageToken"]
