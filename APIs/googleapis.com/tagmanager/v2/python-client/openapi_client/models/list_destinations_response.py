...
class ListDestinationsResponse(BaseModel):
    ...
    """ # noqa: E501
    destination: Optional[List[Destination]] = Field(default=None, description="All Destinations linked to a GTM Container.")
    ...
    __properties: ClassVar[List[str]] = ["destination", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": [Destination.from_dict(_item) for _item in obj["destination"]] if obj.get("destination") is not None else None,
