...
class ListTransformationsResponse(BaseModel):
    ...
    transformation: Optional[List[Transformation]] = Field(default=None, description="All GTM Transformations of a GTM Container.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "transformation"]
