...
class CreateBuiltInVariableResponse(BaseModel):
    ...
    """ # noqa: E501
    built_in_variable: Optional[List[BuiltInVariable]] = Field(default=None, description="List of created built-in variables.", alias="builtInVariable")
    __properties: ClassVar[List[str]] = ["builtInVariable"]
