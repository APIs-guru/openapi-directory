...
class ListGtagConfigResponse(BaseModel):
    ...
    """ # noqa: E501
    gtag_config: Optional[List[GtagConfig]] = Field(default=None, description="All Google tag configs in a Container.", alias="gtagConfig")
    ...
    __properties: ClassVar[List[str]] = ["gtagConfig", "nextPageToken"]
