...
class Trigger(BaseModel):
    ...
    auto_event_filter: Optional[List[Condition]] = Field(default=None, description="Used in the case of auto event tracking. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update", alias="autoEventFilter")
    ...
    custom_event_filter: Optional[List[Condition]] = Field(default=None, description="Used in the case of custom event, which is fired iff all Conditions are true. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update", alias="customEventFilter")
    event_name: Optional[Parameter] = Field(default=None, alias="eventName")
    filter: Optional[List[Condition]] = Field(default=None, description="The trigger will only fire iff all Conditions are true. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Trigger display name. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update")
    notes: Optional[StrictStr] = Field(default=None, description="User notes on how to apply this trigger in the container. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update")
    ...
    path: Optional[StrictStr] = Field(default=None, description="GTM Trigger's API relative path.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Defines the data layer event that causes this trigger. @mutable tagmanager.accounts.containers.workspaces.triggers.create @mutable tagmanager.accounts.containers.workspaces.triggers.update")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "autoEventFilter", "checkValidation", "containerId", "continuousTimeMinMilliseconds", "customEventFilter", "eventName", "filter", "fingerprint", "horizontalScrollPercentageList", "interval", "intervalSeconds", "limit", "maxTimerLengthSeconds", "name", "notes", "parameter", "parentFolderId", "path", "selector", "tagManagerUrl", "totalTimeMinMilliseconds", "triggerId", "type", "uniqueTriggerId", "verticalScrollPercentageList", "visibilitySelector", "visiblePercentageMax", "visiblePercentageMin", "waitForTags", "waitForTagsTimeout", "workspaceId"]
