...
class Environment(BaseModel):
    ...
    authorization_timestamp: Optional[StrictStr] = Field(default=None, description="The last update time-stamp for the authorization code.", alias="authorizationTimestamp")
    container_id: Optional[StrictStr] = Field(default=None, description="GTM Container ID.", alias="containerId")
    container_version_id: Optional[StrictStr] = Field(default=None, description="Represents a link to a container version.", alias="containerVersionId")
    ...
    enable_debug: Optional[StrictBool] = Field(default=None, description="Whether or not to enable debug by default for the environment. @mutable tagmanager.accounts.containers.environments.create @mutable tagmanager.accounts.containers.environments.update", alias="enableDebug")
    ...
    path: Optional[StrictStr] = Field(default=None, description="GTM Environment's API relative path.")
    ...
    workspace_id: Optional[StrictStr] = Field(default=None, description="Represents a link to a quick preview of a workspace.", alias="workspaceId")
    __properties: ClassVar[List[str]] = ["accountId", "authorizationCode", "authorizationTimestamp", "containerId", "containerVersionId", "description", "enableDebug", "environmentId", "fingerprint", "name", "path", "tagManagerUrl", "type", "url", "workspaceId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['user', 'live', 'latest', 'workspace']):
            raise ValueError("must be one of enum values ('user', 'live', 'latest', 'workspace')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorizationTimestamp": obj.get("authorizationTimestamp"),
