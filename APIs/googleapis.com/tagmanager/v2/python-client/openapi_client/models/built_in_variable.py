...
class BuiltInVariable(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the built-in variable to be used to refer to the built-in variable.")
    path: Optional[StrictStr] = Field(default=None, description="GTM BuiltInVariable's API relative path.")
    type: Optional[StrictStr] = Field(default=None, description="Type of built-in variable. @required.tagmanager.accounts.containers.workspaces.built_in_variable.update @mutable tagmanager.accounts.containers.workspaces.built_in_variable.update")
    workspace_id: Optional[StrictStr] = Field(default=None, description="GTM Workspace ID.", alias="workspaceId")
    __properties: ClassVar[List[str]] = ["accountId", "containerId", "name", "path", "type", "workspaceId"]
