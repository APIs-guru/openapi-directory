...
class TestCreateContainerVersionResponse(unittest.TestCase):
    """CreateContainerVersionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateContainerVersionResponse:
        """Test CreateContainerVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateContainerVersionResponse`
        """
        model = CreateContainerVersionResponse()
        if include_optional:
            return CreateContainerVersionResponse(
                ...
                container_version = openapi_client.models.container_version.ContainerVersion(
                    account_id = '', 
                    built_in_variable = [
                        openapi_client.models.built_in_variable.BuiltInVariable(
                            account_id = '', 
                            container_id = '', 
                            name = '', 
                            path = '', 
                    ...
                    tag_manager_url = '', 
                    transformation = [
                        openapi_client.models.transformation.Transformation(
                            account_id = '', 
                            container_id = '', 
                            fingerprint = '', 
                            name = '', 
    ...
    def testCreateContainerVersionResponse(self):
        """Test CreateContainerVersionResponse"""
