...
class TestQuickPreviewResponse(unittest.TestCase):
    """QuickPreviewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuickPreviewResponse:
        """Test QuickPreviewResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuickPreviewResponse`
        """
        model = QuickPreviewResponse()
        if include_optional:
    ...
    def testQuickPreviewResponse(self):
        """Test QuickPreviewResponse"""
