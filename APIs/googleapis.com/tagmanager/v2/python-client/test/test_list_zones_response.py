...
class TestListZonesResponse(unittest.TestCase):
    """ListZonesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListZonesResponse:
        """Test ListZonesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListZonesResponse`
        """
    ...
    def testListZonesResponse(self):
        """Test ListZonesResponse"""
