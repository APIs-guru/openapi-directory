...
------------ | ------------- | ------------- | -------------
**permission** | **List[str]** | List of Account permissions. Valid account permissions are read and manage. @mutable tagmanager.accounts.permissions.create @mutable tagmanager.accounts.permissions.update | [optional] 
