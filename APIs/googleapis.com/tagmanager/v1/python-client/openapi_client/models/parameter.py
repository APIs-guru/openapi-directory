...
class Parameter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "list", "map", "type", "value"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['template', 'integer', 'boolean', 'list', 'map', 'triggerReference', 'tagReference']):
            raise ValueError("must be one of enum values ('template', 'integer', 'boolean', 'list', 'map', 'triggerReference', 'tagReference')")
        return value
