...
class Tag(BaseModel):
    ...
    blocking_rule_id: Optional[List[StrictStr]] = Field(default=None, description="Blocking rule IDs. If any of the listed rules evaluate to true, the tag will not fire. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update", alias="blockingRuleId")
    blocking_trigger_id: Optional[List[StrictStr]] = Field(default=None, description="Blocking trigger IDs. If any of the listed triggers evaluate to true, the tag will not fire. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update", alias="blockingTriggerId")
    ...
    live_only: Optional[StrictBool] = Field(default=None, description="If set to true, this tag will only fire in the live environment (e.g. not in preview or debug mode). @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update", alias="liveOnly")
    name: Optional[StrictStr] = Field(default=None, description="Tag display name. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update")
    notes: Optional[StrictStr] = Field(default=None, description="User notes on how to apply this tag in the container. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update")
    parameter: Optional[List[Parameter]] = Field(default=None, description="The tag's parameters. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update")
    parent_folder_id: Optional[StrictStr] = Field(default=None, description="Parent folder id.", alias="parentFolderId")
    paused: Optional[StrictBool] = Field(default=None, description="True if the tag is paused. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update")
    priority: Optional[Parameter] = None
    schedule_end_ms: Optional[StrictStr] = Field(default=None, description="The end timestamp in milliseconds to schedule a tag. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update", alias="scheduleEndMs")
    schedule_start_ms: Optional[StrictStr] = Field(default=None, description="The start timestamp in milliseconds to schedule a tag. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update", alias="scheduleStartMs")
    ...
    type: Optional[StrictStr] = Field(default=None, description="GTM Tag Type. @mutable tagmanager.accounts.containers.tags.create @mutable tagmanager.accounts.containers.tags.update")
    __properties: ClassVar[List[str]] = ["accountId", "blockingRuleId", "blockingTriggerId", "containerId", "fingerprint", "firingRuleId", "firingTriggerId", "liveOnly", "name", "notes", "parameter", "parentFolderId", "paused", "priority", "scheduleEndMs", "scheduleStartMs", "setupTag", "tagFiringOption", "tagId", "teardownTag", "type"]
    ...
    def tag_firing_option_validate_enum(cls, value):
        ...
        if value not in set(['unlimited', 'oncePerEvent', 'oncePerLoad']):
            raise ValueError("must be one of enum values ('unlimited', 'oncePerEvent', 'oncePerLoad')")
        return value
