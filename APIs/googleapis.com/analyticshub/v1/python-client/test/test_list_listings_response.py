...
class TestListListingsResponse(unittest.TestCase):
    """ListListingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListListingsResponse:
        """Test ListListingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListListingsResponse`
        """
        model = ListListingsResponse()
        if include_optional:
    ...
    def testListListingsResponse(self):
        """Test ListListingsResponse"""
