...
class ListScansResponse(BaseModel):
    ...
    scans: Optional[List[Scan]] = Field(default=None, description="Available scans based on the list query parameters.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "scans"]
