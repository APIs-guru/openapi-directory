...
class TestIamPermissionsRequest(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[StrictStr]] = Field(default=None, description="REQUIRED: The set of permissions to check for 'resource'. Permissions with wildcards (such as '*', 'spanner.*', 'spanner.instances.*') are not allowed.")
