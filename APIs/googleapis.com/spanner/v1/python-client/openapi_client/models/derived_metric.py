...
class DerivedMetric(BaseModel):
    ...
    """ # noqa: E501
    denominator: Optional[LocalizedString] = None
    numerator: Optional[LocalizedString] = None
    __properties: ClassVar[List[str]] = ["denominator", "numerator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "denominator": LocalizedString.from_dict(obj["denominator"]) if obj.get("denominator") is not None else None,
            "numerator": LocalizedString.from_dict(obj["numerator"]) if obj.get("numerator") is not None else None
        })
        return _obj
