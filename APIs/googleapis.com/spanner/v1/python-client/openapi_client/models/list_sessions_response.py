...
class ListSessionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="`next_page_token` can be sent in a subsequent ListSessions call to fetch more of the matching sessions.", alias="nextPageToken")
    sessions: Optional[List[Session]] = Field(default=None, description="The list of requested sessions.")
