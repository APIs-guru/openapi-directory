...
class ContextValue(BaseModel):
    ...
    severity: Optional[StrictStr] = Field(default=None, description="The severity of this context.")
    unit: Optional[StrictStr] = Field(default=None, description="The unit of the context value.")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The value for the context.")
    __properties: ClassVar[List[str]] = ["label", "severity", "unit", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": LocalizedString.from_dict(obj["label"]) if obj.get("label") is not None else None,
