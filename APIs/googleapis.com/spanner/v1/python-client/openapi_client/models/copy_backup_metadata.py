...
class CopyBackupMetadata(BaseModel):
    ...
    """ # noqa: E501
    cancel_time: Optional[StrictStr] = Field(default=None, description="The time at which cancellation of CopyBackup operation was received. Operations.CancelOperation starts asynchronous cancellation on a long-running operation. The server makes a best effort to cancel the operation, but success is not guaranteed. Clients can use Operations.GetOperation or other methods to check whether the cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation, the operation is not deleted; instead, it becomes an operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.", alias="cancelTime")
    name: Optional[StrictStr] = Field(default=None, description="The name of the backup being created through the copy operation. Values are of the form `projects//instances//backups/`.")
    progress: Optional[OperationProgress] = None
    source_backup: Optional[StrictStr] = Field(default=None, description="The name of the source backup that is being copied. Values are of the form `projects//instances//backups/`.", alias="sourceBackup")
    __properties: ClassVar[List[str]] = ["cancelTime", "name", "progress", "sourceBackup"]
