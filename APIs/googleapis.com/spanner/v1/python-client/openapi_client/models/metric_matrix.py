...
class MetricMatrix(BaseModel):
    ...
    """ # noqa: E501
    rows: Optional[List[MetricMatrixRow]] = Field(default=None, description="The rows of the matrix.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [MetricMatrixRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
