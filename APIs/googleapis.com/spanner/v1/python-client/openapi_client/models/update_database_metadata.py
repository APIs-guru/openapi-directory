...
class UpdateDatabaseMetadata(BaseModel):
    ...
    """ # noqa: E501
    cancel_time: Optional[StrictStr] = Field(default=None, description="The time at which this operation was cancelled. If set, this operation is in the process of undoing itself (which is best-effort).", alias="cancelTime")
    progress: Optional[OperationProgress] = None
    request: Optional[UpdateDatabaseRequest] = None
    __properties: ClassVar[List[str]] = ["cancelTime", "progress", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": UpdateDatabaseRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
