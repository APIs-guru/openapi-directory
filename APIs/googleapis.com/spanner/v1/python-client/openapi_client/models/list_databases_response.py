...
class ListDatabasesResponse(BaseModel):
    ...
    """ # noqa: E501
    databases: Optional[List[Database]] = Field(default=None, description="Databases that matched the request.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="`next_page_token` can be sent in a subsequent ListDatabases call to fetch more of the matching databases.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["databases", "nextPageToken"]
