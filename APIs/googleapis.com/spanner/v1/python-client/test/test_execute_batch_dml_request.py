...
class TestExecuteBatchDmlRequest(unittest.TestCase):
    """ExecuteBatchDmlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteBatchDmlRequest:
        """Test ExecuteBatchDmlRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteBatchDmlRequest`
        """
        model = ExecuteBatchDmlRequest()
        if include_optional:
    ...
    def testExecuteBatchDmlRequest(self):
        """Test ExecuteBatchDmlRequest"""
