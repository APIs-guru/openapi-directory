...
class TestKeyRangeInfos(unittest.TestCase):
    """KeyRangeInfos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyRangeInfos:
        """Test KeyRangeInfos
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyRangeInfos`
        """
        model = KeyRangeInfos()
        if include_optional:
