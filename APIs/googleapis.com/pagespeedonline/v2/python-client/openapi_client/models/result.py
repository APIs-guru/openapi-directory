...
class Result(BaseModel):
    ...
    rule_groups: Optional[Dict[str, ResultRuleGroupsValue]] = Field(default=None, description="A map with one entry for each rule group in these results.", alias="ruleGroups")
    screenshot: Optional[PagespeedApiImageV2] = None
    ...
    __properties: ClassVar[List[str]] = ["captchaResult", "formattedResults", "id", "invalidRules", "kind", "pageStats", "responseCode", "ruleGroups", "screenshot", "title", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ruleGroups": dict(
                (_k, ResultRuleGroupsValue.from_dict(_v))
                for _k, _v in obj["ruleGroups"].items()
            )
            if obj.get("ruleGroups") is not None
            else None,
            "screenshot": PagespeedApiImageV2.from_dict(obj["screenshot"]) if obj.get("screenshot") is not None else None,
            "title": obj.get("title"),
