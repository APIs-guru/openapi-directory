...
class ResultFormattedResultsRuleResultsValue(BaseModel):
    """
    The enum-like identifier for this rule. For instance \"EnableKeepAlive\" or \"AvoidCssImport\". Not localized.
    """ # noqa: E501
    groups: Optional[List[StrictStr]] = Field(default=None, description="List of rule groups that this rule belongs to. Each entry in the list is one of \"SPEED\" or \"USABILITY\".")
    ...
    summary: Optional[PagespeedApiFormatStringV2] = None
    url_blocks: Optional[List[ResultFormattedResultsRuleResultsValueUrlBlocksInner]] = Field(default=None, description="List of blocks of URLs. Each block may contain a heading and a list of URLs. Each URL may optionally include additional details.", alias="urlBlocks")
    __properties: ClassVar[List[str]] = ["groups", "localizedRuleName", "ruleImpact", "summary", "urlBlocks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summary": PagespeedApiFormatStringV2.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "urlBlocks": [ResultFormattedResultsRuleResultsValueUrlBlocksInner.from_dict(_item) for _item in obj["urlBlocks"]] if obj.get("urlBlocks") is not None else None
        })
        return _obj
