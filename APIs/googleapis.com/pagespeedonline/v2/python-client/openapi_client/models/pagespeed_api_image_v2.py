...
class PagespeedApiImageV2(BaseModel):
    """
    PagespeedApiImageV2
    """ # noqa: E501
    ...
    page_rect: Optional[PagespeedApiImageV2PageRect] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagespeedApiImageV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagespeedApiImageV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page_rect": PagespeedApiImageV2PageRect.from_dict(obj["page_rect"]) if obj.get("page_rect") is not None else None,
            "width": obj.get("width")
        })
        return _obj
