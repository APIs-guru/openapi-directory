...
class ResultFormattedResults(BaseModel):
    """
    ...
    rule_results: Optional[Dict[str, ResultFormattedResultsRuleResultsValue]] = Field(default=None, description="Dictionary of formatted rule results, with one entry for each PageSpeed rule instantiated and run by the server.", alias="ruleResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ruleResults": dict(
                (_k, ResultFormattedResultsRuleResultsValue.from_dict(_v))
