...
class ResultFormattedResultsRuleResultsValueUrlBlocksInner(BaseModel):
    """
    ResultFormattedResultsRuleResultsValueUrlBlocksInner
    """ # noqa: E501
    header: Optional[ResultFormattedResultsRuleResultsValueUrlBlocksInnerHeader] = None
    urls: Optional[List[ResultFormattedResultsRuleResultsValueUrlBlocksInnerUrlsInner]] = Field(default=None, description="List of entries that provide information about URLs in the url block. Optional.")
    __properties: ClassVar[List[str]] = ["header", "urls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "header": ResultFormattedResultsRuleResultsValueUrlBlocksInnerHeader.from_dict(obj["header"]) if obj.get("header") is not None else None,
            "urls": [ResultFormattedResultsRuleResultsValueUrlBlocksInnerUrlsInner.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None
        })
        return _obj
