...
class PagespeedApiPagespeedResponseV4LoadingExperienceMetricsValueDistributionsInner(BaseModel):
    """
    PagespeedApiPagespeedResponseV4LoadingExperienceMetricsValueDistributionsInner
    """ # noqa: E501
    max: Optional[StrictInt] = None
    min: Optional[StrictInt] = None
    proportion: Optional[Union[StrictFloat, StrictInt]] = None
