...
class PagespeedApiPagespeedResponseV4FormattedResultsRuleResultsValueUrlBlocksInner(BaseModel):
    """
    PagespeedApiPagespeedResponseV4FormattedResultsRuleResultsValueUrlBlocksInner
    """ # noqa: E501
    header: Optional[PagespeedApiFormatStringV4] = None
    urls: Optional[List[PagespeedApiPagespeedResponseV4FormattedResultsRuleResultsValueUrlBlocksInnerUrlsInner]] = Field(default=None, description="List of entries that provide information about URLs in the url block. Optional.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "header": PagespeedApiFormatStringV4.from_dict(obj["header"]) if obj.get("header") is not None else None,
            "urls": [PagespeedApiPagespeedResponseV4FormattedResultsRuleResultsValueUrlBlocksInnerUrlsInner.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None
        })
        return _obj
