...
class TestPagespeedApiPagespeedResponseV4FormattedResults(unittest.TestCase):
    """PagespeedApiPagespeedResponseV4FormattedResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagespeedApiPagespeedResponseV4FormattedResults:
        """Test PagespeedApiPagespeedResponseV4FormattedResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagespeedApiPagespeedResponseV4FormattedResults`
        """
        model = PagespeedApiPagespeedResponseV4FormattedResults()
        if include_optional:
    ...
    def testPagespeedApiPagespeedResponseV4FormattedResults(self):
        """Test PagespeedApiPagespeedResponseV4FormattedResults"""
