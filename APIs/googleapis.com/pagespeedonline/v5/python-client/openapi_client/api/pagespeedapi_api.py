...
class PagespeedapiApi:
    ...
    def pagespeedonline_pagespeedapi_runpagespeed(
        self,
        url: Annotated[StrictStr, Field(description="Required. The URL to fetch and analyze")],
        ...
        captcha_token: Annotated[Optional[StrictStr], Field(description="The captcha token passed when filling out a captcha.")] = None,
        category: Annotated[Optional[List[StrictStr]], Field(description="A Lighthouse category to run; if none are given, only Performance category will be run")] = None,
        ...
        :param url: Required. The URL to fetch and analyze (required)
        :type url: str
        ...
        :param captcha_token: The captcha token passed when filling out a captcha.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PagespeedApiPagespeedResponseV5",
        }
    ...
    def pagespeedonline_pagespeedapi_runpagespeed_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagespeedApiPagespeedResponseV5]:
        """pagespeedonline_pagespeedapi_runpagespeed
    ...
    def _pagespeedonline_pagespeedapi_runpagespeed_serialize(
        ...
        if captcha_token is not None:
            ...
            _query_params.append(('captchaToken', captcha_token))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pagespeedonline/v5/runPagespeed',
