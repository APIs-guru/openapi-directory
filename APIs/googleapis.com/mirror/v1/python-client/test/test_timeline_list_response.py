...
class TestTimelineListResponse(unittest.TestCase):
    """TimelineListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineListResponse:
        """Test TimelineListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineListResponse`
        """
        model = TimelineListResponse()
        if include_optional:
            return TimelineListResponse(
                items = [
                    openapi_client.models.timeline_item.TimelineItem(
                        attachments = [
    ...
    def testTimelineListResponse(self):
        """Test TimelineListResponse"""
