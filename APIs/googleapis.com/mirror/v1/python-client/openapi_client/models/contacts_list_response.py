...
class ContactsListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Contact]] = Field(default=None, description="Contact list.")
    kind: Optional[StrictStr] = Field(default='mirror#contacts', description="The type of resource. This is always mirror#contacts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'mirror#contacts'
        })
        return _obj
