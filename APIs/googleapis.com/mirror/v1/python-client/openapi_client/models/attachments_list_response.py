...
class AttachmentsListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Attachment]] = Field(default=None, description="The list of attachments.")
    kind: Optional[StrictStr] = Field(default='mirror#attachmentsList', description="The type of resource. This is always mirror#attachmentsList.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'mirror#attachmentsList'
        })
        return _obj
