...
class LocationsApi:
    ...
    def mirror_locations_get(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the location or latest for the last known location.")],
        ...
        :param id: The ID of the location or latest for the last known location. (required)
        :type id: str
        ...
        _param = self._mirror_locations_get_serialize(
            id=id,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def mirror_locations_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the location or latest for the last known location.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def mirror_locations_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the location or latest for the last known location.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _mirror_locations_get_serialize(
        self,
        id,
        alt,
        fields,
    ...
    def mirror_locations_list(
        ...
        _param = self._mirror_locations_list_serialize(
            alt=alt,
            fields=fields,
            key=key,
            oauth_token=oauth_token,
    ...
    @validate_call
    def mirror_locations_list_with_http_info(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocationsListResponse]:
        """mirror_locations_list
    ...
    @validate_call
    def mirror_locations_list_without_preload_content(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _mirror_locations_list_serialize(
        self,
        alt,
        fields,
        key,
