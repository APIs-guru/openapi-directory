...
class AccountsApi:
    ...
    def mirror_accounts_insert(
        self,
        user_token: Annotated[StrictStr, Field(description="The ID for the user.")],
        account_type: Annotated[StrictStr, Field(description="Account type to be passed to Android Account Manager.")],
        account_name: Annotated[StrictStr, Field(description="The name of the account to be passed to the Android Account Manager.")],
        ...
        :param user_token: The ID for the user. (required)
        :type user_token: str
        :param account_type: Account type to be passed to Android Account Manager. (required)
        :type account_type: str
        :param account_name: The name of the account to be passed to the Android Account Manager. (required)
        ...
        _param = self._mirror_accounts_insert_serialize(
    ...
    @validate_call
    def mirror_accounts_insert_with_http_info(
        self,
        user_token: Annotated[StrictStr, Field(description="The ID for the user.")],
        account_type: Annotated[StrictStr, Field(description="Account type to be passed to Android Account Manager.")],
        account_name: Annotated[StrictStr, Field(description="The name of the account to be passed to the Android Account Manager.")],
    ...
    @validate_call
    def mirror_accounts_insert_without_preload_content(
        self,
        user_token: Annotated[StrictStr, Field(description="The ID for the user.")],
        account_type: Annotated[StrictStr, Field(description="Account type to be passed to Android Account Manager.")],
        account_name: Annotated[StrictStr, Field(description="The name of the account to be passed to the Android Account Manager.")],
    ...
    def _mirror_accounts_insert_serialize(
        self,
        user_token,
        account_type,
        account_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounts/{userToken}/{accountType}/{accountName}',
