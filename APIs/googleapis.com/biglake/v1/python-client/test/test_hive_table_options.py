...
class TestHiveTableOptions(unittest.TestCase):
    """HiveTableOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HiveTableOptions:
        """Test HiveTableOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HiveTableOptions`
        """
        model = HiveTableOptions()
        if include_optional:
