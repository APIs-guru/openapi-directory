...
class SerDeInfo(BaseModel):
    ...
    """ # noqa: E501
    serialization_lib: Optional[StrictStr] = Field(default=None, description="The fully qualified Java class name of the serialization library.", alias="serializationLib")
    __properties: ClassVar[List[str]] = ["serializationLib"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serializationLib": obj.get("serializationLib")
        })
        return _obj
