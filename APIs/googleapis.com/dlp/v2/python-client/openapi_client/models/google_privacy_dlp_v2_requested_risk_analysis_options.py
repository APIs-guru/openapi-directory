...
class GooglePrivacyDlpV2RequestedRiskAnalysisOptions(BaseModel):
    ...
    """ # noqa: E501
    job_config: Optional[GooglePrivacyDlpV2RiskAnalysisJobConfig] = Field(default=None, alias="jobConfig")
    __properties: ClassVar[List[str]] = ["jobConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.job_config:
            _dict['jobConfig'] = self.job_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobConfig": GooglePrivacyDlpV2RiskAnalysisJobConfig.from_dict(obj["jobConfig"]) if obj.get("jobConfig") is not None else None
        })
        return _obj
