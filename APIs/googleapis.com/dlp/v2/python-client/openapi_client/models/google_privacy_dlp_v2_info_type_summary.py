...
class GooglePrivacyDlpV2InfoTypeSummary(BaseModel):
    ...
    """ # noqa: E501
    estimated_prevalence: Optional[StrictInt] = Field(default=None, description="Not populated for predicted infotypes.", alias="estimatedPrevalence")
    info_type: Optional[GooglePrivacyDlpV2InfoType] = Field(default=None, alias="infoType")
    __properties: ClassVar[List[str]] = ["estimatedPrevalence", "infoType"]
