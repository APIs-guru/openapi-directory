...
class GooglePrivacyDlpV2StatisticalTable(BaseModel):
    ...
    """ # noqa: E501
    quasi_ids: Optional[List[GooglePrivacyDlpV2QuasiIdentifierField]] = Field(default=None, description="Required. Quasi-identifier columns.", alias="quasiIds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quasiIds": [GooglePrivacyDlpV2QuasiIdentifierField.from_dict(_item) for _item in obj["quasiIds"]] if obj.get("quasiIds") is not None else None,
