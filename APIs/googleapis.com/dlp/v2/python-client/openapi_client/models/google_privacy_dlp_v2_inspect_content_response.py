...
class GooglePrivacyDlpV2InspectContentResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[GooglePrivacyDlpV2InspectResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": GooglePrivacyDlpV2InspectResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
