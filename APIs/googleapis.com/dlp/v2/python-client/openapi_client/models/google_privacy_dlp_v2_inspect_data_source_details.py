...
class GooglePrivacyDlpV2InspectDataSourceDetails(BaseModel):
    ...
    """ # noqa: E501
    requested_options: Optional[GooglePrivacyDlpV2RequestedOptions] = Field(default=None, alias="requestedOptions")
    result: Optional[GooglePrivacyDlpV2Result] = None
    __properties: ClassVar[List[str]] = ["requestedOptions", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestedOptions": GooglePrivacyDlpV2RequestedOptions.from_dict(obj["requestedOptions"]) if obj.get("requestedOptions") is not None else None,
            "result": GooglePrivacyDlpV2Result.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
