...
class GooglePrivacyDlpV2Row(BaseModel):
    ...
    Values of the row.
    """ # noqa: E501
    values: Optional[List[GooglePrivacyDlpV2Value]] = Field(default=None, description="Individual cells.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [GooglePrivacyDlpV2Value.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
