...
class GooglePrivacyDlpV2ContentItem(BaseModel):
    ...
    table: Optional[GooglePrivacyDlpV2Table] = None
    value: Optional[StrictStr] = Field(default=None, description="String data to inspect or redact.")
    __properties: ClassVar[List[str]] = ["byteItem", "table", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "table": GooglePrivacyDlpV2Table.from_dict(obj["table"]) if obj.get("table") is not None else None,
            "value": obj.get("value")
        })
        return _obj
