...
class GooglePrivacyDlpV2BigQueryRegexes(BaseModel):
    """
    A collection of regular expressions to determine what tables to match against.
    """ # noqa: E501
    patterns: Optional[List[GooglePrivacyDlpV2BigQueryRegex]] = Field(default=None, description="A single BigQuery regular expression pattern to match against one or more tables, datasets, or projects that contain BigQuery tables.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patterns": [GooglePrivacyDlpV2BigQueryRegex.from_dict(_item) for _item in obj["patterns"]] if obj.get("patterns") is not None else None
        })
        return _obj
