...
class GooglePrivacyDlpV2DeidentifyContentRequest(BaseModel):
    ...
    deidentify_template_name: Optional[StrictStr] = Field(default=None, description="Template to use. Any configuration directly specified in deidentify_config will override those set in the template. Singular fields that are set in this request will replace their corresponding fields in the template. Repeated fields are appended. Singular sub-messages and groups are recursively merged.", alias="deidentifyTemplateName")
    ...
    __properties: ClassVar[List[str]] = ["deidentifyConfig", "deidentifyTemplateName", "inspectConfig", "inspectTemplateName", "item", "locationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deidentifyTemplateName": obj.get("deidentifyTemplateName"),
