...
class GooglePrivacyDlpV2ImageRedactionConfig(BaseModel):
    ...
    redact_all_text: Optional[StrictBool] = Field(default=None, description="If true, all text found in the image, regardless whether it matches an info_type, is redacted. Only one should be provided.", alias="redactAllText")
    redaction_color: Optional[GooglePrivacyDlpV2Color] = Field(default=None, alias="redactionColor")
    __properties: ClassVar[List[str]] = ["infoType", "redactAllText", "redactionColor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redactAllText": obj.get("redactAllText"),
