...
class GooglePrivacyDlpV2ReplaceValueConfig(BaseModel):
    ...
    """ # noqa: E501
    new_value: Optional[GooglePrivacyDlpV2Value] = Field(default=None, alias="newValue")
    __properties: ClassVar[List[str]] = ["newValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newValue": GooglePrivacyDlpV2Value.from_dict(obj["newValue"]) if obj.get("newValue") is not None else None
        })
        return _obj
