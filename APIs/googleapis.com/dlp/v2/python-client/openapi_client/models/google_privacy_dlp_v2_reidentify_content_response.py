...
class GooglePrivacyDlpV2ReidentifyContentResponse(BaseModel):
    ...
    overview: Optional[GooglePrivacyDlpV2TransformationOverview] = None
    __properties: ClassVar[List[str]] = ["item", "overview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overview": GooglePrivacyDlpV2TransformationOverview.from_dict(obj["overview"]) if obj.get("overview") is not None else None
        })
        return _obj
