...
class GooglePrivacyDlpV2CloudStoragePath(BaseModel):
    ...
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="A URL representing a file or path (no wildcards) in Cloud Storage. Example: `gs://[BUCKET_NAME]/dictionary.txt`")
