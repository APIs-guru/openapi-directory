...
class GooglePrivacyDlpV2OtherInfoTypeSummary(BaseModel):
    ...
    """ # noqa: E501
    estimated_prevalence: Optional[StrictInt] = Field(default=None, description="Approximate percentage of non-null rows that contained data detected by this infotype.", alias="estimatedPrevalence")
    excluded_from_analysis: Optional[StrictBool] = Field(default=None, description="Whether this infoType was excluded from sensitivity and risk analysis due to factors such as low prevalence (subject to change).", alias="excludedFromAnalysis")
    info_type: Optional[GooglePrivacyDlpV2InfoType] = Field(default=None, alias="infoType")
    __properties: ClassVar[List[str]] = ["estimatedPrevalence", "excludedFromAnalysis", "infoType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "estimatedPrevalence": obj.get("estimatedPrevalence"),
            "excludedFromAnalysis": obj.get("excludedFromAnalysis"),
