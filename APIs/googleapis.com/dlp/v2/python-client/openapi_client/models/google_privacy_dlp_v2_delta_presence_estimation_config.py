...
class GooglePrivacyDlpV2DeltaPresenceEstimationConfig(BaseModel):
    ...
    """ # noqa: E501
    auxiliary_tables: Optional[List[GooglePrivacyDlpV2StatisticalTable]] = Field(default=None, description="Several auxiliary tables can be used in the analysis. Each custom_tag used to tag a quasi-identifiers field must appear in exactly one field of one auxiliary table.", alias="auxiliaryTables")
    quasi_ids: Optional[List[GooglePrivacyDlpV2QuasiId]] = Field(default=None, description="Required. Fields considered to be quasi-identifiers. No two fields can have the same tag.", alias="quasiIds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auxiliaryTables": [GooglePrivacyDlpV2StatisticalTable.from_dict(_item) for _item in obj["auxiliaryTables"]] if obj.get("auxiliaryTables") is not None else None,
            "quasiIds": [GooglePrivacyDlpV2QuasiId.from_dict(_item) for _item in obj["quasiIds"]] if obj.get("quasiIds") is not None else None,
