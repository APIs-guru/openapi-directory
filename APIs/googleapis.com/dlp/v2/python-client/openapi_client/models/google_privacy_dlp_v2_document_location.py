...
class GooglePrivacyDlpV2DocumentLocation(BaseModel):
    ...
    """ # noqa: E501
    file_offset: Optional[StrictStr] = Field(default=None, description="Offset of the line, from the beginning of the file, where the finding is located.", alias="fileOffset")
    __properties: ClassVar[List[str]] = ["fileOffset"]
