...
class GooglePrivacyDlpV2CreateStoredInfoTypeRequest(BaseModel):
    ...
    stored_info_type_id: Optional[StrictStr] = Field(default=None, description="The storedInfoType ID can contain uppercase and lowercase letters, numbers, and hyphens; that is, it must match the regular expression: `[a-zA-Z\\d-_]+`. The maximum length is 100 characters. Can be empty to allow the system to generate one.", alias="storedInfoTypeId")
    __properties: ClassVar[List[str]] = ["config", "locationId", "storedInfoTypeId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storedInfoTypeId": obj.get("storedInfoTypeId")
        })
        return _obj
