...
class GooglePrivacyDlpV2DataProfilePubSubMessage(BaseModel):
    ...
    """ # noqa: E501
    event: Optional[StrictStr] = Field(default=None, description="The event that caused the Pub/Sub message to be sent.")
    profile: Optional[GooglePrivacyDlpV2TableDataProfile] = None
    __properties: ClassVar[List[str]] = ["event", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "profile": GooglePrivacyDlpV2TableDataProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj
