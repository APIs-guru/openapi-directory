...
class GooglePrivacyDlpV2ListInfoTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    info_types: Optional[List[GooglePrivacyDlpV2InfoTypeDescription]] = Field(default=None, description="Set of sensitive infoTypes.", alias="infoTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "infoTypes": [GooglePrivacyDlpV2InfoTypeDescription.from_dict(_item) for _item in obj["infoTypes"]] if obj.get("infoTypes") is not None else None
        })
        return _obj
