...
class GooglePrivacyDlpV2CreateDlpJobRequest(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="The job id can contain uppercase and lowercase letters, numbers, and hyphens; that is, it must match the regular expression: `[a-zA-Z\\d-_]+`. The maximum length is 100 characters. Can be empty to allow the system to generate one.", alias="jobId")
    location_id: Optional[StrictStr] = Field(default=None, description="Deprecated. This field has no effect.", alias="locationId")
    risk_job: Optional[GooglePrivacyDlpV2RiskAnalysisJobConfig] = Field(default=None, alias="riskJob")
    __properties: ClassVar[List[str]] = ["inspectJob", "jobId", "locationId", "riskJob"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of risk_job
        if self.risk_job:
            _dict['riskJob'] = self.risk_job.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "riskJob": GooglePrivacyDlpV2RiskAnalysisJobConfig.from_dict(obj["riskJob"]) if obj.get("riskJob") is not None else None
        })
        return _obj
