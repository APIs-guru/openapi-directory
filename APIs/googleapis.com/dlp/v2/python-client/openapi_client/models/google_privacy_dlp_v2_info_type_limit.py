...
class GooglePrivacyDlpV2InfoTypeLimit(BaseModel):
    ...
    max_findings: Optional[StrictInt] = Field(default=None, description="Max findings limit for the given infoType.", alias="maxFindings")
    __properties: ClassVar[List[str]] = ["infoType", "maxFindings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxFindings": obj.get("maxFindings")
        })
        return _obj
