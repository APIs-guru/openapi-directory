...
class GooglePrivacyDlpV2BucketingConfig(BaseModel):
    ...
    """ # noqa: E501
    buckets: Optional[List[GooglePrivacyDlpV2Bucket]] = Field(default=None, description="Set of buckets. Ranges must be non-overlapping.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [GooglePrivacyDlpV2Bucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
