...
class GooglePrivacyDlpV2TableOptions(BaseModel):
    ...
    """ # noqa: E501
    identifying_fields: Optional[List[GooglePrivacyDlpV2FieldId]] = Field(default=None, description="The columns that are the primary keys for table objects included in ContentItem. A copy of this cell's value will stored alongside alongside each finding so that the finding can be traced to the specific row it came from. No more than 3 may be provided.", alias="identifyingFields")
    __properties: ClassVar[List[str]] = ["identifyingFields"]
