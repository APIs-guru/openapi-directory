...
class GooglePrivacyDlpV2ListDlpJobsResponse(BaseModel):
    ...
    """ # noqa: E501
    jobs: Optional[List[GooglePrivacyDlpV2DlpJob]] = Field(default=None, description="A list of DlpJobs that matches the specified filter in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [GooglePrivacyDlpV2DlpJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
