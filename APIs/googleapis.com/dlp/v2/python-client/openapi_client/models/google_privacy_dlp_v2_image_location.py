...
class GooglePrivacyDlpV2ImageLocation(BaseModel):
    ...
    """ # noqa: E501
    bounding_boxes: Optional[List[GooglePrivacyDlpV2BoundingBox]] = Field(default=None, description="Bounding boxes locating the pixels within the image containing the finding.", alias="boundingBoxes")
    __properties: ClassVar[List[str]] = ["boundingBoxes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boundingBoxes": [GooglePrivacyDlpV2BoundingBox.from_dict(_item) for _item in obj["boundingBoxes"]] if obj.get("boundingBoxes") is not None else None
        })
        return _obj
