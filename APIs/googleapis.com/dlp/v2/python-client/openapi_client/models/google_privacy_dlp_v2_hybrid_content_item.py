...
class GooglePrivacyDlpV2HybridContentItem(BaseModel):
    ...
    """ # noqa: E501
    finding_details: Optional[GooglePrivacyDlpV2HybridFindingDetails] = Field(default=None, alias="findingDetails")
    item: Optional[GooglePrivacyDlpV2ContentItem] = None
    __properties: ClassVar[List[str]] = ["findingDetails", "item"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.finding_details:
            _dict['findingDetails'] = self.finding_details.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "findingDetails": GooglePrivacyDlpV2HybridFindingDetails.from_dict(obj["findingDetails"]) if obj.get("findingDetails") is not None else None,
