...
class InfoTypesApi:
    ...
    def dlp_info_types_list(
        ...
        parent: Annotated[Optional[StrictStr], Field(description="The parent resource name. The format of this value is as follows: locations/ LOCATION_ID")] = None,
        ...
        _param = self._dlp_info_types_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def dlp_info_types_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def dlp_info_types_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _dlp_info_types_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
