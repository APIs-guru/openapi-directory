...
class TestGooglePrivacyDlpV2StoredInfoTypeConfig(unittest.TestCase):
    """GooglePrivacyDlpV2StoredInfoTypeConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2StoredInfoTypeConfig:
        """Test GooglePrivacyDlpV2StoredInfoTypeConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2StoredInfoTypeConfig`
        """
        model = GooglePrivacyDlpV2StoredInfoTypeConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2StoredInfoTypeConfig(self):
        """Test GooglePrivacyDlpV2StoredInfoTypeConfig"""
