...
class TestGooglePrivacyDlpV2RequestedRiskAnalysisOptions(unittest.TestCase):
    """GooglePrivacyDlpV2RequestedRiskAnalysisOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2RequestedRiskAnalysisOptions:
        """Test GooglePrivacyDlpV2RequestedRiskAnalysisOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2RequestedRiskAnalysisOptions`
        """
        model = GooglePrivacyDlpV2RequestedRiskAnalysisOptions()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2RequestedRiskAnalysisOptions(self):
        """Test GooglePrivacyDlpV2RequestedRiskAnalysisOptions"""
