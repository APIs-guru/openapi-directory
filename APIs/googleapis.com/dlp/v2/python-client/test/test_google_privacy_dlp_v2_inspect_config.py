...
class TestGooglePrivacyDlpV2InspectConfig(unittest.TestCase):
    """GooglePrivacyDlpV2InspectConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectConfig:
        """Test GooglePrivacyDlpV2InspectConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectConfig`
        """
        model = GooglePrivacyDlpV2InspectConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectConfig(self):
        """Test GooglePrivacyDlpV2InspectConfig"""
