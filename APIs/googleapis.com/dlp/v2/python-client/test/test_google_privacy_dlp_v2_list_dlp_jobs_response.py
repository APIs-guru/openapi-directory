...
class TestGooglePrivacyDlpV2ListDlpJobsResponse(unittest.TestCase):
    """GooglePrivacyDlpV2ListDlpJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2ListDlpJobsResponse:
        """Test GooglePrivacyDlpV2ListDlpJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2ListDlpJobsResponse`
        """
        model = GooglePrivacyDlpV2ListDlpJobsResponse()
        if include_optional:
            return GooglePrivacyDlpV2ListDlpJobsResponse(
                jobs = [
                    openapi_client.models.google_privacy_dlp_v2_dlp_job.GooglePrivacyDlpV2DlpJob(
                        action_details = [
    ...
    def testGooglePrivacyDlpV2ListDlpJobsResponse(self):
        """Test GooglePrivacyDlpV2ListDlpJobsResponse"""
