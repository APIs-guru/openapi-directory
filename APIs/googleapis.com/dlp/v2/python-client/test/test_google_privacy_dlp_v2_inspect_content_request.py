...
class TestGooglePrivacyDlpV2InspectContentRequest(unittest.TestCase):
    """GooglePrivacyDlpV2InspectContentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectContentRequest:
        """Test GooglePrivacyDlpV2InspectContentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectContentRequest`
        """
        model = GooglePrivacyDlpV2InspectContentRequest()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectContentRequest(self):
        """Test GooglePrivacyDlpV2InspectContentRequest"""
