...
class TestGooglePrivacyDlpV2UpdateInspectTemplateRequest(unittest.TestCase):
    """GooglePrivacyDlpV2UpdateInspectTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2UpdateInspectTemplateRequest:
        """Test GooglePrivacyDlpV2UpdateInspectTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2UpdateInspectTemplateRequest`
        """
        model = GooglePrivacyDlpV2UpdateInspectTemplateRequest()
        if include_optional:
            return GooglePrivacyDlpV2UpdateInspectTemplateRequest(
                inspect_template = openapi_client.models.google_privacy_dlp_v2_inspect_template.GooglePrivacyDlpV2InspectTemplate(
                    create_time = '', 
                    description = '', 
                    display_name = '', 
    ...
    def testGooglePrivacyDlpV2UpdateInspectTemplateRequest(self):
        """Test GooglePrivacyDlpV2UpdateInspectTemplateRequest"""
