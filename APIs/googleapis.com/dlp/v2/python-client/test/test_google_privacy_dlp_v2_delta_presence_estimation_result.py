...
class TestGooglePrivacyDlpV2DeltaPresenceEstimationResult(unittest.TestCase):
    """GooglePrivacyDlpV2DeltaPresenceEstimationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DeltaPresenceEstimationResult:
        """Test GooglePrivacyDlpV2DeltaPresenceEstimationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DeltaPresenceEstimationResult`
        """
        model = GooglePrivacyDlpV2DeltaPresenceEstimationResult()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DeltaPresenceEstimationResult(self):
        """Test GooglePrivacyDlpV2DeltaPresenceEstimationResult"""
