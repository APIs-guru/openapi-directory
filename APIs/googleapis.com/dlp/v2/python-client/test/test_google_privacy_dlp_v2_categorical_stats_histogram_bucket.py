...
class TestGooglePrivacyDlpV2CategoricalStatsHistogramBucket(unittest.TestCase):
    """GooglePrivacyDlpV2CategoricalStatsHistogramBucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CategoricalStatsHistogramBucket:
        """Test GooglePrivacyDlpV2CategoricalStatsHistogramBucket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CategoricalStatsHistogramBucket`
        """
        model = GooglePrivacyDlpV2CategoricalStatsHistogramBucket()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2CategoricalStatsHistogramBucket(self):
        """Test GooglePrivacyDlpV2CategoricalStatsHistogramBucket"""
