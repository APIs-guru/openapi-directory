...
class TestGooglePrivacyDlpV2HybridContentItem(unittest.TestCase):
    """GooglePrivacyDlpV2HybridContentItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2HybridContentItem:
        """Test GooglePrivacyDlpV2HybridContentItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2HybridContentItem`
        """
        model = GooglePrivacyDlpV2HybridContentItem()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2HybridContentItem(self):
        """Test GooglePrivacyDlpV2HybridContentItem"""
