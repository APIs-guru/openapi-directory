...
class TestGooglePrivacyDlpV2DataProfileJobConfig(unittest.TestCase):
    """GooglePrivacyDlpV2DataProfileJobConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DataProfileJobConfig:
        """Test GooglePrivacyDlpV2DataProfileJobConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DataProfileJobConfig`
        """
        model = GooglePrivacyDlpV2DataProfileJobConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DataProfileJobConfig(self):
        """Test GooglePrivacyDlpV2DataProfileJobConfig"""
