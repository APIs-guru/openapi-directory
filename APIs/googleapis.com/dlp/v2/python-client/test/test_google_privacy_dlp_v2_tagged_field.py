...
class TestGooglePrivacyDlpV2TaggedField(unittest.TestCase):
    """GooglePrivacyDlpV2TaggedField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2TaggedField:
        """Test GooglePrivacyDlpV2TaggedField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2TaggedField`
        """
        model = GooglePrivacyDlpV2TaggedField()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2TaggedField(self):
        """Test GooglePrivacyDlpV2TaggedField"""
