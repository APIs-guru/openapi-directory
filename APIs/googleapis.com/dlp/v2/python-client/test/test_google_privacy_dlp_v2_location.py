...
class TestGooglePrivacyDlpV2Location(unittest.TestCase):
    """GooglePrivacyDlpV2Location unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2Location:
        """Test GooglePrivacyDlpV2Location
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2Location`
        """
        model = GooglePrivacyDlpV2Location()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2Location(self):
        """Test GooglePrivacyDlpV2Location"""
