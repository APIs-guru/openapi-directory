...
class TestGooglePrivacyDlpV2InspectJobConfig(unittest.TestCase):
    """GooglePrivacyDlpV2InspectJobConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectJobConfig:
        """Test GooglePrivacyDlpV2InspectJobConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectJobConfig`
        """
        model = GooglePrivacyDlpV2InspectJobConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectJobConfig(self):
        """Test GooglePrivacyDlpV2InspectJobConfig"""
