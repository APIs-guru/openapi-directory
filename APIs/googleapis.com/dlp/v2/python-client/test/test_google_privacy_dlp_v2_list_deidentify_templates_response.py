...
class TestGooglePrivacyDlpV2ListDeidentifyTemplatesResponse(unittest.TestCase):
    """GooglePrivacyDlpV2ListDeidentifyTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2ListDeidentifyTemplatesResponse:
        """Test GooglePrivacyDlpV2ListDeidentifyTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2ListDeidentifyTemplatesResponse`
        """
        model = GooglePrivacyDlpV2ListDeidentifyTemplatesResponse()
        if include_optional:
            return GooglePrivacyDlpV2ListDeidentifyTemplatesResponse(
                deidentify_templates = [
                    openapi_client.models.google_privacy_dlp_v2_deidentify_template.GooglePrivacyDlpV2DeidentifyTemplate(
                        create_time = '', 
    ...
    def testGooglePrivacyDlpV2ListDeidentifyTemplatesResponse(self):
        """Test GooglePrivacyDlpV2ListDeidentifyTemplatesResponse"""
