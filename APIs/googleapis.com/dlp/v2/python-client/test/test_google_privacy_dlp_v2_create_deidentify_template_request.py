...
class TestGooglePrivacyDlpV2CreateDeidentifyTemplateRequest(unittest.TestCase):
    """GooglePrivacyDlpV2CreateDeidentifyTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CreateDeidentifyTemplateRequest:
        """Test GooglePrivacyDlpV2CreateDeidentifyTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CreateDeidentifyTemplateRequest`
        """
        model = GooglePrivacyDlpV2CreateDeidentifyTemplateRequest()
        if include_optional:
            return GooglePrivacyDlpV2CreateDeidentifyTemplateRequest(
                deidentify_template = openapi_client.models.google_privacy_dlp_v2_deidentify_template.GooglePrivacyDlpV2DeidentifyTemplate(
                    create_time = '', 
    ...
    def testGooglePrivacyDlpV2CreateDeidentifyTemplateRequest(self):
        """Test GooglePrivacyDlpV2CreateDeidentifyTemplateRequest"""
