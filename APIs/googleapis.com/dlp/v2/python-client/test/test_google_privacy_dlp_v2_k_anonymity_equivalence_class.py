...
class TestGooglePrivacyDlpV2KAnonymityEquivalenceClass(unittest.TestCase):
    """GooglePrivacyDlpV2KAnonymityEquivalenceClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2KAnonymityEquivalenceClass:
        """Test GooglePrivacyDlpV2KAnonymityEquivalenceClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2KAnonymityEquivalenceClass`
        """
        model = GooglePrivacyDlpV2KAnonymityEquivalenceClass()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2KAnonymityEquivalenceClass(self):
        """Test GooglePrivacyDlpV2KAnonymityEquivalenceClass"""
