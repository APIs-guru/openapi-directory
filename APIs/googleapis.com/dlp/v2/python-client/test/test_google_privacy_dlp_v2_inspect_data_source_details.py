...
class TestGooglePrivacyDlpV2InspectDataSourceDetails(unittest.TestCase):
    """GooglePrivacyDlpV2InspectDataSourceDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectDataSourceDetails:
        """Test GooglePrivacyDlpV2InspectDataSourceDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectDataSourceDetails`
        """
        model = GooglePrivacyDlpV2InspectDataSourceDetails()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectDataSourceDetails(self):
        """Test GooglePrivacyDlpV2InspectDataSourceDetails"""
