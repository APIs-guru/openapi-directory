...
class TestGooglePrivacyDlpV2DataProfileConfigSnapshot(unittest.TestCase):
    """GooglePrivacyDlpV2DataProfileConfigSnapshot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DataProfileConfigSnapshot:
        """Test GooglePrivacyDlpV2DataProfileConfigSnapshot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DataProfileConfigSnapshot`
        """
        model = GooglePrivacyDlpV2DataProfileConfigSnapshot()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DataProfileConfigSnapshot(self):
        """Test GooglePrivacyDlpV2DataProfileConfigSnapshot"""
