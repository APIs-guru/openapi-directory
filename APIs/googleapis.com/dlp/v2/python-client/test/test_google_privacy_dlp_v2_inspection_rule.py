...
class TestGooglePrivacyDlpV2InspectionRule(unittest.TestCase):
    """GooglePrivacyDlpV2InspectionRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectionRule:
        """Test GooglePrivacyDlpV2InspectionRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectionRule`
        """
        model = GooglePrivacyDlpV2InspectionRule()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectionRule(self):
        """Test GooglePrivacyDlpV2InspectionRule"""
