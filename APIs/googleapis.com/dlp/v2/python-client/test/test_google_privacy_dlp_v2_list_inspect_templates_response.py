...
class TestGooglePrivacyDlpV2ListInspectTemplatesResponse(unittest.TestCase):
    """GooglePrivacyDlpV2ListInspectTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2ListInspectTemplatesResponse:
        """Test GooglePrivacyDlpV2ListInspectTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2ListInspectTemplatesResponse`
        """
        model = GooglePrivacyDlpV2ListInspectTemplatesResponse()
        if include_optional:
            return GooglePrivacyDlpV2ListInspectTemplatesResponse(
                inspect_templates = [
                    openapi_client.models.google_privacy_dlp_v2_inspect_template.GooglePrivacyDlpV2InspectTemplate(
                        create_time = '', 
                        description = '', 
                        display_name = '', 
    ...
    def testGooglePrivacyDlpV2ListInspectTemplatesResponse(self):
        """Test GooglePrivacyDlpV2ListInspectTemplatesResponse"""
