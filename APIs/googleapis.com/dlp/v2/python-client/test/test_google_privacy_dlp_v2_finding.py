...
class TestGooglePrivacyDlpV2Finding(unittest.TestCase):
    """GooglePrivacyDlpV2Finding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2Finding:
        """Test GooglePrivacyDlpV2Finding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2Finding`
        """
        model = GooglePrivacyDlpV2Finding()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2Finding(self):
        """Test GooglePrivacyDlpV2Finding"""
