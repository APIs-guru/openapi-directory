...
class TestGooglePrivacyDlpV2DeidentifyContentResponse(unittest.TestCase):
    """GooglePrivacyDlpV2DeidentifyContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DeidentifyContentResponse:
        """Test GooglePrivacyDlpV2DeidentifyContentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DeidentifyContentResponse`
        """
        model = GooglePrivacyDlpV2DeidentifyContentResponse()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DeidentifyContentResponse(self):
        """Test GooglePrivacyDlpV2DeidentifyContentResponse"""
