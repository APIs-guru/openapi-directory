...
class TestGooglePrivacyDlpV2CreateDiscoveryConfigRequest(unittest.TestCase):
    """GooglePrivacyDlpV2CreateDiscoveryConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CreateDiscoveryConfigRequest:
        """Test GooglePrivacyDlpV2CreateDiscoveryConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CreateDiscoveryConfigRequest`
        """
        model = GooglePrivacyDlpV2CreateDiscoveryConfigRequest()
        if include_optional:
            return GooglePrivacyDlpV2CreateDiscoveryConfigRequest(
                config_id = '',
    ...
    def testGooglePrivacyDlpV2CreateDiscoveryConfigRequest(self):
        """Test GooglePrivacyDlpV2CreateDiscoveryConfigRequest"""
