...
class TestGooglePrivacyDlpV2ListTableDataProfilesResponse(unittest.TestCase):
    """GooglePrivacyDlpV2ListTableDataProfilesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2ListTableDataProfilesResponse:
        """Test GooglePrivacyDlpV2ListTableDataProfilesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2ListTableDataProfilesResponse`
        """
        model = GooglePrivacyDlpV2ListTableDataProfilesResponse()
        if include_optional:
            return GooglePrivacyDlpV2ListTableDataProfilesResponse(
                next_page_token = '',
                table_data_profiles = [
                    openapi_client.models.google_privacy_dlp_v2_table_data_profile.GooglePrivacyDlpV2TableDataProfile(
    ...
    def testGooglePrivacyDlpV2ListTableDataProfilesResponse(self):
        """Test GooglePrivacyDlpV2ListTableDataProfilesResponse"""
