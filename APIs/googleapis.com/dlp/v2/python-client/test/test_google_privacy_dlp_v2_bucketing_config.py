...
class TestGooglePrivacyDlpV2BucketingConfig(unittest.TestCase):
    """GooglePrivacyDlpV2BucketingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2BucketingConfig:
        """Test GooglePrivacyDlpV2BucketingConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2BucketingConfig`
        """
        model = GooglePrivacyDlpV2BucketingConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2BucketingConfig(self):
        """Test GooglePrivacyDlpV2BucketingConfig"""
