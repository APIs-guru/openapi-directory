...
class TestGooglePrivacyDlpV2InspectContentResponse(unittest.TestCase):
    """GooglePrivacyDlpV2InspectContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectContentResponse:
        """Test GooglePrivacyDlpV2InspectContentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectContentResponse`
        """
        model = GooglePrivacyDlpV2InspectContentResponse()
        if include_optional:
            return GooglePrivacyDlpV2InspectContentResponse(
                result = openapi_client.models.google_privacy_dlp_v2_inspect_result.GooglePrivacyDlpV2InspectResult(
                    findings = [
    ...
    def testGooglePrivacyDlpV2InspectContentResponse(self):
        """Test GooglePrivacyDlpV2InspectContentResponse"""
