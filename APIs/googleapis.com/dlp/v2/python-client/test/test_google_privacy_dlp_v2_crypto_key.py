...
class TestGooglePrivacyDlpV2CryptoKey(unittest.TestCase):
    """GooglePrivacyDlpV2CryptoKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CryptoKey:
        """Test GooglePrivacyDlpV2CryptoKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CryptoKey`
        """
        model = GooglePrivacyDlpV2CryptoKey()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2CryptoKey(self):
        """Test GooglePrivacyDlpV2CryptoKey"""
