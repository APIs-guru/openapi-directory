...
class TestGooglePrivacyDlpV2InfoTypeTransformation(unittest.TestCase):
    """GooglePrivacyDlpV2InfoTypeTransformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InfoTypeTransformation:
        """Test GooglePrivacyDlpV2InfoTypeTransformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InfoTypeTransformation`
        """
        model = GooglePrivacyDlpV2InfoTypeTransformation()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InfoTypeTransformation(self):
        """Test GooglePrivacyDlpV2InfoTypeTransformation"""
