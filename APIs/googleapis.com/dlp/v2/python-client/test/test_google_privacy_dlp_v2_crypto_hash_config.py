...
class TestGooglePrivacyDlpV2CryptoHashConfig(unittest.TestCase):
    """GooglePrivacyDlpV2CryptoHashConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CryptoHashConfig:
        """Test GooglePrivacyDlpV2CryptoHashConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CryptoHashConfig`
        """
        model = GooglePrivacyDlpV2CryptoHashConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2CryptoHashConfig(self):
        """Test GooglePrivacyDlpV2CryptoHashConfig"""
