...
class TestGooglePrivacyDlpV2CreateInspectTemplateRequest(unittest.TestCase):
    """GooglePrivacyDlpV2CreateInspectTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CreateInspectTemplateRequest:
        """Test GooglePrivacyDlpV2CreateInspectTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CreateInspectTemplateRequest`
        """
        model = GooglePrivacyDlpV2CreateInspectTemplateRequest()
        if include_optional:
            return GooglePrivacyDlpV2CreateInspectTemplateRequest(
    ...
    def testGooglePrivacyDlpV2CreateInspectTemplateRequest(self):
        """Test GooglePrivacyDlpV2CreateInspectTemplateRequest"""
