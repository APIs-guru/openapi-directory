...
class TestGooglePrivacyDlpV2PrimitiveTransformation(unittest.TestCase):
    """GooglePrivacyDlpV2PrimitiveTransformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2PrimitiveTransformation:
        """Test GooglePrivacyDlpV2PrimitiveTransformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2PrimitiveTransformation`
        """
        model = GooglePrivacyDlpV2PrimitiveTransformation()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2PrimitiveTransformation(self):
        """Test GooglePrivacyDlpV2PrimitiveTransformation"""
