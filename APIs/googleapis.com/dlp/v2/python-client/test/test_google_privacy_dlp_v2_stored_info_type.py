...
class TestGooglePrivacyDlpV2StoredInfoType(unittest.TestCase):
    """GooglePrivacyDlpV2StoredInfoType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2StoredInfoType:
        """Test GooglePrivacyDlpV2StoredInfoType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2StoredInfoType`
        """
        model = GooglePrivacyDlpV2StoredInfoType()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2StoredInfoType(self):
        """Test GooglePrivacyDlpV2StoredInfoType"""
