...
class TestGooglePrivacyDlpV2Row(unittest.TestCase):
    """GooglePrivacyDlpV2Row unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2Row:
        """Test GooglePrivacyDlpV2Row
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2Row`
        """
        model = GooglePrivacyDlpV2Row()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2Row(self):
        """Test GooglePrivacyDlpV2Row"""
