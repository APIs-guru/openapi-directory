...
class TestGooglePrivacyDlpV2RecordTransformations(unittest.TestCase):
    """GooglePrivacyDlpV2RecordTransformations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2RecordTransformations:
        """Test GooglePrivacyDlpV2RecordTransformations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2RecordTransformations`
        """
        model = GooglePrivacyDlpV2RecordTransformations()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2RecordTransformations(self):
        """Test GooglePrivacyDlpV2RecordTransformations"""
