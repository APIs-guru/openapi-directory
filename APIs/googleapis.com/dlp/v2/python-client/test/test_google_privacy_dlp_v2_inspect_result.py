...
class TestGooglePrivacyDlpV2InspectResult(unittest.TestCase):
    """GooglePrivacyDlpV2InspectResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectResult:
        """Test GooglePrivacyDlpV2InspectResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectResult`
        """
        model = GooglePrivacyDlpV2InspectResult()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectResult(self):
        """Test GooglePrivacyDlpV2InspectResult"""
