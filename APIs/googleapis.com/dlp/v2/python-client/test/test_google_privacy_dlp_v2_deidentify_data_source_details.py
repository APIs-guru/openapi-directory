...
class TestGooglePrivacyDlpV2DeidentifyDataSourceDetails(unittest.TestCase):
    """GooglePrivacyDlpV2DeidentifyDataSourceDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DeidentifyDataSourceDetails:
        """Test GooglePrivacyDlpV2DeidentifyDataSourceDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DeidentifyDataSourceDetails`
        """
        model = GooglePrivacyDlpV2DeidentifyDataSourceDetails()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DeidentifyDataSourceDetails(self):
        """Test GooglePrivacyDlpV2DeidentifyDataSourceDetails"""
