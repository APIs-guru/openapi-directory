...
class TestGooglePrivacyDlpV2DataProfilePubSubMessage(unittest.TestCase):
    """GooglePrivacyDlpV2DataProfilePubSubMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DataProfilePubSubMessage:
        """Test GooglePrivacyDlpV2DataProfilePubSubMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DataProfilePubSubMessage`
        """
        model = GooglePrivacyDlpV2DataProfilePubSubMessage()
        if include_optional:
            return GooglePrivacyDlpV2DataProfilePubSubMessage(
                event = 'EVENT_TYPE_UNSPECIFIED',
                profile = openapi_client.models.google_privacy_dlp_v2_table_data_profile.GooglePrivacyDlpV2TableDataProfile(
    ...
    def testGooglePrivacyDlpV2DataProfilePubSubMessage(self):
        """Test GooglePrivacyDlpV2DataProfilePubSubMessage"""
