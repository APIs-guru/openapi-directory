...
class TestGooglePrivacyDlpV2InfoTypeSummary(unittest.TestCase):
    """GooglePrivacyDlpV2InfoTypeSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InfoTypeSummary:
        """Test GooglePrivacyDlpV2InfoTypeSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InfoTypeSummary`
        """
        model = GooglePrivacyDlpV2InfoTypeSummary()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InfoTypeSummary(self):
        """Test GooglePrivacyDlpV2InfoTypeSummary"""
