...
class TestGooglePrivacyDlpV2DataProfileBigQueryRowSchema(unittest.TestCase):
    """GooglePrivacyDlpV2DataProfileBigQueryRowSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DataProfileBigQueryRowSchema:
        """Test GooglePrivacyDlpV2DataProfileBigQueryRowSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DataProfileBigQueryRowSchema`
        """
        model = GooglePrivacyDlpV2DataProfileBigQueryRowSchema()
        if include_optional:
            return GooglePrivacyDlpV2DataProfileBigQueryRowSchema(
                column_profile = openapi_client.models.google_privacy_dlp_v2_column_data_profile.GooglePrivacyDlpV2ColumnDataProfile(
                    column = '', 
                    ...
                    table_full_resource = '', 
                    table_id = '', ),
                table_profile = openapi_client.models.google_privacy_dlp_v2_table_data_profile.GooglePrivacyDlpV2TableDataProfile(
    ...
    def testGooglePrivacyDlpV2DataProfileBigQueryRowSchema(self):
        """Test GooglePrivacyDlpV2DataProfileBigQueryRowSchema"""
