...
class TestGooglePrivacyDlpV2DeidentifyConfig(unittest.TestCase):
    """GooglePrivacyDlpV2DeidentifyConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DeidentifyConfig:
        """Test GooglePrivacyDlpV2DeidentifyConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DeidentifyConfig`
        """
        model = GooglePrivacyDlpV2DeidentifyConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DeidentifyConfig(self):
        """Test GooglePrivacyDlpV2DeidentifyConfig"""
