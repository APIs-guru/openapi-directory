...
class TestGooglePrivacyDlpV2PubSubNotification(unittest.TestCase):
    """GooglePrivacyDlpV2PubSubNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2PubSubNotification:
        """Test GooglePrivacyDlpV2PubSubNotification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2PubSubNotification`
        """
        model = GooglePrivacyDlpV2PubSubNotification()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2PubSubNotification(self):
        """Test GooglePrivacyDlpV2PubSubNotification"""
