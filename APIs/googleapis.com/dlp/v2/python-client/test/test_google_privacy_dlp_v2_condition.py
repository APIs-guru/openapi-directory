...
class TestGooglePrivacyDlpV2Condition(unittest.TestCase):
    """GooglePrivacyDlpV2Condition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2Condition:
        """Test GooglePrivacyDlpV2Condition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2Condition`
        """
        model = GooglePrivacyDlpV2Condition()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2Condition(self):
        """Test GooglePrivacyDlpV2Condition"""
