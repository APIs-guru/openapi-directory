...
class TestGooglePrivacyDlpV2RequestedDeidentifyOptions(unittest.TestCase):
    """GooglePrivacyDlpV2RequestedDeidentifyOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2RequestedDeidentifyOptions:
        """Test GooglePrivacyDlpV2RequestedDeidentifyOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2RequestedDeidentifyOptions`
        """
        model = GooglePrivacyDlpV2RequestedDeidentifyOptions()
        if include_optional:
            return GooglePrivacyDlpV2RequestedDeidentifyOptions(
                ...
                snapshot_image_redact_template = openapi_client.models.google_privacy_dlp_v2_deidentify_template.GooglePrivacyDlpV2DeidentifyTemplate(
                    ...
                    name = '', 
                    update_time = '', ),
                snapshot_structured_deidentify_template = openapi_client.models.google_privacy_dlp_v2_deidentify_template.GooglePrivacyDlpV2DeidentifyTemplate(
                    create_time = '', 
                    deidentify_config = openapi_client.models.google_privacy_dlp_v2_deidentify_config.GooglePrivacyDlpV2DeidentifyConfig(
                        image_transformations = openapi_client.models.google_privacy_dlp_v2_image_transformations.GooglePrivacyDlpV2ImageTransformations(
                            transforms = [
    ...
    def testGooglePrivacyDlpV2RequestedDeidentifyOptions(self):
        """Test GooglePrivacyDlpV2RequestedDeidentifyOptions"""
