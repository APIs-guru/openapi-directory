...
class TestGooglePrivacyDlpV2TransformationOverview(unittest.TestCase):
    """GooglePrivacyDlpV2TransformationOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2TransformationOverview:
        """Test GooglePrivacyDlpV2TransformationOverview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2TransformationOverview`
        """
        model = GooglePrivacyDlpV2TransformationOverview()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2TransformationOverview(self):
        """Test GooglePrivacyDlpV2TransformationOverview"""
