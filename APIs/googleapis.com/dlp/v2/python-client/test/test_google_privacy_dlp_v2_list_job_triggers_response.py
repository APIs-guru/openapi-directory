...
class TestGooglePrivacyDlpV2ListJobTriggersResponse(unittest.TestCase):
    """GooglePrivacyDlpV2ListJobTriggersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2ListJobTriggersResponse:
        """Test GooglePrivacyDlpV2ListJobTriggersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2ListJobTriggersResponse`
        """
        model = GooglePrivacyDlpV2ListJobTriggersResponse()
        if include_optional:
            return GooglePrivacyDlpV2ListJobTriggersResponse(
                job_triggers = [
                    openapi_client.models.google_privacy_dlp_v2_job_trigger.GooglePrivacyDlpV2JobTrigger(
                        create_time = '', 
                        description = '', 
                        display_name = '', 
                        errors = [
    ...
    def testGooglePrivacyDlpV2ListJobTriggersResponse(self):
        """Test GooglePrivacyDlpV2ListJobTriggersResponse"""
