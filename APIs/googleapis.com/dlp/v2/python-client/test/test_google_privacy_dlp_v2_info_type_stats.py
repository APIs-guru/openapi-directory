...
class TestGooglePrivacyDlpV2InfoTypeStats(unittest.TestCase):
    """GooglePrivacyDlpV2InfoTypeStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InfoTypeStats:
        """Test GooglePrivacyDlpV2InfoTypeStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InfoTypeStats`
        """
        model = GooglePrivacyDlpV2InfoTypeStats()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InfoTypeStats(self):
        """Test GooglePrivacyDlpV2InfoTypeStats"""
