...
class TestGooglePrivacyDlpV2DeidentifyTemplate(unittest.TestCase):
    """GooglePrivacyDlpV2DeidentifyTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DeidentifyTemplate:
        """Test GooglePrivacyDlpV2DeidentifyTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DeidentifyTemplate`
        """
        model = GooglePrivacyDlpV2DeidentifyTemplate()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DeidentifyTemplate(self):
        """Test GooglePrivacyDlpV2DeidentifyTemplate"""
