...
class TestGooglePrivacyDlpV2DiscoveryConfig(unittest.TestCase):
    """GooglePrivacyDlpV2DiscoveryConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2DiscoveryConfig:
        """Test GooglePrivacyDlpV2DiscoveryConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2DiscoveryConfig`
        """
        model = GooglePrivacyDlpV2DiscoveryConfig()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2DiscoveryConfig(self):
        """Test GooglePrivacyDlpV2DiscoveryConfig"""
