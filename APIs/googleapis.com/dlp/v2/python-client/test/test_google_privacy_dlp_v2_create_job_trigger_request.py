...
class TestGooglePrivacyDlpV2CreateJobTriggerRequest(unittest.TestCase):
    """GooglePrivacyDlpV2CreateJobTriggerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2CreateJobTriggerRequest:
        """Test GooglePrivacyDlpV2CreateJobTriggerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2CreateJobTriggerRequest`
        """
        model = GooglePrivacyDlpV2CreateJobTriggerRequest()
        if include_optional:
            return GooglePrivacyDlpV2CreateJobTriggerRequest(
                job_trigger = openapi_client.models.google_privacy_dlp_v2_job_trigger.GooglePrivacyDlpV2JobTrigger(
                    create_time = '', 
                    description = '', 
                    display_name = '', 
                    errors = [
                    ...
                    triggers = [
                        openapi_client.models.google_privacy_dlp_v2_trigger.GooglePrivacyDlpV2Trigger(
                            manual = openapi_client.models.google_privacy_dlp_v2_manual.GooglePrivacyDlpV2Manual(), 
                            schedule = openapi_client.models.google_privacy_dlp_v2_schedule.GooglePrivacyDlpV2Schedule(
    ...
    def testGooglePrivacyDlpV2CreateJobTriggerRequest(self):
        """Test GooglePrivacyDlpV2CreateJobTriggerRequest"""
