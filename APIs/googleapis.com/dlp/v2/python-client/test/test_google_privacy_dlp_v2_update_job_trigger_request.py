...
class TestGooglePrivacyDlpV2UpdateJobTriggerRequest(unittest.TestCase):
    """GooglePrivacyDlpV2UpdateJobTriggerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2UpdateJobTriggerRequest:
        """Test GooglePrivacyDlpV2UpdateJobTriggerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2UpdateJobTriggerRequest`
        """
        model = GooglePrivacyDlpV2UpdateJobTriggerRequest()
        if include_optional:
            return GooglePrivacyDlpV2UpdateJobTriggerRequest(
    ...
    def testGooglePrivacyDlpV2UpdateJobTriggerRequest(self):
        """Test GooglePrivacyDlpV2UpdateJobTriggerRequest"""
