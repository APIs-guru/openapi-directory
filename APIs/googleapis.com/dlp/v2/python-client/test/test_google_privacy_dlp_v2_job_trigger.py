...
class TestGooglePrivacyDlpV2JobTrigger(unittest.TestCase):
    """GooglePrivacyDlpV2JobTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2JobTrigger:
        """Test GooglePrivacyDlpV2JobTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2JobTrigger`
        """
        model = GooglePrivacyDlpV2JobTrigger()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2JobTrigger(self):
        """Test GooglePrivacyDlpV2JobTrigger"""
