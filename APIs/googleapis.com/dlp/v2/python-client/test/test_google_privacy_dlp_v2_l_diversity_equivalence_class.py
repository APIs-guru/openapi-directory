...
class TestGooglePrivacyDlpV2LDiversityEquivalenceClass(unittest.TestCase):
    """GooglePrivacyDlpV2LDiversityEquivalenceClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2LDiversityEquivalenceClass:
        """Test GooglePrivacyDlpV2LDiversityEquivalenceClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2LDiversityEquivalenceClass`
        """
        model = GooglePrivacyDlpV2LDiversityEquivalenceClass()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2LDiversityEquivalenceClass(self):
        """Test GooglePrivacyDlpV2LDiversityEquivalenceClass"""
