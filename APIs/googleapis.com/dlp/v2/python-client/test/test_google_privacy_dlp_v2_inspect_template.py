...
class TestGooglePrivacyDlpV2InspectTemplate(unittest.TestCase):
    """GooglePrivacyDlpV2InspectTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InspectTemplate:
        """Test GooglePrivacyDlpV2InspectTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InspectTemplate`
        """
        model = GooglePrivacyDlpV2InspectTemplate()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InspectTemplate(self):
        """Test GooglePrivacyDlpV2InspectTemplate"""
