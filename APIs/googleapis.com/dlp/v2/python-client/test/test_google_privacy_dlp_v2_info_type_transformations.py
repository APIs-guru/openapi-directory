...
class TestGooglePrivacyDlpV2InfoTypeTransformations(unittest.TestCase):
    """GooglePrivacyDlpV2InfoTypeTransformations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2InfoTypeTransformations:
        """Test GooglePrivacyDlpV2InfoTypeTransformations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2InfoTypeTransformations`
        """
        model = GooglePrivacyDlpV2InfoTypeTransformations()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2InfoTypeTransformations(self):
        """Test GooglePrivacyDlpV2InfoTypeTransformations"""
