...
class TestGooglePrivacyDlpV2UpdateDeidentifyTemplateRequest(unittest.TestCase):
    """GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest:
        """Test GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest`
        """
        model = GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest()
        if include_optional:
            return GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest(
    ...
    def testGooglePrivacyDlpV2UpdateDeidentifyTemplateRequest(self):
        """Test GooglePrivacyDlpV2UpdateDeidentifyTemplateRequest"""
