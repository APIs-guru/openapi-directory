...
class TestGooglePrivacyDlpV2NumericalStatsResult(unittest.TestCase):
    """GooglePrivacyDlpV2NumericalStatsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2NumericalStatsResult:
        """Test GooglePrivacyDlpV2NumericalStatsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2NumericalStatsResult`
        """
        model = GooglePrivacyDlpV2NumericalStatsResult()
        if include_optional:
    ...
    def testGooglePrivacyDlpV2NumericalStatsResult(self):
        """Test GooglePrivacyDlpV2NumericalStatsResult"""
