...
class TestGooglePrivacyDlpV2Bucket(unittest.TestCase):
    """GooglePrivacyDlpV2Bucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePrivacyDlpV2Bucket:
        """Test GooglePrivacyDlpV2Bucket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePrivacyDlpV2Bucket`
        """
        model = GooglePrivacyDlpV2Bucket()
        if include_optional:
            return GooglePrivacyDlpV2Bucket(
                ...
                min = openapi_client.models.google_privacy_dlp_v2_value.GooglePrivacyDlpV2Value(
                    ...
                    time_value = openapi_client.models.google_type_time_of_day.GoogleTypeTimeOfDay(
                        ...
                        seconds = 56, ), 
                    timestamp_value = '', ),
                replacement_value = openapi_client.models.google_privacy_dlp_v2_value.GooglePrivacyDlpV2Value(
                    boolean_value = True, 
                    date_value = openapi_client.models.google_type_date.GoogleTypeDate(
                        day = 56, 
                        month = 56, 
    ...
    def testGooglePrivacyDlpV2Bucket(self):
        """Test GooglePrivacyDlpV2Bucket"""
