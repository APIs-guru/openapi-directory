...
google_privacy_dlp_v2_quasi_id_instance = GooglePrivacyDlpV2QuasiId.from_json(json)
# print the JSON string representation of the object
print(GooglePrivacyDlpV2QuasiId.to_json())

# convert the object into a dict
google_privacy_dlp_v2_quasi_id_dict = google_privacy_dlp_v2_quasi_id_instance.to_dict()
# create an instance of GooglePrivacyDlpV2QuasiId from a dict
google_privacy_dlp_v2_quasi_id_from_dict = GooglePrivacyDlpV2QuasiId.from_dict(google_privacy_dlp_v2_quasi_id_dict)
```
