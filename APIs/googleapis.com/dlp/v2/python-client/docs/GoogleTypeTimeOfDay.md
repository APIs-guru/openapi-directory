...
google_type_time_of_day_instance = GoogleTypeTimeOfDay.from_json(json)
# print the JSON string representation of the object
print(GoogleTypeTimeOfDay.to_json())

# convert the object into a dict
google_type_time_of_day_dict = google_type_time_of_day_instance.to_dict()
# create an instance of GoogleTypeTimeOfDay from a dict
google_type_time_of_day_from_dict = GoogleTypeTimeOfDay.from_dict(google_type_time_of_day_dict)
```
