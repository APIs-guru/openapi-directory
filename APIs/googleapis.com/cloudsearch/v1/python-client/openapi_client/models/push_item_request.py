...
class PushItemRequest(BaseModel):
    ...
    item: Optional[PushItem] = None
    __properties: ClassVar[List[str]] = ["connectorName", "debugOptions", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": PushItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
