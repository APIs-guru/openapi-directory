...
class CustomerSessionStats(BaseModel):
    ...
    search_sessions_count: Optional[StrictStr] = Field(default=None, description="The count of search sessions on the day", alias="searchSessionsCount")
    __properties: ClassVar[List[str]] = ["date", "searchSessionsCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchSessionsCount": obj.get("searchSessionsCount")
        })
        return _obj
