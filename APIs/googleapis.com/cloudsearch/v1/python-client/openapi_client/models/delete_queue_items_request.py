...
class DeleteQueueItemsRequest(BaseModel):
    ...
    queue: Optional[StrictStr] = Field(default=None, description="The name of a queue to delete items from.")
    __properties: ClassVar[List[str]] = ["connectorName", "debugOptions", "queue"]
