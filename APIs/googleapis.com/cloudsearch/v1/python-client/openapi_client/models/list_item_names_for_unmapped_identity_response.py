...
class ListItemNamesForUnmappedIdentityResponse(BaseModel):
    ...
    """ # noqa: E501
    item_names: Optional[List[StrictStr]] = Field(default=None, alias="itemNames")
    ...
    __properties: ClassVar[List[str]] = ["itemNames", "nextPageToken"]
