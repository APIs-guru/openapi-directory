...
class PeoplePromotionCard(BaseModel):
    """
    PeoplePromotionCard
    """ # noqa: E501
    people: Optional[List[PersonCore]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "people": [PersonCore.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None
        })
        return _obj
