...
class ObjectValues(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [StructuredDataObject.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj

from openapi_client.models.structured_data_object import StructuredDataObject
# TODO: Rewrite to not use raise_errors
ObjectValues.model_rebuild(raise_errors=False)
