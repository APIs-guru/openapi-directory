...
class Value(BaseModel):
    ...
    date_value: Optional[ModelDate] = Field(default=None, alias="dateValue")
    double_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="doubleValue")
    integer_value: Optional[StrictStr] = Field(default=None, alias="integerValue")
    string_value: Optional[StrictStr] = Field(default=None, alias="stringValue")
    timestamp_value: Optional[StrictStr] = Field(default=None, alias="timestampValue")
    __properties: ClassVar[List[str]] = ["booleanValue", "dateValue", "doubleValue", "integerValue", "stringValue", "timestampValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dateValue": ModelDate.from_dict(obj["dateValue"]) if obj.get("dateValue") is not None else None,
