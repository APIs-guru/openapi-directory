...
class EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents(BaseModel):
    """
    A list of events where all guests declined.
    """ # noqa: E501
    events: Optional[List[EnterpriseTopazSidekickAgendaEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [EnterpriseTopazSidekickAgendaEntry.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
