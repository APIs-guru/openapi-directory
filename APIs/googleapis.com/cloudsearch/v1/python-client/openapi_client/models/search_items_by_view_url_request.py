...
class SearchItemsByViewUrlRequest(BaseModel):
    ...
    page_token: Optional[StrictStr] = Field(default=None, description="The next_page_token value returned from a previous request, if any.", alias="pageToken")
    view_url: Optional[StrictStr] = Field(default=None, description="Specify the full view URL to find the corresponding item. The maximum length is 2048 characters.", alias="viewUrl")
    __properties: ClassVar[List[str]] = ["debugOptions", "pageToken", "viewUrl"]
