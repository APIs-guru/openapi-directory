...
class BooleanPropertyOptions(BaseModel):
    ...
    """ # noqa: E501
    operator_options: Optional[BooleanOperatorOptions] = Field(default=None, alias="operatorOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operatorOptions": BooleanOperatorOptions.from_dict(obj["operatorOptions"]) if obj.get("operatorOptions") is not None else None
        })
        return _obj
