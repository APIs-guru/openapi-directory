...
class EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader(BaseModel):
    """
    Recommended header to display for the card.
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="The suggested title to display. This defaults to the user's query.")
