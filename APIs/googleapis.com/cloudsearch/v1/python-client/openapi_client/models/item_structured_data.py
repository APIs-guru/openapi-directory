...
class ItemStructuredData(BaseModel):
    ...
    object: Optional[StructuredDataObject] = None
    __properties: ClassVar[List[str]] = ["hash", "object"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hash": obj.get("hash"),
            "object": StructuredDataObject.from_dict(obj["object"]) if obj.get("object") is not None else None
        })
        return _obj
