...
class EnterpriseTopazFrontendTeamsLink(BaseModel):
    """
    EnterpriseTopazFrontendTeamsLink
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The identifying link type")
    url: Optional[SafeUrlProto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "url": SafeUrlProto.from_dict(obj["url"]) if obj.get("url") is not None else None
        })
        return _obj
