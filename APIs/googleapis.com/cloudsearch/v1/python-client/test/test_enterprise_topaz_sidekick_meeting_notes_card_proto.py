...
class TestEnterpriseTopazSidekickMeetingNotesCardProto(unittest.TestCase):
    """EnterpriseTopazSidekickMeetingNotesCardProto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickMeetingNotesCardProto:
        """Test EnterpriseTopazSidekickMeetingNotesCardProto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickMeetingNotesCardProto`
        """
        model = EnterpriseTopazSidekickMeetingNotesCardProto()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickMeetingNotesCardProto(self):
        """Test EnterpriseTopazSidekickMeetingNotesCardProto"""
