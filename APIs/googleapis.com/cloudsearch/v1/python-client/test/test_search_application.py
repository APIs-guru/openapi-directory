...
class TestSearchApplication(unittest.TestCase):
    """SearchApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchApplication:
        """Test SearchApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchApplication`
        """
        model = SearchApplication()
        if include_optional:
