...
class TestEnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry(unittest.TestCase):
    """EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry:
        """Test EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry`
        """
        model = EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry(self):
        """Test EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry"""
