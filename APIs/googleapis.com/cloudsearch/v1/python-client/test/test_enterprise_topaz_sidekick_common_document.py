...
class TestEnterpriseTopazSidekickCommonDocument(unittest.TestCase):
    """EnterpriseTopazSidekickCommonDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickCommonDocument:
        """Test EnterpriseTopazSidekickCommonDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickCommonDocument`
        """
        model = EnterpriseTopazSidekickCommonDocument()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickCommonDocument(self):
        """Test EnterpriseTopazSidekickCommonDocument"""
