...
class TestEnterpriseTopazSidekickDocumentPerCategoryList(unittest.TestCase):
    """EnterpriseTopazSidekickDocumentPerCategoryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickDocumentPerCategoryList:
        """Test EnterpriseTopazSidekickDocumentPerCategoryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickDocumentPerCategoryList`
        """
        model = EnterpriseTopazSidekickDocumentPerCategoryList()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickDocumentPerCategoryList(self):
        """Test EnterpriseTopazSidekickDocumentPerCategoryList"""
