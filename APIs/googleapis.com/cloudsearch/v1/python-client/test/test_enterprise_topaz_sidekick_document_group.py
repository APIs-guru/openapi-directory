...
class TestEnterpriseTopazSidekickDocumentGroup(unittest.TestCase):
    """EnterpriseTopazSidekickDocumentGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickDocumentGroup:
        """Test EnterpriseTopazSidekickDocumentGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickDocumentGroup`
        """
        model = EnterpriseTopazSidekickDocumentGroup()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickDocumentGroup(self):
        """Test EnterpriseTopazSidekickDocumentGroup"""
