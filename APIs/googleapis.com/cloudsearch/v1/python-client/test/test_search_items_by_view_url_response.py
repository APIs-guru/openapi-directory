...
class TestSearchItemsByViewUrlResponse(unittest.TestCase):
    """SearchItemsByViewUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchItemsByViewUrlResponse:
        """Test SearchItemsByViewUrlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchItemsByViewUrlResponse`
        """
        model = SearchItemsByViewUrlResponse()
        if include_optional:
    ...
    def testSearchItemsByViewUrlResponse(self):
        """Test SearchItemsByViewUrlResponse"""
