...
class TestEnterpriseTopazSidekickPersonalizedDocsCardProto(unittest.TestCase):
    """EnterpriseTopazSidekickPersonalizedDocsCardProto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickPersonalizedDocsCardProto:
        """Test EnterpriseTopazSidekickPersonalizedDocsCardProto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickPersonalizedDocsCardProto`
        """
        model = EnterpriseTopazSidekickPersonalizedDocsCardProto()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickPersonalizedDocsCardProto(self):
        """Test EnterpriseTopazSidekickPersonalizedDocsCardProto"""
