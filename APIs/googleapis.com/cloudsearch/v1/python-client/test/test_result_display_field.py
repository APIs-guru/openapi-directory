...
class TestResultDisplayField(unittest.TestCase):
    """ResultDisplayField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultDisplayField:
        """Test ResultDisplayField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultDisplayField`
        """
        model = ResultDisplayField()
        if include_optional:
            return ResultDisplayField(
                label = '',
                operator_name = '',
                var_property = openapi_client.models.named_property.NamedProperty(
                    boolean_value = True, 
    ...
    def testResultDisplayField(self):
        """Test ResultDisplayField"""
