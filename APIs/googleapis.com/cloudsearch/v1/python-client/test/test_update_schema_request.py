...
class TestUpdateSchemaRequest(unittest.TestCase):
    """UpdateSchemaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSchemaRequest:
        """Test UpdateSchemaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSchemaRequest`
        """
    ...
    def testUpdateSchemaRequest(self):
        """Test UpdateSchemaRequest"""
