...
class TestEnterpriseTopazSidekickMeetingNotesCardRequest(unittest.TestCase):
    """EnterpriseTopazSidekickMeetingNotesCardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickMeetingNotesCardRequest:
        """Test EnterpriseTopazSidekickMeetingNotesCardRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickMeetingNotesCardRequest`
        """
        model = EnterpriseTopazSidekickMeetingNotesCardRequest()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickMeetingNotesCardRequest(self):
        """Test EnterpriseTopazSidekickMeetingNotesCardRequest"""
