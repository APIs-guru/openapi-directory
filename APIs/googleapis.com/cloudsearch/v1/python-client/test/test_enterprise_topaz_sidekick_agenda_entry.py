...
class TestEnterpriseTopazSidekickAgendaEntry(unittest.TestCase):
    """EnterpriseTopazSidekickAgendaEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickAgendaEntry:
        """Test EnterpriseTopazSidekickAgendaEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickAgendaEntry`
        """
        model = EnterpriseTopazSidekickAgendaEntry()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickAgendaEntry(self):
        """Test EnterpriseTopazSidekickAgendaEntry"""
