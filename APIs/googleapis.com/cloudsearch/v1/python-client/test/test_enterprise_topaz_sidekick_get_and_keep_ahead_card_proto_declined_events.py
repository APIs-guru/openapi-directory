...
class TestEnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents(unittest.TestCase):
    """EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents:
        """Test EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents`
        """
        model = EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents(self):
        """Test EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents"""
