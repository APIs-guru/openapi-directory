...
class TestResultDisplayLine(unittest.TestCase):
    """ResultDisplayLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultDisplayLine:
        """Test ResultDisplayLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultDisplayLine`
        """
        model = ResultDisplayLine()
        if include_optional:
    ...
    def testResultDisplayLine(self):
        """Test ResultDisplayLine"""
