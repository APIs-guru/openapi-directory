...
class TestIndexItemRequest(unittest.TestCase):
    """IndexItemRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexItemRequest:
        """Test IndexItemRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexItemRequest`
        """
        model = IndexItemRequest()
        if include_optional:
            return IndexItemRequest(
                connector_name = '',
                debug_options = openapi_client.models.debug_options.DebugOptions(
                    enable_debugging = True, ),
                index_item_options = openapi_client.models.index_item_options.IndexItemOptions(
                    allow_unknown_gsuite_principals = True, ),
