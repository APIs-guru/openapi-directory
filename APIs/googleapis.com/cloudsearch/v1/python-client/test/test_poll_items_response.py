...
class TestPollItemsResponse(unittest.TestCase):
    """PollItemsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollItemsResponse:
        """Test PollItemsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollItemsResponse`
        """
        model = PollItemsResponse()
        if include_optional:
    ...
    def testPollItemsResponse(self):
        """Test PollItemsResponse"""
