...
class TestResultCounts(unittest.TestCase):
    """ResultCounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultCounts:
        """Test ResultCounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultCounts`
        """
        model = ResultCounts()
        if include_optional:
            return ResultCounts(
