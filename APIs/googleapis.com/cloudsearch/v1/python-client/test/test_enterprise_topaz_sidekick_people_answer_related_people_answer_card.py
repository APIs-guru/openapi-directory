...
class TestEnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard(unittest.TestCase):
    """EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard:
        """Test EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard`
        """
        model = EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard(self):
        """Test EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard"""
