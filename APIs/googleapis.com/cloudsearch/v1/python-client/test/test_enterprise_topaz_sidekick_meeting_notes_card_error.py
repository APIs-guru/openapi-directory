...
class TestEnterpriseTopazSidekickMeetingNotesCardError(unittest.TestCase):
    """EnterpriseTopazSidekickMeetingNotesCardError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTopazSidekickMeetingNotesCardError:
        """Test EnterpriseTopazSidekickMeetingNotesCardError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTopazSidekickMeetingNotesCardError`
        """
        model = EnterpriseTopazSidekickMeetingNotesCardError()
        if include_optional:
    ...
    def testEnterpriseTopazSidekickMeetingNotesCardError(self):
        """Test EnterpriseTopazSidekickMeetingNotesCardError"""
