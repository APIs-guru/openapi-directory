...
------------- | ------------- | -------------
[**iap_get_iam_policy**](V1beta1Api.md#iap_get_iam_policy) | **POST** /v1beta1/{resource}:getIamPolicy | 
[**iap_set_iam_policy**](V1beta1Api.md#iap_set_iam_policy) | **POST** /v1beta1/{resource}:setIamPolicy | 
[**iap_test_iam_permissions**](V1beta1Api.md#iap_test_iam_permissions) | **POST** /v1beta1/{resource}:testIamPermissions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of V1beta1Api->iap_set_iam_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1beta1Api->iap_set_iam_policy: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of V1beta1Api->iap_test_iam_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling V1beta1Api->iap_test_iam_permissions: %s\n" % e)
```
