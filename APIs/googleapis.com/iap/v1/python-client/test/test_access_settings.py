...
class TestAccessSettings(unittest.TestCase):
    """AccessSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessSettings:
        """Test AccessSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessSettings`
        """
