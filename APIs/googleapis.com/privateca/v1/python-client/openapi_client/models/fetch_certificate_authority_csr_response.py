...
class FetchCertificateAuthorityCsrResponse(BaseModel):
    """
    Response message for CertificateAuthorityService.FetchCertificateAuthorityCsr.
    """ # noqa: E501
    pem_csr: Optional[StrictStr] = Field(default=None, description="Output only. The PEM-encoded signed certificate signing request (CSR).", alias="pemCsr")
    __properties: ClassVar[List[str]] = ["pemCsr"]
