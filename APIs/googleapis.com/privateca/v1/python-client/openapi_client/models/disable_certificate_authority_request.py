...
class DisableCertificateAuthorityRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ignoreDependentResources", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ignoreDependentResources": obj.get("ignoreDependentResources"),
