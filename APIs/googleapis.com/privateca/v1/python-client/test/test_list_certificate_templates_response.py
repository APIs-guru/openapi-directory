...
class TestListCertificateTemplatesResponse(unittest.TestCase):
    """ListCertificateTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCertificateTemplatesResponse:
        """Test ListCertificateTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCertificateTemplatesResponse`
        """
        model = ListCertificateTemplatesResponse()
        if include_optional:
            return ListCertificateTemplatesResponse(
                certificate_templates = [
                    openapi_client.models.certificate_template.CertificateTemplate(
                        create_time = '', 
                        description = '', 
                        ...
                        predefined_values = openapi_client.models.x509_parameters.X509Parameters(
                            aia_ocsp_servers = [
                                ''
                                ], 
    ...
    def testListCertificateTemplatesResponse(self):
        """Test ListCertificateTemplatesResponse"""
