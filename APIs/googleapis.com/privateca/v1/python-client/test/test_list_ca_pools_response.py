...
class TestListCaPoolsResponse(unittest.TestCase):
    """ListCaPoolsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCaPoolsResponse:
        """Test ListCaPoolsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCaPoolsResponse`
        """
        model = ListCaPoolsResponse()
        if include_optional:
            return ListCaPoolsResponse(
                ca_pools = [
                    openapi_client.models.ca_pool.CaPool(
    ...
    def testListCaPoolsResponse(self):
        """Test ListCaPoolsResponse"""
