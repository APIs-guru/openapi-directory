...
google_iam_v2beta_deny_rule_instance = GoogleIamV2betaDenyRule.from_json(json)
# print the JSON string representation of the object
print(GoogleIamV2betaDenyRule.to_json())

# convert the object into a dict
google_iam_v2beta_deny_rule_dict = google_iam_v2beta_deny_rule_instance.to_dict()
# create an instance of GoogleIamV2betaDenyRule from a dict
google_iam_v2beta_deny_rule_from_dict = GoogleIamV2betaDenyRule.from_dict(google_iam_v2beta_deny_rule_dict)
```
