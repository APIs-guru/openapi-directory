...
class GoogleIamV2betaPolicyRule(BaseModel):
    """
    A single rule in a `Policy`.
    """ # noqa: E501
    deny_rule: Optional[GoogleIamV2betaDenyRule] = Field(default=None, alias="denyRule")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "denyRule": GoogleIamV2betaDenyRule.from_dict(obj["denyRule"]) if obj.get("denyRule") is not None else None,
