...
class GoogleIamAdminV1AuditData(BaseModel):
    ...
    """ # noqa: E501
    permission_delta: Optional[GoogleIamAdminV1AuditDataPermissionDelta] = Field(default=None, alias="permissionDelta")
    __properties: ClassVar[List[str]] = ["permissionDelta"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of permission_delta
        if self.permission_delta:
            _dict['permissionDelta'] = self.permission_delta.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissionDelta": GoogleIamAdminV1AuditDataPermissionDelta.from_dict(obj["permissionDelta"]) if obj.get("permissionDelta") is not None else None
        })
        return _obj
