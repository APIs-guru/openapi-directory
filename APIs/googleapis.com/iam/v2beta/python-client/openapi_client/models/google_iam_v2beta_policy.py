...
class GoogleIamV2betaPolicy(BaseModel):
    """
    ...
    rules: Optional[List[GoogleIamV2betaPolicyRule]] = Field(default=None, description="A list of rules that specify the behavior of the `Policy`. All of the rules should be of the `kind` specified in the `Policy`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "name": obj.get("name"),
            "rules": [GoogleIamV2betaPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
            "uid": obj.get("uid"),
