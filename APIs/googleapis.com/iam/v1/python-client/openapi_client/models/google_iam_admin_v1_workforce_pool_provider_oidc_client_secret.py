...
class GoogleIamAdminV1WorkforcePoolProviderOidcClientSecret(BaseModel):
    """
    Representation of a client secret configured for the OIDC provider.
    """ # noqa: E501
    value: Optional[GoogleIamAdminV1WorkforcePoolProviderOidcClientSecretValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": GoogleIamAdminV1WorkforcePoolProviderOidcClientSecretValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
