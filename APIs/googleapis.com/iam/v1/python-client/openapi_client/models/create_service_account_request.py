...
class CreateServiceAccountRequest(BaseModel):
    ...
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="Required. The account id that is used to generate the service account email address and a stable unique id. It is unique within a project, must be 6-30 characters long, and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])` to comply with RFC1035.", alias="accountId")
    service_account: Optional[ServiceAccount] = Field(default=None, alias="serviceAccount")
    __properties: ClassVar[List[str]] = ["accountId", "serviceAccount"]
