...
class ListServiceAccountKeysResponse(BaseModel):
    ...
    """ # noqa: E501
    keys: Optional[List[ServiceAccountKey]] = Field(default=None, description="The public keys for the service account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [ServiceAccountKey.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
