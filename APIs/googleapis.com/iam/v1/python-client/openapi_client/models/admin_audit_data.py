...
class AdminAuditData(BaseModel):
    ...
    """ # noqa: E501
    permission_delta: Optional[PermissionDelta] = Field(default=None, alias="permissionDelta")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissionDelta": PermissionDelta.from_dict(obj["permissionDelta"]) if obj.get("permissionDelta") is not None else None
        })
        return _obj
