...
class QueryAuditableServicesResponse(BaseModel):
    ...
    """ # noqa: E501
    services: Optional[List[AuditableService]] = Field(default=None, description="The auditable services for a resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [AuditableService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
