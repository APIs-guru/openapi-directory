...
class QueryGrantableRolesResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="To retrieve the next page of results, set `QueryGrantableRolesRequest.page_token` to this value.", alias="nextPageToken")
    roles: Optional[List[Role]] = Field(default=None, description="The list of matching roles.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "roles"]
