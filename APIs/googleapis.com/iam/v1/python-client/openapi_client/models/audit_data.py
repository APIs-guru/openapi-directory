...
class AuditData(BaseModel):
    ...
    """ # noqa: E501
    policy_delta: Optional[PolicyDelta] = Field(default=None, alias="policyDelta")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policyDelta": PolicyDelta.from_dict(obj["policyDelta"]) if obj.get("policyDelta") is not None else None
        })
        return _obj
