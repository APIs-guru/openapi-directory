...
class IamPoliciesApi:
    ...
    @validate_call
    def iam_iam_policies_lint_policy(
        self,
        ...
        lint_policy_request: Optional[LintPolicyRequest] = None,
        ...
        :param lint_policy_request:
        :type lint_policy_request: LintPolicyRequest
        ...
        _param = self._iam_iam_policies_lint_policy_serialize(
            xgafv=xgafv,
            ...
            lint_policy_request=lint_policy_request,
    ...
    @validate_call
    def iam_iam_policies_lint_policy_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LintPolicyResponse]:
        """iam_iam_policies_lint_policy
    ...
    @validate_call
    def iam_iam_policies_lint_policy_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _iam_iam_policies_lint_policy_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if lint_policy_request is not None:
            _body_params = lint_policy_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/iamPolicies:lintPolicy',
    ...
    @validate_call
    def iam_iam_policies_query_auditable_services(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        query_auditable_services_request: Optional[QueryAuditableServicesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param query_auditable_services_request:
        :type query_auditable_services_request: QueryAuditableServicesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._iam_iam_policies_query_auditable_services_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            query_auditable_services_request=query_auditable_services_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QueryAuditableServicesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def iam_iam_policies_query_auditable_services_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryAuditableServicesResponse]:
        """iam_iam_policies_query_auditable_services
    ...
    @validate_call
    def iam_iam_policies_query_auditable_services_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _iam_iam_policies_query_auditable_services_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        upload_protocol,
        upload_type,
        query_auditable_services_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if query_auditable_services_request is not None:
            _body_params = query_auditable_services_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/iamPolicies:queryAuditableServices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
