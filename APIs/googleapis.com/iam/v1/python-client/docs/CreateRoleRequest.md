...
**role_id** | **str** | The role ID to use for this role. A role ID may contain alphanumeric characters, underscores (&#x60;_&#x60;), and periods (&#x60;.&#x60;). It must contain a minimum of 3 characters and a maximum of 64 characters. | [optional] 
