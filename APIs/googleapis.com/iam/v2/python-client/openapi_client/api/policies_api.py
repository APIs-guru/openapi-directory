...
class PoliciesApi:
    ...
    def iam_policies_create_policy(
        ...
        google_iam_v2_policy: Optional[GoogleIamV2Policy] = None,
        ...
        :type policy_id: str
        :param google_iam_v2_policy:
        :type google_iam_v2_policy: GoogleIamV2Policy
        ...
        _param = self._iam_policies_create_policy_serialize(
            ...
            policy_id=policy_id,
            google_iam_v2_policy=google_iam_v2_policy,
    ...
    def _iam_policies_create_policy_serialize(
        ...
        if google_iam_v2_policy is not None:
            _body_params = google_iam_v2_policy
    ...
    def iam_policies_list_policies(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleIamV2ListPoliciesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def iam_policies_list_policies_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleIamV2ListPoliciesResponse]:
        """iam_policies_list_policies
