...
------------- | ------------- | -------------
[**integrations_projects_locations_apps_script_projects_create**](ProjectsApi.md#integrations_projects_locations_apps_script_projects_create) | **POST** /v1alpha/{parent}/appsScriptProjects | 
[**integrations_projects_locations_apps_script_projects_link**](ProjectsApi.md#integrations_projects_locations_apps_script_projects_link) | **POST** /v1alpha/{parent}/appsScriptProjects:link | 
[**integrations_projects_locations_connections_list**](ProjectsApi.md#integrations_projects_locations_connections_list) | **GET** /v1alpha/{parent}/connections | 
[**integrations_projects_locations_connections_runtime_action_schemas_list**](ProjectsApi.md#integrations_projects_locations_connections_runtime_action_schemas_list) | **GET** /v1alpha/{parent}/runtimeActionSchemas | 
[**integrations_projects_locations_connections_runtime_entity_schemas_list**](ProjectsApi.md#integrations_projects_locations_connections_runtime_entity_schemas_list) | **GET** /v1alpha/{parent}/runtimeEntitySchemas | 
[**integrations_projects_locations_integrations_execute_event**](ProjectsApi.md#integrations_projects_locations_integrations_execute_event) | **POST** /v1alpha/{name}:executeEvent | 
[**integrations_projects_locations_products_auth_configs_create**](ProjectsApi.md#integrations_projects_locations_products_auth_configs_create) | **POST** /v1alpha/{parent}/authConfigs | 
[**integrations_projects_locations_products_auth_configs_list**](ProjectsApi.md#integrations_projects_locations_products_auth_configs_list) | **GET** /v1alpha/{parent}/authConfigs | 
[**integrations_projects_locations_products_certificates_create**](ProjectsApi.md#integrations_projects_locations_products_certificates_create) | **POST** /v1alpha/{parent}/certificates | 
[**integrations_projects_locations_products_certificates_list**](ProjectsApi.md#integrations_projects_locations_products_certificates_list) | **GET** /v1alpha/{parent}/certificates | 
[**integrations_projects_locations_products_integrations_execute**](ProjectsApi.md#integrations_projects_locations_products_integrations_execute) | **POST** /v1alpha/{name}:execute | 
[**integrations_projects_locations_products_integrations_executions_cancel**](ProjectsApi.md#integrations_projects_locations_products_integrations_executions_cancel) | **POST** /v1alpha/{name}:cancel | 
[**integrations_projects_locations_products_integrations_executions_list**](ProjectsApi.md#integrations_projects_locations_products_integrations_executions_list) | **GET** /v1alpha/{parent}/executions | 
[**integrations_projects_locations_products_integrations_executions_suspensions_lift**](ProjectsApi.md#integrations_projects_locations_products_integrations_executions_suspensions_lift) | **POST** /v1alpha/{name}:lift | 
[**integrations_projects_locations_products_integrations_executions_suspensions_list**](ProjectsApi.md#integrations_projects_locations_products_integrations_executions_suspensions_list) | **GET** /v1alpha/{parent}/suspensions | 
[**integrations_projects_locations_products_integrations_executions_suspensions_resolve**](ProjectsApi.md#integrations_projects_locations_products_integrations_executions_suspensions_resolve) | **POST** /v1alpha/{name}:resolve | 
[**integrations_projects_locations_products_integrations_list**](ProjectsApi.md#integrations_projects_locations_products_integrations_list) | **GET** /v1alpha/{parent}/integrations | 
[**integrations_projects_locations_products_integrations_schedule**](ProjectsApi.md#integrations_projects_locations_products_integrations_schedule) | **POST** /v1alpha/{name}:schedule | 
[**integrations_projects_locations_products_integrations_versions_download**](ProjectsApi.md#integrations_projects_locations_products_integrations_versions_download) | **GET** /v1alpha/{name}:download | 
[**integrations_projects_locations_products_integrations_versions_publish**](ProjectsApi.md#integrations_projects_locations_products_integrations_versions_publish) | **POST** /v1alpha/{name}:publish | 
[**integrations_projects_locations_products_integrations_versions_takeover_edit_lock**](ProjectsApi.md#integrations_projects_locations_products_integrations_versions_takeover_edit_lock) | **POST** /v1alpha/{integrationVersion}:takeoverEditLock | 
[**integrations_projects_locations_products_integrations_versions_unpublish**](ProjectsApi.md#integrations_projects_locations_products_integrations_versions_unpublish) | **POST** /v1alpha/{name}:unpublish | 
[**integrations_projects_locations_products_integrations_versions_upload**](ProjectsApi.md#integrations_projects_locations_products_integrations_versions_upload) | **POST** /v1alpha/{parent}/versions:upload | 
[**integrations_projects_locations_products_integrationtemplates_versions_create**](ProjectsApi.md#integrations_projects_locations_products_integrationtemplates_versions_create) | **POST** /v1alpha/{parent}/versions | 
[**integrations_projects_locations_products_integrationtemplates_versions_list**](ProjectsApi.md#integrations_projects_locations_products_integrationtemplates_versions_list) | **GET** /v1alpha/{parent}/versions | 
[**integrations_projects_locations_sfdc_instances_create**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_create) | **POST** /v1alpha/{parent}/sfdcInstances | 
[**integrations_projects_locations_sfdc_instances_list**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_list) | **GET** /v1alpha/{parent}/sfdcInstances | 
[**integrations_projects_locations_sfdc_instances_sfdc_channels_create**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_sfdc_channels_create) | **POST** /v1alpha/{parent}/sfdcChannels | 
[**integrations_projects_locations_sfdc_instances_sfdc_channels_delete**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_sfdc_channels_delete) | **DELETE** /v1alpha/{name} | 
[**integrations_projects_locations_sfdc_instances_sfdc_channels_get**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_sfdc_channels_get) | **GET** /v1alpha/{name} | 
[**integrations_projects_locations_sfdc_instances_sfdc_channels_list**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_sfdc_channels_list) | **GET** /v1alpha/{parent}/sfdcChannels | 
[**integrations_projects_locations_sfdc_instances_sfdc_channels_patch**](ProjectsApi.md#integrations_projects_locations_sfdc_instances_sfdc_channels_patch) | **PATCH** /v1alpha/{name} | 
...
# **integrations_projects_locations_integrations_execute_event**
> GoogleCloudIntegrationsV1alphaExecuteEventResponse integrations_projects_locations_integrations_execute_event(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, google_cloud_integrations_v1alpha_execute_event_request=google_cloud_integrations_v1alpha_execute_event_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    name = 'name_example' # str | Required. The integration resource name. Format: projects/{gcp_project_id}/locations/{location}/integrations/{integration_id}
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    google_cloud_integrations_v1alpha_execute_event_request = openapi_client.GoogleCloudIntegrationsV1alphaExecuteEventRequest() # GoogleCloudIntegrationsV1alphaExecuteEventRequest |  (optional)

    try:
        api_response = api_instance.integrations_projects_locations_integrations_execute_event(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, google_cloud_integrations_v1alpha_execute_event_request=google_cloud_integrations_v1alpha_execute_event_request)
        print("The response of ProjectsApi->integrations_projects_locations_integrations_execute_event:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->integrations_projects_locations_integrations_execute_event: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **str**| Required. The integration resource name. Format: projects/{gcp_project_id}/locations/{location}/integrations/{integration_id} | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **google_cloud_integrations_v1alpha_execute_event_request** | [**GoogleCloudIntegrationsV1alphaExecuteEventRequest**](GoogleCloudIntegrationsV1alphaExecuteEventRequest.md)|  | [optional] 

### Return type

[**GoogleCloudIntegrationsV1alphaExecuteEventResponse**](GoogleCloudIntegrationsV1alphaExecuteEventResponse.md)
...
# **integrations_projects_locations_products_integrationtemplates_versions_create**
> GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion integrations_projects_locations_products_integrationtemplates_versions_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, new_integration=new_integration, google_cloud_integrations_v1alpha_integration_template_version=google_cloud_integrations_v1alpha_integration_template_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    parent = 'parent_example' # str | Required. The parent resource where this TemplateVersion will be created. Format: projects/{project}/location/{location}/product/{product}/integrationtemplates/{integrationtemplate}
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    google_cloud_integrations_v1alpha_integration_template_version = openapi_client.GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion() # GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion |  (optional)

    try:
        api_response = api_instance.integrations_projects_locations_products_integrationtemplates_versions_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, new_integration=new_integration, google_cloud_integrations_v1alpha_integration_template_version=google_cloud_integrations_v1alpha_integration_template_version)
        print("The response of ProjectsApi->integrations_projects_locations_products_integrationtemplates_versions_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->integrations_projects_locations_products_integrationtemplates_versions_create: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. The parent resource where this TemplateVersion will be created. Format: projects/{project}/location/{location}/product/{product}/integrationtemplates/{integrationtemplate} | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **google_cloud_integrations_v1alpha_integration_template_version** | [**GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion**](GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion.md)|  | [optional] 

### Return type

[**GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion**](GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion.md)
...
# **integrations_projects_locations_products_integrationtemplates_versions_list**
> GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse integrations_projects_locations_products_integrationtemplates_versions_list(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, page_size=page_size, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    parent = 'parent_example' # str | Required. Format: projects/{project}/location/{location}/product/{product}/integrationtemplates/{integrationtemplate}
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    filter = 'filter_example' # str | Filter syntax: defined in the EBNF grammar. (optional)
    page_size = 56 # int | The maximum number of IntegrationTemplateVersions to return. The service may return fewer than this value. If unspecified, at most 50 versions will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. (optional)
    page_token = 'page_token_example' # str | A page token, received from a previous `ListIntegrationTemplateVersions` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListIntegrationTemplateVersions` must match the call that provided the page token. (optional)

    try:
        api_response = api_instance.integrations_projects_locations_products_integrationtemplates_versions_list(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, page_size=page_size, page_token=page_token)
        print("The response of ProjectsApi->integrations_projects_locations_products_integrationtemplates_versions_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->integrations_projects_locations_products_integrationtemplates_versions_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. Format: projects/{project}/location/{location}/product/{product}/integrationtemplates/{integrationtemplate} | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **filter** | **str**| Filter syntax: defined in the EBNF grammar. | [optional] 
 **page_size** | **int**| The maximum number of IntegrationTemplateVersions to return. The service may return fewer than this value. If unspecified, at most 50 versions will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. | [optional] 
 **page_token** | **str**| A page token, received from a previous &#x60;ListIntegrationTemplateVersions&#x60; call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to &#x60;ListIntegrationTemplateVersions&#x60; must match the call that provided the page token. | [optional] 

### Return type

[**GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse**](GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse.md)
