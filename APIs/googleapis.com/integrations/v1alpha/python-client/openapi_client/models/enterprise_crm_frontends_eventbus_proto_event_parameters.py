...
class EnterpriseCrmFrontendsEventbusProtoEventParameters(BaseModel):
    ...
    """ # noqa: E501
    parameters: Optional[List[EnterpriseCrmFrontendsEventbusProtoParameterEntry]] = Field(default=None, description="Parameters are a part of Event and can be used to communicate between different tasks that are part of the same workflow execution.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": [EnterpriseCrmFrontendsEventbusProtoParameterEntry.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
