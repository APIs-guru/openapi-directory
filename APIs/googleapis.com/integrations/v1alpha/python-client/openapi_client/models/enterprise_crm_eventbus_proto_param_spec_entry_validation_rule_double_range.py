...
class EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleDoubleRange(BaseModel):
    ...
    """ # noqa: E501
    max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The inclusive maximum of the acceptable range.")
    min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The inclusive minimum of the acceptable range.")
