...
class GoogleCloudConnectorsV1AuthConfigUserPassword(BaseModel):
    ...
    """ # noqa: E501
    password: Optional[GoogleCloudConnectorsV1Secret] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "password": GoogleCloudConnectorsV1Secret.from_dict(obj["password"]) if obj.get("password") is not None else None,
