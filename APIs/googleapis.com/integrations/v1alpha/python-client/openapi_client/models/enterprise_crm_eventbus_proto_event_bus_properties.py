...
class EnterpriseCrmEventbusProtoEventBusProperties(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[List[EnterpriseCrmEventbusProtoPropertyEntry]] = Field(default=None, description="An unordered list of property entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": [EnterpriseCrmEventbusProtoPropertyEntry.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
