...
class GoogleCloudIntegrationsV1alphaResolveSuspensionRequest(BaseModel):
    ...
    """ # noqa: E501
    suspension: Optional[GoogleCloudIntegrationsV1alphaSuspension] = None
    __properties: ClassVar[List[str]] = ["suspension"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suspension": GoogleCloudIntegrationsV1alphaSuspension.from_dict(obj["suspension"]) if obj.get("suspension") is not None else None
        })
        return _obj
