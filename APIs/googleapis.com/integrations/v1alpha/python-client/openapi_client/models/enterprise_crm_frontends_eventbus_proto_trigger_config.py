...
class EnterpriseCrmFrontendsEventbusProtoTriggerConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertConfig", "cloudSchedulerConfig", "description", "enabledClients", "errorCatcherId", "label", "nextTasksExecutionPolicy", "pauseWorkflowExecutions", "position", "properties", "startTasks", "triggerCriteria", "triggerId", "triggerNumber", "triggerType"]
