...
class EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleStringRegex(BaseModel):
    ...
    """ # noqa: E501
    exclusive: Optional[StrictBool] = Field(default=None, description="Whether the regex matcher is applied exclusively (if true, matching values will be rejected).")
    regex: Optional[StrictStr] = Field(default=None, description="The regex applied to the input value(s).")
    __properties: ClassVar[List[str]] = ["exclusive", "regex"]
