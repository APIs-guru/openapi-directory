...
class GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest(BaseModel):
    ...
    """ # noqa: E501
    script_id: Optional[StrictStr] = Field(default=None, description="The id of the Apps Script project to be linked.", alias="scriptId")
    __properties: ClassVar[List[str]] = ["scriptId"]
