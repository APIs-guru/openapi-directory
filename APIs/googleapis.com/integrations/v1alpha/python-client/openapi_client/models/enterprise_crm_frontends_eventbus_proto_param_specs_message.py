...
class EnterpriseCrmFrontendsEventbusProtoParamSpecsMessage(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnterpriseCrmFrontendsEventbusProtoParamSpecsMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnterpriseCrmFrontendsEventbusProtoParamSpecsMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "parameters": [EnterpriseCrmFrontendsEventbusProtoParamSpecEntry.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
