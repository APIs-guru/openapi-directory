...
class GoogleCloudIntegrationsV1alphaSuspensionAudit(BaseModel):
    ...
    """ # noqa: E501
    resolve_time: Optional[StrictStr] = Field(default=None, description="Time at which this suspension was resolved.", alias="resolveTime")
    resolver: Optional[StrictStr] = Field(default=None, description="Email address of the person who resolved this suspension.")
    __properties: ClassVar[List[str]] = ["resolveTime", "resolver"]
