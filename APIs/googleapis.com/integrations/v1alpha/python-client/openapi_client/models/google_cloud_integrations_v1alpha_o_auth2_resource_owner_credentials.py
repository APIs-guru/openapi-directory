...
class GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentials(BaseModel):
    ...
    password: Optional[StrictStr] = Field(default=None, description="The user's password.")
    ...
    __properties: ClassVar[List[str]] = ["accessToken", "clientId", "clientSecret", "password", "requestType", "scope", "tokenEndpoint", "tokenParams", "username"]
