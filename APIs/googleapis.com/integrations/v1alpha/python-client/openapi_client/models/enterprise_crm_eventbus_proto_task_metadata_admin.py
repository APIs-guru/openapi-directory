...
class EnterpriseCrmEventbusProtoTaskMetadataAdmin(BaseModel):
    ...
    """ # noqa: E501
    google_group_email: Optional[StrictStr] = Field(default=None, alias="googleGroupEmail")
    user_email: Optional[StrictStr] = Field(default=None, alias="userEmail")
    __properties: ClassVar[List[str]] = ["googleGroupEmail", "userEmail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "googleGroupEmail": obj.get("googleGroupEmail"),
