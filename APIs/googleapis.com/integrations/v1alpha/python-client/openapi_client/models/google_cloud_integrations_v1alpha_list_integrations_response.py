...
class GoogleCloudIntegrationsV1alphaListIntegrationsResponse(BaseModel):
    ...
    """ # noqa: E501
    integrations: Optional[List[GoogleCloudIntegrationsV1alphaIntegration]] = Field(default=None, description="The integrations which match the request.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="The next page token for the response.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["integrations", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [GoogleCloudIntegrationsV1alphaIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None,
