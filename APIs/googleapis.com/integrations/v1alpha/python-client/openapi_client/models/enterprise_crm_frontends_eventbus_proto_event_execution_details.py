...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails(BaseModel):
    ...
    event_execution_snapshot: Optional[List[EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot]] = Field(default=None, description="After snapshot migration, this field will no longer be populated, but old execution snapshots will still be accessible.", alias="eventExecutionSnapshot")
    event_execution_state: Optional[StrictStr] = Field(default=None, description="The execution state of this event.", alias="eventExecutionState")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventExecutionSnapshot": [EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot.from_dict(_item) for _item in obj["eventExecutionSnapshot"]] if obj.get("eventExecutionSnapshot") is not None else None,
