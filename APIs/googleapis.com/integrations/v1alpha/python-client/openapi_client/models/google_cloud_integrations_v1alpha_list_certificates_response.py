...
class GoogleCloudIntegrationsV1alphaListCertificatesResponse(BaseModel):
    ...
    """ # noqa: E501
    certificates: Optional[List[GoogleCloudIntegrationsV1alphaCertificate]] = Field(default=None, description="The list of Certificates retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [GoogleCloudIntegrationsV1alphaCertificate.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None,
