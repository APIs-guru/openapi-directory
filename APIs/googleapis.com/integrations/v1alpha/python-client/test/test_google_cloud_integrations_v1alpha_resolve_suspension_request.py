...
class TestGoogleCloudIntegrationsV1alphaResolveSuspensionRequest(unittest.TestCase):
    """GoogleCloudIntegrationsV1alphaResolveSuspensionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudIntegrationsV1alphaResolveSuspensionRequest:
        """Test GoogleCloudIntegrationsV1alphaResolveSuspensionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudIntegrationsV1alphaResolveSuspensionRequest`
        """
        model = GoogleCloudIntegrationsV1alphaResolveSuspensionRequest()
        if include_optional:
            return GoogleCloudIntegrationsV1alphaResolveSuspensionRequest(
                suspension = openapi_client.models.google_cloud_integrations_v1alpha_suspension.GoogleCloudIntegrationsV1alphaSuspension(
    ...
    def testGoogleCloudIntegrationsV1alphaResolveSuspensionRequest(self):
        """Test GoogleCloudIntegrationsV1alphaResolveSuspensionRequest"""
