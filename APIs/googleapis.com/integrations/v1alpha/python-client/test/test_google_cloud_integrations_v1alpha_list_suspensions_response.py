...
class TestGoogleCloudIntegrationsV1alphaListSuspensionsResponse(unittest.TestCase):
    """GoogleCloudIntegrationsV1alphaListSuspensionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudIntegrationsV1alphaListSuspensionsResponse:
        """Test GoogleCloudIntegrationsV1alphaListSuspensionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudIntegrationsV1alphaListSuspensionsResponse`
        """
        model = GoogleCloudIntegrationsV1alphaListSuspensionsResponse()
        if include_optional:
            return GoogleCloudIntegrationsV1alphaListSuspensionsResponse(
                next_page_token = '',
                suspensions = [
                    openapi_client.models.google_cloud_integrations_v1alpha_suspension.GoogleCloudIntegrationsV1alphaSuspension(
    ...
    def testGoogleCloudIntegrationsV1alphaListSuspensionsResponse(self):
        """Test GoogleCloudIntegrationsV1alphaListSuspensionsResponse"""
