...
class TestGoogleCloudConnectorsV1Connection(unittest.TestCase):
    """GoogleCloudConnectorsV1Connection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudConnectorsV1Connection:
        """Test GoogleCloudConnectorsV1Connection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudConnectorsV1Connection`
        """
        model = GoogleCloudConnectorsV1Connection()
        if include_optional:
    ...
    def testGoogleCloudConnectorsV1Connection(self):
        """Test GoogleCloudConnectorsV1Connection"""
