...
class TestEnterpriseCrmEventbusProtoCustomSuspensionRequest(unittest.TestCase):
    """EnterpriseCrmEventbusProtoCustomSuspensionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseCrmEventbusProtoCustomSuspensionRequest:
        """Test EnterpriseCrmEventbusProtoCustomSuspensionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseCrmEventbusProtoCustomSuspensionRequest`
        """
        model = EnterpriseCrmEventbusProtoCustomSuspensionRequest()
        if include_optional:
    ...
    def testEnterpriseCrmEventbusProtoCustomSuspensionRequest(self):
        """Test EnterpriseCrmEventbusProtoCustomSuspensionRequest"""
