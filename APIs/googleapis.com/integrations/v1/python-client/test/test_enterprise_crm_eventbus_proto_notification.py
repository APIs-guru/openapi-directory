...
class TestEnterpriseCrmEventbusProtoNotification(unittest.TestCase):
    """EnterpriseCrmEventbusProtoNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseCrmEventbusProtoNotification:
        """Test EnterpriseCrmEventbusProtoNotification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseCrmEventbusProtoNotification`
        """
        model = EnterpriseCrmEventbusProtoNotification()
        if include_optional:
    ...
    def testEnterpriseCrmEventbusProtoNotification(self):
        """Test EnterpriseCrmEventbusProtoNotification"""
