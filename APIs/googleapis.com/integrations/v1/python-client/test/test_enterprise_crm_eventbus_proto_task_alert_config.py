...
class TestEnterpriseCrmEventbusProtoTaskAlertConfig(unittest.TestCase):
    """EnterpriseCrmEventbusProtoTaskAlertConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseCrmEventbusProtoTaskAlertConfig:
        """Test EnterpriseCrmEventbusProtoTaskAlertConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseCrmEventbusProtoTaskAlertConfig`
        """
        model = EnterpriseCrmEventbusProtoTaskAlertConfig()
        if include_optional:
    ...
    def testEnterpriseCrmEventbusProtoTaskAlertConfig(self):
        """Test EnterpriseCrmEventbusProtoTaskAlertConfig"""
