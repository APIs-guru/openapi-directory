...
class GoogleCloudIntegrationsV1alphaAuthToken(BaseModel):
    ...
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="The token for the auth type.")
    type: Optional[StrictStr] = Field(default=None, description="Authentication type, e.g. \"Basic\", \"Bearer\", etc.")
