...
class GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse(BaseModel):
    ...
    """ # noqa: E501
    trigger_url: Optional[StrictStr] = Field(default=None, description="The trigger url that will be returned", alias="triggerUrl")
    __properties: ClassVar[List[str]] = ["triggerUrl"]
