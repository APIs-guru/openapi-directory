...
class EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleIntRange(BaseModel):
    ...
    """ # noqa: E501
    max: Optional[StrictStr] = Field(default=None, description="The inclusive maximum of the acceptable range.")
    min: Optional[StrictStr] = Field(default=None, description="The inclusive minimum of the acceptable range.")
