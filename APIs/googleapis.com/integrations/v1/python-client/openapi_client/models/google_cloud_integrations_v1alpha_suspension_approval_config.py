...
class GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig(BaseModel):
    ...
    """ # noqa: E501
    custom_message: Optional[StrictStr] = Field(default=None, description="Information to provide for recipients.", alias="customMessage")
    email_addresses: Optional[List[StrictStr]] = Field(default=None, description="Email addresses to send approval request to.", alias="emailAddresses")
    expiration: Optional[GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration] = None
    __properties: ClassVar[List[str]] = ["customMessage", "emailAddresses", "expiration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expiration": GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration.from_dict(obj["expiration"]) if obj.get("expiration") is not None else None
        })
        return _obj
