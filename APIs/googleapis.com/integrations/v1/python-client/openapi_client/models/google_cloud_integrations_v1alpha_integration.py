...
class GoogleCloudIntegrationsV1alphaIntegration(BaseModel):
    ...
    """ # noqa: E501
    active: Optional[StrictBool] = Field(default=None, description="Required. If any integration version is published.")
    description: Optional[StrictStr] = Field(default=None, description="Optional.")
    name: Optional[StrictStr] = Field(default=None, description="Required. The resource name of the integration.")
    update_time: Optional[StrictStr] = Field(default=None, description="Output only. Auto-generated.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["active", "description", "name", "updateTime"]
