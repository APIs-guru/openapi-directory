...
class GoogleCloudIntegrationsV1alphaNextTask(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="User-provided description intended to give additional business context about the task.")
    display_name: Optional[StrictStr] = Field(default=None, description="User-provided label that is attached to this edge in the UI.", alias="displayName")
    task_config_id: Optional[StrictStr] = Field(default=None, description="ID of the next task.", alias="taskConfigId")
    task_id: Optional[StrictStr] = Field(default=None, description="Task number of the next task.", alias="taskId")
    __properties: ClassVar[List[str]] = ["condition", "description", "displayName", "taskConfigId", "taskId"]
