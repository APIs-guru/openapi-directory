...
class GoogleCloudIntegrationsV1alphaCoordinate(BaseModel):
    ...
    """ # noqa: E501
    x: Optional[StrictInt] = Field(default=None, description="Required. X axis of the coordinate")
    y: Optional[StrictInt] = Field(default=None, description="Required. Y axis of the coordinate")
