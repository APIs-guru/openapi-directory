...
class GoogleCloudIntegrationsV1alphaParameterMapEntry(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[GoogleCloudIntegrationsV1alphaParameterMapField] = None
    value: Optional[GoogleCloudIntegrationsV1alphaParameterMapField] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": GoogleCloudIntegrationsV1alphaParameterMapField.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "value": GoogleCloudIntegrationsV1alphaParameterMapField.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
