...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue(BaseModel):
    ...
    """ # noqa: E501
    absolute: Optional[StrictStr] = Field(default=None, description="Absolute value threshold.")
    percentage: Optional[StrictInt] = Field(default=None, description="Percentage threshold.")
