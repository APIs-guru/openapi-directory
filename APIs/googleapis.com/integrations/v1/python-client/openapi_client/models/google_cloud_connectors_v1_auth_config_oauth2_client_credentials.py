...
class GoogleCloudConnectorsV1AuthConfigOauth2ClientCredentials(BaseModel):
    ...
    client_secret: Optional[GoogleCloudConnectorsV1Secret] = Field(default=None, alias="clientSecret")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clientSecret": GoogleCloudConnectorsV1Secret.from_dict(obj["clientSecret"]) if obj.get("clientSecret") is not None else None
        })
        return _obj
