...
class EnterpriseCrmEventbusProtoCombinedCondition(BaseModel):
    ...
    """ # noqa: E501
    conditions: Optional[List[EnterpriseCrmEventbusProtoCondition]] = Field(default=None, description="A set of individual constituent conditions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conditions": [EnterpriseCrmEventbusProtoCondition.from_dict(_item) for _item in obj["conditions"]] if obj.get("conditions") is not None else None
        })
        return _obj
