...
class GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse(BaseModel):
    """
    Response containing all provisioned regions for Connector Platform.
    """ # noqa: E501
    regions: Optional[List[StrictStr]] = Field(default=None, description="All regions where Connector Platform is provisioned.")
