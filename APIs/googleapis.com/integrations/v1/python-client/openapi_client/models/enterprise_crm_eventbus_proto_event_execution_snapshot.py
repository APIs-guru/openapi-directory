...
class EnterpriseCrmEventbusProtoEventExecutionSnapshot(BaseModel):
    ...
    diff_params: Optional[EnterpriseCrmEventbusProtoEventParameters] = Field(default=None, alias="diffParams")
    ...
    event_params: Optional[EnterpriseCrmEventbusProtoEventParameters] = Field(default=None, alias="eventParams")
    exceed_max_size: Optional[StrictBool] = Field(default=None, description="indicate whether snapshot exceeded maximum size before clean up", alias="exceedMaxSize")
    ...
    __properties: ClassVar[List[str]] = ["checkpointTaskNumber", "conditionResults", "diffParams", "eventExecutionInfoId", "eventExecutionSnapshotId", "eventExecutionSnapshotMetadata", "eventParams", "exceedMaxSize", "snapshotTime", "taskExecutionDetails", "taskName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diffParams": EnterpriseCrmEventbusProtoEventParameters.from_dict(obj["diffParams"]) if obj.get("diffParams") is not None else None,
            ...
            "eventParams": EnterpriseCrmEventbusProtoEventParameters.from_dict(obj["eventParams"]) if obj.get("eventParams") is not None else None,
            "exceedMaxSize": obj.get("exceedMaxSize"),
