...
class GoogleCloudIntegrationsV1alphaCancelExecutionResponse(BaseModel):
    ...
    """ # noqa: E501
    is_canceled: Optional[StrictBool] = Field(default=None, description="True if cancellation performed successfully", alias="isCanceled")
    __properties: ClassVar[List[str]] = ["isCanceled"]
