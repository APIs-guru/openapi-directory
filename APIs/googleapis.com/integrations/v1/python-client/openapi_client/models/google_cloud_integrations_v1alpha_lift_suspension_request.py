...
class GoogleCloudIntegrationsV1alphaLiftSuspensionRequest(BaseModel):
    ...
    """ # noqa: E501
    suspension_result: Optional[StrictStr] = Field(default=None, description="User passed in suspension result and will be used to control workflow execution branching behavior by setting up corresponnding edge condition with suspension result. For example, if you want to lift the suspension, you can pass \"Approved\", or if you want to reject the suspension and terminate workfloe execution, you can pass \"Rejected\" and terminate the workflow execution with configuring the edge condition.", alias="suspensionResult")
    __properties: ClassVar[List[str]] = ["suspensionResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suspensionResult": obj.get("suspensionResult")
        })
        return _obj
