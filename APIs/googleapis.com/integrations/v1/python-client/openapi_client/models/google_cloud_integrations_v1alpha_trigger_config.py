...
class GoogleCloudIntegrationsV1alphaTriggerConfig(BaseModel):
    ...
    trigger: Optional[StrictStr] = Field(default=None, description="Optional. Name of the trigger. Example: \"API Trigger\", \"Cloud Pub Sub Trigger\" When set will be sent out to monitoring dashabord for tracking purpose.")
    ...
    __properties: ClassVar[List[str]] = ["alertConfig", "cloudSchedulerConfig", "description", "errorCatcherId", "label", "nextTasksExecutionPolicy", "position", "properties", "startTasks", "trigger", "triggerId", "triggerNumber", "triggerType"]
