...
class TestWriteLogEntriesRequest(unittest.TestCase):
    """WriteLogEntriesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WriteLogEntriesRequest:
        """Test WriteLogEntriesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WriteLogEntriesRequest`
        """
        model = WriteLogEntriesRequest()
        if include_optional:
    ...
    def testWriteLogEntriesRequest(self):
        """Test WriteLogEntriesRequest"""
