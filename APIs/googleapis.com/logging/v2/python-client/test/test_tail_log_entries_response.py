...
class TestTailLogEntriesResponse(unittest.TestCase):
    """TailLogEntriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TailLogEntriesResponse:
        """Test TailLogEntriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TailLogEntriesResponse`
        """
        model = TailLogEntriesResponse()
        if include_optional:
            return TailLogEntriesResponse(
                ...
                suppression_info = [
                    openapi_client.models.suppression_info.SuppressionInfo(
    ...
    def testTailLogEntriesResponse(self):
        """Test TailLogEntriesResponse"""
