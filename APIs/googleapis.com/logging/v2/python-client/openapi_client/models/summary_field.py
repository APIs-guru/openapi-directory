...
class SummaryField(BaseModel):
    ...
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="Optional. The field from the LogEntry to include in the summary line, for example resource.type or jsonPayload.name.", alias="field")
