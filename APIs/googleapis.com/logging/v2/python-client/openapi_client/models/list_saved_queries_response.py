...
class ListSavedQueriesResponse(BaseModel):
    ...
    saved_queries: Optional[List[SavedQuery]] = Field(default=None, description="A list of saved queries.", alias="savedQueries")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="The unreachable resources. It can be either 1) a saved query if a specific query is unreachable or 2) a location if a specific location is unreachabe. \"projects/[PROJECT_ID]/locations/[LOCATION_ID]/savedQueries/[QUERY_ID]\" \"projects/[PROJECT_ID]/locations/[LOCATION_ID]\" For example: \"projects/my-project/locations/global/savedQueries/12345678\" \"projects/my-project/locations/global\" If there are unreachable resources, the response will first return pages that contain saved queries, and then return pages that contain the unreachable resources.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "savedQueries", "unreachable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "savedQueries": [SavedQuery.from_dict(_item) for _item in obj["savedQueries"]] if obj.get("savedQueries") is not None else None,
