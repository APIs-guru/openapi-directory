...
class BucketMetadata(BaseModel):
    ...
    """ # noqa: E501
    create_bucket_request: Optional[CreateBucketRequest] = Field(default=None, alias="createBucketRequest")
    ...
    update_bucket_request: Optional[UpdateBucketRequest] = Field(default=None, alias="updateBucketRequest")
    __properties: ClassVar[List[str]] = ["createBucketRequest", "endTime", "startTime", "state", "updateBucketRequest"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of create_bucket_request
        if self.create_bucket_request:
            _dict['createBucketRequest'] = self.create_bucket_request.to_dict()
        # override the default output from pydantic by calling `to_dict()` of update_bucket_request
        if self.update_bucket_request:
            _dict['updateBucketRequest'] = self.update_bucket_request.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createBucketRequest": CreateBucketRequest.from_dict(obj["createBucketRequest"]) if obj.get("createBucketRequest") is not None else None,
            "endTime": obj.get("endTime"),
            "startTime": obj.get("startTime"),
            "state": obj.get("state"),
            "updateBucketRequest": UpdateBucketRequest.from_dict(obj["updateBucketRequest"]) if obj.get("updateBucketRequest") is not None else None
        })
        return _obj
