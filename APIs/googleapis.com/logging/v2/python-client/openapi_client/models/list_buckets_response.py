...
class ListBucketsResponse(BaseModel):
    ...
    """ # noqa: E501
    buckets: Optional[List[LogBucket]] = Field(default=None, description="A list of buckets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [LogBucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None,
