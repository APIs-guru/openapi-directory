...
class ListViewsResponse(BaseModel):
    ...
    views: Optional[List[LogView]] = Field(default=None, description="A list of views.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "views": [LogView.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
