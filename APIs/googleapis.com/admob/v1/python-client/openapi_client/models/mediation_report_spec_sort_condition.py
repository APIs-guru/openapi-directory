...
class MediationReportSpecSortCondition(BaseModel):
    ...
    def dimension_validate_enum(cls, value):
        ...
        if value not in set(['DIMENSION_UNSPECIFIED', 'DATE', 'MONTH', 'WEEK', 'AD_SOURCE', 'AD_SOURCE_INSTANCE', 'AD_UNIT', 'APP', 'MEDIATION_GROUP', 'COUNTRY', 'FORMAT', 'PLATFORM', 'MOBILE_OS_VERSION', 'GMA_SDK_VERSION', 'APP_VERSION_NAME', 'SERVING_RESTRICTION']):
            raise ValueError("must be one of enum values ('DIMENSION_UNSPECIFIED', 'DATE', 'MONTH', 'WEEK', 'AD_SOURCE', 'AD_SOURCE_INSTANCE', 'AD_UNIT', 'APP', 'MEDIATION_GROUP', 'COUNTRY', 'FORMAT', 'PLATFORM', 'MOBILE_OS_VERSION', 'GMA_SDK_VERSION', 'APP_VERSION_NAME', 'SERVING_RESTRICTION')")
        return value
    ...
    def metric_validate_enum(cls, value):
        ...
        if value not in set(['METRIC_UNSPECIFIED', 'AD_REQUESTS', 'CLICKS', 'ESTIMATED_EARNINGS', 'IMPRESSIONS', 'IMPRESSION_CTR', 'MATCHED_REQUESTS', 'MATCH_RATE', 'OBSERVED_ECPM']):
            raise ValueError("must be one of enum values ('METRIC_UNSPECIFIED', 'AD_REQUESTS', 'CLICKS', 'ESTIMATED_EARNINGS', 'IMPRESSIONS', 'IMPRESSION_CTR', 'MATCHED_REQUESTS', 'MATCH_RATE', 'OBSERVED_ECPM')")
        return value
