...
------------ | ------------- | ------------- | -------------
*AccountsApi* | [**admob_accounts_ad_units_list**](docs/AccountsApi.md#admob_accounts_ad_units_list) | **GET** /v1/{parent}/adUnits | 
*AccountsApi* | [**admob_accounts_apps_list**](docs/AccountsApi.md#admob_accounts_apps_list) | **GET** /v1/{parent}/apps | 
*AccountsApi* | [**admob_accounts_get**](docs/AccountsApi.md#admob_accounts_get) | **GET** /v1/{name} | 
*AccountsApi* | [**admob_accounts_list**](docs/AccountsApi.md#admob_accounts_list) | **GET** /v1/accounts | 
*AccountsApi* | [**admob_accounts_mediation_report_generate**](docs/AccountsApi.md#admob_accounts_mediation_report_generate) | **POST** /v1/{parent}/mediationReport:generate | 
*AccountsApi* | [**admob_accounts_network_report_generate**](docs/AccountsApi.md#admob_accounts_network_report_generate) | **POST** /v1/{parent}/networkReport:generate | 
