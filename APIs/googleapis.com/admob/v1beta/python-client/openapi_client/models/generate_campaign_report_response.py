...
class GenerateCampaignReportResponse(BaseModel):
    """
    Campaign Report API response.
    """ # noqa: E501
    rows: Optional[List[ReportRow]] = Field(default=None, description="The campaign report data from the specified publisher. At most 100000 rows will be returned from the API.")
