...
class ResponsePoliciesUpdateResponse(BaseModel):
    ...
    response_policy: Optional[ResponsePolicy] = Field(default=None, alias="responsePolicy")
    __properties: ClassVar[List[str]] = ["header", "responsePolicy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of response_policy
        if self.response_policy:
            _dict['responsePolicy'] = self.response_policy.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responsePolicy": ResponsePolicy.from_dict(obj["responsePolicy"]) if obj.get("responsePolicy") is not None else None
        })
        return _obj
