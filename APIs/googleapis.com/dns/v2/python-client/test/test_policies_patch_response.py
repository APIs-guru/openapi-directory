...
class TestPoliciesPatchResponse(unittest.TestCase):
    """PoliciesPatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoliciesPatchResponse:
        """Test PoliciesPatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoliciesPatchResponse`
        """
        model = PoliciesPatchResponse()
        if include_optional:
    ...
    def testPoliciesPatchResponse(self):
        """Test PoliciesPatchResponse"""
