...
class TestResponsePolicyRulesListResponse(unittest.TestCase):
    """ResponsePolicyRulesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponsePolicyRulesListResponse:
        """Test ResponsePolicyRulesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponsePolicyRulesListResponse`
        """
        model = ResponsePolicyRulesListResponse()
        if include_optional:
            return ResponsePolicyRulesListResponse(
                ...
                response_policy_rules = [
                    openapi_client.models.response_policy_rule.ResponsePolicyRule(
    ...
    def testResponsePolicyRulesListResponse(self):
        """Test ResponsePolicyRulesListResponse"""
