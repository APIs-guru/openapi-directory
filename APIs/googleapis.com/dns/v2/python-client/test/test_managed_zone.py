...
class TestManagedZone(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ManagedZone:
        """Test ManagedZone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedZone`
        """
        model = ManagedZone()
        if include_optional:
            return ManagedZone(
