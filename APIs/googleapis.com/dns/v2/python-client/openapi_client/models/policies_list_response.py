...
class PoliciesListResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='dns#policiesListResponse', description="Type of resource.")
    ...
    policies: Optional[List[Policy]] = Field(default=None, description="The policy resources.")
    __properties: ClassVar[List[str]] = ["header", "kind", "nextPageToken", "policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'dns#policiesListResponse',
