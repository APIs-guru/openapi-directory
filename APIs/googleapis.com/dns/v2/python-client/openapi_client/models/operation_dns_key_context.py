...
class OperationDnsKeyContext(BaseModel):
    ...
    """ # noqa: E501
    new_value: Optional[DnsKey] = Field(default=None, alias="newValue")
    old_value: Optional[DnsKey] = Field(default=None, alias="oldValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newValue": DnsKey.from_dict(obj["newValue"]) if obj.get("newValue") is not None else None,
            "oldValue": DnsKey.from_dict(obj["oldValue"]) if obj.get("oldValue") is not None else None
        })
        return _obj
