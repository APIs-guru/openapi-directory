...
class ResponsePolicyRule(BaseModel):
    ...
    def behavior_validate_enum(cls, value):
        ...
        if value not in set(['BEHAVIOR_UNSPECIFIED', 'BYPASS_RESPONSE_POLICY']):
            raise ValueError("must be one of enum values ('BEHAVIOR_UNSPECIFIED', 'BYPASS_RESPONSE_POLICY')")
        return value
