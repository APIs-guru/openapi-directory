...
class ManagedZoneOperationsApi:
    ...
    def dns_managed_zone_operations_get(
        ...
        managed_zone: Annotated[StrictStr, Field(description="Identifies the managed zone addressed by this request.")],
        operation: Annotated[StrictStr, Field(description="Identifies the operation addressed by this request (ID of the operation).")],
        ...
        :type location: str
        :param managed_zone: Identifies the managed zone addressed by this request. (required)
        ...
        _param = self._dns_managed_zone_operations_get_serialize(
            project=project,
            location=location,
    ...
    @validate_call
    def dns_managed_zone_operations_get_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Identifies the project addressed by this request.")],
        location: Annotated[StrictStr, Field(description="Specifies the location of the resource. This information will be used for routing and will be part of the resource name.")],
        managed_zone: Annotated[StrictStr, Field(description="Identifies the managed zone addressed by this request.")],
    ...
    @validate_call
    def dns_managed_zone_operations_get_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Identifies the project addressed by this request.")],
        location: Annotated[StrictStr, Field(description="Specifies the location of the resource. This information will be used for routing and will be part of the resource name.")],
        managed_zone: Annotated[StrictStr, Field(description="Identifies the managed zone addressed by this request.")],
    ...
    def _dns_managed_zone_operations_get_serialize(
        self,
        project,
        location,
        managed_zone,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations/{operation}',
    ...
    def dns_managed_zone_operations_list(
        ...
        sort_by: Annotated[Optional[StrictStr], Field(description="Sorting criterion. The only supported values are START_TIME and ID.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type page_token: str
        :param sort_by: Sorting criterion. The only supported values are START_TIME and ID.
        :type sort_by: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._dns_managed_zone_operations_list_serialize(
            project=project,
            location=location,
            managed_zone=managed_zone,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagedZoneOperationsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dns_managed_zone_operations_list_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Identifies the project addressed by this request.")],
        location: Annotated[StrictStr, Field(description="Specifies the location of the resource. This information will be used for routing and will be part of the resource name.")],
        managed_zone: Annotated[StrictStr, Field(description="Identifies the managed zone addressed by this request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagedZoneOperationsListResponse]:
        """dns_managed_zone_operations_list
    ...
    @validate_call
    def dns_managed_zone_operations_list_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Identifies the project addressed by this request.")],
        location: Annotated[StrictStr, Field(description="Specifies the location of the resource. This information will be used for routing and will be part of the resource name.")],
        managed_zone: Annotated[StrictStr, Field(description="Identifies the managed zone addressed by this request.")],
    ...
    def _dns_managed_zone_operations_list_serialize(
        self,
        project,
        location,
        managed_zone,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
