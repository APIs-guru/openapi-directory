...
class RRSetRoutingPolicyWrrPolicy(BaseModel):
    ...
    kind: Optional[StrictStr] = 'dns#rRSetRoutingPolicyWrrPolicy'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [RRSetRoutingPolicyWrrPolicyWrrPolicyItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind") if obj.get("kind") is not None else 'dns#rRSetRoutingPolicyWrrPolicy'
        })
        return _obj
