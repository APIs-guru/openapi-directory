...
class ManagedZoneServiceDirectoryConfig(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = 'dns#managedZoneServiceDirectoryConfig'
    namespace: Optional[ManagedZoneServiceDirectoryConfigNamespace] = None
    __properties: ClassVar[List[str]] = ["kind", "namespace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'dns#managedZoneServiceDirectoryConfig',
            "namespace": ManagedZoneServiceDirectoryConfigNamespace.from_dict(obj["namespace"]) if obj.get("namespace") is not None else None
        })
        return _obj
