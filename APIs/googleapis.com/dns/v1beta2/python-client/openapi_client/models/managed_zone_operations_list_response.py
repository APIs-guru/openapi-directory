...
class ManagedZoneOperationsListResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='dns#managedZoneOperationsListResponse', description="Type of resource.")
    ...
    operations: Optional[List[Operation]] = Field(default=None, description="The operation resources.")
    __properties: ClassVar[List[str]] = ["header", "kind", "nextPageToken", "operations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'dns#managedZoneOperationsListResponse',
