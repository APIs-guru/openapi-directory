...
class ResponsePolicyRulesUpdateResponse(BaseModel):
    ...
    response_policy_rule: Optional[ResponsePolicyRule] = Field(default=None, alias="responsePolicyRule")
    __properties: ClassVar[List[str]] = ["header", "responsePolicyRule"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of response_policy_rule
        if self.response_policy_rule:
            _dict['responsePolicyRule'] = self.response_policy_rule.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responsePolicyRule": ResponsePolicyRule.from_dict(obj["responsePolicyRule"]) if obj.get("responsePolicyRule") is not None else None
        })
        return _obj
