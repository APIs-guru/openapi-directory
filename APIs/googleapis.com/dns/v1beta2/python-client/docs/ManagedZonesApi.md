...
------------- | ------------- | -------------
[**dns_managed_zones_create**](ManagedZonesApi.md#dns_managed_zones_create) | **POST** /dns/v1beta2/projects/{project}/managedZones | 
[**dns_managed_zones_delete**](ManagedZonesApi.md#dns_managed_zones_delete) | **DELETE** /dns/v1beta2/projects/{project}/managedZones/{managedZone} | 
[**dns_managed_zones_get**](ManagedZonesApi.md#dns_managed_zones_get) | **GET** /dns/v1beta2/projects/{project}/managedZones/{managedZone} | 
[**dns_managed_zones_get_iam_policy**](ManagedZonesApi.md#dns_managed_zones_get_iam_policy) | **POST** /dns/v1beta2/{resource}:getIamPolicy | 
[**dns_managed_zones_list**](ManagedZonesApi.md#dns_managed_zones_list) | **GET** /dns/v1beta2/projects/{project}/managedZones | 
[**dns_managed_zones_patch**](ManagedZonesApi.md#dns_managed_zones_patch) | **PATCH** /dns/v1beta2/projects/{project}/managedZones/{managedZone} | 
[**dns_managed_zones_set_iam_policy**](ManagedZonesApi.md#dns_managed_zones_set_iam_policy) | **POST** /dns/v1beta2/{resource}:setIamPolicy | 
[**dns_managed_zones_test_iam_permissions**](ManagedZonesApi.md#dns_managed_zones_test_iam_permissions) | **POST** /dns/v1beta2/{resource}:testIamPermissions | 
[**dns_managed_zones_update**](ManagedZonesApi.md#dns_managed_zones_update) | **PUT** /dns/v1beta2/projects/{project}/managedZones/{managedZone} | 
