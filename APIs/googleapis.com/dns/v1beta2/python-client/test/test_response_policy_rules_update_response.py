...
class TestResponsePolicyRulesUpdateResponse(unittest.TestCase):
    """ResponsePolicyRulesUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponsePolicyRulesUpdateResponse:
        """Test ResponsePolicyRulesUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponsePolicyRulesUpdateResponse`
        """
        model = ResponsePolicyRulesUpdateResponse()
        if include_optional:
    ...
    def testResponsePolicyRulesUpdateResponse(self):
        """Test ResponsePolicyRulesUpdateResponse"""
