...
class TestResourceRecordSetsListResponse(unittest.TestCase):
    """ResourceRecordSetsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceRecordSetsListResponse:
        """Test ResourceRecordSetsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceRecordSetsListResponse`
        """
        model = ResourceRecordSetsListResponse()
        if include_optional:
    ...
    def testResourceRecordSetsListResponse(self):
        """Test ResourceRecordSetsListResponse"""
