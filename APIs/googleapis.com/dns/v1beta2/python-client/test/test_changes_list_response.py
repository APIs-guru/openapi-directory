...
class TestChangesListResponse(unittest.TestCase):
    """ChangesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangesListResponse:
        """Test ChangesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangesListResponse`
        """
        model = ChangesListResponse()
        if include_optional:
    ...
    def testChangesListResponse(self):
        """Test ChangesListResponse"""
