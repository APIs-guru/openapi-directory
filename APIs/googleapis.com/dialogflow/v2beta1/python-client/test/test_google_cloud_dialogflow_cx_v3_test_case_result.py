...
class TestGoogleCloudDialogflowCxV3TestCaseResult(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TestCaseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TestCaseResult:
        """Test GoogleCloudDialogflowCxV3TestCaseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TestCaseResult`
        """
        model = GoogleCloudDialogflowCxV3TestCaseResult()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TestCaseResult(self):
        """Test GoogleCloudDialogflowCxV3TestCaseResult"""
