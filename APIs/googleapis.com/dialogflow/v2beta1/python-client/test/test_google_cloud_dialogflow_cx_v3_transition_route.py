...
class TestGoogleCloudDialogflowCxV3TransitionRoute(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TransitionRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TransitionRoute:
        """Test GoogleCloudDialogflowCxV3TransitionRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TransitionRoute`
        """
        model = GoogleCloudDialogflowCxV3TransitionRoute()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TransitionRoute(self):
        """Test GoogleCloudDialogflowCxV3TransitionRoute"""
