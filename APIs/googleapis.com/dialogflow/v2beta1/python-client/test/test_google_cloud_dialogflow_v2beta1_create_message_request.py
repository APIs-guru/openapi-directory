...
class TestGoogleCloudDialogflowV2beta1CreateMessageRequest(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1CreateMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1CreateMessageRequest:
        """Test GoogleCloudDialogflowV2beta1CreateMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1CreateMessageRequest`
        """
        model = GoogleCloudDialogflowV2beta1CreateMessageRequest()
        if include_optional:
            return GoogleCloudDialogflowV2beta1CreateMessageRequest(
                message = openapi_client.models.google_cloud_dialogflow_v2beta1_message.GoogleCloudDialogflowV2beta1Message(
                    content = '', 
                    create_time = '', 
                    language_code = '', 
    ...
    def testGoogleCloudDialogflowV2beta1CreateMessageRequest(self):
        """Test GoogleCloudDialogflowV2beta1CreateMessageRequest"""
