...
class TestGoogleCloudDialogflowV2beta1BatchCreateMessagesResponse(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse:
        """Test GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse`
        """
        model = GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1BatchCreateMessagesResponse(self):
        """Test GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse"""
