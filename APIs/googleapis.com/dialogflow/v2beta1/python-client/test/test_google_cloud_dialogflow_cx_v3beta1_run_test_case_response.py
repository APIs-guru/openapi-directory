...
class TestGoogleCloudDialogflowCxV3beta1RunTestCaseResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1RunTestCaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1RunTestCaseResponse:
        """Test GoogleCloudDialogflowCxV3beta1RunTestCaseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1RunTestCaseResponse`
        """
        model = GoogleCloudDialogflowCxV3beta1RunTestCaseResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3beta1RunTestCaseResponse(
                result = openapi_client.models.google_cloud_dialogflow_cx_v3beta1_test_case_result.GoogleCloudDialogflowCxV3beta1TestCaseResult(
                    conversation_turns = [
    ...
    def testGoogleCloudDialogflowCxV3beta1RunTestCaseResponse(self):
        """Test GoogleCloudDialogflowCxV3beta1RunTestCaseResponse"""
