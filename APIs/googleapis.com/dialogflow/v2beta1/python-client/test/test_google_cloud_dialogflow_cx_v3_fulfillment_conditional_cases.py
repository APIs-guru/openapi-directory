...
class TestGoogleCloudDialogflowCxV3FulfillmentConditionalCases(unittest.TestCase):
    """GoogleCloudDialogflowCxV3FulfillmentConditionalCases unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3FulfillmentConditionalCases:
        """Test GoogleCloudDialogflowCxV3FulfillmentConditionalCases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3FulfillmentConditionalCases`
        """
        model = GoogleCloudDialogflowCxV3FulfillmentConditionalCases()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3FulfillmentConditionalCases(self):
        """Test GoogleCloudDialogflowCxV3FulfillmentConditionalCases"""
