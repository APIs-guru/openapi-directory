...
class TestGoogleCloudDialogflowV2beta1TextToSpeechSettings(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1TextToSpeechSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1TextToSpeechSettings:
        """Test GoogleCloudDialogflowV2beta1TextToSpeechSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1TextToSpeechSettings`
        """
        model = GoogleCloudDialogflowV2beta1TextToSpeechSettings()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1TextToSpeechSettings(self):
        """Test GoogleCloudDialogflowV2beta1TextToSpeechSettings"""
