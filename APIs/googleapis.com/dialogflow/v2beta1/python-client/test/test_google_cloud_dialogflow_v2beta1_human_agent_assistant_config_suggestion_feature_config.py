...
class TestGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig:
        """Test GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig`
        """
        model = GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig(self):
        """Test GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig"""
