...
class TestGoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest:
        """Test GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest`
        """
        model = GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest()
        if include_optional:
            return GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest(
                conversation_profile = openapi_client.models.google_cloud_dialogflow_v2beta1_conversation_profile.GoogleCloudDialogflowV2beta1ConversationProfile(
                ...
                latest_message = '',
                max_context_size = 56,
                stateless_conversation = openapi_client.models.google_cloud_dialogflow_v2beta1_generate_stateless_summary_request_minimal_conversation.GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequestMinimalConversation(
                    messages = [
                        openapi_client.models.google_cloud_dialogflow_v2beta1_message.GoogleCloudDialogflowV2beta1Message(
                            content = '', 
                            create_time = '', 
                            language_code = '', 
    ...
    def testGoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest(self):
        """Test GoogleCloudDialogflowV2beta1GenerateStatelessSummaryRequest"""
