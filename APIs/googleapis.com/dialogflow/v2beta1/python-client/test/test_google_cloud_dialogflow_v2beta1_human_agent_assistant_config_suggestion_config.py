...
class TestGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig:
        """Test GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig`
        """
        model = GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig(self):
        """Test GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig"""
