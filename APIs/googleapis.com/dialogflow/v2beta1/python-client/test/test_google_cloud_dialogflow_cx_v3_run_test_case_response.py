...
class TestGoogleCloudDialogflowCxV3RunTestCaseResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3RunTestCaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3RunTestCaseResponse:
        """Test GoogleCloudDialogflowCxV3RunTestCaseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3RunTestCaseResponse`
        """
        model = GoogleCloudDialogflowCxV3RunTestCaseResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3RunTestCaseResponse(
                result = openapi_client.models.google_cloud_dialogflow_cx_v3_test_case_result.GoogleCloudDialogflowCxV3TestCaseResult(
                    conversation_turns = [
    ...
    def testGoogleCloudDialogflowCxV3RunTestCaseResponse(self):
        """Test GoogleCloudDialogflowCxV3RunTestCaseResponse"""
