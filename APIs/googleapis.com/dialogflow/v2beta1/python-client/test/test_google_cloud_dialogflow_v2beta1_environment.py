...
class TestGoogleCloudDialogflowV2beta1Environment(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1Environment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1Environment:
        """Test GoogleCloudDialogflowV2beta1Environment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1Environment`
        """
        model = GoogleCloudDialogflowV2beta1Environment()
        if include_optional:
            return GoogleCloudDialogflowV2beta1Environment(
                agent_version = '',
                description = '',
    ...
    def testGoogleCloudDialogflowV2beta1Environment(self):
        """Test GoogleCloudDialogflowV2beta1Environment"""
