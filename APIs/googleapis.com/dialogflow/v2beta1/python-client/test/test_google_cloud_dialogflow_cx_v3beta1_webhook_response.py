...
class TestGoogleCloudDialogflowCxV3beta1WebhookResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1WebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1WebhookResponse:
        """Test GoogleCloudDialogflowCxV3beta1WebhookResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1WebhookResponse`
        """
        model = GoogleCloudDialogflowCxV3beta1WebhookResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3beta1WebhookResponse(
                fulfillment_response = openapi_client.models.google_cloud_dialogflow_cx_v3beta1_webhook_response_fulfillment_response.GoogleCloudDialogflowCxV3beta1WebhookResponseFulfillmentResponse(
    ...
    def testGoogleCloudDialogflowCxV3beta1WebhookResponse(self):
        """Test GoogleCloudDialogflowCxV3beta1WebhookResponse"""
