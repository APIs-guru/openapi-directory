...
class TestGoogleCloudDialogflowV2beta1IntentMessageRbmCardContent(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent:
        """Test GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent`
        """
        model = GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1IntentMessageRbmCardContent(self):
        """Test GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent"""
