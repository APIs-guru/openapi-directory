...
class TestGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase:
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase`
        """
        model = GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase(self):
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase"""
