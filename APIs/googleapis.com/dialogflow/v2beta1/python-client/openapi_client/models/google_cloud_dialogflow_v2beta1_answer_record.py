...
class GoogleCloudDialogflowV2beta1AnswerRecord(BaseModel):
    """
    ...
    """ # noqa: E501
    agent_assistant_record: Optional[GoogleCloudDialogflowV2beta1AgentAssistantRecord] = Field(default=None, alias="agentAssistantRecord")
    answer_feedback: Optional[GoogleCloudDialogflowV2beta1AnswerFeedback] = Field(default=None, alias="answerFeedback")
    name: Optional[StrictStr] = Field(default=None, description="The unique identifier of this answer record. Required for AnswerRecords.UpdateAnswerRecord method. Format: `projects//locations//answerRecords/`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agentAssistantRecord": GoogleCloudDialogflowV2beta1AgentAssistantRecord.from_dict(obj["agentAssistantRecord"]) if obj.get("agentAssistantRecord") is not None else None,
            "answerFeedback": GoogleCloudDialogflowV2beta1AnswerFeedback.from_dict(obj["answerFeedback"]) if obj.get("answerFeedback") is not None else None,
            "name": obj.get("name")
        })
        return _obj
