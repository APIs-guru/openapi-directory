...
class GoogleCloudDialogflowCxV3beta1WebhookResponse(BaseModel):
    ...
    """ # noqa: E501
    fulfillment_response: Optional[GoogleCloudDialogflowCxV3beta1WebhookResponseFulfillmentResponse] = Field(default=None, alias="fulfillmentResponse")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fulfillmentResponse": GoogleCloudDialogflowCxV3beta1WebhookResponseFulfillmentResponse.from_dict(obj["fulfillmentResponse"]) if obj.get("fulfillmentResponse") is not None else None,
