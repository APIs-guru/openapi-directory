...
class GoogleCloudDialogflowV2beta1SuggestSmartRepliesResponse(BaseModel):
    ...
    smart_reply_answers: Optional[List[GoogleCloudDialogflowV2beta1SmartReplyAnswer]] = Field(default=None, description="Output only. Multiple reply options provided by smart reply service. The order is based on the rank of the model prediction. The maximum number of the returned replies is set in SmartReplyConfig.", alias="smartReplyAnswers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "smartReplyAnswers": [GoogleCloudDialogflowV2beta1SmartReplyAnswer.from_dict(_item) for _item in obj["smartReplyAnswers"]] if obj.get("smartReplyAnswers") is not None else None
        })
        return _obj
