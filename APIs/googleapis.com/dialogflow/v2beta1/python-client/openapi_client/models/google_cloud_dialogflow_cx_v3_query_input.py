...
class GoogleCloudDialogflowCxV3QueryInput(BaseModel):
    ...
    """ # noqa: E501
    audio: Optional[GoogleCloudDialogflowCxV3AudioInput] = None
    dtmf: Optional[GoogleCloudDialogflowCxV3DtmfInput] = None
    event: Optional[GoogleCloudDialogflowCxV3EventInput] = None
    intent: Optional[GoogleCloudDialogflowCxV3IntentInput] = None
    ...
    text: Optional[GoogleCloudDialogflowCxV3TextInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audio": GoogleCloudDialogflowCxV3AudioInput.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
            "dtmf": GoogleCloudDialogflowCxV3DtmfInput.from_dict(obj["dtmf"]) if obj.get("dtmf") is not None else None,
            "event": GoogleCloudDialogflowCxV3EventInput.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "intent": GoogleCloudDialogflowCxV3IntentInput.from_dict(obj["intent"]) if obj.get("intent") is not None else None,
            "languageCode": obj.get("languageCode"),
            "text": GoogleCloudDialogflowCxV3TextInput.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
