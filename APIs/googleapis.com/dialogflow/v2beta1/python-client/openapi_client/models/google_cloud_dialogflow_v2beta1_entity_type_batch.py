...
class GoogleCloudDialogflowV2beta1EntityTypeBatch(BaseModel):
    """
    This message is a wrapper around a collection of entity types.
    """ # noqa: E501
    entity_types: Optional[List[GoogleCloudDialogflowV2beta1EntityType]] = Field(default=None, description="A collection of entity types.", alias="entityTypes")
