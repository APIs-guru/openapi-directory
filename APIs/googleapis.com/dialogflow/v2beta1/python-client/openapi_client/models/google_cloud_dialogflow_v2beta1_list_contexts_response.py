...
class GoogleCloudDialogflowV2beta1ListContextsResponse(BaseModel):
    """
    The response message for Contexts.ListContexts.
    """ # noqa: E501
    contexts: Optional[List[GoogleCloudDialogflowV2beta1Context]] = Field(default=None, description="The list of contexts. There will be a maximum number of items returned based on the page_size field in the request.")
