...
class GoogleCloudDialogflowV2beta1BatchDeleteIntentsRequest(BaseModel):
    """
    The request message for Intents.BatchDeleteIntents.
    """ # noqa: E501
    intents: Optional[List[GoogleCloudDialogflowV2beta1Intent]] = Field(default=None, description="Required. The collection of intents to delete. Only intent `name` must be filled in.")
