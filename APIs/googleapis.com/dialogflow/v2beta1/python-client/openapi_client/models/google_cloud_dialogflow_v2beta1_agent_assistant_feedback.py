...
class GoogleCloudDialogflowV2beta1AgentAssistantFeedback(BaseModel):
    """
    ...
    knowledge_search_feedback: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedbackKnowledgeSearchFeedback] = Field(default=None, alias="knowledgeSearchFeedback")
    summarization_feedback: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedbackSummarizationFeedback] = Field(default=None, alias="summarizationFeedback")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "knowledgeSearchFeedback": GoogleCloudDialogflowV2beta1AgentAssistantFeedbackKnowledgeSearchFeedback.from_dict(obj["knowledgeSearchFeedback"]) if obj.get("knowledgeSearchFeedback") is not None else None,
            "summarizationFeedback": GoogleCloudDialogflowV2beta1AgentAssistantFeedbackSummarizationFeedback.from_dict(obj["summarizationFeedback"]) if obj.get("summarizationFeedback") is not None else None
        })
        return _obj
