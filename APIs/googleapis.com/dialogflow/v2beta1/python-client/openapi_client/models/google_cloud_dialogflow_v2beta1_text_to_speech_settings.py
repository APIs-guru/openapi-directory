...
class GoogleCloudDialogflowV2beta1TextToSpeechSettings(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1TextToSpeechSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1TextToSpeechSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "synthesizeSpeechConfigs": dict(
                (_k, GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig.from_dict(_v))
