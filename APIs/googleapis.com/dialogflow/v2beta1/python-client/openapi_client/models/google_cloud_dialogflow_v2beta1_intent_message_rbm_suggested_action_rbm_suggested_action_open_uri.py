...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionOpenUri(BaseModel):
    """
    ...
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="Required. The uri to open on the user device")
