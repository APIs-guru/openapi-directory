...
class GoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse(BaseModel):
    ...
    faq_answers: Optional[List[GoogleCloudDialogflowV2beta1FaqAnswer]] = Field(default=None, description="Output only. Answers extracted from FAQ documents.", alias="faqAnswers")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "faqAnswers": [GoogleCloudDialogflowV2beta1FaqAnswer.from_dict(_item) for _item in obj["faqAnswers"]] if obj.get("faqAnswers") is not None else None,
