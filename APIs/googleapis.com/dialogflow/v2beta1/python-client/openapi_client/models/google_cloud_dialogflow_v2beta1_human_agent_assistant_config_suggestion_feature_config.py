...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig(BaseModel):
    """
    Config for suggestion features.
    """ # noqa: E501
    conversation_model_config: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfig] = Field(default=None, alias="conversationModelConfig")
    conversation_process_config: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationProcessConfig] = Field(default=None, alias="conversationProcessConfig")
    ...
    enable_event_based_suggestion: Optional[StrictBool] = Field(default=None, description="Automatically iterates all participants and tries to compile suggestions. Supported features: ARTICLE_SUGGESTION, FAQ, DIALOGFLOW_ASSIST, ENTITY_EXTRACTION, KNOWLEDGE_ASSIST.", alias="enableEventBasedSuggestion")
    query_config: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfig] = Field(default=None, alias="queryConfig")
    suggestion_feature: Optional[GoogleCloudDialogflowV2beta1SuggestionFeature] = Field(default=None, alias="suggestionFeature")
    suggestion_trigger_settings: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionTriggerSettings] = Field(default=None, alias="suggestionTriggerSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversationModelConfig": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfig.from_dict(obj["conversationModelConfig"]) if obj.get("conversationModelConfig") is not None else None,
            "conversationProcessConfig": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationProcessConfig.from_dict(obj["conversationProcessConfig"]) if obj.get("conversationProcessConfig") is not None else None,
            ...
            "queryConfig": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfig.from_dict(obj["queryConfig"]) if obj.get("queryConfig") is not None else None,
            "suggestionFeature": GoogleCloudDialogflowV2beta1SuggestionFeature.from_dict(obj["suggestionFeature"]) if obj.get("suggestionFeature") is not None else None,
            "suggestionTriggerSettings": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionTriggerSettings.from_dict(obj["suggestionTriggerSettings"]) if obj.get("suggestionTriggerSettings") is not None else None
        })
        return _obj
