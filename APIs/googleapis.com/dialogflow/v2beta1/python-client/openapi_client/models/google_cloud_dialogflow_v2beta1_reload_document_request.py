...
class GoogleCloudDialogflowV2beta1ReloadDocumentRequest(BaseModel):
    """
    Request message for Documents.ReloadDocument.
    """ # noqa: E501
    gcs_source: Optional[GoogleCloudDialogflowV2beta1GcsSource] = Field(default=None, alias="gcsSource")
    ...
    __properties: ClassVar[List[str]] = ["gcsSource", "importGcsCustomMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gcsSource": GoogleCloudDialogflowV2beta1GcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None,
