...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfig(BaseModel):
    """
    ...
    context_filter_settings: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings] = Field(default=None, alias="contextFilterSettings")
    dialogflow_query_source: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource] = Field(default=None, alias="dialogflowQuerySource")
    document_query_source: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource] = Field(default=None, alias="documentQuerySource")
    knowledge_base_query_source: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource] = Field(default=None, alias="knowledgeBaseQuerySource")
    ...
    sections: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigSections] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contextFilterSettings": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings.from_dict(obj["contextFilterSettings"]) if obj.get("contextFilterSettings") is not None else None,
            "dialogflowQuerySource": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource.from_dict(obj["dialogflowQuerySource"]) if obj.get("dialogflowQuerySource") is not None else None,
            "documentQuerySource": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource.from_dict(obj["documentQuerySource"]) if obj.get("documentQuerySource") is not None else None,
            "knowledgeBaseQuerySource": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource.from_dict(obj["knowledgeBaseQuerySource"]) if obj.get("knowledgeBaseQuerySource") is not None else None,
            "maxResults": obj.get("maxResults"),
            "sections": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigSections.from_dict(obj["sections"]) if obj.get("sections") is not None else None
        })
        return _obj
