...
class GoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse(BaseModel):
    """
    ...
    session_entity_types: Optional[List[GoogleCloudDialogflowV2beta1SessionEntityType]] = Field(default=None, description="The list of session entity types. There will be a maximum number of items returned based on the page_size field in the request.", alias="sessionEntityTypes")
