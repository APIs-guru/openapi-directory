...
class GoogleCloudDialogflowV2beta1Sentiment(BaseModel):
    ...
    """ # noqa: E501
    magnitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A non-negative number in the [0, +inf) range, which represents the absolute magnitude of sentiment, regardless of score (positive or negative).")
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sentiment score between -1.0 (negative sentiment) and 1.0 (positive sentiment).")
