...
class GoogleCloudDialogflowV2beta1ConversationProfile(BaseModel):
    """
    Defines the services to connect to incoming Dialogflow conversations.
    """ # noqa: E501
    automated_agent_config: Optional[GoogleCloudDialogflowV2beta1AutomatedAgentConfig] = Field(default=None, alias="automatedAgentConfig")
    ...
    human_agent_assistant_config: Optional[GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig] = Field(default=None, alias="humanAgentAssistantConfig")
    human_agent_handoff_config: Optional[GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig] = Field(default=None, alias="humanAgentHandoffConfig")
    ...
    logging_config: Optional[GoogleCloudDialogflowV2beta1LoggingConfig] = Field(default=None, alias="loggingConfig")
    ...
    new_message_event_notification_config: Optional[GoogleCloudDialogflowV2beta1NotificationConfig] = Field(default=None, alias="newMessageEventNotificationConfig")
    notification_config: Optional[GoogleCloudDialogflowV2beta1NotificationConfig] = Field(default=None, alias="notificationConfig")
    ...
    stt_config: Optional[GoogleCloudDialogflowV2beta1SpeechToTextConfig] = Field(default=None, alias="sttConfig")
    ...
    tts_config: Optional[GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig] = Field(default=None, alias="ttsConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "automatedAgentConfig": GoogleCloudDialogflowV2beta1AutomatedAgentConfig.from_dict(obj["automatedAgentConfig"]) if obj.get("automatedAgentConfig") is not None else None,
            "createTime": obj.get("createTime"),
            "displayName": obj.get("displayName"),
            "humanAgentAssistantConfig": GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig.from_dict(obj["humanAgentAssistantConfig"]) if obj.get("humanAgentAssistantConfig") is not None else None,
            "humanAgentHandoffConfig": GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig.from_dict(obj["humanAgentHandoffConfig"]) if obj.get("humanAgentHandoffConfig") is not None else None,
            "languageCode": obj.get("languageCode"),
            "loggingConfig": GoogleCloudDialogflowV2beta1LoggingConfig.from_dict(obj["loggingConfig"]) if obj.get("loggingConfig") is not None else None,
            "name": obj.get("name"),
            "newMessageEventNotificationConfig": GoogleCloudDialogflowV2beta1NotificationConfig.from_dict(obj["newMessageEventNotificationConfig"]) if obj.get("newMessageEventNotificationConfig") is not None else None,
            "notificationConfig": GoogleCloudDialogflowV2beta1NotificationConfig.from_dict(obj["notificationConfig"]) if obj.get("notificationConfig") is not None else None,
            "securitySettings": obj.get("securitySettings"),
            "sttConfig": GoogleCloudDialogflowV2beta1SpeechToTextConfig.from_dict(obj["sttConfig"]) if obj.get("sttConfig") is not None else None,
            "timeZone": obj.get("timeZone"),
            "ttsConfig": GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig.from_dict(obj["ttsConfig"]) if obj.get("ttsConfig") is not None else None,
