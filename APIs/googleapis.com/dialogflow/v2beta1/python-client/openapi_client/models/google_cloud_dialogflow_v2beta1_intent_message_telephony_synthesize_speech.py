...
class GoogleCloudDialogflowV2beta1IntentMessageTelephonySynthesizeSpeech(BaseModel):
    ...
    """ # noqa: E501
    ssml: Optional[StrictStr] = Field(default=None, description="The SSML to be synthesized. For more information, see [SSML](https://developers.google.com/actions/reference/ssml).")
