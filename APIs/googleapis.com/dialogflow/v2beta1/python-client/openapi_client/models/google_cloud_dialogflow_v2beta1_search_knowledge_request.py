...
class GoogleCloudDialogflowV2beta1SearchKnowledgeRequest(BaseModel):
    """
    ...
    query: Optional[GoogleCloudDialogflowV2beta1TextInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": GoogleCloudDialogflowV2beta1TextInput.from_dict(obj["query"]) if obj.get("query") is not None else None,
