...
class GoogleCloudDialogflowV2beta1IntentBatch(BaseModel):
    """
    This message is a wrapper around a collection of intents.
    """ # noqa: E501
    intents: Optional[List[GoogleCloudDialogflowV2beta1Intent]] = Field(default=None, description="A collection of intents.")
