...
class GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseMediaObject(BaseModel):
    """
    ...
    icon: Optional[GoogleCloudDialogflowV2beta1IntentMessageImage] = None
    large_image: Optional[GoogleCloudDialogflowV2beta1IntentMessageImage] = Field(default=None, alias="largeImage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": GoogleCloudDialogflowV2beta1IntentMessageImage.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "largeImage": GoogleCloudDialogflowV2beta1IntentMessageImage.from_dict(obj["largeImage"]) if obj.get("largeImage") is not None else None,
            "name": obj.get("name")
        })
        return _obj
