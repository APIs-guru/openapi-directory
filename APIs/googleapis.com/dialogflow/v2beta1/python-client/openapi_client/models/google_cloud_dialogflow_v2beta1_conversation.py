...
class GoogleCloudDialogflowV2beta1Conversation(BaseModel):
    """
    ...
    phone_number: Optional[GoogleCloudDialogflowV2beta1ConversationPhoneNumber] = Field(default=None, alias="phoneNumber")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "phoneNumber": GoogleCloudDialogflowV2beta1ConversationPhoneNumber.from_dict(obj["phoneNumber"]) if obj.get("phoneNumber") is not None else None,
