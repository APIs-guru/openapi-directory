...
class GoogleCloudDialogflowV2beta1AnswerFeedback(BaseModel):
    """
    Represents feedback the customer has about the quality & correctness of a certain answer in a conversation.
    """ # noqa: E501
    agent_assistant_detail_feedback: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedback] = Field(default=None, alias="agentAssistantDetailFeedback")
    click_time: Optional[StrictStr] = Field(default=None, description="Time when the answer/item was clicked.", alias="clickTime")
    clicked: Optional[StrictBool] = Field(default=None, description="Indicates whether the answer/item was clicked by the human agent or not. Default to false. For knowledge search, the answer record is considered to be clicked if the answer was copied or any URI was clicked.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agentAssistantDetailFeedback": GoogleCloudDialogflowV2beta1AgentAssistantFeedback.from_dict(obj["agentAssistantDetailFeedback"]) if obj.get("agentAssistantDetailFeedback") is not None else None,
