...
class GoogleCloudDialogflowV2beta1CompileSuggestionResponse(BaseModel):
    """
    The response message for Participants.CompileSuggestion.
    """ # noqa: E501
    context_size: Optional[StrictInt] = Field(default=None, description="Number of messages prior to and including latest_message to compile the suggestion. It may be smaller than the CompileSuggestionRequest.context_size field in the request if there aren't that many messages in the conversation.", alias="contextSize")
    ...
    suggestion: Optional[GoogleCloudDialogflowV2beta1Suggestion] = None
    __properties: ClassVar[List[str]] = ["contextSize", "latestMessage", "suggestion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestion": GoogleCloudDialogflowV2beta1Suggestion.from_dict(obj["suggestion"]) if obj.get("suggestion") is not None else None
        })
        return _obj
