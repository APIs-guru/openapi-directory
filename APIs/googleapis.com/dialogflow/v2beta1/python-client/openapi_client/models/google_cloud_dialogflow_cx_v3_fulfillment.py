...
class GoogleCloudDialogflowCxV3Fulfillment(BaseModel):
    ...
    conditional_cases: Optional[List[GoogleCloudDialogflowCxV3FulfillmentConditionalCases]] = Field(default=None, description="Conditional cases for this fulfillment.", alias="conditionalCases")
    ...
    messages: Optional[List[GoogleCloudDialogflowCxV3ResponseMessage]] = Field(default=None, description="The list of rich message responses to present to the user.")
    ...
    set_parameter_actions: Optional[List[GoogleCloudDialogflowCxV3FulfillmentSetParameterAction]] = Field(default=None, description="Set parameter values before executing the webhook.", alias="setParameterActions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditionalCases": [GoogleCloudDialogflowCxV3FulfillmentConditionalCases.from_dict(_item) for _item in obj["conditionalCases"]] if obj.get("conditionalCases") is not None else None,
            ...
            "setParameterActions": [GoogleCloudDialogflowCxV3FulfillmentSetParameterAction.from_dict(_item) for _item in obj["setParameterActions"]] if obj.get("setParameterActions") is not None else None,
            "tag": obj.get("tag"),
