...
class GoogleCloudDialogflowCxV3beta1WebhookRequest(BaseModel):
    ...
    fulfillment_info: Optional[GoogleCloudDialogflowCxV3beta1WebhookRequestFulfillmentInfo] = Field(default=None, alias="fulfillmentInfo")
    intent_info: Optional[GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo] = Field(default=None, alias="intentInfo")
    ...
    messages: Optional[List[GoogleCloudDialogflowCxV3beta1ResponseMessage]] = Field(default=None, description="The list of rich message responses to present to the user. Webhook can choose to append or replace this list in WebhookResponse.fulfillment_response;")
    page_info: Optional[GoogleCloudDialogflowCxV3beta1PageInfo] = Field(default=None, alias="pageInfo")
    payload: Optional[Dict[str, Any]] = Field(default=None, description="Custom data set in QueryParameters.payload.")
    sentiment_analysis_result: Optional[GoogleCloudDialogflowCxV3beta1WebhookRequestSentimentAnalysisResult] = Field(default=None, alias="sentimentAnalysisResult")
    session_info: Optional[GoogleCloudDialogflowCxV3beta1SessionInfo] = Field(default=None, alias="sessionInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfillmentInfo": GoogleCloudDialogflowCxV3beta1WebhookRequestFulfillmentInfo.from_dict(obj["fulfillmentInfo"]) if obj.get("fulfillmentInfo") is not None else None,
            "intentInfo": GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo.from_dict(obj["intentInfo"]) if obj.get("intentInfo") is not None else None,
            ...
            "pageInfo": GoogleCloudDialogflowCxV3beta1PageInfo.from_dict(obj["pageInfo"]) if obj.get("pageInfo") is not None else None,
            "payload": obj.get("payload"),
            "sentimentAnalysisResult": GoogleCloudDialogflowCxV3beta1WebhookRequestSentimentAnalysisResult.from_dict(obj["sentimentAnalysisResult"]) if obj.get("sentimentAnalysisResult") is not None else None,
            "sessionInfo": GoogleCloudDialogflowCxV3beta1SessionInfo.from_dict(obj["sessionInfo"]) if obj.get("sessionInfo") is not None else None,
            "text": obj.get("text"),
