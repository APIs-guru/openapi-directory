...
class GoogleCloudDialogflowV2beta1BatchUpdateEntitiesRequest(BaseModel):
    """
    The request message for EntityTypes.BatchUpdateEntities.
    """ # noqa: E501
    entities: Optional[List[GoogleCloudDialogflowV2beta1EntityTypeEntity]] = Field(default=None, description="Required. The entities to update or create.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1BatchUpdateEntitiesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1BatchUpdateEntitiesRequest from a dict"""
        if obj is None:
            return None
