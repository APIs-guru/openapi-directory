...
class GoogleCloudDialogflowV2beta1BatchCreateMessagesResponse(BaseModel):
    """
    The request message for Conversations.BatchCreateMessagesResponse.
    """ # noqa: E501
    messages: Optional[List[GoogleCloudDialogflowV2beta1Message]] = Field(default=None, description="Messages created.")
