...
class GoogleCloudDialogflowCxV3ResponseMessageMixedAudio(BaseModel):
    ...
    """ # noqa: E501
    segments: Optional[List[GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment]] = Field(default=None, description="Segments this audio response is composed of.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segments": [GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
