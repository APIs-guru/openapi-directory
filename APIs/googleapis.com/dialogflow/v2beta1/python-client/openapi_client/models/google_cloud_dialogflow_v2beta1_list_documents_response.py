...
class GoogleCloudDialogflowV2beta1ListDocumentsResponse(BaseModel):
    """
    Response message for Documents.ListDocuments.
    """ # noqa: E501
    documents: Optional[List[GoogleCloudDialogflowV2beta1Document]] = Field(default=None, description="The list of documents.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [GoogleCloudDialogflowV2beta1Document.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None,
