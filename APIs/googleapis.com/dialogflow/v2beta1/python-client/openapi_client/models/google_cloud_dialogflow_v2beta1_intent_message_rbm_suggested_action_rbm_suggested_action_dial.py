...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionDial(BaseModel):
    """
    Opens the user's default dialer app with the specified phone number but does not dial automatically.
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Required. The phone number to fill in the default dialer app. This field should be in [E.164](https://en.wikipedia.org/wiki/E.164) format. An example of a correctly formatted phone number: +15556767888.", alias="phoneNumber")
