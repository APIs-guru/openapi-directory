...
class GoogleCloudDialogflowV3alpha1ConversationSignals(BaseModel):
    ...
    """ # noqa: E501
    turn_signals: Optional[GoogleCloudDialogflowV3alpha1TurnSignals] = Field(default=None, alias="turnSignals")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "turnSignals": GoogleCloudDialogflowV3alpha1TurnSignals.from_dict(obj["turnSignals"]) if obj.get("turnSignals") is not None else None
        })
        return _obj
