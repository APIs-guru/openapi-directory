...
class GoogleCloudDialogflowV2beta1OutputAudioConfig(BaseModel):
    """
    ...
    synthesize_speech_config: Optional[GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig] = Field(default=None, alias="synthesizeSpeechConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "synthesizeSpeechConfig": GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig.from_dict(obj["synthesizeSpeechConfig"]) if obj.get("synthesizeSpeechConfig") is not None else None
        })
        return _obj
