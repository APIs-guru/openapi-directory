...
class GoogleCloudDialogflowCxV3beta1BatchRunTestCasesMetadata(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[GoogleCloudDialogflowCxV3beta1TestError]] = Field(default=None, description="The test errors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [GoogleCloudDialogflowCxV3beta1TestError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
