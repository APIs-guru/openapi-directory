...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig(BaseModel):
    """
    The configuration used for human agent side Dialogflow assist suggestion.
    """ # noqa: E501
    agent: Optional[StrictStr] = Field(default=None, description="Optional. The name of a dialogflow virtual agent used for intent detection and suggestion triggered by human agent. Format: `projects//locations//agent`.")
