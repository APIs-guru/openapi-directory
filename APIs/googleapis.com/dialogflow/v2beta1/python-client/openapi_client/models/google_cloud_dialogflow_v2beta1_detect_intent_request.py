...
class GoogleCloudDialogflowV2beta1DetectIntentRequest(BaseModel):
    """
    ...
    query_input: Optional[GoogleCloudDialogflowV2beta1QueryInput] = Field(default=None, alias="queryInput")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryInput": GoogleCloudDialogflowV2beta1QueryInput.from_dict(obj["queryInput"]) if obj.get("queryInput") is not None else None,
