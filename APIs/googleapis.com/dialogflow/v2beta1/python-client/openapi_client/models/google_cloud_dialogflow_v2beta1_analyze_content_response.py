...
class GoogleCloudDialogflowV2beta1AnalyzeContentResponse(BaseModel):
    """
    The response message for Participants.AnalyzeContent.
    """ # noqa: E501
    automated_agent_reply: Optional[GoogleCloudDialogflowV2beta1AutomatedAgentReply] = Field(default=None, alias="automatedAgentReply")
    dtmf_parameters: Optional[GoogleCloudDialogflowV2beta1DtmfParameters] = Field(default=None, alias="dtmfParameters")
    end_user_suggestion_results: Optional[List[GoogleCloudDialogflowV2beta1SuggestionResult]] = Field(default=None, description="The suggestions for end user. The order is the same as HumanAgentAssistantConfig.SuggestionConfig.feature_configs of HumanAgentAssistantConfig.end_user_suggestion_config. Same as human_agent_suggestion_results, any failure of Agent Assist features will not lead to the overall failure of an AnalyzeContent API call. Instead, the features will fail silently with the error field set in the corresponding SuggestionResult.", alias="endUserSuggestionResults")
    human_agent_suggestion_results: Optional[List[GoogleCloudDialogflowV2beta1SuggestionResult]] = Field(default=None, description="The suggestions for most recent human agent. The order is the same as HumanAgentAssistantConfig.SuggestionConfig.feature_configs of HumanAgentAssistantConfig.human_agent_suggestion_config. Note that any failure of Agent Assist features will not lead to the overall failure of an AnalyzeContent API call. Instead, the features will fail silently with the error field set in the corresponding SuggestionResult.", alias="humanAgentSuggestionResults")
    message: Optional[GoogleCloudDialogflowV2beta1Message] = None
    reply_audio: Optional[GoogleCloudDialogflowV2beta1OutputAudio] = Field(default=None, alias="replyAudio")
    reply_text: Optional[StrictStr] = Field(default=None, description="Output only. The output text content. This field is set if the automated agent responded with text to show to the user.", alias="replyText")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "automatedAgentReply": GoogleCloudDialogflowV2beta1AutomatedAgentReply.from_dict(obj["automatedAgentReply"]) if obj.get("automatedAgentReply") is not None else None,
            "dtmfParameters": GoogleCloudDialogflowV2beta1DtmfParameters.from_dict(obj["dtmfParameters"]) if obj.get("dtmfParameters") is not None else None,
            "endUserSuggestionResults": [GoogleCloudDialogflowV2beta1SuggestionResult.from_dict(_item) for _item in obj["endUserSuggestionResults"]] if obj.get("endUserSuggestionResults") is not None else None,
            "humanAgentSuggestionResults": [GoogleCloudDialogflowV2beta1SuggestionResult.from_dict(_item) for _item in obj["humanAgentSuggestionResults"]] if obj.get("humanAgentSuggestionResults") is not None else None,
            "message": GoogleCloudDialogflowV2beta1Message.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "replyAudio": GoogleCloudDialogflowV2beta1OutputAudio.from_dict(obj["replyAudio"]) if obj.get("replyAudio") is not None else None,
