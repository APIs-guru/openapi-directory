...
class GoogleCloudDialogflowCxV3TestCase(BaseModel):
    ...
    last_test_result: Optional[GoogleCloudDialogflowCxV3TestCaseResult] = Field(default=None, alias="lastTestResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastTestResult": GoogleCloudDialogflowCxV3TestCaseResult.from_dict(obj["lastTestResult"]) if obj.get("lastTestResult") is not None else None,
            "name": obj.get("name"),
            "notes": obj.get("notes"),
            "tags": obj.get("tags"),
            "testCaseConversationTurns": [GoogleCloudDialogflowCxV3ConversationTurn.from_dict(_item) for _item in obj["testCaseConversationTurns"]] if obj.get("testCaseConversationTurns") is not None else None,
            "testConfig": GoogleCloudDialogflowCxV3TestConfig.from_dict(obj["testConfig"]) if obj.get("testConfig") is not None else None
        })
        return _obj
