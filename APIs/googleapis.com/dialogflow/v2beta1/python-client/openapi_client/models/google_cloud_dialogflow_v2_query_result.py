...
class GoogleCloudDialogflowV2QueryResult(BaseModel):
    ...
    fulfillment_messages: Optional[List[GoogleCloudDialogflowV2IntentMessage]] = Field(default=None, description="The collection of rich messages to present to the user.", alias="fulfillmentMessages")
    ...
    intent: Optional[GoogleCloudDialogflowV2Intent] = None
    ...
    output_contexts: Optional[List[GoogleCloudDialogflowV2Context]] = Field(default=None, description="The collection of output contexts. If applicable, `output_contexts.parameters` contains entries with name `.original` containing the original parameter values before the query.", alias="outputContexts")
    ...
    sentiment_analysis_result: Optional[GoogleCloudDialogflowV2SentimentAnalysisResult] = Field(default=None, alias="sentimentAnalysisResult")
    ...
    __properties: ClassVar[List[str]] = ["action", "allRequiredParamsPresent", "cancelsSlotFilling", "diagnosticInfo", "fulfillmentMessages", "fulfillmentText", "intent", "intentDetectionConfidence", "languageCode", "outputContexts", "parameters", "queryText", "sentimentAnalysisResult", "speechRecognitionConfidence", "webhookPayload", "webhookSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intent": GoogleCloudDialogflowV2Intent.from_dict(obj["intent"]) if obj.get("intent") is not None else None,
            ...
            "sentimentAnalysisResult": GoogleCloudDialogflowV2SentimentAnalysisResult.from_dict(obj["sentimentAnalysisResult"]) if obj.get("sentimentAnalysisResult") is not None else None,
