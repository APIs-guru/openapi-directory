...
class GoogleCloudDialogflowV2beta1Document(BaseModel):
    """
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The raw content of the document. This field is only permitted for EXTRACTIVE_QA and FAQ knowledge types. Note: This field is in the process of being deprecated, please use raw_content instead.")
    ...
    latest_reload_status: Optional[GoogleCloudDialogflowV2beta1DocumentReloadStatus] = Field(default=None, alias="latestReloadStatus")
    ...
    __properties: ClassVar[List[str]] = ["content", "contentUri", "displayName", "enableAutoReload", "knowledgeTypes", "latestReloadStatus", "metadata", "mimeType", "name", "rawContent", "state"]
    ...
    def knowledge_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['KNOWLEDGE_TYPE_UNSPECIFIED', 'FAQ', 'EXTRACTIVE_QA', 'ARTICLE_SUGGESTION', 'AGENT_FACING_SMART_REPLY', 'SMART_REPLY']):
                raise ValueError("each list item must be one of ('KNOWLEDGE_TYPE_UNSPECIFIED', 'FAQ', 'EXTRACTIVE_QA', 'ARTICLE_SUGGESTION', 'AGENT_FACING_SMART_REPLY', 'SMART_REPLY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latestReloadStatus": GoogleCloudDialogflowV2beta1DocumentReloadStatus.from_dict(obj["latestReloadStatus"]) if obj.get("latestReloadStatus") is not None else None,
