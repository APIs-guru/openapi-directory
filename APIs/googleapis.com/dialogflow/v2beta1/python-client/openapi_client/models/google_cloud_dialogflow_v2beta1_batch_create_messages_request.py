...
class GoogleCloudDialogflowV2beta1BatchCreateMessagesRequest(BaseModel):
    """
    The request message for Conversations.BatchCreateMessagesRequest.
    """ # noqa: E501
    requests: Optional[List[GoogleCloudDialogflowV2beta1CreateMessageRequest]] = Field(default=None, description="Required. A maximum of 300 messages can be created in a batch. CreateMessageRequest.message.send_time is required. All created messages will have identical Message.create_time.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudDialogflowV2beta1CreateMessageRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
