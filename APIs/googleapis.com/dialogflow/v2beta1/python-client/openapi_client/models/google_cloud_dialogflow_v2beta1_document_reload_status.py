...
class GoogleCloudDialogflowV2beta1DocumentReloadStatus(BaseModel):
    """
    The status of a reload attempt.
    """ # noqa: E501
    status: Optional[GoogleRpcStatus] = None
    time: Optional[StrictStr] = Field(default=None, description="Output only. The time of a reload attempt. This reload may have been triggered automatically or manually and may not have succeeded.")
