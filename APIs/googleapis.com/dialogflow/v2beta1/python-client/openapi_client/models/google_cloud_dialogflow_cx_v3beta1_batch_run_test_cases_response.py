...
class GoogleCloudDialogflowCxV3beta1BatchRunTestCasesResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[GoogleCloudDialogflowCxV3beta1TestCaseResult]] = Field(default=None, description="The test case results. The detailed conversation turns are empty in this response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [GoogleCloudDialogflowCxV3beta1TestCaseResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
