...
class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem]] = Field(default=None, description="Required. Carousel items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
