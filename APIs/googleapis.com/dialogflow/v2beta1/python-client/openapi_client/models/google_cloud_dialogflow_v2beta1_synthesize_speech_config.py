...
class GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig(BaseModel):
    """
    ...
    voice: Optional[GoogleCloudDialogflowV2beta1VoiceSelectionParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voice": GoogleCloudDialogflowV2beta1VoiceSelectionParams.from_dict(obj["voice"]) if obj.get("voice") is not None else None,
