...
class GoogleCloudDialogflowV2beta1ListConversationsResponse(BaseModel):
    """
    The response message for Conversations.ListConversations.
    """ # noqa: E501
    conversations: Optional[List[GoogleCloudDialogflowV2beta1Conversation]] = Field(default=None, description="The list of conversations. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [GoogleCloudDialogflowV2beta1Conversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
