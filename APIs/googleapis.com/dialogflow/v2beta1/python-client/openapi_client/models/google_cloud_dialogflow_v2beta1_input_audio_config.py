...
class GoogleCloudDialogflowV2beta1InputAudioConfig(BaseModel):
    """
    ...
    barge_in_config: Optional[GoogleCloudDialogflowV2beta1BargeInConfig] = Field(default=None, alias="bargeInConfig")
    ...
    speech_contexts: Optional[List[GoogleCloudDialogflowV2beta1SpeechContext]] = Field(default=None, description="Context information to assist speech recognition. See [the Cloud Speech documentation](https://cloud.google.com/speech-to-text/docs/basics#phrase-hints) for more details.", alias="speechContexts")
    __properties: ClassVar[List[str]] = ["audioEncoding", "bargeInConfig", "disableNoSpeechRecognizedEvent", "enableAutomaticPunctuation", "enableWordInfo", "languageCode", "model", "modelVariant", "optOutConformerModelMigration", "phraseHints", "sampleRateHertz", "singleUtterance", "speechContexts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1InputAudioConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2beta1InputAudioConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bargeInConfig": GoogleCloudDialogflowV2beta1BargeInConfig.from_dict(obj["bargeInConfig"]) if obj.get("bargeInConfig") is not None else None,
            ...
            "speechContexts": [GoogleCloudDialogflowV2beta1SpeechContext.from_dict(_item) for _item in obj["speechContexts"]] if obj.get("speechContexts") is not None else None
        })
        return _obj
