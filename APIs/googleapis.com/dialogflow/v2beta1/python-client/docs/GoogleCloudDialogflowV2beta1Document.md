...
------------ | ------------- | ------------- | -------------
**content** | **str** | The raw content of the document. This field is only permitted for EXTRACTIVE_QA and FAQ knowledge types. Note: This field is in the process of being deprecated, please use raw_content instead. | [optional] 
...
**latest_reload_status** | [**GoogleCloudDialogflowV2beta1DocumentReloadStatus**](GoogleCloudDialogflowV2beta1DocumentReloadStatus.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudDialogflowV2beta1Document from a JSON string
google_cloud_dialogflow_v2beta1_document_instance = GoogleCloudDialogflowV2beta1Document.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2beta1Document.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2beta1_document_dict = google_cloud_dialogflow_v2beta1_document_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2beta1Document from a dict
google_cloud_dialogflow_v2beta1_document_from_dict = GoogleCloudDialogflowV2beta1Document.from_dict(google_cloud_dialogflow_v2beta1_document_dict)
```
