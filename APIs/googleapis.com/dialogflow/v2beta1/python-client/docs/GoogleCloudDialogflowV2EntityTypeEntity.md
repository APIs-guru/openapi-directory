...
google_cloud_dialogflow_v2_entity_type_entity_instance = GoogleCloudDialogflowV2EntityTypeEntity.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2EntityTypeEntity.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2_entity_type_entity_dict = google_cloud_dialogflow_v2_entity_type_entity_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2EntityTypeEntity from a dict
google_cloud_dialogflow_v2_entity_type_entity_from_dict = GoogleCloudDialogflowV2EntityTypeEntity.from_dict(google_cloud_dialogflow_v2_entity_type_entity_dict)
```
