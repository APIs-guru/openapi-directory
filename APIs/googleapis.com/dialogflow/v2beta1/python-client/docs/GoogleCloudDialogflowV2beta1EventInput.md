...
google_cloud_dialogflow_v2beta1_event_input_instance = GoogleCloudDialogflowV2beta1EventInput.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2beta1EventInput.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2beta1_event_input_dict = google_cloud_dialogflow_v2beta1_event_input_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2beta1EventInput from a dict
google_cloud_dialogflow_v2beta1_event_input_from_dict = GoogleCloudDialogflowV2beta1EventInput.from_dict(google_cloud_dialogflow_v2beta1_event_input_dict)
```
