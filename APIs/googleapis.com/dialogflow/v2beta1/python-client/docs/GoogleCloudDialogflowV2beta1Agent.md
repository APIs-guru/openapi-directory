...
**parent** | **str** | Required. The project of this agent. Format: &#x60;projects/&#x60; or &#x60;projects//locations/&#x60; | [optional] 
...
google_cloud_dialogflow_v2beta1_agent_instance = GoogleCloudDialogflowV2beta1Agent.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2beta1Agent.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2beta1_agent_dict = google_cloud_dialogflow_v2beta1_agent_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2beta1Agent from a dict
google_cloud_dialogflow_v2beta1_agent_from_dict = GoogleCloudDialogflowV2beta1Agent.from_dict(google_cloud_dialogflow_v2beta1_agent_dict)
```
