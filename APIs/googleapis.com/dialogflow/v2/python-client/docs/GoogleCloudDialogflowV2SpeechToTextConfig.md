...
google_cloud_dialogflow_v2_speech_to_text_config_instance = GoogleCloudDialogflowV2SpeechToTextConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2SpeechToTextConfig.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2_speech_to_text_config_dict = google_cloud_dialogflow_v2_speech_to_text_config_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2SpeechToTextConfig from a dict
google_cloud_dialogflow_v2_speech_to_text_config_from_dict = GoogleCloudDialogflowV2SpeechToTextConfig.from_dict(google_cloud_dialogflow_v2_speech_to_text_config_dict)
```
