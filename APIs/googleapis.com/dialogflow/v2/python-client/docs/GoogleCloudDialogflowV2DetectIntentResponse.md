...
google_cloud_dialogflow_v2_detect_intent_response_instance = GoogleCloudDialogflowV2DetectIntentResponse.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2DetectIntentResponse.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2_detect_intent_response_dict = google_cloud_dialogflow_v2_detect_intent_response_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2DetectIntentResponse from a dict
google_cloud_dialogflow_v2_detect_intent_response_from_dict = GoogleCloudDialogflowV2DetectIntentResponse.from_dict(google_cloud_dialogflow_v2_detect_intent_response_dict)
```
