...
google_cloud_dialogflow_v2_synthesize_speech_config_instance = GoogleCloudDialogflowV2SynthesizeSpeechConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2SynthesizeSpeechConfig.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2_synthesize_speech_config_dict = google_cloud_dialogflow_v2_synthesize_speech_config_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2SynthesizeSpeechConfig from a dict
google_cloud_dialogflow_v2_synthesize_speech_config_from_dict = GoogleCloudDialogflowV2SynthesizeSpeechConfig.from_dict(google_cloud_dialogflow_v2_synthesize_speech_config_dict)
```
