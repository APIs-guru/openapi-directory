...
google_cloud_dialogflow_cx_v3beta1_intent_parameter_instance = GoogleCloudDialogflowCxV3beta1IntentParameter.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3beta1IntentParameter.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3beta1_intent_parameter_dict = google_cloud_dialogflow_cx_v3beta1_intent_parameter_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3beta1IntentParameter from a dict
google_cloud_dialogflow_cx_v3beta1_intent_parameter_from_dict = GoogleCloudDialogflowCxV3beta1IntentParameter.from_dict(google_cloud_dialogflow_cx_v3beta1_intent_parameter_dict)
```
