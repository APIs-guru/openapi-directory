...
google_cloud_dialogflow_v2_text_input_instance = GoogleCloudDialogflowV2TextInput.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowV2TextInput.to_json())

# convert the object into a dict
google_cloud_dialogflow_v2_text_input_dict = google_cloud_dialogflow_v2_text_input_instance.to_dict()
# create an instance of GoogleCloudDialogflowV2TextInput from a dict
google_cloud_dialogflow_v2_text_input_from_dict = GoogleCloudDialogflowV2TextInput.from_dict(google_cloud_dialogflow_v2_text_input_dict)
```
