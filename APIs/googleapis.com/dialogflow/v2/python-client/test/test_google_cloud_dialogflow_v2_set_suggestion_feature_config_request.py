...
class TestGoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest(unittest.TestCase):
    """GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest:
        """Test GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest`
        """
        model = GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest()
        if include_optional:
            return GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest(
                participant_role = 'ROLE_UNSPECIFIED',
                suggestion_feature_config = openapi_client.models.google_cloud_dialogflow_v2_human_agent_assistant_config_suggestion_feature_config.GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig(
    ...
    def testGoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest(self):
        """Test GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest"""
