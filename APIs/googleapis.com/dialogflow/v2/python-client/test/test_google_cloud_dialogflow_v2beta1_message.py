...
class TestGoogleCloudDialogflowV2beta1Message(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1Message unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1Message:
        """Test GoogleCloudDialogflowV2beta1Message
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1Message`
        """
        model = GoogleCloudDialogflowV2beta1Message()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1Message(self):
        """Test GoogleCloudDialogflowV2beta1Message"""
