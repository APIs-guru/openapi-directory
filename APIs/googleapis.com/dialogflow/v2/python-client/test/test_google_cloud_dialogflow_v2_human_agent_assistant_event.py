...
class TestGoogleCloudDialogflowV2HumanAgentAssistantEvent(unittest.TestCase):
    """GoogleCloudDialogflowV2HumanAgentAssistantEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2HumanAgentAssistantEvent:
        """Test GoogleCloudDialogflowV2HumanAgentAssistantEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2HumanAgentAssistantEvent`
        """
        model = GoogleCloudDialogflowV2HumanAgentAssistantEvent()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2HumanAgentAssistantEvent(self):
        """Test GoogleCloudDialogflowV2HumanAgentAssistantEvent"""
