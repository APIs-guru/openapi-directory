...
class TestGoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig(unittest.TestCase):
    """GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig:
        """Test GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig`
        """
        model = GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig(self):
        """Test GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig"""
