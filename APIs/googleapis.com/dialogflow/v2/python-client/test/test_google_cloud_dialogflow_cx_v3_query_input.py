...
class TestGoogleCloudDialogflowCxV3QueryInput(unittest.TestCase):
    """GoogleCloudDialogflowCxV3QueryInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3QueryInput:
        """Test GoogleCloudDialogflowCxV3QueryInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3QueryInput`
        """
        model = GoogleCloudDialogflowCxV3QueryInput()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3QueryInput(self):
        """Test GoogleCloudDialogflowCxV3QueryInput"""
