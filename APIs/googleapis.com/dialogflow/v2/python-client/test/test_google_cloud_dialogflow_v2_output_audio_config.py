...
class TestGoogleCloudDialogflowV2OutputAudioConfig(unittest.TestCase):
    """GoogleCloudDialogflowV2OutputAudioConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2OutputAudioConfig:
        """Test GoogleCloudDialogflowV2OutputAudioConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2OutputAudioConfig`
        """
        model = GoogleCloudDialogflowV2OutputAudioConfig()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2OutputAudioConfig(self):
        """Test GoogleCloudDialogflowV2OutputAudioConfig"""
