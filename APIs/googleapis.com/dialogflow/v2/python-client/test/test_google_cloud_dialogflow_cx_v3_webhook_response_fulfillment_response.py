...
class TestGoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse:
        """Test GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse`
        """
        model = GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse(self):
        """Test GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse"""
