...
class TestGoogleCloudDialogflowV2ListConversationModelEvaluationsResponse(unittest.TestCase):
    """GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse:
        """Test GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse`
        """
        model = GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse()
        if include_optional:
            return GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse(
                conversation_model_evaluations = [
                    openapi_client.models.google_cloud_dialogflow_v2_conversation_model_evaluation.GoogleCloudDialogflowV2ConversationModelEvaluation(
                        create_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudDialogflowV2ListConversationModelEvaluationsResponse(self):
        """Test GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse"""
