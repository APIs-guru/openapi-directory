...
class TestGoogleCloudDialogflowCxV3beta1ResponseMessage(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1ResponseMessage:
        """Test GoogleCloudDialogflowCxV3beta1ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1ResponseMessage`
        """
        model = GoogleCloudDialogflowCxV3beta1ResponseMessage()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1ResponseMessage(self):
        """Test GoogleCloudDialogflowCxV3beta1ResponseMessage"""
