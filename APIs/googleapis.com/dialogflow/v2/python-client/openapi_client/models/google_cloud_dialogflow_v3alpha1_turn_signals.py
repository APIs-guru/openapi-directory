...
class GoogleCloudDialogflowV3alpha1TurnSignals(BaseModel):
    ...
    triggered_abandonment_event: Optional[StrictBool] = Field(default=None, description="Whether agent has triggered the event corresponding to user abandoning the conversation.", alias="triggeredAbandonmentEvent")
    ...
    __properties: ClassVar[List[str]] = ["agentEscalated", "dtmfUsed", "failureReasons", "noMatch", "noUserInput", "reachedEndPage", "sentimentMagnitude", "sentimentScore", "triggeredAbandonmentEvent", "userEscalated", "webhookStatuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "triggeredAbandonmentEvent": obj.get("triggeredAbandonmentEvent"),
