...
class GoogleCloudDialogflowV2ListParticipantsResponse(BaseModel):
    """
    ...
    participants: Optional[List[GoogleCloudDialogflowV2Participant]] = Field(default=None, description="The list of participants. There is a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participants": [GoogleCloudDialogflowV2Participant.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None
        })
        return _obj
