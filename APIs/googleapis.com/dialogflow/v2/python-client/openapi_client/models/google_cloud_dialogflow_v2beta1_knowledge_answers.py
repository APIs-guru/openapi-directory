...
class GoogleCloudDialogflowV2beta1KnowledgeAnswers(BaseModel):
    ...
    """ # noqa: E501
    answers: Optional[List[GoogleCloudDialogflowV2beta1KnowledgeAnswersAnswer]] = Field(default=None, description="A list of answers from Knowledge Connector.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [GoogleCloudDialogflowV2beta1KnowledgeAnswersAnswer.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
