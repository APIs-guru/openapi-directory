...
class GoogleCloudDialogflowV2BatchUpdateEntitiesRequest(BaseModel):
    """
    The request message for EntityTypes.BatchUpdateEntities.
    """ # noqa: E501
    entities: Optional[List[GoogleCloudDialogflowV2EntityTypeEntity]] = Field(default=None, description="Required. The entities to update or create.")
    ...
    __properties: ClassVar[List[str]] = ["entities", "languageCode", "updateMask"]
