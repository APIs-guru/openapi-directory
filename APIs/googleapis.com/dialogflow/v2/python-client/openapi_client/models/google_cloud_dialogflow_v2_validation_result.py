...
class GoogleCloudDialogflowV2ValidationResult(BaseModel):
    """
    Represents the output of agent validation.
    """ # noqa: E501
    validation_errors: Optional[List[GoogleCloudDialogflowV2ValidationError]] = Field(default=None, description="Contains all validation errors.", alias="validationErrors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationErrors": [GoogleCloudDialogflowV2ValidationError.from_dict(_item) for _item in obj["validationErrors"]] if obj.get("validationErrors") is not None else None
        })
        return _obj
