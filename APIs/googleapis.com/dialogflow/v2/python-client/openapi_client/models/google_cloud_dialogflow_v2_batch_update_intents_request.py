...
class GoogleCloudDialogflowV2BatchUpdateIntentsRequest(BaseModel):
    """
    GoogleCloudDialogflowV2BatchUpdateIntentsRequest
    """ # noqa: E501
    intent_batch_inline: Optional[GoogleCloudDialogflowV2IntentBatch] = Field(default=None, alias="intentBatchInline")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2BatchUpdateIntentsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2BatchUpdateIntentsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "intentBatchInline": GoogleCloudDialogflowV2IntentBatch.from_dict(obj["intentBatchInline"]) if obj.get("intentBatchInline") is not None else None,
