...
class GoogleCloudDialogflowV2Agent(BaseModel):
    """
    ...
    parent: Optional[StrictStr] = Field(default=None, description="Required. The project of this agent. Format: `projects/`.")
