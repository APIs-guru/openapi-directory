...
class GoogleCloudDialogflowCxV3WebhookRequestIntentInfoIntentParameterValue(BaseModel):
    ...
    """ # noqa: E501
    original_value: Optional[StrictStr] = Field(default=None, description="Always present. Original text value extracted from user utterance.", alias="originalValue")
    resolved_value: Optional[Any] = Field(default=None, description="Always present. Structured value for the parameter extracted from user utterance.", alias="resolvedValue")
    __properties: ClassVar[List[str]] = ["originalValue", "resolvedValue"]
