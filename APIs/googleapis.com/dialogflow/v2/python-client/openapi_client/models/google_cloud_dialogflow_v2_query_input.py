...
class GoogleCloudDialogflowV2QueryInput(BaseModel):
    """
    Represents the query input. It can contain either: 1. An audio config which instructs the speech recognizer how to process the speech audio. 2. A conversational query in the form of text. 3. An event that specifies which intent to trigger.
    """ # noqa: E501
    audio_config: Optional[GoogleCloudDialogflowV2InputAudioConfig] = Field(default=None, alias="audioConfig")
    event: Optional[GoogleCloudDialogflowV2EventInput] = None
    text: Optional[GoogleCloudDialogflowV2TextInput] = None
    __properties: ClassVar[List[str]] = ["audioConfig", "event", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audioConfig": GoogleCloudDialogflowV2InputAudioConfig.from_dict(obj["audioConfig"]) if obj.get("audioConfig") is not None else None,
            "event": GoogleCloudDialogflowV2EventInput.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "text": GoogleCloudDialogflowV2TextInput.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
