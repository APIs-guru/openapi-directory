...
class GoogleCloudDialogflowV2beta1IntentMessageTelephonyTransferCall(BaseModel):
    ...
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Required. The phone number to transfer the call to in [E.164 format](https://en.wikipedia.org/wiki/E.164). We currently only allow transferring to US numbers (+1xxxyyyzzzz).", alias="phoneNumber")
