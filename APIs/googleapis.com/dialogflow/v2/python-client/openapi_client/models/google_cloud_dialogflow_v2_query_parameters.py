...
class GoogleCloudDialogflowV2QueryParameters(BaseModel):
    """
    Represents the parameters of the conversational query.
    """ # noqa: E501
    contexts: Optional[List[GoogleCloudDialogflowV2Context]] = Field(default=None, description="The collection of contexts to be activated before this query is executed.")
    ...
    sentiment_analysis_request_config: Optional[GoogleCloudDialogflowV2SentimentAnalysisRequestConfig] = Field(default=None, alias="sentimentAnalysisRequestConfig")
    session_entity_types: Optional[List[GoogleCloudDialogflowV2SessionEntityType]] = Field(default=None, description="Additional session entity types to replace or extend developer entity types with. The entity synonyms apply to all languages and persist for the session of this query.", alias="sessionEntityTypes")
    ...
    __properties: ClassVar[List[str]] = ["contexts", "geoLocation", "payload", "platform", "resetContexts", "sentimentAnalysisRequestConfig", "sessionEntityTypes", "timeZone", "webhookHeaders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contexts": [GoogleCloudDialogflowV2Context.from_dict(_item) for _item in obj["contexts"]] if obj.get("contexts") is not None else None,
            ...
            "sentimentAnalysisRequestConfig": GoogleCloudDialogflowV2SentimentAnalysisRequestConfig.from_dict(obj["sentimentAnalysisRequestConfig"]) if obj.get("sentimentAnalysisRequestConfig") is not None else None,
