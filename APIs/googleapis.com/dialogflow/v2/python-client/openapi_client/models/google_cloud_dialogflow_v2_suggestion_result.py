...
class GoogleCloudDialogflowV2SuggestionResult(BaseModel):
    ...
    suggest_articles_response: Optional[GoogleCloudDialogflowV2SuggestArticlesResponse] = Field(default=None, alias="suggestArticlesResponse")
    suggest_faq_answers_response: Optional[GoogleCloudDialogflowV2SuggestFaqAnswersResponse] = Field(default=None, alias="suggestFaqAnswersResponse")
    suggest_smart_replies_response: Optional[GoogleCloudDialogflowV2SuggestSmartRepliesResponse] = Field(default=None, alias="suggestSmartRepliesResponse")
    __properties: ClassVar[List[str]] = ["error", "suggestArticlesResponse", "suggestFaqAnswersResponse", "suggestSmartRepliesResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestArticlesResponse": GoogleCloudDialogflowV2SuggestArticlesResponse.from_dict(obj["suggestArticlesResponse"]) if obj.get("suggestArticlesResponse") is not None else None,
            "suggestFaqAnswersResponse": GoogleCloudDialogflowV2SuggestFaqAnswersResponse.from_dict(obj["suggestFaqAnswersResponse"]) if obj.get("suggestFaqAnswersResponse") is not None else None,
            "suggestSmartRepliesResponse": GoogleCloudDialogflowV2SuggestSmartRepliesResponse.from_dict(obj["suggestSmartRepliesResponse"]) if obj.get("suggestSmartRepliesResponse") is not None else None
        })
        return _obj
