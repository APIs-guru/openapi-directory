...
class GoogleCloudDialogflowV2WebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    original_detect_intent_request: Optional[GoogleCloudDialogflowV2OriginalDetectIntentRequest] = Field(default=None, alias="originalDetectIntentRequest")
    ...
    session: Optional[StrictStr] = Field(default=None, description="The unique identifier of detectIntent request session. Can be used to identify end-user inside webhook implementation. Format: `projects//agent/sessions/`, or `projects//agent/environments//users//sessions/`.")
    __properties: ClassVar[List[str]] = ["originalDetectIntentRequest", "queryResult", "responseId", "session"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "originalDetectIntentRequest": GoogleCloudDialogflowV2OriginalDetectIntentRequest.from_dict(obj["originalDetectIntentRequest"]) if obj.get("originalDetectIntentRequest") is not None else None,
