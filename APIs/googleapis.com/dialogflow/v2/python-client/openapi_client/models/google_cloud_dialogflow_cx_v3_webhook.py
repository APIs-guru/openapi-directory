...
class GoogleCloudDialogflowCxV3Webhook(BaseModel):
    ...
    generic_web_service: Optional[GoogleCloudDialogflowCxV3WebhookGenericWebService] = Field(default=None, alias="genericWebService")
    ...
    service_directory: Optional[GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig] = Field(default=None, alias="serviceDirectory")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3Webhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3Webhook from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "genericWebService": GoogleCloudDialogflowCxV3WebhookGenericWebService.from_dict(obj["genericWebService"]) if obj.get("genericWebService") is not None else None,
            "name": obj.get("name"),
            "serviceDirectory": GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig.from_dict(obj["serviceDirectory"]) if obj.get("serviceDirectory") is not None else None,
