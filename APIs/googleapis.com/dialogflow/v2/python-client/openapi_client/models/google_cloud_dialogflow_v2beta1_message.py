...
class GoogleCloudDialogflowV2beta1Message(BaseModel):
    ...
    message_annotation: Optional[GoogleCloudDialogflowV2beta1MessageAnnotation] = Field(default=None, alias="messageAnnotation")
    ...
    sentiment_analysis: Optional[GoogleCloudDialogflowV2beta1SentimentAnalysisResult] = Field(default=None, alias="sentimentAnalysis")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageAnnotation": GoogleCloudDialogflowV2beta1MessageAnnotation.from_dict(obj["messageAnnotation"]) if obj.get("messageAnnotation") is not None else None,
            "name": obj.get("name"),
            "participant": obj.get("participant"),
            "participantRole": obj.get("participantRole"),
            "sendTime": obj.get("sendTime"),
            "sentimentAnalysis": GoogleCloudDialogflowV2beta1SentimentAnalysisResult.from_dict(obj["sentimentAnalysis"]) if obj.get("sentimentAnalysis") is not None else None
        })
        return _obj
