...
class GoogleCloudDialogflowCxV3Intent(BaseModel):
    ...
    parameters: Optional[List[GoogleCloudDialogflowCxV3IntentParameter]] = Field(default=None, description="The collection of parameters associated with the intent.")
    ...
    training_phrases: Optional[List[GoogleCloudDialogflowCxV3IntentTrainingPhrase]] = Field(default=None, description="The collection of training phrases the agent is trained on to identify the intent.", alias="trainingPhrases")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3Intent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3Intent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parameters": [GoogleCloudDialogflowCxV3IntentParameter.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
            "priority": obj.get("priority"),
            "trainingPhrases": [GoogleCloudDialogflowCxV3IntentTrainingPhrase.from_dict(_item) for _item in obj["trainingPhrases"]] if obj.get("trainingPhrases") is not None else None
        })
        return _obj
