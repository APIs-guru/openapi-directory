...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCases(BaseModel):
    ...
    """ # noqa: E501
    cases: Optional[List[GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase]] = Field(default=None, description="A list of cascading if-else conditions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cases": [GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None
        })
        return _obj
...
GoogleCloudDialogflowCxV3FulfillmentConditionalCases.model_rebuild(raise_errors=False)
