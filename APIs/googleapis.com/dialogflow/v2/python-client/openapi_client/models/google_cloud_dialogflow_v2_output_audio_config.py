...
class GoogleCloudDialogflowV2OutputAudioConfig(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2OutputAudioConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2OutputAudioConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "synthesizeSpeechConfig": GoogleCloudDialogflowV2SynthesizeSpeechConfig.from_dict(obj["synthesizeSpeechConfig"]) if obj.get("synthesizeSpeechConfig") is not None else None
        })
        return _obj
