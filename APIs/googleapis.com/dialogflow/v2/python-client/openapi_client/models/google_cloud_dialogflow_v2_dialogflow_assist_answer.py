...
class GoogleCloudDialogflowV2DialogflowAssistAnswer(BaseModel):
    """
    ...
    intent_suggestion: Optional[GoogleCloudDialogflowV2IntentSuggestion] = Field(default=None, alias="intentSuggestion")
    query_result: Optional[GoogleCloudDialogflowV2QueryResult] = Field(default=None, alias="queryResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intentSuggestion": GoogleCloudDialogflowV2IntentSuggestion.from_dict(obj["intentSuggestion"]) if obj.get("intentSuggestion") is not None else None,
            "queryResult": GoogleCloudDialogflowV2QueryResult.from_dict(obj["queryResult"]) if obj.get("queryResult") is not None else None
        })
        return _obj
