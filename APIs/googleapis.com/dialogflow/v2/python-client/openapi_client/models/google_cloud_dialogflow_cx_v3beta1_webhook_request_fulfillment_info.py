...
class GoogleCloudDialogflowCxV3beta1WebhookRequestFulfillmentInfo(BaseModel):
    ...
    """ # noqa: E501
    tag: Optional[StrictStr] = Field(default=None, description="Always present. The value of the Fulfillment.tag field will be populated in this field by Dialogflow when the associated webhook is called. The tag is typically used by the webhook service to identify which fulfillment is being called, but it could be used for other purposes.")
