...
class GoogleCloudDialogflowV2ImportDocumentsRequest(BaseModel):
    """
    Request message for Documents.ImportDocuments.
    """ # noqa: E501
    document_template: Optional[GoogleCloudDialogflowV2ImportDocumentTemplate] = Field(default=None, alias="documentTemplate")
    gcs_source: Optional[GoogleCloudDialogflowV2GcsSources] = Field(default=None, alias="gcsSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentTemplate": GoogleCloudDialogflowV2ImportDocumentTemplate.from_dict(obj["documentTemplate"]) if obj.get("documentTemplate") is not None else None,
            "gcsSource": GoogleCloudDialogflowV2GcsSources.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None,
