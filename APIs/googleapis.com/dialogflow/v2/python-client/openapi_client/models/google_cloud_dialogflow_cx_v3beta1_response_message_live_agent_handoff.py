...
class GoogleCloudDialogflowCxV3beta1ResponseMessageLiveAgentHandoff(BaseModel):
    ...
    """ # noqa: E501
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Custom metadata for your handoff procedure. Dialogflow doesn't impose any structure on this.")
