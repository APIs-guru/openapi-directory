...
class GoogleCloudDialogflowV2ListEntityTypesResponse(BaseModel):
    """
    The response message for EntityTypes.ListEntityTypes.
    """ # noqa: E501
    entity_types: Optional[List[GoogleCloudDialogflowV2EntityType]] = Field(default=None, description="The list of agent entity types. There will be a maximum number of items returned based on the page_size field in the request.", alias="entityTypes")
