...
class GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo(BaseModel):
    ...
    parameters: Optional[Dict[str, GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue]] = Field(default=None, description="Parameters identified as a result of intent matching. This is a map of the name of the identified parameter to the value of the parameter identified from the user's utterance. All parameters defined in the matched intent that are identified will be surfaced here.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": dict(
                (_k, GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue.from_dict(_v))
