...
class GoogleCloudDialogflowV2Environment(BaseModel):
    """
    ...
    fulfillment: Optional[GoogleCloudDialogflowV2Fulfillment] = None
    name: Optional[StrictStr] = Field(default=None, description="Output only. The unique identifier of this agent environment. Supported formats: - `projects//agent/environments/` - `projects//locations//agent/environments/` The environment ID for the default environment is `-`.")
    ...
    text_to_speech_settings: Optional[GoogleCloudDialogflowV2TextToSpeechSettings] = Field(default=None, alias="textToSpeechSettings")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2Environment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowV2Environment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fulfillment": GoogleCloudDialogflowV2Fulfillment.from_dict(obj["fulfillment"]) if obj.get("fulfillment") is not None else None,
            "name": obj.get("name"),
            "state": obj.get("state"),
            "textToSpeechSettings": GoogleCloudDialogflowV2TextToSpeechSettings.from_dict(obj["textToSpeechSettings"]) if obj.get("textToSpeechSettings") is not None else None,
