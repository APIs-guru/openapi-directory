...
class GoogleCloudDialogflowV2SuggestArticlesResponse(BaseModel):
    ...
    """ # noqa: E501
    article_answers: Optional[List[GoogleCloudDialogflowV2ArticleAnswer]] = Field(default=None, description="Articles ordered by score in descending order.", alias="articleAnswers")
    context_size: Optional[StrictInt] = Field(default=None, description="Number of messages prior to and including latest_message to compile the suggestion. It may be smaller than the SuggestArticlesRequest.context_size field in the request if there aren't that many messages in the conversation.", alias="contextSize")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "articleAnswers": [GoogleCloudDialogflowV2ArticleAnswer.from_dict(_item) for _item in obj["articleAnswers"]] if obj.get("articleAnswers") is not None else None,
