...
class GoogleCloudDialogflowV2ListVersionsResponse(BaseModel):
    """
    ...
    versions: Optional[List[GoogleCloudDialogflowV2Version]] = Field(default=None, description="The list of agent versions. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [GoogleCloudDialogflowV2Version.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
