...
class GoogleCloudDialogflowV2SearchAgentsResponse(BaseModel):
    """
    The response message for Agents.SearchAgents.
    """ # noqa: E501
    agents: Optional[List[GoogleCloudDialogflowV2Agent]] = Field(default=None, description="The list of agents. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [GoogleCloudDialogflowV2Agent.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None,
