...
class GoogleCloudDialogflowV2EntityTypeBatch(BaseModel):
    """
    This message is a wrapper around a collection of entity types.
    """ # noqa: E501
    entity_types: Optional[List[GoogleCloudDialogflowV2EntityType]] = Field(default=None, description="A collection of entity types.", alias="entityTypes")
    __properties: ClassVar[List[str]] = ["entityTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityTypes": [GoogleCloudDialogflowV2EntityType.from_dict(_item) for _item in obj["entityTypes"]] if obj.get("entityTypes") is not None else None
        })
        return _obj
