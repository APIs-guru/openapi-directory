...
class GoogleCloudDialogflowCxV3TestCaseError(BaseModel):
    ...
    test_case: Optional[GoogleCloudDialogflowCxV3TestCase] = Field(default=None, alias="testCase")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testCase": GoogleCloudDialogflowCxV3TestCase.from_dict(obj["testCase"]) if obj.get("testCase") is not None else None
        })
        return _obj
