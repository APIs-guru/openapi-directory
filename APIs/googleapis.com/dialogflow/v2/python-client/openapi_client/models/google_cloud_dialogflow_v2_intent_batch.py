...
class GoogleCloudDialogflowV2IntentBatch(BaseModel):
    """
    This message is a wrapper around a collection of intents.
    """ # noqa: E501
    intents: Optional[List[GoogleCloudDialogflowV2Intent]] = Field(default=None, description="A collection of intents.")
