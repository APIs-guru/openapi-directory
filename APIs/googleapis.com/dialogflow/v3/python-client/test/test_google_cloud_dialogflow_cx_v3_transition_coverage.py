...
class TestGoogleCloudDialogflowCxV3TransitionCoverage(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TransitionCoverage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TransitionCoverage:
        """Test GoogleCloudDialogflowCxV3TransitionCoverage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TransitionCoverage`
        """
        model = GoogleCloudDialogflowCxV3TransitionCoverage()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TransitionCoverage(self):
        """Test GoogleCloudDialogflowCxV3TransitionCoverage"""
