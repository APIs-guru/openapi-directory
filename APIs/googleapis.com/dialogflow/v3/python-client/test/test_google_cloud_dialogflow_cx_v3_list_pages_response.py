...
class TestGoogleCloudDialogflowCxV3ListPagesResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListPagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListPagesResponse:
        """Test GoogleCloudDialogflowCxV3ListPagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListPagesResponse`
        """
        model = GoogleCloudDialogflowCxV3ListPagesResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3ListPagesResponse(
                next_page_token = '',
                pages = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_page.GoogleCloudDialogflowCxV3Page(
    ...
    def testGoogleCloudDialogflowCxV3ListPagesResponse(self):
        """Test GoogleCloudDialogflowCxV3ListPagesResponse"""
