...
class TestGoogleCloudDialogflowCxV3Fulfillment(unittest.TestCase):
    """GoogleCloudDialogflowCxV3Fulfillment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3Fulfillment:
        """Test GoogleCloudDialogflowCxV3Fulfillment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3Fulfillment`
        """
        model = GoogleCloudDialogflowCxV3Fulfillment()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3Fulfillment(self):
        """Test GoogleCloudDialogflowCxV3Fulfillment"""
