...
class TestGoogleCloudDialogflowCxV3ListFlowsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListFlowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListFlowsResponse:
        """Test GoogleCloudDialogflowCxV3ListFlowsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListFlowsResponse`
        """
        model = GoogleCloudDialogflowCxV3ListFlowsResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3ListFlowsResponse(
                flows = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_flow.GoogleCloudDialogflowCxV3Flow(
    ...
    def testGoogleCloudDialogflowCxV3ListFlowsResponse(self):
        """Test GoogleCloudDialogflowCxV3ListFlowsResponse"""
