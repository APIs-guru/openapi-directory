...
class TestGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition:
        """Test GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition`
        """
        model = GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition(self):
        """Test GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition"""
