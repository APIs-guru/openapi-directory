...
class TestGoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse:
        """Test GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse`
        """
        model = GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse(
                next_page_token = '',
                transition_route_groups = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_transition_route_group.GoogleCloudDialogflowCxV3TransitionRouteGroup(
                        display_name = '', 
                        name = '', 
                        transition_routes = [
    ...
    def testGoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse(self):
        """Test GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse"""
