...
class TestGoogleCloudDialogflowCxV3beta1EventHandler(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1EventHandler unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1EventHandler:
        """Test GoogleCloudDialogflowCxV3beta1EventHandler
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1EventHandler`
        """
        model = GoogleCloudDialogflowCxV3beta1EventHandler()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1EventHandler(self):
        """Test GoogleCloudDialogflowCxV3beta1EventHandler"""
