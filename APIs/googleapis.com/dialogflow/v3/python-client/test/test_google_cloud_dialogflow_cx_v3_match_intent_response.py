...
class TestGoogleCloudDialogflowCxV3MatchIntentResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3MatchIntentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3MatchIntentResponse:
        """Test GoogleCloudDialogflowCxV3MatchIntentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3MatchIntentResponse`
        """
        model = GoogleCloudDialogflowCxV3MatchIntentResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3MatchIntentResponse(
                ...
                matches = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_match.GoogleCloudDialogflowCxV3Match(
                        confidence = 1.337, 
                        event = '', 
    ...
    def testGoogleCloudDialogflowCxV3MatchIntentResponse(self):
        """Test GoogleCloudDialogflowCxV3MatchIntentResponse"""
