...
class TestGoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard(unittest.TestCase):
    """GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard:
        """Test GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard`
        """
        model = GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard()
        if include_optional:
    ...
    def testGoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard(self):
        """Test GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard"""
