...
class TestGoogleCloudDialogflowCxV3Flow(unittest.TestCase):
    """GoogleCloudDialogflowCxV3Flow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3Flow:
        """Test GoogleCloudDialogflowCxV3Flow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3Flow`
        """
        model = GoogleCloudDialogflowCxV3Flow()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3Flow(self):
        """Test GoogleCloudDialogflowCxV3Flow"""
