...
class TestGoogleCloudDialogflowCxV3ListTestCasesResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListTestCasesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListTestCasesResponse:
        """Test GoogleCloudDialogflowCxV3ListTestCasesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListTestCasesResponse`
        """
        model = GoogleCloudDialogflowCxV3ListTestCasesResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3ListTestCasesResponse(
                next_page_token = '',
                test_cases = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_test_case.GoogleCloudDialogflowCxV3TestCase(
                        creation_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudDialogflowCxV3ListTestCasesResponse(self):
        """Test GoogleCloudDialogflowCxV3ListTestCasesResponse"""
