...
class TestGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage:
        """Test GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage`
        """
        model = GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage(self):
        """Test GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage"""
