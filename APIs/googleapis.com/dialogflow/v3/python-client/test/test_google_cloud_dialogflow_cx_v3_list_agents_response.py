...
class TestGoogleCloudDialogflowCxV3ListAgentsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListAgentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListAgentsResponse:
        """Test GoogleCloudDialogflowCxV3ListAgentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListAgentsResponse`
        """
        model = GoogleCloudDialogflowCxV3ListAgentsResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3ListAgentsResponse(
                agents = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_agent.GoogleCloudDialogflowCxV3Agent(
    ...
    def testGoogleCloudDialogflowCxV3ListAgentsResponse(self):
        """Test GoogleCloudDialogflowCxV3ListAgentsResponse"""
