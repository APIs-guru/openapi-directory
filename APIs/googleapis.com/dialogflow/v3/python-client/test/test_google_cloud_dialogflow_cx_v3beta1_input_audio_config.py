...
class TestGoogleCloudDialogflowCxV3beta1InputAudioConfig(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1InputAudioConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1InputAudioConfig:
        """Test GoogleCloudDialogflowCxV3beta1InputAudioConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1InputAudioConfig`
        """
        model = GoogleCloudDialogflowCxV3beta1InputAudioConfig()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1InputAudioConfig(self):
        """Test GoogleCloudDialogflowCxV3beta1InputAudioConfig"""
