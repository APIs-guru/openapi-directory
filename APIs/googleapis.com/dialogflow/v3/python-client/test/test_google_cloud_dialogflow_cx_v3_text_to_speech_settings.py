...
class TestGoogleCloudDialogflowCxV3TextToSpeechSettings(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TextToSpeechSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TextToSpeechSettings:
        """Test GoogleCloudDialogflowCxV3TextToSpeechSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TextToSpeechSettings`
        """
        model = GoogleCloudDialogflowCxV3TextToSpeechSettings()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TextToSpeechSettings(self):
        """Test GoogleCloudDialogflowCxV3TextToSpeechSettings"""
