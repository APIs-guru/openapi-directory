...
class TestGoogleCloudDialogflowCxV3ConversationTurn(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ConversationTurn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ConversationTurn:
        """Test GoogleCloudDialogflowCxV3ConversationTurn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ConversationTurn`
        """
        model = GoogleCloudDialogflowCxV3ConversationTurn()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3ConversationTurn(self):
        """Test GoogleCloudDialogflowCxV3ConversationTurn"""
