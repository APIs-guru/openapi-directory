...
class TestGoogleCloudDialogflowCxV3QueryResult(unittest.TestCase):
    """GoogleCloudDialogflowCxV3QueryResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3QueryResult:
        """Test GoogleCloudDialogflowCxV3QueryResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3QueryResult`
        """
        model = GoogleCloudDialogflowCxV3QueryResult()
        if include_optional:
            return GoogleCloudDialogflowCxV3QueryResult(
                ...
                sentiment_analysis_result = openapi_client.models.google_cloud_dialogflow_cx_v3_sentiment_analysis_result.GoogleCloudDialogflowCxV3SentimentAnalysisResult(
                    magnitude = 1.337, 
                    score = 1.337, ),
                text = '',
                transcript = '',
    ...
    def testGoogleCloudDialogflowCxV3QueryResult(self):
        """Test GoogleCloudDialogflowCxV3QueryResult"""
