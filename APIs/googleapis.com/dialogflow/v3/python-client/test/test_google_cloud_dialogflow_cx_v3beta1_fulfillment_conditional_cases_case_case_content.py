...
class TestGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent:
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent`
        """
        model = GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent(self):
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent"""
