...
class TestGoogleCloudDialogflowCxV3ListTestCaseResultsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ListTestCaseResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ListTestCaseResultsResponse:
        """Test GoogleCloudDialogflowCxV3ListTestCaseResultsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ListTestCaseResultsResponse`
        """
        model = GoogleCloudDialogflowCxV3ListTestCaseResultsResponse()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3ListTestCaseResultsResponse(self):
        """Test GoogleCloudDialogflowCxV3ListTestCaseResultsResponse"""
