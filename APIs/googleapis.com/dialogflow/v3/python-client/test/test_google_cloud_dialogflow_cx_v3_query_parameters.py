...
class TestGoogleCloudDialogflowCxV3QueryParameters(unittest.TestCase):
    """GoogleCloudDialogflowCxV3QueryParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3QueryParameters:
        """Test GoogleCloudDialogflowCxV3QueryParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3QueryParameters`
        """
        model = GoogleCloudDialogflowCxV3QueryParameters()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3QueryParameters(self):
        """Test GoogleCloudDialogflowCxV3QueryParameters"""
