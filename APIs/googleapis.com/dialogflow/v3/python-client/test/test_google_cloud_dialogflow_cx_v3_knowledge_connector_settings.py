...
class TestGoogleCloudDialogflowCxV3KnowledgeConnectorSettings(unittest.TestCase):
    """GoogleCloudDialogflowCxV3KnowledgeConnectorSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3KnowledgeConnectorSettings:
        """Test GoogleCloudDialogflowCxV3KnowledgeConnectorSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3KnowledgeConnectorSettings`
        """
        model = GoogleCloudDialogflowCxV3KnowledgeConnectorSettings()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3KnowledgeConnectorSettings(self):
        """Test GoogleCloudDialogflowCxV3KnowledgeConnectorSettings"""
