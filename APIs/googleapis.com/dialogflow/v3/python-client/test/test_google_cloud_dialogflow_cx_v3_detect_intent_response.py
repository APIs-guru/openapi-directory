...
class TestGoogleCloudDialogflowCxV3DetectIntentResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3DetectIntentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3DetectIntentResponse:
        """Test GoogleCloudDialogflowCxV3DetectIntentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3DetectIntentResponse`
        """
        model = GoogleCloudDialogflowCxV3DetectIntentResponse()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3DetectIntentResponse(self):
        """Test GoogleCloudDialogflowCxV3DetectIntentResponse"""
