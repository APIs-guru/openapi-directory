...
google_cloud_dialogflow_cx_v3_text_to_speech_settings_instance = GoogleCloudDialogflowCxV3TextToSpeechSettings.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3TextToSpeechSettings.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3_text_to_speech_settings_dict = google_cloud_dialogflow_cx_v3_text_to_speech_settings_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3TextToSpeechSettings from a dict
google_cloud_dialogflow_cx_v3_text_to_speech_settings_from_dict = GoogleCloudDialogflowCxV3TextToSpeechSettings.from_dict(google_cloud_dialogflow_cx_v3_text_to_speech_settings_dict)
```
