...
**barge_in_config** | [**GoogleCloudDialogflowCxV3BargeInConfig**](GoogleCloudDialogflowCxV3BargeInConfig.md) |  | [optional] 
...
google_cloud_dialogflow_cx_v3_input_audio_config_instance = GoogleCloudDialogflowCxV3InputAudioConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3InputAudioConfig.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3_input_audio_config_dict = google_cloud_dialogflow_cx_v3_input_audio_config_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3InputAudioConfig from a dict
google_cloud_dialogflow_cx_v3_input_audio_config_from_dict = GoogleCloudDialogflowCxV3InputAudioConfig.from_dict(google_cloud_dialogflow_cx_v3_input_audio_config_dict)
```
