...
google_cloud_dialogflow_cx_v3_nlu_settings_instance = GoogleCloudDialogflowCxV3NluSettings.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3NluSettings.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3_nlu_settings_dict = google_cloud_dialogflow_cx_v3_nlu_settings_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3NluSettings from a dict
google_cloud_dialogflow_cx_v3_nlu_settings_from_dict = GoogleCloudDialogflowCxV3NluSettings.from_dict(google_cloud_dialogflow_cx_v3_nlu_settings_dict)
```
