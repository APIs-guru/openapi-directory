...
class GoogleCloudDialogflowCxV3ListFlowsResponse(BaseModel):
    """
    The response message for Flows.ListFlows.
    """ # noqa: E501
    flows: Optional[List[GoogleCloudDialogflowCxV3Flow]] = Field(default=None, description="The list of flows. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flows": [GoogleCloudDialogflowCxV3Flow.from_dict(_item) for _item in obj["flows"]] if obj.get("flows") is not None else None,
