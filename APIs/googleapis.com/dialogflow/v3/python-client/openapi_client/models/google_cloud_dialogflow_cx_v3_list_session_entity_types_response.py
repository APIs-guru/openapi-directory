...
class GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse(BaseModel):
    """
    ...
    session_entity_types: Optional[List[GoogleCloudDialogflowCxV3SessionEntityType]] = Field(default=None, description="The list of session entity types. There will be a maximum number of items returned based on the page_size field in the request.", alias="sessionEntityTypes")
