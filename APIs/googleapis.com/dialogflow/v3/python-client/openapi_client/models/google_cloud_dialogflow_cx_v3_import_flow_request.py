...
class GoogleCloudDialogflowCxV3ImportFlowRequest(BaseModel):
    """
    ...
    flow_import_strategy: Optional[GoogleCloudDialogflowCxV3FlowImportStrategy] = Field(default=None, alias="flowImportStrategy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flowImportStrategy": GoogleCloudDialogflowCxV3FlowImportStrategy.from_dict(obj["flowImportStrategy"]) if obj.get("flowImportStrategy") is not None else None,
