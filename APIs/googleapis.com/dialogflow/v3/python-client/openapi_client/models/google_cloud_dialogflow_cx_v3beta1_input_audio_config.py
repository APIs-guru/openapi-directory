...
class GoogleCloudDialogflowCxV3beta1InputAudioConfig(BaseModel):
    ...
    barge_in_config: Optional[GoogleCloudDialogflowCxV3beta1BargeInConfig] = Field(default=None, alias="bargeInConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bargeInConfig": GoogleCloudDialogflowCxV3beta1BargeInConfig.from_dict(obj["bargeInConfig"]) if obj.get("bargeInConfig") is not None else None,
