...
class GoogleCloudDialogflowCxV3Generator(BaseModel):
    """
    ...
    placeholders: Optional[List[GoogleCloudDialogflowCxV3GeneratorPlaceholder]] = Field(default=None, description="Optional. List of custom placeholders in the prompt text.")
    prompt_text: Optional[GoogleCloudDialogflowCxV3Phrase] = Field(default=None, alias="promptText")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "placeholders": [GoogleCloudDialogflowCxV3GeneratorPlaceholder.from_dict(_item) for _item in obj["placeholders"]] if obj.get("placeholders") is not None else None,
            "promptText": GoogleCloudDialogflowCxV3Phrase.from_dict(obj["promptText"]) if obj.get("promptText") is not None else None
        })
        return _obj
