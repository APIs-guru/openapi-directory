...
class GoogleCloudDialogflowCxV3SynthesizeSpeechConfig(BaseModel):
    """
    ...
    voice: Optional[GoogleCloudDialogflowCxV3VoiceSelectionParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voice": GoogleCloudDialogflowCxV3VoiceSelectionParams.from_dict(obj["voice"]) if obj.get("voice") is not None else None,
