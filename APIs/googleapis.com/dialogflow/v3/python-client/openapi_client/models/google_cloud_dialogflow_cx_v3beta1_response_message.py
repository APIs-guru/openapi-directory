...
class GoogleCloudDialogflowCxV3beta1ResponseMessage(BaseModel):
    ...
    conversation_success: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageConversationSuccess] = Field(default=None, alias="conversationSuccess")
    ...
    live_agent_handoff: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageLiveAgentHandoff] = Field(default=None, alias="liveAgentHandoff")
    mixed_audio: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudio] = Field(default=None, alias="mixedAudio")
    output_audio_text: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText] = Field(default=None, alias="outputAudioText")
    ...
    play_audio: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudio] = Field(default=None, alias="playAudio")
    telephony_transfer_call: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageTelephonyTransferCall] = Field(default=None, alias="telephonyTransferCall")
    text: Optional[GoogleCloudDialogflowCxV3beta1ResponseMessageText] = None
    __properties: ClassVar[List[str]] = ["channel", "conversationSuccess", "endInteraction", "knowledgeInfoCard", "liveAgentHandoff", "mixedAudio", "outputAudioText", "payload", "playAudio", "telephonyTransferCall", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversationSuccess": GoogleCloudDialogflowCxV3beta1ResponseMessageConversationSuccess.from_dict(obj["conversationSuccess"]) if obj.get("conversationSuccess") is not None else None,
            "endInteraction": obj.get("endInteraction"),
            "knowledgeInfoCard": obj.get("knowledgeInfoCard"),
            "liveAgentHandoff": GoogleCloudDialogflowCxV3beta1ResponseMessageLiveAgentHandoff.from_dict(obj["liveAgentHandoff"]) if obj.get("liveAgentHandoff") is not None else None,
            "mixedAudio": GoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudio.from_dict(obj["mixedAudio"]) if obj.get("mixedAudio") is not None else None,
            "outputAudioText": GoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText.from_dict(obj["outputAudioText"]) if obj.get("outputAudioText") is not None else None,
            "payload": obj.get("payload"),
            "playAudio": GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudio.from_dict(obj["playAudio"]) if obj.get("playAudio") is not None else None,
            "telephonyTransferCall": GoogleCloudDialogflowCxV3beta1ResponseMessageTelephonyTransferCall.from_dict(obj["telephonyTransferCall"]) if obj.get("telephonyTransferCall") is not None else None,
            "text": GoogleCloudDialogflowCxV3beta1ResponseMessageText.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
