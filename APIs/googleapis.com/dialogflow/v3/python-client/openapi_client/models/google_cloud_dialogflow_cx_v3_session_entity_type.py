...
class GoogleCloudDialogflowCxV3SessionEntityType(BaseModel):
    """
    ...
    """ # noqa: E501
    entities: Optional[List[GoogleCloudDialogflowCxV3EntityTypeEntity]] = Field(default=None, description="Required. The collection of entities to override or supplement the custom entity type.")
