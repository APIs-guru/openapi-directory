...
class GoogleCloudDialogflowCxV3beta1ConversationSignals(BaseModel):
    ...
    """ # noqa: E501
    turn_signals: Optional[GoogleCloudDialogflowCxV3beta1TurnSignals] = Field(default=None, alias="turnSignals")
    __properties: ClassVar[List[str]] = ["turnSignals"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of turn_signals
        if self.turn_signals:
            _dict['turnSignals'] = self.turn_signals.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "turnSignals": GoogleCloudDialogflowCxV3beta1TurnSignals.from_dict(obj["turnSignals"]) if obj.get("turnSignals") is not None else None
        })
        return _obj
