...
class GoogleCloudDialogflowCxV3Form(BaseModel):
    ...
    """ # noqa: E501
    parameters: Optional[List[GoogleCloudDialogflowCxV3FormParameter]] = Field(default=None, description="Parameters to collect from the user.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": [GoogleCloudDialogflowCxV3FormParameter.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
