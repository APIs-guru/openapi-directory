...
class GoogleCloudDialogflowCxV3QueryResult(BaseModel):
    """
    ...
    intent: Optional[GoogleCloudDialogflowCxV3Intent] = None
    ...
    match: Optional[GoogleCloudDialogflowCxV3Match] = None
    ...
    response_messages: Optional[List[GoogleCloudDialogflowCxV3ResponseMessage]] = Field(default=None, description="The list of rich messages returned to the client. Responses vary from simple text messages to more sophisticated, structured payloads used to drive complex logic.", alias="responseMessages")
    sentiment_analysis_result: Optional[GoogleCloudDialogflowCxV3SentimentAnalysisResult] = Field(default=None, alias="sentimentAnalysisResult")
    ...
    __properties: ClassVar[List[str]] = ["advancedSettings", "allowAnswerFeedback", "currentPage", "diagnosticInfo", "dtmf", "intent", "intentDetectionConfidence", "languageCode", "match", "parameters", "responseMessages", "sentimentAnalysisResult", "text", "transcript", "triggerEvent", "triggerIntent", "webhookPayloads", "webhookStatuses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3QueryResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3QueryResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "intent": GoogleCloudDialogflowCxV3Intent.from_dict(obj["intent"]) if obj.get("intent") is not None else None,
            "intentDetectionConfidence": obj.get("intentDetectionConfidence"),
            "languageCode": obj.get("languageCode"),
            "match": GoogleCloudDialogflowCxV3Match.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "parameters": obj.get("parameters"),
            "responseMessages": [GoogleCloudDialogflowCxV3ResponseMessage.from_dict(_item) for _item in obj["responseMessages"]] if obj.get("responseMessages") is not None else None,
            "sentimentAnalysisResult": GoogleCloudDialogflowCxV3SentimentAnalysisResult.from_dict(obj["sentimentAnalysisResult"]) if obj.get("sentimentAnalysisResult") is not None else None,
            "text": obj.get("text"),
