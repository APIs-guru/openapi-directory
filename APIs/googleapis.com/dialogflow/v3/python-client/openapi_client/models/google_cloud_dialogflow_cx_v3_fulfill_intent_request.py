...
class GoogleCloudDialogflowCxV3FulfillIntentRequest(BaseModel):
    """
    Request of FulfillIntent
    """ # noqa: E501
    match: Optional[GoogleCloudDialogflowCxV3Match] = None
    match_intent_request: Optional[GoogleCloudDialogflowCxV3MatchIntentRequest] = Field(default=None, alias="matchIntentRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchIntentRequest": GoogleCloudDialogflowCxV3MatchIntentRequest.from_dict(obj["matchIntentRequest"]) if obj.get("matchIntentRequest") is not None else None,
