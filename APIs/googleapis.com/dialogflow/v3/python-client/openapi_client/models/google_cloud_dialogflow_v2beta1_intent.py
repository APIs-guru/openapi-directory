...
class GoogleCloudDialogflowV2beta1Intent(BaseModel):
    ...
    followup_intent_info: Optional[List[GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo]] = Field(default=None, description="Output only. Information about all followup intents that have this intent as a direct or indirect parent. We populate this field only in the output.", alias="followupIntentInfo")
    input_context_names: Optional[List[StrictStr]] = Field(default=None, description="Optional. The list of context names required for this intent to be triggered. Formats: - `projects//agent/sessions/-/contexts/` - `projects//locations//agent/sessions/-/contexts/`", alias="inputContextNames")
    ...
    messages: Optional[List[GoogleCloudDialogflowV2beta1IntentMessage]] = Field(default=None, description="Optional. The collection of rich messages corresponding to the `Response` field in the Dialogflow console.")
    ...
    ml_enabled: Optional[StrictBool] = Field(default=None, description="Optional. Indicates whether Machine Learning is enabled for the intent. Note: If `ml_enabled` setting is set to false, then this intent is not taken into account during inference in `ML ONLY` match mode. Also, auto-markup in the UI is turned off. DEPRECATED! Please use `ml_disabled` field instead. NOTE: If both `ml_enabled` and `ml_disabled` are either not set or false, then the default value is determined as follows: - Before April 15th, 2018 the default is: ml_enabled = false / ml_disabled = true. - After April 15th, 2018 the default is: ml_enabled = true / ml_disabled = false.", alias="mlEnabled")
    name: Optional[StrictStr] = Field(default=None, description="Optional. The unique identifier of this intent. Required for Intents.UpdateIntent and Intents.BatchUpdateIntents methods. Supported formats: - `projects//agent/intents/` - `projects//locations//agent/intents/`")
    ...
    parameters: Optional[List[GoogleCloudDialogflowV2beta1IntentParameter]] = Field(default=None, description="Optional. The collection of parameters associated with the intent.")
    parent_followup_intent_name: Optional[StrictStr] = Field(default=None, description="Optional. The unique identifier of the parent intent in the chain of followup intents. You can set this field when creating an intent, for example with CreateIntent or BatchUpdateIntents, in order to make this intent a followup intent. It identifies the parent followup intent. Format: `projects//agent/intents/`.", alias="parentFollowupIntentName")
    ...
    root_followup_intent_name: Optional[StrictStr] = Field(default=None, description="Output only. The unique identifier of the root intent in the chain of followup intents. It identifies the correct followup intents chain for this intent. Format: `projects//agent/intents/`.", alias="rootFollowupIntentName")
    training_phrases: Optional[List[GoogleCloudDialogflowV2beta1IntentTrainingPhrase]] = Field(default=None, description="Optional. The collection of examples that the agent is trained on.", alias="trainingPhrases")
    ...
    def default_response_platforms_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['PLATFORM_UNSPECIFIED', 'FACEBOOK', 'SLACK', 'TELEGRAM', 'KIK', 'SKYPE', 'LINE', 'VIBER', 'ACTIONS_ON_GOOGLE', 'TELEPHONY', 'GOOGLE_HANGOUTS']):
                raise ValueError("each list item must be one of ('PLATFORM_UNSPECIFIED', 'FACEBOOK', 'SLACK', 'TELEGRAM', 'KIK', 'SKYPE', 'LINE', 'VIBER', 'ACTIONS_ON_GOOGLE', 'TELEPHONY', 'GOOGLE_HANGOUTS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "followupIntentInfo": [GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo.from_dict(_item) for _item in obj["followupIntentInfo"]] if obj.get("followupIntentInfo") is not None else None,
            "inputContextNames": obj.get("inputContextNames"),
            "isFallback": obj.get("isFallback"),
            "liveAgentHandoff": obj.get("liveAgentHandoff"),
            "messages": [GoogleCloudDialogflowV2beta1IntentMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "mlDisabled": obj.get("mlDisabled"),
            "mlEnabled": obj.get("mlEnabled"),
            "name": obj.get("name"),
            ...
            "parameters": [GoogleCloudDialogflowV2beta1IntentParameter.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
            ...
            "trainingPhrases": [GoogleCloudDialogflowV2beta1IntentTrainingPhrase.from_dict(_item) for _item in obj["trainingPhrases"]] if obj.get("trainingPhrases") is not None else None,
