...
class GoogleCloudDialogflowCxV3beta1WebhookResponseFulfillmentResponse(BaseModel):
    ...
    """ # noqa: E501
    merge_behavior: Optional[StrictStr] = Field(default=None, description="Merge behavior for `messages`.", alias="mergeBehavior")
    ...
    __properties: ClassVar[List[str]] = ["mergeBehavior", "messages"]

    @field_validator('merge_behavior')
    def merge_behavior_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['MERGE_BEHAVIOR_UNSPECIFIED', 'APPEND', 'REPLACE']):
            raise ValueError("must be one of enum values ('MERGE_BEHAVIOR_UNSPECIFIED', 'APPEND', 'REPLACE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mergeBehavior": obj.get("mergeBehavior"),
