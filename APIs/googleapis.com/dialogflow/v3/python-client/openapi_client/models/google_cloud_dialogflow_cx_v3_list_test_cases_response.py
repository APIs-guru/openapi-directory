...
class GoogleCloudDialogflowCxV3ListTestCasesResponse(BaseModel):
    """
    ...
    test_cases: Optional[List[GoogleCloudDialogflowCxV3TestCase]] = Field(default=None, description="The list of test cases. There will be a maximum number of items returned based on the page_size field in the request.", alias="testCases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testCases": [GoogleCloudDialogflowCxV3TestCase.from_dict(_item) for _item in obj["testCases"]] if obj.get("testCases") is not None else None
        })
        return _obj
