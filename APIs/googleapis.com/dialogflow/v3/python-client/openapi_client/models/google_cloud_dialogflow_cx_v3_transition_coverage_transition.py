...
class GoogleCloudDialogflowCxV3TransitionCoverageTransition(BaseModel):
    """
    ...
    event_handler: Optional[GoogleCloudDialogflowCxV3EventHandler] = Field(default=None, alias="eventHandler")
    index: Optional[StrictInt] = Field(default=None, description="The index of a transition in the transition list. Starting from 0.")
    source: Optional[GoogleCloudDialogflowCxV3TransitionCoverageTransitionNode] = None
    target: Optional[GoogleCloudDialogflowCxV3TransitionCoverageTransitionNode] = None
    transition_route: Optional[GoogleCloudDialogflowCxV3TransitionRoute] = Field(default=None, alias="transitionRoute")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventHandler": GoogleCloudDialogflowCxV3EventHandler.from_dict(obj["eventHandler"]) if obj.get("eventHandler") is not None else None,
            "index": obj.get("index"),
            "source": GoogleCloudDialogflowCxV3TransitionCoverageTransitionNode.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": GoogleCloudDialogflowCxV3TransitionCoverageTransitionNode.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "transitionRoute": GoogleCloudDialogflowCxV3TransitionRoute.from_dict(obj["transitionRoute"]) if obj.get("transitionRoute") is not None else None
        })
        return _obj
