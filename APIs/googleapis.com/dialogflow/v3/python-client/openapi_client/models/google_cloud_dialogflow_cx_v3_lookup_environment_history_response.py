...
class GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse(BaseModel):
    """
    The response message for Environments.LookupEnvironmentHistory.
    """ # noqa: E501
    environments: Optional[List[GoogleCloudDialogflowCxV3Environment]] = Field(default=None, description="Represents a list of snapshots for an environment. Time of the snapshots is stored in `update_time`.")
