...
class GoogleCloudDialogflowCxV3Page(BaseModel):
    ...
    entry_fulfillment: Optional[GoogleCloudDialogflowCxV3Fulfillment] = Field(default=None, alias="entryFulfillment")
    event_handlers: Optional[List[GoogleCloudDialogflowCxV3EventHandler]] = Field(default=None, description="Handlers associated with the page to handle events such as webhook errors, no match or no input.", alias="eventHandlers")
    form: Optional[GoogleCloudDialogflowCxV3Form] = None
    knowledge_connector_settings: Optional[GoogleCloudDialogflowCxV3KnowledgeConnectorSettings] = Field(default=None, alias="knowledgeConnectorSettings")
    ...
    transition_routes: Optional[List[GoogleCloudDialogflowCxV3TransitionRoute]] = Field(default=None, description="A list of transitions for the transition rules of this page. They route the conversation to another page in the same flow, or another flow. When we are in a certain page, the TransitionRoutes are evalauted in the following order: * TransitionRoutes defined in the page with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in flow with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in the page with only condition specified. * TransitionRoutes defined in the transition route groups with only condition specified.", alias="transitionRoutes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entryFulfillment": GoogleCloudDialogflowCxV3Fulfillment.from_dict(obj["entryFulfillment"]) if obj.get("entryFulfillment") is not None else None,
            "eventHandlers": [GoogleCloudDialogflowCxV3EventHandler.from_dict(_item) for _item in obj["eventHandlers"]] if obj.get("eventHandlers") is not None else None,
            "form": GoogleCloudDialogflowCxV3Form.from_dict(obj["form"]) if obj.get("form") is not None else None,
            "knowledgeConnectorSettings": GoogleCloudDialogflowCxV3KnowledgeConnectorSettings.from_dict(obj["knowledgeConnectorSettings"]) if obj.get("knowledgeConnectorSettings") is not None else None,
            "name": obj.get("name"),
            "transitionRouteGroups": obj.get("transitionRouteGroups"),
            "transitionRoutes": [GoogleCloudDialogflowCxV3TransitionRoute.from_dict(_item) for _item in obj["transitionRoutes"]] if obj.get("transitionRoutes") is not None else None
        })
        return _obj
