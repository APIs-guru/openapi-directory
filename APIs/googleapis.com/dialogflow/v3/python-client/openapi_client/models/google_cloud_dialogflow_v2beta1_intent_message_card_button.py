...
class GoogleCloudDialogflowV2beta1IntentMessageCardButton(BaseModel):
    ...
    """ # noqa: E501
    postback: Optional[StrictStr] = Field(default=None, description="Optional. The text to send back to the Dialogflow API or a URI to open.")
    text: Optional[StrictStr] = Field(default=None, description="Optional. The text to show on the button.")
    __properties: ClassVar[List[str]] = ["postback", "text"]
