...
class GoogleCloudDialogflowCxV3ImportFlowResponse(BaseModel):
    ...
    """ # noqa: E501
    flow: Optional[StrictStr] = Field(default=None, description="The unique identifier of the new flow. Format: `projects//locations//agents//flows/`.")
    __properties: ClassVar[List[str]] = ["flow"]
