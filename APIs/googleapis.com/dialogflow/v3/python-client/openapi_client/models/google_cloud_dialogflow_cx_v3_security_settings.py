...
class GoogleCloudDialogflowCxV3SecuritySettings(BaseModel):
    """
    Represents the settings related to security issues, such as data redaction and data retention. It may take hours for updates on the settings to propagate to all the related components and take effect.
    """ # noqa: E501
    audio_export_settings: Optional[GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettings] = Field(default=None, alias="audioExportSettings")
    ...
    insights_export_settings: Optional[GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettings] = Field(default=None, alias="insightsExportSettings")
    ...
    redaction_scope: Optional[StrictStr] = Field(default=None, description="Defines the data for which Dialogflow applies redaction. Dialogflow does not redact data that it does not have access to – for example, Cloud logging.", alias="redactionScope")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3SecuritySettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3SecuritySettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "audioExportSettings": GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettings.from_dict(obj["audioExportSettings"]) if obj.get("audioExportSettings") is not None else None,
            "deidentifyTemplate": obj.get("deidentifyTemplate"),
            "displayName": obj.get("displayName"),
            "insightsExportSettings": GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettings.from_dict(obj["insightsExportSettings"]) if obj.get("insightsExportSettings") is not None else None,
