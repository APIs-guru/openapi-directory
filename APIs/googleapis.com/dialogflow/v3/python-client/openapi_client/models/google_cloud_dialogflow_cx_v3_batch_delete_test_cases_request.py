...
class GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest(BaseModel):
    """
    The request message for TestCases.BatchDeleteTestCases.
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="Required. Format of test case names: `projects//locations/ /agents//testCases/`.")
