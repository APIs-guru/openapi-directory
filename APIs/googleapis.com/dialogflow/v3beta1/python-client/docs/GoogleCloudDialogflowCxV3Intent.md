...
**parameters** | [**List[GoogleCloudDialogflowCxV3IntentParameter]**](GoogleCloudDialogflowCxV3IntentParameter.md) | The collection of parameters associated with the intent. | [optional] 
...
**training_phrases** | [**List[GoogleCloudDialogflowCxV3IntentTrainingPhrase]**](GoogleCloudDialogflowCxV3IntentTrainingPhrase.md) | The collection of training phrases the agent is trained on to identify the intent. | [optional] 
...
google_cloud_dialogflow_cx_v3_intent_instance = GoogleCloudDialogflowCxV3Intent.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3Intent.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3_intent_dict = google_cloud_dialogflow_cx_v3_intent_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3Intent from a dict
google_cloud_dialogflow_cx_v3_intent_from_dict = GoogleCloudDialogflowCxV3Intent.from_dict(google_cloud_dialogflow_cx_v3_intent_dict)
```
