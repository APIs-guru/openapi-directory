...
google_cloud_dialogflow_cx_v3beta1_export_test_cases_request_instance = GoogleCloudDialogflowCxV3beta1ExportTestCasesRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3beta1ExportTestCasesRequest.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3beta1_export_test_cases_request_dict = google_cloud_dialogflow_cx_v3beta1_export_test_cases_request_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3beta1ExportTestCasesRequest from a dict
google_cloud_dialogflow_cx_v3beta1_export_test_cases_request_from_dict = GoogleCloudDialogflowCxV3beta1ExportTestCasesRequest.from_dict(google_cloud_dialogflow_cx_v3beta1_export_test_cases_request_dict)
```
