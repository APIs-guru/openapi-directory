...
**search_config** | [**GoogleCloudDialogflowCxV3beta1SearchConfig**](GoogleCloudDialogflowCxV3beta1SearchConfig.md) |  | [optional] 
**session_entity_types** | [**List[GoogleCloudDialogflowCxV3beta1SessionEntityType]**](GoogleCloudDialogflowCxV3beta1SessionEntityType.md) | Additional session entity types to replace or extend developer entity types with. The entity synonyms apply to all languages and persist for the session of this query. | [optional] 
...
google_cloud_dialogflow_cx_v3beta1_query_parameters_instance = GoogleCloudDialogflowCxV3beta1QueryParameters.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDialogflowCxV3beta1QueryParameters.to_json())

# convert the object into a dict
google_cloud_dialogflow_cx_v3beta1_query_parameters_dict = google_cloud_dialogflow_cx_v3beta1_query_parameters_instance.to_dict()
# create an instance of GoogleCloudDialogflowCxV3beta1QueryParameters from a dict
google_cloud_dialogflow_cx_v3beta1_query_parameters_from_dict = GoogleCloudDialogflowCxV3beta1QueryParameters.from_dict(google_cloud_dialogflow_cx_v3beta1_query_parameters_dict)
```
