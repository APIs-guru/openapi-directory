...
class GoogleCloudDialogflowCxV3beta1IntentCoverage(BaseModel):
    ...
    """ # noqa: E501
    coverage_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent of intents in the agent that are covered.", alias="coverageScore")
    intents: Optional[List[GoogleCloudDialogflowCxV3beta1IntentCoverageIntent]] = Field(default=None, description="The list of Intents present in the agent")
    __properties: ClassVar[List[str]] = ["coverageScore", "intents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intents": [GoogleCloudDialogflowCxV3beta1IntentCoverageIntent.from_dict(_item) for _item in obj["intents"]] if obj.get("intents") is not None else None
        })
        return _obj
