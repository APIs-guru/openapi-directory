...
class GoogleCloudDialogflowCxV3beta1MatchIntentResponse(BaseModel):
    ...
    matches: Optional[List[GoogleCloudDialogflowCxV3beta1Match]] = Field(default=None, description="Match results, if more than one, ordered descendingly by the confidence we have that the particular intent matches the query.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [GoogleCloudDialogflowCxV3beta1Match.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "text": obj.get("text"),
