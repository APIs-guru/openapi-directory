...
class GoogleCloudDialogflowCxV3beta1IntentCoverageIntent(BaseModel):
    ...
    The agent's intent.
    """ # noqa: E501
    covered: Optional[StrictBool] = Field(default=None, description="Whether the intent is covered by at least one of the agent's test cases.")
    intent: Optional[StrictStr] = Field(default=None, description="The intent full resource name")
    __properties: ClassVar[List[str]] = ["covered", "intent"]
