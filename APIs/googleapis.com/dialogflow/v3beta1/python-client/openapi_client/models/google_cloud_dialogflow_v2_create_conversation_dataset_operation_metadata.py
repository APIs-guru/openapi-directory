...
class GoogleCloudDialogflowV2CreateConversationDatasetOperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    conversation_dataset: Optional[StrictStr] = Field(default=None, description="The resource name of the conversation dataset that will be created. Format: `projects//locations//conversationDatasets/`", alias="conversationDataset")
    __properties: ClassVar[List[str]] = ["conversationDataset"]
