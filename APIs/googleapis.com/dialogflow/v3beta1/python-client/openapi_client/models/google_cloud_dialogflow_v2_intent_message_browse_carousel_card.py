...
class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard(BaseModel):
    ...
    items: Optional[List[GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem]] = Field(default=None, description="Required. List of items in the Browse Carousel Card. Minimum of two items, maximum of ten.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
