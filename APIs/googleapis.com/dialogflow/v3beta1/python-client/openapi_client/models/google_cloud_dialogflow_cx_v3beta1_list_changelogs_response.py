...
class GoogleCloudDialogflowCxV3beta1ListChangelogsResponse(BaseModel):
    ...
    """ # noqa: E501
    changelogs: Optional[List[GoogleCloudDialogflowCxV3beta1Changelog]] = Field(default=None, description="The list of changelogs. There will be a maximum number of items returned based on the page_size field in the request. The changelogs will be ordered by timestamp.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changelogs": [GoogleCloudDialogflowCxV3beta1Changelog.from_dict(_item) for _item in obj["changelogs"]] if obj.get("changelogs") is not None else None,
