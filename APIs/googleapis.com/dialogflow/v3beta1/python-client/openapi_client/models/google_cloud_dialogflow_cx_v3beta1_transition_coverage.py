...
class GoogleCloudDialogflowCxV3beta1TransitionCoverage(BaseModel):
    ...
    transitions: Optional[List[GoogleCloudDialogflowCxV3beta1TransitionCoverageTransition]] = Field(default=None, description="The list of Transitions present in the agent.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transitions": [GoogleCloudDialogflowCxV3beta1TransitionCoverageTransition.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None
        })
        return _obj
