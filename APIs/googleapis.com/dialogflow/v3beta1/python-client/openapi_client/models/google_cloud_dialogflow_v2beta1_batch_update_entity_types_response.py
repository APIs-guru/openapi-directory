...
class GoogleCloudDialogflowV2beta1BatchUpdateEntityTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    entity_types: Optional[List[GoogleCloudDialogflowV2beta1EntityType]] = Field(default=None, description="The collection of updated or created entity types.", alias="entityTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityTypes": [GoogleCloudDialogflowV2beta1EntityType.from_dict(_item) for _item in obj["entityTypes"]] if obj.get("entityTypes") is not None else None
        })
        return _obj
