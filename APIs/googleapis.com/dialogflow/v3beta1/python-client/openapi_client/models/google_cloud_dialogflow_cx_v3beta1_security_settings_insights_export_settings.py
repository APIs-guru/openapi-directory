...
class GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings(BaseModel):
    ...
    """ # noqa: E501
    enable_insights_export: Optional[StrictBool] = Field(default=None, description="If enabled, we will automatically exports conversations to Insights and Insights runs its analyzers.", alias="enableInsightsExport")
    __properties: ClassVar[List[str]] = ["enableInsightsExport"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enableInsightsExport": obj.get("enableInsightsExport")
        })
        return _obj
