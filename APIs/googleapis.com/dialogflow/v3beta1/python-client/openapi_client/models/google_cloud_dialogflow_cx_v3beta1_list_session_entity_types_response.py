...
class GoogleCloudDialogflowCxV3beta1ListSessionEntityTypesResponse(BaseModel):
    ...
    session_entity_types: Optional[List[GoogleCloudDialogflowCxV3beta1SessionEntityType]] = Field(default=None, description="The list of session entity types. There will be a maximum number of items returned based on the page_size field in the request.", alias="sessionEntityTypes")
    __properties: ClassVar[List[str]] = ["nextPageToken", "sessionEntityTypes"]
