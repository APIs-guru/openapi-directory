...
class GoogleCloudDialogflowCxV3beta1ListWebhooksResponse(BaseModel):
    ...
    webhooks: Optional[List[GoogleCloudDialogflowCxV3beta1Webhook]] = Field(default=None, description="The list of webhooks. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webhooks": [GoogleCloudDialogflowCxV3beta1Webhook.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
