...
class GoogleCloudDialogflowCxV3beta1GenerativeSettings(BaseModel):
    """
    Settings for Generative AI.
    """ # noqa: E501
    fallback_settings: Optional[GoogleCloudDialogflowCxV3beta1GenerativeSettingsFallbackSettings] = Field(default=None, alias="fallbackSettings")
    generative_safety_settings: Optional[GoogleCloudDialogflowCxV3beta1SafetySettings] = Field(default=None, alias="generativeSafetySettings")
    knowledge_connector_settings: Optional[GoogleCloudDialogflowCxV3beta1GenerativeSettingsKnowledgeConnectorSettings] = Field(default=None, alias="knowledgeConnectorSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fallbackSettings": GoogleCloudDialogflowCxV3beta1GenerativeSettingsFallbackSettings.from_dict(obj["fallbackSettings"]) if obj.get("fallbackSettings") is not None else None,
            "generativeSafetySettings": GoogleCloudDialogflowCxV3beta1SafetySettings.from_dict(obj["generativeSafetySettings"]) if obj.get("generativeSafetySettings") is not None else None,
            "knowledgeConnectorSettings": GoogleCloudDialogflowCxV3beta1GenerativeSettingsKnowledgeConnectorSettings.from_dict(obj["knowledgeConnectorSettings"]) if obj.get("knowledgeConnectorSettings") is not None else None,
