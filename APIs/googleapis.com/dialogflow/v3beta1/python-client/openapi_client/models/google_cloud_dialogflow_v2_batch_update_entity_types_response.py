...
class GoogleCloudDialogflowV2BatchUpdateEntityTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    entity_types: Optional[List[GoogleCloudDialogflowV2EntityType]] = Field(default=None, description="The collection of updated or created entity types.", alias="entityTypes")
