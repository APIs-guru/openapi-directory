...
class GoogleCloudDialogflowCxV3beta1ExportAgentRequest(BaseModel):
    ...
    git_destination: Optional[GoogleCloudDialogflowCxV3beta1ExportAgentRequestGitDestination] = Field(default=None, alias="gitDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gitDestination": GoogleCloudDialogflowCxV3beta1ExportAgentRequestGitDestination.from_dict(obj["gitDestination"]) if obj.get("gitDestination") is not None else None,
