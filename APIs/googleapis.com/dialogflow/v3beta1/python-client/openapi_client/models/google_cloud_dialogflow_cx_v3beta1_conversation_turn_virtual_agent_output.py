...
class GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutput(BaseModel):
    ...
    differences: Optional[List[GoogleCloudDialogflowCxV3beta1TestRunDifference]] = Field(default=None, description="Output only. If this is part of a result conversation turn, the list of differences between the original run and the replay for this output, if any.")
    ...
    text_responses: Optional[List[GoogleCloudDialogflowCxV3beta1ResponseMessageText]] = Field(default=None, description="The text responses from the agent for the turn.", alias="textResponses")
    triggered_intent: Optional[GoogleCloudDialogflowCxV3beta1Intent] = Field(default=None, alias="triggeredIntent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "differences": [GoogleCloudDialogflowCxV3beta1TestRunDifference.from_dict(_item) for _item in obj["differences"]] if obj.get("differences") is not None else None,
            ...
            "textResponses": [GoogleCloudDialogflowCxV3beta1ResponseMessageText.from_dict(_item) for _item in obj["textResponses"]] if obj.get("textResponses") is not None else None,
            "triggeredIntent": GoogleCloudDialogflowCxV3beta1Intent.from_dict(obj["triggeredIntent"]) if obj.get("triggeredIntent") is not None else None
        })
        return _obj
