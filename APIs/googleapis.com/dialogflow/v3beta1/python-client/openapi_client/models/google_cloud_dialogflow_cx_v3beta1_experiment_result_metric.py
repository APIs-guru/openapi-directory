...
class GoogleCloudDialogflowCxV3beta1ExperimentResultMetric(BaseModel):
    ...
    """ # noqa: E501
    confidence_interval: Optional[GoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval] = Field(default=None, alias="confidenceInterval")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidenceInterval": GoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval.from_dict(obj["confidenceInterval"]) if obj.get("confidenceInterval") is not None else None,
            "count": obj.get("count"),
