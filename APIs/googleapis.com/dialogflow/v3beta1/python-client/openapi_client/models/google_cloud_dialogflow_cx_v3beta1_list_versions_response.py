...
class GoogleCloudDialogflowCxV3beta1ListVersionsResponse(BaseModel):
    ...
    versions: Optional[List[GoogleCloudDialogflowCxV3beta1Version]] = Field(default=None, description="A list of versions. There will be a maximum number of items returned based on the page_size field in the request. The list may in some cases be empty or contain fewer entries than page_size even if this isn't the last page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [GoogleCloudDialogflowCxV3beta1Version.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
