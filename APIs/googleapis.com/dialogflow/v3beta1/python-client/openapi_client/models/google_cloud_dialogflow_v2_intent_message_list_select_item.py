...
class GoogleCloudDialogflowV2IntentMessageListSelectItem(BaseModel):
    ...
    An item in the list.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Optional. The main text describing the item.")
    image: Optional[GoogleCloudDialogflowV2IntentMessageImage] = None
    info: Optional[GoogleCloudDialogflowV2IntentMessageSelectItemInfo] = None
    title: Optional[StrictStr] = Field(default=None, description="Required. The title of the list item.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": GoogleCloudDialogflowV2IntentMessageSelectItemInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "title": obj.get("title")
        })
        return _obj
