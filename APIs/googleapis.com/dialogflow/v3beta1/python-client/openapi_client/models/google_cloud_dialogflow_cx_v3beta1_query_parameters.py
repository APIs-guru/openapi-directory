...
class GoogleCloudDialogflowCxV3beta1QueryParameters(BaseModel):
    ...
    search_config: Optional[GoogleCloudDialogflowCxV3beta1SearchConfig] = Field(default=None, alias="searchConfig")
    session_entity_types: Optional[List[GoogleCloudDialogflowCxV3beta1SessionEntityType]] = Field(default=None, description="Additional session entity types to replace or extend developer entity types with. The entity synonyms apply to all languages and persist for the session of this query.", alias="sessionEntityTypes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3beta1QueryParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3beta1QueryParameters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "searchConfig": GoogleCloudDialogflowCxV3beta1SearchConfig.from_dict(obj["searchConfig"]) if obj.get("searchConfig") is not None else None,
            "sessionEntityTypes": [GoogleCloudDialogflowCxV3beta1SessionEntityType.from_dict(_item) for _item in obj["sessionEntityTypes"]] if obj.get("sessionEntityTypes") is not None else None,
