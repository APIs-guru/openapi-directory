...
class GoogleCloudDialogflowV2beta1SessionEntityType(BaseModel):
    ...
    """ # noqa: E501
    entities: Optional[List[GoogleCloudDialogflowV2beta1EntityTypeEntity]] = Field(default=None, description="Required. The collection of entities associated with this session entity type.")
