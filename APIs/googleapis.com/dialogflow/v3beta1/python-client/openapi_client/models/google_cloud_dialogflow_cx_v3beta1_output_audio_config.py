...
class GoogleCloudDialogflowCxV3beta1OutputAudioConfig(BaseModel):
    ...
    synthesize_speech_config: Optional[GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfig] = Field(default=None, alias="synthesizeSpeechConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3beta1OutputAudioConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDialogflowCxV3beta1OutputAudioConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "synthesizeSpeechConfig": GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfig.from_dict(obj["synthesizeSpeechConfig"]) if obj.get("synthesizeSpeechConfig") is not None else None
        })
        return _obj
