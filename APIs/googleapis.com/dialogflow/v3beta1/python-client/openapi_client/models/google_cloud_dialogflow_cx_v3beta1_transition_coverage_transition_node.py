...
class GoogleCloudDialogflowCxV3beta1TransitionCoverageTransitionNode(BaseModel):
    ...
    """ # noqa: E501
    flow: Optional[GoogleCloudDialogflowCxV3beta1Flow] = None
    page: Optional[GoogleCloudDialogflowCxV3beta1Page] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flow": GoogleCloudDialogflowCxV3beta1Flow.from_dict(obj["flow"]) if obj.get("flow") is not None else None,
            "page": GoogleCloudDialogflowCxV3beta1Page.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
