...
class GoogleCloudDialogflowCxV3Environment(BaseModel):
    ...
    test_cases_config: Optional[GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig] = Field(default=None, alias="testCasesConfig")
    ...
    version_configs: Optional[List[GoogleCloudDialogflowCxV3EnvironmentVersionConfig]] = Field(default=None, description="A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.", alias="versionConfigs")
    webhook_config: Optional[GoogleCloudDialogflowCxV3EnvironmentWebhookConfig] = Field(default=None, alias="webhookConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "testCasesConfig": GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig.from_dict(obj["testCasesConfig"]) if obj.get("testCasesConfig") is not None else None,
            "updateTime": obj.get("updateTime"),
            "versionConfigs": [GoogleCloudDialogflowCxV3EnvironmentVersionConfig.from_dict(_item) for _item in obj["versionConfigs"]] if obj.get("versionConfigs") is not None else None,
            "webhookConfig": GoogleCloudDialogflowCxV3EnvironmentWebhookConfig.from_dict(obj["webhookConfig"]) if obj.get("webhookConfig") is not None else None
        })
        return _obj
