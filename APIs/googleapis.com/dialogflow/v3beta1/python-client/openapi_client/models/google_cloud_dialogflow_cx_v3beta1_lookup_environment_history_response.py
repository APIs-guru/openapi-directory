...
class GoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse(BaseModel):
    ...
    """ # noqa: E501
    environments: Optional[List[GoogleCloudDialogflowCxV3beta1Environment]] = Field(default=None, description="Represents a list of snapshots for an environment. Time of the snapshots is stored in `update_time`.")
