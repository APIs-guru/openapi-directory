...
class GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="The source of this request, e.g., `google`, `facebook`, `slack`. It is set by Dialogflow-owned servers.")
    version: Optional[StrictStr] = Field(default=None, description="Optional. The version of the protocol used for this request. This field is AoG-specific.")
    __properties: ClassVar[List[str]] = ["payload", "source", "version"]
