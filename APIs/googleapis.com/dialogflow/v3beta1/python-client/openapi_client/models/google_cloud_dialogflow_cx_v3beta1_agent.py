...
class GoogleCloudDialogflowCxV3beta1Agent(BaseModel):
    ...
    answer_feedback_settings: Optional[GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings] = Field(default=None, alias="answerFeedbackSettings")
    ...
    gen_app_builder_settings: Optional[GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings] = Field(default=None, alias="genAppBuilderSettings")
    git_integration_settings: Optional[GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings] = Field(default=None, alias="gitIntegrationSettings")
    ...
    speech_to_text_settings: Optional[GoogleCloudDialogflowCxV3beta1SpeechToTextSettings] = Field(default=None, alias="speechToTextSettings")
    ...
    text_to_speech_settings: Optional[GoogleCloudDialogflowCxV3beta1TextToSpeechSettings] = Field(default=None, alias="textToSpeechSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "answerFeedbackSettings": GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings.from_dict(obj["answerFeedbackSettings"]) if obj.get("answerFeedbackSettings") is not None else None,
            ...
            "genAppBuilderSettings": GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings.from_dict(obj["genAppBuilderSettings"]) if obj.get("genAppBuilderSettings") is not None else None,
            "gitIntegrationSettings": GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings.from_dict(obj["gitIntegrationSettings"]) if obj.get("gitIntegrationSettings") is not None else None,
            "locked": obj.get("locked"),
            "name": obj.get("name"),
            "securitySettings": obj.get("securitySettings"),
            "speechToTextSettings": GoogleCloudDialogflowCxV3beta1SpeechToTextSettings.from_dict(obj["speechToTextSettings"]) if obj.get("speechToTextSettings") is not None else None,
            "startFlow": obj.get("startFlow"),
            "supportedLanguageCodes": obj.get("supportedLanguageCodes"),
            "textToSpeechSettings": GoogleCloudDialogflowCxV3beta1TextToSpeechSettings.from_dict(obj["textToSpeechSettings"]) if obj.get("textToSpeechSettings") is not None else None,
