...
class GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse(BaseModel):
    ...
    test_case_results: Optional[List[GoogleCloudDialogflowCxV3beta1TestCaseResult]] = Field(default=None, description="The list of test case results.", alias="testCaseResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testCaseResults": [GoogleCloudDialogflowCxV3beta1TestCaseResult.from_dict(_item) for _item in obj["testCaseResults"]] if obj.get("testCaseResults") is not None else None
        })
        return _obj
