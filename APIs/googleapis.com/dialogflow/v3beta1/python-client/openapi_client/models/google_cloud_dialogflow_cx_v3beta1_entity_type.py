...
class GoogleCloudDialogflowCxV3beta1EntityType(BaseModel):
    ...
    entities: Optional[List[GoogleCloudDialogflowCxV3beta1EntityTypeEntity]] = Field(default=None, description="The collection of entity entries associated with the entity type.")
    excluded_phrases: Optional[List[GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase]] = Field(default=None, description="Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry `giant`(an adjective), you might consider adding `giants`(a noun) as an exclusion. If the kind of entity type is `KIND_MAP`, then the phrases specified by entities and excluded phrases should be mutually exclusive.", alias="excludedPhrases")
    ...
    redact: Optional[StrictBool] = Field(default=None, description="Indicates whether parameters of the entity type should be redacted in log. If redaction is enabled, page parameters and intent parameters referring to the entity type will be replaced by parameter name during logging.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludedPhrases": [GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase.from_dict(_item) for _item in obj["excludedPhrases"]] if obj.get("excludedPhrases") is not None else None,
            "kind": obj.get("kind"),
            "name": obj.get("name"),
