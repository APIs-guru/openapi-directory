...
class GoogleCloudDialogflowCxV3beta1Experiment(BaseModel):
    ...
    definition: Optional[GoogleCloudDialogflowCxV3beta1ExperimentDefinition] = None
    ...
    experiment_length: Optional[StrictStr] = Field(default=None, description="Maximum number of days to run the experiment. If auto-rollout is not enabled, default value and maximum will be 30 days. If auto-rollout is enabled, default value and maximum will be 6 days.", alias="experimentLength")
    ...
    result: Optional[GoogleCloudDialogflowCxV3beta1ExperimentResult] = None
    rollout_config: Optional[GoogleCloudDialogflowCxV3beta1RolloutConfig] = Field(default=None, alias="rolloutConfig")
    ...
    rollout_state: Optional[GoogleCloudDialogflowCxV3beta1RolloutState] = Field(default=None, alias="rolloutState")
    ...
    variants_history: Optional[List[GoogleCloudDialogflowCxV3beta1VariantsHistory]] = Field(default=None, description="The history of updates to the experiment variants.", alias="variantsHistory")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definition": GoogleCloudDialogflowCxV3beta1ExperimentDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
            ...
            "name": obj.get("name"),
            "result": GoogleCloudDialogflowCxV3beta1ExperimentResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "rolloutConfig": GoogleCloudDialogflowCxV3beta1RolloutConfig.from_dict(obj["rolloutConfig"]) if obj.get("rolloutConfig") is not None else None,
            "rolloutFailureReason": obj.get("rolloutFailureReason"),
            "rolloutState": GoogleCloudDialogflowCxV3beta1RolloutState.from_dict(obj["rolloutState"]) if obj.get("rolloutState") is not None else None,
            "startTime": obj.get("startTime"),
            "state": obj.get("state"),
            "variantsHistory": [GoogleCloudDialogflowCxV3beta1VariantsHistory.from_dict(_item) for _item in obj["variantsHistory"]] if obj.get("variantsHistory") is not None else None
        })
        return _obj
