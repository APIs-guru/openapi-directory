...
class GoogleCloudDialogflowCxV3beta1ListDeploymentsResponse(BaseModel):
    ...
    """ # noqa: E501
    deployments: Optional[List[GoogleCloudDialogflowCxV3beta1Deployment]] = Field(default=None, description="The list of deployments. There will be a maximum number of items returned based on the page_size field in the request. The list may in some cases be empty or contain fewer entries than page_size even if this isn't the last page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployments": [GoogleCloudDialogflowCxV3beta1Deployment.from_dict(_item) for _item in obj["deployments"]] if obj.get("deployments") is not None else None,
