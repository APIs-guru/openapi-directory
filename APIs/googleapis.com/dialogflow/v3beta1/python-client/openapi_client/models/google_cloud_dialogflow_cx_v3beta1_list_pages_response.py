...
class GoogleCloudDialogflowCxV3beta1ListPagesResponse(BaseModel):
    ...
    pages: Optional[List[GoogleCloudDialogflowCxV3beta1Page]] = Field(default=None, description="The list of pages. There will be a maximum number of items returned based on the page_size field in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [GoogleCloudDialogflowCxV3beta1Page.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None
        })
        return _obj
