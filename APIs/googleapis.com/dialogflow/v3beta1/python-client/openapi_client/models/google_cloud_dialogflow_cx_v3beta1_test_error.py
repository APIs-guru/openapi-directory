...
class GoogleCloudDialogflowCxV3beta1TestError(BaseModel):
    ...
    test_case: Optional[StrictStr] = Field(default=None, description="The test case resource name.", alias="testCase")
    test_time: Optional[StrictStr] = Field(default=None, description="The timestamp when the test was completed.", alias="testTime")
    __properties: ClassVar[List[str]] = ["status", "testCase", "testTime"]
