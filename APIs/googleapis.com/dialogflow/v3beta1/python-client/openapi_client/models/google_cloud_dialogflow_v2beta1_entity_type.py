...
class GoogleCloudDialogflowV2beta1EntityType(BaseModel):
    ...
    entities: Optional[List[GoogleCloudDialogflowV2beta1EntityTypeEntity]] = Field(default=None, description="Optional. The collection of entity entries associated with the entity type.")
    kind: Optional[StrictStr] = Field(default=None, description="Required. Indicates the kind of entity type.")
    name: Optional[StrictStr] = Field(default=None, description="The unique identifier of the entity type. Required for EntityTypes.UpdateEntityType and EntityTypes.BatchUpdateEntityTypes methods. Supported formats: - `projects//agent/entityTypes/` - `projects//locations//agent/entityTypes/`")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": [GoogleCloudDialogflowV2beta1EntityTypeEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "kind": obj.get("kind"),
            "name": obj.get("name")
        })
        return _obj
