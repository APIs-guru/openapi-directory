...
class TestGoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase(unittest.TestCase):
    """GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase:
        """Test GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase`
        """
        model = GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase(self):
        """Test GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCase"""
