...
class TestGoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse:
        """Test GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse`
        """
        model = GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse(
                next_page_token = '',
                test_case_results = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3beta1_test_case_result.GoogleCloudDialogflowCxV3beta1TestCaseResult(
                        conversation_turns = [
    ...
    def testGoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse(self):
        """Test GoogleCloudDialogflowCxV3beta1ListTestCaseResultsResponse"""
