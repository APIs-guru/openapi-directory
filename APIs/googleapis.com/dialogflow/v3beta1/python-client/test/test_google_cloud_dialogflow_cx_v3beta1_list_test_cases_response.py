...
class TestGoogleCloudDialogflowCxV3beta1ListTestCasesResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1ListTestCasesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1ListTestCasesResponse:
        """Test GoogleCloudDialogflowCxV3beta1ListTestCasesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1ListTestCasesResponse`
        """
        model = GoogleCloudDialogflowCxV3beta1ListTestCasesResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3beta1ListTestCasesResponse(
                next_page_token = '',
                test_cases = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3beta1_test_case.GoogleCloudDialogflowCxV3beta1TestCase(
                        creation_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudDialogflowCxV3beta1ListTestCasesResponse(self):
        """Test GoogleCloudDialogflowCxV3beta1ListTestCasesResponse"""
