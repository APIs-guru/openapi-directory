...
class TestGoogleCloudDialogflowCxV3beta1Agent(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1Agent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1Agent:
        """Test GoogleCloudDialogflowCxV3beta1Agent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1Agent`
        """
        model = GoogleCloudDialogflowCxV3beta1Agent()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1Agent(self):
        """Test GoogleCloudDialogflowCxV3beta1Agent"""
