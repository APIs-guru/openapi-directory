...
class TestGoogleCloudDialogflowCxV3TestCaseError(unittest.TestCase):
    """GoogleCloudDialogflowCxV3TestCaseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3TestCaseError:
        """Test GoogleCloudDialogflowCxV3TestCaseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3TestCaseError`
        """
        model = GoogleCloudDialogflowCxV3TestCaseError()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3TestCaseError(self):
        """Test GoogleCloudDialogflowCxV3TestCaseError"""
