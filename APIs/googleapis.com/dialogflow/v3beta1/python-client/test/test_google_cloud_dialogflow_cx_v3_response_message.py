...
class TestGoogleCloudDialogflowCxV3ResponseMessage(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ResponseMessage:
        """Test GoogleCloudDialogflowCxV3ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ResponseMessage`
        """
        model = GoogleCloudDialogflowCxV3ResponseMessage()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3ResponseMessage(self):
        """Test GoogleCloudDialogflowCxV3ResponseMessage"""
