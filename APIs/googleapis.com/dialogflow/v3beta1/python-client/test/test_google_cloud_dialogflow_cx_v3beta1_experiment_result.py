...
class TestGoogleCloudDialogflowCxV3beta1ExperimentResult(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1ExperimentResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1ExperimentResult:
        """Test GoogleCloudDialogflowCxV3beta1ExperimentResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1ExperimentResult`
        """
        model = GoogleCloudDialogflowCxV3beta1ExperimentResult()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1ExperimentResult(self):
        """Test GoogleCloudDialogflowCxV3beta1ExperimentResult"""
