...
class TestGoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage:
        """Test GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage`
        """
        model = GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage(self):
        """Test GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverage"""
