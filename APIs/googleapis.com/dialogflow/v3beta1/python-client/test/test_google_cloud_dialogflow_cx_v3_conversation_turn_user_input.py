...
class TestGoogleCloudDialogflowCxV3ConversationTurnUserInput(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ConversationTurnUserInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ConversationTurnUserInput:
        """Test GoogleCloudDialogflowCxV3ConversationTurnUserInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ConversationTurnUserInput`
        """
        model = GoogleCloudDialogflowCxV3ConversationTurnUserInput()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3ConversationTurnUserInput(self):
        """Test GoogleCloudDialogflowCxV3ConversationTurnUserInput"""
