...
class TestGoogleCloudDialogflowCxV3ImportTestCasesMetadata(unittest.TestCase):
    """GoogleCloudDialogflowCxV3ImportTestCasesMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3ImportTestCasesMetadata:
        """Test GoogleCloudDialogflowCxV3ImportTestCasesMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3ImportTestCasesMetadata`
        """
        model = GoogleCloudDialogflowCxV3ImportTestCasesMetadata()
        if include_optional:
            return GoogleCloudDialogflowCxV3ImportTestCasesMetadata(
                errors = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3_test_case_error.GoogleCloudDialogflowCxV3TestCaseError(
                        status = openapi_client.models.google_rpc_status.GoogleRpcStatus(
                            ...
                            message = '', ), 
                        test_case = openapi_client.models.google_cloud_dialogflow_cx_v3_test_case.GoogleCloudDialogflowCxV3TestCase(
                            creation_time = '', 
                            display_name = '', 
                            last_test_result = openapi_client.models.google_cloud_dialogflow_cx_v3_test_case_result.GoogleCloudDialogflowCxV3TestCaseResult(
                                conversation_turns = [
                            ...
                            test_config = openapi_client.models.google_cloud_dialogflow_cx_v3_test_config.GoogleCloudDialogflowCxV3TestConfig(
                                flow = '', 
                                page = '', 
                                tracking_parameters = [
                                    ''
    ...
    def testGoogleCloudDialogflowCxV3ImportTestCasesMetadata(self):
        """Test GoogleCloudDialogflowCxV3ImportTestCasesMetadata"""
