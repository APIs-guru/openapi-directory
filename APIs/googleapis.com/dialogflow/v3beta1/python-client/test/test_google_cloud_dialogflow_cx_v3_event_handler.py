...
class TestGoogleCloudDialogflowCxV3EventHandler(unittest.TestCase):
    """GoogleCloudDialogflowCxV3EventHandler unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3EventHandler:
        """Test GoogleCloudDialogflowCxV3EventHandler
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3EventHandler`
        """
        model = GoogleCloudDialogflowCxV3EventHandler()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3EventHandler(self):
        """Test GoogleCloudDialogflowCxV3EventHandler"""
