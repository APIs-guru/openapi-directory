...
class TestGoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition:
        """Test GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition`
        """
        model = GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition(self):
        """Test GoogleCloudDialogflowCxV3beta1TransitionRouteGroupCoverageCoverageTransition"""
