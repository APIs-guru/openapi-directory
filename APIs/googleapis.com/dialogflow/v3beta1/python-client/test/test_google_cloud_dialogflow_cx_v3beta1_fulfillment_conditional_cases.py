...
class TestGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases:
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases`
        """
        model = GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases()
        if include_optional:
    ...
    def testGoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases(self):
        """Test GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases"""
