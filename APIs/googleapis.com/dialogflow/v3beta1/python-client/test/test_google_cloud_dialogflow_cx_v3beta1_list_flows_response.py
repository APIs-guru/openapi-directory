...
class TestGoogleCloudDialogflowCxV3beta1ListFlowsResponse(unittest.TestCase):
    """GoogleCloudDialogflowCxV3beta1ListFlowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDialogflowCxV3beta1ListFlowsResponse:
        """Test GoogleCloudDialogflowCxV3beta1ListFlowsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDialogflowCxV3beta1ListFlowsResponse`
        """
        model = GoogleCloudDialogflowCxV3beta1ListFlowsResponse()
        if include_optional:
            return GoogleCloudDialogflowCxV3beta1ListFlowsResponse(
                flows = [
                    openapi_client.models.google_cloud_dialogflow_cx_v3beta1_flow.GoogleCloudDialogflowCxV3beta1Flow(
    ...
    def testGoogleCloudDialogflowCxV3beta1ListFlowsResponse(self):
        """Test GoogleCloudDialogflowCxV3beta1ListFlowsResponse"""
