...
class RepresentativeInfoResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='civicinfo#representativeInfoResponse', description="Identifies what kind of resource this is. Value: the fixed string \"civicinfo#representativeInfoResponse\".")
    ...
    __properties: ClassVar[List[str]] = ["divisions", "kind", "normalizedInput", "offices", "officials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'civicinfo#representativeInfoResponse',
