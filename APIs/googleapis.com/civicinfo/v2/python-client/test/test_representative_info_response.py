...
class TestRepresentativeInfoResponse(unittest.TestCase):
    """RepresentativeInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepresentativeInfoResponse:
        """Test RepresentativeInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepresentativeInfoResponse`
        """
        model = RepresentativeInfoResponse()
        if include_optional:
    ...
    def testRepresentativeInfoResponse(self):
        """Test RepresentativeInfoResponse"""
