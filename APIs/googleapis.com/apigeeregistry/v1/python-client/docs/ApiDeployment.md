...
**api_spec_revision** | **str** | The full resource name (including revision ID) of the spec of the API being served by the deployment. Changes to this value will update the revision. Format: &#x60;projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec@revision}&#x60; | [optional] 
**create_time** | **str** | Output only. Creation timestamp; when the deployment resource was created. | [optional] [readonly] 
