...
**contents** | **bytearray** | Input only. The contents of the spec. Provided by API callers when specs are created or updated. To access the contents of a spec, use GetApiSpecContents. | [optional] 
**create_time** | **str** | Output only. Creation timestamp; when the spec resource was created. | [optional] [readonly] 
...
**revision_create_time** | **str** | Output only. Revision creation timestamp; when the represented revision was created. | [optional] [readonly] 
...
**revision_update_time** | **str** | Output only. Last update timestamp: when the represented revision was last modified. | [optional] [readonly] 
