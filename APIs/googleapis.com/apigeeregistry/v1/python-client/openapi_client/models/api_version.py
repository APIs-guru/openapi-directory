...
class ApiVersion(BaseModel):
    ...
    primary_spec: Optional[StrictStr] = Field(default=None, description="The primary spec for this version. Format: projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}", alias="primarySpec")
    ...
    __properties: ClassVar[List[str]] = ["annotations", "createTime", "description", "displayName", "labels", "name", "primarySpec", "state", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "primarySpec": obj.get("primarySpec"),
            "state": obj.get("state"),
