...
class ApiDeployment(BaseModel):
    ...
    api_spec_revision: Optional[StrictStr] = Field(default=None, description="The full resource name (including revision ID) of the spec of the API being served by the deployment. Changes to this value will update the revision. Format: `projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec@revision}`", alias="apiSpecRevision")
    create_time: Optional[StrictStr] = Field(default=None, description="Output only. Creation timestamp; when the deployment resource was created.", alias="createTime")
