...
class Api(BaseModel):
    ...
    recommended_deployment: Optional[StrictStr] = Field(default=None, description="The recommended deployment of the API. Format: `projects/{project}/locations/{location}/apis/{api}/deployments/{deployment}`", alias="recommendedDeployment")
    recommended_version: Optional[StrictStr] = Field(default=None, description="The recommended version of the API. Format: `projects/{project}/locations/{location}/apis/{api}/versions/{version}`", alias="recommendedVersion")
