...
class OperationMetadata(BaseModel):
    ...
    cancellation_requested: Optional[StrictBool] = Field(default=None, description="Identifies whether the user has requested cancellation of the operation. Operations that have successfully been cancelled have Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.", alias="cancellationRequested")
    ...
    __properties: ClassVar[List[str]] = ["apiVersion", "cancellationRequested", "createTime", "endTime", "statusMessage", "target", "verb"]
