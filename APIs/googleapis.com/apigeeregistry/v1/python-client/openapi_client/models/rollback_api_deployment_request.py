...
class RollbackApiDeploymentRequest(BaseModel):
    ...
    """ # noqa: E501
    revision_id: Optional[StrictStr] = Field(default=None, description="Required. The revision ID to roll back to. It must be a revision of the same deployment. Example: `c7cfa2a8`", alias="revisionId")
