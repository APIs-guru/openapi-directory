...
class StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData(BaseModel):
    """
    ...
    compliance: Optional[List[StorageDatabasecenterPartnerapiV1mainCompliance]] = Field(default=None, description="Industry standards associated with this signal; if this signal is an issue, that could be a violation of the associated industry standard(s). For example, AUTO_BACKUP_DISABLED signal is associated with CIS GCP 1.1, CIS GCP 1.2, CIS GCP 1.3, NIST 800-53 and ISO-27001 compliance standards. If a database resource does not have automated backup enable, it will violate these following industry standards.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compliance": [StorageDatabasecenterPartnerapiV1mainCompliance.from_dict(_item) for _item in obj["compliance"]] if obj.get("compliance") is not None else None,
