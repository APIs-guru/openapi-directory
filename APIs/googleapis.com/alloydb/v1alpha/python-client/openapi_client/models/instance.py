...
class Instance(BaseModel):
    ...
    network_config: Optional[InstanceNetworkConfig] = Field(default=None, alias="networkConfig")
    ...
    psc_instance_config: Optional[PscInstanceConfig] = Field(default=None, alias="pscInstanceConfig")
    ...
    __properties: ClassVar[List[str]] = ["annotations", "availabilityType", "clientConnectionConfig", "createTime", "databaseFlags", "deleteTime", "displayName", "etag", "gceZone", "instanceType", "ipAddress", "labels", "machineConfig", "name", "networkConfig", "nodes", "pscInstanceConfig", "publicIpAddress", "queryInsightsConfig", "readPoolConfig", "reconciling", "satisfiesPzi", "satisfiesPzs", "state", "uid", "updatePolicy", "updateTime", "writableNode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.nodes:
            ...
            _dict['nodes'] = _items
        # override the default output from pydantic by calling `to_dict()` of psc_instance_config
        if self.psc_instance_config:
            _dict['pscInstanceConfig'] = self.psc_instance_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "networkConfig": InstanceNetworkConfig.from_dict(obj["networkConfig"]) if obj.get("networkConfig") is not None else None,
            "nodes": [Node.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "pscInstanceConfig": PscInstanceConfig.from_dict(obj["pscInstanceConfig"]) if obj.get("pscInstanceConfig") is not None else None,
