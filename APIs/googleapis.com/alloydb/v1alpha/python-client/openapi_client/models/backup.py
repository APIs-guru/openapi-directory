...
class Backup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annotations", "clusterName", "clusterUid", "createTime", "databaseVersion", "deleteTime", "description", "displayName", "encryptionConfig", "encryptionInfo", "etag", "expiryQuantity", "expiryTime", "labels", "name", "reconciling", "satisfiesPzi", "satisfiesPzs", "sizeBytes", "state", "type", "uid", "updateTime"]
