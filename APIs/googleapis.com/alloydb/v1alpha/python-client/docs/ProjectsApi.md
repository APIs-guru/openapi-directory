...
------------- | ------------- | -------------
[**alloydb_projects_locations_backups_create**](ProjectsApi.md#alloydb_projects_locations_backups_create) | **POST** /v1alpha/{parent}/backups | 
[**alloydb_projects_locations_backups_list**](ProjectsApi.md#alloydb_projects_locations_backups_list) | **GET** /v1alpha/{parent}/backups | 
[**alloydb_projects_locations_clusters_create**](ProjectsApi.md#alloydb_projects_locations_clusters_create) | **POST** /v1alpha/{parent}/clusters | 
[**alloydb_projects_locations_clusters_createsecondary**](ProjectsApi.md#alloydb_projects_locations_clusters_createsecondary) | **POST** /v1alpha/{parent}/clusters:createsecondary | 
[**alloydb_projects_locations_clusters_generate_client_certificate**](ProjectsApi.md#alloydb_projects_locations_clusters_generate_client_certificate) | **POST** /v1alpha/{parent}:generateClientCertificate | 
[**alloydb_projects_locations_clusters_instances_create**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_create) | **POST** /v1alpha/{parent}/instances | 
[**alloydb_projects_locations_clusters_instances_createsecondary**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_createsecondary) | **POST** /v1alpha/{parent}/instances:createsecondary | 
[**alloydb_projects_locations_clusters_instances_failover**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_failover) | **POST** /v1alpha/{name}:failover | 
[**alloydb_projects_locations_clusters_instances_get_connection_info**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_get_connection_info) | **GET** /v1alpha/{parent}/connectionInfo | 
[**alloydb_projects_locations_clusters_instances_inject_fault**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_inject_fault) | **POST** /v1alpha/{name}:injectFault | 
[**alloydb_projects_locations_clusters_instances_list**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_list) | **GET** /v1alpha/{parent}/instances | 
[**alloydb_projects_locations_clusters_instances_restart**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_restart) | **POST** /v1alpha/{name}:restart | 
[**alloydb_projects_locations_clusters_list**](ProjectsApi.md#alloydb_projects_locations_clusters_list) | **GET** /v1alpha/{parent}/clusters | 
[**alloydb_projects_locations_clusters_promote**](ProjectsApi.md#alloydb_projects_locations_clusters_promote) | **POST** /v1alpha/{name}:promote | 
[**alloydb_projects_locations_clusters_restore**](ProjectsApi.md#alloydb_projects_locations_clusters_restore) | **POST** /v1alpha/{parent}/clusters:restore | 
[**alloydb_projects_locations_clusters_users_create**](ProjectsApi.md#alloydb_projects_locations_clusters_users_create) | **POST** /v1alpha/{parent}/users | 
[**alloydb_projects_locations_clusters_users_list**](ProjectsApi.md#alloydb_projects_locations_clusters_users_list) | **GET** /v1alpha/{parent}/users | 
[**alloydb_projects_locations_clusters_users_patch**](ProjectsApi.md#alloydb_projects_locations_clusters_users_patch) | **PATCH** /v1alpha/{name} | 
[**alloydb_projects_locations_list**](ProjectsApi.md#alloydb_projects_locations_list) | **GET** /v1alpha/{name}/locations | 
[**alloydb_projects_locations_operations_cancel**](ProjectsApi.md#alloydb_projects_locations_operations_cancel) | **POST** /v1alpha/{name}:cancel | 
[**alloydb_projects_locations_operations_delete**](ProjectsApi.md#alloydb_projects_locations_operations_delete) | **DELETE** /v1alpha/{name} | 
[**alloydb_projects_locations_operations_get**](ProjectsApi.md#alloydb_projects_locations_operations_get) | **GET** /v1alpha/{name} | 
[**alloydb_projects_locations_operations_list**](ProjectsApi.md#alloydb_projects_locations_operations_list) | **GET** /v1alpha/{name}/operations | 
[**alloydb_projects_locations_supported_database_flags_list**](ProjectsApi.md#alloydb_projects_locations_supported_database_flags_list) | **GET** /v1alpha/{parent}/supportedDatabaseFlags | 
