...
------------- | ------------- | -------------
[**alloydb_projects_locations_backups_create**](ProjectsApi.md#alloydb_projects_locations_backups_create) | **POST** /v1/{parent}/backups | 
[**alloydb_projects_locations_backups_list**](ProjectsApi.md#alloydb_projects_locations_backups_list) | **GET** /v1/{parent}/backups | 
[**alloydb_projects_locations_clusters_create**](ProjectsApi.md#alloydb_projects_locations_clusters_create) | **POST** /v1/{parent}/clusters | 
[**alloydb_projects_locations_clusters_createsecondary**](ProjectsApi.md#alloydb_projects_locations_clusters_createsecondary) | **POST** /v1/{parent}/clusters:createsecondary | 
[**alloydb_projects_locations_clusters_generate_client_certificate**](ProjectsApi.md#alloydb_projects_locations_clusters_generate_client_certificate) | **POST** /v1/{parent}:generateClientCertificate | 
[**alloydb_projects_locations_clusters_instances_create**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_create) | **POST** /v1/{parent}/instances | 
[**alloydb_projects_locations_clusters_instances_createsecondary**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_createsecondary) | **POST** /v1/{parent}/instances:createsecondary | 
[**alloydb_projects_locations_clusters_instances_failover**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_failover) | **POST** /v1/{name}:failover | 
[**alloydb_projects_locations_clusters_instances_get_connection_info**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_get_connection_info) | **GET** /v1/{parent}/connectionInfo | 
[**alloydb_projects_locations_clusters_instances_inject_fault**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_inject_fault) | **POST** /v1/{name}:injectFault | 
[**alloydb_projects_locations_clusters_instances_list**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_list) | **GET** /v1/{parent}/instances | 
[**alloydb_projects_locations_clusters_instances_restart**](ProjectsApi.md#alloydb_projects_locations_clusters_instances_restart) | **POST** /v1/{name}:restart | 
[**alloydb_projects_locations_clusters_list**](ProjectsApi.md#alloydb_projects_locations_clusters_list) | **GET** /v1/{parent}/clusters | 
[**alloydb_projects_locations_clusters_promote**](ProjectsApi.md#alloydb_projects_locations_clusters_promote) | **POST** /v1/{name}:promote | 
[**alloydb_projects_locations_clusters_restore**](ProjectsApi.md#alloydb_projects_locations_clusters_restore) | **POST** /v1/{parent}/clusters:restore | 
[**alloydb_projects_locations_clusters_users_create**](ProjectsApi.md#alloydb_projects_locations_clusters_users_create) | **POST** /v1/{parent}/users | 
[**alloydb_projects_locations_clusters_users_list**](ProjectsApi.md#alloydb_projects_locations_clusters_users_list) | **GET** /v1/{parent}/users | 
[**alloydb_projects_locations_clusters_users_patch**](ProjectsApi.md#alloydb_projects_locations_clusters_users_patch) | **PATCH** /v1/{name} | 
[**alloydb_projects_locations_list**](ProjectsApi.md#alloydb_projects_locations_list) | **GET** /v1/{name}/locations | 
[**alloydb_projects_locations_operations_cancel**](ProjectsApi.md#alloydb_projects_locations_operations_cancel) | **POST** /v1/{name}:cancel | 
[**alloydb_projects_locations_operations_delete**](ProjectsApi.md#alloydb_projects_locations_operations_delete) | **DELETE** /v1/{name} | 
[**alloydb_projects_locations_operations_get**](ProjectsApi.md#alloydb_projects_locations_operations_get) | **GET** /v1/{name} | 
[**alloydb_projects_locations_operations_list**](ProjectsApi.md#alloydb_projects_locations_operations_list) | **GET** /v1/{name}/operations | 
[**alloydb_projects_locations_supported_database_flags_list**](ProjectsApi.md#alloydb_projects_locations_supported_database_flags_list) | **GET** /v1/{parent}/supportedDatabaseFlags | 
...
> object alloydb_projects_locations_operations_cancel(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, body=body)
