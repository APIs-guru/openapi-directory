...
class RestartInstanceRequest(BaseModel):
    ...
    validate_only: Optional[StrictBool] = Field(default=None, description="Optional. If set, performs request validation (e.g. permission checks and any other type of validation), but do not actually execute the restart.", alias="validateOnly")
