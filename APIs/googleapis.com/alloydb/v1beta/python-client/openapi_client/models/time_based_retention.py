...
class TimeBasedRetention(BaseModel):
    ...
    """ # noqa: E501
    retention_period: Optional[StrictStr] = Field(default=None, description="The retention period.", alias="retentionPeriod")
    __properties: ClassVar[List[str]] = ["retentionPeriod"]
