...
class TestAddOrderDealsRequest(unittest.TestCase):
    """AddOrderDealsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOrderDealsRequest:
        """Test AddOrderDealsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOrderDealsRequest`
        """
        model = AddOrderDealsRequest()
        if include_optional:
    ...
    def testAddOrderDealsRequest(self):
        """Test AddOrderDealsRequest"""
