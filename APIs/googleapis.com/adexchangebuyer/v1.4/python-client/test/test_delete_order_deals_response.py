...
class TestDeleteOrderDealsResponse(unittest.TestCase):
    """DeleteOrderDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteOrderDealsResponse:
        """Test DeleteOrderDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteOrderDealsResponse`
        """
        model = DeleteOrderDealsResponse()
        if include_optional:
    ...
    def testDeleteOrderDealsResponse(self):
        """Test DeleteOrderDealsResponse"""
