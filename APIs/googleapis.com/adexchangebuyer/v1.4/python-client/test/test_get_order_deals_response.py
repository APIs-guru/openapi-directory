...
class TestGetOrderDealsResponse(unittest.TestCase):
    """GetOrderDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrderDealsResponse:
        """Test GetOrderDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrderDealsResponse`
        """
        model = GetOrderDealsResponse()
        if include_optional:
            return GetOrderDealsResponse(
                deals = [
                    openapi_client.models.marketplace_deal.MarketplaceDeal(
    ...
    def testGetOrderDealsResponse(self):
        """Test GetOrderDealsResponse"""
