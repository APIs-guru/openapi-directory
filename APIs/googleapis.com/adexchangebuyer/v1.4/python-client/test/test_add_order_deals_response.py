...
class TestAddOrderDealsResponse(unittest.TestCase):
    """AddOrderDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOrderDealsResponse:
        """Test AddOrderDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOrderDealsResponse`
        """
        model = AddOrderDealsResponse()
        if include_optional:
    ...
    def testAddOrderDealsResponse(self):
        """Test AddOrderDealsResponse"""
