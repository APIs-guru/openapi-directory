...
class TestSharedTargeting(unittest.TestCase):
    """SharedTargeting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharedTargeting:
        """Test SharedTargeting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharedTargeting`
        """
        model = SharedTargeting()
        if include_optional:
