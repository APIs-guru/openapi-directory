...
class TestEditAllOrderDealsResponse(unittest.TestCase):
    """EditAllOrderDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditAllOrderDealsResponse:
        """Test EditAllOrderDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditAllOrderDealsResponse`
        """
        model = EditAllOrderDealsResponse()
        if include_optional:
    ...
    def testEditAllOrderDealsResponse(self):
        """Test EditAllOrderDealsResponse"""
