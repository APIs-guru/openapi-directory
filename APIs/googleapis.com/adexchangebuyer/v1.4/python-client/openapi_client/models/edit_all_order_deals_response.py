...
class EditAllOrderDealsResponse(BaseModel):
    ...
    """ # noqa: E501
    deals: Optional[List[MarketplaceDeal]] = Field(default=None, description="List of all deals in the proposal after edit.")
    order_revision_number: Optional[StrictStr] = Field(default=None, description="The latest revision number after the update has been applied.", alias="orderRevisionNumber")
    __properties: ClassVar[List[str]] = ["deals", "orderRevisionNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderRevisionNumber": obj.get("orderRevisionNumber")
        })
        return _obj
