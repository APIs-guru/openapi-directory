...
class Dimension(BaseModel):
    ...
    """ # noqa: E501
    dimension_type: Optional[StrictStr] = Field(default=None, alias="dimensionType")
    dimension_values: Optional[List[DimensionDimensionValue]] = Field(default=None, alias="dimensionValues")
    __properties: ClassVar[List[str]] = ["dimensionType", "dimensionValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dimensionValues": [DimensionDimensionValue.from_dict(_item) for _item in obj["dimensionValues"]] if obj.get("dimensionValues") is not None else None
        })
        return _obj
