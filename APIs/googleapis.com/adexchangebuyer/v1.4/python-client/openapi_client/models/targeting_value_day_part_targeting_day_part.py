...
class TargetingValueDayPartTargetingDayPart(BaseModel):
    ...
    end_minute: Optional[StrictInt] = Field(default=None, alias="endMinute")
    start_hour: Optional[StrictInt] = Field(default=None, alias="startHour")
    start_minute: Optional[StrictInt] = Field(default=None, alias="startMinute")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TargetingValueDayPartTargetingDayPart from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TargetingValueDayPartTargetingDayPart from a dict"""
        if obj is None:
            return None
