...
class AddOrderDealsRequest(BaseModel):
    ...
    """ # noqa: E501
    deals: Optional[List[MarketplaceDeal]] = Field(default=None, description="The list of deals to add")
    proposal_revision_number: Optional[StrictStr] = Field(default=None, description="The last known proposal revision number.", alias="proposalRevisionNumber")
    ...
    __properties: ClassVar[List[str]] = ["deals", "proposalRevisionNumber", "updateAction"]
