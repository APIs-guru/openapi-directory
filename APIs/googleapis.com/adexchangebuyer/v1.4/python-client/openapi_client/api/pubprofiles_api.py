...
class PubprofilesApi:
    ...
    def adexchangebuyer_pubprofiles_list(
        self,
        account_id: Annotated[StrictInt, Field(description="The accountId of the publisher to get profiles for.")],
        ...
        :param account_id: The accountId of the publisher to get profiles for. (required)
        :type account_id: int
        ...
        _param = self._adexchangebuyer_pubprofiles_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPublisherProfilesByAccountIdResponse",
        }
    ...
    @validate_call
    def adexchangebuyer_pubprofiles_list_with_http_info(
        self,
        account_id: Annotated[StrictInt, Field(description="The accountId of the publisher to get profiles for.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPublisherProfilesByAccountIdResponse]:
        """adexchangebuyer_pubprofiles_list
    ...
    @validate_call
    def adexchangebuyer_pubprofiles_list_without_preload_content(
        self,
        account_id: Annotated[StrictInt, Field(description="The accountId of the publisher to get profiles for.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _adexchangebuyer_pubprofiles_list_serialize(
        self,
        account_id,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/publisher/{accountId}/profiles',
