...
class MarketplaceprivateauctionApi:
    ...
    def adexchangebuyer_marketplaceprivateauction_updateproposal(
        self,
        private_auction_id: Annotated[StrictStr, Field(description="The private auction id to be updated.")],
        ...
        update_private_auction_proposal_request: Optional[UpdatePrivateAuctionProposalRequest] = None,
        ...
        :param private_auction_id: The private auction id to be updated. (required)
        ...
        :type user_ip: str
        :param update_private_auction_proposal_request:
        :type update_private_auction_proposal_request: UpdatePrivateAuctionProposalRequest
        ...
        _param = self._adexchangebuyer_marketplaceprivateauction_updateproposal_serialize(
            ...
            user_ip=user_ip,
            update_private_auction_proposal_request=update_private_auction_proposal_request,
    ...
    @validate_call
    def adexchangebuyer_marketplaceprivateauction_updateproposal_with_http_info(
        self,
        private_auction_id: Annotated[StrictStr, Field(description="The private auction id to be updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def adexchangebuyer_marketplaceprivateauction_updateproposal_without_preload_content(
        self,
        private_auction_id: Annotated[StrictStr, Field(description="The private auction id to be updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _adexchangebuyer_marketplaceprivateauction_updateproposal_serialize(
        self,
        private_auction_id,
        alt,
        fields,
        ...
        if private_auction_id is not None:
            _path_params['privateAuctionId'] = private_auction_id
        ...
        if update_private_auction_proposal_request is not None:
            _body_params = update_private_auction_proposal_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/privateauction/{privateAuctionId}/updateproposal',
