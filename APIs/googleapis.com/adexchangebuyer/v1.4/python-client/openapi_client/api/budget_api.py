...
class BudgetApi:
    ...
    def adexchangebuyer_budget_get(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id to get the budget information for.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id to get the budget information for.")],
        ...
        :param account_id: The account id to get the budget information for. (required)
        :type account_id: str
        :param billing_id: The billing id to get the budget information for. (required)
        :type billing_id: str
        ...
        _param = self._adexchangebuyer_budget_get_serialize(
    ...
    @validate_call
    def adexchangebuyer_budget_get_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id to get the budget information for.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id to get the budget information for.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def adexchangebuyer_budget_get_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id to get the budget information for.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id to get the budget information for.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _adexchangebuyer_budget_get_serialize(
        self,
        account_id,
        billing_id,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/billinginfo/{accountId}/{billingId}',
    ...
    def adexchangebuyer_budget_patch(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id associated with the budget being updated.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id associated with the budget being updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        :param account_id: The account id associated with the budget being updated. (required)
        :type account_id: str
        :param billing_id: The billing id associated with the budget being updated. (required)
        :type billing_id: str
        :param alt: Data format for the response.
        :type alt: str
        :param fields: Selector specifying which fields to include in a partial response.
        ...
        _param = self._adexchangebuyer_budget_patch_serialize(
            account_id=account_id,
            billing_id=billing_id,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def adexchangebuyer_budget_patch_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id associated with the budget being updated.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id associated with the budget being updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def adexchangebuyer_budget_patch_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id associated with the budget being updated.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id associated with the budget being updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _adexchangebuyer_budget_patch_serialize(
        self,
        account_id,
        billing_id,
        alt,
    ...
    def adexchangebuyer_budget_update(
        ...
        _param = self._adexchangebuyer_budget_update_serialize(
            account_id=account_id,
            billing_id=billing_id,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def adexchangebuyer_budget_update_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id associated with the budget being updated.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id associated with the budget being updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def adexchangebuyer_budget_update_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The account id associated with the budget being updated.")],
        billing_id: Annotated[StrictStr, Field(description="The billing id associated with the budget being updated.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _adexchangebuyer_budget_update_serialize(
        self,
        account_id,
        billing_id,
        alt,
