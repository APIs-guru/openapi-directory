...
class Account(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bidderLocation", "cookieMatchingNid", "cookieMatchingUrl", "id", "kind", "maximumActiveCreatives", "maximumTotalQps", "numberActiveCreatives"]
