...
class PretargetingConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billingId", "configId", "configName", "creativeType", "dimensions", "excludedContentLabels", "excludedGeoCriteriaIds", "excludedPlacements", "excludedUserLists", "excludedVerticals", "geoCriteriaIds", "isActive", "kind", "languages", "maximumQps", "mobileCarriers", "mobileDevices", "mobileOperatingSystemVersions", "placements", "platforms", "supportedCreativeAttributes", "userLists", "vendorTypes", "verticals"]
