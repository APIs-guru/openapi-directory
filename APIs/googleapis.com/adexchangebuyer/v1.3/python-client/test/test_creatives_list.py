...
class TestCreativesList(unittest.TestCase):
    """CreativesList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreativesList:
        """Test CreativesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreativesList`
        """
        model = CreativesList()
        if include_optional:
