...
class InternalRange(BaseModel):
    ...
    ip_cidr_range: Optional[StrictStr] = Field(default=None, description="IP range that this internal range defines.", alias="ipCidrRange")
    ...
    usage: Optional[StrictStr] = Field(default=None, description="The type of usage set for this internal range.")
