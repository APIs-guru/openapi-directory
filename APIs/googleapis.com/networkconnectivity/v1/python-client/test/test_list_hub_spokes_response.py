...
class TestListHubSpokesResponse(unittest.TestCase):
    """ListHubSpokesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListHubSpokesResponse:
        """Test ListHubSpokesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListHubSpokesResponse`
        """
        model = ListHubSpokesResponse()
        if include_optional:
            return ListHubSpokesResponse(
                next_page_token = '',
                spokes = [
                    openapi_client.models.spoke.Spoke(
                        create_time = '', 
                        description = '', 
                        group = '', 
                        hub = '', 
    ...
    def testListHubSpokesResponse(self):
        """Test ListHubSpokesResponse"""
