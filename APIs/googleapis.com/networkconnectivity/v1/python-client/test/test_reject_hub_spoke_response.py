...
class TestRejectHubSpokeResponse(unittest.TestCase):
    """RejectHubSpokeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RejectHubSpokeResponse:
        """Test RejectHubSpokeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RejectHubSpokeResponse`
        """
        model = RejectHubSpokeResponse()
        if include_optional:
    ...
    def testRejectHubSpokeResponse(self):
        """Test RejectHubSpokeResponse"""
