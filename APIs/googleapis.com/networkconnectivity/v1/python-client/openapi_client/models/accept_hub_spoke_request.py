...
class AcceptHubSpokeRequest(BaseModel):
    """
    ...
    spoke_uri: Optional[StrictStr] = Field(default=None, description="Required. The URI of the spoke to accept into the hub.", alias="spokeUri")
    __properties: ClassVar[List[str]] = ["requestId", "spokeUri"]
