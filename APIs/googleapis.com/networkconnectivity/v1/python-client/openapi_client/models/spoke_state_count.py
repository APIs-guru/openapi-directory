...
class SpokeStateCount(BaseModel):
    """
    The number of spokes that are in a particular state and associated with a given hub.
    """ # noqa: E501
    count: Optional[StrictStr] = Field(default=None, description="Output only. The total number of spokes that are in this state and associated with a given hub.")
    state: Optional[StrictStr] = Field(default=None, description="Output only. The state of the spokes.")
