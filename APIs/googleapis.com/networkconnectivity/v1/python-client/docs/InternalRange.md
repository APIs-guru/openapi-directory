...
**ip_cidr_range** | **str** | The IP range that this internal range defines. | [optional] 
...
**usage** | **str** | The type of usage set for this InternalRange. | [optional] 
