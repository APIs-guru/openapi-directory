...
class AccessSecretVersionResponse(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the SecretVersion in the format `projects/*/secrets/*/versions/*`.")
    payload: Optional[SecretPayload] = None
    __properties: ClassVar[List[str]] = ["name", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "payload": SecretPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
