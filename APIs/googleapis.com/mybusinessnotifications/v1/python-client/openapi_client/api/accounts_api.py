...
class AccountsApi:
    ...
    def mybusinessnotifications_accounts_get_notification_setting(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the notification setting we are trying to fetch.")],
        ...
        """mybusinessnotifications_accounts_get_notification_setting
        ...
        _param = self._mybusinessnotifications_accounts_get_notification_setting_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def mybusinessnotifications_accounts_get_notification_setting_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the notification setting we are trying to fetch.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusinessnotifications_accounts_get_notification_setting_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the notification setting we are trying to fetch.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusinessnotifications_accounts_get_notification_setting_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def mybusinessnotifications_accounts_update_notification_setting(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name this setting is for. This is of the form `accounts/{account_id}/notificationSetting`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        update_mask: Annotated[Optional[StrictStr], Field(description="Required. The specific fields that should be updated. The only editable field is notification_setting.")] = None,
        ...
        """mybusinessnotifications_accounts_update_notification_setting
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param update_mask: Required. The specific fields that should be updated. The only editable field is notification_setting.
        :type update_mask: str
        :param notification_setting:
        :type notification_setting: NotificationSetting
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._mybusinessnotifications_accounts_update_notification_setting_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def mybusinessnotifications_accounts_update_notification_setting_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name this setting is for. This is of the form `accounts/{account_id}/notificationSetting`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusinessnotifications_accounts_update_notification_setting_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name this setting is for. This is of the form `accounts/{account_id}/notificationSetting`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusinessnotifications_accounts_update_notification_setting_serialize(
        self,
        name,
        xgafv,
        access_token,
        ...
        if notification_setting is not None:
            _body_params = notification_setting
