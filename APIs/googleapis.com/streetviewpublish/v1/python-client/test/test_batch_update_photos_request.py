...
class TestBatchUpdatePhotosRequest(unittest.TestCase):
    """BatchUpdatePhotosRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdatePhotosRequest:
        """Test BatchUpdatePhotosRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdatePhotosRequest`
        """
        model = BatchUpdatePhotosRequest()
        if include_optional:
            return BatchUpdatePhotosRequest(
                update_photo_requests = [
                    openapi_client.models.update_photo_request.UpdatePhotoRequest(
    ...
    def testBatchUpdatePhotosRequest(self):
        """Test BatchUpdatePhotosRequest"""
