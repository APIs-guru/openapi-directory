...
class TestListPhotosResponse(unittest.TestCase):
    """ListPhotosResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPhotosResponse:
        """Test ListPhotosResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPhotosResponse`
        """
    ...
    def testListPhotosResponse(self):
        """Test ListPhotosResponse"""
