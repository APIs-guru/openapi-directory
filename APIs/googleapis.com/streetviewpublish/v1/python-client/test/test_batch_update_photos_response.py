...
class TestBatchUpdatePhotosResponse(unittest.TestCase):
    """BatchUpdatePhotosResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdatePhotosResponse:
        """Test BatchUpdatePhotosResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdatePhotosResponse`
        """
        model = BatchUpdatePhotosResponse()
        if include_optional:
    ...
    def testBatchUpdatePhotosResponse(self):
        """Test BatchUpdatePhotosResponse"""
