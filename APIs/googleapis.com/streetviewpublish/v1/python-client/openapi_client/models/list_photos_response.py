...
class ListPhotosResponse(BaseModel):
    ...
    photos: Optional[List[Photo]] = Field(default=None, description="List of photos. The pageSize field in the request determines the number of items returned.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "photos"]
