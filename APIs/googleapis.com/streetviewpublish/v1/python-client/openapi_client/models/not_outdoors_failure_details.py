...
class NotOutdoorsFailureDetails(BaseModel):
    ...
    """ # noqa: E501
    start_time: Optional[StrictStr] = Field(default=None, description="Relative time (from the start of the video stream) when an indoor frame was found.", alias="startTime")
