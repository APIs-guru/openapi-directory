...
class Size(BaseModel):
    ...
    """ # noqa: E501
    height: Optional[StrictInt] = Field(default=None, description="The height of the creative.")
    width: Optional[StrictInt] = Field(default=None, description="The width of the creative")
