...
class RowDimensions(BaseModel):
    ...
    """ # noqa: E501
    publisher_identifier: Optional[StrictStr] = Field(default=None, description="The publisher identifier for this row, if a breakdown by [BreakdownDimension.PUBLISHER_IDENTIFIER](https://developers.google.com/authorized-buyers/apis/reference/rest/v2beta1/bidders.accounts.filterSets#FilterSet.BreakdownDimension) was requested.", alias="publisherIdentifier")
    time_interval: Optional[TimeInterval] = Field(default=None, alias="timeInterval")
    __properties: ClassVar[List[str]] = ["publisherIdentifier", "timeInterval"]
