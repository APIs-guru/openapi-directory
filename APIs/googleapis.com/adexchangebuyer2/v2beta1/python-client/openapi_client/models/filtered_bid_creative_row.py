...
class FilteredBidCreativeRow(BaseModel):
    ...
    creative_id: Optional[StrictStr] = Field(default=None, description="The ID of the creative.", alias="creativeId")
    row_dimensions: Optional[RowDimensions] = Field(default=None, alias="rowDimensions")
    __properties: ClassVar[List[str]] = ["bidCount", "creativeId", "rowDimensions"]
