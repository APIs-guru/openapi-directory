...
class CalloutStatusRow(BaseModel):
    ...
    """ # noqa: E501
    callout_status_id: Optional[StrictInt] = Field(default=None, description="The ID of the callout status. See [callout-status-codes](https://developers.google.com/authorized-buyers/rtb/downloads/callout-status-codes).", alias="calloutStatusId")
    ...
    __properties: ClassVar[List[str]] = ["calloutStatusId", "impressionCount", "rowDimensions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calloutStatusId": obj.get("calloutStatusId"),
