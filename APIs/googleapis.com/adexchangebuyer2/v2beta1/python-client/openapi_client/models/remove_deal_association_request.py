...
class RemoveDealAssociationRequest(BaseModel):
    ...
    """ # noqa: E501
    association: Optional[CreativeDealAssociation] = None
    __properties: ClassVar[List[str]] = ["association"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association": CreativeDealAssociation.from_dict(obj["association"]) if obj.get("association") is not None else None
        })
        return _obj
