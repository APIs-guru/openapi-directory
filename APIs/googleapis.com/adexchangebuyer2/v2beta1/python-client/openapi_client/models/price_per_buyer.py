...
class PricePerBuyer(BaseModel):
    ...
    """ # noqa: E501
    advertiser_ids: Optional[List[StrictStr]] = Field(default=None, description="The list of advertisers for this price when associated with this buyer. If empty, all advertisers with this buyer pay this price.", alias="advertiserIds")
    buyer: Optional[Buyer] = None
    price: Optional[Price] = None
    __properties: ClassVar[List[str]] = ["advertiserIds", "buyer", "price"]
