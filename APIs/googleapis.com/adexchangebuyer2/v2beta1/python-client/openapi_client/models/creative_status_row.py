...
class CreativeStatusRow(BaseModel):
    ...
    creative_status_id: Optional[StrictInt] = Field(default=None, description="The ID of the creative status. See [creative-status-codes](https://developers.google.com/authorized-buyers/rtb/downloads/creative-status-codes).", alias="creativeStatusId")
    row_dimensions: Optional[RowDimensions] = Field(default=None, alias="rowDimensions")
    __properties: ClassVar[List[str]] = ["bidCount", "creativeStatusId", "rowDimensions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creativeStatusId": obj.get("creativeStatusId"),
