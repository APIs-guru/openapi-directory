...
class RealtimeTimeRange(BaseModel):
    ...
    """ # noqa: E501
    start_timestamp: Optional[StrictStr] = Field(default=None, description="The start timestamp of the real-time RTB metrics aggregation.", alias="startTimestamp")
    __properties: ClassVar[List[str]] = ["startTimestamp"]
