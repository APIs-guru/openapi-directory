...
class NonBillableWinningBidStatusRow(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The status specifying why the winning bids were not billed.")
    __properties: ClassVar[List[str]] = ["bidCount", "rowDimensions", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['STATUS_UNSPECIFIED', 'AD_NOT_RENDERED', 'INVALID_IMPRESSION', 'FATAL_VAST_ERROR', 'LOST_IN_MEDIATION']):
            raise ValueError("must be one of enum values ('STATUS_UNSPECIFIED', 'AD_NOT_RENDERED', 'INVALID_IMPRESSION', 'FATAL_VAST_ERROR', 'LOST_IN_MEDIATION')")
        return value
