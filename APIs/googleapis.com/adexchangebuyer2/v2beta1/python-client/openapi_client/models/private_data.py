...
class PrivateData(BaseModel):
    ...
    """ # noqa: E501
    reference_id: Optional[StrictStr] = Field(default=None, description="A buyer or seller specified reference ID. This can be queried in the list operations (max-length: 1024 unicode code units).", alias="referenceId")
