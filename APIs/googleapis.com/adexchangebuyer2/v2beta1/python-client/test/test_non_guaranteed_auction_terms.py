...
class TestNonGuaranteedAuctionTerms(unittest.TestCase):
    """NonGuaranteedAuctionTerms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonGuaranteedAuctionTerms:
        """Test NonGuaranteedAuctionTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonGuaranteedAuctionTerms`
        """
        model = NonGuaranteedAuctionTerms()
        if include_optional:
    ...
    def testNonGuaranteedAuctionTerms(self):
        """Test NonGuaranteedAuctionTerms"""
