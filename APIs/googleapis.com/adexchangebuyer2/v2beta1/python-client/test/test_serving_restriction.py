...
class TestServingRestriction(unittest.TestCase):
    """ServingRestriction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingRestriction:
        """Test ServingRestriction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServingRestriction`
        """
        model = ServingRestriction()
        if include_optional:
    ...
    def testServingRestriction(self):
        """Test ServingRestriction"""
