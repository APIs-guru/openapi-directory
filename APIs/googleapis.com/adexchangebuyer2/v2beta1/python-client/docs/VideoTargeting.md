...
------------ | ------------- | ------------- | -------------
**excluded_position_types** | **List[str]** | A list of video positions to be excluded. Position types can either be included or excluded (XOR). | [optional] 
**targeted_position_types** | **List[str]** | A list of video positions to be included. When the included list is present, the excluded list must be empty. When the excluded list is present, the included list must be empty. | [optional] 
