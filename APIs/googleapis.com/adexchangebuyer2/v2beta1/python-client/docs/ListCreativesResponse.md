...
**next_page_token** | **str** | A token to retrieve the next page of results. Pass this value in the ListCreativesRequest.page_token field in the subsequent call to &#x60;ListCreatives&#x60; method to retrieve the next page of results. | [optional] 
