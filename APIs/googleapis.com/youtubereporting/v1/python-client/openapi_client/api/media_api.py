...
class MediaApi:
    ...
    def youtubereporting_media_download(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded.")],
        ...
        :param resource_name: Name of the media that is being downloaded. (required)
        ...
        _param = self._youtubereporting_media_download_serialize(
    ...
    @validate_call
    def youtubereporting_media_download_with_http_info(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def youtubereporting_media_download_without_preload_content(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _youtubereporting_media_download_serialize(
        self,
        resource_name,
        xgafv,
        access_token,
