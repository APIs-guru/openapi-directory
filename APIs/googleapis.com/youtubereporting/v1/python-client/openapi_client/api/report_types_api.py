...
class ReportTypesApi:
    ...
    def youtubereporting_report_types_list(
        ...
        include_system_managed: Annotated[Optional[StrictBool], Field(description="If set to true, also system-managed report types will be returned; otherwise only the report types that can be used to create new reporting jobs will be returned.")] = None,
        ...
        page_token: Annotated[Optional[StrictStr], Field(description="A token identifying a page of results the server should return. Typically, this is the value of ListReportTypesResponse.next_page_token returned in response to the previous call to the `ListReportTypes` method.")] = None,
        ...
        _param = self._youtubereporting_report_types_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def youtubereporting_report_types_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListReportTypesResponse]:
        """youtubereporting_report_types_list
    ...
    @validate_call
    def youtubereporting_report_types_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _youtubereporting_report_types_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
