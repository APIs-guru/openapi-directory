...
class Range(BaseModel):
    ...
    """ # noqa: E501
    ip_cidr_range: Optional[StrictStr] = Field(default=None, description="CIDR range in \"10.x.x.x/y\" format that is within the allocated ranges and currently unused.", alias="ipCidrRange")
    ...
    __properties: ClassVar[List[str]] = ["ipCidrRange", "network"]
