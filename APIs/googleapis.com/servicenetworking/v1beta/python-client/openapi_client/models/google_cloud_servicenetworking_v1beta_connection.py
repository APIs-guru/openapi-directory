...
class GoogleCloudServicenetworkingV1betaConnection(BaseModel):
    ...
    reserved_peering_ranges: Optional[List[StrictStr]] = Field(default=None, description="The name of one or more allocated IP address ranges for this service producer of type `PEERING`. Note that invoking this method with a different range when connection is already established will not modify already provisioned service producer subnetworks.", alias="reservedPeeringRanges")
