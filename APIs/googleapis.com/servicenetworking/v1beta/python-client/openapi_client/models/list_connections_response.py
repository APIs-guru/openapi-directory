...
class ListConnectionsResponse(BaseModel):
    ...
    """ # noqa: E501
    connections: Optional[List[GoogleCloudServicenetworkingV1betaConnection]] = Field(default=None, description="The list of Connections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connections": [GoogleCloudServicenetworkingV1betaConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
