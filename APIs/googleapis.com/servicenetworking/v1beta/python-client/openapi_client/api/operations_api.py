...
class OperationsApi:
    ...
    def servicenetworking_operations_get(
        ...
        _param = self._servicenetworking_operations_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def servicenetworking_operations_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def servicenetworking_operations_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _servicenetworking_operations_get_serialize(
        self,
        name,
        xgafv,
        access_token,
