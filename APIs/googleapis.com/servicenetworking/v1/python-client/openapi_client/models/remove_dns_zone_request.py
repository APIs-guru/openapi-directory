...
class RemoveDnsZoneRequest(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. The name for both the private zone in the shared producer host project and the peering zone in the consumer project.")
    __properties: ClassVar[List[str]] = ["consumerNetwork", "name"]
