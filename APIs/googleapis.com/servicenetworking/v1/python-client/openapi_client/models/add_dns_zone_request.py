...
class AddDnsZoneRequest(BaseModel):
    """
    ...
    dns_suffix: Optional[StrictStr] = Field(default=None, description="Required. The DNS name suffix for the zones e.g. `example.com.`. Cloud DNS requires that a DNS suffix ends with a trailing dot.", alias="dnsSuffix")
    ...
    __properties: ClassVar[List[str]] = ["consumerNetwork", "dnsSuffix", "name"]
