...
class TestUpdateConsumerConfigRequest(unittest.TestCase):
    """UpdateConsumerConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateConsumerConfigRequest:
        """Test UpdateConsumerConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateConsumerConfigRequest`
        """
        model = UpdateConsumerConfigRequest()
        if include_optional:
            return UpdateConsumerConfigRequest(
                consumer_config = openapi_client.models.consumer_config.ConsumerConfig(
                    cloudsql_configs = [
    ...
    def testUpdateConsumerConfigRequest(self):
        """Test UpdateConsumerConfigRequest"""
