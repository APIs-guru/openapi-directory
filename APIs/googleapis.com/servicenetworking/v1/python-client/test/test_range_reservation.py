...
class TestRangeReservation(unittest.TestCase):
    """RangeReservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RangeReservation:
        """Test RangeReservation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeReservation`
        """
        model = RangeReservation()
        if include_optional:
