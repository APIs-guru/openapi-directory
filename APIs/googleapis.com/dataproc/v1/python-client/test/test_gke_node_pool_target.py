...
class TestGkeNodePoolTarget(unittest.TestCase):
    """GkeNodePoolTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GkeNodePoolTarget:
        """Test GkeNodePoolTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GkeNodePoolTarget`
        """
        model = GkeNodePoolTarget()
        if include_optional:
    ...
    def testGkeNodePoolTarget(self):
        """Test GkeNodePoolTarget"""
