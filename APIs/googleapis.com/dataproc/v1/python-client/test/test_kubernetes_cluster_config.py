...
class TestKubernetesClusterConfig(unittest.TestCase):
    """KubernetesClusterConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KubernetesClusterConfig:
        """Test KubernetesClusterConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubernetesClusterConfig`
        """
        model = KubernetesClusterConfig()
        if include_optional:
    ...
    def testKubernetesClusterConfig(self):
        """Test KubernetesClusterConfig"""
