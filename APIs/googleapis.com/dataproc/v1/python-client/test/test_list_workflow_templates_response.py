...
class TestListWorkflowTemplatesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListWorkflowTemplatesResponse:
        """Test ListWorkflowTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWorkflowTemplatesResponse`
        """
        ...
        if include_optional:
            return ListWorkflowTemplatesResponse(
                next_page_token = '',
                templates = [
                    openapi_client.models.workflow_template.WorkflowTemplate(
                        create_time = '', 
                        dag_timeout = '', 
