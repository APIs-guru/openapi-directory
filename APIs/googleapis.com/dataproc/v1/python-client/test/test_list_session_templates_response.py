...
class TestListSessionTemplatesResponse(unittest.TestCase):
    """ListSessionTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListSessionTemplatesResponse:
        """Test ListSessionTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSessionTemplatesResponse`
        """
        model = ListSessionTemplatesResponse()
        if include_optional:
            return ListSessionTemplatesResponse(
                next_page_token = '',
                session_templates = [
                    openapi_client.models.session_template.SessionTemplate(
                        create_time = '', 
                        creator = '', 
                        description = '', 
    ...
    def testListSessionTemplatesResponse(self):
        """Test ListSessionTemplatesResponse"""
