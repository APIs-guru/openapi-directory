...
class TestWorkflowTemplatePlacement(unittest.TestCase):
    """WorkflowTemplatePlacement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowTemplatePlacement:
        """Test WorkflowTemplatePlacement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowTemplatePlacement`
        """
        model = WorkflowTemplatePlacement()
        if include_optional:
    ...
    def testWorkflowTemplatePlacement(self):
        """Test WorkflowTemplatePlacement"""
