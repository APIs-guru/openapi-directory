...
class TestGkeClusterConfig(unittest.TestCase):
    """GkeClusterConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GkeClusterConfig:
        """Test GkeClusterConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GkeClusterConfig`
        """
        model = GkeClusterConfig()
        if include_optional:
