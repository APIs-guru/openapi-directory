    ...
    def make_instance(self, include_optional) -> ClusterConfig:
        ...
        if include_optional:
            return ClusterConfig(
                ...
                secondary_worker_config = openapi_client.models.instance_group_config.InstanceGroupConfig(
                    accelerators = [
                        openapi_client.models.accelerator_config.AcceleratorConfig(
                            accelerator_count = 56, 
                            accelerator_type_uri = '', )
                ...
                temp_bucket = '',
                worker_config = openapi_client.models.instance_group_config.InstanceGroupConfig(
                    accelerators = [
                        openapi_client.models.accelerator_config.AcceleratorConfig(
                            accelerator_count = 56, 
                            accelerator_type_uri = '', )
