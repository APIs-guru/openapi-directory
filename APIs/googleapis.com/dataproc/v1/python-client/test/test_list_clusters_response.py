            ...
            return ListClustersResponse(
                clusters = [
                    openapi_client.models.cluster.Cluster(
                        ...
                        metrics = openapi_client.models.cluster_metrics.ClusterMetrics(
                            hdfs_metrics = {
                                'key' : ''
                                }, 
                            yarn_metrics = {
                        ...
                        status_history = [
                            openapi_client.models.cluster_status.ClusterStatus(
                                detail = '', 
                                state = 'UNKNOWN', 
                                state_start_time = '', 
                                substate = 'UNSPECIFIED', )
                            ], 
                        virtual_cluster_config = openapi_client.models.virtual_cluster_config.VirtualClusterConfig(
