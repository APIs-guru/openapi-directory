...
class ParameterValidation(BaseModel):
    ...
    """ # noqa: E501
    regex: Optional[RegexValidation] = None
    values: Optional[ValueValidation] = None
    __properties: ClassVar[List[str]] = ["regex", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "regex": RegexValidation.from_dict(obj["regex"]) if obj.get("regex") is not None else None,
            "values": ValueValidation.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
