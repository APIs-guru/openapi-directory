...
class InstanceSelection(BaseModel):
    ...
    """ # noqa: E501
    machine_types: Optional[List[StrictStr]] = Field(default=None, description="Optional. Full machine-type names, e.g. \"n1-standard-16\".", alias="machineTypes")
    ...
    __properties: ClassVar[List[str]] = ["machineTypes", "rank"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "machineTypes": obj.get("machineTypes"),
            "rank": obj.get("rank")
        })
        return _obj
