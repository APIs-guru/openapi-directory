...
class AuxiliaryServicesConfig(BaseModel):
    ...
    spark_history_server_config: Optional[SparkHistoryServerConfig] = Field(default=None, alias="sparkHistoryServerConfig")
    __properties: ClassVar[List[str]] = ["metastoreConfig", "sparkHistoryServerConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spark_history_server_config
        if self.spark_history_server_config:
            _dict['sparkHistoryServerConfig'] = self.spark_history_server_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sparkHistoryServerConfig": SparkHistoryServerConfig.from_dict(obj["sparkHistoryServerConfig"]) if obj.get("sparkHistoryServerConfig") is not None else None
        })
        return _obj
