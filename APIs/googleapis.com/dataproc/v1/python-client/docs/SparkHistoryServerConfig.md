...
------------ | ------------- | ------------- | -------------
**dataproc_cluster** | **str** | Optional. Resource name of an existing Dataproc Cluster to act as a Spark History Server for the workload.Example: projects/[project_id]/regions/[region]/clusters/[cluster_name] | [optional] 
