...
class TransferLocationRequest(BaseModel):
    ...
    """ # noqa: E501
    destination_account: Optional[StrictStr] = Field(default=None, description="Required. Name of the account resource to transfer the location to (for example, \"accounts/{account}\").", alias="destinationAccount")
    __properties: ClassVar[List[str]] = ["destinationAccount"]
