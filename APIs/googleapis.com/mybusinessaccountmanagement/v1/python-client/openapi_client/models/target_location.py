...
class TargetLocation(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The address of the location to which the user is invited.")
    ...
    __properties: ClassVar[List[str]] = ["address", "locationName"]
