...
class OrganizationInfo(BaseModel):
    ...
    phone_number: Optional[StrictStr] = Field(default=None, description="Output only. The contact number for the organization.", alias="phoneNumber")
    registered_domain: Optional[StrictStr] = Field(default=None, description="Output only. The registered domain for the account.", alias="registeredDomain")
    __properties: ClassVar[List[str]] = ["address", "phoneNumber", "registeredDomain"]
