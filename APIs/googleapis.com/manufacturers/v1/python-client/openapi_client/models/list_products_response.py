...
class ListProductsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token for the retrieval of the next page of product statuses.", alias="nextPageToken")
    products: Optional[List[Product]] = Field(default=None, description="List of the products.")
