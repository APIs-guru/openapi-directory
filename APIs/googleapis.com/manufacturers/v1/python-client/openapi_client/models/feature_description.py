...
class FeatureDescription(BaseModel):
    ...
    """ # noqa: E501
    headline: Optional[StrictStr] = Field(default=None, description="A short description of the feature.")
    image: Optional[Image] = None
    text: Optional[StrictStr] = Field(default=None, description="A detailed description of the feature.")
    __properties: ClassVar[List[str]] = ["headline", "image", "text"]
