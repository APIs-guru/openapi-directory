...
class Count(BaseModel):
    ...
    """ # noqa: E501
    unit: Optional[StrictStr] = Field(default=None, description="The unit in which these products are counted.")
    value: Optional[StrictStr] = Field(default=None, description="The numeric value of the number of products in a package.")
