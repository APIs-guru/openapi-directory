...
class Capacity(BaseModel):
    ...
    """ # noqa: E501
    unit: Optional[StrictStr] = Field(default=None, description="The unit of the capacity, i.e., MB, GB, or TB.")
    value: Optional[StrictStr] = Field(default=None, description="The numeric value of the capacity.")
