...
class SavedColumnsApi:
    ...
    def doubleclicksearch_saved_columns_list(
        self,
        agency_id: Annotated[StrictStr, Field(description="DS ID of the agency.")],
        advertiser_id: Annotated[StrictStr, Field(description="DS ID of the advertiser.")],
        ...
        :param agency_id: DS ID of the agency. (required)
        :type agency_id: str
        :param advertiser_id: DS ID of the advertiser. (required)
        ...
        _param = self._doubleclicksearch_saved_columns_list_serialize(
            agency_id=agency_id,
    ...
    @validate_call
    def doubleclicksearch_saved_columns_list_with_http_info(
        self,
        agency_id: Annotated[StrictStr, Field(description="DS ID of the agency.")],
        advertiser_id: Annotated[StrictStr, Field(description="DS ID of the advertiser.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def doubleclicksearch_saved_columns_list_without_preload_content(
        self,
        agency_id: Annotated[StrictStr, Field(description="DS ID of the agency.")],
        advertiser_id: Annotated[StrictStr, Field(description="DS ID of the advertiser.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _doubleclicksearch_saved_columns_list_serialize(
        self,
        agency_id,
        advertiser_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/doubleclicksearch/v2/agency/{agencyId}/advertiser/{advertiserId}/savedcolumns',
