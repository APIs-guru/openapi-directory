...
class CustomDimension(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Custom dimension name.")
    value: Optional[StrictStr] = Field(default=None, description="Custom dimension value.")
