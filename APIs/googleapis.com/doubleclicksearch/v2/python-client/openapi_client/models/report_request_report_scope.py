...
class ReportRequestReportScope(BaseModel):
    """
    ...
    keyword_id: Optional[StrictStr] = Field(default=None, description="DS keyword ID.", alias="keywordId")
    __properties: ClassVar[List[str]] = ["adGroupId", "adId", "advertiserId", "agencyId", "campaignId", "engineAccountId", "keywordId"]
