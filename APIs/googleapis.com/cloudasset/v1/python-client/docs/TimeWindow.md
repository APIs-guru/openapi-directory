...
------------ | ------------- | ------------- | -------------
**end_time** | **str** | End time of the time window (inclusive). If not specified, the current timestamp is used instead. | [optional] 
**start_time** | **str** | Start time of the time window (exclusive). | [optional] 
