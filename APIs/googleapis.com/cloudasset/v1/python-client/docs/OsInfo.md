...
json = "{}"
# create an instance of OsInfo from a JSON string
os_info_instance = OsInfo.from_json(json)
# print the JSON string representation of the object
print(OsInfo.to_json())

# convert the object into a dict
os_info_dict = os_info_instance.to_dict()
# create an instance of OsInfo from a dict
os_info_from_dict = OsInfo.from_dict(os_info_dict)
```
