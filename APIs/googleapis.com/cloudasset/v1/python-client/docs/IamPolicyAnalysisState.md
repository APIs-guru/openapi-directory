...
iam_policy_analysis_state_instance = IamPolicyAnalysisState.from_json(json)
# print the JSON string representation of the object
print(IamPolicyAnalysisState.to_json())

# convert the object into a dict
iam_policy_analysis_state_dict = iam_policy_analysis_state_instance.to_dict()
# create an instance of IamPolicyAnalysisState from a dict
iam_policy_analysis_state_from_dict = IamPolicyAnalysisState.from_dict(iam_policy_analysis_state_dict)
```
