...
class ListSavedQueriesResponse(BaseModel):
    ...
    saved_queries: Optional[List[SavedQuery]] = Field(default=None, description="A list of savedQueries.", alias="savedQueries")
    __properties: ClassVar[List[str]] = ["nextPageToken", "savedQueries"]
