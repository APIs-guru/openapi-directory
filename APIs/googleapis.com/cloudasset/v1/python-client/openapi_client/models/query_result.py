...
class QueryResult(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Token to retrieve the next page of the results.", alias="nextPageToken")
    rows: Optional[List[Dict[str, Any]]] = Field(default=None, description="Each row hold a query result in the format of `Struct`.")
    var_schema: Optional[TableSchema] = Field(default=None, alias="schema")
    total_rows: Optional[StrictStr] = Field(default=None, description="Total rows of the whole query results.", alias="totalRows")
    __properties: ClassVar[List[str]] = ["nextPageToken", "rows", "schema", "totalRows"]
