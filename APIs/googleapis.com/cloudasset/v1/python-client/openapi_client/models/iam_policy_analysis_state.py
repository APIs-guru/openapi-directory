...
class IamPolicyAnalysisState(BaseModel):
    """
    Represents the detailed state of an entity under analysis, such as a resource, an identity or an access.
    """ # noqa: E501
    cause: Optional[StrictStr] = Field(default=None, description="The human-readable description of the cause of failure.")
    code: Optional[StrictStr] = Field(default=None, description="The Google standard error code that best describes the state. For example: - OK means the analysis on this entity has been successfully finished; - PERMISSION_DENIED means an access denied error is encountered; - DEADLINE_EXCEEDED means the analysis on this entity hasn't been started in time;")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IamPolicyAnalysisState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IamPolicyAnalysisState from a dict"""
        if obj is None:
            return None
