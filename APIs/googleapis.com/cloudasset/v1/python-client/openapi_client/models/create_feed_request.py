...
class CreateFeedRequest(BaseModel):
    ...
    feed_id: Optional[StrictStr] = Field(default=None, description="Required. This is the client-assigned asset feed identifier and it needs to be unique under a specific parent project/folder/organization.", alias="feedId")
    __properties: ClassVar[List[str]] = ["feed", "feedId"]
