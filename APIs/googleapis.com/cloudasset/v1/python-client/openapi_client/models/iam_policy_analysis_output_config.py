...
class IamPolicyAnalysisOutputConfig(BaseModel):
    ...
    """ # noqa: E501
    bigquery_destination: Optional[GoogleCloudAssetV1BigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    gcs_destination: Optional[GoogleCloudAssetV1GcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryDestination": GoogleCloudAssetV1BigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None,
            "gcsDestination": GoogleCloudAssetV1GcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None
        })
        return _obj
