...
class Asset(BaseModel):
    ...
    os_inventory: Optional[Inventory] = Field(default=None, alias="osInventory")
    related_asset: Optional[RelatedAsset] = Field(default=None, alias="relatedAsset")
    related_assets: Optional[RelatedAssets] = Field(default=None, alias="relatedAssets")
    ...
    __properties: ClassVar[List[str]] = ["accessLevel", "accessPolicy", "ancestors", "assetType", "iamPolicy", "name", "orgPolicy", "osInventory", "relatedAsset", "relatedAssets", "resource", "servicePerimeter", "updateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of os_inventory
        if self.os_inventory:
            _dict['osInventory'] = self.os_inventory.to_dict()
        # override the default output from pydantic by calling `to_dict()` of related_asset
        if self.related_asset:
            _dict['relatedAsset'] = self.related_asset.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "osInventory": Inventory.from_dict(obj["osInventory"]) if obj.get("osInventory") is not None else None,
            "relatedAsset": RelatedAsset.from_dict(obj["relatedAsset"]) if obj.get("relatedAsset") is not None else None,
            "relatedAssets": RelatedAssets.from_dict(obj["relatedAssets"]) if obj.get("relatedAssets") is not None else None,
