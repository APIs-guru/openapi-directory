...
class UpdateFeedRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. Only updates the `feed` fields indicated by this mask. The field mask must not be empty, and it must not contain fields that are immutable or only set by the server.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["feed", "updateMask"]
