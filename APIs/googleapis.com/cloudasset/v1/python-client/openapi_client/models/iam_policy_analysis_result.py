...
class IamPolicyAnalysisResult(BaseModel):
    ...
    """ # noqa: E501
    access_control_lists: Optional[List[GoogleCloudAssetV1AccessControlList]] = Field(default=None, description="The access control lists derived from the iam_binding that match or potentially match resource and access selectors specified in the request.", alias="accessControlLists")
    ...
    identity_list: Optional[GoogleCloudAssetV1IdentityList] = Field(default=None, alias="identityList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessControlLists": [GoogleCloudAssetV1AccessControlList.from_dict(_item) for _item in obj["accessControlLists"]] if obj.get("accessControlLists") is not None else None,
            ...
            "identityList": GoogleCloudAssetV1IdentityList.from_dict(obj["identityList"]) if obj.get("identityList") is not None else None
        })
        return _obj
