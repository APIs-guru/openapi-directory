...
class PolicyInfo(BaseModel):
    ...
    """ # noqa: E501
    attached_resource: Optional[StrictStr] = Field(default=None, description="The full resource name the policy is directly attached to.", alias="attachedResource")
    policy: Optional[Policy] = None
    __properties: ClassVar[List[str]] = ["attachedResource", "policy"]
