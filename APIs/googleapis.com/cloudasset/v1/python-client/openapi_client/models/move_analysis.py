...
class MoveAnalysis(BaseModel):
    ...
    """ # noqa: E501
    analysis: Optional[MoveAnalysisResult] = None
    display_name: Optional[StrictStr] = Field(default=None, description="The user friendly display name of the analysis. E.g. IAM, organization policy etc.", alias="displayName")
    error: Optional[Status] = None
    __properties: ClassVar[List[str]] = ["analysis", "displayName", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analysis": MoveAnalysisResult.from_dict(obj["analysis"]) if obj.get("analysis") is not None else None,
