...
class QueryAssetsOutputConfig(BaseModel):
    """
    Output configuration query assets.
    """ # noqa: E501
    bigquery_destination: Optional[GoogleCloudAssetV1QueryAssetsOutputConfigBigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryDestination": GoogleCloudAssetV1QueryAssetsOutputConfigBigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None
        })
        return _obj
