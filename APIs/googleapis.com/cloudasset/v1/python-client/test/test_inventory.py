...
class TestInventory(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Inventory:
        ...
        if include_optional:
            return Inventory(
                items = {
                    'key' : openapi_client.models.item.Item(
                        available_package = openapi_client.models.software_package.SoftwarePackage(
                        ...
                        create_time = '', 
                        id = '', 
                        installed_package = openapi_client.models.software_package.SoftwarePackage(), 
                        origin_type = 'ORIGIN_TYPE_UNSPECIFIED', 
                        type = 'TYPE_UNSPECIFIED', 
                        update_time = '', )
                    },
                name = '',
                os_info = openapi_client.models.os_info.OsInfo(
                    architecture = '', 
                    hostname = '', 
                    kernel_release = '', 
                    kernel_version = '', 
