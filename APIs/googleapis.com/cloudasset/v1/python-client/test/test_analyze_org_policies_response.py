...
class TestAnalyzeOrgPoliciesResponse(unittest.TestCase):
    """AnalyzeOrgPoliciesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeOrgPoliciesResponse:
        """Test AnalyzeOrgPoliciesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeOrgPoliciesResponse`
        """
        model = AnalyzeOrgPoliciesResponse()
        if include_optional:
            return AnalyzeOrgPoliciesResponse(
                ...
                next_page_token = '',
                org_policy_results = [
                    openapi_client.models.org_policy_result.OrgPolicyResult(
    ...
    def testAnalyzeOrgPoliciesResponse(self):
        """Test AnalyzeOrgPoliciesResponse"""
