        ...
        if include_optional:
            return TemporalAsset(
                asset = openapi_client.models.asset.Asset(
                    ...
                    os_inventory = openapi_client.models.inventory.Inventory(
                        items = {
                        ...
                        os_info = openapi_client.models.os_info.OsInfo(
                            ...
                            version = '', ), 
                        update_time = '', ), 
                    related_asset = openapi_client.models.related_asset.RelatedAsset(
                        asset_type = '', 
                        relationship_type = '', ), 
                    related_assets = openapi_client.models.related_assets.RelatedAssets(
                        assets = [
                    ...
                    update_time = '', ),
                deleted = True,
                prior_asset = openapi_client.models.asset.Asset(
                    access_level = openapi_client.models.google_identity_accesscontextmanager_v1_access_level.GoogleIdentityAccesscontextmanagerV1AccessLevel(
                        basic = openapi_client.models.google_identity_accesscontextmanager_v1_basic_level.GoogleIdentityAccesscontextmanagerV1BasicLevel(
                            combining_function = 'AND', 
                            conditions = [
