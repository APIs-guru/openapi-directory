...
class TestAnalyzeOrgPolicyGovernedAssetsResponse(unittest.TestCase):
    """AnalyzeOrgPolicyGovernedAssetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeOrgPolicyGovernedAssetsResponse:
        """Test AnalyzeOrgPolicyGovernedAssetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeOrgPolicyGovernedAssetsResponse`
        """
        model = AnalyzeOrgPolicyGovernedAssetsResponse()
        if include_optional:
            return AnalyzeOrgPolicyGovernedAssetsResponse(
                constraint = openapi_client.models.analyzer_org_policy_constraint.AnalyzerOrgPolicyConstraint(
                    ...
                    google_defined_constraint = openapi_client.models.google_cloud_asset_v1_constraint.GoogleCloudAssetV1Constraint(
                        ...
                        name = '', ), ),
                governed_assets = [
                    openapi_client.models.google_cloud_asset_v1_analyze_org_policy_governed_assets_response_governed_asset.GoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset(
    ...
    def testAnalyzeOrgPolicyGovernedAssetsResponse(self):
        """Test AnalyzeOrgPolicyGovernedAssetsResponse"""
