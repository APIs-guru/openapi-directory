...
class TestEffectiveIamPolicy(unittest.TestCase):
    """EffectiveIamPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectiveIamPolicy:
        """Test EffectiveIamPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectiveIamPolicy`
        """
        model = EffectiveIamPolicy()
        if include_optional:
    ...
    def testEffectiveIamPolicy(self):
        """Test EffectiveIamPolicy"""
