...
class GoogleCloudAssetV1p7beta1PartitionSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["partitionKey"]
    ...
    def partition_key_validate_enum(cls, value):
        ...
        if value not in set(['PARTITION_KEY_UNSPECIFIED', 'READ_TIME', 'REQUEST_TIME']):
            raise ValueError("must be one of enum values ('PARTITION_KEY_UNSPECIFIED', 'READ_TIME', 'REQUEST_TIME')")
        return value
