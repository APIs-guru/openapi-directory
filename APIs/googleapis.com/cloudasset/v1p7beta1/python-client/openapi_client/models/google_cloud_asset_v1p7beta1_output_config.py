...
class GoogleCloudAssetV1p7beta1OutputConfig(BaseModel):
    """
    Output configuration for export assets destination.
    """ # noqa: E501
    bigquery_destination: Optional[GoogleCloudAssetV1p7beta1BigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    gcs_destination: Optional[GoogleCloudAssetV1p7beta1GcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryDestination": GoogleCloudAssetV1p7beta1BigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None,
            "gcsDestination": GoogleCloudAssetV1p7beta1GcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None
        })
        return _obj
