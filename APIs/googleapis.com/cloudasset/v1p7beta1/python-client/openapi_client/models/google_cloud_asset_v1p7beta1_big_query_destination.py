...
class GoogleCloudAssetV1p7beta1BigQueryDestination(BaseModel):
    """
    A BigQuery destination for exporting assets to.
    """ # noqa: E501
    dataset: Optional[StrictStr] = Field(default=None, description="Required. The BigQuery dataset in format \"projects/projectId/datasets/datasetId\", to which the snapshot result should be exported. If this dataset does not exist, the export call returns an INVALID_ARGUMENT error.")
    ...
    partition_spec: Optional[GoogleCloudAssetV1p7beta1PartitionSpec] = Field(default=None, alias="partitionSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "force": obj.get("force"),
            "partitionSpec": GoogleCloudAssetV1p7beta1PartitionSpec.from_dict(obj["partitionSpec"]) if obj.get("partitionSpec") is not None else None,
