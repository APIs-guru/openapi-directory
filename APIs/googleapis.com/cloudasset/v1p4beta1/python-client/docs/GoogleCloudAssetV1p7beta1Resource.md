...
**parent** | **str** | The full name of the immediate parent of this resource. See [Resource Names](https://cloud.google.com/apis/design/resource_names#full_resource_name) for more information. For Google Cloud assets, this value is the parent resource defined in the [Cloud IAM policy hierarchy](https://cloud.google.com/iam/docs/overview#policy_hierarchy). Example: &#x60;//cloudresourcemanager.googleapis.com/projects/my_project_123&#x60; For third-party assets, this field may be set differently. | [optional] 
