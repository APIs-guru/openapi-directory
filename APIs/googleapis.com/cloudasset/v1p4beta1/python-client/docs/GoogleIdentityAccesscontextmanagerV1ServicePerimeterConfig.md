...
**vpc_accessible_services** | [**GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices**](GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices.md) |  | [optional] 
...
google_identity_accesscontextmanager_v1_service_perimeter_config_instance = GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig.to_json())

# convert the object into a dict
google_identity_accesscontextmanager_v1_service_perimeter_config_dict = google_identity_accesscontextmanager_v1_service_perimeter_config_instance.to_dict()
# create an instance of GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig from a dict
google_identity_accesscontextmanager_v1_service_perimeter_config_from_dict = GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig.from_dict(google_identity_accesscontextmanager_v1_service_perimeter_config_dict)
```
