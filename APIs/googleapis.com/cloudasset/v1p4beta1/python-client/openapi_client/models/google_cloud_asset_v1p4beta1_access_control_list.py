...
class GoogleCloudAssetV1p4beta1AccessControlList(BaseModel):
    """
    ...
    """ # noqa: E501
    accesses: Optional[List[GoogleCloudAssetV1p4beta1Access]] = Field(default=None, description="The accesses that match one of the following conditions: - The access_selector, if it is specified in request; - Otherwise, access specifiers reachable from the policy binding's role.")
    resource_edges: Optional[List[GoogleCloudAssetV1p4beta1Edge]] = Field(default=None, description="Resource edges of the graph starting from the policy attached resource to any descendant resources. The Edge.source_node contains the full resource name of a parent resource and Edge.target_node contains the full resource name of a child resource. This field is present only if the output_resource_edges option is enabled in request.", alias="resourceEdges")
    resources: Optional[List[GoogleCloudAssetV1p4beta1Resource]] = Field(default=None, description="The resources that match one of the following conditions: - The resource_selector, if it is specified in request; - Otherwise, resources reachable from the policy attached resource.")
    __properties: ClassVar[List[str]] = ["accesses", "resourceEdges", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accesses": [GoogleCloudAssetV1p4beta1Access.from_dict(_item) for _item in obj["accesses"]] if obj.get("accesses") is not None else None,
            "resourceEdges": [GoogleCloudAssetV1p4beta1Edge.from_dict(_item) for _item in obj["resourceEdges"]] if obj.get("resourceEdges") is not None else None,
            "resources": [GoogleCloudAssetV1p4beta1Resource.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
