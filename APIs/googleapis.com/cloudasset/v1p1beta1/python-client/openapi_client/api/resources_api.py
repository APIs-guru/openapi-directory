...
class ResourcesApi:
    ...
    @validate_call
    def cloudasset_resources_search_all(
        self,
        ...
        asset_types: Annotated[Optional[List[StrictStr]], Field(description="Optional. A list of asset types that this request searches for. If empty, it will search all the supported asset types.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Optional. A comma separated list of fields specifying the sorting order of the results. The default order is ascending. Add ` DESC` after the field name to indicate descending order. Redundant space characters are ignored. For example, ` location DESC , name `.")] = None,
        ...
        query: Annotated[Optional[StrictStr], Field(description="Optional. The query statement.")] = None,
        ...
        _param = self._cloudasset_resources_search_all_serialize(
            scope=scope,
            xgafv=xgafv,
    ...
    @validate_call
    def cloudasset_resources_search_all_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="Required. The relative name of an asset. The search is limited to the resources within the `scope`. The allowed value must be: * Organization number (such as \"organizations/123\") * Folder number (such as \"folders/1234\") * Project number (such as \"projects/12345\") * Project ID (such as \"projects/abc\")")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudasset_resources_search_all_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="Required. The relative name of an asset. The search is limited to the resources within the `scope`. The allowed value must be: * Organization number (such as \"organizations/123\") * Folder number (such as \"folders/1234\") * Project number (such as \"projects/12345\") * Project ID (such as \"projects/abc\")")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudasset_resources_search_all_serialize(
        self,
        scope,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1p1beta1/{scope}/resources:searchAll',
