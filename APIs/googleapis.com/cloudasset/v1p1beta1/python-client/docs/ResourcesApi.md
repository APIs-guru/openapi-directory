...
------------- | ------------- | -------------
[**cloudasset_resources_search_all**](ResourcesApi.md#cloudasset_resources_search_all) | **GET** /v1p1beta1/{scope}/resources:searchAll | 


# **cloudasset_resources_search_all**
> SearchAllResourcesResponse cloudasset_resources_search_all(scope, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, asset_types=asset_types, order_by=order_by, page_size=page_size, page_token=page_token, query=query)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    asset_types = ['asset_types_example'] # List[str] | Optional. A list of asset types that this request searches for. If empty, it will search all the supported asset types. (optional)
    order_by = 'order_by_example' # str | Optional. A comma separated list of fields specifying the sorting order of the results. The default order is ascending. Add ` DESC` after the field name to indicate descending order. Redundant space characters are ignored. For example, ` location DESC , name `. (optional)
    ...
    query = 'query_example' # str | Optional. The query statement. (optional)

    try:
        api_response = api_instance.cloudasset_resources_search_all(scope, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, asset_types=asset_types, order_by=order_by, page_size=page_size, page_token=page_token, query=query)
        print("The response of ResourcesApi->cloudasset_resources_search_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcesApi->cloudasset_resources_search_all: %s\n" % e)
```
 ...
 **asset_types** | [**List[str]**](str.md)| Optional. A list of asset types that this request searches for. If empty, it will search all the supported asset types. | [optional] 
 **order_by** | **str**| Optional. A comma separated list of fields specifying the sorting order of the results. The default order is ascending. Add &#x60; DESC&#x60; after the field name to indicate descending order. Redundant space characters are ignored. For example, &#x60; location DESC , name &#x60;. | [optional] 
 ...
 **query** | **str**| Optional. The query statement. | [optional] 
