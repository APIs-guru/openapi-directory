...
class TestBatchGetAssetsHistoryResponse(unittest.TestCase):
    """BatchGetAssetsHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchGetAssetsHistoryResponse:
        """Test BatchGetAssetsHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchGetAssetsHistoryResponse`
        """
        model = BatchGetAssetsHistoryResponse()
        if include_optional:
            return BatchGetAssetsHistoryResponse(
                assets = [
                    openapi_client.models.temporal_asset.TemporalAsset(
    ...
    def testBatchGetAssetsHistoryResponse(self):
        """Test BatchGetAssetsHistoryResponse"""
