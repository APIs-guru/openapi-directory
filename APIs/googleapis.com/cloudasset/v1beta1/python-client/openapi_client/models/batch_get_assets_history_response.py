...
class BatchGetAssetsHistoryResponse(BaseModel):
    """
    Batch get assets history response.
    """ # noqa: E501
    assets: Optional[List[TemporalAsset]] = Field(default=None, description="A list of assets with valid time windows.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [TemporalAsset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
