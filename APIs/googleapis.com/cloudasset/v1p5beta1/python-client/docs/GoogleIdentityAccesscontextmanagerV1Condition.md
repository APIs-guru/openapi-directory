...
**vpc_network_sources** | [**List[GoogleIdentityAccesscontextmanagerV1VpcNetworkSource]**](GoogleIdentityAccesscontextmanagerV1VpcNetworkSource.md) | The request must originate from one of the provided VPC networks in Google Cloud. Cannot specify this field together with &#x60;ip_subnetworks&#x60;. | [optional] 
