...
class TestGoogleIdentityAccesscontextmanagerV1AccessLevel(unittest.TestCase):
    """GoogleIdentityAccesscontextmanagerV1AccessLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleIdentityAccesscontextmanagerV1AccessLevel:
        """Test GoogleIdentityAccesscontextmanagerV1AccessLevel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleIdentityAccesscontextmanagerV1AccessLevel`
        """
        model = GoogleIdentityAccesscontextmanagerV1AccessLevel()
        if include_optional:
    ...
    def testGoogleIdentityAccesscontextmanagerV1AccessLevel(self):
        """Test GoogleIdentityAccesscontextmanagerV1AccessLevel"""
