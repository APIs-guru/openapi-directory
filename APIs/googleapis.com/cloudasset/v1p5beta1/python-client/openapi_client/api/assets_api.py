...
class AssetsApi:
    ...
    def cloudasset_assets_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Name of the organization or project the assets belong to. Format: \"organizations/[organization-number]\" (such as \"organizations/123\"), \"projects/[project-id]\" (such as \"projects/my-project-id\"), or \"projects/[project-number]\" (such as \"projects/12345\").")],
    ...
    def _cloudasset_assets_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1p5beta1/{parent}/assets',
