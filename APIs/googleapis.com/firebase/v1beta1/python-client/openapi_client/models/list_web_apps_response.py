...
class ListWebAppsResponse(BaseModel):
    ...
    ListWebAppsResponse
    """ # noqa: E501
    apps: Optional[List[WebApp]] = Field(default=None, description="List of each `WebApp` associated with the specified `FirebaseProject`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [WebApp.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
