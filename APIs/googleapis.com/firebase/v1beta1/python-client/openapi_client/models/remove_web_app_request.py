...
class RemoveWebAppRequest(BaseModel):
    ...
    etag: Optional[StrictStr] = Field(default=None, description="Checksum provided in the WebApp resource. If provided, this checksum ensures that the client has an up-to-date value before proceeding.")
    immediate: Optional[StrictBool] = Field(default=None, description="Determines whether to _immediately_ delete the WebApp. If set to true, the App is immediately deleted from the Project and cannot be restored to the Project. If not set, defaults to false, which means the App will be set to expire in 30 days. Within the 30 days, the App may be restored to the Project using UndeleteWebApp")
