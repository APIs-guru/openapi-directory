...
class SearchFirebaseAppsResponse(BaseModel):
    ...
    """ # noqa: E501
    apps: Optional[List[FirebaseAppInfo]] = Field(default=None, description="One page of results from a call to `SearchFirebaseApps`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [FirebaseAppInfo.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
