...
class AvailableProjectsApi:
    ...
    def firebase_available_projects_list(
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of Projects to return in the response. The server may return fewer than this value at its discretion. If no value is specified (or too large a value is specified), the server will impose its own limit. This value cannot be negative.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Token returned from a previous call to `ListAvailableProjects` indicating where in the set of Projects to resume listing.")] = None,
        ...
        _param = self._firebase_available_projects_list_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAvailableProjectsResponse",
        }
    ...
    @validate_call
    def firebase_available_projects_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAvailableProjectsResponse]:
        """firebase_available_projects_list
    ...
    @validate_call
    def firebase_available_projects_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _firebase_available_projects_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta1/availableProjects',
