...
------------- | ------------- | -------------
[**oslogin_users_get_login_profile**](UsersApi.md#oslogin_users_get_login_profile) | **GET** /v1beta/{name}/loginProfile | 
[**oslogin_users_import_ssh_public_key**](UsersApi.md#oslogin_users_import_ssh_public_key) | **POST** /v1beta/{parent}:importSshPublicKey | 
[**oslogin_users_projects_zones_sign_ssh_public_key**](UsersApi.md#oslogin_users_projects_zones_sign_ssh_public_key) | **POST** /v1beta/{parent}:signSshPublicKey | 
[**oslogin_users_ssh_public_keys_create**](UsersApi.md#oslogin_users_ssh_public_keys_create) | **POST** /v1beta/{parent}/sshPublicKeys | 
[**oslogin_users_ssh_public_keys_delete**](UsersApi.md#oslogin_users_ssh_public_keys_delete) | **DELETE** /v1beta/{name} | 
[**oslogin_users_ssh_public_keys_get**](UsersApi.md#oslogin_users_ssh_public_keys_get) | **GET** /v1beta/{name} | 
[**oslogin_users_ssh_public_keys_patch**](UsersApi.md#oslogin_users_ssh_public_keys_patch) | **PATCH** /v1beta/{name} | 


# **oslogin_users_get_login_profile**
> LoginProfile oslogin_users_get_login_profile(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, project_id=project_id, system_id=system_id, view=view)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    view = 'view_example' # str | The view configures whether to retrieve security keys information. (optional)
 ...
 **view** | **str**| The view configures whether to retrieve security keys information. | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    parent = 'parent_example' # str | The unique ID for the user in format `users/{user}`.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
...
> SignSshPublicKeyResponse oslogin_users_projects_zones_sign_ssh_public_key(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, sign_ssh_public_key_request=sign_ssh_public_key_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    parent = 'parent_example' # str | The parent project and zone for the signing request. This is needed to properly ensure per-organization ISS processing and potentially to provide for the possibility of zone-specific certificates used in the signing process.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    sign_ssh_public_key_request = openapi_client.SignSshPublicKeyRequest() # SignSshPublicKeyRequest |  (optional)

    try:
        api_response = api_instance.oslogin_users_projects_zones_sign_ssh_public_key(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, sign_ssh_public_key_request=sign_ssh_public_key_request)
        print("The response of UsersApi->oslogin_users_projects_zones_sign_ssh_public_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->oslogin_users_projects_zones_sign_ssh_public_key: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| The parent project and zone for the signing request. This is needed to properly ensure per-organization ISS processing and potentially to provide for the possibility of zone-specific certificates used in the signing process. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **sign_ssh_public_key_request** | [**SignSshPublicKeyRequest**](SignSshPublicKeyRequest.md)|  | [optional] 
