...
------------- | ------------- | -------------
[**oslogin_users_get_login_profile**](UsersApi.md#oslogin_users_get_login_profile) | **GET** /v1alpha/{name}/loginProfile | 
[**oslogin_users_import_ssh_public_key**](UsersApi.md#oslogin_users_import_ssh_public_key) | **POST** /v1alpha/{parent}:importSshPublicKey | 
[**oslogin_users_projects_zones_sign_ssh_public_key**](UsersApi.md#oslogin_users_projects_zones_sign_ssh_public_key) | **POST** /v1alpha/{parent}:signSshPublicKey | 
[**oslogin_users_ssh_public_keys_create**](UsersApi.md#oslogin_users_ssh_public_keys_create) | **POST** /v1alpha/{parent}/sshPublicKeys | 
[**oslogin_users_ssh_public_keys_delete**](UsersApi.md#oslogin_users_ssh_public_keys_delete) | **DELETE** /v1alpha/{name} | 
[**oslogin_users_ssh_public_keys_get**](UsersApi.md#oslogin_users_ssh_public_keys_get) | **GET** /v1alpha/{name} | 
[**oslogin_users_ssh_public_keys_patch**](UsersApi.md#oslogin_users_ssh_public_keys_patch) | **PATCH** /v1alpha/{name} | 


# **oslogin_users_get_login_profile**
> LoginProfile oslogin_users_get_login_profile(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, operating_system_type=operating_system_type, project_id=project_id, system_id=system_id, view=view)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    operating_system_type = 'operating_system_type_example' # str | The type of operating system associated with the account. (optional)
 ...
 **operating_system_type** | **str**| The type of operating system associated with the account. | [optional] 
...
> object oslogin_users_ssh_public_keys_delete(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, operating_system_type=operating_system_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.oslogin_users_ssh_public_keys_delete(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, operating_system_type=operating_system_type)
