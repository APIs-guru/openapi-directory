...
------------ | ------------- | ------------- | -------------
*UsersApi* | [**oslogin_users_get_login_profile**](docs/UsersApi.md#oslogin_users_get_login_profile) | **GET** /v1/{name}/loginProfile | 
*UsersApi* | [**oslogin_users_import_ssh_public_key**](docs/UsersApi.md#oslogin_users_import_ssh_public_key) | **POST** /v1/{parent}:importSshPublicKey | 
*UsersApi* | [**oslogin_users_ssh_public_keys_create**](docs/UsersApi.md#oslogin_users_ssh_public_keys_create) | **POST** /v1/{parent}/sshPublicKeys | 
*UsersApi* | [**oslogin_users_ssh_public_keys_delete**](docs/UsersApi.md#oslogin_users_ssh_public_keys_delete) | **DELETE** /v1/{name} | 
*UsersApi* | [**oslogin_users_ssh_public_keys_get**](docs/UsersApi.md#oslogin_users_ssh_public_keys_get) | **GET** /v1/{name} | 
*UsersApi* | [**oslogin_users_ssh_public_keys_patch**](docs/UsersApi.md#oslogin_users_ssh_public_keys_patch) | **PATCH** /v1/{name} | 
