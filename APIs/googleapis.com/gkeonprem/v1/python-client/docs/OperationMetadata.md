...
**control_plane_disconnected** | **bool** | Output only. Denotes if the local managing cluster&#39;s control plane is currently disconnected. This is expected to occur temporarily during self-managed cluster upgrades. | [optional] [readonly] 
...
**type** | **str** | Output only. Type of operation being executed. | [optional] [readonly] 
