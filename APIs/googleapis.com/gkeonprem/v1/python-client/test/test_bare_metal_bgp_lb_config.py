...
class TestBareMetalBgpLbConfig(unittest.TestCase):
    """BareMetalBgpLbConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BareMetalBgpLbConfig:
        """Test BareMetalBgpLbConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BareMetalBgpLbConfig`
        """
        model = BareMetalBgpLbConfig()
        if include_optional:
    ...
    def testBareMetalBgpLbConfig(self):
        """Test BareMetalBgpLbConfig"""
