...
class TestBareMetalLoadBalancerNodePoolConfig(unittest.TestCase):
    """BareMetalLoadBalancerNodePoolConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BareMetalLoadBalancerNodePoolConfig:
        """Test BareMetalLoadBalancerNodePoolConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BareMetalLoadBalancerNodePoolConfig`
        """
        model = BareMetalLoadBalancerNodePoolConfig()
        if include_optional:
    ...
    def testBareMetalLoadBalancerNodePoolConfig(self):
        """Test BareMetalLoadBalancerNodePoolConfig"""
