...
class TestListBareMetalAdminClustersResponse(unittest.TestCase):
    """ListBareMetalAdminClustersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBareMetalAdminClustersResponse:
        """Test ListBareMetalAdminClustersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBareMetalAdminClustersResponse`
        """
        model = ListBareMetalAdminClustersResponse()
        if include_optional:
            return ListBareMetalAdminClustersResponse(
                bare_metal_admin_clusters = [
                    openapi_client.models.bare_metal_admin_cluster.BareMetalAdminCluster(
                        annotations = {
                            'key' : ''
                            }, 
                        bare_metal_version = '', 
    ...
    def testListBareMetalAdminClustersResponse(self):
        """Test ListBareMetalAdminClustersResponse"""
