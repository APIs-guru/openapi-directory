...
class TestVmwareNodePool(unittest.TestCase):
    """VmwareNodePool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VmwareNodePool:
        """Test VmwareNodePool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VmwareNodePool`
        """
        model = VmwareNodePool()
        if include_optional:
