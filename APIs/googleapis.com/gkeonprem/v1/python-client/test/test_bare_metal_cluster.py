...
class TestBareMetalCluster(unittest.TestCase):
    """BareMetalCluster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BareMetalCluster:
        """Test BareMetalCluster
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BareMetalCluster`
        """
        model = BareMetalCluster()
        if include_optional:
