...
class TestListVmwareAdminClustersResponse(unittest.TestCase):
    """ListVmwareAdminClustersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListVmwareAdminClustersResponse:
        """Test ListVmwareAdminClustersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListVmwareAdminClustersResponse`
        """
        model = ListVmwareAdminClustersResponse()
        if include_optional:
            return ListVmwareAdminClustersResponse(
                ...
                vmware_admin_clusters = [
                    openapi_client.models.vmware_admin_cluster.VmwareAdminCluster(
    ...
    def testListVmwareAdminClustersResponse(self):
        """Test ListVmwareAdminClustersResponse"""
