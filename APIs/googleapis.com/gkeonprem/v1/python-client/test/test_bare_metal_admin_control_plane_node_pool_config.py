...
class TestBareMetalAdminControlPlaneNodePoolConfig(unittest.TestCase):
    """BareMetalAdminControlPlaneNodePoolConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BareMetalAdminControlPlaneNodePoolConfig:
        """Test BareMetalAdminControlPlaneNodePoolConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BareMetalAdminControlPlaneNodePoolConfig`
        """
        model = BareMetalAdminControlPlaneNodePoolConfig()
        if include_optional:
    ...
    def testBareMetalAdminControlPlaneNodePoolConfig(self):
        """Test BareMetalAdminControlPlaneNodePoolConfig"""
