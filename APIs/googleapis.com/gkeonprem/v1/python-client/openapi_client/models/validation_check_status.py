...
class ValidationCheckStatus(BaseModel):
    """
    ValidationCheckStatus defines the detailed validation check status.
    """ # noqa: E501
    result: Optional[List[ValidationCheckResult]] = Field(default=None, description="Individual checks which failed as part of the Preflight check execution.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [ValidationCheckResult.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
