...
class VmwareSeesawConfig(BaseModel):
    """
    ...
    group: Optional[StrictStr] = Field(default=None, description="Required. In general the following format should be used for the Seesaw group name: seesaw-for-[cluster_name].")
    ip_blocks: Optional[List[VmwareIpBlock]] = Field(default=None, description="Required. The IP Blocks to be used by the Seesaw load balancer", alias="ipBlocks")
    master_ip: Optional[StrictStr] = Field(default=None, description="Required. MasterIP is the IP announced by the master of Seesaw group.", alias="masterIp")
