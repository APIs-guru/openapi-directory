...
class VmwareStaticIpConfig(BaseModel):
    """
    Represents the network configuration required for the VMware user clusters with Static IP configurations.
    """ # noqa: E501
    ip_blocks: Optional[List[VmwareIpBlock]] = Field(default=None, description="Represents the configuration values for static IP allocation to nodes.", alias="ipBlocks")
