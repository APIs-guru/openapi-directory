...
class BareMetalAdminNetworkConfig(BaseModel):
    """
    BareMetalAdminNetworkConfig specifies the cluster network configuration.
    """ # noqa: E501
    island_mode_cidr: Optional[BareMetalAdminIslandModeCidrConfig] = Field(default=None, alias="islandModeCidr")
    __properties: ClassVar[List[str]] = ["islandModeCidr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "islandModeCidr": BareMetalAdminIslandModeCidrConfig.from_dict(obj["islandModeCidr"]) if obj.get("islandModeCidr") is not None else None
        })
        return _obj
