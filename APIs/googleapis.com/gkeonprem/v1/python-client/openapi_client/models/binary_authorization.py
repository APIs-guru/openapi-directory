...
class BinaryAuthorization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["evaluationMode"]
    ...
    def evaluation_mode_validate_enum(cls, value):
        ...
        if value not in set(['EVALUATION_MODE_UNSPECIFIED', 'DISABLED', 'PROJECT_SINGLETON_POLICY_ENFORCE']):
            raise ValueError("must be one of enum values ('EVALUATION_MODE_UNSPECIFIED', 'DISABLED', 'PROJECT_SINGLETON_POLICY_ENFORCE')")
        return value
