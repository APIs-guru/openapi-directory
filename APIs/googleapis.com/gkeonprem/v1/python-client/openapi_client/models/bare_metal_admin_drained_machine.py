...
class BareMetalAdminDrainedMachine(BaseModel):
    """
    BareMetalAdminDrainedMachine represents the machines that are drained.
    """ # noqa: E501
    node_ip: Optional[StrictStr] = Field(default=None, description="Drained machine IP address.", alias="nodeIp")
    __properties: ClassVar[List[str]] = ["nodeIp"]
