...
class Fleet(BaseModel):
    ...
    """ # noqa: E501
    membership: Optional[StrictStr] = Field(default=None, description="Output only. The name of the managed fleet Membership resource associated to this cluster. Membership names are formatted as `projects//locations//memberships/`.")
