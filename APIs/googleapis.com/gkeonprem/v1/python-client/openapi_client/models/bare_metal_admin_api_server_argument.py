...
class BareMetalAdminApiServerArgument(BaseModel):
    """
    ...
    """ # noqa: E501
    argument: Optional[StrictStr] = Field(default=None, description="Required. The argument name as it appears on the API Server command line please make sure to remove the leading dashes.")
