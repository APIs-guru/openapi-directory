...
class BareMetalAdminLoadBalancerConfig(BaseModel):
    """
    BareMetalAdminLoadBalancerConfig specifies the load balancer configuration.
    """ # noqa: E501
    manual_lb_config: Optional[BareMetalAdminManualLbConfig] = Field(default=None, alias="manualLbConfig")
    port_config: Optional[BareMetalAdminPortConfig] = Field(default=None, alias="portConfig")
    vip_config: Optional[BareMetalAdminVipConfig] = Field(default=None, alias="vipConfig")
    __properties: ClassVar[List[str]] = ["manualLbConfig", "portConfig", "vipConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.port_config:
            _dict['portConfig'] = self.port_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "manualLbConfig": BareMetalAdminManualLbConfig.from_dict(obj["manualLbConfig"]) if obj.get("manualLbConfig") is not None else None,
            "portConfig": BareMetalAdminPortConfig.from_dict(obj["portConfig"]) if obj.get("portConfig") is not None else None,
            "vipConfig": BareMetalAdminVipConfig.from_dict(obj["vipConfig"]) if obj.get("vipConfig") is not None else None
        })
        return _obj
