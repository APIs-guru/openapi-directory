...
class EnrollVmwareClusterRequest(BaseModel):
    """
    ...
    validate_only: Optional[StrictBool] = Field(default=None, description="Validate the request without actually doing any updates.", alias="validateOnly")
    vmware_cluster_id: Optional[StrictStr] = Field(default=None, description="User provided OnePlatform identifier that is used as part of the resource name. This must be unique among all GKE on-prem clusters within a project and location and will return a 409 if the cluster already exists. (https://tools.ietf.org/html/rfc1123) format.", alias="vmwareClusterId")
    __properties: ClassVar[List[str]] = ["adminClusterMembership", "localName", "validateOnly", "vmwareClusterId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vmwareClusterId": obj.get("vmwareClusterId")
        })
        return _obj
