...
class VmwareDhcpIpConfig(BaseModel):
    """
    Represents the network configuration required for the VMware user clusters with DHCP IP configurations.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="enabled is a flag to mark if DHCP IP allocation is used for VMware user clusters.")
