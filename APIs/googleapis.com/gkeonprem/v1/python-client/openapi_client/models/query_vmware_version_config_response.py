...
class QueryVmwareVersionConfigResponse(BaseModel):
    """
    Response message for querying VMware user cluster version config.
    """ # noqa: E501
    versions: Optional[List[VmwareVersionInfo]] = Field(default=None, description="List of available versions to install or to upgrade to.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [VmwareVersionInfo.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
