...
class TestCreateClusterMetadata(unittest.TestCase):
    """CreateClusterMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateClusterMetadata:
        """Test CreateClusterMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateClusterMetadata`
        """
        model = CreateClusterMetadata()
        if include_optional:
            return CreateClusterMetadata(
                finish_time = '',
                original_request = openapi_client.models.create_cluster_request.CreateClusterRequest(
                ...
                request_time = '',
                tables = {
                    'key' : openapi_client.models.table_progress.TableProgress(
    ...
    def testCreateClusterMetadata(self):
        """Test CreateClusterMetadata"""
