...
class TestPartialUpdateClusterMetadata(unittest.TestCase):
    """PartialUpdateClusterMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialUpdateClusterMetadata:
        """Test PartialUpdateClusterMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartialUpdateClusterMetadata`
        """
        model = PartialUpdateClusterMetadata()
        if include_optional:
            return PartialUpdateClusterMetadata(
                finish_time = '',
                original_request = openapi_client.models.partial_update_cluster_request.PartialUpdateClusterRequest(
    ...
    def testPartialUpdateClusterMetadata(self):
        """Test PartialUpdateClusterMetadata"""
