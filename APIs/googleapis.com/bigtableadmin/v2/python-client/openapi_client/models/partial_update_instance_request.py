...
class PartialUpdateInstanceRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. The subset of Instance fields which should be replaced. Must be explicitly set.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["instance", "updateMask"]
