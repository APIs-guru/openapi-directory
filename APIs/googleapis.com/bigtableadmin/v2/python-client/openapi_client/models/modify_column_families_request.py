...
class ModifyColumnFamiliesRequest(BaseModel):
    ...
    """ # noqa: E501
    ignore_warnings: Optional[StrictBool] = Field(default=None, description="Optional. If true, ignore safety checks when modifying the column families.", alias="ignoreWarnings")
    modifications: Optional[List[Modification]] = Field(default=None, description="Required. Modifications to be atomically applied to the specified table's families. Entries are applied in order, meaning that earlier modifications can be masked by later ones (in the case of repeated updates to the same family, for example).")
    __properties: ClassVar[List[str]] = ["ignoreWarnings", "modifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ignoreWarnings": obj.get("ignoreWarnings"),
