...
class TestListGroupStatsResponse(unittest.TestCase):
    """ListGroupStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGroupStatsResponse:
        """Test ListGroupStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGroupStatsResponse`
        """
        model = ListGroupStatsResponse()
        if include_optional:
            return ListGroupStatsResponse(
                error_group_stats = [
                    openapi_client.models.error_group_stats.ErrorGroupStats(
                        affected_services = [
    ...
    def testListGroupStatsResponse(self):
        """Test ListGroupStatsResponse"""
