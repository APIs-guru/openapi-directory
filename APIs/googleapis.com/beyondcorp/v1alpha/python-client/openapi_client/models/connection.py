...
class Connection(BaseModel):
    ...
    """ # noqa: E501
    application_endpoint: Optional[ApplicationEndpoint] = Field(default=None, alias="applicationEndpoint")
    connectors: Optional[List[StrictStr]] = Field(default=None, description="Optional. List of [google.cloud.beyondcorp.v1main.Connector.name] that are authorised to be associated with this Connection.")
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="Optional. An arbitrary user-provided name for the connection. Cannot exceed 64 characters.", alias="displayName")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Unique resource name of the connection. The name is ignored when creating a connection.")
    state: Optional[StrictStr] = Field(default=None, description="Output only. The current state of the connection.")
    type: Optional[StrictStr] = Field(default=None, description="Required. The type of network connectivity used by the connection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationEndpoint": ApplicationEndpoint.from_dict(obj["applicationEndpoint"]) if obj.get("applicationEndpoint") is not None else None,
