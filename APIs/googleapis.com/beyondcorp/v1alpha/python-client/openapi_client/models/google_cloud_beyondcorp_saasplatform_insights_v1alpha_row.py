...
class GoogleCloudBeyondcorpSaasplatformInsightsV1alphaRow(BaseModel):
    """
    Row of the fetch response consisting of a set of entries.
    """ # noqa: E501
    field_values: Optional[List[GoogleCloudBeyondcorpSaasplatformInsightsV1alphaRowFieldVal]] = Field(default=None, description="Output only. Columns/entries/key-vals in the result.", alias="fieldValues")
    __properties: ClassVar[List[str]] = ["fieldValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fieldValues": [GoogleCloudBeyondcorpSaasplatformInsightsV1alphaRowFieldVal.from_dict(_item) for _item in obj["fieldValues"]] if obj.get("fieldValues") is not None else None
        })
        return _obj
