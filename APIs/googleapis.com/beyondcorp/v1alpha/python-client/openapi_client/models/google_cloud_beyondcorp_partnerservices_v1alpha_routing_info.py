...
class GoogleCloudBeyondcorpPartnerservicesV1alphaRoutingInfo(BaseModel):
    """
    Message contains the routing information to direct traffic to the proxy server.
    """ # noqa: E501
    pac_uri: Optional[StrictStr] = Field(default=None, description="Required. Proxy Auto-Configuration (PAC) URI.", alias="pacUri")
    __properties: ClassVar[List[str]] = ["pacUri"]
