...
class GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfo(BaseModel):
    """
    PrincipalInfo represents an Identity oneof.
    """ # noqa: E501
    service_account: Optional[GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoServiceAccount] = Field(default=None, alias="serviceAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceAccount": GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoServiceAccount.from_dict(obj["serviceAccount"]) if obj.get("serviceAccount") is not None else None
        })
        return _obj
