...
class ResolveInstanceConfigResponse(BaseModel):
    """
    Response message for BeyondCorp.ResolveInstanceConfig.
    """ # noqa: E501
    instance_config: Optional[ConnectorInstanceConfig] = Field(default=None, alias="instanceConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instanceConfig": ConnectorInstanceConfig.from_dict(obj["instanceConfig"]) if obj.get("instanceConfig") is not None else None
        })
        return _obj
