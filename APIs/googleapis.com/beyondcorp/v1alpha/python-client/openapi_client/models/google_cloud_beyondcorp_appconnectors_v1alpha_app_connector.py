...
class GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector(BaseModel):
    """
    ...
    principal_info: Optional[GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfo] = Field(default=None, alias="principalInfo")
    resource_info: Optional[GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfo] = Field(default=None, alias="resourceInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "principalInfo": GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfo.from_dict(obj["principalInfo"]) if obj.get("principalInfo") is not None else None,
            "resourceInfo": GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfo.from_dict(obj["resourceInfo"]) if obj.get("resourceInfo") is not None else None,
            "state": obj.get("state"),
            "uid": obj.get("uid"),
