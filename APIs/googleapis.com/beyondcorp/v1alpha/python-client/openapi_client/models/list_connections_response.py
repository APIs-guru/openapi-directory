...
class ListConnectionsResponse(BaseModel):
    ...
    """ # noqa: E501
    connections: Optional[List[Connection]] = Field(default=None, description="A list of BeyondCorp Connections in the project.")
    ...
    __properties: ClassVar[List[str]] = ["connections", "nextPageToken", "unreachable"]
