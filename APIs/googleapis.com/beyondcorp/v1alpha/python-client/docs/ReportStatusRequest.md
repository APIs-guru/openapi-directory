...
report_status_request_instance = ReportStatusRequest.from_json(json)
# print the JSON string representation of the object
print(ReportStatusRequest.to_json())

# convert the object into a dict
report_status_request_dict = report_status_request_instance.to_dict()
# create an instance of ReportStatusRequest from a dict
report_status_request_from_dict = ReportStatusRequest.from_dict(report_status_request_dict)
```
