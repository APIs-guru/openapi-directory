...
connector_operation_metadata_instance = ConnectorOperationMetadata.from_json(json)
# print the JSON string representation of the object
print(ConnectorOperationMetadata.to_json())

# convert the object into a dict
connector_operation_metadata_dict = connector_operation_metadata_instance.to_dict()
# create an instance of ConnectorOperationMetadata from a dict
connector_operation_metadata_from_dict = ConnectorOperationMetadata.from_dict(connector_operation_metadata_dict)
```
