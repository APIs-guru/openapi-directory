...
------------ | ------------- | ------------- | -------------
**stable_image** | **str** | The stable image that the remote agent will fallback to if the target image fails. | [optional] 
**target_image** | **str** | The initial image the remote agent will attempt to run for the control plane. | [optional] 
