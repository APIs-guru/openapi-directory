...
json = "{}"
# create an instance of ConnectionOperationMetadata from a JSON string
connection_operation_metadata_instance = ConnectionOperationMetadata.from_json(json)
# print the JSON string representation of the object
print(ConnectionOperationMetadata.to_json())

# convert the object into a dict
connection_operation_metadata_dict = connection_operation_metadata_instance.to_dict()
# create an instance of ConnectionOperationMetadata from a dict
connection_operation_metadata_from_dict = ConnectionOperationMetadata.from_dict(connection_operation_metadata_dict)
```
