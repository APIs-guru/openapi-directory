...
json = "{}"
# create an instance of AppGatewayOperationMetadata from a JSON string
app_gateway_operation_metadata_instance = AppGatewayOperationMetadata.from_json(json)
# print the JSON string representation of the object
print(AppGatewayOperationMetadata.to_json())

# convert the object into a dict
app_gateway_operation_metadata_dict = app_gateway_operation_metadata_instance.to_dict()
# create an instance of AppGatewayOperationMetadata from a dict
app_gateway_operation_metadata_from_dict = AppGatewayOperationMetadata.from_dict(app_gateway_operation_metadata_dict)
```
