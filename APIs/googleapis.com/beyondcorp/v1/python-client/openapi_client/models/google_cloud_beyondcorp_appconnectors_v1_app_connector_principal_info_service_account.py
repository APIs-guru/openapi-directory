...
class GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoServiceAccount(BaseModel):
    """
    ServiceAccount represents a GCP service account.
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Email address of the service account.")
