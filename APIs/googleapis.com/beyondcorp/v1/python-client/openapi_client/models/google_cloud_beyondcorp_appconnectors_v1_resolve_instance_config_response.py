...
class GoogleCloudBeyondcorpAppconnectorsV1ResolveInstanceConfigResponse(BaseModel):
    ...
    """ # noqa: E501
    instance_config: Optional[GoogleCloudBeyondcorpAppconnectorsV1AppConnectorInstanceConfig] = Field(default=None, alias="instanceConfig")
    __properties: ClassVar[List[str]] = ["instanceConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instanceConfig": GoogleCloudBeyondcorpAppconnectorsV1AppConnectorInstanceConfig.from_dict(obj["instanceConfig"]) if obj.get("instanceConfig") is not None else None
        })
        return _obj
