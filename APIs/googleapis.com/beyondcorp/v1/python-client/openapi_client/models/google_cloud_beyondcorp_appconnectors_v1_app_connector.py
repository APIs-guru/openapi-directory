...
class GoogleCloudBeyondcorpAppconnectorsV1AppConnector(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="Optional. An arbitrary user-provided name for the AppConnector. Cannot exceed 64 characters.", alias="displayName")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Unique resource name of the AppConnector. The name is ignored when creating a AppConnector.")
    principal_info: Optional[GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo] = Field(default=None, alias="principalInfo")
    resource_info: Optional[GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo] = Field(default=None, alias="resourceInfo")
    state: Optional[StrictStr] = Field(default=None, description="Output only. The current state of the AppConnector.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudBeyondcorpAppconnectorsV1AppConnector from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudBeyondcorpAppconnectorsV1AppConnector from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "principalInfo": GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo.from_dict(obj["principalInfo"]) if obj.get("principalInfo") is not None else None,
            "resourceInfo": GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo.from_dict(obj["resourceInfo"]) if obj.get("resourceInfo") is not None else None,
            "state": obj.get("state"),
            "uid": obj.get("uid"),
