...
class GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo(BaseModel):
    ...
    """ # noqa: E501
    service_account: Optional[GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoServiceAccount] = Field(default=None, alias="serviceAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceAccount": GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoServiceAccount.from_dict(obj["serviceAccount"]) if obj.get("serviceAccount") is not None else None
        })
        return _obj
