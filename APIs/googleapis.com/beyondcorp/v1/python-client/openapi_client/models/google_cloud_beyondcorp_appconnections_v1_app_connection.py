...
class GoogleCloudBeyondcorpAppconnectionsV1AppConnection(BaseModel):
    ...
    """ # noqa: E501
    application_endpoint: Optional[GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpoint] = Field(default=None, alias="applicationEndpoint")
    ...
    gateway: Optional[GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationEndpoint": GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpoint.from_dict(obj["applicationEndpoint"]) if obj.get("applicationEndpoint") is not None else None,
            "connectors": obj.get("connectors"),
            "createTime": obj.get("createTime"),
            "displayName": obj.get("displayName"),
            "gateway": GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway.from_dict(obj["gateway"]) if obj.get("gateway") is not None else None,
