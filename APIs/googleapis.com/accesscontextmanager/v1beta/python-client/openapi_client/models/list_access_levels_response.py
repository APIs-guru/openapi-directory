...
class ListAccessLevelsResponse(BaseModel):
    ...
    """ # noqa: E501
    access_levels: Optional[List[AccessLevel]] = Field(default=None, description="List of the Access Level instances.", alias="accessLevels")
    ...
    __properties: ClassVar[List[str]] = ["accessLevels", "nextPageToken"]
