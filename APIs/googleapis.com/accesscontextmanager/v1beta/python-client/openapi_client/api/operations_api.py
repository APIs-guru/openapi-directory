...
class OperationsApi:
    ...
    def accesscontextmanager_operations_get(
        ...
        access_level_format: Annotated[Optional[StrictStr], Field(description="Whether to return `BasicLevels` in the Cloud Common Expression Language rather than as `BasicLevels`. Defaults to AS_DEFINED, where Access Levels are returned as `BasicLevels` or `CustomLevels` based on how they were created. If set to CEL, all Access Levels are returned as `CustomLevels`. In the CEL case, `BasicLevels` are translated to equivalent `CustomLevels`.")] = None,
        ...
        _param = self._accesscontextmanager_operations_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def accesscontextmanager_operations_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def accesscontextmanager_operations_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _accesscontextmanager_operations_get_serialize(
        self,
        name,
        xgafv,
        access_token,
