...
class TestReplaceAccessLevelsResponse(unittest.TestCase):
    """ReplaceAccessLevelsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceAccessLevelsResponse:
        """Test ReplaceAccessLevelsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceAccessLevelsResponse`
        """
        model = ReplaceAccessLevelsResponse()
        if include_optional:
    ...
    def testReplaceAccessLevelsResponse(self):
        """Test ReplaceAccessLevelsResponse"""
