...
class OperationsApi:
    ...
    @validate_call
    def accesscontextmanager_operations_cancel(
        self,
        ...
        _param = self._accesscontextmanager_operations_cancel_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def accesscontextmanager_operations_cancel_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def accesscontextmanager_operations_cancel_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _accesscontextmanager_operations_cancel_serialize(
        self,
        name,
        xgafv,
        access_token,
