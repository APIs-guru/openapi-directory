...
class ReplaceServicePerimetersRequest(BaseModel):
    """
    ...
    service_perimeters: Optional[List[ServicePerimeter]] = Field(default=None, description="Required. The desired Service Perimeters that should replace all existing Service Perimeters in the Access Policy.", alias="servicePerimeters")
    __properties: ClassVar[List[str]] = ["etag", "servicePerimeters"]
