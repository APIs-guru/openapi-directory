...
class Condition(BaseModel):
    ...
    """ # noqa: E501
    device_policy: Optional[DevicePolicy] = Field(default=None, alias="devicePolicy")
    ...
    vpc_network_sources: Optional[List[VpcNetworkSource]] = Field(default=None, description="The request must originate from one of the provided VPC networks in Google Cloud. Cannot specify this field together with `ip_subnetworks`.", alias="vpcNetworkSources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devicePolicy": DevicePolicy.from_dict(obj["devicePolicy"]) if obj.get("devicePolicy") is not None else None,
            "ipSubnetworks": obj.get("ipSubnetworks"),
            "members": obj.get("members"),
            "negate": obj.get("negate"),
            "regions": obj.get("regions"),
            "requiredAccessLevels": obj.get("requiredAccessLevels"),
            "vpcNetworkSources": [VpcNetworkSource.from_dict(_item) for _item in obj["vpcNetworkSources"]] if obj.get("vpcNetworkSources") is not None else None
        })
        return _obj
