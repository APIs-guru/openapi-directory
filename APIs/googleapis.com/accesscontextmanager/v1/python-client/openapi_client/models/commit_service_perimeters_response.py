...
class CommitServicePerimetersResponse(BaseModel):
    """
    A response to CommitServicePerimetersRequest. This will be put inside of Operation.response field.
    """ # noqa: E501
    service_perimeters: Optional[List[ServicePerimeter]] = Field(default=None, description="List of all the Service Perimeter instances in the Access Policy.", alias="servicePerimeters")
