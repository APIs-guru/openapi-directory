...
------------ | ------------- | ------------- | -------------
**periods** | [**List[TimePeriod]**](TimePeriod.md) | A collection of times that this location is open for business. Each period represents a range of hours when the location is open during the week. | [optional] 
