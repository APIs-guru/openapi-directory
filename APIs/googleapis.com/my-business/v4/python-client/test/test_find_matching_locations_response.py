...
class TestFindMatchingLocationsResponse(unittest.TestCase):
    """FindMatchingLocationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindMatchingLocationsResponse:
        """Test FindMatchingLocationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindMatchingLocationsResponse`
        """
        model = FindMatchingLocationsResponse()
        if include_optional:
            return FindMatchingLocationsResponse(
                match_time = '',
                matched_locations = [
                    openapi_client.models.matched_location.MatchedLocation(
                        is_exact_match = True, 
    ...
    def testFindMatchingLocationsResponse(self):
        """Test FindMatchingLocationsResponse"""
