...
class TestFoodMenuItemAttributes(unittest.TestCase):
    """FoodMenuItemAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FoodMenuItemAttributes:
        """Test FoodMenuItemAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FoodMenuItemAttributes`
        """
        model = FoodMenuItemAttributes()
        if include_optional:
            return FoodMenuItemAttributes(
                allergen = [
    ...
    def testFoodMenuItemAttributes(self):
        """Test FoodMenuItemAttributes"""
