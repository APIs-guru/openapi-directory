...
class TestDimensionalMetricValue(unittest.TestCase):
    """DimensionalMetricValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DimensionalMetricValue:
        """Test DimensionalMetricValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DimensionalMetricValue`
        """
        model = DimensionalMetricValue()
        if include_optional:
    ...
    def testDimensionalMetricValue(self):
        """Test DimensionalMetricValue"""
