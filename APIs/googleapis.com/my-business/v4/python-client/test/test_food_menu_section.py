...
class TestFoodMenuSection(unittest.TestCase):
    """FoodMenuSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FoodMenuSection:
        """Test FoodMenuSection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FoodMenuSection`
        """
        model = FoodMenuSection()
        if include_optional:
            return FoodMenuSection(
                items = [
                    openapi_client.models.food_menu_item.FoodMenuItem(
