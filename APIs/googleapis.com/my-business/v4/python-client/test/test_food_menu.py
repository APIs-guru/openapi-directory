...
class TestFoodMenu(unittest.TestCase):
    """FoodMenu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FoodMenu:
        """Test FoodMenu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FoodMenu`
        """
        model = FoodMenu()
        if include_optional:
            return FoodMenu(
                ...
                sections = [
                    openapi_client.models.food_menu_section.FoodMenuSection(
                        items = [
