...
class TestListMediaItemsResponse(unittest.TestCase):
    """ListMediaItemsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMediaItemsResponse:
        """Test ListMediaItemsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMediaItemsResponse`
        """
        model = ListMediaItemsResponse()
        if include_optional:
    ...
    def testListMediaItemsResponse(self):
        """Test ListMediaItemsResponse"""
