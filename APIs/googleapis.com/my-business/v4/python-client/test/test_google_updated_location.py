...
class TestGoogleUpdatedLocation(unittest.TestCase):
    """GoogleUpdatedLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleUpdatedLocation:
        """Test GoogleUpdatedLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleUpdatedLocation`
        """
        model = GoogleUpdatedLocation()
        if include_optional:
    ...
    def testGoogleUpdatedLocation(self):
        """Test GoogleUpdatedLocation"""
