...
class TestReportLocalPostInsightsResponse(unittest.TestCase):
    """ReportLocalPostInsightsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportLocalPostInsightsResponse:
        """Test ReportLocalPostInsightsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportLocalPostInsightsResponse`
        """
        model = ReportLocalPostInsightsResponse()
        if include_optional:
            return ReportLocalPostInsightsResponse(
                local_post_metrics = [
                    openapi_client.models.local_post_metrics.LocalPostMetrics(
                        local_post_name = '', 
                        metric_values = [
    ...
    def testReportLocalPostInsightsResponse(self):
        """Test ReportLocalPostInsightsResponse"""
