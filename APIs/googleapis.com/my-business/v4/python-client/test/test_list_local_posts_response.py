...
class TestListLocalPostsResponse(unittest.TestCase):
    """ListLocalPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListLocalPostsResponse:
        """Test ListLocalPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListLocalPostsResponse`
        """
        model = ListLocalPostsResponse()
        if include_optional:
            return ListLocalPostsResponse(
                local_posts = [
                    openapi_client.models.local_post.LocalPost(
    ...
    def testListLocalPostsResponse(self):
        """Test ListLocalPostsResponse"""
