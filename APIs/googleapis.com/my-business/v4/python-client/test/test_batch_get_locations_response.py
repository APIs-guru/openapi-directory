...
class TestBatchGetLocationsResponse(unittest.TestCase):
    """BatchGetLocationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchGetLocationsResponse:
        """Test BatchGetLocationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchGetLocationsResponse`
        """
        model = BatchGetLocationsResponse()
        if include_optional:
    ...
    def testBatchGetLocationsResponse(self):
        """Test BatchGetLocationsResponse"""
