...
class TestFoodMenus(unittest.TestCase):
    """FoodMenus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FoodMenus:
        """Test FoodMenus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FoodMenus`
        """
        model = FoodMenus()
        if include_optional:
            return FoodMenus(
                menus = [
                    openapi_client.models.food_menu.FoodMenu(
                        cuisines = [
                            'CUISINE_UNSPECIFIED'
                            ], 
                        labels = [
