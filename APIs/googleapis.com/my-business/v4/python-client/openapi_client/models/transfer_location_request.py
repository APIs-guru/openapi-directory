...
class TransferLocationRequest(BaseModel):
    ...
    """ # noqa: E501
    to_account: Optional[StrictStr] = Field(default=None, description="Name of the account resource to transfer the location to (for example, \"accounts/8675309\").", alias="toAccount")
    __properties: ClassVar[List[str]] = ["toAccount"]
