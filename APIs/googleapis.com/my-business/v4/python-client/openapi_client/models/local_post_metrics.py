...
class LocalPostMetrics(BaseModel):
    """
    All the metrics requested for a Local Post.
    """ # noqa: E501
    local_post_name: Optional[StrictStr] = Field(default=None, alias="localPostName")
    ...
    __properties: ClassVar[List[str]] = ["localPostName", "metricValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localPostName": obj.get("localPostName"),
