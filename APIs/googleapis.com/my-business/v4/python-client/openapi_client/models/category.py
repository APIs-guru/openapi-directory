...
class Category(BaseModel):
    ...
    """ # noqa: E501
    category_id: Optional[StrictStr] = Field(default=None, description="@OutputOnly. A stable ID (provided by Google) for this category. The `category_id` must be specified when modifying the category (when creating or updating a location).", alias="categoryId")
    display_name: Optional[StrictStr] = Field(default=None, description="@OutputOnly. The human-readable name of the category. This is set when reading the location. When modifying the location, `category_id` must be set.", alias="displayName")
    ...
    service_types: Optional[List[ServiceType]] = Field(default=None, description="@OutputOnly. A list of all the service types that are available for this business category.", alias="serviceTypes")
    __properties: ClassVar[List[str]] = ["categoryId", "displayName", "moreHoursTypes", "serviceTypes"]
