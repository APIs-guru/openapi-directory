...
class PhoneVerificationData(BaseModel):
    """
    Display Data for verifications through phone, e.g. phone call, sms.
    """ # noqa: E501
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number that the PIN will be sent to.", alias="phoneNumber")
