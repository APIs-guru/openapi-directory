...
class AssociateLocationRequest(BaseModel):
    ...
    """ # noqa: E501
    place_id: Optional[StrictStr] = Field(default=None, description="The association to establish. If not set, it indicates no match.", alias="placeId")
    __properties: ClassVar[List[str]] = ["placeId"]
