...
class FoodMenuItemOption(BaseModel):
    """
    Option of an Item. It requires an explicit user selection.
    """ # noqa: E501
    attributes: Optional[FoodMenuItemAttributes] = None
    labels: Optional[List[MenuLabel]] = Field(default=None, description="Required. Language tagged labels for this menu item option. E.g.: \"beef pad thai\", \"veggie pad thai\", \"small pizza\", \"large pizza\". Display names should be 140 characters or less, with descriptions 1,000 characters or less. At least one set of labels is required.")
    __properties: ClassVar[List[str]] = ["attributes", "labels"]
