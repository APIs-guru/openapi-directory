...
class ListInvitationsResponse(BaseModel):
    ...
    """ # noqa: E501
    invitations: Optional[List[Invitation]] = Field(default=None, description="A collection of location invitations that are pending for the account. The number of invitations listed here cannot exceed 1000.")
