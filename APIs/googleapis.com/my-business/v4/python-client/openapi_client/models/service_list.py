...
class ServiceList(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Required. Google identifier for this location in the form: `accounts/{account_id}/locations/{location_id}/serviceList`")
    service_items: Optional[List[ServiceItem]] = Field(default=None, description="Service items that are contained within this service list. Duplicated service items will be removed automatically.", alias="serviceItems")
    __properties: ClassVar[List[str]] = ["name", "serviceItems"]
