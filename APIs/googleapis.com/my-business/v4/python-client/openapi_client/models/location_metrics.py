...
class LocationMetrics(BaseModel):
    ...
    """ # noqa: E501
    location_name: Optional[StrictStr] = Field(default=None, description="The location resource name these values belong to.", alias="locationName")
    metric_values: Optional[List[MetricValue]] = Field(default=None, description="A list of values for the requested metrics.", alias="metricValues")
    time_zone: Optional[StrictStr] = Field(default=None, description="IANA timezone for the location.", alias="timeZone")
    __properties: ClassVar[List[str]] = ["locationName", "metricValues", "timeZone"]
