...
class FetchVerificationOptionsRequest(BaseModel):
    ...
    language_code: Optional[StrictStr] = Field(default=None, description="The BCP 47 language code representing the language that is to be used for the verification process. Available options vary by language.", alias="languageCode")
    __properties: ClassVar[List[str]] = ["context", "languageCode"]
