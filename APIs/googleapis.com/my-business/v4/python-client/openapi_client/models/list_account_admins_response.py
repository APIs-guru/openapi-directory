...
class ListAccountAdminsResponse(BaseModel):
    ...
    """ # noqa: E501
    admins: Optional[List[Admin]] = Field(default=None, description="A collection of Admin instances.")
    __properties: ClassVar[List[str]] = ["admins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "admins": [Admin.from_dict(_item) for _item in obj["admins"]] if obj.get("admins") is not None else None
        })
        return _obj
