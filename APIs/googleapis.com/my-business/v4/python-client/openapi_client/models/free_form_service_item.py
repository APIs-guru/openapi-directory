...
class FreeFormServiceItem(BaseModel):
    ...
    """ # noqa: E501
    category_id: Optional[StrictStr] = Field(default=None, description="Required. The `category_id` and `service_type_id` should match the possible combinations provided in the `Category` message.", alias="categoryId")
    label: Optional[Label] = None
    __properties: ClassVar[List[str]] = ["categoryId", "label"]
