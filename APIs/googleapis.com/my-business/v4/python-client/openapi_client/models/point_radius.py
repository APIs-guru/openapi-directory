...
class PointRadius(BaseModel):
    ...
    radius_km: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The distance in kilometers of the area around the point.", alias="radiusKm")
    __properties: ClassVar[List[str]] = ["latlng", "radiusKm"]
