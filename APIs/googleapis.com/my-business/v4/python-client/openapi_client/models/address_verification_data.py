...
class AddressVerificationData(BaseModel):
    ...
    business_name: Optional[StrictStr] = Field(default=None, description="Merchant's business name.", alias="businessName")
    __properties: ClassVar[List[str]] = ["address", "businessName"]
