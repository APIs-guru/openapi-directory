...
class VerifyLocationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["verification"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyLocationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyLocationResponse from a dict"""
        if obj is None:
            return None
