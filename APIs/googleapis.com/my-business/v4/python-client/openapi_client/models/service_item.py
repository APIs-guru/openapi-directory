...
class ServiceItem(BaseModel):
    ...
    is_offered: Optional[StrictBool] = Field(default=None, description="Optional. This field decides whether or not the input service is offered by the merchant.", alias="isOffered")
    price: Optional[Money] = None
    structured_service_item: Optional[StructuredServiceItem] = Field(default=None, alias="structuredServiceItem")
    __properties: ClassVar[List[str]] = ["freeFormServiceItem", "isOffered", "price", "structuredServiceItem"]
