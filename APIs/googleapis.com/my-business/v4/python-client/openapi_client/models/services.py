...
class Services(BaseModel):
    ...
    languages_spoken: Optional[LanguagesSpoken] = Field(default=None, alias="languagesSpoken")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of languages_spoken
        if self.languages_spoken:
            _dict['languagesSpoken'] = self.languages_spoken.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "languagesSpoken": LanguagesSpoken.from_dict(obj["languagesSpoken"]) if obj.get("languagesSpoken") is not None else None,
