...
class Ingredient(BaseModel):
    ...
    """ # noqa: E501
    labels: Optional[List[MenuLabel]] = Field(default=None, description="Required. Labels to describe ingredient. Display names should be 140 characters or less, with descriptions 1,000 characters or less. At least one set of labels is required.")
