...
class GoogleLocationsApi:
    ...
    @validate_call
    def mybusiness_google_locations_report(
        self,
        name: Annotated[StrictStr, Field(description="Resource name of a [GoogleLocation], in the format `googleLocations/{googleLocationId}`.")],
        ...
        report_google_location_request: Optional[ReportGoogleLocationRequest] = None,
        ...
        """mybusiness_google_locations_report
        ...
        :param report_google_location_request:
        :type report_google_location_request: ReportGoogleLocationRequest
        ...
        _param = self._mybusiness_google_locations_report_serialize(
            name=name,
            xgafv=xgafv,
            ...
            report_google_location_request=report_google_location_request,
    ...
    @validate_call
    def mybusiness_google_locations_report_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Resource name of a [GoogleLocation], in the format `googleLocations/{googleLocationId}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusiness_google_locations_report_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Resource name of a [GoogleLocation], in the format `googleLocations/{googleLocationId}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusiness_google_locations_report_serialize(
        self,
        name,
        xgafv,
        access_token,
        ...
        upload_protocol,
        upload_type,
        report_google_location_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if report_google_location_request is not None:
            _body_params = report_google_location_request
    ...
    @validate_call
    def mybusiness_google_locations_search(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        search_google_locations_request: Optional[SearchGoogleLocationsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """mybusiness_google_locations_search
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param search_google_locations_request:
        :type search_google_locations_request: SearchGoogleLocationsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._mybusiness_google_locations_search_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            search_google_locations_request=search_google_locations_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchGoogleLocationsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def mybusiness_google_locations_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchGoogleLocationsResponse]:
        """mybusiness_google_locations_search
    ...
    @validate_call
    def mybusiness_google_locations_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _mybusiness_google_locations_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        upload_protocol,
        upload_type,
        search_google_locations_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if search_google_locations_request is not None:
            _body_params = search_google_locations_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v4/googleLocations:search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
