...
class ChainsApi:
    ...
    @validate_call
    def mybusiness_chains_get(
        self,
        name: Annotated[StrictStr, Field(description="The chain's resource name, in the format `chains/{chain_place_id}`.")],
        ...
        _param = self._mybusiness_chains_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def mybusiness_chains_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The chain's resource name, in the format `chains/{chain_place_id}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def mybusiness_chains_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The chain's resource name, in the format `chains/{chain_place_id}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _mybusiness_chains_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def mybusiness_chains_search(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        chain_display_name: Annotated[Optional[StrictStr], Field(description="Search for a chain by its name. Exact/partial/fuzzy/related queries are supported. Examples: \"walmart\", \"wal-mart\", \"walmmmart\", \"沃尔玛\"")] = None,
        result_count: Annotated[Optional[StrictInt], Field(description="The maximum number of matched chains to return from this query. The default is 10. The maximum possible value is 500.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._mybusiness_chains_search_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def mybusiness_chains_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def mybusiness_chains_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _mybusiness_chains_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if chain_display_name is not None:
            
            _query_params.append(('chainDisplayName', chain_display_name))
            
        if result_count is not None:
            
            _query_params.append(('resultCount', result_count))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v4/chains:search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
