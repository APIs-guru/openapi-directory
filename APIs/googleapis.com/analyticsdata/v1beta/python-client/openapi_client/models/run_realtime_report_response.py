...
class RunRealtimeReportResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this message is. This `kind` is always the fixed string \"analyticsData#runRealtimeReport\". Useful to distinguish between response types in JSON.")
    ...
    row_count: Optional[StrictInt] = Field(default=None, description="The total number of rows in the query result. `rowCount` is independent of the number of rows returned in the response and the `limit` request parameter. For example if a query returns 175 rows and includes `limit` of 50 in the API request, the response will contain `rowCount` of 175 but only 50 rows.", alias="rowCount")
    ...
    __properties: ClassVar[List[str]] = ["dimensionHeaders", "kind", "maximums", "metricHeaders", "minimums", "propertyQuota", "rowCount", "rows", "totals"]
