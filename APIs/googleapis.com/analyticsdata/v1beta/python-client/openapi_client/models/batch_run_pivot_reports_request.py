...
class BatchRunPivotReportsRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[RunPivotReportRequest]] = Field(default=None, description="Individual requests. Each request has a separate pivot report response. Each batch request is allowed up to 5 requests.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [RunPivotReportRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
