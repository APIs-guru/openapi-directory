...
class V1betaAudienceDimensionValue(BaseModel):
    """
    The value of a dimension.
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Value as a string if the dimension type is a string.")
