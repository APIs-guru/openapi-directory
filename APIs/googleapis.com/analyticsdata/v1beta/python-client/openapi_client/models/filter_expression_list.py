...
class FilterExpressionList(BaseModel):
    ...
    """ # noqa: E501
    expressions: Optional[List[FilterExpression]] = Field(default=None, description="A list of filter expressions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "expressions": [FilterExpression.from_dict(_item) for _item in obj["expressions"]] if obj.get("expressions") is not None else None
        })
        return _obj

from openapi_client.models.filter_expression import FilterExpression
# TODO: Rewrite to not use raise_errors
FilterExpressionList.model_rebuild(raise_errors=False)
