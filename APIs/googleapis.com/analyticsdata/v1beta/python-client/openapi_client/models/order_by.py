...
class OrderBy(BaseModel):
    ...
    """ # noqa: E501
    desc: Optional[StrictBool] = Field(default=None, description="If true, sorts by descending order.")
    dimension: Optional[DimensionOrderBy] = None
    metric: Optional[MetricOrderBy] = None
    pivot: Optional[PivotOrderBy] = None
    __properties: ClassVar[List[str]] = ["desc", "dimension", "metric", "pivot"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "desc": obj.get("desc"),
            "dimension": DimensionOrderBy.from_dict(obj["dimension"]) if obj.get("dimension") is not None else None,
            "metric": MetricOrderBy.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "pivot": PivotOrderBy.from_dict(obj["pivot"]) if obj.get("pivot") is not None else None
        })
        return _obj
