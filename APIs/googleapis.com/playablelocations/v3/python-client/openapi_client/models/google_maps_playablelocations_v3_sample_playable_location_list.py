...
class GoogleMapsPlayablelocationsV3SamplePlayableLocationList(BaseModel):
    ...
    """ # noqa: E501
    locations: Optional[List[GoogleMapsPlayablelocationsV3SamplePlayableLocation]] = Field(default=None, description="A list of playable locations for this game object type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "locations": [GoogleMapsPlayablelocationsV3SamplePlayableLocation.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None
        })
        return _obj
