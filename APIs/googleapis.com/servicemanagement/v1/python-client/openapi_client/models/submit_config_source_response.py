...
class SubmitConfigSourceResponse(BaseModel):
    """
    Response message for SubmitConfigSource method.
    """ # noqa: E501
    service_config: Optional[Service] = Field(default=None, alias="serviceConfig")
    __properties: ClassVar[List[str]] = ["serviceConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceConfig": Service.from_dict(obj["serviceConfig"]) if obj.get("serviceConfig") is not None else None
        })
        return _obj
