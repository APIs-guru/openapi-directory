...
class TestSubmitConfigSourceResponse(unittest.TestCase):
    """SubmitConfigSourceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitConfigSourceResponse:
        """Test SubmitConfigSourceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitConfigSourceResponse`
        """
        model = SubmitConfigSourceResponse()
        if include_optional:
            return SubmitConfigSourceResponse(
                service_config = openapi_client.models.service.Service(
                    apis = [
    ...
    def testSubmitConfigSourceResponse(self):
        """Test SubmitConfigSourceResponse"""
