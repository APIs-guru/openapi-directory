...
google_cloud_videointelligence_v1p1beta1_word_info_instance = GoogleCloudVideointelligenceV1p1beta1WordInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1p1beta1WordInfo.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1p1beta1_word_info_dict = google_cloud_videointelligence_v1p1beta1_word_info_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1p1beta1WordInfo from a dict
google_cloud_videointelligence_v1p1beta1_word_info_from_dict = GoogleCloudVideointelligenceV1p1beta1WordInfo.from_dict(google_cloud_videointelligence_v1p1beta1_word_info_dict)
```
