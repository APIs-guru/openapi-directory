...
**video_context** | [**GoogleCloudVideointelligenceV1p3beta1VideoContext**](GoogleCloudVideointelligenceV1p3beta1VideoContext.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest from a JSON string
google_cloud_videointelligence_v1p3beta1_annotate_video_request_instance = GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1p3beta1_annotate_video_request_dict = google_cloud_videointelligence_v1p3beta1_annotate_video_request_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest from a dict
google_cloud_videointelligence_v1p3beta1_annotate_video_request_from_dict = GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.from_dict(google_cloud_videointelligence_v1p3beta1_annotate_video_request_dict)
```
