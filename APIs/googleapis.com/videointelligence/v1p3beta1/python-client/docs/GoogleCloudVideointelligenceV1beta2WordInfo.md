...
google_cloud_videointelligence_v1beta2_word_info_instance = GoogleCloudVideointelligenceV1beta2WordInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1beta2WordInfo.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1beta2_word_info_dict = google_cloud_videointelligence_v1beta2_word_info_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1beta2WordInfo from a dict
google_cloud_videointelligence_v1beta2_word_info_from_dict = GoogleCloudVideointelligenceV1beta2WordInfo.from_dict(google_cloud_videointelligence_v1beta2_word_info_dict)
```
