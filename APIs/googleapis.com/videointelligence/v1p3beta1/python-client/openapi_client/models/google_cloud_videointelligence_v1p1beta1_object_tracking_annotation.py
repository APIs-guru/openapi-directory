...
class GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation(BaseModel):
    ...
    frames: Optional[List[GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]] = Field(default=None, description="Information corresponding to all frames where this object track appears. Non-streaming batch mode: it may be one or multiple ObjectTrackingFrame messages in frames. Streaming mode: it can only be one ObjectTrackingFrame message in frames.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
