...
class GoogleCloudVideointelligenceV1p3beta1DetectedLandmark(BaseModel):
    ...
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The confidence score of the detected landmark. Range [0, 1].")
    name: Optional[StrictStr] = Field(default=None, description="The name of this landmark, for example, left_hand, right_shoulder.")
    point: Optional[GoogleCloudVideointelligenceV1p3beta1NormalizedVertex] = None
    __properties: ClassVar[List[str]] = ["confidence", "name", "point"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "point": GoogleCloudVideointelligenceV1p3beta1NormalizedVertex.from_dict(obj["point"]) if obj.get("point") is not None else None
        })
        return _obj
