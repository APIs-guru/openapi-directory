...
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest(BaseModel):
    ...
    video_context: Optional[GoogleCloudVideointelligenceV1p3beta1VideoContext] = Field(default=None, alias="videoContext")
    ...
    def features_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['FEATURE_UNSPECIFIED', 'LABEL_DETECTION', 'SHOT_CHANGE_DETECTION', 'EXPLICIT_CONTENT_DETECTION', 'FACE_DETECTION', 'SPEECH_TRANSCRIPTION', 'TEXT_DETECTION', 'OBJECT_TRACKING', 'LOGO_RECOGNITION', 'CELEBRITY_RECOGNITION', 'PERSON_DETECTION']):
                raise ValueError("each list item must be one of ('FEATURE_UNSPECIFIED', 'LABEL_DETECTION', 'SHOT_CHANGE_DETECTION', 'EXPLICIT_CONTENT_DETECTION', 'FACE_DETECTION', 'SPEECH_TRANSCRIPTION', 'TEXT_DETECTION', 'OBJECT_TRACKING', 'LOGO_RECOGNITION', 'CELEBRITY_RECOGNITION', 'PERSON_DETECTION')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "videoContext": GoogleCloudVideointelligenceV1p3beta1VideoContext.from_dict(obj["videoContext"]) if obj.get("videoContext") is not None else None
        })
        return _obj
