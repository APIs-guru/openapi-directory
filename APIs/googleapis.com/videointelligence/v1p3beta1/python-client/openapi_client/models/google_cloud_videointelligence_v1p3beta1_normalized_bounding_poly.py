...
class GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    vertices: Optional[List[GoogleCloudVideointelligenceV1p3beta1NormalizedVertex]] = Field(default=None, description="Normalized vertices of the bounding polygon.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vertices": [GoogleCloudVideointelligenceV1p3beta1NormalizedVertex.from_dict(_item) for _item in obj["vertices"]] if obj.get("vertices") is not None else None
        })
        return _obj
