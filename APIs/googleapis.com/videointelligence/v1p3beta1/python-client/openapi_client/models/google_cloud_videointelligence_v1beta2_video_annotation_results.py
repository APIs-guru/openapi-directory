...
class GoogleCloudVideointelligenceV1beta2VideoAnnotationResults(BaseModel):
    ...
    explicit_annotation: Optional[GoogleCloudVideointelligenceV1beta2ExplicitContentAnnotation] = Field(default=None, alias="explicitAnnotation")
    face_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2FaceAnnotation]] = Field(default=None, description="Deprecated. Please use `face_detection_annotations` instead.", alias="faceAnnotations")
    face_detection_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation]] = Field(default=None, description="Face detection annotations.", alias="faceDetectionAnnotations")
    frame_label_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LabelAnnotation]] = Field(default=None, description="Label annotations on frame level. There is exactly one element for each unique label.", alias="frameLabelAnnotations")
    ...
    logo_recognition_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LogoRecognitionAnnotation]] = Field(default=None, description="Annotations for list of logos detected, tracked and recognized in video.", alias="logoRecognitionAnnotations")
    object_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation]] = Field(default=None, description="Annotations for list of objects detected and tracked in video.", alias="objectAnnotations")
    person_detection_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation]] = Field(default=None, description="Person detection annotations.", alias="personDetectionAnnotations")
    segment: Optional[GoogleCloudVideointelligenceV1beta2VideoSegment] = None
    segment_label_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LabelAnnotation]] = Field(default=None, description="Topical label annotations on video level or user-specified segment level. There is exactly one element for each unique label.", alias="segmentLabelAnnotations")
    segment_presence_label_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LabelAnnotation]] = Field(default=None, description="Presence label annotations on video level or user-specified segment level. There is exactly one element for each unique label. Compared to the existing topical `segment_label_annotations`, this field presents more fine-grained, segment-level labels detected in video content and is made available only when the client sets `LabelDetectionConfig.model` to \"builtin/latest\" in the request.", alias="segmentPresenceLabelAnnotations")
    shot_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2VideoSegment]] = Field(default=None, description="Shot annotations. Each shot is represented as a video segment.", alias="shotAnnotations")
    shot_label_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LabelAnnotation]] = Field(default=None, description="Topical label annotations on shot level. There is exactly one element for each unique label.", alias="shotLabelAnnotations")
    shot_presence_label_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2LabelAnnotation]] = Field(default=None, description="Presence label annotations on shot level. There is exactly one element for each unique label. Compared to the existing topical `shot_label_annotations`, this field presents more fine-grained, shot-level labels detected in video content and is made available only when the client sets `LabelDetectionConfig.model` to \"builtin/latest\" in the request.", alias="shotPresenceLabelAnnotations")
    speech_transcriptions: Optional[List[GoogleCloudVideointelligenceV1beta2SpeechTranscription]] = Field(default=None, description="Speech transcription.", alias="speechTranscriptions")
    text_annotations: Optional[List[GoogleCloudVideointelligenceV1beta2TextAnnotation]] = Field(default=None, description="OCR text detection and tracking. Annotations for list of detected text snippets. Each will have list of frame information associated with it.", alias="textAnnotations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "explicitAnnotation": GoogleCloudVideointelligenceV1beta2ExplicitContentAnnotation.from_dict(obj["explicitAnnotation"]) if obj.get("explicitAnnotation") is not None else None,
            "faceAnnotations": [GoogleCloudVideointelligenceV1beta2FaceAnnotation.from_dict(_item) for _item in obj["faceAnnotations"]] if obj.get("faceAnnotations") is not None else None,
            "faceDetectionAnnotations": [GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation.from_dict(_item) for _item in obj["faceDetectionAnnotations"]] if obj.get("faceDetectionAnnotations") is not None else None,
            "frameLabelAnnotations": [GoogleCloudVideointelligenceV1beta2LabelAnnotation.from_dict(_item) for _item in obj["frameLabelAnnotations"]] if obj.get("frameLabelAnnotations") is not None else None,
            "inputUri": obj.get("inputUri"),
            "logoRecognitionAnnotations": [GoogleCloudVideointelligenceV1beta2LogoRecognitionAnnotation.from_dict(_item) for _item in obj["logoRecognitionAnnotations"]] if obj.get("logoRecognitionAnnotations") is not None else None,
            "objectAnnotations": [GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation.from_dict(_item) for _item in obj["objectAnnotations"]] if obj.get("objectAnnotations") is not None else None,
            "personDetectionAnnotations": [GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation.from_dict(_item) for _item in obj["personDetectionAnnotations"]] if obj.get("personDetectionAnnotations") is not None else None,
            "segment": GoogleCloudVideointelligenceV1beta2VideoSegment.from_dict(obj["segment"]) if obj.get("segment") is not None else None,
            "segmentLabelAnnotations": [GoogleCloudVideointelligenceV1beta2LabelAnnotation.from_dict(_item) for _item in obj["segmentLabelAnnotations"]] if obj.get("segmentLabelAnnotations") is not None else None,
            "segmentPresenceLabelAnnotations": [GoogleCloudVideointelligenceV1beta2LabelAnnotation.from_dict(_item) for _item in obj["segmentPresenceLabelAnnotations"]] if obj.get("segmentPresenceLabelAnnotations") is not None else None,
            "shotAnnotations": [GoogleCloudVideointelligenceV1beta2VideoSegment.from_dict(_item) for _item in obj["shotAnnotations"]] if obj.get("shotAnnotations") is not None else None,
            "shotLabelAnnotations": [GoogleCloudVideointelligenceV1beta2LabelAnnotation.from_dict(_item) for _item in obj["shotLabelAnnotations"]] if obj.get("shotLabelAnnotations") is not None else None,
            "shotPresenceLabelAnnotations": [GoogleCloudVideointelligenceV1beta2LabelAnnotation.from_dict(_item) for _item in obj["shotPresenceLabelAnnotations"]] if obj.get("shotPresenceLabelAnnotations") is not None else None,
            "speechTranscriptions": [GoogleCloudVideointelligenceV1beta2SpeechTranscription.from_dict(_item) for _item in obj["speechTranscriptions"]] if obj.get("speechTranscriptions") is not None else None,
            "textAnnotations": [GoogleCloudVideointelligenceV1beta2TextAnnotation.from_dict(_item) for _item in obj["textAnnotations"]] if obj.get("textAnnotations") is not None else None
        })
        return _obj
