...
class GoogleCloudVideointelligenceV1p2beta1LabelSegment(BaseModel):
    ...
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence that the label is accurate. Range: [0, 1].")
    segment: Optional[GoogleCloudVideointelligenceV1p2beta1VideoSegment] = None
    __properties: ClassVar[List[str]] = ["confidence", "segment"]
