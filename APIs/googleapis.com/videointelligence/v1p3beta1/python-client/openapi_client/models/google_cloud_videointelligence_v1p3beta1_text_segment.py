...
class GoogleCloudVideointelligenceV1p3beta1TextSegment(BaseModel):
    ...
    frames: Optional[List[GoogleCloudVideointelligenceV1p3beta1TextFrame]] = Field(default=None, description="Information related to the frames where OCR detected text appears.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p3beta1TextSegment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p3beta1TextSegment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudVideointelligenceV1p3beta1TextFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
