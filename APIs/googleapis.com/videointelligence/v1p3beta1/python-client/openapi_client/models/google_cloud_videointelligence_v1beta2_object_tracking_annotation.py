...
class GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
