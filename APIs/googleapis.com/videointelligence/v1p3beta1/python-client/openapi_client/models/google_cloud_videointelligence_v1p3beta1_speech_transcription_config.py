...
class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig(BaseModel):
    ...
    speech_contexts: Optional[List[GoogleCloudVideointelligenceV1p3beta1SpeechContext]] = Field(default=None, description="Optional. A means to provide context to assist the speech recognition.", alias="speechContexts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "speechContexts": [GoogleCloudVideointelligenceV1p3beta1SpeechContext.from_dict(_item) for _item in obj["speechContexts"]] if obj.get("speechContexts") is not None else None
        })
        return _obj
