...
class GoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox(BaseModel):
    ...
    """ # noqa: E501
    bottom: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bottom Y coordinate.")
    left: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Left X coordinate.")
    right: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Right X coordinate.")
    top: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Top Y coordinate.")
