...
class TestGoogleCloudVideointelligenceV1p1beta1TimestampedObject(unittest.TestCase):
    """GoogleCloudVideointelligenceV1p1beta1TimestampedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1p1beta1TimestampedObject:
        """Test GoogleCloudVideointelligenceV1p1beta1TimestampedObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1p1beta1TimestampedObject`
        """
        model = GoogleCloudVideointelligenceV1p1beta1TimestampedObject()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1p1beta1TimestampedObject(self):
        """Test GoogleCloudVideointelligenceV1p1beta1TimestampedObject"""
