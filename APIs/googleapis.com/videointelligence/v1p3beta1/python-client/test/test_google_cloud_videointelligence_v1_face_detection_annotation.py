...
class TestGoogleCloudVideointelligenceV1FaceDetectionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1FaceDetectionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1FaceDetectionAnnotation:
        """Test GoogleCloudVideointelligenceV1FaceDetectionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1FaceDetectionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1FaceDetectionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1FaceDetectionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1FaceDetectionAnnotation"""
