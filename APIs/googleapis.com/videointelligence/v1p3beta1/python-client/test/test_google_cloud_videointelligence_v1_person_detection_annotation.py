...
class TestGoogleCloudVideointelligenceV1PersonDetectionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1PersonDetectionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1PersonDetectionAnnotation:
        """Test GoogleCloudVideointelligenceV1PersonDetectionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1PersonDetectionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1PersonDetectionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1PersonDetectionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1PersonDetectionAnnotation"""
