...
class TestGoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation:
        """Test GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1beta2PersonDetectionAnnotation"""
