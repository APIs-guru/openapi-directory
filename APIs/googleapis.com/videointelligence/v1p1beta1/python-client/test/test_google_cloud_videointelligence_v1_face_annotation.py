...
class TestGoogleCloudVideointelligenceV1FaceAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1FaceAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1FaceAnnotation:
        """Test GoogleCloudVideointelligenceV1FaceAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1FaceAnnotation`
        """
        model = GoogleCloudVideointelligenceV1FaceAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1FaceAnnotation(self):
        """Test GoogleCloudVideointelligenceV1FaceAnnotation"""
