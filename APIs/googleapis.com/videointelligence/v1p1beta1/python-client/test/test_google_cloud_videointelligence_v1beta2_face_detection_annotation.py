...
class TestGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation:
        """Test GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation"""
