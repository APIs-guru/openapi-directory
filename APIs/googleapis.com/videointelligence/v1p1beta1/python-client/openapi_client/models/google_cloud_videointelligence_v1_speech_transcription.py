...
class GoogleCloudVideointelligenceV1SpeechTranscription(BaseModel):
    ...
    """ # noqa: E501
    alternatives: Optional[List[GoogleCloudVideointelligenceV1SpeechRecognitionAlternative]] = Field(default=None, description="May contain one or more recognition hypotheses (up to the maximum specified in `max_alternatives`). These alternatives are ordered in terms of accuracy, with the top (first) alternative being the most probable, as ranked by the recognizer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alternatives": [GoogleCloudVideointelligenceV1SpeechRecognitionAlternative.from_dict(_item) for _item in obj["alternatives"]] if obj.get("alternatives") is not None else None,
