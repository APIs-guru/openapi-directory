...
class GoogleCloudVideointelligenceV1beta2FaceFrame(BaseModel):
    ...
    """ # noqa: E501
    normalized_bounding_boxes: Optional[List[GoogleCloudVideointelligenceV1beta2NormalizedBoundingBox]] = Field(default=None, description="Normalized Bounding boxes in a frame. There can be more than one boxes if the same face is detected in multiple locations within the current frame.", alias="normalizedBoundingBoxes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedBoundingBoxes": [GoogleCloudVideointelligenceV1beta2NormalizedBoundingBox.from_dict(_item) for _item in obj["normalizedBoundingBoxes"]] if obj.get("normalizedBoundingBoxes") is not None else None,
