...
class GoogleCloudVideointelligenceV1beta2ExplicitContentAnnotation(BaseModel):
    ...
    """ # noqa: E501
    frames: Optional[List[GoogleCloudVideointelligenceV1beta2ExplicitContentFrame]] = Field(default=None, description="All video frames where explicit content was detected.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "frames": [GoogleCloudVideointelligenceV1beta2ExplicitContentFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
