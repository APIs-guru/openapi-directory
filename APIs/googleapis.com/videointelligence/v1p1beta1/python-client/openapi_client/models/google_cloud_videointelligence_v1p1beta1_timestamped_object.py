...
class GoogleCloudVideointelligenceV1p1beta1TimestampedObject(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[List[GoogleCloudVideointelligenceV1p1beta1DetectedAttribute]] = Field(default=None, description="Optional. The attributes of the object in the bounding box.")
    landmarks: Optional[List[GoogleCloudVideointelligenceV1p1beta1DetectedLandmark]] = Field(default=None, description="Optional. The detected landmarks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "landmarks": [GoogleCloudVideointelligenceV1p1beta1DetectedLandmark.from_dict(_item) for _item in obj["landmarks"]] if obj.get("landmarks") is not None else None,
