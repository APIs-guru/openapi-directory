...
class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest(BaseModel):
    """
    ...
    video_context: Optional[GoogleCloudVideointelligenceV1p1beta1VideoContext] = Field(default=None, alias="videoContext")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "videoContext": GoogleCloudVideointelligenceV1p1beta1VideoContext.from_dict(obj["videoContext"]) if obj.get("videoContext") is not None else None
        })
        return _obj
