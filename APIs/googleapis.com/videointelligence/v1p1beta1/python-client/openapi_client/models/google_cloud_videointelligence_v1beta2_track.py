...
class GoogleCloudVideointelligenceV1beta2Track(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[List[GoogleCloudVideointelligenceV1beta2DetectedAttribute]] = Field(default=None, description="Optional. Attributes in the track level.")
    ...
    segment: Optional[GoogleCloudVideointelligenceV1beta2VideoSegment] = None
    timestamped_objects: Optional[List[GoogleCloudVideointelligenceV1beta2TimestampedObject]] = Field(default=None, description="The object with timestamp and attributes per frame in the track.", alias="timestampedObjects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segment": GoogleCloudVideointelligenceV1beta2VideoSegment.from_dict(obj["segment"]) if obj.get("segment") is not None else None,
            "timestampedObjects": [GoogleCloudVideointelligenceV1beta2TimestampedObject.from_dict(_item) for _item in obj["timestampedObjects"]] if obj.get("timestampedObjects") is not None else None
        })
        return _obj
