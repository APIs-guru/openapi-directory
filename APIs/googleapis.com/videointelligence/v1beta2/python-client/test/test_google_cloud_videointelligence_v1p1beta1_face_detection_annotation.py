...
class TestGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation:
        """Test GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation"""
