...
class TestGoogleCloudVideointelligenceV1LogoRecognitionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1LogoRecognitionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1LogoRecognitionAnnotation:
        """Test GoogleCloudVideointelligenceV1LogoRecognitionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1LogoRecognitionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1LogoRecognitionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1LogoRecognitionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1LogoRecognitionAnnotation"""
