...
google_cloud_videointelligence_v1p1beta1_face_frame_instance = GoogleCloudVideointelligenceV1p1beta1FaceFrame.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1p1beta1FaceFrame.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1p1beta1_face_frame_dict = google_cloud_videointelligence_v1p1beta1_face_frame_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1p1beta1FaceFrame from a dict
google_cloud_videointelligence_v1p1beta1_face_frame_from_dict = GoogleCloudVideointelligenceV1p1beta1FaceFrame.from_dict(google_cloud_videointelligence_v1p1beta1_face_frame_dict)
```
