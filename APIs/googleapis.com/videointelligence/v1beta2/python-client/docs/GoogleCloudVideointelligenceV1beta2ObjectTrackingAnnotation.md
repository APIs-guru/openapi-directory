...
google_cloud_videointelligence_v1beta2_object_tracking_annotation_instance = GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1beta2_object_tracking_annotation_dict = google_cloud_videointelligence_v1beta2_object_tracking_annotation_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation from a dict
google_cloud_videointelligence_v1beta2_object_tracking_annotation_from_dict = GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation.from_dict(google_cloud_videointelligence_v1beta2_object_tracking_annotation_dict)
```
