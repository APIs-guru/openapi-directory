...
class GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation(BaseModel):
    ...
    segments: Optional[List[GoogleCloudVideointelligenceV1p3beta1VideoSegment]] = Field(default=None, description="All video segments where the recognized logo appears. There might be multiple instances of the same logo class appearing in one VideoSegment.")
    tracks: Optional[List[GoogleCloudVideointelligenceV1p3beta1Track]] = Field(default=None, description="All logo tracks where the recognized logo appears. Each track corresponds to one logo instance appearing in consecutive frames.")
