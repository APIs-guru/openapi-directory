...
class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest(BaseModel):
    """
    ...
    video_context: Optional[GoogleCloudVideointelligenceV1beta2VideoContext] = Field(default=None, alias="videoContext")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "videoContext": GoogleCloudVideointelligenceV1beta2VideoContext.from_dict(obj["videoContext"]) if obj.get("videoContext") is not None else None
        })
        return _obj
