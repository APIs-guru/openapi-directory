...
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoResponse(BaseModel):
    ...
    """ # noqa: E501
    annotation_results: Optional[List[GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults]] = Field(default=None, description="Annotation results for all videos specified in `AnnotateVideoRequest`.", alias="annotationResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationResults": [GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.from_dict(_item) for _item in obj["annotationResults"]] if obj.get("annotationResults") is not None else None
        })
        return _obj
