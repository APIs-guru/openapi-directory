...
class TestGoogleCloudVideointelligenceV1LabelAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1LabelAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1LabelAnnotation:
        """Test GoogleCloudVideointelligenceV1LabelAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1LabelAnnotation`
        """
        model = GoogleCloudVideointelligenceV1LabelAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1LabelAnnotation(self):
        """Test GoogleCloudVideointelligenceV1LabelAnnotation"""
