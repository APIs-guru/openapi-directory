...
class TestGoogleCloudVideointelligenceV1TimestampedObject(unittest.TestCase):
    """GoogleCloudVideointelligenceV1TimestampedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1TimestampedObject:
        """Test GoogleCloudVideointelligenceV1TimestampedObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1TimestampedObject`
        """
        model = GoogleCloudVideointelligenceV1TimestampedObject()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1TimestampedObject(self):
        """Test GoogleCloudVideointelligenceV1TimestampedObject"""
