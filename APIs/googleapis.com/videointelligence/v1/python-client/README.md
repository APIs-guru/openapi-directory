...
------------ | ------------- | ------------- | -------------
*OperationsApi* | [**videointelligence_operations_projects_locations_operations_cancel**](docs/OperationsApi.md#videointelligence_operations_projects_locations_operations_cancel) | **POST** /v1/operations/{name}:cancel | 
*OperationsApi* | [**videointelligence_operations_projects_locations_operations_delete**](docs/OperationsApi.md#videointelligence_operations_projects_locations_operations_delete) | **DELETE** /v1/operations/{name} | 
*OperationsApi* | [**videointelligence_operations_projects_locations_operations_get**](docs/OperationsApi.md#videointelligence_operations_projects_locations_operations_get) | **GET** /v1/operations/{name} | 
*ProjectsApi* | [**videointelligence_projects_locations_operations_cancel**](docs/ProjectsApi.md#videointelligence_projects_locations_operations_cancel) | **POST** /v1/{name}:cancel | 
*ProjectsApi* | [**videointelligence_projects_locations_operations_delete**](docs/ProjectsApi.md#videointelligence_projects_locations_operations_delete) | **DELETE** /v1/{name} | 
*ProjectsApi* | [**videointelligence_projects_locations_operations_get**](docs/ProjectsApi.md#videointelligence_projects_locations_operations_get) | **GET** /v1/{name} | 
*ProjectsApi* | [**videointelligence_projects_locations_operations_list**](docs/ProjectsApi.md#videointelligence_projects_locations_operations_list) | **GET** /v1/{name}/operations | 
*VideosApi* | [**videointelligence_videos_annotate**](docs/VideosApi.md#videointelligence_videos_annotate) | **POST** /v1/videos:annotate | 
