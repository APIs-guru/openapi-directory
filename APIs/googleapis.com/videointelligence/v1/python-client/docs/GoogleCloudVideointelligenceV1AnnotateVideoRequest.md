...
**video_context** | [**GoogleCloudVideointelligenceV1VideoContext**](GoogleCloudVideointelligenceV1VideoContext.md) |  | [optional] 
...
google_cloud_videointelligence_v1_annotate_video_request_instance = GoogleCloudVideointelligenceV1AnnotateVideoRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1AnnotateVideoRequest.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1_annotate_video_request_dict = google_cloud_videointelligence_v1_annotate_video_request_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1AnnotateVideoRequest from a dict
google_cloud_videointelligence_v1_annotate_video_request_from_dict = GoogleCloudVideointelligenceV1AnnotateVideoRequest.from_dict(google_cloud_videointelligence_v1_annotate_video_request_dict)
```
