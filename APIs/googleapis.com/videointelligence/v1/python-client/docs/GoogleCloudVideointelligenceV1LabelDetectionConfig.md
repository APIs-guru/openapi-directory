...
json = "{}"
# create an instance of GoogleCloudVideointelligenceV1LabelDetectionConfig from a JSON string
google_cloud_videointelligence_v1_label_detection_config_instance = GoogleCloudVideointelligenceV1LabelDetectionConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudVideointelligenceV1LabelDetectionConfig.to_json())

# convert the object into a dict
google_cloud_videointelligence_v1_label_detection_config_dict = google_cloud_videointelligence_v1_label_detection_config_instance.to_dict()
# create an instance of GoogleCloudVideointelligenceV1LabelDetectionConfig from a dict
google_cloud_videointelligence_v1_label_detection_config_from_dict = GoogleCloudVideointelligenceV1LabelDetectionConfig.from_dict(google_cloud_videointelligence_v1_label_detection_config_dict)
```
