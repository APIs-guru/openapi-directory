...
class GoogleCloudVideointelligenceV1p3beta1StreamingAnnotateVideoResponse(BaseModel):
    ...
    """ # noqa: E501
    annotation_results: Optional[GoogleCloudVideointelligenceV1p3beta1StreamingVideoAnnotationResults] = Field(default=None, alias="annotationResults")
    annotation_results_uri: Optional[StrictStr] = Field(default=None, description="Google Cloud Storage URI that stores annotation results of one streaming session in JSON format. It is the annotation_result_storage_directory from the request followed by '/cloud_project_number-session_id'.", alias="annotationResultsUri")
    error: Optional[GoogleRpcStatus] = None
    __properties: ClassVar[List[str]] = ["annotationResults", "annotationResultsUri", "error"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of annotation_results
        if self.annotation_results:
            _dict['annotationResults'] = self.annotation_results.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationResults": GoogleCloudVideointelligenceV1p3beta1StreamingVideoAnnotationResults.from_dict(obj["annotationResults"]) if obj.get("annotationResults") is not None else None,
            "annotationResultsUri": obj.get("annotationResultsUri"),
