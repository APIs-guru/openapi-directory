...
class GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative(BaseModel):
    ...
    words: Optional[List[GoogleCloudVideointelligenceV1p3beta1WordInfo]] = Field(default=None, description="Output only. A list of word-specific information for each recognized word. Note: When `enable_speaker_diarization` is set to true, you will see all the words from the beginning of the audio.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "words": [GoogleCloudVideointelligenceV1p3beta1WordInfo.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
