...
class GoogleCloudVideointelligenceV1p2beta1TextSegment(BaseModel):
    ...
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence for the track of detected text. It is calculated as the highest over all frames where OCR detected text appears.")
    frames: Optional[List[GoogleCloudVideointelligenceV1p2beta1TextFrame]] = Field(default=None, description="Information related to the frames where OCR detected text appears.")
    segment: Optional[GoogleCloudVideointelligenceV1p2beta1VideoSegment] = None
    __properties: ClassVar[List[str]] = ["confidence", "frames", "segment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudVideointelligenceV1p2beta1TextFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
