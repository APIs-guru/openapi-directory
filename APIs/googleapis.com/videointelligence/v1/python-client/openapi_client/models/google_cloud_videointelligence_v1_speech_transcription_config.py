...
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig(BaseModel):
    """
    ...
    speech_contexts: Optional[List[GoogleCloudVideointelligenceV1SpeechContext]] = Field(default=None, description="Optional. A means to provide context to assist the speech recognition.", alias="speechContexts")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1SpeechTranscriptionConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1SpeechTranscriptionConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "speechContexts": [GoogleCloudVideointelligenceV1SpeechContext.from_dict(_item) for _item in obj["speechContexts"]] if obj.get("speechContexts") is not None else None
        })
        return _obj
