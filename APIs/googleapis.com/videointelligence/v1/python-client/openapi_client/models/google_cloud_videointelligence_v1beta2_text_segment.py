...
class GoogleCloudVideointelligenceV1beta2TextSegment(BaseModel):
    ...
    frames: Optional[List[GoogleCloudVideointelligenceV1beta2TextFrame]] = Field(default=None, description="Information related to the frames where OCR detected text appears.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudVideointelligenceV1beta2TextFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
