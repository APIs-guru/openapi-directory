...
class GoogleCloudVideointelligenceV1beta2LogoRecognitionAnnotation(BaseModel):
    ...
    segments: Optional[List[GoogleCloudVideointelligenceV1beta2VideoSegment]] = Field(default=None, description="All video segments where the recognized logo appears. There might be multiple instances of the same logo class appearing in one VideoSegment.")
    tracks: Optional[List[GoogleCloudVideointelligenceV1beta2Track]] = Field(default=None, description="All logo tracks where the recognized logo appears. Each track corresponds to one logo instance appearing in consecutive frames.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segments": [GoogleCloudVideointelligenceV1beta2VideoSegment.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
            "tracks": [GoogleCloudVideointelligenceV1beta2Track.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
