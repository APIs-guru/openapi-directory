...
class GoogleCloudVideointelligenceV1beta2TextAnnotation(BaseModel):
    ...
    """ # noqa: E501
    segments: Optional[List[GoogleCloudVideointelligenceV1beta2TextSegment]] = Field(default=None, description="All video segments where OCR detected text appears.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segments": [GoogleCloudVideointelligenceV1beta2TextSegment.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
            "text": obj.get("text"),
