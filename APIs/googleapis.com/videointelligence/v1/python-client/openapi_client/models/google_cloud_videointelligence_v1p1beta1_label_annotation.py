...
class GoogleCloudVideointelligenceV1p1beta1LabelAnnotation(BaseModel):
    ...
    Label annotation.
    """ # noqa: E501
    category_entities: Optional[List[GoogleCloudVideointelligenceV1p1beta1Entity]] = Field(default=None, description="Common categories for the detected entity. For example, when the label is `Terrier`, the category is likely `dog`. And in some cases there might be more than one categories e.g., `Terrier` could also be a `pet`.", alias="categoryEntities")
    entity: Optional[GoogleCloudVideointelligenceV1p1beta1Entity] = None
    frames: Optional[List[GoogleCloudVideointelligenceV1p1beta1LabelFrame]] = Field(default=None, description="All video frames where a label was detected.")
    segments: Optional[List[GoogleCloudVideointelligenceV1p1beta1LabelSegment]] = Field(default=None, description="All video segments where a label was detected.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categoryEntities": [GoogleCloudVideointelligenceV1p1beta1Entity.from_dict(_item) for _item in obj["categoryEntities"]] if obj.get("categoryEntities") is not None else None,
            "entity": GoogleCloudVideointelligenceV1p1beta1Entity.from_dict(obj["entity"]) if obj.get("entity") is not None else None,
            "frames": [GoogleCloudVideointelligenceV1p1beta1LabelFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
            "segments": [GoogleCloudVideointelligenceV1p1beta1LabelSegment.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
