...
class GoogleCloudVideointelligenceV1p2beta1VideoAnnotationProgress(BaseModel):
    ...
    def feature_validate_enum(cls, value):
        ...
        if value not in set(['FEATURE_UNSPECIFIED', 'LABEL_DETECTION', 'SHOT_CHANGE_DETECTION', 'EXPLICIT_CONTENT_DETECTION', 'FACE_DETECTION', 'SPEECH_TRANSCRIPTION', 'TEXT_DETECTION', 'OBJECT_TRACKING', 'LOGO_RECOGNITION', 'PERSON_DETECTION']):
            raise ValueError("must be one of enum values ('FEATURE_UNSPECIFIED', 'LABEL_DETECTION', 'SHOT_CHANGE_DETECTION', 'EXPLICIT_CONTENT_DETECTION', 'FACE_DETECTION', 'SPEECH_TRANSCRIPTION', 'TEXT_DETECTION', 'OBJECT_TRACKING', 'LOGO_RECOGNITION', 'PERSON_DETECTION')")
        return value
