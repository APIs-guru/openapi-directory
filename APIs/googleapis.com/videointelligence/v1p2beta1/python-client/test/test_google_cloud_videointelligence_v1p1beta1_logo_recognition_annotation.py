...
class TestGoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation(unittest.TestCase):
    """GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation:
        """Test GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation`
        """
        model = GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation()
        if include_optional:
    ...
    def testGoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation(self):
        """Test GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation"""
