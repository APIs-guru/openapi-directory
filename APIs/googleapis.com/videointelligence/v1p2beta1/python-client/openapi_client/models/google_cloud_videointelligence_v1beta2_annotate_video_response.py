...
class GoogleCloudVideointelligenceV1beta2AnnotateVideoResponse(BaseModel):
    ...
    """ # noqa: E501
    annotation_results: Optional[List[GoogleCloudVideointelligenceV1beta2VideoAnnotationResults]] = Field(default=None, description="Annotation results for all videos specified in `AnnotateVideoRequest`.", alias="annotationResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationResults": [GoogleCloudVideointelligenceV1beta2VideoAnnotationResults.from_dict(_item) for _item in obj["annotationResults"]] if obj.get("annotationResults") is not None else None
        })
        return _obj
