...
class GoogleCloudVideointelligenceV1p3beta1FaceFrame(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedBoundingBoxes": [GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox.from_dict(_item) for _item in obj["normalizedBoundingBoxes"]] if obj.get("normalizedBoundingBoxes") is not None else None,
