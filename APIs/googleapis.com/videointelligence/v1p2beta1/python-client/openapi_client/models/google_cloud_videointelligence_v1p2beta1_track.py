...
class GoogleCloudVideointelligenceV1p2beta1Track(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[List[GoogleCloudVideointelligenceV1p2beta1DetectedAttribute]] = Field(default=None, description="Optional. Attributes in the track level.")
    ...
    timestamped_objects: Optional[List[GoogleCloudVideointelligenceV1p2beta1TimestampedObject]] = Field(default=None, description="The object with timestamp and attributes per frame in the track.", alias="timestampedObjects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timestampedObjects": [GoogleCloudVideointelligenceV1p2beta1TimestampedObject.from_dict(_item) for _item in obj["timestampedObjects"]] if obj.get("timestampedObjects") is not None else None
        })
        return _obj
