...
class GoogleCloudVideointelligenceV1beta2FaceAnnotation(BaseModel):
    ...
    """ # noqa: E501
    frames: Optional[List[GoogleCloudVideointelligenceV1beta2FaceFrame]] = Field(default=None, description="All video frames where a face was detected.")
    segments: Optional[List[GoogleCloudVideointelligenceV1beta2FaceSegment]] = Field(default=None, description="All video segments where a face was detected.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "frames": [GoogleCloudVideointelligenceV1beta2FaceFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
            "segments": [GoogleCloudVideointelligenceV1beta2FaceSegment.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
