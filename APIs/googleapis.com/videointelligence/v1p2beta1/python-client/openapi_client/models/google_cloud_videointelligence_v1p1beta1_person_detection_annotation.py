...
class GoogleCloudVideointelligenceV1p1beta1PersonDetectionAnnotation(BaseModel):
    ...
    """ # noqa: E501
    tracks: Optional[List[GoogleCloudVideointelligenceV1p1beta1Track]] = Field(default=None, description="The detected tracks of a person.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1PersonDetectionAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1PersonDetectionAnnotation from a dict"""
        if obj is None:
            return None
