...
class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse(BaseModel):
    ...
    """ # noqa: E501
    annotation_results: Optional[List[GoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults]] = Field(default=None, description="Annotation results for all videos specified in `AnnotateVideoRequest`.", alias="annotationResults")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "annotationResults": [GoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults.from_dict(_item) for _item in obj["annotationResults"]] if obj.get("annotationResults") is not None else None
        })
        return _obj
