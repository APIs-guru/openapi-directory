...
class TestGoogleCloudRecaptchaenterpriseV1FraudSignals(unittest.TestCase):
    """GoogleCloudRecaptchaenterpriseV1FraudSignals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudRecaptchaenterpriseV1FraudSignals:
        """Test GoogleCloudRecaptchaenterpriseV1FraudSignals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudRecaptchaenterpriseV1FraudSignals`
        """
        model = GoogleCloudRecaptchaenterpriseV1FraudSignals()
        if include_optional:
    ...
    def testGoogleCloudRecaptchaenterpriseV1FraudSignals(self):
        """Test GoogleCloudRecaptchaenterpriseV1FraudSignals"""
