...
class TestGoogleCloudRecaptchaenterpriseV1Key(unittest.TestCase):
    """GoogleCloudRecaptchaenterpriseV1Key unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudRecaptchaenterpriseV1Key:
        """Test GoogleCloudRecaptchaenterpriseV1Key
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudRecaptchaenterpriseV1Key`
        """
        model = GoogleCloudRecaptchaenterpriseV1Key()
        if include_optional:
    ...
    def testGoogleCloudRecaptchaenterpriseV1Key(self):
        """Test GoogleCloudRecaptchaenterpriseV1Key"""
