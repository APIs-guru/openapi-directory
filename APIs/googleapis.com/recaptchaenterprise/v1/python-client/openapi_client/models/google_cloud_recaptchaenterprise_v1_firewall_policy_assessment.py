...
class GoogleCloudRecaptchaenterpriseV1FirewallPolicyAssessment(BaseModel):
    ...
    firewall_policy: Optional[GoogleCloudRecaptchaenterpriseV1FirewallPolicy] = Field(default=None, alias="firewallPolicy")
    __properties: ClassVar[List[str]] = ["error", "firewallPolicy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firewallPolicy": GoogleCloudRecaptchaenterpriseV1FirewallPolicy.from_dict(obj["firewallPolicy"]) if obj.get("firewallPolicy") is not None else None
        })
        return _obj
