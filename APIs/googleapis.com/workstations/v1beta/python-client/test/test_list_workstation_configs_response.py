...
class TestListWorkstationConfigsResponse(unittest.TestCase):
    """ListWorkstationConfigsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWorkstationConfigsResponse:
        """Test ListWorkstationConfigsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWorkstationConfigsResponse`
        """
        model = ListWorkstationConfigsResponse()
        if include_optional:
    ...
    def testListWorkstationConfigsResponse(self):
        """Test ListWorkstationConfigsResponse"""
