...
class TestWorkstationConfig(unittest.TestCase):
    """WorkstationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkstationConfig:
        """Test WorkstationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkstationConfig`
        """
    ...
    def testWorkstationConfig(self):
        """Test WorkstationConfig"""
