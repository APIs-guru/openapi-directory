...
class GceConfidentialInstanceConfig(BaseModel):
    ...
    """ # noqa: E501
    enable_confidential_compute: Optional[StrictBool] = Field(default=None, description="Optional. Whether the instance has confidential compute enabled.", alias="enableConfidentialCompute")
