...
class WorkstationConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annotations", "conditions", "container", "createTime", "degraded", "deleteTime", "disableTcpConnections", "displayName", "enableAuditAgent", "encryptionKey", "etag", "host", "idleTimeout", "labels", "name", "persistentDirectories", "readinessChecks", "reconciling", "replicaZones", "runningTimeout", "uid", "updateTime"]
