...
**create_time** | **str** | Output only. Time that the operation was created. | [optional] [readonly] 
**end_time** | **str** | Output only. Time that the operation finished running. | [optional] [readonly] 
**requested_cancellation** | **bool** | Output only. Identifies whether the user has requested cancellation of the operation. | [optional] [readonly] 
