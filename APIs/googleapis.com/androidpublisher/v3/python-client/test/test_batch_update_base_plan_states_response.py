...
class TestBatchUpdateBasePlanStatesResponse(unittest.TestCase):
    """BatchUpdateBasePlanStatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateBasePlanStatesResponse:
        """Test BatchUpdateBasePlanStatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateBasePlanStatesResponse`
        """
        model = BatchUpdateBasePlanStatesResponse()
        if include_optional:
    ...
    def testBatchUpdateBasePlanStatesResponse(self):
        """Test BatchUpdateBasePlanStatesResponse"""
