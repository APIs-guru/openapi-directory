...
class TestVariantTargeting(unittest.TestCase):
    """VariantTargeting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantTargeting:
        """Test VariantTargeting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantTargeting`
        """
        model = VariantTargeting()
        if include_optional:
