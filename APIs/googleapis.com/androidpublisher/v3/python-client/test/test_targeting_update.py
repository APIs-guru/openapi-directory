...
class TestTargetingUpdate(unittest.TestCase):
    """TargetingUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetingUpdate:
        """Test TargetingUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetingUpdate`
        """
        model = TargetingUpdate()
        if include_optional:
