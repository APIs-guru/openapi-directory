...
class TestSubscriptionPurchaseLineItem(unittest.TestCase):
    """SubscriptionPurchaseLineItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPurchaseLineItem:
        """Test SubscriptionPurchaseLineItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPurchaseLineItem`
        """
        model = SubscriptionPurchaseLineItem()
        if include_optional:
    ...
    def testSubscriptionPurchaseLineItem(self):
        """Test SubscriptionPurchaseLineItem"""
