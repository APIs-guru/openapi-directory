...
class TestBatchUpdateSubscriptionOfferStatesResponse(unittest.TestCase):
    """BatchUpdateSubscriptionOfferStatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateSubscriptionOfferStatesResponse:
        """Test BatchUpdateSubscriptionOfferStatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateSubscriptionOfferStatesResponse`
        """
        model = BatchUpdateSubscriptionOfferStatesResponse()
        if include_optional:
    ...
    def testBatchUpdateSubscriptionOfferStatesResponse(self):
        """Test BatchUpdateSubscriptionOfferStatesResponse"""
