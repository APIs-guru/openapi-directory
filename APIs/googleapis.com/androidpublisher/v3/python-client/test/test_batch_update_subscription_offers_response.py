...
class TestBatchUpdateSubscriptionOffersResponse(unittest.TestCase):
    """BatchUpdateSubscriptionOffersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateSubscriptionOffersResponse:
        """Test BatchUpdateSubscriptionOffersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateSubscriptionOffersResponse`
        """
        model = BatchUpdateSubscriptionOffersResponse()
        if include_optional:
    ...
    def testBatchUpdateSubscriptionOffersResponse(self):
        """Test BatchUpdateSubscriptionOffersResponse"""
