...
class TestListAppRecoveriesResponse(unittest.TestCase):
    """ListAppRecoveriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAppRecoveriesResponse:
        """Test ListAppRecoveriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAppRecoveriesResponse`
        """
        model = ListAppRecoveriesResponse()
        if include_optional:
            return ListAppRecoveriesResponse(
                recovery_actions = [
                    openapi_client.models.app_recovery_action.AppRecoveryAction(
                        app_recovery_id = '', 
                        cancel_time = '', 
                        create_time = '', 
                        deploy_time = '', 
    ...
    def testListAppRecoveriesResponse(self):
        """Test ListAppRecoveriesResponse"""
