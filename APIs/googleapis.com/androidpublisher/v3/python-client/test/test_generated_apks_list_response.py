...
class TestGeneratedApksListResponse(unittest.TestCase):
    """GeneratedApksListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratedApksListResponse:
        """Test GeneratedApksListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratedApksListResponse`
        """
        model = GeneratedApksListResponse()
        if include_optional:
            return GeneratedApksListResponse(
                generated_apks = [
                    openapi_client.models.generated_apks_per_signing_key.GeneratedApksPerSigningKey(
    ...
    def testGeneratedApksListResponse(self):
        """Test GeneratedApksListResponse"""
