...
class TestBatchUpdateSubscriptionsRequest(unittest.TestCase):
    """BatchUpdateSubscriptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateSubscriptionsRequest:
        """Test BatchUpdateSubscriptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateSubscriptionsRequest`
        """
        model = BatchUpdateSubscriptionsRequest()
        if include_optional:
            return BatchUpdateSubscriptionsRequest(
                requests = [
                    openapi_client.models.update_subscription_request.UpdateSubscriptionRequest(
                        allow_missing = True, 
    ...
    def testBatchUpdateSubscriptionsRequest(self):
        """Test BatchUpdateSubscriptionsRequest"""
