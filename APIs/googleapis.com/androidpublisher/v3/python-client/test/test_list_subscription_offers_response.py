...
class TestListSubscriptionOffersResponse(unittest.TestCase):
    """ListSubscriptionOffersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListSubscriptionOffersResponse:
        """Test ListSubscriptionOffersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSubscriptionOffersResponse`
        """
        model = ListSubscriptionOffersResponse()
        if include_optional:
    ...
    def testListSubscriptionOffersResponse(self):
        """Test ListSubscriptionOffersResponse"""
