...
class TestBatchUpdateSubscriptionsResponse(unittest.TestCase):
    """BatchUpdateSubscriptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateSubscriptionsResponse:
        """Test BatchUpdateSubscriptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateSubscriptionsResponse`
        """
        model = BatchUpdateSubscriptionsResponse()
        if include_optional:
    ...
    def testBatchUpdateSubscriptionsResponse(self):
        """Test BatchUpdateSubscriptionsResponse"""
