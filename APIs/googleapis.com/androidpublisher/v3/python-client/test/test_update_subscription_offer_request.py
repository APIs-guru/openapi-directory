...
class TestUpdateSubscriptionOfferRequest(unittest.TestCase):
    """UpdateSubscriptionOfferRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSubscriptionOfferRequest:
        """Test UpdateSubscriptionOfferRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSubscriptionOfferRequest`
        """
        model = UpdateSubscriptionOfferRequest()
        if include_optional:
    ...
    def testUpdateSubscriptionOfferRequest(self):
        """Test UpdateSubscriptionOfferRequest"""
