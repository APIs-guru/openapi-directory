...
class ActivateBasePlanRequest(BaseModel):
    ...
    """ # noqa: E501
    base_plan_id: Optional[StrictStr] = Field(default=None, description="Required. The unique base plan ID of the base plan to activate.", alias="basePlanId")
    ...
    package_name: Optional[StrictStr] = Field(default=None, description="Required. The parent app (package name) of the base plan to activate.", alias="packageName")
    product_id: Optional[StrictStr] = Field(default=None, description="Required. The parent subscription (ID) of the base plan to activate.", alias="productId")
