...
class ListingsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this response (\"androidpublisher#listingsListResponse\").")
    listings: Optional[List[Listing]] = Field(default=None, description="All localized listings.")
