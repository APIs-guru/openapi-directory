...
class InappproductsListResponse(BaseModel):
    ...
    """ # noqa: E501
    inappproduct: Optional[List[InAppProduct]] = Field(default=None, description="All in-app products.")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this response (\"androidpublisher#inappproductsListResponse\").")
