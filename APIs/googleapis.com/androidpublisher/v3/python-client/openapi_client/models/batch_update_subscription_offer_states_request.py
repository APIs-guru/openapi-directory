...
class BatchUpdateSubscriptionOfferStatesRequest(BaseModel):
    """
    Request message for BatchUpdateSubscriptionOfferStates.
    """ # noqa: E501
    requests: Optional[List[UpdateSubscriptionOfferStateRequest]] = Field(default=None, description="Required. The update request list of up to 100 elements. All requests must update different offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateSubscriptionOfferStateRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
