...
class Timestamp(BaseModel):
    ...
    """ # noqa: E501
    nanos: Optional[StrictInt] = Field(default=None, description="Non-negative fractions of a second at nanosecond resolution. Must be from 0 to 999,999,999 inclusive.")
    seconds: Optional[StrictStr] = Field(default=None, description="Represents seconds of UTC time since Unix epoch.")
