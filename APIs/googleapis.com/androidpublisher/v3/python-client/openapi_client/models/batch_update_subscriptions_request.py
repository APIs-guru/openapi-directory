...
class BatchUpdateSubscriptionsRequest(BaseModel):
    """
    Request message for BatchUpdateSubscription.
    """ # noqa: E501
    requests: Optional[List[UpdateSubscriptionRequest]] = Field(default=None, description="Required. A list of update requests of up to 100 elements. All requests must update different subscriptions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateSubscriptionRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
