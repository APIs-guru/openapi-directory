...
class ApkSet(BaseModel):
    """
    A set of apks representing a module.
    """ # noqa: E501
    apk_description: Optional[List[ApkDescription]] = Field(default=None, description="Description of the generated apks.", alias="apkDescription")
    module_metadata: Optional[ModuleMetadata] = Field(default=None, alias="moduleMetadata")
    __properties: ClassVar[List[str]] = ["apkDescription", "moduleMetadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of module_metadata
        if self.module_metadata:
            _dict['moduleMetadata'] = self.module_metadata.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "moduleMetadata": ModuleMetadata.from_dict(obj["moduleMetadata"]) if obj.get("moduleMetadata") is not None else None
        })
        return _obj
