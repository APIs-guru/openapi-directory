...
class BatchUpdateBasePlanStatesRequest(BaseModel):
    """
    Request message for BatchUpdateBasePlanStates.
    """ # noqa: E501
    requests: Optional[List[UpdateBasePlanStateRequest]] = Field(default=None, description="Required. The update request list of up to 100 elements. All requests must update different base plans.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateBasePlanStateRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
