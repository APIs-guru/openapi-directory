...
class SafetyLabelsUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "safetyLabels": obj.get("safetyLabels")
        })
        return _obj
