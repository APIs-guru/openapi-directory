...
class SdkVersionTargeting(BaseModel):
    """
    Targeting based on sdk version.
    """ # noqa: E501
    alternatives: Optional[List[SdkVersion]] = Field(default=None, description="Targeting of other sibling directories that were in the Bundle. For main splits this is targeting of other main splits.")
    value: Optional[List[SdkVersion]] = Field(default=None, description="Value of an sdk version.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alternatives": [SdkVersion.from_dict(_item) for _item in obj["alternatives"]] if obj.get("alternatives") is not None else None,
            "value": [SdkVersion.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
