...
class BatchGetSubscriptionsResponse(BaseModel):
    """
    Response message for BatchGetSubscriptions endpoint.
    """ # noqa: E501
    subscriptions: Optional[List[Subscription]] = Field(default=None, description="The list of requested subscriptions, in the same order as the request.")
