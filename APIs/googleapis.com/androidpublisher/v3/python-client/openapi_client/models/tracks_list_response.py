...
class TracksListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this response (\"androidpublisher#tracksListResponse\").")
    tracks: Optional[List[Track]] = Field(default=None, description="All tracks (including tracks with no releases).")
    __properties: ClassVar[List[str]] = ["kind", "tracks"]
