...
class RegionalBasePlanConfig(BaseModel):
    ...
    """ # noqa: E501
    new_subscriber_availability: Optional[StrictBool] = Field(default=None, description="Whether the base plan in the specified region is available for new subscribers. Existing subscribers will not have their subscription canceled if this value is set to false. If not specified, this will default to false.", alias="newSubscriberAvailability")
    ...
    __properties: ClassVar[List[str]] = ["newSubscriberAvailability", "price", "regionCode"]
