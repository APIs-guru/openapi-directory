...
class ImagesDeleteAllResponse(BaseModel):
    ...
    """ # noqa: E501
    deleted: Optional[List[Image]] = Field(default=None, description="The deleted images.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deleted": [Image.from_dict(_item) for _item in obj["deleted"]] if obj.get("deleted") is not None else None
        })
        return _obj
