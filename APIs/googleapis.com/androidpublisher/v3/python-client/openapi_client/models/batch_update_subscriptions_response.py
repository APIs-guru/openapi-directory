...
class BatchUpdateSubscriptionsResponse(BaseModel):
    """
    Response message for BatchUpdateSubscription.
    """ # noqa: E501
    subscriptions: Optional[List[Subscription]] = Field(default=None, description="The updated subscriptions list.")
