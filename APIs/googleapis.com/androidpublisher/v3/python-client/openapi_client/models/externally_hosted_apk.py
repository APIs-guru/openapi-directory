...
class ExternallyHostedApk(BaseModel):
    ...
    certificate_base64s: Optional[List[StrictStr]] = Field(default=None, description="A certificate (or array of certificates if a certificate-chain is used) used to sign this APK, represented as a base64 encoded byte array.", alias="certificateBase64s")
    ...
    uses_permissions: Optional[List[UsesPermission]] = Field(default=None, description="The permissions requested by this APK.", alias="usesPermissions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usesPermissions": [UsesPermission.from_dict(_item) for _item in obj["usesPermissions"]] if obj.get("usesPermissions") is not None else None,
