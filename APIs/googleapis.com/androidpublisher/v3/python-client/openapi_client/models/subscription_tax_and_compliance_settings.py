...
class SubscriptionTaxAndComplianceSettings(BaseModel):
    ...
    is_tokenized_digital_asset: Optional[StrictBool] = Field(default=None, description="Whether this subscription is declared as a product representing a tokenized digital asset.", alias="isTokenizedDigitalAsset")
