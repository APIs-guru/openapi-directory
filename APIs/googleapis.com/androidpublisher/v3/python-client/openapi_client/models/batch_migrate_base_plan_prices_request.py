...
class BatchMigrateBasePlanPricesRequest(BaseModel):
    """
    Request message for BatchMigrateBasePlanPrices.
    """ # noqa: E501
    requests: Optional[List[MigrateBasePlanPricesRequest]] = Field(default=None, description="Required. Up to 100 price migration requests. All requests must update different base plans.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [MigrateBasePlanPricesRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
