...
class AppVersionList(BaseModel):
    ...
    """ # noqa: E501
    version_codes: Optional[List[StrictStr]] = Field(default=None, description="List of app version codes.", alias="versionCodes")
    __properties: ClassVar[List[str]] = ["versionCodes"]
