...
class BatchUpdateSubscriptionOffersRequest(BaseModel):
    """
    Request message for BatchUpdateSubscriptionOffers.
    """ # noqa: E501
    requests: Optional[List[UpdateSubscriptionOfferRequest]] = Field(default=None, description="Required. A list of update requests of up to 100 elements. All requests must update different subscription offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateSubscriptionOfferRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
