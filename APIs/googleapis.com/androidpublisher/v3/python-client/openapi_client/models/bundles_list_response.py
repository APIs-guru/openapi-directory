...
class BundlesListResponse(BaseModel):
    ...
    """ # noqa: E501
    bundles: Optional[List[Bundle]] = Field(default=None, description="All app bundles.")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this response (\"androidpublisher#bundlesListResponse\").")
