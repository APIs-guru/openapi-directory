...
class ConvertedRegionPrice(BaseModel):
    ...
    region_code: Optional[StrictStr] = Field(default=None, description="The region code of the region.", alias="regionCode")
    tax_amount: Optional[Money] = Field(default=None, alias="taxAmount")
    __properties: ClassVar[List[str]] = ["price", "regionCode", "taxAmount"]
