...
class DeactivateSubscriptionOfferRequest(BaseModel):
    ...
    """ # noqa: E501
    base_plan_id: Optional[StrictStr] = Field(default=None, description="Required. The parent base plan (ID) of the offer to deactivate.", alias="basePlanId")
    ...
    offer_id: Optional[StrictStr] = Field(default=None, description="Required. The unique offer ID of the offer to deactivate.", alias="offerId")
    package_name: Optional[StrictStr] = Field(default=None, description="Required. The parent app (package name) of the offer to deactivate.", alias="packageName")
    product_id: Optional[StrictStr] = Field(default=None, description="Required. The parent subscription (ID) of the offer to deactivate.", alias="productId")
    __properties: ClassVar[List[str]] = ["basePlanId", "latencyTolerance", "offerId", "packageName", "productId"]
