...
class BatchMigrateBasePlanPricesResponse(BaseModel):
    """
    Response message for BatchMigrateBasePlanPrices.
    """ # noqa: E501
    responses: Optional[List[Dict[str, Any]]] = Field(default=None, description="Contains one response per requested price migration, in the same order as the request.")
