...
class InappproductsBatchUpdateRequest(BaseModel):
    """
    Request to update or insert one or more in-app products.
    """ # noqa: E501
    requests: Optional[List[InappproductsUpdateRequest]] = Field(default=None, description="Required. Individual update requests. At least one request is required. Can contain up to 100 requests. All requests must correspond to different in-app products.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [InappproductsUpdateRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
