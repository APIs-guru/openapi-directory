...
class OrdersApi:
    ...
    def androidpublisher_orders_refund(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription or in-app item was purchased (for example, 'com.some.thing').")],
        order_id: Annotated[StrictStr, Field(description="The order ID provided to the user when the subscription or in-app order was purchased.")],
        ...
        revoke: Annotated[Optional[StrictBool], Field(description="Whether to revoke the purchased item. If set to true, access to the subscription or in-app item will be terminated immediately. If the item is a recurring subscription, all future payments will also be terminated. Consumed in-app items need to be handled by developer's app. (optional).")] = None,
        ...
        :param package_name: The package name of the application for which this subscription or in-app item was purchased (for example, 'com.some.thing'). (required)
        :type package_name: str
        :param order_id: The order ID provided to the user when the subscription or in-app order was purchased. (required)
        :type order_id: str
        ...
        _param = self._androidpublisher_orders_refund_serialize(
    ...
    @validate_call
    def androidpublisher_orders_refund_with_http_info(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription or in-app item was purchased (for example, 'com.some.thing').")],
        order_id: Annotated[StrictStr, Field(description="The order ID provided to the user when the subscription or in-app order was purchased.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def androidpublisher_orders_refund_without_preload_content(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription or in-app item was purchased (for example, 'com.some.thing').")],
        order_id: Annotated[StrictStr, Field(description="The order ID provided to the user when the subscription or in-app order was purchased.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _androidpublisher_orders_refund_serialize(
        self,
        package_name,
        order_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/androidpublisher/v3/applications/{packageName}/orders/{orderId}:refund',
