...
class GrantsApi:
    ...
    def androidpublisher_grants_create(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The user which needs permission. Format: developers/{developer}/users/{user}")],
        ...
        :param parent: Required. The user which needs permission. Format: developers/{developer}/users/{user} (required)
        :type parent: str
        ...
        _param = self._androidpublisher_grants_create_serialize(
            parent=parent,
            xgafv=xgafv,
    ...
    @validate_call
    def androidpublisher_grants_create_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The user which needs permission. Format: developers/{developer}/users/{user}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def androidpublisher_grants_create_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The user which needs permission. Format: developers/{developer}/users/{user}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _androidpublisher_grants_create_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/androidpublisher/v3/{parent}/grants',
