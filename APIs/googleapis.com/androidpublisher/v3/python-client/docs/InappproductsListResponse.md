...
------------ | ------------- | ------------- | -------------
**inappproduct** | [**List[InAppProduct]**](InAppProduct.md) | All in-app products. | [optional] 
**kind** | **str** | The kind of this response (\&quot;androidpublisher#inappproductsListResponse\&quot;). | [optional] 
