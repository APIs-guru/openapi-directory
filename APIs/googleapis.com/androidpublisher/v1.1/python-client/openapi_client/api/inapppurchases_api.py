...
class InapppurchasesApi:
    ...
    @validate_call
    def androidpublisher_inapppurchases_get(
        self,
        ...
        _param = self._androidpublisher_inapppurchases_get_serialize(
    ...
    @validate_call
    def androidpublisher_inapppurchases_get_with_http_info(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application the inapp product was sold in (for example, 'com.some.thing').")],
        product_id: Annotated[StrictStr, Field(description="The inapp product SKU (for example, 'com.some.thing.inapp1').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the inapp product was purchased.")],
    ...
    @validate_call
    def androidpublisher_inapppurchases_get_without_preload_content(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application the inapp product was sold in (for example, 'com.some.thing').")],
        product_id: Annotated[StrictStr, Field(description="The inapp product SKU (for example, 'com.some.thing.inapp1').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the inapp product was purchased.")],
    ...
    def _androidpublisher_inapppurchases_get_serialize(
        self,
        package_name,
        product_id,
        token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{packageName}/inapp/{productId}/purchases/{token}',
