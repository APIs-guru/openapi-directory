...
class PurchasesApi:
    ...
    @validate_call
    def androidpublisher_purchases_cancel(
        self,
        ...
        _param = self._androidpublisher_purchases_cancel_serialize(
    ...
    @validate_call
    def androidpublisher_purchases_cancel_with_http_info(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription was purchased (for example, 'com.some.thing').")],
        subscription_id: Annotated[StrictStr, Field(description="The purchased subscription ID (for example, 'monthly001').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the subscription was purchased.")],
    ...
    @validate_call
    def androidpublisher_purchases_cancel_without_preload_content(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription was purchased (for example, 'com.some.thing').")],
        subscription_id: Annotated[StrictStr, Field(description="The purchased subscription ID (for example, 'monthly001').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the subscription was purchased.")],
    ...
    def _androidpublisher_purchases_cancel_serialize(
        self,
        package_name,
        subscription_id,
        token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{packageName}/subscriptions/{subscriptionId}/purchases/{token}/cancel',
    ...
    @validate_call
    def androidpublisher_purchases_get(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription was purchased (for example, 'com.some.thing').")],
        subscription_id: Annotated[StrictStr, Field(description="The purchased subscription ID (for example, 'monthly001').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the subscription was purchased.")],
        ...
        _param = self._androidpublisher_purchases_get_serialize(
            package_name=package_name,
            subscription_id=subscription_id,
            token=token,
            alt=alt,
    ...
    @validate_call
    def androidpublisher_purchases_get_with_http_info(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription was purchased (for example, 'com.some.thing').")],
        subscription_id: Annotated[StrictStr, Field(description="The purchased subscription ID (for example, 'monthly001').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the subscription was purchased.")],
    ...
    @validate_call
    def androidpublisher_purchases_get_without_preload_content(
        self,
        package_name: Annotated[StrictStr, Field(description="The package name of the application for which this subscription was purchased (for example, 'com.some.thing').")],
        subscription_id: Annotated[StrictStr, Field(description="The purchased subscription ID (for example, 'monthly001').")],
        token: Annotated[StrictStr, Field(description="The token provided to the user's device when the subscription was purchased.")],
    ...
    def _androidpublisher_purchases_get_serialize(
        self,
        package_name,
        subscription_id,
        token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{packageName}/subscriptions/{subscriptionId}/purchases/{token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
