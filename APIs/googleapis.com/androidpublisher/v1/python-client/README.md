...
# Defining the host is optional and defaults to https://www.googleapis.com/androidpublisher/v1/applications
# See configuration.py for a list of all supported configuration parameters.
configuration = openapi_client.Configuration(
    host = "https://www.googleapis.com/androidpublisher/v1/applications"
)
