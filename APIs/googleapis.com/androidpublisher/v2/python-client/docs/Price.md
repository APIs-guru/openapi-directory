...
------------ | ------------- | ------------- | -------------
**currency** | **str** | 3 letter Currency code, as defined by ISO 4217. | [optional] 
**price_micros** | **str** | The price in millionths of the currency base unit represented as a string. | [optional] 
