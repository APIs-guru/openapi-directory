...
class UserComment(BaseModel):
    ...
    original_text: Optional[StrictStr] = Field(default=None, description="Untranslated text of the review, in the case where the review has been translated. If the review has not been translated this is left blank.", alias="originalText")
