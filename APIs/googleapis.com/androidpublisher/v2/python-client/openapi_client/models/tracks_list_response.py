...
class TracksListResponse(BaseModel):
    ...
    TracksListResponse
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default='androidpublisher#tracksListResponse', description="Identifies what kind of resource this is. Value: the fixed string \"androidpublisher#tracksListResponse\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'androidpublisher#tracksListResponse',
