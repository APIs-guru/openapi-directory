...
class BundlesListResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='androidpublisher#bundlesListResponse', description="Identifies what kind of resource this is. Value: the fixed string \"androidpublisher#bundlesListResponse\".")
    __properties: ClassVar[List[str]] = ["bundles", "kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'androidpublisher#bundlesListResponse'
        })
        return _obj
