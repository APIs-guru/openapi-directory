...
------------ | ------------- | ------------- | -------------
**authorized_network** | **str** | The full name of the Google Compute Engine [network](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. If left unspecified, the &#x60;default&#x60; network will be used. | [optional] 
...
**maintenance_policy** | [**GoogleCloudMemcacheV1MaintenancePolicy**](GoogleCloudMemcacheV1MaintenancePolicy.md) |  | [optional] 
