...
class WeeklyMaintenanceWindow(BaseModel):
    ...
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Required. Allows to define schedule that runs specified day of the week.")
    duration: Optional[StrictStr] = Field(default=None, description="Required. Duration of the time window.")
