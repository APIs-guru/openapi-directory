...
class Instance(BaseModel):
    ...
    """ # noqa: E501
    authorized_network: Optional[StrictStr] = Field(default=None, description="The full name of the Google Compute Engine [network](https://cloud.google.com/vpc/docs/vpc) to which the instance is connected. If left unspecified, the `default` network will be used.", alias="authorizedNetwork")
    ...
    maintenance_policy: Optional[GoogleCloudMemcacheV1beta2MaintenancePolicy] = Field(default=None, alias="maintenancePolicy")
    ...
    update_available: Optional[StrictBool] = Field(default=None, description="Output only. Returns true if there is an update waiting to be applied", alias="updateAvailable")
    ...
    __properties: ClassVar[List[str]] = ["authorizedNetwork", "createTime", "discoveryEndpoint", "displayName", "instanceMessages", "labels", "maintenancePolicy", "maintenanceSchedule", "memcacheFullVersion", "memcacheNodes", "memcacheVersion", "name", "nodeConfig", "nodeCount", "parameters", "reservedIpRangeId", "state", "updateAvailable", "updateTime", "zones"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maintenancePolicy": GoogleCloudMemcacheV1beta2MaintenancePolicy.from_dict(obj["maintenancePolicy"]) if obj.get("maintenancePolicy") is not None else None,
