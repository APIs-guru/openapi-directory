...
class UpdateParametersRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. Mask of fields to update.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["parameters", "updateMask"]
