...
class GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse(BaseModel):
    ...
    """ # noqa: E501
    instances: Optional[List[GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance]] = Field(default=None, description="The list of instances in a given project.")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Unreachable regions.")
    __properties: ClassVar[List[str]] = ["instances", "unreachable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
