...
class GoogleDevtoolsRemotebuildexecutionAdminV1alphaSchedulerNotificationConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    topic: Optional[StrictStr] = Field(default=None, description="The Pub/Sub topic resource name to issue notifications to. Note that the topic does not need to be owned by the same project as this instance. Format: `projects//topics/`.")
