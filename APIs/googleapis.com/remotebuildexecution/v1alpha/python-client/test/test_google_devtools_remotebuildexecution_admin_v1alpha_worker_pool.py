...
class TestGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool(unittest.TestCase):
    """GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool:
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool`
        """
        model = GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool()
        if include_optional:
    ...
    def testGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool(self):
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool"""
