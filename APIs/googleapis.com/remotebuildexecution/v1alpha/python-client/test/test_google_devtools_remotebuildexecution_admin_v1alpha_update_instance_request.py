...
class TestGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest(unittest.TestCase):
    """GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest:
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest`
        """
        model = GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest()
        if include_optional:
            return GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest(
    ...
    def testGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest(self):
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest"""
