...
class TestGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse(unittest.TestCase):
    """GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse:
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse`
        """
        model = GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse()
        if include_optional:
            return GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse(
                worker_pools = [
                    openapi_client.models.google_devtools_remotebuildexecution_admin_v1alpha_worker_pool.GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool(
    ...
    def testGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse(self):
        """Test GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse"""
