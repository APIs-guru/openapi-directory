...
class TestInstanceSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InstanceSpec:
        """Test InstanceSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceSpec`
        """
        model = InstanceSpec()
        if include_optional:
            return InstanceSpec(
