...
class TestInstanceTemplateSpec(unittest.TestCase):
    """InstanceTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceTemplateSpec:
        """Test InstanceTemplateSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceTemplateSpec`
        """
        model = InstanceTemplateSpec()
        if include_optional:
    ...
    def testInstanceTemplateSpec(self):
        """Test InstanceTemplateSpec"""
