...
------------ | ------------- | ------------- | -------------
*NamespacesApi* | [**run_namespaces_jobs_create**](docs/NamespacesApi.md#run_namespaces_jobs_create) | **POST** /apis/run.googleapis.com/v1alpha1/{parent}/jobs | 
*NamespacesApi* | [**run_namespaces_jobs_delete**](docs/NamespacesApi.md#run_namespaces_jobs_delete) | **DELETE** /apis/run.googleapis.com/v1alpha1/{name} | 
*NamespacesApi* | [**run_namespaces_jobs_get**](docs/NamespacesApi.md#run_namespaces_jobs_get) | **GET** /apis/run.googleapis.com/v1alpha1/{name} | 
*NamespacesApi* | [**run_namespaces_jobs_list**](docs/NamespacesApi.md#run_namespaces_jobs_list) | **GET** /apis/run.googleapis.com/v1alpha1/{parent}/jobs | 
