...
**prefix** | **str** | (Optional) An optional identifier to prepend to each key in the ConfigMap. Must be a C_IDENTIFIER. | [optional] 
...
env_from_source_from_dict = EnvFromSource.from_dict(env_from_source_dict)
```
