...
**name** | **str** | The name of the volume. There must be a corresponding Volume with the same name. | [optional] 
**read_only** | **bool** | (Optional) Only true is accepted. Defaults to true. | [optional] 
**sub_path** | **str** | (Optional) Path within the volume from which the container&#39;s volume should be mounted. Defaults to \&quot;\&quot; (volume&#39;s root). | [optional] 
