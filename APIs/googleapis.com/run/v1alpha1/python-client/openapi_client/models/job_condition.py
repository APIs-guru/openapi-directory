...
class JobCondition(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(default=None, description="Optional. One-word CamelCase reason for the condition's last transition.")
    severity: Optional[StrictStr] = Field(default=None, description="Optional. How to interpret failures of this condition, one of Error, Warning, Info")
    status: Optional[StrictStr] = Field(default=None, description="Required. Status of the condition, one of True, False, Unknown.")
