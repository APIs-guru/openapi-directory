...
class EnvFromSource(BaseModel):
    ...
    prefix: Optional[StrictStr] = Field(default=None, description="(Optional) An optional identifier to prepend to each key in the ConfigMap. Must be a C_IDENTIFIER.")
