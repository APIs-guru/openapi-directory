...
class SecretEnvSource(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The Secret to select from.")
    optional: Optional[StrictBool] = Field(default=None, description="(Optional) Specify whether the Secret must be defined")
