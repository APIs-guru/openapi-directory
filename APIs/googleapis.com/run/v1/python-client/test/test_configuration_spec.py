...
class TestConfigurationSpec(unittest.TestCase):
    """ConfigurationSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationSpec:
        """Test ConfigurationSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationSpec`
        """
    ...
    def testConfigurationSpec(self):
        """Test ConfigurationSpec"""
