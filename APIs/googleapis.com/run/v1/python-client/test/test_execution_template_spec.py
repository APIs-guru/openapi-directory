...
class TestExecutionTemplateSpec(unittest.TestCase):
    """ExecutionTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecutionTemplateSpec:
        """Test ExecutionTemplateSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecutionTemplateSpec`
        """
        model = ExecutionTemplateSpec()
        if include_optional:
    ...
    def testExecutionTemplateSpec(self):
        """Test ExecutionTemplateSpec"""
