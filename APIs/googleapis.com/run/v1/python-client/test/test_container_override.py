...
class TestContainerOverride(unittest.TestCase):
    """ContainerOverride unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContainerOverride:
        """Test ContainerOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerOverride`
        """
        model = ContainerOverride()
        if include_optional:
    ...
    def testContainerOverride(self):
        """Test ContainerOverride"""
