...
class TestRevisionSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RevisionSpec:
        """Test RevisionSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionSpec`
        """
        model = RevisionSpec()
        if include_optional:
            return RevisionSpec(
