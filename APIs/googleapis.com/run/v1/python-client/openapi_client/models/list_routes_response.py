...
class ListRoutesResponse(BaseModel):
    ...
    items: Optional[List[Route]] = Field(default=None, description="List of Routes.")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this resource, in this case always \"RouteList\".")
