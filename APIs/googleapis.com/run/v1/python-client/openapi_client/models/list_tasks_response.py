...
class ListTasksResponse(BaseModel):
    ...
    items: Optional[List[Task]] = Field(default=None, description="List of Tasks.")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this resource, in this case \"TasksList\".")
