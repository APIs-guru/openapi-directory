...
class Service(BaseModel):
    ...
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, description="The API version for this call. It must be \"serving.knative.dev/v1\".", alias="apiVersion")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of resource. It must be \"Service\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": ServiceStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
