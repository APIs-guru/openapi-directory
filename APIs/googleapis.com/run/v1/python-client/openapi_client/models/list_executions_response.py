...
class ListExecutionsResponse(BaseModel):
    ...
    items: Optional[List[Execution]] = Field(default=None, description="List of Executions.")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this resource, in this case \"ExecutionsList\".")
