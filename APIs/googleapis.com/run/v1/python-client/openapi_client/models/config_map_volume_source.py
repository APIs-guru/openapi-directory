...
class ConfigMapVolumeSource(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the config.")
    optional: Optional[StrictBool] = Field(default=None, description="(Optional) Specify whether the Secret or its keys must be defined.")
