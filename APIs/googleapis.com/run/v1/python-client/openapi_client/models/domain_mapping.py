...
class DomainMapping(BaseModel):
    ...
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, description="The API version for this call such as \"domains.cloudrun.com/v1\".", alias="apiVersion")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of resource, in this case \"DomainMapping\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": DomainMappingSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": DomainMappingStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
