...
class AuthorizedDomain(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Relative name of the domain authorized for use. Example: `example.com`.")
    name: Optional[StrictStr] = Field(default=None, description="Deprecated Read only. Full path to the `AuthorizedDomain` resource in the API. Example: `projects/myproject/authorizedDomains/example.com`.")
