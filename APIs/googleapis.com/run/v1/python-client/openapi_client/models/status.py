...
class Status(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the operation. One of: \"Success\" or \"Failure\".")
    __properties: ClassVar[List[str]] = ["code", "details", "message", "metadata", "reason", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": StatusDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
