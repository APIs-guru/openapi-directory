...
class Revision(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this resource, in this case \"Revision\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": RevisionSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": RevisionStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
