...
class Route(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="The kind of this resource, in this case always \"Route\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": RouteSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": RouteStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
