...
class GoogleCloudRunV2HTTPHeader(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Required. The header field name")
    value: Optional[StrictStr] = Field(default=None, description="The header field value")
