...
class GoogleCloudRunV2TrafficTargetStatus(BaseModel):
    ...
    """ # noqa: E501
    percent: Optional[StrictInt] = Field(default=None, description="Specifies percent of the traffic to this Revision.")
    revision: Optional[StrictStr] = Field(default=None, description="Revision to which this traffic is sent.")
    tag: Optional[StrictStr] = Field(default=None, description="Indicates the string used in the URI to exclusively reference this target.")
    type: Optional[StrictStr] = Field(default=None, description="The allocation type for this traffic target.")
    uri: Optional[StrictStr] = Field(default=None, description="Displays the target URI.")
    __properties: ClassVar[List[str]] = ["percent", "revision", "tag", "type", "uri"]
