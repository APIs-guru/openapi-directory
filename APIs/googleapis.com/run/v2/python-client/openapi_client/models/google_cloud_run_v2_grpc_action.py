...
class GoogleCloudRunV2GRPCAction(BaseModel):
    ...
    """ # noqa: E501
    port: Optional[StrictInt] = Field(default=None, description="Port number of the gRPC service. Number must be in the range 1 to 65535. If not specified, defaults to the exposed port of the container, which is the value of container.ports[0].containerPort.")
