...
class GoogleCloudRunV2EnvVarSource(BaseModel):
    ...
    """ # noqa: E501
    secret_key_ref: Optional[GoogleCloudRunV2SecretKeySelector] = Field(default=None, alias="secretKeyRef")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secretKeyRef": GoogleCloudRunV2SecretKeySelector.from_dict(obj["secretKeyRef"]) if obj.get("secretKeyRef") is not None else None
        })
        return _obj
