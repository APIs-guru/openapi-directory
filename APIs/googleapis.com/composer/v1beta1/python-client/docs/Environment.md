...
**update_time** | **str** | Output only. The time at which this environment was last modified. | [optional] [readonly] 
**uuid** | **str** | Output only. The UUID (Universally Unique IDentifier) associated with this environment. This value is generated when the environment is created. | [optional] [readonly] 
