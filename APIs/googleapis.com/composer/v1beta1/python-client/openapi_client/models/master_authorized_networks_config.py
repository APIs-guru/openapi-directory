...
class MasterAuthorizedNetworksConfig(BaseModel):
    ...
    """ # noqa: E501
    cidr_blocks: Optional[List[CidrBlock]] = Field(default=None, description="Up to 50 external networks that could access Kubernetes master through HTTPS.", alias="cidrBlocks")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether or not master authorized networks feature is enabled.")
    __properties: ClassVar[List[str]] = ["cidrBlocks", "enabled"]
