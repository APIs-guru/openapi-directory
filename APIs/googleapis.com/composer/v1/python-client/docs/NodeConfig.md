...
**service_account** | **str** | Optional. The Google Cloud Platform Service Account to be used by the node VMs. If a service account is not specified, the \&quot;default\&quot; Compute Engine service account is used. Cannot be updated. | [optional] 
