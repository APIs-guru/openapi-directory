...
class WebpushConfig(BaseModel):
    ...
    fcm_options: Optional[WebpushFcmOptions] = Field(default=None, alias="fcmOptions")
    headers: Optional[Dict[str, StrictStr]] = Field(default=None, description="HTTP headers defined in webpush protocol. Refer to [Webpush protocol](https://tools.ietf.org/html/rfc8030#section-5) for supported headers, e.g. \"TTL\": \"15\".")
    notification: Optional[Dict[str, Any]] = Field(default=None, description="Web Notification options as a JSON object. Supports Notification instance properties as defined in [Web Notification API](https://developer.mozilla.org/en-US/docs/Web/API/Notification). If present, \"title\" and \"body\" fields override [google.firebase.fcm.v1.Notification.title] and [google.firebase.fcm.v1.Notification.body].")
    __properties: ClassVar[List[str]] = ["data", "fcmOptions", "headers", "notification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "fcmOptions": WebpushFcmOptions.from_dict(obj["fcmOptions"]) if obj.get("fcmOptions") is not None else None,
