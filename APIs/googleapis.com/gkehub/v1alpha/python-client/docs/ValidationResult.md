...
------------ | ------------- | ------------- | -------------
**result** | **str** | Additional information for the validation. | [optional] 
**success** | **bool** | Whether the validation is passed or not. | [optional] 
**validator** | **str** | Validator type to validate membership with. | [optional] 
