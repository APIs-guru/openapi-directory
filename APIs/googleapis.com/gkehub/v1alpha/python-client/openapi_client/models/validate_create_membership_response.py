...
class ValidateCreateMembershipResponse(BaseModel):
    """
    Response message for the `GkeHub.ValidateCreateMembership` method.
    """ # noqa: E501
    validation_results: Optional[List[ValidationResult]] = Field(default=None, description="Wraps all the validator results.", alias="validationResults")
    __properties: ClassVar[List[str]] = ["validationResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationResults": [ValidationResult.from_dict(_item) for _item in obj["validationResults"]] if obj.get("validationResults") is not None else None
        })
        return _obj
