...
class ScopeFeatureState(BaseModel):
    """
    ScopeFeatureState contains Scope-wide Feature status information.
    """ # noqa: E501
    clusterupgrade: Optional[ClusterUpgradeScopeState] = None
    state: Optional[FeatureState] = None
    __properties: ClassVar[List[str]] = ["clusterupgrade", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusterupgrade": ClusterUpgradeScopeState.from_dict(obj["clusterupgrade"]) if obj.get("clusterupgrade") is not None else None,
