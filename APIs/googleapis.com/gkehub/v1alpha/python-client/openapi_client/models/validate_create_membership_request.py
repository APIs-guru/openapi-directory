...
class ValidateCreateMembershipRequest(BaseModel):
    """
    Request message for the `GkeHub.ValidateCreateMembership` method.
    """ # noqa: E501
    membership: Optional[Membership] = None
    membership_id: Optional[StrictStr] = Field(default=None, description="Required. Client chosen membership id.", alias="membershipId")
    __properties: ClassVar[List[str]] = ["membership", "membershipId"]
