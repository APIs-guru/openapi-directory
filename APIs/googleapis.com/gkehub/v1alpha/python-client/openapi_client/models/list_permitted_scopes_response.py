...
class ListPermittedScopesResponse(BaseModel):
    """
    List of permitted Scopes.
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to request the next page of resources from the `ListPermittedScopes` method. The value of an empty string means that there are no more resources to return.", alias="nextPageToken")
    scopes: Optional[List[Scope]] = Field(default=None, description="The list of permitted Scopes")
    __properties: ClassVar[List[str]] = ["nextPageToken", "scopes"]
