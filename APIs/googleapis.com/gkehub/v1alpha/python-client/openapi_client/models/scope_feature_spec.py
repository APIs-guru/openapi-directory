...
class ScopeFeatureSpec(BaseModel):
    """
    ScopeFeatureSpec contains feature specs for a fleet scope.
    """ # noqa: E501
    clusterupgrade: Optional[ClusterUpgradeScopeSpec] = None
    __properties: ClassVar[List[str]] = ["clusterupgrade"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusterupgrade": ClusterUpgradeScopeSpec.from_dict(obj["clusterupgrade"]) if obj.get("clusterupgrade") is not None else None
        })
        return _obj
