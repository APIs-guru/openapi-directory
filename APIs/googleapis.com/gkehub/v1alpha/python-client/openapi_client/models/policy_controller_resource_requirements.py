...
class PolicyControllerResourceRequirements(BaseModel):
    """
    ResourceRequirements describes the compute resource requirements.
    """ # noqa: E501
    limits: Optional[PolicyControllerResourceList] = None
    requests: Optional[PolicyControllerResourceList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "limits": PolicyControllerResourceList.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "requests": PolicyControllerResourceList.from_dict(obj["requests"]) if obj.get("requests") is not None else None
        })
        return _obj
