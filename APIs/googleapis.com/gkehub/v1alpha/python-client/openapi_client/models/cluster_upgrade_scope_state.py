...
class ClusterUpgradeScopeState(BaseModel):
    """
    **ClusterUpgrade**: The state for the scope-level ClusterUpgrade feature.
    """ # noqa: E501
    downstream_scopes: Optional[List[StrictStr]] = Field(default=None, description="This scopes whose upstream_scopes contain the current scope. The scope name should be in the form: `projects/{p}/locations/gloobal/scopes/{s}` Where {p} is the project, {s} is a valid Scope in this project. {p} WILL match the Feature's project.", alias="downstreamScopes")
    ...
    __properties: ClassVar[List[str]] = ["downstreamScopes", "gkeState", "ignored"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "downstreamScopes": obj.get("downstreamScopes"),
