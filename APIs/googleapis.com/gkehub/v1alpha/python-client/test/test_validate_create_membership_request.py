...
class TestValidateCreateMembershipRequest(unittest.TestCase):
    """ValidateCreateMembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateCreateMembershipRequest:
        """Test ValidateCreateMembershipRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateCreateMembershipRequest`
        """
        model = ValidateCreateMembershipRequest()
        if include_optional:
            return ValidateCreateMembershipRequest(
    ...
    def testValidateCreateMembershipRequest(self):
        """Test ValidateCreateMembershipRequest"""
