...
class TestClusterUpgradeScopeState(unittest.TestCase):
    """ClusterUpgradeScopeState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterUpgradeScopeState:
        """Test ClusterUpgradeScopeState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterUpgradeScopeState`
        """
        model = ClusterUpgradeScopeState()
        if include_optional:
            return ClusterUpgradeScopeState(
                downstream_scopes = [
                    ''
                    ],
    ...
    def testClusterUpgradeScopeState(self):
        """Test ClusterUpgradeScopeState"""
