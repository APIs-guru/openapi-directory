...
class TestListBoundMembershipsResponse(unittest.TestCase):
    """ListBoundMembershipsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBoundMembershipsResponse:
        """Test ListBoundMembershipsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBoundMembershipsResponse`
        """
        model = ListBoundMembershipsResponse()
        if include_optional:
    ...
    def testListBoundMembershipsResponse(self):
        """Test ListBoundMembershipsResponse"""
