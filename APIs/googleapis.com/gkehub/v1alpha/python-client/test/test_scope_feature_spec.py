...
class TestScopeFeatureSpec(unittest.TestCase):
    """ScopeFeatureSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScopeFeatureSpec:
        """Test ScopeFeatureSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScopeFeatureSpec`
        """
        model = ScopeFeatureSpec()
        if include_optional:
