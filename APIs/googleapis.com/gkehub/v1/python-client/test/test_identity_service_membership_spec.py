...
class TestIdentityServiceMembershipSpec(unittest.TestCase):
    """IdentityServiceMembershipSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityServiceMembershipSpec:
        """Test IdentityServiceMembershipSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityServiceMembershipSpec`
        """
        model = IdentityServiceMembershipSpec()
        if include_optional:
    ...
    def testIdentityServiceMembershipSpec(self):
        """Test IdentityServiceMembershipSpec"""
