...
class MembershipEndpoint(BaseModel):
    ...
    google_managed: Optional[StrictBool] = Field(default=None, description="Output only. Whether the lifecycle of this membership is managed by a google cluster platform service.", alias="googleManaged")
    ...
    __properties: ClassVar[List[str]] = ["applianceCluster", "edgeCluster", "gkeCluster", "googleManaged", "kubernetesMetadata", "kubernetesResource", "multiCloudCluster", "onPremCluster"]
