...
class ConfigManagementPolicyControllerVersion(BaseModel):
    """
    The build version of Gatekeeper Policy Controller is using.
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="The gatekeeper image tag that is composed of ACM version, git tag, build number.")
