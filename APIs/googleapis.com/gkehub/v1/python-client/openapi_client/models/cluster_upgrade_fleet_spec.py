...
class ClusterUpgradeFleetSpec(BaseModel):
    """
    **ClusterUpgrade**: The configuration for the fleet-level ClusterUpgrade feature.
    ...
    upstream_fleets: Optional[List[StrictStr]] = Field(default=None, description="This fleet consumes upgrades that have COMPLETE status code in the upstream fleets. See UpgradeStatus.Code for code definitions. The fleet name should be either fleet project number or id. This is defined as repeated for future proof reasons. Initial implementation will enforce at most one upstream fleet.", alias="upstreamFleets")
    __properties: ClassVar[List[str]] = ["gkeUpgradeOverrides", "postConditions", "upstreamFleets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upstreamFleets": obj.get("upstreamFleets")
        })
        return _obj
