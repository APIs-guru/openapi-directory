...
class ConfigManagementHierarchyControllerDeploymentState(BaseModel):
    """
    Deployment state for Hierarchy Controller
    """ # noqa: E501
    extension: Optional[StrictStr] = Field(default=None, description="The deployment state for Hierarchy Controller extension (e.g. v0.7.0-hc.1)")
    hnc: Optional[StrictStr] = Field(default=None, description="The deployment state for open source HNC (e.g. v0.7.0-hc.0)")
    __properties: ClassVar[List[str]] = ["extension", "hnc"]
    ...
    @field_validator('hnc')
    def hnc_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
