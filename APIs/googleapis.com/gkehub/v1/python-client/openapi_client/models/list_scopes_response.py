...
class ListScopesResponse(BaseModel):
    ...
    List of Scopes.
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to request the next page of resources from the `ListScopes` method. The value of an empty string means that there are no more resources to return.", alias="nextPageToken")
    scopes: Optional[List[Scope]] = Field(default=None, description="The list of Scopes")
