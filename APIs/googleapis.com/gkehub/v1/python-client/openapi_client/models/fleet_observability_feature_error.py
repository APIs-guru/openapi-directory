...
class FleetObservabilityFeatureError(BaseModel):
    """
    All error details of the fleet observability feature.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code of the error.")
    description: Optional[StrictStr] = Field(default=None, description="A human-readable description of the current status.")
