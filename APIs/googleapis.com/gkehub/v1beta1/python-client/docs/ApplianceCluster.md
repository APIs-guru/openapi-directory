...
------------ | ------------- | ------------- | -------------
**resource_link** | **str** | Immutable. Self-link of the GCP resource for the Appliance Cluster. For example: //transferappliance.googleapis.com/projects/my-project/locations/us-west1-a/appliances/my-appliance | [optional] 
