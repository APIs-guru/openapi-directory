...
------------ | ------------- | ------------- | -------------
**resource_link** | **str** | Immutable. Self-link of the GCP resource for the Edge Cluster. For example: //edgecontainer.googleapis.com/projects/my-project/locations/us-west1-a/clusters/my-cluster | [optional] 
