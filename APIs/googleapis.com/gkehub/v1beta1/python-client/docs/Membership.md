...
**description** | **str** | Optional. Description of this membership, limited to 63 characters. Must match the regex: &#x60;a-zA-Z0-9*&#x60; | [optional] 
...
**labels** | **Dict[str, str]** | Optional. GCP labels for this membership. | [optional] 
