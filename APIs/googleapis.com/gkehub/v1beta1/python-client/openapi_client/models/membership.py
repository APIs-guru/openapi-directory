...
class Membership(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Optional. Description of this membership, limited to 63 characters. Must match the regex: `a-zA-Z0-9*`")
    ...
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Optional. GCP labels for this membership.")
