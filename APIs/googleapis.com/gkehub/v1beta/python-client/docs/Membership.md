...
**external_id** | **str** | Optional. An externally-generated and managed ID for this Membership. This ID may be modified after creation, but this is not recommended. The ID must match the regex: &#x60;a-zA-Z0-9*&#x60; If this Membership represents a Kubernetes cluster, this value should be set to the UID of the &#x60;kube-system&#x60; namespace object. | [optional] 
