...
class TestConfigManagementHierarchyControllerState(unittest.TestCase):
    """ConfigManagementHierarchyControllerState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigManagementHierarchyControllerState:
        """Test ConfigManagementHierarchyControllerState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigManagementHierarchyControllerState`
        """
        model = ConfigManagementHierarchyControllerState()
        if include_optional:
    ...
    def testConfigManagementHierarchyControllerState(self):
        """Test ConfigManagementHierarchyControllerState"""
