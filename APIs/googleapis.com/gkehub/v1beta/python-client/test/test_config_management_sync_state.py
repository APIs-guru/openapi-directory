...
class TestConfigManagementSyncState(unittest.TestCase):
    """ConfigManagementSyncState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigManagementSyncState:
        """Test ConfigManagementSyncState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigManagementSyncState`
        """
        model = ConfigManagementSyncState()
        if include_optional:
    ...
    def testConfigManagementSyncState(self):
        """Test ConfigManagementSyncState"""
