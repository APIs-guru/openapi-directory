...
class TestPolicyControllerHubConfig(unittest.TestCase):
    """PolicyControllerHubConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyControllerHubConfig:
        """Test PolicyControllerHubConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyControllerHubConfig`
        """
        model = PolicyControllerHubConfig()
        if include_optional:
    ...
    def testPolicyControllerHubConfig(self):
        """Test PolicyControllerHubConfig"""
