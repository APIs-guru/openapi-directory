...
class BinaryAuthorizationConfig(BaseModel):
    """
    BinaryAuthorizationConfig defines the fleet level configuration of binary authorization feature.
    """ # noqa: E501
    evaluation_mode: Optional[StrictStr] = Field(default=None, description="Optional. Mode of operation for binauthz policy evaluation.", alias="evaluationMode")
    ...
    __properties: ClassVar[List[str]] = ["evaluationMode", "policyBindings"]
    ...
    def evaluation_mode_validate_enum(cls, value):
        ...
        if value not in set(['EVALUATION_MODE_UNSPECIFIED', 'DISABLED', 'POLICY_BINDINGS']):
            raise ValueError("must be one of enum values ('EVALUATION_MODE_UNSPECIFIED', 'DISABLED', 'POLICY_BINDINGS')")
        return value
