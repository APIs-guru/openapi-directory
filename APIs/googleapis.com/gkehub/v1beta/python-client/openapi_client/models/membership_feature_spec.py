...
class MembershipFeatureSpec(BaseModel):
    ...
    cloudbuild: Optional[MembershipSpec] = None
    ...
    __properties: ClassVar[List[str]] = ["anthosobservability", "cloudbuild", "configmanagement", "fleetobservability", "identityservice", "mesh", "origin", "policycontroller"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudbuild": MembershipSpec.from_dict(obj["cloudbuild"]) if obj.get("cloudbuild") is not None else None,
