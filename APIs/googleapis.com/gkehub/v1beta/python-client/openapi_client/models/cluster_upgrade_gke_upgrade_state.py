...
class ClusterUpgradeGKEUpgradeState(BaseModel):
    """
    GKEUpgradeState is a GKEUpgrade and its state at the scope and fleet level.
    """ # noqa: E501
    stats: Optional[Dict[str, StrictStr]] = Field(default=None, description="Number of GKE clusters in each status code.")
    status: Optional[ClusterUpgradeUpgradeStatus] = None
    upgrade: Optional[ClusterUpgradeGKEUpgrade] = None
    __properties: ClassVar[List[str]] = ["stats", "status", "upgrade"]
