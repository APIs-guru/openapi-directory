...
class MembershipFeatureState(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["appdevexperience", "clusterupgrade", "configmanagement", "fleetobservability", "identityservice", "metering", "policycontroller", "servicemesh", "state"]
