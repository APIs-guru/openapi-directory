...
class FleetObservabilityFeatureSpec(BaseModel):
    """
    **Fleet Observability**: The Hub-wide input for the FleetObservability feature.
    """ # noqa: E501
    logging_config: Optional[FleetObservabilityLoggingConfig] = Field(default=None, alias="loggingConfig")
    __properties: ClassVar[List[str]] = ["loggingConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loggingConfig": FleetObservabilityLoggingConfig.from_dict(obj["loggingConfig"]) if obj.get("loggingConfig") is not None else None
        })
        return _obj
