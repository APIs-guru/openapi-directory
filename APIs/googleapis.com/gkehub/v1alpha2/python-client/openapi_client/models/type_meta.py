...
class TypeMeta(BaseModel):
    ...
    """ # noqa: E501
    api_version: Optional[StrictStr] = Field(default=None, description="APIVersion of the resource (e.g. v1).", alias="apiVersion")
    kind: Optional[StrictStr] = Field(default=None, description="Kind of the resource (e.g. Deployment).")
