...
class GoogleCloudResourcesettingsV1ListSettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Unused. A page token used to retrieve the next page.", alias="nextPageToken")
    settings: Optional[List[GoogleCloudResourcesettingsV1Setting]] = Field(default=None, description="A list of settings that are available at the specified Cloud resource.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": [GoogleCloudResourcesettingsV1Setting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
