...
class GoogleCloudResourcesettingsV1ValueEnumValue(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="The value of this enum")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudResourcesettingsV1ValueEnumValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudResourcesettingsV1ValueEnumValue from a dict"""
        if obj is None:
            return None
