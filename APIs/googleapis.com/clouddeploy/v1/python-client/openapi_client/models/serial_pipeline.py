...
class SerialPipeline(BaseModel):
    ...
    """ # noqa: E501
    stages: Optional[List[Stage]] = Field(default=None, description="Each stage specifies configuration for a `Target`. The ordering of this list defines the promotion flow.")
