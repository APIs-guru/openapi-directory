...
class ListRolloutsResponse(BaseModel):
    ...
    rollouts: Optional[List[Rollout]] = Field(default=None, description="The `Rollout` objects.")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations that could not be reached.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "rollouts", "unreachable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollouts": [Rollout.from_dict(_item) for _item in obj["rollouts"]] if obj.get("rollouts") is not None else None,
