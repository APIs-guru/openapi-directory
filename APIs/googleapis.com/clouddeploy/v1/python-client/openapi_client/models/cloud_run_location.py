...
class CloudRunLocation(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Required. The location for the Cloud Run Service. Format must be `projects/{project}/locations/{location}`.")
