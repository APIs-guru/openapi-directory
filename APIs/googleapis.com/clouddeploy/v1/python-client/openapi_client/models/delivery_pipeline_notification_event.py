...
class DeliveryPipelineNotificationEvent(BaseModel):
    ...
    """ # noqa: E501
    delivery_pipeline: Optional[StrictStr] = Field(default=None, description="The name of the `Delivery Pipeline`.", alias="deliveryPipeline")
    message: Optional[StrictStr] = Field(default=None, description="Debug message for when a notification fails to send.")
    ...
    __properties: ClassVar[List[str]] = ["deliveryPipeline", "message", "pipelineUid", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deliveryPipeline": obj.get("deliveryPipeline"),
