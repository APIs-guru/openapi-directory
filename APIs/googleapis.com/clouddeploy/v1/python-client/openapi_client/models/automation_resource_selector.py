...
class AutomationResourceSelector(BaseModel):
    """
    AutomationResourceSelector contains the information to select the resources to which an Automation is going to be applied.
    """ # noqa: E501
    targets: Optional[List[TargetAttribute]] = Field(default=None, description="Contains attributes about a target.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targets": [TargetAttribute.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
