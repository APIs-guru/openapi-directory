...
class Postdeploy(BaseModel):
    ...
    """ # noqa: E501
    actions: Optional[List[StrictStr]] = Field(default=None, description="Optional. A sequence of Skaffold custom actions to invoke during execution of the postdeploy job.")
