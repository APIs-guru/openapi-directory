...
class RepairPhase(BaseModel):
    ...
    """ # noqa: E501
    retry: Optional[RetryPhase] = None
    rollback: Optional[RollbackAttempt] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retry": RetryPhase.from_dict(obj["retry"]) if obj.get("retry") is not None else None,
            "rollback": RollbackAttempt.from_dict(obj["rollback"]) if obj.get("rollback") is not None else None
        })
        return _obj
