...
class AdvanceRolloutRequest(BaseModel):
    ...
    """ # noqa: E501
    phase_id: Optional[StrictStr] = Field(default=None, description="Required. The phase ID to advance the `Rollout` to.", alias="phaseId")
    __properties: ClassVar[List[str]] = ["phaseId"]
