...
class AutomationEvent(BaseModel):
    ...
    """ # noqa: E501
    automation: Optional[StrictStr] = Field(default=None, description="The name of the `AutomationRun`.")
    ...
    __properties: ClassVar[List[str]] = ["automation", "message", "pipelineUid", "type"]
