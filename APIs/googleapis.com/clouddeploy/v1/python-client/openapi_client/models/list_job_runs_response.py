...
class ListJobRunsResponse(BaseModel):
    ...
    """ # noqa: E501
    job_runs: Optional[List[JobRun]] = Field(default=None, description="The `JobRun` objects.", alias="jobRuns")
    ...
    __properties: ClassVar[List[str]] = ["jobRuns", "nextPageToken", "unreachable"]
