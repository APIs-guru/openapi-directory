...
class RepairMode(BaseModel):
    """
    Configuration of the repair action.
    """ # noqa: E501
    retry: Optional[Retry] = None
    rollback: Optional[Rollback] = None
    __properties: ClassVar[List[str]] = ["retry", "rollback"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retry": Retry.from_dict(obj["retry"]) if obj.get("retry") is not None else None,
            "rollback": Rollback.from_dict(obj["rollback"]) if obj.get("rollback") is not None else None
        })
        return _obj
