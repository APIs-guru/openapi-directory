...
class DefaultPool(BaseModel):
    ...
    service_account: Optional[StrictStr] = Field(default=None, description="Optional. Google service account to use for execution. If unspecified, the project execution service account (-compute@developer.gserviceaccount.com) will be used.", alias="serviceAccount")
    __properties: ClassVar[List[str]] = ["artifactStorage", "serviceAccount"]
