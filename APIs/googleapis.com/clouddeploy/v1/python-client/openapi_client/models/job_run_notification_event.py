...
class JobRunNotificationEvent(BaseModel):
    ...
    """ # noqa: E501
    job_run: Optional[StrictStr] = Field(default=None, description="The name of the `JobRun`.", alias="jobRun")
    ...
    __properties: ClassVar[List[str]] = ["jobRun", "message", "pipelineUid", "release", "releaseUid", "rollout", "rolloutUid", "targetId", "type"]
