...
class CustomTargetDeployMetadata(BaseModel):
    """
    CustomTargetDeployMetadata contains information from a Custom Target deploy operation.
    """ # noqa: E501
    skip_message: Optional[StrictStr] = Field(default=None, description="Output only. Skip message provided in the results of a custom deploy operation.", alias="skipMessage")
    __properties: ClassVar[List[str]] = ["skipMessage"]
