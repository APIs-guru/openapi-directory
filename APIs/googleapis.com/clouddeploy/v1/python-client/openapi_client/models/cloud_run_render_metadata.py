...
class CloudRunRenderMetadata(BaseModel):
    ...
    """ # noqa: E501
    service: Optional[StrictStr] = Field(default=None, description="Output only. The name of the Cloud Run Service in the rendered manifest. Format is `projects/{project}/locations/{location}/services/{service}`.")
