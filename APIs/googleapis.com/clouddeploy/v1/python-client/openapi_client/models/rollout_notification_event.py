...
class RolloutNotificationEvent(BaseModel):
    ...
    rollout: Optional[StrictStr] = Field(default=None, description="The name of the `Rollout`.")
    rollout_uid: Optional[StrictStr] = Field(default=None, description="Unique identifier of the `Rollout`.", alias="rolloutUid")
    target_id: Optional[StrictStr] = Field(default=None, description="ID of the `Target` that the rollout is deployed to.", alias="targetId")
    type: Optional[StrictStr] = Field(default=None, description="Type of this notification, e.g. for a Pub/Sub failure.")
    __properties: ClassVar[List[str]] = ["message", "pipelineUid", "release", "releaseUid", "rollout", "rolloutUid", "targetId", "type"]
