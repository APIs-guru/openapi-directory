...
class ListAutomationsResponse(BaseModel):
    ...
    """ # noqa: E501
    automations: Optional[List[Automation]] = Field(default=None, description="The `Automation` objects.")
    ...
    __properties: ClassVar[List[str]] = ["automations", "nextPageToken", "unreachable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAutomationsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAutomationsResponse from a dict"""
        if obj is None:
            return None
