...
class TestRollbackTargetConfig(unittest.TestCase):
    """RollbackTargetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollbackTargetConfig:
        """Test RollbackTargetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollbackTargetConfig`
        """
        model = RollbackTargetConfig()
        if include_optional:
    ...
    def testRollbackTargetConfig(self):
        """Test RollbackTargetConfig"""
