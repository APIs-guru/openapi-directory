...
class TestListRolloutsResponse(unittest.TestCase):
    """ListRolloutsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRolloutsResponse:
        """Test ListRolloutsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRolloutsResponse`
        """
        model = ListRolloutsResponse()
        if include_optional:
    ...
    def testListRolloutsResponse(self):
        """Test ListRolloutsResponse"""
