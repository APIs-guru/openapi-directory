...
class TestRollbackTargetResponse(unittest.TestCase):
    """RollbackTargetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollbackTargetResponse:
        """Test RollbackTargetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollbackTargetResponse`
        """
        model = RollbackTargetResponse()
        if include_optional:
    ...
    def testRollbackTargetResponse(self):
        """Test RollbackTargetResponse"""
