...
class TestDeliveryPipeline(unittest.TestCase):
    """DeliveryPipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryPipeline:
        """Test DeliveryPipeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryPipeline`
        """
        model = DeliveryPipeline()
        if include_optional:
