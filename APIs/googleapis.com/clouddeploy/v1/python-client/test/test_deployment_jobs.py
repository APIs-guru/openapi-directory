...
class TestDeploymentJobs(unittest.TestCase):
    """DeploymentJobs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentJobs:
        """Test DeploymentJobs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentJobs`
        """
        model = DeploymentJobs()
        if include_optional:
            return DeploymentJobs(
                ...
                postdeploy_job = openapi_client.models.job.Job(
                    ...
                    state = 'STATE_UNSPECIFIED', 
                    verify_job = openapi_client.models.verify_job.VerifyJob(), ),
                predeploy_job = openapi_client.models.job.Job(
                    advance_child_rollout_job = openapi_client.models.advance_child_rollout_job.AdvanceChildRolloutJob(), 
                    create_child_rollout_job = openapi_client.models.create_child_rollout_job.CreateChildRolloutJob(), 
                    deploy_job = openapi_client.models.deploy_job.DeployJob(), 
                    id = '', 
                    ...
                    state = 'STATE_UNSPECIFIED', 
                    verify_job = openapi_client.models.verify_job.VerifyJob(), ),
                verify_job = openapi_client.models.job.Job(
                    advance_child_rollout_job = openapi_client.models.advance_child_rollout_job.AdvanceChildRolloutJob(), 
                    create_child_rollout_job = openapi_client.models.create_child_rollout_job.CreateChildRolloutJob(), 
                    deploy_job = openapi_client.models.deploy_job.DeployJob(), 
                    id = '', 
