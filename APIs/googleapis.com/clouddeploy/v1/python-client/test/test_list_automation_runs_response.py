...
class TestListAutomationRunsResponse(unittest.TestCase):
    """ListAutomationRunsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAutomationRunsResponse:
        """Test ListAutomationRunsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAutomationRunsResponse`
        """
        model = ListAutomationRunsResponse()
        if include_optional:
            return ListAutomationRunsResponse(
                automation_runs = [
                    openapi_client.models.automation_run.AutomationRun(
    ...
    def testListAutomationRunsResponse(self):
        """Test ListAutomationRunsResponse"""
