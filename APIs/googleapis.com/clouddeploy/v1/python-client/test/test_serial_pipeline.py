...
class TestSerialPipeline(unittest.TestCase):
    """SerialPipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SerialPipeline:
        """Test SerialPipeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SerialPipeline`
        """
        model = SerialPipeline()
        if include_optional:
