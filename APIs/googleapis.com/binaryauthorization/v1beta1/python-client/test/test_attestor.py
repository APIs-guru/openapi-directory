...
class TestAttestor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Attestor:
        """Test Attestor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Attestor`
        """
        model = Attestor()
        if include_optional:
            return Attestor(
                ...
                name = '',
                update_time = '',
                user_owned_drydock_note = openapi_client.models.user_owned_drydock_note.UserOwnedDrydockNote(
