...
class Attestor(BaseModel):
    ...
    user_owned_drydock_note: Optional[UserOwnedDrydockNote] = Field(default=None, alias="userOwnedDrydockNote")
    __properties: ClassVar[List[str]] = ["description", "etag", "name", "updateTime", "userOwnedDrydockNote"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of user_owned_drydock_note
        if self.user_owned_drydock_note:
            _dict['userOwnedDrydockNote'] = self.user_owned_drydock_note.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userOwnedDrydockNote": UserOwnedDrydockNote.from_dict(obj["userOwnedDrydockNote"]) if obj.get("userOwnedDrydockNote") is not None else None
        })
        return _obj
