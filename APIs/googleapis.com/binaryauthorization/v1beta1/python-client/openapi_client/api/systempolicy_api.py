...
class SystempolicyApi:
    ...
    def binaryauthorization_systempolicy_get_policy(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name, in the format `locations/*/policy`. Note that the system policy is not associated with a project.")],
        ...
        """binaryauthorization_systempolicy_get_policy

        Gets the current system policy in the specified location.

        :param name: Required. The resource name, in the format `locations/*/policy`. Note that the system policy is not associated with a project. (required)
        :type name: str
        ...
        _param = self._binaryauthorization_systempolicy_get_policy_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def binaryauthorization_systempolicy_get_policy_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name, in the format `locations/*/policy`. Note that the system policy is not associated with a project.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def binaryauthorization_systempolicy_get_policy_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name, in the format `locations/*/policy`. Note that the system policy is not associated with a project.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _binaryauthorization_systempolicy_get_policy_serialize(
        self,
        name,
        xgafv,
        access_token,
