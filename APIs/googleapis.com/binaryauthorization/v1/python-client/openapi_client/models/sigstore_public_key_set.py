...
class SigstorePublicKeySet(BaseModel):
    """
    ...
    """ # noqa: E501
    public_keys: Optional[List[SigstorePublicKey]] = Field(default=None, description="Required. `public_keys` must have at least one entry.", alias="publicKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicKeys": [SigstorePublicKey.from_dict(_item) for _item in obj["publicKeys"]] if obj.get("publicKeys") is not None else None
        })
        return _obj
