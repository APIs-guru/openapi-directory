...
class UserOwnedGrafeasNote(BaseModel):
    """
    ...
    note_reference: Optional[StrictStr] = Field(default=None, description="Required. The Grafeas resource name of a Attestation.Authority Note, created by the user, in the format: `projects/*/notes/*`. This field may not be updated. An attestation by this attestor is stored as a Grafeas Attestation.Authority Occurrence that names a container image and that links to this Note. Grafeas is an external dependency.", alias="noteReference")
