...
class AttestationSource(BaseModel):
    """
    Specifies the locations for fetching the provenance attestations.
    """ # noqa: E501
    container_analysis_attestation_projects: Optional[List[StrictStr]] = Field(default=None, description="The IDs of the Google Cloud projects that store the SLSA attestations as Container Analysis Occurrences, in the format `projects/[PROJECT_ID]`. Maximum number of `container_analysis_attestation_projects` allowed in each `AttestationSource` is 10.", alias="containerAnalysisAttestationProjects")
    __properties: ClassVar[List[str]] = ["containerAnalysisAttestationProjects"]
