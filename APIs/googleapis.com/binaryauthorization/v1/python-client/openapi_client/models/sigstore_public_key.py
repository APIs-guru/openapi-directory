...
class SigstorePublicKey(BaseModel):
    """
    A Sigstore public key. `SigstorePublicKey` is the public key material used to authenticate Sigstore signatures.
    """ # noqa: E501
    public_key_pem: Optional[StrictStr] = Field(default=None, description="The public key material in PEM format.", alias="publicKeyPem")
    __properties: ClassVar[List[str]] = ["publicKeyPem"]
