...
class TestSimpleSigningAttestationCheck(unittest.TestCase):
    """SimpleSigningAttestationCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSigningAttestationCheck:
        """Test SimpleSigningAttestationCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSigningAttestationCheck`
        """
        model = SimpleSigningAttestationCheck()
        if include_optional:
    ...
    def testSimpleSigningAttestationCheck(self):
        """Test SimpleSigningAttestationCheck"""
