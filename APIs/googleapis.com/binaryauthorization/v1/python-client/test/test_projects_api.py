...
class TestProjectsApi(unittest.TestCase):
    ...
    def test_binaryauthorization_projects_platforms_gke_policies_evaluate(self) -> None:
        """Test case for binaryauthorization_projects_platforms_gke_policies_evaluate

        """
        pass

    def test_binaryauthorization_projects_platforms_policies_create(self) -> None:
        """Test case for binaryauthorization_projects_platforms_policies_create

        """
        pass

    def test_binaryauthorization_projects_platforms_policies_delete(self) -> None:
        """Test case for binaryauthorization_projects_platforms_policies_delete

        """
        pass

    def test_binaryauthorization_projects_platforms_policies_list(self) -> None:
        """Test case for binaryauthorization_projects_platforms_policies_list

        """
        pass

    def test_binaryauthorization_projects_platforms_policies_replace_platform_policy(self) -> None:
