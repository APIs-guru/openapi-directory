...
class TestPlatformPolicy(unittest.TestCase):
    """PlatformPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformPolicy:
        """Test PlatformPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformPolicy`
        """
        model = PlatformPolicy()
        if include_optional:
            return PlatformPolicy(
                description = '',
                gke_policy = openapi_client.models.gke_policy.GkePolicy(
                    check_sets = [
                        openapi_client.models.check_set.CheckSet(
                            checks = [
