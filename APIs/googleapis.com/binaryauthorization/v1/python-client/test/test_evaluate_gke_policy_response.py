...
class TestEvaluateGkePolicyResponse(unittest.TestCase):
    """EvaluateGkePolicyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EvaluateGkePolicyResponse:
        """Test EvaluateGkePolicyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EvaluateGkePolicyResponse`
        """
        model = EvaluateGkePolicyResponse()
        if include_optional:
            return EvaluateGkePolicyResponse(
                results = [
                    openapi_client.models.pod_result.PodResult(
                        image_results = [
    ...
    def testEvaluateGkePolicyResponse(self):
        """Test EvaluateGkePolicyResponse"""
