...
class TestListPlatformPoliciesResponse(unittest.TestCase):
    """ListPlatformPoliciesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPlatformPoliciesResponse:
        """Test ListPlatformPoliciesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPlatformPoliciesResponse`
        """
        model = ListPlatformPoliciesResponse()
        if include_optional:
            return ListPlatformPoliciesResponse(
                next_page_token = '',
                platform_policies = [
                    openapi_client.models.platform_policy.PlatformPolicy(
                        description = '', 
    ...
    def testListPlatformPoliciesResponse(self):
        """Test ListPlatformPoliciesResponse"""
