...
class TestGkePolicy(unittest.TestCase):
    """GkePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GkePolicy:
        """Test GkePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GkePolicy`
        """
        model = GkePolicy()
        if include_optional:
            return GkePolicy(
