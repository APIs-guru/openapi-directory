...
class TestSigstoreSignatureCheck(unittest.TestCase):
    """SigstoreSignatureCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SigstoreSignatureCheck:
        """Test SigstoreSignatureCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SigstoreSignatureCheck`
        """
        model = SigstoreSignatureCheck()
        if include_optional:
    ...
    def testSigstoreSignatureCheck(self):
        """Test SigstoreSignatureCheck"""
