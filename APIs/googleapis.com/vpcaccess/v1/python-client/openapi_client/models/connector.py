...
class Connector(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connectedProjects", "ipCidrRange", "machineType", "maxInstances", "maxThroughput", "minInstances", "minThroughput", "name", "network", "state", "subnet"]
