...
class RemoveHeldAccountsRequest(BaseModel):
    ...
    """ # noqa: E501
    account_ids: Optional[List[StrictStr]] = Field(default=None, description="The account IDs of the accounts to remove from the hold.", alias="accountIds")
    __properties: ClassVar[List[str]] = ["accountIds"]
