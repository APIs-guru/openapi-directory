...
class MailOptions(BaseModel):
    ...
    """ # noqa: E501
    client_side_encrypted_option: Optional[StrictStr] = Field(default=None, description="Specifies whether the results should include encrypted content, unencrypted content, or both. Defaults to including both.", alias="clientSideEncryptedOption")
    exclude_drafts: Optional[StrictBool] = Field(default=None, description="Set to **true** to exclude drafts.", alias="excludeDrafts")
    __properties: ClassVar[List[str]] = ["clientSideEncryptedOption", "excludeDrafts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludeDrafts": obj.get("excludeDrafts")
        })
        return _obj
