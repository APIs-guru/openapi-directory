...
class AddHeldAccountResult(BaseModel):
    ...
    """ # noqa: E501
    account: Optional[HeldAccount] = None
    status: Optional[Status] = None
    __properties: ClassVar[List[str]] = ["account", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": HeldAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
