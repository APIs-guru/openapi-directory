...
class CloudStorageSink(BaseModel):
    ...
    """ # noqa: E501
    files: Optional[List[CloudStorageFile]] = Field(default=None, description="Output only. The exported files in Cloud Storage.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [CloudStorageFile.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
