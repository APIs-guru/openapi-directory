...
class TestListHoldsResponse(unittest.TestCase):
    """ListHoldsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListHoldsResponse:
        """Test ListHoldsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListHoldsResponse`
        """
        model = ListHoldsResponse()
        if include_optional:
            return ListHoldsResponse(
                holds = [
                    openapi_client.models.hold.Hold(
                        accounts = [
    ...
    def testListHoldsResponse(self):
        """Test ListHoldsResponse"""
