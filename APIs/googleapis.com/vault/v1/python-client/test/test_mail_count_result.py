...
class TestMailCountResult(unittest.TestCase):
    """MailCountResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailCountResult:
        """Test MailCountResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailCountResult`
        """
        model = MailCountResult()
        if include_optional:
