...
class TestCountArtifactsRequest(unittest.TestCase):
    """CountArtifactsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountArtifactsRequest:
        """Test CountArtifactsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountArtifactsRequest`
        """
        model = CountArtifactsRequest()
        if include_optional:
            return CountArtifactsRequest(
                ...
                view = 'COUNT_RESULT_VIEW_UNSPECIFIED'
            )
        else:
            return CountArtifactsRequest(
        )
    ...
    def testCountArtifactsRequest(self):
        """Test CountArtifactsRequest"""
