...
class TestCountArtifactsMetadata(unittest.TestCase):
    """CountArtifactsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountArtifactsMetadata:
        """Test CountArtifactsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountArtifactsMetadata`
        """
        model = CountArtifactsMetadata()
        if include_optional:
            return CountArtifactsMetadata(
                end_time = '',
                matter_id = '',
    ...
    def testCountArtifactsMetadata(self):
        """Test CountArtifactsMetadata"""
