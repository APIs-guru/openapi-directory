...
class TestCorpusQuery(unittest.TestCase):
    """CorpusQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusQuery:
        """Test CorpusQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusQuery`
        """
        model = CorpusQuery()
        if include_optional:
            return CorpusQuery(
