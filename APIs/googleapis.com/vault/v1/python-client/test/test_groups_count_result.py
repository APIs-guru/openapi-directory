...
class TestGroupsCountResult(unittest.TestCase):
    """GroupsCountResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsCountResult:
        """Test GroupsCountResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsCountResult`
        """
        model = GroupsCountResult()
        if include_optional:
    ...
    def testGroupsCountResult(self):
        """Test GroupsCountResult"""
