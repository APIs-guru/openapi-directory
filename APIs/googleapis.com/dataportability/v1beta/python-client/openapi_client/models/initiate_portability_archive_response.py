...
class InitiatePortabilityArchiveResponse(BaseModel):
    """
    Response from initiating an Archive job.
    """ # noqa: E501
    archive_job_id: Optional[StrictStr] = Field(default=None, description="The archive job ID that is initiated in the API. This can be used to get the state of the job.", alias="archiveJobId")
    __properties: ClassVar[List[str]] = ["archiveJobId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "archiveJobId": obj.get("archiveJobId")
        })
        return _obj
