...
class InitiatePortabilityArchiveRequest(BaseModel):
    """
    Request to kick off an Archive job.
    """ # noqa: E501
    resources: Optional[List[StrictStr]] = Field(default=None, description="The resources from which you're exporting data. These values have a 1:1 correspondence with the OAuth scopes.")
