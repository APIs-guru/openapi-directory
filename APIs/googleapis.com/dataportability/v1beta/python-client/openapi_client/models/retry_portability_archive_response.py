...
class RetryPortabilityArchiveResponse(BaseModel):
    """
    Response from retrying a Portability Archive.
    """ # noqa: E501
    archive_job_id: Optional[StrictStr] = Field(default=None, description="The archive job ID that is initiated by the retry endpoint. This can be used to get the state of the new job.", alias="archiveJobId")
