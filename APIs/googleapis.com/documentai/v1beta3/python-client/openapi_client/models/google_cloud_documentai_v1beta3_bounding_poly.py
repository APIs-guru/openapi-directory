...
class GoogleCloudDocumentaiV1beta3BoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    normalized_vertices: Optional[List[GoogleCloudDocumentaiV1beta3NormalizedVertex]] = Field(default=None, description="The bounding polygon normalized vertices.", alias="normalizedVertices")
    vertices: Optional[List[GoogleCloudDocumentaiV1beta3Vertex]] = Field(default=None, description="The bounding polygon vertices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedVertices": [GoogleCloudDocumentaiV1beta3NormalizedVertex.from_dict(_item) for _item in obj["normalizedVertices"]] if obj.get("normalizedVertices") is not None else None,
            "vertices": [GoogleCloudDocumentaiV1beta3Vertex.from_dict(_item) for _item in obj["vertices"]] if obj.get("vertices") is not None else None
        })
        return _obj
