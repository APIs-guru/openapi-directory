...
class GoogleCloudDocumentaiV1beta3Evaluation(BaseModel):
    ...
    """ # noqa: E501
    all_entities_metrics: Optional[GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics] = Field(default=None, alias="allEntitiesMetrics")
    create_time: Optional[StrictStr] = Field(default=None, description="The time that the evaluation was created.", alias="createTime")
    document_counters: Optional[GoogleCloudDocumentaiV1beta3EvaluationCounters] = Field(default=None, alias="documentCounters")
    entity_metrics: Optional[Dict[str, GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics]] = Field(default=None, description="Metrics across confidence levels, for different entities.", alias="entityMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allEntitiesMetrics": GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics.from_dict(obj["allEntitiesMetrics"]) if obj.get("allEntitiesMetrics") is not None else None,
            "createTime": obj.get("createTime"),
            "documentCounters": GoogleCloudDocumentaiV1beta3EvaluationCounters.from_dict(obj["documentCounters"]) if obj.get("documentCounters") is not None else None,
            "entityMetrics": dict(
                (_k, GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics.from_dict(_v))
