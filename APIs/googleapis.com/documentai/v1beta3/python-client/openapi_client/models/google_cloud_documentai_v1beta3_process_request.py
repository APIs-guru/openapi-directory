...
class GoogleCloudDocumentaiV1beta3ProcessRequest(BaseModel):
    ...
    gcs_document: Optional[GoogleCloudDocumentaiV1beta3GcsDocument] = Field(default=None, alias="gcsDocument")
    ...
    raw_document: Optional[GoogleCloudDocumentaiV1beta3RawDocument] = Field(default=None, alias="rawDocument")
    ...
    __properties: ClassVar[List[str]] = ["document", "fieldMask", "gcsDocument", "inlineDocument", "labels", "processOptions", "rawDocument", "skipHumanReview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsDocument": GoogleCloudDocumentaiV1beta3GcsDocument.from_dict(obj["gcsDocument"]) if obj.get("gcsDocument") is not None else None,
            ...
            "rawDocument": GoogleCloudDocumentaiV1beta3RawDocument.from_dict(obj["rawDocument"]) if obj.get("rawDocument") is not None else None,
