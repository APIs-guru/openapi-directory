...
class GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadataIndividualExportStatus(BaseModel):
    """
    ...
    output_gcs_destination: Optional[StrictStr] = Field(default=None, description="The output_gcs_destination of the exported document if it was successful, otherwise empty.", alias="outputGcsDestination")
    status: Optional[GoogleRpcStatus] = None
    __properties: ClassVar[List[str]] = ["documentId", "outputGcsDestination", "status"]
