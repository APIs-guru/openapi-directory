...
class GoogleCloudDocumentaiV1beta3DocumentPageFormField(BaseModel):
    ...
    field_name: Optional[GoogleCloudDocumentaiV1beta3DocumentPageLayout] = Field(default=None, alias="fieldName")
    field_value: Optional[GoogleCloudDocumentaiV1beta3DocumentPageLayout] = Field(default=None, alias="fieldValue")
    name_detected_languages: Optional[List[GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage]] = Field(default=None, description="A list of detected languages for name together with confidence.", alias="nameDetectedLanguages")
    provenance: Optional[GoogleCloudDocumentaiV1beta3DocumentProvenance] = None
    value_detected_languages: Optional[List[GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage]] = Field(default=None, description="A list of detected languages for value together with confidence.", alias="valueDetectedLanguages")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDocumentaiV1beta3DocumentPageFormField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDocumentaiV1beta3DocumentPageFormField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fieldName": GoogleCloudDocumentaiV1beta3DocumentPageLayout.from_dict(obj["fieldName"]) if obj.get("fieldName") is not None else None,
            "fieldValue": GoogleCloudDocumentaiV1beta3DocumentPageLayout.from_dict(obj["fieldValue"]) if obj.get("fieldValue") is not None else None,
            "nameDetectedLanguages": [GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage.from_dict(_item) for _item in obj["nameDetectedLanguages"]] if obj.get("nameDetectedLanguages") is not None else None,
            ...
            "valueDetectedLanguages": [GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage.from_dict(_item) for _item in obj["valueDetectedLanguages"]] if obj.get("valueDetectedLanguages") is not None else None,
