...
class GoogleCloudDocumentaiV1beta3ListProcessorsResponse(BaseModel):
    ...
    processors: Optional[List[GoogleCloudDocumentaiV1beta3Processor]] = Field(default=None, description="The list of processors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processors": [GoogleCloudDocumentaiV1beta3Processor.from_dict(_item) for _item in obj["processors"]] if obj.get("processors") is not None else None
        })
        return _obj
