...
class GoogleCloudDocumentaiV1beta3OcrConfig(BaseModel):
    ...
    hints: Optional[GoogleCloudDocumentaiV1beta3OcrConfigHints] = None
    premium_features: Optional[GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures] = Field(default=None, alias="premiumFeatures")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hints": GoogleCloudDocumentaiV1beta3OcrConfigHints.from_dict(obj["hints"]) if obj.get("hints") is not None else None,
            "premiumFeatures": GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures.from_dict(obj["premiumFeatures"]) if obj.get("premiumFeatures") is not None else None
        })
        return _obj
