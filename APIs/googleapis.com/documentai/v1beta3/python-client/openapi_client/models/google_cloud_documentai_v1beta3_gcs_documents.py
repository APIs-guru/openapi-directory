...
class GoogleCloudDocumentaiV1beta3GcsDocuments(BaseModel):
    ...
    """ # noqa: E501
    documents: Optional[List[GoogleCloudDocumentaiV1beta3GcsDocument]] = Field(default=None, description="The list of documents.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [GoogleCloudDocumentaiV1beta3GcsDocument.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
