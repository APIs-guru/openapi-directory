...
class GoogleCloudDocumentaiV1beta3ProcessorType(BaseModel):
    ...
    available_locations: Optional[List[GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo]] = Field(default=None, description="The locations in which this processor is available.", alias="availableLocations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availableLocations": [GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo.from_dict(_item) for _item in obj["availableLocations"]] if obj.get("availableLocations") is not None else None,
