...
class GoogleCloudDocumentaiV1beta1DocumentPageDetectedBarcode(BaseModel):
    ...
    A detected barcode.
    """ # noqa: E501
    barcode: Optional[GoogleCloudDocumentaiV1beta1Barcode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "barcode": GoogleCloudDocumentaiV1beta1Barcode.from_dict(obj["barcode"]) if obj.get("barcode") is not None else None,
