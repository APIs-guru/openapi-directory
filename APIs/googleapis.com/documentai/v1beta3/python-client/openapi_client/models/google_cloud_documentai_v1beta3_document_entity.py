...
class GoogleCloudDocumentaiV1beta3DocumentEntity(BaseModel):
    ...
    normalized_value: Optional[GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue] = Field(default=None, alias="normalizedValue")
    page_anchor: Optional[GoogleCloudDocumentaiV1beta3DocumentPageAnchor] = Field(default=None, alias="pageAnchor")
    properties: Optional[List[GoogleCloudDocumentaiV1beta3DocumentEntity]] = Field(default=None, description="Optional. Entities can be nested to form a hierarchical data structure representing the content in the document.")
    ...
    text_anchor: Optional[GoogleCloudDocumentaiV1beta3DocumentTextAnchor] = Field(default=None, alias="textAnchor")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "normalizedValue": GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue.from_dict(obj["normalizedValue"]) if obj.get("normalizedValue") is not None else None,
            "pageAnchor": GoogleCloudDocumentaiV1beta3DocumentPageAnchor.from_dict(obj["pageAnchor"]) if obj.get("pageAnchor") is not None else None,
            "properties": [GoogleCloudDocumentaiV1beta3DocumentEntity.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            ...
            "textAnchor": GoogleCloudDocumentaiV1beta3DocumentTextAnchor.from_dict(obj["textAnchor"]) if obj.get("textAnchor") is not None else None,
            "type": obj.get("type")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
GoogleCloudDocumentaiV1beta3DocumentEntity.model_rebuild(raise_errors=False)
