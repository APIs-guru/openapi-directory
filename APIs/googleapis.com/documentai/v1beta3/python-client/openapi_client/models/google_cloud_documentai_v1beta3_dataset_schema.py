...
class GoogleCloudDocumentaiV1beta3DatasetSchema(BaseModel):
    """
    Dataset Schema.
    """ # noqa: E501
    document_schema: Optional[GoogleCloudDocumentaiV1beta3DocumentSchema] = Field(default=None, alias="documentSchema")
    name: Optional[StrictStr] = Field(default=None, description="Dataset schema resource name. Format: `projects/{project}/locations/{location}/processors/{processor}/dataset/datasetSchema`")
    __properties: ClassVar[List[str]] = ["documentSchema", "name"]
