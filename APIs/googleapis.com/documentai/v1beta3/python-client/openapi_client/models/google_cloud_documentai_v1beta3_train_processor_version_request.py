...
class GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest(BaseModel):
    ...
    custom_document_extraction_options: Optional[GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions] = Field(default=None, alias="customDocumentExtractionOptions")
    document_schema: Optional[GoogleCloudDocumentaiV1beta3DocumentSchema] = Field(default=None, alias="documentSchema")
    foundation_model_tuning_options: Optional[GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions] = Field(default=None, alias="foundationModelTuningOptions")
    input_data: Optional[GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData] = Field(default=None, alias="inputData")
    processor_version: Optional[GoogleCloudDocumentaiV1beta3ProcessorVersion] = Field(default=None, alias="processorVersion")
    __properties: ClassVar[List[str]] = ["baseProcessorVersion", "customDocumentExtractionOptions", "documentSchema", "foundationModelTuningOptions", "inputData", "processorVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of foundation_model_tuning_options
        if self.foundation_model_tuning_options:
            _dict['foundationModelTuningOptions'] = self.foundation_model_tuning_options.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customDocumentExtractionOptions": GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions.from_dict(obj["customDocumentExtractionOptions"]) if obj.get("customDocumentExtractionOptions") is not None else None,
            ...
            "foundationModelTuningOptions": GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions.from_dict(obj["foundationModelTuningOptions"]) if obj.get("foundationModelTuningOptions") is not None else None,
            "inputData": GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData.from_dict(obj["inputData"]) if obj.get("inputData") is not None else None,
            "processorVersion": GoogleCloudDocumentaiV1beta3ProcessorVersion.from_dict(obj["processorVersion"]) if obj.get("processorVersion") is not None else None
        })
        return _obj
