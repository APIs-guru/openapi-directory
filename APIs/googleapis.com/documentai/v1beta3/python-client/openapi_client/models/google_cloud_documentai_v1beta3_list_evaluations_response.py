...
class GoogleCloudDocumentaiV1beta3ListEvaluationsResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluations: Optional[List[GoogleCloudDocumentaiV1beta3Evaluation]] = Field(default=None, description="The evaluations requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluations": [GoogleCloudDocumentaiV1beta3Evaluation.from_dict(_item) for _item in obj["evaluations"]] if obj.get("evaluations") is not None else None,
