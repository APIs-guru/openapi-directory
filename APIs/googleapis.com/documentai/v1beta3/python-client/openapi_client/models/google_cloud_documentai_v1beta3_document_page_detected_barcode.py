...
class GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode(BaseModel):
    ...
    A detected barcode.
    """ # noqa: E501
    barcode: Optional[GoogleCloudDocumentaiV1beta3Barcode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "barcode": GoogleCloudDocumentaiV1beta3Barcode.from_dict(obj["barcode"]) if obj.get("barcode") is not None else None,
