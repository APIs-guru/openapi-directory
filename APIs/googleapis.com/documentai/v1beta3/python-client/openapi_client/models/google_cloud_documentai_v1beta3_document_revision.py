...
class GoogleCloudDocumentaiV1beta3DocumentRevision(BaseModel):
    ...
    human_review: Optional[GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview] = Field(default=None, alias="humanReview")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "humanReview": GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview.from_dict(obj["humanReview"]) if obj.get("humanReview") is not None else None,
            "id": obj.get("id"),
