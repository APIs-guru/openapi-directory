...
class TestGoogleCloudDocumentaiV1beta3DocumentMetadata(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta3DocumentMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta3DocumentMetadata:
        """Test GoogleCloudDocumentaiV1beta3DocumentMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta3DocumentMetadata`
        """
        model = GoogleCloudDocumentaiV1beta3DocumentMetadata()
        if include_optional:
            return GoogleCloudDocumentaiV1beta3DocumentMetadata(
    ...
    def testGoogleCloudDocumentaiV1beta3DocumentMetadata(self):
        """Test GoogleCloudDocumentaiV1beta3DocumentMetadata"""
