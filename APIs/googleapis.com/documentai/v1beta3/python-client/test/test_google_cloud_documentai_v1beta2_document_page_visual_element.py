...
class TestGoogleCloudDocumentaiV1beta2DocumentPageVisualElement(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta2DocumentPageVisualElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta2DocumentPageVisualElement:
        """Test GoogleCloudDocumentaiV1beta2DocumentPageVisualElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta2DocumentPageVisualElement`
        """
        model = GoogleCloudDocumentaiV1beta2DocumentPageVisualElement()
        if include_optional:
    ...
    def testGoogleCloudDocumentaiV1beta2DocumentPageVisualElement(self):
        """Test GoogleCloudDocumentaiV1beta2DocumentPageVisualElement"""
