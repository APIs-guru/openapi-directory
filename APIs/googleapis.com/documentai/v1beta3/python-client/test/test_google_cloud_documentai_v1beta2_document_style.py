...
class TestGoogleCloudDocumentaiV1beta2DocumentStyle(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta2DocumentStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta2DocumentStyle:
        """Test GoogleCloudDocumentaiV1beta2DocumentStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta2DocumentStyle`
        """
        model = GoogleCloudDocumentaiV1beta2DocumentStyle()
        if include_optional:
    ...
    def testGoogleCloudDocumentaiV1beta2DocumentStyle(self):
        """Test GoogleCloudDocumentaiV1beta2DocumentStyle"""
