...
json = "{}"
# create an instance of GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue from a JSON string
google_cloud_documentai_v1beta2_document_entity_normalized_value_instance = GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue.to_json())

# convert the object into a dict
google_cloud_documentai_v1beta2_document_entity_normalized_value_dict = google_cloud_documentai_v1beta2_document_entity_normalized_value_instance.to_dict()
# create an instance of GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue from a dict
google_cloud_documentai_v1beta2_document_entity_normalized_value_from_dict = GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue.from_dict(google_cloud_documentai_v1beta2_document_entity_normalized_value_dict)
```
