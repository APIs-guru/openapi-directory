...
class GoogleCloudDocumentaiV1beta2DocumentPageToken(BaseModel):
    ...
    A detected token.
    """ # noqa: E501
    detected_break: Optional[GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak] = Field(default=None, alias="detectedBreak")
    ...
    style_info: Optional[GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo] = Field(default=None, alias="styleInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detectedBreak": GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak.from_dict(obj["detectedBreak"]) if obj.get("detectedBreak") is not None else None,
            ...
            "styleInfo": GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo.from_dict(obj["styleInfo"]) if obj.get("styleInfo") is not None else None
        })
        return _obj
