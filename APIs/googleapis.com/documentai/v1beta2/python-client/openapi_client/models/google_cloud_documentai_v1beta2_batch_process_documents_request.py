...
class GoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    requests: Optional[List[GoogleCloudDocumentaiV1beta2ProcessDocumentRequest]] = Field(default=None, description="Required. Individual requests for each document.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudDocumentaiV1beta2ProcessDocumentRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
