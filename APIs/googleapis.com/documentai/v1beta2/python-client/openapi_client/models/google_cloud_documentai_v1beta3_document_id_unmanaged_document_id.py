...
class GoogleCloudDocumentaiV1beta3DocumentIdUnmanagedDocumentId(BaseModel):
    """
    Identifies a document uniquely within the scope of a dataset in unmanaged option.
    """ # noqa: E501
    doc_id: Optional[StrictStr] = Field(default=None, description="Required. The id of the document.", alias="docId")
