...
class TestGoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata(unittest.TestCase):
    """GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata:
        """Test GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata`
        """
        model = GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata()
        if include_optional:
            return GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata(
                ...
                individual_batch_delete_statuses = [
                    openapi_client.models.google_cloud_documentai_uiv1beta3_batch_delete_documents_metadata_individual_batch_delete_status.GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadataIndividualBatchDeleteStatus(
    ...
    def testGoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata(self):
        """Test GoogleCloudDocumentaiUiv1beta3BatchDeleteDocumentsMetadata"""
