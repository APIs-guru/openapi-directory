...
google_cloud_documentai_v1_document_page_token_style_info_instance = GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo.to_json())

# convert the object into a dict
google_cloud_documentai_v1_document_page_token_style_info_dict = google_cloud_documentai_v1_document_page_token_style_info_instance.to_dict()
# create an instance of GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo from a dict
google_cloud_documentai_v1_document_page_token_style_info_from_dict = GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo.from_dict(google_cloud_documentai_v1_document_page_token_style_info_dict)
```
