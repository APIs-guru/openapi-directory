...
```python
from openapi_client.models.google_cloud_documentai_v1_document_entity_normalized_value import GoogleCloudDocumentaiV1DocumentEntityNormalizedValue

# TODO update the JSON string below
json = "{}"
# create an instance of GoogleCloudDocumentaiV1DocumentEntityNormalizedValue from a JSON string
google_cloud_documentai_v1_document_entity_normalized_value_instance = GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.to_json())

# convert the object into a dict
google_cloud_documentai_v1_document_entity_normalized_value_dict = google_cloud_documentai_v1_document_entity_normalized_value_instance.to_dict()
# create an instance of GoogleCloudDocumentaiV1DocumentEntityNormalizedValue from a dict
google_cloud_documentai_v1_document_entity_normalized_value_from_dict = GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.from_dict(google_cloud_documentai_v1_document_entity_normalized_value_dict)
```
