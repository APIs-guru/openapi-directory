...
class GoogleCloudDocumentaiV1beta2DocumentPage(BaseModel):
    ...
    """ # noqa: E501
    blocks: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageBlock]] = Field(default=None, description="A list of visually detected text blocks on the page. A block has a set of lines (collected into paragraphs) that have a common line-spacing and orientation.")
    detected_barcodes: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageDetectedBarcode]] = Field(default=None, description="A list of detected barcodes.", alias="detectedBarcodes")
    detected_languages: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageDetectedLanguage]] = Field(default=None, description="A list of detected languages together with confidence.", alias="detectedLanguages")
    dimension: Optional[GoogleCloudDocumentaiV1beta2DocumentPageDimension] = None
    form_fields: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageFormField]] = Field(default=None, description="A list of visually detected form fields on the page.", alias="formFields")
    image: Optional[GoogleCloudDocumentaiV1beta2DocumentPageImage] = None
    image_quality_scores: Optional[GoogleCloudDocumentaiV1beta2DocumentPageImageQualityScores] = Field(default=None, alias="imageQualityScores")
    layout: Optional[GoogleCloudDocumentaiV1beta2DocumentPageLayout] = None
    lines: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageLine]] = Field(default=None, description="A list of visually detected text lines on the page. A collection of tokens that a human would perceive as a line.")
    ...
    paragraphs: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageParagraph]] = Field(default=None, description="A list of visually detected text paragraphs on the page. A collection of lines that a human would perceive as a paragraph.")
    provenance: Optional[GoogleCloudDocumentaiV1beta2DocumentProvenance] = None
    symbols: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageSymbol]] = Field(default=None, description="A list of visually detected symbols on the page.")
    tables: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageTable]] = Field(default=None, description="A list of visually detected tables on the page.")
    tokens: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageToken]] = Field(default=None, description="A list of visually detected tokens on the page.")
    transforms: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageMatrix]] = Field(default=None, description="Transformation matrices that were applied to the original document image to produce Page.image.")
    visual_elements: Optional[List[GoogleCloudDocumentaiV1beta2DocumentPageVisualElement]] = Field(default=None, description="A list of detected non-text visual elements e.g. checkbox, signature etc. on the page.", alias="visualElements")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [GoogleCloudDocumentaiV1beta2DocumentPageBlock.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None,
            "detectedBarcodes": [GoogleCloudDocumentaiV1beta2DocumentPageDetectedBarcode.from_dict(_item) for _item in obj["detectedBarcodes"]] if obj.get("detectedBarcodes") is not None else None,
            "detectedLanguages": [GoogleCloudDocumentaiV1beta2DocumentPageDetectedLanguage.from_dict(_item) for _item in obj["detectedLanguages"]] if obj.get("detectedLanguages") is not None else None,
            "dimension": GoogleCloudDocumentaiV1beta2DocumentPageDimension.from_dict(obj["dimension"]) if obj.get("dimension") is not None else None,
            "formFields": [GoogleCloudDocumentaiV1beta2DocumentPageFormField.from_dict(_item) for _item in obj["formFields"]] if obj.get("formFields") is not None else None,
            "image": GoogleCloudDocumentaiV1beta2DocumentPageImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "imageQualityScores": GoogleCloudDocumentaiV1beta2DocumentPageImageQualityScores.from_dict(obj["imageQualityScores"]) if obj.get("imageQualityScores") is not None else None,
            "layout": GoogleCloudDocumentaiV1beta2DocumentPageLayout.from_dict(obj["layout"]) if obj.get("layout") is not None else None,
            "lines": [GoogleCloudDocumentaiV1beta2DocumentPageLine.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None,
            "pageNumber": obj.get("pageNumber"),
            "paragraphs": [GoogleCloudDocumentaiV1beta2DocumentPageParagraph.from_dict(_item) for _item in obj["paragraphs"]] if obj.get("paragraphs") is not None else None,
            ...
            "symbols": [GoogleCloudDocumentaiV1beta2DocumentPageSymbol.from_dict(_item) for _item in obj["symbols"]] if obj.get("symbols") is not None else None,
            "tables": [GoogleCloudDocumentaiV1beta2DocumentPageTable.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None,
            "tokens": [GoogleCloudDocumentaiV1beta2DocumentPageToken.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
            "transforms": [GoogleCloudDocumentaiV1beta2DocumentPageMatrix.from_dict(_item) for _item in obj["transforms"]] if obj.get("transforms") is not None else None,
            "visualElements": [GoogleCloudDocumentaiV1beta2DocumentPageVisualElement.from_dict(_item) for _item in obj["visualElements"]] if obj.get("visualElements") is not None else None
        })
        return _obj
