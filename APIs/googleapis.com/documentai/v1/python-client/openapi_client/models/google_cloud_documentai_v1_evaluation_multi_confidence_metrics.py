...
class GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics(BaseModel):
    """
    ...
    confidence_level_metrics: Optional[List[GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics]] = Field(default=None, description="Metrics across confidence levels with fuzzy matching enabled.", alias="confidenceLevelMetrics")
    confidence_level_metrics_exact: Optional[List[GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics]] = Field(default=None, description="Metrics across confidence levels with only exact matching.", alias="confidenceLevelMetricsExact")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confidenceLevelMetrics": [GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics.from_dict(_item) for _item in obj["confidenceLevelMetrics"]] if obj.get("confidenceLevelMetrics") is not None else None,
            "confidenceLevelMetricsExact": [GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics.from_dict(_item) for _item in obj["confidenceLevelMetricsExact"]] if obj.get("confidenceLevelMetricsExact") is not None else None,
