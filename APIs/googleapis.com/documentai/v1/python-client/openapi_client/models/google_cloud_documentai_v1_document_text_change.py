...
class GoogleCloudDocumentaiV1DocumentTextChange(BaseModel):
    ...
    provenance: Optional[List[GoogleCloudDocumentaiV1DocumentProvenance]] = Field(default=None, description="The history of this annotation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "provenance": [GoogleCloudDocumentaiV1DocumentProvenance.from_dict(_item) for _item in obj["provenance"]] if obj.get("provenance") is not None else None,
