...
class GoogleCloudDocumentaiV1DocumentProvenance(BaseModel):
    ...
    parents: Optional[List[GoogleCloudDocumentaiV1DocumentProvenanceParent]] = Field(default=None, description="References to the original elements that are replaced.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parents": [GoogleCloudDocumentaiV1DocumentProvenanceParent.from_dict(_item) for _item in obj["parents"]] if obj.get("parents") is not None else None,
