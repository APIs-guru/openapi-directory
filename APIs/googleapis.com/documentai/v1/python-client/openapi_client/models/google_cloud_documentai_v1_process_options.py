...
class GoogleCloudDocumentaiV1ProcessOptions(BaseModel):
    """
    ...
    individual_page_selector: Optional[GoogleCloudDocumentaiV1ProcessOptionsIndividualPageSelector] = Field(default=None, alias="individualPageSelector")
    ocr_config: Optional[GoogleCloudDocumentaiV1OcrConfig] = Field(default=None, alias="ocrConfig")
    schema_override: Optional[GoogleCloudDocumentaiV1DocumentSchema] = Field(default=None, alias="schemaOverride")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "individualPageSelector": GoogleCloudDocumentaiV1ProcessOptionsIndividualPageSelector.from_dict(obj["individualPageSelector"]) if obj.get("individualPageSelector") is not None else None,
            "ocrConfig": GoogleCloudDocumentaiV1OcrConfig.from_dict(obj["ocrConfig"]) if obj.get("ocrConfig") is not None else None,
            "schemaOverride": GoogleCloudDocumentaiV1DocumentSchema.from_dict(obj["schemaOverride"]) if obj.get("schemaOverride") is not None else None
        })
        return _obj
