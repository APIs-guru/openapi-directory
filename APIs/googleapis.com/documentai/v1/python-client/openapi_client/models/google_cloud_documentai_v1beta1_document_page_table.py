...
class GoogleCloudDocumentaiV1beta1DocumentPageTable(BaseModel):
    ...
    """ # noqa: E501
    body_rows: Optional[List[GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow]] = Field(default=None, description="Body rows of the table.", alias="bodyRows")
    ...
    header_rows: Optional[List[GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow]] = Field(default=None, description="Header rows of the table.", alias="headerRows")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bodyRows": [GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow.from_dict(_item) for _item in obj["bodyRows"]] if obj.get("bodyRows") is not None else None,
            ...
            "headerRows": [GoogleCloudDocumentaiV1beta1DocumentPageTableTableRow.from_dict(_item) for _item in obj["headerRows"]] if obj.get("headerRows") is not None else None,
