...
class GoogleCloudDocumentaiV1DocumentPageLayout(BaseModel):
    ...
    """ # noqa: E501
    bounding_poly: Optional[GoogleCloudDocumentaiV1BoundingPoly] = Field(default=None, alias="boundingPoly")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boundingPoly": GoogleCloudDocumentaiV1BoundingPoly.from_dict(obj["boundingPoly"]) if obj.get("boundingPoly") is not None else None,
