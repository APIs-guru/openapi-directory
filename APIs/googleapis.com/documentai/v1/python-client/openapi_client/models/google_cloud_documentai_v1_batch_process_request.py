...
class GoogleCloudDocumentaiV1BatchProcessRequest(BaseModel):
    """
    Request message for BatchProcessDocuments.
    """ # noqa: E501
    document_output_config: Optional[GoogleCloudDocumentaiV1DocumentOutputConfig] = Field(default=None, alias="documentOutputConfig")
    input_documents: Optional[GoogleCloudDocumentaiV1BatchDocumentsInputConfig] = Field(default=None, alias="inputDocuments")
    ...
    __properties: ClassVar[List[str]] = ["documentOutputConfig", "inputDocuments", "labels", "processOptions", "skipHumanReview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentOutputConfig": GoogleCloudDocumentaiV1DocumentOutputConfig.from_dict(obj["documentOutputConfig"]) if obj.get("documentOutputConfig") is not None else None,
            "inputDocuments": GoogleCloudDocumentaiV1BatchDocumentsInputConfig.from_dict(obj["inputDocuments"]) if obj.get("inputDocuments") is not None else None,
