...
class GoogleCloudDocumentaiV1ListProcessorsResponse(BaseModel):
    """
    Response message for the ListProcessors method.
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Points to the next processor, otherwise empty.", alias="nextPageToken")
    processors: Optional[List[GoogleCloudDocumentaiV1Processor]] = Field(default=None, description="The list of processors.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "processors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processors": [GoogleCloudDocumentaiV1Processor.from_dict(_item) for _item in obj["processors"]] if obj.get("processors") is not None else None
        })
        return _obj
