...
class GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadata(BaseModel):
    ...
    import_config_validation_results: Optional[List[GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult]] = Field(default=None, description="Validation statuses of the batch documents import config.", alias="importConfigValidationResults")
    individual_import_statuses: Optional[List[GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataIndividualImportStatus]] = Field(default=None, description="The list of response details of each document.", alias="individualImportStatuses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "importConfigValidationResults": [GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult.from_dict(_item) for _item in obj["importConfigValidationResults"]] if obj.get("importConfigValidationResults") is not None else None,
            "individualImportStatuses": [GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataIndividualImportStatus.from_dict(_item) for _item in obj["individualImportStatuses"]] if obj.get("individualImportStatuses") is not None else None,
