...
class GoogleCloudDocumentaiV1GcsDocuments(BaseModel):
    """
    Specifies a set of documents on Cloud Storage.
    """ # noqa: E501
    documents: Optional[List[GoogleCloudDocumentaiV1GcsDocument]] = Field(default=None, description="The list of documents.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [GoogleCloudDocumentaiV1GcsDocument.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
