...
class GoogleCloudDocumentaiV1beta1Document(BaseModel):
    ...
    entities: Optional[List[GoogleCloudDocumentaiV1beta1DocumentEntity]] = Field(default=None, description="A list of entities detected on Document.text. For document shards, entities in this list may cross shard boundaries.")
    entity_relations: Optional[List[GoogleCloudDocumentaiV1beta1DocumentEntityRelation]] = Field(default=None, description="Placeholder. Relationship among Document.entities.", alias="entityRelations")
    ...
    pages: Optional[List[GoogleCloudDocumentaiV1beta1DocumentPage]] = Field(default=None, description="Visual page layout for the Document.")
    revisions: Optional[List[GoogleCloudDocumentaiV1beta1DocumentRevision]] = Field(default=None, description="Placeholder. Revision history of this document.")
    shard_info: Optional[GoogleCloudDocumentaiV1beta1DocumentShardInfo] = Field(default=None, alias="shardInfo")
    text: Optional[StrictStr] = Field(default=None, description="Optional. UTF-8 encoded text in reading order from the document.")
    text_changes: Optional[List[GoogleCloudDocumentaiV1beta1DocumentTextChange]] = Field(default=None, description="Placeholder. A list of text corrections made to Document.text. This is usually used for annotating corrections to OCR mistakes. Text changes for a given revision may not overlap with each other.", alias="textChanges")
    text_styles: Optional[List[GoogleCloudDocumentaiV1beta1DocumentStyle]] = Field(default=None, description="Styles for the Document.text.", alias="textStyles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": [GoogleCloudDocumentaiV1beta1DocumentEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "entityRelations": [GoogleCloudDocumentaiV1beta1DocumentEntityRelation.from_dict(_item) for _item in obj["entityRelations"]] if obj.get("entityRelations") is not None else None,
            "error": GoogleRpcStatus.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "mimeType": obj.get("mimeType"),
            "pages": [GoogleCloudDocumentaiV1beta1DocumentPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "revisions": [GoogleCloudDocumentaiV1beta1DocumentRevision.from_dict(_item) for _item in obj["revisions"]] if obj.get("revisions") is not None else None,
            "shardInfo": GoogleCloudDocumentaiV1beta1DocumentShardInfo.from_dict(obj["shardInfo"]) if obj.get("shardInfo") is not None else None,
            "text": obj.get("text"),
            "textChanges": [GoogleCloudDocumentaiV1beta1DocumentTextChange.from_dict(_item) for _item in obj["textChanges"]] if obj.get("textChanges") is not None else None,
            "textStyles": [GoogleCloudDocumentaiV1beta1DocumentStyle.from_dict(_item) for _item in obj["textStyles"]] if obj.get("textStyles") is not None else None,
            "uri": obj.get("uri")
        })
        return _obj
