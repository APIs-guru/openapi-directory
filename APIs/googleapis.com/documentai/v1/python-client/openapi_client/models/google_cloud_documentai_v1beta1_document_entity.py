...
class GoogleCloudDocumentaiV1beta1DocumentEntity(BaseModel):
    ...
    normalized_value: Optional[GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue] = Field(default=None, alias="normalizedValue")
    page_anchor: Optional[GoogleCloudDocumentaiV1beta1DocumentPageAnchor] = Field(default=None, alias="pageAnchor")
    properties: Optional[List[GoogleCloudDocumentaiV1beta1DocumentEntity]] = Field(default=None, description="Optional. Entities can be nested to form a hierarchical data structure representing the content in the document.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "normalizedValue": GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue.from_dict(obj["normalizedValue"]) if obj.get("normalizedValue") is not None else None,
            "pageAnchor": GoogleCloudDocumentaiV1beta1DocumentPageAnchor.from_dict(obj["pageAnchor"]) if obj.get("pageAnchor") is not None else None,
            "properties": [GoogleCloudDocumentaiV1beta1DocumentEntity.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
...
GoogleCloudDocumentaiV1beta1DocumentEntity.model_rebuild(raise_errors=False)
