...
class GoogleCloudDocumentaiV1DocumentSchema(BaseModel):
    """
    ...
    entity_types: Optional[List[GoogleCloudDocumentaiV1DocumentSchemaEntityType]] = Field(default=None, description="Entity types of the schema.", alias="entityTypes")
    metadata: Optional[GoogleCloudDocumentaiV1DocumentSchemaMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entityTypes": [GoogleCloudDocumentaiV1DocumentSchemaEntityType.from_dict(_item) for _item in obj["entityTypes"]] if obj.get("entityTypes") is not None else None,
            "metadata": GoogleCloudDocumentaiV1DocumentSchemaMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
