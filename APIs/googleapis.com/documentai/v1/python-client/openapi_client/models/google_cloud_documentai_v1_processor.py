...
class GoogleCloudDocumentaiV1Processor(BaseModel):
    """
    ...
    processor_version_aliases: Optional[List[GoogleCloudDocumentaiV1ProcessorVersionAlias]] = Field(default=None, description="Output only. The processor version aliases.", alias="processorVersionAliases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processorVersionAliases": [GoogleCloudDocumentaiV1ProcessorVersionAlias.from_dict(_item) for _item in obj["processorVersionAliases"]] if obj.get("processorVersionAliases") is not None else None,
            "state": obj.get("state"),
            "type": obj.get("type")
        })
        return _obj
