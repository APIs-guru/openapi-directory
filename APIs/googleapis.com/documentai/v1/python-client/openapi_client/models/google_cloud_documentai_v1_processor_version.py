...
class GoogleCloudDocumentaiV1ProcessorVersion(BaseModel):
    """
    ...
    deprecation_info: Optional[GoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo] = Field(default=None, alias="deprecationInfo")
    ...
    latest_evaluation: Optional[GoogleCloudDocumentaiV1EvaluationReference] = Field(default=None, alias="latestEvaluation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deprecationInfo": GoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo.from_dict(obj["deprecationInfo"]) if obj.get("deprecationInfo") is not None else None,
            ...
            "latestEvaluation": GoogleCloudDocumentaiV1EvaluationReference.from_dict(obj["latestEvaluation"]) if obj.get("latestEvaluation") is not None else None,
