...
class GoogleCloudDocumentaiV1DocumentPageTableTableRow(BaseModel):
    ...
    """ # noqa: E501
    cells: Optional[List[GoogleCloudDocumentaiV1DocumentPageTableTableCell]] = Field(default=None, description="Cells that make up this row.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cells": [GoogleCloudDocumentaiV1DocumentPageTableTableCell.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None
        })
        return _obj
