...
class TestGoogleCloudDocumentaiV1beta2DocumentPageTableTableCell(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell:
        """Test GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell`
        """
        model = GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell()
        if include_optional:
    ...
    def testGoogleCloudDocumentaiV1beta2DocumentPageTableTableCell(self):
        """Test GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell"""
