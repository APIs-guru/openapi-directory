...
class TestGoogleCloudDocumentaiV1beta3DocumentId(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta3DocumentId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta3DocumentId:
        """Test GoogleCloudDocumentaiV1beta3DocumentId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta3DocumentId`
        """
        model = GoogleCloudDocumentaiV1beta3DocumentId()
        if include_optional:
    ...
    def testGoogleCloudDocumentaiV1beta3DocumentId(self):
        """Test GoogleCloudDocumentaiV1beta3DocumentId"""
