...
class TestGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue(unittest.TestCase):
    """GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue:
        """Test GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue`
        """
        model = GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue()
        if include_optional:
    ...
    def testGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue(self):
        """Test GoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue"""
