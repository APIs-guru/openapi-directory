...
class GoogleFirebaseAppdistroV1ListReleasesResponse(BaseModel):
    ...
    releases: Optional[List[GoogleFirebaseAppdistroV1Release]] = Field(default=None, description="The releases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "releases": [GoogleFirebaseAppdistroV1Release.from_dict(_item) for _item in obj["releases"]] if obj.get("releases") is not None else None
        })
        return _obj
