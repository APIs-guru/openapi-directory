...
class GoogleFirebaseAppdistroV1BatchDeleteReleasesRequest(BaseModel):
    ...
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="Required. The names of the release resources to delete. Format: `projects/{project_number}/apps/{app_id}/releases/{release_id}` A maximum of 100 releases can be deleted per request.")
