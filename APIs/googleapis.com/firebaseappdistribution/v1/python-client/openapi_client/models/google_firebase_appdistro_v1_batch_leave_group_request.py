...
class GoogleFirebaseAppdistroV1BatchLeaveGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = Field(default=None, description="Required. The email addresses of the testers to be removed from the group. A maximum of 999 and a minimum of 1 testers can be removed in a batch.")
