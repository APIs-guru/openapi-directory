...
class GoogleFirebaseAppdistroV1BatchAddTestersRequest(BaseModel):
    ...
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = Field(default=None, description="Required. The email addresses of the tester resources to create. A maximum of 999 and a minimum of 1 tester can be created in a batch.")
