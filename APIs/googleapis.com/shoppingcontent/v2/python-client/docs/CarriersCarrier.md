...
------------ | ------------- | ------------- | -------------
**country** | **str** | The CLDR country code of the carrier (e.g., \&quot;US\&quot;). Always present. | [optional] 
...
**name** | **str** | The name of the carrier (e.g., &#x60;\&quot;UPS\&quot;&#x60;). Always present. | [optional] 
**services** | **List[str]** | A list of supported services (e.g., &#x60;\&quot;ground\&quot;&#x60;) for that carrier. Contains at least one service. This is the list of valid values for CarrierRate.carrierService. | [optional] 
