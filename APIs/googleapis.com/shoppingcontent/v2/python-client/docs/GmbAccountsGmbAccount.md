...
------------ | ------------- | ------------- | -------------
**email** | **str** | The email which identifies the GMB account. | [optional] 
**listing_count** | **str** | Number of listings under this account. | [optional] 
**name** | **str** | The name of the GMB account. | [optional] 
**type** | **str** | The type of the GMB account (User or Business). | [optional] 
