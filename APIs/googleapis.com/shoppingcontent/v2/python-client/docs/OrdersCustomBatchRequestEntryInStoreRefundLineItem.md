...
json = "{}"
# create an instance of OrdersCustomBatchRequestEntryInStoreRefundLineItem from a JSON string
orders_custom_batch_request_entry_in_store_refund_line_item_instance = OrdersCustomBatchRequestEntryInStoreRefundLineItem.from_json(json)
# print the JSON string representation of the object
print(OrdersCustomBatchRequestEntryInStoreRefundLineItem.to_json())

# convert the object into a dict
orders_custom_batch_request_entry_in_store_refund_line_item_dict = orders_custom_batch_request_entry_in_store_refund_line_item_instance.to_dict()
# create an instance of OrdersCustomBatchRequestEntryInStoreRefundLineItem from a dict
orders_custom_batch_request_entry_in_store_refund_line_item_from_dict = OrdersCustomBatchRequestEntryInStoreRefundLineItem.from_dict(orders_custom_batch_request_entry_in_store_refund_line_item_dict)
```
