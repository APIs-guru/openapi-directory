...
[**content_orders_custombatch**](OrdersApi.md#content_orders_custombatch) | **POST** /orders/batch | 
...
[**content_orders_refund**](OrdersApi.md#content_orders_refund) | **POST** /{merchantId}/orders/{orderId}/refund | 
...
[**content_orders_returnlineitem**](OrdersApi.md#content_orders_returnlineitem) | **POST** /{merchantId}/orders/{orderId}/returnLineItem | 
...
> OrdersCustomBatchResponse content_orders_custombatch(xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_custom_batch_request=orders_custom_batch_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    orders_custom_batch_request = openapi_client.OrdersCustomBatchRequest() # OrdersCustomBatchRequest |  (optional)

    try:
        api_response = api_instance.content_orders_custombatch(xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_custom_batch_request=orders_custom_batch_request)
        print("The response of OrdersApi->content_orders_custombatch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->content_orders_custombatch: %s\n" % e)
```
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **orders_custom_batch_request** | [**OrdersCustomBatchRequest**](OrdersCustomBatchRequest.md)|  | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    statuses = ['statuses_example'] # List[str] | Obtains orders that match any of the specified statuses. Please note that `active` is a shortcut for `pendingShipment` and `partiallyShipped`, and `completed` is a shortcut for `shipped`, `partiallyDelivered`, `delivered`, `partiallyReturned`, `returned`, and `canceled`. (optional)
 ...
 **statuses** | [**List[str]**](str.md)| Obtains orders that match any of the specified statuses. Please note that &#x60;active&#x60; is a shortcut for &#x60;pendingShipment&#x60; and &#x60;partiallyShipped&#x60;, and &#x60;completed&#x60; is a shortcut for &#x60;shipped&#x60;, &#x60;partiallyDelivered&#x60;, &#x60;delivered&#x60;, &#x60;partiallyReturned&#x60;, &#x60;returned&#x60;, and &#x60;canceled&#x60;. | [optional] 
...
> OrdersRefundResponse content_orders_refund(merchant_id, order_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_refund_request=orders_refund_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    orders_refund_request = openapi_client.OrdersRefundRequest() # OrdersRefundRequest |  (optional)

    try:
        api_response = api_instance.content_orders_refund(merchant_id, order_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_refund_request=orders_refund_request)
        print("The response of OrdersApi->content_orders_refund:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->content_orders_refund: %s\n" % e)
```
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **orders_refund_request** | [**OrdersRefundRequest**](OrdersRefundRequest.md)|  | [optional] 
...
> OrdersReturnLineItemResponse content_orders_returnlineitem(merchant_id, order_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_return_line_item_request=orders_return_line_item_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    orders_return_line_item_request = openapi_client.OrdersReturnLineItemRequest() # OrdersReturnLineItemRequest |  (optional)

    try:
        api_response = api_instance.content_orders_returnlineitem(merchant_id, order_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, orders_return_line_item_request=orders_return_line_item_request)
        print("The response of OrdersApi->content_orders_returnlineitem:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->content_orders_returnlineitem: %s\n" % e)
```
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **orders_return_line_item_request** | [**OrdersReturnLineItemRequest**](OrdersReturnLineItemRequest.md)|  | [optional] 
