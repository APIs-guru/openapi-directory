...
**quantity** | **int** | The quantity to return and refund. Quantity is required. | [optional] 
...
orders_return_refund_line_item_request_instance = OrdersReturnRefundLineItemRequest.from_json(json)
# print the JSON string representation of the object
print(OrdersReturnRefundLineItemRequest.to_json())

# convert the object into a dict
orders_return_refund_line_item_request_dict = orders_return_refund_line_item_request_instance.to_dict()
# create an instance of OrdersReturnRefundLineItemRequest from a dict
orders_return_refund_line_item_request_from_dict = OrdersReturnRefundLineItemRequest.from_dict(orders_return_refund_line_item_request_dict)
```
