...
class OrderinvoicesApi:
    ...
    def content_orderinvoices_createchargeinvoice(
        ...
        orderinvoices_create_charge_invoice_request: Optional[OrderinvoicesCreateChargeInvoiceRequest] = None,
        ...
        :param orderinvoices_create_charge_invoice_request:
        :type orderinvoices_create_charge_invoice_request: OrderinvoicesCreateChargeInvoiceRequest
        ...
        _param = self._content_orderinvoices_createchargeinvoice_serialize(
            ...
            orderinvoices_create_charge_invoice_request=orderinvoices_create_charge_invoice_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderinvoicesCreateChargeInvoiceResponse",
        }
    ...
    @validate_call
    def content_orderinvoices_createchargeinvoice_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        order_id: Annotated[StrictStr, Field(description="The ID of the order.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderinvoicesCreateChargeInvoiceResponse]:
        """content_orderinvoices_createchargeinvoice
    ...
    @validate_call
    def content_orderinvoices_createchargeinvoice_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        order_id: Annotated[StrictStr, Field(description="The ID of the order.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_orderinvoices_createchargeinvoice_serialize(
        self,
        merchant_id,
        order_id,
        xgafv,
        ...
        upload_protocol,
        upload_type,
        orderinvoices_create_charge_invoice_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if orderinvoices_create_charge_invoice_request is not None:
            _body_params = orderinvoices_create_charge_invoice_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/orderinvoices/{orderId}/createChargeInvoice',
    ...
    def content_orderinvoices_createrefundinvoice(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        orderinvoices_create_refund_invoice_request: Optional[OrderinvoicesCreateRefundInvoiceRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param orderinvoices_create_refund_invoice_request:
        :type orderinvoices_create_refund_invoice_request: OrderinvoicesCreateRefundInvoiceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._content_orderinvoices_createrefundinvoice_serialize(
            merchant_id=merchant_id,
            order_id=order_id,
            xgafv=xgafv,
            access_token=access_token,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            orderinvoices_create_refund_invoice_request=orderinvoices_create_refund_invoice_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderinvoicesCreateRefundInvoiceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def content_orderinvoices_createrefundinvoice_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        order_id: Annotated[StrictStr, Field(description="The ID of the order.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderinvoicesCreateRefundInvoiceResponse]:
        """content_orderinvoices_createrefundinvoice
    ...
    @validate_call
    def content_orderinvoices_createrefundinvoice_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The ID of the account that manages the order. This cannot be a multi-client account.")],
        order_id: Annotated[StrictStr, Field(description="The ID of the order.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _content_orderinvoices_createrefundinvoice_serialize(
        self,
        merchant_id,
        order_id,
        xgafv,
        ...
        upload_protocol,
        upload_type,
        orderinvoices_create_refund_invoice_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if orderinvoices_create_refund_invoice_request is not None:
            _body_params = orderinvoices_create_refund_invoice_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{merchantId}/orderinvoices/{orderId}/createRefundInvoice',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
