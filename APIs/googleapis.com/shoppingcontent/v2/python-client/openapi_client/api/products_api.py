...
class ProductsApi:
    ...
    def content_products_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        include_invalid_inserted_items: Annotated[Optional[StrictBool], Field(description="Flag to include the invalid inserted items in the result of the list request. By default the invalid items are not shown (the default value is false).")] = None,
        ...
        _param = self._content_products_list_serialize(
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            include_invalid_inserted_items=include_invalid_inserted_items,
    ...
    def _content_products_list_serialize(
        ...
        if include_invalid_inserted_items is not None:
            
            _query_params.append(('includeInvalidInsertedItems', include_invalid_inserted_items))
