...
class ProductStatus(BaseModel):
    ...
    data_quality_issues: Optional[List[ProductStatusDataQualityIssue]] = Field(default=None, description="DEPRECATED - never populated", alias="dataQualityIssues")
    ...
    __properties: ClassVar[List[str]] = ["creationDate", "dataQualityIssues", "destinationStatuses", "googleExpirationDate", "itemLevelIssues", "kind", "lastUpdateDate", "link", "product", "productId", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataQualityIssues": [ProductStatusDataQualityIssue.from_dict(_item) for _item in obj["dataQualityIssues"]] if obj.get("dataQualityIssues") is not None else None,
