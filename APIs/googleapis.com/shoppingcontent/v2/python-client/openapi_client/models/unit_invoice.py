...
class UnitInvoice(BaseModel):
    ...
    UnitInvoice
    """ # noqa: E501
    additional_charges: Optional[List[UnitInvoiceAdditionalCharge]] = Field(default=None, description="Additional charges for a unit, e.g. shipping costs.", alias="additionalCharges")
    promotions: Optional[List[Promotion]] = Field(default=None, description="Deprecated.")
    unit_price_pretax: Optional[Price] = Field(default=None, alias="unitPricePretax")
    ...
    __properties: ClassVar[List[str]] = ["additionalCharges", "promotions", "unitPricePretax", "unitPriceTaxes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unit_price_pretax
        if self.unit_price_pretax:
            _dict['unitPricePretax'] = self.unit_price_pretax.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitPricePretax": Price.from_dict(obj["unitPricePretax"]) if obj.get("unitPricePretax") is not None else None,
