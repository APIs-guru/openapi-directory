...
class ProductstatusesCustomBatchResponseEntry(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#productstatusesCustomBatchResponseEntry`\"")
    product_status: Optional[ProductStatus] = Field(default=None, alias="productStatus")
    __properties: ClassVar[List[str]] = ["batchId", "errors", "kind", "productStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.product_status:
            _dict['productStatus'] = self.product_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "productStatus": ProductStatus.from_dict(obj["productStatus"]) if obj.get("productStatus") is not None else None
        })
        return _obj
