...
class TestOrderLineItem(BaseModel):
    ...
    unit_tax: Optional[Price] = Field(default=None, alias="unitTax")
    __properties: ClassVar[List[str]] = ["product", "quantityOrdered", "returnInfo", "shippingDetails", "unitTax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unit_tax
        if self.unit_tax:
            _dict['unitTax'] = self.unit_tax.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitTax": Price.from_dict(obj["unitTax"]) if obj.get("unitTax") is not None else None
        })
        return _obj
