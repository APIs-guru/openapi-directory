...
class OrdersCustomBatchResponseEntry(BaseModel):
    ...
    execution_status: Optional[StrictStr] = Field(default=None, description="The status of the execution. Only defined if 1. the request was successful; and 2. the method is not `get`, `getByMerchantOrderId`, or one of the test methods. Acceptable values are: - \"`duplicate`\" - \"`executed`\" ", alias="executionStatus")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"`content#ordersCustomBatchResponseEntry`\"")
    order: Optional[Order] = None
    __properties: ClassVar[List[str]] = ["batchId", "errors", "executionStatus", "kind", "order"]
