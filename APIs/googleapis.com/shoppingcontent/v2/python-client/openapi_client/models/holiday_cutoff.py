...
class HolidayCutoff(BaseModel):
    ...
    HolidayCutoff
    """ # noqa: E501
    deadline_date: Optional[StrictStr] = Field(default=None, description="Date of the order deadline, in ISO 8601 format. E.g. \"2016-11-29\" for 29th November 2016. Required.", alias="deadlineDate")
    ...
    deadline_timezone: Optional[StrictStr] = Field(default=None, description="Timezone identifier for the deadline hour. A list of identifiers can be found in the AdWords API documentation. E.g. \"Europe/Zurich\". Required.", alias="deadlineTimezone")
    holiday_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the holiday. Required.", alias="holidayId")
    visible_from_date: Optional[StrictStr] = Field(default=None, description="Date on which the deadline will become visible to consumers in ISO 8601 format. E.g. \"2016-10-31\" for 31st October 2016. Required.", alias="visibleFromDate")
