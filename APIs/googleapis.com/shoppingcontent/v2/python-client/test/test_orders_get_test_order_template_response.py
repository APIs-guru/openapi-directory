...
class TestOrdersGetTestOrderTemplateResponse(unittest.TestCase):
    """OrdersGetTestOrderTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersGetTestOrderTemplateResponse:
        """Test OrdersGetTestOrderTemplateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersGetTestOrderTemplateResponse`
        """
        model = OrdersGetTestOrderTemplateResponse()
        if include_optional:
            return OrdersGetTestOrderTemplateResponse(
                kind = '',
                template = openapi_client.models.test_order.TestOrder(
    ...
    def testOrdersGetTestOrderTemplateResponse(self):
        """Test OrdersGetTestOrderTemplateResponse"""
