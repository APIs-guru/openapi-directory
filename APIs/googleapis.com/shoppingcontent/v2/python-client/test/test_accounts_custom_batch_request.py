...
class TestAccountsCustomBatchRequest(unittest.TestCase):
    """AccountsCustomBatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountsCustomBatchRequest:
        """Test AccountsCustomBatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountsCustomBatchRequest`
        """
        model = AccountsCustomBatchRequest()
        if include_optional:
            return AccountsCustomBatchRequest(
                entries = [
                    openapi_client.models.accounts_custom_batch_request_entry.AccountsCustomBatchRequestEntry(
                        ...
                        link_request = openapi_client.models.accounts_custom_batch_request_entry_link_request.AccountsCustomBatchRequestEntryLinkRequest(
                            action = '', 
                            link_type = '', 
                            linked_account_id = '', ), 
                        merchant_id = '', 
    ...
    def testAccountsCustomBatchRequest(self):
        """Test AccountsCustomBatchRequest"""
