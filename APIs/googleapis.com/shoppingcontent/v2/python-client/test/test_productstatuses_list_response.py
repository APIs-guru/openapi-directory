...
class TestProductstatusesListResponse(unittest.TestCase):
    """ProductstatusesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductstatusesListResponse:
        """Test ProductstatusesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductstatusesListResponse`
        """
        model = ProductstatusesListResponse()
        if include_optional:
            return ProductstatusesListResponse(
                kind = '',
                next_page_token = '',
                resources = [
                    openapi_client.models.product_status.ProductStatus(
                        creation_date = '', 
                        data_quality_issues = [
                            openapi_client.models.product_status_data_quality_issue.ProductStatusDataQualityIssue(
                                destination = '', 
                                detail = '', 
                                fetch_status = '', 
                                id = '', 
    ...
    def testProductstatusesListResponse(self):
        """Test ProductstatusesListResponse"""
