...
class TestLiasettingsListResponse(unittest.TestCase):
    """LiasettingsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiasettingsListResponse:
        """Test LiasettingsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiasettingsListResponse`
        """
        model = LiasettingsListResponse()
        if include_optional:
            return LiasettingsListResponse(
                kind = '',
                next_page_token = '',
                resources = [
                    openapi_client.models.lia_settings.LiaSettings(
                        account_id = '', 
                        country_settings = [
    ...
    def testLiasettingsListResponse(self):
        """Test LiasettingsListResponse"""
