...
class TestShippingsettingsCustomBatchRequest(unittest.TestCase):
    """ShippingsettingsCustomBatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingsettingsCustomBatchRequest:
        """Test ShippingsettingsCustomBatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingsettingsCustomBatchRequest`
        """
        model = ShippingsettingsCustomBatchRequest()
        if include_optional:
            return ShippingsettingsCustomBatchRequest(
                entries = [
                    openapi_client.models.shippingsettings_custom_batch_request_entry.ShippingsettingsCustomBatchRequestEntry(
                        account_id = '', 
                        batch_id = 56, 
                        merchant_id = '', 
                        method = '', 
                        shipping_settings = openapi_client.models.shipping_settings.ShippingSettings(
                            account_id = '', 
                            postal_code_groups = [
    ...
    def testShippingsettingsCustomBatchRequest(self):
        """Test ShippingsettingsCustomBatchRequest"""
