...
class TestOrdersCustomBatchResponseEntry(unittest.TestCase):
    """OrdersCustomBatchResponseEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersCustomBatchResponseEntry:
        """Test OrdersCustomBatchResponseEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersCustomBatchResponseEntry`
        """
        model = OrdersCustomBatchResponseEntry()
        if include_optional:
    ...
    def testOrdersCustomBatchResponseEntry(self):
        """Test OrdersCustomBatchResponseEntry"""
