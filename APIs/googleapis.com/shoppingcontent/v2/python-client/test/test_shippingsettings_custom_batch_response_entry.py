...
class TestShippingsettingsCustomBatchResponseEntry(unittest.TestCase):
    """ShippingsettingsCustomBatchResponseEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingsettingsCustomBatchResponseEntry:
        """Test ShippingsettingsCustomBatchResponseEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingsettingsCustomBatchResponseEntry`
        """
        model = ShippingsettingsCustomBatchResponseEntry()
        if include_optional:
    ...
    def testShippingsettingsCustomBatchResponseEntry(self):
        """Test ShippingsettingsCustomBatchResponseEntry"""
