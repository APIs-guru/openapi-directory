...
class TestLiasettingsCustomBatchResponseEntry(unittest.TestCase):
    """LiasettingsCustomBatchResponseEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiasettingsCustomBatchResponseEntry:
        """Test LiasettingsCustomBatchResponseEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiasettingsCustomBatchResponseEntry`
        """
        model = LiasettingsCustomBatchResponseEntry()
        if include_optional:
    ...
    def testLiasettingsCustomBatchResponseEntry(self):
        """Test LiasettingsCustomBatchResponseEntry"""
