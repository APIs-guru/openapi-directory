...
class TestShippingsettingsCustomBatchRequestEntry(unittest.TestCase):
    """ShippingsettingsCustomBatchRequestEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingsettingsCustomBatchRequestEntry:
        """Test ShippingsettingsCustomBatchRequestEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingsettingsCustomBatchRequestEntry`
        """
        model = ShippingsettingsCustomBatchRequestEntry()
        if include_optional:
    ...
    def testShippingsettingsCustomBatchRequestEntry(self):
        """Test ShippingsettingsCustomBatchRequestEntry"""
