...
class TestAccountsCustomBatchResponseEntry(unittest.TestCase):
    """AccountsCustomBatchResponseEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountsCustomBatchResponseEntry:
        """Test AccountsCustomBatchResponseEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountsCustomBatchResponseEntry`
        """
        model = AccountsCustomBatchResponseEntry()
        if include_optional:
    ...
    def testAccountsCustomBatchResponseEntry(self):
        """Test AccountsCustomBatchResponseEntry"""
