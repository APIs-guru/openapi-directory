...
class WorkspacesApi:
    ...
    def area120tables_workspaces_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the workspace to retrieve. Format: workspaces/{workspace}")],
        ...
        _param = self._area120tables_workspaces_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def area120tables_workspaces_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the workspace to retrieve. Format: workspaces/{workspace}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def area120tables_workspaces_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the workspace to retrieve. Format: workspaces/{workspace}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _area120tables_workspaces_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def area120tables_workspaces_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of workspaces to return. The service may return fewer than this value. If unspecified, at most 10 workspaces are returned. The maximum value is 25; values above 25 are coerced to 25.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A page token, received from a previous `ListWorkspaces` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListWorkspaces` must match the call that provided the page token.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._area120tables_workspaces_list_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def area120tables_workspaces_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def area120tables_workspaces_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _area120tables_workspaces_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1alpha1/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
