...
class BatchCreateRowsRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[CreateRowRequest]] = Field(default=None, description="Required. The request message specifying the rows to create. A maximum of 500 rows can be created in a single batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreateRowRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
