...
class BatchUpdateRowsRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[UpdateRowRequest]] = Field(default=None, description="Required. The request messages specifying the rows to update. A maximum of 500 rows can be modified in a single batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateRowRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
