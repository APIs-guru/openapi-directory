...
class TestListDeviceRegistriesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListDeviceRegistriesResponse:
        ...
        """
        model = ListDeviceRegistriesResponse()
        if include_optional:
            return ListDeviceRegistriesResponse(
                device_registries = [
                    openapi_client.models.device_registry.DeviceRegistry(
                        credentials = [
