...
class RegistryCredential(BaseModel):
    ...
    """ # noqa: E501
    public_key_certificate: Optional[PublicKeyCertificate] = Field(default=None, alias="publicKeyCertificate")
    __properties: ClassVar[List[str]] = ["publicKeyCertificate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicKeyCertificate": PublicKeyCertificate.from_dict(obj["publicKeyCertificate"]) if obj.get("publicKeyCertificate") is not None else None
        })
        return _obj
