...
class ListDevicesResponse(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[Device]] = Field(default=None, description="The devices that match the request.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="If not empty, indicates that there may be more devices that match the request; this value should be passed in a new `ListDevicesRequest`.", alias="nextPageToken")
