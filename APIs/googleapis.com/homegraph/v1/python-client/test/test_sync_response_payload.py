...
class TestSyncResponsePayload(unittest.TestCase):
    """SyncResponsePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncResponsePayload:
        """Test SyncResponsePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncResponsePayload`
        """
        model = SyncResponsePayload()
        if include_optional:
    ...
    def testSyncResponsePayload(self):
        """Test SyncResponsePayload"""
