...
class AgentUsersApi:
    ...
    def homegraph_agent_users_delete(
        self,
        agent_user_id: Annotated[StrictStr, Field(description="Required. Third-party user ID.")],
        ...
        request_id: Annotated[Optional[StrictStr], Field(description="Request ID used for debugging.")] = None,
        ...
        :param agent_user_id: Required. Third-party user ID. (required)
        ...
        _param = self._homegraph_agent_users_delete_serialize(
    ...
    @validate_call
    def homegraph_agent_users_delete_with_http_info(
        self,
        agent_user_id: Annotated[StrictStr, Field(description="Required. Third-party user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def homegraph_agent_users_delete_without_preload_content(
        self,
        agent_user_id: Annotated[StrictStr, Field(description="Required. Third-party user ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _homegraph_agent_users_delete_serialize(
        self,
        agent_user_id,
        xgafv,
        access_token,
        ...
        if agent_user_id is not None:
            _path_params['agentUserId'] = agent_user_id
