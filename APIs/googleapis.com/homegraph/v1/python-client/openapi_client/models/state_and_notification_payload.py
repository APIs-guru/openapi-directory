...
class StateAndNotificationPayload(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[ReportStateAndNotificationDevice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": ReportStateAndNotificationDevice.from_dict(obj["devices"]) if obj.get("devices") is not None else None
        })
        return _obj
