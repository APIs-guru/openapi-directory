...
class SyncResponsePayload(BaseModel):
    ...
    """ # noqa: E501
    agent_user_id: Optional[StrictStr] = Field(default=None, description="Third-party user ID", alias="agentUserId")
    devices: Optional[List[Device]] = Field(default=None, description="Devices associated with the third-party user.")
    __properties: ClassVar[List[str]] = ["agentUserId", "devices"]
