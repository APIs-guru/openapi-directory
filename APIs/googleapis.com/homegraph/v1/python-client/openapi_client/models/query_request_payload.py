...
class QueryRequestPayload(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[List[AgentDeviceId]] = Field(default=None, description="Third-party device IDs for which to get the device states.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [AgentDeviceId.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
