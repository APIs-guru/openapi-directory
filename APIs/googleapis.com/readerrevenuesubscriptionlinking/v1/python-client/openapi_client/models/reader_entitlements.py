...
class ReaderEntitlements(BaseModel):
    ...
    """ # noqa: E501
    entitlements: Optional[List[Entitlement]] = Field(default=None, description="All of the entitlements for a publication reader.")
    name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the singleton.")
    __properties: ClassVar[List[str]] = ["entitlements", "name"]
