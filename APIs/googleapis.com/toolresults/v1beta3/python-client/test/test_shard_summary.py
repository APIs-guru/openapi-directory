...
class TestShardSummary(unittest.TestCase):
    """ShardSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShardSummary:
        """Test ShardSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShardSummary`
        """
        model = ShardSummary()
        if include_optional:
            return ShardSummary(
