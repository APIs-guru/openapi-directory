...
class TestMergedResult(unittest.TestCase):
    """MergedResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergedResult:
        """Test MergedResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergedResult`
        """
        model = MergedResult()
        if include_optional:
            return MergedResult(
