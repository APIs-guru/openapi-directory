...
class TestPerfSampleSeries(unittest.TestCase):
    """PerfSampleSeries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerfSampleSeries:
        """Test PerfSampleSeries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerfSampleSeries`
        """
        model = PerfSampleSeries()
        if include_optional:
