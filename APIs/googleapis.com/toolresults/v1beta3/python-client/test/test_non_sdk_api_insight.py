...
class TestNonSdkApiInsight(unittest.TestCase):
    """NonSdkApiInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonSdkApiInsight:
        """Test NonSdkApiInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonSdkApiInsight`
        """
        model = NonSdkApiInsight()
        if include_optional:
