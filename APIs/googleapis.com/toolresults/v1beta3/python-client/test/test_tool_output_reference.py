...
class TestToolOutputReference(unittest.TestCase):
    """ToolOutputReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolOutputReference:
        """Test ToolOutputReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolOutputReference`
        """
        model = ToolOutputReference()
        if include_optional:
    ...
    def testToolOutputReference(self):
        """Test ToolOutputReference"""
