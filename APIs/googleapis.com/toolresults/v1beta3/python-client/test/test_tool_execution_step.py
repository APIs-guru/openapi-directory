...
class TestToolExecutionStep(unittest.TestCase):
    """ToolExecutionStep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolExecutionStep:
        """Test ToolExecutionStep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolExecutionStep`
        """
    ...
    def testToolExecutionStep(self):
        """Test ToolExecutionStep"""
