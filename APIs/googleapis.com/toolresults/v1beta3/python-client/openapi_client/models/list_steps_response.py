...
class ListStepsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A continuation token to resume the query at the next item. If set, indicates that there are more steps to read, by calling list again with this value in the page_token field.", alias="nextPageToken")
    steps: Optional[List[Step]] = Field(default=None, description="Steps.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "steps"]
