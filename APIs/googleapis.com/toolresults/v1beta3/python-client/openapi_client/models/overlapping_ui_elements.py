...
class OverlappingUIElements(BaseModel):
    ...
    """ # noqa: E501
    resource_name: Optional[List[StrictStr]] = Field(default=None, description="Resource names of the overlapping screen elements", alias="resourceName")
    screen_id: Optional[StrictStr] = Field(default=None, description="The screen id of the elements", alias="screenId")
    __properties: ClassVar[List[str]] = ["resourceName", "screenId"]
