...
class PerfEnvironment(BaseModel):
    ...
    """ # noqa: E501
    cpu_info: Optional[CPUInfo] = Field(default=None, alias="cpuInfo")
    memory_info: Optional[MemoryInfo] = Field(default=None, alias="memoryInfo")
    __properties: ClassVar[List[str]] = ["cpuInfo", "memoryInfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cpu_info:
            _dict['cpuInfo'] = self.cpu_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cpuInfo": CPUInfo.from_dict(obj["cpuInfo"]) if obj.get("cpuInfo") is not None else None,
