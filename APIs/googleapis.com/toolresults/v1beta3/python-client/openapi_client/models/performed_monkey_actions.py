...
class PerformedMonkeyActions(BaseModel):
    ...
    """ # noqa: E501
    total_actions: Optional[StrictInt] = Field(default=None, description="The total number of monkey actions performed during the crawl.", alias="totalActions")
    __properties: ClassVar[List[str]] = ["totalActions"]
