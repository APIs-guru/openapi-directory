...
class PendingGoogleUpdateInsight(BaseModel):
    ...
    """ # noqa: E501
    name_of_google_library: Optional[StrictStr] = Field(default=None, description="The name of the Google-provided library with the non-SDK API dependency.", alias="nameOfGoogleLibrary")
    __properties: ClassVar[List[str]] = ["nameOfGoogleLibrary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nameOfGoogleLibrary": obj.get("nameOfGoogleLibrary")
        })
        return _obj
