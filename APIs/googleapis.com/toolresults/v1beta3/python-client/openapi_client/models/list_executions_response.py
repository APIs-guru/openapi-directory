...
class ListExecutionsResponse(BaseModel):
    ...
    """ # noqa: E501
    executions: Optional[List[Execution]] = Field(default=None, description="Executions. Always set.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A continuation token to resume the query at the next item. Will only be set if there are more Executions to fetch.", alias="nextPageToken")
