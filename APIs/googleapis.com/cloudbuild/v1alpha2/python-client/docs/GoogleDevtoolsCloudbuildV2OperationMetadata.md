...
google_devtools_cloudbuild_v2_operation_metadata_instance = GoogleDevtoolsCloudbuildV2OperationMetadata.from_json(json)
# print the JSON string representation of the object
print(GoogleDevtoolsCloudbuildV2OperationMetadata.to_json())

# convert the object into a dict
google_devtools_cloudbuild_v2_operation_metadata_dict = google_devtools_cloudbuild_v2_operation_metadata_instance.to_dict()
# create an instance of GoogleDevtoolsCloudbuildV2OperationMetadata from a dict
google_devtools_cloudbuild_v2_operation_metadata_from_dict = GoogleDevtoolsCloudbuildV2OperationMetadata.from_dict(google_devtools_cloudbuild_v2_operation_metadata_dict)
```
