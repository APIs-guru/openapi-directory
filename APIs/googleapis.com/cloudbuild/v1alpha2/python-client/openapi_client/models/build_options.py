...
class BuildOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["diskSizeGb", "dynamicSubstitutions", "env", "logStreamingOption", "logging", "machineType", "pool", "requestedVerifyOption", "secretEnv", "sourceProvenanceHash", "substitutionOption", "volumes", "workerPool"]
    ...
    def source_provenance_hash_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['NONE', 'SHA256', 'MD5']):
                raise ValueError("each list item must be one of ('NONE', 'SHA256', 'MD5')")
        return value
