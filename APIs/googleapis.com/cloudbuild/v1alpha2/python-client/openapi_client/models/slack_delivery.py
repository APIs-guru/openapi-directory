...
class SlackDelivery(BaseModel):
    ...
    """ # noqa: E501
    webhook_uri: Optional[NotifierSecretRef] = Field(default=None, alias="webhookUri")
    __properties: ClassVar[List[str]] = ["webhookUri"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of webhook_uri
        if self.webhook_uri:
            _dict['webhookUri'] = self.webhook_uri.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhookUri": NotifierSecretRef.from_dict(obj["webhookUri"]) if obj.get("webhookUri") is not None else None
        })
        return _obj
