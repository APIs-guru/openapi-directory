...
------------ | ------------- | ------------- | -------------
*ProjectsApi* | [**cloudbuild_projects_locations_operations_cancel**](docs/ProjectsApi.md#cloudbuild_projects_locations_operations_cancel) | **POST** /v1alpha2/{name}:cancel | 
*ProjectsApi* | [**cloudbuild_projects_worker_pools_create**](docs/ProjectsApi.md#cloudbuild_projects_worker_pools_create) | **POST** /v1alpha2/{parent}/workerPools | 
*ProjectsApi* | [**cloudbuild_projects_worker_pools_delete**](docs/ProjectsApi.md#cloudbuild_projects_worker_pools_delete) | **DELETE** /v1alpha2/{name} | 
*ProjectsApi* | [**cloudbuild_projects_worker_pools_get**](docs/ProjectsApi.md#cloudbuild_projects_worker_pools_get) | **GET** /v1alpha2/{name} | 
*ProjectsApi* | [**cloudbuild_projects_worker_pools_list**](docs/ProjectsApi.md#cloudbuild_projects_worker_pools_list) | **GET** /v1alpha2/{parent}/workerPools | 
*ProjectsApi* | [**cloudbuild_projects_worker_pools_patch**](docs/ProjectsApi.md#cloudbuild_projects_worker_pools_patch) | **PATCH** /v1alpha2/{name} | 
