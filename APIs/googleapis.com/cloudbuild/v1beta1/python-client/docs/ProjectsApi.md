...
------------- | ------------- | -------------
[**cloudbuild_projects_locations_operations_cancel**](ProjectsApi.md#cloudbuild_projects_locations_operations_cancel) | **POST** /v1beta1/{name}:cancel | 
[**cloudbuild_projects_locations_worker_pools_create**](ProjectsApi.md#cloudbuild_projects_locations_worker_pools_create) | **POST** /v1beta1/{parent}/workerPools | 
[**cloudbuild_projects_locations_worker_pools_delete**](ProjectsApi.md#cloudbuild_projects_locations_worker_pools_delete) | **DELETE** /v1beta1/{name} | 
[**cloudbuild_projects_locations_worker_pools_get**](ProjectsApi.md#cloudbuild_projects_locations_worker_pools_get) | **GET** /v1beta1/{name} | 
[**cloudbuild_projects_locations_worker_pools_list**](ProjectsApi.md#cloudbuild_projects_locations_worker_pools_list) | **GET** /v1beta1/{parent}/workerPools | 
[**cloudbuild_projects_locations_worker_pools_patch**](ProjectsApi.md#cloudbuild_projects_locations_worker_pools_patch) | **PATCH** /v1beta1/{name} | 
...
> Operation cloudbuild_projects_locations_worker_pools_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, worker_pool_id=worker_pool_id, worker_pool=worker_pool)
...
> Operation cloudbuild_projects_locations_worker_pools_delete(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, etag=etag)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    name = 'name_example' # str | Required. The name of the `WorkerPool` to delete. Format: `projects/{project}/locations/{workerPool}/workerPools/{workerPool}`.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    etag = 'etag_example' # str | Optional. If this is provided, it must match the server's etag on the workerpool for the request to be processed. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **str**| Required. The name of the &#x60;WorkerPool&#x60; to delete. Format: &#x60;projects/{project}/locations/{workerPool}/workerPools/{workerPool}&#x60;. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **etag** | **str**| Optional. If this is provided, it must match the server&#39;s etag on the workerpool for the request to be processed. | [optional] 
...
> WorkerPool cloudbuild_projects_locations_worker_pools_get(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    update_mask = 'update_mask_example' # str | A mask specifying which fields in `WorkerPool` to update. (optional)
    worker_pool = openapi_client.WorkerPool() # WorkerPool |  (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **update_mask** | **str**| A mask specifying which fields in &#x60;WorkerPool&#x60; to update. | [optional] 
 **worker_pool** | [**WorkerPool**](WorkerPool.md)|  | [optional] 
