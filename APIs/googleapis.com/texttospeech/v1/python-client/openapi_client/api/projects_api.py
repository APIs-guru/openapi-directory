...
class ProjectsApi:
    ...
    def texttospeech_projects_locations_operations_get(
        ...
        _param = self._texttospeech_projects_locations_operations_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def texttospeech_projects_locations_operations_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def texttospeech_projects_locations_operations_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _texttospeech_projects_locations_operations_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def texttospeech_projects_locations_operations_list(
        ...
        _param = self._texttospeech_projects_locations_operations_list_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def texttospeech_projects_locations_operations_list_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def texttospeech_projects_locations_operations_list_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _texttospeech_projects_locations_operations_list_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def texttospeech_projects_locations_synthesize_long_audio(
        self,
        parent: Annotated[StrictStr, Field(description="The resource states of the request in the form of `projects/*/locations/*`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        synthesize_long_audio_request: Optional[SynthesizeLongAudioRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param parent: The resource states of the request in the form of `projects/*/locations/*`. (required)
        :type parent: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param synthesize_long_audio_request:
        :type synthesize_long_audio_request: SynthesizeLongAudioRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._texttospeech_projects_locations_synthesize_long_audio_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            synthesize_long_audio_request=synthesize_long_audio_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def texttospeech_projects_locations_synthesize_long_audio_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="The resource states of the request in the form of `projects/*/locations/*`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def texttospeech_projects_locations_synthesize_long_audio_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="The resource states of the request in the form of `projects/*/locations/*`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _texttospeech_projects_locations_synthesize_long_audio_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if synthesize_long_audio_request is not None:
            _body_params = synthesize_long_audio_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{parent}:synthesizeLongAudio',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
