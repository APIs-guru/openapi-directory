...
class AudioConfig(BaseModel):
    ...
    def audio_encoding_validate_enum(cls, value):
        ...
        if value not in set(['AUDIO_ENCODING_UNSPECIFIED', 'LINEAR16', 'MP3', 'OGG_OPUS', 'MULAW', 'ALAW']):
            raise ValueError("must be one of enum values ('AUDIO_ENCODING_UNSPECIFIED', 'LINEAR16', 'MP3', 'OGG_OPUS', 'MULAW', 'ALAW')")
        return value
