...
class TestSynthesizeLongAudioRequest(unittest.TestCase):
    """SynthesizeLongAudioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SynthesizeLongAudioRequest:
        """Test SynthesizeLongAudioRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SynthesizeLongAudioRequest`
        """
        model = SynthesizeLongAudioRequest()
        if include_optional:
    ...
    def testSynthesizeLongAudioRequest(self):
        """Test SynthesizeLongAudioRequest"""
