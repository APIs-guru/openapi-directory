...
class SynthesizeLongAudioRequest(BaseModel):
    ...
    output_gcs_uri: Optional[StrictStr] = Field(default=None, description="Required. Specifies a Cloud Storage URI for the synthesis results. Must be specified in the format: `gs://bucket_name/object_name`, and the bucket must already exist.", alias="outputGcsUri")
    voice: Optional[VoiceSelectionParams] = None
    __properties: ClassVar[List[str]] = ["audioConfig", "input", "outputGcsUri", "voice"]
