...
class VSphereScan(BaseModel):
    """
    Message describing a MC Source of type VSphere Scan.
    """ # noqa: E501
    core_source: Optional[StrictStr] = Field(default=None, description="reference to the corresponding VSphere Scan in MC Source.", alias="coreSource")
    __properties: ClassVar[List[str]] = ["coreSource"]
