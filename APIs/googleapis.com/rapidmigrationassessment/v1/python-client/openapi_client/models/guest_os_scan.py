...
class GuestOsScan(BaseModel):
    """
    Message describing a MC Source of type Guest OS Scan.
    """ # noqa: E501
    core_source: Optional[StrictStr] = Field(default=None, description="reference to the corresponding Guest OS Scan in MC Source.", alias="coreSource")
