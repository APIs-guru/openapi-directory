...
class ListQueriesResponse(BaseModel):
    ...
    ListQueriesResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token, which can be sent as page_token to retrieve the next page of queries. If this field is omitted, there are no subsequent pages.", alias="nextPageToken")
    queries: Optional[List[Query]] = Field(default=None, description="The list of queries.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "queries"]
