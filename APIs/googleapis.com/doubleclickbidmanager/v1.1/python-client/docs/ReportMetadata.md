...
------------ | ------------- | ------------- | -------------
**google_cloud_storage_path** | **str** | The path to the location in Google Cloud Storage where the report is stored. | [optional] 
**report_data_end_time_ms** | **str** | The ending time for the data that is shown in the report. | [optional] 
**report_data_start_time_ms** | **str** | The starting time for the data that is shown in the report. | [optional] 
