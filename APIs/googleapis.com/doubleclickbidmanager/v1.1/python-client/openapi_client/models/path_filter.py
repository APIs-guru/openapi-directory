...
class PathFilter(BaseModel):
    ...
    path_match_position: Optional[StrictStr] = Field(default=None, description="Indicates the position of the path the filter should match to (first, last, or any event in path).", alias="pathMatchPosition")
