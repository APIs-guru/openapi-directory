...
class PathQueryOptionsFilter(BaseModel):
    ...
    match: Optional[StrictStr] = Field(default=None, description="Indicates how the filter should be matched to the value.")
    values: Optional[List[StrictStr]] = Field(default=None, description="Value to filter on.")
