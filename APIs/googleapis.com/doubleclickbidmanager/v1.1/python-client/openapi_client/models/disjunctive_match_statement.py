...
class DisjunctiveMatchStatement(BaseModel):
    ...
    """ # noqa: E501
    event_filters: Optional[List[EventFilter]] = Field(default=None, description="Filters. There is a limit of 100 filters that can be set per disjunctive match statement.", alias="eventFilters")
    __properties: ClassVar[List[str]] = ["eventFilters"]
