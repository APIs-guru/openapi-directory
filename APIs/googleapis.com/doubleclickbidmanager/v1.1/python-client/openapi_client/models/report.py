...
class Report(BaseModel):
    ...
    Represents a report.
    """ # noqa: E501
    key: Optional[ReportKey] = None
    metadata: Optional[ReportMetadata] = None
    params: Optional[Parameters] = None
    __properties: ClassVar[List[str]] = ["key", "metadata", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": ReportKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "metadata": ReportMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
