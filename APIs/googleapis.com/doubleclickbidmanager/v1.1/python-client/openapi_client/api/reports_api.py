...
class ReportsApi:
    ...
    def doubleclickbidmanager_reports_listreports(
        self,
        query_id: Annotated[StrictStr, Field(description="Query ID with which the reports are associated.")],
        ...
        :param query_id: Query ID with which the reports are associated. (required)
        :type query_id: str
        ...
        _param = self._doubleclickbidmanager_reports_listreports_serialize(
            query_id=query_id,
            xgafv=xgafv,
    ...
    @validate_call
    def doubleclickbidmanager_reports_listreports_with_http_info(
        self,
        query_id: Annotated[StrictStr, Field(description="Query ID with which the reports are associated.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def doubleclickbidmanager_reports_listreports_without_preload_content(
        self,
        query_id: Annotated[StrictStr, Field(description="Query ID with which the reports are associated.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _doubleclickbidmanager_reports_listreports_serialize(
        self,
        query_id,
        xgafv,
        access_token,
