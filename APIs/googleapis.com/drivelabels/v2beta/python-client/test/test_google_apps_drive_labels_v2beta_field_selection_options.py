...
class TestGoogleAppsDriveLabelsV2betaFieldSelectionOptions(unittest.TestCase):
    """GoogleAppsDriveLabelsV2betaFieldSelectionOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAppsDriveLabelsV2betaFieldSelectionOptions:
        """Test GoogleAppsDriveLabelsV2betaFieldSelectionOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAppsDriveLabelsV2betaFieldSelectionOptions`
        """
        model = GoogleAppsDriveLabelsV2betaFieldSelectionOptions()
        if include_optional:
    ...
    def testGoogleAppsDriveLabelsV2betaFieldSelectionOptions(self):
        """Test GoogleAppsDriveLabelsV2betaFieldSelectionOptions"""
