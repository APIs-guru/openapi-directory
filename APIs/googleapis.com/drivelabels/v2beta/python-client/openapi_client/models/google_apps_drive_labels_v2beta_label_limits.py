...
class GoogleAppsDriveLabelsV2betaLabelLimits(BaseModel):
    ...
    """ # noqa: E501
    field_limits: Optional[GoogleAppsDriveLabelsV2betaFieldLimits] = Field(default=None, alias="fieldLimits")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fieldLimits": GoogleAppsDriveLabelsV2betaFieldLimits.from_dict(obj["fieldLimits"]) if obj.get("fieldLimits") is not None else None,
