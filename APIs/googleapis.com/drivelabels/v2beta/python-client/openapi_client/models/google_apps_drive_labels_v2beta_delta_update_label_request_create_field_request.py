...
class GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestCreateFieldRequest(BaseModel):
    ...
    """ # noqa: E501
    var_field: Optional[GoogleAppsDriveLabelsV2betaField] = Field(default=None, alias="field")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": GoogleAppsDriveLabelsV2betaField.from_dict(obj["field"]) if obj.get("field") is not None else None
        })
        return _obj
