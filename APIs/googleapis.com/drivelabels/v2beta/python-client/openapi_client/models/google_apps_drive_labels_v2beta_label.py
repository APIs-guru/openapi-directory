...
class GoogleAppsDriveLabelsV2betaLabel(BaseModel):
    ...
    """ # noqa: E501
    applied_capabilities: Optional[GoogleAppsDriveLabelsV2betaLabelAppliedCapabilities] = Field(default=None, alias="appliedCapabilities")
    applied_label_policy: Optional[GoogleAppsDriveLabelsV2betaLabelAppliedLabelPolicy] = Field(default=None, alias="appliedLabelPolicy")
    ...
    display_hints: Optional[GoogleAppsDriveLabelsV2betaLabelDisplayHints] = Field(default=None, alias="displayHints")
    fields: Optional[List[GoogleAppsDriveLabelsV2betaField]] = Field(default=None, description="List of fields in descending priority order.")
    ...
    properties: Optional[GoogleAppsDriveLabelsV2betaLabelProperties] = None
    ...
    revision_creator: Optional[GoogleAppsDriveLabelsV2betaUserInfo] = Field(default=None, alias="revisionCreator")
    ...
    schema_capabilities: Optional[GoogleAppsDriveLabelsV2betaLabelSchemaCapabilities] = Field(default=None, alias="schemaCapabilities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appliedCapabilities": GoogleAppsDriveLabelsV2betaLabelAppliedCapabilities.from_dict(obj["appliedCapabilities"]) if obj.get("appliedCapabilities") is not None else None,
            "appliedLabelPolicy": GoogleAppsDriveLabelsV2betaLabelAppliedLabelPolicy.from_dict(obj["appliedLabelPolicy"]) if obj.get("appliedLabelPolicy") is not None else None,
            ...
            "displayHints": GoogleAppsDriveLabelsV2betaLabelDisplayHints.from_dict(obj["displayHints"]) if obj.get("displayHints") is not None else None,
            "fields": [GoogleAppsDriveLabelsV2betaField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "id": obj.get("id"),
            ...
            "name": obj.get("name"),
            "properties": GoogleAppsDriveLabelsV2betaLabelProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            ...
            "revisionCreator": GoogleAppsDriveLabelsV2betaUserInfo.from_dict(obj["revisionCreator"]) if obj.get("revisionCreator") is not None else None,
            "revisionId": obj.get("revisionId"),
            "schemaCapabilities": GoogleAppsDriveLabelsV2betaLabelSchemaCapabilities.from_dict(obj["schemaCapabilities"]) if obj.get("schemaCapabilities") is not None else None
        })
        return _obj
