...
class GoogleAppsDriveLabelsV2betaBatchUpdateLabelPermissionsResponse(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[GoogleAppsDriveLabelsV2betaLabelPermission]] = Field(default=None, description="Required. Permissions updated.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [GoogleAppsDriveLabelsV2betaLabelPermission.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
