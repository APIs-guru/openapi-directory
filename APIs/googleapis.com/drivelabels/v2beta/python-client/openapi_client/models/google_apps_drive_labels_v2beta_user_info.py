...
class GoogleAppsDriveLabelsV2betaUserInfo(BaseModel):
    ...
    """ # noqa: E501
    person: Optional[StrictStr] = Field(default=None, description="The identifier for this user that can be used with the People API to get more information. For example, people/12345678.")
