...
class GoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints(BaseModel):
    ...
    """ # noqa: E501
    badge_colors: Optional[GoogleAppsDriveLabelsV2betaBadgeColors] = Field(default=None, alias="badgeColors")
    ...
    dark_badge_colors: Optional[GoogleAppsDriveLabelsV2betaBadgeColors] = Field(default=None, alias="darkBadgeColors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "badgeColors": GoogleAppsDriveLabelsV2betaBadgeColors.from_dict(obj["badgeColors"]) if obj.get("badgeColors") is not None else None,
            "badgePriority": obj.get("badgePriority"),
            "darkBadgeColors": GoogleAppsDriveLabelsV2betaBadgeColors.from_dict(obj["darkBadgeColors"]) if obj.get("darkBadgeColors") is not None else None,
