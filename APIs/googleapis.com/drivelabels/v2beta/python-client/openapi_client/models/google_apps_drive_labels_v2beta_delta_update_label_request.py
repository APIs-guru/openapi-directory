...
class GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest(BaseModel):
    ...
    requests: Optional[List[GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestRequest]] = Field(default=None, description="A list of updates to apply to the Label. Requests will be applied in the order they are specified.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None,
