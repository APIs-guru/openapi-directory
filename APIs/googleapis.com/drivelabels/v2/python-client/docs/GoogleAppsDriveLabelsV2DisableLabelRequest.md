...
google_apps_drive_labels_v2_disable_label_request_instance = GoogleAppsDriveLabelsV2DisableLabelRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleAppsDriveLabelsV2DisableLabelRequest.to_json())

# convert the object into a dict
google_apps_drive_labels_v2_disable_label_request_dict = google_apps_drive_labels_v2_disable_label_request_instance.to_dict()
# create an instance of GoogleAppsDriveLabelsV2DisableLabelRequest from a dict
google_apps_drive_labels_v2_disable_label_request_from_dict = GoogleAppsDriveLabelsV2DisableLabelRequest.from_dict(google_apps_drive_labels_v2_disable_label_request_dict)
```
