...
------------ | ------------- | ------------- | -------------
**applied_capabilities** | [**GoogleAppsDriveLabelsV2LabelAppliedCapabilities**](GoogleAppsDriveLabelsV2LabelAppliedCapabilities.md) |  | [optional] 
**applied_label_policy** | [**GoogleAppsDriveLabelsV2LabelAppliedLabelPolicy**](GoogleAppsDriveLabelsV2LabelAppliedLabelPolicy.md) |  | [optional] 
...
**display_hints** | [**GoogleAppsDriveLabelsV2LabelDisplayHints**](GoogleAppsDriveLabelsV2LabelDisplayHints.md) |  | [optional] 
...
**revision_creator** | [**GoogleAppsDriveLabelsV2UserInfo**](GoogleAppsDriveLabelsV2UserInfo.md) |  | [optional] 
...
**schema_capabilities** | [**GoogleAppsDriveLabelsV2LabelSchemaCapabilities**](GoogleAppsDriveLabelsV2LabelSchemaCapabilities.md) |  | [optional] 
...
google_apps_drive_labels_v2_label_instance = GoogleAppsDriveLabelsV2Label.from_json(json)
# print the JSON string representation of the object
print(GoogleAppsDriveLabelsV2Label.to_json())

# convert the object into a dict
google_apps_drive_labels_v2_label_dict = google_apps_drive_labels_v2_label_instance.to_dict()
# create an instance of GoogleAppsDriveLabelsV2Label from a dict
google_apps_drive_labels_v2_label_from_dict = GoogleAppsDriveLabelsV2Label.from_dict(google_apps_drive_labels_v2_label_dict)
```
