...
google_apps_drive_labels_v2_update_label_copy_mode_request_instance = GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest.to_json())

# convert the object into a dict
google_apps_drive_labels_v2_update_label_copy_mode_request_dict = google_apps_drive_labels_v2_update_label_copy_mode_request_instance.to_dict()
# create an instance of GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest from a dict
google_apps_drive_labels_v2_update_label_copy_mode_request_from_dict = GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest.from_dict(google_apps_drive_labels_v2_update_label_copy_mode_request_dict)
```
