...
google_apps_drive_labels_v2_publish_label_request_instance = GoogleAppsDriveLabelsV2PublishLabelRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleAppsDriveLabelsV2PublishLabelRequest.to_json())

# convert the object into a dict
google_apps_drive_labels_v2_publish_label_request_dict = google_apps_drive_labels_v2_publish_label_request_instance.to_dict()
# create an instance of GoogleAppsDriveLabelsV2PublishLabelRequest from a dict
google_apps_drive_labels_v2_publish_label_request_from_dict = GoogleAppsDriveLabelsV2PublishLabelRequest.from_dict(google_apps_drive_labels_v2_publish_label_request_dict)
```
