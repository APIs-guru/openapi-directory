...
json = "{}"
# create an instance of GoogleAppsDriveLabelsV2EnableLabelRequest from a JSON string
google_apps_drive_labels_v2_enable_label_request_instance = GoogleAppsDriveLabelsV2EnableLabelRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleAppsDriveLabelsV2EnableLabelRequest.to_json())

# convert the object into a dict
google_apps_drive_labels_v2_enable_label_request_dict = google_apps_drive_labels_v2_enable_label_request_instance.to_dict()
# create an instance of GoogleAppsDriveLabelsV2EnableLabelRequest from a dict
google_apps_drive_labels_v2_enable_label_request_from_dict = GoogleAppsDriveLabelsV2EnableLabelRequest.from_dict(google_apps_drive_labels_v2_enable_label_request_dict)
```
