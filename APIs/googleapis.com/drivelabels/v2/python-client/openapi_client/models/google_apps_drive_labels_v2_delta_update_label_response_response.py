...
class GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseResponse(BaseModel):
    """
    A single response from an update.
    """ # noqa: E501
    create_field: Optional[GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateFieldResponse] = Field(default=None, alias="createField")
    create_selection_choice: Optional[GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateSelectionChoiceResponse] = Field(default=None, alias="createSelectionChoice")
    ...
    update_field: Optional[GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateFieldPropertiesResponse] = Field(default=None, alias="updateField")
    ...
    update_selection_choice_properties: Optional[GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateSelectionChoicePropertiesResponse] = Field(default=None, alias="updateSelectionChoiceProperties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createField": GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateFieldResponse.from_dict(obj["createField"]) if obj.get("createField") is not None else None,
            "createSelectionChoice": GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateSelectionChoiceResponse.from_dict(obj["createSelectionChoice"]) if obj.get("createSelectionChoice") is not None else None,
            ...
            "updateField": GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateFieldPropertiesResponse.from_dict(obj["updateField"]) if obj.get("updateField") is not None else None,
            "updateFieldType": obj.get("updateFieldType"),
            "updateLabel": obj.get("updateLabel"),
            "updateSelectionChoiceProperties": GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateSelectionChoicePropertiesResponse.from_dict(obj["updateSelectionChoiceProperties"]) if obj.get("updateSelectionChoiceProperties") is not None else None
        })
        return _obj
