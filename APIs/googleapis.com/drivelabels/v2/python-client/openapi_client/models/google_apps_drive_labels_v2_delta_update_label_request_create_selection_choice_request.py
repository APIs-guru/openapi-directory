...
class GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestCreateSelectionChoiceRequest(BaseModel):
    """
    Request to create a Selection Choice.
    """ # noqa: E501
    choice: Optional[GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "choice": GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice.from_dict(obj["choice"]) if obj.get("choice") is not None else None,
