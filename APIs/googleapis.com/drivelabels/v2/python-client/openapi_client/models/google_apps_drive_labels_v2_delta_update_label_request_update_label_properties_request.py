...
class GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateLabelPropertiesRequest(BaseModel):
    """
    Updates basic properties of a Label.
    """ # noqa: E501
    properties: Optional[GoogleAppsDriveLabelsV2LabelProperties] = None
    update_mask: Optional[StrictStr] = Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `label_properties` is implied and should not be specified. A single `*` can be used as short-hand for updating every field.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["properties", "updateMask"]
