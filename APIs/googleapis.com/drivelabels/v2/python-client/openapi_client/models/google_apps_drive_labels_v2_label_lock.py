...
class GoogleAppsDriveLabelsV2LabelLock(BaseModel):
    """
    A Lock that can be applied to a Label, Field, or Choice.
    """ # noqa: E501
    capabilities: Optional[GoogleAppsDriveLabelsV2LabelLockCapabilities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": GoogleAppsDriveLabelsV2LabelLockCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None,
