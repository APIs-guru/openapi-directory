...
class UsersApi:
    ...
    def drivelabels_users_get_capabilities(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the user. Only \"users/me/capabilities\" is supported.")],
        ...
        customer: Annotated[Optional[StrictStr], Field(description="The customer to scope this request to. For example: \"customers/abcd1234\". If unset, will return settings within the current customer.")] = None,
        use_admin_access: Annotated[Optional[StrictBool], Field(description="Set to `true` in order to use the user's admin credentials. The server verifies that the user is an admin for the label before allowing access.")] = None,
        ...
        _param = self._drivelabels_users_get_capabilities_serialize(
            name=name,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleAppsDriveLabelsV2UserCapabilities",
        }
    ...
    @validate_call
    def drivelabels_users_get_capabilities_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the user. Only \"users/me/capabilities\" is supported.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def drivelabels_users_get_capabilities_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the user. Only \"users/me/capabilities\" is supported.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _drivelabels_users_get_capabilities_serialize(
        self,
        name,
        xgafv,
        access_token,
