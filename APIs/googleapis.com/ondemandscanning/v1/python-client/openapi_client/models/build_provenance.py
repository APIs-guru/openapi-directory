...
class BuildProvenance(BaseModel):
    ...
    end_time: Optional[StrictStr] = Field(default=None, description="Time at which execution of the build was finished.", alias="endTime")
    id: Optional[StrictStr] = Field(default=None, description="Required. Unique identifier of the build.")
    logs_uri: Optional[StrictStr] = Field(default=None, description="URI where any logs for this provenance were written.", alias="logsUri")
    ...
    __properties: ClassVar[List[str]] = ["buildOptions", "builderVersion", "builtArtifacts", "commands", "createTime", "creator", "endTime", "id", "logsUri", "projectId", "sourceProvenance", "startTime", "triggerId"]
