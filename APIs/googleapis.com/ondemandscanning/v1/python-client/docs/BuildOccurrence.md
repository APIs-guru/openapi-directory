...
build_occurrence_instance = BuildOccurrence.from_json(json)
# print the JSON string representation of the object
print(BuildOccurrence.to_json())

# convert the object into a dict
build_occurrence_dict = build_occurrence_instance.to_dict()
# create an instance of BuildOccurrence from a dict
build_occurrence_from_dict = BuildOccurrence.from_dict(build_occurrence_dict)
```
