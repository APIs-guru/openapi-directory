...
class AnalyzePackagesResponseV1(BaseModel):
    ...
    """ # noqa: E501
    scan: Optional[StrictStr] = Field(default=None, description="The name of the scan resource created by this successful scan.")
    __properties: ClassVar[List[str]] = ["scan"]
