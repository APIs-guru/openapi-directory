...
class TestAnalyzePackagesRequest(unittest.TestCase):
    """AnalyzePackagesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzePackagesRequest:
        """Test AnalyzePackagesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzePackagesRequest`
        """
        model = AnalyzePackagesRequest()
        if include_optional:
    ...
    def testAnalyzePackagesRequest(self):
        """Test AnalyzePackagesRequest"""
