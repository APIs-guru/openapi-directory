...
class TestListVulnerabilitiesResponse(unittest.TestCase):
    """ListVulnerabilitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListVulnerabilitiesResponse:
        """Test ListVulnerabilitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListVulnerabilitiesResponse`
        """
        model = ListVulnerabilitiesResponse()
        if include_optional:
    ...
    def testListVulnerabilitiesResponse(self):
        """Test ListVulnerabilitiesResponse"""
