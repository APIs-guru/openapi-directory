...
class TestVexAssessment(unittest.TestCase):
    """VexAssessment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VexAssessment:
        """Test VexAssessment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VexAssessment`
        """
        model = VexAssessment()
        if include_optional:
