...
class BlogsApi:
    ...
    def blogger_blogs_get(
        ...
        _param = self._blogger_blogs_get_serialize(
            blog_id=blog_id,
            xgafv=xgafv,
    ...
    @validate_call
    def blogger_blogs_get_with_http_info(
        self,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_blogs_get_without_preload_content(
        self,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_blogs_get_serialize(
        self,
        blog_id,
        xgafv,
        access_token,
    ...
    def blogger_blogs_list(
        ...
        _param = self._blogger_blogs_list_serialize(
            user_id=user_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def blogger_blogs_list_with_http_info(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_blogs_list_without_preload_content(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_blogs_list_serialize(
        self,
        user_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/users/{userId}/blogs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
