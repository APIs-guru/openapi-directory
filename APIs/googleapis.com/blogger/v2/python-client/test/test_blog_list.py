...
class TestBlogList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BlogList:
        """Test BlogList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlogList`
        """
        model = BlogList()
        if include_optional:
            return BlogList(
                blog_user_infos = [
                    openapi_client.models.blog_user_info.BlogUserInfo(
                ...
                items = [
                    openapi_client.models.blog.Blog(
                        custom_meta_data = '', 
                        description = '', 
                        id = '', 
                        kind = '', 
