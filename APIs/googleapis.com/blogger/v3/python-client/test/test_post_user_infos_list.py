...
class TestPostUserInfosList(unittest.TestCase):
    """PostUserInfosList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostUserInfosList:
        """Test PostUserInfosList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostUserInfosList`
        """
        model = PostUserInfosList()
        if include_optional:
            return PostUserInfosList(
                items = [
                    openapi_client.models.post_user_info.PostUserInfo(
                        kind = '', 
    ...
    def testPostUserInfosList(self):
        """Test PostUserInfosList"""
