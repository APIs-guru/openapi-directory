...
class TestPostReplies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostReplies:
        """Test PostReplies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostReplies`
        """
        model = PostReplies()
        if include_optional:
            return PostReplies(
