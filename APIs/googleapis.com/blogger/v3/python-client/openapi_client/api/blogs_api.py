...
class BlogsApi:
    ...
    def blogger_blogs_get(
        ...
        max_posts: Optional[StrictInt] = None,
    ...
    def _blogger_blogs_get_serialize(
        ...
        if max_posts is not None:
            ...
            _query_params.append(('maxPosts', max_posts))
    ...
    def blogger_blogs_get_by_url(
        ...
        _param = self._blogger_blogs_get_by_url_serialize(
            url=url,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def blogger_blogs_get_by_url_with_http_info(
        self,
        url: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_blogs_get_by_url_without_preload_content(
        self,
        url: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_blogs_get_by_url_serialize(
        self,
        url,
        xgafv,
        access_token,
    ...
    def blogger_blogs_list_by_user(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        fetch_user_info: Optional[StrictBool] = None,
        role: Optional[List[StrictStr]] = None,
        status: Annotated[Optional[List[StrictStr]], Field(description="Default value of status is LIVE.")] = None,
        view: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._blogger_blogs_list_by_user_serialize(
            user_id=user_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def blogger_blogs_list_by_user_with_http_info(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_blogs_list_by_user_without_preload_content(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_blogs_list_by_user_serialize(
        self,
        user_id,
        xgafv,
        access_token,
        ...
        if fetch_user_info is not None:
            
            _query_params.append(('fetchUserInfo', fetch_user_info))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/users/{userId}/blogs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
