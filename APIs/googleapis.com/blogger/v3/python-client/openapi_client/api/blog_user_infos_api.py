...
class BlogUserInfosApi:
    ...
    def blogger_blog_user_infos_get(
        ...
        _param = self._blogger_blog_user_infos_get_serialize(
            user_id=user_id,
            blog_id=blog_id,
            xgafv=xgafv,
    ...
    @validate_call
    def blogger_blog_user_infos_get_with_http_info(
        self,
        user_id: StrictStr,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def blogger_blog_user_infos_get_without_preload_content(
        self,
        user_id: StrictStr,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _blogger_blog_user_infos_get_serialize(
        self,
        user_id,
        blog_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/users/{userId}/blogs/{blogId}',
