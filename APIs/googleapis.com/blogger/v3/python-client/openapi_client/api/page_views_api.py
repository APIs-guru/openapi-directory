...
class PageViewsApi:
    ...
    def blogger_page_views_get(
        ...
        range: Optional[List[StrictStr]] = None,
        ...
        _param = self._blogger_page_views_get_serialize(
            blog_id=blog_id,
            xgafv=xgafv,
    ...
    @validate_call
    def blogger_page_views_get_with_http_info(
        self,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_page_views_get_without_preload_content(
        self,
        blog_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_page_views_get_serialize(
        self,
        blog_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/blogs/{blogId}/pageviews',
