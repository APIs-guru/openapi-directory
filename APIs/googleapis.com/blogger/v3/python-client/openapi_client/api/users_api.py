...
class UsersApi:
    ...
    def blogger_users_get(
        ...
        _param = self._blogger_users_get_serialize(
            user_id=user_id,
            xgafv=xgafv,
    ...
    @validate_call
    def blogger_users_get_with_http_info(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def blogger_users_get_without_preload_content(
        self,
        user_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _blogger_users_get_serialize(
        self,
        user_id,
        xgafv,
        access_token,
