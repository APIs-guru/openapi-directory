...
class OrganizationsApi:
    ...
    def orgpolicy_organizations_custom_constraints_create(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Must be in the following form: * `organizations/{organization_id}`")],
        ...
        google_cloud_orgpolicy_v2_custom_constraint: Optional[GoogleCloudOrgpolicyV2CustomConstraint] = None,
        ...
        :param google_cloud_orgpolicy_v2_custom_constraint:
        :type google_cloud_orgpolicy_v2_custom_constraint: GoogleCloudOrgpolicyV2CustomConstraint
        ...
        _param = self._orgpolicy_organizations_custom_constraints_create_serialize(
            parent=parent,
            xgafv=xgafv,
            ...
            google_cloud_orgpolicy_v2_custom_constraint=google_cloud_orgpolicy_v2_custom_constraint,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudOrgpolicyV2CustomConstraint",
        }
    ...
    @validate_call
    def orgpolicy_organizations_custom_constraints_create_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Must be in the following form: * `organizations/{organization_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def orgpolicy_organizations_custom_constraints_create_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Must be in the following form: * `organizations/{organization_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _orgpolicy_organizations_custom_constraints_create_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        upload_protocol,
        upload_type,
        google_cloud_orgpolicy_v2_custom_constraint,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if google_cloud_orgpolicy_v2_custom_constraint is not None:
            _body_params = google_cloud_orgpolicy_v2_custom_constraint
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/{parent}/customConstraints',
    ...
    def orgpolicy_organizations_custom_constraints_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The target Google Cloud resource that parents the set of custom constraints that will be returned from this call. Must be in one of the following forms: * `organizations/{organization_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        _param = self._orgpolicy_organizations_custom_constraints_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudOrgpolicyV2ListCustomConstraintsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def orgpolicy_organizations_custom_constraints_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The target Google Cloud resource that parents the set of custom constraints that will be returned from this call. Must be in one of the following forms: * `organizations/{organization_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def orgpolicy_organizations_custom_constraints_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The target Google Cloud resource that parents the set of custom constraints that will be returned from this call. Must be in one of the following forms: * `organizations/{organization_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _orgpolicy_organizations_custom_constraints_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
