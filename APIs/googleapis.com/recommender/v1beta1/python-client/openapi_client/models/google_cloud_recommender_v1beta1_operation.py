...
class GoogleCloudRecommenderV1beta1Operation(BaseModel):
    """
    ...
    value_matcher: Optional[GoogleCloudRecommenderV1beta1ValueMatcher] = Field(default=None, alias="valueMatcher")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pathValueMatchers": dict(
                (_k, GoogleCloudRecommenderV1beta1ValueMatcher.from_dict(_v))
            ...
            "value": obj.get("value"),
            "valueMatcher": GoogleCloudRecommenderV1beta1ValueMatcher.from_dict(obj["valueMatcher"]) if obj.get("valueMatcher") is not None else None
        })
        return _obj
