...
class GoogleCloudRecommenderV1beta1OperationGroup(BaseModel):
    """
    Group of operations that need to be performed atomically.
    """ # noqa: E501
    operations: Optional[List[GoogleCloudRecommenderV1beta1Operation]] = Field(default=None, description="List of operations across one or more resources that belong to this group. Loosely based on RFC6902 and should be performed in the order they appear.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operations": [GoogleCloudRecommenderV1beta1Operation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
