...
**insight_type_generation_config** | [**GoogleCloudRecommenderV1InsightTypeGenerationConfig**](GoogleCloudRecommenderV1InsightTypeGenerationConfig.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudRecommenderV1InsightTypeConfig from a JSON string
google_cloud_recommender_v1_insight_type_config_instance = GoogleCloudRecommenderV1InsightTypeConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudRecommenderV1InsightTypeConfig.to_json())

# convert the object into a dict
google_cloud_recommender_v1_insight_type_config_dict = google_cloud_recommender_v1_insight_type_config_instance.to_dict()
# create an instance of GoogleCloudRecommenderV1InsightTypeConfig from a dict
google_cloud_recommender_v1_insight_type_config_from_dict = GoogleCloudRecommenderV1InsightTypeConfig.from_dict(google_cloud_recommender_v1_insight_type_config_dict)
```
