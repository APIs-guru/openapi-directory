...
class GoogleCloudRecommenderV1Recommendation(BaseModel):
    """
    A recommendation along with a suggested action. E.g., a rightsizing recommendation for an underutilized VM, IAM role recommendations, etc
    """ # noqa: E501
    additional_impact: Optional[List[GoogleCloudRecommenderV1Impact]] = Field(default=None, description="Optional set of additional impact that this recommendation may have when trying to optimize for the primary category. These may be positive or negative.", alias="additionalImpact")
    associated_insights: Optional[List[GoogleCloudRecommenderV1RecommendationInsightReference]] = Field(default=None, description="Insights that led to this recommendation.", alias="associatedInsights")
    content: Optional[GoogleCloudRecommenderV1RecommendationContent] = None
    ...
    primary_impact: Optional[GoogleCloudRecommenderV1Impact] = Field(default=None, alias="primaryImpact")
    ...
    state_info: Optional[GoogleCloudRecommenderV1RecommendationStateInfo] = Field(default=None, alias="stateInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalImpact": [GoogleCloudRecommenderV1Impact.from_dict(_item) for _item in obj["additionalImpact"]] if obj.get("additionalImpact") is not None else None,
            "associatedInsights": [GoogleCloudRecommenderV1RecommendationInsightReference.from_dict(_item) for _item in obj["associatedInsights"]] if obj.get("associatedInsights") is not None else None,
            "content": GoogleCloudRecommenderV1RecommendationContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "description": obj.get("description"),
            "etag": obj.get("etag"),
            "lastRefreshTime": obj.get("lastRefreshTime"),
            "name": obj.get("name"),
            "primaryImpact": GoogleCloudRecommenderV1Impact.from_dict(obj["primaryImpact"]) if obj.get("primaryImpact") is not None else None,
            "priority": obj.get("priority"),
            "recommenderSubtype": obj.get("recommenderSubtype"),
            "stateInfo": GoogleCloudRecommenderV1RecommendationStateInfo.from_dict(obj["stateInfo"]) if obj.get("stateInfo") is not None else None,
