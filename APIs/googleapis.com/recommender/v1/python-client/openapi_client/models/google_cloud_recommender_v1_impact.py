...
class GoogleCloudRecommenderV1Impact(BaseModel):
    """
    Contains the impact a recommendation can have for a given category.
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Category that is being targeted.")
    cost_projection: Optional[GoogleCloudRecommenderV1CostProjection] = Field(default=None, alias="costProjection")
    reliability_projection: Optional[GoogleCloudRecommenderV1ReliabilityProjection] = Field(default=None, alias="reliabilityProjection")
    security_projection: Optional[GoogleCloudRecommenderV1SecurityProjection] = Field(default=None, alias="securityProjection")
    sustainability_projection: Optional[GoogleCloudRecommenderV1SustainabilityProjection] = Field(default=None, alias="sustainabilityProjection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "costProjection": GoogleCloudRecommenderV1CostProjection.from_dict(obj["costProjection"]) if obj.get("costProjection") is not None else None,
            "reliabilityProjection": GoogleCloudRecommenderV1ReliabilityProjection.from_dict(obj["reliabilityProjection"]) if obj.get("reliabilityProjection") is not None else None,
            "securityProjection": GoogleCloudRecommenderV1SecurityProjection.from_dict(obj["securityProjection"]) if obj.get("securityProjection") is not None else None,
            "sustainabilityProjection": GoogleCloudRecommenderV1SustainabilityProjection.from_dict(obj["sustainabilityProjection"]) if obj.get("sustainabilityProjection") is not None else None
        })
        return _obj
