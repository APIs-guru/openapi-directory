...
class GoogleCloudRecommenderV1RecommenderConfig(BaseModel):
    """
    ...
    recommender_generation_config: Optional[GoogleCloudRecommenderV1RecommenderGenerationConfig] = Field(default=None, alias="recommenderGenerationConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "recommenderGenerationConfig": GoogleCloudRecommenderV1RecommenderGenerationConfig.from_dict(obj["recommenderGenerationConfig"]) if obj.get("recommenderGenerationConfig") is not None else None,
