...
class GoogleCloudRecommenderV1InsightTypeGenerationConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    params: Optional[Dict[str, Any]] = Field(default=None, description="Parameters for this InsightTypeGenerationConfig. These configs can be used by or are applied to all subtypes.")
