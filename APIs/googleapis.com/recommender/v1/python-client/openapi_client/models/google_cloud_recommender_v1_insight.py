...
class GoogleCloudRecommenderV1Insight(BaseModel):
    """
    An insight along with the information used to derive the insight. The insight may have associated recommendations as well.
    """ # noqa: E501
    associated_recommendations: Optional[List[GoogleCloudRecommenderV1InsightRecommendationReference]] = Field(default=None, description="Recommendations derived from this insight.", alias="associatedRecommendations")
    ...
    state_info: Optional[GoogleCloudRecommenderV1InsightStateInfo] = Field(default=None, alias="stateInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associatedRecommendations": [GoogleCloudRecommenderV1InsightRecommendationReference.from_dict(_item) for _item in obj["associatedRecommendations"]] if obj.get("associatedRecommendations") is not None else None,
            ...
            "stateInfo": GoogleCloudRecommenderV1InsightStateInfo.from_dict(obj["stateInfo"]) if obj.get("stateInfo") is not None else None,
