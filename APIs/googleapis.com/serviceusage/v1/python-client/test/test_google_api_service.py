...
class TestGoogleApiService(unittest.TestCase):
    """GoogleApiService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleApiService:
        """Test GoogleApiService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleApiService`
        """
        model = GoogleApiService()
        if include_optional:
