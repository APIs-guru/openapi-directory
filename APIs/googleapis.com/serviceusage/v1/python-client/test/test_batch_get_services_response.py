...
class TestBatchGetServicesResponse(unittest.TestCase):
    """BatchGetServicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchGetServicesResponse:
        """Test BatchGetServicesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchGetServicesResponse`
        """
        model = BatchGetServicesResponse()
        if include_optional:
    ...
    def testBatchGetServicesResponse(self):
        """Test BatchGetServicesResponse"""
