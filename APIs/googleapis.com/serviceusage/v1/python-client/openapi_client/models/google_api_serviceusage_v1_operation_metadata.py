...
class GoogleApiServiceusageV1OperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    resource_names: Optional[List[StrictStr]] = Field(default=None, description="The full name of the resources that this operation is directly associated with.", alias="resourceNames")
