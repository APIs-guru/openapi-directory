...
class BatchCreateConsumerOverridesResponse(BaseModel):
    ...
    """ # noqa: E501
    overrides: Optional[List[QuotaOverride]] = Field(default=None, description="The overrides that were created.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overrides": [QuotaOverride.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
