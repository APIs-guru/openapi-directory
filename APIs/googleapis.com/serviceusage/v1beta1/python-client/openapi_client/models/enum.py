...
class Enum(BaseModel):
    ...
    enumvalue: Optional[List[EnumValue]] = Field(default=None, description="Enum value definitions.")
    name: Optional[StrictStr] = Field(default=None, description="Enum type name.")
    options: Optional[List[Option]] = Field(default=None, description="Protocol buffer options.")
    ...
    __properties: ClassVar[List[str]] = ["edition", "enumvalue", "name", "options", "sourceContext", "syntax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in enumvalue (list)
        _items = []
        if self.enumvalue:
            for _item_enumvalue in self.enumvalue:
                if _item_enumvalue:
                    _items.append(_item_enumvalue.to_dict())
            _dict['enumvalue'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enumvalue": [EnumValue.from_dict(_item) for _item in obj["enumvalue"]] if obj.get("enumvalue") is not None else None,
            "name": obj.get("name"),
