...
class QuotaBucket(BaseModel):
    ...
    producer_quota_policy: Optional[ProducerQuotaPolicy] = Field(default=None, alias="producerQuotaPolicy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "producerQuotaPolicy": ProducerQuotaPolicy.from_dict(obj["producerQuotaPolicy"]) if obj.get("producerQuotaPolicy") is not None else None
        })
        return _obj
