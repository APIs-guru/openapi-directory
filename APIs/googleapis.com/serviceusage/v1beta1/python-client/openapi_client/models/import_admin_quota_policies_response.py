...
class ImportAdminQuotaPoliciesResponse(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[List[AdminQuotaPolicy]] = Field(default=None, description="The policies that were created from the imported data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [AdminQuotaPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
