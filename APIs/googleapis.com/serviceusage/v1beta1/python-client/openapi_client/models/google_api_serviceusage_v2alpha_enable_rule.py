...
class GoogleApiServiceusageV2alphaEnableRule(BaseModel):
    """
    The consumer policy rule that defines enabled services, groups, and categories.
    """ # noqa: E501
    services: Optional[List[StrictStr]] = Field(default=None, description="The names of the services that are enabled. Example: `services/storage.googleapis.com`.")
