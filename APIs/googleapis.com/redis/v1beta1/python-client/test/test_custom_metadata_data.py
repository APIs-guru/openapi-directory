...
class TestCustomMetadataData(unittest.TestCase):
    """CustomMetadataData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomMetadataData:
        """Test CustomMetadataData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomMetadataData`
        """
        model = CustomMetadataData()
        if include_optional:
    ...
    def testCustomMetadataData(self):
        """Test CustomMetadataData"""
