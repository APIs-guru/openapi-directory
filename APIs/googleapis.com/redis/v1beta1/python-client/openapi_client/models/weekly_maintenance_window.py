...
class WeeklyMaintenanceWindow(BaseModel):
    ...
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Required. The day of week that maintenance updates occur.")
    duration: Optional[StrictStr] = Field(default=None, description="Output only. Duration of the maintenance window. The current window is fixed at 1 hour.")
