...
class ScriptsApi:
    ...
    def script_scripts_run(
        self,
        script_id: Annotated[StrictStr, Field(description="The script ID of the script to be executed. Find the script ID on the **Project settings** page under \"IDs.\" As multiple executable APIs can be deployed in new IDE for same script, this field should be populated with DeploymentID generated while deploying in new IDE instead of script ID.")],
        ...
        :param script_id: The script ID of the script to be executed. Find the script ID on the **Project settings** page under \"IDs.\" As multiple executable APIs can be deployed in new IDE for same script, this field should be populated with DeploymentID generated while deploying in new IDE instead of script ID. (required)
        :type script_id: str
        ...
        _param = self._script_scripts_run_serialize(
            script_id=script_id,
            xgafv=xgafv,
    ...
    @validate_call
    def script_scripts_run_with_http_info(
        self,
        script_id: Annotated[StrictStr, Field(description="The script ID of the script to be executed. Find the script ID on the **Project settings** page under \"IDs.\" As multiple executable APIs can be deployed in new IDE for same script, this field should be populated with DeploymentID generated while deploying in new IDE instead of script ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def script_scripts_run_without_preload_content(
        self,
        script_id: Annotated[StrictStr, Field(description="The script ID of the script to be executed. Find the script ID on the **Project settings** page under \"IDs.\" As multiple executable APIs can be deployed in new IDE for same script, this field should be populated with DeploymentID generated while deploying in new IDE instead of script ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _script_scripts_run_serialize(
        self,
        script_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/scripts/{scriptId}:run',
