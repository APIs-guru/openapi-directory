...
class Content(BaseModel):
    ...
    """ # noqa: E501
    files: Optional[List[File]] = Field(default=None, description="The list of script project files. One of the files is a script manifest; it must be named \"appsscript\", must have type of JSON, and include the manifest configurations for the project.")
    script_id: Optional[StrictStr] = Field(default=None, description="The script project's Drive ID.", alias="scriptId")
    __properties: ClassVar[List[str]] = ["files", "scriptId"]
