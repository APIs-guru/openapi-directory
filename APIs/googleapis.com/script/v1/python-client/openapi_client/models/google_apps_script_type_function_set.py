...
class GoogleAppsScriptTypeFunctionSet(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[GoogleAppsScriptTypeFunction]] = Field(default=None, description="A list of functions composing the set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [GoogleAppsScriptTypeFunction.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
