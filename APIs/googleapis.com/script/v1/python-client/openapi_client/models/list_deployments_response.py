...
class ListDeploymentsResponse(BaseModel):
    ...
    """ # noqa: E501
    deployments: Optional[List[Deployment]] = Field(default=None, description="The list of deployments.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token that can be used in the next call to get the next page of results.", alias="nextPageToken")
