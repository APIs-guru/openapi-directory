...
**size** | **str** | Size of this ad unit. Size values are in the form SIZE_{width}_{height}. | [optional] 
**type** | **str** | Type of this ad unit. Possible values are TEXT, TEXT_IMAGE, IMAGE and LINK. | [optional] 
