...
class AssociationsessionsApi:
    ...
    def adsensehost_associationsessions_start(
        self,
        product_code: Annotated[List[StrictStr], Field(description="Products to associate with the user.")],
        website_url: Annotated[StrictStr, Field(description="The URL of the user's hosted website.")],
        ...
        callback_url: Annotated[Optional[StrictStr], Field(description="The URL to redirect the user to once association is completed. It receives a token parameter that can then be used to retrieve the associated account.")] = None,
        user_locale: Annotated[Optional[StrictStr], Field(description="The preferred locale of the user.")] = None,
        website_locale: Annotated[Optional[StrictStr], Field(description="The locale of the user's hosted website.")] = None,
        ...
        :param product_code: Products to associate with the user. (required)
        :type product_code: List[str]
        :param website_url: The URL of the user's hosted website. (required)
        ...
        _param = self._adsensehost_associationsessions_start_serialize(
    ...
    @validate_call
    def adsensehost_associationsessions_start_with_http_info(
        self,
        product_code: Annotated[List[StrictStr], Field(description="Products to associate with the user.")],
        website_url: Annotated[StrictStr, Field(description="The URL of the user's hosted website.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssociationSession]:
        """adsensehost_associationsessions_start
    ...
    @validate_call
    def adsensehost_associationsessions_start_without_preload_content(
        self,
        product_code: Annotated[List[StrictStr], Field(description="Products to associate with the user.")],
        website_url: Annotated[StrictStr, Field(description="The URL of the user's hosted website.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _adsensehost_associationsessions_start_serialize(
        self,
        product_code,
        website_url,
        alt,
        ...
        if website_url is not None:
            ...
            _query_params.append(('websiteUrl', website_url))
        ...
        if user_locale is not None:
            ...
            _query_params.append(('userLocale', user_locale))
            
        if website_locale is not None:
            
            _query_params.append(('websiteLocale', website_locale))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/associationsessions/start',
    ...
    def adsensehost_associationsessions_verify(
        self,
        token: Annotated[StrictStr, Field(description="The token returned to the association callback URL.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        _param = self._adsensehost_associationsessions_verify_serialize(
            token=token,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def adsensehost_associationsessions_verify_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="The token returned to the association callback URL.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def adsensehost_associationsessions_verify_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="The token returned to the association callback URL.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _adsensehost_associationsessions_verify_serialize(
        self,
        token,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/associationsessions/verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
