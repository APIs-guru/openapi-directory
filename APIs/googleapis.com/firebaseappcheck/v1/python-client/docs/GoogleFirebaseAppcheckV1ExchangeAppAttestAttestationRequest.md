...
google_firebase_appcheck_v1_exchange_app_attest_attestation_request_instance = GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest.to_json())

# convert the object into a dict
google_firebase_appcheck_v1_exchange_app_attest_attestation_request_dict = google_firebase_appcheck_v1_exchange_app_attest_attestation_request_instance.to_dict()
# create an instance of GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest from a dict
google_firebase_appcheck_v1_exchange_app_attest_attestation_request_from_dict = GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest.from_dict(google_firebase_appcheck_v1_exchange_app_attest_attestation_request_dict)
```
