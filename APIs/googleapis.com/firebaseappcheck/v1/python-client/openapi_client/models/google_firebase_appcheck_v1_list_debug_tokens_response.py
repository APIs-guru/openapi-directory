...
class GoogleFirebaseAppcheckV1ListDebugTokensResponse(BaseModel):
    ...
    """ # noqa: E501
    debug_tokens: Optional[List[GoogleFirebaseAppcheckV1DebugToken]] = Field(default=None, description="The DebugTokens retrieved.", alias="debugTokens")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "debugTokens": [GoogleFirebaseAppcheckV1DebugToken.from_dict(_item) for _item in obj["debugTokens"]] if obj.get("debugTokens") is not None else None,
