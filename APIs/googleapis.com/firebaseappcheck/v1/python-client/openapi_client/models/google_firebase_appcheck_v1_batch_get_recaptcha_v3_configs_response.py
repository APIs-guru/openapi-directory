...
class GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse(BaseModel):
    ...
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1RecaptchaV3Config]] = Field(default=None, description="RecaptchaV3Configs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1RecaptchaV3Config.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
