...
class GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse(BaseModel):
    ...
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig]] = Field(default=None, description="RecaptchaEnterpriseConfigs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
