...
class GoogleFirebaseAppcheckV1betaListServicesResponse(BaseModel):
    """
    ...
    services: Optional[List[GoogleFirebaseAppcheckV1betaService]] = Field(default=None, description="The Services retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [GoogleFirebaseAppcheckV1betaService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
