...
class GoogleFirebaseAppcheckV1betaBatchUpdateResourcePoliciesResponse(BaseModel):
    """
    Response message for the BatchUpdateResourcePolicies method.
    """ # noqa: E501
    resource_policies: Optional[List[GoogleFirebaseAppcheckV1betaResourcePolicy]] = Field(default=None, description="ResourcePolicy objects after the updates have been applied.", alias="resourcePolicies")
    __properties: ClassVar[List[str]] = ["resourcePolicies"]
