...
class GoogleFirebaseAppcheckV1betaUpdateServiceRequest(BaseModel):
    """
    Request message for the UpdateService method as well as an individual update message for the BatchUpdateServices method.
    """ # noqa: E501
    service: Optional[GoogleFirebaseAppcheckV1betaService] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service": GoogleFirebaseAppcheckV1betaService.from_dict(obj["service"]) if obj.get("service") is not None else None,
