...
class GoogleFirebaseAppcheckV1betaBatchGetAppAttestConfigsResponse(BaseModel):
    """
    Response message for the BatchGetAppAttestConfigs method.
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1betaAppAttestConfig]] = Field(default=None, description="AppAttestConfigs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1betaAppAttestConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
