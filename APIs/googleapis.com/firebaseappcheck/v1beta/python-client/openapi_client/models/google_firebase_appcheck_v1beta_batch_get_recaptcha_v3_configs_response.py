...
class GoogleFirebaseAppcheckV1betaBatchGetRecaptchaV3ConfigsResponse(BaseModel):
    """
    Response message for the BatchGetRecaptchaV3Configs method.
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1betaRecaptchaV3Config]] = Field(default=None, description="RecaptchaV3Configs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1betaRecaptchaV3Config.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
