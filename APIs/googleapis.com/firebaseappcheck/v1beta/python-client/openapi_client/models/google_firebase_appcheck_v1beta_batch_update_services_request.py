...
class GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest(BaseModel):
    """
    Request message for the BatchUpdateServices method.
    """ # noqa: E501
    requests: Optional[List[GoogleFirebaseAppcheckV1betaUpdateServiceRequest]] = Field(default=None, description="Required. The request messages specifying the Services to update. A maximum of 100 objects can be updated in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleFirebaseAppcheckV1betaUpdateServiceRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None,
