...
class GoogleFirebaseAppcheckV1betaBatchGetRecaptchaConfigsResponse(BaseModel):
    """
    Response message for the BatchGetRecaptchaConfigs method.
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1betaRecaptchaConfig]] = Field(default=None, description="RecaptchaConfigs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1betaRecaptchaConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
