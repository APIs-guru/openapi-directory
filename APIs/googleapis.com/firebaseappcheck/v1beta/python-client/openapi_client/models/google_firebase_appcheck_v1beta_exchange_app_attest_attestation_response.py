...
class GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationResponse(BaseModel):
    """
    Response message for the ExchangeAppAttestAttestation method.
    """ # noqa: E501
    app_check_token: Optional[GoogleFirebaseAppcheckV1betaAppCheckToken] = Field(default=None, alias="appCheckToken")
    ...
    attestation_token: Optional[GoogleFirebaseAppcheckV1betaAttestationTokenResponse] = Field(default=None, alias="attestationToken")
    __properties: ClassVar[List[str]] = ["appCheckToken", "artifact", "attestationToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of attestation_token
        if self.attestation_token:
            _dict['attestationToken'] = self.attestation_token.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appCheckToken": GoogleFirebaseAppcheckV1betaAppCheckToken.from_dict(obj["appCheckToken"]) if obj.get("appCheckToken") is not None else None,
            "artifact": obj.get("artifact"),
            "attestationToken": GoogleFirebaseAppcheckV1betaAttestationTokenResponse.from_dict(obj["attestationToken"]) if obj.get("attestationToken") is not None else None
        })
        return _obj
