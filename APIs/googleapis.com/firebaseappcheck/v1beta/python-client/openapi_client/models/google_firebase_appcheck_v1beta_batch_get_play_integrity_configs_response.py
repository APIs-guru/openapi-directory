...
class GoogleFirebaseAppcheckV1betaBatchGetPlayIntegrityConfigsResponse(BaseModel):
    """
    Response message for the BatchGetPlayIntegrityConfigs method.
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1betaPlayIntegrityConfig]] = Field(default=None, description="PlayIntegrityConfigs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1betaPlayIntegrityConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
