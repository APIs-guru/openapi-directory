...
class GoogleFirebaseAppcheckV1betaPublicJwkSet(BaseModel):
    """
    ...
    """ # noqa: E501
    keys: Optional[List[GoogleFirebaseAppcheckV1betaPublicJwk]] = Field(default=None, description="The set of public keys. See [section 5.1 of RFC 7517](https://tools.ietf.org/html/rfc7517#section-5).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [GoogleFirebaseAppcheckV1betaPublicJwk.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
