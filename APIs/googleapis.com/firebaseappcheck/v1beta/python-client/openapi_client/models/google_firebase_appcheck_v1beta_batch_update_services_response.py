...
class GoogleFirebaseAppcheckV1betaBatchUpdateServicesResponse(BaseModel):
    """
    Response message for the BatchUpdateServices method.
    """ # noqa: E501
    services: Optional[List[GoogleFirebaseAppcheckV1betaService]] = Field(default=None, description="Service objects after the updates have been applied.")
