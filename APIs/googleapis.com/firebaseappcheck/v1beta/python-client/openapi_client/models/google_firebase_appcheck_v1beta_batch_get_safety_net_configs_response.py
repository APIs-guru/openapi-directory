...
class GoogleFirebaseAppcheckV1betaBatchGetSafetyNetConfigsResponse(BaseModel):
    """
    Response message for the BatchGetSafetyNetConfigs method.
    """ # noqa: E501
    configs: Optional[List[GoogleFirebaseAppcheckV1betaSafetyNetConfig]] = Field(default=None, description="SafetyNetConfigs retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GoogleFirebaseAppcheckV1betaSafetyNetConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
