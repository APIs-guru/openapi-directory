...
google_firebase_appcheck_v1beta_debug_token_instance = GoogleFirebaseAppcheckV1betaDebugToken.from_json(json)
# print the JSON string representation of the object
print(GoogleFirebaseAppcheckV1betaDebugToken.to_json())

# convert the object into a dict
google_firebase_appcheck_v1beta_debug_token_dict = google_firebase_appcheck_v1beta_debug_token_instance.to_dict()
# create an instance of GoogleFirebaseAppcheckV1betaDebugToken from a dict
google_firebase_appcheck_v1beta_debug_token_from_dict = GoogleFirebaseAppcheckV1betaDebugToken.from_dict(google_firebase_appcheck_v1beta_debug_token_dict)
```
