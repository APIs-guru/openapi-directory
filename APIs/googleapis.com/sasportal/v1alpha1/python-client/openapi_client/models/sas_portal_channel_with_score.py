...
class SasPortalChannelWithScore(BaseModel):
    ...
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The channel score, normalized to be in the range [0,100].")
    __properties: ClassVar[List[str]] = ["frequencyRange", "score"]
