...
class SasPortalMoveDeploymentRequest(BaseModel):
    ...
    """ # noqa: E501
    destination: Optional[StrictStr] = Field(default=None, description="Required. The name of the new parent resource node or customer to reparent the deployment under.")
