...
class SasPortalListGcpProjectDeploymentsResponse(BaseModel):
    """
    Response for [ListGcpProjectDeployments].
    """ # noqa: E501
    deployments: Optional[List[SasPortalGcpProjectDeployment]] = Field(default=None, description="Optional. Deployments associated with the GCP project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployments": [SasPortalGcpProjectDeployment.from_dict(_item) for _item in obj["deployments"]] if obj.get("deployments") is not None else None
        })
        return _obj
