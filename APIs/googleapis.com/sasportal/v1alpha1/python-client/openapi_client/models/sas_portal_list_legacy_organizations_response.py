...
class SasPortalListLegacyOrganizationsResponse(BaseModel):
    """
    Response for [ListLegacyOrganizations]. [spectrum.sas.portal.v1alpha1.Provisioning.ListLegacyOrganizations].
    """ # noqa: E501
    organizations: Optional[List[SasPortalOrganization]] = Field(default=None, description="Optional. Legacy SAS organizations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [SasPortalOrganization.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
