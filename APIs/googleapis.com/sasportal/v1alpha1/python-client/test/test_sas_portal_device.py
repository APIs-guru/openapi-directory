...
class TestSasPortalDevice(unittest.TestCase):
    """SasPortalDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SasPortalDevice:
        """Test SasPortalDevice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SasPortalDevice`
        """
        model = SasPortalDevice()
        if include_optional:
