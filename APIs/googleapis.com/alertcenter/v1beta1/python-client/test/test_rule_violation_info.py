...
class TestRuleViolationInfo(unittest.TestCase):
    """RuleViolationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RuleViolationInfo:
        """Test RuleViolationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RuleViolationInfo`
        """
        model = RuleViolationInfo()
        if include_optional:
    ...
    def testRuleViolationInfo(self):
        """Test RuleViolationInfo"""
