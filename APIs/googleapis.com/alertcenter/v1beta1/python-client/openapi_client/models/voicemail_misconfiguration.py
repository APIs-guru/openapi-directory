...
class VoicemailMisconfiguration(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[VoicemailRecipientError]] = Field(default=None, description="Issue(s) with voicemail recipients.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [VoicemailRecipientError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
