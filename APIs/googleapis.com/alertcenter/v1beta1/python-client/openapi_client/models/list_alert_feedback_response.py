...
class ListAlertFeedbackResponse(BaseModel):
    ...
    """ # noqa: E501
    feedback: Optional[List[AlertFeedback]] = Field(default=None, description="The list of alert feedback. Feedback entries for each alert are ordered by creation time descending.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feedback": [AlertFeedback.from_dict(_item) for _item in obj["feedback"]] if obj.get("feedback") is not None else None
        })
        return _obj
