...
class SSOProfileCreatedEvent(BaseModel):
    ...
    """ # noqa: E501
    inbound_sso_profile_name: Optional[StrictStr] = Field(default=None, description="sso profile name which got created", alias="inboundSsoProfileName")
    __properties: ClassVar[List[str]] = ["inboundSsoProfileName"]
