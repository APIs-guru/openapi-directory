...
class PredefinedDetectorInfo(BaseModel):
    ...
    """ # noqa: E501
    detector_name: Optional[StrictStr] = Field(default=None, description="Name that uniquely identifies the detector.", alias="detectorName")
    __properties: ClassVar[List[str]] = ["detectorName"]
