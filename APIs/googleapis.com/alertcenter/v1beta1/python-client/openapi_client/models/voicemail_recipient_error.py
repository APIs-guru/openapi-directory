...
class VoicemailRecipientError(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Email address of the invalid recipient. This may be unavailable if the recipient was deleted.")
    invalid_reason: Optional[StrictStr] = Field(default=None, description="Reason for the error.", alias="invalidReason")
    __properties: ClassVar[List[str]] = ["email", "invalidReason"]
    ...
    def invalid_reason_validate_enum(cls, value):
        ...
        if value not in set(['EMAIL_INVALID_REASON_UNSPECIFIED', 'OUT_OF_QUOTA', 'RECIPIENT_DELETED']):
            raise ValueError("must be one of enum values ('EMAIL_INVALID_REASON_UNSPECIFIED', 'OUT_OF_QUOTA', 'RECIPIENT_DELETED')")
        return value
