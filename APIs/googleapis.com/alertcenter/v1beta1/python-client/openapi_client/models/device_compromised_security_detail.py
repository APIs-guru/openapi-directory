...
class DeviceCompromisedSecurityDetail(BaseModel):
    ...
    """ # noqa: E501
    device_compromised_state: Optional[StrictStr] = Field(default=None, description="The device compromised state. Possible values are \"`Compromised`\" or \"`Not Compromised`\".", alias="deviceCompromisedState")
    ...
    __properties: ClassVar[List[str]] = ["deviceCompromisedState", "deviceId", "deviceModel", "deviceType", "iosVendorId", "resourceId", "serialNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deviceCompromisedState": obj.get("deviceCompromisedState"),
