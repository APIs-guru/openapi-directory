...
class MandatoryServiceAnnouncement(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Detailed, freeform text describing the announcement")
    title: Optional[StrictStr] = Field(default=None, description="One line summary of the announcement")
