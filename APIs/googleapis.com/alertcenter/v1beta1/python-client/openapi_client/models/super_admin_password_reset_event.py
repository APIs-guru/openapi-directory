...
class SuperAdminPasswordResetEvent(BaseModel):
    ...
    """ # noqa: E501
    user_email: Optional[StrictStr] = Field(default=None, description="email of person whose password was reset", alias="userEmail")
    __properties: ClassVar[List[str]] = ["userEmail"]
