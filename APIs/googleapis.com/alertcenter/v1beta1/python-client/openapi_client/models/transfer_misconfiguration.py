...
class TransferMisconfiguration(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[TransferError]] = Field(default=None, description="Details for each invalid transfer or forward.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [TransferError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
