...
class GoogleCloudFunctionsV2betaStage(BaseModel):
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2betaStateMessage]] = Field(default=None, description="State messages from the current Stage.", alias="stateMessages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "stateMessages": [GoogleCloudFunctionsV2betaStateMessage.from_dict(_item) for _item in obj["stateMessages"]] if obj.get("stateMessages") is not None else None
        })
        return _obj
