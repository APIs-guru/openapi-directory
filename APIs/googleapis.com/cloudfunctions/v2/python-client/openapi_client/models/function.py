...
class Function(BaseModel):
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2StateMessage]] = Field(default=None, description="Output only. State Messages for this Cloud Function.", alias="stateMessages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "stateMessages": [GoogleCloudFunctionsV2StateMessage.from_dict(_item) for _item in obj["stateMessages"]] if obj.get("stateMessages") is not None else None,
