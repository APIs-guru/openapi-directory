...
class GoogleCloudFunctionsV2Stage(BaseModel):
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2StateMessage]] = Field(default=None, description="State messages from the current Stage.", alias="stateMessages")
