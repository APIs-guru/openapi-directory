...
class GoogleCloudFunctionsV2betaOperationMetadata(BaseModel):
    ...
    stages: Optional[List[GoogleCloudFunctionsV2betaStage]] = Field(default=None, description="Mechanism for reporting in-progress stages")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudFunctionsV2betaOperationMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudFunctionsV2betaOperationMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stages": [GoogleCloudFunctionsV2betaStage.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None,
