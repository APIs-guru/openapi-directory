...
google_cloud_functions_v2alpha_operation_metadata_instance = GoogleCloudFunctionsV2alphaOperationMetadata.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudFunctionsV2alphaOperationMetadata.to_json())

# convert the object into a dict
google_cloud_functions_v2alpha_operation_metadata_dict = google_cloud_functions_v2alpha_operation_metadata_instance.to_dict()
# create an instance of GoogleCloudFunctionsV2alphaOperationMetadata from a dict
google_cloud_functions_v2alpha_operation_metadata_from_dict = GoogleCloudFunctionsV2alphaOperationMetadata.from_dict(google_cloud_functions_v2alpha_operation_metadata_dict)
```
