...
class Function(BaseModel):
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2betaStateMessage]] = Field(default=None, description="Output only. State Messages for this Cloud Function.", alias="stateMessages")
