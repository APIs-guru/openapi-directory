...
class HttpsTrigger(BaseModel):
    ...
    """ # noqa: E501
    security_level: Optional[StrictStr] = Field(default=None, description="The security level for the function.", alias="securityLevel")
    url: Optional[StrictStr] = Field(default=None, description="Output only. The deployed url for the function.")
    __properties: ClassVar[List[str]] = ["securityLevel", "url"]
