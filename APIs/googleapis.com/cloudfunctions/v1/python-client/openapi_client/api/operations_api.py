...
class OperationsApi:
    ...
    @validate_call
    def cloudfunctions_operations_list(
        self,
        ...
        _param = self._cloudfunctions_operations_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def cloudfunctions_operations_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def cloudfunctions_operations_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudfunctions_operations_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
