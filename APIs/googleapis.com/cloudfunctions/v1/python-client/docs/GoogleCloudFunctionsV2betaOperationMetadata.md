...
google_cloud_functions_v2beta_operation_metadata_instance = GoogleCloudFunctionsV2betaOperationMetadata.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudFunctionsV2betaOperationMetadata.to_json())

# convert the object into a dict
google_cloud_functions_v2beta_operation_metadata_dict = google_cloud_functions_v2beta_operation_metadata_instance.to_dict()
# create an instance of GoogleCloudFunctionsV2betaOperationMetadata from a dict
google_cloud_functions_v2beta_operation_metadata_from_dict = GoogleCloudFunctionsV2betaOperationMetadata.from_dict(google_cloud_functions_v2beta_operation_metadata_dict)
```
