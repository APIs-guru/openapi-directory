...
class TestGoogleCloudAiplatformV1beta1MutateDeployedModelRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1MutateDeployedModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1MutateDeployedModelRequest:
        """Test GoogleCloudAiplatformV1beta1MutateDeployedModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1MutateDeployedModelRequest`
        """
        model = GoogleCloudAiplatformV1beta1MutateDeployedModelRequest()
        if include_optional:
            return GoogleCloudAiplatformV1beta1MutateDeployedModelRequest(
    ...
    def testGoogleCloudAiplatformV1beta1MutateDeployedModelRequest(self):
        """Test GoogleCloudAiplatformV1beta1MutateDeployedModelRequest"""
