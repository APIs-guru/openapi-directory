...
class TestGoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig:
        """Test GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig`
        """
        model = GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig(self):
        """Test GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig"""
