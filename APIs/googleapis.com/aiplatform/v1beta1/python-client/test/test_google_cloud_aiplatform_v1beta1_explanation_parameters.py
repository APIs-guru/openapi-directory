...
class TestGoogleCloudAiplatformV1beta1ExplanationParameters(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ExplanationParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ExplanationParameters:
        """Test GoogleCloudAiplatformV1beta1ExplanationParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ExplanationParameters`
        """
        model = GoogleCloudAiplatformV1beta1ExplanationParameters()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1ExplanationParameters(self):
        """Test GoogleCloudAiplatformV1beta1ExplanationParameters"""
