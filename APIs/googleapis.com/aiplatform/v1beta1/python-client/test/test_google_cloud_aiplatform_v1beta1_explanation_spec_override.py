...
class TestGoogleCloudAiplatformV1beta1ExplanationSpecOverride(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ExplanationSpecOverride unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ExplanationSpecOverride:
        """Test GoogleCloudAiplatformV1beta1ExplanationSpecOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ExplanationSpecOverride`
        """
        model = GoogleCloudAiplatformV1beta1ExplanationSpecOverride()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ExplanationSpecOverride(
    ...
    def testGoogleCloudAiplatformV1beta1ExplanationSpecOverride(self):
        """Test GoogleCloudAiplatformV1beta1ExplanationSpecOverride"""
