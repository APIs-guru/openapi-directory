...
class TestGoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob:
        """Test GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob`
        """
        model = GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob(
    ...
    def testGoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob(self):
        """Test GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJob"""
