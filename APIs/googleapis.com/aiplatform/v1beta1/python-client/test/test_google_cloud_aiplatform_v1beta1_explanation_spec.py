...
class TestGoogleCloudAiplatformV1beta1ExplanationSpec(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ExplanationSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ExplanationSpec:
        """Test GoogleCloudAiplatformV1beta1ExplanationSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ExplanationSpec`
        """
        model = GoogleCloudAiplatformV1beta1ExplanationSpec()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1ExplanationSpec(self):
        """Test GoogleCloudAiplatformV1beta1ExplanationSpec"""
