...
class TestGoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig:
        """Test GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig`
        """
        model = GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig(self):
        """Test GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig"""
