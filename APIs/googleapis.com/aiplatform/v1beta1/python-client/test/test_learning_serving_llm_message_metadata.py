...
class TestLearningServingLlmMessageMetadata(unittest.TestCase):
    """LearningServingLlmMessageMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningServingLlmMessageMetadata:
        """Test LearningServingLlmMessageMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningServingLlmMessageMetadata`
        """
        model = LearningServingLlmMessageMetadata()
        if include_optional:
    ...
    def testLearningServingLlmMessageMetadata(self):
        """Test LearningServingLlmMessageMetadata"""
