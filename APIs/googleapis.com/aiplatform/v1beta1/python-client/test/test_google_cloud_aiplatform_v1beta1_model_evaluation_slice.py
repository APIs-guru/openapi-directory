...
class TestGoogleCloudAiplatformV1beta1ModelEvaluationSlice(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ModelEvaluationSlice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ModelEvaluationSlice:
        """Test GoogleCloudAiplatformV1beta1ModelEvaluationSlice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ModelEvaluationSlice`
        """
        model = GoogleCloudAiplatformV1beta1ModelEvaluationSlice()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ModelEvaluationSlice(
                create_time = '',
                metrics = None,
                metrics_schema_uri = '',
    ...
    def testGoogleCloudAiplatformV1beta1ModelEvaluationSlice(self):
        """Test GoogleCloudAiplatformV1beta1ModelEvaluationSlice"""
