...
class TestCloudAiLargeModelsVisionMediaGenerateContentResponse(unittest.TestCase):
    """CloudAiLargeModelsVisionMediaGenerateContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudAiLargeModelsVisionMediaGenerateContentResponse:
        """Test CloudAiLargeModelsVisionMediaGenerateContentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudAiLargeModelsVisionMediaGenerateContentResponse`
        """
        model = CloudAiLargeModelsVisionMediaGenerateContentResponse()
        if include_optional:
            return CloudAiLargeModelsVisionMediaGenerateContentResponse(
                response = openapi_client.models.cloud_ai_nl_llm_proto_service_generate_multi_modal_response.CloudAiNlLlmProtoServiceGenerateMultiModalResponse(
                    candidates = [
    ...
    def testCloudAiLargeModelsVisionMediaGenerateContentResponse(self):
        """Test CloudAiLargeModelsVisionMediaGenerateContentResponse"""
