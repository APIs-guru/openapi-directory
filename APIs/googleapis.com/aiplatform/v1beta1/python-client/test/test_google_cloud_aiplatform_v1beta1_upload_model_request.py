...
class TestGoogleCloudAiplatformV1beta1UploadModelRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1UploadModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1UploadModelRequest:
        """Test GoogleCloudAiplatformV1beta1UploadModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1UploadModelRequest`
        """
        model = GoogleCloudAiplatformV1beta1UploadModelRequest()
        if include_optional:
            return GoogleCloudAiplatformV1beta1UploadModelRequest(
                model = openapi_client.models.google_cloud_aiplatform_v1beta1_model.GoogleCloudAiplatformV1beta1Model(
                    artifact_uri = '', 
    ...
    def testGoogleCloudAiplatformV1beta1UploadModelRequest(self):
        """Test GoogleCloudAiplatformV1beta1UploadModelRequest"""
