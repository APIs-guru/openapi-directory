...
class TestGoogleCloudAiplatformV1beta1FeatureOnlineStore(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1FeatureOnlineStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1FeatureOnlineStore:
        """Test GoogleCloudAiplatformV1beta1FeatureOnlineStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1FeatureOnlineStore`
        """
        model = GoogleCloudAiplatformV1beta1FeatureOnlineStore()
        if include_optional:
            return GoogleCloudAiplatformV1beta1FeatureOnlineStore(
    ...
    def testGoogleCloudAiplatformV1beta1FeatureOnlineStore(self):
        """Test GoogleCloudAiplatformV1beta1FeatureOnlineStore"""
