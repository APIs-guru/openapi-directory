...
class TestGoogleCloudAiplatformV1beta1SmoothGradConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1SmoothGradConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1SmoothGradConfig:
        """Test GoogleCloudAiplatformV1beta1SmoothGradConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1SmoothGradConfig`
        """
        model = GoogleCloudAiplatformV1beta1SmoothGradConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1SmoothGradConfig(self):
        """Test GoogleCloudAiplatformV1beta1SmoothGradConfig"""
