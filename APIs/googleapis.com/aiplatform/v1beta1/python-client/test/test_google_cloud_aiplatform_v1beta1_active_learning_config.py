...
class TestGoogleCloudAiplatformV1beta1ActiveLearningConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ActiveLearningConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ActiveLearningConfig:
        """Test GoogleCloudAiplatformV1beta1ActiveLearningConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ActiveLearningConfig`
        """
        model = GoogleCloudAiplatformV1beta1ActiveLearningConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1ActiveLearningConfig(self):
        """Test GoogleCloudAiplatformV1beta1ActiveLearningConfig"""
