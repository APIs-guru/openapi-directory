...
class TestGoogleCloudAiplatformV1beta1QueryDeployedModelsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse:
        """Test GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse`
        """
        model = GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse(
                deployed_model_refs = [
                ...
                next_page_token = '',
                total_deployed_model_count = 56,
                total_endpoint_count = 56
            )
        else:
            return GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse(
        )
    ...
    def testGoogleCloudAiplatformV1beta1QueryDeployedModelsResponse(self):
        """Test GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse"""
