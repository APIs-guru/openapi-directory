...
class TestGoogleCloudAiplatformV1beta1CustomJobSpec(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1CustomJobSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1CustomJobSpec:
        """Test GoogleCloudAiplatformV1beta1CustomJobSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1CustomJobSpec`
        """
        model = GoogleCloudAiplatformV1beta1CustomJobSpec()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1CustomJobSpec(self):
        """Test GoogleCloudAiplatformV1beta1CustomJobSpec"""
