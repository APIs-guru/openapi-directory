...
class TestGoogleCloudAiplatformV1beta1ListModelVersionsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ListModelVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ListModelVersionsResponse:
        """Test GoogleCloudAiplatformV1beta1ListModelVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ListModelVersionsResponse`
        """
        model = GoogleCloudAiplatformV1beta1ListModelVersionsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ListModelVersionsResponse(
                models = [
    ...
    def testGoogleCloudAiplatformV1beta1ListModelVersionsResponse(self):
        """Test GoogleCloudAiplatformV1beta1ListModelVersionsResponse"""
