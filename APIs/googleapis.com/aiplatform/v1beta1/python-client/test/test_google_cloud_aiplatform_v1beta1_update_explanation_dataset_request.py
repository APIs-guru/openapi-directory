...
class TestGoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest:
        """Test GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest`
        """
        model = GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest()
        if include_optional:
            return GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest(
    ...
    def testGoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest(self):
        """Test GoogleCloudAiplatformV1beta1UpdateExplanationDatasetRequest"""
