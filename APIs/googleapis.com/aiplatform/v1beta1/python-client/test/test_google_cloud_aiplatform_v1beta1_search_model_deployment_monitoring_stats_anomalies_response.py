...
class TestGoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse:
        """Test GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse`
        """
        model = GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse()
        if include_optional:
            return GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse(
                monitoring_stats = [
    ...
    def testGoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse(self):
        """Test GoogleCloudAiplatformV1beta1SearchModelDeploymentMonitoringStatsAnomaliesResponse"""
