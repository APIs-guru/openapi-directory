...
class TestGoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse:
        """Test GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse`
        """
        model = GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse(
                next_page_token = '',
                training_pipelines = [
                    openapi_client.models.google_cloud_aiplatform_v1beta1_training_pipeline.GoogleCloudAiplatformV1beta1TrainingPipeline(
                        create_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse(self):
        """Test GoogleCloudAiplatformV1beta1ListTrainingPipelinesResponse"""
