...
class TestGoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata:
        """Test GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata`
        """
        model = GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata()
        if include_optional:
            return GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata(
    ...
    def testGoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata(self):
        """Test GoogleCloudAiplatformV1beta1UpdateIndexOperationMetadata"""
