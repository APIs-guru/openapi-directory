...
class TestLearningGenaiRootRoutingDecision(unittest.TestCase):
    """LearningGenaiRootRoutingDecision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningGenaiRootRoutingDecision:
        """Test LearningGenaiRootRoutingDecision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningGenaiRootRoutingDecision`
        """
        model = LearningGenaiRootRoutingDecision()
        if include_optional:
    ...
    def testLearningGenaiRootRoutingDecision(self):
        """Test LearningGenaiRootRoutingDecision"""
