...
class TestGoogleCloudAiplatformV1beta1CustomJob(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1CustomJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1CustomJob:
        """Test GoogleCloudAiplatformV1beta1CustomJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1CustomJob`
        """
        model = GoogleCloudAiplatformV1beta1CustomJob()
        if include_optional:
            return GoogleCloudAiplatformV1beta1CustomJob(
                create_time = '',
                display_name = '',
    ...
    def testGoogleCloudAiplatformV1beta1CustomJob(self):
        """Test GoogleCloudAiplatformV1beta1CustomJob"""
