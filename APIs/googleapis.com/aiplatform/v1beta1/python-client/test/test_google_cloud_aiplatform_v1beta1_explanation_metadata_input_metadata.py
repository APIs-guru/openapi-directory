...
class TestGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata:
        """Test GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata`
        """
        model = GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata(
    ...
    def testGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata(self):
        """Test GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata"""
