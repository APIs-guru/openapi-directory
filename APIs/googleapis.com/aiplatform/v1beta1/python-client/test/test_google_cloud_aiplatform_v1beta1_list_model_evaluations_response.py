...
class TestGoogleCloudAiplatformV1beta1ListModelEvaluationsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse:
        """Test GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse`
        """
        model = GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse(
                model_evaluations = [
                    openapi_client.models.google_cloud_aiplatform_v1beta1_model_evaluation.GoogleCloudAiplatformV1beta1ModelEvaluation(
    ...
    def testGoogleCloudAiplatformV1beta1ListModelEvaluationsResponse(self):
        """Test GoogleCloudAiplatformV1beta1ListModelEvaluationsResponse"""
