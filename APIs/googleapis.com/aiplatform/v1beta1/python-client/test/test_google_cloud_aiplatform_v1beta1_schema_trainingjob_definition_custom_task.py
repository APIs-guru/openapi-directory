...
class TestGoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask:
        """Test GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask`
        """
        model = GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask()
        if include_optional:
            return GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask(
                inputs = openapi_client.models.google_cloud_aiplatform_v1beta1_custom_job_spec.GoogleCloudAiplatformV1beta1CustomJobSpec(
                ...
                metadata = openapi_client.models.google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_custom_job_metadata.GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomJobMetadata(
                    backing_custom_job = '', )
            )
        else:
            return GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask(
    ...
    def testGoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask(self):
        """Test GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask"""
