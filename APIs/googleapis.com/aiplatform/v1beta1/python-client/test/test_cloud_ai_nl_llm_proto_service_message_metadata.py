...
class TestCloudAiNlLlmProtoServiceMessageMetadata(unittest.TestCase):
    """CloudAiNlLlmProtoServiceMessageMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudAiNlLlmProtoServiceMessageMetadata:
        """Test CloudAiNlLlmProtoServiceMessageMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudAiNlLlmProtoServiceMessageMetadata`
        """
        model = CloudAiNlLlmProtoServiceMessageMetadata()
        if include_optional:
    ...
    def testCloudAiNlLlmProtoServiceMessageMetadata(self):
        """Test CloudAiNlLlmProtoServiceMessageMetadata"""
