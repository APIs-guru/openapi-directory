...
class TestGoogleCloudAiplatformV1beta1IntegratedGradientsAttribution(unittest.TestCase):
    """GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution:
        """Test GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution`
        """
        model = GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1beta1IntegratedGradientsAttribution(self):
        """Test GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution"""
