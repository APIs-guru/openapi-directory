...
class GoogleCloudAiplatformV1beta1CreateFeatureRequest(BaseModel):
    """
    Request message for FeaturestoreService.CreateFeature. Request message for FeatureRegistryService.CreateFeature.
    """ # noqa: E501
    feature: Optional[GoogleCloudAiplatformV1beta1Feature] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feature": GoogleCloudAiplatformV1beta1Feature.from_dict(obj["feature"]) if obj.get("feature") is not None else None,
