...
class GoogleCloudAiplatformV1beta1PipelineTaskDetailArtifactList(BaseModel):
    """
    A list of artifact metadata.
    """ # noqa: E501
    artifacts: Optional[List[GoogleCloudAiplatformV1beta1Artifact]] = Field(default=None, description="Output only. A list of artifact metadata.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": [GoogleCloudAiplatformV1beta1Artifact.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None
        })
        return _obj
