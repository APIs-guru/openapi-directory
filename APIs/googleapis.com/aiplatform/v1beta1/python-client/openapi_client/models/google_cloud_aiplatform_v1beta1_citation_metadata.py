...
class GoogleCloudAiplatformV1beta1CitationMetadata(BaseModel):
    """
    A collection of source attributions for a piece of content.
    """ # noqa: E501
    citations: Optional[List[GoogleCloudAiplatformV1beta1Citation]] = Field(default=None, description="Output only. List of citations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "citations": [GoogleCloudAiplatformV1beta1Citation.from_dict(_item) for _item in obj["citations"]] if obj.get("citations") is not None else None
        })
        return _obj
