...
class GoogleCloudAiplatformV1beta1NearestNeighborQueryEmbedding(BaseModel):
    """
    The embedding vector.
    """ # noqa: E501
    value: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Optional. Individual value in the embedding.")
