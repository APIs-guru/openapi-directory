...
class GoogleCloudAiplatformV1beta1CreatePipelineJobRequest(BaseModel):
    """
    ...
    pipeline_job: Optional[GoogleCloudAiplatformV1beta1PipelineJob] = Field(default=None, alias="pipelineJob")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pipelineJob": GoogleCloudAiplatformV1beta1PipelineJob.from_dict(obj["pipelineJob"]) if obj.get("pipelineJob") is not None else None,
