...
class GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies(BaseModel):
    """
    ...
    prediction_stats: Optional[List[GoogleCloudAiplatformV1beta1FeatureStatsAnomaly]] = Field(default=None, description="A list of historical stats generated by different time window's Prediction Dataset.", alias="predictionStats")
    threshold: Optional[GoogleCloudAiplatformV1beta1ThresholdConfig] = None
    training_stats: Optional[GoogleCloudAiplatformV1beta1FeatureStatsAnomaly] = Field(default=None, alias="trainingStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predictionStats": [GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.from_dict(_item) for _item in obj["predictionStats"]] if obj.get("predictionStats") is not None else None,
            "threshold": GoogleCloudAiplatformV1beta1ThresholdConfig.from_dict(obj["threshold"]) if obj.get("threshold") is not None else None,
            "trainingStats": GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.from_dict(obj["trainingStats"]) if obj.get("trainingStats") is not None else None
        })
        return _obj
