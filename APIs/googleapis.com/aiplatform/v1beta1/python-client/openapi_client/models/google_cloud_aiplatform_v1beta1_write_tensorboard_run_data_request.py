...
class GoogleCloudAiplatformV1beta1WriteTensorboardRunDataRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeSeriesData": [GoogleCloudAiplatformV1beta1TimeSeriesData.from_dict(_item) for _item in obj["timeSeriesData"]] if obj.get("timeSeriesData") is not None else None
        })
        return _obj
