...
class GoogleCloudAiplatformV1beta1DataItemView(BaseModel):
    """
    A container for a single DataItem and Annotations on it.
    """ # noqa: E501
    annotations: Optional[List[GoogleCloudAiplatformV1beta1Annotation]] = Field(default=None, description="The Annotations on the DataItem. If too many Annotations should be returned for the DataItem, this field will be truncated per annotations_limit in request. If it was, then the has_truncated_annotations will be set to true.")
    data_item: Optional[GoogleCloudAiplatformV1beta1DataItem] = Field(default=None, alias="dataItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataItem": GoogleCloudAiplatformV1beta1DataItem.from_dict(obj["dataItem"]) if obj.get("dataItem") is not None else None,
