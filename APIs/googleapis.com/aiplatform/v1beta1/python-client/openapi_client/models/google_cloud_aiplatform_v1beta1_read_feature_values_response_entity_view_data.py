...
class GoogleCloudAiplatformV1beta1ReadFeatureValuesResponseEntityViewData(BaseModel):
    """
    Container to hold value(s), successive in time, for one Feature from the request.
    """ # noqa: E501
    value: Optional[GoogleCloudAiplatformV1beta1FeatureValue] = None
    values: Optional[GoogleCloudAiplatformV1beta1FeatureValueList] = None
    __properties: ClassVar[List[str]] = ["value", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": GoogleCloudAiplatformV1beta1FeatureValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "values": GoogleCloudAiplatformV1beta1FeatureValueList.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
