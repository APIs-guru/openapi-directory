...
class GoogleCloudAiplatformV1beta1SchemaPredictPredictionVideoObjectTrackingPredictionResult(BaseModel):
    """
    ...
    frames: Optional[List[GoogleCloudAiplatformV1beta1SchemaPredictPredictionVideoObjectTrackingPredictionResultFrame]] = Field(default=None, description="All of the frames of the video in which a single object instance has been detected. The bounding boxes in the frames identify the same object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frames": [GoogleCloudAiplatformV1beta1SchemaPredictPredictionVideoObjectTrackingPredictionResultFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
            "id": obj.get("id"),
