...
class GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig(BaseModel):
    """
    ...
    input_artifacts: Optional[Dict[str, GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigInputArtifact]] = Field(default=None, description="The runtime artifacts of the PipelineJob. The key will be the input artifact name and the value would be one of the InputArtifact.", alias="inputArtifacts")
    ...
    parameters: Optional[Dict[str, GoogleCloudAiplatformV1beta1Value]] = Field(default=None, description="Deprecated. Use RuntimeConfig.parameter_values instead. The runtime parameters of the PipelineJob. The parameters will be passed into PipelineJob.pipeline_spec to replace the placeholders at runtime. This field is used by pipelines built using `PipelineJob.pipeline_spec.schema_version` 2.0.0 or lower, such as pipelines built using Kubeflow Pipelines SDK 1.8 or lower.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputArtifacts": dict(
                (_k, GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigInputArtifact.from_dict(_v))
            ...
            "parameters": dict(
                (_k, GoogleCloudAiplatformV1beta1Value.from_dict(_v))
