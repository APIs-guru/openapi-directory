...
class GoogleCloudAiplatformV1beta1SchemaPredictPredictionTimeSeriesForecastingPredictionResult(BaseModel):
    """
    ...
    tft_feature_importance: Optional[GoogleCloudAiplatformV1beta1SchemaPredictPredictionTftFeatureImportance] = Field(default=None, alias="tftFeatureImportance")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tftFeatureImportance": GoogleCloudAiplatformV1beta1SchemaPredictPredictionTftFeatureImportance.from_dict(obj["tftFeatureImportance"]) if obj.get("tftFeatureImportance") is not None else None,
            "value": obj.get("value")
        })
        return _obj
