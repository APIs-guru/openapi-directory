...
class GoogleCloudAiplatformV1beta1SchemaPredictionResultError(BaseModel):
    """
    GoogleCloudAiplatformV1beta1SchemaPredictionResultError
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Error message with additional details.")
    status: Optional[StrictStr] = Field(default=None, description="Error status. This will be serialized into the enum name e.g. \"NOT_FOUND\".")
