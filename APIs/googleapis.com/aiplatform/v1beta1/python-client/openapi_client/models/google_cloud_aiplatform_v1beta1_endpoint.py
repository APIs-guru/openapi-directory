...
class GoogleCloudAiplatformV1beta1Endpoint(BaseModel):
    """
    ...
    deployed_models: Optional[List[GoogleCloudAiplatformV1beta1DeployedModel]] = Field(default=None, description="Output only. The models deployed in this Endpoint. To add or remove DeployedModels use EndpointService.DeployModel and EndpointService.UndeployModel respectively.", alias="deployedModels")
    ...
    predict_request_response_logging_config: Optional[GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig] = Field(default=None, alias="predictRequestResponseLoggingConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predictRequestResponseLoggingConfig": GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig.from_dict(obj["predictRequestResponseLoggingConfig"]) if obj.get("predictRequestResponseLoggingConfig") is not None else None,
