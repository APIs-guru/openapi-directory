...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageSegmentation(BaseModel):
    """
    A TrainingJob that trains and uploads an AutoML Image Segmentation Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageSegmentationInputs] = None
    metadata: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageSegmentationMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageSegmentationInputs.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "metadata": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageSegmentationMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
