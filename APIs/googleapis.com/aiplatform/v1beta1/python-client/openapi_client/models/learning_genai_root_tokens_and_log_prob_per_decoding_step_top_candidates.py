...
class LearningGenaiRootTokensAndLogProbPerDecodingStepTopCandidates(BaseModel):
    """
    Candidates with top log probabilities at each decoding step.
    """ # noqa: E501
    candidates: Optional[List[LearningGenaiRootTokensAndLogProbPerDecodingStepCandidate]] = Field(default=None, description="Sorted by log probability in descending order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "candidates": [LearningGenaiRootTokensAndLogProbPerDecodingStepCandidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None
        })
        return _obj
