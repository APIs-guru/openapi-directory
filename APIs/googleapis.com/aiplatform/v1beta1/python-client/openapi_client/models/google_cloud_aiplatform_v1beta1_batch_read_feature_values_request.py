...
class GoogleCloudAiplatformV1beta1BatchReadFeatureValuesRequest(BaseModel):
    """
    Request message for FeaturestoreService.BatchReadFeatureValues.
    """ # noqa: E501
    bigquery_read_instances: Optional[GoogleCloudAiplatformV1beta1BigQuerySource] = Field(default=None, alias="bigqueryReadInstances")
    csv_read_instances: Optional[GoogleCloudAiplatformV1beta1CsvSource] = Field(default=None, alias="csvReadInstances")
    destination: Optional[GoogleCloudAiplatformV1beta1FeatureValueDestination] = None
    entity_type_specs: Optional[List[GoogleCloudAiplatformV1beta1BatchReadFeatureValuesRequestEntityTypeSpec]] = Field(default=None, description="Required. Specifies EntityType grouping Features to read values of and settings.", alias="entityTypeSpecs")
    pass_through_fields: Optional[List[GoogleCloudAiplatformV1beta1BatchReadFeatureValuesRequestPassThroughField]] = Field(default=None, description="When not empty, the specified fields in the *_read_instances source will be joined as-is in the output, in addition to those fields from the Featurestore Entity. For BigQuery source, the type of the pass-through values will be automatically inferred. For CSV source, the pass-through values will be passed as opaque bytes.", alias="passThroughFields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryReadInstances": GoogleCloudAiplatformV1beta1BigQuerySource.from_dict(obj["bigqueryReadInstances"]) if obj.get("bigqueryReadInstances") is not None else None,
            "csvReadInstances": GoogleCloudAiplatformV1beta1CsvSource.from_dict(obj["csvReadInstances"]) if obj.get("csvReadInstances") is not None else None,
            "destination": GoogleCloudAiplatformV1beta1FeatureValueDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            "entityTypeSpecs": [GoogleCloudAiplatformV1beta1BatchReadFeatureValuesRequestEntityTypeSpec.from_dict(_item) for _item in obj["entityTypeSpecs"]] if obj.get("entityTypeSpecs") is not None else None,
            "passThroughFields": [GoogleCloudAiplatformV1beta1BatchReadFeatureValuesRequestPassThroughField.from_dict(_item) for _item in obj["passThroughFields"]] if obj.get("passThroughFields") is not None else None,
