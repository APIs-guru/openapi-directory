...
class GoogleCloudAiplatformV1beta1BatchReadTensorboardTimeSeriesDataResponse(BaseModel):
    """
    Response message for TensorboardService.BatchReadTensorboardTimeSeriesData.
    """ # noqa: E501
    time_series_data: Optional[List[GoogleCloudAiplatformV1beta1TimeSeriesData]] = Field(default=None, description="The returned time series data.", alias="timeSeriesData")
