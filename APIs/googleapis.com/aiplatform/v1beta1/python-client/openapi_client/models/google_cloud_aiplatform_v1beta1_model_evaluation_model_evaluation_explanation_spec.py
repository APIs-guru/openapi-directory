...
class GoogleCloudAiplatformV1beta1ModelEvaluationModelEvaluationExplanationSpec(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["explanationSpec", "explanationType"]
