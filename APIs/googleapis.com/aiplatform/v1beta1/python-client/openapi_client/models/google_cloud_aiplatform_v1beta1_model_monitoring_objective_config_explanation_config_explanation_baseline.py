...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaseline(BaseModel):
    """
    Output from BatchPredictionJob for Model Monitoring baseline dataset, which can be used to generate baseline attribution scores.
    """ # noqa: E501
    bigquery: Optional[GoogleCloudAiplatformV1beta1BigQueryDestination] = None
    gcs: Optional[GoogleCloudAiplatformV1beta1GcsDestination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigquery": GoogleCloudAiplatformV1beta1BigQueryDestination.from_dict(obj["bigquery"]) if obj.get("bigquery") is not None else None,
            "gcs": GoogleCloudAiplatformV1beta1GcsDestination.from_dict(obj["gcs"]) if obj.get("gcs") is not None else None,
