...
class GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig(BaseModel):
    """
    ...
    predictions_format: Optional[StrictStr] = Field(default=None, description="Required. The format in which Vertex AI gives the predictions, must be one of the Model's supported_output_storage_formats.", alias="predictionsFormat")
    __properties: ClassVar[List[str]] = ["bigqueryDestination", "gcsDestination", "predictionsFormat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predictionsFormat": obj.get("predictionsFormat")
        })
        return _obj
