...
class GoogleCloudAiplatformV1beta1FetchFeatureValuesResponseFeatureNameValuePairListFeatureNameValuePair(BaseModel):
    """
    Feature name & value pair.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Feature short name.")
