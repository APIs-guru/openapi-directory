...
class IntelligenceCloudAutomlXpsMetricEntry(BaseModel):
    """
    ...
    system_labels: Optional[List[IntelligenceCloudAutomlXpsMetricEntryLabel]] = Field(default=None, description="Billing system labels for this (metric, value) pair.", alias="systemLabels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "systemLabels": [IntelligenceCloudAutomlXpsMetricEntryLabel.from_dict(_item) for _item in obj["systemLabels"]] if obj.get("systemLabels") is not None else None
        })
        return _obj
