...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsTextExtractionEvaluationMetrics(BaseModel):
    """
    Metrics for text extraction evaluation results.
    """ # noqa: E501
    confidence_metrics: Optional[List[GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsTextExtractionEvaluationMetricsConfidenceMetrics]] = Field(default=None, description="Metrics that have confidence thresholds. Precision-recall curve can be derived from them.", alias="confidenceMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidenceMetrics": [GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsTextExtractionEvaluationMetricsConfidenceMetrics.from_dict(_item) for _item in obj["confidenceMetrics"]] if obj.get("confidenceMetrics") is not None else None,
