...
class GoogleCloudAiplatformV1beta1Feature(BaseModel):
    """
    ...
    monitoring_stats: Optional[List[GoogleCloudAiplatformV1beta1FeatureStatsAnomaly]] = Field(default=None, description="Output only. Only applicable for Vertex AI Feature Store (Legacy). A list of historical SnapshotAnalysis stats requested by user, sorted by FeatureStatsAnomaly.start_time descending.", alias="monitoringStats")
    monitoring_stats_anomalies: Optional[List[GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomaly]] = Field(default=None, description="Output only. Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives.", alias="monitoringStatsAnomalies")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "description", "disableMonitoring", "etag", "labels", "monitoringConfig", "monitoringStats", "monitoringStatsAnomalies", "name", "pointOfContact", "updateTime", "valueType", "versionColumnName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitoringStats": [GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.from_dict(_item) for _item in obj["monitoringStats"]] if obj.get("monitoringStats") is not None else None,
            "monitoringStatsAnomalies": [GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomaly.from_dict(_item) for _item in obj["monitoringStatsAnomalies"]] if obj.get("monitoringStatsAnomalies") is not None else None,
            "name": obj.get("name"),
