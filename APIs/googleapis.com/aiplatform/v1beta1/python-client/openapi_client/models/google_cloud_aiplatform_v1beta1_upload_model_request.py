...
class GoogleCloudAiplatformV1beta1UploadModelRequest(BaseModel):
    """
    Request message for ModelService.UploadModel.
    """ # noqa: E501
    model: Optional[GoogleCloudAiplatformV1beta1Model] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": GoogleCloudAiplatformV1beta1Model.from_dict(obj["model"]) if obj.get("model") is not None else None,
