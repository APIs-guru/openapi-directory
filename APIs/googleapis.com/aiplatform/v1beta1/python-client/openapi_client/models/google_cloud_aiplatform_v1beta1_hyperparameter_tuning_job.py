...
class GoogleCloudAiplatformV1beta1HyperparameterTuningJob(BaseModel):
    """
    ...
    trials: Optional[List[GoogleCloudAiplatformV1beta1Trial]] = Field(default=None, description="Output only. Trials of the HyperparameterTuningJob.")
