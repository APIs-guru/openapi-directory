...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsQuestionAnsweringEvaluationMetrics(BaseModel):
    """
    GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsQuestionAnsweringEvaluationMetrics
    """ # noqa: E501
    exact_match: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The rate at which the input predicted strings exactly match their references.", alias="exactMatch")
    __properties: ClassVar[List[str]] = ["exactMatch"]
