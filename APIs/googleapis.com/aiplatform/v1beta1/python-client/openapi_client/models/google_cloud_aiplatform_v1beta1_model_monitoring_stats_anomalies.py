...
class GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies(BaseModel):
    """
    ...
    feature_stats: Optional[List[GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies]] = Field(default=None, description="A list of historical Stats and Anomalies generated for all Features.", alias="featureStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "featureStats": [GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies.from_dict(_item) for _item in obj["featureStats"]] if obj.get("featureStats") is not None else None,
