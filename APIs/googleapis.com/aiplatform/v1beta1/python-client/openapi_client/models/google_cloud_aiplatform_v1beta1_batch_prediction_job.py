...
class GoogleCloudAiplatformV1beta1BatchPredictionJob(BaseModel):
    """
    ...
    """ # noqa: E501
    completion_stats: Optional[GoogleCloudAiplatformV1beta1CompletionStats] = Field(default=None, alias="completionStats")
    ...
    dedicated_resources: Optional[GoogleCloudAiplatformV1beta1BatchDedicatedResources] = Field(default=None, alias="dedicatedResources")
    ...
    input_config: Optional[GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig] = Field(default=None, alias="inputConfig")
    instance_config: Optional[GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig] = Field(default=None, alias="instanceConfig")
    ...
    manual_batch_tuning_parameters: Optional[GoogleCloudAiplatformV1beta1ManualBatchTuningParameters] = Field(default=None, alias="manualBatchTuningParameters")
    ...
    model_monitoring_config: Optional[GoogleCloudAiplatformV1beta1ModelMonitoringConfig] = Field(default=None, alias="modelMonitoringConfig")
    model_monitoring_stats_anomalies: Optional[List[GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies]] = Field(default=None, description="Get batch prediction job monitoring statistics.", alias="modelMonitoringStatsAnomalies")
    model_monitoring_status: Optional[GoogleRpcStatus] = Field(default=None, alias="modelMonitoringStatus")
    ...
    output_config: Optional[GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig] = Field(default=None, alias="outputConfig")
    output_info: Optional[GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfo] = Field(default=None, alias="outputInfo")
    ...
    resources_consumed: Optional[GoogleCloudAiplatformV1beta1ResourcesConsumed] = Field(default=None, alias="resourcesConsumed")
    ...
    unmanaged_container_model: Optional[GoogleCloudAiplatformV1beta1UnmanagedContainerModel] = Field(default=None, alias="unmanagedContainerModel")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of model_monitoring_config
        if self.model_monitoring_config:
            _dict['modelMonitoringConfig'] = self.model_monitoring_config.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in model_monitoring_stats_anomalies (list)
        _items = []
        if self.model_monitoring_stats_anomalies:
            for _item_model_monitoring_stats_anomalies in self.model_monitoring_stats_anomalies:
                if _item_model_monitoring_stats_anomalies:
                    _items.append(_item_model_monitoring_stats_anomalies.to_dict())
            _dict['modelMonitoringStatsAnomalies'] = _items
        # override the default output from pydantic by calling `to_dict()` of model_monitoring_status
        if self.model_monitoring_status:
            _dict['modelMonitoringStatus'] = self.model_monitoring_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completionStats": GoogleCloudAiplatformV1beta1CompletionStats.from_dict(obj["completionStats"]) if obj.get("completionStats") is not None else None,
            "createTime": obj.get("createTime"),
            "dedicatedResources": GoogleCloudAiplatformV1beta1BatchDedicatedResources.from_dict(obj["dedicatedResources"]) if obj.get("dedicatedResources") is not None else None,
            ...
            "inputConfig": GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None,
            "instanceConfig": GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig.from_dict(obj["instanceConfig"]) if obj.get("instanceConfig") is not None else None,
            "labels": obj.get("labels"),
            "manualBatchTuningParameters": GoogleCloudAiplatformV1beta1ManualBatchTuningParameters.from_dict(obj["manualBatchTuningParameters"]) if obj.get("manualBatchTuningParameters") is not None else None,
            "model": obj.get("model"),
            "modelMonitoringConfig": GoogleCloudAiplatformV1beta1ModelMonitoringConfig.from_dict(obj["modelMonitoringConfig"]) if obj.get("modelMonitoringConfig") is not None else None,
            "modelMonitoringStatsAnomalies": [GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies.from_dict(_item) for _item in obj["modelMonitoringStatsAnomalies"]] if obj.get("modelMonitoringStatsAnomalies") is not None else None,
            "modelMonitoringStatus": GoogleRpcStatus.from_dict(obj["modelMonitoringStatus"]) if obj.get("modelMonitoringStatus") is not None else None,
            "modelParameters": obj.get("modelParameters"),
            "modelVersionId": obj.get("modelVersionId"),
            "name": obj.get("name"),
            "outputConfig": GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig.from_dict(obj["outputConfig"]) if obj.get("outputConfig") is not None else None,
            "outputInfo": GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfo.from_dict(obj["outputInfo"]) if obj.get("outputInfo") is not None else None,
            ...
            "resourcesConsumed": GoogleCloudAiplatformV1beta1ResourcesConsumed.from_dict(obj["resourcesConsumed"]) if obj.get("resourcesConsumed") is not None else None,
            "serviceAccount": obj.get("serviceAccount"),
            "startTime": obj.get("startTime"),
            "state": obj.get("state"),
            "unmanagedContainerModel": GoogleCloudAiplatformV1beta1UnmanagedContainerModel.from_dict(obj["unmanagedContainerModel"]) if obj.get("unmanagedContainerModel") is not None else None,
