...
class GoogleCloudAiplatformV1beta1Value(BaseModel):
    """
    Value is the value of the field.
    """ # noqa: E501
    double_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A double value.", alias="doubleValue")
    int_value: Optional[StrictStr] = Field(default=None, description="An integer value.", alias="intValue")
    string_value: Optional[StrictStr] = Field(default=None, description="A string value.", alias="stringValue")
    __properties: ClassVar[List[str]] = ["doubleValue", "intValue", "stringValue"]
