...
class GoogleCloudAiplatformV1beta1Schedule(BaseModel):
    """
    ...
    create_pipeline_job_request: Optional[GoogleCloudAiplatformV1beta1CreatePipelineJobRequest] = Field(default=None, alias="createPipelineJobRequest")
    ...
    last_scheduled_run_response: Optional[GoogleCloudAiplatformV1beta1ScheduleRunResponse] = Field(default=None, alias="lastScheduledRunResponse")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1Schedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1Schedule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "createPipelineJobRequest": GoogleCloudAiplatformV1beta1CreatePipelineJobRequest.from_dict(obj["createPipelineJobRequest"]) if obj.get("createPipelineJobRequest") is not None else None,
            ...
            "lastScheduledRunResponse": GoogleCloudAiplatformV1beta1ScheduleRunResponse.from_dict(obj["lastScheduledRunResponse"]) if obj.get("lastScheduledRunResponse") is not None else None,
