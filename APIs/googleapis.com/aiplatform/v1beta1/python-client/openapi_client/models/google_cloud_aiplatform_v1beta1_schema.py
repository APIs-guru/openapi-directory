...
class GoogleCloudAiplatformV1beta1Schema(BaseModel):
    """
    ...
    items: Optional[GoogleCloudAiplatformV1beta1Schema] = None
    nullable: Optional[StrictBool] = Field(default=None, description="Optional. Indicates if the value may be null.")
    properties: Optional[Dict[str, GoogleCloudAiplatformV1beta1Schema]] = Field(default=None, description="Optional. Properties of Type.OBJECT.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": GoogleCloudAiplatformV1beta1Schema.from_dict(obj["items"]) if obj.get("items") is not None else None,
            "nullable": obj.get("nullable"),
            "properties": dict(
                (_k, GoogleCloudAiplatformV1beta1Schema.from_dict(_v))
...
GoogleCloudAiplatformV1beta1Schema.model_rebuild(raise_errors=False)
