...
class GoogleCloudAiplatformV1beta1PublisherModelCallToActionDeploy(BaseModel):
    """
    ...
    container_spec: Optional[GoogleCloudAiplatformV1beta1ModelContainerSpec] = Field(default=None, alias="containerSpec")
    dedicated_resources: Optional[GoogleCloudAiplatformV1beta1DedicatedResources] = Field(default=None, alias="dedicatedResources")
    large_model_reference: Optional[GoogleCloudAiplatformV1beta1LargeModelReference] = Field(default=None, alias="largeModelReference")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "containerSpec": GoogleCloudAiplatformV1beta1ModelContainerSpec.from_dict(obj["containerSpec"]) if obj.get("containerSpec") is not None else None,
            ...
            "largeModelReference": GoogleCloudAiplatformV1beta1LargeModelReference.from_dict(obj["largeModelReference"]) if obj.get("largeModelReference") is not None else None,
