...
class GoogleCloudAiplatformV1beta1ActiveLearningConfig(BaseModel):
    """
    ...
    sample_config: Optional[GoogleCloudAiplatformV1beta1SampleConfig] = Field(default=None, alias="sampleConfig")
    training_config: Optional[GoogleCloudAiplatformV1beta1TrainingConfig] = Field(default=None, alias="trainingConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sampleConfig": GoogleCloudAiplatformV1beta1SampleConfig.from_dict(obj["sampleConfig"]) if obj.get("sampleConfig") is not None else None,
            "trainingConfig": GoogleCloudAiplatformV1beta1TrainingConfig.from_dict(obj["trainingConfig"]) if obj.get("trainingConfig") is not None else None
        })
        return _obj
