...
class GoogleCloudAiplatformV1beta1SuggestTrialsResponse(BaseModel):
    """
    ...
    trials: Optional[List[GoogleCloudAiplatformV1beta1Trial]] = Field(default=None, description="A list of Trials.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trials": [GoogleCloudAiplatformV1beta1Trial.from_dict(_item) for _item in obj["trials"]] if obj.get("trials") is not None else None
        })
        return _obj
