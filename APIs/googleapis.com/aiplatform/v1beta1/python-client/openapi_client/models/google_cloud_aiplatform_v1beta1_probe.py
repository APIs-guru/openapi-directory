...
class GoogleCloudAiplatformV1beta1Probe(BaseModel):
    """
    Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic.
    """ # noqa: E501
    var_exec: Optional[GoogleCloudAiplatformV1beta1ProbeExecAction] = Field(default=None, alias="exec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exec": GoogleCloudAiplatformV1beta1ProbeExecAction.from_dict(obj["exec"]) if obj.get("exec") is not None else None,
