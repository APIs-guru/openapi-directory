...
class GoogleCloudAiplatformV1beta1ImportFeatureValuesRequest(BaseModel):
    """
    Request message for FeaturestoreService.ImportFeatureValues.
    """ # noqa: E501
    avro_source: Optional[GoogleCloudAiplatformV1beta1AvroSource] = Field(default=None, alias="avroSource")
    bigquery_source: Optional[GoogleCloudAiplatformV1beta1BigQuerySource] = Field(default=None, alias="bigquerySource")
    csv_source: Optional[GoogleCloudAiplatformV1beta1CsvSource] = Field(default=None, alias="csvSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "avroSource": GoogleCloudAiplatformV1beta1AvroSource.from_dict(obj["avroSource"]) if obj.get("avroSource") is not None else None,
            ...
            "csvSource": GoogleCloudAiplatformV1beta1CsvSource.from_dict(obj["csvSource"]) if obj.get("csvSource") is not None else None,
            ...
            "featureSpecs": [GoogleCloudAiplatformV1beta1ImportFeatureValuesRequestFeatureSpec.from_dict(_item) for _item in obj["featureSpecs"]] if obj.get("featureSpecs") is not None else None,
