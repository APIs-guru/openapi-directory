...
class GoogleCloudAiplatformV1beta1TrainingPipeline(BaseModel):
    """
    ...
    input_data_config: Optional[GoogleCloudAiplatformV1beta1InputDataConfig] = Field(default=None, alias="inputDataConfig")
    ...
    model_to_upload: Optional[GoogleCloudAiplatformV1beta1Model] = Field(default=None, alias="modelToUpload")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1TrainingPipeline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1TrainingPipeline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inputDataConfig": GoogleCloudAiplatformV1beta1InputDataConfig.from_dict(obj["inputDataConfig"]) if obj.get("inputDataConfig") is not None else None,
            "labels": obj.get("labels"),
            "modelId": obj.get("modelId"),
            "modelToUpload": GoogleCloudAiplatformV1beta1Model.from_dict(obj["modelToUpload"]) if obj.get("modelToUpload") is not None else None,
            "name": obj.get("name"),
