...
class GoogleCloudAiplatformV1beta1ListSavedQueriesResponse(BaseModel):
    """
    ...
    saved_queries: Optional[List[GoogleCloudAiplatformV1beta1SavedQuery]] = Field(default=None, description="A list of SavedQueries that match the specified filter in the request.", alias="savedQueries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "savedQueries": [GoogleCloudAiplatformV1beta1SavedQuery.from_dict(_item) for _item in obj["savedQueries"]] if obj.get("savedQueries") is not None else None
        })
        return _obj
