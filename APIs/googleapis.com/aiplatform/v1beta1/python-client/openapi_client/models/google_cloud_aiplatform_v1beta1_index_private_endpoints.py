...
class GoogleCloudAiplatformV1beta1IndexPrivateEndpoints(BaseModel):
    """
    ...
    psc_automated_endpoints: Optional[List[GoogleCloudAiplatformV1beta1PscAutomatedEndpoints]] = Field(default=None, description="Output only. PscAutomatedEndpoints is populated if private service connect is enabled if PscAutomatedConfig is set.", alias="pscAutomatedEndpoints")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1IndexPrivateEndpoints from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1IndexPrivateEndpoints from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pscAutomatedEndpoints": [GoogleCloudAiplatformV1beta1PscAutomatedEndpoints.from_dict(_item) for _item in obj["pscAutomatedEndpoints"]] if obj.get("pscAutomatedEndpoints") is not None else None,
