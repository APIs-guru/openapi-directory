...
class GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences(BaseModel):
    """
    The regional resource name or the URI. Key is region, e.g., us-central1, europe-west2, global, etc..
    """ # noqa: E501
    references: Optional[Dict[str, GoogleCloudAiplatformV1beta1PublisherModelResourceReference]] = Field(default=None, description="Required.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "references": dict(
                (_k, GoogleCloudAiplatformV1beta1PublisherModelResourceReference.from_dict(_v))
