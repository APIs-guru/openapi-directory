...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomTask(BaseModel):
    """
    A TrainingJob that trains a custom code Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1beta1CustomJobSpec] = None
    metadata: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomJobMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1beta1CustomJobSpec.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "metadata": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionCustomJobMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
