...
class GoogleCloudAiplatformV1beta1TensorboardBlobSequence(BaseModel):
    """
    ...
    """ # noqa: E501
    values: Optional[List[GoogleCloudAiplatformV1beta1TensorboardBlob]] = Field(default=None, description="List of blobs contained within the sequence.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [GoogleCloudAiplatformV1beta1TensorboardBlob.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
