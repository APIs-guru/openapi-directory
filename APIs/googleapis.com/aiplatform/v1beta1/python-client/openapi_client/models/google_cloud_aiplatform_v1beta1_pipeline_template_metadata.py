...
class GoogleCloudAiplatformV1beta1PipelineTemplateMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="The version_name in artifact registry. Will always be presented in output if the PipelineJob.template_uri is from supported template registry. Format is \"sha256:abcdef123456...\".")
