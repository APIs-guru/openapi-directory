...
class GoogleCloudAiplatformV1beta1Featurestore(BaseModel):
    """
    ...
    online_serving_config: Optional[GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig] = Field(default=None, alias="onlineServingConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "onlineServingConfig": GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig.from_dict(obj["onlineServingConfig"]) if obj.get("onlineServingConfig") is not None else None,
