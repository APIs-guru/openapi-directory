...
class GoogleCloudAiplatformV1beta1ReadIndexDatapointsResponse(BaseModel):
    """
    The response message for MatchService.ReadIndexDatapoints.
    """ # noqa: E501
    datapoints: Optional[List[GoogleCloudAiplatformV1beta1IndexDatapoint]] = Field(default=None, description="The result list of datapoints.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datapoints": [GoogleCloudAiplatformV1beta1IndexDatapoint.from_dict(_item) for _item in obj["datapoints"]] if obj.get("datapoints") is not None else None
        })
        return _obj
