...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs(BaseModel):
    """
    ...
    data_granularity: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputsGranularity] = Field(default=None, alias="dataGranularity")
    ...
    hierarchy_config: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionHierarchyConfig] = Field(default=None, alias="hierarchyConfig")
    ...
    window_config: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionWindowConfig] = Field(default=None, alias="windowConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataGranularity": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputsGranularity.from_dict(obj["dataGranularity"]) if obj.get("dataGranularity") is not None else None,
            ...
            "hierarchyConfig": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionHierarchyConfig.from_dict(obj["hierarchyConfig"]) if obj.get("hierarchyConfig") is not None else None,
            ...
            "transformations": [GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputsTransformation.from_dict(_item) for _item in obj["transformations"]] if obj.get("transformations") is not None else None,
            ...
            "windowConfig": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionWindowConfig.from_dict(obj["windowConfig"]) if obj.get("windowConfig") is not None else None
        })
        return _obj
