...
class CloudAiLargeModelsVisionRelativeTemporalPartition(BaseModel):
    """
    ...
    """ # noqa: E501
    end_offset: Optional[StrictStr] = Field(default=None, description="End time offset of the partition.", alias="endOffset")
    start_offset: Optional[StrictStr] = Field(default=None, description="Start time offset of the partition.", alias="startOffset")
    __properties: ClassVar[List[str]] = ["endOffset", "startOffset"]
