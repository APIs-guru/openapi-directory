...
class GoogleCloudAiplatformV1beta1Explanation(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributions": [GoogleCloudAiplatformV1beta1Attribution.from_dict(_item) for _item in obj["attributions"]] if obj.get("attributions") is not None else None,
            "neighbors": [GoogleCloudAiplatformV1beta1Neighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
