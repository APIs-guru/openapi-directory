...
class GoogleCloudAiplatformV1beta1Trial(BaseModel):
    """
    ...
    final_measurement: Optional[GoogleCloudAiplatformV1beta1Measurement] = Field(default=None, alias="finalMeasurement")
    ...
    measurements: Optional[List[GoogleCloudAiplatformV1beta1Measurement]] = Field(default=None, description="Output only. A list of measurements that are strictly lexicographically ordered by their induced tuples (steps, elapsed_duration). These are used for early stopping computations.")
    name: Optional[StrictStr] = Field(default=None, description="Output only. Resource name of the Trial assigned by the service.")
    parameters: Optional[List[GoogleCloudAiplatformV1beta1TrialParameter]] = Field(default=None, description="Output only. The parameters of the Trial.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1Trial from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1Trial from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "finalMeasurement": GoogleCloudAiplatformV1beta1Measurement.from_dict(obj["finalMeasurement"]) if obj.get("finalMeasurement") is not None else None,
            "id": obj.get("id"),
            "infeasibleReason": obj.get("infeasibleReason"),
            "measurements": [GoogleCloudAiplatformV1beta1Measurement.from_dict(_item) for _item in obj["measurements"]] if obj.get("measurements") is not None else None,
            "name": obj.get("name"),
            "parameters": [GoogleCloudAiplatformV1beta1TrialParameter.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
