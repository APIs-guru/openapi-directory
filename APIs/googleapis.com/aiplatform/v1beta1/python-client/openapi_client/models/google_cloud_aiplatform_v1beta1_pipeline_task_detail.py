...
class GoogleCloudAiplatformV1beta1PipelineTaskDetail(BaseModel):
    """
    ...
    execution: Optional[GoogleCloudAiplatformV1beta1Execution] = None
    executor_detail: Optional[GoogleCloudAiplatformV1beta1PipelineTaskExecutorDetail] = Field(default=None, alias="executorDetail")
    inputs: Optional[Dict[str, GoogleCloudAiplatformV1beta1PipelineTaskDetailArtifactList]] = Field(default=None, description="Output only. The runtime input artifacts of the task.")
    outputs: Optional[Dict[str, GoogleCloudAiplatformV1beta1PipelineTaskDetailArtifactList]] = Field(default=None, description="Output only. The runtime output artifacts of the task.")
    ...
    pipeline_task_status: Optional[List[GoogleCloudAiplatformV1beta1PipelineTaskDetailPipelineTaskStatus]] = Field(default=None, description="Output only. A list of task status. This field keeps a record of task status evolving over time.", alias="pipelineTaskStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "execution": GoogleCloudAiplatformV1beta1Execution.from_dict(obj["execution"]) if obj.get("execution") is not None else None,
            "executorDetail": GoogleCloudAiplatformV1beta1PipelineTaskExecutorDetail.from_dict(obj["executorDetail"]) if obj.get("executorDetail") is not None else None,
            "inputs": dict(
                (_k, GoogleCloudAiplatformV1beta1PipelineTaskDetailArtifactList.from_dict(_v))
            ...
            "pipelineTaskStatus": [GoogleCloudAiplatformV1beta1PipelineTaskDetailPipelineTaskStatus.from_dict(_item) for _item in obj["pipelineTaskStatus"]] if obj.get("pipelineTaskStatus") is not None else None,
