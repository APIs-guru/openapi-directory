...
class GoogleCloudAiplatformV1beta1NotebookRuntime(BaseModel):
    """
    ...
    notebook_runtime_template_ref: Optional[GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef] = Field(default=None, alias="notebookRuntimeTemplateRef")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1NotebookRuntime from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1NotebookRuntime from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "notebookRuntimeTemplateRef": GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef.from_dict(obj["notebookRuntimeTemplateRef"]) if obj.get("notebookRuntimeTemplateRef") is not None else None,
