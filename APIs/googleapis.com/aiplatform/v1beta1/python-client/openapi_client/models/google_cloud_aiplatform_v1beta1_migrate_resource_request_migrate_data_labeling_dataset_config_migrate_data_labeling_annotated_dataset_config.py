...
class GoogleCloudAiplatformV1beta1MigrateResourceRequestMigrateDataLabelingDatasetConfigMigrateDataLabelingAnnotatedDatasetConfig(BaseModel):
    """
    Config for migrating AnnotatedDataset in datalabeling.googleapis.com to Vertex AI's SavedQuery.
    """ # noqa: E501
    annotated_dataset: Optional[StrictStr] = Field(default=None, description="Required. Full resource name of data labeling AnnotatedDataset. Format: `projects/{project}/datasets/{dataset}/annotatedDatasets/{annotated_dataset}`.", alias="annotatedDataset")
    __properties: ClassVar[List[str]] = ["annotatedDataset"]
