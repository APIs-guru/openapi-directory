...
class GoogleCloudAiplatformV1beta1BatchCreateTensorboardTimeSeriesRequest(BaseModel):
    """
    Request message for TensorboardService.BatchCreateTensorboardTimeSeries.
    """ # noqa: E501
    requests: Optional[List[GoogleCloudAiplatformV1beta1CreateTensorboardTimeSeriesRequest]] = Field(default=None, description="Required. The request message specifying the TensorboardTimeSeries to create. A maximum of 1000 TensorboardTimeSeries can be created in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudAiplatformV1beta1CreateTensorboardTimeSeriesRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
