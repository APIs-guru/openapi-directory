...
class GoogleCloudAiplatformV1beta1PublisherModelCallToActionViewRestApi(BaseModel):
    """
    Rest API docs.
    """ # noqa: E501
    documentations: Optional[List[GoogleCloudAiplatformV1beta1PublisherModelDocumentation]] = Field(default=None, description="Required.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentations": [GoogleCloudAiplatformV1beta1PublisherModelDocumentation.from_dict(_item) for _item in obj["documentations"]] if obj.get("documentations") is not None else None,
            "title": obj.get("title")
        })
        return _obj
