...
class GoogleCloudAiplatformV1beta1ModelEvaluationSliceSliceSliceSpecRange(BaseModel):
    """
    A range of values for slice(s). `low` is inclusive, `high` is exclusive.
    """ # noqa: E501
    high: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Exclusive high value for the range.")
    low: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Inclusive low value for the range.")
