...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsVideoObjectTrackingMetrics(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trackMetrics": [GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsTrackMetrics.from_dict(_item) for _item in obj["trackMetrics"]] if obj.get("trackMetrics") is not None else None
        })
        return _obj
