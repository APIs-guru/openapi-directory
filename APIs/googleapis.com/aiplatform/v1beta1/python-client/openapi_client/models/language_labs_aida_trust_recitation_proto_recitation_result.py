...
class LanguageLabsAidaTrustRecitationProtoRecitationResult(BaseModel):
    """
    The recitation result for one input
    """ # noqa: E501
    dynamic_segment_results: Optional[List[LanguageLabsAidaTrustRecitationProtoSegmentResult]] = Field(default=None, alias="dynamicSegmentResults")
    recitation_action: Optional[StrictStr] = Field(default=None, description="The recitation action for one given input. When its segments contain different actions, the overall action will be returned in the precedence of BLOCK > CITE > NO_ACTION. When the given input is not found in any source, the recitation action will not be specified.", alias="recitationAction")
    training_segment_results: Optional[List[LanguageLabsAidaTrustRecitationProtoSegmentResult]] = Field(default=None, alias="trainingSegmentResults")
