...
class GoogleCloudAiplatformV1beta1FindNeighborsResponseNearestNeighbors(BaseModel):
    """
    Nearest neighbors for one query.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the query datapoint.")
    neighbors: Optional[List[GoogleCloudAiplatformV1beta1FindNeighborsResponseNeighbor]] = Field(default=None, description="All its neighbors.")
    __properties: ClassVar[List[str]] = ["id", "neighbors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "neighbors": [GoogleCloudAiplatformV1beta1FindNeighborsResponseNeighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
