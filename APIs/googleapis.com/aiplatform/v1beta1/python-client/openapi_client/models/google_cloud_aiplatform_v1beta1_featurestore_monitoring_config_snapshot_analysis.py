...
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysis(BaseModel):
    """
    ...
    monitoring_interval: Optional[StrictStr] = Field(default=None, description="Configuration of the snapshot analysis based monitoring pipeline running interval. The value is rolled up to full day. If both monitoring_interval_days and the deprecated `monitoring_interval` field are set when creating/updating EntityTypes/Features, monitoring_interval_days will be used.", alias="monitoringInterval")
    ...
    __properties: ClassVar[List[str]] = ["disabled", "monitoringInterval", "monitoringIntervalDays", "stalenessDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitoringInterval": obj.get("monitoringInterval"),
