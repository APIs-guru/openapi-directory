...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlForecasting(BaseModel):
    """
    A TrainingJob that trains and uploads an AutoML Forecasting Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlForecastingInputs] = None
    metadata: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlForecastingMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlForecastingInputs.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "metadata": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlForecastingMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
