...
class GoogleCloudAiplatformV1beta1NearestNeighbors(BaseModel):
    """
    Nearest neighbors for one query.
    """ # noqa: E501
    neighbors: Optional[List[GoogleCloudAiplatformV1beta1NearestNeighborsNeighbor]] = Field(default=None, description="All its neighbors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "neighbors": [GoogleCloudAiplatformV1beta1NearestNeighborsNeighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
