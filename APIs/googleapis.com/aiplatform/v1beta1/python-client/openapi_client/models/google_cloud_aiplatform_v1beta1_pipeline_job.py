...
class GoogleCloudAiplatformV1beta1PipelineJob(BaseModel):
    """
    ...
    job_detail: Optional[GoogleCloudAiplatformV1beta1PipelineJobDetail] = Field(default=None, alias="jobDetail")
    ...
    preflight_validations: Optional[StrictBool] = Field(default=None, description="Optional. Whether to do component level validations before job creation.", alias="preflightValidations")
    ...
    runtime_config: Optional[GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig] = Field(default=None, alias="runtimeConfig")
    ...
    template_metadata: Optional[GoogleCloudAiplatformV1beta1PipelineTemplateMetadata] = Field(default=None, alias="templateMetadata")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "displayName", "encryptionSpec", "endTime", "error", "jobDetail", "labels", "name", "network", "pipelineSpec", "preflightValidations", "reservedIpRanges", "runtimeConfig", "scheduleName", "serviceAccount", "startTime", "state", "templateMetadata", "templateUri", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobDetail": GoogleCloudAiplatformV1beta1PipelineJobDetail.from_dict(obj["jobDetail"]) if obj.get("jobDetail") is not None else None,
            "labels": obj.get("labels"),
            "name": obj.get("name"),
            "network": obj.get("network"),
            "pipelineSpec": obj.get("pipelineSpec"),
            "preflightValidations": obj.get("preflightValidations"),
            "reservedIpRanges": obj.get("reservedIpRanges"),
            "runtimeConfig": GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig.from_dict(obj["runtimeConfig"]) if obj.get("runtimeConfig") is not None else None,
            "scheduleName": obj.get("scheduleName"),
            "serviceAccount": obj.get("serviceAccount"),
            "startTime": obj.get("startTime"),
            "state": obj.get("state"),
            "templateMetadata": GoogleCloudAiplatformV1beta1PipelineTemplateMetadata.from_dict(obj["templateMetadata"]) if obj.get("templateMetadata") is not None else None,
