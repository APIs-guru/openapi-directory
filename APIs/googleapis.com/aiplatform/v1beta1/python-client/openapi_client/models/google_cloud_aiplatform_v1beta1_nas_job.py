...
class GoogleCloudAiplatformV1beta1NasJob(BaseModel):
    """
    ...
    nas_job_output: Optional[GoogleCloudAiplatformV1beta1NasJobOutput] = Field(default=None, alias="nasJobOutput")
    nas_job_spec: Optional[GoogleCloudAiplatformV1beta1NasJobSpec] = Field(default=None, alias="nasJobSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "nasJobOutput": GoogleCloudAiplatformV1beta1NasJobOutput.from_dict(obj["nasJobOutput"]) if obj.get("nasJobOutput") is not None else None,
            "nasJobSpec": GoogleCloudAiplatformV1beta1NasJobSpec.from_dict(obj["nasJobSpec"]) if obj.get("nasJobSpec") is not None else None,
