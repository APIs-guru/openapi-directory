...
class GoogleCloudAiplatformV1beta1VertexAISearch(BaseModel):
    """
    Retrieve from Vertex AI Search datastore for grounding. See https://cloud.google.com/vertex-ai-search-and-conversation
    """ # noqa: E501
    datastore: Optional[StrictStr] = Field(default=None, description="Required. Fully-qualified Vertex AI Search's datastore resource ID. projects/<>/locations/<>/collections/<>/dataStores/<>")
