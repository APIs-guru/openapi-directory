...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsClassificationEvaluationMetrics(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auPrc": obj.get("auPrc"),
            "auRoc": obj.get("auRoc"),
            "confidenceMetrics": [GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsClassificationEvaluationMetricsConfidenceMetrics.from_dict(_item) for _item in obj["confidenceMetrics"]] if obj.get("confidenceMetrics") is not None else None,
