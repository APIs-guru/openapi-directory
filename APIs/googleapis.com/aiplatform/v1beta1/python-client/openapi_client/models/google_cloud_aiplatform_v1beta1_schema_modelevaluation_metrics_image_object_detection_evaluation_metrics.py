...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsImageObjectDetectionEvaluationMetrics(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boundingBoxMetrics": [GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsBoundingBoxMetrics.from_dict(_item) for _item in obj["boundingBoxMetrics"]] if obj.get("boundingBoxMetrics") is not None else None,
