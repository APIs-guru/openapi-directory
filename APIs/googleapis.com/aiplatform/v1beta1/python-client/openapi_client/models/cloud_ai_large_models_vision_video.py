...
class CloudAiLargeModelsVisionVideo(BaseModel):
    """
    Video
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="Path to another storage (typically Google Cloud Storage).")
    video: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Raw bytes.")
    __properties: ClassVar[List[str]] = ["uri", "video"]
