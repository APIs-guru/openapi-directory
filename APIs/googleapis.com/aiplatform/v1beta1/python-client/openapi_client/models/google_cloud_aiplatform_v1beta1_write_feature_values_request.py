...
class GoogleCloudAiplatformV1beta1WriteFeatureValuesRequest(BaseModel):
    """
    Request message for FeaturestoreOnlineServingService.WriteFeatureValues.
    """ # noqa: E501
    payloads: Optional[List[GoogleCloudAiplatformV1beta1WriteFeatureValuesPayload]] = Field(default=None, description="Required. The entities to be written. Up to 100,000 feature values can be written across all `payloads`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payloads": [GoogleCloudAiplatformV1beta1WriteFeatureValuesPayload.from_dict(_item) for _item in obj["payloads"]] if obj.get("payloads") is not None else None
        })
        return _obj
