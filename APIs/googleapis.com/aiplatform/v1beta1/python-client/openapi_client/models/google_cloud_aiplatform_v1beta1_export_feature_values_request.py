...
class GoogleCloudAiplatformV1beta1ExportFeatureValuesRequest(BaseModel):
    """
    ...
    full_export: Optional[GoogleCloudAiplatformV1beta1ExportFeatureValuesRequestFullExport] = Field(default=None, alias="fullExport")
    settings: Optional[List[GoogleCloudAiplatformV1beta1DestinationFeatureSetting]] = Field(default=None, description="Per-Feature export settings.")
    snapshot_export: Optional[GoogleCloudAiplatformV1beta1ExportFeatureValuesRequestSnapshotExport] = Field(default=None, alias="snapshotExport")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fullExport": GoogleCloudAiplatformV1beta1ExportFeatureValuesRequestFullExport.from_dict(obj["fullExport"]) if obj.get("fullExport") is not None else None,
            ...
            "snapshotExport": GoogleCloudAiplatformV1beta1ExportFeatureValuesRequestSnapshotExport.from_dict(obj["snapshotExport"]) if obj.get("snapshotExport") is not None else None
        })
        return _obj
