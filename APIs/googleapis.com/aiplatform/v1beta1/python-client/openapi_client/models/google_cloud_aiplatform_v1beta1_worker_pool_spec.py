...
class GoogleCloudAiplatformV1beta1WorkerPoolSpec(BaseModel):
    """
    Represents the spec of a worker pool in a job.
    """ # noqa: E501
    container_spec: Optional[GoogleCloudAiplatformV1beta1ContainerSpec] = Field(default=None, alias="containerSpec")
    ...
    nfs_mounts: Optional[List[GoogleCloudAiplatformV1beta1NfsMount]] = Field(default=None, description="Optional. List of NFS mount spec.", alias="nfsMounts")
    python_package_spec: Optional[GoogleCloudAiplatformV1beta1PythonPackageSpec] = Field(default=None, alias="pythonPackageSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containerSpec": GoogleCloudAiplatformV1beta1ContainerSpec.from_dict(obj["containerSpec"]) if obj.get("containerSpec") is not None else None,
            ...
            "nfsMounts": [GoogleCloudAiplatformV1beta1NfsMount.from_dict(_item) for _item in obj["nfsMounts"]] if obj.get("nfsMounts") is not None else None,
            "pythonPackageSpec": GoogleCloudAiplatformV1beta1PythonPackageSpec.from_dict(obj["pythonPackageSpec"]) if obj.get("pythonPackageSpec") is not None else None,
