...
class GoogleCloudAiplatformV1beta1ModelEvaluation(BaseModel):
    """
    A collection of metrics calculated by comparing Model's predictions on all of the test data against annotations from the test data.
    """ # noqa: E501
    bias_configs: Optional[GoogleCloudAiplatformV1beta1ModelEvaluationBiasConfig] = Field(default=None, alias="biasConfigs")
    ...
    explanation_specs: Optional[List[GoogleCloudAiplatformV1beta1ModelEvaluationModelEvaluationExplanationSpec]] = Field(default=None, description="Describes the values of ExplanationSpec that are used for explaining the predicted values on the evaluated data.", alias="explanationSpecs")
    ...
    __properties: ClassVar[List[str]] = ["biasConfigs", "createTime", "displayName", "explanationSpecs", "metadata", "metrics", "metricsSchemaUri", "modelExplanation", "name", "sliceDimensions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of bias_configs
        if self.bias_configs:
            _dict['biasConfigs'] = self.bias_configs.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "biasConfigs": GoogleCloudAiplatformV1beta1ModelEvaluationBiasConfig.from_dict(obj["biasConfigs"]) if obj.get("biasConfigs") is not None else None,
            "createTime": obj.get("createTime"),
            "displayName": obj.get("displayName"),
            "explanationSpecs": [GoogleCloudAiplatformV1beta1ModelEvaluationModelEvaluationExplanationSpec.from_dict(_item) for _item in obj["explanationSpecs"]] if obj.get("explanationSpecs") is not None else None,
