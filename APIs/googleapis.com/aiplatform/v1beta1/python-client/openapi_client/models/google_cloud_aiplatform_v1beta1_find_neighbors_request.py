...
class GoogleCloudAiplatformV1beta1FindNeighborsRequest(BaseModel):
    """
    ...
    queries: Optional[List[GoogleCloudAiplatformV1beta1FindNeighborsRequestQuery]] = Field(default=None, description="The list of queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queries": [GoogleCloudAiplatformV1beta1FindNeighborsRequestQuery.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None,
