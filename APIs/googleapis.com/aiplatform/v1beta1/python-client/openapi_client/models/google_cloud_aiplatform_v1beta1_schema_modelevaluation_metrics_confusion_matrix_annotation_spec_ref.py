...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsConfusionMatrixAnnotationSpecRef(BaseModel):
    """
    GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsConfusionMatrixAnnotationSpecRef
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Display name of the AnnotationSpec.", alias="displayName")
    id: Optional[StrictStr] = Field(default=None, description="ID of the AnnotationSpec.")
