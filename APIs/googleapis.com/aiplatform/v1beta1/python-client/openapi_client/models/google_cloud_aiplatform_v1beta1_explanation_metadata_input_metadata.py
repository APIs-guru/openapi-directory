...
class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata(BaseModel):
    """
    ...
    feature_value_domain: Optional[GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain] = Field(default=None, alias="featureValueDomain")
    ...
    visualization: Optional[GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "featureValueDomain": GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain.from_dict(obj["featureValueDomain"]) if obj.get("featureValueDomain") is not None else None,
            ...
            "visualization": GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.from_dict(obj["visualization"]) if obj.get("visualization") is not None else None
        })
        return _obj
