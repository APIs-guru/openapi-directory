...
class GoogleCloudAiplatformV1beta1SchemaVisualInspectionClassificationLabelSavedQueryMetadata(BaseModel):
    """
    GoogleCloudAiplatformV1beta1SchemaVisualInspectionClassificationLabelSavedQueryMetadata
    """ # noqa: E501
    multi_label: Optional[StrictBool] = Field(default=None, description="Whether or not the classification label is multi_label.", alias="multiLabel")
    __properties: ClassVar[List[str]] = ["multiLabel"]
