...
class GoogleCloudAiplatformV1beta1EvaluatedAnnotation(BaseModel):
    """
    ...
    error_analysis_annotations: Optional[List[GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation]] = Field(default=None, description="Annotations of model error analysis results.", alias="errorAnalysisAnnotations")
    ...
    explanations: Optional[List[GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation]] = Field(default=None, description="Explanations of predictions. Each element of the explanations indicates the explanation for one explanation Method. The attributions list in the EvaluatedAnnotationExplanation.explanation object corresponds to the predictions list. For example, the second element in the attributions list explains the second element in the predictions list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errorAnalysisAnnotations": [GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation.from_dict(_item) for _item in obj["errorAnalysisAnnotations"]] if obj.get("errorAnalysisAnnotations") is not None else None,
            "evaluatedDataItemViewId": obj.get("evaluatedDataItemViewId"),
            "explanations": [GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation.from_dict(_item) for _item in obj["explanations"]] if obj.get("explanations") is not None else None,
