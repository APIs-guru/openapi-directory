...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTables(BaseModel):
    """
    A TrainingJob that trains and uploads an AutoML Tables Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesInputs] = None
    metadata: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesInputs.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "metadata": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
