...
class GoogleCloudAiplatformV1beta1InputDataConfig(BaseModel):
    """
    ...
    bigquery_destination: Optional[GoogleCloudAiplatformV1beta1BigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    ...
    filter_split: Optional[GoogleCloudAiplatformV1beta1FilterSplit] = Field(default=None, alias="filterSplit")
    fraction_split: Optional[GoogleCloudAiplatformV1beta1FractionSplit] = Field(default=None, alias="fractionSplit")
    ...
    predefined_split: Optional[GoogleCloudAiplatformV1beta1PredefinedSplit] = Field(default=None, alias="predefinedSplit")
    ...
    stratified_split: Optional[GoogleCloudAiplatformV1beta1StratifiedSplit] = Field(default=None, alias="stratifiedSplit")
    timestamp_split: Optional[GoogleCloudAiplatformV1beta1TimestampSplit] = Field(default=None, alias="timestampSplit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bigqueryDestination": GoogleCloudAiplatformV1beta1BigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None,
            "datasetId": obj.get("datasetId"),
            "filterSplit": GoogleCloudAiplatformV1beta1FilterSplit.from_dict(obj["filterSplit"]) if obj.get("filterSplit") is not None else None,
            "fractionSplit": GoogleCloudAiplatformV1beta1FractionSplit.from_dict(obj["fractionSplit"]) if obj.get("fractionSplit") is not None else None,
            ...
            "predefinedSplit": GoogleCloudAiplatformV1beta1PredefinedSplit.from_dict(obj["predefinedSplit"]) if obj.get("predefinedSplit") is not None else None,
            "savedQueryId": obj.get("savedQueryId"),
            "stratifiedSplit": GoogleCloudAiplatformV1beta1StratifiedSplit.from_dict(obj["stratifiedSplit"]) if obj.get("stratifiedSplit") is not None else None,
            "timestampSplit": GoogleCloudAiplatformV1beta1TimestampSplit.from_dict(obj["timestampSplit"]) if obj.get("timestampSplit") is not None else None
        })
        return _obj
