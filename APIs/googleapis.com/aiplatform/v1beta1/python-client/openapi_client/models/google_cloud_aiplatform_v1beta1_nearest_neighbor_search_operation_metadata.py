...
class GoogleCloudAiplatformV1beta1NearestNeighborSearchOperationMetadata(BaseModel):
    """
    Runtime operation metadata with regard to Matching Engine Index.
    """ # noqa: E501
    content_validation_stats: Optional[List[GoogleCloudAiplatformV1beta1NearestNeighborSearchOperationMetadataContentValidationStats]] = Field(default=None, description="The validation stats of the content (per file) to be inserted or updated on the Matching Engine Index resource. Populated if contentsDeltaUri is provided as part of Index.metadata. Please note that, currently for those files that are broken or has unsupported file format, we will not have the stats for those files.", alias="contentValidationStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contentValidationStats": [GoogleCloudAiplatformV1beta1NearestNeighborSearchOperationMetadataContentValidationStats.from_dict(_item) for _item in obj["contentValidationStats"]] if obj.get("contentValidationStats") is not None else None,
