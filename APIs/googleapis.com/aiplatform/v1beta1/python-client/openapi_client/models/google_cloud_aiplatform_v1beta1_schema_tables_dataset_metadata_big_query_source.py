...
class GoogleCloudAiplatformV1beta1SchemaTablesDatasetMetadataBigQuerySource(BaseModel):
    """
    GoogleCloudAiplatformV1beta1SchemaTablesDatasetMetadataBigQuerySource
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="The URI of a BigQuery table. e.g. bq://projectId.bqDatasetId.bqTableId")
