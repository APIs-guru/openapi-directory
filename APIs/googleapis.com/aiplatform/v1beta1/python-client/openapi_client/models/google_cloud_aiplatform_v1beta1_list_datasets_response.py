...
class GoogleCloudAiplatformV1beta1ListDatasetsResponse(BaseModel):
    """
    Response message for DatasetService.ListDatasets.
    """ # noqa: E501
    datasets: Optional[List[GoogleCloudAiplatformV1beta1Dataset]] = Field(default=None, description="A list of Datasets that matches the specified filter in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [GoogleCloudAiplatformV1beta1Dataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
