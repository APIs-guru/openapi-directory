...
class GoogleCloudAiplatformV1beta1ExamplesOverride(BaseModel):
    """
    ...
    restrictions: Optional[List[GoogleCloudAiplatformV1beta1ExamplesRestrictionsNamespace]] = Field(default=None, description="Restrict the resulting nearest neighbors to respect these constraints.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restrictions": [GoogleCloudAiplatformV1beta1ExamplesRestrictionsNamespace.from_dict(_item) for _item in obj["restrictions"]] if obj.get("restrictions") is not None else None,
