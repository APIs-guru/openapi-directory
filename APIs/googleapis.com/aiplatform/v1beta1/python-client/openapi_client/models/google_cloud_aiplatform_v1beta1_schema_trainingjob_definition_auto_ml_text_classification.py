...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTextClassification(BaseModel):
    """
    A TrainingJob that trains and uploads an AutoML Text Classification Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTextClassificationInputs] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTextClassificationInputs.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None
        })
        return _obj
