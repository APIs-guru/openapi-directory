...
class GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsVideoActionMetrics(BaseModel):
    """
    The Evaluation metrics given a specific precision_window_length.
    """ # noqa: E501
    confidence_metrics: Optional[List[GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsVideoActionMetricsConfidenceMetrics]] = Field(default=None, description="Metrics for each label-match confidence_threshold from 0.05,0.10,...,0.95,0.96,0.97,0.98,0.99.", alias="confidenceMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidenceMetrics": [GoogleCloudAiplatformV1beta1SchemaModelevaluationMetricsVideoActionMetricsConfidenceMetrics.from_dict(_item) for _item in obj["confidenceMetrics"]] if obj.get("confidenceMetrics") is not None else None,
