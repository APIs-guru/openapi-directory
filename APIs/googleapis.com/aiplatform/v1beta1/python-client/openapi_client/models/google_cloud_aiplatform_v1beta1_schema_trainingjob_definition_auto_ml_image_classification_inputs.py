...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageClassificationInputs(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["baseModelId", "budgetMilliNodeHours", "disableEarlyStopping", "modelType", "multiLabel", "tunableParameter", "uptrainBaseModelId"]
    ...
    def model_type_validate_enum(cls, value):
        ...
        if value not in set(['MODEL_TYPE_UNSPECIFIED', 'CLOUD', 'CLOUD_1', 'MOBILE_TF_LOW_LATENCY_1', 'MOBILE_TF_VERSATILE_1', 'MOBILE_TF_HIGH_ACCURACY_1', 'EFFICIENTNET', 'MAXVIT', 'VIT', 'COCA']):
            raise ValueError("must be one of enum values ('MODEL_TYPE_UNSPECIFIED', 'CLOUD', 'CLOUD_1', 'MOBILE_TF_LOW_LATENCY_1', 'MOBILE_TF_VERSATILE_1', 'MOBILE_TF_HIGH_ACCURACY_1', 'EFFICIENTNET', 'MAXVIT', 'VIT', 'COCA')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageClassificationInputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageClassificationInputs from a dict"""
        if obj is None:
            return None
