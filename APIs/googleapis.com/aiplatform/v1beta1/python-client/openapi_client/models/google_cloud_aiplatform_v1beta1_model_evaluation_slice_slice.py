...
class GoogleCloudAiplatformV1beta1ModelEvaluationSliceSlice(BaseModel):
    """
    ...
    slice_spec: Optional[GoogleCloudAiplatformV1beta1ModelEvaluationSliceSliceSliceSpec] = Field(default=None, alias="sliceSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sliceSpec": GoogleCloudAiplatformV1beta1ModelEvaluationSliceSliceSliceSpec.from_dict(obj["sliceSpec"]) if obj.get("sliceSpec") is not None else None,
            "value": obj.get("value")
        })
        return _obj
