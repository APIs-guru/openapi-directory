...
class GoogleCloudAiplatformV1beta1DedicatedResources(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autoscalingMetricSpecs": [GoogleCloudAiplatformV1beta1AutoscalingMetricSpec.from_dict(_item) for _item in obj["autoscalingMetricSpecs"]] if obj.get("autoscalingMetricSpecs") is not None else None,
