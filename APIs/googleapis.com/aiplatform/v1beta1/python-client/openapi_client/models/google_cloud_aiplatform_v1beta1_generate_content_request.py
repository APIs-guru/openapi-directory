...
class GoogleCloudAiplatformV1beta1GenerateContentRequest(BaseModel):
    """
    Request message for [PredictionService.GenerateContent].
    """ # noqa: E501
    contents: Optional[List[GoogleCloudAiplatformV1beta1Content]] = Field(default=None, description="Required. The content of the current conversation with the model. For single-turn queries, this is a single instance. For multi-turn queries, this is a repeated field that contains conversation history + latest request.")
    generation_config: Optional[GoogleCloudAiplatformV1beta1GenerationConfig] = Field(default=None, alias="generationConfig")
    safety_settings: Optional[List[GoogleCloudAiplatformV1beta1SafetySetting]] = Field(default=None, description="Optional. Per request settings for blocking unsafe content. Enforced on GenerateContentResponse.candidates.", alias="safetySettings")
    tools: Optional[List[GoogleCloudAiplatformV1beta1Tool]] = Field(default=None, description="Optional. A list of `Tools` the model may use to generate the next response. A `Tool` is a piece of code that enables the system to interact with external systems to perform an action, or set of actions, outside of knowledge and scope of the model.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contents": [GoogleCloudAiplatformV1beta1Content.from_dict(_item) for _item in obj["contents"]] if obj.get("contents") is not None else None,
            "generationConfig": GoogleCloudAiplatformV1beta1GenerationConfig.from_dict(obj["generationConfig"]) if obj.get("generationConfig") is not None else None,
            "safetySettings": [GoogleCloudAiplatformV1beta1SafetySetting.from_dict(_item) for _item in obj["safetySettings"]] if obj.get("safetySettings") is not None else None,
            "tools": [GoogleCloudAiplatformV1beta1Tool.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None
        })
        return _obj
