...
class GoogleCloudAiplatformV1beta1BatchCreateTensorboardRunsRequest(BaseModel):
    """
    Request message for TensorboardService.BatchCreateTensorboardRuns.
    """ # noqa: E501
    requests: Optional[List[GoogleCloudAiplatformV1beta1CreateTensorboardRunRequest]] = Field(default=None, description="Required. The request message specifying the TensorboardRuns to create. A maximum of 1000 TensorboardRuns can be created in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudAiplatformV1beta1CreateTensorboardRunRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
