...
class GoogleCloudAiplatformV1beta1SchemaTablesDatasetMetadata(BaseModel):
    """
    The metadata of Datasets that contain tables data.
    """ # noqa: E501
    input_config: Optional[GoogleCloudAiplatformV1beta1SchemaTablesDatasetMetadataInputConfig] = Field(default=None, alias="inputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputConfig": GoogleCloudAiplatformV1beta1SchemaTablesDatasetMetadataInputConfig.from_dict(obj["inputConfig"]) if obj.get("inputConfig") is not None else None
        })
        return _obj
