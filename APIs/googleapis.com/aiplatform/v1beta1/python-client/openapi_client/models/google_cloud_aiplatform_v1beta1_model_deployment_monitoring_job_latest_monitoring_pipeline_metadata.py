...
class GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata(BaseModel):
    """
    All metadata of most recent monitoring pipelines.
    """ # noqa: E501
    run_time: Optional[StrictStr] = Field(default=None, description="The time that most recent monitoring pipelines that is related to this run.", alias="runTime")
    status: Optional[GoogleRpcStatus] = None
    __properties: ClassVar[List[str]] = ["runTime", "status"]
