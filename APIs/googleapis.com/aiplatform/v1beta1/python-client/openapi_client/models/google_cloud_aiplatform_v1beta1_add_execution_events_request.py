...
class GoogleCloudAiplatformV1beta1AddExecutionEventsRequest(BaseModel):
    """
    Request message for MetadataService.AddExecutionEvents.
    """ # noqa: E501
    events: Optional[List[GoogleCloudAiplatformV1beta1Event]] = Field(default=None, description="The Events to create and add.")
