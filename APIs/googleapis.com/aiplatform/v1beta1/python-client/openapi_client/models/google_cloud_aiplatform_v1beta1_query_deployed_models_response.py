...
class GoogleCloudAiplatformV1beta1QueryDeployedModelsResponse(BaseModel):
    """
    Response message for QueryDeployedModels method.
    """ # noqa: E501
    deployed_model_refs: Optional[List[GoogleCloudAiplatformV1beta1DeployedModelRef]] = Field(default=None, description="References to the DeployedModels that share the specified deploymentResourcePool.", alias="deployedModelRefs")
    deployed_models: Optional[List[GoogleCloudAiplatformV1beta1DeployedModel]] = Field(default=None, description="DEPRECATED Use deployed_model_refs instead.", alias="deployedModels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployedModelRefs": [GoogleCloudAiplatformV1beta1DeployedModelRef.from_dict(_item) for _item in obj["deployedModelRefs"]] if obj.get("deployedModelRefs") is not None else None,
            "deployedModels": [GoogleCloudAiplatformV1beta1DeployedModel.from_dict(_item) for _item in obj["deployedModels"]] if obj.get("deployedModels") is not None else None,
