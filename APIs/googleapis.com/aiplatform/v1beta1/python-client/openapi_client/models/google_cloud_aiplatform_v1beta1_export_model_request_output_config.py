...
class GoogleCloudAiplatformV1beta1ExportModelRequestOutputConfig(BaseModel):
    """
    Output configuration for the Model export.
    """ # noqa: E501
    artifact_destination: Optional[GoogleCloudAiplatformV1beta1GcsDestination] = Field(default=None, alias="artifactDestination")
    ...
    image_destination: Optional[GoogleCloudAiplatformV1beta1ContainerRegistryDestination] = Field(default=None, alias="imageDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifactDestination": GoogleCloudAiplatformV1beta1GcsDestination.from_dict(obj["artifactDestination"]) if obj.get("artifactDestination") is not None else None,
            "exportFormatId": obj.get("exportFormatId"),
            "imageDestination": GoogleCloudAiplatformV1beta1ContainerRegistryDestination.from_dict(obj["imageDestination"]) if obj.get("imageDestination") is not None else None
        })
        return _obj
