...
class GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesInputs(BaseModel):
    """
    ...
    export_evaluated_data_items_config: Optional[GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionExportEvaluatedDataItemsConfig] = Field(default=None, alias="exportEvaluatedDataItemsConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exportEvaluatedDataItemsConfig": GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionExportEvaluatedDataItemsConfig.from_dict(obj["exportEvaluatedDataItemsConfig"]) if obj.get("exportEvaluatedDataItemsConfig") is not None else None,
            ...
            "transformations": [GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlTablesInputsTransformation.from_dict(_item) for _item in obj["transformations"]] if obj.get("transformations") is not None else None,
