...
class GoogleCloudAiplatformV1beta1Model(BaseModel):
    """
    ...
    base_model_source: Optional[GoogleCloudAiplatformV1beta1ModelBaseModelSource] = Field(default=None, alias="baseModelSource")
    ...
    deployed_models: Optional[List[GoogleCloudAiplatformV1beta1DeployedModelRef]] = Field(default=None, description="Output only. The pointers to DeployedModels created from this Model. Note that Model could have been deployed to Endpoints in different Locations.", alias="deployedModels")
    ...
    model_source_info: Optional[GoogleCloudAiplatformV1beta1ModelSourceInfo] = Field(default=None, alias="modelSourceInfo")
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the Model.")
    original_model_info: Optional[GoogleCloudAiplatformV1beta1ModelOriginalModelInfo] = Field(default=None, alias="originalModelInfo")
    ...
    supported_export_formats: Optional[List[GoogleCloudAiplatformV1beta1ModelExportFormat]] = Field(default=None, description="Output only. The formats in which this Model may be exported. If empty, this Model is not available for export.", alias="supportedExportFormats")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of base_model_source
        if self.base_model_source:
            _dict['baseModelSource'] = self.base_model_source.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "baseModelSource": GoogleCloudAiplatformV1beta1ModelBaseModelSource.from_dict(obj["baseModelSource"]) if obj.get("baseModelSource") is not None else None,
            ...
            "deployedModels": [GoogleCloudAiplatformV1beta1DeployedModelRef.from_dict(_item) for _item in obj["deployedModels"]] if obj.get("deployedModels") is not None else None,
            ...
            "modelSourceInfo": GoogleCloudAiplatformV1beta1ModelSourceInfo.from_dict(obj["modelSourceInfo"]) if obj.get("modelSourceInfo") is not None else None,
            "name": obj.get("name"),
            "originalModelInfo": GoogleCloudAiplatformV1beta1ModelOriginalModelInfo.from_dict(obj["originalModelInfo"]) if obj.get("originalModelInfo") is not None else None,
            ...
            "supportedExportFormats": [GoogleCloudAiplatformV1beta1ModelExportFormat.from_dict(_item) for _item in obj["supportedExportFormats"]] if obj.get("supportedExportFormats") is not None else None,
