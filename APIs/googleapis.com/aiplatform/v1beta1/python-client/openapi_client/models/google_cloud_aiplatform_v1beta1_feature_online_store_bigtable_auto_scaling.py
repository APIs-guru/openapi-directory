...
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScaling(BaseModel):
    """
    ...
    max_node_count: Optional[StrictInt] = Field(default=None, description="Required. The maximum number of nodes to scale up to. Must be greater than or equal to min_node_count, and less than or equal to 10 times of 'min_node_count'.", alias="maxNodeCount")
