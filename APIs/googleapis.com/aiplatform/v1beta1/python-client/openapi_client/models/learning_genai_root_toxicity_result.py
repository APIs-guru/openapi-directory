...
class LearningGenaiRootToxicityResult(BaseModel):
    """
    A model can generate multiple signals and this captures all the generated signals for a single message.
    """ # noqa: E501
    signals: Optional[List[LearningGenaiRootToxicitySignal]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signals": [LearningGenaiRootToxicitySignal.from_dict(_item) for _item in obj["signals"]] if obj.get("signals") is not None else None
        })
        return _obj
