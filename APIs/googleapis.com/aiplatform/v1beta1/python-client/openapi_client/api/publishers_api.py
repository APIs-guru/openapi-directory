...
class PublishersApi:
    ...
    @validate_call
    def aiplatform_publishers_models_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the PublisherModel resource. Format: `publishers/{publisher}/models/{publisher_model}`")],
        ...
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The IETF BCP-47 language code representing the language in which the publisher model's text information should be written in (see go/bcp47).")] = None,
        view: Annotated[Optional[StrictStr], Field(description="Optional. PublisherModel view specifying which fields to read.")] = None,
        ...
        _param = self._aiplatform_publishers_models_get_serialize(
            name=name,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudAiplatformV1beta1PublisherModel",
        }
    ...
    @validate_call
    def aiplatform_publishers_models_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the PublisherModel resource. Format: `publishers/{publisher}/models/{publisher_model}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudAiplatformV1beta1PublisherModel]:
        """aiplatform_publishers_models_get
    ...
    @validate_call
    def aiplatform_publishers_models_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the PublisherModel resource. Format: `publishers/{publisher}/models/{publisher_model}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _aiplatform_publishers_models_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    @validate_call
    def aiplatform_publishers_models_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the Publisher from which to list the PublisherModels. Format: `publishers/{publisher}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Optional. The standard list filter.")] = None,
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The IETF BCP-47 language code representing the language in which the publisher models' text information should be written in (see go/bcp47). If not set, by default English (en).")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Optional. A comma-separated list of fields to order by, sorted in ascending order. Use \"desc\" after a field name for descending.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. The standard list page size.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. The standard list page token. Typically obtained via ListPublisherModelsResponse.next_page_token of the previous ModelGardenService.ListPublisherModels call.")] = None,
        view: Annotated[Optional[StrictStr], Field(description="Optional. PublisherModel view specifying which fields to read.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._aiplatform_publishers_models_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudAiplatformV1beta1ListPublisherModelsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def aiplatform_publishers_models_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the Publisher from which to list the PublisherModels. Format: `publishers/{publisher}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudAiplatformV1beta1ListPublisherModelsResponse]:
        """aiplatform_publishers_models_list
    ...
    @validate_call
    def aiplatform_publishers_models_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the Publisher from which to list the PublisherModels. Format: `publishers/{publisher}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _aiplatform_publishers_models_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
