...
**disable_explanations** | **bool** | If true, deploy the model without explainable feature, regardless the existence of Model.explanation_spec or explanation_spec. | [optional] 
...
**enable_container_logging** | **bool** | If true, the container of the DeployedModel instances will send &#x60;stderr&#x60; and &#x60;stdout&#x60; streams to Cloud Logging. Only supported for custom-trained Models and AutoML Tabular Models. | [optional] 
...
**private_endpoints** | [**GoogleCloudAiplatformV1beta1PrivateEndpoints**](GoogleCloudAiplatformV1beta1PrivateEndpoints.md) |  | [optional] 
...
google_cloud_aiplatform_v1beta1_deployed_model_instance = GoogleCloudAiplatformV1beta1DeployedModel.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1DeployedModel.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_deployed_model_dict = google_cloud_aiplatform_v1beta1_deployed_model_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1DeployedModel from a dict
google_cloud_aiplatform_v1beta1_deployed_model_from_dict = GoogleCloudAiplatformV1beta1DeployedModel.from_dict(google_cloud_aiplatform_v1beta1_deployed_model_dict)
```
