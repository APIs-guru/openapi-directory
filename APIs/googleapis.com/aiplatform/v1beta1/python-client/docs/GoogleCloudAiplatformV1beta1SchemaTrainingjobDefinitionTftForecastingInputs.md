...
**data_granularity** | [**GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputsGranularity**](GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputsGranularity.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs from a JSON string
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_tft_forecasting_inputs_instance = GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_tft_forecasting_inputs_dict = google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_tft_forecasting_inputs_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs from a dict
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_tft_forecasting_inputs_from_dict = GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionTftForecastingInputs.from_dict(google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_tft_forecasting_inputs_dict)
```
