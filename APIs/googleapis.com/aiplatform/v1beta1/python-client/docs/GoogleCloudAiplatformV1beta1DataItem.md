...
google_cloud_aiplatform_v1beta1_data_item_instance = GoogleCloudAiplatformV1beta1DataItem.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1DataItem.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_data_item_dict = google_cloud_aiplatform_v1beta1_data_item_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1DataItem from a dict
google_cloud_aiplatform_v1beta1_data_item_from_dict = GoogleCloudAiplatformV1beta1DataItem.from_dict(google_cloud_aiplatform_v1beta1_data_item_dict)
```
