...
google_cloud_aiplatform_v1beta1_notebook_euc_config_instance = GoogleCloudAiplatformV1beta1NotebookEucConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1NotebookEucConfig.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_notebook_euc_config_dict = google_cloud_aiplatform_v1beta1_notebook_euc_config_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1NotebookEucConfig from a dict
google_cloud_aiplatform_v1beta1_notebook_euc_config_from_dict = GoogleCloudAiplatformV1beta1NotebookEucConfig.from_dict(google_cloud_aiplatform_v1beta1_notebook_euc_config_dict)
```
