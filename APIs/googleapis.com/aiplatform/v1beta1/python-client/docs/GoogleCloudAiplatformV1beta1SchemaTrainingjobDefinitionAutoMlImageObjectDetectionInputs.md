...
**tunable_parameter** | [**GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutomlImageTrainingTunableParameter**](GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutomlImageTrainingTunableParameter.md) |  | [optional] 
...
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_auto_ml_image_object_detection_inputs_instance = GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageObjectDetectionInputs.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageObjectDetectionInputs.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_auto_ml_image_object_detection_inputs_dict = google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_auto_ml_image_object_detection_inputs_instance.to_dict()
...
google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_auto_ml_image_object_detection_inputs_from_dict = GoogleCloudAiplatformV1beta1SchemaTrainingjobDefinitionAutoMlImageObjectDetectionInputs.from_dict(google_cloud_aiplatform_v1beta1_schema_trainingjob_definition_auto_ml_image_object_detection_inputs_dict)
```
