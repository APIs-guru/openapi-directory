...
**online_serving_config** | [**GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig**](GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1beta1Featurestore from a JSON string
google_cloud_aiplatform_v1beta1_featurestore_instance = GoogleCloudAiplatformV1beta1Featurestore.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1Featurestore.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_featurestore_dict = google_cloud_aiplatform_v1beta1_featurestore_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1Featurestore from a dict
google_cloud_aiplatform_v1beta1_featurestore_from_dict = GoogleCloudAiplatformV1beta1Featurestore.from_dict(google_cloud_aiplatform_v1beta1_featurestore_dict)
```
