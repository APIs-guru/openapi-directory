...
google_cloud_aiplatform_v1beta1_attribution_instance = GoogleCloudAiplatformV1beta1Attribution.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1Attribution.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_attribution_dict = google_cloud_aiplatform_v1beta1_attribution_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1Attribution from a dict
google_cloud_aiplatform_v1beta1_attribution_from_dict = GoogleCloudAiplatformV1beta1Attribution.from_dict(google_cloud_aiplatform_v1beta1_attribution_dict)
```
