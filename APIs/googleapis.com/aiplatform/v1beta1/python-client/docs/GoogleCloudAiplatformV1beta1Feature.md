...
**monitoring_stats_anomalies** | [**List[GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomaly]**](GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomaly.md) | Output only. Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives. | [optional] [readonly] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1beta1Feature from a JSON string
google_cloud_aiplatform_v1beta1_feature_instance = GoogleCloudAiplatformV1beta1Feature.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1Feature.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_feature_dict = google_cloud_aiplatform_v1beta1_feature_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1Feature from a dict
google_cloud_aiplatform_v1beta1_feature_from_dict = GoogleCloudAiplatformV1beta1Feature.from_dict(google_cloud_aiplatform_v1beta1_feature_dict)
```
