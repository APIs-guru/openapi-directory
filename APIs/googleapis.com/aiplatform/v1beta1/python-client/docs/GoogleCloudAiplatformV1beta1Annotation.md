...
------------ | ------------- | ------------- | -------------
**annotation_source** | [**GoogleCloudAiplatformV1beta1UserActionReference**](GoogleCloudAiplatformV1beta1UserActionReference.md) |  | [optional] 
...
google_cloud_aiplatform_v1beta1_annotation_instance = GoogleCloudAiplatformV1beta1Annotation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1Annotation.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_annotation_dict = google_cloud_aiplatform_v1beta1_annotation_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1Annotation from a dict
google_cloud_aiplatform_v1beta1_annotation_from_dict = GoogleCloudAiplatformV1beta1Annotation.from_dict(google_cloud_aiplatform_v1beta1_annotation_dict)
```
