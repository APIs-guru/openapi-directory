...
**deployed_indexes** | [**List[GoogleCloudAiplatformV1beta1DeployedIndexRef]**](GoogleCloudAiplatformV1beta1DeployedIndexRef.md) | Output only. The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first. | [optional] [readonly] 
...
**index_stats** | [**GoogleCloudAiplatformV1beta1IndexStats**](GoogleCloudAiplatformV1beta1IndexStats.md) |  | [optional] 
...
google_cloud_aiplatform_v1beta1_index_instance = GoogleCloudAiplatformV1beta1Index.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1Index.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_index_dict = google_cloud_aiplatform_v1beta1_index_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1Index from a dict
google_cloud_aiplatform_v1beta1_index_from_dict = GoogleCloudAiplatformV1beta1Index.from_dict(google_cloud_aiplatform_v1beta1_index_dict)
```
