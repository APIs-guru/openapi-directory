...
**nas_job_output** | [**GoogleCloudAiplatformV1beta1NasJobOutput**](GoogleCloudAiplatformV1beta1NasJobOutput.md) |  | [optional] 
**nas_job_spec** | [**GoogleCloudAiplatformV1beta1NasJobSpec**](GoogleCloudAiplatformV1beta1NasJobSpec.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1beta1NasJob from a JSON string
google_cloud_aiplatform_v1beta1_nas_job_instance = GoogleCloudAiplatformV1beta1NasJob.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1NasJob.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_nas_job_dict = google_cloud_aiplatform_v1beta1_nas_job_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1NasJob from a dict
google_cloud_aiplatform_v1beta1_nas_job_from_dict = GoogleCloudAiplatformV1beta1NasJob.from_dict(google_cloud_aiplatform_v1beta1_nas_job_dict)
```
