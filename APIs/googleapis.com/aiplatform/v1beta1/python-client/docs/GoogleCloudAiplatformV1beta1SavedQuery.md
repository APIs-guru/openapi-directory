...
google_cloud_aiplatform_v1beta1_saved_query_instance = GoogleCloudAiplatformV1beta1SavedQuery.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1beta1SavedQuery.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1beta1_saved_query_dict = google_cloud_aiplatform_v1beta1_saved_query_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1beta1SavedQuery from a dict
google_cloud_aiplatform_v1beta1_saved_query_from_dict = GoogleCloudAiplatformV1beta1SavedQuery.from_dict(google_cloud_aiplatform_v1beta1_saved_query_dict)
```
