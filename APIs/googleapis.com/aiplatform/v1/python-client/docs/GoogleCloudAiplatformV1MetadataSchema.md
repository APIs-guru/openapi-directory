...
google_cloud_aiplatform_v1_metadata_schema_instance = GoogleCloudAiplatformV1MetadataSchema.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1MetadataSchema.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_metadata_schema_dict = google_cloud_aiplatform_v1_metadata_schema_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1MetadataSchema from a dict
google_cloud_aiplatform_v1_metadata_schema_from_dict = GoogleCloudAiplatformV1MetadataSchema.from_dict(google_cloud_aiplatform_v1_metadata_schema_dict)
```
