...
google_cloud_aiplatform_v1_automatic_resources_instance = GoogleCloudAiplatformV1AutomaticResources.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1AutomaticResources.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_automatic_resources_dict = google_cloud_aiplatform_v1_automatic_resources_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1AutomaticResources from a dict
google_cloud_aiplatform_v1_automatic_resources_from_dict = GoogleCloudAiplatformV1AutomaticResources.from_dict(google_cloud_aiplatform_v1_automatic_resources_dict)
```
