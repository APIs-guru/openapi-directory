...
google_cloud_aiplatform_v1_dedicated_resources_instance = GoogleCloudAiplatformV1DedicatedResources.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1DedicatedResources.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_dedicated_resources_dict = google_cloud_aiplatform_v1_dedicated_resources_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1DedicatedResources from a dict
google_cloud_aiplatform_v1_dedicated_resources_from_dict = GoogleCloudAiplatformV1DedicatedResources.from_dict(google_cloud_aiplatform_v1_dedicated_resources_dict)
```
