...
**saved_queries** | [**List[GoogleCloudAiplatformV1SavedQuery]**](GoogleCloudAiplatformV1SavedQuery.md) | All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec. | [optional] 
...
google_cloud_aiplatform_v1_dataset_instance = GoogleCloudAiplatformV1Dataset.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1Dataset.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_dataset_dict = google_cloud_aiplatform_v1_dataset_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1Dataset from a dict
google_cloud_aiplatform_v1_dataset_from_dict = GoogleCloudAiplatformV1Dataset.from_dict(google_cloud_aiplatform_v1_dataset_dict)
```
