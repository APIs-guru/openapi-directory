...
**deployed_indexes** | [**List[GoogleCloudAiplatformV1DeployedIndex]**](GoogleCloudAiplatformV1DeployedIndex.md) | Output only. The indexes deployed in this endpoint. | [optional] [readonly] 
...
google_cloud_aiplatform_v1_index_endpoint_instance = GoogleCloudAiplatformV1IndexEndpoint.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1IndexEndpoint.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_index_endpoint_dict = google_cloud_aiplatform_v1_index_endpoint_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1IndexEndpoint from a dict
google_cloud_aiplatform_v1_index_endpoint_from_dict = GoogleCloudAiplatformV1IndexEndpoint.from_dict(google_cloud_aiplatform_v1_index_endpoint_dict)
```
