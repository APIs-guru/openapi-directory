...
google_cloud_aiplatform_v1_event_instance = GoogleCloudAiplatformV1Event.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1Event.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_event_dict = google_cloud_aiplatform_v1_event_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1Event from a dict
google_cloud_aiplatform_v1_event_from_dict = GoogleCloudAiplatformV1Event.from_dict(google_cloud_aiplatform_v1_event_dict)
```
