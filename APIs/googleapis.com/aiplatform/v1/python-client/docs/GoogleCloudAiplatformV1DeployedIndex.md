...
**deployed_index_auth_config** | [**GoogleCloudAiplatformV1DeployedIndexAuthConfig**](GoogleCloudAiplatformV1DeployedIndexAuthConfig.md) |  | [optional] 
...
**private_endpoints** | [**GoogleCloudAiplatformV1IndexPrivateEndpoints**](GoogleCloudAiplatformV1IndexPrivateEndpoints.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1DeployedIndex from a JSON string
google_cloud_aiplatform_v1_deployed_index_instance = GoogleCloudAiplatformV1DeployedIndex.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1DeployedIndex.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_deployed_index_dict = google_cloud_aiplatform_v1_deployed_index_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1DeployedIndex from a dict
google_cloud_aiplatform_v1_deployed_index_from_dict = GoogleCloudAiplatformV1DeployedIndex.from_dict(google_cloud_aiplatform_v1_deployed_index_dict)
```
