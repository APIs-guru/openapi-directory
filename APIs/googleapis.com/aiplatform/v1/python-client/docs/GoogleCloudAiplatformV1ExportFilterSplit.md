...
google_cloud_aiplatform_v1_export_filter_split_instance = GoogleCloudAiplatformV1ExportFilterSplit.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1ExportFilterSplit.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_export_filter_split_dict = google_cloud_aiplatform_v1_export_filter_split_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1ExportFilterSplit from a dict
google_cloud_aiplatform_v1_export_filter_split_from_dict = GoogleCloudAiplatformV1ExportFilterSplit.from_dict(google_cloud_aiplatform_v1_export_filter_split_dict)
```
