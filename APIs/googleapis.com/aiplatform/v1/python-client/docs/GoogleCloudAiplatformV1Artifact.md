...
google_cloud_aiplatform_v1_artifact_instance = GoogleCloudAiplatformV1Artifact.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1Artifact.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_artifact_dict = google_cloud_aiplatform_v1_artifact_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1Artifact from a dict
google_cloud_aiplatform_v1_artifact_from_dict = GoogleCloudAiplatformV1Artifact.from_dict(google_cloud_aiplatform_v1_artifact_dict)
```
