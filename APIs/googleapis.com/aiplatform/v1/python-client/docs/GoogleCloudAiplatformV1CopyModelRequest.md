...
google_cloud_aiplatform_v1_copy_model_request_instance = GoogleCloudAiplatformV1CopyModelRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1CopyModelRequest.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_copy_model_request_dict = google_cloud_aiplatform_v1_copy_model_request_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1CopyModelRequest from a dict
google_cloud_aiplatform_v1_copy_model_request_from_dict = GoogleCloudAiplatformV1CopyModelRequest.from_dict(google_cloud_aiplatform_v1_copy_model_request_dict)
```
