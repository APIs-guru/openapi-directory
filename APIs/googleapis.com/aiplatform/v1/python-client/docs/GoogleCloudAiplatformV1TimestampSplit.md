...
google_cloud_aiplatform_v1_timestamp_split_instance = GoogleCloudAiplatformV1TimestampSplit.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1TimestampSplit.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_timestamp_split_dict = google_cloud_aiplatform_v1_timestamp_split_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1TimestampSplit from a dict
google_cloud_aiplatform_v1_timestamp_split_from_dict = GoogleCloudAiplatformV1TimestampSplit.from_dict(google_cloud_aiplatform_v1_timestamp_split_dict)
```
