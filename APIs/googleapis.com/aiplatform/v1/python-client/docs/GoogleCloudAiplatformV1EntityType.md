...
**monitoring_config** | [**GoogleCloudAiplatformV1FeaturestoreMonitoringConfig**](GoogleCloudAiplatformV1FeaturestoreMonitoringConfig.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1EntityType from a JSON string
google_cloud_aiplatform_v1_entity_type_instance = GoogleCloudAiplatformV1EntityType.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1EntityType.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_entity_type_dict = google_cloud_aiplatform_v1_entity_type_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1EntityType from a dict
google_cloud_aiplatform_v1_entity_type_from_dict = GoogleCloudAiplatformV1EntityType.from_dict(google_cloud_aiplatform_v1_entity_type_dict)
```
