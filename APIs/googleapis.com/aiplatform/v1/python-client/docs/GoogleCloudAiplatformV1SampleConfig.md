...
google_cloud_aiplatform_v1_sample_config_instance = GoogleCloudAiplatformV1SampleConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1SampleConfig.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_sample_config_dict = google_cloud_aiplatform_v1_sample_config_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1SampleConfig from a dict
google_cloud_aiplatform_v1_sample_config_from_dict = GoogleCloudAiplatformV1SampleConfig.from_dict(google_cloud_aiplatform_v1_sample_config_dict)
```
