...
google_cloud_aiplatform_v1_tensorboard_experiment_instance = GoogleCloudAiplatformV1TensorboardExperiment.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1TensorboardExperiment.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_tensorboard_experiment_dict = google_cloud_aiplatform_v1_tensorboard_experiment_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1TensorboardExperiment from a dict
google_cloud_aiplatform_v1_tensorboard_experiment_from_dict = GoogleCloudAiplatformV1TensorboardExperiment.from_dict(google_cloud_aiplatform_v1_tensorboard_experiment_dict)
```
