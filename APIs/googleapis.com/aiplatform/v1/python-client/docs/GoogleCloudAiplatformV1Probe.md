...
------------ | ------------- | ------------- | -------------
**var_exec** | [**GoogleCloudAiplatformV1ProbeExecAction**](GoogleCloudAiplatformV1ProbeExecAction.md) |  | [optional] 
...
google_cloud_aiplatform_v1_probe_instance = GoogleCloudAiplatformV1Probe.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1Probe.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_probe_dict = google_cloud_aiplatform_v1_probe_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1Probe from a dict
google_cloud_aiplatform_v1_probe_from_dict = GoogleCloudAiplatformV1Probe.from_dict(google_cloud_aiplatform_v1_probe_dict)
```
