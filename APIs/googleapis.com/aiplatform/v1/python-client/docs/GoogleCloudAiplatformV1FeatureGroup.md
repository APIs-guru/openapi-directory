...
------------ | ------------- | ------------- | -------------
**big_query** | [**GoogleCloudAiplatformV1FeatureGroupBigQuery**](GoogleCloudAiplatformV1FeatureGroupBigQuery.md) |  | [optional] 
...
json = "{}"
# create an instance of GoogleCloudAiplatformV1FeatureGroup from a JSON string
google_cloud_aiplatform_v1_feature_group_instance = GoogleCloudAiplatformV1FeatureGroup.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1FeatureGroup.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_feature_group_dict = google_cloud_aiplatform_v1_feature_group_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1FeatureGroup from a dict
google_cloud_aiplatform_v1_feature_group_from_dict = GoogleCloudAiplatformV1FeatureGroup.from_dict(google_cloud_aiplatform_v1_feature_group_dict)
```
