...
json = "{}"
# create an instance of GoogleCloudAiplatformV1DatasetVersion from a JSON string
google_cloud_aiplatform_v1_dataset_version_instance = GoogleCloudAiplatformV1DatasetVersion.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1DatasetVersion.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_dataset_version_dict = google_cloud_aiplatform_v1_dataset_version_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1DatasetVersion from a dict
google_cloud_aiplatform_v1_dataset_version_from_dict = GoogleCloudAiplatformV1DatasetVersion.from_dict(google_cloud_aiplatform_v1_dataset_version_dict)
```
