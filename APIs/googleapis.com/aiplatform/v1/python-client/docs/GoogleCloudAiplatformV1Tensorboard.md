...
google_cloud_aiplatform_v1_tensorboard_instance = GoogleCloudAiplatformV1Tensorboard.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1Tensorboard.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_tensorboard_dict = google_cloud_aiplatform_v1_tensorboard_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1Tensorboard from a dict
google_cloud_aiplatform_v1_tensorboard_from_dict = GoogleCloudAiplatformV1Tensorboard.from_dict(google_cloud_aiplatform_v1_tensorboard_dict)
```
