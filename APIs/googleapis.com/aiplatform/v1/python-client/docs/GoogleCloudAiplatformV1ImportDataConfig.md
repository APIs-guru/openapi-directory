...
google_cloud_aiplatform_v1_import_data_config_instance = GoogleCloudAiplatformV1ImportDataConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1ImportDataConfig.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_import_data_config_dict = google_cloud_aiplatform_v1_import_data_config_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1ImportDataConfig from a dict
google_cloud_aiplatform_v1_import_data_config_from_dict = GoogleCloudAiplatformV1ImportDataConfig.from_dict(google_cloud_aiplatform_v1_import_data_config_dict)
```
