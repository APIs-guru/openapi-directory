...
google_cloud_aiplatform_v1_tensorboard_run_instance = GoogleCloudAiplatformV1TensorboardRun.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1TensorboardRun.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_tensorboard_run_dict = google_cloud_aiplatform_v1_tensorboard_run_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1TensorboardRun from a dict
google_cloud_aiplatform_v1_tensorboard_run_from_dict = GoogleCloudAiplatformV1TensorboardRun.from_dict(google_cloud_aiplatform_v1_tensorboard_run_dict)
```
