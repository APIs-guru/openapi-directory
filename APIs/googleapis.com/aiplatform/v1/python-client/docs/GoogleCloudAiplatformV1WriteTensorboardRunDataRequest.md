...
google_cloud_aiplatform_v1_write_tensorboard_run_data_request_instance = GoogleCloudAiplatformV1WriteTensorboardRunDataRequest.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudAiplatformV1WriteTensorboardRunDataRequest.to_json())

# convert the object into a dict
google_cloud_aiplatform_v1_write_tensorboard_run_data_request_dict = google_cloud_aiplatform_v1_write_tensorboard_run_data_request_instance.to_dict()
# create an instance of GoogleCloudAiplatformV1WriteTensorboardRunDataRequest from a dict
google_cloud_aiplatform_v1_write_tensorboard_run_data_request_from_dict = GoogleCloudAiplatformV1WriteTensorboardRunDataRequest.from_dict(google_cloud_aiplatform_v1_write_tensorboard_run_data_request_dict)
```
