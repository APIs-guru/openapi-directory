...
class GoogleCloudAiplatformV1FeatureGroupBigQuery(BaseModel):
    """
    Input source type for BigQuery Tables and Views.
    """ # noqa: E501
    big_query_source: Optional[GoogleCloudAiplatformV1BigQuerySource] = Field(default=None, alias="bigQuerySource")
