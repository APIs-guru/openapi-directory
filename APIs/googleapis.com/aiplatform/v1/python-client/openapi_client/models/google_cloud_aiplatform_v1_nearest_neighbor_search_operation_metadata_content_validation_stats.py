...
class GoogleCloudAiplatformV1NearestNeighborSearchOperationMetadataContentValidationStats(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partialErrors": [GoogleCloudAiplatformV1NearestNeighborSearchOperationMetadataRecordError.from_dict(_item) for _item in obj["partialErrors"]] if obj.get("partialErrors") is not None else None,
