...
class GoogleCloudAiplatformV1ExplanationMetadataOverride(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": dict(
                (_k, GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride.from_dict(_v))
