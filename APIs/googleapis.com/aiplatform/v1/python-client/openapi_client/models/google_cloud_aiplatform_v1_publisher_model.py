...
class GoogleCloudAiplatformV1PublisherModel(BaseModel):
    """
    ...
    supported_actions: Optional[GoogleCloudAiplatformV1PublisherModelCallToAction] = Field(default=None, alias="supportedActions")
    ...
    __properties: ClassVar[List[str]] = ["frameworks", "launchStage", "name", "openSourceCategory", "predictSchemata", "publisherModelTemplate", "supportedActions", "versionId", "versionState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportedActions": GoogleCloudAiplatformV1PublisherModelCallToAction.from_dict(obj["supportedActions"]) if obj.get("supportedActions") is not None else None,
