...
class GoogleCloudAiplatformV1CustomJob(BaseModel):
    """
    ...
    job_spec: Optional[GoogleCloudAiplatformV1CustomJobSpec] = Field(default=None, alias="jobSpec")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobSpec": GoogleCloudAiplatformV1CustomJobSpec.from_dict(obj["jobSpec"]) if obj.get("jobSpec") is not None else None,
