...
class GoogleCloudAiplatformV1Tensor(BaseModel):
    """
    A tensor value type.
    """ # noqa: E501
    ...
    list_val: Optional[List[GoogleCloudAiplatformV1Tensor]] = Field(default=None, description="A list of tensor values.", alias="listVal")
    ...
    struct_val: Optional[Dict[str, GoogleCloudAiplatformV1Tensor]] = Field(default=None, description="A map of string to tensor.", alias="structVal")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "listVal": [GoogleCloudAiplatformV1Tensor.from_dict(_item) for _item in obj["listVal"]] if obj.get("listVal") is not None else None,
            "shape": obj.get("shape"),
            "stringVal": obj.get("stringVal"),
            "structVal": dict(
                (_k, GoogleCloudAiplatformV1Tensor.from_dict(_v))
...
GoogleCloudAiplatformV1Tensor.model_rebuild(raise_errors=False)
