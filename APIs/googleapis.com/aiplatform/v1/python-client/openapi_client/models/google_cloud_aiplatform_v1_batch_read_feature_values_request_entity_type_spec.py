...
class GoogleCloudAiplatformV1BatchReadFeatureValuesRequestEntityTypeSpec(BaseModel):
    """
    ...
    settings: Optional[List[GoogleCloudAiplatformV1DestinationFeatureSetting]] = Field(default=None, description="Per-Feature settings for the batch read.")
