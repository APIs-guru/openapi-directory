...
class GoogleCloudAiplatformV1ModelContainerSpec(BaseModel):
    """
    ...
    startup_probe: Optional[GoogleCloudAiplatformV1Probe] = Field(default=None, alias="startupProbe")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "env": [GoogleCloudAiplatformV1EnvVar.from_dict(_item) for _item in obj["env"]] if obj.get("env") is not None else None,
            "grpcPorts": [GoogleCloudAiplatformV1Port.from_dict(_item) for _item in obj["grpcPorts"]] if obj.get("grpcPorts") is not None else None,
            "healthProbe": GoogleCloudAiplatformV1Probe.from_dict(obj["healthProbe"]) if obj.get("healthProbe") is not None else None,
            "healthRoute": obj.get("healthRoute"),
            "imageUri": obj.get("imageUri"),
            "ports": [GoogleCloudAiplatformV1Port.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
            "predictRoute": obj.get("predictRoute"),
            "sharedMemorySizeMb": obj.get("sharedMemorySizeMb"),
            "startupProbe": GoogleCloudAiplatformV1Probe.from_dict(obj["startupProbe"]) if obj.get("startupProbe") is not None else None
        })
        return _obj
