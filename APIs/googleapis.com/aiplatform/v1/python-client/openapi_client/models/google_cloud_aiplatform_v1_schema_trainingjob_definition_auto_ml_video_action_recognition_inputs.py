...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutoMlVideoActionRecognitionInputs(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["modelType"]
    ...
    def model_type_validate_enum(cls, value):
        ...
        if value not in set(['MODEL_TYPE_UNSPECIFIED', 'CLOUD', 'MOBILE_VERSATILE_1', 'MOBILE_JETSON_VERSATILE_1', 'MOBILE_CORAL_VERSATILE_1']):
            raise ValueError("must be one of enum values ('MODEL_TYPE_UNSPECIFIED', 'CLOUD', 'MOBILE_VERSATILE_1', 'MOBILE_JETSON_VERSATILE_1', 'MOBILE_CORAL_VERSATILE_1')")
        return value
