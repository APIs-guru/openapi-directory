...
class CloudAiLargeModelsVisionNamedBoundingBox(BaseModel):
    """
    ...
    x1: Optional[Union[StrictFloat, StrictInt]] = None
    x2: Optional[Union[StrictFloat, StrictInt]] = None
    y1: Optional[Union[StrictFloat, StrictInt]] = None
    y2: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["classes", "entities", "scores", "x1", "x2", "y1", "y2"]
