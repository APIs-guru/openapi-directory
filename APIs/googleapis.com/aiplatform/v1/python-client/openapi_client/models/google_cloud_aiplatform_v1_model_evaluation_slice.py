...
class GoogleCloudAiplatformV1ModelEvaluationSlice(BaseModel):
    """
    ...
    slice: Optional[GoogleCloudAiplatformV1ModelEvaluationSliceSlice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "slice": GoogleCloudAiplatformV1ModelEvaluationSliceSlice.from_dict(obj["slice"]) if obj.get("slice") is not None else None
        })
        return _obj
