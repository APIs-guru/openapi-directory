...
class LearningGenaiRootScoredSimilarityTakedownPhrase(BaseModel):
    """
    Proto containing the results from the Universal Sentence Encoder / Other models
    """ # noqa: E501
    phrase: Optional[LearningGenaiRootSimilarityTakedownPhrase] = None
    similarity_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="similarityScore")
    __properties: ClassVar[List[str]] = ["phrase", "similarityScore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "phrase": LearningGenaiRootSimilarityTakedownPhrase.from_dict(obj["phrase"]) if obj.get("phrase") is not None else None,
            "similarityScore": obj.get("similarityScore")
        })
        return _obj
