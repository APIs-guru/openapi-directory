...
class GoogleCloudAiplatformV1SchemaPredictPredictionClassificationPredictionResult(BaseModel):
    """
    ...
    ids: Optional[List[StrictStr]] = Field(default=None, description="The resource IDs of the AnnotationSpecs that had been identified.")
    __properties: ClassVar[List[str]] = ["confidences", "displayNames", "ids"]
