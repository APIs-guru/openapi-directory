...
class GoogleCloudAiplatformV1FeatureValueList(BaseModel):
    """
    Container for list of values.
    """ # noqa: E501
    values: Optional[List[GoogleCloudAiplatformV1FeatureValue]] = Field(default=None, description="A list of feature values. All of them should be the same data type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [GoogleCloudAiplatformV1FeatureValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
