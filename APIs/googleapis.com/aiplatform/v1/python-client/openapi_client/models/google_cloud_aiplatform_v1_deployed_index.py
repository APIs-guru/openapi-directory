...
class GoogleCloudAiplatformV1DeployedIndex(BaseModel):
    """
    ...
    deployed_index_auth_config: Optional[GoogleCloudAiplatformV1DeployedIndexAuthConfig] = Field(default=None, alias="deployedIndexAuthConfig")
    ...
    private_endpoints: Optional[GoogleCloudAiplatformV1IndexPrivateEndpoints] = Field(default=None, alias="privateEndpoints")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deployedIndexAuthConfig": GoogleCloudAiplatformV1DeployedIndexAuthConfig.from_dict(obj["deployedIndexAuthConfig"]) if obj.get("deployedIndexAuthConfig") is not None else None,
            ...
            "privateEndpoints": GoogleCloudAiplatformV1IndexPrivateEndpoints.from_dict(obj["privateEndpoints"]) if obj.get("privateEndpoints") is not None else None,
