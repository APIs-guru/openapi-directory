...
class GoogleCloudAiplatformV1BatchMigrateResourcesOperationMetadataPartialResult(BaseModel):
    """
    ...
    request: Optional[GoogleCloudAiplatformV1MigrateResourceRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": obj.get("model"),
            "request": GoogleCloudAiplatformV1MigrateResourceRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
