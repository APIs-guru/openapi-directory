...
class GoogleCloudAiplatformV1DeployedModel(BaseModel):
    """
    ...
    private_endpoints: Optional[GoogleCloudAiplatformV1PrivateEndpoints] = Field(default=None, alias="privateEndpoints")
    ...
    __properties: ClassVar[List[str]] = ["automaticResources", "createTime", "dedicatedResources", "disableContainerLogging", "displayName", "enableAccessLogging", "explanationSpec", "id", "model", "modelVersionId", "privateEndpoints", "serviceAccount", "sharedResources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privateEndpoints": GoogleCloudAiplatformV1PrivateEndpoints.from_dict(obj["privateEndpoints"]) if obj.get("privateEndpoints") is not None else None,
