...
class GoogleCloudAiplatformV1PythonPackageSpec(BaseModel):
    """
    The spec of a Python packaged code.
    """ # noqa: E501
    args: Optional[List[StrictStr]] = Field(default=None, description="Command line arguments to be passed to the Python task.")
    env: Optional[List[GoogleCloudAiplatformV1EnvVar]] = Field(default=None, description="Environment variables to be passed to the python module. Maximum limit is 100.")
