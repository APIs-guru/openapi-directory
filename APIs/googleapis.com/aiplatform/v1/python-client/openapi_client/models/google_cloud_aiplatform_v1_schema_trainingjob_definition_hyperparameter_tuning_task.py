...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHyperparameterTuningTask(BaseModel):
    """
    A TrainingJob that tunes Hypererparameters of a custom code Model.
    """ # noqa: E501
    inputs: Optional[GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHyperparameterTuningJobSpec] = None
    metadata: Optional[GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHyperparameterTuningJobMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHyperparameterTuningJobSpec.from_dict(obj["inputs"]) if obj.get("inputs") is not None else None,
            "metadata": GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHyperparameterTuningJobMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
