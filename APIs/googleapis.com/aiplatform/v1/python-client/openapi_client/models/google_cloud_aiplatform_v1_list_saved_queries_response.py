...
class GoogleCloudAiplatformV1ListSavedQueriesResponse(BaseModel):
    """
    ...
    saved_queries: Optional[List[GoogleCloudAiplatformV1SavedQuery]] = Field(default=None, description="A list of SavedQueries that match the specified filter in the request.", alias="savedQueries")
