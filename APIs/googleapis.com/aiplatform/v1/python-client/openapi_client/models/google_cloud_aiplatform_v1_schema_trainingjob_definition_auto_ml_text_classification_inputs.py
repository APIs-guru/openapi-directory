...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutoMlTextClassificationInputs(BaseModel):
    """
    GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutoMlTextClassificationInputs
    """ # noqa: E501
    multi_label: Optional[StrictBool] = Field(default=None, alias="multiLabel")
