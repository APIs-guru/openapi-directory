...
class GoogleCloudAiplatformV1CustomJobSpec(BaseModel):
    """
    Represents the spec of a CustomJob.
    """ # noqa: E501
    base_output_directory: Optional[GoogleCloudAiplatformV1GcsDestination] = Field(default=None, alias="baseOutputDirectory")
    ...
    scheduling: Optional[GoogleCloudAiplatformV1Scheduling] = None
    ...
    worker_pool_specs: Optional[List[GoogleCloudAiplatformV1WorkerPoolSpec]] = Field(default=None, description="Required. The spec of the worker pools including machine type and Docker image. All worker pools except the first one are optional and can be skipped by providing an empty value.", alias="workerPoolSpecs")
    __properties: ClassVar[List[str]] = ["baseOutputDirectory", "enableDashboardAccess", "enableWebAccess", "experiment", "experimentRun", "models", "network", "protectedArtifactLocationId", "reservedIpRanges", "scheduling", "serviceAccount", "tensorboard", "workerPoolSpecs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "baseOutputDirectory": GoogleCloudAiplatformV1GcsDestination.from_dict(obj["baseOutputDirectory"]) if obj.get("baseOutputDirectory") is not None else None,
            ...
            "scheduling": GoogleCloudAiplatformV1Scheduling.from_dict(obj["scheduling"]) if obj.get("scheduling") is not None else None,
            "serviceAccount": obj.get("serviceAccount"),
            "tensorboard": obj.get("tensorboard"),
            "workerPoolSpecs": [GoogleCloudAiplatformV1WorkerPoolSpec.from_dict(_item) for _item in obj["workerPoolSpecs"]] if obj.get("workerPoolSpecs") is not None else None
        })
        return _obj
