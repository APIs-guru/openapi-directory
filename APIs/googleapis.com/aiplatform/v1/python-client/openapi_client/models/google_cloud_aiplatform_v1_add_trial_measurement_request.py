...
class GoogleCloudAiplatformV1AddTrialMeasurementRequest(BaseModel):
    """
    Request message for VizierService.AddTrialMeasurement.
    """ # noqa: E501
    measurement: Optional[GoogleCloudAiplatformV1Measurement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "measurement": GoogleCloudAiplatformV1Measurement.from_dict(obj["measurement"]) if obj.get("measurement") is not None else None
        })
        return _obj
