...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfig(BaseModel):
    """
    ...
    maximum_runtime_constraint: Optional[GoogleCloudAiplatformV1StudyTimeConstraint] = Field(default=None, alias="maximumRuntimeConstraint")
    ...
    minimum_runtime_constraint: Optional[GoogleCloudAiplatformV1StudyTimeConstraint] = Field(default=None, alias="minimumRuntimeConstraint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maximumRuntimeConstraint": GoogleCloudAiplatformV1StudyTimeConstraint.from_dict(obj["maximumRuntimeConstraint"]) if obj.get("maximumRuntimeConstraint") is not None else None,
            "minNumTrials": obj.get("minNumTrials"),
            "minimumRuntimeConstraint": GoogleCloudAiplatformV1StudyTimeConstraint.from_dict(obj["minimumRuntimeConstraint"]) if obj.get("minimumRuntimeConstraint") is not None else None,
