...
class GoogleCloudAiplatformV1SchemaImageSegmentationAnnotationMaskAnnotation(BaseModel):
    """
    The mask based segmentation annotation.
    """ # noqa: E501
    annotation_spec_colors: Optional[List[GoogleCloudAiplatformV1SchemaAnnotationSpecColor]] = Field(default=None, description="The mapping between color and AnnotationSpec for this Annotation.", alias="annotationSpecColors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1SchemaImageSegmentationAnnotationMaskAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1SchemaImageSegmentationAnnotationMaskAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "annotationSpecColors": [GoogleCloudAiplatformV1SchemaAnnotationSpecColor.from_dict(_item) for _item in obj["annotationSpecColors"]] if obj.get("annotationSpecColors") is not None else None,
