...
class GoogleCloudAiplatformV1ReadIndexDatapointsResponse(BaseModel):
    """
    The response message for MatchService.ReadIndexDatapoints.
    """ # noqa: E501
    datapoints: Optional[List[GoogleCloudAiplatformV1IndexDatapoint]] = Field(default=None, description="The result list of datapoints.")
