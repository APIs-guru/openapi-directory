...
class GoogleCloudAiplatformV1Index(BaseModel):
    """
    ...
    deployed_indexes: Optional[List[GoogleCloudAiplatformV1DeployedIndexRef]] = Field(default=None, description="Output only. The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first.", alias="deployedIndexes")
    ...
    index_stats: Optional[GoogleCloudAiplatformV1IndexStats] = Field(default=None, alias="indexStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deployedIndexes": [GoogleCloudAiplatformV1DeployedIndexRef.from_dict(_item) for _item in obj["deployedIndexes"]] if obj.get("deployedIndexes") is not None else None,
            ...
            "etag": obj.get("etag"),
            "indexStats": GoogleCloudAiplatformV1IndexStats.from_dict(obj["indexStats"]) if obj.get("indexStats") is not None else None,
