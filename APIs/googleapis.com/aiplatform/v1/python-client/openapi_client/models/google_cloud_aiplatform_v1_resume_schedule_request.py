...
class GoogleCloudAiplatformV1ResumeScheduleRequest(BaseModel):
    """
    Request message for ScheduleService.ResumeSchedule.
    """ # noqa: E501
    catch_up: Optional[StrictBool] = Field(default=None, description="Optional. Whether to backfill missed runs when the schedule is resumed from PAUSED state. If set to true, all missed runs will be scheduled. New runs will be scheduled after the backfill is complete. This will also update Schedule.catch_up field. Default to false.", alias="catchUp")
    __properties: ClassVar[List[str]] = ["catchUp"]
