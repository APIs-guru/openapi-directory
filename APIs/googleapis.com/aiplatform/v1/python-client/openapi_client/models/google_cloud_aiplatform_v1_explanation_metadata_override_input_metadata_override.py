...
class GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride(BaseModel):
    """
    The input metadata entries to be overridden.
    """ # noqa: E501
    input_baselines: Optional[List[Any]] = Field(default=None, description="Baseline inputs for this feature. This overrides the `input_baseline` field of the ExplanationMetadata.InputMetadata object of the corresponding feature's input metadata. If it's not specified, the original baselines are not overridden.", alias="inputBaselines")
    __properties: ClassVar[List[str]] = ["inputBaselines"]
