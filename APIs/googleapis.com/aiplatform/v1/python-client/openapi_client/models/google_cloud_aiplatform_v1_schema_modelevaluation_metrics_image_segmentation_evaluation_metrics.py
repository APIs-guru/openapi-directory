...
class GoogleCloudAiplatformV1SchemaModelevaluationMetricsImageSegmentationEvaluationMetrics(BaseModel):
    """
    Metrics for image segmentation evaluation results.
    """ # noqa: E501
    confidence_metrics_entries: Optional[List[GoogleCloudAiplatformV1SchemaModelevaluationMetricsImageSegmentationEvaluationMetricsConfidenceMetricsEntry]] = Field(default=None, description="Metrics for each confidenceThreshold in 0.00,0.05,0.10,...,0.95,0.96,0.97,0.98,0.99 Precision-recall curve can be derived from it.", alias="confidenceMetricsEntries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidenceMetricsEntries": [GoogleCloudAiplatformV1SchemaModelevaluationMetricsImageSegmentationEvaluationMetricsConfidenceMetricsEntry.from_dict(_item) for _item in obj["confidenceMetricsEntries"]] if obj.get("confidenceMetricsEntries") is not None else None
        })
        return _obj
