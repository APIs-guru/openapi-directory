...
class GoogleCloudAiplatformV1Annotation(BaseModel):
    """
    Used to assign specific AnnotationSpec to a particular area of a DataItem or the whole part of the DataItem.
    """ # noqa: E501
    annotation_source: Optional[GoogleCloudAiplatformV1UserActionReference] = Field(default=None, alias="annotationSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationSource": GoogleCloudAiplatformV1UserActionReference.from_dict(obj["annotationSource"]) if obj.get("annotationSource") is not None else None,
