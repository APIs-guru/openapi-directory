...
class GoogleCloudAiplatformV1StreamingReadFeatureValuesRequest(BaseModel):
    """
    Request message for FeaturestoreOnlineServingService.StreamingFeatureValuesRead.
    """ # noqa: E501
    entity_ids: Optional[List[StrictStr]] = Field(default=None, description="Required. IDs of entities to read Feature values of. The maximum number of IDs is 100. For example, for a machine learning model predicting user clicks on a website, an entity ID could be `user_123`.", alias="entityIds")
    feature_selector: Optional[GoogleCloudAiplatformV1FeatureSelector] = Field(default=None, alias="featureSelector")
    __properties: ClassVar[List[str]] = ["entityIds", "featureSelector"]
