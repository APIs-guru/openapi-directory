...
class GoogleCloudAiplatformV1PublisherModelCallToActionViewRestApi(BaseModel):
    """
    Rest API docs.
    """ # noqa: E501
    documentations: Optional[List[GoogleCloudAiplatformV1PublisherModelDocumentation]] = Field(default=None, description="Required.")
    title: Optional[StrictStr] = Field(default=None, description="Required. The title of the view rest API.")
    __properties: ClassVar[List[str]] = ["documentations", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentations": [GoogleCloudAiplatformV1PublisherModelDocumentation.from_dict(_item) for _item in obj["documentations"]] if obj.get("documentations") is not None else None,
            "title": obj.get("title")
        })
        return _obj
