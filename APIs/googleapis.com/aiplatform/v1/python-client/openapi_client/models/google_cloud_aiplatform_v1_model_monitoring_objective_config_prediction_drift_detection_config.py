...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig(BaseModel):
    """
    The config for Prediction data drift detection.
    """ # noqa: E501
    attribution_score_drift_thresholds: Optional[Dict[str, GoogleCloudAiplatformV1ThresholdConfig]] = Field(default=None, description="Key is the feature name and value is the threshold. The threshold here is against attribution score distance between different time windows.", alias="attributionScoreDriftThresholds")
    default_drift_threshold: Optional[GoogleCloudAiplatformV1ThresholdConfig] = Field(default=None, alias="defaultDriftThreshold")
    drift_thresholds: Optional[Dict[str, GoogleCloudAiplatformV1ThresholdConfig]] = Field(default=None, description="Key is the feature name and value is the threshold. If a feature needs to be monitored for drift, a value threshold must be configured for that feature. The threshold here is against feature distribution distance between different time windws.", alias="driftThresholds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultDriftThreshold": GoogleCloudAiplatformV1ThresholdConfig.from_dict(obj["defaultDriftThreshold"]) if obj.get("defaultDriftThreshold") is not None else None,
