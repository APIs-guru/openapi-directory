...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs(BaseModel):
    """
    ...
    data_granularity: Optional[GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsGranularity] = Field(default=None, alias="dataGranularity")
    ...
    quantiles: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Quantiles to use for minimize-quantile-loss `optimization_objective`. Up to 5 quantiles are allowed of values between 0 and 1, exclusive. Required if the value of optimization_objective is minimize-quantile-loss. Represents the percent quantiles to use for that objective. Quantiles must be unique.")
    ...
    __properties: ClassVar[List[str]] = ["additionalExperiments", "availableAtForecastColumns", "contextWindow", "dataGranularity", "exportEvaluatedDataItemsConfig", "forecastHorizon", "hierarchyConfig", "holidayRegions", "optimizationObjective", "quantiles", "targetColumn", "timeColumn", "timeSeriesAttributeColumns", "timeSeriesIdentifierColumn", "trainBudgetMilliNodeHours", "transformations", "unavailableAtForecastColumns", "validationOptions", "weightColumn", "windowConfig"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dataGranularity": GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsGranularity.from_dict(obj["dataGranularity"]) if obj.get("dataGranularity") is not None else None,
            ...
            "transformations": [GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation.from_dict(_item) for _item in obj["transformations"]] if obj.get("transformations") is not None else None,
