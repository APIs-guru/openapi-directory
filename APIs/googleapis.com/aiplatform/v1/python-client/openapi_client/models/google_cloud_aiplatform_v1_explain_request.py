...
class GoogleCloudAiplatformV1ExplainRequest(BaseModel):
    """
    ...
    explanation_spec_override: Optional[GoogleCloudAiplatformV1ExplanationSpecOverride] = Field(default=None, alias="explanationSpecOverride")
    ...
    __properties: ClassVar[List[str]] = ["deployedModelId", "explanationSpecOverride", "instances", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "explanationSpecOverride": GoogleCloudAiplatformV1ExplanationSpecOverride.from_dict(obj["explanationSpecOverride"]) if obj.get("explanationSpecOverride") is not None else None,
