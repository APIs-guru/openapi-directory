...
class GoogleCloudAiplatformV1ExplanationParameters(BaseModel):
    """
    Parameters to configure explaining for Model's predictions.
    """ # noqa: E501
    examples: Optional[GoogleCloudAiplatformV1Examples] = None
    integrated_gradients_attribution: Optional[GoogleCloudAiplatformV1IntegratedGradientsAttribution] = Field(default=None, alias="integratedGradientsAttribution")
    ...
    sampled_shapley_attribution: Optional[GoogleCloudAiplatformV1SampledShapleyAttribution] = Field(default=None, alias="sampledShapleyAttribution")
    ...
    xrai_attribution: Optional[GoogleCloudAiplatformV1XraiAttribution] = Field(default=None, alias="xraiAttribution")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1ExplanationParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1ExplanationParameters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "examples": GoogleCloudAiplatformV1Examples.from_dict(obj["examples"]) if obj.get("examples") is not None else None,
            "integratedGradientsAttribution": GoogleCloudAiplatformV1IntegratedGradientsAttribution.from_dict(obj["integratedGradientsAttribution"]) if obj.get("integratedGradientsAttribution") is not None else None,
            "outputIndices": obj.get("outputIndices"),
            "sampledShapleyAttribution": GoogleCloudAiplatformV1SampledShapleyAttribution.from_dict(obj["sampledShapleyAttribution"]) if obj.get("sampledShapleyAttribution") is not None else None,
            "topK": obj.get("topK"),
            "xraiAttribution": GoogleCloudAiplatformV1XraiAttribution.from_dict(obj["xraiAttribution"]) if obj.get("xraiAttribution") is not None else None
        })
        return _obj
