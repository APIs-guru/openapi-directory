...
class GoogleCloudAiplatformV1StudySpec(BaseModel):
    """
    Represents specification of a Study.
    """ # noqa: E501
    algorithm: Optional[StrictStr] = Field(default=None, description="The search algorithm specified for the Study.")
    convex_automated_stopping_spec: Optional[GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec] = Field(default=None, alias="convexAutomatedStoppingSpec")
    decay_curve_stopping_spec: Optional[GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpec] = Field(default=None, alias="decayCurveStoppingSpec")
    ...
    median_automated_stopping_spec: Optional[GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpec] = Field(default=None, alias="medianAutomatedStoppingSpec")
    metrics: Optional[List[GoogleCloudAiplatformV1StudySpecMetricSpec]] = Field(default=None, description="Required. Metric specs for the Study.")
    ...
    parameters: Optional[List[GoogleCloudAiplatformV1StudySpecParameterSpec]] = Field(default=None, description="Required. The set of parameters to tune.")
    study_stopping_config: Optional[GoogleCloudAiplatformV1StudySpecStudyStoppingConfig] = Field(default=None, alias="studyStoppingConfig")
    __properties: ClassVar[List[str]] = ["algorithm", "convexAutomatedStoppingSpec", "decayCurveStoppingSpec", "measurementSelectionType", "medianAutomatedStoppingSpec", "metrics", "observationNoise", "parameters", "studyStoppingConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "convexAutomatedStoppingSpec": GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec.from_dict(obj["convexAutomatedStoppingSpec"]) if obj.get("convexAutomatedStoppingSpec") is not None else None,
            "decayCurveStoppingSpec": GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpec.from_dict(obj["decayCurveStoppingSpec"]) if obj.get("decayCurveStoppingSpec") is not None else None,
            "measurementSelectionType": obj.get("measurementSelectionType"),
            "medianAutomatedStoppingSpec": GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpec.from_dict(obj["medianAutomatedStoppingSpec"]) if obj.get("medianAutomatedStoppingSpec") is not None else None,
            "metrics": [GoogleCloudAiplatformV1StudySpecMetricSpec.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "observationNoise": obj.get("observationNoise"),
            "parameters": [GoogleCloudAiplatformV1StudySpecParameterSpec.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
            "studyStoppingConfig": GoogleCloudAiplatformV1StudySpecStudyStoppingConfig.from_dict(obj["studyStoppingConfig"]) if obj.get("studyStoppingConfig") is not None else None
        })
        return _obj
