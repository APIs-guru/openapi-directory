...
class GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairList(BaseModel):
    """
    Response structure in the format of key (feature name) and (feature) value pair.
    """ # noqa: E501
    features: Optional[List[GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairListFeatureNameValuePair]] = Field(default=None, description="List of feature names and values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": [GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairListFeatureNameValuePair.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
