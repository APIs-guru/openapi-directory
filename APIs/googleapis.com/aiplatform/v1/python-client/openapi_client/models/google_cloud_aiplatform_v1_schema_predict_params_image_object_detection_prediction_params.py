...
class GoogleCloudAiplatformV1SchemaPredictParamsImageObjectDetectionPredictionParams(BaseModel):
    """
    ...
    max_predictions: Optional[StrictInt] = Field(default=None, description="The Model only returns up to that many top, by confidence score, predictions per instance. Note that number of returned predictions is also limited by metadata's predictionsLimit. Default value is 10.", alias="maxPredictions")
