...
class GoogleCloudAiplatformV1SearchModelDeploymentMonitoringStatsAnomaliesRequest(BaseModel):
    """
    ...
    objectives: Optional[List[GoogleCloudAiplatformV1SearchModelDeploymentMonitoringStatsAnomaliesRequestStatsAnomaliesObjective]] = Field(default=None, description="Required. Objectives of the stats to retrieve.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objectives": [GoogleCloudAiplatformV1SearchModelDeploymentMonitoringStatsAnomaliesRequestStatsAnomaliesObjective.from_dict(_item) for _item in obj["objectives"]] if obj.get("objectives") is not None else None,
