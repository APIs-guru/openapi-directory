...
class GoogleCloudAiplatformV1ListDataItemsResponse(BaseModel):
    """
    Response message for DatasetService.ListDataItems.
    """ # noqa: E501
    data_items: Optional[List[GoogleCloudAiplatformV1DataItem]] = Field(default=None, description="A list of DataItems that matches the specified filter in the request.", alias="dataItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataItems": [GoogleCloudAiplatformV1DataItem.from_dict(_item) for _item in obj["dataItems"]] if obj.get("dataItems") is not None else None,
