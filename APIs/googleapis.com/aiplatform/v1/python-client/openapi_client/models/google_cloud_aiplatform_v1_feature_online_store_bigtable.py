...
class GoogleCloudAiplatformV1FeatureOnlineStoreBigtable(BaseModel):
    """
    GoogleCloudAiplatformV1FeatureOnlineStoreBigtable
    """ # noqa: E501
    auto_scaling: Optional[GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScaling] = Field(default=None, alias="autoScaling")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autoScaling": GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScaling.from_dict(obj["autoScaling"]) if obj.get("autoScaling") is not None else None
        })
        return _obj
