...
class GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfig(BaseModel):
    """
    The config for email alert.
    """ # noqa: E501
    user_emails: Optional[List[StrictStr]] = Field(default=None, description="The email addresses to send the alert.", alias="userEmails")
