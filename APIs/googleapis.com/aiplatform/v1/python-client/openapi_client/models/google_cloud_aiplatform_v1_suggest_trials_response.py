...
class GoogleCloudAiplatformV1SuggestTrialsResponse(BaseModel):
    """
    ...
    trials: Optional[List[GoogleCloudAiplatformV1Trial]] = Field(default=None, description="A list of Trials.")
