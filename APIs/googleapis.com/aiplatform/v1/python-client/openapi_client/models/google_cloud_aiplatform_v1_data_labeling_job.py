...
class GoogleCloudAiplatformV1DataLabelingJob(BaseModel):
    """
    DataLabelingJob is used to trigger a human labeling job on unlabeled data from the following Dataset:
    """ # noqa: E501
    active_learning_config: Optional[GoogleCloudAiplatformV1ActiveLearningConfig] = Field(default=None, alias="activeLearningConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeLearningConfig": GoogleCloudAiplatformV1ActiveLearningConfig.from_dict(obj["activeLearningConfig"]) if obj.get("activeLearningConfig") is not None else None,
