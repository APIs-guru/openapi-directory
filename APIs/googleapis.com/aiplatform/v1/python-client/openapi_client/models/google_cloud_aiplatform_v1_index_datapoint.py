...
class GoogleCloudAiplatformV1IndexDatapoint(BaseModel):
    """
    A datapoint of Index.
    """ # noqa: E501
    crowding_tag: Optional[GoogleCloudAiplatformV1IndexDatapointCrowdingTag] = Field(default=None, alias="crowdingTag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "crowdingTag": GoogleCloudAiplatformV1IndexDatapointCrowdingTag.from_dict(obj["crowdingTag"]) if obj.get("crowdingTag") is not None else None,
            "datapointId": obj.get("datapointId"),
            "featureVector": obj.get("featureVector"),
            "numericRestricts": [GoogleCloudAiplatformV1IndexDatapointNumericRestriction.from_dict(_item) for _item in obj["numericRestricts"]] if obj.get("numericRestricts") is not None else None,
            "restricts": [GoogleCloudAiplatformV1IndexDatapointRestriction.from_dict(_item) for _item in obj["restricts"]] if obj.get("restricts") is not None else None
        })
        return _obj
