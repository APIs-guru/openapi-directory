...
class CloudAiLargeModelsVisionMedia(BaseModel):
    """
    Media.
    """ # noqa: E501
    image: Optional[CloudAiLargeModelsVisionImage] = None
    video: Optional[CloudAiLargeModelsVisionVideo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": CloudAiLargeModelsVisionImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "video": CloudAiLargeModelsVisionVideo.from_dict(obj["video"]) if obj.get("video") is not None else None
        })
        return _obj
