...
class LearningGenaiRootSimilarityTakedownPhrase(BaseModel):
    """
    ...
    """ # noqa: E501
    blocked_phrase: Optional[StrictStr] = Field(default=None, alias="blockedPhrase")
    __properties: ClassVar[List[str]] = ["blockedPhrase"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blockedPhrase": obj.get("blockedPhrase")
        })
        return _obj
