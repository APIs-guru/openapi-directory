...
class GoogleCloudAiplatformV1TensorboardTimeSeries(BaseModel):
    """
    ...
    metadata: Optional[GoogleCloudAiplatformV1TensorboardTimeSeriesMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "metadata": GoogleCloudAiplatformV1TensorboardTimeSeriesMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": obj.get("name"),
