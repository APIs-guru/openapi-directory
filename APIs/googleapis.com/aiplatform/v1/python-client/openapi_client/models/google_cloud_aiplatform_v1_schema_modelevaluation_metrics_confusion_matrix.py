...
class GoogleCloudAiplatformV1SchemaModelevaluationMetricsConfusionMatrix(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotationSpecs": [GoogleCloudAiplatformV1SchemaModelevaluationMetricsConfusionMatrixAnnotationSpecRef.from_dict(_item) for _item in obj["annotationSpecs"]] if obj.get("annotationSpecs") is not None else None,
            "rows": obj.get("rows")
        })
        return _obj
