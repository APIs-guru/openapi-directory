...
class GoogleCloudAiplatformV1FeatureValue(BaseModel):
    """
    Value for a feature.
    """ # noqa: E501
    bool_array_value: Optional[GoogleCloudAiplatformV1BoolArray] = Field(default=None, alias="boolArrayValue")
    ...
    double_array_value: Optional[GoogleCloudAiplatformV1DoubleArray] = Field(default=None, alias="doubleArrayValue")
    ...
    int64_array_value: Optional[GoogleCloudAiplatformV1Int64Array] = Field(default=None, alias="int64ArrayValue")
    int64_value: Optional[StrictStr] = Field(default=None, description="Int64 feature value.", alias="int64Value")
    metadata: Optional[GoogleCloudAiplatformV1FeatureValueMetadata] = None
    string_array_value: Optional[GoogleCloudAiplatformV1StringArray] = Field(default=None, alias="stringArrayValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boolArrayValue": GoogleCloudAiplatformV1BoolArray.from_dict(obj["boolArrayValue"]) if obj.get("boolArrayValue") is not None else None,
            "boolValue": obj.get("boolValue"),
            "bytesValue": obj.get("bytesValue"),
            "doubleArrayValue": GoogleCloudAiplatformV1DoubleArray.from_dict(obj["doubleArrayValue"]) if obj.get("doubleArrayValue") is not None else None,
            "doubleValue": obj.get("doubleValue"),
            "int64ArrayValue": GoogleCloudAiplatformV1Int64Array.from_dict(obj["int64ArrayValue"]) if obj.get("int64ArrayValue") is not None else None,
            "int64Value": obj.get("int64Value"),
            "metadata": GoogleCloudAiplatformV1FeatureValueMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "stringArrayValue": GoogleCloudAiplatformV1StringArray.from_dict(obj["stringArrayValue"]) if obj.get("stringArrayValue") is not None else None,
