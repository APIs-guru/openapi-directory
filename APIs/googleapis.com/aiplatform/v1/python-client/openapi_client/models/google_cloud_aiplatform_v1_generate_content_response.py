...
class GoogleCloudAiplatformV1GenerateContentResponse(BaseModel):
    """
    Response message for [PredictionService.GenerateContent].
    """ # noqa: E501
    candidates: Optional[List[GoogleCloudAiplatformV1Candidate]] = Field(default=None, description="Output only. Generated candidates.")
    prompt_feedback: Optional[GoogleCloudAiplatformV1GenerateContentResponsePromptFeedback] = Field(default=None, alias="promptFeedback")
    usage_metadata: Optional[GoogleCloudAiplatformV1GenerateContentResponseUsageMetadata] = Field(default=None, alias="usageMetadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "candidates": [GoogleCloudAiplatformV1Candidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None,
            "promptFeedback": GoogleCloudAiplatformV1GenerateContentResponsePromptFeedback.from_dict(obj["promptFeedback"]) if obj.get("promptFeedback") is not None else None,
            "usageMetadata": GoogleCloudAiplatformV1GenerateContentResponseUsageMetadata.from_dict(obj["usageMetadata"]) if obj.get("usageMetadata") is not None else None
        })
        return _obj
