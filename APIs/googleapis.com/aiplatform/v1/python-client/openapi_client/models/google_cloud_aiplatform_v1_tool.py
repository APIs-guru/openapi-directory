...
class GoogleCloudAiplatformV1Tool(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "functionDeclarations": [GoogleCloudAiplatformV1FunctionDeclaration.from_dict(_item) for _item in obj["functionDeclarations"]] if obj.get("functionDeclarations") is not None else None
        })
        return _obj
