...
class GoogleCloudAiplatformV1BatchPredictionJobInputConfig(BaseModel):
    """
    ...
    instances_format: Optional[StrictStr] = Field(default=None, description="Required. The format in which instances are given, must be one of the Model's supported_input_storage_formats.", alias="instancesFormat")
    __properties: ClassVar[List[str]] = ["bigquerySource", "gcsSource", "instancesFormat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instancesFormat": obj.get("instancesFormat")
        })
        return _obj
