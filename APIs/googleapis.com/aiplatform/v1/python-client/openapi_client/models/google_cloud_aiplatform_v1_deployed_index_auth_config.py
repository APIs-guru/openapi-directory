...
class GoogleCloudAiplatformV1DeployedIndexAuthConfig(BaseModel):
    """
    Used to set up the auth on the DeployedIndex's private endpoint.
    """ # noqa: E501
    auth_provider: Optional[GoogleCloudAiplatformV1DeployedIndexAuthConfigAuthProvider] = Field(default=None, alias="authProvider")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authProvider": GoogleCloudAiplatformV1DeployedIndexAuthConfigAuthProvider.from_dict(obj["authProvider"]) if obj.get("authProvider") is not None else None
        })
        return _obj
