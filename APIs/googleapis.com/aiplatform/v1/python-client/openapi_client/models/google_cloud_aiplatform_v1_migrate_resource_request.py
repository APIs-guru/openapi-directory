...
class GoogleCloudAiplatformV1MigrateResourceRequest(BaseModel):
    """
    Config of migrating one resource from automl.googleapis.com, datalabeling.googleapis.com and ml.googleapis.com to Vertex AI.
    """ # noqa: E501
    migrate_automl_dataset_config: Optional[GoogleCloudAiplatformV1MigrateResourceRequestMigrateAutomlDatasetConfig] = Field(default=None, alias="migrateAutomlDatasetConfig")
    migrate_automl_model_config: Optional[GoogleCloudAiplatformV1MigrateResourceRequestMigrateAutomlModelConfig] = Field(default=None, alias="migrateAutomlModelConfig")
    migrate_data_labeling_dataset_config: Optional[GoogleCloudAiplatformV1MigrateResourceRequestMigrateDataLabelingDatasetConfig] = Field(default=None, alias="migrateDataLabelingDatasetConfig")
    migrate_ml_engine_model_version_config: Optional[GoogleCloudAiplatformV1MigrateResourceRequestMigrateMlEngineModelVersionConfig] = Field(default=None, alias="migrateMlEngineModelVersionConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "migrateAutomlDatasetConfig": GoogleCloudAiplatformV1MigrateResourceRequestMigrateAutomlDatasetConfig.from_dict(obj["migrateAutomlDatasetConfig"]) if obj.get("migrateAutomlDatasetConfig") is not None else None,
            "migrateAutomlModelConfig": GoogleCloudAiplatformV1MigrateResourceRequestMigrateAutomlModelConfig.from_dict(obj["migrateAutomlModelConfig"]) if obj.get("migrateAutomlModelConfig") is not None else None,
            "migrateDataLabelingDatasetConfig": GoogleCloudAiplatformV1MigrateResourceRequestMigrateDataLabelingDatasetConfig.from_dict(obj["migrateDataLabelingDatasetConfig"]) if obj.get("migrateDataLabelingDatasetConfig") is not None else None,
            "migrateMlEngineModelVersionConfig": GoogleCloudAiplatformV1MigrateResourceRequestMigrateMlEngineModelVersionConfig.from_dict(obj["migrateMlEngineModelVersionConfig"]) if obj.get("migrateMlEngineModelVersionConfig") is not None else None
        })
        return _obj
