...
class GoogleCloudAiplatformV1BlurBaselineConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    max_blur_sigma: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The standard deviation of the blur kernel for the blurred baseline. The same blurring parameter is used for both the height and the width dimension. If not set, the method defaults to the zero (i.e. black for images) baseline.", alias="maxBlurSigma")
    __properties: ClassVar[List[str]] = ["maxBlurSigma"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxBlurSigma": obj.get("maxBlurSigma")
        })
        return _obj
