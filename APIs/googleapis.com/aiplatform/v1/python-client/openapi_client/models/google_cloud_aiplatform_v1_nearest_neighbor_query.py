...
class GoogleCloudAiplatformV1NearestNeighborQuery(BaseModel):
    """
    A query to find a number of similar entities.
    """ # noqa: E501
    embedding: Optional[GoogleCloudAiplatformV1NearestNeighborQueryEmbedding] = None
    ...
    parameters: Optional[GoogleCloudAiplatformV1NearestNeighborQueryParameters] = None
    ...
    string_filters: Optional[List[GoogleCloudAiplatformV1NearestNeighborQueryStringFilter]] = Field(default=None, description="Optional. The list of string filters.", alias="stringFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "embedding": GoogleCloudAiplatformV1NearestNeighborQueryEmbedding.from_dict(obj["embedding"]) if obj.get("embedding") is not None else None,
            "entityId": obj.get("entityId"),
            "neighborCount": obj.get("neighborCount"),
            "parameters": GoogleCloudAiplatformV1NearestNeighborQueryParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
            "perCrowdingAttributeNeighborCount": obj.get("perCrowdingAttributeNeighborCount"),
            "stringFilters": [GoogleCloudAiplatformV1NearestNeighborQueryStringFilter.from_dict(_item) for _item in obj["stringFilters"]] if obj.get("stringFilters") is not None else None
        })
        return _obj
