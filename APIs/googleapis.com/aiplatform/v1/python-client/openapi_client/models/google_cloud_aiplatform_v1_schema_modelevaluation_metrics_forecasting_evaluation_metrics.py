...
class GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics(BaseModel):
    """
    ...
    quantile_metrics: Optional[List[GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetricsQuantileMetricsEntry]] = Field(default=None, description="The quantile metrics entries for each quantile.", alias="quantileMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quantileMetrics": [GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetricsQuantileMetricsEntry.from_dict(_item) for _item in obj["quantileMetrics"]] if obj.get("quantileMetrics") is not None else None,
