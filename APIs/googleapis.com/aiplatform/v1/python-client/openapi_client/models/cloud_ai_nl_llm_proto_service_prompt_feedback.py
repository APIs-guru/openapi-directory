...
class CloudAiNlLlmProtoServicePromptFeedback(BaseModel):
    """
    Content filter results for a prompt sent in the request.
    """ # noqa: E501
    block_reason: Optional[StrictStr] = Field(default=None, description="Blocked reason.", alias="blockReason")
    block_reason_message: Optional[StrictStr] = Field(default=None, description="A readable block reason message.", alias="blockReasonMessage")
    safety_ratings: Optional[List[CloudAiNlLlmProtoServiceSafetyRating]] = Field(default=None, description="Safety ratings.", alias="safetyRatings")
    __properties: ClassVar[List[str]] = ["blockReason", "blockReasonMessage", "safetyRatings"]
    ...
    def block_reason_validate_enum(cls, value):
        ...
        if value not in set(['BLOCKED_REASON_UNSPECIFIED', 'SAFETY', 'OTHER']):
            raise ValueError("must be one of enum values ('BLOCKED_REASON_UNSPECIFIED', 'SAFETY', 'OTHER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockReasonMessage": obj.get("blockReasonMessage"),
