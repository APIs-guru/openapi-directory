...
class GoogleCloudAiplatformV1IndexEndpoint(BaseModel):
    """
    ...
    deployed_indexes: Optional[List[GoogleCloudAiplatformV1DeployedIndex]] = Field(default=None, description="Output only. The indexes deployed in this endpoint.", alias="deployedIndexes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1IndexEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1IndexEndpoint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "deployedIndexes": [GoogleCloudAiplatformV1DeployedIndex.from_dict(_item) for _item in obj["deployedIndexes"]] if obj.get("deployedIndexes") is not None else None,
