...
class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutoMlImageObjectDetectionInputs(BaseModel):
    """
    ...
    tunable_parameter: Optional[GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutomlImageTrainingTunableParameter] = Field(default=None, alias="tunableParameter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tunableParameter": GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutomlImageTrainingTunableParameter.from_dict(obj["tunableParameter"]) if obj.get("tunableParameter") is not None else None,
