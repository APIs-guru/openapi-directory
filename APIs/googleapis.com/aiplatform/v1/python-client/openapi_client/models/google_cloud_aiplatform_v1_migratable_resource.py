...
class GoogleCloudAiplatformV1MigratableResource(BaseModel):
    """
    Represents one resource that exists in automl.googleapis.com, datalabeling.googleapis.com or ml.googleapis.com.
    """ # noqa: E501
    automl_dataset: Optional[GoogleCloudAiplatformV1MigratableResourceAutomlDataset] = Field(default=None, alias="automlDataset")
    automl_model: Optional[GoogleCloudAiplatformV1MigratableResourceAutomlModel] = Field(default=None, alias="automlModel")
    data_labeling_dataset: Optional[GoogleCloudAiplatformV1MigratableResourceDataLabelingDataset] = Field(default=None, alias="dataLabelingDataset")
    ...
    ml_engine_model_version: Optional[GoogleCloudAiplatformV1MigratableResourceMlEngineModelVersion] = Field(default=None, alias="mlEngineModelVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "automlDataset": GoogleCloudAiplatformV1MigratableResourceAutomlDataset.from_dict(obj["automlDataset"]) if obj.get("automlDataset") is not None else None,
            "automlModel": GoogleCloudAiplatformV1MigratableResourceAutomlModel.from_dict(obj["automlModel"]) if obj.get("automlModel") is not None else None,
            "dataLabelingDataset": GoogleCloudAiplatformV1MigratableResourceDataLabelingDataset.from_dict(obj["dataLabelingDataset"]) if obj.get("dataLabelingDataset") is not None else None,
            "lastMigrateTime": obj.get("lastMigrateTime"),
            "lastUpdateTime": obj.get("lastUpdateTime"),
            "mlEngineModelVersion": GoogleCloudAiplatformV1MigratableResourceMlEngineModelVersion.from_dict(obj["mlEngineModelVersion"]) if obj.get("mlEngineModelVersion") is not None else None
        })
        return _obj
