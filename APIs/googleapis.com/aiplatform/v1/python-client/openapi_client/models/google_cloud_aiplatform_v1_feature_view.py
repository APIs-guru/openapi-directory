...
class GoogleCloudAiplatformV1FeatureView(BaseModel):
    """
    FeatureView is representation of values that the FeatureOnlineStore will serve based on its syncConfig.
    """ # noqa: E501
    big_query_source: Optional[GoogleCloudAiplatformV1FeatureViewBigQuerySource] = Field(default=None, alias="bigQuerySource")
    ...
    feature_registry_source: Optional[GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource] = Field(default=None, alias="featureRegistrySource")
    ...
    sync_config: Optional[GoogleCloudAiplatformV1FeatureViewSyncConfig] = Field(default=None, alias="syncConfig")
    ...
    __properties: ClassVar[List[str]] = ["bigQuerySource", "createTime", "etag", "featureRegistrySource", "labels", "name", "syncConfig", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigQuerySource": GoogleCloudAiplatformV1FeatureViewBigQuerySource.from_dict(obj["bigQuerySource"]) if obj.get("bigQuerySource") is not None else None,
            "createTime": obj.get("createTime"),
            "etag": obj.get("etag"),
            "featureRegistrySource": GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource.from_dict(obj["featureRegistrySource"]) if obj.get("featureRegistrySource") is not None else None,
            "labels": obj.get("labels"),
            "name": obj.get("name"),
            "syncConfig": GoogleCloudAiplatformV1FeatureViewSyncConfig.from_dict(obj["syncConfig"]) if obj.get("syncConfig") is not None else None,
