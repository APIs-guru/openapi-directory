...
class GoogleCloudAiplatformV1FeatureGroup(BaseModel):
    """
    Vertex AI Feature Group.
    """ # noqa: E501
    big_query: Optional[GoogleCloudAiplatformV1FeatureGroupBigQuery] = Field(default=None, alias="bigQuery")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigQuery": GoogleCloudAiplatformV1FeatureGroupBigQuery.from_dict(obj["bigQuery"]) if obj.get("bigQuery") is not None else None,
