...
class GoogleCloudAiplatformV1NotebookRuntimeTemplate(BaseModel):
    """
    ...
    data_persistent_disk_spec: Optional[GoogleCloudAiplatformV1PersistentDiskSpec] = Field(default=None, alias="dataPersistentDiskSpec")
    ...
    euc_config: Optional[GoogleCloudAiplatformV1NotebookEucConfig] = Field(default=None, alias="eucConfig")
    idle_shutdown_config: Optional[GoogleCloudAiplatformV1NotebookIdleShutdownConfig] = Field(default=None, alias="idleShutdownConfig")
    ...
    network_spec: Optional[GoogleCloudAiplatformV1NetworkSpec] = Field(default=None, alias="networkSpec")
    ...
    shielded_vm_config: Optional[GoogleCloudAiplatformV1ShieldedVmConfig] = Field(default=None, alias="shieldedVmConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1NotebookRuntimeTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudAiplatformV1NotebookRuntimeTemplate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dataPersistentDiskSpec": GoogleCloudAiplatformV1PersistentDiskSpec.from_dict(obj["dataPersistentDiskSpec"]) if obj.get("dataPersistentDiskSpec") is not None else None,
            "description": obj.get("description"),
            "displayName": obj.get("displayName"),
            "etag": obj.get("etag"),
            "eucConfig": GoogleCloudAiplatformV1NotebookEucConfig.from_dict(obj["eucConfig"]) if obj.get("eucConfig") is not None else None,
            "idleShutdownConfig": GoogleCloudAiplatformV1NotebookIdleShutdownConfig.from_dict(obj["idleShutdownConfig"]) if obj.get("idleShutdownConfig") is not None else None,
            ...
            "name": obj.get("name"),
            "networkSpec": GoogleCloudAiplatformV1NetworkSpec.from_dict(obj["networkSpec"]) if obj.get("networkSpec") is not None else None,
            ...
            "shieldedVmConfig": GoogleCloudAiplatformV1ShieldedVmConfig.from_dict(obj["shieldedVmConfig"]) if obj.get("shieldedVmConfig") is not None else None,
