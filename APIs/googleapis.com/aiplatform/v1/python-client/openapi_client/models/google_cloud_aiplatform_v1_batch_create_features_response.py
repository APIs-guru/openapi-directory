...
class GoogleCloudAiplatformV1BatchCreateFeaturesResponse(BaseModel):
    """
    Response message for FeaturestoreService.BatchCreateFeatures.
    """ # noqa: E501
    features: Optional[List[GoogleCloudAiplatformV1Feature]] = Field(default=None, description="The Features created.")
