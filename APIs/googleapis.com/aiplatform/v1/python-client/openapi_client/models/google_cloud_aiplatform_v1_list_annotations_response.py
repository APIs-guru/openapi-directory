...
class GoogleCloudAiplatformV1ListAnnotationsResponse(BaseModel):
    """
    Response message for DatasetService.ListAnnotations.
    """ # noqa: E501
    annotations: Optional[List[GoogleCloudAiplatformV1Annotation]] = Field(default=None, description="A list of Annotations that matches the specified filter in the request.")
