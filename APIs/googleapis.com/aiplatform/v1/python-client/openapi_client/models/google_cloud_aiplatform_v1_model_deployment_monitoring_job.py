...
class GoogleCloudAiplatformV1ModelDeploymentMonitoringJob(BaseModel):
    """
    ...
    bigquery_tables: Optional[List[GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable]] = Field(default=None, description="Output only. The created bigquery tables for the job under customer project. Customer could do their own query & analysis. There could be 4 log tables in maximum: 1. Training data logging predict request/response 2. Serving data logging predict request/response", alias="bigqueryTables")
    ...
    latest_monitoring_pipeline_metadata: Optional[GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata] = Field(default=None, alias="latestMonitoringPipelineMetadata")
    ...
    logging_sampling_strategy: Optional[GoogleCloudAiplatformV1SamplingStrategy] = Field(default=None, alias="loggingSamplingStrategy")
    model_deployment_monitoring_objective_configs: Optional[List[GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig]] = Field(default=None, description="Required. The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.", alias="modelDeploymentMonitoringObjectiveConfigs")
    model_deployment_monitoring_schedule_config: Optional[GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig] = Field(default=None, alias="modelDeploymentMonitoringScheduleConfig")
    model_monitoring_alert_config: Optional[GoogleCloudAiplatformV1ModelMonitoringAlertConfig] = Field(default=None, alias="modelMonitoringAlertConfig")
    ...
    stats_anomalies_base_directory: Optional[GoogleCloudAiplatformV1GcsDestination] = Field(default=None, alias="statsAnomaliesBaseDirectory")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bigqueryTables": [GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable.from_dict(_item) for _item in obj["bigqueryTables"]] if obj.get("bigqueryTables") is not None else None,
            ...
            "latestMonitoringPipelineMetadata": GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata.from_dict(obj["latestMonitoringPipelineMetadata"]) if obj.get("latestMonitoringPipelineMetadata") is not None else None,
            "logTtl": obj.get("logTtl"),
            "loggingSamplingStrategy": GoogleCloudAiplatformV1SamplingStrategy.from_dict(obj["loggingSamplingStrategy"]) if obj.get("loggingSamplingStrategy") is not None else None,
            "modelDeploymentMonitoringObjectiveConfigs": [GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.from_dict(_item) for _item in obj["modelDeploymentMonitoringObjectiveConfigs"]] if obj.get("modelDeploymentMonitoringObjectiveConfigs") is not None else None,
            "modelDeploymentMonitoringScheduleConfig": GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.from_dict(obj["modelDeploymentMonitoringScheduleConfig"]) if obj.get("modelDeploymentMonitoringScheduleConfig") is not None else None,
            "modelMonitoringAlertConfig": GoogleCloudAiplatformV1ModelMonitoringAlertConfig.from_dict(obj["modelMonitoringAlertConfig"]) if obj.get("modelMonitoringAlertConfig") is not None else None,
            "name": obj.get("name"),
            ...
            "state": obj.get("state"),
            "statsAnomaliesBaseDirectory": GoogleCloudAiplatformV1GcsDestination.from_dict(obj["statsAnomaliesBaseDirectory"]) if obj.get("statsAnomaliesBaseDirectory") is not None else None,
