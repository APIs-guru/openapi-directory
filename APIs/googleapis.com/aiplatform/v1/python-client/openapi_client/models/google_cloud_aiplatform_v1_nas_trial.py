...
class GoogleCloudAiplatformV1NasTrial(BaseModel):
    """
    Represents a uCAIP NasJob trial.
    """ # noqa: E501
    end_time: Optional[StrictStr] = Field(default=None, description="Output only. Time when the NasTrial's status changed to `SUCCEEDED` or `INFEASIBLE`.", alias="endTime")
    final_measurement: Optional[GoogleCloudAiplatformV1Measurement] = Field(default=None, alias="finalMeasurement")
    id: Optional[StrictStr] = Field(default=None, description="Output only. The identifier of the NasTrial assigned by the service.")
    start_time: Optional[StrictStr] = Field(default=None, description="Output only. Time when the NasTrial was started.", alias="startTime")
    state: Optional[StrictStr] = Field(default=None, description="Output only. The detailed state of the NasTrial.")
    __properties: ClassVar[List[str]] = ["endTime", "finalMeasurement", "id", "startTime", "state"]
