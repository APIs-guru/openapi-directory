...
class GoogleCloudAiplatformV1ModelEvaluationSliceSliceSliceSpec(BaseModel):
    """
    Specification for how the data should be sliced.
    """ # noqa: E501
    configs: Optional[Dict[str, GoogleCloudAiplatformV1ModelEvaluationSliceSliceSliceSpecSliceConfig]] = Field(default=None, description="Mapping configuration for this SliceSpec. The key is the name of the feature. By default, the key will be prefixed by \"instance\" as a dictionary prefix for Vertex Batch Predictions output format.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": dict(
                (_k, GoogleCloudAiplatformV1ModelEvaluationSliceSliceSliceSpecSliceConfig.from_dict(_v))
