...
class GoogleCloudAiplatformV1FindNeighborsResponseNearestNeighbors(BaseModel):
    """
    Nearest neighbors for one query.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the query datapoint.")
    neighbors: Optional[List[GoogleCloudAiplatformV1FindNeighborsResponseNeighbor]] = Field(default=None, description="All its neighbors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "neighbors": [GoogleCloudAiplatformV1FindNeighborsResponseNeighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
