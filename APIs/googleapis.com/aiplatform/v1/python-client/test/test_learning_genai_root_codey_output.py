...
class TestLearningGenaiRootCodeyOutput(unittest.TestCase):
    """LearningGenaiRootCodeyOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningGenaiRootCodeyOutput:
        """Test LearningGenaiRootCodeyOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningGenaiRootCodeyOutput`
        """
        model = LearningGenaiRootCodeyOutput()
        if include_optional:
    ...
    def testLearningGenaiRootCodeyOutput(self):
        """Test LearningGenaiRootCodeyOutput"""
