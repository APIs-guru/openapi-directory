...
class TestGoogleCloudAiplatformV1XraiAttribution(unittest.TestCase):
    """GoogleCloudAiplatformV1XraiAttribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1XraiAttribution:
        """Test GoogleCloudAiplatformV1XraiAttribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1XraiAttribution`
        """
        model = GoogleCloudAiplatformV1XraiAttribution()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1XraiAttribution(self):
        """Test GoogleCloudAiplatformV1XraiAttribution"""
