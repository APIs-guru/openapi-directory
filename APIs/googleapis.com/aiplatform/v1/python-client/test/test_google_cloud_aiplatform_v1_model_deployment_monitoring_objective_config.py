...
class TestGoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig:
        """Test GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig`
        """
        model = GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig(self):
        """Test GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig"""
