...
class TestLearningGenaiRootFilterMetadataFilterDebugInfo(unittest.TestCase):
    """LearningGenaiRootFilterMetadataFilterDebugInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningGenaiRootFilterMetadataFilterDebugInfo:
        """Test LearningGenaiRootFilterMetadataFilterDebugInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningGenaiRootFilterMetadataFilterDebugInfo`
        """
        model = LearningGenaiRootFilterMetadataFilterDebugInfo()
        if include_optional:
    ...
    def testLearningGenaiRootFilterMetadataFilterDebugInfo(self):
        """Test LearningGenaiRootFilterMetadataFilterDebugInfo"""
