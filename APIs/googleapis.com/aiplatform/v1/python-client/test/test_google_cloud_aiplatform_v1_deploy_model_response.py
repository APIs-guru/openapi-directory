...
class TestGoogleCloudAiplatformV1DeployModelResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1DeployModelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1DeployModelResponse:
        """Test GoogleCloudAiplatformV1DeployModelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1DeployModelResponse`
        """
        model = GoogleCloudAiplatformV1DeployModelResponse()
        if include_optional:
            return GoogleCloudAiplatformV1DeployModelResponse(
    ...
    def testGoogleCloudAiplatformV1DeployModelResponse(self):
        """Test GoogleCloudAiplatformV1DeployModelResponse"""
