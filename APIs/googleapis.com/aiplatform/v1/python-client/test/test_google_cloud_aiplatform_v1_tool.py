...
class TestGoogleCloudAiplatformV1Tool(unittest.TestCase):
    """GoogleCloudAiplatformV1Tool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1Tool:
        """Test GoogleCloudAiplatformV1Tool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1Tool`
        """
        model = GoogleCloudAiplatformV1Tool()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1Tool(self):
        """Test GoogleCloudAiplatformV1Tool"""
