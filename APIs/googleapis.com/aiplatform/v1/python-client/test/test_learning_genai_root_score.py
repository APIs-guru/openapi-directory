...
class TestLearningGenaiRootScore(unittest.TestCase):
    """LearningGenaiRootScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningGenaiRootScore:
        """Test LearningGenaiRootScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningGenaiRootScore`
        """
        model = LearningGenaiRootScore()
        if include_optional:
    ...
    def testLearningGenaiRootScore(self):
        """Test LearningGenaiRootScore"""
