...
class TestGoogleCloudAiplatformV1UploadModelRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1UploadModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1UploadModelRequest:
        """Test GoogleCloudAiplatformV1UploadModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1UploadModelRequest`
        """
        model = GoogleCloudAiplatformV1UploadModelRequest()
        if include_optional:
            return GoogleCloudAiplatformV1UploadModelRequest(
                model = openapi_client.models.google_cloud_aiplatform_v1_model.GoogleCloudAiplatformV1Model(
                    artifact_uri = '', 
    ...
    def testGoogleCloudAiplatformV1UploadModelRequest(self):
        """Test GoogleCloudAiplatformV1UploadModelRequest"""
