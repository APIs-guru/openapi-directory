...
class TestGoogleCloudAiplatformV1ImportModelEvaluationRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1ImportModelEvaluationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ImportModelEvaluationRequest:
        """Test GoogleCloudAiplatformV1ImportModelEvaluationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ImportModelEvaluationRequest`
        """
        model = GoogleCloudAiplatformV1ImportModelEvaluationRequest()
        if include_optional:
            return GoogleCloudAiplatformV1ImportModelEvaluationRequest(
                model_evaluation = openapi_client.models.google_cloud_aiplatform_v1_model_evaluation.GoogleCloudAiplatformV1ModelEvaluation(
                    annotation_schema_uri = '', 
                    create_time = '', 
                    data_item_schema_uri = '', 
                    display_name = '', 
                    explanation_specs = [
                        openapi_client.models.google_cloud_aiplatform_v1_model_evaluation_model_evaluation_explanation_spec.GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec(
    ...
    def testGoogleCloudAiplatformV1ImportModelEvaluationRequest(self):
        """Test GoogleCloudAiplatformV1ImportModelEvaluationRequest"""
