...
class TestLanguageLabsAidaTrustRecitationProtoSegmentResult(unittest.TestCase):
    """LanguageLabsAidaTrustRecitationProtoSegmentResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LanguageLabsAidaTrustRecitationProtoSegmentResult:
        """Test LanguageLabsAidaTrustRecitationProtoSegmentResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguageLabsAidaTrustRecitationProtoSegmentResult`
        """
        model = LanguageLabsAidaTrustRecitationProtoSegmentResult()
        if include_optional:
    ...
    def testLanguageLabsAidaTrustRecitationProtoSegmentResult(self):
        """Test LanguageLabsAidaTrustRecitationProtoSegmentResult"""
