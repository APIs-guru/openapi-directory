...
class TestGoogleCloudAiplatformV1Endpoint(unittest.TestCase):
    """GoogleCloudAiplatformV1Endpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1Endpoint:
        """Test GoogleCloudAiplatformV1Endpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1Endpoint`
        """
        model = GoogleCloudAiplatformV1Endpoint()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1Endpoint(self):
        """Test GoogleCloudAiplatformV1Endpoint"""
