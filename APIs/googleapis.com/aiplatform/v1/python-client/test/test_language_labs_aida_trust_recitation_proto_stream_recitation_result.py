...
class TestLanguageLabsAidaTrustRecitationProtoStreamRecitationResult(unittest.TestCase):
    """LanguageLabsAidaTrustRecitationProtoStreamRecitationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LanguageLabsAidaTrustRecitationProtoStreamRecitationResult:
        """Test LanguageLabsAidaTrustRecitationProtoStreamRecitationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguageLabsAidaTrustRecitationProtoStreamRecitationResult`
        """
        model = LanguageLabsAidaTrustRecitationProtoStreamRecitationResult()
        if include_optional:
    ...
    def testLanguageLabsAidaTrustRecitationProtoStreamRecitationResult(self):
        """Test LanguageLabsAidaTrustRecitationProtoStreamRecitationResult"""
