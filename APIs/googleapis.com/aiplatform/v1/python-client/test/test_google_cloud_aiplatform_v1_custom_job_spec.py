...
class TestGoogleCloudAiplatformV1CustomJobSpec(unittest.TestCase):
    """GoogleCloudAiplatformV1CustomJobSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1CustomJobSpec:
        """Test GoogleCloudAiplatformV1CustomJobSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1CustomJobSpec`
        """
        model = GoogleCloudAiplatformV1CustomJobSpec()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1CustomJobSpec(self):
        """Test GoogleCloudAiplatformV1CustomJobSpec"""
