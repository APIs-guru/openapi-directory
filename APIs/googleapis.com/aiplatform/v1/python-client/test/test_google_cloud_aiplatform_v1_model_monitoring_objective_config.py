...
class TestGoogleCloudAiplatformV1ModelMonitoringObjectiveConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig:
        """Test GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig`
        """
        model = GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1ModelMonitoringObjectiveConfig(self):
        """Test GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig"""
