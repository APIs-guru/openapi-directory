...
class TestGoogleCloudAiplatformV1Examples(unittest.TestCase):
    """GoogleCloudAiplatformV1Examples unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1Examples:
        """Test GoogleCloudAiplatformV1Examples
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1Examples`
        """
        model = GoogleCloudAiplatformV1Examples()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1Examples(self):
        """Test GoogleCloudAiplatformV1Examples"""
