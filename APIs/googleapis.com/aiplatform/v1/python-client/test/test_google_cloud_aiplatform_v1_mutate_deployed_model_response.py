...
class TestGoogleCloudAiplatformV1MutateDeployedModelResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1MutateDeployedModelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1MutateDeployedModelResponse:
        """Test GoogleCloudAiplatformV1MutateDeployedModelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1MutateDeployedModelResponse`
        """
        model = GoogleCloudAiplatformV1MutateDeployedModelResponse()
        if include_optional:
            return GoogleCloudAiplatformV1MutateDeployedModelResponse(
    ...
    def testGoogleCloudAiplatformV1MutateDeployedModelResponse(self):
        """Test GoogleCloudAiplatformV1MutateDeployedModelResponse"""
