...
class TestGoogleCloudAiplatformV1BatchPredictionJob(unittest.TestCase):
    """GoogleCloudAiplatformV1BatchPredictionJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1BatchPredictionJob:
        """Test GoogleCloudAiplatformV1BatchPredictionJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1BatchPredictionJob`
        """
        model = GoogleCloudAiplatformV1BatchPredictionJob()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1BatchPredictionJob(self):
        """Test GoogleCloudAiplatformV1BatchPredictionJob"""
