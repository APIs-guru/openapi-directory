...
class TestGoogleCloudAiplatformV1ListSchedulesResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListSchedulesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListSchedulesResponse:
        """Test GoogleCloudAiplatformV1ListSchedulesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListSchedulesResponse`
        """
        model = GoogleCloudAiplatformV1ListSchedulesResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListSchedulesResponse(
                next_page_token = '',
                schedules = [
                    openapi_client.models.google_cloud_aiplatform_v1_schedule.GoogleCloudAiplatformV1Schedule(
                        allow_queueing = True, 
                        catch_up = True, 
                        create_pipeline_job_request = openapi_client.models.google_cloud_aiplatform_v1_create_pipeline_job_request.GoogleCloudAiplatformV1CreatePipelineJobRequest(
                            parent = '', 
                        ...
                        last_pause_time = '', 
                        last_resume_time = '', 
                        last_scheduled_run_response = openapi_client.models.google_cloud_aiplatform_v1_schedule_run_response.GoogleCloudAiplatformV1ScheduleRunResponse(
                            run_response = '', 
                            scheduled_run_time = '', ), 
    ...
    def testGoogleCloudAiplatformV1ListSchedulesResponse(self):
        """Test GoogleCloudAiplatformV1ListSchedulesResponse"""
