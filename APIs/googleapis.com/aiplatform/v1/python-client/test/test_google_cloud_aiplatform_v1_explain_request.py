...
class TestGoogleCloudAiplatformV1ExplainRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1ExplainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ExplainRequest:
        """Test GoogleCloudAiplatformV1ExplainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ExplainRequest`
        """
        model = GoogleCloudAiplatformV1ExplainRequest()
        if include_optional:
            return GoogleCloudAiplatformV1ExplainRequest(
                deployed_model_id = '',
                explanation_spec_override = openapi_client.models.google_cloud_aiplatform_v1_explanation_spec_override.GoogleCloudAiplatformV1ExplanationSpecOverride(
                    examples_override = openapi_client.models.google_cloud_aiplatform_v1_examples_override.GoogleCloudAiplatformV1ExamplesOverride(
                        crowding_count = 56, 
                    ...
                    metadata = openapi_client.models.google_cloud_aiplatform_v1_explanation_metadata_override.GoogleCloudAiplatformV1ExplanationMetadataOverride(
                        inputs = {
                            'key' : openapi_client.models.google_cloud_aiplatform_v1_explanation_metadata_override_input_metadata_override.GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride(
                                input_baselines = [
                                    null
                                    ], )
                            }, ), 
    ...
    def testGoogleCloudAiplatformV1ExplainRequest(self):
        """Test GoogleCloudAiplatformV1ExplainRequest"""
