...
class TestGoogleCloudAiplatformV1ExplanationMetadata(unittest.TestCase):
    """GoogleCloudAiplatformV1ExplanationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ExplanationMetadata:
        """Test GoogleCloudAiplatformV1ExplanationMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ExplanationMetadata`
        """
        model = GoogleCloudAiplatformV1ExplanationMetadata()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1ExplanationMetadata(self):
        """Test GoogleCloudAiplatformV1ExplanationMetadata"""
