...
class TestGoogleCloudAiplatformV1ListCustomJobsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListCustomJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListCustomJobsResponse:
        """Test GoogleCloudAiplatformV1ListCustomJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListCustomJobsResponse`
        """
        model = GoogleCloudAiplatformV1ListCustomJobsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListCustomJobsResponse(
                custom_jobs = [
                    openapi_client.models.google_cloud_aiplatform_v1_custom_job.GoogleCloudAiplatformV1CustomJob(
                        create_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudAiplatformV1ListCustomJobsResponse(self):
        """Test GoogleCloudAiplatformV1ListCustomJobsResponse"""
