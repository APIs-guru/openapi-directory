...
class TestGoogleCloudAiplatformV1MutateDeployedIndexResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1MutateDeployedIndexResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1MutateDeployedIndexResponse:
        """Test GoogleCloudAiplatformV1MutateDeployedIndexResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1MutateDeployedIndexResponse`
        """
        model = GoogleCloudAiplatformV1MutateDeployedIndexResponse()
        if include_optional:
            return GoogleCloudAiplatformV1MutateDeployedIndexResponse(
    ...
    def testGoogleCloudAiplatformV1MutateDeployedIndexResponse(self):
        """Test GoogleCloudAiplatformV1MutateDeployedIndexResponse"""
