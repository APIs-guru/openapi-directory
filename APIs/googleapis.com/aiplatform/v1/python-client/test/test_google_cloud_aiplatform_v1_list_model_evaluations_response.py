...
class TestGoogleCloudAiplatformV1ListModelEvaluationsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListModelEvaluationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListModelEvaluationsResponse:
        """Test GoogleCloudAiplatformV1ListModelEvaluationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListModelEvaluationsResponse`
        """
        model = GoogleCloudAiplatformV1ListModelEvaluationsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListModelEvaluationsResponse(
                model_evaluations = [
                    openapi_client.models.google_cloud_aiplatform_v1_model_evaluation.GoogleCloudAiplatformV1ModelEvaluation(
    ...
    def testGoogleCloudAiplatformV1ListModelEvaluationsResponse(self):
        """Test GoogleCloudAiplatformV1ListModelEvaluationsResponse"""
