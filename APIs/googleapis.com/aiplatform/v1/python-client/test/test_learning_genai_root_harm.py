...
class TestLearningGenaiRootHarm(unittest.TestCase):
    """LearningGenaiRootHarm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LearningGenaiRootHarm:
        """Test LearningGenaiRootHarm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearningGenaiRootHarm`
        """
        model = LearningGenaiRootHarm()
        if include_optional:
    ...
    def testLearningGenaiRootHarm(self):
        """Test LearningGenaiRootHarm"""
