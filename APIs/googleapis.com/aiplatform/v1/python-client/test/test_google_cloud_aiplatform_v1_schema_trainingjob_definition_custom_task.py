...
class TestGoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask(unittest.TestCase):
    """GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask:
        """Test GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask`
        """
        model = GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask()
        if include_optional:
            return GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask(
                inputs = openapi_client.models.google_cloud_aiplatform_v1_custom_job_spec.GoogleCloudAiplatformV1CustomJobSpec(
                ...
                metadata = openapi_client.models.google_cloud_aiplatform_v1_schema_trainingjob_definition_custom_job_metadata.GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomJobMetadata(
                    backing_custom_job = '', )
            )
        else:
            return GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask(
    ...
    def testGoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask(self):
        """Test GoogleCloudAiplatformV1SchemaTrainingjobDefinitionCustomTask"""
