...
class TestGoogleCloudAiplatformV1DeployIndexRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1DeployIndexRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1DeployIndexRequest:
        """Test GoogleCloudAiplatformV1DeployIndexRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1DeployIndexRequest`
        """
        model = GoogleCloudAiplatformV1DeployIndexRequest()
        if include_optional:
            return GoogleCloudAiplatformV1DeployIndexRequest(
    ...
    def testGoogleCloudAiplatformV1DeployIndexRequest(self):
        """Test GoogleCloudAiplatformV1DeployIndexRequest"""
