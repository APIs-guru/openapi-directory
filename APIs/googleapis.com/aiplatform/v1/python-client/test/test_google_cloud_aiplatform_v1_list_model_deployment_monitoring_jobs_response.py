...
class TestGoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse:
        """Test GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse`
        """
        model = GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse(
                model_deployment_monitoring_jobs = [
                    openapi_client.models.google_cloud_aiplatform_v1_model_deployment_monitoring_job.GoogleCloudAiplatformV1ModelDeploymentMonitoringJob(
    ...
    def testGoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse(self):
        """Test GoogleCloudAiplatformV1ListModelDeploymentMonitoringJobsResponse"""
