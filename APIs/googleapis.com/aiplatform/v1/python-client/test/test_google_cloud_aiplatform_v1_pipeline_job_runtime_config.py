...
class TestGoogleCloudAiplatformV1PipelineJobRuntimeConfig(unittest.TestCase):
    """GoogleCloudAiplatformV1PipelineJobRuntimeConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1PipelineJobRuntimeConfig:
        """Test GoogleCloudAiplatformV1PipelineJobRuntimeConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1PipelineJobRuntimeConfig`
        """
        model = GoogleCloudAiplatformV1PipelineJobRuntimeConfig()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1PipelineJobRuntimeConfig(self):
        """Test GoogleCloudAiplatformV1PipelineJobRuntimeConfig"""
