...
class TestGoogleCloudAiplatformV1ExplanationSpec(unittest.TestCase):
    """GoogleCloudAiplatformV1ExplanationSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ExplanationSpec:
        """Test GoogleCloudAiplatformV1ExplanationSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ExplanationSpec`
        """
        model = GoogleCloudAiplatformV1ExplanationSpec()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1ExplanationSpec(self):
        """Test GoogleCloudAiplatformV1ExplanationSpec"""
