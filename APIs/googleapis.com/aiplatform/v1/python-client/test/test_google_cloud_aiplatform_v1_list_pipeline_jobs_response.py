...
class TestGoogleCloudAiplatformV1ListPipelineJobsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListPipelineJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListPipelineJobsResponse:
        """Test GoogleCloudAiplatformV1ListPipelineJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListPipelineJobsResponse`
        """
        model = GoogleCloudAiplatformV1ListPipelineJobsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListPipelineJobsResponse(
                next_page_token = '',
                pipeline_jobs = [
                    openapi_client.models.google_cloud_aiplatform_v1_pipeline_job.GoogleCloudAiplatformV1PipelineJob(
                        create_time = '', 
                        display_name = '', 
    ...
    def testGoogleCloudAiplatformV1ListPipelineJobsResponse(self):
        """Test GoogleCloudAiplatformV1ListPipelineJobsResponse"""
