...
class TestGoogleCloudAiplatformV1DedicatedResources(unittest.TestCase):
    """GoogleCloudAiplatformV1DedicatedResources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1DedicatedResources:
        """Test GoogleCloudAiplatformV1DedicatedResources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1DedicatedResources`
        """
        model = GoogleCloudAiplatformV1DedicatedResources()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1DedicatedResources(self):
        """Test GoogleCloudAiplatformV1DedicatedResources"""
