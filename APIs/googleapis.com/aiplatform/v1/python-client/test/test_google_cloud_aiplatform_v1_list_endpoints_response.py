...
class TestGoogleCloudAiplatformV1ListEndpointsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListEndpointsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListEndpointsResponse:
        """Test GoogleCloudAiplatformV1ListEndpointsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListEndpointsResponse`
        """
        model = GoogleCloudAiplatformV1ListEndpointsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListEndpointsResponse(
                endpoints = [
                    openapi_client.models.google_cloud_aiplatform_v1_endpoint.GoogleCloudAiplatformV1Endpoint(
                        create_time = '', 
                        deployed_models = [
                            openapi_client.models.google_cloud_aiplatform_v1_deployed_model.GoogleCloudAiplatformV1DeployedModel(
                        ...
                        name = '', 
                        network = '', 
                        predict_request_response_logging_config = openapi_client.models.google_cloud_aiplatform_v1_predict_request_response_logging_config.GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig(
    ...
    def testGoogleCloudAiplatformV1ListEndpointsResponse(self):
        """Test GoogleCloudAiplatformV1ListEndpointsResponse"""
