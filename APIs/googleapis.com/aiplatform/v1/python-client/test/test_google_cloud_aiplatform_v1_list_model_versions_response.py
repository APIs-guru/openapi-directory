...
class TestGoogleCloudAiplatformV1ListModelVersionsResponse(unittest.TestCase):
    """GoogleCloudAiplatformV1ListModelVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ListModelVersionsResponse:
        """Test GoogleCloudAiplatformV1ListModelVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ListModelVersionsResponse`
        """
        model = GoogleCloudAiplatformV1ListModelVersionsResponse()
        if include_optional:
            return GoogleCloudAiplatformV1ListModelVersionsResponse(
                models = [
                    openapi_client.models.google_cloud_aiplatform_v1_model.GoogleCloudAiplatformV1Model(
                        artifact_uri = '', 
    ...
    def testGoogleCloudAiplatformV1ListModelVersionsResponse(self):
        """Test GoogleCloudAiplatformV1ListModelVersionsResponse"""
