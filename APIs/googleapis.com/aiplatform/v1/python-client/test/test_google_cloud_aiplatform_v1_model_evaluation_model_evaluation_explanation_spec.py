...
class TestGoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec(unittest.TestCase):
    """GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec:
        """Test GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec`
        """
        model = GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec()
        if include_optional:
    ...
    def testGoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec(self):
        """Test GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec"""
