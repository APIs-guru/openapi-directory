...
class TestGoogleCloudAiplatformV1DeployModelRequest(unittest.TestCase):
    """GoogleCloudAiplatformV1DeployModelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudAiplatformV1DeployModelRequest:
        """Test GoogleCloudAiplatformV1DeployModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudAiplatformV1DeployModelRequest`
        """
        model = GoogleCloudAiplatformV1DeployModelRequest()
        if include_optional:
            return GoogleCloudAiplatformV1DeployModelRequest(
    ...
    def testGoogleCloudAiplatformV1DeployModelRequest(self):
        """Test GoogleCloudAiplatformV1DeployModelRequest"""
