...
class CryptoKeyVersion(BaseModel):
    ...
    external_protection_level_options: Optional[ExternalProtectionLevelOptions] = Field(default=None, alias="externalProtectionLevelOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalProtectionLevelOptions": ExternalProtectionLevelOptions.from_dict(obj["externalProtectionLevelOptions"]) if obj.get("externalProtectionLevelOptions") is not None else None,
