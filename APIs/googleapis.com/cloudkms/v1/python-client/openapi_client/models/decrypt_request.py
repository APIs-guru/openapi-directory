...
class DecryptRequest(BaseModel):
    ...
    """ # noqa: E501
    additional_authenticated_data: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Optional. Optional data that must match the data originally supplied in EncryptRequest.additional_authenticated_data.", alias="additionalAuthenticatedData")
    ...
    ciphertext: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Required. The encrypted data originally returned in EncryptResponse.ciphertext.")
    ...
    __properties: ClassVar[List[str]] = ["additionalAuthenticatedData", "additionalAuthenticatedDataCrc32c", "ciphertext", "ciphertextCrc32c"]
