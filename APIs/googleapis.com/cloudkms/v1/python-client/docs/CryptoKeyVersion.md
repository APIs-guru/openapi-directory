...
**external_protection_level_options** | [**ExternalProtectionLevelOptions**](ExternalProtectionLevelOptions.md) |  | [optional] 
...
json = "{}"
# create an instance of CryptoKeyVersion from a JSON string
crypto_key_version_instance = CryptoKeyVersion.from_json(json)
# print the JSON string representation of the object
print(CryptoKeyVersion.to_json())

# convert the object into a dict
crypto_key_version_dict = crypto_key_version_instance.to_dict()
# create an instance of CryptoKeyVersion from a dict
crypto_key_version_from_dict = CryptoKeyVersion.from_dict(crypto_key_version_dict)
```
