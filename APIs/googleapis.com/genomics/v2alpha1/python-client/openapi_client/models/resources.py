...
class Resources(BaseModel):
    ...
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, description="The project ID to allocate resources in.", alias="projectId")
    ...
    __properties: ClassVar[List[str]] = ["projectId", "regions", "virtualMachine", "zones"]
