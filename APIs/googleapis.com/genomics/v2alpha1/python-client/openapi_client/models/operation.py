...
class Operation(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="An OperationMetadata or Metadata object. This will always be returned with the Operation.")
    name: Optional[StrictStr] = Field(default=None, description="The server-assigned name, which is only unique within the same service that originally returns it. For example: `operations/CJHU7Oi_ChDrveSpBRjfuL-qzoWAgEw`")
