...
class UnexpectedExitStatusEvent(BaseModel):
    ...
    """ # noqa: E501
    action_id: Optional[StrictInt] = Field(default=None, description="The numeric ID of the action that started the container.", alias="actionId")
    exit_status: Optional[StrictInt] = Field(default=None, description="The exit status of the container.", alias="exitStatus")
    __properties: ClassVar[List[str]] = ["actionId", "exitStatus"]
