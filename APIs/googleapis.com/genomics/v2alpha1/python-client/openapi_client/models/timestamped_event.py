...
class TimestampedEvent(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = Field(default=None, description="The event data.")
    timestamp: Optional[StrictStr] = Field(default=None, description="The time when the event happened.")
