...
class Event(BaseModel):
    ...
    details: Optional[Dict[str, Any]] = Field(default=None, description="Machine-readable details about the event.")
    timestamp: Optional[StrictStr] = Field(default=None, description="The time at which the event occurred.")
    __properties: ClassVar[List[str]] = ["description", "details", "timestamp"]
