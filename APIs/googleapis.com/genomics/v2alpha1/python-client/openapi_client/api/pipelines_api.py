...
class PipelinesApi:
    ...
    def genomics_pipelines_run(
        ...
        run_pipeline_request: Optional[RunPipelineRequest] = None,
        ...
        :param run_pipeline_request:
        :type run_pipeline_request: RunPipelineRequest
        ...
        _param = self._genomics_pipelines_run_serialize(
            xgafv=xgafv,
            ...
            run_pipeline_request=run_pipeline_request,
    ...
    @validate_call
    def genomics_pipelines_run_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def genomics_pipelines_run_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _genomics_pipelines_run_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if run_pipeline_request is not None:
            _body_params = run_pipeline_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2alpha1/pipelines:run',
