...
class PlaceActionTypeMetadataApi:
    ...
    def mybusinessplaceactions_place_action_type_metadata_list(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Optional. A filter constraining the place action types to return metadata for. The response includes entries that match the filter. We support only the following filters: 1. location=XYZ where XYZ is a string indicating the resource name of a location, in the format `locations/{location_id}`. 2. region_code=XYZ where XYZ is a Unicode CLDR region code to find available action types. If no filter is provided, all place action types are returned.")] = None,
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The IETF BCP-47 code of language to get display names in. If this language is not available, they will be provided in English.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. How many action types to include per page. Default is 10, minimum is 1.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. If specified, the next page of place action type metadata is retrieved. The `pageToken` is returned when a call to `placeActionTypeMetadata.list` returns more results than can fit into the requested page size.")] = None,
        ...
        _param = self._mybusinessplaceactions_place_action_type_metadata_list_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListPlaceActionTypeMetadataResponse",
        }
    ...
    @validate_call
    def mybusinessplaceactions_place_action_type_metadata_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def mybusinessplaceactions_place_action_type_metadata_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _mybusinessplaceactions_place_action_type_metadata_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/placeActionTypeMetadata',
