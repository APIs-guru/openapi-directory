...
class TestTokenPayloadExternal(unittest.TestCase):
    """TokenPayloadExternal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenPayloadExternal:
        """Test TokenPayloadExternal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenPayloadExternal`
        """
    ...
    def testTokenPayloadExternal(self):
        """Test TokenPayloadExternal"""
