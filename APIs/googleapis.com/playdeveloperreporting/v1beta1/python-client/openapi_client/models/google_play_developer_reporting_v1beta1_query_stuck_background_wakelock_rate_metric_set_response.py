...
class GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse(BaseModel):
    """
    ...
    rows: Optional[List[GooglePlayDeveloperReportingV1beta1MetricsRow]] = Field(default=None, description="Returned rows of data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [GooglePlayDeveloperReportingV1beta1MetricsRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
