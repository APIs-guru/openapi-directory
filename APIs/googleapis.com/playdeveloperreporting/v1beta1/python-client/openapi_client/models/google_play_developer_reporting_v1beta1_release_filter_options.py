...
class GooglePlayDeveloperReportingV1beta1ReleaseFilterOptions(BaseModel):
    """
    A set of filtering options for releases and version codes specific to an app.
    """ # noqa: E501
    tracks: Optional[List[GooglePlayDeveloperReportingV1beta1Track]] = Field(default=None, description="List of tracks to filter releases over. Provides the grouping of version codes under releases and tracks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tracks": [GooglePlayDeveloperReportingV1beta1Track.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
