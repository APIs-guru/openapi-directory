...
class GooglePlayDeveloperReportingV1beta1ErrorIssue(BaseModel):
    ...
    first_app_version: Optional[GooglePlayDeveloperReportingV1beta1AppVersion] = Field(default=None, alias="firstAppVersion")
    first_os_version: Optional[GooglePlayDeveloperReportingV1beta1OsVersion] = Field(default=None, alias="firstOsVersion")
    ...
    last_app_version: Optional[GooglePlayDeveloperReportingV1beta1AppVersion] = Field(default=None, alias="lastAppVersion")
    ...
    last_os_version: Optional[GooglePlayDeveloperReportingV1beta1OsVersion] = Field(default=None, alias="lastOsVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstAppVersion": GooglePlayDeveloperReportingV1beta1AppVersion.from_dict(obj["firstAppVersion"]) if obj.get("firstAppVersion") is not None else None,
            "firstOsVersion": GooglePlayDeveloperReportingV1beta1OsVersion.from_dict(obj["firstOsVersion"]) if obj.get("firstOsVersion") is not None else None,
            "issueUri": obj.get("issueUri"),
            "lastAppVersion": GooglePlayDeveloperReportingV1beta1AppVersion.from_dict(obj["lastAppVersion"]) if obj.get("lastAppVersion") is not None else None,
            "lastErrorReportTime": obj.get("lastErrorReportTime"),
            "lastOsVersion": GooglePlayDeveloperReportingV1beta1OsVersion.from_dict(obj["lastOsVersion"]) if obj.get("lastOsVersion") is not None else None,
