...
class GooglePlayDeveloperReportingV1beta1Anomaly(BaseModel):
    ...
    """ # noqa: E501
    dimensions: Optional[List[GooglePlayDeveloperReportingV1beta1DimensionValue]] = Field(default=None, description="Combination of dimensions in which the anomaly was detected.")
    metric: Optional[GooglePlayDeveloperReportingV1beta1MetricValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metric": GooglePlayDeveloperReportingV1beta1MetricValue.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
