...
class AnomaliesApi:
    ...
    def playdeveloperreporting_anomalies_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Parent app for which anomalies were detected. Format: apps/{app}")],
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Filtering criteria for anomalies. For basic filter guidance, please check: https://google.aip.dev/160. **Supported functions:** * `activeBetween(startTime, endTime)`: If specified, only list anomalies that were active in between `startTime` (inclusive) and `endTime` (exclusive). Both parameters are expected to conform to an RFC-3339 formatted string (e.g. `2012-04-21T11:30:00-04:00`). UTC offsets are supported. Both `startTime` and `endTime` accept the special value `UNBOUNDED`, to signify intervals with no lower or upper bound, respectively. Examples: * `activeBetween(\"2021-04-21T11:30:00Z\", \"2021-07-21T00:00:00Z\")` * `activeBetween(UNBOUNDED, \"2021-11-21T00:00:00-04:00\")` * `activeBetween(\"2021-07-21T00:00:00-04:00\", UNBOUNDED)`")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Maximum size of the returned data. If unspecified, at most 10 anomalies will be returned. The maximum value is 100; values above 100 will be coerced to 100.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A page token, received from a previous `ListErrorReports` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListErrorReports` must match the call that provided the page token.")] = None,
        ...
        :type filter: str
        :param page_size: Maximum size of the returned data. If unspecified, at most 10 anomalies will be returned. The maximum value is 100; values above 100 will be coerced to 100.
        :type page_size: int
        :param page_token: A page token, received from a previous `ListErrorReports` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListErrorReports` must match the call that provided the page token.
        :type page_token: str
        ...
        _param = self._playdeveloperreporting_anomalies_list_serialize(
            parent=parent,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse",
        }
    ...
    @validate_call
    def playdeveloperreporting_anomalies_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Parent app for which anomalies were detected. Format: apps/{app}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse]:
        """playdeveloperreporting_anomalies_list
    ...
    @validate_call
    def playdeveloperreporting_anomalies_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. Parent app for which anomalies were detected. Format: apps/{app}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _playdeveloperreporting_anomalies_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1alpha1/{parent}/anomalies',
