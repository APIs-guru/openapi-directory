...
class GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Identifier. The resource name. Format: apps/{app}/crashRateMetricSet")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet from a dict"""
        if obj is None:
            return None
