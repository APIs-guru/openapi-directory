...
class GooglePlayDeveloperReportingV1alpha1ErrorReport(BaseModel):
    """
    ...
    """ # noqa: E501
    app_version: Optional[GooglePlayDeveloperReportingV1alpha1AppVersion] = Field(default=None, alias="appVersion")
    device_model: Optional[GooglePlayDeveloperReportingV1alpha1DeviceModelSummary] = Field(default=None, alias="deviceModel")
    ...
    os_version: Optional[GooglePlayDeveloperReportingV1alpha1OsVersion] = Field(default=None, alias="osVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appVersion": GooglePlayDeveloperReportingV1alpha1AppVersion.from_dict(obj["appVersion"]) if obj.get("appVersion") is not None else None,
            "deviceModel": GooglePlayDeveloperReportingV1alpha1DeviceModelSummary.from_dict(obj["deviceModel"]) if obj.get("deviceModel") is not None else None,
            "eventTime": obj.get("eventTime"),
            "issue": obj.get("issue"),
            "name": obj.get("name"),
            "osVersion": GooglePlayDeveloperReportingV1alpha1OsVersion.from_dict(obj["osVersion"]) if obj.get("osVersion") is not None else None,
