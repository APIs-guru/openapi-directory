...
class GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Identifier. The resource name. Format: apps/{app}/stuckBackgroundWakelockRateMetricSet")
