...
class GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse(BaseModel):
    """
    ...
    rows: Optional[List[GooglePlayDeveloperReportingV1alpha1MetricsRow]] = Field(default=None, description="Returned rows of data.")
