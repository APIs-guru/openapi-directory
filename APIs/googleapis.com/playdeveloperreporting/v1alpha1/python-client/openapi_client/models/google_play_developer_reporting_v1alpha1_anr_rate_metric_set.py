...
class GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Identifier. The resource name. Format: apps/{app}/anrRateMetricSet")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet from a dict"""
        if obj is None:
            return None
