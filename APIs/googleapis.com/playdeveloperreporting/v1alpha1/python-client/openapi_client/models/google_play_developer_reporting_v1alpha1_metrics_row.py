...
class GooglePlayDeveloperReportingV1alpha1MetricsRow(BaseModel):
    """
    ...
    dimensions: Optional[List[GooglePlayDeveloperReportingV1alpha1DimensionValue]] = Field(default=None, description="Dimension columns in the row.")
    metrics: Optional[List[GooglePlayDeveloperReportingV1alpha1MetricValue]] = Field(default=None, description="Metric columns in the row.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [GooglePlayDeveloperReportingV1alpha1MetricValue.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
