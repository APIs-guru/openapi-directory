...
class GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse(BaseModel):
    """
    Response with a list of anomalies in datasets.
    """ # noqa: E501
    anomalies: Optional[List[GooglePlayDeveloperReportingV1alpha1Anomaly]] = Field(default=None, description="Anomalies that were found.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anomalies": [GooglePlayDeveloperReportingV1alpha1Anomaly.from_dict(_item) for _item in obj["anomalies"]] if obj.get("anomalies") is not None else None,
