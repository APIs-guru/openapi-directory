...
class GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Identifier. The resource name. Format: apps/{app}/slowStartRateMetricSet")
