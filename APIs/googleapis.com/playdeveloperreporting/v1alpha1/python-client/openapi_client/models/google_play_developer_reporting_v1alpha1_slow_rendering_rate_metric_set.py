...
class GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Identifier. The resource name. Format: apps/{app}/slowRenderingRateMetricSet")
