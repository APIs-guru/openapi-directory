...
class GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse(BaseModel):
    """
    Response message for SearchAccessibleApps.
    """ # noqa: E501
    apps: Optional[List[GooglePlayDeveloperReportingV1alpha1App]] = Field(default=None, description="The apps accessible to the user calling the endpoint.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [GooglePlayDeveloperReportingV1alpha1App.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
