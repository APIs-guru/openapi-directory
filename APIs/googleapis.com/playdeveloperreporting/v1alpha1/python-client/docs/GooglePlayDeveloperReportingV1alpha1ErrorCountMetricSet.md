...
google_play_developer_reporting_v1alpha1_error_count_metric_set_instance = GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet.from_json(json)
# print the JSON string representation of the object
print(GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet.to_json())

# convert the object into a dict
google_play_developer_reporting_v1alpha1_error_count_metric_set_dict = google_play_developer_reporting_v1alpha1_error_count_metric_set_instance.to_dict()
# create an instance of GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet from a dict
google_play_developer_reporting_v1alpha1_error_count_metric_set_from_dict = GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet.from_dict(google_play_developer_reporting_v1alpha1_error_count_metric_set_dict)
```
