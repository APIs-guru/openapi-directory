...
class RestoreDomainRequest(BaseModel):
    ...
    """ # noqa: E501
    backup_id: Optional[StrictStr] = Field(default=None, description="Required. ID of the backup to be restored", alias="backupId")
    __properties: ClassVar[List[str]] = ["backupId"]
