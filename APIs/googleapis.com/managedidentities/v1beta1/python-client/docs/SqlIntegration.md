...
------------ | ------------- | ------------- | -------------
**create_time** | **str** | Output only. The time sql integration was created. | [optional] [readonly] 
...
**update_time** | **str** | Output only. The time sql integration was updated. | [optional] [readonly] 
