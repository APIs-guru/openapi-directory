...
class ListPeeringsResponse(BaseModel):
    ...
    peerings: Optional[List[Peering]] = Field(default=None, description="A list of Managed Identities Service Peerings in the project.")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations that could not be reached.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "peerings", "unreachable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "peerings": [Peering.from_dict(_item) for _item in obj["peerings"]] if obj.get("peerings") is not None else None,
