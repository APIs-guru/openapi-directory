...
class ListDomainsResponse(BaseModel):
    ...
    """ # noqa: E501
    domains: Optional[List[Domain]] = Field(default=None, description="A list of Managed Identities Service domains in the project.")
    ...
    __properties: ClassVar[List[str]] = ["domains", "nextPageToken", "unreachable"]
