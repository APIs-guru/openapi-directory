...
class GoogleCloudBillingBudgetsV1CustomPeriod(BaseModel):
    """
    All date times begin at 12 AM US and Canadian Pacific Time (UTC-8).
    """ # noqa: E501
    end_date: Optional[GoogleTypeDate] = Field(default=None, alias="endDate")
    start_date: Optional[GoogleTypeDate] = Field(default=None, alias="startDate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endDate": GoogleTypeDate.from_dict(obj["endDate"]) if obj.get("endDate") is not None else None,
            "startDate": GoogleTypeDate.from_dict(obj["startDate"]) if obj.get("startDate") is not None else None
        })
        return _obj
