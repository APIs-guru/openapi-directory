...
class TestGoogleCloudBillingBudgetsV1ListBudgetsResponse(unittest.TestCase):
    """GoogleCloudBillingBudgetsV1ListBudgetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingBudgetsV1ListBudgetsResponse:
        """Test GoogleCloudBillingBudgetsV1ListBudgetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingBudgetsV1ListBudgetsResponse`
        """
        model = GoogleCloudBillingBudgetsV1ListBudgetsResponse()
        if include_optional:
            return GoogleCloudBillingBudgetsV1ListBudgetsResponse(
                budgets = [
                    openapi_client.models.google_cloud_billing_budgets_v1_budget.GoogleCloudBillingBudgetsV1Budget(
    ...
    def testGoogleCloudBillingBudgetsV1ListBudgetsResponse(self):
        """Test GoogleCloudBillingBudgetsV1ListBudgetsResponse"""
