...
class TestGoogleCloudBillingBudgetsV1beta1CreateBudgetRequest(unittest.TestCase):
    """GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest:
        """Test GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest`
        """
        model = GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest()
        if include_optional:
            return GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest(
    ...
    def testGoogleCloudBillingBudgetsV1beta1CreateBudgetRequest(self):
        """Test GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest"""
