...
class TestGoogleCloudBillingBudgetsV1beta1Budget(unittest.TestCase):
    """GoogleCloudBillingBudgetsV1beta1Budget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingBudgetsV1beta1Budget:
        """Test GoogleCloudBillingBudgetsV1beta1Budget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingBudgetsV1beta1Budget`
        """
        model = GoogleCloudBillingBudgetsV1beta1Budget()
        if include_optional:
    ...
    def testGoogleCloudBillingBudgetsV1beta1Budget(self):
        """Test GoogleCloudBillingBudgetsV1beta1Budget"""
