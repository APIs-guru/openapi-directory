...
class TestGoogleCloudBillingBudgetsV1beta1ListBudgetsResponse(unittest.TestCase):
    """GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse:
        """Test GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse`
        """
        model = GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse()
        if include_optional:
            return GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse(
                budgets = [
                    openapi_client.models.google_cloud_billing_budgets_v1beta1_budget.GoogleCloudBillingBudgetsV1beta1Budget(
    ...
    def testGoogleCloudBillingBudgetsV1beta1ListBudgetsResponse(self):
        """Test GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse"""
