...
class GoogleCloudBillingBudgetsV1beta1Filter(BaseModel):
    ...
    """ # noqa: E501
    calendar_period: Optional[StrictStr] = Field(default=None, description="Optional. Specifies to track usage for recurring calendar period. For example, assume that CalendarPeriod.QUARTER is set. The budget will track usage from April 1 to June 30, when the current calendar month is April, May, June. After that, it will track usage from July 1 to September 30 when the current calendar month is July, August, September, so on.", alias="calendarPeriod")
    ...
    custom_period: Optional[GoogleCloudBillingBudgetsV1beta1CustomPeriod] = Field(default=None, alias="customPeriod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customPeriod": GoogleCloudBillingBudgetsV1beta1CustomPeriod.from_dict(obj["customPeriod"]) if obj.get("customPeriod") is not None else None,
