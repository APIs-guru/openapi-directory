...
class GoogleCloudBillingBudgetsV1beta1Budget(BaseModel):
    ...
    """ # noqa: E501
    all_updates_rule: Optional[GoogleCloudBillingBudgetsV1beta1AllUpdatesRule] = Field(default=None, alias="allUpdatesRule")
    amount: Optional[GoogleCloudBillingBudgetsV1beta1BudgetAmount] = None
    budget_filter: Optional[GoogleCloudBillingBudgetsV1beta1Filter] = Field(default=None, alias="budgetFilter")
    display_name: Optional[StrictStr] = Field(default=None, description="User data for display name in UI. Validation: <= 60 chars.", alias="displayName")
    etag: Optional[StrictStr] = Field(default=None, description="Optional. Etag to validate that the object is unchanged for a read-modify-write operation. An empty etag will cause an update to overwrite other changes.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of all_updates_rule
        if self.all_updates_rule:
            _dict['allUpdatesRule'] = self.all_updates_rule.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allUpdatesRule": GoogleCloudBillingBudgetsV1beta1AllUpdatesRule.from_dict(obj["allUpdatesRule"]) if obj.get("allUpdatesRule") is not None else None,
            "amount": GoogleCloudBillingBudgetsV1beta1BudgetAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "budgetFilter": GoogleCloudBillingBudgetsV1beta1Filter.from_dict(obj["budgetFilter"]) if obj.get("budgetFilter") is not None else None,
            "displayName": obj.get("displayName"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "ownershipScope": obj.get("ownershipScope"),
            "thresholdRules": [GoogleCloudBillingBudgetsV1beta1ThresholdRule.from_dict(_item) for _item in obj["thresholdRules"]] if obj.get("thresholdRules") is not None else None
        })
        return _obj
