...
class GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse(BaseModel):
    ...
    """ # noqa: E501
    budgets: Optional[List[GoogleCloudBillingBudgetsV1beta1Budget]] = Field(default=None, description="List of the budgets owned by the requested billing account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgets": [GoogleCloudBillingBudgetsV1beta1Budget.from_dict(_item) for _item in obj["budgets"]] if obj.get("budgets") is not None else None,
