...
------------- | ------------- | -------------
[**networksecurity_projects_locations_address_groups_add_items**](ProjectsApi.md#networksecurity_projects_locations_address_groups_add_items) | **POST** /v1beta1/{addressGroup}:addItems | 
[**networksecurity_projects_locations_address_groups_clone_items**](ProjectsApi.md#networksecurity_projects_locations_address_groups_clone_items) | **POST** /v1beta1/{addressGroup}:cloneItems | 
[**networksecurity_projects_locations_address_groups_create**](ProjectsApi.md#networksecurity_projects_locations_address_groups_create) | **POST** /v1beta1/{parent}/addressGroups | 
[**networksecurity_projects_locations_address_groups_list**](ProjectsApi.md#networksecurity_projects_locations_address_groups_list) | **GET** /v1beta1/{parent}/addressGroups | 
[**networksecurity_projects_locations_address_groups_list_references**](ProjectsApi.md#networksecurity_projects_locations_address_groups_list_references) | **GET** /v1beta1/{addressGroup}:listReferences | 
[**networksecurity_projects_locations_address_groups_remove_items**](ProjectsApi.md#networksecurity_projects_locations_address_groups_remove_items) | **POST** /v1beta1/{addressGroup}:removeItems | 
[**networksecurity_projects_locations_authorization_policies_create**](ProjectsApi.md#networksecurity_projects_locations_authorization_policies_create) | **POST** /v1beta1/{parent}/authorizationPolicies | 
[**networksecurity_projects_locations_authorization_policies_list**](ProjectsApi.md#networksecurity_projects_locations_authorization_policies_list) | **GET** /v1beta1/{parent}/authorizationPolicies | 
[**networksecurity_projects_locations_client_tls_policies_create**](ProjectsApi.md#networksecurity_projects_locations_client_tls_policies_create) | **POST** /v1beta1/{parent}/clientTlsPolicies | 
[**networksecurity_projects_locations_client_tls_policies_list**](ProjectsApi.md#networksecurity_projects_locations_client_tls_policies_list) | **GET** /v1beta1/{parent}/clientTlsPolicies | 
[**networksecurity_projects_locations_firewall_endpoint_associations_create**](ProjectsApi.md#networksecurity_projects_locations_firewall_endpoint_associations_create) | **POST** /v1beta1/{parent}/firewallEndpointAssociations | 
[**networksecurity_projects_locations_firewall_endpoint_associations_list**](ProjectsApi.md#networksecurity_projects_locations_firewall_endpoint_associations_list) | **GET** /v1beta1/{parent}/firewallEndpointAssociations | 
[**networksecurity_projects_locations_gateway_security_policies_create**](ProjectsApi.md#networksecurity_projects_locations_gateway_security_policies_create) | **POST** /v1beta1/{parent}/gatewaySecurityPolicies | 
[**networksecurity_projects_locations_gateway_security_policies_list**](ProjectsApi.md#networksecurity_projects_locations_gateway_security_policies_list) | **GET** /v1beta1/{parent}/gatewaySecurityPolicies | 
[**networksecurity_projects_locations_gateway_security_policies_rules_create**](ProjectsApi.md#networksecurity_projects_locations_gateway_security_policies_rules_create) | **POST** /v1beta1/{parent}/rules | 
[**networksecurity_projects_locations_gateway_security_policies_rules_list**](ProjectsApi.md#networksecurity_projects_locations_gateway_security_policies_rules_list) | **GET** /v1beta1/{parent}/rules | 
[**networksecurity_projects_locations_list**](ProjectsApi.md#networksecurity_projects_locations_list) | **GET** /v1beta1/{name}/locations | 
[**networksecurity_projects_locations_operations_cancel**](ProjectsApi.md#networksecurity_projects_locations_operations_cancel) | **POST** /v1beta1/{name}:cancel | 
[**networksecurity_projects_locations_operations_list**](ProjectsApi.md#networksecurity_projects_locations_operations_list) | **GET** /v1beta1/{name}/operations | 
[**networksecurity_projects_locations_server_tls_policies_create**](ProjectsApi.md#networksecurity_projects_locations_server_tls_policies_create) | **POST** /v1beta1/{parent}/serverTlsPolicies | 
[**networksecurity_projects_locations_server_tls_policies_get_iam_policy**](ProjectsApi.md#networksecurity_projects_locations_server_tls_policies_get_iam_policy) | **GET** /v1beta1/{resource}:getIamPolicy | 
[**networksecurity_projects_locations_server_tls_policies_list**](ProjectsApi.md#networksecurity_projects_locations_server_tls_policies_list) | **GET** /v1beta1/{parent}/serverTlsPolicies | 
[**networksecurity_projects_locations_server_tls_policies_set_iam_policy**](ProjectsApi.md#networksecurity_projects_locations_server_tls_policies_set_iam_policy) | **POST** /v1beta1/{resource}:setIamPolicy | 
[**networksecurity_projects_locations_server_tls_policies_test_iam_permissions**](ProjectsApi.md#networksecurity_projects_locations_server_tls_policies_test_iam_permissions) | **POST** /v1beta1/{resource}:testIamPermissions | 
[**networksecurity_projects_locations_tls_inspection_policies_create**](ProjectsApi.md#networksecurity_projects_locations_tls_inspection_policies_create) | **POST** /v1beta1/{parent}/tlsInspectionPolicies | 
[**networksecurity_projects_locations_tls_inspection_policies_list**](ProjectsApi.md#networksecurity_projects_locations_tls_inspection_policies_list) | **GET** /v1beta1/{parent}/tlsInspectionPolicies | 
[**networksecurity_projects_locations_url_lists_create**](ProjectsApi.md#networksecurity_projects_locations_url_lists_create) | **POST** /v1beta1/{parent}/urlLists | 
[**networksecurity_projects_locations_url_lists_delete**](ProjectsApi.md#networksecurity_projects_locations_url_lists_delete) | **DELETE** /v1beta1/{name} | 
[**networksecurity_projects_locations_url_lists_get**](ProjectsApi.md#networksecurity_projects_locations_url_lists_get) | **GET** /v1beta1/{name} | 
[**networksecurity_projects_locations_url_lists_list**](ProjectsApi.md#networksecurity_projects_locations_url_lists_list) | **GET** /v1beta1/{parent}/urlLists | 
[**networksecurity_projects_locations_url_lists_patch**](ProjectsApi.md#networksecurity_projects_locations_url_lists_patch) | **PATCH** /v1beta1/{name} | 
...
> Operation networksecurity_projects_locations_firewall_endpoint_associations_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, firewall_endpoint_association_id=firewall_endpoint_association_id, request_id=request_id, firewall_endpoint_association=firewall_endpoint_association)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    firewall_endpoint_association_id = 'firewall_endpoint_association_id_example' # str | Optional. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC. (optional)
    request_id = 'request_id_example' # str | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). (optional)
    firewall_endpoint_association = openapi_client.FirewallEndpointAssociation() # FirewallEndpointAssociation |  (optional)

    try:
        api_response = api_instance.networksecurity_projects_locations_firewall_endpoint_associations_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, firewall_endpoint_association_id=firewall_endpoint_association_id, request_id=request_id, firewall_endpoint_association=firewall_endpoint_association)
        print("The response of ProjectsApi->networksecurity_projects_locations_firewall_endpoint_associations_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->networksecurity_projects_locations_firewall_endpoint_associations_create: %s\n" % e)
```
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **firewall_endpoint_association_id** | **str**| Optional. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC. | [optional] 
 **request_id** | **str**| Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). | [optional] 
 **firewall_endpoint_association** | [**FirewallEndpointAssociation**](FirewallEndpointAssociation.md)|  | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    parent = 'parent_example' # str | Required. Parent value for ListAssociationsRequest
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    try:
        api_response = api_instance.networksecurity_projects_locations_firewall_endpoint_associations_list(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, order_by=order_by, page_size=page_size, page_token=page_token)
        print("The response of ProjectsApi->networksecurity_projects_locations_firewall_endpoint_associations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->networksecurity_projects_locations_firewall_endpoint_associations_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. Parent value for ListAssociationsRequest | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
