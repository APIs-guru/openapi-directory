...
class ServerTlsPolicy(BaseModel):
    ...
    server_certificate: Optional[GoogleCloudNetworksecurityV1beta1CertificateProvider] = Field(default=None, alias="serverCertificate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "serverCertificate": GoogleCloudNetworksecurityV1beta1CertificateProvider.from_dict(obj["serverCertificate"]) if obj.get("serverCertificate") is not None else None,
