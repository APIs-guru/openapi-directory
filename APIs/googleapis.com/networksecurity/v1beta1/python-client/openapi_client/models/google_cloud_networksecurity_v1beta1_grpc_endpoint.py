...
class GoogleCloudNetworksecurityV1beta1GrpcEndpoint(BaseModel):
    ...
    """ # noqa: E501
    target_uri: Optional[StrictStr] = Field(default=None, description="Required. The target URI of the gRPC endpoint. Only UDS path is supported, and should start with \"unix:\".", alias="targetUri")
    __properties: ClassVar[List[str]] = ["targetUri"]
