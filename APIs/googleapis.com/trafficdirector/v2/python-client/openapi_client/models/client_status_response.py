...
class ClientStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[List[ClientConfig]] = Field(default=None, description="Client configs for the clients specified in the ClientStatusRequest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [ClientConfig.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None
        })
        return _obj
