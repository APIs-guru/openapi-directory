...
class TestStructMatcher(unittest.TestCase):
    """StructMatcher unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructMatcher:
        """Test StructMatcher
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructMatcher`
        """
        model = StructMatcher()
        if include_optional:
