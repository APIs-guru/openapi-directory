...
class Node(BaseModel):
    ...
    dynamic_parameters: Optional[Dict[str, ContextParams]] = Field(default=None, description="Map from xDS resource type URL to dynamic context parameters. These may vary at runtime (unlike other fields in this message). For example, the xDS client may have a shard identifier that changes during the lifetime of the xDS client. In Envoy, this would be achieved by updating the dynamic context on the Server::Instance's LocalInfo context provider. The shard ID dynamic parameter then appears in this field during future discovery requests.", alias="dynamicParameters")
    ...
    __properties: ClassVar[List[str]] = ["clientFeatures", "cluster", "dynamicParameters", "extensions", "id", "listeningAddresses", "locality", "metadata", "userAgentBuildVersion", "userAgentName", "userAgentVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in dynamic_parameters (dict)
        _field_dict = {}
        if self.dynamic_parameters:
            for _key_dynamic_parameters in self.dynamic_parameters:
                if self.dynamic_parameters[_key_dynamic_parameters]:
                    _field_dict[_key_dynamic_parameters] = self.dynamic_parameters[_key_dynamic_parameters].to_dict()
            _dict['dynamicParameters'] = _field_dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dynamicParameters": dict(
                (_k, ContextParams.from_dict(_v))
                for _k, _v in obj["dynamicParameters"].items()
            )
            if obj.get("dynamicParameters") is not None
            else None,
