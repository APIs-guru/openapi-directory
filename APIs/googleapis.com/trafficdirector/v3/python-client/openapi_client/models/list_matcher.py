...
class ListMatcher(BaseModel):
    ...
    """ # noqa: E501
    one_of: Optional[ValueMatcher] = Field(default=None, alias="oneOf")
    __properties: ClassVar[List[str]] = ["oneOf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oneOf": ValueMatcher.from_dict(obj["oneOf"]) if obj.get("oneOf") is not None else None
        })
        return _obj

from openapi_client.models.value_matcher import ValueMatcher
# TODO: Rewrite to not use raise_errors
ListMatcher.model_rebuild(raise_errors=False)
