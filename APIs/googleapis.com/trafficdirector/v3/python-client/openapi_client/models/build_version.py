...
class BuildVersion(BaseModel):
    ...
    """ # noqa: E501
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Free-form build information. Envoy defines several well known keys in the source/common/version/version.h file")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version": SemanticVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
