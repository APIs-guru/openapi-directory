...
class ListWorkflowsResponse(BaseModel):
    ...
    workflows: Optional[List[Workflow]] = Field(default=None, description="The workflows which match the request.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "unreachable", "workflows"]
