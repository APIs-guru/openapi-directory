...
class CheckResponse(BaseModel):
    ...
    error_code: Optional[List[StrictStr]] = Field(default=None, description="Error codes that describe the result of the Check operation.", alias="errorCode")
    linked: Optional[StrictBool] = Field(default=None, description="Set to true if the assets specified in the request are linked by the relation specified in the request.")
    ...
    __properties: ClassVar[List[str]] = ["debugString", "errorCode", "linked", "maxAge"]
