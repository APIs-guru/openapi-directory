...
class ServiceData(BaseModel):
    ...
    """ # noqa: E501
    pd: Optional[PersistentDiskData] = None
    __properties: ClassVar[List[str]] = ["pd"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pd
        if self.pd:
            _dict['pd'] = self.pd.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pd": PersistentDiskData.from_dict(obj["pd"]) if obj.get("pd") is not None else None
        })
        return _obj
