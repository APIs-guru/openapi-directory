...
class Instance(BaseModel):
    ...
    enable_zone_separation: Optional[StrictBool] = Field(default=None, description="Option to enable zone separation.", alias="enableZoneSeparation")
    ...
    version: Optional[StrictStr] = Field(default=None, description="Current version of Data Fusion.")
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['STATE_UNSPECIFIED', 'CREATING', 'RUNNING', 'FAILED', 'DELETING', 'UPGRADING', 'RESTARTING', 'UPDATING', 'AUTO_UPDATING', 'AUTO_UPGRADING', 'DISABLED']):
            raise ValueError("must be one of enum values ('STATE_UNSPECIFIED', 'CREATING', 'RUNNING', 'FAILED', 'DELETING', 'UPGRADING', 'RESTARTING', 'UPDATING', 'AUTO_UPDATING', 'AUTO_UPGRADING', 'DISABLED')")
        return value
