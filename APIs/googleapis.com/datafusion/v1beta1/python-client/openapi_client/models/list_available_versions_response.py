...
class ListAvailableVersionsResponse(BaseModel):
    ...
    """ # noqa: E501
    available_versions: Optional[List[Version]] = Field(default=None, description="Represents a list of versions that are supported.", alias="availableVersions")
    ...
    __properties: ClassVar[List[str]] = ["availableVersions", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableVersions": [Version.from_dict(_item) for _item in obj["availableVersions"]] if obj.get("availableVersions") is not None else None,
