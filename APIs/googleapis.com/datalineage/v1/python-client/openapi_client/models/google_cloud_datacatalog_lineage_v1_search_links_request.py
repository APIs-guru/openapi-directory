...
class GoogleCloudDatacatalogLineageV1SearchLinksRequest(BaseModel):
    ...
    source: Optional[GoogleCloudDatacatalogLineageV1EntityReference] = None
    target: Optional[GoogleCloudDatacatalogLineageV1EntityReference] = None
    __properties: ClassVar[List[str]] = ["pageSize", "pageToken", "source", "target"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": GoogleCloudDatacatalogLineageV1EntityReference.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": GoogleCloudDatacatalogLineageV1EntityReference.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
