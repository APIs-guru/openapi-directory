...
class GoogleCloudPolicytroubleshooterV1betaExplainedPolicy(BaseModel):
    """
    Details about how a specific IAM Policy contributed to the access check.
    """ # noqa: E501
    access: Optional[StrictStr] = Field(default=None, description="Indicates whether _this policy_ provides the specified permission to the specified member for the specified resource. This field does _not_ indicate whether the member actually has the permission for the resource. There might be another policy that overrides this policy. To determine whether the member actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse.")
    binding_explanations: Optional[List[GoogleCloudPolicytroubleshooterV1betaBindingExplanation]] = Field(default=None, description="Details about how each binding in the policy affects the member's ability, or inability, to use the permission for the resource. If the sender of the request does not have access to the policy, this field is omitted.", alias="bindingExplanations")
    full_resource_name: Optional[StrictStr] = Field(default=None, description="The full resource name that identifies the resource. For example, `//compute.googleapis.com/projects/my-project/zones/us-central1-a/instances/my-instance`. If the sender of the request does not have access to the policy, this field is omitted. For examples of full resource names for Google Cloud services, see https://cloud.google.com/iam/help/troubleshooter/full-resource-names.", alias="fullResourceName")
    policy: Optional[GoogleIamV1Policy] = None
    relevance: Optional[StrictStr] = Field(default=None, description="The relevance of this policy to the overall determination in the TroubleshootIamPolicyResponse. If the sender of the request does not have access to the policy, this field is omitted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bindingExplanations": [GoogleCloudPolicytroubleshooterV1betaBindingExplanation.from_dict(_item) for _item in obj["bindingExplanations"]] if obj.get("bindingExplanations") is not None else None,
