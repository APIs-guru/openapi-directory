...
class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest(BaseModel):
    """
    Request for TroubleshootIamPolicy.
    """ # noqa: E501
    access_tuple: Optional[GoogleCloudPolicytroubleshooterV1betaAccessTuple] = Field(default=None, alias="accessTuple")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessTuple": GoogleCloudPolicytroubleshooterV1betaAccessTuple.from_dict(obj["accessTuple"]) if obj.get("accessTuple") is not None else None
        })
        return _obj
