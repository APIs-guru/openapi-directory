...
**binding_explanations** | [**List[GoogleCloudPolicytroubleshooterV1BindingExplanation]**](GoogleCloudPolicytroubleshooterV1BindingExplanation.md) | Details about how each binding in the policy affects the principal&#39;s ability, or inability, to use the permission for the resource. If the sender of the request does not have access to the policy, this field is omitted. | [optional] 
...
json = "{}"
# create an instance of GoogleCloudPolicytroubleshooterV1ExplainedPolicy from a JSON string
google_cloud_policytroubleshooter_v1_explained_policy_instance = GoogleCloudPolicytroubleshooterV1ExplainedPolicy.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudPolicytroubleshooterV1ExplainedPolicy.to_json())

# convert the object into a dict
google_cloud_policytroubleshooter_v1_explained_policy_dict = google_cloud_policytroubleshooter_v1_explained_policy_instance.to_dict()
# create an instance of GoogleCloudPolicytroubleshooterV1ExplainedPolicy from a dict
google_cloud_policytroubleshooter_v1_explained_policy_from_dict = GoogleCloudPolicytroubleshooterV1ExplainedPolicy.from_dict(google_cloud_policytroubleshooter_v1_explained_policy_dict)
```
