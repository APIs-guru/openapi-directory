...
class GoogleCloudPolicytroubleshooterV1ExplainedPolicy(BaseModel):
    ...
    binding_explanations: Optional[List[GoogleCloudPolicytroubleshooterV1BindingExplanation]] = Field(default=None, description="Details about how each binding in the policy affects the principal's ability, or inability, to use the permission for the resource. If the sender of the request does not have access to the policy, this field is omitted.", alias="bindingExplanations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bindingExplanations": [GoogleCloudPolicytroubleshooterV1BindingExplanation.from_dict(_item) for _item in obj["bindingExplanations"]] if obj.get("bindingExplanations") is not None else None,
