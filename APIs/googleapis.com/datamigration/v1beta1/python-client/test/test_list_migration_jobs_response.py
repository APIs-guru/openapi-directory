...
class TestListMigrationJobsResponse(unittest.TestCase):
    """ListMigrationJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMigrationJobsResponse:
        """Test ListMigrationJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMigrationJobsResponse`
        """
        model = ListMigrationJobsResponse()
        if include_optional:
            return ListMigrationJobsResponse(
                migration_jobs = [
                    openapi_client.models.migration_job.MigrationJob(
                        create_time = '', 
                        destination = '', 
    ...
    def testListMigrationJobsResponse(self):
        """Test ListMigrationJobsResponse"""
