...
class SqlIpConfig(BaseModel):
    ...
    enable_ipv4: Optional[StrictBool] = Field(default=None, description="Whether the instance is assigned a public IP address or not.", alias="enableIpv4")
    ...
    __properties: ClassVar[List[str]] = ["authorizedNetworks", "enableIpv4", "privateNetwork", "requireSsl"]
