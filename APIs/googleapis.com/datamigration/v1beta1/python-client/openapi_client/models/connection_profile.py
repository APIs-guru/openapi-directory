...
class ConnectionProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cloudsql", "createTime", "displayName", "error", "labels", "mysql", "name", "provider", "state", "updateTime"]
    ...
    def provider_validate_enum(cls, value):
        ...
        if value not in set(['DATABASE_PROVIDER_UNSPECIFIED', 'CLOUDSQL', 'RDS']):
            raise ValueError("must be one of enum values ('DATABASE_PROVIDER_UNSPECIFIED', 'CLOUDSQL', 'RDS')")
        return value
