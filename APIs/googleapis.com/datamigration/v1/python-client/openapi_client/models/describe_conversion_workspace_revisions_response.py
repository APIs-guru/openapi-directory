...
class DescribeConversionWorkspaceRevisionsResponse(BaseModel):
    """
    Response message for 'DescribeConversionWorkspaceRevisions' request.
    """ # noqa: E501
    revisions: Optional[List[ConversionWorkspace]] = Field(default=None, description="The list of conversion workspace revisions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "revisions": [ConversionWorkspace.from_dict(_item) for _item in obj["revisions"]] if obj.get("revisions") is not None else None
        })
        return _obj
