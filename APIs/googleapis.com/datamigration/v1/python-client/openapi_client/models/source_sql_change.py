...
class SourceSqlChange(BaseModel):
    """
    ...
    """ # noqa: E501
    sql_code: Optional[StrictStr] = Field(default=None, description="Required. Sql code for source (stored procedure, function, trigger or view)", alias="sqlCode")
    __properties: ClassVar[List[str]] = ["sqlCode"]
