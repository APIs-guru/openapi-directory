...
class SearchBackgroundJobsResponse(BaseModel):
    """
    Response message for 'SearchBackgroundJobs' request.
    """ # noqa: E501
    jobs: Optional[List[BackgroundJobLogEntry]] = Field(default=None, description="The list of conversion workspace mapping rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [BackgroundJobLogEntry.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None
        })
        return _obj
