...
class SingleEntityRename(BaseModel):
    """
    ...
    """ # noqa: E501
    new_name: Optional[StrictStr] = Field(default=None, description="Required. The new name of the destination entity", alias="newName")
    __properties: ClassVar[List[str]] = ["newName"]
