...
class ViewEntity(BaseModel):
    ...
    """ # noqa: E501
    constraints: Optional[List[ConstraintEntity]] = Field(default=None, description="View constraints.")
    ...
    sql_code: Optional[StrictStr] = Field(default=None, description="The SQL code which creates the view.", alias="sqlCode")
    __properties: ClassVar[List[str]] = ["constraints", "customFeatures", "sqlCode"]
