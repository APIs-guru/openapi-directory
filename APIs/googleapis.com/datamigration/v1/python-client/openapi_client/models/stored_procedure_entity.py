...
class StoredProcedureEntity(BaseModel):
    """
    ...
    sql_code: Optional[StrictStr] = Field(default=None, description="The SQL code which creates the stored procedure.", alias="sqlCode")
