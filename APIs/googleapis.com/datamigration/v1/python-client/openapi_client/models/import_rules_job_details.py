...
class ImportRulesJobDetails(BaseModel):
    """
    Details regarding an Import Rules background job.
    """ # noqa: E501
    file_format: Optional[StrictStr] = Field(default=None, description="Output only. The requested file format.", alias="fileFormat")
    files: Optional[List[StrictStr]] = Field(default=None, description="Output only. File names used for the import rules job.")
    __properties: ClassVar[List[str]] = ["fileFormat", "files"]
