...
class TestMappingRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MappingRule:
        """Test MappingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MappingRule`
        """
        model = MappingRule()
        if include_optional:
            return MappingRule(
