...
json = "{}"
# create an instance of GoogleCloudClouddmsV1OperationMetadata from a JSON string
google_cloud_clouddms_v1_operation_metadata_instance = GoogleCloudClouddmsV1OperationMetadata.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudClouddmsV1OperationMetadata.to_json())

# convert the object into a dict
google_cloud_clouddms_v1_operation_metadata_dict = google_cloud_clouddms_v1_operation_metadata_instance.to_dict()
# create an instance of GoogleCloudClouddmsV1OperationMetadata from a dict
google_cloud_clouddms_v1_operation_metadata_from_dict = GoogleCloudClouddmsV1OperationMetadata.from_dict(google_cloud_clouddms_v1_operation_metadata_dict)
```
