...
class Endpoint(BaseModel):
    ...
    create_time: Optional[StrictStr] = Field(default=None, description="Output only. The timestamp when the endpoint was created.", alias="createTime")
    ...
    uid: Optional[StrictStr] = Field(default=None, description="Output only. A globally unique identifier (in UUID4 format) for this endpoint.")
    update_time: Optional[StrictStr] = Field(default=None, description="Output only. The timestamp when the endpoint was last updated.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["address", "createTime", "metadata", "name", "network", "port", "uid", "updateTime"]
