...
class ProjectsApi:
    ...
    def fcmdata_projects_android_apps_delivery_data_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The application for which to list delivery data. Format: `projects/{project_id}/androidApps/{app_id}`")],
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of entries to return. The service may return fewer than this value. If unspecified, at most 1,000 entries will be returned. The maximum value is 10,000; values above 10,000 will be capped to 10,000. This default may change over time.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A page token, received from a previous `ListAndroidDeliveryDataRequest` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListAndroidDeliveryDataRequest` must match the call that provided the page token.")] = None,
        ...
        _param = self._fcmdata_projects_android_apps_delivery_data_list_serialize(
            parent=parent,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleFirebaseFcmDataV1beta1ListAndroidDeliveryDataResponse",
        }
    ...
    @validate_call
    def fcmdata_projects_android_apps_delivery_data_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The application for which to list delivery data. Format: `projects/{project_id}/androidApps/{app_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def fcmdata_projects_android_apps_delivery_data_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The application for which to list delivery data. Format: `projects/{project_id}/androidApps/{app_id}`")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _fcmdata_projects_android_apps_delivery_data_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta1/{parent}/deliveryData',
