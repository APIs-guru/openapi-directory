...
------------ | ------------- | ------------- | -------------
**name** | **str** | The name of the Cloud SQL instance being referenced. This does not include the project ID. | [optional] 
**project** | **str** | The project ID of the Cloud SQL instance being referenced. The default is the same project ID as the instance references it. | [optional] 
**region** | **str** | The region of the Cloud SQL instance being referenced. | [optional] 
