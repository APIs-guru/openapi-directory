...
------------- | ------------- | -------------
[**sql_backup_runs_delete**](BackupRunsApi.md#sql_backup_runs_delete) | **DELETE** /v1/projects/{project}/instances/{instance}/backupRuns/{id} | 
[**sql_backup_runs_get**](BackupRunsApi.md#sql_backup_runs_get) | **GET** /v1/projects/{project}/instances/{instance}/backupRuns/{id} | 
[**sql_backup_runs_insert**](BackupRunsApi.md#sql_backup_runs_insert) | **POST** /v1/projects/{project}/instances/{instance}/backupRuns | 
[**sql_backup_runs_list**](BackupRunsApi.md#sql_backup_runs_list) | **GET** /v1/projects/{project}/instances/{instance}/backupRuns | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/backupRuns/list) method.
 ...
 **id** | **str**| The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/backupRuns/list) method. | 
