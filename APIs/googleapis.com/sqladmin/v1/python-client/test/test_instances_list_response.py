...
class TestInstancesListResponse(unittest.TestCase):
    """InstancesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstancesListResponse:
        """Test InstancesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstancesListResponse`
        """
        model = InstancesListResponse()
        if include_optional:
            return InstancesListResponse(
                ...
                next_page_token = '',
                warnings = [
                    openapi_client.models.api_warning.ApiWarning(
    ...
    def testInstancesListResponse(self):
        """Test InstancesListResponse"""
