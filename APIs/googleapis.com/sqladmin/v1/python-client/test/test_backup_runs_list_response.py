...
class TestBackupRunsListResponse(unittest.TestCase):
    """BackupRunsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackupRunsListResponse:
        """Test BackupRunsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupRunsListResponse`
        """
        model = BackupRunsListResponse()
        if include_optional:
            return BackupRunsListResponse(
                items = [
                    openapi_client.models.backup_run.BackupRun(
    ...
    def testBackupRunsListResponse(self):
        """Test BackupRunsListResponse"""
