...
class BackupRunsApi:
    ...
    def sql_backup_runs_delete(
        ...
        id: Annotated[StrictStr, Field(description="The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/backupRuns/list) method.")],
        ...
        :type instance: str
        :param id: The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/backupRuns/list) method. (required)
        :type id: str
    ...
    def _sql_backup_runs_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/projects/{project}/instances/{instance}/backupRuns/{id}',
    ...
    def _sql_backup_runs_insert_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/projects/{project}/instances/{instance}/backupRuns',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
