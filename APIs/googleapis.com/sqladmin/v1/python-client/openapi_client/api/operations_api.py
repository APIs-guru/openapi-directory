...
class OperationsApi:
    ...
    def sql_operations_cancel(
        ...
        _param = self._sql_operations_cancel_serialize(
            project=project,
            operation=operation,
            xgafv=xgafv,
    ...
    @validate_call
    def sql_operations_cancel_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        operation: Annotated[StrictStr, Field(description="Instance operation ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def sql_operations_cancel_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        operation: Annotated[StrictStr, Field(description="Instance operation ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _sql_operations_cancel_serialize(
        self,
        project,
        operation,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/projects/{project}/operations/{operation}/cancel',
    ...
    def sql_operations_get(
        ...
        _param = self._sql_operations_get_serialize(
            project=project,
            operation=operation,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def sql_operations_get_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        operation: Annotated[StrictStr, Field(description="Instance operation ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def sql_operations_get_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        operation: Annotated[StrictStr, Field(description="Instance operation ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _sql_operations_get_serialize(
        self,
        project,
        operation,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/projects/{project}/operations/{operation}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sql_operations_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        instance: Annotated[Optional[StrictStr], Field(description="Cloud SQL instance ID. This does not include the project ID.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of operations per response.")] = None,
        ...
        :type instance: str
        :param max_results: Maximum number of operations per response.
        ...
        _param = self._sql_operations_list_serialize(
            project=project,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def sql_operations_list_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def sql_operations_list_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _sql_operations_list_serialize(
        self,
        project,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/projects/{project}/operations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
