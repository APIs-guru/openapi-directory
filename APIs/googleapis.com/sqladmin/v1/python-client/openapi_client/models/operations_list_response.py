...
class OperationsListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[Operation]] = Field(default=None, description="List of operation resources.")
    kind: Optional[StrictStr] = Field(default=None, description="This is always `sql#operationsList`.")
