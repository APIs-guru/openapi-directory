...
class OperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    additional_info: Optional[Dict[str, StrictStr]] = Field(default=None, description="Output only. AdditionalInfo contains additional Info related to backup plan association resource.", alias="additionalInfo")
    ...
    __properties: ClassVar[List[str]] = ["additionalInfo", "apiVersion", "createTime", "endTime", "requestedCancellation", "statusMessage", "target", "verb"]
