...
class AdminSettings(BaseModel):
    ...
    """ # noqa: E501
    allowed_email_domains: Optional[List[StrictStr]] = Field(default=None, description="Email domain allowlist for the instance.", alias="allowedEmailDomains")
    __properties: ClassVar[List[str]] = ["allowedEmailDomains"]
