...
class ImportInstanceRequest(BaseModel):
    ...
    """ # noqa: E501
    gcs_uri: Optional[StrictStr] = Field(default=None, description="Path to the import folder in Google Cloud Storage, in the form `gs://bucketName/folderName`.", alias="gcsUri")
