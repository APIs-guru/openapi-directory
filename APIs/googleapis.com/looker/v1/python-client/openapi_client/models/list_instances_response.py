...
class ListInstancesResponse(BaseModel):
    ...
    """ # noqa: E501
    instances: Optional[List[Instance]] = Field(default=None, description="The list of instances matching the request filters, up to the requested ListInstancesRequest.pageSize.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="If provided, a page token that can look up the next ListInstancesRequest.pageSize results. If empty, the results list is exhausted.", alias="nextPageToken")
