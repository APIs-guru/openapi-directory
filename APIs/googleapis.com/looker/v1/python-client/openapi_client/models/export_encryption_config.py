...
class ExportEncryptionConfig(BaseModel):
    """
    Configuration for Encryption - e.g. CMEK.
    """ # noqa: E501
    kms_key_name: Optional[StrictStr] = Field(default=None, description="Required. Name of the CMEK key in KMS.", alias="kmsKeyName")
