...
class MaintenanceWindow(BaseModel):
    ...
    """ # noqa: E501
    day_of_week: Optional[StrictStr] = Field(default=None, description="Required. Day of the week for this MaintenanceWindow (in UTC).", alias="dayOfWeek")
    start_time: Optional[TimeOfDay] = Field(default=None, alias="startTime")
    __properties: ClassVar[List[str]] = ["dayOfWeek", "startTime"]
