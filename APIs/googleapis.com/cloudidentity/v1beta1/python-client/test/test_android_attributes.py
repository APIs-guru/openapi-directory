...
class TestAndroidAttributes(unittest.TestCase):
    """AndroidAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AndroidAttributes:
        """Test AndroidAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AndroidAttributes`
        """
        model = AndroidAttributes()
        if include_optional:
    ...
    def testAndroidAttributes(self):
        """Test AndroidAttributes"""
