...
class TestGoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse(unittest.TestCase):
    """GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse:
        """Test GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse`
        """
        model = GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse()
        if include_optional:
            return GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse(
                device = openapi_client.models.google_apps_cloudidentity_devices_v1_device.GoogleAppsCloudidentityDevicesV1Device(
    ...
    def testGoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse(self):
        """Test GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse"""
