...
class TestCancelWipeDeviceResponse(unittest.TestCase):
    """CancelWipeDeviceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelWipeDeviceResponse:
        """Test CancelWipeDeviceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelWipeDeviceResponse`
        """
        model = CancelWipeDeviceResponse()
        if include_optional:
            return CancelWipeDeviceResponse(
    ...
    def testCancelWipeDeviceResponse(self):
        """Test CancelWipeDeviceResponse"""
