...
class TestWipeDeviceResponse(unittest.TestCase):
    """WipeDeviceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WipeDeviceResponse:
        """Test WipeDeviceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WipeDeviceResponse`
        """
        model = WipeDeviceResponse()
        if include_optional:
    ...
    def testWipeDeviceResponse(self):
        """Test WipeDeviceResponse"""
