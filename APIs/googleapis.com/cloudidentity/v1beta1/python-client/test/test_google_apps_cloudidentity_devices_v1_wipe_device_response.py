...
class TestGoogleAppsCloudidentityDevicesV1WipeDeviceResponse(unittest.TestCase):
    """GoogleAppsCloudidentityDevicesV1WipeDeviceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAppsCloudidentityDevicesV1WipeDeviceResponse:
        """Test GoogleAppsCloudidentityDevicesV1WipeDeviceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAppsCloudidentityDevicesV1WipeDeviceResponse`
        """
        model = GoogleAppsCloudidentityDevicesV1WipeDeviceResponse()
        if include_optional:
            return GoogleAppsCloudidentityDevicesV1WipeDeviceResponse(
    ...
    def testGoogleAppsCloudidentityDevicesV1WipeDeviceResponse(self):
        """Test GoogleAppsCloudidentityDevicesV1WipeDeviceResponse"""
