...
class TestEndpointVerificationSpecificAttributes(unittest.TestCase):
    """EndpointVerificationSpecificAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointVerificationSpecificAttributes:
        """Test EndpointVerificationSpecificAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointVerificationSpecificAttributes`
        """
        model = EndpointVerificationSpecificAttributes()
        if include_optional:
    ...
    def testEndpointVerificationSpecificAttributes(self):
        """Test EndpointVerificationSpecificAttributes"""
