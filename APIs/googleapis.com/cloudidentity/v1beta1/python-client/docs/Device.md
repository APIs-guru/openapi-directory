...
------------ | ------------- | ------------- | -------------
**android_specific_attributes** | [**AndroidAttributes**](AndroidAttributes.md) |  | [optional] 
...
**client_types** | **List[str]** | List of the clients the device is reporting to. | [optional] 
...
**endpoint_verification_specific_attributes** | [**EndpointVerificationSpecificAttributes**](EndpointVerificationSpecificAttributes.md) |  | [optional] 
...
**name** | **str** | Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: &#x60;devices/{device_id}&#x60;, where device_id is the unique id assigned to the Device. | [optional] [readonly] 
