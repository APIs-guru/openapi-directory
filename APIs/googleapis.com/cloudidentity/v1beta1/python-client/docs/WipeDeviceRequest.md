...
wipe_device_request_instance = WipeDeviceRequest.from_json(json)
# print the JSON string representation of the object
print(WipeDeviceRequest.to_json())

# convert the object into a dict
wipe_device_request_dict = wipe_device_request_instance.to_dict()
# create an instance of WipeDeviceRequest from a dict
wipe_device_request_from_dict = WipeDeviceRequest.from_dict(wipe_device_request_dict)
```
