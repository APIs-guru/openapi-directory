...
class GoogleAppsCloudidentityDevicesV1CancelWipeDeviceResponse(BaseModel):
    ...
    """ # noqa: E501
    device: Optional[GoogleAppsCloudidentityDevicesV1Device] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": GoogleAppsCloudidentityDevicesV1Device.from_dict(obj["device"]) if obj.get("device") is not None else None
        })
        return _obj
