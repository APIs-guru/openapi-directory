...
class Membership(BaseModel):
    ...
    member_key: Optional[EntityKey] = Field(default=None, alias="memberKey")
    name: Optional[StrictStr] = Field(default=None, description="Output only. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Membership`. Shall be of the form `groups/{group_id}/memberships/{membership_id}`.")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "deliverySetting", "memberKey", "name", "preferredMemberKey", "roles", "type", "updateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of member_key
        if self.member_key:
            _dict['memberKey'] = self.member_key.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberKey": EntityKey.from_dict(obj["memberKey"]) if obj.get("memberKey") is not None else None,
            "name": obj.get("name"),
