...
class Device(BaseModel):
    ...
    """ # noqa: E501
    android_specific_attributes: Optional[AndroidAttributes] = Field(default=None, alias="androidSpecificAttributes")
    ...
    client_types: Optional[List[StrictStr]] = Field(default=None, description="List of the clients the device is reporting to.", alias="clientTypes")
    ...
    endpoint_verification_specific_attributes: Optional[EndpointVerificationSpecificAttributes] = Field(default=None, alias="endpointVerificationSpecificAttributes")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}`, where device_id is the unique id assigned to the Device.")
    ...
    __properties: ClassVar[List[str]] = ["androidSpecificAttributes", "assetTag", "basebandVersion", "bootloaderVersion", "brand", "buildNumber", "clientTypes", "compromisedState", "createTime", "deviceId", "deviceType", "enabledDeveloperOptions", "enabledUsbDebugging", "encryptionState", "endpointVerificationSpecificAttributes", "hostname", "imei", "kernelVersion", "lastSyncTime", "managementState", "manufacturer", "meid", "model", "name", "networkOperator", "osVersion", "otherAccounts", "ownerType", "releaseVersion", "securityPatchTime", "serialNumber", "wifiMacAddresses"]

    @field_validator('client_types')
    def client_types_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['CLIENT_TYPE_UNSPECIFIED', 'DRIVE_FS', 'FUNDAMENTAL', 'ENDPOINT_VERIFICATION', 'WINDOWS_ADVANCED', 'GOOGLE_CREDENTIALS_PROVIDER_FOR_WINDOWS']):
                raise ValueError("each list item must be one of ('CLIENT_TYPE_UNSPECIFIED', 'DRIVE_FS', 'FUNDAMENTAL', 'ENDPOINT_VERIFICATION', 'WINDOWS_ADVANCED', 'GOOGLE_CREDENTIALS_PROVIDER_FOR_WINDOWS')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of endpoint_verification_specific_attributes
        if self.endpoint_verification_specific_attributes:
            _dict['endpointVerificationSpecificAttributes'] = self.endpoint_verification_specific_attributes.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "androidSpecificAttributes": AndroidAttributes.from_dict(obj["androidSpecificAttributes"]) if obj.get("androidSpecificAttributes") is not None else None,
            ...
            "clientTypes": obj.get("clientTypes"),
            ...
            "endpointVerificationSpecificAttributes": EndpointVerificationSpecificAttributes.from_dict(obj["endpointVerificationSpecificAttributes"]) if obj.get("endpointVerificationSpecificAttributes") is not None else None,
