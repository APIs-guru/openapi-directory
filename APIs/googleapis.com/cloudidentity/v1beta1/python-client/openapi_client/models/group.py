...
class Group(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Group`. Shall be of the form `groups/{group_id}`.")
    ...
    posix_groups: Optional[List[PosixGroup]] = Field(default=None, description="Optional. The POSIX groups associated with the `Group`.", alias="posixGroups")
    ...
    __properties: ClassVar[List[str]] = ["additionalGroupKeys", "createTime", "description", "displayName", "dynamicGroupMetadata", "groupKey", "labels", "name", "parent", "posixGroups", "updateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in posix_groups (list)
        _items = []
        if self.posix_groups:
            for _item_posix_groups in self.posix_groups:
                if _item_posix_groups:
                    _items.append(_item_posix_groups.to_dict())
            _dict['posixGroups'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "posixGroups": [PosixGroup.from_dict(_item) for _item in obj["posixGroups"]] if obj.get("posixGroups") is not None else None,
