...
class TestGoogleAppsCloudidentityDevicesV1ListDevicesResponse(unittest.TestCase):
    """GoogleAppsCloudidentityDevicesV1ListDevicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAppsCloudidentityDevicesV1ListDevicesResponse:
        """Test GoogleAppsCloudidentityDevicesV1ListDevicesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAppsCloudidentityDevicesV1ListDevicesResponse`
        """
        model = GoogleAppsCloudidentityDevicesV1ListDevicesResponse()
        if include_optional:
            return GoogleAppsCloudidentityDevicesV1ListDevicesResponse(
                devices = [
                    openapi_client.models.google_apps_cloudidentity_devices_v1_device.GoogleAppsCloudidentityDevicesV1Device(
    ...
    def testGoogleAppsCloudidentityDevicesV1ListDevicesResponse(self):
        """Test GoogleAppsCloudidentityDevicesV1ListDevicesResponse"""
