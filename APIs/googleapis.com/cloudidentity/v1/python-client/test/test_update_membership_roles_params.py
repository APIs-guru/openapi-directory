...
class TestUpdateMembershipRolesParams(unittest.TestCase):
    """UpdateMembershipRolesParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMembershipRolesParams:
        """Test UpdateMembershipRolesParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMembershipRolesParams`
        """
        model = UpdateMembershipRolesParams()
        if include_optional:
    ...
    def testUpdateMembershipRolesParams(self):
        """Test UpdateMembershipRolesParams"""
