...
class SearchDirectGroupsResponse(BaseModel):
    ...
    """ # noqa: E501
    memberships: Optional[List[MembershipRelation]] = Field(default=None, description="List of direct groups satisfying the query.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Token to retrieve the next page of results, or empty if there are no more results available for listing.", alias="nextPageToken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memberships": [MembershipRelation.from_dict(_item) for _item in obj["memberships"]] if obj.get("memberships") is not None else None,
