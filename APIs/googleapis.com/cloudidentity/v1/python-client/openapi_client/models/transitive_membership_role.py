...
class TransitiveMembershipRole(BaseModel):
    ...
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="TransitiveMembershipRole in string format. Currently supported TransitiveMembershipRoles: `\"MEMBER\"`, `\"OWNER\"`, and `\"MANAGER\"`.")
