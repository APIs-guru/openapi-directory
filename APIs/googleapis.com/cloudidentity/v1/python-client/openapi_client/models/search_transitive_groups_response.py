...
class SearchTransitiveGroupsResponse(BaseModel):
    ...
    """ # noqa: E501
    memberships: Optional[List[GroupRelation]] = Field(default=None, description="List of transitive groups satisfying the query.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memberships": [GroupRelation.from_dict(_item) for _item in obj["memberships"]] if obj.get("memberships") is not None else None,
