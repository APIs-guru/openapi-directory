...
class AddIdpCredentialRequest(BaseModel):
    ...
    """ # noqa: E501
    pem_data: Optional[StrictStr] = Field(default=None, description="PEM encoded x509 certificate containing the public key for verifying IdP signatures.", alias="pemData")
    __properties: ClassVar[List[str]] = ["pemData"]
