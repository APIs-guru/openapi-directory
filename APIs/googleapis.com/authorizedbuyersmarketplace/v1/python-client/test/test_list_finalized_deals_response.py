...
class TestListFinalizedDealsResponse(unittest.TestCase):
    """ListFinalizedDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFinalizedDealsResponse:
        """Test ListFinalizedDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFinalizedDealsResponse`
        """
        model = ListFinalizedDealsResponse()
        if include_optional:
            return ListFinalizedDealsResponse(
                finalized_deals = [
                    openapi_client.models.finalized_deal.FinalizedDeal(
    ...
    def testListFinalizedDealsResponse(self):
        """Test ListFinalizedDealsResponse"""
