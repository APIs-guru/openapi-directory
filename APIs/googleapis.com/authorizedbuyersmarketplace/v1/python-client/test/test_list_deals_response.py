...
class TestListDealsResponse(unittest.TestCase):
    """ListDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDealsResponse:
        """Test ListDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDealsResponse`
        """
        model = ListDealsResponse()
        if include_optional:
    ...
    def testListDealsResponse(self):
        """Test ListDealsResponse"""
