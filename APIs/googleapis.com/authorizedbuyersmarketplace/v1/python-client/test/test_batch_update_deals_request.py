...
class TestBatchUpdateDealsRequest(unittest.TestCase):
    """BatchUpdateDealsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateDealsRequest:
        """Test BatchUpdateDealsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateDealsRequest`
        """
        model = BatchUpdateDealsRequest()
        if include_optional:
            return BatchUpdateDealsRequest(
                requests = [
                    openapi_client.models.update_deal_request.UpdateDealRequest(
    ...
    def testBatchUpdateDealsRequest(self):
        """Test BatchUpdateDealsRequest"""
