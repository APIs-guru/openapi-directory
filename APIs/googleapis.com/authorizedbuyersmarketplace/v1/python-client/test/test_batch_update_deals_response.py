...
class TestBatchUpdateDealsResponse(unittest.TestCase):
    """BatchUpdateDealsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateDealsResponse:
        """Test BatchUpdateDealsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateDealsResponse`
        """
        model = BatchUpdateDealsResponse()
        if include_optional:
    ...
    def testBatchUpdateDealsResponse(self):
        """Test BatchUpdateDealsResponse"""
