...
class VideoTargeting(BaseModel):
    ...
    """ # noqa: E501
    excluded_position_types: Optional[List[StrictStr]] = Field(default=None, description="A list of video positions to be excluded. When this field is populated, the targeted_position_types field must be empty.", alias="excludedPositionTypes")
    targeted_position_types: Optional[List[StrictStr]] = Field(default=None, description="A list of video positions to be included. When this field is populated, the excluded_position_types field must be empty.", alias="targetedPositionTypes")
