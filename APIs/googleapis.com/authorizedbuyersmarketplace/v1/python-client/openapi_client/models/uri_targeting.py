...
class UriTargeting(BaseModel):
    ...
    """ # noqa: E501
    excluded_uris: Optional[List[StrictStr]] = Field(default=None, description="A list of URLs to be excluded.", alias="excludedUris")
    targeted_uris: Optional[List[StrictStr]] = Field(default=None, description="A list of URLs to be included.", alias="targetedUris")
    __properties: ClassVar[List[str]] = ["excludedUris", "targetedUris"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetedUris": obj.get("targetedUris")
        })
        return _obj
