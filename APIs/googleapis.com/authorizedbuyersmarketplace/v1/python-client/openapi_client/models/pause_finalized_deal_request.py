...
class PauseFinalizedDealRequest(BaseModel):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason to pause the finalized deal, will be displayed to the seller. Maximum length is 1000 characters.")
