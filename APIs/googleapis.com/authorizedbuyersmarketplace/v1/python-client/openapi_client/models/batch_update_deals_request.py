...
class BatchUpdateDealsRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[UpdateDealRequest]] = Field(default=None, description="Required. List of request messages to update deals.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateDealRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
