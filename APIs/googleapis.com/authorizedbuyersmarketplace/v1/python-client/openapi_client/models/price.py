...
class Price(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The pricing type for the deal.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TYPE_UNSPECIFIED', 'CPM', 'CPD']):
            raise ValueError("must be one of enum values ('TYPE_UNSPECIFIED', 'CPM', 'CPD')")
        return value
