...
class ApiApi:
    ...
    @validate_call
    def cloudtasks_api_queue_update(
        self,
        ...
        app_id: Annotated[Optional[StrictStr], Field(description="Required. The App ID is supplied as an HTTP parameter. Unlike internal usage of App ID, it does not include a region prefix. Rather, the App ID represents the Project ID against which to make the request.")] = None,
        ...
        _param = self._cloudtasks_api_queue_update_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def cloudtasks_api_queue_update_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def cloudtasks_api_queue_update_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudtasks_api_queue_update_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/queue/update',
