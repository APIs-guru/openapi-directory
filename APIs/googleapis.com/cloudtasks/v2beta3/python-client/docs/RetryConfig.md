...
------------ | ------------- | ------------- | -------------
**max_attempts** | **int** | Number of attempts per task. Cloud Tasks will attempt the task &#x60;max_attempts&#x60; times (that is, if the first attempt fails, then there will be &#x60;max_attempts - 1&#x60; retries). Must be &gt;&#x3D; -1. If unspecified when the queue is created, Cloud Tasks will pick the default. -1 indicates unlimited attempts. This field has the same meaning as [task_retry_limit in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters). | [optional] 
