...
------------- | ------------- | -------------
[**cloudtasks_projects_locations_list**](ProjectsApi.md#cloudtasks_projects_locations_list) | **GET** /v2beta3/{name}/locations | 
[**cloudtasks_projects_locations_queues_create**](ProjectsApi.md#cloudtasks_projects_locations_queues_create) | **POST** /v2beta3/{parent}/queues | 
[**cloudtasks_projects_locations_queues_get_iam_policy**](ProjectsApi.md#cloudtasks_projects_locations_queues_get_iam_policy) | **POST** /v2beta3/{resource}:getIamPolicy | 
[**cloudtasks_projects_locations_queues_list**](ProjectsApi.md#cloudtasks_projects_locations_queues_list) | **GET** /v2beta3/{parent}/queues | 
[**cloudtasks_projects_locations_queues_patch**](ProjectsApi.md#cloudtasks_projects_locations_queues_patch) | **PATCH** /v2beta3/{name} | 
[**cloudtasks_projects_locations_queues_pause**](ProjectsApi.md#cloudtasks_projects_locations_queues_pause) | **POST** /v2beta3/{name}:pause | 
[**cloudtasks_projects_locations_queues_purge**](ProjectsApi.md#cloudtasks_projects_locations_queues_purge) | **POST** /v2beta3/{name}:purge | 
[**cloudtasks_projects_locations_queues_resume**](ProjectsApi.md#cloudtasks_projects_locations_queues_resume) | **POST** /v2beta3/{name}:resume | 
[**cloudtasks_projects_locations_queues_set_iam_policy**](ProjectsApi.md#cloudtasks_projects_locations_queues_set_iam_policy) | **POST** /v2beta3/{resource}:setIamPolicy | 
[**cloudtasks_projects_locations_queues_tasks_buffer**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_buffer) | **POST** /v2beta3/{queue}/tasks/{taskId}:buffer | 
[**cloudtasks_projects_locations_queues_tasks_create**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_create) | **POST** /v2beta3/{parent}/tasks | 
[**cloudtasks_projects_locations_queues_tasks_delete**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_delete) | **DELETE** /v2beta3/{name} | 
[**cloudtasks_projects_locations_queues_tasks_get**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_get) | **GET** /v2beta3/{name} | 
[**cloudtasks_projects_locations_queues_tasks_list**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_list) | **GET** /v2beta3/{parent}/tasks | 
[**cloudtasks_projects_locations_queues_tasks_run**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_run) | **POST** /v2beta3/{name}:run | 
[**cloudtasks_projects_locations_queues_test_iam_permissions**](ProjectsApi.md#cloudtasks_projects_locations_queues_test_iam_permissions) | **POST** /v2beta3/{resource}:testIamPermissions | 
