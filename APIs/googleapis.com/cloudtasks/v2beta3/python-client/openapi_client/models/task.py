...
class Task(BaseModel):
    ...
    schedule_time: Optional[StrictStr] = Field(default=None, description="The time when the task is scheduled to be attempted. For App Engine queues, this is when the task will be attempted or retried. `schedule_time` will be truncated to the nearest microsecond.", alias="scheduleTime")
    ...
    __properties: ClassVar[List[str]] = ["appEngineHttpRequest", "createTime", "dispatchCount", "dispatchDeadline", "firstAttempt", "httpRequest", "lastAttempt", "name", "pullMessage", "responseCount", "scheduleTime", "view"]
