...
class QueryOverride(BaseModel):
    ...
    """ # noqa: E501
    var_query_params: Optional[StrictStr] = Field(default=None, description="The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.", alias="queryParams")
    __properties: ClassVar[List[str]] = ["queryParams"]
