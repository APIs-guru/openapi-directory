...
class ListQueuesResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve next page of results. To return the next page of results, call ListQueues with this value as the page_token. If the next_page_token is empty, there are no more results. The page token is valid for only 2 hours.", alias="nextPageToken")
    queues: Optional[List[Queue]] = Field(default=None, description="The list of queues.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "queues"]
