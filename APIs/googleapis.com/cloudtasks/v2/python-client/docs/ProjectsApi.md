...
------------- | ------------- | -------------
[**cloudtasks_projects_locations_list**](ProjectsApi.md#cloudtasks_projects_locations_list) | **GET** /v2/{name}/locations | 
[**cloudtasks_projects_locations_queues_create**](ProjectsApi.md#cloudtasks_projects_locations_queues_create) | **POST** /v2/{parent}/queues | 
[**cloudtasks_projects_locations_queues_get_iam_policy**](ProjectsApi.md#cloudtasks_projects_locations_queues_get_iam_policy) | **POST** /v2/{resource}:getIamPolicy | 
[**cloudtasks_projects_locations_queues_list**](ProjectsApi.md#cloudtasks_projects_locations_queues_list) | **GET** /v2/{parent}/queues | 
[**cloudtasks_projects_locations_queues_patch**](ProjectsApi.md#cloudtasks_projects_locations_queues_patch) | **PATCH** /v2/{name} | 
[**cloudtasks_projects_locations_queues_pause**](ProjectsApi.md#cloudtasks_projects_locations_queues_pause) | **POST** /v2/{name}:pause | 
[**cloudtasks_projects_locations_queues_purge**](ProjectsApi.md#cloudtasks_projects_locations_queues_purge) | **POST** /v2/{name}:purge | 
[**cloudtasks_projects_locations_queues_resume**](ProjectsApi.md#cloudtasks_projects_locations_queues_resume) | **POST** /v2/{name}:resume | 
[**cloudtasks_projects_locations_queues_set_iam_policy**](ProjectsApi.md#cloudtasks_projects_locations_queues_set_iam_policy) | **POST** /v2/{resource}:setIamPolicy | 
[**cloudtasks_projects_locations_queues_tasks_buffer**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_buffer) | **POST** /v2/{queue}/tasks/{taskId}:buffer | 
[**cloudtasks_projects_locations_queues_tasks_create**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_create) | **POST** /v2/{parent}/tasks | 
[**cloudtasks_projects_locations_queues_tasks_delete**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_delete) | **DELETE** /v2/{name} | 
[**cloudtasks_projects_locations_queues_tasks_get**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_get) | **GET** /v2/{name} | 
[**cloudtasks_projects_locations_queues_tasks_list**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_list) | **GET** /v2/{parent}/tasks | 
[**cloudtasks_projects_locations_queues_tasks_run**](ProjectsApi.md#cloudtasks_projects_locations_queues_tasks_run) | **POST** /v2/{name}:run | 
[**cloudtasks_projects_locations_queues_test_iam_permissions**](ProjectsApi.md#cloudtasks_projects_locations_queues_test_iam_permissions) | **POST** /v2/{resource}:testIamPermissions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    task_id = 'task_id_example' # str | Optional. Task ID for the task being created. If not provided, Cloud Tasks generates an ID for the task.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
 ...
 **task_id** | **str**| Optional. Task ID for the task being created. If not provided, Cloud Tasks generates an ID for the task. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
