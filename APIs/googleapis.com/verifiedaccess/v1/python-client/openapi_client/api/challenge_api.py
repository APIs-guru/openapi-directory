...
class ChallengeApi:
    ...
    @validate_call
    def verifiedaccess_challenge_create(
        self,
        ...
        _param = self._verifiedaccess_challenge_create_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def verifiedaccess_challenge_create_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def verifiedaccess_challenge_create_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _verifiedaccess_challenge_create_serialize(
        self,
        xgafv,
        access_token,
        alt,
    ...
    def _verifiedaccess_challenge_verify_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/challenge:verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
