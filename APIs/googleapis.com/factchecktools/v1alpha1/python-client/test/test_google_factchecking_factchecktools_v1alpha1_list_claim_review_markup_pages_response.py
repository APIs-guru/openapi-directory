...
class TestGoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse(unittest.TestCase):
    """GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse:
        """Test GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse`
        """
        model = GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse()
        if include_optional:
            return GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse(
                claim_review_markup_pages = [
                    openapi_client.models.google_factchecking_factchecktools_v1alpha1_claim_review_markup_page.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage(
    ...
    def testGoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse(self):
        """Test GoogleFactcheckingFactchecktoolsV1alpha1ListClaimReviewMarkupPagesResponse"""
