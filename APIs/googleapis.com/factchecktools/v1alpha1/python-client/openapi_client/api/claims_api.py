...
class ClaimsApi:
    ...
    @validate_call
    def factchecktools_claims_search(
        self,
        ...
        language_code: Annotated[Optional[StrictStr], Field(description="The BCP-47 language code, such as \"en-US\" or \"sr-Latn\". Can be used to restrict results by language, though we do not currently consider the region.")] = None,
        max_age_days: Annotated[Optional[StrictInt], Field(description="The maximum age of the returned search results, in days. Age is determined by either claim date or review date, whichever is newer.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="An integer that specifies the current offset (that is, starting result location) in search results. This field is only considered if `page_token` is unset. For example, 0 means to return results starting from the first matching result, and 10 means to return from the 11th result.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The pagination size. We will return up to that many results. Defaults to 10 if not set.")] = None,
        ...
        query: Annotated[Optional[StrictStr], Field(description="Textual query string. Required unless `review_publisher_site_filter` is specified.")] = None,
        review_publisher_site_filter: Annotated[Optional[StrictStr], Field(description="The review publisher site to filter results by, e.g. nytimes.com.")] = None,
        ...
        _param = self._factchecktools_claims_search_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse",
        }
    ...
    @validate_call
    def factchecktools_claims_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def factchecktools_claims_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _factchecktools_claims_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if max_age_days is not None:
            ...
            _query_params.append(('maxAgeDays', max_age_days))
        ...
        if review_publisher_site_filter is not None:
            ...
            _query_params.append(('reviewPublisherSiteFilter', review_publisher_site_filter))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1alpha1/claims:search',
