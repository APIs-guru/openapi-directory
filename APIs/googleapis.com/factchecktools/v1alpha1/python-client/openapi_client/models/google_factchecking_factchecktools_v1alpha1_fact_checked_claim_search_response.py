...
class GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    claims: Optional[List[GoogleFactcheckingFactchecktoolsV1alpha1Claim]] = Field(default=None, description="The list of claims and all of their associated information.")
    ...
    __properties: ClassVar[List[str]] = ["claims", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "claims": [GoogleFactcheckingFactchecktoolsV1alpha1Claim.from_dict(_item) for _item in obj["claims"]] if obj.get("claims") is not None else None,
