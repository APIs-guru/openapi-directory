...
**source_representative_instance_name** | **str** | Required. The name of the instance which acts as an on-premises primary instance in the replication setup. | [optional] 
