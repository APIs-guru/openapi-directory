...
------------ | ------------- | ------------- | -------------
**code** | **str** | Identifies the specific error that occurred. | [optional] 
**kind** | **str** | This is always &#x60;sql#operationError&#x60;. | [optional] 
**message** | **str** | Additional information about the error encountered. | [optional] 
