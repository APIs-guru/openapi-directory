...
------------ | ------------- | ------------- | -------------
**end_date** | **str** | \&quot;deny maintenance period\&quot; end date. If the year of the end date is empty, the year of the start date also must be empty. In this case, it means the deny maintenance period recurs every year. The date is in format yyyy-mm-dd i.e., 2020-11-01, or mm-dd, i.e., 11-01 | [optional] 
