...
class TestExportContext(unittest.TestCase):
    """ExportContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportContext:
        """Test ExportContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportContext`
        """
        model = ExportContext()
        if include_optional:
