...
class TestSslCertsInsertResponse(unittest.TestCase):
    """SslCertsInsertResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SslCertsInsertResponse:
        """Test SslCertsInsertResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SslCertsInsertResponse`
        """
        model = SslCertsInsertResponse()
        if include_optional:
            return SslCertsInsertResponse(
                client_cert = openapi_client.models.ssl_cert_detail.SslCertDetail(
    ...
    def testSslCertsInsertResponse(self):
        """Test SslCertsInsertResponse"""
