...
class ConnectApi:
    ...
    def sql_connect_generate_ephemeral(
        ...
        generate_ephemeral_cert_request: Optional[GenerateEphemeralCertRequest] = None,
        ...
        :param generate_ephemeral_cert_request:
        :type generate_ephemeral_cert_request: GenerateEphemeralCertRequest
        ...
        _param = self._sql_connect_generate_ephemeral_serialize(
            project=project,
            instance=instance,
            xgafv=xgafv,
            ...
            generate_ephemeral_cert_request=generate_ephemeral_cert_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GenerateEphemeralCertResponse",
        }
    ...
    @validate_call
    def sql_connect_generate_ephemeral_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        instance: Annotated[StrictStr, Field(description="Cloud SQL instance ID. This does not include the project ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateEphemeralCertResponse]:
        """sql_connect_generate_ephemeral
    ...
    @validate_call
    def sql_connect_generate_ephemeral_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        instance: Annotated[StrictStr, Field(description="Cloud SQL instance ID. This does not include the project ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _sql_connect_generate_ephemeral_serialize(
        self,
        project,
        instance,
        xgafv,
        ...
        upload_protocol,
        upload_type,
        generate_ephemeral_cert_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if generate_ephemeral_cert_request is not None:
            _body_params = generate_ephemeral_cert_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sql/v1beta4/projects/{project}/instances/{instance}:generateEphemeralCert',
    ...
    def sql_connect_get(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        read_time: Annotated[Optional[StrictStr], Field(description="Optional. Optional snapshot read timestamp to trade freshness for performance.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._sql_connect_get_serialize(
            project=project,
            instance=instance,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def sql_connect_get_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        instance: Annotated[StrictStr, Field(description="Cloud SQL instance ID. This does not include the project ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def sql_connect_get_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project that contains the instance.")],
        instance: Annotated[StrictStr, Field(description="Cloud SQL instance ID. This does not include the project ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _sql_connect_get_serialize(
        self,
        project,
        instance,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sql/v1beta4/projects/{project}/instances/{instance}/connectSettings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
