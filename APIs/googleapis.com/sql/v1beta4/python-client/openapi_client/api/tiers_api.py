...
class TiersApi:
    ...
    def sql_tiers_list(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project for which to list tiers.")],
        ...
        :param project: Project ID of the project for which to list tiers. (required)
        :type project: str
        ...
        _param = self._sql_tiers_list_serialize(
            project=project,
            xgafv=xgafv,
    ...
    @validate_call
    def sql_tiers_list_with_http_info(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project for which to list tiers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def sql_tiers_list_without_preload_content(
        self,
        project: Annotated[StrictStr, Field(description="Project ID of the project for which to list tiers.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _sql_tiers_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sql/v1beta4/projects/{project}/tiers',
