...
class ImportContext(BaseModel):
    ...
    file_type: Optional[StrictStr] = Field(default=None, description="The file type for the specified uri. * `SQL`: The file contains SQL statements. * `CSV`: The file contains CSV data. * `BAK`: The file contains backup data for a SQL Server instance.", alias="fileType")
