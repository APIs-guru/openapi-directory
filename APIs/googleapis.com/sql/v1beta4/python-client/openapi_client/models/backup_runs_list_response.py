...
class BackupRunsListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[BackupRun]] = Field(default=None, description="A list of backup runs in reverse chronological order of the enqueued time.")
    kind: Optional[StrictStr] = Field(default=None, description="This is always `sql#backupRunsList`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [BackupRun.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
