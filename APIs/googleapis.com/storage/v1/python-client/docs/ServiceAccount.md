...
------------ | ------------- | ------------- | -------------
**email_address** | **str** | The ID of the notification. | [optional] 
**kind** | **str** | The kind of item this is. For notifications, this is always storage#notification. | [optional] [default to 'storage#serviceAccount']
