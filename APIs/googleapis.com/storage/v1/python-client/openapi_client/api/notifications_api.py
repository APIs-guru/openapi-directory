...
class NotificationsApi:
    ...
    def storage_notifications_delete(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="ID of the notification to delete.")],
        ...
        _param = self._storage_notifications_delete_serialize(
            bucket=bucket,
    ...
    @validate_call
    def storage_notifications_delete_with_http_info(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="ID of the notification to delete.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def storage_notifications_delete_without_preload_content(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="ID of the notification to delete.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _storage_notifications_delete_serialize(
        self,
        bucket,
        notification,
        alt,
        ...
        if notification is not None:
            _path_params['notification'] = notification
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/b/{bucket}/notificationConfigs/{notification}',
    ...
    def storage_notifications_get(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="Notification ID")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        _param = self._storage_notifications_get_serialize(
            bucket=bucket,
            notification=notification,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def storage_notifications_get_with_http_info(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="Notification ID")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def storage_notifications_get_without_preload_content(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        notification: Annotated[StrictStr, Field(description="Notification ID")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _storage_notifications_get_serialize(
        self,
        bucket,
        notification,
        alt,
    ...
    def storage_notifications_insert(
        ...
        _param = self._storage_notifications_insert_serialize(
            bucket=bucket,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def storage_notifications_insert_with_http_info(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def storage_notifications_insert_without_preload_content(
        self,
        bucket: Annotated[StrictStr, Field(description="The parent bucket of the notification.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _storage_notifications_insert_serialize(
        self,
        bucket,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/b/{bucket}/notificationConfigs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def storage_notifications_list(
        self,
        bucket: Annotated[StrictStr, Field(description="Name of a Google Cloud Storage bucket.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        _param = self._storage_notifications_list_serialize(
            bucket=bucket,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def storage_notifications_list_with_http_info(
        self,
        bucket: Annotated[StrictStr, Field(description="Name of a Google Cloud Storage bucket.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def storage_notifications_list_without_preload_content(
        self,
        bucket: Annotated[StrictStr, Field(description="Name of a Google Cloud Storage bucket.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _storage_notifications_list_serialize(
        self,
        bucket,
        alt,
        fields,
