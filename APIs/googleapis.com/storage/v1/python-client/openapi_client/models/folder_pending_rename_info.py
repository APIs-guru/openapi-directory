...
class FolderPendingRenameInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    operation_id: Optional[StrictStr] = Field(default=None, description="The ID of the rename folder operation.", alias="operationId")
