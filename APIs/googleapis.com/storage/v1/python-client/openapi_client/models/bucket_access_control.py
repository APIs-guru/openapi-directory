...
class BucketAccessControl(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='storage#bucketAccessControl', description="The kind of item this is. For bucket access control entries, this is always storage#bucketAccessControl.")
    ...
    __properties: ClassVar[List[str]] = ["bucket", "domain", "email", "entity", "entityId", "etag", "id", "kind", "projectTeam", "role", "selfLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'storage#bucketAccessControl',
