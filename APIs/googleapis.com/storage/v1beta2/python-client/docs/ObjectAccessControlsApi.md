...
> storage_object_access_controls_delete(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.storage_object_access_controls_delete(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
> ObjectAccessControl storage_object_access_controls_get(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_object_access_controls_get(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
> ObjectAccessControl storage_object_access_controls_insert(bucket, object, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_object_access_controls_insert(bucket, object, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
...
> ObjectAccessControls storage_object_access_controls_list(bucket, object, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_object_access_controls_list(bucket, object, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation)
...
> ObjectAccessControl storage_object_access_controls_patch(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_object_access_controls_patch(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
...
> ObjectAccessControl storage_object_access_controls_update(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_object_access_controls_update(bucket, object, entity, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, generation=generation, object_access_control=object_access_control)
