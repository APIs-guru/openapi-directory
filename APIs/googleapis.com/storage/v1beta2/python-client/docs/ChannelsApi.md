...
> storage_channels_stop(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, channel=channel)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.storage_channels_stop(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, channel=channel)
