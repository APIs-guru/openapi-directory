...
**generation** | **str** | The content generation of the object. | [optional] 
...
**object** | **str** | The name of the object. | [optional] 
**role** | **str** | The access permission for the entity. Can be READER or OWNER. | [optional] 
