...
class TestBucketLifecycleRuleInner(unittest.TestCase):
    """BucketLifecycleRuleInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketLifecycleRuleInner:
        """Test BucketLifecycleRuleInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketLifecycleRuleInner`
        """
        model = BucketLifecycleRuleInner()
        if include_optional:
            return BucketLifecycleRuleInner(
    ...
    def testBucketLifecycleRuleInner(self):
        """Test BucketLifecycleRuleInner"""
