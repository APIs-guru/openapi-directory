...
class BucketAccessControl(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="The access permission for the entity. Can be READER, WRITER, or OWNER.")
    self_link: Optional[StrictStr] = Field(default=None, description="The link to this access-control entry.", alias="selfLink")
    __properties: ClassVar[List[str]] = ["bucket", "domain", "email", "entity", "entityId", "etag", "id", "kind", "role", "selfLink"]
