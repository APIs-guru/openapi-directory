...
------------- | ------------- | -------------
[**file_projects_locations_backups_create**](ProjectsApi.md#file_projects_locations_backups_create) | **POST** /v1beta1/{parent}/backups | 
[**file_projects_locations_backups_list**](ProjectsApi.md#file_projects_locations_backups_list) | **GET** /v1beta1/{parent}/backups | 
[**file_projects_locations_instances_create**](ProjectsApi.md#file_projects_locations_instances_create) | **POST** /v1beta1/{parent}/instances | 
[**file_projects_locations_instances_list**](ProjectsApi.md#file_projects_locations_instances_list) | **GET** /v1beta1/{parent}/instances | 
[**file_projects_locations_instances_restore**](ProjectsApi.md#file_projects_locations_instances_restore) | **POST** /v1beta1/{name}:restore | 
[**file_projects_locations_instances_revert**](ProjectsApi.md#file_projects_locations_instances_revert) | **POST** /v1beta1/{name}:revert | 
[**file_projects_locations_instances_shares_create**](ProjectsApi.md#file_projects_locations_instances_shares_create) | **POST** /v1beta1/{parent}/shares | 
[**file_projects_locations_instances_shares_list**](ProjectsApi.md#file_projects_locations_instances_shares_list) | **GET** /v1beta1/{parent}/shares | 
[**file_projects_locations_instances_snapshots_create**](ProjectsApi.md#file_projects_locations_instances_snapshots_create) | **POST** /v1beta1/{parent}/snapshots | 
[**file_projects_locations_instances_snapshots_list**](ProjectsApi.md#file_projects_locations_instances_snapshots_list) | **GET** /v1beta1/{parent}/snapshots | 
[**file_projects_locations_instances_snapshots_patch**](ProjectsApi.md#file_projects_locations_instances_snapshots_patch) | **PATCH** /v1beta1/{name} | 
[**file_projects_locations_list**](ProjectsApi.md#file_projects_locations_list) | **GET** /v1beta1/{name}/locations | 
[**file_projects_locations_operations_cancel**](ProjectsApi.md#file_projects_locations_operations_cancel) | **POST** /v1beta1/{name}:cancel | 
[**file_projects_locations_operations_delete**](ProjectsApi.md#file_projects_locations_operations_delete) | **DELETE** /v1beta1/{name} | 
[**file_projects_locations_operations_get**](ProjectsApi.md#file_projects_locations_operations_get) | **GET** /v1beta1/{name} | 
[**file_projects_locations_operations_list**](ProjectsApi.md#file_projects_locations_operations_list) | **GET** /v1beta1/{name}/operations | 
...
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. The backup&#39;s project and location, in the format &#x60;projects/{project_id}/locations/{location}&#x60;. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**. | 
 ...
 **backup_id** | **str**| Required. The ID to use for the backup. The ID must be unique within the specified project and location. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. | [optional] 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. The project and location for which to retrieve backup information, in the format &#x60;projects/{project_id}/locations/{location}&#x60;. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**. To retrieve backup information for all locations, use \&quot;-\&quot; for the &#x60;{location}&#x60; value. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    instance_id = 'instance_id_example' # str | Required. The ID of the instance to create. The ID must be unique within the specified project and location. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **instance_id** | **str**| Required. The ID of the instance to create. The ID must be unique within the specified project and location. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    name = 'name_example' # str | Required. The resource name of the instance, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}`.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **str**| Required. The resource name of the instance, in the format &#x60;projects/{project_id}/locations/{location_id}/instances/{instance_id}&#x60;. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
...
> Operation file_projects_locations_instances_shares_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, share_id=share_id, share=share)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    parent = 'parent_example' # str | Required. The Filestore Instance to create the share for, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    share_id = 'share_id_example' # str | Required. The ID to use for the share. The ID must be unique within the specified instance. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. (optional)
    share = openapi_client.Share() # Share |  (optional)

    try:
        api_response = api_instance.file_projects_locations_instances_shares_create(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, share_id=share_id, share=share)
        print("The response of ProjectsApi->file_projects_locations_instances_shares_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->file_projects_locations_instances_shares_create: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. The Filestore Instance to create the share for, in the format &#x60;projects/{project_id}/locations/{location}/instances/{instance_id}&#x60; | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **share_id** | **str**| Required. The ID to use for the share. The ID must be unique within the specified instance. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. | [optional] 
...
> ListSharesResponse file_projects_locations_instances_shares_list(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, order_by=order_by, page_size=page_size, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectsApi(api_client)
    parent = 'parent_example' # str | Required. The instance for which to retrieve share information, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
    ...
    try:
        api_response = api_instance.file_projects_locations_instances_shares_list(parent, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, filter=filter, order_by=order_by, page_size=page_size, page_token=page_token)
        print("The response of ProjectsApi->file_projects_locations_instances_shares_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->file_projects_locations_instances_shares_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **str**| Required. The instance for which to retrieve share information, in the format &#x60;projects/{project_id}/locations/{location}/instances/{instance_id}&#x60;. | 
 **xgafv** | **str**| V1 error format. | [optional] 
 **access_token** | **str**| OAuth access token. | [optional] 
 **alt** | **str**| Data format for response. | [optional] 
 **param_callback** | **str**| JSONP | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    force = True # bool | If set to true, any snapshots of the instance will also be deleted. (Otherwise, the request will only work if the instance has no snapshots.) (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **force** | **bool**| If set to true, any snapshots of the instance will also be deleted. (Otherwise, the request will only work if the instance has no snapshots.) | [optional] 
