...
class FileShareConfig(BaseModel):
    ...
    source_backup: Optional[StrictStr] = Field(default=None, description="The resource name of the backup, in the format `projects/{project_id}/locations/{location_id}/backups/{backup_id}`, that this file share has been restored from.", alias="sourceBackup")
