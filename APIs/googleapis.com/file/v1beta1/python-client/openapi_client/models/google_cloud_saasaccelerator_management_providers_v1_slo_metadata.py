...
class GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata(BaseModel):
    ...
    tier: Optional[StrictStr] = Field(default=None, description="Name of the SLO tier the Instance belongs to. This name will be expected to match the tiers specified in the service SLO configuration. Field is mandatory and must not be empty.")
    __properties: ClassVar[List[str]] = ["nodes", "perSliEligibility", "tier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
