...
class Backup(BaseModel):
    ...
    download_bytes: Optional[StrictStr] = Field(default=None, description="Output only. Amount of bytes that will be downloaded if the backup is restored. This may be different than storage bytes, since sequential backups of the same disk will share storage.", alias="downloadBytes")
    kms_key: Optional[StrictStr] = Field(default=None, description="Immutable. KMS key name used for data encryption.", alias="kmsKey")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Resource labels to represent user provided metadata.")
    name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the backup, in the format `projects/{project_number}/locations/{location_id}/backups/{backup_id}`.")
    ...
    source_instance: Optional[StrictStr] = Field(default=None, description="The resource name of the source Filestore instance, in the format `projects/{project_number}/locations/{location_id}/instances/{instance_id}`, used to create this backup.", alias="sourceInstance")
    ...
    __properties: ClassVar[List[str]] = ["capacityGb", "createTime", "description", "downloadBytes", "kmsKey", "labels", "name", "satisfiesPzi", "satisfiesPzs", "sourceFileShare", "sourceInstance", "sourceInstanceTier", "state", "storageBytes"]
