...
**download_bytes** | **str** | Output only. Amount of bytes that will be downloaded if the backup is restored. This may be different than storage bytes, since sequential backups of the same disk will share storage. | [optional] [readonly] 
**kms_key** | **str** | Immutable. KMS key name used for data encryption. | [optional] 
**labels** | **Dict[str, str]** | Resource labels to represent user provided metadata. | [optional] 
**name** | **str** | Output only. The resource name of the backup, in the format &#x60;projects/{project_number}/locations/{location_id}/backups/{backup_id}&#x60;. | [optional] [readonly] 
...
**source_instance** | **str** | The resource name of the source Filestore instance, in the format &#x60;projects/{project_number}/locations/{location_id}/instances/{instance_id}&#x60;, used to create this backup. | [optional] 
