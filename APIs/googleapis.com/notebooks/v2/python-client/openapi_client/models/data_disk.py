...
class DataDisk(BaseModel):
    ...
    disk_size_gb: Optional[StrictStr] = Field(default=None, description="Optional. The size of the disk in GB attached to this VM instance, up to a maximum of 64000 GB (64 TB). If not specified, this defaults to 100.", alias="diskSizeGb")
    disk_type: Optional[StrictStr] = Field(default=None, description="Optional. Input only. Indicates the type of the disk.", alias="diskType")
