...
class ResizeDiskRequest(BaseModel):
    ...
    data_disk: Optional[DataDisk] = Field(default=None, alias="dataDisk")
    __properties: ClassVar[List[str]] = ["bootDisk", "dataDisk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataDisk": DataDisk.from_dict(obj["dataDisk"]) if obj.get("dataDisk") is not None else None
        })
        return _obj
