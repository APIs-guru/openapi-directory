...
class ListInstancesResponse(BaseModel):
    ...
    """ # noqa: E501
    instances: Optional[List[Instance]] = Field(default=None, description="A list of returned instances.")
    ...
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations that could not be reached. For example, ['us-west1-a', 'us-central1-b']. A ListInstancesResponse will only contain either instances or unreachables,")
