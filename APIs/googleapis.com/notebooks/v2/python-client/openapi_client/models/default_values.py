...
class DefaultValues(BaseModel):
    ...
    """ # noqa: E501
    machine_type: Optional[StrictStr] = Field(default=None, description="Output only. The default machine type used by the backend if not provided by the user.", alias="machineType")
