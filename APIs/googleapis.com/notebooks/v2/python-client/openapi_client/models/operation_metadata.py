...
class OperationMetadata(BaseModel):
    ...
    endpoint: Optional[StrictStr] = Field(default=None, description="API endpoint name of this operation.")
    ...
    __properties: ClassVar[List[str]] = ["apiVersion", "createTime", "endTime", "endpoint", "requestedCancellation", "statusMessage", "target", "verb"]
