...
------------ | ------------- | ------------- | -------------
**family** | **str** | Optional. Use this VM image family to find the image; the newest image in this family will be used. | [optional] 
**name** | **str** | Optional. Use VM image name to find the image. | [optional] 
