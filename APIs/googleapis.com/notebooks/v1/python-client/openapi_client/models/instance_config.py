...
class InstanceConfig(BaseModel):
    ...
    """ # noqa: E501
    enable_health_monitoring: Optional[StrictBool] = Field(default=None, description="Verifies core internal services are running.", alias="enableHealthMonitoring")
    ...
    __properties: ClassVar[List[str]] = ["enableHealthMonitoring", "notebookUpgradeSchedule"]
