...
class SwitchRuntimeRequest(BaseModel):
    ...
    machine_type: Optional[StrictStr] = Field(default=None, description="machine type.", alias="machineType")
    request_id: Optional[StrictStr] = Field(default=None, description="Idempotent request UUID.", alias="requestId")
    __properties: ClassVar[List[str]] = ["acceleratorConfig", "machineType", "requestId"]
