...
class ListEnvironmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    environments: Optional[List[Environment]] = Field(default=None, description="A list of returned environments.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A page token that can be used to continue listing from the last result in the next list call.", alias="nextPageToken")
    unreachable: Optional[List[StrictStr]] = Field(default=None, description="Locations that could not be reached.")
    __properties: ClassVar[List[str]] = ["environments", "nextPageToken", "unreachable"]
