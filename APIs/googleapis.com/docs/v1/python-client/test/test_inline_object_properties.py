...
class TestInlineObjectProperties(unittest.TestCase):
    """InlineObjectProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineObjectProperties:
        """Test InlineObjectProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineObjectProperties`
        """
        model = InlineObjectProperties()
        if include_optional:
    ...
    def testInlineObjectProperties(self):
        """Test InlineObjectProperties"""
