...
class TestAutoText(unittest.TestCase):
    """AutoText unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoText:
        """Test AutoText
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoText`
        """
        model = AutoText()
        if include_optional:
            return AutoText(
