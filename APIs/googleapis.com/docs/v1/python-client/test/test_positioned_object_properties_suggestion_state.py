...
class TestPositionedObjectPropertiesSuggestionState(unittest.TestCase):
    """PositionedObjectPropertiesSuggestionState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PositionedObjectPropertiesSuggestionState:
        """Test PositionedObjectPropertiesSuggestionState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionedObjectPropertiesSuggestionState`
        """
        model = PositionedObjectPropertiesSuggestionState()
        if include_optional:
    ...
    def testPositionedObjectPropertiesSuggestionState(self):
        """Test PositionedObjectPropertiesSuggestionState"""
