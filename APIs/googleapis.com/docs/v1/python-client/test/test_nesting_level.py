...
class TestNestingLevel(unittest.TestCase):
    """NestingLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestingLevel:
        """Test NestingLevel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestingLevel`
        """
        model = NestingLevel()
        if include_optional:
            return NestingLevel(
