...
class TestTextStyleSuggestionState(unittest.TestCase):
    """TextStyleSuggestionState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextStyleSuggestionState:
        """Test TextStyleSuggestionState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextStyleSuggestionState`
        """
        model = TextStyleSuggestionState()
        if include_optional:
    ...
    def testTextStyleSuggestionState(self):
        """Test TextStyleSuggestionState"""
