...
class TestColumnBreak(unittest.TestCase):
    """ColumnBreak unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColumnBreak:
        """Test ColumnBreak
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ColumnBreak`
        """
        model = ColumnBreak()
        if include_optional:
            return ColumnBreak(
