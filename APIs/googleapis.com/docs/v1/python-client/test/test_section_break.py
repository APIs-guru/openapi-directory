...
class TestSectionBreak(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SectionBreak:
        """Test SectionBreak
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SectionBreak`
        """
        model = SectionBreak()
        if include_optional:
            return SectionBreak(
