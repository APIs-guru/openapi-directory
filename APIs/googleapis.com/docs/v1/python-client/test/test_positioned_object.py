...
class TestPositionedObject(unittest.TestCase):
    """PositionedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PositionedObject:
        """Test PositionedObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionedObject`
        """
        model = PositionedObject()
        if include_optional:
