...
class TestSuggestedListProperties(unittest.TestCase):
    """SuggestedListProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedListProperties:
        """Test SuggestedListProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedListProperties`
        """
        model = SuggestedListProperties()
        if include_optional:
    ...
    def testSuggestedListProperties(self):
        """Test SuggestedListProperties"""
