...
class TestSuggestedParagraphStyle(unittest.TestCase):
    """SuggestedParagraphStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedParagraphStyle:
        """Test SuggestedParagraphStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedParagraphStyle`
        """
        model = SuggestedParagraphStyle()
        if include_optional:
    ...
    def testSuggestedParagraphStyle(self):
        """Test SuggestedParagraphStyle"""
