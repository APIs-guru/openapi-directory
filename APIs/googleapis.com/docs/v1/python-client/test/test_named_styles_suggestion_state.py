...
class TestNamedStylesSuggestionState(unittest.TestCase):
    """NamedStylesSuggestionState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedStylesSuggestionState:
        """Test NamedStylesSuggestionState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedStylesSuggestionState`
        """
        model = NamedStylesSuggestionState()
        if include_optional:
    ...
    def testNamedStylesSuggestionState(self):
        """Test NamedStylesSuggestionState"""
