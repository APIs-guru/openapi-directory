...
class TestSuggestedBullet(unittest.TestCase):
    """SuggestedBullet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedBullet:
        """Test SuggestedBullet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedBullet`
        """
        model = SuggestedBullet()
        if include_optional:
