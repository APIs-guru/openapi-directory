...
class TestSuggestedInlineObjectProperties(unittest.TestCase):
    """SuggestedInlineObjectProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedInlineObjectProperties:
        """Test SuggestedInlineObjectProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedInlineObjectProperties`
        """
        model = SuggestedInlineObjectProperties()
        if include_optional:
    ...
    def testSuggestedInlineObjectProperties(self):
        """Test SuggestedInlineObjectProperties"""
