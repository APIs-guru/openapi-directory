...
class TestSuggestedTextStyle(unittest.TestCase):
    """SuggestedTextStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedTextStyle:
        """Test SuggestedTextStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedTextStyle`
        """
        model = SuggestedTextStyle()
        if include_optional:
    ...
    def testSuggestedTextStyle(self):
        """Test SuggestedTextStyle"""
