...
class TestRichLink(unittest.TestCase):
    """RichLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichLink:
        """Test RichLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RichLink`
        """
        model = RichLink()
        if include_optional:
            return RichLink(
