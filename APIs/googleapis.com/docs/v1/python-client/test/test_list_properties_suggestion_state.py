...
class TestListPropertiesSuggestionState(unittest.TestCase):
    """ListPropertiesSuggestionState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPropertiesSuggestionState:
        """Test ListPropertiesSuggestionState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPropertiesSuggestionState`
        """
        model = ListPropertiesSuggestionState()
        if include_optional:
    ...
    def testListPropertiesSuggestionState(self):
        """Test ListPropertiesSuggestionState"""
