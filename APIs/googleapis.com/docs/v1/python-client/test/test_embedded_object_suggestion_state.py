...
class TestEmbeddedObjectSuggestionState(unittest.TestCase):
    """EmbeddedObjectSuggestionState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmbeddedObjectSuggestionState:
        """Test EmbeddedObjectSuggestionState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmbeddedObjectSuggestionState`
        """
        model = EmbeddedObjectSuggestionState()
        if include_optional:
    ...
    def testEmbeddedObjectSuggestionState(self):
        """Test EmbeddedObjectSuggestionState"""
