...
class TestInlineObjectElement(unittest.TestCase):
    """InlineObjectElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineObjectElement:
        """Test InlineObjectElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineObjectElement`
        """
        model = InlineObjectElement()
        if include_optional:
    ...
    def testInlineObjectElement(self):
        """Test InlineObjectElement"""
