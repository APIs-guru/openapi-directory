...
class TestParagraphElement(unittest.TestCase):
    """ParagraphElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParagraphElement:
        """Test ParagraphElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParagraphElement`
        """
