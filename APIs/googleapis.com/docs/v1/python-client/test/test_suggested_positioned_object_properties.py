...
class TestSuggestedPositionedObjectProperties(unittest.TestCase):
    """SuggestedPositionedObjectProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestedPositionedObjectProperties:
        """Test SuggestedPositionedObjectProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedPositionedObjectProperties`
        """
        model = SuggestedPositionedObjectProperties()
        if include_optional:
    ...
    def testSuggestedPositionedObjectProperties(self):
        """Test SuggestedPositionedObjectProperties"""
