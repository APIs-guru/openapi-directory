...
class TestNamedStyles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NamedStyles:
        """Test NamedStyles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedStyles`
        """
        model = NamedStyles()
        if include_optional:
            return NamedStyles(
