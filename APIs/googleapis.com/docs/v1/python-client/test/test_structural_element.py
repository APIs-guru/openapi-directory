...
class TestStructuralElement(unittest.TestCase):
    """StructuralElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructuralElement:
        """Test StructuralElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructuralElement`
        """
    ...
    def testStructuralElement(self):
        """Test StructuralElement"""
