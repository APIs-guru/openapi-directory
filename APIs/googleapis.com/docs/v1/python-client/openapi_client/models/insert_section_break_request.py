...
class InsertSectionBreakRequest(BaseModel):
    ...
    section_type: Optional[StrictStr] = Field(default=None, description="The type of section to insert.", alias="sectionType")
    __properties: ClassVar[List[str]] = ["endOfSegmentLocation", "location", "sectionType"]
