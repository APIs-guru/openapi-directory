...
class NamedRange(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the named range.")
    named_range_id: Optional[StrictStr] = Field(default=None, description="The ID of the named range.", alias="namedRangeId")
    ranges: Optional[List[Range]] = Field(default=None, description="The ranges that belong to this named range.")
    __properties: ClassVar[List[str]] = ["name", "namedRangeId", "ranges"]
