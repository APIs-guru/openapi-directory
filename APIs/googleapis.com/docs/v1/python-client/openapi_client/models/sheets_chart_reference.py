...
class SheetsChartReference(BaseModel):
    ...
    """ # noqa: E501
    chart_id: Optional[StrictInt] = Field(default=None, description="The ID of the specific chart in the Google Sheets spreadsheet that's embedded.", alias="chartId")
    ...
    __properties: ClassVar[List[str]] = ["chartId", "spreadsheetId"]
