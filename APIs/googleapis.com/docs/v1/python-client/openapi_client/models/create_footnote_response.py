...
class CreateFootnoteResponse(BaseModel):
    ...
    """ # noqa: E501
    footnote_id: Optional[StrictStr] = Field(default=None, description="The ID of the created footnote.", alias="footnoteId")
    __properties: ClassVar[List[str]] = ["footnoteId"]
