...
class SuggestedDocumentStyle(BaseModel):
    ...
    document_style_suggestion_state: Optional[DocumentStyleSuggestionState] = Field(default=None, alias="documentStyleSuggestionState")
    __properties: ClassVar[List[str]] = ["documentStyle", "documentStyleSuggestionState"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of document_style_suggestion_state
        if self.document_style_suggestion_state:
            _dict['documentStyleSuggestionState'] = self.document_style_suggestion_state.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentStyleSuggestionState": DocumentStyleSuggestionState.from_dict(obj["documentStyleSuggestionState"]) if obj.get("documentStyleSuggestionState") is not None else None
        })
        return _obj
