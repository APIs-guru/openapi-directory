...
class TableRowStyleSuggestionState(BaseModel):
    ...
    """ # noqa: E501
    min_row_height_suggested: Optional[StrictBool] = Field(default=None, description="Indicates if there was a suggested change to min_row_height.", alias="minRowHeightSuggested")
    __properties: ClassVar[List[str]] = ["minRowHeightSuggested"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minRowHeightSuggested": obj.get("minRowHeightSuggested")
        })
        return _obj
