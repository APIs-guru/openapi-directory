...
class InsertTableRequest(BaseModel):
    ...
    """ # noqa: E501
    columns: Optional[StrictInt] = Field(default=None, description="The number of columns in the table.")
    end_of_segment_location: Optional[EndOfSegmentLocation] = Field(default=None, alias="endOfSegmentLocation")
    location: Optional[Location] = None
    rows: Optional[StrictInt] = Field(default=None, description="The number of rows in the table.")
    __properties: ClassVar[List[str]] = ["columns", "endOfSegmentLocation", "location", "rows"]
