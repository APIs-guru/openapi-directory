...
class Header(BaseModel):
    ...
    A document header.
    """ # noqa: E501
    content: Optional[List[StructuralElement]] = Field(default=None, description="The contents of the header. The indexes for a header's content begin at zero.")
    header_id: Optional[StrictStr] = Field(default=None, description="The ID of the header.", alias="headerId")
    __properties: ClassVar[List[str]] = ["content", "headerId"]
