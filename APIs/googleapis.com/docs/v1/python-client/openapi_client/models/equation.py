...
class Equation(BaseModel):
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. An Equation may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    __properties: ClassVar[List[str]] = ["suggestedDeletionIds", "suggestedInsertionIds"]
