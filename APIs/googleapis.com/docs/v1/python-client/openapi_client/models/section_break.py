...
class SectionBreak(BaseModel):
    ...
    """ # noqa: E501
    section_style: Optional[SectionStyle] = Field(default=None, alias="sectionStyle")
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. A SectionBreak may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    __properties: ClassVar[List[str]] = ["sectionStyle", "suggestedDeletionIds", "suggestedInsertionIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of section_style
        if self.section_style:
            _dict['sectionStyle'] = self.section_style.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sectionStyle": SectionStyle.from_dict(obj["sectionStyle"]) if obj.get("sectionStyle") is not None else None,
