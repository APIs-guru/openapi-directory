...
class CreateNamedRangeResponse(BaseModel):
    ...
    """ # noqa: E501
    named_range_id: Optional[StrictStr] = Field(default=None, description="The ID of the created named range.", alias="namedRangeId")
    __properties: ClassVar[List[str]] = ["namedRangeId"]
