...
class Bullet(BaseModel):
    ...
    """ # noqa: E501
    list_id: Optional[StrictStr] = Field(default=None, description="The ID of the list this paragraph belongs to.", alias="listId")
    nesting_level: Optional[StrictInt] = Field(default=None, description="The nesting level of this paragraph in the list.", alias="nestingLevel")
    text_style: Optional[TextStyle] = Field(default=None, alias="textStyle")
    __properties: ClassVar[List[str]] = ["listId", "nestingLevel", "textStyle"]
