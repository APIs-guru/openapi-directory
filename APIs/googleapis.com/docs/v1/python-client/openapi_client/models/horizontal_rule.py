...
class HorizontalRule(BaseModel):
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. A HorizontalRule may have multiple insertion IDs if it is a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    suggested_text_style_changes: Optional[Dict[str, SuggestedTextStyle]] = Field(default=None, description="The suggested text style changes to this HorizontalRule, keyed by suggestion ID.", alias="suggestedTextStyleChanges")
