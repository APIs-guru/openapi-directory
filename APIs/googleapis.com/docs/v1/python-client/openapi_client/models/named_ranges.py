...
class NamedRanges(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name that all the named ranges share.")
    named_ranges: Optional[List[NamedRange]] = Field(default=None, description="The NamedRanges that share the same name.", alias="namedRanges")
    __properties: ClassVar[List[str]] = ["name", "namedRanges"]
