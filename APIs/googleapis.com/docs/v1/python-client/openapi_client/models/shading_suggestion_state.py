...
class ShadingSuggestionState(BaseModel):
    ...
    """ # noqa: E501
    background_color_suggested: Optional[StrictBool] = Field(default=None, description="Indicates if there was a suggested change to the Shading.", alias="backgroundColorSuggested")
