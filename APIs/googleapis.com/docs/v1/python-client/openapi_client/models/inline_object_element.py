...
class InlineObjectElement(BaseModel):
    ...
    """ # noqa: E501
    inline_object_id: Optional[StrictStr] = Field(default=None, description="The ID of the InlineObject this element contains.", alias="inlineObjectId")
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. An InlineObjectElement may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    suggested_text_style_changes: Optional[Dict[str, SuggestedTextStyle]] = Field(default=None, description="The suggested text style changes to this InlineObject, keyed by suggestion ID.", alias="suggestedTextStyleChanges")
    text_style: Optional[TextStyle] = Field(default=None, alias="textStyle")
    __properties: ClassVar[List[str]] = ["inlineObjectId", "suggestedDeletionIds", "suggestedInsertionIds", "suggestedTextStyleChanges", "textStyle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inlineObjectId": obj.get("inlineObjectId"),
