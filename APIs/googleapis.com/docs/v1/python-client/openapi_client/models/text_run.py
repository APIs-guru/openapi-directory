...
class TextRun(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The text of this run. Any non-text elements in the run are replaced with the Unicode character U+E907.")
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. A TextRun may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    suggested_text_style_changes: Optional[Dict[str, SuggestedTextStyle]] = Field(default=None, description="The suggested text style changes to this run, keyed by suggestion ID.", alias="suggestedTextStyleChanges")
    text_style: Optional[TextStyle] = Field(default=None, alias="textStyle")
    __properties: ClassVar[List[str]] = ["content", "suggestedDeletionIds", "suggestedInsertionIds", "suggestedTextStyleChanges", "textStyle"]
