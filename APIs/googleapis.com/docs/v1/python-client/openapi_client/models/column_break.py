...
class ColumnBreak(BaseModel):
    ...
    suggested_insertion_ids: Optional[List[StrictStr]] = Field(default=None, description="The suggested insertion IDs. A ColumnBreak may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion.", alias="suggestedInsertionIds")
    suggested_text_style_changes: Optional[Dict[str, SuggestedTextStyle]] = Field(default=None, description="The suggested text style changes to this ColumnBreak, keyed by suggestion ID.", alias="suggestedTextStyleChanges")
    text_style: Optional[TextStyle] = Field(default=None, alias="textStyle")
    __properties: ClassVar[List[str]] = ["suggestedDeletionIds", "suggestedInsertionIds", "suggestedTextStyleChanges", "textStyle"]
