...
class TestListTimeSeriesResponse(unittest.TestCase):
    """ListTimeSeriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTimeSeriesResponse:
        """Test ListTimeSeriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTimeSeriesResponse`
        """
        model = ListTimeSeriesResponse()
        if include_optional:
    ...
    def testListTimeSeriesResponse(self):
        """Test ListTimeSeriesResponse"""
