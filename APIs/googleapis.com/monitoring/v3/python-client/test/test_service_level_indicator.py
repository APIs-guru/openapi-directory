...
class TestServiceLevelIndicator(unittest.TestCase):
    """ServiceLevelIndicator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceLevelIndicator:
        """Test ServiceLevelIndicator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceLevelIndicator`
        """
        model = ServiceLevelIndicator()
        if include_optional:
    ...
    def testServiceLevelIndicator(self):
        """Test ServiceLevelIndicator"""
