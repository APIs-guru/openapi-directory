...
class TestListAlertPoliciesResponse(unittest.TestCase):
    """ListAlertPoliciesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAlertPoliciesResponse:
        """Test ListAlertPoliciesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAlertPoliciesResponse`
        """
        model = ListAlertPoliciesResponse()
        if include_optional:
            return ListAlertPoliciesResponse(
                alert_policies = [
                    openapi_client.models.alert_policy.AlertPolicy(
    ...
    def testListAlertPoliciesResponse(self):
        """Test ListAlertPoliciesResponse"""
