...
class TestCollectdPayload(unittest.TestCase):
    """CollectdPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectdPayload:
        """Test CollectdPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectdPayload`
        """
        model = CollectdPayload()
        if include_optional:
