...
class TestCollectdValue(unittest.TestCase):
    """CollectdValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectdValue:
        """Test CollectdValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectdValue`
        """
        model = CollectdValue()
        if include_optional:
