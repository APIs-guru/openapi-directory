...
class TestUptimeCheckConfig(unittest.TestCase):
    """UptimeCheckConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeCheckConfig:
        """Test UptimeCheckConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeCheckConfig`
        """
        model = UptimeCheckConfig()
        if include_optional:
    ...
    def testUptimeCheckConfig(self):
        """Test UptimeCheckConfig"""
