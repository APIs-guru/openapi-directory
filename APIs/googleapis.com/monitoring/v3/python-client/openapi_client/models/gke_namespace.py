...
class GkeNamespace(BaseModel):
    ...
    namespace_name: Optional[StrictStr] = Field(default=None, description="The name of this namespace.", alias="namespaceName")
    ...
    __properties: ClassVar[List[str]] = ["clusterName", "location", "namespaceName", "projectId"]
