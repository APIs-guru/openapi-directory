...
class GkeService(BaseModel):
    ...
    service_name: Optional[StrictStr] = Field(default=None, description="The name of this service.", alias="serviceName")
    __properties: ClassVar[List[str]] = ["clusterName", "location", "namespaceName", "projectId", "serviceName"]
