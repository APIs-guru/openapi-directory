...
class CollectdValueError(BaseModel):
    """
    Describes the error status for values that were not written.
    """ # noqa: E501
    error: Optional[Status] = None
    index: Optional[StrictInt] = Field(default=None, description="The zero-based index in CollectdPayload.values within the parent CreateCollectdTimeSeriesRequest.collectd_payloads.")
