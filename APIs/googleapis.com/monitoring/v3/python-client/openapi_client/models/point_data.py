...
class PointData(BaseModel):
    ...
    values: Optional[List[TypedValue]] = Field(default=None, description="The values that make up the point.")
    __properties: ClassVar[List[str]] = ["timeInterval", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [TypedValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
