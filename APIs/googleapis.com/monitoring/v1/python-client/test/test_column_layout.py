...
class TestColumnLayout(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ColumnLayout:
        """Test ColumnLayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ColumnLayout`
        """
        model = ColumnLayout()
        if include_optional:
            return ColumnLayout(
