...
class TestTableDataSet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TableDataSet:
        """Test TableDataSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableDataSet`
        """
        model = TableDataSet()
        if include_optional:
            return TableDataSet(
