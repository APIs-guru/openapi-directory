...
class TestMosaicLayout(unittest.TestCase):
    """MosaicLayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MosaicLayout:
        """Test MosaicLayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MosaicLayout`
        """
        model = MosaicLayout()
        if include_optional:
            return MosaicLayout(
