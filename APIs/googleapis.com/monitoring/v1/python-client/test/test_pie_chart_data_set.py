...
class TestPieChartDataSet(unittest.TestCase):
    """PieChartDataSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PieChartDataSet:
        """Test PieChartDataSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PieChartDataSet`
        """
        model = PieChartDataSet()
        if include_optional:
