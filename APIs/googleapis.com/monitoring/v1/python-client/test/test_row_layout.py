...
class TestRowLayout(unittest.TestCase):
    """RowLayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RowLayout:
        """Test RowLayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RowLayout`
        """
        model = RowLayout()
        if include_optional:
            return RowLayout(
