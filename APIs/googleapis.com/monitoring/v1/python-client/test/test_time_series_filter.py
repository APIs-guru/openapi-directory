...
class TestTimeSeriesFilter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeSeriesFilter:
        """Test TimeSeriesFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSeriesFilter`
        """
        model = TimeSeriesFilter()
        if include_optional:
