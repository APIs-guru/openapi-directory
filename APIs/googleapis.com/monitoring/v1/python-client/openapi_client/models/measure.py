...
class Measure(BaseModel):
    ...
    column: Optional[StrictStr] = Field(default=None, description="Required. The column name within in the dataset used for the measure.")
    __properties: ClassVar[List[str]] = ["aggregationFunction", "column"]
