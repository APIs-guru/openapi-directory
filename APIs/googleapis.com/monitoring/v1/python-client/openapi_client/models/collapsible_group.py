...
class CollapsibleGroup(BaseModel):
    ...
    """ # noqa: E501
    collapsed: Optional[StrictBool] = Field(default=None, description="The collapsed state of the widget on first page load.")
    __properties: ClassVar[List[str]] = ["collapsed"]
