...
class Parameter(BaseModel):
    ...
    """ # noqa: E501
    double_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A floating-point parameter value.", alias="doubleValue")
    int_value: Optional[StrictStr] = Field(default=None, description="An integer parameter value.", alias="intValue")
    __properties: ClassVar[List[str]] = ["doubleValue", "intValue"]
