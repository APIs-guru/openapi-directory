...
class ListDashboardsResponse(BaseModel):
    ...
    """ # noqa: E501
    dashboards: Optional[List[Dashboard]] = Field(default=None, description="The list of requested dashboards.")
    ...
    __properties: ClassVar[List[str]] = ["dashboards", "nextPageToken"]
