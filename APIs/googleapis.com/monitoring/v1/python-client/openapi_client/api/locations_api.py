...
class LocationsApi:
    ...
    def monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project(
        ...
        monitored_resource_container: Annotated[Optional[StrictStr], Field(description="Required. The resource name of the Monitored Project being requested. Example: projects/{MONITORED_PROJECT_ID_OR_NUMBER}")] = None,
        ...
        :param monitored_resource_container: Required. The resource name of the Monitored Project being requested. Example: projects/{MONITORED_PROJECT_ID_OR_NUMBER}
        :type monitored_resource_container: str
        ...
        _param = self._monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListMetricsScopesByMonitoredProjectResponse",
        }
    ...
    @validate_call
    def monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListMetricsScopesByMonitoredProjectResponse]:
        """monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project
    ...
    @validate_call
    def monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _monitoring_locations_global_metrics_scopes_list_metrics_scopes_by_monitored_project_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if monitored_resource_container is not None:
            
            _query_params.append(('monitoredResourceContainer', monitored_resource_container))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject',
    ...
    def monitoring_locations_global_metrics_scopes_projects_create(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the existing Metrics Scope that will monitor this project. Example: locations/global/metricsScopes/{SCOPING_PROJECT_ID_OR_NUMBER}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        monitored_project: Optional[MonitoredProject] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param monitored_project:
        :type monitored_project: MonitoredProject
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._monitoring_locations_global_metrics_scopes_projects_create_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def monitoring_locations_global_metrics_scopes_projects_create_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the existing Metrics Scope that will monitor this project. Example: locations/global/metricsScopes/{SCOPING_PROJECT_ID_OR_NUMBER}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def monitoring_locations_global_metrics_scopes_projects_create_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the existing Metrics Scope that will monitor this project. Example: locations/global/metricsScopes/{SCOPING_PROJECT_ID_OR_NUMBER}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _monitoring_locations_global_metrics_scopes_projects_create_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        if monitored_project is not None:
            _body_params = monitored_project
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{parent}/projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
