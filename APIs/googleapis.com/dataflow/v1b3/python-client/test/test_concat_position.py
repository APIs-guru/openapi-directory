...
class TestConcatPosition(unittest.TestCase):
    """ConcatPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConcatPosition:
        """Test ConcatPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConcatPosition`
        """
        model = ConcatPosition()
        if include_optional:
