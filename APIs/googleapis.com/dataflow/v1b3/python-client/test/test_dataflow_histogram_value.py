...
class TestDataflowHistogramValue(unittest.TestCase):
    """DataflowHistogramValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataflowHistogramValue:
        """Test DataflowHistogramValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataflowHistogramValue`
        """
        model = DataflowHistogramValue()
        if include_optional:
    ...
    def testDataflowHistogramValue(self):
        """Test DataflowHistogramValue"""
