...
class TestPerStepNamespaceMetrics(unittest.TestCase):
    """PerStepNamespaceMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerStepNamespaceMetrics:
        """Test PerStepNamespaceMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerStepNamespaceMetrics`
        """
        model = PerStepNamespaceMetrics()
        if include_optional:
    ...
    def testPerStepNamespaceMetrics(self):
        """Test PerStepNamespaceMetrics"""
