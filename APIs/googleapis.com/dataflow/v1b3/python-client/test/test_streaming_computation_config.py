...
class TestStreamingComputationConfig(unittest.TestCase):
    """StreamingComputationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingComputationConfig:
        """Test StreamingComputationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingComputationConfig`
        """
        model = StreamingComputationConfig()
        if include_optional:
    ...
    def testStreamingComputationConfig(self):
        """Test StreamingComputationConfig"""
