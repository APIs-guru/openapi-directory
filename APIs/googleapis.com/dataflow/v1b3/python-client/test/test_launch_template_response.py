...
class TestLaunchTemplateResponse(unittest.TestCase):
    """LaunchTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaunchTemplateResponse:
        """Test LaunchTemplateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaunchTemplateResponse`
        """
        model = LaunchTemplateResponse()
        if include_optional:
    ...
    def testLaunchTemplateResponse(self):
        """Test LaunchTemplateResponse"""
