...
class TestLeaseWorkItemResponse(unittest.TestCase):
    """LeaseWorkItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeaseWorkItemResponse:
        """Test LeaseWorkItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeaseWorkItemResponse`
        """
        model = LeaseWorkItemResponse()
        if include_optional:
            return LeaseWorkItemResponse(
                ...
                work_items = [
                    openapi_client.models.work_item.WorkItem(
                        configuration = '', 
                        id = '', 
    ...
    def testLeaseWorkItemResponse(self):
        """Test LeaseWorkItemResponse"""
