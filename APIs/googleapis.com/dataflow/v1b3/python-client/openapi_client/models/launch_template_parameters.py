...
class LaunchTemplateParameters(BaseModel):
    ...
    job_name: Optional[StrictStr] = Field(default=None, description="Required. The job name to use for the created job. The name must match the regular expression `[a-z]([-a-z0-9]{0,1022}[a-z0-9])?`", alias="jobName")
    parameters: Optional[Dict[str, StrictStr]] = Field(default=None, description="The runtime parameters to pass to the job.")
    transform_name_mapping: Optional[Dict[str, StrictStr]] = Field(default=None, description="Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced to the corresponding name prefixes of the new job.", alias="transformNameMapping")
