...
class WorkerThreadScalingReportResponse(BaseModel):
    ...
    """ # noqa: E501
    recommended_thread_count: Optional[StrictInt] = Field(default=None, description="Recommended number of threads for a worker.", alias="recommendedThreadCount")
    __properties: ClassVar[List[str]] = ["recommendedThreadCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recommendedThreadCount": obj.get("recommendedThreadCount")
        })
        return _obj
