...
class IntegerList(BaseModel):
    ...
    """ # noqa: E501
    elements: Optional[List[SplitInt64]] = Field(default=None, description="Elements of the list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [SplitInt64.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
