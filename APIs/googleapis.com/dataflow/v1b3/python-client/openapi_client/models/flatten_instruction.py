...
class FlattenInstruction(BaseModel):
    ...
    """ # noqa: E501
    inputs: Optional[List[InstructionInput]] = Field(default=None, description="Describes the inputs to the flatten instruction.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": [InstructionInput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None
        })
        return _obj
