...
class SeqMapTaskOutputInfo(BaseModel):
    ...
    tag: Optional[StrictStr] = Field(default=None, description="The id of the TupleTag the user code will tag the output value by.")
    __properties: ClassVar[List[str]] = ["sink", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sink": Sink.from_dict(obj["sink"]) if obj.get("sink") is not None else None,
            "tag": obj.get("tag")
        })
        return _obj
