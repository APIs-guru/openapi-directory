...
class CounterStructuredNameAndMetadata(BaseModel):
    ...
    """ # noqa: E501
    metadata: Optional[CounterMetadata] = None
    name: Optional[CounterStructuredName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": CounterMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": CounterStructuredName.from_dict(obj["name"]) if obj.get("name") is not None else None
        })
        return _obj
