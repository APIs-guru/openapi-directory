...
class MultiOutputInfo(BaseModel):
    ...
    """ # noqa: E501
    tag: Optional[StrictStr] = Field(default=None, description="The id of the tag the user code will emit to this output by; this should correspond to the tag of some SideInputInfo.")
