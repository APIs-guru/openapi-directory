...
class ApproximateProgress(BaseModel):
    ...
    """ # noqa: E501
    percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Obsolete.", alias="percentComplete")
    position: Optional[Position] = None
    remaining_time: Optional[StrictStr] = Field(default=None, description="Obsolete.", alias="remainingTime")
    __properties: ClassVar[List[str]] = ["percentComplete", "position", "remainingTime"]
