...
class StragglerDebuggingInfo(BaseModel):
    ...
    """ # noqa: E501
    hot_key: Optional[HotKeyDebuggingInfo] = Field(default=None, alias="hotKey")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.hot_key:
            _dict['hotKey'] = self.hot_key.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hotKey": HotKeyDebuggingInfo.from_dict(obj["hotKey"]) if obj.get("hotKey") is not None else None
        })
        return _obj
