...
class PerStepNamespaceMetrics(BaseModel):
    """
    ...
    """ # noqa: E501
    metric_values: Optional[List[MetricValue]] = Field(default=None, description="Optional. Metrics that are recorded for this namespace and unfused step.", alias="metricValues")
    metrics_namespace: Optional[StrictStr] = Field(default=None, description="The namespace of these metrics on the worker.", alias="metricsNamespace")
    original_step: Optional[StrictStr] = Field(default=None, description="The original system name of the unfused step that these metrics are reported from.", alias="originalStep")
    __properties: ClassVar[List[str]] = ["metricValues", "metricsNamespace", "originalStep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricsNamespace": obj.get("metricsNamespace"),
            "originalStep": obj.get("originalStep")
        })
        return _obj
