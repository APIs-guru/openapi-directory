...
class WorkerThreadScalingReport(BaseModel):
    ...
    """ # noqa: E501
    current_thread_count: Optional[StrictInt] = Field(default=None, description="Current number of active threads in a worker.", alias="currentThreadCount")
    __properties: ClassVar[List[str]] = ["currentThreadCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentThreadCount": obj.get("currentThreadCount")
        })
        return _obj
