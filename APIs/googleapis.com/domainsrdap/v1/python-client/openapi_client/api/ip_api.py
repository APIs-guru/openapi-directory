...
class IpApi:
    ...
    def domainsrdap_ip_get(
        ...
        :param ip_id: (required)
        :type ip_id: str
        :param ip_id1: (required)
        :type ip_id1: str
        ...
        _param = self._domainsrdap_ip_get_serialize(
            ip_id=ip_id,
            ip_id1=ip_id1,
            xgafv=xgafv,
    ...
    @validate_call
    def domainsrdap_ip_get_with_http_info(
        self,
        ip_id: StrictStr,
        ip_id1: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def domainsrdap_ip_get_without_preload_content(
        self,
        ip_id: StrictStr,
        ip_id1: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _domainsrdap_ip_get_serialize(
        self,
        ip_id,
        ip_id1,
        xgafv,
        ...
        if ip_id1 is not None:
            _path_params['ipId1'] = ip_id1
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/ip/{ipId}/{ipId1}',
