...
class EntityApi:
    ...
    def domainsrdap_entity_get(
        ...
        _param = self._domainsrdap_entity_get_serialize(
            entity_id=entity_id,
            xgafv=xgafv,
    ...
    @validate_call
    def domainsrdap_entity_get_with_http_info(
        self,
        entity_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def domainsrdap_entity_get_without_preload_content(
        self,
        entity_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _domainsrdap_entity_get_serialize(
        self,
        entity_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/entity/{entityId}',
