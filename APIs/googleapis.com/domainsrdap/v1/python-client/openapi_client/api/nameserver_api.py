...
class NameserverApi:
    ...
    def domainsrdap_nameserver_get(
        ...
        :param nameserver_id: (required)
        :type nameserver_id: str
        ...
        _param = self._domainsrdap_nameserver_get_serialize(
    ...
    @validate_call
    def domainsrdap_nameserver_get_with_http_info(
        self,
        nameserver_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def domainsrdap_nameserver_get_without_preload_content(
        self,
        nameserver_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _domainsrdap_nameserver_get_serialize(
        self,
        nameserver_id,
        xgafv,
        access_token,
        ...
        if nameserver_id is not None:
            _path_params['nameserverId'] = nameserver_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/nameserver/{nameserverId}',
