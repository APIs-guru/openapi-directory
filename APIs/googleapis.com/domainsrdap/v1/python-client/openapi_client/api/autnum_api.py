...
class AutnumApi:
    ...
    def domainsrdap_autnum_get(
        ...
        """domainsrdap_autnum_get

        The RDAP API recognizes this command from the RDAP specification but does not support it. The response is a formatted 501 error.

        :param autnum_id: (required)
        :type autnum_id: str
        ...
        _param = self._domainsrdap_autnum_get_serialize(
            autnum_id=autnum_id,
            xgafv=xgafv,
    ...
    @validate_call
    def domainsrdap_autnum_get_with_http_info(
        self,
        autnum_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def domainsrdap_autnum_get_without_preload_content(
        self,
        autnum_id: StrictStr,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _domainsrdap_autnum_get_serialize(
        self,
        autnum_id,
        xgafv,
        access_token,
        ...
        if autnum_id is not None:
            _path_params['autnumId'] = autnum_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/autnum/{autnumId}',
