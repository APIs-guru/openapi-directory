...
class OperationsApi:
    ...
    def cloudprivatecatalogproducer_operations_cancel(
        ...
        _param = self._cloudprivatecatalogproducer_operations_cancel_serialize(
            name=name,
            alt=alt,
            key=key,
    ...
    @validate_call
    def cloudprivatecatalogproducer_operations_cancel_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def cloudprivatecatalogproducer_operations_cancel_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _cloudprivatecatalogproducer_operations_cancel_serialize(
        self,
        name,
        alt,
        key,
    ...
    def cloudprivatecatalogproducer_operations_list(
        ...
        _param = self._cloudprivatecatalogproducer_operations_list_serialize(
            alt=alt,
            key=key,
            access_token=access_token,
            upload_protocol=upload_protocol,
    ...
    @validate_call
    def cloudprivatecatalogproducer_operations_list_with_http_info(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudprivatecatalogproducer_operations_list_without_preload_content(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudprivatecatalogproducer_operations_list_serialize(
        self,
        alt,
        key,
        access_token,
