...
class GoogleCloudPrivatecatalogproducerV1beta1CreateAssociationRequest(BaseModel):
    ...
    """ # noqa: E501
    association: Optional[GoogleCloudPrivatecatalogproducerV1beta1Association] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association": GoogleCloudPrivatecatalogproducerV1beta1Association.from_dict(obj["association"]) if obj.get("association") is not None else None
        })
        return _obj
