...
class GoogleCloudPrivatecatalogproducerV1beta1ListVersionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token returned from a previous call to ListProducts that indicates where the listing should continue from. This field is optional.", alias="nextPageToken")
    versions: Optional[List[GoogleCloudPrivatecatalogproducerV1beta1Version]] = Field(default=None, description="The `VersiVersionon` returned from the list call.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [GoogleCloudPrivatecatalogproducerV1beta1Version.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
