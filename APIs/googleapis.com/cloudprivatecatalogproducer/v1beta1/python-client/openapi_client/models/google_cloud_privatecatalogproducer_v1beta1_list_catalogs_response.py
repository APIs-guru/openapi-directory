...
class GoogleCloudPrivatecatalogproducerV1beta1ListCatalogsResponse(BaseModel):
    ...
    """ # noqa: E501
    catalogs: Optional[List[GoogleCloudPrivatecatalogproducerV1beta1Catalog]] = Field(default=None, description="The `Catalogs` returned from the list call.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A pagination token returned from a previous call to ListCatalogs that indicates where the listing should continue from. This field is optional.", alias="nextPageToken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalogs": [GoogleCloudPrivatecatalogproducerV1beta1Catalog.from_dict(_item) for _item in obj["catalogs"]] if obj.get("catalogs") is not None else None,
