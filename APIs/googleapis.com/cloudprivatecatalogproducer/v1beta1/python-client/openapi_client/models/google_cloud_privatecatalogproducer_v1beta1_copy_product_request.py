...
class GoogleCloudPrivatecatalogproducerV1beta1CopyProductRequest(BaseModel):
    ...
    """ # noqa: E501
    destination_product_name: Optional[StrictStr] = Field(default=None, description="The resource name of the destination product that is copied to.", alias="destinationProductName")
    __properties: ClassVar[List[str]] = ["destinationProductName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destinationProductName": obj.get("destinationProductName")
        })
        return _obj
