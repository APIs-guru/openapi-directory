...
class GoogleCloudPrivatecatalogproducerV1beta1ListProductsResponse(BaseModel):
    ...
    products: Optional[List[GoogleCloudPrivatecatalogproducerV1beta1Product]] = Field(default=None, description="The `Product` returned from the list call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [GoogleCloudPrivatecatalogproducerV1beta1Product.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
