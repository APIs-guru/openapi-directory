...
class ListDataSourcesResponse(BaseModel):
    ...
    """ # noqa: E501
    data_source: Optional[List[DataSource]] = Field(default=None, description="A previously created data source.", alias="dataSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataSource": [DataSource.from_dict(_item) for _item in obj["dataSource"]] if obj.get("dataSource") is not None else None
        })
        return _obj
