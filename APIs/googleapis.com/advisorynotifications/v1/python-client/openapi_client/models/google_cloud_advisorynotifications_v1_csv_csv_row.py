...
class GoogleCloudAdvisorynotificationsV1CsvCsvRow(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[StrictStr]] = Field(default=None, description="The data entries in a CSV file row, as a string array rather than a single comma-separated string.")
