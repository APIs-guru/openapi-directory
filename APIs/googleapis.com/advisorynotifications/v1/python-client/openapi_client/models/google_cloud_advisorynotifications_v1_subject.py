...
class GoogleCloudAdvisorynotificationsV1Subject(BaseModel):
    ...
    """ # noqa: E501
    text: Optional[GoogleCloudAdvisorynotificationsV1Text] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": GoogleCloudAdvisorynotificationsV1Text.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
