...
class GoogleCloudAdvisorynotificationsV1Attachment(BaseModel):
    ...
    """ # noqa: E501
    csv: Optional[GoogleCloudAdvisorynotificationsV1Csv] = None
    display_name: Optional[StrictStr] = Field(default=None, description="The title of the attachment.", alias="displayName")
    __properties: ClassVar[List[str]] = ["csv", "displayName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "csv": GoogleCloudAdvisorynotificationsV1Csv.from_dict(obj["csv"]) if obj.get("csv") is not None else None,
