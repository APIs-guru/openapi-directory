...
class GoogleCloudAdvisorynotificationsV1ListNotificationsResponse(BaseModel):
    ...
    notifications: Optional[List[GoogleCloudAdvisorynotificationsV1Notification]] = Field(default=None, description="List of notifications under a given parent.")
    total_size: Optional[StrictInt] = Field(default=None, description="Estimation of a total number of notifications.", alias="totalSize")
    __properties: ClassVar[List[str]] = ["nextPageToken", "notifications", "totalSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifications": [GoogleCloudAdvisorynotificationsV1Notification.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None,
