...
class GoogleCloudAdvisorynotificationsV1NotificationSettings(BaseModel):
    """
    Settings for each NotificationType.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the associated NotificationType is enabled.")
