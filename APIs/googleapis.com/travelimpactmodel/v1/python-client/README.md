...
------------ | ------------- | ------------- | -------------
*FlightsApi* | [**travelimpactmodel_flights_compute_flight_emissions**](docs/FlightsApi.md#travelimpactmodel_flights_compute_flight_emissions) | **POST** /v1/flights:computeFlightEmissions | 


## Documentation For Models

 - [ComputeFlightEmissionsRequest](docs/ComputeFlightEmissionsRequest.md)
 - [ComputeFlightEmissionsResponse](docs/ComputeFlightEmissionsResponse.md)
 - [EmissionsGramsPerPax](docs/EmissionsGramsPerPax.md)
 - [Flight](docs/Flight.md)
 - [FlightWithEmissions](docs/FlightWithEmissions.md)
