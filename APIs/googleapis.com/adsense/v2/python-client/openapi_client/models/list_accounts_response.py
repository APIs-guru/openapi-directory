...
class ListAccountsResponse(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[Account]] = Field(default=None, description="The accounts returned in this list response.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Continuation token used to page through accounts. To retrieve the next page of the results, set the next request's \"page_token\" value to this.", alias="nextPageToken")
