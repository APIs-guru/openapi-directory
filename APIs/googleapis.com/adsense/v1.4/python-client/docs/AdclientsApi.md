...
------------- | ------------- | -------------
[**adsense_adclients_list**](AdclientsApi.md#adsense_adclients_list) | **GET** /adclients | 


# **adsense_adclients_list**
> AdClients adsense_adclients_list(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.adsense_adclients_list(alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
        print("The response of AdclientsApi->adsense_adclients_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdclientsApi->adsense_adclients_list: %s\n" % e)
```
