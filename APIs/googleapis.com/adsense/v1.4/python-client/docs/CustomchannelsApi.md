...
------------- | ------------- | -------------
[**adsense_customchannels_adunits_list**](CustomchannelsApi.md#adsense_customchannels_adunits_list) | **GET** /adclients/{adClientId}/customchannels/{customChannelId}/adunits | 
[**adsense_customchannels_get**](CustomchannelsApi.md#adsense_customchannels_get) | **GET** /adclients/{adClientId}/customchannels/{customChannelId} | 
[**adsense_customchannels_list**](CustomchannelsApi.md#adsense_customchannels_list) | **GET** /adclients/{adClientId}/customchannels | 


# **adsense_customchannels_adunits_list**
> AdUnits adsense_customchannels_adunits_list(ad_client_id, custom_channel_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, include_inactive=include_inactive, max_results=max_results, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.adsense_customchannels_adunits_list(ad_client_id, custom_channel_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, include_inactive=include_inactive, max_results=max_results, page_token=page_token)
        print("The response of CustomchannelsApi->adsense_customchannels_adunits_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomchannelsApi->adsense_customchannels_adunits_list: %s\n" % e)
```
...
> CustomChannel adsense_customchannels_get(ad_client_id, custom_channel_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.adsense_customchannels_get(ad_client_id, custom_channel_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip)
        print("The response of CustomchannelsApi->adsense_customchannels_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomchannelsApi->adsense_customchannels_get: %s\n" % e)
```
...
> CustomChannels adsense_customchannels_list(ad_client_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.adsense_customchannels_list(ad_client_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
        print("The response of CustomchannelsApi->adsense_customchannels_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomchannelsApi->adsense_customchannels_list: %s\n" % e)
```
