...
------------- | ------------- | -------------
[**adsense_urlchannels_list**](UrlchannelsApi.md#adsense_urlchannels_list) | **GET** /adclients/{adClientId}/urlchannels | 


# **adsense_urlchannels_list**
> UrlChannels adsense_urlchannels_list(ad_client_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.adsense_urlchannels_list(ad_client_id, alt=alt, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, user_ip=user_ip, max_results=max_results, page_token=page_token)
        print("The response of UrlchannelsApi->adsense_urlchannels_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UrlchannelsApi->adsense_urlchannels_list: %s\n" % e)
```
