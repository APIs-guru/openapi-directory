...
class ExistingDisk(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="The name of the Persistent Disk resource. The Persistent Disk resource must be in the same zone as the Pool.")
    __properties: ClassVar[List[str]] = ["attachment", "source"]
