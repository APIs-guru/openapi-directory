...
class EnvVariable(BaseModel):
    ...
    """ # noqa: E501
    hidden: Optional[StrictBool] = Field(default=None, description="Deprecated, do not use.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the environment variable.")
    value: Optional[StrictStr] = Field(default=None, description="The value of the variable.")
    __properties: ClassVar[List[str]] = ["hidden", "name", "value"]
