...
class Replica(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="[Output Only] The name of the Replica object.")
    self_link: Optional[StrictStr] = Field(default=None, description="[Output Only] The self-link of the Replica.", alias="selfLink")
    status: Optional[ReplicaStatus] = None
    __properties: ClassVar[List[str]] = ["name", "selfLink", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": ReplicaStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
