...
class OperationsApi:
    ...
    def cloudshell_operations_cancel(
        ...
        _param = self._cloudshell_operations_cancel_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def cloudshell_operations_cancel_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudshell_operations_cancel_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be cancelled.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudshell_operations_cancel_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def cloudshell_operations_delete(
        ...
        _param = self._cloudshell_operations_delete_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def cloudshell_operations_delete_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be deleted.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudshell_operations_delete_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation resource to be deleted.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudshell_operations_delete_serialize(
        self,
        name,
        xgafv,
        access_token,
