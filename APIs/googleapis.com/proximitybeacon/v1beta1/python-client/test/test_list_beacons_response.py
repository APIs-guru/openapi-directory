...
class TestListBeaconsResponse(unittest.TestCase):
    """ListBeaconsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBeaconsResponse:
        """Test ListBeaconsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBeaconsResponse`
        """
        model = ListBeaconsResponse()
        if include_optional:
            return ListBeaconsResponse(
                beacons = [
                    openapi_client.models.beacon.Beacon(
    ...
    def testListBeaconsResponse(self):
        """Test ListBeaconsResponse"""
