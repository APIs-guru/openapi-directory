...
**time_zone** | [**GoogleTypeTimeZone**](GoogleTypeTimeZone.md) |  | [optional] 
...
google_type_date_time_instance = GoogleTypeDateTime.from_json(json)
# print the JSON string representation of the object
print(GoogleTypeDateTime.to_json())

# convert the object into a dict
google_type_date_time_dict = google_type_date_time_instance.to_dict()
# create an instance of GoogleTypeDateTime from a dict
google_type_date_time_from_dict = GoogleTypeDateTime.from_dict(google_type_date_time_dict)
```
