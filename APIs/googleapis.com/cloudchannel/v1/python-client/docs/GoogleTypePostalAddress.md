...
google_type_postal_address_instance = GoogleTypePostalAddress.from_json(json)
# print the JSON string representation of the object
print(GoogleTypePostalAddress.to_json())

# convert the object into a dict
google_type_postal_address_dict = google_type_postal_address_instance.to_dict()
# create an instance of GoogleTypePostalAddress from a dict
google_type_postal_address_from_dict = GoogleTypePostalAddress.from_dict(google_type_postal_address_dict)
```
