...
class GoogleCloudChannelV1UnregisterSubscriberRequest(BaseModel):
    ...
    """ # noqa: E501
    service_account: Optional[StrictStr] = Field(default=None, description="Required. Service account to unregister from subscriber access to the topic.", alias="serviceAccount")
