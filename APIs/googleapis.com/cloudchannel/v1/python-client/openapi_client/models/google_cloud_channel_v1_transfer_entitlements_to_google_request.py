...
class GoogleCloudChannelV1TransferEntitlementsToGoogleRequest(BaseModel):
    ...
    """ # noqa: E501
    entitlements: Optional[List[GoogleCloudChannelV1Entitlement]] = Field(default=None, description="Required. The entitlements to transfer to Google.")
    ...
    __properties: ClassVar[List[str]] = ["entitlements", "requestId"]
