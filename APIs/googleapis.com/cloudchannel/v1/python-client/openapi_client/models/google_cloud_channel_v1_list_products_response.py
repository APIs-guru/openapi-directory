...
class GoogleCloudChannelV1ListProductsResponse(BaseModel):
    ...
    products: Optional[List[GoogleCloudChannelV1Product]] = Field(default=None, description="List of Products requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [GoogleCloudChannelV1Product.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
