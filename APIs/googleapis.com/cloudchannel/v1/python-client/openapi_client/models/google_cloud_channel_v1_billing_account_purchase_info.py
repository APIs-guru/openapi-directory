...
class GoogleCloudChannelV1BillingAccountPurchaseInfo(BaseModel):
    """
    Represents a billing account that can be used to make a purchase.
    """ # noqa: E501
    billing_account: Optional[GoogleCloudChannelV1BillingAccount] = Field(default=None, alias="billingAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billingAccount": GoogleCloudChannelV1BillingAccount.from_dict(obj["billingAccount"]) if obj.get("billingAccount") is not None else None
        })
        return _obj
