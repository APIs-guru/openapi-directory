...
class GoogleCloudChannelV1Product(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Resource Name of the Product. Format: products/{product_id}")
    __properties: ClassVar[List[str]] = ["marketingInfo", "name"]
