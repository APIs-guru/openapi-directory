...
class GoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest(BaseModel):
    ...
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Required. Domain to fetch for Cloud Identity account customers, including domained and domainless.")
