...
class GoogleCloudChannelV1RunReportJobRequest(BaseModel):
    ...
    language_code: Optional[StrictStr] = Field(default=None, description="Optional. The BCP-47 language code, such as \"en-US\". If specified, the response is localized to the corresponding language code if the original data sources support it. Default is \"en-US\".", alias="languageCode")
    __properties: ClassVar[List[str]] = ["dateRange", "filter", "languageCode"]
