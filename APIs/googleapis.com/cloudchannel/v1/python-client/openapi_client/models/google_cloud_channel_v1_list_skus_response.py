...
class GoogleCloudChannelV1ListSkusResponse(BaseModel):
    ...
    skus: Optional[List[GoogleCloudChannelV1Sku]] = Field(default=None, description="The list of SKUs requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skus": [GoogleCloudChannelV1Sku.from_dict(_item) for _item in obj["skus"]] if obj.get("skus") is not None else None
        })
        return _obj
