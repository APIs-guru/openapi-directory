...
class GoogleCloudChannelV1ChangeParametersRequest(BaseModel):
    ...
    """ # noqa: E501
    parameters: Optional[List[GoogleCloudChannelV1Parameter]] = Field(default=None, description="Required. Entitlement parameters to update. You can only change editable parameters. To view the available Parameters for a request, refer to the Offer.parameter_definitions from the desired offer.")
    ...
    __properties: ClassVar[List[str]] = ["parameters", "purchaseOrderId", "requestId"]
