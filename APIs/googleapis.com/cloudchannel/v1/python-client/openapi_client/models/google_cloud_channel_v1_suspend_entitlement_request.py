...
class GoogleCloudChannelV1SuspendEntitlementRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudChannelV1SuspendEntitlementRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudChannelV1SuspendEntitlementRequest from a dict"""
        if obj is None:
            return None
