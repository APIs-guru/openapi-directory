...
class GoogleCloudChannelV1Sku(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Resource Name of the SKU. Format: products/{product_id}/skus/{sku_id}")
    product: Optional[GoogleCloudChannelV1Product] = None
    __properties: ClassVar[List[str]] = ["marketingInfo", "name", "product"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "product": GoogleCloudChannelV1Product.from_dict(obj["product"]) if obj.get("product") is not None else None
        })
        return _obj
