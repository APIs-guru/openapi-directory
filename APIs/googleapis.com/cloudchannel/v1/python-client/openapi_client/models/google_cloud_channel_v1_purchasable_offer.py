...
class GoogleCloudChannelV1PurchasableOffer(BaseModel):
    ...
    """ # noqa: E501
    offer: Optional[GoogleCloudChannelV1Offer] = None
    __properties: ClassVar[List[str]] = ["offer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offer": GoogleCloudChannelV1Offer.from_dict(obj["offer"]) if obj.get("offer") is not None else None
        })
        return _obj
