...
class GoogleCloudChannelV1CreateEntitlementRequest(BaseModel):
    ...
    """ # noqa: E501
    entitlement: Optional[GoogleCloudChannelV1Entitlement] = None
    ...
    __properties: ClassVar[List[str]] = ["entitlement", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlement": GoogleCloudChannelV1Entitlement.from_dict(obj["entitlement"]) if obj.get("entitlement") is not None else None,
