...
class GoogleCloudChannelV1ChangeRenewalSettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    renewal_settings: Optional[GoogleCloudChannelV1RenewalSettings] = Field(default=None, alias="renewalSettings")
    ...
    __properties: ClassVar[List[str]] = ["renewalSettings", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "renewalSettings": GoogleCloudChannelV1RenewalSettings.from_dict(obj["renewalSettings"]) if obj.get("renewalSettings") is not None else None,
