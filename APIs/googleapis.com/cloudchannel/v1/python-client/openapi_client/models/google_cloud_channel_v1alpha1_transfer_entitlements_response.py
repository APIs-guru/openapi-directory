...
class GoogleCloudChannelV1alpha1TransferEntitlementsResponse(BaseModel):
    ...
    """ # noqa: E501
    entitlements: Optional[List[GoogleCloudChannelV1alpha1Entitlement]] = Field(default=None, description="The transferred entitlements.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlements": [GoogleCloudChannelV1alpha1Entitlement.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None
        })
        return _obj
