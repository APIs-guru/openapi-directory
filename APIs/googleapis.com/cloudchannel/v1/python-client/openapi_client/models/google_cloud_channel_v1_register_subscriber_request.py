...
class GoogleCloudChannelV1RegisterSubscriberRequest(BaseModel):
    ...
    """ # noqa: E501
    service_account: Optional[StrictStr] = Field(default=None, description="Required. Service account that provides subscriber access to the registered topic.", alias="serviceAccount")
