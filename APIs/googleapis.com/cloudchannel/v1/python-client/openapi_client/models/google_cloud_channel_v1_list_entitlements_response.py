...
class GoogleCloudChannelV1ListEntitlementsResponse(BaseModel):
    ...
    """ # noqa: E501
    entitlements: Optional[List[GoogleCloudChannelV1Entitlement]] = Field(default=None, description="The reseller customer's entitlements.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to list the next page of results. Pass to ListEntitlementsRequest.page_token to obtain that page.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["entitlements", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlements": [GoogleCloudChannelV1Entitlement.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None,
