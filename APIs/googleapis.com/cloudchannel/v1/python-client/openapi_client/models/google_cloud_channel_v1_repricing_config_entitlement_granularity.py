...
class GoogleCloudChannelV1RepricingConfigEntitlementGranularity(BaseModel):
    ...
    """ # noqa: E501
    entitlement: Optional[StrictStr] = Field(default=None, description="Resource name of the entitlement. Format: accounts/{account_id}/customers/{customer_id}/entitlements/{entitlement_id}")
