...
class GoogleCloudChannelV1ListOffersResponse(BaseModel):
    ...
    offers: Optional[List[GoogleCloudChannelV1Offer]] = Field(default=None, description="The list of Offers requested.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "offers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offers": [GoogleCloudChannelV1Offer.from_dict(_item) for _item in obj["offers"]] if obj.get("offers") is not None else None
        })
        return _obj
