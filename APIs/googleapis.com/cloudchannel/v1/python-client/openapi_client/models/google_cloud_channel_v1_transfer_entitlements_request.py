...
class GoogleCloudChannelV1TransferEntitlementsRequest(BaseModel):
    ...
    """ # noqa: E501
    auth_token: Optional[StrictStr] = Field(default=None, description="The super admin of the resold customer generates this token to authorize a reseller to access their Cloud Identity and purchase entitlements on their behalf. You can omit this token after authorization. See https://support.google.com/a/answer/7643790 for more details.", alias="authToken")
    entitlements: Optional[List[GoogleCloudChannelV1Entitlement]] = Field(default=None, description="Required. The new entitlements to create or transfer.")
    ...
    __properties: ClassVar[List[str]] = ["authToken", "entitlements", "requestId"]
