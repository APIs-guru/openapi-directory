...
class ProductsApi:
    ...
    def cloudchannel_products_list(
        ...
        account: Annotated[Optional[StrictStr], Field(description="Required. The resource name of the reseller account. Format: accounts/{account_id}.")] = None,
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The BCP-47 language code. For example, \"en-US\". The response will localize in the corresponding language code, if specified. The default value is \"en-US\".")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. Requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 Products. The maximum value is 1000; the server will coerce values above 1000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. A token for a page of results other than the first page.")] = None,
        ...
        _param = self._cloudchannel_products_list_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudChannelV1ListProductsResponse",
        }
    ...
    @validate_call
    def cloudchannel_products_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def cloudchannel_products_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudchannel_products_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
    ...
    def cloudchannel_products_skus_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the Product to list SKUs for. Parent uses the format: products/{product_id}. Supports products/- to retrieve SKUs for all products.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        account: Annotated[Optional[StrictStr], Field(description="Required. Resource name of the reseller. Format: accounts/{account_id}.")] = None,
        language_code: Annotated[Optional[StrictStr], Field(description="Optional. The BCP-47 language code. For example, \"en-US\". The response will localize in the corresponding language code, if specified. The default value is \"en-US\".")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. Requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 SKUs. The maximum value is 1000; the server will coerce values above 1000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. A token for a page of results other than the first page. Optional.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._cloudchannel_products_skus_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudChannelV1ListSkusResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def cloudchannel_products_skus_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the Product to list SKUs for. Parent uses the format: products/{product_id}. Supports products/- to retrieve SKUs for all products.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudchannel_products_skus_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The resource name of the Product to list SKUs for. Parent uses the format: products/{product_id}. Supports products/- to retrieve SKUs for all products.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudchannel_products_skus_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
