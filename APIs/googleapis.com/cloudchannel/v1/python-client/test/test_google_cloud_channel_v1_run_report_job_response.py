...
class TestGoogleCloudChannelV1RunReportJobResponse(unittest.TestCase):
    """GoogleCloudChannelV1RunReportJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1RunReportJobResponse:
        """Test GoogleCloudChannelV1RunReportJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1RunReportJobResponse`
        """
        model = GoogleCloudChannelV1RunReportJobResponse()
        if include_optional:
            return GoogleCloudChannelV1RunReportJobResponse(
                report_job = openapi_client.models.google_cloud_channel_v1_report_job.GoogleCloudChannelV1ReportJob(
                    name = '', 
    ...
    def testGoogleCloudChannelV1RunReportJobResponse(self):
        """Test GoogleCloudChannelV1RunReportJobResponse"""
