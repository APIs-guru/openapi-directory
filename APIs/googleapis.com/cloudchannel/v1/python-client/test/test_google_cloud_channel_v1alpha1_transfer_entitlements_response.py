...
class TestGoogleCloudChannelV1alpha1TransferEntitlementsResponse(unittest.TestCase):
    """GoogleCloudChannelV1alpha1TransferEntitlementsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1alpha1TransferEntitlementsResponse:
        """Test GoogleCloudChannelV1alpha1TransferEntitlementsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1alpha1TransferEntitlementsResponse`
        """
        model = GoogleCloudChannelV1alpha1TransferEntitlementsResponse()
        if include_optional:
            return GoogleCloudChannelV1alpha1TransferEntitlementsResponse(
                entitlements = [
                    openapi_client.models.google_cloud_channel_v1alpha1_entitlement.GoogleCloudChannelV1alpha1Entitlement(
                        assigned_units = 56, 
    ...
    def testGoogleCloudChannelV1alpha1TransferEntitlementsResponse(self):
        """Test GoogleCloudChannelV1alpha1TransferEntitlementsResponse"""
