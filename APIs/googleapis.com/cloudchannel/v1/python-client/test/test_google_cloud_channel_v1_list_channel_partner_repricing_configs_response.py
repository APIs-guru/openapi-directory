...
class TestGoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse(unittest.TestCase):
    """GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse:
        """Test GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse`
        """
        model = GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse()
        if include_optional:
            return GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse(
                channel_partner_repricing_configs = [
                    openapi_client.models.google_cloud_channel_v1_channel_partner_repricing_config.GoogleCloudChannelV1ChannelPartnerRepricingConfig(
                        name = '', 
    ...
    def testGoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse(self):
        """Test GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse"""
