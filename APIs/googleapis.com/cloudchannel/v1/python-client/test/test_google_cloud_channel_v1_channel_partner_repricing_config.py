...
class TestGoogleCloudChannelV1ChannelPartnerRepricingConfig(unittest.TestCase):
    """GoogleCloudChannelV1ChannelPartnerRepricingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1ChannelPartnerRepricingConfig:
        """Test GoogleCloudChannelV1ChannelPartnerRepricingConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1ChannelPartnerRepricingConfig`
        """
        model = GoogleCloudChannelV1ChannelPartnerRepricingConfig()
        if include_optional:
    ...
    def testGoogleCloudChannelV1ChannelPartnerRepricingConfig(self):
        """Test GoogleCloudChannelV1ChannelPartnerRepricingConfig"""
