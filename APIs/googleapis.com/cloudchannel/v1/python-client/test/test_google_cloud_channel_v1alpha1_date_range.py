...
class TestGoogleCloudChannelV1alpha1DateRange(unittest.TestCase):
    """GoogleCloudChannelV1alpha1DateRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1alpha1DateRange:
        """Test GoogleCloudChannelV1alpha1DateRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1alpha1DateRange`
        """
        model = GoogleCloudChannelV1alpha1DateRange()
        if include_optional:
    ...
    def testGoogleCloudChannelV1alpha1DateRange(self):
        """Test GoogleCloudChannelV1alpha1DateRange"""
