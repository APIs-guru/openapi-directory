...
class TestGoogleCloudChannelV1ReportResultsMetadata(unittest.TestCase):
    """GoogleCloudChannelV1ReportResultsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1ReportResultsMetadata:
        """Test GoogleCloudChannelV1ReportResultsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1ReportResultsMetadata`
        """
        model = GoogleCloudChannelV1ReportResultsMetadata()
        if include_optional:
    ...
    def testGoogleCloudChannelV1ReportResultsMetadata(self):
        """Test GoogleCloudChannelV1ReportResultsMetadata"""
