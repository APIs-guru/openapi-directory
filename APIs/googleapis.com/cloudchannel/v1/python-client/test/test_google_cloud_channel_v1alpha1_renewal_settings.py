...
class TestGoogleCloudChannelV1alpha1RenewalSettings(unittest.TestCase):
    """GoogleCloudChannelV1alpha1RenewalSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1alpha1RenewalSettings:
        """Test GoogleCloudChannelV1alpha1RenewalSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1alpha1RenewalSettings`
        """
        model = GoogleCloudChannelV1alpha1RenewalSettings()
        if include_optional:
    ...
    def testGoogleCloudChannelV1alpha1RenewalSettings(self):
        """Test GoogleCloudChannelV1alpha1RenewalSettings"""
