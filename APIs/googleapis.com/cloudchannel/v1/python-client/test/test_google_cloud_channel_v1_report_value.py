...
class TestGoogleCloudChannelV1ReportValue(unittest.TestCase):
    """GoogleCloudChannelV1ReportValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1ReportValue:
        """Test GoogleCloudChannelV1ReportValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1ReportValue`
        """
        model = GoogleCloudChannelV1ReportValue()
        if include_optional:
    ...
    def testGoogleCloudChannelV1ReportValue(self):
        """Test GoogleCloudChannelV1ReportValue"""
