...
class TestGoogleCloudChannelV1CustomerRepricingConfig(unittest.TestCase):
    """GoogleCloudChannelV1CustomerRepricingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudChannelV1CustomerRepricingConfig:
        """Test GoogleCloudChannelV1CustomerRepricingConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudChannelV1CustomerRepricingConfig`
        """
        model = GoogleCloudChannelV1CustomerRepricingConfig()
        if include_optional:
    ...
    def testGoogleCloudChannelV1CustomerRepricingConfig(self):
        """Test GoogleCloudChannelV1CustomerRepricingConfig"""
