...
class TaskGroupStatus(BaseModel):
    ...
    """ # noqa: E501
    counts: Optional[Dict[str, StrictStr]] = Field(default=None, description="Count of task in each state in the TaskGroup. The map key is task state name.")
    instances: Optional[List[InstanceStatus]] = Field(default=None, description="Status of instances allocated for the TaskGroup.")
    __properties: ClassVar[List[str]] = ["counts", "instances"]
