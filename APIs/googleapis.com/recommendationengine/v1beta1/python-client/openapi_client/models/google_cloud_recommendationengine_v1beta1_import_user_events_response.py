...
class GoogleCloudRecommendationengineV1beta1ImportUserEventsResponse(BaseModel):
    ...
    import_summary: Optional[GoogleCloudRecommendationengineV1beta1UserEventImportSummary] = Field(default=None, alias="importSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "importSummary": GoogleCloudRecommendationengineV1beta1UserEventImportSummary.from_dict(obj["importSummary"]) if obj.get("importSummary") is not None else None
        })
        return _obj
