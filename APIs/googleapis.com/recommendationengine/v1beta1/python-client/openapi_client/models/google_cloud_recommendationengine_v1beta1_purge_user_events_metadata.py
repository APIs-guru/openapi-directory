...
class GoogleCloudRecommendationengineV1beta1PurgeUserEventsMetadata(BaseModel):
    ...
    operation_name: Optional[StrictStr] = Field(default=None, description="The ID of the request / operation.", alias="operationName")
    __properties: ClassVar[List[str]] = ["createTime", "operationName"]
