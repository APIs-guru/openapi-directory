...
class ListPackagesResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token to retrieve the next page of packages, or empty if there are no more packages to return.", alias="nextPageToken")
    packages: Optional[List[Package]] = Field(default=None, description="The packages returned.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "packages"]
