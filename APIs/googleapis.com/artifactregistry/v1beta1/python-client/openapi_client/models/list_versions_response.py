...
class ListVersionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token to retrieve the next page of versions, or empty if there are no more versions to return.", alias="nextPageToken")
    versions: Optional[List[Version]] = Field(default=None, description="The versions returned.")
