...
class ImportAptArtifactsErrorInfo(BaseModel):
    ...
    gcs_source: Optional[ImportAptArtifactsGcsSource] = Field(default=None, alias="gcsSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsSource": ImportAptArtifactsGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None
        })
        return _obj
