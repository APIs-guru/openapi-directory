...
class YumArtifact(BaseModel):
    ...
    package_name: Optional[StrictStr] = Field(default=None, description="Output only. The yum package name of the artifact.", alias="packageName")
    ...
    __properties: ClassVar[List[str]] = ["architecture", "name", "packageName", "packageType"]
