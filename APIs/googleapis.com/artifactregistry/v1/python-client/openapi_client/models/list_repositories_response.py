...
class ListRepositoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="The token to retrieve the next page of repositories, or empty if there are no more repositories to return.", alias="nextPageToken")
    repositories: Optional[List[Repository]] = Field(default=None, description="The repositories returned.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "repositories"]
