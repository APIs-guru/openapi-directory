...
class ImportGoogetArtifactsErrorInfo(BaseModel):
    """
    Error information explaining why a package was not imported.
    """ # noqa: E501
    error: Optional[Status] = None
    gcs_source: Optional[ImportGoogetArtifactsGcsSource] = Field(default=None, alias="gcsSource")
    __properties: ClassVar[List[str]] = ["error", "gcsSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsSource": ImportGoogetArtifactsGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None
        })
        return _obj
