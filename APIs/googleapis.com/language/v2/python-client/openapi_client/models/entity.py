...
class Entity(BaseModel):
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Metadata associated with the entity. For the metadata associated with other entity types, see the Type table below.")
    ...
    __properties: ClassVar[List[str]] = ["mentions", "metadata", "name", "sentiment", "type"]
