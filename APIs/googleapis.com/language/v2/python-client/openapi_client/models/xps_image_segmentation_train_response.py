...
class XPSImageSegmentationTrainResponse(BaseModel):
    """
    XPSImageSegmentationTrainResponse
    """ # noqa: E501
    color_maps: Optional[List[XPSColorMap]] = Field(default=None, description="Color map of the model.", alias="colorMaps")
    ...
    __properties: ClassVar[List[str]] = ["colorMaps", "exportModelSpec", "modelArtifactSpec", "modelServingSpec", "stopReason", "trainCostNodeSeconds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in color_maps (list)
        _items = []
        if self.color_maps:
            for _item_color_maps in self.color_maps:
                if _item_color_maps:
                    _items.append(_item_color_maps.to_dict())
            _dict['colorMaps'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "colorMaps": [XPSColorMap.from_dict(_item) for _item in obj["colorMaps"]] if obj.get("colorMaps") is not None else None,
