...
class CpuMetric(BaseModel):
    ...
    """ # noqa: E501
    core_number: Optional[StrictStr] = Field(default=None, description="Required. Number of CPU cores.", alias="coreNumber")
    core_sec: Optional[StrictStr] = Field(default=None, description="Required. Total seconds of core usage, e.g. 4.", alias="coreSec")
    cpu_type: Optional[StrictStr] = Field(default=None, description="Required. Type of cpu, e.g. N2.", alias="cpuType")
    ...
    __properties: ClassVar[List[str]] = ["coreNumber", "coreSec", "cpuType", "machineSpec", "trackingLabels"]

    @field_validator('cpu_type')
    def cpu_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['UNKNOWN_CPU_TYPE', 'A2', 'A3', 'C2', 'C2D', 'CUSTOM', 'E2', 'G2', 'C3', 'M2', 'M1', 'N1', 'N2_CUSTOM', 'N2', 'N2D']):
            raise ValueError("must be one of enum values ('UNKNOWN_CPU_TYPE', 'A2', 'A3', 'C2', 'C2D', 'CUSTOM', 'E2', 'G2', 'C3', 'M2', 'M1', 'N1', 'N2_CUSTOM', 'N2', 'N2D')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coreNumber": obj.get("coreNumber"),
            "coreSec": obj.get("coreSec"),
