...
class XPSTranslationTrainResponse(BaseModel):
    """
    ...
    def model_type_validate_enum(cls, value):
        ...
        if value not in set(['MODEL_TYPE_UNSPECIFIED', 'LEGACY', 'CURRENT']):
            raise ValueError("must be one of enum values ('MODEL_TYPE_UNSPECIFIED', 'LEGACY', 'CURRENT')")
        return value
