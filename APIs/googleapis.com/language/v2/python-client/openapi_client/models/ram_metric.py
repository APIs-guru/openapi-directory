...
class RamMetric(BaseModel):
    ...
    RamMetric
    """ # noqa: E501
    gib_sec: Optional[StrictStr] = Field(default=None, description="Required. VM memory in Gigabyte second, e.g. 3600. Using int64 type to match billing metrics definition.", alias="gibSec")
    machine_spec: Optional[StrictStr] = Field(default=None, description="Required. Machine spec, e.g. N1_STANDARD_4.", alias="machineSpec")
    memories: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Required. VM memory in gb.")
    ram_type: Optional[StrictStr] = Field(default=None, description="Required. Type of ram.", alias="ramType")
    ...
    __properties: ClassVar[List[str]] = ["gibSec", "machineSpec", "memories", "ramType", "trackingLabels"]
    ...
    @field_validator('ram_type')
    def ram_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['UNKNOWN_RAM_TYPE', 'A2', 'A3', 'C2', 'C2D', 'CUSTOM', 'E2', 'G2', 'C3', 'M2', 'M1', 'N1', 'N2_CUSTOM', 'N2', 'N2D']):
            raise ValueError("must be one of enum values ('UNKNOWN_RAM_TYPE', 'A2', 'A3', 'C2', 'C2D', 'CUSTOM', 'E2', 'G2', 'C3', 'M2', 'M1', 'N1', 'N2_CUSTOM', 'N2', 'N2D')")
        return value
