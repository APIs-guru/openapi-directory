...
class XPSImageClassificationTrainResponse(BaseModel):
    """
    ...
    stop_reason: Optional[StrictStr] = Field(default=None, description="Stop reason for training job, e.g. 'TRAIN_BUDGET_REACHED', 'MODEL_CONVERGED', 'MODEL_EARLY_STOPPED'.", alias="stopReason")
    train_cost_in_node_time: Optional[StrictStr] = Field(default=None, description="The actual cost to create this model. - For edge type model, the cost is expressed in node hour. - For cloud type model,the cost is expressed in compute hour. - Populated for models created before GA. To be deprecated after GA.", alias="trainCostInNodeTime")
    train_cost_node_seconds: Optional[StrictStr] = Field(default=None, description="The actual training cost, expressed in node seconds. Populated for models trained in node time.", alias="trainCostNodeSeconds")
    __properties: ClassVar[List[str]] = ["classCount", "exportModelSpec", "modelArtifactSpec", "modelServingSpec", "stopReason", "trainCostInNodeTime", "trainCostNodeSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trainCostInNodeTime": obj.get("trainCostInNodeTime"),
