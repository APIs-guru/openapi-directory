...
class XPSStructType(BaseModel):
    """
    `StructType` defines the DataType-s of a STRUCT type.
    """ # noqa: E501
    fields: Optional[Dict[str, XPSDataType]] = Field(default=None, description="Unordered map of struct field names to their data types.")
...
XPSStructType.model_rebuild(raise_errors=False)
