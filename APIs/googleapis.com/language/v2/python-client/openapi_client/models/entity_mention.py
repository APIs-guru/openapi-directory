...
class EntityMention(BaseModel):
    ...
    """ # noqa: E501
    probability: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Probability score associated with the entity. The score shows the probability of the entity mention being the entity type. The score is in (0, 1] range.")
    sentiment: Optional[Sentiment] = None
    text: Optional[TextSpan] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of the entity mention.")
    __properties: ClassVar[List[str]] = ["probability", "sentiment", "text", "type"]
