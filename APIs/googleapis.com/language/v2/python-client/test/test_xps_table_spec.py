...
class TestXPSTableSpec(unittest.TestCase):
    """XPSTableSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSTableSpec:
        """Test XPSTableSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSTableSpec`
        """
        model = XPSTableSpec()
        if include_optional:
            return XPSTableSpec(
