...
class TestXPSDataStats(unittest.TestCase):
    """XPSDataStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSDataStats:
        """Test XPSDataStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSDataStats`
        """
        model = XPSDataStats()
        if include_optional:
            return XPSDataStats(
