...
class TestXPSTextComponentModel(unittest.TestCase):
    """XPSTextComponentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSTextComponentModel:
        """Test XPSTextComponentModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSTextComponentModel`
        """
        model = XPSTextComponentModel()
        if include_optional:
    ...
    def testXPSTextComponentModel(self):
        """Test XPSTextComponentModel"""
