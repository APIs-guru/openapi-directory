...
class TestXPSStringStats(unittest.TestCase):
    """XPSStringStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSStringStats:
        """Test XPSStringStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSStringStats`
        """
        model = XPSStringStats()
        if include_optional:
