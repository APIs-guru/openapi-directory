...
class TestXPSVideoExportModelSpec(unittest.TestCase):
    """XPSVideoExportModelSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSVideoExportModelSpec:
        """Test XPSVideoExportModelSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSVideoExportModelSpec`
        """
        model = XPSVideoExportModelSpec()
        if include_optional:
    ...
    def testXPSVideoExportModelSpec(self):
        """Test XPSVideoExportModelSpec"""
