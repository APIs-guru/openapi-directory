...
class TestXPSTablesPreprocessResponse(unittest.TestCase):
    """XPSTablesPreprocessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSTablesPreprocessResponse:
        """Test XPSTablesPreprocessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSTablesPreprocessResponse`
        """
        model = XPSTablesPreprocessResponse()
        if include_optional:
    ...
    def testXPSTablesPreprocessResponse(self):
        """Test XPSTablesPreprocessResponse"""
