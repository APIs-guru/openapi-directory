...
class TestXPSColumnSpec(unittest.TestCase):
    """XPSColumnSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSColumnSpec:
        """Test XPSColumnSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSColumnSpec`
        """
        model = XPSColumnSpec()
        if include_optional:
