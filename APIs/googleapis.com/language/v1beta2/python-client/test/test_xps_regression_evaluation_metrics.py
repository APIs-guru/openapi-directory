...
class TestXPSRegressionEvaluationMetrics(unittest.TestCase):
    """XPSRegressionEvaluationMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSRegressionEvaluationMetrics:
        """Test XPSRegressionEvaluationMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSRegressionEvaluationMetrics`
        """
        model = XPSRegressionEvaluationMetrics()
        if include_optional:
    ...
    def testXPSRegressionEvaluationMetrics(self):
        """Test XPSRegressionEvaluationMetrics"""
