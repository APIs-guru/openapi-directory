...
class TestInfraUsage(unittest.TestCase):
    """InfraUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfraUsage:
        """Test InfraUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraUsage`
        """
        model = InfraUsage()
        if include_optional:
            return InfraUsage(
