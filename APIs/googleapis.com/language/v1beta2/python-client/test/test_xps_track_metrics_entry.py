...
class TestXPSTrackMetricsEntry(unittest.TestCase):
    """XPSTrackMetricsEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSTrackMetricsEntry:
        """Test XPSTrackMetricsEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSTrackMetricsEntry`
        """
        model = XPSTrackMetricsEntry()
        if include_optional:
    ...
    def testXPSTrackMetricsEntry(self):
        """Test XPSTrackMetricsEntry"""
