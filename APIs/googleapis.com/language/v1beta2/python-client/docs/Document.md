...
------------ | ------------- | ------------- | -------------
**boilerplate_handling** | **str** | Indicates how detected boilerplate(e.g. advertisements, copyright declarations, banners) should be handled for this document. If not specified, boilerplate will be treated the same as content. | [optional] 
...
**reference_web_uri** | **str** | The web URI where the document comes from. This URI is not used for fetching the content, but as a hint for analyzing the document. | [optional] 
