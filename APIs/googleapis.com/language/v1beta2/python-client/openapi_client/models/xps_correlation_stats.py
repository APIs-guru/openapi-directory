...
class XPSCorrelationStats(BaseModel):
    """
    ...
    """ # noqa: E501
    cramers_v: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The correlation value using the Cramer's V measure.", alias="cramersV")
    __properties: ClassVar[List[str]] = ["cramersV"]
