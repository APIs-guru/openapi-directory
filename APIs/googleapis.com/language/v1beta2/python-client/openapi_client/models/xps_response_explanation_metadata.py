...
class XPSResponseExplanationMetadata(BaseModel):
    """
    XPSResponseExplanationMetadata
    """ # noqa: E501
    inputs: Optional[Dict[str, XPSResponseExplanationMetadataInputMetadata]] = Field(default=None, description="Metadata of the input.")
    outputs: Optional[Dict[str, XPSResponseExplanationMetadataOutputMetadata]] = Field(default=None, description="Metadata of the output.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": dict(
                (_k, XPSResponseExplanationMetadataInputMetadata.from_dict(_v))
                for _k, _v in obj["inputs"].items()
            )
            if obj.get("inputs") is not None
            else None,
            "outputs": dict(
                (_k, XPSResponseExplanationMetadataOutputMetadata.from_dict(_v))
