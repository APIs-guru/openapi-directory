...
class XPSArrayStats(BaseModel):
    """
    The data statistics of a series of ARRAY values.
    """ # noqa: E501
    common_stats: Optional[XPSCommonStats] = Field(default=None, alias="commonStats")
    member_stats: Optional[XPSDataStats] = Field(default=None, alias="memberStats")
    __properties: ClassVar[List[str]] = ["commonStats", "memberStats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberStats": XPSDataStats.from_dict(obj["memberStats"]) if obj.get("memberStats") is not None else None
        })
        return _obj

from openapi_client.models.xps_data_stats import XPSDataStats
# TODO: Rewrite to not use raise_errors
XPSArrayStats.model_rebuild(raise_errors=False)
