...
class Entity(BaseModel):
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Metadata associated with the entity. Currently, Wikipedia URLs and Knowledge Graph MIDs are provided, if available. The associated keys are \"wikipedia_url\" and \"mid\", respectively.")
    ...
    __properties: ClassVar[List[str]] = ["mentions", "metadata", "name", "salience", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UNKNOWN', 'PERSON', 'LOCATION', 'ORGANIZATION', 'EVENT', 'WORK_OF_ART', 'CONSUMER_GOOD', 'OTHER']):
            raise ValueError("must be one of enum values ('UNKNOWN', 'PERSON', 'LOCATION', 'ORGANIZATION', 'EVENT', 'WORK_OF_ART', 'CONSUMER_GOOD', 'OTHER')")
        return value
