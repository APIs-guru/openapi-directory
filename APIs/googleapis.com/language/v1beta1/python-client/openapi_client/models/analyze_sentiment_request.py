...
class AnalyzeSentimentRequest(BaseModel):
    ...
    encoding_type: Optional[StrictStr] = Field(default=None, description="The encoding type used by the API to calculate sentence offsets for the sentence sentiment.", alias="encodingType")
