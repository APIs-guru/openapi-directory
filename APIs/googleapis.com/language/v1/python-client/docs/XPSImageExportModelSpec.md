...
xps_image_export_model_spec_instance = XPSImageExportModelSpec.from_json(json)
# print the JSON string representation of the object
print(XPSImageExportModelSpec.to_json())

# convert the object into a dict
xps_image_export_model_spec_dict = xps_image_export_model_spec_instance.to_dict()
# create an instance of XPSImageExportModelSpec from a dict
xps_image_export_model_spec_from_dict = XPSImageExportModelSpec.from_dict(xps_image_export_model_spec_dict)
```
