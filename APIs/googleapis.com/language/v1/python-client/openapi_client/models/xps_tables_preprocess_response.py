...
class XPSTablesPreprocessResponse(BaseModel):
    """
    XPSTablesPreprocessResponse
    """ # noqa: E501
    tables_dataset_metadata: Optional[XPSTablesDatasetMetadata] = Field(default=None, alias="tablesDatasetMetadata")
    __properties: ClassVar[List[str]] = ["tablesDatasetMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tablesDatasetMetadata": XPSTablesDatasetMetadata.from_dict(obj["tablesDatasetMetadata"]) if obj.get("tablesDatasetMetadata") is not None else None
        })
        return _obj
