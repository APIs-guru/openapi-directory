...
class AnalyzeSentimentRequest(BaseModel):
    ...
    encoding_type: Optional[StrictStr] = Field(default=None, description="The encoding type used by the API to calculate sentence offsets.", alias="encodingType")
    __properties: ClassVar[List[str]] = ["document", "encodingType"]
    ...
    def encoding_type_validate_enum(cls, value):
        ...
        if value not in set(['NONE', 'UTF8', 'UTF16', 'UTF32']):
            raise ValueError("must be one of enum values ('NONE', 'UTF8', 'UTF16', 'UTF32')")
        return value
