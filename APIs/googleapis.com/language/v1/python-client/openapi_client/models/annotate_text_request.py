...
class AnnotateTextRequest(BaseModel):
    ...
    features: Optional[AnnotateTextRequestFeatures] = None
    __properties: ClassVar[List[str]] = ["document", "encodingType", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": AnnotateTextRequestFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
        return _obj
