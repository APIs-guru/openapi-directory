...
class XPSBoundingBoxMetricsEntry(BaseModel):
    """
    Bounding box matching model metrics for a single intersection-over-union threshold and multiple label match confidence thresholds.
    """ # noqa: E501
    confidence_metrics_entries: Optional[List[XPSBoundingBoxMetricsEntryConfidenceMetricsEntry]] = Field(default=None, description="Metrics for each label-match confidence_threshold from 0.05,0.10,...,0.95,0.96,0.97,0.98,0.99.", alias="confidenceMetricsEntries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidenceMetricsEntries": [XPSBoundingBoxMetricsEntryConfidenceMetricsEntry.from_dict(_item) for _item in obj["confidenceMetricsEntries"]] if obj.get("confidenceMetricsEntries") is not None else None,
