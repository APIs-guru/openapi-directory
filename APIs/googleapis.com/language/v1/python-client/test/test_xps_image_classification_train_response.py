...
class TestXPSImageClassificationTrainResponse(unittest.TestCase):
    """XPSImageClassificationTrainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSImageClassificationTrainResponse:
        """Test XPSImageClassificationTrainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSImageClassificationTrainResponse`
        """
        model = XPSImageClassificationTrainResponse()
        if include_optional:
    ...
    def testXPSImageClassificationTrainResponse(self):
        """Test XPSImageClassificationTrainResponse"""
