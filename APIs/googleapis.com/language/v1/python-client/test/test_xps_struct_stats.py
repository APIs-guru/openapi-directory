...
class TestXPSStructStats(unittest.TestCase):
    """XPSStructStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XPSStructStats:
        """Test XPSStructStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XPSStructStats`
        """
        model = XPSStructStats()
        if include_optional:
            return XPSStructStats(
                common_stats = openapi_client.models.xps_common_stats.XPSCommonStats(
                    ...
                    valid_value_count = '', ),
                field_stats = {
                    'key' : openapi_client.models.xps_data_stats.XPSDataStats(
