...
class ImportDomainRequest(BaseModel):
    ...
    """ # noqa: E501
    domain_name: Optional[StrictStr] = Field(default=None, description="Required. The domain name. Unicode domain names must be expressed in Punycode format.", alias="domainName")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Set of labels associated with the `Registration`.")
    __properties: ClassVar[List[str]] = ["domainName", "labels"]
