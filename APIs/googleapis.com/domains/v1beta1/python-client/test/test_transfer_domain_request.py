...
class TestTransferDomainRequest(unittest.TestCase):
    """TransferDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferDomainRequest:
        """Test TransferDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferDomainRequest`
        """
        model = TransferDomainRequest()
        if include_optional:
            return TransferDomainRequest(
                authorization_code = openapi_client.models.authorization_code.AuthorizationCode(
                    code = '', ),
                contact_notices = [
    ...
    def testTransferDomainRequest(self):
        """Test TransferDomainRequest"""
