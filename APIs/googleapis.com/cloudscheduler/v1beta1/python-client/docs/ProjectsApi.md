...
------------- | ------------- | -------------
[**cloudscheduler_projects_locations_jobs_create**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_create) | **POST** /v1beta1/{parent}/jobs | 
[**cloudscheduler_projects_locations_jobs_delete**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_delete) | **DELETE** /v1beta1/{name} | 
[**cloudscheduler_projects_locations_jobs_get**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_get) | **GET** /v1beta1/{name} | 
[**cloudscheduler_projects_locations_jobs_list**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_list) | **GET** /v1beta1/{parent}/jobs | 
[**cloudscheduler_projects_locations_jobs_patch**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_patch) | **PATCH** /v1beta1/{name} | 
[**cloudscheduler_projects_locations_jobs_pause**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_pause) | **POST** /v1beta1/{name}:pause | 
[**cloudscheduler_projects_locations_jobs_resume**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_resume) | **POST** /v1beta1/{name}:resume | 
[**cloudscheduler_projects_locations_jobs_run**](ProjectsApi.md#cloudscheduler_projects_locations_jobs_run) | **POST** /v1beta1/{name}:run | 
[**cloudscheduler_projects_locations_list**](ProjectsApi.md#cloudscheduler_projects_locations_list) | **GET** /v1beta1/{name}/locations | 
...
> object cloudscheduler_projects_locations_jobs_delete(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, legacy_app_engine_cron=legacy_app_engine_cron)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    legacy_app_engine_cron = True # bool | This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job in the __cron queue with the corresponding name will be deleted instead. (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **legacy_app_engine_cron** | **bool**| This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job in the __cron queue with the corresponding name will be deleted instead. | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    filter = 'filter_example' # str | `filter` can be used to specify a subset of jobs. If `filter` equals `target_config=\"HttpConfig\"`, then the http target jobs are retrieved. If `filter` equals `target_config=\"PubSubConfig\"`, then the Pub/Sub target jobs are retrieved. If `filter` equals `labels.foo=value1 labels.foo=value2` then only jobs which are labeled with foo=value1 AND foo=value2 will be returned. (optional)
    legacy_app_engine_cron = True # bool | This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the jobs in the __cron queue will be listed instead. (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **filter** | **str**| &#x60;filter&#x60; can be used to specify a subset of jobs. If &#x60;filter&#x60; equals &#x60;target_config&#x3D;\&quot;HttpConfig\&quot;&#x60;, then the http target jobs are retrieved. If &#x60;filter&#x60; equals &#x60;target_config&#x3D;\&quot;PubSubConfig\&quot;&#x60;, then the Pub/Sub target jobs are retrieved. If &#x60;filter&#x60; equals &#x60;labels.foo&#x3D;value1 labels.foo&#x3D;value2&#x60; then only jobs which are labeled with foo&#x3D;value1 AND foo&#x3D;value2 will be returned. | [optional] 
 **legacy_app_engine_cron** | **bool**| This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the jobs in the __cron queue will be listed instead. | [optional] 
...
> Job cloudscheduler_projects_locations_jobs_run(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, run_job_request=run_job_request)
