...
class Job(BaseModel):
    ...
    legacy_app_engine_cron: Optional[StrictBool] = Field(default=None, description="Immutable. This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job will be considered a legacy job. Note that App Engine Cron jobs have fewer features than Cloud Scheduler jobs, e.g., are only limited to App Engine targets.", alias="legacyAppEngineCron")
    ...
    __properties: ClassVar[List[str]] = ["appEngineHttpTarget", "attemptDeadline", "description", "httpTarget", "lastAttemptTime", "legacyAppEngineCron", "name", "pubsubTarget", "retryConfig", "schedule", "scheduleTime", "state", "status", "timeZone", "userUpdateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "legacyAppEngineCron": obj.get("legacyAppEngineCron"),
            "name": obj.get("name"),
