...
json = "{}"
# create an instance of GoogleTypeExpr from a JSON string
google_type_expr_instance = GoogleTypeExpr.from_json(json)
# print the JSON string representation of the object
print(GoogleTypeExpr.to_json())

# convert the object into a dict
google_type_expr_dict = google_type_expr_instance.to_dict()
# create an instance of GoogleTypeExpr from a dict
google_type_expr_from_dict = GoogleTypeExpr.from_dict(google_type_expr_dict)
```
