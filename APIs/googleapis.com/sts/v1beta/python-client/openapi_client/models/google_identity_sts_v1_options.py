...
class GoogleIdentityStsV1Options(BaseModel):
    ...
    """ # noqa: E501
    access_boundary: Optional[GoogleIdentityStsV1AccessBoundary] = Field(default=None, alias="accessBoundary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessBoundary": GoogleIdentityStsV1AccessBoundary.from_dict(obj["accessBoundary"]) if obj.get("accessBoundary") is not None else None,
