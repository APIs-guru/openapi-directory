...
class GoogleIdentityStsV1AccessBoundary(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleIdentityStsV1AccessBoundary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleIdentityStsV1AccessBoundary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accessBoundaryRules": [GoogleIdentityStsV1AccessBoundaryRule.from_dict(_item) for _item in obj["accessBoundaryRules"]] if obj.get("accessBoundaryRules") is not None else None
        })
        return _obj
