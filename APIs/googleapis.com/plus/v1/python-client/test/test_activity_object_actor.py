...
class TestActivityObjectActor(unittest.TestCase):
    """ActivityObjectActor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityObjectActor:
        """Test ActivityObjectActor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityObjectActor`
        """
        model = ActivityObjectActor()
        if include_optional:
    ...
    def testActivityObjectActor(self):
        """Test ActivityObjectActor"""
