...
class ActivitiesApi:
    ...
    def plus_activities_get(
        self,
        activity_id: Annotated[StrictStr, Field(description="The ID of the activity to get.")],
        ...
        _param = self._plus_activities_get_serialize(
    ...
    @validate_call
    def plus_activities_get_with_http_info(
        self,
        activity_id: Annotated[StrictStr, Field(description="The ID of the activity to get.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def plus_activities_get_without_preload_content(
        self,
        activity_id: Annotated[StrictStr, Field(description="The ID of the activity to get.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _plus_activities_get_serialize(
        self,
        activity_id,
        alt,
        fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/activities/{activityId}',
    ...
    def plus_activities_list(
        self,
        user_id: Annotated[StrictStr, Field(description="The ID of the user to get activities for. The special value \"me\" can be used to indicate the authenticated user.")],
        collection: Annotated[StrictStr, Field(description="The collection of activities to list.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        quota_user: Annotated[Optional[StrictStr], Field(description="An opaque string that represents a user for quota purposes. Must not exceed 40 characters.")] = None,
        user_ip: Annotated[Optional[StrictStr], Field(description="Deprecated. Please use quotaUser instead.")] = None,
        max_results: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of activities to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults.")] = None,
        ...
        :param user_id: The ID of the user to get activities for. The special value \"me\" can be used to indicate the authenticated user. (required)
        :type user_id: str
        ...
        _param = self._plus_activities_list_serialize(
            user_id=user_id,
    ...
    @validate_call
    def plus_activities_list_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="The ID of the user to get activities for. The special value \"me\" can be used to indicate the authenticated user.")],
        collection: Annotated[StrictStr, Field(description="The collection of activities to list.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def plus_activities_list_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="The ID of the user to get activities for. The special value \"me\" can be used to indicate the authenticated user.")],
        collection: Annotated[StrictStr, Field(description="The collection of activities to list.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _plus_activities_list_serialize(
        self,
        user_id,
        collection,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/people/{userId}/activities/{collection}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def plus_activities_search(
        self,
        query: Annotated[StrictStr, Field(description="Full-text search query string.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        ...
        max_results: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="The maximum number of activities to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Specifies how to order search results.")] = None,
        ...
        _param = self._plus_activities_search_serialize(
            query=query,
            alt=alt,
            fields=fields,
            key=key,
    ...
    @validate_call
    def plus_activities_search_with_http_info(
        self,
        query: Annotated[StrictStr, Field(description="Full-text search query string.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    @validate_call
    def plus_activities_search_without_preload_content(
        self,
        query: Annotated[StrictStr, Field(description="Full-text search query string.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
    ...
    def _plus_activities_search_serialize(
        self,
        query,
        alt,
        fields,
