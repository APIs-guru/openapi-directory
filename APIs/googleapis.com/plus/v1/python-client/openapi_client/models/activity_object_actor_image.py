...
class ActivityObjectActorImage(BaseModel):
    """
    The image representation of the original actor.
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="A URL that points to a thumbnail photo of the original actor.")
