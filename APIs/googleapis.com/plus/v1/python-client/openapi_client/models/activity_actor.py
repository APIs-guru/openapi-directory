...
class ActivityActor(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="The name of the actor, suitable for display.", alias="displayName")
    id: Optional[StrictStr] = Field(default=None, description="The ID of the actor's Person resource.")
    image: Optional[ActivityActorImage] = None
    name: Optional[ActivityActorName] = None
    url: Optional[StrictStr] = Field(default=None, description="The link to the actor's Google profile.")
    verification: Optional[ActivityActorVerification] = None
    __properties: ClassVar[List[str]] = ["clientSpecificActorInfo", "displayName", "id", "image", "name", "url", "verification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "image": ActivityActorImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "name": ActivityActorName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "url": obj.get("url"),
