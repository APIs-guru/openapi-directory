...
class ActivityObjectActor(BaseModel):
    """
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="The original actor's name, which is suitable for display.", alias="displayName")
    id: Optional[StrictStr] = Field(default=None, description="ID of the original actor.")
    image: Optional[ActivityObjectActorImage] = None
    url: Optional[StrictStr] = Field(default=None, description="A link to the original actor's Google profile.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "image": ActivityObjectActorImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "url": obj.get("url"),
