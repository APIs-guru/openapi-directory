...
class ServicesApi:
    ...
    @validate_call
    def cloudbilling_services_list(
        self,
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Requested page size. Defaults to 5000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token identifying a page of results to return. This should be a `next_page_token` value returned from a previous `ListServices` call. If unspecified, the first page of results is returned.")] = None,
        ...
        _param = self._cloudbilling_services_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def cloudbilling_services_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def cloudbilling_services_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudbilling_services_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
    ...
    @validate_call
    def cloudbilling_services_skus_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the service. Example: \"services/DA34-426B-A397\"")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        currency_code: Annotated[Optional[StrictStr], Field(description="The ISO 4217 currency code for the pricing info in the response proto. Will use the conversion rate as of start_time. Optional. If not specified USD will be used.")] = None,
        end_time: Annotated[Optional[StrictStr], Field(description="Optional exclusive end time of the time range for which the pricing versions will be returned. Timestamps in the future are not allowed. The time range has to be within a single calendar month in America/Los_Angeles timezone. Time range as a whole is optional. If not specified, the latest pricing will be returned (up to 12 hours old at most).")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Requested page size. Defaults to 5000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A token identifying a page of results to return. This should be a `next_page_token` value returned from a previous `ListSkus` call. If unspecified, the first page of results is returned.")] = None,
        ...
        _param = self._cloudbilling_services_skus_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def cloudbilling_services_skus_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the service. Example: \"services/DA34-426B-A397\"")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudbilling_services_skus_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The name of the service. Example: \"services/DA34-426B-A397\"")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudbilling_services_skus_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
