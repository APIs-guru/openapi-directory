...
class TestGoogleCloudBillingPricesV1betaPrice(unittest.TestCase):
    """GoogleCloudBillingPricesV1betaPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingPricesV1betaPrice:
        """Test GoogleCloudBillingPricesV1betaPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingPricesV1betaPrice`
        """
        model = GoogleCloudBillingPricesV1betaPrice()
        if include_optional:
    ...
    def testGoogleCloudBillingPricesV1betaPrice(self):
        """Test GoogleCloudBillingPricesV1betaPrice"""
