...
class TestStandardTierEgressWorkload(unittest.TestCase):
    """StandardTierEgressWorkload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardTierEgressWorkload:
        """Test StandardTierEgressWorkload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardTierEgressWorkload`
        """
        model = StandardTierEgressWorkload()
        if include_optional:
    ...
    def testStandardTierEgressWorkload(self):
        """Test StandardTierEgressWorkload"""
