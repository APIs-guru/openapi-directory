...
class TestGoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice(unittest.TestCase):
    """GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice:
        """Test GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice`
        """
        model = GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice()
        if include_optional:
            return GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice(
                currency_code = '',
                name = '',
    ...
    def testGoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice(self):
        """Test GoogleCloudBillingBillingaccountpricesV1betaBillingAccountPrice"""
