...
class TestCostScenario(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CostScenario:
        """Test CostScenario
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CostScenario`
        """
        model = CostScenario()
        if include_optional:
            return CostScenario(
