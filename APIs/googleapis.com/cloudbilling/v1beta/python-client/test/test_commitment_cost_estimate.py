...
class TestCommitmentCostEstimate(unittest.TestCase):
    """CommitmentCostEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitmentCostEstimate:
        """Test CommitmentCostEstimate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitmentCostEstimate`
        """
        model = CommitmentCostEstimate()
        if include_optional:
    ...
    def testCommitmentCostEstimate(self):
        """Test CommitmentCostEstimate"""
