...
class TestIntraRegionEgress(unittest.TestCase):
    """IntraRegionEgress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntraRegionEgress:
        """Test IntraRegionEgress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntraRegionEgress`
        """
        model = IntraRegionEgress()
        if include_optional:
    ...
    def testIntraRegionEgress(self):
        """Test IntraRegionEgress"""
