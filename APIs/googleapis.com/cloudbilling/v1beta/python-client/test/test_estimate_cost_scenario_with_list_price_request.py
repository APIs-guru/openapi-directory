...
class TestEstimateCostScenarioWithListPriceRequest(unittest.TestCase):
    """EstimateCostScenarioWithListPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateCostScenarioWithListPriceRequest:
        """Test EstimateCostScenarioWithListPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateCostScenarioWithListPriceRequest`
        """
        model = EstimateCostScenarioWithListPriceRequest()
        if include_optional:
    ...
    def testEstimateCostScenarioWithListPriceRequest(self):
        """Test EstimateCostScenarioWithListPriceRequest"""
