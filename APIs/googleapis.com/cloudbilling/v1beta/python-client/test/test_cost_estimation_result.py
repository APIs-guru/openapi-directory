...
class TestCostEstimationResult(unittest.TestCase):
    """CostEstimationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CostEstimationResult:
        """Test CostEstimationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CostEstimationResult`
        """
        model = CostEstimationResult()
        if include_optional:
    ...
    def testCostEstimationResult(self):
        """Test CostEstimationResult"""
