...
class TestUsageRateTimeline(unittest.TestCase):
    """UsageRateTimeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageRateTimeline:
        """Test UsageRateTimeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageRateTimeline`
        """
        model = UsageRateTimeline()
        if include_optional:
    ...
    def testUsageRateTimeline(self):
        """Test UsageRateTimeline"""
