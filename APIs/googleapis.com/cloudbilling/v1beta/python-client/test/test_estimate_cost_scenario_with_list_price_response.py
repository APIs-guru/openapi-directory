...
class TestEstimateCostScenarioWithListPriceResponse(unittest.TestCase):
    """EstimateCostScenarioWithListPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateCostScenarioWithListPriceResponse:
        """Test EstimateCostScenarioWithListPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateCostScenarioWithListPriceResponse`
        """
        model = EstimateCostScenarioWithListPriceResponse()
        if include_optional:
    ...
    def testEstimateCostScenarioWithListPriceResponse(self):
        """Test EstimateCostScenarioWithListPriceResponse"""
