...
class TestCloudCdnEgressWorkload(unittest.TestCase):
    """CloudCdnEgressWorkload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudCdnEgressWorkload:
        """Test CloudCdnEgressWorkload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudCdnEgressWorkload`
        """
        model = CloudCdnEgressWorkload()
        if include_optional:
    ...
    def testCloudCdnEgressWorkload(self):
        """Test CloudCdnEgressWorkload"""
