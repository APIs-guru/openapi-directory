...
class SkusApi:
    ...
    @validate_call
    def cloudbilling_skus_price_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. Name of the latest price to retrieve. Format: skus/{sku}/price")],
        ...
        currency_code: Annotated[Optional[StrictStr], Field(description="Optional. ISO-4217 currency code for the price. If not specified, USD will be used.")] = None,
        ...
        _param = self._cloudbilling_skus_price_get_serialize(
            name=name,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudBillingPricesV1betaPrice",
        }
    ...
    @validate_call
    def cloudbilling_skus_price_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. Name of the latest price to retrieve. Format: skus/{sku}/price")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudBillingPricesV1betaPrice]:
        """cloudbilling_skus_price_get
    ...
    @validate_call
    def cloudbilling_skus_price_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. Name of the latest price to retrieve. Format: skus/{sku}/price")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudbilling_skus_price_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    @validate_call
    def cloudbilling_skus_prices_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. To list the prices for all SKUs, use `-` as the SKU ID. Format: `skus/-` Specifying a specific SKU ID returns a collection with one Price object for the SKU.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        currency_code: Annotated[Optional[StrictStr], Field(description="Optional. ISO-4217 currency code for the price. If not specified, USD will be used.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. Maximum number of prices to return. Results may return fewer than this value. Default value is 50 and maximum value is 5000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Optional. Page token received from a previous ListPrices call to retrieve the next page of results. If this field is empty, the first page is returned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._cloudbilling_skus_prices_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudBillingPricesV1betaListPricesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def cloudbilling_skus_prices_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. To list the prices for all SKUs, use `-` as the SKU ID. Format: `skus/-` Specifying a specific SKU ID returns a collection with one Price object for the SKU.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudBillingPricesV1betaListPricesResponse]:
        """cloudbilling_skus_prices_list
    ...
    @validate_call
    def cloudbilling_skus_prices_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. To list the prices for all SKUs, use `-` as the SKU ID. Format: `skus/-` Specifying a specific SKU ID returns a collection with one Price object for the SKU.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudbilling_skus_prices_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta/{parent}/prices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
