...
class SkuGroupsApi:
    ...
    @validate_call
    def cloudbilling_sku_groups_list(
        self,
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Maximum number of SKU groups to return. Results may return fewer than this value. Default value is 50 and maximum value is 5000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Page token received from a previous ListSkuGroups call to retrieve the next page of results. If this field is empty, the first page is returned.")] = None,
        ...
        _param = self._cloudbilling_sku_groups_list_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudBillingSkugroupsV1betaListSkuGroupsResponse",
        }
    ...
    @validate_call
    def cloudbilling_sku_groups_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudBillingSkugroupsV1betaListSkuGroupsResponse]:
        """cloudbilling_sku_groups_list
    ...
    @validate_call
    def cloudbilling_sku_groups_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _cloudbilling_sku_groups_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta/skuGroups',
    ...
    @validate_call
    def cloudbilling_sku_groups_skus_list(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The SkuGroup to list SkuGroupSku from. Format: skuGroups/{sku_group}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Maximum number of SKU group SKUs to return. Results may return fewer than this value. Default value is 50 and maximum value is 5000.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Page token received from a previous ListSkuGroupSkus call to retrieve the next page of results. If this field is empty, the first page is returned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._cloudbilling_sku_groups_skus_list_serialize(
            parent=parent,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudBillingSkugroupskusV1betaListSkuGroupSkusResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def cloudbilling_sku_groups_skus_list_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The SkuGroup to list SkuGroupSku from. Format: skuGroups/{sku_group}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudBillingSkugroupskusV1betaListSkuGroupSkusResponse]:
        """cloudbilling_sku_groups_skus_list
    ...
    @validate_call
    def cloudbilling_sku_groups_skus_list_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The SkuGroup to list SkuGroupSku from. Format: skuGroups/{sku_group}")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudbilling_sku_groups_skus_list_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta/{parent}/skus',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
