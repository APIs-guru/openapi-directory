...
class GoogleCloudBillingSkugroupskusV1betaGeoTaxonomyRegional(BaseModel):
    """
    Encapsulates a regional geographic taxonomy.
    """ # noqa: E501
    region: Optional[GoogleCloudBillingSkugroupskusV1betaGeoTaxonomyRegion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "region": GoogleCloudBillingSkugroupskusV1betaGeoTaxonomyRegion.from_dict(obj["region"]) if obj.get("region") is not None else None
        })
        return _obj
