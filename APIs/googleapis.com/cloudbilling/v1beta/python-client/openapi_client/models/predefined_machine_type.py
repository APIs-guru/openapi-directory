...
class PredefinedMachineType(BaseModel):
    ...
    """ # noqa: E501
    machine_type: Optional[StrictStr] = Field(default=None, description="The [machine type](https://cloud.google.com/compute/docs/machine-types). For example: \"n1-standard1\".", alias="machineType")
