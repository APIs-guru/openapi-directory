...
class GoogleCloudBillingBillingaccountskugroupskusV1betaGeoTaxonomyRegional(BaseModel):
    """
    Encapsulates a regional geographic taxonomy.
    """ # noqa: E501
    region: Optional[GoogleCloudBillingBillingaccountskugroupskusV1betaGeoTaxonomyRegion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "region": GoogleCloudBillingBillingaccountskugroupskusV1betaGeoTaxonomyRegion.from_dict(obj["region"]) if obj.get("region") is not None else None
        })
        return _obj
