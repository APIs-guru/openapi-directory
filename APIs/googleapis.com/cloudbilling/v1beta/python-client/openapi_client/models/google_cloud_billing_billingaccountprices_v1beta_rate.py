...
class GoogleCloudBillingBillingaccountpricesV1betaRate(BaseModel):
    """
    ...
    """ # noqa: E501
    aggregation_info: Optional[GoogleCloudBillingBillingaccountpricesV1betaAggregationInfo] = Field(default=None, alias="aggregationInfo")
    tiers: Optional[List[GoogleCloudBillingBillingaccountpricesV1betaRateTier]] = Field(default=None, description="All tiers associated with the `Rate` price.")
    unit_info: Optional[GoogleCloudBillingBillingaccountpricesV1betaUnitInfo] = Field(default=None, alias="unitInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregationInfo": GoogleCloudBillingBillingaccountpricesV1betaAggregationInfo.from_dict(obj["aggregationInfo"]) if obj.get("aggregationInfo") is not None else None,
            "tiers": [GoogleCloudBillingBillingaccountpricesV1betaRateTier.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
            "unitInfo": GoogleCloudBillingBillingaccountpricesV1betaUnitInfo.from_dict(obj["unitInfo"]) if obj.get("unitInfo") is not None else None
        })
        return _obj
