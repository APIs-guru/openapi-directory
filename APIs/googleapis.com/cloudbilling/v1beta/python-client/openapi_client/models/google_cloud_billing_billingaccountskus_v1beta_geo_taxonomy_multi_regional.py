...
class GoogleCloudBillingBillingaccountskusV1betaGeoTaxonomyMultiRegional(BaseModel):
    """
    Encapsulates a multi-regional geographic taxonomy.
    """ # noqa: E501
    regions: Optional[List[GoogleCloudBillingBillingaccountskusV1betaGeoTaxonomyRegion]] = Field(default=None, description="Google Cloud regions associated with the multi-regional geographic taxonomy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "regions": [GoogleCloudBillingBillingaccountskusV1betaGeoTaxonomyRegion.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
