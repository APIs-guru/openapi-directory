...
class GoogleCloudBillingBillingaccountskugroupsV1betaBillingAccountSkuGroup(BaseModel):
    """
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Description of the BillingAccountSkuGroup. Example: \"A2 VMs (1 Year CUD)\".", alias="displayName")
    name: Optional[StrictStr] = Field(default=None, description="Resource name for the BillingAccountSkuGroup. Example: \"billingAccounts/012345-567890-ABCDEF/skuGroups/0e6403d1-4694-44d2-a696-7a78b1a69301\".")
