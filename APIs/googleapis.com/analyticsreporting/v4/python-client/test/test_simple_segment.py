...
class TestSimpleSegment(unittest.TestCase):
    """SimpleSegment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleSegment:
        """Test SimpleSegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleSegment`
        """
        model = SimpleSegment()
        if include_optional:
