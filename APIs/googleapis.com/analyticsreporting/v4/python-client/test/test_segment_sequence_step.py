...
class TestSegmentSequenceStep(unittest.TestCase):
    """SegmentSequenceStep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentSequenceStep:
        """Test SegmentSequenceStep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentSequenceStep`
        """
        model = SegmentSequenceStep()
        if include_optional:
    ...
    def testSegmentSequenceStep(self):
        """Test SegmentSequenceStep"""
