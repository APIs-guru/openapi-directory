...
class GoogleCloudPolicyanalyzerV1Activity(BaseModel):
    """
    ...
    observation_period: Optional[GoogleCloudPolicyanalyzerV1ObservationPeriod] = Field(default=None, alias="observationPeriod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "observationPeriod": GoogleCloudPolicyanalyzerV1ObservationPeriod.from_dict(obj["observationPeriod"]) if obj.get("observationPeriod") is not None else None
        })
        return _obj
