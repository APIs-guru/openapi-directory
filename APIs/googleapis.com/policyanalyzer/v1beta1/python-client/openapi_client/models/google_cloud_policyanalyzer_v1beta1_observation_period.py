...
class GoogleCloudPolicyanalyzerV1beta1ObservationPeriod(BaseModel):
    ...
    """ # noqa: E501
    end_time: Optional[StrictStr] = Field(default=None, description="The observation end time.", alias="endTime")
    start_time: Optional[StrictStr] = Field(default=None, description="The observation start time.", alias="startTime")
