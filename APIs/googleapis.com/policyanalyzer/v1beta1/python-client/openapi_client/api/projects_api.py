...
class ProjectsApi:
    ...
    def policyanalyzer_projects_locations_activity_types_activities_query(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The container resource on which to execute the request. Acceptable formats: `projects/[PROJECT_ID|PROJECT_NUMBER]/locations/[LOCATION]/activityTypes/[ACTIVITY_TYPE]` LOCATION here refers to GCP Locations: https://cloud.google.com/about/locations/")],
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Optional. Optional filter expression to restrict the activities returned. Supported filters are: - service_account_last_authn.full_resource_name {=} - service_account_key_last_authn.full_resource_name {=} ")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of results to return from this request. Max limit is 1000. Non-positive values are ignored. The presence of `nextPageToken` in the response indicates that more results might be available.")] = None,
        ...
        _param = self._policyanalyzer_projects_locations_activity_types_activities_query_serialize(
            parent=parent,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse",
        }
    ...
    @validate_call
    def policyanalyzer_projects_locations_activity_types_activities_query_with_http_info(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The container resource on which to execute the request. Acceptable formats: `projects/[PROJECT_ID|PROJECT_NUMBER]/locations/[LOCATION]/activityTypes/[ACTIVITY_TYPE]` LOCATION here refers to GCP Locations: https://cloud.google.com/about/locations/")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse]:
        """policyanalyzer_projects_locations_activity_types_activities_query
    ...
    @validate_call
    def policyanalyzer_projects_locations_activity_types_activities_query_without_preload_content(
        self,
        parent: Annotated[StrictStr, Field(description="Required. The container resource on which to execute the request. Acceptable formats: `projects/[PROJECT_ID|PROJECT_NUMBER]/locations/[LOCATION]/activityTypes/[ACTIVITY_TYPE]` LOCATION here refers to GCP Locations: https://cloud.google.com/about/locations/")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _policyanalyzer_projects_locations_activity_types_activities_query_serialize(
        self,
        parent,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta1/{parent}/activities:query',
