...
------------ | ------------- | ------------- | -------------
*ProjectsApi* | [**policyanalyzer_projects_locations_activity_types_activities_query**](docs/ProjectsApi.md#policyanalyzer_projects_locations_activity_types_activities_query) | **GET** /v1beta1/{parent}/activities:query | 
