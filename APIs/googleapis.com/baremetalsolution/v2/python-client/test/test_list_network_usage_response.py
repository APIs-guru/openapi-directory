...
class TestListNetworkUsageResponse(unittest.TestCase):
    """ListNetworkUsageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListNetworkUsageResponse:
        """Test ListNetworkUsageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListNetworkUsageResponse`
        """
        model = ListNetworkUsageResponse()
        if include_optional:
            return ListNetworkUsageResponse(
                networks = [
                    openapi_client.models.network_usage.NetworkUsage(
    ...
    def testListNetworkUsageResponse(self):
        """Test ListNetworkUsageResponse"""
