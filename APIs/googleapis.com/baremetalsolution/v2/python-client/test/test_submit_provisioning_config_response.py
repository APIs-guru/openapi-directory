...
class TestSubmitProvisioningConfigResponse(unittest.TestCase):
    """SubmitProvisioningConfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitProvisioningConfigResponse:
        """Test SubmitProvisioningConfigResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitProvisioningConfigResponse`
        """
        model = SubmitProvisioningConfigResponse()
        if include_optional:
    ...
    def testSubmitProvisioningConfigResponse(self):
        """Test SubmitProvisioningConfigResponse"""
