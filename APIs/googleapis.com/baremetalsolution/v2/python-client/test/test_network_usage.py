...
class TestNetworkUsage(unittest.TestCase):
    """NetworkUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkUsage:
        """Test NetworkUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkUsage`
        """
        model = NetworkUsage()
        if include_optional:
            return NetworkUsage(
