...
class NetworkUsage(BaseModel):
    ...
    used_ips: Optional[List[StrictStr]] = Field(default=None, description="All used IP addresses in this network.", alias="usedIps")
    __properties: ClassVar[List[str]] = ["network", "usedIps"]
