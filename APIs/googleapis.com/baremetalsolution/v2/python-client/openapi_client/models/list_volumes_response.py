...
class ListVolumesResponse(BaseModel):
    ...
    volumes: Optional[List[Volume]] = Field(default=None, description="The list of storage volumes.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "unreachable", "volumes"]
