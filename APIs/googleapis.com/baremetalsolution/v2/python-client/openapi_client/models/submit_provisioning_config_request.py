...
class SubmitProvisioningConfigRequest(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Optional. Email provided to send a confirmation with provisioning config to.")
    provisioning_config: Optional[ProvisioningConfig] = Field(default=None, alias="provisioningConfig")
    __properties: ClassVar[List[str]] = ["email", "provisioningConfig"]
