...
class NetworkConfig(BaseModel):
    ...
    gcp_service: Optional[StrictStr] = Field(default=None, description="The GCP service of the network. Available gcp_service are in https://cloud.google.com/bare-metal/docs/bms-planning.", alias="gcpService")
    ...
    jumbo_frames_enabled: Optional[StrictBool] = Field(default=None, description="The JumboFramesEnabled option for customer to set.", alias="jumboFramesEnabled")
    name: Optional[StrictStr] = Field(default=None, description="Output only. The name of the network config.")
    service_cidr: Optional[StrictStr] = Field(default=None, description="Service CIDR, if any.", alias="serviceCidr")
    type: Optional[StrictStr] = Field(default=None, description="The type of this network, either Client or Private.")
    ...
    vlan_attachments: Optional[List[IntakeVlanAttachment]] = Field(default=None, description="List of VLAN attachments. As of now there are always 2 attachments, but it is going to change in the future (multi vlan).", alias="vlanAttachments")
    vlan_same_project: Optional[StrictBool] = Field(default=None, description="Whether the VLAN attachment pair is located in the same project.", alias="vlanSameProject")
    __properties: ClassVar[List[str]] = ["bandwidth", "cidr", "gcpService", "id", "jumboFramesEnabled", "name", "serviceCidr", "type", "userNote", "vlanAttachments", "vlanSameProject"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vlanAttachments": [IntakeVlanAttachment.from_dict(_item) for _item in obj["vlanAttachments"]] if obj.get("vlanAttachments") is not None else None,
            "vlanSameProject": obj.get("vlanSameProject")
        })
        return _obj
