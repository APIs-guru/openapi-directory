...
class GoogleCloudPaymentsResellerSubscriptionV1EntitleSubscriptionRequestLineItemEntitlementDetails(BaseModel):
    """
    The details of the line item to be entitled.
    """ # noqa: E501
    line_item_index: Optional[StrictInt] = Field(default=None, description="Required. The index of the line item to be entitled.", alias="lineItemIndex")
    products: Optional[List[StrictStr]] = Field(default=None, description="Optional. Only applicable if the line item corresponds to a hard bundle. Product resource names that identify the bundle elements to be entitled in the line item. If unspecified, all bundle elements will be entitled. The format is 'partners/{partner_id}/products/{product_id}'.")
    __properties: ClassVar[List[str]] = ["lineItemIndex", "products"]
