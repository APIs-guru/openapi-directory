...
class GoogleCloudPaymentsResellerSubscriptionV1ProductBundleDetailsBundleElement(BaseModel):
    """
    The individual product that is included in the bundle.
    """ # noqa: E501
    product: Optional[StrictStr] = Field(default=None, description="Required. Output only. Product resource name that identifies the bundle element. The format is 'partners/{partner_id}/products/{product_id}'.")
