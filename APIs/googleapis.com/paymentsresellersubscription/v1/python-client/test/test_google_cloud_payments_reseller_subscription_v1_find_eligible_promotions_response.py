...
class TestGoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse(unittest.TestCase):
    """GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse:
        """Test GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse`
        """
        model = GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse()
        if include_optional:
    ...
    def testGoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse(self):
        """Test GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse"""
