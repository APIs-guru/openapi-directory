...
class TestGoogleCloudPaymentsResellerSubscriptionV1Promotion(unittest.TestCase):
    """GoogleCloudPaymentsResellerSubscriptionV1Promotion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPaymentsResellerSubscriptionV1Promotion:
        """Test GoogleCloudPaymentsResellerSubscriptionV1Promotion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPaymentsResellerSubscriptionV1Promotion`
        """
        model = GoogleCloudPaymentsResellerSubscriptionV1Promotion()
        if include_optional:
    ...
    def testGoogleCloudPaymentsResellerSubscriptionV1Promotion(self):
        """Test GoogleCloudPaymentsResellerSubscriptionV1Promotion"""
