...
class HashesApi:
    ...
    @validate_call
    def safebrowsing_hashes_search(
        self,
        ...
        hash_prefixes: Annotated[Optional[List[StrictStr]], Field(description="Required. The hash prefixes to be looked up. Clients MUST NOT send more than 1000 hash prefixes. However, following the URL processing procedure, clients SHOULD NOT need to send more than 30 hash prefixes. Currently each hash prefix is required to be exactly 4 bytes long. This MAY be relaxed in the future.")] = None,
        ...
        _param = self._safebrowsing_hashes_search_serialize(
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleSecuritySafebrowsingV5SearchHashesResponse",
        }
    ...
    @validate_call
    def safebrowsing_hashes_search_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def safebrowsing_hashes_search_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _safebrowsing_hashes_search_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if hash_prefixes is not None:
            ...
            _query_params.append(('hashPrefixes', hash_prefixes))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v5/hashes:search',
