...
class GoogleSecuritySafebrowsingV4ThreatEntryMetadata(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[GoogleSecuritySafebrowsingV4ThreatEntryMetadataMetadataEntry]] = Field(default=None, description="The metadata entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GoogleSecuritySafebrowsingV4ThreatEntryMetadataMetadataEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
