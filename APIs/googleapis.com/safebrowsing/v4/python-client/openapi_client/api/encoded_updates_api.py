...
class EncodedUpdatesApi:
    ...
    def safebrowsing_encoded_updates_get(
        self,
        encoded_request: Annotated[StrictStr, Field(description="A serialized FetchThreatListUpdatesRequest proto.")],
        ...
        client_id: Annotated[Optional[StrictStr], Field(description="A client ID that uniquely identifies the client implementation of the Safe Browsing API.")] = None,
        client_version: Annotated[Optional[StrictStr], Field(description="The version of the client implementation.")] = None,
        ...
        :param encoded_request: A serialized FetchThreatListUpdatesRequest proto. (required)
        :type encoded_request: str
        ...
        :param client_id: A client ID that uniquely identifies the client implementation of the Safe Browsing API.
        :type client_id: str
        :param client_version: The version of the client implementation.
        ...
        _param = self._safebrowsing_encoded_updates_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse",
        }
    ...
    @validate_call
    def safebrowsing_encoded_updates_get_with_http_info(
        self,
        encoded_request: Annotated[StrictStr, Field(description="A serialized FetchThreatListUpdatesRequest proto.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse]:
        """safebrowsing_encoded_updates_get
    ...
    @validate_call
    def safebrowsing_encoded_updates_get_without_preload_content(
        self,
        encoded_request: Annotated[StrictStr, Field(description="A serialized FetchThreatListUpdatesRequest proto.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _safebrowsing_encoded_updates_get_serialize(
        self,
        encoded_request,
        xgafv,
        access_token,
        ...
        if encoded_request is not None:
            _path_params['encodedRequest'] = encoded_request
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v4/encodedUpdates/{encodedRequest}',
