...
class TestGoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse(unittest.TestCase):
    """GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse:
        """Test GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse`
        """
        model = GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse()
        if include_optional:
    ...
    def testGoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse(self):
        """Test GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse"""
