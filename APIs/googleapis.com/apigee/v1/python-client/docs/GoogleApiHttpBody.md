...
google_api_http_body_instance = GoogleApiHttpBody.from_json(json)
# print the JSON string representation of the object
print(GoogleApiHttpBody.to_json())

# convert the object into a dict
google_api_http_body_dict = google_api_http_body_instance.to_dict()
# create an instance of GoogleApiHttpBody from a dict
google_api_http_body_from_dict = GoogleApiHttpBody.from_dict(google_api_http_body_dict)
```
