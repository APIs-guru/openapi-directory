...
class GoogleCloudApigeeV1ComputeEnvironmentScoresResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A page token, received from a previous `ComputeScore` call. Provide this to retrieve the subsequent page.", alias="nextPageToken")
    scores: Optional[List[GoogleCloudApigeeV1Score]] = Field(default=None, description="List of scores. One score per day.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "scores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scores": [GoogleCloudApigeeV1Score.from_dict(_item) for _item in obj["scores"]] if obj.get("scores") is not None else None
        })
        return _obj
