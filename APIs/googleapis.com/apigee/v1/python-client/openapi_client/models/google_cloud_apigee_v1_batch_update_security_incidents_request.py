...
class GoogleCloudApigeeV1BatchUpdateSecurityIncidentsRequest(BaseModel):
    """
    Request for BatchUpdateSecurityIncident.
    """ # noqa: E501
    requests: Optional[List[GoogleCloudApigeeV1UpdateSecurityIncidentRequest]] = Field(default=None, description="Optional. Required. The request message specifying the resources to update. A maximum of 1000 can be modified in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleCloudApigeeV1UpdateSecurityIncidentRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
