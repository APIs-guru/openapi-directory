...
class GoogleCloudApigeeV1ListDatastoresResponse(BaseModel):
    ...
    """ # noqa: E501
    datastores: Optional[List[GoogleCloudApigeeV1Datastore]] = Field(default=None, description="A list of datastores")
    __properties: ClassVar[List[str]] = ["datastores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datastores": [GoogleCloudApigeeV1Datastore.from_dict(_item) for _item in obj["datastores"]] if obj.get("datastores") is not None else None
        })
        return _obj
