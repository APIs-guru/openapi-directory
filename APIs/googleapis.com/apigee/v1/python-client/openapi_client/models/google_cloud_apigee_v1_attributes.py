...
class GoogleCloudApigeeV1Attributes(BaseModel):
    ...
    """ # noqa: E501
    attribute: Optional[List[GoogleCloudApigeeV1Attribute]] = Field(default=None, description="List of attributes.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudApigeeV1Attributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudApigeeV1Attributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attribute": [GoogleCloudApigeeV1Attribute.from_dict(_item) for _item in obj["attribute"]] if obj.get("attribute") is not None else None
        })
        return _obj
