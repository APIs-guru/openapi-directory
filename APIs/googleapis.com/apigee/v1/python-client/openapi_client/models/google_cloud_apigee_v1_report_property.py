...
class GoogleCloudApigeeV1ReportProperty(BaseModel):
    ...
    """ # noqa: E501
    var_property: Optional[StrictStr] = Field(default=None, description="name of the property", alias="property")
    value: Optional[List[GoogleCloudApigeeV1Attribute]] = Field(default=None, description="property values")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [GoogleCloudApigeeV1Attribute.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
