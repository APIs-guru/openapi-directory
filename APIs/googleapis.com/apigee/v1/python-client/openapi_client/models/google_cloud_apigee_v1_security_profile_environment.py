...
class GoogleCloudApigeeV1SecurityProfileEnvironment(BaseModel):
    ...
    """ # noqa: E501
    attach_time: Optional[StrictStr] = Field(default=None, description="Output only. Time at which environment was attached to the security profile.", alias="attachTime")
    environment: Optional[StrictStr] = Field(default=None, description="Output only. Name of the environment.")
    __properties: ClassVar[List[str]] = ["attachTime", "environment"]
