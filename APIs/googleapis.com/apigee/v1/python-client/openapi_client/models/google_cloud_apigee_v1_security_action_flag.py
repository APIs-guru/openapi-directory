...
class GoogleCloudApigeeV1SecurityActionFlag(BaseModel):
    """
    The message that should be set in the case of a Flag action.
    """ # noqa: E501
    headers: Optional[List[GoogleCloudApigeeV1SecurityActionHttpHeader]] = Field(default=None, description="Optional. A list of HTTP headers to be sent to the target in case of a FLAG SecurityAction. Limit 5 headers per SecurityAction. At least one is mandatory.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": [GoogleCloudApigeeV1SecurityActionHttpHeader.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None
        })
        return _obj
