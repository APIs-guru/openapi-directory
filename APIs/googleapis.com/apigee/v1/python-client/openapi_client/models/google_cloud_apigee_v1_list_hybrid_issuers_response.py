...
class GoogleCloudApigeeV1ListHybridIssuersResponse(BaseModel):
    ...
    """ # noqa: E501
    issuers: Optional[List[GoogleCloudApigeeV1ServiceIssuersMapping]] = Field(default=None, description="Lists of hybrid services and its trusted issuer email ids.")
    __properties: ClassVar[List[str]] = ["issuers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.issuers:
            for _item_issuers in self.issuers:
                if _item_issuers:
                    _items.append(_item_issuers.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issuers": [GoogleCloudApigeeV1ServiceIssuersMapping.from_dict(_item) for _item in obj["issuers"]] if obj.get("issuers") is not None else None
        })
        return _obj
