...
class GoogleCloudApigeeV1OperationConfig(BaseModel):
    ...
    """ # noqa: E501
    api_source: Optional[StrictStr] = Field(default=None, description="Required. Name of the API proxy or remote service with which the resources, methods, and quota are associated.", alias="apiSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": [GoogleCloudApigeeV1Operation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
