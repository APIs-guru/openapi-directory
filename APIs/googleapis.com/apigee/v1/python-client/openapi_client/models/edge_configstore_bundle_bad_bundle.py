...
class EdgeConfigstoreBundleBadBundle(BaseModel):
    ...
    """ # noqa: E501
    violations: Optional[List[EdgeConfigstoreBundleBadBundleViolation]] = Field(default=None, description="Describes all precondition violations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "violations": [EdgeConfigstoreBundleBadBundleViolation.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None
        })
        return _obj
