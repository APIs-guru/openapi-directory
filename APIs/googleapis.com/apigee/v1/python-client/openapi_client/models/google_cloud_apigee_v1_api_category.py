...
class GoogleCloudApigeeV1ApiCategory(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the category (a UUID).")
    name: Optional[StrictStr] = Field(default=None, description="Name of the category.")
    site_id: Optional[StrictStr] = Field(default=None, description="Name of the portal.", alias="siteId")
    update_time: Optional[StrictStr] = Field(default=None, description="Time the category was last modified in milliseconds since epoch.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["id", "name", "siteId", "updateTime"]
