...
class GoogleCloudApigeeV1EndpointChainingRule(BaseModel):
    ...
    """ # noqa: E501
    deployment_group: Optional[StrictStr] = Field(default=None, description="The deployment group to target for cross-shard chaining calls to these proxies.", alias="deploymentGroup")
    proxy_ids: Optional[List[StrictStr]] = Field(default=None, description="List of proxy ids which may be found in the given deployment group.", alias="proxyIds")
    __properties: ClassVar[List[str]] = ["deploymentGroup", "proxyIds"]
