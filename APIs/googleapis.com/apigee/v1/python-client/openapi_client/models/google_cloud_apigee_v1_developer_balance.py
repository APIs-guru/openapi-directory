...
class GoogleCloudApigeeV1DeveloperBalance(BaseModel):
    ...
    """ # noqa: E501
    wallets: Optional[List[GoogleCloudApigeeV1DeveloperBalanceWallet]] = Field(default=None, description="Output only. List of all wallets. Each individual wallet stores the account balance for a particular currency.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wallets": [GoogleCloudApigeeV1DeveloperBalanceWallet.from_dict(_item) for _item in obj["wallets"]] if obj.get("wallets") is not None else None
        })
        return _obj
