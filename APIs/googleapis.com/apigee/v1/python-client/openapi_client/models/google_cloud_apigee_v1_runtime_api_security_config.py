...
class GoogleCloudApigeeV1RuntimeApiSecurityConfig(BaseModel):
    """
    Runtime configuration for the API Security add-on.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="If the API Security is enabled or not.")
