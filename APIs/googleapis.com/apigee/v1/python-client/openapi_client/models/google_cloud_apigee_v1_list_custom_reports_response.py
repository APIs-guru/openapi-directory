...
class GoogleCloudApigeeV1ListCustomReportsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["qualifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qualifier": [GoogleCloudApigeeV1CustomReport.from_dict(_item) for _item in obj["qualifier"]] if obj.get("qualifier") is not None else None
        })
        return _obj
