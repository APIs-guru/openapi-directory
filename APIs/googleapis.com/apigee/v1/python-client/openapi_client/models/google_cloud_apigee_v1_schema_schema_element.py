...
class GoogleCloudApigeeV1SchemaSchemaElement(BaseModel):
    ...
    properties: Optional[GoogleCloudApigeeV1SchemaSchemaProperty] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": GoogleCloudApigeeV1SchemaSchemaProperty.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
