...
class GoogleCloudApigeeV1Attribute(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="API key of the attribute.")
    value: Optional[StrictStr] = Field(default=None, description="Value of the attribute.")
