...
class GoogleCloudApigeeV1InstanceDeploymentStatusDeployedRevision(BaseModel):
    ...
    """ # noqa: E501
    percentage: Optional[StrictInt] = Field(default=None, description="Percentage of MP replicas reporting this revision.")
    revision: Optional[StrictStr] = Field(default=None, description="API proxy revision reported as deployed.")
    __properties: ClassVar[List[str]] = ["percentage", "revision"]
