...
class GoogleCloudApigeeV1ServiceIssuersMapping(BaseModel):
    ...
    """ # noqa: E501
    email_ids: Optional[List[StrictStr]] = Field(default=None, description="List of trusted issuer email ids.", alias="emailIds")
    service: Optional[StrictStr] = Field(default=None, description="String indicating the Apigee service name.")
    __properties: ClassVar[List[str]] = ["emailIds", "service"]
