...
class GoogleCloudApigeeV1ResourceFile(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="ID of the resource file.")
    type: Optional[StrictStr] = Field(default=None, description="Resource file type. {{ resource_file_type }}")
