...
class GoogleCloudApigeeV1ListDeploymentsResponse(BaseModel):
    ...
    """ # noqa: E501
    deployments: Optional[List[GoogleCloudApigeeV1Deployment]] = Field(default=None, description="List of deployments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployments": [GoogleCloudApigeeV1Deployment.from_dict(_item) for _item in obj["deployments"]] if obj.get("deployments") is not None else None
        })
        return _obj
