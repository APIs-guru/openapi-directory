...
class GoogleCloudApigeeV1GenerateUploadUrlResponse(BaseModel):
    ...
    """ # noqa: E501
    upload_uri: Optional[StrictStr] = Field(default=None, description="The Google Cloud Storage signed URL that can be used to upload a new Archive zip file.", alias="uploadUri")
