...
class GoogleCloudApigeeV1TraceConfig(BaseModel):
    ...
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(default=None, description="Required. Endpoint of the exporter.")
    exporter: Optional[StrictStr] = Field(default=None, description="Required. Exporter that is used to view the distributed trace captured using OpenCensus. An exporter sends traces to any backend that is capable of consuming them. Recorded spans can be exported by registered exporters.")
    sampling_config: Optional[GoogleCloudApigeeV1TraceSamplingConfig] = Field(default=None, alias="samplingConfig")
    __properties: ClassVar[List[str]] = ["endpoint", "exporter", "samplingConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "samplingConfig": GoogleCloudApigeeV1TraceSamplingConfig.from_dict(obj["samplingConfig"]) if obj.get("samplingConfig") is not None else None
        })
        return _obj
