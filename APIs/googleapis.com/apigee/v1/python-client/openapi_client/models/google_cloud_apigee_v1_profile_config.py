...
class GoogleCloudApigeeV1ProfileConfig(BaseModel):
    """
    ProfileConfig defines a set of categories and policies which will be used to compute security score.
    """ # noqa: E501
    categories: Optional[List[GoogleCloudApigeeV1ProfileConfigCategory]] = Field(default=None, description="List of categories of profile config.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [GoogleCloudApigeeV1ProfileConfigCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
