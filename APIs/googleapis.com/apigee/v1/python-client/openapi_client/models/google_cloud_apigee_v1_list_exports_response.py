...
class GoogleCloudApigeeV1ListExportsResponse(BaseModel):
    ...
    """ # noqa: E501
    exports: Optional[List[GoogleCloudApigeeV1Export]] = Field(default=None, description="Details of the export jobs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exports": [GoogleCloudApigeeV1Export.from_dict(_item) for _item in obj["exports"]] if obj.get("exports") is not None else None
        })
        return _obj
