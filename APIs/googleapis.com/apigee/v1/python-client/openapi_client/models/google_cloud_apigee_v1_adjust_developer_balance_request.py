...
class GoogleCloudApigeeV1AdjustDeveloperBalanceRequest(BaseModel):
    ...
    """ # noqa: E501
    adjustment: Optional[GoogleTypeMoney] = None
    __properties: ClassVar[List[str]] = ["adjustment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adjustment": GoogleTypeMoney.from_dict(obj["adjustment"]) if obj.get("adjustment") is not None else None
        })
        return _obj
