...
class GoogleCloudApigeeV1Query(BaseModel):
    ...
    envgroup_hostname: Optional[StrictStr] = Field(default=None, description="Hostname needs to be specified if query intends to run at host level. This field is only allowed when query is submitted by CreateHostAsyncQuery where analytics data will be grouped by organization and hostname.", alias="envgroupHostname")
    ...
    metrics: Optional[List[GoogleCloudApigeeV1QueryMetric]] = Field(default=None, description="A list of Metrics.")
    name: Optional[StrictStr] = Field(default=None, description="Asynchronous Query Name.")
    output_format: Optional[StrictStr] = Field(default=None, description="Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property.", alias="outputFormat")
    ...
    __properties: ClassVar[List[str]] = ["csvDelimiter", "dimensions", "envgroupHostname", "filter", "groupByTimeUnit", "limit", "metrics", "name", "outputFormat", "reportDefinitionId", "timeRange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "metrics": [GoogleCloudApigeeV1QueryMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "name": obj.get("name"),
