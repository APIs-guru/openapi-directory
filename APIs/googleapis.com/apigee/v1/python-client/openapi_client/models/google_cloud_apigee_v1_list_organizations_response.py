...
class GoogleCloudApigeeV1ListOrganizationsResponse(BaseModel):
    ...
    """ # noqa: E501
    organizations: Optional[List[GoogleCloudApigeeV1OrganizationProjectMapping]] = Field(default=None, description="List of Apigee organizations and associated Google Cloud projects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [GoogleCloudApigeeV1OrganizationProjectMapping.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
