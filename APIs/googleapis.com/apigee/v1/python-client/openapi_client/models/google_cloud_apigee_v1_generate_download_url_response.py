...
class GoogleCloudApigeeV1GenerateDownloadUrlResponse(BaseModel):
    ...
    """ # noqa: E501
    download_uri: Optional[StrictStr] = Field(default=None, description="The Google Cloud Storage signed URL that can be used to download the Archive zip file.", alias="downloadUri")
