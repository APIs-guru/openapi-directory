...
class GoogleCloudApigeeV1ListDataCollectorsResponse(BaseModel):
    ...
    """ # noqa: E501
    data_collectors: Optional[List[GoogleCloudApigeeV1DataCollector]] = Field(default=None, description="Data collectors in the specified organization.", alias="dataCollectors")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Page token that you can include in a ListDataCollectors request to retrieve the next page. If omitted, no subsequent pages exist.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["dataCollectors", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataCollectors": [GoogleCloudApigeeV1DataCollector.from_dict(_item) for _item in obj["dataCollectors"]] if obj.get("dataCollectors") is not None else None,
