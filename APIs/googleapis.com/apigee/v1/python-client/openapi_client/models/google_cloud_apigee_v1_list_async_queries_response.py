...
class GoogleCloudApigeeV1ListAsyncQueriesResponse(BaseModel):
    ...
    """ # noqa: E501
    queries: Optional[List[GoogleCloudApigeeV1AsyncQuery]] = Field(default=None, description="The asynchronous queries belong to requested resource name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [GoogleCloudApigeeV1AsyncQuery.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
