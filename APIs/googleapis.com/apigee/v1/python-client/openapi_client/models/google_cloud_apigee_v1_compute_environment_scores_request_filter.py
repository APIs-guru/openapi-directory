...
class GoogleCloudApigeeV1ComputeEnvironmentScoresRequestFilter(BaseModel):
    ...
    """ # noqa: E501
    score_path: Optional[StrictStr] = Field(default=None, description="Optional. Return scores for this component. Example: \"/org@myorg/envgroup@myenvgroup/env@myenv/proxies/proxy@myproxy/source\"", alias="scorePath")
    __properties: ClassVar[List[str]] = ["scorePath"]
