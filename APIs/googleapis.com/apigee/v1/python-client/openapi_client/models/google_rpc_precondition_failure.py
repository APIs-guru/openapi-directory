...
class GoogleRpcPreconditionFailure(BaseModel):
    ...
    """ # noqa: E501
    violations: Optional[List[GoogleRpcPreconditionFailureViolation]] = Field(default=None, description="Describes all precondition violations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "violations": [GoogleRpcPreconditionFailureViolation.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None
        })
        return _obj
