...
class GoogleCloudApigeeV1KeyValueEntry(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Resource URI that can be used to identify the scope of the key value map entries.")
    value: Optional[StrictStr] = Field(default=None, description="Required. Data or payload that is being retrieved and associated with the unique key.")
