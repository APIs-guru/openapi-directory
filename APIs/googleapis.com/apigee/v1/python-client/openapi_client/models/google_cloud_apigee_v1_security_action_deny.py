...
class GoogleCloudApigeeV1SecurityActionDeny(BaseModel):
    """
    Message that should be set in case of a Deny Action.
    """ # noqa: E501
    response_code: Optional[StrictInt] = Field(default=None, description="Optional. The HTTP response code if the Action = DENY.", alias="responseCode")
