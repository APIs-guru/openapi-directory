...
class TestGoogleCloudApigeeV1SetAddonsRequest(unittest.TestCase):
    """GoogleCloudApigeeV1SetAddonsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudApigeeV1SetAddonsRequest:
        """Test GoogleCloudApigeeV1SetAddonsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudApigeeV1SetAddonsRequest`
        """
        model = GoogleCloudApigeeV1SetAddonsRequest()
        if include_optional:
            return GoogleCloudApigeeV1SetAddonsRequest(
    ...
    def testGoogleCloudApigeeV1SetAddonsRequest(self):
        """Test GoogleCloudApigeeV1SetAddonsRequest"""
