...
class TestGoogleCloudApigeeV1OperationConfig(unittest.TestCase):
    """GoogleCloudApigeeV1OperationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudApigeeV1OperationConfig:
        """Test GoogleCloudApigeeV1OperationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudApigeeV1OperationConfig`
        """
        model = GoogleCloudApigeeV1OperationConfig()
        if include_optional:
    ...
    def testGoogleCloudApigeeV1OperationConfig(self):
        """Test GoogleCloudApigeeV1OperationConfig"""
