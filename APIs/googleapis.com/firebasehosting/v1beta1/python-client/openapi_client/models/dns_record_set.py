...
class DnsRecordSet(BaseModel):
    ...
    domain_name: Optional[StrictStr] = Field(default=None, description="Output only. The domain name the record set pertains to.", alias="domainName")
    records: Optional[List[DnsRecord]] = Field(default=None, description="Output only. Records on the domain.")
    __properties: ClassVar[List[str]] = ["checkError", "domainName", "records"]
