...
class ListDomainsResponse(BaseModel):
    ...
    """ # noqa: E501
    domains: Optional[List[Domain]] = Field(default=None, description="The list of domains, if any exist.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="The pagination token, if more results exist.", alias="nextPageToken")
