...
class ListCustomDomainsResponse(BaseModel):
    ...
    """ # noqa: E501
    custom_domains: Optional[List[CustomDomain]] = Field(default=None, description="A list of `CustomDomain` entities associated with the specified Firebase `Site`.", alias="customDomains")
    next_page_token: Optional[StrictStr] = Field(default=None, description="The pagination token, if more results exist beyond the ones in this response. Include this token in your next call to `ListCustomDomains`. Page tokens are short-lived and should not be stored.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["customDomains", "nextPageToken"]
