...
------------ | ------------- | ------------- | -------------
**additional_roles** | **List[str]** | Output only. Additional roles for this user. Only &#x60;commenter&#x60; is currently possible, though more may be supported in the future. | [optional] 
...
**role** | **str** | Output only. The primary role for this user. While new values may be added in the future, the following are currently possible: * &#x60;organizer&#x60; * &#x60;fileOrganizer&#x60; * &#x60;writer&#x60; * &#x60;reader&#x60; | [optional] 
