...
class FileLabelInfo(BaseModel):
    ...
    """ # noqa: E501
    labels: Optional[List[Label]] = Field(default=None, description="Output only. The set of labels on the file as requested by the label IDs in the `includeLabels` parameter. By default, no labels are returned.")
