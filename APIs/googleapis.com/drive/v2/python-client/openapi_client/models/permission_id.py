...
class PermissionId(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='drive#permissionId', description="This is always `drive#permissionId`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'drive#permissionId'
        })
        return _obj
