...
class FileImageMediaMetadata(BaseModel):
    ...
    var_date: Optional[StrictStr] = Field(default=None, description="Output only. The date and time the photo was taken (EXIF format timestamp).", alias="date")
    ...
    __properties: ClassVar[List[str]] = ["aperture", "cameraMake", "cameraModel", "colorSpace", "date", "exposureBias", "exposureMode", "exposureTime", "flashUsed", "focalLength", "height", "isoSpeed", "lens", "location", "maxApertureValue", "meteringMode", "rotation", "sensor", "subjectDistance", "whiteBalance", "width"]
