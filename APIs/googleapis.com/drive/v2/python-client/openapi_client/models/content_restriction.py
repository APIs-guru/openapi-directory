...
class ContentRestriction(BaseModel):
    ...
    restriction_date: Optional[datetime] = Field(default=None, description="The time at which the content restriction was set (formatted RFC 3339 timestamp). Only populated if readOnly is true.", alias="restrictionDate")
    ...
    __properties: ClassVar[List[str]] = ["ownerRestricted", "readOnly", "reason", "restrictingUser", "restrictionDate", "systemRestricted", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restrictionDate": obj.get("restrictionDate"),
