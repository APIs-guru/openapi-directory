...
class PermissionsApi:
    ...
    def drive_permissions_delete(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID for the file or shared drive.")],
        permission_id: Annotated[StrictStr, Field(description="The ID for the permission.")],
        ...
        :param file_id: The ID for the file or shared drive. (required)
        :type file_id: str
        :param permission_id: The ID for the permission. (required)
    ...
    @validate_call
    def drive_permissions_get_id_for_email(
        self,
        email: Annotated[StrictStr, Field(description="The email address for which to return a permission ID")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        _param = self._drive_permissions_get_id_for_email_serialize(
            email=email,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def drive_permissions_get_id_for_email_with_http_info(
        self,
        email: Annotated[StrictStr, Field(description="The email address for which to return a permission ID")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def drive_permissions_get_id_for_email_without_preload_content(
        self,
        email: Annotated[StrictStr, Field(description="The email address for which to return a permission ID")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _drive_permissions_get_id_for_email_serialize(
        self,
        email,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/permissionIds/{email}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def drive_permissions_insert(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        email_message: Annotated[Optional[StrictStr], Field(description="A plain text custom message to include in notification emails.")] = None,
        ...
        send_notification_emails: Annotated[Optional[StrictBool], Field(description="Whether to send notification emails when sharing to users or groups. This parameter is ignored and an email is sent if the `role` is `owner`.")] = None,
        supports_all_drives: Annotated[Optional[StrictBool], Field(description="Whether the requesting application supports both My Drives and shared drives.")] = None,
        supports_team_drives: Annotated[Optional[StrictBool], Field(description="Deprecated: Use `supportsAllDrives` instead.")] = None,
        use_domain_admin_access: Annotated[Optional[StrictBool], Field(description="Issue the request as a domain administrator; if set to true, then the requester will be granted access if the file ID parameter refers to a shared drive and the requester is an administrator of the domain to which the shared drive belongs.")] = None,
        ...
        _param = self._drive_permissions_insert_serialize(
            file_id=file_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def drive_permissions_insert_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID for the file or shared drive.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def drive_permissions_insert_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID for the file or shared drive.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _drive_permissions_insert_serialize(
        self,
        file_id,
        xgafv,
        access_token,
        ...
        if send_notification_emails is not None:
            
            _query_params.append(('sendNotificationEmails', send_notification_emails))
    ...
    def drive_permissions_patch(
        ...
        supports_all_drives: Annotated[Optional[StrictBool], Field(description="Whether the requesting application supports both My Drives and shared drives.")] = None,
        supports_team_drives: Annotated[Optional[StrictBool], Field(description="Deprecated: Use `supportsAllDrives` instead.")] = None,
        transfer_ownership: Annotated[Optional[StrictBool], Field(description="Whether changing a role to `owner` downgrades the current owners to writers. Does nothing if the specified role is not `owner`.")] = None,
        use_domain_admin_access: Annotated[Optional[StrictBool], Field(description="Issue the request as a domain administrator; if set to true, then the requester will be granted access if the file ID parameter refers to a shared drive and the requester is an administrator of the domain to which the shared drive belongs.")] = None,
        permission: Optional[Permission] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._drive_permissions_patch_serialize(
            file_id=file_id,
            permission_id=permission_id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def drive_permissions_patch_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID for the file or shared drive.")],
        permission_id: Annotated[StrictStr, Field(description="The ID for the permission.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def drive_permissions_patch_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID for the file or shared drive.")],
        permission_id: Annotated[StrictStr, Field(description="The ID for the permission.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _drive_permissions_patch_serialize(
        self,
        file_id,
        permission_id,
        xgafv,
