...
class AboutApi:
    ...
    def drive_about_get(
        ...
        include_subscribed: Annotated[Optional[StrictBool], Field(description="Whether to count changes outside the My Drive hierarchy. When set to false, changes to files such as those in the Application Data folder or shared files which have not been added to My Drive will be omitted from the `maxChangeIdCount`.")] = None,
        max_change_id_count: Annotated[Optional[StrictStr], Field(description="Maximum number of remaining change IDs to count")] = None,
        start_change_id: Annotated[Optional[StrictStr], Field(description="Change ID to start counting from when calculating number of remaining change IDs")] = None,
        ...
        _param = self._drive_about_get_serialize(
            ...
            max_change_id_count=max_change_id_count,
    ...
    def _drive_about_get_serialize(
        ...
        if max_change_id_count is not None:
            ...
            _query_params.append(('maxChangeIdCount', max_change_id_count))
