...
class TestFileLabelInfo(unittest.TestCase):
    """FileLabelInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLabelInfo:
        """Test FileLabelInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLabelInfo`
        """
        model = FileLabelInfo()
        if include_optional:
