...
> Permission drive_permissions_create(file_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, email_message=email_message, enforce_single_parent=enforce_single_parent, move_to_new_owners_root=move_to_new_owners_root, send_notification_email=send_notification_email, supports_all_drives=supports_all_drives, supports_team_drives=supports_team_drives, transfer_ownership=transfer_ownership, use_domain_admin_access=use_domain_admin_access, permission=permission)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    file_id = 'file_id_example' # str | The ID of the file or shared drive.
    ...
    email_message = 'email_message_example' # str | A plain text custom message to include in the notification email. (optional)
    ...
    send_notification_email = True # bool | Whether to send a notification email when sharing to users or groups. This defaults to true for users and groups, and is not allowed for other requests. It must not be disabled for ownership transfers. (optional)
    ...
    transfer_ownership = True # bool | Whether to transfer ownership to the specified user and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect. (optional)
    ...
    try:
        api_response = api_instance.drive_permissions_create(file_id, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, email_message=email_message, enforce_single_parent=enforce_single_parent, move_to_new_owners_root=move_to_new_owners_root, send_notification_email=send_notification_email, supports_all_drives=supports_all_drives, supports_team_drives=supports_team_drives, transfer_ownership=transfer_ownership, use_domain_admin_access=use_domain_admin_access, permission=permission)
        print("The response of PermissionsApi->drive_permissions_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsApi->drive_permissions_create: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **file_id** | **str**| The ID of the file or shared drive. | 
 ...
 **email_message** | **str**| A plain text custom message to include in the notification email. | [optional] 
 ...
 **send_notification_email** | **bool**| Whether to send a notification email when sharing to users or groups. This defaults to true for users and groups, and is not allowed for other requests. It must not be disabled for ownership transfers. | [optional] 
 ...
 **transfer_ownership** | **bool**| Whether to transfer ownership to the specified user and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect. | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PermissionsApi(api_client)
    file_id = 'file_id_example' # str | The ID of the file or shared drive.
    permission_id = 'permission_id_example' # str | The ID of the permission.
    xgafv = 'xgafv_example' # str | V1 error format. (optional)
    access_token = 'access_token_example' # str | OAuth access token. (optional)
    alt = 'alt_example' # str | Data format for response. (optional)
    param_callback = 'param_callback_example' # str | JSONP (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    page_size = 56 # int | The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned. (optional)
 ...
 **page_size** | **int**| The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned. | [optional] 
