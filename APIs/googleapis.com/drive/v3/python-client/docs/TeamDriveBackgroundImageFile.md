...
------------ | ------------- | ------------- | -------------
**id** | **str** | The ID of an image file in Drive to use for the background image. | [optional] 
...
team_drive_background_image_file_instance = TeamDriveBackgroundImageFile.from_json(json)
# print the JSON string representation of the object
print(TeamDriveBackgroundImageFile.to_json())

# convert the object into a dict
team_drive_background_image_file_dict = team_drive_background_image_file_instance.to_dict()
# create an instance of TeamDriveBackgroundImageFile from a dict
team_drive_background_image_file_from_dict = TeamDriveBackgroundImageFile.from_dict(team_drive_background_image_file_dict)
```
