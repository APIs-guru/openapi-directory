...
class App(BaseModel):
    ...
    create_in_folder_template: Optional[StrictStr] = Field(default=None, description="The template URL to create a file with this app in a given folder. The template contains the {folderId} to be replaced by the folder ID house the new file.", alias="createInFolderTemplate")
    create_url: Optional[StrictStr] = Field(default=None, description="The URL to create a file with this app.", alias="createUrl")
    ...
    icons: Optional[List[AppIcons]] = Field(default=None, description="The various icons for the app.")
    ...
    kind: Optional[StrictStr] = Field(default='drive#app', description="Output only. Identifies what kind of resource this is. Value: the fixed string \"drive#app\".")
    ...
    object_type: Optional[StrictStr] = Field(default=None, description="The type of object this app creates such as a Chart. If empty, the app name should be used instead.", alias="objectType")
    open_url_template: Optional[StrictStr] = Field(default=None, description="The template URL for opening files with this app. The template contains {ids} or {exportIds} to be replaced by the actual file IDs. For more information, see Open Files for the full documentation.", alias="openUrlTemplate")
    ...
    supports_create: Optional[StrictBool] = Field(default=None, description="Whether this app supports creating objects.", alias="supportsCreate")
    supports_import: Optional[StrictBool] = Field(default=None, description="Whether this app supports importing from Google Docs.", alias="supportsImport")
    ...
    supports_offline_create: Optional[StrictBool] = Field(default=None, description="Whether this app supports creating files when offline.", alias="supportsOfflineCreate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icons": [AppIcons.from_dict(_item) for _item in obj["icons"]] if obj.get("icons") is not None else None,
            "id": obj.get("id"),
