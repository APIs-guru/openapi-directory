...
class TeamDrive(BaseModel):
    ...
    created_time: Optional[datetime] = Field(default=None, description="The time at which the Team Drive was created (RFC 3339 date-time).", alias="createdTime")
    ...
    kind: Optional[StrictStr] = Field(default='drive#teamDrive', description="Identifies what kind of resource this is. Value: the fixed string `\"drive#teamDrive\"`.")
    ...
    theme_id: Optional[StrictStr] = Field(default=None, description="The ID of the theme from which the background image and color will be set. The set of possible `teamDriveThemes` can be retrieved from a `drive.about.get` response. When not specified on a `drive.teamdrives.create` request, a random theme is chosen from which the background image and color are set. This is a write-only field; it can only be set on requests that don't set `colorRgb` or `backgroundImageFile`.", alias="themeId")
    __properties: ClassVar[List[str]] = ["backgroundImageFile", "backgroundImageLink", "capabilities", "colorRgb", "createdTime", "id", "kind", "name", "orgUnitId", "restrictions", "themeId"]
