...
class Change(BaseModel):
    ...
    file_id: Optional[StrictStr] = Field(default=None, description="The ID of the file which has changed.", alias="fileId")
    kind: Optional[StrictStr] = Field(default='drive#change', description="Identifies what kind of resource this is. Value: the fixed string `\"drive#change\"`.")
    removed: Optional[StrictBool] = Field(default=None, description="Whether the file or shared drive has been removed from this list of changes, for example by deletion or loss of access.")
    ...
    time: Optional[datetime] = Field(default=None, description="The time of this change (RFC 3339 date-time).")
    type: Optional[StrictStr] = Field(default=None, description="Deprecated: Use `changeType` instead.")
    __properties: ClassVar[List[str]] = ["changeType", "drive", "driveId", "file", "fileId", "kind", "removed", "teamDrive", "teamDriveId", "time", "type"]
