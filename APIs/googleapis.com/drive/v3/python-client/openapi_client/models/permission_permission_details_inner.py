...
class PermissionPermissionDetailsInner(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="Output only. The primary role for this user. While new values may be added in the future, the following are currently possible: * `organizer` * `fileOrganizer` * `writer` * `commenter` * `reader`")
    __properties: ClassVar[List[str]] = ["inherited", "inheritedFrom", "permissionType", "role"]
