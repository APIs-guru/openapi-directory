...
class RepliesApi:
    ...
    def drive_replies_create(
        ...
        _param = self._drive_replies_create_serialize(
            file_id=file_id,
    ...
    @validate_call
    def drive_replies_create_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file.")],
        comment_id: Annotated[StrictStr, Field(description="The ID of the comment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def drive_replies_create_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file.")],
        comment_id: Annotated[StrictStr, Field(description="The ID of the comment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _drive_replies_create_serialize(
        self,
        file_id,
        comment_id,
        xgafv,
    ...
    def drive_replies_get(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        include_deleted: Annotated[Optional[StrictBool], Field(description="Whether to return deleted replies. Deleted replies will not include their original content.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def drive_replies_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        include_deleted: Annotated[Optional[StrictBool], Field(description="Whether to include deleted replies. Deleted replies will not include their original content.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of replies to return per page.")] = None,
