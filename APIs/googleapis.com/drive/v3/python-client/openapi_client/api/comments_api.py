...
class CommentsApi:
    ...
    def drive_comments_create(
        ...
        _param = self._drive_comments_create_serialize(
            file_id=file_id,
            xgafv=xgafv,
    ...
    @validate_call
    def drive_comments_create_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def drive_comments_create_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="The ID of the file.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _drive_comments_create_serialize(
        self,
        file_id,
        xgafv,
        access_token,
    ...
    def drive_comments_get(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        include_deleted: Annotated[Optional[StrictBool], Field(description="Whether to return deleted comments. Deleted comments will not include their original content.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def drive_comments_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        include_deleted: Annotated[Optional[StrictBool], Field(description="Whether to include deleted comments. Deleted comments will not include their original content.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of comments to return per page.")] = None,
        ...
        start_modified_time: Annotated[Optional[StrictStr], Field(description="The minimum value of 'modifiedTime' for the result comments (RFC 3339 date-time).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _drive_comments_list_serialize(
        ...
        if start_modified_time is not None:
            ...
            _query_params.append(('startModifiedTime', start_modified_time))
