...
class ApplicationsApi:
    ...
    def games_management_applications_list_hidden(
        ...
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of player resources to return in the response, used for paging. For any response, the actual number of player resources returned may be less than the specified `maxResults`.")] = None,
        ...
        _param = self._games_management_applications_list_hidden_serialize(
    ...
    @validate_call
    def games_management_applications_list_hidden_with_http_info(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def games_management_applications_list_hidden_without_preload_content(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _games_management_applications_list_hidden_serialize(
        self,
        application_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/games/v1management/applications/{applicationId}/players/hidden',
