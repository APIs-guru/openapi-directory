...
class PlayersApi:
    ...
    def games_management_players_hide(
        ...
        _param = self._games_management_players_hide_serialize(
    ...
    @validate_call
    def games_management_players_hide_with_http_info(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def games_management_players_hide_without_preload_content(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _games_management_players_hide_serialize(
        self,
        application_id,
        player_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/games/v1management/applications/{applicationId}/players/hidden/{playerId}',
    ...
    def games_management_players_unhide(
        ...
        _param = self._games_management_players_unhide_serialize(
            application_id=application_id,
            player_id=player_id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def games_management_players_unhide_with_http_info(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def games_management_players_unhide_without_preload_content(
        self,
        application_id: Annotated[StrictStr, Field(description="The application ID from the Google Play developer console.")],
        player_id: Annotated[StrictStr, Field(description="A player ID. A value of `me` may be used in place of the authenticated player's ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _games_management_players_unhide_serialize(
        self,
        application_id,
        player_id,
        xgafv,
