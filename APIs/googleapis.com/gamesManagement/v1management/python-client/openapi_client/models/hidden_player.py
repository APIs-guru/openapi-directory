...
class HiddenPlayer(BaseModel):
    ...
    """ # noqa: E501
    hidden_time_millis: Optional[StrictStr] = Field(default=None, description="Output only. The time this player was hidden.", alias="hiddenTimeMillis")
    kind: Optional[StrictStr] = Field(default=None, description="Output only. Uniquely identifies the type of this resource. Value is always the fixed string `gamesManagement#hiddenPlayer`.")
    player: Optional[Player] = None
    __properties: ClassVar[List[str]] = ["hiddenTimeMillis", "kind", "player"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hiddenTimeMillis": obj.get("hiddenTimeMillis"),
            "kind": obj.get("kind"),
