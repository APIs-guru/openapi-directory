...
class EventsResetMultipleForAllRequest(BaseModel):
    ...
    """ # noqa: E501
    event_ids: Optional[List[StrictStr]] = Field(default=None, description="The IDs of events to reset.")
    kind: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the type of this resource. Value is always the fixed string `gamesManagement#eventsResetMultipleForAllRequest`.")
    __properties: ClassVar[List[str]] = ["event_ids", "kind"]
