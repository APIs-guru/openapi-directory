...
class TestRegressionMetrics(unittest.TestCase):
    """RegressionMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegressionMetrics:
        """Test RegressionMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegressionMetrics`
        """
    ...
    def testRegressionMetrics(self):
        """Test RegressionMetrics"""
