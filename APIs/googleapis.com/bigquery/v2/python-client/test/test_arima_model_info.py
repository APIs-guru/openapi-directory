...
class TestArimaModelInfo(unittest.TestCase):
    """ArimaModelInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArimaModelInfo:
        """Test ArimaModelInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArimaModelInfo`
        """
