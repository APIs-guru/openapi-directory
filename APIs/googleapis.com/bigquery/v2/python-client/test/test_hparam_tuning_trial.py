...
class TestHparamTuningTrial(unittest.TestCase):
    """HparamTuningTrial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HparamTuningTrial:
        """Test HparamTuningTrial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HparamTuningTrial`
        """
        model = HparamTuningTrial()
        if include_optional:
    ...
    def testHparamTuningTrial(self):
        """Test HparamTuningTrial"""
