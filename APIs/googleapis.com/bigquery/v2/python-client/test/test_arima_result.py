...
class TestArimaResult(unittest.TestCase):
    """ArimaResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArimaResult:
        """Test ArimaResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArimaResult`
        """
        model = ArimaResult()
        if include_optional:
            return ArimaResult(
