...
class TestRangeValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RangeValue:
        """Test RangeValue
        ...
        if include_optional:
            return RangeValue(
                end = openapi_client.models.query_parameter_value.QueryParameterValue(
                    array_values = [
                    ...
                    value = '', ),
                start = openapi_client.models.query_parameter_value.QueryParameterValue(
                    array_values = [
                        openapi_client.models.query_parameter_value.QueryParameterValue(
                            range_value = openapi_client.models.range_value.RangeValue(
                                end = , ), 
