...
class TestStandardSqlStructType(unittest.TestCase):
    """StandardSqlStructType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardSqlStructType:
        """Test StandardSqlStructType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardSqlStructType`
        """
        model = StandardSqlStructType()
        if include_optional:
    ...
    def testStandardSqlStructType(self):
        """Test StandardSqlStructType"""
