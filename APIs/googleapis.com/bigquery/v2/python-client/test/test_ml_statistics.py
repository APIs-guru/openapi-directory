...
class TestMlStatistics(unittest.TestCase):
    """MlStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MlStatistics:
        """Test MlStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MlStatistics`
        """
        model = MlStatistics()
        if include_optional:
            return MlStatistics(
