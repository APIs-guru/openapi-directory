...
class TestBqmlTrainingRun(unittest.TestCase):
    """BqmlTrainingRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BqmlTrainingRun:
        """Test BqmlTrainingRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BqmlTrainingRun`
        """
        model = BqmlTrainingRun()
        if include_optional:
