...
class TestStandardSqlField(unittest.TestCase):
    """StandardSqlField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardSqlField:
        """Test StandardSqlField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardSqlField`
        """
        model = StandardSqlField()
        if include_optional:
