...
class ProjectsApi:
    ...
    def bigquery_projects_get_service_account(
        ...
        _param = self._bigquery_projects_get_service_account_serialize(
    ...
    @validate_call
    def bigquery_projects_get_service_account_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. ID of the project.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetServiceAccountResponse]:
        """bigquery_projects_get_service_account
    ...
    @validate_call
    def bigquery_projects_get_service_account_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. ID of the project.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _bigquery_projects_get_service_account_serialize(
        self,
        project_id,
        xgafv,
        access_token,
    ...
    def bigquery_projects_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="`maxResults` unset returns all results, up to 50 per page. Additionally, the number of projects in a page may be fewer than `maxResults` because projects are retrieved and then filtered to only projects with the BigQuery API enabled.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Page token, returned by a previous call, to request the next page of results. If not present, no further pages are present.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param max_results: `maxResults` unset returns all results, up to 50 per page. Additionally, the number of projects in a page may be fewer than `maxResults` because projects are retrieved and then filtered to only projects with the BigQuery API enabled.
        :type max_results: int
        :param page_token: Page token, returned by a previous call, to request the next page of results. If not present, no further pages are present.
        :type page_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._bigquery_projects_list_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def bigquery_projects_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def bigquery_projects_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _bigquery_projects_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
