...
class RowAccessPoliciesApi:
    ...
    def bigquery_row_access_policies_list(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. Project ID of the row access policies to list.")],
        dataset_id: Annotated[StrictStr, Field(description="Required. Dataset ID of row access policies to list.")],
        table_id: Annotated[StrictStr, Field(description="Required. Table ID of the table to list row access policies.")],
        ...
        :param project_id: Required. Project ID of the row access policies to list. (required)
        :type project_id: str
        :param dataset_id: Required. Dataset ID of row access policies to list. (required)
        :type dataset_id: str
        :param table_id: Required. Table ID of the table to list row access policies. (required)
        :type table_id: str
        ...
        _param = self._bigquery_row_access_policies_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListRowAccessPoliciesResponse",
        }
    ...
    @validate_call
    def bigquery_row_access_policies_list_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. Project ID of the row access policies to list.")],
        dataset_id: Annotated[StrictStr, Field(description="Required. Dataset ID of row access policies to list.")],
        table_id: Annotated[StrictStr, Field(description="Required. Table ID of the table to list row access policies.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListRowAccessPoliciesResponse]:
        """bigquery_row_access_policies_list
    ...
    @validate_call
    def bigquery_row_access_policies_list_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Required. Project ID of the row access policies to list.")],
        dataset_id: Annotated[StrictStr, Field(description="Required. Dataset ID of row access policies to list.")],
        table_id: Annotated[StrictStr, Field(description="Required. Table ID of the table to list row access policies.")],
    ...
    def _bigquery_row_access_policies_list_serialize(
        self,
        project_id,
        dataset_id,
        table_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/datasets/{datasetId}/tables/{tableId}/rowAccessPolicies',
