...
class StandardSqlTableType(BaseModel):
    ...
    A table type
    """ # noqa: E501
    columns: Optional[List[StandardSqlField]] = Field(default=None, description="The columns in this table type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [StandardSqlField.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
