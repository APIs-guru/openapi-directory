...
class ArimaModelInfo(BaseModel):
    ...
    """ # noqa: E501
    arima_coefficients: Optional[ArimaCoefficients] = Field(default=None, alias="arimaCoefficients")
    arima_fitting_metrics: Optional[ArimaFittingMetrics] = Field(default=None, alias="arimaFittingMetrics")
    has_drift: Optional[StrictBool] = Field(default=None, description="Whether Arima model fitted with drift or not. It is always false when d is not 1.", alias="hasDrift")
    ...
    __properties: ClassVar[List[str]] = ["arimaCoefficients", "arimaFittingMetrics", "hasDrift", "hasHolidayEffect", "hasSpikesAndDips", "hasStepChanges", "nonSeasonalOrder", "seasonalPeriods", "timeSeriesId", "timeSeriesIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of arima_coefficients
        if self.arima_coefficients:
            _dict['arimaCoefficients'] = self.arima_coefficients.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arimaCoefficients": ArimaCoefficients.from_dict(obj["arimaCoefficients"]) if obj.get("arimaCoefficients") is not None else None,
