...
class TableDataInsertAllResponseInsertErrorsInner(BaseModel):
    """
    Error details about a single row's insertion.
    """ # noqa: E501
    errors: Optional[List[ErrorProto]] = Field(default=None, description="Error information for the row indicated by the index property.")
    index: Optional[StrictInt] = Field(default=None, description="The index of the row that error applies to.")
    __properties: ClassVar[List[str]] = ["errors", "index"]
