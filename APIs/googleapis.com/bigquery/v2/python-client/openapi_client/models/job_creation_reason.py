...
class JobCreationReason(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Output only. Specifies the high level reason why a Job was created.")
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['CODE_UNSPECIFIED', 'REQUESTED', 'LONG_RUNNING', 'LARGE_RESULTS', 'OTHER']):
            raise ValueError("must be one of enum values ('CODE_UNSPECIFIED', 'REQUESTED', 'LONG_RUNNING', 'LARGE_RESULTS', 'OTHER')")
        return value
