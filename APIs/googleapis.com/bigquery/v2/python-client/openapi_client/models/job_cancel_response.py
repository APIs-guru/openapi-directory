...
class JobCancelResponse(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='bigquery#jobCancelResponse', description="The resource type of the response.")
    __properties: ClassVar[List[str]] = ["job", "kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else 'bigquery#jobCancelResponse'
        })
        return _obj
