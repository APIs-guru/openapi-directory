...
class StandardSqlField(BaseModel):
    ...
    A field or a column.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Optional. The name of this field. Can be absent for struct fields.")
...
StandardSqlField.model_rebuild(raise_errors=False)
