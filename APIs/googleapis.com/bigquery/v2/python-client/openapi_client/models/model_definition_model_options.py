...
class ModelDefinitionModelOptions(BaseModel):
    """
    Deprecated.
    """ # noqa: E501
    labels: Optional[List[StrictStr]] = None
    loss_type: Optional[StrictStr] = Field(default=None, alias="lossType")
    model_type: Optional[StrictStr] = Field(default=None, alias="modelType")
    __properties: ClassVar[List[str]] = ["labels", "lossType", "modelType"]
