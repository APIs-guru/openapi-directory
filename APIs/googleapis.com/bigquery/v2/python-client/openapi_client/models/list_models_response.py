...
class ListModelsResponse(BaseModel):
    ...
    """ # noqa: E501
    models: Optional[List[Model]] = Field(default=None, description="Models in the requested dataset. Only the following fields are populated: model_reference, model_type, creation_time, last_modified_time and labels.")
