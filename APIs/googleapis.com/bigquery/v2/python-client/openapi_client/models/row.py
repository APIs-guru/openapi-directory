...
class Row(BaseModel):
    ...
    """ # noqa: E501
    actual_label: Optional[StrictStr] = Field(default=None, description="The original label of this row.", alias="actualLabel")
    entries: Optional[List[Entry]] = Field(default=None, description="Info describing predicted label distribution.")
    __properties: ClassVar[List[str]] = ["actualLabel", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actualLabel": obj.get("actualLabel"),
