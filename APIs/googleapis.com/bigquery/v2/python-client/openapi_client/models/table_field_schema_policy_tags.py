...
class TableFieldSchemaPolicyTags(BaseModel):
    """
    ...
    """ # noqa: E501
    names: Optional[List[StrictStr]] = Field(default=None, description="A list of policy tag resource names. For example, \"projects/1/locations/eu/taxonomies/2/policyTags/3\". At most 1 policy tag is currently allowed.")
