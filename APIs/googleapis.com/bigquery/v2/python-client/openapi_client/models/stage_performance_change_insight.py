...
class StagePerformanceChangeInsight(BaseModel):
    ...
    """ # noqa: E501
    input_data_change: Optional[InputDataChange] = Field(default=None, alias="inputDataChange")
    ...
    __properties: ClassVar[List[str]] = ["inputDataChange", "stageId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of input_data_change
        if self.input_data_change:
            _dict['inputDataChange'] = self.input_data_change.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputDataChange": InputDataChange.from_dict(obj["inputDataChange"]) if obj.get("inputDataChange") is not None else None,
