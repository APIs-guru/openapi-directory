...
------------ | ------------- | ------------- | -------------
**uri** | **str** | URI for the output file(s). For example, &#x60;gs://my-bucket/outputs/&#x60;. If empty, the value is populated from Job.output_uri. See [Supported input and output formats](https://cloud.google.com/transcoder/docs/concepts/supported-input-and-output-formats). | [optional] 
