...
**labels** | **Dict[str, str]** | The labels associated with this job template. You can use these to organize and group your job templates. | [optional] 
**name** | **str** | The resource name of the job template. Format: &#x60;projects/{project_number}/locations/{location}/jobTemplates/{job_template}&#x60; | [optional] 
