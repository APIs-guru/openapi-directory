...
class JobConfig(BaseModel):
    ...
    edit_list: Optional[List[EditAtom]] = Field(default=None, description="List of edit atoms. Defines the ultimate timeline of the resulting file or manifest.", alias="editList")
    ...
    encryptions: Optional[List[Encryption]] = Field(default=None, description="List of encryption configurations for the content. Each configuration has an ID. Specify this ID in the MuxStream.encryption_id field to indicate the configuration to use for that `MuxStream` output.")
    ...
    sprite_sheets: Optional[List[SpriteSheet]] = Field(default=None, description="List of output sprite sheets. Spritesheets require at least one VideoStream in the Jobconfig.", alias="spriteSheets")
    __properties: ClassVar[List[str]] = ["adBreaks", "editList", "elementaryStreams", "encryptions", "inputs", "manifests", "muxStreams", "output", "overlays", "pubsubDestination", "spriteSheets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "encryptions": [Encryption.from_dict(_item) for _item in obj["encryptions"]] if obj.get("encryptions") is not None else None,
