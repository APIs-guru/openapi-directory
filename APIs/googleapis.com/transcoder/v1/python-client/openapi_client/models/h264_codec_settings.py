...
class H264CodecSettings(BaseModel):
    ...
    b_frame_count: Optional[StrictInt] = Field(default=None, description="The number of consecutive B-frames. Must be greater than or equal to zero. Must be less than H264CodecSettings.gop_frame_count if set. The default is 0.", alias="bFrameCount")
    ...
    enable_two_pass: Optional[StrictBool] = Field(default=None, description="Use two-pass encoding strategy to achieve better video quality. H264CodecSettings.rate_control_mode must be `vbr`. The default is `false`.", alias="enableTwoPass")
    ...
    preset: Optional[StrictStr] = Field(default=None, description="Enforces the specified codec preset. The default is `veryfast`. The available options are [FFmpeg-compatible](https://trac.ffmpeg.org/wiki/Encode/H.264#Preset). Note that certain values for this field may cause the transcoder to override other fields you set in the `H264CodecSettings` message.")
    ...
    tune: Optional[StrictStr] = Field(default=None, description="Enforces the specified codec tune. The available options are [FFmpeg-compatible](https://trac.ffmpeg.org/wiki/Encode/H.264#Tune). Note that certain values for this field may cause the transcoder to override other fields you set in the `H264CodecSettings` message.")
    vbv_fullness_bits: Optional[StrictInt] = Field(default=None, description="Initial fullness of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default is equal to 90% of H264CodecSettings.vbv_size_bits.", alias="vbvFullnessBits")
    vbv_size_bits: Optional[StrictInt] = Field(default=None, description="Size of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default is equal to H264CodecSettings.bitrate_bps.", alias="vbvSizeBits")
    ...
    __properties: ClassVar[List[str]] = ["allowOpenGop", "aqStrength", "bFrameCount", "bPyramid", "bitrateBps", "crfLevel", "enableTwoPass", "entropyCoder", "frameRate", "frameRateConversionStrategy", "gopDuration", "gopFrameCount", "heightPixels", "hlg", "pixelFormat", "preset", "profile", "rateControlMode", "sdr", "tune", "vbvFullnessBits", "vbvSizeBits", "widthPixels"]
