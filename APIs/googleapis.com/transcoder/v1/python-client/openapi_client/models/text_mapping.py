...
class TextMapping(BaseModel):
    ...
    """ # noqa: E501
    atom_key: Optional[StrictStr] = Field(default=None, description="Required. The EditAtom.key that references atom with text inputs in the JobConfig.edit_list.", alias="atomKey")
    ...
    __properties: ClassVar[List[str]] = ["atomKey", "inputKey", "inputTrack"]
