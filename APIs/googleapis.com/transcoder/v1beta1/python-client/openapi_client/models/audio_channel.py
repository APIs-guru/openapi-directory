...
class AudioChannel(BaseModel):
    ...
    The audio channel.
    """ # noqa: E501
    inputs: Optional[List[AudioChannelInput]] = Field(default=None, description="List of `Job.inputs` for this audio channel.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": [AudioChannelInput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None
        })
        return _obj
