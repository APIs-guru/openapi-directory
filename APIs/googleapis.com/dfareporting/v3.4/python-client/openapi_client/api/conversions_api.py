...
class ConversionsApi:
    ...
    def dfareporting_conversions_batchinsert(
        ...
        conversions_batch_insert_request: Optional[ConversionsBatchInsertRequest] = None,
        ...
        :param conversions_batch_insert_request:
        :type conversions_batch_insert_request: ConversionsBatchInsertRequest
        ...
        _param = self._dfareporting_conversions_batchinsert_serialize(
            ...
            conversions_batch_insert_request=conversions_batch_insert_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ConversionsBatchInsertResponse",
        }
    ...
    @validate_call
    def dfareporting_conversions_batchinsert_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversionsBatchInsertResponse]:
        """dfareporting_conversions_batchinsert
    ...
    @validate_call
    def dfareporting_conversions_batchinsert_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_conversions_batchinsert_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        if conversions_batch_insert_request is not None:
            _body_params = conversions_batch_insert_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/conversions/batchinsert',
    ...
    def dfareporting_conversions_batchupdate(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        conversions_batch_update_request: Optional[ConversionsBatchUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param conversions_batch_update_request:
        :type conversions_batch_update_request: ConversionsBatchUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._dfareporting_conversions_batchupdate_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            conversions_batch_update_request=conversions_batch_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ConversionsBatchUpdateResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_conversions_batchupdate_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversionsBatchUpdateResponse]:
        """dfareporting_conversions_batchupdate
    ...
    @validate_call
    def dfareporting_conversions_batchupdate_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_conversions_batchupdate_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        upload_protocol,
        upload_type,
        conversions_batch_update_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if conversions_batch_update_request is not None:
            _body_params = conversions_batch_update_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/conversions/batchupdate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
