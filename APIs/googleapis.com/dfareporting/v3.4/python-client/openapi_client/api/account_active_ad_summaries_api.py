...
class AccountActiveAdSummariesApi:
    ...
    def dfareporting_account_active_ad_summaries_get(
        ...
        summary_account_id: Annotated[StrictStr, Field(description="Account ID.")],
        ...
        :type profile_id: str
        :param summary_account_id: Account ID. (required)
        :type summary_account_id: str
        ...
        _param = self._dfareporting_account_active_ad_summaries_get_serialize(
            profile_id=profile_id,
            summary_account_id=summary_account_id,
            xgafv=xgafv,
    ...
    @validate_call
    def dfareporting_account_active_ad_summaries_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        summary_account_id: Annotated[StrictStr, Field(description="Account ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountActiveAdSummary]:
        """dfareporting_account_active_ad_summaries_get
    ...
    @validate_call
    def dfareporting_account_active_ad_summaries_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        summary_account_id: Annotated[StrictStr, Field(description="Account ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_account_active_ad_summaries_get_serialize(
        self,
        profile_id,
        summary_account_id,
        xgafv,
        ...
        if summary_account_id is not None:
            _path_params['summaryAccountId'] = summary_account_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/accountActiveAdSummaries/{summaryAccountId}',
