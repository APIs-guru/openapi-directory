...
class CampaignsApi:
    ...
    def dfareporting_campaigns_get(
        ...
        _param = self._dfareporting_campaigns_get_serialize(
    ...
    @validate_call
    def dfareporting_campaigns_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Campaign ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_campaigns_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Campaign ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_campaigns_get_serialize(
        self,
        profile_id,
        id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/campaigns/{id}',
    ...
    def dfareporting_campaigns_insert(
        ...
        _param = self._dfareporting_campaigns_insert_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def dfareporting_campaigns_insert_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def dfareporting_campaigns_insert_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_campaigns_insert_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/campaigns',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def dfareporting_campaigns_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        advertiser_group_ids: Annotated[Optional[List[StrictStr]], Field(description="Select only campaigns whose advertisers belong to these advertiser groups.")] = None,
        advertiser_ids: Annotated[Optional[List[StrictStr]], Field(description="Select only campaigns that belong to these advertisers.")] = None,
        archived: Annotated[Optional[StrictBool], Field(description="Select only archived campaigns. Don't set this field to select both archived and non-archived campaigns.")] = None,
        at_least_one_optimization_activity: Annotated[Optional[StrictBool], Field(description="Select only campaigns that have at least one optimization activity.")] = None,
        excluded_ids: Annotated[Optional[List[StrictStr]], Field(description="Exclude campaigns with these IDs.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Select only campaigns with these IDs.")] = None,
        ...
        overridden_event_tag_id: Annotated[Optional[StrictStr], Field(description="Select only campaigns that have overridden this event tag ID.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Value of the nextPageToken from the previous result page.")] = None,
        search_string: Annotated[Optional[StrictStr], Field(description="Allows searching for campaigns by name or ID. Wildcards (*) are allowed. For example, \"campaign*2015\" will return campaigns with names like \"campaign June 2015\", \"campaign April 2015\", or simply \"campaign 2015\". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \"campaign\" will match campaigns with name \"my campaign\", \"campaign 2015\", or simply \"campaign\".")] = None,
        ...
        subaccount_id: Annotated[Optional[StrictStr], Field(description="Select only campaigns that belong to this subaccount.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._dfareporting_campaigns_list_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            archived=archived,
            at_least_one_optimization_activity=at_least_one_optimization_activity,
    ...
    @validate_call
    def dfareporting_campaigns_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CampaignsListResponse]:
        """dfareporting_campaigns_list
    ...
    @validate_call
    def dfareporting_campaigns_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_campaigns_list_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        advertiser_ids,
        archived,
        at_least_one_optimization_activity,
        excluded_ids,
        ids,
        max_results,
        ...
        if at_least_one_optimization_activity is not None:
            
            _query_params.append(('atLeastOneOptimizationActivity', at_least_one_optimization_activity))
            
        if excluded_ids is not None:
            
            _query_params.append(('excludedIds', excluded_ids))
    ...
    def dfareporting_campaigns_patch(
        ...
        _param = self._dfareporting_campaigns_patch_serialize(
            profile_id=profile_id,
            id=id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def dfareporting_campaigns_patch_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Campaign ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_campaigns_patch_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Campaign ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_campaigns_patch_serialize(
        self,
        profile_id,
        id,
        xgafv,
    ...
    def dfareporting_campaigns_update(
        ...
        _param = self._dfareporting_campaigns_update_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def dfareporting_campaigns_update_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def dfareporting_campaigns_update_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_campaigns_update_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
