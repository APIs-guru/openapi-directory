...
class InventoryItemsApi:
    ...
    def dfareporting_inventory_items_get(
        ...
        id: Annotated[StrictStr, Field(description="Inventory item ID.")],
        ...
        _param = self._dfareporting_inventory_items_get_serialize(
    ...
    @validate_call
    def dfareporting_inventory_items_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        project_id: Annotated[StrictStr, Field(description="Project ID for order documents.")],
        id: Annotated[StrictStr, Field(description="Inventory item ID.")],
    ...
    @validate_call
    def dfareporting_inventory_items_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        project_id: Annotated[StrictStr, Field(description="Project ID for order documents.")],
        id: Annotated[StrictStr, Field(description="Inventory item ID.")],
    ...
    def _dfareporting_inventory_items_get_serialize(
        self,
        profile_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/projects/{projectId}/inventoryItems/{id}',
    ...
    def dfareporting_inventory_items_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Select only inventory items with these IDs.")] = None,
        in_plan: Annotated[Optional[StrictBool], Field(description="Select only inventory items that are in plan.")] = None,
        ...
        order_id: Annotated[Optional[List[StrictStr]], Field(description="Select only inventory items that belong to specified orders.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Value of the nextPageToken from the previous result page.")] = None,
        site_id: Annotated[Optional[List[StrictStr]], Field(description="Select only inventory items that are associated with these sites.")] = None,
        ...
        type: Annotated[Optional[StrictStr], Field(description="Select only inventory items with this type.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type ids: List[str]
        :param in_plan: Select only inventory items that are in plan.
        :type in_plan: bool
        :param max_results: Maximum number of results to return.
        :type max_results: int
        :param order_id: Select only inventory items that belong to specified orders.
        :type order_id: List[str]
        :param page_token: Value of the nextPageToken from the previous result page.
        :type page_token: str
        :param site_id: Select only inventory items that are associated with these sites.
        ...
        _param = self._dfareporting_inventory_items_list_serialize(
            profile_id=profile_id,
            project_id=project_id,
            xgafv=xgafv,
            access_token=access_token,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InventoryItemsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_inventory_items_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        project_id: Annotated[StrictStr, Field(description="Project ID for order documents.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_inventory_items_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        project_id: Annotated[StrictStr, Field(description="Project ID for order documents.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_inventory_items_list_serialize(
        self,
        profile_id,
        project_id,
        xgafv,
        ...
        if in_plan is not None:
            ...
            _query_params.append(('inPlan', in_plan))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/projects/{projectId}/inventoryItems',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
