...
class TagSetting(BaseModel):
    ...
    include_click_through_urls: Optional[StrictBool] = Field(default=None, description="Whether static landing page URLs should be included in the tags. This setting applies only to placements.", alias="includeClickThroughUrls")
