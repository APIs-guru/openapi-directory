...
class FloodlightConfiguration(BaseModel):
    ...
    first_day_of_week: Optional[StrictStr] = Field(default=None, description="Day that will be counted as the first day of the week in reports. This is a required field.", alias="firstDayOfWeek")
    ...
    def first_day_of_week_validate_enum(cls, value):
        ...
        if value not in set(['MONDAY', 'SUNDAY']):
            raise ValueError("must be one of enum values ('MONDAY', 'SUNDAY')")
        return value
