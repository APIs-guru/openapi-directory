...
class PathFilter(BaseModel):
    ...
    """ # noqa: E501
    event_filters: Optional[List[EventFilter]] = Field(default=None, description="Event filters in path report.", alias="eventFilters")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of resource this is, in this case dfareporting#pathFilter.")
    path_match_position: Optional[StrictStr] = Field(default=None, description="Determines how the 'value' field is matched when filtering. If not specified, defaults to EXACT. If set to WILDCARD_EXPRESSION, '*' is allowed as a placeholder for variable length character sequences, and it can be escaped with a backslash. Note, only paid search dimensions ('dfa:paidSearch*') allow a matchType other than EXACT.", alias="pathMatchPosition")
    __properties: ClassVar[List[str]] = ["eventFilters", "kind", "pathMatchPosition"]
