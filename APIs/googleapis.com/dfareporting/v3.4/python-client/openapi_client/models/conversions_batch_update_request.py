...
class ConversionsBatchUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    conversions: Optional[List[Conversion]] = Field(default=None, description="The set of conversions to update.")
    encryption_info: Optional[EncryptionInfo] = Field(default=None, alias="encryptionInfo")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#conversionsBatchUpdateRequest\".")
    __properties: ClassVar[List[str]] = ["conversions", "encryptionInfo", "kind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversions": [Conversion.from_dict(_item) for _item in obj["conversions"]] if obj.get("conversions") is not None else None,
