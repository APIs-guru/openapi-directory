...
class RegionsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#regionsListResponse\".")
    regions: Optional[List[Region]] = Field(default=None, description="Region collection.")
    __properties: ClassVar[List[str]] = ["kind", "regions"]
