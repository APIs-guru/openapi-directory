...
class BrowsersListResponse(BaseModel):
    ...
    """ # noqa: E501
    browsers: Optional[List[Browser]] = Field(default=None, description="Browser collection.")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#browsersListResponse\".")
    __properties: ClassVar[List[str]] = ["browsers", "kind"]
