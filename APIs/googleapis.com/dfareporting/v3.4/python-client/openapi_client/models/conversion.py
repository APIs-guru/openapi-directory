...
class Conversion(BaseModel):
    ...
    gclid: Optional[StrictStr] = Field(default=None, description="The Google click ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId, mobileDeviceId and dclid. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or mobileDeviceId or dclid is a required field.")
    ...
    quantity: Optional[StrictStr] = Field(default=None, description="The quantity of the conversion.")
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The value of the conversion.")
    __properties: ClassVar[List[str]] = ["childDirectedTreatment", "customVariables", "dclid", "encryptedUserId", "encryptedUserIdCandidates", "floodlightActivityId", "floodlightConfigurationId", "gclid", "kind", "limitAdTracking", "matchId", "mobileDeviceId", "nonPersonalizedAd", "ordinal", "quantity", "timestampMicros", "treatmentForUnderage", "value"]
