...
class ConnectionType(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of this connection type.")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#connectionType\".")
    name: Optional[StrictStr] = Field(default=None, description="Name of this connection type.")
