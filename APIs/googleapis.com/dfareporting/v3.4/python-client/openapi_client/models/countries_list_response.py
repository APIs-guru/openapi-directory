...
class CountriesListResponse(BaseModel):
    ...
    """ # noqa: E501
    countries: Optional[List[Country]] = Field(default=None, description="Country collection.")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#countriesListResponse\".")
    __properties: ClassVar[List[str]] = ["countries", "kind"]
