...
class TestFloodlightActivityGroup(unittest.TestCase):
    """FloodlightActivityGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloodlightActivityGroup:
        """Test FloodlightActivityGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloodlightActivityGroup`
        """
        model = FloodlightActivityGroup()
        if include_optional:
    ...
    def testFloodlightActivityGroup(self):
        """Test FloodlightActivityGroup"""
