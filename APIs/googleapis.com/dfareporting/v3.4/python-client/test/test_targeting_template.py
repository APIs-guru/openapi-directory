...
class TestTargetingTemplate(unittest.TestCase):
    """TargetingTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetingTemplate:
        """Test TargetingTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetingTemplate`
        """
    ...
    def testTargetingTemplate(self):
        """Test TargetingTemplate"""
