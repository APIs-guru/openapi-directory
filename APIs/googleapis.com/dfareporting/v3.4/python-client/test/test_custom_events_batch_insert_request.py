...
class TestCustomEventsBatchInsertRequest(unittest.TestCase):
    """CustomEventsBatchInsertRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEventsBatchInsertRequest:
        """Test CustomEventsBatchInsertRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEventsBatchInsertRequest`
        """
        model = CustomEventsBatchInsertRequest()
        if include_optional:
            return CustomEventsBatchInsertRequest(
                custom_events = [
                    openapi_client.models.custom_event.CustomEvent(
    ...
    def testCustomEventsBatchInsertRequest(self):
        """Test CustomEventsBatchInsertRequest"""
