...
class TestConversionsBatchUpdateRequest(unittest.TestCase):
    """ConversionsBatchUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionsBatchUpdateRequest:
        """Test ConversionsBatchUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversionsBatchUpdateRequest`
        """
        model = ConversionsBatchUpdateRequest()
        if include_optional:
    ...
    def testConversionsBatchUpdateRequest(self):
        """Test ConversionsBatchUpdateRequest"""
