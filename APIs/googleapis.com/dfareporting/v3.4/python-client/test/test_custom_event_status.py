...
class TestCustomEventStatus(unittest.TestCase):
    """CustomEventStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEventStatus:
        """Test CustomEventStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEventStatus`
        """
        model = CustomEventStatus()
        if include_optional:
    ...
    def testCustomEventStatus(self):
        """Test CustomEventStatus"""
