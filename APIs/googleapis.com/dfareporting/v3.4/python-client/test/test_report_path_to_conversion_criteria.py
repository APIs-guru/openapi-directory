...
class TestReportPathToConversionCriteria(unittest.TestCase):
    """ReportPathToConversionCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPathToConversionCriteria:
        """Test ReportPathToConversionCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPathToConversionCriteria`
        """
        model = ReportPathToConversionCriteria()
        if include_optional:
    ...
    def testReportPathToConversionCriteria(self):
        """Test ReportPathToConversionCriteria"""
