...
class TestReportPathAttributionCriteria(unittest.TestCase):
    """ReportPathAttributionCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPathAttributionCriteria:
        """Test ReportPathAttributionCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPathAttributionCriteria`
        """
        model = ReportPathAttributionCriteria()
        if include_optional:
    ...
    def testReportPathAttributionCriteria(self):
        """Test ReportPathAttributionCriteria"""
