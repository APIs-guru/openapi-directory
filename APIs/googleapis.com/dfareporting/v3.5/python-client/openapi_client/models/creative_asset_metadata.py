...
class CreativeAssetMetadata(BaseModel):
    ...
    media_response_info: Optional[MediaResponseInfo] = Field(default=None, alias="mediaResponseInfo")
    ...
    __properties: ClassVar[List[str]] = ["assetIdentifier", "clickTags", "counterCustomEvents", "detectedFeatures", "exitCustomEvents", "id", "idDimensionValue", "kind", "mediaRequestInfo", "mediaResponseInfo", "richMedia", "timerCustomEvents", "warnedValidationRules"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of media_response_info
        if self.media_response_info:
            _dict['mediaResponseInfo'] = self.media_response_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mediaResponseInfo": MediaResponseInfo.from_dict(obj["mediaResponseInfo"]) if obj.get("mediaResponseInfo") is not None else None,
