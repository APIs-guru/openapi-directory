...
class SubaccountsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#subaccountsListResponse\".")
    ...
    subaccounts: Optional[List[Subaccount]] = Field(default=None, description="Subaccount collection.")
    __properties: ClassVar[List[str]] = ["kind", "nextPageToken", "subaccounts"]
