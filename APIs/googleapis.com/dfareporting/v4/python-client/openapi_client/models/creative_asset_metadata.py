...
class CreativeAssetMetadata(BaseModel):
    ...
    counter_custom_events: Optional[List[CreativeCustomEvent]] = Field(default=None, description="List of counter events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset.", alias="counterCustomEvents")
    ...
    exit_custom_events: Optional[List[CreativeCustomEvent]] = Field(default=None, description="List of exit events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset.", alias="exitCustomEvents")
    ...
    rich_media: Optional[StrictBool] = Field(default=None, description="True if the uploaded asset is a rich media asset. This is a read-only, auto-generated field.", alias="richMedia")
    timer_custom_events: Optional[List[CreativeCustomEvent]] = Field(default=None, description="List of timer events configured for the asset. This is a read-only, auto-generated field and only applicable to a rich media asset.", alias="timerCustomEvents")
    ...
    __properties: ClassVar[List[str]] = ["assetIdentifier", "clickTags", "counterCustomEvents", "detectedFeatures", "exitCustomEvents", "id", "idDimensionValue", "kind", "richMedia", "timerCustomEvents", "warnedValidationRules"]
