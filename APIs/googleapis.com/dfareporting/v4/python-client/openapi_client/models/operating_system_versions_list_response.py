...
class OperatingSystemVersionsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#operatingSystemVersionsListResponse\".")
    operating_system_versions: Optional[List[OperatingSystemVersion]] = Field(default=None, description="Operating system version collection.", alias="operatingSystemVersions")
    __properties: ClassVar[List[str]] = ["kind", "operatingSystemVersions"]
