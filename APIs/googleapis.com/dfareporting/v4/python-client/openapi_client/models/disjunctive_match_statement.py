...
class DisjunctiveMatchStatement(BaseModel):
    ...
    """ # noqa: E501
    event_filters: Optional[List[EventFilter]] = Field(default=None, description="The event filters contained within this disjunctive match statement.", alias="eventFilters")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of resource this is, in this case dfareporting#disjunctiveMatchStatement.")
    __properties: ClassVar[List[str]] = ["eventFilters", "kind"]
