...
class ConnectionTypesListResponse(BaseModel):
    ...
    """ # noqa: E501
    connection_types: Optional[List[ConnectionType]] = Field(default=None, description="Collection of connection types such as broadband and mobile.", alias="connectionTypes")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#connectionTypesListResponse\".")
    __properties: ClassVar[List[str]] = ["connectionTypes", "kind"]
