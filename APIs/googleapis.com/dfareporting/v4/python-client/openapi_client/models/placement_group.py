...
class PlacementGroup(BaseModel):
    ...
    active_status: Optional[StrictStr] = Field(default=None, description="Whether this placement group is active, inactive, archived or permanently archived.", alias="activeStatus")
