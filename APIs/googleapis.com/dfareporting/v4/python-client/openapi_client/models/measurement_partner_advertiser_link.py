...
class MeasurementPartnerAdvertiserLink(BaseModel):
    """
    MeasurementPartnerAdvertiserLink
    """ # noqa: E501
    link_status: Optional[StrictStr] = Field(default=None, description="Status of the partner link.", alias="linkStatus")
    measurement_partner: Optional[StrictStr] = Field(default=None, description="Measurement partner used for tag wrapping.", alias="measurementPartner")
    partner_advertiser_id: Optional[StrictStr] = Field(default=None, description="partner Advertiser Id.", alias="partnerAdvertiserId")
    __properties: ClassVar[List[str]] = ["linkStatus", "measurementPartner", "partnerAdvertiserId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partnerAdvertiserId": obj.get("partnerAdvertiserId")
        })
        return _obj
