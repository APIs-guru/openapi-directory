...
class BillingProfilesListResponse(BaseModel):
    """
    Billing profile List Response
    """ # noqa: E501
    billing_profiles: Optional[List[BillingProfile]] = Field(default=None, description="Billing profiles collection.", alias="billingProfiles")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#billingProfilesListResponse\".")
    ...
    __properties: ClassVar[List[str]] = ["billingProfiles", "kind", "nextPageToken"]
