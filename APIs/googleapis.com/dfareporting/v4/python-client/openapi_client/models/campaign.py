...
class Campaign(BaseModel):
    ...
    measurement_partner_link: Optional[MeasurementPartnerCampaignLink] = Field(default=None, alias="measurementPartnerLink")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "adBlockingConfiguration", "additionalCreativeOptimizationConfigurations", "advertiserGroupId", "advertiserId", "advertiserIdDimensionValue", "archived", "audienceSegmentGroups", "billingInvoiceCode", "clickThroughUrlSuffixProperties", "comment", "createInfo", "creativeGroupIds", "creativeOptimizationConfiguration", "defaultClickThroughEventTagProperties", "defaultLandingPageId", "endDate", "eventTagOverrides", "externalId", "id", "idDimensionValue", "kind", "lastModifiedInfo", "measurementPartnerLink", "name", "startDate", "subaccountId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of measurement_partner_link
        if self.measurement_partner_link:
            _dict['measurementPartnerLink'] = self.measurement_partner_link.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "measurementPartnerLink": MeasurementPartnerCampaignLink.from_dict(obj["measurementPartnerLink"]) if obj.get("measurementPartnerLink") is not None else None,
            "name": obj.get("name"),
