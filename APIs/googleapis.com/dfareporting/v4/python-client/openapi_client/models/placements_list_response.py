...
class PlacementsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#placementsListResponse\".")
    ...
    placements: Optional[List[Placement]] = Field(default=None, description="Placement collection.")
    __properties: ClassVar[List[str]] = ["kind", "nextPageToken", "placements"]
