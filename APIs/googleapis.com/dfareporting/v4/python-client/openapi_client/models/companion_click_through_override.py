...
class CompanionClickThroughOverride(BaseModel):
    ...
    creative_id: Optional[StrictStr] = Field(default=None, description="ID of the creative for this companion click-through override.", alias="creativeId")
    __properties: ClassVar[List[str]] = ["clickThroughUrl", "creativeId"]
