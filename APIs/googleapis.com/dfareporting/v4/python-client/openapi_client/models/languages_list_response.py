...
class LanguagesListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#languagesListResponse\".")
    languages: Optional[List[Language]] = Field(default=None, description="Language collection.")
    __properties: ClassVar[List[str]] = ["kind", "languages"]
