...
class MeasurementPartnerCampaignLink(BaseModel):
    """
    MeasurementPartnerCampaignLink
    """ # noqa: E501
    link_status: Optional[StrictStr] = Field(default=None, description=".", alias="linkStatus")
    ...
    partner_campaign_id: Optional[StrictStr] = Field(default=None, description="Partner campaign ID needed for establishing linking with Measurement partner.", alias="partnerCampaignId")
    __properties: ClassVar[List[str]] = ["linkStatus", "measurementPartner", "partnerCampaignId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partnerCampaignId": obj.get("partnerCampaignId")
        })
        return _obj
