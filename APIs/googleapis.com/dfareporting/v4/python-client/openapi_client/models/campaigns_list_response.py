...
class CampaignsListResponse(BaseModel):
    ...
    """ # noqa: E501
    campaigns: Optional[List[Campaign]] = Field(default=None, description="Campaign collection.")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#campaignsListResponse\".")
    ...
    __properties: ClassVar[List[str]] = ["campaigns", "kind", "nextPageToken"]
