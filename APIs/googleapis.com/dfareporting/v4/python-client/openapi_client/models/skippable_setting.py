...
class SkippableSetting(BaseModel):
    ...
    Skippable Settings
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#skippableSetting\".")
    ...
    skippable: Optional[StrictBool] = Field(default=None, description="Whether the user can skip creatives served to this placement.")
