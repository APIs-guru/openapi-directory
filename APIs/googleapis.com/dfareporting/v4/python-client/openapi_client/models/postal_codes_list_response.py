...
class PostalCodesListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#postalCodesListResponse\".")
    postal_codes: Optional[List[PostalCode]] = Field(default=None, description="Postal code collection.", alias="postalCodes")
    __properties: ClassVar[List[str]] = ["kind", "postalCodes"]
