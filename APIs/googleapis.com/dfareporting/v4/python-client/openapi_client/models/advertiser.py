...
class Advertiser(BaseModel):
    ...
    measurement_partner_link: Optional[MeasurementPartnerAdvertiserLink] = Field(default=None, alias="measurementPartnerLink")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "advertiserGroupId", "clickThroughUrlSuffix", "defaultClickThroughEventTagId", "defaultEmail", "floodlightConfigurationId", "floodlightConfigurationIdDimensionValue", "id", "idDimensionValue", "kind", "measurementPartnerLink", "name", "originalFloodlightConfigurationId", "status", "subaccountId", "suspended"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "measurementPartnerLink": MeasurementPartnerAdvertiserLink.from_dict(obj["measurementPartnerLink"]) if obj.get("measurementPartnerLink") is not None else None,
            "name": obj.get("name"),
