...
class AdvertisersListResponse(BaseModel):
    ...
    """ # noqa: E501
    advertisers: Optional[List[Advertiser]] = Field(default=None, description="Advertiser collection.")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#advertisersListResponse\".")
    ...
    __properties: ClassVar[List[str]] = ["advertisers", "kind", "nextPageToken"]
