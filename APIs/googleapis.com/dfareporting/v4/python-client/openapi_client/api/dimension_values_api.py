...
class DimensionValuesApi:
    ...
    def dfareporting_dimension_values_query(
        ...
        dimension_value_request: Optional[DimensionValueRequest] = None,
        ...
        :type page_token: str
        :param dimension_value_request:
        :type dimension_value_request: DimensionValueRequest
        ...
        _param = self._dfareporting_dimension_values_query_serialize(
            ...
            dimension_value_request=dimension_value_request,
    ...
    @validate_call
    def dfareporting_dimension_values_query_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="The Campaign Manager 360 user profile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DimensionValueList]:
        """dfareporting_dimension_values_query
    ...
    @validate_call
    def dfareporting_dimension_values_query_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="The Campaign Manager 360 user profile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_dimension_values_query_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        if dimension_value_request is not None:
            _body_params = dimension_value_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/dimensionvalues/query',
