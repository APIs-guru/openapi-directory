...
class SizesApi:
    ...
    def dfareporting_sizes_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        height: Annotated[Optional[StrictInt], Field(description="Select only sizes with this height.")] = None,
        ...
        width: Annotated[Optional[StrictInt], Field(description="Select only sizes with this width.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
