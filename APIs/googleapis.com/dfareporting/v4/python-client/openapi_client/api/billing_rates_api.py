...
class BillingRatesApi:
    ...
    def dfareporting_billing_rates_list(
        ...
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing rate.")],
        ...
        :type profile_id: str
        :param billing_profile_id: Billing profile ID of this billing rate. (required)
        ...
        _param = self._dfareporting_billing_rates_list_serialize(
    ...
    @validate_call
    def dfareporting_billing_rates_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing rate.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingRatesListResponse]:
        """dfareporting_billing_rates_list
    ...
    @validate_call
    def dfareporting_billing_rates_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing rate.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_billing_rates_list_serialize(
        self,
        profile_id,
        billing_profile_id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/billingProfiles/{billingProfileId}/billingRates',
