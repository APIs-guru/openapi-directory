...
class BillingAssignmentsApi:
    ...
    def dfareporting_billing_assignments_insert(
        ...
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing assignment.")],
        ...
        billing_assignment: Optional[BillingAssignment] = None,
        ...
        :type profile_id: str
        :param billing_profile_id: Billing profile ID of this billing assignment. (required)
        ...
        :param billing_assignment:
        :type billing_assignment: BillingAssignment
        ...
        _param = self._dfareporting_billing_assignments_insert_serialize(
            ...
            billing_assignment=billing_assignment,
    ...
    @validate_call
    def dfareporting_billing_assignments_insert_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing assignment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_billing_assignments_insert_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing assignment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_billing_assignments_insert_serialize(
        self,
        profile_id,
        billing_profile_id,
        xgafv,
        ...
        if billing_assignment is not None:
            _body_params = billing_assignment
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/billingProfiles/{billingProfileId}/billingAssignments',
    ...
    def dfareporting_billing_assignments_list(
        ...
        """dfareporting_billing_assignments_list
        ...
        _param = self._dfareporting_billing_assignments_list_serialize(
            profile_id=profile_id,
            billing_profile_id=billing_profile_id,
            xgafv=xgafv,
            access_token=access_token,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BillingAssignmentsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_billing_assignments_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing assignment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingAssignmentsListResponse]:
        """dfareporting_billing_assignments_list
    ...
    @validate_call
    def dfareporting_billing_assignments_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing profile ID of this billing assignment.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_billing_assignments_list_serialize(
        self,
        profile_id,
        billing_profile_id,
        xgafv,
