...
class AccountUserProfilesApi:
    ...
    def dfareporting_account_user_profiles_get(
        ...
        id: Annotated[StrictStr, Field(description="User profile ID.")],
        ...
        _param = self._dfareporting_account_user_profiles_get_serialize(
    ...
    @validate_call
    def dfareporting_account_user_profiles_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="User profile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountUserProfile]:
        """dfareporting_account_user_profiles_get
    ...
    @validate_call
    def dfareporting_account_user_profiles_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="User profile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_account_user_profiles_get_serialize(
        self,
        profile_id,
        id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/accountUserProfiles/{id}',
    ...
    def dfareporting_account_user_profiles_insert(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        account_user_profile: Optional[AccountUserProfile] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param account_user_profile:
        :type account_user_profile: AccountUserProfile
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._dfareporting_account_user_profiles_insert_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def dfareporting_account_user_profiles_insert_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def dfareporting_account_user_profiles_insert_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_account_user_profiles_insert_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if account_user_profile is not None:
            _body_params = account_user_profile
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/accountUserProfiles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def dfareporting_account_user_profiles_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        active: Annotated[Optional[StrictBool], Field(description="Select only active user profiles.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Select only user profiles with these IDs.")] = None,
        ...
        search_string: Annotated[Optional[StrictStr], Field(description="Allows searching for objects by name, ID or email. Wildcards (*) are allowed. For example, \"user profile*2015\" will return objects with names like \"user profile June 2015\", \"user profile April 2015\", or simply \"user profile 2015\". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \"user profile\" will match objects with name \"my user profile\", \"user profile 2015\", or simply \"user profile\".")] = None,
        ...
        subaccount_id: Annotated[Optional[StrictStr], Field(description="Select only user profiles with the specified subaccount ID.")] = None,
        user_role_id: Annotated[Optional[StrictStr], Field(description="Select only user profiles with the specified user role ID.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._dfareporting_account_user_profiles_list_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountUserProfilesListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_account_user_profiles_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def dfareporting_account_user_profiles_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_account_user_profiles_list_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        if user_role_id is not None:
            ...
            _query_params.append(('userRoleId', user_role_id))
    ...
    def dfareporting_account_user_profiles_patch(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Required. AccountUserProfile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        :param profile_id: User profile ID associated with this request. (required)
        :type profile_id: str
        :param id: Required. AccountUserProfile ID. (required)
        :type id: str
        :param xgafv: V1 error format.
        :type xgafv: str
        :param access_token: OAuth access token.
        ...
        _param = self._dfareporting_account_user_profiles_patch_serialize(
            profile_id=profile_id,
            id=id,
            xgafv=xgafv,
            access_token=access_token,
    ...
    @validate_call
    def dfareporting_account_user_profiles_patch_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Required. AccountUserProfile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_account_user_profiles_patch_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Required. AccountUserProfile ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_account_user_profiles_patch_serialize(
        self,
        profile_id,
        id,
        xgafv,
    ...
    def dfareporting_account_user_profiles_update(
        ...
        _param = self._dfareporting_account_user_profiles_update_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def dfareporting_account_user_profiles_update_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def dfareporting_account_user_profiles_update_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_account_user_profiles_update_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
