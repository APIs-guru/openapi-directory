...
class ChangeLogsApi:
    ...
    def dfareporting_change_logs_get(
        ...
        id: Annotated[StrictStr, Field(description="Change log ID.")],
        ...
        _param = self._dfareporting_change_logs_get_serialize(
    ...
    @validate_call
    def dfareporting_change_logs_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Change log ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_change_logs_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Change log ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_change_logs_get_serialize(
        self,
        profile_id,
        id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/changeLogs/{id}',
    ...
    def dfareporting_change_logs_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        action: Annotated[Optional[StrictStr], Field(description="Select only change logs with the specified action.")] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Select only change logs with these IDs.")] = None,
        max_change_time: Annotated[Optional[StrictStr], Field(description="Select only change logs whose change time is before the specified maxChangeTime.The time should be formatted as an RFC3339 date/time string. For example, for 10:54 PM on July 18th, 2015, in the America/New York time zone, the format is \"2015-07-18T22:54:00-04:00\". In other words, the year, month, day, the letter T, the hour (24-hour clock system), minute, second, and then the time zone offset.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results to return.")] = None,
        min_change_time: Annotated[Optional[StrictStr], Field(description="Select only change logs whose change time is after the specified minChangeTime.The time should be formatted as an RFC3339 date/time string. For example, for 10:54 PM on July 18th, 2015, in the America/New York time zone, the format is \"2015-07-18T22:54:00-04:00\". In other words, the year, month, day, the letter T, the hour (24-hour clock system), minute, second, and then the time zone offset.")] = None,
        object_ids: Annotated[Optional[List[StrictStr]], Field(description="Select only change logs with these object IDs.")] = None,
        object_type: Annotated[Optional[StrictStr], Field(description="Select only change logs with the specified object type.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Value of the nextPageToken from the previous result page.")] = None,
        search_string: Annotated[Optional[StrictStr], Field(description="Select only change logs whose object ID, user name, old or new values match the search string.")] = None,
        user_profile_ids: Annotated[Optional[List[StrictStr]], Field(description="Select only change logs with these user profile IDs.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._dfareporting_change_logs_list_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def dfareporting_change_logs_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChangeLogsListResponse]:
        """dfareporting_change_logs_list
    ...
    @validate_call
    def dfareporting_change_logs_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_change_logs_list_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        if max_change_time is not None:
            
            _query_params.append(('maxChangeTime', max_change_time))
        ...
        if min_change_time is not None:
            ...
            _query_params.append(('minChangeTime', min_change_time))
        ...
        if user_profile_ids is not None:
            ...
            _query_params.append(('userProfileIds', user_profile_ids))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/changeLogs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
