...
**active_status** | **str** | Whether this placement is active, inactive, archived or permanently archived. | [optional] 
...
**conversion_domain_override** | [**PlacementConversionDomainOverride**](PlacementConversionDomainOverride.md) |  | [optional] 
...
**name** | **str** | Name of this placement.This is a required field and must be less than or equal to 512 characters long. | [optional] 
**partner_wrapping_data** | [**MeasurementPartnerWrappingData**](MeasurementPartnerWrappingData.md) |  | [optional] 
...
**wrapping_opt_out** | **bool** | Whether this placement opts out of tag wrapping. | [optional] 
