...
class TestFloodlightActivitiesListResponse(unittest.TestCase):
    """FloodlightActivitiesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloodlightActivitiesListResponse:
        """Test FloodlightActivitiesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloodlightActivitiesListResponse`
        """
        model = FloodlightActivitiesListResponse()
        if include_optional:
    ...
    def testFloodlightActivitiesListResponse(self):
        """Test FloodlightActivitiesListResponse"""
