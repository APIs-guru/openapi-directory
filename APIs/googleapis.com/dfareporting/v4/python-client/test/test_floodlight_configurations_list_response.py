...
class TestFloodlightConfigurationsListResponse(unittest.TestCase):
    """FloodlightConfigurationsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloodlightConfigurationsListResponse:
        """Test FloodlightConfigurationsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloodlightConfigurationsListResponse`
        """
        model = FloodlightConfigurationsListResponse()
        if include_optional:
            return FloodlightConfigurationsListResponse(
                floodlight_configurations = [
                    openapi_client.models.floodlight_configuration.FloodlightConfiguration(
                        account_id = '', 
                        advertiser_id = '', 
    ...
    def testFloodlightConfigurationsListResponse(self):
        """Test FloodlightConfigurationsListResponse"""
