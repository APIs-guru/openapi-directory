    ...
    def make_instance(self, include_optional) -> Placement:
        ...
        if include_optional:
            return Placement(
                ...
                placement_group_id = '',
                placement_group_id_dimension_value = openapi_client.models.dimension_value.DimensionValue(
                    dimension_name = '', 
                    etag = '', 
                    id = '', 
                    kind = '', 
                ...
                primary = True,
                publisher_update_info = openapi_client.models.last_modified_info.LastModifiedInfo(
                    time = '', ),
                site_id = '',
