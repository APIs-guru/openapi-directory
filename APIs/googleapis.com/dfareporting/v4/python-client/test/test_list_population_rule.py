...
class TestListPopulationRule(unittest.TestCase):
    """ListPopulationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPopulationRule:
        """Test ListPopulationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPopulationRule`
        """
        model = ListPopulationRule()
        if include_optional:
    ...
    def testListPopulationRule(self):
        """Test ListPopulationRule"""
