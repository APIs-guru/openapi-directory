...
class TestCampaignSummary(unittest.TestCase):
    """CampaignSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignSummary:
        """Test CampaignSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignSummary`
        """
