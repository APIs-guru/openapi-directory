...
class TestReportReachCriteria(unittest.TestCase):
    """ReportReachCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportReachCriteria:
        """Test ReportReachCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportReachCriteria`
        """
        model = ReportReachCriteria()
        if include_optional:
    ...
    def testReportReachCriteria(self):
        """Test ReportReachCriteria"""
