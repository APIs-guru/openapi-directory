...
class TestConversionsBatchUpdateResponse(unittest.TestCase):
    """ConversionsBatchUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionsBatchUpdateResponse:
        """Test ConversionsBatchUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversionsBatchUpdateResponse`
        """
        model = ConversionsBatchUpdateResponse()
        if include_optional:
            return ConversionsBatchUpdateResponse(
                has_failures = True,
                kind = '',
                status = [
                    openapi_client.models.conversion_status.ConversionStatus(
    ...
    def testConversionsBatchUpdateResponse(self):
        """Test ConversionsBatchUpdateResponse"""
