...
class CampaignCreativeAssociationsApi:
    ...
    def dfareporting_campaign_creative_associations_insert(
        ...
        campaign_id: Annotated[StrictStr, Field(description="Campaign ID in this association.")],
        ...
        campaign_creative_association: Optional[CampaignCreativeAssociation] = None,
        ...
        :type profile_id: str
        :param campaign_id: Campaign ID in this association. (required)
        ...
        :param campaign_creative_association:
        :type campaign_creative_association: CampaignCreativeAssociation
        ...
        _param = self._dfareporting_campaign_creative_associations_insert_serialize(
            ...
            campaign_creative_association=campaign_creative_association,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CampaignCreativeAssociation",
        }
    ...
    @validate_call
    def dfareporting_campaign_creative_associations_insert_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        campaign_id: Annotated[StrictStr, Field(description="Campaign ID in this association.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CampaignCreativeAssociation]:
        """dfareporting_campaign_creative_associations_insert
    ...
    @validate_call
    def dfareporting_campaign_creative_associations_insert_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        campaign_id: Annotated[StrictStr, Field(description="Campaign ID in this association.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_campaign_creative_associations_insert_serialize(
        self,
        profile_id,
        campaign_id,
        xgafv,
        ...
        if campaign_creative_association is not None:
            _body_params = campaign_creative_association
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userprofiles/{profileId}/campaigns/{campaignId}/campaignCreativeAssociations',
    ...
    def dfareporting_campaign_creative_associations_list(
        ...
        _param = self._dfareporting_campaign_creative_associations_list_serialize(
            profile_id=profile_id,
            campaign_id=campaign_id,
            xgafv=xgafv,
            access_token=access_token,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CampaignCreativeAssociationsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_campaign_creative_associations_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        campaign_id: Annotated[StrictStr, Field(description="Campaign ID in this association.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CampaignCreativeAssociationsListResponse]:
        """dfareporting_campaign_creative_associations_list
    ...
    @validate_call
    def dfareporting_campaign_creative_associations_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        campaign_id: Annotated[StrictStr, Field(description="Campaign ID in this association.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_campaign_creative_associations_list_serialize(
        self,
        profile_id,
        campaign_id,
        xgafv,
