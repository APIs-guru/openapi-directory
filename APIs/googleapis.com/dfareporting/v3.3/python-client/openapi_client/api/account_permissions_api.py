...
class AccountPermissionsApi:
    ...
    def dfareporting_account_permissions_get(
        ...
        id: Annotated[StrictStr, Field(description="Account permission ID.")],
        ...
        _param = self._dfareporting_account_permissions_get_serialize(
    ...
    @validate_call
    def dfareporting_account_permissions_get_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Account permission ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    @validate_call
    def dfareporting_account_permissions_get_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        id: Annotated[StrictStr, Field(description="Account permission ID.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
    ...
    def _dfareporting_account_permissions_get_serialize(
        self,
        profile_id,
        id,
        xgafv,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/accountPermissions/{id}',
    ...
    def dfareporting_account_permissions_list(
        ...
        _param = self._dfareporting_account_permissions_list_serialize(
            profile_id=profile_id,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AccountPermissionsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def dfareporting_account_permissions_list_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountPermissionsListResponse]:
        """dfareporting_account_permissions_list
    ...
    @validate_call
    def dfareporting_account_permissions_list_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="User profile ID associated with this request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _dfareporting_account_permissions_list_serialize(
        self,
        profile_id,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/userprofiles/{profileId}/accountPermissions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
