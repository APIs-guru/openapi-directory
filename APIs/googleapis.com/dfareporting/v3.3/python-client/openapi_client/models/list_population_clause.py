...
class ListPopulationClause(BaseModel):
    ...
    """ # noqa: E501
    terms: Optional[List[ListPopulationTerm]] = Field(default=None, description="Terms of this list population clause. Each clause is made up of list population terms representing constraints and are joined by ORs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terms": [ListPopulationTerm.from_dict(_item) for _item in obj["terms"]] if obj.get("terms") is not None else None
        })
        return _obj
