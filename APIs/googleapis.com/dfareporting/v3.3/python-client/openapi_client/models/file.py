...
class File(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['PROCESSING', 'REPORT_AVAILABLE', 'FAILED', 'CANCELLED']):
            raise ValueError("must be one of enum values ('PROCESSING', 'REPORT_AVAILABLE', 'FAILED', 'CANCELLED')")
        return value
