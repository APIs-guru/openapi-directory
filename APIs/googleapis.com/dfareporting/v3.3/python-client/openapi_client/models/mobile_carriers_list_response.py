...
class MobileCarriersListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#mobileCarriersListResponse\".")
    mobile_carriers: Optional[List[MobileCarrier]] = Field(default=None, description="Mobile carrier collection.", alias="mobileCarriers")
    __properties: ClassVar[List[str]] = ["kind", "mobileCarriers"]
