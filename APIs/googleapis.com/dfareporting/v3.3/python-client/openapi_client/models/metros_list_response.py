...
class MetrosListResponse(BaseModel):
    ...
    Metro List Response
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#metrosListResponse\".")
    metros: Optional[List[Metro]] = Field(default=None, description="Metro collection.")
    __properties: ClassVar[List[str]] = ["kind", "metros"]
