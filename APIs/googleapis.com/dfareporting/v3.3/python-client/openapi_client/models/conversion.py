...
class Conversion(BaseModel):
    ...
    gclid: Optional[StrictStr] = Field(default=None, description="The Google click ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId and mobileDeviceId. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or mobileDeviceId is a required field.")
    ...
    match_id: Optional[StrictStr] = Field(default=None, description="The match ID field. A match ID is your own first-party identifier that has been synced with Google using the match ID feature in Floodlight. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[],mobileDeviceId and gclid. This or encryptedUserId or encryptedUserIdCandidates[] or mobileDeviceId or gclid is a required field.", alias="matchId")
    mobile_device_id: Optional[StrictStr] = Field(default=None, description="The mobile device ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId and gclid. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or gclid is a required field.", alias="mobileDeviceId")
    ...
    __properties: ClassVar[List[str]] = ["childDirectedTreatment", "customVariables", "encryptedUserId", "encryptedUserIdCandidates", "floodlightActivityId", "floodlightConfigurationId", "gclid", "kind", "limitAdTracking", "matchId", "mobileDeviceId", "nonPersonalizedAd", "ordinal", "quantity", "timestampMicros", "treatmentForUnderage", "value"]
