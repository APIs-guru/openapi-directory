...
class Report(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "criteria", "crossDimensionReachCriteria", "delivery", "etag", "fileName", "floodlightCriteria", "format", "id", "kind", "lastModifiedTime", "name", "ownerProfileId", "pathToConversionCriteria", "reachCriteria", "schedule", "subAccountId", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['STANDARD', 'REACH', 'PATH_TO_CONVERSION', 'CROSS_DIMENSION_REACH', 'FLOODLIGHT']):
            raise ValueError("must be one of enum values ('STANDARD', 'REACH', 'PATH_TO_CONVERSION', 'CROSS_DIMENSION_REACH', 'FLOODLIGHT')")
        return value
