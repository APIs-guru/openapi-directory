...
class CompatibleFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["crossDimensionReachReportCompatibleFields", "floodlightReportCompatibleFields", "kind", "pathToConversionReportCompatibleFields", "reachReportCompatibleFields", "reportCompatibleFields"]
