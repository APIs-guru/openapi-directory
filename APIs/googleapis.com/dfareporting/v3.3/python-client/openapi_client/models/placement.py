...
class Placement(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of this placement.This is a required field and must be less than or equal to 256 characters long.")
