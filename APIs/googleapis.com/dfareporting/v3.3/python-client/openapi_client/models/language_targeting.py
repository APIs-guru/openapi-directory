...
class LanguageTargeting(BaseModel):
    ...
    Language Targeting.
    """ # noqa: E501
    languages: Optional[List[Language]] = Field(default=None, description="Languages that this ad targets. For each language only languageId is required. The other fields are populated automatically when the ad is inserted or updated.")
