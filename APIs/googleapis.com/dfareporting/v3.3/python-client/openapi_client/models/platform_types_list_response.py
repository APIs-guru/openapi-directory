...
class PlatformTypesListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#platformTypesListResponse\".")
    platform_types: Optional[List[PlatformType]] = Field(default=None, description="Platform type collection.", alias="platformTypes")
    __properties: ClassVar[List[str]] = ["kind", "platformTypes"]
