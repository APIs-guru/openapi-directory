...
class PricingSchedule(BaseModel):
    ...
    disregard_overdelivery: Optional[StrictBool] = Field(default=None, description="Whether cap costs are ignored by ad serving.", alias="disregardOverdelivery")
    ...
    __properties: ClassVar[List[str]] = ["capCostOption", "disregardOverdelivery", "endDate", "flighted", "floodlightActivityId", "pricingPeriods", "pricingType", "startDate", "testingStartDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "disregardOverdelivery": obj.get("disregardOverdelivery"),
