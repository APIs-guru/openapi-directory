...
class InventoryItemsListResponse(BaseModel):
    ...
    """ # noqa: E501
    inventory_items: Optional[List[InventoryItem]] = Field(default=None, description="Inventory item collection", alias="inventoryItems")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#inventoryItemsListResponse\".")
    ...
    __properties: ClassVar[List[str]] = ["inventoryItems", "kind", "nextPageToken"]
