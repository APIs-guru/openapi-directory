...
class ConversionsBatchInsertRequest(BaseModel):
    ...
    """ # noqa: E501
    conversions: Optional[List[Conversion]] = Field(default=None, description="The set of conversions to insert.")
    encryption_info: Optional[EncryptionInfo] = Field(default=None, alias="encryptionInfo")
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#conversionsBatchInsertRequest\".")
