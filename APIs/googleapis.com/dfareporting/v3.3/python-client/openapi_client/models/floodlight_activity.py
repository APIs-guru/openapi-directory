...
class FloodlightActivity(BaseModel):
    ...
    hidden: Optional[StrictBool] = Field(default=None, description="Whether this activity is archived.")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "advertiserId", "advertiserIdDimensionValue", "cacheBustingType", "countingMethod", "defaultTags", "expectedUrl", "floodlightActivityGroupId", "floodlightActivityGroupName", "floodlightActivityGroupTagString", "floodlightActivityGroupType", "floodlightConfigurationId", "floodlightConfigurationIdDimensionValue", "floodlightTagType", "hidden", "id", "idDimensionValue", "kind", "name", "notes", "publisherTags", "secure", "sslCompliant", "sslRequired", "subaccountId", "tagFormat", "tagString", "userDefinedVariableTypes"]
