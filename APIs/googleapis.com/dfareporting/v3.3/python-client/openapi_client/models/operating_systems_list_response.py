...
class OperatingSystemsListResponse(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Identifies what kind of resource this is. Value: the fixed string \"dfareporting#operatingSystemsListResponse\".")
    operating_systems: Optional[List[OperatingSystem]] = Field(default=None, description="Operating system collection.", alias="operatingSystems")
    __properties: ClassVar[List[str]] = ["kind", "operatingSystems"]
