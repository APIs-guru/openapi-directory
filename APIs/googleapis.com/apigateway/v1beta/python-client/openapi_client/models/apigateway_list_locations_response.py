...
class ApigatewayListLocationsResponse(BaseModel):
    """
    The response message for Locations.ListLocations.
    """ # noqa: E501
    locations: Optional[List[ApigatewayLocation]] = Field(default=None, description="A list of locations that matches the specified filter in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "locations": [ApigatewayLocation.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
