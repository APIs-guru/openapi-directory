...
apigateway_status_instance = ApigatewayStatus.from_json(json)
# print the JSON string representation of the object
print(ApigatewayStatus.to_json())

# convert the object into a dict
apigateway_status_dict = apigateway_status_instance.to_dict()
# create an instance of ApigatewayStatus from a dict
apigateway_status_from_dict = ApigatewayStatus.from_dict(apigateway_status_dict)
```
