...
**error** | [**ApigatewayStatus**](ApigatewayStatus.md) |  | [optional] 
...
json = "{}"
# create an instance of ApigatewayOperation from a JSON string
apigateway_operation_instance = ApigatewayOperation.from_json(json)
# print the JSON string representation of the object
print(ApigatewayOperation.to_json())

# convert the object into a dict
apigateway_operation_dict = apigateway_operation_instance.to_dict()
# create an instance of ApigatewayOperation from a dict
apigateway_operation_from_dict = ApigatewayOperation.from_dict(apigateway_operation_dict)
```
