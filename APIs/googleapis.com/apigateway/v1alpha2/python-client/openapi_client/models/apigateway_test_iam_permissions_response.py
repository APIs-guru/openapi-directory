...
class ApigatewayTestIamPermissionsResponse(BaseModel):
    """
    Response message for `TestIamPermissions` method.
    """ # noqa: E501
    permissions: Optional[List[StrictStr]] = Field(default=None, description="A subset of `TestPermissionsRequest.permissions` that the caller is allowed.")
