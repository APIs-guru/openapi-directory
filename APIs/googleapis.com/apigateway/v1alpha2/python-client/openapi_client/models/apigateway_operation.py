...
class ApigatewayOperation(BaseModel):
    """
    ...
    error: Optional[ApigatewayStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "done": obj.get("done"),
            "error": ApigatewayStatus.from_dict(obj["error"]) if obj.get("error") is not None else None,
