...
------------- | ------------- | -------------
[**apigateway_projects_locations_gateways_get_iam_policy**](ProjectsApi.md#apigateway_projects_locations_gateways_get_iam_policy) | **GET** /v1alpha2/{resource}:getIamPolicy | 
[**apigateway_projects_locations_gateways_set_iam_policy**](ProjectsApi.md#apigateway_projects_locations_gateways_set_iam_policy) | **POST** /v1alpha2/{resource}:setIamPolicy | 
[**apigateway_projects_locations_gateways_test_iam_permissions**](ProjectsApi.md#apigateway_projects_locations_gateways_test_iam_permissions) | **POST** /v1alpha2/{resource}:testIamPermissions | 
[**apigateway_projects_locations_list**](ProjectsApi.md#apigateway_projects_locations_list) | **GET** /v1alpha2/{name}/locations | 
[**apigateway_projects_locations_operations_cancel**](ProjectsApi.md#apigateway_projects_locations_operations_cancel) | **POST** /v1alpha2/{name}:cancel | 
[**apigateway_projects_locations_operations_delete**](ProjectsApi.md#apigateway_projects_locations_operations_delete) | **DELETE** /v1alpha2/{name} | 
[**apigateway_projects_locations_operations_get**](ProjectsApi.md#apigateway_projects_locations_operations_get) | **GET** /v1alpha2/{name} | 
[**apigateway_projects_locations_operations_list**](ProjectsApi.md#apigateway_projects_locations_operations_list) | **GET** /v1alpha2/{name}/operations | 
...
> ApigatewayOperation apigateway_projects_locations_operations_get(name, xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type)
