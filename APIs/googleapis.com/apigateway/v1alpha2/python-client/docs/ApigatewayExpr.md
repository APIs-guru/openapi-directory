...
json = "{}"
# create an instance of ApigatewayExpr from a JSON string
apigateway_expr_instance = ApigatewayExpr.from_json(json)
# print the JSON string representation of the object
print(ApigatewayExpr.to_json())

# convert the object into a dict
apigateway_expr_dict = apigateway_expr_instance.to_dict()
# create an instance of ApigatewayExpr from a dict
apigateway_expr_from_dict = ApigatewayExpr.from_dict(apigateway_expr_dict)
```
