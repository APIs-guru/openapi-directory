...
------------ | ------------- | ------------- | -------------
**condition** | [**ApigatewayExpr**](ApigatewayExpr.md) |  | [optional] 
...
json = "{}"
# create an instance of ApigatewayBinding from a JSON string
apigateway_binding_instance = ApigatewayBinding.from_json(json)
# print the JSON string representation of the object
print(ApigatewayBinding.to_json())

# convert the object into a dict
apigateway_binding_dict = apigateway_binding_instance.to_dict()
# create an instance of ApigatewayBinding from a dict
apigateway_binding_from_dict = ApigatewayBinding.from_dict(apigateway_binding_dict)
```
