...
class ApigatewayApiConfigOpenApiDocument(BaseModel):
    """
    An OpenAPI Specification Document describing an API.
    """ # noqa: E501
    document: Optional[ApigatewayApiConfigFile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "document": ApigatewayApiConfigFile.from_dict(obj["document"]) if obj.get("document") is not None else None
        })
        return _obj
