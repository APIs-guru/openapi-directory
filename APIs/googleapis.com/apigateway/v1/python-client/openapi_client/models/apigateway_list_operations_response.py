...
class ApigatewayListOperationsResponse(BaseModel):
    """
    ...
    operations: Optional[List[ApigatewayOperation]] = Field(default=None, description="A list of operations that matches the specified filter in the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": [ApigatewayOperation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
