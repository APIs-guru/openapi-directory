...
class ApigatewayApiConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createTime", "displayName", "gatewayServiceAccount", "grpcServices", "labels", "managedServiceConfigs", "name", "openapiDocuments", "serviceConfigId", "state", "updateTime"]
