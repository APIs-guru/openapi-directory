...
class GoogleChromePolicyVersionsV1DefineCertificateResponse(BaseModel):
    ...
    """ # noqa: E501
    network_id: Optional[StrictStr] = Field(default=None, description="The guid of the certificate created by the action.", alias="networkId")
    settings: Optional[List[GoogleChromePolicyVersionsV1NetworkSetting]] = Field(default=None, description="the affiliated settings of the certificate (NOT IMPLEMENTED)")
    target_resource: Optional[StrictStr] = Field(default=None, description="the resource at which the certificate is defined.", alias="targetResource")
