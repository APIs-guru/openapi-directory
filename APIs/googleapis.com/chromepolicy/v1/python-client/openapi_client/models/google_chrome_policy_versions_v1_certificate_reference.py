...
class GoogleChromePolicyVersionsV1CertificateReference(BaseModel):
    ...
    """ # noqa: E501
    network: Optional[StrictStr] = Field(default=None, description="Output only. The name of the referencing network.")
    org_unit_id: Optional[StrictStr] = Field(default=None, description="Output only. The obfuscated id of the org unit the referencing network is in.", alias="orgUnitId")
    __properties: ClassVar[List[str]] = ["network", "orgUnitId"]
