...
class GoogleChromePolicyVersionsV1PolicyModificationFieldError(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="Output only. The error message related to the field.")
    var_field: Optional[StrictStr] = Field(default=None, description="Output only. The name of the field with the error.", alias="field")
