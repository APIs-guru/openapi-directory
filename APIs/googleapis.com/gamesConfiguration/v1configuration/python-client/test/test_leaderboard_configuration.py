...
class TestLeaderboardConfiguration(unittest.TestCase):
    """LeaderboardConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeaderboardConfiguration:
        """Test LeaderboardConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeaderboardConfiguration`
        """
        model = LeaderboardConfiguration()
        if include_optional:
    ...
    def testLeaderboardConfiguration(self):
        """Test LeaderboardConfiguration"""
