...
class LocalizedStringBundle(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the type of this resource. Value is always the fixed string `gamesConfiguration#localizedStringBundle`.")
    translations: Optional[List[LocalizedString]] = Field(default=None, description="The locale strings.")
    __properties: ClassVar[List[str]] = ["kind", "translations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "translations": [LocalizedString.from_dict(_item) for _item in obj["translations"]] if obj.get("translations") is not None else None
        })
        return _obj
