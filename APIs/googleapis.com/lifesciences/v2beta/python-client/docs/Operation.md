...
**metadata** | **Dict[str, object]** | An Metadata object. This will always be returned with the Operation. | [optional] 
**name** | **str** | The server-assigned name for the operation. This may be passed to the other operation methods to retrieve information about the operation&#39;s status. | [optional] 
