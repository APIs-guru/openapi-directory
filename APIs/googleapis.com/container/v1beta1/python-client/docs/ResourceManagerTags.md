...
------------ | ------------- | ------------- | -------------
**tags** | **Dict[str, str]** | Tags must be in one of the following formats ([KEY]&#x3D;[VALUE]) 1. &#x60;tagKeys/{tag_key_id}&#x3D;tagValues/{tag_value_id}&#x60; 2. &#x60;{org_id}/{tag_key_name}&#x3D;{tag_value_name}&#x60; 3. &#x60;{project_id}/{tag_key_name}&#x3D;{tag_value_name}&#x60; | [optional] 
