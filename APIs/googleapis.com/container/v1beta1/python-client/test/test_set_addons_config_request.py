...
class TestSetAddonsConfigRequest(unittest.TestCase):
    """SetAddonsConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetAddonsConfigRequest:
        """Test SetAddonsConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetAddonsConfigRequest`
        """
        model = SetAddonsConfigRequest()
        if include_optional:
    ...
    def testSetAddonsConfigRequest(self):
        """Test SetAddonsConfigRequest"""
