...
class TestHostMaintenancePolicy(unittest.TestCase):
    """HostMaintenancePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostMaintenancePolicy:
        """Test HostMaintenancePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HostMaintenancePolicy`
        """
        model = HostMaintenancePolicy()
        if include_optional:
    ...
    def testHostMaintenancePolicy(self):
        """Test HostMaintenancePolicy"""
