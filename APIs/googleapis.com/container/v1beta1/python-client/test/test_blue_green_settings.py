...
class TestBlueGreenSettings(unittest.TestCase):
    """BlueGreenSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlueGreenSettings:
        """Test BlueGreenSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlueGreenSettings`
        """
        model = BlueGreenSettings()
        if include_optional:
    ...
    def testBlueGreenSettings(self):
        """Test BlueGreenSettings"""
