...
class UpdateClusterRequest(BaseModel):
    ...
    update: Optional[ClusterUpdate] = None
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "name", "projectId", "update", "zone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "update": ClusterUpdate.from_dict(obj["update"]) if obj.get("update") is not None else None,
            "zone": obj.get("zone")
        })
        return _obj
