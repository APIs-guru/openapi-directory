...
class SetLegacyAbacRequest(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Required. Whether ABAC authorization will be enabled in the cluster.")
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster name) of the cluster to set legacy abac. Specified in the format `projects/*/locations/*/clusters/*`.")
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "enabled", "name", "projectId", "zone"]
