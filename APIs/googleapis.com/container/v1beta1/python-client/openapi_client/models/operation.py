...
class Operation(BaseModel):
    ...
    status_message: Optional[StrictStr] = Field(default=None, description="Output only. If an error has occurred, a textual description of the error. Deprecated. Use field error instead.", alias="statusMessage")
