...
class Cluster(BaseModel):
    ...
    cluster_telemetry: Optional[ClusterTelemetry] = Field(default=None, alias="clusterTelemetry")
    ...
    current_node_version: Optional[StrictStr] = Field(default=None, description="[Output only] Deprecated, use [NodePool.version](https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1beta1/projects.locations.clusters.nodePools) instead. The current version of the node software components. If they are currently at multiple versions because they're in the process of being upgraded, this reflects the minimum version of all nodes.", alias="currentNodeVersion")
    ...
    enable_tpu: Optional[StrictBool] = Field(default=None, description="Enable the ability to use Cloud TPUs in this cluster. This field is deprecated, use tpu_config.enabled instead.", alias="enableTpu")
    ...
    master: Optional[Dict[str, Any]] = Field(default=None, description="Master is the configuration for components on master.")
    ...
    master_ipv4_cidr_block: Optional[StrictStr] = Field(default=None, description="The IP prefix in CIDR notation to use for the hosted master network. This prefix will be used for assigning private IP addresses to the master or set of masters, as well as the ILB VIP. This field is deprecated, use private_cluster_config.master_ipv4_cidr_block instead.", alias="masterIpv4CidrBlock")
    ...
    network: Optional[StrictStr] = Field(default=None, description="The name of the Google Compute Engine [network](https://cloud.google.com/compute/docs/networks-and-firewalls#networks) to which the cluster is connected. If left unspecified, the `default` network will be used. On output this shows the network ID instead of the name.")
    ...
    pod_security_policy_config: Optional[PodSecurityPolicyConfig] = Field(default=None, alias="podSecurityPolicyConfig")
    private_cluster: Optional[StrictBool] = Field(default=None, description="If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.", alias="privateCluster")
    private_cluster_config: Optional[PrivateClusterConfig] = Field(default=None, alias="privateClusterConfig")
    protect_config: Optional[ProtectConfig] = Field(default=None, alias="protectConfig")
    ...
    subnetwork: Optional[StrictStr] = Field(default=None, description="The name of the Google Compute Engine [subnetwork](https://cloud.google.com/compute/docs/subnetworks) to which the cluster is connected. On output this shows the subnetwork ID instead of the name.")
    tpu_config: Optional[TpuConfig] = Field(default=None, alias="tpuConfig")
    ...
    workload_alts_config: Optional[WorkloadALTSConfig] = Field(default=None, alias="workloadAltsConfig")
    workload_certificates: Optional[WorkloadCertificates] = Field(default=None, alias="workloadCertificates")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of cluster_telemetry
        if self.cluster_telemetry:
            _dict['clusterTelemetry'] = self.cluster_telemetry.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of pod_security_policy_config
        if self.pod_security_policy_config:
            _dict['podSecurityPolicyConfig'] = self.pod_security_policy_config.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of protect_config
        if self.protect_config:
            _dict['protectConfig'] = self.protect_config.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of tpu_config
        if self.tpu_config:
            _dict['tpuConfig'] = self.tpu_config.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of workload_alts_config
        if self.workload_alts_config:
            _dict['workloadAltsConfig'] = self.workload_alts_config.to_dict()
        # override the default output from pydantic by calling `to_dict()` of workload_certificates
        if self.workload_certificates:
            _dict['workloadCertificates'] = self.workload_certificates.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clusterTelemetry": ClusterTelemetry.from_dict(obj["clusterTelemetry"]) if obj.get("clusterTelemetry") is not None else None,
            ...
            "podSecurityPolicyConfig": PodSecurityPolicyConfig.from_dict(obj["podSecurityPolicyConfig"]) if obj.get("podSecurityPolicyConfig") is not None else None,
            "privateCluster": obj.get("privateCluster"),
            ...
            "protectConfig": ProtectConfig.from_dict(obj["protectConfig"]) if obj.get("protectConfig") is not None else None,
            ...
            "tpuConfig": TpuConfig.from_dict(obj["tpuConfig"]) if obj.get("tpuConfig") is not None else None,
            ...
            "workloadAltsConfig": WorkloadALTSConfig.from_dict(obj["workloadAltsConfig"]) if obj.get("workloadAltsConfig") is not None else None,
            "workloadCertificates": WorkloadCertificates.from_dict(obj["workloadCertificates"]) if obj.get("workloadCertificates") is not None else None,
