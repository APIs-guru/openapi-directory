...
class UpdateNodePoolRequest(BaseModel):
    ...
    disk_size_gb: Optional[StrictStr] = Field(default=None, description="Optional. The desired disk size for nodes in the node pool. Initiates an upgrade operation that migrates the nodes in the node pool to the specified disk size.", alias="diskSizeGb")
    disk_type: Optional[StrictStr] = Field(default=None, description="Optional. The desired disk type for nodes in the node pool. Initiates an upgrade operation that migrates the nodes in the node pool to the specified disk type.", alias="diskType")
    ...
    machine_type: Optional[StrictStr] = Field(default=None, description="Optional. The desired machine type for nodes in the node pool. Initiates an upgrade operation that migrates the nodes in the node pool to the specified machine type.", alias="machineType")
    ...
    node_pool_id: Optional[StrictStr] = Field(default=None, description="Required. Deprecated. The name of the node pool to upgrade. This field has been deprecated and replaced by the name field.", alias="nodePoolId")
