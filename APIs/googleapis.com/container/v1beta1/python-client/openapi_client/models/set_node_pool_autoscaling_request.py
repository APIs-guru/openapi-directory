...
class SetNodePoolAutoscalingRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster, node pool) of the node pool to set autoscaler settings. Specified in the format `projects/*/locations/*/clusters/*/nodePools/*`.")
    ...
    __properties: ClassVar[List[str]] = ["autoscaling", "clusterId", "name", "nodePoolId", "projectId", "zone"]
