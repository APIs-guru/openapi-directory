...
class MeshCertificates(BaseModel):
    ...
    """ # noqa: E501
    enable_certificates: Optional[StrictBool] = Field(default=None, description="enable_certificates controls issuance of workload mTLS certificates. If set, the GKE Workload Identity Certificates controller and node agent will be deployed in the cluster, which can then be configured by creating a WorkloadCertificateConfig Custom Resource. Requires Workload Identity (workload_pool must be non-empty).", alias="enableCertificates")
    __properties: ClassVar[List[str]] = ["enableCertificates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enableCertificates": obj.get("enableCertificates")
        })
        return _obj
