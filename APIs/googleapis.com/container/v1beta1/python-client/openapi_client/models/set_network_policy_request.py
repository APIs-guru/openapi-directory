...
class SetNetworkPolicyRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster name) of the cluster to set networking policy. Specified in the format `projects/*/locations/*/clusters/*`.")
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "name", "networkPolicy", "projectId", "zone"]
