...
class SetAddonsConfigRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster) of the cluster to set addons. Specified in the format `projects/*/locations/*/clusters/*`.")
    ...
    __properties: ClassVar[List[str]] = ["addonsConfig", "clusterId", "name", "projectId", "zone"]
