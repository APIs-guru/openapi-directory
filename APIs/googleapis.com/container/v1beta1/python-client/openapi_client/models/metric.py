...
class Metric(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Required. Metric name, e.g., \"nodes total\", \"percent done\".")
    ...
    __properties: ClassVar[List[str]] = ["doubleValue", "intValue", "name", "stringValue"]
