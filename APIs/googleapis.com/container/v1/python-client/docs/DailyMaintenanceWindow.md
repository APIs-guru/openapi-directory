...
------------ | ------------- | ------------- | -------------
**duration** | **str** | [Output only] Duration of the time window, automatically chosen to be smallest possible in the given scenario. Duration will be in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) format \&quot;PTnHnMnS\&quot;. | [optional] 
**start_time** | **str** | Time within the maintenance window to start the maintenance operations. Time format should be in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) format \&quot;HH:MM\&quot;, where HH : [00-23] and MM : [00-59] GMT. | [optional] 
