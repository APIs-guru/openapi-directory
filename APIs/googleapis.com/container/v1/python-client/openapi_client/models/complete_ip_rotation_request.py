...
class CompleteIPRotationRequest(BaseModel):
    ...
    """ # noqa: E501
    cluster_id: Optional[StrictStr] = Field(default=None, description="Deprecated. The name of the cluster. This field has been deprecated and replaced by the name field.", alias="clusterId")
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster name) of the cluster to complete IP rotation. Specified in the format `projects/*/locations/*/clusters/*`.")
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "name", "projectId", "zone"]
