...
class GetJSONWebKeysResponse(BaseModel):
    ...
    keys: Optional[List[Jwk]] = Field(default=None, description="The public component of the keys used by the cluster to sign token requests.")
    __properties: ClassVar[List[str]] = ["cacheHeader", "keys"]
