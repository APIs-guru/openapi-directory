...
class AutoprovisioningNodePoolDefaults(BaseModel):
    ...
    oauth_scopes: Optional[List[StrictStr]] = Field(default=None, description="Scopes that are used by NAP when creating node pools.", alias="oauthScopes")
    service_account: Optional[StrictStr] = Field(default=None, description="The Google Cloud Platform Service Account to be used by the node VMs.", alias="serviceAccount")
