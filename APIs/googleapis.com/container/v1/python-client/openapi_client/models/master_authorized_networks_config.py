...
class MasterAuthorizedNetworksConfig(BaseModel):
    ...
    """ # noqa: E501
    cidr_blocks: Optional[List[CidrBlock]] = Field(default=None, description="cidr_blocks define up to 50 external networks that could access Kubernetes master through HTTPS.", alias="cidrBlocks")
