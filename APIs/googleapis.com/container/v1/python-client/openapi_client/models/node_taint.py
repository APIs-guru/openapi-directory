...
class NodeTaint(BaseModel):
    ...
    """ # noqa: E501
    effect: Optional[StrictStr] = Field(default=None, description="Effect for taint.")
    key: Optional[StrictStr] = Field(default=None, description="Key for taint.")
    value: Optional[StrictStr] = Field(default=None, description="Value for taint.")
    ...
    def effect_validate_enum(cls, value):
        ...
        if value not in set(['EFFECT_UNSPECIFIED', 'NO_SCHEDULE', 'PREFER_NO_SCHEDULE', 'NO_EXECUTE']):
            raise ValueError("must be one of enum values ('EFFECT_UNSPECIFIED', 'NO_SCHEDULE', 'PREFER_NO_SCHEDULE', 'NO_EXECUTE')")
        return value
