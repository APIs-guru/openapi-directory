...
class StartIPRotationRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name (project, location, cluster name) of the cluster to start IP rotation. Specified in the format `projects/*/locations/*/clusters/*`.")
    ...
    rotate_credentials: Optional[StrictBool] = Field(default=None, description="Whether to rotate credentials during IP rotation.", alias="rotateCredentials")
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "name", "projectId", "rotateCredentials", "zone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rotateCredentials": obj.get("rotateCredentials"),
            "zone": obj.get("zone")
        })
        return _obj
