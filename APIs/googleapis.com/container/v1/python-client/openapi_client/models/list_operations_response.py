...
class ListOperationsResponse(BaseModel):
    ...
    """ # noqa: E501
    missing_zones: Optional[List[StrictStr]] = Field(default=None, description="If any zones are listed here, the list of operations returned may be missing the operations from those zones.", alias="missingZones")
    operations: Optional[List[Operation]] = Field(default=None, description="A list of operations in the project in the specified zone.")
    __properties: ClassVar[List[str]] = ["missingZones", "operations"]
