...
class BlueGreenInfo(BaseModel):
    ...
    def phase_validate_enum(cls, value):
        ...
        if value not in set(['PHASE_UNSPECIFIED', 'UPDATE_STARTED', 'CREATING_GREEN_POOL', 'CORDONING_BLUE_POOL', 'DRAINING_BLUE_POOL', 'NODE_POOL_SOAKING', 'DELETING_BLUE_POOL', 'ROLLBACK_STARTED']):
            raise ValueError("must be one of enum values ('PHASE_UNSPECIFIED', 'UPDATE_STARTED', 'CREATING_GREEN_POOL', 'CORDONING_BLUE_POOL', 'DRAINING_BLUE_POOL', 'NODE_POOL_SOAKING', 'DELETING_BLUE_POOL', 'ROLLBACK_STARTED')")
        return value
