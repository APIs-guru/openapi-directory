...
class SoleTenantConfig(BaseModel):
    ...
    """ # noqa: E501
    node_affinities: Optional[List[NodeAffinity]] = Field(default=None, description="NodeAffinities used to match to a shared sole tenant node group.", alias="nodeAffinities")
    __properties: ClassVar[List[str]] = ["nodeAffinities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodeAffinities": [NodeAffinity.from_dict(_item) for _item in obj["nodeAffinities"]] if obj.get("nodeAffinities") is not None else None
        })
        return _obj
