...
class ListTopicsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="If not empty, indicates that there may be more topics that match the request; this value should be passed in a new `ListTopicsRequest`.", alias="nextPageToken")
    topics: Optional[List[Topic]] = Field(default=None, description="The resulting topics.")
