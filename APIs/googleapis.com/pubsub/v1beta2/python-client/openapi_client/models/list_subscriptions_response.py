...
class ListSubscriptionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="If not empty, indicates that there may be more subscriptions that match the request; this value should be passed in a new `ListSubscriptionsRequest` to get more subscriptions.", alias="nextPageToken")
    subscriptions: Optional[List[Subscription]] = Field(default=None, description="The subscriptions that match the request.")
