...
------------ | ------------- | ------------- | -------------
**ack_id** | **List[str]** | The acknowledgment ID for the message being acknowledged. This was returned by the Pub/Sub system in the Pull response. | [optional] 
**subscription** | **str** | The subscription whose message is being acknowledged. | [optional] 
