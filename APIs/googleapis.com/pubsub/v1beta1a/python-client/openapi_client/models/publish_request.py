...
class PublishRequest(BaseModel):
    ...
    topic: Optional[StrictStr] = Field(default=None, description="The message in the request will be published on this topic.")
    __properties: ClassVar[List[str]] = ["message", "topic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": PubsubMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "topic": obj.get("topic")
        })
        return _obj
