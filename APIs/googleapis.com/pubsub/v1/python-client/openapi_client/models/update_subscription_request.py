...
class UpdateSubscriptionRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. Indicates which fields in the provided subscription to update. Must be specified and non-empty.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["subscription", "updateMask"]
