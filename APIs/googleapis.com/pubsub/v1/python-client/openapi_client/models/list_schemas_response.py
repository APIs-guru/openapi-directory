...
class ListSchemasResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="If not empty, indicates that there may be more schemas that match the request; this value should be passed in a new `ListSchemasRequest`.", alias="nextPageToken")
    schemas: Optional[List[ModelSchema]] = Field(default=None, description="The resulting schemas.")
