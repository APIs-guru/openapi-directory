...
class ListSchemaRevisionsResponse(BaseModel):
    """
    Response for the `ListSchemaRevisions` method.
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token that can be sent as `page_token` to retrieve the next page. If this field is empty, there are no subsequent pages.", alias="nextPageToken")
    schemas: Optional[List[ModelSchema]] = Field(default=None, description="The revisions of the schema.")
