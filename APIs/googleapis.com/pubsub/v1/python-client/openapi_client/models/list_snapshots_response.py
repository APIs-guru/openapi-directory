...
class ListSnapshotsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Optional. If not empty, indicates that there may be more snapshot that match the request; this value should be passed in a new `ListSnapshotsRequest`.", alias="nextPageToken")
    snapshots: Optional[List[Snapshot]] = Field(default=None, description="Optional. The resulting snapshots.")
