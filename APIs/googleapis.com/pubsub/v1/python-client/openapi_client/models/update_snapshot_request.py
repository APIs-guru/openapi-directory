...
class UpdateSnapshotRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. Indicates which fields in the provided snapshot to update. Must be specified and non-empty.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["snapshot", "updateMask"]
