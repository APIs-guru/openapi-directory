...
------------ | ------------- | ------------- | -------------
**ack_ids** | **List[str]** | Required. The acknowledgment ID for the messages being acknowledged that was returned by the Pub/Sub system in the &#x60;Pull&#x60; response. Must not be empty. | [optional] 
