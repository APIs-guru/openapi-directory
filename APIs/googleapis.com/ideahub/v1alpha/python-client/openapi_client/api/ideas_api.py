...
class IdeasApi:
    ...
    def ideahub_ideas_list(
        ...
        parent: Annotated[Optional[StrictStr], Field(description="If defined, specifies the creator for which to filter by. Format: publishers/{publisher}/properties/{property}")] = None,
        ...
        _param = self._ideahub_ideas_list_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def ideahub_ideas_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def ideahub_ideas_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _ideahub_ideas_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
