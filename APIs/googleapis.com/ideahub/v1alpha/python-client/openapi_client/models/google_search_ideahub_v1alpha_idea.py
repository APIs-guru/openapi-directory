...
class GoogleSearchIdeahubV1alphaIdea(BaseModel):
    ...
    topics: Optional[List[GoogleSearchIdeahubV1alphaTopic]] = Field(default=None, description="The Topics that match the idea.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "text": obj.get("text"),
            "topics": [GoogleSearchIdeahubV1alphaTopic.from_dict(_item) for _item in obj["topics"]] if obj.get("topics") is not None else None
        })
        return _obj
