...
class PatchInstanceFilter(BaseModel):
    ...
    group_labels: Optional[List[PatchInstanceFilterGroupLabel]] = Field(default=None, description="Targets VM instances matching at least one of these label sets. This allows targeting of disparate groups, for example \"env=prod or env=staging\".", alias="groupLabels")
