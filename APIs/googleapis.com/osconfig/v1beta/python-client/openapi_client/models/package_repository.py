...
class PackageRepository(BaseModel):
    ...
    """ # noqa: E501
    apt: Optional[AptRepository] = None
    goo: Optional[GooRepository] = None
    yum: Optional[YumRepository] = None
    zypper: Optional[ZypperRepository] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apt": AptRepository.from_dict(obj["apt"]) if obj.get("apt") is not None else None,
            "goo": GooRepository.from_dict(obj["goo"]) if obj.get("goo") is not None else None,
            "yum": YumRepository.from_dict(obj["yum"]) if obj.get("yum") is not None else None,
            "zypper": ZypperRepository.from_dict(obj["zypper"]) if obj.get("zypper") is not None else None
        })
        return _obj
