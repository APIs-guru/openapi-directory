...
class AptRepository(BaseModel):
    ...
    """ # noqa: E501
    archive_type: Optional[StrictStr] = Field(default=None, description="Type of archive files in this repository. The default behavior is DEB.", alias="archiveType")
    ...
    gpg_key: Optional[StrictStr] = Field(default=None, description="URI of the key file for this repository. The agent maintains a keyring at `/etc/apt/trusted.gpg.d/osconfig_agent_managed.gpg` containing all the keys in any applied guest policy.", alias="gpgKey")
