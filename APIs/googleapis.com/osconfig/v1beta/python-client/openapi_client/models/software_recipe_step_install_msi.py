...
class SoftwareRecipeStepInstallMsi(BaseModel):
    ...
    flags: Optional[List[StrictStr]] = Field(default=None, description="The flags to use when installing the MSI defaults to [\"/i\"] (i.e. the install flag).")
    __properties: ClassVar[List[str]] = ["allowedExitCodes", "artifactId", "flags"]
