...
class TestSoftwareRecipeStep(unittest.TestCase):
    """SoftwareRecipeStep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareRecipeStep:
        """Test SoftwareRecipeStep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareRecipeStep`
        """
        model = SoftwareRecipeStep()
        if include_optional:
    ...
    def testSoftwareRecipeStep(self):
        """Test SoftwareRecipeStep"""
