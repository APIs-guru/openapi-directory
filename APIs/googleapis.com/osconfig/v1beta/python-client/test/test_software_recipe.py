...
class TestSoftwareRecipe(unittest.TestCase):
    """SoftwareRecipe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareRecipe:
        """Test SoftwareRecipe
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareRecipe`
        """
        model = SoftwareRecipe()
        if include_optional:
