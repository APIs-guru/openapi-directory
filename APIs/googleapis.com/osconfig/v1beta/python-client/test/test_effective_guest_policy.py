...
class TestEffectiveGuestPolicy(unittest.TestCase):
    """EffectiveGuestPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectiveGuestPolicy:
        """Test EffectiveGuestPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectiveGuestPolicy`
        """
        model = EffectiveGuestPolicy()
        if include_optional:
            return EffectiveGuestPolicy(
                package_repositories = [
                    openapi_client.models.effective_guest_policy_sourced_package_repository.EffectiveGuestPolicySourcedPackageRepository(
                ...
                packages = [
                    openapi_client.models.effective_guest_policy_sourced_package.EffectiveGuestPolicySourcedPackage(
                ...
                software_recipes = [
                    openapi_client.models.effective_guest_policy_sourced_software_recipe.EffectiveGuestPolicySourcedSoftwareRecipe(
    ...
    def testEffectiveGuestPolicy(self):
        """Test EffectiveGuestPolicy"""
