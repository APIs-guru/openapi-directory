...
class TestGuestPolicy(unittest.TestCase):
    """GuestPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestPolicy:
        """Test GuestPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestPolicy`
        """
        model = GuestPolicy()
        if include_optional:
            return GuestPolicy(
