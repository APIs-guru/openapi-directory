...
class InventoryWindowsUpdatePackage(BaseModel):
    """
    Details related to a Windows Update package. Field data and names are taken from Windows Update API IUpdate Interface: https://docs.microsoft.com/en-us/windows/win32/api/_wua/ Descriptive fields like title, and description are localized based on the locale of the VM being updated.
    """ # noqa: E501
    categories: Optional[List[InventoryWindowsUpdatePackageWindowsUpdateCategory]] = Field(default=None, description="The categories that are associated with this update package.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [InventoryWindowsUpdatePackageWindowsUpdateCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
