...
class TestListOSPolicyAssignmentsResponse(unittest.TestCase):
    """ListOSPolicyAssignmentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOSPolicyAssignmentsResponse:
        """Test ListOSPolicyAssignmentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOSPolicyAssignmentsResponse`
        """
        model = ListOSPolicyAssignmentsResponse()
        if include_optional:
    ...
    def testListOSPolicyAssignmentsResponse(self):
        """Test ListOSPolicyAssignmentsResponse"""
