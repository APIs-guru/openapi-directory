...
class TestListOSPolicyAssignmentRevisionsResponse(unittest.TestCase):
    """ListOSPolicyAssignmentRevisionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOSPolicyAssignmentRevisionsResponse:
        """Test ListOSPolicyAssignmentRevisionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOSPolicyAssignmentRevisionsResponse`
        """
        model = ListOSPolicyAssignmentRevisionsResponse()
        if include_optional:
            return ListOSPolicyAssignmentRevisionsResponse(
                next_page_token = '',
                os_policy_assignments = [
                    openapi_client.models.os_policy_assignment.OSPolicyAssignment(
                        baseline = True, 
                        deleted = True, 
                        description = '', 
                        etag = '', 
    ...
    def testListOSPolicyAssignmentRevisionsResponse(self):
        """Test ListOSPolicyAssignmentRevisionsResponse"""
