...
class TestListInventoriesResponse(unittest.TestCase):
    """ListInventoriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInventoriesResponse:
        """Test ListInventoriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInventoriesResponse`
        """
        model = ListInventoriesResponse()
        if include_optional:
    ...
    def testListInventoriesResponse(self):
        """Test ListInventoriesResponse"""
