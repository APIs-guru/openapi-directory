...
class TestOSPolicyResource(unittest.TestCase):
    """OSPolicyResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OSPolicyResource:
        """Test OSPolicyResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OSPolicyResource`
        """
        model = OSPolicyResource()
        if include_optional:
            return OSPolicyResource(
                var_exec = openapi_client.models.os_policy_resource_exec_resource.OSPolicyResourceExecResource(
