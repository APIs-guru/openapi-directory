...
class TestListPatchJobsResponse(unittest.TestCase):
    """ListPatchJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPatchJobsResponse:
        """Test ListPatchJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPatchJobsResponse`
        """
        model = ListPatchJobsResponse()
        if include_optional:
            return ListPatchJobsResponse(
                next_page_token = '',
                patch_jobs = [
                    openapi_client.models.patch_job.PatchJob(
                        create_time = '', 
                        description = '', 
                        display_name = '', 
                        dry_run = True, 
    ...
    def testListPatchJobsResponse(self):
        """Test ListPatchJobsResponse"""
