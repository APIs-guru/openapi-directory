...
class TestOSPolicyResourceExecResourceExec(unittest.TestCase):
    """OSPolicyResourceExecResourceExec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OSPolicyResourceExecResourceExec:
        """Test OSPolicyResourceExecResourceExec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OSPolicyResourceExecResourceExec`
        """
        model = OSPolicyResourceExecResourceExec()
        if include_optional:
    ...
    def testOSPolicyResourceExecResourceExec(self):
        """Test OSPolicyResourceExecResourceExec"""
