...
class TestOSPolicyAssignmentReport(unittest.TestCase):
    """OSPolicyAssignmentReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OSPolicyAssignmentReport:
        """Test OSPolicyAssignmentReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OSPolicyAssignmentReport`
        """
        model = OSPolicyAssignmentReport()
        if include_optional:
    ...
    def testOSPolicyAssignmentReport(self):
        """Test OSPolicyAssignmentReport"""
