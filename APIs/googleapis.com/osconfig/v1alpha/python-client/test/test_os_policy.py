...
class TestOSPolicy(unittest.TestCase):
    """OSPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OSPolicy:
        """Test OSPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OSPolicy`
        """
        model = OSPolicy()
        if include_optional:
            return OSPolicy(
