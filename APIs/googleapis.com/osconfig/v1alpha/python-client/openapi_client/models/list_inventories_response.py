...
class ListInventoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    inventories: Optional[List[Inventory]] = Field(default=None, description="List of inventory objects.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="The pagination token to retrieve the next page of inventory objects.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["inventories", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventories": [Inventory.from_dict(_item) for _item in obj["inventories"]] if obj.get("inventories") is not None else None,
