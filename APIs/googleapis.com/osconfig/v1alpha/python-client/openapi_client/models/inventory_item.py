...
class InventoryItem(BaseModel):
    ...
    """ # noqa: E501
    available_package: Optional[InventorySoftwarePackage] = Field(default=None, alias="availablePackage")
    ...
    installed_package: Optional[InventorySoftwarePackage] = Field(default=None, alias="installedPackage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availablePackage": InventorySoftwarePackage.from_dict(obj["availablePackage"]) if obj.get("availablePackage") is not None else None,
            "createTime": obj.get("createTime"),
            "id": obj.get("id"),
            "installedPackage": InventorySoftwarePackage.from_dict(obj["installedPackage"]) if obj.get("installedPackage") is not None else None,
