...
class OSPolicyAssignmentInstanceFilter(BaseModel):
    ...
    os_short_names: Optional[List[StrictStr]] = Field(default=None, description="Deprecated. Use the `inventories` field instead. A VM is selected if it's OS short name matches with any of the values provided in this list.", alias="osShortNames")
    __properties: ClassVar[List[str]] = ["all", "exclusionLabels", "inclusionLabels", "inventories", "osShortNames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "osShortNames": obj.get("osShortNames")
        })
        return _obj
