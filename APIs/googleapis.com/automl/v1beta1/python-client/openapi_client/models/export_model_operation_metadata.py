...
class ExportModelOperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    output_info: Optional[ExportModelOutputInfo] = Field(default=None, alias="outputInfo")
    __properties: ClassVar[List[str]] = ["outputInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputInfo": ExportModelOutputInfo.from_dict(obj["outputInfo"]) if obj.get("outputInfo") is not None else None
        })
        return _obj
