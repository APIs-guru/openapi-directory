...
class BigQueryDestination(BaseModel):
    ...
    """ # noqa: E501
    output_uri: Optional[StrictStr] = Field(default=None, description="Required. BigQuery URI to a project, up to 2000 characters long. Accepted forms: * BigQuery path e.g. bq://projectId", alias="outputUri")
