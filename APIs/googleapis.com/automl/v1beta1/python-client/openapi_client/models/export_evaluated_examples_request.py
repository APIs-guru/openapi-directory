...
class ExportEvaluatedExamplesRequest(BaseModel):
    ...
    """ # noqa: E501
    output_config: Optional[ExportEvaluatedExamplesOutputConfig] = Field(default=None, alias="outputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputConfig": ExportEvaluatedExamplesOutputConfig.from_dict(obj["outputConfig"]) if obj.get("outputConfig") is not None else None
        })
        return _obj
