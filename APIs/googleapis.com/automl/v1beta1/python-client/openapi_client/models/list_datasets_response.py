...
class ListDatasetsResponse(BaseModel):
    ...
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve next page of results. Pass to ListDatasetsRequest.page_token to obtain that page.", alias="nextPageToken")
