...
class Float64Stats(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["histogramBuckets", "mean", "quantiles", "standardDeviation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "histogramBuckets": [HistogramBucket.from_dict(_item) for _item in obj["histogramBuckets"]] if obj.get("histogramBuckets") is not None else None,
            "mean": obj.get("mean"),
