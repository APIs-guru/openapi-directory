...
class BoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    normalized_vertices: Optional[List[NormalizedVertex]] = Field(default=None, description="Output only . The bounding polygon normalized vertices.", alias="normalizedVertices")
