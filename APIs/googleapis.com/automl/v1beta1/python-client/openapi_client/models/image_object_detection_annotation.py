...
class ImageObjectDetectionAnnotation(BaseModel):
    ...
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Output only. The confidence that this annotation is positive for the parent example, value in [0, 1], higher means higher positivity confidence.")
    __properties: ClassVar[List[str]] = ["boundingBox", "score"]
