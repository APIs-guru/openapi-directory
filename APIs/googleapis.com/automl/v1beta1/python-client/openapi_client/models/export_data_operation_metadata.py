...
class ExportDataOperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    output_info: Optional[ExportDataOutputInfo] = Field(default=None, alias="outputInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputInfo": ExportDataOutputInfo.from_dict(obj["outputInfo"]) if obj.get("outputInfo") is not None else None
        })
        return _obj
