...
class TestPredictRequest(unittest.TestCase):
    """PredictRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PredictRequest:
        """Test PredictRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PredictRequest`
        """
        ...
        if include_optional:
            return PredictRequest(
                ...
                payload = openapi_client.models.example_payload.ExamplePayload(
