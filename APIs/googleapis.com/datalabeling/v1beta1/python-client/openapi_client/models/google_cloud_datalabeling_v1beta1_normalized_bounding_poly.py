...
class GoogleCloudDatalabelingV1beta1NormalizedBoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    normalized_vertices: Optional[List[GoogleCloudDatalabelingV1beta1NormalizedVertex]] = Field(default=None, description="The bounding polygon normalized vertices.", alias="normalizedVertices")
    __properties: ClassVar[List[str]] = ["normalizedVertices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "normalizedVertices": [GoogleCloudDatalabelingV1beta1NormalizedVertex.from_dict(_item) for _item in obj["normalizedVertices"]] if obj.get("normalizedVertices") is not None else None
        })
        return _obj
