...
class GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluations: Optional[List[GoogleCloudDatalabelingV1beta1Evaluation]] = Field(default=None, description="The list of evaluations matching the search.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluations": [GoogleCloudDatalabelingV1beta1Evaluation.from_dict(_item) for _item in obj["evaluations"]] if obj.get("evaluations") is not None else None,
