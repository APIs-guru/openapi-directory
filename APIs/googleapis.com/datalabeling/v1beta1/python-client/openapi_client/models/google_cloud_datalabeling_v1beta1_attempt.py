...
class GoogleCloudDatalabelingV1beta1Attempt(BaseModel):
    ...
    """ # noqa: E501
    attempt_time: Optional[StrictStr] = Field(default=None, alias="attemptTime")
    partial_failures: Optional[List[GoogleRpcStatus]] = Field(default=None, description="Details of errors that occurred.", alias="partialFailures")
    __properties: ClassVar[List[str]] = ["attemptTime", "partialFailures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attemptTime": obj.get("attemptTime"),
