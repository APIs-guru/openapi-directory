...
class GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata(BaseModel):
    ...
    create_time: Optional[StrictStr] = Field(default=None, description="Output only. Timestamp when export dataset request was created.", alias="createTime")
    dataset: Optional[StrictStr] = Field(default=None, description="Output only. The name of dataset to be exported. \"projects/*/datasets/*\"")
    ...
    __properties: ClassVar[List[str]] = ["annotatedDataset", "createTime", "dataset", "partialFailures"]
