...
class GoogleCloudDatalabelingV1beta1DataItem(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. Name of the data item, in format of: projects/{project_id}/datasets/{dataset_id}/dataItems/{data_item_id}")
    ...
    __properties: ClassVar[List[str]] = ["imagePayload", "name", "textPayload", "videoPayload"]
