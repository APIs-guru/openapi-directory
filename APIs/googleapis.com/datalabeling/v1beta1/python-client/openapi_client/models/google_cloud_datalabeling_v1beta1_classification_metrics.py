...
class GoogleCloudDatalabelingV1beta1ClassificationMetrics(BaseModel):
    ...
    """ # noqa: E501
    confusion_matrix: Optional[GoogleCloudDatalabelingV1beta1ConfusionMatrix] = Field(default=None, alias="confusionMatrix")
    pr_curve: Optional[GoogleCloudDatalabelingV1beta1PrCurve] = Field(default=None, alias="prCurve")
    __properties: ClassVar[List[str]] = ["confusionMatrix", "prCurve"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confusionMatrix": GoogleCloudDatalabelingV1beta1ConfusionMatrix.from_dict(obj["confusionMatrix"]) if obj.get("confusionMatrix") is not None else None,
