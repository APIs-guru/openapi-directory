...
class GoogleCloudDatalabelingV1beta1ListInstructionsResponse(BaseModel):
    ...
    """ # noqa: E501
    instructions: Optional[List[GoogleCloudDatalabelingV1beta1Instruction]] = Field(default=None, description="The list of Instructions to return.")
    ...
    __properties: ClassVar[List[str]] = ["instructions", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instructions": [GoogleCloudDatalabelingV1beta1Instruction.from_dict(_item) for _item in obj["instructions"]] if obj.get("instructions") is not None else None,
