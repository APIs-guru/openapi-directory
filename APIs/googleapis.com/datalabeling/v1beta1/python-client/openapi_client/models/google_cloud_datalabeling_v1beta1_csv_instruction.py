...
class GoogleCloudDatalabelingV1beta1CsvInstruction(BaseModel):
    ...
    """ # noqa: E501
    gcs_file_uri: Optional[StrictStr] = Field(default=None, description="CSV file for the instruction. Only gcs path is allowed.", alias="gcsFileUri")
    __properties: ClassVar[List[str]] = ["gcsFileUri"]
