...
class GoogleCloudDatalabelingV1beta1ListDataItemsResponse(BaseModel):
    ...
    """ # noqa: E501
    data_items: Optional[List[GoogleCloudDatalabelingV1beta1DataItem]] = Field(default=None, description="The list of data items to return.", alias="dataItems")
    ...
    __properties: ClassVar[List[str]] = ["dataItems", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataItems": [GoogleCloudDatalabelingV1beta1DataItem.from_dict(_item) for _item in obj["dataItems"]] if obj.get("dataItems") is not None else None,
