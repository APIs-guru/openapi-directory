...
class GoogleCloudDatalabelingV1beta1ListExamplesResponse(BaseModel):
    ...
    """ # noqa: E501
    examples: Optional[List[GoogleCloudDatalabelingV1beta1Example]] = Field(default=None, description="The list of examples to return.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "examples": [GoogleCloudDatalabelingV1beta1Example.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None,
