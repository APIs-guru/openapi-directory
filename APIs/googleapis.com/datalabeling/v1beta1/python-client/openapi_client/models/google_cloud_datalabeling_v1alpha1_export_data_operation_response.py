...
class GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse(BaseModel):
    ...
    label_stats: Optional[GoogleCloudDatalabelingV1alpha1LabelStats] = Field(default=None, alias="labelStats")
    output_config: Optional[GoogleCloudDatalabelingV1alpha1OutputConfig] = Field(default=None, alias="outputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "labelStats": GoogleCloudDatalabelingV1alpha1LabelStats.from_dict(obj["labelStats"]) if obj.get("labelStats") is not None else None,
            "outputConfig": GoogleCloudDatalabelingV1alpha1OutputConfig.from_dict(obj["outputConfig"]) if obj.get("outputConfig") is not None else None,
