...
class GoogleCloudDatalabelingV1beta1SequentialSegment(BaseModel):
    ...
    """ # noqa: E501
    end: Optional[StrictInt] = Field(default=None, description="End position (exclusive).")
    start: Optional[StrictInt] = Field(default=None, description="Start position (inclusive).")
