...
class GoogleCloudDatalabelingV1beta1AnnotationMetadata(BaseModel):
    ...
    """ # noqa: E501
    operator_metadata: Optional[GoogleCloudDatalabelingV1beta1OperatorMetadata] = Field(default=None, alias="operatorMetadata")
    __properties: ClassVar[List[str]] = ["operatorMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operatorMetadata": GoogleCloudDatalabelingV1beta1OperatorMetadata.from_dict(obj["operatorMetadata"]) if obj.get("operatorMetadata") is not None else None
        })
        return _obj
