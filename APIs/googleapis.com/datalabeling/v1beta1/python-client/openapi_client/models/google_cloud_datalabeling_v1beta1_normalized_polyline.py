...
class GoogleCloudDatalabelingV1beta1NormalizedPolyline(BaseModel):
    ...
    Normalized polyline.
    """ # noqa: E501
    normalized_vertices: Optional[List[GoogleCloudDatalabelingV1beta1NormalizedVertex]] = Field(default=None, description="The normalized polyline vertices.", alias="normalizedVertices")
