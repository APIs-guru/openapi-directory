...
class GoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata(BaseModel):
    ...
    """ # noqa: E501
    create_time: Optional[StrictStr] = Field(default=None, description="Output only. Timestamp when import dataset request was created.", alias="createTime")
    dataset: Optional[StrictStr] = Field(default=None, description="Output only. The name of imported dataset. \"projects/*/datasets/*\"")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "dataset", "partialFailures"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata from a dict"""
        if obj is None:
            return None
