...
class GoogleCloudDatalabelingV1beta1TextMetadata(BaseModel):
    ...
    """ # noqa: E501
    language_code: Optional[StrictStr] = Field(default=None, description="The language of this text, as a [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt). Default value is en-US.", alias="languageCode")
