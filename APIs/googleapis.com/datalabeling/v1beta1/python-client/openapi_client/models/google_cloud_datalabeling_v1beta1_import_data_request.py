...
class GoogleCloudDatalabelingV1beta1ImportDataRequest(BaseModel):
    ...
    user_email_address: Optional[StrictStr] = Field(default=None, description="Email of the user who started the import task and should be notified by email. If empty no notification will be sent.", alias="userEmailAddress")
    __properties: ClassVar[List[str]] = ["inputConfig", "userEmailAddress"]
