...
class GoogleCloudDatalabelingV1beta1ListDatasetsResponse(BaseModel):
    ...
    """ # noqa: E501
    datasets: Optional[List[GoogleCloudDatalabelingV1beta1Dataset]] = Field(default=None, description="The list of datasets to return.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [GoogleCloudDatalabelingV1beta1Dataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
