...
class GoogleCloudDatalabelingV1beta1CreateInstructionRequest(BaseModel):
    ...
    """ # noqa: E501
    instruction: Optional[GoogleCloudDatalabelingV1beta1Instruction] = None
    __properties: ClassVar[List[str]] = ["instruction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instruction": GoogleCloudDatalabelingV1beta1Instruction.from_dict(obj["instruction"]) if obj.get("instruction") is not None else None
        })
        return _obj
