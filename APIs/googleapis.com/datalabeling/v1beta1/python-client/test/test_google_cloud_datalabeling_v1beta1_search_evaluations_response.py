...
class TestGoogleCloudDatalabelingV1beta1SearchEvaluationsResponse(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse:
        """Test GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse`
        """
        model = GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse()
        if include_optional:
            return GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse(
                evaluations = [
                    openapi_client.models.google_cloud_datalabeling_v1beta1_evaluation.GoogleCloudDatalabelingV1beta1Evaluation(
    ...
    def testGoogleCloudDatalabelingV1beta1SearchEvaluationsResponse(self):
        """Test GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse"""
