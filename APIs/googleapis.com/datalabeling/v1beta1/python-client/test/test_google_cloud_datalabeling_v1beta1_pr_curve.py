...
class TestGoogleCloudDatalabelingV1beta1PrCurve(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1PrCurve unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1PrCurve:
        """Test GoogleCloudDatalabelingV1beta1PrCurve
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1PrCurve`
        """
        model = GoogleCloudDatalabelingV1beta1PrCurve()
        if include_optional:
    ...
    def testGoogleCloudDatalabelingV1beta1PrCurve(self):
        """Test GoogleCloudDatalabelingV1beta1PrCurve"""
