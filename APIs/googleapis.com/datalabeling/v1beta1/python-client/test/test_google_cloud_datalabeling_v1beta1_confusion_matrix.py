...
class TestGoogleCloudDatalabelingV1beta1ConfusionMatrix(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1ConfusionMatrix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1ConfusionMatrix:
        """Test GoogleCloudDatalabelingV1beta1ConfusionMatrix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1ConfusionMatrix`
        """
        model = GoogleCloudDatalabelingV1beta1ConfusionMatrix()
        if include_optional:
    ...
    def testGoogleCloudDatalabelingV1beta1ConfusionMatrix(self):
        """Test GoogleCloudDatalabelingV1beta1ConfusionMatrix"""
