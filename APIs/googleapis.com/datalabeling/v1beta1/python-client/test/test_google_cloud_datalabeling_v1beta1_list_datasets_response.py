...
class TestGoogleCloudDatalabelingV1beta1ListDatasetsResponse(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1ListDatasetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1ListDatasetsResponse:
        """Test GoogleCloudDatalabelingV1beta1ListDatasetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1ListDatasetsResponse`
        """
        model = GoogleCloudDatalabelingV1beta1ListDatasetsResponse()
        if include_optional:
            return GoogleCloudDatalabelingV1beta1ListDatasetsResponse(
                datasets = [
                    openapi_client.models.google_cloud_datalabeling_v1beta1_dataset.GoogleCloudDatalabelingV1beta1Dataset(
                        blocking_resources = [
                            ''
                            ], 
                        create_time = '', 
    ...
    def testGoogleCloudDatalabelingV1beta1ListDatasetsResponse(self):
        """Test GoogleCloudDatalabelingV1beta1ListDatasetsResponse"""
