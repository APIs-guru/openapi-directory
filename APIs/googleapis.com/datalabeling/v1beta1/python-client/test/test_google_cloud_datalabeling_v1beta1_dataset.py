...
class TestGoogleCloudDatalabelingV1beta1Dataset(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1Dataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1Dataset:
        """Test GoogleCloudDatalabelingV1beta1Dataset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1Dataset`
        """
        model = GoogleCloudDatalabelingV1beta1Dataset()
        if include_optional:
    ...
    def testGoogleCloudDatalabelingV1beta1Dataset(self):
        """Test GoogleCloudDatalabelingV1beta1Dataset"""
