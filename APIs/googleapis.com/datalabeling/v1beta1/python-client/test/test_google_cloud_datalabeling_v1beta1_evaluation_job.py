...
class TestGoogleCloudDatalabelingV1beta1EvaluationJob(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1EvaluationJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1EvaluationJob:
        """Test GoogleCloudDatalabelingV1beta1EvaluationJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1EvaluationJob`
        """
        model = GoogleCloudDatalabelingV1beta1EvaluationJob()
        if include_optional:
            return GoogleCloudDatalabelingV1beta1EvaluationJob(
                annotation_spec_set = '',
                attempts = [
                    openapi_client.models.google_cloud_datalabeling_v1beta1_attempt.GoogleCloudDatalabelingV1beta1Attempt(
                        attempt_time = '', 
                        partial_failures = [
                ...
                create_time = '',
                description = '',
                evaluation_job_config = openapi_client.models.google_cloud_datalabeling_v1beta1_evaluation_job_config.GoogleCloudDatalabelingV1beta1EvaluationJobConfig(
    ...
    def testGoogleCloudDatalabelingV1beta1EvaluationJob(self):
        """Test GoogleCloudDatalabelingV1beta1EvaluationJob"""
