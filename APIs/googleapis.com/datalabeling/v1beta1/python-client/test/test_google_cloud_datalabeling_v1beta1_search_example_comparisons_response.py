...
class TestGoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse:
        """Test GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse`
        """
        model = GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse()
        if include_optional:
            return GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse(
                example_comparisons = [
                    openapi_client.models.google_cloud_datalabeling_v1beta1_example_comparison.GoogleCloudDatalabelingV1beta1ExampleComparison(
    ...
    def testGoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse(self):
        """Test GoogleCloudDatalabelingV1beta1SearchExampleComparisonsResponse"""
