...
class TestGoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse:
        """Test GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse`
        """
        model = GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse()
        if include_optional:
            return GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse(
                evaluation_jobs = [
                    openapi_client.models.google_cloud_datalabeling_v1beta1_evaluation_job.GoogleCloudDatalabelingV1beta1EvaluationJob(
                        annotation_spec_set = '', 
                        attempts = [
    ...
    def testGoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse(self):
        """Test GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse"""
