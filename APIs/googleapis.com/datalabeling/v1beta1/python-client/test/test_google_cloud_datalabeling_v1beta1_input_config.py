...
class TestGoogleCloudDatalabelingV1beta1InputConfig(unittest.TestCase):
    """GoogleCloudDatalabelingV1beta1InputConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatalabelingV1beta1InputConfig:
        """Test GoogleCloudDatalabelingV1beta1InputConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatalabelingV1beta1InputConfig`
        """
        model = GoogleCloudDatalabelingV1beta1InputConfig()
        if include_optional:
    ...
    def testGoogleCloudDatalabelingV1beta1InputConfig(self):
        """Test GoogleCloudDatalabelingV1beta1InputConfig"""
