...
google_cloud_datalabeling_v1beta1_human_annotation_config_instance = GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.to_json())

# convert the object into a dict
google_cloud_datalabeling_v1beta1_human_annotation_config_dict = google_cloud_datalabeling_v1beta1_human_annotation_config_instance.to_dict()
# create an instance of GoogleCloudDatalabelingV1beta1HumanAnnotationConfig from a dict
google_cloud_datalabeling_v1beta1_human_annotation_config_from_dict = GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.from_dict(google_cloud_datalabeling_v1beta1_human_annotation_config_dict)
```
