...
class TestDeidentifiedStoreDestination(unittest.TestCase):
    """DeidentifiedStoreDestination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeidentifiedStoreDestination:
        """Test DeidentifiedStoreDestination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeidentifiedStoreDestination`
        """
        model = DeidentifiedStoreDestination()
        if include_optional:
    ...
    def testDeidentifiedStoreDestination(self):
        """Test DeidentifiedStoreDestination"""
