...
class TestEntityMention(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EntityMention:
        """Test EntityMention
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityMention`
        """
        model = EntityMention()
        if include_optional:
            return EntityMention(
                ...
                subject = openapi_client.models.feature.Feature(
                    confidence = 1.337, 
                    value = '', ),
                temporal_assessment = openapi_client.models.feature.Feature(
                    confidence = 1.337, 
                    value = '', ),
