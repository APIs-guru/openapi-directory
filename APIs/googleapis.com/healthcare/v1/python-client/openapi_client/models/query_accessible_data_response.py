...
class QueryAccessibleDataResponse(BaseModel):
    ...
    """ # noqa: E501
    gcs_uris: Optional[List[StrictStr]] = Field(default=None, description="List of files, each of which contains a list of data_id(s) that are consented for a specified use in the request.", alias="gcsUris")
    __properties: ClassVar[List[str]] = ["gcsUris"]
