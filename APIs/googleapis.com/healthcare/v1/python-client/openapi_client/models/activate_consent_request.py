...
class ActivateConsentRequest(BaseModel):
    ...
    ttl: Optional[StrictStr] = Field(default=None, description="The time to live for this Consent from when it is marked as active.")
    __properties: ClassVar[List[str]] = ["consentArtifact", "expireTime", "ttl"]
