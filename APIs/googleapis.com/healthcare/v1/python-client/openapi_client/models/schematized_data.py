...
class SchematizedData(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[StrictStr] = Field(default=None, description="JSON output of the parser.")
    error: Optional[StrictStr] = Field(default=None, description="The error output of the parser.")
