...
class OperationMetadata(BaseModel):
    ...
    end_time: Optional[StrictStr] = Field(default=None, description="The time at which execution was completed.", alias="endTime")
    logs_url: Optional[StrictStr] = Field(default=None, description="A link to audit and error logs in the log viewer. Error logs are generated only by some operations, listed at [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging).", alias="logsUrl")
