...
class RollbackFhirResourcesRequest(BaseModel):
    ...
    input_gcs_object: Optional[StrictStr] = Field(default=None, description="Optional. GCS object containing list of {resourceType}/{resourceId} lines, identifying resources to be reverted", alias="inputGcsObject")
