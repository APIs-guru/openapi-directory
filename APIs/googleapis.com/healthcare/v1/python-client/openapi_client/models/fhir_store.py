...
class FhirStore(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["complexDataTypeReferenceParsing", "defaultSearchHandlingStrict", "disableReferentialIntegrity", "disableResourceVersioning", "enableUpdateCreate", "labels", "name", "notificationConfig", "notificationConfigs", "streamConfigs", "validationConfig", "version"]
