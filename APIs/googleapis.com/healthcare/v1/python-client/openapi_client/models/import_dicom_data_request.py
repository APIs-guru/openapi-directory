...
class ImportDicomDataRequest(BaseModel):
    ...
    """ # noqa: E501
    gcs_source: Optional[GoogleCloudHealthcareV1DicomGcsSource] = Field(default=None, alias="gcsSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gcsSource": GoogleCloudHealthcareV1DicomGcsSource.from_dict(obj["gcsSource"]) if obj.get("gcsSource") is not None else None
        })
        return _obj
