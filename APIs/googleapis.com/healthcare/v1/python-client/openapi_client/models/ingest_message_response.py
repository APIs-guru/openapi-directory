...
class IngestMessageResponse(BaseModel):
    ...
    """ # noqa: E501
    hl7_ack: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="HL7v2 ACK message.", alias="hl7Ack")
    message: Optional[Message] = None
    __properties: ClassVar[List[str]] = ["hl7Ack", "message"]
