...
class ListConsentRevisionsResponse(BaseModel):
    ...
    """ # noqa: E501
    consents: Optional[List[Consent]] = Field(default=None, description="The returned Consent revisions. The maximum number of revisions returned is determined by the value of `page_size` in the ListConsentRevisionsRequest.")
