...
class DicomStore(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "streamConfigs": [GoogleCloudHealthcareV1DicomStreamConfig.from_dict(_item) for _item in obj["streamConfigs"]] if obj.get("streamConfigs") is not None else None
        })
        return _obj
