...
class ExportDicomDataRequest(BaseModel):
    ...
    """ # noqa: E501
    bigquery_destination: Optional[GoogleCloudHealthcareV1DicomBigQueryDestination] = Field(default=None, alias="bigqueryDestination")
    gcs_destination: Optional[GoogleCloudHealthcareV1DicomGcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigqueryDestination": GoogleCloudHealthcareV1DicomBigQueryDestination.from_dict(obj["bigqueryDestination"]) if obj.get("bigqueryDestination") is not None else None,
            "gcsDestination": GoogleCloudHealthcareV1DicomGcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None
        })
        return _obj
