...
class StructuredStorageInfo(BaseModel):
    """
    StructuredStorageInfo contains details about the data stored in Structured Storage for the referenced resource.
    """ # noqa: E501
    size_bytes: Optional[StrictStr] = Field(default=None, description="Size in bytes of data stored in structured storage.", alias="sizeBytes")
    __properties: ClassVar[List[str]] = ["sizeBytes"]
