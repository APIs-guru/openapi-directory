...
class BoundingPoly(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="A description of this polygon.")
    vertices: Optional[List[Vertex]] = Field(default=None, description="List of the vertices of this polygon.")
    __properties: ClassVar[List[str]] = ["label", "vertices"]
