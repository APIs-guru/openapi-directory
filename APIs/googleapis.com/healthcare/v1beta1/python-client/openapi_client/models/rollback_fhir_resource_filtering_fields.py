...
class RollbackFhirResourceFilteringFields(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadataFilter": obj.get("metadataFilter"),
