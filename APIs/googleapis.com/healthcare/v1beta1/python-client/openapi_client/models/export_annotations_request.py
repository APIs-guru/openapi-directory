...
class ExportAnnotationsRequest(BaseModel):
    ...
    gcs_destination: Optional[GoogleCloudHealthcareV1beta1AnnotationGcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcsDestination": GoogleCloudHealthcareV1beta1AnnotationGcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None
        })
        return _obj
