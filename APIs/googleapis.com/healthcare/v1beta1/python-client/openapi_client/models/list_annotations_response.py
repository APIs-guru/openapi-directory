...
class ListAnnotationsResponse(BaseModel):
    ...
    """ # noqa: E501
    annotations: Optional[List[Annotation]] = Field(default=None, description="The returned Annotations. Won't be more values than the value of page_size in the request. See `AnnotationView` in the request for populated fields.")
