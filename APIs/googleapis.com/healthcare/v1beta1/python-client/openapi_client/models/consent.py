...
class Consent(BaseModel):
    ...
    policies: Optional[List[GoogleCloudHealthcareV1beta1ConsentPolicy]] = Field(default=None, description="Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "policies": [GoogleCloudHealthcareV1beta1ConsentPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
