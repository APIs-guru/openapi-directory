...
class InfoTypeTransformation(BaseModel):
    ...
    info_types: Optional[List[StrictStr]] = Field(default=None, description="`InfoTypes` to apply this transformation to. If this is not specified, this transformation becomes the default transformation, and is used for any `info_type` that is not specified in another transformation.", alias="infoTypes")
