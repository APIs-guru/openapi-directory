...
class QueryAccessibleDataRequest(BaseModel):
    ...
    """ # noqa: E501
    gcs_destination: Optional[GoogleCloudHealthcareV1beta1ConsentGcsDestination] = Field(default=None, alias="gcsDestination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gcsDestination": GoogleCloudHealthcareV1beta1ConsentGcsDestination.from_dict(obj["gcsDestination"]) if obj.get("gcsDestination") is not None else None,
