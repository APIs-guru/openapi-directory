...
json = "{}"
# create an instance of GoogleCloudHealthcareV1beta1DicomGcsDestination from a JSON string
google_cloud_healthcare_v1beta1_dicom_gcs_destination_instance = GoogleCloudHealthcareV1beta1DicomGcsDestination.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudHealthcareV1beta1DicomGcsDestination.to_json())

# convert the object into a dict
google_cloud_healthcare_v1beta1_dicom_gcs_destination_dict = google_cloud_healthcare_v1beta1_dicom_gcs_destination_instance.to_dict()
# create an instance of GoogleCloudHealthcareV1beta1DicomGcsDestination from a dict
google_cloud_healthcare_v1beta1_dicom_gcs_destination_from_dict = GoogleCloudHealthcareV1beta1DicomGcsDestination.from_dict(google_cloud_healthcare_v1beta1_dicom_gcs_destination_dict)
```
