...
class OutputConfig(BaseModel):
    ...
    """ # noqa: E501
    destination: Optional[StrictStr] = Field(default=None, description="The destination for writing trace data. Supported formats include: \"bigquery.googleapis.com/projects/[PROJECT_ID]/datasets/[DATASET]\"")
