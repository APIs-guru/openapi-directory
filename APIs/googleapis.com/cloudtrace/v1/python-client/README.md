...
------------ | ------------- | ------------- | -------------
*ProjectsApi* | [**cloudtrace_projects_patch_traces**](docs/ProjectsApi.md#cloudtrace_projects_patch_traces) | **PATCH** /v1/projects/{projectId}/traces | 
*ProjectsApi* | [**cloudtrace_projects_traces_get**](docs/ProjectsApi.md#cloudtrace_projects_traces_get) | **GET** /v1/projects/{projectId}/traces/{traceId} | 
*ProjectsApi* | [**cloudtrace_projects_traces_list**](docs/ProjectsApi.md#cloudtrace_projects_traces_list) | **GET** /v1/projects/{projectId}/traces | 


## Documentation For Models

 - [ListTracesResponse](docs/ListTracesResponse.md)
 - [Trace](docs/Trace.md)
