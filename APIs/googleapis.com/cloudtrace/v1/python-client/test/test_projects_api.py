...
class TestProjectsApi(unittest.TestCase):
    ...
    def test_cloudtrace_projects_patch_traces(self) -> None:
        """Test case for cloudtrace_projects_patch_traces

        """
        pass

    def test_cloudtrace_projects_traces_get(self) -> None:
        """Test case for cloudtrace_projects_traces_get

        """
        pass

    def test_cloudtrace_projects_traces_list(self) -> None:
