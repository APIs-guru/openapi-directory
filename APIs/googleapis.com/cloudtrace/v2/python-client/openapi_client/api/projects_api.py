...
class ProjectsApi:
    ...
    def cloudtrace_projects_traces_batch_write(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the project where the spans belong. The format is `projects/[PROJECT_ID]`.")],
        ...
        batch_write_spans_request: Optional[BatchWriteSpansRequest] = None,
        ...
        :param batch_write_spans_request:
        :type batch_write_spans_request: BatchWriteSpansRequest
        ...
        _param = self._cloudtrace_projects_traces_batch_write_serialize(
            name=name,
            xgafv=xgafv,
            ...
            batch_write_spans_request=batch_write_spans_request,
    ...
    @validate_call
    def cloudtrace_projects_traces_batch_write_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the project where the spans belong. The format is `projects/[PROJECT_ID]`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudtrace_projects_traces_batch_write_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The name of the project where the spans belong. The format is `projects/[PROJECT_ID]`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudtrace_projects_traces_batch_write_serialize(
        self,
        name,
        xgafv,
        access_token,
        ...
        if batch_write_spans_request is not None:
            _body_params = batch_write_spans_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/{name}/traces:batchWrite',
    ...
    def cloudtrace_projects_traces_spans_create_span(
        ...
        _param = self._cloudtrace_projects_traces_spans_create_span_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def cloudtrace_projects_traces_spans_create_span_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the span in the following format: * `projects/[PROJECT_ID]/traces/[TRACE_ID]/spans/[SPAN_ID]` `[TRACE_ID]` is a unique identifier for a trace within a project; it is a 32-character hexadecimal encoding of a 16-byte array. It should not be zero. `[SPAN_ID]` is a unique identifier for a span within a trace; it is a 16-character hexadecimal encoding of an 8-byte array. It should not be zero. .")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudtrace_projects_traces_spans_create_span_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. The resource name of the span in the following format: * `projects/[PROJECT_ID]/traces/[TRACE_ID]/spans/[SPAN_ID]` `[TRACE_ID]` is a unique identifier for a trace within a project; it is a 32-character hexadecimal encoding of a 16-byte array. It should not be zero. `[SPAN_ID]` is a unique identifier for a span within a trace; it is a 16-character hexadecimal encoding of an 8-byte array. It should not be zero. .")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudtrace_projects_traces_spans_create_span_serialize(
        self,
        name,
        xgafv,
        access_token,
