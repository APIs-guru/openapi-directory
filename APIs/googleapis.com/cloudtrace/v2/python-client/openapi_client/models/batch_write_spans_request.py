...
class BatchWriteSpansRequest(BaseModel):
    """
    The request message for the `BatchWriteSpans` method.
    """ # noqa: E501
    spans: Optional[List[Span]] = Field(default=None, description="Required. A list of new spans. The span names must not match existing spans, otherwise the results are undefined.")
    __properties: ClassVar[List[str]] = ["spans"]
