...
class Annotation(BaseModel):
    ...
    description: Optional[TruncatableString] = None
    __properties: ClassVar[List[str]] = ["attributes", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": TruncatableString.from_dict(obj["description"]) if obj.get("description") is not None else None
        })
        return _obj
