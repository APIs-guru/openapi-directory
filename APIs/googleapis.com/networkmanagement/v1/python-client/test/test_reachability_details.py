...
class TestReachabilityDetails(unittest.TestCase):
    """ReachabilityDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReachabilityDetails:
        """Test ReachabilityDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReachabilityDetails`
        """
        model = ReachabilityDetails()
        if include_optional:
    ...
    def testReachabilityDetails(self):
        """Test ReachabilityDetails"""
