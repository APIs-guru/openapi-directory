...
class TestListConnectivityTestsResponse(unittest.TestCase):
    """ListConnectivityTestsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListConnectivityTestsResponse:
        """Test ListConnectivityTestsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListConnectivityTestsResponse`
        """
        model = ListConnectivityTestsResponse()
        if include_optional:
            return ListConnectivityTestsResponse(
                next_page_token = '',
                resources = [
                    openapi_client.models.connectivity_test.ConnectivityTest(
                        create_time = '', 
                        description = '', 
    ...
    def testListConnectivityTestsResponse(self):
        """Test ListConnectivityTestsResponse"""
