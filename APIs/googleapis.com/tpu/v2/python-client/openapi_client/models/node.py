...
class Node(BaseModel):
    ...
    accelerator_type: Optional[StrictStr] = Field(default=None, description="Optional. The type of hardware accelerators associated with this node.", alias="acceleratorType")
    ...
    __properties: ClassVar[List[str]] = ["acceleratorConfig", "acceleratorType", "apiVersion", "cidrBlock", "createTime", "dataDisks", "description", "health", "healthDescription", "id", "labels", "metadata", "multisliceNode", "name", "networkConfig", "networkEndpoints", "queuedResource", "runtimeVersion", "schedulingConfig", "serviceAccount", "shieldedInstanceConfig", "state", "symptoms", "tags"]
    ...
    def api_version_validate_enum(cls, value):
        ...
        if value not in set(['API_VERSION_UNSPECIFIED', 'V1_ALPHA1', 'V1', 'V2_ALPHA1', 'V2']):
            raise ValueError("must be one of enum values ('API_VERSION_UNSPECIFIED', 'V1_ALPHA1', 'V1', 'V2_ALPHA1', 'V2')")
        return value
