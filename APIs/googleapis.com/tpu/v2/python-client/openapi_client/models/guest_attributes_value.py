...
class GuestAttributesValue(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[GuestAttributesEntry]] = Field(default=None, description="The list of guest attributes entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [GuestAttributesEntry.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
