...
class QueuedResource(BaseModel):
    ...
    reservation_name: Optional[StrictStr] = Field(default=None, description="Optional. Name of the reservation in which the resource should be provisioned. Format: projects/{project}/locations/{zone}/reservations/{reservation}", alias="reservationName")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "guaranteed", "name", "queueingPolicy", "reservationName", "spot", "state", "tpu"]
