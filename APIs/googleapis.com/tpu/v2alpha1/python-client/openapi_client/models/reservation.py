...
class Reservation(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The reservation name with the format: projects/{projectID}/locations/{location}/reservations/{reservationID}")
    standard: Optional[Standard] = None
    __properties: ClassVar[List[str]] = ["name", "standard"]
