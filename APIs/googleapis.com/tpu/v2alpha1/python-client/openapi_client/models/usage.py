...
class Usage(BaseModel):
    ...
    Usage
    """ # noqa: E501
    total: Optional[StrictStr] = Field(default=None, description="The real-time value of usage within the reservation, with the unit specified in field capacity_units.")
