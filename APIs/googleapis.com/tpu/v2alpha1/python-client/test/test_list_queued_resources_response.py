...
class TestListQueuedResourcesResponse(unittest.TestCase):
    """ListQueuedResourcesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListQueuedResourcesResponse:
        """Test ListQueuedResourcesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListQueuedResourcesResponse`
        """
        model = ListQueuedResourcesResponse()
        if include_optional:
            return ListQueuedResourcesResponse(
                next_page_token = '',
                queued_resources = [
                    openapi_client.models.queued_resource.QueuedResource(
                        best_effort = openapi_client.models.best_effort.BestEffort(), 
                        create_time = '', 
                        ...
                        tpu = openapi_client.models.tpu.Tpu(
                            node_spec = [
                                openapi_client.models.node_spec.NodeSpec(
                                    multi_node_params = openapi_client.models.multi_node_params.MultiNodeParams(
                                        node_count = 56, 
                                        node_id_prefix = '', ), 
    ...
    def testListQueuedResourcesResponse(self):
        """Test ListQueuedResourcesResponse"""
