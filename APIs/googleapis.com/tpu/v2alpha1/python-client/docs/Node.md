...
**accelerator_type** | **str** | The type of hardware accelerators associated with this node. | [optional] 
**api_version** | **str** | Output only. The API version that created this Node. | [optional] [readonly] 
**autocheckpoint_enabled** | **bool** | Optional. Whether Autocheckpoint is enabled. | [optional] 
**boot_disk_config** | [**BootDiskConfig**](BootDiskConfig.md) |  | [optional] 
