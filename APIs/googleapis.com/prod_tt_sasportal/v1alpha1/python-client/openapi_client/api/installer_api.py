...
class InstallerApi:
    ...
    def prod_tt_sasportal_installer_generate_secret(
        ...
        _param = self._prod_tt_sasportal_installer_generate_secret_serialize(
            xgafv=xgafv,
    ...
    @validate_call
    def prod_tt_sasportal_installer_generate_secret_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def prod_tt_sasportal_installer_generate_secret_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _prod_tt_sasportal_installer_generate_secret_serialize(
        self,
        xgafv,
        access_token,
        alt,
    ...
    def prod_tt_sasportal_installer_validate(
        ...
        _param = self._prod_tt_sasportal_installer_validate_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def prod_tt_sasportal_installer_validate_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def prod_tt_sasportal_installer_validate_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _prod_tt_sasportal_installer_validate_serialize(
        self,
        xgafv,
        access_token,
        alt,
