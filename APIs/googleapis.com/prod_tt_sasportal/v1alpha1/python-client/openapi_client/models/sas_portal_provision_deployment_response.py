...
class SasPortalProvisionDeploymentResponse(BaseModel):
    ...
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Optional. Optional error message if the provisioning request is not successful.", alias="errorMessage")
