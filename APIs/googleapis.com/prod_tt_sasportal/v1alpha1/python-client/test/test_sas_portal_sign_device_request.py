...
class TestSasPortalSignDeviceRequest(unittest.TestCase):
    """SasPortalSignDeviceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SasPortalSignDeviceRequest:
        """Test SasPortalSignDeviceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SasPortalSignDeviceRequest`
        """
        model = SasPortalSignDeviceRequest()
        if include_optional:
            return SasPortalSignDeviceRequest(
                device = openapi_client.models.sas_portal_device.SasPortalDevice(
    ...
    def testSasPortalSignDeviceRequest(self):
        """Test SasPortalSignDeviceRequest"""
