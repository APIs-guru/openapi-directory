...
json = "{}"
# create an instance of SasPortalOperation from a JSON string
sas_portal_operation_instance = SasPortalOperation.from_json(json)
# print the JSON string representation of the object
print(SasPortalOperation.to_json())

# convert the object into a dict
sas_portal_operation_dict = sas_portal_operation_instance.to_dict()
# create an instance of SasPortalOperation from a dict
sas_portal_operation_from_dict = SasPortalOperation.from_dict(sas_portal_operation_dict)
```
