...
class GenerateAccessTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The OAuth 2.0 access token.", alias="accessToken")
    expire_time: Optional[StrictStr] = Field(default=None, description="Token expiration time. The expiration time is always set.", alias="expireTime")
