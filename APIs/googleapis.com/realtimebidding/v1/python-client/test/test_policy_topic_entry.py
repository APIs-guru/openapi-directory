...
class TestPolicyTopicEntry(unittest.TestCase):
    """PolicyTopicEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyTopicEntry:
        """Test PolicyTopicEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyTopicEntry`
        """
        model = PolicyTopicEntry()
        if include_optional:
