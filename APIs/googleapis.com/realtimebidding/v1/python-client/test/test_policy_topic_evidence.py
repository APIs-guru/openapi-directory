...
class TestPolicyTopicEvidence(unittest.TestCase):
    """PolicyTopicEvidence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyTopicEvidence:
        """Test PolicyTopicEvidence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyTopicEvidence`
        """
        model = PolicyTopicEvidence()
        if include_optional:
    ...
    def testPolicyTopicEvidence(self):
        """Test PolicyTopicEvidence"""
