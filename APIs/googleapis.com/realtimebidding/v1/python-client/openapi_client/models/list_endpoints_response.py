...
class ListEndpointsResponse(BaseModel):
    ...
    """ # noqa: E501
    endpoints: Optional[List[Endpoint]] = Field(default=None, description="List of bidder endpoints.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token which can be passed to a subsequent call to the `ListEndpoints` method to retrieve the next page of results in ListEndpointsRequest.pageToken.", alias="nextPageToken")
