...
class RemoveTargetedSitesRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    sites: Optional[List[StrictStr]] = Field(default=None, description="A list of site URLs to stop targeting in the pretargeting configuration. These values will be removed from the list of targeted URLs in PretargetingConfig.webTargeting.values.")
