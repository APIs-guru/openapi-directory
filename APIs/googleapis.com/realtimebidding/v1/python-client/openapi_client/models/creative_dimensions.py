...
class CreativeDimensions(BaseModel):
    ...
    """ # noqa: E501
    height: Optional[StrictStr] = Field(default=None, description="The height of the creative in pixels.")
    width: Optional[StrictStr] = Field(default=None, description="The width of the creative in pixels.")
