...
class RemoveTargetedAppsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    app_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of app IDs to stop targeting in the pretargeting configuration. These values will be removed from the list of targeted app IDs in PretargetingConfig.appTargeting.mobileAppTargeting.values.", alias="appIds")
    __properties: ClassVar[List[str]] = ["appIds"]
