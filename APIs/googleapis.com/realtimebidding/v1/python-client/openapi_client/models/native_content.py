...
class NativeContent(BaseModel):
    ...
    video_vast_xml: Optional[StrictStr] = Field(default=None, description="The contents of a VAST document for a native video ad.", alias="videoVastXml")
    __properties: ClassVar[List[str]] = ["advertiserName", "appIcon", "body", "callToAction", "clickLinkUrl", "clickTrackingUrl", "headline", "image", "logo", "priceDisplayText", "starRating", "videoUrl", "videoVastXml"]
