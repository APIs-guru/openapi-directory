...
------------ | ------------- | ------------- | -------------
**height** | **int** | The height of the HTML snippet in pixels. Can be used to filter the response of the creatives.list method. | [optional] 
**snippet** | **str** | The HTML snippet that displays the ad when inserted in the web page. | [optional] 
**width** | **int** | The width of the HTML snippet in pixels. Can be used to filter the response of the creatives.list method. | [optional] 
