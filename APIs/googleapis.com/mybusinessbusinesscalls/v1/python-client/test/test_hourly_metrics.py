...
class TestHourlyMetrics(unittest.TestCase):
    """HourlyMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HourlyMetrics:
        """Test HourlyMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HourlyMetrics`
        """
        model = HourlyMetrics()
        if include_optional:
