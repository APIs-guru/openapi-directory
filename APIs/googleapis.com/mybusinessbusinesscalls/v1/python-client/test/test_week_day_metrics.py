...
class TestWeekDayMetrics(unittest.TestCase):
    """WeekDayMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayMetrics:
        """Test WeekDayMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayMetrics`
        """
        model = WeekDayMetrics()
        if include_optional:
