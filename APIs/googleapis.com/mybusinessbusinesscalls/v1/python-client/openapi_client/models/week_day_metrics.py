...
class WeekDayMetrics(BaseModel):
    """
    Metrics for a week day.
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Day of the week. Allowed values are Sunday - Saturday.")
    ...
    __properties: ClassVar[List[str]] = ["day", "missedCallsCount"]
