...
class GoogleAudienceGroup(BaseModel):
    ...
    """ # noqa: E501
    settings: Optional[List[GoogleAudienceTargetingSetting]] = Field(default=None, description="Required. All Google audience targeting settings in Google audience group. Repeated settings with same id will be ignored.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [GoogleAudienceTargetingSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
