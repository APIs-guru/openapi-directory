...
class OnScreenPositionAssignedTargetingOptionDetails(BaseModel):
    ...
    on_screen_position: Optional[StrictStr] = Field(default=None, description="Output only. The on screen position.", alias="onScreenPosition")
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting_option_id field when targeting_type is `TARGETING_TYPE_ON_SCREEN_POSITION`.", alias="targetingOptionId")
    __properties: ClassVar[List[str]] = ["adType", "onScreenPosition", "targetingOptionId"]
    ...
    @field_validator('on_screen_position')
    def on_screen_position_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "onScreenPosition": obj.get("onScreenPosition"),
