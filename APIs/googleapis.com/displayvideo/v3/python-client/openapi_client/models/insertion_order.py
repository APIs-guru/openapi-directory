...
class InsertionOrder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["advertiserId", "bidStrategy", "budget", "campaignId", "displayName", "entityStatus", "frequencyCap", "insertionOrderId", "insertionOrderType", "integrationDetails", "kpi", "name", "pacing", "partnerCosts", "reservationType", "updateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of kpi
        if self.kpi:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kpi": Kpi.from_dict(obj["kpi"]) if obj.get("kpi") is not None else None,
            "name": obj.get("name"),
