...
class RegionalLocationListAssignedTargetingOptionDetails(BaseModel):
    ...
    regional_location_list_id: Optional[StrictStr] = Field(default=None, description="Required. ID of the regional location list. Should refer to the location_list_id field of a LocationList resource whose type is `TARGETING_LOCATION_TYPE_REGIONAL`.", alias="regionalLocationListId")
    __properties: ClassVar[List[str]] = ["negative", "regionalLocationListId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regionalLocationListId": obj.get("regionalLocationListId")
        })
        return _obj
