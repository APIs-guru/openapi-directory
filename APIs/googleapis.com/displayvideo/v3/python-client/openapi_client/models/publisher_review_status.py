...
class PublisherReviewStatus(BaseModel):
    ...
    """ # noqa: E501
    publisher_name: Optional[StrictStr] = Field(default=None, description="The publisher reviewing the creative.", alias="publisherName")
    status: Optional[StrictStr] = Field(default=None, description="Status of the publisher review.")
    __properties: ClassVar[List[str]] = ["publisherName", "status"]
