...
class Partner(BaseModel):
    ...
    billing_config: Optional[PartnerBillingConfig] = Field(default=None, alias="billingConfig")
    ...
    __properties: ClassVar[List[str]] = ["adServerConfig", "billingConfig", "dataAccessConfig", "displayName", "entityStatus", "exchangeConfig", "generalConfig", "name", "partnerId", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billingConfig": PartnerBillingConfig.from_dict(obj["billingConfig"]) if obj.get("billingConfig") is not None else None,
