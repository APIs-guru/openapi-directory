...
class ListChannelsResponse(BaseModel):
    ...
    """ # noqa: E501
    channels: Optional[List[Channel]] = Field(default=None, description="The list of channels. This list will be absent if empty.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListChannels` method to retrieve the next page of results.", alias="nextPageToken")
