...
class YoutubeAndPartnersSettings(BaseModel):
    ...
    third_party_measurement_configs: Optional[ThirdPartyMeasurementConfigs] = Field(default=None, alias="thirdPartyMeasurementConfigs")
    ...
    __properties: ClassVar[List[str]] = ["contentCategory", "effectiveContentCategory", "inventorySourceSettings", "leadFormId", "linkedMerchantId", "relatedVideoIds", "targetFrequency", "thirdPartyMeasurementConfigs", "videoAdSequenceSettings", "viewFrequencyCap"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of third_party_measurement_configs
        if self.third_party_measurement_configs:
            _dict['thirdPartyMeasurementConfigs'] = self.third_party_measurement_configs.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thirdPartyMeasurementConfigs": ThirdPartyMeasurementConfigs.from_dict(obj["thirdPartyMeasurementConfigs"]) if obj.get("thirdPartyMeasurementConfigs") is not None else None,
