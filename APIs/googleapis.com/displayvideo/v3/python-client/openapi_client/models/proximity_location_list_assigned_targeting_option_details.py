...
class ProximityLocationListAssignedTargetingOptionDetails(BaseModel):
    ...
    proximity_radius: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Required. Radius expressed in the distance units set in proximity_radius_unit. This represents the size of the area around a chosen location that will be targeted. Radius should be between 1 and 500 miles or 800 kilometers.", alias="proximityRadius")
    proximity_radius_unit: Optional[StrictStr] = Field(default=None, description="Required. Radius distance units.", alias="proximityRadiusUnit")
    __properties: ClassVar[List[str]] = ["proximityLocationListId", "proximityRadius", "proximityRadiusUnit"]
    ...
    def proximity_radius_unit_validate_enum(cls, value):
        ...
        if value not in set(['PROXIMITY_RADIUS_UNIT_UNSPECIFIED', 'PROXIMITY_RADIUS_UNIT_MILES', 'PROXIMITY_RADIUS_UNIT_KILOMETERS']):
            raise ValueError("must be one of enum values ('PROXIMITY_RADIUS_UNIT_UNSPECIFIED', 'PROXIMITY_RADIUS_UNIT_MILES', 'PROXIMITY_RADIUS_UNIT_KILOMETERS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proximityRadius": obj.get("proximityRadius"),
