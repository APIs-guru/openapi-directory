...
class CustomBiddingAlgorithm(BaseModel):
    ...
    def custom_bidding_algorithm_type_validate_enum(cls, value):
        ...
        if value not in set(['CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED', 'SCRIPT_BASED', 'ADS_DATA_HUB_BASED', 'GOAL_BUILDER_BASED', 'RULE_BASED']):
            raise ValueError("must be one of enum values ('CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED', 'SCRIPT_BASED', 'ADS_DATA_HUB_BASED', 'GOAL_BUILDER_BASED', 'RULE_BASED')")
        return value
