...
class SdfDownloadTask(BaseModel):
    ...
    """ # noqa: E501
    resource_name: Optional[StrictStr] = Field(default=None, description="A resource name to be used in media.download to Download the prepared files. Resource names have the format `download/sdfdownloadtasks/media/{media_id}`. `media_id` will be made available by the long running operation service once the task status is done.", alias="resourceName")
