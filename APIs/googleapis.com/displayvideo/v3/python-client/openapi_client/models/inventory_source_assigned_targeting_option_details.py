...
class InventorySourceAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    inventory_source_id: Optional[StrictStr] = Field(default=None, description="Required. ID of the inventory source. Should refer to the inventory_source_id field of an InventorySource resource.", alias="inventorySourceId")
    __properties: ClassVar[List[str]] = ["inventorySourceId"]
