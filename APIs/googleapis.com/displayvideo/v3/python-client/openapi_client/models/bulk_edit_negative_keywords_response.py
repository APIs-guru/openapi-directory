...
class BulkEditNegativeKeywordsResponse(BaseModel):
    ...
    """ # noqa: E501
    negative_keywords: Optional[List[NegativeKeyword]] = Field(default=None, description="The list of negative keywords that have been successfully created. This list will be absent if empty.", alias="negativeKeywords")
