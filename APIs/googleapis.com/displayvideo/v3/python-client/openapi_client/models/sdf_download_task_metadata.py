...
class SdfDownloadTaskMetadata(BaseModel):
    ...
    end_time: Optional[StrictStr] = Field(default=None, description="The time when execution was completed.", alias="endTime")
    version: Optional[StrictStr] = Field(default=None, description="The SDF version used to execute this download task.")
    __properties: ClassVar[List[str]] = ["createTime", "endTime", "version"]
