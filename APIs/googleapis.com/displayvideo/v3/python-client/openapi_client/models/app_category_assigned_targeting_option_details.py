...
class AppCategoryAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Output only. The display name of the app category.", alias="displayName")
    negative: Optional[StrictBool] = Field(default=None, description="Indicates if this option is being negatively targeted.")
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting_option_id field when targeting_type is `TARGETING_TYPE_APP_CATEGORY`.", alias="targetingOptionId")
