...
class TestLineItemAssignedTargetingOption(unittest.TestCase):
    """LineItemAssignedTargetingOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemAssignedTargetingOption:
        """Test LineItemAssignedTargetingOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemAssignedTargetingOption`
        """
        model = LineItemAssignedTargetingOption()
        if include_optional:
    ...
    def testLineItemAssignedTargetingOption(self):
        """Test LineItemAssignedTargetingOption"""
