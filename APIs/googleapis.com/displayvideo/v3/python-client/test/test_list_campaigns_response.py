...
class TestListCampaignsResponse(unittest.TestCase):
    """ListCampaignsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCampaignsResponse:
        """Test ListCampaignsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCampaignsResponse`
        """
    ...
    def testListCampaignsResponse(self):
        """Test ListCampaignsResponse"""
