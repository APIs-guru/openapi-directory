...
class TestBulkListAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListAssignedTargetingOptionsResponse:
        """Test BulkListAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListAssignedTargetingOptionsResponse`
        """
        model = BulkListAssignedTargetingOptionsResponse()
        if include_optional:
            return BulkListAssignedTargetingOptionsResponse(
                line_item_assigned_targeting_options = [
                    openapi_client.models.line_item_assigned_targeting_option.LineItemAssignedTargetingOption(
                        assigned_targeting_option = openapi_client.models.assigned_targeting_option.AssignedTargetingOption(
    ...
    def testBulkListAssignedTargetingOptionsResponse(self):
        """Test BulkListAssignedTargetingOptionsResponse"""
