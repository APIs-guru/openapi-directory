...
class TestListAdGroupAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListAdGroupAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAdGroupAssignedTargetingOptionsResponse:
        """Test ListAdGroupAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAdGroupAssignedTargetingOptionsResponse`
        """
        model = ListAdGroupAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testListAdGroupAssignedTargetingOptionsResponse(self):
        """Test ListAdGroupAssignedTargetingOptionsResponse"""
