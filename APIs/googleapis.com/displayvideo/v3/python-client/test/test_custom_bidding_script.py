...
class TestCustomBiddingScript(unittest.TestCase):
    """CustomBiddingScript unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomBiddingScript:
        """Test CustomBiddingScript
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomBiddingScript`
        """
        model = CustomBiddingScript()
        if include_optional:
    ...
    def testCustomBiddingScript(self):
        """Test CustomBiddingScript"""
