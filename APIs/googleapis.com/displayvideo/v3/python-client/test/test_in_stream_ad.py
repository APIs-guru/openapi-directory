...
class TestInStreamAd(unittest.TestCase):
    """InStreamAd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InStreamAd:
        """Test InStreamAd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InStreamAd`
        """
        model = InStreamAd()
        if include_optional:
            return InStreamAd(
