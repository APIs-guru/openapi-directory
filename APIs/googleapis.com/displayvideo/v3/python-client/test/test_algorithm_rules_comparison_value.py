...
class TestAlgorithmRulesComparisonValue(unittest.TestCase):
    """AlgorithmRulesComparisonValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmRulesComparisonValue:
        """Test AlgorithmRulesComparisonValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgorithmRulesComparisonValue`
        """
        model = AlgorithmRulesComparisonValue()
        if include_optional:
    ...
    def testAlgorithmRulesComparisonValue(self):
        """Test AlgorithmRulesComparisonValue"""
