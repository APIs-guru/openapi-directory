...
class TestListTargetingOptionsResponse(unittest.TestCase):
    """ListTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTargetingOptionsResponse:
        """Test ListTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTargetingOptionsResponse`
        """
        model = ListTargetingOptionsResponse()
        if include_optional:
    ...
    def testListTargetingOptionsResponse(self):
        """Test ListTargetingOptionsResponse"""
