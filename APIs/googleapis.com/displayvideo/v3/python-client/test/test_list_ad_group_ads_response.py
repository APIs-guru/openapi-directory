...
class TestListAdGroupAdsResponse(unittest.TestCase):
    """ListAdGroupAdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAdGroupAdsResponse:
        """Test ListAdGroupAdsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAdGroupAdsResponse`
        """
        model = ListAdGroupAdsResponse()
        if include_optional:
            return ListAdGroupAdsResponse(
                ad_group_ads = [
                    openapi_client.models.ad_group_ad.AdGroupAd(
                        ad_group_ad_id = '', 
                        ad_group_id = '', 
                        ad_urls = [
    ...
    def testListAdGroupAdsResponse(self):
        """Test ListAdGroupAdsResponse"""
