...
class TestAdGroupAssignedTargetingOption(unittest.TestCase):
    """AdGroupAssignedTargetingOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdGroupAssignedTargetingOption:
        """Test AdGroupAssignedTargetingOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdGroupAssignedTargetingOption`
        """
        model = AdGroupAssignedTargetingOption()
        if include_optional:
    ...
    def testAdGroupAssignedTargetingOption(self):
        """Test AdGroupAssignedTargetingOption"""
