...
class TestBulkUpdateLineItemsRequest(unittest.TestCase):
    """BulkUpdateLineItemsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateLineItemsRequest:
        """Test BulkUpdateLineItemsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateLineItemsRequest`
        """
        model = BulkUpdateLineItemsRequest()
        if include_optional:
            return BulkUpdateLineItemsRequest(
                line_item_ids = [
                    ''
                    ],
                target_line_item = openapi_client.models.line_item.LineItem(
                    advertiser_id = '', 
    ...
    def testBulkUpdateLineItemsRequest(self):
        """Test BulkUpdateLineItemsRequest"""
