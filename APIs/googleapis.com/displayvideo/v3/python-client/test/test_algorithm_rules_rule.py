...
class TestAlgorithmRulesRule(unittest.TestCase):
    """AlgorithmRulesRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmRulesRule:
        """Test AlgorithmRulesRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgorithmRulesRule`
        """
        model = AlgorithmRulesRule()
        if include_optional:
    ...
    def testAlgorithmRulesRule(self):
        """Test AlgorithmRulesRule"""
