...
class TestAlgorithmRules(unittest.TestCase):
    """AlgorithmRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmRules:
        """Test AlgorithmRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgorithmRules`
        """
        model = AlgorithmRules()
        if include_optional:
            return AlgorithmRules(
                impression_signal_ruleset = openapi_client.models.algorithm_rules_ruleset.AlgorithmRulesRuleset(
