...
class TestBulkEditAdvertiserAssignedTargetingOptionsRequest(unittest.TestCase):
    """BulkEditAdvertiserAssignedTargetingOptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditAdvertiserAssignedTargetingOptionsRequest:
        """Test BulkEditAdvertiserAssignedTargetingOptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditAdvertiserAssignedTargetingOptionsRequest`
        """
        model = BulkEditAdvertiserAssignedTargetingOptionsRequest()
        if include_optional:
            return BulkEditAdvertiserAssignedTargetingOptionsRequest(
                create_requests = [
                    openapi_client.models.create_assigned_targeting_options_request.CreateAssignedTargetingOptionsRequest(
                ...
                delete_requests = [
                    openapi_client.models.delete_assigned_targeting_options_request.DeleteAssignedTargetingOptionsRequest(
    ...
    def testBulkEditAdvertiserAssignedTargetingOptionsRequest(self):
        """Test BulkEditAdvertiserAssignedTargetingOptionsRequest"""
