...
class TestListInsertionOrdersResponse(unittest.TestCase):
    """ListInsertionOrdersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInsertionOrdersResponse:
        """Test ListInsertionOrdersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInsertionOrdersResponse`
        """
        model = ListInsertionOrdersResponse()
        if include_optional:
            return ListInsertionOrdersResponse(
                insertion_orders = [
                    openapi_client.models.insertion_order.InsertionOrder(
                        advertiser_id = '', 
                        ...
                        integration_details = openapi_client.models.integration_details.IntegrationDetails(
                            details = '', 
                            integration_code = '', ), 
                        kpi = openapi_client.models.kpi.Kpi(
                            kpi_amount_micros = '', 
                            kpi_percentage_micros = '', 
                            kpi_string = '', 
                            kpi_type = 'KPI_TYPE_UNSPECIFIED', ), 
                        name = '', 
    ...
    def testListInsertionOrdersResponse(self):
        """Test ListInsertionOrdersResponse"""
