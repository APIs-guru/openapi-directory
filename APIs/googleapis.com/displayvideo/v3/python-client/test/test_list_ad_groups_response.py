...
class TestListAdGroupsResponse(unittest.TestCase):
    """ListAdGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAdGroupsResponse:
        """Test ListAdGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAdGroupsResponse`
        """
        model = ListAdGroupsResponse()
        if include_optional:
            return ListAdGroupsResponse(
                ad_groups = [
                    openapi_client.models.ad_group.AdGroup(
    ...
    def testListAdGroupsResponse(self):
        """Test ListAdGroupsResponse"""
