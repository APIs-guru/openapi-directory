...
class TestListInventorySourcesResponse(unittest.TestCase):
    """ListInventorySourcesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInventorySourcesResponse:
        """Test ListInventorySourcesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInventorySourcesResponse`
        """
        model = ListInventorySourcesResponse()
        if include_optional:
            return ListInventorySourcesResponse(
                inventory_sources = [
                    openapi_client.models.inventory_source.InventorySource(
    ...
    def testListInventorySourcesResponse(self):
        """Test ListInventorySourcesResponse"""
