...
class TestBulkEditAssignedTargetingOptionsRequest(unittest.TestCase):
    """BulkEditAssignedTargetingOptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditAssignedTargetingOptionsRequest:
        """Test BulkEditAssignedTargetingOptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditAssignedTargetingOptionsRequest`
        """
        model = BulkEditAssignedTargetingOptionsRequest()
        if include_optional:
            return BulkEditAssignedTargetingOptionsRequest(
                create_requests = [
    ...
    def testBulkEditAssignedTargetingOptionsRequest(self):
        """Test BulkEditAssignedTargetingOptionsRequest"""
