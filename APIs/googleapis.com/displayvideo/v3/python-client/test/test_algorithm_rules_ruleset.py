...
class TestAlgorithmRulesRuleset(unittest.TestCase):
    """AlgorithmRulesRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmRulesRuleset:
        """Test AlgorithmRulesRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgorithmRulesRuleset`
        """
        model = AlgorithmRulesRuleset()
        if include_optional:
            return AlgorithmRulesRuleset(
                aggregation_type = 'RULE_AGGREGATION_TYPE_UNSPECIFIED',
                max_value = 1.337,
                rules = [
                    openapi_client.models.algorithm_rules_rule.AlgorithmRulesRule(
                        conditions = [
                            openapi_client.models.algorithm_rules_rule_condition.AlgorithmRulesRuleCondition(
                        ...
                        default_return_value = openapi_client.models.algorithm_rules_signal_value.AlgorithmRulesSignalValue(
                            number = 1.337, ), )
                    ]
            )
        else:
    ...
    def testAlgorithmRulesRuleset(self):
        """Test AlgorithmRulesRuleset"""
