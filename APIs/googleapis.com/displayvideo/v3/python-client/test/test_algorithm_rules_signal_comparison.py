...
class TestAlgorithmRulesSignalComparison(unittest.TestCase):
    """AlgorithmRulesSignalComparison unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgorithmRulesSignalComparison:
        """Test AlgorithmRulesSignalComparison
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgorithmRulesSignalComparison`
        """
        model = AlgorithmRulesSignalComparison()
        if include_optional:
    ...
    def testAlgorithmRulesSignalComparison(self):
        """Test AlgorithmRulesSignalComparison"""
