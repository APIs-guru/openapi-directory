...
*SdfdownloadtasksApi* | [**displayvideo_sdfdownloadtasks_operations_get**](docs/SdfdownloadtasksApi.md#displayvideo_sdfdownloadtasks_operations_get) | **GET** /v1dev/{name} | 
