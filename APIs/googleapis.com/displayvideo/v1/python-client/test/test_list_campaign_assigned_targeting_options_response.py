...
class TestListCampaignAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListCampaignAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCampaignAssignedTargetingOptionsResponse:
        """Test ListCampaignAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCampaignAssignedTargetingOptionsResponse`
        """
        model = ListCampaignAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testListCampaignAssignedTargetingOptionsResponse(self):
        """Test ListCampaignAssignedTargetingOptionsResponse"""
