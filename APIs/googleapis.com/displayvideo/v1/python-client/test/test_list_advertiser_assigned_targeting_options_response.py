...
class TestListAdvertiserAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListAdvertiserAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAdvertiserAssignedTargetingOptionsResponse:
        """Test ListAdvertiserAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAdvertiserAssignedTargetingOptionsResponse`
        """
        model = ListAdvertiserAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testListAdvertiserAssignedTargetingOptionsResponse(self):
        """Test ListAdvertiserAssignedTargetingOptionsResponse"""
