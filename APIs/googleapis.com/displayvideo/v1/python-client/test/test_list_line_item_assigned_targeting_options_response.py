...
class TestListLineItemAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListLineItemAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListLineItemAssignedTargetingOptionsResponse:
        """Test ListLineItemAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListLineItemAssignedTargetingOptionsResponse`
        """
        model = ListLineItemAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testListLineItemAssignedTargetingOptionsResponse(self):
        """Test ListLineItemAssignedTargetingOptionsResponse"""
