...
class TestBulkListCampaignAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListCampaignAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListCampaignAssignedTargetingOptionsResponse:
        """Test BulkListCampaignAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListCampaignAssignedTargetingOptionsResponse`
        """
        model = BulkListCampaignAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkListCampaignAssignedTargetingOptionsResponse(self):
        """Test BulkListCampaignAssignedTargetingOptionsResponse"""
