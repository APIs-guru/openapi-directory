...
class TestBulkListInsertionOrderAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListInsertionOrderAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListInsertionOrderAssignedTargetingOptionsResponse:
        """Test BulkListInsertionOrderAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListInsertionOrderAssignedTargetingOptionsResponse`
        """
        model = BulkListInsertionOrderAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkListInsertionOrderAssignedTargetingOptionsResponse(self):
        """Test BulkListInsertionOrderAssignedTargetingOptionsResponse"""
