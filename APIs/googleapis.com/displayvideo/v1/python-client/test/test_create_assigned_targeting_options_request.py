...
class TestCreateAssignedTargetingOptionsRequest(unittest.TestCase):
    """CreateAssignedTargetingOptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAssignedTargetingOptionsRequest:
        """Test CreateAssignedTargetingOptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAssignedTargetingOptionsRequest`
        """
        model = CreateAssignedTargetingOptionsRequest()
        if include_optional:
    ...
    def testCreateAssignedTargetingOptionsRequest(self):
        """Test CreateAssignedTargetingOptionsRequest"""
