...
class TestBulkEditLineItemAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkEditLineItemAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditLineItemAssignedTargetingOptionsResponse:
        """Test BulkEditLineItemAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditLineItemAssignedTargetingOptionsResponse`
        """
        model = BulkEditLineItemAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkEditLineItemAssignedTargetingOptionsResponse(self):
        """Test BulkEditLineItemAssignedTargetingOptionsResponse"""
