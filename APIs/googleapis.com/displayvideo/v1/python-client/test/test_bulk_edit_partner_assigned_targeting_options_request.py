...
class TestBulkEditPartnerAssignedTargetingOptionsRequest(unittest.TestCase):
    """BulkEditPartnerAssignedTargetingOptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditPartnerAssignedTargetingOptionsRequest:
        """Test BulkEditPartnerAssignedTargetingOptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditPartnerAssignedTargetingOptionsRequest`
        """
        model = BulkEditPartnerAssignedTargetingOptionsRequest()
        if include_optional:
            return BulkEditPartnerAssignedTargetingOptionsRequest(
                create_requests = [
    ...
    def testBulkEditPartnerAssignedTargetingOptionsRequest(self):
        """Test BulkEditPartnerAssignedTargetingOptionsRequest"""
