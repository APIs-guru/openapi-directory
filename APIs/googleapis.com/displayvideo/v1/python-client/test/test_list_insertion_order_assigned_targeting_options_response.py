...
class TestListInsertionOrderAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListInsertionOrderAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInsertionOrderAssignedTargetingOptionsResponse:
        """Test ListInsertionOrderAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInsertionOrderAssignedTargetingOptionsResponse`
        """
        model = ListInsertionOrderAssignedTargetingOptionsResponse()
        if include_optional:
                ...
                assigned_targeting_options = [
                    openapi_client.models.assigned_targeting_option.AssignedTargetingOption(
                        ...
                        proximity_location_list_details = openapi_client.models.proximity_location_list_assigned_targeting_option_details.ProximityLocationListAssignedTargetingOptionDetails(
                            ...
                            proximity_radius_range = 'PROXIMITY_RADIUS_RANGE_UNSPECIFIED', ), 
    ...
    def testListInsertionOrderAssignedTargetingOptionsResponse(self):
        """Test ListInsertionOrderAssignedTargetingOptionsResponse"""
