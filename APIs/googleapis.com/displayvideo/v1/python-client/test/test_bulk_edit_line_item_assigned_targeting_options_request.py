...
class TestBulkEditLineItemAssignedTargetingOptionsRequest(unittest.TestCase):
    """BulkEditLineItemAssignedTargetingOptionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditLineItemAssignedTargetingOptionsRequest:
        """Test BulkEditLineItemAssignedTargetingOptionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditLineItemAssignedTargetingOptionsRequest`
        """
        model = BulkEditLineItemAssignedTargetingOptionsRequest()
        if include_optional:
            return BulkEditLineItemAssignedTargetingOptionsRequest(
                create_requests = [
    ...
    def testBulkEditLineItemAssignedTargetingOptionsRequest(self):
        """Test BulkEditLineItemAssignedTargetingOptionsRequest"""
