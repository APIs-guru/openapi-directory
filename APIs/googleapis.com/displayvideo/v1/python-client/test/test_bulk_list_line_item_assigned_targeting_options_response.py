...
class TestBulkListLineItemAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListLineItemAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListLineItemAssignedTargetingOptionsResponse:
        """Test BulkListLineItemAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListLineItemAssignedTargetingOptionsResponse`
        """
        model = BulkListLineItemAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkListLineItemAssignedTargetingOptionsResponse(self):
        """Test BulkListLineItemAssignedTargetingOptionsResponse"""
