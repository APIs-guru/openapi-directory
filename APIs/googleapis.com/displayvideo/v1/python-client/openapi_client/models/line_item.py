...
class LineItem(BaseModel):
    ...
    inventory_source_ids: Optional[List[StrictStr]] = Field(default=None, description="The IDs of the private inventory sources assigned to the line item.", alias="inventorySourceIds")
