...
class EnvironmentAssignedTargetingOptionDetails(BaseModel):
    ...
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_ENVIRONMENT` (e.g., \"508010\" for targeting the `ENVIRONMENT_WEB_OPTIMIZED` option).", alias="targetingOptionId")
    __properties: ClassVar[List[str]] = ["environment", "targetingOptionId"]
