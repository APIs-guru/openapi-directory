...
class CustomListGroup(BaseModel):
    ...
    """ # noqa: E501
    settings: Optional[List[CustomListTargetingSetting]] = Field(default=None, description="Required. All custom list targeting settings in custom list group. Repeated settings with same id will be ignored.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [CustomListTargetingSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
