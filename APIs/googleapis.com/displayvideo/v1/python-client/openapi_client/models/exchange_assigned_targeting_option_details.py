...
class ExchangeAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_EXCHANGE`.", alias="targetingOptionId")
