...
class InventorySourceVideoCreativeConfig(BaseModel):
    ...
    """ # noqa: E501
    duration: Optional[StrictStr] = Field(default=None, description="The duration requirements for the video creatives that can be assigned to the inventory source.")
