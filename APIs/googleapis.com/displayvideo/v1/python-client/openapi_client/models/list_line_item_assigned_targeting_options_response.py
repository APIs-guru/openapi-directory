...
class ListLineItemAssignedTargetingOptionsResponse(BaseModel):
    ...
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token identifying the next page of results. This value should be specified as the pageToken in a subsequent ListLineItemAssignedTargetingOptionsRequest to fetch the next page of results. This token will be absent if there are no more assigned_targeting_options to return.", alias="nextPageToken")
