...
class InsertionOrder(BaseModel):
    ...
    def reservation_type_validate_enum(cls, value):
        ...
        if value not in set(['RESERVATION_TYPE_UNSPECIFIED', 'RESERVATION_TYPE_NOT_GUARANTEED', 'RESERVATION_TYPE_PROGRAMMATIC_GUARANTEED', 'RESERVATION_TYPE_TAG_GUARANTEED']):
            raise ValueError("must be one of enum values ('RESERVATION_TYPE_UNSPECIFIED', 'RESERVATION_TYPE_NOT_GUARANTEED', 'RESERVATION_TYPE_PROGRAMMATIC_GUARANTEED', 'RESERVATION_TYPE_TAG_GUARANTEED')")
        return value
