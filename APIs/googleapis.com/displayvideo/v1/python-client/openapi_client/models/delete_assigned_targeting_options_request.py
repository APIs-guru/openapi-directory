...
class DeleteAssignedTargetingOptionsRequest(BaseModel):
    ...
    """ # noqa: E501
    assigned_targeting_option_ids: Optional[List[StrictStr]] = Field(default=None, description="Required. The assigned targeting option IDs to delete.", alias="assignedTargetingOptionIds")
    ...
    __properties: ClassVar[List[str]] = ["assignedTargetingOptionIds", "targetingType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignedTargetingOptionIds": obj.get("assignedTargetingOptionIds"),
