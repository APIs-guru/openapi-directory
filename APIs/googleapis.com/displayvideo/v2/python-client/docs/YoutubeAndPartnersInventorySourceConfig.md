...
**include_youtube_search** | **bool** | Whether to target inventory on the YouTube search results page. | [optional] 
...
**include_youtube_videos** | **bool** | Whether to target inventory of channels and videos on YouTube and YouTube videos embedded on other sites. | [optional] 
