...
class TestAssignedTargetingOption(unittest.TestCase):
    """AssignedTargetingOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignedTargetingOption:
        """Test AssignedTargetingOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignedTargetingOption`
        """
        model = AssignedTargetingOption()
        if include_optional:
    ...
    def testAssignedTargetingOption(self):
        """Test AssignedTargetingOption"""
