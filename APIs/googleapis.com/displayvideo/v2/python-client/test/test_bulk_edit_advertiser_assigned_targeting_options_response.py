...
class TestBulkEditAdvertiserAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkEditAdvertiserAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditAdvertiserAssignedTargetingOptionsResponse:
        """Test BulkEditAdvertiserAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditAdvertiserAssignedTargetingOptionsResponse`
        """
        model = BulkEditAdvertiserAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkEditAdvertiserAssignedTargetingOptionsResponse(self):
        """Test BulkEditAdvertiserAssignedTargetingOptionsResponse"""
