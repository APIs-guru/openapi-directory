...
class TestSearchTargetingOptionsResponse(unittest.TestCase):
    """SearchTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchTargetingOptionsResponse:
        """Test SearchTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchTargetingOptionsResponse`
        """
        model = SearchTargetingOptionsResponse()
        if include_optional:
            return SearchTargetingOptionsResponse(
                next_page_token = '',
                targeting_options = [
                    openapi_client.models.targeting_option.TargetingOption(
    ...
    def testSearchTargetingOptionsResponse(self):
        """Test SearchTargetingOptionsResponse"""
