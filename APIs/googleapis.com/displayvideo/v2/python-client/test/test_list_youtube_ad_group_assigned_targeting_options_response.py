...
class TestListYoutubeAdGroupAssignedTargetingOptionsResponse(unittest.TestCase):
    """ListYoutubeAdGroupAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListYoutubeAdGroupAssignedTargetingOptionsResponse:
        """Test ListYoutubeAdGroupAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListYoutubeAdGroupAssignedTargetingOptionsResponse`
        """
        model = ListYoutubeAdGroupAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testListYoutubeAdGroupAssignedTargetingOptionsResponse(self):
        """Test ListYoutubeAdGroupAssignedTargetingOptionsResponse"""
