...
class TestBumperAd(unittest.TestCase):
    """BumperAd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BumperAd:
        """Test BumperAd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BumperAd`
        """
        model = BumperAd()
        if include_optional:
            return BumperAd(
