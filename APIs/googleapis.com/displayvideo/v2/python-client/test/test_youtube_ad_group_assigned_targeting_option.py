...
class TestYoutubeAdGroupAssignedTargetingOption(unittest.TestCase):
    """YoutubeAdGroupAssignedTargetingOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YoutubeAdGroupAssignedTargetingOption:
        """Test YoutubeAdGroupAssignedTargetingOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YoutubeAdGroupAssignedTargetingOption`
        """
        model = YoutubeAdGroupAssignedTargetingOption()
        if include_optional:
    ...
    def testYoutubeAdGroupAssignedTargetingOption(self):
        """Test YoutubeAdGroupAssignedTargetingOption"""
