...
class TestListYoutubeAdGroupAdsResponse(unittest.TestCase):
    """ListYoutubeAdGroupAdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListYoutubeAdGroupAdsResponse:
        """Test ListYoutubeAdGroupAdsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListYoutubeAdGroupAdsResponse`
        """
        model = ListYoutubeAdGroupAdsResponse()
        if include_optional:
            return ListYoutubeAdGroupAdsResponse(
                next_page_token = '',
                youtube_ad_group_ads = [
                    openapi_client.models.youtube_ad_group_ad.YoutubeAdGroupAd(
                        ad_group_ad_id = '', 
                        ad_group_id = '', 
                        ad_urls = [
    ...
    def testListYoutubeAdGroupAdsResponse(self):
        """Test ListYoutubeAdGroupAdsResponse"""
