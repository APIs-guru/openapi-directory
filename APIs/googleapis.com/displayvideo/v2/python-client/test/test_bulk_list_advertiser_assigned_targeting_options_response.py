...
class TestBulkListAdvertiserAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListAdvertiserAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListAdvertiserAssignedTargetingOptionsResponse:
        """Test BulkListAdvertiserAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListAdvertiserAssignedTargetingOptionsResponse`
        """
        model = BulkListAdvertiserAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkListAdvertiserAssignedTargetingOptionsResponse(self):
        """Test BulkListAdvertiserAssignedTargetingOptionsResponse"""
