...
class TestBulkEditPartnerAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkEditPartnerAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditPartnerAssignedTargetingOptionsResponse:
        """Test BulkEditPartnerAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditPartnerAssignedTargetingOptionsResponse`
        """
        model = BulkEditPartnerAssignedTargetingOptionsResponse()
        if include_optional:
    ...
    def testBulkEditPartnerAssignedTargetingOptionsResponse(self):
        """Test BulkEditPartnerAssignedTargetingOptionsResponse"""
