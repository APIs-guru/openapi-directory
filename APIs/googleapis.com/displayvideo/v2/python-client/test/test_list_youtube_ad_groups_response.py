...
class TestListYoutubeAdGroupsResponse(unittest.TestCase):
    """ListYoutubeAdGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListYoutubeAdGroupsResponse:
        """Test ListYoutubeAdGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListYoutubeAdGroupsResponse`
        """
        model = ListYoutubeAdGroupsResponse()
        if include_optional:
            return ListYoutubeAdGroupsResponse(
                next_page_token = '',
                youtube_ad_groups = [
                    openapi_client.models.youtube_ad_group.YoutubeAdGroup(
    ...
    def testListYoutubeAdGroupsResponse(self):
        """Test ListYoutubeAdGroupsResponse"""
