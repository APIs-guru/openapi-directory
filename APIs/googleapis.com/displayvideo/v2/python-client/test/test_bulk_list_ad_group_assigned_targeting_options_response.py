...
class TestBulkListAdGroupAssignedTargetingOptionsResponse(unittest.TestCase):
    """BulkListAdGroupAssignedTargetingOptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkListAdGroupAssignedTargetingOptionsResponse:
        """Test BulkListAdGroupAssignedTargetingOptionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkListAdGroupAssignedTargetingOptionsResponse`
        """
        model = BulkListAdGroupAssignedTargetingOptionsResponse()
        if include_optional:
            return BulkListAdGroupAssignedTargetingOptionsResponse(
                next_page_token = '',
                youtube_ad_group_assigned_targeting_options = [
                    openapi_client.models.youtube_ad_group_assigned_targeting_option.YoutubeAdGroupAssignedTargetingOption(
    ...
    def testBulkListAdGroupAssignedTargetingOptionsResponse(self):
        """Test BulkListAdGroupAssignedTargetingOptionsResponse"""
