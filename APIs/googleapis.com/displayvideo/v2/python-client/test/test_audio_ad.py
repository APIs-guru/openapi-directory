...
class TestAudioAd(unittest.TestCase):
    """AudioAd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AudioAd:
        """Test AudioAd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AudioAd`
        """
        model = AudioAd()
        if include_optional:
            return AudioAd(
