...
class TestListAdvertisersResponse(unittest.TestCase):
    """ListAdvertisersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAdvertisersResponse:
        """Test ListAdvertisersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAdvertisersResponse`
        """
        model = ListAdvertisersResponse()
        if include_optional:
    ...
    def testListAdvertisersResponse(self):
        """Test ListAdvertisersResponse"""
