...
class ListAdvertisersResponse(BaseModel):
    ...
    """ # noqa: E501
    advertisers: Optional[List[Advertiser]] = Field(default=None, description="The list of advertisers. This list will be absent if empty.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListAdvertisers` method to retrieve the next page of results.", alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["advertisers", "nextPageToken"]
