...
class SubExchangeAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_SUB_EXCHANGE`.", alias="targetingOptionId")
    __properties: ClassVar[List[str]] = ["targetingOptionId"]
