...
class UrlAssignedTargetingOptionDetails(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="Required. The URL, for example `example.com`. DV360 supports two levels of subdirectory targeting, for example `www.example.com/one-subdirectory-level/second-level`, and five levels of subdomain targeting, for example `five.four.three.two.one.example.com`.")
    __properties: ClassVar[List[str]] = ["negative", "url"]
