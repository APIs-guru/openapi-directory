...
class YoutubeAdGroup(BaseModel):
    ...
    youtube_ad_ids: Optional[List[StrictStr]] = Field(default=None, description="The IDs of the youtube_ad_group_ad resources associated with the ad group.", alias="youtubeAdIds")
    __properties: ClassVar[List[str]] = ["adGroupFormat", "adGroupId", "advertiserId", "biddingStrategy", "displayName", "entityStatus", "lineItemId", "name", "productFeedData", "targetingExpansion", "youtubeAdIds"]
    ...
    def ad_group_format_validate_enum(cls, value):
        ...
        if value not in set(['YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD']):
            raise ValueError("must be one of enum values ('YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH', 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "youtubeAdIds": obj.get("youtubeAdIds")
        })
        return _obj
