...
class Asset(BaseModel):
    ...
    A single asset.
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The asset content. For uploaded assets, the content is the serving path.")
    ...
    __properties: ClassVar[List[str]] = ["content", "mediaId"]
