...
class CustomBiddingAlgorithm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["advertiserId", "customBiddingAlgorithmId", "customBiddingAlgorithmType", "displayName", "entityStatus", "modelDetails", "name", "partnerId", "sharedAdvertiserIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modelDetails": [CustomBiddingModelDetails.from_dict(_item) for _item in obj["modelDetails"]] if obj.get("modelDetails") is not None else None,
            "name": obj.get("name"),
