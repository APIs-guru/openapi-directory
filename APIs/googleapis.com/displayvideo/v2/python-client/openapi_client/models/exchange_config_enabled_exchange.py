...
class ExchangeConfigEnabledExchange(BaseModel):
    ...
    """ # noqa: E501
    exchange: Optional[StrictStr] = Field(default=None, description="The enabled exchange.")
    google_ad_manager_agency_id: Optional[StrictStr] = Field(default=None, description="Output only. Agency ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange.", alias="googleAdManagerAgencyId")
    google_ad_manager_buyer_network_id: Optional[StrictStr] = Field(default=None, description="Output only. Network ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange.", alias="googleAdManagerBuyerNetworkId")
    seat_id: Optional[StrictStr] = Field(default=None, description="Output only. Seat ID of the enabled exchange.", alias="seatId")
    __properties: ClassVar[List[str]] = ["exchange", "googleAdManagerAgencyId", "googleAdManagerBuyerNetworkId", "seatId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "googleAdManagerAgencyId": obj.get("googleAdManagerAgencyId"),
            "googleAdManagerBuyerNetworkId": obj.get("googleAdManagerBuyerNetworkId"),
            "seatId": obj.get("seatId")
        })
        return _obj
