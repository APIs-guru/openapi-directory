...
class ContentOutstreamPositionTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    content_outstream_position: Optional[StrictStr] = Field(default=None, description="Output only. The content outstream position.", alias="contentOutstreamPosition")
    __properties: ClassVar[List[str]] = ["contentOutstreamPosition"]
