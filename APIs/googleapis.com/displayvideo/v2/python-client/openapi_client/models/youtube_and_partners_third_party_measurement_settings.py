...
class YoutubeAndPartnersThirdPartyMeasurementSettings(BaseModel):
    ...
    """ # noqa: E501
    brand_lift_vendor_configs: Optional[List[ThirdPartyVendorConfig]] = Field(default=None, description="The third-party vendors measuring brand lift. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_DYNATA` * `THIRD_PARTY_VENDOR_KANTAR`", alias="brandLiftVendorConfigs")
    brand_safety_vendor_configs: Optional[List[ThirdPartyVendorConfig]] = Field(default=None, description="The third-party vendors measuring brand safety. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_ZERF` * `THIRD_PARTY_VENDOR_DOUBLE_VERIFY` * `THIRD_PARTY_VENDOR_INTEGRAL_AD_SCIENCE`", alias="brandSafetyVendorConfigs")
    reach_vendor_configs: Optional[List[ThirdPartyVendorConfig]] = Field(default=None, description="The third-party vendors measuring reach. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_NIELSEN` * `THIRD_PARTY_VENDOR_COMSCORE` * `THIRD_PARTY_VENDOR_KANTAR`", alias="reachVendorConfigs")
