...
class SensitiveCategoryAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    excluded_sensitive_category: Optional[StrictStr] = Field(default=None, description="Required. An enum for the DV360 Sensitive category content classified to be EXCLUDED.", alias="excludedSensitiveCategory")
    __properties: ClassVar[List[str]] = ["excludedSensitiveCategory"]

    @field_validator('excluded_sensitive_category')
    def excluded_sensitive_category_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "excludedSensitiveCategory": obj.get("excludedSensitiveCategory")
        })
        return _obj
