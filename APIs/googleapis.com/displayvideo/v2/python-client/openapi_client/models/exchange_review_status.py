...
class ExchangeReviewStatus(BaseModel):
    ...
    """ # noqa: E501
    exchange: Optional[StrictStr] = Field(default=None, description="The exchange reviewing the creative.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the exchange review.")
    __properties: ClassVar[List[str]] = ["exchange", "status"]
