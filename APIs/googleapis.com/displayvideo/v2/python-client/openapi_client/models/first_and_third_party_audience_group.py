...
class FirstAndThirdPartyAudienceGroup(BaseModel):
    ...
    """ # noqa: E501
    settings: Optional[List[FirstAndThirdPartyAudienceTargetingSetting]] = Field(default=None, description="Required. All first and third party audience targeting settings in first and third party audience group. Repeated settings with same id are not allowed.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [FirstAndThirdPartyAudienceTargetingSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
