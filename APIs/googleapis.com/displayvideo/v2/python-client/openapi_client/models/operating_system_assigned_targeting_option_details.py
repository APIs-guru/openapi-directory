...
class OperatingSystemAssignedTargetingOptionDetails(BaseModel):
    ...
    targeting_option_id: Optional[StrictStr] = Field(default=None, description="Required. The targeting option ID populated in targeting_option_id field when targeting_type is `TARGETING_TYPE_OPERATING_SYSTEM`.", alias="targetingOptionId")
