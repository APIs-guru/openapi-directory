...
class AdvertiserBillingConfig(BaseModel):
    ...
    """ # noqa: E501
    billing_profile_id: Optional[StrictStr] = Field(default=None, description="Optional. The ID of a billing profile assigned to the advertiser.", alias="billingProfileId")
    __properties: ClassVar[List[str]] = ["billingProfileId"]
