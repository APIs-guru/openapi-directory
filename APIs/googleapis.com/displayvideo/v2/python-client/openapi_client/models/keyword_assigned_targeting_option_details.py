...
class KeywordAssignedTargetingOptionDetails(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="Required. The keyword, for example `car insurance`. Positive keyword cannot be offensive word. Must be UTF-8 encoded with a maximum size of 255 bytes. Maximum number of characters is 80. Maximum number of words is 10.")
    negative: Optional[StrictBool] = Field(default=None, description="Indicates if this option is being negatively targeted.")
    __properties: ClassVar[List[str]] = ["keyword", "negative"]
