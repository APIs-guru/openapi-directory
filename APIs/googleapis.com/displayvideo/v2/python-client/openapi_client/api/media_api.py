...
class MediaApi:
    ...
    def displayvideo_media_download(
        ...
        _param = self._displayvideo_media_download_serialize(
    ...
    @validate_call
    def displayvideo_media_download_with_http_info(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GoogleBytestreamMedia]:
        """displayvideo_media_download
    ...
    @validate_call
    def displayvideo_media_download_without_preload_content(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _displayvideo_media_download_serialize(
        self,
        resource_name,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/download/{resourceName}',
    ...
    def displayvideo_media_upload(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        google_bytestream_media: Optional[GoogleBytestreamMedia] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_type: Legacy upload protocol for media (e.g. \"media\", \"multipart\").
        :type upload_type: str
        :param google_bytestream_media:
        :type google_bytestream_media: GoogleBytestreamMedia
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._displayvideo_media_upload_serialize(
            resource_name=resource_name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            ...
            upload_protocol=upload_protocol,
            upload_type=upload_type,
            google_bytestream_media=google_bytestream_media,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def displayvideo_media_upload_with_http_info(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def displayvideo_media_upload_without_preload_content(
        self,
        resource_name: Annotated[StrictStr, Field(description="Name of the media that is being downloaded. See ReadRequest.resource_name.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _displayvideo_media_upload_serialize(
        self,
        resource_name,
        xgafv,
        access_token,
        ...
        # process the form parameters
        # process the body parameter
        if google_bytestream_media is not None:
            _body_params = google_bytestream_media
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/media/{resourceName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
