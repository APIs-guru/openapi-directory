...
class Error(BaseModel):
    ...
    """ # noqa: E501
    context: Optional[StrictStr] = Field(default=None, description="Human-readable stack trace string.")
    payload: Optional[StrictStr] = Field(default=None, description="Error message and data returned represented as a JSON string.")
    stack_trace: Optional[StackTrace] = Field(default=None, alias="stackTrace")
    __properties: ClassVar[List[str]] = ["context", "payload", "stackTrace"]
