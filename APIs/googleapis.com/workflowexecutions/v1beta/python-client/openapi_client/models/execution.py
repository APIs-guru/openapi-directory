...
class Execution(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["argument", "callLogLevel", "endTime", "error", "name", "result", "startTime", "state", "status", "workflowRevisionId"]
    ...
    def call_log_level_validate_enum(cls, value):
        ...
        if value not in set(['CALL_LOG_LEVEL_UNSPECIFIED', 'LOG_ALL_CALLS', 'LOG_ERRORS_ONLY']):
            raise ValueError("must be one of enum values ('CALL_LOG_LEVEL_UNSPECIFIED', 'LOG_ALL_CALLS', 'LOG_ERRORS_ONLY')")
        return value
