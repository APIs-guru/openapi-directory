...
class ListCallbacksResponse(BaseModel):
    ...
    """ # noqa: E501
    callbacks: Optional[List[Callback]] = Field(default=None, description="The callbacks which match the request.")
    ...
    __properties: ClassVar[List[str]] = ["callbacks", "nextPageToken"]
