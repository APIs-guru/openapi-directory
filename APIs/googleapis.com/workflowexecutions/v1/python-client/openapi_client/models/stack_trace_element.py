...
class StackTraceElement(BaseModel):
    ...
    routine: Optional[StrictStr] = Field(default=None, description="The routine where the error occurred.")
    step: Optional[StrictStr] = Field(default=None, description="The step the error occurred at.")
    __properties: ClassVar[List[str]] = ["position", "routine", "step"]
