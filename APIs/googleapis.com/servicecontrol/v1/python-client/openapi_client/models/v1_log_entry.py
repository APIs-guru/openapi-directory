...
class V1LogEntry(BaseModel):
    ...
    """ # noqa: E501
    http_request: Optional[V1HttpRequest] = Field(default=None, alias="httpRequest")
    ...
    monitored_resource_labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="A set of user-defined (key, value) data that provides additional information about the moniotored resource that the log entry belongs to.", alias="monitoredResourceLabels")
    ...
    operation: Optional[V1LogEntryOperation] = None
    ...
    source_location: Optional[V1LogEntrySourceLocation] = Field(default=None, alias="sourceLocation")
    ...
    __properties: ClassVar[List[str]] = ["httpRequest", "insertId", "labels", "monitoredResourceLabels", "name", "operation", "protoPayload", "severity", "sourceLocation", "structPayload", "textPayload", "timestamp", "trace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "httpRequest": V1HttpRequest.from_dict(obj["httpRequest"]) if obj.get("httpRequest") is not None else None,
            "insertId": obj.get("insertId"),
            "labels": obj.get("labels"),
            "monitoredResourceLabels": obj.get("monitoredResourceLabels"),
            "name": obj.get("name"),
            "operation": V1LogEntryOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "protoPayload": obj.get("protoPayload"),
            "severity": obj.get("severity"),
            "sourceLocation": V1LogEntrySourceLocation.from_dict(obj["sourceLocation"]) if obj.get("sourceLocation") is not None else None,
