...
class QuotaProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quotaMode"]
    ...
    def quota_mode_validate_enum(cls, value):
        ...
        if value not in set(['ACQUIRE', 'ACQUIRE_BEST_EFFORT', 'CHECK']):
            raise ValueError("must be one of enum values ('ACQUIRE', 'ACQUIRE_BEST_EFFORT', 'CHECK')")
        return value
