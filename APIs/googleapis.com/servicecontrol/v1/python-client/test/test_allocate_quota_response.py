...
class TestAllocateQuotaResponse(unittest.TestCase):
    """AllocateQuotaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllocateQuotaResponse:
        """Test AllocateQuotaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllocateQuotaResponse`
        """
        model = AllocateQuotaResponse()
        if include_optional:
            return AllocateQuotaResponse(
                allocate_errors = [
                    openapi_client.models.quota_error.QuotaError(
                        code = 'UNSPECIFIED', 
                        description = '', 
                ...
                allocate_info = openapi_client.models.allocate_info.AllocateInfo(
                    unused_arguments = [
                        ''
                        ], ),
                operation_id = '',
    ...
    def testAllocateQuotaResponse(self):
        """Test AllocateQuotaResponse"""
