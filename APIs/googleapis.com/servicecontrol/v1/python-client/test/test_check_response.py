    ...
    def make_instance(self, include_optional) -> CheckResponse:
        ...
        if include_optional:
            return CheckResponse(
                check_errors = [
                    openapi_client.models.check_error.CheckError(
                ...
                check_info = openapi_client.models.check_info.CheckInfo(
                    api_key_uid = '', 
                    consumer_info = openapi_client.models.consumer_info.ConsumerInfo(
                        consumer_number = '', 
                        project_number = '', 
