...
class V2LogEntry(BaseModel):
    ...
    """ # noqa: E501
    http_request: Optional[V2HttpRequest] = Field(default=None, alias="httpRequest")
    ...
    operation: Optional[V2LogEntryOperation] = None
    ...
    source_location: Optional[V2LogEntrySourceLocation] = Field(default=None, alias="sourceLocation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "httpRequest": V2HttpRequest.from_dict(obj["httpRequest"]) if obj.get("httpRequest") is not None else None,
            "insertId": obj.get("insertId"),
            "labels": obj.get("labels"),
            "monitoredResourceLabels": obj.get("monitoredResourceLabels"),
            "name": obj.get("name"),
            "operation": V2LogEntryOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "protoPayload": obj.get("protoPayload"),
            "severity": obj.get("severity"),
            "sourceLocation": V2LogEntrySourceLocation.from_dict(obj["sourceLocation"]) if obj.get("sourceLocation") is not None else None,
