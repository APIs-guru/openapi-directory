...
class V2HttpRequest(BaseModel):
    ...
    referer: Optional[StrictStr] = Field(default=None, description="The referer URL of the request, as defined in [HTTP/1.1 Header Field Definitions](http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html).")
    remote_ip: Optional[StrictStr] = Field(default=None, description="The IP address (IPv4 or IPv6) of the client that issued the HTTP request. Examples: `\"192.168.1.1\"`, `\"FE80::0202:B3FF:FE1E:8329\"`.", alias="remoteIp")
    ...
    server_ip: Optional[StrictStr] = Field(default=None, description="The IP address (IPv4 or IPv6) of the origin server that the request was sent to.", alias="serverIp")
    status: Optional[StrictInt] = Field(default=None, description="The response code indicating the status of the response. Examples: 200, 404.")
