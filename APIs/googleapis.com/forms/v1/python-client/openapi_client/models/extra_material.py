...
class ExtraMaterial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["link", "video"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": TextLink.from_dict(obj["link"]) if obj.get("link") is not None else None,
            "video": VideoLink.from_dict(obj["video"]) if obj.get("video") is not None else None
        })
        return _obj
