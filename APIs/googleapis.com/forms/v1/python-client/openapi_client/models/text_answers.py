...
class TextAnswers(BaseModel):
    ...
    """ # noqa: E501
    answers: Optional[List[TextAnswer]] = Field(default=None, description="Output only. Answers to a question. For multiple-value ChoiceQuestions, each answer is a separate value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [TextAnswer.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
