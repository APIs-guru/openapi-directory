...
class CorrectAnswers(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [CorrectAnswer.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
