...
class BatchUpdateFormResponse(BaseModel):
    ...
    replies: Optional[List[Response]] = Field(default=None, description="The reply of the updates. This maps 1:1 with the update requests, although replies to some requests may be empty.")
    write_control: Optional[WriteControl] = Field(default=None, alias="writeControl")
    __properties: ClassVar[List[str]] = ["form", "replies", "writeControl"]
