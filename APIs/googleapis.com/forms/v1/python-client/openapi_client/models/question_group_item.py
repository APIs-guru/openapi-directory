...
class QuestionGroupItem(BaseModel):
    ...
    questions: Optional[List[Question]] = Field(default=None, description="Required. A list of questions that belong in this question group. A question must only belong to one group. The `kind` of the group may affect what types of questions are allowed.")
    __properties: ClassVar[List[str]] = ["grid", "image", "questions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grid": Grid.from_dict(obj["grid"]) if obj.get("grid") is not None else None,
