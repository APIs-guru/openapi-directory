...
class FileUploadAnswers(BaseModel):
    ...
    """ # noqa: E501
    answers: Optional[List[FileUploadAnswer]] = Field(default=None, description="Output only. All submitted files for a FileUpload question.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [FileUploadAnswer.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
