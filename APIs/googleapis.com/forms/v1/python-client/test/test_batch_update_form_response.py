...
class TestBatchUpdateFormResponse(unittest.TestCase):
    """BatchUpdateFormResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateFormResponse:
        """Test BatchUpdateFormResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateFormResponse`
        """
        model = BatchUpdateFormResponse()
        if include_optional:
            return BatchUpdateFormResponse(
                ...
                replies = [
                    openapi_client.models.response.Response(
                        create_item = openapi_client.models.create_item_response.CreateItemResponse(
                            item_id = '', 
                            question_id = [
                                ''
                                ], ), )
    ...
    def testBatchUpdateFormResponse(self):
        """Test BatchUpdateFormResponse"""
