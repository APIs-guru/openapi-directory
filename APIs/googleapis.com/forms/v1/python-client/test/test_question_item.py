...
class TestQuestionItem(unittest.TestCase):
    """QuestionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuestionItem:
        """Test QuestionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuestionItem`
        """
        model = QuestionItem()
        if include_optional:
            return QuestionItem(
