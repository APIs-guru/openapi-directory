...
class TestRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Request:
        ...
        if include_optional:
            return Request(
                create_item = openapi_client.models.create_item_request.CreateItemRequest(
                    ...
                    location = openapi_client.models.location.Location(
                        index = 56, ), ),
                delete_item = openapi_client.models.delete_item_request.DeleteItemRequest(
                    location = openapi_client.models.location.Location(
                        index = 56, ), ),
                move_item = openapi_client.models.move_item_request.MoveItemRequest(
                    new_location = openapi_client.models.location.Location(
                        index = 56, ), 
                    original_location = openapi_client.models.location.Location(
                        index = 56, ), ),
                update_form_info = openapi_client.models.update_form_info_request.UpdateFormInfoRequest(
                    info = openapi_client.models.info.Info(
                        description = '', 
                        document_title = '', 
                        title = '', ), 
                    update_mask = '', ),
                update_item = openapi_client.models.update_item_request.UpdateItemRequest(
                    item = openapi_client.models.item.Item(
                        description = '', 
                        image_item = openapi_client.models.image_item.ImageItem(
                            image = openapi_client.models.image.Image(
                    ...
                    location = openapi_client.models.location.Location(
                        index = 56, ), 
                    update_mask = '', ),
                update_settings = openapi_client.models.update_settings_request.UpdateSettingsRequest(
