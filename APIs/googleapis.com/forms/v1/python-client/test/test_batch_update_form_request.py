...
class TestBatchUpdateFormRequest(unittest.TestCase):
    """BatchUpdateFormRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateFormRequest:
        """Test BatchUpdateFormRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateFormRequest`
        """
        model = BatchUpdateFormRequest()
        if include_optional:
            return BatchUpdateFormRequest(
    ...
    def testBatchUpdateFormRequest(self):
        """Test BatchUpdateFormRequest"""
