...
class GoogleFirestoreAdminV1WeeklyRecurrence(BaseModel):
    """
    Represents a recurring schedule that runs on a specified day of the week. The time zone is UTC.
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="The day of week to run. DAY_OF_WEEK_UNSPECIFIED is not allowed.")
    __properties: ClassVar[List[str]] = ["day"]
