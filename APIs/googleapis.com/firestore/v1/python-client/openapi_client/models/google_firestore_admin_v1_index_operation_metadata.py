...
class GoogleFirestoreAdminV1IndexOperationMetadata(BaseModel):
    """
    ...
    index: Optional[StrictStr] = Field(default=None, description="The index resource that this operation is acting on. For example: `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}/indexes/{index_id}`")
    ...
    __properties: ClassVar[List[str]] = ["endTime", "index", "progressBytes", "progressDocuments", "startTime", "state"]
