...
json = "{}"
# create an instance of GoogleFirestoreAdminV1beta2IndexConfig from a JSON string
google_firestore_admin_v1beta2_index_config_instance = GoogleFirestoreAdminV1beta2IndexConfig.from_json(json)
# print the JSON string representation of the object
print(GoogleFirestoreAdminV1beta2IndexConfig.to_json())

# convert the object into a dict
google_firestore_admin_v1beta2_index_config_dict = google_firestore_admin_v1beta2_index_config_instance.to_dict()
# create an instance of GoogleFirestoreAdminV1beta2IndexConfig from a dict
google_firestore_admin_v1beta2_index_config_from_dict = GoogleFirestoreAdminV1beta2IndexConfig.from_dict(google_firestore_admin_v1beta2_index_config_dict)
```
