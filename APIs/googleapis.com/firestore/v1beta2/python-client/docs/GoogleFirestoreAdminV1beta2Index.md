...
google_firestore_admin_v1beta2_index_instance = GoogleFirestoreAdminV1beta2Index.from_json(json)
# print the JSON string representation of the object
print(GoogleFirestoreAdminV1beta2Index.to_json())

# convert the object into a dict
google_firestore_admin_v1beta2_index_dict = google_firestore_admin_v1beta2_index_instance.to_dict()
# create an instance of GoogleFirestoreAdminV1beta2Index from a dict
google_firestore_admin_v1beta2_index_from_dict = GoogleFirestoreAdminV1beta2Index.from_dict(google_firestore_admin_v1beta2_index_dict)
```
