...
class TestDocumentTransform(unittest.TestCase):
    """DocumentTransform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTransform:
        """Test DocumentTransform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTransform`
        """
        model = DocumentTransform()
        if include_optional:
    ...
    def testDocumentTransform(self):
        """Test DocumentTransform"""
