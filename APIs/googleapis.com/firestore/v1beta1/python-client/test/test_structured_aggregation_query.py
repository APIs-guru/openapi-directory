...
class TestStructuredAggregationQuery(unittest.TestCase):
    """StructuredAggregationQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructuredAggregationQuery:
        """Test StructuredAggregationQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructuredAggregationQuery`
        """
        model = StructuredAggregationQuery()
        if include_optional:
    ...
    def testStructuredAggregationQuery(self):
        """Test StructuredAggregationQuery"""
