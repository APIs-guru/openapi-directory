...
class Order(BaseModel):
    ...
    An order on a field.
    """ # noqa: E501
    direction: Optional[StrictStr] = Field(default=None, description="The direction to order by. Defaults to `ASCENDING`.")
    ...
    def direction_validate_enum(cls, value):
        ...
        if value not in set(['DIRECTION_UNSPECIFIED', 'ASCENDING', 'DESCENDING']):
            raise ValueError("must be one of enum values ('DIRECTION_UNSPECIFIED', 'ASCENDING', 'DESCENDING')")
        return value
