...
class ReadWrite(BaseModel):
    ...
    """ # noqa: E501
    retry_transaction: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="An optional transaction to retry.", alias="retryTransaction")
    __properties: ClassVar[List[str]] = ["retryTransaction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retryTransaction": obj.get("retryTransaction")
        })
        return _obj
