...
class StructuredAggregationQuery(BaseModel):
    """
    Firestore query for running an aggregation over a StructuredQuery.
    """ # noqa: E501
    aggregations: Optional[List[Aggregation]] = Field(default=None, description="Optional. Series of aggregations to apply over the results of the `structured_query`. Requires: * A minimum of one and maximum of five aggregations per query.")
    structured_query: Optional[StructuredQuery] = Field(default=None, alias="structuredQuery")
    __properties: ClassVar[List[str]] = ["aggregations", "structuredQuery"]
