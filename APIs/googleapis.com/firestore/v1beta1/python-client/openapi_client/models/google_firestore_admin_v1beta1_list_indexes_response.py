...
class GoogleFirestoreAdminV1beta1ListIndexesResponse(BaseModel):
    """
    The response for FirestoreAdmin.ListIndexes.
    """ # noqa: E501
    indexes: Optional[List[GoogleFirestoreAdminV1beta1Index]] = Field(default=None, description="The indexes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "indexes": [GoogleFirestoreAdminV1beta1Index.from_dict(_item) for _item in obj["indexes"]] if obj.get("indexes") is not None else None,
