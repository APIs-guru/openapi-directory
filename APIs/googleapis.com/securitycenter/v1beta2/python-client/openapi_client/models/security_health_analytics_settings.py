...
class SecurityHealthAnalyticsSettings(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the SecurityHealthAnalyticsSettings. Formats: * organizations/{organization}/securityHealthAnalyticsSettings * folders/{folder}/securityHealthAnalyticsSettings * projects/{project}/securityHealthAnalyticsSettings")
    service_account: Optional[StrictStr] = Field(default=None, description="Output only. The service account used by Security Health Analytics detectors.", alias="serviceAccount")
