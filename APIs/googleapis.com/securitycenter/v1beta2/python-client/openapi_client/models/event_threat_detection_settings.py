...
class EventThreatDetectionSettings(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the EventThreatDetectionSettings. Formats: * organizations/{organization}/eventThreatDetectionSettings * folders/{folder}/eventThreatDetectionSettings * projects/{project}/eventThreatDetectionSettings")
    ...
    __properties: ClassVar[List[str]] = ["modules", "name", "serviceEnablementState", "updateTime"]
