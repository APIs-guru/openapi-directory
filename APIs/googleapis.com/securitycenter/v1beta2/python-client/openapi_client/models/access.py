...
class Access(BaseModel):
    ...
    caller_ip_geo: Optional[Geolocation] = Field(default=None, alias="callerIpGeo")
    ...
    service_account_delegation_info: Optional[List[ServiceAccountDelegationInfo]] = Field(default=None, description="The identity delegation history of an authenticated service account that made the request. The `serviceAccountDelegationInfo[]` object contains information about the real authorities that try to access Google Cloud resources by delegating on a service account. When multiple authorities are present, they are guaranteed to be sorted based on the original ordering of the identity delegation events.", alias="serviceAccountDelegationInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callerIpGeo": Geolocation.from_dict(obj["callerIpGeo"]) if obj.get("callerIpGeo") is not None else None,
