...
class GoogleCloudSecuritycenterV2Cvssv3(BaseModel):
    """
    ...
    attack_vector: Optional[StrictStr] = Field(default=None, description="Base Metrics Represents the intrinsic characteristics of a vulnerability that are constant over time and across user environments. This metric reflects the context by which vulnerability exploitation is possible.", alias="attackVector")
    ...
    __properties: ClassVar[List[str]] = ["attackComplexity", "attackVector", "availabilityImpact", "baseScore", "confidentialityImpact", "integrityImpact", "privilegesRequired", "scope", "userInteraction"]
