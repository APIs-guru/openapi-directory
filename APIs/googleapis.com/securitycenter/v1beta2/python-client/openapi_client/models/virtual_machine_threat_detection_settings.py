...
class VirtualMachineThreatDetectionSettings(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the VirtualMachineThreatDetectionSettings. Formats: * organizations/{organization}/virtualMachineThreatDetectionSettings * folders/{folder}/virtualMachineThreatDetectionSettings * projects/{project}/virtualMachineThreatDetectionSettings")
    service_account: Optional[StrictStr] = Field(default=None, description="Output only. The service account used by Virtual Machine Threat Detection detectors.", alias="serviceAccount")
