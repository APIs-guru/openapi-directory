...
class WebSecurityScannerSettings(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the WebSecurityScannerSettings. Formats: * organizations/{organization}/webSecurityScannerSettings * folders/{folder}/webSecurityScannerSettings * projects/{project}/webSecurityScannerSettings")
