...
------------ | ------------- | ------------- | -------------
**end_time** | **str** | The time the subscription has or will end. | [optional] 
**start_time** | **str** | The time the subscription has or will start. | [optional] 
**type** | **str** | The type of subscription | [optional] 
