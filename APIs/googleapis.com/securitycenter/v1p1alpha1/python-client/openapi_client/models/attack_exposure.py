...
class AttackExposure(BaseModel):
    ...
    state: Optional[StrictStr] = Field(default=None, description="What state this AttackExposure is in. This captures whether or not an attack exposure has been calculated or not.")
