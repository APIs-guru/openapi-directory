...
class SecurityPosture(BaseModel):
    ...
    policy_drift_details: Optional[List[PolicyDriftDetails]] = Field(default=None, description="The details about a change in an updated policy that violates the deployed posture.", alias="policyDriftDetails")
    policy_set: Optional[StrictStr] = Field(default=None, description="The name of the updated policyset, for example, `cis-policyset`.", alias="policySet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyDriftDetails": [PolicyDriftDetails.from_dict(_item) for _item in obj["policyDriftDetails"]] if obj.get("policyDriftDetails") is not None else None,
