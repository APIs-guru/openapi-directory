...
class Exfiltration(BaseModel):
    ...
    """ # noqa: E501
    sources: Optional[List[ExfilResource]] = Field(default=None, description="If there are multiple sources, then the data is considered \"joined\" between them. For instance, BigQuery can join multiple tables, and each table would be considered a source.")
    targets: Optional[List[ExfilResource]] = Field(default=None, description="If there are multiple targets, each target would get a complete copy of the \"joined\" source data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sources": [ExfilResource.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None,
            "targets": [ExfilResource.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None,
