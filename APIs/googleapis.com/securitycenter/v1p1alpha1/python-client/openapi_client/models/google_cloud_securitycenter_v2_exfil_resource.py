...
class GoogleCloudSecuritycenterV2ExfilResource(BaseModel):
    """
    Resource where data was exfiltrated from or exfiltrated to.
    """ # noqa: E501
    components: Optional[List[StrictStr]] = Field(default=None, description="Subcomponents of the asset that was exfiltrated, like URIs used during exfiltration, table names, databases, and filenames. For example, multiple tables might have been exfiltrated from the same Cloud SQL instance, or multiple files might have been exfiltrated from the same Cloud Storage bucket.")
    name: Optional[StrictStr] = Field(default=None, description="The resource's [full resource name](https://cloud.google.com/apis/design/resource_names#full_resource_name).")
    __properties: ClassVar[List[str]] = ["components", "name"]
