...
class GoogleCloudSecuritycenterV2LoadBalancer(BaseModel):
    """
    Contains information related to the load balancer associated with the finding.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the load balancer associated with the finding.")
