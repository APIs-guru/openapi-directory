...
class OrganizationsApi:
    ...
    def _securitycenter_organizations_operations_cancel_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1p1alpha1/{name}:cancel',
    ...
    def securitycenter_organizations_operations_list(
        ...
        _param = self._securitycenter_organizations_operations_list_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def securitycenter_organizations_operations_list_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def securitycenter_organizations_operations_list_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _securitycenter_organizations_operations_list_serialize(
        self,
        name,
        xgafv,
        access_token,
