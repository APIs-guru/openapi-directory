...
class GoogleCloudSecuritycenterV2ResourceValueConfig(BaseModel):
    """
    ...
    resource_value: Optional[StrictStr] = Field(default=None, description="Resource value level this expression represents Only required when there is no SDP mapping in the request", alias="resourceValue")
    ...
    sensitive_data_protection_mapping: Optional[GoogleCloudSecuritycenterV2SensitiveDataProtectionMapping] = Field(default=None, alias="sensitiveDataProtectionMapping")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope": obj.get("scope"),
            "sensitiveDataProtectionMapping": GoogleCloudSecuritycenterV2SensitiveDataProtectionMapping.from_dict(obj["sensitiveDataProtectionMapping"]) if obj.get("sensitiveDataProtectionMapping") is not None else None,
