...
class GoogleCloudSecuritycenterV1ResourceSelector(BaseModel):
    ...
    """ # noqa: E501
    resource_types: Optional[List[StrictStr]] = Field(default=None, description="The resource types to run the detector on.", alias="resourceTypes")
    __properties: ClassVar[List[str]] = ["resourceTypes"]
