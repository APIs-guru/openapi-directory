...
class SimulateSecurityHealthAnalyticsCustomModuleRequest(BaseModel):
    """
    ...
    resource: Optional[SimulatedResource] = None
    __properties: ClassVar[List[str]] = ["customConfig", "resource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource": SimulatedResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
