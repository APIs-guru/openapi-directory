...
class GoogleCloudSecuritycenterV2Process(BaseModel):
    """
    ...
    binary: Optional[GoogleCloudSecuritycenterV2File] = None
    env_variables: Optional[List[GoogleCloudSecuritycenterV2EnvironmentVariable]] = Field(default=None, description="Process environment variables.", alias="envVariables")
    ...
    libraries: Optional[List[GoogleCloudSecuritycenterV2File]] = Field(default=None, description="File information for libraries loaded by the process.")
    ...
    script: Optional[GoogleCloudSecuritycenterV2File] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "binary": GoogleCloudSecuritycenterV2File.from_dict(obj["binary"]) if obj.get("binary") is not None else None,
            "envVariables": [GoogleCloudSecuritycenterV2EnvironmentVariable.from_dict(_item) for _item in obj["envVariables"]] if obj.get("envVariables") is not None else None,
            "envVariablesTruncated": obj.get("envVariablesTruncated"),
            "libraries": [GoogleCloudSecuritycenterV2File.from_dict(_item) for _item in obj["libraries"]] if obj.get("libraries") is not None else None,
            "name": obj.get("name"),
            "parentPid": obj.get("parentPid"),
            "pid": obj.get("pid"),
            "script": GoogleCloudSecuritycenterV2File.from_dict(obj["script"]) if obj.get("script") is not None else None
        })
        return _obj
