...
class GoogleCloudSecuritycenterV2File(BaseModel):
    """
    ...
    disk_path: Optional[GoogleCloudSecuritycenterV2DiskPath] = Field(default=None, alias="diskPath")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diskPath": GoogleCloudSecuritycenterV2DiskPath.from_dict(obj["diskPath"]) if obj.get("diskPath") is not None else None,
