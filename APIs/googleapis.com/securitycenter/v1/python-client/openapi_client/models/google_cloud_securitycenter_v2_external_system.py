...
class GoogleCloudSecuritycenterV2ExternalSystem(BaseModel):
    """
    ...
    ticket_info: Optional[GoogleCloudSecuritycenterV2TicketInfo] = Field(default=None, alias="ticketInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ticketInfo": GoogleCloudSecuritycenterV2TicketInfo.from_dict(obj["ticketInfo"]) if obj.get("ticketInfo") is not None else None
        })
        return _obj
