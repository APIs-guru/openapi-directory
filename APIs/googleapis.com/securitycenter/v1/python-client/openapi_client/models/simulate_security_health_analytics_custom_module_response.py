...
class SimulateSecurityHealthAnalyticsCustomModuleResponse(BaseModel):
    """
    Response message for simulating a `SecurityHealthAnalyticsCustomModule` against a given resource.
    """ # noqa: E501
    result: Optional[SimulatedResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": SimulatedResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
