...
class ValidateEventThreatDetectionCustomModuleResponse(BaseModel):
    """
    Response to validating an Event Threat Detection custom module.
    """ # noqa: E501
    errors: Optional[CustomModuleValidationErrors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": CustomModuleValidationErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None
        })
        return _obj
