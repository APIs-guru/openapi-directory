...
class GoogleCloudSecuritycenterV2Cve(BaseModel):
    """
    ...
    """ # noqa: E501
    cvssv3: Optional[GoogleCloudSecuritycenterV2Cvssv3] = None
    ...
    references: Optional[List[GoogleCloudSecuritycenterV2Reference]] = Field(default=None, description="Additional information about the CVE. e.g. https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-34527")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cvssv3": GoogleCloudSecuritycenterV2Cvssv3.from_dict(obj["cvssv3"]) if obj.get("cvssv3") is not None else None,
            "exploitationActivity": obj.get("exploitationActivity"),
            "id": obj.get("id"),
            "impact": obj.get("impact"),
            "observedInTheWild": obj.get("observedInTheWild"),
            "references": [GoogleCloudSecuritycenterV2Reference.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None,
