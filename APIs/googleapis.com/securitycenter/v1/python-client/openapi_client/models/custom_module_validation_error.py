...
class CustomModuleValidationError(BaseModel):
    """
    An error encountered while validating the uploaded configuration of an Event Threat Detection Custom Module.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="A description of the error, suitable for human consumption. Required.")
    end: Optional[Position] = None
    field_path: Optional[StrictStr] = Field(default=None, description="The path, in RFC 8901 JSON Pointer format, to the field that failed validation. This may be left empty if no specific field is affected.", alias="fieldPath")
    start: Optional[Position] = None
    __properties: ClassVar[List[str]] = ["description", "end", "fieldPath", "start"]
