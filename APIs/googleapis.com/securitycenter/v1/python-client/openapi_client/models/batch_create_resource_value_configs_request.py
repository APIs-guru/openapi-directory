...
class BatchCreateResourceValueConfigsRequest(BaseModel):
    """
    Request message to create multiple resource value configs
    """ # noqa: E501
    requests: Optional[List[CreateResourceValueConfigRequest]] = Field(default=None, description="Required. The resource value configs to be created.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreateResourceValueConfigRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
