...
class GoogleCloudSecuritycenterV1p1beta1Finding(BaseModel):
    ...
    security_marks: Optional[GoogleCloudSecuritycenterV1p1beta1SecurityMarks] = Field(default=None, alias="securityMarks")
    ...
    __properties: ClassVar[List[str]] = ["canonicalName", "category", "createTime", "eventTime", "externalUri", "name", "parent", "resourceName", "securityMarks", "severity", "sourceProperties", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "securityMarks": GoogleCloudSecuritycenterV1p1beta1SecurityMarks.from_dict(obj["securityMarks"]) if obj.get("securityMarks") is not None else None,
