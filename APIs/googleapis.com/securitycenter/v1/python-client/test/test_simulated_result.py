...
class TestSimulatedResult(unittest.TestCase):
    """SimulatedResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulatedResult:
        """Test SimulatedResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimulatedResult`
        """
        model = SimulatedResult()
        if include_optional:
