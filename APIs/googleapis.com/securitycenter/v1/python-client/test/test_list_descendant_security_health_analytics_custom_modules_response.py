...
class TestListDescendantSecurityHealthAnalyticsCustomModulesResponse(unittest.TestCase):
    """ListDescendantSecurityHealthAnalyticsCustomModulesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDescendantSecurityHealthAnalyticsCustomModulesResponse:
        """Test ListDescendantSecurityHealthAnalyticsCustomModulesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDescendantSecurityHealthAnalyticsCustomModulesResponse`
        """
        model = ListDescendantSecurityHealthAnalyticsCustomModulesResponse()
        if include_optional:
    ...
    def testListDescendantSecurityHealthAnalyticsCustomModulesResponse(self):
        """Test ListDescendantSecurityHealthAnalyticsCustomModulesResponse"""
