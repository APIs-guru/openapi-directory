...
class TestListAttackPathsResponse(unittest.TestCase):
    """ListAttackPathsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAttackPathsResponse:
        """Test ListAttackPathsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAttackPathsResponse`
        """
        model = ListAttackPathsResponse()
        if include_optional:
            return ListAttackPathsResponse(
                attack_paths = [
                    openapi_client.models.attack_path.AttackPath(
                        edges = [
    ...
    def testListAttackPathsResponse(self):
        """Test ListAttackPathsResponse"""
