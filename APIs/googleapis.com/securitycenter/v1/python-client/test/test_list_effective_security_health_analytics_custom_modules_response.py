...
class TestListEffectiveSecurityHealthAnalyticsCustomModulesResponse(unittest.TestCase):
    """ListEffectiveSecurityHealthAnalyticsCustomModulesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEffectiveSecurityHealthAnalyticsCustomModulesResponse:
        """Test ListEffectiveSecurityHealthAnalyticsCustomModulesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEffectiveSecurityHealthAnalyticsCustomModulesResponse`
        """
        model = ListEffectiveSecurityHealthAnalyticsCustomModulesResponse()
        if include_optional:
            return ListEffectiveSecurityHealthAnalyticsCustomModulesResponse(
                effective_security_health_analytics_custom_modules = [
                    openapi_client.models.google_cloud_securitycenter_v1_effective_security_health_analytics_custom_module.GoogleCloudSecuritycenterV1EffectiveSecurityHealthAnalyticsCustomModule(
    ...
    def testListEffectiveSecurityHealthAnalyticsCustomModulesResponse(self):
        """Test ListEffectiveSecurityHealthAnalyticsCustomModulesResponse"""
