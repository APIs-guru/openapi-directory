...
class TestListFindingsResult(unittest.TestCase):
    """ListFindingsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFindingsResult:
        """Test ListFindingsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFindingsResult`
        """
    ...
    def testListFindingsResult(self):
        """Test ListFindingsResult"""
