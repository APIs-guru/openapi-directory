...
class TestKernelRootkit(unittest.TestCase):
    """KernelRootkit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KernelRootkit:
        """Test KernelRootkit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KernelRootkit`
        """
        model = KernelRootkit()
        if include_optional:
