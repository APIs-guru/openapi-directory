...
class Case(BaseModel):
    ...
    severity: Optional[StrictStr] = Field(default=None, description="REMOVED. The severity of this case. Use priority instead.")
    ...
    __properties: ClassVar[List[str]] = ["classification", "contactEmail", "createTime", "creator", "description", "displayName", "escalated", "languageCode", "name", "priority", "severity", "state", "subscriberEmailAddresses", "testCase", "timeZone", "updateTime"]
    ...
    def severity_validate_enum(cls, value):
        ...
        if value not in set(['SEVERITY_UNSPECIFIED', 'S0', 'S1', 'S2', 'S3', 'S4']):
            raise ValueError("must be one of enum values ('SEVERITY_UNSPECIFIED', 'S0', 'S1', 'S2', 'S3', 'S4')")
        return value
