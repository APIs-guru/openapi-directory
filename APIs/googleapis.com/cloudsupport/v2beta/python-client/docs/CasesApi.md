...
------------- | ------------- | -------------
[**cloudsupport_cases_attachments_list**](CasesApi.md#cloudsupport_cases_attachments_list) | **GET** /v2beta/{parent}/attachments | 
[**cloudsupport_cases_close**](CasesApi.md#cloudsupport_cases_close) | **POST** /v2beta/{name}:close | 
[**cloudsupport_cases_comments_create**](CasesApi.md#cloudsupport_cases_comments_create) | **POST** /v2beta/{parent}/comments | 
[**cloudsupport_cases_comments_list**](CasesApi.md#cloudsupport_cases_comments_list) | **GET** /v2beta/{parent}/comments | 
[**cloudsupport_cases_create**](CasesApi.md#cloudsupport_cases_create) | **POST** /v2beta/{parent}/cases | 
[**cloudsupport_cases_escalate**](CasesApi.md#cloudsupport_cases_escalate) | **POST** /v2beta/{name}:escalate | 
[**cloudsupport_cases_get**](CasesApi.md#cloudsupport_cases_get) | **GET** /v2beta/{name} | 
[**cloudsupport_cases_list**](CasesApi.md#cloudsupport_cases_list) | **GET** /v2beta/{parent}/cases | 
[**cloudsupport_cases_patch**](CasesApi.md#cloudsupport_cases_patch) | **PATCH** /v2beta/{name} | 
[**cloudsupport_cases_search**](CasesApi.md#cloudsupport_cases_search) | **GET** /v2beta/cases:search | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    page_token = 'page_token_example' # str | A token identifying the page of results to return. If unspecified, the first page is retrieved. (optional)
    product_line = 'product_line_example' # str | The product line to request cases for. (optional)
 ...
 **page_token** | **str**| A token identifying the page of results to return. If unspecified, the first page is retrieved. | [optional] 
 **product_line** | **str**| The product line to request cases for. | [optional] 
...
> SearchCasesResponse cloudsupport_cases_search(xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, page_size=page_size, page_token=page_token, parent=parent, query=query)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    page_token = 'page_token_example' # str | A token identifying the page of results to return. If unspecified, the first page is retrieved. (optional)
    parent = 'parent_example' # str | The name of the parent resource to search for cases under. (optional)
    ...
    try:
        api_response = api_instance.cloudsupport_cases_search(xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, page_size=page_size, page_token=page_token, parent=parent, query=query)
 ...
 **page_token** | **str**| A token identifying the page of results to return. If unspecified, the first page is retrieved. | [optional] 
 **parent** | **str**| The name of the parent resource to search for cases under. | [optional] 
