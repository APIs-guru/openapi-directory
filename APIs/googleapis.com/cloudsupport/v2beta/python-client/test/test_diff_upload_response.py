...
class TestDiffUploadResponse(unittest.TestCase):
    """DiffUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiffUploadResponse:
        """Test DiffUploadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiffUploadResponse`
        """
        model = DiffUploadResponse()
        if include_optional:
    ...
    def testDiffUploadResponse(self):
        """Test DiffUploadResponse"""
