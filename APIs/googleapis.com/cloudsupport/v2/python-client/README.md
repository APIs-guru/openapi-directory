...
------------ | ------------- | ------------- | -------------
*CaseClassificationsApi* | [**cloudsupport_case_classifications_search**](docs/CaseClassificationsApi.md#cloudsupport_case_classifications_search) | **GET** /v2/caseClassifications:search | 
*CasesApi* | [**cloudsupport_cases_attachments_list**](docs/CasesApi.md#cloudsupport_cases_attachments_list) | **GET** /v2/{parent}/attachments | 
*CasesApi* | [**cloudsupport_cases_close**](docs/CasesApi.md#cloudsupport_cases_close) | **POST** /v2/{name}:close | 
*CasesApi* | [**cloudsupport_cases_comments_create**](docs/CasesApi.md#cloudsupport_cases_comments_create) | **POST** /v2/{parent}/comments | 
*CasesApi* | [**cloudsupport_cases_comments_list**](docs/CasesApi.md#cloudsupport_cases_comments_list) | **GET** /v2/{parent}/comments | 
*CasesApi* | [**cloudsupport_cases_create**](docs/CasesApi.md#cloudsupport_cases_create) | **POST** /v2/{parent}/cases | 
*CasesApi* | [**cloudsupport_cases_escalate**](docs/CasesApi.md#cloudsupport_cases_escalate) | **POST** /v2/{name}:escalate | 
*CasesApi* | [**cloudsupport_cases_get**](docs/CasesApi.md#cloudsupport_cases_get) | **GET** /v2/{name} | 
*CasesApi* | [**cloudsupport_cases_list**](docs/CasesApi.md#cloudsupport_cases_list) | **GET** /v2/{parent}/cases | 
*CasesApi* | [**cloudsupport_cases_patch**](docs/CasesApi.md#cloudsupport_cases_patch) | **PATCH** /v2/{name} | 
*CasesApi* | [**cloudsupport_cases_search**](docs/CasesApi.md#cloudsupport_cases_search) | **GET** /v2/{parent}/cases:search | 
*MediaApi* | [**cloudsupport_media_download**](docs/MediaApi.md#cloudsupport_media_download) | **GET** /v2/{name}:download | 
*MediaApi* | [**cloudsupport_media_upload**](docs/MediaApi.md#cloudsupport_media_upload) | **POST** /v2/{parent}/attachments | 
