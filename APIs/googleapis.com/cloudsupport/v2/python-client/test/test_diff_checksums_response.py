...
class TestDiffChecksumsResponse(unittest.TestCase):
    """DiffChecksumsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiffChecksumsResponse:
        """Test DiffChecksumsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiffChecksumsResponse`
        """
        model = DiffChecksumsResponse()
        if include_optional:
    ...
    def testDiffChecksumsResponse(self):
        """Test DiffChecksumsResponse"""
