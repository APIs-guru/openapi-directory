...
**job_title_snippet** | **str** | Contains snippets of text from the Job.title field most closely matching a search query&#39;s keywords, if available. The matching query keywords are enclosed in HTML bold tags. | [optional] 
