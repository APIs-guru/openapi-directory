...
class TestBatchCreateJobsRequest(unittest.TestCase):
    """BatchCreateJobsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateJobsRequest:
        """Test BatchCreateJobsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateJobsRequest`
        """
        model = BatchCreateJobsRequest()
        if include_optional:
    ...
    def testBatchCreateJobsRequest(self):
        """Test BatchCreateJobsRequest"""
