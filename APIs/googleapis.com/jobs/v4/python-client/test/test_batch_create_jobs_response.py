...
class TestBatchCreateJobsResponse(unittest.TestCase):
    """BatchCreateJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateJobsResponse:
        """Test BatchCreateJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateJobsResponse`
        """
        model = BatchCreateJobsResponse()
        if include_optional:
    ...
    def testBatchCreateJobsResponse(self):
        """Test BatchCreateJobsResponse"""
