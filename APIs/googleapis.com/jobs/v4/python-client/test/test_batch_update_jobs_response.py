...
class TestBatchUpdateJobsResponse(unittest.TestCase):
    """BatchUpdateJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateJobsResponse:
        """Test BatchUpdateJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateJobsResponse`
        """
        model = BatchUpdateJobsResponse()
        if include_optional:
            return BatchUpdateJobsResponse(
                job_results = [
    ...
    def testBatchUpdateJobsResponse(self):
        """Test BatchUpdateJobsResponse"""
