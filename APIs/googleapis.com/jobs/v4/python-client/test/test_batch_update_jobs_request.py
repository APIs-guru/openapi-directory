...
class TestBatchUpdateJobsRequest(unittest.TestCase):
    """BatchUpdateJobsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateJobsRequest:
        """Test BatchUpdateJobsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateJobsRequest`
        """
        model = BatchUpdateJobsRequest()
        if include_optional:
    ...
    def testBatchUpdateJobsRequest(self):
        """Test BatchUpdateJobsRequest"""
