...
class RequestMetadata(BaseModel):
    ...
    """ # noqa: E501
    allow_missing_ids: Optional[StrictBool] = Field(default=None, description="Only set when any of domain, session_id and user_id isn't available for some reason. It is highly recommended not to set this field and provide accurate domain, session_id and user_id for the best service experience.", alias="allowMissingIds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowMissingIds": obj.get("allowMissingIds"),
