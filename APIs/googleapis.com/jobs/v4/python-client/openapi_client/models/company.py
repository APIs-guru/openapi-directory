...
class Company(BaseModel):
    ...
    """ # noqa: E501
    career_site_uri: Optional[StrictStr] = Field(default=None, description="The URI to employer's career site or careers page on the employer's web site, for example, \"https://careers.google.com\".", alias="careerSiteUri")
    ...
    eeo_text: Optional[StrictStr] = Field(default=None, description="Equal Employment Opportunity legal disclaimer text to be associated with all jobs, and typically to be displayed in all roles. The maximum number of allowed characters is 500.", alias="eeoText")
    ...
    headquarters_address: Optional[StrictStr] = Field(default=None, description="The street address of the company's main headquarters, which may be different from the job location. The service attempts to geolocate the provided address, and populates a more specific location wherever possible in DerivedInfo.headquarters_location.", alias="headquartersAddress")
    hiring_agency: Optional[StrictBool] = Field(default=None, description="Set to true if it is the hiring agency that post jobs for other employers. Defaults to false if not provided.", alias="hiringAgency")
    image_uri: Optional[StrictStr] = Field(default=None, description="A URI that hosts the employer's company logo.", alias="imageUri")
    keyword_searchable_job_custom_attributes: Optional[List[StrictStr]] = Field(default=None, description="This field is deprecated. Please set the searchability of the custom attribute in the Job.custom_attributes going forward. A list of keys of filterable Job.custom_attributes, whose corresponding `string_values` are used in keyword searches. Jobs with `string_values` under these specified field keys are returned if any of the values match the search keyword. Custom field values with parenthesis, brackets and special symbols are not searchable as-is, and those keyword queries must be surrounded by quotes.", alias="keywordSearchableJobCustomAttributes")
    name: Optional[StrictStr] = Field(default=None, description="Required during company update. The resource name for a company. This is generated by the service when a company is created. The format is \"projects/{project_id}/tenants/{tenant_id}/companies/{company_id}\", for example, \"projects/foo/tenants/bar/companies/baz\".")
    size: Optional[StrictStr] = Field(default=None, description="The employer's company size.")
    ...
    website_uri: Optional[StrictStr] = Field(default=None, description="The URI representing the company's primary web site or home page, for example, \"https://www.google.com\". The maximum number of allowed characters is 255.", alias="websiteUri")
