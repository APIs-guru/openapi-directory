...
class CompensationInfo(BaseModel):
    ...
    entries: Optional[List[CompensationEntry]] = Field(default=None, description="Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as **base compensation entry** for the job.")
