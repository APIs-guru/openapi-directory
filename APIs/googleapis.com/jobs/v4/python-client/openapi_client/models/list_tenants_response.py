...
class ListTenantsResponse(BaseModel):
    ...
    tenants: Optional[List[Tenant]] = Field(default=None, description="Tenants for the current client.")
    __properties: ClassVar[List[str]] = ["metadata", "nextPageToken", "tenants"]
