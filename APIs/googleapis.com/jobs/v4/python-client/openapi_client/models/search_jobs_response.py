...
class SearchJobsResponse(BaseModel):
    ...
    location_filters: Optional[List[Location]] = Field(default=None, description="The location filters that the service applied to the specified query. If any filters are lat-lng based, the Location.location_type is Location.LocationType.LOCATION_TYPE_UNSPECIFIED.", alias="locationFilters")
    ...
    total_size: Optional[StrictInt] = Field(default=None, description="Number of jobs that match the specified query. Note: This size is precise only if the total is less than 100,000.", alias="totalSize")
    __properties: ClassVar[List[str]] = ["broadenedQueryJobsCount", "histogramQueryResults", "locationFilters", "matchingJobs", "metadata", "nextPageToken", "spellCorrection", "totalSize"]
