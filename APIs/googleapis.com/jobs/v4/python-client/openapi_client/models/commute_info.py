...
class CommuteInfo(BaseModel):
    ...
    travel_duration: Optional[StrictStr] = Field(default=None, description="The number of seconds required to travel to the job location from the query location. A duration of 0 seconds indicates that the job isn't reachable within the requested duration, but was returned as part of an expanded query.", alias="travelDuration")
