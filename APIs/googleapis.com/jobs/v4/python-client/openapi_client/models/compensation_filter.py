...
class CompensationFilter(BaseModel):
    ...
    """ # noqa: E501
    include_jobs_with_unspecified_compensation_range: Optional[StrictBool] = Field(default=None, description="If set to true, jobs with unspecified compensation range fields are included.", alias="includeJobsWithUnspecifiedCompensationRange")
