...
class ProcessingOptions(BaseModel):
    ...
    """ # noqa: E501
    disable_street_address_resolution: Optional[StrictBool] = Field(default=None, description="If set to `true`, the service does not attempt to resolve a more precise address for the job.", alias="disableStreetAddressResolution")
    html_sanitization: Optional[StrictStr] = Field(default=None, description="Option for job HTML content sanitization. Applied fields are: * description * applicationInfo.instruction * incentives * qualifications * responsibilities HTML tags in these fields may be stripped if sanitiazation isn't disabled. Defaults to HtmlSanitization.SIMPLE_FORMATTING_ONLY.", alias="htmlSanitization")
