...
class MatchingJob(BaseModel):
    ...
    job_title_snippet: Optional[StrictStr] = Field(default=None, description="Contains snippets of text from the Job.title field most closely matching a search query's keywords, if available. The matching query keywords are enclosed in HTML bold tags.", alias="jobTitleSnippet")
