...
class ListJobsResponse(BaseModel):
    ...
    """ # noqa: E501
    jobs: Optional[List[Job]] = Field(default=None, description="The Jobs for a given company. The maximum number of items returned is based on the limit field provided in the request.")
    ...
    __properties: ClassVar[List[str]] = ["jobs", "metadata", "nextPageToken"]
