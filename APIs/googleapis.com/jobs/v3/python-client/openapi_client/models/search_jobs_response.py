...
class SearchJobsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["broadenedQueryJobsCount", "estimatedTotalSize", "histogramResults", "locationFilters", "matchingJobs", "metadata", "nextPageToken", "spellCorrection", "totalSize"]
