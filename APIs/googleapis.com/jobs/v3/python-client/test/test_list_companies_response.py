...
class TestListCompaniesResponse(unittest.TestCase):
    """ListCompaniesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCompaniesResponse:
        """Test ListCompaniesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCompaniesResponse`
        """
    ...
    def testListCompaniesResponse(self):
        """Test ListCompaniesResponse"""
