...
class TestWriteInsightRequest(unittest.TestCase):
    """WriteInsightRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WriteInsightRequest:
        """Test WriteInsightRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WriteInsightRequest`
        """
        model = WriteInsightRequest()
        if include_optional:
            return WriteInsightRequest(
                insight = openapi_client.models.insight.Insight(
                    instance_id = '', 
    ...
    def testWriteInsightRequest(self):
        """Test WriteInsightRequest"""
