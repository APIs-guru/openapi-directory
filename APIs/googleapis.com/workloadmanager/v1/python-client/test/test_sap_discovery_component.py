...
class TestSapDiscoveryComponent(unittest.TestCase):
    """SapDiscoveryComponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SapDiscoveryComponent:
        """Test SapDiscoveryComponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SapDiscoveryComponent`
        """
        model = SapDiscoveryComponent()
        if include_optional:
    ...
    def testSapDiscoveryComponent(self):
        """Test SapDiscoveryComponent"""
