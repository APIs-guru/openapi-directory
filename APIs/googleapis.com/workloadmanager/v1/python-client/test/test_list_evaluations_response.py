...
class TestListEvaluationsResponse(unittest.TestCase):
    """ListEvaluationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEvaluationsResponse:
        """Test ListEvaluationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEvaluationsResponse`
        """
        model = ListEvaluationsResponse()
        if include_optional:
            return ListEvaluationsResponse(
                evaluations = [
                    openapi_client.models.evaluation.Evaluation(
    ...
    def testListEvaluationsResponse(self):
        """Test ListEvaluationsResponse"""
