...
class TestFrontEndServer(unittest.TestCase):
    """FrontEndServer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FrontEndServer:
        """Test FrontEndServer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FrontEndServer`
        """
        model = FrontEndServer()
        if include_optional:
