...
class TestSapDiscoveryResource(unittest.TestCase):
    """SapDiscoveryResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SapDiscoveryResource:
        """Test SapDiscoveryResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SapDiscoveryResource`
        """
        model = SapDiscoveryResource()
        if include_optional:
    ...
    def testSapDiscoveryResource(self):
        """Test SapDiscoveryResource"""
