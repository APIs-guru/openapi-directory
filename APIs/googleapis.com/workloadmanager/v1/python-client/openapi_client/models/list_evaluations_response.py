...
class ListEvaluationsResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluations: Optional[List[Evaluation]] = Field(default=None, description="The list of Evaluation")
    ...
    __properties: ClassVar[List[str]] = ["evaluations", "nextPageToken", "unreachable"]
