...
**binding_explanations** | [**List[GoogleCloudPolicysimulatorV1betaBindingExplanation]**](GoogleCloudPolicysimulatorV1betaBindingExplanation.md) | Details about how each binding in the policy affects the principal&#39;s ability, or inability, to use the permission for the resource. If the user who created the Replay does not have access to the policy, this field is omitted. | [optional] 
...
google_cloud_policysimulator_v1beta_explained_policy_instance = GoogleCloudPolicysimulatorV1betaExplainedPolicy.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudPolicysimulatorV1betaExplainedPolicy.to_json())

# convert the object into a dict
google_cloud_policysimulator_v1beta_explained_policy_dict = google_cloud_policysimulator_v1beta_explained_policy_instance.to_dict()
# create an instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy from a dict
google_cloud_policysimulator_v1beta_explained_policy_from_dict = GoogleCloudPolicysimulatorV1betaExplainedPolicy.from_dict(google_cloud_policysimulator_v1beta_explained_policy_dict)
```
