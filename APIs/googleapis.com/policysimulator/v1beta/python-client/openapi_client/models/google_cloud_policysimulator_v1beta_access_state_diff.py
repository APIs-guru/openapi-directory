...
class GoogleCloudPolicysimulatorV1betaAccessStateDiff(BaseModel):
    """
    ...
    baseline: Optional[GoogleCloudPolicysimulatorV1betaExplainedAccess] = None
    simulated: Optional[GoogleCloudPolicysimulatorV1betaExplainedAccess] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "baseline": GoogleCloudPolicysimulatorV1betaExplainedAccess.from_dict(obj["baseline"]) if obj.get("baseline") is not None else None,
            "simulated": GoogleCloudPolicysimulatorV1betaExplainedAccess.from_dict(obj["simulated"]) if obj.get("simulated") is not None else None
        })
        return _obj
