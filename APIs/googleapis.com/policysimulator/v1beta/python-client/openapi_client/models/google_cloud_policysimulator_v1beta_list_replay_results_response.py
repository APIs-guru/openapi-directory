...
class GoogleCloudPolicysimulatorV1betaListReplayResultsResponse(BaseModel):
    """
    ...
    replay_results: Optional[List[GoogleCloudPolicysimulatorV1betaReplayResult]] = Field(default=None, description="The results of running a Replay.", alias="replayResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replayResults": [GoogleCloudPolicysimulatorV1betaReplayResult.from_dict(_item) for _item in obj["replayResults"]] if obj.get("replayResults") is not None else None
        })
        return _obj
