...
class GoogleCloudOrgpolicyV2AlternatePolicySpec(BaseModel):
    ...
    """ # noqa: E501
    launch: Optional[StrictStr] = Field(default=None, description="Reference to the launch that will be used while audit logging and to control the launch. Should be set only in the alternate policy.")
    spec: Optional[GoogleCloudOrgpolicyV2PolicySpec] = None
    __properties: ClassVar[List[str]] = ["launch", "spec"]
