...
class GoogleCloudPolicysimulatorV1betaExplainedPolicy(BaseModel):
    """
    ...
    binding_explanations: Optional[List[GoogleCloudPolicysimulatorV1betaBindingExplanation]] = Field(default=None, description="Details about how each binding in the policy affects the principal's ability, or inability, to use the permission for the resource. If the user who created the Replay does not have access to the policy, this field is omitted.", alias="bindingExplanations")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bindingExplanations": [GoogleCloudPolicysimulatorV1betaBindingExplanation.from_dict(_item) for _item in obj["bindingExplanations"]] if obj.get("bindingExplanations") is not None else None,
