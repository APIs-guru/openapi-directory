...
class TestGoogleCloudOrgpolicyV2PolicySpec(unittest.TestCase):
    """GoogleCloudOrgpolicyV2PolicySpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudOrgpolicyV2PolicySpec:
        """Test GoogleCloudOrgpolicyV2PolicySpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudOrgpolicyV2PolicySpec`
        """
        model = GoogleCloudOrgpolicyV2PolicySpec()
        if include_optional:
    ...
    def testGoogleCloudOrgpolicyV2PolicySpec(self):
        """Test GoogleCloudOrgpolicyV2PolicySpec"""
