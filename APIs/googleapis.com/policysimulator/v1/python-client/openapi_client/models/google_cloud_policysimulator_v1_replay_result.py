...
class GoogleCloudPolicysimulatorV1ReplayResult(BaseModel):
    """
    The result of replaying a single access tuple against a simulated state.
    """ # noqa: E501
    access_tuple: Optional[GoogleCloudPolicysimulatorV1AccessTuple] = Field(default=None, alias="accessTuple")
    diff: Optional[GoogleCloudPolicysimulatorV1ReplayDiff] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessTuple": GoogleCloudPolicysimulatorV1AccessTuple.from_dict(obj["accessTuple"]) if obj.get("accessTuple") is not None else None,
            "diff": GoogleCloudPolicysimulatorV1ReplayDiff.from_dict(obj["diff"]) if obj.get("diff") is not None else None,
