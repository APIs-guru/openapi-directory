...
class GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customConstraints": [GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay.from_dict(_item) for _item in obj["customConstraints"]] if obj.get("customConstraints") is not None else None,
            "policies": [GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
