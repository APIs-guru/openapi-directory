...
google_cloud_policysimulator_v1_binding_explanation_instance = GoogleCloudPolicysimulatorV1BindingExplanation.from_json(json)
# print the JSON string representation of the object
print(GoogleCloudPolicysimulatorV1BindingExplanation.to_json())

# convert the object into a dict
google_cloud_policysimulator_v1_binding_explanation_dict = google_cloud_policysimulator_v1_binding_explanation_instance.to_dict()
# create an instance of GoogleCloudPolicysimulatorV1BindingExplanation from a dict
google_cloud_policysimulator_v1_binding_explanation_from_dict = GoogleCloudPolicysimulatorV1BindingExplanation.from_dict(google_cloud_policysimulator_v1_binding_explanation_dict)
```
