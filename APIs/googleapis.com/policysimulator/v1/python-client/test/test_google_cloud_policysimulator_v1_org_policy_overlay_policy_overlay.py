...
class TestGoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay(unittest.TestCase):
    """GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay:
        """Test GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay`
        """
        model = GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay()
        if include_optional:
    ...
    def testGoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay(self):
        """Test GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay"""
