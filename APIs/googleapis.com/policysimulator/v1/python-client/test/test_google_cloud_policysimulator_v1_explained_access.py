...
class TestGoogleCloudPolicysimulatorV1ExplainedAccess(unittest.TestCase):
    """GoogleCloudPolicysimulatorV1ExplainedAccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPolicysimulatorV1ExplainedAccess:
        """Test GoogleCloudPolicysimulatorV1ExplainedAccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPolicysimulatorV1ExplainedAccess`
        """
        model = GoogleCloudPolicysimulatorV1ExplainedAccess()
        if include_optional:
    ...
    def testGoogleCloudPolicysimulatorV1ExplainedAccess(self):
        """Test GoogleCloudPolicysimulatorV1ExplainedAccess"""
