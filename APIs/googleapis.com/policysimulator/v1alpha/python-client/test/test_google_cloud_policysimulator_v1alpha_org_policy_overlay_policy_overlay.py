...
class TestGoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay(unittest.TestCase):
    """GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay:
        """Test GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay`
        """
        model = GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay()
        if include_optional:
    ...
    def testGoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay(self):
        """Test GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay"""
