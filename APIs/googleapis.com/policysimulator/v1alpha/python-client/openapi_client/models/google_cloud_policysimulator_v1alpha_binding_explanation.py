...
class GoogleCloudPolicysimulatorV1alphaBindingExplanation(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberships": dict(
                (_k, GoogleCloudPolicysimulatorV1alphaBindingExplanationAnnotatedMembership.from_dict(_v))
