...
class GoogleCloudPolicysimulatorV1alphaReplayResult(BaseModel):
    """
    The result of replaying a single access tuple against a simulated state.
    """ # noqa: E501
    access_tuple: Optional[GoogleCloudPolicysimulatorV1alphaAccessTuple] = Field(default=None, alias="accessTuple")
    diff: Optional[GoogleCloudPolicysimulatorV1alphaReplayDiff] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1alphaReplayResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1alphaReplayResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accessTuple": GoogleCloudPolicysimulatorV1alphaAccessTuple.from_dict(obj["accessTuple"]) if obj.get("accessTuple") is not None else None,
            "diff": GoogleCloudPolicysimulatorV1alphaReplayDiff.from_dict(obj["diff"]) if obj.get("diff") is not None else None,
