...
class GoogleCloudPolicysimulatorV1alphaReplay(BaseModel):
    """
    A resource describing a `Replay`, or simulation.
    """ # noqa: E501
    config: Optional[GoogleCloudPolicysimulatorV1alphaReplayConfig] = None
    ...
    results_summary: Optional[GoogleCloudPolicysimulatorV1alphaReplayResultsSummary] = Field(default=None, alias="resultsSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": GoogleCloudPolicysimulatorV1alphaReplayConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "name": obj.get("name"),
            "resultsSummary": GoogleCloudPolicysimulatorV1alphaReplayResultsSummary.from_dict(obj["resultsSummary"]) if obj.get("resultsSummary") is not None else None,
            "state": obj.get("state")
        })
        return _obj
