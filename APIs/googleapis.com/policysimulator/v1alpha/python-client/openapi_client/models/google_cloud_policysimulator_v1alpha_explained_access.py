...
class GoogleCloudPolicysimulatorV1alphaExplainedAccess(BaseModel):
    """
    ...
    policies: Optional[List[GoogleCloudPolicysimulatorV1alphaExplainedPolicy]] = Field(default=None, description="If the AccessState is `UNKNOWN`, this field contains the policies that led to that result. If the `AccessState` is `GRANTED` or `NOT_GRANTED`, this field is omitted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [GoogleCloudPolicysimulatorV1alphaExplainedPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
