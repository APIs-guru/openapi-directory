...
class GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview(BaseModel):
    """
    ...
    overlay: Optional[GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay] = None
    resource_counts: Optional[GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts] = Field(default=None, alias="resourceCounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "overlay": GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay.from_dict(obj["overlay"]) if obj.get("overlay") is not None else None,
            "resourceCounts": GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts.from_dict(obj["resourceCounts"]) if obj.get("resourceCounts") is not None else None,
            "state": obj.get("state"),
