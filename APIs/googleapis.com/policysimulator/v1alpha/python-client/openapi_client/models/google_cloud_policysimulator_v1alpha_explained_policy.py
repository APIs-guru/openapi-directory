...
class GoogleCloudPolicysimulatorV1alphaExplainedPolicy(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bindingExplanations": [GoogleCloudPolicysimulatorV1alphaBindingExplanation.from_dict(_item) for _item in obj["bindingExplanations"]] if obj.get("bindingExplanations") is not None else None,
