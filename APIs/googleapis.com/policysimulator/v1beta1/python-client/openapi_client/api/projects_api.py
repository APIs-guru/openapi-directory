...
class ProjectsApi:
    ...
    def policysimulator_projects_locations_replays_operations_list(
        ...
        _param = self._policysimulator_projects_locations_replays_operations_list_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def policysimulator_projects_locations_replays_operations_list_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def policysimulator_projects_locations_replays_operations_list_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the operation's parent resource.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _policysimulator_projects_locations_replays_operations_list_serialize(
        self,
        name,
        xgafv,
        access_token,
