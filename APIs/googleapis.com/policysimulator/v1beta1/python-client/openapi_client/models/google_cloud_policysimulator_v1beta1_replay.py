...
class GoogleCloudPolicysimulatorV1beta1Replay(BaseModel):
    """
    A resource describing a `Replay`, or simulation.
    """ # noqa: E501
    config: Optional[GoogleCloudPolicysimulatorV1beta1ReplayConfig] = None
    ...
    results_summary: Optional[GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary] = Field(default=None, alias="resultsSummary")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1beta1Replay from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleCloudPolicysimulatorV1beta1Replay from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "config": GoogleCloudPolicysimulatorV1beta1ReplayConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "name": obj.get("name"),
            "resultsSummary": GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary.from_dict(obj["resultsSummary"]) if obj.get("resultsSummary") is not None else None,
            "state": obj.get("state")
        })
        return _obj
