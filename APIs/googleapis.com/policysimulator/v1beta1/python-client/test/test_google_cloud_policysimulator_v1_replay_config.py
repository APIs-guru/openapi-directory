...
class TestGoogleCloudPolicysimulatorV1ReplayConfig(unittest.TestCase):
    """GoogleCloudPolicysimulatorV1ReplayConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudPolicysimulatorV1ReplayConfig:
        """Test GoogleCloudPolicysimulatorV1ReplayConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudPolicysimulatorV1ReplayConfig`
        """
        model = GoogleCloudPolicysimulatorV1ReplayConfig()
        if include_optional:
    ...
    def testGoogleCloudPolicysimulatorV1ReplayConfig(self):
        """Test GoogleCloudPolicysimulatorV1ReplayConfig"""
