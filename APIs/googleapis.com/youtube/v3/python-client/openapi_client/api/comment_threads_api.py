...
class CommentThreadsApi:
    ...
    @validate_call
    def youtube_comment_threads_insert(
        self,
        ...
        comment_thread: Optional[CommentThread] = None,
        ...
        :type comment_thread: CommentThread
        ...
        _param = self._youtube_comment_threads_insert_serialize(
            part=part,
            xgafv=xgafv,
    ...
    @validate_call
    def youtube_comment_threads_insert_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter identifies the properties that the API response will include. Set the parameter value to snippet. The snippet part has a quota cost of 2 units.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def youtube_comment_threads_insert_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter identifies the properties that the API response will include. Set the parameter value to snippet. The snippet part has a quota cost of 2 units.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _youtube_comment_threads_insert_serialize(
        self,
        part,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/youtube/v3/commentThreads',
    ...
    @validate_call
    def youtube_comment_threads_list(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies a comma-separated list of one or more commentThread resource properties that the API response will include.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
        param_callback: Annotated[Optional[StrictStr], Field(description="JSONP")] = None,
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        all_threads_related_to_channel_id: Annotated[Optional[StrictStr], Field(description="Returns the comment threads of all videos of the channel and the channel comments as well.")] = None,
        channel_id: Annotated[Optional[StrictStr], Field(description="Returns the comment threads for all the channel comments (ie does not include comments left on videos).")] = None,
        id: Annotated[Optional[List[StrictStr]], Field(description="Returns the comment threads with the given IDs for Stubby or Apiary.")] = None,
        ...
        moderation_status: Annotated[Optional[StrictStr], Field(description="Limits the returned comment threads to those with the specified moderation status. Not compatible with the 'id' filter. Valid values: published, heldForReview, likelySpam.")] = None,
        ...
        search_terms: Annotated[Optional[StrictStr], Field(description="Limits the returned comment threads to those matching the specified key words. Not compatible with the 'id' filter.")] = None,
        text_format: Annotated[Optional[StrictStr], Field(description="The requested text format for the returned comments.")] = None,
        video_id: Annotated[Optional[StrictStr], Field(description="Returns the comment threads of the specified video.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._youtube_comment_threads_list_serialize(
            part=part,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def youtube_comment_threads_list_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies a comma-separated list of one or more commentThread resource properties that the API response will include.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentThreadListResponse]:
        """youtube_comment_threads_list
    ...
    @validate_call
    def youtube_comment_threads_list_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies a comma-separated list of one or more commentThread resource properties that the API response will include.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _youtube_comment_threads_list_serialize(
        self,
        part,
        xgafv,
        access_token,
        ...
        if all_threads_related_to_channel_id is not None:
            ...
            _query_params.append(('allThreadsRelatedToChannelId', all_threads_related_to_channel_id))
