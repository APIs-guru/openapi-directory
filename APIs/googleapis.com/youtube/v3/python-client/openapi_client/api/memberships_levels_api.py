...
class MembershipsLevelsApi:
    ...
    @validate_call
    def youtube_memberships_levels_list(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet.")],
        ...
        :param part: The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet. (required)
        :type part: List[str]
        ...
        _param = self._youtube_memberships_levels_list_serialize(
            part=part,
            xgafv=xgafv,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MembershipsLevelListResponse",
        }
    ...
    @validate_call
    def youtube_memberships_levels_list_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MembershipsLevelListResponse]:
        """youtube_memberships_levels_list
    ...
    @validate_call
    def youtube_memberships_levels_list_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _youtube_memberships_levels_list_serialize(
        self,
        part,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/youtube/v3/membershipsLevels',
