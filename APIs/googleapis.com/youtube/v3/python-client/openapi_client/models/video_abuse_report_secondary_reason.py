...
class VideoAbuseReportSecondaryReason(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of this abuse report secondary reason.")
    label: Optional[StrictStr] = Field(default=None, description="The localized label for this abuse report secondary reason.")
