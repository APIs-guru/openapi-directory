...
class PlaylistContentDetails(BaseModel):
    ...
    """ # noqa: E501
    item_count: Optional[StrictInt] = Field(default=None, description="The number of videos in the playlist.", alias="itemCount")
    __properties: ClassVar[List[str]] = ["itemCount"]
