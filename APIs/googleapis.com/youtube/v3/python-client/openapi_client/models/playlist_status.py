...
class PlaylistStatus(BaseModel):
    ...
    PlaylistStatus
    """ # noqa: E501
    privacy_status: Optional[StrictStr] = Field(default=None, description="The playlist's privacy status.", alias="privacyStatus")
    __properties: ClassVar[List[str]] = ["privacyStatus"]
