...
class ChannelSection(BaseModel):
    ...
    localizations: Optional[Dict[str, ChannelSectionLocalization]] = Field(default=None, description="Localizations for different languages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "localizations": dict(
                (_k, ChannelSectionLocalization.from_dict(_v))
