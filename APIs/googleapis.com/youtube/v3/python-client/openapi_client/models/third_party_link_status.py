...
class ThirdPartyLinkStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["linkStatus"]
    ...
    def link_status_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'failed', 'pending', 'linked']):
            raise ValueError("must be one of enum values ('unknown', 'failed', 'pending', 'linked')")
        return value
