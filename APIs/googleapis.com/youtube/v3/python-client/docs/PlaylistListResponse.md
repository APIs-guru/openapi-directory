...
**kind** | **str** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#playlistListResponse\&quot;. | [optional] [default to 'youtube#playlistListResponse']
...
playlist_list_response_instance = PlaylistListResponse.from_json(json)
# print the JSON string representation of the object
print(PlaylistListResponse.to_json())

# convert the object into a dict
playlist_list_response_dict = playlist_list_response_instance.to_dict()
# create an instance of PlaylistListResponse from a dict
playlist_list_response_from_dict = PlaylistListResponse.from_dict(playlist_list_response_dict)
```
