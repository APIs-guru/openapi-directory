...
**kind** | **str** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#liveStreamListResponse\&quot;. | [optional] [default to 'youtube#liveStreamListResponse']
...
json = "{}"
# create an instance of LiveStreamListResponse from a JSON string
live_stream_list_response_instance = LiveStreamListResponse.from_json(json)
# print the JSON string representation of the object
print(LiveStreamListResponse.to_json())

# convert the object into a dict
live_stream_list_response_dict = live_stream_list_response_instance.to_dict()
# create an instance of LiveStreamListResponse from a dict
live_stream_list_response_from_dict = LiveStreamListResponse.from_dict(live_stream_list_response_dict)
```
