...
class ListActivitiesResponse(BaseModel):
    ...
    """ # noqa: E501
    activities: Optional[List[Activity]] = Field(default=None, description="List of activities.")
    next_page_token: Optional[StrictStr] = Field(default=None, description="Token for the next page of results.", alias="nextPageToken")
