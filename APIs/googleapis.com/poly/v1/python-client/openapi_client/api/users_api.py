...
class UsersApi:
    ...
    def poly_users_assets_list(
        self,
        name: Annotated[StrictStr, Field(description="A valid user id. Currently, only the special value 'me', representing the currently-authenticated user is supported. To use 'me', you must pass an OAuth token with the request.")],
        ...
        format: Annotated[Optional[StrictStr], Field(description="Return only assets with the matching format. Acceptable values are: `BLOCKS`, `FBX`, `GLTF`, `GLTF2`, `OBJ`, and `TILT`.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Specifies an ordering for assets. Acceptable values are: `BEST`, `NEWEST`, `OLDEST`. Defaults to `BEST`, which ranks assets based on a combination of popularity and other features.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of assets to be returned. This value must be between `1` and `100`. Defaults to `20`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Specifies a continuation token from a previous search whose results were split into multiple pages. To get the next page, submit the same request specifying the value from next_page_token.")] = None,
        visibility: Annotated[Optional[StrictStr], Field(description="The visibility of the assets to be returned. Defaults to VISIBILITY_UNSPECIFIED which returns all assets.")] = None,
        ...
        _param = self._poly_users_assets_list_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def poly_users_assets_list_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="A valid user id. Currently, only the special value 'me', representing the currently-authenticated user is supported. To use 'me', you must pass an OAuth token with the request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListUserAssetsResponse]:
        """poly_users_assets_list
    ...
    @validate_call
    def poly_users_assets_list_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="A valid user id. Currently, only the special value 'me', representing the currently-authenticated user is supported. To use 'me', you must pass an OAuth token with the request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _poly_users_assets_list_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def poly_users_likedassets_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        format: Annotated[Optional[StrictStr], Field(description="Return only assets with the matching format. Acceptable values are: `BLOCKS`, `FBX`, `GLTF`, `GLTF2`, `OBJ`, `TILT`.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Specifies an ordering for assets. Acceptable values are: `BEST`, `NEWEST`, `OLDEST`, 'LIKED_TIME'. Defaults to `LIKED_TIME`, which ranks assets based on how recently they were liked.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The maximum number of assets to be returned. This value must be between `1` and `100`. Defaults to `20`.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Specifies a continuation token from a previous search whose results were split into multiple pages. To get the next page, submit the same request specifying the value from next_page_token.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._poly_users_likedassets_list_serialize(
            name=name,
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
    ...
    @validate_call
    def poly_users_likedassets_list_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="A valid user id. Currently, only the special value 'me', representing the currently-authenticated user is supported. To use 'me', you must pass an OAuth token with the request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListLikedAssetsResponse]:
        """poly_users_likedassets_list
    ...
    @validate_call
    def poly_users_likedassets_list_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="A valid user id. Currently, only the special value 'me', representing the currently-authenticated user is supported. To use 'me', you must pass an OAuth token with the request.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _poly_users_likedassets_list_serialize(
        self,
        name,
        xgafv,
        access_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/{name}/likedassets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
