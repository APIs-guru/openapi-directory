...
class AssetsApi:
    ...
    def poly_assets_get(
        self,
        name: Annotated[StrictStr, Field(description="Required. An asset's name in the form `assets/{ASSET_ID}`.")],
        ...
        _param = self._poly_assets_get_serialize(
            name=name,
            xgafv=xgafv,
    ...
    @validate_call
    def poly_assets_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Required. An asset's name in the form `assets/{ASSET_ID}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def poly_assets_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Required. An asset's name in the form `assets/{ASSET_ID}`.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _poly_assets_get_serialize(
        self,
        name,
        xgafv,
        access_token,
    ...
    def poly_assets_list(
        ...
        upload_protocol: Annotated[Optional[StrictStr], Field(description="Upload protocol for media (e.g. \"raw\", \"multipart\").")] = None,
        upload_type: Annotated[Optional[StrictStr], Field(description="Legacy upload protocol for media (e.g. \"media\", \"multipart\").")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter assets based on the specified category. Supported values are: `animals`, `architecture`, `art`, `food`, `nature`, `objects`, `people`, `scenes`, `technology`, and `transport`.")] = None,
        curated: Annotated[Optional[StrictBool], Field(description="Return only assets that have been curated by the Poly team.")] = None,
        ...
        keywords: Annotated[Optional[StrictStr], Field(description="One or more search terms to be matched against all text that Poly has indexed for assets, which includes display_name, description, and tags. Multiple keywords should be separated by spaces.")] = None,
        max_complexity: Annotated[Optional[StrictStr], Field(description="Returns assets that are of the specified complexity or less. Defaults to COMPLEX. For example, a request for MEDIUM assets also includes SIMPLE assets.")] = None,
        ...
        _param = self._poly_assets_list_serialize(
            xgafv=xgafv,
            access_token=access_token,
            alt=alt,
            param_callback=param_callback,
    ...
    @validate_call
    def poly_assets_list_with_http_info(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    @validate_call
    def poly_assets_list_without_preload_content(
        self,
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for response.")] = None,
    ...
    def _poly_assets_list_serialize(
        self,
        xgafv,
        access_token,
        alt,
        ...
        if max_complexity is not None:
            ...
            _query_params.append(('maxComplexity', max_complexity))
