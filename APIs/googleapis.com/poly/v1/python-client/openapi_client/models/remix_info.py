...
class RemixInfo(BaseModel):
    ...
    """ # noqa: E501
    source_asset: Optional[List[StrictStr]] = Field(default=None, description="Resource ids for the sources of this remix, of the form: `assets/{ASSET_ID}`", alias="sourceAsset")
    __properties: ClassVar[List[str]] = ["sourceAsset"]
