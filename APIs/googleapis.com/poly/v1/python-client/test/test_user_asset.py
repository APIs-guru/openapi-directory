...
class TestUserAsset(unittest.TestCase):
    """UserAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserAsset:
        """Test UserAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserAsset`
        """
        model = UserAsset()
        if include_optional:
            return UserAsset(
