...
class TestListLikedAssetsResponse(unittest.TestCase):
    """ListLikedAssetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListLikedAssetsResponse:
        """Test ListLikedAssetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListLikedAssetsResponse`
        """
        model = ListLikedAssetsResponse()
        if include_optional:
    ...
    def testListLikedAssetsResponse(self):
        """Test ListLikedAssetsResponse"""
