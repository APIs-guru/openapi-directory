...
class Finding(BaseModel):
    ...
    finding_type: Optional[StrictStr] = Field(default=None, description="The type of the Finding.", alias="findingType")
    ...
    __properties: ClassVar[List[str]] = ["body", "description", "finalUrl", "findingType", "frameUrl", "fuzzedUrl", "httpMethod", "name", "outdatedLibrary", "reproductionUrl", "trackingId", "violatingResource", "vulnerableHeaders", "vulnerableParameters", "xss"]
