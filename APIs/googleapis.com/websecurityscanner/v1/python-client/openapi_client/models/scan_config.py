...
class ScanConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authentication", "blacklistPatterns", "displayName", "exportToSecurityCommandCenter", "ignoreHttpStatusErrors", "managedScan", "maxQps", "name", "riskLevel", "schedule", "startingUrls", "staticIpScan", "userAgent"]
