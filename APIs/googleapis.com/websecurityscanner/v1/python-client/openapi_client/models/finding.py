...
class Finding(BaseModel):
    ...
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Output only. The body of the request that triggered the vulnerability.")
    description: Optional[StrictStr] = Field(default=None, description="Output only. The description of the vulnerability.")
    final_url: Optional[StrictStr] = Field(default=None, description="Output only. The URL where the browser lands when the vulnerability is detected.", alias="finalUrl")
    finding_type: Optional[StrictStr] = Field(default=None, description="Output only. The type of the Finding. Detailed and up-to-date information on findings can be found here: https://cloud.google.com/security-command-center/docs/how-to-remediate-web-security-scanner-findings", alias="findingType")
    form: Optional[Form] = None
    frame_url: Optional[StrictStr] = Field(default=None, description="Output only. If the vulnerability was originated from nested IFrame, the immediate parent IFrame is reported.", alias="frameUrl")
    fuzzed_url: Optional[StrictStr] = Field(default=None, description="Output only. The URL produced by the server-side fuzzer and used in the request that triggered the vulnerability.", alias="fuzzedUrl")
    http_method: Optional[StrictStr] = Field(default=None, description="Output only. The http method of the request that triggered the vulnerability, in uppercase.", alias="httpMethod")
    name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the Finding. The name follows the format of 'projects/{projectId}/scanConfigs/{scanConfigId}/scanruns/{scanRunId}/findings/{findingId}'. The finding IDs are generated by the system.")
    outdated_library: Optional[OutdatedLibrary] = Field(default=None, alias="outdatedLibrary")
    reproduction_url: Optional[StrictStr] = Field(default=None, description="Output only. The URL containing human-readable payload that user can leverage to reproduce the vulnerability.", alias="reproductionUrl")
    severity: Optional[StrictStr] = Field(default=None, description="Output only. The severity level of the reported vulnerability.")
    tracking_id: Optional[StrictStr] = Field(default=None, description="Output only. The tracking ID uniquely identifies a vulnerability instance across multiple ScanRuns.", alias="trackingId")
