...
------------ | ------------- | ------------- | -------------
**finding_count** | **int** | Output only. The count of findings belonging to this finding type. | [optional] 
**finding_type** | **str** | Output only. The finding type associated with the stats. | [optional] 
