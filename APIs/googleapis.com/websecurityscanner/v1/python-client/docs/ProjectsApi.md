...
------------- | ------------- | -------------
[**websecurityscanner_projects_scan_configs_create**](ProjectsApi.md#websecurityscanner_projects_scan_configs_create) | **POST** /v1/{parent}/scanConfigs | 
[**websecurityscanner_projects_scan_configs_delete**](ProjectsApi.md#websecurityscanner_projects_scan_configs_delete) | **DELETE** /v1/{name} | 
[**websecurityscanner_projects_scan_configs_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_list) | **GET** /v1/{parent}/scanConfigs | 
[**websecurityscanner_projects_scan_configs_patch**](ProjectsApi.md#websecurityscanner_projects_scan_configs_patch) | **PATCH** /v1/{name} | 
[**websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list) | **GET** /v1/{parent}/crawledUrls | 
[**websecurityscanner_projects_scan_configs_scan_runs_finding_type_stats_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_finding_type_stats_list) | **GET** /v1/{parent}/findingTypeStats | 
[**websecurityscanner_projects_scan_configs_scan_runs_findings_get**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_findings_get) | **GET** /v1/{name} | 
[**websecurityscanner_projects_scan_configs_scan_runs_findings_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_findings_list) | **GET** /v1/{parent}/findings | 
[**websecurityscanner_projects_scan_configs_scan_runs_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_list) | **GET** /v1/{parent}/scanRuns | 
[**websecurityscanner_projects_scan_configs_scan_runs_stop**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_stop) | **POST** /v1/{name}:stop | 
[**websecurityscanner_projects_scan_configs_start**](ProjectsApi.md#websecurityscanner_projects_scan_configs_start) | **POST** /v1/{name}:start | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    filter = 'filter_example' # str | The filter expression. The expression must be in the format: . Supported field: 'finding_type'. Supported operator: '='. (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **filter** | **str**| The filter expression. The expression must be in the format: . Supported field: &#39;finding_type&#39;. Supported operator: &#39;&#x3D;&#39;. | [optional] 
