...
------------ | ------------- | ------------- | -------------
**code** | **str** | Indicates the reason code for a configuration failure. | [optional] 
**field_name** | **str** | Indicates the full name of the ScanConfig field that triggers this error, for example \&quot;scan_config.max_qps\&quot;. This field is provided for troubleshooting purposes only and its actual value can change in the future. | [optional] 
