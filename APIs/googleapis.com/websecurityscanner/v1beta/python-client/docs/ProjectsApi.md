...
------------- | ------------- | -------------
[**websecurityscanner_projects_scan_configs_create**](ProjectsApi.md#websecurityscanner_projects_scan_configs_create) | **POST** /v1beta/{parent}/scanConfigs | 
[**websecurityscanner_projects_scan_configs_delete**](ProjectsApi.md#websecurityscanner_projects_scan_configs_delete) | **DELETE** /v1beta/{name} | 
[**websecurityscanner_projects_scan_configs_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_list) | **GET** /v1beta/{parent}/scanConfigs | 
[**websecurityscanner_projects_scan_configs_patch**](ProjectsApi.md#websecurityscanner_projects_scan_configs_patch) | **PATCH** /v1beta/{name} | 
[**websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list) | **GET** /v1beta/{parent}/crawledUrls | 
[**websecurityscanner_projects_scan_configs_scan_runs_finding_type_stats_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_finding_type_stats_list) | **GET** /v1beta/{parent}/findingTypeStats | 
[**websecurityscanner_projects_scan_configs_scan_runs_findings_get**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_findings_get) | **GET** /v1beta/{name} | 
[**websecurityscanner_projects_scan_configs_scan_runs_findings_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_findings_list) | **GET** /v1beta/{parent}/findings | 
[**websecurityscanner_projects_scan_configs_scan_runs_list**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_list) | **GET** /v1beta/{parent}/scanRuns | 
[**websecurityscanner_projects_scan_configs_scan_runs_stop**](ProjectsApi.md#websecurityscanner_projects_scan_configs_scan_runs_stop) | **POST** /v1beta/{name}:stop | 
[**websecurityscanner_projects_scan_configs_start**](ProjectsApi.md#websecurityscanner_projects_scan_configs_start) | **POST** /v1beta/{name}:start | 
