...
------------ | ------------- | ------------- | -------------
**body** | **str** | The body of the request that was used to visit the URL. | [optional] 
**http_method** | **str** | The http method of the request that was used to visit the URL, in uppercase. | [optional] 
**url** | **str** | The URL that was crawled. | [optional] 
