...
class BatchCreatePermissionsRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[CreatePermissionRequest]] = Field(default=None, description="The request message specifying the resources to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreatePermissionRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
