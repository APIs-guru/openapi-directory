...
class ListNotesResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Next page's `page_token` field.", alias="nextPageToken")
    notes: Optional[List[Note]] = Field(default=None, description="A page of notes.")
