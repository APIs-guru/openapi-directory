...
class LongRunningRecognizeResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[SpeechRecognitionResult]] = Field(default=None, description="Output only. Sequential list of transcription results corresponding to sequential portions of audio.")
