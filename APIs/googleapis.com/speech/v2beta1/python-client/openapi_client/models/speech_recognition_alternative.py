...
class SpeechRecognitionAlternative(BaseModel):
    ...
    transcript: Optional[StrictStr] = Field(default=None, description="Output only. Transcript text representing the words that the user spoke.")
    words: Optional[List[WordInfo]] = Field(default=None, description="Output only. A list of word-specific information for each recognized word. Note: When `enable_speaker_diarization` is true, you will see all the words from the beginning of the audio.")
