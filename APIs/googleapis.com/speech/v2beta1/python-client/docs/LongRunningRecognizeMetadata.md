...
------------ | ------------- | ------------- | -------------
**last_update_time** | **str** | Output only. Time of the most recent processing update. | [optional] [readonly] 
**progress_percent** | **int** | Output only. Approximate percentage of audio processed thus far. Guaranteed to be 100 when the audio is fully processed and the results are available. | [optional] [readonly] 
**start_time** | **str** | Output only. Time when the request was received. | [optional] [readonly] 
**uri** | **str** | The URI of the audio file being transcribed. Empty if the audio was sent as byte content. | [optional] 
