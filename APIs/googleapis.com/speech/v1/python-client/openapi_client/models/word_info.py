...
class WordInfo(BaseModel):
    ...
    speaker_label: Optional[StrictStr] = Field(default=None, description="Output only. A label value assigned for every unique speaker within the audio. This field specifies which speaker was detected to have spoken this word. For some models, like medical_conversation this can be actual speaker role, for example \"patient\" or \"provider\", but generally this would be a number identifying a speaker. This field is only set if enable_speaker_diarization = 'true' and only for the top alternative.", alias="speakerLabel")
    speaker_tag: Optional[StrictInt] = Field(default=None, description="Output only. A distinct integer value is assigned for every speaker within the audio. This field specifies which one of those speakers was detected to have spoken this word. Value ranges from '1' to diarization_speaker_count. speaker_tag is set if enable_speaker_diarization = 'true' and only for the top alternative. Note: Use speaker_label instead.", alias="speakerTag")
    ...
    __properties: ClassVar[List[str]] = ["confidence", "endTime", "speakerLabel", "speakerTag", "startTime", "word"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "speakerLabel": obj.get("speakerLabel"),
