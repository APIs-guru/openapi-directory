...
class RecognitionMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["audioTopic", "industryNaicsCodeOfAudio", "interactionType", "microphoneDistance", "originalMediaType", "originalMimeType", "recordingDeviceName", "recordingDeviceType"]
