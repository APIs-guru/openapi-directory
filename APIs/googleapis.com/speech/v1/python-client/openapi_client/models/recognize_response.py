...
class RecognizeResponse(BaseModel):
    ...
    using_legacy_models: Optional[StrictBool] = Field(default=None, description="Whether request used legacy asr models (was not automatically migrated to use conformer models).", alias="usingLegacyModels")
    __properties: ClassVar[List[str]] = ["requestId", "results", "speechAdaptationInfo", "totalBilledTime", "usingLegacyModels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usingLegacyModels": obj.get("usingLegacyModels")
        })
        return _obj
