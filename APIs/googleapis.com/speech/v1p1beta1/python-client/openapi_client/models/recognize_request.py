...
class RecognizeRequest(BaseModel):
    ...
    """ # noqa: E501
    audio: Optional[RecognitionAudio] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audio": RecognitionAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
            "config": RecognitionConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
