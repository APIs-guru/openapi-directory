...
class ListPhraseSetResponse(BaseModel):
    """
    ...
    phrase_sets: Optional[List[PhraseSet]] = Field(default=None, description="The phrase set.", alias="phraseSets")
    __properties: ClassVar[List[str]] = ["nextPageToken", "phraseSets"]
