...
class ListCustomClassesResponse(BaseModel):
    """
    Message returned to the client by the `ListCustomClasses` method.
    """ # noqa: E501
    custom_classes: Optional[List[CustomClass]] = Field(default=None, description="The custom classes.", alias="customClasses")
    ...
    __properties: ClassVar[List[str]] = ["customClasses", "nextPageToken"]
