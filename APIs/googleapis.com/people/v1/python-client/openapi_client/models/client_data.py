...
class ClientData(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The client specified key of the client data.")
    metadata: Optional[FieldMetadata] = None
    value: Optional[StrictStr] = Field(default=None, description="The client specified value of the client data.")
    __properties: ClassVar[List[str]] = ["key", "metadata", "value"]
