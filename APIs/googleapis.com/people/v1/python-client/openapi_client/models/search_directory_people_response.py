...
class SearchDirectoryPeopleResponse(BaseModel):
    ...
    people: Optional[List[Person]] = Field(default=None, description="The list of people in the domain directory that match the query.")
    total_size: Optional[StrictInt] = Field(default=None, description="The total number of items in the list without pagination.", alias="totalSize")
    __properties: ClassVar[List[str]] = ["nextPageToken", "people", "totalSize"]
