...
class Locale(BaseModel):
    ...
    value: Optional[StrictStr] = Field(default=None, description="The well-formed [IETF BCP 47](https://tools.ietf.org/html/bcp47) language tag representing the locale.")
