...
class UserDefined(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The end user specified key of the user defined data.")
    metadata: Optional[FieldMetadata] = None
    value: Optional[StrictStr] = Field(default=None, description="The end user specified value of the user defined data.")
