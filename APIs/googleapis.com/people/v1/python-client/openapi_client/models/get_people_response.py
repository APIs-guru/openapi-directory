...
class GetPeopleResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[PersonResponse]] = Field(default=None, description="The response for each requested resource name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [PersonResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
