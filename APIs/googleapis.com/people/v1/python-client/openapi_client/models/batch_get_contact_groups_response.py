...
class BatchGetContactGroupsResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[ContactGroupResponse]] = Field(default=None, description="The list of responses for each requested contact group resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ContactGroupResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
