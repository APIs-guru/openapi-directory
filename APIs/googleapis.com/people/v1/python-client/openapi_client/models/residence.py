...
class Residence(BaseModel):
    ...
    **DEPRECATED**: Please use `person.locations` instead. A person's past or current residence.
    """ # noqa: E501
    current: Optional[StrictBool] = Field(default=None, description="True if the residence is the person's current residence; false if the residence is a past residence.")
    metadata: Optional[FieldMetadata] = None
    value: Optional[StrictStr] = Field(default=None, description="The address of the residence.")
    __properties: ClassVar[List[str]] = ["current", "metadata", "value"]
