...
class Event(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of the event. The type can be custom or one of these predefined values: * `anniversary` * `other`")
    __properties: ClassVar[List[str]] = ["date", "formattedType", "metadata", "type"]
