...
class TestBatchCreateContactsResponse(unittest.TestCase):
    """BatchCreateContactsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateContactsResponse:
        """Test BatchCreateContactsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateContactsResponse`
        """
        model = BatchCreateContactsResponse()
        if include_optional:
            return BatchCreateContactsResponse(
                created_people = [
                    openapi_client.models.person_response.PersonResponse(
                        http_status_code = 56, 
    ...
    def testBatchCreateContactsResponse(self):
        """Test BatchCreateContactsResponse"""
