...
class TestSipAddress(unittest.TestCase):
    """SipAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SipAddress:
        """Test SipAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SipAddress`
        """
        model = SipAddress()
        if include_optional:
            return SipAddress(
