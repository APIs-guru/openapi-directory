...
class TestBatchUpdateContactsRequest(unittest.TestCase):
    """BatchUpdateContactsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateContactsRequest:
        """Test BatchUpdateContactsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateContactsRequest`
        """
        model = BatchUpdateContactsRequest()
        if include_optional:
            return BatchUpdateContactsRequest(
                contacts = {
                    'key' : openapi_client.models.person.Person(
                        addresses = [
    ...
    def testBatchUpdateContactsRequest(self):
        """Test BatchUpdateContactsRequest"""
