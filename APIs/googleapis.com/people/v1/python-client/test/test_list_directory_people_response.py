...
class TestListDirectoryPeopleResponse(unittest.TestCase):
    """ListDirectoryPeopleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDirectoryPeopleResponse:
        """Test ListDirectoryPeopleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDirectoryPeopleResponse`
        """
        model = ListDirectoryPeopleResponse()
        if include_optional:
    ...
    def testListDirectoryPeopleResponse(self):
        """Test ListDirectoryPeopleResponse"""
