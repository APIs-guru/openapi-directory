...
class TestRelationshipInterest(unittest.TestCase):
    """RelationshipInterest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipInterest:
        """Test RelationshipInterest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipInterest`
        """
        model = RelationshipInterest()
        if include_optional:
    ...
    def testRelationshipInterest(self):
        """Test RelationshipInterest"""
