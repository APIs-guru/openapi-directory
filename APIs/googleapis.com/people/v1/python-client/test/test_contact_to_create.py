...
class TestContactToCreate(unittest.TestCase):
    """ContactToCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactToCreate:
        """Test ContactToCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactToCreate`
        """
        model = ContactToCreate()
        if include_optional:
            return ContactToCreate(
                contact_person = openapi_client.models.person.Person(
                    addresses = [
