...
class TestImClient(unittest.TestCase):
    """ImClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImClient:
        """Test ImClient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImClient`
        """
        model = ImClient()
        if include_optional:
            return ImClient(
