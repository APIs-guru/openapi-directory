...
class TestBraggingRights(unittest.TestCase):
    """BraggingRights unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BraggingRights:
        """Test BraggingRights
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BraggingRights`
        """
        model = BraggingRights()
        if include_optional:
