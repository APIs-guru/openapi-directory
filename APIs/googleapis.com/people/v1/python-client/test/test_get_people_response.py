...
class TestGetPeopleResponse(unittest.TestCase):
    """GetPeopleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPeopleResponse:
        """Test GetPeopleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPeopleResponse`
        """
        model = GetPeopleResponse()
        if include_optional:
    ...
    def testGetPeopleResponse(self):
        """Test GetPeopleResponse"""
