...
class TestBatchUpdateContactsResponse(unittest.TestCase):
    """BatchUpdateContactsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUpdateContactsResponse:
        """Test BatchUpdateContactsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUpdateContactsResponse`
        """
        model = BatchUpdateContactsResponse()
        if include_optional:
            return BatchUpdateContactsResponse(
                update_result = {
                    'key' : openapi_client.models.person_response.PersonResponse(
                        http_status_code = 56, 
    ...
    def testBatchUpdateContactsResponse(self):
        """Test BatchUpdateContactsResponse"""
