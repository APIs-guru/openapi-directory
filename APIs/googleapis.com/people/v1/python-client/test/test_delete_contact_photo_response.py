...
class TestDeleteContactPhotoResponse(unittest.TestCase):
    """DeleteContactPhotoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteContactPhotoResponse:
        """Test DeleteContactPhotoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteContactPhotoResponse`
        """
        model = DeleteContactPhotoResponse()
        if include_optional:
    ...
    def testDeleteContactPhotoResponse(self):
        """Test DeleteContactPhotoResponse"""
