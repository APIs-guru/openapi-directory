...
class TestUpdateContactPhotoResponse(unittest.TestCase):
    """UpdateContactPhotoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateContactPhotoResponse:
        """Test UpdateContactPhotoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateContactPhotoResponse`
        """
        model = UpdateContactPhotoResponse()
        if include_optional:
    ...
    def testUpdateContactPhotoResponse(self):
        """Test UpdateContactPhotoResponse"""
