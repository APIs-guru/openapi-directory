...
class GoogleAnalyticsAdminV1alphaRunAccessReportResponse(BaseModel):
    """
    The customized Data Access Record Report response.
    """ # noqa: E501
    dimension_headers: Optional[List[GoogleAnalyticsAdminV1alphaAccessDimensionHeader]] = Field(default=None, description="The header for a column in the report that corresponds to a specific dimension. The number of DimensionHeaders and ordering of DimensionHeaders matches the dimensions present in rows.", alias="dimensionHeaders")
    metric_headers: Optional[List[GoogleAnalyticsAdminV1alphaAccessMetricHeader]] = Field(default=None, description="The header for a column in the report that corresponds to a specific metric. The number of MetricHeaders and ordering of MetricHeaders matches the metrics present in rows.", alias="metricHeaders")
    quota: Optional[GoogleAnalyticsAdminV1alphaAccessQuota] = None
    ...
    rows: Optional[List[GoogleAnalyticsAdminV1alphaAccessRow]] = Field(default=None, description="Rows of dimension value combinations and metric values in the report.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dimensionHeaders": [GoogleAnalyticsAdminV1alphaAccessDimensionHeader.from_dict(_item) for _item in obj["dimensionHeaders"]] if obj.get("dimensionHeaders") is not None else None,
            "metricHeaders": [GoogleAnalyticsAdminV1alphaAccessMetricHeader.from_dict(_item) for _item in obj["metricHeaders"]] if obj.get("metricHeaders") is not None else None,
            "quota": GoogleAnalyticsAdminV1alphaAccessQuota.from_dict(obj["quota"]) if obj.get("quota") is not None else None,
            "rowCount": obj.get("rowCount"),
            "rows": [GoogleAnalyticsAdminV1alphaAccessRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
