...
class GoogleAnalyticsAdminV1alphaChannelGroupFilter(BaseModel):
    """
    A specific filter for a single dimension.
    """ # noqa: E501
    field_name: Optional[StrictStr] = Field(default=None, description="Required. Immutable. The dimension name to filter.", alias="fieldName")
    in_list_filter: Optional[GoogleAnalyticsAdminV1alphaChannelGroupFilterInListFilter] = Field(default=None, alias="inListFilter")
    string_filter: Optional[GoogleAnalyticsAdminV1alphaChannelGroupFilterStringFilter] = Field(default=None, alias="stringFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inListFilter": GoogleAnalyticsAdminV1alphaChannelGroupFilterInListFilter.from_dict(obj["inListFilter"]) if obj.get("inListFilter") is not None else None,
            "stringFilter": GoogleAnalyticsAdminV1alphaChannelGroupFilterStringFilter.from_dict(obj["stringFilter"]) if obj.get("stringFilter") is not None else None
        })
        return _obj
