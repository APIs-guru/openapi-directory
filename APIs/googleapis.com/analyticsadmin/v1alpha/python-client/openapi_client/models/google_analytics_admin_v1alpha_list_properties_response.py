...
class GoogleAnalyticsAdminV1alphaListPropertiesResponse(BaseModel):
    """
    ...
    properties: Optional[List[GoogleAnalyticsAdminV1alphaProperty]] = Field(default=None, description="Results that matched the filter criteria and were accessible to the caller.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [GoogleAnalyticsAdminV1alphaProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
