...
class GoogleAnalyticsAdminV1alphaListAudiencesResponse(BaseModel):
    """
    Response message for ListAudiences RPC.
    """ # noqa: E501
    audiences: Optional[List[GoogleAnalyticsAdminV1alphaAudience]] = Field(default=None, description="List of Audiences.")
    ...
    __properties: ClassVar[List[str]] = ["audiences", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audiences": [GoogleAnalyticsAdminV1alphaAudience.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None,
