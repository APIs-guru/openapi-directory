...
class GoogleAnalyticsAdminV1alphaBatchDeleteAccessBindingsRequest(BaseModel):
    """
    Request message for BatchDeleteAccessBindings RPC.
    """ # noqa: E501
    requests: Optional[List[GoogleAnalyticsAdminV1alphaDeleteAccessBindingRequest]] = Field(default=None, description="Required. The requests specifying the access bindings to delete. A maximum of 1000 access bindings can be deleted in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleAnalyticsAdminV1alphaDeleteAccessBindingRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
