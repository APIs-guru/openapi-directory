...
class GoogleAnalyticsAdminV1alphaGroupingRule(BaseModel):
    """
    The rules that govern how traffic is grouped into one channel.
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Required. Customer defined display name for the channel.", alias="displayName")
    expression: Optional[GoogleAnalyticsAdminV1alphaChannelGroupFilterExpression] = None
    __properties: ClassVar[List[str]] = ["displayName", "expression"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expression": GoogleAnalyticsAdminV1alphaChannelGroupFilterExpression.from_dict(obj["expression"]) if obj.get("expression") is not None else None
        })
        return _obj
