...
class GoogleAnalyticsAdminV1alphaAccessNumericFilter(BaseModel):
    """
    Filters for numeric or date values.
    """ # noqa: E501
    operation: Optional[StrictStr] = Field(default=None, description="The operation type for this filter.")
    value: Optional[GoogleAnalyticsAdminV1alphaNumericValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": GoogleAnalyticsAdminV1alphaNumericValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
