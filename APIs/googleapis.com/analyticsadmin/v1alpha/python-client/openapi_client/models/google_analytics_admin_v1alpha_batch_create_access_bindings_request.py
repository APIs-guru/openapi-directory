...
class GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsRequest(BaseModel):
    """
    Request message for BatchCreateAccessBindings RPC.
    """ # noqa: E501
    requests: Optional[List[GoogleAnalyticsAdminV1alphaCreateAccessBindingRequest]] = Field(default=None, description="Required. The requests specifying the access bindings to create. A maximum of 1000 access bindings can be created in a batch.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GoogleAnalyticsAdminV1alphaCreateAccessBindingRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
