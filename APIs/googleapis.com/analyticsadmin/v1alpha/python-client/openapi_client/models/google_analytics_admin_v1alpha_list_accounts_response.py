...
class GoogleAnalyticsAdminV1alphaListAccountsResponse(BaseModel):
    """
    Request message for ListAccounts RPC.
    """ # noqa: E501
    accounts: Optional[List[GoogleAnalyticsAdminV1alphaAccount]] = Field(default=None, description="Results that were accessible to the caller.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [GoogleAnalyticsAdminV1alphaAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
