...
class GoogleAnalyticsAdminV1alphaAccessFilterExpressionList(BaseModel):
    """
    A list of filter expressions.
    """ # noqa: E501
    expressions: Optional[List[GoogleAnalyticsAdminV1alphaAccessFilterExpression]] = Field(default=None, description="A list of filter expressions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "expressions": [GoogleAnalyticsAdminV1alphaAccessFilterExpression.from_dict(_item) for _item in obj["expressions"]] if obj.get("expressions") is not None else None
        })
        return _obj
...
GoogleAnalyticsAdminV1alphaAccessFilterExpressionList.model_rebuild(raise_errors=False)
