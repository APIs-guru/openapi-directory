...
class GoogleAnalyticsAdminV1alphaFetchAutomatedGa4ConfigurationOptOutResponse(BaseModel):
    """
    Response message for fetching the opt out status for the automated GA4 setup process.
    """ # noqa: E501
    opt_out: Optional[StrictBool] = Field(default=None, description="The opt out status for the UA property.", alias="optOut")
    __properties: ClassVar[List[str]] = ["optOut"]
