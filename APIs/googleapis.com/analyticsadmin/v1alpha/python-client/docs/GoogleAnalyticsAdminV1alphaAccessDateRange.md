...
json = "{}"
# create an instance of GoogleAnalyticsAdminV1alphaAccessDateRange from a JSON string
google_analytics_admin_v1alpha_access_date_range_instance = GoogleAnalyticsAdminV1alphaAccessDateRange.from_json(json)
# print the JSON string representation of the object
print(GoogleAnalyticsAdminV1alphaAccessDateRange.to_json())

# convert the object into a dict
google_analytics_admin_v1alpha_access_date_range_dict = google_analytics_admin_v1alpha_access_date_range_instance.to_dict()
# create an instance of GoogleAnalyticsAdminV1alphaAccessDateRange from a dict
google_analytics_admin_v1alpha_access_date_range_from_dict = GoogleAnalyticsAdminV1alphaAccessDateRange.from_dict(google_analytics_admin_v1alpha_access_date_range_dict)
```
