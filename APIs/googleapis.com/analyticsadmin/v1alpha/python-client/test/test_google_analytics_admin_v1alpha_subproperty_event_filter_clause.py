...
class TestGoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause(unittest.TestCase):
    """GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause:
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause`
        """
        model = GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause()
        if include_optional:
    ...
    def testGoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause(self):
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause"""
