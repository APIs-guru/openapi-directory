...
class TestGoogleAnalyticsAdminV1alphaSubpropertyEventFilter(unittest.TestCase):
    """GoogleAnalyticsAdminV1alphaSubpropertyEventFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAnalyticsAdminV1alphaSubpropertyEventFilter:
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAnalyticsAdminV1alphaSubpropertyEventFilter`
        """
        model = GoogleAnalyticsAdminV1alphaSubpropertyEventFilter()
        if include_optional:
    ...
    def testGoogleAnalyticsAdminV1alphaSubpropertyEventFilter(self):
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilter"""
