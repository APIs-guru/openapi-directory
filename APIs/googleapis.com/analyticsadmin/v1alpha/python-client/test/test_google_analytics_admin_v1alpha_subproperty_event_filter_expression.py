...
class TestGoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression(unittest.TestCase):
    """GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression:
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression`
        """
        model = GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression()
        if include_optional:
    ...
    def testGoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression(self):
        """Test GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpression"""
