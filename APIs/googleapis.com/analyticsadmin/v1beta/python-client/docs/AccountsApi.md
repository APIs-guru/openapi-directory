...
------------- | ------------- | -------------
[**analyticsadmin_accounts_list**](AccountsApi.md#analyticsadmin_accounts_list) | **GET** /v1beta/accounts | 
[**analyticsadmin_accounts_provision_account_ticket**](AccountsApi.md#analyticsadmin_accounts_provision_account_ticket) | **POST** /v1beta/accounts:provisionAccountTicket | 
[**analyticsadmin_accounts_search_change_history_events**](AccountsApi.md#analyticsadmin_accounts_search_change_history_events) | **POST** /v1beta/{account}:searchChangeHistoryEvents | 
...
> GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse analyticsadmin_accounts_provision_account_ticket(xgafv=xgafv, access_token=access_token, alt=alt, param_callback=param_callback, fields=fields, key=key, oauth_token=oauth_token, pretty_print=pretty_print, quota_user=quota_user, upload_protocol=upload_protocol, upload_type=upload_type, google_analytics_admin_v1beta_provision_account_ticket_request=google_analytics_admin_v1beta_provision_account_ticket_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    google_analytics_admin_v1beta_provision_account_ticket_request = openapi_client.GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest() # GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest |  (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **google_analytics_admin_v1beta_provision_account_ticket_request** | [**GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest**](GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest.md)|  | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    upload_protocol = 'upload_protocol_example' # str | Upload protocol for media (e.g. \"raw\", \"multipart\"). (optional)
    upload_type = 'upload_type_example' # str | Legacy upload protocol for media (e.g. \"media\", \"multipart\"). (optional)
    google_analytics_admin_v1beta_search_change_history_events_request = openapi_client.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest() # GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest |  (optional)
 ...
 **upload_protocol** | **str**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **upload_type** | **str**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **google_analytics_admin_v1beta_search_change_history_events_request** | [**GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest**](GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest.md)|  | [optional] 
