...
class GoogleAnalyticsAdminV1betaListAccountsResponse(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[GoogleAnalyticsAdminV1betaAccount]] = Field(default=None, description="Results that were accessible to the caller.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [GoogleAnalyticsAdminV1betaAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
