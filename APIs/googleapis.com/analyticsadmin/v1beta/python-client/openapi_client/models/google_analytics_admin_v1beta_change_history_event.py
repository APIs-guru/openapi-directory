...
class GoogleAnalyticsAdminV1betaChangeHistoryEvent(BaseModel):
    ...
    changes: Optional[List[GoogleAnalyticsAdminV1betaChangeHistoryChange]] = Field(default=None, description="A list of changes made in this change history event that fit the filters specified in SearchChangeHistoryEventsRequest.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": [GoogleAnalyticsAdminV1betaChangeHistoryChange.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None,
