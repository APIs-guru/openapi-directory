...
class GoogleAnalyticsAdminV1betaListCustomDimensionsResponse(BaseModel):
    ...
    """ # noqa: E501
    custom_dimensions: Optional[List[GoogleAnalyticsAdminV1betaCustomDimension]] = Field(default=None, description="List of CustomDimensions.", alias="customDimensions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customDimensions": [GoogleAnalyticsAdminV1betaCustomDimension.from_dict(_item) for _item in obj["customDimensions"]] if obj.get("customDimensions") is not None else None,
