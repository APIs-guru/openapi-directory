...
class GoogleAnalyticsAdminV1betaRunAccessReportRequest(BaseModel):
    ...
    """ # noqa: E501
    date_ranges: Optional[List[GoogleAnalyticsAdminV1betaAccessDateRange]] = Field(default=None, description="Date ranges of access records to read. If multiple date ranges are requested, each response row will contain a zero based date range index. If two date ranges overlap, the access records for the overlapping days is included in the response rows for both date ranges. Requests are allowed up to 2 date ranges.", alias="dateRanges")
    dimension_filter: Optional[GoogleAnalyticsAdminV1betaAccessFilterExpression] = Field(default=None, alias="dimensionFilter")
    dimensions: Optional[List[GoogleAnalyticsAdminV1betaAccessDimension]] = Field(default=None, description="The dimensions requested and displayed in the response. Requests are allowed up to 9 dimensions.")
    ...
    metric_filter: Optional[GoogleAnalyticsAdminV1betaAccessFilterExpression] = Field(default=None, alias="metricFilter")
    metrics: Optional[List[GoogleAnalyticsAdminV1betaAccessMetric]] = Field(default=None, description="The metrics requested and displayed in the response. Requests are allowed up to 10 metrics.")
    ...
    order_bys: Optional[List[GoogleAnalyticsAdminV1betaAccessOrderBy]] = Field(default=None, description="Specifies how rows are ordered in the response.", alias="orderBys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dateRanges": [GoogleAnalyticsAdminV1betaAccessDateRange.from_dict(_item) for _item in obj["dateRanges"]] if obj.get("dateRanges") is not None else None,
            "dimensionFilter": GoogleAnalyticsAdminV1betaAccessFilterExpression.from_dict(obj["dimensionFilter"]) if obj.get("dimensionFilter") is not None else None,
            "dimensions": [GoogleAnalyticsAdminV1betaAccessDimension.from_dict(_item) for _item in obj["dimensions"]] if obj.get("dimensions") is not None else None,
            "expandGroups": obj.get("expandGroups"),
            "includeAllUsers": obj.get("includeAllUsers"),
            "limit": obj.get("limit"),
            "metricFilter": GoogleAnalyticsAdminV1betaAccessFilterExpression.from_dict(obj["metricFilter"]) if obj.get("metricFilter") is not None else None,
            "metrics": [GoogleAnalyticsAdminV1betaAccessMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "offset": obj.get("offset"),
            "orderBys": [GoogleAnalyticsAdminV1betaAccessOrderBy.from_dict(_item) for _item in obj["orderBys"]] if obj.get("orderBys") is not None else None,
