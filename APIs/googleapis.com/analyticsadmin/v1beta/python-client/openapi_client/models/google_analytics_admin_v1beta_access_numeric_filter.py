...
class GoogleAnalyticsAdminV1betaAccessNumericFilter(BaseModel):
    ...
    value: Optional[GoogleAnalyticsAdminV1betaNumericValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": GoogleAnalyticsAdminV1betaNumericValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
