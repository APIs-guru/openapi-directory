...
class GoogleAnalyticsAdminV1betaAccessFilter(BaseModel):
    ...
    """ # noqa: E501
    between_filter: Optional[GoogleAnalyticsAdminV1betaAccessBetweenFilter] = Field(default=None, alias="betweenFilter")
    field_name: Optional[StrictStr] = Field(default=None, description="The dimension name or metric name.", alias="fieldName")
    in_list_filter: Optional[GoogleAnalyticsAdminV1betaAccessInListFilter] = Field(default=None, alias="inListFilter")
    numeric_filter: Optional[GoogleAnalyticsAdminV1betaAccessNumericFilter] = Field(default=None, alias="numericFilter")
    string_filter: Optional[GoogleAnalyticsAdminV1betaAccessStringFilter] = Field(default=None, alias="stringFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "betweenFilter": GoogleAnalyticsAdminV1betaAccessBetweenFilter.from_dict(obj["betweenFilter"]) if obj.get("betweenFilter") is not None else None,
            "fieldName": obj.get("fieldName"),
            "inListFilter": GoogleAnalyticsAdminV1betaAccessInListFilter.from_dict(obj["inListFilter"]) if obj.get("inListFilter") is not None else None,
            "numericFilter": GoogleAnalyticsAdminV1betaAccessNumericFilter.from_dict(obj["numericFilter"]) if obj.get("numericFilter") is not None else None,
            "stringFilter": GoogleAnalyticsAdminV1betaAccessStringFilter.from_dict(obj["stringFilter"]) if obj.get("stringFilter") is not None else None
        })
        return _obj
