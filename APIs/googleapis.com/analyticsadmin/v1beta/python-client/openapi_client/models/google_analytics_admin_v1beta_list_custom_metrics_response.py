...
class GoogleAnalyticsAdminV1betaListCustomMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    custom_metrics: Optional[List[GoogleAnalyticsAdminV1betaCustomMetric]] = Field(default=None, description="List of CustomMetrics.", alias="customMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customMetrics": [GoogleAnalyticsAdminV1betaCustomMetric.from_dict(_item) for _item in obj["customMetrics"]] if obj.get("customMetrics") is not None else None,
