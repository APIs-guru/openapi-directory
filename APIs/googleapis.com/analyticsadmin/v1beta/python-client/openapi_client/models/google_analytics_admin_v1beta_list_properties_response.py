...
class GoogleAnalyticsAdminV1betaListPropertiesResponse(BaseModel):
    ...
    properties: Optional[List[GoogleAnalyticsAdminV1betaProperty]] = Field(default=None, description="Results that matched the filter criteria and were accessible to the caller.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [GoogleAnalyticsAdminV1betaProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
