...
class GoogleAnalyticsAdminV1betaAccessFilterExpressionList(BaseModel):
    ...
    """ # noqa: E501
    expressions: Optional[List[GoogleAnalyticsAdminV1betaAccessFilterExpression]] = Field(default=None, description="A list of filter expressions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "expressions": [GoogleAnalyticsAdminV1betaAccessFilterExpression.from_dict(_item) for _item in obj["expressions"]] if obj.get("expressions") is not None else None
        })
        return _obj
...
GoogleAnalyticsAdminV1betaAccessFilterExpressionList.model_rebuild(raise_errors=False)
