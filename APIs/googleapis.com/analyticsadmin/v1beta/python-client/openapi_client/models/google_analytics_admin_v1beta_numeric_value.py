...
class GoogleAnalyticsAdminV1betaNumericValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["doubleValue", "int64Value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleAnalyticsAdminV1betaNumericValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleAnalyticsAdminV1betaNumericValue from a dict"""
        if obj is None:
            return None
