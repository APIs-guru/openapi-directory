...
class GoogleAnalyticsAdminV1betaDataStream(BaseModel):
    ...
    """ # noqa: E501
    android_app_stream_data: Optional[GoogleAnalyticsAdminV1betaDataStreamAndroidAppStreamData] = Field(default=None, alias="androidAppStreamData")
    ...
    ios_app_stream_data: Optional[GoogleAnalyticsAdminV1betaDataStreamIosAppStreamData] = Field(default=None, alias="iosAppStreamData")
    ...
    web_stream_data: Optional[GoogleAnalyticsAdminV1betaDataStreamWebStreamData] = Field(default=None, alias="webStreamData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "androidAppStreamData": GoogleAnalyticsAdminV1betaDataStreamAndroidAppStreamData.from_dict(obj["androidAppStreamData"]) if obj.get("androidAppStreamData") is not None else None,
            "createTime": obj.get("createTime"),
            "displayName": obj.get("displayName"),
            "iosAppStreamData": GoogleAnalyticsAdminV1betaDataStreamIosAppStreamData.from_dict(obj["iosAppStreamData"]) if obj.get("iosAppStreamData") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type"),
            "updateTime": obj.get("updateTime"),
            "webStreamData": GoogleAnalyticsAdminV1betaDataStreamWebStreamData.from_dict(obj["webStreamData"]) if obj.get("webStreamData") is not None else None
        })
        return _obj
