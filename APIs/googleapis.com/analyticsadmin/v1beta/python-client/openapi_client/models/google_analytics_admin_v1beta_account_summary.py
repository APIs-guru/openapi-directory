...
class GoogleAnalyticsAdminV1betaAccountSummary(BaseModel):
    ...
    property_summaries: Optional[List[GoogleAnalyticsAdminV1betaPropertySummary]] = Field(default=None, description="List of summaries for child accounts of this account.", alias="propertySummaries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "propertySummaries": [GoogleAnalyticsAdminV1betaPropertySummary.from_dict(_item) for _item in obj["propertySummaries"]] if obj.get("propertySummaries") is not None else None
        })
        return _obj
