...
class TestSheetsChart(unittest.TestCase):
    """SheetsChart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SheetsChart:
        """Test SheetsChart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SheetsChart`
        """
        model = SheetsChart()
        if include_optional:
            return SheetsChart(
