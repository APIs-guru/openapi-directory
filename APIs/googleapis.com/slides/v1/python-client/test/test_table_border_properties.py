...
class TestTableBorderProperties(unittest.TestCase):
    """TableBorderProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableBorderProperties:
        """Test TableBorderProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableBorderProperties`
        """
        model = TableBorderProperties()
        if include_optional:
    ...
    def testTableBorderProperties(self):
        """Test TableBorderProperties"""
