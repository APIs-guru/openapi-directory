...
class TestSolidFill(unittest.TestCase):
    """SolidFill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolidFill:
        """Test SolidFill
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SolidFill`
        """
        model = SolidFill()
        if include_optional:
            return SolidFill(
