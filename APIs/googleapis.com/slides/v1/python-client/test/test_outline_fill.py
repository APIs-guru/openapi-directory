...
class TestOutlineFill(unittest.TestCase):
    """OutlineFill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutlineFill:
        """Test OutlineFill
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutlineFill`
        """
        model = OutlineFill()
        if include_optional:
            return OutlineFill(
