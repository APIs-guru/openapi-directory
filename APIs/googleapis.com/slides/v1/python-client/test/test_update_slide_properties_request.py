...
class TestUpdateSlidePropertiesRequest(unittest.TestCase):
    """UpdateSlidePropertiesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSlidePropertiesRequest:
        """Test UpdateSlidePropertiesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSlidePropertiesRequest`
        """
        model = UpdateSlidePropertiesRequest()
        if include_optional:
    ...
    def testUpdateSlidePropertiesRequest(self):
        """Test UpdateSlidePropertiesRequest"""
