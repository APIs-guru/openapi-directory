...
class TestSlideProperties(unittest.TestCase):
    """SlideProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlideProperties:
        """Test SlideProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlideProperties`
        """
        model = SlideProperties()
        if include_optional:
