...
class TestPageBackgroundFill(unittest.TestCase):
    """PageBackgroundFill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBackgroundFill:
        """Test PageBackgroundFill
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBackgroundFill`
        """
        model = PageBackgroundFill()
        if include_optional:
    ...
    def testPageBackgroundFill(self):
        """Test PageBackgroundFill"""
