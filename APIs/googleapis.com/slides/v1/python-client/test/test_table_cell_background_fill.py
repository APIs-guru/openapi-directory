...
class TestTableCellBackgroundFill(unittest.TestCase):
    """TableCellBackgroundFill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableCellBackgroundFill:
        """Test TableCellBackgroundFill
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableCellBackgroundFill`
        """
        model = TableCellBackgroundFill()
        if include_optional:
    ...
    def testTableCellBackgroundFill(self):
        """Test TableCellBackgroundFill"""
