...
class PageElementProperties(BaseModel):
    ...
    """ # noqa: E501
    page_object_id: Optional[StrictStr] = Field(default=None, description="The object ID of the page where the element is located.", alias="pageObjectId")
    size: Optional[Size] = None
    transform: Optional[AffineTransform] = None
    __properties: ClassVar[List[str]] = ["pageObjectId", "size", "transform"]
