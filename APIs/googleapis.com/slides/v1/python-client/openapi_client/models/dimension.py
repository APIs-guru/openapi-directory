...
class Dimension(BaseModel):
    ...
    """ # noqa: E501
    magnitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The magnitude.")
    unit: Optional[StrictStr] = Field(default=None, description="The units for magnitude.")
    __properties: ClassVar[List[str]] = ["magnitude", "unit"]
