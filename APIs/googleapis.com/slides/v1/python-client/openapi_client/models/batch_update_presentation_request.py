...
class BatchUpdatePresentationRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[Request]] = Field(default=None, description="A list of updates to apply to the presentation.")
    write_control: Optional[WriteControl] = Field(default=None, alias="writeControl")
    __properties: ClassVar[List[str]] = ["requests", "writeControl"]
