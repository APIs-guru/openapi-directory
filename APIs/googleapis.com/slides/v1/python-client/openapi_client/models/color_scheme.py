...
class ColorScheme(BaseModel):
    ...
    """ # noqa: E501
    colors: Optional[List[ThemeColorPair]] = Field(default=None, description="The ThemeColorType and corresponding concrete color pairs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "colors": [ThemeColorPair.from_dict(_item) for _item in obj["colors"]] if obj.get("colors") is not None else None
        })
        return _obj
