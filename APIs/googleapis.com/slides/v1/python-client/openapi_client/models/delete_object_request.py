...
class DeleteObjectRequest(BaseModel):
    ...
    """ # noqa: E501
    object_id: Optional[StrictStr] = Field(default=None, description="The object ID of the page or page element to delete. If after a delete operation a group contains only 1 or no page elements, the group is also deleted. If a placeholder is deleted on a layout, any empty inheriting placeholders are also deleted.", alias="objectId")
