...
class TestGoogleCloudDatapipelinesV1Pipeline(unittest.TestCase):
    """GoogleCloudDatapipelinesV1Pipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleCloudDatapipelinesV1Pipeline:
        """Test GoogleCloudDatapipelinesV1Pipeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleCloudDatapipelinesV1Pipeline`
        """
        model = GoogleCloudDatapipelinesV1Pipeline()
        if include_optional:
    ...
    def testGoogleCloudDatapipelinesV1Pipeline(self):
        """Test GoogleCloudDatapipelinesV1Pipeline"""
