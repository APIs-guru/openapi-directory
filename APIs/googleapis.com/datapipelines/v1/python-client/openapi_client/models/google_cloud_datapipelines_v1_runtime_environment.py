...
class GoogleCloudDatapipelinesV1RuntimeEnvironment(BaseModel):
    ...
    additional_user_labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions) page. An object containing a list of key/value pairs. Example: { \"name\": \"wrench\", \"mass\": \"1kg\", \"count\": \"3\" }.", alias="additionalUserLabels")
    bypass_temp_dir_validation: Optional[StrictBool] = Field(default=None, description="Whether to bypass the safety checks for the job's temporary directory. Use with caution.", alias="bypassTempDirValidation")
    ...
    kms_key_name: Optional[StrictStr] = Field(default=None, description="Name for the Cloud KMS key for the job. The key format is: projects//locations//keyRings//cryptoKeys/", alias="kmsKeyName")
    ...
    __properties: ClassVar[List[str]] = ["additionalExperiments", "additionalUserLabels", "bypassTempDirValidation", "enableStreamingEngine", "ipConfiguration", "kmsKeyName", "machineType", "maxWorkers", "network", "numWorkers", "serviceAccountEmail", "subnetwork", "tempLocation", "workerRegion", "workerZone", "zone"]
