...
class TestGoogleMapsPlacesV1SearchNearbyResponse(unittest.TestCase):
    """GoogleMapsPlacesV1SearchNearbyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleMapsPlacesV1SearchNearbyResponse:
        """Test GoogleMapsPlacesV1SearchNearbyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleMapsPlacesV1SearchNearbyResponse`
        """
        model = GoogleMapsPlacesV1SearchNearbyResponse()
        if include_optional:
            return GoogleMapsPlacesV1SearchNearbyResponse(
                places = [
                    openapi_client.models.google_maps_places_v1_place.GoogleMapsPlacesV1Place(
    ...
    def testGoogleMapsPlacesV1SearchNearbyResponse(self):
        """Test GoogleMapsPlacesV1SearchNearbyResponse"""
