...
class GoogleMapsPlacesV1AutocompletePlacesResponse(BaseModel):
    ...
    """ # noqa: E501
    suggestions: Optional[List[GoogleMapsPlacesV1AutocompletePlacesResponseSuggestion]] = Field(default=None, description="Contains a list of suggestions, ordered in descending order of relevance.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suggestions": [GoogleMapsPlacesV1AutocompletePlacesResponseSuggestion.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None
        })
        return _obj
