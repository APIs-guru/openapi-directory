...
class GoogleMapsPlacesV1SearchNearbyResponse(BaseModel):
    ...
    """ # noqa: E501
    places: Optional[List[GoogleMapsPlacesV1Place]] = Field(default=None, description="A list of places that meets user's requirements like places types, number of places and specific location restriction.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "places": [GoogleMapsPlacesV1Place.from_dict(_item) for _item in obj["places"]] if obj.get("places") is not None else None
        })
        return _obj
