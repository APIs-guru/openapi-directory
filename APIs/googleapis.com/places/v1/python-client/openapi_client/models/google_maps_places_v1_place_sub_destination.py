...
class GoogleMapsPlacesV1PlaceSubDestination(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The place id of the sub destination.")
    name: Optional[StrictStr] = Field(default=None, description="The resource name of the sub destination.")
