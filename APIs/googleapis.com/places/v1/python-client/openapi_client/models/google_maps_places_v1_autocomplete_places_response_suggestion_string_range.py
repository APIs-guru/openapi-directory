...
class GoogleMapsPlacesV1AutocompletePlacesResponseSuggestionStringRange(BaseModel):
    ...
    """ # noqa: E501
    end_offset: Optional[StrictInt] = Field(default=None, description="Zero-based offset of the last Unicode character (exclusive).", alias="endOffset")
    start_offset: Optional[StrictInt] = Field(default=None, description="Zero-based offset of the first Unicode character of the string (inclusive).", alias="startOffset")
