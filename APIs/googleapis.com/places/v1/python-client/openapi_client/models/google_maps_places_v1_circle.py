...
class GoogleMapsPlacesV1Circle(BaseModel):
    ...
    """ # noqa: E501
    center: Optional[GoogleTypeLatLng] = None
    radius: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Required. Radius measured in meters. The radius must be within [0.0, 50000.0].")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "center": GoogleTypeLatLng.from_dict(obj["center"]) if obj.get("center") is not None else None,
