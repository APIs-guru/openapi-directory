...
class TestV1Beta1ListConsumerQuotaMetricsResponse(unittest.TestCase):
    """V1Beta1ListConsumerQuotaMetricsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1Beta1ListConsumerQuotaMetricsResponse:
        """Test V1Beta1ListConsumerQuotaMetricsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1Beta1ListConsumerQuotaMetricsResponse`
        """
        model = V1Beta1ListConsumerQuotaMetricsResponse()
        if include_optional:
            return V1Beta1ListConsumerQuotaMetricsResponse(
                metrics = [
                    openapi_client.models.v1_beta1_consumer_quota_metric.V1Beta1ConsumerQuotaMetric(
    ...
    def testV1Beta1ListConsumerQuotaMetricsResponse(self):
        """Test V1Beta1ListConsumerQuotaMetricsResponse"""
