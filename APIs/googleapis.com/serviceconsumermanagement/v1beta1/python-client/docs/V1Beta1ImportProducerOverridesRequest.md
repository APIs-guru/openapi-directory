...
**inline_source** | [**V1Beta1OverrideInlineSource**](V1Beta1OverrideInlineSource.md) |  | [optional] 
...
json = "{}"
# create an instance of V1Beta1ImportProducerOverridesRequest from a JSON string
v1_beta1_import_producer_overrides_request_instance = V1Beta1ImportProducerOverridesRequest.from_json(json)
# print the JSON string representation of the object
print(V1Beta1ImportProducerOverridesRequest.to_json())

# convert the object into a dict
v1_beta1_import_producer_overrides_request_dict = v1_beta1_import_producer_overrides_request_instance.to_dict()
# create an instance of V1Beta1ImportProducerOverridesRequest from a dict
v1_beta1_import_producer_overrides_request_from_dict = V1Beta1ImportProducerOverridesRequest.from_dict(v1_beta1_import_producer_overrides_request_dict)
```
