...
v1beta1_default_identity_instance = V1beta1DefaultIdentity.from_json(json)
# print the JSON string representation of the object
print(V1beta1DefaultIdentity.to_json())

# convert the object into a dict
v1beta1_default_identity_dict = v1beta1_default_identity_instance.to_dict()
# create an instance of V1beta1DefaultIdentity from a dict
v1beta1_default_identity_from_dict = V1beta1DefaultIdentity.from_dict(v1beta1_default_identity_dict)
```
