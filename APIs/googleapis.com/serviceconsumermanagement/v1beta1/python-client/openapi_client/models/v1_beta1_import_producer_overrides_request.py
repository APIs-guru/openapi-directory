...
class V1Beta1ImportProducerOverridesRequest(BaseModel):
    ...
    inline_source: Optional[V1Beta1OverrideInlineSource] = Field(default=None, alias="inlineSource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inlineSource": V1Beta1OverrideInlineSource.from_dict(obj["inlineSource"]) if obj.get("inlineSource") is not None else None
        })
        return _obj
