...
class V1Beta1BatchCreateProducerOverridesResponse(BaseModel):
    """
    Response message for BatchCreateProducerOverrides
    """ # noqa: E501
    overrides: Optional[List[V1Beta1QuotaOverride]] = Field(default=None, description="The overrides that were created.")
