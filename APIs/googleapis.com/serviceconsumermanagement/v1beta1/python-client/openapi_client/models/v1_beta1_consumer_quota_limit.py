...
class V1Beta1ConsumerQuotaLimit(BaseModel):
    ...
    quota_buckets: Optional[List[V1Beta1QuotaBucket]] = Field(default=None, description="Summary of the enforced quota buckets, organized by quota dimension, ordered from least specific to most specific (for example, the global default bucket, with no quota dimensions, will always appear first).", alias="quotaBuckets")
    ...
    __properties: ClassVar[List[str]] = ["isPrecise", "metric", "name", "quotaBuckets", "supportedLocations", "unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "quotaBuckets": [V1Beta1QuotaBucket.from_dict(_item) for _item in obj["quotaBuckets"]] if obj.get("quotaBuckets") is not None else None,
