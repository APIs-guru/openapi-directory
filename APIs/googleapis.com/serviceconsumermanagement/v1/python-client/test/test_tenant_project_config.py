...
class TestTenantProjectConfig(unittest.TestCase):
    """TenantProjectConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantProjectConfig:
        """Test TenantProjectConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantProjectConfig`
        """
        model = TenantProjectConfig()
        if include_optional:
    ...
    def testTenantProjectConfig(self):
        """Test TenantProjectConfig"""
