...
class BillingConfig(BaseModel):
    ...
    """ # noqa: E501
    billing_account: Optional[StrictStr] = Field(default=None, description="Name of the billing account. For example `billingAccounts/012345-567890-ABCDEF`.", alias="billingAccount")
