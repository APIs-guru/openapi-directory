...
class TenantProjectPolicy(BaseModel):
    """
    Describes policy settings that can be applied to a newly created tenant project.
    """ # noqa: E501
    policy_bindings: Optional[List[PolicyBinding]] = Field(default=None, description="Policy bindings to be applied to the tenant project, in addition to the 'roles/owner' role granted to the Service Consumer Management service account.", alias="policyBindings")
    __properties: ClassVar[List[str]] = ["policyBindings"]
