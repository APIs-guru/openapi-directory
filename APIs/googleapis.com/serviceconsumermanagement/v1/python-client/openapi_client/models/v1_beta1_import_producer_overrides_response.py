...
class V1Beta1ImportProducerOverridesResponse(BaseModel):
    """
    Response message for ImportProducerOverrides
    """ # noqa: E501
    overrides: Optional[List[V1Beta1QuotaOverride]] = Field(default=None, description="The overrides that were created from the imported data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overrides": [V1Beta1QuotaOverride.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
