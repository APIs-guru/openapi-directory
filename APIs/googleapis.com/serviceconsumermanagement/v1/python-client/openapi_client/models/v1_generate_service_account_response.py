...
class V1GenerateServiceAccountResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    account: Optional[V1ServiceAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": V1ServiceAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
