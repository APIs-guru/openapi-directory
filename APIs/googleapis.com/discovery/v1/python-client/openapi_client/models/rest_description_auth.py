...
class RestDescriptionAuth(BaseModel):
    """
    Authentication information.
    """ # noqa: E501
    oauth2: Optional[RestDescriptionAuthOauth2] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oauth2": RestDescriptionAuthOauth2.from_dict(obj["oauth2"]) if obj.get("oauth2") is not None else None
        })
        return _obj
