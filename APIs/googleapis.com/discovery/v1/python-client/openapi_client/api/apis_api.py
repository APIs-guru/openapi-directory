...
class ApisApi:
    ...
    def discovery_apis_get_rest(
        self,
        api: Annotated[StrictStr, Field(description="The name of the API.")],
        version: Annotated[StrictStr, Field(description="The version of the API.")],
        ...
        _param = self._discovery_apis_get_rest_serialize(
            api=api,
            version=version,
            alt=alt,
            fields=fields,
    ...
    @validate_call
    def discovery_apis_get_rest_with_http_info(
        self,
        api: Annotated[StrictStr, Field(description="The name of the API.")],
        version: Annotated[StrictStr, Field(description="The version of the API.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    @validate_call
    def discovery_apis_get_rest_without_preload_content(
        self,
        api: Annotated[StrictStr, Field(description="The name of the API.")],
        version: Annotated[StrictStr, Field(description="The version of the API.")],
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
    ...
    def _discovery_apis_get_rest_serialize(
        self,
        api,
        version,
        alt,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/{api}/{version}/rest',
    ...
    def discovery_apis_list(
        ...
        quota_user: Annotated[Optional[StrictStr], Field(description="An opaque string that represents a user for quota purposes. Must not exceed 40 characters.")] = None,
        user_ip: Annotated[Optional[StrictStr], Field(description="Deprecated. Please use quotaUser instead.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Only include APIs with the given name.")] = None,
        preferred: Annotated[Optional[StrictBool], Field(description="Return only the preferred version of an API.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._discovery_apis_list_serialize(
            alt=alt,
            fields=fields,
            key=key,
            oauth_token=oauth_token,
    ...
    @validate_call
    def discovery_apis_list_with_http_info(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def discovery_apis_list_without_preload_content(
        self,
        alt: Annotated[Optional[StrictStr], Field(description="Data format for the response.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Selector specifying which fields to include in a partial response.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _discovery_apis_list_serialize(
        self,
        alt,
        fields,
        key,
