...
class TopicPartitions(BaseModel):
    ...
    """ # noqa: E501
    partition_count: Optional[StrictStr] = Field(default=None, description="The number of partitions in the topic.", alias="partitionCount")
    __properties: ClassVar[List[str]] = ["partitionCount"]
