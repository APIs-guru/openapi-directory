...
class ListSubscriptionsResponse(BaseModel):
    ...
    subscriptions: Optional[List[Subscription]] = Field(default=None, description="The list of subscriptions in the requested parent. The order of the subscriptions is unspecified.")
