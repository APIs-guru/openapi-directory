...
class TestUserCollectionItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserCollectionItem:
        """Test UserCollectionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCollectionItem`
        """
        ...
        if include_optional:
            return UserCollectionItem(
                ...
                created_on = '',
                email = '0',
                failed_login_count = 56,
                first_name = '',
                last_login = '',
                last_name = '',
                login_count = 56,
                roles = [
                    openapi_client.models.user_collection_item_roles_inner.UserCollectionItem_roles_inner(
                        name = '', )
                    ],
                username = '0'
            )
