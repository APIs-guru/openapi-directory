...
class TestTask(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Task:
        ...
        if include_optional:
            return Task(
                class_ref = openapi_client.models.class_reference.ClassReference(
                    class_name = '', 
                    module_path = '', ),
                ...
                execution_timeout = openapi_client.models.time_delta.TimeDelta(
                    __type = '', 
                    days = 56, 
                    microseconds = 56, 
                    seconds = 56, ),
                extra_links = [
                    openapi_client.models.task_extra_links_inner.Task_extra_links_inner(
                        class_ref = openapi_client.models.class_reference.ClassReference(
                            class_name = '', 
                            module_path = '', ), )
                    ],
                ...
                queue = '',
                retries = 1.337,
                retry_delay = openapi_client.models.time_delta.TimeDelta(
                    __type = '', 
                    days = 56, 
                    microseconds = 56, 
                    seconds = 56, ),
                ...
                sub_dag = openapi_client.models.dag.DAG(
                    dag_id = '', 
                    default_view = '', 
                    description = '', 
                    file_token = '', 
