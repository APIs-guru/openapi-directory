...
class TestDatasetCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatasetCollection:
            ...
            return DatasetCollection(
                ...
                datasets = [
                    openapi_client.models.dataset.Dataset(
                        consuming_dags = [
                            openapi_client.models.dag_schedule_dataset_reference.DagScheduleDatasetReference(
                                created_at = '', 
                                dag_id = '', 
                                updated_at = '', )
                            ], 
                        ...
                        id = 56, 
                        producing_tasks = [
                            openapi_client.models.task_outlet_dataset_reference.TaskOutletDatasetReference(
                                created_at = '', 
                                dag_id = '', 
                                task_id = '', 
                                updated_at = '', )
