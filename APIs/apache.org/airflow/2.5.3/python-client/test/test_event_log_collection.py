...
class TestEventLogCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventLogCollection:
        """Test EventLogCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventLogCollection`
        """
        ...
        if include_optional:
            return EventLogCollection(
                total_entries = 56,
                event_logs = [
                    openapi_client.models.event_log.EventLog(
                        dag_id = '', 
                        event = '', 
                        event_log_id = 56, 
