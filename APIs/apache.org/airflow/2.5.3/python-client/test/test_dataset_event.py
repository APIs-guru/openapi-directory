...
class TestDatasetEvent(unittest.TestCase):
    """DatasetEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatasetEvent:
        """Test DatasetEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetEvent`
        """
        model = DatasetEvent()
        if include_optional:
            return DatasetEvent(
                created_dagruns = [
                    openapi_client.models.basic_dag_run.BasicDAGRun(
                        dag_id = '', 
