...
class TestUpdateTaskInstancesState(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateTaskInstancesState:
        """Test UpdateTaskInstancesState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTaskInstancesState`
        """
        model = UpdateTaskInstancesState()
        if include_optional:
