...
class TestExtraLinkCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExtraLinkCollection:
        """Test ExtraLinkCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraLinkCollection`
        """
        model = ExtraLinkCollection()
        if include_optional:
            return ExtraLinkCollection(
                extra_links = [
                    openapi_client.models.extra_link.ExtraLink(
