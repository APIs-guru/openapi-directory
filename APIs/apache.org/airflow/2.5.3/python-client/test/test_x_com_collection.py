...
class TestXComCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> XComCollection:
        """Test XComCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XComCollection`
        """
        ...
        if include_optional:
            return XComCollection(
                total_entries = 56,
                xcom_entries = [
                    openapi_client.models.x_com_collection_item.XComCollectionItem(
                        dag_id = '', 
                        execution_date = '', 
                        key = '', 
                        task_id = '', 
