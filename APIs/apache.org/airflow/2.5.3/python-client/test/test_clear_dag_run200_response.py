...
class TestClearDagRun200Response(unittest.TestCase):
    """ClearDagRun200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClearDagRun200Response:
        """Test ClearDagRun200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClearDagRun200Response`
        """
        model = ClearDagRun200Response()
        if include_optional:
            return ClearDagRun200Response(
                conf = openapi_client.models.conf.conf(),
                dag_id = '',
                dag_run_id = '',
                ...
                state = 'queued',
                task_instances = [
                    openapi_client.models.task_instance.TaskInstance(
                        dag_id = '', 
                        dag_run_id = '', 
                        duration = 1.337, 
                        end_date = '', 
                        ...
                        queue = '', 
                        queued_when = '', 
                        rendered_fields = openapi_client.models.rendered_fields.rendered_fields(), 
                        sla_miss = openapi_client.models.sla_miss.SLAMiss(
                            dag_id = '', 
                            description = '', 
                            email_sent = True, 
                            execution_date = '', 
                        ...
                        trigger = openapi_client.models.trigger.Trigger(
                            ...
                            kwargs = '', 
                            triggerer_id = 56, ), 
                        triggerer_job = openapi_client.models.job.Job(
                            dag_id = '', 
                            end_date = '', 
                            executor_class = '', 
                            hostname = '', 
    ...
    def testClearDagRun200Response(self):
        """Test ClearDagRun200Response"""
