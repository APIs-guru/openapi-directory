...
class TestDAGCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DAGCollection:
        """Test DAGCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DAGCollection`
        """
        model = DAGCollection()
        if include_optional:
            return DAGCollection(
                ...
                dags = [
                    openapi_client.models.dag.DAG(
                        ...
                        last_pickled = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        max_active_runs = 56, 
                        max_active_tasks = 56, 
                        next_dagrun = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        next_dagrun_create_after = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
