...
class TestPluginCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PluginCollection:
        """Test PluginCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginCollection`
        """
        ...
        if include_optional:
            return PluginCollection(
                total_entries = 56,
                plugins = [
                    openapi_client.models.plugin_collection_item.PluginCollectionItem(
