...
class TestDAGRunApi(unittest.TestCase):
    ...
    def test_get_dag_runs_batch(self) -> None:
    ...
    def test_get_upstream_dataset_events(self) -> None:
    ...
    def test_post_dag_run(self) -> None:
    ...
    def test_set_dag_run_note(self) -> None:
    ...
    def test_update_dag_run_state(self) -> None:
