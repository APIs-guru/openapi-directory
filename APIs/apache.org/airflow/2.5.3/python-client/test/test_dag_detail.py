...
class TestDAGDetail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DAGDetail:
        """Test DAGDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DAGDetail`
        """
        model = DAGDetail()
        if include_optional:
            return DAGDetail(
                ...
                catchup = True,
                concurrency = 1.337,
                dag_run_timeout = openapi_client.models.time_delta.TimeDelta(
                    __type = '', 
                    days = 56, 
                    microseconds = 56, 
                    seconds = 56, ),
