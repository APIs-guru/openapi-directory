...
class TestDatasetEventCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatasetEventCollection:
        """Test DatasetEventCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetEventCollection`
        """
        ...
        if include_optional:
            return DatasetEventCollection(
                total_entries = 56,
                dataset_events = [
                    openapi_client.models.dataset_event.DatasetEvent(
                        created_dagruns = [
