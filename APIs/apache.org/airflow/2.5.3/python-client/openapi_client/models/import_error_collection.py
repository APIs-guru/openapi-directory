...
class ImportErrorCollection(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total_entries", "import_errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "import_errors": [ImportError.from_dict(_item) for _item in obj["import_errors"]] if obj.get("import_errors") is not None else None
        })
        return _obj
