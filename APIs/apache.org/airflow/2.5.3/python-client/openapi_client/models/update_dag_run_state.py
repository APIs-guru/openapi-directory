...
class UpdateDagRunState(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="The state to set this DagRun")
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['success', 'failed', 'queued']):
            raise ValueError("must be one of enum values ('success', 'failed', 'queued')")
        return value
