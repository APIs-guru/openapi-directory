...
class VersionInfo(BaseModel):
    ...
    Version information.
    """ # noqa: E501
    git_version: Optional[StrictStr] = Field(default=None, description="The git version (including git commit hash)")
    version: Optional[StrictStr] = Field(default=None, description="The version of Airflow")
