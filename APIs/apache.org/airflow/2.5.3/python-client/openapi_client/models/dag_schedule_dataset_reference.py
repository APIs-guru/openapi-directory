...
class DagScheduleDatasetReference(BaseModel):
    ...
    """ # noqa: E501
    created_at: Optional[StrictStr] = Field(default=None, description="The dataset reference creation time")
    dag_id: Optional[StrictStr] = Field(default=None, description="The DAG ID that depends on the dataset.")
    updated_at: Optional[StrictStr] = Field(default=None, description="The dataset reference update time")
