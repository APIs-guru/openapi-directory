...
class Dataset(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(default=None, description="The dataset creation time")
    extra: Optional[Dict[str, Any]] = Field(default=None, description="The dataset extra")
    id: Optional[StrictInt] = Field(default=None, description="The dataset id")
    producing_tasks: Optional[List[TaskOutletDatasetReference]] = None
    updated_at: Optional[StrictStr] = Field(default=None, description="The dataset update time")
    uri: Optional[StrictStr] = Field(default=None, description="The dataset uri")
    __properties: ClassVar[List[str]] = ["consuming_dags", "created_at", "extra", "id", "producing_tasks", "updated_at", "uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consuming_dags": [DagScheduleDatasetReference.from_dict(_item) for _item in obj["consuming_dags"]] if obj.get("consuming_dags") is not None else None,
            "created_at": obj.get("created_at"),
            "extra": obj.get("extra"),
            "id": obj.get("id"),
            "producing_tasks": [TaskOutletDatasetReference.from_dict(_item) for _item in obj["producing_tasks"]] if obj.get("producing_tasks") is not None else None,
