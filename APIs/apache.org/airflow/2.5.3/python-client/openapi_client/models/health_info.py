...
class HealthInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadatabase", "scheduler"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadatabase": MetadatabaseStatus.from_dict(obj["metadatabase"]) if obj.get("metadatabase") is not None else None,
            "scheduler": SchedulerStatus.from_dict(obj["scheduler"]) if obj.get("scheduler") is not None else None
        })
        return _obj
