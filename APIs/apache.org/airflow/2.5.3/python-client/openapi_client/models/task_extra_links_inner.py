...
class TaskExtraLinksInner(BaseModel):
    """
    TaskExtraLinksInner
    """ # noqa: E501
    class_ref: Optional[ClassReference] = None
    __properties: ClassVar[List[str]] = ["class_ref"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskExtraLinksInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskExtraLinksInner from a dict"""
        if obj is None:
            return None
