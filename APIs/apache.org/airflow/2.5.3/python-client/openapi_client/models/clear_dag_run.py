...
class ClearDagRun(BaseModel):
    ...
    ClearDagRun
    """ # noqa: E501
    dry_run: Optional[StrictBool] = Field(default=True, description="If set, don't actually run this operation. The response will contain a list of task instances planned to be cleaned, but not modified in any way. ")
