...
class EventLogCollection(BaseModel):
    """
    Collection of event logs.  *Changed in version 2.1.0*&#58; 'total_entries' field is added. 
    """ # noqa: E501
    total_entries: Optional[StrictInt] = Field(default=None, description="Count of total objects in the current result set before pagination parameters (limit, offset) are applied. ")
    event_logs: Optional[List[EventLog]] = None
    __properties: ClassVar[List[str]] = ["total_entries", "event_logs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event_logs": [EventLog.from_dict(_item) for _item in obj["event_logs"]] if obj.get("event_logs") is not None else None
        })
        return _obj
