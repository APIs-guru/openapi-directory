...
class DAGRun(BaseModel):
    ...
    external_trigger: Optional[StrictBool] = True
    ...
    __properties: ClassVar[List[str]] = ["conf", "dag_id", "dag_run_id", "data_interval_end", "data_interval_start", "end_date", "execution_date", "external_trigger", "last_scheduling_decision", "logical_date", "note", "run_type", "start_date", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_trigger": obj.get("external_trigger") if obj.get("external_trigger") is not None else True,
