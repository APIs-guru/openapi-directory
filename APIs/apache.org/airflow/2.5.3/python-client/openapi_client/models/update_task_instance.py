...
class UpdateTaskInstance(BaseModel):
    ...
    UpdateTaskInstance
    """ # noqa: E501
    dry_run: Optional[StrictBool] = Field(default=False, description="If set, don't actually run this operation. The response will contain the task instance planned to be affected, but won't be modified in any way. ")
    new_state: Optional[StrictStr] = Field(default=None, description="Expected new state.")
    __properties: ClassVar[List[str]] = ["dry_run", "new_state"]
