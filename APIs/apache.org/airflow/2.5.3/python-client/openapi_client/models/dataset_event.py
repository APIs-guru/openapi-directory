...
class DatasetEvent(BaseModel):
    ...
    dataset_id: Optional[StrictInt] = Field(default=None, description="The dataset id")
    dataset_uri: Optional[StrictStr] = Field(default=None, description="The URI of the dataset")
    extra: Optional[Dict[str, Any]] = Field(default=None, description="The dataset event extra")
    source_dag_id: Optional[StrictStr] = Field(default=None, description="The DAG ID that updated the dataset.")
    source_map_index: Optional[StrictInt] = Field(default=None, description="The task map index that updated the dataset.")
    source_run_id: Optional[StrictStr] = Field(default=None, description="The DAG run ID that updated the dataset.")
    source_task_id: Optional[StrictStr] = Field(default=None, description="The task ID that updated the dataset.")
    timestamp: Optional[StrictStr] = Field(default=None, description="The dataset event creation time")
    __properties: ClassVar[List[str]] = ["created_dagruns", "dataset_id", "dataset_uri", "extra", "source_dag_id", "source_map_index", "source_run_id", "source_task_id", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if source_map_index (nullable) is None
        # and model_fields_set contains the field
        if self.source_map_index is None and "source_map_index" in self.model_fields_set:
            _dict['source_map_index'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "created_dagruns": [BasicDAGRun.from_dict(_item) for _item in obj["created_dagruns"]] if obj.get("created_dagruns") is not None else None,
            "dataset_id": obj.get("dataset_id"),
            "dataset_uri": obj.get("dataset_uri"),
            "extra": obj.get("extra"),
