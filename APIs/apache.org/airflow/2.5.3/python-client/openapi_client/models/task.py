...
class Task(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["class_ref", "depends_on_past", "downstream_task_ids", "end_date", "execution_timeout", "extra_links", "is_mapped", "owner", "pool", "pool_slots", "priority_weight", "queue", "retries", "retry_delay", "retry_exponential_backoff", "start_date", "sub_dag", "task_id", "template_fields", "trigger_rule", "ui_color", "ui_fgcolor", "wait_for_downstream", "weight_rule"]
