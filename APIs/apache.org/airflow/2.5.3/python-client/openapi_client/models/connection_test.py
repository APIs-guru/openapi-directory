...
class ConnectionTest(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The success or failure message of the request.")
    status: Optional[StrictBool] = Field(default=None, description="The status of the request.")
