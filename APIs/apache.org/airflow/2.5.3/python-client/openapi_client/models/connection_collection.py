...
class ConnectionCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total_entries", "connections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connections": [ConnectionCollectionItem.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
