...
class TaskOutletDatasetReference(BaseModel):
    ...
    dag_id: Optional[StrictStr] = Field(default=None, description="The DAG ID that updates the dataset.")
    task_id: Optional[StrictStr] = Field(default=None, description="The task ID that updates the dataset.")
