...
class PluginCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total_entries", "plugins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugins": [PluginCollectionItem.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None
        })
        return _obj
