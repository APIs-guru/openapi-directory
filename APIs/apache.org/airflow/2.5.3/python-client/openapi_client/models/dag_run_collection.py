...
class DAGRunCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total_entries", "dag_runs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dag_runs": [DAGRun.from_dict(_item) for _item in obj["dag_runs"]] if obj.get("dag_runs") is not None else None
        })
        return _obj
