...
class DatasetApi:
    ...
    def get_dataset_events(
        ...
        dataset_id: Annotated[Optional[StrictInt], Field(description="The Dataset ID that updated the dataset.")] = None,
        source_dag_id: Annotated[Optional[StrictStr], Field(description="The DAG ID that updated the dataset.")] = None,
        source_task_id: Annotated[Optional[StrictStr], Field(description="The task ID that updated the dataset.")] = None,
        source_run_id: Annotated[Optional[StrictStr], Field(description="The DAG run ID that updated the dataset.")] = None,
        source_map_index: Annotated[Optional[StrictInt], Field(description="The map index that updated the dataset.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_dataset_events_serialize(
            limit=limit,
            offset=offset,
            order_by=order_by,
    ...
    def _get_dataset_events_serialize(
        self,
        limit,
        offset,
        order_by,
    ...
    def get_datasets(
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0* ")] = None,
        uri_pattern: Annotated[Optional[StrictStr], Field(description="If set, only return datasets with uris matching this pattern. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_upstream_dataset_events_0(
        self,
        ...
        _param = self._get_upstream_dataset_events_0_serialize(
            dag_id=dag_id,
    ...
    @validate_call
    def get_upstream_dataset_events_0_with_http_info(
        self,
        dag_id: Annotated[StrictStr, Field(description="The DAG ID.")],
        dag_run_id: Annotated[StrictStr, Field(description="The DAG run ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_upstream_dataset_events_0_without_preload_content(
        self,
        dag_id: Annotated[StrictStr, Field(description="The DAG ID.")],
        dag_run_id: Annotated[StrictStr, Field(description="The DAG run ID.")],
        _request_timeout: Union[
    ...
    def _get_upstream_dataset_events_0_serialize(
        self,
        dag_id,
        dag_run_id,
        _request_auth,
