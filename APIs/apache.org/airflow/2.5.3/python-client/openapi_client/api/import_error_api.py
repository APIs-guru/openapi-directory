...
class ImportErrorApi:
    ...
    def get_import_error(
        ...
        :param import_error_id: The import error ID. (required)
    ...
    def _get_import_error_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/importErrors/{import_error_id}',
    ...
    def get_import_errors_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImportErrorCollection]:
        """List import errors
