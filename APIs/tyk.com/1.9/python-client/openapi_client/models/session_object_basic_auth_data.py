...
class SessionObjectBasicAuthData(BaseModel):
    """
    SessionObjectBasicAuthData
    """ # noqa: E501
    hash_type: Optional[StrictStr] = None
    password: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hash_type", "password"]
    ...
    def hash_type_validate_enum(cls, value):
        ...
        if value not in set(['', 'bcrypt']):
            raise ValueError("must be one of enum values ('', 'bcrypt')")
        return value
