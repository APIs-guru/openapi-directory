...
class TestAPIDefinitionVersionData(unittest.TestCase):
    """APIDefinitionVersionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> APIDefinitionVersionData:
        """Test APIDefinitionVersionData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `APIDefinitionVersionData`
        """
        model = APIDefinitionVersionData()
        if include_optional:
            return APIDefinitionVersionData(
                not_versioned = True,
                versions = {
    ...
    def testAPIDefinitionVersionData(self):
        """Test APIDefinitionVersionData"""
