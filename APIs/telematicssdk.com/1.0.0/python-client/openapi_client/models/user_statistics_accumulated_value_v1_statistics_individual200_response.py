...
class UserStatisticsAccumulatedValueV1StatisticsIndividual200Response(BaseModel):
    """
    UserStatisticsAccumulatedValueV1StatisticsIndividual200Response
    """ # noqa: E501
    errors: Optional[List[Any]] = Field(default=None, alias="Errors")
    result: Optional[UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult] = Field(default=None, alias="Result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Result": UserStatisticsAccumulatedValueV1StatisticsIndividual200ResponseResult.from_dict(obj["Result"]) if obj.get("Result") is not None else None,
