...
class UserSafeScoringDailyValueV1ScoringsIndividualDaily200Response(BaseModel):
    """
    UserSafeScoringDailyValueV1ScoringsIndividualDaily200Response
    """ # noqa: E501
    errors: Optional[List[Any]] = Field(default=None, alias="Errors")
    result: Optional[List[UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner]] = Field(default=None, alias="Result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Result": [UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner.from_dict(_item) for _item in obj["Result"]] if obj.get("Result") is not None else None,
