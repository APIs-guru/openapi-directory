...
class TripsTripDetails200Response(BaseModel):
    """
    TripsTripDetails200Response
    """ # noqa: E501
    result: Optional[TripsTripDetails200ResponseResult] = Field(default=None, alias="Result")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TripsTripDetails200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TripsTripDetails200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Result": TripsTripDetails200ResponseResult.from_dict(obj["Result"]) if obj.get("Result") is not None else None
        })
        return _obj
