...
class UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccelerationScore", "AppId", "BrakingScore", "CompanyId", "CorneringScore", "DeviceToken", "DistractedScore", "InstanceId", "OverallScore", "SpeedingScore"]
