...
class TripsTripDetails200ResponseResultTrackAddressFinishParts(BaseModel):
    """
    ...
    house: Optional[StrictStr] = Field(default=None, alias="House")
    ...
    __properties: ClassVar[List[str]] = ["City", "CountryCode", "District", "House", "PostalCode", "Street"]
