...
class UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner(BaseModel):
    """
    ...
    calc_date: Optional[StrictStr] = Field(default=None, alias="CalcDate")
    ...
    __properties: ClassVar[List[str]] = ["AccelerationScore", "AppId", "BrakingScore", "CalcDate", "CompanyId", "CorneringScore", "DeviceToken", "DistractedScore", "InstanceId", "OverallScore", "SpeedingScore"]
