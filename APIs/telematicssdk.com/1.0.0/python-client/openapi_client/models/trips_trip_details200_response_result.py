...
class TripsTripDetails200ResponseResult(BaseModel):
    """
    TripsTripDetails200ResponseResult
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Code")
    track: Optional[TripsTripDetails200ResponseResultTrack] = Field(default=None, alias="Track")
    __properties: ClassVar[List[str]] = ["Code", "Track"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Code": obj.get("Code"),
            "Track": TripsTripDetails200ResponseResultTrack.from_dict(obj["Track"]) if obj.get("Track") is not None else None
        })
        return _obj
