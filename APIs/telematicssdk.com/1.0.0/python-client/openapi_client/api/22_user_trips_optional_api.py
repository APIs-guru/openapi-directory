...
class 22UserTripsOptionalApi:
    ...
    @validate_call
    def trips_trip_details_0(
        self,
        track_token: Optional[StrictStr] = None,
        ...
        _param = self._trips_trip_details_0_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TripsTripDetails200Response",
        }
    ...
    @validate_call
    def trips_trip_details_0_with_http_info(
        self,
        track_token: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TripsTripDetails200Response]:
        """Trips - trip details
    ...
    @validate_call
    def trips_trip_details_0_without_preload_content(
        self,
        track_token: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _trips_trip_details_0_serialize(
        self,
        track_token,
        _request_auth,
        _content_type,
        ...
        if track_token is not None:
            ...
            _query_params.append(('trackToken', track_token))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mobilesdk/stage/track/get_track/v1',
