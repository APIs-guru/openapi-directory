...
class TestV1ScoringsConsolidatedDaily200ResponseResultInner(unittest.TestCase):
    """V1ScoringsConsolidatedDaily200ResponseResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ScoringsConsolidatedDaily200ResponseResultInner:
        """Test V1ScoringsConsolidatedDaily200ResponseResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ScoringsConsolidatedDaily200ResponseResultInner`
        """
        model = V1ScoringsConsolidatedDaily200ResponseResultInner()
        if include_optional:
            return V1ScoringsConsolidatedDaily200ResponseResultInner(
    ...
    def testV1ScoringsConsolidatedDaily200ResponseResultInner(self):
        """Test V1ScoringsConsolidatedDaily200ResponseResultInner"""
