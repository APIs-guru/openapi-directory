...
class TestConsolidatedSafeScoringApi(unittest.TestCase):
    """ConsolidatedSafeScoringApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ConsolidatedSafeScoringApi()

    def tearDown(self) -> None:
        pass

    def test__v1_scorings_consolidated_0(self) -> None:
        """Test case for _v1_scorings_consolidated_0

        /v1/Scorings/consolidated
        """
        pass

    def test__v1_scorings_consolidated_daily_0(self) -> None:
        """Test case for _v1_scorings_consolidated_daily_0
