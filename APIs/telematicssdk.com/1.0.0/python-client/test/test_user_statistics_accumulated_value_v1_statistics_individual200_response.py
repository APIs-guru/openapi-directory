...
class TestUserStatisticsAccumulatedValueV1StatisticsIndividual200Response(unittest.TestCase):
    """UserStatisticsAccumulatedValueV1StatisticsIndividual200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserStatisticsAccumulatedValueV1StatisticsIndividual200Response:
        """Test UserStatisticsAccumulatedValueV1StatisticsIndividual200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserStatisticsAccumulatedValueV1StatisticsIndividual200Response`
        """
        model = UserStatisticsAccumulatedValueV1StatisticsIndividual200Response()
        if include_optional:
            return UserStatisticsAccumulatedValueV1StatisticsIndividual200Response(
                errors = [
                    null
                    ],
                result = openapi_client.models.user_statistics_accumulated_value_v1_statistics_individual_200_response_result.userStatisticsAccumulatedValue_v1_statistics_individual_200_response_Result(
    ...
    def testUserStatisticsAccumulatedValueV1StatisticsIndividual200Response(self):
        """Test UserStatisticsAccumulatedValueV1StatisticsIndividual200Response"""
