...
class Test21UserStatisticsOptionalApi(unittest.TestCase):
    """21UserStatisticsOptionalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = 21UserStatisticsOptionalApi()

    def tearDown(self) -> None:
        pass

    def test_user_statistice_daily_value_v1_statistics_individual_daily_0(self) -> None:
    ...
    def test_user_statistics_accumulated_value_v1_statistics_individual_0(self) -> None:
