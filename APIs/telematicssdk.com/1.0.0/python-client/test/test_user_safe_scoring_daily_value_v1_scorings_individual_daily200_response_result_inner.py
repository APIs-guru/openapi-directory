...
class TestUserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner(unittest.TestCase):
    """UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner:
        """Test UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner`
        """
        model = UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner()
        if include_optional:
            return UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner(
    ...
    def testUserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner(self):
        """Test UserSafeScoringDailyValueV1ScoringsIndividualDaily200ResponseResultInner"""
