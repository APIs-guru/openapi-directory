...
class TestUserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult(unittest.TestCase):
    """UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult:
        """Test UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult`
        """
        model = UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult()
        if include_optional:
            return UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult(
                acceleration_score = 79.9375,
                app_id = '',
                braking_score = 76.375,
                company_id = '',
                cornering_score = 96.625,
                device_token = '',
                distracted_score = 94.0625,
                instance_id = '',
                overall_score = 84.3125,
                speeding_score = 91.875
            )
        else:
            return UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult(
        )
    ...
    def testUserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult(self):
        """Test UserSafeScoringAccumulatedValueV1ScoringsIndividual200ResponseResult"""
