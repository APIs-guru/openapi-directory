...
class TestConsolidatedStatisticsApi(unittest.TestCase):
    """ConsolidatedStatisticsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ConsolidatedStatisticsApi()

    def tearDown(self) -> None:
        pass

    def test__v1_statistics_consolidated_0(self) -> None:
        """Test case for _v1_statistics_consolidated_0

        /v1/Statistics/consolidated
        """
        pass

    def test__v1_statistics_consolidated_daily_0(self) -> None:
        """Test case for _v1_statistics_consolidated_daily_0
