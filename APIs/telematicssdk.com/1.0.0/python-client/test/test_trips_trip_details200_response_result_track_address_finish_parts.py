...
class TestTripsTripDetails200ResponseResultTrackAddressFinishParts(unittest.TestCase):
    """TripsTripDetails200ResponseResultTrackAddressFinishParts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TripsTripDetails200ResponseResultTrackAddressFinishParts:
        """Test TripsTripDetails200ResponseResultTrackAddressFinishParts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TripsTripDetails200ResponseResultTrackAddressFinishParts`
        """
        model = TripsTripDetails200ResponseResultTrackAddressFinishParts()
        if include_optional:
            return TripsTripDetails200ResponseResultTrackAddressFinishParts(
                city = '',
                country_code = '',
                district = '',
                house = '',
    ...
    def testTripsTripDetails200ResponseResultTrackAddressFinishParts(self):
        """Test TripsTripDetails200ResponseResultTrackAddressFinishParts"""
