...
class Test24UserSafeScoringOptionalApi(unittest.TestCase):
    """24UserSafeScoringOptionalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = 24UserSafeScoringOptionalApi()

    def tearDown(self) -> None:
        pass

    def test_user_safe_scoring_accumulated_value_v1_scorings_individual_0(self) -> None:
    ...
    def test_user_safe_scoring_daily_value_v1_scorings_individual_daily_0(self) -> None:
