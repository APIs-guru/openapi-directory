...
class TestV1ScoringsConsolidatedDaily200Response(unittest.TestCase):
    """V1ScoringsConsolidatedDaily200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ScoringsConsolidatedDaily200Response:
        """Test V1ScoringsConsolidatedDaily200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ScoringsConsolidatedDaily200Response`
        """
        model = V1ScoringsConsolidatedDaily200Response()
        if include_optional:
            return V1ScoringsConsolidatedDaily200Response(
                ...
                result = [
                    openapi_client.models._v1_scorings_consolidated_daily_200_response_result_inner._v1_scorings_consolidated_daily_200_response_Result_inner(
                        acceleration_score = 81.34408602150538, 
                        app_id = '', 
                        braking_score = 79.12903225806451, 
                        company_id = '', 
                        cornering_score = 94.17204301075267, 
                        device_token = '', 
                        distracted_score = 79.53763440860214, 
                        instance_id = '', 
                        overall_score = 78.88172043010752, 
                        report_date = '2021-01-17T00:00:00', 
                        speeding_score = 74.20430107526882, )
                    ],
                status = 200,
                title = ''
            )
    ...
    def testV1ScoringsConsolidatedDaily200Response(self):
        """Test V1ScoringsConsolidatedDaily200Response"""
