...
class Test22UserTripsOptionalApi(unittest.TestCase):
    """22UserTripsOptionalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = 22UserTripsOptionalApi()

    def tearDown(self) -> None:
        pass

    def test_trips_trip_details_0(self) -> None:
