...
class GeocodeAddressResponse(BaseModel):
    ...
    """ # noqa: E501
    found: StrictInt = Field(description="The number of possible matching locations found")
    locations: List[Location] = Field(description="Array of matching location objects")
    __properties: ClassVar[List[str]] = ["found", "locations"]
