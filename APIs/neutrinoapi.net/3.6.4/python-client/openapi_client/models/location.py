...
class Location(BaseModel):
    ...
    timezone: Timezone
    __properties: ClassVar[List[str]] = ["address", "address-components", "city", "country", "country-code", "country-code3", "currency-code", "latitude", "location-tags", "location-type", "longitude", "postal-address", "postal-code", "region-code", "state", "timezone"]
