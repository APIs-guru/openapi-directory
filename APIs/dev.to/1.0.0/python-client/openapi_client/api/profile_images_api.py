...
class ProfileImagesApi:
    ...
    def get_profile_image(
        self,
        username: Annotated[StrictStr, Field(description="The parameter is the username of the user or the username of the organization.")],
    ...
    def _get_profile_image_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/profile_images/{username}',
