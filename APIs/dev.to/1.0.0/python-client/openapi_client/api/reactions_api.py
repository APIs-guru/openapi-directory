...
class ReactionsApi:
    ...
    @validate_call
    def api_reactions_post(
        self,
        category: StrictStr,
        reactable_id: StrictInt,
        reactable_type: StrictStr,
        ...
        :type category: str
        :param reactable_id: (required)
        :type reactable_id: int
        :param reactable_type: (required)
        ...
        _param = self._api_reactions_post_serialize(
            category=category,
    ...
    @validate_call
    def api_reactions_post_with_http_info(
        self,
        category: StrictStr,
        reactable_id: StrictInt,
        reactable_type: StrictStr,
    ...
    @validate_call
    def api_reactions_post_without_preload_content(
        self,
        category: StrictStr,
        reactable_id: StrictInt,
        reactable_type: StrictStr,
    ...
    def _api_reactions_post_serialize(
        self,
        category,
        reactable_id,
        reactable_type,
        ...
        if reactable_id is not None:
            ...
            _query_params.append(('reactable_id', reactable_id))
            
        if reactable_type is not None:
            
            _query_params.append(('reactable_type', reactable_type))
    ...
    def api_reactions_toggle_post(
        ...
        _param = self._api_reactions_toggle_post_serialize(
            category=category,
            reactable_id=reactable_id,
            reactable_type=reactable_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    def api_reactions_toggle_post_with_http_info(
        self,
        category: StrictStr,
        reactable_id: StrictInt,
        reactable_type: StrictStr,
    ...
    @validate_call
    def api_reactions_toggle_post_without_preload_content(
        self,
        category: StrictStr,
        reactable_id: StrictInt,
        reactable_type: StrictStr,
    ...
    def _api_reactions_toggle_post_serialize(
        self,
        category,
        reactable_id,
        reactable_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/reactions/toggle',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
