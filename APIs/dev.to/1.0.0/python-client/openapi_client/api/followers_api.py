...
class FollowersApi:
    ...
    def get_followers(
        ...
        sort: Annotated[Optional[StrictStr], Field(description="Default is 'created_at'. Specifies the sort order for the created_at param of the follow                                 relationship. To sort by newest followers first (descending order) specify                                 ?sort=-created_at.")] = None,
    ...
    def _get_followers_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/followers/users',
