...
class UsersApi:
    ...
    def get_org_users_0(
        ...
        _param = self._get_org_users_0_serialize(
            username=username,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    def get_org_users_0_with_http_info(
        self,
        username: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
    ...
    @validate_call
    def get_org_users_0_without_preload_content(
        self,
        username: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
    ...
    def _get_org_users_0_serialize(
        self,
        username,
        page,
        per_page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/organizations/{username}/users',
    ...
    def get_user_all_articles_0(
        ...
        _param = self._get_user_all_articles_0_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_all_articles_0_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_all_articles_0_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_all_articles_0_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    def get_user_articles_0(
        ...
        _param = self._get_user_articles_0_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_articles_0_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_articles_0_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_articles_0_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    @validate_call
    def get_user_published_articles_0(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
        ...
        _param = self._get_user_published_articles_0_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_published_articles_0_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_published_articles_0_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_published_articles_0_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    @validate_call
    def get_user_unpublished_articles_0(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
        ...
        _param = self._get_user_unpublished_articles_0_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_unpublished_articles_0_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_unpublished_articles_0_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Pagination page")] = None,
        per_page: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size (the number of items to return per page). The default maximum value can be overridden by \"API_PER_PAGE_MAX\" environment variable.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_unpublished_articles_0_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    def post_admin_users_create(
        self,
        user_invite_param: Optional[UserInviteParam] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_invite_param:
        :type user_invite_param: UserInviteParam
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_admin_users_create_serialize(
            user_invite_param=user_invite_param,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_admin_users_create_with_http_info(
        self,
        user_invite_param: Optional[UserInviteParam] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_admin_users_create_without_preload_content(
        self,
        user_invite_param: Optional[UserInviteParam] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_admin_users_create_serialize(
        self,
        user_invite_param,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if user_invite_param is not None:
            _body_params = user_invite_param
    ...
    def suspend_user(
        self,
        id: Annotated[int, Field(strict=True, ge=1, description="The ID of the user to suspend.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _suspend_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/users/{id}/suspend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def unpublish_user(
        ...
        _param = self._unpublish_user_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def unpublish_user_with_http_info(
        self,
        id: Annotated[int, Field(strict=True, ge=1, description="The ID of the user to unpublish.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def unpublish_user_without_preload_content(
        self,
        id: Annotated[int, Field(strict=True, ge=1, description="The ID of the user to unpublish.")],
        _request_timeout: Union[
            None,
    ...
    def _unpublish_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/users/{id}/unpublish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
