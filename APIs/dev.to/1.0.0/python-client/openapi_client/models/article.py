...
class Article(BaseModel):
    ...
    """ # noqa: E501
    article: Optional[ArticleArticle] = None
    __properties: ClassVar[List[str]] = ["article"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "article": ArticleArticle.from_dict(obj["article"]) if obj.get("article") is not None else None
        })
        return _obj
