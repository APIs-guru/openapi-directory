# openapi_client.FollowedTagsApi
...
# **get_followed_tags**
> List[FollowedTag] get_followed_tags()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.FollowedTagsApi(api_client)

    try:
        # Followed Tags
        api_response = api_instance.get_followed_tags()
        print("The response of FollowedTagsApi->get_followed_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FollowedTagsApi->get_followed_tags: %s\n" % e)
```
