...
class TransportGatewayApiJsonldGet(BaseModel):
    ...
    gateway_api_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender name for the Gateway API service.", alias="gatewayApiFrom")
    gateway_api_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Gateway API service. Stored in encrypted format.", alias="gatewayApiToken")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "gatewayApiFrom", "gatewayApiToken", "id", "partition", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if gateway_api_from (nullable) is None
        # and model_fields_set contains the field
        if self.gateway_api_from is None and "gateway_api_from" in self.model_fields_set:
            _dict['gatewayApiFrom'] = None

        # set to None if gateway_api_token (nullable) is None
        # and model_fields_set contains the field
        if self.gateway_api_token is None and "gateway_api_token" in self.model_fields_set:
            _dict['gatewayApiToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gatewayApiFrom": obj.get("gatewayApiFrom"),
            "gatewayApiToken": obj.get("gatewayApiToken"),
            "id": obj.get("id"),
