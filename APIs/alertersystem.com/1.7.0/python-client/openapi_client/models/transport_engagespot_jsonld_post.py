...
class TransportEngagespotJsonldPost(BaseModel):
    ...
    engagespot_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the EngageSpot service. Stored in encrypted format.", alias="engagespotApiKey")
    engagespot_campaign_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The campaign name for the EngageSpot service.", alias="engagespotCampaignName")
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "engagespotApiKey", "engagespotCampaignName", "partition", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if engagespot_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.engagespot_api_key is None and "engagespot_api_key" in self.model_fields_set:
            _dict['engagespotApiKey'] = None

        # set to None if engagespot_campaign_name (nullable) is None
        # and model_fields_set contains the field
        if self.engagespot_campaign_name is None and "engagespot_campaign_name" in self.model_fields_set:
            _dict['engagespotCampaignName'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "engagespotApiKey": obj.get("engagespotApiKey"),
            "engagespotCampaignName": obj.get("engagespotCampaignName"),
