...
class TransportDiscordJsonldPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "discordToken", "discordWebhookId", "partition", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportDiscordJsonldPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportDiscordJsonldPost from a dict"""
        if obj is None:
            return None
