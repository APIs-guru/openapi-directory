...
class ApiTeamInvitationGetCollection200Response(BaseModel):
    """
    ApiTeamInvitationGetCollection200Response
    """ # noqa: E501
    hydramember: List[TeamInvitationJsonldGet] = Field(alias="hydra:member")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hydra:member": [TeamInvitationJsonldGet.from_dict(_item) for _item in obj["hydra:member"]] if obj.get("hydra:member") is not None else None,
