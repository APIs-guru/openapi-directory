...
class TransportRingCentralJsonldGet(BaseModel):
    ...
    ring_central_api_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API token for the Ring Central service. Stored in encrypted format.", alias="ringCentralApiToken")
    ring_central_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender value for the Ring Central service.", alias="ringCentralFrom")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "ringCentralApiToken", "ringCentralFrom", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportRingCentralJsonldGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if ring_central_api_token (nullable) is None
        # and model_fields_set contains the field
        if self.ring_central_api_token is None and "ring_central_api_token" in self.model_fields_set:
            _dict['ringCentralApiToken'] = None

        # set to None if ring_central_from (nullable) is None
        # and model_fields_set contains the field
        if self.ring_central_from is None and "ring_central_from" in self.model_fields_set:
            _dict['ringCentralFrom'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportRingCentralJsonldGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ringCentralApiToken": obj.get("ringCentralApiToken"),
            "ringCentralFrom": obj.get("ringCentralFrom"),
