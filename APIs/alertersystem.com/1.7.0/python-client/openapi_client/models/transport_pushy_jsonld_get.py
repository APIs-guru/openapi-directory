...
class TransportPushyJsonldGet(BaseModel):
    ...
    pushy_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the Pushy service. Stored in encrypted format.", alias="pushyApiKey")
    pushy_to: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The recipient ID for the Pushy service.", alias="pushyTo")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "pushyApiKey", "pushyTo", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if pushy_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.pushy_api_key is None and "pushy_api_key" in self.model_fields_set:
            _dict['pushyApiKey'] = None

        # set to None if pushy_to (nullable) is None
        # and model_fields_set contains the field
        if self.pushy_to is None and "pushy_to" in self.model_fields_set:
            _dict['pushyTo'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pushyApiKey": obj.get("pushyApiKey"),
            "pushyTo": obj.get("pushyTo"),
