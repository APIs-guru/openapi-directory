...
class TransportPlivoGet(BaseModel):
    ...
    plivo_auth_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The auth ID for the Plivo service.", alias="plivoAuthId")
    plivo_auth_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The auth token for the Plivo service. Stored in encrypted format.", alias="plivoAuthToken")
    plivo_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender value for the Plivo service.", alias="plivoFrom")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "plivoAuthId", "plivoAuthToken", "plivoFrom", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportPlivoGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if plivo_auth_id (nullable) is None
        # and model_fields_set contains the field
        if self.plivo_auth_id is None and "plivo_auth_id" in self.model_fields_set:
            _dict['plivoAuthId'] = None

        # set to None if plivo_auth_token (nullable) is None
        # and model_fields_set contains the field
        if self.plivo_auth_token is None and "plivo_auth_token" in self.model_fields_set:
            _dict['plivoAuthToken'] = None

        # set to None if plivo_from (nullable) is None
        # and model_fields_set contains the field
        if self.plivo_from is None and "plivo_from" in self.model_fields_set:
            _dict['plivoFrom'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportPlivoGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plivoAuthId": obj.get("plivoAuthId"),
            "plivoAuthToken": obj.get("plivoAuthToken"),
            "plivoFrom": obj.get("plivoFrom"),
