...
class TransportLightSmsJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "lightSmsLogin", "lightSmsPhone", "lightSmsToken", "partition", "resourceOwner", "transportName"]
