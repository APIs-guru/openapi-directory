...
class TransportWebhookGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "httpMethodCode", "id", "mustBeEncryptedValue", "partition", "resourceOwner", "transportName", "webhookHeaders", "webhookUrl"]
