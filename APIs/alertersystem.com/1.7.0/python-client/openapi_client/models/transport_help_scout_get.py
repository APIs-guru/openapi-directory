...
class TransportHelpScoutGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "helpScoutCustomerEmail", "helpScoutMailboxId", "helpScoutOauthToken", "id", "partition", "resourceOwner", "transportName"]
