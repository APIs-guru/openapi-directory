...
class TransportAlertaGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertaApiKey", "alertaCorrelate", "alertaEnvironment", "alertaEvent", "alertaGroup", "alertaHost", "alertaOrigin", "alertaResource", "alertaService", "alertaSeverity", "alertaStatus", "alertaTags", "alertaType", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
