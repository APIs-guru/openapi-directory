...
class TransportContactEveryoneGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contactEveryoneCategory", "contactEveryoneDiffusionName", "contactEveryoneToken", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
