...
class TransportTwilioJsonldGet(BaseModel):
    ...
    twilio_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender for the Twilio service.", alias="twilioFrom")
    twilio_sid: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The SID for the Twilio service.", alias="twilioSid")
    twilio_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Twilio service. Stored in encrypted format.", alias="twilioToken")
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName", "twilioFrom", "twilioSid", "twilioToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if twilio_from (nullable) is None
        # and model_fields_set contains the field
        if self.twilio_from is None and "twilio_from" in self.model_fields_set:
            _dict['twilioFrom'] = None
        ...
        # set to None if twilio_token (nullable) is None
        # and model_fields_set contains the field
        if self.twilio_token is None and "twilio_token" in self.model_fields_set:
            _dict['twilioToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "twilioFrom": obj.get("twilioFrom"),
            "twilioSid": obj.get("twilioSid"),
            "twilioToken": obj.get("twilioToken")
        })
        return _obj
