...
class TransportSms77JsonldGet(BaseModel):
    ...
    sms77_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the Sms77 service. Stored in encrypted format.", alias="sms77ApiKey")
    sms77_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The optional sender for the Sms77 service.", alias="sms77From")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "sms77ApiKey", "sms77From", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if sms77_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.sms77_api_key is None and "sms77_api_key" in self.model_fields_set:
            _dict['sms77ApiKey'] = None

        # set to None if sms77_from (nullable) is None
        # and model_fields_set contains the field
        if self.sms77_from is None and "sms77_from" in self.model_fields_set:
            _dict['sms77From'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sms77ApiKey": obj.get("sms77ApiKey"),
            "sms77From": obj.get("sms77From"),
