...
class TransportSlackJsonldPut(BaseModel):
    ...
    slack_channel: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The channel (channel, private group, or IM channel to send message to, it can be an encoded ID, or a name) for the Slack service.", alias="slackChannel")
    slack_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Slack service. Stored in encrypted format.", alias="slackToken")
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "slackChannel", "slackToken", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportSlackJsonldPut from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if slack_token (nullable) is None
        # and model_fields_set contains the field
        if self.slack_token is None and "slack_token" in self.model_fields_set:
            _dict['slackToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportSlackJsonldPut from a dict"""
        if obj is None:
            return None
