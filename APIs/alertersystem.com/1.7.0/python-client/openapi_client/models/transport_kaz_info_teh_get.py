...
class TransportKazInfoTehGet(BaseModel):
    ...
    kaz_info_teh_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The from value for the KazInfoTeh service.", alias="kazInfoTehFrom")
    kaz_info_teh_password: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The password for the KazInfoTeh service. Stored in encrypted format.", alias="kazInfoTehPassword")
    kaz_info_teh_username: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The username for the KazInfoTeh service.", alias="kazInfoTehUsername")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "kazInfoTehFrom", "kazInfoTehPassword", "kazInfoTehUsername", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportKazInfoTehGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if kaz_info_teh_from (nullable) is None
        # and model_fields_set contains the field
        if self.kaz_info_teh_from is None and "kaz_info_teh_from" in self.model_fields_set:
            _dict['kazInfoTehFrom'] = None

        # set to None if kaz_info_teh_password (nullable) is None
        # and model_fields_set contains the field
        if self.kaz_info_teh_password is None and "kaz_info_teh_password" in self.model_fields_set:
            _dict['kazInfoTehPassword'] = None

        # set to None if kaz_info_teh_username (nullable) is None
        # and model_fields_set contains the field
        if self.kaz_info_teh_username is None and "kaz_info_teh_username" in self.model_fields_set:
            _dict['kazInfoTehUsername'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportKazInfoTehGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "kazInfoTehFrom": obj.get("kazInfoTehFrom"),
            "kazInfoTehPassword": obj.get("kazInfoTehPassword"),
            "kazInfoTehUsername": obj.get("kazInfoTehUsername"),
