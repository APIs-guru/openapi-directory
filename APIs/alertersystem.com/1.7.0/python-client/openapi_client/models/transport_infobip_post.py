...
class TransportInfobipPost(BaseModel):
    ...
    infobip_auth_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The auth token for the Infobip service. Stored in encrypted format.", alias="infobipAuthToken")
    infobip_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender value for the Infobip service.", alias="infobipFrom")
    infobip_host: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The host for the Infobip service.", alias="infobipHost")
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "infobipAuthToken", "infobipFrom", "infobipHost", "partition", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if infobip_auth_token (nullable) is None
        # and model_fields_set contains the field
        if self.infobip_auth_token is None and "infobip_auth_token" in self.model_fields_set:
            _dict['infobipAuthToken'] = None

        # set to None if infobip_from (nullable) is None
        # and model_fields_set contains the field
        if self.infobip_from is None and "infobip_from" in self.model_fields_set:
            _dict['infobipFrom'] = None

        # set to None if infobip_host (nullable) is None
        # and model_fields_set contains the field
        if self.infobip_host is None and "infobip_host" in self.model_fields_set:
            _dict['infobipHost'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "infobipAuthToken": obj.get("infobipAuthToken"),
            "infobipFrom": obj.get("infobipFrom"),
            "infobipHost": obj.get("infobipHost"),
