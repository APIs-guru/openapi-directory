...
class TransportAmazonSnsJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "amazonSnsAccessKey", "amazonSnsRegion", "amazonSnsSecretKey", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
