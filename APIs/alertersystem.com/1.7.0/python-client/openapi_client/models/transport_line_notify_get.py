...
class TransportLineNotifyGet(BaseModel):
    ...
    line_notify_access_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The access token for the LINE Notify service. Stored in encrypted format.", alias="lineNotifyAccessToken")
    line_notify_sticker_id: Optional[StrictStr] = Field(default=None, description="The sticker ID value for the LINE Notify service.", alias="lineNotifyStickerId")
    line_notify_sticker_package_id: Optional[StrictStr] = Field(default=None, description="The sticker package ID value for the LINE Notify service.", alias="lineNotifyStickerPackageId")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "lineNotifyAccessToken", "lineNotifyStickerId", "lineNotifyStickerPackageId", "partition", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if line_notify_access_token (nullable) is None
        # and model_fields_set contains the field
        if self.line_notify_access_token is None and "line_notify_access_token" in self.model_fields_set:
            _dict['lineNotifyAccessToken'] = None

        # set to None if line_notify_sticker_id (nullable) is None
        # and model_fields_set contains the field
        if self.line_notify_sticker_id is None and "line_notify_sticker_id" in self.model_fields_set:
            _dict['lineNotifyStickerId'] = None

        # set to None if line_notify_sticker_package_id (nullable) is None
        # and model_fields_set contains the field
        if self.line_notify_sticker_package_id is None and "line_notify_sticker_package_id" in self.model_fields_set:
            _dict['lineNotifyStickerPackageId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "lineNotifyAccessToken": obj.get("lineNotifyAccessToken"),
            "lineNotifyStickerId": obj.get("lineNotifyStickerId"),
            "lineNotifyStickerPackageId": obj.get("lineNotifyStickerPackageId"),
