...
class TransportAmazonSnsGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amazonSnsAccessKey", "amazonSnsRegion", "amazonSnsSecretKey", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
