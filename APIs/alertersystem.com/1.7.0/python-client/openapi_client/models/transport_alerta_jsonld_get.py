...
class TransportAlertaJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "alertaApiKey", "alertaCorrelate", "alertaEnvironment", "alertaEvent", "alertaGroup", "alertaHost", "alertaOrigin", "alertaResource", "alertaService", "alertaSeverity", "alertaStatus", "alertaTags", "alertaType", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
