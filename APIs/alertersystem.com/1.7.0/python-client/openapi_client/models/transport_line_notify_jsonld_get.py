...
class TransportLineNotifyJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "lineNotifyAccessToken", "lineNotifyStickerId", "lineNotifyStickerPackageId", "partition", "resourceOwner", "transportName"]
