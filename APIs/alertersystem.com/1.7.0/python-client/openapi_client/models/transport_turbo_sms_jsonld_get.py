...
class TransportTurboSmsJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName", "turboSmsAuthToken", "turboSmsFrom"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportTurboSmsJsonldGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportTurboSmsJsonldGet from a dict"""
        if obj is None:
            return None
