...
class TransportWebhookJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "httpMethodCode", "id", "mustBeEncryptedValue", "partition", "resourceOwner", "transportName", "webhookHeaders", "webhookUrl"]
