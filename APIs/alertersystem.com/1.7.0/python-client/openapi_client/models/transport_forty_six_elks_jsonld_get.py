...
class TransportFortySixElksJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "fortySixElksApiPassword", "fortySixElksApiUsername", "fortySixElksFrom", "id", "partition", "resourceOwner", "transportName"]
