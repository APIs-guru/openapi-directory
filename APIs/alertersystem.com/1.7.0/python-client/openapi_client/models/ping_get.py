...
class PingGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertLogs", "createdAt", "dataSegmentCode", "expectNextPingAt", "expectNextPingAtEpoch", "id", "ipAddress", "monitor", "monitorStatusLog", "partition", "pingCustomCode", "pingCustomPayload", "pingMethodCode", "resourceOwner"]
