...
class TransportSimpleTextinPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "partition", "simpleTextinApiKey", "simpleTextinFrom", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportSimpleTextinPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportSimpleTextinPost from a dict"""
        if obj is None:
            return None
