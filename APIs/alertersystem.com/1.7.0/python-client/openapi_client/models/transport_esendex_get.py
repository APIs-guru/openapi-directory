...
class TransportEsendexGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "esendexAccountReference", "esendexFrom", "esendexPassword", "esendexUsername", "id", "partition", "resourceOwner", "transportName"]
