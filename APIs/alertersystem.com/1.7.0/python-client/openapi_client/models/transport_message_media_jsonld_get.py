...
class TransportMessageMediaJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "messageMediaApiKey", "messageMediaApiSecret", "messageMediaFrom", "partition", "resourceOwner", "transportName"]
