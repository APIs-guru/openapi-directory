...
class TransportMastodonJsonldPut(BaseModel):
    ...
    mastodon_access_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The access token for the Mastodon service. Stored in encrypted format.", alias="mastodonAccessToken")
    mastodon_host: Optional[StrictStr] = Field(description="The host name for the Mastodon service (omit the \"https://\" part).", alias="mastodonHost")
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "mastodonAccessToken", "mastodonHost", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if mastodon_access_token (nullable) is None
        # and model_fields_set contains the field
        if self.mastodon_access_token is None and "mastodon_access_token" in self.model_fields_set:
            _dict['mastodonAccessToken'] = None

        # set to None if mastodon_host (nullable) is None
        # and model_fields_set contains the field
        if self.mastodon_host is None and "mastodon_host" in self.model_fields_set:
            _dict['mastodonHost'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mastodonAccessToken": obj.get("mastodonAccessToken"),
            "mastodonHost": obj.get("mastodonHost"),
