...
class TransportFortySixElksGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "fortySixElksApiPassword", "fortySixElksApiUsername", "fortySixElksFrom", "id", "partition", "resourceOwner", "transportName"]
