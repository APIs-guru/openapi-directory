...
class TransportOctopushJsonldGet(BaseModel):
    ...
    octopush_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the Octopush service. Stored in encrypted format.", alias="octopushApiKey")
    octopush_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender value for the Octopush service.", alias="octopushFrom")
    octopush_type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.", alias="octopushType")
    octopush_user_login: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The user login (email) for the Octopush service.", alias="octopushUserLogin")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "octopushApiKey", "octopushFrom", "octopushType", "octopushUserLogin", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportOctopushJsonldGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if octopush_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.octopush_api_key is None and "octopush_api_key" in self.model_fields_set:
            _dict['octopushApiKey'] = None

        # set to None if octopush_from (nullable) is None
        # and model_fields_set contains the field
        if self.octopush_from is None and "octopush_from" in self.model_fields_set:
            _dict['octopushFrom'] = None

        # set to None if octopush_type (nullable) is None
        # and model_fields_set contains the field
        if self.octopush_type is None and "octopush_type" in self.model_fields_set:
            _dict['octopushType'] = None

        # set to None if octopush_user_login (nullable) is None
        # and model_fields_set contains the field
        if self.octopush_user_login is None and "octopush_user_login" in self.model_fields_set:
            _dict['octopushUserLogin'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportOctopushJsonldGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "octopushApiKey": obj.get("octopushApiKey"),
            "octopushFrom": obj.get("octopushFrom"),
            "octopushType": obj.get("octopushType"),
            "octopushUserLogin": obj.get("octopushUserLogin"),
