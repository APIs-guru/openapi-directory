...
class ApiTransportPushbulletGetCollection200Response(BaseModel):
    """
    ApiTransportPushbulletGetCollection200Response
    """ # noqa: E501
    hydramember: List[TransportPushbulletJsonldGet] = Field(alias="hydra:member")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiTransportPushbulletGetCollection200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiTransportPushbulletGetCollection200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hydra:member": [TransportPushbulletJsonldGet.from_dict(_item) for _item in obj["hydra:member"]] if obj.get("hydra:member") is not None else None,
