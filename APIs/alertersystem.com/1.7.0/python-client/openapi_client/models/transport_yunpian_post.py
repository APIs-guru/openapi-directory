...
class TransportYunpianPost(BaseModel):
    ...
    yunpian_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the Yunpian service. Stored in encrypted format.", alias="yunpianApiKey")
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "partition", "transportName", "yunpianApiKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportYunpianPost from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if yunpian_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.yunpian_api_key is None and "yunpian_api_key" in self.model_fields_set:
            _dict['yunpianApiKey'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportYunpianPost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "yunpianApiKey": obj.get("yunpianApiKey")
        })
        return _obj
