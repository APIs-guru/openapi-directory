...
class ApiTransportMicrosoftTeamsGetCollection200Response(BaseModel):
    """
    ApiTransportMicrosoftTeamsGetCollection200Response
    """ # noqa: E501
    hydramember: List[TransportMicrosoftTeamsJsonldGet] = Field(alias="hydra:member")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hydra:member": [TransportMicrosoftTeamsJsonldGet.from_dict(_item) for _item in obj["hydra:member"]] if obj.get("hydra:member") is not None else None,
