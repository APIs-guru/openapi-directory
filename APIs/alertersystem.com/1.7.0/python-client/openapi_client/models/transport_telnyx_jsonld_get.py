...
class TransportTelnyxJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "telnyxApiKey", "telnyxFrom", "telnyxMessagingProfileId", "transportName"]
