...
class TransportTelegramPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "partition", "telegramChatId", "telegramToken", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportTelegramPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportTelegramPost from a dict"""
        if obj is None:
            return None
