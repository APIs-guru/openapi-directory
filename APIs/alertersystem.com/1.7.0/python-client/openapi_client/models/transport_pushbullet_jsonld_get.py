...
class TransportPushbulletJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "pushbulletAccessToken", "pushbulletEmail", "resourceOwner", "transportName"]
