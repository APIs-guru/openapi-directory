...
class TransportChatworkJsonldGet(BaseModel):
    ...
    chatwork_api_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API token for the Chatwork service. Stored in encrypted format.", alias="chatworkApiToken")
    chatwork_room_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The room ID for the Chatwork service.", alias="chatworkRoomId")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "chatworkApiToken", "chatworkRoomId", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportChatworkJsonldGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if chatwork_api_token (nullable) is None
        # and model_fields_set contains the field
        if self.chatwork_api_token is None and "chatwork_api_token" in self.model_fields_set:
            _dict['chatworkApiToken'] = None

        # set to None if chatwork_room_id (nullable) is None
        # and model_fields_set contains the field
        if self.chatwork_room_id is None and "chatwork_room_id" in self.model_fields_set:
            _dict['chatworkRoomId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportChatworkJsonldGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            "chatworkApiToken": obj.get("chatworkApiToken"),
            "chatworkRoomId": obj.get("chatworkRoomId"),
