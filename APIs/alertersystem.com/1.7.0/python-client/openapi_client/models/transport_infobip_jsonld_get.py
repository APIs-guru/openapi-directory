...
class TransportInfobipJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "infobipAuthToken", "infobipFrom", "infobipHost", "partition", "resourceOwner", "transportName"]
