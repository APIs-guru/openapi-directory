...
class TransportPushoverGet(BaseModel):
    ...
    pushover_app_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The app token for the Pushover service. Stored in encrypted format.", alias="pushoverAppToken")
    pushover_user_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The user key for the Pushover service.", alias="pushoverUserKey")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "pushoverAppToken", "pushoverUserKey", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportPushoverGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if pushover_app_token (nullable) is None
        # and model_fields_set contains the field
        if self.pushover_app_token is None and "pushover_app_token" in self.model_fields_set:
            _dict['pushoverAppToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportPushoverGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pushoverAppToken": obj.get("pushoverAppToken"),
