...
class TransportSinchJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "sinchAuthToken", "sinchFrom", "sinchServicePlanId", "transportName"]
