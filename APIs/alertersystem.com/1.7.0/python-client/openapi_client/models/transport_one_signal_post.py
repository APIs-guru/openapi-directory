...
class TransportOneSignalPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "oneSignalApiKey", "oneSignalAppId", "oneSignalDefaultRecipientId", "partition", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportOneSignalPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportOneSignalPost from a dict"""
        if obj is None:
            return None
