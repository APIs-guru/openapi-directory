...
class TransportSmsapiGet(BaseModel):
    ...
    smsapi_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender name for the SMS API service.", alias="smsapiFrom")
    smsapi_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API token for the SMS API service. Stored in encrypted format.", alias="smsapiToken")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "smsapiFrom", "smsapiToken", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if smsapi_from (nullable) is None
        # and model_fields_set contains the field
        if self.smsapi_from is None and "smsapi_from" in self.model_fields_set:
            _dict['smsapiFrom'] = None

        # set to None if smsapi_token (nullable) is None
        # and model_fields_set contains the field
        if self.smsapi_token is None and "smsapi_token" in self.model_fields_set:
            _dict['smsapiToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "smsapiFrom": obj.get("smsapiFrom"),
            "smsapiToken": obj.get("smsapiToken"),
