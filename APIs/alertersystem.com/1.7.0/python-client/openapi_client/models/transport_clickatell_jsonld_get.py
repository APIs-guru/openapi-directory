...
class TransportClickatellJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "clickatellAccessToken", "clickatellFrom", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
