...
class TransportContactEveryoneJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "contactEveryoneCategory", "contactEveryoneDiffusionName", "contactEveryoneToken", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
