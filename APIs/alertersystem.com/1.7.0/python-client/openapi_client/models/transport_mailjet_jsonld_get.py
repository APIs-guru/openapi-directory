...
class TransportMailjetJsonldGet(BaseModel):
    ...
    mailjet_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The alphanumeric sender ID for the MailJet service.", alias="mailjetFrom")
    mailjet_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The SMS auth token for the MailJet service. Stored in encrypted format.", alias="mailjetToken")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "mailjetFrom", "mailjetToken", "partition", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if mailjet_from (nullable) is None
        # and model_fields_set contains the field
        if self.mailjet_from is None and "mailjet_from" in self.model_fields_set:
            _dict['mailjetFrom'] = None

        # set to None if mailjet_token (nullable) is None
        # and model_fields_set contains the field
        if self.mailjet_token is None and "mailjet_token" in self.model_fields_set:
            _dict['mailjetToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "mailjetFrom": obj.get("mailjetFrom"),
            "mailjetToken": obj.get("mailjetToken"),
