...
class TransportMessageMediaGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "messageMediaApiKey", "messageMediaApiSecret", "messageMediaFrom", "partition", "resourceOwner", "transportName"]
