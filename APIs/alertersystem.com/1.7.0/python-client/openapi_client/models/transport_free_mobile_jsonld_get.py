...
class TransportFreeMobileJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "freeMobileApiKey", "freeMobileLogin", "freeMobilePhone", "id", "partition", "resourceOwner", "transportName"]
