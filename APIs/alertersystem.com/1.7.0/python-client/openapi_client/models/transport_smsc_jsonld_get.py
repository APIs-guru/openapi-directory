...
class TransportSmscJsonldGet(BaseModel):
    ...
    smsc_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender (NB: text identity, not a phone number) for the Smsc service.", alias="smscFrom")
    smsc_login: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The login for the Smsc service.", alias="smscLogin")
    smsc_password: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API password for the Smsc service. Stored in encrypted format.", alias="smscPassword")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "smscFrom", "smscLogin", "smscPassword", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if smsc_from (nullable) is None
        # and model_fields_set contains the field
        if self.smsc_from is None and "smsc_from" in self.model_fields_set:
            _dict['smscFrom'] = None

        # set to None if smsc_login (nullable) is None
        # and model_fields_set contains the field
        if self.smsc_login is None and "smsc_login" in self.model_fields_set:
            _dict['smscLogin'] = None

        # set to None if smsc_password (nullable) is None
        # and model_fields_set contains the field
        if self.smsc_password is None and "smsc_password" in self.model_fields_set:
            _dict['smscPassword'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "smscFrom": obj.get("smscFrom"),
            "smscLogin": obj.get("smscLogin"),
            "smscPassword": obj.get("smscPassword"),
