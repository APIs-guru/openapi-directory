...
class TransportTrelloGet(BaseModel):
    ...
    trello_api_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The API key for the Trello service.", alias="trelloApiKey")
    trello_api_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API token for the Trello service. Stored in encrypted format.", alias="trelloApiToken")
    trello_list_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The list ID for the Trello service.", alias="trelloListId")
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName", "trelloApiKey", "trelloApiToken", "trelloListId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if trello_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.trello_api_key is None and "trello_api_key" in self.model_fields_set:
            _dict['trelloApiKey'] = None

        # set to None if trello_api_token (nullable) is None
        # and model_fields_set contains the field
        if self.trello_api_token is None and "trello_api_token" in self.model_fields_set:
            _dict['trelloApiToken'] = None

        # set to None if trello_list_id (nullable) is None
        # and model_fields_set contains the field
        if self.trello_list_id is None and "trello_list_id" in self.model_fields_set:
            _dict['trelloListId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trelloApiKey": obj.get("trelloApiKey"),
            "trelloApiToken": obj.get("trelloApiToken"),
            "trelloListId": obj.get("trelloListId")
        })
        return _obj
