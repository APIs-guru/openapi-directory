...
class TransportMattermostGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "mattermostAccessToken", "mattermostChannel", "mattermostHost", "mattermostPath", "partition", "resourceOwner", "transportName"]
