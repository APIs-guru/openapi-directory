...
class TransportGoogleChatJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "googleChatAccessKey", "googleChatAccessToken", "googleChatSpace", "googleChatThreadKey", "id", "partition", "resourceOwner", "transportName"]
