...
class TransportSpotHitGet(BaseModel):
    ...
    spot_hit_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender (3-11 letters, default is a 5 digits phone number) for the Spot-Hit service.", alias="spotHitFrom")
    spot_hit_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API token for the Spot-Hit service. Stored in encrypted format.", alias="spotHitToken")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "spotHitFrom", "spotHitToken", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if spot_hit_from (nullable) is None
        # and model_fields_set contains the field
        if self.spot_hit_from is None and "spot_hit_from" in self.model_fields_set:
            _dict['spotHitFrom'] = None

        # set to None if spot_hit_token (nullable) is None
        # and model_fields_set contains the field
        if self.spot_hit_token is None and "spot_hit_token" in self.model_fields_set:
            _dict['spotHitToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spotHitFrom": obj.get("spotHitFrom"),
            "spotHitToken": obj.get("spotHitToken"),
