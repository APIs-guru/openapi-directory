...
class TransportOneSignalGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "oneSignalApiKey", "oneSignalAppId", "oneSignalDefaultRecipientId", "partition", "resourceOwner", "transportName"]
