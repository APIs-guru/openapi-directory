...
class TeamInvitationJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "inviteeEmail", "inviteeFirstName", "inviteeLastName", "partition", "resourceOwner", "statusAt", "teamInvitationStatus", "teamMemberRoleCode"]
