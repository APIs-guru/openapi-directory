...
class TransportZendeskJsonldGet(BaseModel):
    ...
    zendesk_email: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The login email address for the Zendesk service.", alias="zendeskEmail")
    zendesk_host: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The host name for the Zendesk service (domain.zendesk.com).", alias="zendeskHost")
    zendesk_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Zendesk service. Stored in encrypted format.", alias="zendeskToken")
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName", "zendeskEmail", "zendeskHost", "zendeskToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if zendesk_email (nullable) is None
        # and model_fields_set contains the field
        if self.zendesk_email is None and "zendesk_email" in self.model_fields_set:
            _dict['zendeskEmail'] = None

        # set to None if zendesk_host (nullable) is None
        # and model_fields_set contains the field
        if self.zendesk_host is None and "zendesk_host" in self.model_fields_set:
            _dict['zendeskHost'] = None

        # set to None if zendesk_token (nullable) is None
        # and model_fields_set contains the field
        if self.zendesk_token is None and "zendesk_token" in self.model_fields_set:
            _dict['zendeskToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "zendeskHost": obj.get("zendeskHost"),
            "zendeskToken": obj.get("zendeskToken")
        })
        return _obj
