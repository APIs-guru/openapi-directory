...
class TransportSmsBiurasJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "smsBiurasApiKey", "smsBiurasFrom", "smsBiurasUid", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportSmsBiurasJsonldGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportSmsBiurasJsonldGet from a dict"""
        if obj is None:
            return None
