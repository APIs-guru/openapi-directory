...
class TransportTelegramGet(BaseModel):
    ...
    telegram_chat_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The chat ID for the Telegram service.", alias="telegramChatId")
    telegram_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Telegram service. Stored in encrypted format.", alias="telegramToken")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "telegramChatId", "telegramToken", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportTelegramGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if telegram_token (nullable) is None
        # and model_fields_set contains the field
        if self.telegram_token is None and "telegram_token" in self.model_fields_set:
            _dict['telegramToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportTelegramGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "telegramToken": obj.get("telegramToken"),
