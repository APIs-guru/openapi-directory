...
class TransportIqsmsJsonldGet(BaseModel):
    ...
    iqsms_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The sender value for the Iqsms service.", alias="iqsmsFrom")
    iqsms_login: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The login for the Iqsms service.", alias="iqsmsLogin")
    iqsms_password: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The password for the Iqsms service. Stored in encrypted format.", alias="iqsmsPassword")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "iqsmsFrom", "iqsmsLogin", "iqsmsPassword", "partition", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if iqsms_from (nullable) is None
        # and model_fields_set contains the field
        if self.iqsms_from is None and "iqsms_from" in self.model_fields_set:
            _dict['iqsmsFrom'] = None

        # set to None if iqsms_login (nullable) is None
        # and model_fields_set contains the field
        if self.iqsms_login is None and "iqsms_login" in self.model_fields_set:
            _dict['iqsmsLogin'] = None

        # set to None if iqsms_password (nullable) is None
        # and model_fields_set contains the field
        if self.iqsms_password is None and "iqsms_password" in self.model_fields_set:
            _dict['iqsmsPassword'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "iqsmsFrom": obj.get("iqsmsFrom"),
            "iqsmsLogin": obj.get("iqsmsLogin"),
            "iqsmsPassword": obj.get("iqsmsPassword"),
