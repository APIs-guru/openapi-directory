...
class PartitionGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertServices", "createdAt", "dataSegmentCode", "id", "monitors", "partitionName", "partitionNotes", "resourceOwner", "teamInvitations", "teamMembers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartitionGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartitionGet from a dict"""
        if obj is None:
            return None
