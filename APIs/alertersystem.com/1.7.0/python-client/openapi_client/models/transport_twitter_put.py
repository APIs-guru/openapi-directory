...
class TransportTwitterPut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "transportName", "twitterAccessToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportTwitterPut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportTwitterPut from a dict"""
        if obj is None:
            return None
