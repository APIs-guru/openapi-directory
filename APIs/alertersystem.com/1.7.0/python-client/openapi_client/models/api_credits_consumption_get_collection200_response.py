...
class ApiCreditsConsumptionGetCollection200Response(BaseModel):
    """
    ApiCreditsConsumptionGetCollection200Response
    """ # noqa: E501
    hydramember: List[CreditsConsumptionJsonldGet] = Field(alias="hydra:member")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hydra:member": [CreditsConsumptionJsonldGet.from_dict(_item) for _item in obj["hydra:member"]] if obj.get("hydra:member") is not None else None,
