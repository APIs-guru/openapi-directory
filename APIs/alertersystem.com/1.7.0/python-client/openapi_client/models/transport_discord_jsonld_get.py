...
class TransportDiscordJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "discordToken", "discordWebhookId", "id", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportDiscordJsonldGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportDiscordJsonldGet from a dict"""
        if obj is None:
            return None
