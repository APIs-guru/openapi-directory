...
class TransportKazInfoTehJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "kazInfoTehFrom", "kazInfoTehPassword", "kazInfoTehUsername", "partition", "resourceOwner", "transportName"]
