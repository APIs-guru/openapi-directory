...
class TimezoneCodeJsonldGet(BaseModel):
    ...
    offset_from_utc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The numeric offset from the UTC timezone.", alias="offsetFromUtc")
    timezone_date_string: Optional[StrictStr] = Field(default=None, description="The text offset from the UTC timezone that forms part of the ISO 8601 date time format.", alias="timezoneDateString")
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "codeName", "id", "offsetFromUtc", "timezoneDateString"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "offsetFromUtc": obj.get("offsetFromUtc"),
            "timezoneDateString": obj.get("timezoneDateString")
        })
        return _obj
