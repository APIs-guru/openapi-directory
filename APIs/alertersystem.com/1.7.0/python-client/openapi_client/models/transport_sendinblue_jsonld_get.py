...
class TransportSendinblueJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "sendinblueApiKey", "sendinblueSenderPhone", "transportName"]
