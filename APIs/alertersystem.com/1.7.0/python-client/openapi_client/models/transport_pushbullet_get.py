...
class TransportPushbulletGet(BaseModel):
    ...
    pushbullet_access_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The access token for the Pushbullet service. Stored in encrypted format.", alias="pushbulletAccessToken")
    pushbullet_email: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The recipient email for the Pushbullet service.", alias="pushbulletEmail")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "pushbulletAccessToken", "pushbulletEmail", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportPushbulletGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if pushbullet_email (nullable) is None
        # and model_fields_set contains the field
        if self.pushbullet_email is None and "pushbullet_email" in self.model_fields_set:
            _dict['pushbulletEmail'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportPushbulletGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pushbulletEmail": obj.get("pushbulletEmail"),
