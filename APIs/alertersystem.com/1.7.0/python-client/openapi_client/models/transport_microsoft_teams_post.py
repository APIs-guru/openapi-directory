...
class TransportMicrosoftTeamsPost(BaseModel):
    ...
    microsoft_teams_path: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The path (has the following format: 'webhookb2/{uuid}@{uuid}/IncomingWebhook/{id}/{uuid}') for the Microsoft Teams service. Stored in encrypted format.", alias="microsoftTeamsPath")
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "microsoftTeamsPath", "partition", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if microsoft_teams_path (nullable) is None
        # and model_fields_set contains the field
        if self.microsoft_teams_path is None and "microsoft_teams_path" in self.model_fields_set:
            _dict['microsoftTeamsPath'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "microsoftTeamsPath": obj.get("microsoftTeamsPath"),
