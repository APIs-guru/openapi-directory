...
class TransportAlertaPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertaApiKey", "alertaCorrelate", "alertaEnvironment", "alertaEvent", "alertaGroup", "alertaHost", "alertaOrigin", "alertaResource", "alertaService", "alertaSeverity", "alertaStatus", "alertaTags", "alertaType", "dataSegmentCode", "partition", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportAlertaPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportAlertaPost from a dict"""
        if obj is None:
            return None
