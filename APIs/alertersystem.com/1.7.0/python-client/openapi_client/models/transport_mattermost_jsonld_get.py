...
class TransportMattermostJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "mattermostAccessToken", "mattermostChannel", "mattermostHost", "mattermostPath", "partition", "resourceOwner", "transportName"]
