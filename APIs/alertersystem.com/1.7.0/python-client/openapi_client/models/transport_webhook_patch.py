...
class TransportWebhookPatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "httpMethodCode", "mustBeEncryptedValue", "transportName", "webhookHeaders", "webhookUrl"]
