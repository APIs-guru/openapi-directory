...
class TransportAllMySmsJsonldGet(BaseModel):
    ...
    all_my_sms_api_key: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The API key for the Allmysms service. Stored in encrypted format.", alias="allMySmsApiKey")
    all_my_sms_from: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The sender value (default 36180) for the Allmysms service.", alias="allMySmsFrom")
    all_my_sms_login: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The login credential for the Allmysms service.", alias="allMySmsLogin")
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "allMySmsApiKey", "allMySmsFrom", "allMySmsLogin", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportAllMySmsJsonldGet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if all_my_sms_api_key (nullable) is None
        # and model_fields_set contains the field
        if self.all_my_sms_api_key is None and "all_my_sms_api_key" in self.model_fields_set:
            _dict['allMySmsApiKey'] = None

        # set to None if all_my_sms_from (nullable) is None
        # and model_fields_set contains the field
        if self.all_my_sms_from is None and "all_my_sms_from" in self.model_fields_set:
            _dict['allMySmsFrom'] = None

        # set to None if all_my_sms_login (nullable) is None
        # and model_fields_set contains the field
        if self.all_my_sms_login is None and "all_my_sms_login" in self.model_fields_set:
            _dict['allMySmsLogin'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportAllMySmsJsonldGet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            "allMySmsApiKey": obj.get("allMySmsApiKey"),
            "allMySmsFrom": obj.get("allMySmsFrom"),
            "allMySmsLogin": obj.get("allMySmsLogin"),
