...
class TransportEngagespotJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "engagespotApiKey", "engagespotCampaignName", "id", "partition", "resourceOwner", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportEngagespotJsonldGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportEngagespotJsonldGet from a dict"""
        if obj is None:
            return None
