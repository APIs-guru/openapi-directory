...
class TransportTwitterGet(BaseModel):
    ...
    twitter_access_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The access token for the Twitter service. Stored in encrypted format.", alias="twitterAccessToken")
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "transportName", "twitterAccessToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if twitter_access_token (nullable) is None
        # and model_fields_set contains the field
        if self.twitter_access_token is None and "twitter_access_token" in self.model_fields_set:
            _dict['twitterAccessToken'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "twitterAccessToken": obj.get("twitterAccessToken")
        })
        return _obj
