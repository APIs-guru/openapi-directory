...
class TransportMobytJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "mobytAccessToken", "mobytFrom", "mobytTypeQuality", "mobytUserKey", "partition", "resourceOwner", "transportName"]
