...
class TransportGotifyJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "gotifyApiUrl", "gotifyAppToken", "gotifyPriority", "id", "partition", "resourceOwner", "transportName"]
