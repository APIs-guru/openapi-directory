...
class TransportMastodonPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataSegmentCode", "mastodonAccessToken", "mastodonHost", "partition", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportMastodonPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportMastodonPost from a dict"""
        if obj is None:
            return None
