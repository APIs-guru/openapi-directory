...
class TransportExpoGet(BaseModel):
    ...
    expo_token: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(description="The token for the Expo service. Stored in encrypted format.", alias="expoToken")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "expoToken", "id", "partition", "resourceOwner", "transportName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if expo_token (nullable) is None
        # and model_fields_set contains the field
        if self.expo_token is None and "expo_token" in self.model_fields_set:
            _dict['expoToken'] = None
