...
class TransportPlivoJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "plivoAuthId", "plivoAuthToken", "plivoFrom", "resourceOwner", "transportName"]
