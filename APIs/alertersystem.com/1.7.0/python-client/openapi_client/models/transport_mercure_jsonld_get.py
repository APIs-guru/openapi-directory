...
class TransportMercureJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "mercureHubJwtToken", "mercureHubUrl", "mercureTopic", "partition", "resourceOwner", "transportName"]
