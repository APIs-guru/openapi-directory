...
class TransportSendberryJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "sendberryAuthKey", "sendberryFrom", "sendberryPassword", "sendberryUsername", "transportName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportSendberryJsonldGet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportSendberryJsonldGet from a dict"""
        if obj is None:
            return None
