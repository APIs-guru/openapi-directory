...
class TransportHelpScoutJsonldGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "createdAt", "dataSegmentCode", "helpScoutCustomerEmail", "helpScoutMailboxId", "helpScoutOauthToken", "id", "partition", "resourceOwner", "transportName"]
