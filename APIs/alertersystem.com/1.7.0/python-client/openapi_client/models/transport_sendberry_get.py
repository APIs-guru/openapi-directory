...
class TransportSendberryGet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "dataSegmentCode", "id", "partition", "resourceOwner", "sendberryAuthKey", "sendberryFrom", "sendberryPassword", "sendberryUsername", "transportName"]
