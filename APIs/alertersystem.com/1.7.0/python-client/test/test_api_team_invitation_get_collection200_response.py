...
class TestApiTeamInvitationGetCollection200Response(unittest.TestCase):
    """ApiTeamInvitationGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTeamInvitationGetCollection200Response:
        """Test ApiTeamInvitationGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTeamInvitationGetCollection200Response`
        """
        model = ApiTeamInvitationGetCollection200Response()
        if include_optional:
            return ApiTeamInvitationGetCollection200Response(
                hydramember = [
                    openapi_client.models.team_invitation/jsonld_get.TeamInvitation.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTeamInvitationGetCollection200Response(self):
        """Test ApiTeamInvitationGetCollection200Response"""
