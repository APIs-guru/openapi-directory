...
class TestTransportChatworkApi(unittest.TestCase):
    """TransportChatworkApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportChatworkApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_chatwork_get_collection(self) -> None:
    ...
    def test_api_transport_chatwork_id_delete(self) -> None:
    ...
    def test_api_transport_chatwork_id_get(self) -> None:
    ...
    def test_api_transport_chatwork_id_patch(self) -> None:
    ...
    def test_api_transport_chatwork_id_put(self) -> None:
    ...
    def test_api_transport_chatwork_post(self) -> None:
