...
class TestTransportMercureApi(unittest.TestCase):
    """TransportMercureApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportMercureApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_mercure_get_collection(self) -> None:
    ...
    def test_api_transport_mercure_id_delete(self) -> None:
    ...
    def test_api_transport_mercure_id_get(self) -> None:
    ...
    def test_api_transport_mercure_id_patch(self) -> None:
    ...
    def test_api_transport_mercure_id_put(self) -> None:
    ...
    def test_api_transport_mercure_post(self) -> None:
