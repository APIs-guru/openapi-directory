...
class TestTransportTwilioApi(unittest.TestCase):
    """TransportTwilioApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportTwilioApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_twilio_get_collection(self) -> None:
    ...
    def test_api_transport_twilio_id_delete(self) -> None:
    ...
    def test_api_transport_twilio_id_get(self) -> None:
    ...
    def test_api_transport_twilio_id_patch(self) -> None:
    ...
    def test_api_transport_twilio_id_put(self) -> None:
    ...
    def test_api_transport_twilio_post(self) -> None:
