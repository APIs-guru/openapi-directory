...
class TestTransportGoogleChatApi(unittest.TestCase):
    """TransportGoogleChatApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportGoogleChatApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_google_chat_get_collection(self) -> None:
    ...
    def test_api_transport_google_chat_id_delete(self) -> None:
    ...
    def test_api_transport_google_chat_id_get(self) -> None:
    ...
    def test_api_transport_google_chat_id_patch(self) -> None:
    ...
    def test_api_transport_google_chat_id_put(self) -> None:
    ...
    def test_api_transport_google_chat_post(self) -> None:
