...
class TestTransportPushoverApi(unittest.TestCase):
    """TransportPushoverApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportPushoverApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_pushover_get_collection(self) -> None:
    ...
    def test_api_transport_pushover_id_delete(self) -> None:
    ...
    def test_api_transport_pushover_id_get(self) -> None:
    ...
    def test_api_transport_pushover_id_patch(self) -> None:
    ...
    def test_api_transport_pushover_id_put(self) -> None:
    ...
    def test_api_transport_pushover_post(self) -> None:
