...
class TestTransportMicrosoftTeamsApi(unittest.TestCase):
    """TransportMicrosoftTeamsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportMicrosoftTeamsApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_microsoft_teams_get_collection(self) -> None:
    ...
    def test_api_transport_microsoft_teams_id_delete(self) -> None:
    ...
    def test_api_transport_microsoft_teams_id_get(self) -> None:
    ...
    def test_api_transport_microsoft_teams_id_patch(self) -> None:
    ...
    def test_api_transport_microsoft_teams_id_put(self) -> None:
    ...
    def test_api_transport_microsoft_teams_post(self) -> None:
