...
class TestAlertServiceJsonldPost(unittest.TestCase):
    """AlertServiceJsonldPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServiceJsonldPost:
        """Test AlertServiceJsonldPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServiceJsonldPost`
        """
        model = AlertServiceJsonldPost()
        if include_optional:
            return AlertServiceJsonldPost(
                alert_service_name = '',
                alert_service_notes = '',
    ...
    def testAlertServiceJsonldPost(self):
        """Test AlertServiceJsonldPost"""
