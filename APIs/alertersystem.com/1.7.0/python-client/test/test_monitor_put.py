...
class TestMonitorPut(unittest.TestCase):
    """MonitorPut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorPut:
        """Test MonitorPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorPut`
        """
        model = MonitorPut()
        if include_optional:
            return MonitorPut(
