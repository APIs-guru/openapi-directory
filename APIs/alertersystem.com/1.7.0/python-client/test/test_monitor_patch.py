...
class TestMonitorPatch(unittest.TestCase):
    """MonitorPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorPatch:
        """Test MonitorPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorPatch`
        """
        model = MonitorPatch()
        if include_optional:
            return MonitorPatch(
