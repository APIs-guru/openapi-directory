...
class TestAlertServiceJsonldGet(unittest.TestCase):
    """AlertServiceJsonldGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServiceJsonldGet:
        """Test AlertServiceJsonldGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServiceJsonldGet`
        """
        model = AlertServiceJsonldGet()
        if include_optional:
            return AlertServiceJsonldGet(
                context = None,
                id = '',
                type = '',
                alert_service_name = '',
    ...
    def testAlertServiceJsonldGet(self):
        """Test AlertServiceJsonldGet"""
