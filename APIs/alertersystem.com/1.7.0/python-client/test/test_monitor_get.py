...
class TestMonitorGet(unittest.TestCase):
    """MonitorGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorGet:
        """Test MonitorGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorGet`
        """
        model = MonitorGet()
        if include_optional:
            return MonitorGet(
