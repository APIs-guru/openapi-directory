...
class TestApiTransportEmailGetCollection200Response(unittest.TestCase):
    """ApiTransportEmailGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportEmailGetCollection200Response:
        """Test ApiTransportEmailGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportEmailGetCollection200Response`
        """
        model = ApiTransportEmailGetCollection200Response()
        if include_optional:
            return ApiTransportEmailGetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_email/jsonld_get.TransportEmail.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportEmailGetCollection200Response(self):
        """Test ApiTransportEmailGetCollection200Response"""
