...
class TestAlertServicePut(unittest.TestCase):
    """AlertServicePut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServicePut:
        """Test AlertServicePut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServicePut`
        """
        model = AlertServicePut()
        if include_optional:
            return AlertServicePut(
                alert_service_name = '',
                alert_service_notes = '',
                data_segment_code = '',
                media_objects = [
