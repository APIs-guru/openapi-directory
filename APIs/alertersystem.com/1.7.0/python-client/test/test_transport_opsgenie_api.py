...
class TestTransportOpsgenieApi(unittest.TestCase):
    """TransportOpsgenieApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportOpsgenieApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_opsgenie_get_collection(self) -> None:
    ...
    def test_api_transport_opsgenie_id_delete(self) -> None:
    ...
    def test_api_transport_opsgenie_id_get(self) -> None:
    ...
    def test_api_transport_opsgenie_id_patch(self) -> None:
    ...
    def test_api_transport_opsgenie_id_put(self) -> None:
    ...
    def test_api_transport_opsgenie_post(self) -> None:
