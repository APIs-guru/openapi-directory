...
class TestTransportFreshdeskApi(unittest.TestCase):
    """TransportFreshdeskApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportFreshdeskApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_freshdesk_get_collection(self) -> None:
    ...
    def test_api_transport_freshdesk_id_delete(self) -> None:
    ...
    def test_api_transport_freshdesk_id_get(self) -> None:
    ...
    def test_api_transport_freshdesk_id_patch(self) -> None:
    ...
    def test_api_transport_freshdesk_id_put(self) -> None:
    ...
    def test_api_transport_freshdesk_post(self) -> None:
