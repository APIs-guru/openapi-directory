...
class TestTransportGitterApi(unittest.TestCase):
    """TransportGitterApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportGitterApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_gitter_get_collection(self) -> None:
    ...
    def test_api_transport_gitter_id_delete(self) -> None:
    ...
    def test_api_transport_gitter_id_get(self) -> None:
    ...
    def test_api_transport_gitter_id_patch(self) -> None:
    ...
    def test_api_transport_gitter_id_put(self) -> None:
    ...
    def test_api_transport_gitter_post(self) -> None:
