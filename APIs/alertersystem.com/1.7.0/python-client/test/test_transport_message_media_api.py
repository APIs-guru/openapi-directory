...
class TestTransportMessageMediaApi(unittest.TestCase):
    """TransportMessageMediaApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportMessageMediaApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_message_media_get_collection(self) -> None:
    ...
    def test_api_transport_message_media_id_delete(self) -> None:
    ...
    def test_api_transport_message_media_id_get(self) -> None:
    ...
    def test_api_transport_message_media_id_patch(self) -> None:
    ...
    def test_api_transport_message_media_id_put(self) -> None:
    ...
    def test_api_transport_message_media_post(self) -> None:
