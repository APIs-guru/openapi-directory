...
class TestTransportAlertaApi(unittest.TestCase):
    """TransportAlertaApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportAlertaApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_alerta_get_collection(self) -> None:
    ...
    def test_api_transport_alerta_id_delete(self) -> None:
    ...
    def test_api_transport_alerta_id_get(self) -> None:
    ...
    def test_api_transport_alerta_id_patch(self) -> None:
    ...
    def test_api_transport_alerta_id_put(self) -> None:
    ...
    def test_api_transport_alerta_post(self) -> None:
