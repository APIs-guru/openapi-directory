...
class TestTransportGotifyApi(unittest.TestCase):
    """TransportGotifyApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportGotifyApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_gotify_get_collection(self) -> None:
    ...
    def test_api_transport_gotify_id_delete(self) -> None:
    ...
    def test_api_transport_gotify_id_get(self) -> None:
    ...
    def test_api_transport_gotify_id_patch(self) -> None:
    ...
    def test_api_transport_gotify_id_put(self) -> None:
    ...
    def test_api_transport_gotify_post(self) -> None:
