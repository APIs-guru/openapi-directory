...
class TestApiPartitionGetCollection200Response(unittest.TestCase):
    """ApiPartitionGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiPartitionGetCollection200Response:
        """Test ApiPartitionGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiPartitionGetCollection200Response`
        """
        model = ApiPartitionGetCollection200Response()
        if include_optional:
            return ApiPartitionGetCollection200Response(
                hydramember = [
                    openapi_client.models.partition/jsonld_get.Partition.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
                        alert_services = [
    ...
    def testApiPartitionGetCollection200Response(self):
        """Test ApiPartitionGetCollection200Response"""
