...
class TestApiMediaObjectGetCollection200Response(unittest.TestCase):
    """ApiMediaObjectGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiMediaObjectGetCollection200Response:
        """Test ApiMediaObjectGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiMediaObjectGetCollection200Response`
        """
        model = ApiMediaObjectGetCollection200Response()
        if include_optional:
            return ApiMediaObjectGetCollection200Response(
                hydramember = [
                    openapi_client.models.media_object/jsonld_get.MediaObject.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
                        content_url = '', 
    ...
    def testApiMediaObjectGetCollection200Response(self):
        """Test ApiMediaObjectGetCollection200Response"""
