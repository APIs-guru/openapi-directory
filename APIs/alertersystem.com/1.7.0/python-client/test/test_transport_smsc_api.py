...
class TestTransportSmscApi(unittest.TestCase):
    """TransportSmscApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportSmscApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_smsc_get_collection(self) -> None:
    ...
    def test_api_transport_smsc_id_delete(self) -> None:
    ...
    def test_api_transport_smsc_id_get(self) -> None:
    ...
    def test_api_transport_smsc_id_patch(self) -> None:
    ...
    def test_api_transport_smsc_id_put(self) -> None:
    ...
    def test_api_transport_smsc_post(self) -> None:
