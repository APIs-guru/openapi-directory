...
class TestTransportOvhCloudApi(unittest.TestCase):
    """TransportOvhCloudApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportOvhCloudApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_ovh_cloud_get_collection(self) -> None:
    ...
    def test_api_transport_ovh_cloud_id_delete(self) -> None:
    ...
    def test_api_transport_ovh_cloud_id_get(self) -> None:
    ...
    def test_api_transport_ovh_cloud_id_patch(self) -> None:
    ...
    def test_api_transport_ovh_cloud_id_put(self) -> None:
    ...
    def test_api_transport_ovh_cloud_post(self) -> None:
