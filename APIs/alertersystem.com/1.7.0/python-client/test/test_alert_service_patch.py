...
class TestAlertServicePatch(unittest.TestCase):
    """AlertServicePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServicePatch:
        """Test AlertServicePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServicePatch`
        """
        model = AlertServicePatch()
        if include_optional:
            return AlertServicePatch(
                alert_service_name = '',
                alert_service_notes = '',
                data_segment_code = '',
                media_objects = [
    ...
    def testAlertServicePatch(self):
        """Test AlertServicePatch"""
