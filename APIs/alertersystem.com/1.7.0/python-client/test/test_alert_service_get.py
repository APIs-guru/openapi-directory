...
class TestAlertServiceGet(unittest.TestCase):
    """AlertServiceGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServiceGet:
        """Test AlertServiceGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServiceGet`
        """
        model = AlertServiceGet()
        if include_optional:
