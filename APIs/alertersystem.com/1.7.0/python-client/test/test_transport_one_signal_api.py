...
class TestTransportOneSignalApi(unittest.TestCase):
    """TransportOneSignalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportOneSignalApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_one_signal_get_collection(self) -> None:
    ...
    def test_api_transport_one_signal_id_delete(self) -> None:
    ...
    def test_api_transport_one_signal_id_get(self) -> None:
    ...
    def test_api_transport_one_signal_id_patch(self) -> None:
    ...
    def test_api_transport_one_signal_id_put(self) -> None:
    ...
    def test_api_transport_one_signal_post(self) -> None:
