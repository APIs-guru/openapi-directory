...
class TestTransportSlackApi(unittest.TestCase):
    """TransportSlackApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportSlackApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_slack_get_collection(self) -> None:
    ...
    def test_api_transport_slack_id_delete(self) -> None:
    ...
    def test_api_transport_slack_id_get(self) -> None:
    ...
    def test_api_transport_slack_id_patch(self) -> None:
    ...
    def test_api_transport_slack_id_put(self) -> None:
    ...
    def test_api_transport_slack_post(self) -> None:
