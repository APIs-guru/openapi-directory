...
class TestApiTeamMemberGetCollection200Response(unittest.TestCase):
    """ApiTeamMemberGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTeamMemberGetCollection200Response:
        """Test ApiTeamMemberGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTeamMemberGetCollection200Response`
        """
        model = ApiTeamMemberGetCollection200Response()
        if include_optional:
            return ApiTeamMemberGetCollection200Response(
                hydramember = [
                    openapi_client.models.team_member/jsonld_get.TeamMember.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTeamMemberGetCollection200Response(self):
        """Test ApiTeamMemberGetCollection200Response"""
