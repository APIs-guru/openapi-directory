...
class TestTransportWebhookApi(unittest.TestCase):
    """TransportWebhookApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportWebhookApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_webhook_get_collection(self) -> None:
    ...
    def test_api_transport_webhook_id_delete(self) -> None:
    ...
    def test_api_transport_webhook_id_get(self) -> None:
    ...
    def test_api_transport_webhook_id_patch(self) -> None:
    ...
    def test_api_transport_webhook_id_put(self) -> None:
    ...
    def test_api_transport_webhook_post(self) -> None:
