...
class TestTransportFortySixElksApi(unittest.TestCase):
    """TransportFortySixElksApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportFortySixElksApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_forty_six_elks_get_collection(self) -> None:
    ...
    def test_api_transport_forty_six_elks_id_delete(self) -> None:
    ...
    def test_api_transport_forty_six_elks_id_get(self) -> None:
    ...
    def test_api_transport_forty_six_elks_id_patch(self) -> None:
    ...
    def test_api_transport_forty_six_elks_id_put(self) -> None:
    ...
    def test_api_transport_forty_six_elks_post(self) -> None:
