...
class TestApiTransportGitterGetCollection200Response(unittest.TestCase):
    """ApiTransportGitterGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportGitterGetCollection200Response:
        """Test ApiTransportGitterGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportGitterGetCollection200Response`
        """
        model = ApiTransportGitterGetCollection200Response()
        if include_optional:
            return ApiTransportGitterGetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_gitter/jsonld_get.TransportGitter.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportGitterGetCollection200Response(self):
        """Test ApiTransportGitterGetCollection200Response"""
