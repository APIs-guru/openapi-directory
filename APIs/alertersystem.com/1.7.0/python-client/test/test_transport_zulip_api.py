...
class TestTransportZulipApi(unittest.TestCase):
    """TransportZulipApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportZulipApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_zulip_get_collection(self) -> None:
    ...
    def test_api_transport_zulip_id_delete(self) -> None:
    ...
    def test_api_transport_zulip_id_get(self) -> None:
    ...
    def test_api_transport_zulip_id_patch(self) -> None:
    ...
    def test_api_transport_zulip_id_put(self) -> None:
    ...
    def test_api_transport_zulip_post(self) -> None:
