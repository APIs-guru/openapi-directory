...
class TestTransportSmsmodeApi(unittest.TestCase):
    """TransportSmsmodeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportSmsmodeApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_smsmode_get_collection(self) -> None:
    ...
    def test_api_transport_smsmode_id_delete(self) -> None:
    ...
    def test_api_transport_smsmode_id_get(self) -> None:
    ...
    def test_api_transport_smsmode_id_patch(self) -> None:
    ...
    def test_api_transport_smsmode_id_put(self) -> None:
    ...
    def test_api_transport_smsmode_post(self) -> None:
