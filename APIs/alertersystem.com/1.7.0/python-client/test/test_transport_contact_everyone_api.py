...
class TestTransportContactEveryoneApi(unittest.TestCase):
    """TransportContactEveryoneApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportContactEveryoneApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_contact_everyone_get_collection(self) -> None:
    ...
    def test_api_transport_contact_everyone_id_delete(self) -> None:
    ...
    def test_api_transport_contact_everyone_id_get(self) -> None:
    ...
    def test_api_transport_contact_everyone_id_patch(self) -> None:
    ...
    def test_api_transport_contact_everyone_id_put(self) -> None:
    ...
    def test_api_transport_contact_everyone_post(self) -> None:
