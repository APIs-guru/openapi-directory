...
class TestTransportFreeMobileApi(unittest.TestCase):
    """TransportFreeMobileApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportFreeMobileApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_free_mobile_get_collection(self) -> None:
    ...
    def test_api_transport_free_mobile_id_delete(self) -> None:
    ...
    def test_api_transport_free_mobile_id_get(self) -> None:
    ...
    def test_api_transport_free_mobile_id_patch(self) -> None:
    ...
    def test_api_transport_free_mobile_id_put(self) -> None:
    ...
    def test_api_transport_free_mobile_post(self) -> None:
