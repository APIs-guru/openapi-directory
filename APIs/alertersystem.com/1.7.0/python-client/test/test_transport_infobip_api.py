...
class TestTransportInfobipApi(unittest.TestCase):
    """TransportInfobipApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportInfobipApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_infobip_get_collection(self) -> None:
    ...
    def test_api_transport_infobip_id_delete(self) -> None:
    ...
    def test_api_transport_infobip_id_get(self) -> None:
    ...
    def test_api_transport_infobip_id_patch(self) -> None:
    ...
    def test_api_transport_infobip_id_put(self) -> None:
    ...
    def test_api_transport_infobip_post(self) -> None:
