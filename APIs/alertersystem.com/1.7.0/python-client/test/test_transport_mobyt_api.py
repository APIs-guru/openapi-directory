...
class TestTransportMobytApi(unittest.TestCase):
    """TransportMobytApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportMobytApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_mobyt_get_collection(self) -> None:
    ...
    def test_api_transport_mobyt_id_delete(self) -> None:
    ...
    def test_api_transport_mobyt_id_get(self) -> None:
    ...
    def test_api_transport_mobyt_id_patch(self) -> None:
    ...
    def test_api_transport_mobyt_id_put(self) -> None:
    ...
    def test_api_transport_mobyt_post(self) -> None:
