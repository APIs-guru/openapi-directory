...
class TestTransportKazInfoTehApi(unittest.TestCase):
    """TransportKazInfoTehApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportKazInfoTehApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_kaz_info_teh_get_collection(self) -> None:
    ...
    def test_api_transport_kaz_info_teh_id_delete(self) -> None:
    ...
    def test_api_transport_kaz_info_teh_id_get(self) -> None:
    ...
    def test_api_transport_kaz_info_teh_id_patch(self) -> None:
    ...
    def test_api_transport_kaz_info_teh_id_put(self) -> None:
    ...
    def test_api_transport_kaz_info_teh_post(self) -> None:
