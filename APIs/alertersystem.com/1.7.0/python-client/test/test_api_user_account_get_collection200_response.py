...
class TestApiUserAccountGetCollection200Response(unittest.TestCase):
    """ApiUserAccountGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiUserAccountGetCollection200Response:
        """Test ApiUserAccountGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiUserAccountGetCollection200Response`
        """
        model = ApiUserAccountGetCollection200Response()
        if include_optional:
            return ApiUserAccountGetCollection200Response(
                hydramember = [
                    openapi_client.models.user_account/jsonld_get.UserAccount.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
                        account_level_code = '', 
    ...
    def testApiUserAccountGetCollection200Response(self):
        """Test ApiUserAccountGetCollection200Response"""
