...
class TestApiHttpMethodCodeGetCollection200Response(unittest.TestCase):
    """ApiHttpMethodCodeGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiHttpMethodCodeGetCollection200Response:
        """Test ApiHttpMethodCodeGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiHttpMethodCodeGetCollection200Response`
        """
        model = ApiHttpMethodCodeGetCollection200Response()
        if include_optional:
            return ApiHttpMethodCodeGetCollection200Response(
                hydramember = [
                    openapi_client.models.http_method_code/jsonld_get.HttpMethodCode.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
                        code_name = '', 
    ...
    def testApiHttpMethodCodeGetCollection200Response(self):
        """Test ApiHttpMethodCodeGetCollection200Response"""
