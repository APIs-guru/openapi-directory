...
class TestAlertServiceJsonldPut(unittest.TestCase):
    """AlertServiceJsonldPut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertServiceJsonldPut:
        """Test AlertServiceJsonldPut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertServiceJsonldPut`
        """
        model = AlertServiceJsonldPut()
        if include_optional:
            return AlertServiceJsonldPut(
                alert_service_name = '',
                alert_service_notes = '',
                data_segment_code = '',
                media_objects = [
    ...
    def testAlertServiceJsonldPut(self):
        """Test AlertServiceJsonldPut"""
