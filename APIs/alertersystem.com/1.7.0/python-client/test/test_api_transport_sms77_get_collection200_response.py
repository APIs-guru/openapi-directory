...
class TestApiTransportSms77GetCollection200Response(unittest.TestCase):
    """ApiTransportSms77GetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportSms77GetCollection200Response:
        """Test ApiTransportSms77GetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportSms77GetCollection200Response`
        """
        model = ApiTransportSms77GetCollection200Response()
        if include_optional:
            return ApiTransportSms77GetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_sms77/jsonld_get.TransportSms77.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportSms77GetCollection200Response(self):
        """Test ApiTransportSms77GetCollection200Response"""
