...
class TestApiTransportSmscGetCollection200Response(unittest.TestCase):
    """ApiTransportSmscGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportSmscGetCollection200Response:
        """Test ApiTransportSmscGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportSmscGetCollection200Response`
        """
        model = ApiTransportSmscGetCollection200Response()
        if include_optional:
            return ApiTransportSmscGetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_smsc/jsonld_get.TransportSmsc.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportSmscGetCollection200Response(self):
        """Test ApiTransportSmscGetCollection200Response"""
