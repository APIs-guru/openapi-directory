...
class TestApiTransportPushyGetCollection200Response(unittest.TestCase):
    """ApiTransportPushyGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportPushyGetCollection200Response:
        """Test ApiTransportPushyGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportPushyGetCollection200Response`
        """
        model = ApiTransportPushyGetCollection200Response()
        if include_optional:
            return ApiTransportPushyGetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_pushy/jsonld_get.TransportPushy.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportPushyGetCollection200Response(self):
        """Test ApiTransportPushyGetCollection200Response"""
