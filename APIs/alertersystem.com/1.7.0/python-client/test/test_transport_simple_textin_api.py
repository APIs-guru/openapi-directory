...
class TestTransportSimpleTextinApi(unittest.TestCase):
    """TransportSimpleTextinApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportSimpleTextinApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_simple_textin_get_collection(self) -> None:
    ...
    def test_api_transport_simple_textin_id_delete(self) -> None:
    ...
    def test_api_transport_simple_textin_id_get(self) -> None:
    ...
    def test_api_transport_simple_textin_id_patch(self) -> None:
    ...
    def test_api_transport_simple_textin_id_put(self) -> None:
    ...
    def test_api_transport_simple_textin_post(self) -> None:
