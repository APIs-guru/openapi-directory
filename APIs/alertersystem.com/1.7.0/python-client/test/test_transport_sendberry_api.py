...
class TestTransportSendberryApi(unittest.TestCase):
    """TransportSendberryApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TransportSendberryApi()

    def tearDown(self) -> None:
        pass

    def test_api_transport_sendberry_get_collection(self) -> None:
    ...
    def test_api_transport_sendberry_id_delete(self) -> None:
    ...
    def test_api_transport_sendberry_id_get(self) -> None:
    ...
    def test_api_transport_sendberry_id_patch(self) -> None:
    ...
    def test_api_transport_sendberry_id_put(self) -> None:
    ...
    def test_api_transport_sendberry_post(self) -> None:
