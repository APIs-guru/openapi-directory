...
class TestApiTransportTrelloGetCollection200Response(unittest.TestCase):
    """ApiTransportTrelloGetCollection200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiTransportTrelloGetCollection200Response:
        """Test ApiTransportTrelloGetCollection200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiTransportTrelloGetCollection200Response`
        """
        model = ApiTransportTrelloGetCollection200Response()
        if include_optional:
            return ApiTransportTrelloGetCollection200Response(
                hydramember = [
                    openapi_client.models.transport_trello/jsonld_get.TransportTrello.jsonld-get(
                        @context = null, 
                        @id = '', 
                        @type = '', 
    ...
    def testApiTransportTrelloGetCollection200Response(self):
        """Test ApiTransportTrelloGetCollection200Response"""
