...
json = "{}"
# create an instance of TransportSendberryPut from a JSON string
transport_sendberry_put_instance = TransportSendberryPut.from_json(json)
# print the JSON string representation of the object
print(TransportSendberryPut.to_json())

# convert the object into a dict
transport_sendberry_put_dict = transport_sendberry_put_instance.to_dict()
# create an instance of TransportSendberryPut from a dict
transport_sendberry_put_from_dict = TransportSendberryPut.from_dict(transport_sendberry_put_dict)
```
