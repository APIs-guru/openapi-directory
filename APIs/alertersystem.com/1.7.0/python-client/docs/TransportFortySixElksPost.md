...
transport_forty_six_elks_post_instance = TransportFortySixElksPost.from_json(json)
# print the JSON string representation of the object
print(TransportFortySixElksPost.to_json())

# convert the object into a dict
transport_forty_six_elks_post_dict = transport_forty_six_elks_post_instance.to_dict()
# create an instance of TransportFortySixElksPost from a dict
transport_forty_six_elks_post_from_dict = TransportFortySixElksPost.from_dict(transport_forty_six_elks_post_dict)
```
