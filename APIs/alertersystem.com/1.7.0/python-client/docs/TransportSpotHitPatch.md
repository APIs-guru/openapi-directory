...
json = "{}"
# create an instance of TransportSpotHitPatch from a JSON string
transport_spot_hit_patch_instance = TransportSpotHitPatch.from_json(json)
# print the JSON string representation of the object
print(TransportSpotHitPatch.to_json())

# convert the object into a dict
transport_spot_hit_patch_dict = transport_spot_hit_patch_instance.to_dict()
# create an instance of TransportSpotHitPatch from a dict
transport_spot_hit_patch_from_dict = TransportSpotHitPatch.from_dict(transport_spot_hit_patch_dict)
```
