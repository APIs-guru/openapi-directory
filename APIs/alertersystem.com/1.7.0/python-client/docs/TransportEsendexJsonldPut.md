...
json = "{}"
# create an instance of TransportEsendexJsonldPut from a JSON string
transport_esendex_jsonld_put_instance = TransportEsendexJsonldPut.from_json(json)
# print the JSON string representation of the object
print(TransportEsendexJsonldPut.to_json())

# convert the object into a dict
transport_esendex_jsonld_put_dict = transport_esendex_jsonld_put_instance.to_dict()
# create an instance of TransportEsendexJsonldPut from a dict
transport_esendex_jsonld_put_from_dict = TransportEsendexJsonldPut.from_dict(transport_esendex_jsonld_put_dict)
```
