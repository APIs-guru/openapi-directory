...
transport_click_send_jsonld_put_instance = TransportClickSendJsonldPut.from_json(json)
# print the JSON string representation of the object
print(TransportClickSendJsonldPut.to_json())

# convert the object into a dict
transport_click_send_jsonld_put_dict = transport_click_send_jsonld_put_instance.to_dict()
# create an instance of TransportClickSendJsonldPut from a dict
transport_click_send_jsonld_put_from_dict = TransportClickSendJsonldPut.from_dict(transport_click_send_jsonld_put_dict)
```
