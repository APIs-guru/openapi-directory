...
transport_pager_duty_get_instance = TransportPagerDutyGet.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyGet.to_json())

# convert the object into a dict
transport_pager_duty_get_dict = transport_pager_duty_get_instance.to_dict()
# create an instance of TransportPagerDutyGet from a dict
transport_pager_duty_get_from_dict = TransportPagerDutyGet.from_dict(transport_pager_duty_get_dict)
```
