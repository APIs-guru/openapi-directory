...
json = "{}"
# create an instance of TransportMobytGet from a JSON string
transport_mobyt_get_instance = TransportMobytGet.from_json(json)
# print the JSON string representation of the object
print(TransportMobytGet.to_json())

# convert the object into a dict
transport_mobyt_get_dict = transport_mobyt_get_instance.to_dict()
# create an instance of TransportMobytGet from a dict
transport_mobyt_get_from_dict = TransportMobytGet.from_dict(transport_mobyt_get_dict)
```
