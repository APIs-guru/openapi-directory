...
transport_pager_tree_post_instance = TransportPagerTreePost.from_json(json)
# print the JSON string representation of the object
print(TransportPagerTreePost.to_json())

# convert the object into a dict
transport_pager_tree_post_dict = transport_pager_tree_post_instance.to_dict()
# create an instance of TransportPagerTreePost from a dict
transport_pager_tree_post_from_dict = TransportPagerTreePost.from_dict(transport_pager_tree_post_dict)
```
