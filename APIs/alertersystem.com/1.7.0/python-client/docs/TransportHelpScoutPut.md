...
transport_help_scout_put_instance = TransportHelpScoutPut.from_json(json)
# print the JSON string representation of the object
print(TransportHelpScoutPut.to_json())

# convert the object into a dict
transport_help_scout_put_dict = transport_help_scout_put_instance.to_dict()
# create an instance of TransportHelpScoutPut from a dict
transport_help_scout_put_from_dict = TransportHelpScoutPut.from_dict(transport_help_scout_put_dict)
```
