...
json = "{}"
# create an instance of TransportFreshdeskJsonldGet from a JSON string
transport_freshdesk_jsonld_get_instance = TransportFreshdeskJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportFreshdeskJsonldGet.to_json())

# convert the object into a dict
transport_freshdesk_jsonld_get_dict = transport_freshdesk_jsonld_get_instance.to_dict()
# create an instance of TransportFreshdeskJsonldGet from a dict
transport_freshdesk_jsonld_get_from_dict = TransportFreshdeskJsonldGet.from_dict(transport_freshdesk_jsonld_get_dict)
```
