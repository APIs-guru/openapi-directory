...
transport_termii_put_instance = TransportTermiiPut.from_json(json)
# print the JSON string representation of the object
print(TransportTermiiPut.to_json())

# convert the object into a dict
transport_termii_put_dict = transport_termii_put_instance.to_dict()
# create an instance of TransportTermiiPut from a dict
transport_termii_put_from_dict = TransportTermiiPut.from_dict(transport_termii_put_dict)
```
