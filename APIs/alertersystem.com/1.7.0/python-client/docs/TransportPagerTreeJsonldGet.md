...
transport_pager_tree_jsonld_get_instance = TransportPagerTreeJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportPagerTreeJsonldGet.to_json())

# convert the object into a dict
transport_pager_tree_jsonld_get_dict = transport_pager_tree_jsonld_get_instance.to_dict()
# create an instance of TransportPagerTreeJsonldGet from a dict
transport_pager_tree_jsonld_get_from_dict = TransportPagerTreeJsonldGet.from_dict(transport_pager_tree_jsonld_get_dict)
```
