...
json = "{}"
# create an instance of TransportOpsgeniePost from a JSON string
transport_opsgenie_post_instance = TransportOpsgeniePost.from_json(json)
# print the JSON string representation of the object
print(TransportOpsgeniePost.to_json())

# convert the object into a dict
transport_opsgenie_post_dict = transport_opsgenie_post_instance.to_dict()
# create an instance of TransportOpsgeniePost from a dict
transport_opsgenie_post_from_dict = TransportOpsgeniePost.from_dict(transport_opsgenie_post_dict)
```
