...
transport_pager_duty_patch_instance = TransportPagerDutyPatch.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyPatch.to_json())

# convert the object into a dict
transport_pager_duty_patch_dict = transport_pager_duty_patch_instance.to_dict()
# create an instance of TransportPagerDutyPatch from a dict
transport_pager_duty_patch_from_dict = TransportPagerDutyPatch.from_dict(transport_pager_duty_patch_dict)
```
