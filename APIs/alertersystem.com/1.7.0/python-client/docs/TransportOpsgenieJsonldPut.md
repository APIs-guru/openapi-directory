...
json = "{}"
# create an instance of TransportOpsgenieJsonldPut from a JSON string
transport_opsgenie_jsonld_put_instance = TransportOpsgenieJsonldPut.from_json(json)
# print the JSON string representation of the object
print(TransportOpsgenieJsonldPut.to_json())

# convert the object into a dict
transport_opsgenie_jsonld_put_dict = transport_opsgenie_jsonld_put_instance.to_dict()
# create an instance of TransportOpsgenieJsonldPut from a dict
transport_opsgenie_jsonld_put_from_dict = TransportOpsgenieJsonldPut.from_dict(transport_opsgenie_jsonld_put_dict)
```
