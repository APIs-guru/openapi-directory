...
transport_ovh_cloud_put_instance = TransportOvhCloudPut.from_json(json)
# print the JSON string representation of the object
print(TransportOvhCloudPut.to_json())

# convert the object into a dict
transport_ovh_cloud_put_dict = transport_ovh_cloud_put_instance.to_dict()
# create an instance of TransportOvhCloudPut from a dict
transport_ovh_cloud_put_from_dict = TransportOvhCloudPut.from_dict(transport_ovh_cloud_put_dict)
```
