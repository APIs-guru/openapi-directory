...
transport_help_scout_patch_instance = TransportHelpScoutPatch.from_json(json)
# print the JSON string representation of the object
print(TransportHelpScoutPatch.to_json())

# convert the object into a dict
transport_help_scout_patch_dict = transport_help_scout_patch_instance.to_dict()
# create an instance of TransportHelpScoutPatch from a dict
transport_help_scout_patch_from_dict = TransportHelpScoutPatch.from_dict(transport_help_scout_patch_dict)
```
