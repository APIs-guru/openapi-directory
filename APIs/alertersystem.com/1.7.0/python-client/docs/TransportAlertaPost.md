...
transport_alerta_post_instance = TransportAlertaPost.from_json(json)
# print the JSON string representation of the object
print(TransportAlertaPost.to_json())

# convert the object into a dict
transport_alerta_post_dict = transport_alerta_post_instance.to_dict()
# create an instance of TransportAlertaPost from a dict
transport_alerta_post_from_dict = TransportAlertaPost.from_dict(transport_alerta_post_dict)
```
