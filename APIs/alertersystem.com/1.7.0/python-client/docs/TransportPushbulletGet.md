...
transport_pushbullet_get_instance = TransportPushbulletGet.from_json(json)
# print the JSON string representation of the object
print(TransportPushbulletGet.to_json())

# convert the object into a dict
transport_pushbullet_get_dict = transport_pushbullet_get_instance.to_dict()
# create an instance of TransportPushbulletGet from a dict
transport_pushbullet_get_from_dict = TransportPushbulletGet.from_dict(transport_pushbullet_get_dict)
```
