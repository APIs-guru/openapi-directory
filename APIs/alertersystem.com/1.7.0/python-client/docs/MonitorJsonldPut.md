...
monitor_jsonld_put_instance = MonitorJsonldPut.from_json(json)
# print the JSON string representation of the object
print(MonitorJsonldPut.to_json())

# convert the object into a dict
monitor_jsonld_put_dict = monitor_jsonld_put_instance.to_dict()
# create an instance of MonitorJsonldPut from a dict
monitor_jsonld_put_from_dict = MonitorJsonldPut.from_dict(monitor_jsonld_put_dict)
```
