...
json = "{}"
# create an instance of AlertServiceJsonldPost from a JSON string
alert_service_jsonld_post_instance = AlertServiceJsonldPost.from_json(json)
# print the JSON string representation of the object
print(AlertServiceJsonldPost.to_json())

# convert the object into a dict
alert_service_jsonld_post_dict = alert_service_jsonld_post_instance.to_dict()
# create an instance of AlertServiceJsonldPost from a dict
alert_service_jsonld_post_from_dict = AlertServiceJsonldPost.from_dict(alert_service_jsonld_post_dict)
```
