...
json = "{}"
# create an instance of TransportOrangeSmsPost from a JSON string
transport_orange_sms_post_instance = TransportOrangeSmsPost.from_json(json)
# print the JSON string representation of the object
print(TransportOrangeSmsPost.to_json())

# convert the object into a dict
transport_orange_sms_post_dict = transport_orange_sms_post_instance.to_dict()
# create an instance of TransportOrangeSmsPost from a dict
transport_orange_sms_post_from_dict = TransportOrangeSmsPost.from_dict(transport_orange_sms_post_dict)
```
