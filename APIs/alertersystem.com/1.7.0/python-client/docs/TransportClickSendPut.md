...
json = "{}"
# create an instance of TransportClickSendPut from a JSON string
transport_click_send_put_instance = TransportClickSendPut.from_json(json)
# print the JSON string representation of the object
print(TransportClickSendPut.to_json())

# convert the object into a dict
transport_click_send_put_dict = transport_click_send_put_instance.to_dict()
# create an instance of TransportClickSendPut from a dict
transport_click_send_put_from_dict = TransportClickSendPut.from_dict(transport_click_send_put_dict)
```
