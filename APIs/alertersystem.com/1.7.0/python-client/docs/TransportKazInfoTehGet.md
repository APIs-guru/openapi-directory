...
transport_kaz_info_teh_get_instance = TransportKazInfoTehGet.from_json(json)
# print the JSON string representation of the object
print(TransportKazInfoTehGet.to_json())

# convert the object into a dict
transport_kaz_info_teh_get_dict = transport_kaz_info_teh_get_instance.to_dict()
# create an instance of TransportKazInfoTehGet from a dict
transport_kaz_info_teh_get_from_dict = TransportKazInfoTehGet.from_dict(transport_kaz_info_teh_get_dict)
```
