...
json = "{}"
# create an instance of TransportIqsmsGet from a JSON string
transport_iqsms_get_instance = TransportIqsmsGet.from_json(json)
# print the JSON string representation of the object
print(TransportIqsmsGet.to_json())

# convert the object into a dict
transport_iqsms_get_dict = transport_iqsms_get_instance.to_dict()
# create an instance of TransportIqsmsGet from a dict
transport_iqsms_get_from_dict = TransportIqsmsGet.from_dict(transport_iqsms_get_dict)
```
