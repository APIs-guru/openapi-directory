...
transport_vonage_post_instance = TransportVonagePost.from_json(json)
# print the JSON string representation of the object
print(TransportVonagePost.to_json())

# convert the object into a dict
transport_vonage_post_dict = transport_vonage_post_instance.to_dict()
# create an instance of TransportVonagePost from a dict
transport_vonage_post_from_dict = TransportVonagePost.from_dict(transport_vonage_post_dict)
```
