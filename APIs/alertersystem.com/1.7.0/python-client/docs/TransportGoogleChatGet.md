...
transport_google_chat_get_instance = TransportGoogleChatGet.from_json(json)
# print the JSON string representation of the object
print(TransportGoogleChatGet.to_json())

# convert the object into a dict
transport_google_chat_get_dict = transport_google_chat_get_instance.to_dict()
# create an instance of TransportGoogleChatGet from a dict
transport_google_chat_get_from_dict = TransportGoogleChatGet.from_dict(transport_google_chat_get_dict)
```
