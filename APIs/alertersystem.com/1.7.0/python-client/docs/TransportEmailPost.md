...
transport_email_post_instance = TransportEmailPost.from_json(json)
# print the JSON string representation of the object
print(TransportEmailPost.to_json())

# convert the object into a dict
transport_email_post_dict = transport_email_post_instance.to_dict()
# create an instance of TransportEmailPost from a dict
transport_email_post_from_dict = TransportEmailPost.from_dict(transport_email_post_dict)
```
