...
json = "{}"
# create an instance of TransportTermiiGet from a JSON string
transport_termii_get_instance = TransportTermiiGet.from_json(json)
# print the JSON string representation of the object
print(TransportTermiiGet.to_json())

# convert the object into a dict
transport_termii_get_dict = transport_termii_get_instance.to_dict()
# create an instance of TransportTermiiGet from a dict
transport_termii_get_from_dict = TransportTermiiGet.from_dict(transport_termii_get_dict)
```
