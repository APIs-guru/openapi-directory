...
transport_trello_post_instance = TransportTrelloPost.from_json(json)
# print the JSON string representation of the object
print(TransportTrelloPost.to_json())

# convert the object into a dict
transport_trello_post_dict = transport_trello_post_instance.to_dict()
# create an instance of TransportTrelloPost from a dict
transport_trello_post_from_dict = TransportTrelloPost.from_dict(transport_trello_post_dict)
```
