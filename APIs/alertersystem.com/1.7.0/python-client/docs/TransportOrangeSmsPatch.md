...
json = "{}"
# create an instance of TransportOrangeSmsPatch from a JSON string
transport_orange_sms_patch_instance = TransportOrangeSmsPatch.from_json(json)
# print the JSON string representation of the object
print(TransportOrangeSmsPatch.to_json())

# convert the object into a dict
transport_orange_sms_patch_dict = transport_orange_sms_patch_instance.to_dict()
# create an instance of TransportOrangeSmsPatch from a dict
transport_orange_sms_patch_from_dict = TransportOrangeSmsPatch.from_dict(transport_orange_sms_patch_dict)
```
