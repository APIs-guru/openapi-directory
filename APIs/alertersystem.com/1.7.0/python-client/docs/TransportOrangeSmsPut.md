...
json = "{}"
# create an instance of TransportOrangeSmsPut from a JSON string
transport_orange_sms_put_instance = TransportOrangeSmsPut.from_json(json)
# print the JSON string representation of the object
print(TransportOrangeSmsPut.to_json())

# convert the object into a dict
transport_orange_sms_put_dict = transport_orange_sms_put_instance.to_dict()
# create an instance of TransportOrangeSmsPut from a dict
transport_orange_sms_put_from_dict = TransportOrangeSmsPut.from_dict(transport_orange_sms_put_dict)
```
