...
json = "{}"
# create an instance of TransportSinchPatch from a JSON string
transport_sinch_patch_instance = TransportSinchPatch.from_json(json)
# print the JSON string representation of the object
print(TransportSinchPatch.to_json())

# convert the object into a dict
transport_sinch_patch_dict = transport_sinch_patch_instance.to_dict()
# create an instance of TransportSinchPatch from a dict
transport_sinch_patch_from_dict = TransportSinchPatch.from_dict(transport_sinch_patch_dict)
```
