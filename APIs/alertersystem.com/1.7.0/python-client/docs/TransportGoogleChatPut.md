...
json = "{}"
# create an instance of TransportGoogleChatPut from a JSON string
transport_google_chat_put_instance = TransportGoogleChatPut.from_json(json)
# print the JSON string representation of the object
print(TransportGoogleChatPut.to_json())

# convert the object into a dict
transport_google_chat_put_dict = transport_google_chat_put_instance.to_dict()
# create an instance of TransportGoogleChatPut from a dict
transport_google_chat_put_from_dict = TransportGoogleChatPut.from_dict(transport_google_chat_put_dict)
```
