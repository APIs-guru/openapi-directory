...
transport_esendex_jsonld_get_instance = TransportEsendexJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportEsendexJsonldGet.to_json())

# convert the object into a dict
transport_esendex_jsonld_get_dict = transport_esendex_jsonld_get_instance.to_dict()
# create an instance of TransportEsendexJsonldGet from a dict
transport_esendex_jsonld_get_from_dict = TransportEsendexJsonldGet.from_dict(transport_esendex_jsonld_get_dict)
```
