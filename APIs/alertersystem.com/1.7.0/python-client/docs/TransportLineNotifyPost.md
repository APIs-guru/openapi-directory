...
transport_line_notify_post_instance = TransportLineNotifyPost.from_json(json)
# print the JSON string representation of the object
print(TransportLineNotifyPost.to_json())

# convert the object into a dict
transport_line_notify_post_dict = transport_line_notify_post_instance.to_dict()
# create an instance of TransportLineNotifyPost from a dict
transport_line_notify_post_from_dict = TransportLineNotifyPost.from_dict(transport_line_notify_post_dict)
```
