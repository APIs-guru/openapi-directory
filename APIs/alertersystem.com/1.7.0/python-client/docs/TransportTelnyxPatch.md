...
json = "{}"
# create an instance of TransportTelnyxPatch from a JSON string
transport_telnyx_patch_instance = TransportTelnyxPatch.from_json(json)
# print the JSON string representation of the object
print(TransportTelnyxPatch.to_json())

# convert the object into a dict
transport_telnyx_patch_dict = transport_telnyx_patch_instance.to_dict()
# create an instance of TransportTelnyxPatch from a dict
transport_telnyx_patch_from_dict = TransportTelnyxPatch.from_dict(transport_telnyx_patch_dict)
```
