...
json = "{}"
# create an instance of TransportHelpScoutPost from a JSON string
transport_help_scout_post_instance = TransportHelpScoutPost.from_json(json)
# print the JSON string representation of the object
print(TransportHelpScoutPost.to_json())

# convert the object into a dict
transport_help_scout_post_dict = transport_help_scout_post_instance.to_dict()
# create an instance of TransportHelpScoutPost from a dict
transport_help_scout_post_from_dict = TransportHelpScoutPost.from_dict(transport_help_scout_post_dict)
```
