...
json = "{}"
# create an instance of TransportPagerTreePut from a JSON string
transport_pager_tree_put_instance = TransportPagerTreePut.from_json(json)
# print the JSON string representation of the object
print(TransportPagerTreePut.to_json())

# convert the object into a dict
transport_pager_tree_put_dict = transport_pager_tree_put_instance.to_dict()
# create an instance of TransportPagerTreePut from a dict
transport_pager_tree_put_from_dict = TransportPagerTreePut.from_dict(transport_pager_tree_put_dict)
```
