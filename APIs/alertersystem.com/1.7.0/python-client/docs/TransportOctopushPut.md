...
transport_octopush_put_instance = TransportOctopushPut.from_json(json)
# print the JSON string representation of the object
print(TransportOctopushPut.to_json())

# convert the object into a dict
transport_octopush_put_dict = transport_octopush_put_instance.to_dict()
# create an instance of TransportOctopushPut from a dict
transport_octopush_put_from_dict = TransportOctopushPut.from_dict(transport_octopush_put_dict)
```
