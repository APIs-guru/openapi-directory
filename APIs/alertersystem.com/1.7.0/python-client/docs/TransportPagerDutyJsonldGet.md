...
transport_pager_duty_jsonld_get_instance = TransportPagerDutyJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyJsonldGet.to_json())

# convert the object into a dict
transport_pager_duty_jsonld_get_dict = transport_pager_duty_jsonld_get_instance.to_dict()
# create an instance of TransportPagerDutyJsonldGet from a dict
transport_pager_duty_jsonld_get_from_dict = TransportPagerDutyJsonldGet.from_dict(transport_pager_duty_jsonld_get_dict)
```
