...
transport_webhook_jsonld_post_instance = TransportWebhookJsonldPost.from_json(json)
# print the JSON string representation of the object
print(TransportWebhookJsonldPost.to_json())

# convert the object into a dict
transport_webhook_jsonld_post_dict = transport_webhook_jsonld_post_instance.to_dict()
# create an instance of TransportWebhookJsonldPost from a dict
transport_webhook_jsonld_post_from_dict = TransportWebhookJsonldPost.from_dict(transport_webhook_jsonld_post_dict)
```
