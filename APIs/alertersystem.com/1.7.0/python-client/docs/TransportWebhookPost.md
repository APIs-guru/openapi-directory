...
transport_webhook_post_instance = TransportWebhookPost.from_json(json)
# print the JSON string representation of the object
print(TransportWebhookPost.to_json())

# convert the object into a dict
transport_webhook_post_dict = transport_webhook_post_instance.to_dict()
# create an instance of TransportWebhookPost from a dict
transport_webhook_post_from_dict = TransportWebhookPost.from_dict(transport_webhook_post_dict)
```
