...
transport_mastodon_post_instance = TransportMastodonPost.from_json(json)
# print the JSON string representation of the object
print(TransportMastodonPost.to_json())

# convert the object into a dict
transport_mastodon_post_dict = transport_mastodon_post_instance.to_dict()
# create an instance of TransportMastodonPost from a dict
transport_mastodon_post_from_dict = TransportMastodonPost.from_dict(transport_mastodon_post_dict)
```
