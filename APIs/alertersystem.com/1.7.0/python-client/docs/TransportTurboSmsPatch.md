...
json = "{}"
# create an instance of TransportTurboSmsPatch from a JSON string
transport_turbo_sms_patch_instance = TransportTurboSmsPatch.from_json(json)
# print the JSON string representation of the object
print(TransportTurboSmsPatch.to_json())

# convert the object into a dict
transport_turbo_sms_patch_dict = transport_turbo_sms_patch_instance.to_dict()
# create an instance of TransportTurboSmsPatch from a dict
transport_turbo_sms_patch_from_dict = TransportTurboSmsPatch.from_dict(transport_turbo_sms_patch_dict)
```
