...
team_member_jsonld_get_instance = TeamMemberJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TeamMemberJsonldGet.to_json())

# convert the object into a dict
team_member_jsonld_get_dict = team_member_jsonld_get_instance.to_dict()
# create an instance of TeamMemberJsonldGet from a dict
team_member_jsonld_get_from_dict = TeamMemberJsonldGet.from_dict(team_member_jsonld_get_dict)
```
