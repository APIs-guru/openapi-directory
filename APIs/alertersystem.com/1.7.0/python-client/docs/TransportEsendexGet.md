...
json = "{}"
# create an instance of TransportEsendexGet from a JSON string
transport_esendex_get_instance = TransportEsendexGet.from_json(json)
# print the JSON string representation of the object
print(TransportEsendexGet.to_json())

# convert the object into a dict
transport_esendex_get_dict = transport_esendex_get_instance.to_dict()
# create an instance of TransportEsendexGet from a dict
transport_esendex_get_from_dict = TransportEsendexGet.from_dict(transport_esendex_get_dict)
```
