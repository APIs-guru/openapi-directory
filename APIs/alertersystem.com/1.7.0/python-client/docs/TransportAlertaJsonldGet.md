...
json = "{}"
# create an instance of TransportAlertaJsonldGet from a JSON string
transport_alerta_jsonld_get_instance = TransportAlertaJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportAlertaJsonldGet.to_json())

# convert the object into a dict
transport_alerta_jsonld_get_dict = transport_alerta_jsonld_get_instance.to_dict()
# create an instance of TransportAlertaJsonldGet from a dict
transport_alerta_jsonld_get_from_dict = TransportAlertaJsonldGet.from_dict(transport_alerta_jsonld_get_dict)
```
