...
transport_pager_duty_jsonld_post_instance = TransportPagerDutyJsonldPost.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyJsonldPost.to_json())

# convert the object into a dict
transport_pager_duty_jsonld_post_dict = transport_pager_duty_jsonld_post_instance.to_dict()
# create an instance of TransportPagerDutyJsonldPost from a dict
transport_pager_duty_jsonld_post_from_dict = TransportPagerDutyJsonldPost.from_dict(transport_pager_duty_jsonld_post_dict)
```
