...
json = "{}"
# create an instance of TransportLineNotifyPut from a JSON string
transport_line_notify_put_instance = TransportLineNotifyPut.from_json(json)
# print the JSON string representation of the object
print(TransportLineNotifyPut.to_json())

# convert the object into a dict
transport_line_notify_put_dict = transport_line_notify_put_instance.to_dict()
# create an instance of TransportLineNotifyPut from a dict
transport_line_notify_put_from_dict = TransportLineNotifyPut.from_dict(transport_line_notify_put_dict)
```
