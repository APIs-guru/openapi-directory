...
transport_alerta_patch_instance = TransportAlertaPatch.from_json(json)
# print the JSON string representation of the object
print(TransportAlertaPatch.to_json())

# convert the object into a dict
transport_alerta_patch_dict = transport_alerta_patch_instance.to_dict()
# create an instance of TransportAlertaPatch from a dict
transport_alerta_patch_from_dict = TransportAlertaPatch.from_dict(transport_alerta_patch_dict)
```
