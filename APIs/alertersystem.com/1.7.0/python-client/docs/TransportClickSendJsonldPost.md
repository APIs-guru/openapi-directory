...
json = "{}"
# create an instance of TransportClickSendJsonldPost from a JSON string
transport_click_send_jsonld_post_instance = TransportClickSendJsonldPost.from_json(json)
# print the JSON string representation of the object
print(TransportClickSendJsonldPost.to_json())

# convert the object into a dict
transport_click_send_jsonld_post_dict = transport_click_send_jsonld_post_instance.to_dict()
# create an instance of TransportClickSendJsonldPost from a dict
transport_click_send_jsonld_post_from_dict = TransportClickSendJsonldPost.from_dict(transport_click_send_jsonld_post_dict)
```
