...
json = "{}"
# create an instance of PingJsonldPost from a JSON string
ping_jsonld_post_instance = PingJsonldPost.from_json(json)
# print the JSON string representation of the object
print(PingJsonldPost.to_json())

# convert the object into a dict
ping_jsonld_post_dict = ping_jsonld_post_instance.to_dict()
# create an instance of PingJsonldPost from a dict
ping_jsonld_post_from_dict = PingJsonldPost.from_dict(ping_jsonld_post_dict)
```
