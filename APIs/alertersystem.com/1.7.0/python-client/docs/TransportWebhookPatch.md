...
json = "{}"
# create an instance of TransportWebhookPatch from a JSON string
transport_webhook_patch_instance = TransportWebhookPatch.from_json(json)
# print the JSON string representation of the object
print(TransportWebhookPatch.to_json())

# convert the object into a dict
transport_webhook_patch_dict = transport_webhook_patch_instance.to_dict()
# create an instance of TransportWebhookPatch from a dict
transport_webhook_patch_from_dict = TransportWebhookPatch.from_dict(transport_webhook_patch_dict)
```
