...
json = "{}"
# create an instance of TransportPlivoPatch from a JSON string
transport_plivo_patch_instance = TransportPlivoPatch.from_json(json)
# print the JSON string representation of the object
print(TransportPlivoPatch.to_json())

# convert the object into a dict
transport_plivo_patch_dict = transport_plivo_patch_instance.to_dict()
# create an instance of TransportPlivoPatch from a dict
transport_plivo_patch_from_dict = TransportPlivoPatch.from_dict(transport_plivo_patch_dict)
```
