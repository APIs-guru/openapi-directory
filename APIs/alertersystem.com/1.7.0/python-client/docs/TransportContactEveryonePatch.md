...
json = "{}"
# create an instance of TransportContactEveryonePatch from a JSON string
transport_contact_everyone_patch_instance = TransportContactEveryonePatch.from_json(json)
# print the JSON string representation of the object
print(TransportContactEveryonePatch.to_json())

# convert the object into a dict
transport_contact_everyone_patch_dict = transport_contact_everyone_patch_instance.to_dict()
# create an instance of TransportContactEveryonePatch from a dict
transport_contact_everyone_patch_from_dict = TransportContactEveryonePatch.from_dict(transport_contact_everyone_patch_dict)
```
