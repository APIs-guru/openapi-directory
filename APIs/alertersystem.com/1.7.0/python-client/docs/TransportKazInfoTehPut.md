...
json = "{}"
# create an instance of TransportKazInfoTehPut from a JSON string
transport_kaz_info_teh_put_instance = TransportKazInfoTehPut.from_json(json)
# print the JSON string representation of the object
print(TransportKazInfoTehPut.to_json())

# convert the object into a dict
transport_kaz_info_teh_put_dict = transport_kaz_info_teh_put_instance.to_dict()
# create an instance of TransportKazInfoTehPut from a dict
transport_kaz_info_teh_put_from_dict = TransportKazInfoTehPut.from_dict(transport_kaz_info_teh_put_dict)
```
