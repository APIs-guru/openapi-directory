...
monitor_jsonld_post_instance = MonitorJsonldPost.from_json(json)
# print the JSON string representation of the object
print(MonitorJsonldPost.to_json())

# convert the object into a dict
monitor_jsonld_post_dict = monitor_jsonld_post_instance.to_dict()
# create an instance of MonitorJsonldPost from a dict
monitor_jsonld_post_from_dict = MonitorJsonldPost.from_dict(monitor_jsonld_post_dict)
```
