...
transport_bandwidth_patch_instance = TransportBandwidthPatch.from_json(json)
# print the JSON string representation of the object
print(TransportBandwidthPatch.to_json())

# convert the object into a dict
transport_bandwidth_patch_dict = transport_bandwidth_patch_instance.to_dict()
# create an instance of TransportBandwidthPatch from a dict
transport_bandwidth_patch_from_dict = TransportBandwidthPatch.from_dict(transport_bandwidth_patch_dict)
```
