...
transport_click_send_jsonld_get_instance = TransportClickSendJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportClickSendJsonldGet.to_json())

# convert the object into a dict
transport_click_send_jsonld_get_dict = transport_click_send_jsonld_get_instance.to_dict()
# create an instance of TransportClickSendJsonldGet from a dict
transport_click_send_jsonld_get_from_dict = TransportClickSendJsonldGet.from_dict(transport_click_send_jsonld_get_dict)
```
