...
json = "{}"
# create an instance of TransportOpsgeniePut from a JSON string
transport_opsgenie_put_instance = TransportOpsgeniePut.from_json(json)
# print the JSON string representation of the object
print(TransportOpsgeniePut.to_json())

# convert the object into a dict
transport_opsgenie_put_dict = transport_opsgenie_put_instance.to_dict()
# create an instance of TransportOpsgeniePut from a dict
transport_opsgenie_put_from_dict = TransportOpsgeniePut.from_dict(transport_opsgenie_put_dict)
```
