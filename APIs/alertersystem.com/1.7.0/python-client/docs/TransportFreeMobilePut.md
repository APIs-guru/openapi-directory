...
json = "{}"
# create an instance of TransportFreeMobilePut from a JSON string
transport_free_mobile_put_instance = TransportFreeMobilePut.from_json(json)
# print the JSON string representation of the object
print(TransportFreeMobilePut.to_json())

# convert the object into a dict
transport_free_mobile_put_dict = transport_free_mobile_put_instance.to_dict()
# create an instance of TransportFreeMobilePut from a dict
transport_free_mobile_put_from_dict = TransportFreeMobilePut.from_dict(transport_free_mobile_put_dict)
```
