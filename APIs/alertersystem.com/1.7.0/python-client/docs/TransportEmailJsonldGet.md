...
transport_email_jsonld_get_instance = TransportEmailJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportEmailJsonldGet.to_json())

# convert the object into a dict
transport_email_jsonld_get_dict = transport_email_jsonld_get_instance.to_dict()
# create an instance of TransportEmailJsonldGet from a dict
transport_email_jsonld_get_from_dict = TransportEmailJsonldGet.from_dict(transport_email_jsonld_get_dict)
```
