...
json = "{}"
# create an instance of TransportAlertaJsonldPut from a JSON string
transport_alerta_jsonld_put_instance = TransportAlertaJsonldPut.from_json(json)
# print the JSON string representation of the object
print(TransportAlertaJsonldPut.to_json())

# convert the object into a dict
transport_alerta_jsonld_put_dict = transport_alerta_jsonld_put_instance.to_dict()
# create an instance of TransportAlertaJsonldPut from a dict
transport_alerta_jsonld_put_from_dict = TransportAlertaJsonldPut.from_dict(transport_alerta_jsonld_put_dict)
```
