...
transport_all_my_sms_patch_instance = TransportAllMySmsPatch.from_json(json)
# print the JSON string representation of the object
print(TransportAllMySmsPatch.to_json())

# convert the object into a dict
transport_all_my_sms_patch_dict = transport_all_my_sms_patch_instance.to_dict()
# create an instance of TransportAllMySmsPatch from a dict
transport_all_my_sms_patch_from_dict = TransportAllMySmsPatch.from_dict(transport_all_my_sms_patch_dict)
```
