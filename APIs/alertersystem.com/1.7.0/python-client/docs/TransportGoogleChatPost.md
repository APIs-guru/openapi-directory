...
transport_google_chat_post_instance = TransportGoogleChatPost.from_json(json)
# print the JSON string representation of the object
print(TransportGoogleChatPost.to_json())

# convert the object into a dict
transport_google_chat_post_dict = transport_google_chat_post_instance.to_dict()
# create an instance of TransportGoogleChatPost from a dict
transport_google_chat_post_from_dict = TransportGoogleChatPost.from_dict(transport_google_chat_post_dict)
```
