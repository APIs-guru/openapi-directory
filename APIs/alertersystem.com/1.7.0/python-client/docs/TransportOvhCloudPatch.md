...
transport_ovh_cloud_patch_instance = TransportOvhCloudPatch.from_json(json)
# print the JSON string representation of the object
print(TransportOvhCloudPatch.to_json())

# convert the object into a dict
transport_ovh_cloud_patch_dict = transport_ovh_cloud_patch_instance.to_dict()
# create an instance of TransportOvhCloudPatch from a dict
transport_ovh_cloud_patch_from_dict = TransportOvhCloudPatch.from_dict(transport_ovh_cloud_patch_dict)
```
