...
json = "{}"
# create an instance of TransportSmsBiurasPut from a JSON string
transport_sms_biuras_put_instance = TransportSmsBiurasPut.from_json(json)
# print the JSON string representation of the object
print(TransportSmsBiurasPut.to_json())

# convert the object into a dict
transport_sms_biuras_put_dict = transport_sms_biuras_put_instance.to_dict()
# create an instance of TransportSmsBiurasPut from a dict
transport_sms_biuras_put_from_dict = TransportSmsBiurasPut.from_dict(transport_sms_biuras_put_dict)
```
