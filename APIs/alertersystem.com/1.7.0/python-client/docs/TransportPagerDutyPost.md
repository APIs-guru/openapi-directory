...
transport_pager_duty_post_instance = TransportPagerDutyPost.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyPost.to_json())

# convert the object into a dict
transport_pager_duty_post_dict = transport_pager_duty_post_instance.to_dict()
# create an instance of TransportPagerDutyPost from a dict
transport_pager_duty_post_from_dict = TransportPagerDutyPost.from_dict(transport_pager_duty_post_dict)
```
