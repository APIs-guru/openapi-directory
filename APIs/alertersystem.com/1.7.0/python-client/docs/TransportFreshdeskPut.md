...
json = "{}"
# create an instance of TransportFreshdeskPut from a JSON string
transport_freshdesk_put_instance = TransportFreshdeskPut.from_json(json)
# print the JSON string representation of the object
print(TransportFreshdeskPut.to_json())

# convert the object into a dict
transport_freshdesk_put_dict = transport_freshdesk_put_instance.to_dict()
# create an instance of TransportFreshdeskPut from a dict
transport_freshdesk_put_from_dict = TransportFreshdeskPut.from_dict(transport_freshdesk_put_dict)
```
