...
transport_alerta_put_instance = TransportAlertaPut.from_json(json)
# print the JSON string representation of the object
print(TransportAlertaPut.to_json())

# convert the object into a dict
transport_alerta_put_dict = transport_alerta_put_instance.to_dict()
# create an instance of TransportAlertaPut from a dict
transport_alerta_put_from_dict = TransportAlertaPut.from_dict(transport_alerta_put_dict)
```
