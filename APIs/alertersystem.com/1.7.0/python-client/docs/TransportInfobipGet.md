...
json = "{}"
# create an instance of TransportInfobipGet from a JSON string
transport_infobip_get_instance = TransportInfobipGet.from_json(json)
# print the JSON string representation of the object
print(TransportInfobipGet.to_json())

# convert the object into a dict
transport_infobip_get_dict = transport_infobip_get_instance.to_dict()
# create an instance of TransportInfobipGet from a dict
transport_infobip_get_from_dict = TransportInfobipGet.from_dict(transport_infobip_get_dict)
```
