...
json = "{}"
# create an instance of TransportBandwidthPost from a JSON string
transport_bandwidth_post_instance = TransportBandwidthPost.from_json(json)
# print the JSON string representation of the object
print(TransportBandwidthPost.to_json())

# convert the object into a dict
transport_bandwidth_post_dict = transport_bandwidth_post_instance.to_dict()
# create an instance of TransportBandwidthPost from a dict
transport_bandwidth_post_from_dict = TransportBandwidthPost.from_dict(transport_bandwidth_post_dict)
```
