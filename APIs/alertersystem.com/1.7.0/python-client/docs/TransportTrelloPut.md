...
json = "{}"
# create an instance of TransportTrelloPut from a JSON string
transport_trello_put_instance = TransportTrelloPut.from_json(json)
# print the JSON string representation of the object
print(TransportTrelloPut.to_json())

# convert the object into a dict
transport_trello_put_dict = transport_trello_put_instance.to_dict()
# create an instance of TransportTrelloPut from a dict
transport_trello_put_from_dict = TransportTrelloPut.from_dict(transport_trello_put_dict)
```
