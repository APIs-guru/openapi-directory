...
ping_jsonld_get_instance = PingJsonldGet.from_json(json)
# print the JSON string representation of the object
print(PingJsonldGet.to_json())

# convert the object into a dict
ping_jsonld_get_dict = ping_jsonld_get_instance.to_dict()
# create an instance of PingJsonldGet from a dict
ping_jsonld_get_from_dict = PingJsonldGet.from_dict(ping_jsonld_get_dict)
```
