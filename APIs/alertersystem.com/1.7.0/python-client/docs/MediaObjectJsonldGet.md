...
media_object_jsonld_get_instance = MediaObjectJsonldGet.from_json(json)
# print the JSON string representation of the object
print(MediaObjectJsonldGet.to_json())

# convert the object into a dict
media_object_jsonld_get_dict = media_object_jsonld_get_instance.to_dict()
# create an instance of MediaObjectJsonldGet from a dict
media_object_jsonld_get_from_dict = MediaObjectJsonldGet.from_dict(media_object_jsonld_get_dict)
```
