...
partition_get_instance = PartitionGet.from_json(json)
# print the JSON string representation of the object
print(PartitionGet.to_json())

# convert the object into a dict
partition_get_dict = partition_get_instance.to_dict()
# create an instance of PartitionGet from a dict
partition_get_from_dict = PartitionGet.from_dict(partition_get_dict)
```
