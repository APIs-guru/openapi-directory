...
json = "{}"
# create an instance of TransportMobytPut from a JSON string
transport_mobyt_put_instance = TransportMobytPut.from_json(json)
# print the JSON string representation of the object
print(TransportMobytPut.to_json())

# convert the object into a dict
transport_mobyt_put_dict = transport_mobyt_put_instance.to_dict()
# create an instance of TransportMobytPut from a dict
transport_mobyt_put_from_dict = TransportMobytPut.from_dict(transport_mobyt_put_dict)
```
