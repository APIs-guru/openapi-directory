...
monitor_jsonld_get_instance = MonitorJsonldGet.from_json(json)
# print the JSON string representation of the object
print(MonitorJsonldGet.to_json())

# convert the object into a dict
monitor_jsonld_get_dict = monitor_jsonld_get_instance.to_dict()
# create an instance of MonitorJsonldGet from a dict
monitor_jsonld_get_from_dict = MonitorJsonldGet.from_dict(monitor_jsonld_get_dict)
```
