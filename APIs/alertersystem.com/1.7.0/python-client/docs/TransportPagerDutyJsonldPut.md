...
json = "{}"
# create an instance of TransportPagerDutyJsonldPut from a JSON string
transport_pager_duty_jsonld_put_instance = TransportPagerDutyJsonldPut.from_json(json)
# print the JSON string representation of the object
print(TransportPagerDutyJsonldPut.to_json())

# convert the object into a dict
transport_pager_duty_jsonld_put_dict = transport_pager_duty_jsonld_put_instance.to_dict()
# create an instance of TransportPagerDutyJsonldPut from a dict
transport_pager_duty_jsonld_put_from_dict = TransportPagerDutyJsonldPut.from_dict(transport_pager_duty_jsonld_put_dict)
```
