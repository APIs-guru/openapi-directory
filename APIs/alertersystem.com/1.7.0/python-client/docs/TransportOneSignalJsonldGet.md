...
transport_one_signal_jsonld_get_instance = TransportOneSignalJsonldGet.from_json(json)
# print the JSON string representation of the object
print(TransportOneSignalJsonldGet.to_json())

# convert the object into a dict
transport_one_signal_jsonld_get_dict = transport_one_signal_jsonld_get_instance.to_dict()
# create an instance of TransportOneSignalJsonldGet from a dict
transport_one_signal_jsonld_get_from_dict = TransportOneSignalJsonldGet.from_dict(transport_one_signal_jsonld_get_dict)
```
