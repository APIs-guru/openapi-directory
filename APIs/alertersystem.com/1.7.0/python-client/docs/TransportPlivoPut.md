...
json = "{}"
# create an instance of TransportPlivoPut from a JSON string
transport_plivo_put_instance = TransportPlivoPut.from_json(json)
# print the JSON string representation of the object
print(TransportPlivoPut.to_json())

# convert the object into a dict
transport_plivo_put_dict = transport_plivo_put_instance.to_dict()
# create an instance of TransportPlivoPut from a dict
transport_plivo_put_from_dict = TransportPlivoPut.from_dict(transport_plivo_put_dict)
```
