...
json = "{}"
# create an instance of TransportEsendexPost from a JSON string
transport_esendex_post_instance = TransportEsendexPost.from_json(json)
# print the JSON string representation of the object
print(TransportEsendexPost.to_json())

# convert the object into a dict
transport_esendex_post_dict = transport_esendex_post_instance.to_dict()
# create an instance of TransportEsendexPost from a dict
transport_esendex_post_from_dict = TransportEsendexPost.from_dict(transport_esendex_post_dict)
```
