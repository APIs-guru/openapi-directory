...
**values** | **List[str]** | The list of items. | [optional] [readonly] 
...
page_bean_string_instance = PageBeanString.from_json(json)
# print the JSON string representation of the object
print(PageBeanString.to_json())

# convert the object into a dict
page_bean_string_dict = page_bean_string_instance.to_dict()
# create an instance of PageBeanString from a dict
page_bean_string_from_dict = PageBeanString.from_dict(page_bean_string_dict)
```
