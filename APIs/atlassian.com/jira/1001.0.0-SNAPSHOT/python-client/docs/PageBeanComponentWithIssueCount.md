...
page_bean_component_with_issue_count_instance = PageBeanComponentWithIssueCount.from_json(json)
# print the JSON string representation of the object
print(PageBeanComponentWithIssueCount.to_json())

# convert the object into a dict
page_bean_component_with_issue_count_dict = page_bean_component_with_issue_count_instance.to_dict()
# create an instance of PageBeanComponentWithIssueCount from a dict
page_bean_component_with_issue_count_from_dict = PageBeanComponentWithIssueCount.from_dict(page_bean_component_with_issue_count_dict)
```
