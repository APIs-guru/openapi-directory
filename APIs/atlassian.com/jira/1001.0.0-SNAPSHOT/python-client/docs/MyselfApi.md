...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.MyselfApi(api_client)

    try:
        # Delete locale
        api_response = api_instance.delete_locale()
        print("The response of MyselfApi->delete_locale:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MyselfApi->delete_locale: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MyselfApi->get_current_user:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MyselfApi->get_locale:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MyselfApi->get_preference:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.MyselfApi(api_client)
    locale = {"locale":"en_US"} # Locale | The locale defined in a LocaleBean.

    try:
        # Set locale
        api_response = api_instance.set_locale(locale)
        print("The response of MyselfApi->set_locale:\n")
        pprint(api_response)
    except Exception as e:
...
# **set_preference**
> object set_preference(key, body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Set preference
        api_response = api_instance.set_preference(key, body)
        print("The response of MyselfApi->set_preference:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **body** | **str**| The value of the preference as a plain text string. The maximum length is 255 characters. | 
