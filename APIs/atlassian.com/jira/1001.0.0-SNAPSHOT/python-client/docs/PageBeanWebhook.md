...
**values** | [**List[Webhook]**](Webhook.md) | The list of items. | [optional] [readonly] 
...
json = "{}"
# create an instance of PageBeanWebhook from a JSON string
page_bean_webhook_instance = PageBeanWebhook.from_json(json)
# print the JSON string representation of the object
print(PageBeanWebhook.to_json())

# convert the object into a dict
page_bean_webhook_dict = page_bean_webhook_instance.to_dict()
# create an instance of PageBeanWebhook from a dict
page_bean_webhook_from_dict = PageBeanWebhook.from_dict(page_bean_webhook_dict)
```
