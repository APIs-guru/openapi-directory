...
page_bean_group_details_instance = PageBeanGroupDetails.from_json(json)
# print the JSON string representation of the object
print(PageBeanGroupDetails.to_json())

# convert the object into a dict
page_bean_group_details_dict = page_bean_group_details_instance.to_dict()
# create an instance of PageBeanGroupDetails from a dict
page_bean_group_details_from_dict = PageBeanGroupDetails.from_dict(page_bean_group_details_dict)
```
