...
**values** | [**List[Comment]**](Comment.md) | The list of items. | [optional] [readonly] 
...
page_bean_comment_instance = PageBeanComment.from_json(json)
# print the JSON string representation of the object
print(PageBeanComment.to_json())

# convert the object into a dict
page_bean_comment_dict = page_bean_comment_instance.to_dict()
# create an instance of PageBeanComment from a dict
page_bean_comment_from_dict = PageBeanComment.from_dict(page_bean_comment_dict)
```
