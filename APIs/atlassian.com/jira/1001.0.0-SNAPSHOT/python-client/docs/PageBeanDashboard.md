...
**values** | [**List[Dashboard]**](Dashboard.md) | The list of items. | [optional] [readonly] 
...
json = "{}"
# create an instance of PageBeanDashboard from a JSON string
page_bean_dashboard_instance = PageBeanDashboard.from_json(json)
# print the JSON string representation of the object
print(PageBeanDashboard.to_json())

# convert the object into a dict
page_bean_dashboard_dict = page_bean_dashboard_instance.to_dict()
# create an instance of PageBeanDashboard from a dict
page_bean_dashboard_from_dict = PageBeanDashboard.from_dict(page_bean_dashboard_dict)
```
