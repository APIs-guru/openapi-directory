...
json = "{}"
# create an instance of PageBeanWorkflowScheme from a JSON string
page_bean_workflow_scheme_instance = PageBeanWorkflowScheme.from_json(json)
# print the JSON string representation of the object
print(PageBeanWorkflowScheme.to_json())

# convert the object into a dict
page_bean_workflow_scheme_dict = page_bean_workflow_scheme_instance.to_dict()
# create an instance of PageBeanWorkflowScheme from a dict
page_bean_workflow_scheme_from_dict = PageBeanWorkflowScheme.from_dict(page_bean_workflow_scheme_dict)
```
