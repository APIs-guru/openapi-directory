...
page_bean_resolution_json_bean_instance = PageBeanResolutionJsonBean.from_json(json)
# print the JSON string representation of the object
print(PageBeanResolutionJsonBean.to_json())

# convert the object into a dict
page_bean_resolution_json_bean_dict = page_bean_resolution_json_bean_instance.to_dict()
# create an instance of PageBeanResolutionJsonBean from a dict
page_bean_resolution_json_bean_from_dict = PageBeanResolutionJsonBean.from_dict(page_bean_resolution_json_bean_dict)
```
