...
json = "{}"
# create an instance of PageBeanNotificationScheme from a JSON string
page_bean_notification_scheme_instance = PageBeanNotificationScheme.from_json(json)
# print the JSON string representation of the object
print(PageBeanNotificationScheme.to_json())

# convert the object into a dict
page_bean_notification_scheme_dict = page_bean_notification_scheme_instance.to_dict()
# create an instance of PageBeanNotificationScheme from a dict
page_bean_notification_scheme_from_dict = PageBeanNotificationScheme.from_dict(page_bean_notification_scheme_dict)
```
