...
page_bean_version_instance = PageBeanVersion.from_json(json)
# print the JSON string representation of the object
print(PageBeanVersion.to_json())

# convert the object into a dict
page_bean_version_dict = page_bean_version_instance.to_dict()
# create an instance of PageBeanVersion from a dict
page_bean_version_from_dict = PageBeanVersion.from_dict(page_bean_version_dict)
```
