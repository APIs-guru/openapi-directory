...
custom_field_value_update_instance = CustomFieldValueUpdate.from_json(json)
# print the JSON string representation of the object
print(CustomFieldValueUpdate.to_json())

# convert the object into a dict
custom_field_value_update_dict = custom_field_value_update_instance.to_dict()
# create an instance of CustomFieldValueUpdate from a dict
custom_field_value_update_from_dict = CustomFieldValueUpdate.from_dict(custom_field_value_update_dict)
```
