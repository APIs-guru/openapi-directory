...
**values** | [**List[Priority]**](Priority.md) | The list of items. | [optional] [readonly] 
...
json = "{}"
# create an instance of PageBeanPriority from a JSON string
page_bean_priority_instance = PageBeanPriority.from_json(json)
# print the JSON string representation of the object
print(PageBeanPriority.to_json())

# convert the object into a dict
page_bean_priority_dict = page_bean_priority_instance.to_dict()
# create an instance of PageBeanPriority from a dict
page_bean_priority_from_dict = PageBeanPriority.from_dict(page_bean_priority_dict)
```
