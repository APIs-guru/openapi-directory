...
page_bean_user_details_instance = PageBeanUserDetails.from_json(json)
# print the JSON string representation of the object
print(PageBeanUserDetails.to_json())

# convert the object into a dict
page_bean_user_details_dict = page_bean_user_details_instance.to_dict()
# create an instance of PageBeanUserDetails from a dict
page_bean_user_details_from_dict = PageBeanUserDetails.from_dict(page_bean_user_details_dict)
```
