...
**values** | [**List[SecurityLevel]**](SecurityLevel.md) | The list of items. | [optional] [readonly] 
...
json = "{}"
# create an instance of PageBeanSecurityLevel from a JSON string
page_bean_security_level_instance = PageBeanSecurityLevel.from_json(json)
# print the JSON string representation of the object
print(PageBeanSecurityLevel.to_json())

# convert the object into a dict
page_bean_security_level_dict = page_bean_security_level_instance.to_dict()
# create an instance of PageBeanSecurityLevel from a dict
page_bean_security_level_from_dict = PageBeanSecurityLevel.from_dict(page_bean_security_level_dict)
```
