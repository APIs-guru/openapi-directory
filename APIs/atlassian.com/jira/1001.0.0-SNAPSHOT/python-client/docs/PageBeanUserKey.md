...
page_bean_user_key_instance = PageBeanUserKey.from_json(json)
# print the JSON string representation of the object
print(PageBeanUserKey.to_json())

# convert the object into a dict
page_bean_user_key_dict = page_bean_user_key_instance.to_dict()
# create an instance of PageBeanUserKey from a dict
page_bean_user_key_from_dict = PageBeanUserKey.from_dict(page_bean_user_key_dict)
```
