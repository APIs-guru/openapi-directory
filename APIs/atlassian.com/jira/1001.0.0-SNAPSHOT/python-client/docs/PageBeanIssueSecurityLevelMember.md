...
page_bean_issue_security_level_member_instance = PageBeanIssueSecurityLevelMember.from_json(json)
# print the JSON string representation of the object
print(PageBeanIssueSecurityLevelMember.to_json())

# convert the object into a dict
page_bean_issue_security_level_member_dict = page_bean_issue_security_level_member_instance.to_dict()
# create an instance of PageBeanIssueSecurityLevelMember from a dict
page_bean_issue_security_level_member_from_dict = PageBeanIssueSecurityLevelMember.from_dict(page_bean_issue_security_level_member_dict)
```
