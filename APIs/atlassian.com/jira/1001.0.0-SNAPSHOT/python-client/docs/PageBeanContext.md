...
**values** | [**List[Context]**](Context.md) | The list of items. | [optional] [readonly] 
...
json = "{}"
# create an instance of PageBeanContext from a JSON string
page_bean_context_instance = PageBeanContext.from_json(json)
# print the JSON string representation of the object
print(PageBeanContext.to_json())

# convert the object into a dict
page_bean_context_dict = page_bean_context_instance.to_dict()
# create an instance of PageBeanContext from a dict
page_bean_context_from_dict = PageBeanContext.from_dict(page_bean_context_dict)
```
