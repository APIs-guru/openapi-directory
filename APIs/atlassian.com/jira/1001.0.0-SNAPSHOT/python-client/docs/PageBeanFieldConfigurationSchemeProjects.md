...
page_bean_field_configuration_scheme_projects_instance = PageBeanFieldConfigurationSchemeProjects.from_json(json)
# print the JSON string representation of the object
print(PageBeanFieldConfigurationSchemeProjects.to_json())

# convert the object into a dict
page_bean_field_configuration_scheme_projects_dict = page_bean_field_configuration_scheme_projects_instance.to_dict()
# create an instance of PageBeanFieldConfigurationSchemeProjects from a dict
page_bean_field_configuration_scheme_projects_from_dict = PageBeanFieldConfigurationSchemeProjects.from_dict(page_bean_field_configuration_scheme_projects_dict)
```
