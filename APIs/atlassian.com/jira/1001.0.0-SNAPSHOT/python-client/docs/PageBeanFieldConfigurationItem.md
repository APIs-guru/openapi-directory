...
page_bean_field_configuration_item_instance = PageBeanFieldConfigurationItem.from_json(json)
# print the JSON string representation of the object
print(PageBeanFieldConfigurationItem.to_json())

# convert the object into a dict
page_bean_field_configuration_item_dict = page_bean_field_configuration_item_instance.to_dict()
# create an instance of PageBeanFieldConfigurationItem from a dict
page_bean_field_configuration_item_from_dict = PageBeanFieldConfigurationItem.from_dict(page_bean_field_configuration_item_dict)
```
