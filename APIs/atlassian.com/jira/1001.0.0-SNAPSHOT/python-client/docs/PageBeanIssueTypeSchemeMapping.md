...
json = "{}"
# create an instance of PageBeanIssueTypeSchemeMapping from a JSON string
page_bean_issue_type_scheme_mapping_instance = PageBeanIssueTypeSchemeMapping.from_json(json)
# print the JSON string representation of the object
print(PageBeanIssueTypeSchemeMapping.to_json())

# convert the object into a dict
page_bean_issue_type_scheme_mapping_dict = page_bean_issue_type_scheme_mapping_instance.to_dict()
# create an instance of PageBeanIssueTypeSchemeMapping from a dict
page_bean_issue_type_scheme_mapping_from_dict = PageBeanIssueTypeSchemeMapping.from_dict(page_bean_issue_type_scheme_mapping_dict)
```
