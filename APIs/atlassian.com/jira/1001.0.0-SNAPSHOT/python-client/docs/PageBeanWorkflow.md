...
page_bean_workflow_instance = PageBeanWorkflow.from_json(json)
# print the JSON string representation of the object
print(PageBeanWorkflow.to_json())

# convert the object into a dict
page_bean_workflow_dict = page_bean_workflow_instance.to_dict()
# create an instance of PageBeanWorkflow from a dict
page_bean_workflow_from_dict = PageBeanWorkflow.from_dict(page_bean_workflow_dict)
```
