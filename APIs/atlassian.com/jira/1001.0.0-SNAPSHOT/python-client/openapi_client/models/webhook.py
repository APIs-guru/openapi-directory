...
class Webhook(BaseModel):
    ...
    expiration_date: Optional[StrictInt] = Field(default=None, description="The date after which the webhook is no longer sent. Use [Extend webhook life](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-webhooks/#api-rest-api-3-webhook-refresh-put) to extend the date.", alias="expirationDate")
    ...
    id: StrictInt = Field(description="The ID of the webhook.")
    ...
    jql_filter: StrictStr = Field(description="The JQL filter that specifies which issues the webhook is sent for.", alias="jqlFilter")
    __properties: ClassVar[List[str]] = ["events", "expirationDate", "fieldIdsFilter", "id", "issuePropertyKeysFilter", "jqlFilter"]
