...
class CustomFieldCreatedContextOptionsList(BaseModel):
    ...
    """ # noqa: E501
    options: Optional[List[CustomFieldContextOption]] = Field(default=None, description="The created custom field options.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [CustomFieldContextOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
