...
class AddNotificationsDetails(BaseModel):
    ...
    """ # noqa: E501
    notification_scheme_events: List[NotificationSchemeEventDetails] = Field(description="The list of notifications which should be added to the notification scheme.", alias="notificationSchemeEvents")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["notificationSchemeEvents"]
