...
class ParsedJqlQueries(BaseModel):
    ...
    """ # noqa: E501
    queries: List[ParsedJqlQuery] = Field(description="A list of parsed JQL queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [ParsedJqlQuery.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
