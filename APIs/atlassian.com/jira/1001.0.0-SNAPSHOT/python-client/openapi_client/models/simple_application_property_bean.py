...
class SimpleApplicationPropertyBean(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the application property.")
    value: Optional[StrictStr] = Field(default=None, description="The new value.")
