...
class JqlQueriesToSanitize(BaseModel):
    ...
    """ # noqa: E501
    queries: List[JqlQueryToSanitize] = Field(description="The list of JQL queries to sanitize. Must contain unique values. Maximum of 20 queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [JqlQueryToSanitize.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
