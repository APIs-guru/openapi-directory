...
class ContainerForProjectFeatures(BaseModel):
    ...
    """ # noqa: E501
    features: Optional[List[ProjectFeature]] = Field(default=None, description="The project features.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": [ProjectFeature.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
