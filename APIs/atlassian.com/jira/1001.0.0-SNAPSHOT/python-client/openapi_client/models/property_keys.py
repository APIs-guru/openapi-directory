...
class PropertyKeys(BaseModel):
    ...
    """ # noqa: E501
    keys: Optional[List[PropertyKey]] = Field(default=None, description="Property key details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [PropertyKey.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
