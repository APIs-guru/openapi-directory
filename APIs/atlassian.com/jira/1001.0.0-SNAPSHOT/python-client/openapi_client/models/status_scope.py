...
class StatusScope(BaseModel):
    ...
    type: StrictStr = Field(description="The scope of the status. `GLOBAL` for company-managed projects and `PROJECT` for team-managed projects.")
    __properties: ClassVar[List[str]] = ["project", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": ProjectId.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "type": obj.get("type")
        })
        return _obj
