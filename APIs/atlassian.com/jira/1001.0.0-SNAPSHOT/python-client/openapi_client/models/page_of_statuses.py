...
class PageOfStatuses(BaseModel):
    ...
    next_page: Optional[StrictStr] = Field(default=None, description="The URL of the next page of results, if any.", alias="nextPage")
    var_self: Optional[StrictStr] = Field(default=None, description="The URL of this page.", alias="self")
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of items that satisfy the search.")
    values: Optional[List[JiraStatus]] = Field(default=None, description="The list of items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [JiraStatus.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
