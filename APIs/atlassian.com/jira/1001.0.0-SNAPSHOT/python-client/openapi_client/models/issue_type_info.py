...
class IssueTypeInfo(BaseModel):
    ...
    """ # noqa: E501
    avatar_id: Optional[StrictInt] = Field(default=None, description="The avatar of the issue type.", alias="avatarId")
    id: Optional[StrictInt] = Field(default=None, description="The ID of the issue type.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the issue type.")
    __properties: ClassVar[List[str]] = ["avatarId", "id", "name"]
