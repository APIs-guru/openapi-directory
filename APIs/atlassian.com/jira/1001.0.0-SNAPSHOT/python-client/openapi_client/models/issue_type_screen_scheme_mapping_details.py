...
class IssueTypeScreenSchemeMappingDetails(BaseModel):
    ...
    """ # noqa: E501
    issue_type_mappings: List[IssueTypeScreenSchemeMapping] = Field(description="The list of issue type to screen scheme mappings. A *default* entry cannot be specified because a default entry is added when an issue type screen scheme is created.", alias="issueTypeMappings")
    __properties: ClassVar[List[str]] = ["issueTypeMappings"]
