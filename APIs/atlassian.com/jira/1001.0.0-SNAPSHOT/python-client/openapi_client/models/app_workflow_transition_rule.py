...
class AppWorkflowTransitionRule(BaseModel):
    ...
    id: StrictStr = Field(description="The ID of the transition rule.")
    key: StrictStr = Field(description="The key of the rule, as defined in the Connect or the Forge app descriptor.")
    transition: Optional[WorkflowTransition] = None
    __properties: ClassVar[List[str]] = ["configuration", "id", "key", "transition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": RuleConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "id": obj.get("id"),
            "key": obj.get("key"),
            "transition": WorkflowTransition.from_dict(obj["transition"]) if obj.get("transition") is not None else None
        })
        return _obj
