...
class SetDefaultPriorityRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the new default issue priority. Must be an existing ID or null. Setting this to null erases the default priority setting.")
