...
class SetDefaultResolutionRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the new default issue resolution. Must be an existing ID or null. Setting this to null erases the default resolution setting.")
