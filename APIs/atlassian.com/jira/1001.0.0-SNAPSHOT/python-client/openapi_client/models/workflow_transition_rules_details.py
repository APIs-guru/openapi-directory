...
class WorkflowTransitionRulesDetails(BaseModel):
    ...
    workflow_rule_ids: List[StrictStr] = Field(description="The list of connect workflow rule IDs.", alias="workflowRuleIds")
    __properties: ClassVar[List[str]] = ["workflowId", "workflowRuleIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflowRuleIds": obj.get("workflowRuleIds")
        })
        return _obj
