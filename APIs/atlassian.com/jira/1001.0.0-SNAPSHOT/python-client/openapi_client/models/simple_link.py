...
class SimpleLink(BaseModel):
    ...
    icon_class: Optional[StrictStr] = Field(default=None, alias="iconClass")
    id: Optional[StrictStr] = None
    label: Optional[StrictStr] = None
    style_class: Optional[StrictStr] = Field(default=None, alias="styleClass")
    title: Optional[StrictStr] = None
    weight: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["href", "iconClass", "id", "label", "styleClass", "title", "weight"]
