...
class JqlFunctionPrecomputationBean(BaseModel):
    ...
    function_key: Optional[StrictStr] = Field(default=None, alias="functionKey")
    ...
    __properties: ClassVar[List[str]] = ["arguments", "created", "field", "functionKey", "functionName", "id", "operator", "updated", "used", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "field": obj.get("field"),
            "functionKey": obj.get("functionKey"),
