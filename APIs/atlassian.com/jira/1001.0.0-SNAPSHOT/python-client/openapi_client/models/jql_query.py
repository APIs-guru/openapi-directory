...
class JqlQuery(BaseModel):
    ...
    A parsed JQL query.
    """ # noqa: E501
    order_by: Optional[JqlQueryOrderByClause] = Field(default=None, alias="orderBy")
    where: Optional[JqlQueryClause] = None
    __properties: ClassVar[List[str]] = ["orderBy", "where"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderBy": JqlQueryOrderByClause.from_dict(obj["orderBy"]) if obj.get("orderBy") is not None else None,
            "where": JqlQueryClause.from_dict(obj["where"]) if obj.get("where") is not None else None
        })
        return _obj
