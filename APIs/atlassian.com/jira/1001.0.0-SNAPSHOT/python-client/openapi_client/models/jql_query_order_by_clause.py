...
class JqlQueryOrderByClause(BaseModel):
    ...
    """ # noqa: E501
    fields: List[JqlQueryOrderByClauseElement] = Field(description="The list of order-by clause fields and their ordering directives.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [JqlQueryOrderByClauseElement.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
