...
class UiModificationDetails(BaseModel):
    ...
    id: StrictStr = Field(description="The ID of the UI modification.")
    name: StrictStr = Field(description="The name of the UI modification. The maximum length is 255 characters.")
    var_self: StrictStr = Field(description="The URL of the UI modification.", alias="self")
    __properties: ClassVar[List[str]] = ["contexts", "data", "description", "id", "name", "self"]
