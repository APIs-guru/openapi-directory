...
class StatusUpdate(BaseModel):
    ...
    id: StrictStr = Field(description="The ID of the status.")
    name: StrictStr = Field(description="The name of the status.")
    status_category: StrictStr = Field(description="The category of the status.", alias="statusCategory")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["description", "id", "name", "statusCategory"]
