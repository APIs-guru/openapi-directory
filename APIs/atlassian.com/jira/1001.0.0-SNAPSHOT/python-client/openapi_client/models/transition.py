...
class Transition(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="The description of the transition.")
    var_from: List[StrictStr] = Field(description="The statuses the transition can start from.", alias="from")
    id: StrictStr = Field(description="The ID of the transition.")
    name: StrictStr = Field(description="The name of the transition.")
    properties: Optional[Dict[str, Any]] = Field(default=None, description="The properties of the transition.")
    ...
    __properties: ClassVar[List[str]] = ["description", "from", "id", "name", "properties", "rules", "screen", "to", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": WorkflowRules.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
            "screen": TransitionScreenDetails.from_dict(obj["screen"]) if obj.get("screen") is not None else None,
            "to": obj.get("to"),
            "type": obj.get("type")
        })
        return _obj
