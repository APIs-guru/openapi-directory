...
class PageBeanScreenScheme(BaseModel):
    ...
    values: Optional[List[ScreenScheme]] = Field(default=None, description="The list of items.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageBeanScreenScheme from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageBeanScreenScheme from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [ScreenScheme.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
