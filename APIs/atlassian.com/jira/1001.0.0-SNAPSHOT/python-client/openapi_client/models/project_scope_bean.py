...
class ProjectScopeBean(BaseModel):
    ...
    def attributes_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['notSelectable', 'defaultValue']):
                raise ValueError("each list item must be one of ('notSelectable', 'defaultValue')")
        return value
