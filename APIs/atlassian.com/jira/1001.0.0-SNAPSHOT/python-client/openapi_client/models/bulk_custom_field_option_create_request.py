...
class BulkCustomFieldOptionCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    options: Optional[List[CustomFieldOptionCreate]] = Field(default=None, description="Details of options to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [CustomFieldOptionCreate.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
