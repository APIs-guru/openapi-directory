...
class SanitizedJqlQueries(BaseModel):
    ...
    """ # noqa: E501
    queries: Optional[List[SanitizedJqlQuery]] = Field(default=None, description="The list of sanitized JQL queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [SanitizedJqlQuery.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
