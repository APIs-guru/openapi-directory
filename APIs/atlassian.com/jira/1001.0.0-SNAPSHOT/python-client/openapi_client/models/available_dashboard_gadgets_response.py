...
class AvailableDashboardGadgetsResponse(BaseModel):
    ...
    """ # noqa: E501
    gadgets: List[AvailableDashboardGadget] = Field(description="The list of available gadgets.")
    __properties: ClassVar[List[str]] = ["gadgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gadgets": [AvailableDashboardGadget.from_dict(_item) for _item in obj["gadgets"]] if obj.get("gadgets") is not None else None
        })
        return _obj
