...
class BulkIssuePropertyUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    expression: Optional[StrictStr] = Field(default=None, description="EXPERIMENTAL. The Jira expression to calculate the value of the property. The value of the expression must be an object that can be converted to JSON, such as a number, boolean, string, list, or map. The context variables available to the expression are `issue` and `user`. Issues for which the expression returns a value whose JSON representation is longer than 32768 characters are ignored.")
    filter: Optional[IssueFilterForBulkPropertySet] = Field(default=None, description="The bulk operation filter.")
    value: Optional[Any] = Field(default=None, description="The value of the property. The value must be a [valid](https://tools.ietf.org/html/rfc4627), non-empty JSON blob. The maximum length is 32768 characters.")
    __properties: ClassVar[List[str]] = ["expression", "filter", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filter": IssueFilterForBulkPropertySet.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "value": obj.get("value")
        })
        return _obj
