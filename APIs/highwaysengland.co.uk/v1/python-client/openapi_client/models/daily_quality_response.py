...
class DailyQualityResponse(BaseModel):
    ...
    """ # noqa: E501
    qualities: Optional[List[Qualities]] = Field(default=None, alias="Qualities")
    row_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["Qualities", "row_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Qualities": [Qualities.from_dict(_item) for _item in obj["Qualities"]] if obj.get("Qualities") is not None else None,
