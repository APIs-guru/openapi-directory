...
class SiteTypeLayer(BaseModel):
    ...
    SiteTypeLayer
    """ # noqa: E501
    sites: Optional[List[Sites]] = Field(default=None, alias="Sites")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SiteTypeLayer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SiteTypeLayer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Sites": [Sites.from_dict(_item) for _item in obj["Sites"]] if obj.get("Sites") is not None else None
        })
        return _obj
