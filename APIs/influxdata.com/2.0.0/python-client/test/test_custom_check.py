...
class TestCustomCheck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomCheck:
        """Test CustomCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomCheck`
        """
        model = CustomCheck()
        if include_optional:
            return CustomCheck(
