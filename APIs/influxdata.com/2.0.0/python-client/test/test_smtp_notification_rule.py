...
class TestSMTPNotificationRule(unittest.TestCase):
    """SMTPNotificationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SMTPNotificationRule:
        """Test SMTPNotificationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SMTPNotificationRule`
        """
        model = SMTPNotificationRule()
        if include_optional:
            return SMTPNotificationRule(
    ...
    def testSMTPNotificationRule(self):
        """Test SMTPNotificationRule"""
