...
class TestCheckDiscriminator(unittest.TestCase):
    """CheckDiscriminator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDiscriminator:
        """Test CheckDiscriminator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDiscriminator`
        """
        model = CheckDiscriminator()
        if include_optional:
    ...
    def testCheckDiscriminator(self):
        """Test CheckDiscriminator"""
