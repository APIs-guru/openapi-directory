...
class TestHTTPNotificationRule(unittest.TestCase):
    """HTTPNotificationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HTTPNotificationRule:
        """Test HTTPNotificationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HTTPNotificationRule`
        """
        model = HTTPNotificationRule()
        if include_optional:
    ...
    def testHTTPNotificationRule(self):
        """Test HTTPNotificationRule"""
