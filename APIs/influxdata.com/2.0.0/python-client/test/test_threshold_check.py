...
class TestThresholdCheck(unittest.TestCase):
    """ThresholdCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThresholdCheck:
        """Test ThresholdCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThresholdCheck`
        """
        model = ThresholdCheck()
        if include_optional:
