...
class TestTelegramNotificationRule(unittest.TestCase):
    """TelegramNotificationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TelegramNotificationRule:
        """Test TelegramNotificationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TelegramNotificationRule`
        """
        model = TelegramNotificationRule()
        if include_optional:
            return TelegramNotificationRule(
    ...
    def testTelegramNotificationRule(self):
        """Test TelegramNotificationRule"""
