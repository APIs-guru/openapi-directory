...
class TestPagerDutyNotificationRule(unittest.TestCase):
    """PagerDutyNotificationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagerDutyNotificationRule:
        """Test PagerDutyNotificationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagerDutyNotificationRule`
        """
        model = PagerDutyNotificationRule()
        if include_optional:
    ...
    def testPagerDutyNotificationRule(self):
        """Test PagerDutyNotificationRule"""
