...
class TestNotificationRuleDiscriminator(unittest.TestCase):
    """NotificationRuleDiscriminator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationRuleDiscriminator:
        """Test NotificationRuleDiscriminator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationRuleDiscriminator`
        """
        model = NotificationRuleDiscriminator()
        if include_optional:
            return NotificationRuleDiscriminator(
    ...
    def testNotificationRuleDiscriminator(self):
        """Test NotificationRuleDiscriminator"""
