...
class TestXYViewProperties(unittest.TestCase):
    """XYViewProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XYViewProperties:
        """Test XYViewProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XYViewProperties`
        """
        model = XYViewProperties()
        if include_optional:
            return XYViewProperties(
