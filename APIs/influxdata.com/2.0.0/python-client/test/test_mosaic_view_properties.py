...
class TestMosaicViewProperties(unittest.TestCase):
    """MosaicViewProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MosaicViewProperties:
        """Test MosaicViewProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MosaicViewProperties`
        """
        model = MosaicViewProperties()
        if include_optional:
            return MosaicViewProperties(
                colors = [
                    ''
                    ],
                fill_columns = [
    ...
    def testMosaicViewProperties(self):
        """Test MosaicViewProperties"""
