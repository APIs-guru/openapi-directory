...
class CustomCheck(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "labels", "lastRunError", "lastRunStatus", "latestCompleted", "links", "name", "orgID", "ownerID", "query", "status", "taskID", "updatedAt", "type"]
