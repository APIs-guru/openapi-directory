...
class MemberExpression(BaseModel):
    ...
    var_property: Optional[PropertyKey] = Field(default=None, alias="property")
    type: Optional[StrictStr] = Field(default=None, description="Type of AST node")
    __properties: ClassVar[List[str]] = ["object", "property", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": Expression.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "property": PropertyKey.from_dict(obj["property"]) if obj.get("property") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
MemberExpression.model_rebuild(raise_errors=False)
