...
class TemplateSummaryDiffDashboardsInner(BaseModel):
    """
    TemplateSummaryDiffDashboardsInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    kind: Optional[TemplateKind] = None
    new: Optional[TemplateSummaryDiffDashboardsInnerNew] = None
    old: Optional[TemplateSummaryDiffDashboardsInnerNew] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "kind": obj.get("kind"),
            "new": TemplateSummaryDiffDashboardsInnerNew.from_dict(obj["new"]) if obj.get("new") is not None else None,
            "old": TemplateSummaryDiffDashboardsInnerNew.from_dict(obj["old"]) if obj.get("old") is not None else None,
