...
class TemplateSummarySummaryVariablesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["arguments", "description", "envReferences", "id", "kind", "labelAssociations", "name", "orgID", "templateMetaName"]
