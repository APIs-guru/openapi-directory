...
class SlackNotificationEndpoint(BaseModel):
    """
    ...
    token: Optional[StrictStr] = Field(default=None, description="Specifies the API token string. Specify either `URL` or `Token`.")
    url: Optional[StrictStr] = Field(default=None, description="Specifies the URL of the Slack endpoint. Specify either `URL` or `Token`.")
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "labels", "links", "name", "orgID", "status", "type", "updatedAt", "userID", "token", "url"]
