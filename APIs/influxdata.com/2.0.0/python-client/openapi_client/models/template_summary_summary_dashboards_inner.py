...
class TemplateSummarySummaryDashboardsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["charts", "description", "envReferences", "id", "kind", "labelAssociations", "name", "orgID", "templateMetaName"]
