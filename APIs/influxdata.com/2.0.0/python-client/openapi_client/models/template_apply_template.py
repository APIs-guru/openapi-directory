...
class TemplateApplyTemplate(BaseModel):
    """
    TemplateApplyTemplate
    """ # noqa: E501
    content_type: Optional[StrictStr] = Field(default=None, alias="contentType")
    contents: Optional[List[TemplateInner]] = None
    sources: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["contentType", "contents", "sources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contents": [TemplateInner.from_dict(_item) for _item in obj["contents"]] if obj.get("contents") is not None else None,
