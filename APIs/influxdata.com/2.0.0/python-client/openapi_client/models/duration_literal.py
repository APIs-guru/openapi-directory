...
class DurationLiteral(BaseModel):
    ...
    values: Optional[List[Duration]] = Field(default=None, description="Duration values")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "values": [Duration.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
