...
class MarkdownViewProperties(BaseModel):
    ...
    shape: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["note", "shape", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarkdownViewProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarkdownViewProperties from a dict"""
        if obj is None:
            return None
