...
class TaskCreateRequest(BaseModel):
    ...
    org_id: Optional[StrictStr] = Field(default=None, description="The ID of the organization that owns this Task.", alias="orgID")
    status: Optional[TaskStatusType] = None
    __properties: ClassVar[List[str]] = ["description", "flux", "org", "orgID", "status"]
