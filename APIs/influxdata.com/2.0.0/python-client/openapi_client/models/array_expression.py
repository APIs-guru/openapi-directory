...
class ArrayExpression(BaseModel):
    ...
    """ # noqa: E501
    elements: Optional[List[Expression]] = Field(default=None, description="Elements of the array")
    type: Optional[StrictStr] = Field(default=None, description="Type of AST node")
    __properties: ClassVar[List[str]] = ["elements", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [Expression.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
ArrayExpression.model_rebuild(raise_errors=False)
