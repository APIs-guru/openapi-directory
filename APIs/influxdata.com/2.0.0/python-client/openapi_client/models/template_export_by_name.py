...
class TemplateExportByName(BaseModel):
    ...
    """ # noqa: E501
    org_ids: Optional[List[TemplateExportByIDOrgIDsInner]] = Field(default=None, alias="orgIDs")
    resources: Optional[TemplateExportByNameResources] = None
    stack_id: Optional[StrictStr] = Field(default=None, alias="stackID")
    __properties: ClassVar[List[str]] = ["orgIDs", "resources", "stackID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orgIDs": [TemplateExportByIDOrgIDsInner.from_dict(_item) for _item in obj["orgIDs"]] if obj.get("orgIDs") is not None else None,
            "resources": TemplateExportByNameResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
