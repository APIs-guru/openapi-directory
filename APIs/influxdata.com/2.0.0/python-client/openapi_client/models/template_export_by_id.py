...
class TemplateExportByID(BaseModel):
    ...
    resources: Optional[TemplateExportByIDResources] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resources": TemplateExportByIDResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
