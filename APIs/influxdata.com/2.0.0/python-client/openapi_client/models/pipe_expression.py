...
class PipeExpression(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["argument", "call", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "call": CallExpression.from_dict(obj["call"]) if obj.get("call") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
PipeExpression.model_rebuild(raise_errors=False)
