...
class TemplateSummary(BaseModel):
    ...
    TemplateSummary
    """ # noqa: E501
    diff: Optional[TemplateSummaryDiff] = None
    errors: Optional[List[TemplateSummaryErrorsInner]] = None
    sources: Optional[List[StrictStr]] = None
    stack_id: Optional[StrictStr] = Field(default=None, alias="stackID")
    summary: Optional[TemplateSummarySummary] = None
    __properties: ClassVar[List[str]] = ["diff", "errors", "sources", "stackID", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "diff": TemplateSummaryDiff.from_dict(obj["diff"]) if obj.get("diff") is not None else None,
            "errors": [TemplateSummaryErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "sources": obj.get("sources"),
            "stackID": obj.get("stackID"),
            "summary": TemplateSummarySummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
