...
class IndexExpression(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["array", "index", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "array": Expression.from_dict(obj["array"]) if obj.get("array") is not None else None,
            "index": Expression.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
IndexExpression.model_rebuild(raise_errors=False)
