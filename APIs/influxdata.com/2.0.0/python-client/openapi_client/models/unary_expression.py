...
class UnaryExpression(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["argument", "operator", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "argument": Expression.from_dict(obj["argument"]) if obj.get("argument") is not None else None,
...
UnaryExpression.model_rebuild(raise_errors=False)
