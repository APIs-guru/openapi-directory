...
class MemberAssignment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["init", "member", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "init": Expression.from_dict(obj["init"]) if obj.get("init") is not None else None,
            "member": MemberExpression.from_dict(obj["member"]) if obj.get("member") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
MemberAssignment.model_rebuild(raise_errors=False)
