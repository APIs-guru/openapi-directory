...
class PagerDutyNotificationEndpoint(BaseModel):
    """
    ...
    client_url: Optional[StrictStr] = Field(default=None, alias="clientURL")
    routing_key: StrictStr = Field(alias="routingKey")
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "labels", "links", "name", "orgID", "status", "type", "updatedAt", "userID", "clientURL", "routingKey"]
