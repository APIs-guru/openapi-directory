...
class PostNotificationEndpoint(NotificationEndpointDiscriminator):
    """
    PostNotificationEndpoint
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "labels", "links", "name", "orgID", "status", "type", "updatedAt", "userID", "token", "url", "clientURL", "routingKey", "authMethod", "contentTemplate", "headers", "method", "password", "username", "channel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostNotificationEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostNotificationEndpoint from a dict"""
        if obj is None:
            return None
