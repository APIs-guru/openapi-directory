...
class TemplateSummaryDiffDashboardsInnerNew(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["charts", "description", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "charts": [TemplateChart.from_dict(_item) for _item in obj["charts"]] if obj.get("charts") is not None else None,
