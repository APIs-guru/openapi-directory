...
class TemplateExportByIDResources(BaseModel):
    """
    TemplateExportByIDResources
    """ # noqa: E501
    id: StrictStr
    kind: TemplateKind
    name: Optional[StrictStr] = Field(default=None, description="if defined with id, name is used for resource exported by id. if defined independently, resources strictly matching name are exported")
