...
class TemplateSummaryDiffTasksInner(BaseModel):
    """
    TemplateSummaryDiffTasksInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    kind: Optional[TemplateKind] = None
    new: Optional[TemplateSummaryDiffTasksInnerNew] = None
    old: Optional[TemplateSummaryDiffTasksInnerNew] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "kind": obj.get("kind"),
            "new": TemplateSummaryDiffTasksInnerNew.from_dict(obj["new"]) if obj.get("new") is not None else None,
            "old": TemplateSummaryDiffTasksInnerNew.from_dict(obj["old"]) if obj.get("old") is not None else None,
