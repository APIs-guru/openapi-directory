...
class TelegrafPlugins(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["os", "plugins", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "os": obj.get("os"),
            "plugins": [TelegrafPlugin.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,
