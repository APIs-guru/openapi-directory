...
class Stack(BaseModel):
    ...
    events: Optional[List[StackEventsInner]] = None
    id: Optional[StrictStr] = None
    org_id: Optional[StrictStr] = Field(default=None, alias="orgID")
    __properties: ClassVar[List[str]] = ["createdAt", "events", "id", "orgID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [StackEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "id": obj.get("id"),
            "orgID": obj.get("orgID")
        })
        return _obj
