...
class DictExpression(BaseModel):
    ...
    """ # noqa: E501
    elements: Optional[List[DictItem]] = Field(default=None, description="Elements of the dictionary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [DictItem.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
DictExpression.model_rebuild(raise_errors=False)
