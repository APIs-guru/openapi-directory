...
class TemplateSummaryDiffNotificationRulesInner(BaseModel):
    """
    TemplateSummaryDiffNotificationRulesInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    kind: Optional[TemplateKind] = None
    new: Optional[TemplateSummaryDiffNotificationRulesInnerNew] = None
    old: Optional[TemplateSummaryDiffNotificationRulesInnerNew] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "kind": obj.get("kind"),
            "new": TemplateSummaryDiffNotificationRulesInnerNew.from_dict(obj["new"]) if obj.get("new") is not None else None,
            "old": TemplateSummaryDiffNotificationRulesInnerNew.from_dict(obj["old"]) if obj.get("old") is not None else None,
