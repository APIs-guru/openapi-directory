...
class SingleStatViewProperties(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["colors", "decimalPlaces", "note", "prefix", "queries", "shape", "showNoteWhenEmpty", "staticLegend", "suffix", "tickPrefix", "tickSuffix", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['single-stat']):
            raise ValueError("must be one of enum values ('single-stat')")
        return value
