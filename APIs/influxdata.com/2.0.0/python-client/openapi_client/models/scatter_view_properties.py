...
class ScatterViewProperties(BaseModel):
    ...
    symbol_columns: List[StrictStr] = Field(alias="symbolColumns")
    ...
    __properties: ClassVar[List[str]] = ["colors", "fillColumns", "generateXAxisTicks", "generateYAxisTicks", "legendColorizeRows", "legendHide", "legendOpacity", "legendOrientationThreshold", "note", "queries", "shape", "showNoteWhenEmpty", "symbolColumns", "timeFormat", "type", "xAxisLabel", "xColumn", "xDomain", "xPrefix", "xSuffix", "xTickStart", "xTickStep", "xTotalTicks", "yAxisLabel", "yColumn", "yDomain", "yPrefix", "ySuffix", "yTickStart", "yTickStep", "yTotalTicks"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scatter']):
            raise ValueError("must be one of enum values ('scatter')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "symbolColumns": obj.get("symbolColumns"),
