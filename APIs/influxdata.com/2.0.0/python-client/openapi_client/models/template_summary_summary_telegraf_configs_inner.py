...
class TemplateSummarySummaryTelegrafConfigsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["config", "description", "metadata", "name", "orgID", "envReferences", "kind", "labelAssociations", "templateMetaName"]
