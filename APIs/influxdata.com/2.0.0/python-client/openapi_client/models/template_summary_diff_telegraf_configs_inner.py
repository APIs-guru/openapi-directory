...
class TemplateSummaryDiffTelegrafConfigsInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "kind": obj.get("kind"),
            "new": TelegrafRequest.from_dict(obj["new"]) if obj.get("new") is not None else None,
            "old": TelegrafRequest.from_dict(obj["old"]) if obj.get("old") is not None else None,
