...
class TemplateSummarySummaryChecksInner(CheckDiscriminator):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "labels", "lastRunError", "lastRunStatus", "latestCompleted", "links", "name", "orgID", "ownerID", "query", "status", "taskID", "updatedAt", "every", "level", "offset", "reportZero", "staleTime", "statusMessageTemplate", "tags", "timeSince", "type", "thresholds", "envReferences", "kind", "labelAssociations", "templateMetaName"]
