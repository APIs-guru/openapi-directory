...
class DictItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "type", "val"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": Expression.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "type": obj.get("type"),
            "val": Expression.from_dict(obj["val"]) if obj.get("val") is not None else None
        })
        return _obj

from openapi_client.models.expression import Expression
# TODO: Rewrite to not use raise_errors
DictItem.model_rebuild(raise_errors=False)
