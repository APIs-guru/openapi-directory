...
class RunManually(BaseModel):
    ...
    RunManually
    """ # noqa: E501
    scheduled_for: Optional[datetime] = Field(default=None, description="Time used for run's \"now\" option, RFC3339.  Default is the server's now time.", alias="scheduledFor")
