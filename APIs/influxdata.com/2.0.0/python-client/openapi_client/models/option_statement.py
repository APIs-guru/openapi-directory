...
class OptionStatement(BaseModel):
    ...
    """ # noqa: E501
    assignment: Optional[OptionStatementAssignment] = None
    type: Optional[StrictStr] = Field(default=None, description="Type of AST node")
    __properties: ClassVar[List[str]] = ["assignment", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignment": OptionStatementAssignment.from_dict(obj["assignment"]) if obj.get("assignment") is not None else None,
            "type": obj.get("type")
        })
        return _obj
...
OptionStatement.model_rebuild(raise_errors=False)
