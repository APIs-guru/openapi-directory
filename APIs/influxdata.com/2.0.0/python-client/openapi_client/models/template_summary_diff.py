...
class TemplateSummaryDiff(BaseModel):
    """
    TemplateSummaryDiff
    """ # noqa: E501
    buckets: Optional[List[TemplateSummaryDiffBucketsInner]] = None
    checks: Optional[List[TemplateSummaryDiffChecksInner]] = None
    dashboards: Optional[List[TemplateSummaryDiffDashboardsInner]] = None
    label_mappings: Optional[List[TemplateSummaryDiffLabelMappingsInner]] = Field(default=None, alias="labelMappings")
    labels: Optional[List[TemplateSummaryDiffLabelsInner]] = None
    notification_endpoints: Optional[List[TemplateSummaryDiffNotificationEndpointsInner]] = Field(default=None, alias="notificationEndpoints")
    notification_rules: Optional[List[TemplateSummaryDiffNotificationRulesInner]] = Field(default=None, alias="notificationRules")
    tasks: Optional[List[TemplateSummaryDiffTasksInner]] = None
    telegraf_configs: Optional[List[TemplateSummaryDiffTelegrafConfigsInner]] = Field(default=None, alias="telegrafConfigs")
    variables: Optional[List[TemplateSummaryDiffVariablesInner]] = None
    __properties: ClassVar[List[str]] = ["buckets", "checks", "dashboards", "labelMappings", "labels", "notificationEndpoints", "notificationRules", "tasks", "telegrafConfigs", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [TemplateSummaryDiffBucketsInner.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None,
            "checks": [TemplateSummaryDiffChecksInner.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None,
            "dashboards": [TemplateSummaryDiffDashboardsInner.from_dict(_item) for _item in obj["dashboards"]] if obj.get("dashboards") is not None else None,
            ...
            "labels": [TemplateSummaryDiffLabelsInner.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
            "notificationEndpoints": [TemplateSummaryDiffNotificationEndpointsInner.from_dict(_item) for _item in obj["notificationEndpoints"]] if obj.get("notificationEndpoints") is not None else None,
            "notificationRules": [TemplateSummaryDiffNotificationRulesInner.from_dict(_item) for _item in obj["notificationRules"]] if obj.get("notificationRules") is not None else None,
            "tasks": [TemplateSummaryDiffTasksInner.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
            "telegrafConfigs": [TemplateSummaryDiffTelegrafConfigsInner.from_dict(_item) for _item in obj["telegrafConfigs"]] if obj.get("telegrafConfigs") is not None else None,
            "variables": [TemplateSummaryDiffVariablesInner.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
