...
class Telegrafs(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Telegrafs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Telegrafs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "configurations": [Telegraf.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
