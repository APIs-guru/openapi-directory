...
class RulesApi:
    ...
    def get_notification_rules_id_query(
        ...
        _param = self._get_notification_rules_id_query_serialize(
            rule_id=rule_id,
    ...
    @validate_call
    def get_notification_rules_id_query_without_preload_content(
        self,
        rule_id: Annotated[StrictStr, Field(description="The notification rule ID.")],
        zap_trace_span: Annotated[Optional[StrictStr], Field(description="OpenTracing span context")] = None,
        _request_timeout: Union[
    ...
    def _get_notification_rules_id_query_serialize(
        self,
        rule_id,
        zap_trace_span,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/notificationRules/{ruleID}/query',
