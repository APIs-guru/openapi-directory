...
class SetupApi:
    ...
    def post_setup(
        self,
        onboarding_request: Annotated[OnboardingRequest, Field(description="Source to create")],
        zap_trace_span: Annotated[Optional[StrictStr], Field(description="OpenTracing span context")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param onboarding_request: Source to create (required)
        ...
        _param = self._post_setup_serialize(
    ...
    @validate_call
    def post_setup_without_preload_content(
        self,
        onboarding_request: Annotated[OnboardingRequest, Field(description="Source to create")],
        zap_trace_span: Annotated[Optional[StrictStr], Field(description="OpenTracing span context")] = None,
        _request_timeout: Union[
