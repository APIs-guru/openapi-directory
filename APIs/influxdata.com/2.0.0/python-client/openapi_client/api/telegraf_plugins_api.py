...
class TelegrafPluginsApi:
    ...
    def get_telegraf_plugins(
        ...
        type: Annotated[Optional[StrictStr], Field(description="The type of plugin desired.")] = None,
        ...
        _param = self._get_telegraf_plugins_serialize(
    ...
    @validate_call
    def get_telegraf_plugins_with_http_info(
        self,
        zap_trace_span: Annotated[Optional[StrictStr], Field(description="OpenTracing span context")] = None,
        type: Annotated[Optional[StrictStr], Field(description="The type of plugin desired.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_telegraf_plugins_without_preload_content(
        self,
        zap_trace_span: Annotated[Optional[StrictStr], Field(description="OpenTracing span context")] = None,
        type: Annotated[Optional[StrictStr], Field(description="The type of plugin desired.")] = None,
        _request_timeout: Union[
    ...
    def _get_telegraf_plugins_serialize(
        self,
        zap_trace_span,
        type,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/telegraf/plugins',
