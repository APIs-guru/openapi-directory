...
slack_notification_rule_instance = SlackNotificationRule.from_json(json)
# print the JSON string representation of the object
print(SlackNotificationRule.to_json())

# convert the object into a dict
slack_notification_rule_dict = slack_notification_rule_instance.to_dict()
# create an instance of SlackNotificationRule from a dict
slack_notification_rule_from_dict = SlackNotificationRule.from_dict(slack_notification_rule_dict)
```
