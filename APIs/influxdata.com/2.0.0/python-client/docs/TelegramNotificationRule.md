...
telegram_notification_rule_instance = TelegramNotificationRule.from_json(json)
# print the JSON string representation of the object
print(TelegramNotificationRule.to_json())

# convert the object into a dict
telegram_notification_rule_dict = telegram_notification_rule_instance.to_dict()
# create an instance of TelegramNotificationRule from a dict
telegram_notification_rule_from_dict = TelegramNotificationRule.from_dict(telegram_notification_rule_dict)
```
