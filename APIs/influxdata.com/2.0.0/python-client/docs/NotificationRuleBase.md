...
notification_rule_base_instance = NotificationRuleBase.from_json(json)
# print the JSON string representation of the object
print(NotificationRuleBase.to_json())

# convert the object into a dict
notification_rule_base_dict = notification_rule_base_instance.to_dict()
# create an instance of NotificationRuleBase from a dict
notification_rule_base_from_dict = NotificationRuleBase.from_dict(notification_rule_base_dict)
```
