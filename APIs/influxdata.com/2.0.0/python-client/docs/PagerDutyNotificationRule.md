...
pager_duty_notification_rule_instance = PagerDutyNotificationRule.from_json(json)
# print the JSON string representation of the object
print(PagerDutyNotificationRule.to_json())

# convert the object into a dict
pager_duty_notification_rule_dict = pager_duty_notification_rule_instance.to_dict()
# create an instance of PagerDutyNotificationRule from a dict
pager_duty_notification_rule_from_dict = PagerDutyNotificationRule.from_dict(pager_duty_notification_rule_dict)
```
