...
class TestLogFlowStartSessionLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogFlowStartSessionLog:
        """Test LogFlowStartSessionLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogFlowStartSessionLog`
        """
        model = LogFlowStartSessionLog()
        if include_optional:
            return LogFlowStartSessionLog(
                session_id = '',
