...
class TestBuildsListToolsetProjects200ResponseTestcloud(unittest.TestCase):
    """BuildsListToolsetProjects200ResponseTestcloud unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildsListToolsetProjects200ResponseTestcloud:
        """Test BuildsListToolsetProjects200ResponseTestcloud
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildsListToolsetProjects200ResponseTestcloud`
        """
        model = BuildsListToolsetProjects200ResponseTestcloud()
        if include_optional:
            return BuildsListToolsetProjects200ResponseTestcloud(
                projects = [
    ...
    def testBuildsListToolsetProjects200ResponseTestcloud(self):
        """Test BuildsListToolsetProjects200ResponseTestcloud"""
