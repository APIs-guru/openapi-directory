...
class TestBranchConfigurationsUpdateRequest(unittest.TestCase):
    """BranchConfigurationsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BranchConfigurationsUpdateRequest:
        """Test BranchConfigurationsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BranchConfigurationsUpdateRequest`
        """
        model = BranchConfigurationsUpdateRequest()
        if include_optional:
    ...
    def testBranchConfigurationsUpdateRequest(self):
        """Test BranchConfigurationsUpdateRequest"""
