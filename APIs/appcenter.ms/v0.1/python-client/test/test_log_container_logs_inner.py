...
class TestLogContainerLogsInner(unittest.TestCase):
    """LogContainerLogsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogContainerLogsInner:
        """Test LogContainerLogsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogContainerLogsInner`
        """
        model = LogContainerLogsInner()
        if include_optional:
            return LogContainerLogsInner(
    ...
    def testLogContainerLogsInner(self):
        """Test LogContainerLogsInner"""
