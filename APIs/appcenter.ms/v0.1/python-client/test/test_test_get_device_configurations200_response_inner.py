...
class TestTestGetDeviceConfigurations200ResponseInner(unittest.TestCase):
    """TestGetDeviceConfigurations200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestGetDeviceConfigurations200ResponseInner:
        """Test TestGetDeviceConfigurations200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestGetDeviceConfigurations200ResponseInner`
        """
        model = TestGetDeviceConfigurations200ResponseInner()
        if include_optional:
            return TestGetDeviceConfigurations200ResponseInner(
                id = '',
    ...
    def testTestGetDeviceConfigurations200ResponseInner(self):
        """Test TestGetDeviceConfigurations200ResponseInner"""
