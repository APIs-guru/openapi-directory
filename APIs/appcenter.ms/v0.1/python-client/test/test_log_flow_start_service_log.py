...
class TestLogFlowStartServiceLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogFlowStartServiceLog:
        """Test LogFlowStartServiceLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogFlowStartServiceLog`
        """
        model = LogFlowStartServiceLog()
        if include_optional:
            return LogFlowStartServiceLog(
                services = [
                    ''
                    ],
