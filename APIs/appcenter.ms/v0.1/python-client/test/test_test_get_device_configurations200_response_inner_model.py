...
class TestTestGetDeviceConfigurations200ResponseInnerModel(unittest.TestCase):
    """TestGetDeviceConfigurations200ResponseInnerModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestGetDeviceConfigurations200ResponseInnerModel:
        """Test TestGetDeviceConfigurations200ResponseInnerModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestGetDeviceConfigurations200ResponseInnerModel`
        """
        model = TestGetDeviceConfigurations200ResponseInnerModel()
        if include_optional:
            return TestGetDeviceConfigurations200ResponseInnerModel(
    ...
    def testTestGetDeviceConfigurations200ResponseInnerModel(self):
        """Test TestGetDeviceConfigurations200ResponseInnerModel"""
