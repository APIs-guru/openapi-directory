...
class TestGenericLogDiagnostics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GenericLogDiagnostics:
        """Test GenericLogDiagnostics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericLogDiagnostics`
        """
        model = GenericLogDiagnostics()
        if include_optional:
            return GenericLogDiagnostics(
