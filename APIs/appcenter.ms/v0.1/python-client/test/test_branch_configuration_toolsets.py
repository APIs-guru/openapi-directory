...
class TestBranchConfigurationToolsets(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BranchConfigurationToolsets:
        """Test BranchConfigurationToolsets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BranchConfigurationToolsets`
        """
        model = BranchConfigurationToolsets()
        if include_optional:
