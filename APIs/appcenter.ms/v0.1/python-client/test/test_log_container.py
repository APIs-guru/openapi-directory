...
class TestLogContainer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogContainer:
        """Test LogContainer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogContainer`
        """
        model = LogContainer()
        if include_optional:
            return LogContainer(
                ...
                logs = [
                    openapi_client.models.log_container_logs_inner.LogContainer_logs_inner(
