...
class TestStartServiceLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StartServiceLog:
        """Test StartServiceLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartServiceLog`
        """
        model = StartServiceLog()
        if include_optional:
            return StartServiceLog(
                services = [
                    ''
                    ],
