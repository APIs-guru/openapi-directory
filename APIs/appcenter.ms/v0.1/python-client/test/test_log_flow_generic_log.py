...
class TestLogFlowGenericLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogFlowGenericLog:
        """Test LogFlowGenericLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogFlowGenericLog`
        """
        model = LogFlowGenericLog()
        if include_optional:
            return LogFlowGenericLog(
                account_id = '',
                auth_provider = '',
