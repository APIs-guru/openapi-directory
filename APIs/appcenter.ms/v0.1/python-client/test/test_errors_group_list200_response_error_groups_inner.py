...
class TestErrorsGroupList200ResponseErrorGroupsInner(unittest.TestCase):
    """ErrorsGroupList200ResponseErrorGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorsGroupList200ResponseErrorGroupsInner:
        """Test ErrorsGroupList200ResponseErrorGroupsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorsGroupList200ResponseErrorGroupsInner`
        """
        model = ErrorsGroupList200ResponseErrorGroupsInner()
        if include_optional:
            return ErrorsGroupList200ResponseErrorGroupsInner(
                app_build = '',
                app_version = '',
                code_raw = '',
                count = 56,
    ...
    def testErrorsGroupList200ResponseErrorGroupsInner(self):
        """Test ErrorsGroupList200ResponseErrorGroupsInner"""
