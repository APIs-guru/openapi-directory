...
class TestLogFlowErrorLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogFlowErrorLog:
        """Test LogFlowErrorLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogFlowErrorLog`
        """
        model = LogFlowErrorLog()
        if include_optional:
            return LogFlowErrorLog(
