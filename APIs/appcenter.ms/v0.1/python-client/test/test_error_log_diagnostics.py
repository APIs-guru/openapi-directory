...
class TestErrorLogDiagnostics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ErrorLogDiagnostics:
        """Test ErrorLogDiagnostics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorLogDiagnostics`
        """
        model = ErrorLogDiagnostics()
        if include_optional:
            return ErrorLogDiagnostics(
                app_launch_toffset = 56,
                id = '',
                session_id = '',
