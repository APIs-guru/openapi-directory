...
class TestLogWithProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogWithProperties:
        """Test LogWithProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogWithProperties`
        """
        model = LogWithProperties()
        if include_optional:
            return LogWithProperties(
                properties = {
                    'key' : ''
                    },
