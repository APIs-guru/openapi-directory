...
json = "{}"
# create an instance of NotificationsGetAppEmailSettings200Response from a JSON string
notifications_get_app_email_settings200_response_instance = NotificationsGetAppEmailSettings200Response.from_json(json)
# print the JSON string representation of the object
print(NotificationsGetAppEmailSettings200Response.to_json())

# convert the object into a dict
notifications_get_app_email_settings200_response_dict = notifications_get_app_email_settings200_response_instance.to_dict()
# create an instance of NotificationsGetAppEmailSettings200Response from a dict
notifications_get_app_email_settings200_response_from_dict = NotificationsGetAppEmailSettings200Response.from_dict(notifications_get_app_email_settings200_response_dict)
```
