...
stores_release_details_instance = StoresReleaseDetails.from_json(json)
# print the JSON string representation of the object
print(StoresReleaseDetails.to_json())

# convert the object into a dict
stores_release_details_dict = stores_release_details_instance.to_dict()
# create an instance of StoresReleaseDetails from a dict
stores_release_details_from_dict = StoresReleaseDetails.from_dict(stores_release_details_dict)
```
