...
tester_app_release_instance = TesterAppRelease.from_json(json)
# print the JSON string representation of the object
print(TesterAppRelease.to_json())

# convert the object into a dict
tester_app_release_dict = tester_app_release_instance.to_dict()
# create an instance of TesterAppRelease from a dict
tester_app_release_from_dict = TesterAppRelease.from_dict(tester_app_release_dict)
```
