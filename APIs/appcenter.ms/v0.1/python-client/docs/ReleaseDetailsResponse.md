...
release_details_response_instance = ReleaseDetailsResponse.from_json(json)
# print the JSON string representation of the object
print(ReleaseDetailsResponse.to_json())

# convert the object into a dict
release_details_response_dict = release_details_response_instance.to_dict()
# create an instance of ReleaseDetailsResponse from a dict
release_details_response_from_dict = ReleaseDetailsResponse.from_dict(release_details_response_dict)
```
