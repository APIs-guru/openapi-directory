...
log_flow_device_instance = LogFlowDevice.from_json(json)
# print the JSON string representation of the object
print(LogFlowDevice.to_json())

# convert the object into a dict
log_flow_device_dict = log_flow_device_instance.to_dict()
# create an instance of LogFlowDevice from a dict
log_flow_device_from_dict = LogFlowDevice.from_dict(log_flow_device_dict)
```
