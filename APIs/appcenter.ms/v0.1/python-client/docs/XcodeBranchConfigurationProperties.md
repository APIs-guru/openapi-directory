...
json = "{}"
# create an instance of XcodeBranchConfigurationProperties from a JSON string
xcode_branch_configuration_properties_instance = XcodeBranchConfigurationProperties.from_json(json)
# print the JSON string representation of the object
print(XcodeBranchConfigurationProperties.to_json())

# convert the object into a dict
xcode_branch_configuration_properties_dict = xcode_branch_configuration_properties_instance.to_dict()
# create an instance of XcodeBranchConfigurationProperties from a dict
xcode_branch_configuration_properties_from_dict = XcodeBranchConfigurationProperties.from_dict(xcode_branch_configuration_properties_dict)
```
