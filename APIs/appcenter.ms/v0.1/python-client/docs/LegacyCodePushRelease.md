...
legacy_code_push_release_instance = LegacyCodePushRelease.from_json(json)
# print the JSON string representation of the object
print(LegacyCodePushRelease.to_json())

# convert the object into a dict
legacy_code_push_release_dict = legacy_code_push_release_instance.to_dict()
# create an instance of LegacyCodePushRelease from a dict
legacy_code_push_release_from_dict = LegacyCodePushRelease.from_dict(legacy_code_push_release_dict)
```
