...
code_push_release_instance = CodePushRelease.from_json(json)
# print the JSON string representation of the object
print(CodePushRelease.to_json())

# convert the object into a dict
code_push_release_dict = code_push_release_instance.to_dict()
# create an instance of CodePushRelease from a dict
code_push_release_from_dict = CodePushRelease.from_dict(code_push_release_dict)
```
