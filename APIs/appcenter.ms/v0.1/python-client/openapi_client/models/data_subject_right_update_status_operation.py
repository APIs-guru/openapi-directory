...
class DataSubjectRightUpdateStatusOperation(BaseModel):
    ...
    request_id: StrictStr = Field(description="Request identifier of the operation", alias="requestId")
    status: StrictStr = Field(description="Operation status")
    __properties: ClassVar[List[str]] = ["participantData", "requestId", "status"]
