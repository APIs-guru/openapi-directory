...
class LegacyDeploymentHistoryResponse(BaseModel):
    ...
    """ # noqa: E501
    history: Optional[List[LegacyDeploymentHistoryResponseHistoryInner]] = Field(default=None, description="Array containing the deployment's package history.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "history": [LegacyDeploymentHistoryResponseHistoryInner.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
