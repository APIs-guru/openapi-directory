...
class DistributionGroupsUserVerifyRequest(BaseModel):
    ...
    """ # noqa: E501
    distribution_group_ids: List[StrictStr] = Field(description="An array of distribution group ids")
    __properties: ClassVar[List[str]] = ["distribution_group_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "distribution_group_ids": obj.get("distribution_group_ids")
        })
        return _obj
