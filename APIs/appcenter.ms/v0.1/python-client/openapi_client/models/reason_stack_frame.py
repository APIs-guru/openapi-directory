...
class ReasonStackFrame(BaseModel):
    ...
    """ # noqa: E501
    app_code: Optional[StrictBool] = Field(default=None, description="this line isn't from any framework")
    ...
    code_formatted: Optional[StrictStr] = Field(default=None, description="Formatted frame string")
    code_raw: Optional[StrictStr] = Field(default=None, description="Unformatted Frame string")
    exception_type: Optional[StrictStr] = Field(default=None, description="Exception type.")
    ...
    os_exception_type: Optional[StrictStr] = Field(default=None, description="OS exception type. (aka. SIGNAL)")
    __properties: ClassVar[List[str]] = ["app_code", "class_method", "class_name", "code_formatted", "code_raw", "exception_type", "file", "framework_name", "language", "line", "method", "method_params", "os_exception_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "os_exception_type": obj.get("os_exception_type")
        })
        return _obj
