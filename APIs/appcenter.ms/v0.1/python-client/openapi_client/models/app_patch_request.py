...
class AppPatchRequest(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the app")
    icon_asset_id: Optional[StrictStr] = Field(default=None, description="The uuid for the icon's asset id from ACFUS")
    ...
    __properties: ClassVar[List[str]] = ["description", "display_name", "icon_asset_id", "icon_url", "name", "release_type"]
