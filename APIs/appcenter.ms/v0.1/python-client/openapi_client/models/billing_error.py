...
class BillingError(BaseModel):
    ...
    Error
    """ # noqa: E501
    error: Optional[BillingAggregatedInformationGetByAppDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": BillingAggregatedInformationGetByAppDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
