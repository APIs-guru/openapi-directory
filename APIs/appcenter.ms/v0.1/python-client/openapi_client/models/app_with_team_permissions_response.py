...
class AppWithTeamPermissionsResponse(BaseModel):
    ...
    team_permissions: Optional[List[StrictStr]] = Field(default=None, description="The permissions the team has for the app")
    __properties: ClassVar[List[str]] = ["description", "display_name", "icon_source", "icon_url", "id", "name", "os", "owner", "release_type", "app_secret", "azure_subscription", "created_at", "member_permissions", "origin", "platform", "updated_at", "team_permissions"]
    ...
    @field_validator('team_permissions')
    def team_permissions_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "team_permissions": obj.get("team_permissions")
        })
        return _obj
