...
class AppGroupResponse(BaseModel):
    ...
    group_id: StrictStr = Field(description="The unique ID (UUID) of the group that the app belongs to")
    ...
    __properties: ClassVar[List[str]] = ["display_name", "group_id", "id", "name", "os", "platform", "release_type"]
