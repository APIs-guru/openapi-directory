...
class AnalyticsListAudiences200Response(BaseModel):
    """
    List of audiences.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, alias="nextLink")
    values: List[AnalyticsListAudiences200ResponseValuesInner] = Field(description="List of audiences.")
    __properties: ClassVar[List[str]] = ["nextLink", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [AnalyticsListAudiences200ResponseValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
