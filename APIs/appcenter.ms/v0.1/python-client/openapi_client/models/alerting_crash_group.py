...
class AlertingCrashGroup(BaseModel):
    ...
    AlertingCrashGroup
    """ # noqa: E501
    app_display_name: Optional[StrictStr] = None
    app_platform: Optional[StrictStr] = Field(default=None, description="SDK/Platform this thread is beeing generated from")
    app_version: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    stack_trace: Optional[List[StrictStr]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["app_display_name", "app_platform", "app_version", "id", "name", "reason", "stack_trace", "url"]
