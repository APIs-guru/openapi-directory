...
class OrganizationsListAdministered200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": OrganizationsListAdministered200ResponseOrganizations.from_dict(obj["organizations"]) if obj.get("organizations") is not None else None
        })
        return _obj
