...
class UserDataResponse(BaseModel):
    ...
    UserDataResponse
    """ # noqa: E501
    avatar_url: Optional[StrictStr] = Field(default=None, description="The url at which the user's avatar can be reached")
    ...
    __properties: ClassVar[List[str]] = ["avatar_url", "display_name", "id", "name"]
