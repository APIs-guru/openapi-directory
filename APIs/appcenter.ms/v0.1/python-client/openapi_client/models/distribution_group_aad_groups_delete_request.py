...
class DistributionGroupAADGroupsDeleteRequest(BaseModel):
    ...
    """ # noqa: E501
    aad_group_ids: Optional[List[StrictStr]] = Field(default=None, description="The list of aad group ids")
    __properties: ClassVar[List[str]] = ["aad_group_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aad_group_ids": obj.get("aad_group_ids")
        })
        return _obj
