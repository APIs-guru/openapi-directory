...
class AppMembershipsValidationResponseDistributionGroupUsersWithMissingMembershipsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["distribution_group_id", "origin", "user_id"]
