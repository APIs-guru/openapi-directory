...
class UpdateCheckResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["update_info"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.update_info:
            _dict['update_info'] = self.update_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "update_info": CodePushAcquisitionUpdateCheck200ResponseUpdateInfo.from_dict(obj["update_info"]) if obj.get("update_info") is not None else None
        })
        return _obj
