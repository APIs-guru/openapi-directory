...
class AccessKeyListResponse(BaseModel):
    ...
    """ # noqa: E501
    access_keys: Optional[List[AccessKeyListResponseAccessKeysInner]] = Field(default=None, description="Array containing the list of existing AccessKeys", alias="accessKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessKeys": [AccessKeyListResponseAccessKeysInner.from_dict(_item) for _item in obj["accessKeys"]] if obj.get("accessKeys") is not None else None
        })
        return _obj
