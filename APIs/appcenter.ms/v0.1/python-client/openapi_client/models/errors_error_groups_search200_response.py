...
class ErrorsErrorGroupsSearch200Response(BaseModel):
    """
    ErrorsErrorGroupsSearch200Response
    """ # noqa: E501
    error_groups: Optional[List[ErrorsGroupList200ResponseErrorGroupsInner]] = Field(default=None, alias="errorGroups")
    has_more_results: Optional[StrictBool] = Field(default=None, alias="hasMoreResults")
    __properties: ClassVar[List[str]] = ["errorGroups", "hasMoreResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errorGroups": [ErrorsGroupList200ResponseErrorGroupsInner.from_dict(_item) for _item in obj["errorGroups"]] if obj.get("errorGroups") is not None else None,
