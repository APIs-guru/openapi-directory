...
class AppleMutifactorLoginRequest(BaseModel):
    ...
    """ # noqa: E501
    authcode: StrictStr = Field(description="This is the six digit OTP used for completing the multi-factor authentication")
    username: StrictStr = Field(description="The username for the Apple Developer account.")
    __properties: ClassVar[List[str]] = ["authcode", "username"]
