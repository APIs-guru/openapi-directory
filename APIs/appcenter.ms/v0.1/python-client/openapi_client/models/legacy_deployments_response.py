...
class LegacyDeploymentsResponse(BaseModel):
    ...
    """ # noqa: E501
    deployments: Optional[List[LegacyDeploymentResponseDeploymentValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deployments": [LegacyDeploymentResponseDeploymentValue.from_dict(_item) for _item in obj["deployments"]] if obj.get("deployments") is not None else None
        })
        return _obj
