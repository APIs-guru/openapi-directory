...
class BuildsDistributeRequestDestinationsInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['store', 'group', 'tester']):
            raise ValueError("must be one of enum values ('store', 'group', 'tester')")
        return value
