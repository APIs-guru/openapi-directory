...
class TesterAppResponse(BaseModel):
    ...
    microsoft_internal: Optional[StrictBool] = Field(default=None, description="it indicates if the app is microsoft internal")
    permissions: Optional[List[StrictStr]] = Field(default=None, description="The permissions associated with the app")
    __properties: ClassVar[List[str]] = ["description", "display_name", "icon_source", "icon_url", "id", "name", "os", "owner", "release_type", "microsoft_internal", "permissions"]
    ...
    def permissions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['can_remove_from_app']):
                raise ValueError("each list item must be one of ('can_remove_from_app')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "microsoft_internal": obj.get("microsoft_internal"),
