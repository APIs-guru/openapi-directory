...
class AnalyticsLanguageCounts200Response(BaseModel):
    """
    AnalyticsLanguageCounts200Response
    """ # noqa: E501
    languages: Optional[List[AnalyticsLanguageCounts200ResponseLanguagesInner]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["languages", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "languages": [AnalyticsLanguageCounts200ResponseLanguagesInner.from_dict(_item) for _item in obj["languages"]] if obj.get("languages") is not None else None,
            "total": obj.get("total")
        })
        return _obj
