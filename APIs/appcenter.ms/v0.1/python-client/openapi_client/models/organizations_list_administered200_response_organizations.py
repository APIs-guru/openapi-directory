...
class OrganizationsListAdministered200ResponseOrganizations(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avatar_url", "created_at", "display_name", "id", "name", "origin", "updated_at"]
