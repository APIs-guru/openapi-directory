...
class ReleasesGetLatestByDistributionGroup200ResponseDistributionStoresInner(BaseModel):
    """
    ReleasesGetLatestByDistributionGroup200ResponseDistributionStoresInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID identifying a unique distribution store.")
