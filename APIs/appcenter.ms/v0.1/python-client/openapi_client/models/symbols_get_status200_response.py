...
class SymbolsGetStatus200Response(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['available', 'ignored', 'missing']):
            raise ValueError("must be one of enum values ('available', 'ignored', 'missing')")
        return value
