...
class AnalyticsEventCount200Response(BaseModel):
    """
    AnalyticsEventCount200Response
    """ # noqa: E501
    count: Optional[List[AnalyticsDeviceCounts200ResponseDailyInner]] = None
    previous_total_count: Optional[StrictInt] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["count", "previous_total_count", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": [AnalyticsDeviceCounts200ResponseDailyInner.from_dict(_item) for _item in obj["count"]] if obj.get("count") is not None else None,
