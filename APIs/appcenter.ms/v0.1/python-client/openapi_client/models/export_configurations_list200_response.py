...
class ExportConfigurationsList200Response(BaseModel):
    """
    List of export configurations
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, alias="nextLink")
    total: Optional[StrictInt] = Field(default=None, description="the total count of exports")
    values: List[ExportConfigurationsList200ResponseValuesInner]
    __properties: ClassVar[List[str]] = ["nextLink", "total", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [ExportConfigurationsList200ResponseValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
