...
class AppleCredentialNonSecretDetailsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: object = Field(description="Apple credentials non-secret data")
    credential_type: Optional[StrictStr] = Field(default=None, description="the type of the credential", alias="credentialType")
    display_name: StrictStr = Field(description="display name of shared connection", alias="displayName")
    service_type: StrictStr = Field(description="service type of shared connection can be apple|gitlab|googleplay|jira", alias="serviceType")
    __properties: ClassVar[List[str]] = ["credentialType", "displayName", "serviceType"]
