...
class CloseAccountOrganizationResponse(BaseModel):
    ...
    collaborators_count: Union[StrictFloat, StrictInt] = Field(description="The number of collaborators from the organization")
    __properties: ClassVar[List[str]] = ["avatar_url", "created_at", "display_name", "id", "name", "origin", "updated_at", "collaborators_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collaborators_count": obj.get("collaborators_count")
        })
        return _obj
