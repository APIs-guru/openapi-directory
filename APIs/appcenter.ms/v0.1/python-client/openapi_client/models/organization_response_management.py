...
class OrganizationResponseManagement(BaseModel):
    ...
    created_at: StrictStr = Field(description="The date when the organization was created")
    ...
    updated_at: StrictStr = Field(description="The date when the organization was updated")
    ...
    email: Optional[StrictStr] = Field(default=None, description="The organization email, if the app was synced from HockeyApp")
    __properties: ClassVar[List[str]] = ["avatar_url", "created_at", "display_name", "id", "name", "origin", "updated_at", "feature_flags", "email"]
