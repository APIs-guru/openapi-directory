...
class TestGetTestReport200ResponseFeaturesInnerTestsInnerRunsInnerStepsInnerStepExecutionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["device_snapshot_id", "status", "timestamp"]
