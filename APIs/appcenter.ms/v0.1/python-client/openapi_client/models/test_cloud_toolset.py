...
class TestCloudToolset(BaseModel):
    ...
    TestCloudToolset
    """ # noqa: E501
    projects: List[BuildsListToolsetProjects200ResponseTestcloudProjectsInner] = Field(description="The TestCloud projects detected")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projects": [BuildsListToolsetProjects200ResponseTestcloudProjectsInner.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
