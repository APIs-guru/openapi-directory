...
class MessageEnvelope(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[Dict[str, Any]] = Field(default=None, description="Body of the message")
    message_id: Optional[StrictStr] = Field(default=None, description="Unique id of the message", alias="messageId")
    message_type: Optional[StrictStr] = Field(default=None, description="Type of the message", alias="messageType")
    __properties: ClassVar[List[str]] = ["message", "messageId", "messageType"]
