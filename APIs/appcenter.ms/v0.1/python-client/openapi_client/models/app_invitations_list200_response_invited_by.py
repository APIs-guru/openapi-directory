...
class AppInvitationsList200ResponseInvitedBy(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avatar_url", "can_change_password", "display_name", "email", "id", "name", "origin", "permissions"]
