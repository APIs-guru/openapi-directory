...
class AnalyticsModelCounts200Response(BaseModel):
    """
    AnalyticsModelCounts200Response
    """ # noqa: E501
    models: Optional[List[AnalyticsModelCounts200ResponseModelsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [AnalyticsModelCounts200ResponseModelsInner.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
            "total": obj.get("total")
        })
        return _obj
