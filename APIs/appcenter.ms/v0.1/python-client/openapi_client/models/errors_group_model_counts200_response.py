...
class ErrorsGroupModelCounts200Response(BaseModel):
    """
    ErrorsGroupModelCounts200Response
    """ # noqa: E501
    error_count: Optional[StrictInt] = Field(default=None, alias="errorCount")
    models: Optional[List[ErrorsGroupModelCounts200ResponseModelsInner]] = None
    __properties: ClassVar[List[str]] = ["errorCount", "models"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "models": [ErrorsGroupModelCounts200ResponseModelsInner.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
