...
class InternalUserSignupResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The current status of the user record after signup")
    __properties: ClassVar[List[str]] = ["display_name", "email", "external_provider", "external_user_id", "id", "name", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Complete', 'NeedsVerification']):
            raise ValueError("must be one of enum values ('Complete', 'NeedsVerification')")
        return value
