...
class BranchConfigurationsGet200Response(BaseModel):
    """
    ...
    id: StrictInt
    __properties: ClassVar[List[str]] = ["artifactVersioning", "badgeIsEnabled", "cloneFromBranch", "signed", "testsEnabled", "toolsets", "trigger", "id"]
