...
class PostRepositoryProviderMappingRequest(BaseModel):
    ...
    """ # noqa: E501
    account_id: StrictStr = Field(description="App Center account id to link to this provider and external id")
    external_account_id: StrictStr = Field(description="Id of user in the external provider service")
    provider: StrictStr = Field(description="Supported external providers of source control repositories")
    __properties: ClassVar[List[str]] = ["account_id", "external_account_id", "provider"]
