...
class PrivateAppleCredentialsSecretResponse(BaseModel):
    ...
    id: StrictStr = Field(description="id of the shared connection")
    is2_fa: Optional[StrictBool] = Field(default=None, description="if the account is a 2FA account or not", alias="is2FA")
    is_valid: Optional[StrictBool] = Field(default=None, description="whether the credentials are valid or not", alias="isValid")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "id", "is2FA", "isValid", "serviceType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrivateAppleCredentialsSecretResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrivateAppleCredentialsSecretResponse from a dict"""
        if obj is None:
            return None
