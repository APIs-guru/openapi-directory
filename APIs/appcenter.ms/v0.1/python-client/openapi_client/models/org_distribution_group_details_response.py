...
class OrgDistributionGroupDetailsResponse(BaseModel):
    ...
    apps: List[OrgDistributionGroupDetailsResponseAllOfApps] = Field(description="The apps associated with the distribution group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apps": [OrgDistributionGroupDetailsResponseAllOfApps.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
