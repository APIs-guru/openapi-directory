...
class PrivateCreateStoreRequest(BaseModel):
    ...
    """ # noqa: E501
    intune_details: Optional[PrivateCreateStoreRequestIntuneDetails] = None
    ...
    __properties: ClassVar[List[str]] = ["intune_details", "name", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "intune_details": PrivateCreateStoreRequestIntuneDetails.from_dict(obj["intune_details"]) if obj.get("intune_details") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
