...
class DeleteReleasesContainer(BaseModel):
    ...
    """ # noqa: E501
    releases: Annotated[List[DeleteReleasesContainerReleasesInner], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "releases": [DeleteReleasesContainerReleasesInner.from_dict(_item) for _item in obj["releases"]] if obj.get("releases") is not None else None
        })
        return _obj
