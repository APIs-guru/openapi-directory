...
class OrganizationUserResponse(BaseModel):
    ...
    joined_at: StrictStr = Field(description="The date when the user joined the organization")
    name: StrictStr = Field(description="The unique name that is used to identify the user.")
    role: StrictStr = Field(description="The role the user has within the organization")
    __properties: ClassVar[List[str]] = ["display_name", "email", "joined_at", "name", "role"]
