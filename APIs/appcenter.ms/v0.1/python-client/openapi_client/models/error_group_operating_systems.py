...
class ErrorGroupOperatingSystems(BaseModel):
    ...
    operating_systems: Optional[List[ErrorsGroupOperatingSystemCounts200ResponseOperatingSystemsInner]] = Field(default=None, alias="operatingSystems")
    __properties: ClassVar[List[str]] = ["errorCount", "operatingSystems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operatingSystems": [ErrorsGroupOperatingSystemCounts200ResponseOperatingSystemsInner.from_dict(_item) for _item in obj["operatingSystems"]] if obj.get("operatingSystems") is not None else None
        })
        return _obj
