...
class DiagnosticIdResponse(BaseModel):
    ...
    """ # noqa: E501
    diagnostic_id: Optional[StrictStr] = Field(default=None, description="diagnostic id")
    __properties: ClassVar[List[str]] = ["diagnostic_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "diagnostic_id": obj.get("diagnostic_id")
        })
        return _obj
