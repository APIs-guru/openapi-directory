...
class LegacyAppListResponse(BaseModel):
    ...
    """ # noqa: E501
    apps: Optional[List[LegacyAppListResponseAppsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [LegacyAppListResponseAppsInner.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None
        })
        return _obj
