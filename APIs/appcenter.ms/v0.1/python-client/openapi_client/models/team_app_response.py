...
class TeamAppResponse(BaseModel):
    ...
    display_name: StrictStr = Field(description="The display name of the team")
    id: StrictStr = Field(description="The internal unique id (UUID) of the team.")
    name: StrictStr = Field(description="The name of the team")
    permissions: Optional[List[StrictStr]] = Field(default=None, description="The permissions the team has for the app")
    __properties: ClassVar[List[str]] = ["description", "display_name", "id", "name", "permissions"]
