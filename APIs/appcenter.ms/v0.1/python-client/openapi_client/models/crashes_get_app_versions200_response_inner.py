...
class CrashesGetAppVersions200ResponseInner(BaseModel):
    """
    CrashesGetAppVersions200ResponseInner
    """ # noqa: E501
    app_id: StrictStr
    app_version: StrictStr
    app_version_id: StrictStr
    build_number: Optional[StrictStr] = None
    display_name: StrictStr
    __properties: ClassVar[List[str]] = ["app_id", "app_version", "app_version_id", "build_number", "display_name"]
