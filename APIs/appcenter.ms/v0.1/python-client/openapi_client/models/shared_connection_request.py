...
class SharedConnectionRequest(BaseModel):
    ...
    data: Optional[AppleConnectionSecretRequestAllOfData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AppleConnectionSecretRequestAllOfData.from_dict(obj["data"]) if obj.get("data") is not None else None,
