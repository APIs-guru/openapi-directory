...
class DiagnosticsException(BaseModel):
    ...
    a exception
    """ # noqa: E501
    frames: List[DiagnosticsExceptionFramesInner] = Field(description="frames of the excetpion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "frames": [DiagnosticsExceptionFramesInner.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None,
            "inner_exceptions": [DiagnosticsException.from_dict(_item) for _item in obj["inner_exceptions"]] if obj.get("inner_exceptions") is not None else None,
...
DiagnosticsException.model_rebuild(raise_errors=False)
