...
class CreateAccessKeyResponse(BaseModel):
    ...
    """ # noqa: E501
    access_key: Optional[AccessKeyListResponseAccessKeysInner] = Field(default=None, alias="accessKey")
    __properties: ClassVar[List[str]] = ["accessKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessKey": AccessKeyListResponseAccessKeysInner.from_dict(obj["accessKey"]) if obj.get("accessKey") is not None else None
        })
        return _obj
