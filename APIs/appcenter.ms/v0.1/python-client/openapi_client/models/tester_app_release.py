...
class TesterAppRelease(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enabled", "id", "is_external_build", "mandatory_update", "origin", "short_version", "uploaded_at", "version", "install_url", "release_notes", "size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TesterAppRelease from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TesterAppRelease from a dict"""
        if obj is None:
            return None
