...
class PostPlaceholderReleaseUploadForDeleteRequest(BaseModel):
    ...
    """ # noqa: E501
    error_details: Optional[StrictStr] = Field(default=None, description="Additional details to identify why the placeholder ReleaseUpload is being created.")
    __properties: ClassVar[List[str]] = ["error_details"]
