...
class DistributionGroupsGetApps200ResponseInner(BaseModel):
    """
    ...
    origin: Optional[StrictStr] = Field(default=None, description="The creation origin of this app")
    platform: Optional[StrictStr] = Field(default=None, description="The platform of the app")
    __properties: ClassVar[List[str]] = ["description", "display_name", "icon_source", "icon_url", "id", "name", "os", "owner", "release_type", "origin", "platform"]
