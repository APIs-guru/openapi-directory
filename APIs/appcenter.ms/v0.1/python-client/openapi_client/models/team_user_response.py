...
class TeamUserResponse(BaseModel):
    ...
    role: StrictStr = Field(description="The role of the user has within the team")
    __properties: ClassVar[List[str]] = ["display_name", "email", "name", "role"]

    @field_validator('role')
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['maintainer', 'collaborator']):
            raise ValueError("must be one of enum values ('maintainer', 'collaborator')")
        return value
