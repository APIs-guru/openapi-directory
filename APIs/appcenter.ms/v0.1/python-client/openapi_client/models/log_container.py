...
class LogContainer(BaseModel):
    ...
    logs: Annotated[List[LogContainerLogsInner], Field(min_length=0)] = Field(description="the list of logs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logs": [LogContainerLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
