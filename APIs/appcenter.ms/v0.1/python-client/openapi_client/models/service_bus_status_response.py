...
class ServiceBusStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr
    subscriptions: Optional[List[ServiceBusStatusResponseSubscriptionsInner]] = None
    __properties: ClassVar[List[str]] = ["status", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [ServiceBusStatusResponseSubscriptionsInner.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
