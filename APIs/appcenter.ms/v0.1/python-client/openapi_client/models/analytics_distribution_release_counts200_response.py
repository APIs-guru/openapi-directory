...
class AnalyticsDistributionReleaseCounts200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [AnalyticsDistributionReleaseCounts200ResponseCountsInner.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None,
            "total": obj.get("total")
        })
        return _obj
