...
class DeviceSetUpdate(BaseModel):
    ...
    """ # noqa: E501
    devices: List[StrictStr] = Field(description="List of device IDs")
    name: StrictStr = Field(description="The name of the device set")
    __properties: ClassVar[List[str]] = ["devices", "name"]
