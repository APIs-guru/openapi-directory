...
class ReleasesPutDistributionGroupRequest(BaseModel):
    """
    ReleasesPutDistributionGroupRequest
    """ # noqa: E501
    mandatory_update: StrictBool = Field(description="Whether a release is mandatory for the given destination")
    __properties: ClassVar[List[str]] = ["mandatory_update"]
