...
class DeviceRegistrationUrl(BaseModel):
    ...
    """ # noqa: E501
    registration_url: StrictStr = Field(description="The url that can be navigated to in order to start the device registration process.")
    __properties: ClassVar[List[str]] = ["registration_url"]
