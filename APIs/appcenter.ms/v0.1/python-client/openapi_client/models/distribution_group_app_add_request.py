...
class DistributionGroupAppAddRequest(BaseModel):
    ...
    """ # noqa: E501
    apps: Optional[List[DistributionGroupsAddAppsRequestAppsInner]] = Field(default=None, description="The list of apps to add to distribution group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [DistributionGroupsAddAppsRequestAppsInner.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None
        })
        return _obj
