...
class AnalyticsCrashCounts200Response(BaseModel):
    """
    AnalyticsCrashCounts200Response
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total crash count.")
    crashes: Optional[List[AnalyticsDeviceCounts200ResponseDailyInner]] = Field(default=None, description="The total crash count for day.")
    __properties: ClassVar[List[str]] = ["count", "crashes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "crashes": [AnalyticsDeviceCounts200ResponseDailyInner.from_dict(_item) for _item in obj["crashes"]] if obj.get("crashes") is not None else None
        })
        return _obj
