...
class BranchProperties(BaseModel):
    ...
    """ # noqa: E501
    branch: Optional[BuildsListBranches200ResponseInnerValueBranch] = None
    enabled: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["branch", "enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branch": BuildsListBranches200ResponseInnerValueBranch.from_dict(obj["branch"]) if obj.get("branch") is not None else None,
