...
class DistributionGroupPrivateResponse(BaseModel):
    ...
    group_type: Optional[StrictStr] = Field(default=None, description="Type of group")
    __properties: ClassVar[List[str]] = ["display_name", "id", "is_public", "name", "origin", "group_type"]
