...
class BugTrackerIssuesResult(BaseModel):
    ...
    """ # noqa: E501
    issues: Optional[List[BugTrackerGetRepoIssueFromCrash200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issues": [BugTrackerGetRepoIssueFromCrash200Response.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
