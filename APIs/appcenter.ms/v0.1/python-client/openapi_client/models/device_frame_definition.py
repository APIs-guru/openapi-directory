...
class DeviceFrameDefinition(BaseModel):
    ...
    """ # noqa: E501
    frame_url: Optional[StrictStr] = Field(default=None, alias="frameUrl")
    height: Optional[Union[StrictFloat, StrictInt]] = None
    screen: Optional[List[Union[StrictFloat, StrictInt]]] = None
    width: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["frameUrl", "height", "screen", "width"]
