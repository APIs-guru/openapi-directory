...
class ErrorsGroupList200ResponseErrorGroupsInner(BaseModel):
    """
    ...
    state: StrictStr
    __properties: ClassVar[List[str]] = ["appBuild", "appVersion", "codeRaw", "count", "deviceCount", "errorGroupId", "exceptionAppCode", "exceptionClassMethod", "exceptionClassName", "exceptionFile", "exceptionLine", "exceptionMessage", "exceptionMethod", "exceptionType", "firstOccurrence", "hidden", "lastOccurrence", "reasonFrames", "annotation", "state"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in reason_frames (list)
        _items = []
        if self.reason_frames:
            for _item_reason_frames in self.reason_frames:
                if _item_reason_frames:
                    _items.append(_item_reason_frames.to_dict())
            _dict['reasonFrames'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exceptionAppCode": obj.get("exceptionAppCode"),
            "exceptionClassMethod": obj.get("exceptionClassMethod"),
            "exceptionClassName": obj.get("exceptionClassName"),
            "exceptionFile": obj.get("exceptionFile"),
            "exceptionLine": obj.get("exceptionLine"),
            "exceptionMessage": obj.get("exceptionMessage"),
            "exceptionMethod": obj.get("exceptionMethod"),
            "exceptionType": obj.get("exceptionType"),
            "firstOccurrence": obj.get("firstOccurrence"),
            "hidden": obj.get("hidden"),
            "lastOccurrence": obj.get("lastOccurrence"),
            "reasonFrames": [ErrorsGroupList200ResponseErrorGroupsInnerAllOfReasonFramesInner.from_dict(_item) for _item in obj["reasonFrames"]] if obj.get("reasonFrames") is not None else None,
