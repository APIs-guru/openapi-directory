...
class AnalyticsReleasesParameter(BaseModel):
    ...
    """ # noqa: E501
    distribution_group_id: StrictStr = Field(description="distribution group id")
    release_id: StrictInt = Field(description="release id")
    user_id: StrictStr = Field(description="user id")
    __properties: ClassVar[List[str]] = ["distribution_group_id", "release_id", "user_id"]
