...
class CrashesGetAppCrashesInfo200Response(BaseModel):
    """
    CrashesGetAppCrashesInfo200Response
    """ # noqa: E501
    features: CrashesGetAppCrashesInfo200ResponseFeatures
    has_crashes: StrictBool
    __properties: ClassVar[List[str]] = ["features", "has_crashes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": CrashesGetAppCrashesInfo200ResponseFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None,
            "has_crashes": obj.get("has_crashes")
        })
        return _obj
