...
class DeploymentInternal(BaseModel):
    ...
    latest_release: Optional[DeploymentInternalAllOfLatestRelease] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "latest_release": DeploymentInternalAllOfLatestRelease.from_dict(obj["latest_release"]) if obj.get("latest_release") is not None else None,
            "name": obj.get("name")
        })
        return _obj
