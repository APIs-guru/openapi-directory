...
class VersionedBillingPlan(BaseModel):
    ...
    """ # noqa: E501
    document: Optional[BillingAggregatedInformationGetByApp200ResponseBillingPlansBuildServiceCurrentBillingPeriodByAccountPlan] = None
    etag: Optional[StrictStr] = Field(default=None, description="The version of the object")
    __properties: ClassVar[List[str]] = ["document", "etag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "document": BillingAggregatedInformationGetByApp200ResponseBillingPlansBuildServiceCurrentBillingPeriodByAccountPlan.from_dict(obj["document"]) if obj.get("document") is not None else None,
            "etag": obj.get("etag")
        })
        return _obj
