...
class LegacyDeploymentMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    metrics: Optional[Dict[str, LegacyDeploymentMetricsResponseMetricsValue]] = Field(default=None, description="Object containing a property named after each release label, which contains an object that contains that release's metrics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": dict(
                (_k, LegacyDeploymentMetricsResponseMetricsValue.from_dict(_v))
