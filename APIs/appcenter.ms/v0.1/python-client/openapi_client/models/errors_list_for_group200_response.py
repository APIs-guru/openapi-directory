...
class ErrorsListForGroup200Response(BaseModel):
    """
    ErrorsListForGroup200Response
    """ # noqa: E501
    errors: Optional[List[ErrorsListForGroup200ResponseErrorsInner]] = Field(default=None, description="Errors list.")
    next_link: Optional[StrictStr] = Field(default=None, alias="nextLink")
    __properties: ClassVar[List[str]] = ["errors", "nextLink"]
