...
class BuildTimeline(BaseModel):
    ...
    records: Optional[List[BuildTimelineRecordsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "records": [BuildTimelineRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
