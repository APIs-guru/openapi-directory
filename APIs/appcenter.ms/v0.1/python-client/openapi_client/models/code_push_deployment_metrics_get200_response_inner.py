...
class CodePushDeploymentMetricsGet200ResponseInner(BaseModel):
    """
    ...
    installed: Optional[StrictInt] = None
    label: StrictStr
    __properties: ClassVar[List[str]] = ["active", "downloaded", "failed", "installed", "label"]
