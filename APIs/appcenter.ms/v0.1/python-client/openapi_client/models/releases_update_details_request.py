...
class ReleasesUpdateDetailsRequest(BaseModel):
    """
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Toggle this release to be enable distribute/download or not.")
    release_notes: Optional[StrictStr] = Field(default=None, description="Release notes for this release.")
    __properties: ClassVar[List[str]] = ["build", "enabled", "release_notes"]
