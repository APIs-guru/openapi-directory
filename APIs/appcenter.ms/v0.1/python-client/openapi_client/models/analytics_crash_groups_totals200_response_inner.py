...
class AnalyticsCrashGroupsTotals200ResponseInner(BaseModel):
    """
    AnalyticsCrashGroupsTotals200ResponseInner
    """ # noqa: E501
    app_version: Optional[StrictStr] = None
    crash_group_id: Optional[StrictStr] = None
    overall: Optional[AnalyticsCrashGroupsTotals200ResponseInnerOverall] = None
    __properties: ClassVar[List[str]] = ["app_version", "crash_group_id", "overall"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overall": AnalyticsCrashGroupsTotals200ResponseInnerOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None
        })
        return _obj
