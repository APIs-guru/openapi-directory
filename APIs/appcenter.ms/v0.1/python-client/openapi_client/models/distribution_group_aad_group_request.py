...
class DistributionGroupAADGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    aad_groups: Optional[List[DistributionGroupAADGroupRequestAadGroupsInner]] = Field(default=None, description="The list of aad group ids and names to add")
    __properties: ClassVar[List[str]] = ["aad_groups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aad_groups": [DistributionGroupAADGroupRequestAadGroupsInner.from_dict(_item) for _item in obj["aad_groups"]] if obj.get("aad_groups") is not None else None
        })
        return _obj
