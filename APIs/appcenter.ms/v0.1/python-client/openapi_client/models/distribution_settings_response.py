...
class DistributionSettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    default_public: StrictBool = Field(description="Is this app using the \"Default to Public Distribution Groups\" logic")
    __properties: ClassVar[List[str]] = ["default_public"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default_public": obj.get("default_public")
        })
        return _obj
