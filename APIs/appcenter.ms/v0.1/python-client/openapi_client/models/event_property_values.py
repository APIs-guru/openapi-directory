...
class EventPropertyValues(BaseModel):
    ...
    """ # noqa: E501
    total: Optional[StrictInt] = Field(default=None, description="The total property value counts.")
    values: Optional[List[AnalyticsEventPropertyCounts200ResponseValuesInner]] = Field(default=None, description="The event property values.")
    __properties: ClassVar[List[str]] = ["total", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "values": [AnalyticsEventPropertyCounts200ResponseValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
