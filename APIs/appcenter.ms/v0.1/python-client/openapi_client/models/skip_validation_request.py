...
class SkipValidationRequest(BaseModel):
    ...
    """ # noqa: E501
    skip_validation: Optional[StrictBool] = Field(default=None, description="true if we want to skip the validation, false otherwise")
    __properties: ClassVar[List[str]] = ["skip_validation"]
