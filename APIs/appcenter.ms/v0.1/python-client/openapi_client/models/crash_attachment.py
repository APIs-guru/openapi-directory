...
class CrashAttachment(BaseModel):
    ...
    blob_location: StrictStr
    content_type: StrictStr
    crash_id: StrictStr
    created_time: datetime
    file_name: StrictStr
    size: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["app_id", "attachment_id", "blob_location", "content_type", "crash_id", "created_time", "file_name", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blob_location": obj.get("blob_location"),
