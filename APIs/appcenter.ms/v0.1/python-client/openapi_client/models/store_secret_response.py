...
class StoreSecretResponse(BaseModel):
    ...
    secret: Optional[StrictStr] = Field(default=None, description="Secret Json")
    tenant_id: Optional[StrictStr] = Field(default=None, description="Tenant Id for Intune")
    type: Optional[StrictStr] = Field(default=None, description="Store Type")
    __properties: ClassVar[List[str]] = ["id", "name", "secret", "tenant_id", "type"]
