...
class AlertBugTrackerReposResultRepositoriesInner(BaseModel):
    """
    Repostiory object
    """ # noqa: E501
    ...
    id: StrictStr
    name: StrictStr
    owner: Optional[AlertBugTrackerRepoOwner] = None
    private: Optional[StrictBool] = None
    url: StrictStr
    __properties: ClassVar[List[str]] = ["description", "id", "name", "owner", "private", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "owner": AlertBugTrackerRepoOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
