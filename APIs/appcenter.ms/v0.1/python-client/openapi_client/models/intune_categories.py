...
class IntuneCategories(BaseModel):
    ...
    IntuneCategories
    """ # noqa: E501
    odata_context: Optional[StrictStr] = Field(default=None, description="context", alias="odata.context")
    value: Optional[List[IntuneCategoriesValueInner]] = Field(default=None, description="categories for intune app")
    __properties: ClassVar[List[str]] = ["odata.context", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IntuneCategoriesValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
