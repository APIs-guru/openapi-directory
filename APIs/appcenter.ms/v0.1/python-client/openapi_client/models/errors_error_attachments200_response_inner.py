...
class ErrorsErrorAttachments200ResponseInner(BaseModel):
    """
    ...
    blob_location: Optional[StrictStr] = Field(default=None, alias="blobLocation")
    content_type: Optional[StrictStr] = Field(default=None, alias="contentType")
    crash_id: Optional[StrictStr] = Field(default=None, alias="crashId")
    created_time: Optional[datetime] = Field(default=None, alias="createdTime")
    file_name: Optional[StrictStr] = Field(default=None, alias="fileName")
    size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["appId", "attachmentId", "blobLocation", "contentType", "crashId", "createdTime", "fileName", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blobLocation": obj.get("blobLocation"),
            "contentType": obj.get("contentType"),
            "crashId": obj.get("crashId"),
