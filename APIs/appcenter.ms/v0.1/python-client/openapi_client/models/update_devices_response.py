...
class UpdateDevicesResponse(BaseModel):
    ...
    """ # noqa: E501
    status_url: StrictStr = Field(description="URL that can be used to check the status of the update devices operation.")
    __properties: ClassVar[List[str]] = ["status_url"]
