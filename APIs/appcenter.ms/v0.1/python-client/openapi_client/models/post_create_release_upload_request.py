...
class PostCreateReleaseUploadRequest(BaseModel):
    ...
    """ # noqa: E501
    build_number: Optional[StrictStr] = Field(default=None, description="User defined build number")
    build_version: Optional[StrictStr] = Field(default=None, description="User defined build version")
    __properties: ClassVar[List[str]] = ["build_number", "build_version"]
