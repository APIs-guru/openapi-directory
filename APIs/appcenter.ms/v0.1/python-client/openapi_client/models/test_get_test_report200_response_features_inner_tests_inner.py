...
class TestGetTestReport200ResponseFeaturesInnerTestsInner(BaseModel):
    """
    ...
    runs: Optional[List[TestGetTestReport200ResponseFeaturesInnerTestsInnerRunsInner]] = None
    test_name: Optional[StrictStr] = Field(default=None, alias="testName")
    __properties: ClassVar[List[str]] = ["peakDuration", "peakMemory", "runs", "testName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "runs": [TestGetTestReport200ResponseFeaturesInnerTestsInnerRunsInner.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None,
