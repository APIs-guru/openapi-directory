...
class ShareRelationshipsOwnerData(BaseModel):
    """
    ShareRelationshipsOwnerData
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the owner.")
    type: Optional[StrictStr] = Field(default=None, description="Type is user.")
