...
class EmailListCollectionResponse(BaseModel):
    ...
    response_status: Optional[StrictInt] = Field(default=None, description="Http status of response", alias="responseStatus")
    returned_results: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="returnedResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EmailList.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
