...
class ResourceCollectionResponse(BaseModel):
    ...
    returned_results: Optional[StrictInt] = Field(default=None, description="Count of returned results.", alias="returnedResults")
    total_results: Optional[StrictInt] = Field(default=None, description="Total count of results found.", alias="totalResults")
