...
class UserRelationshipsHomeResourceData(BaseModel):
    """
    UserRelationshipsHomeResourceData
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of home directory resource.")
    type: Optional[StrictStr] = Field(default=None, description="Type is resource.")
