...
class SessionActivityEntry(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[SessionActivityEntryAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['sessionActivity']):
            raise ValueError("must be one of enum values ('sessionActivity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": SessionActivityEntryAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
