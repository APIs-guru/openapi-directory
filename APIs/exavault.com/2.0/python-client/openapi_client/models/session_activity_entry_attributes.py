...
class SessionActivityEntryAttributes(BaseModel):
    """
    SessionActivityEntryAttributes
    """ # noqa: E501
    bytes_transferred: Optional[StrictInt] = Field(default=None, alias="bytesTransferred")
    ...
    __properties: ClassVar[List[str]] = ["bytesTransferred", "created", "duration", "fileName", "fileSource", "ipAddress", "operation", "protocol", "sessionId", "status", "username"]
