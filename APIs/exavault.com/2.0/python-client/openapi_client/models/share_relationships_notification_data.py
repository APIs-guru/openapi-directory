...
class ShareRelationshipsNotificationData(BaseModel):
    """
    ShareRelationshipsNotificationData
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the notification. ")
    type: Optional[StrictStr] = Field(default=None, description="Type is notification. ")
