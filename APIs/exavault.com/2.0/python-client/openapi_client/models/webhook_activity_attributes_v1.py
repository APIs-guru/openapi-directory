...
class WebhookActivityAttributesV1(BaseModel):
    ...
    details: Optional[WebhookV1Details] = None
    ...
    webhook_format: Optional[StrictStr] = Field(default=None, description="What version of webhook message is being sent `v1`", alias="webhookFormat")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": WebhookV1Details.from_dict(obj["details"]) if obj.get("details") is not None else None,
