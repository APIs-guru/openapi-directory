...
class WebhookActivityEntry(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[WebhookActivityEntryAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['webhookActivity']):
            raise ValueError("must be one of enum values ('webhookActivity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": WebhookActivityEntryAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
