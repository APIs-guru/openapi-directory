...
class FormResponse(BaseModel):
    ...
    included: Optional[List[Share]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Form.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [Share.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
