...
class ShareResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "included", "responseStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Share.from_dict(obj["data"]) if obj.get("data") is not None else None,
