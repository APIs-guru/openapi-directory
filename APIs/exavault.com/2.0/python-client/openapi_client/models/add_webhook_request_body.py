...
class AddWebhookRequestBody(BaseModel):
    """
    AddWebhookRequestBody
    """ # noqa: E501
    endpoint_url: StrictStr = Field(description="The endpoint is where the webhook request will be sent.", alias="endpointUrl")
    resource: Optional[StrictStr] = Field(default=None, description="Resource identifier for the top folder this webhook is associated with")
    response_version: Optional[StrictStr] = Field(default=None, description="What version of webhook request should be sent to the endpoint URL when messages are sent", alias="responseVersion")
