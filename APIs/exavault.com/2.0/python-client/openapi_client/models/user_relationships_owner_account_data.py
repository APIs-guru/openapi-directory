...
class UserRelationshipsOwnerAccountData(BaseModel):
    """
    UserRelationshipsOwnerAccountData
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the account.")
    type: Optional[StrictStr] = Field(default=None, description="Type is account.")
