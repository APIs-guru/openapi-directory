...
class ResourceCopyMove(BaseModel):
    ...
    meta: Optional[Dict[str, Any]] = Field(default=None, description="Meta object containing non-standard meta-information about the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Resource.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": obj.get("meta")
        })
        return _obj
