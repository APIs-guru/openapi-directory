...
class UpdateAccountRequestBodyAllowedIpRangesInner(BaseModel):
    """
    UpdateAccountRequestBodyAllowedIpRangesInner
    """ # noqa: E501
    ip_end: Optional[StrictStr] = Field(default=None, alias="ipEnd")
    ip_start: Optional[StrictStr] = Field(default=None, alias="ipStart")
    __properties: ClassVar[List[str]] = ["ipEnd", "ipStart"]
