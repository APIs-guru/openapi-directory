...
class SSHKey(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="ID of the key.")
    relationships: Optional[SSHKeyRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['sshKey']):
            raise ValueError("must be one of enum values ('sshKey')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": SSHKeyAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": SSHKeyRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
