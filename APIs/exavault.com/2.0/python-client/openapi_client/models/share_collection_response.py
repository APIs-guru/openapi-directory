...
class ShareCollectionResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[Share]] = None
    included: Optional[List[ShareCollectionResponseIncludedInner]] = None
    response_status: Optional[StrictInt] = Field(default=None, description="Http status code of the response.", alias="responseStatus")
    returned_results: Optional[StrictInt] = Field(default=None, description="Number of returned results.", alias="returnedResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Share.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [ShareCollectionResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
