...
class EmailListRelationships(BaseModel):
    ...
    """ # noqa: E501
    owner_user: Optional[EmailListOwnerUser] = Field(default=None, alias="ownerUser")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ownerUser": EmailListOwnerUser.from_dict(obj["ownerUser"]) if obj.get("ownerUser") is not None else None
        })
        return _obj
