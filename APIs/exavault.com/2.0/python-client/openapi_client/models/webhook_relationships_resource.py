...
class WebhookRelationshipsResource(BaseModel):
    """
    WebhookRelationshipsResource
    """ # noqa: E501
    data: Optional[WebhookRelationshipsResourceData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": WebhookRelationshipsResourceData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
