...
class NotificationCollectionResponse(BaseModel):
    ...
    included: Optional[List[NotificationCollectionResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [NotificationCollectionResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
