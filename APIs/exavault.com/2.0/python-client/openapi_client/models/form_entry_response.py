...
class FormEntryResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[FormEntry]] = Field(default=None, description="Object submissions data for form.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FormEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
