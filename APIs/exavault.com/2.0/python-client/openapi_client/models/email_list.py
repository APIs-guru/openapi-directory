...
class EmailList(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="ID of the email list")
    relationships: Optional[EmailListRelationships] = None
    type: Optional[StrictStr] = Field(default=None, description="Type of record. \"emailList\"")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": EmailListAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": EmailListRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
