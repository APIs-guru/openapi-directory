...
class EmailApi:
    ...
    def send_referral_email(
        ...
        send_referral_email_request_body: Optional[SendReferralEmailRequestBody] = None,
        ...
        :param send_referral_email_request_body:
        :type send_referral_email_request_body: SendReferralEmailRequestBody
        ...
        _param = self._send_referral_email_serialize(
            ev_api_key=ev_api_key,
            ev_access_token=ev_access_token,
            send_referral_email_request_body=send_referral_email_request_body,
    ...
    @validate_call
    def send_referral_email_with_http_info(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        send_referral_email_request_body: Optional[SendReferralEmailRequestBody] = None,
    ...
    @validate_call
    def send_referral_email_without_preload_content(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        send_referral_email_request_body: Optional[SendReferralEmailRequestBody] = None,
    ...
    def _send_referral_email_serialize(
        self,
        ev_api_key,
        ev_access_token,
        send_referral_email_request_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if send_referral_email_request_body is not None:
            _body_params = send_referral_email_request_body
    ...
    def send_welcome_email(
        ...
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        username: Annotated[StrictStr, Field(description="A username to send the welcome email to.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._send_welcome_email_serialize(
            ev_api_key=ev_api_key,
            ev_access_token=ev_access_token,
            username=username,
            _request_auth=_request_auth,
    ...
    @validate_call
    def send_welcome_email_with_http_info(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        username: Annotated[StrictStr, Field(description="A username to send the welcome email to.")],
    ...
    @validate_call
    def send_welcome_email_without_preload_content(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        username: Annotated[StrictStr, Field(description="A username to send the welcome email to.")],
    ...
    def _send_welcome_email_serialize(
        self,
        ev_api_key,
        ev_access_token,
        username,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/email/welcome/{username}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
