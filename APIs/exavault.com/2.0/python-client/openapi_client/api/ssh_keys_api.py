...
class SSHKeysApi:
    ...
    def add_ssh_key(
        ...
        add_ssh_key_request_body: Optional[AddSSHKeyRequestBody] = None,
        ...
        :param add_ssh_key_request_body:
        :type add_ssh_key_request_body: AddSSHKeyRequestBody
        ...
        _param = self._add_ssh_key_serialize(
            ...
            add_ssh_key_request_body=add_ssh_key_request_body,
    ...
    def _add_ssh_key_serialize(
        ...
        if add_ssh_key_request_body is not None:
            _body_params = add_ssh_key_request_body
    ...
    def get_ssh_keys_list(
        ...
        ev_api_key: Annotated[StrictStr, Field(description="API key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        user_id: Annotated[Optional[StrictStr], Field(description=" Only return results for the given user ID. This is not the username, but the numeric ID of the user.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description=" Limits the results by the given number. Cannot be set higher than 100.")] = None,
        ...
        _param = self._get_ssh_keys_list_serialize(
            ev_api_key=ev_api_key,
            ev_access_token=ev_access_token,
            user_id=user_id,
            limit=limit,
    ...
    @validate_call
    def get_ssh_keys_list_with_http_info(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        user_id: Annotated[Optional[StrictStr], Field(description=" Only return results for the given user ID. This is not the username, but the numeric ID of the user.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SSHKeyCollectionResponse]:
        """Get metadata for a list of SSH Keys
    ...
    @validate_call
    def get_ssh_keys_list_without_preload_content(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        user_id: Annotated[Optional[StrictStr], Field(description=" Only return results for the given user ID. This is not the username, but the numeric ID of the user.")] = None,
    ...
    def _get_ssh_keys_list_serialize(
        self,
        ev_api_key,
        ev_access_token,
        user_id,
