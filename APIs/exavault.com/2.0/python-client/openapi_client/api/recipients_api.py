...
class RecipientsApi:
    ...
    def resend_invitations_for_share(
        ...
        share_id: Annotated[StrictInt, Field(description="ID of the share to resend invites for.")],
        resend_invitations_request_body: Optional[ResendInvitationsRequestBody] = None,
        ...
        :param share_id: ID of the share to resend invites for. (required)
        :type share_id: int
        :param resend_invitations_request_body:
        :type resend_invitations_request_body: ResendInvitationsRequestBody
        ...
        _param = self._resend_invitations_for_share_serialize(
            ev_api_key=ev_api_key,
            ev_access_token=ev_access_token,
            share_id=share_id,
            resend_invitations_request_body=resend_invitations_request_body,
    ...
    @validate_call
    def resend_invitations_for_share_with_http_info(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        share_id: Annotated[StrictInt, Field(description="ID of the share to resend invites for.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShareRecipientsResponse]:
        """Resend invitations to share recipients
    ...
    @validate_call
    def resend_invitations_for_share_without_preload_content(
        self,
        ev_api_key: Annotated[StrictStr, Field(description="API Key required to make the API call.")],
        ev_access_token: Annotated[StrictStr, Field(description="Access token required to make the API call.")],
        share_id: Annotated[StrictInt, Field(description="ID of the share to resend invites for.")],
    ...
    def _resend_invitations_for_share_serialize(
        self,
        ev_api_key,
        ev_access_token,
        share_id,
        resend_invitations_request_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if resend_invitations_request_body is not None:
            _body_params = resend_invitations_request_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/recipients/shares/invites/{shareId}',
