...
class TestShareAttributes(unittest.TestCase):
    """ShareAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareAttributes:
        """Test ShareAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareAttributes`
        """
        model = ShareAttributes()
        if include_optional:
