...
class TestShareCollectionResponse(unittest.TestCase):
    """ShareCollectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareCollectionResponse:
        """Test ShareCollectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareCollectionResponse`
        """
        model = ShareCollectionResponse()
        if include_optional:
    ...
    def testShareCollectionResponse(self):
        """Test ShareCollectionResponse"""
