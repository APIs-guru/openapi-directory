...
class TestWebhookActivityAttributesV2(unittest.TestCase):
    """WebhookActivityAttributesV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookActivityAttributesV2:
        """Test WebhookActivityAttributesV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookActivityAttributesV2`
        """
        model = WebhookActivityAttributesV2()
        if include_optional:
            return WebhookActivityAttributesV2(
                account_id = '',
                attempt_id = '',
                created = '',
                details = openapi_client.models.webhook_v2_details.WebhookV2Details(
                    account_name = '', 
                    attempt_id = '', 
                    event = '', 
                    event_data = openapi_client.models.webhook_v2_event_data.WebhookV2EventData(
                        form_details = [
                            None
                            ], 
                        resources = [
    ...
    def testWebhookActivityAttributesV2(self):
        """Test WebhookActivityAttributesV2"""
