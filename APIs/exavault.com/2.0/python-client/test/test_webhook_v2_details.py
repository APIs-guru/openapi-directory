...
class TestWebhookV2Details(unittest.TestCase):
    """WebhookV2Details unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookV2Details:
        """Test WebhookV2Details
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookV2Details`
        """
        model = WebhookV2Details()
        if include_optional:
