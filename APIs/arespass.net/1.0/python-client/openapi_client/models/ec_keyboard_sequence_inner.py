...
class EcKeyboardSequenceInner(BaseModel):
    """
    ...
    penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The penalty applied to this character if it is part of a keyboard sequence.  The penalty is a float number in the range [0, 1]. Full penalty, 0; no penalty, 1. ")
