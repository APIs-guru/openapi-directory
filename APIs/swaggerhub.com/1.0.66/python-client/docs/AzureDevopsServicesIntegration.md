...
azure_devops_services_integration_instance = AzureDevopsServicesIntegration.from_json(json)
# print the JSON string representation of the object
print(AzureDevopsServicesIntegration.to_json())

# convert the object into a dict
azure_devops_services_integration_dict = azure_devops_services_integration_instance.to_dict()
# create an instance of AzureDevopsServicesIntegration from a dict
azure_devops_services_integration_from_dict = AzureDevopsServicesIntegration.from_dict(azure_devops_services_integration_dict)
```
