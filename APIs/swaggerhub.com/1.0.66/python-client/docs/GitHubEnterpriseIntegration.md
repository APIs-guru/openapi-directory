...
json = "{}"
# create an instance of GitHubEnterpriseIntegration from a JSON string
git_hub_enterprise_integration_instance = GitHubEnterpriseIntegration.from_json(json)
# print the JSON string representation of the object
print(GitHubEnterpriseIntegration.to_json())

# convert the object into a dict
git_hub_enterprise_integration_dict = git_hub_enterprise_integration_instance.to_dict()
# create an instance of GitHubEnterpriseIntegration from a dict
git_hub_enterprise_integration_from_dict = GitHubEnterpriseIntegration.from_dict(git_hub_enterprise_integration_dict)
```
