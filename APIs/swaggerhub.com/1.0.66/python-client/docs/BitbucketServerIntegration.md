...
bitbucket_server_integration_instance = BitbucketServerIntegration.from_json(json)
# print the JSON string representation of the object
print(BitbucketServerIntegration.to_json())

# convert the object into a dict
bitbucket_server_integration_dict = bitbucket_server_integration_instance.to_dict()
# create an instance of BitbucketServerIntegration from a dict
bitbucket_server_integration_from_dict = BitbucketServerIntegration.from_dict(bitbucket_server_integration_dict)
```
