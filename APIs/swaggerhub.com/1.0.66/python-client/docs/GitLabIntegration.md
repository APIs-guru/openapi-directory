...
**host** | **str** | The GitLab host to connect to. Make sure to include &#x60;https://&#x60; or &#x60;http://&#x60; at the beginning. | [optional] [default to 'https://gitlab.com']
**owner** | **str** | The owner of the repository to synchronize with | 
**personal_access_token** | **str** | A personal access token for accessing the target repository. The token must have the _api_ scope. Write-only property. Required to create and update the integration.  | [optional] 
...
git_lab_integration_instance = GitLabIntegration.from_json(json)
# print the JSON string representation of the object
print(GitLabIntegration.to_json())

# convert the object into a dict
git_lab_integration_dict = git_lab_integration_instance.to_dict()
# create an instance of GitLabIntegration from a dict
git_lab_integration_from_dict = GitLabIntegration.from_dict(git_lab_integration_dict)
```
