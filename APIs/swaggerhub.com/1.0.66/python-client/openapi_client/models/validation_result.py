...
class ValidationResult(BaseModel):
    ...
    ValidationResult
    """ # noqa: E501
    validation: Optional[List[ValidationErrors]] = Field(default=None, description="An array of standardization issues")
    __properties: ClassVar[List[str]] = ["validation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validation": [ValidationErrors.from_dict(_item) for _item in obj["validation"]] if obj.get("validation") is not None else None
        })
        return _obj
