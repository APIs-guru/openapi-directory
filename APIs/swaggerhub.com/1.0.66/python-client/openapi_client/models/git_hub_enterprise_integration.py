...
class GitHubEnterpriseIntegration(BaseModel):
    """
    ...
    def config_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['GITHUB_ENTERPRISE']):
            raise ValueError("must be one of enum values ('GITHUB_ENTERPRISE')")
        return value
