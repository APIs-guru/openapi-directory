...
class ApiMetadata(BaseModel):
    ...
    tags: List[StrictStr]
    __properties: ClassVar[List[str]] = ["categories", "defaultVersion", "links", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": [ApiMetadataLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
