...
class AmazonIntegration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "id", "name", "accessKey", "apiId", "basePathMode", "deploymentMode", "publishMode", "region", "secretKey", "updateDefinition"]
