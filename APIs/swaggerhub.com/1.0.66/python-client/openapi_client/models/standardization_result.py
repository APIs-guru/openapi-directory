...
class StandardizationResult(BaseModel):
    ...
    """ # noqa: E501
    validation: Optional[List[StandardizationError]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validation": [StandardizationError.from_dict(_item) for _item in obj["validation"]] if obj.get("validation") is not None else None
        })
        return _obj
