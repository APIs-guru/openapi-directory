...
class AmazonApiGatewayIntegration(BaseModel):
    """
    ...
    proxy_to_address: StrictStr = Field(description="The URL of the backend endpoint to which API Gateway will proxy the requests", alias="proxyToAddress")
    __properties: ClassVar[List[str]] = ["enabled", "id", "name", "accessKey", "apiId", "basePathMode", "deploymentMode", "publishMode", "region", "secretKey", "updateDefinition", "configType", "proxyToAddress"]
    ...
    def config_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AMAZON_API_GATEWAY']):
            raise ValueError("must be one of enum values ('AMAZON_API_GATEWAY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proxyToAddress": obj.get("proxyToAddress")
        })
        return _obj
