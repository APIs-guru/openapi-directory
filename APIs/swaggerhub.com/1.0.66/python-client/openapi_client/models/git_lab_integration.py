...
class GitLabIntegration(BaseModel):
    ...
    host: Optional[StrictStr] = Field(default='https://gitlab.com', description="The GitLab host to connect to. Make sure to include `https://` or `http://` at the beginning.")
    owner: StrictStr = Field(description="The owner of the repository to synchronize with")
    personal_access_token: Optional[SecretStr] = Field(default=None, description="A personal access token for accessing the target repository. The token must have the _api_ scope. Write-only property. Required to create and update the integration. ", alias="personalAccessToken")
    __properties: ClassVar[List[str]] = ["enabled", "id", "name", "branch", "ignoredPaths", "managedPaths", "outputFile", "outputFolder", "providedPaths", "repository", "syncMethod", "target", "configType", "host", "owner", "personalAccessToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitLabIntegration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitLabIntegration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "host": obj.get("host") if obj.get("host") is not None else 'https://gitlab.com',
            "owner": obj.get("owner"),
