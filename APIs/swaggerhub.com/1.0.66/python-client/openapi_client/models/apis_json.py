...
class ApisJson(BaseModel):
    """
    ApisJson
    """ # noqa: E501
    apis: Optional[List[ApisJsonApi]] = None
    description: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    offset: Optional[StrictInt] = None
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apis", "description", "name", "offset", "totalCount", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apis": [ApisJsonApi.from_dict(_item) for _item in obj["apis"]] if obj.get("apis") is not None else None,
