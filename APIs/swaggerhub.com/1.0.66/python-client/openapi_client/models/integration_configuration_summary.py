...
class IntegrationConfigurationSummary(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "id", "name", "configType"]

    @field_validator('config_type')
    def config_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AMAZON_API_GATEWAY', 'AMAZON_API_GATEWAY_LAMBDA', 'API_AUTO_MOCKING', 'APIGEE_EDGE', 'AZURE_DEVOPS_SERVICES', 'BITBUCKET_CLOUD', 'BITBUCKET_SERVER', 'GITHUB', 'GITHUB_ENTERPRISE', 'GITLAB', 'WEBHOOK']):
            raise ValueError("must be one of enum values ('AMAZON_API_GATEWAY', 'AMAZON_API_GATEWAY_LAMBDA', 'API_AUTO_MOCKING', 'APIGEE_EDGE', 'AZURE_DEVOPS_SERVICES', 'BITBUCKET_CLOUD', 'BITBUCKET_SERVER', 'GITHUB', 'GITHUB_ENTERPRISE', 'GITLAB', 'WEBHOOK')")
        return value
