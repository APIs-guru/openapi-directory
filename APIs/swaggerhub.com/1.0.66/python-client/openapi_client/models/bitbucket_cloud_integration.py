...
class BitbucketCloudIntegration(BaseModel):
    """
    ...
    def config_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BITBUCKET_CLOUD']):
            raise ValueError("must be one of enum values ('BITBUCKET_CLOUD')")
        return value
