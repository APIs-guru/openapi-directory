...
class IntegrationConfigurations(BaseModel):
    """
    IntegrationConfigurations
    """ # noqa: E501
    integrations: Optional[List[IntegrationConfigurationSummary]] = Field(default=None, description="A list of integrations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [IntegrationConfigurationSummary.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
