...
class DraftModel(BaseModel):
    ...
    DraftModel
    """ # noqa: E501
    comments: Optional[List[ClosableComment]] = None
    yaml: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["comments", "yaml"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": [ClosableComment.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
            "yaml": obj.get("yaml")
        })
        return _obj
