...
class SCMIntegrationConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "id", "name", "branch", "ignoredPaths", "managedPaths", "outputFile", "outputFolder", "providedPaths", "repository", "syncMethod", "target"]
