...
class NewComment(BaseModel):
    ...
    replies: Optional[List[NewReply]] = None
    __properties: ClassVar[List[str]] = ["body", "position", "replies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replies": [NewReply.from_dict(_item) for _item in obj["replies"]] if obj.get("replies") is not None else None
        })
        return _obj
