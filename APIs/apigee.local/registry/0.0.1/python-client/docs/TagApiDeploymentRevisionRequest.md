...
------------ | ------------- | ------------- | -------------
**name** | **str** | Required. The name of the deployment to be tagged, including the revision ID. | 
**tag** | **str** | Required. The tag to apply. The tag should be at most 40 characters, and match &#x60;[a-z][a-z0-9-]{3,39}&#x60;. | 
