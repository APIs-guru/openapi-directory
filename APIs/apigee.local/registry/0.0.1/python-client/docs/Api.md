...
**recommended_deployment** | **str** | The recommended deployment of the API. Format: apis/{api}/deployments/{deployment} | [optional] 
**recommended_version** | **str** | The recommended version of the API. Format: apis/{api}/versions/{version} | [optional] 
