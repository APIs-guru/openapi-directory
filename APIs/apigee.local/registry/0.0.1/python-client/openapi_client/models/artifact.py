...
class Artifact(BaseModel):
    ...
    """ # noqa: E501
    contents: Optional[StrictStr] = Field(default=None, description="Input only. The contents of the artifact. Provided by API callers when artifacts are created or replaced. To access the contents of an artifact, use GetArtifactContents.")
    ...
    __properties: ClassVar[List[str]] = ["contents", "createTime", "hash", "mimeType", "name", "sizeBytes", "updateTime"]
