...
class Api(BaseModel):
    ...
    availability: Optional[StrictStr] = Field(default=None, description="A user-definable description of the availability of this service. Format: free-form, but we expect single words that describe availability, e.g. \"NONE\", \"TESTING\", \"PREVIEW\", \"GENERAL\", \"DEPRECATED\", \"SHUTDOWN\".")
    ...
    recommended_deployment: Optional[StrictStr] = Field(default=None, description="The recommended deployment of the API. Format: apis/{api}/deployments/{deployment}", alias="recommendedDeployment")
    recommended_version: Optional[StrictStr] = Field(default=None, description="The recommended version of the API. Format: apis/{api}/versions/{version}", alias="recommendedVersion")
    update_time: Optional[datetime] = Field(default=None, description="Output only. Last update timestamp.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["annotations", "availability", "createTime", "description", "displayName", "labels", "name", "recommendedDeployment", "recommendedVersion", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "recommendedDeployment": obj.get("recommendedDeployment"),
            "recommendedVersion": obj.get("recommendedVersion"),
