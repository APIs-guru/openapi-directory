...
class TestPreviousBuild(unittest.TestCase):
    """PreviousBuild unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviousBuild:
        """Test PreviousBuild
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviousBuild`
        """
        model = PreviousBuild()
        if include_optional:
