...
class TestTestsTestsInner(unittest.TestCase):
    """TestsTestsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestsTestsInner:
        """Test TestsTestsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestsTestsInner`
        """
        model = TestsTestsInner()
        if include_optional:
            return TestsTestsInner(
                classname = '',
                file = '',
                message = '',
                name = '',
