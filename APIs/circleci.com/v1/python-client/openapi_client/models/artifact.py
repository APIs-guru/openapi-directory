...
class Artifact(BaseModel):
    ...
    Artifact
    """ # noqa: E501
    node_index: Optional[StrictInt] = None
    path: Optional[StrictStr] = None
    pretty_path: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["node_index", "path", "pretty_path", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "pretty_path": obj.get("pretty_path"),
            "url": obj.get("url")
        })
        return _obj
