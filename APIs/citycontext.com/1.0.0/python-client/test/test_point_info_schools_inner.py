...
class TestPointInfoSchoolsInner(unittest.TestCase):
    """PointInfoSchoolsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointInfoSchoolsInner:
        """Test PointInfoSchoolsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointInfoSchoolsInner`
        """
        model = PointInfoSchoolsInner()
        if include_optional:
            return PointInfoSchoolsInner(
                distance_meters = 56,
                last_inpection_url = '',
    ...
    def testPointInfoSchoolsInner(self):
        """Test PointInfoSchoolsInner"""
