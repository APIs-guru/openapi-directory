...
class PointInfoParksInner(BaseModel):
    """
    PointInfoParksInner
    """ # noqa: E501
    area_sqm: StrictInt = Field(alias="areaSqm")
    centroid: Dict[str, Any]
    distance_meters: StrictInt = Field(alias="distanceMeters")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["areaSqm", "centroid", "distanceMeters", "name"]
