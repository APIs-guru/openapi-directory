...
class PointInfoLsoa(BaseModel):
    """
    Statistics for lower layer super output areas (LSOA)
    """ # noqa: E501
    crimes: Optional[Dict[str, Any]] = None
    name: StrictStr
    population: Optional[PointInfoLsoaPopulation] = None
    __properties: ClassVar[List[str]] = ["crimes", "name", "population"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "crimes": obj.get("crimes"),
            "name": obj.get("name"),
            "population": PointInfoLsoaPopulation.from_dict(obj["population"]) if obj.get("population") is not None else None
        })
        return _obj
