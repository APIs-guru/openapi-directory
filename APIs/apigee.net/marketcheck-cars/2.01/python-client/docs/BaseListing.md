...
base_listing_instance = BaseListing.from_json(json)
# print the JSON string representation of the object
print(BaseListing.to_json())

# convert the object into a dict
base_listing_dict = base_listing_instance.to_dict()
# create an instance of BaseListing from a dict
base_listing_from_dict = BaseListing.from_dict(base_listing_dict)
```
