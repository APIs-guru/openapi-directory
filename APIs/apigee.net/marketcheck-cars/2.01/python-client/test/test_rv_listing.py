...
class TestRVListing(unittest.TestCase):
    """RVListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RVListing:
        """Test RVListing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RVListing`
        """
        model = RVListing()
        if include_optional:
            return RVListing(
