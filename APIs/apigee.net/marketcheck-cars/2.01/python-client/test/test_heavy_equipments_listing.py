...
class TestHeavyEquipmentsListing(unittest.TestCase):
    """HeavyEquipmentsListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeavyEquipmentsListing:
        """Test HeavyEquipmentsListing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeavyEquipmentsListing`
        """
        model = HeavyEquipmentsListing()
        if include_optional:
    ...
    def testHeavyEquipmentsListing(self):
        """Test HeavyEquipmentsListing"""
