...
class TestCarRankResponse(unittest.TestCase):
    """CarRankResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarRankResponse:
        """Test CarRankResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarRankResponse`
        """
        model = CarRankResponse()
        if include_optional:
            return CarRankResponse(
                num_ranked = 56,
                ranked_listings = [
                    openapi_client.models.car_listing_rank.CarListingRank(
                        ranked_listing = [
