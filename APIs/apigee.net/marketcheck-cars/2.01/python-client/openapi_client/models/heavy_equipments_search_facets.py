...
class HeavyEquipmentsSearchFacets(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["body_type", "category", "city", "cylinders", "dealer_id", "drivetrain", "engine", "exterior_color", "fuel_type", "interior_color", "inventory_type", "make", "model", "seller_name", "source", "state", "sub_category", "transmission", "trim", "year"]
