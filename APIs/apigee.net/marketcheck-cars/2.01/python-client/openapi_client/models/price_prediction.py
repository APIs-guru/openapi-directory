...
class PricePrediction(BaseModel):
    ...
    """ # noqa: E501
    predicted_price: Optional[StrictInt] = Field(default=None, description="Actual predicted price of a car")
    price_range: Optional[PricePredictionPriceRange] = None
    specs: Optional[PredictedSpecs] = None
    __properties: ClassVar[List[str]] = ["predicted_price", "price_range", "specs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predicted_price": obj.get("predicted_price"),
            "price_range": PricePredictionPriceRange.from_dict(obj["price_range"]) if obj.get("price_range") is not None else None,
            "specs": PredictedSpecs.from_dict(obj["specs"]) if obj.get("specs") is not None else None
        })
        return _obj
