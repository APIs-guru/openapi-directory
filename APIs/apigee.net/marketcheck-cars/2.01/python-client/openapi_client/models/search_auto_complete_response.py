...
class SearchAutoCompleteResponse(BaseModel):
    ...
    """ # noqa: E501
    terms: Optional[List[SearchAutoCompleteResponseTermsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terms": [SearchAutoCompleteResponseTermsInner.from_dict(_item) for _item in obj["terms"]] if obj.get("terms") is not None else None
        })
        return _obj
