...
class PricePredictionPriceRange(BaseModel):
    """
    Price range around the predicted price, estimating the error in predicted price
    """ # noqa: E501
    lower_bound: Optional[StrictInt] = Field(default=None, description="Lower bound")
    upper_bound: Optional[StrictInt] = Field(default=None, description="Upper bound")
    __properties: ClassVar[List[str]] = ["lower_bound", "upper_bound"]
