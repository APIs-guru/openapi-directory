...
class DealerRating(BaseModel):
    ...
    overall_rating: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Overall rating of the dealership on scale 1-5")
    rating_components: Optional[List[RatingComponents]] = None
    ...
    __properties: ClassVar[List[str]] = ["city", "latitude", "longitude", "name", "overall_rating", "rating_components", "state", "street", "zip"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rating_components (list)
        _items = []
        if self.rating_components:
            for _item_rating_components in self.rating_components:
                if _item_rating_components:
                    _items.append(_item_rating_components.to_dict())
            _dict['rating_components'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rating_components": [RatingComponents.from_dict(_item) for _item in obj["rating_components"]] if obj.get("rating_components") is not None else None,
            "state": obj.get("state"),
