...
class UKBaseListing(BaseModel):
    ...
    car_location: Optional[CarLocation] = None
    ...
    co2_emissions: Optional[StrictStr] = Field(default=None, description="CO2 emissions by car")
    ...
    insurance_group: Optional[StrictStr] = Field(default=None, description="Insurance Group of car")
    ...
    num_owners: Optional[StrictStr] = Field(default=None, description="Number of owners")
    ...
    uvc_id: Optional[StrictStr] = Field(default=None, description="UVC ID of the car")
    ...
    __properties: ClassVar[List[str]] = ["base_ext_color", "base_int_color", "build", "car_location", "carfax_1_owner", "carfax_clean_title", "co2_emissions", "data_source", "dealer", "dist", "dom", "dom_180", "dom_active", "exterior_color", "financing_options", "first_seen_at", "first_seen_at_date", "heading", "id", "in_transit", "insurance_group", "interior_color", "inventory_type", "is_certified", "is_translated", "last_seen_at", "last_seen_at_date", "leasing_options", "media", "miles", "model_code", "msrp", "num_owners", "price", "price_change_percent", "ref_miles", "ref_miles_dt", "ref_price", "ref_price_dt", "scraped_at", "scraped_at_date", "seller_type", "source", "stock_no", "title_type", "uvc_id", "vdp_url", "vehicle_registration_mark"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of car_location
        if self.car_location:
            _dict['car_location'] = self.car_location.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "car_location": CarLocation.from_dict(obj["car_location"]) if obj.get("car_location") is not None else None,
            ...
            "insurance_group": obj.get("insurance_group"),
