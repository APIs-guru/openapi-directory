...
class RVListing(BaseModel):
    """
    Represents a full list of attributes available with Marketcheck for a car
    """ # noqa: E501
    build: Optional[RVBuild] = None
    dealer: Optional[NestDealer] = None
    dp_url: Optional[StrictStr] = Field(default=None, description="Details Page url of the specific RV")
    ...
    __properties: ClassVar[List[str]] = ["build", "dealer", "dp_url", "exterior_color", "extra", "first_seen_at", "first_seen_at_date", "heading", "id", "interior_color", "inventory_type", "last_seen_at", "last_seen_at_date", "media", "miles", "msrp", "price", "scraped_at", "scraped_at_date", "seller_type", "source", "stock_no", "vin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "build": RVBuild.from_dict(obj["build"]) if obj.get("build") is not None else None,
