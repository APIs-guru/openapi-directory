...
class ListingNestExtraAttributes(BaseModel):
    """
    ...
    seller_comments: Optional[StrictStr] = Field(default=None, description="Seller comments for the car")
    ...
    __properties: ClassVar[List[str]] = ["dealer_added_f", "electronics_f", "exterior_f", "features", "interior_f", "options", "safety_f", "seller_comments", "standard_f", "technical_f"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seller_comments": obj.get("seller_comments"),
