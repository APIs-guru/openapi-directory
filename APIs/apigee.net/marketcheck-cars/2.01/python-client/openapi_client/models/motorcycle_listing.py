...
class MotorcycleListing(BaseModel):
    ...
    """ # noqa: E501
    build: Optional[MotorcycleBuild] = None
    color: Optional[StrictStr] = Field(default=None, description="Color of the motorcycle")
    dealer: Optional[NestDealer] = None
    dp_url: Optional[StrictStr] = Field(default=None, description="Details Page url of the specific motorcycle")
    ...
    inventory_type: Optional[StrictStr] = Field(default=None, description="Inventory type of motorcycle")
    ...
    miles: Optional[StrictInt] = Field(default=None, description="Odometer reading / reported miles usage for the motorcycle")
    msrp: Optional[StrictInt] = Field(default=None, description="MSRP for the motorcycle")
    price: Optional[StrictInt] = Field(default=None, description="Asking price for the motorcycle")
    ...
    seller_type: Optional[StrictStr] = Field(default=None, description="Seller type for the motorcycle")
    source: Optional[StrictStr] = Field(default=None, description="Source domain of the listing")
    stock_no: Optional[StrictStr] = Field(default=None, description="Stock number of motorcycle in dealers inventory")
    vin: Optional[StrictStr] = Field(default=None, description="VIN for the Motorcycle")
    __properties: ClassVar[List[str]] = ["build", "color", "dealer", "dp_url", "extra", "first_seen_at", "first_seen_at_date", "heading", "id", "inventory_type", "last_seen_at", "last_seen_at_date", "media", "miles", "msrp", "price", "scraped_at", "scraped_at_date", "seller_type", "source", "stock_no", "vin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "build": MotorcycleBuild.from_dict(obj["build"]) if obj.get("build") is not None else None,
            "color": obj.get("color"),
