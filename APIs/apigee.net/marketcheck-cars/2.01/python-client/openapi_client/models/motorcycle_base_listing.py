...
class MotorcycleBaseListing(BaseModel):
    """
    ...
    dist: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Distance of the motorcycle's location from the specified user lcoation")
    ...
    __properties: ClassVar[List[str]] = ["build", "color", "dealer", "dist", "dp_url", "first_seen_at", "first_seen_at_date", "heading", "id", "inventory_type", "last_seen_at", "last_seen_at_date", "media", "miles", "msrp", "price", "scraped_at", "scraped_at_date", "seller_type", "source", "stock_no", "vin"]
