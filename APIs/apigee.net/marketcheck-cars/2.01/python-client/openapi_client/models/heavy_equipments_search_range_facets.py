...
class HeavyEquipmentsSearchRangeFacets(BaseModel):
    """
    HeavyEquipmentsSearchRangeFacets
    """ # noqa: E501
    hours_used: Optional[List[RangeFacetItem]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in hours_used (list)
        _items = []
        if self.hours_used:
            for _item_hours_used in self.hours_used:
                if _item_hours_used:
                    _items.append(_item_hours_used.to_dict())
            _dict['hours_used'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hours_used": [RangeFacetItem.from_dict(_item) for _item in obj["hours_used"]] if obj.get("hours_used") is not None else None,
