...
class ManageQuery(BaseModel):
    ...
    ManageQuery
    """ # noqa: E501
    es_rules: Optional[StrictStr] = Field(default=None, alias="esRules")
    name: Optional[StrictStr] = None
    qb_rules: Optional[StrictStr] = Field(default=None, alias="qbRules")
    short_code: Optional[StrictStr] = Field(default=None, alias="shortCode")
    __properties: ClassVar[List[str]] = ["esRules", "name", "qbRules", "shortCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "esRules": obj.get("esRules"),
            "name": obj.get("name"),
            "qbRules": obj.get("qbRules"),
