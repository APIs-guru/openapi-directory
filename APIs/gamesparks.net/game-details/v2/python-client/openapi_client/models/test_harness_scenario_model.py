...
class TestHarnessScenarioModel(BaseModel):
    ...
    """ # noqa: E501
    scenario_json: Optional[Dict[str, Any]] = Field(default=None, alias="scenarioJson")
    scenario_name: Optional[StrictStr] = Field(default=None, alias="scenarioName")
    __properties: ClassVar[List[str]] = ["scenarioJson", "scenarioName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scenarioJson": obj.get("scenarioJson"),
