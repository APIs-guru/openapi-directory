...
class GameRegionOptionsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locked", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [GameRegionOptionDTO.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
