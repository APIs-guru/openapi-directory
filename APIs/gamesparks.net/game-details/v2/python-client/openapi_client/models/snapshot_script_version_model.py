...
class SnapshotScriptVersionModel(BaseModel):
    ...
    """ # noqa: E501
    cloud_code_version: Optional[StrictInt] = Field(default=None, alias="cloudCodeVersion")
    created_date: Optional[datetime] = Field(default=None, alias="createdDate")
    description: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    live: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["cloudCodeVersion", "createdDate", "description", "id", "live"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloudCodeVersion": obj.get("cloudCodeVersion"),
