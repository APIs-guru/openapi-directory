...
class ManageSnippet(BaseModel):
    ...
    script_data: Optional[StrictStr] = Field(default=None, alias="scriptData")
    short_code: Optional[StrictStr] = Field(default=None, alias="shortCode")
    template: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["groups", "name", "script", "scriptData", "shortCode", "template"]
