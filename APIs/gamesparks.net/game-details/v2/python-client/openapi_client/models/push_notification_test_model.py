...
class PushNotificationTestModel(BaseModel):
    ...
    """ # noqa: E501
    custom_json: Optional[StrictStr] = Field(default=None, alias="customJson")
    message_id: Optional[StrictStr] = Field(default=None, alias="messageId")
    push_id: Optional[StrictStr] = Field(default=None, alias="pushId")
    subtitle: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["customJson", "messageId", "pushId", "subtitle", "summary", "title"]
