...
------------- | ------------- | -------------
[**post_cart**](CartApi.md#post_cart) | **POST** /{siteId}/cart | Send a cart for the given site


# **post_cart**
> post_cart(site_id, body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.Cart() # Cart | cart json for the event

    try:
        # Send a cart for the given site
        api_instance.post_cart(site_id, body)
    except Exception as e:
        print("Exception when calling CartApi->post_cart: %s\n" % e)
```
