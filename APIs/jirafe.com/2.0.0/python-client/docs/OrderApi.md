...
------------- | ------------- | -------------
[**post_order_cancelled**](OrderApi.md#post_order_cancelled) | **POST** /{siteId}/order | Send a order for the given site


# **post_order_cancelled**
> post_order_cancelled(site_id, body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.OrderCancelled() # OrderCancelled | order json for the event

    try:
        # Send a order for the given site
        api_instance.post_order_cancelled(site_id, body)
    except Exception as e:
        print("Exception when calling OrderApi->post_order_cancelled: %s\n" % e)
```
