...
------------- | ------------- | -------------
[**post_category**](CategoryApi.md#post_category) | **POST** /{siteId}/category | Send a category for the given site


# **post_category**
> post_category(site_id, body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.Category() # Category | category json for the event

    try:
        # Send a category for the given site
        api_instance.post_category(site_id, body)
    except Exception as e:
        print("Exception when calling CategoryApi->post_category: %s\n" % e)
```
