...
class Visit(BaseModel):
    ...
    Visit
    """ # noqa: E501
    last_pageview_id: StrictStr
    pageview_id: StrictStr
    visit_id: StrictStr
    visitor_id: StrictStr
    __properties: ClassVar[List[str]] = ["last_pageview_id", "pageview_id", "visit_id", "visitor_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "last_pageview_id": obj.get("last_pageview_id"),
            "pageview_id": obj.get("pageview_id"),
