...
class CartItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cart_item_number", "change_date", "create_date", "discount_price", "id", "price", "product", "quantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cart_item_number": obj.get("cart_item_number"),
