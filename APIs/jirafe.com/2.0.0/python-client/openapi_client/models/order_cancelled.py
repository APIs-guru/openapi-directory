...
class OrderCancelled(BaseModel):
    ...
    status: StrictStr
    __properties: ClassVar[List[str]] = ["cancel_date", "order_number", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cancel_date": obj.get("cancel_date"),
            "order_number": obj.get("order_number"),
            "status": obj.get("status") if obj.get("status") is not None else 'cancelled'
        })
        return _obj
