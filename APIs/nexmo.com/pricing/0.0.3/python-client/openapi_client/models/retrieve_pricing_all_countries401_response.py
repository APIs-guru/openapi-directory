...
class RetrievePricingAllCountries401Response(BaseModel):
    """
    RetrievePricingAllCountries401Response
    """ # noqa: E501
    code: StrictStr
    currency: StrictStr
    error_code_label: StrictStr = Field(alias="error-code-label")
    __properties: ClassVar[List[str]] = ["code", "currency", "error-code-label"]
