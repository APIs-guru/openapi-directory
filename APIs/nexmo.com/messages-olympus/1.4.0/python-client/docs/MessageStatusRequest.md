...
message_status_request_instance = MessageStatusRequest.from_json(json)
# print the JSON string representation of the object
print(MessageStatusRequest.to_json())

# convert the object into a dict
message_status_request_dict = message_status_request_instance.to_dict()
# create an instance of MessageStatusRequest from a dict
message_status_request_from_dict = MessageStatusRequest.from_dict(message_status_request_dict)
```
