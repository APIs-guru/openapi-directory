...
message_status_mms_instance = MessageStatusMMS.from_json(json)
# print the JSON string representation of the object
print(MessageStatusMMS.to_json())

# convert the object into a dict
message_status_mms_dict = message_status_mms_instance.to_dict()
# create an instance of MessageStatusMMS from a dict
message_status_mms_from_dict = MessageStatusMMS.from_dict(message_status_mms_dict)
```
