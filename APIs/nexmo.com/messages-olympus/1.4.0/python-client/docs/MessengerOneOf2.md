...
messenger_one_of2_instance = MessengerOneOf2.from_json(json)
# print the JSON string representation of the object
print(MessengerOneOf2.to_json())

# convert the object into a dict
messenger_one_of2_dict = messenger_one_of2_instance.to_dict()
# create an instance of MessengerOneOf2 from a dict
messenger_one_of2_from_dict = MessengerOneOf2.from_dict(messenger_one_of2_dict)
```
