...
mms_one_of_instance = MMSOneOf.from_json(json)
# print the JSON string representation of the object
print(MMSOneOf.to_json())

# convert the object into a dict
mms_one_of_dict = mms_one_of_instance.to_dict()
# create an instance of MMSOneOf from a dict
mms_one_of_from_dict = MMSOneOf.from_dict(mms_one_of_dict)
```
