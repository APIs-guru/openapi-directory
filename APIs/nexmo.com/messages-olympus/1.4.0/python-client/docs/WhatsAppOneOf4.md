...
whats_app_one_of4_instance = WhatsAppOneOf4.from_json(json)
# print the JSON string representation of the object
print(WhatsAppOneOf4.to_json())

# convert the object into a dict
whats_app_one_of4_dict = whats_app_one_of4_instance.to_dict()
# create an instance of WhatsAppOneOf4 from a dict
whats_app_one_of4_from_dict = WhatsAppOneOf4.from_dict(whats_app_one_of4_dict)
```
