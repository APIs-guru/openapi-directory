...
class ErrorMessageParamsInvalidParametersInner(BaseModel):
    """
    ErrorMessageParamsInvalidParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of invalid parameter")
    reason: Optional[StrictStr] = Field(default=None, description="Reason of failure")
