...
class MMSOneOf2(BaseModel):
    ...
    audio: MMSOneOf2AllOfAudio
    message_type: StrictStr = Field(description="The type of message to send. You must provide `audio` in this field.  For best device and network support .mp3 is recommended. Not supported for US short codes. ")
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "audio", "message_type", "channel", "from", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "audio": MMSOneOf2AllOfAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
