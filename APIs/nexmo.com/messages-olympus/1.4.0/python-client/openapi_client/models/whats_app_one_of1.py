...
class WhatsAppOneOf1(BaseModel):
    """
    WhatsAppOneOf1
    """ # noqa: E501
    ...
    text: Optional[Any] = Field(default=None, description="The location to be sent in the message. ")
    __properties: ClassVar[List[str]] = ["client_ref", "location", "message_type", "channel", "from", "to", "text"]
