...
class WhatsApp1Whatsapp(BaseModel):
    """
    ...
    """ # noqa: E501
    conversation: Optional[WhatsApp1WhatsappConversation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversation": WhatsApp1WhatsappConversation.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None
        })
        return _obj
