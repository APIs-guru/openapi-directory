...
class Order(BaseModel):
    ...
    message_type: StrictStr = Field(description="The type of message to send.")
    order: Order1Order
    __properties: ClassVar[List[str]] = ["client_ref", "message_type", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": Order1Order.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
