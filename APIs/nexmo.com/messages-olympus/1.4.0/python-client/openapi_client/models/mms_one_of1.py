...
class MMSOneOf1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "message_type", "vcard", "channel", "from", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vcard": MMSOneOf1AllOfVcard.from_dict(obj["vcard"]) if obj.get("vcard") is not None else None,
