...
class ViberOneOf2(BaseModel):
    ...
    viber_service: Optional[ChannelOptionsViberVideoViberService] = None
    __properties: ClassVar[List[str]] = ["client_ref", "message_type", "video", "channel", "from", "to", "viber_service"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "video": ViberOneOf2AllOfVideo.from_dict(obj["video"]) if obj.get("video") is not None else None,
            "channel": obj.get("channel"),
            "from": obj.get("from"),
            "to": obj.get("to"),
            "viber_service": ChannelOptionsViberVideoViberService.from_dict(obj["viber_service"]) if obj.get("viber_service") is not None else None
        })
        return _obj
