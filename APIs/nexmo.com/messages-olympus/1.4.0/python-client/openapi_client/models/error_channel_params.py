...
class ErrorChannelParams(BaseModel):
    ...
    invalid_parameters: Optional[List[ErrorChannelParamsInvalidParametersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invalid_parameters": [ErrorChannelParamsInvalidParametersInner.from_dict(_item) for _item in obj["invalid_parameters"]] if obj.get("invalid_parameters") is not None else None,
            "title": obj.get("title"),
            "type": obj.get("type")
        })
        return _obj
