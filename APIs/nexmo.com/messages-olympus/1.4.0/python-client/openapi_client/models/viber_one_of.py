...
class ViberOneOf(BaseModel):
    ...
    text: Optional[Any] = Field(description="The text of message to send; limited to 1000 characters, including unicode. ")
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "message_type", "text", "channel", "from", "to", "viber_service"]
