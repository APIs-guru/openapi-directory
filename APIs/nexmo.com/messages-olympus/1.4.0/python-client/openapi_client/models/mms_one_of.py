...
class MMSOneOf(BaseModel):
    ...
    message_type: StrictStr = Field(description="The type of message to send. You must provide `image` in this field")
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "image", "message_type", "channel", "from", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MMSOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MMSOneOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": MMSOneOfAllOfImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
