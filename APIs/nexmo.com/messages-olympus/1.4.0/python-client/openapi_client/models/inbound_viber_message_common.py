...
class InboundViberMessageCommon(BaseModel):
    ...
    context: Optional[InboundViberMessageCommonContext] = None
    ...
    __properties: ClassVar[List[str]] = ["channel", "context", "from", "message_uuid", "timestamp", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": InboundViberMessageCommonContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "from": obj.get("from"),
