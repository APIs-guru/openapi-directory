...
class ViberOneOf1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "image", "message_type", "channel", "from", "to", "viber_service"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": ViberOneOf1AllOfImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
