...
class MessageStatusWhatsApp(BaseModel):
    """
    ...
    usage: Optional[WhatsApp1Usage] = None
    channel: StrictStr = Field(description="The channel sending to.")
    whatsapp: Optional[WhatsApp1Whatsapp] = None
    __properties: ClassVar[List[str]] = ["client_ref", "error", "from", "message_uuid", "status", "timestamp", "to", "usage", "channel", "whatsapp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to": obj.get("to"),
            "usage": WhatsApp1Usage.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
            "channel": obj.get("channel"),
            "whatsapp": WhatsApp1Whatsapp.from_dict(obj["whatsapp"]) if obj.get("whatsapp") is not None else None
        })
        return _obj
