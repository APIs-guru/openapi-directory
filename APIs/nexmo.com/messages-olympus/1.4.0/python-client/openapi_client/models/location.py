...
class Location(BaseModel):
    ...
    message_type: StrictStr = Field(description="The type of message to send. You must provide `location` in this field")
    __properties: ClassVar[List[str]] = ["client_ref", "location", "message_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": Location1Location.from_dict(obj["location"]) if obj.get("location") is not None else None,
