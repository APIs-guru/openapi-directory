...
class WhatsAppOneOf4(BaseModel):
    """
    WhatsAppOneOf4
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsAppOneOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsAppOneOf4 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "video": WhatsAppOneOf4AllOfVideo.from_dict(obj["video"]) if obj.get("video") is not None else None,
