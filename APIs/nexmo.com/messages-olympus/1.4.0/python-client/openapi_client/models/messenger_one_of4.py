...
class MessengerOneOf4(BaseModel):
    """
    MessengerOneOf4
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["client_ref", "file", "message_type", "channel", "from", "messenger", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": MessengerOneOf4AllOfFile.from_dict(obj["file"]) if obj.get("file") is not None else None,
