...
class DefaultApi:
    ...
    def send_message(
        self,
        send_message_request: Annotated[SendMessageRequest, Field(description="Send a Message.")],
        ...
        :param send_message_request: Send a Message. (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '202': "SendMessage202Response",
            '401': "SendMessage401Response",
            '402': "ErrorPaymentRequired",
            '422': "SendMessage422Response",
            '429': "ErrorThrottled",
            '500': "ErrorInternal",
        }
    ...
    def send_message_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SendMessage202Response]:
        """Send a message to the given channel.
