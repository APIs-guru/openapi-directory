...
class TestErrorSender(unittest.TestCase):
    """ErrorSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorSender:
        """Test ErrorSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorSender`
        """
        model = ErrorSender()
        if include_optional:
            return ErrorSender(
