...
class TestMessageStatusViber(unittest.TestCase):
    """MessageStatusViber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatusViber:
        """Test MessageStatusViber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatusViber`
        """
        model = MessageStatusViber()
        if include_optional:
    ...
    def testMessageStatusViber(self):
        """Test MessageStatusViber"""
