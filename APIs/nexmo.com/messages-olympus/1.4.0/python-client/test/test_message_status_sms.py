...
class TestMessageStatusSMS(unittest.TestCase):
    """MessageStatusSMS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatusSMS:
        """Test MessageStatusSMS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatusSMS`
        """
        model = MessageStatusSMS()
        if include_optional:
