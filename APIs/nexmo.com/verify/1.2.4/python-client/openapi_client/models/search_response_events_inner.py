...
class SearchResponseEventsInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['tts', 'sms']):
            raise ValueError("must be one of enum values ('tts', 'sms')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponseEventsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponseEventsInner from a dict"""
        if obj is None:
            return None
