...
class NetworkUnblockResponseOk(BaseModel):
    ...
    Success
    """ # noqa: E501
    network: Optional[StrictStr] = Field(default=None, description="The unique network ID")
    unblocked_until: Optional[StrictStr] = Field(default=None, description="Gives the DateTime when the unblock will expire.")
    __properties: ClassVar[List[str]] = ["network", "unblocked_until"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unblocked_until": obj.get("unblocked_until")
        })
        return _obj
