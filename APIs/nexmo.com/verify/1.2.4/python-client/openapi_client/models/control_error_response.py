...
class ControlErrorResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["error_text", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['0', '1', '2', '3', '4', '5', '6', '8', '9', '19']):
            raise ValueError("must be one of enum values ('0', '1', '2', '3', '4', '5', '6', '8', '9', '19')")
        return value
