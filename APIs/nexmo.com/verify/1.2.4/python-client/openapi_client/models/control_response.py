...
class ControlResponse(BaseModel):
    ...
    Success
    """ # noqa: E501
    command: Optional[StrictStr] = Field(default=None, description="The `cmd` you sent in the request.")
    status: Optional[StrictStr] = Field(default=None, description="`cmd` | Code | Description -- | -- | -- Any | 0 | Success ")
    __properties: ClassVar[List[str]] = ["command", "status"]
    ...
    def command_validate_enum(cls, value):
        ...
        if value not in set(['cancel', 'trigger_next_event']):
            raise ValueError("must be one of enum values ('cancel', 'trigger_next_event')")
        return value
