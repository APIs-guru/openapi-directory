...
class RequestResponse(BaseModel):
    ...
    Success
    """ # noqa: E501
    request_id: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="The unique ID of the Verify request. You need this `request_id` for the Verify check.")
    status: Optional[StrictStr] = Field(default=None, description="Indicates the outcome of the request; zero is success")
