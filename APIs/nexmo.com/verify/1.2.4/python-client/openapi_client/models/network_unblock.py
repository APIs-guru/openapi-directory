...
class NetworkUnblock(BaseModel):
    ...
    NetworkUnblock
    """ # noqa: E501
    network: Optional[StrictStr] = Field(default=None, description="The Network code")
    unblock_duration: Optional[Annotated[int, Field(le=86400, strict=True, ge=0)]] = Field(default=3600, description="An optional duration the unblock will be applied for in seconds")
    __properties: ClassVar[List[str]] = ["network", "unblock_duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unblock_duration": obj.get("unblock_duration") if obj.get("unblock_duration") is not None else 3600
        })
        return _obj
