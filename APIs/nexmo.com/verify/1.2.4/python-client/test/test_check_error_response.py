...
class TestCheckErrorResponse(unittest.TestCase):
    """CheckErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckErrorResponse:
        """Test CheckErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckErrorResponse`
        """
        model = CheckErrorResponse()
        if include_optional:
    ...
    def testCheckErrorResponse(self):
        """Test CheckErrorResponse"""
