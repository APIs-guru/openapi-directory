...
class TestSearchResponseChecksInner(unittest.TestCase):
    """SearchResponseChecksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchResponseChecksInner:
        """Test SearchResponseChecksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResponseChecksInner`
        """
        model = SearchResponseChecksInner()
        if include_optional:
            return SearchResponseChecksInner(
                code = '987654',
    ...
    def testSearchResponseChecksInner(self):
        """Test SearchResponseChecksInner"""
