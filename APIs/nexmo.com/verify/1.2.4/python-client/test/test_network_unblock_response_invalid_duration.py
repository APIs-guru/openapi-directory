...
class TestNetworkUnblockResponseInvalidDuration(unittest.TestCase):
    """NetworkUnblockResponseInvalidDuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkUnblockResponseInvalidDuration:
        """Test NetworkUnblockResponseInvalidDuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkUnblockResponseInvalidDuration`
        """
        model = NetworkUnblockResponseInvalidDuration()
        if include_optional:
    ...
    def testNetworkUnblockResponseInvalidDuration(self):
        """Test NetworkUnblockResponseInvalidDuration"""
