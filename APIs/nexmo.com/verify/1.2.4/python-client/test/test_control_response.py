...
class TestControlResponse(unittest.TestCase):
    """ControlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlResponse:
        """Test ControlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlResponse`
        """
