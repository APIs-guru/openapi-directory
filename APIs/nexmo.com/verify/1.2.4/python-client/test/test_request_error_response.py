...
class TestRequestErrorResponse(unittest.TestCase):
    """RequestErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestErrorResponse:
        """Test RequestErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestErrorResponse`
        """
    ...
    def testRequestErrorResponse(self):
        """Test RequestErrorResponse"""
