...
class TestSearchResponseEventsInner(unittest.TestCase):
    """SearchResponseEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchResponseEventsInner:
        """Test SearchResponseEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResponseEventsInner`
        """
        model = SearchResponseEventsInner()
        if include_optional:
            return SearchResponseEventsInner(
                id = '',
                type = 'tts'
            )
        else:
    ...
    def testSearchResponseEventsInner(self):
        """Test SearchResponseEventsInner"""
