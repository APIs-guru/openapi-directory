...
class TestNetworkUnblockResponseForbidden(unittest.TestCase):
    """NetworkUnblockResponseForbidden unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkUnblockResponseForbidden:
        """Test NetworkUnblockResponseForbidden
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkUnblockResponseForbidden`
        """
        model = NetworkUnblockResponseForbidden()
        if include_optional:
            return NetworkUnblockResponseForbidden(
    ...
    def testNetworkUnblockResponseForbidden(self):
        """Test NetworkUnblockResponseForbidden"""
