...
class TestNetworkUnblockResponseNotFound(unittest.TestCase):
    """NetworkUnblockResponseNotFound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkUnblockResponseNotFound:
        """Test NetworkUnblockResponseNotFound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkUnblockResponseNotFound`
        """
        model = NetworkUnblockResponseNotFound()
        if include_optional:
    ...
    def testNetworkUnblockResponseNotFound(self):
        """Test NetworkUnblockResponseNotFound"""
