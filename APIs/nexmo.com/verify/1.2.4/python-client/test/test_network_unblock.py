...
class TestNetworkUnblock(unittest.TestCase):
    """NetworkUnblock unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkUnblock:
        """Test NetworkUnblock
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkUnblock`
        """
        model = NetworkUnblock()
        if include_optional:
