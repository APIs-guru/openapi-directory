...
class ErrorMessage(BaseModel):
    ...
    ErrorMessage
    """ # noqa: E501
    error_text: Optional[StrictStr] = Field(default=None, description="The description of the error", alias="error-text")
    status: Optional[StrictStr] = Field(default=None, description="The error status of the message")
    __properties: ClassVar[List[str]] = ["error-text", "status"]
