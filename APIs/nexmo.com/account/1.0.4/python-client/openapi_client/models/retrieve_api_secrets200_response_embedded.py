...
class RetrieveAPISecrets200ResponseEmbedded(BaseModel):
    """
    The single `secrets` key returns an array of API secrets
    """ # noqa: E501
    secrets: Optional[List[SecretInfo]] = Field(default=None, description="Array of API secrets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secrets": [SecretInfo.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
