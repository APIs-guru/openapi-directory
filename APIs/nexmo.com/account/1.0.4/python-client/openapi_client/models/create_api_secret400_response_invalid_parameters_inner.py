...
class CreateAPISecret400ResponseInvalidParametersInner(BaseModel):
    """
    CreateAPISecret400ResponseInvalidParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Field name")
    reason: Optional[StrictStr] = Field(default=None, description="Explanation of why parameter is considered invalid")
