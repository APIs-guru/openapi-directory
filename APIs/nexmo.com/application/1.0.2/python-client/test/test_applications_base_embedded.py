...
class TestApplicationsBaseEmbedded(unittest.TestCase):
    """ApplicationsBaseEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationsBaseEmbedded:
        """Test ApplicationsBaseEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationsBaseEmbedded`
        """
        model = ApplicationsBaseEmbedded()
        if include_optional:
            return ApplicationsBaseEmbedded(
                applications = [
    ...
    def testApplicationsBaseEmbedded(self):
        """Test ApplicationsBaseEmbedded"""
