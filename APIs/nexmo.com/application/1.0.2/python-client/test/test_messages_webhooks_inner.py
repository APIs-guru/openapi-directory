...
class TestMessagesWebhooksInner(unittest.TestCase):
    """MessagesWebhooksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessagesWebhooksInner:
        """Test MessagesWebhooksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessagesWebhooksInner`
        """
        model = MessagesWebhooksInner()
        if include_optional:
            return MessagesWebhooksInner(
    ...
    def testMessagesWebhooksInner(self):
        """Test MessagesWebhooksInner"""
