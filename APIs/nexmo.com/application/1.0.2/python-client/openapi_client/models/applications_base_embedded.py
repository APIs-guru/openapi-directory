...
class ApplicationsBaseEmbedded(BaseModel):
    """
    ApplicationsBaseEmbedded
    """ # noqa: E501
    applications: Optional[List[Application]] = Field(default=None, description="The collection of your applications. Each object contains information about an an individual application. The public_key is not included in the application information.")
