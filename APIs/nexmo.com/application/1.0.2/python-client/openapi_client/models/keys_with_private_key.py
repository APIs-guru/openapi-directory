...
class KeysWithPrivateKey(BaseModel):
    """
    KeysWithPrivateKey
    """ # noqa: E501
    public_key: Optional[StrictStr] = Field(default=None, description="The public key used to validate the [JWT](https://en.wikipedia.org/wiki/JSON_Web_Token).")
    private_key: Optional[StrictStr] = Field(default=None, description="The private key you use to generate the JSON Web Token (JWT) that authenticates your requests to Messages API.")
    __properties: ClassVar[List[str]] = ["public_key", "private_key"]
