...
class Voice(BaseModel):
    ...
    """ # noqa: E501
    webhooks: Optional[List[VoiceWebhooksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [VoiceWebhooksInner.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
