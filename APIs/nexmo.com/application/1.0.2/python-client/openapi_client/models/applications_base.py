...
class ApplicationsBase(BaseModel):
    ...
    ApplicationsBase
    """ # noqa: E501
    embedded: Optional[ApplicationsBaseEmbedded] = Field(default=None, alias="_embedded")
    count: Optional[StrictInt] = Field(default=None, description="The number of items associated with your account.")
    page_index: Optional[StrictInt] = Field(default=None, description="The offset from the first page.")
    page_size: Optional[StrictInt] = Field(default=None, description="The number of items returned on each call to this endpoint. The default is 10 records.")
    __properties: ClassVar[List[str]] = ["_embedded", "count", "page_index", "page_size"]
