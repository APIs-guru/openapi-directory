...
class UpdateApplicationRequest(BaseModel):
    ...
    """ # noqa: E501
    answer_method: Optional[StrictStr] = Field(default='GET', description="The HTTP method used to make the request to `answer_url`. The default value is `GET`.")
    answer_url: Optional[StrictStr] = Field(default=None, description="The URL where your webhook delivers the Nexmo Call Control Object that governs this call. As soon as your user answers a call Nexmo makes a request to `answer_url`.")
    ...
    event_method: Optional[StrictStr] = Field(default='POST', description="The HTTP method used to send event information to `event_url`. The default value is POST.")
    event_url: Optional[StrictStr] = Field(default=None, description="Nexmo sends event information asynchronously to this URL when status changes.")
    name: StrictStr = Field(description="The name of your application.")
    type: StrictStr = Field(description="The Nexmo product or products that you access with this application. Currently `voice` and `messages` application types are supported. You  can't change the type of application.")
    __properties: ClassVar[List[str]] = ["answer_method", "answer_url", "api_key", "api_secret", "event_method", "event_url", "name", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answer_method": obj.get("answer_method") if obj.get("answer_method") is not None else 'GET',
