...
class NiResponseXmlAdvancedError(BaseModel):
    """
    The error code and status of your request
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The status code")
    status_text: Optional[StrictStr] = Field(default=None, description="The status description of your request.")
    __properties: ClassVar[List[str]] = ["code", "status_text"]
