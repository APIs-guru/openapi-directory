...
class NiResponseXmlStandardCallerIdentity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["caller-name", "caller-type", "caller_name", "caller_type", "firs_name", "first-name", "last-name", "last_name"]
