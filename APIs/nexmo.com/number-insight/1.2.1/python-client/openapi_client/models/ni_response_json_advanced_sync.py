...
class NiResponseJsonAdvancedSync(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of real_time_data
        if self.real_time_data:
            _dict['real_time_data'] = self.real_time_data.to_dict()
        ...
        # set to None if real_time_data (nullable) is None
        # and model_fields_set contains the field
        if self.real_time_data is None and "real_time_data" in self.model_fields_set:
            _dict['real_time_data'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "real_time_data": NiRealtimeData.from_dict(obj["real_time_data"]) if obj.get("real_time_data") is not None else None,
