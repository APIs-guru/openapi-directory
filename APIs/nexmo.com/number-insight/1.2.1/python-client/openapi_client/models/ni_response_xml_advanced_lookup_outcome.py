...
class NiResponseXmlAdvancedLookupOutcome(BaseModel):
    """
    An object indicating whether all information about a phone number has been returned.
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Shows if all information about a phone number has been returned. Possible values:  Code | Text -- | -- 0 | Success 1 | Partial success - some fields populated 2 | Failed ")
    ...
    __properties: ClassVar[List[str]] = ["code", "lookup_outcome_message"]
