...
ni_response_json_standard_instance = NiResponseJsonStandard.from_json(json)
# print the JSON string representation of the object
print(NiResponseJsonStandard.to_json())

# convert the object into a dict
ni_response_json_standard_dict = ni_response_json_standard_instance.to_dict()
# create an instance of NiResponseJsonStandard from a dict
ni_response_json_standard_from_dict = NiResponseJsonStandard.from_dict(ni_response_json_standard_dict)
```
