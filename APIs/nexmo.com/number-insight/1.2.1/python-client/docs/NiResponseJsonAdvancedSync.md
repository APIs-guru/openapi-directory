...
json = "{}"
# create an instance of NiResponseJsonAdvancedSync from a JSON string
ni_response_json_advanced_sync_instance = NiResponseJsonAdvancedSync.from_json(json)
# print the JSON string representation of the object
print(NiResponseJsonAdvancedSync.to_json())

# convert the object into a dict
ni_response_json_advanced_sync_dict = ni_response_json_advanced_sync_instance.to_dict()
# create an instance of NiResponseJsonAdvancedSync from a dict
ni_response_json_advanced_sync_from_dict = NiResponseJsonAdvancedSync.from_dict(ni_response_json_advanced_sync_dict)
```
