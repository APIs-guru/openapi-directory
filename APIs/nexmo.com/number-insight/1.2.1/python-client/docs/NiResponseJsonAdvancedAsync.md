...
ni_response_json_advanced_async_instance = NiResponseJsonAdvancedAsync.from_json(json)
# print the JSON string representation of the object
print(NiResponseJsonAdvancedAsync.to_json())

# convert the object into a dict
ni_response_json_advanced_async_dict = ni_response_json_advanced_async_instance.to_dict()
# create an instance of NiResponseJsonAdvancedAsync from a dict
ni_response_json_advanced_async_from_dict = NiResponseJsonAdvancedAsync.from_dict(ni_response_json_advanced_async_dict)
```
