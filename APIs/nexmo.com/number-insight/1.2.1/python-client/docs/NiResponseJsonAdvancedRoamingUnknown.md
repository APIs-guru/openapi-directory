...
json = "{}"
# create an instance of NiResponseJsonAdvancedRoamingUnknown from a JSON string
ni_response_json_advanced_roaming_unknown_instance = NiResponseJsonAdvancedRoamingUnknown.from_json(json)
# print the JSON string representation of the object
print(NiResponseJsonAdvancedRoamingUnknown.to_json())

# convert the object into a dict
ni_response_json_advanced_roaming_unknown_dict = ni_response_json_advanced_roaming_unknown_instance.to_dict()
# create an instance of NiResponseJsonAdvancedRoamingUnknown from a dict
ni_response_json_advanced_roaming_unknown_from_dict = NiResponseJsonAdvancedRoamingUnknown.from_dict(ni_response_json_advanced_roaming_unknown_dict)
```
