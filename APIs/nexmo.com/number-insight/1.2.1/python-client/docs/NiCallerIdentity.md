...
ni_caller_identity_instance = NiCallerIdentity.from_json(json)
# print the JSON string representation of the object
print(NiCallerIdentity.to_json())

# convert the object into a dict
ni_caller_identity_dict = ni_caller_identity_instance.to_dict()
# create an instance of NiCallerIdentity from a dict
ni_caller_identity_from_dict = NiCallerIdentity.from_dict(ni_caller_identity_dict)
```
