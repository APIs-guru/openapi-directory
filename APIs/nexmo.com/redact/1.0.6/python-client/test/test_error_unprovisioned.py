...
class TestErrorUnprovisioned(unittest.TestCase):
    """ErrorUnprovisioned unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorUnprovisioned:
        """Test ErrorUnprovisioned
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorUnprovisioned`
        """
        model = ErrorUnprovisioned()
        if include_optional:
    ...
    def testErrorUnprovisioned(self):
        """Test ErrorUnprovisioned"""
