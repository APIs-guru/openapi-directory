...
class DefaultApi:
    ...
    def redact_message(
        self,
        redact_transaction: RedactTransaction,
        ...
        :param redact_transaction: (required)
        :type redact_transaction: RedactTransaction
        ...
        _param = self._redact_message_serialize(
            redact_transaction=redact_transaction,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "RedactMessage403Response",
            '404': "ErrorInvalidId",
            '422': "RedactMessage422Response",
            '429': "ErrorThrottled",
        }
    ...
    @validate_call
    def redact_message_with_http_info(
        self,
        redact_transaction: RedactTransaction,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def redact_message_without_preload_content(
        self,
        redact_transaction: RedactTransaction,
        _request_timeout: Union[
            None,
    ...
    def _redact_message_serialize(
        ...
        if redact_transaction is not None:
            _body_params = redact_transaction
