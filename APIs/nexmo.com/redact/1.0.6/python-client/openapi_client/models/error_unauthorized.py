...
class ErrorUnauthorized(BaseModel):
    ...
    ErrorUnauthorized
    """ # noqa: E501
    error_title: StrictStr = Field(description="Error title")
    type: StrictStr = Field(description="Machine readable error type")
    __properties: ClassVar[List[str]] = ["error_title", "type"]
