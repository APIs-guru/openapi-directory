...
class MessagesResponseCreateReport(BaseModel):
    """
    Messages
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "receive_time", "request_id", "request_status", "start_time", "direction", "from", "id", "include_message", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesResponseCreateReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesResponseCreateReport from a dict"""
        if obj is None:
            return None
