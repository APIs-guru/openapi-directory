...
class ConversationsResponseGetReport(BaseModel):
    """
    Conversations
    """ # noqa: E501
    ...
    status: Optional[StrictStr] = Field(default=None, description="Search only for conversation events with the specified event status.")
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "items_count", "product", "receive_time", "request_id", "request_status", "start_time", "conversation_id", "status"]
