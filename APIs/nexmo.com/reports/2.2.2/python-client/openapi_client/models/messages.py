...
class MESSAGES(ReportRequest):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "direction", "from", "id", "include_message", "to"]
