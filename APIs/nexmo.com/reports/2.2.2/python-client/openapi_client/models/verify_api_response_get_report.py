...
class VerifyApiResponseGetReport(BaseModel):
    """
    Verify
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "items_count", "product", "receive_time", "request_id", "request_status", "start_time", "network", "to"]
