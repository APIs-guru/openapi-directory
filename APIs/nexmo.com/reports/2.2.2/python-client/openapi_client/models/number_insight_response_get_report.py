...
class NumberInsightResponseGetReport(BaseModel):
    """
    Number Insight
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "items_count", "product", "receive_time", "request_id", "request_status", "start_time", "network", "number"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumberInsightResponseGetReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumberInsightResponseGetReport from a dict"""
        if obj is None:
            return None
