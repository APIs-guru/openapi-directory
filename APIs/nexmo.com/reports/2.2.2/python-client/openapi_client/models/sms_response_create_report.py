...
class SmsResponseCreateReport(BaseModel):
    """
    SMS
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "receive_time", "request_id", "request_status", "start_time", "account_ref", "client_ref", "direction", "from", "include_message", "network", "show_concatenated", "status", "to"]
