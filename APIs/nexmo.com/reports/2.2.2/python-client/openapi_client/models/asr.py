...
class ASR(ReportRequest):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "direction", "from", "status", "to"]
