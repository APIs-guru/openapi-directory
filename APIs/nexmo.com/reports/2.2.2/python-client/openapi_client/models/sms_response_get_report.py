...
class SmsResponseGetReport(BaseModel):
    """
    SMS
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "items_count", "product", "receive_time", "request_id", "request_status", "start_time", "account_ref", "client_ref", "direction", "from", "include_message", "network", "show_concatenated", "status", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsResponseGetReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsResponseGetReport from a dict"""
        if obj is None:
            return None
