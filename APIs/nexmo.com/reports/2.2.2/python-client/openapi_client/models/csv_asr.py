...
class CsvAsr(BaseModel):
    ...
    call_date_start: Optional[date] = Field(default=None, description="Date of the start of the call.")
    ...
    status_description: Optional[StrictStr] = Field(default=None, description="ASR error message.")
    ...
    __properties: ClassVar[List[str]] = ["account_id", "call_date_start", "call_id", "currency", "date_end", "date_start", "direction", "duration", "from", "price", "status", "status_description", "to", "total_price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "call_date_start": obj.get("call_date_start"),
