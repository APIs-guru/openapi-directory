...
class JsonSmsInbound(BaseModel):
    """
    Inbound SMS
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["account_id", "country", "country_name", "currency", "date_received", "direction", "from", "message_id", "network", "network_name", "to", "total_price"]
