...
class AsrResponseCreateReport(BaseModel):
    """
    ASR
    """ # noqa: E501
    ...
    product: Optional[ProductAsr] = None
    ...
    status: Optional[AsrStatus] = None
    to: Optional[StrictStr] = Field(default=None, description="Request to this number.")
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "receive_time", "request_id", "request_status", "start_time", "direction", "from", "status", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AsrResponseCreateReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AsrResponseCreateReport from a dict"""
        if obj is None:
            return None
