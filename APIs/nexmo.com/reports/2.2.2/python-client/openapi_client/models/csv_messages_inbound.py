...
class CsvMessagesInbound(BaseModel):
    """
    Inbound Messages
    """ # noqa: E501
    ...
    provider: Optional[StrictStr] = Field(default=None, description="Provider of the message.")
    ...
    __properties: ClassVar[List[str]] = ["account_id", "currency", "date_received", "direction", "from", "message_body", "message_id", "provider", "to", "total_price"]
