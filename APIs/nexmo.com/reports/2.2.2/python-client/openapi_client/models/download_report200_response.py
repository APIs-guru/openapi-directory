...
class DownloadReport200Response(BaseModel):
    """
    DownloadReport200Response
    """ # noqa: E501
    report: Optional[List[DownloadReport200ResponseReportInner]] = Field(default=None, description="The report in CSV format inside the zip archive.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": [DownloadReport200ResponseReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
