...
class InAppVoiceResponseCreateReport(BaseModel):
    """
    In App Voice
    """ # noqa: E501
    ...
    conversation_id: Optional[StrictStr] = Field(default=None, description="Search only for In App Voive calls attached to this particular Conversation. This should include the \"CON-\" prefix.")
    __properties: ClassVar[List[str]] = ["_links", "account_id", "callback_url", "date_end", "date_start", "include_subaccounts", "product", "receive_time", "request_id", "request_status", "start_time", "conversation_id"]
