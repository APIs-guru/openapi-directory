...
json = "{}"
# create an instance of AsrResponseGetReport from a JSON string
asr_response_get_report_instance = AsrResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(AsrResponseGetReport.to_json())

# convert the object into a dict
asr_response_get_report_dict = asr_response_get_report_instance.to_dict()
# create an instance of AsrResponseGetReport from a dict
asr_response_get_report_from_dict = AsrResponseGetReport.from_dict(asr_response_get_report_dict)
```
