...
get_records200_response_one_of6_instance = GetRecords200ResponseOneOf6.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf6.to_json())

# convert the object into a dict
get_records200_response_one_of6_dict = get_records200_response_one_of6_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf6 from a dict
get_records200_response_one_of6_from_dict = GetRecords200ResponseOneOf6.from_dict(get_records200_response_one_of6_dict)
```
