...
get_records200_response_one_of3_instance = GetRecords200ResponseOneOf3.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf3.to_json())

# convert the object into a dict
get_records200_response_one_of3_dict = get_records200_response_one_of3_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf3 from a dict
get_records200_response_one_of3_from_dict = GetRecords200ResponseOneOf3.from_dict(get_records200_response_one_of3_dict)
```
