...
websocket_call_response_create_report_instance = WebsocketCallResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(WebsocketCallResponseCreateReport.to_json())

# convert the object into a dict
websocket_call_response_create_report_dict = websocket_call_response_create_report_instance.to_dict()
# create an instance of WebsocketCallResponseCreateReport from a dict
websocket_call_response_create_report_from_dict = WebsocketCallResponseCreateReport.from_dict(websocket_call_response_create_report_dict)
```
