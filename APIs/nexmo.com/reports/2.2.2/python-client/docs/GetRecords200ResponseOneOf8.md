...
**records** | [**List[CsvMessagesInbound]**](CsvMessagesInbound.md) | Records in JSON format | [optional] 
...
get_records200_response_one_of8_instance = GetRecords200ResponseOneOf8.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf8.to_json())

# convert the object into a dict
get_records200_response_one_of8_dict = get_records200_response_one_of8_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf8 from a dict
get_records200_response_one_of8_from_dict = GetRecords200ResponseOneOf8.from_dict(get_records200_response_one_of8_dict)
```
