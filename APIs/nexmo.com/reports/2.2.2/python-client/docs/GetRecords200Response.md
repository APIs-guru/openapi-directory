...
get_records200_response_instance = GetRecords200Response.from_json(json)
# print the JSON string representation of the object
print(GetRecords200Response.to_json())

# convert the object into a dict
get_records200_response_dict = get_records200_response_instance.to_dict()
# create an instance of GetRecords200Response from a dict
get_records200_response_from_dict = GetRecords200Response.from_dict(get_records200_response_dict)
```
