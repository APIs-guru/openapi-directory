...
voice_call_response_create_report_instance = VoiceCallResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(VoiceCallResponseCreateReport.to_json())

# convert the object into a dict
voice_call_response_create_report_dict = voice_call_response_create_report_instance.to_dict()
# create an instance of VoiceCallResponseCreateReport from a dict
voice_call_response_create_report_from_dict = VoiceCallResponseCreateReport.from_dict(voice_call_response_create_report_dict)
```
