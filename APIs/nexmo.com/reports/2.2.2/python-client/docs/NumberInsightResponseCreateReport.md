...
number_insight_response_create_report_instance = NumberInsightResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(NumberInsightResponseCreateReport.to_json())

# convert the object into a dict
number_insight_response_create_report_dict = number_insight_response_create_report_instance.to_dict()
# create an instance of NumberInsightResponseCreateReport from a dict
number_insight_response_create_report_from_dict = NumberInsightResponseCreateReport.from_dict(number_insight_response_create_report_dict)
```
