...
json = "{}"
# create an instance of VoiceCallResponseGetReport from a JSON string
voice_call_response_get_report_instance = VoiceCallResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(VoiceCallResponseGetReport.to_json())

# convert the object into a dict
voice_call_response_get_report_dict = voice_call_response_get_report_instance.to_dict()
# create an instance of VoiceCallResponseGetReport from a dict
voice_call_response_get_report_from_dict = VoiceCallResponseGetReport.from_dict(voice_call_response_get_report_dict)
```
