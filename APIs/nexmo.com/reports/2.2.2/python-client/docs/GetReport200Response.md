...
get_report200_response_instance = GetReport200Response.from_json(json)
# print the JSON string representation of the object
print(GetReport200Response.to_json())

# convert the object into a dict
get_report200_response_dict = get_report200_response_instance.to_dict()
# create an instance of GetReport200Response from a dict
get_report200_response_from_dict = GetReport200Response.from_dict(get_report200_response_dict)
```
