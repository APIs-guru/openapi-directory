...
**records** | [**List[CsvVerify]**](CsvVerify.md) | Records in JSON format | [optional] 
...
json = "{}"
# create an instance of GetRecords200ResponseOneOf5 from a JSON string
get_records200_response_one_of5_instance = GetRecords200ResponseOneOf5.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf5.to_json())

# convert the object into a dict
get_records200_response_one_of5_dict = get_records200_response_one_of5_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf5 from a dict
get_records200_response_one_of5_from_dict = GetRecords200ResponseOneOf5.from_dict(get_records200_response_one_of5_dict)
```
