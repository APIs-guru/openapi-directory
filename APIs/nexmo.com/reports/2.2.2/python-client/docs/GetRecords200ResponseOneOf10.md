...
get_records200_response_one_of10_instance = GetRecords200ResponseOneOf10.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf10.to_json())

# convert the object into a dict
get_records200_response_one_of10_dict = get_records200_response_one_of10_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf10 from a dict
get_records200_response_one_of10_from_dict = GetRecords200ResponseOneOf10.from_dict(get_records200_response_one_of10_dict)
```
