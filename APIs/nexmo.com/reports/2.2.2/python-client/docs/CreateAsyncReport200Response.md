...
create_async_report200_response_instance = CreateAsyncReport200Response.from_json(json)
# print the JSON string representation of the object
print(CreateAsyncReport200Response.to_json())

# convert the object into a dict
create_async_report200_response_dict = create_async_report200_response_instance.to_dict()
# create an instance of CreateAsyncReport200Response from a dict
create_async_report200_response_from_dict = CreateAsyncReport200Response.from_dict(create_async_report200_response_dict)
```
