...
json = "{}"
# create an instance of WebsocketCallResponseGetReport from a JSON string
websocket_call_response_get_report_instance = WebsocketCallResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(WebsocketCallResponseGetReport.to_json())

# convert the object into a dict
websocket_call_response_get_report_dict = websocket_call_response_get_report_instance.to_dict()
# create an instance of WebsocketCallResponseGetReport from a dict
websocket_call_response_get_report_from_dict = WebsocketCallResponseGetReport.from_dict(websocket_call_response_get_report_dict)
```
