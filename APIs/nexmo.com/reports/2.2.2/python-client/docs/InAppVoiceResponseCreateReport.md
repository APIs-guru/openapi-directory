...
**request_status** | [**RequestStatusCreateReport**](RequestStatusCreateReport.md) |  | [optional] 
...
json = "{}"
# create an instance of InAppVoiceResponseCreateReport from a JSON string
in_app_voice_response_create_report_instance = InAppVoiceResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(InAppVoiceResponseCreateReport.to_json())

# convert the object into a dict
in_app_voice_response_create_report_dict = in_app_voice_response_create_report_instance.to_dict()
# create an instance of InAppVoiceResponseCreateReport from a dict
in_app_voice_response_create_report_from_dict = InAppVoiceResponseCreateReport.from_dict(in_app_voice_response_create_report_dict)
```
