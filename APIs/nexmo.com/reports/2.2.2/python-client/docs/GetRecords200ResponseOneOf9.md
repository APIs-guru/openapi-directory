...
json = "{}"
# create an instance of GetRecords200ResponseOneOf9 from a JSON string
get_records200_response_one_of9_instance = GetRecords200ResponseOneOf9.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf9.to_json())

# convert the object into a dict
get_records200_response_one_of9_dict = get_records200_response_one_of9_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf9 from a dict
get_records200_response_one_of9_from_dict = GetRecords200ResponseOneOf9.from_dict(get_records200_response_one_of9_dict)
```
