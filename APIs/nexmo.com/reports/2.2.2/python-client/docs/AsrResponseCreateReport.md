...
asr_response_create_report_instance = AsrResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(AsrResponseCreateReport.to_json())

# convert the object into a dict
asr_response_create_report_dict = asr_response_create_report_instance.to_dict()
# create an instance of AsrResponseCreateReport from a dict
asr_response_create_report_from_dict = AsrResponseCreateReport.from_dict(asr_response_create_report_dict)
```
