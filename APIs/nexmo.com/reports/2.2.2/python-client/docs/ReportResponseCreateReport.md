...
json = "{}"
# create an instance of ReportResponseCreateReport from a JSON string
report_response_create_report_instance = ReportResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(ReportResponseCreateReport.to_json())

# convert the object into a dict
report_response_create_report_dict = report_response_create_report_instance.to_dict()
# create an instance of ReportResponseCreateReport from a dict
report_response_create_report_from_dict = ReportResponseCreateReport.from_dict(report_response_create_report_dict)
```
