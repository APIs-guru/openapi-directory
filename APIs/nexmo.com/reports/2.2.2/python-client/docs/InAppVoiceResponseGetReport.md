...
json = "{}"
# create an instance of InAppVoiceResponseGetReport from a JSON string
in_app_voice_response_get_report_instance = InAppVoiceResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(InAppVoiceResponseGetReport.to_json())

# convert the object into a dict
in_app_voice_response_get_report_dict = in_app_voice_response_get_report_instance.to_dict()
# create an instance of InAppVoiceResponseGetReport from a dict
in_app_voice_response_get_report_from_dict = InAppVoiceResponseGetReport.from_dict(in_app_voice_response_get_report_dict)
```
