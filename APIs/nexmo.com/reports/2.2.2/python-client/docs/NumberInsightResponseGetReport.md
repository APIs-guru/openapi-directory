...
number_insight_response_get_report_instance = NumberInsightResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(NumberInsightResponseGetReport.to_json())

# convert the object into a dict
number_insight_response_get_report_dict = number_insight_response_get_report_instance.to_dict()
# create an instance of NumberInsightResponseGetReport from a dict
number_insight_response_get_report_from_dict = NumberInsightResponseGetReport.from_dict(number_insight_response_get_report_dict)
```
