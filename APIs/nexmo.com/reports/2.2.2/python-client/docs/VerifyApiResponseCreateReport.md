...
verify_api_response_create_report_instance = VerifyApiResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(VerifyApiResponseCreateReport.to_json())

# convert the object into a dict
verify_api_response_create_report_dict = verify_api_response_create_report_instance.to_dict()
# create an instance of VerifyApiResponseCreateReport from a dict
verify_api_response_create_report_from_dict = VerifyApiResponseCreateReport.from_dict(verify_api_response_create_report_dict)
```
