...
**concatenated** | **bool** | Whether the SMS was split up into multiple parts (due to its length). | [optional] [default to False]
...
json_sms_outbound_with_body_instance = JsonSmsOutboundWithBody.from_json(json)
# print the JSON string representation of the object
print(JsonSmsOutboundWithBody.to_json())

# convert the object into a dict
json_sms_outbound_with_body_dict = json_sms_outbound_with_body_instance.to_dict()
# create an instance of JsonSmsOutboundWithBody from a dict
json_sms_outbound_with_body_from_dict = JsonSmsOutboundWithBody.from_dict(json_sms_outbound_with_body_dict)
```
