...
get_records200_response_one_of7_instance = GetRecords200ResponseOneOf7.from_json(json)
# print the JSON string representation of the object
print(GetRecords200ResponseOneOf7.to_json())

# convert the object into a dict
get_records200_response_one_of7_dict = get_records200_response_one_of7_instance.to_dict()
# create an instance of GetRecords200ResponseOneOf7 from a dict
get_records200_response_one_of7_from_dict = GetRecords200ResponseOneOf7.from_dict(get_records200_response_one_of7_dict)
```
