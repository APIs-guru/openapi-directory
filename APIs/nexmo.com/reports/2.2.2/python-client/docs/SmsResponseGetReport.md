...
sms_response_get_report_instance = SmsResponseGetReport.from_json(json)
# print the JSON string representation of the object
print(SmsResponseGetReport.to_json())

# convert the object into a dict
sms_response_get_report_dict = sms_response_get_report_instance.to_dict()
# create an instance of SmsResponseGetReport from a dict
sms_response_get_report_from_dict = SmsResponseGetReport.from_dict(sms_response_get_report_dict)
```
