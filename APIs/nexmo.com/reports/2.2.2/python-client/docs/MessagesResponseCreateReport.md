...
messages_response_create_report_instance = MessagesResponseCreateReport.from_json(json)
# print the JSON string representation of the object
print(MessagesResponseCreateReport.to_json())

# convert the object into a dict
messages_response_create_report_dict = messages_response_create_report_instance.to_dict()
# create an instance of MessagesResponseCreateReport from a dict
messages_response_create_report_from_dict = MessagesResponseCreateReport.from_dict(messages_response_create_report_dict)
```
