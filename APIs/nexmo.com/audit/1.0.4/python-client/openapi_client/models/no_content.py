...
class NoContent(BaseModel):
    ...
    NoContent
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="A human readable description of the error AAA")
    message: Optional[StrictStr] = Field(default=None, description="A longer description of the error BBB")
