...
class ContextAppCreate(BaseModel):
    """
    ContextAppCreate
    """ # noqa: E501
    app_id: Optional[StrictStr] = Field(default=None, description="UUID of the app that was created", alias="appId")
    created: Optional[ContextAppCreateCreated] = None
    __properties: ClassVar[List[str]] = ["appId", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appId": obj.get("appId"),
            "created": ContextAppCreateCreated.from_dict(obj["created"]) if obj.get("created") is not None else None
        })
        return _obj
