...
class ErrorForbidden(BaseModel):
    ...
    ErrorForbidden
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="A human readable description of the error")
    message: Optional[StrictStr] = Field(default=None, description="A longer description of the error")
    status: Optional[StrictInt] = Field(default=None, description="The HTTP Status code of the error")
