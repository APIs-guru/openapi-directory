...
class ErrorNotFound(BaseModel):
    ...
    ErrorNotFound
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="A human readable description of the error XXX")
    message: Optional[StrictStr] = Field(default=None, description="A longer description of the error YYY")
