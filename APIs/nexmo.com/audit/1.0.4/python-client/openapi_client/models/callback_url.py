...
class CallbackUrl(BaseModel):
    ...
    CallbackUrl
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="The HTTP method used to make a callback to your application")
    url: Optional[StrictStr] = Field(default=None, description="The URL used for a callback to your application")
    __properties: ClassVar[List[str]] = ["method", "url"]
