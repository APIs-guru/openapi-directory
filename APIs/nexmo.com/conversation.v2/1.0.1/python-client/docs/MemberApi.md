...
------------- | ------------- | -------------
[**get_members**](MemberApi.md#get_members) | **GET** /conversations/{conversation_id}/members | List Members


# **get_members**
> GetMembers200Response get_members(conversation_id, page_size=page_size, order=order, cursor=cursor)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Members
        api_response = api_instance.get_members(conversation_id, page_size=page_size, order=order, cursor=cursor)
