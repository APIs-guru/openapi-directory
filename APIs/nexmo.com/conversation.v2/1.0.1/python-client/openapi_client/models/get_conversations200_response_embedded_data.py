...
class GetConversations200ResponseEmbeddedData(BaseModel):
    """
    GetConversations200ResponseEmbeddedData
    """ # noqa: E501
    conversations: Optional[List[ConversationList]] = Field(default=None, description="List of conversations matching the provided filter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [ConversationList.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None
        })
        return _obj
