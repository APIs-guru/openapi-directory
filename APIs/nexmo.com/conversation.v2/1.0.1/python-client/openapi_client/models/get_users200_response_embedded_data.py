...
class GetUsers200ResponseEmbeddedData(BaseModel):
    """
    GetUsers200ResponseEmbeddedData
    """ # noqa: E501
    users: Optional[List[UserList]] = Field(default=None, description="List of users matching the provided filter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserList.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
