...
class GetEvents200ResponseEmbeddedData(BaseModel):
    """
    GetEvents200ResponseEmbeddedData
    """ # noqa: E501
    events: Optional[List[AllEvents]] = Field(default=None, description="List of events matching the provided filter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [AllEvents.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
