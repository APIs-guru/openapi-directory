...
class ConversationApi:
    ...
    def get_conversations(
        self,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="The number of results returned per page.   The default value is `10`. The maximum value is `100`.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="Show the most (`desc`) / least (`asc`) recently created entries first")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="The cursor to start returning results from.  You are not expected to provide this manually, but to follow the url provided in `_links.next.href` in the response which contains a `cursor` value ")] = None,
        date_start: Annotated[Optional[StrictStr], Field(description="Search for conversations created after this ISO8601 date")] = None,
        date_end: Annotated[Optional[StrictStr], Field(description="Search for conversations created before this ISO8601 date")] = None,
