...
class TestVSMAccountResponse(unittest.TestCase):
    """VSMAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VSMAccountResponse:
        """Test VSMAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VSMAccountResponse`
        """
        model = VSMAccountResponse()
        if include_optional:
    ...
    def testVSMAccountResponse(self):
        """Test VSMAccountResponse"""
