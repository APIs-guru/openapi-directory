...
class TestGetAllAccountResponse(unittest.TestCase):
    """GetAllAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllAccountResponse:
        """Test GetAllAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllAccountResponse`
        """
        model = GetAllAccountResponse()
        if include_optional:
    ...
    def testGetAllAccountResponse(self):
        """Test GetAllAccountResponse"""
