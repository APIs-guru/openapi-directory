...
class TestUpdateMessengerAccountRequest(unittest.TestCase):
    """UpdateMessengerAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMessengerAccountRequest:
        """Test UpdateMessengerAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMessengerAccountRequest`
        """
        model = UpdateMessengerAccountRequest()
        if include_optional:
    ...
    def testUpdateMessengerAccountRequest(self):
        """Test UpdateMessengerAccountRequest"""
