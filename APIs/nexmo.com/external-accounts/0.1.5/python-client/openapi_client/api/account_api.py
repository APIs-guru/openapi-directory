...
class AccountApi:
    ...
    def get_all_accounts(
        ...
        page_number: Annotated[Optional[StrictInt], Field(description="Page number of the results")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size of the results")] = None,
    ...
    def get_all_accounts_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllAccounts200Response]:
        """Retrieve all accounts you own
