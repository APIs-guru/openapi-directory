...
class LinkApplication403Response(BaseModel):
    """
    LinkApplication403Response
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="The application does not exist or the application type is not \"messages\"")
