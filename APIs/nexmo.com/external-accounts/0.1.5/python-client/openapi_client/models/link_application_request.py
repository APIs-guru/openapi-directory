...
class LinkApplicationRequest(BaseModel):
    ...
    """ # noqa: E501
    application: StrictStr = Field(description="There is just one application allowed per an account. The application type must be type \"messages\". For more information please see [Application API Spec](https://developer.nexmo.com/api/application.v2)")
