...
class LinkApplication409Response(BaseModel):
    """
    LinkApplication409Response
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="The account reached limit of maximum number of linked applications. (The only one application is allowed per an account)")
