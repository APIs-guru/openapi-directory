...
class UpdateMessengerAccount400Response(BaseModel):
    """
    UpdateMessengerAccount400Response
    """ # noqa: E501
    detail: Optional[StrictStr] = None
    instance: Optional[StrictStr] = None
    invalid_params: Optional[List[UpdateMessengerAccount400ResponseInvalidParamsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invalid_params": [UpdateMessengerAccount400ResponseInvalidParamsInner.from_dict(_item) for _item in obj["invalid_params"]] if obj.get("invalid_params") is not None else None,
            "title": obj.get("title"),
            "type": obj.get("type")
        })
        return _obj
