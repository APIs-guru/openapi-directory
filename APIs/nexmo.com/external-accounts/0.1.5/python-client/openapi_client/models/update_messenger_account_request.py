...
class UpdateMessengerAccountRequest(BaseModel):
    """
    UpdateMessengerAccountRequest
    """ # noqa: E501
    access_token: Optional[StrictStr] = None
    applications: Optional[List[StrictStr]] = None
    name: Optional[StrictStr] = Field(default=None, description="The new account name")
    __properties: ClassVar[List[str]] = ["access_token", "applications", "name"]
