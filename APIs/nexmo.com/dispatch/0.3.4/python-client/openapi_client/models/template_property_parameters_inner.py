...
class TemplatePropertyParametersInner(BaseModel):
    """
    TemplatePropertyParametersInner
    """ # noqa: E501
    default: Optional[StrictStr] = Field(default=None, description="The parameters are an array. The first value being {{1}} in the template.")
