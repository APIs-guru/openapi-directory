...
class TemplateProperty(BaseModel):
    ...
    parameters: Optional[List[TemplatePropertyParametersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "parameters": [TemplatePropertyParametersInner.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
