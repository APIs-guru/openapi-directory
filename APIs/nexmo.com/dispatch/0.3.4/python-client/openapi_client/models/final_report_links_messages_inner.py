...
class FinalReportLinksMessagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["channel", "href", "message_uuid", "status", "usage"]
    ...
    def channel_validate_enum(cls, value):
        ...
        if value not in set(['messenger', 'viber_sevice_msg', 'sms', 'whatsapp', 'mms']):
            raise ValueError("must be one of enum values ('messenger', 'viber_sevice_msg', 'sms', 'whatsapp', 'mms')")
        return value
