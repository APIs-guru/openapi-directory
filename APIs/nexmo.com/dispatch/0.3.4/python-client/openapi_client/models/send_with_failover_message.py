...
class SendWithFailoverMessage(BaseModel):
    """
    Send With Failover Message
    """ # noqa: E501
    failover: Optional[FailoverProperty] = None
    var_from: FromProperty = Field(alias="from")
    message: MessageProperty
    to: ToProperty
    __properties: ClassVar[List[str]] = ["failover", "from", "message", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "failover": FailoverProperty.from_dict(obj["failover"]) if obj.get("failover") is not None else None,
