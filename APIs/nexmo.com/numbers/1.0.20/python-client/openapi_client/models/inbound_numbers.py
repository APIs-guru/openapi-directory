...
class InboundNumbers(BaseModel):
    ...
    InboundNumbers
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The total amount of numbers owned by the account")
    numbers: Optional[List[Ownednumber]] = Field(default=None, description="A paginated array of numbers and their details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "numbers": [Ownednumber.from_dict(_item) for _item in obj["numbers"]] if obj.get("numbers") is not None else None
        })
        return _obj
