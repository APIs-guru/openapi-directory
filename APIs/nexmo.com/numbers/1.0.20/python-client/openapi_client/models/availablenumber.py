...
class Availablenumber(BaseModel):
    ...
    Availablenumber
    """ # noqa: E501
    cost: Optional[StrictStr] = Field(default=None, description="The monthly rental cost for this number, in Euros")
    ...
    __properties: ClassVar[List[str]] = ["cost", "country", "features", "msisdn", "type"]
