...
class TestOwnednumber(unittest.TestCase):
    """Ownednumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ownednumber:
        """Test Ownednumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ownednumber`
        """
        model = Ownednumber()
        if include_optional:
            return Ownednumber(
