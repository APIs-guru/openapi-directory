...
create_call_request_ncco_instance = CreateCallRequestNcco.from_json(json)
# print the JSON string representation of the object
print(CreateCallRequestNcco.to_json())

# convert the object into a dict
create_call_request_ncco_dict = create_call_request_ncco_instance.to_dict()
# create an instance of CreateCallRequestNcco from a dict
create_call_request_ncco_from_dict = CreateCallRequestNcco.from_dict(create_call_request_ncco_dict)
```
