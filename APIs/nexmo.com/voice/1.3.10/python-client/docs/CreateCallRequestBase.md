...
json = "{}"
# create an instance of CreateCallRequestBase from a JSON string
create_call_request_base_instance = CreateCallRequestBase.from_json(json)
# print the JSON string representation of the object
print(CreateCallRequestBase.to_json())

# convert the object into a dict
create_call_request_base_dict = create_call_request_base_instance.to_dict()
# create an instance of CreateCallRequestBase from a dict
create_call_request_base_from_dict = CreateCallRequestBase.from_dict(create_call_request_base_dict)
```
