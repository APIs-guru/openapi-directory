...
class CreateCallRequestBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["event_method", "event_url", "from", "length_timer", "machine_detection", "random_from_number", "ringing_timer", "to"]
