...
class EndpointWebsocketHeaders(BaseModel):
    """
    Details of the Websocket you want to connect to
    """ # noqa: E501
    customer_id: Optional[StrictStr] = Field(default=None, description="This is an example header. You can provide any headers you may need")
