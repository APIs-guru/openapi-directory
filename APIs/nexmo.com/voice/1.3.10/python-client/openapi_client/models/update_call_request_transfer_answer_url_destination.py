...
class UpdateCallRequestTransferAnswerUrlDestination(BaseModel):
    """
    UpdateCallRequestTransferAnswerUrlDestination
    """ # noqa: E501
    type: StrictStr = Field(description="Always `ncco`")
    url: List[StrictStr] = Field(description="The URL that Vonage makes a request to. Must return an NCCO.")
