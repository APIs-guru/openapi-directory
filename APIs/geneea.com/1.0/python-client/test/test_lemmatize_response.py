...
class TestLemmatizeResponse(unittest.TestCase):
    """LemmatizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LemmatizeResponse:
        """Test LemmatizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LemmatizeResponse`
        """
        model = LemmatizeResponse()
        if include_optional:
    ...
    def testLemmatizeResponse(self):
        """Test LemmatizeResponse"""
