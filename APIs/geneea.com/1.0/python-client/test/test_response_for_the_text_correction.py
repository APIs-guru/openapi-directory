...
class TestResponseForTheTextCorrection(unittest.TestCase):
    """ResponseForTheTextCorrection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseForTheTextCorrection:
        """Test ResponseForTheTextCorrection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseForTheTextCorrection`
        """
        model = ResponseForTheTextCorrection()
        if include_optional:
            return ResponseForTheTextCorrection(
                corrected = True,
                corrected_text = '',
                diacritized = True,
                id = '',
    ...
    def testResponseForTheTextCorrection(self):
        """Test ResponseForTheTextCorrection"""
