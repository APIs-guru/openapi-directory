...
class TestEntrystringlong(unittest.TestCase):
    """Entrystringlong unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Entrystringlong:
        """Test Entrystringlong
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Entrystringlong`
        """
        model = Entrystringlong()
        if include_optional:
            return Entrystringlong(
                key = 56
            )
        else:
            return Entrystringlong(
