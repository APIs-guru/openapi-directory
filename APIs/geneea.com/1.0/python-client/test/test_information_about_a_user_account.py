...
class TestInformationAboutAUserAccount(unittest.TestCase):
    """InformationAboutAUserAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InformationAboutAUserAccount:
        """Test InformationAboutAUserAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InformationAboutAUserAccount`
        """
        model = InformationAboutAUserAccount()
        if include_optional:
            return InformationAboutAUserAccount(
                remaining_quotas = [
                    openapi_client.models.entry«string,long».Entry«string,long»(
                        key = 56, )
                    ],
                type = ''
            )
    ...
    def testInformationAboutAUserAccount(self):
        """Test InformationAboutAUserAccount"""
