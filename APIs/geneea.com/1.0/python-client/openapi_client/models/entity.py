...
class Entity(BaseModel):
    ...
    The named entity
    """ # noqa: E501
    entity: StrictStr = Field(description="Disambiguated and standardized form of the entity")
    links: Dict[str, Any] = Field(description="Disambiguation links for the entity, e.g. its DBpedia page")
    sentiment: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Detected sentiment of the entity (value from -1.0 to 1.0)")
    text_offset: StrictInt = Field(description="Character offset in the text (starting from 0)", alias="textOffset")
    type: StrictStr = Field(description="Detected type of the entity")
    __properties: ClassVar[List[str]] = ["entity", "links", "sentiment", "textOffset", "type"]
