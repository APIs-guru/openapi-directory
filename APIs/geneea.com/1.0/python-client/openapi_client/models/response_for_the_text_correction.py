...
class ResponseForTheTextCorrection(BaseModel):
    """
    ResponseForTheTextCorrection
    """ # noqa: E501
    corrected: Optional[StrictBool] = None
    corrected_text: StrictStr = Field(description="Corrected text of the document", alias="correctedText")
    diacritized: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["corrected", "correctedText", "diacritized", "id", "language", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diacritized": obj.get("diacritized"),
            "id": obj.get("id"),
