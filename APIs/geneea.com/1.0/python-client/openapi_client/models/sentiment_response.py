...
class SentimentResponse(BaseModel):
    ...
    sentiment: Union[StrictFloat, StrictInt] = Field(description="Detected sentiment of the document (value from -1.0 to 1.0)")
    text: Optional[StrictStr] = Field(default=None, description="The raw text of the document which has been analysed")
    __properties: ClassVar[List[str]] = ["id", "language", "sentiment", "text"]
