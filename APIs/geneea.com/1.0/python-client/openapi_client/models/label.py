...
class Label(BaseModel):
    ...
    The topic label
    """ # noqa: E501
    confidence: Union[StrictFloat, StrictInt] = Field(description="Confidence (probability) of this label")
    label: StrictStr = Field(description="The value of this label")
    __properties: ClassVar[List[str]] = ["confidence", "label"]
