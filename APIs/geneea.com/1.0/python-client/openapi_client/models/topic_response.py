...
class TopicResponse(BaseModel):
    ...
    """ # noqa: E501
    confidence: Union[StrictFloat, StrictInt] = Field(description="Confidence for the detected topic")
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the document")
    labels: List[Label] = Field(description="Probabilistic distribution over possible topic labels")
    ...
    topic: StrictStr = Field(description="Detected topic of the document")
    __properties: ClassVar[List[str]] = ["confidence", "id", "labels", "language", "text", "topic"]
