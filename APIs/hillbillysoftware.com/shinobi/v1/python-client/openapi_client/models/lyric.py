...
class Lyric(BaseModel):
    ...
    lyrics: Optional[StrictStr] = Field(default=None, alias="Lyrics")
    song: Optional[StrictStr] = Field(default=None, alias="Song")
    __properties: ClassVar[List[str]] = ["AlbumID", "Artist", "Lyrics", "Song"]
