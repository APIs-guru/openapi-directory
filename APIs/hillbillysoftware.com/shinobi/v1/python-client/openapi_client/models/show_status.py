...
class ShowStatus(BaseModel):
    ...
    ShowStatus
    """ # noqa: E501
    enddate: Optional[StrictStr] = Field(default=None, alias="Enddate")
    id: Optional[StrictStr] = Field(default=None, alias="ID")
    title: Optional[StrictStr] = Field(default=None, alias="Title")
    years_on: Optional[StrictStr] = Field(default=None, alias="YearsOn")
    imdb_id: Optional[StrictStr] = Field(default=None, alias="imdbID")
    status: Optional[StrictStr] = None
    tvdb_id: Optional[StrictStr] = Field(default=None, alias="tvdbID")
    __properties: ClassVar[List[str]] = ["Enddate", "ID", "Title", "YearsOn", "imdbID", "status", "tvdbID"]
