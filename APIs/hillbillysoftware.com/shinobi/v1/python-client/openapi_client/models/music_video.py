...
class MusicVideo(BaseModel):
    ...
    decription: Optional[StrictStr] = Field(default=None, alias="Decription")
    video: Optional[StrictStr] = Field(default=None, alias="Video")
    __properties: ClassVar[List[str]] = ["AlbumID", "ArtistID", "Decription", "Video"]
