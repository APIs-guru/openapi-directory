...
class TVShowSeasons(BaseModel):
    """
    TVShowSeasons
    """ # noqa: E501
    episodes: Optional[StrictStr] = Field(default=None, alias="Episodes")
    ...
    showname: Optional[StrictStr] = Field(default=None, alias="Showname")
    __properties: ClassVar[List[str]] = ["Episodes", "Externals", "Seasons", "Showname"]
