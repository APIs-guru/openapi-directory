...
class Episode(BaseModel):
    ...
    Episode
    """ # noqa: E501
    airdate: Optional[StrictStr] = Field(default=None, alias="Airdate")
    airtime: Optional[StrictStr] = Field(default=None, alias="Airtime")
    episode_no: Optional[StrictStr] = Field(default=None, alias="EpisodeNo")
    ...
    __properties: ClassVar[List[str]] = ["Airdate", "Airtime", "EpisodeNo", "Externals", "Image", "Season", "Synopsis", "Title"]
