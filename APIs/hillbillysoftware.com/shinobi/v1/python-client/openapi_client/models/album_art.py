...
class AlbumArt(BaseModel):
    ...
    albumname: Optional[StrictStr] = Field(default=None, alias="Albumname")
    art: Optional[StrictStr] = Field(default=None, alias="Art")
    __properties: ClassVar[List[str]] = ["AlbumID", "Albumname", "Art"]
