...
------------- | ------------- | -------------
[**get_association_by_id**](PublicApi.md#get_association_by_id) | **GET** /platform/public/association | Get association by id
[**get_association_filter**](PublicApi.md#get_association_filter) | **GET** /platform/public/association/filter | Filter available associations
[**get_data_metrics**](PublicApi.md#get_data_metrics) | **GET** /platform/public/utils/metrics | Get metrics about the current data release
[**get_data_stats**](PublicApi.md#get_data_stats) | **GET** /platform/public/utils/stats | Get statistics about the current data release
[**get_evidence_by_id**](PublicApi.md#get_evidence_by_id) | **GET** /platform/public/evidence | Get evidence by ID
[**get_evidence_filter**](PublicApi.md#get_evidence_filter) | **GET** /platform/public/evidence/filter | Filter available evidence
[**get_ping**](PublicApi.md#get_ping) | **GET** /platform/public/utils/ping | Ping service
[**get_search**](PublicApi.md#get_search) | **GET** /platform/public/search | Search for a disease or a target
[**get_therapeutic_areas**](PublicApi.md#get_therapeutic_areas) | **GET** /platform/public/utils/therapeuticareas | Get the list of therapeutic areas about the current data release
[**get_version**](PublicApi.md#get_version) | **GET** /platform/public/utils/version | Get API version
[**post_association_filter**](PublicApi.md#post_association_filter) | **POST** /platform/public/association/filter | Batch query available associations
[**post_evidence_by_id**](PublicApi.md#post_evidence_by_id) | **POST** /platform/public/evidence | Get evidence for a list of IDs
[**post_evidence_filter**](PublicApi.md#post_evidence_filter) | **POST** /platform/public/evidence/filter | Batch filter available evidence


# **get_association_by_id**
> get_association_by_id(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get association by id
        api_instance.get_association_by_id(id)
    except Exception as e:
        print("Exception when calling PublicApi->get_association_by_id: %s\n" % e)
```
...
> get_association_filter(target=target, disease=disease, therapeutic_area=therapeutic_area, datasource=datasource, datatype=datatype, pathway=pathway, target_class=target_class, uniprotkw=uniprotkw, direct=direct, datastructure=datastructure, fields=fields, facets=facets, scorevalue_min=scorevalue_min, scorevalue_max=scorevalue_max, scorevalue_types=scorevalue_types, size=size, var_from=var_from, format=format, sort=sort, search=search)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Filter available associations
        api_instance.get_association_filter(target=target, disease=disease, therapeutic_area=therapeutic_area, datasource=datasource, datatype=datatype, pathway=pathway, target_class=target_class, uniprotkw=uniprotkw, direct=direct, datastructure=datastructure, fields=fields, facets=facets, scorevalue_min=scorevalue_min, scorevalue_max=scorevalue_max, scorevalue_types=scorevalue_types, size=size, var_from=var_from, format=format, sort=sort, search=search)
    except Exception as e:
        print("Exception when calling PublicApi->get_association_filter: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get metrics about the current data release
        api_instance.get_data_metrics()
    except Exception as e:
        print("Exception when calling PublicApi->get_data_metrics: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get statistics about the current data release
        api_instance.get_data_stats()
    except Exception as e:
        print("Exception when calling PublicApi->get_data_stats: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get evidence by ID
        api_instance.get_evidence_by_id(id)
    except Exception as e:
        print("Exception when calling PublicApi->get_evidence_by_id: %s\n" % e)
```
...
# **get_evidence_filter**
> get_evidence_filter(target=target, disease=disease, data_source=data_source, datatype=datatype, pathway=pathway, uniprotkw=uniprotkw, datastructure=datastructure, fields=fields, scorevalue_min=scorevalue_min, scorevalue_max=scorevalue_max, sort=sort, size=size, var_from=var_from, format=format)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Filter available evidence
        api_instance.get_evidence_filter(target=target, disease=disease, data_source=data_source, datatype=datatype, pathway=pathway, uniprotkw=uniprotkw, datastructure=datastructure, fields=fields, scorevalue_min=scorevalue_min, scorevalue_max=scorevalue_max, sort=sort, size=size, var_from=var_from, format=format)
    except Exception as e:
        print("Exception when calling PublicApi->get_evidence_filter: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PublicApi->get_ping: %s\n" % e)
```
...
# **get_search**
> get_search(q, size=size, var_from=var_from, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for a disease or a target
        api_instance.get_search(q, size=size, var_from=var_from, filter=filter)
    except Exception as e:
        print("Exception when calling PublicApi->get_search: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the list of therapeutic areas about the current data release
        api_instance.get_therapeutic_areas()
    except Exception as e:
        print("Exception when calling PublicApi->get_therapeutic_areas: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PublicApi->get_version: %s\n" % e)
```
...
# **post_association_filter**
> post_association_filter(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Batch query available associations
        api_instance.post_association_filter(body)
    except Exception as e:
        print("Exception when calling PublicApi->post_association_filter: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get evidence for a list of IDs
        api_instance.post_evidence_by_id(body)
    except Exception as e:
        print("Exception when calling PublicApi->post_evidence_by_id: %s\n" % e)
```
...
# **post_evidence_filter**
> post_evidence_filter(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Batch filter available evidence
        api_instance.post_evidence_filter(body)
    except Exception as e:
        print("Exception when calling PublicApi->post_evidence_filter: %s\n" % e)
```
