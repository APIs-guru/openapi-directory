...
class TestUtilsApi(unittest.TestCase):
    ...
    def test_get_data_metrics_0(self) -> None:
    ...
    def test_get_data_stats_0(self) -> None:
    ...
    def test_get_therapeutic_areas_0(self) -> None:
    ...
    def test_get_version_0(self) -> None:
