...
class TestPublicApi(unittest.TestCase):
    ...
    def test_get_association_by_id(self) -> None:
    ...
    def test_get_association_filter(self) -> None:
    ...
    def test_get_data_metrics(self) -> None:
    ...
    def test_get_data_stats(self) -> None:
    ...
    def test_get_evidence_filter(self) -> None:
    ...
    def test_get_therapeutic_areas(self) -> None:
    ...
    def test_post_association_filter(self) -> None:
    ...
    def test_post_evidence_by_id(self) -> None:
    ...
    def test_post_evidence_filter(self) -> None:
