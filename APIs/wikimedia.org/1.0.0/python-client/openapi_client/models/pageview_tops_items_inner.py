...
class PageviewTopsItemsInner(BaseModel):
    """
    PageviewTopsItemsInner
    """ # noqa: E501
    access: Optional[StrictStr] = None
    articles: Optional[List[PageviewTopsItemsInnerArticlesInner]] = None
    day: Optional[StrictStr] = None
    month: Optional[StrictStr] = None
    project: Optional[StrictStr] = None
    year: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["access", "articles", "day", "month", "project", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "articles": [PageviewTopsItemsInnerArticlesInner.from_dict(_item) for _item in obj["articles"]] if obj.get("articles") is not None else None,
            "day": obj.get("day"),
            "month": obj.get("month"),
