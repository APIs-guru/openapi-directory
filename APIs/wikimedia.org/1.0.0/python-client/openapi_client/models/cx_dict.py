...
class CxDict(BaseModel):
    ...
    CxDict
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="the original word to look up")
    translations: Optional[List[CxDictTranslationsInner]] = Field(default=None, description="the translations found")
    __properties: ClassVar[List[str]] = ["source", "translations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "translations": [CxDictTranslationsInner.from_dict(_item) for _item in obj["translations"]] if obj.get("translations") is not None else None
        })
        return _obj
