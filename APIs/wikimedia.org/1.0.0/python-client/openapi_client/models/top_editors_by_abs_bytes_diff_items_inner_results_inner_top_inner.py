...
class TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner(BaseModel):
    """
    TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner
    """ # noqa: E501
    abs_bytes_diff: Optional[StrictInt] = None
    rank: Optional[StrictInt] = None
    user_text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["abs_bytes_diff", "rank", "user_text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abs_bytes_diff": obj.get("abs_bytes_diff"),
            "rank": obj.get("rank"),
