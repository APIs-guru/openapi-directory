...
class TestBytesDifferenceDataApi(unittest.TestCase):
    """BytesDifferenceDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BytesDifferenceDataApi()

    def tearDown(self) -> None:
        pass

    def test_metrics_bytes_difference_absolute_aggregate_project_editor_type_page_type_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_bytes_difference_absolute_per_page_project_page_title_editor_type_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_bytes_difference_net_aggregate_project_editor_type_page_type_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_bytes_difference_net_per_page_project_page_title_editor_type_granularity_start_end_get(self) -> None:
