...
class TestRegisteredUsersDataApi(unittest.TestCase):
    """RegisteredUsersDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RegisteredUsersDataApi()

    def tearDown(self) -> None:
        pass

    def test_metrics_registered_users_new_project_granularity_start_end_get(self) -> None:
