...
class TestFeedContentAvailabilityApi(unittest.TestCase):
    """FeedContentAvailabilityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = FeedContentAvailabilityApi()

    def tearDown(self) -> None:
        pass

    def test_feed_availability_get(self) -> None:
