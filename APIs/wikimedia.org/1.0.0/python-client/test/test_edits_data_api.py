...
class TestEditsDataApi(unittest.TestCase):
    """EditsDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EditsDataApi()

    def tearDown(self) -> None:
        pass

    def test_metrics_edits_aggregate_project_editor_type_page_type_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_edits_per_page_project_page_title_editor_type_granularity_start_end_get(self) -> None:
