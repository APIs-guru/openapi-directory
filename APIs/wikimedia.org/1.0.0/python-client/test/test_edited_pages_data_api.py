...
class TestEditedPagesDataApi(unittest.TestCase):
    """EditedPagesDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EditedPagesDataApi()

    def tearDown(self) -> None:
        pass

    def test_metrics_edited_pages_aggregate_project_editor_type_page_type_activity_level_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_edited_pages_new_project_editor_type_page_type_granularity_start_end_get(self) -> None:
    ...
    def test_metrics_edited_pages_top_by_absolute_bytes_difference_project_editor_type_page_type_year_month_day_get(self) -> None:
    ...
    def test_metrics_edited_pages_top_by_edits_project_editor_type_page_type_year_month_day_get(self) -> None:
    ...
    def test_metrics_edited_pages_top_by_net_bytes_difference_project_editor_type_page_type_year_month_day_get(self) -> None:
