...
class AiPlanningLevelRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "method", "params", "planningLevelId", "startDate"]

    @field_validator('method')
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['icueMLP', 'icueMLO', 'icueMLN']):
            raise ValueError("must be one of enum values ('icueMLP', 'icueMLO', 'icueMLN')")
        return value
