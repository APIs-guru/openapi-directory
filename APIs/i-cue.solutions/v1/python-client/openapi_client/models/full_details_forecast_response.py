...
class FullDetailsForecastResponse(BaseModel):
    ...
    time_series: Optional[List[TimeSeriesFullDetailsResponse]] = Field(default=None, alias="timeSeries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeSeries": [TimeSeriesFullDetailsResponse.from_dict(_item) for _item in obj["timeSeries"]] if obj.get("timeSeries") is not None else None
        })
        return _obj
