...
class HistoryAndForecastResponse(BaseModel):
    ...
    time_series: Optional[List[TimeSeriesHistoryAndForecastResponse]] = Field(default=None, alias="timeSeries")
    __properties: ClassVar[List[str]] = ["hyperparameters", "timeSeries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeSeries": [TimeSeriesHistoryAndForecastResponse.from_dict(_item) for _item in obj["timeSeries"]] if obj.get("timeSeries") is not None else None
        })
        return _obj
