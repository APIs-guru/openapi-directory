...
debtor_account_write_instance = DebtorAccountWrite.from_json(json)
# print the JSON string representation of the object
print(DebtorAccountWrite.to_json())

# convert the object into a dict
debtor_account_write_dict = debtor_account_write_instance.to_dict()
# create an instance of DebtorAccountWrite from a dict
debtor_account_write_from_dict = DebtorAccountWrite.from_dict(debtor_account_write_dict)
```
