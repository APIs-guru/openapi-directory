...
**link** | **str** | Link to initiate authorization with Institution | [optional] [readonly] [default to 'https://ob.nordigen.com/pis/start/ec728ca1-e25f-4eab-8fa6-66b94439722f/{$INSTITUTION_ID}']
...
**periodic_payment** | [**PeriodicPayment**](PeriodicPayment.md) |  | [optional] 
...
json = "{}"
# create an instance of PaymentWrite from a JSON string
payment_write_instance = PaymentWrite.from_json(json)
# print the JSON string representation of the object
print(PaymentWrite.to_json())

# convert the object into a dict
payment_write_dict = payment_write_instance.to_dict()
# create an instance of PaymentWrite from a dict
payment_write_from_dict = PaymentWrite.from_dict(payment_write_dict)
```
