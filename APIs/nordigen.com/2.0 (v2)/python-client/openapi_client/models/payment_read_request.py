...
class PaymentReadRequest(BaseModel):
    """
    PaymentReadSerializer.
    """ # noqa: E501
    creditor_account: Optional[StrictStr] = Field(default=None, description="Registered creditor account")
    creditor_object: Optional[CreditorAccountWriteRequest] = Field(default=None, description="Creditor account")
    custom_payment_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, description="Payment Custom Payment ID")
    debtor_account: DebtorAccountWriteRequest
    description: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default='GOCARDLESS', description="Payment description")
    institution_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default='SWEDBANK_SANDBOX_SANDLV22', description="Institution ID for Payment")
    instructed_amount: InstructedAmountRequest = Field(description="Instructed amount")
    ...
    redirect: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(description="Redirect URL to your application after payment is done")
    __properties: ClassVar[List[str]] = ["creditor_account", "creditor_object", "custom_payment_id", "debtor_account", "description", "institution_id", "instructed_amount", "payment_product", "redirect"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditor_object": CreditorAccountWriteRequest.from_dict(obj["creditor_object"]) if obj.get("creditor_object") is not None else None,
            "custom_payment_id": obj.get("custom_payment_id"),
            "debtor_account": DebtorAccountWriteRequest.from_dict(obj["debtor_account"]) if obj.get("debtor_account") is not None else None,
            "description": obj.get("description") if obj.get("description") is not None else 'GOCARDLESS',
            "institution_id": obj.get("institution_id") if obj.get("institution_id") is not None else 'SWEDBANK_SANDBOX_SANDLV22',
            "instructed_amount": InstructedAmountRequest.from_dict(obj["instructed_amount"]) if obj.get("instructed_amount") is not None else None,
