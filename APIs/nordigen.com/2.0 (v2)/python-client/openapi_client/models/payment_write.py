...
class PaymentWrite(BaseModel):
    ...
    link: Optional[StrictStr] = Field(default='https://ob.nordigen.com/pis/start/ec728ca1-e25f-4eab-8fa6-66b94439722f/{$INSTITUTION_ID}', description="Link to initiate authorization with Institution")
    ...
    requested_execution_date: Optional[date] = Field(default=None, description="Payment Execution date (for periodic payments)")
    submit_payment: Optional[StrictBool] = Field(default=False, description="Indicates whether payment should be submitted separately")
    __properties: ClassVar[List[str]] = ["creditor_account", "creditor_object", "custom_payment_id", "description", "instructed_amount", "link", "payment_id", "payment_product", "payment_status", "payment_type", "periodic_payment", "redirect", "requested_execution_date", "submit_payment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.periodic_payment:
            _dict['periodic_payment'] = self.periodic_payment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "link": obj.get("link") if obj.get("link") is not None else 'https://ob.nordigen.com/pis/start/ec728ca1-e25f-4eab-8fa6-66b94439722f/{$INSTITUTION_ID}',
            "payment_id": obj.get("payment_id"),
            "payment_product": obj.get("payment_product"),
            "payment_status": obj.get("payment_status"),
            "payment_type": obj.get("payment_type"),
            "periodic_payment": PeriodicPayment.from_dict(obj["periodic_payment"]) if obj.get("periodic_payment") is not None else None,
            "redirect": obj.get("redirect"),
            "requested_execution_date": obj.get("requested_execution_date"),
            "submit_payment": obj.get("submit_payment") if obj.get("submit_payment") is not None else False
        })
        return _obj
