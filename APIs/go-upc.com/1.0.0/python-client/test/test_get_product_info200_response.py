...
class TestGetProductInfo200Response(unittest.TestCase):
    """GetProductInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProductInfo200Response:
        """Test GetProductInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProductInfo200Response`
        """
        model = GetProductInfo200Response()
        if include_optional:
            return GetProductInfo200Response(
                barcode_url = 'https://go-upc.com/barcode/829576019311',
                code_type = 'UPC',
                product = openapi_client.models.get_product_info_200_response_product.getProductInfo_200_response_product(
    ...
    def testGetProductInfo200Response(self):
        """Test GetProductInfo200Response"""
