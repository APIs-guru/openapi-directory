...
class UploadParameterObject(BaseModel):
    """
    ...
    policy: Optional[StrictStr] = Field(default=None, alias="Policy")
    signature: Optional[StrictStr] = Field(default=None, alias="Signature")
    acl: Optional[StrictStr] = None
    action: Optional[StrictStr] = None
    key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["AWSAccessKeyId", "Content-Type", "Policy", "Signature", "acl", "action", "key"]
