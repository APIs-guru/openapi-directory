...
class TestAdminReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdminReport:
        """Test AdminReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminReport`
        """
        model = AdminReport()
        if include_optional:
            return AdminReport(
                account = openapi_client.models.account.Account(
                    ...
                    username = '', ),
                action_taken = '',
                assigned_account = openapi_client.models.account.Account(
                    acct = '', 
                    avatar = '', 
                    avatar_static = '', 
                    bot = True, 
