...
class ApiV1StatusesIdReblogPostRequest(BaseModel):
    ...
    """ # noqa: E501
    visibility: Optional[StrictStr] = Field(default=None, description="any visibility except limited or direct (i.e. public, unlisted, private). Defaults to public. Currently unused in UI.")
