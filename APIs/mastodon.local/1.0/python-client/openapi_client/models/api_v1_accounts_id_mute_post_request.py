...
class ApiV1AccountsIdMutePostRequest(BaseModel):
    ...
    """ # noqa: E501
    duration: Optional[StrictInt] = Field(default=0, description="How long the mute should last, in seconds. Defaults to 0 (indefinite).")
    notifications: Optional[StrictBool] = Field(default=True, description="Mute notifications in addition to statuses? Defaults to true.")
    __properties: ClassVar[List[str]] = ["duration", "notifications"]
