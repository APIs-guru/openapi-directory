...
class ApiV2SearchGet200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hashtags": [Status.from_dict(_item) for _item in obj["hashtags"]] if obj.get("hashtags") is not None else None,
            "statuses": [Tag.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
