...
class Context(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ancestors", "descendants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ancestors": [Status.from_dict(_item) for _item in obj["ancestors"]] if obj.get("ancestors") is not None else None,
            "descendants": [Status.from_dict(_item) for _item in obj["descendants"]] if obj.get("descendants") is not None else None
        })
        return _obj
