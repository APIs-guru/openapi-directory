...
class ApiV1ScheduledStatusesIdPutRequest(BaseModel):
    ...
    """ # noqa: E501
    scheduled_at: Optional[datetime] = Field(default=None, description="ISO 8601 Datetime at which the status will be published. Must be at least 5 minutes into the future.")
    __properties: ClassVar[List[str]] = ["scheduled_at"]
