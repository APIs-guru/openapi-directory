...
class Tag(BaseModel):
    ...
    """ # noqa: E501
    history: Optional[List[History]] = Field(default=None, description="Usage statistics for given days.")
    name: StrictStr = Field(description="The value of the hashtag after the `#` sign.")
    url: StrictStr = Field(description="A link to the hashtag on the instance.")
    __properties: ClassVar[List[str]] = ["history", "name", "url"]
