...
class ApiV1AppsPost200Response(BaseModel):
    """
    ...
    vapid_key: Optional[StrictStr] = None
    website: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "id", "name", "redirect_uri", "vapid_key", "website"]
