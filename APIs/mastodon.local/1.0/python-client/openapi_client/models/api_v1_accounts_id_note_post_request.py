...
class ApiV1AccountsIdNotePostRequest(BaseModel):
    ...
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="The comment to be set on that user. Provide an empty string or leave out this parameter to clear the currently set note.")
