...
class Token(BaseModel):
    ...
    shop_url: Optional[StrictStr] = Field(default=None, alias="shopURL")
    ...
    __properties: ClassVar[List[str]] = ["active", "expirationTime", "licenseNumber", "number", "shopURL", "tokenType", "vendorNumber"]
