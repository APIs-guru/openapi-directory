...
class VersionMetaData(BaseModel):
    ...
    id: StrictStr = Field(description="The artifact id.")
    ...
    type: ArtifactType
    version: StrictInt
    __properties: ClassVar[List[str]] = ["createdBy", "createdOn", "description", "globalId", "id", "labels", "name", "properties", "state", "type", "version"]
