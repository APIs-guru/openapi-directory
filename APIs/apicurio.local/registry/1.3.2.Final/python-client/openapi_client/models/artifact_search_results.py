...
class ArtifactSearchResults(BaseModel):
    """
    Describes the response received when searching for artifacts.
    """ # noqa: E501
    artifacts: List[SearchedArtifact] = Field(description="The artifacts that matched the search criteria.")
    count: StrictInt = Field(description="The total number of artifacts that matched the search criteria.")
    __properties: ClassVar[List[str]] = ["artifacts", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": [SearchedArtifact.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
            "count": obj.get("count")
        })
        return _obj
