...
class TestArtifactSearchResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ArtifactSearchResults:
        """Test ArtifactSearchResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactSearchResults`
        """
        model = ArtifactSearchResults()
        if include_optional:
            return ArtifactSearchResults(
                artifacts = [
                    {"createdBy":"user1","createdOn":"2019-03-22T12:51:19Z","description":"Description of the artifact","id":"Procurement-Invoice","labels":["current","internal"],"name":"Artifact Name","state":"ENABLED","type":"AVRO"}
                    ],
                count = 56
            )
        else:
