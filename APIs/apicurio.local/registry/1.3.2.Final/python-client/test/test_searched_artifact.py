...
class TestSearchedArtifact(unittest.TestCase):
    """SearchedArtifact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchedArtifact:
        """Test SearchedArtifact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchedArtifact`
        """
        model = SearchedArtifact()
        if include_optional:
