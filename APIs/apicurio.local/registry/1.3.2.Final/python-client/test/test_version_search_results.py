    ...
    def make_instance(self, include_optional) -> VersionSearchResults:
        ...
        if include_optional:
            return VersionSearchResults(
                count = 56,
                versions = [
                    {"createdBy":"user1","createdOn":"2019-03-22T12:51:19Z","description":"Description of the artifact version","globalId":3849759283547,"labels":["current","internal"],"name":"Artifact Version Name","state":"ENABLED","type":"AVRO","version":17}
                    ]
            )
        else:
            return VersionSearchResults(
