...
------------- | ------------- | -------------
[**create_artifact_rule**](ArtifactRulesApi.md#create_artifact_rule) | **POST** /artifacts/{artifactId}/rules | Create artifact rule
[**delete_artifact_rule**](ArtifactRulesApi.md#delete_artifact_rule) | **DELETE** /artifacts/{artifactId}/rules/{rule} | Delete artifact rule
[**delete_artifact_rules**](ArtifactRulesApi.md#delete_artifact_rules) | **DELETE** /artifacts/{artifactId}/rules | Delete artifact rules
[**get_artifact_rule_config**](ArtifactRulesApi.md#get_artifact_rule_config) | **GET** /artifacts/{artifactId}/rules/{rule} | Get artifact rule configuration
[**list_artifact_rules**](ArtifactRulesApi.md#list_artifact_rules) | **GET** /artifacts/{artifactId}/rules | List artifact rules
[**test_update_artifact**](ArtifactRulesApi.md#test_update_artifact) | **PUT** /artifacts/{artifactId}/test | Test update artifact
[**update_artifact_rule_config**](ArtifactRulesApi.md#update_artifact_rule_config) | **PUT** /artifacts/{artifactId}/rules/{rule} | Update artifact rule configuration


# **create_artifact_rule**
> create_artifact_rule(artifact_id, rule)
...
> delete_artifact_rule(rule, artifact_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete artifact rule
        api_instance.delete_artifact_rule(rule, artifact_id)
    except Exception as e:
...
> delete_artifact_rules(artifact_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete artifact rules
        api_instance.delete_artifact_rules(artifact_id)
    except Exception as e:
...
> Rule get_artifact_rule_config(rule, artifact_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get artifact rule configuration
        api_response = api_instance.get_artifact_rule_config(rule, artifact_id)
...
# **list_artifact_rules**
> List[RuleType] list_artifact_rules(artifact_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List artifact rules
        api_response = api_instance.list_artifact_rules(artifact_id)
...
> test_update_artifact(artifact_id, x_registry_artifact_type=x_registry_artifact_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Test update artifact
        api_instance.test_update_artifact(artifact_id, x_registry_artifact_type=x_registry_artifact_type)
    except Exception as e:
...
> Rule update_artifact_rule_config(rule, artifact_id, rule2)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update artifact rule configuration
        api_response = api_instance.update_artifact_rule_config(rule, artifact_id, rule2)
