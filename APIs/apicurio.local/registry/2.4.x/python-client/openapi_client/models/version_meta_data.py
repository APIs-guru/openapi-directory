...
class VersionMetaData(BaseModel):
    ...
    group_id: Optional[StrictStr] = Field(default=None, description="An ID of a single artifact group.", alias="groupId")
    id: StrictStr = Field(description="The ID of a single artifact.")
    ...
    type: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["contentId", "createdBy", "createdOn", "description", "globalId", "groupId", "id", "labels", "name", "properties", "state", "type", "version"]
