...
class ArtifactMetaData(BaseModel):
    ...
    type: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["contentId", "createdBy", "createdOn", "description", "globalId", "groupId", "id", "labels", "modifiedBy", "modifiedOn", "name", "properties", "references", "state", "type", "version"]
