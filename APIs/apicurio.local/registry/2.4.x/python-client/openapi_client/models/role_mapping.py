...
class RoleMapping(BaseModel):
    ...
    principal_name: Optional[StrictStr] = Field(default=None, description="A friendly name for the principal.", alias="principalName")
    role: RoleType
    __properties: ClassVar[List[str]] = ["principalId", "principalName", "role"]
