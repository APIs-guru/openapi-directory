...
class ArtifactContent(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="Raw content of the artifact or a valid (and accessible) URL where the content can be found.")
    references: List[ArtifactReference] = Field(description="Collection of references to other artifacts.")
    __properties: ClassVar[List[str]] = ["content", "references"]
