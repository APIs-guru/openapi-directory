...
class SystemApi:
    ...
    def get_resource_limits(
        ...
        _param = self._get_resource_limits_serialize(
    ...
    @validate_call
    def get_resource_limits_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_resource_limits_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_resource_limits_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
