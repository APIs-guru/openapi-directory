...
class TestNamedLogConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NamedLogConfiguration:
        """Test NamedLogConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedLogConfiguration`
        """
        model = NamedLogConfiguration()
        if include_optional:
