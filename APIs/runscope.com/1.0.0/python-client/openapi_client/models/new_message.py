...
class NewMessage(BaseModel):
    ...
    NewMessage
    """ # noqa: E501
    request: Optional[NewMessageRequest] = None
    response: Optional[NewMessageResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": NewMessageRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
            "response": NewMessageResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
