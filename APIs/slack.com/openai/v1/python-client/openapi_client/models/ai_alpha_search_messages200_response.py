...
class AiAlphaSearchMessages200Response(BaseModel):
    """
    AiAlphaSearchMessages200Response
    """ # noqa: E501
    ok: StrictBool = Field(description="Boolean indicating whether or not the request was successful")
    results: Optional[List[Result]] = None
    __properties: ClassVar[List[str]] = ["ok", "results"]
