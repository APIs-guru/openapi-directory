...
class UsersIdentitySchemaInnerAnyOf2User(BaseModel):
    """
    ...
    image_72: StrictStr
    name: StrictStr
    __properties: ClassVar[List[str]] = ["id", "image_192", "image_24", "image_32", "image_48", "image_512", "image_72", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsersIdentitySchemaInnerAnyOf2User from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsersIdentitySchemaInnerAnyOf2User from a dict"""
        if obj is None:
            return None
