...
class StarsListSchemaItemsInnerInnerAnyOf1(BaseModel):
    """
    ...
    file: ObjsFile
    type: StrictStr
    __properties: ClassVar[List[str]] = ["date_create", "file", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StarsListSchemaItemsInnerInnerAnyOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StarsListSchemaItemsInnerInnerAnyOf1 from a dict"""
        if obj is None:
            return None
