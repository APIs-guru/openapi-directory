...
class ConversationsRepliesSuccessSchema(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in messages (list of list)
        _items = []
        if self.messages:
            for _item_messages in self.messages:
                if _item_messages:
                    _items.append(
                         [_inner_item.to_dict() for _inner_item in _item_messages if _inner_item is not None]
                    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [
                    [ConversationsRepliesSuccessSchemaMessagesInnerInner.from_dict(_inner_item) for _inner_item in _item]
