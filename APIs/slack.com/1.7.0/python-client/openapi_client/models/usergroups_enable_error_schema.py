...
class UsergroupsEnableErrorSchema(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['not_authed', 'invalid_auth', 'account_inactive', 'token_revoked', 'no_permission', 'org_login_required', 'user_is_bot', 'user_is_restricted', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_require', 'fatal_error', 'missing_charset', 'superfluous_charset']):
            raise ValueError("must be one of enum values ('not_authed', 'invalid_auth', 'account_inactive', 'token_revoked', 'no_permission', 'org_login_required', 'user_is_bot', 'user_is_restricted', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_require', 'fatal_error', 'missing_charset', 'superfluous_charset')")
        return value
