...
class ObjsReminder(BaseModel):
    ...
    ObjsReminder
    """ # noqa: E501
    complete_ts: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["complete_ts", "creator", "id", "recurring", "text", "time", "user"]
    ...
    def id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^Rm[A-Z0-9]{8,}$", value):
            raise ValueError(r"must validate the regular expression /^Rm[A-Z0-9]{8,}$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "complete_ts": obj.get("complete_ts"),
