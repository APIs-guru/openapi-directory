...
class ObjsUserInnerAnyOf1(BaseModel):
    """
    enterprise user
    """ # noqa: E501
    color: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="refercing to bug: https://jira.tinyspeck.com/browse/EVALUE-1559")
    ...
    teams: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1)]] = None
