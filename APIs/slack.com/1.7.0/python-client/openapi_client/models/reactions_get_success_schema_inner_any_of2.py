...
class ReactionsGetSuccessSchemaInnerAnyOf2(BaseModel):
    """
    ...
    ok: StrictBool
    type: StrictStr
    __properties: ClassVar[List[str]] = ["comment", "file", "ok", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReactionsGetSuccessSchemaInnerAnyOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReactionsGetSuccessSchemaInnerAnyOf2 from a dict"""
        if obj is None:
            return None
