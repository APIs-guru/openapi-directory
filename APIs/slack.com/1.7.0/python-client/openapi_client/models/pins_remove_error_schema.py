...
class PinsRemoveErrorSchema(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bad_timestamp', 'file_not_found', 'file_comment_not_found', 'message_not_found', 'no_item_specified', 'not_pinned', 'permission_denied', 'not_authed', 'invalid_auth', 'account_inactive', 'no_permission', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_typ', 'missing_post_typ', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeou', 'upgrade_required']):
            raise ValueError("must be one of enum values ('bad_timestamp', 'file_not_found', 'file_comment_not_found', 'message_not_found', 'no_item_specified', 'not_pinned', 'permission_denied', 'not_authed', 'invalid_auth', 'account_inactive', 'no_permission', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_typ', 'missing_post_typ', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeou', 'upgrade_required')")
        return value
