...
class ConversationMPIMObject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accepted_user", "connected_team_ids", "conversation_host_id", "created", "creator", "display_counts", "id", "internal_team_ids", "is_archived", "is_channel", "is_ext_shared", "is_frozen", "is_general", "is_group", "is_im", "is_member", "is_moved", "is_mpim", "is_non_threadable", "is_open", "is_org_shared", "is_pending_ext_shared", "is_private", "is_read_only", "is_shared", "is_starred", "is_thread_only", "last_read", "latest", "members", "name", "name_normalized", "num_members", "parent_conversation", "pending_connected_team_ids", "pending_shared", "pin_count", "previous_names", "priority", "purpose", "shared_team_ids", "shares", "timezone_count", "topic", "unlinked", "unread_count", "unread_count_display", "user", "version"]
