...
class ConversationsHistoryErrorSchema(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['missing_scope', 'channel_not_found', 'invalid_ts_latest', 'invalid_ts_oldest', 'not_authed', 'invalid_auth', 'account_inactive', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_required']):
            raise ValueError("must be one of enum values ('missing_scope', 'channel_not_found', 'invalid_ts_latest', 'invalid_ts_oldest', 'not_authed', 'invalid_auth', 'account_inactive', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_required')")
        return value
