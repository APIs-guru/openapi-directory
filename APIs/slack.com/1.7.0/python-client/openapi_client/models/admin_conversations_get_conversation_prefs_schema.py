...
class AdminConversationsGetConversationPrefsSchema(BaseModel):
    """
    Schema for successful response of admin.conversations.getConversationPrefs
    """ # noqa: E501
    ok: StrictBool
    prefs: Optional[AdminConversationsGetConversationPrefsSchemaPrefs] = None
    __properties: ClassVar[List[str]] = ["ok", "prefs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": obj.get("ok"),
            "prefs": AdminConversationsGetConversationPrefsSchemaPrefs.from_dict(obj["prefs"]) if obj.get("prefs") is not None else None
        })
        return _obj
