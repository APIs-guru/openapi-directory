...
class ObjsMessageAttachmentsInner(BaseModel):
    """
    ObjsMessageAttachmentsInner
    """ # noqa: E501
    fallback: Optional[StrictStr] = None
    id: StrictInt
    image_bytes: Optional[StrictInt] = None
    image_height: Optional[StrictInt] = None
    image_url: Optional[StrictStr] = None
    image_width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["fallback", "id", "image_bytes", "image_height", "image_url", "image_width"]
