...
class UsersInfoSuccessSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ok", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": obj.get("ok"),
            "user": [ObjsUserInner.from_dict(_item) for _item in obj["user"]] if obj.get("user") is not None else None
        })
