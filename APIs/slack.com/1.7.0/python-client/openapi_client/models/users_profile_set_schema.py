...
class UsersProfileSetSchema(BaseModel):
    """
    Schema for successful response from users.profile.set method
    """ # noqa: E501
    email_pending: Optional[StrictStr] = None
    ok: StrictBool
    profile: ObjsUserProfile
    username: StrictStr
    __properties: ClassVar[List[str]] = ["email_pending", "ok", "profile", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email_pending": obj.get("email_pending"),
            "ok": obj.get("ok"),
