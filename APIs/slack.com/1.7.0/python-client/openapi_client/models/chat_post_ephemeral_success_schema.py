...
class ChatPostEphemeralSuccessSchema(BaseModel):
    """
    Schema for successful response from chat.postEphemeral method
    """ # noqa: E501
    message_ts: Annotated[str, Field(strict=True)]
    ok: StrictBool
    __properties: ClassVar[List[str]] = ["message_ts", "ok"]

    @field_validator('message_ts')
    def message_ts_validate_regular_expression(cls, value):
