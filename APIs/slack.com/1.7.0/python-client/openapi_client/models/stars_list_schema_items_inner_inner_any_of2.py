...
class StarsListSchemaItemsInnerInnerAnyOf2(BaseModel):
    """
    ...
    file: ObjsFile
    type: StrictStr
    __properties: ClassVar[List[str]] = ["comment", "date_create", "file", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['file_comment']):
            raise ValueError("must be one of enum values ('file_comment')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StarsListSchemaItemsInnerInnerAnyOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StarsListSchemaItemsInnerInnerAnyOf2 from a dict"""
        if obj is None:
            return None
