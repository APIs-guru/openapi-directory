...
class CallsParticipantsApi:
    ...
    def calls_participants_add(
        ...
        _param = self._calls_participants_add_serialize(
            token=token,
            id=id,
            users=users,
    ...
    @validate_call
    def calls_participants_add_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `calls:write`")],
        id: Annotated[StrictStr, Field(description="`id` returned by the [`calls.add`](/methods/calls.add) method.")],
        users: Annotated[StrictStr, Field(description="The list of users to add as participants in the Call. [Read more on how to specify users here](/apis/calls#users).")],
    ...
    @validate_call
    def calls_participants_add_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `calls:write`")],
        id: Annotated[StrictStr, Field(description="`id` returned by the [`calls.add`](/methods/calls.add) method.")],
        users: Annotated[StrictStr, Field(description="The list of users to add as participants in the Call. [Read more on how to specify users here](/apis/calls#users).")],
    ...
    def _calls_participants_add_serialize(
        self,
        token,
        id,
        users,
    ...
    def calls_participants_remove(
        ...
        _param = self._calls_participants_remove_serialize(
            token=token,
            id=id,
            users=users,
            _request_auth=_request_auth,
    ...
    @validate_call
    def calls_participants_remove_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `calls:write`")],
        id: Annotated[StrictStr, Field(description="`id` returned by the [`calls.add`](/methods/calls.add) method.")],
        users: Annotated[StrictStr, Field(description="The list of users to remove as participants in the Call. [Read more on how to specify users here](/apis/calls#users).")],
    ...
    @validate_call
    def calls_participants_remove_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `calls:write`")],
        id: Annotated[StrictStr, Field(description="`id` returned by the [`calls.add`](/methods/calls.add) method.")],
        users: Annotated[StrictStr, Field(description="The list of users to remove as participants in the Call. [Read more on how to specify users here](/apis/calls#users).")],
    ...
    def _calls_participants_remove_serialize(
        self,
        token,
        id,
        users,
