...
class TestObjsUserInner(unittest.TestCase):
    """ObjsUserInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjsUserInner:
        """Test ObjsUserInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjsUserInner`
        """
        model = ObjsUserInner()
        if include_optional:
            return ObjsUserInner(
                color = '2ECB02',
                deleted = True,
