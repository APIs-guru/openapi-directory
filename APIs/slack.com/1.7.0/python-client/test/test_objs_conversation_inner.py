...
class TestObjsConversationInner(unittest.TestCase):
    """ObjsConversationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjsConversationInner:
        """Test ObjsConversationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjsConversationInner`
        """
        model = ObjsConversationInner()
        if include_optional:
            return ObjsConversationInner(
    ...
    def testObjsConversationInner(self):
        """Test ObjsConversationInner"""
