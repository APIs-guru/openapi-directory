...
class TestUsergroupsEnableSchema(unittest.TestCase):
    """UsergroupsEnableSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsergroupsEnableSchema:
        """Test UsergroupsEnableSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsergroupsEnableSchema`
        """
        model = UsergroupsEnableSchema()
        if include_optional:
    ...
    def testUsergroupsEnableSchema(self):
        """Test UsergroupsEnableSchema"""
