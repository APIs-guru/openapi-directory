...
class TestConversationMPIMObject(unittest.TestCase):
    """ConversationMPIMObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMPIMObject:
        """Test ConversationMPIMObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMPIMObject`
        """
        model = ConversationMPIMObject()
        if include_optional:
            return ConversationMPIMObject(
    ...
    def testConversationMPIMObject(self):
        """Test ConversationMPIMObject"""
