# openapi_client.AdminAppsRequestsApi
...
> DefaultSuccessTemplate admin_apps_requests_list(token, limit=limit, cursor=cursor, team_id=team_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdminAppsRequestsApi(api_client)
    ...
    try:
        api_response = api_instance.admin_apps_requests_list(token, limit=limit, cursor=cursor, team_id=team_id)
        print("The response of AdminAppsRequestsApi->admin_apps_requests_list:\n")
        pprint(api_response)
