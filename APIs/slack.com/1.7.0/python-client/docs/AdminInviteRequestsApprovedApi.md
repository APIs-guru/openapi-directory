# openapi_client.AdminInviteRequestsApprovedApi
...
> DefaultSuccessTemplate admin_invite_requests_approved_list(token, team_id=team_id, cursor=cursor, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdminInviteRequestsApprovedApi(api_client)
    ...
    try:
        api_response = api_instance.admin_invite_requests_approved_list(token, team_id=team_id, cursor=cursor, limit=limit)
        print("The response of AdminInviteRequestsApprovedApi->admin_invite_requests_approved_list:\n")
        pprint(api_response)
