# openapi_client.AdminInviteRequestsApi
...
> DefaultSuccessTemplate admin_invite_requests_approve(token, invite_request_id, team_id=team_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdminInviteRequestsApi(api_client)
    token = 'token_example' # str | Authentication token. Requires scope: `admin.invites:write`
    invite_request_id = 'invite_request_id_example' # str | ID of the request to invite.
    team_id = 'team_id_example' # str | ID for the workspace where the invite request was made. (optional)

    try:
        api_response = api_instance.admin_invite_requests_approve(token, invite_request_id, team_id=team_id)
        print("The response of AdminInviteRequestsApi->admin_invite_requests_approve:\n")
        pprint(api_response)
 ...
 **team_id** | **str**| ID for the workspace where the invite request was made. | [optional] 
...
> DefaultSuccessTemplate admin_invite_requests_deny(token, invite_request_id, team_id=team_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.admin_invite_requests_deny(token, invite_request_id, team_id=team_id)
        print("The response of AdminInviteRequestsApi->admin_invite_requests_deny:\n")
        pprint(api_response)
    except Exception as e:
...
> DefaultSuccessTemplate admin_invite_requests_list(token, team_id=team_id, cursor=cursor, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.admin_invite_requests_list(token, team_id=team_id, cursor=cursor, limit=limit)
        print("The response of AdminInviteRequestsApi->admin_invite_requests_list:\n")
        pprint(api_response)
    except Exception as e:
