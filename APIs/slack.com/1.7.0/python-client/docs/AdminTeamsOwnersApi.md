# openapi_client.AdminTeamsOwnersApi
...
> DefaultSuccessTemplate admin_teams_owners_list(token, team_id, limit=limit, cursor=cursor)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdminTeamsOwnersApi(api_client)
    ...
    try:
        api_response = api_instance.admin_teams_owners_list(token, team_id, limit=limit, cursor=cursor)
        print("The response of AdminTeamsOwnersApi->admin_teams_owners_list:\n")
        pprint(api_response)
