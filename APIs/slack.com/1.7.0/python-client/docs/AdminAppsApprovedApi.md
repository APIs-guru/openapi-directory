# openapi_client.AdminAppsApprovedApi
...
> DefaultSuccessTemplate admin_apps_approved_list(token, limit=limit, cursor=cursor, team_id=team_id, enterprise_id=enterprise_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AdminAppsApprovedApi(api_client)
    ...
    try:
        api_response = api_instance.admin_apps_approved_list(token, limit=limit, cursor=cursor, team_id=team_id, enterprise_id=enterprise_id)
        print("The response of AdminAppsApprovedApi->admin_apps_approved_list:\n")
        pprint(api_response)
