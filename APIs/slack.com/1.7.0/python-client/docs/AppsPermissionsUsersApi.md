# openapi_client.AppsPermissionsUsersApi
...
> DefaultSuccessTemplate apps_permissions_users_list(token, cursor=cursor, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AppsPermissionsUsersApi(api_client)
    ...
    try:
        api_response = api_instance.apps_permissions_users_list(token, cursor=cursor, limit=limit)
        print("The response of AppsPermissionsUsersApi->apps_permissions_users_list:\n")
        pprint(api_response)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.apps_permissions_users_request(token, scopes, trigger_id, user)
        print("The response of AppsPermissionsUsersApi->apps_permissions_users_request:\n")
        pprint(api_response)
    except Exception as e:
