...
class TestMlsInformation(unittest.TestCase):
    """MlsInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MlsInformation:
        """Test MlsInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MlsInformation`
        """
        model = MlsInformation()
        if include_optional:
