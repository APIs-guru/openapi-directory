...
class TestOpenHouse(unittest.TestCase):
    """OpenHouse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenHouse:
        """Test OpenHouse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenHouse`
        """
        model = OpenHouse()
        if include_optional:
            return OpenHouse(
                ...
                input_id = None,
                listing = openapi_client.models.listing.Listing(
