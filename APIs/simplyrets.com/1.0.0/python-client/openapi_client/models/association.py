...
class Association(BaseModel):
    ...
    """ # noqa: E501
    amenities: Optional[StrictStr] = Field(default=None, description="Any extra amenities granted by the HOA")
    fee: Optional[StrictInt] = Field(default=None, description="Association fee")
    name: Optional[StrictStr] = Field(default=None, description="Name of the association")
    __properties: ClassVar[List[str]] = ["amenities", "fee", "name"]
