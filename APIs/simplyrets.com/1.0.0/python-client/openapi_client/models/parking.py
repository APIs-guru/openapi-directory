...
class Parking(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Parking features description")
    leased: Optional[StrictStr] = None
    spaces: Optional[StrictInt] = Field(default=None, description="Number of parking spaces")
    __properties: ClassVar[List[str]] = ["description", "leased", "spaces"]
