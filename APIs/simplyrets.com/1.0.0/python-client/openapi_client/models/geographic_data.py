...
class GeographicData(BaseModel):
    ...
    """ # noqa: E501
    county: Optional[StrictStr] = Field(default=None, description="Listing county")
    directions: Optional[StrictStr] = Field(default=None, description="Directions to the property")
    lat: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Listing latitude (if available)")
    lng: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Listing longitude (if available)")
    market_area: Optional[StrictStr] = Field(default=None, description="Listing GeoMarket area. May be the same as mlsArea", alias="marketArea")
    __properties: ClassVar[List[str]] = ["county", "directions", "lat", "lng", "marketArea"]
