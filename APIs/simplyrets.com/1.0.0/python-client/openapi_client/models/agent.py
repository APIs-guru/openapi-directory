...
class Agent(BaseModel):
    ...
    first_name: Optional[StrictStr] = Field(default=None, description="Agent first name", alias="firstName")
    id: Optional[StrictStr] = Field(default=None, description="Well known Agent MLS number or id.")
    last_name: Optional[StrictStr] = Field(default=None, description="Agent last name", alias="lastName")
    __properties: ClassVar[List[str]] = ["contact", "firstName", "id", "lastName"]
