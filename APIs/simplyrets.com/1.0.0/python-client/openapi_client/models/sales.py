...
class Sales(BaseModel):
    ...
    Sales Data
    """ # noqa: E501
    agent: Optional[StrictStr] = Field(default=None, description="RETS Sales data agent id")
    close_date: Optional[datetime] = Field(default=None, description="RETS Sales data close date", alias="closeDate")
    close_price: Optional[StrictInt] = Field(default=None, description="RETS Sales data sold price", alias="closePrice")
    contract_date: Optional[datetime] = Field(default=None, description="RETS Sales data contract date", alias="contractDate")
    office: Optional[StrictStr] = Field(default=None, description="RETS Sales data selling office/brokerage id")
    __properties: ClassVar[List[str]] = ["agent", "closeDate", "closePrice", "contractDate", "office"]
