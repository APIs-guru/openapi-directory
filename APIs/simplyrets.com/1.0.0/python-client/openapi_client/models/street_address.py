...
class StreetAddress(BaseModel):
    ...
    country: Optional[StrictStr] = Field(default=None, description="Street address country (United States or Canada)")
    cross_street: Optional[StrictStr] = Field(default=None, description="Known cross street", alias="crossStreet")
    full: Optional[StrictStr] = Field(default=None, description="Full pretty-printed address with suffix (if available)")
    postal_code: Optional[StrictStr] = Field(default=None, description="Street Address postal code", alias="postalCode")
    state: Optional[StrictStr] = Field(default=None, description="State or province. Maps to the data dictionary field `StateOrProvince`.")
    street_name: Optional[StrictStr] = Field(default=None, description="Name of the street", alias="streetName")
    street_number: Optional[StrictInt] = Field(default=None, description="Street number", alias="streetNumber")
    street_number_text: Optional[StrictStr] = Field(default=None, description="Textual representation of the street number. This field is usually redundant with what's in `streetNumber` but is occassionally usefuly for street number which are actually alpha-numerical. For example, \"N63453\" or \"34556B\".  **Added on 2016/05/02** ", alias="streetNumberText")
    __properties: ClassVar[List[str]] = ["city", "country", "crossStreet", "full", "postalCode", "state", "streetName", "streetNumber", "streetNumberText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "crossStreet": obj.get("crossStreet"),
            "full": obj.get("full"),
            "postalCode": obj.get("postalCode"),
            "state": obj.get("state"),
            "streetName": obj.get("streetName"),
            "streetNumber": obj.get("streetNumber"),
            "streetNumberText": obj.get("streetNumberText")
        })
        return _obj
