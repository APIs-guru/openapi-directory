...
class Office(BaseModel):
    ...
    RETS MLS Office
    """ # noqa: E501
    brokerid: Optional[StrictStr] = Field(default=None, description="Office or brokerage MLS identifier  **Not available for all RETS vendors** ")
    contact: Optional[ContactInformation] = None
    name: Optional[StrictStr] = Field(default=None, description="Pimary office name")
    serving_name: Optional[StrictStr] = Field(default=None, description="Primary office or brokerage name", alias="servingName")
    __properties: ClassVar[List[str]] = ["brokerid", "contact", "name", "servingName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ContactInformation.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "name": obj.get("name"),
            "servingName": obj.get("servingName")
        })
        return _obj
