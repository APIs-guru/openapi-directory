...
class Error(BaseModel):
    ...
    Error information
    """ # noqa: E501
    error: Optional[StrictInt] = Field(default=None, description="Error code. In general, we try to adhere to HTTP status code and use these error statuses for detailed reporting. ")
    message: Optional[StrictStr] = Field(default=None, description="Status message with an explanation of the error")
