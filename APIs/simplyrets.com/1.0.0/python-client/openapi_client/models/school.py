...
class School(BaseModel):
    ...
    """ # noqa: E501
    district: Optional[StrictStr] = Field(default=None, description="School district name.")
    elementary_school: Optional[StrictStr] = Field(default=None, description="Elementary school name.", alias="elementarySchool")
    high_school: Optional[StrictStr] = Field(default=None, description="High school name", alias="highSchool")
    middle_school: Optional[StrictStr] = Field(default=None, description="Middle or junior school name", alias="middleSchool")
    __properties: ClassVar[List[str]] = ["district", "elementarySchool", "highSchool", "middleSchool"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "elementarySchool": obj.get("elementarySchool"),
            "highSchool": obj.get("highSchool"),
            "middleSchool": obj.get("middleSchool")
        })
        return _obj
