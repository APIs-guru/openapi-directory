...
class OpenHouse(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The remarks and/or description details for the open house")
    end_time: Optional[datetime] = Field(default=None, description="The ending date time for the open house", alias="endTime")
    input_id: Optional[Dict[str, Any]] = Field(default=None, description="The MLS number for the showing agent or agent which created the OpenHouse in the MLS database. ", alias="inputId")
    listing: Optional[Listing] = None
    open_house_id: Optional[StrictStr] = Field(default=None, description="The MLS number or id provided by the MLS ", alias="openHouseId")
    open_house_key: Optional[StrictStr] = Field(default=None, description="A unique identifier for the open house which is specific to the SimplyRETS API ", alias="openHouseKey")
    refreshments: Optional[StrictStr] = Field(default=None, description="Provided")
    start_time: Optional[datetime] = Field(default=None, description="Start Date for the open house", alias="startTime")
    type: Optional[StrictStr] = Field(default=None, description="The open house type. For example, Public or Private")
    __properties: ClassVar[List[str]] = ["description", "endTime", "inputId", "listing", "openHouseId", "openHouseKey", "refreshments", "startTime", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "openHouseId": obj.get("openHouseId"),
            "openHouseKey": obj.get("openHouseKey"),
            "refreshments": obj.get("refreshments"),
