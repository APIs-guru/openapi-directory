...
class Tax(BaseModel):
    ...
    RETS MLS Tax Data
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Tax Parcel ID for the listing")
    tax_annual_amount: Optional[StrictStr] = Field(default=None, description="Annual tax amount in USD", alias="taxAnnualAmount")
    tax_year: Optional[StrictInt] = Field(default=None, description="Tax Year", alias="taxYear")
    __properties: ClassVar[List[str]] = ["id", "taxAnnualAmount", "taxYear"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "taxAnnualAmount": obj.get("taxAnnualAmount"),
