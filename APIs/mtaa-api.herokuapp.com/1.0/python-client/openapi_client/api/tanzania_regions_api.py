...
class TanzaniaRegionsApi:
    ...
    def tanzania_regions(
        ...
        _param = self._tanzania_regions_serialize(
            country=country,
    ...
    @validate_call
    def tanzania_regions_with_http_info(
        self,
        country: Annotated[StrictStr, Field(description="Country name in lowercase eg (Tanzania)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def tanzania_regions_without_preload_content(
        self,
        country: Annotated[StrictStr, Field(description="Country name in lowercase eg (Tanzania)")],
        _request_timeout: Union[
            None,
    ...
    def _tanzania_regions_serialize(
        self,
        country,
        _request_auth,
        _content_type,
