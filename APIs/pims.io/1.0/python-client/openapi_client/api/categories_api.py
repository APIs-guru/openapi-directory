...
class CategoriesApi:
    ...
    def fetch_all_categories(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the categories whose label/short label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the categories which are not ignored. If set to `true`, show all categories.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the categories in the corresponding order.")] = None,
    ...
    def fetch_all_categories_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CategoriesEntity]]:
        """Find all categories
    ...
    @validate_call
    def fetch_all_events_categories(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._fetch_all_events_categories_serialize(
            event_id=event_id,
            show_ignored=show_ignored,
            page_size=page_size,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[EventsCategoriesEntity]",
            '401': "Error401",
            '403': "Error403",
            '422': "Error422",
            '500': "Error500",
    ...
    @validate_call
    def fetch_all_events_categories_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EventsCategoriesEntity]]:
        """Find all categories for one event
    ...
    @validate_call
    def fetch_all_events_categories_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
    ...
    def _fetch_all_events_categories_serialize(
        self,
        event_id,
        show_ignored,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_one_category(
        self,
        category_id: Annotated[StrictInt, Field(description="ID of the targeted category.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param category_id: ID of the targeted category. (required)
        ...
        _param = self._fetch_one_category_serialize(
    ...
    @validate_call
    def fetch_one_category_with_http_info(
        self,
        category_id: Annotated[StrictInt, Field(description="ID of the targeted category.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_category_without_preload_content(
        self,
        category_id: Annotated[StrictInt, Field(description="ID of the targeted category.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_category_serialize(
        self,
        category_id,
        accept_language,
        _request_auth,
    ...
    @validate_call
    def fetch_one_event_category(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        category_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the targeted event category.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the embedded [event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param event_id: ID of the targeted event. (required)
        :type event_id: int
        :param category_id: ID of the targeted event category. (required)
        ...
        _param = self._fetch_one_event_category_serialize(
            event_id=event_id,
            category_id=category_id,
            show_ignored=show_ignored,
            _request_auth=_request_auth,
    ...
    @validate_call
    def fetch_one_event_category_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        category_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the targeted event category.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the embedded [event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventsCategoriesEntity]:
        """Get one event category by ID
    ...
    @validate_call
    def fetch_one_event_category_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        category_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the targeted event category.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the embedded [event-]price ranges which are not ignored. If set to `true`, show everything.")] = None,
    ...
    def _fetch_one_event_category_serialize(
        self,
        event_id,
        category_id,
        show_ignored,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/categories/{category_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
