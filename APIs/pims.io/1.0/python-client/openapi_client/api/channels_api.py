...
class ChannelsApi:
    ...
    def fetch_all_channels(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the channels whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the channels which are not ignored. If set to `true`, show all channels.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the channels in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_channels_serialize(
            label=label,
    ...
    @validate_call
    def fetch_all_channels_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the channels whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the channels which are not ignored. If set to `true`, show all channels.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the channels in the corresponding order.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChannelsEntity]]:
        """Find all channels
    ...
    @validate_call
    def fetch_all_channels_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the channels whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the channels which are not ignored. If set to `true`, show all channels.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the channels in the corresponding order.")] = None,
    ...
    def _fetch_all_channels_serialize(
        self,
        label,
        show_ignored,
        sort,
    ...
    @validate_call
    def fetch_all_events_channels(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]channels which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._fetch_all_events_channels_serialize(
            event_id=event_id,
            show_ignored=show_ignored,
            page_size=page_size,
            _request_auth=_request_auth,
    ...
    @validate_call
    def fetch_all_events_channels_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]channels which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EventsChannelsEntity]]:
        """Find all channels for one event
    ...
    @validate_call
    def fetch_all_events_channels_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]channels which are not ignored. If set to `true`, show everything.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
    ...
    def _fetch_all_events_channels_serialize(
        self,
        event_id,
        show_ignored,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/channels',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_one_channel(
        self,
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted channel.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param channel_id: ID of the targeted channel. (required)
        :type channel_id: int
        :param accept_language: Language used for the translatable labels.
        :type accept_language: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._fetch_one_channel_serialize(
    ...
    @validate_call
    def fetch_one_channel_with_http_info(
        self,
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted channel.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_channel_without_preload_content(
        self,
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted channel.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_channel_serialize(
        self,
        channel_id,
        accept_language,
        _request_auth,
    ...
    @validate_call
    def fetch_one_event_channel(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted event channel.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param event_id: ID of the targeted event. (required)
        :type event_id: int
        :param channel_id: ID of the targeted event channel. (required)
        :type channel_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._fetch_one_event_channel_serialize(
            event_id=event_id,
            channel_id=channel_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_one_event_channel_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted event channel.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventsChannelsEntity]:
        """Get one event channel by ID
    ...
    @validate_call
    def fetch_one_event_channel_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        channel_id: Annotated[StrictInt, Field(description="ID of the targeted event channel.")],
        _request_timeout: Union[
    ...
    def _fetch_one_event_channel_serialize(
        self,
        event_id,
        channel_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/channels/{channel_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
