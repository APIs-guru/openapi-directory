...
class EventsApi:
    ...
    def fetch_all_events(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the events whose label contains this value.")] = None,
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
        city: Annotated[Optional[StrictStr], Field(description="Find only the events whose venue city (or metropolitan area) contains this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the events in the corresponding order.")] = None,
        ...
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        ...
        _param = self._fetch_all_events_serialize(
            label=label,
    ...
    @validate_call
    def fetch_all_events_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the events whose label contains this value.")] = None,
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    @validate_call
    def fetch_all_events_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the events whose label contains this value.")] = None,
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    def _fetch_all_events_serialize(
        self,
        label,
        from_datetime,
        to_datetime,
        ...
        if from_datetime is not None:
            if isinstance(from_datetime, date):
        ...
        if to_datetime is not None:
            if isinstance(to_datetime, date):
                _query_params.append(
                    (
                        'to_datetime',
    ...
    @validate_call
    def fetch_all_series_events(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
        city: Annotated[Optional[StrictStr], Field(description="Find only the events whose venue city (or metropolitan area) contains this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the events in the corresponding order.")] = None,
        ...
        :param series_id: ID of the targeted series. (required)
        :type series_id: int
        :param from_datetime: Find only the events starting after this date.
        :type from_datetime: date
        :param to_datetime: Find only the events starting before this date.
        ...
        _param = self._fetch_all_series_events_serialize(
            series_id=series_id,
            from_datetime=from_datetime,
            to_datetime=to_datetime,
            city=city,
    ...
    @validate_call
    def fetch_all_series_events_with_http_info(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    @validate_call
    def fetch_all_series_events_without_preload_content(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    def _fetch_all_series_events_serialize(
        self,
        series_id,
        from_datetime,
        to_datetime,
        ...
        if series_id is not None:
            _path_params['series_id'] = series_id
        # process the query parameters
        if from_datetime is not None:
            if isinstance(from_datetime, date):
                _query_params.append(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/series/{series_id}/events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_all_venues_events(
        self,
        venue_id: Annotated[StrictInt, Field(description="ID of the targeted venue.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
        city: Annotated[Optional[StrictStr], Field(description="Find only the events whose venue city (or metropolitan area) contains this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the events in the corresponding order.")] = None,
        ...
        :param venue_id: ID of the targeted venue. (required)
        :type venue_id: int
        :param from_datetime: Find only the events starting after this date.
        :type from_datetime: date
        :param to_datetime: Find only the events starting before this date.
        ...
        _param = self._fetch_all_venues_events_serialize(
            venue_id=venue_id,
            from_datetime=from_datetime,
            to_datetime=to_datetime,
            city=city,
    ...
    @validate_call
    def fetch_all_venues_events_with_http_info(
        self,
        venue_id: Annotated[StrictInt, Field(description="ID of the targeted venue.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    @validate_call
    def fetch_all_venues_events_without_preload_content(
        self,
        venue_id: Annotated[StrictInt, Field(description="ID of the targeted venue.")],
        from_datetime: Annotated[Optional[date], Field(description="Find only the events starting after this date.")] = None,
        to_datetime: Annotated[Optional[date], Field(description="Find only the events starting before this date.")] = None,
    ...
    def _fetch_all_venues_events_serialize(
        self,
        venue_id,
        from_datetime,
        to_datetime,
        ...
        if venue_id is not None:
            _path_params['venue_id'] = venue_id
        # process the query parameters
        if from_datetime is not None:
            if isinstance(from_datetime, date):
                _query_params.append(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/venues/{venue_id}/events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_one_event(
        ...
        _param = self._fetch_one_event_serialize(
            event_id=event_id,
            accept_language=accept_language,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_one_event_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_event_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_event_serialize(
        self,
        event_id,
        accept_language,
        _request_auth,
