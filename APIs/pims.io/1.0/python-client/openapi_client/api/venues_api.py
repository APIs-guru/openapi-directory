...
class VenuesApi:
    ...
    def fetch_all_venues(
        ...
        city: Annotated[Optional[StrictStr], Field(description="Find only the venues whose city contains this value.")] = None,
        country_code: Annotated[Optional[StrictStr], Field(description="Find only the venues whose country_code is equal to this value.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Find only the venues whose type is equal to this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the venues in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_venues_serialize(
            label=label,
            city=city,
    ...
    @validate_call
    def fetch_all_venues_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the venues whose label contains this value.")] = None,
        city: Annotated[Optional[StrictStr], Field(description="Find only the venues whose city contains this value.")] = None,
        country_code: Annotated[Optional[StrictStr], Field(description="Find only the venues whose country_code is equal to this value.")] = None,
    ...
    @validate_call
    def fetch_all_venues_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the venues whose label contains this value.")] = None,
        city: Annotated[Optional[StrictStr], Field(description="Find only the venues whose city contains this value.")] = None,
        country_code: Annotated[Optional[StrictStr], Field(description="Find only the venues whose country_code is equal to this value.")] = None,
    ...
    def _fetch_all_venues_serialize(
        self,
        label,
        city,
        country_code,
    ...
    def fetch_one_venue(
        ...
        _param = self._fetch_one_venue_serialize(
            venue_id=venue_id,
            accept_language=accept_language,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_one_venue_with_http_info(
        self,
        venue_id: Annotated[StrictInt, Field(description="ID of the targeted venue.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_venue_without_preload_content(
        self,
        venue_id: Annotated[StrictInt, Field(description="ID of the targeted venue.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_venue_serialize(
        self,
        venue_id,
        accept_language,
        _request_auth,
