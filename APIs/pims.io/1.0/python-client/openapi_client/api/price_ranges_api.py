...
class PriceRangesApi:
    ...
    @validate_call
    def fetch_all_price_ranges(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the price ranges whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the price ranges which are not ignored. If set to `true`, show all price ranges.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the price ranges in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_price_ranges_serialize(
            label=label,
    ...
    @validate_call
    def fetch_all_price_ranges_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the price ranges whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the price ranges which are not ignored. If set to `true`, show all price ranges.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the price ranges in the corresponding order.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PriceRangesEntity]]:
        """Find all price ranges
    ...
    @validate_call
    def fetch_all_price_ranges_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the price ranges whose label contains this value.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the price ranges which are not ignored. If set to `true`, show all price ranges.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the price ranges in the corresponding order.")] = None,
    ...
    def _fetch_all_price_ranges_serialize(
        self,
        label,
        show_ignored,
        sort,
    ...
    @validate_call
    def fetch_one_price_range(
        self,
        price_range_id: Annotated[StrictInt, Field(description="ID of the targeted price range.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param price_range_id: ID of the targeted price range. (required)
        ...
        _param = self._fetch_one_price_range_serialize(
    ...
    @validate_call
    def fetch_one_price_range_with_http_info(
        self,
        price_range_id: Annotated[StrictInt, Field(description="ID of the targeted price range.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_price_range_without_preload_content(
        self,
        price_range_id: Annotated[StrictInt, Field(description="ID of the targeted price range.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_price_range_serialize(
        self,
        price_range_id,
        accept_language,
        _request_auth,
        ...
        if price_range_id is not None:
            _path_params['price_range_id'] = price_range_id
        # process the query parameters
        # process the header parameters
        if accept_language is not None:
            _header_params['Accept-Language'] = accept_language
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/price-ranges/{price_range_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
