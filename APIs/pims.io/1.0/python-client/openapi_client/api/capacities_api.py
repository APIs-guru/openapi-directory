...
class CapacitiesApi:
    ...
    @validate_call
    def fetch_all_events_capacities(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the capacities in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_events_capacities_serialize(
            event_id=event_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[EventsCapacitiesEntity]",
            '401': "Error401",
            '403': "Error403",
            '422': "Error422",
            '500': "Error500",
    ...
    @validate_call
    def fetch_all_events_capacities_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the capacities in the corresponding order.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EventsCapacitiesEntity]]:
        """Find all capacities for one event
    ...
    @validate_call
    def fetch_all_events_capacities_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the capacities in the corresponding order.")] = None,
    ...
    def _fetch_all_events_capacities_serialize(
        self,
        event_id,
        show_ignored,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/capacities',
    ...
    @validate_call
    def fetch_one_event_capacity(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        capacity_id: Annotated[StrictInt, Field(description="ID of the targeted capacity.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param event_id: ID of the targeted event. (required)
        :type event_id: int
        :param capacity_id: ID of the targeted capacity. (required)
        ...
        _param = self._fetch_one_event_capacity_serialize(
            event_id=event_id,
    ...
    @validate_call
    def fetch_one_event_capacity_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        capacity_id: Annotated[StrictInt, Field(description="ID of the targeted capacity.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventsCapacitiesEntity]:
        """Get one capacity by ID
    ...
    @validate_call
    def fetch_one_event_capacity_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        capacity_id: Annotated[StrictInt, Field(description="ID of the targeted capacity.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.")] = None,
    ...
    def _fetch_one_event_capacity_serialize(
        self,
        event_id,
        capacity_id,
        show_ignored,
        ...
        if capacity_id is not None:
            _path_params['capacity_id'] = capacity_id
        # process the query parameters
        if show_ignored is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/capacities/{capacity_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
