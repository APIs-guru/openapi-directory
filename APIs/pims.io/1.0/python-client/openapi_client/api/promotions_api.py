...
class PromotionsApi:
    ...
    @validate_call
    def fetch_all_events_promotions(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the promotions ending before this date.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose type is equal to this value.")] = None,
        family: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose family is equal to this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the promotions in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_events_promotions_serialize(
            event_id=event_id,
            label=label,
            from_date=from_date,
            to_date=to_date,
    ...
    @validate_call
    def fetch_all_events_promotions_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PromotionsEntity]]:
        """Find all promotions for one event
    ...
    @validate_call
    def fetch_all_events_promotions_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
    ...
    def _fetch_all_events_promotions_serialize(
        self,
        event_id,
        label,
        from_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/promotions',
    ...
    def fetch_all_promotions(
        ...
        _param = self._fetch_all_promotions_serialize(
            label=label,
            from_date=from_date,
            to_date=to_date,
            type=type,
    ...
    @validate_call
    def fetch_all_promotions_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the promotions ending before this date.")] = None,
    ...
    @validate_call
    def fetch_all_promotions_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the promotions ending before this date.")] = None,
    ...
    def _fetch_all_promotions_serialize(
        self,
        label,
        from_date,
        to_date,
    ...
    @validate_call
    def fetch_all_series_promotions(
        self,
        ...
        _param = self._fetch_all_series_promotions_serialize(
            series_id=series_id,
            label=label,
            from_date=from_date,
            to_date=to_date,
    ...
    @validate_call
    def fetch_all_series_promotions_with_http_info(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
    ...
    @validate_call
    def fetch_all_series_promotions_without_preload_content(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        label: Annotated[Optional[StrictStr], Field(description="Find only the promotions whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the promotions starting after this date.")] = None,
    ...
    def _fetch_all_series_promotions_serialize(
        self,
        series_id,
        label,
        from_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/series/{series_id}/promotions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_one_promotion(
        self,
        promotion_id: Annotated[StrictInt, Field(description="ID of the targeted promotion.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param promotion_id: ID of the targeted promotion. (required)
        ...
        _param = self._fetch_one_promotion_serialize(
    ...
    @validate_call
    def fetch_one_promotion_with_http_info(
        self,
        promotion_id: Annotated[StrictInt, Field(description="ID of the targeted promotion.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_promotion_without_preload_content(
        self,
        promotion_id: Annotated[StrictInt, Field(description="ID of the targeted promotion.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_promotion_serialize(
        self,
        promotion_id,
        accept_language,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/promotions/{promotion_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
