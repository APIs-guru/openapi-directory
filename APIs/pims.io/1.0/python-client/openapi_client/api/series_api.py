...
class SeriesApi:
    ...
    def fetch_all_series(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the venues whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the series starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the series ending before this date.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Find only the series whose type is equal to this value.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the series in the corresponding order.")] = None,
        ...
        _param = self._fetch_all_series_serialize(
            label=label,
            from_date=from_date,
            to_date=to_date,
            type=type,
    ...
    @validate_call
    def fetch_all_series_with_http_info(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the venues whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the series starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the series ending before this date.")] = None,
    ...
    @validate_call
    def fetch_all_series_without_preload_content(
        self,
        label: Annotated[Optional[StrictStr], Field(description="Find only the venues whose label contains this value.")] = None,
        from_date: Annotated[Optional[date], Field(description="Find only the series starting after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the series ending before this date.")] = None,
    ...
    def _fetch_all_series_serialize(
        self,
        label,
        from_date,
        to_date,
    ...
    def fetch_one_series(
        ...
        _param = self._fetch_one_series_serialize(
            series_id=series_id,
            accept_language=accept_language,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_one_series_with_http_info(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_one_series_without_preload_content(
        self,
        series_id: Annotated[StrictInt, Field(description="ID of the targeted series.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Language used for the translatable labels.")] = None,
        _request_timeout: Union[
    ...
    def _fetch_one_series_serialize(
        self,
        series_id,
        accept_language,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/series/{series_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
