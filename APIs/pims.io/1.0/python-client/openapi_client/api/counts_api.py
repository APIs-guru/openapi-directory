...
class CountsApi:
    ...
    @validate_call
    def fetch_all_detailed_ticket_counts(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        from_date: Annotated[Optional[date], Field(description="Find only the ticket counts after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the ticket counts before this date.")] = None,
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
        show_not_approved: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the approved ticket counts. If set to `true`, show all the ticket counts.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort the ticket counts in the corresponding order.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Pagination size, i.e. maximum number of items to be displayed in the response.")] = None,
    ...
    ) -> List[TicketCountsDetailedEntity]:
        """Find all detailed ticket counts for one event


        :param event_id: ID of the targeted event. (required)
        :type event_id: int
        ...
        _param = self._fetch_all_detailed_ticket_counts_serialize(
            event_id=event_id,
            from_date=from_date,
            to_date=to_date,
            show_ignored=show_ignored,
            show_not_approved=show_not_approved,
            sort=sort,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[TicketCountsDetailedEntity]",
            '401': "Error401",
            '403': "Error403",
            '422': "Error422",
            '500': "Error500",
    ...
    @validate_call
    def fetch_all_detailed_ticket_counts_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        from_date: Annotated[Optional[date], Field(description="Find only the ticket counts after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the ticket counts before this date.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TicketCountsDetailedEntity]]:
        """Find all detailed ticket counts for one event
    ...
    @validate_call
    def fetch_all_detailed_ticket_counts_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        from_date: Annotated[Optional[date], Field(description="Find only the ticket counts after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the ticket counts before this date.")] = None,
    ...
    def _fetch_all_detailed_ticket_counts_serialize(
        self,
        event_id,
        from_date,
        to_date,
        ...
        if show_ignored is not None:
            ...
            _query_params.append(('show_ignored', show_ignored))
            
        if show_not_approved is not None:
            
            _query_params.append(('show_not_approved', show_not_approved))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/ticket-counts/detailed',
    ...
    def fetch_all_ticket_counts(
        ...
        _param = self._fetch_all_ticket_counts_serialize(
            event_id=event_id,
            from_date=from_date,
            to_date=to_date,
            show_ignored=show_ignored,
    ...
    @validate_call
    def fetch_all_ticket_counts_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        from_date: Annotated[Optional[date], Field(description="Find only the ticket counts after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the ticket counts before this date.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TicketCountsEntity]]:
        """Find all ticket counts for one event
    ...
    @validate_call
    def fetch_all_ticket_counts_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        from_date: Annotated[Optional[date], Field(description="Find only the ticket counts after this date.")] = None,
        to_date: Annotated[Optional[date], Field(description="Find only the ticket counts before this date.")] = None,
    ...
    def _fetch_all_ticket_counts_serialize(
        self,
        event_id,
        from_date,
        to_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/ticket-counts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_one_detailed_ticket_count(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        ticket_count_id: Annotated[StrictInt, Field(description="ID of the targeted ticket count.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param event_id: ID of the targeted event. (required)
        :type event_id: int
        :param ticket_count_id: ID of the targeted ticket count. (required)
        ...
        _param = self._fetch_one_detailed_ticket_count_serialize(
            event_id=event_id,
            ticket_count_id=ticket_count_id,
            show_ignored=show_ignored,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TicketCountsDetailedEntity",
            '401': "Error401",
            '403': "Error403",
            '404': "Error404",
            '500': "Error500",
    ...
    @validate_call
    def fetch_one_detailed_ticket_count_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        ticket_count_id: Annotated[StrictInt, Field(description="ID of the targeted ticket count.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketCountsDetailedEntity]:
        """Get one detailed ticket count by ID
    ...
    @validate_call
    def fetch_one_detailed_ticket_count_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        ticket_count_id: Annotated[StrictInt, Field(description="ID of the targeted ticket count.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
    ...
    def _fetch_one_detailed_ticket_count_serialize(
        self,
        event_id,
        ticket_count_id,
        show_ignored,
        ...
        if event_id is not None:
            _path_params['event_id'] = event_id
        if ticket_count_id is not None:
            _path_params['ticket_count_id'] = ticket_count_id
        # process the query parameters
        if show_ignored is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/ticket-counts/detailed/{ticket_count_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_one_ticket_count(
        ...
        _param = self._fetch_one_ticket_count_serialize(
            event_id=event_id,
            ticket_count_id=ticket_count_id,
            show_ignored=show_ignored,
            _request_auth=_request_auth,
    ...
    @validate_call
    def fetch_one_ticket_count_with_http_info(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        ticket_count_id: Annotated[StrictInt, Field(description="ID of the targeted ticket count.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketCountsEntity]:
        """Get one ticket count by ID
    ...
    @validate_call
    def fetch_one_ticket_count_without_preload_content(
        self,
        event_id: Annotated[StrictInt, Field(description="ID of the targeted event.")],
        ticket_count_id: Annotated[StrictInt, Field(description="ID of the targeted ticket count.")],
        show_ignored: Annotated[Optional[StrictBool], Field(description="If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.")] = None,
    ...
    def _fetch_one_ticket_count_serialize(
        self,
        event_id,
        ticket_count_id,
        show_ignored,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/events/{event_id}/ticket-counts/{ticket_count_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
