...
class ChannelsEntity(BaseModel):
    """
    ChannelsEntity
    """ # noqa: E501
    id: StrictInt = Field(description="Unique ID of the channel.")
    ignored: StrictBool = Field(description="Defines whether this channel is ignored or not.")
    label: StrictStr = Field(description="Full label of the channel.")
    last_update_timestamp: StrictInt = Field(description="Timestamp for when the channel was last updated in the customer's database.")
    short_label: Optional[StrictStr] = Field(description="Short label of the channel (generally less than 5 characters).")
