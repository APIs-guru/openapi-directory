...
class PromotionsEntityTypeFamily(BaseModel):
    """
    Family the promotion type belongs to.
    """ # noqa: E501
    id: StrictStr = Field(description="String identifying the promotion family.")
    label: StrictStr = Field(description="Label of the promotion family. This value is translated according to the 'Accept-Language' header.")
