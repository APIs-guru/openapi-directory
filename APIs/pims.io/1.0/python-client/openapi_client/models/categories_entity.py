...
class CategoriesEntity(BaseModel):
    """
    CategoriesEntity
    """ # noqa: E501
    id: StrictInt = Field(description="Unique ID of the category.")
    ignored: StrictBool = Field(description="Defines whether this category is ignored or not.")
    label: StrictStr = Field(description="Full label of the category.")
    last_update_timestamp: StrictInt = Field(description="Timestamp for when the category was last updated in the customer's database.")
    short_label: Optional[StrictStr] = Field(description="Short label of the category (generally less than 5 characters).")
    __properties: ClassVar[List[str]] = ["id", "ignored", "label", "last_update_timestamp", "short_label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "short_label": obj.get("short_label")
        })
        return _obj
