...
class PriceRangesEntity(BaseModel):
    """
    PriceRangesEntity
    """ # noqa: E501
    id: StrictInt = Field(description="Unique ID of the price range.")
    ignored: StrictBool = Field(description="Defines whether this price range is ignored or not.")
    label: StrictStr = Field(description="Full label of the price range.")
    last_update_timestamp: StrictInt = Field(description="Timestamp for when the price range was last updated in the customer's database.")
    short_label: Optional[StrictStr] = Field(description="Short label of the price range (generally less than 5 characters).")
