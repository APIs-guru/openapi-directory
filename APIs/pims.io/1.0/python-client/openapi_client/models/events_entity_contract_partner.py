...
class EventsEntityContractPartner(BaseModel):
    """
    Contract partner.
    """ # noqa: E501
    id: StrictInt = Field(description="Unique ID identifying the contract partner.")
    label: StrictStr = Field(description="Label of the contract partner.")
