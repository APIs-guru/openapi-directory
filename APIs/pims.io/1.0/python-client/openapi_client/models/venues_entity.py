...
class VenuesEntity(BaseModel):
    """
    VenuesEntity
    """ # noqa: E501
    alternative_labels: Optional[List[StrictStr]] = Field(default=None, description="Array of alternative/old names of the venue.")
    city: StrictStr = Field(description="City in which the venue is.")
    country_code: StrictStr = Field(description="Country in which the venue is (<a href='https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3'>ISO 3166-1 alpha-3 code</a>).")
    creation_timestamp: StrictInt = Field(description="Timestamp for when the venue was created in the customer's database.")
    first_address: Optional[StrictStr] = Field(description="First address field of the venue.")
    id: StrictInt = Field(description="Unique ID of the venue.")
    label: StrictStr = Field(description="Name of the venue.")
    ...
    major_city: Optional[StrictStr] = Field(description="Major city or metropolitan area the venue belongs to.")
    second_address: Optional[StrictStr] = Field(description="Second address field of the venue.")
    type: VenuesEntityType
    zip_code: Optional[StrictStr] = Field(description="ZIP code of the venue.")
    __properties: ClassVar[List[str]] = ["alternative_labels", "city", "country_code", "creation_timestamp", "first_address", "id", "label", "last_update_timestamp", "major_city", "second_address", "type", "zip_code"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if first_address (nullable) is None
        # and model_fields_set contains the field
        if self.first_address is None and "first_address" in self.model_fields_set:
            _dict['first_address'] = None

        # set to None if major_city (nullable) is None
        # and model_fields_set contains the field
        if self.major_city is None and "major_city" in self.model_fields_set:
            _dict['major_city'] = None

        # set to None if second_address (nullable) is None
        # and model_fields_set contains the field
        if self.second_address is None and "second_address" in self.model_fields_set:
            _dict['second_address'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alternative_labels": obj.get("alternative_labels"),
            "city": obj.get("city"),
            ...
            "major_city": obj.get("major_city"),
            "second_address": obj.get("second_address"),
            "type": VenuesEntityType.from_dict(obj["type"]) if obj.get("type") is not None else None,
