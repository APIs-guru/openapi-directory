...
class SeriesEntityContract(BaseModel):
    """
    Contract of the series.
    """ # noqa: E501
    partner: Optional[SeriesEntityContractPartner] = None
    type: SeriesEntityContractType
    __properties: ClassVar[List[str]] = ["partner", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "partner": SeriesEntityContractPartner.from_dict(obj["partner"]) if obj.get("partner") is not None else None,
            "type": SeriesEntityContractType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
