...
class PromotionsEntityType(BaseModel):
    """
    Type of the promotion.
    """ # noqa: E501
    family: PromotionsEntityTypeFamily
    id: StrictStr = Field(description="String identifying the promotion type.")
    label: StrictStr = Field(description="Label of the promotion type. This value is translated according to the 'Accept-Language' header.")
    __properties: ClassVar[List[str]] = ["family", "id", "label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "family": PromotionsEntityTypeFamily.from_dict(obj["family"]) if obj.get("family") is not None else None,
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
