...
class TicketCountsDetailedEntityEventChannelsInner(BaseModel):
    """
    TicketCountsDetailedEntityEventChannelsInner
    """ # noqa: E501
    event_categories: List[TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner] = Field(description="Array of event categories which where sold.")
    id: StrictInt = Field(description="ID of the event channel.")
    __properties: ClassVar[List[str]] = ["event_categories", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event_categories": [TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.from_dict(_item) for _item in obj["event_categories"]] if obj.get("event_categories") is not None else None,
            "id": obj.get("id")
        })
        return _obj
