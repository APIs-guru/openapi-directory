...
class PromotionsEntityCost(BaseModel):
    """
    Cost of the promotion.
    """ # noqa: E501
    currency: Optional[StrictStr] = Field(default=None, description="Currency of the unit_cost (<a href='https://en.wikipedia.org/wiki/ISO_4217#Active_codes'>ISO 4212 alphabetic code</a>).")
    exchange: Optional[StrictStr] = Field(default=None, description="What was offered in exchange of the promotion.")
    quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Quantity of the promotion (see unit_cost).")
    state: Optional[PromotionsEntityCostState] = None
    type: PromotionsEntityCostType
    unit_cost: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Unit cost of the promotion. The total cost of the promotion can be calculated with: quantity × unit_cost.")
    valorized_quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Valorized quantity of the promotion (see valorized_unit_cost). *This field may be omitted according to the customer configuration.*")
    valorized_unit_cost: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Valorized unit cost of the promotion. The total valorized cost of the promotion can be calculated with: valorized_quantity × valorized_unit_cost. *This field may be omitted according to the customer configuration.*")
    __properties: ClassVar[List[str]] = ["currency", "exchange", "quantity", "state", "type", "unit_cost", "valorized_quantity", "valorized_unit_cost"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.unit_cost is None and "unit_cost" in self.model_fields_set:
            _dict['unit_cost'] = None

        # set to None if valorized_quantity (nullable) is None
        # and model_fields_set contains the field
        if self.valorized_quantity is None and "valorized_quantity" in self.model_fields_set:
            _dict['valorized_quantity'] = None

        # set to None if valorized_unit_cost (nullable) is None
        # and model_fields_set contains the field
        if self.valorized_unit_cost is None and "valorized_unit_cost" in self.model_fields_set:
            _dict['valorized_unit_cost'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": PromotionsEntityCostState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "type": PromotionsEntityCostType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "unit_cost": obj.get("unit_cost"),
            "valorized_quantity": obj.get("valorized_quantity"),
            "valorized_unit_cost": obj.get("valorized_unit_cost")
        })
        return _obj
