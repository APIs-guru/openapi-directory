...
class Error422(BaseModel):
    ...
    Error422
    """ # noqa: E501
    detail: StrictStr = Field(description="Description of the error.")
    status: StrictInt = Field(description="Status code of the error.")
    title: StrictStr = Field(description="Message corresponding to the status code.")
    type: StrictStr = Field(description="Link to RFC 2616 about status codes definitions.")
