...
class TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner(BaseModel):
    """
    TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
    """ # noqa: E501
    event_price_ranges: List[TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner] = Field(description="Array of event price ranges which where sold.")
    id: StrictInt = Field(description="ID of the event category.")
    __properties: ClassVar[List[str]] = ["event_price_ranges", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event_price_ranges": [TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner.from_dict(_item) for _item in obj["event_price_ranges"]] if obj.get("event_price_ranges") is not None else None,
            "id": obj.get("id")
        })
        return _obj
