...
class PromotionsEntitySupplier(BaseModel):
    """
    Supplier of the promotion.
    """ # noqa: E501
    id: StrictInt = Field(description="Unique ID of the supplier.")
    label: StrictStr = Field(description="Name of the supplier.")
