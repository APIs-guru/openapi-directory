...
class EventsEntityContract(BaseModel):
    """
    Contract of the series.
    """ # noqa: E501
    partner: Optional[EventsEntityContractPartner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "partner": EventsEntityContractPartner.from_dict(obj["partner"]) if obj.get("partner") is not None else None,
            "type": EventsEntityContractType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
