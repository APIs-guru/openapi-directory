...
class TicketCountsEntity(BaseModel):
    """
    TicketCountsEntity
    """ # noqa: E501
    ...
    currency: Optional[StrictStr] = Field(default=None, description="Currency of the gross (<a href='https://en.wikipedia.org/wiki/ISO_4217#Active_codes'>ISO 4212 alphabetic code</a>).")
    ...
    gross: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Gross (= income for the sold tickets, including VAT but excluding all commissions).")
    id: StrictInt = Field(description="Unique ID of the ticket count.")
    reservations: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Ticket reservations (= number of reserved tickets). *This field may be omitted according to the customer configuration.*")
    sales: Annotated[int, Field(strict=True, ge=0)] = Field(description="Ticket sales (= number of sold tickets).")
    __properties: ClassVar[List[str]] = ["approved", "comment", "currency", "date", "final", "gross", "id", "reservations", "sales"]
