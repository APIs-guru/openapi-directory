...
class TestVenuesEntityType(unittest.TestCase):
    """VenuesEntityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuesEntityType:
        """Test VenuesEntityType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuesEntityType`
        """
        model = VenuesEntityType()
        if include_optional:
            return VenuesEntityType(
                id = 'SAL',
                label = 'Venue'
            )
        else:
