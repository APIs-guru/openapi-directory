...
class TestPriceRangesEntity(unittest.TestCase):
    """PriceRangesEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceRangesEntity:
        """Test PriceRangesEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceRangesEntity`
        """
        model = PriceRangesEntity()
        if include_optional:
            return PriceRangesEntity(
                id = 123,
                ignored = False,
                label = 'REDUCED PRICE',
    ...
    def testPriceRangesEntity(self):
        """Test PriceRangesEntity"""
