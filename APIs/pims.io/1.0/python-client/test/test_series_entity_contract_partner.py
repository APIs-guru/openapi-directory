...
class TestSeriesEntityContractPartner(unittest.TestCase):
    """SeriesEntityContractPartner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesEntityContractPartner:
        """Test SeriesEntityContractPartner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesEntityContractPartner`
        """
        model = SeriesEntityContractPartner()
        if include_optional:
            return SeriesEntityContractPartner(
                id = 56,
                label = ''
            )
        else:
    ...
    def testSeriesEntityContractPartner(self):
        """Test SeriesEntityContractPartner"""
