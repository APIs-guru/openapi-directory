...
class TestPromotionsEntityAppliedToInner(unittest.TestCase):
    """PromotionsEntityAppliedToInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityAppliedToInner:
        """Test PromotionsEntityAppliedToInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityAppliedToInner`
        """
        model = PromotionsEntityAppliedToInner()
        if include_optional:
            return PromotionsEntityAppliedToInner(
                event_id = 2142,
                quantity = 0,
                series_id = 263,
                unit_cost = 0,
    ...
    def testPromotionsEntityAppliedToInner(self):
        """Test PromotionsEntityAppliedToInner"""
