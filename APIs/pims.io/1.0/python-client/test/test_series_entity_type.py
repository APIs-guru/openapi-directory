...
class TestSeriesEntityType(unittest.TestCase):
    """SeriesEntityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesEntityType:
        """Test SeriesEntityType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesEntityType`
        """
        model = SeriesEntityType()
        if include_optional:
