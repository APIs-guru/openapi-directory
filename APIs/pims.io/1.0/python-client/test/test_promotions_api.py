...
class TestPromotionsApi(unittest.TestCase):
    ...
    def test_fetch_all_events_promotions(self) -> None:
    ...
    def test_fetch_all_promotions(self) -> None:
    ...
    def test_fetch_all_series_promotions(self) -> None:
    ...
    def test_fetch_one_promotion(self) -> None:
