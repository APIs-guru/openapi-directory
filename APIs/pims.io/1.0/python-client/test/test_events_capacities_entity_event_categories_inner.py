...
class TestEventsCapacitiesEntityEventCategoriesInner(unittest.TestCase):
    """EventsCapacitiesEntityEventCategoriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsCapacitiesEntityEventCategoriesInner:
        """Test EventsCapacitiesEntityEventCategoriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsCapacitiesEntityEventCategoriesInner`
        """
        model = EventsCapacitiesEntityEventCategoriesInner()
        if include_optional:
            return EventsCapacitiesEntityEventCategoriesInner(
                comps = 56,
                holds = 56,
                id = 56,
                kills = 56,
    ...
    def testEventsCapacitiesEntityEventCategoriesInner(self):
        """Test EventsCapacitiesEntityEventCategoriesInner"""
