...
class TestEventsChannelsEntity(unittest.TestCase):
    """EventsChannelsEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsChannelsEntity:
        """Test EventsChannelsEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsChannelsEntity`
        """
        model = EventsChannelsEntity()
        if include_optional:
    ...
    def testEventsChannelsEntity(self):
        """Test EventsChannelsEntity"""
