...
class TestPromotionsEntitySupplier(unittest.TestCase):
    """PromotionsEntitySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntitySupplier:
        """Test PromotionsEntitySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntitySupplier`
        """
        model = PromotionsEntitySupplier()
        if include_optional:
            return PromotionsEntitySupplier(
                id = 56,
                label = ''
            )
        else:
    ...
    def testPromotionsEntitySupplier(self):
        """Test PromotionsEntitySupplier"""
