...
class TestCountsApi(unittest.TestCase):
    ...
    def test_fetch_all_detailed_ticket_counts(self) -> None:
    ...
    def test_fetch_all_ticket_counts(self) -> None:
    ...
    def test_fetch_one_detailed_ticket_count(self) -> None:
    ...
    def test_fetch_one_ticket_count(self) -> None:
