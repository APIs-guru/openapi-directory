...
class TestPromotionsEntityTypeFamily(unittest.TestCase):
    """PromotionsEntityTypeFamily unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityTypeFamily:
        """Test PromotionsEntityTypeFamily
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityTypeFamily`
        """
        model = PromotionsEntityTypeFamily()
        if include_optional:
            return PromotionsEntityTypeFamily(
                id = 'PRE',
                label = 'Press'
            )
        else:
    ...
    def testPromotionsEntityTypeFamily(self):
        """Test PromotionsEntityTypeFamily"""
