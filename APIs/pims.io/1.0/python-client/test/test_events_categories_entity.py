...
class TestEventsCategoriesEntity(unittest.TestCase):
    """EventsCategoriesEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsCategoriesEntity:
        """Test EventsCategoriesEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsCategoriesEntity`
        """
        model = EventsCategoriesEntity()
        if include_optional:
            return EventsCategoriesEntity(
                category = openapi_client.models.category.Category(
                    ...
                    short_label = 'CAT1', ),
                event_price_ranges = [
                    openapi_client.models.events_categories_entity_event_price_ranges_inner.EventsCategoriesEntity_event_price_ranges_inner(
                        base_price = 44.5, 
                        currency = 'EUR', 
                        id = 56789, 
                        ignored = False, 
    ...
    def testEventsCategoriesEntity(self):
        """Test EventsCategoriesEntity"""
