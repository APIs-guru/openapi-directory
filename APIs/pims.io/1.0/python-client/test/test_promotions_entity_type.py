...
class TestPromotionsEntityType(unittest.TestCase):
    """PromotionsEntityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityType:
        """Test PromotionsEntityType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityType`
        """
        model = PromotionsEntityType()
        if include_optional:
            return PromotionsEntityType(
    ...
    def testPromotionsEntityType(self):
        """Test PromotionsEntityType"""
