...
class TestTicketCountsEntity(unittest.TestCase):
    """TicketCountsEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketCountsEntity:
        """Test TicketCountsEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketCountsEntity`
        """
        model = TicketCountsEntity()
        if include_optional:
            return TicketCountsEntity(
                approved = True,
                comment = 'No sales',
                currency = 'EUR',
    ...
    def testTicketCountsEntity(self):
        """Test TicketCountsEntity"""
