...
class TestPromotionsEntityCost(unittest.TestCase):
    """PromotionsEntityCost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityCost:
        """Test PromotionsEntityCost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityCost`
        """
        model = PromotionsEntityCost()
        if include_optional:
            return PromotionsEntityCost(
                currency = '',
                exchange = '',
                quantity = 0,
                state = openapi_client.models.promotions_entity_cost_state.PromotionsEntity_cost_state(
                    id = 'PRE', 
                    label = '', ),
                type = openapi_client.models.promotions_entity_cost_type.PromotionsEntity_cost_type(
                    id = 'GRA', 
                    label = 'Free', ),
                unit_cost = 0,
                valorized_quantity = 0,
                valorized_unit_cost = 0
            )
        else:
            return PromotionsEntityCost(
                type = openapi_client.models.promotions_entity_cost_type.PromotionsEntity_cost_type(
    ...
    def testPromotionsEntityCost(self):
        """Test PromotionsEntityCost"""
