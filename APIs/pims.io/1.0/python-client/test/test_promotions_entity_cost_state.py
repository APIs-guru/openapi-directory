...
class TestPromotionsEntityCostState(unittest.TestCase):
    """PromotionsEntityCostState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityCostState:
        """Test PromotionsEntityCostState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityCostState`
        """
        model = PromotionsEntityCostState()
        if include_optional:
            return PromotionsEntityCostState(
                id = 'PRE',
                label = ''
            )
        else:
    ...
    def testPromotionsEntityCostState(self):
        """Test PromotionsEntityCostState"""
