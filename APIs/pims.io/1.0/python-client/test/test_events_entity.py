...
class TestEventsEntity(unittest.TestCase):
    """EventsEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsEntity:
        """Test EventsEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsEntity`
        """
        model = EventsEntity()
        if include_optional:
            return EventsEntity(
                ...
                contract = openapi_client.models.events_entity_contract.EventsEntity_contract(
                    partner = openapi_client.models.events_entity_contract_partner.EventsEntity_contract_partner(
                        id = 12, 
                        label = 'K Prod', ), 
                    type = openapi_client.models.events_entity_contract_type.EventsEntity_contract_type(
                        id = 'COP', 
                        label = 'Coprod', ), ),
                costing_capacity = 2074,
                creation_timestamp = 1496903403,
                currency = '',
                datetime = '2018-01-11T20:00:00',
                free = True,
                general_sales_date = 'Wed Jun 14 20:00:00 EDT 2017',
                id = 2142,
                input_type = openapi_client.models.events_entity_input_type.EventsEntity_input_type(
                    id = 'DET', 
                    label = 'Detailed sales', ),
                label = 'Alan Wilson',
                last_update_timestamp = 1516500001,
                max_capacity = 2100,
                presales_date = 'Tue Jun 13 20:00:00 EDT 2017',
                series_id = 263,
                sold_out_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
