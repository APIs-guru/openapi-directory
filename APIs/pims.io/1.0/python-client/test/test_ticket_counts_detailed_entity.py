...
class TestTicketCountsDetailedEntity(unittest.TestCase):
    """TicketCountsDetailedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketCountsDetailedEntity:
        """Test TicketCountsDetailedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketCountsDetailedEntity`
        """
        model = TicketCountsDetailedEntity()
        if include_optional:
            return TicketCountsDetailedEntity(
                approved = True,
                comment = 'No sales',
                var_date = 'Mon Jul 02 20:00:00 EDT 2018',
                event_channels = [
                    openapi_client.models.ticket_counts_detailed_entity_event_channels_inner.TicketCountsDetailedEntity_event_channels_inner(
                        event_categories = [
    ...
    def testTicketCountsDetailedEntity(self):
        """Test TicketCountsDetailedEntity"""
