...
class TestTicketCountsDetailedEntityEventChannelsInner(unittest.TestCase):
    """TicketCountsDetailedEntityEventChannelsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketCountsDetailedEntityEventChannelsInner:
        """Test TicketCountsDetailedEntityEventChannelsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketCountsDetailedEntityEventChannelsInner`
        """
        model = TicketCountsDetailedEntityEventChannelsInner()
        if include_optional:
            return TicketCountsDetailedEntityEventChannelsInner(
                event_categories = [
                    openapi_client.models.ticket_counts_detailed_entity_event_channels_inner_event_categories_inner.TicketCountsDetailedEntity_event_channels_inner_event_categories_inner(
                        event_price_ranges = [
                            openapi_client.models.ticket_counts_detailed_entity_event_channels_inner_event_categories_inner_event_price_ranges_inner.TicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner(
                                currency = 'EUR', 
                                gross = 864.0, 
                                id = 24680, 
                                reservations = 0, 
    ...
    def testTicketCountsDetailedEntityEventChannelsInner(self):
        """Test TicketCountsDetailedEntityEventChannelsInner"""
