...
class TestEventsEntityInputType(unittest.TestCase):
    """EventsEntityInputType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsEntityInputType:
        """Test EventsEntityInputType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsEntityInputType`
        """
        model = EventsEntityInputType()
        if include_optional:
            return EventsEntityInputType(
                id = 'DET',
    ...
    def testEventsEntityInputType(self):
        """Test EventsEntityInputType"""
