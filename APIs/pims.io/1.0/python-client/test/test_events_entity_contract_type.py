...
class TestEventsEntityContractType(unittest.TestCase):
    """EventsEntityContractType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsEntityContractType:
        """Test EventsEntityContractType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsEntityContractType`
        """
        model = EventsEntityContractType()
        if include_optional:
            return EventsEntityContractType(
                id = 'COP',
                label = 'Coprod'
            )
        else:
    ...
    def testEventsEntityContractType(self):
        """Test EventsEntityContractType"""
