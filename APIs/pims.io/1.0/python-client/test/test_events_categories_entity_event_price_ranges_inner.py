...
class TestEventsCategoriesEntityEventPriceRangesInner(unittest.TestCase):
    """EventsCategoriesEntityEventPriceRangesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsCategoriesEntityEventPriceRangesInner:
        """Test EventsCategoriesEntityEventPriceRangesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsCategoriesEntityEventPriceRangesInner`
        """
        model = EventsCategoriesEntityEventPriceRangesInner()
        if include_optional:
            return EventsCategoriesEntityEventPriceRangesInner(
                base_price = 44.5,
                currency = 'EUR',
                id = 56789,
                ignored = False,
                price_range = openapi_client.models.price_range.Price range(
                    id = 123, 
                    ignored = False, 
                    label = 'REDUCED PRICE', 
    ...
    def testEventsCategoriesEntityEventPriceRangesInner(self):
        """Test EventsCategoriesEntityEventPriceRangesInner"""
