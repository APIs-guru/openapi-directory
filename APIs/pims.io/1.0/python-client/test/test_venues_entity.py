...
class TestVenuesEntity(unittest.TestCase):
    """VenuesEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuesEntity:
        """Test VenuesEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuesEntity`
        """
        model = VenuesEntity()
        if include_optional:
            return VenuesEntity(
