...
class TestEventsCapacitiesEntity(unittest.TestCase):
    """EventsCapacitiesEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsCapacitiesEntity:
        """Test EventsCapacitiesEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsCapacitiesEntity`
        """
        model = EventsCapacitiesEntity()
        if include_optional:
            return EventsCapacitiesEntity(
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                event_categories = [
                    openapi_client.models.events_capacities_entity_event_categories_inner.EventsCapacitiesEntity_event_categories_inner(
                        comps = 56, 
                        holds = 56, 
                        id = 56, 
                        kills = 56, 
                        sellable_capacity = 56, 
                        total_capacity = 56, )
                    ],
                id = 56
            )
    ...
    def testEventsCapacitiesEntity(self):
        """Test EventsCapacitiesEntity"""
