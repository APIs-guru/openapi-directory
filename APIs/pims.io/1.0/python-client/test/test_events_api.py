...
class TestEventsApi(unittest.TestCase):
    ...
    def test_fetch_all_events(self) -> None:
    ...
    def test_fetch_all_series_events(self) -> None:
    ...
    def test_fetch_all_venues_events(self) -> None:
    ...
    def test_fetch_one_event(self) -> None:
