...
class TestPromotionsEntityCostType(unittest.TestCase):
    """PromotionsEntityCostType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntityCostType:
        """Test PromotionsEntityCostType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntityCostType`
        """
        model = PromotionsEntityCostType()
        if include_optional:
            return PromotionsEntityCostType(
                id = 'GRA',
                label = 'Free'
            )
        else:
    ...
    def testPromotionsEntityCostType(self):
        """Test PromotionsEntityCostType"""
