...
class TestSeriesEntityContractType(unittest.TestCase):
    """SeriesEntityContractType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesEntityContractType:
        """Test SeriesEntityContractType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesEntityContractType`
        """
        model = SeriesEntityContractType()
        if include_optional:
            return SeriesEntityContractType(
                id = 'PRO',
                label = 'Production'
            )
        else:
    ...
    def testSeriesEntityContractType(self):
        """Test SeriesEntityContractType"""
