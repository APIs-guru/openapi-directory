...
class TestPromotionsEntity(unittest.TestCase):
    """PromotionsEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionsEntity:
        """Test PromotionsEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionsEntity`
        """
        model = PromotionsEntity()
        if include_optional:
            return PromotionsEntity(
                applied_to = [
                    openapi_client.models.promotions_entity_applied_to_inner.PromotionsEntity_applied_to_inner(
                        event_id = 2142, 
                        quantity = 0, 
                        series_id = 263, 
                        unit_cost = 0, 
                ...
                comments = '',
                cost = openapi_client.models.promotions_entity_cost.PromotionsEntity_cost(
                    currency = '', 
                    exchange = '', 
                    quantity = 0, 
                    ...
                    valorized_quantity = 0, 
                    valorized_unit_cost = 0, ),
                end_date = 'Tue Jan 30 19:00:00 EST 2018',
                file = '',
                id = 2404,
                label = '1/2 page Club et Concerts',
                start_date = 'Mon Jan 01 19:00:00 EST 2018',
                supplier = openapi_client.models.promotions_entity_supplier.PromotionsEntity_supplier(
                    id = 56, 
                    label = '', ),
                type = openapi_client.models.promotions_entity_type.PromotionsEntity_type(
                    family = openapi_client.models.promotions_entity_type_family.PromotionsEntity_type_family(
                        id = 'PRE', 
                        label = 'Press', ), 
                    id = 'PPR', 
                    label = 'Media ads', )
