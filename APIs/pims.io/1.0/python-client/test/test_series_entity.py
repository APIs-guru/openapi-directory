...
class TestSeriesEntity(unittest.TestCase):
    """SeriesEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesEntity:
        """Test SeriesEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesEntity`
        """
        model = SeriesEntity()
        if include_optional:
            return SeriesEntity(
                contract = openapi_client.models.series_entity_contract.SeriesEntity_contract(
                    partner = openapi_client.models.series_entity_contract_partner.SeriesEntity_contract_partner(
                        id = 56, 
                        label = '', ), 
                    type = openapi_client.models.series_entity_contract_type.SeriesEntity_contract_type(
                        id = 'PRO', 
                        label = 'Production', ), ),
                costing_capacity = 1465,
                creation_timestamp = 1503655564,
                first_date = 'Mon May 21 20:00:00 EDT 2018',
                id = 263,
                label = 'Tintin et Milou Live - Paris 2018',
                last_date = 'Sat Jun 02 20:00:00 EDT 2018',
                last_update_timestamp = 1516500001,
                type = openapi_client.models.series_entity_type.SeriesEntity_type(
                    id = 'LGS', 
                    label = 'Long series', ),
                venue = openapi_client.models.venue.Venue(
                    ...
                    city = 'Saint-Herblain', 
                    country_code = 'FR', 
                    creation_timestamp = 1262300401, 
                    first_address = 'ZAC d'Ar Mor', 
                    id = 27, 
                    label = 'Zénith de Nantes Métropole', 
                    last_update_timestamp = 1473008115, 
                    major_city = 'Nantes', 
                    second_address = 'Boulevard du Zénith', 
                    type = openapi_client.models.venues_entity_type.VenuesEntity_type(
                        id = 'SAL', 
                        label = 'Venue', ), 
                    zip_code = '44800', )
            )
