...
class TestChannelsEntity(unittest.TestCase):
    """ChannelsEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelsEntity:
        """Test ChannelsEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelsEntity`
        """
        model = ChannelsEntity()
        if include_optional:
