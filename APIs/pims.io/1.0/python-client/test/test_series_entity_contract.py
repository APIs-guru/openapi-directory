...
class TestSeriesEntityContract(unittest.TestCase):
    """SeriesEntityContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesEntityContract:
        """Test SeriesEntityContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesEntityContract`
        """
        model = SeriesEntityContract()
        if include_optional:
            return SeriesEntityContract(
    ...
    def testSeriesEntityContract(self):
        """Test SeriesEntityContract"""
