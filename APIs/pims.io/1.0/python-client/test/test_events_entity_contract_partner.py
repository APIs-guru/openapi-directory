...
class TestEventsEntityContractPartner(unittest.TestCase):
    """EventsEntityContractPartner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsEntityContractPartner:
        """Test EventsEntityContractPartner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsEntityContractPartner`
        """
        model = EventsEntityContractPartner()
        if include_optional:
            return EventsEntityContractPartner(
                id = 12,
                label = 'K Prod'
            )
        else:
    ...
    def testEventsEntityContractPartner(self):
        """Test EventsEntityContractPartner"""
