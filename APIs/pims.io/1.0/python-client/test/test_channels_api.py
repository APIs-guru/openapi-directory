...
class TestChannelsApi(unittest.TestCase):
    ...
    def test_fetch_all_channels(self) -> None:
    ...
    def test_fetch_all_events_channels(self) -> None:
    ...
    def test_fetch_one_channel(self) -> None:
    ...
    def test_fetch_one_event_channel(self) -> None:
