...
class TestEventsEntityContract(unittest.TestCase):
    """EventsEntityContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsEntityContract:
        """Test EventsEntityContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsEntityContract`
        """
        model = EventsEntityContract()
        if include_optional:
            return EventsEntityContract(
    ...
    def testEventsEntityContract(self):
        """Test EventsEntityContract"""
