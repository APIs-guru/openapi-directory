...
class TestTicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner(unittest.TestCase):
    """TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner:
        """Test TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner`
        """
        model = TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner()
        if include_optional:
            return TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner(
                event_price_ranges = [
    ...
    def testTicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner(self):
        """Test TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner"""
