...
class PurchaseInvoiceDelivery(BaseModel):
    """
    The details of the delivery associated with this invoice.
    """ # noqa: E501
    actual_date: Optional[StrictStr] = Field(default=None, description="The actual delivery date.")
    location: Optional[Location] = None
    party: Optional[PurchaseInvoiceParty] = None
    __properties: ClassVar[List[str]] = ["actual_date", "location", "party"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "party": PurchaseInvoiceParty.from_dict(obj["party"]) if obj.get("party") is not None else None
        })
        return _obj
