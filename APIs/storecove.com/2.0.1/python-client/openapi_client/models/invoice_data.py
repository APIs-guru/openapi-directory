...
class InvoiceData(BaseModel):
    ...
    """ # noqa: E501
    conversion_strategy: Optional[StrictStr] = Field(default=None, description="How to interpret the document.", alias="conversionStrategy")
    document: Optional[Annotated[str, Field(min_length=5, strict=True)]] = Field(default=None, description="The base64 encoded version of the document.")
    __properties: ClassVar[List[str]] = ["conversionStrategy", "document"]
