...
class LineDeliveryDeliveryLocation(BaseModel):
    """
    ...
    scheme_id: Optional[StrictStr] = Field(default=None, description="The schemeId of the location identifier (e.g. '0088')", alias="schemeId")
