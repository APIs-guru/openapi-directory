...
class LineAllowanceCharge(BaseModel):
    ...
    LineAllowanceCharge
    """ # noqa: E501
    amount_excluding_tax: Union[StrictFloat, StrictInt] = Field(description="The amount for the allowance or charge, excluding tax.", alias="amountExcludingTax")
    ...
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the allowance or charge, free text")
    ...
    __properties: ClassVar[List[str]] = ["amountExcludingTax", "baseAmountExcludingTax", "reason", "reasonCode"]
