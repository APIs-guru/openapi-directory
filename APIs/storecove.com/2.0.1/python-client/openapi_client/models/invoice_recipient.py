...
class InvoiceRecipient(BaseModel):
    ...
    public_identifiers: Optional[List[PublicIdentifier]] = Field(default=None, description="A list of public identifiers that uniquely identify this customer.", alias="publicIdentifiers")
    __properties: ClassVar[List[str]] = ["emails", "publicIdentifiers"]
