...
class TestSendableDocument(unittest.TestCase):
    """SendableDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendableDocument:
        """Test SendableDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendableDocument`
        """
        model = SendableDocument()
        if include_optional:
