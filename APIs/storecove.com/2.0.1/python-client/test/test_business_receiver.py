...
class TestBusinessReceiver(unittest.TestCase):
    """BusinessReceiver unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessReceiver:
        """Test BusinessReceiver
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessReceiver`
        """
        model = BusinessReceiver()
        if include_optional:
