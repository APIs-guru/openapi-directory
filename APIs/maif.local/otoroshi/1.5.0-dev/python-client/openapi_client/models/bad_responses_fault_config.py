...
class BadResponsesFaultConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ratio", "responses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratio": obj.get("ratio"),
            "responses": [BadResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
