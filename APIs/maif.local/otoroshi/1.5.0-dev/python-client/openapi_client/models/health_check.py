...
class HealthCheck(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether or not healthcheck is enabled on the current service descriptor")
    url: Optional[StrictStr] = Field(default=None, description="The URL to check")
