...
class IpFiltering(BaseModel):
    ...
    """ # noqa: E501
    blacklist: List[StrictStr] = Field(description="Blacklisted IP addresses")
    whitelist: List[StrictStr] = Field(description="Whitelisted IP addresses")
    __properties: ClassVar[List[str]] = ["blacklist", "whitelist"]
