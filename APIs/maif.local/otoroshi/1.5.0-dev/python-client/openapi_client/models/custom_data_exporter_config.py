...
class CustomDataExporterConfig(BaseModel):
    ...
    """ # noqa: E501
    config: Dict[str, StrictStr] = Field(description="Custom data exporter config")
    ref: StrictStr = Field(description="Script Ref")
    __properties: ClassVar[List[str]] = ["config", "ref"]
