...
class ScriptCompilationResult(BaseModel):
    ...
    """ # noqa: E501
    done: StrictBool = Field(description="Is the task done or not")
    error: Optional[ScriptCompilationError] = None
    __properties: ClassVar[List[str]] = ["done", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "done": obj.get("done"),
            "error": ScriptCompilationError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
