...
class ImportExportServiceGroupsInner(BaseModel):
    """
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The descriptoin of the group")
    id: StrictStr = Field(description="The unique id of the group. Usually 64 random alpha numerical characters, but can be anything")
