...
class NearestAirportDto(BaseModel):
    """
    
    """ # noqa: E501
    city: Optional[StrictStr] = Field(default=None, description="City where the airport is located.")
    country: Optional[Country] = None
    distance_in_km: Optional[StrictInt] = Field(default=None, description="Distance in kilometers.", alias="distanceInKm")
    ...
    __properties: ClassVar[List[str]] = ["city", "country", "distanceInKm", "geoCoordinates", "id", "name", "self"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "distanceInKm": obj.get("distanceInKm"),
