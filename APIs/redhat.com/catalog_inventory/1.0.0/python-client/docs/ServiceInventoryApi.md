# openapi_client.ServiceInventoryApi
...
> ServiceInventoriesCollection list_service_inventories(limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ServiceInventoryApi(api_client)
    ...
    try:
        # List ServiceInventories
        api_response = api_instance.list_service_inventories(limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of ServiceInventoryApi->list_service_inventories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceInventoryApi->list_service_inventories: %s\n" % e)
```
...
> TagsCollection list_service_inventory_tags(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Tags for ServiceInventory
        api_response = api_instance.list_service_inventory_tags(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of ServiceInventoryApi->list_service_inventory_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceInventoryApi->list_service_inventory_tags: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Show an existing ServiceInventory
        api_response = api_instance.show_service_inventory(id)
        print("The response of ServiceInventoryApi->show_service_inventory:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceInventoryApi->show_service_inventory: %s\n" % e)
```
...
> List[Tag] tag_service_inventory(id, tag)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ServiceInventoryApi(api_client)
    id = 'id_example' # str | ID of the resource
    tag = [openapi_client.Tag()] # List[Tag] | Tag attributes to add

    try:
        # Tag a ServiceInventory
        api_response = api_instance.tag_service_inventory(id, tag)
        print("The response of ServiceInventoryApi->tag_service_inventory:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceInventoryApi->tag_service_inventory: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ServiceInventoryApi(api_client)
    id = 'id_example' # str | ID of the resource
    tag = [openapi_client.Tag()] # List[Tag] | Tag attributes to removed

    try:
        # Untag a ServiceInventory
        api_instance.untag_service_inventory(id, tag)
    except Exception as e:
        print("Exception when calling ServiceInventoryApi->untag_service_inventory: %s\n" % e)
```
