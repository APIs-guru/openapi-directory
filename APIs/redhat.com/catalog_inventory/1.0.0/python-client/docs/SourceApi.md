...
------------- | ------------- | -------------
[**incremental_refresh_source**](SourceApi.md#incremental_refresh_source) | **PATCH** /sources/{id}/incremental_refresh | Incremental Refresh an existing Source
...
[**list_source_tasks**](SourceApi.md#list_source_tasks) | **GET** /sources/{id}/tasks | List Tasks for Source
[**list_sources**](SourceApi.md#list_sources) | **GET** /sources | List Sources
[**refresh_source**](SourceApi.md#refresh_source) | **PATCH** /sources/{id}/refresh |  Refresh an existing Source
[**show_source**](SourceApi.md#show_source) | **GET** /sources/{id} | Show an existing Source


# **incremental_refresh_source**
> incremental_refresh_source(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Incremental Refresh an existing Source
        api_instance.incremental_refresh_source(id)
    except Exception as e:
        print("Exception when calling SourceApi->incremental_refresh_source: %s\n" % e)
```
...
> ServiceInstancesCollection list_source_service_instances(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServiceInstances for Source
        api_response = api_instance.list_source_service_instances(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_service_instances:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_service_instances: %s\n" % e)
```
...
> ServiceInventoriesCollection list_source_service_inventories(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServiceInventories for Source
        api_response = api_instance.list_source_service_inventories(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_service_inventories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_service_inventories: %s\n" % e)
```
...
> ServiceOfferingNodesCollection list_source_service_offering_nodes(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServiceOfferingNodes for Source
        api_response = api_instance.list_source_service_offering_nodes(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_service_offering_nodes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_service_offering_nodes: %s\n" % e)
```
...
> ServiceOfferingsCollection list_source_service_offerings(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServiceOfferings for Source
        api_response = api_instance.list_source_service_offerings(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_service_offerings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_service_offerings: %s\n" % e)
```
...
> ServicePlansCollection list_source_service_plans(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServicePlans for Source
        api_response = api_instance.list_source_service_plans(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_service_plans:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_service_plans: %s\n" % e)
```
...
# **list_source_tasks**
> TasksCollection list_source_tasks(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Tasks for Source
        api_response = api_instance.list_source_tasks(id, limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_source_tasks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_source_tasks: %s\n" % e)
```
...
# **list_sources**
> SourcesCollection list_sources(limit=limit, offset=offset, filter=filter, sort_by=sort_by)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Sources
        api_response = api_instance.list_sources(limit=limit, offset=offset, filter=filter, sort_by=sort_by)
        print("The response of SourceApi->list_sources:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->list_sources: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        #  Refresh an existing Source
        api_instance.refresh_source(id)
    except Exception as e:
        print("Exception when calling SourceApi->refresh_source: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SourceApi->show_source:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourceApi->show_source: %s\n" % e)
```
