...
class TaskApi:
    ...
    def show_task(
        self,
        id: Annotated[str, Field(strict=True, description="UUID of task")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._show_task_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def show_task_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="UUID of task")],
        _request_timeout: Union[
            None,
    ...
    def update_task(
        self,
        id: Annotated[str, Field(strict=True, description="UUID of task")],
        task: Annotated[Task, Field(description="Task attributes to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
