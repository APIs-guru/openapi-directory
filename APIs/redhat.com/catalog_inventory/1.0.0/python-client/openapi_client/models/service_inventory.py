...
class ServiceInventory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["archived_at", "created_at", "description", "extra", "id", "last_seen_at", "name", "refresh_state_part_id", "source_created_at", "source_id", "source_ref", "source_updated_at", "updated_at"]
