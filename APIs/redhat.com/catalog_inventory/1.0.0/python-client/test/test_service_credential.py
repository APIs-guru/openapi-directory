...
class TestServiceCredential(unittest.TestCase):
    """ServiceCredential unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceCredential:
        """Test ServiceCredential
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceCredential`
        """
    ...
    def testServiceCredential(self):
        """Test ServiceCredential"""
