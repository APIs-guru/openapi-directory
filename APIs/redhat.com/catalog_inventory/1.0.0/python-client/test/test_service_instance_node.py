...
class TestServiceInstanceNode(unittest.TestCase):
    """ServiceInstanceNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceInstanceNode:
        """Test ServiceInstanceNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceInstanceNode`
        """
        model = ServiceInstanceNode()
        if include_optional:
    ...
    def testServiceInstanceNode(self):
        """Test ServiceInstanceNode"""
