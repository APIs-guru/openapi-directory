...
class TestServiceInventoriesCollection(unittest.TestCase):
    """ServiceInventoriesCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceInventoriesCollection:
        """Test ServiceInventoriesCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceInventoriesCollection`
        """
        model = ServiceInventoriesCollection()
        if include_optional:
            return ServiceInventoriesCollection(
                data = [
                    openapi_client.models.service_inventory.ServiceInventory(
    ...
    def testServiceInventoriesCollection(self):
        """Test ServiceInventoriesCollection"""
