...
class TestServiceOfferingNodesCollection(unittest.TestCase):
    """ServiceOfferingNodesCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceOfferingNodesCollection:
        """Test ServiceOfferingNodesCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceOfferingNodesCollection`
        """
        model = ServiceOfferingNodesCollection()
        if include_optional:
            return ServiceOfferingNodesCollection(
                data = [
                    openapi_client.models.service_offering_node.ServiceOfferingNode(
    ...
    def testServiceOfferingNodesCollection(self):
        """Test ServiceOfferingNodesCollection"""
