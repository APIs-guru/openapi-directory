...
class TestServiceInstanceNodesCollection(unittest.TestCase):
    """ServiceInstanceNodesCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceInstanceNodesCollection:
        """Test ServiceInstanceNodesCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceInstanceNodesCollection`
        """
        model = ServiceInstanceNodesCollection()
        if include_optional:
            return ServiceInstanceNodesCollection(
                data = [
                    openapi_client.models.service_instance_node.ServiceInstanceNode(
    ...
    def testServiceInstanceNodesCollection(self):
        """Test ServiceInstanceNodesCollection"""
