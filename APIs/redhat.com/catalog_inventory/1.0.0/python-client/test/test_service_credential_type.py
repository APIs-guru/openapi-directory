...
class TestServiceCredentialType(unittest.TestCase):
    """ServiceCredentialType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceCredentialType:
        """Test ServiceCredentialType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceCredentialType`
        """
        model = ServiceCredentialType()
        if include_optional:
    ...
    def testServiceCredentialType(self):
        """Test ServiceCredentialType"""
