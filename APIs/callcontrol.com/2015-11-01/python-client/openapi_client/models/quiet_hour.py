...
class QuietHour(BaseModel):
    ...
    QuietHour
    """ # noqa: E501
    day_of_week_list: Optional[List[StrictStr]] = Field(default=None, alias="DayOfWeekList")
    duration_min: Optional[StrictInt] = Field(default=None, alias="DurationMin")
    start_hour_local: Optional[StrictInt] = Field(default=None, alias="StartHourLocal")
    start_min_local: Optional[StrictInt] = Field(default=None, alias="StartMinLocal")
    time_zone_name: Optional[StrictStr] = Field(default=None, alias="TimeZoneName")
    __properties: ClassVar[List[str]] = ["DayOfWeekList", "DurationMin", "StartHourLocal", "StartMinLocal", "TimeZoneName"]

    @field_validator('day_of_week_list')
    def day_of_week_list_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DayOfWeekList": obj.get("DayOfWeekList"),
            "DurationMin": obj.get("DurationMin"),
            "StartHourLocal": obj.get("StartHourLocal"),
            "StartMinLocal": obj.get("StartMinLocal"),
