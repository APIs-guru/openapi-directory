...
class TestCallReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CallReport:
        """Test CallReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallReport`
        """
        model = CallReport()
        if include_optional:
            return CallReport(
                call_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                caller_type = 'Unknown',
                comment = '',
                ip_address = '',
                latitude = 1.337,
