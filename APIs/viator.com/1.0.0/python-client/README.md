...
------------ | ------------- | ------------- | -------------
*BookingServicesApi* | [**booking_availability**](docs/BookingServicesApi.md#booking_availability) | **POST** /booking/availability | /booking/availability
*BookingServicesApi* | [**booking_availability_dates**](docs/BookingServicesApi.md#booking_availability_dates) | **GET** /booking/availability/dates | /booking/availability/dates
*BookingServicesApi* | [**booking_availability_tourgrades**](docs/BookingServicesApi.md#booking_availability_tourgrades) | **POST** /booking/availability/tourgrades | /booking/availability/tourgrades
*BookingServicesApi* | [**booking_availability_tourgrades_pricingmatrix**](docs/BookingServicesApi.md#booking_availability_tourgrades_pricingmatrix) | **POST** /booking/availability/tourgrades/pricingmatrix | /booking/availability/tourgrades/pricingmatrix
*BookingServicesApi* | [**booking_book**](docs/BookingServicesApi.md#booking_book) | **POST** /booking/book | /booking/book
*BookingServicesApi* | [**booking_calculateprice**](docs/BookingServicesApi.md#booking_calculateprice) | **POST** /booking/calculateprice | /booking/calculateprice
*BookingServicesApi* | [**booking_hotels**](docs/BookingServicesApi.md#booking_hotels) | **GET** /booking/hotels | /booking/hotels
*BookingServicesApi* | [**booking_mybookings**](docs/BookingServicesApi.md#booking_mybookings) | **GET** /booking/mybookings | /booking/mybookings
*BookingServicesApi* | [**booking_pastbooking**](docs/BookingServicesApi.md#booking_pastbooking) | **GET** /booking/pastbooking | /booking/pastbooking
*BookingServicesApi* | [**booking_pricingmatrix**](docs/BookingServicesApi.md#booking_pricingmatrix) | **POST** /booking/pricingmatrix | /booking/pricingmatrix
*BookingServicesApi* | [**booking_status**](docs/BookingServicesApi.md#booking_status) | **POST** /booking/status | /booking/status
*BookingServicesApi* | [**booking_status_items**](docs/BookingServicesApi.md#booking_status_items) | **POST** /booking/status/items | /booking/status/items
*BookingServicesApi* | [**booking_voucher**](docs/BookingServicesApi.md#booking_voucher) | **GET** /booking/voucher | /booking/voucher
*BookingServicesApi* | [**cancel_booking**](docs/BookingServicesApi.md#cancel_booking) | **POST** /bookings/{booking-reference}/cancel | /bookings/{booking-reference}/cancel
*BookingServicesApi* | [**cancel_booking_quote**](docs/BookingServicesApi.md#cancel_booking_quote) | **GET** /bookings/{booking-reference}/cancel-quote | /bookings/{booking-reference}/cancel-quote
*BookingServicesApi* | [**cancellation_reasons**](docs/BookingServicesApi.md#cancellation_reasons) | **GET** /bookings/cancel-reasons | /bookings/cancel-reasons
*DeprecatedServicesApi* | [**merchant_cancellation**](docs/DeprecatedServicesApi.md#merchant_cancellation) | **POST** /merchant/cancellation | /merchant/cancellation
*GeneralServicesApi* | [**health_check**](docs/GeneralServicesApi.md#health_check) | **GET** /health/check | /health/check
*ProductServicesApi* | [**available_products**](docs/ProductServicesApi.md#available_products) | **POST** /available/products | /available/products
*ProductServicesApi* | [**product**](docs/ProductServicesApi.md#product) | **GET** /product | /product
*ProductServicesApi* | [**product_photos**](docs/ProductServicesApi.md#product_photos) | **GET** /product/photos | /product/photos
*ProductServicesApi* | [**product_reviews**](docs/ProductServicesApi.md#product_reviews) | **GET** /product/reviews | /product/reviews
*ProductServicesApi* | [**search_freetext**](docs/ProductServicesApi.md#search_freetext) | **POST** /search/freetext | /search/freetext
*ProductServicesApi* | [**search_products**](docs/ProductServicesApi.md#search_products) | **POST** /search/products | /search/products
*ProductServicesApi* | [**search_products_codes**](docs/ProductServicesApi.md#search_products_codes) | **POST** /search/products/codes | /search/products/codes
*TaxonomyServicesApi* | [**taxonomy_attractions**](docs/TaxonomyServicesApi.md#taxonomy_attractions) | **POST** /taxonomy/attractions | /taxonomy/attractions
*TaxonomyServicesApi* | [**taxonomy_categories**](docs/TaxonomyServicesApi.md#taxonomy_categories) | **GET** /taxonomy/categories | /taxonomy/categories
*TaxonomyServicesApi* | [**taxonomy_destinations**](docs/TaxonomyServicesApi.md#taxonomy_destinations) | **GET** /taxonomy/destinations | /taxonomy/destinations
