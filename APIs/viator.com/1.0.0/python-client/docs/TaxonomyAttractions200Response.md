# TaxonomyAttractions200Response
...
**data** | [**List[TaxonomyAttractions200ResponseAllOfDataInner]**](TaxonomyAttractions200ResponseAllOfDataInner.md) | **array** of attraction objects | [optional] 
...
json = "{}"
# create an instance of TaxonomyAttractions200Response from a JSON string
taxonomy_attractions200_response_instance = TaxonomyAttractions200Response.from_json(json)
# print the JSON string representation of the object
print(TaxonomyAttractions200Response.to_json())

# convert the object into a dict
taxonomy_attractions200_response_dict = taxonomy_attractions200_response_instance.to_dict()
# create an instance of TaxonomyAttractions200Response from a dict
taxonomy_attractions200_response_from_dict = TaxonomyAttractions200Response.from_dict(taxonomy_attractions200_response_dict)
```
