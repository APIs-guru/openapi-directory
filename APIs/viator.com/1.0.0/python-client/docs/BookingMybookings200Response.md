...
json = "{}"
# create an instance of BookingMybookings200Response from a JSON string
booking_mybookings200_response_instance = BookingMybookings200Response.from_json(json)
# print the JSON string representation of the object
print(BookingMybookings200Response.to_json())

# convert the object into a dict
booking_mybookings200_response_dict = booking_mybookings200_response_instance.to_dict()
# create an instance of BookingMybookings200Response from a dict
booking_mybookings200_response_from_dict = BookingMybookings200Response.from_dict(booking_mybookings200_response_dict)
```
