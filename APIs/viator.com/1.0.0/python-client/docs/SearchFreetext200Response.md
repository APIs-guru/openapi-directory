...
json = "{}"
# create an instance of SearchFreetext200Response from a JSON string
search_freetext200_response_instance = SearchFreetext200Response.from_json(json)
# print the JSON string representation of the object
print(SearchFreetext200Response.to_json())

# convert the object into a dict
search_freetext200_response_dict = search_freetext200_response_instance.to_dict()
# create an instance of SearchFreetext200Response from a dict
search_freetext200_response_from_dict = SearchFreetext200Response.from_dict(search_freetext200_response_dict)
```
