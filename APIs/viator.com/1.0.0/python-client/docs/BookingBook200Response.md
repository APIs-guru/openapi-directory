...
json = "{}"
# create an instance of BookingBook200Response from a JSON string
booking_book200_response_instance = BookingBook200Response.from_json(json)
# print the JSON string representation of the object
print(BookingBook200Response.to_json())

# convert the object into a dict
booking_book200_response_dict = booking_book200_response_instance.to_dict()
# create an instance of BookingBook200Response from a dict
booking_book200_response_from_dict = BookingBook200Response.from_dict(booking_book200_response_dict)
```
