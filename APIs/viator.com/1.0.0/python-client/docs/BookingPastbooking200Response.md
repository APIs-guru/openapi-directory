...
json = "{}"
# create an instance of BookingPastbooking200Response from a JSON string
booking_pastbooking200_response_instance = BookingPastbooking200Response.from_json(json)
# print the JSON string representation of the object
print(BookingPastbooking200Response.to_json())

# convert the object into a dict
booking_pastbooking200_response_dict = booking_pastbooking200_response_instance.to_dict()
# create an instance of BookingPastbooking200Response from a dict
booking_pastbooking200_response_from_dict = BookingPastbooking200Response.from_dict(booking_pastbooking200_response_dict)
```
