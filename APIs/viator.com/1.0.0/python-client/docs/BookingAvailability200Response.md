...
json = "{}"
# create an instance of BookingAvailability200Response from a JSON string
booking_availability200_response_instance = BookingAvailability200Response.from_json(json)
# print the JSON string representation of the object
print(BookingAvailability200Response.to_json())

# convert the object into a dict
booking_availability200_response_dict = booking_availability200_response_instance.to_dict()
# create an instance of BookingAvailability200Response from a dict
booking_availability200_response_from_dict = BookingAvailability200Response.from_dict(booking_availability200_response_dict)
```
