...
json = "{}"
# create an instance of BookingAvailabilityTourgrades200Response from a JSON string
booking_availability_tourgrades200_response_instance = BookingAvailabilityTourgrades200Response.from_json(json)
# print the JSON string representation of the object
print(BookingAvailabilityTourgrades200Response.to_json())

# convert the object into a dict
booking_availability_tourgrades200_response_dict = booking_availability_tourgrades200_response_instance.to_dict()
# create an instance of BookingAvailabilityTourgrades200Response from a dict
booking_availability_tourgrades200_response_from_dict = BookingAvailabilityTourgrades200Response.from_dict(booking_availability_tourgrades200_response_dict)
```
