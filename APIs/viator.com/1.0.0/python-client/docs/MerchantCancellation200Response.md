...
json = "{}"
# create an instance of MerchantCancellation200Response from a JSON string
merchant_cancellation200_response_instance = MerchantCancellation200Response.from_json(json)
# print the JSON string representation of the object
print(MerchantCancellation200Response.to_json())

# convert the object into a dict
merchant_cancellation200_response_dict = merchant_cancellation200_response_instance.to_dict()
# create an instance of MerchantCancellation200Response from a dict
merchant_cancellation200_response_from_dict = MerchantCancellation200Response.from_dict(merchant_cancellation200_response_dict)
```
