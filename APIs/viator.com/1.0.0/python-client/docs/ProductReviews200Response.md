...
**data** | [**List[ReviewObject]**](ReviewObject.md) | **array** of review objects | [optional] 
...
json = "{}"
# create an instance of ProductReviews200Response from a JSON string
product_reviews200_response_instance = ProductReviews200Response.from_json(json)
# print the JSON string representation of the object
print(ProductReviews200Response.to_json())

# convert the object into a dict
product_reviews200_response_dict = product_reviews200_response_instance.to_dict()
# create an instance of ProductReviews200Response from a dict
product_reviews200_response_from_dict = ProductReviews200Response.from_dict(product_reviews200_response_dict)
```
