...
**data** | [**List[SearchProducts200ResponseAllOfDataInner]**](SearchProducts200ResponseAllOfDataInner.md) | **array** of product objects | [optional] 
...
json = "{}"
# create an instance of SearchProducts200Response from a JSON string
search_products200_response_instance = SearchProducts200Response.from_json(json)
# print the JSON string representation of the object
print(SearchProducts200Response.to_json())

# convert the object into a dict
search_products200_response_dict = search_products200_response_instance.to_dict()
# create an instance of SearchProducts200Response from a dict
search_products200_response_from_dict = SearchProducts200Response.from_dict(search_products200_response_dict)
```
