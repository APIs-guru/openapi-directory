...
**item_summaries** | [**List[BookingPastbooking200ResponseAllOfDataItemSummariesInner]**](BookingPastbooking200ResponseAllOfDataItemSummariesInner.md) | **array** of item summary objects | [optional] 
**itinerary_id** | **int** | ignore (Viator only) | [optional] 
**rules_applied** | **str** | ignore (Viator only) | [optional] 
**sort_order** | **int** | **sort order** for *this* result | [optional] 
...
```python
from openapi_client.models.booking_pastbooking200_response_all_of_data import BookingPastbooking200ResponseAllOfData

# TODO update the JSON string below
json = "{}"
# create an instance of BookingPastbooking200ResponseAllOfData from a JSON string
booking_pastbooking200_response_all_of_data_instance = BookingPastbooking200ResponseAllOfData.from_json(json)
# print the JSON string representation of the object
print(BookingPastbooking200ResponseAllOfData.to_json())

# convert the object into a dict
booking_pastbooking200_response_all_of_data_dict = booking_pastbooking200_response_all_of_data_instance.to_dict()
# create an instance of BookingPastbooking200ResponseAllOfData from a dict
booking_pastbooking200_response_all_of_data_from_dict = BookingPastbooking200ResponseAllOfData.from_dict(booking_pastbooking200_response_all_of_data_dict)
```
