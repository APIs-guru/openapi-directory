# TaxonomyDestinations200Response
...
**data** | [**List[TaxonomyDestinations200ResponseAllOfDataInner]**](TaxonomyDestinations200ResponseAllOfDataInner.md) | **array** of destination objects | [optional] 
...
json = "{}"
# create an instance of TaxonomyDestinations200Response from a JSON string
taxonomy_destinations200_response_instance = TaxonomyDestinations200Response.from_json(json)
# print the JSON string representation of the object
print(TaxonomyDestinations200Response.to_json())

# convert the object into a dict
taxonomy_destinations200_response_dict = taxonomy_destinations200_response_instance.to_dict()
# create an instance of TaxonomyDestinations200Response from a dict
taxonomy_destinations200_response_from_dict = TaxonomyDestinations200Response.from_dict(taxonomy_destinations200_response_dict)
```
