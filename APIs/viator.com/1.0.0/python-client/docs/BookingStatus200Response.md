...
json = "{}"
# create an instance of BookingStatus200Response from a JSON string
booking_status200_response_instance = BookingStatus200Response.from_json(json)
# print the JSON string representation of the object
print(BookingStatus200Response.to_json())

# convert the object into a dict
booking_status200_response_dict = booking_status200_response_instance.to_dict()
# create an instance of BookingStatus200Response from a dict
booking_status200_response_from_dict = BookingStatus200Response.from_dict(booking_status200_response_dict)
```
