...
**data** | **str** | **HTML-formatted** voucher content | [optional] 
...
json = "{}"
# create an instance of BookingVoucher200Response from a JSON string
booking_voucher200_response_instance = BookingVoucher200Response.from_json(json)
# print the JSON string representation of the object
print(BookingVoucher200Response.to_json())

# convert the object into a dict
booking_voucher200_response_dict = booking_voucher200_response_instance.to_dict()
# create an instance of BookingVoucher200Response from a dict
booking_voucher200_response_from_dict = BookingVoucher200Response.from_dict(booking_voucher200_response_dict)
```
