...
class TestBrandInner2(unittest.TestCase):
    """BrandInner2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandInner2:
        """Test BrandInner2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandInner2`
        """
        model = BrandInner2()
        if include_optional:
            return BrandInner2(
