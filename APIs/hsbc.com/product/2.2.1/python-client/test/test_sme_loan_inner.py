...
class TestSMELoanInner(unittest.TestCase):
    """SMELoanInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SMELoanInner:
        """Test SMELoanInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SMELoanInner`
        """
        model = SMELoanInner()
        if include_optional:
            return SMELoanInner(
