...
class TestSMELoanMarketingStateInner(unittest.TestCase):
    """SMELoanMarketingStateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SMELoanMarketingStateInner:
        """Test SMELoanMarketingStateInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SMELoanMarketingStateInner`
        """
        model = SMELoanMarketingStateInner()
        if include_optional:
            return SMELoanMarketingStateInner(
    ...
    def testSMELoanMarketingStateInner(self):
        """Test SMELoanMarketingStateInner"""
