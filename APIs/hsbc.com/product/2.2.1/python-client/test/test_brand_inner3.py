...
class TestBrandInner3(unittest.TestCase):
    """BrandInner3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandInner3:
        """Test BrandInner3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandInner3`
        """
        model = BrandInner3()
        if include_optional:
            return BrandInner3(
