...
class TestBCADefinitionMeta(unittest.TestCase):
    """BCADefinitionMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCADefinitionMeta:
        """Test BCADefinitionMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCADefinitionMeta`
        """
        model = BCADefinitionMeta()
        if include_optional:
            return BCADefinitionMeta(
                data = [
                    openapi_client.models.bca_definition.BCADefinition(
                        brand = [
    ...
    def testBCADefinitionMeta(self):
        """Test BCADefinitionMeta"""
