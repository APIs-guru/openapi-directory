...
class TestPCAInner(unittest.TestCase):
    """PCAInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PCAInner:
        """Test PCAInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PCAInner`
        """
        model = PCAInner()
        if include_optional:
            return PCAInner(
