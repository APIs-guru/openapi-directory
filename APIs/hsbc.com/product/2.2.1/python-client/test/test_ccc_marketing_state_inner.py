...
class TestCCCMarketingStateInner(unittest.TestCase):
    """CCCMarketingStateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CCCMarketingStateInner:
        """Test CCCMarketingStateInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CCCMarketingStateInner`
        """
        model = CCCMarketingStateInner()
        if include_optional:
            return CCCMarketingStateInner(
    ...
    def testCCCMarketingStateInner(self):
        """Test CCCMarketingStateInner"""
