...
class TestCCCInner(unittest.TestCase):
    """CCCInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CCCInner:
        """Test CCCInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CCCInner`
        """
        model = CCCInner()
        if include_optional:
            return CCCInner(
