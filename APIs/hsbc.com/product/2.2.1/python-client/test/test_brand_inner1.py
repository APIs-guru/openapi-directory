...
class TestBrandInner1(unittest.TestCase):
    """BrandInner1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandInner1:
        """Test BrandInner1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandInner1`
        """
        model = BrandInner1()
        if include_optional:
            return BrandInner1(
