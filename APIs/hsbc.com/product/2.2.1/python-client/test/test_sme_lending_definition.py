...
class TestSMELendingDefinition(unittest.TestCase):
    """SMELendingDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SMELendingDefinition:
        """Test SMELendingDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SMELendingDefinition`
        """
        model = SMELendingDefinition()
        if include_optional:
            return SMELendingDefinition(
                brand = [
    ...
    def testSMELendingDefinition(self):
        """Test SMELendingDefinition"""
