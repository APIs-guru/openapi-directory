...
class TestCCCDefinition(unittest.TestCase):
    """CCCDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CCCDefinition:
        """Test CCCDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CCCDefinition`
        """
        model = CCCDefinition()
        if include_optional:
            return CCCDefinition(
                brand = [
