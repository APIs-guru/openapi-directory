...
class TestBCAInner(unittest.TestCase):
    """BCAInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCAInner:
        """Test BCAInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCAInner`
        """
        model = BCAInner()
        if include_optional:
            return BCAInner(
