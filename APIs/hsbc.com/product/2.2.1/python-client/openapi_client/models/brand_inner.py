...
class BrandInner(BaseModel):
    ...
    """ # noqa: E501
    bca: Annotated[List[BCAInner], Field(min_length=1)] = Field(description="BCA means a Business Current Account.", alias="BCA")
    ...
    __properties: ClassVar[List[str]] = ["BCA", "BrandName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bca (list)
        _items = []
        if self.bca:
            for _item_bca in self.bca:
                if _item_bca:
                    _items.append(_item_bca.to_dict())
            _dict['BCA'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BCA": [BCAInner.from_dict(_item) for _item in obj["BCA"]] if obj.get("BCA") is not None else None,
