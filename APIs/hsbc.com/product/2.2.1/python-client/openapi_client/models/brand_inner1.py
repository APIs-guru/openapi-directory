...
class BrandInner1(BaseModel):
    ...
    ccc: Annotated[List[CCCInner], Field(min_length=1)] = Field(description="CCC means a Commercial Credit Card.", alias="CCC")
    __properties: ClassVar[List[str]] = ["BrandName", "CCC"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ccc (list)
        _items = []
        if self.ccc:
            for _item_ccc in self.ccc:
                if _item_ccc:
                    _items.append(_item_ccc.to_dict())
            _dict['CCC'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "CCC": [CCCInner.from_dict(_item) for _item in obj["CCC"]] if obj.get("CCC") is not None else None
        })
        return _obj
