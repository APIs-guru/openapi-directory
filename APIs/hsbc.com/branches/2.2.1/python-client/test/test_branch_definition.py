...
class TestBranchDefinition(unittest.TestCase):
    """BranchDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BranchDefinition:
        """Test BranchDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BranchDefinition`
        """
        model = BranchDefinition()
        if include_optional:
