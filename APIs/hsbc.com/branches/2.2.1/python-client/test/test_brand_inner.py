...
class TestBrandInner(unittest.TestCase):
    """BrandInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandInner:
        """Test BrandInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandInner`
        """
        model = BrandInner()
        if include_optional:
            return BrandInner(
