...
class TestATMDefinitionMeta(unittest.TestCase):
    """ATMDefinitionMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ATMDefinitionMeta:
        """Test ATMDefinitionMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ATMDefinitionMeta`
        """
        model = ATMDefinitionMeta()
        if include_optional:
            return ATMDefinitionMeta(
                data = [
                    openapi_client.models.atm_definition.ATMDefinition(
                        brand = [
    ...
    def testATMDefinitionMeta(self):
        """Test ATMDefinitionMeta"""
