...
class TestGetListOfIssues200ResponseResultsInner(unittest.TestCase):
    """GetListOfIssues200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetListOfIssues200ResponseResultsInner:
        """Test GetListOfIssues200ResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetListOfIssues200ResponseResultsInner`
        """
        model = GetListOfIssues200ResponseResultsInner()
        if include_optional:
            return GetListOfIssues200ResponseResultsInner(
                fixed_date = '',
                introduced_date = '',
                is_fixed = True,
                issue = openapi_client.models.get_list_of_issues_200_response_results_inner_issue.Get_list_of_issues_200_response_results_inner_issue(
                    cvssv3 = '', 
                    credit = [
                        null
                        ], 
                    ...
                    exploit_maturity = '', 
                    id = '', 
                    identifiers = openapi_client.models.get_list_of_issues_200_response_results_inner_issue_identifiers.Get_list_of_issues_200_response_results_inner_issue_identifiers(
                        cve = [
                            null
                            ], 
                        cwe = [
                    ...
                    publication_time = '', 
                    semver = openapi_client.models.get_list_of_issues_200_response_results_inner_issue_semver.Get_list_of_issues_200_response_results_inner_issue_semver(
                        unaffected = '', 
                        vulnerable = [
                            null
                            ], ), 
                ...
                project = openapi_client.models.get_list_of_issues_200_response_results_inner_one_of_1_project.Get_list_of_issues_200_response_results_inner_oneOf_1_project(
                    id = '', 
                    name = '', 
                    package_manager = '', 
                    source = '', 
    ...
    def testGetListOfIssues200ResponseResultsInner(self):
        """Test GetListOfIssues200ResponseResultsInner"""
