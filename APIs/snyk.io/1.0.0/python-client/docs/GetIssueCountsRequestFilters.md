...
json = "{}"
# create an instance of GetIssueCountsRequestFilters from a JSON string
get_issue_counts_request_filters_instance = GetIssueCountsRequestFilters.from_json(json)
# print the JSON string representation of the object
print(GetIssueCountsRequestFilters.to_json())

# convert the object into a dict
get_issue_counts_request_filters_dict = get_issue_counts_request_filters_instance.to_dict()
# create an instance of GetIssueCountsRequestFilters from a dict
get_issue_counts_request_filters_from_dict = GetIssueCountsRequestFilters.from_dict(get_issue_counts_request_filters_dict)
```
