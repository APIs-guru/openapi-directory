...
class WebhooksApi:
    ...
    def _create_a_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/webhooks',
    ...
    def delete_a_webhook(
        ...
        webhook_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type org_id: str
        :param webhook_id: Automatically added (required)
        :type webhook_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_a_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/org/{orgId}/webhooks/{webhookId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ping_a_webhook(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID the project belongs to. The `API_KEY` must have access to this organization.")],
        ...
        :param org_id: The organization ID the project belongs to. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        ...
        _param = self._ping_a_webhook_serialize(
            org_id=org_id,
            webhook_id=webhook_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ping_a_webhook_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID the project belongs to. The `API_KEY` must have access to this organization.")],
        webhook_id: Annotated[StrictStr, Field(description="The webhook ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def ping_a_webhook_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID the project belongs to. The `API_KEY` must have access to this organization.")],
        webhook_id: Annotated[StrictStr, Field(description="The webhook ID.")],
        _request_timeout: Union[
    ...
    def _ping_a_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/webhooks/{webhookId}/ping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
