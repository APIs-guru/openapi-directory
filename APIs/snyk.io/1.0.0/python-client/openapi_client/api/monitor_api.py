...
class MonitorApi:
    ...
    def monitor_dep_graph(
        ...
        monitor_dep_graph_request: Optional[MonitorDepGraphRequest] = None,
        ...
        :type org: str
        :param monitor_dep_graph_request:
        :type monitor_dep_graph_request: MonitorDepGraphRequest
        ...
        _param = self._monitor_dep_graph_serialize(
            org=org,
            monitor_dep_graph_request=monitor_dep_graph_request,
    ...
    @validate_call
    def monitor_dep_graph_with_http_info(
        self,
        org: Annotated[Optional[StrictStr], Field(description="The organization to test the package with. See \"The Snyk organization for a request\" above.")] = None,
        monitor_dep_graph_request: Optional[MonitorDepGraphRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def monitor_dep_graph_without_preload_content(
        self,
        org: Annotated[Optional[StrictStr], Field(description="The organization to test the package with. See \"The Snyk organization for a request\" above.")] = None,
        monitor_dep_graph_request: Optional[MonitorDepGraphRequest] = None,
        _request_timeout: Union[
    ...
    def _monitor_dep_graph_serialize(
        self,
        org,
        monitor_dep_graph_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if monitor_dep_graph_request is not None:
            _body_params = monitor_dep_graph_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/monitor/dep-graph',
