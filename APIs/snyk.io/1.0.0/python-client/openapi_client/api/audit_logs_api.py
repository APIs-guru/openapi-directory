...
class AuditLogsApi:
    ...
    @validate_call
    def get_group_level_audit_logs(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access to this group.")],
        var_from: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request. Audit logs are returned in page sizes of 100")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="The sort order of the returned audit logs by date. Values: `ASC`, `DESC`. Default: `DESC`.")] = None,
        get_group_level_audit_logs_request: Optional[GetGroupLevelAuditLogsRequest] = None,
        ...
        :param group_id: The group ID. The `API_KEY` must have access to this group. (required)
        :type group_id: str
        :param var_from: The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.
        :type var_from: str
        ...
        :type sort_order: str
        :param get_group_level_audit_logs_request:
        :type get_group_level_audit_logs_request: GetGroupLevelAuditLogsRequest
        ...
        _param = self._get_group_level_audit_logs_serialize(
            group_id=group_id,
            var_from=var_from,
            to=to,
            page=page,
            sort_order=sort_order,
            get_group_level_audit_logs_request=get_group_level_audit_logs_request,
    ...
    @validate_call
    def get_group_level_audit_logs_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access to this group.")],
        var_from: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.")] = None,
    ...
    @validate_call
    def get_group_level_audit_logs_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access to this group.")],
        var_from: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.")] = None,
    ...
    def _get_group_level_audit_logs_serialize(
        self,
        group_id,
        var_from,
        to,
        page,
        sort_order,
        get_group_level_audit_logs_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if get_group_level_audit_logs_request is not None:
            _body_params = get_group_level_audit_logs_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/group/{groupId}/audit',
    ...
    @validate_call
    def get_organization_level_audit_logs(
        self,
        ...
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request. Audit logs are returned in page sizes of 100.")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="The sort order of the returned audit logs by date. Values: `ASC`, `DESC`. Default: `DESC`.")] = None,
        get_organization_level_audit_logs_request: Optional[GetOrganizationLevelAuditLogsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sort_order: The sort order of the returned audit logs by date. Values: `ASC`, `DESC`. Default: `DESC`.
        :type sort_order: str
        :param get_organization_level_audit_logs_request:
        :type get_organization_level_audit_logs_request: GetOrganizationLevelAuditLogsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_organization_level_audit_logs_serialize(
            org_id=org_id,
            var_from=var_from,
            to=to,
            page=page,
            sort_order=sort_order,
            get_organization_level_audit_logs_request=get_organization_level_audit_logs_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_organization_level_audit_logs_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        var_from: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.")] = None,
    ...
    @validate_call
    def get_organization_level_audit_logs_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        var_from: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.")] = None,
    ...
    def _get_organization_level_audit_logs_serialize(
        self,
        org_id,
        var_from,
        to,
        page,
        sort_order,
        get_organization_level_audit_logs_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_organization_level_audit_logs_request is not None:
            _body_params = get_organization_level_audit_logs_request
