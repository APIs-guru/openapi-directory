...
class LicensesApi:
    ...
    def list_all_licenses(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list projects for. The `API_KEY` must have access to this organization.")],
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort results by.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results by.")] = None,
        list_all_licenses_request: Optional[ListAllLicensesRequest] = None,
        ...
        :param org_id: The organization ID to list projects for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param sort_by: The field to sort results by.
        :type sort_by: str
        :param order: The direction to sort results by.
        :type order: str
        :param list_all_licenses_request:
        :type list_all_licenses_request: ListAllLicensesRequest
        ...
        _param = self._list_all_licenses_serialize(
            org_id=org_id,
            sort_by=sort_by,
            order=order,
            list_all_licenses_request=list_all_licenses_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllLicenses200Response",
        }
    ...
    @validate_call
    def list_all_licenses_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list projects for. The `API_KEY` must have access to this organization.")],
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort results by.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results by.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllLicenses200Response]:
        """List all licenses
    ...
    @validate_call
    def list_all_licenses_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list projects for. The `API_KEY` must have access to this organization.")],
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort results by.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results by.")] = None,
    ...
    def _list_all_licenses_serialize(
        self,
        org_id,
        sort_by,
        order,
        list_all_licenses_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if list_all_licenses_request is not None:
            _body_params = list_all_licenses_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/licenses',
