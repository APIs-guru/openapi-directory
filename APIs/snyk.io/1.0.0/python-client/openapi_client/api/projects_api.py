...
class ProjectsApi:
    ...
    def _activate_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/activate',
    ...
    @validate_call
    def add_a_tag_to_a_project(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to apply the tag to")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type org_id: str
        :param project_id: The project ID to apply the tag to (required)
        :type project_id: str
        :param add_a_tag_to_a_project_request:
        :type add_a_tag_to_a_project_request: AddATagToAProjectRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._add_a_tag_to_a_project_serialize(
            org_id=org_id,
            project_id=project_id,
            add_a_tag_to_a_project_request=add_a_tag_to_a_project_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AddATagToAProject200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def add_a_tag_to_a_project_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to apply the tag to")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddATagToAProject200Response]:
        """Add a tag to a project
    ...
    @validate_call
    def add_a_tag_to_a_project_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to apply the tag to")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
    ...
    def _add_a_tag_to_a_project_serialize(
        self,
        org_id,
        project_id,
        add_a_tag_to_a_project_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if add_a_tag_to_a_project_request is not None:
            _body_params = add_a_tag_to_a_project_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def add_ignore(
        ...
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
        add_ignore_request: Optional[AddIgnoreRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type project_id: str
        :param issue_id: Automatically added (required)
        :type issue_id: str
        :param add_ignore_request:
        :type add_ignore_request: AddIgnoreRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._add_ignore_serialize(
            org_id=org_id,
            project_id=project_id,
            issue_id=issue_id,
            add_ignore_request=add_ignore_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def add_ignore_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    def _add_ignore_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if add_ignore_request is not None:
            _body_params = add_ignore_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/ignore/{issueId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def applying_attributes(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        applying_attributes_request: Optional[ApplyingAttributesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to remove a tag from (required)
        :type project_id: str
        :param applying_attributes_request:
        :type applying_attributes_request: ApplyingAttributesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._applying_attributes_serialize(
            org_id=org_id,
            project_id=project_id,
            applying_attributes_request=applying_attributes_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplyingAttributes200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def applying_attributes_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        applying_attributes_request: Optional[ApplyingAttributesRequest] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplyingAttributes200Response]:
        """Applying attributes
    ...
    @validate_call
    def applying_attributes_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        applying_attributes_request: Optional[ApplyingAttributesRequest] = None,
    ...
    def _applying_attributes_serialize(
        self,
        org_id,
        project_id,
        applying_attributes_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if applying_attributes_request is not None:
            _body_params = applying_attributes_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/attributes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create_jira_issue(
        self,
        issue_id: Annotated[StrictStr, Field(description="The issue ID to create Jira issue for.")],
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        create_jira_issue_request: Optional[CreateJiraIssueRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param issue_id: The issue ID to create Jira issue for. (required)
        :type issue_id: str
        :param org_id: Automatically added (required)
        :type org_id: str
        :param project_id: Automatically added (required)
        :type project_id: str
        :param create_jira_issue_request:
        :type create_jira_issue_request: CreateJiraIssueRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_jira_issue_serialize(
            issue_id=issue_id,
            org_id=org_id,
            project_id=project_id,
            create_jira_issue_request=create_jira_issue_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateJiraIssue200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def create_jira_issue_with_http_info(
        self,
        issue_id: Annotated[StrictStr, Field(description="The issue ID to create Jira issue for.")],
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateJiraIssue200Response]:
        """Create jira issue
    ...
    @validate_call
    def create_jira_issue_without_preload_content(
        self,
        issue_id: Annotated[StrictStr, Field(description="The issue ID to create Jira issue for.")],
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    def _create_jira_issue_serialize(
        self,
        issue_id,
        org_id,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if create_jira_issue_request is not None:
            _body_params = create_jira_issue_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/issue/{issueId}/jira-issue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _deactivate_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/deactivate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_a_project(
        ...
        _param = self._delete_a_project_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_a_project_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_a_project_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
    ...
    def _delete_a_project_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/org/{orgId}/project/{projectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_ignores(
        ...
        _param = self._delete_ignores_serialize(
            org_id=org_id,
            project_id=project_id,
            issue_id=issue_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_ignores_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    @validate_call
    def delete_ignores_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    def delete_project_settings(
        ...
        _param = self._delete_project_settings_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_project_settings_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_project_settings_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
    ...
    def _delete_project_settings_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/org/{orgId}/project/{projectId}/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_project_dependency_graph(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to return issues for. (required)
        :type project_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_project_dependency_graph_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProjectDependencyGraph200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_project_dependency_graph_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProjectDependencyGraph200Response]:
        """Get Project dependency graph
    ...
    @validate_call
    def get_project_dependency_graph_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        _request_timeout: Union[
    ...
    def _get_project_dependency_graph_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/project/{projectId}/dep-graph',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_aggregated_issues(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        list_all_aggregated_issues_request: Optional[ListAllAggregatedIssuesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The project ID to return issues for. (required)
        :type project_id: str
        :param list_all_aggregated_issues_request:
        :type list_all_aggregated_issues_request: ListAllAggregatedIssuesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_all_aggregated_issues_serialize(
            org_id=org_id,
            project_id=project_id,
            list_all_aggregated_issues_request=list_all_aggregated_issues_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllAggregatedIssues200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_all_aggregated_issues_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        list_all_aggregated_issues_request: Optional[ListAllAggregatedIssuesRequest] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllAggregatedIssues200Response]:
        """List all Aggregated issues
    ...
    @validate_call
    def list_all_aggregated_issues_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return issues for.")],
        list_all_aggregated_issues_request: Optional[ListAllAggregatedIssuesRequest] = None,
    ...
    def _list_all_aggregated_issues_serialize(
        self,
        org_id,
        project_id,
        list_all_aggregated_issues_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if list_all_aggregated_issues_request is not None:
            _body_params = list_all_aggregated_issues_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/aggregated-issues',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_all_ignores(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list ignores for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID to list ignores for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to list ignores for. (required)
        :type project_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_all_ignores_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_all_ignores_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list ignores for.")],
        _request_timeout: Union[
    ...
    @validate_call
    def list_all_ignores_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list ignores for.")],
        _request_timeout: Union[
    ...
    def _list_all_ignores_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/project/{projectId}/ignores',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_jira_issues(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list Jira issues for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list Jira issues for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID to list Jira issues for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to list Jira issues for. (required)
        :type project_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_all_jira_issues_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_all_jira_issues_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list Jira issues for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list Jira issues for.")],
        _request_timeout: Union[
    ...
    @validate_call
    def list_all_jira_issues_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list Jira issues for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to list Jira issues for.")],
        _request_timeout: Union[
    ...
    def _list_all_jira_issues_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/project/{projectId}/jira-issues',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_project_issue_paths(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID for which to return issue paths.")],
        snapshot_id: Annotated[Optional[StrictStr], Field(description="The project snapshot ID for which to return issue paths. If set to `latest`, the most recent snapshot will be used. Use the \"List all project snapshots\" endpoint to find suitable values for this.")] = None,
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return per page (1 - 1000, inclusive).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to return.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID for which to return issue paths. (required)
        :type project_id: str
        :param issue_id: The issue ID for which to return issue paths. (required)
        :type issue_id: str
        ...
        _param = self._list_all_project_issue_paths_serialize(
            org_id=org_id,
            project_id=project_id,
            issue_id=issue_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllProjectSnapshotIssuePaths200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_all_project_issue_paths_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID for which to return issue paths.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllProjectSnapshotIssuePaths200Response]:
        """List all project issue paths
    ...
    @validate_call
    def list_all_project_issue_paths_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID for which to return issue paths.")],
    ...
    def _list_all_project_issue_paths_serialize(
        self,
        org_id,
        project_id,
        issue_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/project/{projectId}/issue/{issueId}/paths',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_project_snapshot_aggregated_issues(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        snapshot_id: Annotated[StrictStr, Field(description="The snapshot ID. If set to latest, the most recent snapshot will be used.")],
        list_all_aggregated_issues_request: Optional[ListAllAggregatedIssuesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param project_id: The project ID. (required)
        :type project_id: str
        :param snapshot_id: The snapshot ID. If set to latest, the most recent snapshot will be used. (required)
        :type snapshot_id: str
        :param list_all_aggregated_issues_request:
        :type list_all_aggregated_issues_request: ListAllAggregatedIssuesRequest
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._list_all_project_snapshot_aggregated_issues_serialize(
            org_id=org_id,
            project_id=project_id,
            snapshot_id=snapshot_id,
            list_all_aggregated_issues_request=list_all_aggregated_issues_request,
    ...
    @validate_call
    def list_all_project_snapshot_aggregated_issues_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        snapshot_id: Annotated[StrictStr, Field(description="The snapshot ID. If set to latest, the most recent snapshot will be used.")],
    ...
    @validate_call
    def list_all_project_snapshot_aggregated_issues_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        snapshot_id: Annotated[StrictStr, Field(description="The snapshot ID. If set to latest, the most recent snapshot will be used.")],
    ...
    def _list_all_project_snapshot_aggregated_issues_serialize(
        self,
        org_id,
        project_id,
        snapshot_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/history/{snapshotId}/aggregated-issues',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_project_snapshot_issue_paths(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        snapshot_id: Annotated[StrictStr, Field(description="The project snapshot ID for which to return issue paths. If set to `latest`, the most recent snapshot will be used. Use the \"List all project snapshots\" endpoint to find suitable values for this.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID for which to return issue paths.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return per page (1 - 1000, inclusive).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to return.")] = None,
        _request_timeout: Union[
        ...
        :param project_id: The project ID for which to return issue paths. (required)
        :type project_id: str
        :param snapshot_id: The project snapshot ID for which to return issue paths. If set to `latest`, the most recent snapshot will be used. Use the \"List all project snapshots\" endpoint to find suitable values for this. (required)
        :type snapshot_id: str
        :param issue_id: The issue ID for which to return issue paths. (required)
        :type issue_id: str
        :param per_page: The number of results to return per page (1 - 1000, inclusive).
        ...
        _param = self._list_all_project_snapshot_issue_paths_serialize(
            org_id=org_id,
            project_id=project_id,
            snapshot_id=snapshot_id,
            issue_id=issue_id,
    ...
    @validate_call
    def list_all_project_snapshot_issue_paths_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        snapshot_id: Annotated[StrictStr, Field(description="The project snapshot ID for which to return issue paths. If set to `latest`, the most recent snapshot will be used. Use the \"List all project snapshots\" endpoint to find suitable values for this.")],
    ...
    @validate_call
    def list_all_project_snapshot_issue_paths_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID for which to return issue paths.")],
        snapshot_id: Annotated[StrictStr, Field(description="The project snapshot ID for which to return issue paths. If set to `latest`, the most recent snapshot will be used. Use the \"List all project snapshots\" endpoint to find suitable values for this.")],
    ...
    def _list_all_project_snapshot_issue_paths_serialize(
        self,
        org_id,
        project_id,
        snapshot_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/project/{projectId}/history/{snapshotId}/issue/{issueId}/paths',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_project_snapshots(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return snapshots for.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 10, the maximum is 100).")] = None,
        ...
        list_all_project_snapshots_request: Optional[ListAllProjectSnapshotsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to return snapshots for. (required)
        :type project_id: str
        ...
        :type page: float
        :param list_all_project_snapshots_request:
        :type list_all_project_snapshots_request: ListAllProjectSnapshotsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_all_project_snapshots_serialize(
            org_id=org_id,
            project_id=project_id,
            per_page=per_page,
            page=page,
            list_all_project_snapshots_request=list_all_project_snapshots_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllProjectSnapshots200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_all_project_snapshots_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return snapshots for.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 10, the maximum is 100).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllProjectSnapshots200Response]:
        """List all project snapshots
    ...
    @validate_call
    def list_all_project_snapshots_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to return snapshots for.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 10, the maximum is 100).")] = None,
    ...
    def _list_all_project_snapshots_serialize(
        self,
        org_id,
        project_id,
        per_page,
        page,
        list_all_project_snapshots_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if list_all_project_snapshots_request is not None:
            _body_params = list_all_project_snapshots_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_all_projects(
        ...
        list_all_projects_request: Optional[ListAllProjectsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type org_id: str
        :param list_all_projects_request:
        :type list_all_projects_request: ListAllProjectsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_all_projects_serialize(
            org_id=org_id,
            list_all_projects_request=list_all_projects_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllProjects200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_all_projects_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllProjects200Response]:
        """List all projects
    ...
    def _list_all_projects_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if list_all_projects_request is not None:
            _body_params = list_all_projects_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_project_settings(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param org_id: The organization ID to which the project belongs. The API_KEY must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID (required)
        :type project_id: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._list_project_settings_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListProjectSettings200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_project_settings_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListProjectSettings200Response]:
        """List project settings
    ...
    @validate_call
    def list_project_settings_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID")],
        _request_timeout: Union[
    ...
    def _list_project_settings_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
    ...
    @validate_call
    def move_project_to_a_different_organization(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have group admin permissions. If the project is moved to a new group, a personal level API key is needed.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        move_project_to_a_different_organization_request: Optional[MoveProjectToADifferentOrganizationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID to which the project belongs. The API_KEY must have group admin permissions. If the project is moved to a new group, a personal level API key is needed. (required)
        :type org_id: str
        :param project_id: The project ID. (required)
        :type project_id: str
        :param move_project_to_a_different_organization_request:
        :type move_project_to_a_different_organization_request: MoveProjectToADifferentOrganizationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._move_project_to_a_different_organization_serialize(
            org_id=org_id,
            project_id=project_id,
            move_project_to_a_different_organization_request=move_project_to_a_different_organization_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def move_project_to_a_different_organization_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have group admin permissions. If the project is moved to a new group, a personal level API key is needed.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        move_project_to_a_different_organization_request: Optional[MoveProjectToADifferentOrganizationRequest] = None,
    ...
    @validate_call
    def move_project_to_a_different_organization_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to which the project belongs. The API_KEY must have group admin permissions. If the project is moved to a new group, a personal level API key is needed.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        move_project_to_a_different_organization_request: Optional[MoveProjectToADifferentOrganizationRequest] = None,
    ...
    def _move_project_to_a_different_organization_serialize(
        self,
        org_id,
        project_id,
        move_project_to_a_different_organization_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if move_project_to_a_different_organization_request is not None:
            _body_params = move_project_to_a_different_organization_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/org/{orgId}/project/{projectId}/move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def remove_a_tag_from_a_project(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
        ...
        _param = self._remove_a_tag_from_a_project_serialize(
            org_id=org_id,
            project_id=project_id,
            add_a_tag_to_a_project_request=add_a_tag_to_a_project_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_a_tag_from_a_project_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
    ...
    @validate_call
    def remove_a_tag_from_a_project_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to remove a tag from")],
        add_a_tag_to_a_project_request: Optional[AddATagToAProjectRequest] = None,
    ...
    def _remove_a_tag_from_a_project_serialize(
        self,
        org_id,
        project_id,
        add_a_tag_to_a_project_request,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/project/{projectId}/tags/remove',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def replace_ignores(
        ...
        _param = self._replace_ignores_serialize(
            org_id=org_id,
            project_id=project_id,
            issue_id=issue_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def replace_ignores_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    @validate_call
    def replace_ignores_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        issue_id: Annotated[StrictStr, Field(description="Automatically added")],
    ...
    def _replace_ignores_serialize(
        self,
        org_id,
        project_id,
        issue_id,
    ...
    def retrieve_a_single_project(
        ...
        _param = self._retrieve_a_single_project_serialize(
            org_id=org_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RetrieveASingleProject200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def retrieve_a_single_project_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID the project belongs to. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RetrieveASingleProject200Response]:
        """Retrieve a single project
    ...
    @validate_call
    def retrieve_a_single_project_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID the project belongs to. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID.")],
        _request_timeout: Union[
    ...
    def _retrieve_a_single_project_serialize(
        self,
        org_id,
        project_id,
        _request_auth,
    ...
    def retrieve_ignore(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to modify ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to modify ignores for.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID to modify ignores for. Can be a vulnerability or a license Issue.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID to modify ignores for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param project_id: The project ID to modify ignores for. (required)
        :type project_id: str
        :param issue_id: The issue ID to modify ignores for. Can be a vulnerability or a license Issue. (required)
        :type issue_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._retrieve_ignore_serialize(
            org_id=org_id,
            project_id=project_id,
            issue_id=issue_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def retrieve_ignore_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to modify ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to modify ignores for.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID to modify ignores for. Can be a vulnerability or a license Issue.")],
    ...
    @validate_call
    def retrieve_ignore_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to modify ignores for. The `API_KEY` must have access to this organization.")],
        project_id: Annotated[StrictStr, Field(description="The project ID to modify ignores for.")],
        issue_id: Annotated[StrictStr, Field(description="The issue ID to modify ignores for. Can be a vulnerability or a license Issue.")],
    ...
    def _retrieve_ignore_serialize(
        self,
        org_id,
        project_id,
        issue_id,
    ...
    def update_a_project(
        ...
        _param = self._update_a_project_serialize(
            org_id=org_id,
            project_id=project_id,
    ...
    @validate_call
    def update_a_project_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        update_a_project_request: Optional[UpdateAProjectRequest] = None,
    ...
    @validate_call
    def update_a_project_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        update_a_project_request: Optional[UpdateAProjectRequest] = None,
    ...
    def _update_a_project_serialize(
        self,
        org_id,
        project_id,
    ...
    def update_project_settings(
        ...
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        update_project_settings_request: Optional[UpdateProjectSettingsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Automatically added (required)
        :type project_id: str
        :param update_project_settings_request:
        ...
        _param = self._update_project_settings_serialize(
            org_id=org_id,
            project_id=project_id,
    ...
    @validate_call
    def update_project_settings_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Automatically added")],
        project_id: Annotated[StrictStr, Field(description="Automatically added")],
        update_project_settings_request: Optional[UpdateProjectSettingsRequest] = None,
    ...
    def _update_project_settings_serialize(
        self,
        org_id,
        project_id,
