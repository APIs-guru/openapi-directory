...
class GroupsApi:
    ...
    @validate_call
    def add_a_member_to_an_organization_within_a_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        org_id: Annotated[StrictStr, Field(description="The organization ID we want to add the member to. The `API_KEY` must have access to this organization.")],
        add_a_member_to_an_organization_within_a_group_request: Optional[AddAMemberToAnOrganizationWithinAGroupRequest] = None,
        ...
        :param group_id: The group ID. The `API_KEY` must have access admin to this group. (required)
        :type group_id: str
        :param org_id: The organization ID we want to add the member to. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param add_a_member_to_an_organization_within_a_group_request:
        :type add_a_member_to_an_organization_within_a_group_request: AddAMemberToAnOrganizationWithinAGroupRequest
        ...
        _param = self._add_a_member_to_an_organization_within_a_group_serialize(
            group_id=group_id,
            org_id=org_id,
            add_a_member_to_an_organization_within_a_group_request=add_a_member_to_an_organization_within_a_group_request,
    ...
    @validate_call
    def add_a_member_to_an_organization_within_a_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        org_id: Annotated[StrictStr, Field(description="The organization ID we want to add the member to. The `API_KEY` must have access to this organization.")],
        add_a_member_to_an_organization_within_a_group_request: Optional[AddAMemberToAnOrganizationWithinAGroupRequest] = None,
    ...
    @validate_call
    def add_a_member_to_an_organization_within_a_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        org_id: Annotated[StrictStr, Field(description="The organization ID we want to add the member to. The `API_KEY` must have access to this organization.")],
        add_a_member_to_an_organization_within_a_group_request: Optional[AddAMemberToAnOrganizationWithinAGroupRequest] = None,
    ...
    def _add_a_member_to_an_organization_within_a_group_serialize(
        self,
        group_id,
        org_id,
        add_a_member_to_an_organization_within_a_group_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if add_a_member_to_an_organization_within_a_group_request is not None:
            _body_params = add_a_member_to_an_organization_within_a_group_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/group/{groupId}/org/{orgId}/members',
    ...
    @validate_call
    def delete_tag_from_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        delete_tag_from_group_request: Optional[DeleteTagFromGroupRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param group_id: The group ID. The `API_KEY` must have access admin to this group. (required)
        :type group_id: str
        :param delete_tag_from_group_request:
        :type delete_tag_from_group_request: DeleteTagFromGroupRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_tag_from_group_serialize(
            group_id=group_id,
            delete_tag_from_group_request=delete_tag_from_group_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteTagFromGroup200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def delete_tag_from_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        delete_tag_from_group_request: Optional[DeleteTagFromGroupRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteTagFromGroup200Response]:
        """Delete tag from group
    ...
    @validate_call
    def delete_tag_from_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        delete_tag_from_group_request: Optional[DeleteTagFromGroupRequest] = None,
        _request_timeout: Union[
    ...
    def _delete_tag_from_group_serialize(
        self,
        group_id,
        delete_tag_from_group_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if delete_tag_from_group_request is not None:
            _body_params = delete_tag_from_group_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/group/{groupId}/tags/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_members_in_a_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._list_all_members_in_a_group_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_all_members_in_a_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_all_members_in_a_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        _request_timeout: Union[
            None,
    ...
    def _list_all_members_in_a_group_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def list_all_organizations_in_a_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group and LIST organizations access in this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (maximum is 100).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For pagination - offset (from which to start returning results).")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Only organizations that have a name that **starts with** this value (case insensitive) will be returned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param group_id: The group ID. The `API_KEY` must have READ access to this group and LIST organizations access in this group. (required)
        :type group_id: str
        ...
        _param = self._list_all_organizations_in_a_group_serialize(
            group_id=group_id,
            per_page=per_page,
            page=page,
            name=name,
    ...
    @validate_call
    def list_all_organizations_in_a_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group and LIST organizations access in this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (maximum is 100).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For pagination - offset (from which to start returning results).")] = None,
    ...
    @validate_call
    def list_all_organizations_in_a_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group and LIST organizations access in this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (maximum is 100).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For pagination - offset (from which to start returning results).")] = None,
    ...
    def _list_all_organizations_in_a_group_serialize(
        self,
        group_id,
        per_page,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/group/{groupId}/orgs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_roles_in_a_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param group_id: The group ID. The `API_KEY` must have READ access to this group. (required)
        :type group_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_all_roles_in_a_group_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_all_roles_in_a_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_all_roles_in_a_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have READ access to this group.")],
        _request_timeout: Union[
            None,
    ...
    def _list_all_roles_in_a_group_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/group/{groupId}/roles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_all_tags_in_a_group(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 1000).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The offset from which to start returning results from.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._list_all_tags_in_a_group_serialize(
            group_id=group_id,
            per_page=per_page,
            page=page,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllTagsInAGroup200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_all_tags_in_a_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 1000).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The offset from which to start returning results from.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllTagsInAGroup200Response]:
        """List all tags in a group
    ...
    @validate_call
    def list_all_tags_in_a_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have access admin to this group.")],
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return (the default is 1000).")] = None,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The offset from which to start returning results from.")] = None,
    ...
    def _list_all_tags_in_a_group_serialize(
        self,
        group_id,
        per_page,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/group/{groupId}/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_group_settings(
        self,
        group_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param group_id: Automatically added (required)
        :type group_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_group_settings_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ViewGroupSettings200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def update_group_settings_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ViewGroupSettings200Response]:
        """Update group settings
    ...
    @validate_call
    def update_group_settings_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
    ...
    def _update_group_settings_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/group/{groupId}/settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def view_group_settings(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have admin access to this group.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param group_id: The group ID. The `API_KEY` must have admin access to this group. (required)
        :type group_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._view_group_settings_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_group_settings_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have admin access to this group.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_group_settings_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="The group ID. The `API_KEY` must have admin access to this group.")],
        _request_timeout: Union[
            None,
    ...
    def _view_group_settings_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
