...
class DependenciesApi:
    ...
    def list_all_dependencies(
        ...
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to fetch.")] = None,
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to fetch per page (maximum is 1000).")] = None,
        list_all_dependencies_request: Optional[ListAllDependenciesRequest] = None,
        ...
        :type per_page: float
        :param list_all_dependencies_request:
        :type list_all_dependencies_request: ListAllDependenciesRequest
        ...
        _param = self._list_all_dependencies_serialize(
            org_id=org_id,
            sort_by=sort_by,
            order=order,
            page=page,
            per_page=per_page,
            list_all_dependencies_request=list_all_dependencies_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAllDependencies200Response",
        }
    ...
    @validate_call
    def list_all_dependencies_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list projects for. The `API_KEY` must have access to this organization.")],
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort results by.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results by.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAllDependencies200Response]:
        """List all dependencies
    ...
    @validate_call
    def list_all_dependencies_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list projects for. The `API_KEY` must have access to this organization.")],
        sort_by: Annotated[Optional[StrictStr], Field(description="The field to sort results by.")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results by.")] = None,
    ...
    def _list_all_dependencies_serialize(
        self,
        org_id,
        sort_by,
        order,
        ...
        if list_all_dependencies_request is not None:
            _body_params = list_all_dependencies_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/dependencies',
