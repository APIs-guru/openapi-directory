...
class EntitlementsApi:
    ...
    @validate_call
    def get_an_organizations_entitlement_value(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to query the entitlement for. The `API_KEY` must have access to this organization.")],
        entitlement_key: Annotated[StrictStr, Field(description="The entitlement to query.")],
        ...
        :param org_id: The organization ID to query the entitlement for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param entitlement_key: The entitlement to query. (required)
        ...
        _param = self._get_an_organizations_entitlement_value_serialize(
            org_id=org_id,
    ...
    @validate_call
    def get_an_organizations_entitlement_value_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to query the entitlement for. The `API_KEY` must have access to this organization.")],
        entitlement_key: Annotated[StrictStr, Field(description="The entitlement to query.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_an_organizations_entitlement_value_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to query the entitlement for. The `API_KEY` must have access to this organization.")],
        entitlement_key: Annotated[StrictStr, Field(description="The entitlement to query.")],
        _request_timeout: Union[
    ...
    def _get_an_organizations_entitlement_value_serialize(
        self,
        org_id,
        entitlement_key,
        _request_auth,
        ...
        if entitlement_key is not None:
            _path_params['entitlementKey'] = entitlement_key
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/entitlement/{entitlementKey}',
    ...
    def list_all_entitlements(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list entitlements for. The `API_KEY` must have access to this organization.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param org_id: The organization ID to list entitlements for. The `API_KEY` must have access to this organization. (required)
        :type org_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_all_entitlements_serialize(
            org_id=org_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_all_entitlements_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list entitlements for. The `API_KEY` must have access to this organization.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_all_entitlements_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The organization ID to list entitlements for. The `API_KEY` must have access to this organization.")],
        _request_timeout: Union[
            None,
    ...
    def _list_all_entitlements_serialize(
        self,
        org_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/entitlements',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
