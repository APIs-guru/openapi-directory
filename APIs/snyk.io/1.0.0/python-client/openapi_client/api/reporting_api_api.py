...
class ReportingAPIApi:
    ...
    def get_issue_counts(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        get_issue_counts_request: Optional[GetIssueCountsRequest] = None,
        ...
        :param var_from: The date you wish to fetch results from, in the format `YYYY-MM-DD` (required)
        :type var_from: str
        ...
        :type group_by: str
        :param get_issue_counts_request:
        :type get_issue_counts_request: GetIssueCountsRequest
        ...
        _param = self._get_issue_counts_serialize(
            var_from=var_from,
            to=to,
            group_by=group_by,
            get_issue_counts_request=get_issue_counts_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetIssueCounts200Response",
            '400': "GetIssueCounts400Response",
        }
    ...
    @validate_call
    def get_issue_counts_with_http_info(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetIssueCounts200Response]:
        """Get issue counts
    ...
    @validate_call
    def get_issue_counts_without_preload_content(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
    ...
    def _get_issue_counts_serialize(
        self,
        var_from,
        to,
        group_by,
        get_issue_counts_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if get_issue_counts_request is not None:
            _body_params = get_issue_counts_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/counts/issues',
    ...
    def get_latest_issue_counts(
        ...
        _param = self._get_latest_issue_counts_serialize(
            group_by=group_by,
            get_issue_counts_request=get_issue_counts_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_latest_issue_counts_with_http_info(
        self,
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        get_issue_counts_request: Optional[GetIssueCountsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_latest_issue_counts_without_preload_content(
        self,
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        get_issue_counts_request: Optional[GetIssueCountsRequest] = None,
        _request_timeout: Union[
    ...
    def _get_latest_issue_counts_serialize(
        self,
        group_by,
        get_issue_counts_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/counts/issues/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_latest_project_counts(
        self,
        get_project_counts_request: Optional[GetProjectCountsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param get_project_counts_request:
        :type get_project_counts_request: GetProjectCountsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_latest_project_counts_serialize(
            get_project_counts_request=get_project_counts_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProjectCounts200Response",
            '400': "GetIssueCounts400Response",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_latest_project_counts_with_http_info(
        self,
        get_project_counts_request: Optional[GetProjectCountsRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProjectCounts200Response]:
        """Get latest project counts
    ...
    @validate_call
    def get_latest_project_counts_without_preload_content(
        self,
        get_project_counts_request: Optional[GetProjectCountsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_latest_project_counts_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if get_project_counts_request is not None:
            _body_params = get_project_counts_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/counts/projects/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_list_of_issues(
        ...
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request")] = None,
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return per page (Maximum: 1000)")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The key to sort results by")] = None,
        order: Annotated[Optional[StrictStr], Field(description="The direction to sort results.")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Set to issue to group the same issue in multiple projects")] = None,
        get_list_of_issues_request: Optional[GetListOfIssuesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type group_by: str
        :param get_list_of_issues_request:
        :type get_list_of_issues_request: GetListOfIssuesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_list_of_issues_serialize(
            var_from=var_from,
            to=to,
            page=page,
            per_page=per_page,
            ...
            order=order,
            group_by=group_by,
            get_list_of_issues_request=get_list_of_issues_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetListOfIssues200Response",
            '400': "GetIssueCounts400Response",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_list_of_issues_with_http_info(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetListOfIssues200Response]:
        """Get list of issues
    ...
    @validate_call
    def get_list_of_issues_without_preload_content(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request")] = None,
    ...
    def _get_list_of_issues_serialize(
        self,
        var_from,
        to,
        page,
        ...
        # process the form parameters
        # process the body parameter
        if get_list_of_issues_request is not None:
            _body_params = get_list_of_issues_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/issues/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_list_of_latest_issues(
        ...
        _param = self._get_list_of_latest_issues_serialize(
            page=page,
            per_page=per_page,
            sort_by=sort_by,
            order=order,
    ...
    @validate_call
    def get_list_of_latest_issues_with_http_info(
        self,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request")] = None,
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return per page (Maximum: 1000)")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The key to sort results by")] = None,
    ...
    @validate_call
    def get_list_of_latest_issues_without_preload_content(
        self,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page of results to request")] = None,
        per_page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to return per page (Maximum: 1000)")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="The key to sort results by")] = None,
    ...
    def _get_list_of_latest_issues_serialize(
        self,
        page,
        per_page,
        sort_by,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/issues/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_project_counts(
        ...
        _param = self._get_project_counts_serialize(
            var_from=var_from,
            to=to,
            get_project_counts_request=get_project_counts_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_project_counts_with_http_info(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        get_project_counts_request: Optional[GetProjectCountsRequest] = None,
    ...
    @validate_call
    def get_project_counts_without_preload_content(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to fetch results from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to fetch results until, in the format `YYYY-MM-DD`")],
        get_project_counts_request: Optional[GetProjectCountsRequest] = None,
    ...
    def _get_project_counts_serialize(
        self,
        var_from,
        to,
        get_project_counts_request,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/counts/projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_test_counts(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to count tests from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to count tests until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        get_test_counts_request: Optional[GetTestCountsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: The date you wish to count tests from, in the format `YYYY-MM-DD` (required)
        :type var_from: str
        :param to: The date you wish to count tests until, in the format `YYYY-MM-DD` (required)
        :type to: str
        :param group_by: The field to group results by
        :type group_by: str
        :param get_test_counts_request:
        :type get_test_counts_request: GetTestCountsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_test_counts_serialize(
            var_from=var_from,
            to=to,
            group_by=group_by,
            get_test_counts_request=get_test_counts_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_test_counts_with_http_info(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to count tests from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to count tests until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTestCounts200Response]:
        """Get test counts
    ...
    @validate_call
    def get_test_counts_without_preload_content(
        self,
        var_from: Annotated[StrictStr, Field(description="The date you wish to count tests from, in the format `YYYY-MM-DD`")],
        to: Annotated[StrictStr, Field(description="The date you wish to count tests until, in the format `YYYY-MM-DD`")],
        group_by: Annotated[Optional[StrictStr], Field(description="The field to group results by")] = None,
    ...
    def _get_test_counts_serialize(
        self,
        var_from,
        to,
        group_by,
        get_test_counts_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_test_counts_request is not None:
            _body_params = get_test_counts_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reporting/counts/tests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
