...
class ImportTargetsRequest(BaseModel):
    ...
    # data type: ImportTargetsRequestAnyOf
    anyof_schema_1_validator: Optional[ImportTargetsRequestAnyOf] = None
    # data type: ImportTargetsRequestAnyOf1
    anyof_schema_2_validator: Optional[ImportTargetsRequestAnyOf1] = None
    # data type: ImportTargetsRequestAnyOf2
    anyof_schema_3_validator: Optional[ImportTargetsRequestAnyOf2] = None
    # data type: ImportTargetsRequestAnyOf3
    anyof_schema_4_validator: Optional[ImportTargetsRequestAnyOf3] = None
    # data type: ImportTargetsRequestAnyOf4
    anyof_schema_5_validator: Optional[ImportTargetsRequestAnyOf4] = None
    # data type: ImportTargetsRequestAnyOf5
    anyof_schema_6_validator: Optional[ImportTargetsRequestAnyOf5] = None
    # data type: ImportTargetsRequestAnyOf6
    anyof_schema_7_validator: Optional[ImportTargetsRequestAnyOf6] = None
    # data type: ImportTargetsRequestAnyOf7
    anyof_schema_8_validator: Optional[ImportTargetsRequestAnyOf7] = None
    # data type: ImportTargetsRequestAnyOf8
    anyof_schema_9_validator: Optional[ImportTargetsRequestAnyOf8] = None
    # data type: ImportTargetsRequestAnyOf9
    anyof_schema_10_validator: Optional[ImportTargetsRequestAnyOf9] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ImportTargetsRequestAnyOf, ImportTargetsRequestAnyOf1, ImportTargetsRequestAnyOf2, ImportTargetsRequestAnyOf3, ImportTargetsRequestAnyOf4, ImportTargetsRequestAnyOf5, ImportTargetsRequestAnyOf6, ImportTargetsRequestAnyOf7, ImportTargetsRequestAnyOf8, ImportTargetsRequestAnyOf9]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ImportTargetsRequestAnyOf", "ImportTargetsRequestAnyOf1", "ImportTargetsRequestAnyOf2", "ImportTargetsRequestAnyOf3", "ImportTargetsRequestAnyOf4", "ImportTargetsRequestAnyOf5", "ImportTargetsRequestAnyOf6", "ImportTargetsRequestAnyOf7", "ImportTargetsRequestAnyOf8", "ImportTargetsRequestAnyOf9" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ImportTargetsRequest.model_construct()
        error_messages = []
        # validate data type: ImportTargetsRequestAnyOf
        if not isinstance(v, ImportTargetsRequestAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf1
        if not isinstance(v, ImportTargetsRequestAnyOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf1`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf2
        if not isinstance(v, ImportTargetsRequestAnyOf2):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf2`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf3
        if not isinstance(v, ImportTargetsRequestAnyOf3):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf3`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf4
        if not isinstance(v, ImportTargetsRequestAnyOf4):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf4`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf5
        if not isinstance(v, ImportTargetsRequestAnyOf5):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf5`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf6
        if not isinstance(v, ImportTargetsRequestAnyOf6):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf6`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf7
        if not isinstance(v, ImportTargetsRequestAnyOf7):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf7`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf8
        if not isinstance(v, ImportTargetsRequestAnyOf8):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf8`")
        else:
            return v

        # validate data type: ImportTargetsRequestAnyOf9
        if not isinstance(v, ImportTargetsRequestAnyOf9):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ImportTargetsRequestAnyOf9`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ImportTargetsRequest with anyOf schemas: ImportTargetsRequestAnyOf, ImportTargetsRequestAnyOf1, ImportTargetsRequestAnyOf2, ImportTargetsRequestAnyOf3, ImportTargetsRequestAnyOf4, ImportTargetsRequestAnyOf5, ImportTargetsRequestAnyOf6, ImportTargetsRequestAnyOf7, ImportTargetsRequestAnyOf8, ImportTargetsRequestAnyOf9. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[ImportTargetsRequestAnyOf] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[ImportTargetsRequestAnyOf1] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf1.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[ImportTargetsRequestAnyOf2] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf2.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[ImportTargetsRequestAnyOf3] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf3.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[ImportTargetsRequestAnyOf4] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf4.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_6_validator: Optional[ImportTargetsRequestAnyOf5] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf5.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_7_validator: Optional[ImportTargetsRequestAnyOf6] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf6.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_8_validator: Optional[ImportTargetsRequestAnyOf7] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf7.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_9_validator: Optional[ImportTargetsRequestAnyOf8] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf8.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_10_validator: Optional[ImportTargetsRequestAnyOf9] = None
        try:
            instance.actual_instance = ImportTargetsRequestAnyOf9.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ImportTargetsRequest with anyOf schemas: ImportTargetsRequestAnyOf, ImportTargetsRequestAnyOf1, ImportTargetsRequestAnyOf2, ImportTargetsRequestAnyOf3, ImportTargetsRequestAnyOf4, ImportTargetsRequestAnyOf5, ImportTargetsRequestAnyOf6, ImportTargetsRequestAnyOf7, ImportTargetsRequestAnyOf8, ImportTargetsRequestAnyOf9. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ImportTargetsRequestAnyOf, ImportTargetsRequestAnyOf1, ImportTargetsRequestAnyOf2, ImportTargetsRequestAnyOf3, ImportTargetsRequestAnyOf4, ImportTargetsRequestAnyOf5, ImportTargetsRequestAnyOf6, ImportTargetsRequestAnyOf7, ImportTargetsRequestAnyOf8, ImportTargetsRequestAnyOf9]]:
