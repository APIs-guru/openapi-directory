...
class AuthorizationValue(BaseModel):
    ...
    url_matcher: Optional[Dict[str, Any]] = Field(default=None, alias="urlMatcher")
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["keyName", "type", "urlMatcher", "value"]
