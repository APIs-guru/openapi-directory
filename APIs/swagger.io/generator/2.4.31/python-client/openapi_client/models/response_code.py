...
class ResponseCode(BaseModel):
    ...
    ResponseCode
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="File download code")
    link: Optional[StrictStr] = Field(default=None, description="URL for fetching the generated client")
