...
class TestMerchantsResponse(unittest.TestCase):
    """MerchantsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantsResponse:
        """Test MerchantsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantsResponse`
        """
        model = MerchantsResponse()
        if include_optional:
            return MerchantsResponse(
                merchants = openapi_client.models.merchants.Merchants(
                    merchant = [
    ...
    def testMerchantsResponse(self):
        """Test MerchantsResponse"""
