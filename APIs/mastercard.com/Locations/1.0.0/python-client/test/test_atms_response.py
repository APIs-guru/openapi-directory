...
class TestAtmsResponse(unittest.TestCase):
    """AtmsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AtmsResponse:
        """Test AtmsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AtmsResponse`
        """
        model = AtmsResponse()
        if include_optional:
            return AtmsResponse(
                atms = openapi_client.models.atms.Atms(
                    atm = [
