...
------------ | ------------- | ------------- | -------------
**code** | **str** | Three digit alpha country code as defined in ISO 3166-1. | [optional] 
**geocoding** | **bool** | Boolean which indicates if the country is geocoded. TRUE or FALSE | [optional] 
