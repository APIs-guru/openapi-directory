...
class TestGasWeeklyRecord(unittest.TestCase):
    """GasWeeklyRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GasWeeklyRecord:
        """Test GasWeeklyRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GasWeeklyRecord`
        """
        model = GasWeeklyRecord()
        if include_optional:
