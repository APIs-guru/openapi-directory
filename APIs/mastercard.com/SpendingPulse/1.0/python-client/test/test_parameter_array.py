...
class TestParameterArray(unittest.TestCase):
    """ParameterArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParameterArray:
        """Test ParameterArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParameterArray`
        """
        model = ParameterArray()
        if include_optional:
