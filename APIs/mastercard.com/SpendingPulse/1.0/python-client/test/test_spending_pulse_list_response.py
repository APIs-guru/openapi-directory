...
class TestSpendingPulseListResponse(unittest.TestCase):
    """SpendingPulseListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpendingPulseListResponse:
        """Test SpendingPulseListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpendingPulseListResponse`
        """
        model = SpendingPulseListResponse()
        if include_optional:
            return SpendingPulseListResponse(
                spending_pulse_list = openapi_client.models.spending_pulse_list.SpendingPulseList(
                    count = '100', 
                    message = 'Success', 
                    spending_pulse_array = openapi_client.models.spending_pulse_array.SpendingPulseArray(
    ...
    def testSpendingPulseListResponse(self):
        """Test SpendingPulseListResponse"""
