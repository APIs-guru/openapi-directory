...
class TestSpendingPulseArray(unittest.TestCase):
    """SpendingPulseArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpendingPulseArray:
        """Test SpendingPulseArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpendingPulseArray`
        """
        model = SpendingPulseArray()
        if include_optional:
            return SpendingPulseArray(
                spending_pulse_record = [
                    openapi_client.models.spending_pulse_record.SpendingPulseRecord(
                        country = 'UK', 
    ...
    def testSpendingPulseArray(self):
        """Test SpendingPulseArray"""
