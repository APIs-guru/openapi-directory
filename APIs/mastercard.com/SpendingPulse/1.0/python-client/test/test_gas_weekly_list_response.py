...
class TestGasWeeklyListResponse(unittest.TestCase):
    """GasWeeklyListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GasWeeklyListResponse:
        """Test GasWeeklyListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GasWeeklyListResponse`
        """
        model = GasWeeklyListResponse()
        if include_optional:
            return GasWeeklyListResponse(
                gas_weekly_list = openapi_client.models.gas_weekly_list.GasWeeklyList(
                    count = '100', 
                    gas_weekly_array = openapi_client.models.gas_weekly_array.GasWeeklyArray(
                        gas_weekly_record = [
    ...
    def testGasWeeklyListResponse(self):
        """Test GasWeeklyListResponse"""
