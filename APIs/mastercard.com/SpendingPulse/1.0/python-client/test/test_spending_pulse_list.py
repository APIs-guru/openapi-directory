...
class TestSpendingPulseList(unittest.TestCase):
    """SpendingPulseList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpendingPulseList:
        """Test SpendingPulseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpendingPulseList`
        """
        model = SpendingPulseList()
        if include_optional:
    ...
    def testSpendingPulseList(self):
        """Test SpendingPulseList"""
