...
class Subscription(BaseModel):
    ...
    sector: Optional[StrictStr] = Field(default=None, description="Sector name.", alias="Sector")
    __properties: ClassVar[List[str]] = ["Country", "Ecomm", "Period", "ReportType", "Sector"]
