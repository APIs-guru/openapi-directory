...
class ParametersApi:
    ...
    def parameters_get(
        ...
        _param = self._parameters_get_serialize(
    ...
    @validate_call
    def parameters_get_with_http_info(
        self,
        current_row: Annotated[Optional[StrictStr], Field(description="Starting record number to return.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Used to restrict the number of records returned if needed to be less than max.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ParameterListResponse]:
        """Returns a distinct list of all reports are available and that one is subscribed to.
    ...
    @validate_call
    def parameters_get_without_preload_content(
        self,
        current_row: Annotated[Optional[StrictStr], Field(description="Starting record number to return.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Used to restrict the number of records returned if needed to be less than max.")] = None,
        _request_timeout: Union[
