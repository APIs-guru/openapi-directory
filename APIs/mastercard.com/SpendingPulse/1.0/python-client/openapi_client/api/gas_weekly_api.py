...
class GasWeeklyApi:
    ...
    def gasweekly_get(
        ...
        _param = self._gasweekly_get_serialize(
    ...
    @validate_call
    def gasweekly_get_with_http_info(
        self,
        current_row: Annotated[Optional[StrictStr], Field(description="Starting record number to return.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Used to restrict the number of records returned if needed to be less than max.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GasWeeklyListResponse]:
        """Returns the weekly gasoline report. This resource pulls back the report with ProductLine = \"US Weekly Gasoline Demand Report\". Keep in mind that you must be subscribed to the gasoline weekly report to be able to receive data back from this resource.
    ...
    @validate_call
    def gasweekly_get_without_preload_content(
        self,
        current_row: Annotated[Optional[StrictStr], Field(description="Starting record number to return.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Used to restrict the number of records returned if needed to be less than max.")] = None,
        _request_timeout: Union[
