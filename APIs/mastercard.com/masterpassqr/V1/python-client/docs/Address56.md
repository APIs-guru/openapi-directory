...
address56_instance = Address56.from_json(json)
# print the JSON string representation of the object
print(Address56.to_json())

# convert the object into a dict
address56_dict = address56_instance.to_dict()
# create an instance of Address56 from a dict
address56_from_dict = Address56.from_dict(address56_dict)
```
