...
json = "{}"
# create an instance of CustomField116 from a JSON string
custom_field116_instance = CustomField116.from_json(json)
# print the JSON string representation of the object
print(CustomField116.to_json())

# convert the object into a dict
custom_field116_dict = custom_field116_instance.to_dict()
# create an instance of CustomField116 from a dict
custom_field116_from_dict = CustomField116.from_dict(custom_field116_dict)
```
