...
json = "{}"
# create an instance of Address95 from a JSON string
address95_instance = Address95.from_json(json)
# print the JSON string representation of the object
print(Address95.to_json())

# convert the object into a dict
address95_dict = address95_instance.to_dict()
# create an instance of Address95 from a dict
address95_from_dict = Address95.from_dict(address95_dict)
```
