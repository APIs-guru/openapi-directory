...
**participant** | [**Participant53**](Participant53.md) |  | [optional] 
...
**payment_origination_country** | **str** | Country where the payment originated from as an ISO 3166-1 alpha-3 country code, in upper case.   Type: Alpha [A-Z], Maximum Length: 3 | [optional] 
...
**recipient** | [**Recipient43**](Recipient43.md) |  | [optional] 
...
**reconciliation_data** | [**ReconciliationData51**](ReconciliationData51.md) |  | [optional] 
...
**sender** | [**Sender41**](Sender41.md) |  | [optional] 
...
**transaction_history** | [**TransactionHistory47**](TransactionHistory47.md) |  | [optional] 
...
**transfer_amount** | [**TransferAmount46**](TransferAmount46.md) |  | [optional] 
...
merchant_transfer40_instance = MerchantTransfer40.from_json(json)
# print the JSON string representation of the object
print(MerchantTransfer40.to_json())

# convert the object into a dict
merchant_transfer40_dict = merchant_transfer40_instance.to_dict()
# create an instance of MerchantTransfer40 from a dict
merchant_transfer40_from_dict = MerchantTransfer40.from_dict(merchant_transfer40_dict)
```
