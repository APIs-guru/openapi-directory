...
------------ | ------------- | ------------- | -------------
**additional_merchant_data** | [**AdditionalMerchantData77**](AdditionalMerchantData77.md) |  | [optional] 
**address** | [**Address76**](Address76.md) |  | [optional] 
...
json = "{}"
# create an instance of Recipient75 from a JSON string
recipient75_instance = Recipient75.from_json(json)
# print the JSON string representation of the object
print(Recipient75.to_json())

# convert the object into a dict
recipient75_dict = recipient75_instance.to_dict()
# create an instance of Recipient75 from a dict
recipient75_from_dict = Recipient75.from_dict(recipient75_dict)
```
