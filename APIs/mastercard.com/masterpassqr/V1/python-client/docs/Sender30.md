...
sender30_instance = Sender30.from_json(json)
# print the JSON string representation of the object
print(Sender30.to_json())

# convert the object into a dict
sender30_dict = sender30_instance.to_dict()
# create an instance of Sender30 from a dict
sender30_from_dict = Sender30.from_dict(sender30_dict)
```
