...
token_cryptogram103_instance = TokenCryptogram103.from_json(json)
# print the JSON string representation of the object
print(TokenCryptogram103.to_json())

# convert the object into a dict
token_cryptogram103_dict = token_cryptogram103_instance.to_dict()
# create an instance of TokenCryptogram103 from a dict
token_cryptogram103_from_dict = TokenCryptogram103.from_dict(token_cryptogram103_dict)
```
