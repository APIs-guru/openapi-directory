...
**payment_type** | **str** | Payment type used for transfer. Valid values - P2M: Person to Merchant. | [optional] 
...
**reconciliation_data** | [**ReconciliationData157**](ReconciliationData157.md) |  | [optional] 
...
**transaction_history** | [**TransactionHistory153**](TransactionHistory153.md) |  | [optional] 
**transfer_amount** | [**TransferAmount152**](TransferAmount152.md) |  | [optional] 
...
json = "{}"
# create an instance of Transfer145 from a JSON string
transfer145_instance = Transfer145.from_json(json)
# print the JSON string representation of the object
print(Transfer145.to_json())

# convert the object into a dict
transfer145_dict = transfer145_instance.to_dict()
# create an instance of Transfer145 from a dict
transfer145_from_dict = Transfer145.from_dict(transfer145_dict)
```
