...
json = "{}"
# create an instance of Address106 from a JSON string
address106_instance = Address106.from_json(json)
# print the JSON string representation of the object
print(Address106.to_json())

# convert the object into a dict
address106_dict = address106_instance.to_dict()
# create an instance of Address106 from a dict
address106_from_dict = Address106.from_dict(address106_dict)
```
