...
custom_field84_instance = CustomField84.from_json(json)
# print the JSON string representation of the object
print(CustomField84.to_json())

# convert the object into a dict
custom_field84_dict = custom_field84_instance.to_dict()
# create an instance of CustomField84 from a dict
custom_field84_from_dict = CustomField84.from_dict(custom_field84_dict)
```
