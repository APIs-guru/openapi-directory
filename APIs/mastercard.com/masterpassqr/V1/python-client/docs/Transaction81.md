...
**transaction_amount** | [**TransactionAmount82**](TransactionAmount82.md) |  | [optional] 
...
transaction81_instance = Transaction81.from_json(json)
# print the JSON string representation of the object
print(Transaction81.to_json())

# convert the object into a dict
transaction81_dict = transaction81_instance.to_dict()
# create an instance of Transaction81 from a dict
transaction81_from_dict = Transaction81.from_dict(transaction81_dict)
```
