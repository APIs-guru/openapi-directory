...
**country** | **str** | The recipient&#39;&#39;s/merchant&#39;&#39;s home country as an ISO 3166-1 alpha-3 country code.   Type: Alpha [A-Z], Length: 3 | 
...
**postal_code** | **str** | Postal code of the receipent.   Type: Alphanumeric Special [a-zA-Z0-9- ], Length: 1-10 | [optional] 
...
json = "{}"
# create an instance of Address8 from a JSON string
address8_instance = Address8.from_json(json)
# print the JSON string representation of the object
print(Address8.to_json())

# convert the object into a dict
address8_dict = address8_instance.to_dict()
# create an instance of Address8 from a dict
address8_from_dict = Address8.from_dict(address8_dict)
```
