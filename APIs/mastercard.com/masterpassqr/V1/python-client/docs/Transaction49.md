...
**transaction_amount** | [**TransactionAmount50**](TransactionAmount50.md) |  | [optional] 
...
transaction49_instance = Transaction49.from_json(json)
# print the JSON string representation of the object
print(Transaction49.to_json())

# convert the object into a dict
transaction49_dict = transaction49_instance.to_dict()
# create an instance of Transaction49 from a dict
transaction49_from_dict = Transaction49.from_dict(transaction49_dict)
```
