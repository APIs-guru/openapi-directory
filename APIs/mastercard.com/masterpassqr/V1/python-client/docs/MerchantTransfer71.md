...
**recipient_account_uri** | **str** | URI describing the recipient/merchant account. It will include masked account information (e.g. \&quot;************1234\&quot; for a card account) but will not include security codes (e.g. CVC or expiration date for a card account). | [optional] 
**reconciliation_data** | [**ReconciliationData83**](ReconciliationData83.md) |  | [optional] 
...
**transaction_history** | [**TransactionHistory79**](TransactionHistory79.md) |  | [optional] 
...
**transfer_amount** | [**TransferAmount78**](TransferAmount78.md) |  | [optional] 
...
json = "{}"
# create an instance of MerchantTransfer71 from a JSON string
merchant_transfer71_instance = MerchantTransfer71.from_json(json)
# print the JSON string representation of the object
print(MerchantTransfer71.to_json())

# convert the object into a dict
merchant_transfer71_dict = merchant_transfer71_instance.to_dict()
# create an instance of MerchantTransfer71 from a dict
merchant_transfer71_from_dict = MerchantTransfer71.from_dict(merchant_transfer71_dict)
```
