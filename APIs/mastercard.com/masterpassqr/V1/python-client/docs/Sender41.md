...
sender41_instance = Sender41.from_json(json)
# print the JSON string representation of the object
print(Sender41.to_json())

# convert the object into a dict
sender41_dict = sender41_instance.to_dict()
# create an instance of Sender41 from a dict
sender41_from_dict = Sender41.from_dict(sender41_dict)
```
