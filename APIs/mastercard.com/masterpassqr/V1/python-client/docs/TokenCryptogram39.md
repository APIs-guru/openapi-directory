...
token_cryptogram39_instance = TokenCryptogram39.from_json(json)
# print the JSON string representation of the object
print(TokenCryptogram39.to_json())

# convert the object into a dict
token_cryptogram39_dict = token_cryptogram39_instance.to_dict()
# create an instance of TokenCryptogram39 from a dict
token_cryptogram39_from_dict = TokenCryptogram39.from_dict(token_cryptogram39_dict)
```
