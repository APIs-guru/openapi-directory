...
class TestTransaction24(unittest.TestCase):
    """Transaction24 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transaction24:
        """Test Transaction24
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transaction24`
        """
        model = Transaction24()
        if include_optional:
            return Transaction24(
