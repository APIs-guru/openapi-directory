...
class TestTransfer145(unittest.TestCase):
    """Transfer145 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transfer145:
        """Test Transfer145
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transfer145`
        """
        model = Transfer145()
        if include_optional:
            return Transfer145(
