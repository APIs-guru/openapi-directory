...
class TestData154(unittest.TestCase):
    """Data154 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Data154:
        """Test Data154
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Data154`
        """
        model = Data154()
        if include_optional:
            return Data154(
