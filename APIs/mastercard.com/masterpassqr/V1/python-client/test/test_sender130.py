...
class TestSender130(unittest.TestCase):
    """Sender130 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Sender130:
        """Test Sender130
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sender130`
        """
        model = Sender130()
        if include_optional:
            return Sender130(
