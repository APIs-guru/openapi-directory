...
class TestTransaction81(unittest.TestCase):
    """Transaction81 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transaction81:
        """Test Transaction81
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transaction81`
        """
        model = Transaction81()
        if include_optional:
            return Transaction81(
