...
class TestTransaction140(unittest.TestCase):
    """Transaction140 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transaction140:
        """Test Transaction140
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transaction140`
        """
        model = Transaction140()
        if include_optional:
            return Transaction140(
