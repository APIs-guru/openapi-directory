...
class FundingApi:
    ...
    def create_funding(
        ...
        funding_transfer: Annotated[Optional[FundingTransfer118Wrapper], Field(description="Contains the details of the request message.")] = None,
        ...
        :type funding_transfer: FundingTransfer118Wrapper
        ...
        _param = self._create_funding_serialize(
    ...
    @validate_call
    def create_funding_with_http_info(
        self,
        partner_id: Annotated[StrictStr, Field(description="Path Param - Provider assigned partner id. Details - string, 32")],
        funding_transfer: Annotated[Optional[FundingTransfer118Wrapper], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Transfer129Wrapper]:
        """The Funding Transaction enables the 'pull' of money from the sender's card to the Transaction Originator who is providing the Person to Merchant service. The amount that is debited from the Funding Account (sending consumer's account) will be the amount 'pushed' to the recipient via a payment transfer request.  Funds can be transferred from Mastercard® or Maestro® debit card accounts. To initiate the funding transaction, users can provide the sending consumer's Primary Account Number (PAN) or a unique identifier previously mapped to the sending consumer's account.
    ...
    @validate_call
    def create_funding_without_preload_content(
        self,
        partner_id: Annotated[StrictStr, Field(description="Path Param - Provider assigned partner id. Details - string, 32")],
        funding_transfer: Annotated[Optional[FundingTransfer118Wrapper], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
    ...
    def _create_funding_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/send/v1/partners/{partnerId}/transfers/funding',
