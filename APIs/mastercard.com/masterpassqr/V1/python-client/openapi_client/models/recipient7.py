...
class Recipient7(BaseModel):
    """
    Information about the recipient/merchant of the transaction.
    """ # noqa: E501
    additional_merchant_data: Optional[AdditionalMerchantData9] = None
    address: Address8
    ...
    merchant_category_code: StrictStr = Field(description="Mastercard defined merchant category code. This identifies the type of business of the recipient/merchant. This merchant category code should match valid code set by Mastercard rules.   Type: Numeric [0-9], Length: 1-4")
    middle_name: Optional[StrictStr] = Field(default=None, description="Middle name of the recipient/merchant.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./\\:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÚÚÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], Length: 1-40")
    phone: Optional[StrictStr] = Field(default=None, description="Phone number of the recipient/merchant, Country code can be included.   Type: Numeric [0-9], Length: 1-15")
    token_cryptogram: Optional[TokenCryptogram10] = None
    __properties: ClassVar[List[str]] = ["additional_merchant_data", "address", "authentication_value", "email", "first_name", "last_name", "merchant_category_code", "middle_name", "phone", "token_cryptogram"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additional_merchant_data": AdditionalMerchantData9.from_dict(obj["additional_merchant_data"]) if obj.get("additional_merchant_data") is not None else None,
            "address": Address8.from_dict(obj["address"]) if obj.get("address") is not None else None,
            ...
            "phone": obj.get("phone"),
            "token_cryptogram": TokenCryptogram10.from_dict(obj["token_cryptogram"]) if obj.get("token_cryptogram") is not None else None
        })
        return _obj
