...
class MerchantTransfer71(BaseModel):
    """
    ...
    digital_account_reference_number: Optional[StrictStr] = Field(default=None, description="Reference number identifying the digital account reference number. Details- Numeric, Length 1-20")
    funding_source: Optional[StrictStr] = Field(default=None, description="Funding source must contain one of the following: CREDIT, DEBIT, PREPAID, DEPOSIT_ACCOUNT, MOBILE_MONEY_ACCOUNT, CASH. ")
    ...
    participant: Optional[Participant85] = None
    ...
    recipient: Optional[Recipient75] = None
    recipient_account_uri: Optional[StrictStr] = Field(default=None, description="URI describing the recipient/merchant account. It will include masked account information (e.g. \"************1234\" for a card account) but will not include security codes (e.g. CVC or expiration date for a card account).")
    reconciliation_data: Optional[ReconciliationData83] = None
    ...
    transaction_history: Optional[TransactionHistory79] = None
    ...
    transfer_amount: Optional[TransferAmount78] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participant": Participant85.from_dict(obj["participant"]) if obj.get("participant") is not None else None,
            ...
            "recipient": Recipient75.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "recipient_account_uri": obj.get("recipient_account_uri"),
            "reconciliation_data": ReconciliationData83.from_dict(obj["reconciliation_data"]) if obj.get("reconciliation_data") is not None else None,
            "resource_type": obj.get("resource_type"),
            "routing_transit_number": obj.get("routing_transit_number"),
            "sender": Sender72.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            "sender_account_uri": obj.get("sender_account_uri"),
            "status": obj.get("status"),
            "status_timestamp": obj.get("status_timestamp"),
            "transaction_history": TransactionHistory79.from_dict(obj["transaction_history"]) if obj.get("transaction_history") is not None else None,
            "transaction_local_date_time": obj.get("transaction_local_date_time"),
            "transfer_amount": TransferAmount78.from_dict(obj["transfer_amount"]) if obj.get("transfer_amount") is not None else None,
