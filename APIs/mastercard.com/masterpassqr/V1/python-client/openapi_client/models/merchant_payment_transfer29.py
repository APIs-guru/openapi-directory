...
class MerchantPaymentTransfer29(BaseModel):
    """
    ...
    funding_transaction_reference: Optional[FundingTransactionReference38] = None
    ...
    mastercard_assigned_id: Optional[StrictStr] = Field(default=None, description="Mastercard Assigned ID for tiered interchange calculations. \\n\\nType: Numeric [0-9], Length: 6")
    participant: Optional[Participant37] = None
    ...
    payment_type: StrictStr = Field(description="P2M: Person to Merchant")
    ...
    recipient_account_uri: StrictStr = Field(description="URI to identify the account of the recipient/merchant. When PAN is the URI then recipient/merchant information is required. Pan, Manual Entry Alias and Alias are valid schemas. Valid Values- Refer 'Account URIs'")
    reconciliation_data: Optional[ReconciliationData35] = None
    ...
    token_cryptogram: Optional[TokenCryptogram39] = None
    transaction_local_date_time: StrictStr = Field(description="Local date and time when the transaction is submitted. Details-YYYY-MM-DDTHH:MM:SS±hh[:mm] ")
    ...
    __properties: ClassVar[List[str]] = ["additional_message", "amount", "authentication_value", "channel", "convenience_amount", "convenience_indicator", "currency", "device_id", "digital_account_reference_number", "funding_source", "funding_transaction_reference", "interchange_rate_designator", "location", "mastercard_assigned_id", "participant", "participation_id", "payment_origination_country", "payment_type", "processor_id", "qr_data", "recipient", "recipient_account_uri", "reconciliation_data", "routing_transit_number", "sender", "sender_account_uri", "token_cryptogram", "transaction_local_date_time", "transfer_reference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of funding_transaction_reference
        if self.funding_transaction_reference:
            _dict['funding_transaction_reference'] = self.funding_transaction_reference.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "funding_transaction_reference": FundingTransactionReference38.from_dict(obj["funding_transaction_reference"]) if obj.get("funding_transaction_reference") is not None else None,
            ...
            "participant": Participant37.from_dict(obj["participant"]) if obj.get("participant") is not None else None,
            ...
            "recipient": Recipient32.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "recipient_account_uri": obj.get("recipient_account_uri"),
            "reconciliation_data": ReconciliationData35.from_dict(obj["reconciliation_data"]) if obj.get("reconciliation_data") is not None else None,
            "routing_transit_number": obj.get("routing_transit_number"),
            "sender": Sender30.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            "sender_account_uri": obj.get("sender_account_uri"),
            "token_cryptogram": TokenCryptogram39.from_dict(obj["token_cryptogram"]) if obj.get("token_cryptogram") is not None else None,
