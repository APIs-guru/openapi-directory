...
class NotificationRequest163(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipient": Recipient165.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "recipient_account_uri": obj.get("recipient_account_uri"),
            "transaction_amount": TransactionAmount164.from_dict(obj["transaction_amount"]) if obj.get("transaction_amount") is not None else None,
