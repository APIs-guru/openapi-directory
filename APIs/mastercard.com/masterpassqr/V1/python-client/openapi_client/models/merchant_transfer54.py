...
class MerchantTransfer54(BaseModel):
    """
    ...
    participant: Optional[Participant68] = None
    ...
    recipient: Optional[Recipient58] = None
    ...
    reconciliation_data: Optional[ReconciliationData66] = None
    ...
    transaction_history: Optional[TransactionHistory62] = None
    ...
    transfer_amount: Optional[TransferAmount61] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participant": Participant68.from_dict(obj["participant"]) if obj.get("participant") is not None else None,
            ...
            "recipient": Recipient58.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "recipient_account_uri": obj.get("recipient_account_uri"),
            "reconciliation_data": ReconciliationData66.from_dict(obj["reconciliation_data"]) if obj.get("reconciliation_data") is not None else None,
            "resource_type": obj.get("resource_type"),
            "routing_transit_number": obj.get("routing_transit_number"),
            "sender": Sender55.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            "sender_account_uri": obj.get("sender_account_uri"),
            "status": obj.get("status"),
            "status_timestamp": obj.get("status_timestamp"),
            "transaction_history": TransactionHistory62.from_dict(obj["transaction_history"]) if obj.get("transaction_history") is not None else None,
            "transaction_local_date_time": obj.get("transaction_local_date_time"),
            "transfer_amount": TransferAmount61.from_dict(obj["transfer_amount"]) if obj.get("transfer_amount") is not None else None,
