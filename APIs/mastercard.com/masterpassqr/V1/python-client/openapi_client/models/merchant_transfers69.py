...
class MerchantTransfers69(BaseModel):
    """
    Response details for a merchant transfer.
    """ # noqa: E501
    data: Optional[Data70] = None
    item_count: Optional[StrictInt] = Field(default=None, description="Number of Transactions in the list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Data70.from_dict(obj["data"]) if obj.get("data") is not None else None,
