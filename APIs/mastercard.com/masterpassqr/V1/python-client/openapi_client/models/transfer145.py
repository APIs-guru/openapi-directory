...
class Transfer145(BaseModel):
    ...
    payment_type: Optional[StrictStr] = Field(default=None, description="Payment type used for transfer. Valid values - P2M: Person to Merchant.")
    recipient: Optional[Recipient149] = None
    ...
    reconciliation_data: Optional[ReconciliationData157] = None
    ...
    sender: Optional[Sender146] = None
    ...
    transaction_history: Optional[TransactionHistory153] = None
    transfer_amount: Optional[TransferAmount152] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipient": Recipient149.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "recipient_account_uri": obj.get("recipient_account_uri"),
            "reconciliation_data": ReconciliationData157.from_dict(obj["reconciliation_data"]) if obj.get("reconciliation_data") is not None else None,
            "resource_type": obj.get("resource_type"),
            "sanction_screening_override": obj.get("sanction_screening_override"),
            "sender": Sender146.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            ...
            "transaction_history": TransactionHistory153.from_dict(obj["transaction_history"]) if obj.get("transaction_history") is not None else None,
            "transfer_amount": TransferAmount152.from_dict(obj["transfer_amount"]) if obj.get("transfer_amount") is not None else None,
