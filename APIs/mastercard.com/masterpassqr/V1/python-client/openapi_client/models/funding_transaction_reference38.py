...
class FundingTransactionReference38(BaseModel):
    """
    ...
    """ # noqa: E501
    network: Optional[StrictStr] = Field(default=None, description="Network on which funding transaction is processed required. Valid values will be provided during partner onboarding.")
    reference_number: StrictStr = Field(description="Provide the id from the funding transfer resource.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 * , - . _ ~ ], Length: 1-19")
