...
class TokenCryptogram6(BaseModel):
    """
    ...
    value: StrictStr = Field(description="CONTACTLESS_CHIP - Type: Hexadecimal [A-F0-9], Length: 2-510  CONTACTLESS_MAGSTRIPE - Type: Hexadecimal [A-F0-9], Length: 2-510  DSRP_UCAF - Type: Base64 [A-Za-z0-9+/=?:], Length: 1-510  DSRP_CHIP - Type: Hexadecimal [A-F0-9], Length: 2-510")
