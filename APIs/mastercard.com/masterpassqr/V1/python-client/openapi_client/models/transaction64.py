...
class Transaction64(BaseModel):
    ...
    transaction_amount: Optional[TransactionAmount65] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transaction_amount": TransactionAmount65.from_dict(obj["transaction_amount"]) if obj.get("transaction_amount") is not None else None,
            "type": obj.get("type"),
