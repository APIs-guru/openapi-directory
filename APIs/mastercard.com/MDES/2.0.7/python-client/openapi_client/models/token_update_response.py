...
class TokenUpdateResponse(BaseModel):
    ...
    TokenUpdateResponse
    """ # noqa: E501
    tokens: Optional[TokenUpdateTokens] = Field(default=None, alias="Tokens")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Tokens": TokenUpdateTokens.from_dict(obj["Tokens"]) if obj.get("Tokens") is not None else None
        })
        return _obj
