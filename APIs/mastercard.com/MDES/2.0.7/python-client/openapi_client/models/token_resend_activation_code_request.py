...
class TokenResendActivationCodeRequest(BaseModel):
    """
    TokenResendActivationCodeRequest
    """ # noqa: E501
    activation_method_id: Annotated[str, Field(strict=True, max_length=0)] = Field(description="Identifier of the activation method.", alias="ActivationMethodId")
    audit_info: AuditInfo = Field(alias="AuditInfo")
    token_unique_reference: Annotated[str, Field(strict=True, max_length=48)] = Field(description="TokenUniqueReference of the token. When present, the TUR field will be a 48 characters string.", alias="TokenUniqueReference")
    __properties: ClassVar[List[str]] = ["ActivationMethodId", "AuditInfo", "TokenUniqueReference"]
