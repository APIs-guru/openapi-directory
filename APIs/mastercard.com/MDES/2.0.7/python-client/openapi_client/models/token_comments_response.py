...
class TokenCommentsResponse(BaseModel):
    """
    TokenCommentsResponse
    """ # noqa: E501
    comments: Optional[Comments] = Field(default=None, alias="Comments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Comments": Comments.from_dict(obj["Comments"]) if obj.get("Comments") is not None else None
        })
        return _obj
