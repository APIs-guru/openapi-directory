...
class UpdateTokenAssuranceRequest(BaseModel):
    """
    UpdateTokenAssuranceRequest
    """ # noqa: E501
    audit_info: AuditInfo = Field(alias="AuditInfo")
    comment_text: Optional[Annotated[str, Field(strict=True, max_length=0)]] = Field(default=None, description="Comment related to the update.", alias="CommentText")
    ...
    __properties: ClassVar[List[str]] = ["AuditInfo", "CommentText", "TokenUniqueReference"]
