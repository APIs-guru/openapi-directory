...
class TransactionsResponse(BaseModel):
    ...
    """ # noqa: E501
    transactions: Optional[Transactions] = Field(default=None, alias="Transactions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Transactions": Transactions.from_dict(obj["Transactions"]) if obj.get("Transactions") is not None else None
        })
        return _obj
