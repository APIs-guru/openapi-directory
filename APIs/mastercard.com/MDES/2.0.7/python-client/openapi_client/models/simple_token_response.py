...
class SimpleTokenResponse(BaseModel):
    ...
    SimpleTokenResponse
    """ # noqa: E501
    token: Optional[SimpleTokenCommentResponse] = Field(default=None, alias="Token")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Token": SimpleTokenCommentResponse.from_dict(obj["Token"]) if obj.get("Token") is not None else None
        })
        return _obj
