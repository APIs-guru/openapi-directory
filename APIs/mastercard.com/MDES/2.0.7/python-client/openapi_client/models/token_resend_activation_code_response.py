...
class TokenResendActivationCodeResponse(BaseModel):
    """
    TokenResendActivationCodeResponse
    """ # noqa: E501
    token: Optional[TokenResendActivationCodeResponseToken] = Field(default=None, alias="Token")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Token": TokenResendActivationCodeResponseToken.from_dict(obj["Token"]) if obj.get("Token") is not None else None
        })
        return _obj
