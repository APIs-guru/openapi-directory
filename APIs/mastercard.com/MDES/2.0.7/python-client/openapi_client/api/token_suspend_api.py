...
class TokenSuspendApi:
    ...
    @validate_call
    def token_suspend_post(
        self,
        token_suspend_request_schema: Annotated[Optional[TokenSuspendRequestSchema], Field(description="Contains the details of the request message.")] = None,
        ...
        :type token_suspend_request_schema: TokenSuspendRequestSchema
        ...
        _param = self._token_suspend_post_serialize(
            token_suspend_request_schema=token_suspend_request_schema,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TokenSuspendResponseSchema",
        }
    ...
    @validate_call
    def token_suspend_post_with_http_info(
        self,
        token_suspend_request_schema: Annotated[Optional[TokenSuspendRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TokenSuspendResponseSchema]:
        """token_suspend_post
    ...
    @validate_call
    def token_suspend_post_without_preload_content(
        self,
        token_suspend_request_schema: Annotated[Optional[TokenSuspendRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _token_suspend_post_serialize(
        self,
        token_suspend_request_schema,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if token_suspend_request_schema is not None:
            _body_params = token_suspend_request_schema
