...
class TokenCommentsApi:
    ...
    @validate_call
    def token_comments_post(
        self,
        token_comments_request_schema: Annotated[Optional[TokenCommentsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        ...
        :type token_comments_request_schema: TokenCommentsRequestSchema
        ...
        _param = self._token_comments_post_serialize(
            token_comments_request_schema=token_comments_request_schema,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TokenCommentsResponseSchema",
        }
    ...
    @validate_call
    def token_comments_post_with_http_info(
        self,
        token_comments_request_schema: Annotated[Optional[TokenCommentsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TokenCommentsResponseSchema]:
        """token_comments_post
    ...
    @validate_call
    def token_comments_post_without_preload_content(
        self,
        token_comments_request_schema: Annotated[Optional[TokenCommentsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _token_comments_post_serialize(
        self,
        token_comments_request_schema,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if token_comments_request_schema is not None:
            _body_params = token_comments_request_schema
