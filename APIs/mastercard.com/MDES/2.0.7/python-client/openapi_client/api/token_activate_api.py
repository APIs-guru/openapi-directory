...
class TokenActivateApi:
    ...
    @validate_call
    def token_activate_post(
        self,
        token_activate_request_schema: Annotated[Optional[TokenActivateRequestSchema], Field(description="Contains the details of the request message.")] = None,
        ...
        :type token_activate_request_schema: TokenActivateRequestSchema
        ...
        _param = self._token_activate_post_serialize(
            token_activate_request_schema=token_activate_request_schema,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TokenActivateResponseSchema",
        }
    ...
    @validate_call
    def token_activate_post_with_http_info(
        self,
        token_activate_request_schema: Annotated[Optional[TokenActivateRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TokenActivateResponseSchema]:
        """token_activate_post
    ...
    @validate_call
    def token_activate_post_without_preload_content(
        self,
        token_activate_request_schema: Annotated[Optional[TokenActivateRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _token_activate_post_serialize(
        self,
        token_activate_request_schema,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if token_activate_request_schema is not None:
            _body_params = token_activate_request_schema
