...
class SystemStatusApi:
    ...
    def systemstatus_get(
        ...
        _param = self._systemstatus_get_serialize(
    ...
    @validate_call
    def systemstatus_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SystemStatusResponseSchema]:
        """systemstatus_get
    ...
    @validate_call
    def systemstatus_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _systemstatus_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
