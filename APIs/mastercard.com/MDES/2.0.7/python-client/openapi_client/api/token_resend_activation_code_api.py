...
class TokenResendActivationCodeApi:
    ...
    @validate_call
    def token_resendactivationcode_post(
        self,
        token_resend_activation_code_request_schema: Annotated[Optional[TokenResendActivationCodeRequestSchema], Field(description="Contains the details of the request message.")] = None,
        ...
        :type token_resend_activation_code_request_schema: TokenResendActivationCodeRequestSchema
        ...
        _param = self._token_resendactivationcode_post_serialize(
            token_resend_activation_code_request_schema=token_resend_activation_code_request_schema,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TokenResendActivationCodeResponseSchema",
        }
    ...
    @validate_call
    def token_resendactivationcode_post_with_http_info(
        self,
        token_resend_activation_code_request_schema: Annotated[Optional[TokenResendActivationCodeRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TokenResendActivationCodeResponseSchema]:
        """token_resendactivationcode_post
    ...
    @validate_call
    def token_resendactivationcode_post_without_preload_content(
        self,
        token_resend_activation_code_request_schema: Annotated[Optional[TokenResendActivationCodeRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _token_resendactivationcode_post_serialize(
        self,
        token_resend_activation_code_request_schema,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if token_resend_activation_code_request_schema is not None:
            _body_params = token_resend_activation_code_request_schema
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/token/resendactivationcode',
