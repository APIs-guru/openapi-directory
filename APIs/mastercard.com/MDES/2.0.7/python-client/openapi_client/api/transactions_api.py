...
class TransactionsApi:
    ...
    def transactions_post(
        self,
        transactions_request_schema: Annotated[Optional[TransactionsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        ...
        :type transactions_request_schema: TransactionsRequestSchema
        ...
        _param = self._transactions_post_serialize(
            transactions_request_schema=transactions_request_schema,
    ...
    @validate_call
    def transactions_post_with_http_info(
        self,
        transactions_request_schema: Annotated[Optional[TransactionsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactionsResponseSchema]:
        """transactions_post
    ...
    @validate_call
    def transactions_post_without_preload_content(
        self,
        transactions_request_schema: Annotated[Optional[TransactionsRequestSchema], Field(description="Contains the details of the request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _transactions_post_serialize(
        self,
        transactions_request_schema,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if transactions_request_schema is not None:
            _body_params = transactions_request_schema
