...
class RPPSPaymentValidatorAPIApi:
    ...
    @validate_call
    def is_routing_valid_post(
        self,
        bill_pay_request: Annotated[Optional[BillPayRequest], Field(description="Contains the details of the get PAR API request message.")] = None,
        ...
        :type bill_pay_request: BillPayRequest
        ...
        _param = self._is_routing_valid_post_serialize(
    ...
    @validate_call
    def is_routing_valid_post_with_http_info(
        self,
        bill_pay_request: Annotated[Optional[BillPayRequest], Field(description="Contains the details of the get PAR API request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def is_routing_valid_post_without_preload_content(
        self,
        bill_pay_request: Annotated[Optional[BillPayRequest], Field(description="Contains the details of the get PAR API request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _is_routing_valid_post_serialize(
        self,
        bill_pay_request,
        _request_auth,
        _content_type,
        ...
        if bill_pay_request is not None:
            _body_params = bill_pay_request
