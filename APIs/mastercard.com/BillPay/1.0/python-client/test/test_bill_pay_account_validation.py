...
class TestBillPayAccountValidation(unittest.TestCase):
    """BillPayAccountValidation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillPayAccountValidation:
        """Test BillPayAccountValidation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillPayAccountValidation`
        """
        model = BillPayAccountValidation()
        if include_optional:
    ...
    def testBillPayAccountValidation(self):
        """Test BillPayAccountValidation"""
