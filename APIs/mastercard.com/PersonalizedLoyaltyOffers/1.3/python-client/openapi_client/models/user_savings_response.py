...
class UserSavingsResponse(BaseModel):
    ...
    UserSavingsResponse
    """ # noqa: E501
    response: Optional[SavingsResponse] = Field(default=None, alias="Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Response": SavingsResponse.from_dict(obj["Response"]) if obj.get("Response") is not None else None
        })
        return _obj
