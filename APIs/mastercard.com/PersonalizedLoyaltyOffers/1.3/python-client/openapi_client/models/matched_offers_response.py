...
class MatchedOffersResponse(BaseModel):
    """
    MatchedOffersResponse
    """ # noqa: E501
    response: Optional[MatchedResponse] = Field(default=None, alias="Response")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Response": MatchedResponse.from_dict(obj["Response"]) if obj.get("Response") is not None else None
        })
        return _obj
