...
class TokenResponse(BaseModel):
    ...
    user_token: Optional[UserToken] = Field(default=None, alias="UserToken")
    __properties: ClassVar[List[str]] = ["Status", "UserToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_token
        if self.user_token:
            _dict['UserToken'] = self.user_token.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UserToken": UserToken.from_dict(obj["UserToken"]) if obj.get("UserToken") is not None else None
        })
        return _obj
