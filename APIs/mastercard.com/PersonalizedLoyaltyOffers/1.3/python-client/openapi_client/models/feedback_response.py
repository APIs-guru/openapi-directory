...
class FeedbackResponse(BaseModel):
    ...
    user_feedback: Optional[UserFeedback] = Field(default=None, alias="UserFeedback")
    __properties: ClassVar[List[str]] = ["Status", "UserFeedback"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.user_feedback:
            _dict['UserFeedback'] = self.user_feedback.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UserFeedback": UserFeedback.from_dict(obj["UserFeedback"]) if obj.get("UserFeedback") is not None else None
        })
        return _obj
