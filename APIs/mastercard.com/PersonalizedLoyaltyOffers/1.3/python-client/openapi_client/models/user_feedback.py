...
class UserFeedback(BaseModel):
    ...
    UserFeedback
    """ # noqa: E501
    feedback: Optional[StrictStr] = Field(default=None, description="Response provided by the user.", alias="Feedback")
    ...
    __properties: ClassVar[List[str]] = ["Feedback", "OfferId"]
