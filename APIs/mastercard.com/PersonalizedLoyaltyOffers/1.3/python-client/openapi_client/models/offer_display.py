...
class OfferDisplay(BaseModel):
    """
    OfferDisplay
    """ # noqa: E501
    detailed_terms: Optional[StrictStr] = Field(default=None, description="Conditions required for successful redemption of the offer.", alias="DetailedTerms")
    __properties: ClassVar[List[str]] = ["DetailedTerms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DetailedTerms": obj.get("DetailedTerms")
        })
        return _obj
