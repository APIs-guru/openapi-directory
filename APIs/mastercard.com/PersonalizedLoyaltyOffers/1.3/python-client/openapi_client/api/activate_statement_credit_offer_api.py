...
class ActivateStatementCreditOfferApi:
    ...
    @validate_call
    def activatestatementcreditoffer_post(
        self,
        ...
        _param = self._activatestatementcreditoffer_post_serialize(
            fid=fid,
    ...
    @validate_call
    def activatestatementcreditoffer_post_with_http_info(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        user_token: Annotated[StrictStr, Field(description="Session identifier as returned by the UserToken resource.")],
        offer_id: Annotated[StrictStr, Field(description="System-wide identifier for the campaign, not intended for end-user display.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActivateOfferResponse]:
        """Make Statement Credit Offer Available Redeemable
    ...
    @validate_call
    def activatestatementcreditoffer_post_without_preload_content(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        user_token: Annotated[StrictStr, Field(description="Session identifier as returned by the UserToken resource.")],
        offer_id: Annotated[StrictStr, Field(description="System-wide identifier for the campaign, not intended for end-user display.")],
    ...
    def _activatestatementcreditoffer_post_serialize(
        self,
        fid,
        user_token,
        offer_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/activatestatementcreditoffer',
