...
class UserSavingsApi:
    ...
    def usersavings_get(
        ...
        _param = self._usersavings_get_serialize(
            fid=fid,
    ...
    @validate_call
    def usersavings_get_with_http_info(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        user_token: Annotated[StrictStr, Field(description="Session identifier as returned by the UserToken resource.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserSavingsResponse]:
        """Returns Savings for the User
    ...
    @validate_call
    def usersavings_get_without_preload_content(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        user_token: Annotated[StrictStr, Field(description="Session identifier as returned by the UserToken resource.")],
        _request_timeout: Union[
    ...
    def _usersavings_get_serialize(
        self,
        fid,
        user_token,
        _request_auth,
