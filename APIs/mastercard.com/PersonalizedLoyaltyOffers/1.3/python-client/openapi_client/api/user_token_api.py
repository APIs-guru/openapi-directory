...
class UserTokenApi:
    ...
    def usertoken_get(
        ...
        auth_info: Annotated[StrictStr, Field(description="Authorization Information. AES 128-bit encrypted concatenation of \"User ID as specified in enrollment:FI ID as provided by Mastercard:current Unix time\". Key exchange and establishment of maintenance procedures occur during implementation.")],
        ...
        :type fid: str
        :param auth_info: Authorization Information. AES 128-bit encrypted concatenation of \"User ID as specified in enrollment:FI ID as provided by Mastercard:current Unix time\". Key exchange and establishment of maintenance procedures occur during implementation. (required)
        :type auth_info: str
        ...
        _param = self._usertoken_get_serialize(
            fid=fid,
            auth_info=auth_info,
    ...
    @validate_call
    def usertoken_get_with_http_info(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        auth_info: Annotated[StrictStr, Field(description="Authorization Information. AES 128-bit encrypted concatenation of \"User ID as specified in enrollment:FI ID as provided by Mastercard:current Unix time\". Key exchange and establishment of maintenance procedures occur during implementation.")],
        _request_timeout: Union[
    ...
    @validate_call
    def usertoken_get_without_preload_content(
        self,
        fid: Annotated[StrictStr, Field(description="Financial Institution Identifier. Code that specifies the platform and configuration instance, provided by Mastercard during implementation.")],
        auth_info: Annotated[StrictStr, Field(description="Authorization Information. AES 128-bit encrypted concatenation of \"User ID as specified in enrollment:FI ID as provided by Mastercard:current Unix time\". Key exchange and establishment of maintenance procedures occur during implementation.")],
        _request_timeout: Union[
    ...
    def _usertoken_get_serialize(
        ...
        if auth_info is not None:
            ...
            _query_params.append(('AuthInfo', auth_info))
