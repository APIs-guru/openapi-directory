...
class TestUserSavingsResponse(unittest.TestCase):
    """UserSavingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSavingsResponse:
        """Test UserSavingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSavingsResponse`
        """
        model = UserSavingsResponse()
        if include_optional:
            return UserSavingsResponse(
                response = openapi_client.models.savings_response.SavingsResponse(
    ...
    def testUserSavingsResponse(self):
        """Test UserSavingsResponse"""
