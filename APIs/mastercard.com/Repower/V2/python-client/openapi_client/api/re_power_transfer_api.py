...
class RePowerTransferApi:
    ...
    def repower_post2(
        self,
        repower_request: Annotated[Optional[Repowerrequest1Wrapper], Field(description="Contains the details of the repower request message.")] = None,
        ...
        :type repower_request: Repowerrequest1Wrapper
        ...
        _param = self._repower_post2_serialize(
            repower_request=repower_request,
    ...
    @validate_call
    def repower_post2_with_http_info(
        self,
        repower_request: Annotated[Optional[Repowerrequest1Wrapper], Field(description="Contains the details of the repower request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def repower_post2_without_preload_content(
        self,
        repower_request: Annotated[Optional[Repowerrequest1Wrapper], Field(description="Contains the details of the repower request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _repower_post2_serialize(
        ...
        if repower_request is not None:
            _body_params = repower_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/repower/v2/repower',
