...
class RePowerTransferReversalApi:
    ...
    @validate_call
    def repower_reversal_post2(
        self,
        repower_reversal_request: Annotated[Optional[Repowerreversalrequest10Wrapper], Field(description="Contains the details of the repower reversal request message.")] = None,
        ...
        :type repower_reversal_request: Repowerreversalrequest10Wrapper
        ...
        _param = self._repower_reversal_post2_serialize(
            repower_reversal_request=repower_reversal_request,
    ...
    @validate_call
    def repower_reversal_post2_with_http_info(
        self,
        repower_reversal_request: Annotated[Optional[Repowerreversalrequest10Wrapper], Field(description="Contains the details of the repower reversal request message.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Repowerreversal11Wrapper]:
        """repower_reversal_post2
    ...
    @validate_call
    def repower_reversal_post2_without_preload_content(
        self,
        repower_reversal_request: Annotated[Optional[Repowerreversalrequest10Wrapper], Field(description="Contains the details of the repower reversal request message.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _repower_reversal_post2_serialize(
        self,
        repower_reversal_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if repower_reversal_request is not None:
            _body_params = repower_reversal_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/repower/v2/repowerreversal',
