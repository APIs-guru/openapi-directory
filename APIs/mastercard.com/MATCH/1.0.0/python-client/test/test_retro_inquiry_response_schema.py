...
class TestRetroInquiryResponseSchema(unittest.TestCase):
    """RetroInquiryResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetroInquiryResponseSchema:
        """Test RetroInquiryResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetroInquiryResponseSchema`
        """
        model = RetroInquiryResponseSchema()
        if include_optional:
            return RetroInquiryResponseSchema(
                retro_inquiry_response = openapi_client.models.retro_inquiry_response.RetroInquiryResponse(
                    possible_merchant_matches = openapi_client.models.possible_merchant_matches.PossibleMerchantMatches(
                        terminated_merchant = [
    ...
    def testRetroInquiryResponseSchema(self):
        """Test RetroInquiryResponseSchema"""
