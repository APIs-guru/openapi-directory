...
class TestTerminationInquiryRequest(unittest.TestCase):
    """TerminationInquiryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminationInquiryRequest:
        """Test TerminationInquiryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminationInquiryRequest`
        """
        model = TerminationInquiryRequest()
        if include_optional:
    ...
    def testTerminationInquiryRequest(self):
        """Test TerminationInquiryRequest"""
