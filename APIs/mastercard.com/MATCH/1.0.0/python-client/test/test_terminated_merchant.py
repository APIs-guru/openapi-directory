...
class TestTerminatedMerchant(unittest.TestCase):
    """TerminatedMerchant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminatedMerchant:
        """Test TerminatedMerchant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminatedMerchant`
        """
        model = TerminatedMerchant()
        if include_optional:
    ...
    def testTerminatedMerchant(self):
        """Test TerminatedMerchant"""
