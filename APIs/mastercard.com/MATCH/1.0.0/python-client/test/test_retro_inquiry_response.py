...
class TestRetroInquiryResponse(unittest.TestCase):
    """RetroInquiryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetroInquiryResponse:
        """Test RetroInquiryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetroInquiryResponse`
        """
        model = RetroInquiryResponse()
        if include_optional:
    ...
    def testRetroInquiryResponse(self):
        """Test RetroInquiryResponse"""
