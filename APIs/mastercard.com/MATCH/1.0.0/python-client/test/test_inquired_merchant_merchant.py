...
class TestInquiredMerchantMerchant(unittest.TestCase):
    """InquiredMerchantMerchant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InquiredMerchantMerchant:
        """Test InquiredMerchantMerchant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InquiredMerchantMerchant`
        """
        model = InquiredMerchantMerchant()
        if include_optional:
            return InquiredMerchantMerchant(
    ...
    def testInquiredMerchantMerchant(self):
        """Test InquiredMerchantMerchant"""
