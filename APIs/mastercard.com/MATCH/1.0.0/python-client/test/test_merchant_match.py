...
class TestMerchantMatch(unittest.TestCase):
    """MerchantMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantMatch:
        """Test MerchantMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantMatch`
        """
        model = MerchantMatch()
        if include_optional:
