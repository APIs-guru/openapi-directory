...
class TestPossibleMerchantMatches(unittest.TestCase):
    """PossibleMerchantMatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossibleMerchantMatches:
        """Test PossibleMerchantMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossibleMerchantMatches`
        """
        model = PossibleMerchantMatches()
        if include_optional:
    ...
    def testPossibleMerchantMatches(self):
        """Test PossibleMerchantMatches"""
