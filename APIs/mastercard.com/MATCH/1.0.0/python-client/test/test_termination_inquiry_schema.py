...
class TestTerminationInquirySchema(unittest.TestCase):
    """TerminationInquirySchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminationInquirySchema:
        """Test TerminationInquirySchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminationInquirySchema`
        """
        model = TerminationInquirySchema()
        if include_optional:
            return TerminationInquirySchema(
                termination_inquiry = openapi_client.models.termination_inquiry.TerminationInquiry(
                    page_offset = '', 
    ...
    def testTerminationInquirySchema(self):
        """Test TerminationInquirySchema"""
