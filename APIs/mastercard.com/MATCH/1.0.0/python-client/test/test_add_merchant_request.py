...
class TestAddMerchantRequest(unittest.TestCase):
    """AddMerchantRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddMerchantRequest:
        """Test AddMerchantRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddMerchantRequest`
        """
        model = AddMerchantRequest()
        if include_optional:
    ...
    def testAddMerchantRequest(self):
        """Test AddMerchantRequest"""
