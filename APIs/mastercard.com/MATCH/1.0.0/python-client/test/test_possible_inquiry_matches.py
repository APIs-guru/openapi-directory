...
class TestPossibleInquiryMatches(unittest.TestCase):
    """PossibleInquiryMatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossibleInquiryMatches:
        """Test PossibleInquiryMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossibleInquiryMatches`
        """
        model = PossibleInquiryMatches()
        if include_optional:
    ...
    def testPossibleInquiryMatches(self):
        """Test PossibleInquiryMatches"""
