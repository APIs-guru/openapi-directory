...
**first_name** | **str** | The first name of the principal owner of the business. | [optional] 
**last_name** | **str** | The last name of the principal owner of the business. | [optional] 
...
principal_match_instance = PrincipalMatch.from_json(json)
# print the JSON string representation of the object
print(PrincipalMatch.to_json())

# convert the object into a dict
principal_match_dict = principal_match_instance.to_dict()
# create an instance of PrincipalMatch from a dict
principal_match_from_dict = PrincipalMatch.from_dict(principal_match_dict)
```
