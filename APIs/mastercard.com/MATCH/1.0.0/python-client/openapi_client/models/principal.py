...
class Principal(BaseModel):
    ...
    first_name: StrictStr = Field(description="The first name of the principal owner of the business.", alias="FirstName")
    last_name: StrictStr = Field(description="The last name of the principal owner of the business.", alias="LastName")
    ...
    __properties: ClassVar[List[str]] = ["Address", "AltPhoneNumber", "DriversLicense", "FirstName", "LastName", "MiddleInitial", "NationalId", "PhoneNumber", "SearchCriteria"]
