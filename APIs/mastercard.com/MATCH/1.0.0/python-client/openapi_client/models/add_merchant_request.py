...
class AddMerchantRequest(BaseModel):
    ...
    AddMerchantRequest
    """ # noqa: E501
    acquirer_id: StrictStr = Field(description="The ID of the acquirer.", alias="AcquirerId")
    merchant: Optional[AddMerchantMerchant] = Field(default=None, alias="Merchant")
    __properties: ClassVar[List[str]] = ["AcquirerId", "Merchant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Merchant": AddMerchantMerchant.from_dict(obj["Merchant"]) if obj.get("Merchant") is not None else None
        })
        return _obj
