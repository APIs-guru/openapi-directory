...
class RetroactiveInquiryRequestApi:
    ...
    @validate_call
    def fraud_merchant_v3_retro_retro_list_post(
        self,
        retro_request: Annotated[RetroRequestSchema, Field(description="The retro request object")],
        ...
        :param retro_request: The retro request object (required)
        :type retro_request: RetroRequestSchema
        ...
        _param = self._fraud_merchant_v3_retro_retro_list_post_serialize(
    ...
    @validate_call
    def fraud_merchant_v3_retro_retro_list_post_with_http_info(
        self,
        retro_request: Annotated[RetroRequestSchema, Field(description="The retro request object")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RetroResponseSchema]:
        """Returns the summary of Retro matches for the given Acquirer Id. This resource will return the summary of Retroactive Inquiry matches for the given Acquirer ID/ICA. If an initial inquiry does not result in a possible match, it is still possible that the merchant listing could appear sometime in the next 360 days. This may occur when another acquirer enters the merchant into the MATCH database. The system will automatically continue to search the MATCH system for 360 days. To view these notifications, acquirers must use the Retroactive Inquiry service.
    ...
    @validate_call
    def fraud_merchant_v3_retro_retro_list_post_without_preload_content(
        self,
        retro_request: Annotated[RetroRequestSchema, Field(description="The retro request object")],
        _request_timeout: Union[
            None,
    ...
    def _fraud_merchant_v3_retro_retro_list_post_serialize(
        self,
        retro_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fraud/merchant/v3/retro/retro-list',
