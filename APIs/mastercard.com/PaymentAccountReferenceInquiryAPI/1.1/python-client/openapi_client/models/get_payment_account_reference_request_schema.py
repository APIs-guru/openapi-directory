...
class GetPaymentAccountReferenceRequestSchema(BaseModel):
    """
    GetPaymentAccountReferenceRequestSchema
    """ # noqa: E501
    encrypted_payload: EncryptedPayloadData = Field(alias="encryptedPayload")
    request_id: StrictStr = Field(description="The id of the request submitted.", alias="requestId")
    __properties: ClassVar[List[str]] = ["encryptedPayload", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "encryptedPayload": EncryptedPayloadData.from_dict(obj["encryptedPayload"]) if obj.get("encryptedPayload") is not None else None,
