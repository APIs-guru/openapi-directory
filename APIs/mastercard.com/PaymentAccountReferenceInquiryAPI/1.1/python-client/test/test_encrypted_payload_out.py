...
class TestEncryptedPayloadOut(unittest.TestCase):
    """EncryptedPayloadOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptedPayloadOut:
        """Test EncryptedPayloadOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptedPayloadOut`
        """
        model = EncryptedPayloadOut()
        if include_optional:
            return EncryptedPayloadOut(
    ...
    def testEncryptedPayloadOut(self):
        """Test EncryptedPayloadOut"""
