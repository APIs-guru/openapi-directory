...
class TestEncryptedPayloadData(unittest.TestCase):
    """EncryptedPayloadData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptedPayloadData:
        """Test EncryptedPayloadData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptedPayloadData`
        """
        model = EncryptedPayloadData()
        if include_optional:
    ...
    def testEncryptedPayloadData(self):
        """Test EncryptedPayloadData"""
