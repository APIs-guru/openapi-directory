...
class MerchantIdsApi:
    ...
    def get_merchant_identifiers(
        self,
        merchant_id: Annotated[Optional[StrictStr], Field(description="Merchant's name as provided by the issuer found on a cardholder statement. __Important: Please remove all spaces before submitting a API request.__   ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Determines how the search is performed.              ExactMatch returns either the one merchant that best fits the description or no results at all.              FuzzyMatch returns 0-20 merchants that are similar to the transaction descriptor.               If Type is not provided, defaults to ExactMatch.              Example: FuzzyMatch")] = None,
        ...
        _param = self._get_merchant_identifiers_serialize(
    ...
    @validate_call
    def get_merchant_identifiers_with_http_info(
        self,
        merchant_id: Annotated[Optional[StrictStr], Field(description="Merchant's name as provided by the issuer found on a cardholder statement. __Important: Please remove all spaces before submitting a API request.__   ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Determines how the search is performed.              ExactMatch returns either the one merchant that best fits the description or no results at all.              FuzzyMatch returns 0-20 merchants that are similar to the transaction descriptor.               If Type is not provided, defaults to ExactMatch.              Example: FuzzyMatch")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_merchant_identifiers_without_preload_content(
        self,
        merchant_id: Annotated[Optional[StrictStr], Field(description="Merchant's name as provided by the issuer found on a cardholder statement. __Important: Please remove all spaces before submitting a API request.__   ")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Determines how the search is performed.              ExactMatch returns either the one merchant that best fits the description or no results at all.              FuzzyMatch returns 0-20 merchants that are similar to the transaction descriptor.               If Type is not provided, defaults to ExactMatch.              Example: FuzzyMatch")] = None,
        _request_timeout: Union[
    ...
    def _get_merchant_identifiers_serialize(
        self,
        merchant_id,
        type,
        _request_auth,
