...
class CountrySubdivision(BaseModel):
    ...
    CountrySubdivision
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Abbreviated code for the state or province")
    name: Optional[StrictStr] = Field(default=None, description="Name of the state or province.")
