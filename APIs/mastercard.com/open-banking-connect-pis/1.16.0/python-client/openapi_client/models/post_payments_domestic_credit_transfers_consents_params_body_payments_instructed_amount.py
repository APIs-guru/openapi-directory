...
class PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsInstructedAmount(BaseModel):
    """
    ...
    def currency_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['GBP', 'PLN']):
            raise ValueError("must be one of enum values ('GBP', 'PLN')")
        return value
