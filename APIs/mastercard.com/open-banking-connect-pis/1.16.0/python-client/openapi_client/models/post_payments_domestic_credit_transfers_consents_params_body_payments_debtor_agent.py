...
class PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsDebtorAgent(BaseModel):
    """
    PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsDebtorAgent
    """ # noqa: E501
    identification: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Debtor agent identification, If localInstrument = 'UK.FasterPayments' and debtorAccount was specified then this needs to be a UK Sort code (6 digits)")
