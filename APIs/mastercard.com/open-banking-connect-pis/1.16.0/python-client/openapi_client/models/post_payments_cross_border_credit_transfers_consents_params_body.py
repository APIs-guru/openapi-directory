...
class PostPaymentsCrossBorderCreditTransfersConsentsParamsBody(BaseModel):
    """
    ...
    request_info: PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyRequestInfo = Field(alias="requestInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPayments.from_dict(obj["payments"]) if obj.get("payments") is not None else None,
            "requestInfo": PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyRequestInfo.from_dict(obj["requestInfo"]) if obj.get("requestInfo") is not None else None
        })
        return _obj
