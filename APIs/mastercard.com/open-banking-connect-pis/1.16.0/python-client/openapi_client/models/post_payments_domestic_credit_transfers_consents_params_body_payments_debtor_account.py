...
class PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsDebtorAccount(BaseModel):
    """
    PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsDebtorAccount
    """ # noqa: E501
    identification: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Debtor account identification, If localInstrument = 'UK.FasterPayments' and debtorAgent was specified then this needs to be a UK Account number (8 digits)")
