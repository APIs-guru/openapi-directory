...
class PostPaymentsSepaCreditTransfersConsentsParamsBodyPaymentsDebtorAgent(BaseModel):
    """
    PostPaymentsSepaCreditTransfersConsentsParamsBodyPaymentsDebtorAgent
    """ # noqa: E501
    bicfi: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Debtor FI")
