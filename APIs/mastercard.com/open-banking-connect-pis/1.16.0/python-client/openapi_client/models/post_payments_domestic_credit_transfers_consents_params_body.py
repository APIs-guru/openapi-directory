...
class PostPaymentsDomesticCreditTransfersConsentsParamsBody(BaseModel):
    """
    ...
    request_info: PostPaymentsDomesticCreditTransfersConsentsParamsBodyRequestInfo = Field(alias="requestInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments.from_dict(obj["payments"]) if obj.get("payments") is not None else None,
            "requestInfo": PostPaymentsDomesticCreditTransfersConsentsParamsBodyRequestInfo.from_dict(obj["requestInfo"]) if obj.get("requestInfo") is not None else None
        })
        return _obj
