...
class BINTableListingServiceApi:
    ...
    def binlisting_get(
        ...
        _param = self._binlisting_get_serialize(
    ...
    @validate_call
    def binlisting_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def binlisting_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
