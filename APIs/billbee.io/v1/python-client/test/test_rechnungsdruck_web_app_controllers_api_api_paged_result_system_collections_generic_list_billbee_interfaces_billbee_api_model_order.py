...
class TestRechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder(unittest.TestCase):
    """RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder:
        """Test RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder`
        """
        model = RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder()
        if include_optional:
            return RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder(
                data = [
                    openapi_client.models.billbee/interfaces/billbee_api/model/order.Billbee.Interfaces.BillbeeAPI.Model.Order(
                ...
                error_description = 0,
                error_message = '',
                paging = openapi_client.models.rechnungsdruck/web_app/controllers/api/api_paged_result/paging_information_system/collections/generic/list_billbee/interfaces/billbee_api/model/order_.Rechnungsdruck.WebApp.Controllers.Api.ApiPagedResult.PagingInformation_System.Collections.Generic.List_Billbee.Interfaces.BillbeeAPI.Model.Order_(
                    page = 56, 
                    page_size = 56, 
                    total_pages = 56, 
                    total_rows = 56, )
    ...
    def testRechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder(self):
        """Test RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelOrder"""
