...
class TestBillbeeInterfacesBillbeeAPIModelOrder(unittest.TestCase):
    """BillbeeInterfacesBillbeeAPIModelOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillbeeInterfacesBillbeeAPIModelOrder:
        """Test BillbeeInterfacesBillbeeAPIModelOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillbeeInterfacesBillbeeAPIModelOrder`
        """
        model = BillbeeInterfacesBillbeeAPIModelOrder()
        if include_optional:
    ...
    def testBillbeeInterfacesBillbeeAPIModelOrder(self):
        """Test BillbeeInterfacesBillbeeAPIModelOrder"""
