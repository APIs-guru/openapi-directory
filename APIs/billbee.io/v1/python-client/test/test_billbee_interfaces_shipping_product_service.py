...
class TestBillbeeInterfacesShippingProductService(unittest.TestCase):
    """BillbeeInterfacesShippingProductService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillbeeInterfacesShippingProductService:
        """Test BillbeeInterfacesShippingProductService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillbeeInterfacesShippingProductService`
        """
        model = BillbeeInterfacesShippingProductService()
        if include_optional:
    ...
    def testBillbeeInterfacesShippingProductService(self):
        """Test BillbeeInterfacesShippingProductService"""
