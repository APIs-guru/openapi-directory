...
class BillbeeInterfacesBillbeeAPIModelCustomerApiModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ArchivedAt", "DefaultCommercialMailAddress", "DefaultFax", "DefaultMailAddress", "DefaultPhone1", "DefaultPhone2", "DefaultStatusUpdatesMailAddress", "Email", "Id", "LanguageId", "MetaData", "Name", "Number", "PriceGroupId", "RestoredAt", "Tel1", "Tel2", "Type", "VatId"]
