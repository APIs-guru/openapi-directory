...
class RechnungsdruckWebAppControllersApiOrderStateUpdate(BaseModel):
    ...
    """ # noqa: E501
    new_state_id: Optional[StrictInt] = Field(default=None, description="The new state to set", alias="NewStateId")
    __properties: ClassVar[List[str]] = ["NewStateId"]

    @field_validator('new_state_id')
    def new_state_id_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
