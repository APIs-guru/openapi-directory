...
class RechnungsdruckWebAppControllersApiSearchControllerOrderResult(BaseModel):
    ...
    """ # noqa: E501
    article_texts: Optional[StrictStr] = Field(default=None, alias="ArticleTexts")
    ...
    __properties: ClassVar[List[str]] = ["ArticleTexts", "BuyerName", "CustomerName", "ExternalReference", "Id", "InvoiceNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ArticleTexts": obj.get("ArticleTexts"),
