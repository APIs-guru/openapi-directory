...
class BillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel(BaseModel):
    ...
    thumb_path_ext: Optional[StrictStr] = Field(default=None, alias="ThumbPathExt")
    thumb_url: Optional[StrictStr] = Field(default=None, alias="ThumbUrl")
    url: Optional[StrictStr] = Field(default=None, alias="Url")
    __properties: ClassVar[List[str]] = ["ArticleId", "Id", "IsDefault", "Position", "ThumbPathExt", "ThumbUrl", "Url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ThumbPathExt": obj.get("ThumbPathExt"),
            "ThumbUrl": obj.get("ThumbUrl"),
            "Url": obj.get("Url")
        })
        return _obj
