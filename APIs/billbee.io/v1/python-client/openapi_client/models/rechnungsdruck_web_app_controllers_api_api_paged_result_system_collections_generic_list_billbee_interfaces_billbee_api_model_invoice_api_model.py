...
class RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelInvoiceApiModel(BaseModel):
    """
    ...
    """ # noqa: E501
    data: Optional[List[BillbeeInterfacesBillbeeAPIModelInvoiceApiModel]] = Field(default=None, alias="Data")
    ...
    paging: Optional[RechnungsdruckWebAppControllersApiApiPagedResultPagingInformationSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelInvoiceApiModel] = Field(default=None, alias="Paging")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Data": [BillbeeInterfacesBillbeeAPIModelInvoiceApiModel.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None,
            "ErrorCode": obj.get("ErrorCode"),
            "ErrorDescription": obj.get("ErrorDescription"),
            "ErrorMessage": obj.get("ErrorMessage"),
            "Paging": RechnungsdruckWebAppControllersApiApiPagedResultPagingInformationSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelInvoiceApiModel.from_dict(obj["Paging"]) if obj.get("Paging") is not None else None
        })
        return _obj
