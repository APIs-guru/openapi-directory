...
class SystemCollectionsGenericKeyValuePairSystemStringSystemCollectionsGenericListSystemCollectionsGenericKeyValuePairSystemInt32SystemString(BaseModel):
    """
    ...
    value: Optional[List[SystemCollectionsGenericKeyValuePairSystemInt32SystemString]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": [SystemCollectionsGenericKeyValuePairSystemInt32SystemString.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
