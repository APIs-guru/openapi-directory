...
class BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["BillbeeId", "City", "Company", "Country", "CountryISO2", "Email", "FirstName", "HouseNumber", "LastName", "Line2", "NameAddition", "Phone", "State", "Street", "Zip"]
