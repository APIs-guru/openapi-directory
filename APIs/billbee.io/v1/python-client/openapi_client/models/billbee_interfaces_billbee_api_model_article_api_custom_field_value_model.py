...
class BillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldValueModel(BaseModel):
    ...
    definition: Optional[BillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel] = Field(default=None, alias="Definition")
    definition_id: Optional[StrictInt] = Field(default=None, alias="DefinitionId")
    id: Optional[StrictInt] = Field(default=None, alias="Id")
    value: Optional[Dict[str, Any]] = Field(default=None, alias="Value")
    __properties: ClassVar[List[str]] = ["ArticleId", "Definition", "DefinitionId", "Id", "Value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Definition": BillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel.from_dict(obj["Definition"]) if obj.get("Definition") is not None else None,
