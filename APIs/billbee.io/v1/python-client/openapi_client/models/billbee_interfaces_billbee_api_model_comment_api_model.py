...
class BillbeeInterfacesBillbeeAPIModelCommentApiModel(BaseModel):
    ...
    from_customer: Optional[StrictBool] = Field(default=None, alias="FromCustomer")
    id: Optional[StrictInt] = Field(default=None, alias="Id")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    text: Optional[StrictStr] = Field(default=None, alias="Text")
    __properties: ClassVar[List[str]] = ["Created", "FromCustomer", "Id", "Name", "Text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "FromCustomer": obj.get("FromCustomer"),
            "Id": obj.get("Id"),
            "Name": obj.get("Name"),
            "Text": obj.get("Text")
        })
