...
class RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainerUserAddress(BaseModel):
    """
    ...
    country: Optional[StrictStr] = Field(default=None, description="The ISO2 country code of the users country", alias="Country")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    vat_id: Optional[StrictStr] = Field(default=None, alias="VatId")
    zip: Optional[StrictStr] = Field(default=None, alias="Zip")
    __properties: ClassVar[List[str]] = ["Address1", "Address2", "City", "Company", "Country", "Name", "VatId", "Zip"]
