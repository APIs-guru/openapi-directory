...
class RechnungsdruckWebAppControllersApiInvoice(BaseModel):
    """
    ...
    pdf_data: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="PDFData")
    pdf_download_url: Optional[StrictStr] = Field(default=None, alias="PdfDownloadUrl")
    ...
    __properties: ClassVar[List[str]] = ["InvoiceDate", "InvoiceNumber", "OrderNumber", "PDFData", "PdfDownloadUrl", "TotalGross", "TotalNet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PDFData": obj.get("PDFData"),
            "PdfDownloadUrl": obj.get("PdfDownloadUrl"),
