...
class BillbeeInterfacesBillbeeAPIModelStockArticleApiModel(BaseModel):
    ...
    unfulfilled_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="UnfulfilledAmount")
    __properties: ClassVar[List[str]] = ["Name", "StockCode", "StockCurrent", "StockDesired", "StockId", "StockWarning", "UnfulfilledAmount"]
