...
class BillbeeInterfacesOrderHistoryEntry(BaseModel):
    ...
    event_type_name: Optional[StrictStr] = Field(default=None, alias="EventTypeName")
    text: Optional[StrictStr] = Field(default=None, alias="Text")
    type_id: Optional[StrictInt] = Field(default=None, alias="TypeId")
    __properties: ClassVar[List[str]] = ["Created", "EmployeeName", "EventTypeName", "Text", "TypeId"]
