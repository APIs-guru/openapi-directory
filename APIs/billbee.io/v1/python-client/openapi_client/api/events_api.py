...
class EventsApi:
    ...
    @validate_call
    def event_api_get_list(
        self,
        min_date: Annotated[Optional[datetime], Field(description="Specifies the oldest date to include in the response")] = None,
        max_date: Annotated[Optional[datetime], Field(description="Specifies the newest date to include in the response")] = None,
        ...
        type_id: Annotated[Optional[List[StrictInt]], Field(description="Filter for specific event types")] = None,
        order_id: Annotated[Optional[StrictInt], Field(description="Filter for specific order id")] = None,
        ...
        _param = self._event_api_get_list_serialize(
            min_date=min_date,
            max_date=max_date,
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def event_api_get_list_with_http_info(
        self,
        min_date: Annotated[Optional[datetime], Field(description="Specifies the oldest date to include in the response")] = None,
        max_date: Annotated[Optional[datetime], Field(description="Specifies the newest date to include in the response")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Specifies the page to request")] = None,
    ...
    @validate_call
    def event_api_get_list_without_preload_content(
        self,
        min_date: Annotated[Optional[datetime], Field(description="Specifies the oldest date to include in the response")] = None,
        max_date: Annotated[Optional[datetime], Field(description="Specifies the newest date to include in the response")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Specifies the page to request")] = None,
    ...
    def _event_api_get_list_serialize(
        self,
        min_date,
        max_date,
        page,
