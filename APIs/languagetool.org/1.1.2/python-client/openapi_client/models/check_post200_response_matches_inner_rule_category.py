...
class CheckPost200ResponseMatchesInnerRuleCategory(BaseModel):
    """
    CheckPost200ResponseMatchesInnerRuleCategory
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A category's identifier that's unique for this language.")
    name: Optional[StrictStr] = Field(default=None, description="A short description of the category.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckPost200ResponseMatchesInnerRuleCategory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckPost200ResponseMatchesInnerRuleCategory from a dict"""
        if obj is None:
            return None
