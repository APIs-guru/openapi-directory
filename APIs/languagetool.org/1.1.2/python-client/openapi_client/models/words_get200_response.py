...
class WordsGet200Response(BaseModel):
    """
    WordsGet200Response
    """ # noqa: E501
    words: Optional[List[StrictStr]] = Field(default=None, description="array of words")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WordsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WordsGet200Response from a dict"""
        if obj is None:
            return None
