...
class LanguagesGet200ResponseInner(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="a language code like 'en'")
    long_code: StrictStr = Field(description="a language code like 'en-US' or 'ca-ES-valencia'", alias="longCode")
    name: StrictStr = Field(description="a language name like 'French' or 'English (Australia)'")
    __properties: ClassVar[List[str]] = ["code", "longCode", "name"]
