...
class WordsAddPost200Response(BaseModel):
    """
    WordsAddPost200Response
    """ # noqa: E501
    added: Optional[StrictBool] = Field(default=None, description="true if the word has been added. false means the word hasn't been added because it had been added before.")
