...
class CheckPost200Response(BaseModel):
    """
    CheckPost200Response
    """ # noqa: E501
    language: Optional[CheckPost200ResponseLanguage] = None
    matches: Optional[List[CheckPost200ResponseMatchesInner]] = None
    software: Optional[CheckPost200ResponseSoftware] = None
    __properties: ClassVar[List[str]] = ["language", "matches", "software"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "language": CheckPost200ResponseLanguage.from_dict(obj["language"]) if obj.get("language") is not None else None,
            "matches": [CheckPost200ResponseMatchesInner.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "software": CheckPost200ResponseSoftware.from_dict(obj["software"]) if obj.get("software") is not None else None
        })
        return _obj
