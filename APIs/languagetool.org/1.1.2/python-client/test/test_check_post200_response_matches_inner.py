...
class TestCheckPost200ResponseMatchesInner(unittest.TestCase):
    """CheckPost200ResponseMatchesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseMatchesInner:
        """Test CheckPost200ResponseMatchesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseMatchesInner`
        """
        model = CheckPost200ResponseMatchesInner()
        if include_optional:
            return CheckPost200ResponseMatchesInner(
    ...
    def testCheckPost200ResponseMatchesInner(self):
        """Test CheckPost200ResponseMatchesInner"""
