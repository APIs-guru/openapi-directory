...
class TestCheckPost200ResponseMatchesInnerRuleCategory(unittest.TestCase):
    """CheckPost200ResponseMatchesInnerRuleCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseMatchesInnerRuleCategory:
        """Test CheckPost200ResponseMatchesInnerRuleCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseMatchesInnerRuleCategory`
        """
        model = CheckPost200ResponseMatchesInnerRuleCategory()
        if include_optional:
            return CheckPost200ResponseMatchesInnerRuleCategory(
                id = '',
                name = ''
            )
        else:
    ...
    def testCheckPost200ResponseMatchesInnerRuleCategory(self):
        """Test CheckPost200ResponseMatchesInnerRuleCategory"""
