...
class TestCheckPost200ResponseMatchesInnerReplacementsInner(unittest.TestCase):
    """CheckPost200ResponseMatchesInnerReplacementsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseMatchesInnerReplacementsInner:
        """Test CheckPost200ResponseMatchesInnerReplacementsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseMatchesInnerReplacementsInner`
        """
        model = CheckPost200ResponseMatchesInnerReplacementsInner()
        if include_optional:
            return CheckPost200ResponseMatchesInnerReplacementsInner(
                value = ''
            )
        else:
            return CheckPost200ResponseMatchesInnerReplacementsInner(
    ...
    def testCheckPost200ResponseMatchesInnerReplacementsInner(self):
        """Test CheckPost200ResponseMatchesInnerReplacementsInner"""
