...
class TestCheckPost200ResponseSoftware(unittest.TestCase):
    """CheckPost200ResponseSoftware unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseSoftware:
        """Test CheckPost200ResponseSoftware
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseSoftware`
        """
        model = CheckPost200ResponseSoftware()
        if include_optional:
            return CheckPost200ResponseSoftware(
                api_version = 56,
                build_date = '',
                name = '',
                premium = True,
    ...
    def testCheckPost200ResponseSoftware(self):
        """Test CheckPost200ResponseSoftware"""
