...
class TestCheckPost200ResponseMatchesInnerContext(unittest.TestCase):
    """CheckPost200ResponseMatchesInnerContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseMatchesInnerContext:
        """Test CheckPost200ResponseMatchesInnerContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseMatchesInnerContext`
        """
        model = CheckPost200ResponseMatchesInnerContext()
        if include_optional:
            return CheckPost200ResponseMatchesInnerContext(
                length = 56,
                offset = 56,
                text = ''
            )
    ...
    def testCheckPost200ResponseMatchesInnerContext(self):
        """Test CheckPost200ResponseMatchesInnerContext"""
