...
class TestCheckPost200ResponseLanguageDetectedLanguage(unittest.TestCase):
    """CheckPost200ResponseLanguageDetectedLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPost200ResponseLanguageDetectedLanguage:
        """Test CheckPost200ResponseLanguageDetectedLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPost200ResponseLanguageDetectedLanguage`
        """
        model = CheckPost200ResponseLanguageDetectedLanguage()
        if include_optional:
            return CheckPost200ResponseLanguageDetectedLanguage(
                code = '',
                name = ''
            )
        else:
    ...
    def testCheckPost200ResponseLanguageDetectedLanguage(self):
        """Test CheckPost200ResponseLanguageDetectedLanguage"""
