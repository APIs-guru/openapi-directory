...
class TestLanguagesGet200ResponseInner(unittest.TestCase):
    """LanguagesGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LanguagesGet200ResponseInner:
        """Test LanguagesGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguagesGet200ResponseInner`
        """
        model = LanguagesGet200ResponseInner()
        if include_optional:
    ...
    def testLanguagesGet200ResponseInner(self):
        """Test LanguagesGet200ResponseInner"""
