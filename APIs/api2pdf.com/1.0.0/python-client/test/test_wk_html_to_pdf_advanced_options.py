...
class TestWkHtmlToPdfAdvancedOptions(unittest.TestCase):
    """WkHtmlToPdfAdvancedOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WkHtmlToPdfAdvancedOptions:
        """Test WkHtmlToPdfAdvancedOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WkHtmlToPdfAdvancedOptions`
        """
        model = WkHtmlToPdfAdvancedOptions()
        if include_optional:
    ...
    def testWkHtmlToPdfAdvancedOptions(self):
        """Test WkHtmlToPdfAdvancedOptions"""
