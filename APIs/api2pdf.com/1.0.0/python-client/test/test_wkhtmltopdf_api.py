...
class TestWkhtmltopdfApi(unittest.TestCase):
    """WkhtmltopdfApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WkhtmltopdfApi()

    def tearDown(self) -> None:
        pass

    def test_wkhtmltopdf_from_html_post(self) -> None:
    ...
    def test_wkhtmltopdf_from_url_get(self) -> None:
    ...
    def test_wkhtmltopdf_from_url_post(self) -> None:
