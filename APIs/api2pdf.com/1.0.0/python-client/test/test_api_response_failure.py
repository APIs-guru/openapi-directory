...
class TestApiResponseFailure(unittest.TestCase):
    """ApiResponseFailure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseFailure:
        """Test ApiResponseFailure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseFailure`
        """
        model = ApiResponseFailure()
        if include_optional:
    ...
    def testApiResponseFailure(self):
        """Test ApiResponseFailure"""
