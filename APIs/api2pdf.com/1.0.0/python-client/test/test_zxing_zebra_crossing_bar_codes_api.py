...
class TestZXINGZebraCrossingBarCodesApi(unittest.TestCase):
    """ZXINGZebraCrossingBarCodesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ZXINGZebraCrossingBarCodesApi()

    def tearDown(self) -> None:
        pass

    def test_zebra_get(self) -> None:
