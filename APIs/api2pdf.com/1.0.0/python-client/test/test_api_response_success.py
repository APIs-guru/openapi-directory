...
class TestApiResponseSuccess(unittest.TestCase):
    """ApiResponseSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseSuccess:
        """Test ApiResponseSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseSuccess`
        """
        model = ApiResponseSuccess()
        if include_optional:
    ...
    def testApiResponseSuccess(self):
        """Test ApiResponseSuccess"""
