...
class TestWkHtmlToPdfHtmlToPdfRequest(unittest.TestCase):
    """WkHtmlToPdfHtmlToPdfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WkHtmlToPdfHtmlToPdfRequest:
        """Test WkHtmlToPdfHtmlToPdfRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WkHtmlToPdfHtmlToPdfRequest`
        """
        model = WkHtmlToPdfHtmlToPdfRequest()
        if include_optional:
            return WkHtmlToPdfHtmlToPdfRequest(
                file_name = 'test.pdf',
                html = '<p>Hello World</p>',
                inline_pdf = True,
                options = openapi_client.models.wk_html_to_pdf_advanced_options.WkHtmlToPdfAdvancedOptions(
    ...
    def testWkHtmlToPdfHtmlToPdfRequest(self):
        """Test WkHtmlToPdfHtmlToPdfRequest"""
