...
class TestChromeHtmlToPdfRequest(unittest.TestCase):
    """ChromeHtmlToPdfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChromeHtmlToPdfRequest:
        """Test ChromeHtmlToPdfRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChromeHtmlToPdfRequest`
        """
        model = ChromeHtmlToPdfRequest()
        if include_optional:
    ...
    def testChromeHtmlToPdfRequest(self):
        """Test ChromeHtmlToPdfRequest"""
