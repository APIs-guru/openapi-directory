...
class TestChromeUrlToPdfRequest(unittest.TestCase):
    """ChromeUrlToPdfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChromeUrlToPdfRequest:
        """Test ChromeUrlToPdfRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChromeUrlToPdfRequest`
        """
        model = ChromeUrlToPdfRequest()
        if include_optional:
            return ChromeUrlToPdfRequest(
                file_name = 'test.pdf',
                inline_pdf = True,
                options = openapi_client.models.chrome_advanced_options.ChromeAdvancedOptions(
                    landscape = 'true', 
    ...
    def testChromeUrlToPdfRequest(self):
        """Test ChromeUrlToPdfRequest"""
