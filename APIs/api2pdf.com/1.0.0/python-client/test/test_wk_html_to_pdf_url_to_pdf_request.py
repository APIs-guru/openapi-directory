...
class TestWkHtmlToPdfUrlToPdfRequest(unittest.TestCase):
    """WkHtmlToPdfUrlToPdfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WkHtmlToPdfUrlToPdfRequest:
        """Test WkHtmlToPdfUrlToPdfRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WkHtmlToPdfUrlToPdfRequest`
        """
        model = WkHtmlToPdfUrlToPdfRequest()
        if include_optional:
    ...
    def testWkHtmlToPdfUrlToPdfRequest(self):
        """Test WkHtmlToPdfUrlToPdfRequest"""
