...
class TestLibreOfficeConvertRequest(unittest.TestCase):
    """LibreOfficeConvertRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LibreOfficeConvertRequest:
        """Test LibreOfficeConvertRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LibreOfficeConvertRequest`
        """
        model = LibreOfficeConvertRequest()
        if include_optional:
    ...
    def testLibreOfficeConvertRequest(self):
        """Test LibreOfficeConvertRequest"""
