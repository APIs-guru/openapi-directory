...
class TestChromeAdvancedOptions(unittest.TestCase):
    """ChromeAdvancedOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChromeAdvancedOptions:
        """Test ChromeAdvancedOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChromeAdvancedOptions`
        """
        model = ChromeAdvancedOptions()
        if include_optional:
    ...
    def testChromeAdvancedOptions(self):
        """Test ChromeAdvancedOptions"""
