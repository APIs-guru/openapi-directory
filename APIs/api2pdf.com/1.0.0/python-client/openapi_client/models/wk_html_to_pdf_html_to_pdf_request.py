...
class WkHtmlToPdfHtmlToPdfRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fileName", "html", "inlinePdf", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": WkHtmlToPdfAdvancedOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
