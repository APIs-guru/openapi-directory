...
class ChromeUrlToPdfRequest(BaseModel):
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["fileName", "inlinePdf", "options", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": ChromeAdvancedOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "url": obj.get("url")
        })
        return _obj
