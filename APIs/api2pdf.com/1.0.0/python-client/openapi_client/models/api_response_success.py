...
class ApiResponseSuccess(BaseModel):
    ...
    ApiResponseSuccess
    """ # noqa: E501
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost of the operation (mbIn + mbOut) * $.001")
    mb_in: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of megabytes of bandwidth used to process the pdf", alias="mbIn")
    mb_out: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of megabytes of bandwidth generated from the resulting pdf", alias="mbOut")
    pdf: Optional[StrictStr] = Field(default=None, description="A url to the PDF that will exist only for 24 hours")
    success: Optional[StrictBool] = Field(default=None, description="Will be true if the operation suceeded")
    __properties: ClassVar[List[str]] = ["cost", "mbIn", "mbOut", "pdf", "success"]
