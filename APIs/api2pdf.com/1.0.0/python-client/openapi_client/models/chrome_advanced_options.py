...
class ChromeAdvancedOptions(BaseModel):
    ...
    """ # noqa: E501
    landscape: Optional[StrictStr] = None
    print_background: Optional[StrictBool] = Field(default=None, alias="printBackground")
    __properties: ClassVar[List[str]] = ["landscape", "printBackground"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChromeAdvancedOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChromeAdvancedOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "printBackground": obj.get("printBackground")
        })
        return _obj
