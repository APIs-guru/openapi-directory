...
class WkhtmltopdfApi:
    ...
    def wkhtmltopdf_from_html_post(
        ...
        :param wk_html_to_pdf_html_to_pdf_request: A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `html` *(string, required)* - raw HTML to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).
        :type wk_html_to_pdf_html_to_pdf_request: WkHtmlToPdfHtmlToPdfRequest
        ...
        _param = self._wkhtmltopdf_from_html_post_serialize(
            wk_html_to_pdf_html_to_pdf_request=wk_html_to_pdf_html_to_pdf_request,
    ...
    @validate_call
    def wkhtmltopdf_from_html_post_with_http_info(
        self,
        wk_html_to_pdf_html_to_pdf_request: Annotated[Optional[WkHtmlToPdfHtmlToPdfRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `html` *(string, required)* - raw HTML to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def wkhtmltopdf_from_html_post_without_preload_content(
        self,
        wk_html_to_pdf_html_to_pdf_request: Annotated[Optional[WkHtmlToPdfHtmlToPdfRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `html` *(string, required)* - raw HTML to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).")] = None,
        _request_timeout: Union[
            None,
    ...
    def _wkhtmltopdf_from_html_post_serialize(
        self,
        wk_html_to_pdf_html_to_pdf_request,
        _request_auth,
        _content_type,
        ...
        if wk_html_to_pdf_html_to_pdf_request is not None:
            _body_params = wk_html_to_pdf_html_to_pdf_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/wkhtmltopdf/html',
    ...
    def wkhtmltopdf_from_url_get(
        ...
        _param = self._wkhtmltopdf_from_url_get_serialize(
            url=url,
            output=output,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def wkhtmltopdf_from_url_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="Url of the page to convert to PDF. Must start with http:// or https://.")],
        output: Annotated[Optional[StrictStr], Field(description="Specify output=json to receive a JSON output. Defaults to PDF file.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def wkhtmltopdf_from_url_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="Url of the page to convert to PDF. Must start with http:// or https://.")],
        output: Annotated[Optional[StrictStr], Field(description="Specify output=json to receive a JSON output. Defaults to PDF file.")] = None,
        _request_timeout: Union[
    ...
    def _wkhtmltopdf_from_url_get_serialize(
        self,
        url,
        output,
        _request_auth,
    ...
    def wkhtmltopdf_from_url_post(
        ...
        :param wk_html_to_pdf_url_to_pdf_request: A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - Url to the web page to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).
        :type wk_html_to_pdf_url_to_pdf_request: WkHtmlToPdfUrlToPdfRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._wkhtmltopdf_from_url_post_serialize(
            wk_html_to_pdf_url_to_pdf_request=wk_html_to_pdf_url_to_pdf_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def wkhtmltopdf_from_url_post_with_http_info(
        self,
        wk_html_to_pdf_url_to_pdf_request: Annotated[Optional[WkHtmlToPdfUrlToPdfRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - Url to the web page to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def wkhtmltopdf_from_url_post_without_preload_content(
        self,
        wk_html_to_pdf_url_to_pdf_request: Annotated[Optional[WkHtmlToPdfUrlToPdfRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - Url to the web page to convert to PDF - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. - `options` *(object, optional)* - Include advanced WkHtmlToPdf options like margins, headers, and footers. [See full list of advanced options here](https://www.api2pdf.com/documentation/advanced-options-wkhtmltopdf/).")] = None,
        _request_timeout: Union[
            None,
    ...
    def _wkhtmltopdf_from_url_post_serialize(
        self,
        wk_html_to_pdf_url_to_pdf_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if wk_html_to_pdf_url_to_pdf_request is not None:
            _body_params = wk_html_to_pdf_url_to_pdf_request
