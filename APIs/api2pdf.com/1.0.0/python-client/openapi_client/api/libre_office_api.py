...
class LibreOfficeApi:
    ...
    def libre_convert_post(
        ...
        :param libre_office_convert_request: A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - A direct URL to the file. Api2Pdf will consume the file at that URL and then convert it. - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. 
        :type libre_office_convert_request: LibreOfficeConvertRequest
        ...
        _param = self._libre_convert_post_serialize(
            libre_office_convert_request=libre_office_convert_request,
    ...
    @validate_call
    def libre_convert_post_with_http_info(
        self,
        libre_office_convert_request: Annotated[Optional[LibreOfficeConvertRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - A direct URL to the file. Api2Pdf will consume the file at that URL and then convert it. - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. ")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def libre_convert_post_without_preload_content(
        self,
        libre_office_convert_request: Annotated[Optional[LibreOfficeConvertRequest], Field(description="A JSON object as a payload is required within the body of the request. The following attributes of the JSON object are detailed below: - `url` *(string, required)* - A direct URL to the file. Api2Pdf will consume the file at that URL and then convert it. - `inlinePdf` *(boolean, optional)* - Open the PDF in a browser window. Default to false. - `fileName` *(string, optional)* - Specify a file name for the output PDF. Random name if not specified. ")] = None,
        _request_timeout: Union[
            None,
    ...
    def _libre_convert_post_serialize(
        self,
        libre_office_convert_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if libre_office_convert_request is not None:
            _body_params = libre_office_convert_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/libreoffice/convert',
