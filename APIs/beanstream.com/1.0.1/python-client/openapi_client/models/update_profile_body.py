...
class UpdateProfileBody(BaseModel):
    ...
    card: Optional[ProfileToken] = None
    ...
    __properties: ClassVar[List[str]] = ["billing", "card", "comment", "custom", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "card": ProfileToken.from_dict(obj["card"]) if obj.get("card") is not None else None,
