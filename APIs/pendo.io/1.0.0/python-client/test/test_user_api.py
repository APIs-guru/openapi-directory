...
class TestUserApi(unittest.TestCase):
    ...
    def test_users_id_tags_delete(self) -> None:
    ...
    def test_users_id_tags_get(self) -> None:
    ...
    def test_users_id_tags_post(self) -> None:
    ...
    def test_users_invite_end_user_post(self) -> None:
    ...
    def test_users_invite_vendor_user_post(self) -> None:
    ...
    def test_vendor_users_post(self) -> None:
