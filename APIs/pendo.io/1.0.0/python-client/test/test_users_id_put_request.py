...
class TestUsersIdPutRequest(unittest.TestCase):
    """UsersIdPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersIdPutRequest:
        """Test UsersIdPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdPutRequest`
        """
        model = UsersIdPutRequest()
        if include_optional:
            return UsersIdPutRequest(
                email = '',
                external_id = '',
                name = '',
    ...
    def testUsersIdPutRequest(self):
        """Test UsersIdPutRequest"""
