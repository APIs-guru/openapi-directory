...
class TestHooksUnsubscribePostRequest(unittest.TestCase):
    """HooksUnsubscribePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HooksUnsubscribePostRequest:
        """Test HooksUnsubscribePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HooksUnsubscribePostRequest`
        """
        model = HooksUnsubscribePostRequest()
        if include_optional:
            return HooksUnsubscribePostRequest(
                target_url = ''
            )
        else:
            return HooksUnsubscribePostRequest(
    ...
    def testHooksUnsubscribePostRequest(self):
        """Test HooksUnsubscribePostRequest"""
