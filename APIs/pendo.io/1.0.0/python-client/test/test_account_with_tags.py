...
class TestAccountWithTags(unittest.TestCase):
    """AccountWithTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountWithTags:
        """Test AccountWithTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountWithTags`
        """
        model = AccountWithTags()
        if include_optional:
            return AccountWithTags(
                created_at = '',
                id = '',
                is_paying = True,
                monthly_value = 1.337,
