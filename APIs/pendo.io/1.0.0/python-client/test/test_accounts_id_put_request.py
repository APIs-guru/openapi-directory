...
class TestAccountsIdPutRequest(unittest.TestCase):
    """AccountsIdPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountsIdPutRequest:
        """Test AccountsIdPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountsIdPutRequest`
        """
        model = AccountsIdPutRequest()
        if include_optional:
            return AccountsIdPutRequest(
                monthly_value = 1.337,
                name = '',
                status = 'paying'
            )
    ...
    def testAccountsIdPutRequest(self):
        """Test AccountsIdPutRequest"""
