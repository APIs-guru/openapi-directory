...
class TestEndUserPing(unittest.TestCase):
    """EndUserPing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndUserPing:
        """Test EndUserPing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndUserPing`
        """
        model = EndUserPing()
        if include_optional:
            return EndUserPing(
                account = openapi_client.models.account_with_tags.AccountWithTags(
                    created_at = '', 
                    id = '', 
                    is_paying = True, 
                    monthly_value = 1.337, 
                ...
                return_url = '',
                user = openapi_client.models.end_user_ping_user.EndUserPing_user(
                    allowed_products = [
                        ''
                        ], 
                    created_at = '', 
