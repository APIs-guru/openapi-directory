...
class TestUsersInviteEndUserPostRequest(unittest.TestCase):
    """UsersInviteEndUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInviteEndUserPostRequest:
        """Test UsersInviteEndUserPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInviteEndUserPostRequest`
        """
        model = UsersInviteEndUserPostRequest()
        if include_optional:
            return UsersInviteEndUserPostRequest(
                account_external_id = '',
                account_name = '',
    ...
    def testUsersInviteEndUserPostRequest(self):
        """Test UsersInviteEndUserPostRequest"""
