...
class TestVendorUsersPostRequest(unittest.TestCase):
    """VendorUsersPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorUsersPostRequest:
        """Test VendorUsersPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorUsersPostRequest`
        """
        model = VendorUsersPostRequest()
        if include_optional:
            return VendorUsersPostRequest(
                email = '',
                external_id = '',
                full_name = '',
    ...
    def testVendorUsersPostRequest(self):
        """Test VendorUsersPostRequest"""
