...
class TestEndUserPingUser(unittest.TestCase):
    """EndUserPingUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndUserPingUser:
        """Test EndUserPingUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndUserPingUser`
        """
        model = EndUserPingUser()
        if include_optional:
            return EndUserPingUser(
                allowed_products = [
                    ''
                    ],
                created_at = '',
