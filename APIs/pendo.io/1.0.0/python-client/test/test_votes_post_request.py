...
class TestVotesPostRequest(unittest.TestCase):
    """VotesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VotesPostRequest:
        """Test VotesPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VotesPostRequest`
        """
        model = VotesPostRequest()
        if include_optional:
            return VotesPostRequest(
                user_id = '',
                votes = [
                    openapi_client.models.feature_vote.FeatureVote(
                        feature_id = '', 
                        quantity = 56, )
                    ]
            )
