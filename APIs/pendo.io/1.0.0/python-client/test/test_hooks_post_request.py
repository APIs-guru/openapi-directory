...
class TestHooksPostRequest(unittest.TestCase):
    """HooksPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HooksPostRequest:
        """Test HooksPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HooksPostRequest`
        """
        model = HooksPostRequest()
        if include_optional:
