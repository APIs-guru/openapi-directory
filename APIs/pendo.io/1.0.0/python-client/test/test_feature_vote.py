...
class TestFeatureVote(unittest.TestCase):
    """FeatureVote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureVote:
        """Test FeatureVote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureVote`
        """
        model = FeatureVote()
        if include_optional:
            return FeatureVote(
