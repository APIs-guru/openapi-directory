...
class TestUsersInviteVendorUserPostRequest(unittest.TestCase):
    """UsersInviteVendorUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInviteVendorUserPostRequest:
        """Test UsersInviteVendorUserPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInviteVendorUserPostRequest`
        """
        model = UsersInviteVendorUserPostRequest()
        if include_optional:
            return UsersInviteVendorUserPostRequest(
                email = '',
                external_id = '',
                full_name = '',
                permission_group_id = 1.337,
                team = ''
            )
        else:
            return UsersInviteVendorUserPostRequest(
    ...
    def testUsersInviteVendorUserPostRequest(self):
        """Test UsersInviteVendorUserPostRequest"""
