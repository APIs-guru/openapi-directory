...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.feedback.eu.pendo.io" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'userApiKey (query parameter)' in self.api_key:
            auth['userApiKey (query parameter)'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'auth-token',
        ...
        if 'userApiKey (request header)' in self.api_key:
            auth['userApiKey (request header)'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'auth-token',
                'value': self.get_api_key_with_prefix(
