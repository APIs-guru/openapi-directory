...
class SystemApi:
    ...
    def health_check_ping_get(
        ...
        _param = self._health_check_ping_get_serialize(
    ...
    @validate_call
    def health_check_ping_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def health_check_ping_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _health_check_ping_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health-check/ping',
