...
class UsersInviteEndUserPostRequest(BaseModel):
    """
    UsersInviteEndUserPostRequest
    """ # noqa: E501
    account_external_id: Optional[StrictStr] = None
    account_name: Optional[StrictStr] = None
    account_status: StrictStr
    email: Optional[StrictStr] = None
    full_name: Optional[StrictStr] = None
    monthly_value: Optional[Union[StrictFloat, StrictInt]] = None
    send_invite: Optional[StrictBool] = None
    user_external_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["account_external_id", "account_name", "account_status", "email", "full_name", "monthly_value", "send_invite", "user_external_id"]

    @field_validator('account_status')
    def account_status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['prospect', 'not_paying', 'paying']):
            raise ValueError("must be one of enum values ('prospect', 'not_paying', 'paying')")
        return value
