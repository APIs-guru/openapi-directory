...
class Vote(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="A negative number indicates that the User has indicated \"Not Interested\" in a Features. Between 0 and 1000000 is the User's current prioritization of the Feature.")
    updated_at: Optional[StrictStr] = None
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_at", "feature_id", "quantity", "updated_at", "user_id"]
