...
class UsersIdPutRequest(BaseModel):
    ...
    permission_group_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="only valid for users with role 'vendorUser'")
    __properties: ClassVar[List[str]] = ["email", "external_id", "name", "permission_group_id"]
