...
class AccountsIdPutRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["monthly_value", "name", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['paying', 'prospect', 'not_paying']):
            raise ValueError("must be one of enum values ('paying', 'prospect', 'not_paying')")
        return value
