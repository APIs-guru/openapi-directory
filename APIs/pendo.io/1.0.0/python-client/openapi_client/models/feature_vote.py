...
class FeatureVote(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="Value between -1 and 1000000. -1 indicates that the User is \"Not Interested\" in the feature.")
    __properties: ClassVar[List[str]] = ["feature_id", "quantity"]
