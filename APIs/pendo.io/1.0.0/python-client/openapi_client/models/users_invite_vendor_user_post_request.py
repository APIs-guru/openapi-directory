...
class UsersInviteVendorUserPostRequest(BaseModel):
    """
    ...
    full_name: StrictStr
    permission_group_id: Optional[Union[StrictFloat, StrictInt]] = None
    team: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["email", "external_id", "full_name", "permission_group_id", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permission_group_id": obj.get("permission_group_id"),
            "team": obj.get("team")
        })
        return _obj
