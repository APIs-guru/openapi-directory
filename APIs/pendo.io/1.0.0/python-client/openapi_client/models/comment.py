...
class Comment(BaseModel):
    ...
    is_private: Optional[StrictBool] = Field(default=None, description="Is this Comment hidden from EndUsers?")
    text: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_at", "feature_id", "is_private", "text", "updated_at", "user_id"]
