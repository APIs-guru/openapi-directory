...
class Account(BaseModel):
    ...
    external_id: Optional[StrictStr] = Field(default=None, description="ID for the Account, provided by the Feedback Customer")
    id: Optional[StrictStr] = None
    is_paying: Optional[StrictBool] = None
    monthly_value: Optional[Union[StrictFloat, StrictInt]] = None
    name: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "external_id", "id", "is_paying", "monthly_value", "name", "status"]
