...
class EndUserPing(BaseModel):
    """
    EndUserPing
    """ # noqa: E501
    account: Optional[AccountWithTags] = None
    return_url: Optional[StrictStr] = None
    user: Optional[EndUserPingUser] = None
    __properties: ClassVar[List[str]] = ["account", "return_url", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": AccountWithTags.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "return_url": obj.get("return_url"),
            "user": EndUserPingUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
