...
class ContactEntity(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="Contact Identifier")
    ...
    sync_to_outlook: Optional[StrictBool] = Field(default=None, description="Sync To Outlook")
    ...
    __properties: ClassVar[List[str]] = ["address", "birth_date", "created_at", "department", "description", "do_not_call", "email", "first_name", "id", "last_name", "lead_source", "messenger", "middle_name", "name_suffix", "phone", "position", "relation", "salutation", "sync_to_outlook", "type", "updated_at", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sync_to_outlook": obj.get("sync_to_outlook"),
            "type": obj.get("type"),
