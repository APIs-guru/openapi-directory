...
class EventEntity(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="Event Identifier")
    is_all_day: Optional[StrictBool] = Field(default=None, description="Is All Day")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "description", "ended_at", "id", "is_all_day", "location", "relation", "started_at", "status", "subject", "updated_at"]
