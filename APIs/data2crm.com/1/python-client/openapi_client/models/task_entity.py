...
class TaskEntity(BaseModel):
    ...
    reminder_at: Optional[datetime] = Field(default=None, description="Remainder At")
    started_at: Optional[datetime] = Field(default=None, description="Started At")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    subject: Optional[StrictStr] = Field(default=None, description="Name")
    updated_at: Optional[datetime] = Field(default=None, description="Updated At")
    __properties: ClassVar[List[str]] = ["created_at", "description", "due_at", "ended_at", "id", "priority", "relation", "reminder_at", "started_at", "status", "subject", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reminder_at": obj.get("reminder_at"),
