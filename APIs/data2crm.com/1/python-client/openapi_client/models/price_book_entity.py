...
class PriceBookEntity(BaseModel):
    """
    PriceBookEntity
    """ # noqa: E501
    ...
    id: Optional[StrictStr] = Field(default=None, description="PriceBook Identifier")
    is_active: Optional[StrictBool] = Field(default=None, description="Is Active")
    is_standard: Optional[StrictBool] = Field(default=None, description="Is Standard")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    relation: Optional[Relation] = None
    type: Optional[StrictStr] = Field(default=None, description="Number")
    updated_at: Optional[datetime] = Field(default=None, description="Updated At")
    __properties: ClassVar[List[str]] = ["created_at", "currency", "description", "id", "is_active", "is_standard", "name", "relation", "type", "updated_at"]
