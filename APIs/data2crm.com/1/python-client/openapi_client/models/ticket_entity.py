...
class TicketEntity(BaseModel):
    ...
    due_at: Optional[datetime] = Field(default=None, description="Due At")
    email: Optional[List[Email]] = Field(default=None, description="Email")
    id: Optional[StrictStr] = Field(default=None, description="Ticket Identifier")
    ...
    resolution: Optional[StrictStr] = Field(default=None, description="Resolution")
    ...
    __properties: ClassVar[List[str]] = ["category", "closed_at", "created_at", "description", "due_at", "email", "id", "number", "pipeline_with_stage", "priority", "relation", "resolution", "source", "subject", "updated_at"]
