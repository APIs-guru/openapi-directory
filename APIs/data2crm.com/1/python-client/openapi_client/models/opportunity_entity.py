...
class OpportunityEntity(BaseModel):
    ...
    ended_at: Optional[datetime] = Field(default=None, description="Closed At")
    expected_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Expected Amount")
    expected_end_at: Optional[datetime] = Field(default=None, description="Expected End At")
    id: Optional[StrictStr] = Field(default=None, description="Opportunity Identifier")
    lead_source: Optional[StrictStr] = Field(default=None, description="Lead Source")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    next_step: Optional[StrictStr] = Field(default=None, description="Next Step")
    pipeline_with_stage: Optional[StrictStr] = Field(default=None, description="Pipeline With Stage")
    probability: Optional[StrictInt] = Field(default=None, description="Probability")
    ...
    __properties: ClassVar[List[str]] = ["amount", "created_at", "currency", "description", "ended_at", "expected_amount", "expected_end_at", "id", "lead_source", "name", "next_step", "pipeline_with_stage", "probability", "relation", "state", "type", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pipeline_with_stage": obj.get("pipeline_with_stage"),
