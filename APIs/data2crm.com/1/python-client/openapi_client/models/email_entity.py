...
class EmailEntity(BaseModel):
    ...
    EmailEntity
    """ # noqa: E501
    bcc: Optional[List[StrictStr]] = Field(default=None, description="BCC")
    body: Optional[StrictStr] = Field(default=None, description="Body")
    cc: Optional[List[StrictStr]] = Field(default=None, description="CC")
    ...
    sent_at: Optional[datetime] = Field(default=None, description="Sent At")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    subject: Optional[StrictStr] = Field(default=None, description="Subject")
    to: Optional[List[StrictStr]] = Field(default=None, description="To")
    updated_at: Optional[datetime] = Field(default=None, description="Updated At")
    __properties: ClassVar[List[str]] = ["bcc", "body", "cc", "created_at", "direction", "from", "id", "relation", "sent_at", "status", "subject", "to", "updated_at"]
