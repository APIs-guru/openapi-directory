...
class MeetingEntity(BaseModel):
    ...
    result: Optional[StrictStr] = Field(default=None, description="Result")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "description", "ended_at", "id", "location", "relation", "result", "started_at", "status", "subject", "updated_at"]
