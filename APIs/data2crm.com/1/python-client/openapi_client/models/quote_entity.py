...
class QuoteEntity(BaseModel):
    ...
    carrier: Optional[StrictStr] = Field(default=None, description="Carrier")
    ...
    id: Optional[StrictStr] = Field(default=None, description="Quote Identifier")
    ...
    __properties: ClassVar[List[str]] = ["address", "adjustment", "carrier", "created_at", "currency", "description", "discount", "expiration_date", "grand_total", "id", "number", "payment_terms", "relation", "shipping_and_handling", "status", "subject", "subtotal", "tax", "terms_and_conditions", "total_price", "updated_at"]
