...
class PriceBookItemEntity(BaseModel):
    """
    PriceBookItemEntity
    """ # noqa: E501
    ...
    use_standard_price: Optional[StrictBool] = Field(default=None, description="Is Standard")
    __properties: ClassVar[List[str]] = ["code", "created_at", "id", "is_active", "name", "price", "relation", "updated_at", "use_standard_price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_standard_price": obj.get("use_standard_price")
        })
        return _obj
