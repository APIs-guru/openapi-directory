...
class PriceBookItemRelation(BaseModel):
    """
    PriceBookItemRelation
    """ # noqa: E501
    entity: Optional[PriceBookItemEntityRelation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entity": PriceBookItemEntityRelation.from_dict(obj["entity"]) if obj.get("entity") is not None else None,
            "type": obj.get("type")
        })
        return _obj
