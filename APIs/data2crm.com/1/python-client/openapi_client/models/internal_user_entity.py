...
class InternalUserEntity(BaseModel):
    """
    InternalUserEntity
    """ # noqa: E501
    ...
    internal_request_count: Optional[StrictInt] = Field(default=None, description="Internal Request Count")
    ...
    request_count: Optional[StrictInt] = Field(default=None, description="Request Count")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "email", "internal_request_count", "key", "last_used_at", "name", "organization", "phone", "request_count", "roles", "status", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "internal_request_count": obj.get("internal_request_count"),
            "key": obj.get("key"),
