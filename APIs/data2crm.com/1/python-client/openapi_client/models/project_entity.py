...
class ProjectEntity(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Body")
    ...
    __properties: ClassVar[List[str]] = ["category", "created_at", "description", "ended_at", "id", "name", "pipeline_with_stage", "priority", "relation", "started_at", "status", "updated_at"]
