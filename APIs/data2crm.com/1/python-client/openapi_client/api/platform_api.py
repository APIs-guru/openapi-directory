...
class PlatformApi:
    ...
    def get_platform_collection(
        ...
        _param = self._get_platform_collection_serialize(
    ...
    @validate_call
    def get_platform_collection_with_http_info(
        self,
        x_api2_crm_user_key: Annotated[StrictStr, Field(description="API2CRM user key")],
        page_size: Annotated[Optional[StrictInt], Field(description="Amount of results (default: 25)")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page to show (default: 1)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PlatformEntity]]:
        """GET for platform
    ...
    @validate_call
    def get_platform_collection_without_preload_content(
        self,
        x_api2_crm_user_key: Annotated[StrictStr, Field(description="API2CRM user key")],
        page_size: Annotated[Optional[StrictInt], Field(description="Amount of results (default: 25)")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page to show (default: 1)")] = None,
    ...
    def _get_platform_collection_serialize(
        self,
        x_api2_crm_user_key,
        page_size,
        page,
    ...
    def get_platform_entity(
        self,
        x_api2_crm_user_key: Annotated[StrictStr, Field(description="API2CRM user key")],
        type: Annotated[StrictStr, Field(description="Platform type")],
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_platform_entity_serialize(
            x_api2_crm_user_key=x_api2_crm_user_key,
            type=type,
            fields=fields,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_platform_entity_with_http_info(
        self,
        x_api2_crm_user_key: Annotated[StrictStr, Field(description="API2CRM user key")],
        type: Annotated[StrictStr, Field(description="Platform type")],
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
    ...
    @validate_call
    def get_platform_entity_without_preload_content(
        self,
        x_api2_crm_user_key: Annotated[StrictStr, Field(description="API2CRM user key")],
        type: Annotated[StrictStr, Field(description="Platform type")],
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
    ...
    def _get_platform_entity_serialize(
        self,
        x_api2_crm_user_key,
        type,
        fields,
