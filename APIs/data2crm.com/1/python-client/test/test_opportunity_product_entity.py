...
class TestOpportunityProductEntity(unittest.TestCase):
    """OpportunityProductEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpportunityProductEntity:
        """Test OpportunityProductEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpportunityProductEntity`
        """
        model = OpportunityProductEntity()
        if include_optional:
    ...
    def testOpportunityProductEntity(self):
        """Test OpportunityProductEntity"""
