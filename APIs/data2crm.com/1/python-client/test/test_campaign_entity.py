    ...
    def make_instance(self, include_optional) -> CampaignEntity:
        ...
        if include_optional:
            return CampaignEntity(
                ...
                expected_response = 4235.91,
                expected_revenue = 4235.91,
                expected_start_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                id = '21312411',
                is_active = True,
