    ...
    def make_instance(self, include_optional) -> ApplicationEntity:
        ...
        if include_optional:
            return ApplicationEntity(
                ...
                me = openapi_client.models.user_entity.UserEntity(
                    address = [
                    ...
                    username = 'billwall777', 
                    website = [
                        openapi_client.models.website.Website(
                            type = 'Work', )
                        ], ),
                plan = '',
                requests_limit = openapi_client.models.requests_limit.RequestsLimit(
                    is_exceeded = True, 
                    retry_after = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    type = [
