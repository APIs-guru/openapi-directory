...
class TestTagRelation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TagRelation:
        """Test TagRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagRelation`
        """
        model = TagRelation()
        if include_optional:
            return TagRelation(
