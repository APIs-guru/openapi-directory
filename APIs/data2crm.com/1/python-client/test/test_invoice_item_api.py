...
class TestInvoiceItemApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = InvoiceItemApi()

    def tearDown(self) -> None:
        pass

    def test_create_invoice_item_entity(self) -> None:
    ...
    def test_create_invoice_item_entity_bulk(self) -> None:
    ...
    def test_delete_invoice_item_collection_bulk(self) -> None:
    ...
    def test_delete_invoice_item_entity(self) -> None:
    ...
    def test_get_invoice_item_aggregate(self) -> None:
    ...
    def test_get_invoice_item_collection(self) -> None:
    ...
    def test_get_invoice_item_count_collection(self) -> None:
    ...
    def test_get_invoice_item_describe(self) -> None:
    ...
    def test_get_invoice_item_entity(self) -> None:
    ...
    def test_update_invoice_item_entity(self) -> None:
    ...
    def test_update_invoice_item_entity_bulk(self) -> None:
