...
class TestInvoiceEntity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InvoiceEntity:
        """Test InvoiceEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceEntity`
        """
        model = InvoiceEntity()
        if include_optional:
            return InvoiceEntity(
                ...
                due_date = 'Sat Nov 27 19:00:00 EST 1982',
                excise_duty = 4235.91,
                grand_total = 4235.91,
                id = '21312411',
                invoice_date = 'Sat Nov 27 19:00:00 EST 1982',
                number = '21312411',
                purchase_order = 'Order for notebook',
                received = 4235.91,
