...
class TestFieldItemEntity(unittest.TestCase):
    """FieldItemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FieldItemEntity:
        """Test FieldItemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FieldItemEntity`
        """
        model = FieldItemEntity()
        if include_optional:
