...
class TestCampaignApi(unittest.TestCase):
    ...
    def test_create_campaign_entity(self) -> None:
    ...
    def test_create_campaign_entity_bulk(self) -> None:
    ...
    def test_delete_campaign_collection_bulk(self) -> None:
    ...
    def test_delete_campaign_entity(self) -> None:
    ...
    def test_get_campaign_aggregate(self) -> None:
    ...
    def test_get_campaign_collection(self) -> None:
    ...
    def test_get_campaign_count_collection(self) -> None:
    ...
    def test_get_campaign_describe(self) -> None:
    ...
    def test_get_campaign_entity(self) -> None:
    ...
    def test_update_campaign_entity(self) -> None:
    ...
    def test_update_campaign_entity_bulk(self) -> None:
