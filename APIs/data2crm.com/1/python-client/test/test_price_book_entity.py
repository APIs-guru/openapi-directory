...
class TestPriceBookEntity(unittest.TestCase):
    """PriceBookEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceBookEntity:
        """Test PriceBookEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceBookEntity`
        """
        model = PriceBookEntity()
        if include_optional:
