...
class TestAttachmentEntityWrite(unittest.TestCase):
    """AttachmentEntityWrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentEntityWrite:
        """Test AttachmentEntityWrite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentEntityWrite`
        """
        model = AttachmentEntityWrite()
        if include_optional:
            return AttachmentEntityWrite(
    ...
    def testAttachmentEntityWrite(self):
        """Test AttachmentEntityWrite"""
