...
class TestAttachmentEntityList(unittest.TestCase):
    """AttachmentEntityList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentEntityList:
        """Test AttachmentEntityList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentEntityList`
        """
        model = AttachmentEntityList()
        if include_optional:
            return AttachmentEntityList(
                ...
                size = 34345,
                title = 'Employees List File (json)',
    ...
    def testAttachmentEntityList(self):
        """Test AttachmentEntityList"""
