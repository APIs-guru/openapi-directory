...
class TestCallEntity(unittest.TestCase):
    """CallEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallEntity:
        """Test CallEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallEntity`
        """
        model = CallEntity()
        if include_optional:
            return CallEntity(
