...
class TestOpportunityEntity(unittest.TestCase):
    """OpportunityEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpportunityEntity:
        """Test OpportunityEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpportunityEntity`
        """
        model = OpportunityEntity()
        if include_optional:
    ...
    def testOpportunityEntity(self):
        """Test OpportunityEntity"""
