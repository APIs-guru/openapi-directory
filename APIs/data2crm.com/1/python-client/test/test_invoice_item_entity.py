...
class TestInvoiceItemEntity(unittest.TestCase):
    """InvoiceItemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceItemEntity:
        """Test InvoiceItemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceItemEntity`
        """
        model = InvoiceItemEntity()
        if include_optional:
    ...
    def testInvoiceItemEntity(self):
        """Test InvoiceItemEntity"""
