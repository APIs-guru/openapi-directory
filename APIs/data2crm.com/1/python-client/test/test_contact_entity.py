...
class TestContactEntity(unittest.TestCase):
    """ContactEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactEntity:
        """Test ContactEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactEntity`
        """
        model = ContactEntity()
        if include_optional:
