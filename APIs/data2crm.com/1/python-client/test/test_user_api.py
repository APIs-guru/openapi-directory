...
class TestUserApi(unittest.TestCase):
    ...
    def test_create_user_entity_bulk(self) -> None:
    ...
    def test_delete_user_collection_bulk(self) -> None:
    ...
    def test_delete_user_entity(self) -> None:
    ...
    def test_get_user_aggregate(self) -> None:
    ...
    def test_get_user_count_collection(self) -> None:
    ...
    def test_get_user_describe(self) -> None:
    ...
    def test_update_user_entity(self) -> None:
    ...
    def test_update_user_entity_bulk(self) -> None:
