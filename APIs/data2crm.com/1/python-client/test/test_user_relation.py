...
class TestUserRelation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserRelation:
        """Test UserRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserRelation`
        """
        model = UserRelation()
        if include_optional:
            return UserRelation(
