...
class TestEntityItemEntity(unittest.TestCase):
    """EntityItemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityItemEntity:
        """Test EntityItemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityItemEntity`
        """
        model = EntityItemEntity()
        if include_optional:
