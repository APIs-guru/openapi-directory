...
class TestQuoteItemEntity(unittest.TestCase):
    """QuoteItemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteItemEntity:
        """Test QuoteItemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteItemEntity`
        """
        model = QuoteItemEntity()
        if include_optional:
