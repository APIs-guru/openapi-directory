...
class TestPriceBookItemEntity(unittest.TestCase):
    """PriceBookItemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceBookItemEntity:
        """Test PriceBookItemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceBookItemEntity`
        """
        model = PriceBookItemEntity()
        if include_optional:
    ...
    def testPriceBookItemEntity(self):
        """Test PriceBookItemEntity"""
