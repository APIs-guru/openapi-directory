...
class TestAccountApi(unittest.TestCase):
    ...
    def test_create_account_entity(self) -> None:
    ...
    def test_create_account_entity_bulk(self) -> None:
    ...
    def test_delete_account_collection_bulk(self) -> None:
    ...
    def test_delete_account_entity(self) -> None:
    ...
    def test_get_account_aggregate(self) -> None:
    ...
    def test_get_account_count_collection(self) -> None:
    ...
    def test_get_account_describe(self) -> None:
    ...
    def test_get_account_entity(self) -> None:
    ...
    def test_update_account_entity(self) -> None:
    ...
    def test_update_account_entity_bulk(self) -> None:
