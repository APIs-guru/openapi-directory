...
class TestNoteEntity(unittest.TestCase):
    """NoteEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteEntity:
        """Test NoteEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteEntity`
        """
        model = NoteEntity()
        if include_optional:
            return NoteEntity(
