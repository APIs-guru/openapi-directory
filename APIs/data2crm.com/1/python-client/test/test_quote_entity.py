...
class TestQuoteEntity(unittest.TestCase):
    """QuoteEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteEntity:
        """Test QuoteEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteEntity`
        """
        model = QuoteEntity()
        if include_optional:
            return QuoteEntity(
                ...
                expiration_date = 'Sat Nov 27 19:00:00 EST 1982',
                grand_total = 4235.91,
                id = '21312411',
                number = '21312411',
