...
class TestProductApi(unittest.TestCase):
    ...
    def test_create_product_entity(self) -> None:
    ...
    def test_create_product_entity_bulk(self) -> None:
    ...
    def test_delete_product_collection_bulk(self) -> None:
    ...
    def test_delete_product_entity(self) -> None:
    ...
    def test_get_product_aggregate(self) -> None:
    ...
    def test_get_product_count_collection(self) -> None:
    ...
    def test_get_product_describe(self) -> None:
    ...
    def test_get_product_entity(self) -> None:
    ...
    def test_update_product_entity(self) -> None:
    ...
    def test_update_product_entity_bulk(self) -> None:
