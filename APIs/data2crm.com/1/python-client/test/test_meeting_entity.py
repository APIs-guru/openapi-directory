...
class TestMeetingEntity(unittest.TestCase):
    """MeetingEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingEntity:
        """Test MeetingEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingEntity`
        """
        model = MeetingEntity()
        if include_optional:
