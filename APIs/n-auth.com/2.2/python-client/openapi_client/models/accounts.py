...
class Accounts(BaseModel):
    ...
    Accounts
    """ # noqa: E501
    accounts: List[Account] = Field(description="Array of accounts")
    totalnumber: Optional[StrictInt] = Field(default=None, description="total number of accounts")
    __properties: ClassVar[List[str]] = ["accounts", "totalnumber"]
