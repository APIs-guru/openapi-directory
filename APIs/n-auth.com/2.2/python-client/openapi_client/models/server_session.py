...
class ServerSession(BaseModel):
    ...
    ServerSession
    """ # noqa: E501
    serverid: StrictStr = Field(description="Server Id")
    sessionid: StrictStr = Field(description="Base64 encoded nonce")
    __properties: ClassVar[List[str]] = ["serverid", "sessionid"]
