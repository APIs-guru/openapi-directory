...
class HtmlFooterBody(BaseModel):
    """
    HtmlFooterBody
    """ # noqa: E501
    sessions: Optional[List[ServerSession]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HtmlFooterBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HtmlFooterBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sessions": [ServerSession.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
