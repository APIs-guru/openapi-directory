...
class Users(BaseModel):
    ...
    Users
    """ # noqa: E501
    totalnumber: Optional[StrictInt] = Field(default=None, description="total number of users")
    users: List[User] = Field(description="Array of users")
    __properties: ClassVar[List[str]] = ["totalnumber", "users"]
