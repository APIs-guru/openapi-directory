...
class QODResponse(BaseModel):
    """
    QODResponse
    """ # noqa: E501
    contents: Optional[QODResponseContents] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contents": QODResponseContents.from_dict(obj["contents"]) if obj.get("contents") is not None else None,
