...
class TestQODResponseContents(unittest.TestCase):
    """QODResponseContents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QODResponseContents:
        """Test QODResponseContents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QODResponseContents`
        """
        model = QODResponseContents()
        if include_optional:
            return QODResponseContents(
                quotes = [
                    null
                    ]
            )
    ...
    def testQODResponseContents(self):
        """Test QODResponseContents"""
