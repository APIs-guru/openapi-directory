...
class TestQuoteOfTheDayApi(unittest.TestCase):
    """QuoteOfTheDayApi unit test stubs"""

    def setUp(self) -> None:
        self.api = QuoteOfTheDayApi()

    def tearDown(self) -> None:
        pass

    def test_qod_categories_get(self) -> None:
        """Test case for qod_categories_get

        """
        pass

    def test_qod_get(self) -> None:
        """Test case for qod_get

        """
        pass

    def test_qod_languages_get(self) -> None:
