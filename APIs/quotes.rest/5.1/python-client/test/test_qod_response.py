...
class TestQODResponse(unittest.TestCase):
    """QODResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QODResponse:
        """Test QODResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QODResponse`
        """
        model = QODResponse()
        if include_optional:
            return QODResponse(
                contents = openapi_client.models.qod_response_contents.QODResponse_contents(
                    quotes = [
                        null
                        ], ),
                success = ''
