...
class TestNewQuote(unittest.TestCase):
    """NewQuote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewQuote:
        """Test NewQuote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewQuote`
        """
        model = NewQuote()
        if include_optional:
            return NewQuote(
