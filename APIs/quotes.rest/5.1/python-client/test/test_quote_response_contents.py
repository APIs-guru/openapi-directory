...
class TestQuoteResponseContents(unittest.TestCase):
    """QuoteResponseContents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteResponseContents:
        """Test QuoteResponseContents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteResponseContents`
        """
        model = QuoteResponseContents()
        if include_optional:
    ...
    def testQuoteResponseContents(self):
        """Test QuoteResponseContents"""
