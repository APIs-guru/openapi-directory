...
class TestKeywordJobRank(unittest.TestCase):
    """KeywordJobRank unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordJobRank:
        """Test KeywordJobRank
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordJobRank`
        """
        model = KeywordJobRank()
        if include_optional:
            return KeywordJobRank(
