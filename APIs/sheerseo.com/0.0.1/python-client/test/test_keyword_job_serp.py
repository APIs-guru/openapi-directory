...
class TestKeywordJobSerp(unittest.TestCase):
    """KeywordJobSerp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordJobSerp:
        """Test KeywordJobSerp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordJobSerp`
        """
        model = KeywordJobSerp()
        if include_optional:
            return KeywordJobSerp(
