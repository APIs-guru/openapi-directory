...
class TestKeywordTask(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KeywordTask:
        """Test KeywordTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordTask`
        """
        model = KeywordTask()
        if include_optional:
            return KeywordTask(
