...
class SerpCollectResponseTasksInner(BaseModel):
    """
    SerpCollectResponseTasksInner
    """ # noqa: E501
    task_id: Optional[SerpCollectResponseTasksInnerTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "task_id": SerpCollectResponseTasksInnerTaskId.from_dict(obj["task_id"]) if obj.get("task_id") is not None else None
        })
        return _obj
