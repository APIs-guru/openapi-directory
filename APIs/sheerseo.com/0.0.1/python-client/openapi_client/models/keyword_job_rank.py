...
class KeywordJobRank(BaseModel):
    """
    KeywordJobRank
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="The domain you want to check its rank for the keyword entered")
    ...
    __properties: ClassVar[List[str]] = ["domain", "keyword", "localization_code", "localization_zip", "search_engine"]
