...
class SerpSubmitRequest(BaseModel):
    """
    SerpSubmitRequest
    """ # noqa: E501
    priority: Optional[StrictStr] = Field(default=None, description="The priority for the keyword jobs submitted. High priority costs double credits. Default value is low.")
    tasks: List[KeywordJobSerp] = Field(description="The keyword SERP jobs. Maximum 1000 jobs per a single request.")
    __properties: ClassVar[List[str]] = ["priority", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [KeywordJobSerp.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
