...
class CollectRequest(BaseModel):
    ...
    CollectRequest
    """ # noqa: E501
    task_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=10)] = Field(description="Receiving the request results through thier task id's")
    __properties: ClassVar[List[str]] = ["task_ids"]
