...
class RankSubmitRequest(BaseModel):
    """
    RankSubmitRequest
    """ # noqa: E501
    ...
    tasks: List[KeywordJobRank] = Field(description="The keyword RANK jobs. Maximum 1000 jobs per a single request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [KeywordJobRank.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
