...
class RankSubmitResponse(BaseModel):
    """
    Describes the result of uploading an image resource
    """ # noqa: E501
    error_message: Optional[StrictStr] = None
    response_code: StrictInt = Field(description="The request response_code.")
    tasks: Optional[List[KeywordTask]] = None
    __properties: ClassVar[List[str]] = ["error_message", "response_code", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [KeywordTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
