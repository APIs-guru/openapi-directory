...
class KeywordJobSerp(BaseModel):
    """
    KeywordJobSerp
    """ # noqa: E501
    ...
    search_engine: Optional[StrictStr] = Field(default='google', description="google/bing/google_mobile")
    __properties: ClassVar[List[str]] = ["keyword", "localization_code", "localization_zip", "search_engine"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "search_engine": obj.get("search_engine") if obj.get("search_engine") is not None else 'google'
        })
        return _obj
