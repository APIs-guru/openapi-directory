...
class TestEventOccurenceDetail(unittest.TestCase):
    """EventOccurenceDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventOccurenceDetail:
        """Test EventOccurenceDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventOccurenceDetail`
        """
        model = EventOccurenceDetail()
        if include_optional:
            return EventOccurenceDetail(
                ...
                away_team = openapi_client.models.feature_reference.FeatureReference(
                    @id = '', 
                    @type = '', 
                    name = '', ),
                category = [
                ...
                headline = '',
                home_team = openapi_client.models.feature_reference.FeatureReference(
                    @id = '', 
                    @type = '', 
                    name = '', ),
                html_description = '',
                image = openapi_client.models.image_meta.ImageMeta(
                    ...
                    url = '', 
                    width = 56, ),
                in_language = openapi_client.models.feature_reference.FeatureReference(
                    @id = '', 
                    @type = '', 
                    name = '', ),
                name = '',
    ...
    def testEventOccurenceDetail(self):
        """Test EventOccurenceDetail"""
