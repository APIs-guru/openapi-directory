...
class PlacesSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    places: Optional[List[PlaceDetail]] = None
    query: Optional[PlacesQuery] = None
    stats: Optional[SearchStatsMetaResult] = None
    __properties: ClassVar[List[str]] = ["places", "query", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "places": [PlaceDetail.from_dict(_item) for _item in obj["places"]] if obj.get("places") is not None else None,
            "query": PlacesQuery.from_dict(obj["query"]) if obj.get("query") is not None else None,
