...
class TestGetPurchaseOrdersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersResponse:
        """Test GetPurchaseOrdersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersResponse`
        """
        model = GetPurchaseOrdersResponse()
        if include_optional:
            return GetPurchaseOrdersResponse(
                data = [
                    openapi_client.models.purchase_order.PurchaseOrder(
