...
class TestGetCompanyInfoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCompanyInfoResponse:
        """Test GetCompanyInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyInfoResponse`
        """
        model = GetCompanyInfoResponse()
        if include_optional:
            return GetCompanyInfoResponse(
                data = openapi_client.models.company_info.CompanyInfo(
                    addresses = [
                    ...
                    company_name = 'SpaceX', 
                    company_start_date = 'Thu Jun 04 20:00:00 EDT 2015', 
                    country = 'US', 
                    created_at = '2020-09-30T07:43:32Z', 
                    created_by = '12345', 
                    currency = 'USD', 
                    custom_mappings = openapi_client.models.custom_mappings.CustomMappings(), 
                    default_sales_tax = openapi_client.models.tax_rate.TaxRate(
                        code = 'ABN', 
                        components = [
                            openapi_client.models.tax_components_inner.Tax_components_inner(
                                compound = True, 
                                id = '10', 
                                name = 'GST', 
                                rate = 10, )
