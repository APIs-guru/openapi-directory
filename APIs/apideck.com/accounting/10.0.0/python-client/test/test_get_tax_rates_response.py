...
class TestGetTaxRatesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTaxRatesResponse:
        """Test GetTaxRatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxRatesResponse`
        """
        model = GetTaxRatesResponse()
        if include_optional:
            return GetTaxRatesResponse(
                data = [
                    openapi_client.models.tax_rate.TaxRate(
                        code = 'ABN', 
                        components = [
