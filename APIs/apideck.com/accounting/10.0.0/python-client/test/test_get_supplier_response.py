...
class TestGetSupplierResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSupplierResponse:
        """Test GetSupplierResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupplierResponse`
        """
        model = GetSupplierResponse()
        if include_optional:
            return GetSupplierResponse(
                data = openapi_client.models.supplier.Supplier(
