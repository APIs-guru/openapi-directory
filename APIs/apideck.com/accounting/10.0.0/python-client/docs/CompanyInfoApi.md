# openapi_client.CompanyInfoApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**company_info_one**](CompanyInfoApi.md#company_info_one) | **GET** /accounting/company-info | Get company info


# **company_info_one**
> GetCompanyInfoResponse company_info_one(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CompanyInfoApi(api_client)
    ...
    try:
        # Get company info
        api_response = api_instance.company_info_one(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
        print("The response of CompanyInfoApi->company_info_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyInfoApi->company_info_one: %s\n" % e)
```
