...
**event_type** | [**AccountingEventType**](AccountingEventType.md) |  | [optional] 
...
json = "{}"
# create an instance of AccountingWebhookEvent from a JSON string
accounting_webhook_event_instance = AccountingWebhookEvent.from_json(json)
# print the JSON string representation of the object
print(AccountingWebhookEvent.to_json())

# convert the object into a dict
accounting_webhook_event_dict = accounting_webhook_event_instance.to_dict()
# create an instance of AccountingWebhookEvent from a dict
accounting_webhook_event_from_dict = AccountingWebhookEvent.from_dict(accounting_webhook_event_dict)
```
