...
------------- | ------------- | -------------
[**bills_add**](BillsApi.md#bills_add) | **POST** /accounting/bills | Create Bill
[**bills_all**](BillsApi.md#bills_all) | **GET** /accounting/bills | List Bills
[**bills_delete**](BillsApi.md#bills_delete) | **DELETE** /accounting/bills/{id} | Delete Bill
[**bills_one**](BillsApi.md#bills_one) | **GET** /accounting/bills/{id} | Get Bill
[**bills_update**](BillsApi.md#bills_update) | **PATCH** /accounting/bills/{id} | Update Bill


# **bills_add**
> CreateBillResponse bills_add(x_apideck_consumer_id, x_apideck_app_id, bill, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Bill
        api_response = api_instance.bills_add(x_apideck_consumer_id, x_apideck_app_id, bill, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of BillsApi->bills_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillsApi->bills_add: %s\n" % e)
```
...
# **bills_all**
> GetBillsResponse bills_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, sort=sort, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    sort = openapi_client.BillsSort() # BillsSort | Apply sorting (optional)
    ...
    try:
        # List Bills
        api_response = api_instance.bills_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, sort=sort, pass_through=pass_through, fields=fields)
        print("The response of BillsApi->bills_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillsApi->bills_all: %s\n" % e)
```
...
# **bills_delete**
> DeleteBillResponse bills_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Bill
        api_response = api_instance.bills_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of BillsApi->bills_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillsApi->bills_delete: %s\n" % e)
```
...
# **bills_one**
> GetBillResponse bills_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Bill
        api_response = api_instance.bills_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of BillsApi->bills_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillsApi->bills_one: %s\n" % e)
```
...
# **bills_update**
> UpdateBillResponse bills_update(id, x_apideck_consumer_id, x_apideck_app_id, bill, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Bill
        api_response = api_instance.bills_update(id, x_apideck_consumer_id, x_apideck_app_id, bill, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of BillsApi->bills_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillsApi->bills_update: %s\n" % e)
```
