# openapi_client.ProfitAndLossApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**profit_and_loss_one**](ProfitAndLossApi.md#profit_and_loss_one) | **GET** /accounting/profit-and-loss | Get Profit and Loss


# **profit_and_loss_one**
> GetProfitAndLossResponse profit_and_loss_one(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProfitAndLossApi(api_client)
    ...
    filter = openapi_client.ProfitAndLossFilter() # ProfitAndLossFilter | Apply filters (optional)
    ...
    try:
        # Get Profit and Loss
        api_response = api_instance.profit_and_loss_one(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of ProfitAndLossApi->profit_and_loss_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProfitAndLossApi->profit_and_loss_one: %s\n" % e)
```
