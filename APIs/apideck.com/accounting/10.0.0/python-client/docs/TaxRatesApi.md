...
------------- | ------------- | -------------
[**tax_rates_add**](TaxRatesApi.md#tax_rates_add) | **POST** /accounting/tax-rates | Create Tax Rate
[**tax_rates_all**](TaxRatesApi.md#tax_rates_all) | **GET** /accounting/tax-rates | List Tax Rates
[**tax_rates_delete**](TaxRatesApi.md#tax_rates_delete) | **DELETE** /accounting/tax-rates/{id} | Delete Tax Rate
[**tax_rates_one**](TaxRatesApi.md#tax_rates_one) | **GET** /accounting/tax-rates/{id} | Get Tax Rate
[**tax_rates_update**](TaxRatesApi.md#tax_rates_update) | **PATCH** /accounting/tax-rates/{id} | Update Tax Rate


# **tax_rates_add**
> CreateTaxRateResponse tax_rates_add(x_apideck_consumer_id, x_apideck_app_id, tax_rate, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    tax_rate = openapi_client.TaxRate() # TaxRate | 
    ...
    try:
        # Create Tax Rate
        api_response = api_instance.tax_rates_add(x_apideck_consumer_id, x_apideck_app_id, tax_rate, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of TaxRatesApi->tax_rates_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->tax_rates_add: %s\n" % e)
```
...
# **tax_rates_all**
> GetTaxRatesResponse tax_rates_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.TaxRatesFilter() # TaxRatesFilter | Apply filters (optional)
    ...
    try:
        # List Tax Rates
        api_response = api_instance.tax_rates_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of TaxRatesApi->tax_rates_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->tax_rates_all: %s\n" % e)
```
...
# **tax_rates_delete**
> DeleteTaxRateResponse tax_rates_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Tax Rate
        api_response = api_instance.tax_rates_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of TaxRatesApi->tax_rates_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->tax_rates_delete: %s\n" % e)
```
...
# **tax_rates_one**
> GetTaxRateResponse tax_rates_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tax Rate
        api_response = api_instance.tax_rates_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of TaxRatesApi->tax_rates_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->tax_rates_one: %s\n" % e)
```
...
# **tax_rates_update**
> UpdateTaxRateResponse tax_rates_update(id, x_apideck_consumer_id, x_apideck_app_id, tax_rate, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Tax Rate
        api_response = api_instance.tax_rates_update(id, x_apideck_consumer_id, x_apideck_app_id, tax_rate, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of TaxRatesApi->tax_rates_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->tax_rates_update: %s\n" % e)
```
