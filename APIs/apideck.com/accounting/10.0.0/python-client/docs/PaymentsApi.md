...
------------- | ------------- | -------------
[**payments_add**](PaymentsApi.md#payments_add) | **POST** /accounting/payments | Create Payment
[**payments_all**](PaymentsApi.md#payments_all) | **GET** /accounting/payments | List Payments
[**payments_delete**](PaymentsApi.md#payments_delete) | **DELETE** /accounting/payments/{id} | Delete Payment
[**payments_one**](PaymentsApi.md#payments_one) | **GET** /accounting/payments/{id} | Get Payment
[**payments_update**](PaymentsApi.md#payments_update) | **PATCH** /accounting/payments/{id} | Update Payment


# **payments_add**
> CreatePaymentResponse payments_add(x_apideck_consumer_id, x_apideck_app_id, payment, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Payment
        api_response = api_instance.payments_add(x_apideck_consumer_id, x_apideck_app_id, payment, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of PaymentsApi->payments_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentsApi->payments_add: %s\n" % e)
```
...
# **payments_all**
> GetPaymentsResponse payments_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.PaymentsFilter() # PaymentsFilter | Apply filters (optional)
    ...
    try:
        # List Payments
        api_response = api_instance.payments_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of PaymentsApi->payments_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentsApi->payments_all: %s\n" % e)
```
 ...
 **filter** | [**PaymentsFilter**](.md)| Apply filters | [optional] 
...
# **payments_delete**
> DeletePaymentResponse payments_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Payment
        api_response = api_instance.payments_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **payments_one**
> GetPaymentResponse payments_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Payment
        api_response = api_instance.payments_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of PaymentsApi->payments_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentsApi->payments_one: %s\n" % e)
```
...
# **payments_update**
> UpdatePaymentResponse payments_update(id, x_apideck_consumer_id, x_apideck_app_id, payment, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Payment
        api_response = api_instance.payments_update(id, x_apideck_consumer_id, x_apideck_app_id, payment, x_apideck_service_id=x_apideck_service_id, raw=raw)
