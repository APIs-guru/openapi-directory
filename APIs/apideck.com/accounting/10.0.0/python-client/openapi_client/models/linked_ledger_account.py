...
class LinkedLedgerAccount(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the account.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the account.")
    nominal_code: Optional[StrictStr] = Field(default=None, description="The nominal code of the account.")
    __properties: ClassVar[List[str]] = ["code", "id", "name", "nominal_code"]
