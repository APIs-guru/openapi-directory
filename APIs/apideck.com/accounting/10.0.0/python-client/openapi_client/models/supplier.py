...
class Supplier(BaseModel):
    ...
    individual: Optional[StrictBool] = Field(default=None, description="Is this an individual or business supplier")
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Some notes about this supplier")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Supplier status")
