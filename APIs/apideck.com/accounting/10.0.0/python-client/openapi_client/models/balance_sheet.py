...
class BalanceSheet(BaseModel):
    ...
    end_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The start date of the report")
    equity: BalanceSheetEquity
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    liabilities: BalanceSheetLiabilities
    report_name: StrictStr = Field(description="The name of the report")
    start_date: Annotated[str, Field(strict=True)] = Field(description="The start date of the report")
    ...
    __properties: ClassVar[List[str]] = ["assets", "created_at", "created_by", "custom_mappings", "end_date", "equity", "id", "liabilities", "report_name", "start_date", "updated_at", "updated_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": BalanceSheetAssets.from_dict(obj["assets"]) if obj.get("assets") is not None else None,
            "created_at": obj.get("created_at"),
            "created_by": obj.get("created_by"),
            "custom_mappings": obj.get("custom_mappings"),
            "end_date": obj.get("end_date"),
            "equity": BalanceSheetEquity.from_dict(obj["equity"]) if obj.get("equity") is not None else None,
            "id": obj.get("id"),
            "liabilities": BalanceSheetLiabilities.from_dict(obj["liabilities"]) if obj.get("liabilities") is not None else None,
