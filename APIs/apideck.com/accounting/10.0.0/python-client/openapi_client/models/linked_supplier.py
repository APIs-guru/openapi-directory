...
class LinkedSupplier(BaseModel):
    ...
    company_name: Optional[StrictStr] = Field(default=None, description="The company name of the supplier.")
    display_id: Optional[StrictStr] = Field(default=None, description="The display ID of the supplier.")
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the supplier.")
    id: StrictStr = Field(description="The ID of the supplier this entity is linked to.")
    __properties: ClassVar[List[str]] = ["address", "company_name", "display_id", "display_name", "id"]
