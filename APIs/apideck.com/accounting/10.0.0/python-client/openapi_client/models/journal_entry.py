...
class JournalEntry(BaseModel):
    ...
    journal_symbol: Optional[StrictStr] = Field(default=None, description="Journal symbol of the entry. For example IND for indirect costs")
    line_items: Optional[Annotated[List[JournalEntryLineItem], Field(min_length=2)]] = Field(default=None, description="Requires a minimum of 2 line items that sum to 0")
    memo: Optional[StrictStr] = Field(default=None, description="Reference for the journal entry.")
    number: Optional[StrictStr] = Field(default=None, description="Journal entry number.")
    posted_at: Optional[datetime] = Field(default=None, description="This is the date on which the journal entry was added. This can be different from the creation date and can also be backdated.")
    ...
    tax_type: Optional[StrictStr] = Field(default=None, description="The specific category of tax associated with a transaction like sales or purchase")
    title: Optional[StrictStr] = Field(default=None, description="Journal entry title")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "currency", "currency_rate", "custom_mappings", "id", "journal_symbol", "line_items", "memo", "number", "posted_at", "row_version", "tax_code", "tax_type", "title", "updated_at", "updated_by"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if journal_symbol (nullable) is None
        # and model_fields_set contains the field
        if self.journal_symbol is None and "journal_symbol" in self.model_fields_set:
            _dict['journal_symbol'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "journal_symbol": obj.get("journal_symbol"),
            "line_items": [JournalEntryLineItem.from_dict(_item) for _item in obj["line_items"]] if obj.get("line_items") is not None else None,
            "memo": obj.get("memo"),
