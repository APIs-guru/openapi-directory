...
class Customer(BaseModel):
    ...
    display_id: Optional[StrictStr] = Field(default=None, description="Display ID")
    ...
    individual: Optional[StrictBool] = Field(default=None, description="Is this an individual or business customer")
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Some notes about this customer")
    ...
    project: Optional[StrictBool] = Field(default=None, description="If true, indicates this is a Project.")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Customer status")
    ...
    __properties: ClassVar[List[str]] = ["account", "addresses", "bank_accounts", "channel", "company_name", "created_at", "created_by", "currency", "custom_mappings", "display_id", "display_name", "downstream_id", "emails", "first_name", "id", "individual", "last_name", "middle_name", "notes", "parent", "payment_method", "phone_numbers", "project", "row_version", "status", "suffix", "tax_number", "tax_rate", "title", "updated_at", "updated_by", "websites"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'inactive', 'archived', 'gdpr-erasure-request', 'unknown']):
            raise ValueError("must be one of enum values ('active', 'inactive', 'archived', 'gdpr-erasure-request', 'unknown')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.display_id is None and "display_id" in self.model_fields_set:
        ...
        # set to None if individual (nullable) is None
        # and model_fields_set contains the field
        if self.individual is None and "individual" in self.model_fields_set:
            _dict['individual'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": LinkedLedgerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            ...
            "notes": obj.get("notes"),
            "parent": LinkedParentCustomer.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
