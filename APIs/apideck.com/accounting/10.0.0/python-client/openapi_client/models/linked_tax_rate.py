...
class LinkedTaxRate(BaseModel):
    ...
    LinkedTaxRate
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Tax rate code")
    id: Optional[StrictStr] = Field(default=None, description="The ID of the object.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the tax rate")
    rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Rate of the tax rate")
    __properties: ClassVar[List[str]] = ["code", "id", "name", "rate"]
