...
class CompanyInfo(BaseModel):
    ...
    automated_sales_tax: Optional[StrictBool] = Field(default=None, description="Whether sales tax is calculated automatically for the company")
    company_name: Optional[StrictStr] = Field(default=None, description="The name of the company.")
    company_start_date: Optional[date] = Field(default=None, description="Date when company file was created")
    ...
    fiscal_year_start_month: Optional[StrictStr] = Field(default=None, description="The start month of fiscal year.")
    ...
    legal_name: Optional[StrictStr] = Field(default=None, description="The legal name of the company")
    ...
    sales_tax_enabled: Optional[StrictBool] = Field(default=None, description="Whether sales tax is enabled for the company")
    sales_tax_number: Optional[StrictStr] = None
    status: Optional[StrictStr] = Field(default=None, description="Based on the status some functionality is enabled or disabled.")
    ...
    __properties: ClassVar[List[str]] = ["addresses", "automated_sales_tax", "company_name", "company_start_date", "country", "created_at", "created_by", "currency", "custom_mappings", "default_sales_tax", "emails", "fiscal_year_start_month", "id", "language", "legal_name", "phone_numbers", "row_version", "sales_tax_enabled", "sales_tax_number", "status", "updated_at", "updated_by"]

    @field_validator('fiscal_year_start_month')
    def fiscal_year_start_month_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of default_sales_tax
        if self.default_sales_tax:
            _dict['default_sales_tax'] = self.default_sales_tax.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "automated_sales_tax": obj.get("automated_sales_tax"),
            "company_name": obj.get("company_name"),
            "company_start_date": obj.get("company_start_date"),
            "country": obj.get("country"),
            "created_at": obj.get("created_at"),
            "created_by": obj.get("created_by"),
            "currency": obj.get("currency"),
            "custom_mappings": obj.get("custom_mappings"),
            "default_sales_tax": TaxRate.from_dict(obj["default_sales_tax"]) if obj.get("default_sales_tax") is not None else None,
            "emails": [Email.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "fiscal_year_start_month": obj.get("fiscal_year_start_month"),
            "id": obj.get("id"),
            ...
            "sales_tax_enabled": obj.get("sales_tax_enabled"),
