...
class ProfitAndLoss(BaseModel):
    ...
    gross_profit: Optional[ProfitAndLossGrossProfit] = None
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    income: ProfitAndLossIncome
    net_income: Optional[ProfitAndLossNetIncome] = None
    net_operating_income: Optional[ProfitAndLossNetOperatingIncome] = None
    report_name: StrictStr = Field(description="The name of the report")
    start_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The start date of the report")
    __properties: ClassVar[List[str]] = ["currency", "custom_mappings", "customer_id", "end_date", "expenses", "gross_profit", "id", "income", "net_income", "net_operating_income", "report_name", "start_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of gross_profit
        if self.gross_profit:
            _dict['gross_profit'] = self.gross_profit.to_dict()
        # override the default output from pydantic by calling `to_dict()` of income
        if self.income:
            _dict['income'] = self.income.to_dict()
        # override the default output from pydantic by calling `to_dict()` of net_income
        if self.net_income:
            _dict['net_income'] = self.net_income.to_dict()
        # override the default output from pydantic by calling `to_dict()` of net_operating_income
        if self.net_operating_income:
            _dict['net_operating_income'] = self.net_operating_income.to_dict()
        ...
        # set to None if net_operating_income (nullable) is None
        # and model_fields_set contains the field
        if self.net_operating_income is None and "net_operating_income" in self.model_fields_set:
            _dict['net_operating_income'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expenses": ProfitAndLossExpenses.from_dict(obj["expenses"]) if obj.get("expenses") is not None else None,
            "gross_profit": ProfitAndLossGrossProfit.from_dict(obj["gross_profit"]) if obj.get("gross_profit") is not None else None,
            "id": obj.get("id"),
            "income": ProfitAndLossIncome.from_dict(obj["income"]) if obj.get("income") is not None else None,
            "net_income": ProfitAndLossNetIncome.from_dict(obj["net_income"]) if obj.get("net_income") is not None else None,
            "net_operating_income": ProfitAndLossNetOperatingIncome.from_dict(obj["net_operating_income"]) if obj.get("net_operating_income") is not None else None,
