...
class ProfitAndLossSection(BaseModel):
    ...
    records: Optional[List[ProfitAndLossRecordsInner]] = None
    title: Optional[StrictStr] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "records", "title", "total", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "records": [ProfitAndLossRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
            "title": obj.get("title"),
            "total": obj.get("total"),
            "type": obj.get("type")
        })
...
ProfitAndLossSection.model_rebuild(raise_errors=False)
