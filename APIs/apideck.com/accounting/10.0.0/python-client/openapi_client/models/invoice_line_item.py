...
class InvoiceLineItem(BaseModel):
    ...
    InvoiceLineItem
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="User defined item code")
    ...
    department_id: Optional[StrictStr] = Field(default=None, description="Department id")
    description: Optional[StrictStr] = Field(default=None, description="User defined description")
    discount_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount amount applied to the line item when supported downstream.")
    discount_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount percentage applied to the line item when supported downstream.")
    ...
    line_number: Optional[StrictInt] = Field(default=None, description="Line number in the invoice")
    location_id: Optional[StrictStr] = Field(default=None, description="Location id")
    quantity: Optional[Union[StrictFloat, StrictInt]] = None
    row_id: Optional[StrictStr] = Field(default=None, description="Row ID")
    ...
    tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax amount")
    tax_rate: Optional[LinkedTaxRate] = None
    total_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount of the line item")
    type: Optional[StrictStr] = Field(default=None, description="Item type")
    unit_of_measure: Optional[StrictStr] = Field(default=None, description="Description of the unit type the item is sold as, ie: kg, hour.")
    ...
    __properties: ClassVar[List[str]] = ["code", "created_at", "created_by", "custom_mappings", "department_id", "description", "discount_amount", "discount_percentage", "id", "item", "ledger_account", "line_number", "location_id", "quantity", "row_id", "row_version", "tax_amount", "tax_rate", "total_amount", "type", "unit_of_measure", "unit_price", "updated_at", "updated_by"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['sales_item', 'discount', 'info', 'sub_total']):
            raise ValueError("must be one of enum values ('sales_item', 'discount', 'info', 'sub_total')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "item": LinkedInvoiceItem.from_dict(obj["item"]) if obj.get("item") is not None else None,
