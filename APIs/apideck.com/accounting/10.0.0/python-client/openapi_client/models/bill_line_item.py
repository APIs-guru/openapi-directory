...
class BillLineItem(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="Bill Line Item type")
    ...
    __properties: ClassVar[List[str]] = ["code", "created_at", "created_by", "department_id", "description", "discount_amount", "discount_percentage", "id", "item", "ledger_account", "line_number", "location_id", "quantity", "row_id", "row_version", "tax_amount", "tax_rate", "total_amount", "type", "unit_of_measure", "unit_price", "updated_at", "updated_by"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['expense_item', 'expense_account']):
            raise ValueError("must be one of enum values ('expense_item', 'expense_account')")
        return value
