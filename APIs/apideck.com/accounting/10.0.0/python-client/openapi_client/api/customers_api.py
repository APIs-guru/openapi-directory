...
class CustomersApi:
    ...
    def customers_add(
        ...
        _param = self._customers_add_serialize(
    ...
    @validate_call
    def customers_add_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        customer: Customer,
    ...
    @validate_call
    def customers_add_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        customer: Customer,
    ...
    def _customers_add_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounting/customers',
    ...
    def customers_all(
        ...
        filter: Annotated[Optional[CustomersFilter], Field(description="Apply filters")] = None,
    ...
    def customers_all_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomersResponse]:
        """List Customers
    ...
    def _customers_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/accounting/customers/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
