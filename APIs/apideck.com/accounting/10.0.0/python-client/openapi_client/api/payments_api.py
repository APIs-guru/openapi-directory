...
class PaymentsApi:
    ...
    def _payments_add_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounting/payments',
    ...
    def payments_all(
        ...
        filter: Annotated[Optional[PaymentsFilter], Field(description="Apply filters")] = None,
    ...
    def _payments_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/accounting/payments/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
