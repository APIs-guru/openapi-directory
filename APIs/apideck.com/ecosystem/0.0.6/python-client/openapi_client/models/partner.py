...
class Partner(BaseModel):
    ...
    listed: Optional[StrictStr] = None
    twitter: Optional[StrictStr] = None
    updated_at: Optional[datetime] = None
    website: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["company", "contacts", "created_at", "icon", "id", "listed", "twitter", "updated_at", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": File.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "id": obj.get("id"),
