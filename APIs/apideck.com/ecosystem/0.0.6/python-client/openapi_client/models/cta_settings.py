...
class CTASettings(BaseModel):
    ...
    button_link: Optional[StrictStr] = None
    color: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    enabled: Optional[StrictBool] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["background_color", "button_background_color", "button_color", "button_label", "button_link", "color", "description", "enabled", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "button_link": obj.get("button_link"),
            "color": obj.get("color"),
