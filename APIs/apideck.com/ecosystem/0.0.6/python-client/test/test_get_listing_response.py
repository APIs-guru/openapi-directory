...
class TestGetListingResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetListingResponse:
        """Test GetListingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetListingResponse`
        """
        model = GetListingResponse()
        if include_optional:
            return GetListingResponse(
                data = openapi_client.models.listing.Listing(
                    automate_id = '', 
                    blendr_id = '', 
