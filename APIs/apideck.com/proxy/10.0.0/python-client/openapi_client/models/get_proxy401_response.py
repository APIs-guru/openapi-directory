...
class GetProxy401Response(BaseModel):
    """
    GetProxy401Response
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="Contains parameter or domain specific information related to the error and why it occurred.")
    error: Optional[StrictStr] = Field(default=None, description="Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)")
    ...
    ref: Optional[StrictStr] = Field(default=None, description="Link to documentation of error type")
    status_code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="HTTP status code")
    type_name: Optional[StrictStr] = Field(default=None, description="The type of error returned")
    __properties: ClassVar[List[str]] = ["detail", "error", "message", "ref", "status_code", "type_name"]
