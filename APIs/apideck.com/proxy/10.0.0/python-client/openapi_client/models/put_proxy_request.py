...
PUTPROXYREQUEST_ANY_OF_SCHEMAS = ["object", "str"]

class PutProxyRequest(BaseModel):
    """
    PutProxyRequest
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PutProxyRequest.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PutProxyRequest with anyOf schemas: object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PutProxyRequest with anyOf schemas: object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
