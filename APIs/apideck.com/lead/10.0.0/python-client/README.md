...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create lead
        api_response = api_instance.leads_add(x_apideck_consumer_id, x_apideck_app_id, lead, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of LeadsApi->leads_add:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling LeadsApi->leads_add: %s\n" % e)
...
------------ | ------------- | ------------- | -------------
*LeadsApi* | [**leads_add**](docs/LeadsApi.md#leads_add) | **POST** /lead/leads | Create lead
*LeadsApi* | [**leads_all**](docs/LeadsApi.md#leads_all) | **GET** /lead/leads | List leads
*LeadsApi* | [**leads_delete**](docs/LeadsApi.md#leads_delete) | **DELETE** /lead/leads/{id} | Delete lead
*LeadsApi* | [**leads_one**](docs/LeadsApi.md#leads_one) | **GET** /lead/leads/{id} | Get lead
*LeadsApi* | [**leads_update**](docs/LeadsApi.md#leads_update) | **PATCH** /lead/leads/{id} | Update lead
...
## Documentation For Models
 ...
 - [Lead](docs/Lead.md)
 - [LeadEventType](docs/LeadEventType.md)
 - [LeadWebhookEvent](docs/LeadWebhookEvent.md)
