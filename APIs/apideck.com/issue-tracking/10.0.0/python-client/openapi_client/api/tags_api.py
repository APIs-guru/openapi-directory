...
class TagsApi:
    ...
    def collection_tags_all(
        ...
        _param = self._collection_tags_all_serialize(
    ...
    @validate_call
    def collection_tags_all_with_http_info(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCollectionTagsResponse]:
        """List Tags
    ...
    @validate_call
    def collection_tags_all_without_preload_content(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _collection_tags_all_serialize(
        self,
        collection_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/issue-tracking/collections/{collection_id}/tags',
