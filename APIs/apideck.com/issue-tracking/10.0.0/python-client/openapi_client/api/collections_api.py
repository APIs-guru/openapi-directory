...
class CollectionsApi:
    ...
    def collections_all(
        ...
        sort: Annotated[Optional[CollectionsSort], Field(description="Apply sorting")] = None,
    ...
    def _collections_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/issue-tracking/collections',
    ...
    def _collections_one_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/issue-tracking/collections/{collection_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
