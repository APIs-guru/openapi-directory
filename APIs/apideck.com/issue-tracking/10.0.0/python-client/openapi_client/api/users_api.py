...
class UsersApi:
    ...
    def collection_users_all(
        ...
        _param = self._collection_users_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCollectionUsersResponse",
    ...
    @validate_call
    def collection_users_all_with_http_info(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCollectionUsersResponse]:
        """List Users
    ...
    @validate_call
    def collection_users_all_without_preload_content(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _collection_users_all_serialize(
        self,
        collection_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/issue-tracking/collections/{collection_id}/users',
    ...
    def collection_users_one(
        ...
        _param = self._collection_users_one_serialize(
            collection_id=collection_id,
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
    ...
    @validate_call
    def collection_users_one_with_http_info(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCollectionUserResponse]:
        """Get user
    ...
    @validate_call
    def collection_users_one_without_preload_content(
        self,
        collection_id: Annotated[StrictStr, Field(description="The collection ID")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
    ...
    def _collection_users_one_serialize(
        self,
        collection_id,
        id,
        x_apideck_consumer_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/issue-tracking/collections/{collection_id}/users/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
