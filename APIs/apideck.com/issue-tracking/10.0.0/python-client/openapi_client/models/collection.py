...
class Collection(BaseModel):
    ...
    parent_id: Optional[StrictStr] = Field(default=None, description="The collections's parent ID")
    type: Optional[StrictStr] = Field(default=None, description="The collections's type")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    __properties: ClassVar[List[str]] = ["created_at", "custom_mappings", "description", "id", "name", "parent_id", "type", "updated_at"]
