...
class Ticket(BaseModel):
    ...
    collection_id: Optional[StrictStr] = Field(default=None, description="The ticket's collection ID")
    completed_at: Optional[datetime] = Field(default=None, description="When the ticket was completed")
    ...
    description: Optional[StrictStr] = Field(default=None, description="The ticket's description. HTML version of description is mapped if supported by the third-party platform")
    due_date: Optional[datetime] = Field(default=None, description="Due date of the ticket")
    id: StrictStr = Field(description="A unique identifier for an object.")
    parent_id: Optional[StrictStr] = Field(default=None, description="The ticket's parent ID")
    priority: Optional[StrictStr] = Field(default=None, description="Priority of the ticket")
    status: Optional[StrictStr] = Field(default=None, description="The current status of the ticket. Possible values include: open, in_progress, closed, or - in cases where there is no clear mapping - the original value passed through.")
    subject: Optional[StrictStr] = Field(default=None, description="Subject of the ticket")
    tags: Optional[List[CollectionTag]] = None
    type: Optional[StrictStr] = Field(default=None, description="The ticket's type")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    __properties: ClassVar[List[str]] = ["assignees", "collection_id", "completed_at", "created_at", "created_by", "custom_mappings", "description", "due_date", "id", "parent_id", "priority", "status", "subject", "tags", "type", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignees": [Assignee.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None,
            ...
            "tags": [CollectionTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
            "type": obj.get("type"),
