...
class CollectionTicketComment(BaseModel):
    ...
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Body of the comment")
    ...
    __properties: ClassVar[List[str]] = ["body", "created_at", "created_by", "custom_mappings", "id", "updated_at"]
