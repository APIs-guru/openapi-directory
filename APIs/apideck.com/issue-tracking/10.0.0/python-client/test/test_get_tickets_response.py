            ...
            return GetTicketsResponse(
                data = [
                    openapi_client.models.ticket.Ticket(
                        assignees = [
                            openapi_client.models.assignee.Assignee(
                                id = '12345', 
                                username = 'Cocoa', )
                            ], 
                        collection_id = '12345', 
                        completed_at = '2020-09-30T07:43:32Z', 
                        ...
                        tags = [
                            openapi_client.models.collection_tag.CollectionTag(
                                id = '12345', 
