...
------------- | ------------- | -------------
[**collection_tags_all**](TagsApi.md#collection_tags_all) | **GET** /issue-tracking/collections/{collection_id}/tags | List Tags


# **collection_tags_all**
> GetCollectionTagsResponse collection_tags_all(collection_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Tags
        api_response = api_instance.collection_tags_all(collection_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
        print("The response of TagsApi->collection_tags_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TagsApi->collection_tags_all: %s\n" % e)
```
