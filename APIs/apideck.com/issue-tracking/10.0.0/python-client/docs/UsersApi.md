...
------------- | ------------- | -------------
[**collection_users_all**](UsersApi.md#collection_users_all) | **GET** /issue-tracking/collections/{collection_id}/users | List Users
[**collection_users_one**](UsersApi.md#collection_users_one) | **GET** /issue-tracking/collections/{collection_id}/users/{id} | Get user


# **collection_users_all**
> GetCollectionUsersResponse collection_users_all(collection_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Users
        api_response = api_instance.collection_users_all(collection_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
        print("The response of UsersApi->collection_users_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->collection_users_all: %s\n" % e)
```
...
> GetCollectionUserResponse collection_users_one(collection_id, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get user
        api_response = api_instance.collection_users_one(collection_id, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of UsersApi->collection_users_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->collection_users_one: %s\n" % e)
```
