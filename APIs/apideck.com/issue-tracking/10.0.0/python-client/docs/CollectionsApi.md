...
------------- | ------------- | -------------
[**collections_all**](CollectionsApi.md#collections_all) | **GET** /issue-tracking/collections | List Collections
[**collections_one**](CollectionsApi.md#collections_one) | **GET** /issue-tracking/collections/{collection_id} | Get Collection


# **collections_all**
> GetCollectionsResponse collections_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, sort=sort, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    sort = openapi_client.CollectionsSort() # CollectionsSort | Apply sorting (optional)
    ...
    try:
        # List Collections
        api_response = api_instance.collections_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, sort=sort, pass_through=pass_through, fields=fields)
        print("The response of CollectionsApi->collections_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CollectionsApi->collections_all: %s\n" % e)
```
...
# **collections_one**
> GetCollectionResponse collections_one(collection_id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Collection
        api_response = api_instance.collections_one(collection_id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of CollectionsApi->collections_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CollectionsApi->collections_one: %s\n" % e)
```
