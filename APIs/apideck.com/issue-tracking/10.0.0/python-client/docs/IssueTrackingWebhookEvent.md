...
**event_type** | [**IssueTrackingEventType**](IssueTrackingEventType.md) |  | [optional] 

## Example

```python
from openapi_client.models.issue_tracking_webhook_event import IssueTrackingWebhookEvent

# TODO update the JSON string below
json = "{}"
# create an instance of IssueTrackingWebhookEvent from a JSON string
issue_tracking_webhook_event_instance = IssueTrackingWebhookEvent.from_json(json)
# print the JSON string representation of the object
print(IssueTrackingWebhookEvent.to_json())

# convert the object into a dict
issue_tracking_webhook_event_dict = issue_tracking_webhook_event_instance.to_dict()
# create an instance of IssueTrackingWebhookEvent from a dict
issue_tracking_webhook_event_from_dict = IssueTrackingWebhookEvent.from_dict(issue_tracking_webhook_event_dict)
```
