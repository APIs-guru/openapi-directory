...
------------ | ------------- | ------------- | -------------
*CollectionsApi* | [**collections_all**](docs/CollectionsApi.md#collections_all) | **GET** /issue-tracking/collections | List Collections
*CollectionsApi* | [**collections_one**](docs/CollectionsApi.md#collections_one) | **GET** /issue-tracking/collections/{collection_id} | Get Collection
*CommentsApi* | [**collection_ticket_comments_add**](docs/CommentsApi.md#collection_ticket_comments_add) | **POST** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments | Create Comment
*CommentsApi* | [**collection_ticket_comments_all**](docs/CommentsApi.md#collection_ticket_comments_all) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments | List Comments
*CommentsApi* | [**collection_ticket_comments_delete**](docs/CommentsApi.md#collection_ticket_comments_delete) | **DELETE** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Delete Comment
*CommentsApi* | [**collection_ticket_comments_one**](docs/CommentsApi.md#collection_ticket_comments_one) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Get Comment
*CommentsApi* | [**collection_ticket_comments_update**](docs/CommentsApi.md#collection_ticket_comments_update) | **PATCH** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Update Comment
*TagsApi* | [**collection_tags_all**](docs/TagsApi.md#collection_tags_all) | **GET** /issue-tracking/collections/{collection_id}/tags | List Tags
*TicketsApi* | [**collection_tickets_add**](docs/TicketsApi.md#collection_tickets_add) | **POST** /issue-tracking/collections/{collection_id}/tickets | Create Ticket
*TicketsApi* | [**collection_tickets_all**](docs/TicketsApi.md#collection_tickets_all) | **GET** /issue-tracking/collections/{collection_id}/tickets | List Tickets
*TicketsApi* | [**collection_tickets_delete**](docs/TicketsApi.md#collection_tickets_delete) | **DELETE** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Delete Ticket
*TicketsApi* | [**collection_tickets_one**](docs/TicketsApi.md#collection_tickets_one) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Get Ticket
*TicketsApi* | [**collection_tickets_update**](docs/TicketsApi.md#collection_tickets_update) | **PATCH** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Update Ticket
*UsersApi* | [**collection_users_all**](docs/UsersApi.md#collection_users_all) | **GET** /issue-tracking/collections/{collection_id}/users | List Users
*UsersApi* | [**collection_users_one**](docs/UsersApi.md#collection_users_one) | **GET** /issue-tracking/collections/{collection_id}/users/{id} | Get user
