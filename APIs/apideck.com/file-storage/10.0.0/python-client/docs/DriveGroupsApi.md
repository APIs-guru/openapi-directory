# openapi_client.DriveGroupsApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**drive_groups_add**](DriveGroupsApi.md#drive_groups_add) | **POST** /file-storage/drive-groups | Create DriveGroup
[**drive_groups_all**](DriveGroupsApi.md#drive_groups_all) | **GET** /file-storage/drive-groups | List DriveGroups
[**drive_groups_delete**](DriveGroupsApi.md#drive_groups_delete) | **DELETE** /file-storage/drive-groups/{id} | Delete DriveGroup
[**drive_groups_one**](DriveGroupsApi.md#drive_groups_one) | **GET** /file-storage/drive-groups/{id} | Get DriveGroup
[**drive_groups_update**](DriveGroupsApi.md#drive_groups_update) | **PATCH** /file-storage/drive-groups/{id} | Update DriveGroup


# **drive_groups_add**
> CreateDriveGroupResponse drive_groups_add(x_apideck_consumer_id, x_apideck_app_id, drive_group, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
# **drive_groups_all**
> GetDriveGroupsResponse drive_groups_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
from openapi_client.models.get_drive_groups_response import GetDriveGroupsResponse
from openapi_client.rest import ApiException
from pprint import pprint
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.DriveGroupsFilter() # DriveGroupsFilter | Apply filters (optional)
    ...
    try:
        # List DriveGroups
        api_response = api_instance.drive_groups_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of DriveGroupsApi->drive_groups_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DriveGroupsApi->drive_groups_all: %s\n" % e)
```
...
# **drive_groups_delete**
> DeleteDriveGroupResponse drive_groups_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete DriveGroup
        api_response = api_instance.drive_groups_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of DriveGroupsApi->drive_groups_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DriveGroupsApi->drive_groups_delete: %s\n" % e)
```
...
# **drive_groups_one**
> GetDriveGroupResponse drive_groups_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get DriveGroup
        api_response = api_instance.drive_groups_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of DriveGroupsApi->drive_groups_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DriveGroupsApi->drive_groups_one: %s\n" % e)
```
...
# **drive_groups_update**
> UpdateDriveGroupResponse drive_groups_update(id, x_apideck_consumer_id, x_apideck_app_id, drive_group, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update DriveGroup
        api_response = api_instance.drive_groups_update(id, x_apideck_consumer_id, x_apideck_app_id, drive_group, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of DriveGroupsApi->drive_groups_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DriveGroupsApi->drive_groups_update: %s\n" % e)
```
