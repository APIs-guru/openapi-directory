...
------------- | ------------- | -------------
[**folders_add**](FoldersApi.md#folders_add) | **POST** /file-storage/folders | Create Folder
[**folders_copy**](FoldersApi.md#folders_copy) | **POST** /file-storage/folders/{id}/copy | Copy Folder
[**folders_delete**](FoldersApi.md#folders_delete) | **DELETE** /file-storage/folders/{id} | Delete Folder
[**folders_one**](FoldersApi.md#folders_one) | **GET** /file-storage/folders/{id} | Get Folder
[**folders_update**](FoldersApi.md#folders_update) | **PATCH** /file-storage/folders/{id} | Rename or move Folder


# **folders_add**
> CreateFolderResponse folders_add(x_apideck_consumer_id, x_apideck_app_id, create_folder_request, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Folder
        api_response = api_instance.folders_add(x_apideck_consumer_id, x_apideck_app_id, create_folder_request, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
        print("The response of FoldersApi->folders_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FoldersApi->folders_add: %s\n" % e)
```
...
# **folders_copy**
> UpdateFolderResponse folders_copy(id, x_apideck_consumer_id, x_apideck_app_id, copy_folder_request, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    x_apideck_consumer_id = 'x_apideck_consumer_id_example' # str | ID of the consumer which you want to get or push data from
    x_apideck_app_id = 'dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX' # str | The ID of your Unify application
    copy_folder_request = openapi_client.CopyFolderRequest() # CopyFolderRequest | 
    x_apideck_service_id = 'x_apideck_service_id_example' # str | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API. (optional)
    raw = False # bool | Include raw response. Mostly used for debugging purposes (optional) (default to False)
    fields = 'id,updated_at' # str | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded. (optional)
    ...
    try:
        # Copy Folder
        api_response = api_instance.folders_copy(id, x_apideck_consumer_id, x_apideck_app_id, copy_folder_request, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
# **folders_delete**
> DeleteFolderResponse folders_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Folder
        api_response = api_instance.folders_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **folders_one**
> GetFolderResponse folders_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Folder
        api_response = api_instance.folders_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of FoldersApi->folders_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FoldersApi->folders_one: %s\n" % e)
```
...
# **folders_update**
> UpdateFolderResponse folders_update(id, x_apideck_consumer_id, x_apideck_app_id, update_folder_request, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Rename or move Folder
        api_response = api_instance.folders_update(id, x_apideck_consumer_id, x_apideck_app_id, update_folder_request, x_apideck_service_id=x_apideck_service_id, raw=raw)
