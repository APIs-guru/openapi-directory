...
**event_type** | [**FileStorageEventType**](FileStorageEventType.md) |  | [optional] 

## Example

```python
from openapi_client.models.file_storage_webhook_event import FileStorageWebhookEvent

# TODO update the JSON string below
json = "{}"
# create an instance of FileStorageWebhookEvent from a JSON string
file_storage_webhook_event_instance = FileStorageWebhookEvent.from_json(json)
# print the JSON string representation of the object
print(FileStorageWebhookEvent.to_json())

# convert the object into a dict
file_storage_webhook_event_dict = file_storage_webhook_event_instance.to_dict()
# create an instance of FileStorageWebhookEvent from a dict
file_storage_webhook_event_from_dict = FileStorageWebhookEvent.from_dict(file_storage_webhook_event_dict)
```
