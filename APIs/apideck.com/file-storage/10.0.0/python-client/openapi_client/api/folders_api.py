...
class FoldersApi:
    ...
    def folders_add(
        ...
        _param = self._folders_add_serialize(
    ...
    @validate_call
    def folders_add_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_folder_request: CreateFolderRequest,
    ...
    @validate_call
    def folders_add_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_folder_request: CreateFolderRequest,
    ...
    def _folders_add_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-storage/folders',
    ...
    def folders_copy(
        ...
        :param x_apideck_app_id: The ID of your Unify application (required)
        :type x_apideck_app_id: str
        :param copy_folder_request: (required)
        :type copy_folder_request: CopyFolderRequest
        :param x_apideck_service_id: Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
        :type x_apideck_service_id: str
        :param raw: Include raw response. Mostly used for debugging purposes
        :type raw: bool
    ...
    def _folders_copy_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if copy_folder_request is not None:
            _body_params = copy_folder_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-storage/folders/{id}/copy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _folders_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/file-storage/folders/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def folders_one(
        ...
        _param = self._folders_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
    ...
    @validate_call
    def folders_one_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    @validate_call
    def folders_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
