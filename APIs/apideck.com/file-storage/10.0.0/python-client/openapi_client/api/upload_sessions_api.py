...
class UploadSessionsApi:
    ...
    def upload_sessions_add(
        ...
        _param = self._upload_sessions_add_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateUploadSessionResponse",
    ...
    @validate_call
    def upload_sessions_add_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_upload_session_request: CreateUploadSessionRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[CreateUploadSessionResponse]:
        """Start Upload Session
    ...
    @validate_call
    def upload_sessions_add_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_upload_session_request: CreateUploadSessionRequest,
    ...
    def _upload_sessions_add_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-storage/upload-sessions',
    ...
    def upload_sessions_delete(
        ...
        _param = self._upload_sessions_delete_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteUploadSessionResponse",
            '400': "BadRequestResponse",
            '401': "UnauthorizedResponse",
            '402': "PaymentRequiredResponse",
            '404': "NotFoundResponse",
    ...
    @validate_call
    def upload_sessions_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteUploadSessionResponse]:
        """Abort Upload Session
    ...
    @validate_call
    def upload_sessions_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _upload_sessions_delete_serialize(
        self,
        id,
        x_apideck_consumer_id,
        x_apideck_app_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/file-storage/upload-sessions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_sessions_finish(
        ...
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
        x_apideck_service_id: Annotated[Optional[StrictStr], Field(description="Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.")] = None,
        digest: Annotated[Optional[StrictStr], Field(description="The RFC3230 message digest of the uploaded part. Only required for the Box connector. More information on the Box API docs [here](https://developer.box.com/reference/put-files-upload-sessions-id/#param-digest)")] = None,
        ...
        _param = self._upload_sessions_finish_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            raw=raw,
    ...
    @validate_call
    def upload_sessions_finish_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    @validate_call
    def upload_sessions_finish_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _upload_sessions_finish_serialize(
        self,
        id,
        x_apideck_consumer_id,
        x_apideck_app_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-storage/upload-sessions/{id}/finish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_sessions_one(
        ...
        _param = self._upload_sessions_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
    ...
    @validate_call
    def upload_sessions_one_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetUploadSessionResponse]:
        """Get Upload Session
    ...
    @validate_call
    def upload_sessions_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _upload_sessions_one_serialize(
        self,
        id,
        x_apideck_consumer_id,
        x_apideck_app_id,
    ...
    def upload_sessions_upload(
        ...
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        part_number: Annotated[Union[Annotated[float, Field(le=10000, strict=True, ge=0)], Annotated[int, Field(le=10000, strict=True, ge=0)]], Field(description="Part number of the file part being uploaded.")],
        ...
        :param x_apideck_app_id: The ID of your Unify application (required)
        :type x_apideck_app_id: str
        :param part_number: Part number of the file part being uploaded. (required)
        :type part_number: float
        :param body: (required)
        :type body: bytearray
        :param x_apideck_service_id: Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
        :type x_apideck_service_id: str
        ...
        _param = self._upload_sessions_upload_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateUploadSessionResponse",
            '400': "BadRequestResponse",
            '401': "UnauthorizedResponse",
            '402': "PaymentRequiredResponse",
            '404': "NotFoundResponse",
    ...
    @validate_call
    def upload_sessions_upload_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[UpdateUploadSessionResponse]:
        """Upload part of File to Upload Session
    ...
    @validate_call
    def upload_sessions_upload_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _upload_sessions_upload_serialize(
        self,
        id,
        x_apideck_consumer_id,
        x_apideck_app_id,
        ...
        if part_number is not None:
            ...
            _query_params.append(('part_number', part_number))
