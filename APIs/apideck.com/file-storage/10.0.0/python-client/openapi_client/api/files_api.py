...
class FilesApi:
    ...
    def files_all(
        ...
        filter: Annotated[Optional[FilesFilter], Field(description="Apply filters")] = None,
        sort: Annotated[Optional[FilesSort], Field(description="Apply sorting")] = None,
        ...
        _param = self._files_all_serialize(
    ...
    @validate_call
    def files_all_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    def _files_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/file-storage/files',
    ...
    def _files_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/file-storage/files/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _files_download_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/file-storage/files/{id}/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def files_export(
        ...
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        format: Annotated[StrictStr, Field(description="File format to export this file to. A list of available file formats for the current file is available as `export_formats` on the File resource.")],
        x_apideck_service_id: Annotated[Optional[StrictStr], Field(description="Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param x_apideck_app_id: The ID of your Unify application (required)
        :type x_apideck_app_id: str
        :param format: File format to export this file to. A list of available file formats for the current file is available as `export_formats` on the File resource. (required)
        :type format: str
        :param x_apideck_service_id: Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
        :type x_apideck_service_id: str
        :param fields: The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
        ...
        _param = self._files_export_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            format=format,
    ...
    @validate_call
    def files_export_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    @validate_call
    def files_export_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _files_export_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/file-storage/files/{id}/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def files_one(
        ...
        _param = self._files_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
    ...
    @validate_call
    def files_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def files_search(
        ...
        :param x_apideck_app_id: The ID of your Unify application (required)
        :type x_apideck_app_id: str
        :param files_search: (required)
        :type files_search: FilesSearch
        :param x_apideck_service_id: Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
        :type x_apideck_service_id: str
        :param pass_through: Optional unmapped key/values that will be passed through to downstream as query parameters. Ie: ?pass_through[search]=leads becomes ?search=leads
        :type pass_through: PassThroughQuery
        ...
        _param = self._files_search_serialize(
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
    ...
    @validate_call
    def files_search_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        files_search: FilesSearch,
    ...
    @validate_call
    def files_search_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        files_search: FilesSearch,
    ...
    def _files_search_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if files_search is not None:
            _body_params = files_search
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-storage/files/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def files_upload(
        self,
        x_apideck_metadata: Annotated[CreateFileRequest, Field(description="Metadata to attach to the file")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
        x_apideck_service_id: Annotated[Optional[StrictStr], Field(description="Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.")] = None,
        ...
        :param x_apideck_metadata: Metadata to attach to the file (required)
        :type x_apideck_metadata: CreateFileRequest
        :param x_apideck_consumer_id: ID of the consumer which you want to get or push data from (required)
        :type x_apideck_consumer_id: str
        :param x_apideck_app_id: The ID of your Unify application (required)
        :type x_apideck_app_id: str
    ...
    def _files_upload_serialize(
        ...
        # process the header parameters
        if x_apideck_metadata is not None:
            _header_params['x-apideck-metadata'] = x_apideck_metadata
        if x_apideck_consumer_id is not None:
            _header_params['x-apideck-consumer-id'] = x_apideck_consumer_id
        if x_apideck_app_id is not None:
            _header_params['x-apideck-app-id'] = x_apideck_app_id
