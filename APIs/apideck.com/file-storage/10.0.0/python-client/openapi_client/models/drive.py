...
class Drive(BaseModel):
    ...
    name: StrictStr = Field(description="The name of the drive")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "custom_mappings", "description", "id", "name", "updated_at", "updated_by"]
