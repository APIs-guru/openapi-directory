...
class DriveGroup(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the drive group")
    id: StrictStr = Field(description="A unique identifier for an object.")
    name: StrictStr = Field(description="The name of the drive group")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "custom_mappings", "description", "display_name", "id", "name", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DriveGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DriveGroup from a dict"""
        if obj is None:
            return None
