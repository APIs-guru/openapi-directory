...
class Folder(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Optional description of the folder")
    ...
    parent_folders: List[LinkedFolder] = Field(description="The parent folders of the file, starting from the root")
    parent_folders_complete: Optional[StrictBool] = Field(default=None, description="Whether the list of parent folder is complete. Some connectors only return the direct parent of a folder")
    path: Optional[StrictStr] = Field(default=None, description="The full path of the folder (includes the folder name)")
    size: Optional[StrictInt] = Field(default=None, description="The size of the folder in bytes")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "custom_mappings", "description", "id", "name", "owner", "parent_folders", "parent_folders_complete", "path", "size", "updated_at", "updated_by"]
