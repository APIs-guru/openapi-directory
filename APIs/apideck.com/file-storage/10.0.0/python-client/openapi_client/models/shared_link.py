...
class SharedLink(BaseModel):
    ...
    download_url: Optional[StrictStr] = Field(default=None, description="The URL that can be used to download the file.")
    expires_at: Optional[datetime] = None
    password: Optional[StrictStr] = Field(default=None, description="Optional password for the shared link.")
    password_protected: Optional[StrictBool] = Field(default=None, description="Indicated if the shared link is password protected.")
    scope: Optional[StrictStr] = Field(default=None, description="The scope of the shared link.")
    target: Optional[SharedLinkTarget] = None
    target_id: Optional[StrictStr] = Field(description="The ID of the file or folder to link.")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    url: Optional[StrictStr] = Field(default=None, description="The URL that can be used to view the file.")
    __properties: ClassVar[List[str]] = ["created_at", "download_url", "expires_at", "password", "password_protected", "scope", "target", "target_id", "updated_at", "url"]
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['public', 'company']):
            raise ValueError("must be one of enum values ('public', 'company')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope": obj.get("scope"),
            "target": SharedLinkTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
