...
class Company(BaseModel):
    ...
    industry: Optional[StrictStr] = Field(default=None, description="Industry")
    interaction_count: Optional[StrictInt] = None
    ...
    payee_number: Optional[StrictStr] = None
    ...
    vat_number: Optional[StrictStr] = Field(default=None, description="VAT number")
    websites: Optional[List[Website]] = None
    __properties: ClassVar[List[str]] = ["abn_branch", "abn_or_tfn", "acn", "addresses", "annual_revenue", "bank_accounts", "birthday", "created_at", "created_by", "currency", "custom_fields", "deleted", "description", "emails", "fax", "first_name", "id", "image", "industry", "interaction_count", "last_activity_at", "last_name", "name", "number_of_employees", "owner_id", "ownership", "parent_id", "payee_number", "phone_numbers", "read_only", "row_type", "sales_tax_number", "salutation", "social_links", "status", "tags", "updated_at", "updated_by", "vat_number", "websites"]
