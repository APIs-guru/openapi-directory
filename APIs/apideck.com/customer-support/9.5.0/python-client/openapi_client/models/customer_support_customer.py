...
class CustomerSupportCustomer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addresses", "bank_accounts", "company_name", "created_at", "created_by", "currency", "emails", "first_name", "id", "individual", "last_name", "notes", "phone_numbers", "status", "tax_number", "updated_at", "updated_by"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'archived', 'gdpr-erasure-request', 'unknown']):
            raise ValueError("must be one of enum values ('active', 'archived', 'gdpr-erasure-request', 'unknown')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.bank_accounts:
            _dict['bank_accounts'] = self.bank_accounts.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank_accounts": BankAccount.from_dict(obj["bank_accounts"]) if obj.get("bank_accounts") is not None else None,
