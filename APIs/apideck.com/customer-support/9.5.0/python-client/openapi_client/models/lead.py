...
class Lead(BaseModel):
    ...
    monetary_amount: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["addresses", "company_id", "company_name", "contact_id", "created_at", "currency", "custom_fields", "description", "emails", "fax", "first_name", "id", "language", "last_name", "lead_source", "monetary_amount", "name", "owner_id", "phone_numbers", "prefix", "social_links", "status", "tags", "title", "updated_at", "websites"]
