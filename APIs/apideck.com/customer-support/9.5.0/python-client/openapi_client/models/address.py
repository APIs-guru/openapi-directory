...
class Address(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["city", "contact_name", "country", "county", "email", "fax", "id", "latitude", "line1", "line2", "line3", "line4", "longitude", "name", "phone_number", "postal_code", "row_version", "salutation", "state", "street_number", "string", "type", "website"]
