...
class TestCustomerSupportCustomer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomerSupportCustomer:
        """Test CustomerSupportCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerSupportCustomer`
        """
        model = CustomerSupportCustomer()
        if include_optional:
            return CustomerSupportCustomer(
                ...
                bank_accounts = openapi_client.models.bank_account.BankAccount(
