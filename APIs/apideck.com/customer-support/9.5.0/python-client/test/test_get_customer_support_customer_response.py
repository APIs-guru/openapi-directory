...
class TestGetCustomerSupportCustomerResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomerSupportCustomerResponse:
        """Test GetCustomerSupportCustomerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerSupportCustomerResponse`
        """
        model = GetCustomerSupportCustomerResponse()
        if include_optional:
            return GetCustomerSupportCustomerResponse(
                data = openapi_client.models.customer_support_customer.CustomerSupportCustomer(
                    addresses = [
