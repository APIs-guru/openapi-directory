...
class TestGetCustomerSupportCustomersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomerSupportCustomersResponse:
        """Test GetCustomerSupportCustomersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerSupportCustomersResponse`
        """
        model = GetCustomerSupportCustomersResponse()
        if include_optional:
            return GetCustomerSupportCustomersResponse(
                data = [
                    openapi_client.models.customer_support_customer.CustomerSupportCustomer(
                        addresses = [
