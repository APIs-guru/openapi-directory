...
------------- | ------------- | -------------
[**customers_add**](CustomersApi.md#customers_add) | **POST** /customer-support/customers | Create Customer Support Customer
[**customers_all**](CustomersApi.md#customers_all) | **GET** /customer-support/customers | List Customer Support Customers
[**customers_delete**](CustomersApi.md#customers_delete) | **DELETE** /customer-support/customers/{id} | Delete Customer Support Customer
[**customers_one**](CustomersApi.md#customers_one) | **GET** /customer-support/customers/{id} | Get Customer Support Customer
[**customers_update**](CustomersApi.md#customers_update) | **PATCH** /customer-support/customers/{id} | Update Customer Support Customer


# **customers_add**
> CreateCustomerSupportCustomerResponse customers_add(x_apideck_consumer_id, x_apideck_app_id, customer_support_customer, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
# **customers_all**
> GetCustomerSupportCustomersResponse customers_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Customer Support Customers
        api_response = api_instance.customers_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, fields=fields)
...
# **customers_delete**
> DeleteCustomerSupportCustomerResponse customers_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **customers_one**
> GetCustomerSupportCustomerResponse customers_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
# **customers_update**
> UpdateCustomerSupportCustomerResponse customers_update(id, x_apideck_consumer_id, x_apideck_app_id, customer_support_customer, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Customer Support Customer
        api_response = api_instance.customers_update(id, x_apideck_consumer_id, x_apideck_app_id, customer_support_customer, x_apideck_service_id=x_apideck_service_id, raw=raw)
