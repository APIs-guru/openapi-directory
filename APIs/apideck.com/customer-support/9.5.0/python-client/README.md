...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    customer_support_customer = openapi_client.CustomerSupportCustomer() # CustomerSupportCustomer | 
    ...
    try:
        ...
        api_response = api_instance.customers_add(x_apideck_consumer_id, x_apideck_app_id, customer_support_customer, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
------------ | ------------- | ------------- | -------------
*CustomersApi* | [**customers_add**](docs/CustomersApi.md#customers_add) | **POST** /customer-support/customers | Create Customer Support Customer
*CustomersApi* | [**customers_all**](docs/CustomersApi.md#customers_all) | **GET** /customer-support/customers | List Customer Support Customers
*CustomersApi* | [**customers_delete**](docs/CustomersApi.md#customers_delete) | **DELETE** /customer-support/customers/{id} | Delete Customer Support Customer
*CustomersApi* | [**customers_one**](docs/CustomersApi.md#customers_one) | **GET** /customer-support/customers/{id} | Get Customer Support Customer
*CustomersApi* | [**customers_update**](docs/CustomersApi.md#customers_update) | **PATCH** /customer-support/customers/{id} | Update Customer Support Customer
