...
from openapi_client.models.webhook_event_logs_filter_service import WebhookEventLogsFilterService
...
class WebhookEventLogsFilter(BaseModel):
    ...
    exclude_apis: Optional[StrictStr] = None
    service: Optional[WebhookEventLogsFilterService] = None
    __properties: ClassVar[List[str]] = ["consumer_id", "entity_type", "event_type", "exclude_apis", "service"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if exclude_apis (nullable) is None
        # and model_fields_set contains the field
        if self.exclude_apis is None and "exclude_apis" in self.model_fields_set:
            _dict['exclude_apis'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exclude_apis": obj.get("exclude_apis"),
            "service": WebhookEventLogsFilterService.from_dict(obj["service"]) if obj.get("service") is not None else None
        })
        return _obj
