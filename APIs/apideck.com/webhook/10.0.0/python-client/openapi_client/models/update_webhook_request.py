...
class UpdateWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    delivery_url: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The delivery url of the webhook endpoint.")
    description: Optional[StrictStr] = Field(default=None, description="A description of the object.")
    events: Optional[List[WebhookEventType]] = Field(default=None, description="The list of subscribed events for this webhook. [`*`] indicates that all events are enabled.")
    status: Optional[Status] = None
    __properties: ClassVar[List[str]] = ["delivery_url", "description", "events", "status"]
