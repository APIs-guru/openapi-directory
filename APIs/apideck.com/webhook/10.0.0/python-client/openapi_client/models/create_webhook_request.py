...
class CreateWebhookRequest(BaseModel):
    ...
    events: List[WebhookEventType] = Field(description="The list of subscribed events for this webhook. [`*`] indicates that all events are enabled.")
    status: Status
    unified_api: UnifiedApiId
    __properties: ClassVar[List[str]] = ["delivery_url", "description", "events", "status", "unified_api"]
