...
class WebhooksApi:
    ...
    def event_logs_all(
        ...
        filter: Annotated[Optional[WebhookEventLogsFilter], Field(description="Filter results")] = None,
        ...
        :type filter: WebhookEventLogsFilter
        ...
        _param = self._event_logs_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetWebhookEventLogsResponse",
    ...
    @validate_call
    def event_logs_all_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWebhookEventLogsResponse]:
        """List event logs
    ...
    @validate_call
    def event_logs_all_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
    ...
    def webhooks_add(
        ...
        _param = self._webhooks_add_serialize(
            x_apideck_app_id=x_apideck_app_id,
    ...
    @validate_call
    def webhooks_add_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_webhook_request: CreateWebhookRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def webhooks_add_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        create_webhook_request: CreateWebhookRequest,
        _request_timeout: Union[
    ...
    def _webhooks_add_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webhook/webhooks',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def webhooks_all(
        ...
        _param = self._webhooks_all_serialize(
            x_apideck_app_id=x_apideck_app_id,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def webhooks_all_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
    ...
    @validate_call
    def webhooks_all_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
    ...
    def webhooks_delete(
        self,
        id: Annotated[StrictStr, Field(description="JWT Webhook token that represents the unifiedApi and applicationId associated to the event source.")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _webhooks_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/webhook/webhooks/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def webhooks_one(
        ...
        _param = self._webhooks_one_serialize(
            id=id,
            x_apideck_app_id=x_apideck_app_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def webhooks_one_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="JWT Webhook token that represents the unifiedApi and applicationId associated to the event source.")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        _request_timeout: Union[
    ...
    @validate_call
    def webhooks_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="JWT Webhook token that represents the unifiedApi and applicationId associated to the event source.")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        _request_timeout: Union[
