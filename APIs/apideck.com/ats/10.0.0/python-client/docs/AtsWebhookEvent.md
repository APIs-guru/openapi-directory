...
**event_type** | [**AtsEventType**](AtsEventType.md) |  | [optional] 

## Example

```python
from openapi_client.models.ats_webhook_event import AtsWebhookEvent

# TODO update the JSON string below
json = "{}"
# create an instance of AtsWebhookEvent from a JSON string
ats_webhook_event_instance = AtsWebhookEvent.from_json(json)
# print the JSON string representation of the object
print(AtsWebhookEvent.to_json())

# convert the object into a dict
ats_webhook_event_dict = ats_webhook_event_instance.to_dict()
# create an instance of AtsWebhookEvent from a dict
ats_webhook_event_from_dict = AtsWebhookEvent.from_dict(ats_webhook_event_dict)
```
