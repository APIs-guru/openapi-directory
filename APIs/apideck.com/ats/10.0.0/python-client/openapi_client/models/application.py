...
class Application(BaseModel):
    ...
    Application
    """ # noqa: E501
    applicant_id: Optional[StrictStr]
    ...
    __properties: ClassVar[List[str]] = ["applicant_id", "created_at", "created_by", "custom_mappings", "id", "job_id", "stage", "status", "updated_at", "updated_by"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['open', 'rejected', 'hired', 'converted', 'other']):
            raise ValueError("must be one of enum values ('open', 'rejected', 'hired', 'converted', 'other')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stage": ApplicationStage.from_dict(obj["stage"]) if obj.get("stage") is not None else None,
