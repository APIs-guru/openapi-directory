...
CUSTOMFIELDVALUE_ANY_OF_SCHEMAS = ["List[object]", "List[str]", "bool", "float", "object", "str"]
...
class CustomFieldValue(BaseModel):
    ...
    anyof_schema_6_validator: Optional[List[Dict[str, Any]]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[object], List[str], bool, float, object, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[object]", "List[str]", "bool", "float", "object", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CustomFieldValue with anyOf schemas: List[object], List[str], bool, float, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CustomFieldValue with anyOf schemas: List[object], List[str], bool, float, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[object], List[str], bool, float, object, str]]:
