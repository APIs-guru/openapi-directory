...
class Applicant(BaseModel):
    ...
    coordinator_id: Optional[StrictStr] = None
    cover_letter: Optional[StrictStr] = None
    ...
    cv_url: Optional[StrictStr] = None
    deleted: Optional[StrictBool] = Field(default=None, description="Flag to indicate if the object is deleted.")
    deleted_at: Optional[datetime] = Field(default=None, description="The time at which the object was deleted.")
    deleted_by: Optional[StrictStr] = Field(default=None, description="The user who deleted the object.")
    ...
    headline: Optional[StrictStr] = Field(default=None, description="Typically a list of previous companies where the contact has worked or schools that the contact has attended")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of an applicant.")
    ...
    position_id: Optional[StrictStr] = Field(default=None, description="The PositionId the applicant applied for.")
    record_url: Optional[StrictStr] = None
    recruiter_id: Optional[StrictStr] = None
    rejected_at: Optional[datetime] = None
    social_links: Optional[List[ApplicantSocialLinksInner]] = None
    source_id: Optional[StrictStr] = None
    sourced_by: Optional[StrictStr] = None
    ...
    websites: Optional[List[ApplicantWebsitesInner]] = None
    __properties: ClassVar[List[str]] = ["addresses", "anonymized", "application_ids", "applications", "archived", "birthday", "confidential", "coordinator_id", "cover_letter", "created_at", "created_by", "custom_fields", "custom_mappings", "cv_url", "deleted", "deleted_at", "deleted_by", "emails", "first_name", "followers", "headline", "id", "initials", "job_url", "last_interaction_at", "last_name", "middle_name", "name", "owner_id", "phone_numbers", "photo_url", "position_id", "record_url", "recruiter_id", "rejected_at", "social_links", "source_id", "sourced_by", "sources", "stage_id", "tags", "title", "updated_at", "updated_by", "websites"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if job_url (nullable) is None
        # and model_fields_set contains the field
        if self.job_url is None and "job_url" in self.model_fields_set:
            _dict['job_url'] = None

        # set to None if last_interaction_at (nullable) is None
        # and model_fields_set contains the field
        if self.last_interaction_at is None and "last_interaction_at" in self.model_fields_set:
            _dict['last_interaction_at'] = None
        ...
        # set to None if sourced_by (nullable) is None
        # and model_fields_set contains the field
        if self.sourced_by is None and "sourced_by" in self.model_fields_set:
            _dict['sourced_by'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coordinator_id": obj.get("coordinator_id"),
            "cover_letter": obj.get("cover_letter"),
            ...
            "last_interaction_at": obj.get("last_interaction_at"),
            ...
            "recruiter_id": obj.get("recruiter_id"),
            "rejected_at": obj.get("rejected_at"),
            "social_links": [ApplicantSocialLinksInner.from_dict(_item) for _item in obj["social_links"]] if obj.get("social_links") is not None else None,
            "source_id": obj.get("source_id"),
            "sourced_by": obj.get("sourced_by"),
            ...
            "websites": [ApplicantWebsitesInner.from_dict(_item) for _item in obj["websites"]] if obj.get("websites") is not None else None
        })
        return _obj
