            ...
            return GetJobsResponse(
                data = [
                    openapi_client.models.job.Job(
                        ...
                        blocks = [{"content":"string","title":"string"}], 
                        branch = {"id":"123","name":"HQ NY"}, 
                        closing = 'The closing section of the job description', 
                        closing_date = 'Thu Oct 29 20:00:00 EDT 2020', 
                        closing_html = '', 
                        code = '123-OC', 
                        confidential = False, 
                        ...
                        language = 'EN', 
                        links = [
                            openapi_client.models.job_links_inner.Job_links_inner(
                                type = 'job_portal', 
                        ...
                        salary = openapi_client.models.job_salary.Job_salary(
                            currency = 'USD', 
                            interval = 'year', 
                            max = 10000, 
                            min = 8000, ), 
