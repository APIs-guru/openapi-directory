...
class TestGetApplicantsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetApplicantsResponse:
        """Test GetApplicantsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApplicantsResponse`
        """
        model = GetApplicantsResponse()
        if include_optional:
            return GetApplicantsResponse(
                data = [
                    openapi_client.models.applicant.Applicant(
                        addresses = [
