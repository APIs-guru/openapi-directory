    ...
    def make_instance(self, include_optional) -> Applicant:
        ...
        if include_optional:
            return Applicant(
                ...
                social_links = [
                    openapi_client.models.applicant_social_links_inner.Applicant_social_links_inner(
                        id = '12345', 
                        type = 'twitter', 
                ...
                updated_by = '12345',
                websites = [
                    openapi_client.models.applicant_websites_inner.Applicant_websites_inner(
                        id = '12345', 
                        type = 'primary', 
