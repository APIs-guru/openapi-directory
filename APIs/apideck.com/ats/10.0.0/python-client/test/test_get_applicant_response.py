...
class TestGetApplicantResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetApplicantResponse:
        """Test GetApplicantResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApplicantResponse`
        """
        model = GetApplicantResponse()
        if include_optional:
            return GetApplicantResponse(
                data = openapi_client.models.applicant.Applicant(
                    addresses = [
