...
class TestGetPosPaymentsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPosPaymentsResponse:
        """Test GetPosPaymentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPosPaymentsResponse`
        """
        model = GetPosPaymentsResponse()
        if include_optional:
            return GetPosPaymentsResponse(
                data = [
                    openapi_client.models.pos_payment.PosPayment(
                        amount = 27.5, 
                        app_fee = 3, 
                        approved = 37.5, 
                        bank_account = openapi_client.models.bank_account.Bank Account(
                            account_ownership_type = '', 
                            ach_details = openapi_client.models.pos_bank_account_ach_details.PosBankAccount_ach_details(
                            ...
                            transfer_type = '', ), 
                        card_details = openapi_client.models.pos_payment_card_details.PosPayment_card_details(
                        ...
                        cash = openapi_client.models.cash_details.Cash details(
                            amount = null, 
                        ...
                        device_id = '12345', 
                        employee_id = '12345', 
                        external_details = openapi_client.models.pos_payment_external_details.PosPayment_external_details(
                            source = '', 
                        ...
                        updated_by = '12345', 
                        wallet = openapi_client.models.wallet_details.Wallet details(
                            status = 'authorized', ), )
                    ],
