            ...
            return GetItemsResponse(
                data = [
                    openapi_client.models.item.Item(
                        ...
                        categories = [{"id":"12345","image_ids":["12345","67890"],"name":"Food"}], 
                        code = '11910345', 
                        cost = 2, 
                        ...
                        name = 'Cocoa', 
                        options = [
                            openapi_client.models.item_options_inner.Item_options_inner(
                                attribute_id = '12345', 
                                id = '12345', 
                                name = 'Option 1', )
                            ], 
                        ...
                        variations = [{"id":"12345","image_ids":["12345","67890"],"item_id":"12345","name":"Food","price_amount":10,"price_currency":"USD","pricing_type":"fixed","sequence":0,"sku":"11910345"}], 
                        version = '12345', )
                    ],
