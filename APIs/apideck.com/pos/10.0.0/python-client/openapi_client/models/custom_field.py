...
class CustomField(BaseModel):
    ...
    CustomField
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="More information about the custom field")
    id: Optional[StrictStr] = Field(description="Unique identifier for the custom field.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the custom field.")
    value: Optional[CustomFieldValue] = None
    __properties: ClassVar[List[str]] = ["description", "id", "name", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "value": CustomFieldValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
