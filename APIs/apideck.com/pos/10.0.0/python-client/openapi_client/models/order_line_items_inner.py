...
from openapi_client.models.variations_inner import VariationsInner
from typing import Optional, Set
from typing_extensions import Self

class OrderLineItemsInner(BaseModel):
    """
    OrderLineItemsInner
    """ # noqa: E501
    applied_discounts: Optional[List[OrderLineItemsInnerAppliedDiscountsInner]] = None
    applied_taxes: Optional[List[OrderLineItemsInnerAppliedTaxesInner]] = None
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    item: Optional[VariationsInner] = None
    modifiers: Optional[List[OrderLineItemsInnerModifiersInner]] = Field(default=None, description="Customizable options – toppings, add-ons, or special requests – create item modifiers. Modifiers that are applied to items will display on your customers’ digital receipts")
    ...
    __properties: ClassVar[List[str]] = ["applied_discounts", "applied_taxes", "id", "item", "modifiers", "name", "quantity", "total_amount", "total_discount", "total_tax", "unit_price"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.applied_discounts:
            ...
            _dict['applied_discounts'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applied_discounts": [OrderLineItemsInnerAppliedDiscountsInner.from_dict(_item) for _item in obj["applied_discounts"]] if obj.get("applied_discounts") is not None else None,
            "applied_taxes": [OrderLineItemsInnerAppliedTaxesInner.from_dict(_item) for _item in obj["applied_taxes"]] if obj.get("applied_taxes") is not None else None,
            "id": obj.get("id"),
            "item": VariationsInner.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "modifiers": [OrderLineItemsInnerModifiersInner.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None,
            "name": obj.get("name"),
