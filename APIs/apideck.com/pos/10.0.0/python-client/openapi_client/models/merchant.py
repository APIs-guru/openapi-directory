...
class Merchant(BaseModel):
    ...
    main_location_id: Optional[StrictStr] = Field(default=None, description="The main location ID of the merchant")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of this merchant.")
    ...
    __properties: ClassVar[List[str]] = ["address", "created_at", "created_by", "currency", "custom_mappings", "id", "language", "main_location_id", "name", "owner_id", "service_charges", "status", "updated_at", "updated_by"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'inactive', 'other']):
            raise ValueError("must be one of enum values ('active', 'inactive', 'other')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if main_location_id (nullable) is None
        # and model_fields_set contains the field
        if self.main_location_id is None and "main_location_id" in self.model_fields_set:
            _dict['main_location_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "main_location_id": obj.get("main_location_id"),
            "name": obj.get("name"),
