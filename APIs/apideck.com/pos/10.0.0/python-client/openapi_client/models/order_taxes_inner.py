...
class OrderTaxesInner(BaseModel):
    """
    OrderTaxesInner
    """ # noqa: E501
    amount: Optional[StrictInt] = None
    auto_applied: Optional[StrictBool] = Field(default=None, description="Square-only: Determines whether the tax was automatically applied to the order based on the catalog configuration. For an example, see Automatically Apply Taxes to an Order. [https://developer.squareup.com/docs/orders-api/apply-taxes-and-discounts/auto-apply-taxes]()")
    ...
    __properties: ClassVar[List[str]] = ["amount", "auto_applied", "currency", "id", "name", "percentage", "scope", "type"]
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['order', 'line_item']):
            raise ValueError("must be one of enum values ('order', 'line_item')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'additive', 'inclusive']):
            raise ValueError("must be one of enum values ('unknown', 'additive', 'inclusive')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_applied": obj.get("auto_applied"),
