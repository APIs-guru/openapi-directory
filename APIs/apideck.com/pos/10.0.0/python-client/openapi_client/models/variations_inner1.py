...
class VariationsInner1(BaseModel):
    """
    VariationsInner1
    """ # noqa: E501
    ...
    item_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    ...
    stockable: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["created_at", "id", "item_id", "name", "present_at_all_locations", "price_amount", "price_currency", "pricing_type", "sequence", "sku", "stockable", "updated_at", "version"]
    ...
    def pricing_type_validate_enum(cls, value):
        ...
        if value not in set(['fixed', 'variable', 'other']):
            raise ValueError("must be one of enum values ('fixed', 'variable', 'other')")
        return value
