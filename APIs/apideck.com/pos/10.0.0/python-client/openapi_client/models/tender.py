...
class Tender(BaseModel):
    ...
    allows_tipping: Optional[StrictBool] = Field(default=True, description="Allow tipping on payment from tender")
    ...
    opens_cash_drawer: Optional[StrictBool] = Field(default=True, description="If this tender opens the cash drawer")
    ...
    __properties: ClassVar[List[str]] = ["active", "allows_tipping", "created_at", "created_by", "custom_mappings", "editable", "hidden", "id", "key", "label", "opens_cash_drawer", "updated_at", "updated_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allows_tipping": obj.get("allows_tipping") if obj.get("allows_tipping") is not None else True,
            ...
            "key": obj.get("key"),
            "label": obj.get("label"),
            "opens_cash_drawer": obj.get("opens_cash_drawer") if obj.get("opens_cash_drawer") is not None else True,
