...
class Location(BaseModel):
    ...
    business_name: Optional[StrictStr] = Field(default=None, description="The business name of the location")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the location")
    status: Optional[StrictStr] = Field(default=None, description="Status of this location.")
    ...
    __properties: ClassVar[List[str]] = ["address", "business_name", "created_at", "created_by", "currency", "custom_mappings", "id", "merchant_id", "name", "status", "updated_at", "updated_by"]
