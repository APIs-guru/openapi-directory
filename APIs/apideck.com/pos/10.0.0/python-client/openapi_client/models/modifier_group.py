...
class ModifierGroup(BaseModel):
    ...
    maximum_allowed: Optional[StrictInt] = None
    minimum_required: Optional[StrictInt] = None
    modifiers: Optional[List[ModifierGroupModifiersInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["alternate_name", "created_at", "created_by", "custom_mappings", "deleted", "id", "maximum_allowed", "minimum_required", "modifiers", "name", "present_at_all_locations", "row_version", "selection_type", "updated_at", "updated_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "maximum_allowed": obj.get("maximum_allowed"),
            "minimum_required": obj.get("minimum_required"),
            "modifiers": [ModifierGroupModifiersInner.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None,
            "name": obj.get("name"),
