...
class Modifier(BaseModel):
    ...
    Modifier
    """ # noqa: E501
    alternate_name: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["alternate_name", "available", "created_at", "created_by", "currency", "custom_mappings", "id", "idempotency_key", "modifier_group_id", "name", "price_amount", "updated_at", "updated_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modifier_group_id": obj.get("modifier_group_id"),
            "name": obj.get("name"),
