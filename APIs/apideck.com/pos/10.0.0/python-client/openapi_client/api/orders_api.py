...
class OrdersApi:
    ...
    def orders_add(
        ...
        _param = self._orders_add_serialize(
    ...
    @validate_call
    def orders_add_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        order: Order,
    ...
    def orders_all(
        ...
        location_id: Annotated[Optional[StrictStr], Field(description="ID of the location.")] = None,
    ...
    def orders_pay(
        ...
        _param = self._orders_pay_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            order=order,
    ...
    @validate_call
    def orders_pay_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _orders_pay_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pos/orders/{id}/pay',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
