...
------------- | ------------- | -------------
[**items_add**](ItemsApi.md#items_add) | **POST** /pos/items | Create Item
[**items_all**](ItemsApi.md#items_all) | **GET** /pos/items | List Items
[**items_delete**](ItemsApi.md#items_delete) | **DELETE** /pos/items/{id} | Delete Item
[**items_one**](ItemsApi.md#items_one) | **GET** /pos/items/{id} | Get Item
[**items_update**](ItemsApi.md#items_update) | **PATCH** /pos/items/{id} | Update Item


# **items_add**
> CreateItemResponse items_add(x_apideck_consumer_id, x_apideck_app_id, item, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
# **items_all**
> GetItemsResponse items_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Items
        api_response = api_instance.items_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, fields=fields)
        print("The response of ItemsApi->items_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->items_all: %s\n" % e)
```
...
# **items_delete**
> DeleteItemResponse items_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Item
        api_response = api_instance.items_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **items_one**
> GetItemResponse items_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Item
        api_response = api_instance.items_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of ItemsApi->items_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->items_one: %s\n" % e)
```
...
# **items_update**
> UpdateItemResponse items_update(id, x_apideck_consumer_id, x_apideck_app_id, item, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Item
        api_response = api_instance.items_update(id, x_apideck_consumer_id, x_apideck_app_id, item, x_apideck_service_id=x_apideck_service_id, raw=raw)
