...
from openapi_client.models.update_contact_response import UpdateContactResponse
...
class ContactsApi:
    ...
    def contacts_add(
        ...
        _param = self._contacts_add_serialize(
    ...
    @validate_call
    def contacts_add_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        contact: Contact,
    ...
    @validate_call
    def contacts_add_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        contact: Contact,
    ...
    def contacts_all(
        ...
        filter: Annotated[Optional[ContactsFilter], Field(description="Apply filters")] = None,
        sort: Annotated[Optional[ContactsSort], Field(description="Apply sorting")] = None,
        ...
        :type filter: ContactsFilter
        :param sort: Apply sorting
        :type sort: ContactsSort
        ...
        _param = self._contacts_all_serialize(
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            raw=raw,
            x_apideck_service_id=x_apideck_service_id,
    ...
    @validate_call
    def contacts_all_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    @validate_call
    def contacts_all_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    def contacts_one(
        ...
        _param = self._contacts_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
    ...
    @validate_call
    def contacts_one_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    @validate_call
    def contacts_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def contacts_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateContactResponse]:
        """Update contact
