...
class Lead(BaseModel):
    ...
    company_id: Optional[StrictStr] = Field(default=None, description="The company the lead is associated with.")
    company_name: Optional[StrictStr] = Field(description="The name of the company the lead is associated with.")
    created_at: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Date created in ISO 8601 format")
    ...
    description: Optional[StrictStr] = Field(default=None, description="The description of the lead.")
    emails: Optional[List[Email]] = None
    fax: Optional[StrictStr] = Field(default=None, description="The fax number of the lead.")
    first_name: Optional[StrictStr] = Field(default=None, description="The first name of the lead.")
    ...
    last_name: Optional[StrictStr] = Field(default=None, description="The last name of the lead.")
    lead_id: Optional[StrictStr] = Field(default=None, description="The identifier of the lead.")
    lead_source: Optional[StrictStr] = Field(default=None, description="The source of the lead.")
    monetary_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The monetary amount of the lead.")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Full name of the lead.")
    owner_id: Optional[StrictStr] = Field(default=None, description="The owner of the lead.")
    phone_numbers: Optional[List[PhoneNumber]] = None
    prefix: Optional[StrictStr] = Field(default=None, description="The prefix of the lead.")
    social_links: Optional[List[SocialLink]] = None
    status: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    title: Optional[StrictStr] = Field(default=None, description="The job title of the lead.")
    updated_at: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Date updated in ISO 8601 format")
    websites: Optional[List[Website]] = None
    __properties: ClassVar[List[str]] = ["addresses", "company_id", "company_name", "created_at", "currency", "custom_fields", "custom_mappings", "description", "emails", "fax", "first_name", "id", "language", "last_name", "lead_id", "lead_source", "monetary_amount", "name", "owner_id", "phone_numbers", "prefix", "social_links", "status", "tags", "title", "updated_at", "websites"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if monetary_amount (nullable) is None
        # and model_fields_set contains the field
        if self.monetary_amount is None and "monetary_amount" in self.model_fields_set:
            _dict['monetary_amount'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monetary_amount": obj.get("monetary_amount"),
            "name": obj.get("name"),
