...
class User(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(default=None, description="The date and time when the user was created.")
    ...
    image: Optional[StrictStr] = Field(default=None, description="The URL of the user's avatar")
    ...
    parent_id: Optional[StrictStr] = Field(default=None, description="The parent user id")
    ...
    updated_at: Optional[StrictStr] = Field(default=None, description="The date and time when the user was last updated.")
    username: Optional[StrictStr] = Field(default=None, description="The username of the user")
    __properties: ClassVar[List[str]] = ["addresses", "company_name", "created_at", "custom_mappings", "department", "description", "division", "emails", "employee_number", "first_name", "id", "image", "language", "last_name", "parent_id", "password", "phone_numbers", "status", "title", "updated_at", "username"]
