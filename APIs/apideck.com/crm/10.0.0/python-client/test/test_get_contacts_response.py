...
class TestGetContactsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetContactsResponse:
        """Test GetContactsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContactsResponse`
        """
            ...
            return GetContactsResponse(
                data = [
                    openapi_client.models.contact.Contact(
                        ...
                        fax = '+12129876543', 
                        first_call_at = '2020-09-30T07:43:32Z', 
                        first_email_at = '2020-09-30T07:43:32Z', 
                        first_name = 'Elon', 
                        gender = 'female', 
                        id = '12345', 
