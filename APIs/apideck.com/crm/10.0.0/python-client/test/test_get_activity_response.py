...
class TestGetActivityResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetActivityResponse:
        """Test GetActivityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetActivityResponse`
        """
        model = GetActivityResponse()
        if include_optional:
            return GetActivityResponse(
                data = openapi_client.models.activity.Activity(
                    account_id = '12345', 
                    ...
                    asset_id = '12345', 
                    attendees = [
                        openapi_client.models.activity_attendee.ActivityAttendee(
                            contact_id = '12345', 
                    ...
                    lead_id = '12345', 
                    location = 'Space', 
                    location_address = openapi_client.models.address.Address(
                        city = 'San Francisco', 
