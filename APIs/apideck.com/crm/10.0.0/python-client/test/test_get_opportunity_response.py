...
class TestGetOpportunityResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOpportunityResponse:
        """Test GetOpportunityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOpportunityResponse`
        """
        model = GetOpportunityResponse()
        if include_optional:
            return GetOpportunityResponse(
                data = openapi_client.models.opportunity.Opportunity(
                    close_date = 'Thu Oct 29 20:00:00 EDT 2020', 
                    company_id = '12345', 
                    company_name = 'Copper', 
                    contact_id = '12345', 
                    contact_ids = [
                    ...
                    date_last_contacted = '2020-09-30T00:00Z', 
                    date_lead_created = '2020-09-30T00:00Z', 
                    date_stage_changed = '2020-09-30T00:00Z', 
                    deleted = False, 
                    ...
                    priority = 'None', 
                    source_id = '12345', 
                    stage_last_changed_at = '2020-09-30T07:43:32Z', 
                    status = 'Open', 
                    status_id = '12345', 
                    tags = ["New"], 
                    title = 'New Rocket', 
