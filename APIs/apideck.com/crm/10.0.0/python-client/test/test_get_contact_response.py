...
class TestGetContactResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetContactResponse:
        """Test GetContactResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContactResponse`
        """
        model = GetContactResponse()
        if include_optional:
            return GetContactResponse(
                data = openapi_client.models.contact.Contact(
                    active = True, 
                    addresses = [
