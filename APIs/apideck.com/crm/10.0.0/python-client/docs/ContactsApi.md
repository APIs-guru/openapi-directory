...
------------- | ------------- | -------------
[**contacts_add**](ContactsApi.md#contacts_add) | **POST** /crm/contacts | Create contact
[**contacts_all**](ContactsApi.md#contacts_all) | **GET** /crm/contacts | List contacts
[**contacts_delete**](ContactsApi.md#contacts_delete) | **DELETE** /crm/contacts/{id} | Delete contact
[**contacts_one**](ContactsApi.md#contacts_one) | **GET** /crm/contacts/{id} | Get contact
[**contacts_update**](ContactsApi.md#contacts_update) | **PATCH** /crm/contacts/{id} | Update contact


# **contacts_add**
> CreateContactResponse contacts_add(x_apideck_consumer_id, x_apideck_app_id, contact, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create contact
        api_response = api_instance.contacts_add(x_apideck_consumer_id, x_apideck_app_id, contact, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of ContactsApi->contacts_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ContactsApi->contacts_add: %s\n" % e)
```
...
# **contacts_all**
> GetContactsResponse contacts_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.ContactsFilter() # ContactsFilter | Apply filters (optional)
    sort = openapi_client.ContactsSort() # ContactsSort | Apply sorting (optional)
    ...
    try:
        # List contacts
        api_response = api_instance.contacts_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
        print("The response of ContactsApi->contacts_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ContactsApi->contacts_all: %s\n" % e)
```
 ...
 **filter** | [**ContactsFilter**](.md)| Apply filters | [optional] 
 **sort** | [**ContactsSort**](.md)| Apply sorting | [optional] 
...
# **contacts_delete**
> DeleteContactResponse contacts_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete contact
        api_response = api_instance.contacts_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **contacts_one**
> GetContactResponse contacts_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get contact
        api_response = api_instance.contacts_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of ContactsApi->contacts_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ContactsApi->contacts_one: %s\n" % e)
```
...
# **contacts_update**
> UpdateContactResponse contacts_update(id, x_apideck_consumer_id, x_apideck_app_id, contact, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update contact
        api_response = api_instance.contacts_update(id, x_apideck_consumer_id, x_apideck_app_id, contact, x_apideck_service_id=x_apideck_service_id, raw=raw)
