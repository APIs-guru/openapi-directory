...
------------- | ------------- | -------------
[**leads_add**](LeadsApi.md#leads_add) | **POST** /crm/leads | Create lead
[**leads_all**](LeadsApi.md#leads_all) | **GET** /crm/leads | List leads
[**leads_delete**](LeadsApi.md#leads_delete) | **DELETE** /crm/leads/{id} | Delete lead
[**leads_one**](LeadsApi.md#leads_one) | **GET** /crm/leads/{id} | Get lead
[**leads_update**](LeadsApi.md#leads_update) | **PATCH** /crm/leads/{id} | Update lead
...
# **leads_all**
> GetLeadsResponse leads_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List leads
        api_response = api_instance.leads_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
