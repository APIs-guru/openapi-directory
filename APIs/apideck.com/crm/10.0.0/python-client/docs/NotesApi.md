...
------------- | ------------- | -------------
[**notes_add**](NotesApi.md#notes_add) | **POST** /crm/notes | Create note
[**notes_all**](NotesApi.md#notes_all) | **GET** /crm/notes | List notes
[**notes_delete**](NotesApi.md#notes_delete) | **DELETE** /crm/notes/{id} | Delete note
[**notes_one**](NotesApi.md#notes_one) | **GET** /crm/notes/{id} | Get note
[**notes_update**](NotesApi.md#notes_update) | **PATCH** /crm/notes/{id} | Update note


# **notes_add**
> CreateNoteResponse notes_add(x_apideck_consumer_id, x_apideck_app_id, note, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create note
        api_response = api_instance.notes_add(x_apideck_consumer_id, x_apideck_app_id, note, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of NotesApi->notes_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotesApi->notes_add: %s\n" % e)
```
...
# **notes_all**
> GetNotesResponse notes_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List notes
        api_response = api_instance.notes_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
        print("The response of NotesApi->notes_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotesApi->notes_all: %s\n" % e)
```
...
# **notes_delete**
> DeleteNoteResponse notes_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete note
        api_response = api_instance.notes_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of NotesApi->notes_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotesApi->notes_delete: %s\n" % e)
```
...
# **notes_one**
> GetNoteResponse notes_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get note
        api_response = api_instance.notes_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of NotesApi->notes_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotesApi->notes_one: %s\n" % e)
```
...
# **notes_update**
> UpdateNoteResponse notes_update(id, x_apideck_consumer_id, x_apideck_app_id, note, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update note
        api_response = api_instance.notes_update(id, x_apideck_consumer_id, x_apideck_app_id, note, x_apideck_service_id=x_apideck_service_id, raw=raw)
