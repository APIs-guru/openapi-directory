...
------------- | ------------- | -------------
[**activities_add**](ActivitiesApi.md#activities_add) | **POST** /crm/activities | Create activity
[**activities_all**](ActivitiesApi.md#activities_all) | **GET** /crm/activities | List activities
[**activities_delete**](ActivitiesApi.md#activities_delete) | **DELETE** /crm/activities/{id} | Delete activity
[**activities_one**](ActivitiesApi.md#activities_one) | **GET** /crm/activities/{id} | Get activity
[**activities_update**](ActivitiesApi.md#activities_update) | **PATCH** /crm/activities/{id} | Update activity


# **activities_add**
> CreateActivityResponse activities_add(x_apideck_consumer_id, x_apideck_app_id, activity, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
# **activities_all**
> GetActivitiesResponse activities_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.ActivitiesFilter() # ActivitiesFilter | Apply filters (optional)
    ...
    try:
        # List activities
        api_response = api_instance.activities_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of ActivitiesApi->activities_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitiesApi->activities_all: %s\n" % e)
```
...
# **activities_delete**
> DeleteActivityResponse activities_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete activity
        api_response = api_instance.activities_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of ActivitiesApi->activities_delete:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitiesApi->activities_delete: %s\n" % e)
```
...
# **activities_one**
> GetActivityResponse activities_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get activity
        api_response = api_instance.activities_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of ActivitiesApi->activities_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitiesApi->activities_one: %s\n" % e)
```
...
# **activities_update**
> UpdateActivityResponse activities_update(id, x_apideck_consumer_id, x_apideck_app_id, activity, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update activity
        api_response = api_instance.activities_update(id, x_apideck_consumer_id, x_apideck_app_id, activity, x_apideck_service_id=x_apideck_service_id, raw=raw)
        print("The response of ActivitiesApi->activities_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitiesApi->activities_update: %s\n" % e)
```
