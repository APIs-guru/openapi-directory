...
class ConnectionImportData(BaseModel):
    ...
    """ # noqa: E501
    credentials: Optional[ConnectionImportDataCredentials] = None
    ...
    __properties: ClassVar[List[str]] = ["credentials", "metadata", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": ConnectionImportDataCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
