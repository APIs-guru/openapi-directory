...
class RequestCountAllocation(BaseModel):
    ...
    """ # noqa: E501
    proxy: Optional[Union[StrictFloat, StrictInt]] = None
    unify: Optional[Union[StrictFloat, StrictInt]] = None
    vault: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["proxy", "unify", "vault"]
