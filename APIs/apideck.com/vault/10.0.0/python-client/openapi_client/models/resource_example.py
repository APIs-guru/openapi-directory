...
class ResourceExample(BaseModel):
    ...
    ResourceExample
    """ # noqa: E501
    example_response: Optional[Dict[str, Any]] = Field(default=None, description="Example response from the downstream API")
    resource: Optional[LinkedConnectorResource] = None
    ...
    __properties: ClassVar[List[str]] = ["example_response", "resource", "service_id", "unified_api"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource": LinkedConnectorResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
