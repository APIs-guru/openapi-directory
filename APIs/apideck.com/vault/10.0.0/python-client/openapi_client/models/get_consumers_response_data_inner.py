...
class GetConsumersResponseDataInner(BaseModel):
    """
    GetConsumersResponseDataInner
    """ # noqa: E501
    aggregated_request_count: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    request_count_updated: Optional[StrictStr] = None
    request_counts: Optional[RequestCountAllocation] = None
    services: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["aggregated_request_count", "application_id", "consumer_id", "created", "metadata", "modified", "request_count_updated", "request_counts", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregated_request_count": obj.get("aggregated_request_count"),
            "application_id": obj.get("application_id"),
            "consumer_id": obj.get("consumer_id"),
            "created": obj.get("created"),
            "metadata": ConsumerMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "modified": obj.get("modified"),
            "request_count_updated": obj.get("request_count_updated"),
            "request_counts": RequestCountAllocation.from_dict(obj["request_counts"]) if obj.get("request_counts") is not None else None,
