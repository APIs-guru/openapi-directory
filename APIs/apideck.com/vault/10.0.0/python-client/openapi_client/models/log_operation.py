...
class LogOperation(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The OpenApi Operation Id associated with the request")
    name: StrictStr = Field(description="The OpenApi Operation name associated with the request")
