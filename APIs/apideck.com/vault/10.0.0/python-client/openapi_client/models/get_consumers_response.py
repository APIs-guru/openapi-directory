...
class GetConsumersResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[GetConsumersResponseDataInner]
    ...
    __properties: ClassVar[List[str]] = ["data", "links", "meta", "status", "status_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetConsumersResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
