...
class ConnectionConfigurationInnerDefaultsInner(BaseModel):
    """
    ...
    value: Optional[ConnectionConfigurationInnerDefaultsInnerValue] = None
    __properties: ClassVar[List[str]] = ["id", "options", "target", "value"]
    ...
    def target_validate_enum(cls, value):
        ...
        if value not in set(['custom_fields', 'resource']):
            raise ValueError("must be one of enum values ('custom_fields', 'resource')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": ConnectionConfigurationInnerDefaultsInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
