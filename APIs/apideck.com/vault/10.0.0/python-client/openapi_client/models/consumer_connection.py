...
class ConsumerConnection(BaseModel):
    ...
    unified_api: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    website: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["auth_type", "consumer_id", "created_at", "enabled", "icon", "id", "logo", "metadata", "name", "service_id", "settings", "state", "tag_line", "unified_api", "updated_at", "website"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['available', 'callable', 'added', 'configured', 'authorized']):
            raise ValueError("must be one of enum values ('available', 'callable', 'added', 'configured', 'authorized')")
        return value
