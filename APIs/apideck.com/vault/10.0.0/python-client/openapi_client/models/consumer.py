...
class Consumer(BaseModel):
    ...
    consumer_id: StrictStr = Field(description="Unique consumer identifier. You can freely choose a consumer ID yourself. Most of the time, this is an ID of your internal data model that represents a user or account in your system (for example account:12345). If the consumer doesn't exist yet, Vault will upsert a consumer based on your ID.")
    ...
    __properties: ClassVar[List[str]] = ["aggregated_request_count", "application_id", "connections", "consumer_id", "created", "metadata", "modified", "request_count_updated", "request_counts", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connections": [ConsumerConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,
