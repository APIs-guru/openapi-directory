...
class GetCustomMappingResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data", "status", "status_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CustomMapping.from_dict(obj["data"]) if obj.get("data") is not None else None,
