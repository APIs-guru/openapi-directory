...
class ConsumerRequestCountsInDateRangeResponseData(BaseModel):
    ...
    end_datetime: Optional[StrictStr] = None
    request_counts: Optional[RequestCountAllocation] = None
    start_datetime: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["aggregated_request_count", "application_id", "consumer_id", "end_datetime", "request_counts", "start_datetime"]
