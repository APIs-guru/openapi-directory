...
class SessionsApi:
    ...
    def sessions_create(
        ...
        session: Annotated[Optional[Session], Field(description="Additional redirect uri and/or consumer metadata")] = None,
        ...
        _param = self._sessions_create_serialize(
    ...
    @validate_call
    def sessions_create_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        session: Annotated[Optional[Session], Field(description="Additional redirect uri and/or consumer metadata")] = None,
    ...
    @validate_call
    def sessions_create_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        session: Annotated[Optional[Session], Field(description="Additional redirect uri and/or consumer metadata")] = None,
    ...
    def _sessions_create_serialize(
        self,
