...
class TestConnectionEvent(unittest.TestCase):
    """ConnectionEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionEvent:
        """Test ConnectionEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionEvent`
        """
        model = ConnectionEvent()
        if include_optional:
            return ConnectionEvent(
                entity = openapi_client.models.consumer_connection.ConsumerConnection(
                    auth_type = 'oauth2', 
