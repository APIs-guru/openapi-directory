...
class TestConnectionsApi(unittest.TestCase):
    ...
    def test_connection_settings_all(self) -> None:
    ...
    def test_connection_settings_update(self) -> None:
    ...
    def test_connections_add(self) -> None:
    ...
    def test_connections_all(self) -> None:
    ...
    def test_connections_authorize(self) -> None:
    ...
    def test_connections_callback(self) -> None:
    ...
    def test_connections_import(self) -> None:
    ...
    def test_connections_one(self) -> None:
    ...
    def test_connections_revoke(self) -> None:
    ...
    def test_connections_token(self) -> None:
    ...
    def test_custom_fields_all(self) -> None:
