...
class TestSession(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Session:
        ...
        if include_optional:
            return Session(
                consumer_metadata = openapi_client.models.consumer_metadata.ConsumerMetadata(
                    account_name = 'SpaceX', 
                    email = 'elon@musk.com', 
                    image = 'https://www.spacex.com/static/images/share.jpg', 
                    user_name = 'Elon Musk', ),
                custom_consumer_settings = {"feature_flag_1":true,"tax_rates":[{"id":"6","label":"6%"},{"id":"21","label":"21%"}]},
                redirect_uri = 'https://mysaas.com/dashboard',
                settings = openapi_client.models.session_settings.Session_settings(
                    allow_actions = [
                        'delete'
                        ], 
                    auto_redirect = True, 
                ...
                theme = openapi_client.models.session_theme.Session_theme(
