...
class TestCreateSessionResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateSessionResponseData:
        """Test CreateSessionResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSessionResponseData`
        """
        model = CreateSessionResponseData()
        if include_optional:
