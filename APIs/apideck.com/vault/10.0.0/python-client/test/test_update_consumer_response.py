...
class TestUpdateConsumerResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateConsumerResponse:
        """Test UpdateConsumerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateConsumerResponse`
        """
        model = UpdateConsumerResponse()
        if include_optional:
            return UpdateConsumerResponse(
                data = openapi_client.models.consumer.Consumer(
                    aggregated_request_count = 101, 
                    application_id = 'dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX', 
                    connections = [
                        openapi_client.models.consumer_connection.ConsumerConnection(
                            auth_type = 'oauth2', 
                            ...
                            settings = {"instance_url":"https://eu28.salesforce.com"}, 
                            state = 'authorized', 
                    ...
                    metadata = openapi_client.models.consumer_metadata.ConsumerMetadata(
                        account_name = 'SpaceX', 
                        email = 'elon@musk.com', 
                    ...
                    request_counts = openapi_client.models.request_count_allocation.RequestCountAllocation(
                        proxy = 10, 
                        unify = 100, 
                        vault = 21, ), 
