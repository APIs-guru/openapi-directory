...
class TestConsumersApi(unittest.TestCase):
    ...
    def test_consumer_request_counts_all(self) -> None:
    ...
    def test_consumers_add(self) -> None:
    ...
    def test_consumers_all(self) -> None:
    ...
    def test_consumers_delete(self) -> None:
    ...
    def test_consumers_one(self) -> None:
    ...
    def test_consumers_update(self) -> None:
