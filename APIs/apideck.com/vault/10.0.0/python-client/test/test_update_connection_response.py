...
class TestUpdateConnectionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateConnectionResponse:
        """Test UpdateConnectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateConnectionResponse`
        """
        model = UpdateConnectionResponse()
        if include_optional:
            return UpdateConnectionResponse(
                data = openapi_client.models.connection.Connection(
                    auth_type = 'oauth2', 
                    ...
                    configuration = [
                        openapi_client.models.connection_configuration_inner.Connection_configuration_inner(
                            defaults = [
                                openapi_client.models.connection_configuration_inner_defaults_inner.Connection_configuration_inner_defaults_inner(
                                    id = 'ProductInterest', 
                                    options = [
                                        null
                                        ], 
                    ...
                    custom_mappings = [
                        openapi_client.models.custom_mapping.CustomMapping(
                    ...
                    enabled = True, 
                    form_fields = [{"custom_field":false,"disabled":false,"id":"instance_url","label":"Instance url","mask":false,"placeholder":"","required":true,"sensitive":false,"type":"text","value":"https://eu28.salesforce.com"},{"custom_field":false,"disabled":false,"id":"api_key","label":"API Key","mask":false,"placeholder":"","required":true,"sensitive":true,"type":"text","value":"123455677"}], 
                    has_guide = True, 
                    ...
                    metadata = {"account":{"id":"c01458a5-7276-41ce-bc19-639906b0450a","name":"My Company"},"plan":"enterprise"}, 
                    name = 'Salesforce', 
                    ...
                    settings = {"api_key":"12345xxxxxx","instance_url":"https://eu28.salesforce.com"}, 
                    settings_required_for_authorization = ["client_id","client_secret"], 
                    state = 'authorized', 
                    status = 'live', 
                    subscriptions = [
                        openapi_client.models.webhook_subscription.WebhookSubscription(
