...
------------- | ------------- | -------------
[**orders_all**](OrdersApi.md#orders_all) | **GET** /ecommerce/orders | List Orders
[**orders_one**](OrdersApi.md#orders_one) | **GET** /ecommerce/orders/{id} | Get Order


# **orders_all**
> GetEcommerceOrdersResponse orders_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.EcommerceOrdersFilter() # EcommerceOrdersFilter | Apply filters (optional)
    ...
    try:
        # List Orders
        api_response = api_instance.orders_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
# **orders_one**
> GetEcommerceOrderResponse orders_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
