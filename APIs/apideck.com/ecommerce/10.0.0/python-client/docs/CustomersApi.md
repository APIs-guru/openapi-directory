...
------------- | ------------- | -------------
[**customers_all**](CustomersApi.md#customers_all) | **GET** /ecommerce/customers | List Customers
[**customers_one**](CustomersApi.md#customers_one) | **GET** /ecommerce/customers/{id} | Get Customer


# **customers_all**
> GetEcommerceCustomersResponse customers_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, pass_through=pass_through, fields=fields)
...
# **customers_one**
> GetEcommerceCustomerResponse customers_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
