...
------------- | ------------- | -------------
[**products_all**](ProductsApi.md#products_all) | **GET** /ecommerce/products | List Products
[**products_one**](ProductsApi.md#products_one) | **GET** /ecommerce/products/{id} | Get Product


# **products_all**
> GetProductsResponse products_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Products
        api_response = api_instance.products_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, pass_through=pass_through, fields=fields)
        print("The response of ProductsApi->products_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductsApi->products_all: %s\n" % e)
```
...
# **products_one**
> GetProductResponse products_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Product
        api_response = api_instance.products_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of ProductsApi->products_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductsApi->products_one: %s\n" % e)
```
