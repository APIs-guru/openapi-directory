...
class CustomersApi:
    ...
    def customers_all(
        ...
        filter: Annotated[Optional[EcommerceCustomersFilter], Field(description="Apply filters")] = None,
        ...
        :type filter: EcommerceCustomersFilter
        ...
        _param = self._customers_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEcommerceCustomersResponse",
    ...
    @validate_call
    def customers_all_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEcommerceCustomersResponse]:
        """List Customers
    ...
    @validate_call
    def customers_all_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    def _customers_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ecommerce/customers',
    ...
    def customers_one(
        ...
        _param = self._customers_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEcommerceCustomerResponse",
            '400': "BadRequestResponse",
            '401': "UnauthorizedResponse",
            '402': "PaymentRequiredResponse",
            '404': "NotFoundResponse",
    ...
    @validate_call
    def customers_one_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEcommerceCustomerResponse]:
        """Get Customer
    ...
    @validate_call
    def customers_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _customers_one_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ecommerce/customers/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
