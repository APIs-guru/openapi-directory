...
class OrdersApi:
    ...
    def orders_all(
        ...
        filter: Annotated[Optional[EcommerceOrdersFilter], Field(description="Apply filters")] = None,
        ...
        :type filter: EcommerceOrdersFilter
        ...
        _param = self._orders_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEcommerceOrdersResponse",
    ...
    def orders_all_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEcommerceOrdersResponse]:
        """List Orders
    ...
    @validate_call
    def orders_all_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    def _orders_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ecommerce/orders',
    ...
    def orders_one(
        ...
        _param = self._orders_one_serialize(
            id=id,
            x_apideck_consumer_id=x_apideck_consumer_id,
            x_apideck_app_id=x_apideck_app_id,
            x_apideck_service_id=x_apideck_service_id,
    ...
    def orders_one_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEcommerceOrderResponse]:
        """Get Order
    ...
    @validate_call
    def orders_one_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _orders_one_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ecommerce/orders/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
