...
class EcommerceAddress(BaseModel):
    ...
    """ # noqa: E501
    city: Optional[StrictStr] = Field(default=None, description="City of the billing address.")
    company_name: Optional[StrictStr] = Field(default=None, description="Company name of the customer")
    country: Optional[Annotated[str, Field(strict=True, max_length=2)]] = Field(default=None, description="Country of the billing address.")
    line1: Optional[StrictStr] = Field(default=None, description="Address line 1 of the billing address.")
    line2: Optional[StrictStr] = Field(default=None, description="Address line 2 of the billing address.")
    postal_code: Optional[StrictStr] = Field(default=None, description="Postal/ZIP code of the billing address.")
    state: Optional[StrictStr] = Field(default=None, description="State/province of the billing address.")
    __properties: ClassVar[List[str]] = ["city", "company_name", "country", "line1", "line2", "postal_code", "state"]
