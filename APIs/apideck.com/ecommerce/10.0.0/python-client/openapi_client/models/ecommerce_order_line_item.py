...
class EcommerceOrderLineItem(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The description of the product or variant associated with the line item.")
    ...
    name: Optional[StrictStr] = Field(description="The name of the product or variant associated with the line item.")
    options: Optional[List[EcommerceOrderLineItemOptionsInner]] = None
    product_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for the product associated with the line item.")
    quantity: Optional[StrictStr] = Field(description="The quantity of the product or variant associated with the line item.")
    sku: Optional[StrictStr] = Field(default=None, description="The SKU of the product or variant associated with the line item.")
    tax_amount: Optional[StrictStr] = Field(default=None, description="The total tax amount applied to the product or variant associated with the line item.")
    tax_rate: Optional[StrictStr] = Field(default=None, description="The tax rate applied to the product or variant associated with the line item.")
    total_amount: Optional[StrictStr] = Field(description="The total amount for the product(s) or variant associated with the line item, including taxes and discounts.")
    unit_price: Optional[StrictStr] = Field(default=None, description="The unit price of the product or variant associated with the line item.")
    variant_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for the variant of the product associated with the line item, if applicable.")
    __properties: ClassVar[List[str]] = ["description", "discounts", "id", "name", "options", "product_id", "quantity", "sku", "tax_amount", "tax_rate", "total_amount", "unit_price", "variant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "options": [EcommerceOrderLineItemOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
