...
class LinkedEcommerceCustomer(BaseModel):
    ...
    """ # noqa: E501
    company_name: Optional[StrictStr] = Field(default=None, description="Company name of the customer")
    emails: Optional[List[Email]] = None
    first_name: Optional[StrictStr] = Field(default=None, description="First name of the customer")
    id: Optional[StrictStr] = Field(description="The ID of the customer this entity is linked to.")
    ...
    __properties: ClassVar[List[str]] = ["company_name", "emails", "first_name", "id", "last_name", "name", "phone_numbers"]
