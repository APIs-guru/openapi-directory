...
class TrackingItem(BaseModel):
    ...
    """ # noqa: E501
    number: Optional[StrictStr] = Field(description=" The tracking number associated with the shipment, which can be used to track the progress of the delivery.")
    provider: Optional[StrictStr] = Field(description="The name or code of the carrier or shipping company that is handling the shipment.")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the carrier's tracking page, which can be used to view detailed information about the shipment's progress.")
    __properties: ClassVar[List[str]] = ["number", "provider", "updated_at", "url"]
