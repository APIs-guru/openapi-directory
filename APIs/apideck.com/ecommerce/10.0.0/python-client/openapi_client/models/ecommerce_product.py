...
class EcommerceProduct(BaseModel):
    ...
    EcommerceProduct
    """ # noqa: E501
    categories: Optional[List[ProductCategoriesInner]] = Field(default=None, description="An array of categories for the product, used for organization and searching.")
    ...
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the product.")
    id: StrictStr = Field(description="A unique identifier for an object.")
    images: Optional[List[ProductImagesInner]] = Field(default=None, description="An array of image URLs for the product.")
    inventory_quantity: Optional[StrictStr] = Field(default=None, description="The quantity of the product in stock.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the product as it should be displayed to customers.")
    options: Optional[List[ProductOptionsInner]] = Field(default=None, description="An array of options for the product.")
    price: Optional[StrictStr] = Field(default=None, description="The price of the product.")
    sku: Optional[StrictStr] = Field(default=None, description="The stock keeping unit of the product.")
    status: Optional[StrictStr] = Field(default=None, description="The current status of the product (active or archived).")
    tags: Optional[List[Optional[StrictStr]]] = Field(default=None, description="An array of tags for the product, used for organization and searching.")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    variants: Optional[List[EcommerceProductVariantsInner]] = None
    weight: Optional[StrictStr] = Field(default=None, description="The weight of the product.")
    weight_unit: Optional[StrictStr] = Field(default=None, description="The unit of measurement for the weight of the product.")
    __properties: ClassVar[List[str]] = ["categories", "created_at", "custom_mappings", "description", "id", "images", "inventory_quantity", "name", "options", "price", "sku", "status", "tags", "updated_at", "variants", "weight", "weight_unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [ProductCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            ...
            "name": obj.get("name"),
            "options": [ProductOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
            "price": obj.get("price"),
            "sku": obj.get("sku"),
            "status": obj.get("status"),
            "tags": obj.get("tags"),
            "updated_at": obj.get("updated_at"),
            "variants": [EcommerceProductVariantsInner.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None,
