...
class EcommerceStore(BaseModel):
    ...
    EcommerceStore
    """ # noqa: E501
    admin_url: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The store's admin login URL")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The store's name")
    store_url: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The store's website URL")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    __properties: ClassVar[List[str]] = ["admin_url", "created_at", "custom_mappings", "id", "name", "store_url", "updated_at"]

    @field_validator('admin_url')
    def admin_url_validate_regular_expression(cls, value):
    ...
    def store_url_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
