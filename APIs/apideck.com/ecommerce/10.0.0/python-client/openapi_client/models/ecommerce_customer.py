...
class EcommerceCustomer(BaseModel):
    ...
    EcommerceCustomer
    """ # noqa: E501
    addresses: Optional[List[AddressesInner]] = Field(default=None, description="An array of addresses for the customer.")
    ...
    emails: Optional[List[Email]] = Field(default=None, description="An array of email addresses for the customer.")
    ...
    phone_numbers: Optional[List[PhoneNumber]] = Field(default=None, description="An array of phone numbers for the customer.")
    status: Optional[StrictStr] = Field(default=None, description="The current status of the customer")
    updated_at: Optional[datetime] = Field(default=None, description="The date and time when the object was last updated.")
    __properties: ClassVar[List[str]] = ["addresses", "company_name", "created_at", "currency", "custom_mappings", "emails", "first_name", "id", "last_name", "name", "orders", "phone_numbers", "status", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [AddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            ...
            "name": obj.get("name"),
            "orders": [LinkedEcommerceOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
