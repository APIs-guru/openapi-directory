    ...
    def make_instance(self, include_optional) -> GetProductsResponse:
        ...
        if include_optional:
            return GetProductsResponse(
                data = [
                    openapi_client.models.ecommerce_product.EcommerceProduct(
                        categories = [
                            openapi_client.models.product_categories_inner.Product_Categories_inner(
                                id = '12345', 
                                name = 'Laptops', )
                            ], 
                        ...
                        id = '12345', 
                        images = [
                            openapi_client.models.product_images_inner.Product_Images_inner(
                                url = 'https://example.com/macbook-pro.jpg', )
                            ], 
                        inventory_quantity = '10', 
                        name = 'MacBook Pro', 
                        options = [
                            openapi_client.models.product_options_inner.Product_Options_inner(
                                name = 'Color', 
                                values = [
                                    'Red'
                                    ], )
                        ...
                        variants = [
                            openapi_client.models.ecommerce_product_variants_inner.EcommerceProduct_variants_inner(
                                images = [
                                    openapi_client.models.ecommerce_product_variants_inner_images_inner.EcommerceProduct_variants_inner_images_inner(
                                        url = 'https://example.com/macbook-pro.jpg', )
                                    ], 
                                inventory_quantity = '5', 
                                name = 'Midnight 16inch MacBook Pro', 
                                options = [
                                    openapi_client.models.ecommerce_product_variants_inner_options_inner.EcommerceProduct_variants_inner_options_inner(
                                        name = 'Color', 
                                        value = 'Silver', )
                                    ], 
                                price = '1999.99', 
