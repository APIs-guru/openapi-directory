...
class TestGetConnectorsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetConnectorsResponse:
        """Test GetConnectorsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetConnectorsResponse`
        """
        model = GetConnectorsResponse()
        if include_optional:
