...
class TestGetConnectorResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetConnectorResponse:
        """Test GetConnectorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetConnectorResponse`
        """
        model = GetConnectorResponse()
        if include_optional:
            return GetConnectorResponse(
                data = openapi_client.models.connector.Connector(
                    auth_only = True, 
                    auth_type = 'oauth2', 
                    blind_mapped = True, 
                    ...
                    docs = [
                        openapi_client.models.connector_doc.ConnectorDoc(
                    ...
                    oauth_scopes = [
                        openapi_client.models.connector_oauth_scopes_inner.Connector_oauth_scopes_inner(
                            default_apis = [
                                'crm'
                                ], 
                            id = 'contacts:all', 
                    ...
                    schema_support = openapi_client.models.schema_support.SchemaSupport(
                        supported = True, ), 
                    service_id = 'close', 
                    settings = [
                        openapi_client.models.connector_setting.ConnectorSetting(
                            id = 'pipeline_id', 
                            label = 'Pipeline', 
                            type = 'select', )
                        ], 
                    ...
                    status = 'live', 
                    supported_events = [
                        openapi_client.models.connector_event.ConnectorEvent(
                    ...
                    supported_resources = [
                        openapi_client.models.linked_connector_resource.LinkedConnectorResource(
                            downstream_id = 'accounts', 
                            downstream_name = 'Accounts', 
                            id = 'companies', 
                            name = 'Companies', )
                        ], 
                    tls_support = openapi_client.models.connector_tls_support.Connector_tls_support(
                        description = '', 
                        type = '', ), 
                    unified_apis = [
                        openapi_client.models.connector_unified_apis_inner.Connector_unified_apis_inner(
                            auth_only = True, 
                    ...
                    webhook_support = openapi_client.models.webhook_support.WebhookSupport(
                        managed_via = 'api', 
                        mode = 'native', 
                        subscription_level = 'integration', 
                        virtual_webhooks = openapi_client.models.virtual_webhooks.Virtual Webhooks(
                            request_rate = openapi_client.models.request_rate.Request Rate(
                                rate = 56, 
                                size = 56, 
                                unit = 'second', ), ), ), 
