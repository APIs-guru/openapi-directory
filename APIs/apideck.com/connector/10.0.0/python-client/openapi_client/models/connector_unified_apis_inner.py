...
class ConnectorUnifiedApisInner(BaseModel):
    """
    ...
    downstream_unsupported_resources: Optional[List[StrictStr]] = Field(default=None, description="List of resources that are not supported on the downstream.")
    id: Optional[UnifiedApiId] = None
    name: Optional[StrictStr] = Field(default=None, description="Name of the API.")
    oauth_scopes: Optional[List[ConnectorUnifiedApisInnerOauthScopesInner]] = None
    supported_events: Optional[List[ConnectorEvent]] = Field(default=None, description="List of events that are supported on the connector for this Unified API.")
    ...
    __properties: ClassVar[List[str]] = ["auth_only", "downstream_unsupported_resources", "id", "name", "oauth_scopes", "supported_events", "supported_resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "downstream_unsupported_resources": obj.get("downstream_unsupported_resources"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "oauth_scopes": [ConnectorUnifiedApisInnerOauthScopesInner.from_dict(_item) for _item in obj["oauth_scopes"]] if obj.get("oauth_scopes") is not None else None,
