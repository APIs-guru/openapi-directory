...
class ConnectorDoc(BaseModel):
    ...
    ConnectorDoc
    """ # noqa: E501
    audience: Optional[StrictStr] = Field(default=None, description="Audience for the doc.")
    format: Optional[StrictStr] = Field(default=None, description="Format of the doc.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the doc.")
    url: Optional[StrictStr] = Field(default=None, description="Link to fetch the content of the doc.")
    __properties: ClassVar[List[str]] = ["audience", "format", "id", "name", "url"]
    ...
    def audience_validate_enum(cls, value):
        ...
        if value not in set(['application_owner', 'consumer']):
            raise ValueError("must be one of enum values ('application_owner', 'consumer')")
        return value
