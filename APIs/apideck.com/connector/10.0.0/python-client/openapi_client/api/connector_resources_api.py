...
class ConnectorResourcesApi:
    ...
    def connector_resources_one(
        ...
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
        unified_api: Annotated[Optional[UnifiedApiId], Field(description="Specify unified API for the connector resource. This is useful when a resource appears in multiple APIs")] = None,
        ...
        :type id: str
        :param resource_id: ID of the resource you are acting upon. (required)
        ...
        _param = self._connector_resources_one_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetConnectorResourceResponse",
    ...
    @validate_call
    def connector_resources_one_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetConnectorResourceResponse]:
        """Get Connector Resource
    ...
    @validate_call
    def connector_resources_one_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
    ...
    def _connector_resources_one_serialize(
        self,
        x_apideck_app_id,
        id,
        resource_id,
        ...
        if unified_api is not None:
            ...
            _query_params.append(('unified_api', unified_api.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/connector/connectors/{id}/resources/{resource_id}',
