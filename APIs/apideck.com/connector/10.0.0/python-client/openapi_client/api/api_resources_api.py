...
class APIResourcesApi:
    ...
    def api_resource_coverage_one(
        ...
        _param = self._api_resource_coverage_one_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetApiResourceCoverageResponse",
    ...
    @validate_call
    def api_resource_coverage_one_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApiResourceCoverageResponse]:
        """Get API Resource Coverage
    ...
    @validate_call
    def api_resource_coverage_one_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
    ...
    def _api_resource_coverage_one_serialize(
        self,
        x_apideck_app_id,
        id,
        resource_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/connector/apis/{id}/resources/{resource_id}/coverage',
    ...
    def api_resources_one(
        ...
        _param = self._api_resources_one_serialize(
            x_apideck_app_id=x_apideck_app_id,
            id=id,
            resource_id=resource_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def api_resources_one_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApiResourceResponse]:
        """Get API Resource
    ...
    @validate_call
    def api_resources_one_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        resource_id: Annotated[StrictStr, Field(description="ID of the resource you are acting upon.")],
    ...
    def _api_resources_one_serialize(
        self,
        x_apideck_app_id,
        id,
        resource_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/connector/apis/{id}/resources/{resource_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
