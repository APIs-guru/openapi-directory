...
class ConnectorsApi:
    ...
    def connectors_all(
        ...
        filter: Annotated[Optional[ConnectorsFilter], Field(description="Apply filters")] = None,
        ...
        _param = self._connectors_all_serialize(
    ...
    @validate_call
    def connectors_all_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetConnectorsResponse]:
        """List Connectors
    ...
    @validate_call
    def connectors_all_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        cursor: Annotated[Optional[StrictStr], Field(description="Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Number of results to return. Minimum 1, Maximum 200, Default 20")] = None,
    ...
    def _connectors_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/connector/connectors',
    ...
    def connectors_one(
        ...
        _param = self._connectors_one_serialize(
            x_apideck_app_id=x_apideck_app_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def connectors_one_with_http_info(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetConnectorResponse]:
        """Get Connector
    ...
    @validate_call
    def connectors_one_without_preload_content(
        self,
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        id: Annotated[StrictStr, Field(description="ID of the record you are acting upon.")],
        _request_timeout: Union[
    ...
    def _connectors_one_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/connector/connectors/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
