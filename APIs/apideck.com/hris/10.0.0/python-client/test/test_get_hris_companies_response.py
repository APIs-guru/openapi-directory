...
class TestGetHrisCompaniesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetHrisCompaniesResponse:
        """Test GetHrisCompaniesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHrisCompaniesResponse`
        """
        model = GetHrisCompaniesResponse()
        if include_optional:
            return GetHrisCompaniesResponse(
                data = [
                    openapi_client.models.hris_company.HrisCompany(
                        addresses = [
