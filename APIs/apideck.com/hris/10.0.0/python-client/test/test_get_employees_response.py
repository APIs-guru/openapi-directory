...
class TestGetEmployeesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEmployeesResponse:
        """Test GetEmployeesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEmployeesResponse`
        """
        model = GetEmployeesResponse()
        if include_optional:
            return GetEmployeesResponse(
                data = [
                    openapi_client.models.employee.Employee(
                        addresses = [
