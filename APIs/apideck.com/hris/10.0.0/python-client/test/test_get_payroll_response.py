...
class TestGetPayrollResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPayrollResponse:
        """Test GetPayrollResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayrollResponse`
        """
        model = GetPayrollResponse()
        if include_optional:
            return GetPayrollResponse(
                data = openapi_client.models.payroll.Payroll(
                    check_date = '2022-04-08', 
                    company_id = '23456', 
                    compensations = [
                        openapi_client.models.compensation.Compensation(
                            benefits = [
                                openapi_client.models.benefit.Benefit(
                    ...
                    totals = openapi_client.models.payroll_totals.PayrollTotals(
