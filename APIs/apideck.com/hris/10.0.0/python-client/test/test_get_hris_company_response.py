...
class TestGetHrisCompanyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetHrisCompanyResponse:
        """Test GetHrisCompanyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHrisCompanyResponse`
        """
        model = GetHrisCompanyResponse()
        if include_optional:
            return GetHrisCompanyResponse(
                data = openapi_client.models.hris_company.HrisCompany(
                    addresses = [
