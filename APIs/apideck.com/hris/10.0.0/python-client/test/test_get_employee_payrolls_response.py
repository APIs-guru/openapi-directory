...
class TestGetEmployeePayrollsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEmployeePayrollsResponse:
        """Test GetEmployeePayrollsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEmployeePayrollsResponse`
        """
        model = GetEmployeePayrollsResponse()
        if include_optional:
            return GetEmployeePayrollsResponse(
                data = [
                    openapi_client.models.employee_payroll.EmployeePayroll(
