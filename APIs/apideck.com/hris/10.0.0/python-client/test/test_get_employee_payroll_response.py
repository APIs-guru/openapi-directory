...
class TestGetEmployeePayrollResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEmployeePayrollResponse:
        """Test GetEmployeePayrollResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEmployeePayrollResponse`
        """
        model = GetEmployeePayrollResponse()
        if include_optional:
            return GetEmployeePayrollResponse(
                data = openapi_client.models.employee_payroll.EmployeePayroll(
