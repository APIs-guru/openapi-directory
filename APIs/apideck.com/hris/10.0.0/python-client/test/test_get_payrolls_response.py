...
class TestGetPayrollsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPayrollsResponse:
        """Test GetPayrollsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayrollsResponse`
        """
        model = GetPayrollsResponse()
        if include_optional:
            return GetPayrollsResponse(
                data = [
                    openapi_client.models.payroll.Payroll(
