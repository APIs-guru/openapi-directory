...
**event_type** | [**HrisEventType**](HrisEventType.md) |  | [optional] 
...
json = "{}"
# create an instance of HrisWebhookEvent from a JSON string
hris_webhook_event_instance = HrisWebhookEvent.from_json(json)
# print the JSON string representation of the object
print(HrisWebhookEvent.to_json())

# convert the object into a dict
hris_webhook_event_dict = hris_webhook_event_instance.to_dict()
# create an instance of HrisWebhookEvent from a dict
hris_webhook_event_from_dict = HrisWebhookEvent.from_dict(hris_webhook_event_dict)
```
