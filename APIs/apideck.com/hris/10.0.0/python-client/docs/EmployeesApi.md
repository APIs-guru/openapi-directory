...
------------- | ------------- | -------------
[**employees_add**](EmployeesApi.md#employees_add) | **POST** /hris/employees | Create Employee
[**employees_all**](EmployeesApi.md#employees_all) | **GET** /hris/employees | List Employees
[**employees_delete**](EmployeesApi.md#employees_delete) | **DELETE** /hris/employees/{id} | Delete Employee
[**employees_one**](EmployeesApi.md#employees_one) | **GET** /hris/employees/{id} | Get Employee
[**employees_update**](EmployeesApi.md#employees_update) | **PATCH** /hris/employees/{id} | Update Employee


# **employees_add**
> CreateEmployeeResponse employees_add(x_apideck_consumer_id, x_apideck_app_id, employee, raw=raw, x_apideck_service_id=x_apideck_service_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    employee = openapi_client.Employee() # Employee | 
    ...
    try:
        # Create Employee
        api_response = api_instance.employees_add(x_apideck_consumer_id, x_apideck_app_id, employee, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of EmployeesApi->employees_add:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmployeesApi->employees_add: %s\n" % e)
```
...
# **employees_all**
> GetEmployeesResponse employees_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = openapi_client.EmployeesFilter() # EmployeesFilter | Apply filters (optional)
    sort = openapi_client.EmployeesSort() # EmployeesSort | Apply sorting (optional)
    ...
    try:
        # List Employees
        api_response = api_instance.employees_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, cursor=cursor, limit=limit, filter=filter, sort=sort, pass_through=pass_through, fields=fields)
        print("The response of EmployeesApi->employees_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmployeesApi->employees_all: %s\n" % e)
```
 ...
 **filter** | [**EmployeesFilter**](.md)| Apply filters | [optional] 
 **sort** | [**EmployeesSort**](.md)| Apply sorting | [optional] 
...
# **employees_delete**
> DeleteEmployeeResponse employees_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Employee
        api_response = api_instance.employees_delete(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
# **employees_one**
> GetEmployeeResponse employees_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Employee
        api_response = api_instance.employees_one(id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=x_apideck_service_id, raw=raw, fields=fields)
        print("The response of EmployeesApi->employees_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmployeesApi->employees_one: %s\n" % e)
```
...
# **employees_update**
> UpdateEmployeeResponse employees_update(id, x_apideck_consumer_id, x_apideck_app_id, employee, x_apideck_service_id=x_apideck_service_id, raw=raw)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Employee
        api_response = api_instance.employees_update(id, x_apideck_consumer_id, x_apideck_app_id, employee, x_apideck_service_id=x_apideck_service_id, raw=raw)
