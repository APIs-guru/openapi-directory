...
------------- | ------------- | -------------
[**payrolls_all**](PayrollsApi.md#payrolls_all) | **GET** /hris/payrolls | List Payroll
[**payrolls_one**](PayrollsApi.md#payrolls_one) | **GET** /hris/payrolls/{payroll_id} | Get Payroll


# **payrolls_all**
> GetPayrollsResponse payrolls_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, filter=filter, pass_through=pass_through, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Payroll
        api_response = api_instance.payrolls_all(x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, filter=filter, pass_through=pass_through, fields=fields)
        print("The response of PayrollsApi->payrolls_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PayrollsApi->payrolls_all: %s\n" % e)
```
...
# **payrolls_one**
> GetPayrollResponse payrolls_one(payroll_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Payroll
        api_response = api_instance.payrolls_one(payroll_id, x_apideck_consumer_id, x_apideck_app_id, raw=raw, x_apideck_service_id=x_apideck_service_id, fields=fields)
        print("The response of PayrollsApi->payrolls_one:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PayrollsApi->payrolls_one: %s\n" % e)
```
