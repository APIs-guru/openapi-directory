...
class EmployeeManager(BaseModel):
    ...
    EmployeeManager
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The email address of the manager.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the manager, often a combination of their first and last names.")
    __properties: ClassVar[List[str]] = ["email", "employment_status", "first_name", "id", "last_name", "name"]
