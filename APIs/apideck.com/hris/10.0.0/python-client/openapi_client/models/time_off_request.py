...
class TimeOffRequest(BaseModel):
    ...
    TimeOffRequest
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of time off requested.")
    approval_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date the request was approved")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of the time off request.")
    employee_id: Optional[StrictStr] = Field(default=None, description="ID of the employee")
    end_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The end date of the time off request.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for an object.")
    notes: Optional[TimeOffRequestNotes] = None
    policy_id: Optional[StrictStr] = Field(default=None, description="ID of the policy")
    request_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date the request was made.")
    request_type: Optional[StrictStr] = Field(default=None, description="The type of request")
    start_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The start date of the time off request.")
    status: Optional[StrictStr] = Field(default=None, description="The status of the time off request.")
    units: Optional[StrictStr] = Field(default=None, description="The unit of time off requested. Possible values include: `hours`, `days`, or `other`.")
    ...
    __properties: ClassVar[List[str]] = ["amount", "approval_date", "created_at", "created_by", "custom_mappings", "description", "employee_id", "end_date", "id", "notes", "policy_id", "request_date", "request_type", "start_date", "status", "units", "updated_at", "updated_by"]
    ...
    def request_date_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def request_type_validate_enum(cls, value):
        ...
        if value not in set(['vacation', 'sick', 'personal', 'jury_duty', 'volunteer', 'bereavement', 'other']):
            raise ValueError("must be one of enum values ('vacation', 'sick', 'personal', 'jury_duty', 'volunteer', 'bereavement', 'other')")
        return value
    ...
    def units_validate_enum(cls, value):
        ...
        if value not in set(['days', 'hours', 'other']):
            raise ValueError("must be one of enum values ('days', 'hours', 'other')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if request_date (nullable) is None
        # and model_fields_set contains the field
        if self.request_date is None and "request_date" in self.model_fields_set:
            _dict['request_date'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "notes": TimeOffRequestNotes.from_dict(obj["notes"]) if obj.get("notes") is not None else None,
