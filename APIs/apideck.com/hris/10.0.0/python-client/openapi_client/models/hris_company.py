...
class HrisCompany(BaseModel):
    ...
    company_number: Optional[StrictStr] = Field(default=None, description="An Company Number, Company ID or Company Code, is a unique number that has been assigned to each company.")
    ...
    debtor_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    legal_name: Optional[Annotated[str, Field(min_length=1, strict=True)]]
    phone_numbers: Optional[List[PhoneNumber]] = None
    status: Optional[StrictStr] = None
    subdomain: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["addresses", "company_number", "created_at", "created_by", "currency", "custom_mappings", "debtor_id", "deleted", "display_name", "emails", "id", "legal_name", "phone_numbers", "status", "subdomain", "updated_at", "updated_by", "websites"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'inactive', 'trial', 'other']):
            raise ValueError("must be one of enum values ('active', 'inactive', 'trial', 'other')")
        return value
