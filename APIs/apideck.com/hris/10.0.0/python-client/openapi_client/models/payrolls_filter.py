...
class PayrollsFilter(BaseModel):
    ...
    PayrollsFilter
    """ # noqa: E501
    end_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Return payrolls whose pay period is before the end date")
    start_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Return payrolls whose pay period is after the start date")
