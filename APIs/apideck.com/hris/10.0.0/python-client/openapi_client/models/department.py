...
class Department(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Department name")
    ...
    __properties: ClassVar[List[str]] = ["code", "created_at", "created_by", "custom_mappings", "description", "id", "name", "parent_id", "updated_at", "updated_by"]
