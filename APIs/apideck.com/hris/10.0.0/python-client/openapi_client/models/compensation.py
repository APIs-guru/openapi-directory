...
class Compensation(BaseModel):
    ...
    Compensation
    """ # noqa: E501
    benefits: Optional[List[Benefit]] = Field(default=None, description="An array of employee benefits for the pay period.")
    deductions: Optional[List[Deduction]] = Field(default=None, description="An array of employee deductions for the pay period.")
    employee_id: Optional[StrictStr] = Field(description="A unique identifier for an object.")
    gross_pay: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The employee's gross pay. Only available when payroll has been processed")
    net_pay: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The employee's net pay. Only available when payroll has been processed")
    taxes: Optional[List[Tax]] = Field(default=None, description="An array of employer and employee taxes for the pay period.")
    __properties: ClassVar[List[str]] = ["benefits", "deductions", "employee_id", "gross_pay", "net_pay", "taxes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "benefits": [Benefit.from_dict(_item) for _item in obj["benefits"]] if obj.get("benefits") is not None else None,
