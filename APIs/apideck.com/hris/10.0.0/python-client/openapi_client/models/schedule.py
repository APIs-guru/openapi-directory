...
class Schedule(BaseModel):
    ...
    Schedule
    """ # noqa: E501
    end_date: Annotated[str, Field(strict=True)] = Field(description="The end date, inclusive, of the schedule period.")
    id: StrictStr = Field(description="A unique identifier for an object.")
    start_date: Annotated[str, Field(strict=True)] = Field(description="The start date, inclusive, of the schedule period.")
    work_pattern: ScheduleWorkPattern
    __properties: ClassVar[List[str]] = ["end_date", "id", "start_date", "work_pattern"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of work_pattern
        if self.work_pattern:
            _dict['work_pattern'] = self.work_pattern.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "work_pattern": ScheduleWorkPattern.from_dict(obj["work_pattern"]) if obj.get("work_pattern") is not None else None
        })
        return _obj
