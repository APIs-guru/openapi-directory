...
class Payroll(BaseModel):
    ...
    Payroll
    """ # noqa: E501
    check_date: Optional[Annotated[str, Field(strict=True)]] = Field(description="The date on which employees will be paid for the payroll.")
    company_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the company.")
    compensations: Optional[List[Compensation]] = Field(default=None, description="An array of compensations for the payroll.")
    ...
    end_date: Optional[Annotated[str, Field(strict=True)]] = Field(description="The end date, inclusive, of the pay period.")
    id: Optional[StrictStr] = Field(description="A unique identifier for an object.")
    processed: Optional[StrictBool] = Field(description="Whether or not the payroll has been successfully processed. Note that processed payrolls cannot be updated.")
    processed_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date the payroll was processed.")
    start_date: Optional[Annotated[str, Field(strict=True)]] = Field(description="The start date, inclusive, of the pay period.")
    totals: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["check_date", "company_id", "compensations", "custom_mappings", "end_date", "id", "processed", "processed_date", "start_date", "totals"]

    @field_validator('check_date')
    def check_date_validate_regular_expression(cls, value):
    ...
    def processed_date_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if processed_date (nullable) is None
        # and model_fields_set contains the field
        if self.processed_date is None and "processed_date" in self.model_fields_set:
            _dict['processed_date'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compensations": [Compensation.from_dict(_item) for _item in obj["compensations"]] if obj.get("compensations") is not None else None,
            "custom_mappings": obj.get("custom_mappings"),
            "end_date": obj.get("end_date"),
            "id": obj.get("id"),
            "processed": obj.get("processed"),
            "processed_date": obj.get("processed_date"),
            "start_date": obj.get("start_date"),
            "totals": PayrollTotals.from_dict(obj["totals"]) if obj.get("totals") is not None else None
        })
        return _obj
