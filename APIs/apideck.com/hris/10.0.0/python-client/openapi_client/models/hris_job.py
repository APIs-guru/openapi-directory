...
class HrisJob(BaseModel):
    ...
    location: Optional[HrisJobLocation] = None
    start_date: Optional[date] = None
    title: Optional[StrictStr] = Field(default=None, description="The job title of the person.")
    __properties: ClassVar[List[str]] = ["custom_mappings", "department", "employee_id", "employment_status", "end_date", "id", "is_primary", "location", "start_date", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": HrisJobLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
