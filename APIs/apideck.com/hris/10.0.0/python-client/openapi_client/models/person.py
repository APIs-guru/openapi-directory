...
class Person(BaseModel):
    ...
    Person
    """ # noqa: E501
    birthday: Optional[date] = Field(default=None, description="Date of birth")
    ...
    deceased_on: Optional[date] = Field(default=None, description="Date of death")
    ...
    initials: Optional[StrictStr] = Field(default=None, description="Initials of the person")
    ...
    __properties: ClassVar[List[str]] = ["birthday", "custom_mappings", "deceased_on", "first_name", "gender", "id", "initials", "last_name", "middle_name"]
