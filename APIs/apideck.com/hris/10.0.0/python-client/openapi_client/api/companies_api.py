...
class CompaniesApi:
    ...
    def companies_add(
        ...
        :param hris_company: (required)
        :type hris_company: HrisCompany
    ...
    def companies_add_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateHrisCompanyResponse]:
        """Create Company
    ...
    def _companies_add_serialize(
        ...
        if hris_company is not None:
            _body_params = hris_company
    ...
    def companies_all_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetHrisCompaniesResponse]:
        """List Companies
    ...
    def companies_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteHrisCompanyResponse]:
        """Delete Company
    ...
    def _companies_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/hris/companies/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def companies_one_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetHrisCompanyResponse]:
        """Get Company
    ...
    def companies_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateHrisCompanyResponse]:
        """Update Company
