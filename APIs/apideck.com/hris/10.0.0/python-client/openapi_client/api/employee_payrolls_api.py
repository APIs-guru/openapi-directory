...
class EmployeePayrollsApi:
    ...
    def employee_payrolls_all(
        self,
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        ...
        :param employee_id: ID of the employee you are acting upon. (required)
        ...
        _param = self._employee_payrolls_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEmployeePayrollsResponse",
    ...
    @validate_call
    def employee_payrolls_all_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEmployeePayrollsResponse]:
        """List Employee Payrolls
    ...
    @validate_call
    def employee_payrolls_all_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _employee_payrolls_all_serialize(
        self,
        employee_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/hris/payrolls/employees/{employee_id}',
    ...
    def employee_payrolls_one(
        ...
        _param = self._employee_payrolls_one_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEmployeePayrollResponse",
            '400': "BadRequestResponse",
            '401': "UnauthorizedResponse",
            '402': "PaymentRequiredResponse",
            '404': "NotFoundResponse",
    ...
    @validate_call
    def employee_payrolls_one_with_http_info(
        self,
        payroll_id: Annotated[StrictStr, Field(description="ID of the payroll you are acting upon.")],
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEmployeePayrollResponse]:
        """Get Employee Payroll
    ...
    @validate_call
    def employee_payrolls_one_without_preload_content(
        self,
        payroll_id: Annotated[StrictStr, Field(description="ID of the payroll you are acting upon.")],
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
    ...
    def _employee_payrolls_one_serialize(
        self,
        payroll_id,
        employee_id,
        x_apideck_consumer_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/hris/payrolls/employees/{employee_id}/payrolls/{payroll_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
