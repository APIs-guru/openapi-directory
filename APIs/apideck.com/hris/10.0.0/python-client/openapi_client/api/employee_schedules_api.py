...
class EmployeeSchedulesApi:
    ...
    def employee_schedules_all(
        ...
        _param = self._employee_schedules_all_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEmployeeSchedulesResponse",
    ...
    @validate_call
    def employee_schedules_all_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEmployeeSchedulesResponse]:
        """List Employee Schedules
    ...
    @validate_call
    def employee_schedules_all_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="ID of the employee you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _employee_schedules_all_serialize(
        self,
        employee_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/hris/schedules/employees/{employee_id}',
