...
class PayrollsApi:
    ...
    def payrolls_all(
        ...
        filter: Annotated[Optional[PayrollsFilter], Field(description="Apply filters")] = None,
        ...
        _param = self._payrolls_all_serialize(
    ...
    @validate_call
    def payrolls_all_with_http_info(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPayrollsResponse]:
        """List Payroll
    ...
    @validate_call
    def payrolls_all_without_preload_content(
        self,
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
    ...
    def payrolls_one(
        self,
        payroll_id: Annotated[StrictStr, Field(description="ID of the payroll you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        raw: Annotated[Optional[StrictBool], Field(description="Include raw response. Mostly used for debugging purposes")] = None,
        x_apideck_service_id: Annotated[Optional[StrictStr], Field(description="Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.")] = None,
        ...
        :param payroll_id: ID of the payroll you are acting upon. (required)
        :type payroll_id: str
        :param x_apideck_consumer_id: ID of the consumer which you want to get or push data from (required)
        :type x_apideck_consumer_id: str
        :param x_apideck_app_id: The ID of your Unify application (required)
        ...
        _param = self._payrolls_one_serialize(
    ...
    @validate_call
    def payrolls_one_with_http_info(
        self,
        payroll_id: Annotated[StrictStr, Field(description="ID of the payroll you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPayrollResponse]:
        """Get Payroll
    ...
    @validate_call
    def payrolls_one_without_preload_content(
        self,
        payroll_id: Annotated[StrictStr, Field(description="ID of the payroll you are acting upon.")],
        x_apideck_consumer_id: Annotated[StrictStr, Field(description="ID of the consumer which you want to get or push data from")],
        x_apideck_app_id: Annotated[StrictStr, Field(description="The ID of your Unify application")],
    ...
    def _payrolls_one_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/hris/payrolls/{payroll_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
