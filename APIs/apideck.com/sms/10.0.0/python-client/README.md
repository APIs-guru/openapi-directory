...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    message = openapi_client.Message() # Message | 
    ...
    try:
        # Create Message
        api_response = api_instance.messages_add(x_apideck_consumer_id, x_apideck_app_id, message, raw=raw, x_apideck_service_id=x_apideck_service_id)
        print("The response of MessagesApi->messages_add:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling MessagesApi->messages_add: %s\n" % e)
...
------------ | ------------- | ------------- | -------------
*MessagesApi* | [**messages_add**](docs/MessagesApi.md#messages_add) | **POST** /sms/messages | Create Message
*MessagesApi* | [**messages_all**](docs/MessagesApi.md#messages_all) | **GET** /sms/messages | List Messages
*MessagesApi* | [**messages_delete**](docs/MessagesApi.md#messages_delete) | **DELETE** /sms/messages/{id} | Delete Message
*MessagesApi* | [**messages_one**](docs/MessagesApi.md#messages_one) | **GET** /sms/messages/{id} | Get Message
*MessagesApi* | [**messages_update**](docs/MessagesApi.md#messages_update) | **PATCH** /sms/messages/{id} | Update Message
