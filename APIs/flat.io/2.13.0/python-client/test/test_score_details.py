    ...
    def make_instance(self, include_optional) -> ScoreDetails:
        ...
        if include_optional:
            return ScoreDetails(
                ...
                comments = {"monthly":30,"total":42,"unique":35,"weekly":10},
                composer = '',
                ...
                license = 'copyright',
                license_text = '',
                likes = {"monthly":30,"total":42,"weekly":10},
                lyricist = '',
                ...
                organization = '',
                parent_score = '',
                plays = {"monthly":30,"total":42,"weekly":10},
                publication_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                rights = {"aclAdmin":true,"aclRead":true,"aclWrite":true,"isCollaborator":true},
                samples = [
                    ''
                    ],
                subtitle = '',
                ...
                views = {"monthly":30,"total":42,"weekly":10}
            )
        else:
            return ScoreDetails(
        )
