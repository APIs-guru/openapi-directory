...
class TestAssignmentSubmissionUpdateComments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AssignmentSubmissionUpdateComments:
        """Test AssignmentSubmissionUpdateComments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignmentSubmissionUpdateComments`
        """
        model = AssignmentSubmissionUpdateComments()
        if include_optional:
