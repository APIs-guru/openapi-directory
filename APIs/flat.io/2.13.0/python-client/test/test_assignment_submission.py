    ...
    def make_instance(self, include_optional) -> AssignmentSubmission:
        ...
        if include_optional:
            return AssignmentSubmission(
                ...
                creator = '',
                draft_grade = 1.337,
                google_classroom = {"alternateLink":"http://classroom.google.com/c/music-theory/a/first-assignment/submissions/student/my-submission","id":"CgsI-00000000000","state":"turned_in"},
                grade = 1.337,
                id = '',
                max_points = 1.337,
                microsoft_graph = {"alternateLink":"https://teams.microsoft.com/l/entity","id":"8e460d32-d2d4-46b3-8e1a-9b7677a48fda","state":"returned"},
                return_creator = '',
                return_date = '',
                state = 'created',
                submission_date = ''
