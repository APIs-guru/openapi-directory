...
class ScoreFork(BaseModel):
    ...
    """ # noqa: E501
    collection: Optional[StrictStr] = Field(default='root', description="Unique identifier of a collection where the score will be copied. If no collection identifier is provided, the score will be stored in the `root` directory. ")
