...
class OrganizationInvitation(BaseModel):
    ...
    """ # noqa: E501
    custom_code: Optional[StrictStr] = Field(default=None, description="Enrollment code to use when joining this organization", alias="customCode")
    ...
    used_by: Optional[StrictStr] = Field(default=None, description="The unique identifier of the User who used this invitation", alias="usedBy")
    __properties: ClassVar[List[str]] = ["customCode", "email", "id", "invitedBy", "organization", "organizationRole", "usedBy"]
