...
class ClassAttachmentCreation(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of the attachment posted")
    ...
    __properties: ClassVar[List[str]] = ["googleDriveFileId", "lockScoreTemplate", "score", "sharingMode", "type", "url", "worksheet"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['flat', 'link', 'googleDrive', 'worksheet']):
            raise ValueError("must be one of enum values ('flat', 'link', 'googleDrive', 'worksheet')")
        return value
