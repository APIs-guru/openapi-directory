...
class AssignmentCopy(BaseModel):
    ...
    classroom: Optional[StrictStr] = Field(default=None, description="The destination classroom where the assignment will be copied")
    ...
    __properties: ClassVar[List[str]] = ["assignment", "classroom", "scheduledDate"]
