...
class FlatErrorResponse(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="A corresponding code for this error")
    id: Optional[StrictStr] = Field(default=None, description="An unique error identifier generated for the request")
    message: Optional[StrictStr] = Field(default=None, description="A printable message for this message")
    param: Optional[StrictStr] = Field(default=None, description="The related parameter that caused the error")
    __properties: ClassVar[List[str]] = ["code", "id", "message", "param"]
