...
class DefaultApi:
    ...
    def resources_get(
        self,
        description: Annotated[StrictStr, Field(description="The string you are looking for in the word meaning, for example, chariot. Wildcards are allowed, for example, char\\*.")],
