...
class TestPointPointDailyAllDayData(unittest.TestCase):
    """PointPointDailyAllDayData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointPointDailyAllDayData:
        """Test PointPointDailyAllDayData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointPointDailyAllDayData`
        """
        model = PointPointDailyAllDayData()
        if include_optional:
    ...
    def testPointPointDailyAllDayData(self):
        """Test PointPointDailyAllDayData"""
