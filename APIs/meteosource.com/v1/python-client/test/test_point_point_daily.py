...
class TestPointPointDaily(unittest.TestCase):
    """PointPointDaily unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointPointDaily:
        """Test PointPointDaily
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointPointDaily`
        """
        model = PointPointDaily()
        if include_optional:
