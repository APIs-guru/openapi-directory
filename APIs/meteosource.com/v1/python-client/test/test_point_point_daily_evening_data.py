...
class TestPointPointDailyEveningData(unittest.TestCase):
    """PointPointDailyEveningData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointPointDailyEveningData:
        """Test PointPointDailyEveningData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointPointDailyEveningData`
        """
        model = PointPointDailyEveningData()
        if include_optional:
    ...
    def testPointPointDailyEveningData(self):
        """Test PointPointDailyEveningData"""
