...
class PointPointMinutelyPrecipitationData(BaseModel):
    ...
    precipitation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minutely precipitation amount (per hour). For the startup tier, showing one value per 10 minutes. For other tiers, showing one value per each minute.  Unit: mm/h")
    __properties: ClassVar[List[str]] = ["date", "precipitation"]
