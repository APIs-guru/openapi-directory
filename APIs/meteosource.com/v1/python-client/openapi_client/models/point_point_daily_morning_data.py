...
class PointPointDailyMorningData(BaseModel):
    ...
    temperature: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Temperature 2 metres above ground. (morning avg) Units: metric = °C, us = °F, uk = °C, ca = °C")
    visibility: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Visibility. (morning avg) Units: metric = km, us = mi, uk = mi, ca = km")
    weather: Optional[StrictStr] = Field(default=None, description="Morning day string identifier of the weather icon, e.g. `light_rain`.")
    wind: PointPointDailyMorningWindData
    wind_chill: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Temperature 2 metres above ground. (morning avg) Units: metric = °C, us = °F, uk = °C, ca = °C")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloud_cover": PointPointDailyMorningCloudCoverData.from_dict(obj["cloud_cover"]) if obj.get("cloud_cover") is not None else None,
            "dew_point": obj.get("dew_point"),
            "feels_like": obj.get("feels_like"),
            "humidity": obj.get("humidity"),
            "icon": obj.get("icon"),
            "ozone": obj.get("ozone"),
            "precipitation": PointPointDailyMorningPrecipitationData.from_dict(obj["precipitation"]) if obj.get("precipitation") is not None else None,
            "pressure": obj.get("pressure"),
            "probability": PointPointDailyMorningProbData.from_dict(obj["probability"]) if obj.get("probability") is not None else None,
            ...
            "wind": PointPointDailyMorningWindData.from_dict(obj["wind"]) if obj.get("wind") is not None else None,
