...
class PointPointDailyAstroData(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PointPointDailyAstroData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PointPointDailyAstroData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "moon": PointPointDailyMoonData.from_dict(obj["moon"]) if obj.get("moon") is not None else None,
            "sun": PointPointDailySunData.from_dict(obj["sun"]) if obj.get("sun") is not None else None
        })
        return _obj
