...
class TimeMachineTimeMachineHourlyData(BaseModel):
    ...
    """ # noqa: E501
    cape: Optional[StrictInt] = Field(default=None, description="Convective available potential energy. Unit: J/kg")
    ...
    evaporation: Optional[StrictInt] = Field(default=None, description="Evaporation of liquid water into water vapor. Unit: mm/h")
    ...
    irradiance: Optional[StrictInt] = Field(default=None, description="Global downward short-wave radiation flux. Unit: W/m2")
    ozone: Optional[StrictInt] = Field(default=None, description="Total column of ozone. Unit: Dobson")
    ...
    __properties: ClassVar[List[str]] = ["cape", "cloud_cover", "date", "dew_point", "evaporation", "feels_like", "humidity", "icon", "irradiance", "ozone", "precipitation", "pressure", "soil_temperature", "surface_temperature", "temperature", "weather", "wind", "wind_chill"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cape": obj.get("cape"),
            "cloud_cover": TimeMachineTimeMachineCloudCoverData.from_dict(obj["cloud_cover"]) if obj.get("cloud_cover") is not None else None,
            "date": obj.get("date"),
            ...
            "ozone": obj.get("ozone"),
            "precipitation": TimeMachineTimeMachinePrecipitationData.from_dict(obj["precipitation"]) if obj.get("precipitation") is not None else None,
            ...
            "wind": TimeMachineTimeMachineWindData.from_dict(obj["wind"]) if obj.get("wind") is not None else None,
