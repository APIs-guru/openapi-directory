...
class PointPointDailyAfternoonData(BaseModel):
    ...
    temperature: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Temperature 2 metres above ground. (afternoon avg) Units: metric = °C, us = °F, uk = °C, ca = °C")
    visibility: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Visibility. (afternoon avg) Units: metric = km, us = mi, uk = mi, ca = km")
    weather: Optional[StrictStr] = Field(default=None, description="Afternoon day string identifier of the weather icon, e.g. `light_rain`.")
    wind: PointPointDailyAfternoonWindData
    wind_chill: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Temperature 2 metres above ground. (afternoon avg) Units: metric = °C, us = °F, uk = °C, ca = °C")
    __properties: ClassVar[List[str]] = ["cloud_cover", "dew_point", "feels_like", "humidity", "icon", "ozone", "precipitation", "pressure", "probability", "snow_depth", "soil_temperature", "surface_temperature", "temperature", "visibility", "weather", "wind", "wind_chill"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cloud_cover": PointPointDailyAfternoonCloudCoverData.from_dict(obj["cloud_cover"]) if obj.get("cloud_cover") is not None else None,
            "dew_point": obj.get("dew_point"),
            "feels_like": obj.get("feels_like"),
            "humidity": obj.get("humidity"),
            "icon": obj.get("icon"),
            "ozone": obj.get("ozone"),
            "precipitation": PointPointDailyAfternoonPrecipitationData.from_dict(obj["precipitation"]) if obj.get("precipitation") is not None else None,
            "pressure": obj.get("pressure"),
            "probability": PointPointDailyAfternoonProbData.from_dict(obj["probability"]) if obj.get("probability") is not None else None,
            ...
            "wind": PointPointDailyAfternoonWindData.from_dict(obj["wind"]) if obj.get("wind") is not None else None,
