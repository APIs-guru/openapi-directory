...
class PointPointDailyStatsData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "precipitation": PointPointDailyStatsPrecipitationData.from_dict(obj["precipitation"]) if obj.get("precipitation") is not None else None,
            "temperature": PointPointDailyStatsTemperatureData.from_dict(obj["temperature"]) if obj.get("temperature") is not None else None,
            "wind": PointPointDailyStatsWindData.from_dict(obj["wind"]) if obj.get("wind") is not None else None
        })
        return _obj
