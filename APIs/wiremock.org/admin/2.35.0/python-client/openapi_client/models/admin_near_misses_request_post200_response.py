...
class AdminNearMissesRequestPost200Response(BaseModel):
    """
    AdminNearMissesRequestPost200Response
    """ # noqa: E501
    near_misses: Optional[List[AdminNearMissesRequestPostRequest]] = Field(default=None, alias="nearMisses")
    __properties: ClassVar[List[str]] = ["nearMisses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nearMisses": [AdminNearMissesRequestPostRequest.from_dict(_item) for _item in obj["nearMisses"]] if obj.get("nearMisses") is not None else None
        })
        return _obj
