...
class AdminSettingsPostRequest(BaseModel):
    """
    ...
    fixed_delay: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="fixedDelay")
    __properties: ClassVar[List[str]] = ["median", "sigma", "type", "lower", "upper", "fixedDelay"]
