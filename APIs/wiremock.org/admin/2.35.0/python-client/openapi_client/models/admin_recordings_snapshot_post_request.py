...
class AdminRecordingsSnapshotPostRequest(BaseModel):
    """
    ...
    filters: Optional[AdminRecordingsSnapshotPostRequestAllOfFilters] = None
    __properties: ClassVar[List[str]] = ["captureHeaders", "extractBodyCriteria", "persist", "repeatsAsScenarios", "requestBodyPattern", "transformerParameters", "transformers", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": AdminRecordingsSnapshotPostRequestAllOfFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
