...
class ClusterConfiguration(BaseModel):
    ...
    response_type: Optional[StrictStr] = Field(default='json', description="Specifies the response format. You can either choose `geojson` or `json`.")
    routing: Optional[ClusterConfigurationRouting] = None
    __properties: ClassVar[List[str]] = ["clustering", "response_type", "routing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clustering": ClusterConfigurationClustering.from_dict(obj["clustering"]) if obj.get("clustering") is not None else None,
            "response_type": obj.get("response_type") if obj.get("response_type") is not None else 'json',
            "routing": ClusterConfigurationRouting.from_dict(obj["routing"]) if obj.get("routing") is not None else None
        })
        return _obj
