...
class SymmetricalMatrixRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["curbsides", "fail_fast", "out_arrays", "point_hints", "points", "snap_preventions", "turn_costs", "vehicle"]
