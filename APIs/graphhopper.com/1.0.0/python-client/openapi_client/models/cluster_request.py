...
class ClusterRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["configuration", "customers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": ClusterConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "customers": [ClusterCustomer.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
