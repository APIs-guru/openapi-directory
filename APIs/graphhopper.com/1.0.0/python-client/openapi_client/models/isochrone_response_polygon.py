...
class IsochroneResponsePolygon(BaseModel):
    ...
    properties: Optional[IsochroneResponsePolygonProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geometry": Polygon.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "properties": IsochroneResponsePolygonProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
