...
class GeocodingResponse(BaseModel):
    ...
    took: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="in ms")
    __properties: ClassVar[List[str]] = ["hits", "took"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [GeocodingLocation.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
            "took": obj.get("took")
        })
        return _obj
