...
class MapMatchingAPIApi:
    ...
    def post_gpx(
        self,
        gps_accuracy: Annotated[Optional[StrictInt], Field(description="Specify the precision of a point, in meter")] = None,
        vehicle: Annotated[Optional[StrictStr], Field(description="Specify the vehicle profile like car")] = None,
        ...
        _param = self._post_gpx_serialize(
    ...
    @validate_call
    def post_gpx_without_preload_content(
        self,
        gps_accuracy: Annotated[Optional[StrictInt], Field(description="Specify the precision of a point, in meter")] = None,
        vehicle: Annotated[Optional[StrictStr], Field(description="Specify the vehicle profile like car")] = None,
        _request_timeout: Union[
    ...
    def _post_gpx_serialize(
        ...
        if gps_accuracy is not None:
            ...
            _query_params.append(('gps_accuracy', gps_accuracy))
