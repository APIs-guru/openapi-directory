...
class ClusterAPIApi:
    ...
    def async_clustering_problem(
        self,
        cluster_request: Annotated[ClusterRequest, Field(description="Request object that contains the problem to be solved")],
        ...
        :param cluster_request: Request object that contains the problem to be solved (required)
        ...
        _param = self._async_clustering_problem_serialize(
    ...
    @validate_call
    def async_clustering_problem_with_http_info(
        self,
        cluster_request: Annotated[ClusterRequest, Field(description="Request object that contains the problem to be solved")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def async_clustering_problem_without_preload_content(
        self,
        cluster_request: Annotated[ClusterRequest, Field(description="Request object that contains the problem to be solved")],
        _request_timeout: Union[
            None,
    ...
    def _async_clustering_problem_serialize(
        self,
        cluster_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/cluster/calculate',
    ...
    def get_cluster_solution(
        ...
        _param = self._get_cluster_solution_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ClusterResponse",
            '400': "BadRequest",
            '404': "GetClusterSolution404Response",
            '500': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_cluster_solution_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Request solution with jobId")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_cluster_solution_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Request solution with jobId")],
        _request_timeout: Union[
            None,
    ...
    def _get_cluster_solution_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cluster/solution/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def solve_clustering_problem(
        ...
        _param = self._solve_clustering_problem_serialize(
            cluster_request=cluster_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def solve_clustering_problem_with_http_info(
        self,
        cluster_request: Annotated[ClusterRequest, Field(description="Request object that contains the problem to be solved")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def solve_clustering_problem_without_preload_content(
        self,
        cluster_request: Annotated[ClusterRequest, Field(description="Request object that contains the problem to be solved")],
        _request_timeout: Union[
            None,
    ...
    def _solve_clustering_problem_serialize(
        self,
        cluster_request,
        _request_auth,
        _content_type,
