...
class MatrixAPIApi:
    ...
    def calculate_matrix(
        self,
        post_matrix_request: Optional[PostMatrixRequest] = None,
        ...
        :param post_matrix_request:
        :type post_matrix_request: PostMatrixRequest
        ...
        _param = self._calculate_matrix_serialize(
            post_matrix_request=post_matrix_request,
    ...
    @validate_call
    def calculate_matrix_with_http_info(
        self,
        post_matrix_request: Optional[PostMatrixRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def calculate_matrix_without_preload_content(
        self,
        post_matrix_request: Optional[PostMatrixRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _calculate_matrix_serialize(
        self,
        post_matrix_request,
        _request_auth,
        _content_type,
        ...
        if post_matrix_request is not None:
            _body_params = post_matrix_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/matrix/calculate',
    ...
    def get_matrix(
        self,
        point: Annotated[Optional[List[StrictStr]], Field(description="Specify multiple points in `latitude,longitude` for which the weight-, route-, time- or distance-matrix should be calculated. In this case the starts are identical to the destinations. If there are N points, then NxN entries will be calculated. The order of the point parameter is important. Specify at least three points. Cannot be used together with from_point or to_point.")] = None,
        from_point: Annotated[Optional[List[StrictStr]], Field(description="The starting points for the routes in `latitude,longitude`. E.g. if you want to calculate the three routes A-&gt;1, A-&gt;2, A-&gt;3 then you have one from_point parameter and three to_point parameters.")] = None,
        to_point: Annotated[Optional[List[StrictStr]], Field(description="The destination points for the routes in `latitude,longitude`.")] = None,
        point_hint: Annotated[Optional[List[StrictStr]], Field(description="Optional parameter. Specifies a hint for each `point` parameter to prefer a certain street for the closest location lookup. E.g. if there is an address or house with two or more neighboring streets you can control for which street the closest location is looked up.")] = None,
        from_point_hint: Annotated[Optional[List[StrictStr]], Field(description="For the from_point parameter. See point_hint")] = None,
        to_point_hint: Annotated[Optional[List[StrictStr]], Field(description="For the to_point parameter. See point_hint")] = None,
        ...
        from_curbside: Annotated[Optional[List[StrictStr]], Field(description="Curbside setting for the from_point parameter. See curbside.")] = None,
        to_curbside: Annotated[Optional[List[StrictStr]], Field(description="Curbside setting for the to_point parameter. See curbside.")] = None,
        out_array: Annotated[Optional[List[StrictStr]], Field(description="Specifies which arrays should be included in the response. Specify one or more of the following options 'weights', 'times', 'distances'. To specify more than one array use e.g. out_array=times&out_array=distances. The units of the entries of distances are meters, of times are seconds and of weights is arbitrary and it can differ for different vehicles or versions of this API.")] = None,
        vehicle: Annotated[Optional[VehicleProfileId], Field(description="The vehicle profile for which the matrix should be calculated.")] = None,
        fail_fast: Annotated[Optional[StrictBool], Field(description="Specifies whether or not the matrix calculation should return with an error as soon as possible in case some points cannot be found or some points are not connected. If set to `false` the time/weight/distance matrix will be calculated for all valid points and contain the `null` value for all entries that could not be calculated. The `hint` field of the response will also contain additional information about what went wrong (see its documentation).")] = None,
        turn_costs: Annotated[Optional[StrictBool], Field(description="Specifies if turn restrictions should be considered. Enabling this option increases the matrix computation time. Only supported for motor vehicles and OpenStreetMap.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_matrix_serialize(
            point=point,
    ...
    @validate_call
    def get_matrix_without_preload_content(
        self,
        point: Annotated[Optional[List[StrictStr]], Field(description="Specify multiple points in `latitude,longitude` for which the weight-, route-, time- or distance-matrix should be calculated. In this case the starts are identical to the destinations. If there are N points, then NxN entries will be calculated. The order of the point parameter is important. Specify at least three points. Cannot be used together with from_point or to_point.")] = None,
        from_point: Annotated[Optional[List[StrictStr]], Field(description="The starting points for the routes in `latitude,longitude`. E.g. if you want to calculate the three routes A-&gt;1, A-&gt;2, A-&gt;3 then you have one from_point parameter and three to_point parameters.")] = None,
        to_point: Annotated[Optional[List[StrictStr]], Field(description="The destination points for the routes in `latitude,longitude`.")] = None,
    ...
    def _get_matrix_serialize(
        ...
        if from_point is not None:
            ...
            _query_params.append(('from_point', from_point))
            
        if to_point is not None:
            
            _query_params.append(('to_point', to_point))
            
        if point_hint is not None:
            
            _query_params.append(('point_hint', point_hint))
            
        if from_point_hint is not None:
            
            _query_params.append(('from_point_hint', from_point_hint))
            
        if to_point_hint is not None:
            
            _query_params.append(('to_point_hint', to_point_hint))
        ...
        if from_curbside is not None:
            
            _query_params.append(('from_curbside', from_curbside))
            
        if to_curbside is not None:
            
            _query_params.append(('to_curbside', to_curbside))
            
        if out_array is not None:
            
            _query_params.append(('out_array', out_array))
        ...
        if fail_fast is not None:
            ...
            _query_params.append(('fail_fast', fail_fast))
    ...
    def get_matrix_solution(
        self,
        job_id: Annotated[StrictStr, Field(description="Request solution with jobId")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param job_id: Request solution with jobId (required)
        :type job_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_matrix_solution_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_matrix_solution_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Request solution with jobId")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_matrix_solution_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Request solution with jobId")],
        _request_timeout: Union[
            None,
    ...
    def _get_matrix_solution_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/matrix/solution/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_matrix(
        ...
        _param = self._post_matrix_serialize(
            post_matrix_request=post_matrix_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_matrix_with_http_info(
        self,
        post_matrix_request: Optional[PostMatrixRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_matrix_without_preload_content(
        self,
        post_matrix_request: Optional[PostMatrixRequest] = None,
        _request_timeout: Union[
            None,
