...
class RouteOptimizationAPIApi:
    ...
    def async_vrp(
        self,
        request: Annotated[Request, Field(description="The request that contains the problem to be solved.")],
        ...
        _param = self._async_vrp_serialize(
            request=request,
    ...
    @validate_call
    def async_vrp_without_preload_content(
        self,
        request: Annotated[Request, Field(description="The request that contains the problem to be solved.")],
        _request_timeout: Union[
            None,
    ...
    def _get_solution_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/vrp/solution/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def solve_vrp(
        self,
        request: Annotated[Request, Field(description="The request that contains the vehicle routing problem to be solved.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._solve_vrp_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def solve_vrp_without_preload_content(
        self,
        request: Annotated[Request, Field(description="The request that contains the vehicle routing problem to be solved.")],
        _request_timeout: Union[
            None,
