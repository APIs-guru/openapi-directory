...
class TestMatrixAPIApi(unittest.TestCase):
    """MatrixAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MatrixAPIApi()

    def tearDown(self) -> None:
        pass

    def test_calculate_matrix(self) -> None:
    ...
    def test_get_matrix_solution(self) -> None:
    ...
    def test_post_matrix(self) -> None:
