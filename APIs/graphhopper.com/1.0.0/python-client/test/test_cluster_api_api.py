...
class TestClusterAPIApi(unittest.TestCase):
    """ClusterAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ClusterAPIApi()

    def tearDown(self) -> None:
        pass

    def test_async_clustering_problem(self) -> None:
    ...
    def test_get_cluster_solution(self) -> None:
    ...
    def test_solve_clustering_problem(self) -> None:
