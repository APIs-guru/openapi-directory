...
class TestRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Request:
        ...
        if include_optional:
            return Request(
                algorithm = openapi_client.models.algorithm.Algorithm(
                    objective = 'transport_time', 
                    problem_type = 'min', ),
                configuration = openapi_client.models.configuration.Configuration(
                    routing = openapi_client.models.routing.Routing(
                        calc_points = True, 
                ...
                shipments = [
                    openapi_client.models.shipment.Shipment(
                        allowed_vehicles = ["technician_peter","technician_stefan"], 
                        delivery = openapi_client.models.stop.Stop(
                            address = openapi_client.models.address.Address(
                                curbside = 'any', 
                                lat = 51.512665, 
                                location_id = '550e8400-e29b-11d4-a716-446655440000', 
                        ...
                        pickup = openapi_client.models.stop.Stop(
                            duration = 1800, 
                            group = 'ASAP', 
                            preparation_time = 300, 
                            time_windows = [{"earliest":32400,"latest":36000},{"earliest":50400,"latest":54000}], ), 
                ...
                vehicle_types = [
                    openapi_client.models.vehicle_type.VehicleType(
                        capacity = [100,500], 
                        consider_traffic = True, 
                        cost_per_activation = 1.337, 
                        cost_per_meter = 1.337, 
                        cost_per_second = 1.337, 
                        network_data_provider = 'openstreetmap', 
                        profile = null, 
                        service_time_factor = 1.337, 
                        speed_factor = 1.337, 
                        type_id = 'my-own-type', )
                    ],
                vehicles = [
                    openapi_client.models.vehicle.Vehicle(
                        break = null, 
                        earliest_start = 56, 
                        end_address = openapi_client.models.address.Address(
                            curbside = 'any', 
                            lat = 51.512665, 
                            location_id = '550e8400-e29b-11d4-a716-446655440000', 
                            lon = -0.092869, 
                        ...
                        start_address = openapi_client.models.address.Address(
                            curbside = 'any', 
                            lat = 51.512665, 
                            location_id = '550e8400-e29b-11d4-a716-446655440000', 
                            lon = -0.092869, 
