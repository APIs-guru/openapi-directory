...
class TestRouteOptimizationAPIApi(unittest.TestCase):
    """RouteOptimizationAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RouteOptimizationAPIApi()

    def tearDown(self) -> None:
        pass

    def test_async_vrp(self) -> None:
