...
class IssuingCountry(BaseModel):
    """
    IssuingCountry
    """ # noqa: E501
    ean: StrictStr
    issuing_country: StrictStr = Field(alias="issuingCountry")
    __properties: ClassVar[List[str]] = ["ean", "issuingCountry"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssuingCountry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssuingCountry from a dict"""
        if obj is None:
            return None
