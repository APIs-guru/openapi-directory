...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkSelf(BaseModel):
    """
    PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkSelf
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI of the variation entity")
