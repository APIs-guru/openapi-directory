...
class MeasurementFamiliesGetList200ResponseUnitsUnitCodeLabels(BaseModel):
    """
    Unit labels for each locale. More details <a href='/concepts/target-market-settings.html#focus-on-the-units'>here</a>.
    """ # noqa: E501
    locale_code: Optional[StrictStr] = Field(default=None, description="Unit label for the locale `localeCode`", alias="localeCode")
