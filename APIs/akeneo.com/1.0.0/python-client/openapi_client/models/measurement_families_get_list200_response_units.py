...
class MeasurementFamiliesGetList200ResponseUnits(BaseModel):
    ...
    """ # noqa: E501
    unit_code: Optional[MeasurementFamiliesGetList200ResponseUnitsUnitCode] = Field(default=None, alias="unitCode")
    __properties: ClassVar[List[str]] = ["unitCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitCode": MeasurementFamiliesGetList200ResponseUnitsUnitCode.from_dict(obj["unitCode"]) if obj.get("unitCode") is not None else None
        })
        return _obj
