...
class Locales(BaseModel):
    ...
    Locales
    """ # noqa: E501
    links: Optional[PAMAssetCategoriesAllOfLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": PAMAssetCategoriesAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
