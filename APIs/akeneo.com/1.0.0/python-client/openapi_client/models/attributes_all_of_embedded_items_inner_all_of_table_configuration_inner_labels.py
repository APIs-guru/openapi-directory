...
class AttributesAllOfEmbeddedItemsInnerAllOfTableConfigurationInnerLabels(BaseModel):
    """
    Column labels for each locale
    """ # noqa: E501
    locale_code: Optional[StrictStr] = Field(default=None, description="Column label for the locale `localeCode`", alias="localeCode")
