...
class PublishedProductsAllOfEmbeddedItemsInnerAllOfAssociations(BaseModel):
    """
    Several associations related to groups and/or other published products, grouped by association types
    """ # noqa: E501
    association_type_code: Optional[PublishedProductsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode] = Field(default=None, alias="associationTypeCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associationTypeCode": PublishedProductsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode.from_dict(obj["associationTypeCode"]) if obj.get("associationTypeCode") is not None else None
        })
        return _obj
