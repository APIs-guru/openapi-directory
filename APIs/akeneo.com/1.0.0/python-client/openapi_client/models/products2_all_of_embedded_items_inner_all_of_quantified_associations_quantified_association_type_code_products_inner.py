...
class Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductsInner(BaseModel):
    """
    Products2AllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductsInner
    """ # noqa: E501
    quantity: Optional[StrictInt] = None
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["quantity", "uuid"]
