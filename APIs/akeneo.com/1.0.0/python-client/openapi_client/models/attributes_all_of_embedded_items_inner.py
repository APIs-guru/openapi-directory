...
class AttributesAllOfEmbeddedItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_links", "allowed_extensions", "available_locales", "code", "date_max", "date_min", "decimals_allowed", "default_metric_unit", "default_value", "group", "group_labels", "labels", "localizable", "max_characters", "max_file_size", "metric_family", "negative_allowed", "number_max", "number_min", "reference_data_name", "scopable", "sort_order", "table_configuration", "type", "unique", "useable_as_grid_filter", "validation_regexp", "validation_rule", "wysiwyg_enabled"]
