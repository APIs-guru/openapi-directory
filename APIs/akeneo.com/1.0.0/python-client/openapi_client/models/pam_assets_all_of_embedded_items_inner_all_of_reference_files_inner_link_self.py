...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkSelf(BaseModel):
    """
    PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkSelf
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI of the reference file entity")
