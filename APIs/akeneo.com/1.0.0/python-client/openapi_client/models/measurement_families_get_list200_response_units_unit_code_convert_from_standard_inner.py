...
class MeasurementFamiliesGetList200ResponseUnitsUnitCodeConvertFromStandardInner(BaseModel):
    ...
    """ # noqa: E501
    operator: Optional[StrictStr] = Field(default=None, description="Operator for a conversion operation to convert the unit in the standard unit")
    value: Optional[StrictStr] = Field(default=None, description="Value for a conversion operation to convert the unit in the standard unit")
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['mul', 'div', 'add', 'sub']):
            raise ValueError("must be one of enum values ('mul', 'div', 'add', 'sub')")
        return value
