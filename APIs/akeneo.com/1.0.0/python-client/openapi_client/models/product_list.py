...
class ProductList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "associations", "categories", "completenesses", "created", "enabled", "family", "groups", "identifier", "metadata", "parent", "quality_scores", "quantified_associations", "updated", "uuid", "values"]
