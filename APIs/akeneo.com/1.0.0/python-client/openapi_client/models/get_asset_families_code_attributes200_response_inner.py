...
class GetAssetFamiliesCodeAttributes200ResponseInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowed_extensions", "code", "decimals_allowed", "is_read_only", "is_required_for_completeness", "is_rich_text_editor", "is_textarea", "labels", "max_characters", "max_file_size", "max_value", "media_type", "min_value", "prefix", "suffix", "type", "validation_regexp", "validation_rule", "value_per_channel", "value_per_locale"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['text', 'media_link', 'number', 'media_file', 'single_option', 'multiple_options', 'reference_entity_single_link', 'reference_entity_multiple_links', 'boolean']):
            raise ValueError("must be one of enum values ('text', 'media_link', 'number', 'media_file', 'single_option', 'multiple_options', 'reference_entity_single_link', 'reference_entity_multiple_links', 'boolean')")
        return value
