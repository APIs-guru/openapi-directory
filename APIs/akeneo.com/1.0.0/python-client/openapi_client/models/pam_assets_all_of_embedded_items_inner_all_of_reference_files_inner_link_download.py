...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkDownload(BaseModel):
    """
    PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkDownload
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI to download the reference file")
