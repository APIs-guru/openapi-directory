...
class PostProductsUuidRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associations", "categories", "completenesses", "created", "enabled", "family", "groups", "metadata", "parent", "quality_scores", "quantified_associations", "updated", "uuid", "values"]
