...
class MeasurementFamilyList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "labels", "standard_unit_code", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "labels": MeasurementFamiliesGetList200ResponseLabels.from_dict(obj["labels"]) if obj.get("labels") is not None else None,
            "standard_unit_code": obj.get("standard_unit_code"),
            "units": MeasurementFamiliesGetList200ResponseUnits.from_dict(obj["units"]) if obj.get("units") is not None else None
        })
        return _obj
