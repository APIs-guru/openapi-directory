...
class ProductModelsAllOfEmbeddedItemsInnerAllOfAssociations(BaseModel):
    ...
    """ # noqa: E501
    association_type_code: Optional[ProductModelsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode] = Field(default=None, alias="associationTypeCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associationTypeCode": ProductModelsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode.from_dict(obj["associationTypeCode"]) if obj.get("associationTypeCode") is not None else None
        })
        return _obj
