...
class ReferenceEntitiesAllOfEmbeddedItemsInnerAllOfLinksImageDownload(BaseModel):
    """
    ReferenceEntitiesAllOfEmbeddedItemsInnerAllOfLinksImageDownload
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI to download the binaries of the reference entity image file")
