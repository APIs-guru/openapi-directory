...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkDownload(BaseModel):
    """
    PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkDownload
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI to download the variation file")
