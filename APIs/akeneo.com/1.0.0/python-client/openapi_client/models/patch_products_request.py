...
class PatchProductsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associations", "categories", "completenesses", "created", "enabled", "family", "groups", "identifier", "metadata", "parent", "quality_scores", "quantified_associations", "updated", "uuid", "values"]
