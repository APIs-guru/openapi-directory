...
class PatchProductModelsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associations", "categories", "code", "created", "family", "family_variant", "metadata", "parent", "quality_scores", "quantified_associations", "updated", "values"]
