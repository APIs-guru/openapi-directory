...
class Source(BaseModel):
    ...
    large_logo_url: Optional[StrictStr] = Field(default=None, alias="largeLogoUrl")
    name: Optional[StrictStr] = None
    small_logo_url: Optional[StrictStr] = Field(default=None, alias="smallLogoUrl")
    website_url: Optional[StrictStr] = Field(default=None, alias="websiteUrl")
    __properties: ClassVar[List[str]] = ["acronym", "contactEmail", "id", "largeLogoUrl", "name", "smallLogoUrl", "websiteUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "largeLogoUrl": obj.get("largeLogoUrl"),
            "name": obj.get("name"),
            "smallLogoUrl": obj.get("smallLogoUrl"),
