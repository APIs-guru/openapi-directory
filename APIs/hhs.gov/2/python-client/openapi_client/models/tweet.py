...
class Tweet(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tweetDate": obj.get("tweetDate"),
            "tweetId": obj.get("tweetId"),
            "videoVariantUrl": obj.get("videoVariantUrl")
        })
        return _obj
