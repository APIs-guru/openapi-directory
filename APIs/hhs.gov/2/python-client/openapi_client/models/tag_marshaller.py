...
class TagMarshaller(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "language": TagLanguageMarshaller.from_dict(obj["language"]) if obj.get("language") is not None else None,
            "name": obj.get("name"),
            "type": TagTypeMarshaller.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
