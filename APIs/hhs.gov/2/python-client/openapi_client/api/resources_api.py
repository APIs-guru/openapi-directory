...
class ResourcesApi:
    ...
    def resources_json_get(
        ...
        _param = self._resources_json_get_serialize(
            q=q,
    ...
    @validate_call
    def resources_json_get_with_http_info(
        self,
        q: Annotated[StrictStr, Field(description="The search query supplied by the user")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resources_json_get_without_preload_content(
        self,
        q: Annotated[StrictStr, Field(description="The search query supplied by the user")],
        _request_timeout: Union[
            None,
    ...
    def _resources_json_get_serialize(
        self,
        q,
        _request_auth,
        _content_type,
