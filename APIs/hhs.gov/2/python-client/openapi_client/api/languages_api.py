...
class LanguagesApi:
    ...
    @validate_call
    def resources_languages_id_json_get(
        self,
        id: Annotated[StrictInt, Field(description="The id of the language to look up")],
        ...
        _param = self._resources_languages_id_json_get_serialize(
            id=id,
    ...
    @validate_call
    def resources_languages_id_json_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the language to look up")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LanguageWrapped]]:
        """Get Language by ID
    ...
    @validate_call
    def resources_languages_id_json_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the language to look up")],
        _request_timeout: Union[
            None,
    ...
    def _resources_languages_id_json_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/languages/{id}.json',
    ...
    @validate_call
    def resources_languages_json_get(
        self,
        ...
        _param = self._resources_languages_json_get_serialize(
            max=max,
            offset=offset,
            sort=sort,
            _request_auth=_request_auth,
    ...
    @validate_call
    def resources_languages_json_get_with_http_info(
        self,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Return records starting at the offset index.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="The name of the property to which sorting will be applied")] = None,
    ...
    @validate_call
    def resources_languages_json_get_without_preload_content(
        self,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Return records starting at the offset index.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="The name of the property to which sorting will be applied")] = None,
    ...
    def _resources_languages_json_get_serialize(
        self,
        max,
        offset,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/languages.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
