...
class MediaTypesApi:
    ...
    @validate_call
    def resources_media_types_format_get(
        self,
        ...
        _param = self._resources_media_types_format_get_serialize(
            format=format,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[MediaTypeHolderWrapped]",
            '400': None,
            '500': None,
        }
    ...
    @validate_call
    def resources_media_types_format_get_with_http_info(
        self,
        format: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[MediaTypeHolderWrapped]]:
        """Get MediaTypes
    ...
    @validate_call
    def resources_media_types_format_get_without_preload_content(
        self,
        format: Annotated[StrictStr, Field(description="Automatically added")],
        _request_timeout: Union[
            None,
    ...
    def _resources_media_types_format_get_serialize(
        self,
        format,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/mediaTypes.{format}',
