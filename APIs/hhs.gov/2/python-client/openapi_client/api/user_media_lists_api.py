...
class UserMediaListsApi:
    ...
    @validate_call
    def resources_user_media_lists_id_json_get(
        self,
        ...
        _param = self._resources_user_media_lists_id_json_get_serialize(
            id=id,
    ...
    @validate_call
    def resources_user_media_lists_id_json_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        display_method: Annotated[Optional[StrictStr], Field(description="Method used to render an html request. Accepts one: [mv, list, feed]")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def resources_user_media_lists_id_json_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        display_method: Annotated[Optional[StrictStr], Field(description="Method used to render an html request. Accepts one: [mv, list, feed]")] = None,
        _request_timeout: Union[
    ...
    def _resources_user_media_lists_id_json_get_serialize(
        self,
        id,
        display_method,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/userMediaLists/{id}.json',
