...
class CampaignsApi:
    ...
    @validate_call
    def resources_campaigns_id_json_get(
        self,
        ...
        _param = self._resources_campaigns_id_json_get_serialize(
            id=id,
    ...
    @validate_call
    def resources_campaigns_id_json_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resources_campaigns_id_json_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        _request_timeout: Union[
            None,
    ...
    def _resources_campaigns_id_json_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/campaigns/{id}.json',
    ...
    @validate_call
    def resources_campaigns_id_media_json_get(
        self,
        id: Annotated[StrictInt, Field(description="The id of the campaign to find media items for")],
        ...
        _param = self._resources_campaigns_id_media_json_get_serialize(
            id=id,
            sort=sort,
            max=max,
            offset=offset,
    ...
    @validate_call
    def resources_campaigns_id_media_json_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the campaign to find media items for")],
        sort: Annotated[Optional[StrictStr], Field(description="The name of the property to which sorting will be applied")] = None,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
    ...
    @validate_call
    def resources_campaigns_id_media_json_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the campaign to find media items for")],
        sort: Annotated[Optional[StrictStr], Field(description="The name of the property to which sorting will be applied")] = None,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
    ...
    def _resources_campaigns_id_media_json_get_serialize(
        self,
        id,
        sort,
        max,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/campaigns/{id}/media.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def resources_campaigns_id_syndicate_format_get(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        ...
        _param = self._resources_campaigns_id_syndicate_format_get_serialize(
            id=id,
            format=format,
    ...
    @validate_call
    def resources_campaigns_id_syndicate_format_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        format: Annotated[StrictStr, Field(description="Automatically added")],
        display_method: Annotated[Optional[StrictStr], Field(description="Method used to render an html request. Accepts one: [mv, list, feed]")] = None,
    ...
    @validate_call
    def resources_campaigns_id_syndicate_format_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the record to look up")],
        format: Annotated[StrictStr, Field(description="Automatically added")],
        display_method: Annotated[Optional[StrictStr], Field(description="Method used to render an html request. Accepts one: [mv, list, feed]")] = None,
    ...
    def _resources_campaigns_id_syndicate_format_get_serialize(
        self,
        id,
        format,
        display_method,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/campaigns/{id}/syndicate.{format}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def resources_campaigns_json_get(
        self,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The offset of the records set to return for pagination")] = None,
        ...
        _param = self._resources_campaigns_json_get_serialize(
            max=max,
            offset=offset,
            sort=sort,
            _request_auth=_request_auth,
    ...
    @validate_call
    def resources_campaigns_json_get_with_http_info(
        self,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The offset of the records set to return for pagination")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="* Set of fields to sort the records by.")] = None,
    ...
    @validate_call
    def resources_campaigns_json_get_without_preload_content(
        self,
        max: Annotated[Optional[StrictInt], Field(description="The maximum number of records to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The offset of the records set to return for pagination")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="* Set of fields to sort the records by.")] = None,
    ...
    def _resources_campaigns_json_get_serialize(
        self,
        max,
        offset,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/campaigns.json',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
