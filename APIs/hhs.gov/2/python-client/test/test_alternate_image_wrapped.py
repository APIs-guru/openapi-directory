...
class TestAlternateImageWrapped(unittest.TestCase):
    """AlternateImageWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlternateImageWrapped:
        """Test AlternateImageWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlternateImageWrapped`
        """
        model = AlternateImageWrapped()
        if include_optional:
            return AlternateImageWrapped(
                callback = '',
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.alternate_image.AlternateImage(
                        height = 56, 
                        id = 56, 
                        name = '', 
                        url = '', 
    ...
    def testAlternateImageWrapped(self):
        """Test AlternateImageWrapped"""
