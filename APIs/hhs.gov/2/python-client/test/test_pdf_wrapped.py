...
class TestPDFWrapped(unittest.TestCase):
    """PDFWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PDFWrapped:
        """Test PDFWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PDFWrapped`
        """
        model = PDFWrapped()
        if include_optional:
            return PDFWrapped(
