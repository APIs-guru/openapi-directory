...
class TestInfographicWrapped(unittest.TestCase):
    """InfographicWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfographicWrapped:
        """Test InfographicWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfographicWrapped`
        """
        model = InfographicWrapped()
        if include_optional:
            return InfographicWrapped(
                callback = '',
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.infographic.Infographic(
                        campaigns = [
    ...
    def testInfographicWrapped(self):
        """Test InfographicWrapped"""
