...
class TestPaginationWrapped(unittest.TestCase):
    """PaginationWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationWrapped:
        """Test PaginationWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationWrapped`
        """
        model = PaginationWrapped()
        if include_optional:
            return PaginationWrapped(
                callback = '',
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.pagination.Pagination(
                        count = 56, 
                        current_url = '', 
                        max = 56, 
                        next_url = '', 
    ...
    def testPaginationWrapped(self):
        """Test PaginationWrapped"""
