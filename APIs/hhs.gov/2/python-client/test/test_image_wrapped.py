...
class TestImageWrapped(unittest.TestCase):
    """ImageWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageWrapped:
        """Test ImageWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageWrapped`
        """
        model = ImageWrapped()
        if include_optional:
            return ImageWrapped(
