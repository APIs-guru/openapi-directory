...
class TestMediaItemWrapped(unittest.TestCase):
    """MediaItemWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaItemWrapped:
        """Test MediaItemWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaItemWrapped`
        """
        model = MediaItemWrapped()
        if include_optional:
