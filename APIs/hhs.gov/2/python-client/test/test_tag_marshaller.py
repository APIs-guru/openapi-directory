...
class TestTagMarshaller(unittest.TestCase):
    """TagMarshaller unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagMarshaller:
        """Test TagMarshaller
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagMarshaller`
        """
        model = TagMarshaller()
        if include_optional:
            return TagMarshaller(
                id = 56,
                language = openapi_client.models.tag_language_marshaller.TagLanguageMarshaller(
                    id = 56, 
                    is_active = True, 
                    iso_code = '', 
                    name = '', ),
                name = '',
                type = openapi_client.models.tag_type_marshaller.TagTypeMarshaller(
                    id = 56, 
                    name = '', )
            )
        else:
