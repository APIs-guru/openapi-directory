...
class TestVideoWrapped(unittest.TestCase):
    """VideoWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoWrapped:
        """Test VideoWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoWrapped`
        """
        model = VideoWrapped()
        if include_optional:
            return VideoWrapped(
