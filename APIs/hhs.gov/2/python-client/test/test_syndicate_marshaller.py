...
class TestSyndicateMarshaller(unittest.TestCase):
    """SyndicateMarshaller unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyndicateMarshaller:
        """Test SyndicateMarshaller
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyndicateMarshaller`
        """
        model = SyndicateMarshaller()
        if include_optional:
    ...
    def testSyndicateMarshaller(self):
        """Test SyndicateMarshaller"""
