...
class TestTweetWrapped(unittest.TestCase):
    """TweetWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TweetWrapped:
        """Test TweetWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TweetWrapped`
        """
        model = TweetWrapped()
        if include_optional:
            return TweetWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.tweet.Tweet(
                        account = null, 
                        campaigns = [
                        ...
                        source_url = '', 
                        target_url = '', 
                        tweet_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        tweet_id = 56, 
                        video_variant_url = '', )
                    ]
            )
