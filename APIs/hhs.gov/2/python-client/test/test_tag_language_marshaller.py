...
class TestTagLanguageMarshaller(unittest.TestCase):
    """TagLanguageMarshaller unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagLanguageMarshaller:
        """Test TagLanguageMarshaller
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagLanguageMarshaller`
        """
        model = TagLanguageMarshaller()
        if include_optional:
    ...
    def testTagLanguageMarshaller(self):
        """Test TagLanguageMarshaller"""
