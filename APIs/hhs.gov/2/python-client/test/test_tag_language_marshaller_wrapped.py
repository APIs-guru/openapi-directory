...
class TestTagLanguageMarshallerWrapped(unittest.TestCase):
    """TagLanguageMarshallerWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagLanguageMarshallerWrapped:
        """Test TagLanguageMarshallerWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagLanguageMarshallerWrapped`
        """
        model = TagLanguageMarshallerWrapped()
        if include_optional:
            return TagLanguageMarshallerWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.tag_language_marshaller.TagLanguageMarshaller(
                        id = 56, 
                        is_active = True, 
                        iso_code = '', 
                        name = '', )
    ...
    def testTagLanguageMarshallerWrapped(self):
        """Test TagLanguageMarshallerWrapped"""
