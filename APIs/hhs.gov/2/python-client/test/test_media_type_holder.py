...
class TestMediaTypeHolder(unittest.TestCase):
    """MediaTypeHolder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaTypeHolder:
        """Test MediaTypeHolder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaTypeHolder`
        """
        model = MediaTypeHolder()
        if include_optional:
