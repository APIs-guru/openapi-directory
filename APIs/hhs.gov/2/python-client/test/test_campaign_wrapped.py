...
class TestCampaignWrapped(unittest.TestCase):
    """CampaignWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignWrapped:
        """Test CampaignWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignWrapped`
        """
        model = CampaignWrapped()
        if include_optional:
