...
class TestInfographic(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Infographic:
        """Test Infographic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Infographic`
        """
        model = Infographic()
        if include_optional:
            return Infographic(
