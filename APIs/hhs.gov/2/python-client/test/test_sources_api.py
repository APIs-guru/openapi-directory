...
class TestSourcesApi(unittest.TestCase):
    ...
    def test_resources_sources_id_json_get(self) -> None:
    ...
    def test_resources_sources_id_syndicate_format_get(self) -> None:
    ...
    def test_resources_sources_json_get(self) -> None:
