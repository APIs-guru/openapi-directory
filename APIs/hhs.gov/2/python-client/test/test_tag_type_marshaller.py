...
class TestTagTypeMarshaller(unittest.TestCase):
    """TagTypeMarshaller unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagTypeMarshaller:
        """Test TagTypeMarshaller
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagTypeMarshaller`
        """
        model = TagTypeMarshaller()
        if include_optional:
    ...
    def testTagTypeMarshaller(self):
        """Test TagTypeMarshaller"""
