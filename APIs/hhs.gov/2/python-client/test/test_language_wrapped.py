...
class TestLanguageWrapped(unittest.TestCase):
    """LanguageWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LanguageWrapped:
        """Test LanguageWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguageWrapped`
        """
        model = LanguageWrapped()
        if include_optional:
