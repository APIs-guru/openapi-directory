...
class TestExtendedAttributeWrapped(unittest.TestCase):
    """ExtendedAttributeWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedAttributeWrapped:
        """Test ExtendedAttributeWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedAttributeWrapped`
        """
        model = ExtendedAttributeWrapped()
        if include_optional:
            return ExtendedAttributeWrapped(
                callback = '',
    ...
    def testExtendedAttributeWrapped(self):
        """Test ExtendedAttributeWrapped"""
