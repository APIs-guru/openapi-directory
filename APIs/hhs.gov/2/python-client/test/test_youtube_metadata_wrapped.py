...
class TestYoutubeMetadataWrapped(unittest.TestCase):
    """YoutubeMetadataWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YoutubeMetadataWrapped:
        """Test YoutubeMetadataWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YoutubeMetadataWrapped`
        """
        model = YoutubeMetadataWrapped()
        if include_optional:
            return YoutubeMetadataWrapped(
                callback = '',
    ...
    def testYoutubeMetadataWrapped(self):
        """Test YoutubeMetadataWrapped"""
