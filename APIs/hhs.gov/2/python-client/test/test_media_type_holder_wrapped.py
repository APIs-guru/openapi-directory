...
class TestMediaTypeHolderWrapped(unittest.TestCase):
    """MediaTypeHolderWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaTypeHolderWrapped:
        """Test MediaTypeHolderWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaTypeHolderWrapped`
        """
        model = MediaTypeHolderWrapped()
        if include_optional:
            return MediaTypeHolderWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.media_type_holder.MediaTypeHolder(
                        description = '', 
                        name = '', )
                    ]
            )
    ...
    def testMediaTypeHolderWrapped(self):
        """Test MediaTypeHolderWrapped"""
