...
class TestTagTypeMarshallerWrapped(unittest.TestCase):
    """TagTypeMarshallerWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagTypeMarshallerWrapped:
        """Test TagTypeMarshallerWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagTypeMarshallerWrapped`
        """
        model = TagTypeMarshallerWrapped()
        if include_optional:
            return TagTypeMarshallerWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.tag_type_marshaller.TagTypeMarshaller(
                        id = 56, 
                        name = '', )
                    ]
            )
    ...
    def testTagTypeMarshallerWrapped(self):
        """Test TagTypeMarshallerWrapped"""
