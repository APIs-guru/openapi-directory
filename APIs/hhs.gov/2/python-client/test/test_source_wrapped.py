...
class TestSourceWrapped(unittest.TestCase):
    """SourceWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceWrapped:
        """Test SourceWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceWrapped`
        """
        model = SourceWrapped()
        if include_optional:
