...
class TestTagMarshallerWrapped(unittest.TestCase):
    """TagMarshallerWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagMarshallerWrapped:
        """Test TagMarshallerWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagMarshallerWrapped`
        """
        model = TagMarshallerWrapped()
        if include_optional:
            return TagMarshallerWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.tag_marshaller.TagMarshaller(
                        id = 56, 
    ...
    def testTagMarshallerWrapped(self):
        """Test TagMarshallerWrapped"""
