...
class TestSyndicateMarshallerWrapped(unittest.TestCase):
    """SyndicateMarshallerWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyndicateMarshallerWrapped:
        """Test SyndicateMarshallerWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyndicateMarshallerWrapped`
        """
        model = SyndicateMarshallerWrapped()
        if include_optional:
            return SyndicateMarshallerWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.syndicate_marshaller.SyndicateMarshaller(
                        content = '', 
                        description = '', 
                        id = 56, 
                        media_type = '', 
    ...
    def testSyndicateMarshallerWrapped(self):
        """Test SyndicateMarshallerWrapped"""
