...
class TestHtmlWrapped(unittest.TestCase):
    """HtmlWrapped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HtmlWrapped:
        """Test HtmlWrapped
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HtmlWrapped`
        """
        model = HtmlWrapped()
        if include_optional:
            return HtmlWrapped(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.html.Html(
                        campaigns = [
