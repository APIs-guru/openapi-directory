...
class TestResourcesMediaIdYoutubeMetaDataJsonGet200Response(unittest.TestCase):
    """ResourcesMediaIdYoutubeMetaDataJsonGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourcesMediaIdYoutubeMetaDataJsonGet200Response:
        """Test ResourcesMediaIdYoutubeMetaDataJsonGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourcesMediaIdYoutubeMetaDataJsonGet200Response`
        """
        model = ResourcesMediaIdYoutubeMetaDataJsonGet200Response()
        if include_optional:
            return ResourcesMediaIdYoutubeMetaDataJsonGet200Response(
                ...
                meta = openapi_client.models.meta.Meta(
                    ...
                    status = 56, ),
                results = [
                    openapi_client.models.youtube_metadata.YoutubeMetadata()
                    ]
            )
        else:
            return ResourcesMediaIdYoutubeMetaDataJsonGet200Response(
    ...
    def testResourcesMediaIdYoutubeMetaDataJsonGet200Response(self):
        """Test ResourcesMediaIdYoutubeMetaDataJsonGet200Response"""
