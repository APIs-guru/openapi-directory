...
class TestCampaignsApi(unittest.TestCase):
    ...
    def test_resources_campaigns_id_json_get(self) -> None:
    ...
    def test_resources_campaigns_id_media_json_get(self) -> None:
    ...
    def test_resources_campaigns_id_syndicate_format_get(self) -> None:
    ...
    def test_resources_campaigns_json_get(self) -> None:
