...
class TestAlternateImage(unittest.TestCase):
    """AlternateImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlternateImage:
        """Test AlternateImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlternateImage`
        """
        model = AlternateImage()
        if include_optional:
