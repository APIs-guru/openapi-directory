...
class TestOfferingUser(unittest.TestCase):
    """OfferingUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferingUser:
        """Test OfferingUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferingUser`
        """
        model = OfferingUser()
        if include_optional:
            return OfferingUser(
