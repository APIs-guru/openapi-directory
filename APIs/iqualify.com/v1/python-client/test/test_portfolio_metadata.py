...
class TestPortfolioMetadata(unittest.TestCase):
    """PortfolioMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioMetadata:
        """Test PortfolioMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioMetadata`
        """
    ...
    def testPortfolioMetadata(self):
        """Test PortfolioMetadata"""
