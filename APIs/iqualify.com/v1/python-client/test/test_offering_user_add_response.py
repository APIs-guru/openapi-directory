...
class TestOfferingUserAddResponse(unittest.TestCase):
    """OfferingUserAddResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferingUserAddResponse:
        """Test OfferingUserAddResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferingUserAddResponse`
        """
        model = OfferingUserAddResponse()
        if include_optional:
    ...
    def testOfferingUserAddResponse(self):
        """Test OfferingUserAddResponse"""
