...
class TestPulseAnswer(unittest.TestCase):
    """PulseAnswer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseAnswer:
        """Test PulseAnswer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseAnswer`
        """
        model = PulseAnswer()
        if include_optional:
            return PulseAnswer(
