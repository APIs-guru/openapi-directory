    ...
    def make_instance(self, include_optional) -> UserResponse:
        ...
        if include_optional:
            return UserResponse(
                avatar_url = '',
                email = '0',
                first_access_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                first_name = '0',
                id = '',
                invite = openapi_client.models.invite.Invite(
                    url = '', ),
                last_access_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                last_name = '0',
