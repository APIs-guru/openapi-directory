...
class TestOfferingMetadataResponse(unittest.TestCase):
    """OfferingMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferingMetadataResponse:
        """Test OfferingMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferingMetadataResponse`
        """
        model = OfferingMetadataResponse()
        if include_optional:
            return OfferingMetadataResponse(
                ...
                identifier = '',
                is_readonly = True,
                metadata = openapi_client.models.offering_metadata.OfferingMetadata(
                    category = '', 
                    level = '', 
                    root_content_id = '', 
                    tags = [
    ...
    def testOfferingMetadataResponse(self):
        """Test OfferingMetadataResponse"""
