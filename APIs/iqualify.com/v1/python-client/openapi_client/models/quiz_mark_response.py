...
class QuizMarkResponse(BaseModel):
    """
    QuizMarkResponse
    """ # noqa: E501
    ...
    learner_fullname: Optional[StrictStr] = Field(default=None, alias="learnerFullname")
    learner_person_id: Optional[StrictStr] = Field(default=None, alias="learnerPersonId")
    mark: Optional[StrictStr] = None
    quiz_id: Optional[StrictStr] = Field(default=None, alias="quizId")
    quiz_title: Optional[StrictStr] = Field(default=None, alias="quizTitle")
    __properties: ClassVar[List[str]] = ["attempts", "lastAttemptAt", "learnerEmail", "learnerFullname", "learnerPersonId", "mark", "quizId", "quizTitle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "learnerFullname": obj.get("learnerFullname"),
            "learnerPersonId": obj.get("learnerPersonId"),
            "mark": obj.get("mark"),
            "quizId": obj.get("quizId"),
            "quizTitle": obj.get("quizTitle")
        })
        return _obj
