...
class PulseMCQOption(BaseModel):
    """
    PulseMCQOption
    """ # noqa: E501
    option: Optional[StrictStr] = None
    value: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["option", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PulseMCQOption from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PulseMCQOption from a dict"""
        if obj is None:
            return None
