...
class OfferingUserResponse(BaseModel):
    """
    ...
    evaluated_by: Optional[List[StrictStr]] = Field(default=None, alias="evaluatedBy")
    evaluates: Optional[List[StrictStr]] = None
    ...
    marked_by: Optional[List[StrictStr]] = Field(default=None, alias="markedBy")
    marks: Optional[List[StrictStr]] = None
    person_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="personId")
    profile: Optional[UserProfile] = None
    __properties: ClassVar[List[str]] = ["avatarUrl", "email", "evaluatedBy", "evaluates", "firstName", "id", "isFacilitator", "isMarker", "isReadonly", "lastName", "markedBy", "marks", "personId", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "evaluatedBy": obj.get("evaluatedBy"),
