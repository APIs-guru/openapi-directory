...
class MarkFeedback(BaseModel):
    ...
    feedback_by: Optional[StrictStr] = Field(default=None, alias="feedbackBy")
    id: Optional[StrictStr] = None
    mark: Optional[StrictStr] = None
    marker_id: Optional[StrictStr] = Field(default=None, alias="markerId")
    __properties: ClassVar[List[str]] = ["createdAt", "feedback", "feedbackBy", "id", "mark", "markerId"]
