...
class LearnerResponse(BaseModel):
    ...
    offerings: Optional[List[OfferingProgressRow]] = None
    person_id: Optional[StrictStr] = Field(default=None, alias="personId")
    __properties: ClassVar[List[str]] = ["email", "firstName", "id", "lastName", "offerings", "personId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offerings": [OfferingProgressRow.from_dict(_item) for _item in obj["offerings"]] if obj.get("offerings") is not None else None,
