...
class UserResponse(BaseModel):
    ...
    first_access_at: Optional[datetime] = Field(default=None, alias="firstAccessAt")
    ...
    last_access_at: Optional[datetime] = Field(default=None, alias="lastAccessAt")
    ...
    __properties: ClassVar[List[str]] = ["avatarUrl", "email", "firstAccessAt", "firstName", "id", "invite", "lastAccessAt", "lastName", "metadata", "personId", "profile"]
