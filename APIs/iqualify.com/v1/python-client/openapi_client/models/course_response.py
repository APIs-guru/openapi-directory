...
class CourseResponse(BaseModel):
    ...
    metadata: Optional[CourseResponseMetadata] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["coverImageUrl", "createdAt", "id", "metadata", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metadata": CourseResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": obj.get("name")
        })
        return _obj
