...
class CourseMetaResponse(BaseModel):
    ...
    CourseMetaResponse
    """ # noqa: E501
    cover_image_url: Optional[StrictStr] = Field(default=None, alias="coverImageUrl")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    id: Optional[StrictStr] = None
    metadata: Optional[CourseMetaResponseMetadata] = None
    name: Optional[StrictStr] = None
    tasks_enabled: Optional[StrictBool] = Field(default=None, alias="tasksEnabled")
    __properties: ClassVar[List[str]] = ["coverImageUrl", "createdAt", "id", "metadata", "name", "tasksEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metadata": CourseMetaResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": obj.get("name"),
