...
class ThemeResponse(BaseModel):
    ...
    number_of_questions: Optional[StrictStr] = Field(default=None, alias="numberOfQuestions")
    __properties: ClassVar[List[str]] = ["filter", "numberOfQuestions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numberOfQuestions": obj.get("numberOfQuestions")
        })
        return _obj
