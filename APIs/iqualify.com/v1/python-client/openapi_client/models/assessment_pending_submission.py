...
class AssessmentPendingSubmission(BaseModel):
    """
    ...
    offering_name: Optional[StrictStr] = Field(default=None, alias="offeringName")
    ...
    __properties: ClassVar[List[str]] = ["content", "documents", "dueDate", "durationMinutes", "filename", "hidden", "id", "markNumber", "markType", "maxAttempts", "offeringId", "offeringName", "openDate", "pid", "points", "themes", "title", "totalQuestions", "totalThemes", "type", "users"]
