...
class ChannelRequired(BaseModel):
    ...
    ChannelRequired
    """ # noqa: E501
    is_broadcast_only: Optional[StrictBool] = Field(default=False, alias="isBroadcastOnly")
    title: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["isBroadcastOnly", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isBroadcastOnly": obj.get("isBroadcastOnly") if obj.get("isBroadcastOnly") is not None else False,
            "title": obj.get("title")
        })
        return _obj
