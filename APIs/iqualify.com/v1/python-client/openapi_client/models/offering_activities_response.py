...
class OfferingActivitiesResponse(BaseModel):
    """
    OfferingActivitiesResponse
    """ # noqa: E501
    activity_id: Optional[StrictStr] = Field(default=None, alias="activityId")
    time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="expected minutes to complete")
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["activityId", "time", "title"]
