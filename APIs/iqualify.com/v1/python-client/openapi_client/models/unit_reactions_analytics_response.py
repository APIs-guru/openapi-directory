...
class UnitReactionsAnalyticsResponse(BaseModel):
    """
    UnitReactionsAnalyticsResponse
    """ # noqa: E501
    feedback: Optional[UnitReactionsFeedback] = None
    page_id: Optional[StrictBool] = Field(default=None, alias="pageId")
    __properties: ClassVar[List[str]] = ["feedback", "pageId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feedback": UnitReactionsFeedback.from_dict(obj["feedback"]) if obj.get("feedback") is not None else None,
