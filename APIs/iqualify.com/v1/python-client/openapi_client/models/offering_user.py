...
class OfferingUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "firstName", "isFacilitator", "isMarker", "isReadonly", "lastName", "metadata", "personId", "profile", "sendInvite", "sendNotificationEmail"]
