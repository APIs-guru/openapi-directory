...
class OfferingBadge(BaseModel):
    """
    OfferingBadge
    """ # noqa: E501
    badge_expiry: Optional[BadgeExpiry] = Field(default=None, alias="badgeExpiry")
    description: Optional[StrictStr] = None
    requires_approval: Optional[StrictBool] = Field(default=None, alias="requiresApproval")
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["badgeExpiry", "description", "requiresApproval", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badgeExpiry": BadgeExpiry.from_dict(obj["badgeExpiry"]) if obj.get("badgeExpiry") is not None else None,
