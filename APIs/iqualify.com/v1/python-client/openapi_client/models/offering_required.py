...
class OfferingRequired(BaseModel):
    """
    OfferingRequired
    """ # noqa: E501
    ...
    create_default_channels: Optional[StrictBool] = Field(default=False, alias="createDefaultChannels")
    ...
    root_content_id: Optional[StrictStr] = Field(default=None, description="Every time a course is republished it's assigned a new contentId. rootContentId is the first original contentId associated with a course.", alias="rootContentId")
    start: datetime
    ...
    __properties: ClassVar[List[str]] = ["badge", "contentId", "createDefaultChannels", "description", "earlyCloseOffDate", "end", "hasEarlyCloseOff", "identifier", "isReadonly", "metadata", "name", "rootContentId", "start", "trailerVideoUrl", "useRelativeDates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createDefaultChannels": obj.get("createDefaultChannels") if obj.get("createDefaultChannels") is not None else False,
