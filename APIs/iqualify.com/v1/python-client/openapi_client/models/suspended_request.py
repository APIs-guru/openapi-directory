...
class SuspendedRequest(BaseModel):
    """
    SuspendedRequest
    """ # noqa: E501
    suspended: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["suspended"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SuspendedRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SuspendedRequest from a dict"""
        if obj is None:
            return None
