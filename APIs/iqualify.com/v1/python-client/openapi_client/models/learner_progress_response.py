...
class LearnerProgressResponse(BaseModel):
    ...
    last_logged_in_at: Optional[datetime] = Field(default=None, alias="lastLoggedInAt")
    last_name: Optional[StrictStr] = Field(default=None, alias="lastName")
    person_id: Optional[StrictStr] = Field(default=None, alias="personId")
    __properties: ClassVar[List[str]] = ["completion", "courseId", "email", "firstName", "lastLoggedInAt", "lastName", "personId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastLoggedInAt": obj.get("lastLoggedInAt"),
