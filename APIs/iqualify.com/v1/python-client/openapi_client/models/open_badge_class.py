...
class OpenBadgeClass(BaseModel):
    """
    OpenBadgeClass
    """ # noqa: E501
    criteria: Optional[OpenBadgeClassCriteria] = None
    ...
    __properties: ClassVar[List[str]] = ["criteria", "description", "id", "image", "issuer", "name", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": OpenBadgeClassCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None,
