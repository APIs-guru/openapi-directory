...
class TestNetworkServiceDeleteResponse(unittest.TestCase):
    """NetworkServiceDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkServiceDeleteResponse:
        """Test NetworkServiceDeleteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkServiceDeleteResponse`
        """
        model = NetworkServiceDeleteResponse()
        if include_optional:
            return NetworkServiceDeleteResponse(
                billing_account = '',
                capacity = 1,
    ...
    def testNetworkServiceDeleteResponse(self):
        """Test NetworkServiceDeleteResponse"""
