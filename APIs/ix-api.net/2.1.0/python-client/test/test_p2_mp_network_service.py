...
class TestP2MPNetworkService(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> P2MPNetworkService:
        """Test P2MPNetworkService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `P2MPNetworkService`
        """
        model = P2MPNetworkService()
        if include_optional:
            return P2MPNetworkService(
                billing_account = '',
