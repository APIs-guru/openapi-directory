...
class TestProductOfferingPartial(unittest.TestCase):
    """ProductOfferingPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductOfferingPartial:
        """Test ProductOfferingPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductOfferingPartial`
        """
        model = ProductOfferingPartial()
        if include_optional:
            return ProductOfferingPartial(
                bandwidth_max = 0,
                bandwidth_min = 0,
                display_name = '',
    ...
    def testProductOfferingPartial(self):
        """Test ProductOfferingPartial"""
