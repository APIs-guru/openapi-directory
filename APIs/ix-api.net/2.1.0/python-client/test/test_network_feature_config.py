...
class TestNetworkFeatureConfig(unittest.TestCase):
    """NetworkFeatureConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkFeatureConfig:
        """Test NetworkFeatureConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkFeatureConfig`
        """
    ...
    def testNetworkFeatureConfig(self):
        """Test NetworkFeatureConfig"""
