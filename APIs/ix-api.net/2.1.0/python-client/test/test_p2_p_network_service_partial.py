...
class TestP2PNetworkServicePartial(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> P2PNetworkServicePartial:
        """Test P2PNetworkServicePartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `P2PNetworkServicePartial`
        """
        model = P2PNetworkServicePartial()
        if include_optional:
