...
mp2_mp_network_service_config_partial_instance = MP2MPNetworkServiceConfigPartial.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkServiceConfigPartial.to_json())

# convert the object into a dict
mp2_mp_network_service_config_partial_dict = mp2_mp_network_service_config_partial_instance.to_dict()
# create an instance of MP2MPNetworkServiceConfigPartial from a dict
mp2_mp_network_service_config_partial_from_dict = MP2MPNetworkServiceConfigPartial.from_dict(mp2_mp_network_service_config_partial_dict)
```
