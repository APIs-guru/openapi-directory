...
p2_p_network_service_config_request_instance = P2PNetworkServiceConfigRequest.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkServiceConfigRequest.to_json())

# convert the object into a dict
p2_p_network_service_config_request_dict = p2_p_network_service_config_request_instance.to_dict()
# create an instance of P2PNetworkServiceConfigRequest from a dict
p2_p_network_service_config_request_from_dict = P2PNetworkServiceConfigRequest.from_dict(p2_p_network_service_config_request_dict)
```
