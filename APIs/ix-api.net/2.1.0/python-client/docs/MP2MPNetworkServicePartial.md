...
json = "{}"
# create an instance of MP2MPNetworkServicePartial from a JSON string
mp2_mp_network_service_partial_instance = MP2MPNetworkServicePartial.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkServicePartial.to_json())

# convert the object into a dict
mp2_mp_network_service_partial_dict = mp2_mp_network_service_partial_instance.to_dict()
# create an instance of MP2MPNetworkServicePartial from a dict
mp2_mp_network_service_partial_from_dict = MP2MPNetworkServicePartial.from_dict(mp2_mp_network_service_partial_dict)
```
