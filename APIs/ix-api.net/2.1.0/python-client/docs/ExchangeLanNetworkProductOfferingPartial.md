...
json = "{}"
# create an instance of ExchangeLanNetworkProductOfferingPartial from a JSON string
exchange_lan_network_product_offering_partial_instance = ExchangeLanNetworkProductOfferingPartial.from_json(json)
# print the JSON string representation of the object
print(ExchangeLanNetworkProductOfferingPartial.to_json())

# convert the object into a dict
exchange_lan_network_product_offering_partial_dict = exchange_lan_network_product_offering_partial_instance.to_dict()
# create an instance of ExchangeLanNetworkProductOfferingPartial from a dict
exchange_lan_network_product_offering_partial_from_dict = ExchangeLanNetworkProductOfferingPartial.from_dict(exchange_lan_network_product_offering_partial_dict)
```
