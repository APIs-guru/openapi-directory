...
route_server_network_feature_config_request_partial_instance = RouteServerNetworkFeatureConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(RouteServerNetworkFeatureConfigRequestPartial.to_json())

# convert the object into a dict
route_server_network_feature_config_request_partial_dict = route_server_network_feature_config_request_partial_instance.to_dict()
# create an instance of RouteServerNetworkFeatureConfigRequestPartial from a dict
route_server_network_feature_config_request_partial_from_dict = RouteServerNetworkFeatureConfigRequestPartial.from_dict(route_server_network_feature_config_request_partial_dict)
```
