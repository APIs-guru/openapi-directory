...
exchange_lan_network_service_config_instance = ExchangeLanNetworkServiceConfig.from_json(json)
# print the JSON string representation of the object
print(ExchangeLanNetworkServiceConfig.to_json())

# convert the object into a dict
exchange_lan_network_service_config_dict = exchange_lan_network_service_config_instance.to_dict()
# create an instance of ExchangeLanNetworkServiceConfig from a dict
exchange_lan_network_service_config_from_dict = ExchangeLanNetworkServiceConfig.from_dict(exchange_lan_network_service_config_dict)
```
