...
network_service_config_update_instance = NetworkServiceConfigUpdate.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceConfigUpdate.to_json())

# convert the object into a dict
network_service_config_update_dict = network_service_config_update_instance.to_dict()
# create an instance of NetworkServiceConfigUpdate from a dict
network_service_config_update_from_dict = NetworkServiceConfigUpdate.from_dict(network_service_config_update_dict)
```
