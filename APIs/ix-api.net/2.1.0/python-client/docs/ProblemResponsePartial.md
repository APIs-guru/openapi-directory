...
**type** | **str** | A URI reference (see RFC3986) that identifies the problem type.  This specification encourages that, when dereferenced, it provide human-readable documentation for the problem type (e.g., using HTML [W3C.REC-html5-20141028]).  When this member is not present, its value is assumed to be \&quot;about:blank\&quot;.  | [optional] 
...
json = "{}"
# create an instance of ProblemResponsePartial from a JSON string
problem_response_partial_instance = ProblemResponsePartial.from_json(json)
# print the JSON string representation of the object
print(ProblemResponsePartial.to_json())

# convert the object into a dict
problem_response_partial_dict = problem_response_partial_instance.to_dict()
# create an instance of ProblemResponsePartial from a dict
problem_response_partial_from_dict = ProblemResponsePartial.from_dict(problem_response_partial_dict)
```
