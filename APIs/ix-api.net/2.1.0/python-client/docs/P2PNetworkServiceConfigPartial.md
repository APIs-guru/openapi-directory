...
json = "{}"
# create an instance of P2PNetworkServiceConfigPartial from a JSON string
p2_p_network_service_config_partial_instance = P2PNetworkServiceConfigPartial.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkServiceConfigPartial.to_json())

# convert the object into a dict
p2_p_network_service_config_partial_dict = p2_p_network_service_config_partial_instance.to_dict()
# create an instance of P2PNetworkServiceConfigPartial from a dict
p2_p_network_service_config_partial_from_dict = P2PNetworkServiceConfigPartial.from_dict(p2_p_network_service_config_partial_dict)
```
