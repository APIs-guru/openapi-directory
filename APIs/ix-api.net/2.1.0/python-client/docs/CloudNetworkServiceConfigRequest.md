...
cloud_network_service_config_request_instance = CloudNetworkServiceConfigRequest.from_json(json)
# print the JSON string representation of the object
print(CloudNetworkServiceConfigRequest.to_json())

# convert the object into a dict
cloud_network_service_config_request_dict = cloud_network_service_config_request_instance.to_dict()
# create an instance of CloudNetworkServiceConfigRequest from a dict
cloud_network_service_config_request_from_dict = CloudNetworkServiceConfigRequest.from_dict(cloud_network_service_config_request_dict)
```
