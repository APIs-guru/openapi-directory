...
mp2_mp_network_service_config_update_instance = MP2MPNetworkServiceConfigUpdate.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkServiceConfigUpdate.to_json())

# convert the object into a dict
mp2_mp_network_service_config_update_dict = mp2_mp_network_service_config_update_instance.to_dict()
# create an instance of MP2MPNetworkServiceConfigUpdate from a dict
mp2_mp_network_service_config_update_from_dict = MP2MPNetworkServiceConfigUpdate.from_dict(mp2_mp_network_service_config_update_dict)
```
