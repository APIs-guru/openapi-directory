...
mp2_mp_network_service_instance = MP2MPNetworkService.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkService.to_json())

# convert the object into a dict
mp2_mp_network_service_dict = mp2_mp_network_service_instance.to_dict()
# create an instance of MP2MPNetworkService from a dict
mp2_mp_network_service_from_dict = MP2MPNetworkService.from_dict(mp2_mp_network_service_dict)
```
