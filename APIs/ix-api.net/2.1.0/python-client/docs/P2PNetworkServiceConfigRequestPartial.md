...
json = "{}"
# create an instance of P2PNetworkServiceConfigRequestPartial from a JSON string
p2_p_network_service_config_request_partial_instance = P2PNetworkServiceConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkServiceConfigRequestPartial.to_json())

# convert the object into a dict
p2_p_network_service_config_request_partial_dict = p2_p_network_service_config_request_partial_instance.to_dict()
# create an instance of P2PNetworkServiceConfigRequestPartial from a dict
p2_p_network_service_config_request_partial_from_dict = P2PNetworkServiceConfigRequestPartial.from_dict(p2_p_network_service_config_request_partial_dict)
```
