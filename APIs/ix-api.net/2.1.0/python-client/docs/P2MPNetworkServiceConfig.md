...
p2_mp_network_service_config_instance = P2MPNetworkServiceConfig.from_json(json)
# print the JSON string representation of the object
print(P2MPNetworkServiceConfig.to_json())

# convert the object into a dict
p2_mp_network_service_config_dict = p2_mp_network_service_config_instance.to_dict()
# create an instance of P2MPNetworkServiceConfig from a dict
p2_mp_network_service_config_from_dict = P2MPNetworkServiceConfig.from_dict(p2_mp_network_service_config_dict)
```
