...
network_service_request_instance = NetworkServiceRequest.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceRequest.to_json())

# convert the object into a dict
network_service_request_dict = network_service_request_instance.to_dict()
# create an instance of NetworkServiceRequest from a dict
network_service_request_from_dict = NetworkServiceRequest.from_dict(network_service_request_dict)
```
