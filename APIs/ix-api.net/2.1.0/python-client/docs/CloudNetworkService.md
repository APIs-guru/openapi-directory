...
json = "{}"
# create an instance of CloudNetworkService from a JSON string
cloud_network_service_instance = CloudNetworkService.from_json(json)
# print the JSON string representation of the object
print(CloudNetworkService.to_json())

# convert the object into a dict
cloud_network_service_dict = cloud_network_service_instance.to_dict()
# create an instance of CloudNetworkService from a dict
cloud_network_service_from_dict = CloudNetworkService.from_dict(cloud_network_service_dict)
```
