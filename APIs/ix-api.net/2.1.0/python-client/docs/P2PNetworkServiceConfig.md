...
p2_p_network_service_config_instance = P2PNetworkServiceConfig.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkServiceConfig.to_json())

# convert the object into a dict
p2_p_network_service_config_dict = p2_p_network_service_config_instance.to_dict()
# create an instance of P2PNetworkServiceConfig from a dict
p2_p_network_service_config_from_dict = P2PNetworkServiceConfig.from_dict(p2_p_network_service_config_dict)
```
