...
mp2_mp_network_service_config_request_partial_instance = MP2MPNetworkServiceConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkServiceConfigRequestPartial.to_json())

# convert the object into a dict
mp2_mp_network_service_config_request_partial_dict = mp2_mp_network_service_config_request_partial_instance.to_dict()
# create an instance of MP2MPNetworkServiceConfigRequestPartial from a dict
mp2_mp_network_service_config_request_partial_from_dict = MP2MPNetworkServiceConfigRequestPartial.from_dict(mp2_mp_network_service_config_request_partial_dict)
```
