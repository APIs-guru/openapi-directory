...
connection_request_partial_instance = ConnectionRequestPartial.from_json(json)
# print the JSON string representation of the object
print(ConnectionRequestPartial.to_json())

# convert the object into a dict
connection_request_partial_dict = connection_request_partial_instance.to_dict()
# create an instance of ConnectionRequestPartial from a dict
connection_request_partial_from_dict = ConnectionRequestPartial.from_dict(connection_request_partial_dict)
```
