...
network_service_config_request_partial_instance = NetworkServiceConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceConfigRequestPartial.to_json())

# convert the object into a dict
network_service_config_request_partial_dict = network_service_config_request_partial_instance.to_dict()
# create an instance of NetworkServiceConfigRequestPartial from a dict
network_service_config_request_partial_from_dict = NetworkServiceConfigRequestPartial.from_dict(network_service_config_request_partial_dict)
```
