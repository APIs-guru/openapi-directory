...
ip_address_partial_instance = IpAddressPartial.from_json(json)
# print the JSON string representation of the object
print(IpAddressPartial.to_json())

# convert the object into a dict
ip_address_partial_dict = ip_address_partial_instance.to_dict()
# create an instance of IpAddressPartial from a dict
ip_address_partial_from_dict = IpAddressPartial.from_dict(ip_address_partial_dict)
```
