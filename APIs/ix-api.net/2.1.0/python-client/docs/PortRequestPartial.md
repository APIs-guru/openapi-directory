...
**media_type** | **str** | The media type of the interface. See the device&#39;s capabilities to see what types are available.  | [optional] 
...
json = "{}"
# create an instance of PortRequestPartial from a JSON string
port_request_partial_instance = PortRequestPartial.from_json(json)
# print the JSON string representation of the object
print(PortRequestPartial.to_json())

# convert the object into a dict
port_request_partial_dict = port_request_partial_instance.to_dict()
# create an instance of PortRequestPartial from a dict
port_request_partial_from_dict = PortRequestPartial.from_dict(port_request_partial_dict)
```
