...
json = "{}"
# create an instance of IpAddressRequestPartial from a JSON string
ip_address_request_partial_instance = IpAddressRequestPartial.from_json(json)
# print the JSON string representation of the object
print(IpAddressRequestPartial.to_json())

# convert the object into a dict
ip_address_request_partial_dict = ip_address_request_partial_instance.to_dict()
# create an instance of IpAddressRequestPartial from a dict
ip_address_request_partial_from_dict = IpAddressRequestPartial.from_dict(ip_address_request_partial_dict)
```
