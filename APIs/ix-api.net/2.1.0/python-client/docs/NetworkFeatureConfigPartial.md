...
network_feature_config_partial_instance = NetworkFeatureConfigPartial.from_json(json)
# print the JSON string representation of the object
print(NetworkFeatureConfigPartial.to_json())

# convert the object into a dict
network_feature_config_partial_dict = network_feature_config_partial_instance.to_dict()
# create an instance of NetworkFeatureConfigPartial from a dict
network_feature_config_partial_from_dict = NetworkFeatureConfigPartial.from_dict(network_feature_config_partial_dict)
```
