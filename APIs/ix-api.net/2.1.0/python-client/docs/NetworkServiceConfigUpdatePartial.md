...
network_service_config_update_partial_instance = NetworkServiceConfigUpdatePartial.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceConfigUpdatePartial.to_json())

# convert the object into a dict
network_service_config_update_partial_dict = network_service_config_update_partial_instance.to_dict()
# create an instance of NetworkServiceConfigUpdatePartial from a dict
network_service_config_update_partial_from_dict = NetworkServiceConfigUpdatePartial.from_dict(network_service_config_update_partial_dict)
```
