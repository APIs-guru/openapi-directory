...
cloud_network_service_partial_instance = CloudNetworkServicePartial.from_json(json)
# print the JSON string representation of the object
print(CloudNetworkServicePartial.to_json())

# convert the object into a dict
cloud_network_service_partial_dict = cloud_network_service_partial_instance.to_dict()
# create an instance of CloudNetworkServicePartial from a dict
cloud_network_service_partial_from_dict = CloudNetworkServicePartial.from_dict(cloud_network_service_partial_dict)
```
