...
contact_partial_instance = ContactPartial.from_json(json)
# print the JSON string representation of the object
print(ContactPartial.to_json())

# convert the object into a dict
contact_partial_dict = contact_partial_instance.to_dict()
# create an instance of ContactPartial from a dict
contact_partial_from_dict = ContactPartial.from_dict(contact_partial_dict)
```
