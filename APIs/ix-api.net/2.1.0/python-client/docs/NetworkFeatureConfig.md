...
network_feature_config_instance = NetworkFeatureConfig.from_json(json)
# print the JSON string representation of the object
print(NetworkFeatureConfig.to_json())

# convert the object into a dict
network_feature_config_dict = network_feature_config_instance.to_dict()
# create an instance of NetworkFeatureConfig from a dict
network_feature_config_from_dict = NetworkFeatureConfig.from_dict(network_feature_config_dict)
```
