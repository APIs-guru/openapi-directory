...
json = "{}"
# create an instance of ConnectionUpdatePartial from a JSON string
connection_update_partial_instance = ConnectionUpdatePartial.from_json(json)
# print the JSON string representation of the object
print(ConnectionUpdatePartial.to_json())

# convert the object into a dict
connection_update_partial_dict = connection_update_partial_instance.to_dict()
# create an instance of ConnectionUpdatePartial from a dict
connection_update_partial_from_dict = ConnectionUpdatePartial.from_dict(connection_update_partial_dict)
```
