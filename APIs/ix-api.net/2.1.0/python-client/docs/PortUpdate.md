...
json = "{}"
# create an instance of PortUpdate from a JSON string
port_update_instance = PortUpdate.from_json(json)
# print the JSON string representation of the object
print(PortUpdate.to_json())

# convert the object into a dict
port_update_dict = port_update_instance.to_dict()
# create an instance of PortUpdate from a dict
port_update_from_dict = PortUpdate.from_dict(port_update_dict)
```
