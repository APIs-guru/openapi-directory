...
json = "{}"
# create an instance of ExchangeLanNetworkServiceConfigUpdatePartial from a JSON string
exchange_lan_network_service_config_update_partial_instance = ExchangeLanNetworkServiceConfigUpdatePartial.from_json(json)
# print the JSON string representation of the object
print(ExchangeLanNetworkServiceConfigUpdatePartial.to_json())

# convert the object into a dict
exchange_lan_network_service_config_update_partial_dict = exchange_lan_network_service_config_update_partial_instance.to_dict()
# create an instance of ExchangeLanNetworkServiceConfigUpdatePartial from a dict
exchange_lan_network_service_config_update_partial_from_dict = ExchangeLanNetworkServiceConfigUpdatePartial.from_dict(exchange_lan_network_service_config_update_partial_dict)
```
