...
network_service_delete_response_partial_instance = NetworkServiceDeleteResponsePartial.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceDeleteResponsePartial.to_json())

# convert the object into a dict
network_service_delete_response_partial_dict = network_service_delete_response_partial_instance.to_dict()
# create an instance of NetworkServiceDeleteResponsePartial from a dict
network_service_delete_response_partial_from_dict = NetworkServiceDeleteResponsePartial.from_dict(network_service_delete_response_partial_dict)
```
