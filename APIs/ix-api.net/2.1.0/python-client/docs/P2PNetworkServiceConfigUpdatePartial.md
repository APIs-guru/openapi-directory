...
json = "{}"
# create an instance of P2PNetworkServiceConfigUpdatePartial from a JSON string
p2_p_network_service_config_update_partial_instance = P2PNetworkServiceConfigUpdatePartial.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkServiceConfigUpdatePartial.to_json())

# convert the object into a dict
p2_p_network_service_config_update_partial_dict = p2_p_network_service_config_update_partial_instance.to_dict()
# create an instance of P2PNetworkServiceConfigUpdatePartial from a dict
p2_p_network_service_config_update_partial_from_dict = P2PNetworkServiceConfigUpdatePartial.from_dict(p2_p_network_service_config_update_partial_dict)
```
