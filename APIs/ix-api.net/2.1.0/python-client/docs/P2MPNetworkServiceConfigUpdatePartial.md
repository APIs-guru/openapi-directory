...
p2_mp_network_service_config_update_partial_instance = P2MPNetworkServiceConfigUpdatePartial.from_json(json)
# print the JSON string representation of the object
print(P2MPNetworkServiceConfigUpdatePartial.to_json())

# convert the object into a dict
p2_mp_network_service_config_update_partial_dict = p2_mp_network_service_config_update_partial_instance.to_dict()
# create an instance of P2MPNetworkServiceConfigUpdatePartial from a dict
p2_mp_network_service_config_update_partial_from_dict = P2MPNetworkServiceConfigUpdatePartial.from_dict(p2_mp_network_service_config_update_partial_dict)
```
