...
json = "{}"
# create an instance of ExchangeLanNetworkServiceConfigPartial from a JSON string
exchange_lan_network_service_config_partial_instance = ExchangeLanNetworkServiceConfigPartial.from_json(json)
# print the JSON string representation of the object
print(ExchangeLanNetworkServiceConfigPartial.to_json())

# convert the object into a dict
exchange_lan_network_service_config_partial_dict = exchange_lan_network_service_config_partial_instance.to_dict()
# create an instance of ExchangeLanNetworkServiceConfigPartial from a dict
exchange_lan_network_service_config_partial_from_dict = ExchangeLanNetworkServiceConfigPartial.from_dict(exchange_lan_network_service_config_partial_dict)
```
