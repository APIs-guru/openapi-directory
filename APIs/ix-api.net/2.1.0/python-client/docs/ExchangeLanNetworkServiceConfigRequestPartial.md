...
json = "{}"
# create an instance of ExchangeLanNetworkServiceConfigRequestPartial from a JSON string
exchange_lan_network_service_config_request_partial_instance = ExchangeLanNetworkServiceConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(ExchangeLanNetworkServiceConfigRequestPartial.to_json())

# convert the object into a dict
exchange_lan_network_service_config_request_partial_dict = exchange_lan_network_service_config_request_partial_instance.to_dict()
# create an instance of ExchangeLanNetworkServiceConfigRequestPartial from a dict
exchange_lan_network_service_config_request_partial_from_dict = ExchangeLanNetworkServiceConfigRequestPartial.from_dict(exchange_lan_network_service_config_request_partial_dict)
```
