...
json = "{}"
# create an instance of NetworkServiceConfig from a JSON string
network_service_config_instance = NetworkServiceConfig.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceConfig.to_json())

# convert the object into a dict
network_service_config_dict = network_service_config_instance.to_dict()
# create an instance of NetworkServiceConfig from a dict
network_service_config_from_dict = NetworkServiceConfig.from_dict(network_service_config_dict)
```
