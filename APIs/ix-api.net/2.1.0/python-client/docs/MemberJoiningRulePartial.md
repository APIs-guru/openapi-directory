...
member_joining_rule_partial_instance = MemberJoiningRulePartial.from_json(json)
# print the JSON string representation of the object
print(MemberJoiningRulePartial.to_json())

# convert the object into a dict
member_joining_rule_partial_dict = member_joining_rule_partial_instance.to_dict()
# create an instance of MemberJoiningRulePartial from a dict
member_joining_rule_partial_from_dict = MemberJoiningRulePartial.from_dict(member_joining_rule_partial_dict)
```
