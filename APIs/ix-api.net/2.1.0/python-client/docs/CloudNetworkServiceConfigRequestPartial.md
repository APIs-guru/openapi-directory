...
cloud_network_service_config_request_partial_instance = CloudNetworkServiceConfigRequestPartial.from_json(json)
# print the JSON string representation of the object
print(CloudNetworkServiceConfigRequestPartial.to_json())

# convert the object into a dict
cloud_network_service_config_request_partial_dict = cloud_network_service_config_request_partial_instance.to_dict()
# create an instance of CloudNetworkServiceConfigRequestPartial from a dict
cloud_network_service_config_request_partial_from_dict = CloudNetworkServiceConfigRequestPartial.from_dict(cloud_network_service_config_request_partial_dict)
```
