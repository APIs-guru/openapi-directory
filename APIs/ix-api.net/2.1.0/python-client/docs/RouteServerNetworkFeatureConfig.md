...
route_server_network_feature_config_instance = RouteServerNetworkFeatureConfig.from_json(json)
# print the JSON string representation of the object
print(RouteServerNetworkFeatureConfig.to_json())

# convert the object into a dict
route_server_network_feature_config_dict = route_server_network_feature_config_instance.to_dict()
# create an instance of RouteServerNetworkFeatureConfig from a dict
route_server_network_feature_config_from_dict = RouteServerNetworkFeatureConfig.from_dict(route_server_network_feature_config_dict)
```
