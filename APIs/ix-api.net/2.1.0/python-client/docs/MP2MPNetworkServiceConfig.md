...
mp2_mp_network_service_config_instance = MP2MPNetworkServiceConfig.from_json(json)
# print the JSON string representation of the object
print(MP2MPNetworkServiceConfig.to_json())

# convert the object into a dict
mp2_mp_network_service_config_dict = mp2_mp_network_service_config_instance.to_dict()
# create an instance of MP2MPNetworkServiceConfig from a dict
mp2_mp_network_service_config_from_dict = MP2MPNetworkServiceConfig.from_dict(mp2_mp_network_service_config_dict)
```
