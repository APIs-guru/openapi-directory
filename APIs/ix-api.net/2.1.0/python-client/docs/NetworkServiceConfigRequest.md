...
network_service_config_request_instance = NetworkServiceConfigRequest.from_json(json)
# print the JSON string representation of the object
print(NetworkServiceConfigRequest.to_json())

# convert the object into a dict
network_service_config_request_dict = network_service_config_request_instance.to_dict()
# create an instance of NetworkServiceConfigRequest from a dict
network_service_config_request_from_dict = NetworkServiceConfigRequest.from_dict(network_service_config_request_dict)
```
