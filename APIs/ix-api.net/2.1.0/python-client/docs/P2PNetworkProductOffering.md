...
p2_p_network_product_offering_instance = P2PNetworkProductOffering.from_json(json)
# print the JSON string representation of the object
print(P2PNetworkProductOffering.to_json())

# convert the object into a dict
p2_p_network_product_offering_dict = p2_p_network_product_offering_instance.to_dict()
# create an instance of P2PNetworkProductOffering from a dict
p2_p_network_product_offering_from_dict = P2PNetworkProductOffering.from_dict(p2_p_network_product_offering_dict)
```
