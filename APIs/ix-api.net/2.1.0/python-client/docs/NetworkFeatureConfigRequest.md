...
network_feature_config_request_instance = NetworkFeatureConfigRequest.from_json(json)
# print the JSON string representation of the object
print(NetworkFeatureConfigRequest.to_json())

# convert the object into a dict
network_feature_config_request_dict = network_feature_config_request_instance.to_dict()
# create an instance of NetworkFeatureConfigRequest from a dict
network_feature_config_request_from_dict = NetworkFeatureConfigRequest.from_dict(network_feature_config_request_dict)
```
