...
json = "{}"
# create an instance of P2MPNetworkServiceConfigRequest from a JSON string
p2_mp_network_service_config_request_instance = P2MPNetworkServiceConfigRequest.from_json(json)
# print the JSON string representation of the object
print(P2MPNetworkServiceConfigRequest.to_json())

# convert the object into a dict
p2_mp_network_service_config_request_dict = p2_mp_network_service_config_request_instance.to_dict()
# create an instance of P2MPNetworkServiceConfigRequest from a dict
p2_mp_network_service_config_request_from_dict = P2MPNetworkServiceConfigRequest.from_dict(p2_mp_network_service_config_request_dict)
```
