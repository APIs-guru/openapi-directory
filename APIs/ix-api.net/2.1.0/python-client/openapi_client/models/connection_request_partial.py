...
class ConnectionRequestPartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "consuming_account", "contract_ref", "external_ref", "lacp_timeout", "managing_account", "mode", "purchase_order", "role_assignments", "speed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectionRequestPartial from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectionRequestPartial from a dict"""
        if obj is None:
            return None
