...
class MacAddress(BaseModel):
    ...
    MacAddress
    """ # noqa: E501
    address: StrictStr = Field(description="Unicast MAC address, formatted hexadecimal values with colons. ")
    ...
    __properties: ClassVar[List[str]] = ["address", "consuming_account", "external_ref", "id", "managing_account", "valid_not_after", "valid_not_before"]
