...
class P2MPNetworkService(BaseModel):
    """
    P2MPNetworkService
    """ # noqa: E501
    ...
    name: Annotated[str, Field(strict=True, max_length=40)] = Field(description="Name of the point to multi-point virtual circuit.")
