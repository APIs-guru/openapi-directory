...
class MP2MPNetworkServiceConfigUpdatePartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "macs", "managing_account", "network_feature_configs", "purchase_order", "role_assignments", "type", "vlan_config"]
