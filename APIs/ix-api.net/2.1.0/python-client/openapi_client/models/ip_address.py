...
class IpAddress(BaseModel):
    ...
    IpAddress
    """ # noqa: E501
    address: StrictStr = Field(description="IPv4 or IPv6 Address in the following format: - IPv4: [dot-decimal notation](https://en.wikipedia.org/wiki/Dot-decimal_notation) - IPv6: hexadecimal colon separated notation ")
    ...
    prefix_length: Annotated[int, Field(le=128, strict=True, ge=0)] = Field(description="The CIDR ip prefix length ")
    valid_not_after: Optional[datetime] = None
    valid_not_before: Optional[datetime] = None
    version: StrictInt = Field(description="The version of the internet protocol. ")
