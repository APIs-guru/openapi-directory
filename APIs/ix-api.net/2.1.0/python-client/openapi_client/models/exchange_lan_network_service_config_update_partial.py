...
class ExchangeLanNetworkServiceConfigUpdatePartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asns", "billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "ips", "listed", "macs", "managing_account", "network_feature_configs", "purchase_order", "role_assignments", "type", "vlan_config"]
