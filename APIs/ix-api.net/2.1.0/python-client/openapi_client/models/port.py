...
class Port(BaseModel):
    ...
    device: StrictStr = Field(description="The device the port. ")
    ...
    media_type: Annotated[str, Field(strict=True, max_length=20)] = Field(description="The media type of the port. Query the device's capabilities for available types. ")
    ...
    pop: StrictStr = Field(description="Same as the `pop` of the `device`. ")
