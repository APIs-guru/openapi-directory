...
class P2PNetworkServiceConfigRequest(BaseModel):
    """
    ...
    network_service: StrictStr = Field(description="The id of the `NetworkService` to configure.")
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role_assignments", "type", "vlan_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of P2PNetworkServiceConfigRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of P2PNetworkServiceConfigRequest from a dict"""
        if obj is None:
            return None
