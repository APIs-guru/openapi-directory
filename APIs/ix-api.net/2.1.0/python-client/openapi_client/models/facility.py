...
class Facility(BaseModel):
    ...
    Facility
    """ # noqa: E501
    address_country: Annotated[str, Field(strict=True, max_length=2)] = Field(description="ISO 3166-1 alpha-2 country code, for example DE ")
    address_locality: Annotated[str, Field(strict=True, max_length=80)] = Field(description="The locality/city. For example, Mountain View.")
    address_region: Annotated[str, Field(strict=True, max_length=80)] = Field(description="The region. For example, CA")
    id: Annotated[str, Field(strict=True, max_length=80)]
    metro_area: StrictStr = Field(description="Id of the `MetroArea` the DC is located in. ")
    name: Annotated[str, Field(strict=True, max_length=80)] = Field(description="Name of the Datacenter as called by the operator ")
    organisation_name: Annotated[str, Field(strict=True, max_length=80)] = Field(description="Name of Datacenter operator ")
    ...
    pops: List[StrictStr] = Field(description="List of pops in the `Facility`.")
    postal_code: Annotated[str, Field(strict=True, max_length=18)] = Field(description="A postal code. For example, 9404")
    street_address: Annotated[str, Field(strict=True, max_length=80)] = Field(description="The street address. For example, 1600 Amphitheatre Pkwy.")
