...
class P2MPNetworkProductOffering(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bandwidth_max", "bandwidth_min", "display_name", "downgrade_allowed", "handover_metro_area", "handover_metro_area_network", "id", "name", "physical_port_speed", "provider_vlans", "resource_type", "service_metro_area", "service_metro_area_network", "service_provider", "type", "upgrade_allowed"]
