...
class AccountsList401Response(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['https://errors.ix-api.net/v2/authentication-error.html', 'https://errors.ix-api.net/v2/signature-expired.html']):
            raise ValueError("must be one of enum values ('https://errors.ix-api.net/v2/authentication-error.html', 'https://errors.ix-api.net/v2/signature-expired.html')")
        return value
