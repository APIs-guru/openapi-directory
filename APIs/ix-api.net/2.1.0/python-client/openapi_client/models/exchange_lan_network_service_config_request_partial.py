...
class ExchangeLanNetworkServiceConfigRequestPartial(BaseModel):
    ...
    """ # noqa: E501
    asns: Optional[List[Annotated[int, Field(le=4294967295, strict=True, ge=0)]]] = None
    ...
    listed: Optional[StrictBool] = Field(default=None, description="The customer wants to be featured on the member list")
    ...
    product_offering: Optional[StrictStr] = Field(default=None, description="The product offering must match the type `exchange_lan` and must refer to the related network service through the `exchange_lan_network_service` property.")
    ...
    __properties: ClassVar[List[str]] = ["asns", "billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "ips", "listed", "macs", "managing_account", "network_feature_configs", "network_service", "product_offering", "purchase_order", "role_assignments", "type", "vlan_config"]
