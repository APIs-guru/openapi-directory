...
class CloudNetworkServiceConfigPartial(BaseModel):
    ...
    handover: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The handover enumerates the connection and is required for checking diversity constraints.  It must be within `1 <= x <= network_service.diversity`. ")
    ...
    network_service: Optional[StrictStr] = Field(default=None, description="The id of the configured network service.")
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "charged_until", "cloud_vlan", "connection", "consuming_account", "contract_ref", "decommission_at", "external_ref", "handover", "id", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role_assignments", "state", "status", "type", "vlan_config"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if cloud_vlan (nullable) is None
        # and model_fields_set contains the field
        if self.cloud_vlan is None and "cloud_vlan" in self.model_fields_set:
            _dict['cloud_vlan'] = None
