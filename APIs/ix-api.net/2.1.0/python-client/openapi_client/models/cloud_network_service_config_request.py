...
class CloudNetworkServiceConfigRequest(BaseModel):
    """
    ...
    handover: Annotated[int, Field(strict=True, ge=1)] = Field(description="The handover enumerates the connection and is required for checking diversity constraints.  It must be within `1 <= x <= network_service.diversity`. ")
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "cloud_vlan", "connection", "consuming_account", "contract_ref", "external_ref", "handover", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role_assignments", "type", "vlan_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudNetworkServiceConfigRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudNetworkServiceConfigRequest from a dict"""
        if obj is None:
            return None
