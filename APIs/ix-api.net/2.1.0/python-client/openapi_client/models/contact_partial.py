...
class ContactPartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["consuming_account", "email", "external_ref", "id", "managing_account", "name", "telephone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContactPartial from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContactPartial from a dict"""
        if obj is None:
            return None
