...
class PortRequest(BaseModel):
    ...
    media_type: Annotated[str, Field(strict=True, max_length=20)] = Field(description="The media type of the interface. See the device's capabilities to see what types are available. ")
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "connection", "consuming_account", "contract_ref", "external_ref", "managing_account", "media_type", "pop", "purchase_order", "role_assignments", "speed"]
