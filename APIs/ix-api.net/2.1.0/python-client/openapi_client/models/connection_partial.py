...
class ConnectionPartial(BaseModel):
    ...
    outer_vlan_ethertypes: Optional[List[StrictStr]] = Field(default=None, description="The ethertype of the outer tag in hexadecimal notation. ")
    ...
    vlan_types: Optional[List[StrictStr]] = Field(default=None, description="A list of vlan config types you can configure using this connection.")
