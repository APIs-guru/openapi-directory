...
class PortUpdatePartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "connection", "consuming_account", "contract_ref", "external_ref", "managing_account", "purchase_order", "role_assignments", "speed"]
