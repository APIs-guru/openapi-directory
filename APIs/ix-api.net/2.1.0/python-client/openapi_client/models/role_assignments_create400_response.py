...
class RoleAssignmentsCreate400Response(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['https://errors.ix-api.net/v2/validation-error.html', 'https://errors.ix-api.net/v2/unable-to-fulfill.html']):
            raise ValueError("must be one of enum values ('https://errors.ix-api.net/v2/validation-error.html', 'https://errors.ix-api.net/v2/unable-to-fulfill.html')")
        return value
