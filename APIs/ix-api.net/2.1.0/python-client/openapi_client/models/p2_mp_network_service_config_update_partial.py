...
class P2MPNetworkServiceConfigUpdatePartial(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default='leaf', description="A `leaf` can only reach roots and is isolated from other leafs. A `root` can reach any other point in the virtual circuit including other roots.")
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "managing_account", "network_feature_configs", "purchase_order", "role", "role_assignments", "type", "vlan_config"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['root', 'leaf']):
            raise ValueError("must be one of enum values ('root', 'leaf')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of P2MPNetworkServiceConfigUpdatePartial from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of P2MPNetworkServiceConfigUpdatePartial from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role") if obj.get("role") is not None else 'leaf',
