...
class AccountsRead404Response(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['https://errors.ix-api.net/v2/not-found.html']):
            raise ValueError("must be one of enum values ('https://errors.ix-api.net/v2/not-found.html')")
        return value
