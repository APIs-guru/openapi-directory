...
class P2PNetworkServiceConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "charged_until", "connection", "consuming_account", "contract_ref", "decommission_at", "external_ref", "id", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role_assignments", "state", "status", "type", "vlan_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of P2PNetworkServiceConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of P2PNetworkServiceConfig from a dict"""
        if obj is None:
            return None
