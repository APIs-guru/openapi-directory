...
class CloudNetworkService(BaseModel):
    """
    CloudNetworkService
    """ # noqa: E501
    ...
    provider_ref: Optional[StrictStr] = Field(description="For a cloud network service with the exchange first workflow, the `provider_ref` will be a reference to a resource of the cloud provider. (E.g. the UUID of a virtual circuit.)  The `provider_ref` is managed by the exchange and its meaning may vary between different cloud services. ")
