...
class RouteServerNetworkFeatureConfigUpdate(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["as_set_v4", "as_set_v6", "asn", "bgp_session_type", "consuming_account", "external_ref", "insert_ixp_asn", "ip", "managing_account", "max_prefix_v4", "max_prefix_v6", "password", "session_mode", "type"]
