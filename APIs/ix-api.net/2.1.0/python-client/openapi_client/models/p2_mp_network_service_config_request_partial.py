...
class P2MPNetworkServiceConfigRequestPartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "connection", "consuming_account", "contract_ref", "external_ref", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role", "role_assignments", "type", "vlan_config"]
