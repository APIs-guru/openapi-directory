...
class P2MPNetworkServicePartial(BaseModel):
    ...
    member_joining_rules: Optional[List[StrictStr]] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=40)]] = Field(default=None, description="Name of the point to multi-point virtual circuit.")
    ...
    product_offering: Optional[StrictStr] = None
    public: Optional[StrictBool] = Field(default=False, description="A public p2mp network service can be joined by everyone on the exchange unless denied by a member-joining-rule.  Public network services are visible to other members of the IXP, however only `name`, `type`, `product_offering`, `consuming_account` and `managing_account` are made available.  Other required fields are redacted.")
