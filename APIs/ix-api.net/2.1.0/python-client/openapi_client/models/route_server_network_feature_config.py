...
class RouteServerNetworkFeatureConfig(BaseModel):
    """
    ...
    ip: StrictStr = Field(description="The BGP session will be established from this IP address. Only IPs assigned to the corresponding network service config can be used.")
    ...
    network_feature: StrictStr
    network_service_config: StrictStr
    ...
    session_mode: StrictStr = Field(description="Set the session mode with the routeserver. ")
    state: StrictStr
    status: Optional[List[Status]] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["as_set_v4", "as_set_v6", "asn", "bgp_session_type", "billing_account", "consuming_account", "contract_ref", "external_ref", "id", "insert_ixp_asn", "ip", "managing_account", "max_prefix_v4", "max_prefix_v6", "network_feature", "network_service_config", "password", "purchase_order", "role_assignments", "session_mode", "state", "status", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RouteServerNetworkFeatureConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RouteServerNetworkFeatureConfig from a dict"""
        if obj is None:
            return None
