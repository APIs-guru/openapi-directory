...
class CloudNetworkServiceConfigUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "cloud_vlan", "connection", "consuming_account", "contract_ref", "external_ref", "handover", "managing_account", "network_feature_configs", "purchase_order", "role_assignments", "type", "vlan_config"]
