...
class P2PNetworkServiceRequest(BaseModel):
    """
    ...
    joining_member_account: StrictStr = Field(description="The account of the B-side member joining the virtual circuit. ")
