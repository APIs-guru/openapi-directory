...
class P2PNetworkService(BaseModel):
    """
    P2PNetworkService
    """ # noqa: E501
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "charged_until", "consuming_account", "contract_ref", "decommission_at", "external_ref", "id", "joining_member_account", "managing_account", "nsc_required_contact_roles", "product_offering", "purchase_order", "state", "status", "type"]
