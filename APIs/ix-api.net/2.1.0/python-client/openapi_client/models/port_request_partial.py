...
class PortRequestPartial(BaseModel):
    ...
    media_type: Optional[Annotated[str, Field(strict=True, max_length=20)]] = Field(default=None, description="The media type of the interface. See the device's capabilities to see what types are available. ")
