...
class MP2MPNetworkServiceRequest(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["billing_account", "consuming_account", "contract_ref", "external_ref", "managing_account", "name", "product_offering", "public", "purchase_order", "type"]
