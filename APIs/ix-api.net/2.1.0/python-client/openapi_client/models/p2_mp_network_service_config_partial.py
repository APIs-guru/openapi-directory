...
class P2MPNetworkServiceConfigPartial(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_account", "capacity", "charged_until", "connection", "consuming_account", "contract_ref", "decommission_at", "external_ref", "id", "managing_account", "network_feature_configs", "network_service", "purchase_order", "role", "role_assignments", "state", "status", "type", "vlan_config"]
