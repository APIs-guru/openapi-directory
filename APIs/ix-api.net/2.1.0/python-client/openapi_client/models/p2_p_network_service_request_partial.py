...
class P2PNetworkServiceRequestPartial(BaseModel):
    ...
    joining_member_account: Optional[StrictStr] = Field(default=None, description="The account of the B-side member joining the virtual circuit. ")
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["billing_account", "consuming_account", "contract_ref", "external_ref", "joining_member_account", "managing_account", "product_offering", "purchase_order", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "joining_member_account": obj.get("joining_member_account"),
