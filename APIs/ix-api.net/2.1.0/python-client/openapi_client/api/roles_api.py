...
class RolesApi:
    ...
    def roles_read(
        ...
        id2: Annotated[Optional[List[StrictStr]], Field(description="Filter by id")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter by name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._roles_read_serialize(
            id=id,
            id2=id2,
            name=name,
            _request_auth=_request_auth,
    ...
    @validate_call
    def roles_read_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Get by id")],
        id2: Annotated[Optional[List[StrictStr]], Field(description="Filter by id")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filter by name")] = None,
