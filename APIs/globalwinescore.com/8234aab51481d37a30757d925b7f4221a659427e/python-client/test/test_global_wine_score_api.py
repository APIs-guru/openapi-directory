...
class TestGlobalWineScoreApi(unittest.TestCase):
    """GlobalWineScoreApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GlobalWineScoreApi()

    def tearDown(self) -> None:
        pass

    def test_globalwinescores_latest_get(self) -> None:
    ...
    def test_list_historical_gws(self) -> None:
