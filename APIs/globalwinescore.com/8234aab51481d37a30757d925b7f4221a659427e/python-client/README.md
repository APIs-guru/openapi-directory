...
------------ | ------------- | ------------- | -------------
*GlobalWineScoreApi* | [**globalwinescores_latest_get**](docs/GlobalWineScoreApi.md#globalwinescores_latest_get) | **GET** /globalwinescores/latest/ | List all latest GWS
*GlobalWineScoreApi* | [**list_historical_gws**](docs/GlobalWineScoreApi.md#list_historical_gws) | **GET** /globalwinescores/ | List all historical GWS
