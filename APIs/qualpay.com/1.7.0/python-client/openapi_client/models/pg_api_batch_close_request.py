...
class PGApiBatchCloseRequest(BaseModel):
    """
    ...
    tran_currency: Optional[StrictInt] = Field(default=None, description="<strong>Format: </strong>Variable length, up to 3 N<br><strong>Default: </strong>840<br><strong>Description: </strong>ISO numeric currency code for the transaction. Refer to <a href=\"/developer/api/reference#country-codes\"target=\"_blank\">Country Codes</a> for a list of currency codes.")
    user_id: Optional[StrictInt] = Field(default=None, description="INTERNAL USE ONLY.")
    __properties: ClassVar[List[str]] = ["developer_id", "echo_fields", "loc_id", "merchant_id", "profile_id", "report_data", "retry_attempt", "retry_id", "session_id", "tran_currency", "user_id"]
