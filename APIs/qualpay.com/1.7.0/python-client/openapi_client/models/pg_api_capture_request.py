...
class PGApiCaptureRequest(BaseModel):
    """
    PGApiCaptureRequest
    """ # noqa: E501
    amt_tran: Union[StrictFloat, StrictInt] = Field(description="<strong>Format: </strong>Variable length, up to 12,2 N<br><strong>Description: </strong>Total amount to capture. The amount must be less than or equal to the authorized amount.")
