...
class PGApiBatchCloseResponse(BaseModel):
    """
    PGApiBatchCloseResponse
    """ # noqa: E501
    batch_info: Optional[StrictStr] = Field(default=None, description="<strong>Format: </strong>Variable length<br><strong>Description: </strong>JSON array of JSON objects containing the batch close results by currency and location.")
    ...
    __properties: ClassVar[List[str]] = ["batch_info", "echo_fields", "pg_id", "rcode", "rmsg"]
