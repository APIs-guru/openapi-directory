...
class PGApiTokenizeResponse(BaseModel):
    """
    ...
    card_number: Optional[StrictStr] = Field(default=None, description="<strong>Format: </strong>Variable length, up to 16 AN<br><strong>Description: </strong>Cardholder's card number (truncated).")
    ...
    __properties: ClassVar[List[str]] = ["card_id", "card_number", "echo_fields", "pg_id", "rcode", "rmsg"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PGApiTokenizeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PGApiTokenizeResponse from a dict"""
        if obj is None:
            return None
