...
class ArdefRequest(BaseModel):
    """
    ArdefRequest
    """ # noqa: E501
    card_number: StrictStr = Field(description="<strong>Format: </strong>Variable length, up to 19 N<br><strong>Description: </strong>Cardholder's card number.")
    ...
    __properties: ClassVar[List[str]] = ["card_number", "merchant_id"]
