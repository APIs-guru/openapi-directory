...
class PGApiVerifyResponse(BaseModel):
    """
    PGApiVerifyResponse
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["auth_avs_result", "auth_code", "auth_cvv2_result", "card_id", "card_number", "echo_fields", "merchant_advice_code", "pg_id", "rcode", "rmsg"]
