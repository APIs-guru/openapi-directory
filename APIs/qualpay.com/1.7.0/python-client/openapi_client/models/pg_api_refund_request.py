...
class PGApiRefundRequest(BaseModel):
    """
    PGApiRefundRequest
    """ # noqa: E501
    amt_tran: Union[StrictFloat, StrictInt] = Field(description="<strong>Format: </strong>Variable length, up to 12,2 N<br><strong>Description: </strong>Total amount to refund. Partial refunds are allowed by providing an amount in this field that is less than the total original transaction amount.")
    ...
    vendor_id: Optional[StrictInt] = Field(default=None, description="<strong>Format: </strong>Variable length, up to 12 N<br><strong>Description: </strong>Identifies the vendor to which this refund request applies.")
    __properties: ClassVar[List[str]] = ["amt_tran", "developer_id", "echo_fields", "loc_id", "merchant_id", "profile_id", "report_data", "retry_attempt", "retry_id", "session_id", "user_id", "vendor_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PGApiRefundRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PGApiRefundRequest from a dict"""
        if obj is None:
            return None
