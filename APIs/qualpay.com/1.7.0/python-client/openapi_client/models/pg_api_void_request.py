...
class PGApiVoidRequest(BaseModel):
    """
    PGApiVoidRequest
    """ # noqa: E501
    ...
    vendor_id: Optional[StrictInt] = Field(default=None, description="<strong>Format: </strong>Variable length, up to 12 N<br><strong>Description: </strong>Identifies the vendor to which this void request applies.")
    __properties: ClassVar[List[str]] = ["developer_id", "echo_fields", "loc_id", "merchant_id", "profile_id", "report_data", "retry_attempt", "retry_id", "session_id", "user_id", "vendor_id"]
