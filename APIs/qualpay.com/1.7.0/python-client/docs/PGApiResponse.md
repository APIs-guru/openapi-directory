...
json = "{}"
# create an instance of PGApiResponse from a JSON string
pg_api_response_instance = PGApiResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiResponse.to_json())

# convert the object into a dict
pg_api_response_dict = pg_api_response_instance.to_dict()
# create an instance of PGApiResponse from a dict
pg_api_response_from_dict = PGApiResponse.from_dict(pg_api_response_dict)
```
