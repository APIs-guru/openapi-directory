...
json = "{}"
# create an instance of PGApiVoidResponse from a JSON string
pg_api_void_response_instance = PGApiVoidResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiVoidResponse.to_json())

# convert the object into a dict
pg_api_void_response_dict = pg_api_void_response_instance.to_dict()
# create an instance of PGApiVoidResponse from a dict
pg_api_void_response_from_dict = PGApiVoidResponse.from_dict(pg_api_void_response_dict)
```
