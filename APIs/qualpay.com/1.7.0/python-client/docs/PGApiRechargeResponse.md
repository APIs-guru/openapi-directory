...
pg_api_recharge_response_instance = PGApiRechargeResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiRechargeResponse.to_json())

# convert the object into a dict
pg_api_recharge_response_dict = pg_api_recharge_response_instance.to_dict()
# create an instance of PGApiRechargeResponse from a dict
pg_api_recharge_response_from_dict = PGApiRechargeResponse.from_dict(pg_api_recharge_response_dict)
```
