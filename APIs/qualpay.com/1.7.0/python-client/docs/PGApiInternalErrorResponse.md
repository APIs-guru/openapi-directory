...
json = "{}"
# create an instance of PGApiInternalErrorResponse from a JSON string
pg_api_internal_error_response_instance = PGApiInternalErrorResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiInternalErrorResponse.to_json())

# convert the object into a dict
pg_api_internal_error_response_dict = pg_api_internal_error_response_instance.to_dict()
# create an instance of PGApiInternalErrorResponse from a dict
pg_api_internal_error_response_from_dict = PGApiInternalErrorResponse.from_dict(pg_api_internal_error_response_dict)
```
