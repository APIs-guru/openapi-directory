...
pg_api_tokenize_response_instance = PGApiTokenizeResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiTokenizeResponse.to_json())

# convert the object into a dict
pg_api_tokenize_response_dict = pg_api_tokenize_response_instance.to_dict()
# create an instance of PGApiTokenizeResponse from a dict
pg_api_tokenize_response_from_dict = PGApiTokenizeResponse.from_dict(pg_api_tokenize_response_dict)
```
