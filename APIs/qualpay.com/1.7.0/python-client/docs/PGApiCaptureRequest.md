...
------------ | ------------- | ------------- | -------------
**amt_tran** | **float** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length, up to 12,2 N&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;Total amount to capture. The amount must be less than or equal to the authorized amount. | 
...
json = "{}"
# create an instance of PGApiCaptureRequest from a JSON string
pg_api_capture_request_instance = PGApiCaptureRequest.from_json(json)
# print the JSON string representation of the object
print(PGApiCaptureRequest.to_json())

# convert the object into a dict
pg_api_capture_request_dict = pg_api_capture_request_instance.to_dict()
# create an instance of PGApiCaptureRequest from a dict
pg_api_capture_request_from_dict = PGApiCaptureRequest.from_dict(pg_api_capture_request_dict)
```
