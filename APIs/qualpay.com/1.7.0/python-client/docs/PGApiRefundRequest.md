...
------------ | ------------- | ------------- | -------------
**amt_tran** | **float** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length, up to 12,2 N&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;Total amount to refund. Partial refunds are allowed by providing an amount in this field that is less than the total original transaction amount. | 
...
pg_api_refund_request_instance = PGApiRefundRequest.from_json(json)
# print the JSON string representation of the object
print(PGApiRefundRequest.to_json())

# convert the object into a dict
pg_api_refund_request_dict = pg_api_refund_request_instance.to_dict()
# create an instance of PGApiRefundRequest from a dict
pg_api_refund_request_from_dict = PGApiRefundRequest.from_dict(pg_api_refund_request_dict)
```
