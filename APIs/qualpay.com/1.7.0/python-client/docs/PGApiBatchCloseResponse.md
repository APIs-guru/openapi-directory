...
------------ | ------------- | ------------- | -------------
**batch_info** | **str** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;JSON array of JSON objects containing the batch close results by currency and location. | [optional] [readonly] 
...
json = "{}"
# create an instance of PGApiBatchCloseResponse from a JSON string
pg_api_batch_close_response_instance = PGApiBatchCloseResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiBatchCloseResponse.to_json())

# convert the object into a dict
pg_api_batch_close_response_dict = pg_api_batch_close_response_instance.to_dict()
# create an instance of PGApiBatchCloseResponse from a dict
pg_api_batch_close_response_from_dict = PGApiBatchCloseResponse.from_dict(pg_api_batch_close_response_dict)
```
