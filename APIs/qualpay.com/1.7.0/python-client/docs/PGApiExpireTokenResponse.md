...
json = "{}"
# create an instance of PGApiExpireTokenResponse from a JSON string
pg_api_expire_token_response_instance = PGApiExpireTokenResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiExpireTokenResponse.to_json())

# convert the object into a dict
pg_api_expire_token_response_dict = pg_api_expire_token_response_instance.to_dict()
# create an instance of PGApiExpireTokenResponse from a dict
pg_api_expire_token_response_from_dict = PGApiExpireTokenResponse.from_dict(pg_api_expire_token_response_dict)
```
