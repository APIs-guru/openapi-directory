...
pg_api_capture_response_instance = PGApiCaptureResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiCaptureResponse.to_json())

# convert the object into a dict
pg_api_capture_response_dict = pg_api_capture_response_instance.to_dict()
# create an instance of PGApiCaptureResponse from a dict
pg_api_capture_response_from_dict = PGApiCaptureResponse.from_dict(pg_api_capture_response_dict)
```
