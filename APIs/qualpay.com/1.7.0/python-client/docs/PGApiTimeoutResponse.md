...
pg_api_timeout_response_instance = PGApiTimeoutResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiTimeoutResponse.to_json())

# convert the object into a dict
pg_api_timeout_response_dict = pg_api_timeout_response_instance.to_dict()
# create an instance of PGApiTimeoutResponse from a dict
pg_api_timeout_response_from_dict = PGApiTimeoutResponse.from_dict(pg_api_timeout_response_dict)
```
