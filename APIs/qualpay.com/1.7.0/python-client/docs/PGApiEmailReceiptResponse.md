...
json = "{}"
# create an instance of PGApiEmailReceiptResponse from a JSON string
pg_api_email_receipt_response_instance = PGApiEmailReceiptResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiEmailReceiptResponse.to_json())

# convert the object into a dict
pg_api_email_receipt_response_dict = pg_api_email_receipt_response_instance.to_dict()
# create an instance of PGApiEmailReceiptResponse from a dict
pg_api_email_receipt_response_from_dict = PGApiEmailReceiptResponse.from_dict(pg_api_email_receipt_response_dict)
```
