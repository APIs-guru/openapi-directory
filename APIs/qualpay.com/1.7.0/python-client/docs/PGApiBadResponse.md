...
json = "{}"
# create an instance of PGApiBadResponse from a JSON string
pg_api_bad_response_instance = PGApiBadResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiBadResponse.to_json())

# convert the object into a dict
pg_api_bad_response_dict = pg_api_bad_response_instance.to_dict()
# create an instance of PGApiBadResponse from a dict
pg_api_bad_response_from_dict = PGApiBadResponse.from_dict(pg_api_bad_response_dict)
```
