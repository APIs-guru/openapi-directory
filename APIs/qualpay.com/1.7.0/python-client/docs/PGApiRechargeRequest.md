...
------------ | ------------- | ------------- | -------------
**amt_tran** | **float** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length, up to 12,2 N&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;Amount to recharge using the payment data from a previous transaction. | 
...
pg_api_recharge_request_instance = PGApiRechargeRequest.from_json(json)
# print the JSON string representation of the object
print(PGApiRechargeRequest.to_json())

# convert the object into a dict
pg_api_recharge_request_dict = pg_api_recharge_request_instance.to_dict()
# create an instance of PGApiRechargeRequest from a dict
pg_api_recharge_request_from_dict = PGApiRechargeRequest.from_dict(pg_api_recharge_request_dict)
```
