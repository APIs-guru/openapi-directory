...
json = "{}"
# create an instance of PGApiUnauthResponse from a JSON string
pg_api_unauth_response_instance = PGApiUnauthResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiUnauthResponse.to_json())

# convert the object into a dict
pg_api_unauth_response_dict = pg_api_unauth_response_instance.to_dict()
# create an instance of PGApiUnauthResponse from a dict
pg_api_unauth_response_from_dict = PGApiUnauthResponse.from_dict(pg_api_unauth_response_dict)
```
