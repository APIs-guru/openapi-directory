...
pg_api_refund_response_instance = PGApiRefundResponse.from_json(json)
# print the JSON string representation of the object
print(PGApiRefundResponse.to_json())

# convert the object into a dict
pg_api_refund_response_dict = pg_api_refund_response_instance.to_dict()
# create an instance of PGApiRefundResponse from a dict
pg_api_refund_response_from_dict = PGApiRefundResponse.from_dict(pg_api_refund_response_dict)
```
