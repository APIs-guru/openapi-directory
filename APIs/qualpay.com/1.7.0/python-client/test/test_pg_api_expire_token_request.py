...
class TestPGApiExpireTokenRequest(unittest.TestCase):
    """PGApiExpireTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PGApiExpireTokenRequest:
        """Test PGApiExpireTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PGApiExpireTokenRequest`
        """
        model = PGApiExpireTokenRequest()
        if include_optional:
            return PGApiExpireTokenRequest(
    ...
    def testPGApiExpireTokenRequest(self):
        """Test PGApiExpireTokenRequest"""
