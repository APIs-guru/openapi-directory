...
class TestPGApiRefundRequest(unittest.TestCase):
    """PGApiRefundRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PGApiRefundRequest:
        """Test PGApiRefundRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PGApiRefundRequest`
        """
        model = PGApiRefundRequest()
        if include_optional:
            return PGApiRefundRequest(
                amt_tran = 1193.5,
    ...
    def testPGApiRefundRequest(self):
        """Test PGApiRefundRequest"""
