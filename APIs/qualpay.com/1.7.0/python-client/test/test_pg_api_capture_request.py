...
class TestPGApiCaptureRequest(unittest.TestCase):
    """PGApiCaptureRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PGApiCaptureRequest:
        """Test PGApiCaptureRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PGApiCaptureRequest`
        """
        model = PGApiCaptureRequest()
        if include_optional:
            return PGApiCaptureRequest(
                amt_tran = 1193.5,
    ...
    def testPGApiCaptureRequest(self):
        """Test PGApiCaptureRequest"""
