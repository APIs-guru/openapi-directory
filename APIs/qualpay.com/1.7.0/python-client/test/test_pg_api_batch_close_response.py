...
class TestPGApiBatchCloseResponse(unittest.TestCase):
    """PGApiBatchCloseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PGApiBatchCloseResponse:
        """Test PGApiBatchCloseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PGApiBatchCloseResponse`
        """
        model = PGApiBatchCloseResponse()
        if include_optional:
    ...
    def testPGApiBatchCloseResponse(self):
        """Test PGApiBatchCloseResponse"""
