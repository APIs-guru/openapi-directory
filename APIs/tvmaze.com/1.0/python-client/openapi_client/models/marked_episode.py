...
class MarkedEpisode(BaseModel):
    ...
    MarkedEpisode
    """ # noqa: E501
    embedded: Optional[MarkedEpisodeEmbedded] = Field(default=None, alias="_embedded")
    ...
    __properties: ClassVar[List[str]] = ["_embedded", "episode_id", "marked_at", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": MarkedEpisodeEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
