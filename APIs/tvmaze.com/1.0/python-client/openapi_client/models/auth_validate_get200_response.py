...
class AuthValidateGet200Response(BaseModel):
    """
    AuthValidateGet200Response
    """ # noqa: E501
    premium: Optional[StrictInt] = Field(default=None, description="The user's premium level; 1 for Bronze, 2 for Silver, 3 for Gold; or 0 for none")
    __properties: ClassVar[List[str]] = ["premium"]
