...
class TagInstance(BaseModel):
    ...
    TagInstance
    """ # noqa: E501
    embedded: Optional[ShowFollowEmbedded] = Field(default=None, alias="_embedded")
    show_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_embedded", "show_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": ShowFollowEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
