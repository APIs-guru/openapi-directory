...
class AuthPollPost200Response(BaseModel):
    """
    AuthPollPost200Response
    """ # noqa: E501
    apikey: Optional[StrictStr] = Field(default=None, description="The user's API key")
    username: Optional[StrictStr] = Field(default=None, description="The user's username")
    __properties: ClassVar[List[str]] = ["apikey", "username"]
