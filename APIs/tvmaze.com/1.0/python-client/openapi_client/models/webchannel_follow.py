...
class WebchannelFollow(BaseModel):
    ...
    WebchannelFollow
    """ # noqa: E501
    embedded: Optional[WebchannelFollowEmbedded] = Field(default=None, alias="_embedded")
    webchannel_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_embedded", "webchannel_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": WebchannelFollowEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "webchannel_id": obj.get("webchannel_id")
        })
        return _obj
