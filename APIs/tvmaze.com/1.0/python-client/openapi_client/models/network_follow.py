...
class NetworkFollow(BaseModel):
    ...
    NetworkFollow
    """ # noqa: E501
    embedded: Optional[NetworkFollowEmbedded] = Field(default=None, alias="_embedded")
    network_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_embedded", "network_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": NetworkFollowEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
