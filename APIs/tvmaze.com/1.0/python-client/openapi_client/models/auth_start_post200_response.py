...
class AuthStartPost200Response(BaseModel):
    """
    AuthStartPost200Response
    """ # noqa: E501
    confirm_url: Optional[StrictStr] = Field(default=None, description="URL where the user can confirm the authentication request")
    token: Optional[StrictStr] = Field(default=None, description="Authentication token to use in the `poll` endpoint")
    __properties: ClassVar[List[str]] = ["confirm_url", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confirm_url": obj.get("confirm_url"),
            "token": obj.get("token")
        })
        return _obj
