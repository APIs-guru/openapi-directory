...
class AuthStartPostRequest(BaseModel):
    ...
    email_confirmation: Optional[StrictBool] = Field(default=True, description="Whether to email the user a confirmation link")
    __properties: ClassVar[List[str]] = ["email", "email_confirmation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "email_confirmation": obj.get("email_confirmation") if obj.get("email_confirmation") is not None else True
        })
        return _obj
