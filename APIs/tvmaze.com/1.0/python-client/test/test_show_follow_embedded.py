...
class TestShowFollowEmbedded(unittest.TestCase):
    """ShowFollowEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowFollowEmbedded:
        """Test ShowFollowEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowFollowEmbedded`
        """
        model = ShowFollowEmbedded()
        if include_optional:
            return ShowFollowEmbedded(
                show = openapi_client.models.show.Show()
            )
        else:
            return ShowFollowEmbedded(
        )
    ...
    def testShowFollowEmbedded(self):
        """Test ShowFollowEmbedded"""
