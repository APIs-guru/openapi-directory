...
class TestAuthStartPostRequest(unittest.TestCase):
    """AuthStartPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthStartPostRequest:
        """Test AuthStartPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthStartPostRequest`
        """
        model = AuthStartPostRequest()
        if include_optional:
            return AuthStartPostRequest(
                email = '',
    ...
    def testAuthStartPostRequest(self):
        """Test AuthStartPostRequest"""
