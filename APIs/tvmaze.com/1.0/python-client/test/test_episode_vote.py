...
class TestEpisodeVote(unittest.TestCase):
    """EpisodeVote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EpisodeVote:
        """Test EpisodeVote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EpisodeVote`
        """
        model = EpisodeVote()
        if include_optional:
            return EpisodeVote(
