...
class TestTagInstance(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TagInstance:
        """Test TagInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagInstance`
        """
        model = TagInstance()
        if include_optional:
            return TagInstance(
                embedded = openapi_client.models.show_follow__embedded.ShowFollow__embedded(
