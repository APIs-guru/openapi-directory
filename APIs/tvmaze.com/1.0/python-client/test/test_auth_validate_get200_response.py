...
class TestAuthValidateGet200Response(unittest.TestCase):
    """AuthValidateGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthValidateGet200Response:
        """Test AuthValidateGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthValidateGet200Response`
        """
        model = AuthValidateGet200Response()
        if include_optional:
            return AuthValidateGet200Response(
                premium = 56
            )
        else:
            return AuthValidateGet200Response(
    ...
    def testAuthValidateGet200Response(self):
        """Test AuthValidateGet200Response"""
