...
class TestMarkedEpisodeEmbedded(unittest.TestCase):
    """MarkedEpisodeEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkedEpisodeEmbedded:
        """Test MarkedEpisodeEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkedEpisodeEmbedded`
        """
        model = MarkedEpisodeEmbedded()
        if include_optional:
    ...
    def testMarkedEpisodeEmbedded(self):
        """Test MarkedEpisodeEmbedded"""
