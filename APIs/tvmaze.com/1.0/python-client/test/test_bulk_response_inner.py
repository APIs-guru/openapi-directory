...
class TestBulkResponseInner(unittest.TestCase):
    """BulkResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkResponseInner:
        """Test BulkResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkResponseInner`
        """
        model = BulkResponseInner()
        if include_optional:
            return BulkResponseInner(
                code = 56,
                errors = None,
                input = None,
                message = '',
    ...
    def testBulkResponseInner(self):
        """Test BulkResponseInner"""
