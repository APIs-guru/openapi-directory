...
class TestAuthPollPost200Response(unittest.TestCase):
    """AuthPollPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthPollPost200Response:
        """Test AuthPollPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthPollPost200Response`
        """
        model = AuthPollPost200Response()
        if include_optional:
            return AuthPollPost200Response(
                apikey = '',
                username = ''
            )
        else:
    ...
    def testAuthPollPost200Response(self):
        """Test AuthPollPost200Response"""
