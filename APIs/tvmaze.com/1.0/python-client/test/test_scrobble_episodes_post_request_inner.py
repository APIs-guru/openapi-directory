...
class TestScrobbleEpisodesPostRequestInner(unittest.TestCase):
    """ScrobbleEpisodesPostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScrobbleEpisodesPostRequestInner:
        """Test ScrobbleEpisodesPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrobbleEpisodesPostRequestInner`
        """
        model = ScrobbleEpisodesPostRequestInner()
        if include_optional:
            return ScrobbleEpisodesPostRequestInner(
                episode_id = 56,
                marked_at = 56,
                type = None
            )
    ...
    def testScrobbleEpisodesPostRequestInner(self):
        """Test ScrobbleEpisodesPostRequestInner"""
