...
class TestWebchannelFollow(unittest.TestCase):
    """WebchannelFollow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebchannelFollow:
        """Test WebchannelFollow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebchannelFollow`
        """
        model = WebchannelFollow()
        if include_optional:
            return WebchannelFollow(
                embedded = openapi_client.models.webchannel_follow__embedded.WebchannelFollow__embedded(
                    webchannel = openapi_client.models.webchannel.Webchannel(), ),
                webchannel_id = 56
            )
        else:
            return WebchannelFollow(
