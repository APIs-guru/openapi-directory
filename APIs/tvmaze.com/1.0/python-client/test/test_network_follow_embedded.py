...
class TestNetworkFollowEmbedded(unittest.TestCase):
    """NetworkFollowEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkFollowEmbedded:
        """Test NetworkFollowEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkFollowEmbedded`
        """
        model = NetworkFollowEmbedded()
        if include_optional:
    ...
    def testNetworkFollowEmbedded(self):
        """Test NetworkFollowEmbedded"""
