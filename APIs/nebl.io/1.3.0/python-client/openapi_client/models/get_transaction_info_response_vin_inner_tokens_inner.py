...
class GetTransactionInfoResponseVinInnerTokensInner(BaseModel):
    """
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of tokens")
    ...
    issue_txid: Optional[StrictStr] = Field(default=None, description="TXID the token was issued in", alias="issueTxid")
    ...
    __properties: ClassVar[List[str]] = ["aggregationPolicy", "amount", "divisibility", "issueTxid", "lockStatus", "tokenId"]
