...
class GetFaucetResponse(BaseModel):
    ...
    GetFaucetResponse
    """ # noqa: E501
    data: Optional[GetFaucetResponseData] = None
    status: Optional[StrictStr] = Field(default=None, description="Whether the withdrawal was successful")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetFaucetResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
