...
class IssueTokenRequestTransferInner(BaseModel):
    """
    IssueTokenRequestTransferInner
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Address to send the amount of issued tokens to")
