...
class GetTxResponse(BaseModel):
    ...
    fees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total NEBL used in fees for this transaction")
    locktime: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Transaction locktime")
    size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Transcation size in bytes")
    ...
    value_in: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total NEBL input in this transaction", alias="valueIn")
    value_out: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total NEBL output in this transaction", alias="valueOut")
    version: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Transaction version")
    vin: Optional[List[GetTxResponseVinInner]] = Field(default=None, description="Array of transaction inputs")
    vout: Optional[List[GetTxResponseVoutInner]] = Field(default=None, description="Array of transaction outputs")
    __properties: ClassVar[List[str]] = ["blockhash", "blockheight", "blocktime", "confirmations", "fee", "fees", "locktime", "size", "time", "totalsent", "txid", "valueIn", "valueOut", "version", "vin", "vout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "txid": obj.get("txid"),
            "valueIn": obj.get("valueIn"),
            "valueOut": obj.get("valueOut"),
            "version": obj.get("version"),
            "vin": [GetTxResponseVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [GetTxResponseVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None
        })
        return _obj
