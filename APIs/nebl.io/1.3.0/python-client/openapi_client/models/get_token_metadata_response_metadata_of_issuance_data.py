...
class GetTokenMetadataResponseMetadataOfIssuanceData(BaseModel):
    """
    GetTokenMetadataResponseMetadataOfIssuanceData
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Token description")
    issuer: Optional[StrictStr] = Field(default=None, description="Name of token issuer")
    token_name: Optional[StrictStr] = Field(default=None, description="Token symbol", alias="tokenName")
    user_data: Optional[GetTokenMetadataResponseMetadataOfIssuanceDataUserData] = Field(default=None, alias="userData")
    __properties: ClassVar[List[str]] = ["description", "issuer", "tokenName", "userData"]
