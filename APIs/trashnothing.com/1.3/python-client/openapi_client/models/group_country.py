...
class GroupCountry(BaseModel):
    ...
    """ # noqa: E501
    abbreviation: Optional[StrictStr] = Field(default=None, description="A 2 letter country code for the country (see https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 ). ")
