...
class GetAllPostsChanges200Response(BaseModel):
    """
    GetAllPostsChanges200Response
    """ # noqa: E501
    changes: Optional[List[GetAllPostsChanges200ResponseChangesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": [GetAllPostsChanges200ResponseChangesInner.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
