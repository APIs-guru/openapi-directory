...
class PostSearchResult(BaseModel):
    ...
    search_content: Optional[StrictStr] = Field(default=None, description="A snippet of the post content as HTML with the parts of the content that matched the search query (if any) wrapped in an HTML span tags with the class 'highlight' (eg. &lt;span class=\"highlight\"&gt;matched words&lt;/span&gt;). May be null if none of the words in the post content matched the search query. <br /><br /> NOTE: This is not the full content of the post  It is just a snippet of around 200 characters that can be used to display the parts of the post content relevant to the search query. ")
    search_title: Optional[StrictStr] = Field(default=None, description="The post subject as HTML with the parts of the subject that matched the search query (if any) wrapped in HTML span tags with the class 'highlight'. (eg. &lt;span class=\"highlight\"&gt;matched words&lt;/span&gt;). May be null if none of the words in the subject matched the search query. ")
    __properties: ClassVar[List[str]] = ["content", "date", "expiration", "footer", "group_id", "latitude", "longitude", "outcome", "photos", "post_id", "repost_count", "reselling", "source", "title", "type", "url", "user_id", "search_content", "search_title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "search_content": obj.get("search_content"),
            "search_title": obj.get("search_title")
        })
        return _obj
