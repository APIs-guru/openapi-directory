...
class GetPosts200Response(BaseModel):
    """
    GetPosts200Response
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["end_index", "group_ids", "last_listings_view", "num_pages", "num_posts", "page", "per_page", "posts", "start_index"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_listings_view": obj.get("last_listings_view"),
