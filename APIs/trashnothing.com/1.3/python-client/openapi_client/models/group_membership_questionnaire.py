...
class GroupMembershipQuestionnaire(BaseModel):
    """
    Membership questionnaire data.  Will be null unless the membership status is pending-questions.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="A message from the group moderators to be displayed above the questions (may be null).")
    questions: Optional[List[StrictStr]] = Field(default=None, description="The list of questions.")
    __properties: ClassVar[List[str]] = ["message", "questions"]
