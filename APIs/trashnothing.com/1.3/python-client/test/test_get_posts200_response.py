...
class TestGetPosts200Response(unittest.TestCase):
    """GetPosts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPosts200Response:
        """Test GetPosts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPosts200Response`
        """
        model = GetPosts200Response()
        if include_optional:
            return GetPosts200Response(
                ...
                last_listings_view = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                num_pages = 56,
                num_posts = 56,
                page = 56,
                per_page = 56,
    ...
    def testGetPosts200Response(self):
        """Test GetPosts200Response"""
