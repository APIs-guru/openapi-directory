...
class TestGroupCountry(unittest.TestCase):
    """GroupCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCountry:
        """Test GroupCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCountry`
        """
        model = GroupCountry()
        if include_optional:
            return GroupCountry(
