...
class TestGroupRegion(unittest.TestCase):
    """GroupRegion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupRegion:
        """Test GroupRegion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupRegion`
        """
        model = GroupRegion()
        if include_optional:
            return GroupRegion(
