...
class SubmissionBatchData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "submissions", "template_id", "test"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submissions": [SubmissionDataBatchRequest.from_dict(_item) for _item in obj["submissions"]] if obj.get("submissions") is not None else None,
