...
class UpdateDataRequestResponse(BaseModel):
    """
    ...
    status: StrictStr
    __properties: ClassVar[List[str]] = ["data_request", "errors", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.data_request:
            _dict['data_request'] = self.data_request.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data_request": SubmissionDataRequest.from_dict(obj["data_request"]) if obj.get("data_request") is not None else None,
