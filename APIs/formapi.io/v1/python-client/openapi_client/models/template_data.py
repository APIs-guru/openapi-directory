...
class TemplateData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allow_additional_properties", "description", "editable_submissions", "expiration_interval", "expire_after", "expire_submissions", "footer_html", "header_html", "html", "name", "public_submissions", "public_web_form", "redirect_url", "scss", "slack_webhook_url", "webhook_url"]
