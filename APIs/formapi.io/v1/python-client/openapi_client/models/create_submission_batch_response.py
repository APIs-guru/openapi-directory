...
class CreateSubmissionBatchResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["error", "errors", "status", "submission_batch", "submissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submissions": [CreateSubmissionBatchSubmissionsResponse.from_dict(_item) for _item in obj["submissions"]] if obj.get("submissions") is not None else None
        })
        return _obj
