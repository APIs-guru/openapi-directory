...
class CreateSubmissionDataRequestTokenResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["errors", "status", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": CreateSubmissionDataRequestTokenResponseToken.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
