...
class CreateSubmissionDataRequestTokenResponseToken(BaseModel):
    """
    CreateSubmissionDataRequestTokenResponseToken
    """ # noqa: E501
    data_request_url: StrictStr
    expires_at: StrictStr
    id: StrictStr
    secret: StrictStr
    __properties: ClassVar[List[str]] = ["data_request_url", "expires_at", "id", "secret"]
