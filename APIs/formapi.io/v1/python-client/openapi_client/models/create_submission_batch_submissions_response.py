...
class CreateSubmissionBatchSubmissionsResponse(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['success', 'error', 'valid_but_not_saved']):
            raise ValueError("must be one of enum values ('success', 'error', 'valid_but_not_saved')")
        return value
