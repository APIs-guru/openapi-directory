...
class AddFieldsTemplateResponse(BaseModel):
    """
    AddFieldsTemplateResponse
    """ # noqa: E501
    errors: Optional[List[StrictStr]] = None
    new_field_ids: Optional[List[StrictInt]] = None
    status: StrictStr
    __properties: ClassVar[List[str]] = ["errors", "new_field_ids", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "new_field_ids": obj.get("new_field_ids"),
