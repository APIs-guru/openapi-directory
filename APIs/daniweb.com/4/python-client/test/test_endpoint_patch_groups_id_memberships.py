...
class TestEndpointPatchGroupsIDMemberships(unittest.TestCase):
    """EndpointPatchGroupsIDMemberships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchGroupsIDMemberships:
        """Test EndpointPatchGroupsIDMemberships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchGroupsIDMemberships`
        """
        model = EndpointPatchGroupsIDMemberships()
        if include_optional:
            return EndpointPatchGroupsIDMemberships(
                data = [
                    openapi_client.models.endpoint_patch_groups_id_memberships_data_inner.Endpoint_patch_groups_ID_memberships_data_inner(
    ...
    def testEndpointPatchGroupsIDMemberships(self):
        """Test EndpointPatchGroupsIDMemberships"""
