...
class TestEndpointGetMessagesID(unittest.TestCase):
    """EndpointGetMessagesID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetMessagesID:
        """Test EndpointGetMessagesID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetMessagesID`
        """
        model = EndpointGetMessagesID()
        if include_optional:
    ...
    def testEndpointGetMessagesID(self):
        """Test EndpointGetMessagesID"""
