...
class TestEndpointGetUsersID(unittest.TestCase):
    """EndpointGetUsersID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersID:
        """Test EndpointGetUsersID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersID`
        """
        model = EndpointGetUsersID()
        if include_optional:
    ...
    def testEndpointGetUsersID(self):
        """Test EndpointGetUsersID"""
