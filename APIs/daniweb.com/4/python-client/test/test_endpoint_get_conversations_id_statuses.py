...
class TestEndpointGetConversationsIDStatuses(unittest.TestCase):
    """EndpointGetConversationsIDStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetConversationsIDStatuses:
        """Test EndpointGetConversationsIDStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetConversationsIDStatuses`
        """
        model = EndpointGetConversationsIDStatuses()
        if include_optional:
    ...
    def testEndpointGetConversationsIDStatuses(self):
        """Test EndpointGetConversationsIDStatuses"""
