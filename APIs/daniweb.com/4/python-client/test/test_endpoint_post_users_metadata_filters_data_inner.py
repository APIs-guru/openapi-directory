...
class TestEndpointPostUsersMetadataFiltersDataInner(unittest.TestCase):
    """EndpointPostUsersMetadataFiltersDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersMetadataFiltersDataInner:
        """Test EndpointPostUsersMetadataFiltersDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersMetadataFiltersDataInner`
        """
        model = EndpointPostUsersMetadataFiltersDataInner()
        if include_optional:
            return EndpointPostUsersMetadataFiltersDataInner(
                matched_metadata = {
                    'key' : [
                        ''
                        ]
    ...
    def testEndpointPostUsersMetadataFiltersDataInner(self):
        """Test EndpointPostUsersMetadataFiltersDataInner"""
