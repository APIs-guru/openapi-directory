...
class TestEndpointPatchConversationsIDStatuses(unittest.TestCase):
    """EndpointPatchConversationsIDStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchConversationsIDStatuses:
        """Test EndpointPatchConversationsIDStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchConversationsIDStatuses`
        """
        model = EndpointPatchConversationsIDStatuses()
        if include_optional:
            return EndpointPatchConversationsIDStatuses(
                data = openapi_client.models.endpoint_patch_conversations_id_statuses_data.Endpoint_patch_conversations_ID_statuses_data(
    ...
    def testEndpointPatchConversationsIDStatuses(self):
        """Test EndpointPatchConversationsIDStatuses"""
