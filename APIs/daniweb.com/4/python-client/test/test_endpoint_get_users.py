...
class TestEndpointGetUsers(unittest.TestCase):
    """EndpointGetUsers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsers:
        """Test EndpointGetUsers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsers`
        """
        model = EndpointGetUsers()
        if include_optional:
