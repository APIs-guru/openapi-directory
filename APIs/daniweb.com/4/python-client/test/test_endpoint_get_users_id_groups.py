...
class TestEndpointGetUsersIDGroups(unittest.TestCase):
    """EndpointGetUsersIDGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersIDGroups:
        """Test EndpointGetUsersIDGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersIDGroups`
        """
        model = EndpointGetUsersIDGroups()
        if include_optional:
    ...
    def testEndpointGetUsersIDGroups(self):
        """Test EndpointGetUsersIDGroups"""
