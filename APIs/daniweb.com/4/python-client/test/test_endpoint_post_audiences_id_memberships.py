...
class TestEndpointPostAudiencesIDMemberships(unittest.TestCase):
    """EndpointPostAudiencesIDMemberships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostAudiencesIDMemberships:
        """Test EndpointPostAudiencesIDMemberships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostAudiencesIDMemberships`
        """
        model = EndpointPostAudiencesIDMemberships()
        if include_optional:
            return EndpointPostAudiencesIDMemberships(
                data = openapi_client.models.endpoint_post_audiences_id_memberships_data.Endpoint_post_audiences_ID_memberships_data(
                    audience = openapi_client.models.endpoint_post_audiences_id_memberships_data_audience.Endpoint_post_audiences_ID_memberships_data_audience(
                        id = 1.337, ), 
    ...
    def testEndpointPostAudiencesIDMemberships(self):
        """Test EndpointPostAudiencesIDMemberships"""
