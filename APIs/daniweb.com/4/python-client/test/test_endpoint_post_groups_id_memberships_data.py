...
class TestEndpointPostGroupsIDMembershipsData(unittest.TestCase):
    """EndpointPostGroupsIDMembershipsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsIDMembershipsData:
        """Test EndpointPostGroupsIDMembershipsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsIDMembershipsData`
        """
        model = EndpointPostGroupsIDMembershipsData()
        if include_optional:
            return EndpointPostGroupsIDMembershipsData(
    ...
    def testEndpointPostGroupsIDMembershipsData(self):
        """Test EndpointPostGroupsIDMembershipsData"""
