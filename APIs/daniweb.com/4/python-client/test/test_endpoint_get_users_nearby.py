...
class TestEndpointGetUsersNearby(unittest.TestCase):
    """EndpointGetUsersNearby unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersNearby:
        """Test EndpointGetUsersNearby
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersNearby`
        """
        model = EndpointGetUsersNearby()
        if include_optional:
            return EndpointGetUsersNearby(
                data = [
                    openapi_client.models.endpoint_get_users_nearby_data_inner.Endpoint_get_users_nearby_data_inner(
    ...
    def testEndpointGetUsersNearby(self):
        """Test EndpointGetUsersNearby"""
