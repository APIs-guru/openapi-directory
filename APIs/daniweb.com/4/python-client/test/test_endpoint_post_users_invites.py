...
class TestEndpointPostUsersInvites(unittest.TestCase):
    """EndpointPostUsersInvites unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersInvites:
        """Test EndpointPostUsersInvites
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersInvites`
        """
        model = EndpointPostUsersInvites()
        if include_optional:
            return EndpointPostUsersInvites(
                data = openapi_client.models.endpoint_post_users_invites_data.Endpoint_post_users_invites_data(
                    discovered = openapi_client.models.endpoint_post_users_invites_data_discovered.Endpoint_post_users_invites_data_discovered(
                        users = [
                    ...
                    emailed = openapi_client.models.endpoint_post_users_invites_data_emailed.Endpoint_post_users_invites_data_emailed(
                        emails = [
                            ''
                            ], ), 
                    existing = openapi_client.models.endpoint_post_users_invites_data_existing.Endpoint_post_users_invites_data_existing(
                        conversations = [
                            openapi_client.models.user.User(
                                id = 1.337, )
                            ], ), 
                    invalid = openapi_client.models.endpoint_post_users_invites_data_emailed.Endpoint_post_users_invites_data_emailed(), ),
                success = True
            )
        else:
            return EndpointPostUsersInvites(
    ...
    def testEndpointPostUsersInvites(self):
        """Test EndpointPostUsersInvites"""
