...
class TestEndpointGetUsersIDGroupsMessages(unittest.TestCase):
    """EndpointGetUsersIDGroupsMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersIDGroupsMessages:
        """Test EndpointGetUsersIDGroupsMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersIDGroupsMessages`
        """
        model = EndpointGetUsersIDGroupsMessages()
        if include_optional:
    ...
    def testEndpointGetUsersIDGroupsMessages(self):
        """Test EndpointGetUsersIDGroupsMessages"""
