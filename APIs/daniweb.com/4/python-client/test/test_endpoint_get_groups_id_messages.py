...
class TestEndpointGetGroupsIDMessages(unittest.TestCase):
    """EndpointGetGroupsIDMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsIDMessages:
        """Test EndpointGetGroupsIDMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsIDMessages`
        """
        model = EndpointGetGroupsIDMessages()
        if include_optional:
    ...
    def testEndpointGetGroupsIDMessages(self):
        """Test EndpointGetGroupsIDMessages"""
