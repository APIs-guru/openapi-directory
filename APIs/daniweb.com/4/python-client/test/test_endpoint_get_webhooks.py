...
class TestEndpointGetWebhooks(unittest.TestCase):
    """EndpointGetWebhooks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetWebhooks:
        """Test EndpointGetWebhooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetWebhooks`
        """
        model = EndpointGetWebhooks()
        if include_optional:
                    ...
                    openapi_client.models.webhook.Webhook(
                        app = openapi_client.models.app.App(
                            ...
                            legal = openapi_client.models.app_legal.App_legal(
                                privacy_url = '', 
                                tos_url = '', ), ), 
                        event = openapi_client.models.webhook_event.Webhook_event(
                            action = '', ), 
                        id = 1.337, 
                        name = '', 
                        object = openapi_client.models.webhook_object.Webhook_object(
                            id = 1.337, 
                            type = '', ), 
                        uri = '', 
    ...
    def testEndpointGetWebhooks(self):
        """Test EndpointGetWebhooks"""
