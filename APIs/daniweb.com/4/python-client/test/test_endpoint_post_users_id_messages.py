...
class TestEndpointPostUsersIDMessages(unittest.TestCase):
    """EndpointPostUsersIDMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersIDMessages:
        """Test EndpointPostUsersIDMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersIDMessages`
        """
        model = EndpointPostUsersIDMessages()
        if include_optional:
    ...
    def testEndpointPostUsersIDMessages(self):
        """Test EndpointPostUsersIDMessages"""
