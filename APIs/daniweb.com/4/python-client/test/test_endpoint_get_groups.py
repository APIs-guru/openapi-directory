...
class TestEndpointGetGroups(unittest.TestCase):
    """EndpointGetGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroups:
        """Test EndpointGetGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroups`
        """
        model = EndpointGetGroups()
        if include_optional:
    ...
    def testEndpointGetGroups(self):
        """Test EndpointGetGroups"""
