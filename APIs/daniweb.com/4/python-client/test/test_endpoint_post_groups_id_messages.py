...
class TestEndpointPostGroupsIDMessages(unittest.TestCase):
    """EndpointPostGroupsIDMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsIDMessages:
        """Test EndpointPostGroupsIDMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsIDMessages`
        """
        model = EndpointPostGroupsIDMessages()
        if include_optional:
            return EndpointPostGroupsIDMessages(
                data = [
                    openapi_client.models.group_message.Group_message(
    ...
    def testEndpointPostGroupsIDMessages(self):
        """Test EndpointPostGroupsIDMessages"""
