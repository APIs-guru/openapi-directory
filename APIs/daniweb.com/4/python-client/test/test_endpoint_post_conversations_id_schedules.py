...
class TestEndpointPostConversationsIDSchedules(unittest.TestCase):
    """EndpointPostConversationsIDSchedules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostConversationsIDSchedules:
        """Test EndpointPostConversationsIDSchedules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostConversationsIDSchedules`
        """
        model = EndpointPostConversationsIDSchedules()
        if include_optional:
            return EndpointPostConversationsIDSchedules(
                data = [
                    openapi_client.models.endpoint_post_conversations_id_schedules_data_inner.Endpoint_post_conversations_ID_schedules_data_inner(
                        author_count = 1.337, 
                        conversation_count = 1.337, 
                        conversation_id = 1.337, 
                        date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        first_message = openapi_client.models.message.Message(
    ...
    def testEndpointPostConversationsIDSchedules(self):
        """Test EndpointPostConversationsIDSchedules"""
