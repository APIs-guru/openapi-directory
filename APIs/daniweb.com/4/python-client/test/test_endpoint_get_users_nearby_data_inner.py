...
class TestEndpointGetUsersNearbyDataInner(unittest.TestCase):
    """EndpointGetUsersNearbyDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersNearbyDataInner:
        """Test EndpointGetUsersNearbyDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersNearbyDataInner`
        """
        model = EndpointGetUsersNearbyDataInner()
        if include_optional:
            return EndpointGetUsersNearbyDataInner(
    ...
    def testEndpointGetUsersNearbyDataInner(self):
        """Test EndpointGetUsersNearbyDataInner"""
