...
class TestEndpointPostGroupsMessagesMetadataFiltersDataInner(unittest.TestCase):
    """EndpointPostGroupsMessagesMetadataFiltersDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsMessagesMetadataFiltersDataInner:
        """Test EndpointPostGroupsMessagesMetadataFiltersDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsMessagesMetadataFiltersDataInner`
        """
        model = EndpointPostGroupsMessagesMetadataFiltersDataInner()
        if include_optional:
            return EndpointPostGroupsMessagesMetadataFiltersDataInner(
                matched_metadata = {
                    'key' : [
                        ''
                        ]
    ...
    def testEndpointPostGroupsMessagesMetadataFiltersDataInner(self):
        """Test EndpointPostGroupsMessagesMetadataFiltersDataInner"""
