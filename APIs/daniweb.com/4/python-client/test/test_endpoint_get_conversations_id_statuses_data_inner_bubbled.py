...
class TestEndpointGetConversationsIDStatusesDataInnerBubbled(unittest.TestCase):
    """EndpointGetConversationsIDStatusesDataInnerBubbled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetConversationsIDStatusesDataInnerBubbled:
        """Test EndpointGetConversationsIDStatusesDataInnerBubbled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetConversationsIDStatusesDataInnerBubbled`
        """
        model = EndpointGetConversationsIDStatusesDataInnerBubbled()
        if include_optional:
            return EndpointGetConversationsIDStatusesDataInnerBubbled(
    ...
    def testEndpointGetConversationsIDStatusesDataInnerBubbled(self):
        """Test EndpointGetConversationsIDStatusesDataInnerBubbled"""
