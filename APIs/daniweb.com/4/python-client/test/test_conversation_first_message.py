...
class TestConversationFirstMessage(unittest.TestCase):
    """ConversationFirstMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationFirstMessage:
        """Test ConversationFirstMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationFirstMessage`
        """
        model = ConversationFirstMessage()
        if include_optional:
    ...
    def testConversationFirstMessage(self):
        """Test ConversationFirstMessage"""
