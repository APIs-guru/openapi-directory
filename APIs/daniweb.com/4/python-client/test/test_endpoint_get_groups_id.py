...
class TestEndpointGetGroupsID(unittest.TestCase):
    """EndpointGetGroupsID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsID:
        """Test EndpointGetGroupsID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsID`
        """
        model = EndpointGetGroupsID()
        if include_optional:
    ...
    def testEndpointGetGroupsID(self):
        """Test EndpointGetGroupsID"""
