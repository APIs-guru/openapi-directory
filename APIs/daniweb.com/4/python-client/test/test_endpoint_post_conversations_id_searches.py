...
class TestEndpointPostConversationsIDSearches(unittest.TestCase):
    """EndpointPostConversationsIDSearches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostConversationsIDSearches:
        """Test EndpointPostConversationsIDSearches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostConversationsIDSearches`
        """
        model = EndpointPostConversationsIDSearches()
        if include_optional:
            return EndpointPostConversationsIDSearches(
                data = [
                    openapi_client.models.endpoint_post_conversations_id_searches_data_inner.Endpoint_post_conversations_ID_searches_data_inner(
                        message = openapi_client.models.message.Message(
                            ...
                            text = openapi_client.models.group_message_text.Group_message_text(
                                parsed = '', ), 
                            timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                        relevance = openapi_client.models.endpoint_post_conversations_id_searches_data_inner_relevance.Endpoint_post_conversations_ID_searches_data_inner_relevance(
                            score = 1.337, ), )
                    ],
    ...
    def testEndpointPostConversationsIDSearches(self):
        """Test EndpointPostConversationsIDSearches"""
