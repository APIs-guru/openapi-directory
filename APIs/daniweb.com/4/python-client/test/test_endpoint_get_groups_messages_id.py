...
class TestEndpointGetGroupsMessagesID(unittest.TestCase):
    """EndpointGetGroupsMessagesID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsMessagesID:
        """Test EndpointGetGroupsMessagesID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsMessagesID`
        """
        model = EndpointGetGroupsMessagesID()
        if include_optional:
    ...
    def testEndpointGetGroupsMessagesID(self):
        """Test EndpointGetGroupsMessagesID"""
