...
class TestEndpointPostMessagesMetadataFiltersDataInner(unittest.TestCase):
    """EndpointPostMessagesMetadataFiltersDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostMessagesMetadataFiltersDataInner:
        """Test EndpointPostMessagesMetadataFiltersDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostMessagesMetadataFiltersDataInner`
        """
        model = EndpointPostMessagesMetadataFiltersDataInner()
        if include_optional:
            return EndpointPostMessagesMetadataFiltersDataInner(
                matched_metadata = {
                    'key' : [
                        ''
                        ]
    ...
    def testEndpointPostMessagesMetadataFiltersDataInner(self):
        """Test EndpointPostMessagesMetadataFiltersDataInner"""
