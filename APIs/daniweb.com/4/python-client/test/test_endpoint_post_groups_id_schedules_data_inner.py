...
class TestEndpointPostGroupsIDSchedulesDataInner(unittest.TestCase):
    """EndpointPostGroupsIDSchedulesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsIDSchedulesDataInner:
        """Test EndpointPostGroupsIDSchedulesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsIDSchedulesDataInner`
        """
        model = EndpointPostGroupsIDSchedulesDataInner()
        if include_optional:
            return EndpointPostGroupsIDSchedulesDataInner(
                author_count = 1.337,
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                first_message = openapi_client.models.group_message.Group_message(
                ...
                group_count = 1.337,
                group_id = 1.337,
                last_message = openapi_client.models.group_message.Group_message(
                    author = openapi_client.models.user.User(
                        business_card = openapi_client.models.me_business_card.Me_business_card(
                            company_name = '', 
                            company_size = '', 
                    ...
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                message_count = 1.337,
                my_message_count = 1.337,
                navigation = openapi_client.models.endpoint_post_conversations_id_schedules_data_inner_navigation.Endpoint_post_conversations_ID_schedules_data_inner_navigation(
    ...
    def testEndpointPostGroupsIDSchedulesDataInner(self):
        """Test EndpointPostGroupsIDSchedulesDataInner"""
