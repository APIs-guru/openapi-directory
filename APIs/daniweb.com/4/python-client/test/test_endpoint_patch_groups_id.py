...
class TestEndpointPatchGroupsID(unittest.TestCase):
    """EndpointPatchGroupsID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchGroupsID:
        """Test EndpointPatchGroupsID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchGroupsID`
        """
        model = EndpointPatchGroupsID()
        if include_optional:
    ...
    def testEndpointPatchGroupsID(self):
        """Test EndpointPatchGroupsID"""
