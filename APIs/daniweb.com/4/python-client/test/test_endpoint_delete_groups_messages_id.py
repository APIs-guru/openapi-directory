...
class TestEndpointDeleteGroupsMessagesID(unittest.TestCase):
    """EndpointDeleteGroupsMessagesID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointDeleteGroupsMessagesID:
        """Test EndpointDeleteGroupsMessagesID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointDeleteGroupsMessagesID`
        """
        model = EndpointDeleteGroupsMessagesID()
        if include_optional:
    ...
    def testEndpointDeleteGroupsMessagesID(self):
        """Test EndpointDeleteGroupsMessagesID"""
