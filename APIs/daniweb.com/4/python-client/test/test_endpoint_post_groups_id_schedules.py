...
class TestEndpointPostGroupsIDSchedules(unittest.TestCase):
    """EndpointPostGroupsIDSchedules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsIDSchedules:
        """Test EndpointPostGroupsIDSchedules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsIDSchedules`
        """
        model = EndpointPostGroupsIDSchedules()
        if include_optional:
            return EndpointPostGroupsIDSchedules(
                data = [
                    openapi_client.models.endpoint_post_groups_id_schedules_data_inner.Endpoint_post_groups_ID_schedules_data_inner(
                        author_count = 1.337, 
    ...
    def testEndpointPostGroupsIDSchedules(self):
        """Test EndpointPostGroupsIDSchedules"""
