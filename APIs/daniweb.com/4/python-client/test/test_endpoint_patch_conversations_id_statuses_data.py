...
class TestEndpointPatchConversationsIDStatusesData(unittest.TestCase):
    """EndpointPatchConversationsIDStatusesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchConversationsIDStatusesData:
        """Test EndpointPatchConversationsIDStatusesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchConversationsIDStatusesData`
        """
        model = EndpointPatchConversationsIDStatusesData()
        if include_optional:
            return EndpointPatchConversationsIDStatusesData(
    ...
    def testEndpointPatchConversationsIDStatusesData(self):
        """Test EndpointPatchConversationsIDStatusesData"""
