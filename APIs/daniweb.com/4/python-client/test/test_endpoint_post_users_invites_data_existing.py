...
class TestEndpointPostUsersInvitesDataExisting(unittest.TestCase):
    """EndpointPostUsersInvitesDataExisting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersInvitesDataExisting:
        """Test EndpointPostUsersInvitesDataExisting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersInvitesDataExisting`
        """
        model = EndpointPostUsersInvitesDataExisting()
        if include_optional:
            return EndpointPostUsersInvitesDataExisting(
                conversations = [
    ...
    def testEndpointPostUsersInvitesDataExisting(self):
        """Test EndpointPostUsersInvitesDataExisting"""
