...
class TestEndpointPostAudiencesIDMembershipsData(unittest.TestCase):
    """EndpointPostAudiencesIDMembershipsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostAudiencesIDMembershipsData:
        """Test EndpointPostAudiencesIDMembershipsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostAudiencesIDMembershipsData`
        """
        model = EndpointPostAudiencesIDMembershipsData()
        if include_optional:
            return EndpointPostAudiencesIDMembershipsData(
    ...
    def testEndpointPostAudiencesIDMembershipsData(self):
        """Test EndpointPostAudiencesIDMembershipsData"""
