...
class TestEndpointPostGroupsMessagesMetadataFilters(unittest.TestCase):
    """EndpointPostGroupsMessagesMetadataFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsMessagesMetadataFilters:
        """Test EndpointPostGroupsMessagesMetadataFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsMessagesMetadataFilters`
        """
        model = EndpointPostGroupsMessagesMetadataFilters()
        if include_optional:
            return EndpointPostGroupsMessagesMetadataFilters(
                data = [
                    openapi_client.models.endpoint_post_groups_messages_metadata_filters_data_inner.Endpoint_post_groups_messages_metadata_filters_data_inner(
                        matched_metadata = {
                            'key' : [
                                ''
                                ]
    ...
    def testEndpointPostGroupsMessagesMetadataFilters(self):
        """Test EndpointPostGroupsMessagesMetadataFilters"""
