...
class TestEndpointGetMessagesIDMetadata(unittest.TestCase):
    """EndpointGetMessagesIDMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetMessagesIDMetadata:
        """Test EndpointGetMessagesIDMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetMessagesIDMetadata`
        """
        model = EndpointGetMessagesIDMetadata()
        if include_optional:
            return EndpointGetMessagesIDMetadata(
                data = [
                    openapi_client.models.message_data.Message_data(
    ...
    def testEndpointGetMessagesIDMetadata(self):
        """Test EndpointGetMessagesIDMetadata"""
