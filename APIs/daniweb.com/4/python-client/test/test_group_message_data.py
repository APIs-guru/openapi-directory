...
class TestGroupMessageData(unittest.TestCase):
    """GroupMessageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupMessageData:
        """Test GroupMessageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupMessageData`
        """
        model = GroupMessageData()
        if include_optional:
