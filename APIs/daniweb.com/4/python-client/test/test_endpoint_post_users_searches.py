...
class TestEndpointPostUsersSearches(unittest.TestCase):
    """EndpointPostUsersSearches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersSearches:
        """Test EndpointPostUsersSearches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersSearches`
        """
        model = EndpointPostUsersSearches()
        if include_optional:
            return EndpointPostUsersSearches(
                data = [
                    openapi_client.models.endpoint_post_users_searches_data_inner.Endpoint_post_users_searches_data_inner(
    ...
    def testEndpointPostUsersSearches(self):
        """Test EndpointPostUsersSearches"""
