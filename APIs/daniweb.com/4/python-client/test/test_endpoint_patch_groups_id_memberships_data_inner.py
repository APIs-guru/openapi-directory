...
class TestEndpointPatchGroupsIDMembershipsDataInner(unittest.TestCase):
    """EndpointPatchGroupsIDMembershipsDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchGroupsIDMembershipsDataInner:
        """Test EndpointPatchGroupsIDMembershipsDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchGroupsIDMembershipsDataInner`
        """
        model = EndpointPatchGroupsIDMembershipsDataInner()
        if include_optional:
            return EndpointPatchGroupsIDMembershipsDataInner(
                ...
                member = openapi_client.models.user.User(
                    ...
                    usage = openapi_client.models.me_usage.Me_usage(
                        ...
                        last_activity_timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        online_status = True, ), ),
                privileges = openapi_client.models.endpoint_patch_groups_id_memberships_data_inner_privileges.Endpoint_patch_groups_ID_memberships_data_inner_privileges(
                    moderator = True, )
            )
        else:
            return EndpointPatchGroupsIDMembershipsDataInner(
    ...
    def testEndpointPatchGroupsIDMembershipsDataInner(self):
        """Test EndpointPatchGroupsIDMembershipsDataInner"""
