...
class TestEndpointGetGroupsMessagesIDMetadata(unittest.TestCase):
    """EndpointGetGroupsMessagesIDMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsMessagesIDMetadata:
        """Test EndpointGetGroupsMessagesIDMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsMessagesIDMetadata`
        """
        model = EndpointGetGroupsMessagesIDMetadata()
        if include_optional:
            return EndpointGetGroupsMessagesIDMetadata(
                data = [
                    openapi_client.models.group_message_data.Group_message_data(
                        app = openapi_client.models.app.App(
                            ...
                            legal = openapi_client.models.app_legal.App_legal(
                                privacy_url = '', 
                                tos_url = '', ), ), 
                        content = openapi_client.models.group_message_data_content.Group_message_data_content(
                            key = '', 
                            value = '', ), 
                        id = 1.337, 
                        message = openapi_client.models.group_message.Group_message(
                            ...
                            timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                        owner = , 
                        settings = openapi_client.models.group_message_data_settings.Group_message_data_settings(
                            privacy = '', ), 
                        status = openapi_client.models.group_message_data_status.Group_message_data_status(
    ...
    def testEndpointGetGroupsMessagesIDMetadata(self):
        """Test EndpointGetGroupsMessagesIDMetadata"""
