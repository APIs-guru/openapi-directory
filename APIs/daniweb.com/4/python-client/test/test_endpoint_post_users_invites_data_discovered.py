...
class TestEndpointPostUsersInvitesDataDiscovered(unittest.TestCase):
    """EndpointPostUsersInvitesDataDiscovered unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersInvitesDataDiscovered:
        """Test EndpointPostUsersInvitesDataDiscovered
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersInvitesDataDiscovered`
        """
        model = EndpointPostUsersInvitesDataDiscovered()
        if include_optional:
            return EndpointPostUsersInvitesDataDiscovered(
                users = [
    ...
    def testEndpointPostUsersInvitesDataDiscovered(self):
        """Test EndpointPostUsersInvitesDataDiscovered"""
