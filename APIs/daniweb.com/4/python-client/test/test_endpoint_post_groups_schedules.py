...
class TestEndpointPostGroupsSchedules(unittest.TestCase):
    """EndpointPostGroupsSchedules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostGroupsSchedules:
        """Test EndpointPostGroupsSchedules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostGroupsSchedules`
        """
        model = EndpointPostGroupsSchedules()
        if include_optional:
    ...
    def testEndpointPostGroupsSchedules(self):
        """Test EndpointPostGroupsSchedules"""
