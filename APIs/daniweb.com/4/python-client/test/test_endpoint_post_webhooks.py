...
class TestEndpointPostWebhooks(unittest.TestCase):
    """EndpointPostWebhooks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostWebhooks:
        """Test EndpointPostWebhooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostWebhooks`
        """
        model = EndpointPostWebhooks()
        if include_optional:
    ...
    def testEndpointPostWebhooks(self):
        """Test EndpointPostWebhooks"""
