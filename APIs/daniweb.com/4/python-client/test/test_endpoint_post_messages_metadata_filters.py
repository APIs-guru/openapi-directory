...
class TestEndpointPostMessagesMetadataFilters(unittest.TestCase):
    """EndpointPostMessagesMetadataFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostMessagesMetadataFilters:
        """Test EndpointPostMessagesMetadataFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostMessagesMetadataFilters`
        """
        model = EndpointPostMessagesMetadataFilters()
        if include_optional:
            return EndpointPostMessagesMetadataFilters(
                data = [
                    openapi_client.models.endpoint_post_messages_metadata_filters_data_inner.Endpoint_post_messages_metadata_filters_data_inner(
                        matched_metadata = {
                            'key' : [
                                ''
                                ]
    ...
    def testEndpointPostMessagesMetadataFilters(self):
        """Test EndpointPostMessagesMetadataFilters"""
