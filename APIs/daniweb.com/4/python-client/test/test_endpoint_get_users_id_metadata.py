...
class TestEndpointGetUsersIDMetadata(unittest.TestCase):
    """EndpointGetUsersIDMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersIDMetadata:
        """Test EndpointGetUsersIDMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersIDMetadata`
        """
        model = EndpointGetUsersIDMetadata()
        if include_optional:
            return EndpointGetUsersIDMetadata(
                data = [
                    openapi_client.models.user_data.User_data(
    ...
    def testEndpointGetUsersIDMetadata(self):
        """Test EndpointGetUsersIDMetadata"""
