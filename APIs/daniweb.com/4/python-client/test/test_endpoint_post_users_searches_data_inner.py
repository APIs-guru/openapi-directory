...
class TestEndpointPostUsersSearchesDataInner(unittest.TestCase):
    """EndpointPostUsersSearchesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersSearchesDataInner:
        """Test EndpointPostUsersSearchesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersSearchesDataInner`
        """
        model = EndpointPostUsersSearchesDataInner()
        if include_optional:
            return EndpointPostUsersSearchesDataInner(
    ...
    def testEndpointPostUsersSearchesDataInner(self):
        """Test EndpointPostUsersSearchesDataInner"""
