...
class TestEndpointPostConversationsSearches(unittest.TestCase):
    """EndpointPostConversationsSearches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostConversationsSearches:
        """Test EndpointPostConversationsSearches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostConversationsSearches`
        """
        model = EndpointPostConversationsSearches()
        if include_optional:
    ...
    def testEndpointPostConversationsSearches(self):
        """Test EndpointPostConversationsSearches"""
