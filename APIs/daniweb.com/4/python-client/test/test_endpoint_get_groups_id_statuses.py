...
class TestEndpointGetGroupsIDStatuses(unittest.TestCase):
    """EndpointGetGroupsIDStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsIDStatuses:
        """Test EndpointGetGroupsIDStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsIDStatuses`
        """
        model = EndpointGetGroupsIDStatuses()
        if include_optional:
            return EndpointGetGroupsIDStatuses(
                data = [
                    openapi_client.models.endpoint_get_groups_id_statuses_data_inner.Endpoint_get_groups_ID_statuses_data_inner(
    ...
    def testEndpointGetGroupsIDStatuses(self):
        """Test EndpointGetGroupsIDStatuses"""
