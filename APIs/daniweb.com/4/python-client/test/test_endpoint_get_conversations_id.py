...
class TestEndpointGetConversationsID(unittest.TestCase):
    """EndpointGetConversationsID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetConversationsID:
        """Test EndpointGetConversationsID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetConversationsID`
        """
        model = EndpointGetConversationsID()
        if include_optional:
    ...
    def testEndpointGetConversationsID(self):
        """Test EndpointGetConversationsID"""
