...
class TestEndpointGetConversationsIDMessages(unittest.TestCase):
    """EndpointGetConversationsIDMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetConversationsIDMessages:
        """Test EndpointGetConversationsIDMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetConversationsIDMessages`
        """
        model = EndpointGetConversationsIDMessages()
        if include_optional:
    ...
    def testEndpointGetConversationsIDMessages(self):
        """Test EndpointGetConversationsIDMessages"""
