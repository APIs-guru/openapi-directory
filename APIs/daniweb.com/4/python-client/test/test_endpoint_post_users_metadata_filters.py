...
class TestEndpointPostUsersMetadataFilters(unittest.TestCase):
    """EndpointPostUsersMetadataFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersMetadataFilters:
        """Test EndpointPostUsersMetadataFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersMetadataFilters`
        """
        model = EndpointPostUsersMetadataFilters()
        if include_optional:
            return EndpointPostUsersMetadataFilters(
                data = [
                    openapi_client.models.endpoint_post_users_metadata_filters_data_inner.Endpoint_post_users_metadata_filters_data_inner(
                        matched_metadata = {
                            'key' : [
                                ''
                                ]
    ...
    def testEndpointPostUsersMetadataFilters(self):
        """Test EndpointPostUsersMetadataFilters"""
