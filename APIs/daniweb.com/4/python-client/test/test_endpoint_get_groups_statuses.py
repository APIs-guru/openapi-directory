...
class TestEndpointGetGroupsStatuses(unittest.TestCase):
    """EndpointGetGroupsStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetGroupsStatuses:
        """Test EndpointGetGroupsStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetGroupsStatuses`
        """
        model = EndpointGetGroupsStatuses()
        if include_optional:
            return EndpointGetGroupsStatuses(
                data = [
                    openapi_client.models.endpoint_get_groups_statuses_data_inner.Endpoint_get_groups_statuses_data_inner(
                        earliest_unseen_message = openapi_client.models.group_message.Group_message(
    ...
    def testEndpointGetGroupsStatuses(self):
        """Test EndpointGetGroupsStatuses"""
