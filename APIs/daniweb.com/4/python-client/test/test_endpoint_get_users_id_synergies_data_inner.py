...
class TestEndpointGetUsersIDSynergiesDataInner(unittest.TestCase):
    """EndpointGetUsersIDSynergiesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersIDSynergiesDataInner:
        """Test EndpointGetUsersIDSynergiesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersIDSynergiesDataInner`
        """
        model = EndpointGetUsersIDSynergiesDataInner()
        if include_optional:
            return EndpointGetUsersIDSynergiesDataInner(
    ...
    def testEndpointGetUsersIDSynergiesDataInner(self):
        """Test EndpointGetUsersIDSynergiesDataInner"""
