...
class TestEndpointPatchPositionsID(unittest.TestCase):
    """EndpointPatchPositionsID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPatchPositionsID:
        """Test EndpointPatchPositionsID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPatchPositionsID`
        """
        model = EndpointPatchPositionsID()
        if include_optional:
    ...
    def testEndpointPatchPositionsID(self):
        """Test EndpointPatchPositionsID"""
