...
class TestEndpointGetUsersIDPositions(unittest.TestCase):
    """EndpointGetUsersIDPositions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointGetUsersIDPositions:
        """Test EndpointGetUsersIDPositions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointGetUsersIDPositions`
        """
        model = EndpointGetUsersIDPositions()
        if include_optional:
    ...
    def testEndpointGetUsersIDPositions(self):
        """Test EndpointGetUsersIDPositions"""
