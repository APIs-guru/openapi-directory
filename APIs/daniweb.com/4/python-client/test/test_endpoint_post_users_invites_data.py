...
class TestEndpointPostUsersInvitesData(unittest.TestCase):
    """EndpointPostUsersInvitesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostUsersInvitesData:
        """Test EndpointPostUsersInvitesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostUsersInvitesData`
        """
        model = EndpointPostUsersInvitesData()
        if include_optional:
            return EndpointPostUsersInvitesData(
    ...
    def testEndpointPostUsersInvitesData(self):
        """Test EndpointPostUsersInvitesData"""
