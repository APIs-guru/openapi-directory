...
class TestEndpointPostConversationsIDMessages(unittest.TestCase):
    """EndpointPostConversationsIDMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostConversationsIDMessages:
        """Test EndpointPostConversationsIDMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostConversationsIDMessages`
        """
        model = EndpointPostConversationsIDMessages()
        if include_optional:
    ...
    def testEndpointPostConversationsIDMessages(self):
        """Test EndpointPostConversationsIDMessages"""
