...
class TestMeUsage(unittest.TestCase):
    """MeUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeUsage:
        """Test MeUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeUsage`
        """
        model = MeUsage()
        if include_optional:
            return MeUsage(
