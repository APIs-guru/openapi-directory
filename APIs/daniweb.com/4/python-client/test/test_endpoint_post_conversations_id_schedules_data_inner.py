...
class TestEndpointPostConversationsIDSchedulesDataInner(unittest.TestCase):
    """EndpointPostConversationsIDSchedulesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointPostConversationsIDSchedulesDataInner:
        """Test EndpointPostConversationsIDSchedulesDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointPostConversationsIDSchedulesDataInner`
        """
        model = EndpointPostConversationsIDSchedulesDataInner()
        if include_optional:
            return EndpointPostConversationsIDSchedulesDataInner(
                author_count = 1.337,
    ...
    def testEndpointPostConversationsIDSchedulesDataInner(self):
        """Test EndpointPostConversationsIDSchedulesDataInner"""
