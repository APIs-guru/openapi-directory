...
class EndpointPatchGroupsIDMemberships(BaseModel):
    """
    EndpointPatchGroupsIDMemberships
    """ # noqa: E501
    data: Optional[List[EndpointPatchGroupsIDMembershipsDataInner]] = None
    pagination: Optional[ApiPagination] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["data", "pagination", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EndpointPatchGroupsIDMembershipsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
