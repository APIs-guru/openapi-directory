...
class EndpointPostAudiencesIDMembershipsData(BaseModel):
    """
    EndpointPostAudiencesIDMembershipsData
    """ # noqa: E501
    audience: Optional[EndpointPostAudiencesIDMembershipsDataAudience] = None
    member: Optional[User] = None
    __properties: ClassVar[List[str]] = ["audience", "member"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audience": EndpointPostAudiencesIDMembershipsDataAudience.from_dict(obj["audience"]) if obj.get("audience") is not None else None,
