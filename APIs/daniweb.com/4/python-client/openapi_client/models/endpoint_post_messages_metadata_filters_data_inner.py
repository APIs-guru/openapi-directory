...
class EndpointPostMessagesMetadataFiltersDataInner(BaseModel):
    """
    EndpointPostMessagesMetadataFiltersDataInner
    """ # noqa: E501
    matched_metadata: Optional[Dict[str, List[StrictStr]]] = None
    message: Optional[Message] = None
    __properties: ClassVar[List[str]] = ["matched_metadata", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matched_metadata": obj.get("matched_metadata"),
