...
class MeLocation(BaseModel):
    """
    MeLocation
    """ # noqa: E501
    city: Optional[StrictStr] = None
    country: Optional[Union[StrictFloat, StrictInt]] = None
    ip_address: Optional[StrictStr] = None
    latitude: Optional[StrictStr] = None
    longitude: Optional[StrictStr] = None
    region: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["city", "country", "ip_address", "latitude", "longitude", "region"]
