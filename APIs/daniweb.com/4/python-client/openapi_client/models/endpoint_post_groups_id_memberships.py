...
class EndpointPostGroupsIDMemberships(BaseModel):
    """
    EndpointPostGroupsIDMemberships
    """ # noqa: E501
    data: Optional[EndpointPostGroupsIDMembershipsData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EndpointPostGroupsIDMembershipsData.from_dict(obj["data"]) if obj.get("data") is not None else None,
