...
class EndpointPatchGroupsIDMembershipsDataInner(BaseModel):
    """
    EndpointPatchGroupsIDMembershipsDataInner
    """ # noqa: E501
    group: Optional[Group] = None
    member: Optional[User] = None
    privileges: Optional[EndpointPatchGroupsIDMembershipsDataInnerPrivileges] = None
    __properties: ClassVar[List[str]] = ["group", "member", "privileges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privileges": EndpointPatchGroupsIDMembershipsDataInnerPrivileges.from_dict(obj["privileges"]) if obj.get("privileges") is not None else None
        })
        return _obj
