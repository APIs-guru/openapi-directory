...
class EndpointGetAutocompletes(BaseModel):
    """
    EndpointGetAutocompletes
    """ # noqa: E501
    data: Optional[EndpointGetAutocompletesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EndpointGetAutocompletesData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
