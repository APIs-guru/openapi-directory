...
class Position(BaseModel):
    ...
    organization: Optional[PositionOrganization] = None
    role: Optional[PositionRole] = None
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["app", "category", "id", "organization", "role", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "organization": PositionOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "role": PositionRole.from_dict(obj["role"]) if obj.get("role") is not None else None,
