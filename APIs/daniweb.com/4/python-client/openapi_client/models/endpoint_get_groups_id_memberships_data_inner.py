...
class EndpointGetGroupsIDMembershipsDataInner(BaseModel):
    """
    EndpointGetGroupsIDMembershipsDataInner
    """ # noqa: E501
    group: Optional[Group] = None
    member: Optional[User] = None
    privileges: Optional[EndpointGetGroupsIDMembershipsDataInnerPrivileges] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privileges": EndpointGetGroupsIDMembershipsDataInnerPrivileges.from_dict(obj["privileges"]) if obj.get("privileges") is not None else None
        })
        return _obj
