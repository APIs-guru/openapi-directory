...
class EndpointPostUsersInvites(BaseModel):
    """
    EndpointPostUsersInvites
    """ # noqa: E501
    data: Optional[EndpointPostUsersInvitesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EndpointPostUsersInvitesData.from_dict(obj["data"]) if obj.get("data") is not None else None,
