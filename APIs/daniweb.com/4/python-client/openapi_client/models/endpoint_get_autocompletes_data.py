...
class EndpointGetAutocompletesData(BaseModel):
    """
    EndpointGetAutocompletesData
    """ # noqa: E501
    conversations: Optional[List[StrictStr]] = None
    locations: Optional[List[StrictStr]] = None
    matches: Optional[List[StrictStr]] = None
    people: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["conversations", "locations", "matches", "people"]
