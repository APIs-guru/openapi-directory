...
class AutocompletesApi:
    ...
    def autocompletes_get(
        ...
        _param = self._autocompletes_get_serialize(
            query=query,
    ...
    @validate_call
    def autocompletes_get_with_http_info(
        self,
        query: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointGetAutocompletes]:
        """autocompletes_get
    ...
    @validate_call
    def autocompletes_get_without_preload_content(
        self,
        query: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _autocompletes_get_serialize(
        self,
        query,
        _request_auth,
        _content_type,
