...
class PositionsApi:
    ...
    def positions_id_delete(
        ...
        _param = self._positions_id_delete_serialize(
            id=id,
    ...
    @validate_call
    def positions_id_delete_with_http_info(
        self,
        id: Annotated[int, Field(strict=True, ge=1)],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointDeletePositionsID]:
        """positions_id_delete
    ...
    @validate_call
    def positions_id_delete_without_preload_content(
        self,
        id: Annotated[int, Field(strict=True, ge=1)],
        _request_timeout: Union[
            None,
    ...
    def _positions_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def positions_id_patch(
        ...
        organization_size: Optional[StrictStr] = None,
        ...
        _param = self._positions_id_patch_serialize(
            id=id,
            category=category,
    ...
    @validate_call
    def positions_id_patch_with_http_info(
        self,
        id: Annotated[int, Field(strict=True, ge=1)],
        category: StrictStr,
        organization: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointPatchPositionsID]:
        """positions_id_patch
    ...
    @validate_call
    def positions_id_patch_without_preload_content(
        self,
        id: Annotated[int, Field(strict=True, ge=1)],
        category: StrictStr,
        organization: StrictStr,
    ...
    def _positions_id_patch_serialize(
        self,
        id,
        category,
        organization,
        ...
        if organization_size is not None:
            _form_params.append(('organization_size', organization_size))
    ...
    def positions_post(
        ...
        _param = self._positions_post_serialize(
            category=category,
            organization=organization,
            role=role,
            start_date=start_date,
    ...
    @validate_call
    def positions_post_with_http_info(
        self,
        category: StrictStr,
        organization: StrictStr,
        role: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointPostPositions]:
        """positions_post
    ...
    @validate_call
    def positions_post_without_preload_content(
        self,
        category: StrictStr,
        organization: StrictStr,
        role: StrictStr,
