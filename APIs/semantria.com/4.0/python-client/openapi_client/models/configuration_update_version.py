...
class ConfigurationUpdateVersion(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auto_response", "callback", "categories_threshold", "chars_threshold", "collection", "config_id", "document", "entities_threshold", "is_primary", "language", "name", "one_sentence", "process_html"]
