...
class ConfigurationResponseVersion(BaseModel):
    """
    ...
    config_id: StrictStr = Field(description="Unique configuration identifier")
    document: ConfigurationDocumentSection
    entities_threshold: StrictInt = Field(description="Defines low threshold for evidence score of named and user entities to be reported in the output. Default: 55")
    from_template_config_id: StrictStr = Field(description="Unique identifier of configuration (template) the current configuration has been clonned from")
    ...
    __properties: ClassVar[List[str]] = ["auto_response", "callback", "categories_threshold", "chars_threshold", "collection", "config_id", "document", "entities_threshold", "from_template_config_id", "is_primary", "language", "modified", "name", "one_sentence", "process_html", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from_template_config_id": obj.get("from_template_config_id"),
