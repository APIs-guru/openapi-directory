...
class TestConfigurationResponseVersion(unittest.TestCase):
    """ConfigurationResponseVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationResponseVersion:
        """Test ConfigurationResponseVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationResponseVersion`
        """
        model = ConfigurationResponseVersion()
        if include_optional:
            return ConfigurationResponseVersion(
                auto_response = True,
                callback = '',
    ...
    def testConfigurationResponseVersion(self):
        """Test ConfigurationResponseVersion"""
