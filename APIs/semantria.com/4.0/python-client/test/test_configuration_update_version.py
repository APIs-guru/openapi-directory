...
class TestConfigurationUpdateVersion(unittest.TestCase):
    """ConfigurationUpdateVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationUpdateVersion:
        """Test ConfigurationUpdateVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationUpdateVersion`
        """
        model = ConfigurationUpdateVersion()
        if include_optional:
            return ConfigurationUpdateVersion(
                auto_response = True,
                callback = '',
    ...
    def testConfigurationUpdateVersion(self):
        """Test ConfigurationUpdateVersion"""
