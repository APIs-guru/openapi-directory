...
class CreateOrderBody(BaseModel):
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Any notes about this order. This field is always returned when reading the order back.")
    ...
    __properties: ClassVar[List[str]] = ["models", "notes", "shipping_address", "shipping_service"]
