...
class ShippingOptionsBody(BaseModel):
    """
    ShippingOptionsBody
    """ # noqa: E501
    models: Optional[List[ModelPrint]] = None
    shipping_address: Optional[ShippingAddress] = None
    __properties: ClassVar[List[str]] = ["models", "shipping_address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [ModelPrint.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
