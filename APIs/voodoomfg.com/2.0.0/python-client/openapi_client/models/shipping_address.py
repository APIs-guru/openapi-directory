...
class ShippingAddress(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Contact email address for the recipient.")
    ...
    street2: Optional[StrictStr] = Field(default=None, description="Second line of the street address (Apartment or Suite number, etc). Optional.")
    zip: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["city", "country", "email", "name", "state", "street1", "street2", "zip"]
