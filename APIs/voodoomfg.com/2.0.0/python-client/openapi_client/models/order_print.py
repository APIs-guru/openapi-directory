...
class OrderPrint(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="The number of prints requested for this model and material pair.")
    units: Optional[StrictStr] = Field(default=None, description="Units for the requested print. One of \"mm\", \"cm\", or \"in\".")
    __properties: ClassVar[List[str]] = ["material", "model", "quantity", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "material": Material.from_dict(obj["material"]) if obj.get("material") is not None else None,
