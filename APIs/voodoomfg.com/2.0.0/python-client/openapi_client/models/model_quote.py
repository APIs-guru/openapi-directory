...
class ModelQuote(BaseModel):
    ...
    """ # noqa: E501
    material_id: Optional[StrictInt] = Field(default=None, description="Requested material id.")
    model_id: Optional[StrictInt] = Field(default=None, description="Requested model id. Not present on the response from /model/quote_attrs.")
    options: Optional[ProductionOptionsCosts] = None
    quote: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost for printing the model in the requested quantity, before any additional services.")
    unit_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost of a single print of the specified model.")
    units: Optional[StrictStr] = Field(default=None, description="Units for the requested print. One of \"mm\", \"cm\", or \"in\".")
    __properties: ClassVar[List[str]] = ["material_id", "model_id", "options", "quote", "unit_cost", "units"]
