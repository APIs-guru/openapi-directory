...
class CreateModelBody(BaseModel):
    ...
    CreateModelBody
    """ # noqa: E501
    file_url: Optional[StrictStr] = Field(default=None, description="URL to download the model data from. The URL must end in .STL or .OBJ -- the extension of the final segment of the URL is used to determine how ot parse the file.")
