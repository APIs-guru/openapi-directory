...
class OrderCreatePost200Response(BaseModel):
    """
    ...
    quote_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for confirming this order. Use this value with /order/confirm place the order.")
    ...
    __properties: ClassVar[List[str]] = ["address", "delivery_date", "notes", "order_items", "quote", "quote_id", "shipping_service"]
