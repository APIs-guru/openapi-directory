...
class TestConfirmOrderBody(unittest.TestCase):
    """ConfirmOrderBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmOrderBody:
        """Test ConfirmOrderBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmOrderBody`
        """
        model = ConfirmOrderBody()
        if include_optional:
