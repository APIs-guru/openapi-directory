...
class TestShippingOptionsBody(unittest.TestCase):
    """ShippingOptionsBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingOptionsBody:
        """Test ShippingOptionsBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingOptionsBody`
        """
        model = ShippingOptionsBody()
        if include_optional:
            return ShippingOptionsBody(
                models = [
    ...
    def testShippingOptionsBody(self):
        """Test ShippingOptionsBody"""
