...
class TestOrderPrint(unittest.TestCase):
    """OrderPrint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderPrint:
        """Test OrderPrint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderPrint`
        """
        model = OrderPrint()
        if include_optional:
            return OrderPrint(
                material = openapi_client.models.material.Material(
                    color = '', 
                    color_sample = '', 
                    id = 56, 
                    type = '', ),
