...
class TestProductionOptionsCosts(unittest.TestCase):
    """ProductionOptionsCosts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductionOptionsCosts:
        """Test ProductionOptionsCosts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductionOptionsCosts`
        """
        model = ProductionOptionsCosts()
        if include_optional:
            return ProductionOptionsCosts(
                orientation = 1.337
            )
        else:
            return ProductionOptionsCosts(
    ...
    def testProductionOptionsCosts(self):
        """Test ProductionOptionsCosts"""
