...
class TestCreateModelBody(unittest.TestCase):
    """CreateModelBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateModelBody:
        """Test CreateModelBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateModelBody`
        """
        model = CreateModelBody()
        if include_optional:
            return CreateModelBody(
                file_url = ''
            )
        else:
            return CreateModelBody(
