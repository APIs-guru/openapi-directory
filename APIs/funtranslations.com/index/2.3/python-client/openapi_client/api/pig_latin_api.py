...
class PigLatinApi:
    ...
    def translate_piglatin_get(
        ...
        _param = self._translate_piglatin_get_serialize(
            text=text,
    ...
    @validate_call
    def translate_piglatin_get_with_http_info(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def translate_piglatin_get_without_preload_content(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    def _translate_piglatin_get_serialize(
        self,
        text,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/translate/piglatin',
