...
class MorseApi:
    ...
    @validate_call
    def translate_morse2english_get(
        self,
        ...
        _param = self._translate_morse2english_get_serialize(
            text=text,
    ...
    @validate_call
    def translate_morse2english_get_with_http_info(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def translate_morse2english_get_without_preload_content(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    def _translate_morse2english_get_serialize(
        self,
        text,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/translate/morse2english',
    ...
    @validate_call
    def translate_morse_audio_get(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        speed: Annotated[StrictInt, Field(description="Audio Speed (Words/Minute)")],
        tone: Annotated[StrictInt, Field(description="Audio Tone Frequency(Hz)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._translate_morse_audio_get_serialize(
            text=text,
            speed=speed,
            tone=tone,
            _request_auth=_request_auth,
    ...
    @validate_call
    def translate_morse_audio_get_with_http_info(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        speed: Annotated[StrictInt, Field(description="Audio Speed (Words/Minute)")],
        tone: Annotated[StrictInt, Field(description="Audio Tone Frequency(Hz)")],
    ...
    @validate_call
    def translate_morse_audio_get_without_preload_content(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        speed: Annotated[StrictInt, Field(description="Audio Speed (Words/Minute)")],
        tone: Annotated[StrictInt, Field(description="Audio Tone Frequency(Hz)")],
    ...
    def _translate_morse_audio_get_serialize(
        self,
        text,
        speed,
        tone,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/translate/morse/audio',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def translate_morse_get(
        ...
        _param = self._translate_morse_get_serialize(
            text=text,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def translate_morse_get_with_http_info(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def translate_morse_get_without_preload_content(
        self,
        text: Annotated[StrictStr, Field(description="Text to translate")],
        _request_timeout: Union[
            None,
    ...
    def _translate_morse_get_serialize(
        self,
        text,
        _request_auth,
        _content_type,
