...
class TestCharactersApi(unittest.TestCase):
    ...
    def test_translate_chef_get(self) -> None:
        """Test case for translate_chef_get

        """
        pass

    def test_translate_dolan_get(self) -> None:
        """Test case for translate_dolan_get

        """
        pass

    def test_translate_ferblatin_get(self) -> None:
        """Test case for translate_ferblatin_get

        """
        pass

    def test_translate_fudd_get(self) -> None:
        """Test case for translate_fudd_get

        """
        pass

    def test_translate_minion_get(self) -> None:
        """Test case for translate_minion_get

        """
        pass

    def test_translate_pirate_get(self) -> None:
