...
class TestMorseApi(unittest.TestCase):
    """MorseApi unit test stubs"""
    ...
    def test_translate_morse2english_get(self) -> None:
        """Test case for translate_morse2english_get

        """
        pass

    def test_translate_morse_audio_get(self) -> None:
        """Test case for translate_morse_audio_get

        """
        pass

    def test_translate_morse_get(self) -> None:
