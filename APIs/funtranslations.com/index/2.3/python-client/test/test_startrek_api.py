...
class TestStartrekApi(unittest.TestCase):
    """StartrekApi unit test stubs"""

    def setUp(self) -> None:
        self.api = StartrekApi()

    def tearDown(self) -> None:
        pass

    def test_translate_klingon_get(self) -> None:
        """Test case for translate_klingon_get

        """
        pass

    def test_translate_vulcan_get(self) -> None:
