# openapi_client.InternetFADApi

All URIs are relative to *http://api.funtranslations.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**translate_ermahgerd_get**](InternetFADApi.md#translate_ermahgerd_get) | **GET** /translate/ermahgerd | 


# **translate_ermahgerd_get**
> translate_ermahgerd_get(text)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.InternetFADApi(api_client)
    text = 'text_example' # str | Text to translate

    try:
        api_instance.translate_ermahgerd_get(text)
    except Exception as e:
        print("Exception when calling InternetFADApi->translate_ermahgerd_get: %s\n" % e)
```
