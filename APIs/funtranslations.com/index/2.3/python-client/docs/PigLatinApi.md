# openapi_client.PigLatinApi

All URIs are relative to *http://api.funtranslations.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**translate_piglatin_get**](PigLatinApi.md#translate_piglatin_get) | **GET** /translate/piglatin | 


# **translate_piglatin_get**
> translate_piglatin_get(text)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PigLatinApi(api_client)
    text = 'text_example' # str | Text to translate

    try:
        api_instance.translate_piglatin_get(text)
    except Exception as e:
        print("Exception when calling PigLatinApi->translate_piglatin_get: %s\n" % e)
```
