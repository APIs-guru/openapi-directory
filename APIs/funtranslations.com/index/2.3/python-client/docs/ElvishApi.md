# openapi_client.ElvishApi

All URIs are relative to *http://api.funtranslations.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**translate_quneya_get**](ElvishApi.md#translate_quneya_get) | **GET** /translate/quneya | 
[**translate_sindarin_get**](ElvishApi.md#translate_sindarin_get) | **GET** /translate/sindarin | 


# **translate_quneya_get**
> translate_quneya_get(text)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ElvishApi(api_client)
    text = 'text_example' # str | Text to translate

    try:
        api_instance.translate_quneya_get(text)
    except Exception as e:
        print("Exception when calling ElvishApi->translate_quneya_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.translate_sindarin_get(text)
    except Exception as e:
        print("Exception when calling ElvishApi->translate_sindarin_get: %s\n" % e)
```
