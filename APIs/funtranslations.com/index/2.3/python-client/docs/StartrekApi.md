# openapi_client.StartrekApi

All URIs are relative to *http://api.funtranslations.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**translate_klingon_get**](StartrekApi.md#translate_klingon_get) | **GET** /translate/klingon | 
[**translate_vulcan_get**](StartrekApi.md#translate_vulcan_get) | **GET** /translate/vulcan | 


# **translate_klingon_get**
> translate_klingon_get(text)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.StartrekApi(api_client)
    text = 'text_example' # str | Text to translate

    try:
        api_instance.translate_klingon_get(text)
    except Exception as e:
        print("Exception when calling StartrekApi->translate_klingon_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.translate_vulcan_get(text)
    except Exception as e:
        print("Exception when calling StartrekApi->translate_vulcan_get: %s\n" % e)
```
