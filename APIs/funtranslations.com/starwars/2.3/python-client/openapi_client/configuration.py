...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.funtranslations.com" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-Funtranslations-Api-Secret' in self.api_key:
            auth['X-Funtranslations-Api-Secret'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Funtranslations-Api-Secret',
