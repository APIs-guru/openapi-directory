...
class MessagesApi:
    ...
    def messages_fetch(
        ...
        message_id: Annotated[StrictStr, Field(description="ID of message to return")],
        ...
        :type account_id: str
        :param message_id: ID of message to return (required)
        :type message_id: str
        ...
        _param = self._messages_fetch_serialize(
    ...
    @validate_call
    def messages_fetch_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        message_id: Annotated[StrictStr, Field(description="ID of message to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def messages_fetch_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        message_id: Annotated[StrictStr, Field(description="ID of message to return")],
        _request_timeout: Union[
    ...
    def _messages_fetch_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/accounts/{accountId}/messages/{messageId}',
    ...
    def messages_fetch_all(
        ...
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact")] = None,
        conversation_id: Annotated[Optional[StrictStr], Field(description="ID of conversation")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._messages_fetch_all_serialize(
            account_id=account_id,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    def messages_fetch_all_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Results to skip when paginating through a result set")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    @validate_call
    def messages_fetch_all_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Results to skip when paginating through a result set")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    def _messages_fetch_all_serialize(
        self,
        account_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/accounts/{accountId}/messages',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def messages_send(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        send_messages_request: Optional[SendMessagesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
