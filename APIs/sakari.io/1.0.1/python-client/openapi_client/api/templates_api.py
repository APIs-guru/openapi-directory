...
class TemplatesApi:
    ...
    def _templates_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/accounts/{accountId}/templates',
    ...
    def templates_fetch(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        template_id: Annotated[StrictStr, Field(description="ID of template to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param account_id: Account to apply operations to (required)
        :type account_id: str
        :param template_id: ID of template to return (required)
        ...
        _param = self._templates_fetch_serialize(
            account_id=account_id,
    ...
    @validate_call
    def templates_fetch_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        template_id: Annotated[StrictStr, Field(description="ID of template to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def templates_fetch_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        template_id: Annotated[StrictStr, Field(description="ID of template to return")],
        _request_timeout: Union[
    ...
    def _templates_fetch_serialize(
        self,
        account_id,
        template_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/accounts/{accountId}/templates/{templateId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def templates_fetch_all(
        ...
        _param = self._templates_fetch_all_serialize(
            account_id=account_id,
            offset=offset,
            limit=limit,
            name=name,
    ...
    @validate_call
    def templates_fetch_all_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Results to skip when paginating through a result set")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    @validate_call
    def templates_fetch_all_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Results to skip when paginating through a result set")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    def _templates_fetch_all_serialize(
        self,
        account_id,
        offset,
        limit,
    ...
    def templates_remove(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        template_id: Annotated[StrictStr, Field(description="Template id to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param account_id: Account to apply operations to (required)
        :type account_id: str
        :param template_id: Template id to delete (required)
        :type template_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def templates_update(
        self,
        account_id: Annotated[StrictStr, Field(description="Account to apply operations to")],
        template_id: Annotated[StrictStr, Field(description="ID of template")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param account_id: Account to apply operations to (required)
        :type account_id: str
        :param template_id: ID of template (required)
        :type template_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
