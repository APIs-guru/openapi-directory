...
class WebhooksResponse(BaseModel):
    ...
    WebhooksResponse
    """ # noqa: E501
    error: Optional[PaginatedResponseError] = None
    pagination: Optional[PaginatedResponsePagination] = None
    success: Optional[StrictBool] = None
    data: Optional[List[Webhook]] = None
    __properties: ClassVar[List[str]] = ["error", "pagination", "success", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": PaginatedResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "pagination": PaginatedResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
