...
class CampaignRequest(BaseModel):
    ...
    CampaignRequest
    """ # noqa: E501
    filters: Optional[CampaignRequestFilters] = None
    template: Optional[StrictStr] = None
    trigger: Optional[CampaignRequestTrigger] = None
    __properties: ClassVar[List[str]] = ["filters", "template", "trigger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": CampaignRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "template": obj.get("template"),
            "trigger": CampaignRequestTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None
        })
        return _obj
