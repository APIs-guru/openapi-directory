...
class WebhooksSubscribeRequest(BaseModel):
    ...
    def event_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['contact-created', 'contact-updated', 'contact-removed', 'message-received', 'message-sent', 'message-status', 'conversation-started', 'contact-opt-out', 'contact-opt-in', 'list-opt-out', 'list-opt-in']):
                raise ValueError("each list item must be one of ('contact-created', 'contact-updated', 'contact-removed', 'message-received', 'message-sent', 'message-status', 'conversation-started', 'contact-opt-out', 'contact-opt-in', 'list-opt-out', 'list-opt-in')")
        return value
