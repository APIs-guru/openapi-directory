...
class ContactRequest(BaseModel):
    ...
    mobile: Optional[ContactIdentifiersMobile] = None
    attributes: Optional[Dict[str, Any]] = None
    tags: Optional[List[Tag]] = None
    __properties: ClassVar[List[str]] = ["email", "firstName", "id", "lastName", "mobile", "attributes", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mobile": ContactIdentifiersMobile.from_dict(obj["mobile"]) if obj.get("mobile") is not None else None,
