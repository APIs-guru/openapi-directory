...
class SendMessagesRequest(BaseModel):
    ...
    conversation_strategy: Optional[StrictStr] = Field(default=None, alias="conversationStrategy")
    conversations: Optional[List[StrictStr]] = Field(default=None, description="List of conversation ids to send messages to")
    filters: Optional[SendMessagesRequestFilters] = None
    media: Optional[List[SendMessagesRequestMediaInner]] = Field(default=None, description="List of media objects to attach to message")
    phone_number_filter: Optional[SendMessagesRequestPhoneNumberFilter] = Field(default=None, alias="phoneNumberFilter")
    template: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["contacts", "conversationStrategy", "conversations", "filters", "media", "phoneNumberFilter", "template", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.media:
            ...
            _dict['media'] = _items
        # override the default output from pydantic by calling `to_dict()` of phone_number_filter
        if self.phone_number_filter:
            _dict['phoneNumberFilter'] = self.phone_number_filter.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [ContactRequest.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None,
            "conversationStrategy": obj.get("conversationStrategy"),
            "conversations": obj.get("conversations"),
            "filters": SendMessagesRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "media": [SendMessagesRequestMediaInner.from_dict(_item) for _item in obj["media"]] if obj.get("media") is not None else None,
            "phoneNumberFilter": SendMessagesRequestPhoneNumberFilter.from_dict(obj["phoneNumberFilter"]) if obj.get("phoneNumberFilter") is not None else None,
