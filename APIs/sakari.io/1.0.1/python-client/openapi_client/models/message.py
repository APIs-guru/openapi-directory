...
class Message(BaseModel):
    ...
    media: Optional[List[MessageMediaInner]] = Field(default=None, description="List of media objects attached to message")
    ...
    __properties: ClassVar[List[str]] = ["contact", "conversation", "created", "error", "id", "media", "message", "outgoing", "phoneNumber", "price", "read", "segments", "status", "template", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversation": MessageConversation.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None,
            ...
            "id": obj.get("id"),
            "media": [MessageMediaInner.from_dict(_item) for _item in obj["media"]] if obj.get("media") is not None else None,
