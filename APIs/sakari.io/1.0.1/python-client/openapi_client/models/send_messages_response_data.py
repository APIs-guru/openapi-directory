...
class SendMessagesResponseData(BaseModel):
    """
    SendMessagesResponseData
    """ # noqa: E501
    estimated_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="estimatedPrice")
    invalid: Optional[List[Contact]] = None
    job_id: Optional[StrictStr] = Field(default=None, alias="jobId")
    messages: Optional[List[Message]] = None
    requested: Optional[StrictInt] = None
    valid: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["estimatedPrice", "invalid", "jobId", "messages", "requested", "valid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.invalid:
            for _item_invalid in self.invalid:
                if _item_invalid:
                    _items.append(_item_invalid.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "estimatedPrice": obj.get("estimatedPrice"),
            "invalid": [Contact.from_dict(_item) for _item in obj["invalid"]] if obj.get("invalid") is not None else None,
            "jobId": obj.get("jobId"),
