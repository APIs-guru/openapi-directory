...
class Webhook(BaseModel):
    ...
    def event_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['message-received', 'message-status', 'message-sent', 'conversation-closed', 'contact-created', 'contact-updated', 'contact-removed']):
                raise ValueError("each list item must be one of ('message-received', 'message-status', 'message-sent', 'conversation-closed', 'contact-created', 'contact-updated', 'contact-removed')")
        return value
