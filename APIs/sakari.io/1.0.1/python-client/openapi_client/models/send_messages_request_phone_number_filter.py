...
from openapi_client.models.message_conversation import MessageConversation
from typing import Optional, Set
from typing_extensions import Self

class SendMessagesRequestPhoneNumberFilter(BaseModel):
    """
    SendMessagesRequestPhoneNumberFilter
    """ # noqa: E501
    group: Optional[MessageConversation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": MessageConversation.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
