...
class ContactUploadResponseData(BaseModel):
    """
    ContactUploadResponseData
    """ # noqa: E501
    contacts: Optional[List[Contact]] = Field(default=None, description="Uploaded contacts")
    errors: Optional[List[Contact]] = Field(default=None, description="Contacts that failed validation")
    inserted: Optional[StrictInt] = None
    submitted: Optional[StrictInt] = None
    success: Optional[StrictInt] = None
    updated: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["contacts", "errors", "inserted", "submitted", "success", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [Contact.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
