...
class Conversation(BaseModel):
    ...
    unread: Optional[List[StrictStr]] = None
    updated: Optional[Updated] = None
    __properties: ClassVar[List[str]] = ["closed", "contact", "created", "id", "lastMessage", "phoneNumber", "unread", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ContactIdentifiers.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "created": Updated.from_dict(obj["created"]) if obj.get("created") is not None else None,
            "id": obj.get("id"),
            "lastMessage": Message.from_dict(obj["lastMessage"]) if obj.get("lastMessage") is not None else None,
