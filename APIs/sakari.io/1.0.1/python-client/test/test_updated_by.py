...
from openapi_client.models.updated_by import UpdatedBy

class TestUpdatedBy(unittest.TestCase):
    """UpdatedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedBy:
        """Test UpdatedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedBy`
        """
        model = UpdatedBy()
        if include_optional:
            return UpdatedBy(
