...
class TestContactUploadResponse(unittest.TestCase):
    """ContactUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUploadResponse:
        """Test ContactUploadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUploadResponse`
        """
        model = ContactUploadResponse()
        if include_optional:
    ...
    def testContactUploadResponse(self):
        """Test ContactUploadResponse"""
