...
class TestCampaignRequestTrigger(unittest.TestCase):
    """CampaignRequestTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignRequestTrigger:
        """Test CampaignRequestTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignRequestTrigger`
        """
        model = CampaignRequestTrigger()
        if include_optional:
    ...
    def testCampaignRequestTrigger(self):
        """Test CampaignRequestTrigger"""
