...
class TestSendMessagesRequestFilters(unittest.TestCase):
    """SendMessagesRequestFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessagesRequestFilters:
        """Test SendMessagesRequestFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessagesRequestFilters`
        """
        model = SendMessagesRequestFilters()
        if include_optional:
    ...
    def testSendMessagesRequestFilters(self):
        """Test SendMessagesRequestFilters"""
