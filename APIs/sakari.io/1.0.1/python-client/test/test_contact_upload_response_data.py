...
class TestContactUploadResponseData(unittest.TestCase):
    """ContactUploadResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUploadResponseData:
        """Test ContactUploadResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUploadResponseData`
        """
        model = ContactUploadResponseData()
        if include_optional:
    ...
    def testContactUploadResponseData(self):
        """Test ContactUploadResponseData"""
