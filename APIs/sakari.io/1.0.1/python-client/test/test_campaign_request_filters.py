...
class TestCampaignRequestFilters(unittest.TestCase):
    """CampaignRequestFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignRequestFilters:
        """Test CampaignRequestFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignRequestFilters`
        """
        model = CampaignRequestFilters()
        if include_optional:
    ...
    def testCampaignRequestFilters(self):
        """Test CampaignRequestFilters"""
