...
class TestSendMessagesRequestPhoneNumberFilter(unittest.TestCase):
    """SendMessagesRequestPhoneNumberFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessagesRequestPhoneNumberFilter:
        """Test SendMessagesRequestPhoneNumberFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessagesRequestPhoneNumberFilter`
        """
        model = SendMessagesRequestPhoneNumberFilter()
        if include_optional:
    ...
    def testSendMessagesRequestPhoneNumberFilter(self):
        """Test SendMessagesRequestPhoneNumberFilter"""
