...
class TestPaginatedResponseError(unittest.TestCase):
    """PaginatedResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseError:
        """Test PaginatedResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResponseError`
        """
        model = PaginatedResponseError()
        if include_optional:
            return PaginatedResponseError(
                code = '',
                message = ''
            )
        else:
    ...
    def testPaginatedResponseError(self):
        """Test PaginatedResponseError"""
