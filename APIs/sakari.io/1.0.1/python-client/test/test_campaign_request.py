    ...
    def make_instance(self, include_optional) -> CampaignRequest:
        ...
        if include_optional:
            return CampaignRequest(
                filters = openapi_client.models.campaign_request_filters.CampaignRequest_filters(
                    attributes = [
                        ''
                        ], 
                    contacts = [
                ...
                template = '',
                trigger = openapi_client.models.campaign_request_trigger.CampaignRequest_trigger(
                    code = 'M', )
            )
        else:
            return CampaignRequest(
