...
class TestSendMessagesResponseData(unittest.TestCase):
    """SendMessagesResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessagesResponseData:
        """Test SendMessagesResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessagesResponseData`
        """
        model = SendMessagesResponseData()
        if include_optional:
            return SendMessagesResponseData(
                estimated_price = 1.337,
                invalid = [
                    null
                    ],
                job_id = '',
    ...
    def testSendMessagesResponseData(self):
        """Test SendMessagesResponseData"""
