...
class TestShareFileResponseData(unittest.TestCase):
    """ShareFileResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareFileResponseData:
        """Test ShareFileResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareFileResponseData`
        """
        model = ShareFileResponseData()
        if include_optional:
    ...
    def testShareFileResponseData(self):
        """Test ShareFileResponseData"""
