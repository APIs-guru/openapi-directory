    ...
    def make_instance(self, include_optional) -> SendMessagesRequest:
        ...
        if include_optional:
            return SendMessagesRequest(
                ...
                filters = openapi_client.models.send_messages_request_filters.SendMessagesRequest_filters(
                    attributes = [
                        None
                        ], 
                    tags = [
                ...
                media = [
                    openapi_client.models.send_messages_request_media_inner.SendMessagesRequest_media_inner(
                        url = '', )
                    ],
                phone_number_filter = openapi_client.models.send_messages_request_phone_number_filter.SendMessagesRequest_phoneNumberFilter(
                    group = openapi_client.models.message_conversation.Message_conversation(
                        id = '', ), ),
                template = '',
                type = 'SMS'
            )
