...
class TestPaginatedResponsePagination(unittest.TestCase):
    """PaginatedResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponsePagination:
        """Test PaginatedResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResponsePagination`
        """
        model = PaginatedResponsePagination()
        if include_optional:
            return PaginatedResponsePagination(
                limit = 56,
                offset = 56,
                total_count = 56
            )
    ...
    def testPaginatedResponsePagination(self):
        """Test PaginatedResponsePagination"""
