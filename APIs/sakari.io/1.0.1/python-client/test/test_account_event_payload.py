...
class TestAccountEventPayload(unittest.TestCase):
    """AccountEventPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountEventPayload:
        """Test AccountEventPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountEventPayload`
        """
        model = AccountEventPayload()
        if include_optional:
            return AccountEventPayload(
                balance = 1.337
            )
        else:
            return AccountEventPayload(
    ...
    def testAccountEventPayload(self):
        """Test AccountEventPayload"""
