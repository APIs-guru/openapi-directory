...
class TestSendMessagesRequestMediaInner(unittest.TestCase):
    """SendMessagesRequestMediaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessagesRequestMediaInner:
        """Test SendMessagesRequestMediaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessagesRequestMediaInner`
        """
        model = SendMessagesRequestMediaInner()
        if include_optional:
            return SendMessagesRequestMediaInner(
                url = ''
            )
        else:
            return SendMessagesRequestMediaInner(
    ...
    def testSendMessagesRequestMediaInner(self):
        """Test SendMessagesRequestMediaInner"""
