...
class TestMessageMediaInner(unittest.TestCase):
    """MessageMediaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageMediaInner:
        """Test MessageMediaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageMediaInner`
        """
        model = MessageMediaInner()
        if include_optional:
            return MessageMediaInner(
                filename = '',
                type = '',
                url = ''
            )
    ...
    def testMessageMediaInner(self):
        """Test MessageMediaInner"""
