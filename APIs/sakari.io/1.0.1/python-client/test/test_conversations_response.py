...
class TestConversationsResponse(unittest.TestCase):
    """ConversationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationsResponse:
        """Test ConversationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationsResponse`
        """
        model = ConversationsResponse()
        if include_optional:
            return ConversationsResponse(
                ...
                data = [
                    openapi_client.models.conversation.Conversation(
                        closed = True, 
                        contact = openapi_client.models.contact_identifiers.ContactIdentifiers(
                            email = 'chris@sakari.io', 
                            first_name = 'Chris', 
                            id = '', 
                            last_name = 'Bloggs', 
                            mobile = openapi_client.models.contact_identifiers_mobile.ContactIdentifiers_mobile(
                                country = '', 
                                number = '123-456-7890', ), ), 
                        created = openapi_client.models.updated.Updated(
                            at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            by = openapi_client.models.updated_by.Updated_by(
                                first_name = 'Joe', 
                                id = '', 
                                last_name = 'Bloggs', ), ), 
                        id = '', 
                        last_message = openapi_client.models.message.Message(
                            conversation = openapi_client.models.message_conversation.Message_conversation(
                                id = '', ), 
                            ...
                            id = '', 
                            media = [
                                openapi_client.models.message_media_inner.Message_media_inner(
                                    filename = '', 
                                    type = '', 
                                    url = '', )
                                ], 
                            ...
                            status = '', 
                            template = '', 
                            updated = openapi_client.models.updated.Updated(
                                at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), ), 
    ...
    def testConversationsResponse(self):
        """Test ConversationsResponse"""
