...
class TestMessageConversation(unittest.TestCase):
    """MessageConversation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageConversation:
        """Test MessageConversation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageConversation`
        """
    ...
    def testMessageConversation(self):
        """Test MessageConversation"""
