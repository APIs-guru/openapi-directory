...
class TestMessageEventPayload(unittest.TestCase):
    """MessageEventPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageEventPayload:
        """Test MessageEventPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageEventPayload`
        """
    ...
    def testMessageEventPayload(self):
        """Test MessageEventPayload"""
