...
class TestContactIdentifiersMobile(unittest.TestCase):
    """ContactIdentifiersMobile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactIdentifiersMobile:
        """Test ContactIdentifiersMobile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactIdentifiersMobile`
        """
        model = ContactIdentifiersMobile()
        if include_optional:
    ...
    def testContactIdentifiersMobile(self):
        """Test ContactIdentifiersMobile"""
