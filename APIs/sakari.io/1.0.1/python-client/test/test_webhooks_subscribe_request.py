...
class TestWebhooksSubscribeRequest(unittest.TestCase):
    """WebhooksSubscribeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksSubscribeRequest:
        """Test WebhooksSubscribeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksSubscribeRequest`
        """
        model = WebhooksSubscribeRequest()
        if include_optional:
    ...
    def testWebhooksSubscribeRequest(self):
        """Test WebhooksSubscribeRequest"""
