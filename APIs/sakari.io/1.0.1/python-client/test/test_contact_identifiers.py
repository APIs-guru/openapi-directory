...
class TestContactIdentifiers(unittest.TestCase):
    """ContactIdentifiers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactIdentifiers:
        """Test ContactIdentifiers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactIdentifiers`
        """
        model = ContactIdentifiers()
        if include_optional:
    ...
    def testContactIdentifiers(self):
        """Test ContactIdentifiers"""
