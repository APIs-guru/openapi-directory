...
class TestPlayersApi(unittest.TestCase):
    ...
    def test_create_player_url(self) -> None:
    ...
    def test_delete_player_url(self) -> None:
    ...
    def test_list_player_urls(self) -> None:
    ...
    def test_request_player_rebuild(self) -> None:
    ...
    def test_show_player(self) -> None:
    ...
    def test_show_player_state(self) -> None:
    ...
    def test_show_player_url(self) -> None:
    ...
    def test_update_player_url(self) -> None:
