...
class TestPlayer3(unittest.TestCase):
    """Player3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Player3:
        """Test Player3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Player3`
        """
        model = Player3()
        if include_optional:
            return Player3(
