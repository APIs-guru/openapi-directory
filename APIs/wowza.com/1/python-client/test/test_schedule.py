    ...
    def make_instance(self, include_optional) -> Schedule:
        ...
        if include_optional:
            return Schedule(
                ...
                end_repeat = 'Thu Dec 14 19:00:00 EST 2017',
                id = '9w49LQ8L',
                name = 'Scheduled start for my camera',
                recurrence_data = 'monday,tuesday,wednesday,thursday,friday',
                recurrence_type = 'recur',
                start_repeat = 'Wed Nov 15 19:00:00 EST 2017',
                start_transcoder = '2017-11-16T00:00Z',
                state = 'enabled',
                stop_transcoder = '2017-12-15T23:59:59.999Z',
                transcoder_id = 'kZjkbPS3',
                transcoder_name = 'My Camera',
                updated_at = '2017-11-14T18:26:18.284Z'
            )
        else:
            return Schedule(
        )
