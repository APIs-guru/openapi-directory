...
class TestStreamTarget6(unittest.TestCase):
    """StreamTarget6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamTarget6:
        """Test StreamTarget6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamTarget6`
        """
        model = StreamTarget6()
        if include_optional:
            return StreamTarget6(
                ...
                source_url = 'ws://example.com/stream/stream1',
