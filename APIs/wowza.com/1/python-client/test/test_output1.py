...
class TestOutput1(unittest.TestCase):
    """Output1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Output1:
        """Test Output1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Output1`
        """
        model = Output1()
        if include_optional:
            return Output1(
