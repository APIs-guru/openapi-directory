...
class TestPlayerUpdateInput(unittest.TestCase):
    """PlayerUpdateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerUpdateInput:
        """Test PlayerUpdateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerUpdateInput`
        """
        model = PlayerUpdateInput()
        if include_optional:
            return PlayerUpdateInput(
                player = openapi_client.models.player.player(
                    countdown = True, 
                    countdown_at = '2017-11-16T20:00Z', 
                    hosted_page = True, 
    ...
    def testPlayerUpdateInput(self):
        """Test PlayerUpdateInput"""
