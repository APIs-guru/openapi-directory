...
class TestLimits1(unittest.TestCase):
    """Limits1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Limits1:
        """Test Limits1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Limits1`
        """
        model = Limits1()
        if include_optional:
            return Limits1(
