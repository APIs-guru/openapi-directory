...
class TestTranscoderCreateInput(unittest.TestCase):
    """TranscoderCreateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranscoderCreateInput:
        """Test TranscoderCreateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranscoderCreateInput`
        """
        model = TranscoderCreateInput()
        if include_optional:
    ...
    def testTranscoderCreateInput(self):
        """Test TranscoderCreateInput"""
