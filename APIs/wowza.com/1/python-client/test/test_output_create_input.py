...
class TestOutputCreateInput(unittest.TestCase):
    """OutputCreateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutputCreateInput:
        """Test OutputCreateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutputCreateInput`
        """
        model = OutputCreateInput()
        if include_optional:
    ...
    def testOutputCreateInput(self):
        """Test OutputCreateInput"""
