...
class TestLiveStreamsApi(unittest.TestCase):
    ...
    def test_regenerate_connection_code_live_stream(self) -> None:
    ...
    def test_reset_live_stream(self) -> None:
    ...
    def test_show_live_stream(self) -> None:
    ...
    def test_show_live_stream_state(self) -> None:
    ...
    def test_show_live_stream_stats(self) -> None:
    ...
    def test_show_live_stream_thumbnail_url(self) -> None:
    ...
    def test_start_live_stream(self) -> None:
    ...
    def test_stop_live_stream(self) -> None:
