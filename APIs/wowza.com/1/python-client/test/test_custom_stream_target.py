...
class TestCustomStreamTarget(unittest.TestCase):
    """CustomStreamTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomStreamTarget:
        """Test CustomStreamTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomStreamTarget`
        """
        model = CustomStreamTarget()
        if include_optional:
    ...
    def testCustomStreamTarget(self):
        """Test CustomStreamTarget"""
