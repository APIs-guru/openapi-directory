...
class TestTranscoder8(unittest.TestCase):
    """Transcoder8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transcoder8:
        """Test Transcoder8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transcoder8`
        """
        model = Transcoder8()
        if include_optional:
            return Transcoder8(
