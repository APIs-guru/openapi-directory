...
class TestTranscoder9(unittest.TestCase):
    """Transcoder9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Transcoder9:
        """Test Transcoder9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Transcoder9`
        """
        model = Transcoder9()
        if include_optional:
            return Transcoder9(
