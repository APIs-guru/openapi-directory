...
class TestStreamTargetCreateInput(unittest.TestCase):
    """StreamTargetCreateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamTargetCreateInput:
        """Test StreamTargetCreateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamTargetCreateInput`
        """
        model = StreamTargetCreateInput()
        if include_optional:
            return StreamTargetCreateInput(
    ...
    def testStreamTargetCreateInput(self):
        """Test StreamTargetCreateInput"""
