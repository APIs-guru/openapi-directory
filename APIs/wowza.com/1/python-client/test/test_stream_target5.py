...
class TestStreamTarget5(unittest.TestCase):
    """StreamTarget5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamTarget5:
        """Test StreamTarget5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamTarget5`
        """
        model = StreamTarget5()
        if include_optional:
            return StreamTarget5(
