...
class TestLiveStream7(unittest.TestCase):
    """LiveStream7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiveStream7:
        """Test LiveStream7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiveStream7`
        """
        model = LiveStream7()
        if include_optional:
            return LiveStream7(
