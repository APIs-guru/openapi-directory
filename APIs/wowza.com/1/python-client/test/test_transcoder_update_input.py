...
class TestTranscoderUpdateInput(unittest.TestCase):
    """TranscoderUpdateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranscoderUpdateInput:
        """Test TranscoderUpdateInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranscoderUpdateInput`
        """
        model = TranscoderUpdateInput()
        if include_optional:
            return TranscoderUpdateInput(
    ...
    def testTranscoderUpdateInput(self):
        """Test TranscoderUpdateInput"""
