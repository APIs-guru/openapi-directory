...
from openapi_client.api.stream_sources_api import StreamSourcesApi


class TestStreamSourcesApi(unittest.TestCase):
    """StreamSourcesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = StreamSourcesApi()

    def tearDown(self) -> None:
        pass

    def test_add_stream_source(self) -> None:
    ...
    def test_create_stream_source(self) -> None:
    ...
    def test_show_stream_source(self) -> None:
    ...
    def test_update_stream_source(self) -> None:
