...
class TestStreamSource1(unittest.TestCase):
    """StreamSource1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamSource1:
        """Test StreamSource1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamSource1`
        """
        model = StreamSource1()
        if include_optional:
