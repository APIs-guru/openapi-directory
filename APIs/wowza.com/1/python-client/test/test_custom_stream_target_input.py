...
class TestCustomStreamTargetInput(unittest.TestCase):
    """CustomStreamTargetInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomStreamTargetInput:
        """Test CustomStreamTargetInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomStreamTargetInput`
        """
        model = CustomStreamTargetInput()
        if include_optional:
            return CustomStreamTargetInput(
                stream_target = openapi_client.models.custom_stream_target.custom_stream_target(
    ...
    def testCustomStreamTargetInput(self):
        """Test CustomStreamTargetInput"""
