...
json = "{}"
# create an instance of KeyframeIntervalMetric from a JSON string
keyframe_interval_metric_instance = KeyframeIntervalMetric.from_json(json)
# print the JSON string representation of the object
print(KeyframeIntervalMetric.to_json())

# convert the object into a dict
keyframe_interval_metric_dict = keyframe_interval_metric_instance.to_dict()
# create an instance of KeyframeIntervalMetric from a dict
keyframe_interval_metric_from_dict = KeyframeIntervalMetric.from_dict(keyframe_interval_metric_dict)
```
