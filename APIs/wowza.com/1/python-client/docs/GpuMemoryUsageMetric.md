...
gpu_memory_usage_metric_instance = GpuMemoryUsageMetric.from_json(json)
# print the JSON string representation of the object
print(GpuMemoryUsageMetric.to_json())

# convert the object into a dict
gpu_memory_usage_metric_dict = gpu_memory_usage_metric_instance.to_dict()
# create an instance of GpuMemoryUsageMetric from a dict
gpu_memory_usage_metric_from_dict = GpuMemoryUsageMetric.from_dict(gpu_memory_usage_metric_dict)
```
