...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SpecsApi(api_client)

    try:
        # Fetch Swagger information
        api_response = api_instance.specs()
        print("The response of SpecsApi->specs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpecsApi->specs: %s\n" % e)
```
