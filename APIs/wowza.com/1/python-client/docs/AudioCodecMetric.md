...
json = "{}"
# create an instance of AudioCodecMetric from a JSON string
audio_codec_metric_instance = AudioCodecMetric.from_json(json)
# print the JSON string representation of the object
print(AudioCodecMetric.to_json())

# convert the object into a dict
audio_codec_metric_dict = audio_codec_metric_instance.to_dict()
# create an instance of AudioCodecMetric from a dict
audio_codec_metric_from_dict = AudioCodecMetric.from_dict(audio_codec_metric_dict)
```
