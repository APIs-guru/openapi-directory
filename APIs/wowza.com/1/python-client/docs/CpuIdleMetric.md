...
json = "{}"
# create an instance of CpuIdleMetric from a JSON string
cpu_idle_metric_instance = CpuIdleMetric.from_json(json)
# print the JSON string representation of the object
print(CpuIdleMetric.to_json())

# convert the object into a dict
cpu_idle_metric_dict = cpu_idle_metric_instance.to_dict()
# create an instance of CpuIdleMetric from a dict
cpu_idle_metric_from_dict = CpuIdleMetric.from_dict(cpu_idle_metric_dict)
```
