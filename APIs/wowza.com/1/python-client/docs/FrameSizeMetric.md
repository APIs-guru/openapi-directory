...
frame_size_metric_instance = FrameSizeMetric.from_json(json)
# print the JSON string representation of the object
print(FrameSizeMetric.to_json())

# convert the object into a dict
frame_size_metric_dict = frame_size_metric_instance.to_dict()
# create an instance of FrameSizeMetric from a dict
frame_size_metric_from_dict = FrameSizeMetric.from_dict(frame_size_metric_dict)
```
