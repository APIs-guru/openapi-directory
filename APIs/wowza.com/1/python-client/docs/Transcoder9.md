...
**remove_watermark_image** | **bool** | If &lt;strong&gt;true&lt;/strong&gt;, removes the watermark from the output. The default is &lt;strong&gt;false&lt;/strong&gt;. | [optional] 
...
transcoder9_instance = Transcoder9.from_json(json)
# print the JSON string representation of the object
print(Transcoder9.to_json())

# convert the object into a dict
transcoder9_dict = transcoder9_instance.to_dict()
# create an instance of Transcoder9 from a dict
transcoder9_from_dict = Transcoder9.from_dict(transcoder9_dict)
```
