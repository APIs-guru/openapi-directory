...
bytes_in_rate_metric_instance = BytesInRateMetric.from_json(json)
# print the JSON string representation of the object
print(BytesInRateMetric.to_json())

# convert the object into a dict
bytes_in_rate_metric_dict = bytes_in_rate_metric_instance.to_dict()
# create an instance of BytesInRateMetric from a dict
bytes_in_rate_metric_from_dict = BytesInRateMetric.from_dict(bytes_in_rate_metric_dict)
```
