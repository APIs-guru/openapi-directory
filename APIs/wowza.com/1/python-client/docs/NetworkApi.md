...
------------- | ------------- | -------------
[**usage_network_stream_sources_index**](NetworkApi.md#usage_network_stream_sources_index) | **GET** /usage/network/stream_sources | Fetch network usage for all stream sources
[**usage_network_stream_targets_index**](NetworkApi.md#usage_network_stream_targets_index) | **GET** /usage/network/stream_targets | Fetch network usage for all stream targets
[**usage_network_transcoders_index**](NetworkApi.md#usage_network_transcoders_index) | **GET** /usage/network/transcoders | Fetch network usage for all transcoders


# **usage_network_stream_sources_index**
> UsageNetworkStreamSources usage_network_stream_sources_index(var_from=var_from, to=to)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch network usage for all stream sources
        api_response = api_instance.usage_network_stream_sources_index(var_from=var_from, to=to)
        print("The response of NetworkApi->usage_network_stream_sources_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->usage_network_stream_sources_index: %s\n" % e)
```
...
# **usage_network_stream_targets_index**
> UsageNetworkStreamTargets usage_network_stream_targets_index(var_from=var_from, to=to)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch network usage for all stream targets
        api_response = api_instance.usage_network_stream_targets_index(var_from=var_from, to=to)
        print("The response of NetworkApi->usage_network_stream_targets_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->usage_network_stream_targets_index: %s\n" % e)
```
...
# **usage_network_transcoders_index**
> UsageNetworkTranscoders usage_network_transcoders_index(var_from=var_from, to=to, transcoder_type=transcoder_type, billing_mode=billing_mode)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch network usage for all transcoders
        api_response = api_instance.usage_network_transcoders_index(var_from=var_from, to=to, transcoder_type=transcoder_type, billing_mode=billing_mode)
        print("The response of NetworkApi->usage_network_transcoders_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->usage_network_transcoders_index: %s\n" % e)
```
