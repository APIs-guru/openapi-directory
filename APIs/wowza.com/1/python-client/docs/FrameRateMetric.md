...
json = "{}"
# create an instance of FrameRateMetric from a JSON string
frame_rate_metric_instance = FrameRateMetric.from_json(json)
# print the JSON string representation of the object
print(FrameRateMetric.to_json())

# convert the object into a dict
frame_rate_metric_dict = frame_rate_metric_instance.to_dict()
# create an instance of FrameRateMetric from a dict
frame_rate_metric_from_dict = FrameRateMetric.from_dict(frame_rate_metric_dict)
```
