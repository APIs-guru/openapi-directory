...
json = "{}"
# create an instance of GpuEncoderUsageMetric from a JSON string
gpu_encoder_usage_metric_instance = GpuEncoderUsageMetric.from_json(json)
# print the JSON string representation of the object
print(GpuEncoderUsageMetric.to_json())

# convert the object into a dict
gpu_encoder_usage_metric_dict = gpu_encoder_usage_metric_instance.to_dict()
# create an instance of GpuEncoderUsageMetric from a dict
gpu_encoder_usage_metric_from_dict = GpuEncoderUsageMetric.from_dict(gpu_encoder_usage_metric_dict)
```
