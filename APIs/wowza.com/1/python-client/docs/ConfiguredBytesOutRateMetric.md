...
json = "{}"
# create an instance of ConfiguredBytesOutRateMetric from a JSON string
configured_bytes_out_rate_metric_instance = ConfiguredBytesOutRateMetric.from_json(json)
# print the JSON string representation of the object
print(ConfiguredBytesOutRateMetric.to_json())

# convert the object into a dict
configured_bytes_out_rate_metric_dict = configured_bytes_out_rate_metric_instance.to_dict()
# create an instance of ConfiguredBytesOutRateMetric from a dict
configured_bytes_out_rate_metric_from_dict = ConfiguredBytesOutRateMetric.from_dict(configured_bytes_out_rate_metric_dict)
```
