...
------------ | ------------- | ------------- | -------------
**application_name** | **str** | The application name from the pull stream source URL. | [optional] 
**billing_mode** | **str** | The billing mode for the transcoder. The default is &lt;strong&gt;pay_as_you_go&lt;/strong&gt;. | [optional] 
**broadcast_location** | **str** | The location where Wowza Streaming Cloud transcodes your stream. Choose a location as close as possible to your video source. | [optional] 
...
**created_at** | **datetime** | The date and time that the transcoder was created. | [optional] 
...
**direct_playback_urls** | [**List[PlaybackUrl1]**](PlaybackUrl1.md) | An array of direct playback URLs the transcoder&#39;s delivery protocols. Each protocol has a URL for the source and a URL for each output rendition. | [optional] 
...
**domain_name** | **str** | The domain name from the pull stream source URL. | [optional] 
**id** | **str** | The unique alphanumeric string that identifies the transcoder. | [optional] 
...
**name** | **str** | A descriptive name for the transcoder. Maximum 200 characters. | [optional] 
...
**protocol** | **str** | The transport protocol for the source video. The default is &lt;strong&gt;rtmp&lt;/strong&gt;. | [optional] 
...
**source_port** | **int** | The port used for RTMP pull connections to Wowza Streaming Cloud. | [optional] 
...
**stream_name** | **str** | The stream name from the pull stream source URL. | [optional] 
...
**updated_at** | **datetime** | The date and time that the transcoder was updated. | [optional] 
...
**watermark_image_url** | **str** | The path to a GIF, JPEG, or PNG image that is embedded in all bitrate renditions of the stream. Watermark image files must be 2.5 MB or smaller. | [optional] 
...
transcoder_instance = Transcoder.from_json(json)
# print the JSON string representation of the object
print(Transcoder.to_json())

# convert the object into a dict
transcoder_dict = transcoder_instance.to_dict()
# create an instance of Transcoder from a dict
transcoder_from_dict = Transcoder.from_dict(transcoder_dict)
```
