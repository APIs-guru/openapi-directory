...
**billing_mode** | **str** | The billing mode for the stream. The default is &lt;strong&gt;pay_as_you_go&lt;/strong&gt;. | 
**broadcast_location** | **str** | The location of your stream. Choose a location as close as possible to your video source. | 
...
json = "{}"
# create an instance of LiveStream6 from a JSON string
live_stream6_instance = LiveStream6.from_json(json)
# print the JSON string representation of the object
print(LiveStream6.to_json())

# convert the object into a dict
live_stream6_dict = live_stream6_instance.to_dict()
# create an instance of LiveStream6 from a dict
live_stream6_from_dict = LiveStream6.from_dict(live_stream6_dict)
```
