...
class RecordingsApi:
    ...
    def delete_recording(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the recording.")],
    ...
    def show_recording(
        ...
        _param = self._show_recording_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def show_recording_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the recording.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShowRecording200Response]:
        """Fetch a recording
    ...
    @validate_call
    def show_recording_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the recording.")],
        _request_timeout: Union[
            None,
    ...
    def show_recording_state(
        ...
        _param = self._show_recording_state_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ShowRecordingState200Response",
            '401': "Error401",
            '403': "Error403",
            '404': "Error404",
            '410': "Error410",
    ...
    @validate_call
    def show_recording_state_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the recording.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShowRecordingState200Response]:
        """Fetch the state of a recording
    ...
    @validate_call
    def show_recording_state_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the recording.")],
        _request_timeout: Union[
            None,
    ...
    def _show_recording_state_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/recordings/{id}/state',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
