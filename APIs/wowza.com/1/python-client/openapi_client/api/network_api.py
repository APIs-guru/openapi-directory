...
class NetworkApi:
    ...
    @validate_call
    def usage_network_stream_sources_index(
        self,
        ...
        _param = self._usage_network_stream_sources_index_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def usage_network_stream_sources_index_with_http_info(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsageNetworkStreamSources]:
        """Fetch network usage for all stream sources
    ...
    @validate_call
    def usage_network_stream_sources_index_without_preload_content(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        _request_timeout: Union[
    ...
    def _usage_network_stream_sources_index_serialize(
        self,
        var_from,
        to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/usage/network/stream_sources',
    ...
    @validate_call
    def usage_network_stream_targets_index(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        _request_timeout: Union[
        ...
        _param = self._usage_network_stream_targets_index_serialize(
            var_from=var_from,
            to=to,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def usage_network_stream_targets_index_with_http_info(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsageNetworkStreamTargets]:
        """Fetch network usage for all stream targets
    ...
    @validate_call
    def usage_network_stream_targets_index_without_preload_content(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        _request_timeout: Union[
    ...
    def _usage_network_stream_targets_index_serialize(
        self,
        var_from,
        to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/usage/network/stream_targets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def usage_network_transcoders_index(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        ...
        _param = self._usage_network_transcoders_index_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def usage_network_transcoders_index_with_http_info(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        transcoder_type: Annotated[Optional[StrictStr], Field(description="The type of transcoder. The default is <strong>transcoded</strong>.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsageNetworkTranscoders]:
        """Fetch network usage for all transcoders
    ...
    @validate_call
    def usage_network_transcoders_index_without_preload_content(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        transcoder_type: Annotated[Optional[StrictStr], Field(description="The type of transcoder. The default is <strong>transcoded</strong>.")] = None,
    ...
    def _usage_network_transcoders_index_serialize(
        self,
        var_from,
        to,
        transcoder_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/usage/network/transcoders',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
