...
class ProcessingTimeApi:
    ...
    @validate_call
    def usage_time_transcoders_index(
        self,
        ...
        transcoder_type: Annotated[Optional[StrictStr], Field(description="The type of transcoder. The default is <strong>transcoded</strong>.")] = None,
        billing_mode: Annotated[Optional[StrictStr], Field(description="The billing mode for the transcoder. The default is <strong>pay_as_you_go</strong>.")] = None,
        ...
        _param = self._usage_time_transcoders_index_serialize(
            var_from=var_from,
            to=to,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UsageTimeTranscoders",
            '401': "Error401",
            '422': "Error422InvalidTimeFormat",
        }
    ...
    @validate_call
    def usage_time_transcoders_index_with_http_info(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        transcoder_type: Annotated[Optional[StrictStr], Field(description="The type of transcoder. The default is <strong>transcoded</strong>.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsageTimeTranscoders]:
        """Fetch stream processing time
    ...
    @validate_call
    def usage_time_transcoders_index_without_preload_content(
        self,
        var_from: Annotated[Optional[datetime], Field(description="The start of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>from</em> default is the last billing date.")] = None,
        to: Annotated[Optional[datetime], Field(description="The end of the range of time you want to view. Specify <strong>YYYY-MM-DD HH:MM:SS</strong> where <strong>HH</strong> is a 24-hour clock in UTC. The <em>to</em> default is the end of the current day.")] = None,
        transcoder_type: Annotated[Optional[StrictStr], Field(description="The type of transcoder. The default is <strong>transcoded</strong>.")] = None,
    ...
    def _usage_time_transcoders_index_serialize(
        self,
        var_from,
        to,
        transcoder_type,
        ...
        if transcoder_type is not None:
            
            _query_params.append(('transcoder_type', transcoder_type))
            
        if billing_mode is not None:
            
            _query_params.append(('billing_mode', billing_mode))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/usage/time/transcoders',
