...
class SchedulesApi:
    ...
    def create_schedule(
        self,
        schedule: Annotated[ScheduleCreateInput, Field(description="Provide the details of the schedule to create in the body of the request.")],
        ...
        :type schedule: ScheduleCreateInput
    ...
    def create_schedule_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateSchedule200Response]:
        """Create a schedule
    ...
    def delete_schedule(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def disable_schedule(
        ...
        _param = self._disable_schedule_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DisableSchedule200Response",
            '401': "Error401",
            '403': "Error403",
            '404': "Error404",
            '410': "Error410",
    ...
    @validate_call
    def disable_schedule_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DisableSchedule200Response]:
        """Disable a schedule
    ...
    @validate_call
    def disable_schedule_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    def _disable_schedule_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/schedules/{id}/disable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def enable_schedule(
        ...
        _param = self._enable_schedule_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def enable_schedule_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EnableSchedule200Response]:
        """Enable a schedule
    ...
    @validate_call
    def enable_schedule_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    def _enable_schedule_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/schedules/{id}/enable',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_schedule(
        ...
        _param = self._show_schedule_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def show_schedule_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def show_schedule_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    def show_schedule_state(
        ...
        _param = self._show_schedule_state_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def show_schedule_state_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def show_schedule_state_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        _request_timeout: Union[
            None,
    ...
    def _show_schedule_state_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/schedules/{id}/state',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_schedule(
        self,
        id: Annotated[StrictStr, Field(description="The unique alphanumeric string that identifies the schedule.")],
        schedule: Annotated[ScheduleUpdateInput, Field(description="Provide the details of the schedule to update in the body of the request.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type schedule: ScheduleUpdateInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
