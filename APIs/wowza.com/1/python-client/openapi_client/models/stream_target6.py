...
class StreamTarget6(BaseModel):
    ...
    primary_url: Optional[StrictStr] = Field(default=None, description="Only for targets whose <em>type</em> is <strong>CustomStreamTarget</strong>. The primary RTMP ingest URL, without the preceding protocol and without the trailing slash (/).")
    ...
    stream_name: Optional[StrictStr] = Field(default=None, description="Only for targets whose <em>type</em> is <strong>CustomStreamTarget</strong>. The name of the stream as defined in the target's ingestion settings.")
    ...
    __properties: ClassVar[List[str]] = ["backup_url", "chunk_size", "enabled", "hds_playback_url", "hls_playback_url", "ingest_ip_whitelist", "name", "password", "primary_url", "provider", "rtmp_playback_url", "source_url", "stream_name", "username"]
