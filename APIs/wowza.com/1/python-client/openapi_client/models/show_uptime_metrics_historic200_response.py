...
class ShowUptimeMetricsHistoric200Response(BaseModel):
    """
    ShowUptimeMetricsHistoric200Response
    """ # noqa: E501
    historic: List[ShmHistoricMetrics]
    limits: Limits1
    __properties: ClassVar[List[str]] = ["historic", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "historic": [ShmHistoricMetrics.from_dict(_item) for _item in obj["historic"]] if obj.get("historic") is not None else None,
            "limits": Limits1.from_dict(obj["limits"]) if obj.get("limits") is not None else None
        })
        return _obj
