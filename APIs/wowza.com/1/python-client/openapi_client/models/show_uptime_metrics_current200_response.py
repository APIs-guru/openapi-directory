...
class ShowUptimeMetricsCurrent200Response(BaseModel):
    """
    ShowUptimeMetricsCurrent200Response
    """ # noqa: E501
    current: ShmMetrics
    limits: Limits
    __properties: ClassVar[List[str]] = ["current", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": ShmMetrics.from_dict(obj["current"]) if obj.get("current") is not None else None,
