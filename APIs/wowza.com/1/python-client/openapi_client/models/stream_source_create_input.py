...
class StreamSourceCreateInput(BaseModel):
    """
    StreamSourceCreateInput
    """ # noqa: E501
    stream_source: StreamSource1
    __properties: ClassVar[List[str]] = ["stream_source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stream_source": StreamSource1.from_dict(obj["stream_source"]) if obj.get("stream_source") is not None else None
        })
        return _obj
