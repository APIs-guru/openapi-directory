...
class CountryObject(BaseModel):
    ...
    CountryObject
    """ # noqa: E501
    country_code: Optional[TheCountryCodeOfTheCountry] = None
    __properties: ClassVar[List[str]] = ["country_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country_code": TheCountryCodeOfTheCountry.from_dict(obj["country_code"]) if obj.get("country_code") is not None else None
        })
        return _obj
