...
class Transcoder8(BaseModel):
    """
    Transcoder8
    """ # noqa: E501
    billing_mode: StrictStr = Field(description="The billing mode for the transcoder. The default is <strong>pay_as_you_go</strong>.")
    broadcast_location: StrictStr = Field(description="The location where Wowza Streaming Cloud transcodes your stream. Choose a location as close as possible to your video source.")
    ...
    transcoder_type: StrictStr = Field(description="The type of transcoder, either <strong>transcoded</strong> for streams that are transcoded into adaptive bitrate renditions or <strong>passthrough</strong> for streams that aren't processed by the transcoder. The default is <strong>transcoded</strong>.")
    ...
    __properties: ClassVar[List[str]] = ["billing_mode", "broadcast_location", "buffer_size", "closed_caption_type", "delivery_method", "delivery_protocols", "description", "disable_authentication", "idle_timeout", "low_latency", "name", "password", "play_maximum_connections", "protocol", "recording", "source_url", "stream_extension", "stream_smoother", "stream_source_id", "suppress_stream_target_start", "transcoder_type", "username", "video_fallback", "watermark", "watermark_height", "watermark_image", "watermark_opacity", "watermark_position", "watermark_width"]
