...
class ShowStreamTargetMetricsCurrent200Response(BaseModel):
    """
    ...
    metrics: Optional[StreamTargetMetrics] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metrics": StreamTargetMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj
