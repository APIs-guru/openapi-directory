...
class CustomStreamTarget1(BaseModel):
    """
    CustomStreamTarget1
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["enable_hls", "enabled", "ingest_ip_whitelist", "name", "provider", "region_override", "source_delivery_method", "source_url", "type"]
