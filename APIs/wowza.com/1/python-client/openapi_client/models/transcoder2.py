...
class Transcoder2(BaseModel):
    """
    Transcoder2
    """ # noqa: E501
    recordings: Optional[List[Recording]] = Field(default=None, description="Array of recordings of this transcoder. See /recordings for more details.")
