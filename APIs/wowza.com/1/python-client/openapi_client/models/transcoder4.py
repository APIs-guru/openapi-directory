...
class Transcoder4(BaseModel):
    """
    Transcoder4
    """ # noqa: E501
    schedules: Optional[List[Schedule]] = Field(default=None, description="Array of schedules of this transcoder. See /schedules for more details.")
