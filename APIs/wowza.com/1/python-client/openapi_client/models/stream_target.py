...
class StreamTarget(BaseModel):
    ...
    StreamTarget
    """ # noqa: E501
    backup_url: Optional[StrictStr] = Field(default=None, description="The backup ingest URL for a target whose <em>type</em> is <strong>WowzaStreamTarget</strong> or <strong>CustomStreamTarget</strong>.")
    ...
    enable_hls: Optional[StrictBool] = Field(default=None, description="Returned only for targets whose <em>type</em> is <strong>UltraLowLatencyStreamTarget</strong>. Indicates whether Apple HLS playback is enabled for the stream target.")
    ...
    playback_urls: Optional[HashOfPlaybackURLs] = None
    ...
    secure_ingest_query_param: Optional[StrictStr] = Field(default=None, description="Only for targets whose <em>use_secure_ingest</em> is <strong>true</strong>. The query parameter needed for secure stream delivery between the transcoder and the target.")
    source_delivery_method: Optional[StrictStr] = Field(default=None, description="Only for targets whose <em>type</em> is <strong>UltraLowLatencyStreamTarget</strong>. The type of connection between the stream source and the stream target. **push** instructs the source to push the stream to the stream target. **pull** instructs the stream target to pull the stream from the source.")
    source_url: Optional[StrictStr] = Field(default=None, description="Only for targets whose <em>type</em> is <strong>UltraLowLatencyStreamTarget</strong> and <em>source_delivery_method</em> is **pull**. The URL of a source IP camera or encoder connecting to the stream target.")
    ...
    __properties: ClassVar[List[str]] = ["backup_url", "chunk_size", "connection_code", "connection_code_expires_at", "created_at", "enable_hls", "enabled", "hds_playback_url", "hls_playback_url", "id", "ingest_ip_whitelist", "location", "name", "password", "playback_urls", "primary_url", "provider", "region_override", "rtmp_playback_url", "secure_ingest_query_param", "source_delivery_method", "source_url", "stream_name", "type", "updated_at", "use_cors", "use_https", "use_secure_ingest", "username"]
    ...
    def region_override_validate_enum(cls, value):
        ...
        if value not in set(['azure-westus', 'azure-eastus2', 'azure-northeurope', 'null']):
            raise ValueError("must be one of enum values ('azure-westus', 'azure-eastus2', 'azure-northeurope', 'null')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of playback_urls
        if self.playback_urls:
            _dict['playback_urls'] = self.playback_urls.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "playback_urls": HashOfPlaybackURLs.from_dict(obj["playback_urls"]) if obj.get("playback_urls") is not None else None,
            "primary_url": obj.get("primary_url"),
            "provider": obj.get("provider"),
            "region_override": obj.get("region_override"),
            "rtmp_playback_url": obj.get("rtmp_playback_url"),
            "secure_ingest_query_param": obj.get("secure_ingest_query_param"),
