...
class SetRecoveryCredentialRequest(BaseModel):
    """
    SetRecoveryCredentialRequest
    """ # noqa: E501
    credentials: Optional[SetRecoveryCredentialRequestCredentials] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": SetRecoveryCredentialRequestCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
        return _obj
