...
**delta_return** | **float** | The relative tolerance over the minimum variance portfolio return, if applicable | [optional] [default to 0.1]
**delta_volatility** | **float** | The relative tolerance over the minimum variance portfolio volatility | [optional] [default to 0.1]
...
json = "{}"
# create an instance of PortfolioOptimizationMinimumVarianceDiversifiedPostRequestConstraints from a JSON string
portfolio_optimization_minimum_variance_diversified_post_request_constraints_instance = PortfolioOptimizationMinimumVarianceDiversifiedPostRequestConstraints.from_json(json)
# print the JSON string representation of the object
print(PortfolioOptimizationMinimumVarianceDiversifiedPostRequestConstraints.to_json())

# convert the object into a dict
portfolio_optimization_minimum_variance_diversified_post_request_constraints_dict = portfolio_optimization_minimum_variance_diversified_post_request_constraints_instance.to_dict()
# create an instance of PortfolioOptimizationMinimumVarianceDiversifiedPostRequestConstraints from a dict
portfolio_optimization_minimum_variance_diversified_post_request_constraints_from_dict = PortfolioOptimizationMinimumVarianceDiversifiedPostRequestConstraints.from_dict(portfolio_optimization_minimum_variance_diversified_post_request_constraints_dict)
```
