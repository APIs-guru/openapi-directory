...
class PortfolioOptimizationEqualRiskContributionsPostRequest(BaseModel):
    ...
    constraints: Optional[PortfolioOptimizationEqualRiskContributionsPostRequestConstraints] = None
    __properties: ClassVar[List[str]] = ["assets", "assetsCovarianceMatrix", "constraints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "constraints": PortfolioOptimizationEqualRiskContributionsPostRequestConstraints.from_dict(obj["constraints"]) if obj.get("constraints") is not None else None
        })
        return _obj
