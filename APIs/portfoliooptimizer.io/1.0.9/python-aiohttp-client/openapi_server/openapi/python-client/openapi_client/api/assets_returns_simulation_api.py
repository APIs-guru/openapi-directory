...
class AssetsReturnsSimulationApi:
    ...
    @validate_call
    def assets_returns_simulation_bootstrap_post(
        self,
        ...
        :param body: (required)
        :type body: AssetsReturnsSimulationBootstrapPostRequest
        ...
        _param = self._assets_returns_simulation_bootstrap_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsReturnsSimulationBootstrapPost200Response",
        }
    ...
    @validate_call
    def assets_returns_simulation_bootstrap_post_with_http_info(
        self,
        body: AssetsReturnsSimulationBootstrapPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsReturnsSimulationBootstrapPost200Response]:
        """Bootstrap
    ...
    @validate_call
    def assets_returns_simulation_bootstrap_post_without_preload_content(
        self,
        body: AssetsReturnsSimulationBootstrapPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_returns_simulation_bootstrap_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/returns/simulation/bootstrap',
