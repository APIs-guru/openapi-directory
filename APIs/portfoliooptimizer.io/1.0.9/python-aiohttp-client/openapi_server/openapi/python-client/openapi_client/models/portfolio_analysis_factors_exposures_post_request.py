...
class PortfolioAnalysisFactorsExposuresPostRequest(BaseModel):
    ...
    """ # noqa: E501
    factors: Optional[Annotated[List[PortfolioAnalysisFactorsExposuresPostRequestFactorsInner], Field(min_length=1)]] = None
    portfolios: Annotated[List[PortfolioAnalysisFactorsExposuresPostRequestPortfoliosInner], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["factors", "portfolios"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "factors": [PortfolioAnalysisFactorsExposuresPostRequestFactorsInner.from_dict(_item) for _item in obj["factors"]] if obj.get("factors") is not None else None,
            "portfolios": [PortfolioAnalysisFactorsExposuresPostRequestPortfoliosInner.from_dict(_item) for _item in obj["portfolios"]] if obj.get("portfolios") is not None else None
        })
        return _obj
