...
class TestPortfolioOptimizationApi(unittest.TestCase):
    """PortfolioOptimizationApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PortfolioOptimizationApi()

    def tearDown(self) -> None:
        pass

    def test_portfolio_optimization_equal_risk_contributions_post(self) -> None:
    ...
    def test_portfolio_optimization_equal_sharpe_ratio_contributions_post(self) -> None:
    ...
    def test_portfolio_optimization_equal_volatility_weighted_post(self) -> None:
    ...
    def test_portfolio_optimization_equal_weighted_post(self) -> None:
    ...
    def test_portfolio_optimization_hierarchical_risk_parity_clustering_based_post(self) -> None:
    ...
    def test_portfolio_optimization_hierarchical_risk_parity_post(self) -> None:
    ...
    def test_portfolio_optimization_inverse_variance_weighted_post(self) -> None:
    ...
    def test_portfolio_optimization_inverse_volatility_weighted_post(self) -> None:
    ...
    def test_portfolio_optimization_market_capitalization_weighted_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_decorrelation_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_ulcer_performance_index_post(self) -> None:
    ...
    def test_portfolio_optimization_minimum_correlation_post(self) -> None:
    ...
    def test_portfolio_optimization_minimum_ulcer_index_post(self) -> None:
    ...
    def test_portfolio_optimization_most_diversified_post(self) -> None:
