...
class PortfolioAnalysisReturnPostRequest(Model):
    ...
    def __init__(self, assets: int=None, assets_returns: List[float]=None, portfolios: List[PortfolioAnalysisReturnPostRequestOneOf1PortfoliosInner]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PortfolioAnalysisReturnPostRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _portfolio_analysis_return_post_request of this PortfolioAnalysisReturnPostRequest.
        """
