...
class PortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedPostRequest(Model):
    ...
    def __init__(self, assets: int=None, assets_covariance_matrix: List[List[float]]=None, assets_returns: List[float]=None, constraints: PortfolioAnalysisMeanVarianceEfficientFrontierPostRequestConstraints=None, risk_free_rate: float=None, subset_portfolios: int=128, subset_portfolios_aggregation_method: str='average', subset_portfolios_enumeration_method: str='randomSampling', subset_size: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedPostRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _portfolio_optimization_maximum_sharpe_ratio_subset_resampling_based_post_request of this PortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedPostRequest.
        """
