...
class AssetsCorrelationMatrixPost200Response(Model):
    ...
    def __init__(self, assets_correlation_matrix: List[List[float]]=None):
        """AssetsCorrelationMatrixPost200Response - a model defined in OpenAPI

        :param assets_correlation_matrix: The assets_correlation_matrix of this AssetsCorrelationMatrixPost200Response.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AssetsCorrelationMatrixPost200Response':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _assets_correlation_matrix_post_200_response of this AssetsCorrelationMatrixPost200Response.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def assets_correlation_matrix(self):
        """Gets the assets_correlation_matrix of this AssetsCorrelationMatrixPost200Response.

        assetsCorrelationMatrix[i][j] is the correlation between the asset i and the asset j

        :return: The assets_correlation_matrix of this AssetsCorrelationMatrixPost200Response.
    ...
    def assets_correlation_matrix(self, assets_correlation_matrix):
        """Sets the assets_correlation_matrix of this AssetsCorrelationMatrixPost200Response.
