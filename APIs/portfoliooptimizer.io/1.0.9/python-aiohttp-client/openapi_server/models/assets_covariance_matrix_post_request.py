...
class AssetsCovarianceMatrixPostRequest(Model):
    ...
    def __init__(self, assets: int=None, assets_correlation_matrix: List[List[float]]=None, assets_variances: List[float]=None, assets_volatilities: List[float]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AssetsCovarianceMatrixPostRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _assets_covariance_matrix_post_request of this AssetsCovarianceMatrixPostRequest.
        """
