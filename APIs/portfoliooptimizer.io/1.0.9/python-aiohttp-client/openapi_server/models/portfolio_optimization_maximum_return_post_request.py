...
class PortfolioOptimizationMaximumReturnPostRequest(Model):
    ...
    def __init__(self, assets: int=None, assets_covariance_matrix: List[List[float]]=None, assets_returns: List[float]=None, constraints: PortfolioAnalysisMeanVarianceEfficientFrontierPostRequestConstraints=None):
        """PortfolioOptimizationMaximumReturnPostRequest - a model defined in OpenAPI

        :param assets: The assets of this PortfolioOptimizationMaximumReturnPostRequest.
        :param assets_covariance_matrix: The assets_covariance_matrix of this PortfolioOptimizationMaximumReturnPostRequest.
        :param assets_returns: The assets_returns of this PortfolioOptimizationMaximumReturnPostRequest.
        :param constraints: The constraints of this PortfolioOptimizationMaximumReturnPostRequest.
        """
        self.openapi_types = {
            'assets': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PortfolioOptimizationMaximumReturnPostRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _portfolio_optimization_maximum_return_post_request of this PortfolioOptimizationMaximumReturnPostRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def assets(self):
        """Gets the assets of this PortfolioOptimizationMaximumReturnPostRequest.

        The number of assets

        :return: The assets of this PortfolioOptimizationMaximumReturnPostRequest.
        :rtype: int
        """
        return self._assets
    ...
    def assets(self, assets):
        """Sets the assets of this PortfolioOptimizationMaximumReturnPostRequest.
    ...
    def assets_covariance_matrix(self):
        """Gets the assets_covariance_matrix of this PortfolioOptimizationMaximumReturnPostRequest.

        assetsCovarianceMatrix[i][j] is the covariance between the asset i and the asset j

        :return: The assets_covariance_matrix of this PortfolioOptimizationMaximumReturnPostRequest.
    ...
    def assets_covariance_matrix(self, assets_covariance_matrix):
        """Sets the assets_covariance_matrix of this PortfolioOptimizationMaximumReturnPostRequest.
    ...
    def assets_returns(self):
        """Gets the assets_returns of this PortfolioOptimizationMaximumReturnPostRequest.

        assetsReturns[i] is the arithmetic return of asset i

        :return: The assets_returns of this PortfolioOptimizationMaximumReturnPostRequest.
        :rtype: List[float]
        """
    ...
    def assets_returns(self, assets_returns):
        """Sets the assets_returns of this PortfolioOptimizationMaximumReturnPostRequest.
    ...
    def constraints(self):
        """Gets the constraints of this PortfolioOptimizationMaximumReturnPostRequest.


        :return: The constraints of this PortfolioOptimizationMaximumReturnPostRequest.
    ...
    def constraints(self, constraints):
        """Sets the constraints of this PortfolioOptimizationMaximumReturnPostRequest.
