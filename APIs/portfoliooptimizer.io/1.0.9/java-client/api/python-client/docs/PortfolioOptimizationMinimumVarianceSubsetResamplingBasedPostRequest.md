...
json = "{}"
# create an instance of PortfolioOptimizationMinimumVarianceSubsetResamplingBasedPostRequest from a JSON string
portfolio_optimization_minimum_variance_subset_resampling_based_post_request_instance = PortfolioOptimizationMinimumVarianceSubsetResamplingBasedPostRequest.from_json(json)
# print the JSON string representation of the object
print(PortfolioOptimizationMinimumVarianceSubsetResamplingBasedPostRequest.to_json())

# convert the object into a dict
portfolio_optimization_minimum_variance_subset_resampling_based_post_request_dict = portfolio_optimization_minimum_variance_subset_resampling_based_post_request_instance.to_dict()
# create an instance of PortfolioOptimizationMinimumVarianceSubsetResamplingBasedPostRequest from a dict
portfolio_optimization_minimum_variance_subset_resampling_based_post_request_from_dict = PortfolioOptimizationMinimumVarianceSubsetResamplingBasedPostRequest.from_dict(portfolio_optimization_minimum_variance_subset_resampling_based_post_request_dict)
```
