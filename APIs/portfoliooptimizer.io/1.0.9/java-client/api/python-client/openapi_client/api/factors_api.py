...
class FactorsApi:
    ...
    @validate_call
    def factors_residualization_post(
        self,
        body: FactorsResidualizationPostRequest,
        ...
        :param body: (required)
        :type body: FactorsResidualizationPostRequest
        ...
        _param = self._factors_residualization_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FactorsResidualizationPost200Response",
        }
    ...
    @validate_call
    def factors_residualization_post_with_http_info(
        self,
        body: FactorsResidualizationPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FactorsResidualizationPost200Response]:
        """Residualization
    ...
    @validate_call
    def factors_residualization_post_without_preload_content(
        self,
        body: FactorsResidualizationPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _factors_residualization_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/factors/residualization',
