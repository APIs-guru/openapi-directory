...
|**deltaReturn** | **BigDecimal** | The relative tolerance over the maximum return portfolio return |  [optional] |
|**deltaVolatility** | **BigDecimal** | The relative tolerance over the maximum return portfolio volatility, if applicable |  [optional] |
