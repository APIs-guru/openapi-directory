...
/**
 * API tests for AssetsReturnsSimulationApi
 */
@Disabled
public class AssetsReturnsSimulationApiTest {

    private final AssetsReturnsSimulationApi api = new AssetsReturnsSimulationApi();
     ...
     */
    @Test
    public void assetsReturnsSimulationBootstrapPostTest() throws ApiException {
        AssetsReturnsSimulationBootstrapPostRequest body = null;
        AssetsReturnsSimulationBootstrapPost200Response response = api.assetsReturnsSimulationBootstrapPost(body);
