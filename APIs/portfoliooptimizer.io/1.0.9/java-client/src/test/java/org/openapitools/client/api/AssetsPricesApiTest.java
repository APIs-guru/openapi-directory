...
/**
 * API tests for AssetsPricesApi
 */
@Disabled
public class AssetsPricesApiTest {

    private final AssetsPricesApi api = new AssetsPricesApi();
     ...
     */
    @Test
    public void assetsPricesAdjustedForwardPostTest() throws ApiException {
        AssetsPricesAdjustedPostRequest body = null;
        AssetsPricesAdjustedPost200Response response = api.assetsPricesAdjustedForwardPost(body);
     ...
     */
    @Test
    public void assetsPricesAdjustedPostTest() throws ApiException {
        AssetsPricesAdjustedPostRequest body = null;
        AssetsPricesAdjustedPost200Response response = api.assetsPricesAdjustedPost(body);
        // TODO: test validations
    }
