...
/*
 * OAI_portfolio_optimization_minimum_variance_post_request.h
 *
 * 
 */

#ifndef OAI_portfolio_optimization_minimum_variance_post_request_H
#define OAI_portfolio_optimization_minimum_variance_post_request_H
...
class OAI_portfolio_optimization_minimum_variance_post_request : public OAIObject {
public:
    OAI_portfolio_optimization_minimum_variance_post_request();
    OAI_portfolio_optimization_minimum_variance_post_request(QString json);
    ~OAI_portfolio_optimization_minimum_variance_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_portfolio_optimization_minimum_variance_post_request)

#endif // OAI_portfolio_optimization_minimum_variance_post_request_H
