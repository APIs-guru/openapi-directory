# PortfolioOptimizer.PortfolioOptimizationMaximumReturnSubsetResamplingBasedPostRequest
...
**assetsCovarianceMatrix** | **[[Number]]** | assetsCovarianceMatrix[i][j] is the covariance between the asset i and the asset j | [optional] 
