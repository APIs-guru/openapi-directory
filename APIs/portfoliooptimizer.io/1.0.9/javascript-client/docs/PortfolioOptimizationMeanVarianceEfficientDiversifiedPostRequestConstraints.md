# PortfolioOptimizer.PortfolioOptimizationMeanVarianceEfficientDiversifiedPostRequestConstraints
...
**deltaReturn** | **Number** | The relative tolerance over the mean-variance efficient portfolio return | [optional] [default to 0.1]
**deltaVolatility** | **Number** | The relative tolerance over the mean-variance efficient portfolio volatility | [optional] [default to 0.1]
...
**portfolioReturn** | **Number** | The portfolio return; exclusive with portfolioVolatility and riskTolerance | [optional] 
**portfolioVolatility** | **Number** | The portfolio volatility; exclusive with portfolioReturn and riskTolerance | [optional] 
**riskTolerance** | **Number** | The portfolio risk tolerance; exclusive with portfolioReturn and portfolioVolatility | [optional] 
