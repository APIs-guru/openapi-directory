# PortfolioOptimizer.PortfolioAnalysisMeanVarianceMinimumVarianceFrontierPostRequest
...
**portfolios** | **Number** | The number of portfolios to compute on the mean-variance minimum variance frontier | [optional] [default to 25]
