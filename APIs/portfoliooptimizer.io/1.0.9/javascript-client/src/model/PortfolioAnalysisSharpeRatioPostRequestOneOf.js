...
/**
 * The PortfolioAnalysisSharpeRatioPostRequestOneOf model module.
 * @module model/PortfolioAnalysisSharpeRatioPostRequestOneOf
 * @version 1.0.9
 */
class PortfolioAnalysisSharpeRatioPostRequestOneOf {
    /**
     * Constructs a new <code>PortfolioAnalysisSharpeRatioPostRequestOneOf</code>.
     * @alias module:model/PortfolioAnalysisSharpeRatioPostRequestOneOf
     ...
     */
    constructor(assets, assetsCovarianceMatrix, assetsReturns, portfolios, riskFreeRate) { 
        
        PortfolioAnalysisSharpeRatioPostRequestOneOf.initialize(this, assets, assetsCovarianceMatrix, assetsReturns, portfolios, riskFreeRate);
    }
     ...
     */
    static initialize(obj, assets, assetsCovarianceMatrix, assetsReturns, portfolios, riskFreeRate) { 
        obj['assets'] = assets;
    ...
    /**
     * Constructs a <code>PortfolioAnalysisSharpeRatioPostRequestOneOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortfolioAnalysisSharpeRatioPostRequestOneOf} obj Optional instance to populate.
     * @return {module:model/PortfolioAnalysisSharpeRatioPostRequestOneOf} The populated <code>PortfolioAnalysisSharpeRatioPostRequestOneOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortfolioAnalysisSharpeRatioPostRequestOneOf();
    ...
    /**
     * Validates the JSON data with respect to <code>PortfolioAnalysisSharpeRatioPostRequestOneOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortfolioAnalysisSharpeRatioPostRequestOneOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PortfolioAnalysisSharpeRatioPostRequestOneOf.RequiredProperties) {
...
PortfolioAnalysisSharpeRatioPostRequestOneOf.RequiredProperties = ["assets", "assetsCovarianceMatrix", "assetsReturns", "portfolios", "riskFreeRate"];

/**
 * The number of assets
 * @member {Number} assets
 */
PortfolioAnalysisSharpeRatioPostRequestOneOf.prototype['assets'] = undefined;

/**
 * assetsCovarianceMatrix[i][j] is the covariance between the asset i and the asset j
 * @member {Array.<Array.<Number>>} assetsCovarianceMatrix
 */
PortfolioAnalysisSharpeRatioPostRequestOneOf.prototype['assetsCovarianceMatrix'] = undefined;

/**
 * assetsReturns[i] is the arithmetic return of asset i
 * @member {Array.<Number>} assetsReturns
 */
PortfolioAnalysisSharpeRatioPostRequestOneOf.prototype['assetsReturns'] = undefined;

/**
 * @member {Array.<module:model/PortfolioAnalysisSharpeRatioPostRequestOneOfPortfoliosInner>} portfolios
 */
PortfolioAnalysisSharpeRatioPostRequestOneOf.prototype['portfolios'] = undefined;

/**
 * The risk free rate
 * @member {Number} riskFreeRate
 */
PortfolioAnalysisSharpeRatioPostRequestOneOf.prototype['riskFreeRate'] = undefined;
...
export default PortfolioAnalysisSharpeRatioPostRequestOneOf;
