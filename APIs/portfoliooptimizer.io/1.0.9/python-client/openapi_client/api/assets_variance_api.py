...
class AssetsVarianceApi:
    ...
    @validate_call
    def assets_variance_post(
        self,
        body: AssetsVariancePostRequest,
        ...
        :param body: (required)
        :type body: AssetsVariancePostRequest
        ...
        _param = self._assets_variance_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsVariancePost200Response",
        }
    ...
    @validate_call
    def assets_variance_post_with_http_info(
        self,
        body: AssetsVariancePostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsVariancePost200Response]:
        """Variance
    ...
    @validate_call
    def assets_variance_post_without_preload_content(
        self,
        body: AssetsVariancePostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_variance_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
