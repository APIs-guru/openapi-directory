...
class AssetsReturnsSimulationMonteCarloCornishFisherPost200ResponseSimulationsInner(BaseModel):
    """
    AssetsReturnsSimulationMonteCarloCornishFisherPost200ResponseSimulationsInner
    """ # noqa: E501
    assets: Annotated[List[AssetsReturnsSimulationBootstrapPost200ResponseSimulationsInnerAssetsInner], Field(min_length=1, max_length=1)] = Field(description="assets[i] is the data for the i-th asset")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [AssetsReturnsSimulationBootstrapPost200ResponseSimulationsInnerAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
