...
class FactorsResidualizationPostRequest(BaseModel):
    ...
    """ # noqa: E501
    factors: Annotated[List[FactorsResidualizationPostRequestFactorsInner], Field(min_length=2)]
    residualized_factor: Annotated[int, Field(strict=True, ge=1)] = Field(description="The index of the factor to residualize", alias="residualizedFactor")
    __properties: ClassVar[List[str]] = ["factors", "residualizedFactor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "factors": [FactorsResidualizationPostRequestFactorsInner.from_dict(_item) for _item in obj["factors"]] if obj.get("factors") is not None else None,
            "residualizedFactor": obj.get("residualizedFactor")
        })
        return _obj
