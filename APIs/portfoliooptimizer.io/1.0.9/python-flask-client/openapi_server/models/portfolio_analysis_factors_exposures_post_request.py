...
from openapi_server.models.portfolio_analysis_factors_exposures_post_request_factors_inner import PortfolioAnalysisFactorsExposuresPostRequestFactorsInner  # noqa: E501
from openapi_server.models.portfolio_analysis_factors_exposures_post_request_portfolios_inner import PortfolioAnalysisFactorsExposuresPostRequestPortfoliosInner  # noqa: E501
...
class PortfolioAnalysisFactorsExposuresPostRequest(Model):
    ...
    def __init__(self, factors=None, portfolios=None):  # noqa: E501
        """PortfolioAnalysisFactorsExposuresPostRequest - a model defined in OpenAPI

        :param factors: The factors of this PortfolioAnalysisFactorsExposuresPostRequest.  # noqa: E501
        :type factors: List[PortfolioAnalysisFactorsExposuresPostRequestFactorsInner]
        :param portfolios: The portfolios of this PortfolioAnalysisFactorsExposuresPostRequest.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PortfolioAnalysisFactorsExposuresPostRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The _portfolio_analysis_factors_exposures_post_request of this PortfolioAnalysisFactorsExposuresPostRequest.  # noqa: E501
        :rtype: PortfolioAnalysisFactorsExposuresPostRequest
        """
        return util.deserialize_model(dikt, cls)

    @property
    def factors(self) -> List[PortfolioAnalysisFactorsExposuresPostRequestFactorsInner]:
    ...
    @factors.setter
    def factors(self, factors: List[PortfolioAnalysisFactorsExposuresPostRequestFactorsInner]):
    ...
    @property
    def portfolios(self) -> List[PortfolioAnalysisFactorsExposuresPostRequestPortfoliosInner]:
    ...
    @portfolios.setter
    def portfolios(self, portfolios: List[PortfolioAnalysisFactorsExposuresPostRequestPortfoliosInner]):
