...
public class FactorsApiTest {
     ...
     */
    @Test
    public void factorsResidualizationPostTest() throws ApiException {
        FactorsResidualizationPostRequest body = null;
        FactorsResidualizationPost200Response response = api.factorsResidualizationPost(body);
