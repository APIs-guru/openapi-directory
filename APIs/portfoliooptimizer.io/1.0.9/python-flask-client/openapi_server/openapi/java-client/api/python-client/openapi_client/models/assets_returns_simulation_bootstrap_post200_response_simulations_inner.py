...
class AssetsReturnsSimulationBootstrapPost200ResponseSimulationsInner(BaseModel):
    """
    AssetsReturnsSimulationBootstrapPost200ResponseSimulationsInner
    """ # noqa: E501
    assets: List[AssetsReturnsSimulationBootstrapPost200ResponseSimulationsInnerAssetsInner] = Field(description="assets[i] is the data for the i-th asset")
