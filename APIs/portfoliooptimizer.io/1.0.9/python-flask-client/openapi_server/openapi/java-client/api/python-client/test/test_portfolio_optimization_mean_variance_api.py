...
class TestPortfolioOptimizationMeanVarianceApi(unittest.TestCase):
    """PortfolioOptimizationMeanVarianceApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PortfolioOptimizationMeanVarianceApi()

    def tearDown(self) -> None:
        pass

    def test_portfolio_optimization_maximum_return_diversified_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_return_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_return_subset_resampling_based_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_sharpe_ratio_diversified_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_sharpe_ratio_post(self) -> None:
    ...
    def test_portfolio_optimization_maximum_sharpe_ratio_subset_resampling_based_post(self) -> None:
    ...
    def test_portfolio_optimization_mean_variance_efficient_diversified_post(self) -> None:
    ...
    def test_portfolio_optimization_mean_variance_efficient_post(self) -> None:
    ...
    def test_portfolio_optimization_mean_variance_efficient_subset_resampling_based_post(self) -> None:
    ...
    def test_portfolio_optimization_minimum_variance_diversified_post(self) -> None:
    ...
    def test_portfolio_optimization_minimum_variance_post(self) -> None:
    ...
    def test_portfolio_optimization_minimum_variance_subset_resampling_based_post(self) -> None:
