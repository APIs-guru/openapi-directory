...
class PortfolioAnalysisValueAtRiskConditionalCornishFisherPost200Response(BaseModel):
    """
    PortfolioAnalysisValueAtRiskConditionalCornishFisherPost200Response
    """ # noqa: E501
    portfolios: Annotated[List[PortfolioAnalysisValueAtRiskConditionalCornishFisherPost200ResponsePortfoliosInner], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "portfolios": [PortfolioAnalysisValueAtRiskConditionalCornishFisherPost200ResponsePortfoliosInner.from_dict(_item) for _item in obj["portfolios"]] if obj.get("portfolios") is not None else None
        })
        return _obj
