...
class PortfolioAnalysisSharpeRatioBiasAdjustedPostRequest(BaseModel):
    ...
    """ # noqa: E501
    portfolios: Annotated[List[PortfolioAnalysisSharpeRatioBiasAdjustedPostRequestPortfoliosInner], Field(min_length=1)]
    risk_free_rate: Union[StrictFloat, StrictInt] = Field(description="The risk free rate", alias="riskFreeRate")
    __properties: ClassVar[List[str]] = ["portfolios", "riskFreeRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "portfolios": [PortfolioAnalysisSharpeRatioBiasAdjustedPostRequestPortfoliosInner.from_dict(_item) for _item in obj["portfolios"]] if obj.get("portfolios") is not None else None,
