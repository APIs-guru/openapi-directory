...
class AssetsPricesAdjustedPostRequest(BaseModel):
    ...
    """ # noqa: E501
    assets: Annotated[List[AssetsPricesAdjustedPostRequestAssetsInner], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [AssetsPricesAdjustedPostRequestAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
