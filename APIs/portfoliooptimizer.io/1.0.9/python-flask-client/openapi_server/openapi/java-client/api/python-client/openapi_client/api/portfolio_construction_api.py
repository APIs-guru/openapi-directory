...
class PortfolioConstructionApi:
    ...
    @validate_call
    def portfolio_construction_investable_post(
        self,
        ...
        :param body: (required)
        :type body: PortfolioConstructionInvestablePostRequest
        ...
        _param = self._portfolio_construction_investable_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PortfolioConstructionInvestablePost200Response",
        }
    ...
    @validate_call
    def portfolio_construction_investable_post_with_http_info(
        self,
        body: PortfolioConstructionInvestablePostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PortfolioConstructionInvestablePost200Response]:
        """Investable Portfolio
    ...
    @validate_call
    def portfolio_construction_investable_post_without_preload_content(
        self,
        body: PortfolioConstructionInvestablePostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_construction_investable_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/construction/investable',
    ...
    @validate_call
    def portfolio_construction_mimicking_post(
        self,
        ...
        :param body: (required)
        :type body: PortfolioConstructionMimickingPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._portfolio_construction_mimicking_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def portfolio_construction_mimicking_post_with_http_info(
        self,
        body: PortfolioConstructionMimickingPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def portfolio_construction_mimicking_post_without_preload_content(
        self,
        body: PortfolioConstructionMimickingPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_construction_mimicking_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/construction/mimicking',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def portfolio_construction_random_post(
        self,
        body: PortfolioConstructionRandomPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: (required)
        :type body: PortfolioConstructionRandomPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._portfolio_construction_random_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PortfolioConstructionRandomPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def portfolio_construction_random_post_with_http_info(
        self,
        body: PortfolioConstructionRandomPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PortfolioConstructionRandomPost200Response]:
        """Random Portfolio
    ...
    @validate_call
    def portfolio_construction_random_post_without_preload_content(
        self,
        body: PortfolioConstructionRandomPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_construction_random_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/construction/random',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
