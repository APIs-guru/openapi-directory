...
|**deltaReturn** | **BigDecimal** | The relative tolerance over the mean-variance efficient portfolio return |  [optional] |
|**deltaVolatility** | **BigDecimal** | The relative tolerance over the mean-variance efficient portfolio volatility |  [optional] |
