...
/*
 * OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf.h
 *
 * 
 */

#ifndef OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_H
#define OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_H
...
namespace OpenAPI {
class OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_portfolios_inner;

class OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf : public OAIObject {
public:
    OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf();
    OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf(QString json);
    ~OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf() override;
    ...
    QList<OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_portfolios_inner> getPortfolios() const;
    void setPortfolios(const QList<OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_portfolios_inner> &portfolios);
...
private:
    ...
    QList<OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_portfolios_inner> m_portfolios;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf)

#endif // OAI_portfolio_analysis_sharpe_ratio_post_request_oneOf_H
