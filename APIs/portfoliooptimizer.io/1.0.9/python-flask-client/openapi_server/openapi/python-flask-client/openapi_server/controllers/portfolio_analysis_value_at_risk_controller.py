...
def portfolio_analysis_value_at_risk_cornish_fisher_corrected_post(body):  # noqa: E501
    """Corrected Cornish-Fisher Value At Risk

    Compute the corrected Cornish-Fisher value at risk of one or several portfolio(s) from portfolio values.  References * [Lamb, John D., Maura E. Monville, and Kai-Hong Tee. Making Cornish–fisher Fit for Risk Measurement, Journal of Risk, Volume 21, Number 5, p. 53-81](http://doi.org/10.21314/JOR.2019.408)  # noqa: E501

    :param body: 
    :type body: dict | bytes

    :rtype: Union[PortfolioAnalysisValueAtRiskCornishFisherPost200Response, Tuple[PortfolioAnalysisValueAtRiskCornishFisherPost200Response, int], Tuple[PortfolioAnalysisValueAtRiskCornishFisherPost200Response, int, Dict[str, str]]
    """
...
def portfolio_analysis_value_at_risk_cornish_fisher_post(body):  # noqa: E501
    """Cornish-Fisher Value At Risk

    Compute the Cornish-Fisher value at risk of one or several portfolio(s) from portfolio values.  References * [Laurent Favre and José-Antonio Galeano, Mean-Modified Value-at-Risk Optimization with Hedge Funds, The Journal of Alternative Investments Fall 2002, 5 (2) 21-25](https://jai.pm-research.com/content/5/2/21) * [Lamb, John D., Maura E. Monville, and Kai-Hong Tee. Making Cornish–fisher Fit for Risk Measurement, Journal of Risk, Volume 21, Number 5, p. 53-81](http://doi.org/10.21314/JOR.2019.408)  # noqa: E501
...
def portfolio_analysis_value_at_risk_gaussian_post(body):  # noqa: E501
    """Gaussian Value At Risk

    Compute the Gaussian value at risk of one or several portfolio(s) from portfolio values.  References * [Ballotta, Laura and Fusai, Gianluca, A Gentle Introduction to Value at Risk](https://papers.ssrn.com/sol3/papers.cfm?abstract_id&#x3D;2942138)  # noqa: E501
...
def portfolio_analysis_value_at_risk_historical_post(body):  # noqa: E501
