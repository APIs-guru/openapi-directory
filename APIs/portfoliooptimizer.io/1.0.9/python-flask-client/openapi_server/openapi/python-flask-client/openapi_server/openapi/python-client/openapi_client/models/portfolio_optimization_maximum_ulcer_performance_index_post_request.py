...
class PortfolioOptimizationMaximumUlcerPerformanceIndexPostRequest(BaseModel):
    ...
    """ # noqa: E501
    assets: Annotated[List[AssetsReturnsPostRequestAssetsInner], Field(min_length=1)]
    ...
    __properties: ClassVar[List[str]] = ["assets", "constraints", "riskFreeRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [AssetsReturnsPostRequestAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
