...
class AssetsVolatilityApi:
    ...
    @validate_call
    def assets_volatility_post(
        self,
        body: AssetsVolatilityPostRequest,
        ...
        :param body: (required)
        :type body: AssetsVolatilityPostRequest
        ...
        _param = self._assets_volatility_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsVolatilityPost200Response",
        }
    ...
    @validate_call
    def assets_volatility_post_with_http_info(
        self,
        body: AssetsVolatilityPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsVolatilityPost200Response]:
        """Volatility
    ...
    @validate_call
    def assets_volatility_post_without_preload_content(
        self,
        body: AssetsVolatilityPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_volatility_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/volatility',
