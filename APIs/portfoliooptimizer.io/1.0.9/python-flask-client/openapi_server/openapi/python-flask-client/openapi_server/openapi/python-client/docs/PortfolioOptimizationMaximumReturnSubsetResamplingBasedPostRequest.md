...
portfolio_optimization_maximum_return_subset_resampling_based_post_request_instance = PortfolioOptimizationMaximumReturnSubsetResamplingBasedPostRequest.from_json(json)
# print the JSON string representation of the object
print(PortfolioOptimizationMaximumReturnSubsetResamplingBasedPostRequest.to_json())

# convert the object into a dict
portfolio_optimization_maximum_return_subset_resampling_based_post_request_dict = portfolio_optimization_maximum_return_subset_resampling_based_post_request_instance.to_dict()
# create an instance of PortfolioOptimizationMaximumReturnSubsetResamplingBasedPostRequest from a dict
portfolio_optimization_maximum_return_subset_resampling_based_post_request_from_dict = PortfolioOptimizationMaximumReturnSubsetResamplingBasedPostRequest.from_dict(portfolio_optimization_maximum_return_subset_resampling_based_post_request_dict)
```
