...
from openapi_server.models.portfolio_analysis_mean_variance_efficient_frontier_post200_response_portfolios_inner import PortfolioAnalysisMeanVarianceEfficientFrontierPost200ResponsePortfoliosInner  # noqa: E501
...
class PortfolioAnalysisMeanVarianceEfficientFrontierPost200Response(Model):
    ...
    def __init__(self, portfolios=None):  # noqa: E501
        ...
        :param portfolios: The portfolios of this PortfolioAnalysisMeanVarianceEfficientFrontierPost200Response.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PortfolioAnalysisMeanVarianceEfficientFrontierPost200Response':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The _portfolio_analysis_mean_variance_efficient_frontier_post_200_response of this PortfolioAnalysisMeanVarianceEfficientFrontierPost200Response.  # noqa: E501
        :rtype: PortfolioAnalysisMeanVarianceEfficientFrontierPost200Response
        """
        return util.deserialize_model(dikt, cls)

    @property
    def portfolios(self) -> List[PortfolioAnalysisMeanVarianceEfficientFrontierPost200ResponsePortfoliosInner]:
    ...
    @portfolios.setter
    def portfolios(self, portfolios: List[PortfolioAnalysisMeanVarianceEfficientFrontierPost200ResponsePortfoliosInner]):
