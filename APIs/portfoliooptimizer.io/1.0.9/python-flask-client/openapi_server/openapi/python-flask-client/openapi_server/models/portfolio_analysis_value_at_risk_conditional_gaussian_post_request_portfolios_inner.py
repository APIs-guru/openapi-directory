...
class PortfolioAnalysisValueAtRiskConditionalGaussianPostRequestPortfoliosInner(Model):
    ...
    def __init__(self, portfolio_values=None):  # noqa: E501
        ...
        :param portfolio_values: The portfolio_values of this PortfolioAnalysisValueAtRiskConditionalGaussianPostRequestPortfoliosInner.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PortfolioAnalysisValueAtRiskConditionalGaussianPostRequestPortfoliosInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The _portfolio_analysis_value_at_risk_conditional_gaussian_post_request_portfolios_inner of this PortfolioAnalysisValueAtRiskConditionalGaussianPostRequestPortfoliosInner.  # noqa: E501
        :rtype: PortfolioAnalysisValueAtRiskConditionalGaussianPostRequestPortfoliosInner
        """
    ...
    def portfolio_values(self, portfolio_values: List[float]):
        ...
        if portfolio_values is not None and len(portfolio_values) < 3:
            raise ValueError("Invalid value for `portfolio_values`, number of items must be greater than or equal to `3`")  # noqa: E501
