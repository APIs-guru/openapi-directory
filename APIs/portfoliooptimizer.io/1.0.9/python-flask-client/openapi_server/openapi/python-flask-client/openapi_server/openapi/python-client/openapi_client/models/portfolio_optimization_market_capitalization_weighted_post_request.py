...
class PortfolioOptimizationMarketCapitalizationWeightedPostRequest(BaseModel):
    ...
    assets_market_capitalizations: Annotated[List[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(min_length=2)] = Field(description="assetsMarketCapitalizations[i] is the market capitalization of the asset i", alias="assetsMarketCapitalizations")
    __properties: ClassVar[List[str]] = ["assets", "assetsMarketCapitalizations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assetsMarketCapitalizations": obj.get("assetsMarketCapitalizations")
        })
        return _obj
