...
class AssetsPricesApi:
    ...
    @validate_call
    def assets_prices_adjusted_forward_post(
        self,
        body: AssetsPricesAdjustedPostRequest,
        ...
        :param body: (required)
        :type body: AssetsPricesAdjustedPostRequest
        ...
        _param = self._assets_prices_adjusted_forward_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsPricesAdjustedPost200Response",
        }
    ...
    @validate_call
    def assets_prices_adjusted_forward_post_with_http_info(
        self,
        body: AssetsPricesAdjustedPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsPricesAdjustedPost200Response]:
        """Forward-Adjusted Prices
    ...
    @validate_call
    def assets_prices_adjusted_forward_post_without_preload_content(
        self,
        body: AssetsPricesAdjustedPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_prices_adjusted_forward_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/prices/adjusted/forward',
    ...
    @validate_call
    def assets_prices_adjusted_post(
        self,
        body: AssetsPricesAdjustedPostRequest,
        _request_timeout: Union[
            None,
        ...
        _param = self._assets_prices_adjusted_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def assets_prices_adjusted_post_with_http_info(
        self,
        body: AssetsPricesAdjustedPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def assets_prices_adjusted_post_without_preload_content(
        self,
        body: AssetsPricesAdjustedPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_prices_adjusted_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/prices/adjusted',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
