...
class AssetsAnalysisApi:
    ...
    @validate_call
    def assets_analysis_absorption_ratio_post(
        self,
        ...
        :param body: (required)
        :type body: AssetsAnalysisAbsorptionRatioPostRequest
        ...
        _param = self._assets_analysis_absorption_ratio_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsAnalysisAbsorptionRatioPost200Response",
        }
    ...
    @validate_call
    def assets_analysis_absorption_ratio_post_with_http_info(
        self,
        body: AssetsAnalysisAbsorptionRatioPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsAnalysisAbsorptionRatioPost200Response]:
        """Absorption Ratio
    ...
    @validate_call
    def assets_analysis_absorption_ratio_post_without_preload_content(
        self,
        body: AssetsAnalysisAbsorptionRatioPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_analysis_absorption_ratio_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/analysis/absorption-ratio',
    ...
    @validate_call
    def assets_analysis_turbulence_index_post(
        self,
        ...
        :param body: (required)
        :type body: AssetsAnalysisTurbulenceIndexPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._assets_analysis_turbulence_index_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsAnalysisTurbulenceIndexPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def assets_analysis_turbulence_index_post_with_http_info(
        self,
        body: AssetsAnalysisTurbulenceIndexPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsAnalysisTurbulenceIndexPost200Response]:
        """Turbulence Index
    ...
    @validate_call
    def assets_analysis_turbulence_index_post_without_preload_content(
        self,
        body: AssetsAnalysisTurbulenceIndexPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_analysis_turbulence_index_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/analysis/turbulence-index',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
