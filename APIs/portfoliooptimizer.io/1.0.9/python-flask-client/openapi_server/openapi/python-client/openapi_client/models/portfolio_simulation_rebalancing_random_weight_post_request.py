...
class PortfolioSimulationRebalancingRandomWeightPostRequest(BaseModel):
    ...
    portfolios: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=25, description="The number of portfolios to simulate")
    __properties: ClassVar[List[str]] = ["assets", "portfolios"]
