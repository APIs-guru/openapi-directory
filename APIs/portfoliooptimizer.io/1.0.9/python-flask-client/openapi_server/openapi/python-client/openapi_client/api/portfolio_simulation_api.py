...
class PortfolioSimulationApi:
    ...
    @validate_call
    def portfolio_simulation_rebalancing_drift_weight_post(
        self,
        ...
        :param body: (required)
        :type body: PortfolioSimulationRebalancingDriftWeightPostRequest
        ...
        _param = self._portfolio_simulation_rebalancing_drift_weight_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PortfolioSimulationRebalancingDriftWeightPost200Response",
        }
    ...
    @validate_call
    def portfolio_simulation_rebalancing_drift_weight_post_with_http_info(
        self,
        body: PortfolioSimulationRebalancingDriftWeightPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PortfolioSimulationRebalancingDriftWeightPost200Response]:
        """Drift-weight Portfolio Rebalancing
    ...
    @validate_call
    def portfolio_simulation_rebalancing_drift_weight_post_without_preload_content(
        self,
        body: PortfolioSimulationRebalancingDriftWeightPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_simulation_rebalancing_drift_weight_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/simulation/rebalancing/drift-weight',
    ...
    @validate_call
    def portfolio_simulation_rebalancing_fixed_weight_post(
        self,
        body: PortfolioSimulationRebalancingDriftWeightPostRequest,
        _request_timeout: Union[
            None,
        ...
        _param = self._portfolio_simulation_rebalancing_fixed_weight_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def portfolio_simulation_rebalancing_fixed_weight_post_with_http_info(
        self,
        body: PortfolioSimulationRebalancingDriftWeightPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def portfolio_simulation_rebalancing_fixed_weight_post_without_preload_content(
        self,
        body: PortfolioSimulationRebalancingDriftWeightPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_simulation_rebalancing_fixed_weight_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/simulation/rebalancing/fixed-weight',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def portfolio_simulation_rebalancing_random_weight_post(
        self,
        ...
        :param body: (required)
        :type body: PortfolioSimulationRebalancingRandomWeightPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._portfolio_simulation_rebalancing_random_weight_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def portfolio_simulation_rebalancing_random_weight_post_with_http_info(
        self,
        body: PortfolioSimulationRebalancingRandomWeightPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def portfolio_simulation_rebalancing_random_weight_post_without_preload_content(
        self,
        body: PortfolioSimulationRebalancingRandomWeightPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _portfolio_simulation_rebalancing_random_weight_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/portfolio/simulation/rebalancing/random-weight',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
