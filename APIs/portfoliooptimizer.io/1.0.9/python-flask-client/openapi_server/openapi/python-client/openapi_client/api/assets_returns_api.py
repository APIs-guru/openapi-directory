...
class AssetsReturnsApi:
    ...
    @validate_call
    def assets_returns_average_post(
        self,
        body: AssetsReturnsAveragePostRequest,
        ...
        :param body: (required)
        :type body: AssetsReturnsAveragePostRequest
        ...
        _param = self._assets_returns_average_post_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsReturnsAveragePost200Response",
        }
    ...
    @validate_call
    def assets_returns_average_post_with_http_info(
        self,
        body: AssetsReturnsAveragePostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsReturnsAveragePost200Response]:
        """Arithmetic Average Return
    ...
    @validate_call
    def assets_returns_average_post_without_preload_content(
        self,
        body: AssetsReturnsAveragePostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_returns_average_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/returns/average',
    ...
    @validate_call
    def assets_returns_logarithmic_post(
        self,
        body: AssetsReturnsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: (required)
        :type body: AssetsReturnsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._assets_returns_logarithmic_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsReturnsLogarithmicPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def assets_returns_logarithmic_post_with_http_info(
        self,
        body: AssetsReturnsPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsReturnsLogarithmicPost200Response]:
        """Logarithmic Returns
    ...
    @validate_call
    def assets_returns_logarithmic_post_without_preload_content(
        self,
        body: AssetsReturnsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_returns_logarithmic_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/returns/logarithmic',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def assets_returns_post(
        ...
        _param = self._assets_returns_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsReturnsPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def assets_returns_post_with_http_info(
        self,
        body: AssetsReturnsPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsReturnsPost200Response]:
        """Arithmetic Returns
    ...
    @validate_call
    def assets_returns_post_without_preload_content(
        self,
        body: AssetsReturnsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_returns_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def assets_returns_turbulence_partitioned_post(
        self,
        body: AssetsReturnsTurbulencePartitionedPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: (required)
        :type body: AssetsReturnsTurbulencePartitionedPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._assets_returns_turbulence_partitioned_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssetsReturnsTurbulencePartitionedPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def assets_returns_turbulence_partitioned_post_with_http_info(
        self,
        body: AssetsReturnsTurbulencePartitionedPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssetsReturnsTurbulencePartitionedPost200Response]:
        """Turbulence-partitioned Asset Returns
    ...
    @validate_call
    def assets_returns_turbulence_partitioned_post_without_preload_content(
        self,
        body: AssetsReturnsTurbulencePartitionedPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _assets_returns_turbulence_partitioned_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/assets/returns/turbulence-partitioned',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
