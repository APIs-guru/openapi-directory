...
class VehicleCandidate(BaseModel):
    ...
    VehicleCandidate
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="confidence of value (percent)")
    name: Optional[StrictStr] = Field(default=None, description="name of value")
