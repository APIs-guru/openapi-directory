...
class TestTextureInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TextureInfo:
        """Test TextureInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextureInfo`
        """
        model = TextureInfo()
        if include_optional:
            return TextureInfo(
