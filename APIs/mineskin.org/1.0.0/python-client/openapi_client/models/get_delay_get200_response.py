...
class GetDelayGet200Response(BaseModel):
    """
    GetDelayGet200Response
    """ # noqa: E501
    delay: Optional[StrictInt] = None
    next: Optional[StrictInt] = None
    next_relative: Optional[StrictInt] = Field(default=None, alias="nextRelative")
    __properties: ClassVar[List[str]] = ["delay", "next", "nextRelative"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delay": obj.get("delay"),
            "next": obj.get("next"),
            "nextRelative": obj.get("nextRelative")
        })
        return _obj
