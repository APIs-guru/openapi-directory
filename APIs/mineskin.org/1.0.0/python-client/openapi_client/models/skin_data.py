...
class SkinData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["texture", "uuid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of texture
        if self.texture:
            _dict['texture'] = self.texture.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "texture": TextureInfo.from_dict(obj["texture"]) if obj.get("texture") is not None else None,
            "uuid": obj.get("uuid")
        })
        return _obj
