...
class GenerateUploadPost429Response(BaseModel):
    """
    GenerateUploadPost429Response
    """ # noqa: E501
    delay: Optional[StrictInt] = Field(default=None, description="The API's current delay in seconds")
    error: StrictStr = Field(description="Error message")
    next_request: Optional[StrictInt] = Field(default=None, description="Unix timestamp when the next request is allowed", alias="nextRequest")
    __properties: ClassVar[List[str]] = ["delay", "error", "nextRequest"]
