...
class BetaAppLocalizationUpdateRequestData(BaseModel):
    """
    BetaAppLocalizationUpdateRequestData
    """ # noqa: E501
    attributes: Optional[BetaAppLocalizationUpdateRequestDataAttributes] = None
    id: StrictStr
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['betaAppLocalizations']):
            raise ValueError("must be one of enum values ('betaAppLocalizations')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": BetaAppLocalizationUpdateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
