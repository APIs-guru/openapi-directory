...
class BuildsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[Build]
    included: Optional[List[BuildResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [BuildResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
