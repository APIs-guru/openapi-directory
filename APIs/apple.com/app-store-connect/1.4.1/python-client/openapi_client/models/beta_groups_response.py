...
class BetaGroupsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[BetaGroup]
    included: Optional[List[BetaGroupResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BetaGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [BetaGroupResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
