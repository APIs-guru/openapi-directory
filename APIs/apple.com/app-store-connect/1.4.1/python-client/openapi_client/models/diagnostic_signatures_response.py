...
class DiagnosticSignaturesResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DiagnosticSignature.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [DiagnosticLog.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
