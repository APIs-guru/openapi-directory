...
class BuildIcon(BaseModel):
    ...
    BuildIcon
    """ # noqa: E501
    attributes: Optional[BuildIconAttributes] = None
    id: StrictStr
    links: ResourceLinks
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['buildIcons']):
            raise ValueError("must be one of enum values ('buildIcons')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": BuildIconAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
