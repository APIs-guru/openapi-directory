...
class AppUpdateRequestData(BaseModel):
    ...
    id: StrictStr
    relationships: Optional[AppUpdateRequestDataRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "relationships": AppUpdateRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
