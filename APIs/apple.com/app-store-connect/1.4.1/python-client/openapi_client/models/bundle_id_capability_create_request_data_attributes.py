...
class BundleIdCapabilityCreateRequestDataAttributes(BaseModel):
    """
    BundleIdCapabilityCreateRequestDataAttributes
    """ # noqa: E501
    capability_type: CapabilityType = Field(alias="capabilityType")
    settings: Optional[List[CapabilitySetting]] = None
    __properties: ClassVar[List[str]] = ["capabilityType", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilityType": obj.get("capabilityType"),
            "settings": [CapabilitySetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
