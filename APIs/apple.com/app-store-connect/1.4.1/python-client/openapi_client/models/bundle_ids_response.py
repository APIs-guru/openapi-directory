...
class BundleIdsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[BundleId]
    included: Optional[List[BundleIdResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [BundleIdResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
