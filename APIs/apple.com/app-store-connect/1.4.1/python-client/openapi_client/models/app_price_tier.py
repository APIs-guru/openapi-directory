...
class AppPriceTier(BaseModel):
    ...
    id: StrictStr
    links: ResourceLinks
    relationships: Optional[AppPriceTierRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": AppPriceTierRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
