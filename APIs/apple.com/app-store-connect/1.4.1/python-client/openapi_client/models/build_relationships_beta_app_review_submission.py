...
class BuildRelationshipsBetaAppReviewSubmission(BaseModel):
    """
    BuildRelationshipsBetaAppReviewSubmission
    """ # noqa: E501
    data: Optional[BuildRelationshipsBetaAppReviewSubmissionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BuildRelationshipsBetaAppReviewSubmissionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
