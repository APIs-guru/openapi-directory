...
class AppRelationshipsEndUserLicenseAgreementData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['endUserLicenseAgreements']):
            raise ValueError("must be one of enum values ('endUserLicenseAgreements')")
        return value
