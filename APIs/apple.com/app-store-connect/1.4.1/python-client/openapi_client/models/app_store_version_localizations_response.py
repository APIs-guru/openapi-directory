...
class AppStoreVersionLocalizationsResponse(BaseModel):
    ...
    included: Optional[List[AppStoreVersionLocalizationResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [AppStoreVersionLocalizationResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
