...
class AppCategoryResponse(BaseModel):
    ...
    """ # noqa: E501
    data: AppCategory
    included: Optional[List[AppCategoriesResponseIncludedInner]] = None
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": [AppCategoriesResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
