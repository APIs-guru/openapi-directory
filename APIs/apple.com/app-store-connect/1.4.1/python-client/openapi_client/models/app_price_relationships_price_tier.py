...
class AppPriceRelationshipsPriceTier(BaseModel):
    """
    AppPriceRelationshipsPriceTier
    """ # noqa: E501
    data: Optional[AppPriceRelationshipsPriceTierData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppPriceRelationshipsPriceTierData.from_dict(obj["data"]) if obj.get("data") is not None else None,
