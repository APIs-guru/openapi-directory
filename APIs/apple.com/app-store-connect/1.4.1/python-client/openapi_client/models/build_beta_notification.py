...
class BuildBetaNotification(BaseModel):
    ...
    links: ResourceLinks
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "links", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['buildBetaNotifications']):
            raise ValueError("must be one of enum values ('buildBetaNotifications')")
        return value
