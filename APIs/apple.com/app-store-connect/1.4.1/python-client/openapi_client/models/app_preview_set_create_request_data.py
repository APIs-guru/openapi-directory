...
class AppPreviewSetCreateRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appPreviewSets']):
            raise ValueError("must be one of enum values ('appPreviewSets')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": AppPreviewSetCreateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
