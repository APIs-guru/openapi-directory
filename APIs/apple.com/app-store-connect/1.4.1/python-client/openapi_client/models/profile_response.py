...
class ProfileResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Profile
    included: Optional[List[ProfileResponseIncludedInner]] = None
    links: DocumentLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Profile.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [ProfileResponseIncludedInner.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
