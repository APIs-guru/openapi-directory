...
class AppPriceTierRelationships(BaseModel):
    """
    AppPriceTierRelationships
    """ # noqa: E501
    price_points: Optional[AppPriceTierRelationshipsPricePoints] = Field(default=None, alias="pricePoints")
    __properties: ClassVar[List[str]] = ["pricePoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pricePoints": AppPriceTierRelationshipsPricePoints.from_dict(obj["pricePoints"]) if obj.get("pricePoints") is not None else None
        })
        return _obj
