...
class AppStoreReviewAttachmentUpdateRequestData(BaseModel):
    """
    AppStoreReviewAttachmentUpdateRequestData
    """ # noqa: E501
    attributes: Optional[AppScreenshotUpdateRequestDataAttributes] = None
    id: StrictStr
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appStoreReviewAttachments']):
            raise ValueError("must be one of enum values ('appStoreReviewAttachments')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": AppScreenshotUpdateRequestDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
