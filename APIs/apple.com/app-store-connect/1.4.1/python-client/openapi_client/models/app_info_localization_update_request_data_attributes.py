...
class AppInfoLocalizationUpdateRequestDataAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "privacyPolicyText", "privacyPolicyUrl", "subtitle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "privacyPolicyText": obj.get("privacyPolicyText"),
