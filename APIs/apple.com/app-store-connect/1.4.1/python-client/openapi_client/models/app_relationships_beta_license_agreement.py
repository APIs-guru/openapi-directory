...
class AppRelationshipsBetaLicenseAgreement(BaseModel):
    """
    AppRelationshipsBetaLicenseAgreement
    """ # noqa: E501
    data: Optional[AppRelationshipsBetaLicenseAgreementData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppRelationshipsBetaLicenseAgreementData.from_dict(obj["data"]) if obj.get("data") is not None else None,
