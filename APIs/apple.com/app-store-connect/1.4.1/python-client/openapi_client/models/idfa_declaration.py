...
class IdfaDeclaration(BaseModel):
    ...
    IdfaDeclaration
    """ # noqa: E501
    attributes: Optional[IdfaDeclarationAttributes] = None
    id: StrictStr
    links: ResourceLinks
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['idfaDeclarations']):
            raise ValueError("must be one of enum values ('idfaDeclarations')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": IdfaDeclarationAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
