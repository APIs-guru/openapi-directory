...
class ErrorResponseErrorsInner(BaseModel):
    ...
    source: Optional[ErrorResponseErrorsInnerSource] = None
    status: StrictStr
    title: StrictStr
    __properties: ClassVar[List[str]] = ["code", "detail", "id", "source", "status", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "source": ErrorResponseErrorsInnerSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
