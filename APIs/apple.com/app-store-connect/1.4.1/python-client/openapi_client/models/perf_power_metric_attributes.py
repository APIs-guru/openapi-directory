...
class PerfPowerMetricAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["deviceType", "metricType", "platform"]
    ...
    def metric_type_validate_enum(cls, value):
        ...
        if value not in set(['DISK', 'HANG', 'BATTERY', 'LAUNCH', 'MEMORY', 'ANIMATION', 'TERMINATION']):
            raise ValueError("must be one of enum values ('DISK', 'HANG', 'BATTERY', 'LAUNCH', 'MEMORY', 'ANIMATION', 'TERMINATION')")
        return value
    ...
    def platform_validate_enum(cls, value):
        ...
        if value not in set(['IOS']):
            raise ValueError("must be one of enum values ('IOS')")
        return value
