...
class AppStoreVersionLocalizationUpdateRequestDataAttributes(BaseModel):
    """
    ...
    whats_new: Optional[StrictStr] = Field(default=None, alias="whatsNew")
    __properties: ClassVar[List[str]] = ["description", "keywords", "marketingUrl", "promotionalText", "supportUrl", "whatsNew"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "promotionalText": obj.get("promotionalText"),
            "supportUrl": obj.get("supportUrl"),
            "whatsNew": obj.get("whatsNew")
        })
        return _obj
