...
class TestBetaTesterResponseIncludedInner(unittest.TestCase):
    """BetaTesterResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaTesterResponseIncludedInner:
        """Test BetaTesterResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaTesterResponseIncludedInner`
        """
        model = BetaTesterResponseIncludedInner()
        if include_optional:
            return BetaTesterResponseIncludedInner(
    ...
    def testBetaTesterResponseIncludedInner(self):
        """Test BetaTesterResponseIncludedInner"""
