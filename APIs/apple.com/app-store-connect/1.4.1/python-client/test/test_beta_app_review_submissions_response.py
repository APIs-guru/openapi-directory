...
class TestBetaAppReviewSubmissionsResponse(unittest.TestCase):
    """BetaAppReviewSubmissionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaAppReviewSubmissionsResponse:
        """Test BetaAppReviewSubmissionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaAppReviewSubmissionsResponse`
        """
        model = BetaAppReviewSubmissionsResponse()
        if include_optional:
            return BetaAppReviewSubmissionsResponse(
                data = [
                    openapi_client.models.beta_app_review_submission.BetaAppReviewSubmission(
    ...
    def testBetaAppReviewSubmissionsResponse(self):
        """Test BetaAppReviewSubmissionsResponse"""
