...
class TestAppPriceResponse(unittest.TestCase):
    """AppPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPriceResponse:
        """Test AppPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPriceResponse`
        """
        model = AppPriceResponse()
        if include_optional:
            return AppPriceResponse(
                data = openapi_client.models.app_price.AppPrice(
                    id = '', 
