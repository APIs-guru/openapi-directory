...
class TestAgeRatingDeclaration(unittest.TestCase):
    """AgeRatingDeclaration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgeRatingDeclaration:
        """Test AgeRatingDeclaration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeRatingDeclaration`
        """
        model = AgeRatingDeclaration()
        if include_optional:
    ...
    def testAgeRatingDeclaration(self):
        """Test AgeRatingDeclaration"""
