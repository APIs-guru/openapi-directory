...
class TestAppPricesResponse(unittest.TestCase):
    """AppPricesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPricesResponse:
        """Test AppPricesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPricesResponse`
        """
        model = AppPricesResponse()
        if include_optional:
            return AppPricesResponse(
                data = [
                    openapi_client.models.app_price.AppPrice(
                        id = '', 
    ...
    def testAppPricesResponse(self):
        """Test AppPricesResponse"""
