...
class TestBetaAppReviewSubmissionResponse(unittest.TestCase):
    """BetaAppReviewSubmissionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaAppReviewSubmissionResponse:
        """Test BetaAppReviewSubmissionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaAppReviewSubmissionResponse`
        """
        model = BetaAppReviewSubmissionResponse()
        if include_optional:
            return BetaAppReviewSubmissionResponse(
                data = openapi_client.models.beta_app_review_submission.BetaAppReviewSubmission(
    ...
    def testBetaAppReviewSubmissionResponse(self):
        """Test BetaAppReviewSubmissionResponse"""
