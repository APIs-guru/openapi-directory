...
class TestAppStoreVersionResponseIncludedInner(unittest.TestCase):
    """AppStoreVersionResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreVersionResponseIncludedInner:
        """Test AppStoreVersionResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreVersionResponseIncludedInner`
        """
        model = AppStoreVersionResponseIncludedInner()
        if include_optional:
            return AppStoreVersionResponseIncludedInner(
    ...
    def testAppStoreVersionResponseIncludedInner(self):
        """Test AppStoreVersionResponseIncludedInner"""
