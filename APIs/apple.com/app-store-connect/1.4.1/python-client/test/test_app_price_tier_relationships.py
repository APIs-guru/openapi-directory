...
class TestAppPriceTierRelationships(unittest.TestCase):
    """AppPriceTierRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPriceTierRelationships:
        """Test AppPriceTierRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPriceTierRelationships`
        """
        model = AppPriceTierRelationships()
        if include_optional:
            return AppPriceTierRelationships(
    ...
    def testAppPriceTierRelationships(self):
        """Test AppPriceTierRelationships"""
