...
class TestIdfaDeclaration(unittest.TestCase):
    """IdfaDeclaration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdfaDeclaration:
        """Test IdfaDeclaration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdfaDeclaration`
        """
        model = IdfaDeclaration()
        if include_optional:
