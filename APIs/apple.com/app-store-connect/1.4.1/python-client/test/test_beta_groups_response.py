...
class TestBetaGroupsResponse(unittest.TestCase):
    """BetaGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaGroupsResponse:
        """Test BetaGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaGroupsResponse`
        """
        model = BetaGroupsResponse()
        if include_optional:
    ...
    def testBetaGroupsResponse(self):
        """Test BetaGroupsResponse"""
