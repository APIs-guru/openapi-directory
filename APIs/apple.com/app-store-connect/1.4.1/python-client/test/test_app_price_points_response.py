...
class TestAppPricePointsResponse(unittest.TestCase):
    """AppPricePointsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPricePointsResponse:
        """Test AppPricePointsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPricePointsResponse`
        """
        model = AppPricePointsResponse()
        if include_optional:
    ...
    def testAppPricePointsResponse(self):
        """Test AppPricePointsResponse"""
