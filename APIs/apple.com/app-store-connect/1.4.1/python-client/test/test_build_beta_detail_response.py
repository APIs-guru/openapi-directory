...
class TestBuildBetaDetailResponse(unittest.TestCase):
    """BuildBetaDetailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildBetaDetailResponse:
        """Test BuildBetaDetailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildBetaDetailResponse`
        """
        model = BuildBetaDetailResponse()
        if include_optional:
            return BuildBetaDetailResponse(
                data = openapi_client.models.build_beta_detail.BuildBetaDetail(
    ...
    def testBuildBetaDetailResponse(self):
        """Test BuildBetaDetailResponse"""
