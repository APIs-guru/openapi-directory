...
class TestBetaGroupResponseIncludedInner(unittest.TestCase):
    """BetaGroupResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BetaGroupResponseIncludedInner:
        """Test BetaGroupResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BetaGroupResponseIncludedInner`
        """
        model = BetaGroupResponseIncludedInner()
        if include_optional:
            return BetaGroupResponseIncludedInner(
    ...
    def testBetaGroupResponseIncludedInner(self):
        """Test BetaGroupResponseIncludedInner"""
