...
class TestIdfaDeclarationCreateRequestData(unittest.TestCase):
    """IdfaDeclarationCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdfaDeclarationCreateRequestData:
        """Test IdfaDeclarationCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdfaDeclarationCreateRequestData`
        """
        model = IdfaDeclarationCreateRequestData()
        if include_optional:
            return IdfaDeclarationCreateRequestData(
    ...
    def testIdfaDeclarationCreateRequestData(self):
        """Test IdfaDeclarationCreateRequestData"""
