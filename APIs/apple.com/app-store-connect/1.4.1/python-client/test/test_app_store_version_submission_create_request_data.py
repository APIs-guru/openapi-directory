...
class TestAppStoreVersionSubmissionCreateRequestData(unittest.TestCase):
    """AppStoreVersionSubmissionCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppStoreVersionSubmissionCreateRequestData:
        """Test AppStoreVersionSubmissionCreateRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppStoreVersionSubmissionCreateRequestData`
        """
        model = AppStoreVersionSubmissionCreateRequestData()
        if include_optional:
            return AppStoreVersionSubmissionCreateRequestData(
    ...
    def testAppStoreVersionSubmissionCreateRequestData(self):
        """Test AppStoreVersionSubmissionCreateRequestData"""
