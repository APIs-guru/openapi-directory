...
class TestAppEncryptionDeclarationResponse(unittest.TestCase):
    """AppEncryptionDeclarationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEncryptionDeclarationResponse:
        """Test AppEncryptionDeclarationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEncryptionDeclarationResponse`
        """
        model = AppEncryptionDeclarationResponse()
        if include_optional:
    ...
    def testAppEncryptionDeclarationResponse(self):
        """Test AppEncryptionDeclarationResponse"""
