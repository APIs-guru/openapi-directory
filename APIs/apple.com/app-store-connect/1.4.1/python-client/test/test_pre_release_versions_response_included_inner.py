...
class TestPreReleaseVersionsResponseIncludedInner(unittest.TestCase):
    """PreReleaseVersionsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreReleaseVersionsResponseIncludedInner:
        """Test PreReleaseVersionsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreReleaseVersionsResponseIncludedInner`
        """
        model = PreReleaseVersionsResponseIncludedInner()
        if include_optional:
    ...
    def testPreReleaseVersionsResponseIncludedInner(self):
        """Test PreReleaseVersionsResponseIncludedInner"""
