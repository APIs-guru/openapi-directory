...
class PlayMediaIntentHandlingHandleInvocationResponse(InvocationResponse):
    ...
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PlayMediaIntentHandling.handle']):
            raise ValueError("must be one of enum values ('PlayMediaIntentHandling.handle')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayMediaIntentHandlingHandleInvocationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayMediaIntentHandlingHandleInvocationResponse from a dict"""
        if obj is None:
            return None
