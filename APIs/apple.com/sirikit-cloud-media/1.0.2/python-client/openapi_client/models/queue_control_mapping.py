...
class QueueControlMapping(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueueControlMapping from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueueControlMapping from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "default": PlayMediaControl.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
