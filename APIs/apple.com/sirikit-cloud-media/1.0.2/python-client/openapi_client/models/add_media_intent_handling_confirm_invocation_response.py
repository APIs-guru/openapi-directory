...
class AddMediaIntentHandlingConfirmInvocationResponse(InvocationResponse):
    ...
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AddMediaIntentHandling.confirm']):
            raise ValueError("must be one of enum values ('AddMediaIntentHandling.confirm')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddMediaIntentHandlingConfirmInvocationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddMediaIntentHandlingConfirmInvocationResponse from a dict"""
        if obj is None:
            return None
