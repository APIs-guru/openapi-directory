...
class MediaDestinationLibrary(MediaDestination):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MediaDestinationLibrary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MediaDestinationLibrary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mediaDestinationType": obj.get("mediaDestinationType")
        })
        return _obj
