...
class PlayMediaIntentHandlingResolveMediaItemsInvocationResponse(InvocationResponse):
    ...
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PlayMediaIntentHandling.resolveMediaItems']):
            raise ValueError("must be one of enum values ('PlayMediaIntentHandling.resolveMediaItems')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayMediaIntentHandlingResolveMediaItemsInvocationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayMediaIntentHandlingResolveMediaItemsInvocationResponse from a dict"""
        if obj is None:
            return None
