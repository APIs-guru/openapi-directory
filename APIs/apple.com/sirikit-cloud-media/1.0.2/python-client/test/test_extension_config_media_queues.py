...
class TestExtensionConfigMediaQueues(unittest.TestCase):
    """ExtensionConfigMediaQueues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtensionConfigMediaQueues:
        """Test ExtensionConfigMediaQueues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtensionConfigMediaQueues`
        """
        model = ExtensionConfigMediaQueues()
        if include_optional:
    ...
    def testExtensionConfigMediaQueues(self):
        """Test ExtensionConfigMediaQueues"""
