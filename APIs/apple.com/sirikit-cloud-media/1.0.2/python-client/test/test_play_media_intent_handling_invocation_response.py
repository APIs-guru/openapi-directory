...
class TestPlayMediaIntentHandlingInvocationResponse(unittest.TestCase):
    """PlayMediaIntentHandlingInvocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayMediaIntentHandlingInvocationResponse:
        """Test PlayMediaIntentHandlingInvocationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayMediaIntentHandlingInvocationResponse`
        """
        model = PlayMediaIntentHandlingInvocationResponse()
        if include_optional:
    ...
    def testPlayMediaIntentHandlingInvocationResponse(self):
        """Test PlayMediaIntentHandlingInvocationResponse"""
