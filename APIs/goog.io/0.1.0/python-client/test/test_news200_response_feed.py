...
class TestNews200ResponseFeed(unittest.TestCase):
    """News200ResponseFeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> News200ResponseFeed:
        """Test News200ResponseFeed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `News200ResponseFeed`
        """
        model = News200ResponseFeed()
        if include_optional:
            return News200ResponseFeed(
                generator = '',
                generator_detail = '',
                language = '',
                link = '',
    ...
    def testNews200ResponseFeed(self):
        """Test News200ResponseFeed"""
