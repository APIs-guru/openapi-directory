...
class TestImages200ResponseImageResultsInnerImage(unittest.TestCase):
    """Images200ResponseImageResultsInnerImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Images200ResponseImageResultsInnerImage:
        """Test Images200ResponseImageResultsInnerImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Images200ResponseImageResultsInnerImage`
        """
        model = Images200ResponseImageResultsInnerImage()
        if include_optional:
            return Images200ResponseImageResultsInnerImage(
                alt = '',
                src = ''
            )
        else:
    ...
    def testImages200ResponseImageResultsInnerImage(self):
        """Test Images200ResponseImageResultsInnerImage"""
