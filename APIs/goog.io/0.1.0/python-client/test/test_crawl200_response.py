...
class TestCrawl200Response(unittest.TestCase):
    """Crawl200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Crawl200Response:
        """Test Crawl200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Crawl200Response`
        """
        model = Crawl200Response()
        if include_optional:
