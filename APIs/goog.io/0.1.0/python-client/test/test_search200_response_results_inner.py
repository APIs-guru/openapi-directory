...
class TestSearch200ResponseResultsInner(unittest.TestCase):
    """Search200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Search200ResponseResultsInner:
        """Test Search200ResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Search200ResponseResultsInner`
        """
        model = Search200ResponseResultsInner()
        if include_optional:
            return Search200ResponseResultsInner(
                description = '',
                link = '',
                title = ''
            )
    ...
    def testSearch200ResponseResultsInner(self):
        """Test Search200ResponseResultsInner"""
