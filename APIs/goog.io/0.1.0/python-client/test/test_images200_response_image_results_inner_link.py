...
class TestImages200ResponseImageResultsInnerLink(unittest.TestCase):
    """Images200ResponseImageResultsInnerLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Images200ResponseImageResultsInnerLink:
        """Test Images200ResponseImageResultsInnerLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Images200ResponseImageResultsInnerLink`
        """
        model = Images200ResponseImageResultsInnerLink()
        if include_optional:
            return Images200ResponseImageResultsInnerLink(
                domain = '',
                href = '',
                title = ''
            )
    ...
    def testImages200ResponseImageResultsInnerLink(self):
        """Test Images200ResponseImageResultsInnerLink"""
