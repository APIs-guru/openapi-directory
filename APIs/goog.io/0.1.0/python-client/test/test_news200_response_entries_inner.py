...
class TestNews200ResponseEntriesInner(unittest.TestCase):
    """News200ResponseEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> News200ResponseEntriesInner:
        """Test News200ResponseEntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `News200ResponseEntriesInner`
        """
        model = News200ResponseEntriesInner()
        if include_optional:
            return News200ResponseEntriesInner(
                guidislink = '',
                id = '',
                link = '',
                links = '',
    ...
    def testNews200ResponseEntriesInner(self):
        """Test News200ResponseEntriesInner"""
