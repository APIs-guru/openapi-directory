...
class TestSerpData(unittest.TestCase):
    """SerpData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SerpData:
        """Test SerpData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SerpData`
        """
        model = SerpData()
        if include_optional:
            return SerpData(
