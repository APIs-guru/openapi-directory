...
class TestNews200Response(unittest.TestCase):
    """News200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> News200Response:
        """Test News200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `News200Response`
        """
        model = News200Response()
        if include_optional:
            return News200Response(
                entries = [
                    openapi_client.models.news_200_response_entries_inner.News_200_response_entries_inner(
                        guidislink = '', 
                        id = '', 
                        link = '', 
                        links = '', 
                ...
                feed = openapi_client.models.news_200_response_feed.News_200_response_feed(
                    generator = '', 
                    generator_detail = '', 
                    language = '', 
                    link = '', 
