...
class TestSerp200Response(unittest.TestCase):
    """Serp200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Serp200Response:
        """Test Serp200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Serp200Response`
        """
        model = Serp200Response()
        if include_optional:
