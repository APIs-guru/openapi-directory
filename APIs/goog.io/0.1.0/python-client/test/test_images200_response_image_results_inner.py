...
class TestImages200ResponseImageResultsInner(unittest.TestCase):
    """Images200ResponseImageResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Images200ResponseImageResultsInner:
        """Test Images200ResponseImageResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Images200ResponseImageResultsInner`
        """
        model = Images200ResponseImageResultsInner()
        if include_optional:
            return Images200ResponseImageResultsInner(
                image = openapi_client.models.images_200_response_image_results_inner_image.Images_200_response_image_results_inner_image(
                    alt = '', 
                    src = '', ),
                link = openapi_client.models.images_200_response_image_results_inner_link.Images_200_response_image_results_inner_link(
                    domain = '', 
                    href = '', 
                    title = '', )
            )
    ...
    def testImages200ResponseImageResultsInner(self):
        """Test Images200ResponseImageResultsInner"""
