...
class Serp200Response(BaseModel):
    """
    Serp200Response
    """ # noqa: E501
    position: Optional[StrictInt] = None
    query: Optional[StrictStr] = None
    searched_results: Optional[StrictInt] = None
    website: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["position", "query", "searched_results", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": obj.get("query"),
            "searched_results": obj.get("searched_results"),
