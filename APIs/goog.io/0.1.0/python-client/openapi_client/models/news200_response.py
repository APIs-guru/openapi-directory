...
class News200Response(BaseModel):
    """
    News200Response
    """ # noqa: E501
    entries: Optional[List[News200ResponseEntriesInner]] = None
    feed: Optional[News200ResponseFeed] = None
    __properties: ClassVar[List[str]] = ["entries", "feed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [News200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "feed": News200ResponseFeed.from_dict(obj["feed"]) if obj.get("feed") is not None else None
        })
        return _obj
