...
class Images200ResponseImageResultsInner(BaseModel):
    """
    Images200ResponseImageResultsInner
    """ # noqa: E501
    image: Optional[Images200ResponseImageResultsInnerImage] = None
    link: Optional[Images200ResponseImageResultsInnerLink] = None
    __properties: ClassVar[List[str]] = ["image", "link"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": Images200ResponseImageResultsInnerImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "link": Images200ResponseImageResultsInnerLink.from_dict(obj["link"]) if obj.get("link") is not None else None
        })
        return _obj
