...
class News200ResponseEntriesInner(BaseModel):
    """
    News200ResponseEntriesInner
    """ # noqa: E501
    guidislink: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    link: Optional[StrictStr] = None
    links: Optional[StrictStr] = None
    published: Optional[StrictStr] = None
    published_parsed: Optional[StrictStr] = None
    source: Optional[StrictStr] = None
    sub_articles: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    summary_detail: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    title_detail: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["guidislink", "id", "link", "links", "published", "published_parsed", "source", "sub_articles", "summary", "summary_detail", "title", "title_detail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "guidislink": obj.get("guidislink"),
            "id": obj.get("id"),
            "link": obj.get("link"),
            "links": obj.get("links"),
            "published": obj.get("published"),
            "published_parsed": obj.get("published_parsed"),
            "source": obj.get("source"),
            "sub_articles": obj.get("sub_articles"),
            "summary": obj.get("summary"),
            "summary_detail": obj.get("summary_detail"),
            "title": obj.get("title"),
            "title_detail": obj.get("title_detail")
        })
        return _obj
