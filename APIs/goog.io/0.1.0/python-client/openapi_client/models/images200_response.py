...
class Images200Response(BaseModel):
    """
    Images200Response
    """ # noqa: E501
    answers: Optional[List[StrictStr]] = None
    image_results: Optional[List[Images200ResponseImageResultsInner]] = None
    results: Optional[List[Dict[str, Any]]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["answers", "image_results", "results", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image_results": [Images200ResponseImageResultsInner.from_dict(_item) for _item in obj["image_results"]] if obj.get("image_results") is not None else None,
