...
class Search200Response(BaseModel):
    ...
    results: Optional[List[Search200ResponseResultsInner]] = None
    total: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["answer", "results", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [Search200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total")
        })
        return _obj
