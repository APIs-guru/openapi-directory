...
class OrderChangeMessage(ResponseMessage):
    ...
    oc: Optional[List[OrderMarketChange]] = Field(default=None, description="OrderMarketChanges - the modifications to account's orders (will be null on a heartbeat")
    ...
    __properties: ClassVar[List[str]] = ["id", "op", "clk", "conflateMs", "ct", "heartbeatMs", "initialClk", "oc", "pt", "segmentType", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in oc (list)
        _items = []
        if self.oc:
            for _item_oc in self.oc:
                if _item_oc:
                    _items.append(_item_oc.to_dict())
            _dict['oc'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oc": [OrderMarketChange.from_dict(_item) for _item in obj["oc"]] if obj.get("oc") is not None else None,
            "pt": obj.get("pt"),
