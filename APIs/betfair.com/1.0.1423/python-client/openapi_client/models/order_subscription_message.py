...
class OrderSubscriptionMessage(RequestMessage):
    ...
    order_filter: Optional[OrderFilter] = Field(default=None, alias="orderFilter")
    ...
    __properties: ClassVar[List[str]] = ["id", "op", "clk", "conflateMs", "heartbeatMs", "initialClk", "orderFilter", "segmentationEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of order_filter
        if self.order_filter:
            _dict['orderFilter'] = self.order_filter.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderFilter": OrderFilter.from_dict(obj["orderFilter"]) if obj.get("orderFilter") is not None else None,
