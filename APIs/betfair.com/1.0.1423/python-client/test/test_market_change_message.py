...
class TestMarketChangeMessage(unittest.TestCase):
    """MarketChangeMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketChangeMessage:
        """Test MarketChangeMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketChangeMessage`
        """
        model = MarketChangeMessage()
        if include_optional:
            return MarketChangeMessage(
                ...
                initial_clk = '',
                mc = [
                    openapi_client.models.market_change.MarketChange(
                        con = True, 
                        id = '', 
                        img = True, 
                        market_definition = openapi_client.models.market_definition.MarketDefinition(
                            bet_delay = 56, 
                            betting_type = 'ODDS', 
                            bsp_market = True, 
                            bsp_reconciled = True, 
                            ...
                            version = 56, ), 
                        rc = [
                            openapi_client.models.runner_change.RunnerChange(
                                atb = [
                                    [
                                        1.337
                                        ]
    ...
    def testMarketChangeMessage(self):
        """Test MarketChangeMessage"""
