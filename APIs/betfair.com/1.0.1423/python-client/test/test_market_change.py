...
class TestMarketChange(unittest.TestCase):
    """MarketChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketChange:
        """Test MarketChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketChange`
        """
        model = MarketChange()
        if include_optional:
            return MarketChange(
