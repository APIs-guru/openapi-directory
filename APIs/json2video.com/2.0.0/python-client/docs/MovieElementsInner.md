...
movie_elements_inner_instance = MovieElementsInner.from_json(json)
# print the JSON string representation of the object
print(MovieElementsInner.to_json())

# convert the object into a dict
movie_elements_inner_dict = movie_elements_inner_instance.to_dict()
# create an instance of MovieElementsInner from a dict
movie_elements_inner_from_dict = MovieElementsInner.from_dict(movie_elements_inner_dict)
```
