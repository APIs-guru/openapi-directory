...
**height** | **int** | Desired text element height, but can be overriden by the style defaults. A value of &lt;code&gt;-1&lt;/code&gt; means inherits scenes or movie height | [optional] [default to -1]
...
**type** | **str** |  | 
**width** | **int** | Desired text element width, but can be overriden by the style defaults. A value of &lt;code&gt;-1&lt;/code&gt; means inherits scenes or movie width | [optional] [default to -1]
