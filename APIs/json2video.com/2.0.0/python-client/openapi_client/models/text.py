...
class Text(BaseModel):
    ...
    height: Optional[Annotated[int, Field(le=1080, strict=True, ge=-1)]] = Field(default=-1, description="Desired text element height, but can be overriden by the style defaults. A value of <code>-1</code> means inherits scenes or movie height")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Text formatting settings. In general, these are CSS properties such as <code>font-size</code>, <code>colour</code> or <code>font-weight</code>. See the styles to confirm which properties are available.")
    style: Optional[StrictStr] = Field(default='001', description="Style of the text element. Check all available text style at <a href='https://json2video.com/docs/resources/text/'>https://json2video.com/resources/text/</a>")
    text: StrictStr = Field(description="Text to be printed. The text string does not accept HTML formatting.")
    type: StrictStr
    width: Optional[Annotated[int, Field(le=1920, strict=True, ge=-1)]] = Field(default=-1, description="Desired text element width, but can be overriden by the style defaults. A value of <code>-1</code> means inherits scenes or movie width")
    __properties: ClassVar[List[str]] = ["cache", "comment", "duration", "extra-time", "fade-in", "fade-out", "start", "z-index", "chroma-key", "crop", "pan", "position", "rotate", "scale", "x", "y", "zoom", "height", "settings", "style", "text", "type", "width"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "style": obj.get("style") if obj.get("style") is not None else '001',
            "text": obj.get("text"),
            "type": obj.get("type"),
