...
class Template(BaseModel):
    ...
    height: Optional[Annotated[int, Field(le=1080, strict=True, ge=-1)]] = Field(default=-1, description="Desired text element height, but can be overriden by the component defaults. A value of <code>-1</code> means inherits scenes or movie height")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Settings to be passed to the component")
    template: StrictStr = Field(description="ID of the Component element. Check all available components at <a href='https://json2video.com/docs/resources/basic/'>https://json2video.com/docs/resources/basic/</a>")
    type: StrictStr
    width: Optional[Annotated[int, Field(le=1920, strict=True, ge=-1)]] = Field(default=-1, description="Desired text element width, but can be overriden by the component defaults. A value of <code>-1</code> means inherits scenes or movie width")
    __properties: ClassVar[List[str]] = ["cache", "comment", "duration", "extra-time", "fade-in", "fade-out", "start", "z-index", "chroma-key", "crop", "pan", "position", "rotate", "scale", "x", "y", "zoom", "height", "settings", "template", "type", "width"]
