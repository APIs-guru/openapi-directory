...
class Component(BaseModel):
    ...
    component: StrictStr = Field(description="ID of the Component element. Check all available components in the <a href='https://json2video.com/docs/resources/basic/'>library</a>")
    ...
    __properties: ClassVar[List[str]] = ["cache", "comment", "duration", "extra-time", "fade-in", "fade-out", "start", "z-index", "chroma-key", "crop", "pan", "position", "rotate", "scale", "x", "y", "zoom", "component", "height", "settings", "type", "width"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['component']):
            raise ValueError("must be one of enum values ('component')")
        return value
