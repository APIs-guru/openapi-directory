...
class Video(BaseModel):
    ...
    src: Optional[StrictStr] = Field(default=None, description="URL to the asset file. Videos can be in MP4, MKV, MOV but MP4 is recommended.")
    type: StrictStr
    loop: Optional[Annotated[int, Field(strict=True, ge=-1)]] = Field(default=None, description="Sets the number of loops the video to play. Use -1 for an infinite loop. The default value of 1 plays the video just once.")
    __properties: ClassVar[List[str]] = ["cache", "comment", "duration", "extra-time", "fade-in", "fade-out", "start", "z-index", "chroma-key", "crop", "pan", "position", "rotate", "scale", "x", "y", "zoom", "muted", "volume", "src", "type", "loop"]
