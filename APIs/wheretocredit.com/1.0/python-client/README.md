...
------------ | ------------- | ------------- | -------------
*CalculateApi* | [**api10_calculate_post**](docs/CalculateApi.md#api10_calculate_post) | **POST** /api/1.0/calculate | Calculates the number of miles earned for every frequent flyer program.
*ProgramsApi* | [**api10_programs_get**](docs/ProgramsApi.md#api10_programs_get) | **GET** /api/1.0/programs | Lists all supported frequent flyer programs.


## Documentation For Models

 - [CalculateItineraryProgramResult](docs/CalculateItineraryProgramResult.md)
 - [CalculateItineraryResult](docs/CalculateItineraryResult.md)
 - [CalculateResult](docs/CalculateResult.md)
