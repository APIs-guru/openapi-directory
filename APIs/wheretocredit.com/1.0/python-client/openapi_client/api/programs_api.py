...
class ProgramsApi:
    ...
    def api10_programs_get(
        ...
        _param = self._api10_programs_get_serialize(
    ...
    @validate_call
    def api10_programs_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api10_programs_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _api10_programs_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1.0/programs',
