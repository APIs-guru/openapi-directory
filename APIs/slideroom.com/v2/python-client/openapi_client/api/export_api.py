...
class ExportApi:
    ...
    def export_get_v2(
        ...
        _param = self._export_get_v2_serialize(
            token=token,
    ...
    @validate_call
    def export_get_v2_with_http_info(
        self,
        token: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def export_get_v2_without_preload_content(
        self,
        token: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _export_get_v2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/export/{token}',
