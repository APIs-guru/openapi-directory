...
class ExportResultV2(BaseModel):
    """
    ExportResultV2
    """ # noqa: E501
    completed_files: Optional[StrictInt] = None
    file_urls: Optional[List[StrictStr]] = None
    status: Optional[StrictStr] = None
    total_files: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["completed_files", "file_urls", "status", "total_files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completed_files": obj.get("completed_files"),
