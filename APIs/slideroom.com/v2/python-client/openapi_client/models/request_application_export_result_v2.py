...
class RequestApplicationExportResultV2(BaseModel):
    """
    RequestApplicationExportResultV2
    """ # noqa: E501
    message: Optional[StrictStr] = None
    submissions: Optional[StrictInt] = None
    token: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["message", "submissions", "token"]
