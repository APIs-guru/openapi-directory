...
class RemoteConnectUserDeviceResponse(BaseModel):
    """
    RemoteConnectUserDeviceResponse
    """ # noqa: E501
    remote_connect_url: StrictStr = Field(alias="remoteConnectUrl")
    serial: StrictStr
    __properties: ClassVar[List[str]] = ["remoteConnectUrl", "serial"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "remoteConnectUrl": obj.get("remoteConnectUrl"),
