...
class TestSalesDataApi(unittest.TestCase):
    """SalesDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SalesDataApi()

    def tearDown(self) -> None:
        pass

    def test_get_dealer_sales_region_daily_sales_get(self) -> None:
        """Test case for get_dealer_sales_region_daily_sales_get

        Brand sales by region and Day
        """
        pass

    def test_get_dealer_sales_region_sales_get(self) -> None:
        """Test case for get_dealer_sales_region_sales_get

        Premium. Brand sales by region and month
        """
        pass

    def test_get_model_used_dist_model_year_dist_get(self) -> None:
        """Test case for get_model_used_dist_model_year_dist_get

        Used market share of model year by model
        """
        pass

    def test_get_region_brand_market_share_get_region_brand_market_share_get(self) -> None:
        """Test case for get_region_brand_market_share_get_region_brand_market_share_get

        Market share of a brand in region
        """
        pass

    def test_get_region_market_share_get_region_market_share_get(self) -> None:
        """Test case for get_region_market_share_get_region_market_share_get

        Market share of all brands in region
        """
        pass

    def test_get_top_models_top_models_get(self) -> None:
        """Test case for get_top_models_top_models_get
