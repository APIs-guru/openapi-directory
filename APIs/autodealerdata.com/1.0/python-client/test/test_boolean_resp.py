...
class TestBooleanResp(unittest.TestCase):
    """BooleanResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResp:
        """Test BooleanResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResp`
        """
        model = BooleanResp()
        if include_optional:
            return BooleanResp(
