...
class TestTopModelEntry(unittest.TestCase):
    """TopModelEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopModelEntry:
        """Test TopModelEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopModelEntry`
        """
        model = TopModelEntry()
        if include_optional:
