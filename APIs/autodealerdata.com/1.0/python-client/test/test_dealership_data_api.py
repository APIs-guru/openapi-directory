...
class TestDealershipDataApi(unittest.TestCase):
    """DealershipDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DealershipDataApi()

    def tearDown(self) -> None:
        pass

    def test_get_dealers_get_dealers_by_id_get(self) -> None:
        """Test case for get_dealers_get_dealers_by_id_get

        Premium. Dealers by ID
        """
        pass

    def test_get_dealers_get_dealers_by_region_get(self) -> None:
        """Test case for get_dealers_get_dealers_by_region_get

        Premium. Dealers in a region.
        """
        pass

    def test_get_dealers_get_dealers_get(self) -> None:
        """Test case for get_dealers_get_dealers_get
