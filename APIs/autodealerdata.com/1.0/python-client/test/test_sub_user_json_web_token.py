...
class TestSubUserJSONWebToken(unittest.TestCase):
    """SubUserJSONWebToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubUserJSONWebToken:
        """Test SubUserJSONWebToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubUserJSONWebToken`
        """
        model = SubUserJSONWebToken()
        if include_optional:
    ...
    def testSubUserJSONWebToken(self):
        """Test SubUserJSONWebToken"""
