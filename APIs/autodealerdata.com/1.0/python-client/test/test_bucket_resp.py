...
class TestBucketResp(unittest.TestCase):
    """BucketResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketResp:
        """Test BucketResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketResp`
        """
        model = BucketResp()
        if include_optional:
            return BucketResp(
                ...
                condition = '',
                data = [
                    openapi_client.models.bucket_entry.BucketEntry(
                        bucket = 1.337, 
                        model_name = '', 
