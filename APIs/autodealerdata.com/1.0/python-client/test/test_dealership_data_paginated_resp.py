...
class TestDealershipDataPaginatedResp(unittest.TestCase):
    """DealershipDataPaginatedResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealershipDataPaginatedResp:
        """Test DealershipDataPaginatedResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealershipDataPaginatedResp`
        """
        model = DealershipDataPaginatedResp()
        if include_optional:
            return DealershipDataPaginatedResp(
                brand_name = '',
                cache_time_limit = 56,
                condition = '',
                data = openapi_client.models.dealership_data_paginated.DealershipDataPaginated(
                    dealers = [
    ...
    def testDealershipDataPaginatedResp(self):
        """Test DealershipDataPaginatedResp"""
