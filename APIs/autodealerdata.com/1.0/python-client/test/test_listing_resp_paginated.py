...
class TestListingRespPaginated(unittest.TestCase):
    """ListingRespPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListingRespPaginated:
        """Test ListingRespPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListingRespPaginated`
        """
        model = ListingRespPaginated()
        if include_optional:
    ...
    def testListingRespPaginated(self):
        """Test ListingRespPaginated"""
