...
class TestStaticDataApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = StaticDataApi()

    def tearDown(self) -> None:
        pass

    def test_get_brand_names_get_brands_get(self) -> None:
        """Test case for get_brand_names_get_brands_get

        Get a list of brand names
        """
        pass

    def test_get_model_names_all_get_inactive_models_get(self) -> None:
        """Test case for get_model_names_all_get_inactive_models_get

        Get a list of model names including discontinued models
        """
        pass

    def test_get_model_names_get_models_get(self) -> None:
        """Test case for get_model_names_get_models_get

        Get a list of model names
        """
        pass

    def test_get_regions_get_regions_get(self) -> None:
        """Test case for get_regions_get_regions_get
