...
class TestRegionResp(unittest.TestCase):
    """RegionResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionResp:
        """Test RegionResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionResp`
        """
        model = RegionResp()
        if include_optional:
            return RegionResp(
