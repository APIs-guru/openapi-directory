...
class TestSimilarSalePriceResp(unittest.TestCase):
    """SimilarSalePriceResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarSalePriceResp:
        """Test SimilarSalePriceResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarSalePriceResp`
        """
        model = SimilarSalePriceResp()
        if include_optional:
            return SimilarSalePriceResp(
                brand_name = '',
                cache_time_limit = 56,
                condition = '',
                data = openapi_client.models.similar_sale_price_data.SimilarSalePriceData(
                    days_back = 56, 
                    mile_count = 56, 
                    miles_avg = 1.337, 
                    miles_std_dev = 1.337, 
                    new_count = 56, 
                    new_sale_avg = 1.337, 
                    new_sale_std_dev = 1.337, 
                    used_count = 56, 
                    used_sale_avg = 1.337, 
                    used_sale_std_dev = 1.337, ),
    ...
    def testSimilarSalePriceResp(self):
        """Test SimilarSalePriceResp"""
