...
class TestDealershipDataResp(unittest.TestCase):
    """DealershipDataResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealershipDataResp:
        """Test DealershipDataResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealershipDataResp`
        """
        model = DealershipDataResp()
        if include_optional:
            return DealershipDataResp(
                ...
                condition = '',
                data = [
                    openapi_client.models.dealership_data.DealershipData(
                        address = '', 
                        dealer_name = '', 
                        ids = [
                            56
    ...
    def testDealershipDataResp(self):
        """Test DealershipDataResp"""
