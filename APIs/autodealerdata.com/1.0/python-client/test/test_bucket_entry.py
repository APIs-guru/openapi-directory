...
class TestBucketEntry(unittest.TestCase):
    """BucketEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketEntry:
        """Test BucketEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketEntry`
        """
        model = BucketEntry()
        if include_optional:
            return BucketEntry(
