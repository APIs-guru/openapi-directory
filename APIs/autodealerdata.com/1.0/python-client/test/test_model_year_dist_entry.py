...
class TestModelYearDistEntry(unittest.TestCase):
    """ModelYearDistEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelYearDistEntry:
        """Test ModelYearDistEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelYearDistEntry`
        """
        model = ModelYearDistEntry()
        if include_optional:
    ...
    def testModelYearDistEntry(self):
        """Test ModelYearDistEntry"""
