...
class TestModelResp(unittest.TestCase):
    """ModelResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelResp:
        """Test ModelResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelResp`
        """
        model = ModelResp()
        if include_optional:
            return ModelResp(
                ...
                condition = '',
                data = [
                    openapi_client.models.model_dict.ModelDict(
                        model_name = '', )
                    ],
                model_name = '',
                msg = '',
