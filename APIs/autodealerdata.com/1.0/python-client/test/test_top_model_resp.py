...
class TestTopModelResp(unittest.TestCase):
    """TopModelResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopModelResp:
        """Test TopModelResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopModelResp`
        """
        model = TopModelResp()
        if include_optional:
            return TopModelResp(
                ...
                condition = '',
                data = [
                    openapi_client.models.top_model_entry.TopModelEntry(
                        brand_market_share = 1.337, 
                        brand_name = '', 
                        model_name = '', 
                        percent_of_brand_sales = 1.337, 
                        percent_of_top_sales = 1.337, )
                    ],
                model_name = '',
                msg = '',
                region_name = ''
