...
class TestDealershipDataPaginated(unittest.TestCase):
    """DealershipDataPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealershipDataPaginated:
        """Test DealershipDataPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealershipDataPaginated`
        """
        model = DealershipDataPaginated()
        if include_optional:
            return DealershipDataPaginated(
                dealers = [
    ...
    def testDealershipDataPaginated(self):
        """Test DealershipDataPaginated"""
