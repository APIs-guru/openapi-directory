...
class TestSimilarSalePriceData(unittest.TestCase):
    """SimilarSalePriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarSalePriceData:
        """Test SimilarSalePriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarSalePriceData`
        """
        model = SimilarSalePriceData()
        if include_optional:
    ...
    def testSimilarSalePriceData(self):
        """Test SimilarSalePriceData"""
