...
class TestVehHistoryData(unittest.TestCase):
    """VehHistoryData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VehHistoryData:
        """Test VehHistoryData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehHistoryData`
        """
        model = VehHistoryData()
        if include_optional:
            return VehHistoryData(
                data = [
                    openapi_client.models.veh_history.VehHistory(
                        dealer_name = '', 
