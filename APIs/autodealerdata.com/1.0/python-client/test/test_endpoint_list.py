...
class TestEndpointList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EndpointList:
        """Test EndpointList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointList`
        """
        model = EndpointList()
        if include_optional:
            return EndpointList(
