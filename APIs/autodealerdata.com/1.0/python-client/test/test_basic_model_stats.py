...
class TestBasicModelStats(unittest.TestCase):
    """BasicModelStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicModelStats:
        """Test BasicModelStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicModelStats`
        """
        model = BasicModelStats()
        if include_optional:
