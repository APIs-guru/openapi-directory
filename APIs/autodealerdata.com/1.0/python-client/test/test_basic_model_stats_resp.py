...
class TestBasicModelStatsResp(unittest.TestCase):
    """BasicModelStatsResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicModelStatsResp:
        """Test BasicModelStatsResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicModelStatsResp`
        """
        model = BasicModelStatsResp()
        if include_optional:
            return BasicModelStatsResp(
                ...
                condition = '',
                data = [
                    openapi_client.models.basic_model_stats.BasicModelStats(
                        average = 1.337, 
                        median = 1.337, 
                        name = '', 
                        p_variance = 1.337, 
    ...
    def testBasicModelStatsResp(self):
        """Test BasicModelStatsResp"""
