...
class TestHistoryResp(unittest.TestCase):
    """HistoryResp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryResp:
        """Test HistoryResp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoryResp`
        """
        model = HistoryResp()
        if include_optional:
            return HistoryResp(
                ...
                cache_time_limit = 56,
                condition = '',
                data = openapi_client.models.veh_history_data.VehHistoryData(
                    data = [
