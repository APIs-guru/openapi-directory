...
class BasicModelStats(BaseModel):
    ...
    name: StrictStr
    p_variance: Union[StrictFloat, StrictInt] = Field(alias="pVariance")
    std_dev: Union[StrictFloat, StrictInt] = Field(alias="stdDev")
    __properties: ClassVar[List[str]] = ["average", "median", "name", "pVariance", "stdDev"]
