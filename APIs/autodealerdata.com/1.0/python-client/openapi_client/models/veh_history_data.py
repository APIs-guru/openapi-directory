...
class VehHistoryData(BaseModel):
    ...
    VehHistoryData
    """ # noqa: E501
    data: List[VehHistory]
    vin: StrictStr
    __properties: ClassVar[List[str]] = ["data", "vin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VehHistory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "vin": obj.get("vin")
        })
        return _obj
