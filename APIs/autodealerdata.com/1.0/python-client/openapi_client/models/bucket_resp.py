...
class BucketResp(BaseModel):
    ...
    cache_time_limit: Optional[StrictInt] = Field(default=600, alias="cacheTimeLimit")
    condition: Optional[StrictStr] = None
    data: List[BucketEntry]
    ...
    __properties: ClassVar[List[str]] = ["brandName", "cacheTimeLimit", "condition", "data", "modelName", "msg", "regionName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cacheTimeLimit": obj.get("cacheTimeLimit") if obj.get("cacheTimeLimit") is not None else 600,
            "condition": obj.get("condition"),
            "data": [BucketEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
