...
class SimilarSalePriceResp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["brandName", "cacheTimeLimit", "condition", "data", "endDate", "modelName", "msg", "regionName", "startDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SimilarSalePriceData.from_dict(obj["data"]) if obj.get("data") is not None else None,
