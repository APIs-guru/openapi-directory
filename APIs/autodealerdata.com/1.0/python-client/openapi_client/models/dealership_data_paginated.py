...
class DealershipDataPaginated(BaseModel):
    ...
    """ # noqa: E501
    dealers: List[DealershipData]
    max_pages: StrictInt = Field(alias="maxPages")
    page: StrictInt
    __properties: ClassVar[List[str]] = ["dealers", "maxPages", "page"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in dealers (list)
        _items = []
        if self.dealers:
            for _item_dealers in self.dealers:
                if _item_dealers:
                    _items.append(_item_dealers.to_dict())
            _dict['dealers'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dealers": [DealershipData.from_dict(_item) for _item in obj["dealers"]] if obj.get("dealers") is not None else None,
