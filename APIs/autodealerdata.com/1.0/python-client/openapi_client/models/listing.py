...
class Listing(BaseModel):
    ...
    Listing
    """ # noqa: E501
    ask_price: Union[StrictFloat, StrictInt] = Field(alias="askPrice")
    brand_name: StrictStr = Field(alias="brandName")
    color: Optional[StrictStr] = None
    dealer_id: StrictInt = Field(alias="dealerID")
    first_seen: date = Field(alias="firstSeen")
    interior_color: Optional[StrictStr] = Field(default=None, alias="interiorColor")
    is_new: StrictBool = Field(alias="isNew")
    last_seen: date = Field(alias="lastSeen")
    mileage: Optional[Union[StrictFloat, StrictInt]] = 0
    model_name: StrictStr = Field(alias="modelName")
    msrp: Union[StrictFloat, StrictInt]
    vin: StrictStr
    vin_decode: Optional[Dict[str, Any]] = Field(default=None, alias="vinDecode")
    year: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["askPrice", "brandName", "color", "dealerID", "firstSeen", "interiorColor", "isNew", "lastSeen", "mileage", "modelName", "msrp", "vin", "vinDecode", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "color": obj.get("color"),
            "dealerID": obj.get("dealerID"),
            "firstSeen": obj.get("firstSeen"),
            "interiorColor": obj.get("interiorColor"),
            "isNew": obj.get("isNew"),
            "lastSeen": obj.get("lastSeen"),
            "mileage": obj.get("mileage") if obj.get("mileage") is not None else 0,
            "modelName": obj.get("modelName"),
            "msrp": obj.get("msrp"),
            "vin": obj.get("vin"),
            "vinDecode": obj.get("vinDecode"),
            "year": obj.get("year")
        })
        return _obj
