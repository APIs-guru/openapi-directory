...
class ModelYearDistEntry(BaseModel):
    ...
    percent_of_market: Union[StrictFloat, StrictInt] = Field(alias="percentOfMarket")
    year: StrictInt
    __properties: ClassVar[List[str]] = ["brandName", "modelName", "percentOfMarket", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "percentOfMarket": obj.get("percentOfMarket"),
            "year": obj.get("year")
        })
        return _obj
