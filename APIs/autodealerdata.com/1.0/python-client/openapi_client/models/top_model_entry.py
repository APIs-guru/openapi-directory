...
class TopModelEntry(BaseModel):
    ...
    TopModelEntry
    """ # noqa: E501
    brand_market_share: Union[StrictFloat, StrictInt] = Field(alias="brandMarketShare")
    brand_name: StrictStr = Field(alias="brandName")
    model_name: StrictStr = Field(alias="modelName")
    percent_of_brand_sales: Union[StrictFloat, StrictInt] = Field(alias="percentOfBrandSales")
    percent_of_top_sales: Union[StrictFloat, StrictInt] = Field(alias="percentOfTopSales")
    __properties: ClassVar[List[str]] = ["brandMarketShare", "brandName", "modelName", "percentOfBrandSales", "percentOfTopSales"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brandMarketShare": obj.get("brandMarketShare"),
            "brandName": obj.get("brandName"),
            "modelName": obj.get("modelName"),
            "percentOfBrandSales": obj.get("percentOfBrandSales"),
            "percentOfTopSales": obj.get("percentOfTopSales")
        })
        return _obj
