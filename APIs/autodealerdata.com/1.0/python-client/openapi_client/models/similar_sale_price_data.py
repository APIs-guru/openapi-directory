...
class SimilarSalePriceData(BaseModel):
    ...
    """ # noqa: E501
    days_back: StrictInt = Field(alias="daysBack")
    mile_count: StrictInt = Field(alias="mileCount")
    miles_avg: Union[StrictFloat, StrictInt] = Field(alias="milesAvg")
    miles_std_dev: Union[StrictFloat, StrictInt] = Field(alias="milesStdDev")
    new_count: StrictInt = Field(alias="newCount")
    new_sale_avg: Union[StrictFloat, StrictInt] = Field(alias="newSaleAvg")
    new_sale_std_dev: Union[StrictFloat, StrictInt] = Field(alias="newSaleStdDev")
    used_count: StrictInt = Field(alias="usedCount")
    used_sale_avg: Union[StrictFloat, StrictInt] = Field(alias="usedSaleAvg")
    used_sale_std_dev: Union[StrictFloat, StrictInt] = Field(alias="usedSaleStdDev")
    __properties: ClassVar[List[str]] = ["daysBack", "mileCount", "milesAvg", "milesStdDev", "newCount", "newSaleAvg", "newSaleStdDev", "usedCount", "usedSaleAvg", "usedSaleStdDev"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "daysBack": obj.get("daysBack"),
            "mileCount": obj.get("mileCount"),
            "milesAvg": obj.get("milesAvg"),
            "milesStdDev": obj.get("milesStdDev"),
            "newCount": obj.get("newCount"),
            "newSaleAvg": obj.get("newSaleAvg"),
            "newSaleStdDev": obj.get("newSaleStdDev"),
            "usedCount": obj.get("usedCount"),
            "usedSaleAvg": obj.get("usedSaleAvg"),
            "usedSaleStdDev": obj.get("usedSaleStdDev")
        })
        return _obj
