...
class TestAEAssessment1(unittest.TestCase):
    """AEAssessment1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AEAssessment1:
        """Test AEAssessment1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AEAssessment1`
        """
        model = AEAssessment1()
        if include_optional:
            return AEAssessment1(
                age = 56,
