...
class TestJournalLine1(unittest.TestCase):
    """JournalLine1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JournalLine1:
        """Test JournalLine1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JournalLine1`
        """
        model = JournalLine1()
        if include_optional:
            return JournalLine1(
