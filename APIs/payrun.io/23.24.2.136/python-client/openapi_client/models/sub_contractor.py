...
class SubContractor(BaseModel):
    ...
    SubContractor
    """ # noqa: E501
    sub_contractor: Optional[SubContractor3] = Field(default=None, alias="SubContractor")
    __properties: ClassVar[List[str]] = ["SubContractor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SubContractor": SubContractor3.from_dict(obj["SubContractor"]) if obj.get("SubContractor") is not None else None
        })
        return _obj
