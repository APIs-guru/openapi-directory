...
class Group(BaseModel):
    ...
    The querys' groups
    """ # noqa: E501
    group: Optional[List[GroupGroupInner]] = Field(default=None, alias="Group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Group": [GroupGroupInner.from_dict(_item) for _item in obj["Group"]] if obj.get("Group") is not None else None
        })
        return _obj
