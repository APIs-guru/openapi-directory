...
class PayRun(BaseModel):
    ...
    PayRun
    """ # noqa: E501
    pay_run: Optional[PayRun3] = Field(default=None, alias="PayRun")
    __properties: ClassVar[List[str]] = ["PayRun"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PayRun": PayRun3.from_dict(obj["PayRun"]) if obj.get("PayRun") is not None else None
        })
        return _obj
