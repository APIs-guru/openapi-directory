...
class HealthCheck(BaseModel):
    ...
    HealthCheck
    """ # noqa: E501
    health_check: Optional[HealthCheck1] = Field(default=None, alias="HealthCheck")
    __properties: ClassVar[List[str]] = ["HealthCheck"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HealthCheck": HealthCheck1.from_dict(obj["HealthCheck"]) if obj.get("HealthCheck") is not None else None
        })
        return _obj
