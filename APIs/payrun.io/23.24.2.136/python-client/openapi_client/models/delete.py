...
class DELETE(BaseModel):
    ...
    """ # noqa: E501
    delete: Optional[List[DELETEDELETEInner]] = Field(default=None, alias="DELETE")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DELETE": [DELETEDELETEInner.from_dict(_item) for _item in obj["DELETE"]] if obj.get("DELETE") is not None else None
        })
        return _obj
