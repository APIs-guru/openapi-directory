...
class JobInfo(BaseModel):
    ...
    JobInfo
    """ # noqa: E501
    job_info: Optional[JobInfo1] = Field(default=None, alias="JobInfo")
    __properties: ClassVar[List[str]] = ["JobInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JobInfo": JobInfo1.from_dict(obj["JobInfo"]) if obj.get("JobInfo") is not None else None
        })
        return _obj
