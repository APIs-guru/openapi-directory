...
class ReferenceApi:
    ...
    def get_journal_expression_schema(
        ...
        _param = self._get_journal_expression_schema_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JournalExpressionDataTable",
            '400': "ErrorModel",
            '401': "ErrorModel",
            '404': "ErrorModel",
            '500': "ErrorModel",
    ...
    @validate_call
    def get_journal_expression_schema_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JournalExpressionDataTable]:
        """Gets the journal expression data schema
    ...
    @validate_call
    def get_journal_expression_schema_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
        _request_timeout: Union[
    ...
    def _get_journal_expression_schema_serialize(
        self,
        authorization,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ReferenceData/JournalExpressionDataTable',
