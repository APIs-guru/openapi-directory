...
class TemplatesApi:
    ...
    def get_template_model(
        self,
        dto_data_type: Annotated[StrictStr, Field(description="The data transfer object type name. E.g PensionPayInstruction")],
        ...
        :param dto_data_type: The data transfer object type name. E.g PensionPayInstruction (required)
        ...
        _param = self._get_template_model_serialize(
            dto_data_type=dto_data_type,
    ...
    @validate_call
    def get_template_model_with_http_info(
        self,
        dto_data_type: Annotated[StrictStr, Field(description="The data transfer object type name. E.g PensionPayInstruction")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
    ...
    @validate_call
    def get_template_model_without_preload_content(
        self,
        dto_data_type: Annotated[StrictStr, Field(description="The data transfer object type name. E.g PensionPayInstruction")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
    ...
    def _get_template_model_serialize(
        self,
        dto_data_type,
        authorization,
        api_version,
        ...
        if dto_data_type is not None:
            _path_params['DtoDataType'] = dto_data_type
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Template/{DtoDataType}',
