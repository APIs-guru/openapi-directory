...
class ThirdPartyTransmissionApi:
    ...
    def delete_third_party_transaction(
        ...
        _param = self._delete_third_party_transaction_serialize(
    ...
    @validate_call
    def delete_third_party_transaction_with_http_info(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        third_party_transaction_id: Annotated[StrictStr, Field(description="The third party transaction unique identifier. E.g TP001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
    ...
    @validate_call
    def delete_third_party_transaction_without_preload_content(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        third_party_transaction_id: Annotated[StrictStr, Field(description="The third party transaction unique identifier. E.g TP001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
    ...
    def _delete_third_party_transaction_serialize(
        self,
        employer_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/Employer/{EmployerId}/ThirdPartyTransaction/{ThirdPartyTransactionId}',
    ...
    def get_third_party_transaction(
        ...
        _param = self._get_third_party_transaction_serialize(
            employer_id=employer_id,
            third_party_transaction_id=third_party_transaction_id,
            authorization=authorization,
            api_version=api_version,
    ...
    @validate_call
    def get_third_party_transaction_with_http_info(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        third_party_transaction_id: Annotated[StrictStr, Field(description="The third party transaction unique identifier. E.g TP001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ThirdPartyTransaction]:
        """Get a third party transaction
    ...
    @validate_call
    def get_third_party_transaction_without_preload_content(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        third_party_transaction_id: Annotated[StrictStr, Field(description="The third party transaction unique identifier. E.g TP001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
    ...
    def _get_third_party_transaction_serialize(
        self,
        employer_id,
        third_party_transaction_id,
        authorization,
    ...
    def get_third_party_transactions(
        ...
        _param = self._get_third_party_transactions_serialize(
            employer_id=employer_id,
            authorization=authorization,
            api_version=api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_third_party_transactions_with_http_info(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
    ...
    @validate_call
    def get_third_party_transactions_without_preload_content(
        self,
        employer_id: Annotated[StrictStr, Field(description="The employers' unique identifier. E.g ER001")],
        authorization: Annotated[StrictStr, Field(description="The OAuth 1 authorization header. &apos;Auto&apos; enables auto complete.")],
        api_version: Annotated[StrictStr, Field(description="The version of the api to target. Omit or set as &apos;default&apos; to target the current api version.")],
    ...
    def _get_third_party_transactions_serialize(
        self,
        employer_id,
        authorization,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Employer/{EmployerId}/ThirdPartyTransactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
