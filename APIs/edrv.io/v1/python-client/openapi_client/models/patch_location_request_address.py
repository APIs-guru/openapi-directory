...
class PatchLocationRequestAddress(BaseModel):
    """
    ...
    street_and_number: Optional[StrictStr] = Field(default=None, alias="streetAndNumber")
    __properties: ClassVar[List[str]] = ["city", "country", "postalCode", "state", "streetAndNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "streetAndNumber": obj.get("streetAndNumber")
        })
        return _obj
