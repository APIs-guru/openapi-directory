...
class UpdatereservationRequest(BaseModel):
    ...
    """ # noqa: E501
    connector: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    driver: Optional[StrictStr] = None
    end_date: Optional[StrictStr] = Field(default=None, alias="endDate")
    evse: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["connector", "driver", "endDate", "evse"]
