...
class SetchargingscheduleRequest(BaseModel):
    """
    SetchargingscheduleRequest
    """ # noqa: E501
    connector: Optional[StrictStr] = None
    schedule: Optional[List[SetchargingscheduleRequestScheduleInner]] = None
    __properties: ClassVar[List[str]] = ["connector", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": [SetchargingscheduleRequestScheduleInner.from_dict(_item) for _item in obj["schedule"]] if obj.get("schedule") is not None else None
        })
        return _obj
