...
class ConnectorsApi:
    ...
    def delete_connector(
        self,
        id: Annotated[StrictStr, Field(description="The connector id that needs to be deleted")],
    ...
    def get_connector(
        self,
        id: Annotated[StrictStr, Field(description="ID of connector that needs to be fetched")],
    ...
    def patch_connector(
        self,
        id: Annotated[StrictStr, Field(description="ID of connector that needs to be updated")],
        post_connectors_request: Annotated[PostConnectorsRequest, Field(description="Include connector properties to update here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param post_connectors_request: Include connector properties to update here (required)
        :type post_connectors_request: PostConnectorsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_connector_serialize(
            id=id,
            post_connectors_request=post_connectors_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _patch_connector_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_connectors_request is not None:
            _body_params = post_connectors_request
    ...
    def post_connectors(
        self,
        post_connectors_request: Annotated[PostConnectorsRequest, Field(description="Include Connector properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_connectors_request: Include Connector properties to create here (required)
        :type post_connectors_request: PostConnectorsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._post_connectors_serialize(
            post_connectors_request=post_connectors_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_connectors_with_http_info(
        self,
        post_connectors_request: Annotated[PostConnectorsRequest, Field(description="Include Connector properties to create here")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_connectors_without_preload_content(
        self,
        post_connectors_request: Annotated[PostConnectorsRequest, Field(description="Include Connector properties to create here")],
        _request_timeout: Union[
            None,
    ...
    def _post_connectors_serialize(
        self,
        post_connectors_request,
        _request_auth,
        _content_type,
