...
class LocationsApi:
    ...
    def delete_location(
        self,
        id: Annotated[StrictStr, Field(description="The location id that needs to be deleted")],
    ...
    def get_location(
        self,
        id: Annotated[StrictStr, Field(description="The location id that needs to be fetched")],
        include_chargestations: Annotated[Optional[StrictBool], Field(description="Populate chargestations")] = None,
        ...
        _param = self._get_location_serialize(
            id=id,
            include_chargestations=include_chargestations,
    ...
    def _get_location_serialize(
        ...
        if id is not None:
            _path_params['id'] = id
        # process the query parameters
        if include_chargestations is not None:
            
            _query_params.append(('include_chargestations', include_chargestations))
    ...
    def patch_location(
        self,
        id: Annotated[StrictStr, Field(description="ID of location that needs to be updated")],
        patch_location_request: Annotated[PatchLocationRequest, Field(description="Include location properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param patch_location_request: Include location properties to create here (required)
        :type patch_location_request: PatchLocationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_location_serialize(
            id=id,
            patch_location_request=patch_location_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_location_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of location that needs to be updated")],
        patch_location_request: Annotated[PatchLocationRequest, Field(description="Include location properties to create here")],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_location_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of location that needs to be updated")],
        patch_location_request: Annotated[PatchLocationRequest, Field(description="Include location properties to create here")],
        _request_timeout: Union[
    ...
    def _patch_location_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patch_location_request is not None:
            _body_params = patch_location_request
    ...
    def post_locations(
        self,
        post_locations_request: Annotated[PostLocationsRequest, Field(description="Include location properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_locations_request: Include location properties to create here (required)
        :type post_locations_request: PostLocationsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_locations_serialize(
            post_locations_request=post_locations_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _post_locations_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_locations_request is not None:
            _body_params = post_locations_request
