...
class TokensApi:
    ...
    def delete_token(
        self,
        id: Annotated[StrictStr, Field(description="The token id that needs to be deleted")],
    ...
    def get_token(
        self,
        id: Annotated[StrictStr, Field(description="The token id that needs to be fetched")],
    ...
    def patch_token(
        self,
        id: Annotated[StrictStr, Field(description="ID of token that needs to be updated")],
        patch_token_request: Annotated[PatchTokenRequest, Field(description="Include token properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param patch_token_request: Include token properties to create here (required)
        :type patch_token_request: PatchTokenRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_token_serialize(
            id=id,
            patch_token_request=patch_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_token_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of token that needs to be updated")],
        patch_token_request: Annotated[PatchTokenRequest, Field(description="Include token properties to create here")],
        _request_timeout: Union[
    ...
    def _patch_token_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patch_token_request is not None:
            _body_params = patch_token_request
    ...
    def post_tokens(
        self,
        post_tokens_request: Annotated[PostTokensRequest, Field(description="Include token properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_tokens_request: Include token properties to create here (required)
        :type post_tokens_request: PostTokensRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_tokens_serialize(
            post_tokens_request=post_tokens_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_tokens_without_preload_content(
        self,
        post_tokens_request: Annotated[PostTokensRequest, Field(description="Include token properties to create here")],
        _request_timeout: Union[
            None,
    ...
    def _post_tokens_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_tokens_request is not None:
            _body_params = post_tokens_request
