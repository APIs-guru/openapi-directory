...
class OrganizationsApi:
    ...
    def get_organization(
        self,
        id: Annotated[StrictStr, Field(description="ID of organization that needs to be fetched")],
        include_locations: Annotated[Optional[StrictBool], Field(description="Populate locations")] = None,
    ...
    def _get_organization_serialize(
        ...
        if include_locations is not None:
            ...
            _query_params.append(('include_locations', include_locations))
    ...
    def patch_organization(
        self,
        id: Annotated[StrictStr, Field(description="ID of organization that needs to be updated")],
        patch_organization_request: Annotated[PatchOrganizationRequest, Field(description="Include organization properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param patch_organization_request: Include organization properties to create here (required)
