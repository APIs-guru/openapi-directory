...
class ConfigurationsApi:
    ...
    def get_configuration(
        self,
        id: Annotated[StrictStr, Field(description="ID of Configuration that needs to be fetched")],
    ...
    def _get_configuration_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/configurations/{id}',
    ...
    def post_configurations(
        self,
        post_configurations_request: Annotated[PostConfigurationsRequest, Field(description="Include Configuration properties to create here")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_configurations_request: Include Configuration properties to create here (required)
