...
class PdfResponseDto(BaseModel):
    ...
    pdf_file_base64_string: Optional[StrictStr] = Field(default=None, description="The Base64 encoded string that is the pdf file.", alias="pdfFileBase64String")
    __properties: ClassVar[List[str]] = ["errorMessage", "pdfFileBase64String"]
