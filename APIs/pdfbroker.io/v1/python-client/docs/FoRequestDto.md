...
json = "{}"
# create an instance of FoRequestDto from a JSON string
fo_request_dto_instance = FoRequestDto.from_json(json)
# print the JSON string representation of the object
print(FoRequestDto.to_json())

# convert the object into a dict
fo_request_dto_dict = fo_request_dto_instance.to_dict()
# create an instance of FoRequestDto from a dict
fo_request_dto_from_dict = FoRequestDto.from_dict(fo_request_dto_dict)
```
