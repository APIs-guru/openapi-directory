...
class JWT1(BaseModel):
    """
    JWT1
    """ # noqa: E501
    exp: Optional[StrictInt] = None
    var_field: Optional[StrictStr] = Field(default=None, alias="field")
    sub: Optional[StrictStr] = Field(default=None, description="base64safe encoded public signing key")
    __properties: ClassVar[List[str]] = ["exp", "field", "sub"]
