...
class OnlineSzamlaStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["messages", "status", "transaction_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [OnlineSzamlaStatusMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
