...
class PartnerApi:
    ...
    def create_partner(
        self,
        partner_upsert: Annotated[PartnerUpsert, Field(description="PartnerUpsert object that you would like to store.")],
        ...
        :param partner_upsert: PartnerUpsert object that you would like to store. (required)
        :type partner_upsert: PartnerUpsert
    ...
    def _create_partner_serialize(
        ...
        if partner_upsert is not None:
            _body_params = partner_upsert
    ...
    def update_partner(
        self,
        id: StrictInt,
        partner_upsert: Annotated[PartnerUpsert, Field(description="Partner object that you would like to update.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param partner_upsert: Partner object that you would like to update. (required)
        :type partner_upsert: PartnerUpsert
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
