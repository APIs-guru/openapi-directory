...
class OrganizationApi:
    ...
    def get_organization_data(
        ...
        _param = self._get_organization_data_serialize(
    ...
    @validate_call
    def get_organization_data_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_organization_data_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_organization_data_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
