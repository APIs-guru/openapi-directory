...
# **get_conversion_rate**
> ConversationRate get_conversion_rate(var_from, to)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    var_from = openapi_client.Currency() # Currency | 
    to = openapi_client.Currency() # Currency | 

    try:
        # Get currencies exchange rate.
        api_response = api_instance.get_conversion_rate(var_from, to)
