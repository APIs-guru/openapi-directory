...
class MetricsThisWeek(BaseModel):
    """
    Summary totals for the last 7 days
    """ # noqa: E501
    added: Optional[StrictInt] = Field(default=None, description="APIs added in the last week")
    updated: Optional[StrictInt] = Field(default=None, description="APIs updated in the last week")
    __properties: ClassVar[List[str]] = ["added", "updated"]
