...
------------- | ------------- | -------------
[**accounts_account_id_balances_get**](BalancesApi.md#accounts_account_id_balances_get) | **GET** /accounts/{accountId}/balances | Get Balances


# **accounts_account_id_balances_get**
> OBReadBalance1 accounts_account_id_balances_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Balances
        api_response = api_instance.accounts_account_id_balances_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of BalancesApi->accounts_account_id_balances_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BalancesApi->accounts_account_id_balances_get: %s\n" % e)
```
