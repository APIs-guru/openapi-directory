...
------------- | ------------- | -------------
[**accounts_account_id_standing_orders_get**](StandingOrdersApi.md#accounts_account_id_standing_orders_get) | **GET** /accounts/{accountId}/standing-orders | Get Standing Orders


# **accounts_account_id_standing_orders_get**
> OBReadStandingOrder6 accounts_account_id_standing_orders_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Standing Orders
        api_response = api_instance.accounts_account_id_standing_orders_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of StandingOrdersApi->accounts_account_id_standing_orders_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StandingOrdersApi->accounts_account_id_standing_orders_get: %s\n" % e)
```
