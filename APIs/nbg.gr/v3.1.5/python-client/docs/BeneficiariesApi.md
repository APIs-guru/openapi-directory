...
------------- | ------------- | -------------
[**accounts_account_id_beneficiaries_get**](BeneficiariesApi.md#accounts_account_id_beneficiaries_get) | **GET** /accounts/{accountId}/beneficiaries | Get Beneficiaries


# **accounts_account_id_beneficiaries_get**
> OBReadBeneficiary5 accounts_account_id_beneficiaries_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Beneficiaries
        api_response = api_instance.accounts_account_id_beneficiaries_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of BeneficiariesApi->accounts_account_id_beneficiaries_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BeneficiariesApi->accounts_account_id_beneficiaries_get: %s\n" % e)
```
