...
------------- | ------------- | -------------
[**accounts_account_id_get**](AccountsApi.md#accounts_account_id_get) | **GET** /accounts/{accountId} | Get Accounts
[**accounts_get**](AccountsApi.md#accounts_get) | **GET** /accounts | Get Accounts


# **accounts_account_id_get**
> OBReadAccount5 accounts_account_id_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Accounts
        api_response = api_instance.accounts_account_id_get(account_id, sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of AccountsApi->accounts_account_id_get:\n")
        pprint(api_response)
...
# **accounts_get**
> OBReadAccount5 accounts_get(sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Accounts
        api_response = api_instance.accounts_get(sandbox_id, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
