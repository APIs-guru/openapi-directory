...
class StatementsApi:
    ...
    @validate_call
    def accounts_account_id_statements_get(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        from_statement_date_time: Annotated[Optional[datetime], Field(description="The UTC ISO 8601 Date Time to filter statements FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")] = None,
        to_statement_date_time: Annotated[Optional[datetime], Field(description="The UTC ISO 8601 Date Time to filter statements TO NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")] = None,
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        ...
        :type account_id: str
        :param sandbox_id: The unique id of the sandbox to be used (required)
        :type sandbox_id: str
        :param from_statement_date_time: The UTC ISO 8601 Date Time to filter statements FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.
        :type from_statement_date_time: datetime
        :param to_statement_date_time: The UTC ISO 8601 Date Time to filter statements TO NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.
        :type to_statement_date_time: datetime
        ...
        _param = self._accounts_account_id_statements_get_serialize(
    ...
    @validate_call
    def accounts_account_id_statements_get_with_http_info(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        from_statement_date_time: Annotated[Optional[datetime], Field(description="The UTC ISO 8601 Date Time to filter statements FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")] = None,
    ...
    @validate_call
    def accounts_account_id_statements_get_without_preload_content(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        from_statement_date_time: Annotated[Optional[datetime], Field(description="The UTC ISO 8601 Date Time to filter statements FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")] = None,
    ...
    def _accounts_account_id_statements_get_serialize(
        self,
        account_id,
        sandbox_id,
        ...
        if from_statement_date_time is not None:
            if isinstance(from_statement_date_time, datetime):
                _query_params.append(
                    (
                        'fromStatementDateTime',
                        from_statement_date_time.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('fromStatementDateTime', from_statement_date_time))
            
        if to_statement_date_time is not None:
            if isinstance(to_statement_date_time, datetime):
                _query_params.append(
                    (
                        'toStatementDateTime',
                        to_statement_date_time.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('toStatementDateTime', to_statement_date_time))
        ...
        if sandbox_id is not None:
            _header_params['sandbox-id'] = sandbox_id
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_file_get(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
        x_fapi_interaction_id: Annotated[Optional[StrictStr], Field(description="An RFC4122 UID used as a correlation id.")] = None,
        ...
        _param = self._accounts_account_id_statements_statement_id_file_get_serialize(
            account_id=account_id,
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_file_get_with_http_info(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_file_get_without_preload_content(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
    ...
    def _accounts_account_id_statements_statement_id_file_get_serialize(
        self,
        account_id,
        statement_id,
        sandbox_id,
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_get(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        ...
        _param = self._accounts_account_id_statements_statement_id_get_serialize(
            account_id=account_id,
            statement_id=statement_id,
            sandbox_id=sandbox_id,
            x_fapi_auth_date=x_fapi_auth_date,
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_get_with_http_info(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
    ...
    @validate_call
    def accounts_account_id_statements_statement_id_get_without_preload_content(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        statement_id: Annotated[Optional[StrictStr], Field(description="StatementId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
    ...
    def _accounts_account_id_statements_statement_id_get_serialize(
        self,
        account_id,
        statement_id,
        sandbox_id,
