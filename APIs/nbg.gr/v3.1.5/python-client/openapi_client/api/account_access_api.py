...
class AccountAccessApi:
    ...
    @validate_call
    def account_access_consents_consent_id_delete(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        ...
        _param = self._account_access_consents_consent_id_delete_serialize(
    ...
    @validate_call
    def account_access_consents_consent_id_delete_with_http_info(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def account_access_consents_consent_id_delete_without_preload_content(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _account_access_consents_consent_id_delete_serialize(
        self,
        consent_id,
        sandbox_id,
        x_fapi_auth_date,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account-access-consents/{consentId}',
    ...
    @validate_call
    def account_access_consents_consent_id_get(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        ...
        _param = self._account_access_consents_consent_id_get_serialize(
            consent_id=consent_id,
            sandbox_id=sandbox_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
    ...
    @validate_call
    def account_access_consents_consent_id_get_with_http_info(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OBReadConsentResponse1]:
        """Get Account Access Consents
    ...
    @validate_call
    def account_access_consents_consent_id_get_without_preload_content(
        self,
        consent_id: Annotated[Optional[StrictStr], Field(description="ConsentId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _account_access_consents_consent_id_get_serialize(
        self,
        consent_id,
        sandbox_id,
        x_fapi_auth_date,
    ...
    @validate_call
    def account_access_consents_post(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
        x_fapi_interaction_id: Annotated[Optional[StrictStr], Field(description="An RFC4122 UID used as a correlation id.")] = None,
        x_customer_user_agent: Annotated[Optional[StrictStr], Field(description="Indicates the user-agent that the PSU is using.")] = None,
        ob_read_consent1: Annotated[Optional[OBReadConsent1], Field(description="Default")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_customer_user_agent: Indicates the user-agent that the PSU is using.
        :type x_customer_user_agent: str
        :param ob_read_consent1: Default
        :type ob_read_consent1: OBReadConsent1
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._account_access_consents_post_serialize(
            sandbox_id=sandbox_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
            ob_read_consent1=ob_read_consent1,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def account_access_consents_post_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
    ...
    @validate_call
    def account_access_consents_post_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
    ...
    def _account_access_consents_post_serialize(
        self,
        sandbox_id,
        x_fapi_auth_date,
        x_fapi_customer_ip_address,
        ...
        # process the form parameters
        # process the body parameter
        if ob_read_consent1 is not None:
            _body_params = ob_read_consent1
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account-access-consents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
