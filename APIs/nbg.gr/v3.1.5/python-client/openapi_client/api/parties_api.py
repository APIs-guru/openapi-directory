...
class PartiesApi:
    ...
    @validate_call
    def accounts_account_id_parties_get(
        self,
        ...
        _param = self._accounts_account_id_parties_get_serialize(
    ...
    @validate_call
    def accounts_account_id_parties_get_with_http_info(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def accounts_account_id_parties_get_without_preload_content(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _accounts_account_id_parties_get_serialize(
        self,
        account_id,
        sandbox_id,
        x_fapi_auth_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{accountId}/parties',
    ...
    @validate_call
    def accounts_account_id_party_get(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        ...
        _param = self._accounts_account_id_party_get_serialize(
            account_id=account_id,
            sandbox_id=sandbox_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
    ...
    @validate_call
    def accounts_account_id_party_get_with_http_info(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def accounts_account_id_party_get_without_preload_content(
        self,
        account_id: Annotated[Optional[StrictStr], Field(description="AccountId")],
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _accounts_account_id_party_get_serialize(
        self,
        account_id,
        sandbox_id,
        x_fapi_auth_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{accountId}/party',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def party_get(
        ...
        _param = self._party_get_serialize(
            sandbox_id=sandbox_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
    ...
    @validate_call
    def party_get_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="The unique id of the sandbox to be used")],
        x_fapi_auth_date: Annotated[Optional[StrictStr], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
