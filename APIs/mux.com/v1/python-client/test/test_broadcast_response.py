...
class TestBroadcastResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BroadcastResponse:
        """Test BroadcastResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastResponse`
        """
        model = BroadcastResponse()
        if include_optional:
            return BroadcastResponse(
                data = openapi_client.models.broadcast.Broadcast(
                    background = '', 
                    id = '', 
                    layout = 'gallery', 
                    live_stream_id = '', 
