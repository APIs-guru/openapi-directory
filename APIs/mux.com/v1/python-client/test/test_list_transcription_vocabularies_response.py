...
class TestListTranscriptionVocabulariesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListTranscriptionVocabulariesResponse:
        """Test ListTranscriptionVocabulariesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTranscriptionVocabulariesResponse`
        """
        model = ListTranscriptionVocabulariesResponse()
        if include_optional:
            return ListTranscriptionVocabulariesResponse(
                data = [
                    openapi_client.models.transcription_vocabulary.TranscriptionVocabulary(
                        created_at = '', 
                        id = '', 
                        name = '', 
                        passthrough = '', 
