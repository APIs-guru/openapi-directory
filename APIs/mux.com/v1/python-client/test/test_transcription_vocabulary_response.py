...
class TestTranscriptionVocabularyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TranscriptionVocabularyResponse:
        """Test TranscriptionVocabularyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranscriptionVocabularyResponse`
        """
        model = TranscriptionVocabularyResponse()
        if include_optional:
            return TranscriptionVocabularyResponse(
                data = openapi_client.models.transcription_vocabulary.TranscriptionVocabulary(
                    created_at = '', 
                    id = '', 
                    name = '', 
                    passthrough = '', 
