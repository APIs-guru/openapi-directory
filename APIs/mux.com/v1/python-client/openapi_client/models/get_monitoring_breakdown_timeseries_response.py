...
class GetMonitoringBreakdownTimeseriesResponse(BaseModel):
    """
    GetMonitoringBreakdownTimeseriesResponse
    """ # noqa: E501
    data: Optional[List[MonitoringBreakdownTimeseriesValues]] = None
    timeframe: Optional[List[StrictInt]] = None
    total_row_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["data", "timeframe", "total_row_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MonitoringBreakdownTimeseriesValues.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
