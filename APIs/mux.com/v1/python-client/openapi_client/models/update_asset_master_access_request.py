...
class UpdateAssetMasterAccessRequest(BaseModel):
    """
    UpdateAssetMasterAccessRequest
    """ # noqa: E501
    master_access: Optional[StrictStr] = Field(default=None, description="Add or remove access to the master version of the video.")
    __properties: ClassVar[List[str]] = ["master_access"]
