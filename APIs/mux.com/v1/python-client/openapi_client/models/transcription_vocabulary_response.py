...
class TranscriptionVocabularyResponse(BaseModel):
    """
    TranscriptionVocabularyResponse
    """ # noqa: E501
    data: Optional[TranscriptionVocabulary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TranscriptionVocabulary.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
