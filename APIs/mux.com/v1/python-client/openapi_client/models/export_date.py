...
class ExportDate(BaseModel):
    """
    ExportDate
    """ # noqa: E501
    export_date: Optional[date] = None
    files: Optional[List[ExportFile]] = None
    __properties: ClassVar[List[str]] = ["export_date", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": [ExportFile.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
