...
class CreateSpaceRequest(BaseModel):
    ...
    CreateSpaceRequest
    """ # noqa: E501
    broadcasts: Optional[List[CreateBroadcastRequest]] = Field(default=None, description="An array of broadcast destinations you want to stream the space to. **Note:** By default only a single broadcast destination can be specified. Contact Mux support if you need more.")
    ...
    type: Optional[SpaceType] = SpaceType.SERVER
    __properties: ClassVar[List[str]] = ["broadcasts", "passthrough", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "broadcasts": [CreateBroadcastRequest.from_dict(_item) for _item in obj["broadcasts"]] if obj.get("broadcasts") is not None else None,
