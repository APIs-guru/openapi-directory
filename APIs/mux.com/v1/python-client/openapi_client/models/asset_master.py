...
class AssetMaster(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="The temporary URL to the master version of the video, as an MP4 file. This URL will expire after 24 hours.")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ready', 'preparing', 'errored']):
            raise ValueError("must be one of enum values ('ready', 'preparing', 'errored')")
        return value
