...
class CreateBroadcastRequest(BaseModel):
    ...
    layout: Optional[BroadcastLayout] = BroadcastLayout.GALLERY
    live_stream_id: StrictStr = Field(description="The ID of the live stream that you want to broadcast to.")
    ...
    resolution: Optional[BroadcastResolution] = BroadcastResolution.ENUM_1920X1080
    __properties: ClassVar[List[str]] = ["background", "layout", "live_stream_id", "passthrough", "resolution"]
