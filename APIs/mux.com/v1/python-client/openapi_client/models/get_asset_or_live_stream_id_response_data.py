...
class GetAssetOrLiveStreamIdResponseData(BaseModel):
    """
    GetAssetOrLiveStreamIdResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The Playback ID used to retrieve the corresponding asset or the live stream ID")
    object: Optional[GetAssetOrLiveStreamIdResponseDataObject] = None
    policy: Optional[PlaybackPolicy] = None
    __properties: ClassVar[List[str]] = ["id", "object", "policy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "object": GetAssetOrLiveStreamIdResponseDataObject.from_dict(obj["object"]) if obj.get("object") is not None else None,
