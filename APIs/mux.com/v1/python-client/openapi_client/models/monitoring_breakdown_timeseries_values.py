...
class MonitoringBreakdownTimeseriesValues(BaseModel):
    """
    MonitoringBreakdownTimeseriesValues
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    values: Optional[List[MonitoringBreakdownTimeseriesDatapoint]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "values": [MonitoringBreakdownTimeseriesDatapoint.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
