...
class ListDimensionsResponseData(BaseModel):
    """
    ListDimensionsResponseData
    """ # noqa: E501
    advanced: Optional[List[StrictStr]] = None
    basic: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["advanced", "basic"]
