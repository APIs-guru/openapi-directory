...
class InputFile(BaseModel):
    ...
    InputFile
    """ # noqa: E501
    container_format: Optional[StrictStr] = None
    tracks: Optional[List[InputTrack]] = None
    __properties: ClassVar[List[str]] = ["container_format", "tracks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "container_format": obj.get("container_format"),
            "tracks": [InputTrack.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
