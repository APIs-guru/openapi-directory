...
class GetMonitoringHistogramTimeseriesResponseMeta(BaseModel):
    """
    GetMonitoringHistogramTimeseriesResponseMeta
    """ # noqa: E501
    buckets: Optional[List[MonitoringHistogramTimeseriesBucket]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [MonitoringHistogramTimeseriesBucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
