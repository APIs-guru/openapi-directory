...
class InputInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file": InputFile.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "settings": InputSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
