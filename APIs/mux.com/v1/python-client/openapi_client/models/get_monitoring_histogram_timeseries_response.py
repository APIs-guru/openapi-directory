...
class GetMonitoringHistogramTimeseriesResponse(BaseModel):
    """
    GetMonitoringHistogramTimeseriesResponse
    """ # noqa: E501
    data: Optional[List[MonitoringHistogramTimeseriesDatapoint]] = None
    meta: Optional[GetMonitoringHistogramTimeseriesResponseMeta] = None
    timeframe: Optional[List[StrictInt]] = None
    total_row_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["data", "meta", "timeframe", "total_row_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MonitoringHistogramTimeseriesDatapoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": GetMonitoringHistogramTimeseriesResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
