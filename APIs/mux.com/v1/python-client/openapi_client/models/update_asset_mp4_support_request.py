...
class UpdateAssetMP4SupportRequest(BaseModel):
    """
    UpdateAssetMP4SupportRequest
    """ # noqa: E501
    mp4_support: Optional[StrictStr] = Field(default=None, description="String value for the level of mp4 support")
    __properties: ClassVar[List[str]] = ["mp4_support"]
