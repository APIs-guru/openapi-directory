...
class URLSigningKeysApi:
    ...
    def create_url_signing_key(
        ...
        """(Deprecated) Create a URL signing key
        ...
        """ # noqa: E501
        warnings.warn("POST /video/v1/signing-keys is deprecated.", DeprecationWarning)

        _param = self._create_url_signing_key_serialize(
    ...
    @validate_call
    def create_url_signing_key_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def create_url_signing_key_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _create_url_signing_key_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/video/v1/signing-keys',
    ...
    def delete_url_signing_key(
        ...
        """(Deprecated) Delete a URL signing key
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("DELETE /video/v1/signing-keys/{SIGNING_KEY_ID} is deprecated.", DeprecationWarning)

        _param = self._delete_url_signing_key_serialize(
    ...
    @validate_call
    def delete_url_signing_key_with_http_info(
        self,
        signing_key_id: Annotated[StrictStr, Field(description="The ID of the signing key.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_url_signing_key_without_preload_content(
        self,
        signing_key_id: Annotated[StrictStr, Field(description="The ID of the signing key.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_url_signing_key_serialize(
        self,
        signing_key_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/video/v1/signing-keys/{SIGNING_KEY_ID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_url_signing_key(
        ...
        """(Deprecated) Retrieve a URL signing key
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /video/v1/signing-keys/{SIGNING_KEY_ID} is deprecated.", DeprecationWarning)

        _param = self._get_url_signing_key_serialize(
            signing_key_id=signing_key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_url_signing_key_without_preload_content(
        self,
        signing_key_id: Annotated[StrictStr, Field(description="The ID of the signing key.")],
        _request_timeout: Union[
            None,
    ...
    def _get_url_signing_key_serialize(
        self,
        signing_key_id,
        _request_auth,
        _content_type,
    ...
    def list_url_signing_keys(
        ...
        """(Deprecated) List URL signing keys
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /video/v1/signing-keys is deprecated.", DeprecationWarning)

        _param = self._list_url_signing_keys_serialize(
            limit=limit,
            page=page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_url_signing_keys_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items to include in the response")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Offset by this many pages, of the size of `limit`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_url_signing_keys_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items to include in the response")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Offset by this many pages, of the size of `limit`")] = None,
        _request_timeout: Union[
    ...
    def _list_url_signing_keys_serialize(
        self,
        limit,
        page,
        _request_auth,
