...
class ExportsApi:
    ...
    def list_exports(
        ...
        """(Deprecated) List property video view export links
        ...
        """ # noqa: E501
        warnings.warn("GET /data/v1/exports is deprecated.", DeprecationWarning)
    ...
    def list_exports_views(
        ...
        _param = self._list_exports_views_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_exports_views_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListVideoViewExportsResponse]:
        """List available property view exports
    ...
    @validate_call
    def list_exports_views_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_exports_views_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data/v1/exports/views',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
