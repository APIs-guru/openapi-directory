...
class TestAPIPagedResponseBuildSystemSharedDTOJobRun(unittest.TestCase):
    """APIPagedResponseBuildSystemSharedDTOJobRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> APIPagedResponseBuildSystemSharedDTOJobRun:
        """Test APIPagedResponseBuildSystemSharedDTOJobRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `APIPagedResponseBuildSystemSharedDTOJobRun`
        """
        model = APIPagedResponseBuildSystemSharedDTOJobRun()
        if include_optional:
            return APIPagedResponseBuildSystemSharedDTOJobRun(
                entities = [
                    openapi_client.models.build_system/shared/dto/job_run.BuildSystem.Shared.DTO.JobRun(
                        activity_runs = [
    ...
    def testAPIPagedResponseBuildSystemSharedDTOJobRun(self):
        """Test APIPagedResponseBuildSystemSharedDTOJobRun"""
