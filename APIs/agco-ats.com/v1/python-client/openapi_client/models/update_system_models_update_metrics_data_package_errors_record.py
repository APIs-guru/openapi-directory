...
class UpdateSystemModelsUpdateMetricsDataPackageErrorsRecord(BaseModel):
    ...
    """ # noqa: E501
    client_count: Optional[StrictInt] = Field(default=None, alias="ClientCount")
    ...
    __properties: ClassVar[List[str]] = ["ClientCount", "ErrorCode", "LongDescription", "ShortDescription"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSystemModelsUpdateMetricsDataPackageErrorsRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSystemModelsUpdateMetricsDataPackageErrorsRecord from a dict"""
        if obj is None:
            return None
