...
class BuildSystemSharedInterfacesIJobRun(BaseModel):
    ...
    interface of JobRun
    """ # noqa: E501
    activity_runs: Optional[List[BuildSystemSharedInterfacesIActivityRun]] = Field(default=None, description="ActivityRuns", alias="ActivityRuns")
    end_date: Optional[datetime] = Field(default=None, description="end date", alias="EndDate")
    job_id: Optional[StrictInt] = Field(default=None, description="job id", alias="JobID")
    ...
    status: Optional[StrictStr] = Field(default=None, description="status", alias="Status")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ActivityRuns": [BuildSystemSharedInterfacesIActivityRun.from_dict(_item) for _item in obj["ActivityRuns"]] if obj.get("ActivityRuns") is not None else None,
