...
class APIPagedResponseUpdateSystemModelsClient(BaseModel):
    ...
    """ # noqa: E501
    entities: List[UpdateSystemModelsClient] = Field(alias="Entities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Entities": [UpdateSystemModelsClient.from_dict(_item) for _item in obj["Entities"]] if obj.get("Entities") is not None else None,
