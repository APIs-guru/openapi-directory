...
class APIIPagedResponseGlobalResourcesSharedModelsTranslationSetAttribute(BaseModel):
    ...
    """ # noqa: E501
    entities: Optional[List[GlobalResourcesSharedModelsTranslationSetAttribute]] = Field(default=None, alias="Entities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Entities": [GlobalResourcesSharedModelsTranslationSetAttribute.from_dict(_item) for _item in obj["Entities"]] if obj.get("Entities") is not None else None,
