...
class AuthorizationCodesSharedModelsCategoryUserReport(BaseModel):
    ...
    """ # noqa: E501
    categories: Optional[List[AuthorizationCodesSharedModelsCategory]] = Field(default=None, alias="Categories")
    user: Optional[AuthorizationCodesSharedModelsAuthorizationCodeUser] = Field(default=None, alias="User")
    __properties: ClassVar[List[str]] = ["Categories", "User"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Categories": [AuthorizationCodesSharedModelsCategory.from_dict(_item) for _item in obj["Categories"]] if obj.get("Categories") is not None else None,
            "User": AuthorizationCodesSharedModelsAuthorizationCodeUser.from_dict(obj["User"]) if obj.get("User") is not None else None
        })
        return _obj
