...
class APIModelsPasswordReset(BaseModel):
    ...
    """ # noqa: E501
    new_password: StrictStr = Field(description="The new password", alias="NewPassword")
    token: StrictStr = Field(description="The password reset token", alias="Token")
    __properties: ClassVar[List[str]] = ["NewPassword", "Token"]
