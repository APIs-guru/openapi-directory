...
class DealerDBModelsLicenseActivationUpdate(BaseModel):
    ...
    """ # noqa: E501
    license_version: StrictStr = Field(description="The license version to update", alias="LicenseVersion")
    system_info: Optional[StrictStr] = Field(default=None, description="Information about  the system being activated", alias="SystemInfo")
    __properties: ClassVar[List[str]] = ["LicenseVersion", "SystemInfo"]
