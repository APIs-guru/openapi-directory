...
class AuthorizationCodesSharedModelsCategory(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="A description of the Category.", alias="Description")
    id: Optional[StrictStr] = Field(default=None, description="The ID of the Category.", alias="ID")
    name: Optional[StrictStr] = Field(default=None, description="The Name of the Category.", alias="Name")
