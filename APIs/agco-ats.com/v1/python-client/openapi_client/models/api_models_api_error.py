...
class APIModelsApiError(BaseModel):
    ...
    APIModelsApiError
    """ # noqa: E501
    developer_message: Optional[StrictStr] = Field(default=None, alias="DeveloperMessage")
    ...
    __properties: ClassVar[List[str]] = ["DeveloperMessage", "ErrorCode", "MoreInfo", "UserMessage"]
