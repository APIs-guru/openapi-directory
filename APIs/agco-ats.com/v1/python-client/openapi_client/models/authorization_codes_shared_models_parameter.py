...
class AuthorizationCodesSharedModelsParameter(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the parameter. May not be updated.", alias="Name")
    value: StrictStr = Field(description="The value of the parameter. May not be updated.", alias="Value")
