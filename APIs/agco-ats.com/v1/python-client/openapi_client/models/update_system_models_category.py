...
class UpdateSystemModelsCategory(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[List[UpdateSystemModelsAttributeValue]] = Field(default=None, alias="Values")
    category: StrictStr = Field(description="The category name")
    __properties: ClassVar[List[str]] = ["Values", "category"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Values": [UpdateSystemModelsAttributeValue.from_dict(_item) for _item in obj["Values"]] if obj.get("Values") is not None else None,
