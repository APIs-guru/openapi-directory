...
class UpdateSystemModelsClientInfo(BaseModel):
    ...
    package: Optional[List[UpdateSystemModelsPackageReport]] = Field(default=None, description="The packages", alias="Package")
    __properties: ClassVar[List[str]] = ["ClientID", "Package"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Package": [UpdateSystemModelsPackageReport.from_dict(_item) for _item in obj["Package"]] if obj.get("Package") is not None else None
        })
        return _obj
