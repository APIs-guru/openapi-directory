...
class APIModelsAuthenticatedUser(BaseModel):
    ...
    macid: Optional[StrictStr] = Field(default=None, description="The MAC identifier to use for API access", alias="MACId")
    mac_token: Optional[StrictStr] = Field(default=None, description="The MAC token to use for API access", alias="MACToken")
    name: Optional[StrictStr] = Field(default=None, description="The user's name", alias="Name")
    token: Optional[StrictStr] = Field(default=None, description="The token to use for API access", alias="Token")
    ...
    __properties: ClassVar[List[str]] = ["Email", "MACId", "MACToken", "Name", "Token", "UserID", "Username"]
