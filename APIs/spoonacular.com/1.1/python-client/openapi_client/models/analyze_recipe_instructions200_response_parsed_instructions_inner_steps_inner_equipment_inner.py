...
class AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "image", "localizedName", "name"]
