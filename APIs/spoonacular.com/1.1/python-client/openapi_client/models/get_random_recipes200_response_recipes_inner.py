...
class GetRandomRecipes200ResponseRecipesInner(BaseModel):
    """
    GetRandomRecipes200ResponseRecipesInner
    """ # noqa: E501
    aggregate_likes: Union[StrictFloat, StrictInt] = Field(alias="aggregateLikes")
    analyzed_instructions: Optional[List[Dict[str, Any]]] = Field(default=None, alias="analyzedInstructions")
    cheap: StrictBool
    ...
    diets: Optional[List[StrictStr]] = None
    dish_types: Optional[List[StrictStr]] = Field(default=None, alias="dishTypes")
    extended_ingredients: Optional[Annotated[List[ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner], Field(min_length=0)]] = Field(default=None, alias="extendedIngredients")
    ...
    occasions: Optional[List[StrictStr]] = None
    ...
    whole30: StrictBool
    wine_pairing: Optional[ExtractRecipeFromWebsite200ResponseWinePairing] = Field(default=None, alias="winePairing")
