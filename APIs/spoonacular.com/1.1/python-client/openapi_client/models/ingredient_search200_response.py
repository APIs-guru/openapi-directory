...
class IngredientSearch200Response(BaseModel):
    """
    
    """ # noqa: E501
    number: StrictInt
    offset: StrictInt
    results: Annotated[List[IngredientSearch200ResponseResultsInner], Field(min_length=0)]
    total_results: StrictInt = Field(alias="totalResults")
    __properties: ClassVar[List[str]] = ["number", "offset", "results", "totalResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [IngredientSearch200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
