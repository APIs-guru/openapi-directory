...
class AddToMealPlanRequest1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "position", "slot", "type", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "slot": obj.get("slot"),
            "type": obj.get("type"),
            "value": AddToMealPlanRequest1Value.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
