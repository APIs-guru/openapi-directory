...
class GenerateMealPlan200ResponseNutrients(BaseModel):
    """
    GenerateMealPlan200ResponseNutrients
    """ # noqa: E501
    calories: Union[StrictFloat, StrictInt]
    carbohydrates: Union[StrictFloat, StrictInt]
    fat: Union[StrictFloat, StrictInt]
    protein: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["calories", "carbohydrates", "fat", "protein"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "carbohydrates": obj.get("carbohydrates"),
            "fat": obj.get("fat"),
