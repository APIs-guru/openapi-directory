...
class ClassifyGroceryProductBulk200ResponseInner(BaseModel):
    """
    ...
    clean_title: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="cleanTitle")
    image: Annotated[str, Field(min_length=1, strict=True)]
    usda_code: StrictInt = Field(alias="usdaCode")
    __properties: ClassVar[List[str]] = ["breadcrumbs", "category", "cleanTitle", "image", "usdaCode"]
