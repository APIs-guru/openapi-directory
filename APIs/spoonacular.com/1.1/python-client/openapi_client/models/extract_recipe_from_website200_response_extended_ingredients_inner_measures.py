...
class ExtractRecipeFromWebsite200ResponseExtendedIngredientsInnerMeasures(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": ExtractRecipeFromWebsite200ResponseExtendedIngredientsInnerMeasuresMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "us": ExtractRecipeFromWebsite200ResponseExtendedIngredientsInnerMeasuresMetric.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
