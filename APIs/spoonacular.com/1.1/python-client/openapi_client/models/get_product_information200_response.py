...
class GetProductInformation200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aisle", "badges", "breadcrumbs", "generatedText", "id", "imageType", "importantBadges", "ingredientCount", "ingredientList", "ingredients", "likes", "nutrition", "price", "servings", "spoonacularScore", "title"]
