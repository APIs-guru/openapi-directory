...
class GetComparableProducts200ResponseComparableProductsProteinInner(BaseModel):
    """
    GetComparableProducts200ResponseComparableProductsProteinInner
    """ # noqa: E501
    difference: Union[StrictFloat, StrictInt]
    id: StrictInt
    image: Annotated[str, Field(min_length=1, strict=True)]
    title: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["difference", "id", "image", "title"]
