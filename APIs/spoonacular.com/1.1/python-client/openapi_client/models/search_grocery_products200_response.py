...
class SearchGroceryProducts200Response(BaseModel):
    ...
    number: StrictInt
    offset: StrictInt
    products: Annotated[List[SearchGroceryProducts200ResponseProductsInner], Field(min_length=0)]
    total_products: StrictInt = Field(alias="totalProducts")
    type: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["number", "offset", "products", "totalProducts", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [SearchGroceryProducts200ResponseProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
