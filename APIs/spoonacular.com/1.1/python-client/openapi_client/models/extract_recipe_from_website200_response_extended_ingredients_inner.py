...
class ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner(BaseModel):
    """
    ...
    measures: Optional[ExtractRecipeFromWebsite200ResponseExtendedIngredientsInnerMeasures] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "image": obj.get("image"),
            "measures": ExtractRecipeFromWebsite200ResponseExtendedIngredientsInnerMeasures.from_dict(obj["measures"]) if obj.get("measures") is not None else None,
            "meta": obj.get("meta"),
            "name": obj.get("name"),
