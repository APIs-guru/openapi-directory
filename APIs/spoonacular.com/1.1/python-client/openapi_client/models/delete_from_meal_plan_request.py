...
class DeleteFromMealPlanRequest(BaseModel):
    """
    DeleteFromMealPlanRequest
    """ # noqa: E501
    hash: StrictStr = Field(description="The private hash for the username.")
    id: Union[StrictFloat, StrictInt] = Field(description="The shopping list item id.")
    username: StrictStr = Field(description="The username.")
    __properties: ClassVar[List[str]] = ["hash", "id", "username"]
