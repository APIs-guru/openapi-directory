...
class ExtractRecipeFromWebsite200ResponseWinePairing(BaseModel):
    """
    ExtractRecipeFromWebsite200ResponseWinePairing
    """ # noqa: E501
    paired_wines: List[StrictStr] = Field(alias="pairedWines")
    pairing_text: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="pairingText")
    product_matches: Annotated[List[GetWineRecommendation200ResponseRecommendedWinesInner], Field(min_length=0)] = Field(alias="productMatches")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.product_matches:
            for _item_product_matches in self.product_matches:
                if _item_product_matches:
                    _items.append(_item_product_matches.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productMatches": [GetWineRecommendation200ResponseRecommendedWinesInner.from_dict(_item) for _item in obj["productMatches"]] if obj.get("productMatches") is not None else None
        })
        return _obj
