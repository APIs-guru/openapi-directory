...
class GetRecipeIngredientsByID200Response(BaseModel):
    """
    
    """ # noqa: E501
    ingredients: Annotated[List[GetRecipeIngredientsByID200ResponseIngredientsInner], Field(min_length=0)]
    __properties: ClassVar[List[str]] = ["ingredients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ingredients": [GetRecipeIngredientsByID200ResponseIngredientsInner.from_dict(_item) for _item in obj["ingredients"]] if obj.get("ingredients") is not None else None
        })
        return _obj
