...
class GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInner(BaseModel):
    """
    GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInner
    """ # noqa: E501
    name: StrictStr
    steps: Optional[Annotated[List[GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner], Field(min_length=0)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "steps": [GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
