...
class GenerateShoppingListRequest(BaseModel):
    ...
    """ # noqa: E501
    end_date: StrictStr = Field(description="The end date in the format yyyy-mm-dd.", alias="end-date")
    hash: StrictStr = Field(description="The private hash for the username.")
    start_date: StrictStr = Field(description="The start date in the format yyyy-mm-dd.", alias="start-date")
    username: StrictStr = Field(description="The username.")
    __properties: ClassVar[List[str]] = ["end-date", "hash", "start-date", "username"]
