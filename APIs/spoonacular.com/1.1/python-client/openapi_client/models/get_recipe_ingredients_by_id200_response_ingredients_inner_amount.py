...
class GetRecipeIngredientsByID200ResponseIngredientsInnerAmount(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": GetRecipeIngredientsByID200ResponseIngredientsInnerAmountMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "us": GetRecipeIngredientsByID200ResponseIngredientsInnerAmountMetric.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
