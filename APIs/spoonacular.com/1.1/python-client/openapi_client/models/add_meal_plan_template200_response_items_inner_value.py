...
class AddMealPlanTemplate200ResponseItemsInnerValue(BaseModel):
    """
    AddMealPlanTemplate200ResponseItemsInnerValue
    """ # noqa: E501
    id: Optional[StrictInt] = None
    image_type: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="imageType")
    servings: Optional[Union[StrictFloat, StrictInt]] = None
    title: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["id", "imageType", "servings", "title"]
