...
class GetRecipePriceBreakdownByID200ResponseIngredientsInner(BaseModel):
    """
    GetRecipePriceBreakdownByID200ResponseIngredientsInner
    """ # noqa: E501
    amount: Optional[GetRecipeIngredientsByID200ResponseIngredientsInnerAmount] = None
    image: Annotated[str, Field(min_length=1, strict=True)]
    name: Annotated[str, Field(min_length=1, strict=True)]
    price: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["amount", "image", "name", "price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amount": GetRecipeIngredientsByID200ResponseIngredientsInnerAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "image": obj.get("image"),
            "name": obj.get("name"),
            "price": obj.get("price")
        })
