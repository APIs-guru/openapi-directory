...
class ClearMealPlanDayRequest(BaseModel):
    """
    ClearMealPlanDayRequest
    """ # noqa: E501
    var_date: StrictStr = Field(description="The date in the format yyyy-mm-dd.", alias="date")
    hash: StrictStr = Field(description="The private hash for the username.")
    username: StrictStr = Field(description="The username.")
    __properties: ClassVar[List[str]] = ["date", "hash", "username"]
