        ...
        if include_optional:
            return SearchRestaurants200ResponseRestaurantsInnerLocalHours(
                ...
                dine_in = openapi_client.models.search_restaurants_200_response_restaurants_inner_local_hours_delivery.searchRestaurants_200_response_restaurants_inner_local_hours_delivery(
                    ...
                    tuesday = '', 
                    wednesday = '', ),
                operational = openapi_client.models.search_restaurants_200_response_restaurants_inner_local_hours_delivery.searchRestaurants_200_response_restaurants_inner_local_hours_delivery(
                    friday = '', 
                    monday = '', 
                    saturday = '', 
                    sunday = '', 
                    ...
                    tuesday = '', 
                    wednesday = '', ),
                pickup = openapi_client.models.search_restaurants_200_response_restaurants_inner_local_hours_delivery.searchRestaurants_200_response_restaurants_inner_local_hours_delivery(
                    friday = '', 
                    monday = '', 
                    saturday = '', 
                    sunday = '', 
