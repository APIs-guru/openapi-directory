...
class TestIngredientSearch200Response(unittest.TestCase):
    """IngredientSearch200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngredientSearch200Response:
        ...
        """
        model = IngredientSearch200Response()
        if include_optional:
            return IngredientSearch200Response(
                number = 56,
                offset = 56,
                results = [
                    openapi_client.models.ingredient_search_200_response_results_inner.ingredientSearch_200_response_results_inner(
                        id = 56, 
                        image = '0', 
                        name = '0', )
                    ],
    ...
    def testIngredientSearch200Response(self):
        """Test IngredientSearch200Response"""
