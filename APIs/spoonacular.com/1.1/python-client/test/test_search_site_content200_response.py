    ...
    def make_instance(self, include_optional) -> SearchSiteContent200Response:
        ...
        if include_optional:
            return SearchSiteContent200Response(
                articles = [
                    openapi_client.models.search_site_content_200_response_articles_inner.searchSiteContent_200_response_Articles_inner(
                        data_points = [
                            null
                            ], 
                        image = '0', 
                ...
                grocery_products = [
                    openapi_client.models.search_site_content_200_response_grocery_products_inner.searchSiteContent_200_response_Grocery_Products_inner(
                        data_points = [
