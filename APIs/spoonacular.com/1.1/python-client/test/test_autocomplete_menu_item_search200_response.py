...
class TestAutocompleteMenuItemSearch200Response(unittest.TestCase):
    """AutocompleteMenuItemSearch200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutocompleteMenuItemSearch200Response:
        ...
        """
        model = AutocompleteMenuItemSearch200Response()
        if include_optional:
            return AutocompleteMenuItemSearch200Response(
                results = [
                    openapi_client.models.autocomplete_menu_item_search_200_response_results_inner.autocompleteMenuItemSearch_200_response_results_inner(
                        id = 56, 
                        title = '0', )
                    ]
            )
    ...
    def testAutocompleteMenuItemSearch200Response(self):
        """Test AutocompleteMenuItemSearch200Response"""
