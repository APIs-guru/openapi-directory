...
class TimelineWeatherAPI15DayForecastRequestApi:
    ...
    @validate_call
    def visual_crossing_web_services_rest_services_timeline_location_get(
        self,
        location: Annotated[StrictStr, Field(description="Locaton of interest as an address, partial address or decimal latitude,longtude value")],
        key: StrictStr,
        ...
        _param = self._visual_crossing_web_services_rest_services_timeline_location_get_serialize(
            location=location,
            key=key,
    ...
    @validate_call
    def visual_crossing_web_services_rest_services_timeline_location_get_with_http_info(
        self,
        location: Annotated[StrictStr, Field(description="Locaton of interest as an address, partial address or decimal latitude,longtude value")],
        key: StrictStr,
        content_type: Annotated[Optional[StrictStr], Field(description="data format of the output either json or CSV")] = None,
    ...
    @validate_call
    def visual_crossing_web_services_rest_services_timeline_location_get_without_preload_content(
        self,
        location: Annotated[StrictStr, Field(description="Locaton of interest as an address, partial address or decimal latitude,longtude value")],
        key: StrictStr,
        content_type: Annotated[Optional[StrictStr], Field(description="data format of the output either json or CSV")] = None,
    ...
    def _visual_crossing_web_services_rest_services_timeline_location_get_serialize(
        self,
        location,
        key,
        content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/VisualCrossingWebServices/rest/services/timeline/{location}',
