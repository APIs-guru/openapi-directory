...
class TestPhoneEnrichPostRequest(unittest.TestCase):
    """PhoneEnrichPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhoneEnrichPostRequest:
        """Test PhoneEnrichPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhoneEnrichPostRequest`
        """
        model = PhoneEnrichPostRequest()
        if include_optional:
            return PhoneEnrichPostRequest(
                phone = ''
            )
        else:
            return PhoneEnrichPostRequest(
    ...
    def testPhoneEnrichPostRequest(self):
        """Test PhoneEnrichPostRequest"""
