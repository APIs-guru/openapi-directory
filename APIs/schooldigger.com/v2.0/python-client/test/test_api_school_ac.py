...
class TestAPISchoolAC(unittest.TestCase):
    """APISchoolAC unit test stubs"""
    ...
    def make_instance(self, include_optional) -> APISchoolAC:
        """Test APISchoolAC
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `APISchoolAC`
        """
        model = APISchoolAC()
        if include_optional:
            return APISchoolAC(
