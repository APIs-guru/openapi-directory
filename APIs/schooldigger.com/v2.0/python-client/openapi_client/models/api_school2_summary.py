...
class APISchool2Summary(BaseModel):
    """
    ...
    location_is_within_boundary: Optional[StrictBool] = Field(default=None, description="Indicates whether this school's boundary includes the specified location from boundaryLatitude/boundaryLongitude or boundaryAddress. (School Boundary Add-on Package required)", alias="locationIsWithinBoundary")
