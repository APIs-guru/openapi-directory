...
class RankingsApi:
    ...
    def rankings_get_rank_district_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[APIDistrictListRank2]:
        """Returns a SchoolDigger district ranking list
    ...
    def _rankings_get_rank_district_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2.0/rankings/districts/{st}',
    ...
    def rankings_get_school_rank2(
        ...
        _param = self._rankings_get_school_rank2_serialize(
            st=st,
            app_id=app_id,
            app_key=app_key,
            year=year,
    ...
    @validate_call
    def rankings_get_school_rank2_with_http_info(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[APISchoolListRank2]:
        """Returns a SchoolDigger school ranking list
    ...
    @validate_call
    def rankings_get_school_rank2_without_preload_content(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _rankings_get_school_rank2_serialize(
        self,
        st,
        app_id,
        app_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2.0/rankings/schools/{st}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
