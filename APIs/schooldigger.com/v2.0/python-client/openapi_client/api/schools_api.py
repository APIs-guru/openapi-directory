...
class SchoolsApi:
    ...
    def schools_get_all_schools20(
        ...
        boundary_latitude: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Search for schools that include this (boundaryLatitude)/(boundaryLongitude) in its attendance boundary (e.g. 44.982560) (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.)")] = None,
        boundary_longitude: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Search for schools that include this (boundaryLatitude)/(boundaryLongitude) in its attendance boundary (e.g. -124.289185) (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.")] = None,
        boundary_address: Annotated[Optional[StrictStr], Field(description="Full U.S. address: flag returned schools that include this address in its attendance boundary. Example: '123 Main St. AnyTown CA 90001' (optional) (Requires School Boundary API Plan add-on. Calls with this parameter supplied will count toward your monthly call limit.) IMPORTANT NOTE: If you have the lat/long of the address, use boundaryLatitude and boundaryLongitude instead for much faster response times")] = None,
        is_in_boundary_only: Annotated[Optional[StrictBool], Field(description="Return only the schools that include given location (boundaryLatitude/boundaryLongitude) or (boundaryAddress) in its attendance boundary (Requires School Boundary API Plan add-on.)")] = None,
        ...
        _param = self._schools_get_all_schools20_serialize(
            st=st,
            app_id=app_id,
            app_key=app_key,
            q=q,
            ...
            boundary_longitude=boundary_longitude,
    ...
    @validate_call
    def schools_get_all_schools20_with_http_info(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA') - required")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    @validate_call
    def schools_get_all_schools20_without_preload_content(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA') - required")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _schools_get_all_schools20_serialize(
        self,
        st,
        app_id,
        app_key,
        ...
        if boundary_latitude is not None:
            
            _query_params.append(('boundaryLatitude', boundary_latitude))
            
        if boundary_longitude is not None:
            
            _query_params.append(('boundaryLongitude', boundary_longitude))
    ...
    def schools_get_school20(
        ...
        _param = self._schools_get_school20_serialize(
            id=id,
            app_id=app_id,
            app_key=app_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def schools_get_school20_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The 12 digit School ID (e.g. 064215006903)")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    @validate_call
    def schools_get_school20_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The 12 digit School ID (e.g. 064215006903)")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _schools_get_school20_serialize(
        self,
        id,
        app_id,
        app_key,
