...
class DistrictsApi:
    ...
    @validate_call
    def districts_get_all_districts2(
        self,
        ...
        _param = self._districts_get_all_districts2_serialize(
            st=st,
            app_id=app_id,
            app_key=app_key,
            q=q,
    ...
    @validate_call
    def districts_get_all_districts2_with_http_info(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA') - required")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    @validate_call
    def districts_get_all_districts2_without_preload_content(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA') - required")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _districts_get_all_districts2_serialize(
        self,
        st,
        app_id,
        app_key,
    ...
    def districts_get_district2(
        ...
        _param = self._districts_get_district2_serialize(
            id=id,
            app_id=app_id,
            app_key=app_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def districts_get_district2_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The 7 digit District ID (e.g. 0642150)")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    @validate_call
    def districts_get_district2_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The 7 digit District ID (e.g. 0642150)")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _districts_get_district2_serialize(
        self,
        id,
        app_id,
        app_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2.0/districts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
