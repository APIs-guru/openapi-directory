...
class APISchool1Summary(BaseModel):
    """
    ...
    has_boundary: Optional[StrictBool] = Field(default=None, description="Indicates that an attendance boundary is available for this school.", alias="hasBoundary")
    ...
    location_is_within_boundary: Optional[StrictBool] = Field(default=None, description="Indicates whether this school's boundary includes the specified location from nearLatitude/nearLongitude or boundaryAddress. (Enterprise API level only)", alias="locationIsWithinBoundary")
    ...
    url_compare: Optional[StrictStr] = Field(default=None, description="SchoolDigger URL for comparing this school to others", alias="urlCompare")
    __properties: ClassVar[List[str]] = ["address", "county", "distance", "district", "hasBoundary", "highGrade", "isCharterSchool", "isMagnetSchool", "isPrivate", "isTitleISchool", "isTitleISchoolwideSchool", "isVirtualSchool", "locationIsWithinBoundary", "lowGrade", "phone", "privateCoed", "privateDays", "privateHasLibrary", "privateHours", "privateOrientation", "rankHistory", "rankMovement", "schoolLevel", "schoolName", "schoolYearlyDetails", "schoolid", "url", "urlCompare"]
