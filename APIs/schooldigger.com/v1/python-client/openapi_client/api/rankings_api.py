...
class RankingsApi:
    ...
    def rankings_get_rank(
        ...
        _param = self._rankings_get_rank_serialize(
            st=st,
            app_id=app_id,
            app_key=app_key,
            year=year,
    ...
    @validate_call
    def rankings_get_rank_with_http_info(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    @validate_call
    def rankings_get_rank_without_preload_content(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _rankings_get_rank_serialize(
        self,
        st,
        app_id,
        app_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/rankings/schools/{st}',
    ...
    @validate_call
    def rankings_get_rank_district(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
        ...
        _param = self._rankings_get_rank_district_serialize(
            st=st,
            app_id=app_id,
            app_key=app_key,
            year=year,
    ...
    @validate_call
    def rankings_get_rank_district_with_http_info(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[APIDistrictListRank]:
        """Returns a SchoolDigger district ranking list
    ...
    @validate_call
    def rankings_get_rank_district_without_preload_content(
        self,
        st: Annotated[StrictStr, Field(description="Two character state (e.g. 'CA')")],
        app_id: Annotated[StrictStr, Field(description="Your API app id")],
        app_key: Annotated[StrictStr, Field(description="Your API app key")],
    ...
    def _rankings_get_rank_district_serialize(
        self,
        st,
        app_id,
        app_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/rankings/districts/{st}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
