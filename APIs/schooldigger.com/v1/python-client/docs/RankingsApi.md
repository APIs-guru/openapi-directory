...
------------- | ------------- | -------------
[**rankings_get_rank**](RankingsApi.md#rankings_get_rank) | **GET** /v1/rankings/schools/{st} | Returns a SchoolDigger school ranking list
[**rankings_get_rank_district**](RankingsApi.md#rankings_get_rank_district) | **GET** /v1/rankings/districts/{st} | Returns a SchoolDigger district ranking list


# **rankings_get_rank**
> APISchoolListRank rankings_get_rank(st, app_id, app_key, year=year, level=level, page=page, per_page=per_page)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns a SchoolDigger school ranking list
        api_response = api_instance.rankings_get_rank(st, app_id, app_key, year=year, level=level, page=page, per_page=per_page)
        print("The response of RankingsApi->rankings_get_rank:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RankingsApi->rankings_get_rank: %s\n" % e)
```
...
> APIDistrictListRank rankings_get_rank_district(st, app_id, app_key, year=year, page=page, per_page=per_page)
