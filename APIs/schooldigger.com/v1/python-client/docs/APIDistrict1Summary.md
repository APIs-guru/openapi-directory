...
api_district1_summary_instance = APIDistrict1Summary.from_json(json)
# print the JSON string representation of the object
print(APIDistrict1Summary.to_json())

# convert the object into a dict
api_district1_summary_dict = api_district1_summary_instance.to_dict()
# create an instance of APIDistrict1Summary from a dict
api_district1_summary_from_dict = APIDistrict1Summary.from_dict(api_district1_summary_dict)
```
