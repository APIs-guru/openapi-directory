...
message_recipient_response_instance = MessageRecipientResponse.from_json(json)
# print the JSON string representation of the object
print(MessageRecipientResponse.to_json())

# convert the object into a dict
message_recipient_response_dict = message_recipient_response_instance.to_dict()
# create an instance of MessageRecipientResponse from a dict
message_recipient_response_from_dict = MessageRecipientResponse.from_dict(message_recipient_response_dict)
```
