...
class CreditBalanceResponse(BaseModel):
    ...
    """ # noqa: E501
    credit_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The current remaining credit balance for the account. Contains a single decimal place", alias="creditBalance")
    ...
    __properties: ClassVar[List[str]] = ["creditBalance", "statusCode", "timeStamp", "version"]
