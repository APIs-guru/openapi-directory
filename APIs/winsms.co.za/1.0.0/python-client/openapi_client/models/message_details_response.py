...
class MessageDetailsResponse(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The message text that was sent. ")
    recipients: Optional[Annotated[List[MessageRecipientResponse1], Field(min_length=1, max_length=1000)]] = Field(default=None, description="An array of messageRecipientResponse objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipients": [MessageRecipientResponse1.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None
        })
        return _obj
