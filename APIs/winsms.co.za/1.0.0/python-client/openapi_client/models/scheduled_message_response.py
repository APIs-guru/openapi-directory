...
class ScheduledMessageResponse(BaseModel):
    ...
    scheduled_messages: Optional[Annotated[List[ScheduledMessage], Field(min_length=1, max_length=1000)]] = Field(default=None, description="An array of ***scheduledMessage*** objects containing properties of each unsent scheduled message. ", alias="scheduledMessages")
    ...
    __properties: ClassVar[List[str]] = ["resultsLimit", "resultsOffset", "resultsTotalAvailable", "scheduledMessages", "statusCode", "timeStamp", "version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.scheduled_messages:
            ...
            _dict['scheduledMessages'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scheduledMessages": [ScheduledMessage.from_dict(_item) for _item in obj["scheduledMessages"]] if obj.get("scheduledMessages") is not None else None,
