...
class ErrorDetails(BaseModel):
    ...
    ErrorDetails
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="A plain text description of the error that occurred, and possible solutions if available.  ", alias="errorMessage")
    ...
    __properties: ClassVar[List[str]] = ["errorMessage", "statusCode", "timeStamp", "version"]
