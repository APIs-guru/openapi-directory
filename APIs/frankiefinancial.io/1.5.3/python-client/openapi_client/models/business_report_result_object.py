...
class BusinessReportResultObject(BaseModel):
    """
    The positive result of a report generation request if any. 
    """ # noqa: E501
    document_id: Optional[StrictStr] = Field(default=None, alias="documentId")
    location: Optional[StrictStr] = None
    scan_doc_id: Optional[StrictStr] = Field(default=None, alias="scanDocId")
    __properties: ClassVar[List[str]] = ["documentId", "location", "scanDocId"]
