...
class DocumentSearchResultObject(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["documentSearchResults", "requestId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in document_search_results (list)
        _items = []
        if self.document_search_results:
            for _item_document_search_results in self.document_search_results:
                if _item_document_search_results:
                    _items.append(_item_document_search_results.to_dict())
            _dict['documentSearchResults'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentSearchResults": [DocumentSearchResultListItem.from_dict(_item) for _item in obj["documentSearchResults"]] if obj.get("documentSearchResults") is not None else None,
