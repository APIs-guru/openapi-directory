...
class EntitySearchResultObject(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entitySearchResults", "requestId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in entity_search_results (list)
        _items = []
        if self.entity_search_results:
            for _item_entity_search_results in self.entity_search_results:
                if _item_entity_search_results:
                    _items.append(_item_entity_search_results.to_dict())
            _dict['entitySearchResults'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitySearchResults": [EntitySearchResultListItem.from_dict(_item) for _item in obj["entitySearchResults"]] if obj.get("entitySearchResults") is not None else None,
