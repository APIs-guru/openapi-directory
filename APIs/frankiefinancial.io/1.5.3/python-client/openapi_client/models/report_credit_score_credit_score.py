...
class ReportCreditScoreCreditScore(BaseModel):
    """
    ...
    scores: Optional[CreditScoreObject] = None
    __properties: ClassVar[List[str]] = ["abn", "acn", "description", "itemCode", "scores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scores": CreditScoreObject.from_dict(obj["scores"]) if obj.get("scores") is not None else None
        })
        return _obj
