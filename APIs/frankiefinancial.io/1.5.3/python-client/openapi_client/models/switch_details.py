...
class SwitchDetails(BaseModel):
    ...
    """ # noqa: E501
    customer_details: SwitchDetailsCustomerDetails = Field(alias="customerDetails")
    __properties: ClassVar[List[str]] = ["customerDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customerDetails": SwitchDetailsCustomerDetails.from_dict(obj["customerDetails"]) if obj.get("customerDetails") is not None else None
        })
        return _obj
