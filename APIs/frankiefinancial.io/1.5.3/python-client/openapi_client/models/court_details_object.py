...
class CourtDetailsObject(BaseModel):
    """
    Officer court details as returned from an ASIC report.
    """ # noqa: E501
    application_number: Optional[StrictStr] = Field(default=None, alias="applicationNumber")
    application_year: Optional[Annotated[int, Field(le=2999, strict=True, ge=1000)]] = Field(default=None, alias="applicationYear")
    country: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    type: Optional[CodeDescription] = None
    __properties: ClassVar[List[str]] = ["applicationNumber", "applicationYear", "country", "state", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applicationYear": obj.get("applicationYear"),
