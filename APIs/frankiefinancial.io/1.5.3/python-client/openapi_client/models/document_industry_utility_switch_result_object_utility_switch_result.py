...
class DocumentIndustryUtilitySwitchResultObjectUtilitySwitchResult(BaseModel):
    """
    ...
    """ # noqa: E501
    error: Optional[SwitchError] = None
    result: Optional[SwitchResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": SwitchError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "result": SwitchResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
