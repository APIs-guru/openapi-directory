...
class EntityCheckDetailsObject(BaseModel):
    """
    ...
    """ # noqa: E501
    device_check_details: Optional[List[DeviceCheckDetailsObject]] = Field(default=None, alias="deviceCheckDetails")
    entity: EntityObject
    __properties: ClassVar[List[str]] = ["deviceCheckDetails", "entity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in device_check_details (list)
        _items = []
        if self.device_check_details:
            for _item_device_check_details in self.device_check_details:
                if _item_device_check_details:
                    _items.append(_item_device_check_details.to_dict())
            _dict['deviceCheckDetails'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deviceCheckDetails": [DeviceCheckDetailsObject.from_dict(_item) for _item in obj["deviceCheckDetails"]] if obj.get("deviceCheckDetails") is not None else None,
