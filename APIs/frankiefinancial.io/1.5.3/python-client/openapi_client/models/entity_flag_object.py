...
class EntityFlagObject(BaseModel):
    """
    ...
    """ # noqa: E501
    flag: Optional[StrictStr] = Field(default=None, description="Name of the flag")
    value: Optional[StrictInt] = Field(default=None, description="flag value.")
