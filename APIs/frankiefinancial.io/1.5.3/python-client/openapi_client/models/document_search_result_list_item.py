...
class DocumentSearchResultListItem(BaseModel):
    """
    Contains the individual search results for a document.
    """ # noqa: E501
    confidence: Optional[SearchResultConfidenceObject] = None
    document: Optional[IdentityDocumentObject] = None
    __properties: ClassVar[List[str]] = ["confidence", "document"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confidence": SearchResultConfidenceObject.from_dict(obj["confidence"]) if obj.get("confidence") is not None else None,
