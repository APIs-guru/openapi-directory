...
class ErrorObject(BaseModel):
    ...
    error_code: StrictStr = Field(description="Frankie error code", alias="errorCode")
    error_msg: StrictStr = Field(description="Will describe the error", alias="errorMsg")
    http_status_code: Optional[StrictInt] = Field(default=None, description="Deprecated: HTTP status code. Same as that which is passed back in the header. ", alias="httpStatusCode")
    issues: Optional[List[ErrorObjectIssuesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["commit", "errorCode", "errorMsg", "httpStatusCode", "issues", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issues": [ErrorObjectIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
