...
class BasicStatusResultObject(BaseModel):
    """
    ...
    status_msg: StrictStr = Field(description="Simple message describing the final status of the process. Only to be used in success case responses. Otherwise, use the ErrorObject. ", alias="statusMsg")
    __properties: ClassVar[List[str]] = ["requestId", "statusMsg"]
