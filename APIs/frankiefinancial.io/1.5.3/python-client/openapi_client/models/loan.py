...
class Loan(BaseModel):
    ...
    Loan
    """ # noqa: E501
    abn: Optional[StrictStr] = None
    acn: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["abn", "acn", "amount", "companyName", "endAt", "startAt", "status", "termLength", "type", "uuid"]
