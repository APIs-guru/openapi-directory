...
class OrganisationDataObjectRegistration(BaseModel):
    """
    OrganisationDataObjectRegistration
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    previous_number: Optional[StrictStr] = Field(default=None, alias="previousNumber")
    state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date", "previousNumber", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "previousNumber": obj.get("previousNumber"),
            "state": obj.get("state")
        })
        return _obj
