...
class DocumentIndustryUtilityConsentResultObjectUtilityConsentResult(BaseModel):
    """
    ...
    """ # noqa: E501
    error: Optional[EICError] = None
    result: Optional[EICResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": EICError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "result": EICResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
