...
class DocumentChecksResultObject(BaseModel):
    """
    Contains the results of a given document upload.
    """ # noqa: E501
    check_results: Optional[IdentityDocumentCheckResultObject] = Field(default=None, alias="checkResults")
    ...
    __properties: ClassVar[List[str]] = ["checkResults", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checkResults": IdentityDocumentCheckResultObject.from_dict(obj["checkResults"]) if obj.get("checkResults") is not None else None,
