...
class DocumentIndustryUtilityProcessResultObjectUtilityCompareResult(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ComparisonError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "result": ComparisonResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
