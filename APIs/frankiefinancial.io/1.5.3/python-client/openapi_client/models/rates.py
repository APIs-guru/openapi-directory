...
class Rates(BaseModel):
    ...
    value: Optional[List[NameValueUnit]] = Field(default=None, description="Rates for this plan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": [NameValueUnit.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
