...
class DocumentScanResultObject(BaseModel):
    """
    ...
    """ # noqa: E501
    extracted_document: Optional[IdentityDocumentObject] = Field(default=None, alias="extractedDocument")
    extracted_entity: Optional[EntityObject] = Field(default=None, alias="extractedEntity")
    process_result: ProcessResultObject = Field(alias="processResult")
    ...
    __properties: ClassVar[List[str]] = ["extractedDocument", "extractedEntity", "processResult", "requestId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of extracted_document
        if self.extracted_document:
            _dict['extractedDocument'] = self.extracted_document.to_dict()
        # override the default output from pydantic by calling `to_dict()` of extracted_entity
        if self.extracted_entity:
            _dict['extractedEntity'] = self.extracted_entity.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extractedDocument": IdentityDocumentObject.from_dict(obj["extractedDocument"]) if obj.get("extractedDocument") is not None else None,
            "extractedEntity": EntityObject.from_dict(obj["extractedEntity"]) if obj.get("extractedEntity") is not None else None,
