...
class USOfficerDTO(BaseModel):
    """
    USOfficerDTO
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, alias="Address")
    business_address: Optional[ArrayOfString1] = Field(default=None, alias="BusinessAddress")
    ...
    __properties: ClassVar[List[str]] = ["Address", "BusinessAddress", "Date", "MailingAddress", "Name", "Title", "Type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BusinessAddress": ArrayOfString1.from_dict(obj["BusinessAddress"]) if obj.get("BusinessAddress") is not None else None,
            "Date": obj.get("Date"),
