...
class DisplayMarkUpParametersValue(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of parameter * `link` - The 'value' contains a link to external content. The user should be able click on this link to view the content. * `mailto` - The 'value' contains an email address. The user should be able click on this address to send open their email client.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['link', 'mailto']):
            raise ValueError("must be one of enum values ('link', 'mailto')")
        return value
