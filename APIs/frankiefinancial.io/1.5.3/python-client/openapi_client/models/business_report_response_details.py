...
class BusinessReportResponseDetails(BaseModel):
    """
    Results of the entity create or update along with the results of the requested reports. 
    """ # noqa: E501
    check_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the report operation. ", alias="checkId")
    entity: Optional[EntityObject] = None
    reports: Optional[List[BusinessReportResponseObject]] = Field(default=None, description="The collection of requested business reports. ")
    ...
    __properties: ClassVar[List[str]] = ["checkId", "entity", "reports", "requestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [BusinessReportResponseObject.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
