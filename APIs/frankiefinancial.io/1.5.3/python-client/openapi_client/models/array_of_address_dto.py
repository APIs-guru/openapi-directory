...
class ArrayOfAddressDTO(BaseModel):
    """
    ArrayOfAddressDTO
    """ # noqa: E501
    addresses: Optional[List[AddressDTO]] = Field(default=None, alias="Addresses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Addresses": [AddressDTO.from_dict(_item) for _item in obj["Addresses"]] if obj.get("Addresses") is not None else None
        })
        return _obj
