...
class TestDisplayMarkUp(unittest.TestCase):
    """DisplayMarkUp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisplayMarkUp:
        """Test DisplayMarkUp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisplayMarkUp`
        """
        model = DisplayMarkUp()
        if include_optional:
