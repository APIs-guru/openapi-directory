...
class TestComparisonSet(unittest.TestCase):
    """ComparisonSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComparisonSet:
        """Test ComparisonSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComparisonSet`
        """
        model = ComparisonSet()
        if include_optional:
            return ComparisonSet(
                compare_document = openapi_client.models.identity_document_object.IdentityDocumentObject(
                    country = 'AUS', 
                    ...
                    region = 'VIC', ),
                to_document = openapi_client.models.identity_document_object.IdentityDocumentObject(
                    country = 'AUS', 
                    created_from_scan = True, 
                    doc_scan = [
                        openapi_client.models.scanned_document_object.ScannedDocumentObject(
