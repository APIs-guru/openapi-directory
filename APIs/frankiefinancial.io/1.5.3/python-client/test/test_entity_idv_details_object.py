...
class TestEntityIDVDetailsObject(unittest.TestCase):
    """EntityIDVDetailsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityIDVDetailsObject:
        """Test EntityIDVDetailsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityIDVDetailsObject`
        """
        model = EntityIDVDetailsObject()
        if include_optional:
            return EntityIDVDetailsObject(
                applicant_id = '',
                application_id = '',
    ...
    def testEntityIDVDetailsObject(self):
        """Test EntityIDVDetailsObject"""
