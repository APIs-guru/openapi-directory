...
class TestSwitchDetailsCustomerDetails(unittest.TestCase):
    """SwitchDetailsCustomerDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwitchDetailsCustomerDetails:
        """Test SwitchDetailsCustomerDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwitchDetailsCustomerDetails`
        """
        model = SwitchDetailsCustomerDetails()
        if include_optional:
            return SwitchDetailsCustomerDetails(
    ...
    def testSwitchDetailsCustomerDetails(self):
        """Test SwitchDetailsCustomerDetails"""
