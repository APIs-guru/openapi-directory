...
class TestOwnershipQueryResponseObject(unittest.TestCase):
    """OwnershipQueryResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnershipQueryResponseObject:
        """Test OwnershipQueryResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnershipQueryResponseObject`
        """
        model = OwnershipQueryResponseObject()
        if include_optional:
            return OwnershipQueryResponseObject(
    ...
    def testOwnershipQueryResponseObject(self):
        """Test OwnershipQueryResponseObject"""
