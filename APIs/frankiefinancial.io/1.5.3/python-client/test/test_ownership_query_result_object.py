...
class TestOwnershipQueryResultObject(unittest.TestCase):
    """OwnershipQueryResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnershipQueryResultObject:
        """Test OwnershipQueryResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnershipQueryResultObject`
        """
        model = OwnershipQueryResultObject()
        if include_optional:
            return OwnershipQueryResultObject(
                associated_entities = {
    ...
    def testOwnershipQueryResultObject(self):
        """Test OwnershipQueryResultObject"""
