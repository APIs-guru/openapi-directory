...
class TestBackgroundCheckResultObject(unittest.TestCase):
    """BackgroundCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundCheckResultObject:
        """Test BackgroundCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundCheckResultObject`
        """
        model = BackgroundCheckResultObject()
        if include_optional:
            return BackgroundCheckResultObject(
    ...
    def testBackgroundCheckResultObject(self):
        """Test BackgroundCheckResultObject"""
