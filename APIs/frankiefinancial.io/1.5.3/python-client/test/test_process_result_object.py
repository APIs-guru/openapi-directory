...
class TestProcessResultObject(unittest.TestCase):
    """ProcessResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessResultObject:
        """Test ProcessResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessResultObject`
        """
        model = ProcessResultObject()
        if include_optional:
    ...
    def testProcessResultObject(self):
        """Test ProcessResultObject"""
