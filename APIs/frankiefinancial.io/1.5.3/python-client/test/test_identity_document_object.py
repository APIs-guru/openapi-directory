...
class TestIdentityDocumentObject(unittest.TestCase):
    """IdentityDocumentObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityDocumentObject:
        """Test IdentityDocumentObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityDocumentObject`
        """
        model = IdentityDocumentObject()
        if include_optional:
            return IdentityDocumentObject(
                country = 'AUS',
    ...
    def testIdentityDocumentObject(self):
        """Test IdentityDocumentObject"""
