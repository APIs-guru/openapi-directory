...
class TestEntitySearchResultListItem(unittest.TestCase):
    """EntitySearchResultListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitySearchResultListItem:
        """Test EntitySearchResultListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitySearchResultListItem`
        """
        model = EntitySearchResultListItem()
        if include_optional:
            return EntitySearchResultListItem(
                confidence = openapi_client.models.search_result_confidence_object.SearchResultConfidenceObject(
                    ...
                    score = 70, ),
                document_match_types = [
                    'ID number'
                    ],
                document_name_mismatches = [
    ...
    def testEntitySearchResultListItem(self):
        """Test EntitySearchResultListItem"""
