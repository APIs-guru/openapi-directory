...
class TestScreeningResult(unittest.TestCase):
    """ScreeningResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreeningResult:
        """Test ScreeningResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScreeningResult`
        """
