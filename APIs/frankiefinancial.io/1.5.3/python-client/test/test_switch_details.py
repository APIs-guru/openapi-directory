...
class TestSwitchDetails(unittest.TestCase):
    """SwitchDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwitchDetails:
        """Test SwitchDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwitchDetails`
        """
        model = SwitchDetails()
        if include_optional:
