    ...
    def make_instance(self, include_optional) -> Plan:
        ...
        if include_optional:
            return Plan(
                ...
                green_options = openapi_client.models.name_value.NameValue(
                    name = '', 
                    value = [
                        ''
                        ], ),
                ...
                payment_options = openapi_client.models.name_value.NameValue(
                    name = '', 
                    value = [
                        ''
                        ], ),
                rates = openapi_client.models.rates.Rates(
                    name = 'Rates', 
                    value = [
                        openapi_client.models.name_value_unit.NameValueUnit(
                            name = 'Peak Rate', 
