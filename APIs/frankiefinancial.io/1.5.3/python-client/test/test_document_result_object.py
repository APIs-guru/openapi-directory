...
class TestDocumentResultObject(unittest.TestCase):
    """DocumentResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentResultObject:
        """Test DocumentResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentResultObject`
        """
        model = DocumentResultObject()
        if include_optional:
    ...
    def testDocumentResultObject(self):
        """Test DocumentResultObject"""
