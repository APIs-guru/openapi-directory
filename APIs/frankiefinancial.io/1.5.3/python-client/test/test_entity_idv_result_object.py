...
class TestEntityIDVResultObject(unittest.TestCase):
    """EntityIDVResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityIDVResultObject:
        """Test EntityIDVResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityIDVResultObject`
        """
        model = EntityIDVResultObject()
        if include_optional:
    ...
    def testEntityIDVResultObject(self):
        """Test EntityIDVResultObject"""
