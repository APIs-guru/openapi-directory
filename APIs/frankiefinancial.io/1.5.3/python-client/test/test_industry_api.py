...
class TestIndustryApi(unittest.TestCase):
    ...
    def test_create_process_industry_utility_document(self) -> None:
    ...
    def test_update_process_industry_utility_document(self) -> None:
    ...
    def test_update_process_industry_utility_document_consent(self) -> None:
    ...
    def test_update_process_industry_utility_document_switch(self) -> None:
