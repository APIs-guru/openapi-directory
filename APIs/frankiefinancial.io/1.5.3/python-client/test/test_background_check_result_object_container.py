...
class TestBackgroundCheckResultObjectContainer(unittest.TestCase):
    """BackgroundCheckResultObjectContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundCheckResultObjectContainer:
        """Test BackgroundCheckResultObjectContainer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundCheckResultObjectContainer`
        """
        model = BackgroundCheckResultObjectContainer()
        if include_optional:
            return BackgroundCheckResultObjectContainer(
    ...
    def testBackgroundCheckResultObjectContainer(self):
        """Test BackgroundCheckResultObjectContainer"""
