...
class TestIdentityDocumentCheckResultObject(unittest.TestCase):
    """IdentityDocumentCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityDocumentCheckResultObject:
        """Test IdentityDocumentCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityDocumentCheckResultObject`
        """
        model = IdentityDocumentCheckResultObject()
        if include_optional:
            return IdentityDocumentCheckResultObject(
                check_result = [
    ...
    def testIdentityDocumentCheckResultObject(self):
        """Test IdentityDocumentCheckResultObject"""
