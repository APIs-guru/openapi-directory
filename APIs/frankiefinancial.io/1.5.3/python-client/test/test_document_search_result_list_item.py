...
class TestDocumentSearchResultListItem(unittest.TestCase):
    """DocumentSearchResultListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentSearchResultListItem:
        """Test DocumentSearchResultListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentSearchResultListItem`
        """
        model = DocumentSearchResultListItem()
        if include_optional:
            return DocumentSearchResultListItem(
    ...
    def testDocumentSearchResultListItem(self):
        """Test DocumentSearchResultListItem"""
