...
class TestEICResponse(unittest.TestCase):
    """EICResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EICResponse:
        """Test EICResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EICResponse`
        """
        model = EICResponse()
        if include_optional:
            return EICResponse(
