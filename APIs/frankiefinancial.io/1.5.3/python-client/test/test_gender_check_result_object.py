...
class TestGenderCheckResultObject(unittest.TestCase):
    """GenderCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenderCheckResultObject:
        """Test GenderCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenderCheckResultObject`
        """
        model = GenderCheckResultObject()
        if include_optional:
            return GenderCheckResultObject(
                check_result = [
    ...
    def testGenderCheckResultObject(self):
        """Test GenderCheckResultObject"""
