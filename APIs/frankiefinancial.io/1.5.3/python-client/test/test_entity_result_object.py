...
class TestEntityResultObject(unittest.TestCase):
    """EntityResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityResultObject:
        """Test EntityResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityResultObject`
        """
        model = EntityResultObject()
        if include_optional:
    ...
    def testEntityResultObject(self):
        """Test EntityResultObject"""
