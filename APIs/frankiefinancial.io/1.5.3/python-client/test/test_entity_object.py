...
class TestEntityObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EntityObject:
        """Test EntityObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityObject`
        """
        model = EntityObject()
        if include_optional:
            return EntityObject(
