...
class TestOfficerObject(unittest.TestCase):
    """OfficerObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfficerObject:
        """Test OfficerObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfficerObject`
        """
        model = OfficerObject()
        if include_optional:
