...
class TestAMLResultSet(unittest.TestCase):
    """AMLResultSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AMLResultSet:
        """Test AMLResultSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AMLResultSet`
        """
        model = AMLResultSet()
        if include_optional:
            return AMLResultSet(
                ...
                group_details = openapi_client.models.background_check_result_object_container.backgroundCheckResultObjectContainer(
                    bcro = openapi_client.models.background_check_result_object.backgroundCheckResultObject(
                        background_check_type = 'PEP', 
                        check_details = [
                            openapi_client.models.key_value_pair_object.KeyValuePairObject(
