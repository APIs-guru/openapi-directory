...
class TestAddressCheckResultObject(unittest.TestCase):
    """AddressCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressCheckResultObject:
        """Test AddressCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressCheckResultObject`
        """
        model = AddressCheckResultObject()
        if include_optional:
            return AddressCheckResultObject(
    ...
    def testAddressCheckResultObject(self):
        """Test AddressCheckResultObject"""
