...
class TestOwnershipDetailsObject(unittest.TestCase):
    """OwnershipDetailsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnershipDetailsObject:
        """Test OwnershipDetailsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnershipDetailsObject`
        """
        model = OwnershipDetailsObject()
        if include_optional:
            return OwnershipDetailsObject(
                beneficial_owners = [
    ...
    def testOwnershipDetailsObject(self):
        """Test OwnershipDetailsObject"""
