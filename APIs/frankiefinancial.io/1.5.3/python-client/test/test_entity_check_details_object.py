...
class TestEntityCheckDetailsObject(unittest.TestCase):
    """EntityCheckDetailsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityCheckDetailsObject:
        """Test EntityCheckDetailsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityCheckDetailsObject`
        """
        model = EntityCheckDetailsObject()
        if include_optional:
            return EntityCheckDetailsObject(
                device_check_details = [
                    openapi_client.models.device_check_details_object.DeviceCheckDetailsObject(
    ...
    def testEntityCheckDetailsObject(self):
        """Test EntityCheckDetailsObject"""
