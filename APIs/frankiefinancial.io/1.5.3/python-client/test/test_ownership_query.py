...
class TestOwnershipQuery(unittest.TestCase):
    """OwnershipQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnershipQuery:
        """Test OwnershipQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnershipQuery`
        """
        model = OwnershipQuery()
        if include_optional:
