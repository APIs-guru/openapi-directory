...
class TestDefaultOffer(unittest.TestCase):
    """DefaultOffer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultOffer:
        """Test DefaultOffer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultOffer`
        """
        model = DefaultOffer()
        if include_optional:
            return DefaultOffer(
