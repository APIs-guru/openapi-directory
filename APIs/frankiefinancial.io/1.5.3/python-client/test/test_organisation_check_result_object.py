...
class TestOrganisationCheckResultObject(unittest.TestCase):
    """OrganisationCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganisationCheckResultObject:
        """Test OrganisationCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganisationCheckResultObject`
        """
        model = OrganisationCheckResultObject()
        if include_optional:
            return OrganisationCheckResultObject(
                entity_categories = {
                    'key' : [
                        ''
                        ]
    ...
    def testOrganisationCheckResultObject(self):
        """Test OrganisationCheckResultObject"""
