...
class TestDOBCheckResultObject(unittest.TestCase):
    """DOBCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DOBCheckResultObject:
        """Test DOBCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DOBCheckResultObject`
        """
        model = DOBCheckResultObject()
        if include_optional:
            return DOBCheckResultObject(
                check_result = [
    ...
    def testDOBCheckResultObject(self):
        """Test DOBCheckResultObject"""
