...
class TestScannedDocumentObject(unittest.TestCase):
    """ScannedDocumentObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScannedDocumentObject:
        """Test ScannedDocumentObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScannedDocumentObject`
        """
        model = ScannedDocumentObject()
        if include_optional:
            return ScannedDocumentObject(
                scan_delete = True,
    ...
    def testScannedDocumentObject(self):
        """Test ScannedDocumentObject"""
