...
class TestDocumentIndustryUtilityProcessResultObject(unittest.TestCase):
    """DocumentIndustryUtilityProcessResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentIndustryUtilityProcessResultObject:
        """Test DocumentIndustryUtilityProcessResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentIndustryUtilityProcessResultObject`
        """
        model = DocumentIndustryUtilityProcessResultObject()
        if include_optional:
            return DocumentIndustryUtilityProcessResultObject(
                document_id = '84a9a860-68ae-4d7d-9a53-54a1116d5051',
                industry_process = 'elecCompareResult',
                request_id = '01BFJA617JMJXEW6G7TDDXNSHX',
                utility_compare_result = openapi_client.models.document_industry_utility_process_result_object_utility_compare_result.DocumentIndustryUtilityProcessResultObject_utilityCompareResult(
...
Your actual bill will vary depending on your actual usage, tariff type and distributor.', ), 
    ...
    def testDocumentIndustryUtilityProcessResultObject(self):
        """Test DocumentIndustryUtilityProcessResultObject"""
