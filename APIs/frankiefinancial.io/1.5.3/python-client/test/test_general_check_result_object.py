...
class TestGeneralCheckResultObject(unittest.TestCase):
    """GeneralCheckResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralCheckResultObject:
        """Test GeneralCheckResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralCheckResultObject`
        """
        model = GeneralCheckResultObject()
        if include_optional:
            return GeneralCheckResultObject(
    ...
    def testGeneralCheckResultObject(self):
        """Test GeneralCheckResultObject"""
