...
class TestEntitySearchResultObject(unittest.TestCase):
    """EntitySearchResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitySearchResultObject:
        """Test EntitySearchResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitySearchResultObject`
        """
        model = EntitySearchResultObject()
        if include_optional:
            return EntitySearchResultObject(
                entity_search_results = [
                    openapi_client.models.entity_search_result_list_item.EntitySearchResultListItem(
    ...
    def testEntitySearchResultObject(self):
        """Test EntitySearchResultObject"""
