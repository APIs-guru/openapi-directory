...
class TestDocumentChecksResultObject(unittest.TestCase):
    """DocumentChecksResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentChecksResultObject:
        """Test DocumentChecksResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentChecksResultObject`
        """
        model = DocumentChecksResultObject()
        if include_optional:
            return DocumentChecksResultObject(
                check_results = openapi_client.models.identity_document_check_result_object.IdentityDocumentCheckResultObject(
                    check_result = [
    ...
    def testDocumentChecksResultObject(self):
        """Test DocumentChecksResultObject"""
