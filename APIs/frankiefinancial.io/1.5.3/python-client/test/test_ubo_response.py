...
class TestUBOResponse(unittest.TestCase):
    """UBOResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UBOResponse:
        """Test UBOResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UBOResponse`
        """
        model = UBOResponse()
        if include_optional:
            return UBOResponse(
