...
class TestDocumentScanResultObject(unittest.TestCase):
    """DocumentScanResultObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentScanResultObject:
        """Test DocumentScanResultObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentScanResultObject`
        """
        model = DocumentScanResultObject()
        if include_optional:
            return DocumentScanResultObject(
                extracted_document = openapi_client.models.identity_document_object.IdentityDocumentObject(
                    country = 'AUS', 
                    ...
                    region = 'VIC', ),
                extracted_entity = openapi_client.models.entity_object.EntityObject(
                    addresses = [
    ...
    def testDocumentScanResultObject(self):
        """Test DocumentScanResultObject"""
