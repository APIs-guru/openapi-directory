...
class ScheduledMessagesResponseMessage(BaseModel):
    """
    ScheduledMessagesResponseMessage
    """ # noqa: E501
    var_schema: Optional[ScheduledMessage] = Field(default=None, alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schema": ScheduledMessage.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
