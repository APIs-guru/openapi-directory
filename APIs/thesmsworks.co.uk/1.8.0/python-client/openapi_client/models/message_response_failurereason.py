...
class MessageResponseFailurereason(BaseModel):
    """
    MessageResponseFailurereason
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Numeric code that defines the error. Integer.")
    details: Optional[StrictStr] = None
    permanent: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["code", "details", "permanent"]
