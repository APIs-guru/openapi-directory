...
class InlineQueryResultAudio(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["audio_duration", "audio_url", "caption", "caption_entities", "id", "input_message_content", "parse_mode", "performer", "reply_markup", "title", "type"]
