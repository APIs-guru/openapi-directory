...
class InputMediaAudio(BaseModel):
    ...
    """ # noqa: E501
    caption: Optional[StrictStr] = Field(default=None, description="*Optional*. Caption of the audio to be sent, 0-1024 characters after entities parsing")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "duration", "media", "parse_mode", "performer", "thumb", "title", "type"]
