...
class InlineQueryResultCachedPhoto(BaseModel):
    ...
    """ # noqa: E501
    caption: Optional[StrictStr] = Field(default=None, description="*Optional*. Caption of the photo to be sent, 0-1024 characters after entities parsing")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "description", "id", "input_message_content", "parse_mode", "photo_file_id", "reply_markup", "title", "type"]
