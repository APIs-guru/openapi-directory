...
class EditMessageCaptionPostRequest(BaseModel):
    ...
    """ # noqa: E501
    caption: Optional[StrictStr] = Field(default=None, description="New caption of the message, 0-1024 characters after entities parsing")
    caption_entities: Optional[List[MessageEntity]] = Field(default=None, description="List of special entities that appear in the caption, which can be specified instead of *parse\\_mode*")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "chat_id", "inline_message_id", "message_id", "parse_mode", "reply_markup"]
