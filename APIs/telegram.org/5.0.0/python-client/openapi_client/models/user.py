...
class User(BaseModel):
    ...
    can_read_all_group_messages: Optional[StrictBool] = Field(default=None, description="*Optional*. True, if [privacy mode](https://core.telegram.org/bots#privacy-mode) is disabled for the bot. Returned only in [getMe](https://core.telegram.org/bots/api/#getme).")
    first_name: StrictStr = Field(description="User's or bot's first name")
    id: StrictInt = Field(description="Unique identifier for this user or bot")
    ...
    __properties: ClassVar[List[str]] = ["can_join_groups", "can_read_all_group_messages", "first_name", "id", "is_bot", "language_code", "last_name", "supports_inline_queries", "username"]
