...
class InputMediaVideo(BaseModel):
    ...
    duration: Optional[StrictInt] = Field(default=None, description="*Optional*. Video duration")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "duration", "height", "media", "parse_mode", "supports_streaming", "thumb", "type", "width"]
