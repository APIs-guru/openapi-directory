...
class UnpinChatMessagePostRequest(BaseModel):
    ...
    message_id: Optional[StrictInt] = Field(default=None, description="Identifier of a message to unpin. If not specified, the most recent pinned message (by sending date) will be unpinned.")
