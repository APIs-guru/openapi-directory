...
class InlineQueryResultCachedMpeg4Gif(BaseModel):
    ...
    mpeg4_file_id: StrictStr = Field(description="A valid file identifier for the MP4 file")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "id", "input_message_content", "mpeg4_file_id", "parse_mode", "reply_markup", "title", "type"]
