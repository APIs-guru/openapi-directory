...
class Animation(BaseModel):
    ...
    """ # noqa: E501
    duration: StrictInt = Field(description="Duration of the video in seconds as defined by sender")
    file_id: StrictStr = Field(description="Identifier for this file, which can be used to download or reuse the file")
    file_name: Optional[StrictStr] = Field(default=None, description="*Optional*. Original animation filename as defined by sender")
    ...
    height: StrictInt = Field(description="Video height as defined by sender")
    mime_type: Optional[StrictStr] = Field(default=None, description="*Optional*. MIME type of the file as defined by sender")
    thumb: Optional[PhotoSize] = None
    width: StrictInt = Field(description="Video width as defined by sender")
    __properties: ClassVar[List[str]] = ["duration", "file_id", "file_name", "file_size", "file_unique_id", "height", "mime_type", "thumb", "width"]
