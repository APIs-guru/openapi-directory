...
class VideoNote(BaseModel):
    ...
    length: StrictInt = Field(description="Video width and height (diameter of the video message) as defined by sender")
    thumb: Optional[PhotoSize] = None
    __properties: ClassVar[List[str]] = ["duration", "file_id", "file_size", "file_unique_id", "length", "thumb"]
