...
class EditMessageTextPostRequest(BaseModel):
    ...
    text: StrictStr = Field(description="New text of the message, 1-4096 characters after entities parsing")
    __properties: ClassVar[List[str]] = ["chat_id", "disable_web_page_preview", "entities", "inline_message_id", "message_id", "parse_mode", "reply_markup", "text"]
