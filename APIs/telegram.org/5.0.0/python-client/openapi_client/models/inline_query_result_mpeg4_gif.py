...
class InlineQueryResultMpeg4Gif(BaseModel):
    ...
    """ # noqa: E501
    caption: Optional[StrictStr] = Field(default=None, description="*Optional*. Caption of the MPEG-4 file to be sent, 0-1024 characters after entities parsing")
    ...
    mpeg4_duration: Optional[StrictInt] = Field(default=None, description="*Optional*. Video duration")
    mpeg4_height: Optional[StrictInt] = Field(default=None, description="*Optional*. Video height")
    mpeg4_url: StrictStr = Field(description="A valid URL for the MP4 file. File size must not exceed 1MB")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "id", "input_message_content", "mpeg4_duration", "mpeg4_height", "mpeg4_url", "mpeg4_width", "parse_mode", "reply_markup", "thumb_mime_type", "thumb_url", "title", "type"]
