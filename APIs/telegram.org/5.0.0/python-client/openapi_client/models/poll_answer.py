...
class PollAnswer(BaseModel):
    ...
    """ # noqa: E501
    option_ids: List[StrictInt] = Field(description="0-based identifiers of answer options, chosen by the user. May be empty if the user retracted their vote.")
    poll_id: StrictStr = Field(description="Unique poll identifier")
    user: User
    __properties: ClassVar[List[str]] = ["option_ids", "poll_id", "user"]
