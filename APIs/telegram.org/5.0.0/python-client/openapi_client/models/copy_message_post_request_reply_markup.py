...
COPYMESSAGEPOSTREQUESTREPLYMARKUP_ANY_OF_SCHEMAS = ["ForceReply", "InlineKeyboardMarkup", "ReplyKeyboardMarkup", "ReplyKeyboardRemove"]

class CopyMessagePostRequestReplyMarkup(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CopyMessagePostRequestReplyMarkup.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CopyMessagePostRequestReplyMarkup with anyOf schemas: ForceReply, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CopyMessagePostRequestReplyMarkup with anyOf schemas: ForceReply, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove. Details: " + ", ".join(error_messages))
        else:
            return instance
