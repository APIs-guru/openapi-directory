...
class SendContactPostRequest(BaseModel):
    ...
    reply_markup: Optional[SendContactPostRequestReplyMarkup] = None
    ...
    __properties: ClassVar[List[str]] = ["allow_sending_without_reply", "chat_id", "disable_notification", "first_name", "last_name", "phone_number", "reply_markup", "reply_to_message_id", "vcard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reply_markup": SendContactPostRequestReplyMarkup.from_dict(obj["reply_markup"]) if obj.get("reply_markup") is not None else None,
