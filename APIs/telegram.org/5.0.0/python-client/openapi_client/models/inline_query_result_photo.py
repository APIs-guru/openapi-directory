...
class InlineQueryResultPhoto(BaseModel):
    ...
    thumb_url: StrictStr = Field(description="URL of the thumbnail for the photo")
    ...
    __properties: ClassVar[List[str]] = ["caption", "caption_entities", "description", "id", "input_message_content", "parse_mode", "photo_height", "photo_url", "photo_width", "reply_markup", "thumb_url", "title", "type"]
