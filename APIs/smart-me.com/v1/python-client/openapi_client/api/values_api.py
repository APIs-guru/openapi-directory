...
class ValuesApi:
    ...
    def values_get(
        ...
        _param = self._values_get_serialize(
            id=id,
    ...
    @validate_call
    def values_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the device")],
        _request_timeout: Union[
            None,
