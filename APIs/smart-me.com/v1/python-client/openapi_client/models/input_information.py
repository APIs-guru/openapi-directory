...
class InputInformation(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The Name of the Input", alias="Name")
    number: Optional[StrictInt] = Field(default=None, description="The Number of this Input. Use this as ID to switch it on or off.", alias="Number")
