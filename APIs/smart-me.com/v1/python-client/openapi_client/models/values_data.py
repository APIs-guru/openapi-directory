...
class ValuesData(BaseModel):
    ...
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, description="The Date of the Value", alias="Date")
    device_id: Optional[StrictStr] = Field(default=None, description="The ID of the device", alias="DeviceId")
    values: Optional[List[ValueData]] = Field(default=None, description="All values", alias="Values")
    __properties: ClassVar[List[str]] = ["Date", "DeviceId", "Values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Values": [ValueData.from_dict(_item) for _item in obj["Values"]] if obj.get("Values") is not None else None
        })
        return _obj
