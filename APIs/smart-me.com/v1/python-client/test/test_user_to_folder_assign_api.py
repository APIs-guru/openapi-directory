...
class TestUserToFolderAssignApi(unittest.TestCase):
    """UserToFolderAssignApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UserToFolderAssignApi()

    def tearDown(self) -> None:
        pass

    def test_user_to_folder_assign_delete(self) -> None:
    ...
    def test_user_to_folder_assign_post(self) -> None:
