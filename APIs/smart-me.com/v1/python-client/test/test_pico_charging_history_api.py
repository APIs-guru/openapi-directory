...
class TestPicoChargingHistoryApi(unittest.TestCase):
    """PicoChargingHistoryApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PicoChargingHistoryApi()

    def tearDown(self) -> None:
        pass

    def test_pico_charging_history_get(self) -> None:
