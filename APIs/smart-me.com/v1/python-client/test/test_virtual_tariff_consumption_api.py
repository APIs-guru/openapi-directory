...
class TestVirtualTariffConsumptionApi(unittest.TestCase):
    """VirtualTariffConsumptionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = VirtualTariffConsumptionApi()

    def tearDown(self) -> None:
        pass

    def test_virtual_tariff_consumption_get(self) -> None:
