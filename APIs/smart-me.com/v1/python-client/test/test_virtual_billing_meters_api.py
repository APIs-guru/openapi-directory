...
class TestVirtualBillingMetersApi(unittest.TestCase):
    """VirtualBillingMetersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = VirtualBillingMetersApi()

    def tearDown(self) -> None:
        pass

    def test_virtual_billing_meters_get(self) -> None:
