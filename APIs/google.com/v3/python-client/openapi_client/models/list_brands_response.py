...
class ListBrandsResponse(BaseModel):
    ...
    """ # noqa: E501
    brands: Optional[List[Brand]] = Field(default=None, description="A list of all brands associated with the Hotel Center account being queried.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brands": [Brand.from_dict(_item) for _item in obj["brands"]] if obj.get("brands") is not None else None
        })
        return _obj
