...
class ShareApi:
    ...
    def share_map_id_get(
        ...
        _param = self._share_map_id_get_serialize(
            id=id,
    ...
    @validate_call
    def share_map_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Id of map")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def share_map_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Id of map")],
        _request_timeout: Union[
            None,
    ...
    def _share_map_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
