...
class MapCounts(BaseModel):
    ...
    MapCounts
    """ # noqa: E501
    attachments: Optional[StrictInt] = None
    comments: Optional[StrictInt] = None
    impressions: Optional[StrictInt] = None
    respots: Optional[StrictInt] = None
    spots: Optional[StrictInt] = None
    subscriptions: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["attachments", "comments", "impressions", "respots", "spots", "subscriptions"]
