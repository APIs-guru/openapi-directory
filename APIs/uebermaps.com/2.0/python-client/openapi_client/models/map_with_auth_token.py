...
class MapWithAuthToken(BaseModel):
    """
    MapWithAuthToken
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["counts", "created_at", "description", "id", "owner_id", "picture_url", "title", "token", "updated_at", "visibility"]
