...
class GetSellerProductsStatus(BaseModel):
    """
    GetSellerProductsStatus
    """ # noqa: E501
    metadata: Optional[List[Metadata]] = Field(default=None, description="Response payload")
    skus: Optional[List[GetSellerProductStatus]] = Field(default=None, description="Status of the products from the seller")
    __properties: ClassVar[List[str]] = ["metadata", "skus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skus": [GetSellerProductStatus.from_dict(_item) for _item in obj["skus"]] if obj.get("skus") is not None else None
        })
        return _obj
