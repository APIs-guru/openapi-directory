...
class GetProductsResponse(BaseModel):
    ...
    GetProductsResponse
    """ # noqa: E501
    metadata: Optional[List[Metadata]] = Field(default=None, description="Payload with response")
    skus: Optional[List[GetProduct]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skus": [GetProduct.from_dict(_item) for _item in obj["skus"]] if obj.get("skus") is not None else None
        })
        return _obj
