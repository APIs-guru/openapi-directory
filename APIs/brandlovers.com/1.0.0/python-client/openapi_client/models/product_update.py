...
class ProductUpdate(BaseModel):
    ...
    ProductUpdate
    """ # noqa: E501
    attributes: Optional[List[ProductAttribute]] = Field(default=None, description="List of `key` `value` attributes of this product. This is very important for search and SEO optmization. Include all relevant information")
    brand: Optional[StrictStr] = Field(default=None, description="Brand name")
    categories: Optional[List[StrictStr]] = Field(default=None, description="Array of categories associated with this product")
    description: Optional[StrictStr] = Field(default=None, description="Product text description.")
    ...
    images: Optional[List[StrictStr]] = Field(default=None, description="List of valid Product image URLs. HTTP or HTTPS are valid. HTTPS is prefered.")
    ...
    product_id: Optional[StrictStr] = Field(default=None, description="Brand Lovers Product Id. Use this to recommend a product association", alias="productId")
    sku_seller_id: StrictStr = Field(description="Unique Product Id (SKU) in the seller system", alias="skuSellerId")
    stock: Optional[StrictInt] = Field(default=None, description="Number of products availble for sale from the seller. Each new successfull order will automatically reduce the number of products available.")
    title: Optional[StrictStr] = Field(default=None, description="Product name as advertised by manufacturer. This how the product will be displayed in the Marketplace")
