...
class GetProduct(BaseModel):
    ...
    description: StrictStr = Field(description="Product text description.")
    ...
    __properties: ClassVar[List[str]] = ["attributes", "brand", "categories", "description", "dimensions", "errors", "giftWrap", "gtin", "images", "price", "productGroupId", "skuSellerId", "status", "stock", "title", "videos"]
