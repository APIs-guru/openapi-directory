...
class OrdersShipments(BaseModel):
    """
    OrdersShipments
    """ # noqa: E501
    shipments: Optional[List[OrderShippment]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shipments": [OrderShippment.from_dict(_item) for _item in obj["shipments"]] if obj.get("shipments") is not None else None
        })
        return _obj
