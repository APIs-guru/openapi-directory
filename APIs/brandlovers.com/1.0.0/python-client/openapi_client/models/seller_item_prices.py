...
class SellerItemPrices(BaseModel):
    """
    SellerItemPrices
    """ # noqa: E501
    price: ProductPrice
    sku_seller_id: StrictStr = Field(description="Unique product Id from seller that will be updated", alias="skuSellerId")
    __properties: ClassVar[List[str]] = ["price", "skuSellerId"]
