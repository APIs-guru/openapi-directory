...
class TestNewshipmentstatus(unittest.TestCase):
    """Newshipmentstatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Newshipmentstatus:
        """Test Newshipmentstatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Newshipmentstatus`
        """
        model = Newshipmentstatus()
        if include_optional:
    ...
    def testNewshipmentstatus(self):
        """Test Newshipmentstatus"""
