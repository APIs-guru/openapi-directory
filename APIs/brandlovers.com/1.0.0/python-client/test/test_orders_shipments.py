...
class TestOrdersShipments(unittest.TestCase):
    """OrdersShipments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersShipments:
        """Test OrdersShipments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersShipments`
        """
        model = OrdersShipments()
        if include_optional:
            return OrdersShipments(
                shipments = [
                    openapi_client.models.order_shippment.OrderShippment(
