...
class TestShippment(unittest.TestCase):
    """Shippment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Shippment:
        """Test Shippment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Shippment`
        """
        model = Shippment()
        if include_optional:
            return Shippment(
