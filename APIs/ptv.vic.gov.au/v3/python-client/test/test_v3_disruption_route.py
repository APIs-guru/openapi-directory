...
class TestV3DisruptionRoute(unittest.TestCase):
    """V3DisruptionRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DisruptionRoute:
        """Test V3DisruptionRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DisruptionRoute`
        """
        model = V3DisruptionRoute()
        if include_optional:
    ...
    def testV3DisruptionRoute(self):
        """Test V3DisruptionRoute"""
