...
class TestV3StopLocation(unittest.TestCase):
    """V3StopLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopLocation:
        """Test V3StopLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopLocation`
        """
        model = V3StopLocation()
        if include_optional:
