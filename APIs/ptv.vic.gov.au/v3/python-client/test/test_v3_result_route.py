...
class TestV3ResultRoute(unittest.TestCase):
    """V3ResultRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3ResultRoute:
        """Test V3ResultRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3ResultRoute`
        """
        model = V3ResultRoute()
        if include_optional:
            return V3ResultRoute(
                ...
                route_name = '',
                route_number = '',
                route_service_status = openapi_client.models.v3/route_service_status.V3.RouteServiceStatus(
                    description = '', 
