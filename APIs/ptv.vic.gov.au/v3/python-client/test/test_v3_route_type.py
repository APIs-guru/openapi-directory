...
class TestV3RouteType(unittest.TestCase):
    """V3RouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3RouteType:
        """Test V3RouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3RouteType`
        """
        model = V3RouteType()
        if include_optional:
            return V3RouteType(
