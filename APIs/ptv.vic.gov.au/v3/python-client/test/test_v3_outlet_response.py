...
class TestV3OutletResponse(unittest.TestCase):
    """V3OutletResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3OutletResponse:
        """Test V3OutletResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3OutletResponse`
        """
        model = V3OutletResponse()
        if include_optional:
            return V3OutletResponse(
                outlets = [
                    openapi_client.models.v3/outlet.V3.Outlet(
                        outlet_business = '', 
