...
class TestV3StopTicket(unittest.TestCase):
    """V3StopTicket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopTicket:
        """Test V3StopTicket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopTicket`
        """
        model = V3StopTicket()
        if include_optional:
            return V3StopTicket(
