...
class TestV3DisruptionStop(unittest.TestCase):
    """V3DisruptionStop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DisruptionStop:
        """Test V3DisruptionStop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DisruptionStop`
        """
        model = V3DisruptionStop()
        if include_optional:
