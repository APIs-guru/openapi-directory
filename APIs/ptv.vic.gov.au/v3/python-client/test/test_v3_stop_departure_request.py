...
class TestV3StopDepartureRequest(unittest.TestCase):
    """V3StopDepartureRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopDepartureRequest:
        """Test V3StopDepartureRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopDepartureRequest`
        """
        model = V3StopDepartureRequest()
        if include_optional:
    ...
    def testV3StopDepartureRequest(self):
        """Test V3StopDepartureRequest"""
