...
class TestV3StopAccessibility(unittest.TestCase):
    """V3StopAccessibility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopAccessibility:
        """Test V3StopAccessibility
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopAccessibility`
        """
        model = V3StopAccessibility()
        if include_optional:
    ...
    def testV3StopAccessibility(self):
        """Test V3StopAccessibility"""
