...
class TestV3RouteResponse(unittest.TestCase):
    """V3RouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3RouteResponse:
        """Test V3RouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3RouteResponse`
        """
        model = V3RouteResponse()
        if include_optional:
            return V3RouteResponse(
                route = openapi_client.models.v2/object.V2.Object(),
