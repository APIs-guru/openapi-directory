...
class TestV3SiriLineRef(unittest.TestCase):
    """V3SiriLineRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3SiriLineRef:
        """Test V3SiriLineRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3SiriLineRef`
        """
        model = V3SiriLineRef()
        if include_optional:
