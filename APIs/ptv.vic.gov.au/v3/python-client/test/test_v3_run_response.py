...
class TestV3RunResponse(unittest.TestCase):
    """V3RunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3RunResponse:
        """Test V3RunResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3RunResponse`
        """
        model = V3RunResponse()
        if include_optional:
            return V3RunResponse(
                run = openapi_client.models.v3/run.V3.Run(
                    destination_name = '', 
                    direction_id = 56, 
