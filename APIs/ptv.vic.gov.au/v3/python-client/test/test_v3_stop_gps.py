...
class TestV3StopGps(unittest.TestCase):
    """V3StopGps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopGps:
        """Test V3StopGps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopGps`
        """
        model = V3StopGps()
        if include_optional:
            return V3StopGps(
