...
class TestV3StopModel(unittest.TestCase):
    """V3StopModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopModel:
        """Test V3StopModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopModel`
        """
        model = V3StopModel()
        if include_optional:
            return V3StopModel(
