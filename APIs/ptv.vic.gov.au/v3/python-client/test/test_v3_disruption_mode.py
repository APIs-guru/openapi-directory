...
class TestV3DisruptionMode(unittest.TestCase):
    """V3DisruptionMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DisruptionMode:
        """Test V3DisruptionMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DisruptionMode`
        """
        model = V3DisruptionMode()
        if include_optional:
