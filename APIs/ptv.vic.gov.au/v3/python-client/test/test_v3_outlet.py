...
class TestV3Outlet(unittest.TestCase):
    """V3Outlet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3Outlet:
        """Test V3Outlet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3Outlet`
        """
        model = V3Outlet()
        if include_optional:
            return V3Outlet(
