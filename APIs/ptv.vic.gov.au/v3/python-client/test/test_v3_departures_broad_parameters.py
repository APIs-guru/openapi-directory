...
class TestV3DeparturesBroadParameters(unittest.TestCase):
    """V3DeparturesBroadParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DeparturesBroadParameters:
        """Test V3DeparturesBroadParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DeparturesBroadParameters`
        """
        model = V3DeparturesBroadParameters()
        if include_optional:
    ...
    def testV3DeparturesBroadParameters(self):
        """Test V3DeparturesBroadParameters"""
