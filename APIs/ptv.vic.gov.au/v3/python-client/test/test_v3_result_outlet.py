...
class TestV3ResultOutlet(unittest.TestCase):
    """V3ResultOutlet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3ResultOutlet:
        """Test V3ResultOutlet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3ResultOutlet`
        """
        model = V3ResultOutlet()
        if include_optional:
