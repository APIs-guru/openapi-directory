...
class TestV3SiriSubscriptionTopic(unittest.TestCase):
    """V3SiriSubscriptionTopic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3SiriSubscriptionTopic:
        """Test V3SiriSubscriptionTopic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3SiriSubscriptionTopic`
        """
        model = V3SiriSubscriptionTopic()
        if include_optional:
    ...
    def testV3SiriSubscriptionTopic(self):
        """Test V3SiriSubscriptionTopic"""
