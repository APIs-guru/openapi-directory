    ...
    def make_instance(self, include_optional) -> V3SiriLineRefMappingsResponse:
        ...
        if include_optional:
            return V3SiriLineRefMappingsResponse(
                line_refs = {
                    'key' : openapi_client.models.v3/siri_line_ref_direction_refs_dictionary.V3.SiriLineRefDirectionRefsDictionary(
                        direction_refs = {
                            'key' : [
                                openapi_client.models.v3/siri_reference_data_detail.V3.SiriReferenceDataDetail(
                                    direction_id = 56, 
                                    route_id = 56, 
                                    route_number_short = '', 
                                    route_type = 56, 
