...
class TestV3StopsOnRouteResponse(unittest.TestCase):
    """V3StopsOnRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopsOnRouteResponse:
        """Test V3StopsOnRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopsOnRouteResponse`
        """
        model = V3StopsOnRouteResponse()
        if include_optional:
            return V3StopsOnRouteResponse(
                ...
                status = openapi_client.models.v3/status.V3.Status(
                    ...
                    version = '', ),
                stops = [
                    openapi_client.models.v3/stop_on_route.V3.StopOnRoute(
                        disruption_ids = [
                            56
                            ], 
                        route_type = 56, 
    ...
    def testV3StopsOnRouteResponse(self):
        """Test V3StopsOnRouteResponse"""
