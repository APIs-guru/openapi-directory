...
class TestV3Departure(unittest.TestCase):
    """V3Departure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3Departure:
        """Test V3Departure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3Departure`
        """
        model = V3Departure()
        if include_optional:
            return V3Departure(
