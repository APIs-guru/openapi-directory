...
class TestV3BulkDeparturesRouteDirectionResponse(unittest.TestCase):
    """V3BulkDeparturesRouteDirectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3BulkDeparturesRouteDirectionResponse:
        """Test V3BulkDeparturesRouteDirectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3BulkDeparturesRouteDirectionResponse`
        """
        model = V3BulkDeparturesRouteDirectionResponse()
        if include_optional:
    ...
    def testV3BulkDeparturesRouteDirectionResponse(self):
        """Test V3BulkDeparturesRouteDirectionResponse"""
