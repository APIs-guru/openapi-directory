    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.direction_refs:
            for _key_direction_refs in self.direction_refs:
                if self.direction_refs[_key_direction_refs] is not None:
                    _field_dict_of_array[_key_direction_refs] = [
                        _item.to_dict() for _item in self.direction_refs[_key_direction_refs]
                    ]
