...
class V3SiriReferenceDataDetail(BaseModel):
    ...
    """ # noqa: E501
    direction_id: Optional[StrictInt] = None
    route_id: Optional[StrictInt] = None
    route_number_short: Optional[StrictStr] = Field(default=None, description="Route number")
    route_type: Optional[StrictInt] = None
    tracking_supplier_id: Optional[StrictInt] = Field(default=None, description="Authority (Upstream SIRI provider) of a route and direction")
    __properties: ClassVar[List[str]] = ["direction_id", "route_id", "route_number_short", "route_type", "tracking_supplier_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "route_number_short": obj.get("route_number_short"),
            "route_type": obj.get("route_type"),
            "tracking_supplier_id": obj.get("tracking_supplier_id")
        })
        return _obj
