    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.stop_point_refs:
            for _key_stop_point_refs in self.stop_point_refs:
                if self.stop_point_refs[_key_stop_point_refs]:
                    _field_dict[_key_stop_point_refs] = self.stop_point_refs[_key_stop_point_refs].to_dict()
