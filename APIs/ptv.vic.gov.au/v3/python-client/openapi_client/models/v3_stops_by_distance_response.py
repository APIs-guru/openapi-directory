...
class V3StopsByDistanceResponse(BaseModel):
    ...
    stops: Optional[List[V3StopGeosearch]] = Field(default=None, description="Train stations, tram stops, bus stops, regional coach stops or Night Bus stops")
    __properties: ClassVar[List[str]] = ["disruptions", "status", "stops"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stops": [V3StopGeosearch.from_dict(_item) for _item in obj["stops"]] if obj.get("stops") is not None else None
        })
        return _obj
