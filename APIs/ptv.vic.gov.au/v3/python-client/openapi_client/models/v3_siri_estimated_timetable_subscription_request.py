...
class V3SiriEstimatedTimetableSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["consumer_address", "initial_termination_time", "preview_interval", "siri_format", "siri_version", "subscriber_ref", "subscription_ref", "topics"]
