...
class V3SiriDownstreamSubscriptionTopic(BaseModel):
    ...
    """ # noqa: E501
    direction_ref: Optional[StrictInt] = None
    line_ref: Optional[StrictStr] = None
    route_type: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["direction_ref", "line_ref", "route_type"]

    @field_validator('direction_ref')
    def direction_ref_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set([1, 2, 5, 10, 16, 32, 65, 130]):
            raise ValueError("must be one of enum values (1, 2, 5, 10, 16, 32, 65, 130)")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "direction_ref": obj.get("direction_ref"),
