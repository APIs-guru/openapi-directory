...
class V3ResultStop(BaseModel):
    ...
    routes: Optional[List[V3ResultRoute]] = Field(default=None, description="List of routes travelling through the stop")
    stop_distance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Distance of stop from input location (in metres); returns 0 if no location is input")
    ...
    __properties: ClassVar[List[str]] = ["route_type", "routes", "stop_distance", "stop_id", "stop_landmark", "stop_latitude", "stop_longitude", "stop_name", "stop_sequence", "stop_suburb"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stop_distance": obj.get("stop_distance"),
