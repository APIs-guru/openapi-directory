...
class V3SiriLineRefMappingsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["line_refs", "mapping_version", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        _field_dict = {}
        if self.line_refs:
            for _key_line_refs in self.line_refs:
                if self.line_refs[_key_line_refs]:
                    _field_dict[_key_line_refs] = self.line_refs[_key_line_refs].to_dict()
