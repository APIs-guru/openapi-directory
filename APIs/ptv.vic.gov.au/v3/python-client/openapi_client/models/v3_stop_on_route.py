...
class V3StopOnRoute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["disruption_ids", "route_type", "stop_id", "stop_landmark", "stop_latitude", "stop_longitude", "stop_name", "stop_sequence", "stop_suburb", "stop_ticket"]
