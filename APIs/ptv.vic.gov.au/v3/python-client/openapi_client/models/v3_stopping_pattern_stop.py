...
class V3StoppingPatternStop(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["route_type", "stop_distance", "stop_id", "stop_landmark", "stop_latitude", "stop_longitude", "stop_name", "stop_sequence", "stop_suburb", "stop_ticket"]
