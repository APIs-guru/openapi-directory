...
class V3StopGeosearch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["disruption_ids", "route_type", "routes", "stop_distance", "stop_id", "stop_landmark", "stop_latitude", "stop_longitude", "stop_name", "stop_sequence", "stop_suburb"]
