...
class OutletsApi:
    ...
    def outlets_get_all_outlets(
        ...
        _param = self._outlets_get_all_outlets_serialize(
    ...
    @validate_call
    def outlets_get_all_outlets_with_http_info(
        self,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results returned (default = 30)")] = None,
        token: Annotated[Optional[StrictStr], Field(description="Please ignore")] = None,
        devid: Annotated[Optional[StrictStr], Field(description="Your developer id")] = None,
    ...
    @validate_call
    def outlets_get_all_outlets_without_preload_content(
        self,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results returned (default = 30)")] = None,
        token: Annotated[Optional[StrictStr], Field(description="Please ignore")] = None,
        devid: Annotated[Optional[StrictStr], Field(description="Your developer id")] = None,
    ...
    def _outlets_get_all_outlets_serialize(
        self,
        max_results,
        token,
        devid,
    ...
    @validate_call
    def outlets_get_outlets_by_geolocation(
        self,
        ...
        _param = self._outlets_get_outlets_by_geolocation_serialize(
            latitude=latitude,
            longitude=longitude,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V3OutletGeolocationResponse",
            '400': "V3ErrorResponse",
            '403': "V3ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def outlets_get_outlets_by_geolocation_with_http_info(
        self,
        latitude: Annotated[Union[StrictFloat, StrictInt], Field(description="Geographic coordinate of latitude")],
        longitude: Annotated[Union[StrictFloat, StrictInt], Field(description="Geographic coordinate of longitude")],
        max_distance: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default = 300)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V3OutletGeolocationResponse]:
        """List ticket outlets near a specific location
    ...
    @validate_call
    def outlets_get_outlets_by_geolocation_without_preload_content(
        self,
        latitude: Annotated[Union[StrictFloat, StrictInt], Field(description="Geographic coordinate of latitude")],
        longitude: Annotated[Union[StrictFloat, StrictInt], Field(description="Geographic coordinate of longitude")],
        max_distance: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default = 300)")] = None,
    ...
    def _outlets_get_outlets_by_geolocation_serialize(
        self,
        latitude,
        longitude,
        max_distance,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/outlets/location/{latitude},{longitude}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
