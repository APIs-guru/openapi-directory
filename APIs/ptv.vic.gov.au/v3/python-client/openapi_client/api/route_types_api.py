...
class RouteTypesApi:
    ...
    @validate_call
    def route_types_get_route_types(
        self,
        ...
        _param = self._route_types_get_route_types_serialize(
            token=token,
            devid=devid,
            signature=signature,
    ...
    @validate_call
    def route_types_get_route_types_with_http_info(
        self,
        token: Annotated[Optional[StrictStr], Field(description="Please ignore")] = None,
        devid: Annotated[Optional[StrictStr], Field(description="Your developer id")] = None,
        signature: Annotated[Optional[StrictStr], Field(description="Authentication signature for request")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V3RouteTypesResponse]:
        """View all route types and their names
    ...
    @validate_call
    def route_types_get_route_types_without_preload_content(
        self,
        token: Annotated[Optional[StrictStr], Field(description="Please ignore")] = None,
        devid: Annotated[Optional[StrictStr], Field(description="Your developer id")] = None,
        signature: Annotated[Optional[StrictStr], Field(description="Authentication signature for request")] = None,
    ...
    def _route_types_get_route_types_serialize(
        self,
        token,
        devid,
        signature,
