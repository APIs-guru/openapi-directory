...
class GlobalPhoneNumberInformationApi:
    ...
    @validate_call
    def getglobalnumberinfo(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        intlnumber: Annotated[StrictStr, Field(description="International number (with country code) to retrieve information for")],
        ...
        _param = self._getglobalnumberinfo_serialize(
            license=license,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getglobalnumberinfo200Response",
            '400': None,
            '402': None,
            '403': None,
            '404': None,
    ...
    @validate_call
    def getglobalnumberinfo_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        intlnumber: Annotated[StrictStr, Field(description="International number (with country code) to retrieve information for")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getglobalnumberinfo200Response]:
        """Get demographic information for a global telephone number
    ...
    @validate_call
    def getglobalnumberinfo_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        intlnumber: Annotated[StrictStr, Field(description="International number (with country code) to retrieve information for")],
        _request_timeout: Union[
    ...
    def _getglobalnumberinfo_serialize(
        self,
        license,
        intlnumber,
        _request_auth,
        ...
        if intlnumber is not None:
            
            _query_params.append(('intlnumber', intlnumber))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/getglobalnumberinfo',
