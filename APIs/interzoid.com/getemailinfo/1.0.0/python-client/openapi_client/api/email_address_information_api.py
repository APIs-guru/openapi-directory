...
class EmailAddressInformationApi:
    ...
    def getemailinfo(
        ...
        email: Annotated[StrictStr, Field(description="Email address to retrieve validation information")],
        ...
        _param = self._getemailinfo_serialize(
            license=license,
            email=email,
    ...
    @validate_call
    def getemailinfo_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        email: Annotated[StrictStr, Field(description="Email address to retrieve validation information")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getemailinfo200Response]:
        """Gets email validation information for an email address
    ...
    @validate_call
    def getemailinfo_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        email: Annotated[StrictStr, Field(description="Email address to retrieve validation information")],
        _request_timeout: Union[
