...
class FullNameParsedSimilarityKeyApi:
    ...
    @validate_call
    def getfullnameparsedmatch(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        firstname: Annotated[StrictStr, Field(description="First name from which to generate similarity key")],
        lastname: Annotated[StrictStr, Field(description="Last name from which to generate similarity key")],
        ...
        _param = self._getfullnameparsedmatch_serialize(
            license=license,
            firstname=firstname,
            lastname=lastname,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getfullnameparsedmatch200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getfullnameparsedmatch_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        firstname: Annotated[StrictStr, Field(description="First name from which to generate similarity key")],
        lastname: Annotated[StrictStr, Field(description="Last name from which to generate similarity key")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getfullnameparsedmatch200Response]:
        """Gets a similarity key for matching purposes for parsed full name data
    ...
    @validate_call
    def getfullnameparsedmatch_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        firstname: Annotated[StrictStr, Field(description="First name from which to generate similarity key")],
        lastname: Annotated[StrictStr, Field(description="Last name from which to generate similarity key")],
    ...
    def _getfullnameparsedmatch_serialize(
        self,
        license,
        firstname,
        lastname,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/getfullnameparsedmatch',
