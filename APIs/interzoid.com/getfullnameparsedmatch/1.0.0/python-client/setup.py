...
setup(
    name=NAME,
    version=VERSION,
    description="Interzoid Get Full Name Parsed Match Similarity Key API",
    author="API Support",
    author_email="support@interzoid.com",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Interzoid Get Full Name Parsed Match Similarity Key API"],
