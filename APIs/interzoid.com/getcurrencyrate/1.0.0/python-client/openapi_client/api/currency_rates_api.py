...
class CurrencyRatesApi:
    ...
    def getcurrencyrate(
        ...
        symbol: Annotated[StrictStr, Field(description="Currency symbol to retrieve current rate for")],
        ...
        _param = self._getcurrencyrate_serialize(
            license=license,
            symbol=symbol,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getcurrencyrate200Response",
            '400': None,
            '402': None,
            '403': None,
            '404': None,
    ...
    @validate_call
    def getcurrencyrate_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        symbol: Annotated[StrictStr, Field(description="Currency symbol to retrieve current rate for")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getcurrencyrate200Response]:
        """Gets a foreign currency rate for one US Dollar
    ...
    @validate_call
    def getcurrencyrate_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        symbol: Annotated[StrictStr, Field(description="Currency symbol to retrieve current rate for")],
        _request_timeout: Union[
    ...
    def _getcurrencyrate_serialize(
        self,
        license,
        symbol,
        _request_auth,
