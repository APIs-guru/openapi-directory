...
class Getcurrencyrate200Response(BaseModel):
    """
    ...
    rate: Optional[StrictStr] = Field(default=None, alias="Rate")
    symbol: Optional[StrictStr] = Field(default=None, alias="Symbol")
    __properties: ClassVar[List[str]] = ["Code", "Country", "Credits", "Name", "Rate", "Symbol"]
