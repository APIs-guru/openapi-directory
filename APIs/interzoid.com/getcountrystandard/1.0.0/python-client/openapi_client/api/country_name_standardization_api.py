...
class CountryNameStandardizationApi:
    ...
    @validate_call
    def getcountrystandard(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        country: Annotated[StrictStr, Field(description="Country name from which to retrieve the standardized version")],
        ...
        _param = self._getcountrystandard_serialize(
            license=license,
            country=country,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getcountrystandard200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getcountrystandard_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        country: Annotated[StrictStr, Field(description="Country name from which to retrieve the standardized version")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getcountrystandard200Response]:
        """Gets country name standard
    ...
    @validate_call
    def getcountrystandard_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        country: Annotated[StrictStr, Field(description="Country name from which to retrieve the standardized version")],
        _request_timeout: Union[
    ...
    def _getcountrystandard_serialize(
        self,
        license,
        country,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/getcountrystandard',
