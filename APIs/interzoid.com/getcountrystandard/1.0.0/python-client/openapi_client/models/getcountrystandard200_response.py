...
class Getcountrystandard200Response(BaseModel):
    """
    Getcountrystandard200Response
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, alias="Code")
    country_standard: Optional[StrictStr] = Field(default=None, alias="CountryStandard")
    credits: Optional[StrictStr] = Field(default=None, alias="Credits")
    __properties: ClassVar[List[str]] = ["Code", "CountryStandard", "Credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Code": obj.get("Code"),
            "CountryStandard": obj.get("CountryStandard"),
