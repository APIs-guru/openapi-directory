...
class WeatherByCityAndStateApi:
    ...
    def getweather(
        ...
        city: Annotated[StrictStr, Field(description="City for weather information")],
        state: Annotated[StrictStr, Field(description="State for weather information")],
        ...
        _param = self._getweather_serialize(
            license=license,
            city=city,
            state=state,
    ...
    def getweather_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getweather200Response]:
        """Gets current weather information for a US city and state
    ...
    @validate_call
    def getweather_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        city: Annotated[StrictStr, Field(description="City for weather information")],
        state: Annotated[StrictStr, Field(description="State for weather information")],
