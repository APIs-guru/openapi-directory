...
class CountryMatchSimilarityKeyApi:
    ...
    def getcountrymatch(
        ...
        country: Annotated[StrictStr, Field(description="Country name from which to generate similarity key")],
        ...
        _param = self._getcountrymatch_serialize(
            license=license,
            country=country,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getcountrymatch200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getcountrymatch_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        country: Annotated[StrictStr, Field(description="Country name from which to generate similarity key")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getcountrymatch200Response]:
        """Gets a similarity key for matching purposes for country name data
    ...
    @validate_call
    def getcountrymatch_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        country: Annotated[StrictStr, Field(description="Country name from which to generate similarity key")],
        _request_timeout: Union[
    ...
    def _getcountrymatch_serialize(
        self,
        license,
        country,
        _request_auth,
