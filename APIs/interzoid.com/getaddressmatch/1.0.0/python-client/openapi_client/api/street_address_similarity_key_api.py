...
class StreetAddressSimilarityKeyApi:
    ...
    def getaddressmatch(
        ...
        address: Annotated[StrictStr, Field(description="Address from which to generate similarity key")],
        ...
        _param = self._getaddressmatch_serialize(
            license=license,
            address=address,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getaddressmatch200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getaddressmatch_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        address: Annotated[StrictStr, Field(description="Address from which to generate similarity key")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getaddressmatch200Response]:
        """Gets a similarity key for matching purposes for address data
    ...
    @validate_call
    def getaddressmatch_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        address: Annotated[StrictStr, Field(description="Address from which to generate similarity key")],
        _request_timeout: Union[
    ...
    def _getaddressmatch_serialize(
        self,
        license,
        address,
        _request_auth,
