...
class CityDataStandardizationApi:
    ...
    def getcitystandard(
        ...
        city: Annotated[StrictStr, Field(description="City name from which to retrieve the standardized version")],
        ...
        _param = self._getcitystandard_serialize(
            license=license,
            city=city,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getcitystandard200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getcitystandard_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        city: Annotated[StrictStr, Field(description="City name from which to retrieve the standardized version")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getcitystandard200Response]:
        """Gets a city name standard for US and international cities
    ...
    @validate_call
    def getcitystandard_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        city: Annotated[StrictStr, Field(description="City name from which to retrieve the standardized version")],
        _request_timeout: Union[
    ...
    def _getcitystandard_serialize(
        self,
        license,
        city,
        _request_auth,
