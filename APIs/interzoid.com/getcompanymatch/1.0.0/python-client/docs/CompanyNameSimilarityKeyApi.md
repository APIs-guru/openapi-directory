# openapi_client.CompanyNameSimilarityKeyApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CompanyNameSimilarityKeyApi(api_client)
    license = 'license_example' # str | Your Interzoid license API key. Register at www.interzoid.com/register
    company = 'company_example' # str | Company name from which to generate similarity key

    try:
        # Gets a similarity key for matching purposes for company name data
        api_response = api_instance.getcompanymatch(license, company)
        print("The response of CompanyNameSimilarityKeyApi->getcompanymatch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CompanyNameSimilarityKeyApi->getcompanymatch: %s\n" % e)
```
 ...
 **company** | **str**| Company name from which to generate similarity key | 
