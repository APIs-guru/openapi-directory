...
class CompanyNameSimilarityKeyApi:
    ...
    def getcompanymatch(
        ...
        company: Annotated[StrictStr, Field(description="Company name from which to generate similarity key")],
        ...
        _param = self._getcompanymatch_serialize(
            license=license,
            company=company,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getcompanymatch200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getcompanymatch_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        company: Annotated[StrictStr, Field(description="Company name from which to generate similarity key")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getcompanymatch200Response]:
        """Gets a similarity key for matching purposes for company name data
    ...
    @validate_call
    def getcompanymatch_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        company: Annotated[StrictStr, Field(description="Company name from which to generate similarity key")],
        _request_timeout: Union[
    ...
    def _getcompanymatch_serialize(
        self,
        license,
        company,
        _request_auth,
