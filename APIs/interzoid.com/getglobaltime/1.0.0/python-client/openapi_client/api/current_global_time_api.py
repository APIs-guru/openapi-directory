...
class CurrentGlobalTimeApi:
    ...
    def getglobaltime(
        ...
        locale: Annotated[StrictStr, Field(description="Geographic locale to get the current time for")],
        ...
        _param = self._getglobaltime_serialize(
            license=license,
            locale=locale,
    ...
    @validate_call
    def getglobaltime_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        locale: Annotated[StrictStr, Field(description="Geographic locale to get the current time for")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getglobaltime200Response]:
        """Gets the current time for a global locale
    ...
    @validate_call
    def getglobaltime_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        locale: Annotated[StrictStr, Field(description="Geographic locale to get the current time for")],
        _request_timeout: Union[
