...
class WeatherByZipCodeApi:
    ...
    def getweatherzipcode(
        ...
        _param = self._getweatherzipcode_serialize(
            license=license,
            zip=zip,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getweatherzipcode200Response",
            '400': None,
            '402': None,
            '403': None,
            '404': None,
    ...
    @validate_call
    def getweatherzipcode_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        zip: Annotated[StrictStr, Field(description="Zip code for weather information")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getweatherzipcode200Response]:
        """Gets current weather information for a US zip code
    ...
    @validate_call
    def getweatherzipcode_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        zip: Annotated[StrictStr, Field(description="Zip code for weather information")],
        _request_timeout: Union[
    ...
    def _getweatherzipcode_serialize(
        self,
        license,
        zip,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/getweatherzipcode',
