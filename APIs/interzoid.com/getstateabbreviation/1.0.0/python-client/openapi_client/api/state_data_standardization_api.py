...
class StateDataStandardizationApi:
    ...
    @validate_call
    def getstateabbreviation(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        state: Annotated[StrictStr, Field(description="State (or province) name from which to retrieve the two letter abbreviation.")],
        ...
        _param = self._getstateabbreviation_serialize(
            license=license,
            state=state,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Getstateabbreviation200Response",
            '400': None,
            '402': None,
            '403': None,
            '405': None,
    ...
    @validate_call
    def getstateabbreviation_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        state: Annotated[StrictStr, Field(description="State (or province) name from which to retrieve the two letter abbreviation.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getstateabbreviation200Response]:
        """Gets a two-letter abbreviation for a state or province name data
    ...
    @validate_call
    def getstateabbreviation_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        state: Annotated[StrictStr, Field(description="State (or province) name from which to retrieve the two letter abbreviation.")],
        _request_timeout: Union[
    ...
    def _getstateabbreviation_serialize(
        self,
        license,
        state,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/getstateabbreviation',
