...
class DetailedZipCodeInformationApi:
    ...
    def getzipcodeinfo(
        ...
        zip: Annotated[StrictStr, Field(description="Zip code to retrieve detailed information")],
        ...
        _param = self._getzipcodeinfo_serialize(
            license=license,
            zip=zip,
    ...
    @validate_call
    def getzipcodeinfo_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        zip: Annotated[StrictStr, Field(description="Zip code to retrieve detailed information")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getzipcodeinfo200Response]:
        """Gets detailed zip code information
    ...
    @validate_call
    def getzipcodeinfo_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        zip: Annotated[StrictStr, Field(description="Zip code to retrieve detailed information")],
        _request_timeout: Union[
