...
class AreaCodeInformationApi:
    ...
    def getareacode(
        ...
        areacode: Annotated[StrictStr, Field(description="Telephone area code to retrieve area code information")],
        ...
        _param = self._getareacode_serialize(
            license=license,
            areacode=areacode,
    ...
    @validate_call
    def getareacode_with_http_info(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        areacode: Annotated[StrictStr, Field(description="Telephone area code to retrieve area code information")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Getareacode200Response]:
        """Gets telephone area code information
    ...
    @validate_call
    def getareacode_without_preload_content(
        self,
        license: Annotated[StrictStr, Field(description="Your Interzoid license API key. Register at www.interzoid.com/register")],
        areacode: Annotated[StrictStr, Field(description="Telephone area code to retrieve area code information")],
        _request_timeout: Union[
    ...
    def _getareacode_serialize(
        ...
        if areacode is not None:
            ...
            _query_params.append(('areacode', areacode))
