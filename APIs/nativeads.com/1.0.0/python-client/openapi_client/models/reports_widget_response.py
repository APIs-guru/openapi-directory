...
class ReportsWidgetResponse(BaseModel):
    """
    ReportsWidgetResponse
    """ # noqa: E501
    items: Optional[List[ReportsWidgetItem]] = None
    success: Optional[StrictBool] = None
    total_count: Optional[StrictInt] = None
    totals: Optional[Totals] = None
    __properties: ClassVar[List[str]] = ["items", "success", "total_count", "totals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ReportsWidgetItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
