...
class TestRateLimitsResponse(unittest.TestCase):
    """RateLimitsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateLimitsResponse:
        """Test RateLimitsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateLimitsResponse`
        """
        model = RateLimitsResponse()
        if include_optional:
            return RateLimitsResponse(
                rate_limits = [
                    openapi_client.models.rate_limit.RateLimit(
                        api_context = '', 
                        api_name = '', 
                        api_version = '', 
                        resources = [
    ...
    def testRateLimitsResponse(self):
        """Test RateLimitsResponse"""
