...
class Value(BaseModel):
    ...
    """ # noqa: E501
    applicable: Optional[StrictBool] = Field(default=None, description="If set to true, this flag indicates the value in the value field is valid as computed. A value of false indicates one or more of the values used to calculate the value was invalid. The occurrence of this is a rare, however consider this case: suppose a buyer navigates to a View Item page at 11:59 pm (the end of the day) and purchases the item at 12:05am the next day. In this case, the item would have been purchased with 0 views for the day.")
    value: Optional[Dict[str, Any]] = Field(default=None, description="The value of the report data.")
    __properties: ClassVar[List[str]] = ["applicable", "value"]
