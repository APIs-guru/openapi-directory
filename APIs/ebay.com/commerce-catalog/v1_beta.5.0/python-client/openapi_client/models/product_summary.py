...
class ProductSummary(BaseModel):
    ...
    gtin: Optional[List[StrictStr]] = Field(default=None, description="A list of all GTINs that identify this product. This includes all of the values returned in the <b>ean</b>, <b>isbn</b>, and <b>upc</b> fields.")
    ...
    mpn: Optional[List[StrictStr]] = Field(default=None, description="A list of all Manufacturer Product Number (MPN) values that the manufacturer uses to identify this product.")
    product_href: Optional[StrictStr] = Field(default=None, description="The URI of the <b>getProduct</b> call request that retrieves this product's details.", alias="productHref")
    ...
    __properties: ClassVar[List[str]] = ["additionalImages", "aspects", "brand", "ean", "epid", "gtin", "image", "isbn", "mpn", "productHref", "productWebUrl", "title", "upc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isbn": obj.get("isbn"),
            "mpn": obj.get("mpn"),
            "productHref": obj.get("productHref"),
