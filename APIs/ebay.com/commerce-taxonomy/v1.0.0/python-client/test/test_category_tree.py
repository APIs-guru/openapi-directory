...
class TestCategoryTree(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CategoryTree:
        """Test CategoryTree
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryTree`
        """
        model = CategoryTree()
        if include_optional:
            return CategoryTree(
                applicable_marketplace_ids = [
                    ''
                    ],
                category_tree_id = '',
                category_tree_version = '',
                root_category_node = openapi_client.models.category_tree_node.CategoryTreeNode(
