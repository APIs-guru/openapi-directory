...
class CategoryAspect(BaseModel):
    ...
    CategoryAspect
    """ # noqa: E501
    aspects: Optional[List[Aspect]] = Field(default=None, description="A list of aspect metadata that is used to describe the items in a particular leaf category.")
    category: Optional[Category] = None
    __properties: ClassVar[List[str]] = ["aspects", "category"]
