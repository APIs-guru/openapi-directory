...
class ValueConstraint(BaseModel):
    ...
    """ # noqa: E501
    applicable_for_localized_aspect_name: Optional[StrictStr] = Field(default=None, description="The name of the control aspect on which the current aspect value depends.", alias="applicableForLocalizedAspectName")
    applicable_for_localized_aspect_values: Optional[List[StrictStr]] = Field(default=None, description="Contains a list of the values of the control aspect on which this aspect's value depends. When the control aspect has any of the specified values, the current value of the current aspect will also be available.", alias="applicableForLocalizedAspectValues")
    __properties: ClassVar[List[str]] = ["applicableForLocalizedAspectName", "applicableForLocalizedAspectValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicableForLocalizedAspectName": obj.get("applicableForLocalizedAspectName"),
            "applicableForLocalizedAspectValues": obj.get("applicableForLocalizedAspectValues")
        })
        return _obj
