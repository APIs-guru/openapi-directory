...
class CompatibilityProperty(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="This is the actual name of the compatible vehicle property as it is known on the specified eBay marketplace and in the eBay category. This is the string value that should be used in the compatibility_property and filter query parameters of a getCompatibilityPropertyValues request URI. Typical vehicle properties are 'Make', 'Model', 'Year', 'Engine', and 'Trim', but will vary based on the eBay marketplace and the eBay category.")
    __properties: ClassVar[List[str]] = ["localizedName", "name"]
