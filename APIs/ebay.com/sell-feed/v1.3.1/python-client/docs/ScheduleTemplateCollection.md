...
**schedule_templates** | [**List[ScheduleTemplateResponse]**](ScheduleTemplateResponse.md) | An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks. | [optional] 
...
schedule_template_collection_instance = ScheduleTemplateCollection.from_json(json)
# print the JSON string representation of the object
print(ScheduleTemplateCollection.to_json())

# convert the object into a dict
schedule_template_collection_dict = schedule_template_collection_instance.to_dict()
# create an instance of ScheduleTemplateCollection from a dict
schedule_template_collection_from_dict = ScheduleTemplateCollection.from_dict(schedule_template_collection_dict)
```
