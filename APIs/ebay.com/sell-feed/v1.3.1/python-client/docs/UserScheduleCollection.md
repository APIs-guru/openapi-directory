...
json = "{}"
# create an instance of UserScheduleCollection from a JSON string
user_schedule_collection_instance = UserScheduleCollection.from_json(json)
# print the JSON string representation of the object
print(UserScheduleCollection.to_json())

# convert the object into a dict
user_schedule_collection_dict = user_schedule_collection_instance.to_dict()
# create an instance of UserScheduleCollection from a dict
user_schedule_collection_from_dict = UserScheduleCollection.from_dict(user_schedule_collection_dict)
```
