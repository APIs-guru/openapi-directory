...
class ScheduleTemplateCollection(BaseModel):
    ...
    schedule_templates: Optional[List[ScheduleTemplateResponse]] = Field(default=None, description="An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks.", alias="scheduleTemplates")
    total: Optional[StrictInt] = Field(default=None, description="The total number of schedule templates that match the input criteria.")
    __properties: ClassVar[List[str]] = ["href", "limit", "next", "offset", "prev", "scheduleTemplates", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleTemplateCollection from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in schedule_templates (list)
        _items = []
        if self.schedule_templates:
            for _item_schedule_templates in self.schedule_templates:
                if _item_schedule_templates:
                    _items.append(_item_schedule_templates.to_dict())
            _dict['scheduleTemplates'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleTemplateCollection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "prev": obj.get("prev"),
            "scheduleTemplates": [ScheduleTemplateResponse.from_dict(_item) for _item in obj["scheduleTemplates"]] if obj.get("scheduleTemplates") is not None else None,
            "total": obj.get("total")
        })
        return _obj
