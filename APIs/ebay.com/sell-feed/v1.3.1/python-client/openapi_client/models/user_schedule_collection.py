...
class UserScheduleCollection(BaseModel):
    ...
    schedules: Optional[List[UserScheduleResponse]] = Field(default=None, description="An array of the schedules on this page. An empty array is returned if the filter criteria excludes all tasks.")
    total: Optional[StrictInt] = Field(default=None, description="The total number of schedules that match the input criteria.")
    __properties: ClassVar[List[str]] = ["href", "limit", "next", "offset", "prev", "schedules", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prev": obj.get("prev"),
            "schedules": [UserScheduleResponse.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None,
            "total": obj.get("total")
        })
        return _obj
