...
class TaskCollection(BaseModel):
    ...
    tasks: Optional[List[Task]] = Field(default=None, description="An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks. ")
    total: Optional[StrictInt] = Field(default=None, description="The total number of tasks that match the input criteria.")
