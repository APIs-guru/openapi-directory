...
class OrderTaskCollection(BaseModel):
    ...
    tasks: Optional[List[OrderTask]] = Field(default=None, description="An array of the order tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.")
    total: Optional[StrictInt] = Field(default=None, description="The total number of order tasks that match the input criteria.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prev": obj.get("prev"),
            "tasks": [OrderTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
            "total": obj.get("total")
        })
        return _obj
