...
class TestOrderSearchPagedCollection(unittest.TestCase):
    """OrderSearchPagedCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderSearchPagedCollection:
        """Test OrderSearchPagedCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderSearchPagedCollection`
        """
        model = OrderSearchPagedCollection()
        if include_optional:
    ...
    def testOrderSearchPagedCollection(self):
        """Test OrderSearchPagedCollection"""
