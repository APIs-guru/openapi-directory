...
class AspectDistribution(BaseModel):
    ...
    """ # noqa: E501
    aspect_value_distributions: Optional[List[AspectValueDistribution]] = Field(default=None, description="An array of containers for the various values of the aspect and the match count and a HATEOAS reference ( refinementHref) for this aspect.", alias="aspectValueDistributions")
    localized_aspect_name: Optional[StrictStr] = Field(default=None, description="The name of an aspect, such as Brand, Color, etc.", alias="localizedAspectName")
