...
class TypedNameValue(BaseModel):
    """
    The type that defines the fields for the name/value pairs for item aspects.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The text representing the name of the aspect for the name/value pair, such as Color.")
    type: Optional[StrictStr] = Field(default=None, description="This indicates if the value being returned is a string or an array of values. Valid Values: STRING - Indicates the value returned is a string. STRING_ARRAY - Indicates the value returned is an array of strings. Code so that your app gracefully handles any future changes to this list. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:ValueTypeEnum'>eBay API documentation</a>")
    value: Optional[StrictStr] = Field(default=None, description="The value of the aspect for the name/value pair, such as Red.")
