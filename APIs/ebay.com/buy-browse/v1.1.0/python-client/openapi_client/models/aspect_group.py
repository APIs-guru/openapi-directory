...
class AspectGroup(BaseModel):
    ...
    AspectGroup
    """ # noqa: E501
    aspects: Optional[List[Aspect]] = Field(default=None, description="An array of the name/value pairs for the aspects of the product. For example: BRAND/Apple")
    localized_group_name: Optional[StrictStr] = Field(default=None, description="The name of a group of aspects. In the following example, Product Identifiers and Process are product aspect group names. Under the group name are the product aspect name/value pairs. Product Identifiers &nbsp;&nbsp;&nbsp;Brand/Apple &nbsp;&nbsp;&nbsp;Product Family/iMac Processor &nbsp;&nbsp;&nbsp;Processor Type/Intel &nbsp;&nbsp;&nbsp;Processor Speed/3.10", alias="localizedGroupName")
    __properties: ClassVar[List[str]] = ["aspects", "localizedGroupName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "localizedGroupName": obj.get("localizedGroupName")
        })
        return _obj
