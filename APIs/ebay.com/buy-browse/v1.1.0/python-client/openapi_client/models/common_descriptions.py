...
class CommonDescriptions(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The item description that is used by more than one of the item variations.")
    item_ids: Optional[List[StrictStr]] = Field(default=None, description="A list of item ids that have this description.", alias="itemIds")
    __properties: ClassVar[List[str]] = ["description", "itemIds"]
