...
class AspectValueDistribution(BaseModel):
    ...
    """ # noqa: E501
    localized_aspect_value: Optional[StrictStr] = Field(default=None, description="The value of an aspect. For example, Red is a value for the aspect Color.", alias="localizedAspectValue")
    match_count: Optional[StrictInt] = Field(default=None, description="The number of items with this aspect.", alias="matchCount")
    refinement_href: Optional[StrictStr] = Field(default=None, description="A HATEOAS reference for this aspect.", alias="refinementHref")
