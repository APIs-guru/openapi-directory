...
class TaxJurisdiction(BaseModel):
    ...
    tax_jurisdiction_id: Optional[StrictStr] = Field(default=None, description="The identifier of the tax jurisdiction.", alias="taxJurisdictionId")
    __properties: ClassVar[List[str]] = ["region", "taxJurisdictionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxJurisdictionId": obj.get("taxJurisdictionId")
        })
        return _obj
