...
class TestRemoteShopcartResponse(unittest.TestCase):
    """RemoteShopcartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoteShopcartResponse:
        """Test RemoteShopcartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteShopcartResponse`
        """
        model = RemoteShopcartResponse()
        if include_optional:
            return RemoteShopcartResponse(
                ...
                cart_subtotal = openapi_client.models.amount.Amount(
                    currency = '', 
                    value = '', ),
                cart_web_url = '',
    ...
    def testRemoteShopcartResponse(self):
        """Test RemoteShopcartResponse"""
