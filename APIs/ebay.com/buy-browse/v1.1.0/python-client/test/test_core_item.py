...
class TestCoreItem(unittest.TestCase):
    """CoreItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreItem:
        """Test CoreItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreItem`
        """
        model = CoreItem()
        if include_optional:
            return CoreItem(
                ...
                marketing_price = openapi_client.models.marketing_price.MarketingPrice(
                    ...
                    price_treatment = '', ),
                material = '',
                minimum_price_to_bid = openapi_client.models.converted_amount.ConvertedAmount(
                    converted_from_currency = '', 
                    converted_from_value = '', 
                    currency = '', 
                    value = '', ),
                ...
                primary_item_group = openapi_client.models.item_group_summary.ItemGroupSummary(
                    ...
                    item_group_href = '', 
                    item_group_id = '', 
                    item_group_image = openapi_client.models.image.Image(
                        height = 56, 
                        image_url = '', 
                        width = 56, ), 
                    item_group_title = '', 
