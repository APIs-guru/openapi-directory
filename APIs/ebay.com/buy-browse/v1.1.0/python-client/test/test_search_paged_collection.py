...
class TestSearchPagedCollection(unittest.TestCase):
    """SearchPagedCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchPagedCollection:
        """Test SearchPagedCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchPagedCollection`
        """
        model = SearchPagedCollection()
        if include_optional:
            return SearchPagedCollection(
                auto_corrections = openapi_client.models.auto_corrections.AutoCorrections(
                    q = '', ),
                href = '',
                item_summaries = [
                    openapi_client.models.item_summary.ItemSummary(
                        additional_images = [
                ...
                refinement = openapi_client.models.refinement.Refinement(
                    ...
                    buying_option_distributions = [
                        openapi_client.models.buying_option_distribution.BuyingOptionDistribution(
                            buying_option = '', 
                            match_count = 56, 
                            refinement_href = '', )
                        ], 
                    category_distributions = [
                        openapi_client.models.category_distribution.CategoryDistribution(
                            category_id = '', 
                            category_name = '', 
                            match_count = 56, 
                            refinement_href = '', )
                    ...
                    condition_distributions = [
                        openapi_client.models.condition_distribution.ConditionDistribution(
                            condition = '', 
                            condition_id = '', 
                            match_count = 56, 
                            refinement_href = '', )
    ...
    def testSearchPagedCollection(self):
        """Test SearchPagedCollection"""
