...
class TestSellerDetail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SellerDetail:
        """Test SellerDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerDetail`
        """
        model = SellerDetail()
        if include_optional:
            return SellerDetail(
