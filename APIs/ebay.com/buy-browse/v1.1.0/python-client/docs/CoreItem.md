...
core_item_instance = CoreItem.from_json(json)
# print the JSON string representation of the object
print(CoreItem.to_json())

# convert the object into a dict
core_item_dict = core_item_instance.to_dict()
# create an instance of CoreItem from a dict
core_item_from_dict = CoreItem.from_dict(core_item_dict)
```
