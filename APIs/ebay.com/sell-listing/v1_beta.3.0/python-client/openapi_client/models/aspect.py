...
class Aspect(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of an aspect, such and Brand.")
    values: Optional[List[StrictStr]] = Field(default=None, description="A list of potential values for this aspect.")
