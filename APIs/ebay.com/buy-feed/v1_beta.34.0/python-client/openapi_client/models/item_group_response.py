...
class ItemGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    item_groups: Optional[List[ItemGroup]] = Field(default=None, description="The container for the array of items groups returned by the <b> getItemGroupFeed</b> method. The data in the file is tab separated and the first row is the header, which labels the columns and indicates the order of the values for each item. The header labels match the fields that are described in the <a href=\"/api-docs/buy/feed/resources/item_group/methods/getItemGroupFeed#h3-response-fields\">Response fields</a> section.", alias="itemGroups")
    __properties: ClassVar[List[str]] = ["itemGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "itemGroups": [ItemGroup.from_dict(_item) for _item in obj["itemGroups"]] if obj.get("itemGroups") is not None else None
        })
        return _obj
