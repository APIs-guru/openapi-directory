...
class TestItemPriorityApi(unittest.TestCase):
    """ItemPriorityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ItemPriorityApi()

    def tearDown(self) -> None:
        pass

    def test_get_item_priority_feed(self) -> None:
        """Test case for get_item_priority_feed
