...
class TestItemPriorityResponse(unittest.TestCase):
    """ItemPriorityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemPriorityResponse:
        """Test ItemPriorityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemPriorityResponse`
        """
        model = ItemPriorityResponse()
        if include_optional:
            return ItemPriorityResponse(
                item_delta = [
                    openapi_client.models.item_priority.ItemPriority(
                        change_metadata = '', 
                        item_id = '', 
    ...
    def testItemPriorityResponse(self):
        """Test ItemPriorityResponse"""
