...
class TestItemSnapshotResponse(unittest.TestCase):
    """ItemSnapshotResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemSnapshotResponse:
        """Test ItemSnapshotResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemSnapshotResponse`
        """
        model = ItemSnapshotResponse()
        if include_optional:
            return ItemSnapshotResponse(
                items = [
                    openapi_client.models.item_snapshot.ItemSnapshot(
    ...
    def testItemSnapshotResponse(self):
        """Test ItemSnapshotResponse"""
