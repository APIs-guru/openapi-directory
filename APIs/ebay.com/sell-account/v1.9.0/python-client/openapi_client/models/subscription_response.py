...
class SubscriptionResponse(BaseModel):
    ...
    subscriptions: Optional[List[Subscription]] = Field(default=None, description="An array of subscriptions associated with the seller account.")
    total: Optional[StrictInt] = Field(default=None, description="The total number of subscriptions displayed on the current page of results.")
    __properties: ClassVar[List[str]] = ["href", "limit", "next", "subscriptions", "total"]
