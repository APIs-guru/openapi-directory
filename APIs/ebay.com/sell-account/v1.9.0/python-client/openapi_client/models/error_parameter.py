...
class ErrorParameter(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the parameter that caused the error.")
    value: Optional[StrictStr] = Field(default=None, description="The value of the parameter that caused the error.")
