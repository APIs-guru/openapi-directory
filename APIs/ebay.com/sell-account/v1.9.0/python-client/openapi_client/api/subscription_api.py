...
class SubscriptionApi:
    ...
    def get_subscription(
        self,
        limit: Annotated[Optional[StrictStr], Field(description="This field is for future use.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="This field is for future use.")] = None,
