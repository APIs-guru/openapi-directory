...
class TestPaymentPolicyRequest(unittest.TestCase):
    """PaymentPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPolicyRequest:
        """Test PaymentPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPolicyRequest`
        """
        model = PaymentPolicyRequest()
        if include_optional:
    ...
    def testPaymentPolicyRequest(self):
        """Test PaymentPolicyRequest"""
