...
class TestFulfillmentPolicyRequest(unittest.TestCase):
    """FulfillmentPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FulfillmentPolicyRequest:
        """Test FulfillmentPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FulfillmentPolicyRequest`
        """
        model = FulfillmentPolicyRequest()
        if include_optional:
    ...
    def testFulfillmentPolicyRequest(self):
        """Test FulfillmentPolicyRequest"""
