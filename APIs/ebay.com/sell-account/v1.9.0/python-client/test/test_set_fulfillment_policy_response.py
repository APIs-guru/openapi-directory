...
class TestSetFulfillmentPolicyResponse(unittest.TestCase):
    """SetFulfillmentPolicyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetFulfillmentPolicyResponse:
        """Test SetFulfillmentPolicyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetFulfillmentPolicyResponse`
        """
        model = SetFulfillmentPolicyResponse()
        if include_optional:
    ...
    def testSetFulfillmentPolicyResponse(self):
        """Test SetFulfillmentPolicyResponse"""
