...
class TestReturnPolicyRequest(unittest.TestCase):
    """ReturnPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPolicyRequest:
        """Test ReturnPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPolicyRequest`
        """
        model = ReturnPolicyRequest()
        if include_optional:
    ...
    def testReturnPolicyRequest(self):
        """Test ReturnPolicyRequest"""
