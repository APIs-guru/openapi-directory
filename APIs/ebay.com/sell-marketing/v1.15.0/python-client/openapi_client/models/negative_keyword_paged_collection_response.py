...
class NegativeKeywordPagedCollectionResponse(BaseModel):
    ...
    negative_keywords: Optional[List[NegativeKeyword]] = Field(default=None, description="A list of negative keywords returned in the paginated collection.", alias="negativeKeywords")
    ...
    total: Optional[StrictInt] = Field(default=None, description="The total number of result sets in the paginated collection.")
    __properties: ClassVar[List[str]] = ["href", "limit", "negativeKeywords", "next", "offset", "prev", "total"]
