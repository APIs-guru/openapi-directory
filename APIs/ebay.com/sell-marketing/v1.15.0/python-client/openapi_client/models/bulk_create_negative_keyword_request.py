...
class BulkCreateNegativeKeywordRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[CreateNegativeKeywordRequest]] = Field(default=None, description="This array is used to pass in multiple negative keywords for one or more ad groups that belong to a campaign that uses the Cost Per Click (CPC) funding model.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreateNegativeKeywordRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
