...
class BulkUpdateKeywordRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[UpdateKeywordByKeywordIdRequest]] = Field(default=None, description="Use this array to update the bid values and/or statuses of one or more existing keywords.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateKeywordByKeywordIdRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
