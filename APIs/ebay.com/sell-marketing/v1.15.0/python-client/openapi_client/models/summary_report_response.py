...
class SummaryReportResponse(BaseModel):
    ...
    last_updated: Optional[StrictStr] = Field(default=None, description="The date the report was generated.", alias="lastUpdated")
    percentage_sales_lift: Optional[StrictStr] = Field(default=None, description="The percentage of the total dollar amount gained due to promotions. This value is calculated as follows:  <br><br><b>precentageSalesLift</b> = <b>promotionSale</b> / (<b>baseSale</b> + <b>promotionSale</b>)", alias="percentageSalesLift")
    ...
    __properties: ClassVar[List[str]] = ["baseSale", "lastUpdated", "percentageSalesLift", "promotionSale", "totalSale"]
