...
class BulkUpdateAdStatusRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[UpdateAdStatusRequest]] = Field(default=None, description="An array of listing IDs and bid percentages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateAdStatusRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
