...
class AlertDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aspect", "dimension"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aspect": Aspect.from_dict(obj["aspect"]) if obj.get("aspect") is not None else None,
            "dimension": AlertDimension.from_dict(obj["dimension"]) if obj.get("dimension") is not None else None
        })
        return _obj
