...
class TargetedBidRequest(BaseModel):
    ...
    """ # noqa: E501
    keywords: Optional[List[KeywordRequest]] = Field(default=None, description="A list of keywords in the paginated collection. <br /><br /><b>Maximum number of keywords: </b>500")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keywords": [KeywordRequest.from_dict(_item) for _item in obj["keywords"]] if obj.get("keywords") is not None else None
        })
        return _obj
