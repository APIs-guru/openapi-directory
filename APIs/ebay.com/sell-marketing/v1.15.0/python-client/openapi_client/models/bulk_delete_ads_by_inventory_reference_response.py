...
class BulkDeleteAdsByInventoryReferenceResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[DeleteAdsByInventoryReferenceResponse]] = Field(default=None, description="An array of the ads that were deleted by the <b>bulkDeleteAdsByInventoryReference</b> request, including information associated with each individual delete request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [DeleteAdsByInventoryReferenceResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
