...
class BulkDeleteAdRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[DeleteAdRequest]] = Field(default=None, description="An array of the listing IDs that identify the ads to remove.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [DeleteAdRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
