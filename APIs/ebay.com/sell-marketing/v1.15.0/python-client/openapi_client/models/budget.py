...
class Budget(BaseModel):
    ...
    budget_status: Optional[StrictStr] = Field(default=None, description="The budget status for a CPC Promoted Listings campaign. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:BudgetStatusEnum'>eBay API documentation</a>", alias="budgetStatus")
    __properties: ClassVar[List[str]] = ["amount", "budgetStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "budgetStatus": obj.get("budgetStatus")
        })
        return _obj
