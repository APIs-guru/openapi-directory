...
class BulkCreateNegativeKeywordResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[NegativeKeywordResponse]] = Field(default=None, description="A list of negative keywords that have been processed by the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [NegativeKeywordResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
