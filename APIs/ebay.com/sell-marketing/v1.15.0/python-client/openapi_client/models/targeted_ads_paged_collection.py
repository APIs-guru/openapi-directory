...
class TargetedAdsPagedCollection(BaseModel):
    ...
    suggested_items: Optional[List[TargetingItems]] = Field(default=None, description="A list of suggested items in the paginated collection.", alias="suggestedItems")
    ...
    __properties: ClassVar[List[str]] = ["href", "limit", "next", "offset", "prev", "suggestedItems", "total"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in suggested_items (list)
        _items = []
        if self.suggested_items:
            for _item_suggested_items in self.suggested_items:
                if _item_suggested_items:
                    _items.append(_item_suggested_items.to_dict())
            _dict['suggestedItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prev": obj.get("prev"),
            "suggestedItems": [TargetingItems.from_dict(_item) for _item in obj["suggestedItems"]] if obj.get("suggestedItems") is not None else None,
            "total": obj.get("total")
        })
        return _obj
