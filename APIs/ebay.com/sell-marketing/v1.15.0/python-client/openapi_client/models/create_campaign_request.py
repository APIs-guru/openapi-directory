...
class CreateCampaignRequest(BaseModel):
    ...
    """ # noqa: E501
    budget: Optional[CampaignBudgetRequest] = None
    ...
    marketplace_id: Optional[StrictStr] = Field(default=None, description="The ID of the eBay marketplace where the campaign is hosted. See the <b>MarketplaceIdEnum</b> type to get the appropriate enumeration value for the listing marketplace. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/ba:MarketplaceIdEnum'>eBay API documentation</a>", alias="marketplaceId")
    start_date: Optional[StrictStr] = Field(default=None, description="The date and time the campaign starts, in UTC format (<code>yyyy-MM-ddThh:mm:ssZ</code>). For display purposes, convert this time into the local time of the seller.  <p>On the date specified, the service derives the keywords for each listing in the campaign, creates an ad for each listing, and associates each new ad with the campaign. The campaign starts after this process is completed. The amount of time it takes the service to start the campaign depends on the number of listings in the campaign. Call <b>getCampaign</b> to check the status of the campaign.</p>", alias="startDate")
    __properties: ClassVar[List[str]] = ["budget", "campaignCriterion", "campaignName", "endDate", "fundingStrategy", "marketplaceId", "startDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budget": CampaignBudgetRequest.from_dict(obj["budget"]) if obj.get("budget") is not None else None,
