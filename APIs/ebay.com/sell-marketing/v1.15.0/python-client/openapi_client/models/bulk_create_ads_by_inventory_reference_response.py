...
class BulkCreateAdsByInventoryReferenceResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[CreateAdsByInventoryReferenceResponse]] = Field(default=None, description="This array displays the list of ads that were successfully created. For any ads that were not created successfully, the errors array may provide more detail about why creation of one or more ads failed.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [CreateAdsByInventoryReferenceResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
