...
class BulkUpdateNegativeKeywordRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[UpdateNegativeKeywordIdRequest]] = Field(default=None, description="An array to update the statuses of one or more existing negative keywords.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [UpdateNegativeKeywordIdRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
