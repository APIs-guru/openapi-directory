...
class BulkUpdateAdsByInventoryReferenceResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[UpdateAdsByInventoryReferenceResponse]] = Field(default=None, description="A list of inventory references that were processed from the request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [UpdateAdsByInventoryReferenceResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
