...
class BulkCreateAdsByInventoryReferenceRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[CreateAdsByInventoryReferenceRequest]] = Field(default=None, description="A list of inventory reference ID and inventory reference type pairs, and the bid percentage, which the call uses to create ads in bulk.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreateAdsByInventoryReferenceRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
