...
class BulkAdUpdateResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[AdUpdateResponse]] = Field(default=None, description="A set of ad listings processed by the call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [AdUpdateResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
