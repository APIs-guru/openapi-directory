...
class Campaigns(BaseModel):
    ...
    """ # noqa: E501
    campaigns: Optional[List[Campaign]] = Field(default=None, description="This is an array of one or campaigns that match the listing or inventory item group specified in the request.")
