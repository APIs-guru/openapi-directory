...
class CreateAdsByInventoryReferenceRequest(BaseModel):
    ...
    """ # noqa: E501
    ad_group_id: Optional[StrictStr] = Field(default=None, description="<span class=\"tablenote\"><b>Note:</b> This field is not currently in use. Ad groups are only applicable to Promoted Listings Advanced (PLA) ad campaigns that use the Cost Per Click (CPC) funding model. See <a href=\"/api-docs/sell/static/marketing/pl-overview.html#funding-model\">Funding Models</a> in the <i>Promoted Listings Playbook</i> for more information.</span>", alias="adGroupId")
