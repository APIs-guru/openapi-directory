...
class CloneCampaignRequest(BaseModel):
    ...
    """ # noqa: E501
    campaign_name: Optional[StrictStr] = Field(default=None, description="A seller-defined name for the newly-cloned campaign. This value must be unique for the seller. <p>You can use any alphanumeric characters in the name, except the less than (&lt;) or greater than (&gt;) characters.</p><b>Max length: </b>80 characters", alias="campaignName")
    ...
    __properties: ClassVar[List[str]] = ["campaignName", "endDate", "fundingStrategy", "startDate"]
