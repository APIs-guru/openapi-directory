...
class BulkAdUpdateStatusByListingIdResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[AdUpdateStatusByListingIdResponse]] = Field(default=None, description="An array of processed ad listings in bulk.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [AdUpdateStatusByListingIdResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
