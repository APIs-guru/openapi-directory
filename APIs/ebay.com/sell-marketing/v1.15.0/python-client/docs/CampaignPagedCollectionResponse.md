...
json = "{}"
# create an instance of CampaignPagedCollectionResponse from a JSON string
campaign_paged_collection_response_instance = CampaignPagedCollectionResponse.from_json(json)
# print the JSON string representation of the object
print(CampaignPagedCollectionResponse.to_json())

# convert the object into a dict
campaign_paged_collection_response_dict = campaign_paged_collection_response_instance.to_dict()
# create an instance of CampaignPagedCollectionResponse from a dict
campaign_paged_collection_response_from_dict = CampaignPagedCollectionResponse.from_dict(campaign_paged_collection_response_dict)
```
