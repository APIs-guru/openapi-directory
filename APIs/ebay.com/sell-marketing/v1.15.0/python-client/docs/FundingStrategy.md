...
**funding_model** | **str** | Indicates the model that eBay uses to calculate the Promoted Listings fee. &lt;p&gt;For a description of the funding model types, refer to &lt;b&gt;FundingModelTypeEnum&lt;/b&gt;. For implementation help, refer to &lt;a href&#x3D;&#39;https://developer.ebay.com/api-docs/sell/marketing/types/pls:FundingModelEnum&#39;&gt;eBay API documentation&lt;/a&gt; | [optional] 
...
funding_strategy_instance = FundingStrategy.from_json(json)
# print the JSON string representation of the object
print(FundingStrategy.to_json())

# convert the object into a dict
funding_strategy_dict = funding_strategy_instance.to_dict()
# create an instance of FundingStrategy from a dict
funding_strategy_from_dict = FundingStrategy.from_dict(funding_strategy_dict)
```
