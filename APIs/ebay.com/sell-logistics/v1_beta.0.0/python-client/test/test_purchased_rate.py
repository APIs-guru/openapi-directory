...
class TestPurchasedRate(unittest.TestCase):
    """PurchasedRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchasedRate:
        """Test PurchasedRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchasedRate`
        """
        model = PurchasedRate()
        if include_optional:
            return PurchasedRate(
                ...
                total_shipping_cost = openapi_client.models.amount.Amount(
                    currency = '', 
                    value = '', )
            )
        else:
