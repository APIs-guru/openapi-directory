...
class TestShippingQuoteRequest(unittest.TestCase):
    """ShippingQuoteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingQuoteRequest:
        """Test ShippingQuoteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingQuoteRequest`
        """
    ...
    def testShippingQuoteRequest(self):
        """Test ShippingQuoteRequest"""
