...
class Image(BaseModel):
    ...
    """ # noqa: E501
    height: Optional[StrictInt] = Field(default=None, description="<b> Reserved for future use. </b> ")
    image_url: Optional[StrictStr] = Field(default=None, description="The URL of the image.", alias="imageUrl")
    width: Optional[StrictInt] = Field(default=None, description="<b> Reserved for future use. </b> ")
