...
class TestRatingAspect(unittest.TestCase):
    """RatingAspect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatingAspect:
        """Test RatingAspect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatingAspect`
        """
        model = RatingAspect()
        if include_optional:
            return RatingAspect(
