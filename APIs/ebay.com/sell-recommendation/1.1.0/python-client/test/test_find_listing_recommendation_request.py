...
class TestFindListingRecommendationRequest(unittest.TestCase):
    """FindListingRecommendationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindListingRecommendationRequest:
        """Test FindListingRecommendationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindListingRecommendationRequest`
        """
        model = FindListingRecommendationRequest()
        if include_optional:
    ...
    def testFindListingRecommendationRequest(self):
        """Test FindListingRecommendationRequest"""
