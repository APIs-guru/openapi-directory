...
class MarketingRecommendation(BaseModel):
    ...
    """ # noqa: E501
    ad: Optional[Ad] = None
    message: Optional[StrictStr] = Field(default=None, description="A message that can conditionally accompany the listing information.")
    __properties: ClassVar[List[str]] = ["ad", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ad": Ad.from_dict(obj["ad"]) if obj.get("ad") is not None else None,
