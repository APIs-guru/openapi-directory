...
json = "{}"
# create an instance of EventSearchResponse from a JSON string
event_search_response_instance = EventSearchResponse.from_json(json)
# print the JSON string representation of the object
print(EventSearchResponse.to_json())

# convert the object into a dict
event_search_response_dict = event_search_response_instance.to_dict()
# create an instance of EventSearchResponse from a dict
event_search_response_from_dict = EventSearchResponse.from_dict(event_search_response_dict)
```
