# openapi_client.DealItemApi

All URIs are relative to *https://api.ebay.com/buy/deal/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_deal_items**](DealItemApi.md#get_deal_items) | **GET** /deal_item | 


# **get_deal_items**
> DealItemSearchResponse get_deal_items(x_ebay_c_marketplace_id, category_ids=category_ids, commissionable=commissionable, delivery_country=delivery_country, limit=limit, offset=offset)
 ...
 **category_ids** | **str**| The unique identifier of the eBay category for the search. | [optional] 
 **commissionable** | **str**| A filter for commissionable deals. Restriction: This filter is currently only supported for the US marketplace. | [optional] 
 **delivery_country** | **str**| A filter for items that can be shipped to the specified country. | [optional] 
 **limit** | **str**| The maximum number of items, from the current result set, returned on a single page. | [optional] 
...
[**DealItemSearchResponse**](DealItemSearchResponse.md)
