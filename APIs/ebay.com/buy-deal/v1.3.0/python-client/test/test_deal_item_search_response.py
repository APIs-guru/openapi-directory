...
class TestDealItemSearchResponse(unittest.TestCase):
    """DealItemSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealItemSearchResponse:
        """Test DealItemSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealItemSearchResponse`
        """
        model = DealItemSearchResponse()
        if include_optional:
            return DealItemSearchResponse(
                deal_items = [
                    openapi_client.models.deal_item.DealItem(
                        additional_images = [
    ...
    def testDealItemSearchResponse(self):
        """Test DealItemSearchResponse"""
