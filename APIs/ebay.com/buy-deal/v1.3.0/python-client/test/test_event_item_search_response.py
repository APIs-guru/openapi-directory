...
class TestEventItemSearchResponse(unittest.TestCase):
    """EventItemSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventItemSearchResponse:
        """Test EventItemSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventItemSearchResponse`
        """
        model = EventItemSearchResponse()
        if include_optional:
            return EventItemSearchResponse(
                event_items = [
                    openapi_client.models.event_item.EventItem(
                        additional_images = [
    ...
    def testEventItemSearchResponse(self):
        """Test EventItemSearchResponse"""
