...
class TestMarketingPrice(unittest.TestCase):
    """MarketingPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketingPrice:
        """Test MarketingPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketingPrice`
        """
