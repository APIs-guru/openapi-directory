...
class EventItemApi:
    ...
    def get_event_items(
        self,
        event_ids: Annotated[StrictStr, Field(description="The unique identifiers for the eBay events. Maximum Value: 1")],
        x_ebay_c_marketplace_id: Annotated[StrictStr, Field(description="A header used to specify the eBay marketplace ID.")],
        category_ids: Annotated[Optional[StrictStr], Field(description="The unique identifier of the eBay category for the search. Maximum Value: 1")] = None,
        ...
        limit: Annotated[Optional[StrictStr], Field(description="The maximum number of items, from the current result set, returned on a single page. Default: 20")] = None,
        ...
        :param event_ids: The unique identifiers for the eBay events. Maximum Value: 1 (required)
        :type event_ids: str
        ...
        _param = self._get_event_items_serialize(
            event_ids=event_ids,
    ...
    @validate_call
    def get_event_items_with_http_info(
        self,
        event_ids: Annotated[StrictStr, Field(description="The unique identifiers for the eBay events. Maximum Value: 1")],
        x_ebay_c_marketplace_id: Annotated[StrictStr, Field(description="A header used to specify the eBay marketplace ID.")],
        category_ids: Annotated[Optional[StrictStr], Field(description="The unique identifier of the eBay category for the search. Maximum Value: 1")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventItemSearchResponse]:
        """get_event_items
    ...
    @validate_call
    def get_event_items_without_preload_content(
        self,
        event_ids: Annotated[StrictStr, Field(description="The unique identifiers for the eBay events. Maximum Value: 1")],
        x_ebay_c_marketplace_id: Annotated[StrictStr, Field(description="A header used to specify the eBay marketplace ID.")],
        category_ids: Annotated[Optional[StrictStr], Field(description="The unique identifier of the eBay category for the search. Maximum Value: 1")] = None,
    ...
    def _get_event_items_serialize(
        self,
        event_ids,
