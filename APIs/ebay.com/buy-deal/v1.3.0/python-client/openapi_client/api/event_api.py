...
class EventApi:
    ...
    def get_event(
        ...
        event_id: Annotated[StrictStr, Field(description="The unique identifier for the eBay event.")],
        ...
        :param event_id: The unique identifier for the eBay event. (required)
        :type event_id: str
    ...
    def get_events(
        self,
        x_ebay_c_marketplace_id: Annotated[StrictStr, Field(description="A header used to specify the eBay marketplace ID.")],
        limit: Annotated[Optional[StrictStr], Field(description="The maximum number of items, from the current result set, returned on a single page. Default: 20 Maximum Value: 100")] = None,
    ...
    def get_events_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventSearchResponse]:
        """get_events
