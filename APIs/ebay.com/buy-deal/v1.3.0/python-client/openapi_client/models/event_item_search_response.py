...
class EventItemSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    event_items: Optional[List[EventItem]] = Field(default=None, description="A list of event items that match the search criteria.", alias="eventItems")
    ...
    total: Optional[StrictInt] = Field(default=None, description="The total number of matches for the specified search criteria.")
    __properties: ClassVar[List[str]] = ["eventItems", "href", "limit", "next", "offset", "prev", "total"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_items (list)
        _items = []
        if self.event_items:
            for _item_event_items in self.event_items:
                if _item_event_items:
                    _items.append(_item_event_items.to_dict())
            _dict['eventItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventItems": [EventItem.from_dict(_item) for _item in obj["eventItems"]] if obj.get("eventItems") is not None else None,
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
