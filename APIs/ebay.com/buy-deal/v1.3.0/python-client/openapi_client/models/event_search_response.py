...
class EventSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    events: Optional[List[Event]] = Field(default=None, description="A list of results that match the search criteria.")
    ...
    __properties: ClassVar[List[str]] = ["events", "href", "limit", "next", "offset", "prev", "total"]
