...
class EventItem(BaseModel):
    ...
    """ # noqa: E501
    additional_images: Optional[List[Image]] = Field(default=None, description="The additional images for the event item.", alias="additionalImages")
    ...
    category_id: Optional[StrictStr] = Field(default=None, description="The ID of the leaf category for the event item. A leaf category is the lowest level in a category and has no children.", alias="categoryId")
    ...
    event_id: Optional[StrictStr] = Field(default=None, description="The unique event identifier associated with the item.", alias="eventId")
    ...
    item_group_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the event item group. This is the parent item ID for the seller-defined variations. Note: This field is returned for multiple-SKU items.", alias="itemGroupId")
    ...
    item_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the event item. Note: This field is only returned for single-SKU items.", alias="itemId")
    item_web_url: Optional[StrictStr] = Field(default=None, description="The web URL for the event item.", alias="itemWebUrl")
    legacy_item_id: Optional[StrictStr] = Field(default=None, description="The legacy item ID associated with the event item.", alias="legacyItemId")
    marketing_price: Optional[MarketingPrice] = Field(default=None, alias="marketingPrice")
    price: Optional[Amount] = None
    qualified_programs: Optional[List[StrictStr]] = Field(default=None, description="A list of programs applicable to the event item.", alias="qualifiedPrograms")
    shipping_options: Optional[List[ShippingOption]] = Field(default=None, description="The cost required to ship the event item.", alias="shippingOptions")
    title: Optional[StrictStr] = Field(default=None, description="The title of the event item.")
    ...
    __properties: ClassVar[List[str]] = ["additionalImages", "categoryAncestorIds", "categoryId", "energyEfficiencyClass", "eventId", "image", "itemAffiliateWebUrl", "itemGroupId", "itemGroupType", "itemId", "itemWebUrl", "legacyItemId", "marketingPrice", "price", "qualifiedPrograms", "shippingOptions", "title", "unitPrice", "unitPricingMeasure"]
