...
class CardsIdAttachmentCover(BaseModel):
    """
    CardsIdAttachmentCover
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Id of the image attachment of this card to use as its cover, or null for no cover")
