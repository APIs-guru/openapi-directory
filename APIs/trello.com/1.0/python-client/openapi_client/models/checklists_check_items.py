...
class ChecklistsCheckItems(BaseModel):
    """
    ChecklistsCheckItems
    """ # noqa: E501
    checked: Optional[StrictStr] = Field(default=None, description=" true or false")
    ...
    __properties: ClassVar[List[str]] = ["checked", "name", "pos"]
