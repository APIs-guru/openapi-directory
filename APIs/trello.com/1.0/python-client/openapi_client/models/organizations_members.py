...
class OrganizationsMembers(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="One of: admin, normal or observer")
    __properties: ClassVar[List[str]] = ["email", "fullName", "type"]
