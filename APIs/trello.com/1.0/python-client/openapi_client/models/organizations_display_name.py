...
class OrganizationsDisplayName(BaseModel):
    """
    OrganizationsDisplayName
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="A string with a length of at least 1.  Cannot begin or end with a space.")
