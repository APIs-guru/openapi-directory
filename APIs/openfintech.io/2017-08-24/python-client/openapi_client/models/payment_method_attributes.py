...
class PaymentMethodAttributes(BaseModel):
    ...
    code: Optional[StrictStr] = Field(default=None, description="Payment-method`s code")
    name: Optional[StrictStr] = Field(default=None, description="Payment-method`s name")
    processor_name: Optional[StrictStr] = Field(default=None, description="Payment-method`s processor")
    __properties: ClassVar[List[str]] = ["category", "code", "name", "processor_name"]
