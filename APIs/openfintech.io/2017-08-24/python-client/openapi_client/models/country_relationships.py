...
class CountryRelationships(BaseModel):
    """
    CountryRelationships
    """ # noqa: E501
    translations: Optional[CountryTranslations] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountryRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountryRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "translations": CountryTranslations.from_dict(obj["translations"]) if obj.get("translations") is not None else None
        })
        return _obj
