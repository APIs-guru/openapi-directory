...
class PaymentProviderAttributes(BaseModel):
    """
    Array of Payment-provider attributes
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Payment-provider`s code")
    features: Optional[List[StrictStr]] = None
    name: Optional[StrictStr] = Field(default=None, description="Payment-provider`s name")
    sales_channels: Optional[List[StrictStr]] = None
    types: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["code", "features", "name", "sales_channels", "types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "sales_channels": obj.get("sales_channels"),
            "types": obj.get("types")
        })
        return _obj
