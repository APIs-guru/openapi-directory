...
class OrganizationSource(BaseModel):
    ...
    OrganizationSource
    """ # noqa: E501
    data: Optional[OrganizationSourceData] = None
    links: Optional[OrganizationSourceLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OrganizationSourceData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": OrganizationSourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
