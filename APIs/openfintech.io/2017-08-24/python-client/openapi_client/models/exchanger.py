...
class Exchanger(BaseModel):
    ...
    Exchanger
    """ # noqa: E501
    attributes: Optional[ExchangerAttributes] = None
    id: Optional[StrictStr] = Field(default=None, description="Exchanger`s ID")
    links: Optional[SelfLinks] = None
    relationships: Optional[ExchangerRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": ExchangerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": SelfLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": ExchangerRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
