...
class BankOrganization(BaseModel):
    """
    BankOrganization
    """ # noqa: E501
    data: Optional[BankOrganizationData] = None
    links: Optional[BankOrganizationLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BankOrganizationData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": BankOrganizationLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
