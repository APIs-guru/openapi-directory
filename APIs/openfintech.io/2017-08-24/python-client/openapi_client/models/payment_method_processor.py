...
class PaymentMethodProcessor(BaseModel):
    """
    Payment-method issuer.
    """ # noqa: E501
    data: Optional[PaymentMethodProcessorData] = None
    links: Optional[PaymentMethodProcessorLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PaymentMethodProcessorData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": PaymentMethodProcessorLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
