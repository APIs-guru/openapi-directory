...
class ResponseLinks(BaseModel):
    ...
    ResponseLinks
    """ # noqa: E501
    first: StrictStr = Field(description="first page of query")
    last: StrictStr = Field(description="last page of query")
    next: Optional[StrictStr] = Field(default=None, description="next page in query")
    prev: Optional[StrictStr] = Field(default=None, description="previous page in query")
