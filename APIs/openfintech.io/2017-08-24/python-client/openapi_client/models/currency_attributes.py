...
class CurrencyAttributes(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Currency category")
    code: Optional[StrictStr] = Field(default=None, description="Currency system code")
    code_estandards_alpha: Optional[StrictStr] = None
    code_iso_alpha3: Optional[StrictStr] = Field(default=None, description="Currency ISO code")
    code_iso_numeric3: Optional[StrictInt] = Field(default=None, description="Currency ISO numeric code")
    code_json_alpha: Optional[StrictStr] = None
    created: Optional[StrictStr] = Field(default=None, description="Created date in system (in Unixtime)")
    currency_type: Optional[StrictStr] = Field(default=None, description="Type of currencies [national, digital, virtual, metal, energy]")
    decimal_e: Optional[StrictStr] = Field(default=None, description="Number of digits after the decimal separator")
    icon: Optional[CurrencyAttributesIcon] = None
    issuer: Optional[StrictStr] = Field(default=None, description="Currency`s issuer")
    name: Optional[StrictStr] = Field(default=None, description="Currency description")
    native_symbol: Optional[StrictStr] = Field(default=None, description="Currencyâ€™s symbol. In general, only for nationals currencies")
    symbol: Optional[StrictStr] = Field(default=None, description="Currencyâ€™s symbol. In general, only for nationals currencies")
    __properties: ClassVar[List[str]] = ["category", "code", "code_estandards_alpha", "code_iso_alpha3", "code_iso_numeric3", "code_json_alpha", "created", "currency_type", "decimal_e", "icon", "issuer", "name", "native_symbol", "symbol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "code_estandards_alpha": obj.get("code_estandards_alpha"),
            "code_iso_alpha3": obj.get("code_iso_alpha3"),
            "code_iso_numeric3": obj.get("code_iso_numeric3"),
            "code_json_alpha": obj.get("code_json_alpha"),
            "created": obj.get("created"),
            "currency_type": obj.get("currency_type"),
            "decimal_e": obj.get("decimal_e"),
            "icon": CurrencyAttributesIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "issuer": obj.get("issuer"),
            "name": obj.get("name"),
            "native_symbol": obj.get("native_symbol"),
