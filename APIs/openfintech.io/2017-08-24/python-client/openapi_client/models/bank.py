...
class Bank(BaseModel):
    ...
    Bank
    """ # noqa: E501
    attributes: Optional[BankAttributes] = None
    id: Optional[StrictStr] = Field(default=None, description="Bank`s ID")
    links: Optional[SelfLinks] = None
    relationships: Optional[BankRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": BankAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": SelfLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": BankRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
