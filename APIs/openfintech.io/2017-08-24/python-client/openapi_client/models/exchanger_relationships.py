...
class ExchangerRelationships(BaseModel):
    """
    ExchangerRelationships
    """ # noqa: E501
    organization: Optional[ExchangerOrganization] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organization": ExchangerOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
