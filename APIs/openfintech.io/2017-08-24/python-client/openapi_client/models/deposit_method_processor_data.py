...
class DepositMethodProcessorData(BaseModel):
    """
    Processor`s Data.
    """ # noqa: E501
    data: Optional[List[DepositMethodProcessorDataDataInner]] = None
    links: Optional[DepositMethodProcessorDataLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DepositMethodProcessorDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": DepositMethodProcessorDataLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
