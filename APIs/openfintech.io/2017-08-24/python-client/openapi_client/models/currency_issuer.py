...
class CurrencyIssuer(BaseModel):
    """
    Currency Issuer. 'Only for virtual currency' 
    """ # noqa: E501
    data: Optional[CurrencyIssuertData] = None
    links: Optional[CurrencyIssuerLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CurrencyIssuertData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": CurrencyIssuerLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
