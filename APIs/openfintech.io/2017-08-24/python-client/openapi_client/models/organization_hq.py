...
class OrganizationHq(BaseModel):
    """
    OrganizationHq
    """ # noqa: E501
    data: Optional[OrganizationHqData] = None
    links: Optional[OrganizationHqLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OrganizationHqData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": OrganizationHqLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
