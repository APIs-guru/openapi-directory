...
class ResponseMeta(BaseModel):
    ...
    ResponseMeta
    """ # noqa: E501
    pages: Optional[StrictInt] = Field(default=None, description="total pages")
    total: Optional[StrictInt] = Field(default=None, description="total objects in query")
    __properties: ClassVar[List[str]] = ["pages", "total"]
