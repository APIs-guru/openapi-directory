...
class OrganizationSocial(BaseModel):
    """
    Social profiles
    """ # noqa: E501
    facebook: Optional[StrictStr] = None
    google_plus: Optional[StrictStr] = None
    linked_in: Optional[StrictStr] = None
    twitter: Optional[StrictStr] = None
    vkontakte: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["facebook", "google_plus", "linked_in", "twitter", "vkontakte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "google_plus": obj.get("google_plus"),
            "linked_in": obj.get("linked_in"),
            "twitter": obj.get("twitter"),
            "vkontakte": obj.get("vkontakte")
        })
        return _obj
