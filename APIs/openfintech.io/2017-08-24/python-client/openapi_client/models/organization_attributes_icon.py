...
class OrganizationAttributesIcon(BaseModel):
    """
    Links to organization icons
    """ # noqa: E501
    var_16: Optional[StrictStr] = Field(default=None, description="16x16 icon", alias="16")
    var_32: Optional[StrictStr] = Field(default=None, description="32x32 icon", alias="32")
    var_64: Optional[StrictStr] = Field(default=None, description="64x64 icon", alias="64")
    __properties: ClassVar[List[str]] = ["16", "32", "64"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationAttributesIcon from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationAttributesIcon from a dict"""
        if obj is None:
            return None
