...
class PaymentMethodCurrencies(BaseModel):
    """
    PaymentMethodCurrencies
    """ # noqa: E501
    data: Optional[List[StrictStr]] = None
    links: Optional[PaymentMethodCurrenciesLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "links": PaymentMethodCurrenciesLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
