...
class OrganizationAttributes(BaseModel):
    ...
    blog: Optional[StrictStr] = Field(default=None, description="Organization`s blog")
    code: Optional[StrictStr] = Field(default=None, description="Organization`s code")
    contacts: Optional[OrganizationContacts] = None
    description: Optional[StrictStr] = Field(default=None, description="Description")
    icon: Optional[OrganizationAttributesIcon] = None
    industries: Optional[List[StrictStr]] = Field(default=None, description="Industries")
    logo: Optional[OrganizationAttributesLogo] = None
    name: Optional[StrictStr] = Field(default=None, description="Organization`s name")
    site: Optional[StrictStr] = Field(default=None, description="Organization`s site")
    social_profiles: Optional[OrganizationSocial] = None
    status: Optional[StrictStr] = Field(default=None, description="Organization`s status [active, liquidated, deleted]")
    wiki: Optional[StrictStr] = Field(default=None, description="Organization`s wiki")
    __properties: ClassVar[List[str]] = ["address", "blog", "code", "contacts", "description", "icon", "industries", "logo", "name", "site", "social_profiles", "status", "wiki"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.social_profiles:
            _dict['social_profiles'] = self.social_profiles.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": OrganizationAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "blog": obj.get("blog"),
            "code": obj.get("code"),
            "contacts": OrganizationContacts.from_dict(obj["contacts"]) if obj.get("contacts") is not None else None,
            "description": obj.get("description"),
            "icon": OrganizationAttributesIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "industries": obj.get("industries"),
            "logo": OrganizationAttributesLogo.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
            "name": obj.get("name"),
            "site": obj.get("site"),
            "social_profiles": OrganizationSocial.from_dict(obj["social_profiles"]) if obj.get("social_profiles") is not None else None,
