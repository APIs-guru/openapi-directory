...
class CurrencyIssuerOrganization(BaseModel):
    """
    Issuer. 
    """ # noqa: E501
    data: Optional[CurrencyIssuerOrganizationData] = None
    links: Optional[CurrencyIssuerOrganizationLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CurrencyIssuerOrganizationData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": CurrencyIssuerOrganizationLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
