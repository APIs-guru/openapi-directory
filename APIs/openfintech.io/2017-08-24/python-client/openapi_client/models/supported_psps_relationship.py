...
class SupportedPspsRelationship(BaseModel):
    """
    Supported psps
    """ # noqa: E501
    data: Optional[List[SupportedPspsRelationshipDataInner]] = None
    links: Optional[SupportedPspsRelationshipLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SupportedPspsRelationshipDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": SupportedPspsRelationshipLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
