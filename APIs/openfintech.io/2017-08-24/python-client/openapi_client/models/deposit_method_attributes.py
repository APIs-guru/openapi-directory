...
class DepositMethodAttributes(BaseModel):
    """
    Array of Deposit-method attributes
    """ # noqa: E501
    category: Optional[StrictStr] = None
    code: Optional[StrictStr] = Field(default=None, description="Deposit-method`s code")
    name: Optional[StrictStr] = Field(default=None, description="Deposit-method`s name")
    processor_name: Optional[StrictStr] = Field(default=None, description="Deposit-method`s processor")
