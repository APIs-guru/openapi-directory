...
class OrganizationActive(BaseModel):
    """
    OrganizationActive
    """ # noqa: E501
    data: Optional[List[StrictStr]] = None
    links: Optional[OrganizationActiveLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "links": OrganizationActiveLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
