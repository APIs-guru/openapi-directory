...
class PaymentProviderPaymentMethods(BaseModel):
    """
    PaymentProviderPaymentMethods
    """ # noqa: E501
    data: Optional[List[StrictStr]] = None
    links: Optional[PaymentProviderPaymentMethodsLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "links": PaymentProviderPaymentMethodsLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
