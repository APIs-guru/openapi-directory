...
class ExchangersResponse(BaseModel):
    """
    ExchangersResponse
    """ # noqa: E501
    data: Optional[List[Exchanger]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Exchanger.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
