...
class ExchangerAttributes(BaseModel):
    """
    ExchangerAttributes
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Exchanger`s name")
    rates_export_standard: Optional[StrictStr] = None
    rates_export_url: Optional[StrictStr] = None
    status: Optional[StrictStr] = Field(default=None, description="Exchanger`s status [active, blocked, deleted]")
    wmid: Optional[StrictInt] = Field(default=None, description="Exchanger`s WebMoney ID")
    __properties: ClassVar[List[str]] = ["name", "rates_export_standard", "rates_export_url", "status", "wmid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "rates_export_standard": obj.get("rates_export_standard"),
            "rates_export_url": obj.get("rates_export_url"),
