...
class DepositMethodRelationships(BaseModel):
    """
    DepositMethodRelationships
    """ # noqa: E501
    actiove_in_countries: Optional[ActiveInCountriesRelationship] = None
    currencies: Optional[CurrencyParent] = None
    payment_processor: Optional[DepositMethodProcessorData] = None
    supported_psps: Optional[SupportedPspsRelationship] = None
    __properties: ClassVar[List[str]] = ["actiove_in_countries", "currencies", "payment_processor", "supported_psps"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of actiove_in_countries
        if self.actiove_in_countries:
            _dict['actiove_in_countries'] = self.actiove_in_countries.to_dict()
        ...
        if self.payment_processor:
            _dict['payment_processor'] = self.payment_processor.to_dict()
        # override the default output from pydantic by calling `to_dict()` of supported_psps
        if self.supported_psps:
            _dict['supported_psps'] = self.supported_psps.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actiove_in_countries": ActiveInCountriesRelationship.from_dict(obj["actiove_in_countries"]) if obj.get("actiove_in_countries") is not None else None,
            "currencies": CurrencyParent.from_dict(obj["currencies"]) if obj.get("currencies") is not None else None,
            "payment_processor": DepositMethodProcessorData.from_dict(obj["payment_processor"]) if obj.get("payment_processor") is not None else None,
            "supported_psps": SupportedPspsRelationship.from_dict(obj["supported_psps"]) if obj.get("supported_psps") is not None else None
        })
        return _obj
