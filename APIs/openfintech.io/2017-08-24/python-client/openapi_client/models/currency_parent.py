...
class CurrencyParent(BaseModel):
    """
    Parent currency. 'Only for virtual currency' 
    """ # noqa: E501
    data: Optional[CurrencyParentData] = None
    links: Optional[CurrencyParentLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CurrencyParentData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": CurrencyParentLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
