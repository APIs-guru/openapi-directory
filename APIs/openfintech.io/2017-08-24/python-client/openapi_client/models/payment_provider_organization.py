...
class PaymentProviderOrganization(BaseModel):
    """
    PaymentProviderOrganization
    """ # noqa: E501
    data: Optional[PaymentProviderOrganizationData] = None
    links: Optional[PaymentProviderOrganizationLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PaymentProviderOrganizationData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": PaymentProviderOrganizationLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
