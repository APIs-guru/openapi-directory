...
class OrganizationRelationships(BaseModel):
    ...
    """ # noqa: E501
    active_in_countries: Optional[OrganizationActive] = None
    hq_in_country: Optional[OrganizationHq] = None
    source_register_org: Optional[OrganizationSource] = None
    __properties: ClassVar[List[str]] = ["active_in_countries", "hq_in_country", "source_register_org"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of active_in_countries
        if self.active_in_countries:
            _dict['active_in_countries'] = self.active_in_countries.to_dict()
        # override the default output from pydantic by calling `to_dict()` of hq_in_country
        if self.hq_in_country:
            _dict['hq_in_country'] = self.hq_in_country.to_dict()
        # override the default output from pydantic by calling `to_dict()` of source_register_org
        if self.source_register_org:
            _dict['source_register_org'] = self.source_register_org.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_in_countries": OrganizationActive.from_dict(obj["active_in_countries"]) if obj.get("active_in_countries") is not None else None,
            "hq_in_country": OrganizationHq.from_dict(obj["hq_in_country"]) if obj.get("hq_in_country") is not None else None,
            "source_register_org": OrganizationSource.from_dict(obj["source_register_org"]) if obj.get("source_register_org") is not None else None
        })
        return _obj
