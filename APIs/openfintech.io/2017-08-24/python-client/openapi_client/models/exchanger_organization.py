...
class ExchangerOrganization(BaseModel):
    """
    ExchangerOrganization
    """ # noqa: E501
    data: Optional[ExchangerOrganizationData] = None
    links: Optional[ExchangerOrganizationLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ExchangerOrganizationData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": ExchangerOrganizationLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
