...
class DepositMethodProcessorDataDataInner(BaseModel):
    """
    DepositMethodProcessorDataDataInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Processor`s id.")
    type: Optional[StrictStr] = Field(default=None, description="Processor`s type.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepositMethodProcessorDataDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepositMethodProcessorDataDataInner from a dict"""
        if obj is None:
            return None
