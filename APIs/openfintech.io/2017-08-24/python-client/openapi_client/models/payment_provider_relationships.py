...
class PaymentProviderRelationships(BaseModel):
    """
    PaymentProviderRelationships
    """ # noqa: E501
    organization: Optional[PaymentProviderOrganization] = None
    payment_methods: Optional[PaymentProviderPaymentMethods] = Field(default=None, alias="payment-methods")
    __properties: ClassVar[List[str]] = ["organization", "payment-methods"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.payment_methods:
            _dict['payment-methods'] = self.payment_methods.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organization": PaymentProviderOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "payment-methods": PaymentProviderPaymentMethods.from_dict(obj["payment-methods"]) if obj.get("payment-methods") is not None else None
        })
        return _obj
