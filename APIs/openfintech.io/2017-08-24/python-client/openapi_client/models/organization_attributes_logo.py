...
class OrganizationAttributesLogo(BaseModel):
    """
    Links to organization logos
    """ # noqa: E501
    var_50: Optional[StrictStr] = Field(default=None, description="50x50 logo", alias="50")
    var_100: Optional[StrictStr] = Field(default=None, description="100x100 logo", alias="100")
    var_150: Optional[StrictStr] = Field(default=None, description="150x150 logo", alias="150")
    __properties: ClassVar[List[str]] = ["50", "100", "150"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationAttributesLogo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationAttributesLogo from a dict"""
        if obj is None:
            return None
