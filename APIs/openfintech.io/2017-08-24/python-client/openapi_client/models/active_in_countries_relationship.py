...
class ActiveInCountriesRelationship(BaseModel):
    """
    Active in countries
    """ # noqa: E501
    data: Optional[List[ActiveInCountriesRelationshipDataInner]] = None
    links: Optional[ActiveInCountriesRelationshipLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ActiveInCountriesRelationshipDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": ActiveInCountriesRelationshipLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
