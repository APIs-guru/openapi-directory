...
class CurrencyRelationships(BaseModel):
    """
    CurrencyRelationships
    """ # noqa: E501
    countries: Optional[CurrencyCountries] = None
    issuer: Optional[CurrencyIssuer] = None
    issuer_organization: Optional[CurrencyIssuerOrganization] = None
    parent: Optional[CurrencyParent] = None
    __properties: ClassVar[List[str]] = ["countries", "issuer", "issuer_organization", "parent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of issuer_organization
        if self.issuer_organization:
            _dict['issuer_organization'] = self.issuer_organization.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "countries": CurrencyCountries.from_dict(obj["countries"]) if obj.get("countries") is not None else None,
            "issuer": CurrencyIssuer.from_dict(obj["issuer"]) if obj.get("issuer") is not None else None,
            "issuer_organization": CurrencyIssuerOrganization.from_dict(obj["issuer_organization"]) if obj.get("issuer_organization") is not None else None,
            "parent": CurrencyParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None
        })
        return _obj
