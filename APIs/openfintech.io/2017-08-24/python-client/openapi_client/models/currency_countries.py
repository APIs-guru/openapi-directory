...
class CurrencyCountries(BaseModel):
    """
    CurrencyCountries
    """ # noqa: E501
    links: Optional[CurrencyCountryLinks] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrencyCountries from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CurrencyCountries from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "links": CurrencyCountryLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
