...
class BankAttributes(BaseModel):
    """
    ...
    code: Optional[StrictStr] = Field(default=None, description="Bank`s code")
    iban: Optional[StrictStr] = None
    name: Optional[StrictStr] = Field(default=None, description="Bank`s name")
    sort_code: Optional[StrictStr] = None
    status: Optional[StrictStr] = Field(default=None, description="Status [active, liquidated, problem, deleted]")
    vatin: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["account_number", "bank_code", "bic", "code", "iban", "name", "sort_code", "status", "vatin"]
