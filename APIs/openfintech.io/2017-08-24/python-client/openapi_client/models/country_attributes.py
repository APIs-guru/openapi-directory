...
class CountryAttributes(BaseModel):
    ...
    CountryAttributes
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default=None, description="Countryâ€™s area (sq km)")
    calling_codes: Optional[List[StrictInt]] = Field(default=None, description="Array of country`s phone codes")
    capital: Optional[StrictStr] = Field(default=None, description="Countryâ€™s capital")
    code_alpha3: Optional[StrictStr] = Field(default=None, description="Country`s ISO alpha3 code")
    languages: Optional[List[StrictStr]] = Field(default=None, description="Array of country`s languages")
    name: Optional[StrictStr] = Field(default=None, description="Country`s name")
    native_name: Optional[StrictStr] = Field(default=None, description="Country`s nativ name")
    population: Optional[StrictStr] = Field(default=None, description="Countryâ€™s population")
    region: Optional[StrictStr] = Field(default=None, description="Countryâ€™s region:<br>    * Africa   * Americas   * Asia   * Europe   * Oceania   * Polar ")
    sub_region: Optional[StrictStr] = Field(default=None, description="Countryâ€™s sub region:<br>    * Northern Africa   * Southern Africa   * Western Africa   * Eastern Africa   * Middle Africa   * Northern America   * South America   * Central America   * Caribbean   * Southern Asia   * Western Asia   * Eastern Asia   * South-Eastern Asia   * Central Asia   * Northern Europe   * Southern Europe   * Western Europe   * Eastern Europe   * Polynesia   * Australia and New Zealand   * Micronesia   * Melanesia ")
    timezones: Optional[List[StrictStr]] = Field(default=None, description="Array of country`s timezones (UTC)")
    top_level_domains: Optional[List[StrictStr]] = Field(default=None, description="Array of country`s domains")
    __properties: ClassVar[List[str]] = ["area", "calling_codes", "capital", "code_alpha3", "languages", "name", "native_name", "population", "region", "sub_region", "timezones", "top_level_domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "area": obj.get("area"),
            "calling_codes": obj.get("calling_codes"),
            "capital": obj.get("capital"),
            "code_alpha3": obj.get("code_alpha3"),
            "languages": obj.get("languages"),
            "name": obj.get("name"),
            "native_name": obj.get("native_name"),
            "population": obj.get("population"),
            "region": obj.get("region"),
            "sub_region": obj.get("sub_region"),
            "timezones": obj.get("timezones"),
            "top_level_domains": obj.get("top_level_domains")
        })
        return _obj
