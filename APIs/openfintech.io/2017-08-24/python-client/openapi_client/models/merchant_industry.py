...
class MerchantIndustry(BaseModel):
    ...
    MerchantIndustry
    """ # noqa: E501
    attributes: Optional[MerchantIndustryAttributes] = None
    id: Optional[StrictStr] = Field(default=None, description="Merchant-industry`s ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": MerchantIndustryAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
