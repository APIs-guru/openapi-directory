...
class PaymentMethodsApi:
    ...
    def payment_methods_get(
        ...
        _param = self._payment_methods_get_serialize(
    ...
    @validate_call
    def payment_methods_get_with_http_info(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code, category.")] = None,
    ...
    @validate_call
    def payment_methods_get_without_preload_content(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code, category.")] = None,
    ...
    def _payment_methods_get_serialize(
        self,
        page_number,
        page_size,
        filter_search,
    ...
    def payment_methods_id_get(
        ...
        _param = self._payment_methods_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def payment_methods_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def payment_methods_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _payment_methods_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
