...
class CurrenciesApi:
    ...
    def currencies_get(
        ...
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with name, code, type, code_iso_alpha3, code_jsons_alpha, code_estandards_alpha, category.")] = None,
        filter_code_iso_alpha3: Annotated[Optional[StrictStr], Field(description="Filtering by ISO code.")] = None,
        filter_code_iso_numeric3: Annotated[Optional[StrictInt], Field(description="Filtering by ISO number.")] = None,
        filter_code_estandards_alpha: Annotated[Optional[StrictStr], Field(description="Filtering by estandards code.")] = None,
        filter_currency_type: Annotated[Optional[List[StrictStr]], Field(description="Filtration by currency type.")] = None,
        filter_category: Annotated[Optional[List[StrictStr]], Field(description="Filtration by category.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | type | -type | | category | -category | | code | -code | | code_iso_alpha3 | -code_iso_alpha3 | | code_iso_numeric3 | -code_iso_numeric3 | | code_estandards_alpha | -code_estandards_alpha | ")] = None,
        ...
        _param = self._currencies_get_serialize(
            ...
            filter_code_iso_alpha3=filter_code_iso_alpha3,
            filter_code_iso_numeric3=filter_code_iso_numeric3,
            filter_code_estandards_alpha=filter_code_estandards_alpha,
            filter_currency_type=filter_currency_type,
    ...
    def _currencies_get_serialize(
        ...
        page_size,
        filter_search,
        filter_code_iso_alpha3,
        filter_code_iso_numeric3,
        filter_code_estandards_alpha,
        ...
        if filter_code_iso_alpha3 is not None:
            
            _query_params.append(('filter[code_iso_alpha3]', filter_code_iso_alpha3))
            
        if filter_code_iso_numeric3 is not None:
            
            _query_params.append(('filter[code_iso_numeric3]', filter_code_iso_numeric3))
            
        if filter_code_estandards_alpha is not None:
            
            _query_params.append(('filter[code_estandards_alpha]', filter_code_estandards_alpha))
            
        if filter_currency_type is not None:
            
            _query_params.append(('filter[currency_type]', filter_currency_type))
    ...
    def currencies_id_get(
        ...
        _param = self._currencies_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def currencies_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def currencies_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _currencies_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
