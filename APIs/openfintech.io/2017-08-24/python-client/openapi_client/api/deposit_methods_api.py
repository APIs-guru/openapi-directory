...
class DepositMethodsApi:
    ...
    def deposit_methods_get(
        ...
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code, category.")] = None,
        ...
        filter_processor_name: Annotated[Optional[StrictStr], Field(description="Filtering by processor_name.")] = None,
        filter_category: Annotated[Optional[List[StrictStr]], Field(description="Filtering by category.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | | processor_name | -processor_name | | category | -category | ")] = None,
        ...
        _param = self._deposit_methods_get_serialize(
            page_number=page_number,
            page_size=page_size,
            filter_search=filter_search,
            filter_name=filter_name,
            filter_code=filter_code,
            filter_processor_name=filter_processor_name,
    ...
    @validate_call
    def deposit_methods_get_with_http_info(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code, category.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DepositMethodsResponse]:
        """List of deposit methods
    ...
    @validate_call
    def deposit_methods_get_without_preload_content(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code, category.")] = None,
    ...
    def _deposit_methods_get_serialize(
        self,
        page_number,
        page_size,
        filter_search,
        ...
        if filter_processor_name is not None:
            ...
            _query_params.append(('filter[processor_name]', filter_processor_name))
    ...
    def deposit_methods_id_get(
        ...
        _param = self._deposit_methods_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def deposit_methods_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DepositMethodResponse]:
        """Deposit method by ID
    ...
    @validate_call
    def deposit_methods_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _deposit_methods_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/deposit-methods/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
