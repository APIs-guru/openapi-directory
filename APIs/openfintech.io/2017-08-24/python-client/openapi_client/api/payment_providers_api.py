...
class PaymentProvidersApi:
    ...
    def payment_providers_get(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, code, name.")] = None,
        filter_name: Annotated[Optional[StrictStr], Field(description="Filtering by name.")] = None,
        filter_code: Annotated[Optional[StrictStr], Field(description="Filtering by code.")] = None,
        filter_types: Annotated[Optional[List[StrictStr]], Field(description="Filtering by types.")] = None,
        filter_sales_channels: Annotated[Optional[List[StrictStr]], Field(description="Filtering by sales channels.")] = None,
        filter_features: Annotated[Optional[List[StrictStr]], Field(description="Filtering by features.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | ")] = None,
        ...
        _param = self._payment_providers_get_serialize(
            ...
            filter_sales_channels=filter_sales_channels,
    ...
    @validate_call
    def payment_providers_get_with_http_info(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, code, name.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentProvidersResponse]:
        """List of payment providers
    ...
    @validate_call
    def payment_providers_get_without_preload_content(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, code, name.")] = None,
    ...
    def _payment_providers_get_serialize(
        self,
        page_number,
        page_size,
        filter_search,
        ...
        if filter_code is not None:
            ...
            _query_params.append(('filter[code]', filter_code))
            
        if filter_types is not None:
            
            _query_params.append(('filter[types]', filter_types))
            
        if filter_sales_channels is not None:
            
            _query_params.append(('filter[sales_channels]', filter_sales_channels))
            
        if filter_features is not None:
            
            _query_params.append(('filter[features]', filter_features))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment-providers',
    ...
    @validate_call
    def payment_providers_id_get(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._payment_providers_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def payment_providers_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentProviderResponse]:
        """Payment provider by ID
    ...
    @validate_call
    def payment_providers_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _payment_providers_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment-providers/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
