...
class OrganizationsApi:
    ...
    def organizations_get(
        ...
        filter_search: Annotated[Optional[StrictStr], Field(description="Full text search with id, name, code.")] = None,
        ...
        filter_industries: Annotated[Optional[StrictStr], Field(description="Filtering by industries.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | description | -description | ")] = None,
    ...
    def _organizations_get_serialize(
        ...
        if filter_industries is not None:
            
            _query_params.append(('filter[industries]', filter_industries))
