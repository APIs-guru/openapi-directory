...
class CountriesApi:
    ...
    def countries_get(
        ...
        filter_region: Annotated[Optional[List[StrictStr]], Field(description="Filtration by region.")] = None,
        filter_sub_region: Annotated[Optional[List[StrictStr]], Field(description="Filtration by sub region.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | area | -area | | population | -population | | region | -region | | sub_region | -sub_region | ")] = None,
        ...
        _param = self._countries_get_serialize(
            ...
            filter_sub_region=filter_sub_region,
            sort=sort,
    ...
    def _countries_get_serialize(
        ...
        if filter_region is not None:
            ...
            _query_params.append(('filter[region]', filter_region))
            
        if filter_sub_region is not None:
            
            _query_params.append(('filter[sub_region]', filter_sub_region))
    ...
    def countries_id_get(
        ...
        _param = self._countries_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def countries_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def countries_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _countries_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
