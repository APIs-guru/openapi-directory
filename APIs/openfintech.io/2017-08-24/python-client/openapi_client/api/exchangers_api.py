...
class ExchangersApi:
    ...
    def exchangers_get(
        ...
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | <nobr>-rates_export_standard</nobr> | ")] = None,
        ...
        _param = self._exchangers_get_serialize(
    ...
    @validate_call
    def exchangers_get_with_http_info(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_name: Annotated[Optional[StrictStr], Field(description="Filtering by name.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExchangersResponse]:
        """List of exchangers
    ...
    @validate_call
    def exchangers_get_without_preload_content(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_name: Annotated[Optional[StrictStr], Field(description="Filtering by name.")] = None,
    ...
    def exchangers_id_get(
        ...
        _param = self._exchangers_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def exchangers_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def exchangers_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    def _exchangers_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
