...
class BanksApi:
    ...
    def banks_get(
        ...
        filter_sort_code: Annotated[Optional[StrictStr], Field(description="Filtering by banks code.")] = None,
        filter_code: Annotated[Optional[StrictStr], Field(description="Filtering by code.")] = None,
        filter_status: Annotated[Optional[List[StrictStr]], Field(description="Filtration by status.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | sort_code | -sort_code | ")] = None,
        ...
        _param = self._banks_get_serialize(
    ...
    @validate_call
    def banks_get_without_preload_content(
        self,
        page_number: Annotated[Optional[StrictInt], Field(description="Current page number.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Page size.<br>*Default value: 100* ")] = None,
        filter_sort_code: Annotated[Optional[StrictStr], Field(description="Filtering by banks code.")] = None,
    ...
    def _banks_get_serialize(
        ...
        if filter_sort_code is not None:
            
            _query_params.append(('filter[sort_code]', filter_sort_code))
    ...
    def banks_id_get(
        ...
        _param = self._banks_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def banks_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def banks_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique ID.")],
        _request_timeout: Union[
            None,
