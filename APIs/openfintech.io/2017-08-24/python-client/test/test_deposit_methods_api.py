...
class TestDepositMethodsApi(unittest.TestCase):
    """DepositMethodsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DepositMethodsApi()

    def tearDown(self) -> None:
        pass

    def test_deposit_methods_get(self) -> None:
    ...
    def test_deposit_methods_id_get(self) -> None:
