...
class TestPaymentProviderRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderRelationships:
        """Test PaymentProviderRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderRelationships`
        """
        model = PaymentProviderRelationships()
        if include_optional:
            return PaymentProviderRelationships(
