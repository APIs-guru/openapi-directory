...
class TestCurrencyIssuerOrganizationLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyIssuerOrganizationLinks:
        """Test CurrencyIssuerOrganizationLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuerOrganizationLinks`
        """
        model = CurrencyIssuerOrganizationLinks()
        if include_optional:
            return CurrencyIssuerOrganizationLinks(
