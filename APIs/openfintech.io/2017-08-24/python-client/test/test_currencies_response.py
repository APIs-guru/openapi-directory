...
class TestCurrenciesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrenciesResponse:
            ...
            return CurrenciesResponse(
                data = [
                    openapi_client.models.currency.Currency(
                        attributes = openapi_client.models.currency_attributes.CurrencyAttributes(
                            category = 'others', 
                            code = 'UAH', 
                            ...
                            decimal_e = '2', 
                            icon = openapi_client.models.currency_attributes_icon.CurrencyAttributesIcon(
                        ...
                        links = openapi_client.models.self_links.SelfLinks(
                            self = '/v1/{path}/{id}', ), 
                        relationships = openapi_client.models.currency_relationships.CurrencyRelationships(
