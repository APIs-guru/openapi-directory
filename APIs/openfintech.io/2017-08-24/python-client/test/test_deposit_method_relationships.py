...
class TestDepositMethodRelationships(unittest.TestCase):
    """DepositMethodRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodRelationships:
        """Test DepositMethodRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodRelationships`
        """
        model = DepositMethodRelationships()
        if include_optional:
            return DepositMethodRelationships(
                actiove_in_countries = openapi_client.models.active_in_countries_relationship.ActiveInCountriesRelationship(
                    ...
                    links = openapi_client.models.active_in_countries_relationship_links.ActiveInCountriesRelationship_links(
                        related = '/v1/deposit-methods/dm_fyBYShF7DuOXzeiR/active_in_countries', ), ),
                currencies = openapi_client.models.currency_parent.CurrencyParent(
                    data = openapi_client.models.currency_parent_data.CurrencyParentData(
                        id = 'UAH', 
                        type = 'currencies', ), 
                    links = openapi_client.models.currency_parent_links.CurrencyParentLinks(
                ...
                payment_processor = openapi_client.models.deposit_method_processor_data.DepositMethodProcessorData(
                    data = [
                        openapi_client.models.deposit_method_processor_data_data_inner.DepositMethodProcessorData_data_inner(
                            id = 'ppr_zkqg6xJKCIoWjBB9', 
                            type = 'organizations', )
                        ], 
                    links = openapi_client.models.deposit_method_processor_data_links.DepositMethodProcessorData_links(
                ...
                supported_psps = openapi_client.models.supported_psps_relationship.SupportedPspsRelationship(
                    data = [
                        openapi_client.models.supported_psps_relationship_data_inner.SupportedPspsRelationship_data_inner(
                            id = 'psp_xhaKgsBvEUZzWGIP', 
                            type = 'payment-providers', )
                        ], 
                    links = openapi_client.models.supported_psps_relationship_links.SupportedPspsRelationship_links(
                        related = '/v1/deposit-methods/dm_fyBYShF7DuOXzeiR/supported_psps', ), )
            )
        else:
            return DepositMethodRelationships(
        )
    ...
    def testDepositMethodRelationships(self):
        """Test DepositMethodRelationships"""
