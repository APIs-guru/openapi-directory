...
class TestOrganizationSourceData(unittest.TestCase):
    """OrganizationSourceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationSourceData:
        """Test OrganizationSourceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationSourceData`
        """
        model = OrganizationSourceData()
        if include_optional:
            return OrganizationSourceData(
                id = '',
                type = ''
            )
        else:
    ...
    def testOrganizationSourceData(self):
        """Test OrganizationSourceData"""
