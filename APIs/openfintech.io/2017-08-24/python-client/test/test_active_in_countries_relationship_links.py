...
class TestActiveInCountriesRelationshipLinks(unittest.TestCase):
    """ActiveInCountriesRelationshipLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveInCountriesRelationshipLinks:
        """Test ActiveInCountriesRelationshipLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveInCountriesRelationshipLinks`
        """
        model = ActiveInCountriesRelationshipLinks()
        if include_optional:
            return ActiveInCountriesRelationshipLinks(
    ...
    def testActiveInCountriesRelationshipLinks(self):
        """Test ActiveInCountriesRelationshipLinks"""
