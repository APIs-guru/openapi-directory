...
class TestCurrencyParentLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyParentLinks:
        """Test CurrencyParentLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyParentLinks`
        """
        model = CurrencyParentLinks()
        if include_optional:
            return CurrencyParentLinks(
