...
class TestOrganizationHq(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationHq:
        """Test OrganizationHq
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationHq`
        """
        model = OrganizationHq()
        if include_optional:
            return OrganizationHq(
                data = openapi_client.models.organization_hq_data.OrganizationHqData(
                    id = 'UA', 
                    type = 'countries', ),
                links = openapi_client.models.organization_hq_links.OrganizationHqLinks(
