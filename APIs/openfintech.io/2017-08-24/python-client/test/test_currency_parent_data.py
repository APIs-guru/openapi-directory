...
class TestCurrencyParentData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyParentData:
        """Test CurrencyParentData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyParentData`
        """
        model = CurrencyParentData()
        if include_optional:
            return CurrencyParentData(
                id = 'UAH',
                type = 'currencies'
            )
        else:
