...
class TestExchangerOrganization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerOrganization:
        """Test ExchangerOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerOrganization`
        """
        model = ExchangerOrganization()
        if include_optional:
            return ExchangerOrganization(
