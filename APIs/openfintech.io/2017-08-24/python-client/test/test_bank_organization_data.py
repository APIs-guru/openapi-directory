...
class TestBankOrganizationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankOrganizationData:
        """Test BankOrganizationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankOrganizationData`
        """
        model = BankOrganizationData()
        if include_optional:
            return BankOrganizationData(
