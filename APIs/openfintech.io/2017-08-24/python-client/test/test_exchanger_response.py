...
class TestExchangerResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerResponse:
        """Test ExchangerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerResponse`
        """
        model = ExchangerResponse()
        if include_optional:
            return ExchangerResponse(
                data = openapi_client.models.exchanger.Exchanger(
