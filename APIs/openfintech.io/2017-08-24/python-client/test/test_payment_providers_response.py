...
class TestPaymentProvidersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProvidersResponse:
        """Test PaymentProvidersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProvidersResponse`
        """
        model = PaymentProvidersResponse()
        if include_optional:
            return PaymentProvidersResponse(
                data = [
                    openapi_client.models.payment_provider.PaymentProvider(
