...
class TestActiveInCountriesRelationship(unittest.TestCase):
    """ActiveInCountriesRelationship unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveInCountriesRelationship:
        """Test ActiveInCountriesRelationship
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveInCountriesRelationship`
        """
        model = ActiveInCountriesRelationship()
        if include_optional:
            return ActiveInCountriesRelationship(
                data = [
    ...
    def testActiveInCountriesRelationship(self):
        """Test ActiveInCountriesRelationship"""
