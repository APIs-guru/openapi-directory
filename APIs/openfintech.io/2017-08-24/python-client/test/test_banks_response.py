...
class TestBanksResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BanksResponse:
        """Test BanksResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BanksResponse`
        """
        model = BanksResponse()
        if include_optional:
            return BanksResponse(
                data = [
                    openapi_client.models.bank.Bank(
                        attributes = openapi_client.models.bank_attributes.BankAttributes(
                            account_number = '', 
                            bank_code = '', 
                            bic = '', 
                        ...
                        links = openapi_client.models.self_links.SelfLinks(
                            self = '/v1/{path}/{id}', ), 
                        relationships = openapi_client.models.bank_relationships.BankRelationships(
                            organization = openapi_client.models.bank_organization.BankOrganization(
                                data = openapi_client.models.bank_organization_data.BankOrganizationData(
