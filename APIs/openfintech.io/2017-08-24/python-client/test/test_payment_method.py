    ...
    def make_instance(self, include_optional) -> PaymentMethod:
        ...
        if include_optional:
            return PaymentMethod(
                attributes = openapi_client.models.payment_method_attributes.PaymentMethodAttributes(
                    category = 'wallet', 
                    code = 'justpayewallet', 
                    name = 'TOT Just Pay', 
                ...
                links = openapi_client.models.self_links.SelfLinks(
                    self = '/v1/{path}/{id}', ),
                relationships = openapi_client.models.payment_method_relationships.PaymentMethodRelationships(
                    currencies = openapi_client.models.payment_method_currencies.PaymentMethodCurrencies(
                        data = [
                            ''
                            ], 
                        links = openapi_client.models.payment_method_currencies_links.PaymentMethodCurrenciesLinks(
                            related = '/v1/payment-methods/pm_QcW80uZ5XefiQYwp/payment-processor', ), ), 
                    payment_processor = openapi_client.models.payment_method_processor.PaymentMethodProcessor(), ),
