...
class TestSupportedPspsRelationship(unittest.TestCase):
    """SupportedPspsRelationship unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportedPspsRelationship:
        """Test SupportedPspsRelationship
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportedPspsRelationship`
        """
        model = SupportedPspsRelationship()
        if include_optional:
            return SupportedPspsRelationship(
                data = [
    ...
    def testSupportedPspsRelationship(self):
        """Test SupportedPspsRelationship"""
