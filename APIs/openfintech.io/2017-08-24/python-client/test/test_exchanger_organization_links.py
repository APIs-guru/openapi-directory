...
class TestExchangerOrganizationLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerOrganizationLinks:
        """Test ExchangerOrganizationLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerOrganizationLinks`
        """
        model = ExchangerOrganizationLinks()
        if include_optional:
            return ExchangerOrganizationLinks(
