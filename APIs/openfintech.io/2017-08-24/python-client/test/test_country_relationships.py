...
class TestCountryRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryRelationships:
        """Test CountryRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryRelationships`
        """
        model = CountryRelationships()
        if include_optional:
            return CountryRelationships(
                translations = openapi_client.models.country_translations.CountryTranslations(
                    links = openapi_client.models.country_translations_links.CountryTranslationsLinks(
