...
class TestSupportedPspsRelationshipLinks(unittest.TestCase):
    """SupportedPspsRelationshipLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportedPspsRelationshipLinks:
        """Test SupportedPspsRelationshipLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportedPspsRelationshipLinks`
        """
        model = SupportedPspsRelationshipLinks()
        if include_optional:
            return SupportedPspsRelationshipLinks(
    ...
    def testSupportedPspsRelationshipLinks(self):
        """Test SupportedPspsRelationshipLinks"""
