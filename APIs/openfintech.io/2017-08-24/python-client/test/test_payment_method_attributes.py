...
class TestPaymentMethodAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodAttributes:
        """Test PaymentMethodAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodAttributes`
        """
        model = PaymentMethodAttributes()
        if include_optional:
