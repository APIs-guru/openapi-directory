...
class TestDepositMethodAttributes(unittest.TestCase):
    """DepositMethodAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodAttributes:
        """Test DepositMethodAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodAttributes`
        """
        model = DepositMethodAttributes()
        if include_optional:
            return DepositMethodAttributes(
                category = 'wallet',
                code = 'justpayewallet',
                name = 'TOT Just Pay',
    ...
    def testDepositMethodAttributes(self):
        """Test DepositMethodAttributes"""
