...
class TestDepositMethodProcessorData(unittest.TestCase):
    """DepositMethodProcessorData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodProcessorData:
        """Test DepositMethodProcessorData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodProcessorData`
        """
        model = DepositMethodProcessorData()
        if include_optional:
            return DepositMethodProcessorData(
                data = [
    ...
    def testDepositMethodProcessorData(self):
        """Test DepositMethodProcessorData"""
