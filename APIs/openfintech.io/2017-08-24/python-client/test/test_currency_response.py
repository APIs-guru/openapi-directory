...
class TestCurrencyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyResponse:
        """Test CurrencyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyResponse`
        """
        model = CurrencyResponse()
        if include_optional:
            return CurrencyResponse(
                data = openapi_client.models.currency.Currency(
