...
class TestExchangerOrganizationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerOrganizationData:
        """Test ExchangerOrganizationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerOrganizationData`
        """
        model = ExchangerOrganizationData()
        if include_optional:
            return ExchangerOrganizationData(
