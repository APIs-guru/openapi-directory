...
class TestCurrencyIssuertData(unittest.TestCase):
    """CurrencyIssuertData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyIssuertData:
        """Test CurrencyIssuertData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuertData`
        """
        model = CurrencyIssuertData()
        if include_optional:
            return CurrencyIssuertData(
                id = '',
                type = 'issuer'
            )
        else:
    ...
    def testCurrencyIssuertData(self):
        """Test CurrencyIssuertData"""
