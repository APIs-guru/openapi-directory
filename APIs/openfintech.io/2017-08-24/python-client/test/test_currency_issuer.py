...
class TestCurrencyIssuer(unittest.TestCase):
    """CurrencyIssuer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyIssuer:
        """Test CurrencyIssuer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuer`
        """
        model = CurrencyIssuer()
        if include_optional:
            return CurrencyIssuer(
