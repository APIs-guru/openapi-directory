...
class TestBankRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankRelationships:
        """Test BankRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankRelationships`
        """
        model = BankRelationships()
        if include_optional:
            return BankRelationships(
                organization = openapi_client.models.bank_organization.BankOrganization(
                    data = openapi_client.models.bank_organization_data.BankOrganizationData(
                        ...
                        type = 'organizations', ), 
                    links = openapi_client.models.bank_organization_links.BankOrganizationLinks(
