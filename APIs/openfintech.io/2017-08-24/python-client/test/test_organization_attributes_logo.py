...
class TestOrganizationAttributesLogo(unittest.TestCase):
    """OrganizationAttributesLogo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationAttributesLogo:
        """Test OrganizationAttributesLogo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationAttributesLogo`
        """
        model = OrganizationAttributesLogo()
        if include_optional:
            return OrganizationAttributesLogo(
                var_50 = 'https://i.openfintech.io/organizations/Interkassa/logo_50.png',
                var_100 = 'https://i.openfintech.io/organizations/Interkassa/logo_100.png',
                var_150 = 'https://i.openfintech.io/organizations/Interkassa/logo_150.png'
            )
        else:
            return OrganizationAttributesLogo(
        )
    ...
    def testOrganizationAttributesLogo(self):
        """Test OrganizationAttributesLogo"""
