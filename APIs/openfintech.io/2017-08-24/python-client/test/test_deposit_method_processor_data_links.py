...
class TestDepositMethodProcessorDataLinks(unittest.TestCase):
    """DepositMethodProcessorDataLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodProcessorDataLinks:
        """Test DepositMethodProcessorDataLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodProcessorDataLinks`
        """
        model = DepositMethodProcessorDataLinks()
        if include_optional:
            return DepositMethodProcessorDataLinks(
    ...
    def testDepositMethodProcessorDataLinks(self):
        """Test DepositMethodProcessorDataLinks"""
