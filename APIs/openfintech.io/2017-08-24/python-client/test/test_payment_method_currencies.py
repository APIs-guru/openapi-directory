...
class TestPaymentMethodCurrencies(unittest.TestCase):
    """PaymentMethodCurrencies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentMethodCurrencies:
        """Test PaymentMethodCurrencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodCurrencies`
        """
        model = PaymentMethodCurrencies()
        if include_optional:
    ...
    def testPaymentMethodCurrencies(self):
        """Test PaymentMethodCurrencies"""
