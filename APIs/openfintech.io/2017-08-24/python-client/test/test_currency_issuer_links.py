...
class TestCurrencyIssuerLinks(unittest.TestCase):
    """CurrencyIssuerLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyIssuerLinks:
        """Test CurrencyIssuerLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuerLinks`
        """
        model = CurrencyIssuerLinks()
        if include_optional:
            return CurrencyIssuerLinks(
    ...
    def testCurrencyIssuerLinks(self):
        """Test CurrencyIssuerLinks"""
