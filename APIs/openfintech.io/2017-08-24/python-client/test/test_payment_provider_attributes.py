...
class TestPaymentProviderAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderAttributes:
        """Test PaymentProviderAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderAttributes`
        """
        model = PaymentProviderAttributes()
        if include_optional:
            return PaymentProviderAttributes(
                code = 'Interkassa',
