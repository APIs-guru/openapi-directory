...
class TestPaymentProviderOrganizationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderOrganizationData:
        """Test PaymentProviderOrganizationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderOrganizationData`
        """
        model = PaymentProviderOrganizationData()
        if include_optional:
            return PaymentProviderOrganizationData(
