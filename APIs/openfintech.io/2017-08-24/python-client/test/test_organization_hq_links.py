...
class TestOrganizationHqLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationHqLinks:
        """Test OrganizationHqLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationHqLinks`
        """
        model = OrganizationHqLinks()
        if include_optional:
            return OrganizationHqLinks(
