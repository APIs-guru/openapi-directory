...
class TestOrganizationSourceLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationSourceLinks:
        """Test OrganizationSourceLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationSourceLinks`
        """
        model = OrganizationSourceLinks()
        if include_optional:
            return OrganizationSourceLinks(
