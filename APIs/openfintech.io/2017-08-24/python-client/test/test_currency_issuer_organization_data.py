...
class TestCurrencyIssuerOrganizationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyIssuerOrganizationData:
        """Test CurrencyIssuerOrganizationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuerOrganizationData`
        """
        model = CurrencyIssuerOrganizationData()
        if include_optional:
            return CurrencyIssuerOrganizationData(
                id = '',
                type = 'currencies'
            )
        else:
