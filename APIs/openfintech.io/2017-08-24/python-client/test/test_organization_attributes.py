    ...
    def make_instance(self, include_optional) -> OrganizationAttributes:
        ...
        if include_optional:
            return OrganizationAttributes(
                address = openapi_client.models.organization_address.OrganizationAddress(
                    city = 'Kyiv', 
                    country = 'Ukraine', 
                    post_code = 2184, 
                    region = 'Europe', 
                ...
                blog = 'none',
                code = 'interkassa',
                contacts = openapi_client.models.organization_contacts.OrganizationContacts(
                    email = 'support@interkassa.com', 
                    fax = '1234', 
                    phone = '380445859331', 
                    skype = 'skype.ik', ),
                description = 'Payment acceptance system',
                icon = openapi_client.models.organization_attributes_icon.OrganizationAttributesIcon(
                ...
                industries = [psp],
                logo = openapi_client.models.organization_attributes_logo.OrganizationAttributesLogo(
                ...
                social_profiles = openapi_client.models.organization_social.OrganizationSocial(
                    facebook = 'none', 
                    google_plus = 'none', 
                    linked_in = 'none', 
                    twitter = 'none', 
