...
class TestOrganizationAttributesIcon(unittest.TestCase):
    """OrganizationAttributesIcon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationAttributesIcon:
        """Test OrganizationAttributesIcon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationAttributesIcon`
        """
        model = OrganizationAttributesIcon()
        if include_optional:
            return OrganizationAttributesIcon(
                var_16 = 'https://i.openfintech.io/organizations/Interkassa/icon_16.png',
                var_32 = 'https://i.openfintech.io/organizations/Interkassa/icon_32.png',
                var_64 = 'https://i.openfintech.io/organizations/Interkassa/icon_64.png'
            )
        else:
            return OrganizationAttributesIcon(
        )
    ...
    def testOrganizationAttributesIcon(self):
        """Test OrganizationAttributesIcon"""
