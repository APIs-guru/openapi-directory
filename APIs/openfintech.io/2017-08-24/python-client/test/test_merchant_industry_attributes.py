...
class TestMerchantIndustryAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantIndustryAttributes:
        """Test MerchantIndustryAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantIndustryAttributes`
        """
        model = MerchantIndustryAttributes()
        if include_optional:
            return MerchantIndustryAttributes(
                name = 'Airlines'
            )
        else:
            return MerchantIndustryAttributes(
