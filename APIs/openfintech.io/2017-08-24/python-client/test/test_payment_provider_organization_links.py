...
class TestPaymentProviderOrganizationLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderOrganizationLinks:
        """Test PaymentProviderOrganizationLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderOrganizationLinks`
        """
        model = PaymentProviderOrganizationLinks()
        if include_optional:
            return PaymentProviderOrganizationLinks(
