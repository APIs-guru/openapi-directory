...
class TestDepositMethodResponse(unittest.TestCase):
    """DepositMethodResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodResponse:
        """Test DepositMethodResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodResponse`
        """
        model = DepositMethodResponse()
        if include_optional:
            return DepositMethodResponse(
                data = openapi_client.models.deposit_method.DepositMethod(
                    attributes = openapi_client.models.deposit_method_attributes.DepositMethodAttributes(
                        category = 'wallet', 
                        code = 'justpayewallet', 
                        name = 'TOT Just Pay', 
                        processor_name = 'TOT Just Pay', ), 
                    id = 'paym_8NBX4V5fAEmqr3PO', 
                    links = openapi_client.models.self_links.SelfLinks(
                        self = '/v1/{path}/{id}', ), 
                    relationships = openapi_client.models.deposit_method_relationships.DepositMethodRelationships(
                        actiove_in_countries = openapi_client.models.active_in_countries_relationship.ActiveInCountriesRelationship(
                            data = [
                                openapi_client.models.active_in_countries_relationship_data_inner.ActiveInCountriesRelationship_data_inner(
                                    id = 'UA', 
                                    type = 'countries', )
                                ], ), 
                        currencies = openapi_client.models.currency_parent.CurrencyParent(), 
                        payment_processor = openapi_client.models.deposit_method_processor_data.DepositMethodProcessorData(), 
                        supported_psps = openapi_client.models.supported_psps_relationship.SupportedPspsRelationship(), ), 
    ...
    def testDepositMethodResponse(self):
        """Test DepositMethodResponse"""
