...
class TestSupportedPspsRelationshipDataInner(unittest.TestCase):
    """SupportedPspsRelationshipDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportedPspsRelationshipDataInner:
        """Test SupportedPspsRelationshipDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportedPspsRelationshipDataInner`
        """
        model = SupportedPspsRelationshipDataInner()
        if include_optional:
            return SupportedPspsRelationshipDataInner(
    ...
    def testSupportedPspsRelationshipDataInner(self):
        """Test SupportedPspsRelationshipDataInner"""
