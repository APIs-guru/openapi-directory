...
class TestDepositMethodProcessorDataDataInner(unittest.TestCase):
    """DepositMethodProcessorDataDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodProcessorDataDataInner:
        """Test DepositMethodProcessorDataDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodProcessorDataDataInner`
        """
        model = DepositMethodProcessorDataDataInner()
        if include_optional:
            return DepositMethodProcessorDataDataInner(
    ...
    def testDepositMethodProcessorDataDataInner(self):
        """Test DepositMethodProcessorDataDataInner"""
