...
class TestPaymentProviderPaymentMethodsLinks(unittest.TestCase):
    """PaymentProviderPaymentMethodsLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentProviderPaymentMethodsLinks:
        """Test PaymentProviderPaymentMethodsLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderPaymentMethodsLinks`
        """
        model = PaymentProviderPaymentMethodsLinks()
        if include_optional:
            return PaymentProviderPaymentMethodsLinks(
    ...
    def testPaymentProviderPaymentMethodsLinks(self):
        """Test PaymentProviderPaymentMethodsLinks"""
