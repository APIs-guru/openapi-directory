...
class TestPaymentProviderOrganization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderOrganization:
        """Test PaymentProviderOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderOrganization`
        """
        model = PaymentProviderOrganization()
        if include_optional:
            return PaymentProviderOrganization(
