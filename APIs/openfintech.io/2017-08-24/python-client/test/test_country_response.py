...
class TestCountryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryResponse:
        ...
        if include_optional:
            return CountryResponse(
                data = openapi_client.models.country.Country(
                    attributes = openapi_client.models.country_attributes.CountryAttributes(
                        area = '603700', 
                        calling_codes = [380], 
                        capital = 'Kyiv', 
                        code_alpha3 = 'UKR', 
                    ...
                    links = openapi_client.models.self_links.SelfLinks(
                        self = '/v1/{path}/{id}', ), 
                    relationships = openapi_client.models.country_relationships.CountryRelationships(
