...
class TestPaymentMethodProcessorData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodProcessorData:
        """Test PaymentMethodProcessorData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodProcessorData`
        """
        model = PaymentMethodProcessorData()
        if include_optional:
            return PaymentMethodProcessorData(
