...
class TestExchangerAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerAttributes:
        """Test ExchangerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerAttributes`
        """
        model = ExchangerAttributes()
        if include_optional:
            return ExchangerAttributes(
                name = 'Xchange.cc',
