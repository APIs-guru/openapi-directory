...
class TestMerchantIndustriesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantIndustriesResponse:
        """Test MerchantIndustriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantIndustriesResponse`
        """
        model = MerchantIndustriesResponse()
        if include_optional:
            return MerchantIndustriesResponse(
                data = [
                    openapi_client.models.merchant_industry.MerchantIndustry(
