...
class TestExchangersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangersResponse:
        """Test ExchangersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangersResponse`
        """
        model = ExchangersResponse()
        if include_optional:
            return ExchangersResponse(
                data = [
                    openapi_client.models.exchanger.Exchanger(
                        attributes = openapi_client.models.exchanger_attributes.ExchangerAttributes(
                            name = 'Xchange.cc', 
                        ...
                        links = openapi_client.models.self_links.SelfLinks(
                            self = '/v1/{path}/{id}', ), 
                        relationships = openapi_client.models.exchanger_relationships.ExchangerRelationships(
                            organization = openapi_client.models.exchanger_organization.ExchangerOrganization(
                                data = openapi_client.models.exchanger_organization_data.ExchangerOrganizationData(
                                    id = 'org_Dr5Wi728plQ0RPA5', 
                                    type = 'organizations', ), ), ), 
                        type = 'exchangers', )
                    ],
                links = openapi_client.models.response_links.ResponseLinks(
