...
class TestDepositMethodsResponse(unittest.TestCase):
    """DepositMethodsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositMethodsResponse:
        """Test DepositMethodsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositMethodsResponse`
        """
        model = DepositMethodsResponse()
        if include_optional:
            return DepositMethodsResponse(
                data = [
                    openapi_client.models.deposit_method.DepositMethod(
    ...
    def testDepositMethodsResponse(self):
        """Test DepositMethodsResponse"""
