...
class TestOrganizationActiveLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationActiveLinks:
        """Test OrganizationActiveLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationActiveLinks`
        """
        model = OrganizationActiveLinks()
        if include_optional:
            return OrganizationActiveLinks(
