...
class TestBankOrganizationLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankOrganizationLinks:
        """Test BankOrganizationLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankOrganizationLinks`
        """
        model = BankOrganizationLinks()
        if include_optional:
            return BankOrganizationLinks(
