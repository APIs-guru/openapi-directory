...
class TestPaymentProviderPaymentMethods(unittest.TestCase):
    """PaymentProviderPaymentMethods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentProviderPaymentMethods:
        """Test PaymentProviderPaymentMethods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderPaymentMethods`
        """
        model = PaymentProviderPaymentMethods()
        if include_optional:
            return PaymentProviderPaymentMethods(
                data = [],
                links = openapi_client.models.payment_provider_payment_methods_links.PaymentProviderPaymentMethodsLinks(
                    related = '/v1/payment-providers/psp_f9VUSVUhsl7Rm0JD/payment-methods', )
            )
        else:
            return PaymentProviderPaymentMethods(
        )
    ...
    def testPaymentProviderPaymentMethods(self):
        """Test PaymentProviderPaymentMethods"""
