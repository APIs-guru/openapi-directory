...
class TestPaymentMethodProcessor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodProcessor:
        """Test PaymentMethodProcessor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodProcessor`
        """
        model = PaymentMethodProcessor()
        if include_optional:
            return PaymentMethodProcessor(
                data = openapi_client.models.payment_method_processor_data.PaymentMethodProcessorData(
                    id = 'ppr_zkqg6xJKCIoWjBB9', 
                    type = 'payment-method-issuer', ),
                links = openapi_client.models.payment_method_processor_links.PaymentMethodProcessorLinks(
                    related = '/v1/payment-methods/paym_8NBX4V5fAEmqr3PO/payment-processor', )
            )
        else:
            return PaymentMethodProcessor(
        )
