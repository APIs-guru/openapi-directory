...
class TestOrganizationHqData(unittest.TestCase):
    """OrganizationHqData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationHqData:
        """Test OrganizationHqData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationHqData`
        """
        model = OrganizationHqData()
        if include_optional:
            return OrganizationHqData(
                id = 'UA',
                type = 'countries'
            )
        else:
    ...
    def testOrganizationHqData(self):
        """Test OrganizationHqData"""
