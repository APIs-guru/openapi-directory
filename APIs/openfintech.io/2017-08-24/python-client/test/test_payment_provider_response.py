...
class TestPaymentProviderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentProviderResponse:
        """Test PaymentProviderResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProviderResponse`
        """
        model = PaymentProviderResponse()
        if include_optional:
            return PaymentProviderResponse(
                data = openapi_client.models.payment_provider.PaymentProvider(
