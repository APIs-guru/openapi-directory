...
class TestCurrencyAttributesIcon(unittest.TestCase):
    """CurrencyAttributesIcon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyAttributesIcon:
        """Test CurrencyAttributesIcon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyAttributesIcon`
        """
        model = CurrencyAttributesIcon()
        if include_optional:
            return CurrencyAttributesIcon(
                var_16 = 'https://i.openfintech.io/currencies/UAH/icon_16.png',
                var_32 = 'https://i.openfintech.io/currencies/UAH/icon_32.png',
                var_64 = 'https://i.openfintech.io/currencies/UAH/icon_64.png'
            )
        else:
            return CurrencyAttributesIcon(
        )
    ...
    def testCurrencyAttributesIcon(self):
        """Test CurrencyAttributesIcon"""
