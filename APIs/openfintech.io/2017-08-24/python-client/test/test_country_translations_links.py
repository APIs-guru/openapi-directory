...
class TestCountryTranslationsLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryTranslationsLinks:
        """Test CountryTranslationsLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryTranslationsLinks`
        """
        model = CountryTranslationsLinks()
        if include_optional:
            return CountryTranslationsLinks(
