...
class TestCurrencyIssuerOrganization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyIssuerOrganization:
        """Test CurrencyIssuerOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyIssuerOrganization`
        """
        model = CurrencyIssuerOrganization()
        if include_optional:
            return CurrencyIssuerOrganization(
