...
class TestPaymentMethodCurrenciesLinks(unittest.TestCase):
    """PaymentMethodCurrenciesLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentMethodCurrenciesLinks:
        """Test PaymentMethodCurrenciesLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodCurrenciesLinks`
        """
        model = PaymentMethodCurrenciesLinks()
        if include_optional:
            return PaymentMethodCurrenciesLinks(
    ...
    def testPaymentMethodCurrenciesLinks(self):
        """Test PaymentMethodCurrenciesLinks"""
