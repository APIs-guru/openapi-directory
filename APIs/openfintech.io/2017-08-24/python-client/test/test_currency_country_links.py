...
class TestCurrencyCountryLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyCountryLinks:
        """Test CurrencyCountryLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyCountryLinks`
        """
        model = CurrencyCountryLinks()
        if include_optional:
            return CurrencyCountryLinks(
