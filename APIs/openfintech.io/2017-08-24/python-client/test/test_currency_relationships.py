...
class TestCurrencyRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CurrencyRelationships:
        """Test CurrencyRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyRelationships`
        """
        model = CurrencyRelationships()
        if include_optional:
            return CurrencyRelationships(
                countries = openapi_client.models.currency_countries.CurrencyCountries(
                    links = openapi_client.models.currency_country_links.CurrencyCountryLinks(
                        related = '/v1/currencies/UAH/countries', ), ),
                issuer = openapi_client.models.currency_issuer.CurrencyIssuer(
                    data = openapi_client.models.currency_issuert_data.CurrencyIssuertData(
                        id = '', 
                        type = 'issuer', ), 
                    links = openapi_client.models.currency_issuer_links.CurrencyIssuerLinks(
                        related = '/v1/currencies/UAH/issuer', ), ),
                issuer_organization = openapi_client.models.currency_issuer_organization.CurrencyIssuerOrganization(
                    data = openapi_client.models.currency_issuer_organization_data.CurrencyIssuerOrganizationData(
                        id = '', 
                        type = 'currencies', ), 
                    links = openapi_client.models.currency_issuer_organization_links.CurrencyIssuerOrganizationLinks(
                        related = '/v1/currencies/UAH/issuer_organization', ), ),
                parent = openapi_client.models.currency_parent.CurrencyParent(
