...
class TestOrganizationSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationSource:
        """Test OrganizationSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationSource`
        """
        model = OrganizationSource()
        if include_optional:
            return OrganizationSource(
                data = openapi_client.models.organization_source_data.OrganizationSourceData(
                    id = '', 
                    type = '', ),
                links = openapi_client.models.organization_source_links.OrganizationSourceLinks(
