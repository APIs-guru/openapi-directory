...
class TestActiveInCountriesRelationshipDataInner(unittest.TestCase):
    """ActiveInCountriesRelationshipDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveInCountriesRelationshipDataInner:
        """Test ActiveInCountriesRelationshipDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveInCountriesRelationshipDataInner`
        """
        model = ActiveInCountriesRelationshipDataInner()
        if include_optional:
            return ActiveInCountriesRelationshipDataInner(
                id = 'UA',
                type = 'countries'
            )
        else:
    ...
    def testActiveInCountriesRelationshipDataInner(self):
        """Test ActiveInCountriesRelationshipDataInner"""
