...
class TestPaymentMethodRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentMethodRelationships:
        """Test PaymentMethodRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodRelationships`
        """
        model = PaymentMethodRelationships()
        if include_optional:
            return PaymentMethodRelationships(
