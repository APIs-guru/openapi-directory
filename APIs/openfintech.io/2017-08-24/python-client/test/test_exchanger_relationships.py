...
class TestExchangerRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExchangerRelationships:
        """Test ExchangerRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangerRelationships`
        """
        model = ExchangerRelationships()
        if include_optional:
            return ExchangerRelationships(
                organization = openapi_client.models.exchanger_organization.ExchangerOrganization(
                    data = openapi_client.models.exchanger_organization_data.ExchangerOrganizationData(
                        ...
                        type = 'organizations', ), 
                    links = openapi_client.models.exchanger_organization_links.ExchangerOrganizationLinks(
