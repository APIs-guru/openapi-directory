...
class TestMerchantIndustryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantIndustryResponse:
        """Test MerchantIndustryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantIndustryResponse`
        """
        model = MerchantIndustryResponse()
        if include_optional:
            return MerchantIndustryResponse(
                data = openapi_client.models.merchant_industry.MerchantIndustry(
                    attributes = openapi_client.models.merchant_industry_attributes.MerchantIndustryAttributes(
                        name = 'Airlines', ), 
                    id = 'merchind_Cukwq7LEFXiaRpkZ', 
                    type = 'merchant-industries', )
            )
        else:
            return MerchantIndustryResponse(
        )
