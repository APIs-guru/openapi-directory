...
class TestOrganization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Organization:
        ...
        if include_optional:
            return Organization(
                attributes = openapi_client.models.organization_attributes.OrganizationAttributes(
                ...
                links = openapi_client.models.self_links.SelfLinks(
                    self = '/v1/{path}/{id}', ),
                relationships = openapi_client.models.organization_relationships.OrganizationRelationships(
                    active_in_countries = openapi_client.models.organization_active.OrganizationActive(
                        data = none, 
                        links = openapi_client.models.organization_active_links.OrganizationActiveLinks(
                            related = '/v1/organizations/org_lK1mIKXO1kHOrTeJ/active_in_countries', ), ), 
                    hq_in_country = openapi_client.models.organization_hq.OrganizationHq(
                        data = openapi_client.models.organization_hq_data.OrganizationHqData(
                            id = 'UA', 
                            type = 'countries', ), ), 
                    source_register_org = openapi_client.models.organization_source.OrganizationSource(), ),
                type = 'organizations'
            )
        else:
            return Organization(
