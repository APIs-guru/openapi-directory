...
class PeopleApi:
    ...
    def people_search_read(
        ...
        _param = self._people_search_read_serialize(
            user=user,
    ...
    @validate_call
    def people_search_read_with_http_info(
        self,
        user: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def people_search_read_without_preload_content(
        self,
        user: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _people_search_read_serialize(
        self,
        user,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/people/search/{user}',
