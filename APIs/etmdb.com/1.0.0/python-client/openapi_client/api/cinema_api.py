...
class CinemaApi:
    ...
    def cinema_search_read(
        ...
        _param = self._cinema_search_read_serialize(
            id=id,
    ...
    @validate_call
    def cinema_search_read_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cinema_search_read_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _cinema_search_read_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/cinema/search/{id}',
