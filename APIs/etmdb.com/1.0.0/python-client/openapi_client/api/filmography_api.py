...
class FilmographyApi:
    ...
    def filmography_search_read(
        ...
        _param = self._filmography_search_read_serialize(
    ...
    @validate_call
    def filmography_search_read_with_http_info(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def filmography_search_read_without_preload_content(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _filmography_search_read_serialize(
        self,
        movie_title,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/filmography/search/{movie_title}',
    ...
    @validate_call
    def filmography_searchall_read(
        self,
        param: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._filmography_searchall_read_serialize(
            param=param,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def filmography_searchall_read_with_http_info(
        self,
        param: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def filmography_searchall_read_without_preload_content(
        self,
        param: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _filmography_searchall_read_serialize(
        self,
        param,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/filmography/searchall/{param}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
