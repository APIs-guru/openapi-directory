...
class NewsApi:
    ...
    def news_search_read(
        ...
        _param = self._news_search_read_serialize(
            title=title,
    ...
    @validate_call
    def news_search_read_with_http_info(
        self,
        title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def news_search_read_without_preload_content(
        self,
        title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _news_search_read_serialize(
        self,
        title,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/news/search/{title}',
