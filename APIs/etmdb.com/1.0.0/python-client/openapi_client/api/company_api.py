...
class CompanyApi:
    ...
    def company_search_read(
        ...
        _param = self._company_search_read_serialize(
    ...
    @validate_call
    def company_search_read_with_http_info(
        self,
        company_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def company_search_read_without_preload_content(
        self,
        company_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _company_search_read_serialize(
        self,
        company_name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/company/search/{company_name}',
