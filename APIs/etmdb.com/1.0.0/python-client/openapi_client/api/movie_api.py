...
class MovieApi:
    ...
    def movie_search_read(
        ...
        _param = self._movie_search_read_serialize(
    ...
    @validate_call
    def movie_search_read_with_http_info(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def movie_search_read_without_preload_content(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _movie_search_read_serialize(
        self,
        movie_title,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/movie/search/{movie_title}',
