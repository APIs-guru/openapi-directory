...
class MediaApi:
    ...
    def media_search_read(
        ...
        _param = self._media_search_read_serialize(
    ...
    @validate_call
    def media_search_read_with_http_info(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def media_search_read_without_preload_content(
        self,
        movie_title: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _media_search_read_serialize(
        self,
        movie_title,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/media/search/{movie_title}',
    ...
    def media_searchall_read(
        ...
        _param = self._media_searchall_read_serialize(
            user=user,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def media_searchall_read_with_http_info(
        self,
        user: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def media_searchall_read_without_preload_content(
        self,
        user: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _media_searchall_read_serialize(
        self,
        user,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/media/searchall/{user}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
