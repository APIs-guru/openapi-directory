...
class AQCurrentGroup(BaseModel):
    """
    AQCurrentGroup
    """ # noqa: E501
    ...
    data: Optional[List[AQCurrent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AQCurrent.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "lat": obj.get("lat"),
            "lon": obj.get("lon"),
