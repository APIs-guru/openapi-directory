...
class HistoryDay(BaseModel):
    ...
    data: Optional[List[HistoryDayObj]] = None
    ...
    __properties: ClassVar[List[str]] = ["city_name", "country_code", "data", "lat", "lon", "sources", "state_code", "timezone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [HistoryDayObj.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "lat": obj.get("lat"),
            "lon": obj.get("lon"),
