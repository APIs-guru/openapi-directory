...
class HistoryObj(BaseModel):
    ...
    azimuth: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Azimuth angle (Degrees)")
    ...
    h_angle: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Solar hour angle (Degrees)")
    ...
    __properties: ClassVar[List[str]] = ["app_temp", "azimuth", "clouds", "datetime", "dewpt", "dhi", "dni", "elev_angle", "ghi", "h_angle", "pod", "precip", "pres", "revision_status", "rh", "slp", "snow", "solar_rad", "temp", "timestamp_local", "timestamp_utc", "ts", "uv", "vis", "weather", "wind_dir", "wind_gust_spd", "wind_spd"]
