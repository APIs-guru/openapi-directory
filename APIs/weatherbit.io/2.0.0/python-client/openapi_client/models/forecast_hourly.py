...
class ForecastHourly(BaseModel):
    ...
    data: Optional[List[ForecastHour]] = None
    ...
    __properties: ClassVar[List[str]] = ["city_name", "country_code", "data", "lat", "lon", "state_code", "timezone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ForecastHour.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "lat": obj.get("lat"),
            "lon": obj.get("lon"),
