...
class HistoricalAirQualityApi:
    ...
    @validate_call
    def history_airqualitycity_idcity_id_get(
        self,
        city_id: Annotated[Union[StrictFloat, StrictInt], Field(description="City ID.")],
        ...
        :param city_id: City ID. (required)
        :type city_id: float
        ...
        _param = self._history_airqualitycity_idcity_id_get_serialize(
            city_id=city_id,
            key=key,
    ...
    @validate_call
    def history_airqualitycity_idcity_id_get_with_http_info(
        self,
        city_id: Annotated[Union[StrictFloat, StrictInt], Field(description="City ID.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
        param_callback: Annotated[Optional[StrictStr], Field(description="Wraps return in jsonp callback. Example - callback=func")] = None,
    ...
    @validate_call
    def history_airqualitycity_idcity_id_get_without_preload_content(
        self,
        city_id: Annotated[Union[StrictFloat, StrictInt], Field(description="City ID.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
        param_callback: Annotated[Optional[StrictStr], Field(description="Wraps return in jsonp callback. Example - callback=func")] = None,
    ...
    def _history_airqualitycity_idcity_id_get_serialize(
        self,
        city_id,
        key,
        param_callback,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/airquality?city_id={city_id}',
    ...
    @validate_call
    def history_airqualitycitycitycountrycountry_get(
        self,
        ...
        _param = self._history_airqualitycitycitycountrycountry_get_serialize(
            city=city,
            country=country,
            key=key,
            state=state,
    ...
    @validate_call
    def history_airqualitycitycitycountrycountry_get_with_http_info(
        self,
        city: Annotated[StrictStr, Field(description="City search.. Example - &city=Raleigh,NC or &city=Berlin,DE or city=Paris&country=FR")],
        country: Annotated[StrictStr, Field(description="Country Code (2 letter).")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
    ...
    @validate_call
    def history_airqualitycitycitycountrycountry_get_without_preload_content(
        self,
        city: Annotated[StrictStr, Field(description="City search.. Example - &city=Raleigh,NC or &city=Berlin,DE or city=Paris&country=FR")],
        country: Annotated[StrictStr, Field(description="Country Code (2 letter).")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
    ...
    def _history_airqualitycitycitycountrycountry_get_serialize(
        self,
        city,
        country,
        key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/airquality?city={city}&country={country}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def history_airqualitylatlatlonlon_get(
        self,
        ...
        _param = self._history_airqualitylatlatlonlon_get_serialize(
            lat=lat,
            lon=lon,
            key=key,
            param_callback=param_callback,
    ...
    @validate_call
    def history_airqualitylatlatlonlon_get_with_http_info(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
    ...
    @validate_call
    def history_airqualitylatlatlonlon_get_without_preload_content(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
    ...
    def _history_airqualitylatlatlonlon_get_serialize(
        self,
        lat,
        lon,
        key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/airquality?lat={lat}&lon={lon}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def history_airqualitypostal_codepostal_code_get(
        self,
        ...
        _param = self._history_airqualitypostal_codepostal_code_get_serialize(
    ...
    @validate_call
    def history_airqualitypostal_codepostal_code_get_with_http_info(
        self,
        postal_code: Annotated[StrictInt, Field(description="Postal Code. Example: 28546")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
        country: Annotated[Optional[StrictStr], Field(description="Country Code (2 letter).")] = None,
    ...
    @validate_call
    def history_airqualitypostal_codepostal_code_get_without_preload_content(
        self,
        postal_code: Annotated[StrictInt, Field(description="Postal Code. Example: 28546")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
        country: Annotated[Optional[StrictStr], Field(description="Country Code (2 letter).")] = None,
    ...
    def _history_airqualitypostal_codepostal_code_get_serialize(
        self,
        postal_code,
        key,
        country,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/airquality?postal_code={postal_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
