...
class ForecastDegreeDayAPIApi:
    ...
    @validate_call
    def forecast_energylatlatlonlon_get(
        self,
        ...
        tp: Annotated[Optional[StrictStr], Field(description="Time period (default: daily)")] = None,
        ...
        _param = self._forecast_energylatlatlonlon_get_serialize(
            lat=lat,
            lon=lon,
            key=key,
            threshold=threshold,
    ...
    @validate_call
    def forecast_energylatlatlonlon_get_with_http_info(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EnergyObsGroupForecast]:
        """Returns Energy Forecast API response  - Given a single lat/lon. 
    ...
    @validate_call
    def forecast_energylatlatlonlon_get_without_preload_content(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        key: Annotated[StrictStr, Field(description="Your registered API key.")],
    ...
    def _forecast_energylatlatlonlon_get_serialize(
        self,
        lat,
        lon,
        key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/forecast/energy?lat={lat}&lon={lon}',
