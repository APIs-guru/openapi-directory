...
class DailyHistoricalWeatherDataApi:
    ...
    @validate_call
    def history_dailycity_idcity_id_get(
        self,
        ...
        _param = self._history_dailycity_idcity_id_get_serialize(
            city_id=city_id,
    ...
    @validate_call
    def history_dailycity_idcity_id_get_with_http_info(
        self,
        city_id: Annotated[StrictStr, Field(description="City ID. Example: 4487042")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
    ...
    @validate_call
    def history_dailycity_idcity_id_get_without_preload_content(
        self,
        city_id: Annotated[StrictStr, Field(description="City ID. Example: 4487042")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
    ...
    def _history_dailycity_idcity_id_get_serialize(
        self,
        city_id,
        start_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/daily?city_id={city_id}',
    ...
    @validate_call
    def history_dailycitycitycountrycountry_get(
        self,
        ...
        _param = self._history_dailycitycitycountrycountry_get_serialize(
            city=city,
            country=country,
            start_date=start_date,
            end_date=end_date,
    ...
    @validate_call
    def history_dailycitycitycountrycountry_get_with_http_info(
        self,
        city: Annotated[StrictStr, Field(description="City search.. Example - &city=Raleigh,NC or &city=Berlin,DE or city=Paris&country=FR")],
        country: Annotated[StrictStr, Field(description="Country Code (2 letter).")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    @validate_call
    def history_dailycitycitycountrycountry_get_without_preload_content(
        self,
        city: Annotated[StrictStr, Field(description="City search.. Example - &city=Raleigh,NC or &city=Berlin,DE or city=Paris&country=FR")],
        country: Annotated[StrictStr, Field(description="Country Code (2 letter).")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    def _history_dailycitycitycountrycountry_get_serialize(
        self,
        city,
        country,
        start_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/daily?city={city}&country={country}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def history_dailylatlatlonlon_get(
        self,
        ...
        _param = self._history_dailylatlatlonlon_get_serialize(
            lat=lat,
            lon=lon,
            start_date=start_date,
            end_date=end_date,
    ...
    @validate_call
    def history_dailylatlatlonlon_get_with_http_info(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    @validate_call
    def history_dailylatlatlonlon_get_without_preload_content(
        self,
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude component of location.")],
        lon: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude component of location.")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    def _history_dailylatlatlonlon_get_serialize(
        self,
        lat,
        lon,
        start_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/daily?lat={lat}&lon={lon}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def history_dailypostal_codepostal_code_get(
        self,
        ...
        _param = self._history_dailypostal_codepostal_code_get_serialize(
    ...
    @validate_call
    def history_dailypostal_codepostal_code_get_with_http_info(
        self,
        postal_code: Annotated[StrictStr, Field(description="Postal Code. Example: 28546")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
    ...
    @validate_call
    def history_dailypostal_codepostal_code_get_without_preload_content(
        self,
        postal_code: Annotated[StrictStr, Field(description="Postal Code. Example: 28546")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH)")],
    ...
    def _history_dailypostal_codepostal_code_get_serialize(
        self,
        postal_code,
        start_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/daily?postal_code={postal_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def history_dailystationstation_get(
        self,
        ...
        _param = self._history_dailystationstation_get_serialize(
            station=station,
            start_date=start_date,
            end_date=end_date,
            key=key,
    ...
    @validate_call
    def history_dailystationstation_get_with_http_info(
        self,
        station: Annotated[StrictStr, Field(description="Station ID.")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    @validate_call
    def history_dailystationstation_get_without_preload_content(
        self,
        station: Annotated[StrictStr, Field(description="Station ID.")],
        start_date: Annotated[StrictStr, Field(description="Start Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
        end_date: Annotated[StrictStr, Field(description="End Date (YYYY-MM-DD or YYYY-MM-DD:HH).")],
    ...
    def _history_dailystationstation_get_serialize(
        self,
        station,
        start_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/history/daily?station={station}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
