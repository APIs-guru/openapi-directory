...
class Test240HourHourlyForecastApi(unittest.TestCase):
    """240HourHourlyForecastApi unit test stubs"""

    def setUp(self) -> None:
        self.api = 240HourHourlyForecastApi()

    def tearDown(self) -> None:
        pass

    def test_forecast_hourlycity_idcity_id_get(self) -> None:
    ...
    def test_forecast_hourlycitycitycountrycountry_get(self) -> None:
    ...
    def test_forecast_hourlylatlatlonlon_get(self) -> None:
    ...
    def test_forecast_hourlypostal_codepostal_code_get(self) -> None:
