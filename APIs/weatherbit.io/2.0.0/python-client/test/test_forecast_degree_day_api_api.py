...
class TestForecastDegreeDayAPIApi(unittest.TestCase):
    """ForecastDegreeDayAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ForecastDegreeDayAPIApi()

    def tearDown(self) -> None:
        pass

    def test_forecast_energylatlatlonlon_get(self) -> None:
