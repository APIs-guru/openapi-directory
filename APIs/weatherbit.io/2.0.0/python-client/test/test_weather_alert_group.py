...
class TestWeatherAlertGroup(unittest.TestCase):
    """WeatherAlertGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeatherAlertGroup:
        """Test WeatherAlertGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeatherAlertGroup`
        """
        model = WeatherAlertGroup()
        if include_optional:
            return WeatherAlertGroup(
                alerts = [
                    'St Louis, MO'
                    ],
...
bank begins to flood.',
    ...
    def testWeatherAlertGroup(self):
        """Test WeatherAlertGroup"""
