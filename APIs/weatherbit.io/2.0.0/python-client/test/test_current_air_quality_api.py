...
class TestCurrentAirQualityApi(unittest.TestCase):
    """CurrentAirQualityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CurrentAirQualityApi()

    def tearDown(self) -> None:
        pass

    def test_current_airqualitycity_idcity_id_get(self) -> None:
    ...
    def test_current_airqualitycitycitycountrycountry_get(self) -> None:
    ...
    def test_current_airqualitylatlatlonlon_get(self) -> None:
    ...
    def test_current_airqualitypostal_codepostal_code_get(self) -> None:
