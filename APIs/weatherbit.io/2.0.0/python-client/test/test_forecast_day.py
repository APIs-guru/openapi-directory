...
class TestForecastDay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ForecastDay:
        """Test ForecastDay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForecastDay`
        """
        model = ForecastDay()
        if include_optional:
            return ForecastDay(
                ...
                data = [
                    openapi_client.models.forecast.Forecast(
                        ...
                        uv = 6.5, 
                        vis = 3.0, 
                        weather = openapi_client.models.forecast_weather.Forecast_weather(
                            code = '601', 
                            description = 'Snow', 
                            icon = 's02n', ), 
                        wind_cdir = 'ENE', 
