...
class TestHourlyHistoricalWeatherDataApi(unittest.TestCase):
    """HourlyHistoricalWeatherDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HourlyHistoricalWeatherDataApi()

    def tearDown(self) -> None:
        pass

    def test_history_hourlycity_idcity_id_get(self) -> None:
    ...
    def test_history_hourlycitycitycountrycountry_get(self) -> None:
    ...
    def test_history_hourlylatlatlonlon_get(self) -> None:
    ...
    def test_history_hourlypostal_codepostal_code_get(self) -> None:
    ...
    def test_history_hourlystationstation_get(self) -> None:
