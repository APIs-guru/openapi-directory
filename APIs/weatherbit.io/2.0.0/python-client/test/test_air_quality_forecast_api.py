...
class TestAirQualityForecastApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = AirQualityForecastApi()

    def tearDown(self) -> None:
        pass

    def test_forecast_airqualitycity_idcity_id_get(self) -> None:
    ...
    def test_forecast_airqualitycitycitycountrycountry_get(self) -> None:
    ...
    def test_forecast_airqualitylatlatlonlon_get(self) -> None:
    ...
    def test_forecast_airqualitypostal_codepostal_code_get(self) -> None:
