...
class ControllersAdvisoryInlineItem(BaseModel):
    ...
    applicable_systems: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["advisory_type", "applicable_systems", "cve_count", "description", "id", "public_date", "severity", "synopsis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applicable_systems": obj.get("applicable_systems"),
