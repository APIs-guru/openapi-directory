...
class ControllersPackageSystemItem(BaseModel):
    ...
    """ # noqa: E501
    available_evra: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    installed_evra: Optional[StrictStr] = None
    updatable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["available_evra", "display_name", "id", "installed_evra", "updatable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "available_evra": obj.get("available_evra"),
            "display_name": obj.get("display_name"),
            "id": obj.get("id"),
            "installed_evra": obj.get("installed_evra"),
