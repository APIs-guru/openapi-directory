...
class ControllersSystemAdvisoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[ControllersSystemAdvisoryItem]] = Field(default=None, description="advisories items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ControllersSystemAdvisoryItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
