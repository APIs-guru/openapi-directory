...
class ControllersPackageItem(BaseModel):
    ...
    systems_installed: Optional[StrictInt] = None
    systems_updatable: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "summary", "systems_installed", "systems_updatable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "systems_installed": obj.get("systems_installed"),
            "systems_updatable": obj.get("systems_updatable")
        })
        return _obj
