...
class ControllersSystemAdvisoryItemAttributes(BaseModel):
    ...
    """ # noqa: E501
    advisory_type: Optional[StrictInt] = None
    cve_count: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    public_date: Optional[StrictStr] = None
    severity: Optional[StrictInt] = None
    synopsis: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["advisory_type", "cve_count", "description", "public_date", "severity", "synopsis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "advisory_type": obj.get("advisory_type"),
            "cve_count": obj.get("cve_count"),
