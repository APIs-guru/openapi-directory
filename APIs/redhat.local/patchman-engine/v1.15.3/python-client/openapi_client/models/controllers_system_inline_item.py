...
class ControllersSystemInlineItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created", "culled_timestamp", "display_name", "id", "insights_id", "last_evaluation", "last_upload", "os_major", "os_minor", "os_name", "other_count", "packages_installed", "packages_updatable", "rhba_count", "rhea_count", "rhsa_count", "rhsm", "stale", "stale_timestamp", "stale_warning_timestamp", "third_party"]
