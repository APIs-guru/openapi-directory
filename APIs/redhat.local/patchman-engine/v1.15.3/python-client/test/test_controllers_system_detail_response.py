...
class TestControllersSystemDetailResponse(unittest.TestCase):
    """ControllersSystemDetailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersSystemDetailResponse:
        """Test ControllersSystemDetailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersSystemDetailResponse`
        """
        model = ControllersSystemDetailResponse()
        if include_optional:
            return ControllersSystemDetailResponse(
                data = openapi_client.models.controllers/system_item.controllers.SystemItem(
    ...
    def testControllersSystemDetailResponse(self):
        """Test ControllersSystemDetailResponse"""
