...
class TestControllersAdvisoryItemAttributes(unittest.TestCase):
    """ControllersAdvisoryItemAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersAdvisoryItemAttributes:
        """Test ControllersAdvisoryItemAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersAdvisoryItemAttributes`
        """
        model = ControllersAdvisoryItemAttributes()
        if include_optional:
    ...
    def testControllersAdvisoryItemAttributes(self):
        """Test ControllersAdvisoryItemAttributes"""
