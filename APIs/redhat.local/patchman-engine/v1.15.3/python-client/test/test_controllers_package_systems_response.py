...
class TestControllersPackageSystemsResponse(unittest.TestCase):
    """ControllersPackageSystemsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersPackageSystemsResponse:
        """Test ControllersPackageSystemsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersPackageSystemsResponse`
        """
        model = ControllersPackageSystemsResponse()
        if include_optional:
            return ControllersPackageSystemsResponse(
                data = [
                    openapi_client.models.controllers/package_system_item.controllers.PackageSystemItem(
                        available_evra = '', 
                        display_name = '', 
                        id = '', 
                        installed_evra = '', 
    ...
    def testControllersPackageSystemsResponse(self):
        """Test ControllersPackageSystemsResponse"""
