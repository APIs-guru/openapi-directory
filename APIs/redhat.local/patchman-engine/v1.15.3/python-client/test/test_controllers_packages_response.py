...
class TestControllersPackagesResponse(unittest.TestCase):
    """ControllersPackagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersPackagesResponse:
        """Test ControllersPackagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersPackagesResponse`
        """
        model = ControllersPackagesResponse()
        if include_optional:
            return ControllersPackagesResponse(
                data = [
                    openapi_client.models.controllers/package_item.controllers.PackageItem(
                        name = '', 
                        summary = '', 
                        systems_installed = 56, 
                        systems_updatable = 56, )
                    ],
    ...
    def testControllersPackagesResponse(self):
        """Test ControllersPackagesResponse"""
