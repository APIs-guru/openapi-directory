...
class TestControllersSystemItemAttributes(unittest.TestCase):
    """ControllersSystemItemAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersSystemItemAttributes:
        """Test ControllersSystemItemAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersSystemItemAttributes`
        """
        model = ControllersSystemItemAttributes()
        if include_optional:
    ...
    def testControllersSystemItemAttributes(self):
        """Test ControllersSystemItemAttributes"""
