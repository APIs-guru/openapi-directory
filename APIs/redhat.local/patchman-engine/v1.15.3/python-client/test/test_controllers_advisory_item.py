...
class TestControllersAdvisoryItem(unittest.TestCase):
    """ControllersAdvisoryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersAdvisoryItem:
        """Test ControllersAdvisoryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersAdvisoryItem`
        """
        model = ControllersAdvisoryItem()
        if include_optional:
    ...
    def testControllersAdvisoryItem(self):
        """Test ControllersAdvisoryItem"""
