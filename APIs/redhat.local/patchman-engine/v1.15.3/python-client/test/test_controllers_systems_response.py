...
class TestControllersSystemsResponse(unittest.TestCase):
    """ControllersSystemsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersSystemsResponse:
        """Test ControllersSystemsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersSystemsResponse`
        """
        model = ControllersSystemsResponse()
        if include_optional:
    ...
    def testControllersSystemsResponse(self):
        """Test ControllersSystemsResponse"""
