...
class TestControllersAdvisoryDetailResponse(unittest.TestCase):
    """ControllersAdvisoryDetailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControllersAdvisoryDetailResponse:
        """Test ControllersAdvisoryDetailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControllersAdvisoryDetailResponse`
        """
        model = ControllersAdvisoryDetailResponse()
        if include_optional:
            return ControllersAdvisoryDetailResponse(
                data = openapi_client.models.controllers/advisory_detail_item.controllers.AdvisoryDetailItem(
    ...
    def testControllersAdvisoryDetailResponse(self):
        """Test ControllersAdvisoryDetailResponse"""
