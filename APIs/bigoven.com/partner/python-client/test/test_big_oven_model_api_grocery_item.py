...
class TestBigOvenModelAPIGroceryItem(unittest.TestCase):
    """BigOvenModelAPIGroceryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIGroceryItem:
        """Test BigOvenModelAPIGroceryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIGroceryItem`
        """
        model = BigOvenModelAPIGroceryItem()
        if include_optional:
    ...
    def testBigOvenModelAPIGroceryItem(self):
        """Test BigOvenModelAPIGroceryItem"""
