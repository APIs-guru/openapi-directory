...
class TestBigOvenModelAPIGroceryGroceryList(unittest.TestCase):
    """BigOvenModelAPIGroceryGroceryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIGroceryGroceryList:
        """Test BigOvenModelAPIGroceryGroceryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIGroceryGroceryList`
        """
        model = BigOvenModelAPIGroceryGroceryList()
        if include_optional:
            return BigOvenModelAPIGroceryGroceryList(
                items = [
                    openapi_client.models.big_oven/model/api/grocery/item.BigOven.Model.API.Grocery.Item(
                        big_oven_object = '', 
                ...
                last_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                recipes = [
                    openapi_client.models.big_oven/model/api/recipe_info.BigOven.Model.API.RecipeInfo(
                        bookmark_url = '', 
                        category = '', 
                        creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        cuisine = '', 
    ...
    def testBigOvenModelAPIGroceryGroceryList(self):
        """Test BigOvenModelAPIGroceryGroceryList"""
