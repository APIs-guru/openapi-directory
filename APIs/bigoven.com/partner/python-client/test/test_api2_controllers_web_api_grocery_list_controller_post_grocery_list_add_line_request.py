...
class TestAPI2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest(unittest.TestCase):
    """API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest:
        """Test API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest`
        """
        model = API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest(self):
        """Test API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest"""
