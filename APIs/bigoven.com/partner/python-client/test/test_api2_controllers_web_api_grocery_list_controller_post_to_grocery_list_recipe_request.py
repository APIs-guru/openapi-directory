...
class TestAPI2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest(unittest.TestCase):
    """API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest:
        """Test API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest`
        """
        model = API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest()
        if include_optional:
            return API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest(
                department = '',
                name = '',
                notes = '',
                quantity = '',
    ...
    def testAPI2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest(self):
        """Test API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest"""
