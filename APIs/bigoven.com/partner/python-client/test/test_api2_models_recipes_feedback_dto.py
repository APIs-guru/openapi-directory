...
class TestAPI2ModelsRecipesFeedbackDTO(unittest.TestCase):
    """API2ModelsRecipesFeedbackDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsRecipesFeedbackDTO:
        """Test API2ModelsRecipesFeedbackDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsRecipesFeedbackDTO`
        """
        model = API2ModelsRecipesFeedbackDTO()
        if include_optional:
    ...
    def testAPI2ModelsRecipesFeedbackDTO(self):
        """Test API2ModelsRecipesFeedbackDTO"""
