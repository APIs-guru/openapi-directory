...
class TestAPI2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest(unittest.TestCase):
    """API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest:
        """Test API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest`
        """
        model = API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest(self):
        """Test API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest"""
