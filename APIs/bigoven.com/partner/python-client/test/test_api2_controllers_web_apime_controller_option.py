...
class TestAPI2ControllersWebAPIMeControllerOption(unittest.TestCase):
    """API2ControllersWebAPIMeControllerOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIMeControllerOption:
        """Test API2ControllersWebAPIMeControllerOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIMeControllerOption`
        """
        model = API2ControllersWebAPIMeControllerOption()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIMeControllerOption(self):
        """Test API2ControllersWebAPIMeControllerOption"""
