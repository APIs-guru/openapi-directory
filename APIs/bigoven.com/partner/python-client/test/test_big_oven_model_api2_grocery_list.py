...
class TestBigOvenModelAPI2GroceryList(unittest.TestCase):
    """BigOvenModelAPI2GroceryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2GroceryList:
        """Test BigOvenModelAPI2GroceryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2GroceryList`
        """
        model = BigOvenModelAPI2GroceryList()
        if include_optional:
    ...
    def testBigOvenModelAPI2GroceryList(self):
        """Test BigOvenModelAPI2GroceryList"""
