...
class TestAPI2ControllersWebAPINoteControllerNoteRequest(unittest.TestCase):
    """API2ControllersWebAPINoteControllerNoteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPINoteControllerNoteRequest:
        """Test API2ControllersWebAPINoteControllerNoteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPINoteControllerNoteRequest`
        """
        model = API2ControllersWebAPINoteControllerNoteRequest()
        if include_optional:
            return API2ControllersWebAPINoteControllerNoteRequest(
    ...
    def testAPI2ControllersWebAPINoteControllerNoteRequest(self):
        """Test API2ControllersWebAPINoteControllerNoteRequest"""
