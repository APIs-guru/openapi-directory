...
class TestBigOvenModelAPIRecipeInfo(unittest.TestCase):
    """BigOvenModelAPIRecipeInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIRecipeInfo:
        """Test BigOvenModelAPIRecipeInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIRecipeInfo`
        """
        model = BigOvenModelAPIRecipeInfo()
        if include_optional:
            return BigOvenModelAPIRecipeInfo(
                bookmark_url = '',
                category = '',
    ...
    def testBigOvenModelAPIRecipeInfo(self):
        """Test BigOvenModelAPIRecipeInfo"""
