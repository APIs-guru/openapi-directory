...
class TestBigOvenModelRecipeInfoDateTuple2(unittest.TestCase):
    """BigOvenModelRecipeInfoDateTuple2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelRecipeInfoDateTuple2:
        """Test BigOvenModelRecipeInfoDateTuple2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelRecipeInfoDateTuple2`
        """
        model = BigOvenModelRecipeInfoDateTuple2()
        if include_optional:
            return BigOvenModelRecipeInfoDateTuple2(
                var_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                recipe_info = openapi_client.models.big_oven/model/api2/recipe_infox.BigOven.Model.API2.RecipeInfox(
                    category = '', 
    ...
    def testBigOvenModelRecipeInfoDateTuple2(self):
        """Test BigOvenModelRecipeInfoDateTuple2"""
