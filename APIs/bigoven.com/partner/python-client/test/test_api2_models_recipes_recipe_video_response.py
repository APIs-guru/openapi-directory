...
class TestAPI2ModelsRecipesRecipeVideoResponse(unittest.TestCase):
    """API2ModelsRecipesRecipeVideoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsRecipesRecipeVideoResponse:
        """Test API2ModelsRecipesRecipeVideoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsRecipesRecipeVideoResponse`
        """
        model = API2ModelsRecipesRecipeVideoResponse()
        if include_optional:
            return API2ModelsRecipesRecipeVideoResponse(
                inserted_on = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testAPI2ModelsRecipesRecipeVideoResponse(self):
        """Test API2ModelsRecipesRecipeVideoResponse"""
