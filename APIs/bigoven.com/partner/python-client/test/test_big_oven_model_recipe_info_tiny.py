...
class TestBigOvenModelRecipeInfoTiny(unittest.TestCase):
    """BigOvenModelRecipeInfoTiny unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelRecipeInfoTiny:
        """Test BigOvenModelRecipeInfoTiny
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelRecipeInfoTiny`
        """
        model = BigOvenModelRecipeInfoTiny()
        if include_optional:
            return BigOvenModelRecipeInfoTiny(
                image_url = '',
                quality_score = 56,
                recipe_id = 56,
                servings = 1.337,
    ...
    def testBigOvenModelRecipeInfoTiny(self):
        """Test BigOvenModelRecipeInfoTiny"""
