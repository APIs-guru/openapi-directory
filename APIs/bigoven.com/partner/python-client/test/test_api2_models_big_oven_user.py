...
class TestAPI2ModelsBigOvenUser(unittest.TestCase):
    """API2ModelsBigOvenUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsBigOvenUser:
        """Test API2ModelsBigOvenUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsBigOvenUser`
        """
        model = API2ModelsBigOvenUser()
        if include_optional:
            return API2ModelsBigOvenUser(
                accounting = openapi_client.models.api2/models/accounting.API2.Models.Accounting(
                    credit_balance = 56, 
                ...
                bo_auth_token = '',
                last_change_log_id = '',
                personal = openapi_client.models.api2/models/personal.API2.Models.Personal(
                    email = '', 
                    location = openapi_client.models.api2/models/location.API2.Models.Location(
                        city = '', 
                        country = '', 
                        dma = 56, ), ),
                preferences = openapi_client.models.api2/models/preference.API2.Models.Preference(
                    eating_style = '', ),
                profile = openapi_client.models.api2/models/profile.API2.Models.Profile(
                    about_me = '', 
                    background_url = '', 
                    counts = openapi_client.models.api2/models/counts.API2.Models.Counts(
                        added_count = 56, 
                        followers_count = 56, 
                        following_count = 56, 
                        private_recipe_count = 56, 
                        public_recipe_count = 56, 
                        total_recipes = 56, ), 
                    first_name = '', 
                    full_name = '', 
                    home_url = '', 
    ...
    def testAPI2ModelsBigOvenUser(self):
        """Test API2ModelsBigOvenUser"""
