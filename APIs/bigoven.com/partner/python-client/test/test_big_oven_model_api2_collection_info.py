...
class TestBigOvenModelAPI2CollectionInfo(unittest.TestCase):
    """BigOvenModelAPI2CollectionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2CollectionInfo:
        """Test BigOvenModelAPI2CollectionInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2CollectionInfo`
        """
        model = BigOvenModelAPI2CollectionInfo()
        if include_optional:
            return BigOvenModelAPI2CollectionInfo(
                ...
                photo_url = '',
                results = [
                    openapi_client.models.big_oven/model/api2/recipe_infox.BigOven.Model.API2.RecipeInfox(
                        category = '', 
                        ...
                        microcategory = '', 
                        photo_url = '', 
                        poster = openapi_client.models.big_oven/model/api2/user_info_tinyx.BigOven.Model.API2.UserInfoTinyx(
                            first_name = '', 
                            last_name = '', 
                            photo_url = '', 
                            user_id = 56, 
    ...
    def testBigOvenModelAPI2CollectionInfo(self):
        """Test BigOvenModelAPI2CollectionInfo"""
