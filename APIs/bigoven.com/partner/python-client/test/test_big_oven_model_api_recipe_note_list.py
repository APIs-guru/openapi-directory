...
class TestBigOvenModelAPIRecipeNoteList(unittest.TestCase):
    """BigOvenModelAPIRecipeNoteList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIRecipeNoteList:
        """Test BigOvenModelAPIRecipeNoteList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIRecipeNoteList`
        """
        model = BigOvenModelAPIRecipeNoteList()
        if include_optional:
            return BigOvenModelAPIRecipeNoteList(
                result_count = 56,
                results = [
                    openapi_client.models.big_oven/model/api/recipe_note.BigOven.Model.API.RecipeNote(
    ...
    def testBigOvenModelAPIRecipeNoteList(self):
        """Test BigOvenModelAPIRecipeNoteList"""
