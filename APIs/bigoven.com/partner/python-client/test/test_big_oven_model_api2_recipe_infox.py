...
class TestBigOvenModelAPI2RecipeInfox(unittest.TestCase):
    """BigOvenModelAPI2RecipeInfox unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2RecipeInfox:
        """Test BigOvenModelAPI2RecipeInfox
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2RecipeInfox`
        """
        model = BigOvenModelAPI2RecipeInfox()
        if include_optional:
    ...
    def testBigOvenModelAPI2RecipeInfox(self):
        """Test BigOvenModelAPI2RecipeInfox"""
