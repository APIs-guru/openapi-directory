...
class TestBigOvenModelAPIIngredientInfo(unittest.TestCase):
    """BigOvenModelAPIIngredientInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIIngredientInfo:
        """Test BigOvenModelAPIIngredientInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIIngredientInfo`
        """
        model = BigOvenModelAPIIngredientInfo()
        if include_optional:
    ...
    def testBigOvenModelAPIIngredientInfo(self):
        """Test BigOvenModelAPIIngredientInfo"""
