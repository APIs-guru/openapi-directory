...
class TestBigOvenResult(unittest.TestCase):
    """BigOvenResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenResult:
        """Test BigOvenResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenResult`
        """
        model = BigOvenResult()
        if include_optional:
