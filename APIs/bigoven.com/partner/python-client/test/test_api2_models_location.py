...
class TestAPI2ModelsLocation(unittest.TestCase):
    """API2ModelsLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsLocation:
        """Test API2ModelsLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsLocation`
        """
        model = API2ModelsLocation()
        if include_optional:
    ...
    def testAPI2ModelsLocation(self):
        """Test API2ModelsLocation"""
