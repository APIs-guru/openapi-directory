...
class TestBigOvenModelInstructionStep(unittest.TestCase):
    """BigOvenModelInstructionStep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelInstructionStep:
        """Test BigOvenModelInstructionStep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelInstructionStep`
        """
        model = BigOvenModelInstructionStep()
        if include_optional:
    ...
    def testBigOvenModelInstructionStep(self):
        """Test BigOvenModelInstructionStep"""
