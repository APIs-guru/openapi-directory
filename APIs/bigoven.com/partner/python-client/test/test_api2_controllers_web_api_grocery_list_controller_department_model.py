...
class TestAPI2ControllersWebAPIGroceryListControllerDepartmentModel(unittest.TestCase):
    """API2ControllersWebAPIGroceryListControllerDepartmentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIGroceryListControllerDepartmentModel:
        """Test API2ControllersWebAPIGroceryListControllerDepartmentModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIGroceryListControllerDepartmentModel`
        """
        model = API2ControllersWebAPIGroceryListControllerDepartmentModel()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIGroceryListControllerDepartmentModel(self):
        """Test API2ControllersWebAPIGroceryListControllerDepartmentModel"""
