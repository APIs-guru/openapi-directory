...
class TestBigOvenModelAPIReply(unittest.TestCase):
    """BigOvenModelAPIReply unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIReply:
        """Test BigOvenModelAPIReply
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIReply`
        """
        model = BigOvenModelAPIReply()
        if include_optional:
    ...
    def testBigOvenModelAPIReply(self):
        """Test BigOvenModelAPIReply"""
