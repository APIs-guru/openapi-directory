...
class TestBigOvenModelAPIIngredient(unittest.TestCase):
    """BigOvenModelAPIIngredient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIIngredient:
        """Test BigOvenModelAPIIngredient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIIngredient`
        """
        model = BigOvenModelAPIIngredient()
        if include_optional:
    ...
    def testBigOvenModelAPIIngredient(self):
        """Test BigOvenModelAPIIngredient"""
