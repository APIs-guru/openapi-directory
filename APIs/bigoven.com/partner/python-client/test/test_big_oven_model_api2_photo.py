...
class TestBigOvenModelAPI2Photo(unittest.TestCase):
    """BigOvenModelAPI2Photo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2Photo:
        """Test BigOvenModelAPI2Photo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2Photo`
        """
        model = BigOvenModelAPI2Photo()
        if include_optional:
    ...
    def testBigOvenModelAPI2Photo(self):
        """Test BigOvenModelAPI2Photo"""
