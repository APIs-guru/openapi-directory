...
class TestAPI2ModelsPreference(unittest.TestCase):
    """API2ModelsPreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsPreference:
        """Test API2ModelsPreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsPreference`
        """
        model = API2ModelsPreference()
        if include_optional:
    ...
    def testAPI2ModelsPreference(self):
        """Test API2ModelsPreference"""
