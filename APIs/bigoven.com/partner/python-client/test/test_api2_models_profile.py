...
class TestAPI2ModelsProfile(unittest.TestCase):
    """API2ModelsProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsProfile:
        """Test API2ModelsProfile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsProfile`
        """
        model = API2ModelsProfile()
        if include_optional:
    ...
    def testAPI2ModelsProfile(self):
        """Test API2ModelsProfile"""
