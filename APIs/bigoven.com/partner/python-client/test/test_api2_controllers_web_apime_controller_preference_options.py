...
class TestAPI2ControllersWebAPIMeControllerPreferenceOptions(unittest.TestCase):
    """API2ControllersWebAPIMeControllerPreferenceOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIMeControllerPreferenceOptions:
        """Test API2ControllersWebAPIMeControllerPreferenceOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIMeControllerPreferenceOptions`
        """
        model = API2ControllersWebAPIMeControllerPreferenceOptions()
        if include_optional:
            return API2ControllersWebAPIMeControllerPreferenceOptions(
                eating_style = openapi_client.models.api2/controllers/web_api/me_controller/eating_style.API2.Controllers.WebAPI.MeController.EatingStyle(
                    options = [
                        openapi_client.models.api2/controllers/web_api/me_controller/option.API2.Controllers.WebAPI.MeController.Option(
                            description = '', 
                            key = '', )
                        ], )
            )
    ...
    def testAPI2ControllersWebAPIMeControllerPreferenceOptions(self):
        """Test API2ControllersWebAPIMeControllerPreferenceOptions"""
