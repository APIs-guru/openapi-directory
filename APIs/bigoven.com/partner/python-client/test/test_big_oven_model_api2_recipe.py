...
class TestBigOvenModelAPI2Recipe(unittest.TestCase):
    """BigOvenModelAPI2Recipe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2Recipe:
        """Test BigOvenModelAPI2Recipe
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2Recipe`
        """
        model = BigOvenModelAPI2Recipe()
        if include_optional:
            return BigOvenModelAPI2Recipe(
                ...
                star_rating = 1.337,
                steps = [
                    openapi_client.models.big_oven/model/instruction_step.BigOven.Model.InstructionStep(
                        end_gantt = 56, 
                        start_gantt = 56, 
                        text = '', )
                    ],
    ...
    def testBigOvenModelAPI2Recipe(self):
        """Test BigOvenModelAPI2Recipe"""
