...
class TestBigOvenModelAPI2RecipeNote(unittest.TestCase):
    """BigOvenModelAPI2RecipeNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2RecipeNote:
        """Test BigOvenModelAPI2RecipeNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2RecipeNote`
        """
        model = BigOvenModelAPI2RecipeNote()
        if include_optional:
            return BigOvenModelAPI2RecipeNote(
                creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                var_date = '',
                date_dt = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                guid = '',
                id = 56,
                notes = '',
                people = '',
    ...
    def testBigOvenModelAPI2RecipeNote(self):
        """Test BigOvenModelAPI2RecipeNote"""
