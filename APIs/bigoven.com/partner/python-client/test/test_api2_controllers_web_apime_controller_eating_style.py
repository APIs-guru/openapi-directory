...
class TestAPI2ControllersWebAPIMeControllerEatingStyle(unittest.TestCase):
    """API2ControllersWebAPIMeControllerEatingStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIMeControllerEatingStyle:
        """Test API2ControllersWebAPIMeControllerEatingStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIMeControllerEatingStyle`
        """
        model = API2ControllersWebAPIMeControllerEatingStyle()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIMeControllerEatingStyle(self):
        """Test API2ControllersWebAPIMeControllerEatingStyle"""
