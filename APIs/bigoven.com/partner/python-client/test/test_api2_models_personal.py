...
class TestAPI2ModelsPersonal(unittest.TestCase):
    """API2ModelsPersonal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsPersonal:
        """Test API2ModelsPersonal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsPersonal`
        """
        model = API2ModelsPersonal()
        if include_optional:
            return API2ModelsPersonal(
                email = '',
    ...
    def testAPI2ModelsPersonal(self):
        """Test API2ModelsPersonal"""
