...
class TestBigOvenModelAPI2UserInfoTinyx(unittest.TestCase):
    """BigOvenModelAPI2UserInfoTinyx unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2UserInfoTinyx:
        """Test BigOvenModelAPI2UserInfoTinyx
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2UserInfoTinyx`
        """
        model = BigOvenModelAPI2UserInfoTinyx()
        if include_optional:
    ...
    def testBigOvenModelAPI2UserInfoTinyx(self):
        """Test BigOvenModelAPI2UserInfoTinyx"""
