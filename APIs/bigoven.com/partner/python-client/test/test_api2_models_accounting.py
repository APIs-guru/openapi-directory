...
class TestAPI2ModelsAccounting(unittest.TestCase):
    """API2ModelsAccounting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsAccounting:
        """Test API2ModelsAccounting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsAccounting`
        """
        model = API2ModelsAccounting()
        if include_optional:
    ...
    def testAPI2ModelsAccounting(self):
        """Test API2ModelsAccounting"""
