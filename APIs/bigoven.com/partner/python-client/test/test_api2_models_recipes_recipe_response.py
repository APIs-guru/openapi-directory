...
class TestAPI2ModelsRecipesRecipeResponse(unittest.TestCase):
    """API2ModelsRecipesRecipeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsRecipesRecipeResponse:
        """Test API2ModelsRecipesRecipeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsRecipesRecipeResponse`
        """
        model = API2ModelsRecipesRecipeResponse()
        if include_optional:
            return API2ModelsRecipesRecipeResponse(
                ...
                videos = [
                    openapi_client.models.api2/models/recipes/recipe_video_response.API2.Models.Recipes.RecipeVideoResponse(
    ...
    def testAPI2ModelsRecipesRecipeResponse(self):
        """Test API2ModelsRecipesRecipeResponse"""
