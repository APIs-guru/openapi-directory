...
class TestAPI2GroceryListDepartmentResult(unittest.TestCase):
    """API2GroceryListDepartmentResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2GroceryListDepartmentResult:
        """Test API2GroceryListDepartmentResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2GroceryListDepartmentResult`
        """
        model = API2GroceryListDepartmentResult()
        if include_optional:
    ...
    def testAPI2GroceryListDepartmentResult(self):
        """Test API2GroceryListDepartmentResult"""
