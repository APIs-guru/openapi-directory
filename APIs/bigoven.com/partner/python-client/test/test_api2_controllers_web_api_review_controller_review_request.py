...
class TestAPI2ControllersWebAPIReviewControllerReviewRequest(unittest.TestCase):
    """API2ControllersWebAPIReviewControllerReviewRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIReviewControllerReviewRequest:
        """Test API2ControllersWebAPIReviewControllerReviewRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIReviewControllerReviewRequest`
        """
        model = API2ControllersWebAPIReviewControllerReviewRequest()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIReviewControllerReviewRequest(self):
        """Test API2ControllersWebAPIReviewControllerReviewRequest"""
