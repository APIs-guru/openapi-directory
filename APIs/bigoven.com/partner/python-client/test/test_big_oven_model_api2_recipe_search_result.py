...
class TestBigOvenModelAPI2RecipeSearchResult(unittest.TestCase):
    """BigOvenModelAPI2RecipeSearchResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPI2RecipeSearchResult:
        """Test BigOvenModelAPI2RecipeSearchResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPI2RecipeSearchResult`
        """
        model = BigOvenModelAPI2RecipeSearchResult()
        if include_optional:
    ...
    def testBigOvenModelAPI2RecipeSearchResult(self):
        """Test BigOvenModelAPI2RecipeSearchResult"""
