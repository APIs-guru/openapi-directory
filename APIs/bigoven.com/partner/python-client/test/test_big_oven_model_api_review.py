...
class TestBigOvenModelAPIReview(unittest.TestCase):
    """BigOvenModelAPIReview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIReview:
        """Test BigOvenModelAPIReview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIReview`
        """
        model = BigOvenModelAPIReview()
        if include_optional:
            return BigOvenModelAPIReview(
                active_minutes = 56,
                comment = '',
                creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                featured_reply = openapi_client.models.big_oven/model/api/reply.BigOven.Model.API.Reply(
                    comment = '', 
                    creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    id = '', 
                    last_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    poster = openapi_client.models.big_oven/model/api/user_info_tiny.BigOven.Model.API.UserInfoTiny(
                        first_name = '', 
                        last_name = '', 
                        photo_url = '', 
                        user_id = 56, 
                ...
                poster = openapi_client.models.big_oven/model/api/user_info.BigOven.Model.API.UserInfo(
                    ...
                    web_url = '', ),
                replies = [
                    openapi_client.models.big_oven/model/api/review.BigOven.Model.API.Review(
                        active_minutes = 56, 
                        comment = '', 
                        creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        featured_reply = openapi_client.models.big_oven/model/api/reply.BigOven.Model.API.Reply(
    ...
    def testBigOvenModelAPIReview(self):
        """Test BigOvenModelAPIReview"""
