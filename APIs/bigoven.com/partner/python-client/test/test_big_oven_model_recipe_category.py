...
class TestBigOvenModelRecipeCategory(unittest.TestCase):
    """BigOvenModelRecipeCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelRecipeCategory:
        """Test BigOvenModelRecipeCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelRecipeCategory`
        """
        model = BigOvenModelRecipeCategory()
        if include_optional:
            return BigOvenModelRecipeCategory(
                category = '',
                default_active_minutes = 56,
                default_total_minutes = 56,
                id = 56,
                parent_id = 56,
                primary_image = '',
                short_description = ''
    ...
    def testBigOvenModelRecipeCategory(self):
        """Test BigOvenModelRecipeCategory"""
