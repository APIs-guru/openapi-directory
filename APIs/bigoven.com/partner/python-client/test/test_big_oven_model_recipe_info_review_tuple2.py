...
class TestBigOvenModelRecipeInfoReviewTuple2(unittest.TestCase):
    """BigOvenModelRecipeInfoReviewTuple2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelRecipeInfoReviewTuple2:
        """Test BigOvenModelRecipeInfoReviewTuple2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelRecipeInfoReviewTuple2`
        """
        model = BigOvenModelRecipeInfoReviewTuple2()
        if include_optional:
            return BigOvenModelRecipeInfoReviewTuple2(
                recipe_info = openapi_client.models.big_oven/model/api2/recipe_infox.BigOven.Model.API2.RecipeInfox(
                    ...
                    total_tries = 56, 
                    web_url = '', ),
                review = openapi_client.models.big_oven/model/api/review.BigOven.Model.API.Review(
                    active_minutes = 56, 
                    comment = '', 
                    creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
    ...
    def testBigOvenModelRecipeInfoReviewTuple2(self):
        """Test BigOvenModelRecipeInfoReviewTuple2"""
