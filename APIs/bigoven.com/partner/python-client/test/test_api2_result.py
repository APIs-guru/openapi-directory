...
class TestAPI2Result(unittest.TestCase):
    """API2Result unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2Result:
        """Test API2Result
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2Result`
        """
        model = API2Result()
        if include_optional:
            return API2Result(
