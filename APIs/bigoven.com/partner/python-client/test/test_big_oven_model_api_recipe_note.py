...
class TestBigOvenModelAPIRecipeNote(unittest.TestCase):
    """BigOvenModelAPIRecipeNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIRecipeNote:
        """Test BigOvenModelAPIRecipeNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIRecipeNote`
        """
        model = BigOvenModelAPIRecipeNote()
        if include_optional:
    ...
    def testBigOvenModelAPIRecipeNote(self):
        """Test BigOvenModelAPIRecipeNote"""
