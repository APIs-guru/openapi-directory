...
class TestMeApi(unittest.TestCase):
    ...
    def test_me_get_options(self) -> None:
    ...
    def test_me_profile_put(self) -> None:
    ...
    def test_me_put_me_personal(self) -> None:
    ...
    def test_me_put_me_preferences(self) -> None:
