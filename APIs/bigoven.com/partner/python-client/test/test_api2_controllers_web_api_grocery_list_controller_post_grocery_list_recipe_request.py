...
class TestAPI2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest(unittest.TestCase):
    """API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest:
        """Test API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest`
        """
        model = API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest()
        if include_optional:
            return API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest(
                mark_as_pending = True,
                recipe_id = 56,
                scale = 1.337
            )
        else:
    ...
    def testAPI2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest(self):
        """Test API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest"""
