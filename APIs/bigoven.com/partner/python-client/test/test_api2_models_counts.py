...
class TestAPI2ModelsCounts(unittest.TestCase):
    """API2ModelsCounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ModelsCounts:
        """Test API2ModelsCounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ModelsCounts`
        """
        model = API2ModelsCounts()
        if include_optional:
