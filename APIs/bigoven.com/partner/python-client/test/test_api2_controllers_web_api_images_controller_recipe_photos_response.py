...
class TestAPI2ControllersWebAPIImagesControllerRecipePhotosResponse(unittest.TestCase):
    """API2ControllersWebAPIImagesControllerRecipePhotosResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIImagesControllerRecipePhotosResponse:
        """Test API2ControllersWebAPIImagesControllerRecipePhotosResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIImagesControllerRecipePhotosResponse`
        """
        model = API2ControllersWebAPIImagesControllerRecipePhotosResponse()
        if include_optional:
            return API2ControllersWebAPIImagesControllerRecipePhotosResponse(
                result_count = 56,
                results = [
                    openapi_client.models.big_oven/model/api2/photo.BigOven.Model.API2.Photo(
                        caption = '', 
                        creation_date = '', 
                        image_id = 56, 
                        is_primary = True, 
    ...
    def testAPI2ControllersWebAPIImagesControllerRecipePhotosResponse(self):
        """Test API2ControllersWebAPIImagesControllerRecipePhotosResponse"""
