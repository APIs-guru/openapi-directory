...
class TestAPI2ControllersWebAPIReviewControllerReviewRequestLegacy(unittest.TestCase):
    """API2ControllersWebAPIReviewControllerReviewRequestLegacy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> API2ControllersWebAPIReviewControllerReviewRequestLegacy:
        """Test API2ControllersWebAPIReviewControllerReviewRequestLegacy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `API2ControllersWebAPIReviewControllerReviewRequestLegacy`
        """
        model = API2ControllersWebAPIReviewControllerReviewRequestLegacy()
        if include_optional:
    ...
    def testAPI2ControllersWebAPIReviewControllerReviewRequestLegacy(self):
        """Test API2ControllersWebAPIReviewControllerReviewRequestLegacy"""
