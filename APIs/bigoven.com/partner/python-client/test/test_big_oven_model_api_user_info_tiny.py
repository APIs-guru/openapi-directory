...
class TestBigOvenModelAPIUserInfoTiny(unittest.TestCase):
    """BigOvenModelAPIUserInfoTiny unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIUserInfoTiny:
        """Test BigOvenModelAPIUserInfoTiny
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIUserInfoTiny`
        """
        model = BigOvenModelAPIUserInfoTiny()
        if include_optional:
    ...
    def testBigOvenModelAPIUserInfoTiny(self):
        """Test BigOvenModelAPIUserInfoTiny"""
