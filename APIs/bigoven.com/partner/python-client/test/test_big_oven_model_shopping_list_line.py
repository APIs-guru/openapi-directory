...
class TestBigOvenModelShoppingListLine(unittest.TestCase):
    """BigOvenModelShoppingListLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelShoppingListLine:
        """Test BigOvenModelShoppingListLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelShoppingListLine`
        """
        model = BigOvenModelShoppingListLine()
        if include_optional:
            return BigOvenModelShoppingListLine(
                ...
                list_id = 56,
                meal_plan_id = 56,
                meal_plan_object_type = 56,
                notes = '',
                pending_addition = True,
                recipe_id = 56,
                shopping_list_line_id = 56,
                store = '',
                text_amt = '',
                third_party_host = '',
                third_party_title = '',
    ...
    def testBigOvenModelShoppingListLine(self):
        """Test BigOvenModelShoppingListLine"""
