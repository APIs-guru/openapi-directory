...
class TestBigOvenModelAPIUserInfo(unittest.TestCase):
    """BigOvenModelAPIUserInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BigOvenModelAPIUserInfo:
        """Test BigOvenModelAPIUserInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BigOvenModelAPIUserInfo`
        """
        model = BigOvenModelAPIUserInfo()
        if include_optional:
    ...
    def testBigOvenModelAPIUserInfo(self):
        """Test BigOvenModelAPIUserInfo"""
