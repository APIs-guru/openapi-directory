...
class API2ModelsRecipesRecipeVideoResponse(BaseModel):
    ...
    """ # noqa: E501
    inserted_on: Optional[datetime] = Field(default=None, description="Gets or sets the date the video was added.", alias="InsertedOn")
    is_primary_video: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the video is the primary video of the recipe.", alias="IsPrimaryVideo")
    media_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the JWPlayer media id.", alias="MediaId")
    vid_id: Optional[StrictInt] = Field(default=None, description="Gets or sets the video id.", alias="VidId")
    __properties: ClassVar[List[str]] = ["InsertedOn", "IsPrimaryVideo", "MediaId", "VidId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InsertedOn": obj.get("InsertedOn"),
            "IsPrimaryVideo": obj.get("IsPrimaryVideo"),
