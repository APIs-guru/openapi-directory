...
class API2ModelsRecipesRecipeResponse(BaseModel):
    ...
    videos: Optional[List[API2ModelsRecipesRecipeVideoResponse]] = Field(default=None, description="Gets or sets the recipe videos, i.e. a list of type {API2.Models.Recipes.RecipeVideoResponse}", alias="Videos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Videos": [API2ModelsRecipesRecipeVideoResponse.from_dict(_item) for _item in obj["Videos"]] if obj.get("Videos") is not None else None,
