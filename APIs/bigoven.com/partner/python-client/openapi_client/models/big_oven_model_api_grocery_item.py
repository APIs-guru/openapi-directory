...
class BigOvenModelAPIGroceryItem(BaseModel):
    ...
    """ # noqa: E501
    big_oven_object: Optional[StrictStr] = Field(default=None, alias="BigOvenObject")
    ...
    local_status: Optional[StrictStr] = Field(default=None, alias="LocalStatus")
    ...
    __properties: ClassVar[List[str]] = ["BigOvenObject", "CreationDate", "Department", "DisplayQuantity", "GUID", "IsChecked", "ItemID", "LastModified", "LocalStatus", "Name", "Notes", "RecipeID", "ThirdPartyURL"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BigOvenObject": obj.get("BigOvenObject"),
            ...
            "LocalStatus": obj.get("LocalStatus"),
            "Name": obj.get("Name"),
            "Notes": obj.get("Notes"),
