...
class BigOvenModelAPIGroceryGroceryList(BaseModel):
    ...
    recipes: Optional[List[BigOvenModelAPIRecipeInfo]] = Field(default=None, alias="Recipes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Recipes": [BigOvenModelAPIRecipeInfo.from_dict(_item) for _item in obj["Recipes"]] if obj.get("Recipes") is not None else None,
