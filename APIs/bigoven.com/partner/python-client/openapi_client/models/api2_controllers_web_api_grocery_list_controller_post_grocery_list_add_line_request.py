...
class API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest(BaseModel):
    """
    
    """ # noqa: E501
    text: Optional[StrictStr] = Field(default=None, description="Gets or sets the text.")
