...
class API2ControllersWebAPIImagesControllerRecipePhotosResponse(BaseModel):
    ...
    """ # noqa: E501
    result_count: Optional[StrictInt] = Field(default=None, description="Gets or sets the result count.", alias="ResultCount")
    results: Optional[List[BigOvenModelAPI2Photo]] = Field(default=None, description="Gets or sets the results.", alias="Results")
    __properties: ClassVar[List[str]] = ["ResultCount", "Results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Results": [BigOvenModelAPI2Photo.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None
        })
        return _obj
