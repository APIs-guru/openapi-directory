...
class API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest(BaseModel):
    ...
    """ # noqa: E501
    mark_as_pending: Optional[StrictBool] = Field(default=None, description="Gets or sets the mark as pending.", alias="markAsPending")
    recipe_id: Optional[StrictInt] = Field(default=None, description="Gets or sets the recipe identifier.", alias="recipeId")
    scale: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the scale.")
    __properties: ClassVar[List[str]] = ["markAsPending", "recipeId", "scale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "markAsPending": obj.get("markAsPending"),
