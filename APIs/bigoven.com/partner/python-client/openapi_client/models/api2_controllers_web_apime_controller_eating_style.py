...
class API2ControllersWebAPIMeControllerEatingStyle(BaseModel):
    ...
    """ # noqa: E501
    options: Optional[List[API2ControllersWebAPIMeControllerOption]] = Field(default=None, description="Gets or sets the options.", alias="Options")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of API2ControllersWebAPIMeControllerEatingStyle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of API2ControllersWebAPIMeControllerEatingStyle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Options": [API2ControllersWebAPIMeControllerOption.from_dict(_item) for _item in obj["Options"]] if obj.get("Options") is not None else None
        })
        return _obj
