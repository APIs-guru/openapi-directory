...
class API2ModelsProfile(BaseModel):
    ...
    """ # noqa: E501
    about_me: Optional[StrictStr] = Field(default=None, alias="AboutMe")
    background_url: Optional[StrictStr] = Field(default=None, alias="BackgroundUrl")
    counts: Optional[API2ModelsCounts] = Field(default=None, alias="Counts")
    ...
    __properties: ClassVar[List[str]] = ["AboutMe", "BackgroundUrl", "Counts", "FirstName", "FullName", "HomeUrl", "LastName", "PhotoUrl", "UserID", "UserName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Counts": API2ModelsCounts.from_dict(obj["Counts"]) if obj.get("Counts") is not None else None,
