...
class BigOvenModelAPI2GroceryList(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[BigOvenModelAPIGroceryItem]] = Field(default=None, alias="Items")
    last_modified: Optional[datetime] = Field(default=None, alias="LastModified")
    recipes: Optional[List[BigOvenModelAPI2RecipeInfox]] = Field(default=None, alias="Recipes")
    version_guid: Optional[StrictStr] = Field(default=None, alias="VersionGuid")
    __properties: ClassVar[List[str]] = ["Items", "LastModified", "Recipes", "VersionGuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [BigOvenModelAPIGroceryItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "LastModified": obj.get("LastModified"),
            "Recipes": [BigOvenModelAPI2RecipeInfox.from_dict(_item) for _item in obj["Recipes"]] if obj.get("Recipes") is not None else None,
            "VersionGuid": obj.get("VersionGuid")
        })
        return _obj
