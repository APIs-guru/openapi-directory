...
class BigOvenModelAPIIngredientInfo(BaseModel):
    ...
    master_ingredient_id: Optional[StrictInt] = Field(default=None, alias="MasterIngredientID")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    usually_on_hand: Optional[StrictBool] = Field(default=None, alias="UsuallyOnHand")
    __properties: ClassVar[List[str]] = ["Department", "MasterIngredientID", "Name", "UsuallyOnHand"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MasterIngredientID": obj.get("MasterIngredientID"),
            "Name": obj.get("Name"),
            "UsuallyOnHand": obj.get("UsuallyOnHand")
        })
        return _obj
