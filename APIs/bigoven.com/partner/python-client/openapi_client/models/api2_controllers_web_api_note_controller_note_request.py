...
class API2ControllersWebAPINoteControllerNoteRequest(BaseModel):
    ...
    """ # noqa: E501
    creation_date: Optional[datetime] = Field(default=None, description="Gets or sets the creation date.", alias="CreationDate")
    var_date: Optional[datetime] = Field(default=None, description="Gets or sets the date.", alias="Date")
    date_dt: Optional[StrictStr] = Field(default=None, description="Gets or sets the date dt.", alias="DateDT")
    guid: Optional[StrictStr] = Field(default=None, description="Gets or sets the unique identifier.", alias="GUID")
    id: Optional[StrictInt] = Field(default=None, description="Gets or sets the identifier.", alias="ID")
    notes: Optional[StrictStr] = Field(default=None, description="Gets or sets the notes.", alias="Notes")
    people: Optional[StrictStr] = Field(default=None, description="Gets or sets the people.", alias="People")
    recipe_id: Optional[StrictInt] = Field(default=None, description="Gets or sets the recipe identifier.", alias="RecipeID")
    user_id: Optional[StrictInt] = Field(default=None, description="Gets or sets the user identifier.", alias="UserID")
    variations: Optional[StrictStr] = Field(default=None, description="Gets or sets the variations.", alias="Variations")
