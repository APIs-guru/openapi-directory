...
class BigOvenModelAPIReview(BaseModel):
    ...
    featured_reply: Optional[BigOvenModelAPIReply] = Field(default=None, alias="FeaturedReply")
    ...
    replies: Optional[List[BigOvenModelAPIReview]] = Field(default=None, alias="Replies")
    reply_count: Optional[StrictInt] = Field(default=None, alias="ReplyCount")
    review_id: Optional[StrictInt] = Field(default=None, alias="ReviewID")
    ...
    __properties: ClassVar[List[str]] = ["ActiveMinutes", "Comment", "CreationDate", "FeaturedReply", "GUID", "ID", "LastModified", "ParentID", "Poster", "Replies", "ReplyCount", "ReviewID", "StarRating", "TotalMinutes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of featured_reply
        if self.featured_reply:
            _dict['FeaturedReply'] = self.featured_reply.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "FeaturedReply": BigOvenModelAPIReply.from_dict(obj["FeaturedReply"]) if obj.get("FeaturedReply") is not None else None,
            "GUID": obj.get("GUID"),
            "ID": obj.get("ID"),
            "LastModified": obj.get("LastModified"),
            "ParentID": obj.get("ParentID"),
            "Poster": BigOvenModelAPIUserInfo.from_dict(obj["Poster"]) if obj.get("Poster") is not None else None,
            "Replies": [BigOvenModelAPIReview.from_dict(_item) for _item in obj["Replies"]] if obj.get("Replies") is not None else None,
...
BigOvenModelAPIReview.model_rebuild(raise_errors=False)
