...
class API2ModelsPersonal(BaseModel):
    ...
    location: Optional[API2ModelsLocation] = Field(default=None, alias="Location")
    __properties: ClassVar[List[str]] = ["Email", "Location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Email": obj.get("Email"),
            "Location": API2ModelsLocation.from_dict(obj["Location"]) if obj.get("Location") is not None else None
        })
        return _obj
