...
class API2ModelsAccounting(BaseModel):
    ...
    """ # noqa: E501
    credit_balance: Optional[StrictInt] = Field(default=None, alias="CreditBalance")
    member_since: Optional[datetime] = Field(default=None, alias="MemberSince")
    premium_expiry_date: Optional[datetime] = Field(default=None, alias="PremiumExpiryDate")
    user_level: Optional[StrictStr] = Field(default=None, alias="UserLevel")
    __properties: ClassVar[List[str]] = ["CreditBalance", "MemberSince", "PremiumExpiryDate", "UserLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PremiumExpiryDate": obj.get("PremiumExpiryDate"),
