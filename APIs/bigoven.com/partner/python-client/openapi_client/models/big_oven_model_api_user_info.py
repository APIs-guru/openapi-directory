...
class BigOvenModelAPIUserInfo(BaseModel):
    ...
    is_kitchen_helper: Optional[StrictBool] = Field(default=None, alias="IsKitchenHelper")
    is_premium: Optional[StrictBool] = Field(default=None, alias="IsPremium")
    is_using_recurly: Optional[StrictBool] = Field(default=None, alias="IsUsingRecurly")
    ...
    photo_url48: Optional[StrictStr] = Field(default=None, alias="PhotoUrl48")
    ...
    __properties: ClassVar[List[str]] = ["FirstName", "ImageUrl48", "IsKitchenHelper", "IsPremium", "IsUsingRecurly", "LastName", "MemberSince", "PhotoUrl", "PhotoUrl48", "PremiumExpiryDate", "UserID", "UserName", "WebUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IsKitchenHelper": obj.get("IsKitchenHelper"),
            "IsPremium": obj.get("IsPremium"),
            "IsUsingRecurly": obj.get("IsUsingRecurly"),
            "LastName": obj.get("LastName"),
            "MemberSince": obj.get("MemberSince"),
            "PhotoUrl": obj.get("PhotoUrl"),
            "PhotoUrl48": obj.get("PhotoUrl48"),
