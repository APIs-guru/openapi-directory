...
class API2ControllersWebAPIReviewControllerReviewRequestLegacy(BaseModel):
    ...
    make_again: Optional[StrictStr] = Field(default=None, alias="MakeAgain")
    parent_id: Optional[StrictInt] = Field(default=None, alias="ParentID")
    star_rating: Optional[StrictInt] = Field(default=None, alias="StarRating")
    total_minutes: Optional[StrictInt] = Field(default=None, alias="TotalMinutes")
    __properties: ClassVar[List[str]] = ["ActiveMinutes", "Comment", "GUID", "MakeAgain", "ParentID", "StarRating", "TotalMinutes"]
