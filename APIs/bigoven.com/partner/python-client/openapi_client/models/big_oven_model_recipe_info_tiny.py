...
class BigOvenModelRecipeInfoTiny(BaseModel):
    ...
    quality_score: Optional[StrictInt] = Field(default=None, alias="QualityScore")
    recipe_id: Optional[StrictInt] = Field(default=None, alias="RecipeID")
    servings: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Servings")
    title: Optional[StrictStr] = Field(default=None, alias="Title")
    __properties: ClassVar[List[str]] = ["ImageURL", "QualityScore", "RecipeID", "Servings", "Title"]
