...
class BigOvenModelAPIIngredient(BaseModel):
    ...
    """ # noqa: E501
    display_index: Optional[StrictInt] = Field(default=None, alias="DisplayIndex")
    display_quantity: Optional[StrictStr] = Field(default=None, alias="DisplayQuantity")
    html_name: Optional[StrictStr] = Field(default=None, alias="HTMLName")
    ingredient_id: Optional[StrictInt] = Field(default=None, alias="IngredientID")
    ingredient_info: Optional[BigOvenModelAPIIngredientInfo] = Field(default=None, alias="IngredientInfo")
    is_heading: Optional[StrictBool] = Field(default=None, alias="IsHeading")
    is_linked: Optional[StrictBool] = Field(default=None, alias="IsLinked")
    metric_display_quantity: Optional[StrictStr] = Field(default=None, alias="MetricDisplayQuantity")
    metric_quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="MetricQuantity")
    metric_unit: Optional[StrictStr] = Field(default=None, alias="MetricUnit")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    preparation_notes: Optional[StrictStr] = Field(default=None, alias="PreparationNotes")
    ...
    __properties: ClassVar[List[str]] = ["DisplayIndex", "DisplayQuantity", "HTMLName", "IngredientID", "IngredientInfo", "IsHeading", "IsLinked", "MetricDisplayQuantity", "MetricQuantity", "MetricUnit", "Name", "PreparationNotes", "Quantity", "Unit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ingredient_info
        if self.ingredient_info:
            _dict['IngredientInfo'] = self.ingredient_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DisplayIndex": obj.get("DisplayIndex"),
            "DisplayQuantity": obj.get("DisplayQuantity"),
            "HTMLName": obj.get("HTMLName"),
            "IngredientID": obj.get("IngredientID"),
            "IngredientInfo": BigOvenModelAPIIngredientInfo.from_dict(obj["IngredientInfo"]) if obj.get("IngredientInfo") is not None else None,
            "IsHeading": obj.get("IsHeading"),
            "IsLinked": obj.get("IsLinked"),
            "MetricDisplayQuantity": obj.get("MetricDisplayQuantity"),
            "MetricQuantity": obj.get("MetricQuantity"),
            "MetricUnit": obj.get("MetricUnit"),
            "Name": obj.get("Name"),
            "PreparationNotes": obj.get("PreparationNotes"),
