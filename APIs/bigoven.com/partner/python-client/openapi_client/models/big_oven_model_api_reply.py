...
class BigOvenModelAPIReply(BaseModel):
    ...
    poster: Optional[BigOvenModelAPIUserInfoTiny] = Field(default=None, alias="Poster")
    review_id: Optional[StrictStr] = Field(default=None, alias="ReviewID")
    __properties: ClassVar[List[str]] = ["Comment", "CreationDate", "ID", "LastModified", "Poster", "ReviewID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Poster": BigOvenModelAPIUserInfoTiny.from_dict(obj["Poster"]) if obj.get("Poster") is not None else None,
