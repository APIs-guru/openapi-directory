...
class BigOvenModelRecipeInfoReviewTuple2(BaseModel):
    ...
    """ # noqa: E501
    recipe_info: Optional[BigOvenModelAPI2RecipeInfox] = Field(default=None, alias="RecipeInfo")
    review: Optional[BigOvenModelAPIReview] = Field(default=None, alias="Review")
    __properties: ClassVar[List[str]] = ["RecipeInfo", "Review"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BigOvenModelRecipeInfoReviewTuple2 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recipe_info
        if self.recipe_info:
            _dict['RecipeInfo'] = self.recipe_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BigOvenModelRecipeInfoReviewTuple2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "RecipeInfo": BigOvenModelAPI2RecipeInfox.from_dict(obj["RecipeInfo"]) if obj.get("RecipeInfo") is not None else None,
            "Review": BigOvenModelAPIReview.from_dict(obj["Review"]) if obj.get("Review") is not None else None
        })
        return _obj
