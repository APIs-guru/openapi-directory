...
class BigOvenModelInstructionStep(BaseModel):
    ...
    """ # noqa: E501
    end_gantt: Optional[StrictInt] = Field(default=None, alias="EndGantt")
    start_gantt: Optional[StrictInt] = Field(default=None, alias="StartGantt")
    text: Optional[StrictStr] = Field(default=None, alias="Text")
    __properties: ClassVar[List[str]] = ["EndGantt", "StartGantt", "Text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BigOvenModelInstructionStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BigOvenModelInstructionStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "EndGantt": obj.get("EndGantt"),
            "StartGantt": obj.get("StartGantt"),
            "Text": obj.get("Text")
        })
        return _obj
