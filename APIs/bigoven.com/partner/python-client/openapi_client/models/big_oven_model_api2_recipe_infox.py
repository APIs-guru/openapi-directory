...
class BigOvenModelAPI2RecipeInfox(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Category", "CreationDate", "Cuisine", "HasVideos", "IsBookmark", "IsPrivate", "IsRecipeScan", "Microcategory", "PhotoUrl", "Poster", "RecipeID", "ReviewCount", "Servings", "StarRating", "Subcategory", "Title", "TotalTries", "WebURL"]
