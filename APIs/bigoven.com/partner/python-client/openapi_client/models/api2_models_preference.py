...
class API2ModelsPreference(BaseModel):
    ...
    """ # noqa: E501
    eating_style: Optional[StrictStr] = Field(default=None, alias="EatingStyle")
    __properties: ClassVar[List[str]] = ["EatingStyle"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of API2ModelsPreference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of API2ModelsPreference from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "EatingStyle": obj.get("EatingStyle")
        })
        return _obj
