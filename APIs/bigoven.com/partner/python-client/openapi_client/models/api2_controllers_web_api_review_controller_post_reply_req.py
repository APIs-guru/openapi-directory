...
class API2ControllersWebAPIReviewControllerPostReplyReq(BaseModel):
    ...
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="The comment. If mentioning any user(s) (optional), include them as @username in the text body. Do not use @ symbol for anything but mentioning @usernames.", alias="Comment")
