...
class BigOvenModelAPI2CollectionInfo(BaseModel):
    ...
    mobile_url: Optional[StrictStr] = Field(default=None, alias="MobileUrl")
    pro: Optional[StrictBool] = Field(default=None, alias="PRO")
    photo_url: Optional[StrictStr] = Field(default=None, alias="PhotoUrl")
    results: Optional[List[BigOvenModelAPI2RecipeInfox]] = Field(default=None, alias="Results")
    ...
    __properties: ClassVar[List[str]] = ["Description", "ID", "IsFiltered", "IsSponsored", "MobileUrl", "PRO", "PhotoUrl", "Results", "Title", "Token", "WebUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MobileUrl": obj.get("MobileUrl"),
            "PRO": obj.get("PRO"),
            "PhotoUrl": obj.get("PhotoUrl"),
            "Results": [BigOvenModelAPI2RecipeInfox.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None,
            "Title": obj.get("Title"),
            "Token": obj.get("Token"),
