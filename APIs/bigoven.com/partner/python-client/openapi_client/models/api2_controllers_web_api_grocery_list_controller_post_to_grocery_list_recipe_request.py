...
class API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["department", "name", "notes", "quantity", "unit"]
