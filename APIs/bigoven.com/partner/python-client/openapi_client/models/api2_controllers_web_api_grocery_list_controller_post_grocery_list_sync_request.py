...
class API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest(BaseModel):
    ...
    since: Optional[StrictStr] = Field(default=None, description="Gets or sets the since.")
    __properties: ClassVar[List[str]] = ["list", "since"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": BigOvenModelAPIGroceryGroceryList.from_dict(obj["list"]) if obj.get("list") is not None else None,
            "since": obj.get("since")
        })
        return _obj
