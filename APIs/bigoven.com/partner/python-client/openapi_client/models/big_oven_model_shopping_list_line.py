...
class BigOvenModelShoppingListLine(BaseModel):
    ...
    dept: Optional[StrictStr] = Field(default=None, alias="Dept")
    guid: Optional[StrictStr] = Field(default=None, alias="GUID")
    html_item_name: Optional[StrictStr] = Field(default=None, alias="HTMLItemName")
    ...
    meal_plan_id: Optional[StrictInt] = Field(default=None, alias="MealPlanID")
    meal_plan_object_type: Optional[StrictInt] = Field(default=None, alias="MealPlanObjectType")
    notes: Optional[StrictStr] = Field(default=None, alias="Notes")
    pending_addition: Optional[StrictBool] = Field(default=None, alias="PendingAddition")
    recipe_id: Optional[StrictInt] = Field(default=None, alias="RecipeID")
    shopping_list_line_id: Optional[StrictInt] = Field(default=None, alias="ShoppingListLineID")
    store: Optional[StrictStr] = Field(default=None, alias="Store")
    text_amt: Optional[StrictStr] = Field(default=None, alias="TextAmt")
    third_party_host: Optional[StrictStr] = Field(default=None, alias="ThirdPartyHost")
    third_party_title: Optional[StrictStr] = Field(default=None, alias="ThirdPartyTitle")
    third_party_url: Optional[StrictStr] = Field(default=None, alias="ThirdPartyURL")
    __properties: ClassVar[List[str]] = ["DateAdded", "Dept", "GUID", "HTMLItemName", "IsChecked", "ItemName", "LastModified", "ListID", "MealPlanID", "MealPlanObjectType", "Notes", "PendingAddition", "RecipeID", "ShoppingListLineID", "Store", "TextAmt", "ThirdPartyHost", "ThirdPartyTitle", "ThirdPartyURL"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Dept": obj.get("Dept"),
            "GUID": obj.get("GUID"),
            "HTMLItemName": obj.get("HTMLItemName"),
            "IsChecked": obj.get("IsChecked"),
            "ItemName": obj.get("ItemName"),
            "LastModified": obj.get("LastModified"),
            "ListID": obj.get("ListID"),
            "MealPlanID": obj.get("MealPlanID"),
            "MealPlanObjectType": obj.get("MealPlanObjectType"),
            "Notes": obj.get("Notes"),
            "PendingAddition": obj.get("PendingAddition"),
            "RecipeID": obj.get("RecipeID"),
            "ShoppingListLineID": obj.get("ShoppingListLineID"),
            "Store": obj.get("Store"),
            "TextAmt": obj.get("TextAmt"),
            "ThirdPartyHost": obj.get("ThirdPartyHost"),
            "ThirdPartyTitle": obj.get("ThirdPartyTitle"),
            "ThirdPartyURL": obj.get("ThirdPartyURL")
        })
        return _obj
