...
class API2GroceryListDepartmentResult(BaseModel):
    ...
    """ # noqa: E501
    dept: Optional[StrictStr] = Field(default=None, description="Gets or sets the dept.")
    item: Optional[StrictStr] = Field(default=None, description="Gets or sets the item.")
    __properties: ClassVar[List[str]] = ["dept", "item"]
