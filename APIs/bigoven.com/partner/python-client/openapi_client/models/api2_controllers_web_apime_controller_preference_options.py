...
class API2ControllersWebAPIMeControllerPreferenceOptions(BaseModel):
    ...
    """ # noqa: E501
    eating_style: Optional[API2ControllersWebAPIMeControllerEatingStyle] = Field(default=None, alias="EatingStyle")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of API2ControllersWebAPIMeControllerPreferenceOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of eating_style
        if self.eating_style:
            _dict['EatingStyle'] = self.eating_style.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of API2ControllersWebAPIMeControllerPreferenceOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "EatingStyle": API2ControllersWebAPIMeControllerEatingStyle.from_dict(obj["EatingStyle"]) if obj.get("EatingStyle") is not None else None
        })
        return _obj
