...
class API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest(BaseModel):
    ...
    """ # noqa: E501
    department: Optional[StrictStr] = Field(default=None, description="Gets or sets the department.")
    guid: Optional[StrictStr] = Field(default=None, description="Gets or sets the unique identifier.")
    ischecked: Optional[StrictBool] = Field(default=None, description="Gets or sets the ischecked.")
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name.")
    notes: Optional[StrictStr] = Field(default=None, description="Gets or sets the notes.")
    quantity: Optional[StrictStr] = Field(default=None, description="Gets or sets the quantity.")
    unit: Optional[StrictStr] = Field(default=None, description="Gets or sets the unit.")
    __properties: ClassVar[List[str]] = ["department", "guid", "ischecked", "name", "notes", "quantity", "unit"]
