...
class BigOvenModelAPI2RecipeSearchResult(BaseModel):
    ...
    """ # noqa: E501
    result_count: Optional[StrictInt] = Field(default=None, alias="ResultCount")
    results: Optional[List[BigOvenModelAPI2RecipeInfox]] = Field(default=None, alias="Results")
    spell_suggest: Optional[StrictStr] = Field(default=None, alias="SpellSuggest")
    __properties: ClassVar[List[str]] = ["ResultCount", "Results", "SpellSuggest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SpellSuggest": obj.get("SpellSuggest")
        })
        return _obj
