...
class BigOvenModelAPIImage(BaseModel):
    ...
    image_url128: Optional[StrictStr] = Field(default=None, alias="ImageURL128")
    image_url200: Optional[StrictStr] = Field(default=None, alias="ImageURL200")
    image_url256: Optional[StrictStr] = Field(default=None, alias="ImageURL256")
    image_url48: Optional[StrictStr] = Field(default=None, alias="ImageURL48")
    image_url64: Optional[StrictStr] = Field(default=None, alias="ImageURL64")
    ...
    __properties: ClassVar[List[str]] = ["Caption", "CreationDate", "ImageID", "ImageSquares", "ImageURL", "ImageURL120", "ImageURL128", "ImageURL200", "ImageURL256", "ImageURL48", "ImageURL64", "IsPrimary", "MaxImageSquare", "Poster"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ImageURL128": obj.get("ImageURL128"),
            "ImageURL200": obj.get("ImageURL200"),
            "ImageURL256": obj.get("ImageURL256"),
            "ImageURL48": obj.get("ImageURL48"),
            "ImageURL64": obj.get("ImageURL64"),
