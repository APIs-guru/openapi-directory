...
class BigOvenModelAPIRecipeNoteList(BaseModel):
    ...
    results: Optional[List[BigOvenModelAPIRecipeNote]] = Field(default=None, alias="Results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Results": [BigOvenModelAPIRecipeNote.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None
        })
        return _obj
