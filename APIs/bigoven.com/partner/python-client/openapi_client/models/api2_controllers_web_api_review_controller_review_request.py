...
class API2ControllersWebAPIReviewControllerReviewRequest(BaseModel):
    ...
    Payload for reviews
    """ # noqa: E501
    active_minutes: Optional[StrictInt] = Field(default=None, description="How many minutes of ACTIVE time (i.e., actively working on the recipe, not waiting for rising, baking, etc.) did it               demand of the cook? Optional.", alias="ActiveMinutes")
    comment: Optional[StrictStr] = Field(default=None, description="The notes", alias="Comment")
    make_again: Optional[StrictStr] = Field(default=None, description="\"yes\" or \"no\"", alias="MakeAgain")
    star_rating: Optional[StrictInt] = Field(default=None, description="1, 2, 3, 4, or 5", alias="StarRating")
    total_minutes: Optional[StrictInt] = Field(default=None, description="How long, start to finish, in minutes (integer) did it take? Optional.", alias="TotalMinutes")
    __properties: ClassVar[List[str]] = ["ActiveMinutes", "Comment", "MakeAgain", "StarRating", "TotalMinutes"]
