...
class BigOvenModelAPIRecipeInfo(BaseModel):
    ...
    has_videos: Optional[StrictBool] = Field(default=None, alias="HasVideos")
    hero_photo_url: Optional[StrictStr] = Field(default=None, alias="HeroPhotoUrl")
    hide_from_public_search: Optional[StrictBool] = Field(default=None, alias="HideFromPublicSearch")
    image_url: Optional[StrictStr] = Field(default=None, alias="ImageURL")
    image_url120: Optional[StrictStr] = Field(default=None, alias="ImageURL120")
    ...
    quality_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="QualityScore")
    ...
    star_rating_img: Optional[StrictStr] = Field(default=None, alias="StarRatingIMG")
    ...
    total_tries: Optional[StrictInt] = Field(default=None, alias="TotalTries")
    ...
    __properties: ClassVar[List[str]] = ["BookmarkURL", "Category", "CreationDate", "Cuisine", "HasVideos", "HeroPhotoUrl", "HideFromPublicSearch", "ImageURL", "ImageURL120", "IsBookmark", "IsPrivate", "MaxImageSquare", "Microcategory", "Poster", "QualityScore", "RecipeID", "ReviewCount", "StarRating", "StarRatingIMG", "Subcategory", "Title", "TotalTries", "WebURL", "YieldNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HasVideos": obj.get("HasVideos"),
            "HeroPhotoUrl": obj.get("HeroPhotoUrl"),
            "HideFromPublicSearch": obj.get("HideFromPublicSearch"),
            "ImageURL": obj.get("ImageURL"),
            "ImageURL120": obj.get("ImageURL120"),
            ...
            "StarRatingIMG": obj.get("StarRatingIMG"),
            "Subcategory": obj.get("Subcategory"),
            "Title": obj.get("Title"),
            "TotalTries": obj.get("TotalTries"),
