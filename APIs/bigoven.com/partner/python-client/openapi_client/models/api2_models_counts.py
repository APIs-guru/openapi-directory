...
class API2ModelsCounts(BaseModel):
    ...
    following_count: Optional[StrictInt] = Field(default=None, alias="FollowingCount")
    private_recipe_count: Optional[StrictInt] = Field(default=None, alias="PrivateRecipeCount")
    public_recipe_count: Optional[StrictInt] = Field(default=None, alias="PublicRecipeCount")
    total_recipes: Optional[StrictInt] = Field(default=None, alias="TotalRecipes")
    __properties: ClassVar[List[str]] = ["AddedCount", "FollowersCount", "FollowingCount", "PrivateRecipeCount", "PublicRecipeCount", "TotalRecipes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PrivateRecipeCount": obj.get("PrivateRecipeCount"),
            "PublicRecipeCount": obj.get("PublicRecipeCount"),
            "TotalRecipes": obj.get("TotalRecipes")
        })
        return _obj
