...
class BigOvenModelAPI2Photo(BaseModel):
    ...
    poster: Optional[BigOvenModelAPI2UserInfoTinyx] = Field(default=None, alias="Poster")
    __properties: ClassVar[List[str]] = ["Caption", "CreationDate", "ImageID", "IsPrimary", "MaxImageSquare", "PhotoUrl", "Poster"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Poster": BigOvenModelAPI2UserInfoTinyx.from_dict(obj["Poster"]) if obj.get("Poster") is not None else None
        })
        return _obj
