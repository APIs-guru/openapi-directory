...
class BigOvenModelRecipeCategory(BaseModel):
    ...
    default_active_minutes: Optional[StrictInt] = Field(default=None, alias="DefaultActiveMinutes")
    default_total_minutes: Optional[StrictInt] = Field(default=None, alias="DefaultTotalMinutes")
    ...
    __properties: ClassVar[List[str]] = ["Category", "DefaultActiveMinutes", "DefaultTotalMinutes", "ID", "ParentID", "PrimaryImage", "ShortDescription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DefaultActiveMinutes": obj.get("DefaultActiveMinutes"),
            "DefaultTotalMinutes": obj.get("DefaultTotalMinutes"),
            "ID": obj.get("ID"),
