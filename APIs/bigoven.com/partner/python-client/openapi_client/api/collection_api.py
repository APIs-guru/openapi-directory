...
class CollectionApi:
    ...
    def collection_collections(
    ...
    ) -> List[BigOvenModelAPI2CollectionInfo]:
        ...
        _param = self._collection_collections_serialize(
            test=test,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BigOvenModelAPI2CollectionInfo]",
        }
    ...
    @validate_call
    def collection_collections_with_http_info(
        self,
        test: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BigOvenModelAPI2CollectionInfo]]:
        """Get the list of current, seasonal recipe collections. From here, you can use the /collection/{id} endpoint to retrieve the recipes in those collections.
    ...
    @validate_call
    def collection_collections_without_preload_content(
        self,
        test: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _collection_collections_serialize(
        self,
        test,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def collection_get_collection(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        ...
        session_for_logging: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._collection_get_collection_serialize(
            id=id,
            rpp=rpp,
            pg=pg,
            test=test,
            session_for_logging=session_for_logging,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def collection_get_collection_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        rpp: Annotated[Optional[StrictInt], Field(description="results per page")] = None,
        pg: Annotated[Optional[StrictInt], Field(description="page number (starting with 1)")] = None,
    ...
    @validate_call
    def collection_get_collection_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        rpp: Annotated[Optional[StrictInt], Field(description="results per page")] = None,
        pg: Annotated[Optional[StrictInt], Field(description="page number (starting with 1)")] = None,
    ...
    def _collection_get_collection_serialize(
        self,
        id,
        rpp,
        pg,
        ...
        if session_for_logging is not None:
            
            _query_params.append(('sessionForLogging', session_for_logging))
    ...
    @validate_call
    def collection_get_collection_meta(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        _request_timeout: Union[
            None,
        ...
        _param = self._collection_get_collection_meta_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BigOvenModelAPI2CollectionInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def collection_get_collection_meta_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BigOvenModelAPI2CollectionInfo]:
        """Gets a recipe collection metadata. A recipe collection is a curated set of recipes.
    ...
    @validate_call
    def collection_get_collection_meta_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="the collection identifier")],
        _request_timeout: Union[
            None,
    ...
    def _collection_get_collection_meta_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collection/{id}/meta',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
