...
mr_address_instance = MrAddress.from_json(json)
# print the JSON string representation of the object
print(MrAddress.to_json())

# convert the object into a dict
mr_address_dict = mr_address_instance.to_dict()
# create an instance of MrAddress from a dict
mr_address_from_dict = MrAddress.from_dict(mr_address_dict)
```
