...
json = "{}"
# create an instance of UMPRNResponseResult from a JSON string
umprn_response_result_instance = UMPRNResponseResult.from_json(json)
# print the JSON string representation of the object
print(UMPRNResponseResult.to_json())

# convert the object into a dict
umprn_response_result_dict = umprn_response_result_instance.to_dict()
# create an instance of UMPRNResponseResult from a dict
umprn_response_result_from_dict = UMPRNResponseResult.from_dict(umprn_response_result_dict)
```
