...
json = "{}"
# create an instance of AddressResponseResultHitsInner from a JSON string
address_response_result_hits_inner_instance = AddressResponseResultHitsInner.from_json(json)
# print the JSON string representation of the object
print(AddressResponseResultHitsInner.to_json())

# convert the object into a dict
address_response_result_hits_inner_dict = address_response_result_hits_inner_instance.to_dict()
# create an instance of AddressResponseResultHitsInner from a dict
address_response_result_hits_inner_from_dict = AddressResponseResultHitsInner.from_dict(address_response_result_hits_inner_dict)
```
