...
json = "{}"
# create an instance of WelshPafAddress from a JSON string
welsh_paf_address_instance = WelshPafAddress.from_json(json)
# print the JSON string representation of the object
print(WelshPafAddress.to_json())

# convert the object into a dict
welsh_paf_address_dict = welsh_paf_address_instance.to_dict()
# create an instance of WelshPafAddress from a dict
welsh_paf_address_from_dict = WelshPafAddress.from_dict(welsh_paf_address_dict)
```
