...
ab_address_instance = AbAddress.from_json(json)
# print the JSON string representation of the object
print(AbAddress.to_json())

# convert the object into a dict
ab_address_dict = ab_address_instance.to_dict()
# create an instance of AbAddress from a dict
ab_address_from_dict = AbAddress.from_dict(ab_address_dict)
```
