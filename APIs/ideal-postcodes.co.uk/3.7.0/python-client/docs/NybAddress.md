...
A UK premise under construction and currently not occupied.  This dataset is updated by Royal Mail on a monthly cadence.
...
json = "{}"
# create an instance of NybAddress from a JSON string
nyb_address_instance = NybAddress.from_json(json)
# print the JSON string representation of the object
print(NybAddress.to_json())

# convert the object into a dict
nyb_address_dict = nyb_address_instance.to_dict()
# create an instance of NybAddress from a dict
nyb_address_from_dict = NybAddress.from_dict(nyb_address_dict)
```
