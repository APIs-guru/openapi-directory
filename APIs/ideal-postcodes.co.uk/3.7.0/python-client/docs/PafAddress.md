...
Standard UK Address. Also known as a Postcode Address File (PAF) address is defined by Royal Mail and updated on a daily cadence.  A PAF Address represents a deliverable endpoint.
...
json = "{}"
# create an instance of PafAddress from a JSON string
paf_address_instance = PafAddress.from_json(json)
# print the JSON string representation of the object
print(PafAddress.to_json())

# convert the object into a dict
paf_address_dict = paf_address_instance.to_dict()
# create an instance of PafAddress from a dict
paf_address_from_dict = PafAddress.from_dict(paf_address_dict)
```
