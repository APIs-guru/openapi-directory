...
class LicenseesApi:
    ...
    def create_licensee(
        self,
        key: StrictStr,
        licensee_editable: LicenseeEditable,
        ...
        :param key: (required)
        :type key: str
        :param licensee_editable: (required)
        :type licensee_editable: LicenseeEditable
        :param user_token:
        :type user_token: str
        ...
        _param = self._create_licensee_serialize(
            key=key,
            licensee_editable=licensee_editable,
    ...
    def _create_licensee_serialize(
        ...
        if licensee_editable is not None:
            _body_params = licensee_editable
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/keys/{key}/licensees',
    ...
    def delete_licensee_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LicenseeDeleteResponse]:
        """Cancel
    ...
    def _delete_licensee_serialize(
        ...
        if licensee is not None:
            _path_params['licensee'] = licensee
        # process the query parameters
        if user_token is not None:
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/keys/{key}/licensees/{licensee}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_licensees(
        self,
        key: StrictStr,
        starting_after: Annotated[Optional[StrictInt], Field(description="Specify ID of the licensee after which you would like to list results")] = None,
        user_token: Optional[StrictStr] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Specify the maximum number of results to return per page. Default and maximum is `100`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Filter result by licensee name. Query can be shortened to `q=`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param key: (required)
        :type key: str
        :param starting_after: Specify ID of the licensee after which you would like to list results
        :type starting_after: int
        :param user_token:
        :type user_token: str
        :param limit: Specify the maximum number of results to return per page. Default and maximum is `100`.
        :type limit: int
        :param query: Filter result by licensee name. Query can be shortened to `q=`
        :type query: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def retrieve_licensee(
        ...
        _param = self._retrieve_licensee_serialize(
            key=key,
            licensee=licensee,
            user_token=user_token,
            _request_auth=_request_auth,
    ...
    @validate_call
    def retrieve_licensee_with_http_info(
        self,
        key: StrictStr,
        licensee: StrictStr,
        user_token: Optional[StrictStr] = None,
    ...
    @validate_call
    def retrieve_licensee_without_preload_content(
        self,
        key: StrictStr,
        licensee: StrictStr,
        user_token: Optional[StrictStr] = None,
    ...
    def _retrieve_licensee_serialize(
        self,
        key,
        licensee,
        user_token,
