...
class EmailsApi:
    ...
    def email_validation(
        self,
        api_key: StrictStr,
        query: Annotated[StrictStr, Field(description="Specifies the email address to validate")],
        ...
        :type api_key: str
        :param query: Specifies the email address to validate (required)
        :type query: str
        ...
        _param = self._email_validation_serialize(
            api_key=api_key,
            query=query,
    ...
    @validate_call
    def email_validation_with_http_info(
        self,
        api_key: StrictStr,
        query: Annotated[StrictStr, Field(description="Specifies the email address to validate")],
        _request_timeout: Union[
    ...
    @validate_call
    def email_validation_without_preload_content(
        self,
        api_key: StrictStr,
        query: Annotated[StrictStr, Field(description="Specifies the email address to validate")],
        _request_timeout: Union[
    ...
    def _email_validation_serialize(
        self,
        api_key,
        query,
        _request_auth,
