...
class PlaceSearchApi:
    ...
    def find_place(
        self,
        api_key: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="Specifies the place you wish to query. Query can be shortened to `q=`")] = None,
        country_iso: Optional[StrictStr] = None,
        bias_country_iso: Optional[StrictStr] = None,
        ...
        :type api_key: str
        :param query: Specifies the place you wish to query. Query can be shortened to `q=`
        :type query: str
        :param country_iso:
        :type country_iso: str
        :param bias_country_iso:
        :type bias_country_iso: str
        :param bias_lonlat:
        ...
        _param = self._find_place_serialize(
            api_key=api_key,
            query=query,
            country_iso=country_iso,
            bias_country_iso=bias_country_iso,
    ...
    @validate_call
    def find_place_without_preload_content(
        self,
        api_key: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="Specifies the place you wish to query. Query can be shortened to `q=`")] = None,
        country_iso: Optional[StrictStr] = None,
    ...
    def _find_place_serialize(
        ...
        if country_iso is not None:
            ...
            _query_params.append(('country_iso', country_iso))
            
        if bias_country_iso is not None:
            
            _query_params.append(('bias_country_iso', bias_country_iso))
    ...
    def resolve_place(
        self,
        place: Annotated[StrictStr, Field(description="ID of place suggestion")],
        ...
        :param place: ID of place suggestion (required)
        :type place: str
        :param api_key:
        :type api_key: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._resolve_place_serialize(
            place=place,
            api_key=api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def resolve_place_with_http_info(
        self,
        place: Annotated[StrictStr, Field(description="ID of place suggestion")],
        api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResolvePlaceResponse]:
        """Resolve Place
    ...
    @validate_call
    def resolve_place_without_preload_content(
        self,
        place: Annotated[StrictStr, Field(description="ID of place suggestion")],
        api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
