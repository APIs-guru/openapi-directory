...
class ConfigsApi:
    ...
    def create_config(
        self,
        key: StrictStr,
        config_new_param: ConfigNewParam,
        ...
        :param key: (required)
        :type key: str
        :param config_new_param: (required)
        :type config_new_param: ConfigNewParam
        :param user_token:
        :type user_token: str
        ...
        _param = self._create_config_serialize(
            key=key,
            config_new_param=config_new_param,
    ...
    def _create_config_serialize(
        ...
        if config_new_param is not None:
            _body_params = config_new_param
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/keys/{key}/configs',
    ...
    def delete_config_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConfigDeleteResponse]:
        """Delete
    ...
    def _delete_config_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/keys/{key}/configs/{config}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def retrieve_config(
        ...
        _param = self._retrieve_config_serialize(
            key=key,
            config=config,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def retrieve_config_with_http_info(
        self,
        key: StrictStr,
        config: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def retrieve_config_without_preload_content(
        self,
        key: StrictStr,
        config: StrictStr,
        _request_timeout: Union[
    ...
    def _retrieve_config_serialize(
        self,
        key,
        config,
        _request_auth,
    ...
    def update_config(
        ...
        key: StrictStr,
        config: StrictStr,
        config_update_param: ConfigUpdateParam,
        user_token: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param config: (required)
        :type config: str
        :param config_update_param: (required)
        :type config_update_param: ConfigUpdateParam
        :param user_token:
        :type user_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_config_serialize(
            key=key,
            config=config,
            config_update_param=config_update_param,
            user_token=user_token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_config_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if config_update_param is not None:
            _body_params = config_update_param
