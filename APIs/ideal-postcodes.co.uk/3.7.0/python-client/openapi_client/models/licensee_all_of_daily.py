...
class LicenseeAllOfDaily(BaseModel):
    """
    LicenseeAllOfDaily
    """ # noqa: E501
    count: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="The number lookups performed by the licensee on the day represented b `licesees.daily.updatedAt`")
    updated_at: StrictStr = Field(description="The timestamp when the limit was last used.", alias="updatedAt")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LicenseeAllOfDaily from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LicenseeAllOfDaily from a dict"""
        if obj is None:
            return None
