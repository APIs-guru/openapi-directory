...
GBRRESOLVEADDRESSRESPONSERESULT_ONE_OF_SCHEMAS = ["AbAddress", "GbrGlobalAddress", "MrAddress", "NybAddress", "PafAddress", "PafAliasAddress", "WelshPafAddress"]

class GbrResolveAddressResponseResult(BaseModel):
    """
    GbrResolveAddressResponseResult
    """
    # data type: PafAddress
    oneof_schema_1_validator: Optional[PafAddress] = None
    # data type: MrAddress
    oneof_schema_2_validator: Optional[MrAddress] = None
    # data type: WelshPafAddress
    oneof_schema_3_validator: Optional[WelshPafAddress] = None
    # data type: PafAliasAddress
    oneof_schema_4_validator: Optional[PafAliasAddress] = None
    # data type: NybAddress
    oneof_schema_5_validator: Optional[NybAddress] = None
    # data type: AbAddress
    oneof_schema_6_validator: Optional[AbAddress] = None
    # data type: GbrGlobalAddress
    oneof_schema_7_validator: Optional[GbrGlobalAddress] = None
    actual_instance: Optional[Union[AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress]] = None
    one_of_schemas: Set[str] = { "AbAddress", "GbrGlobalAddress", "MrAddress", "NybAddress", "PafAddress", "PafAliasAddress", "WelshPafAddress" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = GbrResolveAddressResponseResult.model_construct()
        error_messages = []
        match = 0
        # validate data type: PafAddress
        if not isinstance(v, PafAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PafAddress`")
        else:
            match += 1
        # validate data type: MrAddress
        if not isinstance(v, MrAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MrAddress`")
        else:
            match += 1
        # validate data type: WelshPafAddress
        if not isinstance(v, WelshPafAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WelshPafAddress`")
        else:
            match += 1
        # validate data type: PafAliasAddress
        if not isinstance(v, PafAliasAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PafAliasAddress`")
        else:
            match += 1
        # validate data type: NybAddress
        if not isinstance(v, NybAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `NybAddress`")
        else:
            match += 1
        # validate data type: AbAddress
        if not isinstance(v, AbAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AbAddress`")
        else:
            match += 1
        # validate data type: GbrGlobalAddress
        if not isinstance(v, GbrGlobalAddress):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GbrGlobalAddress`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in GbrResolveAddressResponseResult with oneOf schemas: AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in GbrResolveAddressResponseResult with oneOf schemas: AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into PafAddress
        try:
            instance.actual_instance = PafAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MrAddress
        try:
            instance.actual_instance = MrAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into WelshPafAddress
        try:
            instance.actual_instance = WelshPafAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PafAliasAddress
        try:
            instance.actual_instance = PafAliasAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into NybAddress
        try:
            instance.actual_instance = NybAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into AbAddress
        try:
            instance.actual_instance = AbAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into GbrGlobalAddress
        try:
            instance.actual_instance = GbrGlobalAddress.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into GbrResolveAddressResponseResult with oneOf schemas: AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GbrResolveAddressResponseResult with oneOf schemas: AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AbAddress, GbrGlobalAddress, MrAddress, NybAddress, PafAddress, PafAliasAddress, WelshPafAddress]]:
