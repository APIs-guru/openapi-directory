...
class ConfigUpdateParam(BaseModel):
    """
    Config object update parameters
    """ # noqa: E501
    payload: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="A serialised payload of up to `4096` characters")
