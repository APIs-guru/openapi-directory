...
class BadRequestResponse(BaseModel):
    ...
    BadRequestResponse
    """ # noqa: E501
    code: StrictInt = Field(description="`400X` type error response code")
    message: StrictStr = Field(description="Bad request error description")
    errors: Optional[List[BadRequestResponseAllOfErrors]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [BadRequestResponseAllOfErrors.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
