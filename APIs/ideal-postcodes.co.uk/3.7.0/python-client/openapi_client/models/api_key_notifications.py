...
class ApiKeyNotifications(BaseModel):
    """
    ApiKeyNotifications
    """ # noqa: E501
    emails: List[StrictStr] = Field(description="A list of email addresses designated by you to receive notifications about this key.")
    enabled: StrictBool = Field(description="Indicates whether email notifications are enabled.")
    __properties: ClassVar[List[str]] = ["emails", "enabled"]
