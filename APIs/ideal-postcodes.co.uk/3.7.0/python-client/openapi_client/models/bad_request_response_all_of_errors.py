...
class BadRequestResponseAllOfErrors(BaseModel):
    """
    BadRequestResponseAllOfErrors
    """ # noqa: E501
    error_code: Optional[StrictStr] = Field(default=None, alias="errorCode")
    message: StrictStr = Field(description="Indicates location of error in request query or URL parameter")
    path: StrictStr = Field(description="Indicates location of error in request query or URL parameter")
    __properties: ClassVar[List[str]] = ["errorCode", "message", "path"]
