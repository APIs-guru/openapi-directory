...
class PlaceResponseResult(BaseModel):
    """
    PlaceResponseResult
    """ # noqa: E501
    hits: List[PlaceResponseResultHitsInner] = Field(description="List of up to 10 matching places ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [PlaceResponseResultHitsInner.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None
        })
        return _obj
