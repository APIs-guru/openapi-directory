...
class ApiKey(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": ApiKeyContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "contexts": [AvailableContextsInner.from_dict(_item) for _item in obj["contexts"]] if obj.get("contexts") is not None else None
        })
        return _obj
