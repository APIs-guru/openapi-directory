...
class ConfigDeleteResponseResult(BaseModel):
    """
    ConfigDeleteResponseResult
    """ # noqa: E501
    deleted: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigDeleteResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigDeleteResponseResult from a dict"""
        if obj is None:
            return None
