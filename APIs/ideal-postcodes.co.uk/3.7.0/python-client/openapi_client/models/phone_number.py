...
class PhoneNumber(BaseModel):
    ...
    current_carrier: Optional[Carrier]
    international_format: StrictStr = Field(description="Phone number formatted to international standard")
    iso_country: StrictStr = Field(description="Country code in 3 letter ISO format")
    iso_country_2: StrictStr = Field(description="Country code in 2 letter ISO format")
    national_format: StrictStr = Field(description="Phone number formatted to local standard")
    original_carrier: Optional[Carrier]
    valid: StrictBool
    __properties: ClassVar[List[str]] = ["country", "current_carrier", "international_format", "iso_country", "iso_country_2", "national_format", "original_carrier", "valid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_carrier": Carrier.from_dict(obj["current_carrier"]) if obj.get("current_carrier") is not None else None,
            "international_format": obj.get("international_format"),
            "iso_country": obj.get("iso_country"),
            "iso_country_2": obj.get("iso_country_2"),
            "national_format": obj.get("national_format"),
            "original_carrier": Carrier.from_dict(obj["original_carrier"]) if obj.get("original_carrier") is not None else None,
            "valid": obj.get("valid")
        })
        return _obj
