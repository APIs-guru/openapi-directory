...
class AddressResponseResult(BaseModel):
    """
    AddressResponseResult
    """ # noqa: E501
    hits: List[AddressResponseResultHitsInner] = Field(description="List of matching addresses ")
    limit: Annotated[int, Field(le=100, strict=True, ge=0)]
    page: Annotated[int, Field(le=10, strict=True, ge=0)]
    total: Annotated[int, Field(le=10000, strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["hits", "limit", "page", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [AddressResponseResultHitsInner.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
