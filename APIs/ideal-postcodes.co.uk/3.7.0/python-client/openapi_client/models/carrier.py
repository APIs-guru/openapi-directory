...
class Carrier(BaseModel):
    ...
    Carrier
    """ # noqa: E501
    country: Optional[StrictStr] = Field(description="Country that number is associated with. In ISO 3166-1 alpha-2 format.")
    name: Optional[StrictStr] = Field(description="The full name of the carrier that number is associated with.")
    network_code: Optional[StrictStr] = Field(description="The [Mobile Country Code](https://en.wikipedia.org/wiki/Mobile_country_code) for the carrier.")
    network_type: Optional[StrictStr] = Field(description="Type of network that number is associated with.")
    ...
    def network_type_validate_enum(cls, value):
        ...
        if value not in set(['mobile', 'landline', 'landline_premium', 'landline_tollfree', 'virtual', 'unknown', 'pager']):
            raise ValueError("must be one of enum values ('mobile', 'landline', 'landline_premium', 'landline_tollfree', 'virtual', 'unknown', 'pager')")
        return value
