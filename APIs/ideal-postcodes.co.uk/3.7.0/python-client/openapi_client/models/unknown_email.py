...
class UnknownEmail(BaseModel):
    """
    UnknownEmail
    """ # noqa: E501
    catchall: Optional[StrictBool] = Field(description="Catch-all status is not known")
    deliverable: Optional[StrictBool] = Field(description="Deliverability is not known")
    disposable: Optional[StrictBool] = Field(description="Disposability is not known")
    free: Optional[StrictBool] = Field(description="Free email provider is not known")
    result: StrictStr
    role: Optional[StrictBool] = Field(description="Role is not known")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if catchall (nullable) is None
        # and model_fields_set contains the field
        if self.catchall is None and "catchall" in self.model_fields_set:
            _dict['catchall'] = None

        # set to None if deliverable (nullable) is None
        # and model_fields_set contains the field
        if self.deliverable is None and "deliverable" in self.model_fields_set:
            _dict['deliverable'] = None
