...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    code: StrictInt = Field(description="API Response Code. Non `2xxx` code indicates a failure. This code will provide a more specific reason when a failure occurs and facilitates debugging.")
    message: StrictStr = Field(description="Human readable error message supplied with every error response.")
