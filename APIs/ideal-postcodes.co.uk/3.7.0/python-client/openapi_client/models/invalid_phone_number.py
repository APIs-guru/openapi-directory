...
class InvalidPhoneNumber(BaseModel):
    """
    InvalidPhoneNumber
    """ # noqa: E501
    country: Optional[StrictStr] = Field(description="Full country name")
    current_carrier: Optional[StrictStr] = Field(default=None, description="Representation of current phone carrier information like network code, name, country, network type")
    international_format: Optional[StrictStr] = Field(description="Phone number formatted to international standard")
    iso_country: Optional[StrictStr] = Field(description="Country code in 3 letter ISO format")
    iso_country_2: Optional[StrictStr] = Field(description="Country code in 2 letter ISO format")
    national_format: Optional[StrictStr] = Field(description="Phone number formatted to local standard")
    original_carrier: Optional[StrictStr] = Field(default=None, description="Representation of original phone carrier information like network code, name, country, network type")
    valid: StrictBool
    ...
    @field_validator('current_carrier')
    def current_carrier_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('international_format')
    def international_format_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def iso_country_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('iso_country_2')
    def iso_country_2_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('national_format')
    def national_format_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('original_carrier')
    def original_carrier_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.international_format is None and "international_format" in self.model_fields_set:
            _dict['international_format'] = None
        ...
        # set to None if iso_country_2 (nullable) is None
        # and model_fields_set contains the field
        if self.iso_country_2 is None and "iso_country_2" in self.model_fields_set:
            _dict['iso_country_2'] = None

        # set to None if national_format (nullable) is None
        # and model_fields_set contains the field
        if self.national_format is None and "national_format" in self.model_fields_set:
            _dict['national_format'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_carrier": obj.get("current_carrier"),
            ...
            "original_carrier": obj.get("original_carrier"),
            "valid": obj.get("valid")
        })
        return _obj
