...
class GbrResolveAddressResponse(BaseModel):
    """
    GbrResolveAddressResponse
    """ # noqa: E501
    code: StrictInt
    message: StrictStr
    result: GbrResolveAddressResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GbrResolveAddressResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
