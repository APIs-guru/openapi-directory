...
class Place(BaseModel):
    ...
    dataset: StrictStr = Field(description="Indicates the provenance of a place.    - `geonames` GeoNames place")
    descriptive_name: StrictStr = Field(description="Longer form description of the place. ")
    id: StrictStr = Field(description="Global unique internally generated identifier for a place")
    language: Language
    latitude: Latitude
    longitude: Longitude
    name: StrictStr = Field(description="Place name ")
    native: Optional[PlaceNative] = None
    __properties: ClassVar[List[str]] = ["country_iso", "dataset", "descriptive_name", "id", "language", "latitude", "longitude", "name", "native"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "descriptive_name": obj.get("descriptive_name"),
            "id": obj.get("id"),
            ...
            "name": obj.get("name"),
            "native": PlaceNative.from_dict(obj["native"]) if obj.get("native") is not None else None
        })
        return _obj
