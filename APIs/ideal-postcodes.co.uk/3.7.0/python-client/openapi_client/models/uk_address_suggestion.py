...
class UkAddressSuggestion(BaseModel):
    """
    ...
    suggestion: StrictStr = Field(description="Address suggestion for a given query.")
    ...
    umprn: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Optionally returned field, representing the UMPRN of a Multiple Residence household")
    urls: UkAddressSuggestionUrls
    __properties: ClassVar[List[str]] = ["id", "suggestion", "udprn", "umprn", "urls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "udprn": obj.get("udprn"),
            "umprn": obj.get("umprn"),
            "urls": UkAddressSuggestionUrls.from_dict(obj["urls"]) if obj.get("urls") is not None else None
        })
        return _obj
