...
class ApiKeyDailyLimit(BaseModel):
    """
    ApiKeyDailyLimit
    """ # noqa: E501
    consumed: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of lookups performed today which count towards your daily limit.")
    limit: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(description="`number` or `null`. The daily lookup limit currently set on your key.  `null` means the limit is currently disabled.")
    __properties: ClassVar[List[str]] = ["consumed", "limit"]
