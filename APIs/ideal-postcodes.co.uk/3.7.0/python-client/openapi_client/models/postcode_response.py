...
class PostcodeResponse(BaseModel):
    ...
    code: StrictInt
    message: StrictStr
    result: List[PostcodeResponseResultInner] = Field(description="All addresses listed at the postcode.  If Eircode is enabled, addreses for the Republic of Ireland will be returned in the English format. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [PostcodeResponseResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
