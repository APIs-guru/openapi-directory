...
class UkAddressSuggestionUrls(BaseModel):
    """
    UkAddressSuggestionUrls
    """ # noqa: E501
    udprn: StrictStr = Field(description="URL to retrieve the entire details for a given address suggestion by the UDPRN")
    umprn: Optional[StrictStr] = Field(default=None, description="Optionally returned field, to retrieve the entire details for a suggested Multiple Residence household")
    __properties: ClassVar[List[str]] = ["udprn", "umprn"]
