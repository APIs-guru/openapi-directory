...
class LicenseeDeleteResponse(BaseModel):
    """
    LicenseeDeleteResponse
    """ # noqa: E501
    code: StrictInt
    message: StrictStr
    result: ConfigDeleteResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": ConfigDeleteResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
