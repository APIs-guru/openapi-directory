...
class AvailableContextsInner(BaseModel):
    """
    AvailableContextsInner
    """ # noqa: E501
    description: StrictStr = Field(description="Country descriptor to show in Address Finder ")
    emoji: StrictStr = Field(description="Emoji text icon")
    iso_2: StrictStr = Field(description="2 letter ISO code")
    iso_3: StrictStr = Field(description="3 letter ISO code")
    rgeo: StrictBool = Field(description="Indicates availability of reverse geolocation search ")
    __properties: ClassVar[List[str]] = ["description", "emoji", "iso_2", "iso_3", "rgeo"]
