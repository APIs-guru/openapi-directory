...
class TestPafBase(unittest.TestCase):
    """PafBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PafBase:
        """Test PafBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PafBase`
        """
        model = PafBase()
        if include_optional:
            return PafBase(
