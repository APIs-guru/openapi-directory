...
class TestGbrCleanseNoMatch(unittest.TestCase):
    """GbrCleanseNoMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrCleanseNoMatch:
        """Test GbrCleanseNoMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrCleanseNoMatch`
        """
        model = GbrCleanseNoMatch()
        if include_optional:
    ...
    def testGbrCleanseNoMatch(self):
        """Test GbrCleanseNoMatch"""
