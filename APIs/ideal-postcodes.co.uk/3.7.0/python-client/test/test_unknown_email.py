...
class TestUnknownEmail(unittest.TestCase):
    """UnknownEmail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnknownEmail:
        """Test UnknownEmail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnknownEmail`
        """
        model = UnknownEmail()
        if include_optional:
            return UnknownEmail(
