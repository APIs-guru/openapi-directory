...
class TestWelshPafAddress(unittest.TestCase):
    """WelshPafAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WelshPafAddress:
        """Test WelshPafAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WelshPafAddress`
        """
        model = WelshPafAddress()
        if include_optional:
