...
class TestEcafAddress(unittest.TestCase):
    """EcafAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EcafAddress:
        """Test EcafAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EcafAddress`
        """
        model = EcafAddress()
        if include_optional:
            return EcafAddress(
