...
class TestPostcodeResponseResultInner(unittest.TestCase):
    """PostcodeResponseResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostcodeResponseResultInner:
        """Test PostcodeResponseResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostcodeResponseResultInner`
        """
        model = PostcodeResponseResultInner()
        if include_optional:
            return PostcodeResponseResultInner(
    ...
    def testPostcodeResponseResultInner(self):
        """Test PostcodeResponseResultInner"""
