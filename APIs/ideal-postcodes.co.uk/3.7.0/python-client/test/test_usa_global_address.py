...
class TestUsaGlobalAddress(unittest.TestCase):
    """UsaGlobalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsaGlobalAddress:
        """Test UsaGlobalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsaGlobalAddress`
        """
        model = UsaGlobalAddress()
        if include_optional:
