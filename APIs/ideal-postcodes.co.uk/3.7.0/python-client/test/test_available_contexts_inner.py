...
class TestAvailableContextsInner(unittest.TestCase):
    """AvailableContextsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableContextsInner:
        """Test AvailableContextsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableContextsInner`
        """
        model = AvailableContextsInner()
        if include_optional:
            return AvailableContextsInner(
    ...
    def testAvailableContextsInner(self):
        """Test AvailableContextsInner"""
