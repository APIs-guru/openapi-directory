...
class TestPafAliasAddress(unittest.TestCase):
    """PafAliasAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PafAliasAddress:
        """Test PafAliasAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PafAliasAddress`
        """
        model = PafAliasAddress()
        if include_optional:
