...
class TestAddressBaseCore(unittest.TestCase):
    """AddressBaseCore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressBaseCore:
        """Test AddressBaseCore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressBaseCore`
        """
        model = AddressBaseCore()
        if include_optional:
            return AddressBaseCore(
                ...
                island = '',
                language = 'en',
                last_update_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                latitude = 1.337,
