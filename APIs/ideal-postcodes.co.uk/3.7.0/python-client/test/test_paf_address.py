...
class TestPafAddress(unittest.TestCase):
    """PafAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PafAddress:
        """Test PafAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PafAddress`
        """
        model = PafAddress()
        if include_optional:
            return PafAddress(
