...
class TestKeyUsageResult(unittest.TestCase):
    """KeyUsageResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyUsageResult:
        """Test KeyUsageResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyUsageResult`
        """
        model = KeyUsageResult()
        if include_optional:
