...
class TestAddressResponseResultHitsInner(unittest.TestCase):
    """AddressResponseResultHitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressResponseResultHitsInner:
        """Test AddressResponseResultHitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressResponseResultHitsInner`
        """
        model = AddressResponseResultHitsInner()
        if include_optional:
            return AddressResponseResultHitsInner(
    ...
    def testAddressResponseResultHitsInner(self):
        """Test AddressResponseResultHitsInner"""
