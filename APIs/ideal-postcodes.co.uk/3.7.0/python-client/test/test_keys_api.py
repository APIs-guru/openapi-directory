...
class TestKeysApi(unittest.TestCase):
    ...
    def test_key_availability(self) -> None:
        """Test case for key_availability

        Availability
        """
        pass

    def test_key_details(self) -> None:
        """Test case for key_details

        Details
        """
        pass

    def test_key_logs(self) -> None:
        """Test case for key_logs
