...
class TestEmailResponseResult(unittest.TestCase):
    """EmailResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailResponseResult:
        """Test EmailResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailResponseResult`
        """
        model = EmailResponseResult()
        if include_optional:
    ...
    def testEmailResponseResult(self):
        """Test EmailResponseResult"""
