...
class TestGbrGlobalAddress(unittest.TestCase):
    """GbrGlobalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrGlobalAddress:
        """Test GbrGlobalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrGlobalAddress`
        """
        model = GbrGlobalAddress()
        if include_optional:
