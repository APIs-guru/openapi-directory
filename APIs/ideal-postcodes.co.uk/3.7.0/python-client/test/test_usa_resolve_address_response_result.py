...
class TestUsaResolveAddressResponseResult(unittest.TestCase):
    """UsaResolveAddressResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsaResolveAddressResponseResult:
        """Test UsaResolveAddressResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsaResolveAddressResponseResult`
        """
        model = UsaResolveAddressResponseResult()
        if include_optional:
    ...
    def testUsaResolveAddressResponseResult(self):
        """Test UsaResolveAddressResponseResult"""
