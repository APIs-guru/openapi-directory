...
class TestApiKeyDetailsResponse(unittest.TestCase):
    """ApiKeyDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyDetailsResponse:
        """Test ApiKeyDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyDetailsResponse`
        """
        model = ApiKeyDetailsResponse()
        if include_optional:
            return ApiKeyDetailsResponse(
                code = 2000,
                message = 'Success',
                result = openapi_client.models.api_key_details.API Key Details(
                    allowed_urls = [
                        ''
                        ], 
                    automated_topups = openapi_client.models.api_key_automated_topup.API Key Automated Topup(
                        enabled = True, ), 
                    current_purchases = [
                        openapi_client.models.api_key_batch_purchase.API Key Batch Purchase(
                            consumed = 121, 
                            expires = '2022-01-06T11:41:27.092Z', 
                            purchased = 20000, )
                        ], 
                    daily_limit = openapi_client.models.api_key_daily_limit.API Key Daily Limit(
                        consumed = 288, 
                        limit = 1000, ), 
                    datasets = openapi_client.models.api_key_dataset_availability.API Key Dataset Availability(
                        ecad = False, 
                        ecaf = False, 
                        herewe = True, 
                        mr = True, 
                        ...
                        pafw = False, 
                        usps = True, ), 
                    individual_limit = openapi_client.models.api_key_individual_limit.API Key Individual Limit(
                        limit = 30, ), 
                    lookups_remaining = 19889, 
                    notifications = openapi_client.models.api_key_notifications.API Key Notifications(
                        emails = [
                            'person@example.com'
                            ], 
                        enabled = True, ), )
    ...
    def testApiKeyDetailsResponse(self):
        """Test ApiKeyDetailsResponse"""
