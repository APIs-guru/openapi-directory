...
class TestLicenseesApi(unittest.TestCase):
    """LicenseesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LicenseesApi()
    ...
    def test_retrieve_licensee(self) -> None:
        """Test case for retrieve_licensee
