...
class TestConfigNewParam(unittest.TestCase):
    """ConfigNewParam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigNewParam:
        """Test ConfigNewParam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigNewParam`
        """
        model = ConfigNewParam()
        if include_optional:
