...
class TestUsaGlobalAddressNative(unittest.TestCase):
    """UsaGlobalAddressNative unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsaGlobalAddressNative:
        """Test UsaGlobalAddressNative
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsaGlobalAddressNative`
        """
        model = UsaGlobalAddressNative()
        if include_optional:
            return UsaGlobalAddressNative(
                ...
                uprn = '',
                ward = 'St. James'',
                native = openapi_client.models.address_base_core.AddressBase Core(
                    administrative_county = '', 
                    building_name = '', 
                    building_number = '', 
                    change_code = 'I', 
    ...
    def testUsaGlobalAddressNative(self):
        """Test UsaGlobalAddressNative"""
