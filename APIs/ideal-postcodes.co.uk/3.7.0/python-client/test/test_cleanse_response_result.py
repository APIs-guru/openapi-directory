...
class TestCleanseResponseResult(unittest.TestCase):
    """CleanseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CleanseResponseResult:
        """Test CleanseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CleanseResponseResult`
        """
        model = CleanseResponseResult()
        if include_optional:
    ...
    def testCleanseResponseResult(self):
        """Test CleanseResponseResult"""
