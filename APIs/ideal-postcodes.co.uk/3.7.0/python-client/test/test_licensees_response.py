...
class TestLicenseesResponse(unittest.TestCase):
    """LicenseesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LicenseesResponse:
        """Test LicenseesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LicenseesResponse`
        """
        model = LicenseesResponse()
        if include_optional:
            return LicenseesResponse(
                code = 2000,
                message = 'Success',
                result = openapi_client.models.licensees_response_result.LicenseesResponse_result(
                    has_more = True, 
                    licensees = [
                        null
                        ], )
    ...
    def testLicenseesResponse(self):
        """Test LicenseesResponse"""
