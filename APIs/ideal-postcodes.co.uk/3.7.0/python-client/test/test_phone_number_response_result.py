...
class TestPhoneNumberResponseResult(unittest.TestCase):
    """PhoneNumberResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhoneNumberResponseResult:
        """Test PhoneNumberResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhoneNumberResponseResult`
        """
        model = PhoneNumberResponseResult()
        if include_optional:
            return PhoneNumberResponseResult(
                country = ERROR_TO_EXAMPLE_VALUE,
                current_carrier = ERROR_TO_EXAMPLE_VALUE,
                international_format = ERROR_TO_EXAMPLE_VALUE,
                iso_country = ERROR_TO_EXAMPLE_VALUE,
                iso_country_2 = ERROR_TO_EXAMPLE_VALUE,
                national_format = ERROR_TO_EXAMPLE_VALUE,
                original_carrier = ERROR_TO_EXAMPLE_VALUE,
                valid = True
            )
        else:
            return PhoneNumberResponseResult(
    ...
    def testPhoneNumberResponseResult(self):
        """Test PhoneNumberResponseResult"""
