...
class TestGbrCleanseMatch(unittest.TestCase):
    """GbrCleanseMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrCleanseMatch:
        """Test GbrCleanseMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrCleanseMatch`
        """
        model = GbrCleanseMatch()
        if include_optional:
