...
class TestMrAddress(unittest.TestCase):
    """MrAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MrAddress:
        """Test MrAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MrAddress`
        """
        model = MrAddress()
        if include_optional:
            return MrAddress(
