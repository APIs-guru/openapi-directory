...
class TestEircBase(unittest.TestCase):
    """EircBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EircBase:
        """Test EircBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EircBase`
        """
        model = EircBase()
        if include_optional:
            return EircBase(
