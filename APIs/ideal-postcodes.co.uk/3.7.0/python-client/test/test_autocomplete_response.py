...
class TestAutocompleteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutocompleteResponse:
        """Test AutocompleteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutocompleteResponse`
        """
        ...
        if include_optional:
            return AutocompleteResponse(
                code = 2000,
                message = 'Success',
                result = openapi_client.models.autocomplete_response_result.AutocompleteResponse_result(
                    hits = [
                        null
                        ], )
            )
