...
class TestUspsAddress(unittest.TestCase):
    """UspsAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UspsAddress:
        """Test UspsAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UspsAddress`
        """
        model = UspsAddress()
        if include_optional:
            return UspsAddress(
