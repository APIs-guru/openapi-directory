...
class TestUMPRNResponseResult(unittest.TestCase):
    """UMPRNResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UMPRNResponseResult:
        """Test UMPRNResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UMPRNResponseResult`
        """
        model = UMPRNResponseResult()
        if include_optional:
    ...
    def testUMPRNResponseResult(self):
        """Test UMPRNResponseResult"""
