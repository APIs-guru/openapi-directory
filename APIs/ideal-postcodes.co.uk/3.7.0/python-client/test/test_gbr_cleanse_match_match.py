...
class TestGbrCleanseMatchMatch(unittest.TestCase):
    """GbrCleanseMatchMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrCleanseMatchMatch:
        """Test GbrCleanseMatchMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrCleanseMatchMatch`
        """
        model = GbrCleanseMatchMatch()
        if include_optional:
    ...
    def testGbrCleanseMatchMatch(self):
        """Test GbrCleanseMatchMatch"""
