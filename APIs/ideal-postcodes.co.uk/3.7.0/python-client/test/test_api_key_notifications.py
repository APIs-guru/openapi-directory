...
class TestApiKeyNotifications(unittest.TestCase):
    """ApiKeyNotifications unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyNotifications:
        """Test ApiKeyNotifications
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyNotifications`
        """
        model = ApiKeyNotifications()
        if include_optional:
            return ApiKeyNotifications(
                emails = [
                    'person@example.com'
                    ],
                enabled = True
    ...
    def testApiKeyNotifications(self):
        """Test ApiKeyNotifications"""
