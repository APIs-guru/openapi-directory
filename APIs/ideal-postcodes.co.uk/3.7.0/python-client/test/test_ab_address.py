...
class TestAbAddress(unittest.TestCase):
    """AbAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbAddress:
        """Test AbAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbAddress`
        """
        model = AbAddress()
        if include_optional:
            return AbAddress(
