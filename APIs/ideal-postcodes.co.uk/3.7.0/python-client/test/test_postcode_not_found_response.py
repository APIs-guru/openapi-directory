...
class TestPostcodeNotFoundResponse(unittest.TestCase):
    """PostcodeNotFoundResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostcodeNotFoundResponse:
        """Test PostcodeNotFoundResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostcodeNotFoundResponse`
        """
        model = PostcodeNotFoundResponse()
        if include_optional:
            return PostcodeNotFoundResponse(
                code = 4040,
    ...
    def testPostcodeNotFoundResponse(self):
        """Test PostcodeNotFoundResponse"""
