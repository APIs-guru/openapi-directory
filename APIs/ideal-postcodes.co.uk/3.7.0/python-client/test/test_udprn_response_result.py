...
class TestUDPRNResponseResult(unittest.TestCase):
    """UDPRNResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UDPRNResponseResult:
        """Test UDPRNResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UDPRNResponseResult`
        """
        model = UDPRNResponseResult()
        if include_optional:
    ...
    def testUDPRNResponseResult(self):
        """Test UDPRNResponseResult"""
