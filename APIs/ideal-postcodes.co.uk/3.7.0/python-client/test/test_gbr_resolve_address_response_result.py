...
class TestGbrResolveAddressResponseResult(unittest.TestCase):
    """GbrResolveAddressResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrResolveAddressResponseResult:
        """Test GbrResolveAddressResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrResolveAddressResponseResult`
        """
        model = GbrResolveAddressResponseResult()
        if include_optional:
    ...
    def testGbrResolveAddressResponseResult(self):
        """Test GbrResolveAddressResponseResult"""
