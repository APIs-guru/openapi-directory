...
class TestGeonamesPlace(unittest.TestCase):
    """GeonamesPlace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeonamesPlace:
        """Test GeonamesPlace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeonamesPlace`
        """
        model = GeonamesPlace()
        if include_optional:
            return GeonamesPlace(
                admin1_code = 'ENG',
                admin1_geonameid = 5353,
                admin1_name = 'England',
                admin2_code = '06',
                admin2_geonameid = 5353,
                admin2_name = 'England',
                admin3_code = '08',
                admin4_code = '07',
                alternatenames = [
