...
class TestAutocompleteResponseResultHitsInner(unittest.TestCase):
    """AutocompleteResponseResultHitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutocompleteResponseResultHitsInner:
        """Test AutocompleteResponseResultHitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutocompleteResponseResultHitsInner`
        """
        model = AutocompleteResponseResultHitsInner()
        if include_optional:
            return AutocompleteResponseResultHitsInner(
                id = 'paf_8387729',
                suggestion = 'Flat 6, 12 Roskear, Camborne, TR14',
                urls = openapi_client.models.uk_address_suggestion_urls.UkAddressSuggestion_urls(
                    udprn = '/v1/udprn/50985827', 
                    umprn = '/v1/umprn/51103417', ),
                udprn = 23747771,
                umprn = 51103417
            )
        else:
    ...
    def testAutocompleteResponseResultHitsInner(self):
        """Test AutocompleteResponseResultHitsInner"""
