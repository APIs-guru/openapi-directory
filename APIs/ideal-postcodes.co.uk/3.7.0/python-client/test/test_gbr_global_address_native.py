...
class TestGbrGlobalAddressNative(unittest.TestCase):
    """GbrGlobalAddressNative unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbrGlobalAddressNative:
        """Test GbrGlobalAddressNative
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbrGlobalAddressNative`
        """
        model = GbrGlobalAddressNative()
        if include_optional:
            return GbrGlobalAddressNative(
                ...
                congressional_district_number = None,
                county = 'Suffolk',
                county_number = None,
                finance_number = None,
    ...
    def testGbrGlobalAddressNative(self):
        """Test GbrGlobalAddressNative"""
