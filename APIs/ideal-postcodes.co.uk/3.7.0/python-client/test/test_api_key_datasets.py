...
class TestApiKeyDatasets(unittest.TestCase):
    """ApiKeyDatasets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyDatasets:
        """Test ApiKeyDatasets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyDatasets`
        """
        model = ApiKeyDatasets()
        if include_optional:
