...
class TestUkAddressSuggestion(unittest.TestCase):
    """UkAddressSuggestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UkAddressSuggestion:
        """Test UkAddressSuggestion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UkAddressSuggestion`
        """
        model = UkAddressSuggestion()
        if include_optional:
    ...
    def testUkAddressSuggestion(self):
        """Test UkAddressSuggestion"""
