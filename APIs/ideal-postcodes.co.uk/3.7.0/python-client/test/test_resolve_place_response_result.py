...
class TestResolvePlaceResponseResult(unittest.TestCase):
    """ResolvePlaceResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResolvePlaceResponseResult:
        """Test ResolvePlaceResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResolvePlaceResponseResult`
        """
        model = ResolvePlaceResponseResult()
        if include_optional:
            return ResolvePlaceResponseResult(
                country_iso = 'GBR',
                dataset = 'geonames',
                descriptive_name = 'London, United Kingdom',
                id = 'geonames_5353',
                language = 'en',
                latitude = None,
                longitude = None,
    ...
    def testResolvePlaceResponseResult(self):
        """Test ResolvePlaceResponseResult"""
