...
class TestAddressResponseResult(unittest.TestCase):
    """AddressResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressResponseResult:
        """Test AddressResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressResponseResult`
        """
        model = AddressResponseResult()
        if include_optional:
    ...
    def testAddressResponseResult(self):
        """Test AddressResponseResult"""
