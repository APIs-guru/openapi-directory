...
class TestNybAddress(unittest.TestCase):
    """NybAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NybAddress:
        """Test NybAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NybAddress`
        """
        model = NybAddress()
        if include_optional:
            return NybAddress(
