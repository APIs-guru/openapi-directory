...
class TestLicensee(unittest.TestCase):
    """Licensee unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Licensee:
        """Test Licensee
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Licensee`
        """
        model = Licensee()
        if include_optional:
            return Licensee(
                address = '12 High Street, Manchester',
                daily = openapi_client.models.licensee_all_of_daily.Licensee_allOf_daily(
                    count = 232, 
                    updated_at = '2016-08-05T16:43:28.865Z', ),
