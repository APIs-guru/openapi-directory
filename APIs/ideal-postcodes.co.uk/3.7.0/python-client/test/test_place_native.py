...
class TestPlaceNative(unittest.TestCase):
    """PlaceNative unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceNative:
        """Test PlaceNative
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceNative`
        """
        model = PlaceNative()
        if include_optional:
            return PlaceNative(
