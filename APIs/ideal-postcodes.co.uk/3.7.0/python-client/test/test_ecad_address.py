...
class TestEcadAddress(unittest.TestCase):
    """EcadAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EcadAddress:
        """Test EcadAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EcadAddress`
        """
        model = EcadAddress()
        if include_optional:
            return EcadAddress(
