...
class TestUKApi(unittest.TestCase):
    """UKApi unit test stubs"""
    ...
    def test_address_cleanse(self) -> None:
        """Test case for address_cleanse
    ...
    def test_postcodes(self) -> None:
        """Test case for postcodes

        Lookup Postcode
        """
        pass

    def test_u_dprn(self) -> None:
        """Test case for u_dprn

        Retrieve by UDPRN
        """
        pass

    def test_u_mprn(self) -> None:
        """Test case for u_mprn
