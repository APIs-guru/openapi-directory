...
class TestConfigsResponseResult(unittest.TestCase):
    """ConfigsResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigsResponseResult:
        """Test ConfigsResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigsResponseResult`
        """
        model = ConfigsResponseResult()
        if include_optional:
            return ConfigsResponseResult(
                configs = [
                    openapi_client.models.config_object.Config Object(
                        created_at = '2016-01-21T17:14:49.971Z', 
                        name = 'woocommerce', 
                        payload = '{
  "removeOrganisation": false
}
', 
                        updated_at = '2016-01-21T17:14:49.971Z', )
                    ]
            )
        else:
            return ConfigsResponseResult(
...
', 
    ...
    def testConfigsResponseResult(self):
        """Test ConfigsResponseResult"""
