...
class PointsRequest(BaseModel):
    ...
    site: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=24)]] = Field(default='Points', description="Site name")
    transmitter: Optional[Transmitter] = None
    __properties: ClassVar[List[str]] = ["antenna", "environment", "model", "network", "output", "points", "receiver", "site", "transmitter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "site": obj.get("site") if obj.get("site") is not None else 'Points',
