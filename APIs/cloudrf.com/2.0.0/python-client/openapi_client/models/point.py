...
class Point(BaseModel):
    ...
    lon: Optional[Union[Annotated[float, Field(le=180, strict=True, ge=-180)], Annotated[int, Field(le=180, strict=True, ge=-180)]]] = Field(default=1.411, description="Longitude in decimal degrees")
    __properties: ClassVar[List[str]] = ["alt", "lat", "lon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lon": obj.get("lon") if obj.get("lon") is not None else 1.411
        })
        return _obj
