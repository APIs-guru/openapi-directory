...
class AreaRequest(BaseModel):
    ...
    site: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=24)]] = Field(default='A1', description="Site name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "site": obj.get("site") if obj.get("site") is not None else 'A1',
