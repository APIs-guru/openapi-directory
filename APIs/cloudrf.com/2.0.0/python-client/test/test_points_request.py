...
class TestPointsRequest(unittest.TestCase):
    """PointsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointsRequest:
        """Test PointsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointsRequest`
        """
        model = PointsRequest()
        if include_optional:
