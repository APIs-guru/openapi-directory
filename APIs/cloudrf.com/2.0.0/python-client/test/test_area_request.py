...
class TestAreaRequest(unittest.TestCase):
    """AreaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaRequest:
        """Test AreaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaRequest`
        """
        model = AreaRequest()
        if include_optional:
            return AreaRequest(
