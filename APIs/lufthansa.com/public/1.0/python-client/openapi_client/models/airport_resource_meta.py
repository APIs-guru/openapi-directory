...
class AirportResourceMeta(BaseModel):
    """
    Container for meta links.
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, alias="@Version")
    link: Optional[List[Link]] = Field(default=None, description="Array: links to resource itself and other related resources.", alias="Link")
    total_count: Optional[StrictInt] = Field(default=None, alias="TotalCount")
    __properties: ClassVar[List[str]] = ["@Version", "Link", "TotalCount"]
