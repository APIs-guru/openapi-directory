...
class PreflightApi:
    ...
    def auto_check_in(
        self,
        ticketnumber: Annotated[StrictStr, Field(description="Ticket number")],
        email_address: Annotated[StrictStr, Field(description="Email address")],
        ...
        _param = self._auto_check_in_serialize(
    ...
    @validate_call
    def auto_check_in_with_http_info(
        self,
        ticketnumber: Annotated[StrictStr, Field(description="Ticket number")],
        email_address: Annotated[StrictStr, Field(description="Email address")],
        accept: Annotated[StrictStr, Field(description="http header: application/json or application/xml (Acceptable values are: \"application/json\", \"application/xml\")")],
    ...
    @validate_call
    def auto_check_in_without_preload_content(
        self,
        ticketnumber: Annotated[StrictStr, Field(description="Ticket number")],
        email_address: Annotated[StrictStr, Field(description="Email address")],
        accept: Annotated[StrictStr, Field(description="http header: application/json or application/xml (Acceptable values are: \"application/json\", \"application/xml\")")],
    ...
    def _auto_check_in_serialize(
        ...
        if ticketnumber is not None:
            _path_params['ticketnumber'] = ticketnumber
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/preflight/autocheckin/{ticketnumber}',
