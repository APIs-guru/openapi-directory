...
class OrdersApi:
    ...
    def orders(
        self,
        order_id: Annotated[StrictStr, Field(description="Unique order identifier")],
        ...
        name: Annotated[StrictStr, Field(description="Surname of traveller")],
        ...
        :param order_id: Unique order identifier (required)
        :type order_id: str
    ...
    def _orders_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/orders/orders/{orderID}/{name}',
