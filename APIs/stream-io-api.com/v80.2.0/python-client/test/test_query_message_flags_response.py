...
class TestQueryMessageFlagsResponse(unittest.TestCase):
    """QueryMessageFlagsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryMessageFlagsResponse:
        """Test QueryMessageFlagsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryMessageFlagsResponse`
        """
        model = QueryMessageFlagsResponse()
        if include_optional:
            return QueryMessageFlagsResponse(
                duration = '',
                flags = [
                    openapi_client.models.message_flag.MessageFlag(
    ...
    def testQueryMessageFlagsResponse(self):
        """Test QueryMessageFlagsResponse"""
