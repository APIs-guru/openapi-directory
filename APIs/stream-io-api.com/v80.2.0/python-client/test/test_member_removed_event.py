...
class TestMemberRemovedEvent(unittest.TestCase):
    """MemberRemovedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberRemovedEvent:
        """Test MemberRemovedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberRemovedEvent`
        """
        model = MemberRemovedEvent()
        if include_optional:
    ...
    def testMemberRemovedEvent(self):
        """Test MemberRemovedEvent"""
