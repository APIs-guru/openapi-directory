...
class TestUpdateChannelPartialResponse(unittest.TestCase):
    """UpdateChannelPartialResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateChannelPartialResponse:
        """Test UpdateChannelPartialResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateChannelPartialResponse`
        """
        model = UpdateChannelPartialResponse()
        if include_optional:
    ...
    def testUpdateChannelPartialResponse(self):
        """Test UpdateChannelPartialResponse"""
