...
class TestNotificationInviteRejectedEvent(unittest.TestCase):
    """NotificationInviteRejectedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationInviteRejectedEvent:
        """Test NotificationInviteRejectedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationInviteRejectedEvent`
        """
        model = NotificationInviteRejectedEvent()
        if include_optional:
    ...
    def testNotificationInviteRejectedEvent(self):
        """Test NotificationInviteRejectedEvent"""
