...
class TestUpdateChannelTypeResponse(unittest.TestCase):
    """UpdateChannelTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateChannelTypeResponse:
        """Test UpdateChannelTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateChannelTypeResponse`
        """
        model = UpdateChannelTypeResponse()
        if include_optional:
    ...
    def testUpdateChannelTypeResponse(self):
        """Test UpdateChannelTypeResponse"""
