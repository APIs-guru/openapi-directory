...
class TestCreateChannelTypeResponse(unittest.TestCase):
    """CreateChannelTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateChannelTypeResponse:
        """Test CreateChannelTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateChannelTypeResponse`
        """
        model = CreateChannelTypeResponse()
        if include_optional:
    ...
    def testCreateChannelTypeResponse(self):
        """Test CreateChannelTypeResponse"""
