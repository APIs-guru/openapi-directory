...
class TestMemberAddedEvent(unittest.TestCase):
    """MemberAddedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberAddedEvent:
        """Test MemberAddedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberAddedEvent`
        """
        model = MemberAddedEvent()
        if include_optional:
