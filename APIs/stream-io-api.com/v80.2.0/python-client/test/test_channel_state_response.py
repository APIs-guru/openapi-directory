...
class TestChannelStateResponse(unittest.TestCase):
    """ChannelStateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelStateResponse:
        """Test ChannelStateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelStateResponse`
        """
        model = ChannelStateResponse()
        if include_optional:
    ...
    def testChannelStateResponse(self):
        """Test ChannelStateResponse"""
