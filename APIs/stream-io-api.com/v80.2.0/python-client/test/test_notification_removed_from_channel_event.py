...
class TestNotificationRemovedFromChannelEvent(unittest.TestCase):
    """NotificationRemovedFromChannelEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationRemovedFromChannelEvent:
        """Test NotificationRemovedFromChannelEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationRemovedFromChannelEvent`
        """
        model = NotificationRemovedFromChannelEvent()
        if include_optional:
    ...
    def testNotificationRemovedFromChannelEvent(self):
        """Test NotificationRemovedFromChannelEvent"""
