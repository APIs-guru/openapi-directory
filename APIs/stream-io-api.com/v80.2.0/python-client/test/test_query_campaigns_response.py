...
class TestQueryCampaignsResponse(unittest.TestCase):
    """QueryCampaignsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryCampaignsResponse:
        """Test QueryCampaignsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryCampaignsResponse`
        """
        model = QueryCampaignsResponse()
        if include_optional:
    ...
    def testQueryCampaignsResponse(self):
        """Test QueryCampaignsResponse"""
