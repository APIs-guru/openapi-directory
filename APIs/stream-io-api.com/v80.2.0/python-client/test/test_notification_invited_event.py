...
class TestNotificationInvitedEvent(unittest.TestCase):
    """NotificationInvitedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationInvitedEvent:
        """Test NotificationInvitedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationInvitedEvent`
        """
        model = NotificationInvitedEvent()
        if include_optional:
    ...
    def testNotificationInvitedEvent(self):
        """Test NotificationInvitedEvent"""
