...
class TestListChannelTypesResponse(unittest.TestCase):
    """ListChannelTypesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListChannelTypesResponse:
        """Test ListChannelTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListChannelTypesResponse`
        """
        model = ListChannelTypesResponse()
        if include_optional:
            return ListChannelTypesResponse(
                channel_types = {
                    'key' : openapi_client.models.channel_type_config.ChannelTypeConfig(
                        automod = 'disabled', 
    ...
    def testListChannelTypesResponse(self):
        """Test ListChannelTypesResponse"""
