...
class TestChannelConfigWithInfo(unittest.TestCase):
    """ChannelConfigWithInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelConfigWithInfo:
        """Test ChannelConfigWithInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelConfigWithInfo`
        """
        model = ChannelConfigWithInfo()
        if include_optional:
    ...
    def testChannelConfigWithInfo(self):
        """Test ChannelConfigWithInfo"""
