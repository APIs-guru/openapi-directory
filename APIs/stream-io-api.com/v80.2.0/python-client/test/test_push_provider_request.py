...
class TestPushProviderRequest(unittest.TestCase):
    """PushProviderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushProviderRequest:
        """Test PushProviderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushProviderRequest`
        """
        model = PushProviderRequest()
        if include_optional:
    ...
    def testPushProviderRequest(self):
        """Test PushProviderRequest"""
