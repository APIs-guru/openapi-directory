...
class TestChannelMemberRequest(unittest.TestCase):
    """ChannelMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelMemberRequest:
        """Test ChannelMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelMemberRequest`
        """
        model = ChannelMemberRequest()
        if include_optional:
            return ChannelMemberRequest(
    ...
    def testChannelMemberRequest(self):
        """Test ChannelMemberRequest"""
