...
class ChannelMember(BaseModel):
    ...
    banned: StrictBool = Field(description="Whether member is banned this channel or not")
    channel_role: StrictStr = Field(description="Role of the member in the channel")
    ...
    shadow_banned: StrictBool = Field(description="Whether member is shadow banned in this channel or not")
