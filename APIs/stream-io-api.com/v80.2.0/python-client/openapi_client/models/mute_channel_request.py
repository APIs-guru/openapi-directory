...
class MuteChannelRequest(BaseModel):
    ...
    MuteChannelRequest
    """ # noqa: E501
    channel_cids: List[StrictStr] = Field(description="Channel CIDs to mute (if multiple channels)")
    expiration: Optional[StrictInt] = Field(default=None, description="Duration of mute in milliseconds")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["channel_cids", "expiration", "user", "user_id"]
