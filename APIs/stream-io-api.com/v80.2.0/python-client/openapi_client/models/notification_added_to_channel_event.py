...
class NotificationAddedToChannelEvent(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["channel", "channel_id", "channel_type", "cid", "created_at", "member", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'notification.added_to_channel'
        })
        return _obj
