...
class UpdateMessagePartialRequest(BaseModel):
    ...
    """ # noqa: E501
    set: Dict[str, Any] = Field(description="Sets new field values")
    skip_enrich_url: Optional[StrictBool] = Field(default=None, description="Do not try to enrich the links within message")
    unset: List[StrictStr] = Field(description="Array of field names to unset")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["set", "skip_enrich_url", "unset", "user", "user_id"]
