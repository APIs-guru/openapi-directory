...
class ChannelDeletedEvent(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["channel", "channel_id", "channel_type", "cid", "created_at", "team", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "team": obj.get("team"),
            "type": obj.get("type") if obj.get("type") is not None else 'channel.deleted'
        })
        return _obj
