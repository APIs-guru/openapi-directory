...
class UpdateChannelTypeResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["automod", "automod_behavior", "automod_thresholds", "blocklist", "blocklist_behavior", "commands", "connect_events", "created_at", "custom_events", "duration", "grants", "max_message_length", "message_retention", "mutes", "name", "permissions", "push_notifications", "quotes", "reactions", "read_events", "reminders", "replies", "search", "typing_events", "updated_at", "uploads", "url_enrichment"]
