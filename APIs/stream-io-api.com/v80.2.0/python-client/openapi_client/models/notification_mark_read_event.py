...
class NotificationMarkReadEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channel", "channel_id", "channel_type", "cid", "created_at", "team", "total_unread_count", "type", "unread_channels", "unread_count", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'notification.mark_read',
