...
class ExportUserResponse(BaseModel):
    ...
    messages: Optional[List[Optional[Message]]] = None
    reactions: Optional[List[Optional[Reaction]]] = None
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["duration", "messages", "reactions", "user"]
