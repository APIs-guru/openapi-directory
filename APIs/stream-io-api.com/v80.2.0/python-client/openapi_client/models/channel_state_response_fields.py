...
class ChannelStateResponseFields(BaseModel):
    ...
    hidden: Optional[StrictBool] = Field(default=None, description="Whether this channel is hidden or not")
    hide_messages_before: Optional[datetime] = Field(default=None, description="Messages before this date are hidden from the user")
    members: List[Optional[ChannelMember]] = Field(description="List of channel members")
    membership: Optional[ChannelMember] = None
    messages: List[Optional[Message]] = Field(description="List of channel messages")
    pending_messages: Optional[List[Optional[PendingMessage]]] = Field(default=None, description="Pending messages that this user has sent")
    pinned_messages: List[Optional[Message]] = Field(description="List of pinned messages in the channel")
    read: Optional[List[Optional[Read]]] = Field(default=None, description="List of read states")
    watcher_count: Optional[StrictInt] = Field(default=None, description="Number of channel watchers")
    watchers: Optional[List[UserObject]] = Field(default=None, description="List of user who is watching the channel")
    __properties: ClassVar[List[str]] = ["channel", "hidden", "hide_messages_before", "members", "membership", "messages", "pending_messages", "pinned_messages", "read", "watcher_count", "watchers"]
