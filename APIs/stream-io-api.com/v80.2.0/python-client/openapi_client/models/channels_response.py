...
class ChannelsResponse(BaseModel):
    ...
    ChannelsResponse
    """ # noqa: E501
    channels: List[ChannelStateResponseFields] = Field(description="List of channels")
    duration: StrictStr
    __properties: ClassVar[List[str]] = ["channels", "duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "channels": [ChannelStateResponseFields.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None,
