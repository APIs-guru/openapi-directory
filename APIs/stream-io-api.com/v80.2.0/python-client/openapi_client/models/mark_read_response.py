...
class MarkReadResponse(BaseModel):
    ...
    """ # noqa: E501
    duration: StrictStr
    event: Optional[MessageReadEvent] = None
    __properties: ClassVar[List[str]] = ["duration", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": MessageReadEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
