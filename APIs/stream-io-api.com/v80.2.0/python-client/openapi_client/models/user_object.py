...
class UserObject(BaseModel):
    ...
    banned: StrictBool = Field(description="Whether a user is banned or not")
    created_at: Optional[datetime] = Field(default=None, description="Date/time of creation")
    deactivated_at: Optional[datetime] = Field(default=None, description="Date of deactivation")
    ...
    last_active: Optional[datetime] = Field(default=None, description="Date of last activity")
    online: StrictBool = Field(description="Whether a user online or not")
    ...
    role: StrictStr = Field(description="Determines the set of user permissions")
    ...
    __properties: ClassVar[List[str]] = ["ban_expires", "banned", "created_at", "deactivated_at", "deleted_at", "id", "invisible", "language", "last_active", "online", "push_notifications", "revoke_tokens_issued_before", "role", "teams", "updated_at"]
