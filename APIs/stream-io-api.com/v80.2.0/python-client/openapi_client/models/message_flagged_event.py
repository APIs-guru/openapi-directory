...
class MessageFlaggedEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cid", "created_at", "flag", "message", "thread_participants", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'message.flagged',
