...
class MarkReadRequest(BaseModel):
    ...
    MarkReadRequest
    """ # noqa: E501
    message_id: Optional[StrictStr] = Field(default=None, description="ID of the message that is considered last read by client")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["message_id", "user", "user_id"]
