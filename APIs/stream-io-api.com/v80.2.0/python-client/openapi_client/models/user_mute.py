...
class UserMute(BaseModel):
    ...
    expires: Optional[datetime] = Field(default=None, description="Date/time of mute expiration")
    target: Optional[UserObject] = None
    updated_at: datetime = Field(description="Date/time of the last update")
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["created_at", "expires", "target", "updated_at", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": UserObject.from_dict(obj["target"]) if obj.get("target") is not None else None,
