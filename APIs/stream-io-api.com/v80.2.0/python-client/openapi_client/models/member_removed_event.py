...
class MemberRemovedEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channel_id", "channel_type", "cid", "created_at", "member", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'member.removed',
