...
class PendingMessage(BaseModel):
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional data attached to the pending message. This data is discarded once the pending message is committed.")
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["channel", "message", "metadata", "user"]
