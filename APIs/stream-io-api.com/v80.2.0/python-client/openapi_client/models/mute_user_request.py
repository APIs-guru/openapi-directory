...
class MuteUserRequest(BaseModel):
    ...
    MuteUserRequest
    """ # noqa: E501
    target_ids: List[StrictStr] = Field(description="User IDs to mute (if multiple users)")
    timeout: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Duration of mute in minutes")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["target_ids", "timeout", "user", "user_id"]
