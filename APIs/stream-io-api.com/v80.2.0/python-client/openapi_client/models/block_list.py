...
class BlockList(BaseModel):
    ...
    name: StrictStr = Field(description="Block list name")
    updated_at: Optional[datetime] = Field(default=None, description="Date/time of the last update")
    words: List[StrictStr] = Field(description="List of words to block")
    __properties: ClassVar[List[str]] = ["created_at", "name", "updated_at", "words"]
