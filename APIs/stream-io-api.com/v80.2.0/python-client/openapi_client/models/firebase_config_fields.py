...
class FirebaseConfigFields(BaseModel):
    ...
    """ # noqa: E501
    apn_template: StrictStr
    credentials_json: Optional[StrictStr] = None
    data_template: StrictStr
    enabled: StrictBool
    notification_template: StrictStr
    server_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apn_template", "credentials_json", "data_template", "enabled", "notification_template", "server_key"]
