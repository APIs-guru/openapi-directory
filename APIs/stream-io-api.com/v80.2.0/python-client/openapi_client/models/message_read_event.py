...
class MessageReadEvent(BaseModel):
    ...
    cid: StrictStr
    created_at: datetime
    last_read_message_id: Optional[StrictStr] = None
    team: Optional[StrictStr] = None
    type: StrictStr
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["channel_id", "channel_type", "cid", "created_at", "last_read_message_id", "team", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_read_message_id": obj.get("last_read_message_id"),
            "team": obj.get("team"),
            "type": obj.get("type") if obj.get("type") is not None else 'message.read',
