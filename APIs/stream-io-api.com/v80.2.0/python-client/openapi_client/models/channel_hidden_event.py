...
class ChannelHiddenEvent(BaseModel):
    ...
    cid: StrictStr
    clear_history: StrictBool
    created_at: datetime
    type: StrictStr
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["channel", "channel_id", "channel_type", "cid", "clear_history", "created_at", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'channel.hidden',
