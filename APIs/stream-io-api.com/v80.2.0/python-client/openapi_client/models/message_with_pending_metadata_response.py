...
class MessageWithPendingMetadataResponse(BaseModel):
    ...
    pending_message_metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Metadata attached to a message while it is pending")
    __properties: ClassVar[List[str]] = ["duration", "message", "pending_message_metadata"]
