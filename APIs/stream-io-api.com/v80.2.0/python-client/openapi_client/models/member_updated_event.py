...
class MemberUpdatedEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channel_id", "channel_type", "cid", "created_at", "member", "team", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "team": obj.get("team"),
            "type": obj.get("type") if obj.get("type") is not None else 'member.updated',
