...
class GetReactionsResponse(BaseModel):
    ...
    """ # noqa: E501
    duration: StrictStr
    reactions: List[Optional[Reaction]] = Field(description="List of reactions")
    __properties: ClassVar[List[str]] = ["duration", "reactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reactions": [Reaction.from_dict(_item) for _item in obj["reactions"]] if obj.get("reactions") is not None else None
        })
        return _obj
