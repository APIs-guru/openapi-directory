...
class ConnectRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["device", "user_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": DeviceFields.from_dict(obj["device"]) if obj.get("device") is not None else None,
            "user_details": UserObject.from_dict(obj["user_details"]) if obj.get("user_details") is not None else None
        })
        return _obj
