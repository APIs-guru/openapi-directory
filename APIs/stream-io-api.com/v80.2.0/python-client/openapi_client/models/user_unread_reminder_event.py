...
class UserUnreadReminderEvent(BaseModel):
    ...
    """ # noqa: E501
    channels: Dict[str, Optional[ChannelMessages]]
    created_at: datetime
    type: StrictStr
    user: Optional[UserObject] = None
    __properties: ClassVar[List[str]] = ["channels", "created_at", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "channels": dict(
                (_k, ChannelMessages.from_dict(_v))
                for _k, _v in obj["channels"].items()
            )
            if obj.get("channels") is not None
            else None,
            "created_at": obj.get("created_at"),
            "type": obj.get("type") if obj.get("type") is not None else 'user.unread_message_reminder',
