...
class CreateDeviceRequest(BaseModel):
    ...
    CreateDeviceRequest
    """ # noqa: E501
    id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "push_provider", "push_provider_name", "user", "user_id"]
