...
class UserWatchingStopEvent(BaseModel):
    ...
    watcher_count: StrictInt
    __properties: ClassVar[List[str]] = ["channel_id", "channel_type", "cid", "created_at", "type", "user", "watcher_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'user.watching.stop',
