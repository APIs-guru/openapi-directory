...
class ImagesRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fixed_height", "fixed_height_downsampled", "fixed_height_still", "fixed_width", "fixed_width_downsampled", "fixed_width_still", "original"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fixed_height": ImageDataRequest.from_dict(obj["fixed_height"]) if obj.get("fixed_height") is not None else None,
            "fixed_height_downsampled": ImageDataRequest.from_dict(obj["fixed_height_downsampled"]) if obj.get("fixed_height_downsampled") is not None else None,
            "fixed_height_still": ImageDataRequest.from_dict(obj["fixed_height_still"]) if obj.get("fixed_height_still") is not None else None,
            "fixed_width": ImageDataRequest.from_dict(obj["fixed_width"]) if obj.get("fixed_width") is not None else None,
            "fixed_width_downsampled": ImageDataRequest.from_dict(obj["fixed_width_downsampled"]) if obj.get("fixed_width_downsampled") is not None else None,
            "fixed_width_still": ImageDataRequest.from_dict(obj["fixed_width_still"]) if obj.get("fixed_width_still") is not None else None,
            "original": ImageDataRequest.from_dict(obj["original"]) if obj.get("original") is not None else None
        })
        return _obj
