...
class HideChannelRequest(BaseModel):
    ...
    HideChannelRequest
    """ # noqa: E501
    clear_history: Optional[StrictBool] = Field(default=None, description="Whether to clear message history of the channel or not")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["clear_history", "user", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clear_history": obj.get("clear_history"),
