...
class AsyncModerationCallbackConfigRequest(BaseModel):
    ...
    server_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mode", "server_url"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['CALLBACK_MODE_NONE', 'CALLBACK_MODE_REST', 'CALLBACK_MODE_TWIRP']):
            raise ValueError("must be one of enum values ('CALLBACK_MODE_NONE', 'CALLBACK_MODE_REST', 'CALLBACK_MODE_TWIRP')")
        return value
