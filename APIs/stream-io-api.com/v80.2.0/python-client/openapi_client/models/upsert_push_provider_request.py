...
class UpsertPushProviderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["push_provider"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "push_provider": PushProviderRequest.from_dict(obj["push_provider"]) if obj.get("push_provider") is not None else None
        })
        return _obj
