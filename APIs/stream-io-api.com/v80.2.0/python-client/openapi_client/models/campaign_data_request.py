...
class CampaignDataRequest(BaseModel):
    ...
    CampaignDataRequest
    """ # noqa: E501
    attachments: Optional[List[Optional[AttachmentRequest]]] = None
    channel_type: Optional[Annotated[str, Field(strict=True, max_length=64)]] = None
    ...
    sender_id: StrictStr
    text: StrictStr
    __properties: ClassVar[List[str]] = ["attachments", "channel_type", "defaults", "description", "name", "segment_id", "sender_id", "text"]
