...
class FlagRequest(BaseModel):
    ...
    FlagRequest
    """ # noqa: E501
    target_message_id: Optional[StrictStr] = Field(default=None, description="ID of the message when reporting a message")
    target_user_id: Optional[StrictStr] = Field(default=None, description="ID of the user when reporting a user")
    user: Optional[UserObjectRequest] = None
    user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["target_message_id", "target_user_id", "user", "user_id"]
