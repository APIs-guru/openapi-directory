...
class TestCampaignResponse(BaseModel):
    ...
    duration: StrictStr
    results: Optional[Dict[str, StrictStr]] = Field(default=None, description="Result of the test per user")
    status: StrictStr
    __properties: ClassVar[List[str]] = ["details", "duration", "results", "status"]
