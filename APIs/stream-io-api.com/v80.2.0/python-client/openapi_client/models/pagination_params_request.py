...
class PaginationParamsRequest(BaseModel):
    ...
    """ # noqa: E501
    id_gt: Optional[StrictInt] = None
    id_gte: Optional[StrictInt] = None
    id_lt: Optional[StrictInt] = None
    id_lte: Optional[StrictInt] = None
    limit: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    offset: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id_gt", "id_gte", "id_lt", "id_lte", "limit", "offset"]
