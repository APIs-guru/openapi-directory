...
class Message(BaseModel):
    ...
    """ # noqa: E501
    attachments: List[Optional[Attachment]] = Field(description="Array of message attachments")
    ...
    cid: StrictStr = Field(description="Channel unique identifier in <type>:<id> format")
    ...
    html: StrictStr = Field(description="Contains HTML markup of the message. Can only be set when using server-side API")
    ...
    id: StrictStr = Field(description="Message ID is unique string identifier of the message")
    image_labels: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Contains image moderation information")
    latest_reactions: List[Optional[Reaction]] = Field(description="List of 10 latest reactions to this message")
    mentioned_users: List[UserObject] = Field(description="List of mentioned users")
    ...
    own_reactions: List[Optional[Reaction]] = Field(description="List of 10 latest reactions of authenticated user to this message")
    ...
    pinned: StrictBool = Field(description="Whether message is pinned or not")
    ...
    reaction_counts: Dict[str, StrictInt] = Field(description="An object containing number of reactions of each type. Key: reaction type (string), value: number of reactions (int)")
    reaction_scores: Dict[str, StrictInt] = Field(description="An object containing scores of reactions of each type. Key: reaction type (string), value: total score of reactions (int)")
    reply_count: StrictInt = Field(description="Number of replies to this message")
    shadowed: StrictBool = Field(description="Whether the message was shadowed or not")
    ...
    silent: StrictBool = Field(description="Whether message is silent or not")
    text: StrictStr = Field(description="Text of the message. Should be empty if `mml` is provided")
    thread_participants: Optional[List[UserObject]] = Field(default=None, description="List of users who participate in thread")
    type: StrictStr = Field(description="Contains type of the message")
