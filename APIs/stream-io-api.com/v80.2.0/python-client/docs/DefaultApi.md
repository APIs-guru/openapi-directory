...
------------- | ------------- | -------------
[**commit_message**](DefaultApi.md#commit_message) | **POST** /messages/{id}/commit | Commit message
[**create_call**](DefaultApi.md#create_call) | **POST** /channels/{type}/{id}/call | Create a call
[**get_call_token1**](DefaultApi.md#get_call_token1) | **POST** /calls/ | Get Call Token ()
[**get_call_token_call_id0**](DefaultApi.md#get_call_token_call_id0) | **POST** /calls/{call_id} | Get Call Token (call_id)


# **commit_message**
> MessageResponse commit_message(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Commit message
        api_response = api_instance.commit_message(id)
        print("The response of DefaultApi->commit_message:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->commit_message: %s\n" % e)
```
...
# **create_call**
> CreateCallResponse create_call(type, id, create_call_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    create_call_request = openapi_client.CreateCallRequest() # CreateCallRequest | 

    try:
        # Create a call
        api_response = api_instance.create_call(type, id, create_call_request)
        print("The response of DefaultApi->create_call:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_call_token1**
> GetCallTokenResponse get_call_token1(get_call_token_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    get_call_token_request = openapi_client.GetCallTokenRequest() # GetCallTokenRequest | 

    try:
        # Get Call Token ()
        api_response = api_instance.get_call_token1(get_call_token_request)
        print("The response of DefaultApi->get_call_token1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_call_token1: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **get_call_token_request** | [**GetCallTokenRequest**](GetCallTokenRequest.md)|  | 
...
# **get_call_token_call_id0**
> GetCallTokenResponse get_call_token_call_id0(call_id, get_call_token_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Call Token (call_id)
        api_response = api_instance.get_call_token_call_id0(call_id, get_call_token_request)
        print("The response of DefaultApi->get_call_token_call_id0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_call_token_call_id0: %s\n" % e)
```
