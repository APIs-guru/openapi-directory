...
[**create_segment**](CampaignsApi.md#create_segment) | **POST** /segments | Create segment
[**delete_campaign**](CampaignsApi.md#delete_campaign) | **DELETE** /campaigns/{id} | Delete campaign
[**delete_segment**](CampaignsApi.md#delete_segment) | **DELETE** /segments/{id} | Delete segment
[**query_campaigns**](CampaignsApi.md#query_campaigns) | **GET** /campaigns | Query campaigns
[**query_recipients**](CampaignsApi.md#query_recipients) | **GET** /recipients | Query recipients
[**query_segments**](CampaignsApi.md#query_segments) | **GET** /segments | Query segments
[**resume_campaign**](CampaignsApi.md#resume_campaign) | **PATCH** /campaigns/{id}/resume | Resume campaign
[**schedule_campaign**](CampaignsApi.md#schedule_campaign) | **PATCH** /campaigns/{id}/schedule | Schedule campaign
[**stop_campaign**](CampaignsApi.md#stop_campaign) | **PATCH** /campaigns/{id}/stop | Stop campaign
[**test_campaign**](CampaignsApi.md#test_campaign) | **POST** /campaigns/{id}/test | Test campaign
[**update_campaign**](CampaignsApi.md#update_campaign) | **PUT** /campaigns/{id} | Update campaign
[**update_segment**](CampaignsApi.md#update_segment) | **PUT** /segments/{id} | Update segment


# **create_campaign**
> CreateCampaignResponse create_campaign(create_campaign_request)
...
# **create_segment**
> CreateSegmentResponse create_segment(create_segment_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create segment
        api_response = api_instance.create_segment(create_segment_request)
        print("The response of CampaignsApi->create_segment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->create_segment: %s\n" % e)
```
...
# **delete_campaign**
> DeleteCampaignResponse delete_campaign(id, recipients=recipients)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CampaignsApi(api_client)
    id = 'id_example' # str | 
    recipients = True # bool |  (optional)

    try:
        # Delete campaign
        api_response = api_instance.delete_campaign(id, recipients=recipients)
...
# **delete_segment**
> DeleteSegmentResponse delete_segment(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CampaignsApi->delete_segment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->delete_segment: %s\n" % e)
```
...
# **query_campaigns**
> QueryCampaignsResponse query_campaigns(payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.CampaignsApi(api_client)
    payload = openapi_client.QueryCampaignsRequest() # QueryCampaignsRequest |  (optional)

    try:
        # Query campaigns
        api_response = api_instance.query_campaigns(payload=payload)
        print("The response of CampaignsApi->query_campaigns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->query_campaigns: %s\n" % e)
```
...
# **query_recipients**
> QueryRecipientsResponse query_recipients(payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.CampaignsApi(api_client)
    payload = openapi_client.QueryRecipientsRequest() # QueryRecipientsRequest |  (optional)

    try:
        # Query recipients
        api_response = api_instance.query_recipients(payload=payload)
        print("The response of CampaignsApi->query_recipients:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->query_recipients: %s\n" % e)
```
...
# **query_segments**
> QuerySegmentsResponse query_segments(payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.CampaignsApi(api_client)
    payload = openapi_client.QuerySegmentsRequest() # QuerySegmentsRequest |  (optional)

    try:
        # Query segments
        api_response = api_instance.query_segments(payload=payload)
        print("The response of CampaignsApi->query_segments:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->query_segments: %s\n" % e)
```
...
# **resume_campaign**
> ResumeCampaignResponse resume_campaign(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Resume campaign
        api_response = api_instance.resume_campaign(id)
        print("The response of CampaignsApi->resume_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->resume_campaign: %s\n" % e)
```
...
# **schedule_campaign**
> ScheduleCampaignResponse schedule_campaign(id, schedule_campaign_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CampaignsApi(api_client)
    id = 'id_example' # str | 
    schedule_campaign_request = openapi_client.ScheduleCampaignRequest() # ScheduleCampaignRequest | 

    try:
        # Schedule campaign
        api_response = api_instance.schedule_campaign(id, schedule_campaign_request)
...
# **stop_campaign**
> StopCampaignResponse stop_campaign(id)
...
# **test_campaign**
> TestCampaignResponse test_campaign(id, test_campaign_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CampaignsApi(api_client)
    id = 'id_example' # str | 
    test_campaign_request = openapi_client.TestCampaignRequest() # TestCampaignRequest | 

    try:
        # Test campaign
        api_response = api_instance.test_campaign(id, test_campaign_request)
        print("The response of CampaignsApi->test_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->test_campaign: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**|  | 
 **test_campaign_request** | [**TestCampaignRequest**](TestCampaignRequest.md)|  | 
...
# **update_campaign**
> UpdateCampaignResponse update_campaign(id, update_campaign_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CampaignsApi(api_client)
    id = 'id_example' # str | 
    update_campaign_request = openapi_client.UpdateCampaignRequest() # UpdateCampaignRequest | 

    try:
        # Update campaign
        api_response = api_instance.update_campaign(id, update_campaign_request)
...
# **update_segment**
> UpdateSegmentResponse update_segment(id, update_segment_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CampaignsApi(api_client)
    id = 'id_example' # str | 
    update_segment_request = openapi_client.UpdateSegmentRequest() # UpdateSegmentRequest | 

    try:
        # Update segment
        api_response = api_instance.update_segment(id, update_segment_request)
        print("The response of CampaignsApi->update_segment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->update_segment: %s\n" % e)
```
