# openapi_client.PermissionsV2Api

All URIs are relative to *https://chat.stream-io-api.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_role**](PermissionsV2Api.md#create_role) | **POST** /roles | Create role
[**delete_role**](PermissionsV2Api.md#delete_role) | **DELETE** /roles/{name} | Delete role
[**get_permission**](PermissionsV2Api.md#get_permission) | **GET** /permissions/{id} | Get permission
[**list_permissions**](PermissionsV2Api.md#list_permissions) | **GET** /permissions | List permissions
[**list_roles**](PermissionsV2Api.md#list_roles) | **GET** /roles | List roles


# **create_role**
> CreateRoleResponse create_role(create_role_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PermissionsV2Api(api_client)
    create_role_request = openapi_client.CreateRoleRequest() # CreateRoleRequest | 

    try:
        # Create role
        api_response = api_instance.create_role(create_role_request)
        print("The response of PermissionsV2Api->create_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsV2Api->create_role: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PermissionsV2Api->delete_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsV2Api->delete_role: %s\n" % e)
```
...
# **get_permission**
> GetCustomPermissionResponse get_permission(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get permission
        api_response = api_instance.get_permission(id)
        print("The response of PermissionsV2Api->get_permission:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsV2Api->get_permission: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PermissionsV2Api->list_permissions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsV2Api->list_permissions: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PermissionsV2Api->list_roles:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsV2Api->list_roles: %s\n" % e)
```
