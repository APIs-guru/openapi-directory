...
[**create_guest**](UsersApi.md#create_guest) | **POST** /guest | Create guest
[**deactivate_user**](UsersApi.md#deactivate_user) | **POST** /users/{user_id}/deactivate | Deactivate user
[**deactivate_users**](UsersApi.md#deactivate_users) | **POST** /users/deactivate | Deactivate users
[**delete_user**](UsersApi.md#delete_user) | **DELETE** /users/{user_id} | Delete user
[**delete_users**](UsersApi.md#delete_users) | **POST** /users/delete | Delete Users
[**export_user**](UsersApi.md#export_user) | **POST** /export/users | Export users
[**flag_1**](UsersApi.md#flag_1) | **POST** /moderation/flag | Flag
[**long_poll**](UsersApi.md#long_poll) | **GET** /longpoll | Long Poll (Transport)
[**mute_user**](UsersApi.md#mute_user) | **POST** /moderation/mute | Mute user
[**query_banned_users**](UsersApi.md#query_banned_users) | **GET** /query_banned_users | Query Banned Users
[**query_users**](UsersApi.md#query_users) | **GET** /users | Query users
[**reactivate_user**](UsersApi.md#reactivate_user) | **POST** /users/{user_id}/reactivate | Reactivate user
[**reactivate_users**](UsersApi.md#reactivate_users) | **POST** /users/reactivate | Reactivate users
[**restore_users**](UsersApi.md#restore_users) | **POST** /users/restore | Restore users
[**unban**](UsersApi.md#unban) | **DELETE** /moderation/ban | Unban user
[**unflag_1**](UsersApi.md#unflag_1) | **POST** /moderation/unflag | Unflag
[**unmute_user**](UsersApi.md#unmute_user) | **POST** /moderation/unmute | Unmute user
[**update_users**](UsersApi.md#update_users) | **POST** /users | Upsert users
[**update_users_partial**](UsersApi.md#update_users_partial) | **PATCH** /users | Partially update user
[**users_user_id_export_get**](UsersApi.md#users_user_id_export_get) | **GET** /users/{user_id}/export | Export user


# **ban**
> Response ban(ban_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Ban user
        api_response = api_instance.ban(ban_request)
        print("The response of UsersApi->ban:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->ban: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    var_json = openapi_client.ConnectRequest() # ConnectRequest |  (optional)

    try:
        # Connect (WebSocket)
        api_instance.connect(var_json=var_json)
    except Exception as e:
        print("Exception when calling UsersApi->connect: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **var_json** | [**ConnectRequest**](.md)|  | [optional] 
...
# **create_guest**
> GuestResponse create_guest(guest_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    guest_request = openapi_client.GuestRequest() # GuestRequest | 

    try:
        # Create guest
        api_response = api_instance.create_guest(guest_request)
        print("The response of UsersApi->create_guest:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->create_guest: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **guest_request** | [**GuestRequest**](GuestRequest.md)|  | 
...
# **deactivate_user**
> DeactivateUserResponse deactivate_user(user_id, deactivate_user_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deactivate user
        api_response = api_instance.deactivate_user(user_id, deactivate_user_request)
...
# **deactivate_users**
> DeactivateUsersResponse deactivate_users(deactivate_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deactivate users
        api_response = api_instance.deactivate_users(deactivate_users_request)
        print("The response of UsersApi->deactivate_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->deactivate_users: %s\n" % e)
```
...
# **delete_user**
> DeleteUserResponse delete_user(user_id, mark_messages_deleted=mark_messages_deleted, hard_delete=hard_delete, delete_conversation_channels=delete_conversation_channels)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete user
        api_response = api_instance.delete_user(user_id, mark_messages_deleted=mark_messages_deleted, hard_delete=hard_delete, delete_conversation_channels=delete_conversation_channels)
...
# **delete_users**
> DeleteUsersResponse delete_users(delete_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Users
        api_response = api_instance.delete_users(delete_users_request)
...
# **export_user**
> ExportUsersResponse export_user(export_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    export_users_request = openapi_client.ExportUsersRequest() # ExportUsersRequest | 

    try:
        # Export users
        api_response = api_instance.export_user(export_users_request)
        print("The response of UsersApi->export_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->export_user: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **export_users_request** | [**ExportUsersRequest**](ExportUsersRequest.md)|  | 
...
# **flag_1**
> FlagResponse flag_1(flag_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Flag
        api_response = api_instance.flag_1(flag_request)
        print("The response of UsersApi->flag_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->flag_1: %s\n" % e)
```
...
# **long_poll**
> long_poll(var_json=var_json, connection_id=connection_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Long Poll (Transport)
        api_instance.long_poll(var_json=var_json, connection_id=connection_id)
    except Exception as e:
        print("Exception when calling UsersApi->long_poll: %s\n" % e)
```
...
# **mute_user**
> MuteUserResponse mute_user(mute_user_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Mute user
        api_response = api_instance.mute_user(mute_user_request)
        print("The response of UsersApi->mute_user:\n")
        pprint(api_response)
    except Exception as e:
...
# **query_banned_users**
> QueryBannedUsersResponse query_banned_users(payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Query Banned Users
        api_response = api_instance.query_banned_users(payload=payload)
        print("The response of UsersApi->query_banned_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->query_banned_users: %s\n" % e)
```
...
# **query_users**
> UsersResponse query_users(payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    payload = openapi_client.QueryUsersRequest() # QueryUsersRequest |  (optional)

    try:
        # Query users
        api_response = api_instance.query_users(payload=payload)
        print("The response of UsersApi->query_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->query_users: %s\n" % e)
```
...
# **reactivate_user**
> ReactivateUserResponse reactivate_user(user_id, reactivate_user_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Reactivate user
        api_response = api_instance.reactivate_user(user_id, reactivate_user_request)
        print("The response of UsersApi->reactivate_user:\n")
        pprint(api_response)
    except Exception as e:
...
# **reactivate_users**
> ReactivateUsersResponse reactivate_users(reactivate_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Reactivate users
        api_response = api_instance.reactivate_users(reactivate_users_request)
        print("The response of UsersApi->reactivate_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->reactivate_users: %s\n" % e)
```
...
# **restore_users**
> Response restore_users(restore_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    restore_users_request = openapi_client.RestoreUsersRequest() # RestoreUsersRequest | 

    try:
        # Restore users
        api_response = api_instance.restore_users(restore_users_request)
        print("The response of UsersApi->restore_users:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->restore_users: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **restore_users_request** | [**RestoreUsersRequest**](RestoreUsersRequest.md)|  | 
...
# **unban**
> Response unban(target_user_id=target_user_id, type=type, id=id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Unban user
        api_response = api_instance.unban(target_user_id=target_user_id, type=type, id=id)
        print("The response of UsersApi->unban:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->unban: %s\n" % e)
```
...
# **unflag_1**
> FlagResponse unflag_1(flag_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Unflag
        api_response = api_instance.unflag_1(flag_request)
        print("The response of UsersApi->unflag_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->unflag_1: %s\n" % e)
```
...
# **unmute_user**
> UnmuteResponse unmute_user(unmute_user_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Unmute user
        api_response = api_instance.unmute_user(unmute_user_request)
        print("The response of UsersApi->unmute_user:\n")
        pprint(api_response)
    except Exception as e:
...
# **update_users**
> UpdateUsersResponse update_users(update_users_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    update_users_request = openapi_client.UpdateUsersRequest() # UpdateUsersRequest | 

    try:
        # Upsert users
        api_response = api_instance.update_users(update_users_request)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_users_request** | [**UpdateUsersRequest**](UpdateUsersRequest.md)|  | 
...
> UpdateUsersResponse update_users_partial(update_user_partial_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UsersApi(api_client)
    update_user_partial_request = openapi_client.UpdateUserPartialRequest() # UpdateUserPartialRequest | 

    try:
        # Partially update user
        api_response = api_instance.update_users_partial(update_user_partial_request)
        print("The response of UsersApi->update_users_partial:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->update_users_partial: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_user_partial_request** | [**UpdateUserPartialRequest**](UpdateUserPartialRequest.md)|  | 
...
# **users_user_id_export_get**
> ExportUserResponse users_user_id_export_get(user_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Export user
        api_response = api_instance.users_user_id_export_get(user_id)
        print("The response of UsersApi->users_user_id_export_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->users_user_id_export_get: %s\n" % e)
```
