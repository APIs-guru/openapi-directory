...
class TestIntervalCollectionResponse(unittest.TestCase):
    """IntervalCollectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntervalCollectionResponse:
        """Test IntervalCollectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntervalCollectionResponse`
        """
        model = IntervalCollectionResponse()
        if include_optional:
            return IntervalCollectionResponse(
                data = openapi_client.models.interval_collection.IntervalCollection(
                    base_currency = '', 
                    intervals = [
    ...
    def testIntervalCollectionResponse(self):
        """Test IntervalCollectionResponse"""
