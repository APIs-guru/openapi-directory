...
class StatusDTO(BaseModel):
    ...
    """ # noqa: E501
    message_id: Optional[StrictStr] = Field(default=None, description="Reference id for status endpoint             ", alias="messageId")
    status_text: Optional[StrictStr] = Field(default=None, description="Status of API Call             ", alias="statusText")
    url: Optional[StrictStr] = Field(default=None, description="Relative url for stauts check             ")
    __properties: ClassVar[List[str]] = ["messageId", "statusText", "url"]
