...
class GymDTO(BaseModel):
    ...
    """ # noqa: E501
    external_gym_number: Optional[StrictInt] = Field(default=None, alias="externalGymNumber")
    gym_id: Optional[StrictInt] = Field(default=None, alias="gymId")
    gym_name: Optional[StrictStr] = Field(default=None, alias="gymName")
    location: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["externalGymNumber", "gymId", "gymName", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "externalGymNumber": obj.get("externalGymNumber"),
            "gymId": obj.get("gymId"),
