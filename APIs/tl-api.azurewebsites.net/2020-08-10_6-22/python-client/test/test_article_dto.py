...
class TestArticleDTO(unittest.TestCase):
    """ArticleDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArticleDTO:
        """Test ArticleDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArticleDTO`
        """
        model = ArticleDTO()
        if include_optional:
            return ArticleDTO(
