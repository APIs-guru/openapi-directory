...
class TestPackageSearchDTO(unittest.TestCase):
    """PackageSearchDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackageSearchDTO:
        """Test PackageSearchDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackageSearchDTO`
        """
        model = PackageSearchDTO()
        if include_optional:
