...
class TestDefaultResponseDTOOfPackageDTOResult(unittest.TestCase):
    """DefaultResponseDTOOfPackageDTOResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultResponseDTOOfPackageDTOResult:
        """Test DefaultResponseDTOOfPackageDTOResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultResponseDTOOfPackageDTOResult`
        """
        model = DefaultResponseDTOOfPackageDTOResult()
        if include_optional:
    ...
    def testDefaultResponseDTOOfPackageDTOResult(self):
        """Test DefaultResponseDTOOfPackageDTOResult"""
