...
class LogApi:
    ...
    def get_log_collection(
        ...
        _param = self._get_log_collection_serialize(
            page=page,
    ...
    @validate_call
    def get_log_collection_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        project_id: Optional[StrictStr] = None,
        created_at: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_log_collection_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        project_id: Optional[StrictStr] = None,
        created_at: Optional[StrictStr] = None,
    ...
    def _get_log_collection_serialize(
        self,
        page,
        project_id,
        created_at,
    ...
    def get_log_item(
        ...
        _param = self._get_log_item_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_log_item_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_log_item_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
