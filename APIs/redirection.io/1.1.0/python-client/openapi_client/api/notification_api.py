...
class NotificationApi:
    ...
    def get_notification_collection(
        ...
        _param = self._get_notification_collection_serialize(
            page=page,
    ...
    @validate_call
    def get_notification_collection_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_notification_collection_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_notification_collection_serialize(
        self,
        page,
        _request_auth,
        _content_type,
    ...
    def get_notification_item(
        ...
        _param = self._get_notification_item_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_notification_item_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_notification_item_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_notification_item_serialize(
        self,
        id,
        _request_auth,
        _content_type,
