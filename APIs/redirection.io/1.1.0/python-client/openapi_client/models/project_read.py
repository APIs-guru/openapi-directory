...
class ProjectRead(BaseModel):
    ...
    current_version: Optional[RuleSetVersionRead] = Field(default=None, alias="currentVersion")
    ...
    user_projects: Optional[List[UserProjectRead]] = Field(default=None, alias="userProjects")
    users_flattened: Optional[List[UserProjectFlattenedRead]] = Field(default=None, alias="usersFlattened")
    working_version: Optional[RuleSetVersionRead] = Field(default=None, alias="workingVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currentVersion": RuleSetVersionRead.from_dict(obj["currentVersion"]) if obj.get("currentVersion") is not None else None,
            "id": obj.get("id"),
            ...
            "userProjects": [UserProjectRead.from_dict(_item) for _item in obj["userProjects"]] if obj.get("userProjects") is not None else None,
            "usersFlattened": [UserProjectFlattenedRead.from_dict(_item) for _item in obj["usersFlattened"]] if obj.get("usersFlattened") is not None else None,
            "workingVersion": RuleSetVersionRead.from_dict(obj["workingVersion"]) if obj.get("workingVersion") is not None else None
        })
        return _obj
