...
class TestSummaryOrganisationsInner(unittest.TestCase):
    """SummaryOrganisationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SummaryOrganisationsInner:
        """Test SummaryOrganisationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryOrganisationsInner`
        """
        model = SummaryOrganisationsInner()
        if include_optional:
            return SummaryOrganisationsInner(
                addons = [
    ...
    def testSummaryOrganisationsInner(self):
        """Test SummaryOrganisationsInner"""
