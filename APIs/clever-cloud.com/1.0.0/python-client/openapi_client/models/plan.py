...
class Plan(BaseModel):
    ...
    Plan
    """ # noqa: E501
    features: List[Feature] = Field(description="The list of the feature in the addon")
    id: StrictStr = Field(description="`plan_${uuid}`")
    name: StrictStr = Field(description="Name of the pan")
    price: StrictInt
    slug: StrictStr
    __properties: ClassVar[List[str]] = ["features", "id", "name", "price", "slug"]
