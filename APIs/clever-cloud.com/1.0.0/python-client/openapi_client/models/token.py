...
class Token(BaseModel):
    ...
    last_utilisation: StrictStr = Field(alias="lastUtilisation")
    rights: Rights
    token: StrictStr
    __properties: ClassVar[List[str]] = ["consumer", "creationDate", "lastUtilisation", "rights", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumer": Consumer.from_dict(obj["consumer"]) if obj.get("consumer") is not None else None,
            "creationDate": obj.get("creationDate"),
            "lastUtilisation": obj.get("lastUtilisation"),
