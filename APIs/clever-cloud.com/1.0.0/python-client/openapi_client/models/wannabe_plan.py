...
class WannabePlan(BaseModel):
    ...
    price: StrictInt
    slug: StrictStr
    __properties: ClassVar[List[str]] = ["features", "name", "price", "slug"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": [WannabePlanFeature.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None,
            "name": obj.get("name"),
            "price": obj.get("price"),
            "slug": obj.get("slug")
        })
