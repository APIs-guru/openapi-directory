...
class LinkedAppEnv(BaseModel):
    ...
    app_name: StrictStr
    env: List[WannabeEnv]
    __properties: ClassVar[List[str]] = ["app_id", "app_name", "env"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "env": [WannabeEnv.from_dict(_item) for _item in obj["env"]] if obj.get("env") is not None else None
        })
        return _obj
