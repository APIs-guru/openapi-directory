...
class WannabeAddonProvider(BaseModel):
    """
    ...
    id: StrictStr
    name: StrictStr
    __properties: ClassVar[List[str]] = ["api", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": WannabeAddonProviderAPI.from_dict(obj["api"]) if obj.get("api") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
