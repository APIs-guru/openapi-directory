...
class SummaryOrganisationsInner(BaseModel):
    """
    SummaryOrganisationsInner
    """ # noqa: E501
    addons: Optional[List[SummaryOrganisationsInnerAddonsInner]] = None
    applications: Optional[List[SummaryOrganisationsInnerApplicationsInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["addons", "applications", "avatar", "consumers", "id", "name", "providers", "role"]
