...
class Deployment(BaseModel):
    ...
    repo_state: StrictStr = Field(alias="repoState")
    shutdownable: StrictBool
    type: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["httpUrl", "repoState", "shutdownable", "type", "url"]
