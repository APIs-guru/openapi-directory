...
class AppInstance(BaseModel):
    ...
    app_port: Optional[StrictInt] = Field(default=None, alias="appPort")
    commit: Optional[StrictStr] = None
    deploy_number: Optional[StrictInt] = Field(default=None, alias="deployNumber")
    flavor: Optional[Flavor] = None
    id: Optional[StrictStr] = None
    ip: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["appId", "appPort", "commit", "deployNumber", "flavor", "id", "ip", "state"]
