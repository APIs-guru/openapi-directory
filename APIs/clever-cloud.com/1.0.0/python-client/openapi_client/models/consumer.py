...
class Consumer(BaseModel):
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["baseUrl", "description", "key", "name", "picture", "rights", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rights": ConsumerRights.from_dict(obj["rights"]) if obj.get("rights") is not None else None,
            "url": obj.get("url")
        })
        return _obj
