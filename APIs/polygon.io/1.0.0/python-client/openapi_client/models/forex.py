...
class Forex(BaseModel):
    ...
    Forex
    """ # noqa: E501
    a: Optional[StrictInt] = Field(default=None, description="Ask price")
    b: Optional[StrictInt] = Field(default=None, description="Bid price")
    t: Optional[StrictInt] = Field(default=None, description="Timestamp of this trade")
    __properties: ClassVar[List[str]] = ["a", "b", "t"]
