...
class AttachmentEdit(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachmentEdit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachmentEdit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attachment": AttachmentEditFields.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
