...
class CustomFieldSelectOptionFields(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the Custom Field Select Option")
    value: Optional[StrictStr] = Field(default=None, description="Value given to the Custom Field Select Option")
