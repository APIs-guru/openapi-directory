...
class CustomerFieldsWithBillingAddressAndShippingAddressFields(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the Customer")
    shipping_address: Optional[ShippingAddress] = None
    __properties: ClassVar[List[str]] = ["billing_address", "id", "shipping_address"]
