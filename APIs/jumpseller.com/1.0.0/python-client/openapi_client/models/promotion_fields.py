...
class PromotionFields(BaseModel):
    ...
    condition_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum order amount to validate the promotion")
    condition_qty: Optional[StrictInt] = Field(default=None, description="Minimum quantity of ordered itens to validate the promotion")
    ...
    discount_amount_fix: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fixed discount amount of the promotion")
    discount_amount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentual discount amount of the promotion")
    ...
    enabled: Optional[StrictBool] = Field(default=True, description="If the promotion is currently enabled")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the promotion ('active', 'expired')")
    times_used: Optional[StrictInt] = Field(default=None, description="Amount of times the promotion was used")
    __properties: ClassVar[List[str]] = ["begins_at", "categories", "code", "condition_price", "condition_qty", "cumulative", "customer_categories", "discount_amount_fix", "discount_amount_percent", "discount_target", "enabled", "expires_at", "id", "lasts", "max_times_used", "name", "products", "products_x", "quantity_x", "status", "times_used"]
