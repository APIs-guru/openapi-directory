...
class HookEdit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HookEdit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HookEdit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hook": HookEditFields.from_dict(obj["hook"]) if obj.get("hook") is not None else None
        })
        return _obj
