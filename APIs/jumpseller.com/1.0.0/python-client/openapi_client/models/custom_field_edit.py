...
class CustomFieldEdit(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomFieldEdit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomFieldEdit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "custom_field": CustomFieldEditFields.from_dict(obj["custom_field"]) if obj.get("custom_field") is not None else None
        })
        return _obj
