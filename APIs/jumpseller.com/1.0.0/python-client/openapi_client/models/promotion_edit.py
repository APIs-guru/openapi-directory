...
class PromotionEdit(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PromotionEdit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PromotionEdit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "promotion": PromotionEditFields.from_dict(obj["promotion"]) if obj.get("promotion") is not None else None
        })
        return _obj
