...
class ProductEditFields(BaseModel):
    ...
    meta_description: Optional[StrictStr] = Field(default=None, description="SEO meta description of the product")
    ...
    page_title: Optional[StrictStr] = Field(default=None, description="SEO title of the product")
    permalink: Optional[StrictStr] = Field(default=None, description="Product unique URL path")
    price: Union[StrictFloat, StrictInt] = Field(description="Price of the product")
    shipping_required: Optional[StrictBool] = Field(default=True, description="False if the product is digital")
    ...
    __properties: ClassVar[List[str]] = ["barcode", "categories", "description", "diameter", "featured", "google_product_category", "height", "length", "meta_description", "name", "package_format", "page_title", "permalink", "price", "shipping_required", "sku", "status", "stock", "stock_unlimited", "weight", "width"]
