...
class VariantFields(BaseModel):
    ...
    sku: Optional[StrictStr] = Field(default=None, description="Stock Keeping Unit of the Product's Variant")
    stock: Optional[StrictInt] = Field(default=100, description="Quantity in stock for the Product's Variant")
    stock_unlimited: Optional[StrictBool] = Field(default=None, description="True if the Product's Variant has unlimited stock")
    __properties: ClassVar[List[str]] = ["id", "image", "options", "price", "sku", "stock", "stock_unlimited"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [ProductOptionVariantEdit.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
            "price": obj.get("price"),
            "sku": obj.get("sku"),
