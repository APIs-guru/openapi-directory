...
class AddProductCustomField(BaseModel):
    ...
    """ # noqa: E501
    var_field: Optional[AddProductCustomFieldFields] = Field(default=None, alias="field")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddProductCustomField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddProductCustomField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "field": AddProductCustomFieldFields.from_dict(obj["field"]) if obj.get("field") is not None else None
        })
        return _obj
