...
class OrderAdditionalFields(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Label of the additional field")
    value: Optional[StrictStr] = Field(default=None, description="Value of the additional field")
