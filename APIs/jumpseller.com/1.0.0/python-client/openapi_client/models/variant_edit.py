...
class VariantEdit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["variant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VariantEdit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VariantEdit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "variant": VariantEditFields.from_dict(obj["variant"]) if obj.get("variant") is not None else None
        })
        return _obj
