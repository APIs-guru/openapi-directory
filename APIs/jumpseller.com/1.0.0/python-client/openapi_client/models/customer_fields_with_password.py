...
class CustomerFieldsWithPassword(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Email of the Customer")
    ...
    phone: Optional[StrictStr] = Field(default=None, description="Phone of the Customer")
    shipping_address: Optional[ShippingAddress] = None
    status: Optional[StrictStr] = Field(default=None, description="Status of the Customer")
    __properties: ClassVar[List[str]] = ["billing_address", "email", "id", "password", "phone", "shipping_address", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['approved', 'pending', 'disabled']):
            raise ValueError("must be one of enum values ('approved', 'pending', 'disabled')")
        return value
