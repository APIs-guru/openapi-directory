...
class OrdersData(BaseModel):
    ...
    paid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount paid.")
    pending: Optional[Union[StrictFloat, StrictInt]] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["average", "count", "date", "paid", "pending", "total"]
