...
class CountryOrders(BaseModel):
    ...
    count: Optional[StrictInt] = Field(default=None, description="Number of country orders.")
    country: Optional[StrictStr] = None
    orders: Optional[List[RegionOrders]] = Field(default=None, description="Orders per region.")
    __properties: ClassVar[List[str]] = ["code", "count", "country", "orders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orders": [RegionOrders.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
