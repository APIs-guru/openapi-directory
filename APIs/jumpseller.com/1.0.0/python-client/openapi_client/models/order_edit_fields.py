...
class OrderEditFields(BaseModel):
    ...
    shipment_status: Optional[StrictStr] = Field(default=None, description="Status of the Order Shipping")
    status: Optional[StrictStr] = Field(default=None, description="Status of the Order")
    tracking_company: Optional[StrictStr] = Field(default=None, description="Shipping Company used for the given Order")
    tracking_number: Optional[StrictStr] = Field(default=None, description="Shipping Tracking Number used for the given Order")
    tracking_url: Optional[StrictStr] = Field(default=None, description="URL to check delivery information for the given Order")
    __properties: ClassVar[List[str]] = ["additional_fields", "additional_information", "shipment_status", "status", "tracking_company", "tracking_number", "tracking_url"]
    ...
    def shipment_status_validate_enum(cls, value):
        ...
        if value not in set(['requested', 'in_transit', 'delivered', 'failed', 'pickup_available']):
            raise ValueError("must be one of enum values ('requested', 'in_transit', 'delivered', 'failed', 'pickup_available')")
        return value
