...
class CustomerFieldsWithPasswordNoID(BaseModel):
    ...
    customer_category: Optional[List[StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["billing_address", "customer_category", "email", "password", "phone", "shipping_address", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer_category": obj.get("customer_category"),
            "email": obj.get("email"),
