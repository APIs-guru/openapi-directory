...
class AttachmentFields(BaseModel):
    ...
    AttachmentFields
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the attachment")
    url: Optional[StrictStr] = Field(default=None, description="Private URL of the attachment")
