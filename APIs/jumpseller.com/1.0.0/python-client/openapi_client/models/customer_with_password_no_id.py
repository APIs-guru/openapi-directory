...
class CustomerWithPasswordNoID(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerWithPasswordNoID from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerWithPasswordNoID from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "customer": CustomerFieldsWithPasswordNoID.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
