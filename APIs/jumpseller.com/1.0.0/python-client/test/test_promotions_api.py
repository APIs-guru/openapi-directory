...
class TestPromotionsApi(unittest.TestCase):
    ...
    def test_promotions_id_json_delete(self) -> None:
    ...
    def test_promotions_id_json_get(self) -> None:
    ...
    def test_promotions_id_json_put(self) -> None:
    ...
    def test_promotions_json_get(self) -> None:
    ...
    def test_promotions_json_post(self) -> None:
