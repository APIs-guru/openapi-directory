...
class TestCustomerCategoriesApi(unittest.TestCase):
    ...
    def test_customer_categories_id_customers_json_delete(self) -> None:
    ...
    def test_customer_categories_id_customers_json_get(self) -> None:
    ...
    def test_customer_categories_id_customers_json_post(self) -> None:
    ...
    def test_customer_categories_id_json_delete(self) -> None:
    ...
    def test_customer_categories_id_json_get(self) -> None:
    ...
    def test_customer_categories_id_json_put(self) -> None:
    ...
    def test_customer_categories_json_get(self) -> None:
    ...
    def test_customer_categories_json_post(self) -> None:
