...
class TestProductOptionsApi(unittest.TestCase):
    """ProductOptionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProductOptionsApi()

    def tearDown(self) -> None:
        pass

    def test_products_id_options_count_json_get(self) -> None:
    ...
    def test_products_id_options_json_get(self) -> None:
    ...
    def test_products_id_options_json_post(self) -> None:
    ...
    def test_products_id_options_option_id_json_delete(self) -> None:
    ...
    def test_products_id_options_option_id_json_get(self) -> None:
    ...
    def test_products_id_options_option_id_json_put(self) -> None:
