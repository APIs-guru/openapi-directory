...
class TestPagesApi(unittest.TestCase):
    ...
    def test_pages_count_json_get(self) -> None:
    ...
    def test_pages_id_json_delete(self) -> None:
    ...
    def test_pages_id_json_get(self) -> None:
    ...
    def test_pages_id_json_put(self) -> None:
    ...
    def test_pages_json_get(self) -> None:
    ...
    def test_pages_json_post(self) -> None:
