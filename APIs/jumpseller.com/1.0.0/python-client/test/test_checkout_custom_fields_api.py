...
class TestCheckoutCustomFieldsApi(unittest.TestCase):
    """CheckoutCustomFieldsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CheckoutCustomFieldsApi()

    def tearDown(self) -> None:
        pass

    def test_checkout_custom_fields_id_json_delete(self) -> None:
    ...
    def test_checkout_custom_fields_id_json_get(self) -> None:
    ...
    def test_checkout_custom_fields_id_json_put(self) -> None:
    ...
    def test_checkout_custom_fields_json_get(self) -> None:
    ...
    def test_checkout_custom_fields_json_post(self) -> None:
