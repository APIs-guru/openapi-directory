...
class TestProductAttachmentsApi(unittest.TestCase):
    """ProductAttachmentsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProductAttachmentsApi()

    def tearDown(self) -> None:
        pass

    def test_products_id_attachments_attachment_id_json_delete(self) -> None:
    ...
    def test_products_id_attachments_attachment_id_json_get(self) -> None:
    ...
    def test_products_id_attachments_count_json_get(self) -> None:
    ...
    def test_products_id_attachments_json_get(self) -> None:
    ...
    def test_products_id_attachments_json_post(self) -> None:
