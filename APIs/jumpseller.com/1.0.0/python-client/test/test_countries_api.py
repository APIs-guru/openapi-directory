...
class TestCountriesApi(unittest.TestCase):
    ...
    def test_countries_country_code_json_get(self) -> None:
    ...
    def test_countries_country_code_regions_json_get(self) -> None:
    ...
    def test_countries_country_code_regions_region_code_json_get(self) -> None:
    ...
    def test_countries_json_get(self) -> None:
