...
class TestCustomerAdditionalFieldsApi(unittest.TestCase):
    """CustomerAdditionalFieldsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomerAdditionalFieldsApi()

    def tearDown(self) -> None:
        pass

    def test_customers_id_fields_field_id_delete(self) -> None:
    ...
    def test_customers_id_fields_field_id_get(self) -> None:
    ...
    def test_customers_id_fields_field_id_put(self) -> None:
    ...
    def test_customers_id_fields_get(self) -> None:
    ...
    def test_customers_id_fields_post(self) -> None:
