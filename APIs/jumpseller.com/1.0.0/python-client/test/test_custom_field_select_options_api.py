...
class TestCustomFieldSelectOptionsApi(unittest.TestCase):
    """CustomFieldSelectOptionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomFieldSelectOptionsApi()

    def tearDown(self) -> None:
        pass

    def test_custom_fields_id_select_options_custom_field_select_option_id_json_get(self) -> None:
    ...
    def test_custom_fields_id_select_options_custom_field_select_option_id_json_put(self) -> None:
    ...
    def test_custom_fields_id_select_options_json_get(self) -> None:
    ...
    def test_custom_fields_id_select_options_json_post(self) -> None:
