...
class TestProductDigitalProductsApi(unittest.TestCase):
    """ProductDigitalProductsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProductDigitalProductsApi()

    def tearDown(self) -> None:
        pass

    def test_products_id_digital_products_count_json_get(self) -> None:
    ...
    def test_products_id_digital_products_digital_product_id_json_delete(self) -> None:
    ...
    def test_products_id_digital_products_digital_product_id_json_get(self) -> None:
    ...
    def test_products_id_digital_products_json_get(self) -> None:
    ...
    def test_products_id_digital_products_json_post(self) -> None:
