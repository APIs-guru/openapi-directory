...
class TestHooksApi(unittest.TestCase):
    ...
    def test_hooks_id_json_delete(self) -> None:
    ...
    def test_hooks_id_json_get(self) -> None:
    ...
    def test_hooks_id_json_put(self) -> None:
    ...
    def test_hooks_json_get(self) -> None:
    ...
    def test_hooks_json_post(self) -> None:
