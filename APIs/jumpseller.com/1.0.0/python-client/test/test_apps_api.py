...
class TestAppsApi(unittest.TestCase):
    ...
    def test_jsapps_code_json_delete(self) -> None:
    ...
    def test_jsapps_code_json_get(self) -> None:
    ...
    def test_jsapps_json_get(self) -> None:
    ...
    def test_jsapps_json_post(self) -> None:
