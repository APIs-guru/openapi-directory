...
class TestFulfillmentsApi(unittest.TestCase):
    ...
    def test_fulfillments_count_json_get(self) -> None:
    ...
    def test_fulfillments_id_json_get(self) -> None:
    ...
    def test_fulfillments_json_get(self) -> None:
    ...
    def test_order_id_fulfillments_json_get(self) -> None:
