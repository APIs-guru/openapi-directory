...
class TestCustomersApi(unittest.TestCase):
    ...
    def test_customers_count_json_get(self) -> None:
    ...
    def test_customers_email_email_json_get(self) -> None:
    ...
    def test_customers_id_json_delete(self) -> None:
    ...
    def test_customers_id_json_get(self) -> None:
    ...
    def test_customers_id_json_put(self) -> None:
    ...
    def test_customers_json_get(self) -> None:
    ...
    def test_customers_json_post(self) -> None:
