...
class TestShippingMethodsApi(unittest.TestCase):
    ...
    def test_shipping_methods_id_json_delete(self) -> None:
    ...
    def test_shipping_methods_id_json_get(self) -> None:
    ...
    def test_shipping_methods_id_json_put(self) -> None:
    ...
    def test_shipping_methods_json_get(self) -> None:
    ...
    def test_shipping_methods_json_post(self) -> None:
