...
class TestCustomFieldsApi(unittest.TestCase):
    ...
    def test_custom_fields_id_json_delete(self) -> None:
    ...
    def test_custom_fields_id_json_get(self) -> None:
    ...
    def test_custom_fields_id_json_put(self) -> None:
    ...
    def test_custom_fields_id_select_options_custom_field_select_option_id_json_delete(self) -> None:
    ...
    def test_custom_fields_json_get(self) -> None:
    ...
    def test_custom_fields_json_post(self) -> None:
