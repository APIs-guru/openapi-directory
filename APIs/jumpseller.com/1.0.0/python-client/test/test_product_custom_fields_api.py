...
class TestProductCustomFieldsApi(unittest.TestCase):
    """ProductCustomFieldsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProductCustomFieldsApi()

    def tearDown(self) -> None:
        pass

    def test_products_id_fields_count_json_get(self) -> None:
    ...
    def test_products_id_fields_json_get(self) -> None:
    ...
    def test_products_id_fields_json_post(self) -> None:
    ...
    def test_products_product_id_fields_field_id_json_delete(self) -> None:
    ...
    def test_products_product_id_fields_field_id_json_put(self) -> None:
