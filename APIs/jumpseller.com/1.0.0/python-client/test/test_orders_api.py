...
class TestOrdersApi(unittest.TestCase):
    ...
    def test_orders_after_id_json_get(self) -> None:
    ...
    def test_orders_count_json_get(self) -> None:
    ...
    def test_orders_id_history_json_get(self) -> None:
    ...
    def test_orders_id_history_json_post(self) -> None:
    ...
    def test_orders_id_json_get(self) -> None:
    ...
    def test_orders_id_json_put(self) -> None:
    ...
    def test_orders_json_get(self) -> None:
    ...
    def test_orders_json_post(self) -> None:
    ...
    def test_orders_status_status_json_get(self) -> None:
