...
from openapi_client.models.template_definition_pages_inner_margins import TemplateDefinitionPagesInnerMargins
...
class TemplateDefinitionPagesInner(BaseModel):
    ...
    margins: Optional[TemplateDefinitionPagesInnerMargins] = None
    width: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Page width in units")
    __properties: ClassVar[List[str]] = ["components", "height", "margins", "width"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "margins": TemplateDefinitionPagesInnerMargins.from_dict(obj["margins"]) if obj.get("margins") is not None else None,
            "width": obj.get("width")
        })
        return _obj
