...
class MergeTemplates200Response(BaseModel):
    """
    MergeTemplates200Response
    """ # noqa: E501
    meta: Optional[MergeTemplates200ResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": MergeTemplates200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
