...
from openapi_client.models.template_definition_layout_margins import TemplateDefinitionLayoutMargins
...
class TemplateDefinitionNewLayout(BaseModel):
    ...
    margins: Optional[TemplateDefinitionLayoutMargins] = None
    orientation: Optional[StrictStr] = Field(default=None, description="Page orientation")
    repeat_layout: Optional[TemplateDefinitionLayoutRepeatLayout] = Field(default=None, alias="repeatLayout")
    rotaion: Optional[StrictInt] = Field(default=None, description="Page rotation in degrees")
    ...
    __properties: ClassVar[List[str]] = ["emptyLabels", "format", "height", "margins", "orientation", "repeatLayout", "rotaion", "unit", "width"]
    ...
    @field_validator('rotaion')
    def rotaion_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "margins": TemplateDefinitionLayoutMargins.from_dict(obj["margins"]) if obj.get("margins") is not None else None,
            "orientation": obj.get("orientation"),
            "repeatLayout": TemplateDefinitionLayoutRepeatLayout.from_dict(obj["repeatLayout"]) if obj.get("repeatLayout") is not None else None,
            "rotaion": obj.get("rotaion"),
            "unit": obj.get("unit"),
            "width": obj.get("width")
        })
        return _obj
