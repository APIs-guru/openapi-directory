...
from openapi_client.models.template_definition_editor import TemplateDefinitionEditor
...
class TemplateDefinition(BaseModel):
    ...
    layout: Optional[TemplateDefinitionLayout] = None
    ...
    __properties: ClassVar[List[str]] = ["dataSettings", "editor", "id", "isDraft", "layout", "name", "pages", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "layout": TemplateDefinitionLayout.from_dict(obj["layout"]) if obj.get("layout") is not None else None,
            "name": obj.get("name"),
