...
class DocumentsApi:
    ...
    def merge_template(
        ...
        data: Annotated[Data, Field(description="Data used to generate the PDF. This can be JSON encoded string or a public URL to your JSON file.")],
        ...
        output: Annotated[Optional[StrictStr], Field(description="Response format. With the url option, the document is stored for 30 days and automatically deleted.")] = None,
    ...
    def merge_template_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MergeTemplates200Response]:
        """Generate document
