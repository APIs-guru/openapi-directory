...
class TestTemplateDefinitionLayout(unittest.TestCase):
    """TemplateDefinitionLayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateDefinitionLayout:
        """Test TemplateDefinitionLayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateDefinitionLayout`
        """
        model = TemplateDefinitionLayout()
        if include_optional:
            return TemplateDefinitionLayout(
                empty_labels = 0,
                format = 'A4',
                height = 29.7,
                margins = openapi_client.models.template_definition_layout_margins.TemplateDefinition_layout_margins(
                    bottom = 0.5, 
                    left = 0.5, 
                    right = 0.5, 
                    top = 0.5, ),
                orientation = 'portrait',
                repeat_layout = openapi_client.models.template_definition_layout_repeat_layout.TemplateDefinition_layout_repeatLayout(
                    format = 'A4', 
                    height = 29.7, 
                    width = 21, ),
                rotation = 0,
    ...
    def testTemplateDefinitionLayout(self):
        """Test TemplateDefinitionLayout"""
