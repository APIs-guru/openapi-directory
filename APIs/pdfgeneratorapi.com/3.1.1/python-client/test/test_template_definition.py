    ...
    def make_instance(self, include_optional) -> TemplateDefinition:
        ...
        if include_optional:
            return TemplateDefinition(
                data_settings = openapi_client.models.template_definition_data_settings.TemplateDefinition_dataSettings(
                    filter_by = [
                        None
                        ], 
                    sort_by = [
                ...
                editor = openapi_client.models.template_definition_editor.TemplateDefinition_editor(
                    height_multiplier = 2, ),
                id = 24382,
                is_draft = True,
                layout = openapi_client.models.template_definition_layout.TemplateDefinition_layout(
                    empty_labels = 0, 
                    format = 'A4', 
                    height = 29.7, 
