    ...
    def make_instance(self, include_optional) -> TemplateDefinitionNew:
        ...
        if include_optional:
            return TemplateDefinitionNew(
                is_draft = True,
                layout = openapi_client.models.template_definition_new_layout.TemplateDefinitionNew_layout(
                    empty_labels = 0, 
                    format = 'A4', 
                    height = 29.7, 
                ...
                pages = [
                    openapi_client.models.template_definition_pages_inner.TemplateDefinition_pages_inner(
                        components = [
                        ...
                        height = 29.7, 
                        margins = openapi_client.models.template_definition_pages_inner_margins.TemplateDefinition_pages_inner_margins(
                            bottom = 0.5, 
                            right = 0.5, ), 
                        width = 21, )
                    ],
