...
class TestTemplateDefinitionNewLayout(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TemplateDefinitionNewLayout:
        """Test TemplateDefinitionNewLayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateDefinitionNewLayout`
        """
        model = TemplateDefinitionNewLayout()
        if include_optional:
