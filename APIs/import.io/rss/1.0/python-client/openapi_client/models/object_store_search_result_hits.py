...
class ObjectStoreSearchResultHits(BaseModel):
    """
    ObjectStoreSearchResultHits
    """ # noqa: E501
    hits: Optional[List[ObjectStoreSearchResultHitsHitsInner]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["hits", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [ObjectStoreSearchResultHitsHitsInner.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
            "total": obj.get("total")
        })
        return _obj
