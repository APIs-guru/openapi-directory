...
------------ | ------------- | ------------- | -------------
*RssImportIoApi* | [**extractor_extractor_id_runs_get**](docs/RssImportIoApi.md#extractor_extractor_id_runs_get) | **GET** /extractor/{extractorId}/runs | Get a feed of the runs performed on an extractor
