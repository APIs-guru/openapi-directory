...
class ObjectStoreSearchResultHitsHitsInner(BaseModel):
    """
    ObjectStoreSearchResultHitsHitsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    score: Optional[StrictInt] = Field(default=None, alias="_score")
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    fields: Optional[CrawlRun] = None
    __properties: ClassVar[List[str]] = ["_id", "_score", "_type", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_type": obj.get("_type"),
            "fields": CrawlRun.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
        return _obj
