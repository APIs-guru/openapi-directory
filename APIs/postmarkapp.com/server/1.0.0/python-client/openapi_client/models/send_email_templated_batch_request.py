...
class SendEmailTemplatedBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    messages: Optional[List[EmailWithTemplateRequest]] = Field(default=None, alias="Messages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Messages": [EmailWithTemplateRequest.from_dict(_item) for _item in obj["Messages"]] if obj.get("Messages") is not None else None
        })
        return _obj
