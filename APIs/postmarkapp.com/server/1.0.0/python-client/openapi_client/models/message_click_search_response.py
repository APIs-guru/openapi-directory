...
class MessageClickSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    clicks: Optional[List[ExtendedMessageClickEventInformation]] = Field(default=None, alias="Clicks")
    total_count: Optional[StrictInt] = Field(default=None, alias="TotalCount")
    __properties: ClassVar[List[str]] = ["Clicks", "TotalCount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.clicks:
            for _item_clicks in self.clicks:
                if _item_clicks:
                    _items.append(_item_clicks.to_dict())
            _dict['Clicks'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Clicks": [ExtendedMessageClickEventInformation.from_dict(_item) for _item in obj["Clicks"]] if obj.get("Clicks") is not None else None,
