...
class SendEmailRequest(BaseModel):
    ...
    bcc: Optional[StrictStr] = Field(default=None, description="Bcc recipient email address. Multiple addresses are comma seperated. Max 50.", alias="Bcc")
    cc: Optional[StrictStr] = Field(default=None, description="Recipient email address. Multiple addresses are comma seperated. Max 50.", alias="Cc")
    var_from: Optional[StrictStr] = Field(default=None, description="The sender email address. Must have a registered and confirmed Sender Signature.", alias="From")
    headers: Optional[List[MessageHeader]] = Field(default=None, alias="Headers")
    html_body: Optional[StrictStr] = Field(default=None, description="If no TextBody specified HTML email message", alias="HtmlBody")
    reply_to: Optional[StrictStr] = Field(default=None, description="Reply To override email address. Defaults to the Reply To set in the sender signature.", alias="ReplyTo")
    subject: Optional[StrictStr] = Field(default=None, description="Email Subject", alias="Subject")
    tag: Optional[StrictStr] = Field(default=None, description="Email tag that allows you to categorize outgoing emails and get detailed statistics.", alias="Tag")
    text_body: Optional[StrictStr] = Field(default=None, description="If no HtmlBody specified Plain text email message", alias="TextBody")
    to: Optional[StrictStr] = Field(default=None, description="Recipient email address. Multiple addresses are comma seperated. Max 50.", alias="To")
    ...
    __properties: ClassVar[List[str]] = ["Attachments", "Bcc", "Cc", "From", "Headers", "HtmlBody", "ReplyTo", "Subject", "Tag", "TextBody", "To", "TrackLinks", "TrackOpens"]
