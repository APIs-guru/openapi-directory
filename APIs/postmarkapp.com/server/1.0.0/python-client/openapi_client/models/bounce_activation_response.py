...
class BounceActivationResponse(BaseModel):
    ...
    """ # noqa: E501
    bounce: Optional[BounceInfoResponse] = Field(default=None, alias="Bounce")
    message: Optional[StrictStr] = Field(default=None, alias="Message")
    __properties: ClassVar[List[str]] = ["Bounce", "Message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Bounce": BounceInfoResponse.from_dict(obj["Bounce"]) if obj.get("Bounce") is not None else None,
