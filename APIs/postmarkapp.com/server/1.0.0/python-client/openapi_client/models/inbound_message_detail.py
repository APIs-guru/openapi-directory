...
class InboundMessageDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Attachments", "Cc", "CcFull", "Date", "From", "FromFull", "FromName", "MailboxHash", "MessageID", "OriginalRecipient", "ReplyTo", "Status", "Subject", "Tag", "To", "ToFull"]
