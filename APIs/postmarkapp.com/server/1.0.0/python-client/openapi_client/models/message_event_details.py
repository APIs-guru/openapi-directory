...
class MessageEventDetails(BaseModel):
    ...
    """ # noqa: E501
    details: Optional[MessageEventDetailsDetails] = Field(default=None, alias="Details")
    ...
    __properties: ClassVar[List[str]] = ["Details", "ReceivedAt", "Recipient", "Type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Details": MessageEventDetailsDetails.from_dict(obj["Details"]) if obj.get("Details") is not None else None,
