...
class SentCountsResponse(BaseModel):
    """
    The result of a get sent counts operation.
    """ # noqa: E501
    days: Optional[List[SentCountsResponseDaysInner]] = Field(default=None, alias="Days")
    sent: Optional[StrictInt] = Field(default=None, alias="Sent")
    __properties: ClassVar[List[str]] = ["Days", "Sent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Days": [SentCountsResponseDaysInner.from_dict(_item) for _item in obj["Days"]] if obj.get("Days") is not None else None,
            "Sent": obj.get("Sent")
        })
        return _obj
