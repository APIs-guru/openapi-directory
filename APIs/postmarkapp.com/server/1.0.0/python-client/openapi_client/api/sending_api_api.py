...
class SendingAPIApi:
    ...
    def send_email(
        ...
        body: Optional[SendEmailRequest] = None,
    ...
    def send_email_batch(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        body: Optional[List[SendEmailRequest]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type x_postmark_server_token: str
        :param body:
        :type body: List[SendEmailRequest]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_email_batch_serialize(
            x_postmark_server_token=x_postmark_server_token,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def send_email_batch_with_http_info(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        body: Optional[List[SendEmailRequest]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def send_email_batch_without_preload_content(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        body: Optional[List[SendEmailRequest]] = None,
        _request_timeout: Union[
    ...
    def _send_email_batch_serialize(
        self,
        x_postmark_server_token,
        body,
        _request_auth,
    ...
    @validate_call
    def send_email_batch_with_templates(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        ...
        _param = self._send_email_batch_with_templates_serialize(
            x_postmark_server_token=x_postmark_server_token,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def send_email_batch_with_templates_with_http_info(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        body: SendEmailTemplatedBatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def send_email_batch_with_templates_without_preload_content(
        self,
        x_postmark_server_token: Annotated[StrictStr, Field(description="The token associated with the Server on which this request will operate.")],
        body: SendEmailTemplatedBatchRequest,
        _request_timeout: Union[
    ...
    def _send_email_batch_with_templates_serialize(
        self,
        x_postmark_server_token,
        body,
        _request_auth,
