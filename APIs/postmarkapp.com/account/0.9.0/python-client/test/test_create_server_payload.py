...
class TestCreateServerPayload(unittest.TestCase):
    """CreateServerPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateServerPayload:
        """Test CreateServerPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateServerPayload`
        """
        model = CreateServerPayload()
        if include_optional:
            return CreateServerPayload(
                bounce_hook_url = '',
                click_hook_url = '',
                color = '',
                delivery_hook_url = '',
    ...
    def testCreateServerPayload(self):
        """Test CreateServerPayload"""
