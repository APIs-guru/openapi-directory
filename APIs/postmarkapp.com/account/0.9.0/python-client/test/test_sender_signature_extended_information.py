...
class TestSenderSignatureExtendedInformation(unittest.TestCase):
    """SenderSignatureExtendedInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SenderSignatureExtendedInformation:
        """Test SenderSignatureExtendedInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SenderSignatureExtendedInformation`
        """
        model = SenderSignatureExtendedInformation()
        if include_optional:
    ...
    def testSenderSignatureExtendedInformation(self):
        """Test SenderSignatureExtendedInformation"""
