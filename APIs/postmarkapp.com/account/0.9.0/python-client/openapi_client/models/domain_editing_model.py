...
class DomainEditingModel(BaseModel):
    """
    
    """ # noqa: E501
    return_path_domain: Optional[StrictStr] = Field(default=None, alias="ReturnPathDomain")
    __properties: ClassVar[List[str]] = ["ReturnPathDomain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainEditingModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainEditingModel from a dict"""
        if obj is None:
            return None
