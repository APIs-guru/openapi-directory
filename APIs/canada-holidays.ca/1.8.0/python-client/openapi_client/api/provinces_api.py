...
class ProvincesApi:
    ...
    def province(
        self,
        province_id: Annotated[StrictStr, Field(description="A Canadian province abbreviation")],
        year: Annotated[Optional[Annotated[int, Field(le=2029, strict=True, ge=2016)]], Field(description="A calendar year")] = None,
        optional: Annotated[Optional[StrictStr], Field(description="A boolean parameter (AB and BC only). If false or 0 (default), will return only legislated holidays. If true or 1, will return optional holidays from Alberta and BC.")] = None,
        ...
        :param province_id: A Canadian province abbreviation (required)
        ...
        _param = self._province_serialize(
    ...
    def province_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Province200Response]:
        """Get a province or territory by abbreviation
    ...
    @validate_call
    def province_without_preload_content(
        self,
        province_id: Annotated[StrictStr, Field(description="A Canadian province abbreviation")],
        year: Annotated[Optional[Annotated[int, Field(le=2029, strict=True, ge=2016)]], Field(description="A calendar year")] = None,
        optional: Annotated[Optional[StrictStr], Field(description="A boolean parameter (AB and BC only). If false or 0 (default), will return only legislated holidays. If true or 1, will return optional holidays from Alberta and BC.")] = None,
    ...
    def _province_serialize(
        ...
        if province_id is not None:
            _path_params['provinceId'] = province_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/provinces/{provinceId}',
    ...
    def provinces(
        ...
        _param = self._provinces_serialize(
            year=year,
            optional=optional,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def provinces_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Provinces200Response]:
        """Get all provinces
    ...
    @validate_call
    def provinces_without_preload_content(
        self,
        year: Annotated[Optional[Annotated[int, Field(le=2029, strict=True, ge=2016)]], Field(description="A calendar year")] = None,
        optional: Annotated[Optional[StrictStr], Field(description="A boolean parameter. If false or 0 (default), will return only legislated holidays. If true or 1, will return optional holidays from Alberta and BC.")] = None,
        _request_timeout: Union[
    ...
    def _provinces_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/provinces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
