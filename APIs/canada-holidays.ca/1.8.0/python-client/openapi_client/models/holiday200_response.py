...
class Holiday200Response(BaseModel):
    """
    Holiday200Response
    """ # noqa: E501
    holiday: Optional[Holiday] = None
    __properties: ClassVar[List[str]] = ["holiday"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "holiday": Holiday.from_dict(obj["holiday"]) if obj.get("holiday") is not None else None
        })
        return _obj
