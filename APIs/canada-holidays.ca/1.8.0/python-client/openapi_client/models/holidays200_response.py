...
class Holidays200Response(BaseModel):
    """
    Holidays200Response
    """ # noqa: E501
    holidays: Optional[List[Holiday]] = None
    __properties: ClassVar[List[str]] = ["holidays"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Holidays200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Holidays200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "holidays": [Holiday.from_dict(_item) for _item in obj["holidays"]] if obj.get("holidays") is not None else None
        })
        return _obj
