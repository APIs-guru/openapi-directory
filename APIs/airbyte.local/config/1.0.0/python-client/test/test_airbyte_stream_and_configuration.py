...
class TestAirbyteStreamAndConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AirbyteStreamAndConfiguration:
        """Test AirbyteStreamAndConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirbyteStreamAndConfiguration`
        """
        model = AirbyteStreamAndConfiguration()
        if include_optional:
