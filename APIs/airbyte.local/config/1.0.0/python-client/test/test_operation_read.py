...
class TestOperationRead(unittest.TestCase):
    """OperationRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationRead:
        """Test OperationRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationRead`
        """
        model = OperationRead()
        if include_optional:
