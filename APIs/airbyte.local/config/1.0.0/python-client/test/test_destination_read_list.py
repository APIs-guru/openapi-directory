...
class TestDestinationReadList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DestinationReadList:
        """Test DestinationReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationReadList`
        """
        model = DestinationReadList()
        if include_optional:
            return DestinationReadList(
                destinations = [
                    openapi_client.models.destination_read.DestinationRead(
