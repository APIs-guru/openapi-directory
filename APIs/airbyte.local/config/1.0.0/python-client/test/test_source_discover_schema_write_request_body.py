...
class TestSourceDiscoverSchemaWriteRequestBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SourceDiscoverSchemaWriteRequestBody:
        """Test SourceDiscoverSchemaWriteRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDiscoverSchemaWriteRequestBody`
        """
        model = SourceDiscoverSchemaWriteRequestBody()
        if include_optional:
    ...
    def testSourceDiscoverSchemaWriteRequestBody(self):
        """Test SourceDiscoverSchemaWriteRequestBody"""
