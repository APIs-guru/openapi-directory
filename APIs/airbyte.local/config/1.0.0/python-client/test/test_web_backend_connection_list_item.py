...
class TestWebBackendConnectionListItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebBackendConnectionListItem:
        """Test WebBackendConnectionListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBackendConnectionListItem`
        """
        model = WebBackendConnectionListItem()
        if include_optional:
    ...
    def testWebBackendConnectionListItem(self):
        """Test WebBackendConnectionListItem"""
