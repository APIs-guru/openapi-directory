...
class TestCheckConnectionRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CheckConnectionRead:
        """Test CheckConnectionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckConnectionRead`
        """
        model = CheckConnectionRead()
        if include_optional:
    ...
    def testCheckConnectionRead(self):
        """Test CheckConnectionRead"""
