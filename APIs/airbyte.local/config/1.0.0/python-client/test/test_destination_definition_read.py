...
class TestDestinationDefinitionRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DestinationDefinitionRead:
        """Test DestinationDefinitionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationDefinitionRead`
        """
        model = DestinationDefinitionRead()
        if include_optional:
