...
class TestWebBackendConnectionUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebBackendConnectionUpdate:
        """Test WebBackendConnectionUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBackendConnectionUpdate`
        """
        model = WebBackendConnectionUpdate()
        if include_optional:
            return WebBackendConnectionUpdate(
                ...
                operations = [
                    openapi_client.models.web_backend_operation_create_or_update.WebBackendOperationCreateOrUpdate(
                        name = '', 
                        operation_id = '', 
    ...
    def testWebBackendConnectionUpdate(self):
        """Test WebBackendConnectionUpdate"""
