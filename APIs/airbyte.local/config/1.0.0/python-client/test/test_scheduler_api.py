...
class TestSchedulerApi(unittest.TestCase):
    ...
    def test_execute_destination_check_connection(self) -> None:
    ...
    def test_execute_source_check_connection(self) -> None:
    ...
    def test_execute_source_discover_schema(self) -> None:
