...
class TestDestinationDefinitionSpecificationRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DestinationDefinitionSpecificationRead:
        """Test DestinationDefinitionSpecificationRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationDefinitionSpecificationRead`
        """
        model = DestinationDefinitionSpecificationRead()
        if include_optional:
