...
class TestOperationReadList(unittest.TestCase):
    """OperationReadList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationReadList:
        """Test OperationReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationReadList`
        """
        model = OperationReadList()
        if include_optional:
    ...
    def testOperationReadList(self):
        """Test OperationReadList"""
