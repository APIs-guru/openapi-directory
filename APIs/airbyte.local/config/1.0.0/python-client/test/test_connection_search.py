...
class TestConnectionSearch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConnectionSearch:
        """Test ConnectionSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionSearch`
        """
        model = ConnectionSearch()
        if include_optional:
            return ConnectionSearch(
                connection_id = '',
                destination = openapi_client.models.destination_search.DestinationSearch(
                ...
                source = openapi_client.models.source_search.SourceSearch(
                    connection_configuration = {"user":"charles"}, 
                    name = '', 
