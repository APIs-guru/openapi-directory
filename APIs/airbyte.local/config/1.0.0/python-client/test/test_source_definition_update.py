...
class TestSourceDefinitionUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SourceDefinitionUpdate:
        """Test SourceDefinitionUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDefinitionUpdate`
        """
        model = SourceDefinitionUpdate()
        if include_optional:
