...
class TestPrivateSourceDefinitionRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateSourceDefinitionRead:
        """Test PrivateSourceDefinitionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateSourceDefinitionRead`
        """
        model = PrivateSourceDefinitionRead()
        if include_optional:
    ...
    def testPrivateSourceDefinitionRead(self):
        """Test PrivateSourceDefinitionRead"""
