...
class TestWebBackendConnectionCreate(unittest.TestCase):
    """WebBackendConnectionCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebBackendConnectionCreate:
        """Test WebBackendConnectionCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBackendConnectionCreate`
        """
        model = WebBackendConnectionCreate()
        if include_optional:
            return WebBackendConnectionCreate(
                ...
                operations = [
                    openapi_client.models.operation_create.OperationCreate(
                        name = '', 
    ...
    def testWebBackendConnectionCreate(self):
        """Test WebBackendConnectionCreate"""
