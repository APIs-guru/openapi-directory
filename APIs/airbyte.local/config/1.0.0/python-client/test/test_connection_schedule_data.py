...
class TestConnectionScheduleData(unittest.TestCase):
    """ConnectionScheduleData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionScheduleData:
        """Test ConnectionScheduleData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionScheduleData`
        """
        model = ConnectionScheduleData()
        if include_optional:
    ...
    def testConnectionScheduleData(self):
        """Test ConnectionScheduleData"""
