...
class TestDestinationDefinitionUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DestinationDefinitionUpdate:
        """Test DestinationDefinitionUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationDefinitionUpdate`
        """
        model = DestinationDefinitionUpdate()
        if include_optional:
