...
class TestSourceDefinitionReadList(unittest.TestCase):
    """SourceDefinitionReadList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceDefinitionReadList:
        """Test SourceDefinitionReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDefinitionReadList`
        """
        model = SourceDefinitionReadList()
        if include_optional:
            return SourceDefinitionReadList(
                source_definitions = [
                    openapi_client.models.source_definition_read.SourceDefinitionRead(
                        docker_image_tag = '', 
                        docker_repository = '', 
                        documentation_url = '', 
                        icon = '', 
    ...
    def testSourceDefinitionReadList(self):
        """Test SourceDefinitionReadList"""
