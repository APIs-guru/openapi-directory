...
class TestDestinationDefinitionCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DestinationDefinitionCreate:
        """Test DestinationDefinitionCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationDefinitionCreate`
        """
        model = DestinationDefinitionCreate()
        if include_optional:
