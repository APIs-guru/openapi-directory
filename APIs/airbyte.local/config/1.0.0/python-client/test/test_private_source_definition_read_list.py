...
class TestPrivateSourceDefinitionReadList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateSourceDefinitionReadList:
        """Test PrivateSourceDefinitionReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateSourceDefinitionReadList`
        """
        model = PrivateSourceDefinitionReadList()
        if include_optional:
            return PrivateSourceDefinitionReadList(
                source_definitions = [
                    openapi_client.models.private_source_definition_read.PrivateSourceDefinitionRead(
                        granted = True, 
    ...
    def testPrivateSourceDefinitionReadList(self):
        """Test PrivateSourceDefinitionReadList"""
