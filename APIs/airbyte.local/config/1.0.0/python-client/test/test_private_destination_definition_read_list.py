...
class TestPrivateDestinationDefinitionReadList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateDestinationDefinitionReadList:
        """Test PrivateDestinationDefinitionReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateDestinationDefinitionReadList`
        """
        model = PrivateDestinationDefinitionReadList()
        if include_optional:
            return PrivateDestinationDefinitionReadList(
                destination_definitions = [
                    openapi_client.models.private_destination_definition_read.PrivateDestinationDefinitionRead(
    ...
    def testPrivateDestinationDefinitionReadList(self):
        """Test PrivateDestinationDefinitionReadList"""
