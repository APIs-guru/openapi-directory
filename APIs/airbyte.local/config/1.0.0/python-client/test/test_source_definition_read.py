...
class TestSourceDefinitionRead(unittest.TestCase):
    """SourceDefinitionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceDefinitionRead:
        """Test SourceDefinitionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDefinitionRead`
        """
        model = SourceDefinitionRead()
        if include_optional:
    ...
    def testSourceDefinitionRead(self):
        """Test SourceDefinitionRead"""
