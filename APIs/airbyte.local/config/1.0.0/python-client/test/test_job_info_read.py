...
class TestJobInfoRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JobInfoRead:
        """Test JobInfoRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobInfoRead`
        """
        model = JobInfoRead()
        if include_optional:
            return JobInfoRead(
