...
class TestAttemptRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttemptRead:
        """Test AttemptRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttemptRead`
        """
        model = AttemptRead()
        if include_optional:
            return AttemptRead(
