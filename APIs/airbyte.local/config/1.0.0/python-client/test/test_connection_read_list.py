...
class TestConnectionReadList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConnectionReadList:
        """Test ConnectionReadList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionReadList`
        """
        model = ConnectionReadList()
        if include_optional:
            return ConnectionReadList(
                connections = [
                    openapi_client.models.connection_read.ConnectionRead(
