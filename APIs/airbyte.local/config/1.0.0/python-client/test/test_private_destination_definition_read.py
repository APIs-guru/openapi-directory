...
class TestPrivateDestinationDefinitionRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateDestinationDefinitionRead:
        """Test PrivateDestinationDefinitionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateDestinationDefinitionRead`
        """
        model = PrivateDestinationDefinitionRead()
        if include_optional:
    ...
    def testPrivateDestinationDefinitionRead(self):
        """Test PrivateDestinationDefinitionRead"""
