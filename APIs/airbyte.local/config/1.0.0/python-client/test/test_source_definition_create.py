...
class TestSourceDefinitionCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SourceDefinitionCreate:
        """Test SourceDefinitionCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDefinitionCreate`
        """
        model = SourceDefinitionCreate()
        if include_optional:
    ...
    def testSourceDefinitionCreate(self):
        """Test SourceDefinitionCreate"""
