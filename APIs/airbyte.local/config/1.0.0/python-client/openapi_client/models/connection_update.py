...
class ConnectionUpdate(BaseModel):
    ...
    """ # noqa: E501
    breaking_change: Optional[StrictBool] = Field(default=None, alias="breakingChange")
    connection_id: StrictStr = Field(alias="connectionId")
    geography: Optional[Geography] = None
    name: Optional[StrictStr] = Field(default=None, description="Name that will be set to this connection")
    ...
    __properties: ClassVar[List[str]] = ["breakingChange", "connectionId", "geography", "name", "namespaceDefinition", "namespaceFormat", "nonBreakingChangesPreference", "notifySchemaChanges", "operationIds", "prefix", "resourceRequirements", "schedule", "scheduleData", "scheduleType", "sourceCatalogId", "status", "syncCatalog"]
