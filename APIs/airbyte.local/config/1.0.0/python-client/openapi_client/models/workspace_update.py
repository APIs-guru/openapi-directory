...
class WorkspaceUpdate(BaseModel):
    ...
    initial_setup_complete: Optional[StrictBool] = Field(default=None, alias="initialSetupComplete")
    ...
    __properties: ClassVar[List[str]] = ["anonymousDataCollection", "defaultGeography", "displaySetupWizard", "email", "initialSetupComplete", "news", "notifications", "securityUpdates", "webhookConfigs", "workspaceId"]
