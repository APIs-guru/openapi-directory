...
class WebBackendConnectionCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["destinationId", "geography", "name", "namespaceDefinition", "namespaceFormat", "nonBreakingChangesPreference", "operationIds", "operations", "prefix", "resourceRequirements", "schedule", "scheduleData", "scheduleType", "sourceCatalogId", "sourceId", "status", "syncCatalog"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": [OperationCreate.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
