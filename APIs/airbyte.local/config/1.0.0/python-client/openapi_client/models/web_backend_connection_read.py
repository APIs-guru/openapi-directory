...
class WebBackendConnectionRead(BaseModel):
    """
    WebBackendConnectionRead
    """ # noqa: E501
    catalog_diff: Optional[CatalogDiff] = Field(default=None, alias="catalogDiff")
    ...
    non_breaking_changes_preference: NonBreakingChangesPreference = Field(alias="nonBreakingChangesPreference")
    notify_schema_changes: StrictBool = Field(alias="notifySchemaChanges")
    operation_ids: Optional[List[StrictStr]] = Field(default=None, alias="operationIds")
    operations: Optional[List[OperationRead]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of catalog_diff
        if self.catalog_diff:
            _dict['catalogDiff'] = self.catalog_diff.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalogDiff": CatalogDiff.from_dict(obj["catalogDiff"]) if obj.get("catalogDiff") is not None else None,
            "catalogId": obj.get("catalogId"),
            "connectionId": obj.get("connectionId"),
            "destination": DestinationRead.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            ...
            "operations": [OperationRead.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
            ...
            "source": SourceRead.from_dict(obj["source"]) if obj.get("source") is not None else None,
