...
class InvalidInputExceptionInfo(BaseModel):
    ...
    message: StrictStr
    validation_errors: List[InvalidInputProperty] = Field(alias="validationErrors")
    __properties: ClassVar[List[str]] = ["exceptionClassName", "exceptionStack", "message", "validationErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validationErrors": [InvalidInputProperty.from_dict(_item) for _item in obj["validationErrors"]] if obj.get("validationErrors") is not None else None
        })
        return _obj
