...
class ConnectionRead(BaseModel):
    ...
    ConnectionRead
    """ # noqa: E501
    breaking_change: StrictBool = Field(alias="breakingChange")
    ...
    __properties: ClassVar[List[str]] = ["breakingChange", "connectionId", "destinationId", "geography", "name", "namespaceDefinition", "namespaceFormat", "nonBreakingChangesPreference", "notifySchemaChanges", "operationIds", "prefix", "resourceRequirements", "schedule", "scheduleData", "scheduleType", "sourceCatalogId", "sourceId", "status", "syncCatalog"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakingChange": obj.get("breakingChange"),
