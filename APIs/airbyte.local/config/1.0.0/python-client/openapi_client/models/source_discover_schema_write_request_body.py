...
class SourceDiscoverSchemaWriteRequestBody(BaseModel):
    """
    to write this requested object to database.
    """ # noqa: E501
    catalog: AirbyteCatalog
    configuration_hash: Optional[StrictStr] = Field(default=None, alias="configurationHash")
    connector_version: Optional[StrictStr] = Field(default=None, alias="connectorVersion")
    source_id: Optional[StrictStr] = Field(default=None, alias="sourceId")
    __properties: ClassVar[List[str]] = ["catalog", "configurationHash", "connectorVersion", "sourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalog": AirbyteCatalog.from_dict(obj["catalog"]) if obj.get("catalog") is not None else None,
            "configurationHash": obj.get("configurationHash"),
