...
class SourceDefinitionUpdate(BaseModel):
    ...
    """ # noqa: E501
    docker_image_tag: StrictStr = Field(alias="dockerImageTag")
    resource_requirements: Optional[ActorDefinitionResourceRequirements] = Field(default=None, alias="resourceRequirements")
    source_definition_id: StrictStr = Field(alias="sourceDefinitionId")
    __properties: ClassVar[List[str]] = ["dockerImageTag", "resourceRequirements", "sourceDefinitionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dockerImageTag": obj.get("dockerImageTag"),
            "resourceRequirements": ActorDefinitionResourceRequirements.from_dict(obj["resourceRequirements"]) if obj.get("resourceRequirements") is not None else None,
