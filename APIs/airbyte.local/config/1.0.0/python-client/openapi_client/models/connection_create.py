...
class ConnectionCreate(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Optional name of the connection")
    ...
    __properties: ClassVar[List[str]] = ["destinationId", "geography", "name", "namespaceDefinition", "namespaceFormat", "nonBreakingChangesPreference", "notifySchemaChanges", "operationIds", "prefix", "resourceRequirements", "schedule", "scheduleData", "scheduleType", "sourceCatalogId", "sourceId", "status", "syncCatalog"]
