...
class SaveAttemptSyncConfigRequestBody(BaseModel):
    """
    SaveAttemptSyncConfigRequestBody
    """ # noqa: E501
    attempt_number: StrictInt = Field(alias="attemptNumber")
    job_id: StrictInt = Field(alias="jobId")
    sync_config: AttemptSyncConfig = Field(alias="syncConfig")
    __properties: ClassVar[List[str]] = ["attemptNumber", "jobId", "syncConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobId": obj.get("jobId"),
            "syncConfig": AttemptSyncConfig.from_dict(obj["syncConfig"]) if obj.get("syncConfig") is not None else None
        })
        return _obj
