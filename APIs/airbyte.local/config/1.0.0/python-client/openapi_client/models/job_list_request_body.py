...
class JobListRequestBody(BaseModel):
    """
    JobListRequestBody
    """ # noqa: E501
    config_id: StrictStr = Field(alias="configId")
    config_types: List[JobConfigType] = Field(alias="configTypes")
    including_job_id: Optional[StrictInt] = Field(default=None, alias="includingJobId")
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["configId", "configTypes", "includingJobId", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includingJobId": obj.get("includingJobId"),
