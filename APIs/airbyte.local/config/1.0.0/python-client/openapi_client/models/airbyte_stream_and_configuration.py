...
class AirbyteStreamAndConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AirbyteStreamConfiguration.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "stream": AirbyteStream.from_dict(obj["stream"]) if obj.get("stream") is not None else None
        })
        return _obj
