...
class ConnectionSearch(BaseModel):
    ...
    destination: Optional[DestinationSearch] = None
    ...
    source: Optional[SourceSearch] = None
    source_id: Optional[StrictStr] = Field(default=None, alias="sourceId")
    status: Optional[ConnectionStatus] = None
    __properties: ClassVar[List[str]] = ["connectionId", "destination", "destinationId", "name", "namespaceDefinition", "namespaceFormat", "prefix", "schedule", "scheduleData", "scheduleType", "source", "sourceId", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destination": DestinationSearch.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            ...
            "source": SourceSearch.from_dict(obj["source"]) if obj.get("source") is not None else None,
