...
class WorkspaceRead(BaseModel):
    ...
    feedback_done: Optional[StrictBool] = Field(default=None, alias="feedbackDone")
    first_completed_sync: Optional[StrictBool] = Field(default=None, alias="firstCompletedSync")
    initial_setup_complete: StrictBool = Field(alias="initialSetupComplete")
    name: StrictStr
    ...
    slug: StrictStr
    webhook_configs: Optional[List[WebhookConfigRead]] = Field(default=None, alias="webhookConfigs")
    workspace_id: StrictStr = Field(alias="workspaceId")
    __properties: ClassVar[List[str]] = ["anonymousDataCollection", "customerId", "defaultGeography", "displaySetupWizard", "email", "feedbackDone", "firstCompletedSync", "initialSetupComplete", "name", "news", "notifications", "securityUpdates", "slug", "webhookConfigs", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "feedbackDone": obj.get("feedbackDone"),
            "firstCompletedSync": obj.get("firstCompletedSync"),
            "initialSetupComplete": obj.get("initialSetupComplete"),
            "name": obj.get("name"),
            "news": obj.get("news"),
            ...
            "slug": obj.get("slug"),
            "webhookConfigs": [WebhookConfigRead.from_dict(_item) for _item in obj["webhookConfigs"]] if obj.get("webhookConfigs") is not None else None,
