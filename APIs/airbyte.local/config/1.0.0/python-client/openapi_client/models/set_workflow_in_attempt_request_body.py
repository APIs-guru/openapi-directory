...
class SetWorkflowInAttemptRequestBody(BaseModel):
    """
    SetWorkflowInAttemptRequestBody
    """ # noqa: E501
    attempt_number: StrictInt = Field(alias="attemptNumber")
    job_id: StrictInt = Field(alias="jobId")
    processing_task_queue: Optional[StrictStr] = Field(default='', alias="processingTaskQueue")
    workflow_id: StrictStr = Field(alias="workflowId")
    __properties: ClassVar[List[str]] = ["attemptNumber", "jobId", "processingTaskQueue", "workflowId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobId": obj.get("jobId"),
            "processingTaskQueue": obj.get("processingTaskQueue") if obj.get("processingTaskQueue") is not None else '',
