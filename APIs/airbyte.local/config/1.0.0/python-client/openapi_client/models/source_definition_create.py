...
class SourceDefinitionCreate(BaseModel):
    ...
    docker_repository: StrictStr = Field(alias="dockerRepository")
    ...
    __properties: ClassVar[List[str]] = ["dockerImageTag", "dockerRepository", "documentationUrl", "icon", "name", "resourceRequirements"]
