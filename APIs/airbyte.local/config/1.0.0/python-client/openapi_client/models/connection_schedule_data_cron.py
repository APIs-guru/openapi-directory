...
class ConnectionScheduleDataCron(BaseModel):
    """
    ConnectionScheduleDataCron
    """ # noqa: E501
    cron_expression: StrictStr = Field(alias="cronExpression")
    cron_time_zone: StrictStr = Field(alias="cronTimeZone")
    __properties: ClassVar[List[str]] = ["cronExpression", "cronTimeZone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cronTimeZone": obj.get("cronTimeZone")
        })
        return _obj
