...
class JobWithAttemptsRead(BaseModel):
    """
    JobWithAttemptsRead
    """ # noqa: E501
    attempts: Optional[List[AttemptRead]] = None
    job: Optional[JobRead] = None
    __properties: ClassVar[List[str]] = ["attempts", "job"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempts": [AttemptRead.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
