...
class TestBatchFirstLastNamePhoneNumberIn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchFirstLastNamePhoneNumberIn:
        """Test BatchFirstLastNamePhoneNumberIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchFirstLastNamePhoneNumberIn`
        """
        model = BatchFirstLastNamePhoneNumberIn()
        if include_optional:
            return BatchFirstLastNamePhoneNumberIn(
                ...
                personal_names_with_phone_numbers = [
                    openapi_client.models.first_last_name_phone_number_in.FirstLastNamePhoneNumberIn(
                        first_name = '', 
                        id = '', 
                        last_name = '', 
                        phone_number = '', )
