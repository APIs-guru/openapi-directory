...
class TestBatchPersonalNameIn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPersonalNameIn:
        """Test BatchPersonalNameIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPersonalNameIn`
        """
        ...
        if include_optional:
            return BatchPersonalNameIn(
                ...
                personal_names = [
                    openapi_client.models.personal_name_in.PersonalNameIn(
                        id = '', 
                        name = '', )
                    ]
            )
