...
class TestFirstLastNameGeoSubclassificationOut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FirstLastNameGeoSubclassificationOut:
        """Test FirstLastNameGeoSubclassificationOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirstLastNameGeoSubclassificationOut`
        """
        model = FirstLastNameGeoSubclassificationOut()
        if include_optional:
