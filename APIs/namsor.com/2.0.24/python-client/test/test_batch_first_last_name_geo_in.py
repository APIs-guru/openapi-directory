...
class TestBatchFirstLastNameGeoIn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchFirstLastNameGeoIn:
        """Test BatchFirstLastNameGeoIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchFirstLastNameGeoIn`
        """
        model = BatchFirstLastNameGeoIn()
        if include_optional:
            return BatchFirstLastNameGeoIn(
                ...
                personal_names = [
                    openapi_client.models.first_last_name_geo_in.FirstLastNameGeoIn(
                        country_iso2 = '', 
                        first_name = '', 
                        id = '', 
                        last_name = '', )
