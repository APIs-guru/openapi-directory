...
class TestPersonalNameGenderedOut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonalNameGenderedOut:
        """Test PersonalNameGenderedOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalNameGenderedOut`
        """
        model = PersonalNameGenderedOut()
        if include_optional:
