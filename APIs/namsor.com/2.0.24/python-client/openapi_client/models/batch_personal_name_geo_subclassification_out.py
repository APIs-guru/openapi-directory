...
class BatchPersonalNameGeoSubclassificationOut(BaseModel):
    """
    Represents the output of inferring the LIKELY country subclassification (regional names).
    """ # noqa: E501
    personal_names: Optional[List[PersonalNameGeoSubclassificationOut]] = Field(default=None, description="Classified names at sub country level (region or state)", alias="personalNames")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "personalNames": [PersonalNameGeoSubclassificationOut.from_dict(_item) for _item in obj["personalNames"]] if obj.get("personalNames") is not None else None
        })
        return _obj
