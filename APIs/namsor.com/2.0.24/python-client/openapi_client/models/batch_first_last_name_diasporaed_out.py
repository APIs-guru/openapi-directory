...
class BatchFirstLastNameDiasporaedOut(BaseModel):
    ...
    """ # noqa: E501
    personal_names: Optional[List[FirstLastNameDiasporaedOut]] = Field(default=None, description="Classified diaspora names", alias="personalNames")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "personalNames": [FirstLastNameDiasporaedOut.from_dict(_item) for _item in obj["personalNames"]] if obj.get("personalNames") is not None else None
        })
        return _obj
