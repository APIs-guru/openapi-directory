...
class BatchPersonalNameSubdivisionIn(BaseModel):
    ...
    personal_names: Optional[List[PersonalNameSubdivisionIn]] = Field(default=None, alias="personalNames")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "personalNames": [PersonalNameSubdivisionIn.from_dict(_item) for _item in obj["personalNames"]] if obj.get("personalNames") is not None else None
        })
        return _obj
