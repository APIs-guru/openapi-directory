...
class TestSegmentsApi(unittest.TestCase):
    ...
    def test_api_v2_segments_get(self) -> None:
    ...
    def test_api_v2_segments_id_content_get(self) -> None:
    ...
    def test_api_v2_segments_id_delete(self) -> None:
    ...
    def test_api_v2_segments_id_get(self) -> None:
    ...
    def test_api_v2_segments_post(self) -> None:
