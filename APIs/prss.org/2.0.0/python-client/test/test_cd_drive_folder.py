...
class TestCDDriveFolder(unittest.TestCase):
    """CDDriveFolder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CDDriveFolder:
        """Test CDDriveFolder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CDDriveFolder`
        """
        model = CDDriveFolder()
        if include_optional:
