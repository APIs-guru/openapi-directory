...
class TestProgramInformationBatch(unittest.TestCase):
    """ProgramInformationBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramInformationBatch:
        """Test ProgramInformationBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramInformationBatch`
        """
        model = ProgramInformationBatch()
        if include_optional:
            return ProgramInformationBatch(
                ...
                message = '',
                name = '',
                program = openapi_client.models.program_information_batch_program.ProgramInformationBatch_program(
                    air_date = '', 
                    title = '', ),
                status = 'queued',
                uri = ''
    ...
    def testProgramInformationBatch(self):
        """Test ProgramInformationBatch"""
