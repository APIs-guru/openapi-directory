...
class TestPiecesApi(unittest.TestCase):
    """PiecesApi unit test stubs"""
    ...
    def test_api_v2_pieces_get(self) -> None:
    ...
    def test_api_v2_pieces_id_delete(self) -> None:
    ...
    def test_api_v2_pieces_id_get(self) -> None:
    ...
    def test_api_v2_pieces_post(self) -> None:
