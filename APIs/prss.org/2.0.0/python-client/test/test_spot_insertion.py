...
class TestSpotInsertion(unittest.TestCase):
    """SpotInsertion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpotInsertion:
        """Test SpotInsertion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpotInsertion`
        """
        model = SpotInsertion()
        if include_optional:
            return SpotInsertion(
                broadcast_service_id = 0,
                created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                cue = 'S:000_SPOT',
                customer_id = 0,
                duration = 56,
                end_date = 'Thu Jan 30 19:00:00 EST 2020',
                id = 0,
                program_id = 0,
                spots = [
                    56
                    ],
                start_date = 'Thu Jan 30 19:00:00 EST 2020'
            )
        else:
            return SpotInsertion(
                broadcast_service_id = 0,
