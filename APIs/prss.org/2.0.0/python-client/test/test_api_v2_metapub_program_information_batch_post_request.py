...
class TestApiV2MetapubProgramInformationBatchPostRequest(unittest.TestCase):
    """ApiV2MetapubProgramInformationBatchPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV2MetapubProgramInformationBatchPostRequest:
        """Test ApiV2MetapubProgramInformationBatchPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV2MetapubProgramInformationBatchPostRequest`
        """
        model = ApiV2MetapubProgramInformationBatchPostRequest()
        if include_optional:
            return ApiV2MetapubProgramInformationBatchPostRequest(
                format = 'radiodns',
                name = '',
                program = openapi_client.models._api_v2_metapub_program_information_batch_post_request_program._api_v2_metapub_program_information_batch_post_request_program(
                    air_date = '', 
                    title = '', ),
                uri = ''
            )
    ...
    def testApiV2MetapubProgramInformationBatchPostRequest(self):
        """Test ApiV2MetapubProgramInformationBatchPostRequest"""
