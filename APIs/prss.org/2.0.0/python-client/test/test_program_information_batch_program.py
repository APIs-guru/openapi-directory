...
class TestProgramInformationBatchProgram(unittest.TestCase):
    """ProgramInformationBatchProgram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramInformationBatchProgram:
        """Test ProgramInformationBatchProgram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramInformationBatchProgram`
        """
        model = ProgramInformationBatchProgram()
        if include_optional:
    ...
    def testProgramInformationBatchProgram(self):
        """Test ProgramInformationBatchProgram"""
