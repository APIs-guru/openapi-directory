...
class TestBroadcastServicesApi(unittest.TestCase):
    """BroadcastServicesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BroadcastServicesApi()

    def tearDown(self) -> None:
        pass

    def test_api_v2_broadcastservices_get(self) -> None:
    ...
    def test_api_v2_broadcastservices_id_get(self) -> None:
