...
class TestMetaPubApi(unittest.TestCase):
    """MetaPubApi unit test stubs"""
    ...
    def test_api_v2_metapub_program_information_batch_batch_id_get(self) -> None:
    ...
    def test_api_v2_metapub_program_information_batch_post(self) -> None:
