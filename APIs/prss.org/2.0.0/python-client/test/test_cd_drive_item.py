...
class TestCDDriveItem(unittest.TestCase):
    """CDDriveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CDDriveItem:
        """Test CDDriveItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CDDriveItem`
        """
        model = CDDriveItem()
        if include_optional:
            return CDDriveItem(
