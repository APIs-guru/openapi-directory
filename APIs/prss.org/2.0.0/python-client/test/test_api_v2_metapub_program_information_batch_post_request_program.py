...
class TestApiV2MetapubProgramInformationBatchPostRequestProgram(unittest.TestCase):
    """ApiV2MetapubProgramInformationBatchPostRequestProgram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV2MetapubProgramInformationBatchPostRequestProgram:
        """Test ApiV2MetapubProgramInformationBatchPostRequestProgram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV2MetapubProgramInformationBatchPostRequestProgram`
        """
        model = ApiV2MetapubProgramInformationBatchPostRequestProgram()
        if include_optional:
            return ApiV2MetapubProgramInformationBatchPostRequestProgram(
                air_date = '',
                title = ''
            )
        else:
    ...
    def testApiV2MetapubProgramInformationBatchPostRequestProgram(self):
        """Test ApiV2MetapubProgramInformationBatchPostRequestProgram"""
