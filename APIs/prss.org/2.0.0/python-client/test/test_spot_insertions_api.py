...
class TestSpotInsertionsApi(unittest.TestCase):
    """SpotInsertionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SpotInsertionsApi()

    def tearDown(self) -> None:
        pass

    def test_api_v2_spotinsertions_get(self) -> None:
    ...
    def test_api_v2_spotinsertions_id_delete(self) -> None:
    ...
    def test_api_v2_spotinsertions_id_get(self) -> None:
    ...
    def test_api_v2_spotinsertions_post(self) -> None:
