...
class TestSpotsApi(unittest.TestCase):
    ...
    def test_api_v2_spots_get(self) -> None:
    ...
    def test_api_v2_spots_id_delete(self) -> None:
    ...
    def test_api_v2_spots_id_get(self) -> None:
    ...
    def test_api_v2_spots_post(self) -> None:
