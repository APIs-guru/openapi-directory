...
class TestPiece(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Piece:
        """Test Piece
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Piece`
        """
        model = Piece()
        if include_optional:
            return Piece(
                ...
                relative_end_time = 56,
                relative_start_time = 56,
                segment_number = 1,
                title = ''
            )
        else:
