...
class TestRadioDNSApi(unittest.TestCase):
    """RadioDNSApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RadioDNSApi()

    def tearDown(self) -> None:
        pass

    def test_radiodns_spi31_gi_xml_get(self) -> None:
    ...
    def test_radiodns_spi31_id_fqdn_sid_date_pi_xml_get(self) -> None:
    ...
    def test_radiodns_spi31_si_xml_get(self) -> None:
