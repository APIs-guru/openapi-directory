...
class TestApiV2CddriveFoldersFolderIdItemsGet200Response(unittest.TestCase):
    """ApiV2CddriveFoldersFolderIdItemsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV2CddriveFoldersFolderIdItemsGet200Response:
        """Test ApiV2CddriveFoldersFolderIdItemsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV2CddriveFoldersFolderIdItemsGet200Response`
        """
        model = ApiV2CddriveFoldersFolderIdItemsGet200Response()
        if include_optional:
            return ApiV2CddriveFoldersFolderIdItemsGet200Response(
                entries = [
                    openapi_client.models.cd_drive_item.CDDriveItem(
                        id = 0, 
                        name = '', 
                        type = 'file', )
                    ],
    ...
    def testApiV2CddriveFoldersFolderIdItemsGet200Response(self):
        """Test ApiV2CddriveFoldersFolderIdItemsGet200Response"""
