...
class EpisodesApi:
    ...
    @validate_call
    def api_v2_episodes_get(
        self,
        program_id: Annotated[StrictInt, Field(description="Matches on the ID of the program that owns the episode.")],
        id: Annotated[Optional[StrictInt], Field(description="Matches on the ID of the episode.")] = None,
        begin_air_date_after: Annotated[Optional[datetime], Field(description="Matches on the begin air date of the episode (inclusive).")] = None,
        end_air_date_before: Annotated[Optional[datetime], Field(description="Matches on the end air date of the episode (inclusive).")] = None,
        ...
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of episodes, based on episode ID. If unspecified, the episodes are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
        ...
        :param program_id: Matches on the ID of the program that owns the episode. (required)
        :type program_id: int
        ...
        _param = self._api_v2_episodes_get_serialize(
            program_id=program_id,
            id=id,
            begin_air_date_after=begin_air_date_after,
            end_air_date_before=end_air_date_before,
    ...
    @validate_call
    def api_v2_episodes_get_with_http_info(
        self,
        program_id: Annotated[StrictInt, Field(description="Matches on the ID of the program that owns the episode.")],
        id: Annotated[Optional[StrictInt], Field(description="Matches on the ID of the episode.")] = None,
        begin_air_date_after: Annotated[Optional[datetime], Field(description="Matches on the begin air date of the episode (inclusive).")] = None,
    ...
    @validate_call
    def api_v2_episodes_get_without_preload_content(
        self,
        program_id: Annotated[StrictInt, Field(description="Matches on the ID of the program that owns the episode.")],
        id: Annotated[Optional[StrictInt], Field(description="Matches on the ID of the episode.")] = None,
        begin_air_date_after: Annotated[Optional[datetime], Field(description="Matches on the begin air date of the episode (inclusive).")] = None,
    ...
    def _api_v2_episodes_get_serialize(
        self,
        program_id,
        id,
        begin_air_date_after,
        end_air_date_before,
        page_start,
        page_size,
        order_by_id,
        ...
        if begin_air_date_after is not None:
            if isinstance(begin_air_date_after, datetime):
                _query_params.append(
                    (
                        'beginAirDateAfter',
                        begin_air_date_after.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('beginAirDateAfter', begin_air_date_after))
            
        if end_air_date_before is not None:
            if isinstance(end_air_date_before, datetime):
                _query_params.append(
                    (
                        'endAirDateBefore',
                        end_air_date_before.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('endAirDateBefore', end_air_date_before))
    ...
    @validate_call
    def api_v2_episodes_id_get(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the episode to operate on.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_v2_episodes_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_episodes_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the episode to operate on.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_episodes_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the episode to operate on.")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_episodes_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/episodes/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
