...
class SpotsApi:
    ...
    @validate_call
    def api_v2_spots_get(
        self,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the spot to return. The first item is indexed at 0.")] = None,
        ...
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of spots, based on spot ID. If unspecified, the spots are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
        ...
        _param = self._api_v2_spots_get_serialize(
    ...
    @validate_call
    def api_v2_spots_get_with_http_info(
        self,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the spot to return. The first item is indexed at 0.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="The number of items to return. Must be between 0 and 500, inclusive.")] = None,
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of spots, based on spot ID. If unspecified, the spots are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
    ...
    @validate_call
    def api_v2_spots_get_without_preload_content(
        self,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the spot to return. The first item is indexed at 0.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="The number of items to return. Must be between 0 and 500, inclusive.")] = None,
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of spots, based on spot ID. If unspecified, the spots are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
    ...
    def _api_v2_spots_get_serialize(
        self,
        page_start,
        page_size,
        order_by_id,
    ...
    def api_v2_spots_id_delete(
        ...
        _param = self._api_v2_spots_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_spots_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_spots_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_spots_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def api_v2_spots_id_get(
        ...
        _param = self._api_v2_spots_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_spots_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_spots_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_spots_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def api_v2_spots_post(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the spot content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        name: Annotated[StrictStr, Field(description="The name of the spot to create/update.")],
        notes: Annotated[StrictStr, Field(description="Notes pertaining to the spot.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cd_drive_uri: The URI to the spot content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'. (required)
        ...
        _param = self._api_v2_spots_post_serialize(
    ...
    @validate_call
    def api_v2_spots_post_with_http_info(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the spot content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        name: Annotated[StrictStr, Field(description="The name of the spot to create/update.")],
        notes: Annotated[StrictStr, Field(description="Notes pertaining to the spot.")],
    ...
    @validate_call
    def api_v2_spots_post_without_preload_content(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the spot content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        name: Annotated[StrictStr, Field(description="The name of the spot to create/update.")],
        notes: Annotated[StrictStr, Field(description="Notes pertaining to the spot.")],
    ...
    def _api_v2_spots_post_serialize(
        self,
        cd_drive_uri,
        name,
        notes,
