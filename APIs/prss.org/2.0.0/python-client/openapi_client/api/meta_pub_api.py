...
class MetaPubApi:
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_batch_id_get(
        self,
        batch_id: Annotated[int, Field(strict=True, ge=0)],
        ...
        """(Deprecated) Get an EPG batch operation.
        ...
        """ # noqa: E501
        warnings.warn("GET /api/v2/metapub/program-information/batch/{batch-id} is deprecated.", DeprecationWarning)

        _param = self._api_v2_metapub_program_information_batch_batch_id_get_serialize(
            batch_id=batch_id,
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_batch_id_get_with_http_info(
        self,
        batch_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProgramInformationBatch]:
        """(Deprecated) Get an EPG batch operation.
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_batch_id_get_without_preload_content(
        self,
        batch_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_metapub_program_information_batch_batch_id_get_serialize(
        self,
        batch_id,
        _request_auth,
        _content_type,
        ...
        if batch_id is not None:
            _path_params['batch-id'] = batch_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/metapub/program-information/batch/{batch-id}',
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_post(
        self,
        api_v2_metapub_program_information_batch_post_request: Optional[ApiV2MetapubProgramInformationBatchPostRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """(Deprecated) Create a batch operation on EPG information.
        ...
        :param api_v2_metapub_program_information_batch_post_request:
        :type api_v2_metapub_program_information_batch_post_request: ApiV2MetapubProgramInformationBatchPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/v2/metapub/program-information/batch is deprecated.", DeprecationWarning)

        _param = self._api_v2_metapub_program_information_batch_post_serialize(
            api_v2_metapub_program_information_batch_post_request=api_v2_metapub_program_information_batch_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_post_with_http_info(
        self,
        api_v2_metapub_program_information_batch_post_request: Optional[ApiV2MetapubProgramInformationBatchPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_metapub_program_information_batch_post_without_preload_content(
        self,
        api_v2_metapub_program_information_batch_post_request: Optional[ApiV2MetapubProgramInformationBatchPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_metapub_program_information_batch_post_serialize(
        self,
        api_v2_metapub_program_information_batch_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if api_v2_metapub_program_information_batch_post_request is not None:
            _body_params = api_v2_metapub_program_information_batch_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/metapub/program-information/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
