...
class PiecesApi:
    ...
    @validate_call
    def api_v2_pieces_get(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the piece.")],
        ...
        :param episode_id: The ID of the episode that owns the piece. (required)
        :type episode_id: int
        ...
        _param = self._api_v2_pieces_get_serialize(
    ...
    @validate_call
    def api_v2_pieces_get_with_http_info(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the piece.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_pieces_get_without_preload_content(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the piece.")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_pieces_get_serialize(
        self,
        episode_id,
        _request_auth,
        _content_type,
    ...
    def api_v2_pieces_id_delete(
        ...
        _param = self._api_v2_pieces_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_pieces_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_pieces_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_pieces_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/pieces/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api_v2_pieces_id_get(
        ...
        _param = self._api_v2_pieces_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_pieces_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_pieces_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_pieces_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def api_v2_pieces_post(
        ...
        _param = self._api_v2_pieces_post_serialize(
            piece=piece,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_pieces_post_with_http_info(
        self,
        piece: Optional[Piece] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_pieces_post_without_preload_content(
        self,
        piece: Optional[Piece] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_pieces_post_serialize(
        self,
        piece,
        _request_auth,
        _content_type,
