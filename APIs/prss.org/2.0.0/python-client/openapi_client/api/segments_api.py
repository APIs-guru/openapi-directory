...
class SegmentsApi:
    ...
    @validate_call
    def api_v2_segments_get(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Optional[StrictInt] = None,
        ...
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of segments, based on segment ID. If unspecified, the segments are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
        ...
        :param episode_id: The ID of the episode that owns the segment. (required)
        :type episode_id: int
        ...
        _param = self._api_v2_segments_get_serialize(
    ...
    @validate_call
    def api_v2_segments_get_with_http_info(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Optional[StrictInt] = None,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the results to return. The first item is indexed at 0.")] = None,
    ...
    @validate_call
    def api_v2_segments_get_without_preload_content(
        self,
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Optional[StrictInt] = None,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the results to return. The first item is indexed at 0.")] = None,
    ...
    def _api_v2_segments_get_serialize(
        self,
        episode_id,
        segment_number,
        page_start,
        ...
        if segment_number is not None:
            ...
            _query_params.append(('segmentNumber', segment_number))
    ...
    @validate_call
    def api_v2_segments_id_content_get(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._api_v2_segments_id_content_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_segments_id_content_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_segments_id_content_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_segments_id_content_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/segments/{id}/content',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api_v2_segments_id_delete(
        ...
        _param = self._api_v2_segments_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_segments_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_segments_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_segments_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/segments/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api_v2_segments_id_get(
        ...
        _param = self._api_v2_segments_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_segments_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_segments_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _api_v2_segments_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def api_v2_segments_post(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the segment content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Annotated[StrictInt, Field(description="The segment number of the segment.")],
        in_cue: Annotated[Optional[StrictStr], Field(description="The incue for the segment. Defaults to the program segment incue.")] = None,
        out_cue: Annotated[Optional[StrictStr], Field(description="The outcue for the segment. Defaults to the program segment outcue.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cd_drive_uri: The URI to the segment content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'. (required)
        :type cd_drive_uri: str
        :param episode_id: The ID of the episode that owns the segment. (required)
        :type episode_id: int
        :param segment_number: The segment number of the segment. (required)
        :type segment_number: int
        ...
        _param = self._api_v2_segments_post_serialize(
            cd_drive_uri=cd_drive_uri,
            episode_id=episode_id,
            segment_number=segment_number,
            in_cue=in_cue,
            out_cue=out_cue,
    ...
    @validate_call
    def api_v2_segments_post_with_http_info(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the segment content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Annotated[StrictInt, Field(description="The segment number of the segment.")],
    ...
    @validate_call
    def api_v2_segments_post_without_preload_content(
        self,
        cd_drive_uri: Annotated[StrictStr, Field(description="The URI to the segment content in CD Drive. Format should be 'cddrive:id:{value}' or 'cddrive://{path}'.")],
        episode_id: Annotated[StrictInt, Field(description="The ID of the episode that owns the segment.")],
        segment_number: Annotated[StrictInt, Field(description="The segment number of the segment.")],
    ...
    def _api_v2_segments_post_serialize(
        self,
        cd_drive_uri,
        episode_id,
        segment_number,
        ...
        # process the header parameters
        # process the form parameters
        if cd_drive_uri is not None:
            _form_params.append(('cdDriveUri', cd_drive_uri))
        if episode_id is not None:
            _form_params.append(('episodeId', episode_id))
        if in_cue is not None:
            _form_params.append(('inCue', in_cue))
        if out_cue is not None:
            _form_params.append(('outCue', out_cue))
        if segment_number is not None:
            _form_params.append(('segmentNumber', segment_number))
        # process the body parameter
