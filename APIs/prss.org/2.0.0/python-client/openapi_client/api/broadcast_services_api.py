...
class BroadcastServicesApi:
    ...
    @validate_call
    def api_v2_broadcastservices_get(
        self,
        ...
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of broadcast services, based on broadcast service ID. If unspecified, the broadcast services are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
        ...
        _param = self._api_v2_broadcastservices_get_serialize(
    ...
    @validate_call
    def api_v2_broadcastservices_get_with_http_info(
        self,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the results to return. The first item is indexed at 0.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="The number of items to return. Must be between 0 and 500, inclusive.")] = None,
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of broadcast services, based on broadcast service ID. If unspecified, the broadcast services are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
    ...
    @validate_call
    def api_v2_broadcastservices_get_without_preload_content(
        self,
        page_start: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The start page of the results to return. The first item is indexed at 0.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="The number of items to return. Must be between 0 and 500, inclusive.")] = None,
        order_by_id: Annotated[Optional[StrictStr], Field(description="The sort order of the list of broadcast services, based on broadcast service ID. If unspecified, the broadcast services are returned in random order. If using paging to iterate through the results, sort order should be specified.")] = None,
    ...
    def _api_v2_broadcastservices_get_serialize(
        self,
        page_start,
        page_size,
        order_by_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/broadcastservices',
    ...
    @validate_call
    def api_v2_broadcastservices_id_get(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the broadcast service to find.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_v2_broadcastservices_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_broadcastservices_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the broadcast service to find.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_broadcastservices_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the broadcast service to find.")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_broadcastservices_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/broadcastservices/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
