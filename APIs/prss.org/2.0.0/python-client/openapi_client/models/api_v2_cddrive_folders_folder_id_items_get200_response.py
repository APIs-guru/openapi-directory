...
class ApiV2CddriveFoldersFolderIdItemsGet200Response(BaseModel):
    """
    ApiV2CddriveFoldersFolderIdItemsGet200Response
    """ # noqa: E501
    entries: Optional[List[CDDriveItem]] = Field(default=None, description="The item instances.")
    limit: Optional[StrictInt] = Field(default=None, description="The maximum number of items to return.")
    offset: Optional[StrictInt] = Field(default=None, description="The start offset into the items.")
    total_count: Optional[StrictInt] = Field(default=None, description="The total number of entries available.", alias="totalCount")
    __properties: ClassVar[List[str]] = ["entries", "limit", "offset", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [CDDriveItem.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "limit": obj.get("limit"),
