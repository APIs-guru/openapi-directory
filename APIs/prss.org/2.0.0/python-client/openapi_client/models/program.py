...
class Program(BaseModel):
    ...
    customer_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The ID of the customer that owns this program.", alias="customerId")
    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the program. Generated at creation.")
    last_modified_date: Optional[datetime] = Field(default=None, description="The date the program was last modified/updated. Automatically updated on any write operation.", alias="lastModifiedDate")
    title: StrictStr = Field(description="The title of the program.")
    __properties: ClassVar[List[str]] = ["createdDate", "customerId", "id", "lastModifiedDate", "title"]
