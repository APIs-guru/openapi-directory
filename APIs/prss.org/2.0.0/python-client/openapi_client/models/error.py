...
class Error(BaseModel):
    ...
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="The occurrence-specific problem description.")
    status: Optional[StrictInt] = Field(default=None, description="The status code of the error.")
    title: Optional[StrictStr] = Field(default=None, description="The general problem description.")
