...
class BroadcastService(BaseModel):
    ...
    """ # noqa: E501
    created_date: datetime = Field(description="The date the broadcast service was created.", alias="createdDate")
    description: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1200)]] = Field(default=None, description="The description of the broadcast service.")
    id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The ID of the broadcast service.")
    last_modified_date: datetime = Field(description="The date the broadcast service was last modified.", alias="lastModifiedDate")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The name of the broadcast service.")
    __properties: ClassVar[List[str]] = ["createdDate", "description", "id", "lastModifiedDate", "name"]
