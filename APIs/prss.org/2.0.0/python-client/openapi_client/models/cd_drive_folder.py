...
class CDDriveFolder(BaseModel):
    """
    A folder in the CD Drive that can contain other items such as files or folders.
    """ # noqa: E501
    created_date: StrictStr = Field(description="The date and time the folder was created.", alias="createdDate")
    id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The ID of the folder.")
    last_modified_date: StrictStr = Field(description="The date and time the folder was last modified. This may only represent a modification to to the folder metadata itself, not to the contents of the folder.", alias="lastModifiedDate")
    ...
    __properties: ClassVar[List[str]] = ["createdDate", "id", "lastModifiedDate", "name", "parentId"]
