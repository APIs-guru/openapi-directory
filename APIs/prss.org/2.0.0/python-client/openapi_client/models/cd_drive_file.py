...
class CDDriveFile(BaseModel):
    """
    A file in the CD Drive that contains content.
    """ # noqa: E501
    created_date: StrictStr = Field(description="The date and time the file was created.", alias="createdDate")
    id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The ID of the file.")
    last_modified_date: StrictStr = Field(description="The date and time the file was last modified.", alias="lastModifiedDate")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The name of the file including the extension.")
    parent_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The ID of the parent folder or 0 for the root folder.", alias="parentId")
    size: Optional[StrictInt] = Field(default=None, description="The size of the file in bytes.")
    __properties: ClassVar[List[str]] = ["createdDate", "id", "lastModifiedDate", "name", "parentId", "size"]
