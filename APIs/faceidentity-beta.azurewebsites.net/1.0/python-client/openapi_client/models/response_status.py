...
class ResponseStatus(BaseModel):
    ...
    ResponseStatus
    """ # noqa: E501
    code: StrictStr = Field(description="Indicates whether connection was established or not")
    message: StrictStr = Field(description="The message that provides more detail relating to the status code")
