...
class SubscriptionApi:
    ...
    @validate_call
    def subscription_listid_post(
        self,
        listid: Annotated[StrictStr, Field(description="Unique 16 characters ID of the contact list")],
        subscription: Annotated[SubscriptionRequest, Field(description="Subscription request")],
        ...
        _param = self._subscription_listid_post_serialize(
            listid=listid,
    ...
    @validate_call
    def subscription_listid_post_with_http_info(
        self,
        listid: Annotated[StrictStr, Field(description="Unique 16 characters ID of the contact list")],
        subscription: Annotated[SubscriptionRequest, Field(description="Subscription request")],
        _request_timeout: Union[
    ...
    @validate_call
    def subscription_listid_post_without_preload_content(
        self,
        listid: Annotated[StrictStr, Field(description="Unique 16 characters ID of the contact list")],
        subscription: Annotated[SubscriptionRequest, Field(description="Subscription request")],
        _request_timeout: Union[
    ...
    def _subscription_listid_post_serialize(
        self,
        listid,
        subscription,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscription/{listid}',
