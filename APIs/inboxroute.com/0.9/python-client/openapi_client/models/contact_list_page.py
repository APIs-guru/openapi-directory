...
class ContactListPage(BaseModel):
    ...
    ContactListPage
    """ # noqa: E501
    page: Optional[List[ContactList]] = Field(default=None, description="Array of ContactList for that page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": [ContactList.from_dict(_item) for _item in obj["page"]] if obj.get("page") is not None else None,
            "total": obj.get("total")
        })
        return _obj
