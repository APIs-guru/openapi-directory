...
class TestOrderTransaction(unittest.TestCase):
    """OrderTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderTransaction:
