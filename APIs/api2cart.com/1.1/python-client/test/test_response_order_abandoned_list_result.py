...
class TestResponseOrderAbandonedListResult(unittest.TestCase):
    """ResponseOrderAbandonedListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseOrderAbandonedListResult:
        """Test ResponseOrderAbandonedListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseOrderAbandonedListResult`
        """
        model = ResponseOrderAbandonedListResult()
        if include_optional:
            return ResponseOrderAbandonedListResult(
    ...
    def testResponseOrderAbandonedListResult(self):
        """Test ResponseOrderAbandonedListResult"""
