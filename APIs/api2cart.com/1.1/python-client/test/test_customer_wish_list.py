...
class TestCustomerWishList(unittest.TestCase):
    """CustomerWishList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerWishList:
