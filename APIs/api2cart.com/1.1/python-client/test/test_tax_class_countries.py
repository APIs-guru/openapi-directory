...
class TestTaxClassCountries(unittest.TestCase):
    """TaxClassCountries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxClassCountries:
        """Test TaxClassCountries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxClassCountries`
        """
        model = TaxClassCountries()
        if include_optional:
            return TaxClassCountries(
    ...
    def testTaxClassCountries(self):
        """Test TaxClassCountries"""
