...
class TestCouponCondition(unittest.TestCase):
    """CouponCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CouponCondition:
        """Test CouponCondition
