...
class TestCustomerAddAddressInner(unittest.TestCase):
    """CustomerAddAddressInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerAddAddressInner:
        """Test CustomerAddAddressInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAddAddressInner`
        """
        model = CustomerAddAddressInner()
        if include_optional:
            return CustomerAddAddressInner(
    ...
    def testCustomerAddAddressInner(self):
        """Test CustomerAddAddressInner"""
