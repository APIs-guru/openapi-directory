...
class OrderStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "history", "id", "name", "refund_info"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of refund_info
        if self.refund_info:
            _dict['refund_info'] = self.refund_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [OrderStatusHistoryItem.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
            "refund_info": OrderStatusRefund.from_dict(obj["refund_info"]) if obj.get("refund_info") is not None else None
        })
        return _obj
