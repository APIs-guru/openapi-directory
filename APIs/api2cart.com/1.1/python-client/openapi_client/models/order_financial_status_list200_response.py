...
class OrderFinancialStatusList200Response(BaseModel):
    """
    OrderFinancialStatusList200Response
    """ # noqa: E501
    result: Optional[OrderFinancialStatusList200ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": OrderFinancialStatusList200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
