...
class BasketLiveShippingService(BaseModel):
    ...
    callback_err_cnt: Optional[StrictInt] = None
    custom_fields: Optional[Dict[str, Any]] = None
    enabled_on_store: Optional[StrictBool] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "callback", "callback_err_cnt", "custom_fields", "enabled_on_store", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callback_err_cnt": obj.get("callback_err_cnt"),
            "custom_fields": obj.get("custom_fields"),
            "enabled_on_store": obj.get("enabled_on_store"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
