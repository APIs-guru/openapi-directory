...
class CartPluginList200ResponseResult(BaseModel):
    """
    CartPluginList200ResponseResult
    """ # noqa: E501
    all_plugins: Optional[StrictInt] = None
    plugins: Optional[List[PluginList]] = None
    __properties: ClassVar[List[str]] = ["all_plugins", "plugins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all_plugins": obj.get("all_plugins"),
            "plugins": [PluginList.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None
        })
        return _obj
