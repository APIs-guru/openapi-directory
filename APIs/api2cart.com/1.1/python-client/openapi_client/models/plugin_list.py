...
class PluginList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "all_plugins", "custom_fields", "plugins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugins": [Plugin.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None
        })
        return _obj
