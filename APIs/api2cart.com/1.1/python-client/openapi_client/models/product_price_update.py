...
class ProductPriceUpdate(BaseModel):
    ...
    ProductPriceUpdate
    """ # noqa: E501
    group_prices: Optional[List[ProductPriceUpdateGroupPricesInner]] = Field(default=None, description="Defines product's group prices")
    product_id: Optional[StrictStr] = Field(default=None, description="Defines the product where the price has to be updated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group_prices": [ProductPriceUpdateGroupPricesInner.from_dict(_item) for _item in obj["group_prices"]] if obj.get("group_prices") is not None else None,
