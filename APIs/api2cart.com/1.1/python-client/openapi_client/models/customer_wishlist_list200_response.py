...
class CustomerWishlistList200Response(BaseModel):
    """
    CustomerWishlistList200Response
    """ # noqa: E501
    result: Optional[ResponseCustomerWishListListResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ResponseCustomerWishListListResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
