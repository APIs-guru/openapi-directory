...
class ProductVariantList200Response(BaseModel):
    """
    ProductVariantList200Response
    """ # noqa: E501
    result: Optional[ProductVariantList200ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ProductVariantList200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
