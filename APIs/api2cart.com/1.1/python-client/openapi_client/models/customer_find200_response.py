...
class CustomerFind200Response(BaseModel):
    """
    CustomerFind200Response
    """ # noqa: E501
    result: Optional[CustomerFind200ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": CustomerFind200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
