...
class ResponseAttributeListResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "attribute", "attributes_count", "custom_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribute": [StoreAttribute.from_dict(_item) for _item in obj["attribute"]] if obj.get("attribute") is not None else None,
