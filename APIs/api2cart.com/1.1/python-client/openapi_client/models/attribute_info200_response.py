...
class AttributeInfo200Response(BaseModel):
    """
    AttributeInfo200Response
    """ # noqa: E501
    result: Optional[StoreAttribute] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": StoreAttribute.from_dict(obj["result"]) if obj.get("result") is not None else None,
