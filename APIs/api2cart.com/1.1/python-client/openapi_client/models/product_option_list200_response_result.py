...
class ProductOptionList200ResponseResult(BaseModel):
    """
    ProductOptionList200ResponseResult
    """ # noqa: E501
    option: Optional[List[ProductOption]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "option": [ProductOption.from_dict(_item) for _item in obj["option"]] if obj.get("option") is not None else None
        })
        return _obj
