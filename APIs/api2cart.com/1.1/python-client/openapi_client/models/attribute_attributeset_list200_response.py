...
class AttributeAttributesetList200Response(BaseModel):
    """
    AttributeAttributesetList200Response
    """ # noqa: E501
    result: Optional[List[StoreAttributeGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [StoreAttributeGroup.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
