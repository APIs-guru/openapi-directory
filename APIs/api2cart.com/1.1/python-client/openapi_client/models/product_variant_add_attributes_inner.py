...
class ProductVariantAddAttributesInner(BaseModel):
    """
    ProductVariantAddAttributesInner
    """ # noqa: E501
    attribute_name: Optional[StrictStr] = None
    attribute_price: Optional[Union[StrictFloat, StrictInt]] = None
    attribute_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attribute_name", "attribute_price", "attribute_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribute_price": obj.get("attribute_price"),
