...
class ResponseOrderTransactionListResult(BaseModel):
    ...
    transactions_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "transactions", "transactions_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [OrderTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
            "transactions_count": obj.get("transactions_count")
        })
        return _obj
