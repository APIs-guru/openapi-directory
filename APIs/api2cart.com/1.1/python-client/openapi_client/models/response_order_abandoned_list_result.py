...
class ResponseOrderAbandonedListResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": [OrderAbandoned.from_dict(_item) for _item in obj["order"]] if obj.get("order") is not None else None
        })
        return _obj
