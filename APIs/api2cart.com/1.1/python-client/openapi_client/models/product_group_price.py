...
class ProductGroupPrice(BaseModel):
    ...
    expire_time: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "expire_time", "group_id", "id", "price", "quantity", "start_time", "store_id"]
