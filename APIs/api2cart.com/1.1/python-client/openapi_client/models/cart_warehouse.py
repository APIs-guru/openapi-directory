...
class CartWarehouse(BaseModel):
    ...
    carriers_ids: Optional[List[StrictStr]] = None
    custom_fields: Optional[Dict[str, Any]] = None
    description: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    stores_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "address", "avail", "carriers_ids", "custom_fields", "description", "id", "name", "stores_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avail": obj.get("avail"),
            "carriers_ids": obj.get("carriers_ids"),
