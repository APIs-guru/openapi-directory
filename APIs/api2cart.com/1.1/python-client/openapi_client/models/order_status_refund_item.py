...
class OrderStatusRefundItem(BaseModel):
    ...
    refund: Optional[Union[StrictFloat, StrictInt]] = None
    variant_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "order_product_id", "product_id", "qty", "refund", "variant_id"]
