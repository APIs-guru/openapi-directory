...
class CategoryFind200ResponseResult(BaseModel):
    """
    CategoryFind200ResponseResult
    """ # noqa: E501
    category: Optional[List[CategoryFind200ResponseResultCategoryInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": [CategoryFind200ResponseResultCategoryInner.from_dict(_item) for _item in obj["category"]] if obj.get("category") is not None else None
        })
        return _obj
