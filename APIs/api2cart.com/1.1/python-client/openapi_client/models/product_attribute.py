...
class ProductAttribute(BaseModel):
    ...
    attribute_group_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["additional_fields", "attribute_group_id", "attribute_id", "code", "custom_fields", "lang_id", "name", "position", "product_id", "required", "store_id", "type", "value", "variant_id", "visible"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribute_group_id": obj.get("attribute_group_id"),
