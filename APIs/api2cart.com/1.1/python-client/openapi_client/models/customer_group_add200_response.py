...
class CustomerGroupAdd200Response(BaseModel):
    """
    CustomerGroupAdd200Response
    """ # noqa: E501
    result: Optional[List[CustomerGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [CustomerGroup.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
