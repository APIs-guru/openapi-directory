...
class ProductGroupItem(BaseModel):
    ...
    child_item_id: Optional[StrictStr] = None
    custom_fields: Optional[Dict[str, Any]] = None
    default_qty_in_pack: Optional[StrictStr] = None
    is_qty_in_pack_fixed: Optional[StrictBool] = None
    product_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "child_item_id", "custom_fields", "default_qty_in_pack", "is_qty_in_pack_fixed", "product_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "child_item_id": obj.get("child_item_id"),
