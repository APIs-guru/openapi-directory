...
class ProductFind200ResponseResult(BaseModel):
    """
    ProductFind200ResponseResult
    """ # noqa: E501
    product: Optional[List[ProductFind200ResponseResultProductInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "product": [ProductFind200ResponseResultProductInner.from_dict(_item) for _item in obj["product"]] if obj.get("product") is not None else None
        })
        return _obj
