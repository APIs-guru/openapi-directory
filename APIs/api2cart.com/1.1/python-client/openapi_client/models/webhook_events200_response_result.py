...
class WebhookEvents200ResponseResult(BaseModel):
    """
    WebhookEvents200ResponseResult
    """ # noqa: E501
    events: Optional[List[WebhookEvents200ResponseResultEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [WebhookEvents200ResponseResultEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
