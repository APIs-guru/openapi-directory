...
class CartShippingZonesList200Response(BaseModel):
    """
    CartShippingZonesList200Response
    """ # noqa: E501
    result: Optional[CartShippingZone] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": CartShippingZone.from_dict(obj["result"]) if obj.get("result") is not None else None,
