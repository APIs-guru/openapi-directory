...
class WebhookList200ResponseResult(BaseModel):
    """
    WebhookList200ResponseResult
    """ # noqa: E501
    webhook: Optional[List[Webhook]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhook": [Webhook.from_dict(_item) for _item in obj["webhook"]] if obj.get("webhook") is not None else None
        })
        return _obj
