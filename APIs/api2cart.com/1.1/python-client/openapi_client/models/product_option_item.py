...
class ProductOptionItem(BaseModel):
    ...
    product_option_item_id: Optional[StrictStr] = None
    quantity: Optional[StrictInt] = None
    sku: Optional[StrictStr] = None
    sort_order: Optional[StrictInt] = None
    type_price: Optional[StrictStr] = None
    weight: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["additional_fields", "custom_fields", "id", "name", "price", "product_option_item_id", "quantity", "sku", "sort_order", "type_price", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "price": obj.get("price"),
            "product_option_item_id": obj.get("product_option_item_id"),
            "quantity": obj.get("quantity"),
            "sku": obj.get("sku"),
            "sort_order": obj.get("sort_order"),
            "type_price": obj.get("type_price"),
