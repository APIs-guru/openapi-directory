...
class WebhookEvents200ResponseResultEventsInner(BaseModel):
    """
    WebhookEvents200ResponseResultEventsInner
    """ # noqa: E501
    action: Optional[StrictStr] = None
    entity: Optional[StrictStr] = None
    webhook_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["action", "entity", "webhook_name"]
