...
class ProductCurrencyList200ResponseResult(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.currency:
            for _item_currency in self.currency:
                if _item_currency:
                    _items.append(_item_currency.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currency": [Currency.from_dict(_item) for _item in obj["currency"]] if obj.get("currency") is not None else None
        })
        return _obj
