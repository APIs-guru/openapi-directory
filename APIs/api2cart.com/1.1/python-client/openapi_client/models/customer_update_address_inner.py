...
class CustomerUpdateAddressInner(BaseModel):
    """
    ...
    address_book_id: Optional[StrictStr] = Field(default=None, description="The ID of the address.")
    ...
    __properties: ClassVar[List[str]] = ["address_book_address1", "address_book_address2", "address_book_city", "address_book_company", "address_book_country", "address_book_default", "address_book_fax", "address_book_first_name", "address_book_id", "address_book_identification_number", "address_book_last_name", "address_book_phone", "address_book_phone_mobile", "address_book_postcode", "address_book_state", "address_book_tax_id", "address_book_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address_book_id": obj.get("address_book_id"),
