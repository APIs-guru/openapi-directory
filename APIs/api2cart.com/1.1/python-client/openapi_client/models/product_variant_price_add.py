...
class ProductVariantPriceAdd(BaseModel):
    ...
    """ # noqa: E501
    group_prices: List[ProductAddGroupPricesInner] = Field(description="Defines variants's group prices")
    id: Optional[StrictStr] = Field(default=None, description="Defines the variant to which the price has to be added")
