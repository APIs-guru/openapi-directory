...
class AuthenticationOAuthApi:
    ...
    def authorize_application(
        ...
        client_id: Annotated[StrictStr, Field(description="Get this from your app settings.")],
        redirect_uri: Annotated[StrictStr, Field(description="URI specified in your app settings.")],
        state: Annotated[Optional[StrictStr], Field(description="State variable for CSRF purposes.")] = None,
        body: Annotated[Optional[StrictStr], Field(description="Default to the sign up page.")] = None,
    ...
    def exchange_refresh_token_for_access_token(
        self,
        exchange_refresh_token_for_access_token_request: Optional[ExchangeRefreshTokenForAccessTokenRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
