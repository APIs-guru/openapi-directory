...
class MoviesApi:
    ...
    @validate_call
    def get_the_most_recommended_movies(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        ...
        _param = self._get_the_most_recommended_movies_serialize(
            period=period,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_the_most_recommended_movies_with_http_info(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
    ...
    @validate_call
    def get_the_most_recommended_movies_without_preload_content(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
    ...
    def _get_the_most_recommended_movies_serialize(
        self,
        period,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/movies/recommended/{period}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
