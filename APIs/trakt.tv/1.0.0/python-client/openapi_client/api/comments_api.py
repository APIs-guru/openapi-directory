...
class CommentsApi:
    ...
    def get_a_comment_or_reply(
        self,
        id: Annotated[StrictStr, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        _request_timeout: Union[
            None,
    ...
    def post_a_reply_for_a_comment(
        ...
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        post_a_reply_for_a_comment_request: Optional[PostAReplyForACommentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_a_comment_or_reply(
        ...
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        update_a_comment_or_reply_request: Optional[UpdateACommentOrReplyRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
