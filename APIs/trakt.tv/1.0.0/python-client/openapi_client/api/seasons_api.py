...
class SeasonsApi:
    ...
    @validate_call
    def get_single_season_for_a_show(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[Optional[StrictStr], Field(description="include episode translations")] = None,
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_single_season_for_a_show_serialize(
            id=id,
            season=season,
    ...
    @validate_call
    def get_single_season_for_a_show_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[Optional[StrictStr], Field(description="include episode translations")] = None,
    ...
    @validate_call
    def get_single_season_for_a_show_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[Optional[StrictStr], Field(description="include episode translations")] = None,
    ...
    def _get_single_season_for_a_show_serialize(
        self,
        id,
        season,
        translations,
    ...
    @validate_call
    def shows_id_seasons_season_watching_get(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        ...
        _param = self._shows_id_seasons_season_watching_get_serialize(
            id=id,
            season=season,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
    ...
    @validate_call
    def shows_id_seasons_season_watching_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
    ...
    @validate_call
    def shows_id_seasons_season_watching_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
    ...
    def _shows_id_seasons_season_watching_get_serialize(
        self,
        id,
        season,
        trakt_api_version,
