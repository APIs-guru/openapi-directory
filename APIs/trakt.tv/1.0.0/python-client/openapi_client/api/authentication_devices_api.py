...
class AuthenticationDevicesApi:
    ...
    def generate_new_device_codes(
        self,
        generate_new_device_codes_request: Optional[GenerateNewDeviceCodesRequest] = None,
    ...
    def poll_for_the_access_token(
        self,
        poll_for_the_access_token_request: Optional[PollForTheAccessTokenRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
