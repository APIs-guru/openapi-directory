...
class RecommendationsApi:
    ...
    def get_movie_recommendations(
        self,
        ignore_collected: Annotated[Optional[StrictStr], Field(description="filter out collected movies")] = None,
        ignore_watchlisted: Annotated[Optional[StrictStr], Field(description="filter out watchlisted movies")] = None,
    ...
    def get_show_recommendations(
        self,
        ignore_collected: Annotated[Optional[StrictStr], Field(description="filter out collected shows")] = None,
        ignore_watchlisted: Annotated[Optional[StrictStr], Field(description="filter out watchlisted movies")] = None,
        trakt_api_version: Annotated[Optional[StrictStr], Field(description="e.g. 2")] = None,
        trakt_api_key: Annotated[Optional[StrictStr], Field(description="e.g. [client_id]")] = None,
        _request_timeout: Union[
