...
from openapi_client.models.add_items_to_personal_list_request_people_inner import AddItemsToPersonalListRequestPeopleInner
from openapi_client.models.remove_items_from_personal_list_request_movies_inner import RemoveItemsFromPersonalListRequestMoviesInner
...
class RemoveItemsFromPersonalListRequest(BaseModel):
    ...
    people: Optional[List[AddItemsToPersonalListRequestPeopleInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["episodes", "movies", "people", "seasons", "shows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "movies": [RemoveItemsFromPersonalListRequestMoviesInner.from_dict(_item) for _item in obj["movies"]] if obj.get("movies") is not None else None,
            "people": [AddItemsToPersonalListRequestPeopleInner.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None,
            ...
            "shows": [RemoveItemsFromPersonalListRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
