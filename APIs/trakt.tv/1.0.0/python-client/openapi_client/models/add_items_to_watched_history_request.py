...
from openapi_client.models.add_items_to_watched_history_request_episodes_inner import AddItemsToWatchedHistoryRequestEpisodesInner
...
from openapi_client.models.add_items_to_watched_history_request_seasons_inner import AddItemsToWatchedHistoryRequestSeasonsInner
...
class AddItemsToWatchedHistoryRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "episodes": [AddItemsToWatchedHistoryRequestEpisodesInner.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "movies": [AddItemsToWatchedHistoryRequestMoviesInner.from_dict(_item) for _item in obj["movies"]] if obj.get("movies") is not None else None,
            "seasons": [AddItemsToWatchedHistoryRequestSeasonsInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None,
            "shows": [AddItemsToWatchedHistoryRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
