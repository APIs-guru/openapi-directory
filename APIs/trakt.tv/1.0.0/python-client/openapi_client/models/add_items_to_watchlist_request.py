...
from openapi_client.models.add_items_to_collection_request_episodes_inner import AddItemsToCollectionRequestEpisodesInner
from openapi_client.models.add_items_to_collection_request_seasons_inner import AddItemsToCollectionRequestSeasonsInner
...
class AddItemsToWatchlistRequest(BaseModel):
    ...
    movies: Optional[List[AddItemsToPersonalRecommendationsRequestMoviesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["episodes", "movies", "seasons", "shows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "episodes": [AddItemsToCollectionRequestEpisodesInner.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "movies": [AddItemsToPersonalRecommendationsRequestMoviesInner.from_dict(_item) for _item in obj["movies"]] if obj.get("movies") is not None else None,
            "seasons": [AddItemsToCollectionRequestSeasonsInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None,
            "shows": [AddItemsToWatchlistRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
