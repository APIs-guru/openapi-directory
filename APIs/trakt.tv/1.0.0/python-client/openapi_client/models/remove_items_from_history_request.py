...
class RemoveItemsFromHistoryRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["episodes", "ids", "movies", "seasons", "shows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ids": obj.get("ids"),
            "movies": [RemoveItemsFromCollectionRequestMoviesInner.from_dict(_item) for _item in obj["movies"]] if obj.get("movies") is not None else None,
            ...
            "shows": [RemoveItemsFromCollectionRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
