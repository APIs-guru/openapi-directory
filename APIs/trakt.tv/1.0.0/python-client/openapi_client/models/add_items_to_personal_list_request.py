...
from openapi_client.models.add_items_to_personal_list_request_movies_inner import AddItemsToPersonalListRequestMoviesInner
...
class AddItemsToPersonalListRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "movies": [AddItemsToPersonalListRequestMoviesInner.from_dict(_item) for _item in obj["movies"]] if obj.get("movies") is not None else None,
            ...
            "shows": [AddItemsToPersonalListRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
