...
from openapi_client.models.add_hidden_items_request_seasons_inner import AddHiddenItemsRequestSeasonsInner
...
class AddHiddenItemsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["movies", "seasons", "shows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seasons": [AddHiddenItemsRequestSeasonsInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None,
            "shows": [AddHiddenItemsRequestShowsInner.from_dict(_item) for _item in obj["shows"]] if obj.get("shows") is not None else None
        })
        return _obj
