...
class TestMoviesApi(unittest.TestCase):
    ...
    def test_get_a_movie(self) -> None:
    ...
    def test_get_all_movie_aliases(self) -> None:
    ...
    def test_get_all_movie_comments(self) -> None:
    ...
    def test_get_all_movie_releases(self) -> None:
    ...
    def test_get_all_movie_translations(self) -> None:
    ...
    def test_get_all_people_for_a_movie(self) -> None:
    ...
    def test_get_lists_containing_this_movie(self) -> None:
    ...
    def test_get_movie_stats(self) -> None:
    ...
    def test_get_movie_studios(self) -> None:
    ...
    def test_get_popular_movies(self) -> None:
    ...
    def test_get_recently_updated_movie_trakt_ids(self) -> None:
    ...
    def test_get_recently_updated_movies(self) -> None:
    ...
    def test_get_related_movies(self) -> None:
    ...
    def test_get_the_most_anticipated_movies(self) -> None:
    ...
    def test_get_the_most_collected_movies(self) -> None:
    ...
    def test_get_the_most_played_movies(self) -> None:
    ...
    def test_get_the_most_recommended_movies(self) -> None:
    ...
    def test_get_the_most_watched_movies(self) -> None:
    ...
    def test_get_the_weekend_box_office(self) -> None:
    ...
    def test_get_trending_movies(self) -> None:
    ...
    def test_get_users_watching_right_now(self) -> None:
