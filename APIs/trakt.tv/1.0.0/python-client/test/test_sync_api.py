...
class TestSyncApi(unittest.TestCase):
    ...
    def test_add_items_to_collection(self) -> None:
    ...
    def test_add_items_to_personal_recommendations(self) -> None:
    ...
    def test_add_items_to_watched_history(self) -> None:
    ...
    def test_add_items_to_watchlist(self) -> None:
    ...
    def test_add_new_ratings(self) -> None:
    ...
    def test_get_last_activity(self) -> None:
    ...
    def test_get_personal_recommendations(self) -> None:
    ...
    def test_get_watched(self) -> None:
    ...
    def test_get_watched_history(self) -> None:
    ...
    def test_remove_a_playback_item(self) -> None:
    ...
    def test_remove_items_from_collection(self) -> None:
    ...
    def test_remove_items_from_history(self) -> None:
    ...
    def test_remove_items_from_personal_recommendations(self) -> None:
    ...
    def test_remove_items_from_watchlist(self) -> None:
    ...
    def test_reorder_personally_recommended_items(self) -> None:
    ...
    def test_reorder_watchlist_items(self) -> None:
