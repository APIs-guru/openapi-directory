...
class TestCalendarsApi(unittest.TestCase):
    ...
    def test_calendars_all_dvd_start_date_days_get(self) -> None:
    ...
    def test_calendars_all_movies_start_date_days_get(self) -> None:
    ...
    def test_calendars_all_shows_new_start_date_days_get(self) -> None:
    ...
    def test_calendars_all_shows_premieres_start_date_days_get(self) -> None:
    ...
    def test_calendars_all_shows_start_date_days_get(self) -> None:
    ...
    def test_get_dvd_releases(self) -> None:
    ...
    def test_get_new_shows(self) -> None:
    ...
    def test_get_season_premieres(self) -> None:
