...
class TestShowsApi(unittest.TestCase):
    ...
    def test_get_a_single_show(self) -> None:
    ...
    def test_get_all_people_for_a_show(self) -> None:
    ...
    def test_get_all_show_aliases(self) -> None:
    ...
    def test_get_all_show_certifications(self) -> None:
    ...
    def test_get_all_show_comments(self) -> None:
    ...
    def test_get_all_show_translations(self) -> None:
    ...
    def test_get_last_episode(self) -> None:
    ...
    def test_get_lists_containing_this_show(self) -> None:
    ...
    def test_get_next_episode(self) -> None:
    ...
    def test_get_popular_shows(self) -> None:
    ...
    def test_get_recently_updated_show_trakt_ids(self) -> None:
    ...
    def test_get_recently_updated_shows(self) -> None:
    ...
    def test_get_related_shows(self) -> None:
    ...
    def test_get_show_collection_progress(self) -> None:
    ...
    def test_get_show_ratings(self) -> None:
    ...
    def test_get_show_stats(self) -> None:
    ...
    def test_get_show_studios(self) -> None:
    ...
    def test_get_show_watched_progress(self) -> None:
    ...
    def test_get_the_most_anticipated_shows(self) -> None:
    ...
    def test_get_the_most_collected_shows(self) -> None:
    ...
    def test_get_the_most_played_shows(self) -> None:
    ...
    def test_get_the_most_recommended_shows(self) -> None:
    ...
    def test_get_the_most_watched_shows(self) -> None:
    ...
    def test_get_trending_shows(self) -> None:
    ...
    def test_reset_show_progress(self) -> None:
    ...
    def test_shows_id_watching_get(self) -> None:
    ...
    def test_undo_reset_show_progress(self) -> None:
