...
class TestUsersApi(unittest.TestCase):
    ...
    def test_add_hidden_items(self) -> None:
    ...
    def test_add_items_to_personal_list(self) -> None:
    ...
    def test_create_personal_list(self) -> None:
    ...
    def test_delete_a_users_personal_list(self) -> None:
    ...
    def test_follow_this_user(self) -> None:
    ...
    def test_get_a_users_personal_lists(self) -> None:
    ...
    def test_get_all_lists_a_user_can_collaborate_on(self) -> None:
    ...
    def test_get_follow_requests(self) -> None:
    ...
    def test_get_hidden_items(self) -> None:
    ...
    def test_get_items_on_a_personal_list(self) -> None:
    ...
    def test_get_pending_following_requests(self) -> None:
    ...
    def test_get_personal_list(self) -> None:
    ...
    def test_like_a_list(self) -> None:
    ...
    def test_remove_hidden_items(self) -> None:
    ...
    def test_remove_items_from_personal_list(self) -> None:
    ...
    def test_remove_like_on_a_list(self) -> None:
    ...
    def test_reorder_a_users_lists(self) -> None:
    ...
    def test_reorder_items_on_a_list(self) -> None:
    ...
    def test_retrieve_settings(self) -> None:
    ...
    def test_unfollow_this_user(self) -> None:
    ...
    def test_update_personal_list(self) -> None:
    ...
    def test_users_id_collection_type_get(self) -> None:
    ...
    def test_users_id_history_type_item_id_get(self) -> None:
    ...
    def test_users_id_lists_list_id_comments_sort_get(self) -> None:
    ...
    def test_users_id_lists_list_id_likes_get(self) -> None:
    ...
    def test_users_id_ratings_type_rating_get(self) -> None:
    ...
    def test_users_id_recommendations_type_sort_get(self) -> None:
    ...
    def test_users_id_watched_type_get(self) -> None:
    ...
    def test_users_id_watchlist_type_sort_get(self) -> None:
