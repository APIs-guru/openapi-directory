...
------------- | ------------- | -------------
[**get_genres**](GenresApi.md#get_genres) | **GET** /genres/{type} | Get genres


# **get_genres**
> get_genres(type, trakt_api_version=trakt_api_version, trakt_api_key=trakt_api_key)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get genres
        api_instance.get_genres(type, trakt_api_version=trakt_api_version, trakt_api_key=trakt_api_key)
