...
------------- | ------------- | -------------
[**get_countries**](CountriesApi.md#get_countries) | **GET** /countries/{type} | Get countries


# **get_countries**
> get_countries(type, trakt_api_version=trakt_api_version, trakt_api_key=trakt_api_key)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get countries
        api_instance.get_countries(type, trakt_api_version=trakt_api_version, trakt_api_key=trakt_api_key)
