...
class TestVenuesByRoute(unittest.TestCase):
    """VenuesByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuesByRoute:
        """Test VenuesByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuesByRoute`
        """
        model = VenuesByRoute()
        if include_optional:
