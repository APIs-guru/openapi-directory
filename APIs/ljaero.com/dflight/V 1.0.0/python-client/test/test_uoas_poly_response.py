...
class TestUOAsPolyResponse(unittest.TestCase):
    """UOAsPolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UOAsPolyResponse:
        """Test UOAsPolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UOAsPolyResponse`
        """
        model = UOAsPolyResponse()
        if include_optional:
