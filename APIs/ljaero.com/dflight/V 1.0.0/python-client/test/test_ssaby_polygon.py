...
class TestSSAByPolygon(unittest.TestCase):
    """SSAByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSAByPolygon:
        """Test SSAByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSAByPolygon`
        """
        model = SSAByPolygon()
        if include_optional:
            return SSAByPolygon(
