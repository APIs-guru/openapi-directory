...
class TestAirspaceByDistance(unittest.TestCase):
    """AirspaceByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirspaceByDistance:
        """Test AirspaceByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirspaceByDistance`
        """
        model = AirspaceByDistance()
        if include_optional:
    ...
    def testAirspaceByDistance(self):
        """Test AirspaceByDistance"""
