...
class TestAerodromeRouteResponse(unittest.TestCase):
    """AerodromeRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeRouteResponse:
        """Test AerodromeRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeRouteResponse`
        """
        model = AerodromeRouteResponse()
        if include_optional:
    ...
    def testAerodromeRouteResponse(self):
        """Test AerodromeRouteResponse"""
