...
class TestSSAPolyResponse(unittest.TestCase):
    """SSAPolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSAPolyResponse:
        """Test SSAPolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSAPolyResponse`
        """
        model = SSAPolyResponse()
        if include_optional:
