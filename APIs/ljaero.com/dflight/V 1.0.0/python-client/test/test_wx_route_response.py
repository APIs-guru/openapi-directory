...
class TestWxRouteResponse(unittest.TestCase):
    """WxRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxRouteResponse:
        """Test WxRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxRouteResponse`
        """
        model = WxRouteResponse()
        if include_optional:
