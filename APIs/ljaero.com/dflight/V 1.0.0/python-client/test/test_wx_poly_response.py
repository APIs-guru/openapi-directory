...
class TestWxPolyResponse(unittest.TestCase):
    """WxPolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxPolyResponse:
        """Test WxPolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxPolyResponse`
        """
        model = WxPolyResponse()
        if include_optional:
