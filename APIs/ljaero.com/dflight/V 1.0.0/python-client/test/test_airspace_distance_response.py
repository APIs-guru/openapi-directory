...
class TestAirspaceDistanceResponse(unittest.TestCase):
    """AirspaceDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirspaceDistanceResponse:
        """Test AirspaceDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirspaceDistanceResponse`
        """
        model = AirspaceDistanceResponse()
        if include_optional:
    ...
    def testAirspaceDistanceResponse(self):
        """Test AirspaceDistanceResponse"""
