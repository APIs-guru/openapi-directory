...
class TestAerodromesByRoute(unittest.TestCase):
    """AerodromesByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromesByRoute:
        """Test AerodromesByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromesByRoute`
        """
        model = AerodromesByRoute()
        if include_optional:
    ...
    def testAerodromesByRoute(self):
        """Test AerodromesByRoute"""
