...
class TestWxDistanceResponse(unittest.TestCase):
    """WxDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxDistanceResponse:
        """Test WxDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxDistanceResponse`
        """
        model = WxDistanceResponse()
        if include_optional:
    ...
    def testWxDistanceResponse(self):
        """Test WxDistanceResponse"""
