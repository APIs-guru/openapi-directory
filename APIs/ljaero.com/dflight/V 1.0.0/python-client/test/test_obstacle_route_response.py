...
class TestObstacleRouteResponse(unittest.TestCase):
    """ObstacleRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObstacleRouteResponse:
        """Test ObstacleRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObstacleRouteResponse`
        """
        model = ObstacleRouteResponse()
        if include_optional:
    ...
    def testObstacleRouteResponse(self):
        """Test ObstacleRouteResponse"""
