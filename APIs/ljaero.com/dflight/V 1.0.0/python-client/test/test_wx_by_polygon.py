...
class TestWxByPolygon(unittest.TestCase):
    """WxByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxByPolygon:
        """Test WxByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxByPolygon`
        """
        model = WxByPolygon()
        if include_optional:
            return WxByPolygon(
