...
class TestVenuePolyResponse(unittest.TestCase):
    """VenuePolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuePolyResponse:
        """Test VenuePolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuePolyResponse`
        """
        model = VenuePolyResponse()
        if include_optional:
    ...
    def testVenuePolyResponse(self):
        """Test VenuePolyResponse"""
