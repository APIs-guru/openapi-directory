...
class TestNOTAMsDistanceResponse(unittest.TestCase):
    """NOTAMsDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsDistanceResponse:
        """Test NOTAMsDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsDistanceResponse`
        """
        model = NOTAMsDistanceResponse()
        if include_optional:
    ...
    def testNOTAMsDistanceResponse(self):
        """Test NOTAMsDistanceResponse"""
