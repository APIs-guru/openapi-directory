...
class TestAerodromePolyResponse(unittest.TestCase):
    """AerodromePolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromePolyResponse:
        """Test AerodromePolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromePolyResponse`
        """
        model = AerodromePolyResponse()
        if include_optional:
    ...
    def testAerodromePolyResponse(self):
        """Test AerodromePolyResponse"""
