...
class TestNOTAMsByRoute(unittest.TestCase):
    """NOTAMsByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsByRoute:
        """Test NOTAMsByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsByRoute`
        """
        model = NOTAMsByRoute()
        if include_optional:
