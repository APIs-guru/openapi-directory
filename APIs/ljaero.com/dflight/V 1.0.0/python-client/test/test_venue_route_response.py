...
class TestVenueRouteResponse(unittest.TestCase):
    """VenueRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueRouteResponse:
        """Test VenueRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueRouteResponse`
        """
        model = VenueRouteResponse()
        if include_optional:
    ...
    def testVenueRouteResponse(self):
        """Test VenueRouteResponse"""
