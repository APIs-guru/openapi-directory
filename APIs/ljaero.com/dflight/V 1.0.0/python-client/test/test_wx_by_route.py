...
class TestWxByRoute(unittest.TestCase):
    """WxByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxByRoute:
        """Test WxByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxByRoute`
        """
        model = WxByRoute()
        if include_optional:
            return WxByRoute(
