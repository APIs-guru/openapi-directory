...
class TestSSAByDistance(unittest.TestCase):
    """SSAByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSAByDistance:
        """Test SSAByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSAByDistance`
        """
        model = SSAByDistance()
        if include_optional:
