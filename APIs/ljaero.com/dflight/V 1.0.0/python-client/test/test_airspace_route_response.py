...
class TestAirspaceRouteResponse(unittest.TestCase):
    """AirspaceRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirspaceRouteResponse:
        """Test AirspaceRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirspaceRouteResponse`
        """
        model = AirspaceRouteResponse()
        if include_optional:
    ...
    def testAirspaceRouteResponse(self):
        """Test AirspaceRouteResponse"""
