...
class TestAirspacePolyResponse(unittest.TestCase):
    """AirspacePolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirspacePolyResponse:
        """Test AirspacePolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirspacePolyResponse`
        """
        model = AirspacePolyResponse()
        if include_optional:
    ...
    def testAirspacePolyResponse(self):
        """Test AirspacePolyResponse"""
