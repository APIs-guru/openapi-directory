...
class TestVenueDistanceResponse(unittest.TestCase):
    """VenueDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueDistanceResponse:
        """Test VenueDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueDistanceResponse`
        """
        model = VenueDistanceResponse()
        if include_optional:
    ...
    def testVenueDistanceResponse(self):
        """Test VenueDistanceResponse"""
