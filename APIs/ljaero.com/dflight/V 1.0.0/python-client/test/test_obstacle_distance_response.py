...
class TestObstacleDistanceResponse(unittest.TestCase):
    """ObstacleDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObstacleDistanceResponse:
        """Test ObstacleDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObstacleDistanceResponse`
        """
        model = ObstacleDistanceResponse()
        if include_optional:
    ...
    def testObstacleDistanceResponse(self):
        """Test ObstacleDistanceResponse"""
