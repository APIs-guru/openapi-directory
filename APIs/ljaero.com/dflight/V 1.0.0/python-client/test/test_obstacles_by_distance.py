...
class TestObstaclesByDistance(unittest.TestCase):
    """ObstaclesByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObstaclesByDistance:
        """Test ObstaclesByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObstaclesByDistance`
        """
        model = ObstaclesByDistance()
        if include_optional:
    ...
    def testObstaclesByDistance(self):
        """Test ObstaclesByDistance"""
