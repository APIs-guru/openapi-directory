...
class TestVenuesByPolygon(unittest.TestCase):
    """VenuesByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuesByPolygon:
        """Test VenuesByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuesByPolygon`
        """
        model = VenuesByPolygon()
        if include_optional:
