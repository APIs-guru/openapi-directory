...
class TestAerodromeDistanceResponse(unittest.TestCase):
    """AerodromeDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeDistanceResponse:
        """Test AerodromeDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeDistanceResponse`
        """
        model = AerodromeDistanceResponse()
        if include_optional:
    ...
    def testAerodromeDistanceResponse(self):
        """Test AerodromeDistanceResponse"""
