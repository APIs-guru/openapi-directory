...
class TestUOAsByPolygon(unittest.TestCase):
    """UOAsByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UOAsByPolygon:
        """Test UOAsByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UOAsByPolygon`
        """
        model = UOAsByPolygon()
        if include_optional:
