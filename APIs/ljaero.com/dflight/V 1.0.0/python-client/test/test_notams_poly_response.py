...
class TestNOTAMsPolyResponse(unittest.TestCase):
    """NOTAMsPolyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsPolyResponse:
        """Test NOTAMsPolyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsPolyResponse`
        """
        model = NOTAMsPolyResponse()
        if include_optional:
    ...
    def testNOTAMsPolyResponse(self):
        """Test NOTAMsPolyResponse"""
