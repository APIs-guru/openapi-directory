...
class TestWxByDistance(unittest.TestCase):
    """WxByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WxByDistance:
        """Test WxByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WxByDistance`
        """
        model = WxByDistance()
        if include_optional:
            return WxByDistance(
