...
class TestUOAsRouteResponse(unittest.TestCase):
    """UOAsRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UOAsRouteResponse:
        """Test UOAsRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UOAsRouteResponse`
        """
        model = UOAsRouteResponse()
        if include_optional:
    ...
    def testUOAsRouteResponse(self):
        """Test UOAsRouteResponse"""
