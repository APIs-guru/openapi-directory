...
class TestVenuesByDistance(unittest.TestCase):
    """VenuesByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenuesByDistance:
        """Test VenuesByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenuesByDistance`
        """
        model = VenuesByDistance()
        if include_optional:
