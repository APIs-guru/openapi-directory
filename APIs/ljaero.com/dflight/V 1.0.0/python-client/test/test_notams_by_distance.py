...
class TestNOTAMsByDistance(unittest.TestCase):
    """NOTAMsByDistance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsByDistance:
        """Test NOTAMsByDistance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsByDistance`
        """
        model = NOTAMsByDistance()
        if include_optional:
            return NOTAMsByDistance(
                distance = None,
                latitude = None,
                longitude = None
            )
