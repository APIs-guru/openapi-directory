...
class TestUOAsDistanceResponse(unittest.TestCase):
    """UOAsDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UOAsDistanceResponse:
        """Test UOAsDistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UOAsDistanceResponse`
        """
        model = UOAsDistanceResponse()
        if include_optional:
    ...
    def testUOAsDistanceResponse(self):
        """Test UOAsDistanceResponse"""
