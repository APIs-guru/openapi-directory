...
class TestNOTAMsRouteResponse(unittest.TestCase):
    """NOTAMsRouteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsRouteResponse:
        """Test NOTAMsRouteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsRouteResponse`
        """
        model = NOTAMsRouteResponse()
        if include_optional:
    ...
    def testNOTAMsRouteResponse(self):
        """Test NOTAMsRouteResponse"""
