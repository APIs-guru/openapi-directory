...
class TestAirspaceByRoute(unittest.TestCase):
    """AirspaceByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AirspaceByRoute:
        """Test AirspaceByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AirspaceByRoute`
        """
        model = AirspaceByRoute()
        if include_optional:
