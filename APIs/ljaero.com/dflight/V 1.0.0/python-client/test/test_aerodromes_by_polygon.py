...
class TestAerodromesByPolygon(unittest.TestCase):
    """AerodromesByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromesByPolygon:
        """Test AerodromesByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromesByPolygon`
        """
        model = AerodromesByPolygon()
        if include_optional:
    ...
    def testAerodromesByPolygon(self):
        """Test AerodromesByPolygon"""
