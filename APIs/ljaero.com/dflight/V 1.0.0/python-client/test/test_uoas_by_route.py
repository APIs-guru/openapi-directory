...
class TestUOAsByRoute(unittest.TestCase):
    """UOAsByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UOAsByRoute:
        """Test UOAsByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UOAsByRoute`
        """
        model = UOAsByRoute()
        if include_optional:
            return UOAsByRoute(
