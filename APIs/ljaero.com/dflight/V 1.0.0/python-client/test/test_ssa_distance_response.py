...
class TestSSADistanceResponse(unittest.TestCase):
    """SSADistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSADistanceResponse:
        """Test SSADistanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSADistanceResponse`
        """
        model = SSADistanceResponse()
        if include_optional:
    ...
    def testSSADistanceResponse(self):
        """Test SSADistanceResponse"""
