...
class TestNOTAMsByPolygon(unittest.TestCase):
    """NOTAMsByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOTAMsByPolygon:
        """Test NOTAMsByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOTAMsByPolygon`
        """
        model = NOTAMsByPolygon()
        if include_optional:
            return NOTAMsByPolygon(
