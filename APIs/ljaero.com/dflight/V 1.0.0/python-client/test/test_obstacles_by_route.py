...
class TestObstaclesByRoute(unittest.TestCase):
    """ObstaclesByRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObstaclesByRoute:
        """Test ObstaclesByRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObstaclesByRoute`
        """
        model = ObstaclesByRoute()
        if include_optional:
