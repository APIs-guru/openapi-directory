...
class TestObstaclesByPolygon(unittest.TestCase):
    """ObstaclesByPolygon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObstaclesByPolygon:
        """Test ObstaclesByPolygon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObstaclesByPolygon`
        """
        model = ObstaclesByPolygon()
        if include_optional:
    ...
    def testObstaclesByPolygon(self):
        """Test ObstaclesByPolygon"""
