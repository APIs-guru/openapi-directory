...
class FlightRestrictionsApi:
    ...
    def tfr_by_distance_us_v1_restrictions_distance_query_post(
        self,
        notams_by_distance: NOTAMsByDistance,
        ...
        :param notams_by_distance: (required)
        :type notams_by_distance: NOTAMsByDistance
        :param x_api_key:
        :type x_api_key: str
        ...
        _param = self._tfr_by_distance_us_v1_restrictions_distance_query_post_serialize(
            notams_by_distance=notams_by_distance,
            x_api_key=x_api_key,
    ...
    @validate_call
    def tfr_by_distance_us_v1_restrictions_distance_query_post_with_http_info(
        self,
        notams_by_distance: NOTAMsByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NOTAMsDistanceResponse]:
        """Retrieve flight restrictions applicable within given distance of location.
    ...
    @validate_call
    def tfr_by_distance_us_v1_restrictions_distance_query_post_without_preload_content(
        self,
        notams_by_distance: NOTAMsByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _tfr_by_distance_us_v1_restrictions_distance_query_post_serialize(
        self,
        notams_by_distance,
        x_api_key,
        _request_auth,
        ...
        if notams_by_distance is not None:
            _body_params = notams_by_distance
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/restrictions/distance-query',
    ...
    def tfr_by_poly_us_v1_restrictions_polygon_query_post(
        self,
        notams_by_polygon: NOTAMsByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param notams_by_polygon: (required)
        :type notams_by_polygon: NOTAMsByPolygon
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._tfr_by_poly_us_v1_restrictions_polygon_query_post_serialize(
            notams_by_polygon=notams_by_polygon,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def tfr_by_poly_us_v1_restrictions_polygon_query_post_with_http_info(
        self,
        notams_by_polygon: NOTAMsByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NOTAMsPolyResponse]:
        """Retrieve flight restrictions applicable within given area.
    ...
    @validate_call
    def tfr_by_poly_us_v1_restrictions_polygon_query_post_without_preload_content(
        self,
        notams_by_polygon: NOTAMsByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _tfr_by_poly_us_v1_restrictions_polygon_query_post_serialize(
        self,
        notams_by_polygon,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if notams_by_polygon is not None:
            _body_params = notams_by_polygon
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/restrictions/polygon-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def tfr_by_route_us_v1_restrictions_route_query_post(
        ...
        :param notams_by_route: (required)
        :type notams_by_route: NOTAMsByRoute
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._tfr_by_route_us_v1_restrictions_route_query_post_serialize(
            notams_by_route=notams_by_route,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def tfr_by_route_us_v1_restrictions_route_query_post_with_http_info(
        self,
        notams_by_route: NOTAMsByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NOTAMsRouteResponse]:
        """Retrieve flight restrictions applicable along route.
    ...
    @validate_call
    def tfr_by_route_us_v1_restrictions_route_query_post_without_preload_content(
        self,
        notams_by_route: NOTAMsByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _tfr_by_route_us_v1_restrictions_route_query_post_serialize(
        self,
        notams_by_route,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if notams_by_route is not None:
            _body_params = notams_by_route
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/restrictions/route-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
