...
class WeatherApi:
    ...
    def wx_by_distance_us_v1_wx_forecast_distance_query_post(
        ...
        :param wx_by_distance: (required)
        :type wx_by_distance: WxByDistance
        :param x_api_key:
        :type x_api_key: str
        ...
        _param = self._wx_by_distance_us_v1_wx_forecast_distance_query_post_serialize(
            wx_by_distance=wx_by_distance,
            x_api_key=x_api_key,
    ...
    @validate_call
    def wx_by_distance_us_v1_wx_forecast_distance_query_post_with_http_info(
        self,
        wx_by_distance: WxByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WxDistanceResponse]:
        """Retrieve forecast values within given distance of location for all requested weather elements and time periods.
    ...
    @validate_call
    def wx_by_distance_us_v1_wx_forecast_distance_query_post_without_preload_content(
        self,
        wx_by_distance: WxByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _wx_by_distance_us_v1_wx_forecast_distance_query_post_serialize(
        self,
        wx_by_distance,
        x_api_key,
        _request_auth,
        ...
        if wx_by_distance is not None:
            _body_params = wx_by_distance
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/wx-forecast/distance-query',
    ...
    def wx_by_poly_us_v1_wx_forecast_polygon_query_post(
        ...
        :param wx_by_polygon: (required)
        :type wx_by_polygon: WxByPolygon
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._wx_by_poly_us_v1_wx_forecast_polygon_query_post_serialize(
            wx_by_polygon=wx_by_polygon,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def wx_by_poly_us_v1_wx_forecast_polygon_query_post_with_http_info(
        self,
        wx_by_polygon: WxByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def wx_by_poly_us_v1_wx_forecast_polygon_query_post_without_preload_content(
        self,
        wx_by_polygon: WxByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _wx_by_poly_us_v1_wx_forecast_polygon_query_post_serialize(
        self,
        wx_by_polygon,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if wx_by_polygon is not None:
            _body_params = wx_by_polygon
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/wx-forecast/polygon-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def wx_by_route_us_v1_wx_forecast_route_query_post(
        ...
        :param wx_by_route: (required)
        :type wx_by_route: WxByRoute
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._wx_by_route_us_v1_wx_forecast_route_query_post_serialize(
            wx_by_route=wx_by_route,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def wx_by_route_us_v1_wx_forecast_route_query_post_with_http_info(
        self,
        wx_by_route: WxByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def wx_by_route_us_v1_wx_forecast_route_query_post_without_preload_content(
        self,
        wx_by_route: WxByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _wx_by_route_us_v1_wx_forecast_route_query_post_serialize(
        self,
        wx_by_route,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if wx_by_route is not None:
            _body_params = wx_by_route
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/wx-forecast/route-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
