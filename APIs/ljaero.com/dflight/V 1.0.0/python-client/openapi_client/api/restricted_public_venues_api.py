...
class RestrictedPublicVenuesApi:
    ...
    def ven_by_distance_us_v1_venues_distance_query_post(
        self,
        venues_by_distance: VenuesByDistance,
        ...
        :param venues_by_distance: (required)
        :type venues_by_distance: VenuesByDistance
        :param x_api_key:
        :type x_api_key: str
        ...
        _param = self._ven_by_distance_us_v1_venues_distance_query_post_serialize(
            venues_by_distance=venues_by_distance,
            x_api_key=x_api_key,
    ...
    @validate_call
    def ven_by_distance_us_v1_venues_distance_query_post_with_http_info(
        self,
        venues_by_distance: VenuesByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VenueDistanceResponse]:
        """Retrieve all restricted public venues located within given distance of location.
    ...
    @validate_call
    def ven_by_distance_us_v1_venues_distance_query_post_without_preload_content(
        self,
        venues_by_distance: VenuesByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ven_by_distance_us_v1_venues_distance_query_post_serialize(
        self,
        venues_by_distance,
        x_api_key,
        _request_auth,
        ...
        if venues_by_distance is not None:
            _body_params = venues_by_distance
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/venues/distance-query',
    ...
    def ven_by_poly_us_v1_venues_polygon_query_post(
        self,
        venues_by_polygon: VenuesByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param venues_by_polygon: (required)
        :type venues_by_polygon: VenuesByPolygon
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._ven_by_poly_us_v1_venues_polygon_query_post_serialize(
            venues_by_polygon=venues_by_polygon,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ven_by_poly_us_v1_venues_polygon_query_post_with_http_info(
        self,
        venues_by_polygon: VenuesByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ven_by_poly_us_v1_venues_polygon_query_post_without_preload_content(
        self,
        venues_by_polygon: VenuesByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ven_by_poly_us_v1_venues_polygon_query_post_serialize(
        self,
        venues_by_polygon,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if venues_by_polygon is not None:
            _body_params = venues_by_polygon
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/venues/polygon-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ven_by_route_us_v1_venues_route_query_post(
        ...
        :param venues_by_route: (required)
        :type venues_by_route: VenuesByRoute
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._ven_by_route_us_v1_venues_route_query_post_serialize(
            venues_by_route=venues_by_route,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ven_by_route_us_v1_venues_route_query_post_with_http_info(
        self,
        venues_by_route: VenuesByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VenueRouteResponse]:
        """Retrieve all restricted public venues traversed by route.
    ...
    @validate_call
    def ven_by_route_us_v1_venues_route_query_post_without_preload_content(
        self,
        venues_by_route: VenuesByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ven_by_route_us_v1_venues_route_query_post_serialize(
        self,
        venues_by_route,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if venues_by_route is not None:
            _body_params = venues_by_route
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/venues/route-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
