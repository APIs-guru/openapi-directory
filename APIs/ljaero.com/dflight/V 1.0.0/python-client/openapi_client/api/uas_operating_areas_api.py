...
class UASOperatingAreasApi:
    ...
    def uoa_by_distance_us_v1_uoa_distance_query_post(
        self,
        uoas_by_distance: UOAsByDistance,
        ...
        :param uoas_by_distance: (required)
        :type uoas_by_distance: UOAsByDistance
        :param x_api_key:
        :type x_api_key: str
        ...
        _param = self._uoa_by_distance_us_v1_uoa_distance_query_post_serialize(
            uoas_by_distance=uoas_by_distance,
            x_api_key=x_api_key,
    ...
    @validate_call
    def uoa_by_distance_us_v1_uoa_distance_query_post_with_http_info(
        self,
        uoas_by_distance: UOAsByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UOAsDistanceResponse]:
        """Retrieve UAS Operating Areas (UOAs) found within given distance of location.
    ...
    @validate_call
    def uoa_by_distance_us_v1_uoa_distance_query_post_without_preload_content(
        self,
        uoas_by_distance: UOAsByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _uoa_by_distance_us_v1_uoa_distance_query_post_serialize(
        self,
        uoas_by_distance,
        x_api_key,
        _request_auth,
        ...
        if uoas_by_distance is not None:
            _body_params = uoas_by_distance
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/uoa/distance-query',
    ...
    def uoa_by_poly_us_v1_uoa_polygon_query_post(
        ...
        :param uoas_by_polygon: (required)
        :type uoas_by_polygon: UOAsByPolygon
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._uoa_by_poly_us_v1_uoa_polygon_query_post_serialize(
            uoas_by_polygon=uoas_by_polygon,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def uoa_by_poly_us_v1_uoa_polygon_query_post_with_http_info(
        self,
        uoas_by_polygon: UOAsByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def uoa_by_poly_us_v1_uoa_polygon_query_post_without_preload_content(
        self,
        uoas_by_polygon: UOAsByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _uoa_by_poly_us_v1_uoa_polygon_query_post_serialize(
        self,
        uoas_by_polygon,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if uoas_by_polygon is not None:
            _body_params = uoas_by_polygon
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/uoa/polygon-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def uoa_by_route_us_v1_uoa_route_query_post(
        ...
        :param uoas_by_route: (required)
        :type uoas_by_route: UOAsByRoute
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._uoa_by_route_us_v1_uoa_route_query_post_serialize(
            uoas_by_route=uoas_by_route,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def uoa_by_route_us_v1_uoa_route_query_post_with_http_info(
        self,
        uoas_by_route: UOAsByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def uoa_by_route_us_v1_uoa_route_query_post_without_preload_content(
        self,
        uoas_by_route: UOAsByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _uoa_by_route_us_v1_uoa_route_query_post_serialize(
        self,
        uoas_by_route,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if uoas_by_route is not None:
            _body_params = uoas_by_route
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/uoa/route-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
