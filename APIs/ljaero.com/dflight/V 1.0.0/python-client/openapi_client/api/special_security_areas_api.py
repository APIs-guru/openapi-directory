...
class SpecialSecurityAreasApi:
    ...
    def ssa_by_distance_us_v1_ssa_distance_query_post(
        ...
        :param ssaby_distance: (required)
        :type ssaby_distance: SSAByDistance
        :param x_api_key:
        :type x_api_key: str
        ...
        _param = self._ssa_by_distance_us_v1_ssa_distance_query_post_serialize(
            ssaby_distance=ssaby_distance,
            x_api_key=x_api_key,
    ...
    @validate_call
    def ssa_by_distance_us_v1_ssa_distance_query_post_with_http_info(
        self,
        ssaby_distance: SSAByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SSADistanceResponse]:
        """Retrieve all special security areas located within given distance of location.
    ...
    @validate_call
    def ssa_by_distance_us_v1_ssa_distance_query_post_without_preload_content(
        self,
        ssaby_distance: SSAByDistance,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ssa_by_distance_us_v1_ssa_distance_query_post_serialize(
        self,
        ssaby_distance,
        x_api_key,
        _request_auth,
        ...
        if ssaby_distance is not None:
            _body_params = ssaby_distance
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/ssa/distance-query',
    ...
    def ssa_by_poly_us_v1_ssa_polygon_query_post(
        ...
        :param ssaby_polygon: (required)
        :type ssaby_polygon: SSAByPolygon
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._ssa_by_poly_us_v1_ssa_polygon_query_post_serialize(
            ssaby_polygon=ssaby_polygon,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ssa_by_poly_us_v1_ssa_polygon_query_post_with_http_info(
        self,
        ssaby_polygon: SSAByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ssa_by_poly_us_v1_ssa_polygon_query_post_without_preload_content(
        self,
        ssaby_polygon: SSAByPolygon,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ssa_by_poly_us_v1_ssa_polygon_query_post_serialize(
        self,
        ssaby_polygon,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if ssaby_polygon is not None:
            _body_params = ssaby_polygon
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/ssa/polygon-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ssa_by_route_us_v1_ssa_route_query_post(
        ...
        :param ssaby_route: (required)
        :type ssaby_route: SSAByRoute
        :param x_api_key:
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._ssa_by_route_us_v1_ssa_route_query_post_serialize(
            ssaby_route=ssaby_route,
            x_api_key=x_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ssa_by_route_us_v1_ssa_route_query_post_with_http_info(
        self,
        ssaby_route: SSAByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ssa_by_route_us_v1_ssa_route_query_post_without_preload_content(
        self,
        ssaby_route: SSAByRoute,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _ssa_by_route_us_v1_ssa_route_query_post_serialize(
        self,
        ssaby_route,
        x_api_key,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if ssaby_route is not None:
            _body_params = ssaby_route
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/us/v1/ssa/route-query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
