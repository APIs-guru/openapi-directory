...
class ScrapeStoreLinksApi:
    ...
    @validate_call
    def g_etv1_scrape_store_links_format(
        self,
        ...
        _param = self._g_etv1_scrape_store_links_format_serialize(
            website=website,
    ...
    @validate_call
    def g_etv1_scrape_store_links_format_with_http_info(
        self,
        website: Annotated[StrictStr, Field(description="<p>The website (ie. www.soundflair.com)</p> ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def g_etv1_scrape_store_links_format_without_preload_content(
        self,
        website: Annotated[StrictStr, Field(description="<p>The website (ie. www.soundflair.com)</p> ")],
        _request_timeout: Union[
            None,
    ...
    def _g_etv1_scrape_store_links_format_serialize(
        self,
        website,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/scrape_store_links.json',
