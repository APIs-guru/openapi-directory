...
class DefaultApi:
    ...
    def address_get(
        ...
        _param = self._address_get_serialize(
            address=address,
    ...
    @validate_call
    def address_get_with_http_info(
        self,
        address: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddressGet200Response]:
        """address_get
    ...
    @validate_call
    def address_get_without_preload_content(
        self,
        address: StrictStr,
        _request_timeout: Union[
            None,
