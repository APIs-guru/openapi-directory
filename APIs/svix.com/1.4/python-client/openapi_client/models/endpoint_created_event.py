...
class EndpointCreatedEvent(BaseModel):
    ...
    type: Optional[StrictStr] = 'endpoint.created'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['endpoint.created']):
            raise ValueError("must be one of enum values ('endpoint.created')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EndpointCreatedEventData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'endpoint.created'
        })
        return _obj
