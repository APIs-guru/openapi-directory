...
class ApplicationOut(BaseModel):
    ...
    name: StrictStr
    rate_limit: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, alias="rateLimit")
    uid: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Optional unique identifier for the application")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["createdAt", "id", "metadata", "name", "rateLimit", "uid", "updatedAt"]
