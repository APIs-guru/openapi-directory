...
class MessageAttemptEndpointOut(BaseModel):
    """
    MessageAttemptEndpointOut
    """ # noqa: E501
    endpoint_id: StrictStr = Field(alias="endpointId")
    id: StrictStr
    msg_id: StrictStr = Field(alias="msgId")
    response: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["endpointId", "id", "msgId", "response", "responseStatusCode", "status", "timestamp", "triggerType", "url"]
