...
class EndpointUpdatedEvent(BaseModel):
    ...
    type: Optional[StrictStr] = 'endpoint.updated'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['endpoint.updated']):
            raise ValueError("must be one of enum values ('endpoint.updated')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EndpointUpdatedEventData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'endpoint.updated'
        })
        return _obj
