...
class BackgroundTaskFinishedEvent(BaseModel):
    ...
    type: Optional[StrictStr] = 'background_task.finished'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['background_task.finished']):
            raise ValueError("must be one of enum values ('background_task.finished')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BackgroundTaskFinishedEventData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'background_task.finished'
        })
        return _obj
