...
class MessageAttemptFailingEvent(BaseModel):
    ...
    type: Optional[StrictStr] = 'message.attempt.failing'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['message.attempt.failing']):
            raise ValueError("must be one of enum values ('message.attempt.failing')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MessageAttemptFailingEventData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'message.attempt.failing'
        })
        return _obj
