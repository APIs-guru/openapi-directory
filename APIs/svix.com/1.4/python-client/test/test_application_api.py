...
class TestApplicationApi(unittest.TestCase):
    ...
    def test_create_application_api_v1_app_post(self) -> None:
    ...
    def test_delete_application_api_v1_app_app_id_delete(self) -> None:
    ...
    def test_get_application_api_v1_app_app_id_get(self) -> None:
    ...
    def test_list_applications_api_v1_app_get(self) -> None:
    ...
    def test_update_application_api_v1_app_app_id_put(self) -> None:
