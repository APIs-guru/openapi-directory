...
class TestMessageIn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageIn:
        """Test MessageIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageIn`
        """
        model = MessageIn()
        if include_optional:
            return MessageIn(
                application = openapi_client.models.application_in.ApplicationIn(
                    metadata = {
                        'key' : ''
                        }, 
