...
class TestListResponseEventTypeOut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListResponseEventTypeOut:
        """Test ListResponseEventTypeOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListResponseEventTypeOut`
        """
        model = ListResponseEventTypeOut()
        if include_optional:
            return ListResponseEventTypeOut(
                data = [
                    openapi_client.models.event_type_out.EventTypeOut(
                        archived = False, 
    ...
    def testListResponseEventTypeOut(self):
        """Test ListResponseEventTypeOut"""
