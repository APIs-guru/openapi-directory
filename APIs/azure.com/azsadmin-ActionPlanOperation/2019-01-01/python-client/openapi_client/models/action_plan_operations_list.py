...
class ActionPlanOperationsList(BaseModel):
    """
    ...
    value: Optional[List[ActionPlanOperationResourceEntity]] = Field(default=None, description="Array of action plan operations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ActionPlanOperationResourceEntity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
