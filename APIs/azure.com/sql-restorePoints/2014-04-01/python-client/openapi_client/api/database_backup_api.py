...
class DatabaseBackupApi:
    ...
    def restore_points_list_by_database(
        ...
        database_name: Annotated[StrictStr, Field(description="The name of the database to get available restore points.")],
        ...
        :param database_name: The name of the database to get available restore points. (required)
