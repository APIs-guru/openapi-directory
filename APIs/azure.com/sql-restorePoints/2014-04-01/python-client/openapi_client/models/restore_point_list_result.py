...
class RestorePointListResult(BaseModel):
    """
    The response to a list database restore points request.
    """ # noqa: E501
    value: List[RestorePoint] = Field(description="The list of database restore points.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RestorePoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
