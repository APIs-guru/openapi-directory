...
------------ | ------------- | ------------- | -------------
**earliest_restore_date** | **datetime** | The earliest time to which this database can be restored | [optional] [readonly] 
**restore_point_creation_date** | **datetime** | The time the backup was taken | [optional] [readonly] 
**restore_point_label** | **str** | The label of restore point for backup request by user | [optional] [readonly] 
**restore_point_type** | **str** | The type of restore point | [optional] [readonly] 
