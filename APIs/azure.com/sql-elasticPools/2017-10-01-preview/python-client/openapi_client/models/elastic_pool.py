...
class ElasticPool(BaseModel):
    """
    An elastic pool.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Kind of elastic pool. This is metadata used for the Azure portal experience.")
    properties: Optional[ElasticPoolProperties] = None
    sku: Optional[object] = Field(default=None, description="An ARM Resource SKU.")
