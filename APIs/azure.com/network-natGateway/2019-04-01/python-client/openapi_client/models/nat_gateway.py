...
class NatGateway(BaseModel):
    ...
    properties: Optional[NatGatewayPropertiesFormat] = None
    sku: Optional[NatGatewaySku] = None
    zones: Optional[List[StrictStr]] = Field(default=None, description="A list of availability zones denoting the zone in which Nat Gateway should be deployed.")
