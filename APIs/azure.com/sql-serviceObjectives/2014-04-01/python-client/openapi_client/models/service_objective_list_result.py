...
class ServiceObjectiveListResult(BaseModel):
    """
    Represents the response to a get database service objectives request.
    """ # noqa: E501
    value: List[ServiceObjective] = Field(description="The list of database service objectives.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServiceObjective.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
