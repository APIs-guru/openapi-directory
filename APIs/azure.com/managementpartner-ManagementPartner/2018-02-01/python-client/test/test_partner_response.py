...
class TestPartnerResponse(unittest.TestCase):
    """PartnerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartnerResponse:
        """Test PartnerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartnerResponse`
        """
        ...
        if include_optional:
            return PartnerResponse(
                ...
                id = '',
                name = '',
                properties = openapi_client.models.partner_properties.PartnerProperties(
