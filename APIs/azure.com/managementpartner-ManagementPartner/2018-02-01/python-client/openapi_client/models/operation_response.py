...
class OperationResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="this is the operation response name")
    origin: Optional[StrictStr] = Field(default=None, description="the is operation response origin information")
