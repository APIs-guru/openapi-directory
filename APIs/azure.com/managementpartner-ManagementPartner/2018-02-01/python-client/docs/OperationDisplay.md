...
------------ | ------------- | ------------- | -------------
**description** | **str** | the is management partner operation description | [optional] 
**operation** | **str** | the is management partner operation | [optional] 
**provider** | **str** | the is management partner provider | [optional] 
**resource** | **str** | the is management partner resource | [optional] 
