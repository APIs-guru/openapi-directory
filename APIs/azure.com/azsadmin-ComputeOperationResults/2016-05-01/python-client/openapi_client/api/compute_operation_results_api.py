...
class ComputeOperationResultsApi:
    ...
    @validate_call
    def compute_operation_results_get(
        self,
        ...
        operation: Annotated[StrictStr, Field(description="Operation identifier.")],
        ...
        _param = self._compute_operation_results_get_serialize(
    ...
    @validate_call
    def compute_operation_results_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ComputeOperationResult]:
        """compute_operation_results_get
    ...
    @validate_call
    def compute_operation_results_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _compute_operation_results_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/computeOperationResults/{operation}',
    ...
    @validate_call
    def compute_operation_results_list(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        ...
        _param = self._compute_operation_results_list_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            location=location,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ComputeOperationResultList",
            '404': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def compute_operation_results_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ComputeOperationResultList]:
        """compute_operation_results_list
    ...
    @validate_call
    def compute_operation_results_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _compute_operation_results_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/computeOperationResults',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
