...
class CertificateRegistrationProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInnerAvailabilitiesInner(BaseModel):
    """
    Retention policy of a resource metric.
    """ # noqa: E501
    blob_duration: Optional[StrictStr] = Field(default=None, alias="blobDuration")
    time_grain: Optional[StrictStr] = Field(default=None, alias="timeGrain")
    __properties: ClassVar[List[str]] = ["blobDuration", "timeGrain"]
