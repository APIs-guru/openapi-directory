...
class BlobStreamInputDataSourceProperties(BaseModel):
    """
    The properties that are associated with a blob input containing stream data.
    """ # noqa: E501
    source_partition_count: Optional[StrictInt] = Field(default=None, description="The partition count of the blob input data source. Range 1 - 256.", alias="sourcePartitionCount")
