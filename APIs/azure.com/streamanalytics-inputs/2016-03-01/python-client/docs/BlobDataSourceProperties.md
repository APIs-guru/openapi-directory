...
blob_data_source_properties_instance = BlobDataSourceProperties.from_json(json)
# print the JSON string representation of the object
print(BlobDataSourceProperties.to_json())

# convert the object into a dict
blob_data_source_properties_dict = blob_data_source_properties_instance.to_dict()
# create an instance of BlobDataSourceProperties from a dict
blob_data_source_properties_from_dict = BlobDataSourceProperties.from_dict(blob_data_source_properties_dict)
```
