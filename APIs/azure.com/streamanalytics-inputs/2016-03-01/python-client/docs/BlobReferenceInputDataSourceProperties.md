...
blob_reference_input_data_source_properties_instance = BlobReferenceInputDataSourceProperties.from_json(json)
# print the JSON string representation of the object
print(BlobReferenceInputDataSourceProperties.to_json())

# convert the object into a dict
blob_reference_input_data_source_properties_dict = blob_reference_input_data_source_properties_instance.to_dict()
# create an instance of BlobReferenceInputDataSourceProperties from a dict
blob_reference_input_data_source_properties_from_dict = BlobReferenceInputDataSourceProperties.from_dict(blob_reference_input_data_source_properties_dict)
```
