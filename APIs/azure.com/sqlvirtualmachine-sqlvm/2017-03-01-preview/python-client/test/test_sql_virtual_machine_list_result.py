...
class TestSqlVirtualMachineListResult(unittest.TestCase):
    """SqlVirtualMachineListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SqlVirtualMachineListResult:
        """Test SqlVirtualMachineListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SqlVirtualMachineListResult`
        """
        model = SqlVirtualMachineListResult()
        if include_optional:
            return SqlVirtualMachineListResult(
                next_link = '',
                value = [
                    openapi_client.models.sql_virtual_machine.SqlVirtualMachine(
                        identity = openapi_client.models.resource_identity.ResourceIdentity(
                            principal_id = '', 
                            tenant_id = '', 
                            type = 'SystemAssigned', ), 
                        properties = openapi_client.models.sql_virtual_machine_properties.SqlVirtualMachineProperties(
    ...
    def testSqlVirtualMachineListResult(self):
        """Test SqlVirtualMachineListResult"""
