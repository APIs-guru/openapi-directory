...
class TestAvailabilityGroupListenerProperties(unittest.TestCase):
    """AvailabilityGroupListenerProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilityGroupListenerProperties:
        """Test AvailabilityGroupListenerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilityGroupListenerProperties`
        """
        model = AvailabilityGroupListenerProperties()
        if include_optional:
            return AvailabilityGroupListenerProperties(
    ...
    def testAvailabilityGroupListenerProperties(self):
        """Test AvailabilityGroupListenerProperties"""
