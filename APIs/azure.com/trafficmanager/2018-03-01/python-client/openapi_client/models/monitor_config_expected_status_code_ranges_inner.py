...
class MonitorConfigExpectedStatusCodeRangesInner(BaseModel):
    """
    Min and max value of a status code range.
    """ # noqa: E501
    max: Optional[StrictInt] = Field(default=None, description="Max status code.")
    min: Optional[StrictInt] = Field(default=None, description="Min status code.")
