...
class EndpointProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customHeaders", "endpointLocation", "endpointMonitorStatus", "endpointStatus", "geoMapping", "minChildEndpoints", "priority", "target", "targetResourceId", "weight"]
