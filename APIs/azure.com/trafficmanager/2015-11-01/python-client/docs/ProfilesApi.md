...
# **profiles_delete**
> profiles_delete(resource_group_name, profile_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.profiles_delete(resource_group_name, profile_name, api_version, subscription_id)
    except Exception as e:
