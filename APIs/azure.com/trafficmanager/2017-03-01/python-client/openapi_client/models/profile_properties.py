...
class ProfileProperties(BaseModel):
    ...
    traffic_routing_method: Optional[StrictStr] = Field(default=None, description="Gets or sets the traffic routing method of the Traffic Manager profile.  Possible values are 'Performance', 'Weighted', 'Priority' or 'Geographic'.", alias="trafficRoutingMethod")
