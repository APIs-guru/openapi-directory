...
[**profiles_list_all**](ProfilesApi.md#profiles_list_all) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Network/trafficmanagerprofiles | 
[**profiles_list_all_in_resource_group**](ProfilesApi.md#profiles_list_all_in_resource_group) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/trafficmanagerprofiles | 
...
# **profiles_list_all**
> ProfileListResult profiles_list_all(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.profiles_list_all(api_version, subscription_id)
        print("The response of ProfilesApi->profiles_list_all:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProfilesApi->profiles_list_all: %s\n" % e)
```
...
> ProfileListResult profiles_list_all_in_resource_group(resource_group_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.profiles_list_all_in_resource_group(resource_group_name, api_version, subscription_id)
        print("The response of ProfilesApi->profiles_list_all_in_resource_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProfilesApi->profiles_list_all_in_resource_group: %s\n" % e)
```
