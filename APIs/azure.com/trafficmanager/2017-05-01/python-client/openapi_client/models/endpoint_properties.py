...
class EndpointProperties(BaseModel):
    ...
    target: Optional[StrictStr] = Field(default=None, description="The fully-qualified DNS name of the endpoint. Traffic Manager returns this value in DNS responses to direct traffic to this endpoint.")
    ...
    __properties: ClassVar[List[str]] = ["endpointLocation", "endpointMonitorStatus", "endpointStatus", "geoMapping", "minChildEndpoints", "priority", "target", "targetResourceId", "weight"]
