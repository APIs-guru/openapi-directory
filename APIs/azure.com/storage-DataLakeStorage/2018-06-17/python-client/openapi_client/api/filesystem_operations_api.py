...
class FilesystemOperationsApi:
    ...
    def filesystem_create(
        ...
        x_ms_properties: Annotated[Optional[StrictStr], Field(description="User-defined properties to be stored with the filesystem, in the format of a comma-separated list of name and value pairs \"n1=v1, n2=v2, ...\", where each value is base64 encoded.")] = None,
        ...
        :param x_ms_properties: User-defined properties to be stored with the filesystem, in the format of a comma-separated list of name and value pairs \"n1=v1, n2=v2, ...\", where each value is base64 encoded.
