...
*FileAndDirectoryOperationsApi* | [**path_get_properties**](docs/FileAndDirectoryOperationsApi.md#path_get_properties) | **HEAD** /{filesystem}/{path} | Get Properties | Get Status | Get Access Control List | Check Access
