...
class TestWritableSettings(unittest.TestCase):
    """WritableSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WritableSettings:
        """Test WritableSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WritableSettings`
        """
        model = WritableSettings()
        if include_optional:
