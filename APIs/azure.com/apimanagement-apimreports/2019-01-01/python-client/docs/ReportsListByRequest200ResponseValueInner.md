...
reports_list_by_request200_response_value_inner_instance = ReportsListByRequest200ResponseValueInner.from_json(json)
# print the JSON string representation of the object
print(ReportsListByRequest200ResponseValueInner.to_json())

# convert the object into a dict
reports_list_by_request200_response_value_inner_dict = reports_list_by_request200_response_value_inner_instance.to_dict()
# create an instance of ReportsListByRequest200ResponseValueInner from a dict
reports_list_by_request200_response_value_inner_from_dict = ReportsListByRequest200ResponseValueInner.from_dict(reports_list_by_request200_response_value_inner_dict)
```
