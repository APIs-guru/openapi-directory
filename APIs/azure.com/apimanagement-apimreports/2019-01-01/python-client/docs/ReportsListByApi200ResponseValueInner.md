...
reports_list_by_api200_response_value_inner_instance = ReportsListByApi200ResponseValueInner.from_json(json)
# print the JSON string representation of the object
print(ReportsListByApi200ResponseValueInner.to_json())

# convert the object into a dict
reports_list_by_api200_response_value_inner_dict = reports_list_by_api200_response_value_inner_instance.to_dict()
# create an instance of ReportsListByApi200ResponseValueInner from a dict
reports_list_by_api200_response_value_inner_from_dict = ReportsListByApi200ResponseValueInner.from_dict(reports_list_by_api200_response_value_inner_dict)
```
