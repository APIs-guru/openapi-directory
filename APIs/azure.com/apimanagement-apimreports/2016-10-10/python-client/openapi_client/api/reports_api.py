...
class ReportsApi:
    ...
    def reports_list_by_service(
        ...
        aggregation: Annotated[StrictStr, Field(description="Report aggregation.")],
        ...
        interval: Annotated[Optional[StrictStr], Field(description="By time interval. This value is only applicable to ByTime aggregation. Interval must be multiple of 15 minutes and may not be zero. The value should be in ISO  8601 format (http://en.wikipedia.org/wiki/ISO_8601#Durations).This code can be used to convert TimSpan to a valid interval string: XmlConvert.ToString(new TimeSpan(hours, minutes, seconds))")] = None,
        ...
        _param = self._reports_list_by_service_serialize(
    ...
    @validate_call
    def reports_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        aggregation: Annotated[StrictStr, Field(description="Report aggregation.")],
    ...
    @validate_call
    def reports_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        aggregation: Annotated[StrictStr, Field(description="Report aggregation.")],
    ...
    def _reports_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        aggregation,
        ...
        if aggregation is not None:
            _path_params['aggregation'] = aggregation
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/reports/{aggregation}',
