...
class TestAvailabilityStatusListResult(unittest.TestCase):
    """AvailabilityStatusListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilityStatusListResult:
        """Test AvailabilityStatusListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilityStatusListResult`
        """
        model = AvailabilityStatusListResult()
        if include_optional:
            return AvailabilityStatusListResult(
                next_link = '',
                value = [
                    openapi_client.models.availability_status.availabilityStatus(
                        id = '', 
                        location = '', 
                        name = '', 
    ...
    def testAvailabilityStatusListResult(self):
        """Test AvailabilityStatusListResult"""
