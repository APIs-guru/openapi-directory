...
class AvailabilityStatusProperties(BaseModel):
    ...
    """ # noqa: E501
    availability_state: Optional[StrictStr] = Field(default=None, description="Availability status of the resource.", alias="availabilityState")
    ...
    is_arm_resource: Optional[StrictBool] = Field(default=None, description="flag to show if child resource need detail health. ", alias="isArmResource")
    ...
    recently_resolved_state: Optional[AvailabilityStatusPropertiesRecentlyResolvedState] = Field(default=None, alias="recentlyResolvedState")
    ...
    summary: Optional[StrictStr] = Field(default=None, description="Summary description of the availability state.")
    __properties: ClassVar[List[str]] = ["availabilityState", "detailedStatus", "isArmResource", "occuredTime", "reasonChronicity", "reasonType", "recentlyResolvedState", "recommendedActions", "reportedTime", "resolutionETA", "rootCauseAttributionTime", "serviceImpactingEvents", "summary"]
    ...
    def availability_state_validate_enum(cls, value):
        ...
        if value not in set(['Available', 'Unavailable', 'Unknown']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recently_resolved_state
        if self.recently_resolved_state:
            _dict['recentlyResolvedState'] = self.recently_resolved_state.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isArmResource": obj.get("isArmResource"),
            "occuredTime": obj.get("occuredTime"),
            "reasonChronicity": obj.get("reasonChronicity"),
            "reasonType": obj.get("reasonType"),
            "recentlyResolvedState": AvailabilityStatusPropertiesRecentlyResolvedState.from_dict(obj["recentlyResolvedState"]) if obj.get("recentlyResolvedState") is not None else None,
