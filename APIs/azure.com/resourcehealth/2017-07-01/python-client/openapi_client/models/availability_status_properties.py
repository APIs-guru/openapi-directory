...
class AvailabilityStatusProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["availabilityState", "detailedStatus", "healthEventCategory", "healthEventCause", "healthEventId", "healthEventType", "occuredTime", "reasonChronicity", "reasonType", "recentlyResolvedState", "recommendedActions", "reportedTime", "resolutionETA", "rootCauseAttributionTime", "serviceImpactingEvents", "summary"]
