...
class ImpactedRegion(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The impacted region id.")
    name: Optional[StrictStr] = Field(default=None, description="The impacted region name.")
