...
class StatusBanner(BaseModel):
    ...
    """ # noqa: E501
    cloud: Optional[StrictStr] = Field(default=None, description="The cloud type of this banner.")
    ...
    message: Optional[StrictStr] = Field(default=None, description="The details of banner.")
    title: Optional[StrictStr] = Field(default=None, description="The banner title.")
    __properties: ClassVar[List[str]] = ["cloud", "lastModifiedTime", "message", "title"]
