...
class TopQueriesListResult(BaseModel):
    """
    Represents the response to a get top queries request.
    """ # noqa: E501
    value: List[TopQueries] = Field(description="The list of top queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TopQueries.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
