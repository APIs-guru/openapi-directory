...
class QueryMetric(BaseModel):
    ...
    A database query.
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="The name of the metric for display in user interface", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "name", "unit", "value"]
    ...
    def unit_validate_enum(cls, value):
        ...
        if value not in set(['percentage', 'KB', 'microseconds']):
            raise ValueError("must be one of enum values ('percentage', 'KB', 'microseconds')")
        return value
