...
------------ | ------------- | ------------- | -------------
**operation** | **str** | The operation type: read, write, delete, etc. | [optional] 
**provider** | **str** | The service provider: Microsoft.HDInsight | [optional] 
**resource** | **str** | The resource on which the operation is performed: Cluster, Applications, etc. | [optional] 
