...
class OperationListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of operation list results if there are any.", alias="nextLink")
    value: Optional[List[Operation]] = Field(default=None, description="The list of HDInsight operations supported by the HDInsight resource provider.")
