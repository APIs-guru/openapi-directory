...
class EdgeGatewayPoolsApi:
    ...
    def edge_gateway_pools_get(
        ...
        edge_gateway_pool: Annotated[StrictStr, Field(description="Name of the edge gateway pool.")],
        ...
        :type location: str
        :param edge_gateway_pool: Name of the edge gateway pool. (required)
        ...
        _param = self._edge_gateway_pools_get_serialize(
    ...
    @validate_call
    def edge_gateway_pools_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    @validate_call
    def edge_gateway_pools_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _edge_gateway_pools_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        if edge_gateway_pool is not None:
            _path_params['edgeGatewayPool'] = edge_gateway_pool
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGatewayPools/{edgeGatewayPool}',
    ...
    def edge_gateway_pools_list(
        ...
        _param = self._edge_gateway_pools_list_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            location=location,
            api_version=api_version,
    ...
    @validate_call
    def edge_gateway_pools_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EdgeGatewayPoolList]:
        """edge_gateway_pools_list
    ...
    @validate_call
    def edge_gateway_pools_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _edge_gateway_pools_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGatewayPools',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
