...
class EdgeGatewayPoolList(BaseModel):
    """
    ...
    value: Optional[List[EdgeGatewayPool]] = Field(default=None, description="List of edge gateway pool objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EdgeGatewayPool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
