...
class CheckNameAvailabilityRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Resource Name To Verify")
    type: StrictStr = Field(description="Fully qualified resource type which includes provider namespace")
