...
class SpatialAnchorsAccountList(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of resource list results if there are any.", alias="nextLink")
    value: Optional[List[SpatialAnchorsAccount]] = Field(default=None, description="List of resources supported by the Resource Provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SpatialAnchorsAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
