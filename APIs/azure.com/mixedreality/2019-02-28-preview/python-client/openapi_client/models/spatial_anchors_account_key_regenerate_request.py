...
class SpatialAnchorsAccountKeyRegenerateRequest(BaseModel):
    """
    Spatial Anchors Account Regenerate Key
    """ # noqa: E501
    serial: Optional[StrictInt] = Field(default=None, description="serial of key to be regenerated")
    __properties: ClassVar[List[str]] = ["serial"]
