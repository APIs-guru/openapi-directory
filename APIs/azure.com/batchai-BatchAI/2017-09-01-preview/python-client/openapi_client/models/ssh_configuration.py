...
class SshConfiguration(BaseModel):
    ...
    """ # noqa: E501
    public_ips_to_allow: Optional[List[StrictStr]] = Field(default=None, description="Default value is '*' can be used to match all source IPs. Maximum number of publicIPs that can be specified are 400.", alias="publicIPsToAllow")
