...
class UnmanagedFileSystemReference(BaseModel):
    """
    Details of the file system to mount on the compute cluster nodes.
    """ # noqa: E501
    mount_command: StrictStr = Field(alias="mountCommand")
    ...
    __properties: ClassVar[List[str]] = ["mountCommand", "relativeMountPath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mountCommand": obj.get("mountCommand"),
