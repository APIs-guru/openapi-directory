...
class JobPreparation(BaseModel):
    ...
    """ # noqa: E501
    command_line: StrictStr = Field(description="If containerSettings is specified on the job, this commandLine will be executed in the same container as job. Otherwise it will be executed on the node.", alias="commandLine")
