...
class TestAzureBlobFileSystemReference(unittest.TestCase):
    """AzureBlobFileSystemReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AzureBlobFileSystemReference:
        """Test AzureBlobFileSystemReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AzureBlobFileSystemReference`
        """
        model = AzureBlobFileSystemReference()
        if include_optional:
            return AzureBlobFileSystemReference(
                account_name = '',
                container_name = '',
    ...
    def testAzureBlobFileSystemReference(self):
        """Test AzureBlobFileSystemReference"""
