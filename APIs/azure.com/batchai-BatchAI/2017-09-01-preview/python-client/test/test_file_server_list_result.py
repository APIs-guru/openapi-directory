...
class TestFileServerListResult(unittest.TestCase):
    """FileServerListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileServerListResult:
        """Test FileServerListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileServerListResult`
        """
        model = FileServerListResult()
        if include_optional:
            return FileServerListResult(
                next_link = '',
                value = [
                    openapi_client.models.file_server.FileServer(
    ...
    def testFileServerListResult(self):
        """Test FileServerListResult"""
