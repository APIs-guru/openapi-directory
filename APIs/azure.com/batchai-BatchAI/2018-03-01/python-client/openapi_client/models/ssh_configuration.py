...
class SshConfiguration(BaseModel):
    ...
    """ # noqa: E501
    public_ips_to_allow: Optional[List[StrictStr]] = Field(default=None, description="Default value is '*' can be used to match all source IPs. Maximum number of IP ranges that can be specified are 400.", alias="publicIPsToAllow")
    user_account_settings: UserAccountSettings = Field(alias="userAccountSettings")
    __properties: ClassVar[List[str]] = ["publicIPsToAllow", "userAccountSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicIPsToAllow": obj.get("publicIPsToAllow"),
