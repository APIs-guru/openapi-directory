...
class JobBaseProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["caffe2Settings", "caffeSettings", "chainerSettings", "cluster", "cntkSettings", "constraints", "containerSettings", "customToolkitSettings", "environmentVariables", "experimentName", "inputDirectories", "jobPreparation", "mountVolumes", "nodeCount", "outputDirectories", "priority", "pyTorchSettings", "secrets", "stdOutErrPathPrefix", "tensorFlowSettings"]
