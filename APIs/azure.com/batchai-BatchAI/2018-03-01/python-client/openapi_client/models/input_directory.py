...
class InputDirectory(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The path of the input directory will be available as a value of an environment variable with AZ_BATCHAI_INPUT_<id> name, where <id> is the value of id attribute.")
    path: StrictStr
