...
class TestClusterCreateParameters(unittest.TestCase):
    """ClusterCreateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterCreateParameters:
        """Test ClusterCreateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterCreateParameters`
        """
        model = ClusterCreateParameters()
        if include_optional:
            return ClusterCreateParameters(
                location = '',
                properties = openapi_client.models.cluster_base_properties.ClusterBaseProperties(
    ...
    def testClusterCreateParameters(self):
        """Test ClusterCreateParameters"""
