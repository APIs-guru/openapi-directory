...
**environment_variables** | [**List[EnvironmentVariable]**](EnvironmentVariable.md) | Batch AI will setup these additional environment variables for the job. | [optional] 
...
**secrets** | [**List[EnvironmentVariableWithSecretValue]**](EnvironmentVariableWithSecretValue.md) | Batch AI will setup these additional environment variables for the job. Server will never report values of these variables back. | [optional] 
