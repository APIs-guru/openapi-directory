...
class NameValuePair(BaseModel):
    ...
    Name-value pair.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name in the name-value pair.")
    value: Optional[StrictStr] = Field(default=None, description="The value in the name-value pair.")
