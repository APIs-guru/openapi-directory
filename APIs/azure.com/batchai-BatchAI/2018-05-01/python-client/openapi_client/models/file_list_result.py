...
class FileListResult(BaseModel):
    ...
    value: Optional[List[File]] = Field(default=None, description="The collection of returned job directories and files.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [File.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
