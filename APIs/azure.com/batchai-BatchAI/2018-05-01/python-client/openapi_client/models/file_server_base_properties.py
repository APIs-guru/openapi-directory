...
class FileServerBaseProperties(BaseModel):
    ...
    vm_size: StrictStr = Field(description="The size of the virtual machine for the File Server. For information about available VM sizes from the Virtual Machines Marketplace, see Sizes for Virtual Machines (Linux).", alias="vmSize")
