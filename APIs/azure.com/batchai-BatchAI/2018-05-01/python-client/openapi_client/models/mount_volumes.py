...
class MountVolumes(BaseModel):
    ...
    """ # noqa: E501
    azure_blob_file_systems: Optional[List[AzureBlobFileSystemReference]] = Field(default=None, description="A collection of Azure Blob Containers that are to be mounted to the cluster nodes.", alias="azureBlobFileSystems")
    azure_file_shares: Optional[List[AzureFileShareReference]] = Field(default=None, description="A collection of Azure File Shares that are to be mounted to the cluster nodes.", alias="azureFileShares")
    file_servers: Optional[List[FileServerReference]] = Field(default=None, description="A collection of Batch AI File Servers that are to be mounted to the cluster nodes.", alias="fileServers")
    unmanaged_file_systems: Optional[List[UnmanagedFileSystemReference]] = Field(default=None, description="A collection of unmanaged file systems that are to be mounted to the cluster nodes.", alias="unmanagedFileSystems")
