...
class FileServerListResult(BaseModel):
    """
    ...
    value: Optional[List[FileServer]] = Field(default=None, description="The collection of File Servers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FileServer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
