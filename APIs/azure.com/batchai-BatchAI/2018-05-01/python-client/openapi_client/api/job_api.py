...
class JobApi:
    ...
    def _jobs_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs/{jobName}',
    ...
    def jobs_list_by_experiment(
        ...
        _param = self._jobs_list_by_experiment_serialize(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            experiment_name=experiment_name,
            api_version=api_version,
    ...
    @validate_call
    def jobs_list_by_experiment_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="Name of the resource group to which the resource belongs.")],
        workspace_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the workspace. Workspace names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
        experiment_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the experiment. Experiment names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
    ...
    @validate_call
    def jobs_list_by_experiment_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="Name of the resource group to which the resource belongs.")],
        workspace_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the workspace. Workspace names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
        experiment_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the experiment. Experiment names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
    ...
    def _jobs_list_by_experiment_serialize(
        self,
        resource_group_name,
        workspace_name,
        experiment_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _jobs_list_output_files_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs/{jobName}/listOutputFiles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _jobs_list_remote_login_information_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs/{jobName}/listRemoteLoginInformation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _jobs_terminate_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs/{jobName}/terminate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
