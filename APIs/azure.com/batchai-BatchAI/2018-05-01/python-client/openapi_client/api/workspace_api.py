...
class WorkspaceApi:
    ...
    def workspaces_create(
        ...
        parameters: Annotated[WorkspaceCreateParameters, Field(description="Workspace creation parameters.")],
        ...
        :param parameters: Workspace creation parameters. (required)
        :type parameters: WorkspaceCreateParameters
        ...
        _param = self._workspaces_create_serialize(
    ...
    @validate_call
    def workspaces_create_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="Name of the resource group to which the resource belongs.")],
        workspace_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the workspace. Workspace names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
        api_version: Annotated[StrictStr, Field(description="Specifies the version of API used for this request.")],
    ...
    @validate_call
    def workspaces_create_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="Name of the resource group to which the resource belongs.")],
        workspace_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the workspace. Workspace names can only contain a combination of alphanumeric characters along with dash (-) and underscore (_). The name must be from 1 through 64 characters long.")],
        api_version: Annotated[StrictStr, Field(description="Specifies the version of API used for this request.")],
    ...
    def _workspaces_create_serialize(
        self,
        resource_group_name,
        workspace_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}',
    ...
    def _workspaces_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.BatchAI/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _workspaces_list_by_resource_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def workspaces_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Specifies the version of API used for this request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscriptionID for the Azure user.")],
        parameters: Annotated[WorkspaceUpdateParameters, Field(description="Additional parameters for workspace update.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param subscription_id: The subscriptionID for the Azure user. (required)
        :type subscription_id: str
        :param parameters: Additional parameters for workspace update. (required)
