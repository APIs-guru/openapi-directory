...
class TestClusterBaseProperties(unittest.TestCase):
    """ClusterBaseProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterBaseProperties:
        """Test ClusterBaseProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterBaseProperties`
        """
        model = ClusterBaseProperties()
        if include_optional:
            return ClusterBaseProperties(
    ...
    def testClusterBaseProperties(self):
        """Test ClusterBaseProperties"""
