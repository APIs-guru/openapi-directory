...
class TestDedicatedCapacities(unittest.TestCase):
    """DedicatedCapacities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DedicatedCapacities:
        """Test DedicatedCapacities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DedicatedCapacities`
        """
        model = DedicatedCapacities()
        if include_optional:
            return DedicatedCapacities(
                value = [
                    openapi_client.models.dedicated_capacity.DedicatedCapacity(
    ...
    def testDedicatedCapacities(self):
        """Test DedicatedCapacities"""
