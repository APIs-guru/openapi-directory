...
------------ | ------------- | ------------- | -------------
**operation** | **str** | Operation type: create, update, delete, etc. | [optional] [readonly] 
**provider** | **str** | Service provider: Microsoft.PowerBIDedicated. | [optional] [readonly] 
**resource** | **str** | Resource on which the operation is performed: capacity, etc. | [optional] [readonly] 
