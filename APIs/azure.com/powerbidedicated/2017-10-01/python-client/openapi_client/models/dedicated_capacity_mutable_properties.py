...
class DedicatedCapacityMutableProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["administration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "administration": DedicatedCapacityAdministrators.from_dict(obj["administration"]) if obj.get("administration") is not None else None
        })
        return _obj
