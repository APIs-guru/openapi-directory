...
class CheckCapacityNameAvailabilityParameters(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='Microsoft.PowerBIDedicated/capacities', description="The resource type of PowerBI dedicated.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type") if obj.get("type") is not None else 'Microsoft.PowerBIDedicated/capacities'
        })
        return _obj
