...
class DedicatedCapacityUpdateParameters(BaseModel):
    """
    Provision request specification
    """ # noqa: E501
    properties: Optional[DedicatedCapacityMutableProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DedicatedCapacityMutableProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
