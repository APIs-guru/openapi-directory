...
class DedicatedCapacities(BaseModel):
    """
    An array of Dedicated capacities resources.
    """ # noqa: E501
    value: List[DedicatedCapacity] = Field(description="An array of Dedicated capacities resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DedicatedCapacity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
