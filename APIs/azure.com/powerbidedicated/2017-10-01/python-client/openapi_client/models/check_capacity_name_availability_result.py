...
class CheckCapacityNameAvailabilityResult(BaseModel):
    """
    The checking result of capacity name availability.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The detailed message of the request unavailability.")
    name_available: Optional[StrictBool] = Field(default=None, description="Indicator of availability of the capacity name.", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="The reason of unavailability.")
