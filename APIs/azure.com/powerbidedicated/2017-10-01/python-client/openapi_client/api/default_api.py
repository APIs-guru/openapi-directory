...
class DefaultApi:
    ...
    def capacities_list_skus(
        ...
        _param = self._capacities_list_skus_serialize(
    ...
    @validate_call
    def capacities_list_skus_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="A unique identifier for a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
    ...
    @validate_call
    def capacities_list_skus_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="A unique identifier for a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
    ...
    def _capacities_list_skus_serialize(
        self,
        api_version,
        subscription_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.PowerBIDedicated/skus',
