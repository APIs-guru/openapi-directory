...
class GraphQueryListResult(BaseModel):
    """
    Graph query list result.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to fetch the next set of queries.", alias="nextLink")
    value: Optional[List[GraphQueryResource]] = Field(default=None, description="An array of graph queries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [GraphQueryResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
