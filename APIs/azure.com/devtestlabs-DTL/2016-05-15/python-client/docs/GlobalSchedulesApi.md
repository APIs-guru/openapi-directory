...
> ResponseWithContinuationSchedule global_schedules_list_by_resource_group(subscription_id, resource_group_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
> ResponseWithContinuationSchedule global_schedules_list_by_subscription(subscription_id, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
