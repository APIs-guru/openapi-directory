...
# **schedules_list**
> ResponseWithContinuationSchedule schedules_list(subscription_id, resource_group_name, lab_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
> ResponseWithContinuationSchedule schedules_list_applicable(subscription_id, resource_group_name, lab_name, name, api_version)
