...
# **arm_templates_list**
> ResponseWithContinuationArmTemplate arm_templates_list(subscription_id, resource_group_name, lab_name, artifact_source_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
