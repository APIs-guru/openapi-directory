...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | The name of the notificationChannel.
...
> ResponseWithContinuationNotificationChannel notification_channels_list(subscription_id, resource_group_name, lab_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
[**ResponseWithContinuationNotificationChannel**](ResponseWithContinuationNotificationChannel.md)
