...
class LabProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["artifactsStorageAccount", "createdDate", "defaultPremiumStorageAccount", "defaultStorageAccount", "labStorageType", "premiumDataDiskStorageAccount", "premiumDataDisks", "provisioningState", "uniqueIdentifier", "vaultName"]
