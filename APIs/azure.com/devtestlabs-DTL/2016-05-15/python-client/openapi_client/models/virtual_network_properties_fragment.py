...
class VirtualNetworkPropertiesFragment(BaseModel):
    ...
    external_subnets: Optional[List[ExternalSubnetFragment]] = Field(default=None, description="The external subnet properties.", alias="externalSubnets")
    ...
    __properties: ClassVar[List[str]] = ["allowedSubnets", "description", "externalProviderResourceId", "externalSubnets", "provisioningState", "subnetOverrides", "uniqueIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalSubnets": [ExternalSubnetFragment.from_dict(_item) for _item in obj["externalSubnets"]] if obj.get("externalSubnets") is not None else None,
