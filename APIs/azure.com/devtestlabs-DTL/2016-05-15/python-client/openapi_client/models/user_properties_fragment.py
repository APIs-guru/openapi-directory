...
class UserPropertiesFragment(BaseModel):
    """
    ...
    secret_store: Optional[UserSecretStoreFragment] = Field(default=None, alias="secretStore")
    ...
    __properties: ClassVar[List[str]] = ["identity", "provisioningState", "secretStore", "uniqueIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity": UserIdentityFragment.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
            "provisioningState": obj.get("provisioningState"),
            "secretStore": UserSecretStoreFragment.from_dict(obj["secretStore"]) if obj.get("secretStore") is not None else None,
