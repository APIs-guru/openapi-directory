...
class PolicyPropertiesFragment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "evaluatorType", "factData", "factName", "provisioningState", "status", "threshold", "uniqueIdentifier"]
    ...
    def fact_name_validate_enum(cls, value):
        ...
        if value not in set(['UserOwnedLabVmCount', 'UserOwnedLabPremiumVmCount', 'LabVmCount', 'LabPremiumVmCount', 'LabVmSize', 'GalleryImage', 'UserOwnedLabVmCountInSubnet', 'LabTargetCost']):
            raise ValueError("must be one of enum values ('UserOwnedLabVmCount', 'UserOwnedLabPremiumVmCount', 'LabVmCount', 'LabPremiumVmCount', 'LabVmSize', 'GalleryImage', 'UserOwnedLabVmCountInSubnet', 'LabTargetCost')")
        return value
