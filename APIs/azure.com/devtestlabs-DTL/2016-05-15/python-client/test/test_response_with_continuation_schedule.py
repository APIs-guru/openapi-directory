...
class TestResponseWithContinuationSchedule(unittest.TestCase):
    """ResponseWithContinuationSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseWithContinuationSchedule:
        """Test ResponseWithContinuationSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseWithContinuationSchedule`
        """
        model = ResponseWithContinuationSchedule()
        if include_optional:
    ...
    def testResponseWithContinuationSchedule(self):
        """Test ResponseWithContinuationSchedule"""
