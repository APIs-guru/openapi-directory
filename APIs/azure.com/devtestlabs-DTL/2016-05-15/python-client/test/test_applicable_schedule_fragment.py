...
class TestApplicableScheduleFragment(unittest.TestCase):
    """ApplicableScheduleFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicableScheduleFragment:
        """Test ApplicableScheduleFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicableScheduleFragment`
        """
        model = ApplicableScheduleFragment()
        if include_optional:
            return ApplicableScheduleFragment(
    ...
    def testApplicableScheduleFragment(self):
        """Test ApplicableScheduleFragment"""
