...
class TestFormula(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Formula:
        """Test Formula
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Formula`
        """
        model = Formula()
        if include_optional:
            return Formula(
                properties = openapi_client.models.formula_properties.FormulaProperties(
                    ...
                    formula_content = openapi_client.models.lab_virtual_machine_creation_parameter.LabVirtualMachineCreationParameter(
                        location = '', 
                        name = '', 
                        properties = openapi_client.models.lab_virtual_machine_creation_parameter_properties.LabVirtualMachineCreationParameterProperties(
                            allow_claim = True, 
