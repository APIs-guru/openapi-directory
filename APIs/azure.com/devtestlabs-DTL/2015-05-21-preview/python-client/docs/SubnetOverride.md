...
**resource_id** | **str** | The resource identifier of the subnet. | [optional] 
**use_in_vm_creation_permission** | **str** | Indicates whether this subnet can be used during virtual machine creation. | [optional] 
**use_public_ip_address_permission** | **str** | Indicates whether public IP addresses can be assigned to virtual machines on this subnet. | [optional] 
