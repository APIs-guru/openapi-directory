...
class ScheduleProperties(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The status of the schedule.")
    task_type: Optional[StrictStr] = Field(default=None, description="The task type of the schedule.", alias="taskType")
    time_zone_id: Optional[StrictStr] = Field(default=None, description="The time zone id.", alias="timeZoneId")
    weekly_recurrence: Optional[WeekDetails] = Field(default=None, alias="weeklyRecurrence")
    __properties: ClassVar[List[str]] = ["dailyRecurrence", "hourlyRecurrence", "provisioningState", "status", "taskType", "timeZoneId", "weeklyRecurrence"]
    ...
    def task_type_validate_enum(cls, value):
        ...
        if value not in set(['LabVmsShutdownTask', 'LabVmsStartupTask', 'LabBillingTask']):
            raise ValueError("must be one of enum values ('LabVmsShutdownTask', 'LabVmsStartupTask', 'LabBillingTask')")
        return value
