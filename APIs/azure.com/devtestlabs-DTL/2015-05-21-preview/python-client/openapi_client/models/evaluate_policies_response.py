...
class EvaluatePoliciesResponse(BaseModel):
    """
    Response body for evaluating a policy set.
    """ # noqa: E501
    results: Optional[List[PolicySetResult]] = Field(default=None, description="Results of evaluating a policy set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PolicySetResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
