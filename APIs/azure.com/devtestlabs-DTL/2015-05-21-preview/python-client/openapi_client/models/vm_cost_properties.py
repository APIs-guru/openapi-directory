...
class VMCostProperties(BaseModel):
    """
    VMCostProperties
    """ # noqa: E501
    cost: Optional[Union[StrictFloat, StrictInt]] = None
    name: Optional[StrictStr] = None
    resource_group_name: Optional[StrictStr] = Field(default=None, alias="resourceGroupName")
    __properties: ClassVar[List[str]] = ["cost", "name", "resourceGroupName"]
