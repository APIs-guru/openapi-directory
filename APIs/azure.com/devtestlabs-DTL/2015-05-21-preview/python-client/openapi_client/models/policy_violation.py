...
class PolicyViolation(BaseModel):
    ...
    Policy violation.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code of the policy violation.")
    message: Optional[StrictStr] = Field(default=None, description="The message of the policy violation.")
