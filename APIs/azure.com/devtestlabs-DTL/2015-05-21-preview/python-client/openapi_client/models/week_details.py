...
class WeekDetails(BaseModel):
    ...
    """ # noqa: E501
    time: Optional[StrictStr] = Field(default=None, description="The time of the day.")
    weekdays: Optional[List[StrictStr]] = Field(default=None, description="The days of the week.")
    __properties: ClassVar[List[str]] = ["time", "weekdays"]
