...
class PolicyProperties(BaseModel):
    ...
    evaluator_type: Optional[StrictStr] = Field(default=None, description="The evaluator type of the policy.", alias="evaluatorType")
    fact_data: Optional[StrictStr] = Field(default=None, description="The fact data of the policy.", alias="factData")
    fact_name: Optional[StrictStr] = Field(default=None, description="The fact name of the policy.", alias="factName")
    ...
    threshold: Optional[StrictStr] = Field(default=None, description="The threshold of the policy.")
    __properties: ClassVar[List[str]] = ["description", "evaluatorType", "factData", "factName", "provisioningState", "status", "threshold"]
    ...
    def fact_name_validate_enum(cls, value):
        ...
        if value not in set(['UserOwnedLabVmCount', 'LabVmCount', 'LabVmSize', 'GalleryImage', 'UserOwnedLabVmCountInSubnet']):
            raise ValueError("must be one of enum values ('UserOwnedLabVmCount', 'LabVmCount', 'LabVmSize', 'GalleryImage', 'UserOwnedLabVmCountInSubnet')")
        return value
