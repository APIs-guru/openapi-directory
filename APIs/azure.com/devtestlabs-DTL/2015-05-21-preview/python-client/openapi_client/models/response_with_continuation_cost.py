...
class ResponseWithContinuationCost(BaseModel):
    """
    The response of a list operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next set of results.", alias="nextLink")
    value: Optional[List[Cost]] = Field(default=None, description="Results of the list operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Cost.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
