...
class TestLabVirtualMachine(unittest.TestCase):
    """LabVirtualMachine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabVirtualMachine:
        """Test LabVirtualMachine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabVirtualMachine`
        """
    ...
    def testLabVirtualMachine(self):
        """Test LabVirtualMachine"""
