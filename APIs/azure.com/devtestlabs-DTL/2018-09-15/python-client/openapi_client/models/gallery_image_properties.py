...
class GalleryImageProperties(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether this gallery image is enabled.")
    ...
    __properties: ClassVar[List[str]] = ["author", "createdDate", "description", "enabled", "icon", "imageReference", "isPlanAuthorized", "planId"]
