...
class VirtualNetworkProperties(BaseModel):
    ...
    created_date: Optional[datetime] = Field(default=None, description="The creation date of the virtual network.", alias="createdDate")
    ...
    external_subnets: Optional[List[ExternalSubnet]] = Field(default=None, description="The external subnet properties.", alias="externalSubnets")
    ...
    __properties: ClassVar[List[str]] = ["allowedSubnets", "createdDate", "description", "externalProviderResourceId", "externalSubnets", "provisioningState", "subnetOverrides", "uniqueIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in external_subnets (list)
        _items = []
        if self.external_subnets:
            for _item_external_subnets in self.external_subnets:
                if _item_external_subnets:
                    _items.append(_item_external_subnets.to_dict())
            _dict['externalSubnets'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalSubnets": [ExternalSubnet.from_dict(_item) for _item in obj["externalSubnets"]] if obj.get("externalSubnets") is not None else None,
