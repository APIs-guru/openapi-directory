...
class DataDiskStorageTypeInfoFragment(BaseModel):
    """
    Storage information about the data disks present in the custom image
    """ # noqa: E501
    lun: Optional[StrictStr] = Field(default=None, description="Disk Lun")
    storage_type: Optional[StrictStr] = Field(default=None, description="Disk Storage Type", alias="storageType")
    __properties: ClassVar[List[str]] = ["lun", "storageType"]
