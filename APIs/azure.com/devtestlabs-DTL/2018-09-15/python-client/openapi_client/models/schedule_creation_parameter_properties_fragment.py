...
class ScheduleCreationParameterPropertiesFragment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dailyRecurrence", "hourlyRecurrence", "notificationSettings", "status", "targetResourceId", "taskType", "timeZoneId", "weeklyRecurrence"]
