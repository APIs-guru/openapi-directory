...
class EvaluatePoliciesRequest(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[List[EvaluatePoliciesProperties]] = Field(default=None, description="Policies to evaluate.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [EvaluatePoliciesProperties.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
