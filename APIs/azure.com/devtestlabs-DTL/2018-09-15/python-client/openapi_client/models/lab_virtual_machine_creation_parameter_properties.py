...
class LabVirtualMachineCreationParameterProperties(BaseModel):
    ...
    data_disk_parameters: Optional[List[DataDiskProperties]] = Field(default=None, description="New or existing data disks to attach to the virtual machine after creation", alias="dataDiskParameters")
    ...
    schedule_parameters: Optional[List[ScheduleCreationParameter]] = Field(default=None, description="Virtual Machine schedules to be created", alias="scheduleParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataDiskParameters": [DataDiskProperties.from_dict(_item) for _item in obj["dataDiskParameters"]] if obj.get("dataDiskParameters") is not None else None,
            ...
            "scheduleParameters": [ScheduleCreationParameter.from_dict(_item) for _item in obj["scheduleParameters"]] if obj.get("scheduleParameters") is not None else None,
            "size": obj.get("size"),
