...
class SharedPublicIpAddressConfiguration(BaseModel):
    """
    Properties of a virtual machine that determine how it is connected to a load balancer.
    """ # noqa: E501
    inbound_nat_rules: Optional[List[InboundNatRule]] = Field(default=None, description="The incoming NAT rules", alias="inboundNatRules")
