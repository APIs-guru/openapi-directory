...
class LabProperties(BaseModel):
    ...
    artifacts_storage_account: Optional[StrictStr] = Field(default=None, description="The lab's artifact storage account.", alias="artifactsStorageAccount")
    created_date: Optional[datetime] = Field(default=None, description="The creation date of the lab.", alias="createdDate")
    default_premium_storage_account: Optional[StrictStr] = Field(default=None, description="The lab's default premium storage account.", alias="defaultPremiumStorageAccount")
    ...
    load_balancer_id: Optional[StrictStr] = Field(default=None, description="The load balancer used to for lab VMs that use shared IP address.", alias="loadBalancerId")
    ...
    network_security_group_id: Optional[StrictStr] = Field(default=None, description="The Network Security Group attached to the lab VMs Network interfaces to restrict open ports.", alias="networkSecurityGroupId")
    premium_data_disk_storage_account: Optional[StrictStr] = Field(default=None, description="The lab's premium data disk storage account.", alias="premiumDataDiskStorageAccount")
    ...
    public_ip_id: Optional[StrictStr] = Field(default=None, description="The public IP address for the lab's load balancer.", alias="publicIpId")
    ...
    vault_name: Optional[StrictStr] = Field(default=None, description="The lab's Key vault.", alias="vaultName")
    vm_creation_resource_group: Optional[StrictStr] = Field(default=None, description="The resource group in which all new lab virtual machines will be created. To let DevTest Labs manage resource group creation, set this value to null.", alias="vmCreationResourceGroup")
    __properties: ClassVar[List[str]] = ["announcement", "artifactsStorageAccount", "createdDate", "defaultPremiumStorageAccount", "defaultStorageAccount", "environmentPermission", "extendedProperties", "labStorageType", "loadBalancerId", "mandatoryArtifactsResourceIdsLinux", "mandatoryArtifactsResourceIdsWindows", "networkSecurityGroupId", "premiumDataDiskStorageAccount", "premiumDataDisks", "provisioningState", "publicIpId", "support", "uniqueIdentifier", "vaultName", "vmCreationResourceGroup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "announcement": LabAnnouncementProperties.from_dict(obj["announcement"]) if obj.get("announcement") is not None else None,
            "artifactsStorageAccount": obj.get("artifactsStorageAccount"),
            "createdDate": obj.get("createdDate"),
            "defaultPremiumStorageAccount": obj.get("defaultPremiumStorageAccount"),
            ...
            "premiumDataDiskStorageAccount": obj.get("premiumDataDiskStorageAccount"),
            "premiumDataDisks": obj.get("premiumDataDisks"),
            "provisioningState": obj.get("provisioningState"),
            "publicIpId": obj.get("publicIpId"),
            "support": LabSupportProperties.from_dict(obj["support"]) if obj.get("support") is not None else None,
            "uniqueIdentifier": obj.get("uniqueIdentifier"),
            "vaultName": obj.get("vaultName"),
            "vmCreationResourceGroup": obj.get("vmCreationResourceGroup")
        })
        return _obj
