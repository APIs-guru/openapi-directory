...
class NetworkInterfacePropertiesFragment(BaseModel):
    """
    ...
    shared_public_ip_address_configuration: Optional[SharedPublicIpAddressConfigurationFragment] = Field(default=None, alias="sharedPublicIpAddressConfiguration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sharedPublicIpAddressConfiguration": SharedPublicIpAddressConfigurationFragment.from_dict(obj["sharedPublicIpAddressConfiguration"]) if obj.get("sharedPublicIpAddressConfiguration") is not None else None,
