...
class ArtifactInstallPropertiesFragment(BaseModel):
    """
    ...
    parameters: Optional[List[ArtifactParameterPropertiesFragment]] = Field(default=None, description="The parameters of the artifact.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": [ArtifactParameterPropertiesFragment.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
