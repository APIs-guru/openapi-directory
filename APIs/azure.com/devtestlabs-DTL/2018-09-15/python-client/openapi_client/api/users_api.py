...
class UsersApi:
    ...
    def users_create_or_update(
        ...
        name: Annotated[StrictStr, Field(description="The name of the user profile.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        user: Annotated[User, Field(description="Profile of a lab user.")],
    ...
    def _users_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}',
    ...
    def users_get(
        ...
        name: Annotated[StrictStr, Field(description="The name of the user profile.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        expand: Annotated[Optional[StrictStr], Field(description="Specify the $expand query. Example: 'properties($select=identity)'")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _users_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def users_update(
        ...
        name: Annotated[StrictStr, Field(description="The name of the user profile.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        user: Annotated[UserFragment, Field(description="Profile of a lab user.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
