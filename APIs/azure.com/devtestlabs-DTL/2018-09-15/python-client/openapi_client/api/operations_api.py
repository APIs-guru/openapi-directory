...
class OperationsApi:
    ...
    def operations_get(
        ...
        name: Annotated[StrictStr, Field(description="The name of the operation.")],
    ...
    def _operations_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DevTestLab/locations/{locationName}/operations/{name}',
