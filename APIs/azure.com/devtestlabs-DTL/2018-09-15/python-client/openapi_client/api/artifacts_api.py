...
class ArtifactsApi:
    ...
    @validate_call
    def artifacts_generate_arm_template(
        self,
        ...
        generate_arm_template_request: Annotated[GenerateArmTemplateRequest, Field(description="Parameters for generating an ARM template for deploying artifacts.")],
        ...
        :param generate_arm_template_request: Parameters for generating an ARM template for deploying artifacts. (required)
        ...
        _param = self._artifacts_generate_arm_template_serialize(
    ...
    @validate_call
    def artifacts_generate_arm_template_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        lab_name: Annotated[StrictStr, Field(description="The name of the lab.")],
    ...
    @validate_call
    def artifacts_generate_arm_template_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        lab_name: Annotated[StrictStr, Field(description="The name of the lab.")],
    ...
    def _artifacts_generate_arm_template_serialize(
        self,
        subscription_id,
        resource_group_name,
        lab_name,
    ...
    def artifacts_get(
        ...
        name: Annotated[StrictStr, Field(description="The name of the artifact.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        expand: Annotated[Optional[StrictStr], Field(description="Specify the $expand query. Example: 'properties($select=title)'")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
