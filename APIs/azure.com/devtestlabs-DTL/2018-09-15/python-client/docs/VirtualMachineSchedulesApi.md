...
> ScheduleList virtual_machine_schedules_list(subscription_id, resource_group_name, lab_name, virtual_machine_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
