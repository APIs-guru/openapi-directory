...
[**disks_update**](DisksApi.md#disks_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/disks/{name} | 
...
# **disks_list**
> DiskList disks_list(subscription_id, resource_group_name, lab_name, user_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
# **disks_update**
> Disk disks_update(subscription_id, resource_group_name, lab_name, user_name, name, api_version, disk)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | The name of the disk.
    api_version = '2018-09-15' # str | Client API version. (default to '2018-09-15')
    disk = openapi_client.DiskFragment() # DiskFragment | A Disk.

    try:
        api_response = api_instance.disks_update(subscription_id, resource_group_name, lab_name, user_name, name, api_version, disk)
