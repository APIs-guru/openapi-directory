...
**bulk_creation_parameters** | [**BulkCreationParametersFragment**](BulkCreationParametersFragment.md) |  | [optional] 
...
lab_virtual_machine_creation_parameter_properties_fragment_instance = LabVirtualMachineCreationParameterPropertiesFragment.from_json(json)
# print the JSON string representation of the object
print(LabVirtualMachineCreationParameterPropertiesFragment.to_json())

# convert the object into a dict
lab_virtual_machine_creation_parameter_properties_fragment_dict = lab_virtual_machine_creation_parameter_properties_fragment_instance.to_dict()
# create an instance of LabVirtualMachineCreationParameterPropertiesFragment from a dict
lab_virtual_machine_creation_parameter_properties_fragment_from_dict = LabVirtualMachineCreationParameterPropertiesFragment.from_dict(lab_virtual_machine_creation_parameter_properties_fragment_dict)
```
