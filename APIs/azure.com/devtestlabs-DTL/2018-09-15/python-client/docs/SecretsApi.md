...
[**secrets_update**](SecretsApi.md#secrets_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/secrets/{name} | 
...
# **secrets_list**
> SecretList secrets_list(subscription_id, resource_group_name, lab_name, user_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
# **secrets_update**
> Secret secrets_update(subscription_id, resource_group_name, lab_name, user_name, name, api_version, secret)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | The name of the secret.
    api_version = '2018-09-15' # str | Client API version. (default to '2018-09-15')
    secret = openapi_client.SecretFragment() # SecretFragment | A secret.

    try:
        api_response = api_instance.secrets_update(subscription_id, resource_group_name, lab_name, user_name, name, api_version, secret)
