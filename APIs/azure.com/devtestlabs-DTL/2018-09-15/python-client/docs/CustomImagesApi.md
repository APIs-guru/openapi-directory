...
[**custom_images_update**](CustomImagesApi.md#custom_images_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/customimages/{name} | 
...
# **custom_images_list**
> CustomImageList custom_images_list(subscription_id, resource_group_name, lab_name, api_version, expand=expand, filter=filter, top=top, orderby=orderby)
...
> CustomImage custom_images_update(subscription_id, resource_group_name, lab_name, name, api_version, custom_image)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | The name of the custom image.
    api_version = '2018-09-15' # str | Client API version. (default to '2018-09-15')
    custom_image = openapi_client.CustomImageFragment() # CustomImageFragment | A custom image.

    try:
        api_response = api_instance.custom_images_update(subscription_id, resource_group_name, lab_name, name, api_version, custom_image)
        print("The response of CustomImagesApi->custom_images_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomImagesApi->custom_images_update: %s\n" % e)
```
 ...
 **name** | **str**| The name of the custom image. | 
 **api_version** | **str**| Client API version. | [default to &#39;2018-09-15&#39;]
 **custom_image** | [**CustomImageFragment**](CustomImageFragment.md)| A custom image. | 
