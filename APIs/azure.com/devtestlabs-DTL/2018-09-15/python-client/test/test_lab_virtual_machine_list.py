...
class TestLabVirtualMachineList(unittest.TestCase):
    """LabVirtualMachineList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabVirtualMachineList:
        """Test LabVirtualMachineList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabVirtualMachineList`
        """
        model = LabVirtualMachineList()
        if include_optional:
            return LabVirtualMachineList(
                next_link = '',
                value = [
                    openapi_client.models.lab_virtual_machine.LabVirtualMachine(
    ...
    def testLabVirtualMachineList(self):
        """Test LabVirtualMachineList"""
