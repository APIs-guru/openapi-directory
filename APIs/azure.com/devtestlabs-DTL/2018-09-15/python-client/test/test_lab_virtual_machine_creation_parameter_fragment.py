...
class TestLabVirtualMachineCreationParameterFragment(unittest.TestCase):
    """LabVirtualMachineCreationParameterFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabVirtualMachineCreationParameterFragment:
        """Test LabVirtualMachineCreationParameterFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabVirtualMachineCreationParameterFragment`
        """
        model = LabVirtualMachineCreationParameterFragment()
        if include_optional:
            return LabVirtualMachineCreationParameterFragment(
                location = '',
                name = '',
    ...
    def testLabVirtualMachineCreationParameterFragment(self):
        """Test LabVirtualMachineCreationParameterFragment"""
