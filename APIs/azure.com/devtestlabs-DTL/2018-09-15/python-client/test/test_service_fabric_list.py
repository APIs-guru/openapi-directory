...
class TestServiceFabricList(unittest.TestCase):
    """ServiceFabricList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceFabricList:
        """Test ServiceFabricList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceFabricList`
        """
        model = ServiceFabricList()
        if include_optional:
            return ServiceFabricList(
                next_link = '',
                value = [
                    openapi_client.models.service_fabric.ServiceFabric(
                        properties = openapi_client.models.service_fabric_properties.ServiceFabricProperties(
    ...
    def testServiceFabricList(self):
        """Test ServiceFabricList"""
