...
class TestLabVirtualMachineCreationParameterPropertiesFragment(unittest.TestCase):
    """LabVirtualMachineCreationParameterPropertiesFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabVirtualMachineCreationParameterPropertiesFragment:
        """Test LabVirtualMachineCreationParameterPropertiesFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabVirtualMachineCreationParameterPropertiesFragment`
        """
        model = LabVirtualMachineCreationParameterPropertiesFragment()
        if include_optional:
            return LabVirtualMachineCreationParameterPropertiesFragment(
                allow_claim = True,
    ...
    def testLabVirtualMachineCreationParameterPropertiesFragment(self):
        """Test LabVirtualMachineCreationParameterPropertiesFragment"""
