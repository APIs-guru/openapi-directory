...
class TestScheduleFragment(unittest.TestCase):
    """ScheduleFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleFragment:
        """Test ScheduleFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleFragment`
        """
