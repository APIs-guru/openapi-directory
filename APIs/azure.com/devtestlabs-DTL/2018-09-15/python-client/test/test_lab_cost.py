...
class TestLabCost(unittest.TestCase):
    """LabCost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabCost:
        """Test LabCost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabCost`
        """
        model = LabCost()
        if include_optional:
            return LabCost(
                properties = openapi_client.models.lab_cost_properties.LabCostProperties(
