...
class TestSchedulePropertiesFragment(unittest.TestCase):
    """SchedulePropertiesFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchedulePropertiesFragment:
        """Test SchedulePropertiesFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchedulePropertiesFragment`
        """
        model = SchedulePropertiesFragment()
        if include_optional:
            return SchedulePropertiesFragment(
    ...
    def testSchedulePropertiesFragment(self):
        """Test SchedulePropertiesFragment"""
