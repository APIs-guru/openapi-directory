...
class TestScheduleCreationParameter(unittest.TestCase):
    """ScheduleCreationParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleCreationParameter:
        """Test ScheduleCreationParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleCreationParameter`
        """
    ...
    def testScheduleCreationParameter(self):
        """Test ScheduleCreationParameter"""
