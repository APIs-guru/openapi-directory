...
class TestServiceFabric(unittest.TestCase):
    """ServiceFabric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceFabric:
        """Test ServiceFabric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceFabric`
        """
        model = ServiceFabric()
        if include_optional:
