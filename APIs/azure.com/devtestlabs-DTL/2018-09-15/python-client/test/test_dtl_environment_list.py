...
class TestDtlEnvironmentList(unittest.TestCase):
    """DtlEnvironmentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DtlEnvironmentList:
        """Test DtlEnvironmentList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DtlEnvironmentList`
        """
        model = DtlEnvironmentList()
        if include_optional:
    ...
    def testDtlEnvironmentList(self):
        """Test DtlEnvironmentList"""
