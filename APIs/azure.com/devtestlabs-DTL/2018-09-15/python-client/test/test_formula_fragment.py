...
class TestFormulaFragment(unittest.TestCase):
    """FormulaFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormulaFragment:
        """Test FormulaFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormulaFragment`
        """
        model = FormulaFragment()
        if include_optional:
            return FormulaFragment(
                properties = openapi_client.models.formula_properties_fragment.FormulaPropertiesFragment(
                    author = '', 
                    description = '', 
