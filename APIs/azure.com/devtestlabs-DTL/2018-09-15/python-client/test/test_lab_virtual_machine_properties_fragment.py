...
class TestLabVirtualMachinePropertiesFragment(unittest.TestCase):
    """LabVirtualMachinePropertiesFragment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabVirtualMachinePropertiesFragment:
        """Test LabVirtualMachinePropertiesFragment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabVirtualMachinePropertiesFragment`
        """
        model = LabVirtualMachinePropertiesFragment()
        if include_optional:
            return LabVirtualMachinePropertiesFragment(
                allow_claim = True,
    ...
    def testLabVirtualMachinePropertiesFragment(self):
        """Test LabVirtualMachinePropertiesFragment"""
