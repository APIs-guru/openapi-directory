...
class UpdatesApi:
    ...
    def updates_list(
        ...
        _param = self._updates_list_serialize(
    ...
    @validate_call
    def updates_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name")],
        provider_name: Annotated[StrictStr, Field(description="Resource provider name")],
    ...
    @validate_call
    def updates_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name")],
        provider_name: Annotated[StrictStr, Field(description="Resource provider name")],
    ...
    def _updates_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{providerName}/{resourceType}/{resourceName}/providers/Microsoft.Maintenance/updates',
    ...
    def updates_list_parent(
        ...
        _param = self._updates_list_parent_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            provider_name=provider_name,
    ...
    @validate_call
    def updates_list_parent_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name")],
        provider_name: Annotated[StrictStr, Field(description="Resource provider name")],
    ...
    @validate_call
    def updates_list_parent_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name")],
        provider_name: Annotated[StrictStr, Field(description="Resource provider name")],
    ...
    def _updates_list_parent_serialize(
        self,
        subscription_id,
        resource_group_name,
        provider_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{providerName}/{resourceParentType}/{resourceParentName}/{resourceType}/{resourceName}/providers/Microsoft.Maintenance/updates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
