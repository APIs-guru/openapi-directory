...
class ListConfigurationAssignmentsResult(BaseModel):
    """
    Response for ConfigurationAssignments list
    """ # noqa: E501
    value: Optional[List[ConfigurationAssignment]] = Field(default=None, description="The list of configuration Assignments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConfigurationAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
