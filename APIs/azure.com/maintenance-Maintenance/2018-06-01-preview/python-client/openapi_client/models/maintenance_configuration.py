...
class MaintenanceConfiguration(BaseModel):
    """
    Maintenance configuration record type
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Gets or sets location of the resource")
    properties: Optional[MaintenanceConfigurationProperties] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Gets or sets tags of the resource")
