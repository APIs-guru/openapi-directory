...
class ApplyUpdateProperties(BaseModel):
    """
    Properties for apply update
    """ # noqa: E501
    last_update_time: Optional[datetime] = Field(default=None, description="Last Update time", alias="lastUpdateTime")
    ...
    __properties: ClassVar[List[str]] = ["lastUpdateTime", "resourceId", "status"]
