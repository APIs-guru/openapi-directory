...
class ListUpdatesResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[Update]] = Field(default=None, description="The pending updates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Update.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
