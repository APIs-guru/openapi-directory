...
class ListMaintenanceConfigurationsResult(BaseModel):
    """
    Response for MaintenanceConfigurations list
    """ # noqa: E501
    value: Optional[List[MaintenanceConfiguration]] = Field(default=None, description="The list of maintenance Configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MaintenanceConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
