...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.Maintenance/operations | List available operations


# **operations_list**
> OperationsListResult operations_list(api_version)
