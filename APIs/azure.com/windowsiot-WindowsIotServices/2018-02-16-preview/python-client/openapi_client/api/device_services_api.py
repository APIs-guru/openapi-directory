...
class DeviceServicesApi:
    ...
    def services_create_or_update(
        ...
        device_service: Annotated[DeviceService, Field(description="The Windows IoT Device Service metadata and security metadata.")],
        ...
        :type device_service: DeviceService
