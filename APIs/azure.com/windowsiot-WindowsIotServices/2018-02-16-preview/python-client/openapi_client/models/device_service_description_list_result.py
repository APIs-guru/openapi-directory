...
class DeviceServiceDescriptionListResult(BaseModel):
    """
    ...
    value: Optional[List[DeviceService]] = Field(default=None, description="The array of DeviceService objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DeviceService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
