...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[OperationEntity]] = Field(default=None, description="List of Windows IoT Device Service operations supported by the Microsoft.WindowsIoT resource provider.")
