...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    device_service = openapi_client.DeviceServiceProperties() # DeviceServiceProperties | The Windows IoT Device Service metadata and security metadata.
 ...
 **device_service** | [**DeviceServiceProperties**](DeviceServiceProperties.md)| The Windows IoT Device Service metadata and security metadata. | 
