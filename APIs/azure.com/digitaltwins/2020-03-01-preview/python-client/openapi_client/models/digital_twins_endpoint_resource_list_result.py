...
class DigitalTwinsEndpointResourceListResult(BaseModel):
    """
    A list of DigitalTwinsInstance Endpoints with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of DigitalTwinsInstance Endpoints.", alias="nextLink")
    value: Optional[List[DigitalTwinsEndpointResource]] = Field(default=None, description="A list of DigitalTwinsInstance Endpoints.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DigitalTwinsEndpointResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
