...
class DigitalTwinsDescription(BaseModel):
    """
    The description of the DigitalTwins service.
    """ # noqa: E501
    properties: Optional[DigitalTwinsProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "sku": DigitalTwinsSkuInfo.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "tags": obj.get("tags"),
            "type": obj.get("type")
        })
        return _obj
