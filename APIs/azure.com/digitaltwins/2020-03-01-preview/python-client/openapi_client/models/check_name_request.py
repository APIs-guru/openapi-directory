...
class CheckNameRequest(BaseModel):
    ...
    type: StrictStr = Field(description="The type of resource, for instance Microsoft.DigitalTwins/digitalTwinsInstances.")
    __properties: ClassVar[List[str]] = ["name", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Microsoft.DigitalTwins/digitalTwinsInstances']):
            raise ValueError("must be one of enum values ('Microsoft.DigitalTwins/digitalTwinsInstances')")
        return value
