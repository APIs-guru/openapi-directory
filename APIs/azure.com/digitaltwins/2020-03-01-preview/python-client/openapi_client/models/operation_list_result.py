...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[Operation]] = Field(default=None, description="A list of DigitalTwins operations supported by the Microsoft.DigitalTwins resource provider.")
