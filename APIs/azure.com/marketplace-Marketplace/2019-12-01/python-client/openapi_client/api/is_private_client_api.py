...
class IsPrivateClientApi:
    ...
    def private_store_client_get(
        ...
        _param = self._private_store_client_get_serialize(
    ...
    @validate_call
    def private_store_client_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The Azure subscription ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def private_store_client_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The Azure subscription ID.")],
        _request_timeout: Union[
    ...
    def _private_store_client_get_serialize(
        self,
        api_version,
        subscription_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Marketplace/privateStoreClient/isPrivateClient',
