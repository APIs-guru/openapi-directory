...
------------ | ------------- | ------------- | -------------
**operation** | **str** | Operation type: Get Amendments etc. | [optional] 
**provider** | **str** | Service provider: Microsoft.Marketplace | [optional] 
**resource** | **str** | Resource on which the operation is performed: Amendments | [optional] 
