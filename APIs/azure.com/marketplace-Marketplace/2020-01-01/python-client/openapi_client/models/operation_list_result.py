...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[Operation]] = Field(default=None, description="List of Microsoft.Marketplace operations supported by the Microsoft.Marketplace resource provider.")
