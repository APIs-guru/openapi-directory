...
class PrivateStoreProperties(BaseModel):
    """
    Describes the json payload on whether or not the private store is enabled for a given tenant
    """ # noqa: E501
    availability: Optional[StrictStr] = Field(default=None, description="Indicates private store availability")
    name: Optional[StrictStr] = Field(default=None, description="Private Store name")
    __properties: ClassVar[List[str]] = ["availability", "name"]
