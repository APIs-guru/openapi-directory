...
class PrivateStoreList(BaseModel):
    """
    Describes the json payload for the list of available private stores (between zero and one, inclusive)
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of PrivateStore list results if there are any.", alias="nextLink")
    value: Optional[List[PrivateStoreProperties]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PrivateStoreProperties.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
