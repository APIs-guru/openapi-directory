...
class SettingsList(BaseModel):
    ...
    value: Optional[List[Setting]] = Field(default=None, description="The settings list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Setting.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
