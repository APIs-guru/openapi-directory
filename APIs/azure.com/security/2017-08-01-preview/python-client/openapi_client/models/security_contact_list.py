...
class SecurityContactList(BaseModel):
    """
    ...
    value: Optional[List[SecurityContact]] = Field(default=None, description="List of security contacts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SecurityContact.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
