...
class AutoProvisioningSettingList(BaseModel):
    """
    ...
    value: Optional[List[AutoProvisioningSetting]] = Field(default=None, description="List of all the auto provisioning settings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AutoProvisioningSetting.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
