...
class WorkspaceSettingList(BaseModel):
    """
    ...
    value: List[WorkspaceSetting] = Field(description="List of workspace settings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [WorkspaceSetting.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
