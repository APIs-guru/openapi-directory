...
class AtaSolutionProperties(BaseModel):
    """
    AtaSolutionProperties
    """ # noqa: E501
    last_event_received: Optional[StrictStr] = Field(default=None, alias="lastEventReceived")
    ...
    __properties: ClassVar[List[str]] = ["deviceType", "deviceVendor", "workspace"]
