...
class DenyAssignment(BaseModel):
    """
    Deny Assignment
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The deny assignment ID.")
    name: Optional[StrictStr] = Field(default=None, description="The deny assignment name.")
    properties: Optional[DenyAssignmentProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="The deny assignment type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "properties": DenyAssignmentProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
