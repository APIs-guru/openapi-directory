...
class DenyAssignmentListResult(BaseModel):
    """
    ...
    value: Optional[List[DenyAssignment]] = Field(default=None, description="Deny assignment list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DenyAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
