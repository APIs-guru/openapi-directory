...
class TestApiVersionSetGet200Response(unittest.TestCase):
    """ApiVersionSetGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiVersionSetGet200Response:
        """Test ApiVersionSetGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiVersionSetGet200Response`
        """
        model = ApiVersionSetGet200Response()
        if include_optional:
    ...
    def testApiVersionSetGet200Response(self):
        """Test ApiVersionSetGet200Response"""
