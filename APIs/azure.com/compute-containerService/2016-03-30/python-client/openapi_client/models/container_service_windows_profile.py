...
class ContainerServiceWindowsProfile(BaseModel):
    ...
    """ # noqa: E501
    admin_password: StrictStr = Field(description="The administrator password to use for Windows VMs", alias="adminPassword")
    admin_username: StrictStr = Field(description="The administrator username to use for Windows VMs", alias="adminUsername")
