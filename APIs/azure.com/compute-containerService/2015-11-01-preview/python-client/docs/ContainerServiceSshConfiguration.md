...
------------ | ------------- | ------------- | -------------
**public_keys** | [**List[ContainerServiceSshPublicKey]**](ContainerServiceSshPublicKey.md) | Gets or sets the list of SSH public keys used to authenticate with Linux based VMs | [optional] 
