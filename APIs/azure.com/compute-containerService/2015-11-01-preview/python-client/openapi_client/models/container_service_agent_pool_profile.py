...
class ContainerServiceAgentPoolProfile(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=None, description="No. of agents (VMs) that will host docker containers")
    dns_prefix: StrictStr = Field(description="DNS prefix to be used to create FQDN for this agent pool", alias="dnsPrefix")
    fqdn: Optional[StrictStr] = Field(default=None, description="FQDN for the agent pool")
    name: StrictStr = Field(description="Unique name of the agent pool profile within the context of the subscription and resource group")
    vm_size: Optional[StrictStr] = Field(default=None, description="Size of agent VMs", alias="vmSize")
