...
class ContainerServiceWindowsProfile(BaseModel):
    """
    Profile for Windows jumpbox
    """ # noqa: E501
    admin_password: StrictStr = Field(description="The administrator password to use for Windows jumpbox", alias="adminPassword")
    admin_username: StrictStr = Field(description="The administrator username to use for Windows jumpbox", alias="adminUsername")
