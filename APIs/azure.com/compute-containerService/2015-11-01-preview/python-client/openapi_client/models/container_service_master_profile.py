...
class ContainerServiceMasterProfile(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of masters (VMs) in the container cluster")
    dns_prefix: StrictStr = Field(description="DNS prefix to be used to create FQDN for master", alias="dnsPrefix")
    fqdn: Optional[StrictStr] = Field(default=None, description="FQDN for the master")
    __properties: ClassVar[List[str]] = ["count", "dnsPrefix", "fqdn"]
