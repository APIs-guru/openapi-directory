...
class ContainerServiceSshConfiguration(BaseModel):
    ...
    """ # noqa: E501
    public_keys: Optional[List[ContainerServiceSshPublicKey]] = Field(default=None, description="Gets or sets the list of SSH public keys used to authenticate with Linux based VMs", alias="publicKeys")
