...
class ContainerServiceProperties(BaseModel):
    ...
    """ # noqa: E501
    agent_pool_profiles: List[ContainerServiceAgentPoolProfile] = Field(description="Properties of agent pools", alias="agentPoolProfiles")
    ...
    orchestrator_profile: Optional[ContainerServiceOrchestratorProfile] = Field(default=None, alias="orchestratorProfile")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets the provisioning state, which only appears in the response.", alias="provisioningState")
    windows_profile: Optional[ContainerServiceWindowsProfile] = Field(default=None, alias="windowsProfile")
    __properties: ClassVar[List[str]] = ["agentPoolProfiles", "diagnosticsProfile", "linuxProfile", "masterProfile", "orchestratorProfile", "provisioningState", "windowsProfile"]
