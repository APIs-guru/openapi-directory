...
class VirtualMachineSizesApi:
    ...
    @validate_call
    def virtual_machine_sizes_list(
        self,
        ...
        _param = self._virtual_machine_sizes_list_serialize(
            location=location,
    ...
    @validate_call
    def virtual_machine_sizes_list_with_http_info(
        self,
        location: Annotated[str, Field(strict=True, description="The location upon which virtual-machine-sizes is queried.")],
        api_version: Annotated[StrictStr, Field(description="Version of Azure Machine Learning resource provider API.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
    ...
    @validate_call
    def virtual_machine_sizes_list_without_preload_content(
        self,
        location: Annotated[str, Field(strict=True, description="The location upon which virtual-machine-sizes is queried.")],
        api_version: Annotated[StrictStr, Field(description="Version of Azure Machine Learning resource provider API.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
    ...
    def _virtual_machine_sizes_list_serialize(
        self,
        location,
        api_version,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearningServices/locations/{location}/vmSizes',
