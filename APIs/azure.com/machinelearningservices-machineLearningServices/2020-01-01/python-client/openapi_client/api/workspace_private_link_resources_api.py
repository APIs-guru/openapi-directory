...
class WorkspacePrivateLinkResourcesApi:
    ...
    @validate_call
    def private_link_resources_list_by_workspace(
        self,
        ...
        _param = self._private_link_resources_list_by_workspace_serialize(
    ...
    @validate_call
    def private_link_resources_list_by_workspace_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def private_link_resources_list_by_workspace_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _private_link_resources_list_by_workspace_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/privateLinkResources',
