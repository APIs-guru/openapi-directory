...
class WorkspacesApi:
    ...
    def workspace_features_list(
        ...
        _param = self._workspace_features_list_serialize(
    ...
    @validate_call
    def workspace_features_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of Azure Machine Learning resource provider API.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAmlUserFeatureResult]:
        """workspace_features_list
    ...
    @validate_call
    def workspace_features_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of Azure Machine Learning resource provider API.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
    ...
    def _workspace_features_list_serialize(
        self,
        api_version,
        subscription_id,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/features',
