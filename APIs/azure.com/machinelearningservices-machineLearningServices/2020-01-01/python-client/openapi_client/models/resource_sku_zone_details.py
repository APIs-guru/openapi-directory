...
class ResourceSkuZoneDetails(BaseModel):
    ...
    """ # noqa: E501
    capabilities: Optional[List[SKUCapability]] = Field(default=None, description="A list of capabilities that are available for the SKU in the specified list of zones.")
