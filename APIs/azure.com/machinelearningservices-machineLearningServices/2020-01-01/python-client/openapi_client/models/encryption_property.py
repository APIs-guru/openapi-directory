...
class EncryptionProperty(BaseModel):
    ...
    EncryptionProperty
    """ # noqa: E501
    key_vault_properties: KeyVaultProperties = Field(alias="keyVaultProperties")
    status: StrictStr = Field(description="Indicates whether or not the encryption is enabled for the workspace.")
