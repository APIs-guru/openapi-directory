...
class HDInsightAllOfProperties(BaseModel):
    """
    HDInsightAllOfProperties
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Public IP address of the master node of the cluster.")
    administrator_account: Optional[VirtualMachineSshCredentials] = Field(default=None, alias="administratorAccount")
    ssh_port: Optional[StrictInt] = Field(default=None, description="Port open for ssh connections on the master node of the cluster.", alias="sshPort")
    __properties: ClassVar[List[str]] = ["address", "administratorAccount", "sshPort"]
