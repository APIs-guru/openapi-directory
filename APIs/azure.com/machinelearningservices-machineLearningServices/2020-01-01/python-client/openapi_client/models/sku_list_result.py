...
class SkuListResult(BaseModel):
    """
    List of skus with features
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of Workspace Skus. Call ListNext() with this URI to fetch the next page of Workspace Skus", alias="nextLink")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [WorkspaceSku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
