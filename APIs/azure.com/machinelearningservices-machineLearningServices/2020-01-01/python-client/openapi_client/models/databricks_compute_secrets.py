...
class DatabricksComputeSecrets(ComputeSecrets):
    ...
    """ # noqa: E501
    databricks_access_token: Optional[StrictStr] = Field(default=None, description="access token for databricks account.", alias="databricksAccessToken")
    __properties: ClassVar[List[str]] = ["computeType", "databricksAccessToken"]
