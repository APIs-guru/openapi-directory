...
class TestAmlComputeAllOfProperties(unittest.TestCase):
    """AmlComputeAllOfProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmlComputeAllOfProperties:
        """Test AmlComputeAllOfProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmlComputeAllOfProperties`
        """
        model = AmlComputeAllOfProperties()
        if include_optional:
            return AmlComputeAllOfProperties(
    ...
    def testAmlComputeAllOfProperties(self):
        """Test AmlComputeAllOfProperties"""
