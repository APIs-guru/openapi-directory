...
**hbi_workspace** | **bool** | The flag to signal HBI data in the workspace and reduce diagnostic data collected by the service | [optional] [default to False]
...
**service_provisioned_resource_group** | **str** | The name of the managed resource group created by workspace RP in customer subscription if the workspace is CMK workspace | [optional] [readonly] 
