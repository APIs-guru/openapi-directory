...
[**machine_learning_compute_update**](OperationalizationClustersApi.md#machine_learning_compute_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/computes/{computeName} | 
...
> machine_learning_compute_delete(subscription_id, resource_group_name, workspace_name, compute_name, api_version, underlying_resource_action)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    compute_name = 'compute_name_example' # str | Name of the Azure Machine Learning compute.
    api_version = 'api_version_example' # str | Version of Azure Machine Learning resource provider API.
    underlying_resource_action = 'underlying_resource_action_example' # str | Delete the underlying compute if 'Delete', or detach the underlying compute from workspace if 'Detach'.

    try:
        api_instance.machine_learning_compute_delete(subscription_id, resource_group_name, workspace_name, compute_name, api_version, underlying_resource_action)
    except Exception as e:
 ...
 **compute_name** | **str**| Name of the Azure Machine Learning compute. | 
 **api_version** | **str**| Version of Azure Machine Learning resource provider API. | 
 **underlying_resource_action** | **str**| Delete the underlying compute if &#39;Delete&#39;, or detach the underlying compute from workspace if &#39;Detach&#39;. | 
...
> ComputeResource machine_learning_compute_update(subscription_id, resource_group_name, workspace_name, compute_name, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.machine_learning_compute_update(subscription_id, resource_group_name, workspace_name, compute_name, api_version, parameters)
        print("The response of OperationalizationClustersApi->machine_learning_compute_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationalizationClustersApi->machine_learning_compute_update: %s\n" % e)
```
