...
# **usages_list**
> ListUsagesResult usages_list(api_version, subscription_id, location, expand_children=expand_children)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    expand_children = 'expand_children_example' # str | Specifies if detailed usages of child resources are required. (optional)

    try:
        api_response = api_instance.usages_list(api_version, subscription_id, location, expand_children=expand_children)
 ...
 **expand_children** | **str**| Specifies if detailed usages of child resources are required. | [optional] 
