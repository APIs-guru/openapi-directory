...
class WorkspaceProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationInsights", "containerRegistry", "creationTime", "description", "discoveryUrl", "friendlyName", "keyVault", "provisioningState", "storageAccount", "workspaceId"]
