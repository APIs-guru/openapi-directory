...
class AmlComputeNodesInformation(ComputeNodesInformation):
    ...
    """ # noqa: E501
    nodes: Optional[List[AmlComputeNodeInformation]] = Field(default=None, description="The collection of returned AmlCompute nodes details.")
    __properties: ClassVar[List[str]] = ["computeType", "nextLink", "nodes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [AmlComputeNodeInformation.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
