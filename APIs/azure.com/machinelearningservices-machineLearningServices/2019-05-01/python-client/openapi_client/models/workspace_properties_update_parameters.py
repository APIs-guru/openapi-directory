...
class WorkspacePropertiesUpdateParameters(BaseModel):
    ...
    friendly_name: Optional[StrictStr] = Field(default=None, description="The friendly name for this workspace.", alias="friendlyName")
    __properties: ClassVar[List[str]] = ["description", "friendlyName"]
