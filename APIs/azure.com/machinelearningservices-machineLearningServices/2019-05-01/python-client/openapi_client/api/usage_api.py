...
class UsageApi:
    ...
    def usages_list(
        ...
        expand_children: Annotated[Optional[StrictStr], Field(description="Specifies if detailed usages of child resources are required.")] = None,
        ...
        :type location: str
        :param expand_children: Specifies if detailed usages of child resources are required.
    ...
    def _usages_list_serialize(
        ...
        if expand_children is not None:
            ...
            _query_params.append(('expandChildren', expand_children))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearningServices/locations/{location}/usages',
