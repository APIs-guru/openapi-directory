...
class OperationalizationClustersApi:
    ...
    @validate_call
    def machine_learning_compute_create_or_update(
        self,
        ...
        _param = self._machine_learning_compute_create_or_update_serialize(
    ...
    @validate_call
    def machine_learning_compute_create_or_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_create_or_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_create_or_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
    ...
    @validate_call
    def machine_learning_compute_delete(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_delete_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
    ...
    @validate_call
    def machine_learning_compute_delete_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_delete_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_delete_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
    ...
    @validate_call
    def machine_learning_compute_get(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_get_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
    ...
    @validate_call
    def machine_learning_compute_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
    ...
    @validate_call
    def machine_learning_compute_list_by_workspace(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_list_by_workspace_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            api_version=api_version,
    ...
    @validate_call
    def machine_learning_compute_list_by_workspace_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_list_by_workspace_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_list_by_workspace_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
    ...
    @validate_call
    def machine_learning_compute_list_keys(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_list_keys_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
    ...
    @validate_call
    def machine_learning_compute_list_keys_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_list_keys_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_list_keys_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
    ...
    @validate_call
    def machine_learning_compute_system_update(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_system_update_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
    ...
    @validate_call
    def machine_learning_compute_system_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_system_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_system_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
