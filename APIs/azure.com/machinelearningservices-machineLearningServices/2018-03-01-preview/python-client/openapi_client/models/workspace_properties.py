...
class WorkspaceProperties(BaseModel):
    ...
    batchai_workspace: Optional[StrictStr] = Field(default=None, description="ARM id of the Batch AI workspace associated with this workspace. This cannot be changed once the workspace has been created", alias="batchaiWorkspace")
    ...
    __properties: ClassVar[List[str]] = ["applicationInsights", "batchaiWorkspace", "containerRegistry", "creationTime", "description", "discoveryUrl", "friendlyName", "keyVault", "provisioningState", "storageAccount", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "batchaiWorkspace": obj.get("batchaiWorkspace"),
