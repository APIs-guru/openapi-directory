...
class DataFactory(Compute):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["computeLocation", "computeType", "createdOn", "description", "modifiedOn", "provisioningErrors", "provisioningState", "resourceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataFactory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataFactory from a dict"""
        if obj is None:
            return None
