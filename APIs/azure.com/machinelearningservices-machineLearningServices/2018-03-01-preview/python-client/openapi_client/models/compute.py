...
class Compute(BaseModel):
    ...
    resource_id: Optional[StrictStr] = Field(default=None, description="ARM resource id of the compute", alias="resourceId")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'AKS': 'AKS','BatchAI': 'BatchAI','DataFactory': 'DataFactory','HDInsight': 'HDInsight','VirtualMachine': 'VirtualMachine'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AKS, BatchAI, DataFactory, HDInsight, VirtualMachine]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AKS, BatchAI, DataFactory, HDInsight, VirtualMachine]]:
        ...
        if object_type ==  'BatchAI':
            return import_module("openapi_client.models.batch_ai").BatchAI.from_dict(obj)
