...
class VirtualMachine(Compute):
    ...
    """ # noqa: E501
    properties: Optional[VirtualMachineAllOfProperties] = None
    __properties: ClassVar[List[str]] = ["computeLocation", "computeType", "createdOn", "description", "modifiedOn", "provisioningErrors", "provisioningState", "resourceId", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": VirtualMachineAllOfProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
