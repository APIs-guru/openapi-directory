...
class OperationalizationClustersApi:
    ...
    @validate_call
    def machine_learning_compute_update(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
        ...
        _param = self._machine_learning_compute_update_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
    ...
    @validate_call
    def machine_learning_compute_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    @validate_call
    def machine_learning_compute_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group in which workspace is located.")],
        workspace_name: Annotated[StrictStr, Field(description="Name of Azure Machine Learning workspace.")],
    ...
    def _machine_learning_compute_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
