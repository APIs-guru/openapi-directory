...
class QuotaUpdateParameters(BaseModel):
    """
    Quota update parameters.
    """ # noqa: E501
    value: Optional[List[QuotaBaseProperties]] = Field(default=None, description="The list for update quota.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [QuotaBaseProperties.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
