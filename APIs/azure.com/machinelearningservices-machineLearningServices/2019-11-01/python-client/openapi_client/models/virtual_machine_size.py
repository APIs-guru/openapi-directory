...
class VirtualMachineSize(BaseModel):
    ...
    gpus: Optional[StrictInt] = Field(default=None, description="The number of gPUs supported by the virtual machine size.")
    ...
    __properties: ClassVar[List[str]] = ["family", "gpus", "lowPriorityCapable", "maxResourceVolumeMB", "memoryGB", "name", "osVhdSizeMB", "premiumIO", "vCPUs"]
