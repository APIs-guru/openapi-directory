...
------------ | ------------- | ------------- | -------------
**package_sid** | **str** | The package ID for this credential. | [optional] 
**secret_key** | **str** | The secret key. | [optional] 
**windows_live_endpoint** | **str** | The Windows Live endpoint. | [optional] 
