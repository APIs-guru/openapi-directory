...
class ApnsCredential(BaseModel):
    """
    Description of a NotificationHub ApnsCredential.
    """ # noqa: E501
    properties: Optional[ApnsCredentialProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApnsCredentialProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
