...
class PnsCredentialsProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["admCredential", "apnsCredential", "baiduCredential", "gcmCredential", "mpnsCredential", "wnsCredential"]
