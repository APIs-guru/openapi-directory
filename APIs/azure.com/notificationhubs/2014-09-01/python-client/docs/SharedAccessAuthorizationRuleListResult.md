...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Gets or sets link to the next set of results. Not empty if Value contains incomplete list of AuthorizationRules | [optional] 
**value** | [**List[SharedAccessAuthorizationRuleResource]**](SharedAccessAuthorizationRuleResource.md) | Gets or sets result of the List AuthorizationRules operation. | [optional] 
