...
------------ | ------------- | ------------- | -------------
**location** | **str** | Gets or sets Namespace data center location. | 
**properties** | [**NamespaceProperties**](NamespaceProperties.md) |  | 
**tags** | **Dict[str, str]** | Gets or sets Namespace tags. | [optional] 
