...
------------ | ------------- | ------------- | -------------
**apns_certificate** | **str** | Gets or sets the APNS certificate. | [optional] 
**certificate_key** | **str** | Gets or sets the certificate key. | [optional] 
**endpoint** | **str** | Gets or sets the endpoint of this credential. | [optional] 
**thumbprint** | **str** | Gets or sets the Apns certificate Thumbprint | [optional] 
