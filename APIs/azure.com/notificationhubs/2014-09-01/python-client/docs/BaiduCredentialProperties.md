...
------------ | ------------- | ------------- | -------------
**baidu_api_key** | **str** | Get or Set Baidu Api Key. | [optional] 
**baidu_end_point** | **str** | Get or Set Baidu Endpoint. | [optional] 
**baidu_secret_key** | **str** | Get or Set Baidu Secret Key | [optional] 
