...
class TestWnsCredential(unittest.TestCase):
    """WnsCredential unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WnsCredential:
        """Test WnsCredential
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WnsCredential`
        """
        model = WnsCredential()
        if include_optional:
