...
class TestNotificationHubResource(unittest.TestCase):
    """NotificationHubResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationHubResource:
        """Test NotificationHubResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationHubResource`
        """
    ...
    def testNotificationHubResource(self):
        """Test NotificationHubResource"""
