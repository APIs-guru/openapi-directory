...
class SharedAccessAuthorizationRuleCreateOrUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Gets or sets Namespace data center location.")
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets Name of the Namespace AuthorizationRule.")
