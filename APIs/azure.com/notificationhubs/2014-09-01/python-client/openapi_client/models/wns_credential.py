...
class WnsCredential(BaseModel):
    """
    Description of a NotificationHub WnsCredential.
    """ # noqa: E501
    properties: Optional[WnsCredentialProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": WnsCredentialProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
