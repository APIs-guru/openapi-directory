...
class NamespaceProperties(BaseModel):
    ...
    namespace_type: Optional[StrictStr] = Field(default=None, description="Gets or sets the namespace type.", alias="namespaceType")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets or sets provisioning state of the Namespace.", alias="provisioningState")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "critical", "enabled", "name", "namespaceType", "provisioningState", "region", "scaleUnit", "serviceBusEndpoint", "status", "subscriptionId"]
