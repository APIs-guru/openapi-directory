...
class MpnsCredential(BaseModel):
    """
    Description of a NotificationHub MpnsCredential.
    """ # noqa: E501
    properties: Optional[MpnsCredentialProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": MpnsCredentialProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
