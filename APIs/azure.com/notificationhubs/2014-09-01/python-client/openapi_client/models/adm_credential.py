...
class AdmCredential(BaseModel):
    """
    Description of a NotificationHub AdmCredential.
    """ # noqa: E501
    properties: Optional[AdmCredentialProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AdmCredentialProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
