...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Link to the next set of results. Not empty if Value contains incomplete list of NotificationHub | [optional] 
**value** | [**List[NotificationHubResource]**](NotificationHubResource.md) | Result of the List NotificationHub operation. | [optional] 
