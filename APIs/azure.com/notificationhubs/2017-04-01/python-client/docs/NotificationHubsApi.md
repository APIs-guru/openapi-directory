...
------------- | ------------- | -------------
[**notification_hubs_check_notification_hub_availability**](NotificationHubsApi.md#notification_hubs_check_notification_hub_availability) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/checkNotificationHubAvailability | 
...
[**notification_hubs_debug_send**](NotificationHubsApi.md#notification_hubs_debug_send) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName}/debugsend | 
...
[**notification_hubs_list_authorization_rules**](NotificationHubsApi.md#notification_hubs_list_authorization_rules) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName}/AuthorizationRules | 
...
[**notification_hubs_patch**](NotificationHubsApi.md#notification_hubs_patch) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName} | 
[**notification_hubs_regenerate_keys**](NotificationHubsApi.md#notification_hubs_regenerate_keys) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName}/AuthorizationRules/{authorizationRuleName}/regenerateKeys | 


# **notification_hubs_check_notification_hub_availability**
> CheckAvailabilityResult notification_hubs_check_notification_hub_availability(resource_group_name, namespace_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.notification_hubs_check_notification_hub_availability(resource_group_name, namespace_name, api_version, subscription_id, parameters)
        print("The response of NotificationHubsApi->notification_hubs_check_notification_hub_availability:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotificationHubsApi->notification_hubs_check_notification_hub_availability: %s\n" % e)
```
...
> DebugSendResponse notification_hubs_debug_send(resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = None # object | Debug send parameters (optional)

    try:
        api_response = api_instance.notification_hubs_debug_send(resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=parameters)
        print("The response of NotificationHubsApi->notification_hubs_debug_send:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotificationHubsApi->notification_hubs_debug_send: %s\n" % e)
```
...
> PnsCredentialsResource notification_hubs_get_pns_credentials(resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id)
...
> NotificationHubResource notification_hubs_patch(resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.NotificationHubPatchParameters() # NotificationHubPatchParameters | Parameters supplied to patch a NotificationHub Resource. (optional)

    try:
        api_response = api_instance.notification_hubs_patch(resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=parameters)
        print("The response of NotificationHubsApi->notification_hubs_patch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotificationHubsApi->notification_hubs_patch: %s\n" % e)
```
...
> ResourceListKeys notification_hubs_regenerate_keys(resource_group_name, namespace_name, notification_hub_name, authorization_rule_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.PolicykeyResource() # PolicykeyResource | Parameters supplied to regenerate the NotificationHub Authorization Rule Key.

    try:
        api_response = api_instance.notification_hubs_regenerate_keys(resource_group_name, namespace_name, notification_hub_name, authorization_rule_name, api_version, subscription_id, parameters)
        print("The response of NotificationHubsApi->notification_hubs_regenerate_keys:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotificationHubsApi->notification_hubs_regenerate_keys: %s\n" % e)
```
