...
------------ | ------------- | ------------- | -------------
**certificate_key** | **str** | The certificate key for this credential. | [optional] 
**mpns_certificate** | **str** | The MPNS certificate. | [optional] 
**thumbprint** | **str** | The MPNS certificate Thumbprint | [optional] 
