...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[Operation]] = Field(default=None, description="List of NotificationHubs operations supported by the Microsoft.NotificationHubs resource provider.")
