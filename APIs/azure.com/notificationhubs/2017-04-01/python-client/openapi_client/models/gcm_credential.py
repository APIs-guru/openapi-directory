...
class GcmCredential(BaseModel):
    """
    Description of a NotificationHub GcmCredential.
    """ # noqa: E501
    properties: Optional[GcmCredentialProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GcmCredentialProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
