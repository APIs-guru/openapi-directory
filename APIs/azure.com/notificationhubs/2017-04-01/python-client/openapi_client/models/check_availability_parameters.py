...
class CheckAvailabilityParameters(BaseModel):
    ...
    is_availiable: Optional[StrictBool] = Field(default=None, description="True if the name is available and can be used to create new Namespace/NotificationHub. Otherwise false.", alias="isAvailiable")
    ...
    __properties: ClassVar[List[str]] = ["id", "isAvailiable", "location", "name", "sku", "tags", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "isAvailiable": obj.get("isAvailiable"),
