...
[**policy_get_entity_tag**](PolicyApi.md#policy_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policies/{policyId} | 
...
> PolicyGet200Response policy_create_or_update(resource_group_name, service_name, policy_id, api_version, subscription_id, parameters, if_match=if_match)
...
# **policy_get**
> PolicyGet200Response policy_get(resource_group_name, service_name, policy_id, api_version, subscription_id, format=format)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.policy_get(resource_group_name, service_name, policy_id, api_version, subscription_id, format=format)
...
> policy_get_entity_tag(resource_group_name, service_name, policy_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.policy_get_entity_tag(resource_group_name, service_name, policy_id, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling PolicyApi->policy_get_entity_tag: %s\n" % e)
```
...
> PolicyListByService200Response policy_list_by_service(resource_group_name, service_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.policy_list_by_service(resource_group_name, service_name, api_version, subscription_id)
