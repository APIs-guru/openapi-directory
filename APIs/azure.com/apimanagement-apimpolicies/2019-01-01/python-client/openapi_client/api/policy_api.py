...
class PolicyApi:
    ...
    def policy_create_or_update(
        ...
        parameters: Annotated[PolicyGet200Response, Field(description="The policy contents to apply.")],
        ...
        :type parameters: PolicyGet200Response
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PolicyGet200Response",
            '201': "PolicyGet200Response",
        }
    ...
    def policy_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PolicyGet200Response]:
        """policy_create_or_update
    ...
    def policy_get_entity_tag(
        ...
        _param = self._policy_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            policy_id=policy_id,
            api_version=api_version,
    ...
    @validate_call
    def policy_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        policy_id: Annotated[StrictStr, Field(description="The identifier of the Policy.")],
    ...
    @validate_call
    def policy_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        policy_id: Annotated[StrictStr, Field(description="The identifier of the Policy.")],
    ...
    def _policy_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        policy_id,
    ...
    def policy_list_by_service(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PolicyListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def policy_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PolicyListByService200Response]:
        """policy_list_by_service
