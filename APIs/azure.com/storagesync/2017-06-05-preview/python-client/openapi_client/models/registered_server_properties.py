...
class RegisteredServerProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentVersion", "clusterId", "clusterName", "lastHeartBeat", "lastWorkflowId", "provisioningState", "serverCertificate", "serverId", "serverManagementtErrorCode", "serverOSVersion", "serverRole", "storageSyncServiceUid"]
