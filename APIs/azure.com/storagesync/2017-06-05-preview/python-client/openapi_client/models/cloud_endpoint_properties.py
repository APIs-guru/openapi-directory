...
class CloudEndpointProperties(BaseModel):
    ...
    storage_account: Optional[StrictStr] = Field(default=None, description="Storage Account name.", alias="storageAccount")
    storage_account_key: Optional[StrictStr] = Field(default=None, description="Storage Account access key.", alias="storageAccountKey")
    ...
    __properties: ClassVar[List[str]] = ["backupEnabled", "friendlyName", "lastWorkflowId", "partnershipId", "provisioningState", "storageAccount", "storageAccountKey", "storageAccountResourceId", "storageAccountShareName", "storageAccountTenantId"]
