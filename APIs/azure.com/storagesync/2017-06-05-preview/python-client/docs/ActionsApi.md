...
[**cloud_endpoints_restore_heatbeat_0**](ActionsApi.md#cloud_endpoints_restore_heatbeat_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/cloudEndpoints/{cloudEndpointName}/restoreheartbeat | 
[**server_endpoints_recall_0**](ActionsApi.md#server_endpoints_recall_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/serverEndpoints/{serverEndpointName}/recallAction | 
...
# **cloud_endpoints_restore_heatbeat_0**
> cloud_endpoints_restore_heatbeat_0(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.cloud_endpoints_restore_heatbeat_0(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name)
    except Exception as e:
        print("Exception when calling ActionsApi->cloud_endpoints_restore_heatbeat_0: %s\n" % e)
```
...
# **server_endpoints_recall_0**
> server_endpoints_recall_0(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, server_endpoint_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.server_endpoints_recall_0(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, server_endpoint_name)
    except Exception as e:
        print("Exception when calling ActionsApi->server_endpoints_recall_0: %s\n" % e)
```
