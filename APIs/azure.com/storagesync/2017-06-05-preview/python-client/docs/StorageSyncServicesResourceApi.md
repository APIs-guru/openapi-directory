...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    parameters = openapi_client.StorageSyncService() # StorageSyncService | Storage Sync Service resource name.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    storage_sync_service_name = 'storage_sync_service_name_example' # str | Name of Storage Sync Service resource.
    parameters = openapi_client.StorageSyncService() # StorageSyncService | Storage Sync Service resource. (optional)
