...
class CloudEndpointProperties(BaseModel):
    ...
    backup_enabled: Optional[StrictStr] = Field(default=None, description="Backup Enabled", alias="backupEnabled")
    ...
    __properties: ClassVar[List[str]] = ["azureFileShareName", "backupEnabled", "friendlyName", "lastOperationName", "lastWorkflowId", "partnershipId", "provisioningState", "storageAccountResourceId", "storageAccountTenantId"]
