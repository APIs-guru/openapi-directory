...
class TriggerRolloverRequest(BaseModel):
    """
    Trigger Rollover Request.
    """ # noqa: E501
    server_certificate: Optional[StrictStr] = Field(default=None, description="Certificate Data", alias="serverCertificate")
    __properties: ClassVar[List[str]] = ["serverCertificate"]
