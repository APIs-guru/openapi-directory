...
class RegisteredServerProperties(BaseModel):
    ...
    server_managementt_error_code: Optional[StrictInt] = Field(default=None, description="Registered Server Management Error Code", alias="serverManagementtErrorCode")
    ...
    __properties: ClassVar[List[str]] = ["agentVersion", "clusterId", "clusterName", "discoveryEndpointUri", "friendlyName", "lastHeartBeat", "lastOperationName", "lastWorkflowId", "managementEndpointUri", "provisioningState", "resourceLocation", "serverCertificate", "serverId", "serverManagementtErrorCode", "serverOSVersion", "serverRole", "serviceLocation", "storageSyncServiceUid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serverManagementtErrorCode": obj.get("serverManagementtErrorCode"),
