...
class CloudEndpointArray(BaseModel):
    """
    Array of CloudEndpoint
    """ # noqa: E501
    value: Optional[List[CloudEndpoint]] = Field(default=None, description="Collection of CloudEndpoint.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CloudEndpoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
