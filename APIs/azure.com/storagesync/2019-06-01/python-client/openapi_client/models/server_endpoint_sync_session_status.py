...
class ServerEndpointSyncSessionStatus(BaseModel):
    """
    Sync Session status object.
    """ # noqa: E501
    files_not_syncing_errors: Optional[List[ServerEndpointFilesNotSyncingError]] = Field(default=None, description="Array of per-item errors coming from the last sync session.", alias="filesNotSyncingErrors")
    last_sync_per_item_error_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Last sync per item error count.", alias="lastSyncPerItemErrorCount")
    ...
    persistent_files_not_syncing_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Count of persistent files not syncing.", alias="persistentFilesNotSyncingCount")
    transient_files_not_syncing_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Count of transient files not syncing.", alias="transientFilesNotSyncingCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filesNotSyncingErrors": [ServerEndpointFilesNotSyncingError.from_dict(_item) for _item in obj["filesNotSyncingErrors"]] if obj.get("filesNotSyncingErrors") is not None else None,
