...
class ServerEndpointProperties(BaseModel):
    ...
    cloud_tiering_status: Optional[ServerEndpointCloudTieringStatus] = Field(default=None, alias="cloudTieringStatus")
    ...
    recall_status: Optional[ServerEndpointRecallStatus] = Field(default=None, alias="recallStatus")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of cloud_tiering_status
        if self.cloud_tiering_status:
            _dict['cloudTieringStatus'] = self.cloud_tiering_status.to_dict()
        # override the default output from pydantic by calling `to_dict()` of recall_status
        if self.recall_status:
            _dict['recallStatus'] = self.recall_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudTieringStatus": ServerEndpointCloudTieringStatus.from_dict(obj["cloudTieringStatus"]) if obj.get("cloudTieringStatus") is not None else None,
            ...
            "recallStatus": ServerEndpointRecallStatus.from_dict(obj["recallStatus"]) if obj.get("recallStatus") is not None else None,
