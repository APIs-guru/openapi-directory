...
class CloudEndpointCreateParametersProperties(BaseModel):
    """
    CloudEndpoint Properties object.
    """ # noqa: E501
    azure_file_share_name: Optional[StrictStr] = Field(default=None, description="Azure file share name", alias="azureFileShareName")
    ...
    __properties: ClassVar[List[str]] = ["azureFileShareName", "friendlyName", "storageAccountResourceId", "storageAccountTenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureFileShareName": obj.get("azureFileShareName"),
