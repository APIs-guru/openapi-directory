...
class ChangeDetectionApi:
    ...
    @validate_call
    def cloud_endpoints_trigger_change_detection_1(
        self,
        ...
        _param = self._cloud_endpoints_trigger_change_detection_1_serialize(
    ...
    @validate_call
    def cloud_endpoints_trigger_change_detection_1_with_http_info(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    @validate_call
    def cloud_endpoints_trigger_change_detection_1_without_preload_content(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    def _cloud_endpoints_trigger_change_detection_1_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
