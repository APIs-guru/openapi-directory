...
class StorageSyncServiceArray(BaseModel):
    """
    Array of StorageSyncServices
    """ # noqa: E501
    value: Optional[List[StorageSyncService]] = Field(default=None, description="Collection of StorageSyncServices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [StorageSyncService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
