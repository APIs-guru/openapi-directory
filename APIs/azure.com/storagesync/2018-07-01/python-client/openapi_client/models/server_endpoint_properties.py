...
class ServerEndpointProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cloudTiering", "friendlyName", "lastOperationName", "lastWorkflowId", "provisioningState", "serverLocalPath", "serverResourceId", "syncStatus", "tierFilesOlderThanDays", "volumeFreeSpacePercent"]
