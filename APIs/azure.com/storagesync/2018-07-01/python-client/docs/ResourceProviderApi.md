# openapi_client.ResourceProviderApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**operations_list**](ResourceProviderApi.md#operations_list) | **GET** /providers/Microsoft.StorageSync/operations | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ResourceProviderApi(api_client)
    api_version = 'api_version_example' # str | The API version to use for this operation.

    try:
        api_response = api_instance.operations_list(api_version)
        print("The response of ResourceProviderApi->operations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourceProviderApi->operations_list: %s\n" % e)
```
