...
class ServerEndpointArray(BaseModel):
    """
    Array of ServerEndpoint
    """ # noqa: E501
    value: Optional[List[ServerEndpoint]] = Field(default=None, description="Collection of ServerEndpoint.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServerEndpoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
