...
class SyncGroupArray(BaseModel):
    """
    Array of SyncGroup
    """ # noqa: E501
    value: Optional[List[SyncGroup]] = Field(default=None, description="Collection of SyncGroup.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SyncGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
