...
class RegisteredServerArray(BaseModel):
    """
    Array of RegisteredServer
    """ # noqa: E501
    value: Optional[List[RegisteredServer]] = Field(default=None, description="Collection of Registered Server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RegisteredServer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
