...
class ServerEndpointProperties(BaseModel):
    ...
    sync_status: Optional[ServerEndpointHealth] = Field(default=None, alias="syncStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "syncStatus": ServerEndpointHealth.from_dict(obj["syncStatus"]) if obj.get("syncStatus") is not None else None,
