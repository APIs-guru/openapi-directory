...
[**workflows_list_by_storage_sync_service**](WorkflowResourceApi.md#workflows_list_by_storage_sync_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/workflows | 
...
> WorkflowArray workflows_list_by_storage_sync_service(subscription_id, resource_group_name, api_version, storage_sync_service_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.workflows_list_by_storage_sync_service(subscription_id, resource_group_name, api_version, storage_sync_service_name)
        print("The response of WorkflowResourceApi->workflows_list_by_storage_sync_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkflowResourceApi->workflows_list_by_storage_sync_service: %s\n" % e)
```
