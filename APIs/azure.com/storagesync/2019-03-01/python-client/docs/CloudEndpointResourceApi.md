...
[**cloud_endpoints_trigger_change_detection**](CloudEndpointResourceApi.md#cloud_endpoints_trigger_change_detection) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/cloudEndpoints/{cloudEndpointName}/triggerChangeDetection | 
...
# **cloud_endpoints_trigger_change_detection**
> cloud_endpoints_trigger_change_detection(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.cloud_endpoints_trigger_change_detection(subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name, parameters)
    except Exception as e:
        print("Exception when calling CloudEndpointResourceApi->cloud_endpoints_trigger_change_detection: %s\n" % e)
```
