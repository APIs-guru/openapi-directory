...
class SyncGroupProperties(BaseModel):
    ...
    """ # noqa: E501
    sync_group_status: Optional[StrictStr] = Field(default=None, description="Sync group status", alias="syncGroupStatus")
    unique_id: Optional[StrictStr] = Field(default=None, description="Unique Id", alias="uniqueId")
    __properties: ClassVar[List[str]] = ["syncGroupStatus", "uniqueId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "syncGroupStatus": obj.get("syncGroupStatus"),
