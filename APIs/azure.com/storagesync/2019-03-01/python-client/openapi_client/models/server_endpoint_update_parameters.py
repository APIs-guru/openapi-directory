...
class ServerEndpointUpdateParameters(BaseModel):
    """
    Parameters for updating an Server Endpoint.
    """ # noqa: E501
    properties: Optional[ServerEndpointUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ServerEndpointUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
