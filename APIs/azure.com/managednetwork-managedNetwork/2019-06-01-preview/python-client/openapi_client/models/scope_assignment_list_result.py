...
class ScopeAssignmentListResult(BaseModel):
    """
    ...
    value: Optional[List[ScopeAssignment]] = Field(default=None, description="Gets a page of ScopeAssignment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ScopeAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
