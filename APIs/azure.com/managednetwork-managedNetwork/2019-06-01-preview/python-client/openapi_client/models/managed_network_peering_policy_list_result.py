...
class ManagedNetworkPeeringPolicyListResult(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets the URL to get the next page of results.", alias="nextLink")
    value: Optional[List[ManagedNetworkPeeringPolicy]] = Field(default=None, description="Gets a page of Peering Policies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ManagedNetworkPeeringPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
