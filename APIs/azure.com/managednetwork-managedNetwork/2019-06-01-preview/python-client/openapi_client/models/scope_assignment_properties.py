...
class ScopeAssignmentProperties(BaseModel):
    """
    Properties of Managed Network
    """ # noqa: E501
    assigned_managed_network: Optional[StrictStr] = Field(default=None, description="The managed network ID with scope will be assigned to.", alias="assignedManagedNetwork")
