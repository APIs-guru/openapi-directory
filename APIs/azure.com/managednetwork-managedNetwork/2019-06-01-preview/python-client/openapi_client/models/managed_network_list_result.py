...
class ManagedNetworkListResult(BaseModel):
    """
    ...
    value: Optional[List[ManagedNetwork]] = Field(default=None, description="Gets a page of ManagedNetworks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ManagedNetwork.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
