...
class TestScopeAssignmentProperties(unittest.TestCase):
    """ScopeAssignmentProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScopeAssignmentProperties:
        """Test ScopeAssignmentProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScopeAssignmentProperties`
        """
        model = ScopeAssignmentProperties()
        if include_optional:
            return ScopeAssignmentProperties(
    ...
    def testScopeAssignmentProperties(self):
        """Test ScopeAssignmentProperties"""
