...
class TestManagedNetworkUpdate(unittest.TestCase):
    """ManagedNetworkUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedNetworkUpdate:
        """Test ManagedNetworkUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedNetworkUpdate`
        """
        model = ManagedNetworkUpdate()
        if include_optional:
            return ManagedNetworkUpdate(
                tags = {
                    'key' : ''
                    }
            )
    ...
    def testManagedNetworkUpdate(self):
        """Test ManagedNetworkUpdate"""
