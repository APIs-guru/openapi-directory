...
------------- | ------------- | -------------
[**api_issue_attachment_create_or_update**](ApiIssueAttachmentsApi.md#api_issue_attachment_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments/{attachmentId} | 
...
[**api_issue_attachment_get_entity_tag**](ApiIssueAttachmentsApi.md#api_issue_attachment_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments/{attachmentId} | 
[**api_issue_attachment_list_by_service**](ApiIssueAttachmentsApi.md#api_issue_attachment_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments | 


# **api_issue_attachment_create_or_update**
> IssueAttachmentContract api_issue_attachment_create_or_update(resource_group_name, service_name, api_id, issue_id, attachment_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    parameters = openapi_client.IssueAttachmentContract() # IssueAttachmentContract | Create parameters.
    ...
    try:
        ...
        print("The response of ApiIssueAttachmentsApi->api_issue_attachment_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueAttachmentsApi->api_issue_attachment_create_or_update: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiIssueAttachmentsApi->api_issue_attachment_get_entity_tag: %s\n" % e)
```
...
> IssueAttachmentCollection api_issue_attachment_list_by_service(resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_issue_attachment_list_by_service(resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ApiIssueAttachmentsApi->api_issue_attachment_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueAttachmentsApi->api_issue_attachment_list_by_service: %s\n" % e)
```
