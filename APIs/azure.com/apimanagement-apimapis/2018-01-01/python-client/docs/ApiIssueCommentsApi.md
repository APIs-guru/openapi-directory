# openapi_client.ApiIssueCommentsApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_issue_comment_create_or_update**](ApiIssueCommentsApi.md#api_issue_comment_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/comments/{commentId} | 
[**api_issue_comment_delete**](ApiIssueCommentsApi.md#api_issue_comment_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/comments/{commentId} | 
[**api_issue_comment_get**](ApiIssueCommentsApi.md#api_issue_comment_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/comments/{commentId} | 
[**api_issue_comment_get_entity_tag**](ApiIssueCommentsApi.md#api_issue_comment_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/comments/{commentId} | 
[**api_issue_comment_list_by_service**](ApiIssueCommentsApi.md#api_issue_comment_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/comments | 


# **api_issue_comment_create_or_update**
> IssueCommentContract api_issue_comment_create_or_update(resource_group_name, service_name, api_id, issue_id, comment_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApiIssueCommentsApi(api_client)
    ...
    parameters = openapi_client.IssueCommentContract() # IssueCommentContract | Create parameters.
    ...
    try:
        ...
        print("The response of ApiIssueCommentsApi->api_issue_comment_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueCommentsApi->api_issue_comment_create_or_update: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiIssueCommentsApi->api_issue_comment_delete: %s\n" % e)
```
...
> IssueCommentContract api_issue_comment_get(resource_group_name, service_name, api_id, issue_id, comment_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ApiIssueCommentsApi->api_issue_comment_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueCommentsApi->api_issue_comment_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiIssueCommentsApi->api_issue_comment_get_entity_tag: %s\n" % e)
```
...
> IssueCommentCollection api_issue_comment_list_by_service(resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_issue_comment_list_by_service(resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ApiIssueCommentsApi->api_issue_comment_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueCommentsApi->api_issue_comment_list_by_service: %s\n" % e)
```
