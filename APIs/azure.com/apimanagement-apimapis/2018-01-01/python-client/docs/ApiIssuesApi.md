...
[**api_issue_get_entity_tag**](ApiIssuesApi.md#api_issue_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId} | 
[**api_issue_list_by_service**](ApiIssuesApi.md#api_issue_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues | 
[**api_issue_update**](ApiIssuesApi.md#api_issue_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId} | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiIssuesApi->api_issue_get_entity_tag: %s\n" % e)
```
...
> IssueCollection api_issue_list_by_service(resource_group_name, service_name, api_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_issue_list_by_service(resource_group_name, service_name, api_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ApiIssuesApi->api_issue_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssuesApi->api_issue_list_by_service: %s\n" % e)
```
...
# **api_issue_update**
> api_issue_update(resource_group_name, service_name, api_id, issue_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.IssueUpdateContract() # IssueUpdateContract | Update parameters.
    if_match = 'if_match_example' # str | ETag of the Issue Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update. (optional)

    try:
        api_instance.api_issue_update(resource_group_name, service_name, api_id, issue_id, api_version, subscription_id, parameters, if_match=if_match)
    except Exception as e:
        print("Exception when calling ApiIssuesApi->api_issue_update: %s\n" % e)
```
