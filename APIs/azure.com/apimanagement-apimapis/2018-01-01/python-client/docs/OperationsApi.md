...
> OperationContract api_operation_create_or_update(resource_group_name, service_name, api_id, operation_id, api_version, subscription_id, parameters, if_match=if_match)
