...
class ApiCreateOrUpdateParameter(BaseModel):
    """
    API Create or Update Parameters.
    """ # noqa: E501
    properties: Optional[ApiCreateOrUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApiCreateOrUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
