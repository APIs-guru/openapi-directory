...
class ApiDiagnosticLoggerListByService200ResponseValueInnerProperties(BaseModel):
    """
    ...
    sampling: Optional[ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSampling] = None
    __properties: ClassVar[List[str]] = ["credentials", "description", "isBuffered", "loggerType", "sampling"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sampling": ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSampling.from_dict(obj["sampling"]) if obj.get("sampling") is not None else None
        })
        return _obj
