...
class IssueAttachmentCollection(BaseModel):
    """
    ...
    value: Optional[List[IssueAttachmentContract]] = Field(default=None, description="Issue Attachment values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IssueAttachmentContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
