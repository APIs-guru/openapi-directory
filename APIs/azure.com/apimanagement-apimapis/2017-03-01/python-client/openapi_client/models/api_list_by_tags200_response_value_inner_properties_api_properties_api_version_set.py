...
class ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSet(BaseModel):
    """
    Api Version Set Contract details.
    """ # noqa: E501
    properties: Optional[ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSetProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSetProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
