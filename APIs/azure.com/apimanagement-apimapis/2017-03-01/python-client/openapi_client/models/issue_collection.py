...
class IssueCollection(BaseModel):
    ...
    value: Optional[List[IssueContract]] = Field(default=None, description="Issue values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IssueContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
