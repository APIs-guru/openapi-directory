...
class SchemaCollection(BaseModel):
    ...
    value: Optional[List[SchemaContract]] = Field(default=None, description="Api Schema Contract value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SchemaContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
