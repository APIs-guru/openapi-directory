...
class ApiListByTags200ResponseValueInnerPropertiesOperationProperties(BaseModel):
    """
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="Operation name.", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["apiName", "apiRevision", "apiVersion", "description", "displayName", "method", "urlTemplate"]
