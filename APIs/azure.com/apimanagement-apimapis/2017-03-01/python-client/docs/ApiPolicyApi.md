...
> ApiOperationPolicyGet200Response api_policy_create_or_update(resource_group_name, service_name, api_id, policy_id, if_match, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    if_match = 'if_match_example' # str | The entity state (Etag) version of the Api Policy to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation.
    ...
    try:
        api_response = api_instance.api_policy_create_or_update(resource_group_name, service_name, api_id, policy_id, if_match, api_version, subscription_id, parameters)
 ...
 **if_match** | **str**| The entity state (Etag) version of the Api Policy to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. | 
