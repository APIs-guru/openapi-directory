...
api_revision_contract_properties_instance = ApiRevisionContractProperties.from_json(json)
# print the JSON string representation of the object
print(ApiRevisionContractProperties.to_json())

# convert the object into a dict
api_revision_contract_properties_dict = api_revision_contract_properties_instance.to_dict()
# create an instance of ApiRevisionContractProperties from a dict
api_revision_contract_properties_from_dict = ApiRevisionContractProperties.from_dict(api_revision_contract_properties_dict)
```
