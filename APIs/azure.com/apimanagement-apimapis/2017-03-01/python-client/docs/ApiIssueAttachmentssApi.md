# openapi_client.ApiIssueAttachmentssApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_issu_attachment_head**](ApiIssueAttachmentssApi.md#api_issu_attachment_head) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments/{attachmentId} | 
[**api_issue_attachment_create_or_update**](ApiIssueAttachmentssApi.md#api_issue_attachment_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments/{attachmentId} | 


# **api_issu_attachment_head**
> api_issu_attachment_head(resource_group_name, service_name, api_id, issue_id, attachment_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApiIssueAttachmentssApi(api_client)
    ...
    try:
        api_instance.api_issu_attachment_head(resource_group_name, service_name, api_id, issue_id, attachment_id, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling ApiIssueAttachmentssApi->api_issu_attachment_head: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ApiIssueAttachmentssApi->api_issue_attachment_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiIssueAttachmentssApi->api_issue_attachment_create_or_update: %s\n" % e)
```
