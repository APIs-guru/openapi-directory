...
> SchemaContract api_schema_create_or_update(resource_group_name, service_name, api_id, schema_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    parameters = openapi_client.SchemaContract() # SchemaContract | The schema contents to apply.
    if_match = 'if_match_example' # str | The entity state (Etag) version of the Api Schema to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation. (optional)
 ...
 **if_match** | **str**| The entity state (Etag) version of the Api Schema to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. | [optional] 
...
# **api_schema_delete**
> api_schema_delete(resource_group_name, service_name, api_id, schema_id, if_match, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_schema_delete(resource_group_name, service_name, api_id, schema_id, if_match, api_version, subscription_id)
    except Exception as e:
...
# **api_schema_get**
> SchemaContract api_schema_get(resource_group_name, service_name, api_id, schema_id, api_version, subscription_id)
...
> SchemaCollection api_schema_list_by_api(resource_group_name, service_name, api_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_schema_list_by_api(resource_group_name, service_name, api_id, api_version, subscription_id)
