...
class ApiDiagnosticListByService200ResponseValueInnerProperties(BaseModel):
    ...
    log_client_ip: Optional[StrictBool] = Field(default=None, description="Log the ClientIP. Default is false.", alias="logClientIp")
    ...
    __properties: ClassVar[List[str]] = ["alwaysLog", "backend", "frontend", "httpCorrelationProtocol", "logClientIp", "loggerId", "sampling", "verbosity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logClientIp": obj.get("logClientIp"),
