...
class ApiDiagnosticListByService200ResponseValueInnerPropertiesSampling(BaseModel):
    """
    Sampling settings for Diagnostic.
    """ # noqa: E501
    percentage: Optional[Union[Annotated[float, Field(le=1E+2, strict=True, ge=0)], Annotated[int, Field(le=100, strict=True, ge=0)]]] = Field(default=None, description="Rate of sampling for fixed-rate sampling.")
    sampling_type: Optional[StrictStr] = Field(default=None, description="Sampling type.", alias="samplingType")
    __properties: ClassVar[List[str]] = ["percentage", "samplingType"]
