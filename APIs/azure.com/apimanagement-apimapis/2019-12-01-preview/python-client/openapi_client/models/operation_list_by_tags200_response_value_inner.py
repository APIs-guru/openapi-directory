...
class OperationListByTags200ResponseValueInner(BaseModel):
    """
    TagResource contract properties.
    """ # noqa: E501
    api: Optional[OperationListByTags200ResponseValueInnerApi] = None
    operation: Optional[OperationListByTags200ResponseValueInnerOperation] = None
    product: Optional[OperationListByTags200ResponseValueInnerProduct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": OperationListByTags200ResponseValueInnerApi.from_dict(obj["api"]) if obj.get("api") is not None else None,
            "operation": OperationListByTags200ResponseValueInnerOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "product": OperationListByTags200ResponseValueInnerProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "tag": OperationListByTags200ResponseValueInnerTag.from_dict(obj["tag"]) if obj.get("tag") is not None else None
        })
        return _obj
