...
class ApiApi:
    ...
    def api_create_or_update(
        ...
        parameters: Annotated[ApiCreateOrUpdateRequest, Field(description="Create or update parameters.")],
        ...
        :type parameters: ApiCreateOrUpdateRequest
    ...
    def api_delete(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        delete_revisions: Annotated[Optional[StrictBool], Field(description="Delete all revisions of the Api.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _api_delete_serialize(
        ...
        if delete_revisions is not None:
            ...
            _query_params.append(('deleteRevisions', delete_revisions))
    ...
    def api_list_by_service(
        ...
        tags: Annotated[Optional[StrictStr], Field(description="Include tags in the response.")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def api_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiListByService200Response]:
        """api_list_by_service
    ...
    def api_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[ApiUpdateRequest, Field(description="API Update Contract parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: ApiUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
