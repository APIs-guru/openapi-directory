...
class ApiOperationsByTagApi:
    ...
    def operation_list_by_tags(
        ...
        include_not_tagged_operations: Annotated[Optional[StrictBool], Field(description="Include not tagged Operations.")] = None,
        ...
        _param = self._operation_list_by_tags_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OperationListByTags200Response",
        }
    ...
    @validate_call
    def operation_list_by_tags_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OperationListByTags200Response]:
        """operation_list_by_tags
    ...
    @validate_call
    def operation_list_by_tags_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _operation_list_by_tags_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
        ...
        if include_not_tagged_operations is not None:
            ...
            _query_params.append(('includeNotTaggedOperations', include_not_tagged_operations))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags',
