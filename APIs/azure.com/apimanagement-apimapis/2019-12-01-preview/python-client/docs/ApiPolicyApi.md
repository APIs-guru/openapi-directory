...
# **api_policy_get**
> ApiOperationPolicyGet200Response api_policy_get(resource_group_name, service_name, api_id, policy_id, api_version, subscription_id, format=format)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_policy_get(resource_group_name, service_name, api_id, policy_id, api_version, subscription_id, format=format)
