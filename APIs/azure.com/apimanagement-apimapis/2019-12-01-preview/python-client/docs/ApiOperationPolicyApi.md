# openapi_client.ApiOperationPolicyApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_operation_policy_create_or_update**](ApiOperationPolicyApi.md#api_operation_policy_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}/policies/{policyId} | 
[**api_operation_policy_delete**](ApiOperationPolicyApi.md#api_operation_policy_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}/policies/{policyId} | 
[**api_operation_policy_get**](ApiOperationPolicyApi.md#api_operation_policy_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}/policies/{policyId} | 
[**api_operation_policy_get_entity_tag**](ApiOperationPolicyApi.md#api_operation_policy_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}/policies/{policyId} | 
[**api_operation_policy_list_by_operation**](ApiOperationPolicyApi.md#api_operation_policy_list_by_operation) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}/policies | 


# **api_operation_policy_create_or_update**
> ApiOperationPolicyGet200Response api_operation_policy_create_or_update(resource_group_name, service_name, api_id, operation_id, policy_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApiOperationPolicyApi(api_client)
    ...
    try:
        api_response = api_instance.api_operation_policy_create_or_update(resource_group_name, service_name, api_id, operation_id, policy_id, api_version, subscription_id, parameters, if_match=if_match)
        print("The response of ApiOperationPolicyApi->api_operation_policy_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiOperationPolicyApi->api_operation_policy_create_or_update: %s\n" % e)
```
...
> api_operation_policy_delete(resource_group_name, service_name, api_id, operation_id, policy_id, if_match, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_operation_policy_delete(resource_group_name, service_name, api_id, operation_id, policy_id, if_match, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling ApiOperationPolicyApi->api_operation_policy_delete: %s\n" % e)
```
...
> ApiOperationPolicyGet200Response api_operation_policy_get(resource_group_name, service_name, api_id, operation_id, policy_id, api_version, subscription_id, format=format)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_operation_policy_get(resource_group_name, service_name, api_id, operation_id, policy_id, api_version, subscription_id, format=format)
        print("The response of ApiOperationPolicyApi->api_operation_policy_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiOperationPolicyApi->api_operation_policy_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiOperationPolicyApi->api_operation_policy_get_entity_tag: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ApiOperationPolicyApi->api_operation_policy_list_by_operation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiOperationPolicyApi->api_operation_policy_list_by_operation: %s\n" % e)
```
