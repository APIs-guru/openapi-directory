...
class ApiRevisionApi:
    ...
    @validate_call
    def api_revision_list_by_service(
        self,
        ...
        filter: Annotated[Optional[StrictStr], Field(description="|   Field     |     Usage     |     Supported operators     |     Supported functions     |</br>|-------------|-------------|-------------|-------------|</br>| apiRevision | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>")] = None,
        ...
        _param = self._api_revision_list_by_service_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiRevisionListByService200Response",
        }
    ...
    @validate_call
    def api_revision_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="API identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiRevisionListByService200Response]:
        """api_revision_list_by_service
    ...
    @validate_call
    def api_revision_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="API identifier. Must be unique in the current API Management service instance.")],
    ...
    def _api_revision_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
