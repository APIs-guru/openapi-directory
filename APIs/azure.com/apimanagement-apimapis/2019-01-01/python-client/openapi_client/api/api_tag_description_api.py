...
class ApiTagDescriptionApi:
    ...
    @validate_call
    def api_tag_description_create_or_update(
        self,
        ...
        parameters: Annotated[ApiTagDescriptionCreateOrUpdateRequest, Field(description="Create parameters.")],
        ...
        :type parameters: ApiTagDescriptionCreateOrUpdateRequest
        ...
        _param = self._api_tag_description_create_or_update_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiTagDescriptionGet200Response",
            '201': "ApiTagDescriptionGet200Response",
        }
    ...
    @validate_call
    def api_tag_description_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiTagDescriptionGet200Response]:
        """api_tag_description_create_or_update
    ...
    @validate_call
    def api_tag_description_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _api_tag_description_create_or_update_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
    ...
    @validate_call
    def api_tag_description_delete(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        ...
        _param = self._api_tag_description_delete_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    @validate_call
    def api_tag_description_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    @validate_call
    def api_tag_description_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _api_tag_description_delete_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
    ...
    def api_tag_description_get(
        ...
        _param = self._api_tag_description_get_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    @validate_call
    def api_tag_description_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    @validate_call
    def api_tag_description_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _api_tag_description_get_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
    ...
    @validate_call
    def api_tag_description_get_entity_tag(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        ...
        _param = self._api_tag_description_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    @validate_call
    def api_tag_description_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    @validate_call
    def api_tag_description_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _api_tag_description_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
    ...
    @validate_call
    def api_tag_description_list_by_service(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="|   Field     |     Usage     |     Supported operators     |     Supported functions     |</br>|-------------|-------------|-------------|-------------|</br>| displayName | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>| name | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>")] = None,
        ...
        _param = self._api_tag_description_list_by_service_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiTagDescriptionListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def api_tag_description_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiTagDescriptionListByService200Response]:
        """api_tag_description_list_by_service
    ...
    @validate_call
    def api_tag_description_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.")],
    ...
    def _api_tag_description_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
