...
class ApiSchemaCreateOrUpdateRequestPropertiesDocument(BaseModel):
    """
    Schema Document Properties.
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Json escaped string defining the document representing the Schema.")
