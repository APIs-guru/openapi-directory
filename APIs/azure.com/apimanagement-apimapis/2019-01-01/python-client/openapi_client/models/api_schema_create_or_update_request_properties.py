...
class ApiSchemaCreateOrUpdateRequestProperties(BaseModel):
    """
    ...
    document: Optional[ApiSchemaCreateOrUpdateRequestPropertiesDocument] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "document": ApiSchemaCreateOrUpdateRequestPropertiesDocument.from_dict(obj["document"]) if obj.get("document") is not None else None
        })
        return _obj
