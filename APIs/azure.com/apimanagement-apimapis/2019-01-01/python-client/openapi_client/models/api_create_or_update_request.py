...
class ApiCreateOrUpdateRequest(BaseModel):
    """
    API Create or Update Parameters.
    """ # noqa: E501
    properties: Optional[ApiCreateOrUpdateRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApiCreateOrUpdateRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
