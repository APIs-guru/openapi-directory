...
------------- | ------------- | -------------
[**apis_create_or_update**](ApisApi.md#apis_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId} | 
[**apis_delete**](ApisApi.md#apis_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId} | 
[**apis_get**](ApisApi.md#apis_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId} | 
[**apis_list_by_service**](ApisApi.md#apis_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis | 
[**apis_update**](ApisApi.md#apis_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId} | 


# **apis_create_or_update**
> apis_create_or_update(resource_group_name, service_name, api_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    parameters = openapi_client.ApiContract() # ApiContract | Create or update parameters.
    ...
    try:
        api_instance.apis_create_or_update(resource_group_name, service_name, api_id, api_version, subscription_id, parameters, if_match=if_match)
    except Exception as e:
        print("Exception when calling ApisApi->apis_create_or_update: %s\n" % e)
```
...
# **apis_delete**
> apis_delete(resource_group_name, service_name, api_id, if_match, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.apis_delete(resource_group_name, service_name, api_id, if_match, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling ApisApi->apis_delete: %s\n" % e)
```
...
# **apis_get**
> ApiContract apis_get(resource_group_name, service_name, api_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.apis_get(resource_group_name, service_name, api_id, api_version, subscription_id)
        print("The response of ApisApi->apis_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApisApi->apis_get: %s\n" % e)
```
...
> ApiCollection apis_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.apis_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ApisApi->apis_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApisApi->apis_list_by_service: %s\n" % e)
```
...
# **apis_update**
> apis_update(resource_group_name, service_name, api_id, if_match, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.apis_update(resource_group_name, service_name, api_id, if_match, api_version, subscription_id, parameters)
    except Exception as e:
        print("Exception when calling ApisApi->apis_update: %s\n" % e)
```
