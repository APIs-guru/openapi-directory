...
class OperationUpdateContract(BaseModel):
    """
    Api Operation Update Contract details.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the operation within the current API Management service instance. The value is a valid relative URL in the format of /apis/{aid}/operations/{id} where {aid} is an API identifier and {id} is an operation identifier.")
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=300)]] = Field(default=None, description="Operation Name.")
    ...
    responses: Optional[List[ResultContract]] = Field(default=None, description="Array of Operation responses.")
    ...
    __properties: ClassVar[List[str]] = ["description", "request", "responses", "templateParameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [ResultContract.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
