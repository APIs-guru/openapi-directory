...
class ApiContract(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=300)] = Field(description="API name.")
    ...
    protocols: List[StrictStr] = Field(description="Describes on which protocols the operations in this API can be invoked.")
    service_url: Annotated[str, Field(min_length=1, strict=True, max_length=2000)] = Field(description="Absolute URL of the backend service implementing this API.", alias="serviceUrl")
