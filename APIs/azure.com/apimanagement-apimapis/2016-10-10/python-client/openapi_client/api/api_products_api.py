...
class ApiProductsApi:
    ...
    def api_products_list_by_apis(
        ...
        _param = self._api_products_list_by_apis_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiProductsListByApis200Response",
        }
    ...
    @validate_call
    def api_products_list_by_apis_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiProductsListByApis200Response]:
        """api_products_list_by_apis
    ...
    @validate_call
    def api_products_list_by_apis_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="API identifier. Must be unique in the current API Management service instance.")],
    ...
    def _api_products_list_by_apis_serialize(
        self,
        resource_group_name,
        service_name,
        api_id,
