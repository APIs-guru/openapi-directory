...
class TagDescriptionCreateOrUpdateRequest(BaseModel):
    """
    Parameters supplied to the Create TagDescription operation.
    """ # noqa: E501
    properties: Optional[TagDescriptionCreateOrUpdateRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TagDescriptionCreateOrUpdateRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
