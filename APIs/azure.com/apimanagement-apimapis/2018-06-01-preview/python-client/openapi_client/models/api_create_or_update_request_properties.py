...
class ApiCreateOrUpdateRequestProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apiType", "contentFormat", "contentValue", "wsdlSelector"]
    ...
    def content_format_validate_enum(cls, value):
        ...
        if value not in set(['wadl-xml', 'wadl-link-json', 'swagger-json', 'swagger-link-json', 'wsdl', 'wsdl-link', 'openapi', 'openapi+json', 'openapi-link']):
            raise ValueError("must be one of enum values ('wadl-xml', 'wadl-link-json', 'swagger-json', 'swagger-link-json', 'wsdl', 'wsdl-link', 'openapi', 'openapi+json', 'openapi-link')")
        return value
