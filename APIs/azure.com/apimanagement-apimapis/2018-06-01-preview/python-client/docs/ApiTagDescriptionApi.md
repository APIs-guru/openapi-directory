# openapi_client.ApiTagDescriptionApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**tag_description_create_or_update**](ApiTagDescriptionApi.md#tag_description_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**tag_description_delete**](ApiTagDescriptionApi.md#tag_description_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**tag_description_get**](ApiTagDescriptionApi.md#tag_description_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**tag_description_get_entity_state**](ApiTagDescriptionApi.md#tag_description_get_entity_state) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**tag_description_list_by_api**](ApiTagDescriptionApi.md#tag_description_list_by_api) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions | 


# **tag_description_create_or_update**
> TagDescriptionGet200Response tag_description_create_or_update(resource_group_name, service_name, api_id, tag_id, api_version, subscription_id, parameters, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ApiTagDescriptionApi(api_client)
    ...
    parameters = openapi_client.TagDescriptionCreateOrUpdateRequest() # TagDescriptionCreateOrUpdateRequest | Create parameters.
    ...
    try:
        ...
        print("The response of ApiTagDescriptionApi->tag_description_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiTagDescriptionApi->tag_description_create_or_update: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiTagDescriptionApi->tag_description_delete: %s\n" % e)
```
...
# **tag_description_get**
> TagDescriptionGet200Response tag_description_get(resource_group_name, service_name, api_id, tag_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ApiTagDescriptionApi->tag_description_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiTagDescriptionApi->tag_description_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApiTagDescriptionApi->tag_description_get_entity_state: %s\n" % e)
```
...
> TagDescriptionListByApi200Response tag_description_list_by_api(resource_group_name, service_name, api_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    filter = 'filter_example' # str | | Field       | Supported operators    | Supported functions               | |-------------|------------------------|-----------------------------------|   |displayName | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| |name | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith|  (optional)
    ...
    try:
        ...
        print("The response of ApiTagDescriptionApi->tag_description_list_by_api:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiTagDescriptionApi->tag_description_list_by_api: %s\n" % e)
```
 ...
 **api_version** | **str**| Version of the API to be used with the client request. | 
 **subscription_id** | **str**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **filter** | **str**| | Field       | Supported operators    | Supported functions               | |-------------|------------------------|-----------------------------------|   |displayName | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| |name | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith|  | [optional] 
