...
class LuisResult(BaseModel):
    ...
    connected_service_result: Optional[LuisResult] = Field(default=None, alias="connectedServiceResult")
    ...
    query: Optional[StrictStr] = Field(default=None, description="The input utterance that was analyzed.")
    ...
    __properties: ClassVar[List[str]] = ["alteredQuery", "compositeEntities", "connectedServiceResult", "entities", "intents", "query", "sentimentAnalysis", "topScoringIntent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of connected_service_result
        if self.connected_service_result:
            _dict['connectedServiceResult'] = self.connected_service_result.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectedServiceResult": LuisResult.from_dict(obj["connectedServiceResult"]) if obj.get("connectedServiceResult") is not None else None,
...
LuisResult.model_rebuild(raise_errors=False)
