...
class Prediction(BaseModel):
    ...
    """ # noqa: E501
    altered_query: Optional[StrictStr] = Field(default=None, description="The query after spell checking. Only set if spell check was enabled and a spelling mistake was found.", alias="alteredQuery")
    entities: Dict[str, Dict[str, Any]] = Field(description="A dictionary representing the entities that fired.")
    intents: Dict[str, Intent] = Field(description="A dictionary representing the intents that fired.")
    sentiment: Optional[Sentiment] = None
    top_intent: StrictStr = Field(description="The name of the top scoring intent.", alias="topIntent")
    __properties: ClassVar[List[str]] = ["alteredQuery", "entities", "intents", "sentiment", "topIntent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topIntent": obj.get("topIntent")
        })
        return _obj

from openapi_client.models.intent import Intent
# TODO: Rewrite to not use raise_errors
Prediction.model_rebuild(raise_errors=False)
