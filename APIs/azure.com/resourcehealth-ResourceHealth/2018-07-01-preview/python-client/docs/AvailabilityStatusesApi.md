...
|-------------|-------------|------------------|
**200** | The current availability status for a single resource |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | The list of historical availability statuses for a single resource |  -  |
**0** | DefaultErrorResponse |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | The list of current availability status for all the resources in the resource group |  -  |
**0** | DefaultErrorResponse |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | The list of current availability status for all the resources in the subscription |  -  |
**0** | DefaultErrorResponse |  -  |
