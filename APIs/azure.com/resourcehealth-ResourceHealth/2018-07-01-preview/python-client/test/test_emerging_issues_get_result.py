...
class TestEmergingIssuesGetResult(unittest.TestCase):
    """EmergingIssuesGetResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmergingIssuesGetResult:
        """Test EmergingIssuesGetResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmergingIssuesGetResult`
        """
        model = EmergingIssuesGetResult()
        if include_optional:
    ...
    def testEmergingIssuesGetResult(self):
        """Test EmergingIssuesGetResult"""
