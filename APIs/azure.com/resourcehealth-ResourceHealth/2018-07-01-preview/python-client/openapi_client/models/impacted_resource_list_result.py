...
class ImpactedResourceListResult(BaseModel):
    """
    The List impactedResourceStatus operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of impactedResourceStatus.", alias="nextLink")
    value: List[ImpactedResourceStatus] = Field(description="The list of impactedResourceStatus.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ImpactedResourceStatus.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
