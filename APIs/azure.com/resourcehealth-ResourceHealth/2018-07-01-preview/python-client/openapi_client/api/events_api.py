...
class EventsApi:
    ...
    @validate_call
    def events_list_by_single_resource(
        self,
        ...
        _param = self._events_list_by_single_resource_serialize(
    ...
    @validate_call
    def events_list_by_single_resource_with_http_info(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The fully qualified ID of the resource, including the resource name and resource type. Currently the API support not nested and one nesting level resource types : /subscriptions/{subscriptionId}/resourceGroups/{resource-group-name}/providers/{resource-provider-name}/{resource-type}/{resource-name} and /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resource-provider-name}/{parentResourceType}/{parentResourceName}/{resourceType}/{resourceName}")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
    ...
    @validate_call
    def events_list_by_single_resource_without_preload_content(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The fully qualified ID of the resource, including the resource name and resource type. Currently the API support not nested and one nesting level resource types : /subscriptions/{subscriptionId}/resourceGroups/{resource-group-name}/providers/{resource-provider-name}/{resource-type}/{resource-name} and /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resource-provider-name}/{parentResourceType}/{parentResourceName}/{resourceType}/{resourceName}")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
    ...
    def _events_list_by_single_resource_serialize(
        self,
        resource_uri,
        api_version,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{resourceUri}/providers/Microsoft.ResourceHealth/events',
    ...
    @validate_call
    def events_list_by_subscription_id(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        ...
        _param = self._events_list_by_subscription_id_serialize(
            api_version=api_version,
    ...
    @validate_call
    def events_list_by_subscription_id_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
    ...
    @validate_call
    def events_list_by_subscription_id_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
    ...
    def _events_list_by_subscription_id_serialize(
        self,
        api_version,
        subscription_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
