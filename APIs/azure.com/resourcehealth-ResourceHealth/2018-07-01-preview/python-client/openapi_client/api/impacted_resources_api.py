...
class ImpactedResourcesApi:
    ...
    @validate_call
    def impacted_resources_list_by_subscription_id(
        self,
        ...
        _param = self._impacted_resources_list_by_subscription_id_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ImpactedResourceListResult",
        }
    ...
    @validate_call
    def impacted_resources_list_by_subscription_id_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImpactedResourceListResult]:
        """impacted_resources_list_by_subscription_id
    ...
    @validate_call
    def impacted_resources_list_by_subscription_id_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN")] = None,
    ...
    def _impacted_resources_list_by_subscription_id_serialize(
        self,
        api_version,
        subscription_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/impactedResources',
