...
class AvailabilityStatusProperties(BaseModel):
    ...
    occurred_time: Optional[datetime] = Field(default=None, description="Timestamp for when last change in health status occurred.", alias="occurredTime")
    ...
    __properties: ClassVar[List[str]] = ["availabilityState", "detailedStatus", "healthEventCategory", "healthEventCause", "healthEventId", "healthEventType", "occurredTime", "reasonChronicity", "reasonType", "recentlyResolved", "recommendedActions", "reportedTime", "resolutionETA", "rootCauseAttributionTime", "serviceImpactingEvents", "summary"]
