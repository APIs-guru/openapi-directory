...
class TestEmergingIssue(unittest.TestCase):
    """EmergingIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmergingIssue:
        """Test EmergingIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmergingIssue`
        """
        model = EmergingIssue()
        if include_optional:
