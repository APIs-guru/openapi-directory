...
> Events events_list_by_single_resource(resource_uri, api_version, filter=filter, view=view)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    view = 'view_example' # str | setting view=full expands the article parameters (optional)

    try:
        api_response = api_instance.events_list_by_single_resource(resource_uri, api_version, filter=filter, view=view)
 ...
 **view** | **str**| setting view&#x3D;full expands the article parameters | [optional] 
...
> Events events_list_by_subscription_id(api_version, subscription_id, filter=filter, view=view)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.events_list_by_subscription_id(api_version, subscription_id, filter=filter, view=view)
