...
class DownloadedProductsGet200ResponseProperties(BaseModel):
    """
    ...
    links: Optional[List[DownloadedProductsGet200ResponsePropertiesLinksInner]] = Field(default=None, description="List of product links.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": [DownloadedProductsGet200ResponsePropertiesLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
