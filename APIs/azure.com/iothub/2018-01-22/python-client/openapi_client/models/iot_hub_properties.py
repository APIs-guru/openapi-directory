...
class IotHubProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorizationPolicies", "cloudToDevice", "comments", "enableFileUploadNotifications", "eventHubEndpoints", "features", "hostName", "ipFilterRules", "messagingEndpoints", "operationsMonitoringProperties", "provisioningState", "routing", "state", "storageEndpoints"]
