...
class JobResponseListResult(BaseModel):
    """
    The JSON-serialized array of JobResponse objects with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The next link.", alias="nextLink")
    value: Optional[List[JobResponse]] = Field(default=None, description="The array of JobResponse objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [JobResponse.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
