...
class EventHubConsumerGroupsListResult(BaseModel):
    """
    ...
    value: Optional[List[EventHubConsumerGroupInfo]] = Field(default=None, description="List of consumer groups objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EventHubConsumerGroupInfo.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
