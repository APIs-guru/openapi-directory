...
class CertificateBodyDescription(BaseModel):
    """
    The JSON-serialized X509 Certificate.
    """ # noqa: E501
    certificate: Optional[StrictStr] = Field(default=None, description="base-64 representation of the X509 leaf certificate .cer file or just .pem file content.")
