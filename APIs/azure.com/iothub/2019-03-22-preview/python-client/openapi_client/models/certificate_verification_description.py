...
class CertificateVerificationDescription(BaseModel):
    """
    The JSON-serialized leaf certificate
    """ # noqa: E501
    certificate: Optional[StrictStr] = Field(default=None, description="base-64 representation of X509 certificate .cer file or just .pem file content.")
