...
class SharedAccessSignatureAuthorizationRuleListResult(BaseModel):
    ...
    value: Optional[List[SharedAccessSignatureAuthorizationRule]] = Field(default=None, description="The list of shared access policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SharedAccessSignatureAuthorizationRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
