...
class TestRouteResultDetails(BaseModel):
    """
    Detailed result of testing a route
    """ # noqa: E501
    compilation_errors: Optional[List[RouteCompilationError]] = Field(default=None, description="JSON-serialized list of route compilation errors", alias="compilationErrors")
    __properties: ClassVar[List[str]] = ["compilationErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compilationErrors": [RouteCompilationError.from_dict(_item) for _item in obj["compilationErrors"]] if obj.get("compilationErrors") is not None else None
        })
        return _obj
