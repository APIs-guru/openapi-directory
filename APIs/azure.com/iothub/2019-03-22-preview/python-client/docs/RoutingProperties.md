...
**enrichments** | [**List[EnrichmentProperties]**](EnrichmentProperties.md) | The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/iotmsgenrich | [optional] 
