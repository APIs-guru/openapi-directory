...
**storage_containers** | [**List[RoutingStorageContainerProperties]**](RoutingStorageContainerProperties.md) | The list of storage container endpoints that IoT hub routes messages to, based on the routing rules. | [optional] 
