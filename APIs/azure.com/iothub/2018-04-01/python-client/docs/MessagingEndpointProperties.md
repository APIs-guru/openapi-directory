...
------------ | ------------- | ------------- | -------------
**lock_duration_as_iso8601** | **str** | The lock duration. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload. | [optional] 
**max_delivery_count** | **int** | The number of times the IoT hub attempts to deliver a message. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload. | [optional] 
**ttl_as_iso8601** | **str** | The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload. | [optional] 
