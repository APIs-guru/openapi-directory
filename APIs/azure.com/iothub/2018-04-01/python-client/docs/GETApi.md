...
[**iot_hub_resource_get_endpoint_health**](GETApi.md#iot_hub_resource_get_endpoint_health) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{iotHubName}/routingEndpointsHealth | Get the health for routing endpoints
...
[**resource_provider_common_get_subscription_quota**](GETApi.md#resource_provider_common_get_subscription_quota) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Devices/usages | Get the number of iot hubs in the subscription
...
# **iot_hub_resource_get_endpoint_health**
> EndpointHealthDataListResult iot_hub_resource_get_endpoint_health(subscription_id, resource_group_name, iot_hub_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    iot_hub_name = 'iot_hub_name_example' # str | 
    api_version = 'api_version_example' # str | The version of the API.

    try:
        # Get the health for routing endpoints
        api_response = api_instance.iot_hub_resource_get_endpoint_health(subscription_id, resource_group_name, iot_hub_name, api_version)
        print("The response of GETApi->iot_hub_resource_get_endpoint_health:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GETApi->iot_hub_resource_get_endpoint_health: %s\n" % e)
```
...
# **resource_provider_common_get_subscription_quota**
> UserSubscriptionQuotaListResult resource_provider_common_get_subscription_quota(subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the number of iot hubs in the subscription
        api_response = api_instance.resource_provider_common_get_subscription_quota(subscription_id, api_version)
        print("The response of GETApi->resource_provider_common_get_subscription_quota:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GETApi->resource_provider_common_get_subscription_quota: %s\n" % e)
```
