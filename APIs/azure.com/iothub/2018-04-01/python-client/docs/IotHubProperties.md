...
**event_hub_endpoints** | [**Dict[str, EventHubProperties]**](EventHubProperties.md) | The Event Hub-compatible endpoint properties. The possible keys to this dictionary are events and operationsMonitoringEvents. Both of these keys have to be present in the dictionary while making create or update calls for the IoT hub. | [optional] 
...
**operations_monitoring_properties** | [**OperationsMonitoringProperties**](OperationsMonitoringProperties.md) |  | [optional] 
