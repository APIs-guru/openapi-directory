...
class RouteErrorRange(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "end": RouteErrorPosition.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "start": RouteErrorPosition.from_dict(obj["start"]) if obj.get("start") is not None else None
        })
        return _obj
