...
class IotHubProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorizationPolicies", "cloudToDevice", "comments", "enableFileUploadNotifications", "eventHubEndpoints", "features", "hostName", "ipFilterRules", "locations", "messagingEndpoints", "provisioningState", "routing", "state", "storageEndpoints"]
