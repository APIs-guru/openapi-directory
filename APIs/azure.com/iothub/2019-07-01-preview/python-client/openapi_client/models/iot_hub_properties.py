...
class IotHubProperties(BaseModel):
    ...
    comments: Optional[StrictStr] = Field(default=None, description="IoT hub comments.")
    device_streams: Optional[IotHubPropertiesDeviceStreams] = Field(default=None, alias="deviceStreams")
    ...
    event_hub_endpoints: Optional[Dict[str, EventHubProperties]] = Field(default=None, description="The Event Hub-compatible endpoint properties. The only possible keys to this dictionary is events. This key has to be present in the dictionary while making create or update calls for the IoT hub.", alias="eventHubEndpoints")
    ...
    locations: Optional[List[IotHubLocationDescription]] = Field(default=None, description="Primary and secondary location for iot hub")
    ...
    state: Optional[StrictStr] = Field(default=None, description="The hub state.")
    ...
    __properties: ClassVar[List[str]] = ["authorizationPolicies", "cloudToDevice", "comments", "deviceStreams", "enableFileUploadNotifications", "eventHubEndpoints", "features", "hostName", "ipFilterRules", "locations", "messagingEndpoints", "provisioningState", "routing", "state", "storageEndpoints"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of device_streams
        if self.device_streams:
            _dict['deviceStreams'] = self.device_streams.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceStreams": IotHubPropertiesDeviceStreams.from_dict(obj["deviceStreams"]) if obj.get("deviceStreams") is not None else None,
            ...
            "locations": [IotHubLocationDescription.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
