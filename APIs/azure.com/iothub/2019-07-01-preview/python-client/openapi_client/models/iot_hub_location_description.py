...
class IotHubLocationDescription(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Azure Geo Regions")
    role: Optional[StrictStr] = Field(default=None, description="Specific Role assigned to this location")
