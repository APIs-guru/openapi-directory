...
class EndpointHealthDataListResult(BaseModel):
    """
    The JSON-serialized array of EndpointHealthData objects with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to more results", alias="nextLink")
    value: Optional[List[EndpointHealthData]] = Field(default=None, description="JSON-serialized array of Endpoint health data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EndpointHealthData.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
