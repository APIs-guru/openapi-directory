...
class IotHubNameAvailabilityInfo(BaseModel):
    """
    The properties indicating whether a given IoT hub name is available.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The detailed reason message.")
    name_available: Optional[StrictBool] = Field(default=None, description="The value which indicates whether the provided name is available.", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="The reason for unavailability.")
