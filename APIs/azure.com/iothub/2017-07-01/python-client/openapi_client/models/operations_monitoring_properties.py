...
class OperationsMonitoringProperties(BaseModel):
    """
    ...
    def events_validate_enum(cls, value):
        ...
        if value not in set(['None', 'Error', 'Information', 'Error, Information']):
            raise ValueError("must be one of enum values ('None', 'Error', 'Information', 'Error, Information')")
        return value
