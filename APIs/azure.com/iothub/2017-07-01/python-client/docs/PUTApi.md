...
> IotHubDescription iot_hub_resource_create_or_update(api_version, subscription_id, resource_group_name, resource_name, iot_hub_description, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    if_match = 'if_match_example' # str | ETag of the IoT Hub. Do not specify for creating a brand new IoT Hub. Required to update an existing IoT Hub. (optional)

    try:
        # Create or update the metadata of an IoT hub.
        api_response = api_instance.iot_hub_resource_create_or_update(api_version, subscription_id, resource_group_name, resource_name, iot_hub_description, if_match=if_match)
 ...
 **if_match** | **str**| ETag of the IoT Hub. Do not specify for creating a brand new IoT Hub. Required to update an existing IoT Hub. | [optional] 
