...
class FallbackRouteProperties(BaseModel):
    ...
    is_enabled: StrictBool = Field(description="Used to specify whether the fallback route is enabled or not.", alias="isEnabled")
    source: StrictStr = Field(description="The source to which the routing rule is to be applied to. e.g. DeviceMessages")
