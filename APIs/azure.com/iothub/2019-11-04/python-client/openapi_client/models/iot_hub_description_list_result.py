...
class IotHubDescriptionListResult(BaseModel):
    """
    The JSON-serialized array of IotHubDescription objects with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The next link.", alias="nextLink")
    value: Optional[List[IotHubDescription]] = Field(default=None, description="The array of IotHubDescription objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IotHubDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
