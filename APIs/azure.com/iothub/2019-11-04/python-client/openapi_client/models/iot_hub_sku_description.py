...
class IotHubSkuDescription(BaseModel):
    """
    SKU properties.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": IotHubCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "resourceType": obj.get("resourceType"),
            "sku": IotHubSkuInfo.from_dict(obj["sku"]) if obj.get("sku") is not None else None
        })
        return _obj
