...
class PATCHApi:
    ...
    def iot_hub_resource_update(
        ...
        resource_name: Annotated[StrictStr, Field(description="Name of iot hub to update.")],
        api_version: Annotated[StrictStr, Field(description="The version of the API.")],
        iot_hub_tags: Annotated[TagsResource, Field(description="Updated tag information to set into the iot hub instance.")],
        ...
        :type iot_hub_tags: TagsResource
        ...
        _param = self._iot_hub_resource_update_serialize(
    ...
    @validate_call
    def iot_hub_resource_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group identifier.")],
        resource_name: Annotated[StrictStr, Field(description="Name of iot hub to update.")],
    ...
    @validate_call
    def iot_hub_resource_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group identifier.")],
        resource_name: Annotated[StrictStr, Field(description="Name of iot hub to update.")],
    ...
    def _iot_hub_resource_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        resource_name,
        ...
        if iot_hub_tags is not None:
            _body_params = iot_hub_tags
