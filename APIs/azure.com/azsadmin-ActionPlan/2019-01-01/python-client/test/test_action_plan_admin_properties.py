...
class TestActionPlanAdminProperties(unittest.TestCase):
    """ActionPlanAdminProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionPlanAdminProperties:
        """Test ActionPlanAdminProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionPlanAdminProperties`
        """
        model = ActionPlanAdminProperties()
        if include_optional:
            return ActionPlanAdminProperties(
    ...
    def testActionPlanAdminProperties(self):
        """Test ActionPlanAdminProperties"""
