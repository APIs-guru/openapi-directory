...
class ActionPlanResourceEntity(BaseModel):
    """
    Action Plan Resource Entity
    """ # noqa: E501
    e_tag: Optional[StrictStr] = Field(default=None, description="Entity tag of the resource", alias="eTag")
    properties: Optional[ActionPlanAdminProperties] = None
