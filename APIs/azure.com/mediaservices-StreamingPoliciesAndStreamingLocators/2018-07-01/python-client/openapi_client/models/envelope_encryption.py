...
class EnvelopeEncryption(BaseModel):
    ...
    custom_key_acquisition_url_template: Optional[StrictStr] = Field(default=None, description="Template for the URL of the custom service delivering keys to end user players.  Not required when using Azure Media Services for issuing keys.  The template supports replaceable tokens that the service will update at runtime with the value specific to the request.  The currently supported token values are {AlternativeMediaId}, which is replaced with the value of StreamingLocatorId.AlternativeMediaId, and {ContentKeyId}, which is replaced with the value of identifier of the key being requested.", alias="customKeyAcquisitionUrlTemplate")
    enabled_protocols: Optional[EnabledProtocols] = Field(default=None, alias="enabledProtocols")
    __properties: ClassVar[List[str]] = ["clearTracks", "contentKeys", "customKeyAcquisitionUrlTemplate", "enabledProtocols"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customKeyAcquisitionUrlTemplate": obj.get("customKeyAcquisitionUrlTemplate"),
