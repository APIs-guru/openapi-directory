...
class StreamingLocatorsListDefaultResponse(BaseModel):
    """
    The API error.
    """ # noqa: E501
    error: Optional[StreamingLocatorsListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": StreamingLocatorsListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
