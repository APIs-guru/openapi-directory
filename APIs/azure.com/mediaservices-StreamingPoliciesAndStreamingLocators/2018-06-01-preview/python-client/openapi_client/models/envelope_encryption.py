...
class EnvelopeEncryption(BaseModel):
    ...
    custom_key_acquisition_url_template: Optional[StrictStr] = Field(default=None, description="KeyAcquisitionUrlTemplate is used to point to user specified service to delivery content keys", alias="customKeyAcquisitionUrlTemplate")
