...
class TestStreamingLocatorCollection(unittest.TestCase):
    """StreamingLocatorCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingLocatorCollection:
        """Test StreamingLocatorCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingLocatorCollection`
        """
        ...
        if include_optional:
            return StreamingLocatorCollection(
                odata_next_link = '',
                value = [
                    openapi_client.models.streaming_locator.StreamingLocator(
    ...
    def testStreamingLocatorCollection(self):
        """Test StreamingLocatorCollection"""
