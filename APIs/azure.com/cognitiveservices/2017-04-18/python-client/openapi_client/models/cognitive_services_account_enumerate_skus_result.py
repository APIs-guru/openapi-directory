...
class CognitiveServicesAccountEnumerateSkusResult(BaseModel):
    """
    The list of cognitive services accounts operation response.
    """ # noqa: E501
    value: Optional[List[CognitiveServicesResourceAndSku]] = Field(default=None, description="Gets the list of Cognitive Services accounts and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CognitiveServicesResourceAndSku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
