...
class CheckSkuAvailabilityResultList(BaseModel):
    """
    Check SKU availability result list.
    """ # noqa: E501
    value: Optional[List[CheckSkuAvailabilityResult]] = Field(default=None, description="Check SKU availability result list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CheckSkuAvailabilityResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
