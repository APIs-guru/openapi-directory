...
class CheckDomainAvailabilityParameter(BaseModel):
    """
    Check Domain availability parameter.
    """ # noqa: E501
    subdomain_name: StrictStr = Field(description="The subdomain name to use.", alias="subdomainName")
    type: StrictStr = Field(description="The Type of the resource.")
    __properties: ClassVar[List[str]] = ["subdomainName", "type"]
