...
class RestorableDroppedDatabaseListResult(BaseModel):
    """
    The response to a list restorable dropped databases request
    """ # noqa: E501
    value: List[RestorableDroppedDatabase] = Field(description="A list of restorable dropped databases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RestorableDroppedDatabase.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
