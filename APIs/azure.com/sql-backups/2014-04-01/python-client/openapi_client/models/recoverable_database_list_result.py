...
class RecoverableDatabaseListResult(BaseModel):
    """
    The response to a list recoverable databases request
    """ # noqa: E501
    value: List[RecoverableDatabase] = Field(description="A list of recoverable databases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RecoverableDatabase.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
