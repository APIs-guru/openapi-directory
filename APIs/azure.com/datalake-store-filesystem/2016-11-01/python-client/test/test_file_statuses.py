...
class TestFileStatuses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileStatuses:
        """Test FileStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileStatuses`
        """
        model = FileStatuses()
        if include_optional:
            return FileStatuses(
