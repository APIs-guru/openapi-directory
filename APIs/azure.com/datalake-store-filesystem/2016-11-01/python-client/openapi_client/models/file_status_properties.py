...
class FileStatusProperties(BaseModel):
    ...
    acl_bit: Optional[StrictBool] = Field(default=None, description="flag to indicate if extended acls are enabled ", alias="aclBit")
    ...
    ms_expiration_time: Optional[StrictInt] = Field(default=None, description="Gets the expiration time, if any, as ticks since the epoch. If the value is 0 or DateTime.MaxValue there is no expiration.", alias="msExpirationTime")
    ...
    __properties: ClassVar[List[str]] = ["accessTime", "aclBit", "blockSize", "group", "length", "modificationTime", "msExpirationTime", "owner", "pathSuffix", "permission", "type"]
