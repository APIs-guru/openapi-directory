...
class FileStatusesResult(BaseModel):
    """
    Data Lake Store filesystem file status list information response.
    """ # noqa: E501
    file_statuses: Optional[FileStatuses] = Field(default=None, alias="FileStatuses")
    __properties: ClassVar[List[str]] = ["FileStatuses"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of file_statuses
        if self.file_statuses:
            _dict['FileStatuses'] = self.file_statuses.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "FileStatuses": FileStatuses.from_dict(obj["FileStatuses"]) if obj.get("FileStatuses") is not None else None
        })
        return _obj
