...
class ContentSummaryResult(BaseModel):
    ...
    """ # noqa: E501
    content_summary: Optional[ContentSummary] = Field(default=None, alias="ContentSummary")
    __properties: ClassVar[List[str]] = ["ContentSummary"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.content_summary:
            _dict['ContentSummary'] = self.content_summary.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ContentSummary": ContentSummary.from_dict(obj["ContentSummary"]) if obj.get("ContentSummary") is not None else None
        })
        return _obj
