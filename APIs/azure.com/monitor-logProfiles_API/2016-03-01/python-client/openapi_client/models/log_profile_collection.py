...
class LogProfileCollection(BaseModel):
    """
    Represents a collection of log profiles.
    """ # noqa: E501
    value: List[LogProfileResource] = Field(description="the values of the log profiles.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [LogProfileResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
