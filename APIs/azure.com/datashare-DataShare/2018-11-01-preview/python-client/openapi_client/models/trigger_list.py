...
class TriggerList(BaseModel):
    ...
    value: List[Trigger] = Field(description="Collection of items of type DataTransferObjects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Trigger.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
