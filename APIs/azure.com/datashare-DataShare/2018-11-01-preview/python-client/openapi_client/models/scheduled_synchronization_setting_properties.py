...
class ScheduledSynchronizationSettingProperties(BaseModel):
    """
    A Scheduled synchronization setting data transfer object.
    """ # noqa: E501
    created_at: Optional[datetime] = Field(default=None, description="Time at which the synchronization setting was created.", alias="createdAt")
    ...
    user_name: Optional[StrictStr] = Field(default=None, description="Name of the user who created the synchronization setting.", alias="userName")
    __properties: ClassVar[List[str]] = ["createdAt", "provisioningState", "recurrenceInterval", "synchronizationTime", "userName"]
