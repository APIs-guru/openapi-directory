...
class AccountProperties(BaseModel):
    ...
    """ # noqa: E501
    created_at: Optional[datetime] = Field(default=None, description="Time at which the account was created.", alias="createdAt")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of the Account", alias="provisioningState")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "provisioningState", "userEmail", "userName"]
