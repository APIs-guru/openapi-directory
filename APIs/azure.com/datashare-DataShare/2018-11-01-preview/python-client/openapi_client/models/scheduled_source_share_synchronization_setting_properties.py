...
class ScheduledSourceShareSynchronizationSettingProperties(BaseModel):
    """
    A Scheduled source synchronization setting data transfer object.
    """ # noqa: E501
    recurrence_interval: Optional[StrictStr] = Field(default=None, description="Recurrence Interval", alias="recurrenceInterval")
    synchronization_time: Optional[datetime] = Field(default=None, description="Synchronization time", alias="synchronizationTime")
    __properties: ClassVar[List[str]] = ["recurrenceInterval", "synchronizationTime"]
