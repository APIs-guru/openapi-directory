...
class TestInvitationProperties(unittest.TestCase):
    """InvitationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvitationProperties:
        """Test InvitationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvitationProperties`
        """
    ...
    def testInvitationProperties(self):
        """Test InvitationProperties"""
