...
class LogAnalyticsQueryPackQueryListResult(BaseModel):
    """
    Describes the list of Log Analytics QueryPack-Query resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to get the next set of Log Analytics QueryPack definitions if too many QueryPack-Queries where returned in the result set.", alias="nextLink")
    value: List[LogAnalyticsQueryPackQuery] = Field(description="List of Log Analytics QueryPack Query definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LogAnalyticsQueryPackQuery.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
