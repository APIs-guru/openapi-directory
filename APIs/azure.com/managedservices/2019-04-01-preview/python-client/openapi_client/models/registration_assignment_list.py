...
class RegistrationAssignmentList(BaseModel):
    """
    List of registration assignments.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page of registration assignments.", alias="nextLink")
    value: Optional[List[RegistrationAssignment]] = Field(default=None, description="List of registration assignments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RegistrationAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
