...
class RegistrationDefinitionList(BaseModel):
    """
    List of registration definitions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page of registration definitions.", alias="nextLink")
    value: Optional[List[RegistrationDefinition]] = Field(default=None, description="List of registration definitions.")
