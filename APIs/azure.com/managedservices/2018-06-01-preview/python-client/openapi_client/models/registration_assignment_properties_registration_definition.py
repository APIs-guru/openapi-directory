...
class RegistrationAssignmentPropertiesRegistrationDefinition(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of the resource (Microsoft.ManagedServices/registrationDefinitions).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": RegistrationAssignmentPropertiesRegistrationDefinitionProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
