...
class TestRegistrationAssignment(unittest.TestCase):
    """RegistrationAssignment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistrationAssignment:
        """Test RegistrationAssignment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistrationAssignment`
        """
    ...
    def testRegistrationAssignment(self):
        """Test RegistrationAssignment"""
