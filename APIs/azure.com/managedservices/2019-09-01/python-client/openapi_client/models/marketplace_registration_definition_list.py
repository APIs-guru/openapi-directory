...
class MarketplaceRegistrationDefinitionList(BaseModel):
    """
    List of marketplace registration definitions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page of marketplace registration definitions.", alias="nextLink")
    value: Optional[List[RegistrationDefinition]] = Field(default=None, description="List of marketplace registration definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RegistrationDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
