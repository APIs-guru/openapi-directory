...
class RegistrationDefinitionProperties(BaseModel):
    """
    Properties of a registration definition.
    """ # noqa: E501
    authorizations: List[Authorization] = Field(description="Authorization tuple containing principal id of the user/security group or service principal and id of the build-in role.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the registration definition.")
    managed_by_tenant_id: StrictStr = Field(description="Id of the managedBy tenant.", alias="managedByTenantId")
    ...
    __properties: ClassVar[List[str]] = ["authorizations", "description", "managedByTenantId", "managedByTenantName", "provisioningState", "registrationDefinitionName"]
