...
**provider** | **str** | Service provider: Microsoft.ManagedServices | [optional] 
**resource** | **str** | Resource on which the operation is performed: Registration definition, registration assignment etc. | [optional] 
