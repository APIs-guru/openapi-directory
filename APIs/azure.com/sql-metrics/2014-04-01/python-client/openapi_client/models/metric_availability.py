...
class MetricAvailability(BaseModel):
    ...
    """ # noqa: E501
    retention: Optional[StrictStr] = Field(default=None, description="The length of retention for the database metric.")
    time_grain: Optional[StrictStr] = Field(default=None, description="The granularity of the database metric.", alias="timeGrain")
