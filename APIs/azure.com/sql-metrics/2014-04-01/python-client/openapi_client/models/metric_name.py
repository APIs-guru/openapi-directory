...
class MetricName(BaseModel):
    ...
    """ # noqa: E501
    localized_value: Optional[StrictStr] = Field(default=None, description="The friendly name of the database metric.", alias="localizedValue")
    value: Optional[StrictStr] = Field(default=None, description="The name of the database metric.")
