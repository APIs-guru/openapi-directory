...
class MetricDefinition(BaseModel):
    ...
    """ # noqa: E501
    metric_availabilities: Optional[List[MetricAvailability]] = Field(default=None, description="The list of database metric availabilities for the metric.", alias="metricAvailabilities")
    name: Optional[MetricName] = None
    primary_aggregation_type: Optional[StrictStr] = Field(default=None, description="The primary aggregation type defining how metric values are displayed.", alias="primaryAggregationType")
