...
class Category(BaseModel):
    ...
    """ # noqa: E501
    detail: Optional[CategoryDetail] = None
    name: Optional[StrictStr] = Field(default=None, description="Name of the category.")
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Scoring of the category.")
    __properties: ClassVar[List[str]] = ["detail", "name", "score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": CategoryDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
            "name": obj.get("name"),
            "score": obj.get("score")
        })
        return _obj
