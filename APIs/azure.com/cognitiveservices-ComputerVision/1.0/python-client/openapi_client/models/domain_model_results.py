...
class DomainModelResults(BaseModel):
    """
    ...
    result: Optional[Dict[str, Any]] = Field(default=None, description="Model-specific response")
    __properties: ClassVar[List[str]] = ["metadata", "requestId", "result"]
