...
class ListModelsResult(BaseModel):
    ...
    """ # noqa: E501
    models: Optional[List[ModelDescription]] = Field(default=None, description="An array of supported models.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [ModelDescription.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
