...
class ManagedDatabaseRestoreDetailsApi:
    ...
    @validate_call
    def managed_database_restore_details_get(
        self,
        ...
        restore_details_name: Annotated[StrictStr, Field(description="The name of the restore details to retrieve.")],
        ...
        :param restore_details_name: The name of the restore details to retrieve. (required)
        :type restore_details_name: str
        ...
        _param = self._managed_database_restore_details_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagedDatabaseRestoreDetailsResult",
        }
    ...
    @validate_call
    def managed_database_restore_details_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagedDatabaseRestoreDetailsResult]:
        """managed_database_restore_details_get
    ...
    @validate_call
    def managed_database_restore_details_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _managed_database_restore_details_get_serialize(
        self,
        resource_group_name,
        ...
        if restore_details_name is not None:
            _path_params['restoreDetailsName'] = restore_details_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/restoreDetails/{restoreDetailsName}',
