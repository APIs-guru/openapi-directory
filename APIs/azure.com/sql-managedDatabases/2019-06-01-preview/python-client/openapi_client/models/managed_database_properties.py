...
class ManagedDatabaseProperties(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Online', 'Offline', 'Shutdown', 'Creating', 'Inaccessible', 'Restoring', 'Updating']):
            raise ValueError("must be one of enum values ('Online', 'Offline', 'Shutdown', 'Creating', 'Inaccessible', 'Restoring', 'Updating')")
        return value
