...
class ProductsByTagApi:
    ...
    def product_list_by_tags(
        ...
        include_not_tagged_products: Annotated[Optional[StrictBool], Field(description="Include not tagged Products.")] = None,
        ...
        _param = self._product_list_by_tags_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductListByTags200Response",
        }
    ...
    @validate_call
    def product_list_by_tags_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductListByTags200Response]:
        """product_list_by_tags
    ...
    @validate_call
    def product_list_by_tags_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _product_list_by_tags_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
        ...
        if include_not_tagged_products is not None:
            ...
            _query_params.append(('includeNotTaggedProducts', include_not_tagged_products))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/productsByTags',
