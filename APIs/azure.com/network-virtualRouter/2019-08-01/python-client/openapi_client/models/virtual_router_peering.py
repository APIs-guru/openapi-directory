...
class VirtualRouterPeering(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Gets name of the peering unique to VirtualRouter. This name can be used to access the resource.")
    properties: Optional[VirtualRouterPeeringProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Peering type.")
