...
[**virtual_routers_update**](VirtualRoutersApi.md#virtual_routers_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName} | 
...
> VirtualRouter virtual_routers_update(subscription_id, resource_group_name, virtual_router_name, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.VirtualRoutersApi(api_client)
    subscription_id = 'subscription_id_example' # str | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    resource_group_name = 'resource_group_name_example' # str | The resource group name of the Virtual Router.
    virtual_router_name = 'virtual_router_name_example' # str | The name of the Virtual Router being updated.
    api_version = 'api_version_example' # str | Client API version.
    parameters = openapi_client.VirtualRoutersUpdateRequest() # VirtualRoutersUpdateRequest | Parameters supplied to Update Virtual Router Tags.

    try:
        api_response = api_instance.virtual_routers_update(subscription_id, resource_group_name, virtual_router_name, api_version, parameters)
        print("The response of VirtualRoutersApi->virtual_routers_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VirtualRoutersApi->virtual_routers_update: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **subscription_id** | **str**| The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **resource_group_name** | **str**| The resource group name of the Virtual Router. | 
 **virtual_router_name** | **str**| The name of the Virtual Router being updated. | 
 **api_version** | **str**| Client API version. | 
