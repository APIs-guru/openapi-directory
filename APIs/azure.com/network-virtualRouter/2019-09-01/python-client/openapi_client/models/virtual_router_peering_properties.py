...
class VirtualRouterPeeringProperties(BaseModel):
    """
    Properties of the rule group.
    """ # noqa: E501
    peer_asn: Optional[Annotated[int, Field(le=4294967295, strict=True, ge=0)]] = Field(default=None, description="Peer ASN.", alias="peerAsn")
    peer_ip: Optional[StrictStr] = Field(default=None, description="Peer IP.", alias="peerIp")
    ...
    __properties: ClassVar[List[str]] = ["peerAsn", "peerIp", "provisioningState"]
