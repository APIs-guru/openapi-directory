...
class TestVaultListResult(unittest.TestCase):
    """VaultListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VaultListResult:
        """Test VaultListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VaultListResult`
        """
        model = VaultListResult()
        if include_optional:
            return VaultListResult(
                next_link = '',
                value = [
                    openapi_client.models.vault.Vault(
