...
class TestVaultPatchParameters(unittest.TestCase):
    """VaultPatchParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VaultPatchParameters:
        """Test VaultPatchParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VaultPatchParameters`
        """
        model = VaultPatchParameters()
        if include_optional:
            return VaultPatchParameters(
                properties = openapi_client.models.vault_patch_properties.VaultPatchProperties(
                    access_policies = [
    ...
    def testVaultPatchParameters(self):
        """Test VaultPatchParameters"""
