...
class VaultPatchProperties(BaseModel):
    """
    ...
    tenant_id: Optional[StrictStr] = Field(default=None, description="The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.", alias="tenantId")
    __properties: ClassVar[List[str]] = ["accessPolicies", "createMode", "enablePurgeProtection", "enableSoftDelete", "enabledForDeployment", "enabledForDiskEncryption", "enabledForTemplateDeployment", "networkAcls", "sku", "tenantId"]
