...
**enable_soft_delete** | **bool** | Property to specify whether the &#39;soft delete&#39; functionality is enabled for this key vault. If omitted, assume true as default value. Once set to true, cannot be reverted to false. | [optional] 
...
**private_endpoint_connections** | [**List[PrivateEndpointConnectionItem]**](PrivateEndpointConnectionItem.md) | List of private endpoint connections associated with the key vault. | [optional] [readonly] 
**sku** | [**Sku**](Sku.md) |  | 
