...
class PrivateLinkResourcesApi:
    ...
    @validate_call
    def private_link_resources_list_by_vault(
        self,
        ...
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group that contains the key vault.")],
        vault_name: Annotated[str, Field(strict=True, description="The name of the key vault.")],
        ...
        _param = self._private_link_resources_list_by_vault_serialize(
    ...
    @validate_call
    def private_link_resources_list_by_vault_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group that contains the key vault.")],
        vault_name: Annotated[str, Field(strict=True, description="The name of the key vault.")],
    ...
    @validate_call
    def private_link_resources_list_by_vault_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group that contains the key vault.")],
        vault_name: Annotated[str, Field(strict=True, description="The name of the key vault.")],
    ...
    def _private_link_resources_list_by_vault_serialize(
        self,
        subscription_id,
        resource_group_name,
        vault_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/vaults/{vaultName}/privateLinkResources',
