...
class VaultProperties(BaseModel):
    ...
    """ # noqa: E501
    access_policies: Optional[List[AccessPolicyEntry]] = Field(default=None, description="An array of 0 to 16 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID. When `createMode` is set to `recover`, access policies are not required. Otherwise, access policies are required.", alias="accessPolicies")
    ...
    enable_soft_delete: Optional[StrictBool] = Field(default=None, description="Property to specify whether the 'soft delete' functionality is enabled for this key vault. If omitted, assume true as default value. Once set to true, cannot be reverted to false.", alias="enableSoftDelete")
    ...
    private_endpoint_connections: Optional[List[PrivateEndpointConnectionItem]] = Field(default=None, description="List of private endpoint connections associated with the key vault.", alias="privateEndpointConnections")
    sku: Sku
    ...
    __properties: ClassVar[List[str]] = ["accessPolicies", "createMode", "enablePurgeProtection", "enableSoftDelete", "enabledForDeployment", "enabledForDiskEncryption", "enabledForTemplateDeployment", "networkAcls", "privateEndpointConnections", "sku", "tenantId", "vaultUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privateEndpointConnections": [PrivateEndpointConnectionItem.from_dict(_item) for _item in obj["privateEndpointConnections"]] if obj.get("privateEndpointConnections") is not None else None,
