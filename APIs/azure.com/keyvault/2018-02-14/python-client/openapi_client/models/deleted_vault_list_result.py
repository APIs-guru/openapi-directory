...
class DeletedVaultListResult(BaseModel):
    """
    List of vaults
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of deleted vaults.", alias="nextLink")
    value: Optional[List[DeletedVault]] = Field(default=None, description="The list of deleted vaults.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DeletedVault.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
