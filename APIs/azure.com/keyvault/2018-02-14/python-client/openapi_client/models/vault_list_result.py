...
class VaultListResult(BaseModel):
    ...
    List of vaults
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of vaults.", alias="nextLink")
    value: Optional[List[Vault]] = Field(default=None, description="The list of vaults.")
