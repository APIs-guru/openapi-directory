...
class Permissions(BaseModel):
    ...
    def certificates_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['get', 'list', 'delete', 'create', 'import', 'update', 'managecontacts', 'getissuers', 'listissuers', 'setissuers', 'deleteissuers', 'manageissuers', 'recover', 'purge']):
                raise ValueError("each list item must be one of ('get', 'list', 'delete', 'create', 'import', 'update', 'managecontacts', 'getissuers', 'listissuers', 'setissuers', 'deleteissuers', 'manageissuers', 'recover', 'purge')")
        return value
