...
class VaultPatchProperties(BaseModel):
    ...
    enable_purge_protection: Optional[StrictBool] = Field(default=None, description="Property specifying whether protection against purge is enabled for this vault; it is only effective if soft delete is also enabled. Once activated, the property may no longer be reset to false.", alias="enablePurgeProtection")
    enable_soft_delete: Optional[StrictBool] = Field(default=None, description="Property specifying whether recoverable deletion ('soft' delete) is enabled for this key vault. The property may not be set to false.", alias="enableSoftDelete")
    ...
    __properties: ClassVar[List[str]] = ["accessPolicies", "createMode", "enablePurgeProtection", "enableSoftDelete", "enabledForDeployment", "enabledForDiskEncryption", "enabledForTemplateDeployment", "sku", "tenantId"]
