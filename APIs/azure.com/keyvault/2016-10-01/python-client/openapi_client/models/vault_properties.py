...
class VaultProperties(BaseModel):
    ...
    enable_soft_delete: Optional[StrictBool] = Field(default=None, description="Property specifying whether recoverable deletion is enabled for this key vault. Setting this property to true activates the soft delete feature, whereby vaults or vault entities can be recovered after deletion. Enabling this functionality is irreversible - that is, the property does not accept false as its value.", alias="enableSoftDelete")
    ...
    __properties: ClassVar[List[str]] = ["accessPolicies", "createMode", "enablePurgeProtection", "enableSoftDelete", "enabledForDeployment", "enabledForDiskEncryption", "enabledForTemplateDeployment", "sku", "tenantId", "vaultUri"]
