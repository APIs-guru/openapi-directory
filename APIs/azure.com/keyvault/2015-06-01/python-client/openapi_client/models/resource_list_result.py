...
class ResourceListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets the URL to get the next set of vault resources.", alias="nextLink")
    value: Optional[List[Resource]] = Field(default=None, description="Gets the list of vault resources.")
