...
class VaultProperties(BaseModel):
    ...
    """ # noqa: E501
    access_policies: Annotated[List[AccessPolicyEntry], Field(max_length=16)] = Field(description="An array of 0 to 16 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID.", alias="accessPolicies")
    enable_soft_delete: Optional[StrictBool] = Field(default=None, description="Property to specify whether the 'soft delete' functionality is enabled for this key vault.", alias="enableSoftDelete")
    ...
    __properties: ClassVar[List[str]] = ["accessPolicies", "enableSoftDelete", "enabledForDeployment", "enabledForDiskEncryption", "enabledForTemplateDeployment", "sku", "tenantId", "vaultUri"]
