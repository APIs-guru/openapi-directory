...
class VaultListResult(BaseModel):
    ...
    List of vaults
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the URL to get the next set of vaults.", alias="nextLink")
    value: Optional[List[Vault]] = Field(default=None, description="Gets or sets the list of vaults.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Vault.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
