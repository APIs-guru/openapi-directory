...
class TestCertificateIssuerUpdateParameters(unittest.TestCase):
    """CertificateIssuerUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificateIssuerUpdateParameters:
        """Test CertificateIssuerUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificateIssuerUpdateParameters`
        """
        model = CertificateIssuerUpdateParameters()
        if include_optional:
            return CertificateIssuerUpdateParameters(
    ...
    def testCertificateIssuerUpdateParameters(self):
        """Test CertificateIssuerUpdateParameters"""
