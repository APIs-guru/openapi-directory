...
class TestCertificateImportParameters(unittest.TestCase):
    """CertificateImportParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificateImportParameters:
        """Test CertificateImportParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificateImportParameters`
        """
        model = CertificateImportParameters()
        if include_optional:
            return CertificateImportParameters(
    ...
    def testCertificateImportParameters(self):
        """Test CertificateImportParameters"""
