...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The URL to get the next set of keys. | [optional] [readonly] 
**value** | [**List[KeyItem]**](KeyItem.md) | A response message containing a list of keys in the key vault along with a link to the next page of keys. | [optional] [readonly] 
