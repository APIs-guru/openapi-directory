...
json = "{}"
# create an instance of DeletedKeyBundle from a JSON string
deleted_key_bundle_instance = DeletedKeyBundle.from_json(json)
# print the JSON string representation of the object
print(DeletedKeyBundle.to_json())

# convert the object into a dict
deleted_key_bundle_dict = deleted_key_bundle_instance.to_dict()
# create an instance of DeletedKeyBundle from a dict
deleted_key_bundle_from_dict = DeletedKeyBundle.from_dict(deleted_key_bundle_dict)
```
