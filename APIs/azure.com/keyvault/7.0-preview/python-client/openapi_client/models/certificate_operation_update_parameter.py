...
class CertificateOperationUpdateParameter(BaseModel):
    """
    The certificate operation update parameters.
    """ # noqa: E501
    cancellation_requested: StrictBool = Field(description="Indicates if cancellation was requested on the certificate operation.")
    __properties: ClassVar[List[str]] = ["cancellation_requested"]
