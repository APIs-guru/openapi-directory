...
class KeyImportParameters(BaseModel):
    ...
    """ # noqa: E501
    hsm: Optional[StrictBool] = Field(default=None, description="Whether to import as a hardware key (HSM) or software key.", alias="Hsm")
    ...
    __properties: ClassVar[List[str]] = ["Hsm", "attributes", "key", "tags"]
