...
class StorageAccountCreateParameters(BaseModel):
    ...
    """ # noqa: E501
    active_key_name: StrictStr = Field(description="Current active storage account key name.", alias="activeKeyName")
    attributes: Optional[StorageAccountAttributes] = None
    auto_regenerate_key: StrictBool = Field(description="whether keyvault should manage the storage account for the user.", alias="autoRegenerateKey")
    ...
    resource_id: StrictStr = Field(description="Storage account resource id.", alias="resourceId")
    ...
    __properties: ClassVar[List[str]] = ["activeKeyName", "attributes", "autoRegenerateKey", "regenerationPeriod", "resourceId", "tags"]
