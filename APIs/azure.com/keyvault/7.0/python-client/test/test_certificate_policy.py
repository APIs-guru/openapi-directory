...
class TestCertificatePolicy(unittest.TestCase):
    """CertificatePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificatePolicy:
        """Test CertificatePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificatePolicy`
        """
    ...
    def testCertificatePolicy(self):
        """Test CertificatePolicy"""
