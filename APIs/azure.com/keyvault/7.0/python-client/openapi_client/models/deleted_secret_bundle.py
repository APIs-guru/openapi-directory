...
class DeletedSecretBundle(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The secret id.")
    kid: Optional[StrictStr] = Field(default=None, description="If this is a secret backing a KV certificate, then this field specifies the corresponding key backing the KV certificate.")
    managed: Optional[StrictBool] = Field(default=None, description="True if the secret's lifetime is managed by key vault. If this is a secret backing a certificate, then managed will be true.")
    ...
    value: Optional[StrictStr] = Field(default=None, description="The secret value.")
    __properties: ClassVar[List[str]] = ["attributes", "contentType", "id", "kid", "managed", "tags", "value"]
