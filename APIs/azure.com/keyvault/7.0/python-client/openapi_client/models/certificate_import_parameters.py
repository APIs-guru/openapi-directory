...
class CertificateImportParameters(BaseModel):
    """
    The certificate import parameters.
    """ # noqa: E501
    attributes: Optional[CertificateAttributes] = None
    policy: Optional[CertificatePolicy] = None
    pwd: Optional[StrictStr] = Field(default=None, description="If the private key in base64EncodedCertificate is encrypted, the password used for encryption.")
    ...
    value: StrictStr = Field(description="Base64 encoded representation of the certificate object to import. This certificate needs to contain the private key.")
    __properties: ClassVar[List[str]] = ["attributes", "policy", "pwd", "tags", "value"]
