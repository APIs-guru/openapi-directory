...
class SasDefinitionCreateParameters(BaseModel):
    """
    The SAS definition create parameters.
    """ # noqa: E501
    attributes: Optional[SasDefinitionAttributes] = None
    sas_type: StrictStr = Field(description="The type of SAS token the SAS definition will create.", alias="sasType")
    ...
    template_uri: StrictStr = Field(description="The SAS definition token template signed with an arbitrary key.  Tokens created according to the SAS definition will have the same properties as the template.", alias="templateUri")
    validity_period: StrictStr = Field(description="The validity period of SAS tokens created according to the SAS definition.", alias="validityPeriod")
    __properties: ClassVar[List[str]] = ["attributes", "sasType", "tags", "templateUri", "validityPeriod"]
