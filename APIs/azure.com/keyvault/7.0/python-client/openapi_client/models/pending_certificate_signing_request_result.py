...
class PendingCertificateSigningRequestResult(BaseModel):
    """
    The pending certificate signing request result.
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="The pending certificate signing request as Base64 encoded string.")
