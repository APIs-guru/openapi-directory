...
class StorageSystemList(BaseModel):
    """
    ...
    value: Optional[List[StorageSystem]] = Field(default=None, description="List of storage systems.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [StorageSystem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
