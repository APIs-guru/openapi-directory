...
class StorageSystemModel(BaseModel):
    """
    All properties of a storage system.
    """ # noqa: E501
    total_capacity_gb: Optional[StrictInt] = Field(default=None, description="Total capacity of the system.", alias="totalCapacityGB")
    __properties: ClassVar[List[str]] = ["totalCapacityGB"]
