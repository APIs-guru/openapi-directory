# openapi_client.StorageSystemsApi

All URIs are relative to *https://adminmanagement.local.azurestack.external*

Method | HTTP request | Description
------------- | ------------- | -------------
[**storage_systems_get**](StorageSystemsApi.md#storage_systems_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem} | 
[**storage_systems_list**](StorageSystemsApi.md#storage_systems_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems | 


# **storage_systems_get**
> StorageSystem storage_systems_get(subscription_id, resource_group_name, location, storage_sub_system, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.StorageSystemsApi(api_client)
    ...
    try:
        api_response = api_instance.storage_systems_get(subscription_id, resource_group_name, location, storage_sub_system, api_version)
        print("The response of StorageSystemsApi->storage_systems_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StorageSystemsApi->storage_systems_get: %s\n" % e)
```
...
> StorageSystemList storage_systems_list(subscription_id, resource_group_name, location, api_version, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_systems_list(subscription_id, resource_group_name, location, api_version, filter=filter)
        print("The response of StorageSystemsApi->storage_systems_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StorageSystemsApi->storage_systems_list: %s\n" % e)
```
