...
------------ | ------------- | ------------- | -------------
**localized_value** | **str** | Gets a localized string describing the resource name. | [optional] [readonly] 
**value** | **str** | Gets a string describing the resource name. | [optional] [readonly] 
