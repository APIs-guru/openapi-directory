...
class UpdateDataLakeStoreAccountParameters(BaseModel):
    """
    Data Lake Store account information to update.
    """ # noqa: E501
    properties: Optional[UpdateDataLakeStoreAccountProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UpdateDataLakeStoreAccountProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
