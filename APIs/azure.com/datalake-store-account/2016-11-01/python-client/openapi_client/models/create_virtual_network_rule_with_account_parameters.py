...
class CreateVirtualNetworkRuleWithAccountParameters(BaseModel):
    """
    The parameters used to create a new virtual network rule while creating a new Data Lake Store account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the virtual network rule to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": CreateOrUpdateVirtualNetworkRuleProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
