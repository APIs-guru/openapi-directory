...
class CreateDataLakeStoreAccountProperties(BaseModel):
    """
    ...
    firewall_rules: Optional[List[CreateFirewallRuleWithAccountParameters]] = Field(default=None, description="The list of firewall rules associated with this Data Lake Store account.", alias="firewallRules")
    ...
    trusted_id_providers: Optional[List[CreateTrustedIdProviderWithAccountParameters]] = Field(default=None, description="The list of trusted identity providers associated with this Data Lake Store account.", alias="trustedIdProviders")
    virtual_network_rules: Optional[List[CreateVirtualNetworkRuleWithAccountParameters]] = Field(default=None, description="The list of virtual network rules associated with this Data Lake Store account.", alias="virtualNetworkRules")
    __properties: ClassVar[List[str]] = ["defaultGroup", "encryptionConfig", "encryptionState", "firewallAllowAzureIps", "firewallRules", "firewallState", "newTier", "trustedIdProviderState", "trustedIdProviders", "virtualNetworkRules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firewallRules": [CreateFirewallRuleWithAccountParameters.from_dict(_item) for _item in obj["firewallRules"]] if obj.get("firewallRules") is not None else None,
            "firewallState": obj.get("firewallState"),
            "newTier": obj.get("newTier"),
            "trustedIdProviderState": obj.get("trustedIdProviderState"),
            "trustedIdProviders": [CreateTrustedIdProviderWithAccountParameters.from_dict(_item) for _item in obj["trustedIdProviders"]] if obj.get("trustedIdProviders") is not None else None,
            "virtualNetworkRules": [CreateVirtualNetworkRuleWithAccountParameters.from_dict(_item) for _item in obj["virtualNetworkRules"]] if obj.get("virtualNetworkRules") is not None else None
        })
        return _obj
