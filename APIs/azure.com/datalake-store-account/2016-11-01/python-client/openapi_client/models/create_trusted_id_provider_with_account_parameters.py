...
class CreateTrustedIdProviderWithAccountParameters(BaseModel):
    """
    The parameters used to create a new trusted identity provider while creating a new Data Lake Store account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the trusted identity provider to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": CreateOrUpdateTrustedIdProviderProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
