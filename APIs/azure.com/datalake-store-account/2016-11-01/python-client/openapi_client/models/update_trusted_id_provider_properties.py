...
class UpdateTrustedIdProviderProperties(BaseModel):
    """
    The trusted identity provider properties to use when updating a trusted identity provider.
    """ # noqa: E501
    id_provider: Optional[StrictStr] = Field(default=None, description="The URL of this trusted identity provider.", alias="idProvider")
    __properties: ClassVar[List[str]] = ["idProvider"]
