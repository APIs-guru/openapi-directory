...
class UpdateVirtualNetworkRuleProperties(BaseModel):
    """
    The virtual network rule properties to use when updating a virtual network rule.
    """ # noqa: E501
    subnet_id: Optional[StrictStr] = Field(default=None, description="The resource identifier for the subnet.", alias="subnetId")
