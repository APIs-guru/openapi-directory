...
class CreateOrUpdateTrustedIdProviderProperties(BaseModel):
    """
    The trusted identity provider properties to use when creating a new trusted identity provider.
    """ # noqa: E501
    id_provider: StrictStr = Field(description="The URL of this trusted identity provider.", alias="idProvider")
