...
class UpdateVirtualNetworkRuleWithAccountParameters(BaseModel):
    """
    The parameters used to update a virtual network rule while updating a Data Lake Store account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the virtual network rule to update.")
    properties: Optional[UpdateVirtualNetworkRuleProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": UpdateVirtualNetworkRuleProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
