...
class UpdateTrustedIdProviderWithAccountParameters(BaseModel):
    """
    The parameters used to update a trusted identity provider while updating a Data Lake Store account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the trusted identity provider to update.")
    properties: Optional[UpdateTrustedIdProviderProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": UpdateTrustedIdProviderProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
