...
class TestUpdateDataLakeStoreAccountProperties(unittest.TestCase):
    """UpdateDataLakeStoreAccountProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDataLakeStoreAccountProperties:
        """Test UpdateDataLakeStoreAccountProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDataLakeStoreAccountProperties`
        """
        model = UpdateDataLakeStoreAccountProperties()
        if include_optional:
            return UpdateDataLakeStoreAccountProperties(
                default_group = '',
    ...
    def testUpdateDataLakeStoreAccountProperties(self):
        """Test UpdateDataLakeStoreAccountProperties"""
