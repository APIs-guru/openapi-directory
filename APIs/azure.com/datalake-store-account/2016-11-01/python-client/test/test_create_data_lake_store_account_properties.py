...
class TestCreateDataLakeStoreAccountProperties(unittest.TestCase):
    """CreateDataLakeStoreAccountProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDataLakeStoreAccountProperties:
        """Test CreateDataLakeStoreAccountProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDataLakeStoreAccountProperties`
        """
        model = CreateDataLakeStoreAccountProperties()
        if include_optional:
            return CreateDataLakeStoreAccountProperties(
                default_group = '',
    ...
    def testCreateDataLakeStoreAccountProperties(self):
        """Test CreateDataLakeStoreAccountProperties"""
