...
class ResourceSkusListSkus200Response(BaseModel):
    """
    The DMS List SKUs operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of DMS SKUs. Call ListNext() with this to fetch the next page of DMS SKUs.", alias="nextLink")
    value: List[ResourceSkusListSkus200ResponseValueInner] = Field(description="The list of SKUs available for the subscription.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceSkusListSkus200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
