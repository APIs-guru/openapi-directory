...
class ResourceSkusListSkus200ResponseValueInnerRestrictionsInner(BaseModel):
    """
    Describes scaling information of a SKU.
    """ # noqa: E501
    reason_code: Optional[StrictStr] = Field(default=None, description="The reason code for restriction.", alias="reasonCode")
