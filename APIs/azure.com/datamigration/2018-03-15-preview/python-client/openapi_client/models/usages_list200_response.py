...
class UsagesList200Response(BaseModel):
    """
    OData page of quota objects
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to load the next page of quotas, or null or missing if this is the last page", alias="nextLink")
    value: Optional[List[UsagesList200ResponseValueInner]] = Field(default=None, description="List of quotas")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UsagesList200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
