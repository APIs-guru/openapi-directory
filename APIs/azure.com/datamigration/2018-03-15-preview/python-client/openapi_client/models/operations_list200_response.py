...
class OperationsList200Response(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to load the next page of actions", alias="nextLink")
    value: Optional[List[OperationsList200ResponseValueInner]] = Field(default=None, description="List of actions")
