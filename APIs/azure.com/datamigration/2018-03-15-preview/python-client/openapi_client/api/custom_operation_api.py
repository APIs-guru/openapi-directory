...
class CustomOperationApi:
    ...
    @validate_call
    def services_check_children_name_availability(
        self,
        ...
        _param = self._services_check_children_name_availability_serialize(
    ...
    @validate_call
    def services_check_children_name_availability_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        api_version: Annotated[StrictStr, Field(description="Version of the API")],
    ...
    @validate_call
    def services_check_children_name_availability_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        api_version: Annotated[StrictStr, Field(description="Version of the API")],
    ...
    def _services_check_children_name_availability_serialize(
        self,
        subscription_id,
        group_name,
        api_version,
    ...
    def services_check_status_0(
        ...
        _param = self._services_check_status_0_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
            api_version=api_version,
    ...
    @validate_call
    def services_check_status_0_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def services_check_status_0_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    def _services_check_status_0_serialize(
        self,
        subscription_id,
        group_name,
        service_name,
    ...
    def services_start_0(
        ...
        _param = self._services_start_0_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
            api_version=api_version,
    ...
    @validate_call
    def services_start_0_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def services_start_0_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    def _services_start_0_serialize(
        self,
        subscription_id,
        group_name,
        service_name,
    ...
    def services_stop_0(
        ...
        _param = self._services_stop_0_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
            api_version=api_version,
    ...
    @validate_call
    def services_stop_0_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def services_stop_0_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    def _services_stop_0_serialize(
        self,
        subscription_id,
        group_name,
        service_name,
    ...
    def tasks_cancel_0(
        ...
        _param = self._tasks_cancel_0_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
    ...
    @validate_call
    def tasks_cancel_0_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def tasks_cancel_0_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
