...
class TestResourceSkusListSkus200ResponseValueInner(unittest.TestCase):
    """ResourceSkusListSkus200ResponseValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceSkusListSkus200ResponseValueInner:
        """Test ResourceSkusListSkus200ResponseValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceSkusListSkus200ResponseValueInner`
        """
        model = ResourceSkusListSkus200ResponseValueInner()
        if include_optional:
            return ResourceSkusListSkus200ResponseValueInner(
                api_versions = [
                    ''
                    ],
                capabilities = [
    ...
    def testResourceSkusListSkus200ResponseValueInner(self):
        """Test ResourceSkusListSkus200ResponseValueInner"""
