...
class ServicesGet200Response(BaseModel):
    """
    A Data Migration Service resource
    """ # noqa: E501
    etag: Optional[StrictStr] = Field(default=None, description="HTTP strong entity tag value. Ignored if submitted")
    kind: Optional[StrictStr] = Field(default=None, description="The resource kind. Only 'vm' (the default) is supported.")
    properties: Optional[ServicesList200ResponseValueInnerProperties] = None
    sku: Optional[ServicesList200ResponseValueInnerSku] = None
