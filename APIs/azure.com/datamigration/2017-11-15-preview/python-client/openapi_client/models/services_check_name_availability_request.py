...
class ServicesCheckNameAvailabilityRequest(BaseModel):
    """
    A resource type and proposed name
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The proposed resource name")
    type: Optional[StrictStr] = Field(default=None, description="The resource type chain (e.g. virtualMachines/extensions)")
