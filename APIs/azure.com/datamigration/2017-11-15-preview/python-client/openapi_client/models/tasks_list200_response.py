...
class TasksList200Response(BaseModel):
    ...
    OData page of tasks
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to load the next page of tasks", alias="nextLink")
    value: Optional[List[TasksList200ResponseValueInner]] = Field(default=None, description="List of tasks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [TasksList200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
