...
class ServicesListSkus200Response(BaseModel):
    """
    OData page of available SKUs
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to load the next page of service SKUs", alias="nextLink")
    value: Optional[List[ServicesListSkus200ResponseValueInner]] = Field(default=None, description="List of service SKUs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ServicesListSkus200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
