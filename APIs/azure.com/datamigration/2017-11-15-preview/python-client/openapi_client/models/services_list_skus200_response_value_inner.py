...
class ServicesListSkus200ResponseValueInner(BaseModel):
    """
    Describes the available service SKU.
    """ # noqa: E501
    capacity: Optional[ServicesListSkus200ResponseValueInnerCapacity] = None
    resource_type: Optional[StrictStr] = Field(default=None, description="The resource type, including the provider namespace", alias="resourceType")
    sku: Optional[ServicesListSkus200ResponseValueInnerSku] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": ServicesListSkus200ResponseValueInnerCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "resourceType": obj.get("resourceType"),
            "sku": ServicesListSkus200ResponseValueInnerSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None
        })
        return _obj
