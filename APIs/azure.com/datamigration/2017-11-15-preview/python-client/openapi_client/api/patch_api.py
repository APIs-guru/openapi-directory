...
class PATCHApi:
    ...
    def projects_update_1(
        ...
        _param = self._projects_update_1_serialize(
    ...
    @validate_call
    def projects_update_1_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def projects_update_1_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    def _projects_update_1_serialize(
        self,
        subscription_id,
        group_name,
        service_name,
    ...
    def services_update_1(
        ...
        _param = self._services_update_1_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
            api_version=api_version,
    ...
    @validate_call
    def services_update_1_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def services_update_1_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    def _services_update_1_serialize(
        self,
        subscription_id,
        group_name,
        service_name,
    ...
    def tasks_update_1(
        ...
        _param = self._tasks_update_1_serialize(
            subscription_id=subscription_id,
            group_name=group_name,
            service_name=service_name,
            project_name=project_name,
    ...
    @validate_call
    def tasks_update_1_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
    ...
    @validate_call
    def tasks_update_1_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Identifier of the subscription")],
        group_name: Annotated[StrictStr, Field(description="Name of the resource group")],
        service_name: Annotated[StrictStr, Field(description="Name of the service")],
