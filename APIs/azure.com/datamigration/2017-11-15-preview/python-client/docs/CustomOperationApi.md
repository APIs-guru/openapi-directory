# openapi_client.CustomOperationApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**services_check_children_name_availability**](CustomOperationApi.md#services_check_children_name_availability) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/checkNameAvailability | Check nested resource name validity and availability
[**services_check_status_0**](CustomOperationApi.md#services_check_status_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/checkStatus | Check service health status
[**services_start_0**](CustomOperationApi.md#services_start_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/start | Start service
[**services_stop_0**](CustomOperationApi.md#services_stop_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/stop | Stop service
[**tasks_cancel_0**](CustomOperationApi.md#tasks_cancel_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/projects/{projectName}/tasks/{taskName}/cancel | Cancel a task


# **services_check_children_name_availability**
> ServicesCheckNameAvailability200Response services_check_children_name_availability(subscription_id, group_name, api_version, service_name, parameters)
...
# **services_check_status_0**
> ServicesCheckStatus200Response services_check_status_0(subscription_id, group_name, service_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Check service health status
        api_response = api_instance.services_check_status_0(subscription_id, group_name, service_name, api_version)
        print("The response of CustomOperationApi->services_check_status_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomOperationApi->services_check_status_0: %s\n" % e)
```
...
# **services_start_0**
> services_start_0(subscription_id, group_name, service_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Start service
        api_instance.services_start_0(subscription_id, group_name, service_name, api_version)
    except Exception as e:
        print("Exception when calling CustomOperationApi->services_start_0: %s\n" % e)
```
...
# **services_stop_0**
> services_stop_0(subscription_id, group_name, service_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Stop service
        api_instance.services_stop_0(subscription_id, group_name, service_name, api_version)
    except Exception as e:
        print("Exception when calling CustomOperationApi->services_stop_0: %s\n" % e)
```
...
# **tasks_cancel_0**
> TasksGet200Response tasks_cancel_0(subscription_id, group_name, service_name, project_name, task_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Cancel a task
        api_response = api_instance.tasks_cancel_0(subscription_id, group_name, service_name, project_name, task_name, api_version)
        print("The response of CustomOperationApi->tasks_cancel_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomOperationApi->tasks_cancel_0: %s\n" % e)
```
