...
class SyncAgentLinkedDatabaseListResult(BaseModel):
    """
    ...
    value: Optional[List[SyncAgentLinkedDatabase]] = Field(default=None, description="Array of results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SyncAgentLinkedDatabase.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
