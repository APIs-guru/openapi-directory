...
class ProxyApi:
    ...
    def operations_list(
        self,
        api_version: Annotated[str, Field(min_length=10, strict=True, description="The version of the API.")],
    ...
    def _operations_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.HealthcareApis/operations',
    ...
    def services_check_name_availability(
        ...
        check_name_availability_inputs: Annotated[CheckNameAvailabilityParameters, Field(description="Set the name parameter in the CheckNameAvailabilityParameters structure to the name of the service instance to check.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_name_availability_inputs: Set the name parameter in the CheckNameAvailabilityParameters structure to the name of the service instance to check. (required)
        :type check_name_availability_inputs: CheckNameAvailabilityParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._services_check_name_availability_serialize(
            ...
            check_name_availability_inputs=check_name_availability_inputs,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ServicesNameAvailabilityInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def services_check_name_availability_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServicesNameAvailabilityInfo]:
        """services_check_name_availability
    ...
    def _services_check_name_availability_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if check_name_availability_inputs is not None:
            _body_params = check_name_availability_inputs
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.HealthcareApis/checkNameAvailability',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
