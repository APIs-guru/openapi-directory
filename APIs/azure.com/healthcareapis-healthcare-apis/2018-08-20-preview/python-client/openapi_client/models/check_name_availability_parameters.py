...
class CheckNameAvailabilityParameters(BaseModel):
    ...
    Input values.
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the service instance to check.")
    type: StrictStr = Field(description="The fully qualified resource type which includes provider namespace.")
