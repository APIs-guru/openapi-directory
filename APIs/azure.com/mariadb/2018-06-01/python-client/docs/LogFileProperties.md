...
------------ | ------------- | ------------- | -------------
**created_time** | **datetime** | Creation timestamp of the log file. | [optional] [readonly] 
**last_modified_time** | **datetime** | Last modified timestamp of the log file. | [optional] [readonly] 
**size_in_kb** | **int** | Size of the log file. | [optional] 
**type** | **str** | Type of the log file. | [optional] 
**url** | **str** | The url to download the log file from. | [optional] [readonly] 
