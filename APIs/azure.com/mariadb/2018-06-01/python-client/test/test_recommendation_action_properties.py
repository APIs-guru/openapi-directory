...
class TestRecommendationActionProperties(unittest.TestCase):
    """RecommendationActionProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendationActionProperties:
        """Test RecommendationActionProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendationActionProperties`
        """
        model = RecommendationActionProperties()
        if include_optional:
            return RecommendationActionProperties(
                action_id = 56,
                advisor_name = '',
    ...
    def testRecommendationActionProperties(self):
        """Test RecommendationActionProperties"""
