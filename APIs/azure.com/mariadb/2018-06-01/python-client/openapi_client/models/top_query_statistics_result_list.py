...
class TopQueryStatisticsResultList(BaseModel):
    """
    ...
    value: Optional[List[QueryStatistic]] = Field(default=None, description="The list of top query statistics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [QueryStatistic.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
