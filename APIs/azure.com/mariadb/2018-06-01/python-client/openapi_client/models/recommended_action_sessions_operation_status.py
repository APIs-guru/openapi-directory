...
class RecommendedActionSessionsOperationStatus(BaseModel):
    """
    Recommendation action session operation status.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Operation identifier.")
    start_time: Optional[datetime] = Field(default=None, description="Operation start time.", alias="startTime")
    status: Optional[StrictStr] = Field(default=None, description="Operation status.")
    __properties: ClassVar[List[str]] = ["name", "startTime", "status"]
