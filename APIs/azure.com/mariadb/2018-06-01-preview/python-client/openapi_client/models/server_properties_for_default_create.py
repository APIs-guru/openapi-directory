...
class ServerPropertiesForDefaultCreate(ServerPropertiesForCreate):
    ...
    """ # noqa: E501
    administrator_login: StrictStr = Field(description="The administrator's login name of a server. Can only be specified when the server is being created (and is required for creation).", alias="administratorLogin")
    administrator_login_password: SecretStr = Field(description="The password of the administrator login.", alias="administratorLoginPassword")
