...
class LocationBasedPerformanceTierApi:
    ...
    @validate_call
    def location_based_performance_tier_list(
        self,
        ...
        _param = self._location_based_performance_tier_list_serialize(
    ...
    @validate_call
    def location_based_performance_tier_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        location_name: Annotated[StrictStr, Field(description="The name of the location.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PerformanceTierListResult]:
        """location_based_performance_tier_list
    ...
    @validate_call
    def location_based_performance_tier_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        location_name: Annotated[StrictStr, Field(description="The name of the location.")],
    ...
    def _location_based_performance_tier_list_serialize(
        self,
        api_version,
        subscription_id,
        location_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/locations/{locationName}/performanceTiers',
