...
class TestGalleryImageUpdate(unittest.TestCase):
    """GalleryImageUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GalleryImageUpdate:
        """Test GalleryImageUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GalleryImageUpdate`
        """
        model = GalleryImageUpdate()
        if include_optional:
    ...
    def testGalleryImageUpdate(self):
        """Test GalleryImageUpdate"""
