...
class ResourceRange(BaseModel):
    ...
    """ # noqa: E501
    max: Optional[StrictInt] = Field(default=None, description="The maximum number of the resource.")
    min: Optional[StrictInt] = Field(default=None, description="The minimum number of the resource.")
