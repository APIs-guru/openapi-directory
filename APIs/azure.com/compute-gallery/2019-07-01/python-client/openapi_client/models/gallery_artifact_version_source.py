...
class GalleryArtifactVersionSource(BaseModel):
    """
    The gallery artifact version source.
    """ # noqa: E501
    id: StrictStr = Field(description="The id of the gallery artifact version source. Can specify a disk uri, snapshot uri, or user image.")
