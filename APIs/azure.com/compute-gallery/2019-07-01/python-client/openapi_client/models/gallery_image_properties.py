...
class GalleryImageProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "disallowed", "endOfLifeDate", "eula", "hyperVGeneration", "identifier", "osState", "osType", "privacyStatementUri", "provisioningState", "purchasePlan", "recommended", "releaseNoteUri"]
