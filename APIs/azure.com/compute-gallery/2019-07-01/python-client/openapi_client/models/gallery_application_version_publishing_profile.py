...
class GalleryApplicationVersionPublishingProfile(BaseModel):
    """
    The publishing profile of a gallery Image Version.
    """ # noqa: E501
    content_type: Optional[StrictStr] = Field(default=None, description="Optional. May be used to help process this file. The type of file contained in the source, e.g. zip, json, etc.", alias="contentType")
    enable_health_check: Optional[StrictBool] = Field(default=None, description="Optional. Whether or not this application reports health.", alias="enableHealthCheck")
