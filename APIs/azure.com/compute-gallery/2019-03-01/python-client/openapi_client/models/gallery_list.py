...
class GalleryList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of galleries. Call ListNext() with this to fetch the next page of galleries.", alias="nextLink")
    value: List[Gallery] = Field(description="A list of galleries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Gallery.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
