...
class TargetRegion(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the region.")
    regional_replica_count: Optional[StrictInt] = Field(default=None, description="The number of replicas of the Image Version to be created per region. This property is updatable.", alias="regionalReplicaCount")
    ...
    __properties: ClassVar[List[str]] = ["name", "regionalReplicaCount", "storageAccountType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "regionalReplicaCount": obj.get("regionalReplicaCount"),
