...
class IotDpsSkuDefinitionListResult(BaseModel):
    """
    List of available SKUs.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The next link.", alias="nextLink")
    value: Optional[List[IotDpsSkuDefinition]] = Field(default=None, description="The list of SKU's")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IotDpsSkuDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
