...
class POSTApi:
    ...
    def dps_certificate_verify_certificate(
        ...
        api_version: Annotated[StrictStr, Field(description="The version of the API.")],
        request: Annotated[VerificationCodeRequest, Field(description="The name of the certificate")],
        certificate_name2: Annotated[Optional[StrictStr], Field(description="Common Name for the certificate.")] = None,
        certificate_raw_bytes: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="Raw data of certificate.")] = None,
        certificate_is_verified: Annotated[Optional[StrictBool], Field(description="Indicates if the certificate has been verified by owner of the private key.")] = None,
    ...
    @validate_call
    def iot_dps_resource_check_provisioning_service_name_availability(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        api_version: Annotated[StrictStr, Field(description="The version of the API.")],
        ...
        _param = self._iot_dps_resource_check_provisioning_service_name_availability_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            arguments=arguments,
            _request_auth=_request_auth,
    ...
    @validate_call
    def iot_dps_resource_check_provisioning_service_name_availability_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        api_version: Annotated[StrictStr, Field(description="The version of the API.")],
        arguments: Annotated[OperationInputs, Field(description="Set the name parameter in the OperationInputs structure to the name of the provisioning service to check.")],
    ...
    @validate_call
    def iot_dps_resource_check_provisioning_service_name_availability_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        api_version: Annotated[StrictStr, Field(description="The version of the API.")],
        arguments: Annotated[OperationInputs, Field(description="Set the name parameter in the OperationInputs structure to the name of the provisioning service to check.")],
    ...
    def _iot_dps_resource_check_provisioning_service_name_availability_serialize(
        self,
        subscription_id,
        api_version,
        arguments,
    ...
    @validate_call
    def iot_dps_resource_list_keys_for_key_name(
        self,
        ...
        _param = self._iot_dps_resource_list_keys_for_key_name_serialize(
            provisioning_service_name=provisioning_service_name,
            key_name=key_name,
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
    ...
    @validate_call
    def iot_dps_resource_list_keys_for_key_name_with_http_info(
        self,
        provisioning_service_name: Annotated[StrictStr, Field(description="Name of the provisioning service.")],
        key_name: Annotated[StrictStr, Field(description="Logical key name to get key-values for.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
    ...
    @validate_call
    def iot_dps_resource_list_keys_for_key_name_without_preload_content(
        self,
        provisioning_service_name: Annotated[StrictStr, Field(description="Name of the provisioning service.")],
        key_name: Annotated[StrictStr, Field(description="Logical key name to get key-values for.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
    ...
    def _iot_dps_resource_list_keys_for_key_name_serialize(
        self,
        provisioning_service_name,
        key_name,
        subscription_id,
