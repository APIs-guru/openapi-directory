...
class SlbMuxInstanceList(BaseModel):
    """
    ...
    value: Optional[List[SlbMuxInstance]] = Field(default=None, description="List of SLB MUX instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SlbMuxInstance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
