...
class MonetaryCredit(OfferTermInfo):
    ...
    """ # noqa: E501
    credit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of credit provided under the terms of the given offer level.", alias="Credit")
    excluded_meter_ids: Optional[List[StrictStr]] = Field(default=None, description="An array of meter ids that are excluded from the given offer terms.", alias="ExcludedMeterIds")
