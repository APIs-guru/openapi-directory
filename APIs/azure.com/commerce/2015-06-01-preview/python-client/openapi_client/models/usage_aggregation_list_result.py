...
class UsageAggregationListResult(BaseModel):
    """
    The Get UsageAggregates operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the link to the next set of results.", alias="nextLink")
    value: Optional[List[UsageAggregation]] = Field(default=None, description="Gets or sets details for the requested aggregation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UsageAggregation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
