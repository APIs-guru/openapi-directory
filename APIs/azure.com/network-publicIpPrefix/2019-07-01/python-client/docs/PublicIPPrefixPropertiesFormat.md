...
**ip_tags** | [**List[PublicIPPrefixPropertiesFormatIpTagsInner]**](PublicIPPrefixPropertiesFormatIpTagsInner.md) | The list of tags associated with the public IP prefix. | [optional] 
...
**public_ip_address_version** | **str** | IP address version. | [optional] 
