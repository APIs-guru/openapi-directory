...
class PublicIPPrefixListResult(BaseModel):
    """
    ...
    value: Optional[List[PublicIPPrefix]] = Field(default=None, description="A list of public IP prefixes that exists in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PublicIPPrefix.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
