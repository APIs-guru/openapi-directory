...
[**application_definitions_create_or_update_by_id**](ApplicationDefinitionsApi.md#application_definitions_create_or_update_by_id) | **PUT** /{applicationDefinitionId} | 
...
[**application_definitions_delete_by_id**](ApplicationDefinitionsApi.md#application_definitions_delete_by_id) | **DELETE** /{applicationDefinitionId} | 
...
[**application_definitions_get_by_id**](ApplicationDefinitionsApi.md#application_definitions_get_by_id) | **GET** /{applicationDefinitionId} | 
...
> ApplicationDefinition application_definitions_create_or_update_by_id(application_definition_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ApplicationDefinitionsApi(api_client)
    application_definition_id = 'application_definition_id_example' # str | The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applicationDefinitions/{applicationDefinition-name}
    api_version = 'api_version_example' # str | The API version to use for this operation.
    parameters = openapi_client.ApplicationDefinition() # ApplicationDefinition | Parameters supplied to the create or update a managed application definition.

    try:
        api_response = api_instance.application_definitions_create_or_update_by_id(application_definition_id, api_version, parameters)
        print("The response of ApplicationDefinitionsApi->application_definitions_create_or_update_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApplicationDefinitionsApi->application_definitions_create_or_update_by_id: %s\n" % e)
```
...
> application_definitions_delete_by_id(application_definition_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.application_definitions_delete_by_id(application_definition_id, api_version)
    except Exception as e:
        print("Exception when calling ApplicationDefinitionsApi->application_definitions_delete_by_id: %s\n" % e)
```
...
> ApplicationDefinition application_definitions_get_by_id(application_definition_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.application_definitions_get_by_id(application_definition_id, api_version)
        print("The response of ApplicationDefinitionsApi->application_definitions_get_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApplicationDefinitionsApi->application_definitions_get_by_id: %s\n" % e)
```
