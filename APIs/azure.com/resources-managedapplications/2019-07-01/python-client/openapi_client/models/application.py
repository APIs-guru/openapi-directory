...
class Application(BaseModel):
    ...
    kind: Annotated[str, Field(strict=True)] = Field(description="The kind of the managed application. Allowed values are MarketPlace and ServiceCatalog.")
    ...
    __properties: ClassVar[List[str]] = ["managedBy", "sku", "id", "location", "name", "tags", "type"]
