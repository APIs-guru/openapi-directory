...
[**applications_refresh_permissions**](ApplicationsApi.md#applications_refresh_permissions) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/refreshPermissions | 
...
> applications_refresh_permissions(resource_group_name, application_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.applications_refresh_permissions(resource_group_name, application_name, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling ApplicationsApi->applications_refresh_permissions: %s\n" % e)
```
