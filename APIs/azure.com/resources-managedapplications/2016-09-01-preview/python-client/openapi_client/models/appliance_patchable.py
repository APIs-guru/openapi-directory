...
class AppliancePatchable(BaseModel):
    """
    Information about appliance.
    """ # noqa: E501
    kind: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The kind of the appliance. Allowed values are MarketPlace and ServiceCatalog.")
    plan: Optional[PlanPatchable] = None
    properties: Optional[AppliancePropertiesPatchable] = None
