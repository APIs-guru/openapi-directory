...
class ApplianceListResult(BaseModel):
    """
    List of appliances.
    """ # noqa: E501
    ...
    value: Optional[List[Appliance]] = Field(default=None, description="The array of appliances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Appliance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
