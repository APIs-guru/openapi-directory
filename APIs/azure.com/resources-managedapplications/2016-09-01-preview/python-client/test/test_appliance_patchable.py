...
class TestAppliancePatchable(unittest.TestCase):
    """AppliancePatchable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliancePatchable:
        """Test AppliancePatchable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliancePatchable`
        """
        model = AppliancePatchable()
        if include_optional:
            return AppliancePatchable(
                kind = 'g',
                plan = openapi_client.models.plan_patchable.PlanPatchable(
                    ...
                    publisher = '', 
                    version = '', ),
                properties = openapi_client.models.appliance_properties_patchable.AppliancePropertiesPatchable(
    ...
    def testAppliancePatchable(self):
        """Test AppliancePatchable"""
