...
class LocationBasedRecommendedActionSessionsResultApi:
    ...
    @validate_call
    def location_based_recommended_action_sessions_result_list(
        self,
        ...
        _param = self._location_based_recommended_action_sessions_result_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RecommendationActionsResultList",
            '201': "RecommendationActionsResultList",
        }
    ...
    @validate_call
    def location_based_recommended_action_sessions_result_list_with_http_info(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        location_name: Annotated[StrictStr, Field(description="The name of the location.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RecommendationActionsResultList]:
        """location_based_recommended_action_sessions_result_list
    ...
    @validate_call
    def location_based_recommended_action_sessions_result_list_without_preload_content(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        location_name: Annotated[StrictStr, Field(description="The name of the location.")],
    ...
    def _location_based_recommended_action_sessions_result_list_serialize(
        self,
        api_version,
        subscription_id,
        location_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/locations/{locationName}/recommendedActionSessionsOperationResults/{operationId}',
