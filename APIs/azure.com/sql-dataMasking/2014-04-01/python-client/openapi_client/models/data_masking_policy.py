...
class DataMaskingPolicy(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="The kind of data masking policy. Metadata, used for Azure portal.")
    location: Optional[StrictStr] = Field(default=None, description="The location of the data masking policy.")
    properties: Optional[DataMaskingPolicyProperties] = None
