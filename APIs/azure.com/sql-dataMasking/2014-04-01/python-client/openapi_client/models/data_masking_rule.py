...
class DataMaskingRule(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="The kind of Data Masking Rule. Metadata, used for Azure portal.")
    location: Optional[StrictStr] = Field(default=None, description="The location of the data masking rule.")
    properties: Optional[DataMaskingRuleProperties] = None
