...
class DataMaskingRuleListResult(BaseModel):
    """
    The response to a list data masking rules request.
    """ # noqa: E501
    value: Optional[List[DataMaskingRule]] = Field(default=None, description="The list of database data masking rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DataMaskingRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
