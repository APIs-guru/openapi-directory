...
class ErrorAdditionalInfoInfo(BaseModel):
    """
    ErrorAdditionalInfoInfo
    """ # noqa: E501
    current_status: Optional[LockboxRequestStatus] = Field(default=None, alias="currentStatus")
    __properties: ClassVar[List[str]] = ["currentStatus"]
