...
class ErrorAdditionalInfo(BaseModel):
    ...
    """ # noqa: E501
    info: Optional[ErrorAdditionalInfoInfo] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of error info.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "info": ErrorAdditionalInfoInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "type": obj.get("type")
        })
        return _obj
