...
class RequestListResult(BaseModel):
    ...
    value: Optional[List[LockboxRequestResponse]] = Field(default=None, description="A list of Lockbox requests. Populated by a 'List' operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LockboxRequestResponse.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
