...
**is_data_action** | **str** | Gets or sets a value indicating whether it is a data plane action | [optional] [readonly] 
**name** | **str** | Gets or sets action name | [optional] [readonly] 
**origin** | **str** | Gets or sets origin | [optional] [readonly] 
**properties** | **str** | Gets or sets properties | [optional] [readonly] 
