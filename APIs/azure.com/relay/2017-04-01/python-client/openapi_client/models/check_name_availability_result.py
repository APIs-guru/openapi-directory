...
class CheckNameAvailabilityResult(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The detailed info regarding the reason associated with the namespace.")
    name_available: Optional[StrictBool] = Field(default=None, description="Value indicating namespace is available. Returns true if the namespace is available; otherwise, false.", alias="nameAvailable")
