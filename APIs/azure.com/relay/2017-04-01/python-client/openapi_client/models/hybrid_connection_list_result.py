...
class HybridConnectionListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next set of results. Not empty if value contains incomplete list hybrid connection operation.", alias="nextLink")
    value: Optional[List[HybridConnection]] = Field(default=None, description="Result of the list hybrid connections.")
