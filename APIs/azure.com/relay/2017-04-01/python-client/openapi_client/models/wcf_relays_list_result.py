...
class WcfRelaysListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next set of results. Not empty if value contains incomplete list of WCF relays.", alias="nextLink")
    value: Optional[List[WcfRelay]] = Field(default=None, description="Result of the list WCF relay operation.")
