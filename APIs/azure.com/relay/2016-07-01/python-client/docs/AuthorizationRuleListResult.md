...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Link to the next set of results. Not empty if Value contains incomplete list of AuthorizationRules | [optional] 
**value** | [**List[AuthorizationRule]**](AuthorizationRule.md) | Result of the List AuthorizationRules operation. | [optional] 
