...
Result of the request to list EventHub operations. It contains a list of operations and a URL link to get the next set of results.
...
**value** | [**List[Operation]**](Operation.md) | List of EventHub operations supported by the Microsoft.EventHub resource provider. | [optional] [readonly] 
