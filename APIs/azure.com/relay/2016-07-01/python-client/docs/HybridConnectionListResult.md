...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Link to the next set of results. Not empty if Value contains incomplete list of HybridConnection operation | [optional] 
**value** | [**List[HybridConnection]**](HybridConnection.md) | Result of the List HybridConnection . | [optional] 
