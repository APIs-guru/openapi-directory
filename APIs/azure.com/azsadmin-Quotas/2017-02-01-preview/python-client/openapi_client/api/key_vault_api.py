...
class KeyVaultApi:
    ...
    def quotas_list(
        ...
        location: Annotated[StrictStr, Field(description="The location of the quota.")],
        ...
        :param location: The location of the quota. (required)
        :type location: str
    ...
    def _quotas_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.KeyVault.Admin/locations/{location}/quotas',
