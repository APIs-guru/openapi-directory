...
class QuotaProperties(BaseModel):
    ...
    cores_limit: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Maximum number of core allowed.", alias="coresLimit")
    ...
    __properties: ClassVar[List[str]] = ["availabilitySetCount", "coresLimit", "virtualMachineCount", "vmScaleSetCount"]
