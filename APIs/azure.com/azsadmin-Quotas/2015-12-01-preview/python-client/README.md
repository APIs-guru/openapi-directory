...
------------ | ------------- | ------------- | -------------
*QuotasApi* | [**quotas_create_or_update**](docs/QuotasApi.md#quotas_create_or_update) | **PUT** /subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/quotas/{quotaName} | Creates or Updates a Quota.
*QuotasApi* | [**quotas_delete**](docs/QuotasApi.md#quotas_delete) | **DELETE** /subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/quotas/{quotaName} | Deletes specified quota
*QuotasApi* | [**quotas_get**](docs/QuotasApi.md#quotas_get) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/quotas/{quotaName} | Returns the requested quota.
*QuotasApi* | [**quotas_list**](docs/QuotasApi.md#quotas_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/quotas | Lists all quotas.
