...
class QuotaList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to the next page.", alias="nextLink")
    value: Optional[List[Quota]] = Field(default=None, description="List of quotas on this page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Quota.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
