...
------------- | ------------- | -------------
[**quotas_get**](QuotasApi.md#quotas_get) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/locations/{location}/quotas/{resourceName} | 
[**quotas_list**](QuotasApi.md#quotas_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/locations/{location}/quotas | 


# **quotas_get**
> Quota quotas_get(subscription_id, location, resource_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.quotas_get(subscription_id, location, resource_name, api_version)
...
# **quotas_list**
> QuotaList quotas_list(subscription_id, location, api_version, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.quotas_list(subscription_id, location, api_version, filter=filter)
