...
class QuotasList200ResponseValueInner(BaseModel):
    """
    Holds Compute quota information used to control resource allocation.
    """ # noqa: E501
    properties: Optional[QuotasList200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": QuotasList200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
