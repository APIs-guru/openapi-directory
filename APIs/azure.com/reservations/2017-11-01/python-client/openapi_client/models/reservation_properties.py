...
class ReservationProperties(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="Quantity of the SKUs that are part of the Reservation.")
    split_properties: Optional[ReservationSplitProperties] = Field(default=None, alias="splitProperties")
    __properties: ClassVar[List[str]] = ["appliedScopeType", "appliedScopes", "displayName", "effectiveDateTime", "expiryDate", "extendedStatusInfo", "lastUpdatedDateTime", "mergeProperties", "provisioningState", "quantity", "splitProperties"]
