...
class Catalog(BaseModel):
    ...
    size: Optional[StrictStr] = Field(default=None, description="The size of this SKU")
    terms: Optional[List[ReservationTerm]] = Field(default=None, description="Available reservation terms for this resource")
    tier: Optional[StrictStr] = Field(default=None, description="The tier of this SKU")
    __properties: ClassVar[List[str]] = ["capabilities", "locations", "name", "resourceType", "restrictions", "size", "terms", "tier"]
