...
class TestPatchPropertiesRenewProperties(unittest.TestCase):
    """PatchPropertiesRenewProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchPropertiesRenewProperties:
        """Test PatchPropertiesRenewProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchPropertiesRenewProperties`
        """
    ...
    def testPatchPropertiesRenewProperties(self):
        """Test PatchPropertiesRenewProperties"""
