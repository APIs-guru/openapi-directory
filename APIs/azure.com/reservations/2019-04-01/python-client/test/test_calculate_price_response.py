...
class TestCalculatePriceResponse(unittest.TestCase):
    """CalculatePriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculatePriceResponse:
        """Test CalculatePriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculatePriceResponse`
        """
        model = CalculatePriceResponse()
        if include_optional:
            return CalculatePriceResponse(
                properties = openapi_client.models.calculate_price_response_properties.CalculatePriceResponseProperties(
    ...
    def testCalculatePriceResponse(self):
        """Test CalculatePriceResponse"""
