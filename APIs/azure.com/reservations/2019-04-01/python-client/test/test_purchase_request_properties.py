...
class TestPurchaseRequestProperties(unittest.TestCase):
    """PurchaseRequestProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseRequestProperties:
        """Test PurchaseRequestProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseRequestProperties`
        """
    ...
    def testPurchaseRequestProperties(self):
        """Test PurchaseRequestProperties"""
