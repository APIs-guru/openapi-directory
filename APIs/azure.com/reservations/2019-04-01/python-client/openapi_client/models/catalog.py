...
class Catalog(BaseModel):
    ...
    Catalog
    """ # noqa: E501
    billing_plans: Optional[Dict[str, List[ReservationBillingPlan]]] = Field(default=None, description="The billing plan options available for this SKU.", alias="billingPlans")
    ...
    __properties: ClassVar[List[str]] = ["billingPlans", "locations", "name", "resourceType", "restrictions", "skuProperties", "terms"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in billing_plans (dict of array)
        _field_dict_of_array = {}
        if self.billing_plans:
            for _key_billing_plans in self.billing_plans:
                if self.billing_plans[_key_billing_plans] is not None:
                    _field_dict_of_array[_key_billing_plans] = [
                        _item.to_dict() for _item in self.billing_plans[_key_billing_plans]
                    ]
            _dict['billingPlans'] = _field_dict_of_array
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billingPlans": dict(
                (_k,
                        [ReservationBillingPlan.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("billingPlans", {}).items()
            ),
