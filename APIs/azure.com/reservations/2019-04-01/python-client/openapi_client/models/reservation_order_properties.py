...
class ReservationOrderProperties(BaseModel):
    ...
    original_quantity: Optional[StrictInt] = Field(default=None, description="Quantity of the SKUs that are part of the Reservation. Must be greater than zero.", alias="originalQuantity")
    plan_information: Optional[ReservationOrderBillingPlanInformation] = Field(default=None, alias="planInformation")
    ...
    __properties: ClassVar[List[str]] = ["billingPlan", "createdDateTime", "displayName", "expiryDate", "originalQuantity", "planInformation", "provisioningState", "requestDateTime", "reservations", "term"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "planInformation": ReservationOrderBillingPlanInformation.from_dict(obj["planInformation"]) if obj.get("planInformation") is not None else None,
