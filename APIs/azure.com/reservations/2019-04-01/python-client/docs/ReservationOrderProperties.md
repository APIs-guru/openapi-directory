...
**original_quantity** | **int** | Quantity of the SKUs that are part of the Reservation. Must be greater than zero. | [optional] 
**plan_information** | [**ReservationOrderBillingPlanInformation**](ReservationOrderBillingPlanInformation.md) |  | [optional] 
