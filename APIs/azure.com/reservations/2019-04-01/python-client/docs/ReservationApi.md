...
# **reservation_get**
> ReservationResponse reservation_get(reservation_id, reservation_order_id, api_version, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    expand = 'expand_example' # str | Supported value of this query is renewProperties (optional)

    try:
        # Get `Reservation` details.
        api_response = api_instance.reservation_get(reservation_id, reservation_order_id, api_version, expand=expand)
 ...
 **expand** | **str**| Supported value of this query is renewProperties | [optional] 
...
> ReservationOrderResponse reservation_order_get(reservation_order_id, api_version, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    reservation_order_id = 'reservation_order_id_example' # str | Order Id of the reservation
    api_version = 'api_version_example' # str | Supported version for this document is 2019-04-01
    expand = 'expand_example' # str | May be used to expand the planInformation. (optional)

    try:
        # Get a specific `ReservationOrder`.
        api_response = api_instance.reservation_order_get(reservation_order_id, api_version, expand=expand)
 ...
 **reservation_order_id** | **str**| Order Id of the reservation | 
 **api_version** | **str**| Supported version for this document is 2019-04-01 | 
 **expand** | **str**| May be used to expand the planInformation. | [optional] 
