...
class ReservationProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["appliedScopeType", "appliedScopes", "displayName", "effectiveDateTime", "expiryDate", "extendedStatusInfo", "instanceFlexibility", "lastUpdatedDateTime", "mergeProperties", "provisioningState", "quantity", "reservedResourceType", "skuDescription", "splitProperties"]
