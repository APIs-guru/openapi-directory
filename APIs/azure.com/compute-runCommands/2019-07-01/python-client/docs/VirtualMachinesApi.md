...
> RunCommandResult virtual_machines_run_command(resource_group_name, vm_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machines_run_command(resource_group_name, vm_name, api_version, subscription_id, parameters)
        print("The response of VirtualMachinesApi->virtual_machines_run_command:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VirtualMachinesApi->virtual_machines_run_command: %s\n" % e)
```
