...
class VirtualMachineScaleSetVMsApi:
    ...
    @validate_call
    def virtual_machine_scale_set_vms_run_command(
        self,
        ...
        parameters: Annotated[RunCommandInput, Field(description="Parameters supplied to the Run command operation.")],
        ...
        :type parameters: RunCommandInput
        ...
        _param = self._virtual_machine_scale_set_vms_run_command_serialize(
    ...
    @validate_call
    def virtual_machine_scale_set_vms_run_command_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        vm_scale_set_name: Annotated[StrictStr, Field(description="The name of the VM scale set.")],
        instance_id: Annotated[StrictStr, Field(description="The instance ID of the virtual machine.")],
    ...
    @validate_call
    def virtual_machine_scale_set_vms_run_command_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        vm_scale_set_name: Annotated[StrictStr, Field(description="The name of the VM scale set.")],
        instance_id: Annotated[StrictStr, Field(description="The instance ID of the virtual machine.")],
    ...
    def _virtual_machine_scale_set_vms_run_command_serialize(
        self,
        resource_group_name,
        vm_scale_set_name,
        instance_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/runCommand',
