...
class RunCommandResult(BaseModel):
    ...
    RunCommandResult
    """ # noqa: E501
    value: Optional[List[InstanceViewStatus]] = Field(default=None, description="Run command operation response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [InstanceViewStatus.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
