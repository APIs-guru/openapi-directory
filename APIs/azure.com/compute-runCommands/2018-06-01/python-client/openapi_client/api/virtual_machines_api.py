...
class VirtualMachinesApi:
    ...
    @validate_call
    def virtual_machines_run_command(
        self,
        ...
        _param = self._virtual_machines_run_command_serialize(
    ...
    @validate_call
    def virtual_machines_run_command_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        vm_name: Annotated[StrictStr, Field(description="The name of the virtual machine.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    @validate_call
    def virtual_machines_run_command_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        vm_name: Annotated[StrictStr, Field(description="The name of the virtual machine.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _virtual_machines_run_command_serialize(
        self,
        resource_group_name,
        vm_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/runCommand',
