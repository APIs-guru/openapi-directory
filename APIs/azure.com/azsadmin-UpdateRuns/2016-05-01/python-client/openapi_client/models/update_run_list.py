...
class UpdateRunList(BaseModel):
    ...
    value: Optional[List[UpdateRun]] = Field(default=None, description="List of update runs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UpdateRun.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
