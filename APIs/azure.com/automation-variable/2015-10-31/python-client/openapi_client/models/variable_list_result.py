...
class VariableListResult(BaseModel):
    ...
    value: Optional[List[Variable]] = Field(default=None, description="Gets or sets a list of variables.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Variable.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
