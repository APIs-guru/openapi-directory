...
class VariableCreateOrUpdateParameters(BaseModel):
    """
    The parameters supplied to the create or update variable operation.
    """ # noqa: E501
    name: StrictStr = Field(description="Gets or sets the name of the variable.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": VariableCreateOrUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
