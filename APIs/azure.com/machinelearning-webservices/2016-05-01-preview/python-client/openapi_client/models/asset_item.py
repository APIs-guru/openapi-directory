...
class AssetItem(BaseModel):
    ...
    location_info: AssetLocation = Field(alias="locationInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "locationInfo": AssetLocation.from_dict(obj["locationInfo"]) if obj.get("locationInfo") is not None else None,
