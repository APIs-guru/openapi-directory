...
class WebServiceProperties(BaseModel):
    ...
    parameters: Optional[Dict[str, StrictStr]] = Field(default=None, description="The set of global parameters values defined for the web service, given as a global parameter name to default value map. If no default value is specified, the parameter is considered to be required.")
    ...
    __properties: ClassVar[List[str]] = ["assets", "commitmentPlan", "createdOn", "description", "diagnostics", "exampleRequest", "exposeSampleData", "input", "keys", "machineLearningWorkspace", "modifiedOn", "output", "packageType", "parameters", "provisioningState", "readOnly", "realtimeConfiguration", "storageAccount", "swaggerLocation", "title"]
