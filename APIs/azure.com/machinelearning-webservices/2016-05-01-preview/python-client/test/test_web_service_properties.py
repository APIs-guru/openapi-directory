...
class TestWebServiceProperties(unittest.TestCase):
    """WebServiceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebServiceProperties:
        """Test WebServiceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebServiceProperties`
        """
        model = WebServiceProperties()
        if include_optional:
    ...
    def testWebServiceProperties(self):
        """Test WebServiceProperties"""
