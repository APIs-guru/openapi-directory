...
class GraphNode(BaseModel):
    ...
    parameters: Optional[Dict[str, WebServiceParameter]] = Field(default=None, description="If applicable, parameters of the node. Global graph parameters map into these, with values set at runtime.")
