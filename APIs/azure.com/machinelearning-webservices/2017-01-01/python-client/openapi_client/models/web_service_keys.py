...
class WebServiceKeys(BaseModel):
    """
    Access keys for the web service calls.
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="The primary access key.")
    secondary: Optional[StrictStr] = Field(default=None, description="The secondary access key.")
