...
class MachineLearningWorkspace(BaseModel):
    """
    Information about the machine learning workspace containing the experiment that is source for the web service.
    """ # noqa: E501
    id: StrictStr = Field(description="Specifies the workspace ID of the machine learning workspace associated with the web service")
