...
**id** | **str** | Async operation id. | [optional] [readonly] 
**name** | **str** | Async operation name. | [optional] [readonly] 
**percent_complete** | **float** | Async operation progress. | [optional] [readonly] 
**provisioning_state** | **str** | Read Only: The provisioning state of the web service. Valid values are Unknown, Provisioning, Succeeded, and Failed. | [optional] [readonly] 
