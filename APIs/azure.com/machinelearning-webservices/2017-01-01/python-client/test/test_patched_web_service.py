...
class TestPatchedWebService(unittest.TestCase):
    """PatchedWebService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedWebService:
        """Test PatchedWebService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedWebService`
        """
        model = PatchedWebService()
        if include_optional:
            return PatchedWebService(
    ...
    def testPatchedWebService(self):
        """Test PatchedWebService"""
