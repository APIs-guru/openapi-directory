        ...
        if include_optional:
            return IoTSecuritySolutionAnalyticsModelProperties(
                ...
                metrics = openapi_client.models.io_t_severity_metrics.IoTSeverityMetrics(
                    ...
                    low = 56, 
                    medium = 56, ),
                most_prevalent_device_alerts = openapi_client.models.io_t_security_device_alerts_list.IoTSecurityDeviceAlertsList(
                    next_link = '', 
                    value = [
                ...
                most_prevalent_device_recommendations = openapi_client.models.io_t_security_device_recommendations_list.IoTSecurityDeviceRecommendationsList(
                    next_link = '', 
                    value = [
                ...
                top_alerted_devices = openapi_client.models.io_t_security_alerted_devices_list.IoTSecurityAlertedDevicesList(
                    next_link = '', 
                    value = [
