...
class IoTSecurityDeviceRecommendation(BaseModel):
    """
    Statistic information about the number of recommendations per recommendation type
    """ # noqa: E501
    devices_count: Optional[StrictInt] = Field(default=None, description="the number of device with this recommendation", alias="devicesCount")
    recommendation_display_name: Optional[StrictStr] = Field(default=None, description="Display name of the recommendation", alias="recommendationDisplayName")
    ...
    __properties: ClassVar[List[str]] = ["devicesCount", "recommendationDisplayName", "reportedSeverity"]
