...
class IoTSecurityDeviceAlertsList(BaseModel):
    """
    ...
    value: List[IoTSecurityDeviceAlert] = Field(description="List of top alerts data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IoTSecurityDeviceAlert.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
