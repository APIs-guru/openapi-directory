...
class IoTSecurityAggregatedAlertList(BaseModel):
    """
    ...
    value: List[IoTSecurityAggregatedAlert] = Field(description="List of aggregated alerts data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IoTSecurityAggregatedAlert.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
