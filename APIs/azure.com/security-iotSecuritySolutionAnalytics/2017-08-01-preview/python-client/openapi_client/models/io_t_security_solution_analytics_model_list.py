...
class IoTSecuritySolutionAnalyticsModelList(BaseModel):
    """
    List of Security Analytics of a security solution
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page.", alias="nextLink")
    value: List[IoTSecuritySolutionAnalyticsModel] = Field(description="List of Security Analytics of a security solution")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IoTSecuritySolutionAnalyticsModel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
