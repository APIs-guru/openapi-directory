...
class IoTSecuritySolutionAnalyticsModelProperties(BaseModel):
    ...
    """ # noqa: E501
    devices_metrics: Optional[List[IoTSecuritySolutionAnalyticsModelPropertiesDevicesMetricsInner]] = Field(default=None, description="The list of devices metrics by the aggregated date.", alias="devicesMetrics")
    metrics: Optional[IoTSeverityMetrics] = None
    most_prevalent_device_alerts: Optional[IoTSecurityDeviceAlertsList] = Field(default=None, alias="mostPrevalentDeviceAlerts")
    most_prevalent_device_recommendations: Optional[IoTSecurityDeviceRecommendationsList] = Field(default=None, alias="mostPrevalentDeviceRecommendations")
    top_alerted_devices: Optional[IoTSecurityAlertedDevicesList] = Field(default=None, alias="topAlertedDevices")
    unhealthy_device_count: Optional[StrictInt] = Field(default=None, description="number of unhealthy devices", alias="unhealthyDeviceCount")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of most_prevalent_device_alerts
        if self.most_prevalent_device_alerts:
            _dict['mostPrevalentDeviceAlerts'] = self.most_prevalent_device_alerts.to_dict()
        # override the default output from pydantic by calling `to_dict()` of most_prevalent_device_recommendations
        if self.most_prevalent_device_recommendations:
            _dict['mostPrevalentDeviceRecommendations'] = self.most_prevalent_device_recommendations.to_dict()
        # override the default output from pydantic by calling `to_dict()` of top_alerted_devices
        if self.top_alerted_devices:
            _dict['topAlertedDevices'] = self.top_alerted_devices.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mostPrevalentDeviceAlerts": IoTSecurityDeviceAlertsList.from_dict(obj["mostPrevalentDeviceAlerts"]) if obj.get("mostPrevalentDeviceAlerts") is not None else None,
            "mostPrevalentDeviceRecommendations": IoTSecurityDeviceRecommendationsList.from_dict(obj["mostPrevalentDeviceRecommendations"]) if obj.get("mostPrevalentDeviceRecommendations") is not None else None,
            "topAlertedDevices": IoTSecurityAlertedDevicesList.from_dict(obj["topAlertedDevices"]) if obj.get("topAlertedDevices") is not None else None,
