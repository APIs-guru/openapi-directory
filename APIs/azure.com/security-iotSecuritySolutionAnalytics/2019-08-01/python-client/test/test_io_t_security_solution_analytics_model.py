...
class TestIoTSecuritySolutionAnalyticsModel(unittest.TestCase):
    """IoTSecuritySolutionAnalyticsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoTSecuritySolutionAnalyticsModel:
        """Test IoTSecuritySolutionAnalyticsModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoTSecuritySolutionAnalyticsModel`
        """
        model = IoTSecuritySolutionAnalyticsModel()
        if include_optional:
            return IoTSecuritySolutionAnalyticsModel(
                properties = openapi_client.models.io_t_security_solution_analytics_model_properties.IoTSecuritySolutionAnalyticsModelProperties(
                    devices_metrics = [
    ...
    def testIoTSecuritySolutionAnalyticsModel(self):
        """Test IoTSecuritySolutionAnalyticsModel"""
