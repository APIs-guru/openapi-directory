...
class IoTSecurityAggregatedRecommendation(BaseModel):
    """
    IoT Security solution recommendation information.
    """ # noqa: E501
    properties: Optional[IoTSecurityAggregatedRecommendationProperties] = None
    ...
    __properties: ClassVar[List[str]] = ["tags", "id", "name", "type"]
