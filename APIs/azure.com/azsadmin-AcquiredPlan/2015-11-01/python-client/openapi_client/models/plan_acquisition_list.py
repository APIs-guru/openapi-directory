...
class PlanAcquisitionList(BaseModel):
    """
    List of acquired plans.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI to the next page.", alias="nextLink")
    value: Optional[List[PlanAcquisition]] = Field(default=None, description="List of acquired plans.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PlanAcquisition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
