...
class TestIEdmStructuralProperty(unittest.TestCase):
    """IEdmStructuralProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IEdmStructuralProperty:
        """Test IEdmStructuralProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IEdmStructuralProperty`
        """
        model = IEdmStructuralProperty()
        if include_optional:
            return IEdmStructuralProperty(
    ...
    def testIEdmStructuralProperty(self):
        """Test IEdmStructuralProperty"""
