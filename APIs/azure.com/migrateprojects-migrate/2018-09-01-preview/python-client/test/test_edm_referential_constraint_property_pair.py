...
class TestEdmReferentialConstraintPropertyPair(unittest.TestCase):
    """EdmReferentialConstraintPropertyPair unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdmReferentialConstraintPropertyPair:
        """Test EdmReferentialConstraintPropertyPair
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdmReferentialConstraintPropertyPair`
        """
        model = EdmReferentialConstraintPropertyPair()
        if include_optional:
            return EdmReferentialConstraintPropertyPair(
    ...
    def testEdmReferentialConstraintPropertyPair(self):
        """Test EdmReferentialConstraintPropertyPair"""
