...
class TestODataPath(unittest.TestCase):
    """ODataPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ODataPath:
        """Test ODataPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ODataPath`
        """
        model = ODataPath()
        if include_optional:
            return ODataPath(
