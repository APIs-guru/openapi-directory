...
class MachinesApi:
    ...
    @validate_call
    def machines_enumerate_machines(
        self,
        ...
        _param = self._machines_enumerate_machines_serialize(
    ...
    @validate_call
    def machines_enumerate_machines_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    @validate_call
    def machines_enumerate_machines_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    def _machines_enumerate_machines_serialize(
        self,
        subscription_id,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines',
    ...
    @validate_call
    def machines_get_machine(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
        api_version: Annotated[StrictStr, Field(description="Standard request header. Used by service to identify API version used by client.")],
        machine_name: Annotated[StrictStr, Field(description="Unique name of a machine in Azure migration hub.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param api_version: Standard request header. Used by service to identify API version used by client. (required)
        :type api_version: str
        :param machine_name: Unique name of a machine in Azure migration hub. (required)
        ...
        _param = self._machines_get_machine_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            migrate_project_name=migrate_project_name,
            api_version=api_version,
    ...
    @validate_call
    def machines_get_machine_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    @validate_call
    def machines_get_machine_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    def _machines_get_machine_serialize(
        self,
        subscription_id,
        resource_group_name,
        migrate_project_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/machines/{machineName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
