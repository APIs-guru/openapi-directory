...
class DatabaseInstancesApi:
    ...
    @validate_call
    def database_instances_enumerate_database_instances(
        self,
        ...
        _param = self._database_instances_enumerate_database_instances_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DatabaseInstanceCollection",
        }
    ...
    @validate_call
    def database_instances_enumerate_database_instances_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatabaseInstanceCollection]:
        """Gets a list of database instances in the migrate project.
    ...
    @validate_call
    def database_instances_enumerate_database_instances_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    def _database_instances_enumerate_database_instances_serialize(
        self,
        subscription_id,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/databaseInstances',
    ...
    @validate_call
    def database_instances_get_database_instance(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
        database_instance_name: Annotated[StrictStr, Field(description="Unique name of a database instance in Azure migration hub.")],
        api_version: Annotated[StrictStr, Field(description="Standard request header. Used by service to identify API version used by client.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Standard request header. Used by service to respond to client in appropriate language.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param migrate_project_name: Name of the Azure Migrate project. (required)
        :type migrate_project_name: str
        :param database_instance_name: Unique name of a database instance in Azure migration hub. (required)
        ...
        _param = self._database_instances_get_database_instance_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            migrate_project_name=migrate_project_name,
    ...
    @validate_call
    def database_instances_get_database_instance_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    @validate_call
    def database_instances_get_database_instance_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription Id in which migrate project was created.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the Azure Resource Group that migrate project is part of.")],
        migrate_project_name: Annotated[StrictStr, Field(description="Name of the Azure Migrate project.")],
    ...
    def _database_instances_get_database_instance_serialize(
        self,
        subscription_id,
        resource_group_name,
        migrate_project_name,
        ...
        if database_instance_name is not None:
            _path_params['databaseInstanceName'] = database_instance_name
        # process the query parameters
        if api_version is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/databaseInstances/{databaseInstanceName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
