...
class DatabaseInstanceCollection(BaseModel):
    """
    ...
    value: Optional[List[DatabaseInstance]] = Field(default=None, description="Gets or sets the database instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DatabaseInstance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
