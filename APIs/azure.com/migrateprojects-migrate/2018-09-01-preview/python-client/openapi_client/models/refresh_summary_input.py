...
class RefreshSummaryInput(BaseModel):
    """
    Class representing the refresh summary input.
    """ # noqa: E501
    goal: Optional[StrictStr] = Field(default=None, description="Gets or sets the goal for which summary needs to be refreshed.")
