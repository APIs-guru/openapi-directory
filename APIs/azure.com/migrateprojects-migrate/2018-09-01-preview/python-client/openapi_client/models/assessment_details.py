...
class AssessmentDetails(BaseModel):
    ...
    """ # noqa: E501
    assessment_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the id of the assessment done on the machine.", alias="assessmentId")
    ...
    target_storage_type: Optional[Dict[str, StrictStr]] = Field(default=None, description="Gets or sets the target storage type.", alias="targetStorageType")
    target_vm_location: Optional[StrictStr] = Field(default=None, description="Gets or sets the target VM location.", alias="targetVMLocation")
    target_vm_size: Optional[StrictStr] = Field(default=None, description="Gets or sets the target VM size.", alias="targetVMSize")
    __properties: ClassVar[List[str]] = ["assessmentId", "biosId", "enqueueTime", "extendedInfo", "fabricType", "fqdn", "ipAddresses", "lastUpdatedTime", "macAddresses", "machineId", "machineManagerId", "machineName", "solutionName", "targetStorageType", "targetVMLocation", "targetVMSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetStorageType": obj.get("targetStorageType"),
            "targetVMLocation": obj.get("targetVMLocation"),
            "targetVMSize": obj.get("targetVMSize")
        })
        return _obj
