...
class DatabaseMigrateEventProperties(MigrateEventProperties):
    ...
    """ # noqa: E501
    database: Optional[StrictStr] = Field(default=None, description="Gets or sets the database for which the error is being reported.")
    database_instance_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the database instance for which the error is being reported.", alias="databaseInstanceId")
