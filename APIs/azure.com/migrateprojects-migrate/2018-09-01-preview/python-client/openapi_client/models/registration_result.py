...
class RegistrationResult(BaseModel):
    ...
    """ # noqa: E501
    is_registered: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the tool is registered or not.", alias="isRegistered")
    __properties: ClassVar[List[str]] = ["isRegistered"]
