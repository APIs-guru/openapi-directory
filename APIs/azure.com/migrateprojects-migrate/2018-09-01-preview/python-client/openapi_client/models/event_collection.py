...
class EventCollection(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the value of nextLink.", alias="nextLink")
    value: Optional[List[MigrateEvent]] = Field(default=None, description="Gets or sets the machines.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MigrateEvent.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
