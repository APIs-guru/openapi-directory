...
class VaultCertificatesApi:
    ...
    def vault_certificates_create(
        ...
        certificate_name: Annotated[StrictStr, Field(description="Certificate friendly name.")],
        certificate_request: Annotated[CertificateRequest, Field(description="Input parameters for uploading the vault certificate.")],
        ...
        :type certificate_request: CertificateRequest
        ...
        _param = self._vault_certificates_create_serialize(
    ...
    @validate_call
    def vault_certificates_create_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VaultCertificateResponse]:
        """vault_certificates_create
    ...
    @validate_call
    def vault_certificates_create_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _vault_certificates_create_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        if certificate_request is not None:
            _body_params = certificate_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/certificates/{certificateName}',
