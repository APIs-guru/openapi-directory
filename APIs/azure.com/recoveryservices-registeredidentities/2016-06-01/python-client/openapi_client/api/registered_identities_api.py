...
class RegisteredIdentitiesApi:
    ...
    @validate_call
    def registered_identities_delete(
        self,
        ...
        identity_name: Annotated[StrictStr, Field(description="Name of the protection container to unregister.")],
        ...
        _param = self._registered_identities_delete_serialize(
    ...
    @validate_call
    def registered_identities_delete_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def registered_identities_delete_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _registered_identities_delete_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        if identity_name is not None:
            _path_params['identityName'] = identity_name
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/registeredIdentities/{identityName}',
