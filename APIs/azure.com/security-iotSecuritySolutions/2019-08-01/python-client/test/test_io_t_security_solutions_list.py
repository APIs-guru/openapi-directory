...
class TestIoTSecuritySolutionsList(unittest.TestCase):
    """IoTSecuritySolutionsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoTSecuritySolutionsList:
        """Test IoTSecuritySolutionsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoTSecuritySolutionsList`
        """
        model = IoTSecuritySolutionsList()
        if include_optional:
            return IoTSecuritySolutionsList(
                next_link = '',
                value = [
                    openapi_client.models.io_t_security_solution_model.IoTSecuritySolutionModel(
                        location = '', 
    ...
    def testIoTSecuritySolutionsList(self):
        """Test IoTSecuritySolutionsList"""
