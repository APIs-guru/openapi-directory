...
class TestIoTSecuritySolutionProperties(unittest.TestCase):
    """IoTSecuritySolutionProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoTSecuritySolutionProperties:
        """Test IoTSecuritySolutionProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoTSecuritySolutionProperties`
        """
        model = IoTSecuritySolutionProperties()
        if include_optional:
            return IoTSecuritySolutionProperties(
    ...
    def testIoTSecuritySolutionProperties(self):
        """Test IoTSecuritySolutionProperties"""
