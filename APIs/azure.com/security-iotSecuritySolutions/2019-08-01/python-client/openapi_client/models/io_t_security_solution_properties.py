...
class IoTSecuritySolutionProperties(BaseModel):
    ...
    export: Optional[List[StrictStr]] = Field(default=None, description="List of additional options for exporting to workspace data.")
    ...
    status: Optional[StrictStr] = Field(default='Enabled', description="Status of the IoT Security solution.")
    unmasked_ip_logging_status: Optional[StrictStr] = Field(default='Disabled', description="Unmasked IP address logging status", alias="unmaskedIpLoggingStatus")
    ...
    __properties: ClassVar[List[str]] = ["autoDiscoveredResources", "disabledDataSources", "displayName", "export", "iotHubs", "recommendationsConfiguration", "status", "unmaskedIpLoggingStatus", "userDefinedResources", "workspace"]
    ...
    @field_validator('unmasked_ip_logging_status')
    def unmasked_ip_logging_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unmaskedIpLoggingStatus": obj.get("unmaskedIpLoggingStatus") if obj.get("unmaskedIpLoggingStatus") is not None else 'Disabled',
