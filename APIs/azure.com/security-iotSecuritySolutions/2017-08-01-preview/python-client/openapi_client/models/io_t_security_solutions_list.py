...
class IoTSecuritySolutionsList(BaseModel):
    """
    ...
    value: List[IoTSecuritySolutionModel] = Field(description="List of security solutions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IoTSecuritySolutionModel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
