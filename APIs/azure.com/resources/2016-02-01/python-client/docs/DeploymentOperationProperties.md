...
**service_request_id** | **str** | Deployment operation service request id. | [optional] 
**status_code** | **str** | Operation status code. | [optional] 
**status_message** | **object** | Operation status message. | [optional] 
**target_resource** | [**TargetResource**](TargetResource.md) |  | [optional] 
**timestamp** | **datetime** | The date and time of the operation. | [optional] 
