...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    parameters = openapi_client.ExportTemplateRequest() # ExportTemplateRequest | Parameters supplied to the export template resource group operation.
...
> ResourceListResult resource_groups_list_resources(resource_group_name, api_version, subscription_id, filter=filter, expand=expand, top=top)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.resource_groups_list_resources(resource_group_name, api_version, subscription_id, filter=filter, expand=expand, top=top)
