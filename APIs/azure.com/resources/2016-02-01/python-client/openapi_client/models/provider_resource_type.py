...
class ProviderResourceType(BaseModel):
    ...
    locations: Optional[List[StrictStr]] = Field(default=None, description="The collection of locations where this resource type can be created in.")
    ...
    __properties: ClassVar[List[str]] = ["aliases", "apiVersions", "locations", "properties", "resourceType"]
