...
class ResourceGroupListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: StrictStr = Field(description="The URL to get the next set of results.", alias="nextLink")
    value: Optional[List[ResourceGroup]] = Field(default=None, description="The list of resource groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
