...
class DeploymentValidateResult(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ResourceManagementErrorWithDetails.from_dict(obj["error"]) if obj.get("error") is not None else None,
