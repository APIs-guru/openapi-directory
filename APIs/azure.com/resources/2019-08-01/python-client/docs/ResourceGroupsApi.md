...
> ResourceGroupExportResult resource_groups_export_template(subscription_id, resource_group_name, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.resource_groups_export_template(subscription_id, resource_group_name, api_version, parameters)
