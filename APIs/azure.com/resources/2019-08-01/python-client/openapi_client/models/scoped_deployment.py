...
class ScopedDeployment(BaseModel):
    """
    Deployment operation parameters.
    """ # noqa: E501
    location: StrictStr = Field(description="The location to store the deployment data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": DeploymentProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
