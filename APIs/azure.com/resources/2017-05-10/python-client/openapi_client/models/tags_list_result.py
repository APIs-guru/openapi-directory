...
class TagsListResult(BaseModel):
    ...
    value: Optional[List[TagDetails]] = Field(default=None, description="An array of tags.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [TagDetails.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
