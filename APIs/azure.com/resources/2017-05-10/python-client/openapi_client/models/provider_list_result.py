...
class ProviderListResult(BaseModel):
    ...
    value: Optional[List[Provider]] = Field(default=None, description="An array of resource providers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Provider.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
