...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    expand = 'expand_example' # str | The $expand query parameter. e.g. To include property aliases in response, use $expand=resourceTypes/aliases. (optional)
 ...
 **expand** | **str**| The $expand query parameter. e.g. To include property aliases in response, use $expand&#x3D;resourceTypes/aliases. | [optional] 
