...
class DeploymentListResult(BaseModel):
    ...
    value: Optional[List[DeploymentExtended]] = Field(default=None, description="An array of deployments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DeploymentExtended.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
