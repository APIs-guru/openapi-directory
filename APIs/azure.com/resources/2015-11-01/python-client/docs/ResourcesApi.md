...
# **resources_list**
> ResourceListResult resources_list(api_version, subscription_id, filter=filter, top=top)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.resources_list(api_version, subscription_id, filter=filter, top=top)
