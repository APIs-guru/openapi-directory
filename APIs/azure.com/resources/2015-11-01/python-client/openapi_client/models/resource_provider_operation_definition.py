...
class ResourceProviderOperationDefinition(BaseModel):
    ...
    """ # noqa: E501
    display: Optional[ResourceProviderOperationDisplayProperties] = None
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the provider operation name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": ResourceProviderOperationDisplayProperties.from_dict(obj["display"]) if obj.get("display") is not None else None,
            "name": obj.get("name")
        })
        return _obj
