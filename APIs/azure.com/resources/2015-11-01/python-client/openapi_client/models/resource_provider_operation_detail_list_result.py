...
class ResourceProviderOperationDetailListResult(BaseModel):
    """
    ...
    value: Optional[List[ResourceProviderOperationDefinition]] = Field(default=None, description="Gets or sets the list of resource provider operations.")
