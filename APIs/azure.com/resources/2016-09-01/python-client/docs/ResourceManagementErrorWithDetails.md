...
------------ | ------------- | ------------- | -------------
**code** | **str** | The error code returned when exporting the template. | [optional] [readonly] 
**details** | [**List[ResourceManagementErrorWithDetails]**](ResourceManagementErrorWithDetails.md) | Validation error. | [optional] [readonly] 
**message** | **str** | The error message describing the export error. | [optional] [readonly] 
