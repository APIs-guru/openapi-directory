...
[**resource_groups_patch**](ResourceGroupsApi.md#resource_groups_patch) | **PATCH** /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName} | Updates a resource group.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    parameters = openapi_client.ResourceGroup() # ResourceGroup | Parameters supplied to update a resource group.
