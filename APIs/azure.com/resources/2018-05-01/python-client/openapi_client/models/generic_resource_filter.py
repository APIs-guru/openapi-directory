...
class GenericResourceFilter(BaseModel):
    ...
    tagname: Optional[StrictStr] = Field(default=None, description="The tag name.")
    tagvalue: Optional[StrictStr] = Field(default=None, description="The tag value.")
    __properties: ClassVar[List[str]] = ["resourceType", "tagname", "tagvalue"]
