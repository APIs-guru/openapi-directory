...
class DeploymentPropertiesExtended(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "debugSetting", "dependencies", "mode", "onErrorDeployment", "outputs", "parameters", "parametersLink", "providers", "provisioningState", "template", "templateLink", "timestamp"]
