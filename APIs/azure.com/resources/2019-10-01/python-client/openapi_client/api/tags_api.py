...
class TagsApi:
    ...
    @validate_call
    def tags_create_or_update_at_scope(
        self,
        ...
        _param = self._tags_create_or_update_at_scope_serialize(
            scope=scope,
            api_version=api_version,
    ...
    @validate_call
    def tags_create_or_update_at_scope_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        parameters: TagsResource,
    ...
    @validate_call
    def tags_create_or_update_at_scope_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        parameters: TagsResource,
    ...
    def _tags_create_or_update_at_scope_serialize(
        self,
        scope,
        api_version,
        parameters,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/{scope}/providers/Microsoft.Resources/tags/default',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def tags_delete_at_scope(
        ...
        _param = self._tags_delete_at_scope_serialize(
            scope=scope,
            api_version=api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def tags_delete_at_scope_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        _request_timeout: Union[
    ...
    @validate_call
    def tags_delete_at_scope_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        _request_timeout: Union[
    ...
    def _tags_delete_at_scope_serialize(
        self,
        scope,
        api_version,
        _request_auth,
    ...
    def tags_get_at_scope(
        ...
        _param = self._tags_get_at_scope_serialize(
            scope=scope,
            api_version=api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def tags_get_at_scope_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        _request_timeout: Union[
    ...
    @validate_call
    def tags_get_at_scope_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        _request_timeout: Union[
    ...
    def _tags_get_at_scope_serialize(
        self,
        scope,
        api_version,
        _request_auth,
    ...
    def tags_update_at_scope(
        ...
        :type api_version: str
        :param parameters: (required)
        :type parameters: TagsPatchResource
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._tags_update_at_scope_serialize(
            scope=scope,
            api_version=api_version,
            parameters=parameters,
            _request_auth=_request_auth,
    ...
    @validate_call
    def tags_update_at_scope_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        parameters: TagsPatchResource,
    ...
    @validate_call
    def tags_update_at_scope_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="The resource scope.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        parameters: TagsPatchResource,
    ...
    def _tags_update_at_scope_serialize(
        self,
        scope,
        api_version,
        parameters,
