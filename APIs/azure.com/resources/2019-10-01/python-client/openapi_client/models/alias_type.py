...
class AliasType(BaseModel):
    ...
    paths: Optional[List[AliasPathType]] = Field(default=None, description="The paths for an alias.")
    __properties: ClassVar[List[str]] = ["name", "paths"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "paths": [AliasPathType.from_dict(_item) for _item in obj["paths"]] if obj.get("paths") is not None else None
        })
        return _obj
