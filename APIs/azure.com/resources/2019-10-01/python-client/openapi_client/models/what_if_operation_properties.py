...
class WhatIfOperationProperties(BaseModel):
    """
    Deployment operation properties.
    """ # noqa: E501
    changes: Optional[List[WhatIfChange]] = Field(default=None, description="List of resource changes predicted by What-If operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": [WhatIfChange.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
