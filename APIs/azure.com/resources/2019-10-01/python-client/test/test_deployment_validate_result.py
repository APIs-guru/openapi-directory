...
class TestDeploymentValidateResult(unittest.TestCase):
    """DeploymentValidateResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentValidateResult:
        """Test DeploymentValidateResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentValidateResult`
        """
    ...
    def testDeploymentValidateResult(self):
        """Test DeploymentValidateResult"""
