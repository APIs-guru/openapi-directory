...
**capabilities** | **str** | The additional capabilities offered by this resource type. | [optional] 
**locations** | **List[str]** | The collection of locations where this resource type can be created. | [optional] 
