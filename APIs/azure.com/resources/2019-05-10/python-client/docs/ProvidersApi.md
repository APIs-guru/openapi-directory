...
> Provider providers_get_at_tenant_scope(resource_provider_namespace, api_version, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_get_at_tenant_scope(resource_provider_namespace, api_version, expand=expand)
        print("The response of ProvidersApi->providers_get_at_tenant_scope:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_get_at_tenant_scope: %s\n" % e)
```
...
> ProviderListResult providers_list_at_tenant_scope(api_version, top=top, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProvidersApi(api_client)
    api_version = 'api_version_example' # str | The API version to use for this operation.
    top = 56 # int | The number of results to return. If null is passed returns all providers. (optional)
    expand = 'expand_example' # str | The properties to include in the results. For example, use &$expand=metadata in the query string to retrieve resource provider metadata. To include property aliases in response, use $expand=resourceTypes/aliases. (optional)

    try:
        api_response = api_instance.providers_list_at_tenant_scope(api_version, top=top, expand=expand)
        print("The response of ProvidersApi->providers_list_at_tenant_scope:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_list_at_tenant_scope: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **api_version** | **str**| The API version to use for this operation. | 
 **top** | **int**| The number of results to return. If null is passed returns all providers. | [optional] 
 **expand** | **str**| The properties to include in the results. For example, use &amp;$expand&#x3D;metadata in the query string to retrieve resource provider metadata. To include property aliases in response, use $expand&#x3D;resourceTypes/aliases. | [optional] 
