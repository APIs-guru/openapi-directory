...
class CloudErrorError(BaseModel):
    """
    The resource management error response.
    """ # noqa: E501
    additional_info: Optional[List[CloudErrorErrorAdditionalInfoInner]] = Field(default=None, description="The error additional info.", alias="additionalInfo")
    code: Optional[StrictStr] = Field(default=None, description="The error code.")
    details: Optional[List[Dict[str, Any]]] = Field(default=None, description="The error details.")
    message: Optional[StrictStr] = Field(default=None, description="The error message.")
    target: Optional[StrictStr] = Field(default=None, description="The error target.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalInfo": [CloudErrorErrorAdditionalInfoInner.from_dict(_item) for _item in obj["additionalInfo"]] if obj.get("additionalInfo") is not None else None,
            "code": obj.get("code"),
