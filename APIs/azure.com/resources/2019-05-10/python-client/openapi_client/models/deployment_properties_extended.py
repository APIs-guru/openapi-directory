...
class DeploymentPropertiesExtended(BaseModel):
    ...
    duration: Optional[StrictStr] = Field(default=None, description="The duration of the template deployment.")
    mode: Optional[StrictStr] = Field(default=None, description="The deployment mode. Possible values are Incremental and Complete.")
    on_error_deployment: Optional[OnErrorDeploymentExtended] = Field(default=None, alias="onErrorDeployment")
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "debugSetting", "dependencies", "duration", "mode", "onErrorDeployment", "outputs", "parameters", "parametersLink", "providers", "provisioningState", "template", "templateLink", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "onErrorDeployment": OnErrorDeploymentExtended.from_dict(obj["onErrorDeployment"]) if obj.get("onErrorDeployment") is not None else None,
