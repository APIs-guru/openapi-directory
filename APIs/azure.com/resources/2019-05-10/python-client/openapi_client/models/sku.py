...
class Sku(BaseModel):
    ...
    """ # noqa: E501
    capacity: Optional[StrictInt] = Field(default=None, description="The SKU capacity.")
    family: Optional[StrictStr] = Field(default=None, description="The SKU family.")
    model: Optional[StrictStr] = Field(default=None, description="The SKU model.")
    name: Optional[StrictStr] = Field(default=None, description="The SKU name.")
    size: Optional[StrictStr] = Field(default=None, description="The SKU size.")
    tier: Optional[StrictStr] = Field(default=None, description="The SKU tier.")
    __properties: ClassVar[List[str]] = ["capacity", "family", "model", "name", "size", "tier"]
