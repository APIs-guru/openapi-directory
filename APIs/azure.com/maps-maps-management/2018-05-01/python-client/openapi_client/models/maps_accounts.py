...
class MapsAccounts(BaseModel):
    """
    A list of Maps Accounts.
    """ # noqa: E501
    value: Optional[List[MapsAccount]] = Field(default=None, description="a Maps Account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MapsAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
