...
class OperationsApi:
    ...
    def maps_list_operations(
        ...
        _param = self._maps_list_operations_serialize(
    ...
    @validate_call
    def maps_list_operations_with_http_info(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def maps_list_operations_without_preload_content(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        _request_timeout: Union[
            None,
    ...
    def _maps_list_operations_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
