...
class MapsOperations(BaseModel):
    """
    The set of operations available for Maps.
    """ # noqa: E501
    value: Optional[List[MapsOperationsValueInner]] = Field(default=None, description="An operation available for Maps.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MapsOperationsValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
