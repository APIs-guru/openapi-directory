...
class PrivateAtlasList(BaseModel):
    """
    A list of Private Atlas resources.
    """ # noqa: E501
    value: Optional[List[PrivateAtlas]] = Field(default=None, description="a Private Atlas.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PrivateAtlas.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
