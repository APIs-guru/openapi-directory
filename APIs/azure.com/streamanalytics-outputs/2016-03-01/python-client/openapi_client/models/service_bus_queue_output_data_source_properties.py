...
class ServiceBusQueueOutputDataSourceProperties(BaseModel):
    """
    The properties that are associated with a Service Bus Queue output.
    """ # noqa: E501
    property_columns: Optional[List[StrictStr]] = Field(default=None, description="A string array of the names of output columns to be attached to Service Bus messages as custom properties.", alias="propertyColumns")
    queue_name: Optional[StrictStr] = Field(default=None, description="The name of the Service Bus Queue. Required on PUT (CreateOrReplace) requests.", alias="queueName")
    ...
    __properties: ClassVar[List[str]] = ["serviceBusNamespace", "sharedAccessPolicyKey", "sharedAccessPolicyName"]
