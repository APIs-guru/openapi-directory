...
class BlobOutputDataSourceProperties(BaseModel):
    """
    ...
    storage_accounts: Optional[List[BlobOutputDataSourcePropertiesAllOfStorageAccounts]] = Field(default=None, description="A list of one or more Azure Storage accounts. Required on PUT (CreateOrReplace) requests.", alias="storageAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storageAccounts": [BlobOutputDataSourcePropertiesAllOfStorageAccounts.from_dict(_item) for _item in obj["storageAccounts"]] if obj.get("storageAccounts") is not None else None,
