...
class ServiceBusTopicOutputDataSourceProperties(BaseModel):
    """
    ...
    topic_name: Optional[StrictStr] = Field(default=None, description="The name of the Service Bus Topic. Required on PUT (CreateOrReplace) requests.", alias="topicName")
