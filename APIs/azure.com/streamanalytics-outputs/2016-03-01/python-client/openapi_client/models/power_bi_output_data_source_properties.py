...
class PowerBIOutputDataSourceProperties(BaseModel):
    """
    The properties that are associated with a Power BI output.
    """ # noqa: E501
    dataset: Optional[StrictStr] = Field(default=None, description="The name of the Power BI dataset. Required on PUT (CreateOrReplace) requests.")
    group_id: Optional[StrictStr] = Field(default=None, description="The ID of the Power BI group.", alias="groupId")
    group_name: Optional[StrictStr] = Field(default=None, description="The name of the Power BI group. Use this property to help remember which specific Power BI group id was used.", alias="groupName")
    table: Optional[StrictStr] = Field(default=None, description="The name of the Power BI table under the specified dataset. Required on PUT (CreateOrReplace) requests.")
