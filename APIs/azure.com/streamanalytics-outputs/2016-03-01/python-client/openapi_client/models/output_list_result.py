...
class OutputListResult(BaseModel):
    ...
    value: Optional[List[Output]] = Field(default=None, description="A list of outputs under a streaming job. Populated by a 'List' operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Output.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
