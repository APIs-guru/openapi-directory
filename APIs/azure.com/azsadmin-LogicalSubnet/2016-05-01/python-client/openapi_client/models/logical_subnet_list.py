...
class LogicalSubnetList(BaseModel):
    """
    ...
    value: Optional[List[LogicalSubnet]] = Field(default=None, description="List of logical subnets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LogicalSubnet.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
