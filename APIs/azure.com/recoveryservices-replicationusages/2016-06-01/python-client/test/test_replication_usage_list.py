...
class TestReplicationUsageList(unittest.TestCase):
    """ReplicationUsageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplicationUsageList:
        """Test ReplicationUsageList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplicationUsageList`
        """
        model = ReplicationUsageList()
        if include_optional:
            return ReplicationUsageList(
                value = [
                    openapi_client.models.replication_usage.ReplicationUsage(
    ...
    def testReplicationUsageList(self):
        """Test ReplicationUsageList"""
