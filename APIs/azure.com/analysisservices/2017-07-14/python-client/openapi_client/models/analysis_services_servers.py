...
class AnalysisServicesServers(BaseModel):
    """
    An array of Analysis Services resources.
    """ # noqa: E501
    value: List[AnalysisServicesServer] = Field(description="An array of Analysis Services resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AnalysisServicesServer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
