...
class SkuEnumerationForNewResourceResult(BaseModel):
    """
    An object that represents enumerating SKUs for new resources
    """ # noqa: E501
    value: Optional[List[ResourceSku]] = Field(default=None, description="The collection of available SKUs for new resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ResourceSku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
