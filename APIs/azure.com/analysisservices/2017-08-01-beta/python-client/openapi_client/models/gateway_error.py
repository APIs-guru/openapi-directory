...
class GatewayError(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Error code of list gateway.")
    message: Optional[StrictStr] = Field(default=None, description="Error message of list gateway.")
