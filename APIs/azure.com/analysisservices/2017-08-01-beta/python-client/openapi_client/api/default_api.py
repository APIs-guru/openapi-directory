...
class DefaultApi:
    ...
    def servers_list_skus_for_new(
        ...
        _param = self._servers_list_skus_for_new_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SkuEnumerationForNewResourceResult",
        }
    ...
    @validate_call
    def servers_list_skus_for_new_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="A unique identifier for a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SkuEnumerationForNewResourceResult]:
        """servers_list_skus_for_new
    ...
    @validate_call
    def servers_list_skus_for_new_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="A unique identifier for a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
    ...
    def _servers_list_skus_for_new_serialize(
        self,
        api_version,
        subscription_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.AnalysisServices/skus',
