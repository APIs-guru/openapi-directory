...
------------- | ------------- | -------------
[**servers_list_skus_for_new**](DefaultApi.md#servers_list_skus_for_new) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.AnalysisServices/skus | 


# **servers_list_skus_for_new**
> SkuEnumerationForNewResourceResult servers_list_skus_for_new(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.servers_list_skus_for_new(api_version, subscription_id)
        print("The response of DefaultApi->servers_list_skus_for_new:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->servers_list_skus_for_new: %s\n" % e)
```
