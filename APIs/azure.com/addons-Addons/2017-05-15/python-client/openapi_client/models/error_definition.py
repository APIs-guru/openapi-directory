...
class ErrorDefinition(BaseModel):
    ...
    """ # noqa: E501
    code: Annotated[int, Field(le=600, strict=True, ge=100)] = Field(description="Service specific error code which serves as the substatus for the HTTP error code.")
