...
class OperationsDisplayDefinition(BaseModel):
    """
    Display object with properties of the operation.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the operation.")
    operation: Optional[StrictStr] = Field(default=None, description="Short description of the operation.")
    provider: Optional[StrictStr] = Field(default=None, description="Resource provider of the operation.")
    resource: Optional[StrictStr] = Field(default=None, description="Resource for the operation.")
