...
class CanonicalSupportPlanProperties(BaseModel):
    """
    ...
    def provisioning_state_validate_enum(cls, value):
        ...
        if value not in set(['Succeeded', 'Failed', 'Cancelled', 'Purchasing', 'Downgrading', 'Cancelling', 'Upgrading']):
            raise ValueError("must be one of enum values ('Succeeded', 'Failed', 'Cancelled', 'Purchasing', 'Downgrading', 'Cancelling', 'Upgrading')")
        return value
