...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.Addons/operations | 


# **operations_list**
> List[OperationsDefinition] operations_list(api_version)
...
[**List[OperationsDefinition]**](OperationsDefinition.md)
