...
class ContainerServiceListResult(BaseModel):
    """
    The response from the List Container Services operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of container service results.", alias="nextLink")
    value: Optional[List[ContainerService]] = Field(default=None, description="the list of container services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ContainerService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
