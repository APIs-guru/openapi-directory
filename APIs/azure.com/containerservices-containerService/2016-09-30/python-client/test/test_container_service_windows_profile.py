...
class TestContainerServiceWindowsProfile(unittest.TestCase):
    """ContainerServiceWindowsProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContainerServiceWindowsProfile:
        """Test ContainerServiceWindowsProfile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerServiceWindowsProfile`
        """
        model = ContainerServiceWindowsProfile()
        if include_optional:
    ...
    def testContainerServiceWindowsProfile(self):
        """Test ContainerServiceWindowsProfile"""
