...
class ApplicationInsightsComponentProactiveDetectionConfigurationProperties(BaseModel):
    """
    ...
    rule_definitions: Optional[ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitions] = Field(default=None, alias="RuleDefinitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": obj.get("Name"),
            "RuleDefinitions": ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitions.from_dict(obj["RuleDefinitions"]) if obj.get("RuleDefinitions") is not None else None,
