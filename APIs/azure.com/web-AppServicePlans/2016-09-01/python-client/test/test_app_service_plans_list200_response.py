...
class TestAppServicePlansList200Response(unittest.TestCase):
    """AppServicePlansList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppServicePlansList200Response:
        """Test AppServicePlansList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppServicePlansList200Response`
        """
        model = AppServicePlansList200Response()
        if include_optional:
            return AppServicePlansList200Response(
                next_link = '',
                value = [
                    openapi_client.models.app_service_plans_list_200_response_value_inner.AppServicePlans_List_200_response_value_inner(
    ...
    def testAppServicePlansList200Response(self):
        """Test AppServicePlansList200Response"""
