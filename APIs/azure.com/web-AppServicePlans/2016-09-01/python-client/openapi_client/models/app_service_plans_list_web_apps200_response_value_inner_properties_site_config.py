...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    """
    ...
    api_definition: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigApiDefinition] = Field(default=None, alias="apiDefinition")
    app_command_line: Optional[StrictStr] = Field(default=None, description="App command line to launch.", alias="appCommandLine")
    app_settings: Optional[List[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigAppSettingsInner]] = Field(default=None, description="Application settings.", alias="appSettings")
    ...
    auto_heal_rules: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigAutoHealRules] = Field(default=None, alias="autoHealRules")
    auto_swap_slot_name: Optional[StrictStr] = Field(default=None, description="Auto-swap slot name.", alias="autoSwapSlotName")
    connection_strings: Optional[List[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner]] = Field(default=None, description="Connection strings.", alias="connectionStrings")
    cors: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigCors] = None
    ...
    experiments: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigExperiments] = None
    handler_mappings: Optional[List[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner]] = Field(default=None, description="Handler mappings.", alias="handlerMappings")
    ...
    ip_security_restrictions: Optional[List[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner]] = Field(default=None, description="IP security restrictions.", alias="ipSecurityRestrictions")
    ...
    limits: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigLimits] = None
    ...
    machine_key: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigMachineKey] = Field(default=None, alias="machineKey")
    ...
    push: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigPush] = None
    ...
    virtual_applications: Optional[List[AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner]] = Field(default=None, description="Virtual applications.", alias="virtualApplications")
    ...
    __properties: ClassVar[List[str]] = ["alwaysOn", "apiDefinition", "appCommandLine", "appSettings", "autoHealEnabled", "autoHealRules", "autoSwapSlotName", "connectionStrings", "cors", "defaultDocuments", "detailedErrorLoggingEnabled", "documentRoot", "experiments", "handlerMappings", "http20Enabled", "httpLoggingEnabled", "ipSecurityRestrictions", "javaContainer", "javaContainerVersion", "javaVersion", "limits", "linuxFxVersion", "loadBalancing", "localMySqlEnabled", "logsDirectorySizeLimit", "machineKey", "managedPipelineMode", "minTlsVersion", "netFrameworkVersion", "nodeVersion", "numberOfWorkers", "phpVersion", "publishingUsername", "push", "pythonVersion", "remoteDebuggingEnabled", "remoteDebuggingVersion", "requestTracingEnabled", "requestTracingExpirationTime", "scmType", "tracingOptions", "use32BitWorkerProcess", "virtualApplications", "vnetName", "webSocketsEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiDefinition": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigApiDefinition.from_dict(obj["apiDefinition"]) if obj.get("apiDefinition") is not None else None,
            "appCommandLine": obj.get("appCommandLine"),
            "appSettings": [AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigAppSettingsInner.from_dict(_item) for _item in obj["appSettings"]] if obj.get("appSettings") is not None else None,
            "autoHealEnabled": obj.get("autoHealEnabled"),
            "autoHealRules": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigAutoHealRules.from_dict(obj["autoHealRules"]) if obj.get("autoHealRules") is not None else None,
            "autoSwapSlotName": obj.get("autoSwapSlotName"),
            "connectionStrings": [AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner.from_dict(_item) for _item in obj["connectionStrings"]] if obj.get("connectionStrings") is not None else None,
            "cors": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigCors.from_dict(obj["cors"]) if obj.get("cors") is not None else None,
            ...
            "experiments": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigExperiments.from_dict(obj["experiments"]) if obj.get("experiments") is not None else None,
            "handlerMappings": [AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner.from_dict(_item) for _item in obj["handlerMappings"]] if obj.get("handlerMappings") is not None else None,
            ...
            "ipSecurityRestrictions": [AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner.from_dict(_item) for _item in obj["ipSecurityRestrictions"]] if obj.get("ipSecurityRestrictions") is not None else None,
            "javaContainer": obj.get("javaContainer"),
            "javaContainerVersion": obj.get("javaContainerVersion"),
            "javaVersion": obj.get("javaVersion"),
            "limits": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            ...
            "machineKey": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigMachineKey.from_dict(obj["machineKey"]) if obj.get("machineKey") is not None else None,
            ...
            "push": AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigPush.from_dict(obj["push"]) if obj.get("push") is not None else None,
            ...
            "virtualApplications": [AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner.from_dict(_item) for _item in obj["virtualApplications"]] if obj.get("virtualApplications") is not None else None,
