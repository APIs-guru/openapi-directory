...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo(BaseModel):
    ...
    ignore_quotas: Optional[StrictBool] = Field(default=None, description="<code>true</code> if quotas should be ignored; otherwise, <code>false</code>.", alias="ignoreQuotas")
    ...
    __properties: ClassVar[List[str]] = ["appSettingsOverrides", "cloneCustomHostNames", "cloneSourceControl", "configureLoadBalancing", "correlationId", "hostingEnvironment", "ignoreQuotas", "overwrite", "sourceWebAppId", "trafficManagerProfileId", "trafficManagerProfileName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ignoreQuotas": obj.get("ignoreQuotas"),
