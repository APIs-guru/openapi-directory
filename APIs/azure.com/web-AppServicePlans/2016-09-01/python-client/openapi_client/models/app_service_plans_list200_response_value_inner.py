...
class AppServicePlansList200ResponseValueInner(BaseModel):
    """
    App Service plan.
    """ # noqa: E501
    properties: Optional[AppServicePlansList200ResponseValueInnerProperties] = None
    sku: Optional[AppServicePlansList200ResponseValueInnerSku] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServicePlansList200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": AppServicePlansList200ResponseValueInnerSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None
        })
        return _obj
