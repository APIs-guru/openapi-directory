...
class AppServicePlansListUsages200ResponseValueInner(BaseModel):
    """
    ...
    name: Optional[AppServicePlansListUsages200ResponseValueInnerName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "name": AppServicePlansListUsages200ResponseValueInnerName.from_dict(obj["name"]) if obj.get("name") is not None else None,
