...
class HybridConnectionCollectionValueInner(BaseModel):
    """
    Hybrid Connection contract. This is used to configure a Hybrid Connection.
    """ # noqa: E501
    properties: Optional[AppServicePlansGetHybridConnection200ResponseProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServicePlansGetHybridConnection200ResponseProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
