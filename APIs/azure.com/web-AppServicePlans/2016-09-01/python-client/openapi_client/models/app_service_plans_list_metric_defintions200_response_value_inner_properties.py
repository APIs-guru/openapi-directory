...
class AppServicePlansListMetricDefintions200ResponseValueInnerProperties(BaseModel):
    """
    ResourceMetricDefinition resource specific properties
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Resource ID.")
    metric_availabilities: Optional[List[AppServicePlansListMetricDefintions200ResponseValueInnerPropertiesMetricAvailabilitiesInner]] = Field(default=None, description="List of time grains supported for the metric together with retention period.", alias="metricAvailabilities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metricAvailabilities": [AppServicePlansListMetricDefintions200ResponseValueInnerPropertiesMetricAvailabilitiesInner.from_dict(_item) for _item in obj["metricAvailabilities"]] if obj.get("metricAvailabilities") is not None else None,
