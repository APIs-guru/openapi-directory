...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfo(BaseModel):
    """
    Details about app recovery operation.
    """ # noqa: E501
    properties: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfoProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfoProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
