...
class AppServicePlansListMetrics200ResponseValueInner(BaseModel):
    """
    ...
    metric_values: Optional[List[AppServicePlansListMetrics200ResponseValueInnerMetricValuesInner]] = Field(default=None, description="Metric values.", alias="metricValues")
    name: Optional[AppServicePlansListMetricDefintions200ResponseValueInnerPropertiesName] = None
    properties: Optional[List[AppServicePlansListMetrics200ResponseValueInnerMetricValuesInnerPropertiesInner]] = Field(default=None, description="Resource metric properties collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metricValues": [AppServicePlansListMetrics200ResponseValueInnerMetricValuesInner.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None,
            "name": AppServicePlansListMetricDefintions200ResponseValueInnerPropertiesName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "properties": [AppServicePlansListMetrics200ResponseValueInnerMetricValuesInnerPropertiesInner.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
