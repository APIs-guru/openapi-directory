...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfoProperties(BaseModel):
    """
    ...
    recovery_target: Optional[AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfoPropertiesRecoveryTarget] = Field(default=None, alias="recoveryTarget")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoveryTarget": AppServicePlansListWebApps200ResponseValueInnerPropertiesSnapshotInfoPropertiesRecoveryTarget.from_dict(obj["recoveryTarget"]) if obj.get("recoveryTarget") is not None else None,
