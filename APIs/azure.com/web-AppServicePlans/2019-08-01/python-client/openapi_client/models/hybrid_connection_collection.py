...
class HybridConnectionCollection(BaseModel):
    """
    Collection of hostname bindings.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page of resources.", alias="nextLink")
    value: List[HybridConnectionCollectionValueInner] = Field(description="Collection of resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [HybridConnectionCollectionValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
