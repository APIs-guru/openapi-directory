...
class AppServicePlansListVnets200ResponseInner(BaseModel):
    """
    Virtual Network information contract.
    """ # noqa: E501
    properties: Optional[AppServicePlansListVnets200ResponseInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServicePlansListVnets200ResponseInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
