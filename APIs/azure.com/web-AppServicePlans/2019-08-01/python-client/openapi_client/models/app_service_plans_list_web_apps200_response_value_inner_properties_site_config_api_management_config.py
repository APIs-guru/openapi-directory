...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesSiteConfigApiManagementConfig(BaseModel):
    """
    Azure API management (APIM) configuration linked to the app.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="APIM-Api Identifier.")
