...
class AppServicePlanPatchResource(BaseModel):
    """
    ARM resource for a app service plan.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="AppServicePlanPatchResource resource specific properties")
