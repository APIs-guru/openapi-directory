...
class AppServicePlansListMetrics200ResponseValueInner(BaseModel):
    ...
    name: Optional[AppServicePlansListMetrics200ResponseValueInnerName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": AppServicePlansListMetrics200ResponseValueInnerName.from_dict(obj["name"]) if obj.get("name") is not None else None,
