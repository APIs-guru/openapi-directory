...
class AppServicePlansListVnets200ResponseInnerPropertiesRoutesInner(BaseModel):
    """
    Virtual Network route contract used to pass routing information for a Virtual Network.
    """ # noqa: E501
    properties: Optional[AppServicePlansListVnets200ResponseInnerPropertiesRoutesInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServicePlansListVnets200ResponseInnerPropertiesRoutesInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
