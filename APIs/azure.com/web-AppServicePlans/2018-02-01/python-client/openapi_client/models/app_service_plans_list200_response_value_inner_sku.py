...
class AppServicePlansList200ResponseValueInnerSku(BaseModel):
    """
    Description of a SKU for a scalable resource.
    """ # noqa: E501
    capabilities: Optional[List[AppServicePlansList200ResponseValueInnerSkuCapabilitiesInner]] = Field(default=None, description="Capabilities of the SKU, e.g., is traffic manager enabled?")
    ...
    sku_capacity: Optional[AppServicePlansList200ResponseValueInnerSkuSkuCapacity] = Field(default=None, alias="skuCapacity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": [AppServicePlansList200ResponseValueInnerSkuCapabilitiesInner.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None,
            "capacity": obj.get("capacity"),
            "family": obj.get("family"),
            "locations": obj.get("locations"),
            "name": obj.get("name"),
            "size": obj.get("size"),
            "skuCapacity": AppServicePlansList200ResponseValueInnerSkuSkuCapacity.from_dict(obj["skuCapacity"]) if obj.get("skuCapacity") is not None else None,
            "tier": obj.get("tier")
        })
        return _obj
