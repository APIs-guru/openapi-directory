...
class TestAppServicePlansList200ResponseValueInner(unittest.TestCase):
    """AppServicePlansList200ResponseValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppServicePlansList200ResponseValueInner:
        """Test AppServicePlansList200ResponseValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppServicePlansList200ResponseValueInner`
        """
        model = AppServicePlansList200ResponseValueInner()
        if include_optional:
            return AppServicePlansList200ResponseValueInner(
    ...
    def testAppServicePlansList200ResponseValueInner(self):
        """Test AppServicePlansList200ResponseValueInner"""
