...
class WorkbooksListResult(BaseModel):
    """
    Workbook list result.
    """ # noqa: E501
    value: Optional[List[Workbook]] = Field(default=None, description="An array of workbooks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Workbook.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
