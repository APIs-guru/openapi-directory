...
> Workbook workbooks_create_or_update(subscription_id, resource_group_name, resource_name, source_id, api_version, workbook_properties)
 ...
 **source_id** | **str**| Azure Resource Id that will fetch all related workbooks. | 
...
> WorkbooksListResult workbooks_list_by_resource_group(subscription_id, resource_group_name, category, source_id, api_version, tags=tags, can_fetch_content=can_fetch_content)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.workbooks_list_by_resource_group(subscription_id, resource_group_name, category, source_id, api_version, tags=tags, can_fetch_content=can_fetch_content)
...
# **workbooks_update**
> Workbook workbooks_update(subscription_id, resource_group_name, resource_name, source_id, api_version, workbook_update_parameters=workbook_update_parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    source_id = 'source_id_example' # str | Azure Resource Id that will fetch all related workbooks.
    api_version = 'api_version_example' # str | The API version to use for this operation.
    workbook_update_parameters = openapi_client.WorkbookUpdateParameters() # WorkbookUpdateParameters | Properties that need to be specified to create a new workbook. (optional)

    try:
        api_response = api_instance.workbooks_update(subscription_id, resource_group_name, resource_name, source_id, api_version, workbook_update_parameters=workbook_update_parameters)
 ...
 **source_id** | **str**| Azure Resource Id that will fetch all related workbooks. | 
 **api_version** | **str**| The API version to use for this operation. | 
 **workbook_update_parameters** | [**WorkbookUpdateParameters**](WorkbookUpdateParameters.md)| Properties that need to be specified to create a new workbook. | [optional] 
