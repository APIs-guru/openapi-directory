...
class WorkbookUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="The kind of workbook. Choices are user and shared.")
    properties: Optional[WorkbookPropertiesUpdateParameters] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Resource tags")
    __properties: ClassVar[List[str]] = ["kind", "properties", "tags"]
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['user', 'shared']):
            raise ValueError("must be one of enum values ('user', 'shared')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "properties": WorkbookPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
