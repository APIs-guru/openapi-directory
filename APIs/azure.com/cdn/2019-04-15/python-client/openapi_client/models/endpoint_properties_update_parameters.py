...
class EndpointPropertiesUpdateParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentTypesToCompress", "deliveryPolicy", "geoFilters", "isCompressionEnabled", "isHttpAllowed", "isHttpsAllowed", "optimizationType", "originHostHeader", "originPath", "probePath", "queryStringCachingBehavior"]
