...
**provider** | **str** | Service provider: Microsoft.Cdn | [optional] [readonly] 
**resource** | **str** | Resource on which the operation is performed: Profile, endpoint, etc. | [optional] [readonly] 
