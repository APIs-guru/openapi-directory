...
class EndpointUpdateParameters(BaseModel):
    """
    Endpoint properties required for new endpoint creation.
    """ # noqa: E501
    properties: Optional[EndpointPropertiesUpdateParameters] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Endpoint tags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": EndpointPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
