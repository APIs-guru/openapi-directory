...
class Sku(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['Standard_Verizon', 'Premium_Verizon', 'Custom_Verizon', 'Standard_Akamai']):
            raise ValueError("must be one of enum values ('Standard_Verizon', 'Premium_Verizon', 'Custom_Verizon', 'Standard_Akamai')")
        return value
