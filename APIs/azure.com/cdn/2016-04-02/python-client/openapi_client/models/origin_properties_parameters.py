...
class OriginPropertiesParameters(BaseModel):
    ...
    http_port: Optional[StrictInt] = Field(default=None, description="The value of the HTTP port. Must be between 1 and 65535.", alias="httpPort")
    https_port: Optional[StrictInt] = Field(default=None, description="The value of the HTTPS port. Must be between 1 and 65535.", alias="httpsPort")
