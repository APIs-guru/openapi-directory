...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | URL to get the next set of endpoint objects if there is any. | [optional] 
**value** | [**List[Endpoint]**](Endpoint.md) | List of CDN endpoints within a profile | [optional] [readonly] 
