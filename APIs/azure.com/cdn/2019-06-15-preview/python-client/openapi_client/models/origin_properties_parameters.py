...
class OriginPropertiesParameters(BaseModel):
    """
    The JSON object that contains the properties of the origin.
    """ # noqa: E501
    host_name: Optional[StrictStr] = Field(default=None, description="The address of the origin. Domain names, IPv4 addresses, and IPv6 addresses are supported.", alias="hostName")
