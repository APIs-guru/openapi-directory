...
class CustomDomainHttpsParameters(BaseModel):
    ...
    minimum_tls_version: Optional[StrictStr] = Field(default=None, description="TLS protocol version that will be used for Https", alias="minimumTlsVersion")
    ...
    def minimum_tls_version_validate_enum(cls, value):
        ...
        if value not in set(['None', 'TLS10', 'TLS12']):
            raise ValueError("must be one of enum values ('None', 'TLS10', 'TLS12')")
        return value
