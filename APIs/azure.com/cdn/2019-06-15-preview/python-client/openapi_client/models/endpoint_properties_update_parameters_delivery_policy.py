...
class EndpointPropertiesUpdateParametersDeliveryPolicy(BaseModel):
    """
    A policy that specifies the delivery rules to be used for an endpoint.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="User-friendly description of the policy.")
    rules: List[DeliveryRule] = Field(description="A list of the delivery rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [DeliveryRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
