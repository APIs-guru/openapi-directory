...
class EndpointProperties(BaseModel):
    ...
    web_application_firewall_policy_link: Optional[EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink] = Field(default=None, alias="webApplicationFirewallPolicyLink")
    __properties: ClassVar[List[str]] = ["contentTypesToCompress", "deliveryPolicy", "geoFilters", "isCompressionEnabled", "isHttpAllowed", "isHttpsAllowed", "optimizationType", "originHostHeader", "originPath", "probePath", "queryStringCachingBehavior", "webApplicationFirewallPolicyLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webApplicationFirewallPolicyLink": EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink.from_dict(obj["webApplicationFirewallPolicyLink"]) if obj.get("webApplicationFirewallPolicyLink") is not None else None
        })
        return _obj
