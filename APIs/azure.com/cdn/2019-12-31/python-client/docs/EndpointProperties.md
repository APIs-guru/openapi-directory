...
**origin_groups** | [**List[DeepCreatedOriginGroup]**](DeepCreatedOriginGroup.md) | The origin groups comprising of origins that are used for load balancing the traffic based on availability. | [optional] 
