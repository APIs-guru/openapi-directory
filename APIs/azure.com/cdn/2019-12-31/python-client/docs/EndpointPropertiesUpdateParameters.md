...
**default_origin_group** | [**ResourceReference**](ResourceReference.md) |  | [optional] 
...
**probe_path** | **str** | Path to a file hosted on the origin which helps accelerate delivery of the dynamic content and calculate the most optimal routes for the CDN. This is relative to the origin path. This property is only relevant when using a single origin. | [optional] 
