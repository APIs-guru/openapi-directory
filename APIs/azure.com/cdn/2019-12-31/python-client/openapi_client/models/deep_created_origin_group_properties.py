...
class DeepCreatedOriginGroupProperties(BaseModel):
    """
    ...
    origins: List[ResourceReference] = Field(description="The source of the content being delivered via CDN within given origin group.")
