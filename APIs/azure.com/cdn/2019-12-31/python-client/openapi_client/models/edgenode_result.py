...
class EdgenodeResult(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of edgenode list results if there are any.", alias="nextLink")
    value: Optional[List[EdgeNode]] = Field(default=None, description="Edge node of CDN service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EdgeNode.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
