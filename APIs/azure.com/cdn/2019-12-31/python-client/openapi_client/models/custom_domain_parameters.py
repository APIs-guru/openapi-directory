...
class CustomDomainParameters(BaseModel):
    """
    The customDomain JSON object required for custom domain creation or update.
    """ # noqa: E501
    properties: Optional[CustomDomainPropertiesParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": CustomDomainPropertiesParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
