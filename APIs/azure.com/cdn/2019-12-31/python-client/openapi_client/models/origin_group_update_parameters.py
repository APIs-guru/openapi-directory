...
class OriginGroupUpdateParameters(BaseModel):
    """
    Origin group properties needed for origin group creation or update.
    """ # noqa: E501
    properties: Optional[OriginGroupUpdatePropertiesParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": OriginGroupUpdatePropertiesParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
