...
class EndpointProperties(BaseModel):
    ...
    """ # noqa: E501
    host_name: Optional[StrictStr] = Field(default=None, description="The host name of the endpoint structured as {endpointName}.{DNSZone}, e.g. contoso.azureedge.net", alias="hostName")
    origin_groups: Optional[List[DeepCreatedOriginGroup]] = Field(default=None, description="The origin groups comprising of origins that are used for load balancing the traffic based on availability.", alias="originGroups")
    origins: List[DeepCreatedOrigin] = Field(description="The source of the content being delivered via CDN.")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning status of the endpoint.", alias="provisioningState")
    resource_state: Optional[StrictStr] = Field(default=None, description="Resource status of the endpoint.", alias="resourceState")
    ...
    def resource_state_validate_enum(cls, value):
        ...
        if value not in set(['Creating', 'Deleting', 'Running', 'Starting', 'Stopped', 'Stopping']):
            raise ValueError("must be one of enum values ('Creating', 'Deleting', 'Running', 'Starting', 'Stopped', 'Stopping')")
        return value
