...
class CustomDomainProperties(BaseModel):
    ...
    """ # noqa: E501
    custom_https_provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of Custom Https of the custom domain.", alias="customHttpsProvisioningState")
    ...
    __properties: ClassVar[List[str]] = ["customHttpsProvisioningState", "hostName", "provisioningState", "resourceState", "validationData"]
