...
class DeepCreatedOrigin(BaseModel):
    """
    Origin to be added when creating a CDN endpoint.
    """ # noqa: E501
    name: StrictStr = Field(description="Origin name")
    properties: Optional[DeepCreatedOriginProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": DeepCreatedOriginProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
