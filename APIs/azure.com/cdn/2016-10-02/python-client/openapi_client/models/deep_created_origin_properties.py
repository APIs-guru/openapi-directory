...
class DeepCreatedOriginProperties(BaseModel):
    ...
    """ # noqa: E501
    host_name: StrictStr = Field(description="The address of the origin. It can be a domain names, IPv4 address, or IPv6 address.", alias="hostName")
    ...
    __properties: ClassVar[List[str]] = ["hostName", "httpPort", "httpsPort"]
