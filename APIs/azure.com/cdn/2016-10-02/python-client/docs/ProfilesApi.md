...
[**profiles_get_supported_optimization_types**](ProfilesApi.md#profiles_get_supported_optimization_types) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/getSupportedOptimizationTypes | 
...
# **profiles_get_supported_optimization_types**
> SupportedOptimizationTypesResult profiles_get_supported_optimization_types(resource_group_name, profile_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.profiles_get_supported_optimization_types(resource_group_name, profile_name, subscription_id, api_version)
        print("The response of ProfilesApi->profiles_get_supported_optimization_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProfilesApi->profiles_get_supported_optimization_types: %s\n" % e)
```
...
[**SupportedOptimizationTypesResult**](SupportedOptimizationTypesResult.md)
