...
------------ | ------------- | ------------- | -------------
**current_value** | **int** | Actual value of the resource type. | [optional] 
**limit** | **int** | Quota of the resource type. | [optional] 
**resource_type** | **str** | Resource type of the usages. | [optional] 
**unit** | **str** | Unit of the usage. e.g. Count. | [optional] 
