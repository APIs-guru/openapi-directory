...
class EndpointCreateParameters(BaseModel):
    """
    Endpoint properties required for new endpoint creation.
    """ # noqa: E501
    location: StrictStr = Field(description="Endpoint location")
    properties: Optional[EndpointPropertiesCreateParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": EndpointPropertiesCreateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
