...
class OriginListResult(BaseModel):
    """
    OriginListResult
    """ # noqa: E501
    value: Optional[List[Origin]] = Field(default=None, description="List of CDN origins within an endpoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Origin.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
