...
class CheckNameAvailabilityOutput(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The detailed error message describing why the name is not available.", alias="Message")
    ...
    reason: Optional[StrictStr] = Field(default=None, description="The reason why the name is not available.", alias="Reason")
