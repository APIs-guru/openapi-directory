...
class OriginUpdateParameters(BaseModel):
    """
    Origin properties needed for origin creation or update.
    """ # noqa: E501
    properties: Optional[OriginPropertiesParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": OriginPropertiesParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
