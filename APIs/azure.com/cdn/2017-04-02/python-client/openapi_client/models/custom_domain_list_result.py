...
class CustomDomainListResult(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of custom domain objects if there are any.", alias="nextLink")
    value: Optional[List[CustomDomain]] = Field(default=None, description="List of CDN CustomDomains within an endpoint.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CustomDomain.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
