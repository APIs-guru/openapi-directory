...
class EndpointPropertiesUpdateParameters(BaseModel):
    ...
    probe_path: Optional[StrictStr] = Field(default=None, description="Path to a file hosted on the origin which helps accelerate delivery of the dynamic content and calculate the most optimal routes for the CDN. This is relative to the origin path.", alias="probePath")
    query_string_caching_behavior: Optional[QueryStringCachingBehavior] = Field(default=None, alias="queryStringCachingBehavior")
    __properties: ClassVar[List[str]] = ["contentTypesToCompress", "geoFilters", "isCompressionEnabled", "isHttpAllowed", "isHttpsAllowed", "optimizationType", "originHostHeader", "originPath", "probePath", "queryStringCachingBehavior"]
