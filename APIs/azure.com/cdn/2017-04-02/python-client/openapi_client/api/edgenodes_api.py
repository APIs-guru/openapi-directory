...
class EdgenodesApi:
    ...
    def edge_nodes_list(
        ...
        _param = self._edge_nodes_list_serialize(
    ...
    @validate_call
    def edge_nodes_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def edge_nodes_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
            None,
    ...
    def _edge_nodes_list_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Cdn/edgenodes',
