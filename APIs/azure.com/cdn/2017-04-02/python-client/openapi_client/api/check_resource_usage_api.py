...
class CheckResourceUsageApi:
    ...
    def resource_usage_list(
        ...
        _param = self._resource_usage_list_serialize(
    ...
    @validate_call
    def resource_usage_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
    ...
    @validate_call
    def resource_usage_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
    ...
    def _resource_usage_list_serialize(
        self,
        subscription_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Cdn/checkResourceUsage',
