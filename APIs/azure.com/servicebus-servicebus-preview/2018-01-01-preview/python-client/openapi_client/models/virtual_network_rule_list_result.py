...
class VirtualNetworkRuleListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next set of results. Not empty if Value contains an incomplete list of VirtualNetwork Rules", alias="nextLink")
    value: Optional[List[VirtualNetworkRule]] = Field(default=None, description="Result of the List VirtualNetwork Rules operation.")
