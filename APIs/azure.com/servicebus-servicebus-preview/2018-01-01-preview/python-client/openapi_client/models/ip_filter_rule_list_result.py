...
class IpFilterRuleListResult(BaseModel):
    """
    The response from the List namespace operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next set of results. Not empty if Value contains an incomplete list of IpFilter Rules", alias="nextLink")
    value: Optional[List[IpFilterRule]] = Field(default=None, description="Result of the List IpFilter Rules operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IpFilterRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
