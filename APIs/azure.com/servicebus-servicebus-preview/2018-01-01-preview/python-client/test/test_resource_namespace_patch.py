...
class TestResourceNamespacePatch(unittest.TestCase):
    """ResourceNamespacePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceNamespacePatch:
        """Test ResourceNamespacePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceNamespacePatch`
        """
    ...
    def testResourceNamespacePatch(self):
        """Test ResourceNamespacePatch"""
