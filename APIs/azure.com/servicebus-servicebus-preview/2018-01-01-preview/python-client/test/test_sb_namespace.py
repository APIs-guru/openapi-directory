...
class TestSBNamespace(unittest.TestCase):
    """SBNamespace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBNamespace:
        """Test SBNamespace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBNamespace`
        """
        model = SBNamespace()
        if include_optional:
            return SBNamespace(
