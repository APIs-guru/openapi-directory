...
class DataLakeAnalyticsAccountListResult(BaseModel):
    """
    ...
    value: Optional[List[DataLakeAnalyticsAccount]] = Field(default=None, description="the results of the list operation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DataLakeAnalyticsAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
