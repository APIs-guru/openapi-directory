...
class DataLakeStoreAccountInfo(BaseModel):
    """
    Data Lake Store account information.
    """ # noqa: E501
    name: StrictStr = Field(description="the account name of the Data Lake Store account.")
    properties: Optional[DataLakeStoreAccountInfoProperties] = None
