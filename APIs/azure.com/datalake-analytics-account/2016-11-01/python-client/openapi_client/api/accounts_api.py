...
class AccountsApi:
    ...
    def accounts_check_name_availability(
        ...
        parameters: Annotated[CheckNameAvailabilityParameters, Field(description="Parameters supplied to check the Data Lake Analytics account name availability.")],
        ...
        :param parameters: Parameters supplied to check the Data Lake Analytics account name availability. (required)
    ...
    def _accounts_check_name_availability_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeAnalytics/locations/{location}/checkNameAvailability',
    ...
    def accounts_create(
        ...
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        parameters: Annotated[CreateDataLakeAnalyticsAccountParameters, Field(description="Parameters supplied to create a new Data Lake Analytics account.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: CreateDataLakeAnalyticsAccountParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def accounts_update(
        ...
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        parameters: Annotated[Optional[UpdateDataLakeAnalyticsAccountParameters], Field(description="Parameters supplied to the update Data Lake Analytics account operation.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: UpdateDataLakeAnalyticsAccountParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
