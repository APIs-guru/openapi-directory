...
class LocationsApi:
    ...
    def locations_get_capability(
        ...
        _param = self._locations_get_capability_serialize(
    ...
    @validate_call
    def locations_get_capability_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="The resource location without whitespace.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CapabilityInformation]:
        """locations_get_capability
    ...
    @validate_call
    def locations_get_capability_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="The resource location without whitespace.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _locations_get_capability_serialize(
        self,
        subscription_id,
        location,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeAnalytics/locations/{location}/capability',
