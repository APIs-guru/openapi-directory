...
class DataLakeStoreAccountsApi:
    ...
    @validate_call
    def data_lake_store_accounts_add(
        self,
        ...
        parameters: Annotated[Optional[AddDataLakeStoreParameters], Field(description="The details of the Data Lake Store account.")] = None,
        ...
        _param = self._data_lake_store_accounts_add_serialize(
    ...
    @validate_call
    def data_lake_store_accounts_add_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    @validate_call
    def data_lake_store_accounts_add_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    def _data_lake_store_accounts_add_serialize(
        self,
        subscription_id,
        resource_group_name,
        account_name,
    ...
    @validate_call
    def data_lake_store_accounts_delete(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        ...
        _param = self._data_lake_store_accounts_delete_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            data_lake_store_account_name=data_lake_store_account_name,
    ...
    @validate_call
    def data_lake_store_accounts_delete_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    @validate_call
    def data_lake_store_accounts_delete_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    def _data_lake_store_accounts_delete_serialize(
        self,
        subscription_id,
        resource_group_name,
        account_name,
    ...
    @validate_call
    def data_lake_store_accounts_get(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        ...
        _param = self._data_lake_store_accounts_get_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            data_lake_store_account_name=data_lake_store_account_name,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DataLakeStoreAccountInformation",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def data_lake_store_accounts_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataLakeStoreAccountInformation]:
        """data_lake_store_accounts_get
    ...
    @validate_call
    def data_lake_store_accounts_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    def _data_lake_store_accounts_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        account_name,
    ...
    @validate_call
    def data_lake_store_accounts_list_by_account(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        ...
        _param = self._data_lake_store_accounts_list_by_account_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DataLakeStoreAccountInformationListResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def data_lake_store_accounts_list_by_account_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataLakeStoreAccountInformationListResult]:
        """data_lake_store_accounts_list_by_account
    ...
    @validate_call
    def data_lake_store_accounts_list_by_account_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the Azure resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the Data Lake Analytics account.")],
    ...
    def _data_lake_store_accounts_list_by_account_serialize(
        self,
        subscription_id,
        resource_group_name,
        account_name,
