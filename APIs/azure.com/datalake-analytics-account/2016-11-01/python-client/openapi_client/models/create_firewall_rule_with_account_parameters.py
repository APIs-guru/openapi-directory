...
class CreateFirewallRuleWithAccountParameters(BaseModel):
    """
    The parameters used to create a new firewall rule while creating a new Data Lake Analytics account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the firewall rule to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": CreateOrUpdateFirewallRuleProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
