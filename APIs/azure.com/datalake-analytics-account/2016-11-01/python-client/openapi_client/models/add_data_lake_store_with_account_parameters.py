...
class AddDataLakeStoreWithAccountParameters(BaseModel):
    """
    The parameters used to add a new Data Lake Store account while creating a new Data Lake Analytics account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the Data Lake Store account to add.")
    properties: Optional[AddDataLakeStoreProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": AddDataLakeStoreProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
