...
class UpdateDataLakeStoreWithAccountParameters(BaseModel):
    """
    The parameters used to update a Data Lake Store account while updating a Data Lake Analytics account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the Data Lake Store account to update.")
    properties: Optional[UpdateDataLakeStoreProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": UpdateDataLakeStoreProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
