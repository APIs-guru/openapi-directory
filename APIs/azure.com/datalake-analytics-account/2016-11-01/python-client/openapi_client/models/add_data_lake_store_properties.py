...
class AddDataLakeStoreProperties(BaseModel):
    """
    The Data Lake Store account properties to use when adding a new Data Lake Store account.
    """ # noqa: E501
    suffix: Optional[StrictStr] = Field(default=None, description="The optional suffix for the Data Lake Store account.")
    __properties: ClassVar[List[str]] = ["suffix"]
