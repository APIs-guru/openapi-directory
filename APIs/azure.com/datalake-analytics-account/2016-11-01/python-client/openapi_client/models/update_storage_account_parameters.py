...
class UpdateStorageAccountParameters(BaseModel):
    """
    The parameters used to update an Azure Storage account.
    """ # noqa: E501
    properties: Optional[UpdateStorageAccountProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UpdateStorageAccountProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
