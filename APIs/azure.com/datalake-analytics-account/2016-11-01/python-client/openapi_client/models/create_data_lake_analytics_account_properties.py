...
class CreateDataLakeAnalyticsAccountProperties(BaseModel):
    """
    CreateDataLakeAnalyticsAccountProperties
    """ # noqa: E501
    compute_policies: Optional[List[CreateComputePolicyWithAccountParameters]] = Field(default=None, description="The list of compute policies associated with this account.", alias="computePolicies")
    data_lake_store_accounts: List[AddDataLakeStoreWithAccountParameters] = Field(description="The list of Data Lake Store accounts associated with this account.", alias="dataLakeStoreAccounts")
    default_data_lake_store_account: StrictStr = Field(description="The default Data Lake Store account associated with this account.", alias="defaultDataLakeStoreAccount")
    ...
    firewall_rules: Optional[List[CreateFirewallRuleWithAccountParameters]] = Field(default=None, description="The list of firewall rules associated with this account.", alias="firewallRules")
    ...
    storage_accounts: Optional[List[AddStorageAccountWithAccountParameters]] = Field(default=None, description="The list of Azure Blob Storage accounts associated with this account.", alias="storageAccounts")
    __properties: ClassVar[List[str]] = ["computePolicies", "dataLakeStoreAccounts", "defaultDataLakeStoreAccount", "firewallAllowAzureIps", "firewallRules", "firewallState", "maxDegreeOfParallelism", "maxDegreeOfParallelismPerJob", "maxJobCount", "minPriorityPerJob", "newTier", "queryStoreRetention", "storageAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "computePolicies": [CreateComputePolicyWithAccountParameters.from_dict(_item) for _item in obj["computePolicies"]] if obj.get("computePolicies") is not None else None,
            "dataLakeStoreAccounts": [AddDataLakeStoreWithAccountParameters.from_dict(_item) for _item in obj["dataLakeStoreAccounts"]] if obj.get("dataLakeStoreAccounts") is not None else None,
            ...
            "maxDegreeOfParallelism": obj.get("maxDegreeOfParallelism") if obj.get("maxDegreeOfParallelism") is not None else 30,
            "maxDegreeOfParallelismPerJob": obj.get("maxDegreeOfParallelismPerJob"),
            "maxJobCount": obj.get("maxJobCount") if obj.get("maxJobCount") is not None else 3,
            "minPriorityPerJob": obj.get("minPriorityPerJob"),
            "newTier": obj.get("newTier"),
            "queryStoreRetention": obj.get("queryStoreRetention") if obj.get("queryStoreRetention") is not None else 30,
            "storageAccounts": [AddStorageAccountWithAccountParameters.from_dict(_item) for _item in obj["storageAccounts"]] if obj.get("storageAccounts") is not None else None
        })
        return _obj
