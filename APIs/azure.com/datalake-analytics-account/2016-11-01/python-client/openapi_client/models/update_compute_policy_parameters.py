...
class UpdateComputePolicyParameters(BaseModel):
    """
    The parameters used to update a compute policy.
    """ # noqa: E501
    properties: Optional[UpdateComputePolicyProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UpdateComputePolicyProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
