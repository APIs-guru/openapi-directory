...
class UpdateFirewallRuleWithAccountParameters(BaseModel):
    """
    The parameters used to update a firewall rule while updating a Data Lake Analytics account.
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name of the firewall rule to update.")
    properties: Optional[UpdateFirewallRuleProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": UpdateFirewallRuleProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
