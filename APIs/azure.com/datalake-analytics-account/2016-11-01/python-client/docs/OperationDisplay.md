...
------------ | ------------- | ------------- | -------------
**description** | **str** | A friendly description of the operation. | [optional] [readonly] 
**operation** | **str** | A friendly name of the operation. | [optional] [readonly] 
**provider** | **str** | The resource provider of the operation. | [optional] [readonly] 
**resource** | **str** | The resource type of the operation. | [optional] [readonly] 
