...
------------ | ------------- | ------------- | -------------
**message** | **str** | The message describing why the Data Lake Analytics account name is not available, if nameAvailable is false. | [optional] [readonly] 
**name_available** | **bool** | The Boolean value of true or false to indicate whether the Data Lake Analytics account name is available or not. | [optional] [readonly] 
**reason** | **str** | The reason why the Data Lake Analytics account name is not available, if nameAvailable is false. | [optional] [readonly] 
