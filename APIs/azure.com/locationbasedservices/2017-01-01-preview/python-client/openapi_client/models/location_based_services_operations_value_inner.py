...
class LocationBasedServicesOperationsValueInner(BaseModel):
    """
    LocationBasedServicesOperationsValueInner
    """ # noqa: E501
    display: Optional[LocationBasedServicesOperationsValueInnerDisplay] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": LocationBasedServicesOperationsValueInnerDisplay.from_dict(obj["display"]) if obj.get("display") is not None else None,
            "name": obj.get("name"),
