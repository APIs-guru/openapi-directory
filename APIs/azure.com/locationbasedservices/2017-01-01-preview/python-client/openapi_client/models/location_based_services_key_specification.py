...
class LocationBasedServicesKeySpecification(BaseModel):
    """
    Whether the operation refers to the primary or secondary key.
    """ # noqa: E501
    key_type: StrictStr = Field(description="Whether the operation refers to the primary or secondary key.", alias="keyType")
