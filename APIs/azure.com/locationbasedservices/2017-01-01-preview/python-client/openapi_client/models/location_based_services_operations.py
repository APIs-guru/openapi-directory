...
class LocationBasedServicesOperations(BaseModel):
    """
    The set of operations available for Location Based Services.
    """ # noqa: E501
    value: Optional[List[LocationBasedServicesOperationsValueInner]] = Field(default=None, description="An operation available for Location Based Services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [LocationBasedServicesOperationsValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
