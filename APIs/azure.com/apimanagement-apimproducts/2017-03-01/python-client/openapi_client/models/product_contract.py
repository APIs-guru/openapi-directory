...
class ProductContract(BaseModel):
    ...
    Product details.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the Product entity.")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=300)] = Field(description="Product name.")
    ...
    __properties: ClassVar[List[str]] = ["name", "approvalRequired", "description", "state", "subscriptionRequired", "subscriptionsLimit", "terms"]
