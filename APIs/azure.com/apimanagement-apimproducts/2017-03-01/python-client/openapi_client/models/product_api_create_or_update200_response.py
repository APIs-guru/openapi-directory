...
class ProductApiCreateOrUpdate200Response(BaseModel):
    """
    ...
    authentication_settings: Optional[ProductApiCreateOrUpdate200ResponseAllOfAllOfAuthenticationSettings] = Field(default=None, alias="authenticationSettings")
    ...
    subscription_key_parameter_names: Optional[ProductApiCreateOrUpdate200ResponseAllOfAllOfSubscriptionKeyParameterNames] = Field(default=None, alias="subscriptionKeyParameterNames")
    type: Optional[StrictStr] = Field(default=None, description="Type of API.")
    __properties: ClassVar[List[str]] = ["name", "path", "protocols", "serviceUrl", "apiRevision", "authenticationSettings", "description", "isCurrent", "isOnline", "subscriptionKeyParameterNames", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authenticationSettings": ProductApiCreateOrUpdate200ResponseAllOfAllOfAuthenticationSettings.from_dict(obj["authenticationSettings"]) if obj.get("authenticationSettings") is not None else None,
            "description": obj.get("description"),
            "isCurrent": obj.get("isCurrent"),
            "isOnline": obj.get("isOnline"),
            "subscriptionKeyParameterNames": ProductApiCreateOrUpdate200ResponseAllOfAllOfSubscriptionKeyParameterNames.from_dict(obj["subscriptionKeyParameterNames"]) if obj.get("subscriptionKeyParameterNames") is not None else None,
            "type": obj.get("type")
        })
        return _obj
