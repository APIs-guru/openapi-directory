...
class ProductPolicyListByProduct200ResponseValueInner(BaseModel):
    """
    Policy contract Properties.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Policy identifier.")
    policy_content: StrictStr = Field(description="Json escaped Xml Encoded contents of the Policy.", alias="policyContent")
    __properties: ClassVar[List[str]] = ["id", "policyContent"]
