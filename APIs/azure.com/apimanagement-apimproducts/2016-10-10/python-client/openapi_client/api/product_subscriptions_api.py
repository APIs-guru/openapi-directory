...
class ProductSubscriptionsApi:
    ...
    @validate_call
    def product_subscriptions_list_by_products(
        self,
        ...
        _param = self._product_subscriptions_list_by_products_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductSubscriptionsListByProducts200Response",
        }
    ...
    @validate_call
    def product_subscriptions_list_by_products_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductSubscriptionsListByProducts200Response]:
        """product_subscriptions_list_by_products
    ...
    @validate_call
    def product_subscriptions_list_by_products_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _product_subscriptions_list_by_products_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
