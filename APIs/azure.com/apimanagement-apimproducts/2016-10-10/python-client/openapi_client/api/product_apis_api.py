...
class ProductApisApi:
    ...
    def product_apis_create(
        ...
        _param = self._product_apis_create_serialize(
    ...
    @validate_call
    def product_apis_create_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def product_apis_create_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _product_apis_create_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
    ...
    def product_apis_delete(
        ...
        _param = self._product_apis_delete_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            api_id=api_id,
    ...
    @validate_call
    def product_apis_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def product_apis_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _product_apis_delete_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
    ...
    @validate_call
    def product_apis_list_by_products(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _param = self._product_apis_list_by_products_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductApisListByProducts200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def product_apis_list_by_products_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductApisListByProducts200Response]:
        """product_apis_list_by_products
    ...
    @validate_call
    def product_apis_list_by_products_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _product_apis_list_by_products_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
