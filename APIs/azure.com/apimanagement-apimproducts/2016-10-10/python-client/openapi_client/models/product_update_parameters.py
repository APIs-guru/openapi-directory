...
class ProductUpdateParameters(BaseModel):
    """
    ...
    description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=500)]] = Field(default=None, description="Product description.")
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=300)]] = Field(default=None, description="Product name.")
    state: Optional[StrictStr] = Field(default=None, description="whether product is published or not. Published products are discoverable by users of developer portal. Non published products are visible only to administrators.")
    ...
    terms: Optional[StrictStr] = Field(default=None, description="Product terms and conditions. Developer will have to accept these terms before he's allowed to call product API.")
    __properties: ClassVar[List[str]] = ["approvalRequired", "description", "name", "state", "subscriptionRequired", "subscriptionsLimit", "terms"]
