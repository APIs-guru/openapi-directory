...
------------- | ------------- | -------------
[**product_policy_create_or_update**](ProductPolicyApi.md#product_policy_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/policy | 
[**product_policy_delete**](ProductPolicyApi.md#product_policy_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/policy | 
[**product_policy_get**](ProductPolicyApi.md#product_policy_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/policy | 


# **product_policy_create_or_update**
> product_policy_create_or_update(resource_group_name, service_name, product_id, if_match, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.product_policy_create_or_update(resource_group_name, service_name, product_id, if_match, api_version, subscription_id, parameters)
...
> product_policy_delete(resource_group_name, service_name, product_id, if_match, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.product_policy_delete(resource_group_name, service_name, product_id, if_match, api_version, subscription_id)
    except Exception as e:
...
# **product_policy_get**
> bytearray product_policy_get(resource_group_name, service_name, api_version, subscription_id, product_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_policy_get(resource_group_name, service_name, api_version, subscription_id, product_id)
