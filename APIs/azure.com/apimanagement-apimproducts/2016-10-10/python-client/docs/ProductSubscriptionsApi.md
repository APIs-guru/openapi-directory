...
------------- | ------------- | -------------
[**product_subscriptions_list_by_products**](ProductSubscriptionsApi.md#product_subscriptions_list_by_products) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/subscriptions | 


# **product_subscriptions_list_by_products**
> ProductSubscriptionsListByProducts200Response product_subscriptions_list_by_products(resource_group_name, service_name, product_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_subscriptions_list_by_products(resource_group_name, service_name, product_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ProductSubscriptionsApi->product_subscriptions_list_by_products:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductSubscriptionsApi->product_subscriptions_list_by_products: %s\n" % e)
```
