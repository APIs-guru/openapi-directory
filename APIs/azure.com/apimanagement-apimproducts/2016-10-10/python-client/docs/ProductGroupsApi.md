...
------------- | ------------- | -------------
[**product_groups_create**](ProductGroupsApi.md#product_groups_create) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/groups/{groupId} | 
[**product_groups_delete**](ProductGroupsApi.md#product_groups_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/groups/{groupId} | 
[**product_groups_list_by_products**](ProductGroupsApi.md#product_groups_list_by_products) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/groups | 


# **product_groups_create**
> product_groups_create(resource_group_name, service_name, product_id, group_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.product_groups_create(resource_group_name, service_name, product_id, group_id, api_version, subscription_id)
...
> product_groups_delete(resource_group_name, service_name, product_id, group_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.product_groups_delete(resource_group_name, service_name, product_id, group_id, api_version, subscription_id)
    except Exception as e:
...
> ProductGroupsListByProducts200Response product_groups_list_by_products(resource_group_name, service_name, product_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_groups_list_by_products(resource_group_name, service_name, product_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of ProductGroupsApi->product_groups_list_by_products:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductGroupsApi->product_groups_list_by_products: %s\n" % e)
```
