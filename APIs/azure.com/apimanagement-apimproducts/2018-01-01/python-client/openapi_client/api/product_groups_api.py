...
class ProductGroupsApi:
    ...
    def product_group_check_entity_exists(
        ...
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Group identifier. Must be unique in the current API Management service instance.")],
