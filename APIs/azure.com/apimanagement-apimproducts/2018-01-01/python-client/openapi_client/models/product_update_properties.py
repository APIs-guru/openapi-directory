...
class ProductUpdateProperties(BaseModel):
    """
    Parameters supplied to the Update Product operation.
    """ # noqa: E501
    display_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=300)]] = Field(default=None, description="Product name.", alias="displayName")
