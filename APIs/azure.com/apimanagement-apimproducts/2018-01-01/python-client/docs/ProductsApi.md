...
------------- | ------------- | -------------
[**product_create_or_update**](ProductsApi.md#product_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId} | 
[**product_delete**](ProductsApi.md#product_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId} | 
[**product_get**](ProductsApi.md#product_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId} | 
[**product_get_entity_tag**](ProductsApi.md#product_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId} | 
[**product_list_by_service**](ProductsApi.md#product_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products | 
[**product_update**](ProductsApi.md#product_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId} | 


# **product_create_or_update**
> ProductContract product_create_or_update(resource_group_name, service_name, product_id, api_version, subscription_id, parameters, if_match=if_match)
...
# **product_get**
> ProductContract product_get(resource_group_name, service_name, product_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ProductsApi->product_get_entity_tag: %s\n" % e)
```
...
> ProductCollection product_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip, expand_groups=expand_groups)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip, expand_groups=expand_groups)
        print("The response of ProductsApi->product_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductsApi->product_list_by_service: %s\n" % e)
```
