...
product_contract_properties_instance = ProductContractProperties.from_json(json)
# print the JSON string representation of the object
print(ProductContractProperties.to_json())

# convert the object into a dict
product_contract_properties_dict = product_contract_properties_instance.to_dict()
# create an instance of ProductContractProperties from a dict
product_contract_properties_from_dict = ProductContractProperties.from_dict(product_contract_properties_dict)
```
