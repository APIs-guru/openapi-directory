...
# **product_policy_get**
> ProductPolicyGet200Response product_policy_get(resource_group_name, service_name, api_version, subscription_id, product_id, policy_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_policy_get(resource_group_name, service_name, api_version, subscription_id, product_id, policy_id)
...
> product_policy_get_entity_tag(resource_group_name, service_name, api_version, subscription_id, product_id, policy_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.product_policy_get_entity_tag(resource_group_name, service_name, api_version, subscription_id, product_id, policy_id)
    except Exception as e:
...
> ProductPolicyListByProduct200Response product_policy_list_by_product(resource_group_name, service_name, api_version, subscription_id, product_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_policy_list_by_product(resource_group_name, service_name, api_version, subscription_id, product_id)
