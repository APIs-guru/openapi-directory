# openapi_client.ProductTagApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**tag_assign_to_product**](ProductTagApi.md#tag_assign_to_product) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId} | 
[**tag_detach_from_product**](ProductTagApi.md#tag_detach_from_product) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId} | 
[**tag_get_by_product**](ProductTagApi.md#tag_get_by_product) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId} | 
[**tag_get_entity_state_by_product**](ProductTagApi.md#tag_get_entity_state_by_product) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId} | 
[**tag_list_by_product**](ProductTagApi.md#tag_list_by_product) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags | 


# **tag_assign_to_product**
> TagGetByProduct200Response tag_assign_to_product(resource_group_name, service_name, product_id, tag_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProductTagApi(api_client)
    ...
    try:
        api_response = api_instance.tag_assign_to_product(resource_group_name, service_name, product_id, tag_id, api_version, subscription_id)
        print("The response of ProductTagApi->tag_assign_to_product:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductTagApi->tag_assign_to_product: %s\n" % e)
```
...
> tag_detach_from_product(resource_group_name, service_name, product_id, tag_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.tag_detach_from_product(resource_group_name, service_name, product_id, tag_id, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling ProductTagApi->tag_detach_from_product: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ProductTagApi->tag_get_by_product:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductTagApi->tag_get_by_product: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ProductTagApi->tag_get_entity_state_by_product: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ProductTagApi->tag_list_by_product:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductTagApi->tag_list_by_product: %s\n" % e)
```
