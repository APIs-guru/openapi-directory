...
class ProductTagApi:
    ...
    def tag_assign_to_product(
        ...
        _param = self._tag_assign_to_product_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TagGetByProduct200Response",
            '201': "TagGetByProduct200Response",
        }
    ...
    @validate_call
    def tag_assign_to_product_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TagGetByProduct200Response]:
        """tag_assign_to_product
    ...
    @validate_call
    def tag_assign_to_product_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _tag_assign_to_product_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId}',
    ...
    def tag_detach_from_product(
        ...
        _param = self._tag_detach_from_product_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    @validate_call
    def tag_detach_from_product_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def tag_detach_from_product_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _tag_detach_from_product_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
    ...
    def tag_get_by_product(
        ...
        _param = self._tag_get_by_product_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    @validate_call
    def tag_get_by_product_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def tag_get_by_product_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _tag_get_by_product_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
    ...
    @validate_call
    def tag_get_entity_state_by_product(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _param = self._tag_get_entity_state_by_product_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    @validate_call
    def tag_get_entity_state_by_product_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def tag_get_entity_state_by_product_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _tag_get_entity_state_by_product_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
    ...
    def tag_list_by_product(
        ...
        _param = self._tag_list_by_product_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TagListByProduct200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def tag_list_by_product_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TagListByProduct200Response]:
        """tag_list_by_product
    ...
    @validate_call
    def tag_list_by_product_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        product_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Product identifier. Must be unique in the current API Management service instance.")],
    ...
    def _tag_list_by_product_serialize(
        self,
        resource_group_name,
        service_name,
        product_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
