...
class ProductApiListByProduct200ResponseValueInnerProperties(BaseModel):
    """
    Api Entity Properties
    """ # noqa: E501
    api_version_set: Optional[ProductApiListByProduct200ResponseValueInnerPropertiesApiVersionSet] = Field(default=None, alias="apiVersionSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiVersionSet": ProductApiListByProduct200ResponseValueInnerPropertiesApiVersionSet.from_dict(obj["apiVersionSet"]) if obj.get("apiVersionSet") is not None else None,
