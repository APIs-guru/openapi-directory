# openapi_client.ProductSubscriptionApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**product_subscriptions_list**](ProductSubscriptionApi.md#product_subscriptions_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/subscriptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProductSubscriptionApi(api_client)
    ...
    try:
        ...
        print("The response of ProductSubscriptionApi->product_subscriptions_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductSubscriptionApi->product_subscriptions_list: %s\n" % e)
```
