...
# **product_policy_get**
> ProductPolicyGet200Response product_policy_get(resource_group_name, service_name, product_id, policy_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.product_policy_get(resource_group_name, service_name, product_id, policy_id, api_version, subscription_id)
