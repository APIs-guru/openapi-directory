# openapi_client.ProductApiApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**product_api_check_entity_exists**](ProductApiApi.md#product_api_check_entity_exists) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/apis/{apiId} | 
[**product_api_create_or_update**](ProductApiApi.md#product_api_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/apis/{apiId} | 
[**product_api_delete**](ProductApiApi.md#product_api_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/apis/{apiId} | 
[**product_api_list_by_product**](ProductApiApi.md#product_api_list_by_product) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/apis | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ProductApiApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ProductApiApi->product_api_check_entity_exists: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ProductApiApi->product_api_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductApiApi->product_api_create_or_update: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ProductApiApi->product_api_delete: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ProductApiApi->product_api_list_by_product:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductApiApi->product_api_list_by_product: %s\n" % e)
```
