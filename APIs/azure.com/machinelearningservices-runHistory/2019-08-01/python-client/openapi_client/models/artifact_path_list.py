...
class ArtifactPathList(BaseModel):
    """
    Contains list of Artifact Paths.
    """ # noqa: E501
    paths: List[ArtifactPath] = Field(description="List of Artifact Paths.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paths": [ArtifactPath.from_dict(_item) for _item in obj["paths"]] if obj.get("paths") is not None else None
        })
        return _obj
