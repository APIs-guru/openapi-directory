...
class TestBatchAddOrModifyRunResult(unittest.TestCase):
    """BatchAddOrModifyRunResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchAddOrModifyRunResult:
        """Test BatchAddOrModifyRunResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchAddOrModifyRunResult`
        """
        model = BatchAddOrModifyRunResult()
        if include_optional:
            return BatchAddOrModifyRunResult(
                errors = {
                ...
                runs = {
                    'key' : openapi_client.models.run.Run(
                        cancel_uri = '', 
    ...
    def testBatchAddOrModifyRunResult(self):
        """Test BatchAddOrModifyRunResult"""
