...
class TestBatchAddOrModifyRunRequest(unittest.TestCase):
    """BatchAddOrModifyRunRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchAddOrModifyRunRequest:
        """Test BatchAddOrModifyRunRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchAddOrModifyRunRequest`
        """
        model = BatchAddOrModifyRunRequest()
        if include_optional:
            return BatchAddOrModifyRunRequest(
                runs = [
                    openapi_client.models.create_run.CreateRun(
                        cancel_uri = '', 
    ...
    def testBatchAddOrModifyRunRequest(self):
        """Test BatchAddOrModifyRunRequest"""
