...
class KeyValuePairBaseEventErrorResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": BaseEvent.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "value": ErrorResponse.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
