...
------------- | ------------- | -------------
[**server_keys_create_or_update**](ServerKeysApi.md#server_keys_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/keys/{keyName} | 
[**server_keys_delete**](ServerKeysApi.md#server_keys_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/keys/{keyName} | 
[**server_keys_get**](ServerKeysApi.md#server_keys_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/keys/{keyName} | 
[**server_keys_list_by_instance**](ServerKeysApi.md#server_keys_list_by_instance) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/keys | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    key_name = 'key_name_example' # str | The name of the MariaDB Server key to be operated on (updated or created).
    subscription_id = 'subscription_id_example' # str | The subscription ID that identifies an Azure subscription.
    api_version = 'api_version_example' # str | The API version to use for the request.
    parameters = openapi_client.ServerKey() # ServerKey | The requested MariaDB Server key resource state.
 ...
 **key_name** | **str**| The name of the MariaDB Server key to be operated on (updated or created). | 
...
|-------------|-------------|------------------|
**200** | Successfully updated the MariaDB Server key. |  -  |
**202** | Accepted |  -  |
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
    server_name = 'server_name_example' # str | The name of the server.
    key_name = 'key_name_example' # str | The name of the MariaDB Server key to be deleted.
    subscription_id = 'subscription_id_example' # str | The subscription ID that identifies an Azure subscription.
    api_version = 'api_version_example' # str | The API version to use for the request.
 ...
 **resource_group_name** | **str**| The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal. | 
 **server_name** | **str**| The name of the server. | 
 **key_name** | **str**| The name of the MariaDB Server key to be deleted. | 
 **subscription_id** | **str**| The subscription ID that identifies an Azure subscription. | 
 **api_version** | **str**| The API version to use for the request. | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully deleted the MariaDB Server key. |  -  |
**202** | Accepted |  -  |
**204** | The specified MariaDB Server key does not exist. |  -  |
**0** | Error response describing why the operation failed. |  -  |
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
    server_name = 'server_name_example' # str | The name of the server.
    key_name = 'key_name_example' # str | The name of the MariaDB Server key to be retrieved.
    subscription_id = 'subscription_id_example' # str | The subscription ID that identifies an Azure subscription.
    api_version = 'api_version_example' # str | The API version to use for the request.
 ...
 **resource_group_name** | **str**| The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal. | 
 **server_name** | **str**| The name of the server. | 
 **key_name** | **str**| The name of the MariaDB Server key to be retrieved. | 
 **subscription_id** | **str**| The subscription ID that identifies an Azure subscription. | 
 **api_version** | **str**| The API version to use for the request. | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully retrieved the specified MariaDB Server key. |  -  |
**0** | Error response describing why the operation failed. |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully retrieved the list of MariaDB Server keys. |  -  |
**0** | Error response describing why the operation failed. |  -  |
