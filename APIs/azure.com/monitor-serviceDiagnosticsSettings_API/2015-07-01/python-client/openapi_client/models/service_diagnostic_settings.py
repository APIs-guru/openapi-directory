...
class ServiceDiagnosticSettings(BaseModel):
    """
    ...
    workspace_id: Optional[StrictStr] = Field(default=None, description="The workspace ID (resource ID of a Log Analytics workspace) for a Log Analytics workspace to which you would like to send Diagnostic Logs. Example: /subscriptions/4b9e8510-67ab-4e9a-95a9-e2f1e570ea9c/resourceGroups/insights-integration/providers/Microsoft.OperationalInsights/workspaces/viruela2", alias="workspaceId")
    __properties: ClassVar[List[str]] = ["logs", "metrics", "serviceBusRuleId", "storageAccountId", "workspaceId"]
