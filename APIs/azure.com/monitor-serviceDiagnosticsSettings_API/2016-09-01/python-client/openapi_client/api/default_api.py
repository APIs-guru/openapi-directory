...
class DefaultApi:
    ...
    @validate_call
    def service_diagnostic_settings_update(
        self,
        ...
        service_diagnostic_settings_resource: Annotated[ServiceDiagnosticSettingsResourcePatch, Field(description="Parameters supplied to the operation.")],
        ...
        :type service_diagnostic_settings_resource: ServiceDiagnosticSettingsResourcePatch
        ...
        _param = self._service_diagnostic_settings_update_serialize(
            resource_uri=resource_uri,
            api_version=api_version,
            service_diagnostic_settings_resource=service_diagnostic_settings_resource,
    ...
    @validate_call
    def service_diagnostic_settings_update_with_http_info(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        service_diagnostic_settings_resource: Annotated[ServiceDiagnosticSettingsResourcePatch, Field(description="Parameters supplied to the operation.")],
    ...
    @validate_call
    def service_diagnostic_settings_update_without_preload_content(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        service_diagnostic_settings_resource: Annotated[ServiceDiagnosticSettingsResourcePatch, Field(description="Parameters supplied to the operation.")],
    ...
    def _service_diagnostic_settings_update_serialize(
        self,
        resource_uri,
        api_version,
        ...
        if service_diagnostic_settings_resource is not None:
            _body_params = service_diagnostic_settings_resource
