...
class MetricSettings(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool = Field(description="a value indicating whether this timegrain is enabled.")
    retention_policy: Optional[RetentionPolicy] = Field(default=None, alias="retentionPolicy")
    time_grain: StrictStr = Field(description="the timegrain of the metric in ISO8601 format.", alias="timeGrain")
    __properties: ClassVar[List[str]] = ["enabled", "retentionPolicy", "timeGrain"]
