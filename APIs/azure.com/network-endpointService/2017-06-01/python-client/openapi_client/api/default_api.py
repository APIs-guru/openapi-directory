...
class DefaultApi:
    ...
    @validate_call
    def available_endpoint_services_list(
        self,
        location: Annotated[StrictStr, Field(description="The location to check available endpoint services.")],
        ...
        _param = self._available_endpoint_services_list_serialize(
            location=location,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EndpointServicesListResult",
        }
    ...
    @validate_call
    def available_endpoint_services_list_with_http_info(
        self,
        location: Annotated[StrictStr, Field(description="The location to check available endpoint services.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EndpointServicesListResult]:
        """available_endpoint_services_list
    ...
    @validate_call
    def available_endpoint_services_list_without_preload_content(
        self,
        location: Annotated[StrictStr, Field(description="The location to check available endpoint services.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
    ...
    def _available_endpoint_services_list_serialize(
        self,
        location,
        api_version,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/virtualNetworkAvailableEndpointServices',
