...
------------- | ------------- | -------------
[**hyperparameter_tuning_cancel_experiment**](HyperDriveExperimentApi.md#hyperparameter_tuning_cancel_experiment) | **POST** /hyperdrive/v1.0/{armScope}/runs/{runId}/cancel | Cancel an Experiment.
[**hyperparameter_tuning_create_experiment**](HyperDriveExperimentApi.md#hyperparameter_tuning_create_experiment) | **POST** /hyperdrive/v1.0/{armScope}/runs | Create an Experiment.


# **hyperparameter_tuning_cancel_experiment**
> HyperDriveCancelExperimentResponse hyperparameter_tuning_cancel_experiment(arm_scope, run_id, run_history_host=run_history_host)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Cancel an Experiment.
        api_response = api_instance.hyperparameter_tuning_cancel_experiment(arm_scope, run_id, run_history_host=run_history_host)
        print("The response of HyperDriveExperimentApi->hyperparameter_tuning_cancel_experiment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HyperDriveExperimentApi->hyperparameter_tuning_cancel_experiment: %s\n" % e)
```
...
# **hyperparameter_tuning_create_experiment**
> HyperDriveExperimentResponse hyperparameter_tuning_create_experiment(arm_scope, config)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an Experiment.
        api_response = api_instance.hyperparameter_tuning_create_experiment(arm_scope, config)
        print("The response of HyperDriveExperimentApi->hyperparameter_tuning_create_experiment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HyperDriveExperimentApi->hyperparameter_tuning_create_experiment: %s\n" % e)
```
