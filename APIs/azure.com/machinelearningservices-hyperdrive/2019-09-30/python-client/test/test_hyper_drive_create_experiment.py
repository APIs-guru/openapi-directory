...
class TestHyperDriveCreateExperiment(unittest.TestCase):
    """HyperDriveCreateExperiment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HyperDriveCreateExperiment:
        """Test HyperDriveCreateExperiment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HyperDriveCreateExperiment`
        """
        model = HyperDriveCreateExperiment()
        if include_optional:
            return HyperDriveCreateExperiment(
                description = '',
    ...
    def testHyperDriveCreateExperiment(self):
        """Test HyperDriveCreateExperiment"""
