...
class HyperDriveExperimentBasePrimaryMetricConfig(BaseModel):
    """
    Name of the primary metric and goal of optimizing.
    """ # noqa: E501
    goal: StrictStr = Field(description="Determines if the primary metric has to be minimized/maximized.")
    name: StrictStr = Field(description="Name of the primary metric reported by runs.")
    __properties: ClassVar[List[str]] = ["goal", "name"]
