...
class HyperDriveExperimentResponse(BaseModel):
    """
    Response for HyperDrive_CreateExperiment in case of success.
    """ # noqa: E501
    code: StrictInt = Field(description="Response code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": HyperDriveExperiment.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
