...
class HyperDriveExperimentBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "generator_config", "max_concurrent_jobs", "max_duration_minutes", "max_total_jobs", "name", "platform", "platform_config", "policy_config", "primary_metric_config", "study_id"]
