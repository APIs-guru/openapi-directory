...
class HyperDriveBanditPolicy(HyperDrivePolicyConfigBase):
    """
    ...
    """ # noqa: E501
    properties: Optional[HyperDriveBanditPolicyAllOfProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": HyperDriveBanditPolicyAllOfProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
