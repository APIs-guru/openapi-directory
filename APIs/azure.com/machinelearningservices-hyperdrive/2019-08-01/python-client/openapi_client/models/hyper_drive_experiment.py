...
class HyperDriveExperiment(BaseModel):
    """
    ...
    all_jobs_generated: StrictBool = Field(description="Indicates if all runs have been generated.")
    cancellation_requested: StrictBool = Field(description="Indicates if cancellation has been requested for this Hyperdrive run.")
    created: datetime = Field(description="Hyperdrive run creation time.")
    created_by_user_id: StrictInt = Field(description="Id of the user who created the Hyperdrive run.")
    experiment_id: StrictStr = Field(description="Hyperdrive run id.")
    experiment_uri: Optional[StrictStr] = Field(default=None, description="Hyperdrive run Uri.")
    hyperdrive_run_id: StrictStr = Field(description="Hyperdrive run id.")
    modified: datetime = Field(description="Hyperdrive run modification time.")
    status: StrictStr = Field(description="Hyperdrive run status.")
    study_uri: Optional[StrictStr] = Field(default=None, description="Study Uri of the Hyperdrive run.")
    __properties: ClassVar[List[str]] = ["description", "generator_config", "max_concurrent_jobs", "max_duration_minutes", "max_total_jobs", "name", "platform", "platform_config", "policy_config", "primary_metric_config", "study_id", "all_jobs_generated", "cancellation_requested", "created", "created_by_user_id", "experiment_id", "experiment_uri", "hyperdrive_run_id", "modified", "status", "study_uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "all_jobs_generated": obj.get("all_jobs_generated"),
            "cancellation_requested": obj.get("cancellation_requested"),
            "created": obj.get("created"),
            "created_by_user_id": obj.get("created_by_user_id"),
            "experiment_id": obj.get("experiment_id"),
            "experiment_uri": obj.get("experiment_uri"),
            "hyperdrive_run_id": obj.get("hyperdrive_run_id"),
            "modified": obj.get("modified"),
            "status": obj.get("status"),
            "study_uri": obj.get("study_uri")
        })
        return _obj
