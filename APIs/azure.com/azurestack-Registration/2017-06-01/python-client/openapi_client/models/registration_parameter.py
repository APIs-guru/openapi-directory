...
class RegistrationParameter(BaseModel):
    """
    Registration resource
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Location of the resource.")
    properties: Optional[RegistrationParameterProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": RegistrationParameterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
