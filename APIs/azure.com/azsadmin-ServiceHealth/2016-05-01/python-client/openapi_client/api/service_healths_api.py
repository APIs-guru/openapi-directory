...
class ServiceHealthsApi:
    ...
    def service_healths_get(
        ...
        service_health: Annotated[StrictStr, Field(description="Service Health name.")],
        ...
        :type location: str
        :param service_health: Service Health name. (required)
        :type service_health: str
    ...
    def _service_healths_get_serialize(
        ...
        if service_health is not None:
            _path_params['serviceHealth'] = service_health
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/serviceHealths/{serviceHealth}',
    ...
    def service_healths_list(
        ...
        _param = self._service_healths_list_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            location=location,
            api_version=api_version,
    ...
    @validate_call
    def service_healths_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Name of the region")],
    ...
    @validate_call
    def service_healths_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Name of the region")],
    ...
    def _service_healths_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/serviceHealths',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
