...
class ServiceHealthList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI of the next page.", alias="nextLink")
    value: Optional[List[ServiceHealth]] = Field(default=None, description="List of service health objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ServiceHealth.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
