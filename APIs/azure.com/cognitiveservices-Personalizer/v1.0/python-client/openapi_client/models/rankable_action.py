...
class RankableAction(BaseModel):
    """
    An action with it's associated features used for ranking.
    """ # noqa: E501
    features: List[Dict[str, Any]] = Field(description="List of dictionaries containing features.")
    id: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Id of the action.")
    __properties: ClassVar[List[str]] = ["features", "id"]
