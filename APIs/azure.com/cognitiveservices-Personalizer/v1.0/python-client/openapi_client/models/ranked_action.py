...
class RankedAction(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Id of the action")
    probability: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Probability of the action")
    __properties: ClassVar[List[str]] = ["id", "probability"]
