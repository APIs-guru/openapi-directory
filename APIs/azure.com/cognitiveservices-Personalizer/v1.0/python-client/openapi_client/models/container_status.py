...
class ContainerStatus(BaseModel):
    ...
    ContainerStatus
    """ # noqa: E501
    api_status: Optional[StrictStr] = Field(default=None, alias="apiStatus")
    api_status_message: Optional[StrictStr] = Field(default=None, alias="apiStatusMessage")
    service: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apiStatus", "apiStatusMessage", "service"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiStatusMessage": obj.get("apiStatusMessage"),
