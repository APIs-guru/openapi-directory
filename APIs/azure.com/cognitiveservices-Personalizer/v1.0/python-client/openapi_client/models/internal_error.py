...
class InternalError(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Detailed error code.")
    innererror: Optional[InternalError] = None
...
InternalError.model_rebuild(raise_errors=False)
