...
class PolicyResult(BaseModel):
    ...
    summary: Optional[List[PolicyResultSummary]] = None
    total_summary: Optional[PolicyResultSummary] = Field(default=None, alias="totalSummary")
    __properties: ClassVar[List[str]] = ["arguments", "name", "summary", "totalSummary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "summary": [PolicyResultSummary.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None,
            "totalSummary": PolicyResultSummary.from_dict(obj["totalSummary"]) if obj.get("totalSummary") is not None else None
        })
        return _obj
