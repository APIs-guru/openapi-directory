...
class PolicyContract(BaseModel):
    ...
    """ # noqa: E501
    arguments: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="Arguments of the Learning settings.")
    name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Name of the Learning settings.")
