...
class LogsApi:
    ...
    def log_delete(
        ...
        _param = self._log_delete_serialize(
    ...
    @validate_call
    def log_delete_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def log_get_properties(
        ...
        _param = self._log_get_properties_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def log_get_properties_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def log_get_properties_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _log_get_properties_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
