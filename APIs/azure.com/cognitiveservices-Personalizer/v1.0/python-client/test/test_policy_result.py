...
class TestPolicyResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PolicyResult:
        """Test PolicyResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyResult`
        """
        model = PolicyResult()
        if include_optional:
            return PolicyResult(
                ...
                total_summary = openapi_client.models.policy_result_summary.PolicyResultSummary(
                    aggregate_time_window = '', 
                    confidence_interval = 1.337, 
                    ips_estimator_denominator = 1.337, 
                    ips_estimator_numerator = 1.337, 
