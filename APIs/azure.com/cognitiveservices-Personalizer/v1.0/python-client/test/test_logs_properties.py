...
class TestLogsProperties(unittest.TestCase):
    """LogsProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogsProperties:
        """Test LogsProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogsProperties`
        """
        model = LogsProperties()
        if include_optional:
