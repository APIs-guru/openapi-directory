...
class TestRankableAction(unittest.TestCase):
    """RankableAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RankableAction:
        """Test RankableAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RankableAction`
        """
        model = RankableAction()
        if include_optional:
            return RankableAction(
                features = [
                    None
                    ],
                id = ''
