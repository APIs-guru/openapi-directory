...
class TestPolicyResultSummary(unittest.TestCase):
    """PolicyResultSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyResultSummary:
        """Test PolicyResultSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyResultSummary`
        """
        model = PolicyResultSummary()
        if include_optional:
    ...
    def testPolicyResultSummary(self):
        """Test PolicyResultSummary"""
