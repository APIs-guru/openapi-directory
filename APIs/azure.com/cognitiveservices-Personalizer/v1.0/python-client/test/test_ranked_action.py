...
class TestRankedAction(unittest.TestCase):
    """RankedAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RankedAction:
        """Test RankedAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RankedAction`
        """
        model = RankedAction()
        if include_optional:
            return RankedAction(
