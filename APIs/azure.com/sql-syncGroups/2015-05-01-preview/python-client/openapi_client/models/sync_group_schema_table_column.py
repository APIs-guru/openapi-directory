...
class SyncGroupSchemaTableColumn(BaseModel):
    """
    ...
    quoted_name: Optional[StrictStr] = Field(default=None, description="Quoted name of sync group table column.", alias="quotedName")
    __properties: ClassVar[List[str]] = ["dataSize", "dataType", "quotedName"]
