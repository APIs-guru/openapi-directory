...
class TestUsageAggregateModel(unittest.TestCase):
    """UsageAggregateModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageAggregateModel:
        """Test UsageAggregateModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageAggregateModel`
        """
        model = UsageAggregateModel()
        if include_optional:
    ...
    def testUsageAggregateModel(self):
        """Test UsageAggregateModel"""
