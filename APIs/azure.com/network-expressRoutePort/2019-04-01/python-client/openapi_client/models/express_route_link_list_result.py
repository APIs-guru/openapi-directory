...
class ExpressRouteLinkListResult(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteLink]] = Field(default=None, description="The list of ExpressRouteLink sub-resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
