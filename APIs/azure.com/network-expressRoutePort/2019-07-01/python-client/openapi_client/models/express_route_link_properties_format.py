...
class ExpressRouteLinkPropertiesFormat(BaseModel):
    ...
    mac_sec_config: Optional[ExpressRouteLinkMacSecConfig] = Field(default=None, alias="macSecConfig")
    ...
    __properties: ClassVar[List[str]] = ["adminState", "connectorType", "interfaceName", "macSecConfig", "patchPanelId", "provisioningState", "rackId", "routerName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of mac_sec_config
        if self.mac_sec_config:
            _dict['macSecConfig'] = self.mac_sec_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "macSecConfig": ExpressRouteLinkMacSecConfig.from_dict(obj["macSecConfig"]) if obj.get("macSecConfig") is not None else None,
