...
class ExpressRouteLink(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of child port resource that is unique among child port resources of the parent.")
    properties: Optional[ExpressRouteLinkPropertiesFormat] = None
