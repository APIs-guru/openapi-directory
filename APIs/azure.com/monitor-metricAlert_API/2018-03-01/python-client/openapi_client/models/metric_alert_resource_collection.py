...
class MetricAlertResourceCollection(BaseModel):
    """
    Represents a collection of alert rule resources.
    """ # noqa: E501
    value: Optional[List[MetricAlertResource]] = Field(default=None, description="the values for the alert rule resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MetricAlertResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
