...
class MetricCriteria(MultiMetricCriteria):
    ...
    """ # noqa: E501
    operator: StrictStr = Field(description="the criteria operator.")
    threshold: Union[StrictFloat, StrictInt] = Field(description="the criteria threshold value that activates the alert.")
