...
class TestMetricAlertResource(unittest.TestCase):
    """MetricAlertResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricAlertResource:
        """Test MetricAlertResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetricAlertResource`
        """
    ...
    def testMetricAlertResource(self):
        """Test MetricAlertResource"""
