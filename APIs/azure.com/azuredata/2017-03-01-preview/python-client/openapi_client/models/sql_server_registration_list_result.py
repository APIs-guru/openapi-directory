...
class SqlServerRegistrationListResult(BaseModel):
    """
    Server.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to retrieve next page of results.", alias="nextLink")
    value: Optional[List[SqlServerRegistration]] = Field(default=None, description="Array of results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SqlServerRegistration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
