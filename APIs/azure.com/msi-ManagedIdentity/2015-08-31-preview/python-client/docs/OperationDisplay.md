...
------------ | ------------- | ------------- | -------------
**description** | **str** | A description of the operation. | [optional] 
**operation** | **str** | The type of operation. For example: read, write, delete. | [optional] 
**provider** | **str** | Friendly name of the resource provider. | [optional] 
**resource** | **str** | The resource type on which the operation is performed. | [optional] 
