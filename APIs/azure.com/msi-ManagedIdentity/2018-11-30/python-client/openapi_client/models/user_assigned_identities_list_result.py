...
class UserAssignedIdentitiesListResult(BaseModel):
    """
    Values returned by the List operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The url to get the next page of results, if any.", alias="nextLink")
    value: Optional[List[Identity]] = Field(default=None, description="The collection of userAssignedIdentities returned by the listing operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Identity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
