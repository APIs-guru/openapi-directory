...
json = "{}"
# create an instance of ServerBlobAuditingPolicyProperties from a JSON string
server_blob_auditing_policy_properties_instance = ServerBlobAuditingPolicyProperties.from_json(json)
# print the JSON string representation of the object
print(ServerBlobAuditingPolicyProperties.to_json())

# convert the object into a dict
server_blob_auditing_policy_properties_dict = server_blob_auditing_policy_properties_instance.to_dict()
# create an instance of ServerBlobAuditingPolicyProperties from a dict
server_blob_auditing_policy_properties_from_dict = ServerBlobAuditingPolicyProperties.from_dict(server_blob_auditing_policy_properties_dict)
```
