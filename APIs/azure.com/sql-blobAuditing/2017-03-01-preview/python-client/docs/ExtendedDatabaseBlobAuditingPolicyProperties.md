...
json = "{}"
# create an instance of ExtendedDatabaseBlobAuditingPolicyProperties from a JSON string
extended_database_blob_auditing_policy_properties_instance = ExtendedDatabaseBlobAuditingPolicyProperties.from_json(json)
# print the JSON string representation of the object
print(ExtendedDatabaseBlobAuditingPolicyProperties.to_json())

# convert the object into a dict
extended_database_blob_auditing_policy_properties_dict = extended_database_blob_auditing_policy_properties_instance.to_dict()
# create an instance of ExtendedDatabaseBlobAuditingPolicyProperties from a dict
extended_database_blob_auditing_policy_properties_from_dict = ExtendedDatabaseBlobAuditingPolicyProperties.from_dict(extended_database_blob_auditing_policy_properties_dict)
```
