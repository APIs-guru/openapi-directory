...
class MediaServiceProperties(BaseModel):
    ...
    """ # noqa: E501
    media_service_id: Optional[StrictStr] = Field(default=None, description="The Media Services account ID.", alias="mediaServiceId")
    ...
    __properties: ClassVar[List[str]] = ["mediaServiceId", "storageAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mediaServiceId": obj.get("mediaServiceId"),
