...
class ExperimentsApi:
    ...
    @validate_call
    def experiments_create_or_update(
        self,
        ...
        parameters: Annotated[Experiment, Field(description="The Experiment resource")],
        ...
        _param = self._experiments_create_or_update_serialize(
    ...
    @validate_call
    def experiments_create_or_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
    ...
    @validate_call
    def experiments_create_or_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
    ...
    def _experiments_create_or_update_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/NetworkExperimentProfiles/{profileName}/Experiments/{experimentName}',
    ...
    @validate_call
    def experiments_list_by_profile(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        ...
        _param = self._experiments_list_by_profile_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            resource_group_name=resource_group_name,
            profile_name=profile_name,
    ...
    @validate_call
    def experiments_list_by_profile_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
    ...
    @validate_call
    def experiments_list_by_profile_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
    ...
    def _experiments_list_by_profile_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/NetworkExperimentProfiles/{profileName}/Experiments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def experiments_update(
        ...
        profile_name: Annotated[str, Field(strict=True, description="The Profile identifier associated with the Tenant and Partner")],
        experiment_name: Annotated[str, Field(strict=True, description="The Experiment identifier associated with the Experiment")],
        parameters: Annotated[ExperimentUpdateModel, Field(description="The Experiment Update Model")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: ExperimentUpdateModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
