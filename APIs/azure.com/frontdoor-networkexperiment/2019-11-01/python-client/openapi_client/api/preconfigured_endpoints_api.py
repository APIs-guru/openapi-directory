...
class PreconfiguredEndpointsApi:
    ...
    @validate_call
    def preconfigured_endpoints_list(
        self,
        ...
        _param = self._preconfigured_endpoints_list_serialize(
    ...
    @validate_call
    def preconfigured_endpoints_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PreconfiguredEndpointList]:
        """Gets a list of Preconfigured Endpoints
    ...
    @validate_call
    def preconfigured_endpoints_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
    ...
    def _preconfigured_endpoints_list_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/NetworkExperimentProfiles/{profileName}/PreconfiguredEndpoints',
