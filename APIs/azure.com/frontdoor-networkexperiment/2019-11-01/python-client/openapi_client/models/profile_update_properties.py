...
class ProfileUpdateProperties(BaseModel):
    """
    Defines the properties of an experiment
    """ # noqa: E501
    enabled_state: Optional[StrictStr] = Field(default=None, description="The enabled state of the Profile", alias="enabledState")
    __properties: ClassVar[List[str]] = ["enabledState"]
