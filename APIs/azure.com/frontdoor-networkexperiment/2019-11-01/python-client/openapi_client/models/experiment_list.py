...
class ExperimentList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of Experiment objects if there are any.", alias="nextLink")
    value: Optional[List[Experiment]] = Field(default=None, description="List of Experiments within a resource group.")
