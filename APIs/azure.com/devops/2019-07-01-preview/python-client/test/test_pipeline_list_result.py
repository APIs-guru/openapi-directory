...
class TestPipelineListResult(unittest.TestCase):
    """PipelineListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PipelineListResult:
        """Test PipelineListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineListResult`
        """
        model = PipelineListResult()
        if include_optional:
    ...
    def testPipelineListResult(self):
        """Test PipelineListResult"""
