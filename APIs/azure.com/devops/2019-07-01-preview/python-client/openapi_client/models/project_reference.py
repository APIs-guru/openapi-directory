...
class ProjectReference(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique immutable identifier of the Azure DevOps Project.")
    name: StrictStr = Field(description="Name of the Azure DevOps Project.")
