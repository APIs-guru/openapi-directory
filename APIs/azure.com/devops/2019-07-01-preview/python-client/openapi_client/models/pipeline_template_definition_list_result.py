...
class PipelineTemplateDefinitionListResult(BaseModel):
    """
    Result of a request to list all pipeline template definitions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of pipeline template definitions, if there are any.", alias="nextLink")
    value: Optional[List[PipelineTemplateDefinition]] = Field(default=None, description="List of pipeline template definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PipelineTemplateDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
