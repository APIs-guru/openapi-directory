...
class InputValue(BaseModel):
    ...
    """ # noqa: E501
    display_value: Optional[StrictStr] = Field(default=None, description="Description of the input parameter value.", alias="displayValue")
    value: Optional[StrictStr] = Field(default=None, description="Value of an input parameter.")
