...
class PipelineUpdateParameters(BaseModel):
    """
    Request payload used to update an existing Azure Pipeline.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Dictionary of key-value pairs to be set as tags on the Azure Pipeline. This will overwrite any existing tags.")
