...
class OrganizationReference(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique immutable identifier for the Azure DevOps Organization.")
    name: StrictStr = Field(description="Name of the Azure DevOps Organization.")
