...
class BootstrapConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["repository", "template"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repository": CodeRepository.from_dict(obj["repository"]) if obj.get("repository") is not None else None,
            "template": PipelineTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
