...
class OperationListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of operations, if there are any.", alias="nextLink")
    value: Optional[List[Operation]] = Field(default=None, description="List of operations supported by Microsoft.DevOps resource provider.")
