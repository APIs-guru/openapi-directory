...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.DevOps/operations | 
...
|-------------|-------------|------------------|
**200** | The list of supported operations has been fetched successfully. |  -  |
