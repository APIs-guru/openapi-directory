...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The URL to get the next set of operations, if there are any. | [optional] 
**value** | [**List[Operation]**](Operation.md) | List of operations supported by Microsoft.DevOps resource provider. | [optional] [readonly] 
