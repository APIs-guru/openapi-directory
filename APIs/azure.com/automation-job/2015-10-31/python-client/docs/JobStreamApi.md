...
------------- | ------------- | -------------
[**job_stream_get**](JobStreamApi.md#job_stream_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/jobs/{jobId}/streams/{jobStreamId} | 
[**job_stream_list_by_job**](JobStreamApi.md#job_stream_list_by_job) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/jobs/{jobId}/streams | 


# **job_stream_get**
> JobStream job_stream_get(resource_group_name, automation_account_name, job_id, job_stream_id, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.job_stream_get(resource_group_name, automation_account_name, job_id, job_stream_id, subscription_id, api_version)
...
> JobStreamListResult job_stream_list_by_job(resource_group_name, automation_account_name, job_id, subscription_id, api_version, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.job_stream_list_by_job(resource_group_name, automation_account_name, job_id, subscription_id, api_version, filter=filter)
