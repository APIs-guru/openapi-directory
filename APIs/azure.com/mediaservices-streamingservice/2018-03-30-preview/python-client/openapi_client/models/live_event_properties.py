...
class LiveEventProperties(BaseModel):
    ...
    stream_options: Optional[List[StrictStr]] = Field(default=None, description="The stream options.", alias="streamOptions")
    vanity_url: Optional[StrictBool] = Field(default=None, description="The Live Event vanity URL flag.", alias="vanityUrl")
