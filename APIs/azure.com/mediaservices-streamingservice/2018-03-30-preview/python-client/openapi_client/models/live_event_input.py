...
class LiveEventInput(BaseModel):
    ...
    streaming_protocol: StrictStr = Field(description="The streaming protocol for the Live Event.", alias="streamingProtocol")
    __properties: ClassVar[List[str]] = ["accessToken", "endpoints", "keyFrameIntervalDuration", "streamingProtocol"]
