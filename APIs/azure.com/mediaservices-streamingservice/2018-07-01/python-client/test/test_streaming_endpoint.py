...
class TestStreamingEndpoint(unittest.TestCase):
    """StreamingEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingEndpoint:
        """Test StreamingEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingEndpoint`
        """
    ...
    def testStreamingEndpoint(self):
        """Test StreamingEndpoint"""
