...
class LiveEventProperties(BaseModel):
    ...
    transcriptions: Optional[List[LiveEventTranscription]] = Field(default=None, description="The Live Event transcription.")
    ...
    __properties: ClassVar[List[str]] = ["created", "crossSiteAccessPolicies", "description", "encoding", "input", "lastModified", "preview", "provisioningState", "resourceState", "streamOptions", "transcriptions", "vanityUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transcriptions": [LiveEventTranscription.from_dict(_item) for _item in obj["transcriptions"]] if obj.get("transcriptions") is not None else None,
