...
class LiveEventOutputTranscriptionTrack(BaseModel):
    """
    Describes a transcription track in the output of a Live Event, generated using speech-to-text transcription.
    """ # noqa: E501
    track_name: StrictStr = Field(description="The output track name.", alias="trackName")
    __properties: ClassVar[List[str]] = ["trackName"]
