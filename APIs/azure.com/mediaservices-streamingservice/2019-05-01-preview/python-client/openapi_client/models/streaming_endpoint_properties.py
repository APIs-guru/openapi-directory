...
class StreamingEndpointProperties(BaseModel):
    ...
    availability_set_name: Optional[StrictStr] = Field(default=None, description="The name of the AvailabilitySet used with this StreamingEndpoint for high availability streaming.  This value can only be set at creation time.", alias="availabilitySetName")
    ...
    scale_units: StrictInt = Field(description="The number of scale units.  Use the Scale operation to adjust this value.", alias="scaleUnits")
