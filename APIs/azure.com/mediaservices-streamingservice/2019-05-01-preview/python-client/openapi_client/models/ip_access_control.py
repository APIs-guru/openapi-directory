...
class IPAccessControl(BaseModel):
    ...
    """ # noqa: E501
    allow: Optional[List[IPRange]] = Field(default=None, description="The IP allow list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allow": [IPRange.from_dict(_item) for _item in obj["allow"]] if obj.get("allow") is not None else None
        })
        return _obj
