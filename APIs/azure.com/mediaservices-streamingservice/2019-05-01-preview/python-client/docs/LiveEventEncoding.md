...
------------ | ------------- | ------------- | -------------
**encoding_type** | **str** | The encoding type for Live Event.  This value is specified at creation time and cannot be updated. | [optional] 
**preset_name** | **str** | The encoding preset name.  This value is specified at creation time and cannot be updated. | [optional] 
