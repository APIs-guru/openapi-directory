...
class TestStreamingEndpointProperties(unittest.TestCase):
    """StreamingEndpointProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingEndpointProperties:
        """Test StreamingEndpointProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingEndpointProperties`
        """
        model = StreamingEndpointProperties()
        if include_optional:
            return StreamingEndpointProperties(
    ...
    def testStreamingEndpointProperties(self):
        """Test StreamingEndpointProperties"""
