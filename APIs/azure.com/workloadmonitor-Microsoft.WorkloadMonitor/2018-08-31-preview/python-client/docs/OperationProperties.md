...
------------ | ------------- | ------------- | -------------
**description** | **str** | The description of the resource provider. | [optional] [readonly] 
**operation** | **str** | This operation name. | [optional] [readonly] 
**provider** | **str** | The provider name. | [optional] [readonly] 
**resource** | **str** | The resource name. | [optional] [readonly] 
