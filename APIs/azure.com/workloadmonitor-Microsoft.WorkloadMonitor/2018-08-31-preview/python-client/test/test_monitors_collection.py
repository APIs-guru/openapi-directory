...
class TestMonitorsCollection(unittest.TestCase):
    """MonitorsCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorsCollection:
        """Test MonitorsCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorsCollection`
        """
        model = MonitorsCollection()
        if include_optional:
            return MonitorsCollection(
                next_link = '',
                value = [
                    openapi_client.models.monitor.Monitor(
                        etag = '', 
                        properties = openapi_client.models.monitor_properties.MonitorProperties(
    ...
    def testMonitorsCollection(self):
        """Test MonitorsCollection"""
