...
class TestMonitorInstanceProperties(unittest.TestCase):
    """MonitorInstanceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorInstanceProperties:
        """Test MonitorInstanceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorInstanceProperties`
        """
        model = MonitorInstanceProperties()
        if include_optional:
    ...
    def testMonitorInstanceProperties(self):
        """Test MonitorInstanceProperties"""
