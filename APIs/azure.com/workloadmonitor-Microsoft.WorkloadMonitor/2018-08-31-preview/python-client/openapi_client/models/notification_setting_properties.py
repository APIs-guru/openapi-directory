...
class NotificationSettingProperties(BaseModel):
    """
    Model for properties of a NotificationSetting.
    """ # noqa: E501
    action_group_resource_ids: Optional[List[StrictStr]] = Field(default=None, description="List of action group resource ids to be notified", alias="actionGroupResourceIds")
    __properties: ClassVar[List[str]] = ["actionGroupResourceIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionGroupResourceIds": obj.get("actionGroupResourceIds")
        })
        return _obj
