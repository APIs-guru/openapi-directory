...
class ComponentsCollection(BaseModel):
    """
    Model for collection of components.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to the next set of results.", alias="nextLink")
    value: Optional[List[Component]] = Field(default=None, description="Collection of components.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Component.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
