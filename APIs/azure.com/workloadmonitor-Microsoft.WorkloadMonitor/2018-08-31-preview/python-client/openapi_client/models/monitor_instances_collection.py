...
class MonitorInstancesCollection(BaseModel):
    """
    ...
    value: Optional[List[MonitorInstance]] = Field(default=None, description="Collection of health instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MonitorInstance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
