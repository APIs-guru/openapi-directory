...
class MonitorsCollection(BaseModel):
    """
    Model for collection of Monitor.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL for next set of results.", alias="nextLink")
    value: Optional[List[Monitor]] = Field(default=None, description="Collection of Monitor.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Monitor.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
