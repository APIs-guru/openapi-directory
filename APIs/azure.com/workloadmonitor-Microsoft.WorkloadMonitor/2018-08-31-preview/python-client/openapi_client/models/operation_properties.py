...
class OperationProperties(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The description of the resource provider.")
    operation: Optional[StrictStr] = Field(default=None, description="This operation name.")
    provider: Optional[StrictStr] = Field(default=None, description="The provider name.")
