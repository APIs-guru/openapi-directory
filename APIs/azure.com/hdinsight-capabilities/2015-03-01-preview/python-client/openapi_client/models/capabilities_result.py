...
class CapabilitiesResult(BaseModel):
    ...
    """ # noqa: E501
    features: Optional[List[StrictStr]] = Field(default=None, description="The capabilty features.")
    quota: Optional[QuotaCapability] = None
    regions: Optional[Dict[str, RegionsCapability]] = Field(default=None, description="The virtual machine size compatibilty features.")
    versions: Optional[Dict[str, VersionsCapability]] = Field(default=None, description="The version capability.")
    vm_size_filters: Optional[List[VmSizeCompatibilityFilter]] = Field(default=None, description="The virtual machine size compatibilty filters.", alias="vmSize_filters")
