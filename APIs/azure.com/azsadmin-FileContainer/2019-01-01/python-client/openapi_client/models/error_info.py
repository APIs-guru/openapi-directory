...
class ErrorInfo(BaseModel):
    ...
    details: Optional[List[ErrorInfo]] = Field(default=None, description="The detailed error messages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [ErrorInfo.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "message": obj.get("message")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ErrorInfo.model_rebuild(raise_errors=False)
