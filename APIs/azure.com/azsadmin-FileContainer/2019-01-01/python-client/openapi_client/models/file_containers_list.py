...
class FileContainersList(BaseModel):
    """
    List of file containers.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Continuation token.", alias="nextLink")
    value: Optional[List[FileContainer]] = Field(default=None, description="List of file containers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FileContainer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
