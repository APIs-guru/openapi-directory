...
class GroupUsersListByGroups200Response(BaseModel):
    """
    ...
    value: Optional[List[GroupUsersListByGroups200ResponseValueInner]] = Field(default=None, description="Page values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [GroupUsersListByGroups200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
