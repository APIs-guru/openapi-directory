...
class GroupUsersListByGroups200ResponseValueInnerIdentitiesInner(BaseModel):
    """
    User identity details.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier value within provider.")
    provider: Optional[StrictStr] = Field(default=None, description="Identity provider name.")
