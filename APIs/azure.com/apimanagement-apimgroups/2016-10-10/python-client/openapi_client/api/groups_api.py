...
class GroupsApi:
    ...
    def groups_create_or_update(
        ...
        _param = self._groups_create_or_update_serialize(
    ...
    @validate_call
    def groups_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def groups_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    def _groups_create_or_update_serialize(
        self,
        resource_group_name,
        service_name,
        group_id,
    ...
    def groups_list_by_service(
        ...
        _param = self._groups_list_by_service_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def groups_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    @validate_call
    def groups_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _groups_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
    ...
    @validate_call
    def groups_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def groups_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
