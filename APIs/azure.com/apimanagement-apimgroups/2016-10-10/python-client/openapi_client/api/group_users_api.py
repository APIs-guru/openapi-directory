...
class GroupUsersApi:
    ...
    def group_users_create(
        ...
        _param = self._group_users_create_serialize(
    ...
    @validate_call
    def group_users_create_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def group_users_create_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    def _group_users_create_serialize(
        self,
        resource_group_name,
        service_name,
        group_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId}/users/{uid}',
    ...
    def group_users_delete(
        ...
        _param = self._group_users_delete_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            group_id=group_id,
            uid=uid,
    ...
    @validate_call
    def group_users_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def group_users_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    def _group_users_delete_serialize(
        self,
        resource_group_name,
        service_name,
        group_id,
    ...
    @validate_call
    def group_users_list_by_groups(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
        ...
        _param = self._group_users_list_by_groups_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            group_id=group_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GroupUsersListByGroups200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def group_users_list_by_groups_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GroupUsersListByGroups200Response]:
        """group_users_list_by_groups
    ...
    @validate_call
    def group_users_list_by_groups_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        group_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Group identifier. Must be unique in the current API Management service instance.")],
    ...
    def _group_users_list_by_groups_serialize(
        self,
        resource_group_name,
        service_name,
        group_id,
