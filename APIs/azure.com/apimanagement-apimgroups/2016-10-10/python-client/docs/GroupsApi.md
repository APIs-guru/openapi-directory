...
------------- | ------------- | -------------
[**groups_create_or_update**](GroupsApi.md#groups_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**groups_delete**](GroupsApi.md#groups_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**groups_get**](GroupsApi.md#groups_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**groups_list_by_service**](GroupsApi.md#groups_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups | 
[**groups_update**](GroupsApi.md#groups_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 


# **groups_create_or_update**
> groups_create_or_update(resource_group_name, service_name, group_id, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.groups_create_or_update(resource_group_name, service_name, group_id, api_version, subscription_id, parameters)
    except Exception as e:
        print("Exception when calling GroupsApi->groups_create_or_update: %s\n" % e)
```
...
**204** | Group already exists. |  -  |
**0** | Error response describing why the operation failed. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **groups_delete**
> groups_delete(resource_group_name, service_name, group_id, if_match, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.groups_delete(resource_group_name, service_name, group_id, if_match, api_version, subscription_id)
    except Exception as e:
...
**405** | The specified group cannot be updated because it is a built-in group. |  -  |
**0** | Error response describing why the operation failed. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **groups_get**
> GroupContract groups_get(resource_group_name, service_name, group_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.groups_get(resource_group_name, service_name, group_id, api_version, subscription_id)
...
> GroupCollection groups_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.groups_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of GroupsApi->groups_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GroupsApi->groups_list_by_service: %s\n" % e)
```
...
# **groups_update**
> groups_update(resource_group_name, service_name, group_id, if_match, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.groups_update(resource_group_name, service_name, group_id, if_match, api_version, subscription_id, parameters)
    except Exception as e:
