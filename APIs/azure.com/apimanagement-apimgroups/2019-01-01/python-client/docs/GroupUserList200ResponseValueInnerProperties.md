...
**groups** | [**List[GroupListByService200ResponseValueInnerProperties]**](GroupListByService200ResponseValueInnerProperties.md) | Collection of groups user is part of. | [optional] [readonly] 
