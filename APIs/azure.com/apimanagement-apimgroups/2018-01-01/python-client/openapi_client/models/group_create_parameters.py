...
class GroupCreateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[GroupCreateParametersProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GroupCreateParametersProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
