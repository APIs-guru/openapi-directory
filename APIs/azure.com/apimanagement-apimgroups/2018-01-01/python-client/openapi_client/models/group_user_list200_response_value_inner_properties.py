...
class GroupUserList200ResponseValueInnerProperties(BaseModel):
    """
    User profile.
    """ # noqa: E501
    ...
    groups: Optional[List[GroupUserList200ResponseValueInnerPropertiesGroupsInner]] = Field(default=None, description="Collection of groups user is part of.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [GroupUserList200ResponseValueInnerPropertiesGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
