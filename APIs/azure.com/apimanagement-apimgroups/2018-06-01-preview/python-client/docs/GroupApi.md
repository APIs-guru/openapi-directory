...
------------- | ------------- | -------------
[**group_create_or_update**](GroupApi.md#group_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**group_delete**](GroupApi.md#group_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**group_get**](GroupApi.md#group_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**group_get_entity_tag**](GroupApi.md#group_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 
[**group_list_by_service**](GroupApi.md#group_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups | 
[**group_update**](GroupApi.md#group_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} | 


# **group_create_or_update**
> GroupGet200Response group_create_or_update(resource_group_name, service_name, group_id, api_version, subscription_id, parameters, if_match=if_match)
...
|-------------|-------------|------------------|
**200** | Group already exists. |  * ETag - Current entity state version. Should be treated as opaque and used to make conditional HTTP requests. <br>  |
**201** | Group was created successfully. |  * ETag - Current entity state version. Should be treated as opaque and used to make conditional HTTP requests. <br>  |
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GroupApi->group_delete: %s\n" % e)
```
...
# **group_get**
> GroupGet200Response group_get(resource_group_name, service_name, group_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GroupApi->group_get:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GroupApi->group_get_entity_tag: %s\n" % e)
```
...
> GroupListByService200Response group_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GroupApi->group_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GroupApi->group_list_by_service: %s\n" % e)
```
 ...
 **api_version** | **str**| Version of the API to be used with the client request. | 
 **subscription_id** | **str**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **filter** | **str**| | Field       | Supported operators    | Supported functions               | |-------------|------------------------|-----------------------------------|   |name | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| |displayName | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| |description | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| |aadObjectId | eq |    |  | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.GroupUpdateRequest() # GroupUpdateRequest | Update parameters.
