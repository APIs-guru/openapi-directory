...
class RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner(BaseModel):
    """
    Represents a Service Tier Advisor.
    """ # noqa: E501
    properties: Optional[RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
