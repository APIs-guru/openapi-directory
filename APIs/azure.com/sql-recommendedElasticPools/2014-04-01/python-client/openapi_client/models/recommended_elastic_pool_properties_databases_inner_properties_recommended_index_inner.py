...
class RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner(BaseModel):
    """
    Represents a database recommended index.
    """ # noqa: E501
    properties: Optional[RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
