...
class RecommendedElasticPoolListResult(BaseModel):
    """
    Represents the response to a list recommended elastic pool request.
    """ # noqa: E501
    value: List[RecommendedElasticPool] = Field(description="The list of recommended elastic pools hosted in the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RecommendedElasticPool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
