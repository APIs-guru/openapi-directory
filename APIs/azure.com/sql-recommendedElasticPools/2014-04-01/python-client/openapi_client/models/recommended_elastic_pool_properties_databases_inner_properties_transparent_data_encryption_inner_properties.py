...
class RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInnerProperties(BaseModel):
    """
    Represents the properties of a database transparent data encryption.
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The status of the database transparent data encryption.")
