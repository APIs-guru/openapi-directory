...
class TestRecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner(unittest.TestCase):
    """RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner:
        """Test RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner`
        """
        model = RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner()
        if include_optional:
            return RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner(
    ...
    def testRecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner(self):
        """Test RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner"""
