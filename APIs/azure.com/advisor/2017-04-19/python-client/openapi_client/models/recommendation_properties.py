...
class RecommendationProperties(BaseModel):
    ...
    extended_properties: Optional[Dict[str, StrictStr]] = Field(default=None, description="Extended properties", alias="extendedProperties")
    ...
    __properties: ClassVar[List[str]] = ["category", "extendedProperties", "impact", "impactedField", "impactedValue", "lastUpdated", "metadata", "recommendationTypeId", "risk", "shortDescription", "suppressionIds"]
