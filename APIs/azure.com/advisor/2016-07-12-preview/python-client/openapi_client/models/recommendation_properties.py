...
class RecommendationProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category", "impact", "impactedField", "impactedValue", "lastUpdated", "metadata", "recommendationTypeId", "risk", "shortDescription"]
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['HighAvailability', 'Security', 'Performance', 'Cost']):
            raise ValueError("must be one of enum values ('HighAvailability', 'Security', 'Performance', 'Cost')")
        return value
