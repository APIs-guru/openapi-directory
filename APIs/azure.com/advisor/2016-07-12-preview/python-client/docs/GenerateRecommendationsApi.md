...
[**recommendations_get_generate_recommendations_status**](GenerateRecommendationsApi.md#recommendations_get_generate_recommendations_status) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Advisor/generateRecommendations/{operationId} | 
...
> recommendations_get_generate_recommendations_status(subscription_id, operation_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.recommendations_get_generate_recommendations_status(subscription_id, operation_id, api_version)
    except Exception as e:
        print("Exception when calling GenerateRecommendationsApi->recommendations_get_generate_recommendations_status: %s\n" % e)
```
