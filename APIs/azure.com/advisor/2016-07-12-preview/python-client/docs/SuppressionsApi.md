...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | The recommendation has been activated. |  -  |
...
# **suppressions_list**
> List[SuppressionContract] suppressions_list(subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.suppressions_list(subscription_id, api_version)
...
[**List[SuppressionContract]**](SuppressionContract.md)
