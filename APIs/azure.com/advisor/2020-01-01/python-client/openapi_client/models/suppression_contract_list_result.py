...
class SuppressionContractListResult(BaseModel):
    """
    The list of Advisor suppressions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of suppressions.", alias="nextLink")
    value: Optional[List[SuppressionContract]] = Field(default=None, description="The list of suppressions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SuppressionContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
