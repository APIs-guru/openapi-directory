...
class AuthorizationServerListByService200ResponseValueInner(BaseModel):
    """
    External OAuth authorization server settings.
    """ # noqa: E501
    properties: Optional[AuthorizationServerListByService200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AuthorizationServerListByService200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
