...
class TestAuthorizationServerContractProperties(unittest.TestCase):
    """AuthorizationServerContractProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthorizationServerContractProperties:
        """Test AuthorizationServerContractProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorizationServerContractProperties`
        """
        model = AuthorizationServerContractProperties()
        if include_optional:
            return AuthorizationServerContractProperties(
    ...
    def testAuthorizationServerContractProperties(self):
        """Test AuthorizationServerContractProperties"""
