...
class AuthorizationServersApi:
    ...
    def authorization_server_create_or_update(
        ...
        parameters: Annotated[AuthorizationServerContract, Field(description="Create or update parameters.")],
        ...
        :type parameters: AuthorizationServerContract
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AuthorizationServerContract",
            '201': "AuthorizationServerContract",
        }
    ...
    def authorization_server_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthorizationServerContract]:
        """authorization_server_create_or_update
    ...
    def authorization_server_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[AuthorizationServerUpdateContract, Field(description="OAuth2 Server settings Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: AuthorizationServerUpdateContract
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
