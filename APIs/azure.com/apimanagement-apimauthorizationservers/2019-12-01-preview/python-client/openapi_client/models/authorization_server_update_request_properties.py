...
class AuthorizationServerUpdateRequestProperties(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(default=None, description="Client or app secret registered with this authorization server. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.", alias="clientSecret")
    ...
    __properties: ClassVar[List[str]] = ["authorizationEndpoint", "clientId", "clientRegistrationEndpoint", "clientSecret", "displayName", "grantTypes"]
