...
class AuthorizationServerListSecrets200Response(BaseModel):
    """
    Client or app secret used in IdentityProviders, Aad, OpenID or OAuth.
    """ # noqa: E501
    client_secret: Optional[StrictStr] = Field(default=None, description="Client or app secret used in IdentityProviders, Aad, OpenID or OAuth.", alias="clientSecret")
