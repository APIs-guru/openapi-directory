...
class AuthorizationServerApi:
    ...
    @validate_call
    def authorization_server_list_secrets(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        authsid: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the authorization server.")],
        ...
        _param = self._authorization_server_list_secrets_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            authsid=authsid,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AuthorizationServerListSecrets200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def authorization_server_list_secrets_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        authsid: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the authorization server.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthorizationServerListSecrets200Response]:
        """authorization_server_list_secrets
    ...
    @validate_call
    def authorization_server_list_secrets_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        authsid: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the authorization server.")],
    ...
    def _authorization_server_list_secrets_serialize(
        self,
        resource_group_name,
        service_name,
        authsid,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}/listSecrets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
