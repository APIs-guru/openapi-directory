...
**name** | **str** | User-friendly authorization server name. | [optional] 
...
o_auth2_authorization_server_update_contract_instance = OAuth2AuthorizationServerUpdateContract.from_json(json)
# print the JSON string representation of the object
print(OAuth2AuthorizationServerUpdateContract.to_json())

# convert the object into a dict
o_auth2_authorization_server_update_contract_dict = o_auth2_authorization_server_update_contract_instance.to_dict()
# create an instance of OAuth2AuthorizationServerUpdateContract from a dict
o_auth2_authorization_server_update_contract_from_dict = OAuth2AuthorizationServerUpdateContract.from_dict(o_auth2_authorization_server_update_contract_dict)
```
