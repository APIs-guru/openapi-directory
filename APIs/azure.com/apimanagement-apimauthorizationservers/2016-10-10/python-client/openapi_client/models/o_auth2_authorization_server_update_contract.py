...
class OAuth2AuthorizationServerUpdateContract(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=50)]] = Field(default=None, description="User-friendly authorization server name.")
    ...
    __properties: ClassVar[List[str]] = ["authorizationEndpoint", "authorizationMethods", "bearerTokenSendingMethods", "clientAuthenticationMethod", "clientId", "clientRegistrationEndpoint", "clientSecret", "defaultScope", "description", "grantTypes", "name", "resourceOwnerPassword", "resourceOwnerUsername", "supportState", "tokenBodyParameters", "tokenEndpoint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuth2AuthorizationServerUpdateContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuth2AuthorizationServerUpdateContract from a dict"""
        if obj is None:
            return None
