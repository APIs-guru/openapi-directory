...
class OAuth2AuthorizationServerContract(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the authorization server within the current API Management service instance. The value is a valid relative URL in the format of /authorizationServers/{authsid} where {authsid} is an authorization server identifier.")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="User-friendly authorization server name.")
