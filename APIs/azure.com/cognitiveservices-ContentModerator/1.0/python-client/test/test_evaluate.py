...
class TestEvaluate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Evaluate:
        """Test Evaluate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Evaluate`
        """
        model = Evaluate()
        if include_optional:
            return Evaluate(
                adult_classification_score = 1.337,
                advanced_info = [
                ...
                racy_classification_score = 1.337,
                result = True,
