...
class MatchResponse(BaseModel):
    ...
    is_match: Optional[StrictBool] = Field(default=None, description="Indicates if there is a match.", alias="IsMatch")
    matches: Optional[List[Match]] = Field(default=None, description="The match details.", alias="Matches")
    ...
    __properties: ClassVar[List[str]] = ["CacheID", "IsMatch", "Matches", "Status", "TrackingId"]
