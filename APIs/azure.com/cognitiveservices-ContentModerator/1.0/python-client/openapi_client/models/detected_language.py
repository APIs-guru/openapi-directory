...
class DetectedLanguage(BaseModel):
    ...
    """ # noqa: E501
    detected_language: Optional[StrictStr] = Field(default=None, description="The detected language.", alias="DetectedLanguage")
    ...
    __properties: ClassVar[List[str]] = ["DetectedLanguage", "Status", "TrackingId"]
