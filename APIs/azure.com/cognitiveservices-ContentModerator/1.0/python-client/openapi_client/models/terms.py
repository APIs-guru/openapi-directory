...
class Terms(BaseModel):
    ...
    Terms properties.
    """ # noqa: E501
    data: Optional[TermsData] = Field(default=None, alias="Data")
    paging: Optional[TermsPaging] = Field(default=None, alias="Paging")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Data": TermsData.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
            "Paging": TermsPaging.from_dict(obj["Paging"]) if obj.get("Paging") is not None else None
        })
        return _obj
