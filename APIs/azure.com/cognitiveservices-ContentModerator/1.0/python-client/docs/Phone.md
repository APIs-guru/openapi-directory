...
------------ | ------------- | ------------- | -------------
**country_code** | **str** | CountryCode of the detected Phone number. | [optional] 
**index** | **int** | Index(Location) of the Phone number in the input text content. | [optional] 
**text** | **str** | Detected Phone number. | [optional] 
