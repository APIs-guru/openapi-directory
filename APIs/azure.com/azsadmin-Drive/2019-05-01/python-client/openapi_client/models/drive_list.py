...
class DriveList(BaseModel):
    ...
    value: Optional[List[Drive]] = Field(default=None, description="List of storage drives.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Drive.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
