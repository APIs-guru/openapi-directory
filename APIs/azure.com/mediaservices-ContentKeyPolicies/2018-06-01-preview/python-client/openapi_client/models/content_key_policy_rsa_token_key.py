...
class ContentKeyPolicyRsaTokenKey(ContentKeyPolicyRestrictionTokenKey):
    ...
    """ # noqa: E501
    exponent: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="The RSA Parameter exponent")
    modulus: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="The RSA Parameter modulus")
    __properties: ClassVar[List[str]] = ["@odata.type"]

    @field_validator('exponent')
    def exponent_validate_regular_expression(cls, value):
