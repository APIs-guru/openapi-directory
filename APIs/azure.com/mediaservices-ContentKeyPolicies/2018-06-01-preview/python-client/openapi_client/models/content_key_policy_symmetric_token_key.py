...
class ContentKeyPolicySymmetricTokenKey(ContentKeyPolicyRestrictionTokenKey):
    ...
    """ # noqa: E501
    key_value: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="The key value of the key", alias="keyValue")
    __properties: ClassVar[List[str]] = ["@odata.type"]

    @field_validator('key_value')
    def key_value_validate_regular_expression(cls, value):
