...
class TestContentKeyPolicyPlayReadyConfiguration(unittest.TestCase):
    """ContentKeyPolicyPlayReadyConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentKeyPolicyPlayReadyConfiguration:
        """Test ContentKeyPolicyPlayReadyConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentKeyPolicyPlayReadyConfiguration`
        """
        model = ContentKeyPolicyPlayReadyConfiguration()
        if include_optional:
            return ContentKeyPolicyPlayReadyConfiguration(
                licenses = [
                    openapi_client.models.content_key_policy_play_ready_license.ContentKeyPolicyPlayReadyLicense(
    ...
    def testContentKeyPolicyPlayReadyConfiguration(self):
        """Test ContentKeyPolicyPlayReadyConfiguration"""
