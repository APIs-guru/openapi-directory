...
class ContentKeyPoliciesListDefaultResponse(BaseModel):
    """
    The API error.
    """ # noqa: E501
    error: Optional[ContentKeyPoliciesListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ContentKeyPoliciesListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
