...
class ContentKeyPolicyPlayReadyConfiguration(ContentKeyPolicyConfiguration):
    ...
    """ # noqa: E501
    licenses: List[ContentKeyPolicyPlayReadyLicense] = Field(description="The PlayReady licenses.")
    response_custom_data: Optional[StrictStr] = Field(default=None, description="The custom response data.", alias="responseCustomData")
