...
class WorkspacesApi:
    ...
    def workspaces_create_or_update(
        ...
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=64, description="The name of the workspace.")],
        ...
        parameters: Annotated[Workspace, Field(description="Parameters supplied to the create or update a workspace.")],
    ...
    def _workspaces_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces/{workspaceName}',
    ...
    def _workspaces_list_by_resource_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _workspaces_list_by_subscription_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Databricks/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def workspaces_update(
        ...
        api_version: Annotated[StrictStr, Field(description="The API version to use for this operation.")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the target subscription.")],
        parameters: Annotated[WorkspaceUpdate, Field(description="The update to the workspace.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: WorkspaceUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
