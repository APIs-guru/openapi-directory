...
class WorkItemConfigurationsListResult(BaseModel):
    """
    Work item configuration list result.
    """ # noqa: E501
    value: Optional[List[WorkItemConfiguration]] = Field(default=None, description="An array of work item configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [WorkItemConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
