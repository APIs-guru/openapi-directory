...
------------- | ------------- | -------------
[**diagnostic_settings_category_list**](DiagnosticSettingsCategoriesApi.md#diagnostic_settings_category_list) | **GET** /providers/microsoft.aadiam/diagnosticSettingsCategories | 


# **diagnostic_settings_category_list**
> DiagnosticSettingsCategoryResourceCollection diagnostic_settings_category_list(api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.diagnostic_settings_category_list(api_version)
