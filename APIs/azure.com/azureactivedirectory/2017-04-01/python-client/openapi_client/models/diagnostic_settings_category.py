...
class DiagnosticSettingsCategory(BaseModel):
    """
    The diagnostic settings Category.
    """ # noqa: E501
    category_type: Optional[StrictStr] = Field(default=None, description="The type of the diagnostic settings category.", alias="categoryType")
    __properties: ClassVar[List[str]] = ["categoryType"]
