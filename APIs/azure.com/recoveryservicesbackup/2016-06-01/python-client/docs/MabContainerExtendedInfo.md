...
------------ | ------------- | ------------- | -------------
**backup_item_type** | **str** | The type of backup items associated with this container. | [optional] 
**backup_items** | **List[str]** | The list of backup items associated with this container. | [optional] 
**last_backup_status** | **str** | The latest backup status of this container. | [optional] 
**last_refreshed_at** | **datetime** | The time stamp when this container was refreshed. | [optional] 
**policy_name** | **str** | The backup policy associated with this container. | [optional] 
