...
**error_title** | **str** | Title: typically, the entity associated the error. | [optional] 
**recommendations** | **List[str]** | List of localized recommendations for the error string. | [optional] 
