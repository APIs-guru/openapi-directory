...
**policy_inconsistent** | **bool** | Specifies if the backup policy associated with the backup item is inconsistent. | [optional] 
**recovery_point_count** | **int** | The number of backup copies available for this backup item. | [optional] 
