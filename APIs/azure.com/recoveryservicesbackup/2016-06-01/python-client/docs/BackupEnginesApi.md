...
------------- | ------------- | -------------
[**backup_engines_get**](BackupEnginesApi.md#backup_engines_get) | **GET** /Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupEngines | 


# **backup_engines_get**
> BackupEngineBaseResourceList backup_engines_get(api_version, vault_name, resource_group_name, subscription_id, filter=filter, skip_token=skip_token)
 ...
 **filter** | **str**| Use this filter to choose the specific backup management server. backupManagementType { AzureIaasVM, MAB, DPM, AzureBackupServer, AzureSql }. | [optional] 
