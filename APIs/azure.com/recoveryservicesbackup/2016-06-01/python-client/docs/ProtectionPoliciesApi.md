...
[**protection_policies_list**](ProtectionPoliciesApi.md#protection_policies_list) | **GET** /Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies | 


# **protection_policies_create_or_update**
> ProtectionPolicyResource protection_policies_create_or_update(api_version, vault_name, resource_group_name, subscription_id, policy_name, resource_protection_policy)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    policy_name = 'policy_name_example' # str | The backup policy to be created.
    resource_protection_policy = openapi_client.ProtectionPolicyResource() # ProtectionPolicyResource | The resource backup policy.

    try:
        api_response = api_instance.protection_policies_create_or_update(api_version, vault_name, resource_group_name, subscription_id, policy_name, resource_protection_policy)
 ...
 **policy_name** | **str**| The backup policy to be created. | 
 **resource_protection_policy** | [**ProtectionPolicyResource**](ProtectionPolicyResource.md)| The resource backup policy. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group associated with the Recovery Services vault.
    subscription_id = 'subscription_id_example' # str | The subscription ID.
    policy_name = 'policy_name_example' # str | The name of the backup policy to be deleted.
 ...
 **resource_group_name** | **str**| The name of the resource group associated with the Recovery Services vault. | 
 **subscription_id** | **str**| The subscription ID. | 
 **policy_name** | **str**| The name of the backup policy to be deleted. | 
...
> ProtectionPolicyResourceList protection_policies_list(api_version, vault_name, resource_group_name, subscription_id, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group associated with the Recovery Services vault.
    subscription_id = 'subscription_id_example' # str | The subscription ID.
    filter = 'filter_example' # str | The following equation can be used to filter the list of backup policies. backupManagementType eq {AzureIaasVM, MAB, DPM, AzureBackupServer, AzureSql}. (optional)

    try:
        api_response = api_instance.protection_policies_list(api_version, vault_name, resource_group_name, subscription_id, filter=filter)
        print("The response of ProtectionPoliciesApi->protection_policies_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProtectionPoliciesApi->protection_policies_list: %s\n" % e)
```
 ...
 **resource_group_name** | **str**| The name of the resource group associated with the Recovery Services vault. | 
 **subscription_id** | **str**| The subscription ID. | 
 **filter** | **str**| The following equation can be used to filter the list of backup policies. backupManagementType eq {AzureIaasVM, MAB, DPM, AzureBackupServer, AzureSql}. | [optional] 
