...
------------ | ------------- | ------------- | -------------
**months_of_year** | **List[str]** | List of the months of year for the yearly retention policy. | [optional] 
...
**retention_schedule_format_type** | **str** | Retention schedule format for the yearly retention policy. | [optional] 
**retention_schedule_weekly** | [**WeeklyRetentionFormat**](WeeklyRetentionFormat.md) |  | [optional] 
**retention_times** | **List[datetime]** | Retention times for the retention policy. | [optional] 
