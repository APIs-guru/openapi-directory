...
**end_time** | **datetime** | The time when the job ends. The value is in UTC. | [optional] 
**job_id** | **str** | The ID of the job. Each jobID is unique. | [optional] 
**operation** | **str** | The type of operation. | [optional] 
**start_time** | **datetime** | The time when the job starts. The value is in UTC. | [optional] 
