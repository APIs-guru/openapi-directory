...
# **restores_trigger**
> restores_trigger(api_version, vault_name, resource_group_name, subscription_id, fabric_name, container_name, protected_item_name, recovery_point_id, resource_restore_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    protected_item_name = 'protected_item_name_example' # str | The backup item to be restored.
    recovery_point_id = 'recovery_point_id_example' # str | The recovery point ID for the backup data to be restored.
    resource_restore_request = openapi_client.RestoreRequestResource() # RestoreRequestResource | The resource restore request.

    try:
        api_instance.restores_trigger(api_version, vault_name, resource_group_name, subscription_id, fabric_name, container_name, protected_item_name, recovery_point_id, resource_restore_request)
 ...
 **protected_item_name** | **str**| The backup item to be restored. | 
 **recovery_point_id** | **str**| The recovery point ID for the backup data to be restored. | 
 **resource_restore_request** | [**RestoreRequestResource**](RestoreRequestResource.md)| The resource restore request. | 
