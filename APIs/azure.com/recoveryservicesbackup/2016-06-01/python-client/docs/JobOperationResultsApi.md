...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    job_name = 'job_name_example' # str | Job name associated with this GET operation.
    operation_id = 'operation_id_example' # str | OperationID associated with this GET operation.
 ...
 **job_name** | **str**| Job name associated with this GET operation. | 
 **operation_id** | **str**| OperationID associated with this GET operation. | 
