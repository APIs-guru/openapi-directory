...
class TestYearlyRetentionSchedule(unittest.TestCase):
    """YearlyRetentionSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YearlyRetentionSchedule:
        """Test YearlyRetentionSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YearlyRetentionSchedule`
        """
        model = YearlyRetentionSchedule()
        if include_optional:
    ...
    def testYearlyRetentionSchedule(self):
        """Test YearlyRetentionSchedule"""
