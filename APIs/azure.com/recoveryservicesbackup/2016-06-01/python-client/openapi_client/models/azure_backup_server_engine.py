...
class AzureBackupServerEngine(BackupEngineBase):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["backupEngineId", "backupEngineType", "backupManagementType", "canReRegister", "friendlyName", "healthStatus", "registrationStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backupEngineId": obj.get("backupEngineId"),
            "backupEngineType": obj.get("backupEngineType"),
            "backupManagementType": obj.get("backupManagementType"),
            "canReRegister": obj.get("canReRegister"),
