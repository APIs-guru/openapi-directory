...
class AzureSqlProtectedItem(ProtectedItem):
    ...
    """ # noqa: E501
    extended_info: Optional[AzureSqlProtectedItemExtendedInfo] = Field(default=None, alias="extendedInfo")
    protected_item_data_id: Optional[StrictStr] = Field(default=None, description="The internal ID of a backup item. The internal ID is used by the Azure SQL Backup engine to contact Recovery Services.", alias="protectedItemDataId")
    protection_state: Optional[StrictStr] = Field(default=None, description="The backup state of the backup item.", alias="protectionState")
