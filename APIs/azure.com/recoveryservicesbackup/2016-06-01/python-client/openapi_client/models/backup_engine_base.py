...
class BackupEngineBase(BaseModel):
    ...
    """ # noqa: E501
    backup_engine_id: Optional[StrictStr] = Field(default=None, description="The ID of the backup engine.", alias="backupEngineId")
    backup_engine_type: Optional[StrictStr] = Field(default=None, description="The type of the backup engine.", alias="backupEngineType")
    backup_management_type: Optional[StrictStr] = Field(default=None, description="The type of backup management associated with the backup engine.", alias="backupManagementType")
    can_re_register: Optional[StrictBool] = Field(default=None, description="The flag indicating whether the backup engine be registered again, once the engine has been initially registered.", alias="canReRegister")
    friendly_name: Optional[StrictStr] = Field(default=None, description="The friendly name of the backup engine.", alias="friendlyName")
    health_status: Optional[StrictStr] = Field(default=None, description="The backup status of the backup engine.", alias="healthStatus")
    registration_status: Optional[StrictStr] = Field(default=None, description="The status of the backup engine registration with the Recovery Services vault.", alias="registrationStatus")
