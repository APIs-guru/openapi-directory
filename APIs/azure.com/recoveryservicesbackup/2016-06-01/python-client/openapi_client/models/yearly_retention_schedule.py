...
class YearlyRetentionSchedule(BaseModel):
    ...
    """ # noqa: E501
    months_of_year: Optional[List[StrictStr]] = Field(default=None, description="List of the months of year for the yearly retention policy.", alias="monthsOfYear")
    ...
    retention_schedule_format_type: Optional[StrictStr] = Field(default=None, description="Retention schedule format for the yearly retention policy.", alias="retentionScheduleFormatType")
    retention_schedule_weekly: Optional[WeeklyRetentionFormat] = Field(default=None, alias="retentionScheduleWeekly")
    retention_times: Optional[List[datetime]] = Field(default=None, description="Retention times for the retention policy.", alias="retentionTimes")
