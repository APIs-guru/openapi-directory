...
class ProtectionPolicyQueryObject(BaseModel):
    ...
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="The backup management type associated with the backup policy.", alias="backupManagementType")
