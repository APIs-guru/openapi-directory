...
class MabFileFolderProtectedItem(ProtectedItem):
    ...
    """ # noqa: E501
    computer_name: Optional[StrictStr] = Field(default=None, description="The name of the computer associated with this backup item.", alias="computerName")
    extended_info: Optional[MabFileFolderProtectedItemExtendedInfo] = Field(default=None, alias="extendedInfo")
    friendly_name: Optional[StrictStr] = Field(default=None, description="The friendly name of this backup item.", alias="friendlyName")
    is_scheduled_for_deferred_delete: Optional[StrictBool] = Field(default=None, alias="isScheduledForDeferredDelete")
    last_backup_status: Optional[StrictStr] = Field(default=None, description="The status of last backup operation.", alias="lastBackupStatus")
    protection_state: Optional[StrictStr] = Field(default=None, description="The states for this property are: Protected, ProtectionStopped, IRPending, or ProtectionError.", alias="protectionState")
