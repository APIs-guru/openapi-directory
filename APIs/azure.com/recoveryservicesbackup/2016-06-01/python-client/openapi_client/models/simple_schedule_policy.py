...
class SimpleSchedulePolicy(SchedulePolicy):
    ...
    """ # noqa: E501
    schedule_run_days: Optional[List[StrictStr]] = Field(default=None, description="This list is the days of the week when the schedule runs.", alias="scheduleRunDays")
    schedule_run_frequency: Optional[StrictStr] = Field(default=None, description="Defines the frequency interval (daily or weekly) for the schedule policy.", alias="scheduleRunFrequency")
    schedule_run_times: Optional[List[datetime]] = Field(default=None, description="List of times, during a day, when the schedule runs.", alias="scheduleRunTimes")
    schedule_weekly_frequency: Optional[StrictInt] = Field(default=None, description="The number of times per week the schedule runs.", alias="scheduleWeeklyFrequency")
