...
class MabJob(Job):
    ...
    """ # noqa: E501
    actions_info: Optional[List[StrictStr]] = Field(default=None, description="The state or actions applicable on jobs such as Cancel or Retry.", alias="actionsInfo")
    duration: Optional[StrictStr] = Field(default=None, description="The time required for the job to run.")
    ...
    mab_server_name: Optional[StrictStr] = Field(default=None, description="The name of server protecting the data store.", alias="mabServerName")
    mab_server_type: Optional[StrictStr] = Field(default=None, description="Server type of the Azure Backup Server container.", alias="mabServerType")
    ...
    def mab_server_type_validate_enum(cls, value):
        ...
        if value not in set(['Invalid', 'Unknown', 'IaasVMContainer', 'IaasVMServiceContainer', 'DPMContainer', 'DPMVenusContainer', 'MABContainer', 'ClusterResource', 'AzureSqlContainer', 'WindowsServer', 'Windows']):
            raise ValueError("must be one of enum values ('Invalid', 'Unknown', 'IaasVMContainer', 'IaasVMServiceContainer', 'DPMContainer', 'DPMVenusContainer', 'MABContainer', 'ClusterResource', 'AzureSqlContainer', 'WindowsServer', 'Windows')")
        return value
