...
class AzureIaaSVMProtectedItem(ProtectedItem):
    ...
    friendly_name: Optional[StrictStr] = Field(default=None, description="The friendly name of the VM represented by this backup item.", alias="friendlyName")
    last_backup_status: Optional[StrictStr] = Field(default=None, description="The last backup operation status. The possible values are: Healthy or Unhealthy.", alias="lastBackupStatus")
    last_backup_time: Optional[datetime] = Field(default=None, description="The timestamp of the last backup operation for this backup item.", alias="lastBackupTime")
    protection_state: Optional[StrictStr] = Field(default=None, description="The backup state of this backup item.", alias="protectionState")
    protection_status: Optional[StrictStr] = Field(default=None, description="The backup status of this backup item.", alias="protectionStatus")
    virtual_machine_id: Optional[StrictStr] = Field(default=None, description="The fully qualified Resource Manager ID of the virtual machine represented by this item.", alias="virtualMachineId")
