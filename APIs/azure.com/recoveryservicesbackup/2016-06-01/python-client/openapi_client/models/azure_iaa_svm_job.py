...
class AzureIaaSVMJob(Job):
    ...
    """ # noqa: E501
    actions_info: Optional[List[StrictStr]] = Field(default=None, description="Gets or sets the state, or actions, applicable on this job. Examples of the actions are: Cancel or Retry.", alias="actionsInfo")
    duration: Optional[StrictStr] = Field(default=None, description="The time that elapsed during the execution of this job.")
    error_details: Optional[List[AzureIaaSVMErrorInfo]] = Field(default=None, description="Error details about this job.", alias="errorDetails")
    extended_info: Optional[AzureIaaSVMJobExtendedInfo] = Field(default=None, alias="extendedInfo")
    virtual_machine_version: Optional[StrictStr] = Field(default=None, description="Specifies whether the backup item is a Classic VM or a Resource Manager VM.", alias="virtualMachineVersion")
