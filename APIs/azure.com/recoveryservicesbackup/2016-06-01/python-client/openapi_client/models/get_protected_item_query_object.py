...
class GetProtectedItemQueryObject(BaseModel):
    """
    This object filters the list of backup items.
    """ # noqa: E501
    expand: Optional[StrictStr] = Field(default=None, description="Specifies if the additional information should be provided for this item.")
