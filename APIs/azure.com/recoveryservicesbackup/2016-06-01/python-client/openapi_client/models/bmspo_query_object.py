...
class BMSPOQueryObject(BaseModel):
    """
    Filters the list of backup items.
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="The backup management type.", alias="backupManagementType")
    friendly_name: Optional[StrictStr] = Field(default=None, description="The friendly name for the item.", alias="friendlyName")
    status: Optional[StrictStr] = Field(default=None, description="The backup status query parameter.")
