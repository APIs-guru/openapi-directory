...
class BMSBackupEngineQueryObject(BaseModel):
    """
    The query parameters used to GET the list of backup engines.
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="The backup management type associated with the backup engine.", alias="backupManagementType")
    __properties: ClassVar[List[str]] = ["backupManagementType"]
