...
class AzureIaaSVMJobExtendedInfo(BaseModel):
    ...
    """ # noqa: E501
    dynamic_error_message: Optional[StrictStr] = Field(default=None, description="Non-localized error message for job execution.", alias="dynamicErrorMessage")
    ...
    __properties: ClassVar[List[str]] = ["dynamicErrorMessage", "progressPercentage", "propertyBag", "tasksList"]
