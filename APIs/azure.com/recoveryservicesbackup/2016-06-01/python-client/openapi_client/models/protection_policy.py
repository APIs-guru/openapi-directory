...
class ProtectionPolicy(BaseModel):
    ...
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="This property is used as the discriminator for deciding the specific types in the polymorphic chain of types.", alias="backupManagementType")
    protected_items_count: Optional[StrictInt] = Field(default=None, description="The number of items associated with this policy.", alias="protectedItemsCount")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'AzureIaaSVMProtectionPolicy': 'AzureIaaSVMProtectionPolicy','AzureSqlProtectionPolicy': 'AzureSqlProtectionPolicy','MabProtectionPolicy': 'MabProtectionPolicy'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AzureIaaSVMProtectionPolicy, AzureSqlProtectionPolicy, MabProtectionPolicy]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AzureIaaSVMProtectionPolicy, AzureSqlProtectionPolicy, MabProtectionPolicy]]:
