...
class AzureIaaSClassicComputeVMProtectableItem(IaaSVMProtectableItem):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["virtualMachineId", "backupManagementType", "friendlyName", "protectableItemType", "protectionState"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureIaaSClassicComputeVMProtectableItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureIaaSClassicComputeVMProtectableItem from a dict"""
        if obj is None:
            return None
