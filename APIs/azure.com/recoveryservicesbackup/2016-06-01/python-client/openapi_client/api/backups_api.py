...
class BackupsApi:
    ...
    def backups_trigger(
        ...
        protected_item_name: Annotated[StrictStr, Field(description="The name of backup item used in this POST operation.")],
        resource_backup_request: Annotated[BackupRequestResource, Field(description="The resource backup request.")],
        ...
        :param protected_item_name: The name of backup item used in this POST operation. (required)
        :type protected_item_name: str
        :param resource_backup_request: The resource backup request. (required)
        :type resource_backup_request: BackupRequestResource
        ...
        _param = self._backups_trigger_serialize(
            ...
            resource_backup_request=resource_backup_request,
    ...
    def _backups_trigger_serialize(
        ...
        if resource_backup_request is not None:
            _body_params = resource_backup_request
