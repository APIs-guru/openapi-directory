...
class ProtectedItemOperationResultsApi:
    ...
    def protected_item_operation_results_get(
        ...
        operation_id: Annotated[StrictStr, Field(description="The OperationID used in this GET operation.")],
        ...
        :param operation_id: The OperationID used in this GET operation. (required)
