...
class JobDetailsApi:
    ...
    def job_details_get(
        ...
        job_name: Annotated[StrictStr, Field(description="Name of the job associated with this GET operation.")],
        ...
        :param job_name: Name of the job associated with this GET operation. (required)
        :type job_name: str
