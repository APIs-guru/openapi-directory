...
class ExportJobsOperationResultsApi:
    ...
    @validate_call
    def export_jobs_operation_results_get(
        self,
        ...
        operation_id: Annotated[StrictStr, Field(description="The ID associated with the export job.")],
        ...
        :param operation_id: The ID associated with the export job. (required)
        ...
        _param = self._export_jobs_operation_results_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OperationResultInfoBaseResource",
            '202': None,
        }
    ...
    @validate_call
    def export_jobs_operation_results_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the Recovery Services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group associated with the Recovery Services vault.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OperationResultInfoBaseResource]:
        """export_jobs_operation_results_get
    ...
    @validate_call
    def export_jobs_operation_results_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the Recovery Services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group associated with the Recovery Services vault.")],
    ...
    def _export_jobs_operation_results_get_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/operationResults/{operationId}',
