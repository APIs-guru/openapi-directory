...
class BackupEnginesApi:
    ...
    def backup_engines_get(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Use this filter to choose the specific backup management server. backupManagementType { AzureIaasVM, MAB, DPM, AzureBackupServer, AzureSql }.")] = None,
