...
class ResourceLinkResult(BaseModel):
    ...
    value: List[ResourceLink] = Field(description="An array of resource links.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
