...
class ServerConnectionPolicy(BaseModel):
    """
    A server secure connection policy.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Metadata used for the Azure portal experience.")
    location: Optional[StrictStr] = Field(default=None, description="Resource location.")
    properties: Optional[ServerConnectionPolicyProperties] = None
