...
------------ | ------------- | ------------- | -------------
**failed_deployments** | **int** | The number of deployments required by the remediation that have failed. | [optional] 
**successful_deployments** | **int** | The number of deployments required by the remediation that have succeeded. | [optional] 
**total_deployments** | **int** | The number of deployments required by the remediation. | [optional] 
