...
class TestRemediationProperties(unittest.TestCase):
    """RemediationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationProperties:
        """Test RemediationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationProperties`
        """
        model = RemediationProperties()
        if include_optional:
            return RemediationProperties(
    ...
    def testRemediationProperties(self):
        """Test RemediationProperties"""
