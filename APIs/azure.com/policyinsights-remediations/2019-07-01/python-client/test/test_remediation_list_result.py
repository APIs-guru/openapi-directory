...
class TestRemediationListResult(unittest.TestCase):
    """RemediationListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediationListResult:
        """Test RemediationListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediationListResult`
        """
        model = RemediationListResult()
        if include_optional:
    ...
    def testRemediationListResult(self):
        """Test RemediationListResult"""
