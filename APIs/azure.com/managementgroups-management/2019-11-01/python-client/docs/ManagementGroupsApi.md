...
> OperationResults management_groups_delete(group_id, api_version, cache_control=cache_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.management_groups_delete(group_id, api_version, cache_control=cache_control)
        print("The response of ManagementGroupsApi->management_groups_delete:\n")
        pprint(api_response)
    except Exception as e:
...
> ManagementGroup management_groups_get(group_id, api_version, expand=expand, recurse=recurse, filter=filter, cache_control=cache_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    group_id = 'group_id_example' # str | Management Group ID.
    api_version = 'api_version_example' # str | Version of the API to be used with the client request. The current version is 2018-01-01-preview.
    expand = 'expand_example' # str | The $expand=children query string parameter allows clients to request inclusion of children in the response payload.  $expand=path includes the path from the root group to the current group. (optional)
    recurse = True # bool | The $recurse=true query string parameter allows clients to request inclusion of entire hierarchy in the response payload. Note that  $expand=children must be passed up if $recurse is set to true. (optional)
    filter = 'filter_example' # str | A filter which allows the exclusion of subscriptions from results (i.e. '$filter=children.childType ne Subscription') (optional)
    cache_control = 'no-cache' # str | Indicates that the request shouldn't utilize any caches. (optional) (default to 'no-cache')

    try:
        api_response = api_instance.management_groups_get(group_id, api_version, expand=expand, recurse=recurse, filter=filter, cache_control=cache_control)
 ...
 **group_id** | **str**| Management Group ID. | 
 **api_version** | **str**| Version of the API to be used with the client request. The current version is 2018-01-01-preview. | 
 **expand** | **str**| The $expand&#x3D;children query string parameter allows clients to request inclusion of children in the response payload.  $expand&#x3D;path includes the path from the root group to the current group. | [optional] 
 **recurse** | **bool**| The $recurse&#x3D;true query string parameter allows clients to request inclusion of entire hierarchy in the response payload. Note that  $expand&#x3D;children must be passed up if $recurse is set to true. | [optional] 
 **filter** | **str**| A filter which allows the exclusion of subscriptions from results (i.e. &#39;$filter&#x3D;children.childType ne Subscription&#39;) | [optional] 
 **cache_control** | **str**| Indicates that the request shouldn&#39;t utilize any caches. | [optional] [default to &#39;no-cache&#39;]
...
> ManagementGroup management_groups_update(group_id, api_version, patch_group_request, cache_control=cache_control)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    group_id = 'group_id_example' # str | Management Group ID.
    api_version = 'api_version_example' # str | Version of the API to be used with the client request. The current version is 2018-01-01-preview.
    patch_group_request = openapi_client.PatchManagementGroupRequest() # PatchManagementGroupRequest | Management group patch parameters.
    cache_control = 'no-cache' # str | Indicates that the request shouldn't utilize any caches. (optional) (default to 'no-cache')

    try:
        api_response = api_instance.management_groups_update(group_id, api_version, patch_group_request, cache_control=cache_control)
 ...
 **group_id** | **str**| Management Group ID. | 
 **api_version** | **str**| Version of the API to be used with the client request. The current version is 2018-01-01-preview. | 
 **patch_group_request** | [**PatchManagementGroupRequest**](PatchManagementGroupRequest.md)| Management group patch parameters. | 
 **cache_control** | **str**| Indicates that the request shouldn&#39;t utilize any caches. | [optional] [default to &#39;no-cache&#39;]
