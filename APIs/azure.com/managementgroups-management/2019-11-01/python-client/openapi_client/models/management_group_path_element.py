...
class ManagementGroupPathElement(BaseModel):
    """
    A path element of a management group ancestors.
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="The friendly name of the group.", alias="displayName")
