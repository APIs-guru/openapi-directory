...
class DescendantListResult(BaseModel):
    """
    ...
    value: Optional[List[DescendantInfo]] = Field(default=None, description="The list of descendants.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DescendantInfo.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
