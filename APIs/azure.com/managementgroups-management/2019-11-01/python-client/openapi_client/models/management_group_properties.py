...
class ManagementGroupProperties(BaseModel):
    ...
    """ # noqa: E501
    children: Optional[List[ManagementGroupChildInfo]] = Field(default=None, description="The list of children.")
    ...
    path: Optional[List[ManagementGroupPathElement]] = Field(default=None, description="The hierarchial path from the root group to the current group.")
    roles: Optional[List[StrictStr]] = Field(default=None, description="The role definitions associated with the management group.")
    ...
    __properties: ClassVar[List[str]] = ["children", "details", "displayName", "path", "roles", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": [ManagementGroupChildInfo.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
            "details": ManagementGroupDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
            "displayName": obj.get("displayName"),
            "path": [ManagementGroupPathElement.from_dict(_item) for _item in obj["path"]] if obj.get("path") is not None else None,
            "roles": obj.get("roles"),
