...
class EntityInfoProperties(BaseModel):
    ...
    number_of_child_groups: Optional[StrictInt] = Field(default=None, description="Number of children is the number of Groups that are exactly one level underneath the current Group.", alias="numberOfChildGroups")
