...
class TestManagementGroupDetails(unittest.TestCase):
    """ManagementGroupDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagementGroupDetails:
        """Test ManagementGroupDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagementGroupDetails`
        """
    ...
    def testManagementGroupDetails(self):
        """Test ManagementGroupDetails"""
