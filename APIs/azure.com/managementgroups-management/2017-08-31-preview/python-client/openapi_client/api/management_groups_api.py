...
class ManagementGroupsApi:
    ...
    def management_groups_get(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2017-08-31-preview.")],
        ...
        recurse: Annotated[Optional[StrictBool], Field(description="The $recurse=true query string parameter allows clients to request inclusion of entire hierarchy in the response payload.")] = None,
        ...
        :type group_id: str
        :param api_version: Version of the API to be used with the client request. The current version is 2017-08-31-preview. (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagementGroupWithHierarchy",
        }
    ...
    def management_groups_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagementGroupWithHierarchy]:
        """management_groups_get
