...
class NamedValueApi:
    ...
    @validate_call
    def named_value_create_or_update(
        self,
        ...
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
        ...
        parameters: Annotated[NamedValueCreateOrUpdateRequest, Field(description="Create parameters.")],
        ...
        :type parameters: NamedValueCreateOrUpdateRequest
        ...
        _param = self._named_value_create_or_update_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NamedValueGet200Response",
            '201': "NamedValueGet200Response",
            '202': None,
        }
    ...
    @validate_call
    def named_value_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedValueGet200Response]:
        """named_value_create_or_update
    ...
    @validate_call
    def named_value_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_create_or_update_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
        ...
        if named_value_id is not None:
            _path_params['namedValueId'] = named_value_id
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/namedValues/{namedValueId}',
    ...
    def named_value_delete(
        ...
        _param = self._named_value_delete_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            named_value_id=named_value_id,
            if_match=if_match,
    ...
    @validate_call
    def named_value_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    @validate_call
    def named_value_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_delete_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
    ...
    def named_value_get(
        ...
        _param = self._named_value_get_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            named_value_id=named_value_id,
            api_version=api_version,
    ...
    @validate_call
    def named_value_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    @validate_call
    def named_value_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_get_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
    ...
    @validate_call
    def named_value_get_entity_tag(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
        ...
        _param = self._named_value_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            named_value_id=named_value_id,
            api_version=api_version,
    ...
    @validate_call
    def named_value_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    @validate_call
    def named_value_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
    ...
    @validate_call
    def named_value_list_by_service(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="|   Field     |     Usage     |     Supported operators     |     Supported functions     |</br>|-------------|-------------|-------------|-------------|</br>| tags | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith, any, all | </br>| displayName | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>")] = None,
        ...
        _param = self._named_value_list_by_service_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_version=api_version,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NamedValueListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def named_value_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedValueListByService200Response]:
        """named_value_list_by_service
    ...
    @validate_call
    def named_value_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _named_value_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/namedValues',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def named_value_list_value(
        ...
        _param = self._named_value_list_value_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            named_value_id=named_value_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NamedValueListValue200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def named_value_list_value_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedValueListValue200Response]:
        """named_value_list_value
    ...
    @validate_call
    def named_value_list_value_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_list_value_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/namedValues/{namedValueId}/listValue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def named_value_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[NamedValueUpdateRequest, Field(description="Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: NamedValueUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._named_value_update_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            named_value_id=named_value_id,
            if_match=if_match,
    ...
    @validate_call
    def named_value_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    @validate_call
    def named_value_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        named_value_id: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the NamedValue.")],
    ...
    def _named_value_update_serialize(
        self,
        resource_group_name,
        service_name,
        named_value_id,
