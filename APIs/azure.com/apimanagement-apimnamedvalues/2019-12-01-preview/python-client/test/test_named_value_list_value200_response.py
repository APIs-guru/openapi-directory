...
class TestNamedValueListValue200Response(unittest.TestCase):
    """NamedValueListValue200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedValueListValue200Response:
        """Test NamedValueListValue200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedValueListValue200Response`
        """
        model = NamedValueListValue200Response()
        if include_optional:
            return NamedValueListValue200Response(
                value = ''
            )
        else:
            return NamedValueListValue200Response(
    ...
    def testNamedValueListValue200Response(self):
        """Test NamedValueListValue200Response"""
