...
class TestNamedValueUpdateRequest(unittest.TestCase):
    """NamedValueUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedValueUpdateRequest:
        """Test NamedValueUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedValueUpdateRequest`
        """
        model = NamedValueUpdateRequest()
        if include_optional:
            return NamedValueUpdateRequest(
                properties = openapi_client.models.named_value_update_request_properties.NamedValue_Update_request_properties(
                    display_name = '20', 
                    value = '0', )
            )
        else:
    ...
    def testNamedValueUpdateRequest(self):
        """Test NamedValueUpdateRequest"""
