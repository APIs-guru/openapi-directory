...
class TestNamedValueListByService200ResponseValueInnerProperties(unittest.TestCase):
    """NamedValueListByService200ResponseValueInnerProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedValueListByService200ResponseValueInnerProperties:
        """Test NamedValueListByService200ResponseValueInnerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedValueListByService200ResponseValueInnerProperties`
        """
        model = NamedValueListByService200ResponseValueInnerProperties()
        if include_optional:
            return NamedValueListByService200ResponseValueInnerProperties(
                display_name = '20',
                value = '0'
            )
        else:
    ...
    def testNamedValueListByService200ResponseValueInnerProperties(self):
        """Test NamedValueListByService200ResponseValueInnerProperties"""
