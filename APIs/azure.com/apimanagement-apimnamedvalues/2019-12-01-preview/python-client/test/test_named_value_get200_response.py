...
class TestNamedValueGet200Response(unittest.TestCase):
    """NamedValueGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedValueGet200Response:
        """Test NamedValueGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedValueGet200Response`
        """
        model = NamedValueGet200Response()
        if include_optional:
            return NamedValueGet200Response(
    ...
    def testNamedValueGet200Response(self):
        """Test NamedValueGet200Response"""
