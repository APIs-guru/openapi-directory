...
class TestNamedValueCreateOrUpdateRequestProperties(unittest.TestCase):
    """NamedValueCreateOrUpdateRequestProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedValueCreateOrUpdateRequestProperties:
        """Test NamedValueCreateOrUpdateRequestProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedValueCreateOrUpdateRequestProperties`
        """
        model = NamedValueCreateOrUpdateRequestProperties()
        if include_optional:
            return NamedValueCreateOrUpdateRequestProperties(
                display_name = '20',
                value = '0'
            )
        else:
    ...
    def testNamedValueCreateOrUpdateRequestProperties(self):
        """Test NamedValueCreateOrUpdateRequestProperties"""
