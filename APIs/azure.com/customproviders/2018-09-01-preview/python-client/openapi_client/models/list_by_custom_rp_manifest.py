...
class ListByCustomRPManifest(BaseModel):
    """
    ...
    value: Optional[List[CustomRPManifest]] = Field(default=None, description="The array of custom resource provider manifests.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CustomRPManifest.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
