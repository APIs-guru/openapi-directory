...
class AssociationsList(BaseModel):
    """
    ...
    value: Optional[List[Association]] = Field(default=None, description="The array of associations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Association.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
