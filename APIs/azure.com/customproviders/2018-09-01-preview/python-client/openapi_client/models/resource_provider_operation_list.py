...
class ResourceProviderOperationList(BaseModel):
    ...
    value: Optional[List[ResourceProviderOperation]] = Field(default=None, description="List of operations supported by this resource provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceProviderOperation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
