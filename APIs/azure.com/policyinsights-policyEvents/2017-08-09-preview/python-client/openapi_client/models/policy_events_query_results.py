...
class PolicyEventsQueryResults(BaseModel):
    """
    Query results.
    """ # noqa: E501
    value: Optional[List[PolicyEventsQueryResultsTable]] = Field(default=None, description="Query results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PolicyEventsQueryResultsTable.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
