...
**odata_count** | **int** | OData entity count; represents the number of policy event records returned. | [optional] 
**value** | [**List[PolicyEvent]**](PolicyEvent.md) | Query results. | [optional] 
