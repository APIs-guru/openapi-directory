...
class PolicyEventsQueryResults(BaseModel):
    ...
    odata_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="OData entity count; represents the number of policy event records returned.", alias="@odata.count")
    value: Optional[List[PolicyEvent]] = Field(default=None, description="Query results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicyEvent.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
