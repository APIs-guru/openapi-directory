...
class PolicyEvent(BaseModel):
    ...
    odata_id: Optional[StrictStr] = Field(default=None, description="OData entity ID; always set to null since policy event records do not have an entity ID.", alias="@odata.id")
    ...
    principal_oid: Optional[StrictStr] = Field(default=None, description="Principal object ID for the user who initiated the resource operation that triggered the policy event.", alias="principalOid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "principalOid": obj.get("principalOid"),
