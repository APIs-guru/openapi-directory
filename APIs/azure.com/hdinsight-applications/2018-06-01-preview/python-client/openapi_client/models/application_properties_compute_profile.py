...
class ApplicationPropertiesComputeProfile(BaseModel):
    """
    Describes the compute profile.
    """ # noqa: E501
    roles: Optional[List[ApplicationPropertiesComputeProfileRolesInner]] = Field(default=None, description="The list of roles in the cluster.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [ApplicationPropertiesComputeProfileRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
