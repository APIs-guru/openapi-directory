...
class ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfile(BaseModel):
    """
    The ssh username, password, and ssh public key.
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="The password.")
    ssh_profile: Optional[ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfileSshProfile] = Field(default=None, alias="sshProfile")
    username: Optional[StrictStr] = Field(default=None, description="The username.")
    __properties: ClassVar[List[str]] = ["password", "sshProfile", "username"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ssh_profile
        if self.ssh_profile:
            _dict['sshProfile'] = self.ssh_profile.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sshProfile": ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfileSshProfile.from_dict(obj["sshProfile"]) if obj.get("sshProfile") is not None else None,
