...
class ApplicationPropertiesComputeProfileRolesInnerAutoscale(BaseModel):
    """
    The autoscale request parameters
    """ # noqa: E501
    capacity: Optional[ApplicationPropertiesComputeProfileRolesInnerAutoscaleCapacity] = None
    recurrence: Optional[ApplicationPropertiesComputeProfileRolesInnerAutoscaleRecurrence] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": ApplicationPropertiesComputeProfileRolesInnerAutoscaleCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "recurrence": ApplicationPropertiesComputeProfileRolesInnerAutoscaleRecurrence.from_dict(obj["recurrence"]) if obj.get("recurrence") is not None else None
        })
        return _obj
