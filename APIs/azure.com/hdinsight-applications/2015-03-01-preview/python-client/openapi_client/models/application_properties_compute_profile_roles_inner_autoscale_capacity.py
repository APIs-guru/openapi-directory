...
class ApplicationPropertiesComputeProfileRolesInnerAutoscaleCapacity(BaseModel):
    """
    The load-based autoscale request parameters
    """ # noqa: E501
    max_instance_count: Optional[StrictInt] = Field(default=None, description="The maximum instance count of the cluster", alias="maxInstanceCount")
    ...
    __properties: ClassVar[List[str]] = ["maxInstanceCount", "minInstanceCount"]
