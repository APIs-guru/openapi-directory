...
class ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfileSshProfile(BaseModel):
    """
    The list of SSH public keys.
    """ # noqa: E501
    public_keys: Optional[List[ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfileSshProfilePublicKeysInner]] = Field(default=None, description="The list of SSH public keys.", alias="publicKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicKeys": [ApplicationPropertiesComputeProfileRolesInnerOsProfileLinuxOperatingSystemProfileSshProfilePublicKeysInner.from_dict(_item) for _item in obj["publicKeys"]] if obj.get("publicKeys") is not None else None
        })
        return _obj
