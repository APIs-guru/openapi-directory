...
class ServersApi:
    ...
    def servers_create_or_update(
        ...
        parameters: Annotated[Server, Field(description="The required parameters for creating or updating a server.")],
    ...
    def servers_update(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        parameters: Annotated[ServerUpdate, Field(description="The required parameters for updating a server.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
