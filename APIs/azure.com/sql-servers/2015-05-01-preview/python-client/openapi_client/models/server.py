...
class Server(BaseModel):
    ...
    """ # noqa: E501
    identity: Optional[object] = Field(default=None, description="Azure Active Directory identity configuration for a resource.")
    kind: Optional[StrictStr] = Field(default=None, description="Kind of sql server. This is metadata used for the Azure portal experience.")
