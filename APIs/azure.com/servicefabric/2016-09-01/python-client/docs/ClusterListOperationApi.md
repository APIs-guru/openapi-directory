# openapi_client.ClusterListOperationApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**clusters_list**](ClusterListOperationApi.md#clusters_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/clusters | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ClusterListOperationApi(api_client)
    ...
    try:
        ...
        print("The response of ClusterListOperationApi->clusters_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClusterListOperationApi->clusters_list: %s\n" % e)
```
