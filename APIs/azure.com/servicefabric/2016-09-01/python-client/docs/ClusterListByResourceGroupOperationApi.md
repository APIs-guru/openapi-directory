# openapi_client.ClusterListByResourceGroupOperationApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**clusters_list_by_resource_group**](ClusterListByResourceGroupOperationApi.md#clusters_list_by_resource_group) | **GET** /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/clusters | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ClusterListByResourceGroupOperationApi(api_client)
    ...
    try:
        ...
        print("The response of ClusterListByResourceGroupOperationApi->clusters_list_by_resource_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClusterListByResourceGroupOperationApi->clusters_list_by_resource_group: %s\n" % e)
```
