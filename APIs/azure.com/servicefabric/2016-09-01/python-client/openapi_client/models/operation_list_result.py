...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[OperationResult]] = Field(default=None, description="List of ServiceFabric operations supported by the Microsoft.ServiceFabric resource provider.")
