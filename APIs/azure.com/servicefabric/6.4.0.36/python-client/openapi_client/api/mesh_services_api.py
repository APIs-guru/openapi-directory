...
class MeshServicesApi:
    ...
    def mesh_service_get(
        ...
        _param = self._mesh_service_get_serialize(
    ...
    @validate_call
    def mesh_service_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
    ...
    @validate_call
    def mesh_service_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
    ...
    def _mesh_service_get_serialize(
        self,
        api_version,
    ...
    def mesh_service_list(
        ...
        _param = self._mesh_service_list_serialize(
            api_version=api_version,
            application_resource_name=application_resource_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def mesh_service_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        _request_timeout: Union[
    ...
    @validate_call
    def mesh_service_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        _request_timeout: Union[
    ...
    def _mesh_service_list_serialize(
        self,
        api_version,
        application_resource_name,
        _request_auth,
