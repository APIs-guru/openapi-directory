...
class ServiceApi:
    ...
    def resolve_service(
        ...
        partition_key_value: Annotated[Optional[StrictStr], Field(description="Partition key. This is required if the partition scheme for the service is Int64Range or Named.  This is not the partition ID, but rather, either the integer key value, or the name of the partition ID. For example, if your service is using ranged partitions from 0 to 10, then they PartitionKeyValue would be an integer in that range. Query service description to see the range or name.")] = None,
