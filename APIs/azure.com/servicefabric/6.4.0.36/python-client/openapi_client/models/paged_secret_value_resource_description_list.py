...
class PagedSecretValueResourceDescriptionList(BaseModel):
    """
    ...
    items: Optional[List[SecretValueResourceDescription]] = Field(default=None, description="One page of the list.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [SecretValueResourceDescription.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
