...
class PagedServiceReplicaDescriptionList(BaseModel):
    """
    ...
    items: Optional[List[ServiceReplicaDescription]] = Field(default=None, description="List of service resource replica description.", alias="Items")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagedServiceReplicaDescriptionList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagedServiceReplicaDescriptionList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ServiceReplicaDescription.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
