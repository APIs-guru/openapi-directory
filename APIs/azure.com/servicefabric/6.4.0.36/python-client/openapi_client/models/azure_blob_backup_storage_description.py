...
class AzureBlobBackupStorageDescription(BackupStorageDescription):
    ...
    """ # noqa: E501
    connection_string: StrictStr = Field(description="The connection string to connect to the Azure blob store.", alias="ConnectionString")
    container_name: StrictStr = Field(description="The name of the container in the blob store to store and enumerate backups from.", alias="ContainerName")
