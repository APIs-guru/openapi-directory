...
class ImageRegistryCredential(BaseModel):
    ...
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="The password for the private registry. The password is required for create or update operations, however it is not returned in the get or list operations.")
    ...
    __properties: ClassVar[List[str]] = ["password", "server", "username"]
