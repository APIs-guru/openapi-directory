...
class ExecutingFaultsChaosEvent(ChaosEvent):
    ...
    """ # noqa: E501
    faults: Optional[List[StrictStr]] = Field(default=None, description="List of string description of the faults that Chaos decided to execute in an iteration.", alias="Faults")
