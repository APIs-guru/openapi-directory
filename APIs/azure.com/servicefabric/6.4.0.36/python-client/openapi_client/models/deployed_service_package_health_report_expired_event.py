...
class DeployedServicePackageHealthReportExpiredEvent(ApplicationEvent):
    ...
    service_manifest: StrictStr = Field(description="Service manifest name.", alias="ServiceManifest")
    ...
    service_package_instance_id: StrictInt = Field(description="Id of Service package instance.", alias="ServicePackageInstanceId")
