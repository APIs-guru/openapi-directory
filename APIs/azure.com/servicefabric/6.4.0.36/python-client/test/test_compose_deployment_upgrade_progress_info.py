...
class TestComposeDeploymentUpgradeProgressInfo(unittest.TestCase):
    """ComposeDeploymentUpgradeProgressInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComposeDeploymentUpgradeProgressInfo:
        """Test ComposeDeploymentUpgradeProgressInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComposeDeploymentUpgradeProgressInfo`
        """
        model = ComposeDeploymentUpgradeProgressInfo()
        if include_optional:
            return ComposeDeploymentUpgradeProgressInfo(
                ...
                current_upgrade_domain_duration = 'PT0H2M0S',
    ...
    def testComposeDeploymentUpgradeProgressInfo(self):
        """Test ComposeDeploymentUpgradeProgressInfo"""
