...
class ServiceResourceProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["codePackages", "diagnostics", "networkRefs", "osType", "autoScalingPolicies", "description", "healthState", "identityRefs", "replicaCount", "status", "statusDetails", "unhealthyEvaluation"]
