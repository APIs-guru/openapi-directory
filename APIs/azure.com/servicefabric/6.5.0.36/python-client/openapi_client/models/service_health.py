...
class ServiceHealth(BaseModel):
    ...
    partition_health_states: Optional[List[PartitionHealthState]] = Field(default=None, description="The list of partition health states associated with the service.", alias="PartitionHealthStates")
