...
class ChaosStartedEvent(ClusterEvent):
    ...
    wait_time_between_faults_in_seconds: Union[StrictFloat, StrictInt] = Field(description="Wait time between faults in seconds.", alias="WaitTimeBetweenFaultsInSeconds")
