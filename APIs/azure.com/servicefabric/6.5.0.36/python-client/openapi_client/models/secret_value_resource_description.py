...
class SecretValueResourceDescription(BaseModel):
    """
    This type describes a value of a secret resource. The name of this resource is the version identifier corresponding to this secret value.
    """ # noqa: E501
    name: StrictStr = Field(description="Version identifier of the secret value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": SecretValueResourceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
