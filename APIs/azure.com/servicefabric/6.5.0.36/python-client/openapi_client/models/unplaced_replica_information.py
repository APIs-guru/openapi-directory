...
class UnplacedReplicaInformation(BaseModel):
    """
    ...
    unplaced_replica_details: Optional[List[StrictStr]] = Field(default=None, description="List of reasons due to which a replica cannot be placed.", alias="UnplacedReplicaDetails")
    __properties: ClassVar[List[str]] = ["PartitionId", "ServiceName", "UnplacedReplicaDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UnplacedReplicaDetails": obj.get("UnplacedReplicaDetails")
        })
        return _obj
