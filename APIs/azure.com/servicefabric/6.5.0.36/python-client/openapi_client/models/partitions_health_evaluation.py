...
class PartitionsHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    max_percent_unhealthy_partitions_per_service: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of unhealthy partitions per service from the ServiceTypeHealthPolicy.", alias="MaxPercentUnhealthyPartitionsPerService")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of partitions of the service from the health store.", alias="TotalCount")
