...
class AutoScalingMechanism(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AddRemoveReplicaScalingMechanism]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AddRemoveReplicaScalingMechanism]]:
        """Create an instance of AutoScalingMechanism from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'AddRemoveReplicaScalingMechanism':
            return import_module("openapi_client.models.add_remove_replica_scaling_mechanism").AddRemoveReplicaScalingMechanism.from_dict(obj)

        raise ValueError("AutoScalingMechanism failed to lookup discriminator value from " +
