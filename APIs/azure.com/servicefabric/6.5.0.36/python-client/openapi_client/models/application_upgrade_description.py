...
class ApplicationUpgradeDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ApplicationHealthPolicy", "ForceRestart", "MonitoringPolicy", "Name", "Parameters", "RollingUpgradeMode", "SortOrder", "TargetApplicationTypeVersion", "UpgradeKind", "UpgradeReplicaSetCheckTimeoutInSeconds"]
