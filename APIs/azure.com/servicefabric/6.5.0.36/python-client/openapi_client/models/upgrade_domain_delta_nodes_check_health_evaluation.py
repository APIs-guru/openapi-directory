...
class UpgradeDomainDeltaNodesCheckHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    baseline_error_count: Optional[StrictInt] = Field(default=None, description="Number of upgrade domain nodes with aggregated heath state Error in the health store at the beginning of the cluster upgrade.", alias="BaselineErrorCount")
    baseline_total_count: Optional[StrictInt] = Field(default=None, description="Total number of upgrade domain nodes in the health store at the beginning of the cluster upgrade.", alias="BaselineTotalCount")
    max_percent_delta_unhealthy_nodes: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of upgrade domain delta unhealthy nodes from the ClusterUpgradeHealthPolicy.", alias="MaxPercentDeltaUnhealthyNodes")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of upgrade domain nodes in the health store.", alias="TotalCount")
