...
class PagedBackupPolicyDescriptionList(BaseModel):
    """
    ...
    items: Optional[List[BackupPolicyDescription]] = Field(default=None, description="The list of backup policies information.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [BackupPolicyDescription.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
