...
class WaitingChaosEvent(ChaosEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Describes why the WaitingChaosEvent was generated, for example, due to a cluster upgrade.", alias="Reason")
