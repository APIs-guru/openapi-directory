...
class ApplicationTypeApi:
    ...
    def provision_application_type(
        ...
        provision_application_type_description_base_required_body_param: Annotated[ProvisionApplicationTypeDescriptionBase, Field(description="The base type of provision application type description which supports either image store-based provision or external store-based provision.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param api_version: The version of the API. This parameter is required and its value must be '6.2'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
        :type api_version: str
        :param provision_application_type_description_base_required_body_param: The base type of provision application type description which supports either image store-based provision or external store-based provision. (required)
        :type provision_application_type_description_base_required_body_param: ProvisionApplicationTypeDescriptionBase
        :param timeout: The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
        :type timeout: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._provision_application_type_serialize(
            api_version=api_version,
            provision_application_type_description_base_required_body_param=provision_application_type_description_base_required_body_param,
            timeout=timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _provision_application_type_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if provision_application_type_description_base_required_body_param is not None:
            _body_params = provision_application_type_description_base_required_body_param
    ...
    def unprovision_application_type(
        ...
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        application_type_name: Annotated[StrictStr, Field(description="The name of the application type.")],
        unprovision_application_type_description_info: Annotated[UnprovisionApplicationTypeDescriptionInfo, Field(description="The relative path for the application package in the image store specified during the prior copy operation.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param application_type_name: The name of the application type. (required)
        :type application_type_name: str
        :param unprovision_application_type_description_info: The relative path for the application package in the image store specified during the prior copy operation. (required)
        :type unprovision_application_type_description_info: UnprovisionApplicationTypeDescriptionInfo
        :param timeout: The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
        :type timeout: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._unprovision_application_type_serialize(
            api_version=api_version,
            application_type_name=application_type_name,
            unprovision_application_type_description_info=unprovision_application_type_description_info,
            timeout=timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _unprovision_application_type_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if unprovision_application_type_description_info is not None:
            _body_params = unprovision_application_type_description_info
