...
class ReplicaApi:
    ...
    def report_replica_health(
        ...
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        replica_id: Annotated[StrictStr, Field(description="The identifier of the replica.")],
        service_kind: Annotated[StrictStr, Field(description="The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values.")],
        ...
        :param replica_id: The identifier of the replica. (required)
        :type replica_id: str
        :param service_kind: The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. (required)
