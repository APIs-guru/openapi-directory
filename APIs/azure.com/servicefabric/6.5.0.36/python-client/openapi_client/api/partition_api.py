...
class PartitionApi:
    ...
    def move_primary_replica(
        ...
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        node_name: Annotated[Optional[StrictStr], Field(description="The name of the node.")] = None,
        ignore_constraints: Annotated[Optional[StrictBool], Field(description="Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored.")] = None,
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._move_primary_replica_serialize(
            api_version=api_version,
            partition_id=partition_id,
            node_name=node_name,
    ...
    @validate_call
    def move_primary_replica_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        node_name: Annotated[Optional[StrictStr], Field(description="The name of the node.")] = None,
    ...
    @validate_call
    def move_primary_replica_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        node_name: Annotated[Optional[StrictStr], Field(description="The name of the node.")] = None,
    ...
    def _move_primary_replica_serialize(
        self,
        api_version,
        partition_id,
        node_name,
        ...
        if ignore_constraints is not None:
            ...
            _query_params.append(('IgnoreConstraints', ignore_constraints))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Partitions/{partitionId}/$/MovePrimaryReplica',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def move_secondary_replica(
        ...
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        current_node_name: Annotated[StrictStr, Field(description="The name of the source node for secondary replica move.")],
        new_node_name: Annotated[Optional[StrictStr], Field(description="The name of the target node for secondary replica move. If not specified, replica is moved to a random node.")] = None,
        ignore_constraints: Annotated[Optional[StrictBool], Field(description="Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored.")] = None,
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param partition_id: The identity of the partition. (required)
        :type partition_id: str
        :param current_node_name: The name of the source node for secondary replica move. (required)
        ...
        _param = self._move_secondary_replica_serialize(
            api_version=api_version,
            partition_id=partition_id,
    ...
    @validate_call
    def move_secondary_replica_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        current_node_name: Annotated[StrictStr, Field(description="The name of the source node for secondary replica move.")],
    ...
    @validate_call
    def move_secondary_replica_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        current_node_name: Annotated[StrictStr, Field(description="The name of the source node for secondary replica move.")],
    ...
    def _move_secondary_replica_serialize(
        self,
        api_version,
        partition_id,
        current_node_name,
        ...
        if current_node_name is not None:
            ...
            _query_params.append(('CurrentNodeName', current_node_name))
            
        if new_node_name is not None:
            
            _query_params.append(('NewNodeName', new_node_name))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Partitions/{partitionId}/$/MoveSecondaryReplica',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
