...
------------ | ------------- | ------------- | -------------
**current_value** | **float** | The double value of the load for the metric. | [optional] 
**last_reported_utc** | **datetime** | The UTC time when the load is reported. | [optional] 
**name** | **str** | The name of the metric. | [optional] 
**value** | **int** | The value of the load for the metric. In future releases of Service Fabric this parameter will be deprecated in favor of CurrentValue. | [optional] 
