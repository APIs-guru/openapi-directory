...
[**get_unplaced_replica_information**](ServiceApi.md#get_unplaced_replica_information) | **GET** /Services/{serviceId}/$/GetUnplacedReplicaInformation | Gets the information about unplaced replica of the service.
...
> UnplacedReplicaInformation get_unplaced_replica_information(api_version, service_id, partition_id=partition_id, only_query_primaries=only_query_primaries, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    only_query_primaries = False # bool | Indicates that unplaced replica information will be queries only for primary replicas. (optional) (default to False)
    timeout = 60 # int | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional) (default to 60)

    try:
        # Gets the information about unplaced replica of the service.
        api_response = api_instance.get_unplaced_replica_information(api_version, service_id, partition_id=partition_id, only_query_primaries=only_query_primaries, timeout=timeout)
        print("The response of ServiceApi->get_unplaced_replica_information:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceApi->get_unplaced_replica_information: %s\n" % e)
```
 ...
 **only_query_primaries** | **bool**| Indicates that unplaced replica information will be queries only for primary replicas. | [optional] [default to False]
 **timeout** | **int**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
