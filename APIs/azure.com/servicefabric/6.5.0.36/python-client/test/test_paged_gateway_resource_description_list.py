...
class TestPagedGatewayResourceDescriptionList(unittest.TestCase):
    """PagedGatewayResourceDescriptionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedGatewayResourceDescriptionList:
        """Test PagedGatewayResourceDescriptionList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedGatewayResourceDescriptionList`
        """
        model = PagedGatewayResourceDescriptionList()
        if include_optional:
            return PagedGatewayResourceDescriptionList(
                ...
                items = [
                    openapi_client.models.gateway_resource_description.GatewayResourceDescription(
                        name = '', 
                        properties = openapi_client.models.gateway_properties.GatewayProperties(
                            description = '', 
    ...
    def testPagedGatewayResourceDescriptionList(self):
        """Test PagedGatewayResourceDescriptionList"""
