...
class TestNodeDeactivationTask(unittest.TestCase):
    """NodeDeactivationTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeDeactivationTask:
        """Test NodeDeactivationTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeDeactivationTask`
        """
        model = NodeDeactivationTask()
        if include_optional:
    ...
    def testNodeDeactivationTask(self):
        """Test NodeDeactivationTask"""
