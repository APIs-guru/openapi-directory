...
class TestEntityHealth(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EntityHealth:
        """Test EntityHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityHealth`
        """
        model = EntityHealth()
        if include_optional:
            return EntityHealth(
