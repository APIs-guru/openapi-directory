...
class TestStartClusterUpgradeDescription(unittest.TestCase):
    """StartClusterUpgradeDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartClusterUpgradeDescription:
        """Test StartClusterUpgradeDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartClusterUpgradeDescription`
        """
        model = StartClusterUpgradeDescription()
        if include_optional:
            return StartClusterUpgradeDescription(
    ...
    def testStartClusterUpgradeDescription(self):
        """Test StartClusterUpgradeDescription"""
