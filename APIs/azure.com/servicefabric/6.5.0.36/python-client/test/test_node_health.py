...
class TestNodeHealth(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeHealth:
        """Test NodeHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeHealth`
        """
        model = NodeHealth()
        if include_optional:
            return NodeHealth(
