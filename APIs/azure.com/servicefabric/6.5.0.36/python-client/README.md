...
*ClusterApi* | [**get_cluster_load**](docs/ClusterApi.md#get_cluster_load) | **GET** /$/GetLoadInformation | Gets the load of a Service Fabric cluster.
...
*ClusterApi* | [**toggle_verbose_service_placement_health_reporting**](docs/ClusterApi.md#toggle_verbose_service_placement_health_reporting) | **POST** /$/ToggleVerboseServicePlacementHealthReporting | Changes the verbosity of service placement health reporting.
...
*ImageStoreApi* | [**get_image_store_folder_size**](docs/ImageStoreApi.md#get_image_store_folder_size) | **GET** /ImageStore/{contentPath}/$/FolderSize | Get the size of a folder in image store
...
*ImageStoreApi* | [**get_image_store_root_folder_size**](docs/ImageStoreApi.md#get_image_store_root_folder_size) | **GET** /ImageStore/$/FolderSize | Get the folder size at the root of the image store.
...
*PartitionApi* | [**move_primary_replica**](docs/PartitionApi.md#move_primary_replica) | **POST** /Partitions/{partitionId}/$/MovePrimaryReplica | Moves the primary replica of a partition of a stateful service.
*PartitionApi* | [**move_secondary_replica**](docs/PartitionApi.md#move_secondary_replica) | **POST** /Partitions/{partitionId}/$/MoveSecondaryReplica | Moves the secondary replica of a partition of a stateful service.
...
*ServiceApi* | [**get_unplaced_replica_information**](docs/ServiceApi.md#get_unplaced_replica_information) | **GET** /Services/{serviceId}/$/GetUnplacedReplicaInformation | Gets the information about unplaced replica of the service.
...
## Documentation For Models
 ...
 - [ClusterLoadInfo](docs/ClusterLoadInfo.md)
 ...
 - [EnsurePartitionQuorumSafetyCheck](docs/EnsurePartitionQuorumSafetyCheck.md)
 ...
 - [FolderSizeInfo](docs/FolderSizeInfo.md)
 ...
 - [IdentityItemDescription](docs/IdentityItemDescription.md)
 ...
 - [ManagedApplicationIdentity](docs/ManagedApplicationIdentity.md)
 - [ManagedApplicationIdentityDescription](docs/ManagedApplicationIdentityDescription.md)
 ...
 - [UnplacedReplicaInformation](docs/UnplacedReplicaInformation.md)
 ...
 - [UpgradeSortOrder](docs/UpgradeSortOrder.md)
