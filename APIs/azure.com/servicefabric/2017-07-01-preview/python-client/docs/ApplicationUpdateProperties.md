...
json = "{}"
# create an instance of ApplicationUpdateProperties from a JSON string
application_update_properties_instance = ApplicationUpdateProperties.from_json(json)
# print the JSON string representation of the object
print(ApplicationUpdateProperties.to_json())

# convert the object into a dict
application_update_properties_dict = application_update_properties_instance.to_dict()
# create an instance of ApplicationUpdateProperties from a dict
application_update_properties_from_dict = ApplicationUpdateProperties.from_dict(application_update_properties_dict)
```
