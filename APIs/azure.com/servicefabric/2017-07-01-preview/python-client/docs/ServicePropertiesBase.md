...
json = "{}"
# create an instance of ServicePropertiesBase from a JSON string
service_properties_base_instance = ServicePropertiesBase.from_json(json)
# print the JSON string representation of the object
print(ServicePropertiesBase.to_json())

# convert the object into a dict
service_properties_base_dict = service_properties_base_instance.to_dict()
# create an instance of ServicePropertiesBase from a dict
service_properties_base_from_dict = ServicePropertiesBase.from_dict(service_properties_base_dict)
```
