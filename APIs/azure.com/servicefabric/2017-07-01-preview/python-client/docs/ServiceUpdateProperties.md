...
service_update_properties_instance = ServiceUpdateProperties.from_json(json)
# print the JSON string representation of the object
print(ServiceUpdateProperties.to_json())

# convert the object into a dict
service_update_properties_dict = service_update_properties_instance.to_dict()
# create an instance of ServiceUpdateProperties from a dict
service_update_properties_from_dict = ServiceUpdateProperties.from_dict(service_update_properties_dict)
```
