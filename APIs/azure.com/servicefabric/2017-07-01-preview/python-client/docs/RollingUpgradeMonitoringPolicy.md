...
json = "{}"
# create an instance of RollingUpgradeMonitoringPolicy from a JSON string
rolling_upgrade_monitoring_policy_instance = RollingUpgradeMonitoringPolicy.from_json(json)
# print the JSON string representation of the object
print(RollingUpgradeMonitoringPolicy.to_json())

# convert the object into a dict
rolling_upgrade_monitoring_policy_dict = rolling_upgrade_monitoring_policy_instance.to_dict()
# create an instance of RollingUpgradeMonitoringPolicy from a dict
rolling_upgrade_monitoring_policy_from_dict = RollingUpgradeMonitoringPolicy.from_dict(rolling_upgrade_monitoring_policy_dict)
```
