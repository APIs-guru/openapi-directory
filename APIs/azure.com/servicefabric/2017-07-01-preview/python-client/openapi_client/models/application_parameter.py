...
class ApplicationParameter(BaseModel):
    """
    Describes an application parameter override to be applied when creating or upgrading an application.
    """ # noqa: E501
    key: StrictStr = Field(description="The name of the parameter.", alias="Key")
    value: StrictStr = Field(description="The value of the parameter.", alias="Value")
