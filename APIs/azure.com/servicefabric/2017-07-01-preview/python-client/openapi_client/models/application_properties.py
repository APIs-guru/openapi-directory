...
class ApplicationProperties(BaseModel):
    ...
    parameters: Optional[List[ApplicationParameter]] = Field(default=None, description="List of application parameters with overridden values from their default values specified in the application manifest.")
    remove_application_capacity: Optional[StrictBool] = Field(default=None, description="The version of the application type", alias="removeApplicationCapacity")
