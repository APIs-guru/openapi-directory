...
class ServiceUpdateProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["correlationScheme", "defaultMoveCost", "placementConstraints", "serviceLoadMetrics", "servicePlacementPolicies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceUpdateProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceUpdateProperties from a dict"""
        if obj is None:
            return None
