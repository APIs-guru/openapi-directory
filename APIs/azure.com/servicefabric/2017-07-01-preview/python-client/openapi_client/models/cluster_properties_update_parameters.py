...
class ClusterPropertiesUpdateParameters(BaseModel):
    ...
    reliability_level: Optional[StrictStr] = Field(default=None, description="The reliability level sets the replica set size of system services. Learn about [ReliabilityLevel](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-capacity).", alias="reliabilityLevel")
    ...
    upgrade_mode: Optional[StrictStr] = Field(default=None, description="The upgrade mode of the cluster. This indicates if the cluster should be automatically upgraded when new Service Fabric runtime version is available.", alias="upgradeMode")
    __properties: ClassVar[List[str]] = ["addOnFeatures", "certificate", "clientCertificateCommonNames", "clientCertificateThumbprints", "clusterCodeVersion", "fabricSettings", "nodeTypes", "reliabilityLevel", "reverseProxyCertificate", "upgradeDescription", "upgradeMode"]
