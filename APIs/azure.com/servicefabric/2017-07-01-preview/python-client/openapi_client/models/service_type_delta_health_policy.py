...
class ServiceTypeDeltaHealthPolicy(BaseModel):
    ...
    """ # noqa: E501
    max_percent_delta_unhealthy_services: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Maximum percentage of unhealthy services in cluster", alias="maxPercentDeltaUnhealthyServices")
