...
class ApplicationUpgradePolicy(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollingUpgradeMonitoringPolicy": RollingUpgradeMonitoringPolicy.from_dict(obj["rollingUpgradeMonitoringPolicy"]) if obj.get("rollingUpgradeMonitoringPolicy") is not None else None,
