...
class VersionResourceList(BaseModel):
    """
    The list of version resources for the specified application type name.
    """ # noqa: E501
    value: Optional[List[VersionResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VersionResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
