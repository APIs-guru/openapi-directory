...
class RollingUpgradeMonitoringPolicy(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["healthCheckRetryTimeout", "healthCheckStableDuration", "healthCheckWaitDuration", "upgradeDomainTimeout", "upgradeTimeout"]
