...
partition_health_report_expired_event_instance = PartitionHealthReportExpiredEvent.from_json(json)
# print the JSON string representation of the object
print(PartitionHealthReportExpiredEvent.to_json())

# convert the object into a dict
partition_health_report_expired_event_dict = partition_health_report_expired_event_instance.to_dict()
# create an instance of PartitionHealthReportExpiredEvent from a dict
partition_health_report_expired_event_from_dict = PartitionHealthReportExpiredEvent.from_dict(partition_health_report_expired_event_dict)
```
