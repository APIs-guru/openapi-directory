...
[**move_primary_replica**](PartitionApi.md#move_primary_replica) | **POST** /Partitions/{partitionId}/$/MovePrimaryReplica | Moves the primary replica of a partition of a stateful service.
[**move_secondary_replica**](PartitionApi.md#move_secondary_replica) | **POST** /Partitions/{partitionId}/$/MoveSecondaryReplica | Moves the secondary replica of a partition of a stateful service.
...
> move_primary_replica(api_version, partition_id, node_name=node_name, ignore_constraints=ignore_constraints, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.PartitionApi(api_client)
    api_version = 6.5 # str | The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (default to 6.5)
    partition_id = 'partition_id_example' # str | The identity of the partition.
    node_name = 'node_name_example' # str | The name of the node. (optional)
    ignore_constraints = False # bool | Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. (optional) (default to False)
    timeout = 60 # int | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional) (default to 60)

    try:
        # Moves the primary replica of a partition of a stateful service.
        api_instance.move_primary_replica(api_version, partition_id, node_name=node_name, ignore_constraints=ignore_constraints, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->move_primary_replica: %s\n" % e)
```
 ...
 **ignore_constraints** | **bool**| Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. | [optional] [default to False]
 **timeout** | **int**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
...
> move_secondary_replica(api_version, partition_id, current_node_name, new_node_name=new_node_name, ignore_constraints=ignore_constraints, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 6.5 # str | The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (default to 6.5)
    partition_id = 'partition_id_example' # str | The identity of the partition.
    current_node_name = 'current_node_name_example' # str | The name of the source node for secondary replica move.
    new_node_name = 'new_node_name_example' # str | The name of the target node for secondary replica move. If not specified, replica is moved to a random node. (optional)
    ignore_constraints = False # bool | Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. (optional) (default to False)
    timeout = 60 # int | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional) (default to 60)

    try:
        # Moves the secondary replica of a partition of a stateful service.
        api_instance.move_secondary_replica(api_version, partition_id, current_node_name, new_node_name=new_node_name, ignore_constraints=ignore_constraints, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->move_secondary_replica: %s\n" % e)
```
 ...
 **new_node_name** | **str**| The name of the target node for secondary replica move. If not specified, replica is moved to a random node. | [optional] 
 **ignore_constraints** | **bool**| Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. | [optional] [default to False]
 **timeout** | **int**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
