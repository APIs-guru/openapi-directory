...
**type** | [**EnvironmentVariableType**](EnvironmentVariableType.md) |  | [optional] [default to EnvironmentVariableType.CLEARTEXT]
**value** | **str** | The value of the environment variable, will be processed based on the type provided. | [optional] 
