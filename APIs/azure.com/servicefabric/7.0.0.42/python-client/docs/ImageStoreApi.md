...
> FolderSizeInfo get_image_store_folder_size(api_version, content_path, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the size of a folder in image store
        api_response = api_instance.get_image_store_folder_size(api_version, content_path, timeout=timeout)
        print("The response of ImageStoreApi->get_image_store_folder_size:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageStoreApi->get_image_store_folder_size: %s\n" % e)
```
...
> ImageStoreInfo get_image_store_info(api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the overall ImageStore information
        api_response = api_instance.get_image_store_info(api_version, timeout=timeout)
        print("The response of ImageStoreApi->get_image_store_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageStoreApi->get_image_store_info: %s\n" % e)
```
...
> FolderSizeInfo get_image_store_root_folder_size(api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the folder size at the root of the image store.
        api_response = api_instance.get_image_store_root_folder_size(api_version, timeout=timeout)
        print("The response of ImageStoreApi->get_image_store_root_folder_size:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageStoreApi->get_image_store_root_folder_size: %s\n" % e)
```
