...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    force = False # bool | Indicates whether to gracefully roll back and clean up internal system state modified by executing the user-induced operation. (default to False)
