...
> add_configuration_parameter_overrides(api_version, node_name, config_parameter_override_list, force=force, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    config_parameter_override_list = [openapi_client.ConfigParameterOverride()] # List[ConfigParameterOverride] | Description for adding list of configuration overrides.
    force = True # bool | Force adding configuration overrides on specified nodes. (optional)
    ...
    try:
        # Adds the list of configuration overrides on the specified node.
        api_instance.add_configuration_parameter_overrides(api_version, node_name, config_parameter_override_list, force=force, timeout=timeout)
    except Exception as e:
        print("Exception when calling NodeApi->add_configuration_parameter_overrides: %s\n" % e)
```
 ...
 **config_parameter_override_list** | [**List[ConfigParameterOverride]**](ConfigParameterOverride.md)| Description for adding list of configuration overrides. | 
 **force** | **bool**| Force adding configuration overrides on specified nodes. | [optional] 
...
> List[ConfigParameterOverride] get_configuration_overrides(api_version, node_name, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the list of configuration overrides on the specified node.
        api_response = api_instance.get_configuration_overrides(api_version, node_name, timeout=timeout)
        print("The response of NodeApi->get_configuration_overrides:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NodeApi->get_configuration_overrides: %s\n" % e)
```
...
[**List[ConfigParameterOverride]**](ConfigParameterOverride.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of configuration overrides on the node. |  -  |
**0** | The detailed error response. |  -  |
...
> remove_configuration_overrides(api_version, node_name, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Removes configuration overrides on the specified node.
        api_instance.remove_configuration_overrides(api_version, node_name, timeout=timeout)
    except Exception as e:
        print("Exception when calling NodeApi->remove_configuration_overrides: %s\n" % e)
```
