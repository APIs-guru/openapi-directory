...
class MeshServiceReplicasApi:
    ...
    def mesh_service_replica_get(
        ...
        _param = self._mesh_service_replica_get_serialize(
    ...
    @validate_call
    def mesh_service_replica_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
    ...
    @validate_call
    def mesh_service_replica_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
    ...
    def _mesh_service_replica_get_serialize(
        self,
        api_version,
    ...
    def mesh_service_replica_list(
        ...
        _param = self._mesh_service_replica_list_serialize(
            api_version=api_version,
            application_resource_name=application_resource_name,
            service_resource_name=service_resource_name,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PagedServiceReplicaDescriptionList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def mesh_service_replica_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagedServiceReplicaDescriptionList]:
        """Lists all the replicas of a service.
    ...
    @validate_call
    def mesh_service_replica_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '6.4-preview'.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        service_resource_name: Annotated[StrictStr, Field(description="The identity of the service.")],
    ...
    def _mesh_service_replica_list_serialize(
        self,
        api_version,
        application_resource_name,
        service_resource_name,
