...
class NodeApi:
    ...
    def add_configuration_parameter_overrides(
        ...
        config_parameter_override_list: Annotated[List[ConfigParameterOverride], Field(description="Description for adding list of configuration overrides.")],
        force: Annotated[Optional[StrictBool], Field(description="Force adding configuration overrides on specified nodes.")] = None,
        ...
        :type node_name: str
        :param config_parameter_override_list: Description for adding list of configuration overrides. (required)
        :type config_parameter_override_list: List[ConfigParameterOverride]
        ...
        _param = self._add_configuration_parameter_overrides_serialize(
            api_version=api_version,
            node_name=node_name,
            config_parameter_override_list=config_parameter_override_list,
            force=force,
            timeout=timeout,
    ...
    @validate_call
    def add_configuration_parameter_overrides_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        config_parameter_override_list: Annotated[List[ConfigParameterOverride], Field(description="Description for adding list of configuration overrides.")],
    ...
    @validate_call
    def add_configuration_parameter_overrides_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        config_parameter_override_list: Annotated[List[ConfigParameterOverride], Field(description="Description for adding list of configuration overrides.")],
    ...
    def _add_configuration_parameter_overrides_serialize(
        self,
        api_version,
        node_name,
        ...
        if config_parameter_override_list is not None:
            _body_params = config_parameter_override_list
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Nodes/{nodeName}/$/AddConfigurationParameterOverrides',
    ...
    def get_configuration_overrides(
        ...
        _param = self._get_configuration_overrides_serialize(
            api_version=api_version,
            node_name=node_name,
            timeout=timeout,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ConfigParameterOverride]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_configuration_overrides_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ConfigParameterOverride]]:
        """Gets the list of configuration overrides on the specified node.
    ...
    @validate_call
    def get_configuration_overrides_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
    ...
    def _get_configuration_overrides_serialize(
        self,
        api_version,
        node_name,
        timeout,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Nodes/{nodeName}/$/GetConfigurationOverrides',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_configuration_overrides(
        ...
        _param = self._remove_configuration_overrides_serialize(
            api_version=api_version,
            node_name=node_name,
            timeout=timeout,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_configuration_overrides_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
    ...
    @validate_call
    def remove_configuration_overrides_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        node_name: Annotated[StrictStr, Field(description="The name of the node.")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
    ...
    def _remove_configuration_overrides_serialize(
        self,
        api_version,
        node_name,
        timeout,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/Nodes/{nodeName}/$/RemoveConfigurationOverrides',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
