...
class MeshApplicationsApi:
    ...
    @validate_call
    def mesh_application_get_upgrade_progress(
        self,
        ...
        _param = self._mesh_application_get_upgrade_progress_serialize(
            api_version=api_version,
            application_resource_name=application_resource_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationResourceUpgradeProgressInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def mesh_application_get_upgrade_progress_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationResourceUpgradeProgressInfo]:
        """Gets the progress of the latest upgrade performed on this application resource.
    ...
    @validate_call
    def mesh_application_get_upgrade_progress_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be '7.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.")],
        application_resource_name: Annotated[StrictStr, Field(description="The identity of the application.")],
        _request_timeout: Union[
    ...
    def _mesh_application_get_upgrade_progress_serialize(
        self,
        api_version,
        application_resource_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Resources/Applications/{applicationResourceName}/$/GetUpgradeProgress',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
