...
class StatefulServiceUpdateDescription(ServiceUpdateDescription):
    ...
    service_placement_time_limit_seconds: Optional[StrictStr] = Field(default=None, description="The duration for which replicas can stay InBuild before reporting that build is stuck.", alias="ServicePlacementTimeLimitSeconds")
