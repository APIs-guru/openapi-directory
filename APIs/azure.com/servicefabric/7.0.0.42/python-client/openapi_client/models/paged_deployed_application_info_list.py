...
class PagedDeployedApplicationInfoList(BaseModel):
    """
    ...
    items: Optional[List[DeployedApplicationInfo]] = Field(default=None, description="List of deployed application information.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [DeployedApplicationInfo.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
