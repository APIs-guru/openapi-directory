...
class ServiceUpdateDescription(BaseModel):
    ...
    scaling_policies: Optional[List[ScalingPolicyDescription]] = Field(default=None, description="A list that describes the scaling policies.", alias="ScalingPolicies")
