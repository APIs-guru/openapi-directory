...
class NodeDeactivateStartedEvent(NodeEvent):
    ...
    """ # noqa: E501
    batch_id: StrictStr = Field(description="Batch Id.", alias="BatchId")
    deactivate_intent: StrictStr = Field(description="Describes deactivate intent.", alias="DeactivateIntent")
