...
class ServiceResourceDescription(BaseModel):
    """
    This type describes a service resource.
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Service resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": ServiceResourceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
