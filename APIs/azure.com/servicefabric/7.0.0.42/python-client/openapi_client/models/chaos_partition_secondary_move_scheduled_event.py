...
class ChaosPartitionSecondaryMoveScheduledEvent(PartitionEvent):
    ...
    """ # noqa: E501
    destination_node: StrictStr = Field(description="The name of a Service Fabric node.", alias="DestinationNode")
    ...
    source_node: StrictStr = Field(description="The name of a Service Fabric node.", alias="SourceNode")
