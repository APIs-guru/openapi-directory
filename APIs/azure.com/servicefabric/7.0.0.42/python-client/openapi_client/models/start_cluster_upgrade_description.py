...
class StartClusterUpgradeDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ApplicationHealthPolicyMap", "ClusterHealthPolicy", "ClusterUpgradeHealthPolicy", "CodeVersion", "ConfigVersion", "EnableDeltaHealthEvaluation", "ForceRestart", "InstanceCloseDelayDurationInSeconds", "MonitoringPolicy", "RollingUpgradeMode", "SortOrder", "UpgradeKind", "UpgradeReplicaSetCheckTimeoutInSeconds"]
