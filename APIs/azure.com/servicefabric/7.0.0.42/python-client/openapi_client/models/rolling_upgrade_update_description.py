...
class RollingUpgradeUpdateDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["FailureAction", "ForceRestart", "HealthCheckRetryTimeoutInMilliseconds", "HealthCheckStableDurationInMilliseconds", "HealthCheckWaitDurationInMilliseconds", "InstanceCloseDelayDurationInSeconds", "ReplicaSetCheckTimeoutInMilliseconds", "RollingUpgradeMode", "UpgradeDomainTimeoutInMilliseconds", "UpgradeTimeoutInMilliseconds"]
