...
class ApplicationUpgradeDescription(BaseModel):
    ...
    instance_close_delay_duration_in_seconds: Optional[StrictInt] = Field(default=None, description="Duration in seconds, to wait before a stateless instance is closed, to allow the active requests to drain gracefully. This would be effective when the instance is closing during the application/cluster upgrade, only for those instances which have a non-zero delay duration configured in the service description. See InstanceCloseDelayDurationSeconds property in $ref: \"#/definitions/StatelessServiceDescription.yaml\" for details. Note, the default value of InstanceCloseDelayDurationInSeconds is 4294967295, which indicates that the behavior will entirely depend on the delay configured in the stateless service description.", alias="InstanceCloseDelayDurationInSeconds")
    ...
    __properties: ClassVar[List[str]] = ["ApplicationHealthPolicy", "ForceRestart", "InstanceCloseDelayDurationInSeconds", "MonitoringPolicy", "Name", "Parameters", "RollingUpgradeMode", "SortOrder", "TargetApplicationTypeVersion", "UpgradeKind", "UpgradeReplicaSetCheckTimeoutInSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "InstanceCloseDelayDurationInSeconds": obj.get("InstanceCloseDelayDurationInSeconds"),
