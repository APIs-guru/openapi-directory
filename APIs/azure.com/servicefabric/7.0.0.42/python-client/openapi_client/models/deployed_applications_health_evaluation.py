...
class DeployedApplicationsHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    max_percent_unhealthy_deployed_applications: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of unhealthy deployed applications from the ApplicationHealthPolicy.", alias="MaxPercentUnhealthyDeployedApplications")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of deployed applications of the application in the health store.", alias="TotalCount")
