...
class ServiceResourceProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["codePackages", "diagnostics", "networkRefs", "osType", "autoScalingPolicies", "description", "dnsName", "executionPolicy", "healthState", "identityRefs", "replicaCount", "status", "statusDetails", "unhealthyEvaluation"]
