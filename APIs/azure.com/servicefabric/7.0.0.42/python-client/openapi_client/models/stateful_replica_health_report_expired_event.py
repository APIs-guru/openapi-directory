...
class StatefulReplicaHealthReportExpiredEvent(ReplicaEvent):
    ...
    replica_instance_id: StrictInt = Field(description="Id of Replica instance.", alias="ReplicaInstanceId")
    ...
    __properties: ClassVar[List[str]] = ["PartitionId", "ReplicaId", "Category", "EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp"]
