...
class ServiceEvent(FabricEvent):
    ...
    """ # noqa: E501
    service_id: StrictStr = Field(description="The identity of the service. This ID is an encoded representation of the service name. This is used in the REST APIs to identify the service resource. Starting in version 6.0, hierarchical names are delimited with the \"\\~\" character. For example, if the service name is \"fabric:/myapp/app1/svc1\", the service identity would be \"myapp~app1\\~svc1\" in 6.0+ and \"myapp/app1/svc1\" in previous versions.", alias="ServiceId")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ServiceCreatedEvent': 'ServiceCreatedEvent','ServiceDeletedEvent': 'ServiceDeletedEvent','ServiceHealthReportExpiredEvent': 'ServiceHealthReportExpiredEvent','ServiceNewHealthReportEvent': 'ServiceNewHealthReportEvent'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ServiceCreatedEvent, ServiceDeletedEvent, ServiceHealthReportExpiredEvent, ServiceNewHealthReportEvent]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ServiceCreatedEvent, ServiceDeletedEvent, ServiceHealthReportExpiredEvent, ServiceNewHealthReportEvent]]:
        ...
        raise ValueError("ServiceEvent failed to lookup discriminator value from " +
