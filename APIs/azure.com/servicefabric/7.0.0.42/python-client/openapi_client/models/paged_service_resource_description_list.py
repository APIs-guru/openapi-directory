...
class PagedServiceResourceDescriptionList(BaseModel):
    """
    ...
    items: Optional[List[ServiceResourceDescription]] = Field(default=None, description="One page of the list.", alias="Items")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagedServiceResourceDescriptionList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagedServiceResourceDescriptionList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ServiceResourceDescription.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
