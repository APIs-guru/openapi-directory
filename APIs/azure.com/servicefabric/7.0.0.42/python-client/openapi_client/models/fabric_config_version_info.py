...
class FabricConfigVersionInfo(BaseModel):
    """
    Information about a Service Fabric config version.
    """ # noqa: E501
    config_version: Optional[StrictStr] = Field(default=None, description="The config version of Service Fabric.", alias="ConfigVersion")
    __properties: ClassVar[List[str]] = ["ConfigVersion"]
