...
class GetPropertyBatchOperation(PropertyBatchOperation):
    ...
    """ # noqa: E501
    include_value: Optional[StrictBool] = Field(default=False, description="Whether or not to return the property value with the metadata. True if values should be returned with the metadata; False to return only property metadata.", alias="IncludeValue")
