...
class UpgradeOrchestrationServiceState(BaseModel):
    """
    Service state of Service Fabric Upgrade Orchestration Service.
    """ # noqa: E501
    service_state: Optional[StrictStr] = Field(default=None, description="The state of Service Fabric Upgrade Orchestration Service.", alias="ServiceState")
    __properties: ClassVar[List[str]] = ["ServiceState"]
