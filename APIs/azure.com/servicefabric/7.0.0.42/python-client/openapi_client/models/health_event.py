...
class HealthEvent(BaseModel):
    ...
    health_report_id: Optional[StrictStr] = Field(default=None, description="A health report ID which identifies the health report and can be used to find more detailed information about a specific health event at aka.ms/sfhealthid", alias="HealthReportId")
    ...
    source_id: StrictStr = Field(description="The source name that identifies the client/watchdog/system component that generated the health information.", alias="SourceId")
    time_to_live_in_milli_seconds: Optional[StrictStr] = Field(default=None, description="The duration for which this health report is valid. This field uses ISO8601 format for specifying the duration. When clients report periodically, they should send reports with higher frequency than time to live. If clients report on transition, they can set the time to live to infinite. When time to live expires, the health event that contains the health information is either removed from health store, if RemoveWhenExpired is true, or evaluated at error, if RemoveWhenExpired false.  If not specified, time to live defaults to infinite value.", alias="TimeToLiveInMilliSeconds")
    __properties: ClassVar[List[str]] = ["Description", "HealthReportId", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "TimeToLiveInMilliSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HealthReportId": obj.get("HealthReportId"),
