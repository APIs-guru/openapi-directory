...
class SecretResourceDescription(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Secret resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": SecretResourceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
