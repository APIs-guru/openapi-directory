...
class ReplicaEvent(FabricEvent):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ChaosReplicaRemovalScheduledEvent, ChaosReplicaRestartScheduledEvent, StatefulReplicaHealthReportExpiredEvent, StatefulReplicaNewHealthReportEvent, StatelessReplicaHealthReportExpiredEvent, StatelessReplicaNewHealthReportEvent]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ChaosReplicaRemovalScheduledEvent, ChaosReplicaRestartScheduledEvent, StatefulReplicaHealthReportExpiredEvent, StatefulReplicaNewHealthReportEvent, StatelessReplicaHealthReportExpiredEvent, StatelessReplicaNewHealthReportEvent]]:
