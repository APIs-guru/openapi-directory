...
class StatefulServiceDescription(ServiceDescription):
    ...
    service_placement_time_limit_seconds: Optional[Annotated[int, Field(le=4294967295, strict=True, ge=0)]] = Field(default=None, description="The duration for which replicas can stay InBuild before reporting that build is stuck.", alias="ServicePlacementTimeLimitSeconds")
