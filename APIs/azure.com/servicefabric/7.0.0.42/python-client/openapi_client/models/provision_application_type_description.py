...
class ProvisionApplicationTypeDescription(ProvisionApplicationTypeDescriptionBase):
    ...
    application_type_build_path: StrictStr = Field(description="The relative path for the application package in the image store specified during the prior upload operation.", alias="ApplicationTypeBuildPath")
