...
class PagedReplicaInfoList(BaseModel):
    """
    ...
    items: Optional[List[ReplicaInfo]] = Field(default=None, description="List of replica information.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ReplicaInfo.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
