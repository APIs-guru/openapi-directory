...
class TestStatefulServiceReplicaHealth(unittest.TestCase):
    """StatefulServiceReplicaHealth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatefulServiceReplicaHealth:
        """Test StatefulServiceReplicaHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatefulServiceReplicaHealth`
        """
        model = StatefulServiceReplicaHealth()
        if include_optional:
            return StatefulServiceReplicaHealth(
                replica_id = '',
                partition_id = '',
    ...
    def testStatefulServiceReplicaHealth(self):
        """Test StatefulServiceReplicaHealth"""
