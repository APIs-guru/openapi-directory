...
class TestComposeDeploymentUpgradeDescription(unittest.TestCase):
    """ComposeDeploymentUpgradeDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComposeDeploymentUpgradeDescription:
        """Test ComposeDeploymentUpgradeDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComposeDeploymentUpgradeDescription`
        """
        model = ComposeDeploymentUpgradeDescription()
        if include_optional:
            return ComposeDeploymentUpgradeDescription(
    ...
    def testComposeDeploymentUpgradeDescription(self):
        """Test ComposeDeploymentUpgradeDescription"""
