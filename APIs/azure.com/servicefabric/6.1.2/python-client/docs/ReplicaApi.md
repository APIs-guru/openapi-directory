...
# **get_replica_info**
> ReplicaInfo get_replica_info(api_version, partition_id, replica_id, continuation_token=continuation_token, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the information about a replica of a Service Fabric partition.
        api_response = api_instance.get_replica_info(api_version, partition_id, replica_id, continuation_token=continuation_token, timeout=timeout)
