...
------------ | ------------- | ------------- | -------------
**request_abort** | **bool** | _True_ if the repair should be stopped as soon as possible even if it has already started executing. _False_ if the repair should be cancelled only if execution has not yet started. | [optional] 
