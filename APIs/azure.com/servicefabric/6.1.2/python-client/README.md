...
*ServicePackageApi* | [**deployed_service_package_to_node**](docs/ServicePackageApi.md#deployed_service_package_to_node) | **POST** /Nodes/{nodeName}/$/DeployServicePackage | Downloads all of the code packagesassociated with specified service manifest on the specified node.
