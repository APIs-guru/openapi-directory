...
class Int64RangePartitionInformation(PartitionInformation):
    ...
    """ # noqa: E501
    high_key: Optional[StrictStr] = Field(default=None, description="Specifies the maximum key value handled by this partition.", alias="HighKey")
    low_key: Optional[StrictStr] = Field(default=None, description="Specifies the minimum key value handled by this partition.", alias="LowKey")
