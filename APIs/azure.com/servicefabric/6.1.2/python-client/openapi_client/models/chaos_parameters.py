...
class ChaosParameters(BaseModel):
    ...
    """ # noqa: E501
    chaos_target_filter: Optional[ChaosTargetFilter] = Field(default=None, alias="ChaosTargetFilter")
    ...
    __properties: ClassVar[List[str]] = ["ChaosTargetFilter", "ClusterHealthPolicy", "Context", "EnableMoveReplicaFaults", "MaxClusterStabilizationTimeoutInSeconds", "MaxConcurrentFaults", "TimeToRunInSeconds", "WaitTimeBetweenFaultsInSeconds", "WaitTimeBetweenIterationsInSeconds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of chaos_target_filter
        if self.chaos_target_filter:
            _dict['ChaosTargetFilter'] = self.chaos_target_filter.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ChaosTargetFilter": ChaosTargetFilter.from_dict(obj["ChaosTargetFilter"]) if obj.get("ChaosTargetFilter") is not None else None,
