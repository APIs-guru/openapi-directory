...
class ServicesHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    max_percent_unhealthy_services: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of unhealthy services from the ServiceTypeHealthPolicy.", alias="MaxPercentUnhealthyServices")
    service_type_name: Optional[StrictStr] = Field(default=None, description="Name of the service type of the services.", alias="ServiceTypeName")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of services of the current service type in the application from the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "MaxPercentUnhealthyServices", "ServiceTypeName", "TotalCount", "UnhealthyEvaluations"]
