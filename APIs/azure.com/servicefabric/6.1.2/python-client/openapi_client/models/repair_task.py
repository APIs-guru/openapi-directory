...
class RepairTask(BaseModel):
    ...
    result_status: Optional[StrictStr] = Field(default=None, description="A value describing the overall result of the repair task execution. Must be specified in the Restoring and later states, and is immutable once set.", alias="ResultStatus")
    state: StrictStr = Field(description="The workflow state of the repair task. Valid initial states are Created, Claimed, and Preparing.", alias="State")
