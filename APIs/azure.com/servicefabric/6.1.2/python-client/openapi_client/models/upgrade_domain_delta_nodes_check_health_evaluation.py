...
class UpgradeDomainDeltaNodesCheckHealthEvaluation(HealthEvaluation):
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "BaselineErrorCount", "BaselineTotalCount", "MaxPercentDeltaUnhealthyNodes", "TotalCount", "UnhealthyEvaluations", "UpgradeDomainName"]
