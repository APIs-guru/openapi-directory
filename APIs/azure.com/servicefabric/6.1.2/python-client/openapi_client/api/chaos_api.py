...
class ChaosApi:
    ...
    def get_chaos_report(
        ...
        start_time_utc: Annotated[Optional[StrictStr], Field(description="The Windows file time representing the start time of the time range for which a Chaos report is to be generated. Please consult [DateTime.ToFileTimeUtc Method](https://msdn.microsoft.com/en-us/library/system.datetime.tofiletimeutc(v=vs.110).aspx) for details.")] = None,
