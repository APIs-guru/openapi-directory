...
class DeployedServicePackageInfo(BaseModel):
    """
    Information about service package deployed on a Service Fabric node.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the service manifest.", alias="Name")
    ...
    version: Optional[StrictStr] = Field(default=None, description="The version of the service package specified in service manifest.", alias="Version")
    __properties: ClassVar[List[str]] = ["Name", "ServicePackageActivationId", "Status", "Version"]
