...
class NodesHealthEvaluation(HealthEvaluation):
    ...
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of nodes found in the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "MaxPercentUnhealthyNodes", "TotalCount", "UnhealthyEvaluations"]
