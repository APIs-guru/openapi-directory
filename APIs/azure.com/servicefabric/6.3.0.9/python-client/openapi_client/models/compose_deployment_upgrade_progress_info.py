...
class ComposeDeploymentUpgradeProgressInfo(BaseModel):
    ...
    application_upgrade_status_details: Optional[StrictStr] = Field(default=None, description="Additional details of application upgrade including failure message.", alias="ApplicationUpgradeStatusDetails")
