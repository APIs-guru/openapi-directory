...
class DeployedServiceHealthReportExpiredEvent(ApplicationEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "Description", "HealthState", "NodeName", "Property", "RemoveWhenExpired", "SequenceNumber", "ServiceManifest", "ServicePackageActivationId", "ServicePackageInstanceId", "SourceId", "SourceUtcTimestamp", "TTLTimespan"]
