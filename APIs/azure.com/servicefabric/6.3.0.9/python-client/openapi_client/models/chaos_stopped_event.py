...
class ChaosStoppedEvent(ClusterEvent):
    ...
    Chaos Stopped event.
    """ # noqa: E501
    reason: StrictStr = Field(description="Describes reason.", alias="Reason")
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "Reason"]
