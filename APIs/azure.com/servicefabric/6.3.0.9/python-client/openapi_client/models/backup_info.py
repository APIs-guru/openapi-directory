...
class BackupInfo(BaseModel):
    ...
    epoch_of_last_backup_record: Optional[BackupEpoch] = Field(default=None, alias="EpochOfLastBackupRecord")
    ...
    __properties: ClassVar[List[str]] = ["ApplicationName", "BackupChainId", "BackupId", "BackupLocation", "BackupType", "CreationTimeUtc", "EpochOfLastBackupRecord", "FailureError", "LsnOfLastBackupRecord", "PartitionInformation", "ServiceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "EpochOfLastBackupRecord": BackupEpoch.from_dict(obj["EpochOfLastBackupRecord"]) if obj.get("EpochOfLastBackupRecord") is not None else None,
