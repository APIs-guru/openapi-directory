...
class RestoreProgressInfo(BaseModel):
    ...
    restored_epoch: Optional[BackupEpoch] = Field(default=None, alias="RestoredEpoch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RestoredEpoch": BackupEpoch.from_dict(obj["RestoredEpoch"]) if obj.get("RestoredEpoch") is not None else None,
