...
class PagedServiceResourceReplicaDescriptionList(BaseModel):
    """
    ...
    items: Optional[List[ServiceResourceReplicaDescription]] = Field(default=None, description="List of service resource description.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ServiceResourceReplicaDescription.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
