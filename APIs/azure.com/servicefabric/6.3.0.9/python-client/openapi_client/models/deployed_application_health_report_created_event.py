...
class DeployedApplicationHealthReportCreatedEvent(ApplicationEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "ApplicationInstanceId", "Description", "HealthState", "NodeName", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeployedApplicationHealthReportCreatedEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeployedApplicationHealthReportCreatedEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ApplicationInstanceId": obj.get("ApplicationInstanceId"),
