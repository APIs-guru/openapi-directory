...
class StatefulServiceInfo(ServiceInfo):
    ...
    """ # noqa: E501
    has_persisted_state: Optional[StrictBool] = Field(default=None, description="Whether the service has persisted state.", alias="HasPersistedState")
    __properties: ClassVar[List[str]] = ["HealthState", "Id", "IsServiceGroup", "ManifestVersion", "Name", "ServiceKind", "ServiceStatus", "TypeName", "HasPersistedState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HasPersistedState": obj.get("HasPersistedState")
        })
        return _obj
