...
class ApplicationsHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    max_percent_unhealthy_applications: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of unhealthy applications from the ClusterHealthPolicy.", alias="MaxPercentUnhealthyApplications")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of applications from the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "MaxPercentUnhealthyApplications", "TotalCount", "UnhealthyEvaluations"]
