...
class PagedComposeDeploymentStatusInfoList(BaseModel):
    """
    ...
    items: Optional[List[ComposeDeploymentStatusInfo]] = Field(default=None, description="List of compose deployment status information.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ComposeDeploymentStatusInfo.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
