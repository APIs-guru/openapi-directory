...
class ApplicationCreatedEvent(ApplicationEvent):
    ...
    """ # noqa: E501
    application_definition_kind: StrictStr = Field(description="Application definition kind.", alias="ApplicationDefinitionKind")
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "ApplicationDefinitionKind", "ApplicationTypeName", "ApplicationTypeVersion"]
