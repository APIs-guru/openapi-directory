...
class NodeDeactivateStartEvent(NodeEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "NodeName", "BatchId", "DeactivateIntent", "NodeInstance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DeactivateIntent": obj.get("DeactivateIntent"),
