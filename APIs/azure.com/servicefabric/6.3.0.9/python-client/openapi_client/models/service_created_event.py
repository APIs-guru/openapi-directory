...
class ServiceCreatedEvent(ServiceEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ServiceId", "ApplicationName", "ApplicationTypeName", "IsStateful", "MinReplicaSetSize", "PartitionCount", "PartitionId", "ServiceInstance", "ServicePackageVersion", "ServiceTypeName", "TargetReplicaSetSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ServicePackageVersion": obj.get("ServicePackageVersion"),
