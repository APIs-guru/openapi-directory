...
class DeployedServicePackageHealthStateChunkList(BaseModel):
    """
    ...
    """ # noqa: E501
    items: Optional[List[DeployedServicePackageHealthStateChunk]] = Field(default=None, description="The list of deployed service package health state chunks that respect the input filters in the chunk query.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [DeployedServicePackageHealthStateChunk.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
