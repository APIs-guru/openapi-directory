...
class ClusterEvent(FabricEvent):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ChaosStartedEvent': 'ChaosStartedEvent','ChaosStoppedEvent': 'ChaosStoppedEvent','ClusterHealthReportCreatedEvent': 'ClusterHealthReportCreatedEvent','ClusterHealthReportExpiredEvent': 'ClusterHealthReportExpiredEvent','ClusterUpgradeCompleteEvent': 'ClusterUpgradeCompleteEvent','ClusterUpgradeDomainCompleteEvent': 'ClusterUpgradeDomainCompleteEvent','ClusterUpgradeRollbackCompleteEvent': 'ClusterUpgradeRollbackCompleteEvent','ClusterUpgradeRollbackStartEvent': 'ClusterUpgradeRollbackStartEvent','ClusterUpgradeStartEvent': 'ClusterUpgradeStartEvent'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ChaosStartedEvent, ChaosStoppedEvent, ClusterHealthReportCreatedEvent, ClusterHealthReportExpiredEvent, ClusterUpgradeCompleteEvent, ClusterUpgradeDomainCompleteEvent, ClusterUpgradeRollbackCompleteEvent, ClusterUpgradeRollbackStartEvent, ClusterUpgradeStartEvent]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ChaosStartedEvent, ChaosStoppedEvent, ClusterHealthReportCreatedEvent, ClusterHealthReportExpiredEvent, ClusterUpgradeCompleteEvent, ClusterUpgradeDomainCompleteEvent, ClusterUpgradeRollbackCompleteEvent, ClusterUpgradeRollbackStartEvent, ClusterUpgradeStartEvent]]:
