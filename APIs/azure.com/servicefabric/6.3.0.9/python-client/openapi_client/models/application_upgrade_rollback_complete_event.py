...
class ApplicationUpgradeRollbackCompleteEvent(ApplicationEvent):
    ...
    failure_reason: StrictStr = Field(description="Describes reason of failure.", alias="FailureReason")
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "ApplicationTypeName", "ApplicationTypeVersion", "FailureReason", "OverallUpgradeElapsedTimeInMs"]
