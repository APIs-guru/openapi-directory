...
class NodeHealthReportExpiredEvent(NodeEvent):
    ...
    node_instance_id: StrictInt = Field(description="Id of Node instance.", alias="NodeInstanceId")
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "NodeName", "Description", "HealthState", "NodeInstanceId", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs"]
