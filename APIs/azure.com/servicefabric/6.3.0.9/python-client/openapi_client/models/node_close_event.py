...
class NodeCloseEvent(NodeEvent):
    ...
    Node Close event.
    """ # noqa: E501
    error: StrictStr = Field(description="Describes error.", alias="Error")
    node_id: StrictStr = Field(description="Id of Node.", alias="NodeId")
    node_instance: StrictStr = Field(description="Id of Node instance.", alias="NodeInstance")
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "NodeName", "Error", "NodeId", "NodeInstance"]
