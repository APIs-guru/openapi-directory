...
class StatefulReplicaHealthReportCreatedEvent(ReplicaEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "ReplicaId", "Description", "HealthState", "Property", "RemoveWhenExpired", "ReplicaInstanceId", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ReplicaInstanceId": obj.get("ReplicaInstanceId"),
