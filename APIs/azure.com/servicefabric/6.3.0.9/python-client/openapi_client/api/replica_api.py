...
class ReplicaApi:
    ...
    def report_replica_health(
        ...
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        replica_id: Annotated[StrictStr, Field(description="The identifier of the replica.")],
        replica_health_report_service_kind: Annotated[StrictStr, Field(description="The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values.")],
        ...
        :param replica_id: The identifier of the replica. (required)
        :type replica_id: str
        :param replica_health_report_service_kind: The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. (required)
        :type replica_health_report_service_kind: str
        ...
        _param = self._report_replica_health_serialize(
            ...
            partition_id=partition_id,
            replica_id=replica_id,
            replica_health_report_service_kind=replica_health_report_service_kind,
    ...
    def _report_replica_health_serialize(
        ...
        if replica_health_report_service_kind is not None:
            
            _query_params.append(('ReplicaHealthReportServiceKind', replica_health_report_service_kind))
