...
json = "{}"
# create an instance of PartitionHealthReportCreatedEvent from a JSON string
partition_health_report_created_event_instance = PartitionHealthReportCreatedEvent.from_json(json)
# print the JSON string representation of the object
print(PartitionHealthReportCreatedEvent.to_json())

# convert the object into a dict
partition_health_report_created_event_dict = partition_health_report_created_event_instance.to_dict()
# create an instance of PartitionHealthReportCreatedEvent from a dict
partition_health_report_created_event_from_dict = PartitionHealthReportCreatedEvent.from_dict(partition_health_report_created_event_dict)
```
