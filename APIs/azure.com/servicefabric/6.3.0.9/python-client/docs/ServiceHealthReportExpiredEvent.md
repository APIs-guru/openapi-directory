...
json = "{}"
# create an instance of ServiceHealthReportExpiredEvent from a JSON string
service_health_report_expired_event_instance = ServiceHealthReportExpiredEvent.from_json(json)
# print the JSON string representation of the object
print(ServiceHealthReportExpiredEvent.to_json())

# convert the object into a dict
service_health_report_expired_event_dict = service_health_report_expired_event_instance.to_dict()
# create an instance of ServiceHealthReportExpiredEvent from a dict
service_health_report_expired_event_from_dict = ServiceHealthReportExpiredEvent.from_dict(service_health_report_expired_event_dict)
```
