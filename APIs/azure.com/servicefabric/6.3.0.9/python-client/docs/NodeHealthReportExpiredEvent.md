...
json = "{}"
# create an instance of NodeHealthReportExpiredEvent from a JSON string
node_health_report_expired_event_instance = NodeHealthReportExpiredEvent.from_json(json)
# print the JSON string representation of the object
print(NodeHealthReportExpiredEvent.to_json())

# convert the object into a dict
node_health_report_expired_event_dict = node_health_report_expired_event_instance.to_dict()
# create an instance of NodeHealthReportExpiredEvent from a dict
node_health_report_expired_event_from_dict = NodeHealthReportExpiredEvent.from_dict(node_health_report_expired_event_dict)
```
