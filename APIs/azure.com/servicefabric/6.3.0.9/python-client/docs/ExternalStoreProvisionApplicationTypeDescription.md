...
**application_type_name** | **str** | The application type name represents the name of the application type found in the application manifest. | [optional] 
**application_type_version** | **str** | The application type version represents the version of the application type found in the application manifest. | [optional] 
