...
class TestPagedNodeInfoList(unittest.TestCase):
    """PagedNodeInfoList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedNodeInfoList:
        """Test PagedNodeInfoList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedNodeInfoList`
        """
        model = PagedNodeInfoList()
        if include_optional:
    ...
    def testPagedNodeInfoList(self):
        """Test PagedNodeInfoList"""
