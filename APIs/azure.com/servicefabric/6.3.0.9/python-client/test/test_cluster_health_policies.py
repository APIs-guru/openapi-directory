...
class TestClusterHealthPolicies(unittest.TestCase):
    """ClusterHealthPolicies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterHealthPolicies:
        """Test ClusterHealthPolicies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterHealthPolicies`
        """
        model = ClusterHealthPolicies()
        if include_optional:
            return ClusterHealthPolicies(
    ...
    def testClusterHealthPolicies(self):
        """Test ClusterHealthPolicies"""
