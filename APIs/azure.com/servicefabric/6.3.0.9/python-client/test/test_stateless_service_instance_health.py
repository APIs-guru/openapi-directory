...
class TestStatelessServiceInstanceHealth(unittest.TestCase):
    """StatelessServiceInstanceHealth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatelessServiceInstanceHealth:
        """Test StatelessServiceInstanceHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatelessServiceInstanceHealth`
        """
        model = StatelessServiceInstanceHealth()
        if include_optional:
            return StatelessServiceInstanceHealth(
    ...
    def testStatelessServiceInstanceHealth(self):
        """Test StatelessServiceInstanceHealth"""
