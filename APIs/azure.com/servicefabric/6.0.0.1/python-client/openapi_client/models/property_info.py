...
class PropertyInfo(BaseModel):
    ...
    """ # noqa: E501
    metadata: PropertyMetadata = Field(alias="Metadata")
    name: StrictStr = Field(description="The name of the Service Fabric property.", alias="Name")
    value: Optional[PropertyValue] = Field(default=None, alias="Value")
    __properties: ClassVar[List[str]] = ["Metadata", "Name", "Value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Metadata": PropertyMetadata.from_dict(obj["Metadata"]) if obj.get("Metadata") is not None else None,
            "Name": obj.get("Name"),
