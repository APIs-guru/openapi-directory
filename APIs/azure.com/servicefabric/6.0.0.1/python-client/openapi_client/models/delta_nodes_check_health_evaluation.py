...
class DeltaNodesCheckHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    baseline_error_count: Optional[StrictInt] = Field(default=None, description="Number of nodes with aggregated heath state Error in the health store at the beginning of the cluster upgrade.", alias="BaselineErrorCount")
    baseline_total_count: Optional[StrictInt] = Field(default=None, description="Total number of nodes in the health store at the beginning of the cluster upgrade.", alias="BaselineTotalCount")
    max_percent_delta_unhealthy_nodes: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of delta unhealthy nodes from the ClusterUpgradeHealthPolicy.", alias="MaxPercentDeltaUnhealthyNodes")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of nodes in the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "BaselineErrorCount", "BaselineTotalCount", "MaxPercentDeltaUnhealthyNodes", "TotalCount", "UnhealthyEvaluations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Kind": obj.get("Kind"),
            "BaselineErrorCount": obj.get("BaselineErrorCount"),
            "BaselineTotalCount": obj.get("BaselineTotalCount"),
