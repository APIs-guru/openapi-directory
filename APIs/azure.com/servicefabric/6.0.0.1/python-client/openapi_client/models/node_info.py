...
class NodeInfo(BaseModel):
    ...
    node_up_time_in_seconds: Optional[StrictStr] = Field(default=None, description="Time in seconds since the node has been in NodeStatus Up. Value ero indicates that the node is not Up.", alias="NodeUpTimeInSeconds")
