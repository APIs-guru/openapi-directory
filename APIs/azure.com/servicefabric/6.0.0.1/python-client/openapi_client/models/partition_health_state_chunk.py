...
class PartitionHealthStateChunk(BaseModel):
    """
    ...
    replica_health_state_chunks: Optional[ReplicaHealthStateChunkList] = Field(default=None, alias="ReplicaHealthStateChunks")
    __properties: ClassVar[List[str]] = ["HealthState", "PartitionId", "ReplicaHealthStateChunks"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of replica_health_state_chunks
        if self.replica_health_state_chunks:
            _dict['ReplicaHealthStateChunks'] = self.replica_health_state_chunks.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ReplicaHealthStateChunks": ReplicaHealthStateChunkList.from_dict(obj["ReplicaHealthStateChunks"]) if obj.get("ReplicaHealthStateChunks") is not None else None
        })
        return _obj
