...
class StatefulServiceUpdateDescription(ServiceUpdateDescription):
    ...
    quorum_loss_wait_duration_seconds: Optional[StrictStr] = Field(default=None, description="The maximum duration, in seconds, for which a partition is allowed to be in a state of quorum loss.", alias="QuorumLossWaitDurationSeconds")
    replica_restart_wait_duration_seconds: Optional[StrictStr] = Field(default=None, description="The duration, in seconds, between when a replica goes down and when a new replica is created.", alias="ReplicaRestartWaitDurationSeconds")
    stand_by_replica_keep_duration_seconds: Optional[StrictStr] = Field(default=None, description="The definition on how long StandBy replicas should be maintained before being removed.", alias="StandByReplicaKeepDurationSeconds")
