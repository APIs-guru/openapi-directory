...
class DeployedServicePackagesHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of deployed service packages of the deployed application in the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "TotalCount", "UnhealthyEvaluations"]
