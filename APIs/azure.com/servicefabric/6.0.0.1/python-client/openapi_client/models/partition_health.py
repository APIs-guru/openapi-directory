...
class PartitionHealth(BaseModel):
    ...
    replica_health_states: Optional[List[ReplicaHealthState]] = Field(default=None, description="The list of replica health states associated with the partition.", alias="ReplicaHealthStates")
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "HealthEvents", "HealthStatistics", "UnhealthyEvaluations", "PartitionId", "ReplicaHealthStates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ReplicaHealthStates": [ReplicaHealthState.from_dict(_item) for _item in obj["ReplicaHealthStates"]] if obj.get("ReplicaHealthStates") is not None else None
        })
        return _obj
