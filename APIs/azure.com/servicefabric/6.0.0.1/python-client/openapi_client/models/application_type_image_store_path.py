...
class ApplicationTypeImageStorePath(BaseModel):
    """
    Path description for the application package in the image store specified during the prior copy operation.
    """ # noqa: E501
    application_type_build_path: StrictStr = Field(description="The relative image store path to the application package.", alias="ApplicationTypeBuildPath")
    __properties: ClassVar[List[str]] = ["ApplicationTypeBuildPath"]
