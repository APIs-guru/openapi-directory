...
class StatefulServicePartitionInfo(ServicePartitionInfo):
    ...
    """ # noqa: E501
    current_configuration_epoch: Optional[Epoch] = Field(default=None, alias="CurrentConfigurationEpoch")
    last_quorum_loss_duration: Optional[StrictStr] = Field(default=None, description="The duration for which this partition was in quorum loss. If the partition is currently in quorum loss, it returns the duration since it has been in that state. This field is using ISO8601 format for specifying the duration.", alias="LastQuorumLossDuration")
    min_replica_set_size: Optional[StrictInt] = Field(default=None, description="The minimum replica set size as a number.", alias="MinReplicaSetSize")
    target_replica_set_size: Optional[StrictInt] = Field(default=None, description="The target replica set size as a number.", alias="TargetReplicaSetSize")
