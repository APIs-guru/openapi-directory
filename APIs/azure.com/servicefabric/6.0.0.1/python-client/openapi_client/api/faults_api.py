...
class FaultsApi:
    ...
    def cancel_operation(
        ...
        force: Annotated[StrictBool, Field(description="Indicates whether to gracefully rollback and clean up internal system state modified by executing the user-induced operation.")],
    ...
    def start_node_transition(
        ...
        :param operation_id: A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API (required)
        :type operation_id: str
        :param node_transition_type: Indicates the type of transition to perform.  NodeTransitionType.Start will start a stopped node.  NodeTransitionType.Stop will stop a node that is up.   - Invalid - Reserved.  Do not pass into API.   - Start - Transition a stopped node to up.   - Stop - Transition an up node to stopped.  (required)
    ...
    def start_partition_restart(
        ...
        partition_id: Annotated[StrictStr, Field(description="The identity of the partition.")],
        operation_id: Annotated[StrictStr, Field(description="A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API")],
        restart_partition_mode: Annotated[StrictStr, Field(description="- Invalid - Reserved.  Do not pass into API. - AllReplicasOrInstances - All replicas or instances in the partition are restarted at once. - OnlyActiveSecondaries - Only the secondary replicas are restarted. ")],
        timeout: Annotated[Optional[Annotated[int, Field(le=4294967295, strict=True, ge=1)]], Field(description="The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param operation_id: A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API (required)
        :type operation_id: str
        :param restart_partition_mode: - Invalid - Reserved.  Do not pass into API. - AllReplicasOrInstances - All replicas or instances in the partition are restarted at once. - OnlyActiveSecondaries - Only the secondary replicas are restarted.  (required)
