...
class InfrastructureApi:
    ...
    def invoke_infrastructure_command(
        ...
        service_id: Annotated[Optional[StrictStr], Field(description="The identity of the infrastructure service. This is  the full name of the infrastructure service without the 'fabric:' URI scheme. This parameter required only for the cluster that have more than one instance of infrastructure service running.")] = None,
