...
class TestUpdateClusterUpgradeDescription(unittest.TestCase):
    """UpdateClusterUpgradeDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateClusterUpgradeDescription:
        """Test UpdateClusterUpgradeDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateClusterUpgradeDescription`
        """
        model = UpdateClusterUpgradeDescription()
        if include_optional:
            return UpdateClusterUpgradeDescription(
                application_health_policy_map = openapi_client.models.application_health_policies.ApplicationHealthPolicies(
    ...
    def testUpdateClusterUpgradeDescription(self):
        """Test UpdateClusterUpgradeDescription"""
