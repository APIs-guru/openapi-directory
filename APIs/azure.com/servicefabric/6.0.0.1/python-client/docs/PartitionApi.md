...
[**get_partition_load_information**](PartitionApi.md#get_partition_load_information) | **GET** /Partitions/{partitionId}/$/GetLoadInformation | Gets the load of the specified Service Fabric partition.
...
[**recover_partition**](PartitionApi.md#recover_partition) | **POST** /Partitions/{partitionId}/$/Recover | Indicates to the Service Fabric cluster that it should attempt to recover a specific partition which is currently stuck in quorum loss.
[**recover_service_partitions**](PartitionApi.md#recover_service_partitions) | **POST** /Services/$/{serviceId}/$/GetPartitions/$/Recover | Indicates to the Service Fabric cluster that it should attempt to recover the specified service which is currently stuck in quorum loss.
[**recover_system_partitions**](PartitionApi.md#recover_system_partitions) | **POST** /$/RecoverSystemPartitions | Indicates to the Service Fabric cluster that it should attempt to recover the system services which are currently stuck in quorum loss.
...
> PartitionHealth get_partition_health(api_version, partition_id, events_health_state_filter=events_health_state_filter, replicas_health_state_filter=replicas_health_state_filter, exclude_health_statistics=exclude_health_statistics, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the health of the specified Service Fabric partition.
        api_response = api_instance.get_partition_health(api_version, partition_id, events_health_state_filter=events_health_state_filter, replicas_health_state_filter=replicas_health_state_filter, exclude_health_statistics=exclude_health_statistics, timeout=timeout)
        print("The response of PartitionApi->get_partition_health:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_partition_health: %s\n" % e)
```
...
> PartitionHealth get_partition_health_using_policy(api_version, partition_id, events_health_state_filter=events_health_state_filter, replicas_health_state_filter=replicas_health_state_filter, exclude_health_statistics=exclude_health_statistics, timeout=timeout, application_health_policy=application_health_policy)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the health of the specified Service Fabric partition, by using the specified health policy.
        api_response = api_instance.get_partition_health_using_policy(api_version, partition_id, events_health_state_filter=events_health_state_filter, replicas_health_state_filter=replicas_health_state_filter, exclude_health_statistics=exclude_health_statistics, timeout=timeout, application_health_policy=application_health_policy)
        print("The response of PartitionApi->get_partition_health_using_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_partition_health_using_policy: %s\n" % e)
```
...
# **get_partition_info**
> ServicePartitionInfo get_partition_info(api_version, partition_id, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the information about a Service Fabric partition.
        api_response = api_instance.get_partition_info(api_version, partition_id, timeout=timeout)
        print("The response of PartitionApi->get_partition_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_partition_info: %s\n" % e)
```
...
> PagedServicePartitionInfoList get_partition_info_list(api_version, service_id, continuation_token=continuation_token, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the list of partitions of a Service Fabric service.
        api_response = api_instance.get_partition_info_list(api_version, service_id, continuation_token=continuation_token, timeout=timeout)
        print("The response of PartitionApi->get_partition_info_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_partition_info_list: %s\n" % e)
```
...
> PartitionLoadInformation get_partition_load_information(api_version, partition_id, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the load of the specified Service Fabric partition.
        api_response = api_instance.get_partition_load_information(api_version, partition_id, timeout=timeout)
        print("The response of PartitionApi->get_partition_load_information:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_partition_load_information: %s\n" % e)
```
...
> ServiceNameInfo get_service_name_info(api_version, partition_id, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the name of the Service Fabric service for a partition.
        api_response = api_instance.get_service_name_info(api_version, partition_id, timeout=timeout)
        print("The response of PartitionApi->get_service_name_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartitionApi->get_service_name_info: %s\n" % e)
```
...
> recover_all_partitions(api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Indicates to the Service Fabric cluster that it should attempt to recover any services (including system services) which are currently stuck in quorum loss.
        api_instance.recover_all_partitions(api_version, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->recover_all_partitions: %s\n" % e)
```
...
# **recover_partition**
> recover_partition(partition_id, api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Indicates to the Service Fabric cluster that it should attempt to recover a specific partition which is currently stuck in quorum loss.
        api_instance.recover_partition(partition_id, api_version, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->recover_partition: %s\n" % e)
```
...
> recover_service_partitions(service_id, api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Indicates to the Service Fabric cluster that it should attempt to recover the specified service which is currently stuck in quorum loss.
        api_instance.recover_service_partitions(service_id, api_version, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->recover_service_partitions: %s\n" % e)
```
...
> recover_system_partitions(api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Indicates to the Service Fabric cluster that it should attempt to recover the system services which are currently stuck in quorum loss.
        api_instance.recover_system_partitions(api_version, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->recover_system_partitions: %s\n" % e)
```
...
> report_partition_health(api_version, partition_id, health_information, immediate=immediate, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Sends a health report on the Service Fabric partition.
        api_instance.report_partition_health(api_version, partition_id, health_information, immediate=immediate, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->report_partition_health: %s\n" % e)
```
...
> reset_partition_load(partition_id, api_version, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Resets the current load of a Service Fabric partition.
        api_instance.reset_partition_load(partition_id, api_version, timeout=timeout)
    except Exception as e:
        print("Exception when calling PartitionApi->reset_partition_load: %s\n" % e)
```
