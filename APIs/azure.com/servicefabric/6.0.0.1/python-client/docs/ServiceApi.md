...
------------- | ------------- | -------------
[**create_service**](ServiceApi.md#create_service) | **POST** /Applications/{applicationId}/$/GetServices/$/Create | Creates the specified service.
[**create_service_from_template**](ServiceApi.md#create_service_from_template) | **POST** /Applications/{applicationId}/$/GetServices/$/CreateFromTemplate | Creates a Service Fabric service from the service template defined in the application manifest.
...
[**get_service_info**](ServiceApi.md#get_service_info) | **GET** /Applications/{applicationId}/$/GetServices/{serviceId} | Gets the information about the specific service belonging to a Service Fabric application.
...
[**update_service**](ServiceApi.md#update_service) | **POST** /Services/{serviceId}/$/Update | Updates the specified service using the given update description.


# **create_service**
> create_service(application_id, api_version, service_description, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates the specified service.
        api_instance.create_service(application_id, api_version, service_description, timeout=timeout)
...
> create_service_from_template(application_id, api_version, service_from_template_description, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a Service Fabric service from the service template defined in the application manifest.
        api_instance.create_service_from_template(application_id, api_version, service_from_template_description, timeout=timeout)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    previous_rsp_version = 'previous_rsp_version_example' # str | The value in the Version field of the response that was received previously. This is required if the user knows that the result that was got previously is stale. (optional)
    timeout = 60 # int | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional) (default to 60)
 ...
 **previous_rsp_version** | **str**| The value in the Version field of the response that was received previously. This is required if the user knows that the result that was got previously is stale. | [optional] 
 **timeout** | **int**| The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
