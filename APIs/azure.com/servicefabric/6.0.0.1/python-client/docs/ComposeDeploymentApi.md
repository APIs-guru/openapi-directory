...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 6.0-preview # str | The version of the API. This is a required parameter and its value must be \"6.0-preview\". (default to 6.0-preview)
...
------------- | ------------- | ------------- | -------------
 **api_version** | **str**| The version of the API. This is a required parameter and its value must be \&quot;6.0-preview\&quot;. | [default to 6.0-preview]
