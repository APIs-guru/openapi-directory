...
------------- | ------------- | -------------
[**deployed_service_package_to_node**](ServicePackageApi.md#deployed_service_package_to_node) | **POST** /Nodes/{nodeName}/$/DeployServicePackage | Downloads packages associated with specified service manifest to image cache on specified node.
