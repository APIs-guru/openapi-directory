...
deployed_application_health_report_created_event_instance = DeployedApplicationHealthReportCreatedEvent.from_json(json)
# print the JSON string representation of the object
print(DeployedApplicationHealthReportCreatedEvent.to_json())

# convert the object into a dict
deployed_application_health_report_created_event_dict = deployed_application_health_report_created_event_instance.to_dict()
# create an instance of DeployedApplicationHealthReportCreatedEvent from a dict
deployed_application_health_report_created_event_from_dict = DeployedApplicationHealthReportCreatedEvent.from_dict(deployed_application_health_report_created_event_dict)
```
