...
> report_replica_health(api_version, partition_id, replica_id, replica_health_report_service_kind, health_information, immediate=immediate, timeout=timeout)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    partition_id = 'partition_id_example' # str | The identity of the partition.
    replica_id = 'replica_id_example' # str | The identifier of the replica.
    replica_health_report_service_kind = Stateful # str | The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. (default to Stateful)
    ...
    try:
        # Sends a health report on the Service Fabric replica.
        api_instance.report_replica_health(api_version, partition_id, replica_id, replica_health_report_service_kind, health_information, immediate=immediate, timeout=timeout)
    except Exception as e:
 ...
 **partition_id** | **str**| The identity of the partition. | 
 **replica_id** | **str**| The identifier of the replica. | 
 **replica_health_report_service_kind** | **str**| The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. | [default to Stateful]
