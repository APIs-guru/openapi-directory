...
class ClusterConfiguration(BaseModel):
    ...
    """ # noqa: E501
    cluster_configuration: Optional[StrictStr] = Field(default=None, description="The contents of the cluster configuration file.", alias="ClusterConfiguration")
    __properties: ClassVar[List[str]] = ["ClusterConfiguration"]
