...
class ExternalStoreProvisionApplicationTypeDescription(ProvisionApplicationTypeDescriptionBase):
    ...
    """ # noqa: E501
    application_package_download_uri: Optional[StrictStr] = Field(default=None, description="The path to the '.sfpkg' application package from where the application package can be downloaded using HTTP or HTTPS protocols. The application package can be stored in an external store that provides GET operation to download the file. Supported protocols are HTTP and HTTPS, and the path must allow READ access.", alias="ApplicationPackageDownloadUri")
    application_type_name: Optional[StrictStr] = Field(default=None, description="The application type name represents the name of the application type found in the application manifest.", alias="ApplicationTypeName")
    application_type_version: Optional[StrictStr] = Field(default=None, description="The application type version represents the version of the application type found in the application manifest.", alias="ApplicationTypeVersion")
    __properties: ClassVar[List[str]] = ["Async", "Kind", "ApplicationPackageDownloadUri", "ApplicationTypeName", "ApplicationTypeVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Async": obj.get("Async"),
            "Kind": obj.get("Kind"),
            "ApplicationPackageDownloadUri": obj.get("ApplicationPackageDownloadUri"),
