...
class ApplicationUpgradeCompleteEvent(ApplicationEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "ApplicationTypeName", "ApplicationTypeVersion", "OverallUpgradeElapsedTimeInMs"]
