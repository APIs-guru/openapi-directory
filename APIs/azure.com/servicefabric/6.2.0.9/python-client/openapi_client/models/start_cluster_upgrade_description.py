...
class StartClusterUpgradeDescription(BaseModel):
    """
    ...
    code_version: Optional[StrictStr] = Field(default=None, description="The cluster code version.", alias="CodeVersion")
    config_version: Optional[StrictStr] = Field(default=None, description="The cluster configuration version.", alias="ConfigVersion")
    ...
    __properties: ClassVar[List[str]] = ["ApplicationHealthPolicyMap", "ClusterHealthPolicy", "ClusterUpgradeHealthPolicy", "CodeVersion", "ConfigVersion", "EnableDeltaHealthEvaluation", "ForceRestart", "MonitoringPolicy", "RollingUpgradeMode", "UpgradeKind", "UpgradeReplicaSetCheckTimeoutInSeconds"]
