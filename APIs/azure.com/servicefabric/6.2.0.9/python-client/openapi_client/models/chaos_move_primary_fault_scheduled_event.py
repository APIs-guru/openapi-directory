...
class ChaosMovePrimaryFaultScheduledEvent(PartitionEvent):
    ...
    forced_move: StrictBool = Field(description="Indicates a forced move.", alias="ForcedMove")
    node_to: StrictStr = Field(description="The name of a Service Fabric node.", alias="NodeTo")
    service_name: StrictStr = Field(description="Service name.", alias="ServiceName")
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "FaultGroupId", "FaultId", "ForcedMove", "NodeTo", "ServiceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ForcedMove": obj.get("ForcedMove"),
            "NodeTo": obj.get("NodeTo"),
