...
class StatelessServiceInstanceHealth(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "HealthEvents", "HealthStatistics", "UnhealthyEvaluations", "PartitionId", "ServiceKind", "InstanceId"]
