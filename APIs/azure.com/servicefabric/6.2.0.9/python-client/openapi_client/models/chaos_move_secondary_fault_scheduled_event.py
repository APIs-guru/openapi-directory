...
class ChaosMoveSecondaryFaultScheduledEvent(PartitionEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "DestinationNode", "FaultGroupId", "FaultId", "ForcedMove", "ServiceName", "SourceNode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DestinationNode": obj.get("DestinationNode"),
