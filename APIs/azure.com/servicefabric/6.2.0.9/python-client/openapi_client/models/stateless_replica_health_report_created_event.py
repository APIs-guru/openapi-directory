...
class StatelessReplicaHealthReportCreatedEvent(ReplicaEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "ReplicaId", "Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatelessReplicaHealthReportCreatedEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatelessReplicaHealthReportCreatedEvent from a dict"""
        if obj is None:
            return None
