...
class ClusterUpgradeProgressObject(BaseModel):
    """
    ...
    failure_timestamp_utc: Optional[StrictStr] = Field(default=None, description="The failure time of the upgrade in UTC.", alias="FailureTimestampUtc")
    ...
    start_timestamp_utc: Optional[StrictStr] = Field(default=None, description="The start time of the upgrade in UTC.", alias="StartTimestampUtc")
    ...
    upgrade_description: Optional[ClusterUpgradeDescriptionObject] = Field(default=None, alias="UpgradeDescription")
    upgrade_domain_duration_in_milliseconds: Optional[StrictStr] = Field(default=None, description="The estimated elapsed time spent processing the current upgrade domain.", alias="UpgradeDomainDurationInMilliseconds")
    upgrade_domain_progress_at_failure: Optional[FailedUpgradeDomainProgressObject] = Field(default=None, alias="UpgradeDomainProgressAtFailure")
    ...
    upgrade_duration_in_milliseconds: Optional[StrictStr] = Field(default=None, description="The estimated elapsed time spent processing the current overall upgrade.", alias="UpgradeDurationInMilliseconds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UpgradeDescription": ClusterUpgradeDescriptionObject.from_dict(obj["UpgradeDescription"]) if obj.get("UpgradeDescription") is not None else None,
            "UpgradeDomainDurationInMilliseconds": obj.get("UpgradeDomainDurationInMilliseconds"),
            "UpgradeDomainProgressAtFailure": FailedUpgradeDomainProgressObject.from_dict(obj["UpgradeDomainProgressAtFailure"]) if obj.get("UpgradeDomainProgressAtFailure") is not None else None,
