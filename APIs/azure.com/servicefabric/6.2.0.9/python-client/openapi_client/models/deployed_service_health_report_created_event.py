...
class DeployedServiceHealthReportCreatedEvent(ApplicationEvent):
    ...
    ttl_timespan: StrictInt = Field(description="Time to live in milli-seconds.", alias="TTLTimespan")
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "ApplicationId", "Description", "HealthState", "NodeName", "Property", "RemoveWhenExpired", "SequenceNumber", "ServiceManifestName", "ServicePackageActivationId", "ServicePackageInstanceId", "SourceId", "SourceUtcTimestamp", "TTLTimespan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ServicePackageInstanceId": obj.get("ServicePackageInstanceId"),
            "SourceId": obj.get("SourceId"),
            "SourceUtcTimestamp": obj.get("SourceUtcTimestamp"),
            "TTLTimespan": obj.get("TTLTimespan")
        })
        return _obj
