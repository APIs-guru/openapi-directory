...
class StatelessServiceTypeDescription(ServiceTypeDescription):
    ...
    """ # noqa: E501
    use_implicit_host: Optional[StrictBool] = Field(default=None, description="A flag indicating if this type is not implemented and hosted by a user service process, but is implicitly hosted by a system created process. This value is true for services using the guest executable services, false otherwise.", alias="UseImplicitHost")
