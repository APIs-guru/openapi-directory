...
class PartitionPrimaryMoveAnalysisEvent(PartitionAnalysisEvent):
    ...
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "Metadata", "CurrentNode", "MoveReason", "PreviousNode", "RelevantTraces", "WhenMoveCompleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "CurrentNode": obj.get("CurrentNode"),
            "MoveReason": obj.get("MoveReason"),
            "PreviousNode": obj.get("PreviousNode"),
            "RelevantTraces": obj.get("RelevantTraces"),
            "WhenMoveCompleted": obj.get("WhenMoveCompleted")
        })
        return _obj
