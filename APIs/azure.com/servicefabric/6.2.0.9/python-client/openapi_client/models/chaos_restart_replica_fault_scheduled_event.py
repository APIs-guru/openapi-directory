...
class ChaosRestartReplicaFaultScheduledEvent(ReplicaEvent):
    ...
    service_uri: StrictStr = Field(description="Service name.", alias="ServiceUri")
    __properties: ClassVar[List[str]] = ["EventInstanceId", "HasCorrelatedEvents", "Kind", "TimeStamp", "PartitionId", "ReplicaId", "FaultGroupId", "FaultId", "ServiceUri"]
