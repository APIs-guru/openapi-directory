...
class ReplicasHealthEvaluation(HealthEvaluation):
    ...
    """ # noqa: E501
    max_percent_unhealthy_replicas_per_partition: Optional[StrictInt] = Field(default=None, description="Maximum allowed percentage of unhealthy replicas per partition from the ApplicationHealthPolicy.", alias="MaxPercentUnhealthyReplicasPerPartition")
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of replicas in the partition from the health store.", alias="TotalCount")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "Description", "Kind", "MaxPercentUnhealthyReplicasPerPartition", "TotalCount", "UnhealthyEvaluations"]
