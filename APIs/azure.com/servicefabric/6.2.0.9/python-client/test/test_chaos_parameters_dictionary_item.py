...
class TestChaosParametersDictionaryItem(unittest.TestCase):
    """ChaosParametersDictionaryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChaosParametersDictionaryItem:
        """Test ChaosParametersDictionaryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChaosParametersDictionaryItem`
        """
        model = ChaosParametersDictionaryItem()
        if include_optional:
            return ChaosParametersDictionaryItem(
                key = '',
    ...
    def testChaosParametersDictionaryItem(self):
        """Test ChaosParametersDictionaryItem"""
