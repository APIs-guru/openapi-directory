...
json = "{}"
# create an instance of CreateServiceDescription from a JSON string
create_service_description_instance = CreateServiceDescription.from_json(json)
# print the JSON string representation of the object
print(CreateServiceDescription.to_json())

# convert the object into a dict
create_service_description_dict = create_service_description_instance.to_dict()
# create an instance of CreateServiceDescription from a dict
create_service_description_from_dict = CreateServiceDescription.from_dict(create_service_description_dict)
```
