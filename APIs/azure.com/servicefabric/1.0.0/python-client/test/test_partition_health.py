...
class TestPartitionHealth(unittest.TestCase):
    """PartitionHealth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartitionHealth:
        """Test PartitionHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartitionHealth`
        """
        model = PartitionHealth()
        if include_optional:
            return PartitionHealth(
                ...
                replica_health_states = [
                    openapi_client.models.partition_health_replica_health_states_inner.PartitionHealth_ReplicaHealthStates_inner(
                        aggregated_health_state = 'Invalid', 
                        health_events = 56, 
                        partition_id = '', 
                        replica_id = '', )
