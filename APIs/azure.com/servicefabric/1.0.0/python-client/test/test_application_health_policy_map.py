...
class TestApplicationHealthPolicyMap(unittest.TestCase):
    """ApplicationHealthPolicyMap unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationHealthPolicyMap:
        """Test ApplicationHealthPolicyMap
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationHealthPolicyMap`
        """
        model = ApplicationHealthPolicyMap()
        if include_optional:
    ...
    def testApplicationHealthPolicyMap(self):
        """Test ApplicationHealthPolicyMap"""
