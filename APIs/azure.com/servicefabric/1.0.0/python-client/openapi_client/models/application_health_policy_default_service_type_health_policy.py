...
class ApplicationHealthPolicyDefaultServiceTypeHealthPolicy(BaseModel):
    """
    The policy of the default service type health
    """ # noqa: E501
    max_percent_unhealthy_partitions_per_service: Optional[StrictInt] = Field(default=None, alias="MaxPercentUnhealthyPartitionsPerService")
    max_percent_unhealthy_replicas_per_partition: Optional[StrictInt] = Field(default=None, alias="MaxPercentUnhealthyReplicasPerPartition")
