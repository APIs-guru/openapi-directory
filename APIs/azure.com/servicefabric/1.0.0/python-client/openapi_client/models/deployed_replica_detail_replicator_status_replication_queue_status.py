...
class DeployedReplicaDetailReplicatorStatusReplicationQueueStatus(BaseModel):
    """
    The status of the replication queue
    """ # noqa: E501
    committed_sequence_number: Optional[StrictStr] = Field(default=None, alias="CommittedSequenceNumber")
    completed_sequence_number: Optional[StrictStr] = Field(default=None, alias="CompletedSequenceNumber")
    first_sequence_number: Optional[StrictStr] = Field(default=None, alias="FirstSequenceNumber")
    last_sequence_number: Optional[StrictStr] = Field(default=None, alias="LastSequenceNumber")
    queue_memory_size: Optional[StrictStr] = Field(default=None, alias="QueueMemorySize")
    queue_utilization_percentage: Optional[StrictStr] = Field(default=None, alias="QueueUtilizationPercentage")
