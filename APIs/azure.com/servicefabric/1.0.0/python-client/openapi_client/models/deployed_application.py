...
class DeployedApplication(BaseModel):
    """
    The application of the deployed
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    log_directory: Optional[StrictStr] = Field(default=None, alias="LogDirectory")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    status: Optional[StrictStr] = Field(default=None, alias="Status")
    temp_directory: Optional[StrictStr] = Field(default=None, alias="TempDirectory")
    type_name: Optional[StrictStr] = Field(default=None, alias="TypeName")
    work_directory: Optional[StrictStr] = Field(default=None, alias="WorkDirectory")
