...
class DeployedServicePackageHealth(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "ApplicationName", "HealthEvents", "NodeName", "ServiceManifestName"]
