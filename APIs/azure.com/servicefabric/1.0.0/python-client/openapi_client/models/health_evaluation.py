...
class HealthEvaluation(BaseModel):
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Invalid', 'Event', 'Replicas', 'Partitions', 'DeployedServicePackages', 'DeployedApplications', 'Services', 'Nodes', 'Applications', 'SystemApplication', 'UpgradeDomainDeployedApplications', 'UpgradeDomainNodes', 'Node', 'Replica', 'Partition', 'Service', 'DeployedServicePackage', 'DeployedApplication', 'Application', 'DeltaNodesCheck', 'UpgradeDomainDeltaNodesCheck', 'ApplicationTypeApplications']):
            raise ValueError("must be one of enum values ('Invalid', 'Event', 'Replicas', 'Partitions', 'DeployedServicePackages', 'DeployedApplications', 'Services', 'Nodes', 'Applications', 'SystemApplication', 'UpgradeDomainDeployedApplications', 'UpgradeDomainNodes', 'Node', 'Replica', 'Partition', 'Service', 'DeployedServicePackage', 'DeployedApplication', 'Application', 'DeltaNodesCheck', 'UpgradeDomainDeltaNodesCheck', 'ApplicationTypeApplications')")
        return value
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ApplicationHealthEvaluation, ApplicationTypeHealthEvaluation, ApplicationsHealthEvaluation, DeltaNodesCheckHealthEvaluation, DeployedApplicationHealthEvaluation, DeployedApplicationsHealthEvaluation, DeployedServicePackageHealthEvaluation, DeployedServicePackagesHealthEvaluation, EventHealthEvaluation, NodeHealthEvaluation, NodesHealthEvaluation, PartitionHealthEvaluation, PartitionsHealthEvaluation, ReplicaHealthEvaluation, ReplicasHealthEvaluation, ServiceHealthEvaluation, ServicesHealthEvaluation, SystemApplicationHealthEvaluation, UpgradeDomainDeltaNodesCheckHealthEvaluation, UpgradeDomainDeployedApplicationsHealthEvaluation, UpgradeDomainNodesHealthEvaluation]]:
        ...
        if object_type ==  'ApplicationTypeHealthEvaluation':
            return import_module("openapi_client.models.application_type_health_evaluation").ApplicationTypeHealthEvaluation.from_dict(obj)
        ...
        if object_type ==  'UpgradeDomainDeployedApplicationsHealthEvaluation':
            return import_module("openapi_client.models.upgrade_domain_deployed_applications_health_evaluation").UpgradeDomainDeployedApplicationsHealthEvaluation.from_dict(obj)
