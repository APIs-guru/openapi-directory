...
class UpdateDescription(BaseModel):
    ...
    health_check_stable_duration_in_milliseconds: Optional[StrictStr] = Field(default=None, description="The seconds of the health check stable duration", alias="HealthCheckStableDurationInMilliseconds")
    health_check_wait_duration_in_milliseconds: Optional[StrictStr] = Field(default=None, description="The seconds of the health check wait duration", alias="HealthCheckWaitDurationInMilliseconds")
