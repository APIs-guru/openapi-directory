...
class ServiceGroupDescription(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'StatefulServiceGroupDescription': 'StatefulServiceGroupDescription','StatelessServiceGroupDescription': 'StatelessServiceGroupDescription'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[StatefulServiceGroupDescription, StatelessServiceGroupDescription]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[StatefulServiceGroupDescription, StatelessServiceGroupDescription]]:
        """Create an instance of ServiceGroupDescription from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'StatefulServiceGroupDescription':
            return import_module("openapi_client.models.stateful_service_group_description").StatefulServiceGroupDescription.from_dict(obj)
        if object_type ==  'StatelessServiceGroupDescription':
            return import_module("openapi_client.models.stateless_service_group_description").StatelessServiceGroupDescription.from_dict(obj)

        raise ValueError("ServiceGroupDescription failed to lookup discriminator value from " +
