...
class CreateServiceDescription(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'StatefulCreateServiceDescription': 'StatefulCreateServiceDescription','StatelessCreateServiceDescription': 'StatelessCreateServiceDescription'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[StatefulCreateServiceDescription, StatelessCreateServiceDescription]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[StatefulCreateServiceDescription, StatelessCreateServiceDescription]]:
        """Create an instance of CreateServiceDescription from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'StatefulCreateServiceDescription':
            return import_module("openapi_client.models.stateful_create_service_description").StatefulCreateServiceDescription.from_dict(obj)
        if object_type ==  'StatelessCreateServiceDescription':
            return import_module("openapi_client.models.stateless_create_service_description").StatelessCreateServiceDescription.from_dict(obj)

        raise ValueError("CreateServiceDescription failed to lookup discriminator value from " +
