...
class ApplicationType(BaseModel):
    ...
    """ # noqa: E501
    default_parameter_list: Optional[List[ApplicationTypeDefaultParameterListInner]] = Field(default=None, alias="DefaultParameterList")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    version: Optional[StrictStr] = Field(default=None, alias="Version")
    __properties: ClassVar[List[str]] = ["DefaultParameterList", "Name", "Version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DefaultParameterList": [ApplicationTypeDefaultParameterListInner.from_dict(_item) for _item in obj["DefaultParameterList"]] if obj.get("DefaultParameterList") is not None else None,
            "Name": obj.get("Name"),
