...
class PartitionHealthReplicaHealthStatesInner(BaseModel):
    """
    ...
    health_events: Optional[StrictInt] = Field(default=None, alias="HealthEvents")
    ...
    __properties: ClassVar[List[str]] = ["AggregatedHealthState", "HealthEvents", "PartitionId", "ReplicaId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HealthEvents": obj.get("HealthEvents"),
