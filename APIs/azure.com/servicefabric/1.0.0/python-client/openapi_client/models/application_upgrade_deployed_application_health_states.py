...
class ApplicationUpgradeDeployedApplicationHealthStates(BaseModel):
    """
    The states of the deployed application health
    """ # noqa: E501
    domain_name: Optional[StrictStr] = Field(default=None, alias="DomainName")
    node_upgrade_progress_list: Optional[StrictStr] = Field(default=None, alias="NodeUpgradeProgressList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "NodeUpgradeProgressList": obj.get("NodeUpgradeProgressList")
        })
        return _obj
