...
class ServiceTypeServiceTypeDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["HasPersistedState", "IsStateful", "PlacementConstraints", "ServiceTypeName"]
