...
class PartitionLoadInformation(BaseModel):
    ...
    primary_load_metric_reports: Optional[List[StrictStr]] = Field(default=None, alias="PrimaryLoadMetricReports")
    secondary_load_metric_reports: Optional[List[StrictStr]] = Field(default=None, alias="SecondaryLoadMetricReports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PrimaryLoadMetricReports": obj.get("PrimaryLoadMetricReports"),
            "SecondaryLoadMetricReports": obj.get("SecondaryLoadMetricReports")
        })
        return _obj
