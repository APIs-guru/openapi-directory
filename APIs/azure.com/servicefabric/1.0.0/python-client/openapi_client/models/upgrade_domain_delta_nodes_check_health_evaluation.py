...
class UpgradeDomainDeltaNodesCheckHealthEvaluation(HealthEvaluation):
    ...
    max_percent_upgrade_domain_delta_unhealthy_nodes: Optional[StrictInt] = Field(default=None, alias="MaxPercentUpgradeDomainDeltaUnhealthyNodes")
    ...
    upgrade_domain_name: Optional[StrictStr] = Field(default=None, alias="UpgradeDomainName")
