...
class TestPropertyContract(unittest.TestCase):
    """PropertyContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyContract:
        """Test PropertyContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyContract`
        """
