...
class TestPropertyCollection(unittest.TestCase):
    """PropertyCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyCollection:
        """Test PropertyCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyCollection`
        """
        ...
        if include_optional:
            return PropertyCollection(
                ...
                next_link = '',
                value = [
                    openapi_client.models.property_contract.PropertyContract(
                        id = '', )
                    ]
            )
        else:
    ...
    def testPropertyCollection(self):
        """Test PropertyCollection"""
