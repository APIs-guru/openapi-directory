...
[**property_get_entity_tag**](PropertyApi.md#property_get_entity_tag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/properties/{propId} | 
[**property_list_by_service**](PropertyApi.md#property_list_by_service) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/properties | 
...
> PropertyGet200Response property_create_or_update(resource_group_name, service_name, prop_id, api_version, subscription_id, parameters, if_match=if_match)
...
|-------------|-------------|------------------|
**200** | Property was successfully updated. |  * ETag - Current entity state version. Should be treated as opaque and used to make conditional HTTP requests. <br>  |
**201** | Property was successfully created. |  * ETag - Current entity state version. Should be treated as opaque and used to make conditional HTTP requests. <br>  |
...
# **property_get**
> PropertyGet200Response property_get(resource_group_name, service_name, prop_id, api_version, subscription_id)
...
> property_get_entity_tag(resource_group_name, service_name, prop_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.property_get_entity_tag(resource_group_name, service_name, prop_id, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling PropertyApi->property_get_entity_tag: %s\n" % e)
```
...
> PropertyListByService200Response property_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.property_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of PropertyApi->property_list_by_service:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PropertyApi->property_list_by_service: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.PropertyUpdateRequest() # PropertyUpdateRequest | Update parameters.
