...
> PropertyContract property_create_or_update(resource_group_name, service_name, prop_id, api_version, subscription_id, parameters, if_match=if_match)
...
> PropertyCollection property_list_by_service(resource_group_name, service_name, api_version, subscription_id, filter=filter, top=top, skip=skip)
