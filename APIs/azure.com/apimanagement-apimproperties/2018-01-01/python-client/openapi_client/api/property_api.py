...
class PropertyApi:
    ...
    def property_create_or_update(
        ...
        prop_id: Annotated[str, Field(strict=True, max_length=80, description="Identifier of the property.")],
    ...
    def property_get_entity_tag(
        ...
        _param = self._property_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            prop_id=prop_id,
            api_version=api_version,
    ...
    @validate_call
    def property_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        prop_id: Annotated[str, Field(strict=True, max_length=80, description="Identifier of the property.")],
    ...
    @validate_call
    def property_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        prop_id: Annotated[str, Field(strict=True, max_length=80, description="Identifier of the property.")],
    ...
    def _property_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        prop_id,
    ...
    def property_list_by_service(
        ...
        _param = self._property_list_by_service_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def property_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    @validate_call
    def property_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _property_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
