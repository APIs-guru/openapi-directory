...
class PropertyContract(BaseModel):
    ...
    Property details.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Uniquely identifies the property within the current API Management service instance. The value is a valid relative URL in the format of /properties/{propId} where {propId} is a property identifier.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "secret", "tags", "value"]
