...
class PropertyUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Unique name of Property. It may contain only letters, digits, period, dash, and underscore characters.")
    ...
    __properties: ClassVar[List[str]] = ["name", "secret", "tags", "value"]
