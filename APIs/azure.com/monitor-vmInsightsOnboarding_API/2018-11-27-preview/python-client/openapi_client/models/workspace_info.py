...
class WorkspaceInfo(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Azure Resource Manager identifier of the Log Analytics Workspace.")
    location: StrictStr = Field(description="Location of the Log Analytics workspace.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": WorkspaceInfoProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
