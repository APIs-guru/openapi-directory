...
[**features_list_application_version_pattern_features**](DefaultApi.md#features_list_application_version_pattern_features) | **GET** /apps/{appId}/versions/{versionId}/patterns | 
...
# **features_list_application_version_pattern_features**
> List[PatternFeatureInfo] features_list_application_version_pattern_features(app_id, version_id, skip=skip, take=take)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.features_list_application_version_pattern_features(app_id, version_id, skip=skip, take=take)
        print("The response of DefaultApi->features_list_application_version_pattern_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->features_list_application_version_pattern_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    app_id = 'app_id_example' # str | The application ID.
    version_id = 'version_id_example' # str | The version ID.
    model_create_object = openapi_client.ModelCreateObject() # ModelCreateObject | A model object containing the name for the new simple entity extractor.
 ...
 **app_id** | **str**| The application ID. | 
 **version_id** | **str**| The version ID. | 
 **model_create_object** | [**ModelCreateObject**](ModelCreateObject.md)| A model object containing the name for the new simple entity extractor. | 
