...
class LabelTextObject(BaseModel):
    """
    An object containing the example utterance's text.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the Label.")
    text: Optional[StrictStr] = Field(default=None, description="The text of the label.")
