...
class CompositeEntityModel(BaseModel):
    """
    A composite entity extractor.
    """ # noqa: E501
    children: Optional[List[StrictStr]] = Field(default=None, description="Child entities.")
    name: Optional[StrictStr] = Field(default=None, description="Entity name.")
    __properties: ClassVar[List[str]] = ["children", "name"]
