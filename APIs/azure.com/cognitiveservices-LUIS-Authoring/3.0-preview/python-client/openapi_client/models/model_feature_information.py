...
class ModelFeatureInformation(BaseModel):
    """
    An object containing the model feature information either the model name or feature name.
    """ # noqa: E501
    feature_name: Optional[StrictStr] = Field(default=None, description="The name of the feature used.", alias="featureName")
    model_name: Optional[StrictStr] = Field(default=None, description="The name of the model used.", alias="modelName")
    __properties: ClassVar[List[str]] = ["featureName", "modelName"]
