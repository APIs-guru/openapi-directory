...
class IntentsSuggestionExample(BaseModel):
    """
    ...
    tokenized_text: Optional[List[StrictStr]] = Field(default=None, description="The tokenized utterance.", alias="tokenizedText")
