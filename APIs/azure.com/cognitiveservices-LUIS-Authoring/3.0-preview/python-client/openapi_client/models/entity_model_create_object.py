...
class EntityModelCreateObject(BaseModel):
    """
    An entity extractor create object.
    """ # noqa: E501
    children: Optional[List[ChildEntityModelCreateObject]] = Field(default=None, description="Child entities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": [ChildEntityModelCreateObject.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
            "name": obj.get("name")
        })
        return _obj
