...
class EntityModelUpdateObject(BaseModel):
    """
    An entity extractor update object.
    """ # noqa: E501
    instance_of: Optional[StrictStr] = Field(default=None, description="The instance of model name", alias="instanceOf")
    name: Optional[StrictStr] = Field(default=None, description="Entity name.")
    __properties: ClassVar[List[str]] = ["instanceOf", "name"]
