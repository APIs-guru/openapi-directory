...
class AvailableCulture(BaseModel):
    """
    Available culture for using in a new application.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The ISO value for the language.")
    name: Optional[StrictStr] = Field(default=None, description="The language name.")
