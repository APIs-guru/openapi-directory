...
class InformationProtectionPolicyList(BaseModel):
    """
    ...
    value: Optional[List[InformationProtectionPolicy]] = Field(default=None, description="List of information protection policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [InformationProtectionPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
