# openapi_client.InfrastructureInsightsApi

All URIs are relative to *https://adminmanagement.local.azurestack.external*

Method | HTTP request | Description
------------- | ------------- | -------------
[**operations_list**](InfrastructureInsightsApi.md#operations_list) | **GET** /providers/Microsoft.InfrastructureInsights.Admin/operations | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.InfrastructureInsightsApi(api_client)
    api_version = '2016-05-01' # str | Client API Version. (default to '2016-05-01')

    try:
        api_response = api_instance.operations_list(api_version)
        print("The response of InfrastructureInsightsApi->operations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InfrastructureInsightsApi->operations_list: %s\n" % e)
```
