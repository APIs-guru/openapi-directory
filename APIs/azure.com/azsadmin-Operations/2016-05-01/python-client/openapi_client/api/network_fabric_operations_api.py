...
class NetworkFabricOperationsApi:
    ...
    @validate_call
    def network_fabric_operations_get(
        self,
        ...
        network_operation_result: Annotated[StrictStr, Field(description="Id of a network fabric operation.")],
        ...
        :type provider: str
        :param network_operation_result: Id of a network fabric operation. (required)
        ...
        _param = self._network_fabric_operations_get_serialize(
    ...
    @validate_call
    def network_fabric_operations_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        provider: Annotated[StrictStr, Field(description="Name of the provider.")],
    ...
    @validate_call
    def network_fabric_operations_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        provider: Annotated[StrictStr, Field(description="Name of the provider.")],
    ...
    def _network_fabric_operations_get_serialize(
        self,
        subscription_id,
        location,
        provider,
        ...
        if network_operation_result is not None:
            _path_params['networkOperationResult'] = network_operation_result
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/System.{location}/providers/{provider}/fabricLocations/{location}/networkOperationResults/{networkOperationResult}',
