...
class ComputeFabricOperationsApi:
    ...
    @validate_call
    def compute_fabric_operations_get(
        self,
        ...
        provider: Annotated[StrictStr, Field(description="Name of the provider.")],
        compute_operation_result: Annotated[StrictStr, Field(description="Id of a compute fabric operation.")],
        ...
        :type provider: str
        :param compute_operation_result: Id of a compute fabric operation. (required)
        ...
        _param = self._compute_fabric_operations_get_serialize(
            subscription_id=subscription_id,
            location=location,
            provider=provider,
            compute_operation_result=compute_operation_result,
    ...
    @validate_call
    def compute_fabric_operations_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        provider: Annotated[StrictStr, Field(description="Name of the provider.")],
    ...
    @validate_call
    def compute_fabric_operations_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
        provider: Annotated[StrictStr, Field(description="Name of the provider.")],
    ...
    def _compute_fabric_operations_get_serialize(
        self,
        subscription_id,
        location,
        provider,
        compute_operation_result,
        api_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if compute_operation_result is not None:
            _path_params['computeOperationResult'] = compute_operation_result
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/System.{location}/providers/{provider}/fabricLocations/{location}/computeOperationResults/{computeOperationResult}',
