...
class AzureDataLake(BaseModel):
    ...
    store_name: Optional[StrictStr] = Field(default=None, description="The Azure Data Lake store name", alias="storeName")
    ...
    __properties: ClassVar[List[str]] = ["authorityUrl", "certificate", "clientId", "clientSecret", "isCertAuth", "resourceGroup", "resourceUri", "storeName", "subscriptionId", "tenantId", "thumbprint"]
