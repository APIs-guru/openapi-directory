...
class TestPaginatedDataStoreList(unittest.TestCase):
    """PaginatedDataStoreList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedDataStoreList:
        """Test PaginatedDataStoreList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedDataStoreList`
        """
        model = PaginatedDataStoreList()
        if include_optional:
            return PaginatedDataStoreList(
                continuation_token = '',
                next_link = '',
                value = [
    ...
    def testPaginatedDataStoreList(self):
        """Test PaginatedDataStoreList"""
