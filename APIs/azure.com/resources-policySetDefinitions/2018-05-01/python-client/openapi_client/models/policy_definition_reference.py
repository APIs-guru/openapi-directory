...
class PolicyDefinitionReference(BaseModel):
    ...
    policy_definition_id: Optional[StrictStr] = Field(default=None, description="The ID of the policy definition or policy set definition.", alias="policyDefinitionId")
    __properties: ClassVar[List[str]] = ["parameters", "policyDefinitionId"]
