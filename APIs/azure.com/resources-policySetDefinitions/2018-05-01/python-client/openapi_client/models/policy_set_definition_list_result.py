...
class PolicySetDefinitionListResult(BaseModel):
    """
    ...
    value: Optional[List[PolicySetDefinition]] = Field(default=None, description="An array of policy set definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicySetDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
