...
class TestPolicySetDefinition(unittest.TestCase):
    """PolicySetDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicySetDefinition:
        """Test PolicySetDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicySetDefinition`
        """
    ...
    def testPolicySetDefinition(self):
        """Test PolicySetDefinition"""
