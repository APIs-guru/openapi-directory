...
> ContainerHostMapping container_host_mappings_get_container_host_mapping(api_version, subscription_id, resource_group_name, location, container_host_mapping)
