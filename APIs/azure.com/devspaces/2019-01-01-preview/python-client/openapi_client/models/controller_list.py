...
class ControllerList(BaseModel):
    ...
    ControllerList
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI that can be used to request the next page for list of Azure Dev Spaces Controllers.", alias="nextLink")
    value: Optional[List[Controller]] = Field(default=None, description="List of Azure Dev Spaces Controllers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Controller.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
