...
class BlobServiceItems(BaseModel):
    """
    BlobServiceItems
    """ # noqa: E501
    value: Optional[List[BlobServiceProperties]] = Field(default=None, description="List of blob services returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BlobServiceProperties.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
