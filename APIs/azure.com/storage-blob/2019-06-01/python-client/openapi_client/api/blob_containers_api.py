...
class BlobContainersApi:
    ...
    def blob_containers_list(
        ...
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        maxpagesize: Annotated[Optional[StrictStr], Field(description="Optional. Specified maximum number of containers that can be included in the list.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Optional. When specified, only container names starting with the filter will be listed.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
