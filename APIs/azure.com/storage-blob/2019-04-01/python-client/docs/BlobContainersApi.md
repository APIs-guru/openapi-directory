...
> ListContainerItems blob_containers_list(resource_group_name, account_name, api_version, subscription_id, skip_token=skip_token, maxpagesize=maxpagesize, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    skip_token = 'skip_token_example' # str | Optional. Continuation token for the list operation. (optional)
    ...
    try:
        api_response = api_instance.blob_containers_list(resource_group_name, account_name, api_version, subscription_id, skip_token=skip_token, maxpagesize=maxpagesize, filter=filter)
 ...
 **api_version** | **str**| The API version to use for this operation. | 
 **subscription_id** | **str**| The ID of the target subscription. | 
 **skip_token** | **str**| Optional. Continuation token for the list operation. | [optional] 
