...
> ListContainerItems blob_containers_list(resource_group_name, account_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.blob_containers_list(resource_group_name, account_name, api_version, subscription_id)
