...
------------ | ------------- | ------------- | -------------
*SubscriptionsApi* | [**subscriptions_list_quotas**](docs/SubscriptionsApi.md#subscriptions_list_quotas) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.StreamAnalytics/locations/{location}/quotas | 
...
## Documentation For Models
 ...
 - [SubscriptionQuotasListResult](docs/SubscriptionQuotasListResult.md)
