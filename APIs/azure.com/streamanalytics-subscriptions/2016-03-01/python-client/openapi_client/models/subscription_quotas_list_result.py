...
class SubscriptionQuotasListResult(BaseModel):
    """
    Result of the GetQuotas operation. It contains a list of quotas for the subscription in a particular region.
    """ # noqa: E501
    value: Optional[List[SubscriptionQuota]] = Field(default=None, description="List of quotas for the subscription in a particular region.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SubscriptionQuota.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
