...
class MetricDefinitionsApi:
    ...
    def metric_definitions_list(
        ...
        _param = self._metric_definitions_list_serialize(
    ...
    @validate_call
    def metric_definitions_list_with_http_info(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
    ...
    @validate_call
    def metric_definitions_list_without_preload_content(
        self,
        resource_uri: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
    ...
    def _metric_definitions_list_serialize(
        self,
        resource_uri,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{resourceUri}/providers/microsoft.insights/metricDefinitions',
