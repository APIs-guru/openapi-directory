...
class MetricDefinition(BaseModel):
    ...
    """ # noqa: E501
    dimensions: Optional[List[LocalizableString]] = Field(default=None, description="the name and the display name of the dimension, i.e. it is a localizable string.")
    id: Optional[StrictStr] = Field(default=None, description="the resource identifier of the metric definition.")
    is_dimension_required: Optional[StrictBool] = Field(default=None, description="Flag to indicate whether the dimension is required.", alias="isDimensionRequired")
    ...
    namespace: Optional[StrictStr] = Field(default=None, description="the namespace the metric belongs to.")
    primary_aggregation_type: Optional[AggregationType] = Field(default=None, alias="primaryAggregationType")
    ...
    supported_aggregation_types: Optional[List[AggregationType]] = Field(default=None, description="the collection of what aggregation types are supported.", alias="supportedAggregationTypes")
    unit: Optional[Unit] = None
    __properties: ClassVar[List[str]] = ["dimensions", "id", "isDimensionRequired", "metricAvailabilities", "name", "namespace", "primaryAggregationType", "resourceId", "supportedAggregationTypes", "unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dimensions": [LocalizableString.from_dict(_item) for _item in obj["dimensions"]] if obj.get("dimensions") is not None else None,
            "id": obj.get("id"),
            "isDimensionRequired": obj.get("isDimensionRequired"),
