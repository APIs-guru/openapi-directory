...
> MetricDefinitionCollection metric_definitions_list(resource_uri, api_version, metricnamespace=metricnamespace)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.metric_definitions_list(resource_uri, api_version, metricnamespace=metricnamespace)
