...
class FlaggedEnrolledAppProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deviceType", "errors", "friendlyName", "lastModifiedTime", "platform"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [FlaggedEnrolledAppError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
