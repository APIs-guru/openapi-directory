...
class MAMPolicyAppIdOrGroupIdPayload(BaseModel):
    """
    MAM Policy request body for properties Intune MAM.
    """ # noqa: E501
    properties: Optional[MAMPolicyAppOrGroupIdProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": MAMPolicyAppOrGroupIdProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
