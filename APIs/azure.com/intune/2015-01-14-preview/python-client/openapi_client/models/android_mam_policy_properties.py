...
class AndroidMAMPolicyProperties(BaseModel):
    """
    Intune MAM iOS Policy Properties.
    """ # noqa: E501
    file_encryption: Optional[StrictStr] = Field(default='required', alias="fileEncryption")
    screen_capture: Optional[StrictStr] = Field(default='allow', alias="screenCapture")
    ...
    @field_validator('file_encryption')
    def file_encryption_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def screen_capture_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
