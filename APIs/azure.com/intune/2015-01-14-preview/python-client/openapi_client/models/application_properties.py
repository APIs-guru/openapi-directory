...
class ApplicationProperties(BaseModel):
    ...
    platform: StrictStr
    __properties: ClassVar[List[str]] = ["appId", "friendlyName", "platform"]

    @field_validator('platform')
    def platform_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ios', 'android', 'windows']):
            raise ValueError("must be one of enum values ('ios', 'android', 'windows')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "platform": obj.get("platform") if obj.get("platform") is not None else 'ios'
        })
        return _obj
