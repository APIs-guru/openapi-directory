...
class TestIOSMAMPolicyProperties(unittest.TestCase):
    """IOSMAMPolicyProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOSMAMPolicyProperties:
        """Test IOSMAMPolicyProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOSMAMPolicyProperties`
        """
        model = IOSMAMPolicyProperties()
        if include_optional:
            return IOSMAMPolicyProperties(
    ...
    def testIOSMAMPolicyProperties(self):
        """Test IOSMAMPolicyProperties"""
