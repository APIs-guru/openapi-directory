...
class TestMAMPolicyProperties(unittest.TestCase):
    """MAMPolicyProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MAMPolicyProperties:
        """Test MAMPolicyProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MAMPolicyProperties`
        """
        model = MAMPolicyProperties()
        if include_optional:
            return MAMPolicyProperties(
    ...
    def testMAMPolicyProperties(self):
        """Test MAMPolicyProperties"""
