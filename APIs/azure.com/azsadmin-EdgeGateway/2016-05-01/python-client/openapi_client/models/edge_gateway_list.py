...
class EdgeGatewayList(BaseModel):
    """
    ...
    value: Optional[List[EdgeGateway]] = Field(default=None, description="List of edge gateways.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EdgeGateway.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
