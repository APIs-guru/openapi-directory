...
------------ | ------------- | ------------- | -------------
*EdgeGatewaysApi* | [**edge_gateways_get**](docs/EdgeGatewaysApi.md#edge_gateways_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGateways/{edgeGateway} | 
*EdgeGatewaysApi* | [**edge_gateways_list**](docs/EdgeGatewaysApi.md#edge_gateways_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGateways | 


## Documentation For Models

 - [EdgeGateway](docs/EdgeGateway.md)
 - [EdgeGatewayList](docs/EdgeGatewayList.md)
 - [EdgeGatewayModel](docs/EdgeGatewayModel.md)
