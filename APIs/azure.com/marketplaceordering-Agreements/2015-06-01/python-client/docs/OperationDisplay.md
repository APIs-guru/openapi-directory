...
------------ | ------------- | ------------- | -------------
**operation** | **str** | Operation type: Get Agreement, Sign Agreement, Cancel Agreement etc. | [optional] 
**provider** | **str** | Service provider: Microsoft.MarketplaceOrdering | [optional] 
**resource** | **str** | Resource on which the operation is performed: Agreement, virtualmachine, etc. | [optional] 
