...
class ThroughputProperties(BaseModel):
    """
    The properties of an Azure Cosmos DB resource throughput
    """ # noqa: E501
    throughput: StrictInt = Field(description="Value of the Cosmos DB resource throughput")
    __properties: ClassVar[List[str]] = ["throughput"]
