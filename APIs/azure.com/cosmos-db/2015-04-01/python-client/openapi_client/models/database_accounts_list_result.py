...
class DatabaseAccountsListResult(BaseModel):
    """
    The List operation response, that contains the database accounts and their properties.
    """ # noqa: E501
    value: Optional[List[DatabaseAccount]] = Field(default=None, description="List of database account and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabaseAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
