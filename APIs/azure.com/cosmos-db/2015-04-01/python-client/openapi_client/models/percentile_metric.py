...
class PercentileMetric(BaseModel):
    ...
    metric_values: Optional[List[PercentileMetricValue]] = Field(default=None, description="The percentile metric values for the specified time window and timestep.", alias="metricValues")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricValues": [PercentileMetricValue.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None,
