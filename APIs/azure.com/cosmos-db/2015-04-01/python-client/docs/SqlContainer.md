...
sql_container_instance = SqlContainer.from_json(json)
# print the JSON string representation of the object
print(SqlContainer.to_json())

# convert the object into a dict
sql_container_dict = sql_container_instance.to_dict()
# create an instance of SqlContainer from a dict
sql_container_from_dict = SqlContainer.from_dict(sql_container_dict)
```
