...
class FailoverPolicy(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the region in which the database account replicates to. Example: &lt;accountName&gt;-&lt;locationName&gt;.")
    location_name: Optional[StrictStr] = Field(default=None, description="The name of the region in which the database account exists.", alias="locationName")
    __properties: ClassVar[List[str]] = ["failoverPriority", "id", "locationName"]
