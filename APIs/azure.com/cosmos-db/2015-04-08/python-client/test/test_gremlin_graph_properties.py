...
class TestGremlinGraphProperties(unittest.TestCase):
    """GremlinGraphProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GremlinGraphProperties:
        """Test GremlinGraphProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GremlinGraphProperties`
        """
        model = GremlinGraphProperties()
        if include_optional:
            return GremlinGraphProperties(
    ...
    def testGremlinGraphProperties(self):
        """Test GremlinGraphProperties"""
