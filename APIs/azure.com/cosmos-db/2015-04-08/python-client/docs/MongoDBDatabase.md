...
json = "{}"
# create an instance of MongoDBDatabase from a JSON string
mongo_db_database_instance = MongoDBDatabase.from_json(json)
# print the JSON string representation of the object
print(MongoDBDatabase.to_json())

# convert the object into a dict
mongo_db_database_dict = mongo_db_database_instance.to_dict()
# create an instance of MongoDBDatabase from a dict
mongo_db_database_from_dict = MongoDBDatabase.from_dict(mongo_db_database_dict)
```
