...
class TestDatabaseAccountGetProperties(unittest.TestCase):
    """DatabaseAccountGetProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabaseAccountGetProperties:
        """Test DatabaseAccountGetProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabaseAccountGetProperties`
        """
        model = DatabaseAccountGetProperties()
        if include_optional:
            return DatabaseAccountGetProperties(
                capabilities = [
    ...
    def testDatabaseAccountGetProperties(self):
        """Test DatabaseAccountGetProperties"""
