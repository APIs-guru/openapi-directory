...
------------ | ------------- | ------------- | -------------
**properties** | [**SqlTriggerGetProperties**](SqlTriggerGetProperties.md) |  | [optional] 
...
json = "{}"
# create an instance of SqlTriggerGetResults from a JSON string
sql_trigger_get_results_instance = SqlTriggerGetResults.from_json(json)
# print the JSON string representation of the object
print(SqlTriggerGetResults.to_json())

# convert the object into a dict
sql_trigger_get_results_dict = sql_trigger_get_results_instance.to_dict()
# create an instance of SqlTriggerGetResults from a dict
sql_trigger_get_results_from_dict = SqlTriggerGetResults.from_dict(sql_trigger_get_results_dict)
```
