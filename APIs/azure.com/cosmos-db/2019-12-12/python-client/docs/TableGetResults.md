...
------------ | ------------- | ------------- | -------------
**properties** | [**TableGetProperties**](TableGetProperties.md) |  | [optional] 
...
json = "{}"
# create an instance of TableGetResults from a JSON string
table_get_results_instance = TableGetResults.from_json(json)
# print the JSON string representation of the object
print(TableGetResults.to_json())

# convert the object into a dict
table_get_results_dict = table_get_results_instance.to_dict()
# create an instance of TableGetResults from a dict
table_get_results_from_dict = TableGetResults.from_dict(table_get_results_dict)
```
