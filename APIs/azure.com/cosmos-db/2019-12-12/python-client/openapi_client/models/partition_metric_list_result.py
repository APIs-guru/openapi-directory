...
class PartitionMetricListResult(BaseModel):
    """
    The response to a list partition metrics request.
    """ # noqa: E501
    value: Optional[List[PartitionMetric]] = Field(default=None, description="The list of partition-level metrics for the account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PartitionMetric.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
