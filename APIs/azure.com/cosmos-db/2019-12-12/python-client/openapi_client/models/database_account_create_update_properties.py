...
class DatabaseAccountCreateUpdateProperties(BaseModel):
    """
    ...
    database_account_offer_type: DatabaseAccountOfferType = Field(alias="databaseAccountOfferType")
    ...
    locations: List[Location] = Field(description="An array that contains the georeplication locations enabled for the Cosmos DB account.")
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "connectorOffer", "consistencyPolicy", "databaseAccountOfferType", "disableKeyBasedMetadataWriteAccess", "enableAutomaticFailover", "enableCassandraConnector", "enableMultipleWriteLocations", "ipRangeFilter", "isVirtualNetworkFilterEnabled", "keyVaultKeyUri", "locations", "virtualNetworkRules"]
