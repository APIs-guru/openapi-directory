...
class CassandraTableGetProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": CassandraTableGetPropertiesResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
