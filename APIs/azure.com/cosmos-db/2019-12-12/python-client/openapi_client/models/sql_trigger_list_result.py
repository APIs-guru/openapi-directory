...
class SqlTriggerListResult(BaseModel):
    """
    The List operation response, that contains the triggers and their properties.
    """ # noqa: E501
    value: Optional[List[SqlTriggerGetResults]] = Field(default=None, description="List of triggers and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SqlTriggerGetResults.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
