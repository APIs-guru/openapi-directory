...
class PercentileMetricListResult(BaseModel):
    """
    The response to a list percentile metrics request.
    """ # noqa: E501
    value: Optional[List[PercentileMetric]] = Field(default=None, description="The list of percentile metrics for the account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PercentileMetric.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
