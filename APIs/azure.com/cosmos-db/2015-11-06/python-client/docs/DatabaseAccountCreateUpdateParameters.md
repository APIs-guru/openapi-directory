...
database_account_create_update_parameters_instance = DatabaseAccountCreateUpdateParameters.from_json(json)
# print the JSON string representation of the object
print(DatabaseAccountCreateUpdateParameters.to_json())

# convert the object into a dict
database_account_create_update_parameters_dict = database_account_create_update_parameters_instance.to_dict()
# create an instance of DatabaseAccountCreateUpdateParameters from a dict
database_account_create_update_parameters_from_dict = DatabaseAccountCreateUpdateParameters.from_dict(database_account_create_update_parameters_dict)
```
