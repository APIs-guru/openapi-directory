...
mongo_db_collection_instance = MongoDBCollection.from_json(json)
# print the JSON string representation of the object
print(MongoDBCollection.to_json())

# convert the object into a dict
mongo_db_collection_dict = mongo_db_collection_instance.to_dict()
# create an instance of MongoDBCollection from a dict
mongo_db_collection_from_dict = MongoDBCollection.from_dict(mongo_db_collection_dict)
```
