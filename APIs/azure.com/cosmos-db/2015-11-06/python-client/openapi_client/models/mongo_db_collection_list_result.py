...
class MongoDBCollectionListResult(BaseModel):
    """
    The List operation response, that contains the MongoDB collections and their properties.
    """ # noqa: E501
    value: Optional[List[MongoDBCollection]] = Field(default=None, description="List of MongoDB collections and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MongoDBCollection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
