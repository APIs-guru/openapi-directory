...
class MongoDBDatabaseListResult(BaseModel):
    """
    The List operation response, that contains the MongoDB databases and their properties.
    """ # noqa: E501
    value: Optional[List[MongoDBDatabase]] = Field(default=None, description="List of MongoDB databases and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MongoDBDatabase.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
