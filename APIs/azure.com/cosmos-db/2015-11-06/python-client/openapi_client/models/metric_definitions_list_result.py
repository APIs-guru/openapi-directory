...
class MetricDefinitionsListResult(BaseModel):
    """
    The response to a list metric definitions request.
    """ # noqa: E501
    value: Optional[List[MetricDefinition]] = Field(default=None, description="The list of metric definitions for the account.")
