...
class TestGremlinGraphCreateUpdateParameters(unittest.TestCase):
    """GremlinGraphCreateUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GremlinGraphCreateUpdateParameters:
        """Test GremlinGraphCreateUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GremlinGraphCreateUpdateParameters`
        """
        model = GremlinGraphCreateUpdateParameters()
        if include_optional:
            return GremlinGraphCreateUpdateParameters(
                properties = openapi_client.models.gremlin_graph_create_update_properties.GremlinGraphCreateUpdateProperties(
                    options = {
                        'key' : ''
                        }, 
                    resource = openapi_client.models.gremlin_graph_resource.GremlinGraphResource(
    ...
    def testGremlinGraphCreateUpdateParameters(self):
        """Test GremlinGraphCreateUpdateParameters"""
