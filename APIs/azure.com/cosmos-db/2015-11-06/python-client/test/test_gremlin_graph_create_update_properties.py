...
class TestGremlinGraphCreateUpdateProperties(unittest.TestCase):
    """GremlinGraphCreateUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GremlinGraphCreateUpdateProperties:
        """Test GremlinGraphCreateUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GremlinGraphCreateUpdateProperties`
        """
        model = GremlinGraphCreateUpdateProperties()
        if include_optional:
            return GremlinGraphCreateUpdateProperties(
                options = {
                    'key' : ''
                    },
    ...
    def testGremlinGraphCreateUpdateProperties(self):
        """Test GremlinGraphCreateUpdateProperties"""
