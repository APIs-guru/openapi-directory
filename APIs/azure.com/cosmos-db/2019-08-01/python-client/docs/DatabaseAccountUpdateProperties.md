...
database_account_update_properties_instance = DatabaseAccountUpdateProperties.from_json(json)
# print the JSON string representation of the object
print(DatabaseAccountUpdateProperties.to_json())

# convert the object into a dict
database_account_update_properties_dict = database_account_update_properties_instance.to_dict()
# create an instance of DatabaseAccountUpdateProperties from a dict
database_account_update_properties_from_dict = DatabaseAccountUpdateProperties.from_dict(database_account_update_properties_dict)
```
