...
database_account_get_results_instance = DatabaseAccountGetResults.from_json(json)
# print the JSON string representation of the object
print(DatabaseAccountGetResults.to_json())

# convert the object into a dict
database_account_get_results_dict = database_account_get_results_instance.to_dict()
# create an instance of DatabaseAccountGetResults from a dict
database_account_get_results_from_dict = DatabaseAccountGetResults.from_dict(database_account_get_results_dict)
```
