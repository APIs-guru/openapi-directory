...
**composite_indexes** | **List[List[CompositePath]]** | List of composite path list | [optional] 
...
**spatial_indexes** | [**List[SpatialSpec]**](SpatialSpec.md) | List of spatial specifics | [optional] 
