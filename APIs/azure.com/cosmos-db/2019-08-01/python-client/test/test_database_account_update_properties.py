...
class TestDatabaseAccountUpdateProperties(unittest.TestCase):
    """DatabaseAccountUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabaseAccountUpdateProperties:
        """Test DatabaseAccountUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabaseAccountUpdateProperties`
        """
        model = DatabaseAccountUpdateProperties()
        if include_optional:
    ...
    def testDatabaseAccountUpdateProperties(self):
        """Test DatabaseAccountUpdateProperties"""
