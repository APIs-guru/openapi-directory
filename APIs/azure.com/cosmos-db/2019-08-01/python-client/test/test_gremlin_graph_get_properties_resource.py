...
class TestGremlinGraphGetPropertiesResource(unittest.TestCase):
    """GremlinGraphGetPropertiesResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GremlinGraphGetPropertiesResource:
        """Test GremlinGraphGetPropertiesResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GremlinGraphGetPropertiesResource`
        """
    ...
    def testGremlinGraphGetPropertiesResource(self):
        """Test GremlinGraphGetPropertiesResource"""
