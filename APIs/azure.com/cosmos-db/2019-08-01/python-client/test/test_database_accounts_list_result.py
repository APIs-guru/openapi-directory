...
class TestDatabaseAccountsListResult(unittest.TestCase):
    """DatabaseAccountsListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabaseAccountsListResult:
        """Test DatabaseAccountsListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabaseAccountsListResult`
        """
        model = DatabaseAccountsListResult()
        if include_optional:
            return DatabaseAccountsListResult(
                value = [
                    openapi_client.models.database_account_get_results.DatabaseAccountGetResults(
                        kind = 'GlobalDocumentDB', 
                        properties = openapi_client.models.database_account_get_properties.DatabaseAccountGetProperties(
                            capabilities = [
    ...
    def testDatabaseAccountsListResult(self):
        """Test DatabaseAccountsListResult"""
