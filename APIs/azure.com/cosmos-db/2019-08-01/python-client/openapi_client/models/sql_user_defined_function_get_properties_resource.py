...
class SqlUserDefinedFunctionGetPropertiesResource(BaseModel):
    """
    SqlUserDefinedFunctionGetPropertiesResource
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Body of the User Defined Function")
    id: StrictStr = Field(description="Name of the Cosmos DB SQL userDefinedFunction")
