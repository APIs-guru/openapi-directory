...
class PartitionUsagesResult(BaseModel):
    """
    The response to a list partition level usage request.
    """ # noqa: E501
    value: Optional[List[PartitionUsage]] = Field(default=None, description="The list of partition-level usages for the database. A usage is a point in time metric")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PartitionUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
