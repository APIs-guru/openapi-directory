...
class FailoverPolicies(BaseModel):
    """
    The list of new failover policies for the failover priority change.
    """ # noqa: E501
    failover_policies: List[FailoverPolicy] = Field(description="List of failover policies.", alias="failoverPolicies")
    __properties: ClassVar[List[str]] = ["failoverPolicies"]
