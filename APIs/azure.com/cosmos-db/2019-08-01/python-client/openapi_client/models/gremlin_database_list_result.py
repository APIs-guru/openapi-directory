...
class GremlinDatabaseListResult(BaseModel):
    """
    The List operation response, that contains the Gremlin databases and their properties.
    """ # noqa: E501
    value: Optional[List[GremlinDatabaseGetResults]] = Field(default=None, description="List of Gremlin databases and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GremlinDatabaseGetResults.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
