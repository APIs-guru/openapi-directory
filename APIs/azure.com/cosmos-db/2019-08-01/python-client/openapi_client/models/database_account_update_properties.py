...
class DatabaseAccountUpdateProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "connectorOffer", "consistencyPolicy", "disableKeyBasedMetadataWriteAccess", "enableAutomaticFailover", "enableCassandraConnector", "enableMultipleWriteLocations", "ipRangeFilter", "isVirtualNetworkFilterEnabled", "locations", "virtualNetworkRules"]
