...
class SqlStoredProcedureListResult(BaseModel):
    """
    The List operation response, that contains the storedProcedures and their properties.
    """ # noqa: E501
    value: Optional[List[SqlStoredProcedureGetResults]] = Field(default=None, description="List of storedProcedures and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SqlStoredProcedureGetResults.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
