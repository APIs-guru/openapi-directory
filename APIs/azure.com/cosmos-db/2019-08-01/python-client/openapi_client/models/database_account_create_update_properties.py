...
class DatabaseAccountCreateUpdateProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "connectorOffer", "consistencyPolicy", "databaseAccountOfferType", "disableKeyBasedMetadataWriteAccess", "enableAutomaticFailover", "enableCassandraConnector", "enableMultipleWriteLocations", "ipRangeFilter", "isVirtualNetworkFilterEnabled", "locations", "virtualNetworkRules"]
