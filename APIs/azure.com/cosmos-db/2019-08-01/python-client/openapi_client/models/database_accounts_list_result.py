...
class DatabaseAccountsListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[DatabaseAccountGetResults]] = Field(default=None, description="List of database account and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabaseAccountGetResults.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
