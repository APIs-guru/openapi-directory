...
class TestSqlContainerCreateUpdateParameters(unittest.TestCase):
    """SqlContainerCreateUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SqlContainerCreateUpdateParameters:
        """Test SqlContainerCreateUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SqlContainerCreateUpdateParameters`
        """
        model = SqlContainerCreateUpdateParameters()
        if include_optional:
            return SqlContainerCreateUpdateParameters(
                properties = openapi_client.models.sql_container_create_update_properties.SqlContainerCreateUpdateProperties(
                    options = {
                        'key' : ''
                        }, 
    ...
    def testSqlContainerCreateUpdateParameters(self):
        """Test SqlContainerCreateUpdateParameters"""
