...
class CassandraKeyspaceListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[CassandraKeyspace]] = Field(default=None, description="List of Cassandra keyspaces and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CassandraKeyspace.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
