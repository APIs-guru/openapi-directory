...
class SqlContainerListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[SqlContainer]] = Field(default=None, description="List of containers and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SqlContainer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
