...
class DatabaseAccountProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "connectorOffer", "consistencyPolicy", "databaseAccountOfferType", "documentEndpoint", "enableAutomaticFailover", "enableCassandraConnector", "enableMultipleWriteLocations", "failoverPolicies", "ipRangeFilter", "isVirtualNetworkFilterEnabled", "provisioningState", "readLocations", "virtualNetworkRules", "writeLocations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatabaseAccountProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatabaseAccountProperties from a dict"""
        if obj is None:
            return None
