...
json = "{}"
# create an instance of GremlinGraph from a JSON string
gremlin_graph_instance = GremlinGraph.from_json(json)
# print the JSON string representation of the object
print(GremlinGraph.to_json())

# convert the object into a dict
gremlin_graph_dict = gremlin_graph_instance.to_dict()
# create an instance of GremlinGraph from a dict
gremlin_graph_from_dict = GremlinGraph.from_dict(gremlin_graph_dict)
```
