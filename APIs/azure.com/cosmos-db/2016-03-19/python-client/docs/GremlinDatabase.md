...
gremlin_database_instance = GremlinDatabase.from_json(json)
# print the JSON string representation of the object
print(GremlinDatabase.to_json())

# convert the object into a dict
gremlin_database_dict = gremlin_database_instance.to_dict()
# create an instance of GremlinDatabase from a dict
gremlin_database_from_dict = GremlinDatabase.from_dict(gremlin_database_dict)
```
