...
database_account_properties_instance = DatabaseAccountProperties.from_json(json)
# print the JSON string representation of the object
print(DatabaseAccountProperties.to_json())

# convert the object into a dict
database_account_properties_dict = database_account_properties_instance.to_dict()
# create an instance of DatabaseAccountProperties from a dict
database_account_properties_from_dict = DatabaseAccountProperties.from_dict(database_account_properties_dict)
```
