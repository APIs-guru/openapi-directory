...
class TestSqlContainerResource(unittest.TestCase):
    """SqlContainerResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SqlContainerResource:
        """Test SqlContainerResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SqlContainerResource`
        """
    ...
    def testSqlContainerResource(self):
        """Test SqlContainerResource"""
