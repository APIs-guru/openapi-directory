...
class SnapshotProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creationData", "diskSizeBytes", "diskSizeGB", "encryptionSettingsCollection", "hyperVGeneration", "incremental", "osType", "provisioningState", "timeCreated", "uniqueId"]
