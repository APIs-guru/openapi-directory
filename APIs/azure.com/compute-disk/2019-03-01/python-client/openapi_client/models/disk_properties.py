...
class DiskProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creationData", "diskIOPSReadWrite", "diskMBpsReadWrite", "diskSizeBytes", "diskSizeGB", "diskState", "encryptionSettingsCollection", "hyperVGeneration", "osType", "provisioningState", "timeCreated", "uniqueId"]
