...
------------ | ------------- | ------------- | -------------
**managed_by** | **str** | A relative URI containing the ID of the VM that has the disk attached. | [optional] [readonly] 
**properties** | [**DiskProperties**](DiskProperties.md) |  | [optional] 
**sku** | [**DiskSku**](DiskSku.md) |  | [optional] 
**zones** | **List[str]** | The Logical zone list for Disk. | [optional] 
