...
# **snapshots_delete**
> OperationStatusResponse snapshots_delete(subscription_id, resource_group_name, snapshot_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.snapshots_delete(subscription_id, resource_group_name, snapshot_name, api_version)
        print("The response of SnapshotsApi->snapshots_delete:\n")
        pprint(api_response)
    except Exception as e:
...
> OperationStatusResponse snapshots_revoke_access(subscription_id, resource_group_name, snapshot_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.snapshots_revoke_access(subscription_id, resource_group_name, snapshot_name, api_version)
        print("The response of SnapshotsApi->snapshots_revoke_access:\n")
        pprint(api_response)
    except Exception as e:
