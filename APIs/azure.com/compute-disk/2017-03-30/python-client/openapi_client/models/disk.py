...
class Disk(BaseModel):
    ...
    Disk resource.
    """ # noqa: E501
    managed_by: Optional[StrictStr] = Field(default=None, description="A relative URI containing the ID of the VM that has the disk attached.", alias="managedBy")
    properties: Optional[DiskProperties] = None
    sku: Optional[DiskSku] = None
    zones: Optional[List[StrictStr]] = Field(default=None, description="The Logical zone list for Disk.")
