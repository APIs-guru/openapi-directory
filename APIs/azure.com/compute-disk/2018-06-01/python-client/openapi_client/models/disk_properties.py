...
class DiskProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creationData", "diskIOPSReadWrite", "diskMBpsReadWrite", "diskSizeGB", "encryptionSettings", "osType", "provisioningState", "timeCreated"]
