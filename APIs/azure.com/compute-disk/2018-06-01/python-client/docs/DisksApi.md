...
# **disks_delete**
> disks_delete(subscription_id, resource_group_name, disk_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.disks_delete(subscription_id, resource_group_name, disk_name, api_version)
    except Exception as e:
...
# **disks_revoke_access**
> disks_revoke_access(subscription_id, resource_group_name, disk_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.disks_revoke_access(subscription_id, resource_group_name, disk_name, api_version)
    except Exception as e:
