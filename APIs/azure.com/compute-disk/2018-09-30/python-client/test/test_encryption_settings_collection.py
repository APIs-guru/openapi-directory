...
class TestEncryptionSettingsCollection(unittest.TestCase):
    """EncryptionSettingsCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptionSettingsCollection:
        """Test EncryptionSettingsCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptionSettingsCollection`
        """
    ...
    def testEncryptionSettingsCollection(self):
        """Test EncryptionSettingsCollection"""
