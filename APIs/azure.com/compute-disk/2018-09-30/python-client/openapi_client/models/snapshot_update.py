...
class SnapshotUpdate(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[SnapshotUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": SnapshotUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": SnapshotSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
