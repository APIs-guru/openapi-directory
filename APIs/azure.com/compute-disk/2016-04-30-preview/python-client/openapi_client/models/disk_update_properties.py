...
class DiskUpdateProperties(BaseModel):
    """
    Disk resource update properties.
    """ # noqa: E501
    account_type: Optional[StrictStr] = Field(default=None, description="the storage account type of the disk.", alias="accountType")
    creation_data: Optional[CreationData] = Field(default=None, alias="creationData")
    ...
    __properties: ClassVar[List[str]] = ["accountType", "creationData", "diskSizeGB", "encryptionSettings", "osType"]
