...
class CreationData(BaseModel):
    ...
    source_resource_id: Optional[StrictStr] = Field(default=None, description="If createOption is Copy, this is the ARM id of the source snapshot or disk. If createOption is Restore, this is the ARM-like id of the source disk restore point.", alias="sourceResourceId")
    source_uri: Optional[StrictStr] = Field(default=None, description="If createOption is Import, this is a SAS URI to a blob to be imported into a managed disk. If createOption is Copy, this is a relative Uri containing the id of the source snapshot to be copied into a managed disk.", alias="sourceUri")
