...
class AccessUriRaw(BaseModel):
    """
    This object gets 'bubbled up' through flattening.
    """ # noqa: E501
    access_sas: Optional[StrictStr] = Field(default=None, description="A SAS uri for accessing a disk.", alias="accessSAS")
    __properties: ClassVar[List[str]] = ["accessSAS"]
