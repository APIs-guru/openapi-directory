...
class DiskProperties(BaseModel):
    ...
    owner_id: Optional[StrictStr] = Field(default=None, description="A relative URI containing the VM id that has the disk attached.", alias="ownerId")
    ...
    __properties: ClassVar[List[str]] = ["accountType", "creationData", "diskSizeGB", "encryptionSettings", "osType", "ownerId", "provisioningState", "timeCreated"]
