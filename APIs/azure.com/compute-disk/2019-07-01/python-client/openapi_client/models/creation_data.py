...
class CreationData(BaseModel):
    ...
    source_unique_id: Optional[StrictStr] = Field(default=None, description="If this field is set, this is the unique id identifying the source of this resource.", alias="sourceUniqueId")
    ...
    storage_account_id: Optional[StrictStr] = Field(default=None, description="Required if createOption is Import. The Azure Resource Manager identifier of the storage account containing the blob to import as a disk.", alias="storageAccountId")
    upload_size_bytes: Optional[StrictInt] = Field(default=None, description="If createOption is Upload, this is the size of the contents of the upload including the VHD footer. This value should be between 20972032 (20 MiB + 512 bytes for the VHD footer) and 35183298347520 bytes (32 TiB + 512 bytes for the VHD footer).", alias="uploadSizeBytes")
    __properties: ClassVar[List[str]] = ["createOption", "imageReference", "sourceResourceId", "sourceUniqueId", "sourceUri", "storageAccountId", "uploadSizeBytes"]

    @field_validator('create_option')
    def create_option_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Empty', 'Attach', 'FromImage', 'Import', 'Copy', 'Restore', 'Upload']):
            raise ValueError("must be one of enum values ('Empty', 'Attach', 'FromImage', 'Import', 'Copy', 'Restore', 'Upload')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourceUniqueId": obj.get("sourceUniqueId"),
