...
class DiskEncryptionSetUpdate(BaseModel):
    """
    disk encryption set update resource.
    """ # noqa: E501
    properties: Optional[DiskEncryptionSetUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DiskEncryptionSetUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
