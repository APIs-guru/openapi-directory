...
class DiskList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of disks. Call ListNext() with this to fetch the next page of disks.", alias="nextLink")
    value: List[Disk] = Field(description="A list of disks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Disk.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
