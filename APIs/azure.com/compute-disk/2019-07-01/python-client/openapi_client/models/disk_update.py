...
class DiskUpdate(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[DiskUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DiskUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": DiskSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
