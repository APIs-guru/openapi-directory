...
class TestEncryptionSetProperties(unittest.TestCase):
    """EncryptionSetProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptionSetProperties:
        """Test EncryptionSetProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptionSetProperties`
        """
    ...
    def testEncryptionSetProperties(self):
        """Test EncryptionSetProperties"""
