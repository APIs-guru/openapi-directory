...
class TestSnapshotUpdateProperties(unittest.TestCase):
    """SnapshotUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotUpdateProperties:
        """Test SnapshotUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotUpdateProperties`
        """
    ...
    def testSnapshotUpdateProperties(self):
        """Test SnapshotUpdateProperties"""
