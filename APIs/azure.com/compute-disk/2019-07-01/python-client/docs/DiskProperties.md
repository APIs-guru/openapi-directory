...
**disk_size_bytes** | **int** | The size of the disk in bytes. This field is read only. | [optional] [readonly] 
...
**unique_id** | **str** | Unique Guid identifying the resource. | [optional] [readonly] 
