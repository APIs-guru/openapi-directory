...
class ClusterListResult(BaseModel):
    """
    ...
    value: Optional[List[Cluster]] = Field(default=None, description="A list of Log Analytics clusters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Cluster.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
