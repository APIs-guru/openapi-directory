...
class PasswordHashSyncConfiguration(BaseModel):
    """
    The password has synchronization configuration settings.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the password hash synchronization configuration settings is enabled.")
    target: Optional[StrictStr] = Field(default=None, description="The target.")
    __properties: ClassVar[List[str]] = ["enabled", "target"]
