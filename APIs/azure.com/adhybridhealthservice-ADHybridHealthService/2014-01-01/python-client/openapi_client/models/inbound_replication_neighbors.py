...
class InboundReplicationNeighbors(BaseModel):
    """
    The list of replication summary for the domain controller inbound neighbor.
    """ # noqa: E501
    value: Optional[List[InboundReplicationNeighbor]] = Field(default=None, description="The details of inbound replication neighbors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [InboundReplicationNeighbor.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
