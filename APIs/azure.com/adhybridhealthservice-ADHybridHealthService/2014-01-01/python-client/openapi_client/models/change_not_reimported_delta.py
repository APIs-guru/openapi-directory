...
class ChangeNotReimportedDelta(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["anchor", "attributes", "dnAttributes", "operationType"]
    ...
    def operation_type_validate_enum(cls, value):
        ...
        if value not in set(['Undefined', 'None', 'Add', 'Replace', 'Update', 'Delete', 'Obsolete', 'DeleteAdd']):
            raise ValueError("must be one of enum values ('Undefined', 'None', 'Add', 'Replace', 'Update', 'Delete', 'Obsolete', 'DeleteAdd')")
        return value
