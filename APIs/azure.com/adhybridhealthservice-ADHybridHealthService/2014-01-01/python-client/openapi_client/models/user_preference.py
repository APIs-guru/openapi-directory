...
class UserPreference(BaseModel):
    ...
    """ # noqa: E501
    metric_names: Optional[List[StrictStr]] = Field(default=None, description="The name of the metric.", alias="metricNames")
    __properties: ClassVar[List[str]] = ["metricNames"]
