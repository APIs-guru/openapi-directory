...
class Hotfixes(BaseModel):
    """
    The list of hotfixes installed in the server.
    """ # noqa: E501
    value: Optional[List[Hotfix]] = Field(default=None, description="The value returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Hotfix.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
