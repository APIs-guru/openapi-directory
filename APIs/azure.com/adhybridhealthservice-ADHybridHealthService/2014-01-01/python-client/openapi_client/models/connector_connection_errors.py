...
class ConnectorConnectionErrors(BaseModel):
    """
    The list of connector connection errors.
    """ # noqa: E501
    value: Optional[List[ConnectorConnectionError]] = Field(default=None, description="The value returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConnectorConnectionError.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
