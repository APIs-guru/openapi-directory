...
class HelpLink(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="The title for the link.")
    url: Optional[StrictStr] = Field(default=None, description="The url for the help document.")
