...
class AlertFeedbacks(BaseModel):
    """
    The list of alert feedback.
    """ # noqa: E501
    value: Optional[List[AlertFeedback]] = Field(default=None, description="The value returned by the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AlertFeedback.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
