...
class TabularExportError(BaseModel):
    """
    ...
    tabular_export_error_data: Optional[StrictStr] = Field(default=None, description="The export error data.", alias="tabularExportErrorData")
    __properties: ClassVar[List[str]] = ["mergedEntityId", "serviceId", "serviceMemberId", "tabularExportErrorData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tabularExportErrorData": obj.get("tabularExportErrorData")
        })
        return _obj
