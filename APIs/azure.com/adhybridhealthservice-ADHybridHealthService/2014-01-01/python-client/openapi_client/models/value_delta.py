...
class ValueDelta(BaseModel):
    ...
    value: Optional[StrictStr] = Field(default=None, description="The value of the delta.")
    __properties: ClassVar[List[str]] = ["operationType", "value"]
    ...
    def operation_type_validate_enum(cls, value):
        ...
        if value not in set(['Undefined', 'Add', 'Update', 'Delete']):
            raise ValueError("must be one of enum values ('Undefined', 'Add', 'Update', 'Delete')")
        return value
