...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.ADHybridHealthService/operations | 


# **operations_list**
> OperationListResponse operations_list(api_version)
