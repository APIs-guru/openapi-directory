...
------------- | ------------- | -------------
[**reports_get_dev_ops**](DevOpsApi.md#reports_get_dev_ops) | **GET** /providers/Microsoft.ADHybridHealthService/reports/DevOps/IsDevOps | 


# **reports_get_dev_ops**
> Result reports_get_dev_ops(api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.reports_get_dev_ops(api_version)
        print("The response of DevOpsApi->reports_get_dev_ops:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DevOpsApi->reports_get_dev_ops: %s\n" % e)
```
