...
class TestAddsServiceMembers(unittest.TestCase):
    """AddsServiceMembers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddsServiceMembers:
        """Test AddsServiceMembers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddsServiceMembers`
        """
        model = AddsServiceMembers()
        if include_optional:
            return AddsServiceMembers(
                ...
                total_count = 56,
                value = [
                    openapi_client.models.adds_service_member.AddsServiceMember(
                        active_alerts = 56, 
    ...
    def testAddsServiceMembers(self):
        """Test AddsServiceMembers"""
