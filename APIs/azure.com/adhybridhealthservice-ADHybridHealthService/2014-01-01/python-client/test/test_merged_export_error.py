...
class TestMergedExportError(unittest.TestCase):
    """MergedExportError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergedExportError:
        """Test MergedExportError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergedExportError`
        """
        model = MergedExportError()
        if include_optional:
            return MergedExportError(
                attribute_name = '',
                attribute_value = '',
    ...
    def testMergedExportError(self):
        """Test MergedExportError"""
