...
class ServerCommunicationLink(BaseModel):
    """
    Server communication link.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Communication link kind.  This property is used for Azure Portal metadata.")
    location: Optional[StrictStr] = Field(default=None, description="Communication link location.")
    properties: Optional[ServerCommunicationLinkProperties] = None
