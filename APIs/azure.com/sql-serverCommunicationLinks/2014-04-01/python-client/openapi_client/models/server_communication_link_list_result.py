...
class ServerCommunicationLinkListResult(BaseModel):
    """
    A list of server communication links.
    """ # noqa: E501
    value: Optional[List[ServerCommunicationLink]] = Field(default=None, description="The list of server communication links.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServerCommunicationLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
