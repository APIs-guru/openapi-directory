...
class ServerCommunicationLinkProperties(BaseModel):
    """
    The properties of a server communication link.
    """ # noqa: E501
    partner_server: StrictStr = Field(description="The name of the partner server.", alias="partnerServer")
    state: Optional[StrictStr] = Field(default=None, description="The state.")
    __properties: ClassVar[List[str]] = ["partnerServer", "state"]
