...
class NetworkInterfacesListVirtualMachineScaleSetIpConfigurations200Response(BaseModel):
    """
    Response for list ip configurations API service call.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of results.", alias="nextLink")
    value: Optional[List[NetworkInterfacesListVirtualMachineScaleSetIpConfigurations200ResponseValueInner]] = Field(default=None, description="A list of ip configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [NetworkInterfacesListVirtualMachineScaleSetIpConfigurations200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
