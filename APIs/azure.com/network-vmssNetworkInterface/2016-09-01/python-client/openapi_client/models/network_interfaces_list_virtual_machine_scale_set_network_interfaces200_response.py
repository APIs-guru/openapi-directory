...
class NetworkInterfacesListVirtualMachineScaleSetNetworkInterfaces200Response(BaseModel):
    """
    ...
    value: Optional[List[NetworkInterfacesListVirtualMachineScaleSetNetworkInterfaces200ResponseValueInner]] = Field(default=None, description="A list of network interfaces in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [NetworkInterfacesListVirtualMachineScaleSetNetworkInterfaces200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
