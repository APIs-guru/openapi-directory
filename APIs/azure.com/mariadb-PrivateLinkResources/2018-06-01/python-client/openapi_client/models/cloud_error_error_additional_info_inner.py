...
class CloudErrorErrorAdditionalInfoInner(BaseModel):
    """
    The resource management error additional info.
    """ # noqa: E501
    info: Optional[Dict[str, Any]] = Field(default=None, description="The additional info.")
    type: Optional[StrictStr] = Field(default=None, description="The additional info type.")
