...
class TestSecuritySubAssessmentList(unittest.TestCase):
    """SecuritySubAssessmentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecuritySubAssessmentList:
        """Test SecuritySubAssessmentList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecuritySubAssessmentList`
        """
        model = SecuritySubAssessmentList()
        if include_optional:
            return SecuritySubAssessmentList(
                next_link = '',
                value = [
                    openapi_client.models.security_sub_assessment.SecuritySubAssessment(
    ...
    def testSecuritySubAssessmentList(self):
        """Test SecuritySubAssessmentList"""
