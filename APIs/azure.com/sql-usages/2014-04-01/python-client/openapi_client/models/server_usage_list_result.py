...
class ServerUsageListResult(BaseModel):
    """
    Represents the response to a list server metrics request.
    """ # noqa: E501
    value: List[ServerUsage] = Field(description="The list of server metrics for the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServerUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
