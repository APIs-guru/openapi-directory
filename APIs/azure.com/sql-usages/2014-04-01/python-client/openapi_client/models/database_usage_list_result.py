...
class DatabaseUsageListResult(BaseModel):
    """
    The response to a list database metrics request.
    """ # noqa: E501
    value: List[DatabaseUsage] = Field(description="The list of database usages for the database.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabaseUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
