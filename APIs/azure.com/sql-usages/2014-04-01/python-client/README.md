...
------------ | ------------- | ------------- | -------------
*DatabasesApi* | [**database_usages_list_by_database**](docs/DatabasesApi.md#database_usages_list_by_database) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/usages | 
*ServersApi* | [**server_usages_list_by_server**](docs/ServersApi.md#server_usages_list_by_server) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/usages | 


## Documentation For Models

 - [DatabaseUsage](docs/DatabaseUsage.md)
 - [DatabaseUsageListResult](docs/DatabaseUsageListResult.md)
 - [ServerUsage](docs/ServerUsage.md)
 - [ServerUsageListResult](docs/ServerUsageListResult.md)
