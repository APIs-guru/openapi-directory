...
class WebAppsListUsagesSlot200ResponseValueInner(BaseModel):
    """
    ...
    name: Optional[WebAppsListUsagesSlot200ResponseValueInnerName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "name": WebAppsListUsagesSlot200ResponseValueInnerName.from_dict(obj["name"]) if obj.get("name") is not None else None,
