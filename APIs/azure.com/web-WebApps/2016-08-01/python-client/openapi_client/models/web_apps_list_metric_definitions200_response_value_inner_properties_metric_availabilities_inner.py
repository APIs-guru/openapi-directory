...
class WebAppsListMetricDefinitions200ResponseValueInnerPropertiesMetricAvailabilitiesInner(BaseModel):
    """
    Metrics availability and retention.
    """ # noqa: E501
    retention: Optional[StrictStr] = Field(default=None, description="Retention period for the current time grain.")
    time_grain: Optional[StrictStr] = Field(default=None, description="Time grain .", alias="timeGrain")
