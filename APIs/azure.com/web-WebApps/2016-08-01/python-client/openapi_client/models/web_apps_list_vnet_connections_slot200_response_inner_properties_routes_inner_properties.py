...
class WebAppsListVnetConnectionsSlot200ResponseInnerPropertiesRoutesInnerProperties(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of this route. This is only returned by the server and does not need to be set by the client.")
    ...
    __properties: ClassVar[List[str]] = ["endAddress", "name", "routeType", "startAddress"]
