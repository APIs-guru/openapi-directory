...
class SiteConfigurationSnapshotInfo(BaseModel):
    """
    A snapshot of a web app configuration.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="SiteConfigurationSnapshotInfo resource specific properties")
