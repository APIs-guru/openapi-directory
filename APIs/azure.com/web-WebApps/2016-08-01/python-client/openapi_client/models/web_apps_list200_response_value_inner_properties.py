...
class WebAppsList200ResponseValueInnerProperties(BaseModel):
    ...
    snapshot_info: Optional[WebAppsList200ResponseValueInnerPropertiesSnapshotInfo] = Field(default=None, alias="snapshotInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshotInfo": WebAppsList200ResponseValueInnerPropertiesSnapshotInfo.from_dict(obj["snapshotInfo"]) if obj.get("snapshotInfo") is not None else None,
            "state": obj.get("state"),
