...
class WebAppsList200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    ...
    ip_security_restrictions: Optional[List[WebAppsList200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner]] = Field(default=None, description="IP security restrictions.", alias="ipSecurityRestrictions")
