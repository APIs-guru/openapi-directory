...
class DeletedAppRestoreRequest(BaseModel):
    """
    Details about restoring a deleted app.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="DeletedAppRestoreRequest resource specific properties")
