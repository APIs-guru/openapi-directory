...
class KeyVaultReferenceCollection(BaseModel):
    """
    Web app key vault reference and status ARM resource.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="KeyVaultReferenceCollection resource specific properties")
