...
class SitePatchResource(BaseModel):
    """
    ARM resource for a site.
    """ # noqa: E501
    identity: Optional[object] = Field(default=None, description="Managed service identity.")
    properties: Optional[object] = Field(default=None, description="SitePatchResource resource specific properties")
