...
class CustomHostnameAnalysisResult(BaseModel):
    """
    Custom domain analysis.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="CustomHostnameAnalysisResult resource specific properties")
