...
class WebAppsList200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    ...
    api_management_config: Optional[WebAppsList200ResponseValueInnerPropertiesSiteConfigApiManagementConfig] = Field(default=None, alias="apiManagementConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiManagementConfig": WebAppsList200ResponseValueInnerPropertiesSiteConfigApiManagementConfig.from_dict(obj["apiManagementConfig"]) if obj.get("apiManagementConfig") is not None else None,
