...
class PremierAddOnPatchResource(BaseModel):
    """
    ARM resource for a PremierAddOn.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="PremierAddOnPatchResource resource specific properties")
