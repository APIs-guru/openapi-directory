...
class RelayServiceConnectionEntity(BaseModel):
    """
    Hybrid Connection for an App Service app.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="RelayServiceConnectionEntity resource specific properties")
