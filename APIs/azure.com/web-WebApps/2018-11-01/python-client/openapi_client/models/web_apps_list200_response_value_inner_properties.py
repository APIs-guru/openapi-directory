...
class WebAppsList200ResponseValueInnerProperties(BaseModel):
    """
    ...
    cloning_info: Optional[WebAppsList200ResponseValueInnerPropertiesCloningInfo] = Field(default=None, alias="cloningInfo")
    ...
    geo_distributions: Optional[List[WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner]] = Field(default=None, description="GeoDistributions for this site", alias="geoDistributions")
    host_name_ssl_states: Optional[List[WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner]] = Field(default=None, description="Hostname SSL states are used to manage the SSL bindings for app's hostnames.", alias="hostNameSslStates")
    ...
    hosting_environment_profile: Optional[WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile] = Field(default=None, alias="hostingEnvironmentProfile")
    ...
    site_config: Optional[WebAppsList200ResponseValueInnerPropertiesSiteConfig] = Field(default=None, alias="siteConfig")
    slot_swap_status: Optional[WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus] = Field(default=None, alias="slotSwapStatus")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAppsList200ResponseValueInnerProperties from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in geo_distributions (list)
        _items = []
        if self.geo_distributions:
            for _item_geo_distributions in self.geo_distributions:
                if _item_geo_distributions:
                    _items.append(_item_geo_distributions.to_dict())
            _dict['geoDistributions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAppsList200ResponseValueInnerProperties from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cloningInfo": WebAppsList200ResponseValueInnerPropertiesCloningInfo.from_dict(obj["cloningInfo"]) if obj.get("cloningInfo") is not None else None,
            ...
            "geoDistributions": [WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner.from_dict(_item) for _item in obj["geoDistributions"]] if obj.get("geoDistributions") is not None else None,
            "hostNameSslStates": [WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner.from_dict(_item) for _item in obj["hostNameSslStates"]] if obj.get("hostNameSslStates") is not None else None,
            "hostNames": obj.get("hostNames"),
            "hostNamesDisabled": obj.get("hostNamesDisabled"),
            "hostingEnvironmentProfile": WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile.from_dict(obj["hostingEnvironmentProfile"]) if obj.get("hostingEnvironmentProfile") is not None else None,
            ...
            "slotSwapStatus": WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus.from_dict(obj["slotSwapStatus"]) if obj.get("slotSwapStatus") is not None else None,
            "state": obj.get("state"),
