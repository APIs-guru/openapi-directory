...
class WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggers(BaseModel):
    """
    ...
    requests: Optional[WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersRequests] = None
    slow_requests: Optional[WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersSlowRequests] = Field(default=None, alias="slowRequests")
    status_codes: Optional[List[WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersStatusCodesInner]] = Field(default=None, description="A rule based on status codes.", alias="statusCodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requests": WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersRequests.from_dict(obj["requests"]) if obj.get("requests") is not None else None,
            "slowRequests": WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersSlowRequests.from_dict(obj["slowRequests"]) if obj.get("slowRequests") is not None else None,
            "statusCodes": [WebAppsList200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggersStatusCodesInner.from_dict(_item) for _item in obj["statusCodes"]] if obj.get("statusCodes") is not None else None
        })
        return _obj
