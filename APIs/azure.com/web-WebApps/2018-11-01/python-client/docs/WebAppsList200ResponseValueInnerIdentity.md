...
**user_assigned_identities** | [**Dict[str, WebAppsList200ResponseValueInnerIdentityUserAssignedIdentitiesValue]**](WebAppsList200ResponseValueInnerIdentityUserAssignedIdentitiesValue.md) | The list of user assigned identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form: &#39;/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName} | [optional] 
