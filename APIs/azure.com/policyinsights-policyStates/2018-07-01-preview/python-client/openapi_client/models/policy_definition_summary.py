...
class PolicyDefinitionSummary(BaseModel):
    """
    Policy definition summary.
    """ # noqa: E501
    effect: Optional[StrictStr] = Field(default=None, description="Policy effect, i.e. policy definition action.")
    policy_definition_id: Optional[StrictStr] = Field(default=None, description="Policy definition ID.", alias="policyDefinitionId")
    policy_definition_reference_id: Optional[StrictStr] = Field(default=None, description="Policy definition reference ID.", alias="policyDefinitionReferenceId")
    results: Optional[SummaryResults] = None
    __properties: ClassVar[List[str]] = ["effect", "policyDefinitionId", "policyDefinitionReferenceId", "results"]
