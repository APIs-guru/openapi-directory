...
class OperationDisplay(BaseModel):
    ...
    operation: Optional[StrictStr] = Field(default=None, description="Operation name.")
    provider: Optional[StrictStr] = Field(default=None, description="Resource provider name.")
    resource: Optional[StrictStr] = Field(default=None, description="Resource name on which the operation is performed.")
