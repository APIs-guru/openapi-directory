...
class DefaultApi:
    ...
    def policy_states_list_query_results_for_resource(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="OData filter expression.")] = None,
        apply: Annotated[Optional[StrictStr], Field(description="OData apply expression for aggregations.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="The $expand query parameter. For example, to expand policyEvaluationDetails, use $expand=policyEvaluationDetails")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def policy_states_trigger_resource_group_evaluation(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        ...
        _param = self._policy_states_trigger_resource_group_evaluation_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            api_version=api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def policy_states_trigger_resource_group_evaluation_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    @validate_call
    def policy_states_trigger_resource_group_evaluation_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _policy_states_trigger_resource_group_evaluation_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def policy_states_trigger_subscription_evaluation(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
        ...
        _param = self._policy_states_trigger_subscription_evaluation_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def policy_states_trigger_subscription_evaluation_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
    ...
    @validate_call
    def policy_states_trigger_subscription_evaluation_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Microsoft Azure subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
    ...
    def _policy_states_trigger_subscription_evaluation_serialize(
        self,
        subscription_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
