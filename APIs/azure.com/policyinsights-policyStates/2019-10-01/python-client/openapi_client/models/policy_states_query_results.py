...
class PolicyStatesQueryResults(BaseModel):
    """
    Query results.
    """ # noqa: E501
    ...
    odata_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="OData entity count; represents the number of policy state records returned.", alias="@odata.count")
    value: Optional[List[PolicyState]] = Field(default=None, description="Query results.")
    __properties: ClassVar[List[str]] = ["@odata.context", "@odata.count", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicyState.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
