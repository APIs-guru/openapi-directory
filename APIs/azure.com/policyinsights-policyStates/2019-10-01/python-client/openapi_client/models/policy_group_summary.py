...
class PolicyGroupSummary(BaseModel):
    ...
    """ # noqa: E501
    policy_group_name: Optional[StrictStr] = Field(default=None, description="Policy group name.", alias="policyGroupName")
    results: Optional[SummaryResults] = None
    __properties: ClassVar[List[str]] = ["policyGroupName", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policyGroupName": obj.get("policyGroupName"),
