...
class PolicyState(BaseModel):
    ...
    compliance_state: Optional[StrictStr] = Field(default=None, description="Compliance state of the resource.", alias="complianceState")
    ...
    is_compliant: Optional[StrictBool] = Field(default=None, description="Flag which states whether the resource is compliant against the policy assignment it was evaluated against. This property is deprecated; please use ComplianceState instead.", alias="isCompliant")
    ...
    policy_definition_group_names: Optional[List[StrictStr]] = Field(default=None, description="Policy definition group names.", alias="policyDefinitionGroupNames")
    ...
    policy_evaluation_details: Optional[PolicyEvaluationDetails] = Field(default=None, alias="policyEvaluationDetails")
    ...
    __properties: ClassVar[List[str]] = ["@odata.context", "@odata.id", "complianceState", "effectiveParameters", "isCompliant", "managementGroupIds", "policyAssignmentId", "policyAssignmentName", "policyAssignmentOwner", "policyAssignmentParameters", "policyAssignmentScope", "policyDefinitionAction", "policyDefinitionCategory", "policyDefinitionGroupNames", "policyDefinitionId", "policyDefinitionName", "policyDefinitionReferenceId", "policyEvaluationDetails", "policySetDefinitionCategory", "policySetDefinitionId", "policySetDefinitionName", "policySetDefinitionOwner", "policySetDefinitionParameters", "resourceGroup", "resourceId", "resourceLocation", "resourceTags", "resourceType", "subscriptionId", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of policy_evaluation_details
        if self.policy_evaluation_details:
            _dict['policyEvaluationDetails'] = self.policy_evaluation_details.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyDefinitionGroupNames": obj.get("policyDefinitionGroupNames"),
            ...
            "policyEvaluationDetails": PolicyEvaluationDetails.from_dict(obj["policyEvaluationDetails"]) if obj.get("policyEvaluationDetails") is not None else None,
