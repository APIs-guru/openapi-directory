...
class SummarizeResults(BaseModel):
    ...
    odata_count: Optional[Annotated[int, Field(le=1, strict=True, ge=1)]] = Field(default=None, description="OData entity count; represents the number of summaries returned; always set to 1.", alias="@odata.count")
    value: Optional[List[Summary]] = Field(default=None, description="Summarize action results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Summary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
