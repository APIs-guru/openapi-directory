...
class NetworkProfile(BaseModel):
    ...
    """ # noqa: E501
    circuit_id: Optional[StrictStr] = Field(default=None, description="Specifies the circuit id for connecting to express route.", alias="circuitId")
    network_interfaces: Optional[List[IpAddress]] = Field(default=None, description="Specifies the network interfaces for the HANA instance.", alias="networkInterfaces")
    __properties: ClassVar[List[str]] = ["circuitId", "networkInterfaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkInterfaces": [IpAddress.from_dict(_item) for _item in obj["networkInterfaces"]] if obj.get("networkInterfaces") is not None else None
        })
        return _obj
