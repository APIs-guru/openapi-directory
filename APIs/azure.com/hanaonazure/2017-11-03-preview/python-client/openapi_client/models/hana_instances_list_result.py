...
class HanaInstancesListResult(BaseModel):
    """
    The response from the List HANA Instances operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of HANA instances.", alias="nextLink")
    value: Optional[List[HanaInstance]] = Field(default=None, description="The list of SAP HANA on Azure instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [HanaInstance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
