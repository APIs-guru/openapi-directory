...
class SapMonitorListResult(BaseModel):
    """
    The response from the List SAP monitors operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of SAP monitors.", alias="nextLink")
    value: Optional[List[SapMonitor]] = Field(default=None, description="The list of SAP monitors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SapMonitor.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
