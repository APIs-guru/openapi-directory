...
class TestSapMonitor(unittest.TestCase):
    """SapMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SapMonitor:
        """Test SapMonitor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SapMonitor`
        """
        model = SapMonitor()
        if include_optional:
            return SapMonitor(
