...
class TestHanaInstancesListResult(unittest.TestCase):
    """HanaInstancesListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HanaInstancesListResult:
        """Test HanaInstancesListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HanaInstancesListResult`
        """
        model = HanaInstancesListResult()
        if include_optional:
            return HanaInstancesListResult(
                next_link = '',
                value = [
                    openapi_client.models.hana_instance.HanaInstance(
    ...
    def testHanaInstancesListResult(self):
        """Test HanaInstancesListResult"""
