...
class TestHanaInstanceProperties(unittest.TestCase):
    """HanaInstanceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HanaInstanceProperties:
        """Test HanaInstanceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HanaInstanceProperties`
        """
        model = HanaInstanceProperties()
        if include_optional:
            return HanaInstanceProperties(
                hana_instance_id = '',
    ...
    def testHanaInstanceProperties(self):
        """Test HanaInstanceProperties"""
