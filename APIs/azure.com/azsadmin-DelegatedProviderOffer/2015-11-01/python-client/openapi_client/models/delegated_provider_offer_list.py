...
class DelegatedProviderOfferList(BaseModel):
    """
    List of delegated provider offers.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Continuation token", alias="nextLink")
    value: Optional[List[DelegatedProviderOffer]] = Field(default=None, description="Array of delegated provider offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DelegatedProviderOffer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
