...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The URL to get the next set of operations. | [optional] 
**value** | [**List[Operation]**](Operation.md) | List of Storage operations supported by the Storage resource provider. | [optional] 
