...
[**workflow_versions_list_callback_url**](WorkflowTriggersApi.md#workflow_versions_list_callback_url) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/versions/{versionId}/triggers/{triggerName}/listCallbackUrl | 
...
> WorkflowTriggerCallbackUrl workflow_versions_list_callback_url(subscription_id, resource_group_name, workflow_name, version_id, trigger_name, api_version, parameters=parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.workflow_versions_list_callback_url(subscription_id, resource_group_name, workflow_name, version_id, trigger_name, api_version, parameters=parameters)
        print("The response of WorkflowTriggersApi->workflow_versions_list_callback_url:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkflowTriggersApi->workflow_versions_list_callback_url: %s\n" % e)
```
