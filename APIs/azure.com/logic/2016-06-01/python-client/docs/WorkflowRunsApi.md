...
[**workflow_runs_delete**](WorkflowRunsApi.md#workflow_runs_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/runs/{runName} | 
...
> workflow_runs_delete(subscription_id, resource_group_name, workflow_name, run_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.workflow_runs_delete(subscription_id, resource_group_name, workflow_name, run_name, api_version)
    except Exception as e:
        print("Exception when calling WorkflowRunsApi->workflow_runs_delete: %s\n" % e)
```
