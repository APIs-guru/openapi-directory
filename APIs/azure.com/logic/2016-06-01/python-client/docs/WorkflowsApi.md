...
[**workflows_validate**](WorkflowsApi.md#workflows_validate) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/locations/{location}/workflows/{workflowName}/validate | 
[**workflows_validate_workflow**](WorkflowsApi.md#workflows_validate_workflow) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/validate | 
...
# **workflows_validate**
> workflows_validate(subscription_id, resource_group_name, location, workflow_name, api_version, workflow)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.workflows_validate(subscription_id, resource_group_name, location, workflow_name, api_version, workflow)
    except Exception as e:
...
> workflows_validate_workflow(subscription_id, resource_group_name, workflow_name, api_version, validate)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.workflows_validate_workflow(subscription_id, resource_group_name, workflow_name, api_version, validate)
    except Exception as e:
        print("Exception when calling WorkflowsApi->workflows_validate_workflow: %s\n" % e)
```
