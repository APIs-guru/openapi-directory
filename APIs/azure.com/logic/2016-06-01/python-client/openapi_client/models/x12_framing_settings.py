...
class X12FramingSettings(BaseModel):
    """
    The X12 agreement framing settings.
    """ # noqa: E501
    character_set: X12CharacterSet = Field(alias="characterSet")
    ...
    __properties: ClassVar[List[str]] = ["characterSet", "componentSeparator", "dataElementSeparator", "replaceCharacter", "replaceSeparatorsInPayload", "segmentTerminator", "segmentTerminatorSuffix"]
