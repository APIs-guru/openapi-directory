...
class WorkflowRunProperties(BaseModel):
    ...
    response: Optional[WorkflowRunTrigger] = None
    ...
    wait_end_time: Optional[datetime] = Field(default=None, description="Gets the wait end time.", alias="waitEndTime")
    workflow: Optional[ResourceReference] = None
    __properties: ClassVar[List[str]] = ["code", "correlation", "correlationId", "endTime", "error", "outputs", "response", "startTime", "status", "trigger", "waitEndTime", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": WorkflowRunTrigger.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "startTime": obj.get("startTime"),
            "status": obj.get("status"),
            "trigger": WorkflowRunTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None,
            "waitEndTime": obj.get("waitEndTime"),
