...
class AS2MdnSettings(BaseModel):
    ...
    mic_hashing_algorithm: HashingAlgorithm = Field(alias="micHashingAlgorithm")
    need_mdn: StrictBool = Field(description="The value indicating whether to send or request a MDN.", alias="needMdn")
    receipt_delivery_url: Optional[StrictStr] = Field(default=None, description="The receipt delivery URL.", alias="receiptDeliveryUrl")
    send_inbound_mdn_to_message_box: StrictBool = Field(description="The value indicating whether to send inbound MDN to message box.", alias="sendInboundMdnToMessageBox")
    send_mdn_asynchronously: StrictBool = Field(description="The value indicating whether to send the asynchronous MDN.", alias="sendMdnAsynchronously")
    sign_mdn: StrictBool = Field(description="The value indicating whether the MDN needs to be signed or not.", alias="signMdn")
    sign_outbound_mdn_if_optional: StrictBool = Field(description="The value indicating whether to sign the outbound MDN if optional.", alias="signOutboundMdnIfOptional")
