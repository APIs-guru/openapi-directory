...
class IntegrationAccountPartnerProperties(BaseModel):
    """
    ...
    partner_type: PartnerType = Field(alias="partnerType")
    __properties: ClassVar[List[str]] = ["changedTime", "content", "createdTime", "metadata", "partnerType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": PartnerContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "createdTime": obj.get("createdTime"),
            "metadata": obj.get("metadata"),
            "partnerType": obj.get("partnerType")
        })
        return _obj
