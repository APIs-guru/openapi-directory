...
class AzureResourceErrorInfo(BaseModel):
    """
    The azure resource error info.
    """ # noqa: E501
    details: Optional[List[AzureResourceErrorInfo]] = Field(default=None, description="The error details.")
...
AzureResourceErrorInfo.model_rebuild(raise_errors=False)
