...
class RequestHistoryListResult(BaseModel):
    """
    ...
    value: Optional[List[RequestHistory]] = Field(default=None, description="A list of workflow request histories.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RequestHistory.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
