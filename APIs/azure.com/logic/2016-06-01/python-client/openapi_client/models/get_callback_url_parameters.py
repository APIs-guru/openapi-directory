...
class GetCallbackUrlParameters(BaseModel):
    """
    The callback url parameters.
    """ # noqa: E501
    key_type: Optional[KeyType] = Field(default=None, alias="keyType")
    not_after: Optional[datetime] = Field(default=None, description="The expiry time.", alias="notAfter")
    __properties: ClassVar[List[str]] = ["keyType", "notAfter"]
