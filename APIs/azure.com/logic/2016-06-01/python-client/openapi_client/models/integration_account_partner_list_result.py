...
class IntegrationAccountPartnerListResult(BaseModel):
    """
    ...
    value: Optional[List[IntegrationAccountPartner]] = Field(default=None, description="The list of integration account partners.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IntegrationAccountPartner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
