...
class IntegrationAccountRosettaNetProcessConfigurationListResult(BaseModel):
    """
    ...
    value: Optional[List[IntegrationAccountRosettaNetProcessConfiguration]] = Field(default=None, description="The list of integration account RosettaNet PIP configuration.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IntegrationAccountRosettaNetProcessConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
