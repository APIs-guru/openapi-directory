...
class IntegrationAccountCertificatesApi:
    ...
    @validate_call
    def certificates_list_by_integration_accounts(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The resource group name.")],
        integration_account_name: Annotated[StrictStr, Field(description="The integration account name.")],
        ...
        _param = self._certificates_list_by_integration_accounts_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            integration_account_name=integration_account_name,
            api_version=api_version,
    ...
    @validate_call
    def certificates_list_by_integration_accounts_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The resource group name.")],
        integration_account_name: Annotated[StrictStr, Field(description="The integration account name.")],
    ...
    @validate_call
    def certificates_list_by_integration_accounts_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The resource group name.")],
        integration_account_name: Annotated[StrictStr, Field(description="The integration account name.")],
    ...
    def _certificates_list_by_integration_accounts_serialize(
        self,
        subscription_id,
        resource_group_name,
        integration_account_name,
