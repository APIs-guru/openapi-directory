...
class TestWorkflowRunTrigger(unittest.TestCase):
    """WorkflowRunTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowRunTrigger:
        """Test WorkflowRunTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowRunTrigger`
        """
    ...
    def testWorkflowRunTrigger(self):
        """Test WorkflowRunTrigger"""
