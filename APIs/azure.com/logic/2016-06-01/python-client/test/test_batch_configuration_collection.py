...
class TestBatchConfigurationCollection(unittest.TestCase):
    """BatchConfigurationCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchConfigurationCollection:
        """Test BatchConfigurationCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchConfigurationCollection`
        """
        model = BatchConfigurationCollection()
        if include_optional:
            return BatchConfigurationCollection(
                value = [
                    openapi_client.models.batch_configuration.BatchConfiguration(
    ...
    def testBatchConfigurationCollection(self):
        """Test BatchConfigurationCollection"""
