...
class TestWorkflowTriggerProperties(unittest.TestCase):
    """WorkflowTriggerProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowTriggerProperties:
        """Test WorkflowTriggerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowTriggerProperties`
        """
    ...
    def testWorkflowTriggerProperties(self):
        """Test WorkflowTriggerProperties"""
