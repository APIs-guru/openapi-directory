...
class TestIntegrationAccountCertificateListResult(unittest.TestCase):
    """IntegrationAccountCertificateListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationAccountCertificateListResult:
        """Test IntegrationAccountCertificateListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationAccountCertificateListResult`
        """
        model = IntegrationAccountCertificateListResult()
        if include_optional:
            return IntegrationAccountCertificateListResult(
                next_link = '',
                value = [
                    openapi_client.models.integration_account_certificate.IntegrationAccountCertificate(
    ...
    def testIntegrationAccountCertificateListResult(self):
        """Test IntegrationAccountCertificateListResult"""
