...
class WorkflowProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessEndpoint", "changedTime", "createdTime", "definition", "definitionLink", "parameters", "parametersLink", "provisioningState", "sku", "state", "version"]
