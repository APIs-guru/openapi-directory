...
class WorkflowAccessKeyListResult(BaseModel):
    """
    WorkflowAccessKeyListResult
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the URL to get the next set of results.", alias="nextLink")
    value: Optional[List[WorkflowAccessKey]] = Field(default=None, description="Gets or sets a list of workflow access keys.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [WorkflowAccessKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
