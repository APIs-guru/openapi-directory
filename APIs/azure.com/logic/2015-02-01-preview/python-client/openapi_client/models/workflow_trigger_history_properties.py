...
class WorkflowTriggerHistoryProperties(BaseModel):
    ...
    fired: Optional[StrictBool] = Field(default=None, description="Gets a value indicating whether trigger was fired.")
    ...
    __properties: ClassVar[List[str]] = ["code", "endTime", "error", "fired", "inputsLink", "outputsLink", "run", "startTime", "status", "trackingId"]
