...
class WorkflowRunTrigger(BaseModel):
    ...
    tracking_id: Optional[StrictStr] = Field(default=None, description="Gets the trackingId.", alias="trackingId")
    __properties: ClassVar[List[str]] = ["code", "endTime", "error", "inputs", "inputsLink", "name", "outputs", "outputsLink", "startTime", "status", "trackingId"]
