...
class TestWorkflowTriggerHistoryProperties(unittest.TestCase):
    """WorkflowTriggerHistoryProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowTriggerHistoryProperties:
        """Test WorkflowTriggerHistoryProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowTriggerHistoryProperties`
        """
        model = WorkflowTriggerHistoryProperties()
        if include_optional:
            return WorkflowTriggerHistoryProperties(
                code = '',
    ...
    def testWorkflowTriggerHistoryProperties(self):
        """Test WorkflowTriggerHistoryProperties"""
