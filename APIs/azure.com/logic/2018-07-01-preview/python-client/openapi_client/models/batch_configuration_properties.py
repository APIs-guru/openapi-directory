...
class BatchConfigurationProperties(BaseModel):
    """
    The batch configuration properties definition.
    """ # noqa: E501
    batch_group_name: StrictStr = Field(description="The name of the batch group.", alias="batchGroupName")
    ...
    release_criteria: BatchReleaseCriteria = Field(alias="releaseCriteria")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["changedTime", "createdTime", "metadata"]
