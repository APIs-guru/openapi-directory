...
class WorkflowRunListResult(BaseModel):
    ...
    value: Optional[List[WorkflowRun]] = Field(default=None, description="A list of workflow runs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [WorkflowRun.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
