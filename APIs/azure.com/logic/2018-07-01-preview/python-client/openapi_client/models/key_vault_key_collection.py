...
class KeyVaultKeyCollection(BaseModel):
    """
    Collection of key vault keys.
    """ # noqa: E501
    skip_token: Optional[StrictStr] = Field(default=None, description="The skip token.", alias="skipToken")
    value: Optional[List[KeyVaultKey]] = Field(default=None, description="The key vault keys.")
    __properties: ClassVar[List[str]] = ["skipToken", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [KeyVaultKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
