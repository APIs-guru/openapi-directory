...
class BatchReleaseCriteria(BaseModel):
    """
    The batch release criteria.
    """ # noqa: E501
    batch_size: Optional[StrictInt] = Field(default=None, description="The batch size in bytes.", alias="batchSize")
    message_count: Optional[StrictInt] = Field(default=None, description="The message count.", alias="messageCount")
    recurrence: Optional[WorkflowTriggerRecurrence] = None
    __properties: ClassVar[List[str]] = ["batchSize", "messageCount", "recurrence"]
