...
class EdifactDelimiterOverride(BaseModel):
    """
    ...
    decimal_point_indicator: EdifactDecimalIndicator = Field(alias="decimalPointIndicator")
    ...
    message_release: Optional[StrictStr] = Field(default=None, description="The message release.", alias="messageRelease")
    message_version: Optional[StrictStr] = Field(default=None, description="The message version.", alias="messageVersion")
    release_indicator: StrictInt = Field(description="The release indicator.", alias="releaseIndicator")
    repetition_separator: StrictInt = Field(description="The repetition separator.", alias="repetitionSeparator")
    ...
    __properties: ClassVar[List[str]] = ["componentSeparator", "dataElementSeparator", "decimalPointIndicator", "messageAssociationAssignedCode", "messageId", "messageRelease", "messageVersion", "releaseIndicator", "repetitionSeparator", "segmentTerminator", "segmentTerminatorSuffix", "targetNamespace"]
