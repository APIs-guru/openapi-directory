...
class WorkflowTrigger(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets the workflow trigger name.")
    properties: Optional[WorkflowTriggerProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Gets the workflow trigger type.")
