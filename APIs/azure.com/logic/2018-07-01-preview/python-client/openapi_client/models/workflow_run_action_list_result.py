...
class WorkflowRunActionListResult(BaseModel):
    """
    ...
    value: Optional[List[WorkflowRunAction]] = Field(default=None, description="A list of workflow run actions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [WorkflowRunAction.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
