...
class WorkflowListResult(BaseModel):
    ...
    value: Optional[List[Workflow]] = Field(default=None, description="The list of workflows.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Workflow.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
