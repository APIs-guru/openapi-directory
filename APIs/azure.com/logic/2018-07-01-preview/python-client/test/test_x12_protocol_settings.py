...
class TestX12ProtocolSettings(unittest.TestCase):
    """X12ProtocolSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> X12ProtocolSettings:
        """Test X12ProtocolSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `X12ProtocolSettings`
        """
    ...
    def testX12ProtocolSettings(self):
        """Test X12ProtocolSettings"""
