...
class TestBatchConfiguration(unittest.TestCase):
    """BatchConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchConfiguration:
        """Test BatchConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchConfiguration`
        """
        model = BatchConfiguration()
        if include_optional:
            return BatchConfiguration(
                properties = openapi_client.models.batch_configuration_properties.BatchConfigurationProperties(
                    batch_group_name = '', 
                    ...
                    release_criteria = openapi_client.models.batch_release_criteria.BatchReleaseCriteria(
                        batch_size = 56, 
                        message_count = 56, 
    ...
    def testBatchConfiguration(self):
        """Test BatchConfiguration"""
