...
class TestIntegrationServiceEnvironmentListResult(unittest.TestCase):
    """IntegrationServiceEnvironmentListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationServiceEnvironmentListResult:
        """Test IntegrationServiceEnvironmentListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationServiceEnvironmentListResult`
        """
        model = IntegrationServiceEnvironmentListResult()
        if include_optional:
            return IntegrationServiceEnvironmentListResult(
                next_link = '',
                value = [
                    openapi_client.models.integration_service_environment.IntegrationServiceEnvironment(
    ...
    def testIntegrationServiceEnvironmentListResult(self):
        """Test IntegrationServiceEnvironmentListResult"""
