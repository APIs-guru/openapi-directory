...
class TestIntegrationAccountSchema(unittest.TestCase):
    """IntegrationAccountSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationAccountSchema:
        """Test IntegrationAccountSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationAccountSchema`
        """
    ...
    def testIntegrationAccountSchema(self):
        """Test IntegrationAccountSchema"""
