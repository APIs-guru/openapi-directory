...
class TestApiOperationListResult(unittest.TestCase):
    """ApiOperationListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiOperationListResult:
        """Test ApiOperationListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiOperationListResult`
        """
        model = ApiOperationListResult()
        if include_optional:
    ...
    def testApiOperationListResult(self):
        """Test ApiOperationListResult"""
