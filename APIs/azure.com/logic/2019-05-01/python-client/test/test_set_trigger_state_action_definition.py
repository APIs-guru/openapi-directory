...
class TestSetTriggerStateActionDefinition(unittest.TestCase):
    """SetTriggerStateActionDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetTriggerStateActionDefinition:
        """Test SetTriggerStateActionDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetTriggerStateActionDefinition`
        """
        model = SetTriggerStateActionDefinition()
        if include_optional:
            return SetTriggerStateActionDefinition(
                source = openapi_client.models.workflow_trigger.WorkflowTrigger(
                    name = '', 
    ...
    def testSetTriggerStateActionDefinition(self):
        """Test SetTriggerStateActionDefinition"""
