...
class TestManagedApiListResult(unittest.TestCase):
    """ManagedApiListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedApiListResult:
        """Test ManagedApiListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedApiListResult`
        """
        ...
        if include_optional:
            return ManagedApiListResult(
                next_link = '',
                value = [
                    openapi_client.models.managed_api.ManagedApi(
    ...
    def testManagedApiListResult(self):
        """Test ManagedApiListResult"""
