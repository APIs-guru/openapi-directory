...
class TestWorkflowRunAction(unittest.TestCase):
    """WorkflowRunAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowRunAction:
        """Test WorkflowRunAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowRunAction`
        """
    ...
    def testWorkflowRunAction(self):
        """Test WorkflowRunAction"""
