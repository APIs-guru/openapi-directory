...
class TestEdifactOneWayAgreement(unittest.TestCase):
    """EdifactOneWayAgreement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdifactOneWayAgreement:
        """Test EdifactOneWayAgreement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdifactOneWayAgreement`
        """
    ...
    def testEdifactOneWayAgreement(self):
        """Test EdifactOneWayAgreement"""
