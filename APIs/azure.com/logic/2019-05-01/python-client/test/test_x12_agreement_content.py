...
class TestX12AgreementContent(unittest.TestCase):
    """X12AgreementContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> X12AgreementContent:
        """Test X12AgreementContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `X12AgreementContent`
        """
    ...
    def testX12AgreementContent(self):
        """Test X12AgreementContent"""
