...
class TestIntegrationAccountProperties(unittest.TestCase):
    """IntegrationAccountProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationAccountProperties:
        """Test IntegrationAccountProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationAccountProperties`
        """
        model = IntegrationAccountProperties()
        if include_optional:
            return IntegrationAccountProperties(
                integration_service_environment = openapi_client.models.integration_service_environment.IntegrationServiceEnvironment(
    ...
    def testIntegrationAccountProperties(self):
        """Test IntegrationAccountProperties"""
