...
class TestAS2AgreementContent(unittest.TestCase):
    """AS2AgreementContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AS2AgreementContent:
        """Test AS2AgreementContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AS2AgreementContent`
        """
    ...
    def testAS2AgreementContent(self):
        """Test AS2AgreementContent"""
