...
class TestAS2OneWayAgreement(unittest.TestCase):
    """AS2OneWayAgreement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AS2OneWayAgreement:
        """Test AS2OneWayAgreement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AS2OneWayAgreement`
        """
    ...
    def testAS2OneWayAgreement(self):
        """Test AS2OneWayAgreement"""
