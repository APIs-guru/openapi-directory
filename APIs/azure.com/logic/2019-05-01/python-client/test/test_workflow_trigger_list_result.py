...
class TestWorkflowTriggerListResult(unittest.TestCase):
    """WorkflowTriggerListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowTriggerListResult:
        """Test WorkflowTriggerListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowTriggerListResult`
        """
        model = WorkflowTriggerListResult()
        if include_optional:
            return WorkflowTriggerListResult(
                next_link = '',
                value = [
                    openapi_client.models.workflow_trigger.WorkflowTrigger(
                        name = '', 
    ...
    def testWorkflowTriggerListResult(self):
        """Test WorkflowTriggerListResult"""
