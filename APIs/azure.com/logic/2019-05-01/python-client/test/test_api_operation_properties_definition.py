...
class TestApiOperationPropertiesDefinition(unittest.TestCase):
    """ApiOperationPropertiesDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiOperationPropertiesDefinition:
        """Test ApiOperationPropertiesDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiOperationPropertiesDefinition`
        """
        model = ApiOperationPropertiesDefinition()
        if include_optional:
            return ApiOperationPropertiesDefinition(
    ...
    def testApiOperationPropertiesDefinition(self):
        """Test ApiOperationPropertiesDefinition"""
