...
class TestWorkflowRunActionProperties(unittest.TestCase):
    """WorkflowRunActionProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowRunActionProperties:
        """Test WorkflowRunActionProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowRunActionProperties`
        """
        model = WorkflowRunActionProperties()
        if include_optional:
            return WorkflowRunActionProperties(
                code = '',
    ...
    def testWorkflowRunActionProperties(self):
        """Test WorkflowRunActionProperties"""
