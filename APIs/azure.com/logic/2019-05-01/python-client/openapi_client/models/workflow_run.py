...
class WorkflowRun(BaseModel):
    ...
    The workflow run.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets the workflow run name.")
    properties: Optional[WorkflowRunProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Gets the workflow run type.")
