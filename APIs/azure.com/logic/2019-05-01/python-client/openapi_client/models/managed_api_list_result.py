...
class ManagedApiListResult(BaseModel):
    """
    ...
    value: Optional[List[ManagedApi]] = Field(default=None, description="The managed APIs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ManagedApi.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
