...
class ApiDeploymentParameterMetadata(BaseModel):
    """
    ...
    is_required: Optional[StrictBool] = Field(default=None, description="Indicates whether its required.", alias="isRequired")
    type: Optional[StrictStr] = Field(default=None, description="The type.")
    visibility: Optional[ApiDeploymentParameterVisibility] = None
    __properties: ClassVar[List[str]] = ["description", "displayName", "isRequired", "type", "visibility"]
