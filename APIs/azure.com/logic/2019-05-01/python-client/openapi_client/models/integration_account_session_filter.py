...
class IntegrationAccountSessionFilter(BaseModel):
    """
    The integration account session filter.
    """ # noqa: E501
    changed_time: datetime = Field(description="The changed time of integration account sessions.", alias="changedTime")
    __properties: ClassVar[List[str]] = ["changedTime"]
