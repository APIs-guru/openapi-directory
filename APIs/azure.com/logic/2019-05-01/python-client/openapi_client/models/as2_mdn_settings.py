...
class AS2MdnSettings(BaseModel):
    ...
    send_inbound_mdnto_message_box: StrictBool = Field(description="The value indicating whether to send inbound MDN to message box.", alias="sendInboundMDNToMessageBox")
    ...
    sign_outbound_mdnif_optional: StrictBool = Field(description="The value indicating whether to sign the outbound MDN if optional.", alias="signOutboundMDNIfOptional")
