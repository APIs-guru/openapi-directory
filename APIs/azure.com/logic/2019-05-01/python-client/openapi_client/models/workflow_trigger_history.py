...
class WorkflowTriggerHistory(BaseModel):
    """
    The workflow trigger history.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets the workflow trigger history name.")
    properties: Optional[WorkflowTriggerHistoryProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Gets the workflow trigger history type.")
