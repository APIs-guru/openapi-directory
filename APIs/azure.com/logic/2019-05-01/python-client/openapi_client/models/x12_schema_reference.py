...
class X12SchemaReference(BaseModel):
    """
    ...
    schema_version: StrictStr = Field(description="The schema version.", alias="schemaVersion")
    ...
    __properties: ClassVar[List[str]] = ["messageId", "schemaName", "schemaVersion", "senderApplicationId"]
