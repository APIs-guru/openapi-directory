...
class AS2ProtocolSettings(BaseModel):
    ...
    """ # noqa: E501
    acknowledgement_connection_settings: AS2AcknowledgementConnectionSettings = Field(alias="acknowledgementConnectionSettings")
    envelope_settings: AS2EnvelopeSettings = Field(alias="envelopeSettings")
    error_settings: AS2ErrorSettings = Field(alias="errorSettings")
    mdn_settings: AS2MdnSettings = Field(alias="mdnSettings")
    message_connection_settings: AS2MessageConnectionSettings = Field(alias="messageConnectionSettings")
    security_settings: AS2SecuritySettings = Field(alias="securitySettings")
    validation_settings: AS2ValidationSettings = Field(alias="validationSettings")
