...
class WorkflowProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessEndpoint", "changedTime", "createdTime", "definition", "endpointsConfiguration", "integrationAccount", "integrationServiceEnvironment", "parameters", "provisioningState", "sku", "state", "version"]
