...
class WorkflowRunAction(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets the workflow run action name.")
    properties: Optional[WorkflowRunActionProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Gets the workflow run action type.")
