...
class IntegrationAccountProperties(BaseModel):
    """
    The integration account properties.
    """ # noqa: E501
    integration_service_environment: Optional[IntegrationServiceEnvironment] = Field(default=None, alias="integrationServiceEnvironment")
    state: Optional[WorkflowState] = None
    __properties: ClassVar[List[str]] = ["integrationServiceEnvironment", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrationServiceEnvironment": IntegrationServiceEnvironment.from_dict(obj["integrationServiceEnvironment"]) if obj.get("integrationServiceEnvironment") is not None else None,
            "state": obj.get("state")
        })
        return _obj
