...
class FlowEndpointsConfiguration(BaseModel):
    """
    The endpoints configuration.
    """ # noqa: E501
    connector: Optional[FlowEndpoints] = None
    workflow: Optional[FlowEndpoints] = None
    __properties: ClassVar[List[str]] = ["connector", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connector": FlowEndpoints.from_dict(obj["connector"]) if obj.get("connector") is not None else None,
            "workflow": FlowEndpoints.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj
