...
[**workflow_trigger_histories_resubmit**](WorkflowTriggerHistoriesApi.md#workflow_trigger_histories_resubmit) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/triggers/{triggerName}/histories/{historyName}/resubmit | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    history_name = 'history_name_example' # str | The workflow trigger history name. Corresponds to the run name for triggers that resulted in a run.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    filter = 'filter_example' # str | The filter to apply on the operation. Options for filters include: Status, StartTime, and ClientTrackingId. (optional)
 ...
 **filter** | **str**| The filter to apply on the operation. Options for filters include: Status, StartTime, and ClientTrackingId. | [optional] 
...
> workflow_trigger_histories_resubmit(subscription_id, resource_group_name, workflow_name, trigger_name, history_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.workflow_trigger_histories_resubmit(subscription_id, resource_group_name, workflow_name, trigger_name, history_name, api_version)
    except Exception as e:
        print("Exception when calling WorkflowTriggerHistoriesApi->workflow_trigger_histories_resubmit: %s\n" % e)
```
