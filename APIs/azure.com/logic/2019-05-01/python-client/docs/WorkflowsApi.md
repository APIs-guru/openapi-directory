...
> workflows_validate_by_location(subscription_id, resource_group_name, location, workflow_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.workflows_validate_by_location(subscription_id, resource_group_name, location, workflow_name, api_version)
    except Exception as e:
