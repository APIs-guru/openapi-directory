...
class IntegrationAccountPartnerFilter(BaseModel):
    """
    IntegrationAccountPartnerFilter
    """ # noqa: E501
    partner_type: Optional[PartnerType] = Field(default=None, alias="partnerType")
    __properties: ClassVar[List[str]] = ["partnerType"]
