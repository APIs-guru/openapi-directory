...
class X12EnvelopeSettings(BaseModel):
    ...
    X12EnvelopeSettings
    """ # noqa: E501
    control_standards_id: Optional[StrictInt] = Field(default=None, description="The controls standards id.", alias="controlStandardsId")
    control_version_number: Optional[StrictStr] = Field(default=None, description="The control version number.", alias="controlVersionNumber")
    enable_default_group_headers: Optional[StrictBool] = Field(default=None, description="The value indicating whether to enable default group headers.", alias="enableDefaultGroupHeaders")
    functional_group_id: Optional[StrictStr] = Field(default=None, description="The functional group id.", alias="functionalGroupId")
    group_control_number_lower_bound: Optional[StrictInt] = Field(default=None, description="The group control number lower bound.", alias="groupControlNumberLowerBound")
    group_control_number_upper_bound: Optional[StrictInt] = Field(default=None, description="The group control number upper bound.", alias="groupControlNumberUpperBound")
    group_header_agency_code: Optional[StrictStr] = Field(default=None, description="The group header agency code.", alias="groupHeaderAgencyCode")
    group_header_date_format: Optional[X12DateFormat] = Field(default=None, alias="groupHeaderDateFormat")
    group_header_time_format: Optional[X12TimeFormat] = Field(default=None, alias="groupHeaderTimeFormat")
    group_header_version: Optional[StrictStr] = Field(default=None, description="The group header version.", alias="groupHeaderVersion")
    interchange_control_number_lower_bound: Optional[StrictInt] = Field(default=None, description="The interchange  control number lower bound.", alias="interchangeControlNumberLowerBound")
    interchange_control_number_upper_bound: Optional[StrictInt] = Field(default=None, description="The interchange  control number upper bound.", alias="interchangeControlNumberUpperBound")
    overwrite_existing_transaction_set_control_number: Optional[StrictBool] = Field(default=None, description="The value indicating whether to overwrite existing transaction set control number.", alias="overwriteExistingTransactionSetControlNumber")
    ...
    rollover_group_control_number: Optional[StrictBool] = Field(default=None, description="The value indicating whether to rollover group control number.", alias="rolloverGroupControlNumber")
    rollover_interchange_control_number: Optional[StrictBool] = Field(default=None, description="The value indicating whether to rollover interchange control number.", alias="rolloverInterchangeControlNumber")
    rollover_transaction_set_control_number: Optional[StrictBool] = Field(default=None, description="The value indicating whether to rollover transaction set control number.", alias="rolloverTransactionSetControlNumber")
    ...
    transaction_set_control_number_lower_bound: Optional[StrictInt] = Field(default=None, description="The transaction set control number lower bound.", alias="transactionSetControlNumberLowerBound")
    ...
    transaction_set_control_number_upper_bound: Optional[StrictInt] = Field(default=None, description="The transaction set control number upper bound.", alias="transactionSetControlNumberUpperBound")
    usage_indicator: Optional[UsageIndicator] = Field(default=None, alias="usageIndicator")
    use_control_standards_id_as_repetition_character: Optional[StrictBool] = Field(default=None, description="The value indicating whether to use control standards id as repetition character.", alias="useControlStandardsIdAsRepetitionCharacter")
