...
class X12ProtocolSettings(BaseModel):
    ...
    X12ProtocolSettings
    """ # noqa: E501
    acknowledgement_settings: Optional[X12AcknowledgementSettings] = Field(default=None, alias="acknowledgementSettings")
    ...
    envelope_settings: Optional[X12EnvelopeSettings] = Field(default=None, alias="envelopeSettings")
    framing_settings: Optional[X12FramingSettings] = Field(default=None, alias="framingSettings")
    message_filter: Optional[X12MessageFilter] = Field(default=None, alias="messageFilter")
    ...
    processing_settings: Optional[X12ProcessingSettings] = Field(default=None, alias="processingSettings")
    schema_references: Optional[List[X12SchemaReference]] = Field(default=None, description="The X12 schema references.", alias="schemaReferences")
    security_settings: Optional[X12SecuritySettings] = Field(default=None, alias="securitySettings")
    ...
    validation_settings: Optional[X12ValidationSettings] = Field(default=None, alias="validationSettings")
