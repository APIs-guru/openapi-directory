...
class X12EnvelopeOverride(BaseModel):
    ...
    X12EnvelopeOverride
    """ # noqa: E501
    date_format: Optional[X12DateFormat] = Field(default=None, alias="dateFormat")
    ...
    header_version: Optional[StrictStr] = Field(default=None, description="The header version.", alias="headerVersion")
    ...
    protocol_version: Optional[StrictStr] = Field(default=None, description="The protocol version on which this envelope settings has to be applied.", alias="protocolVersion")
    ...
    responsible_agency_code: Optional[StrictInt] = Field(default=None, description="The responsible agency code.", alias="responsibleAgencyCode")
    ...
    time_format: Optional[X12TimeFormat] = Field(default=None, alias="timeFormat")
