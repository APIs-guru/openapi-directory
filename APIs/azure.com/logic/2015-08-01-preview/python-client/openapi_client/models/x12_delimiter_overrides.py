...
class X12DelimiterOverrides(BaseModel):
    ...
    replace_character: Optional[StrictInt] = Field(default=None, description="The replacement character.", alias="replaceCharacter")
    replace_separators_in_payload: Optional[StrictBool] = Field(default=None, description="The value indicating whether to replace separators in payload.", alias="replaceSeparatorsInPayload")
