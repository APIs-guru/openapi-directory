...
class EdifactEnvelopeSettings(BaseModel):
    ...
    apply_delimiter_string_advice: Optional[StrictBool] = Field(default=None, description="The value indicating whether to apply delimiter string advice.", alias="applyDelimiterStringAdvice")
    ...
    create_grouping_segments: Optional[StrictBool] = Field(default=None, description="The value indicating whether to create grouping segments.", alias="createGroupingSegments")
    ...
    is_test_interchange: Optional[StrictBool] = Field(default=None, description="The value indicating whether the message is a test interchange.", alias="isTestInterchange")
