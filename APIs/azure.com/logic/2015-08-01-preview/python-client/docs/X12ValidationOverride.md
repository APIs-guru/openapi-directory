...
**message_id** | **str** | The message id on which the validation settings has to be applied. | [optional] 
...
**validate_character_set** | **bool** | The value indicating whether to validate character Set. | [optional] 
**validate_edi_types** | **bool** | The value indicating whether to validate EDI types. | [optional] 
**validate_xsd_types** | **bool** | The value indicating whether to validate XSD types. | [optional] 
