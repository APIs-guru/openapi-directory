...
class TestNetworkStatusContractByLocation(unittest.TestCase):
    """NetworkStatusContractByLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkStatusContractByLocation:
        """Test NetworkStatusContractByLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkStatusContractByLocation`
        """
        model = NetworkStatusContractByLocation()
        if include_optional:
            return NetworkStatusContractByLocation(
                location = '0',
                network_status = openapi_client.models.network_status_contract.NetworkStatusContract(
                    connectivity_status = [
    ...
    def testNetworkStatusContractByLocation(self):
        """Test NetworkStatusContractByLocation"""
