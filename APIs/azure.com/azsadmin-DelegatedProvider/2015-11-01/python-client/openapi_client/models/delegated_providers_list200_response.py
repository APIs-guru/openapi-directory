...
class DelegatedProvidersList200Response(BaseModel):
    """
    List of subscriptions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI to the next page.", alias="nextLink")
    value: Optional[List[DelegatedProvidersList200ResponseValueInner]] = Field(default=None, description="Subscription definition.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DelegatedProvidersList200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
