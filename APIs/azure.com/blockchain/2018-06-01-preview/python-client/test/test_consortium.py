...
class TestConsortium(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Consortium:
        """Test Consortium
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Consortium`
        """
        model = Consortium()
        if include_optional:
            return Consortium(
