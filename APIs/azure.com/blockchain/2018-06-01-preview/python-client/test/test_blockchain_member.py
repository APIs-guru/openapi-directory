...
class TestBlockchainMember(unittest.TestCase):
    """BlockchainMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockchainMember:
        """Test BlockchainMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockchainMember`
        """
        model = BlockchainMember()
        if include_optional:
