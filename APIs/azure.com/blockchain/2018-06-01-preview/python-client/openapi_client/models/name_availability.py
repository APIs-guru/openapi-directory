...
class NameAvailability(BaseModel):
    ...
    name_available: Optional[StrictBool] = Field(default=None, description="Gets or sets the value indicating whether the name is available.", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="Gets or sets the name availability reason.")
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['NotSpecified', 'AlreadyExists', 'Invalid']):
            raise ValueError("must be one of enum values ('NotSpecified', 'AlreadyExists', 'Invalid')")
        return value
