...
class TransactionNodeCollection(BaseModel):
    """
    ...
    value: Optional[List[TransactionNode]] = Field(default=None, description="Gets or sets the collection of transaction nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [TransactionNode.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
