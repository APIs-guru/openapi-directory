...
class BlockchainMemberCollection(BaseModel):
    """
    Collection of the blockchain member payload which is exposed in the request/response of the resource provider.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the URL, that the client should use to fetch the next page (per server side paging).  It's null for now, added for future use.", alias="nextLink")
    value: Optional[List[BlockchainMember]] = Field(default=None, description="Gets or sets the collection of blockchain members.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [BlockchainMember.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
