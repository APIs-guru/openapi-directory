...
class ResourceTypeSkuCollection(BaseModel):
    """
    Collection of the resource type Sku.
    """ # noqa: E501
    value: Optional[List[ResourceTypeSku]] = Field(default=None, description="Gets or sets the collection of resource type Sku.")
