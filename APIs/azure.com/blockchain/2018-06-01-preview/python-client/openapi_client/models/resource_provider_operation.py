...
class ResourceProviderOperation(BaseModel):
    ...
    is_data_action: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether the operation is a data action or not.", alias="isDataAction")
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the operation name.")
    origin: Optional[StrictStr] = Field(default=None, description="Gets or sets the origin.")
    __properties: ClassVar[List[str]] = ["display", "isDataAction", "name", "origin"]
