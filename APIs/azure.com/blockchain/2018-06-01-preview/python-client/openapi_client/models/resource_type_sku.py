...
class ResourceTypeSku(BaseModel):
    ...
    skus: Optional[List[SkuSetting]] = Field(default=None, description="Gets or sets the Skus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skus": [SkuSetting.from_dict(_item) for _item in obj["skus"]] if obj.get("skus") is not None else None
        })
        return _obj
