...
class ResourceProviderOperationCollection(BaseModel):
    """
    ...
    value: Optional[List[ResourceProviderOperation]] = Field(default=None, description="Gets or sets the collection of operations.")
