...
class NameAvailabilityRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name to check.")
    type: Optional[StrictStr] = Field(default=None, description="Gets or sets the type of the resource to check.")
