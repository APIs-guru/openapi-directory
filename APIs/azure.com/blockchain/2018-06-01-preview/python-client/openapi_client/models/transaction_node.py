...
class TransactionNode(BaseModel):
    ...
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Gets or sets the transaction node location.")
    properties: Optional[TransactionNodeProperties] = None
    id: Optional[StrictStr] = Field(default=None, description="Fully qualified resource Id of the resource.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the resource.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the service - e.g. \"Microsoft.Blockchain\"")
