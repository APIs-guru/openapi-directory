...
class ConsortiumCollection(BaseModel):
    """
    Collection of the consortium payload.
    """ # noqa: E501
    value: Optional[List[Consortium]] = Field(default=None, description="Gets or sets the collection of consortiums.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Consortium.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
