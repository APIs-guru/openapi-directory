...
class DscConfigurationProperties(BaseModel):
    """
    ...
    job_count: Optional[StrictInt] = Field(default=None, description="Gets or sets the job count of the configuration.", alias="jobCount")
    ...
    node_configuration_count: Optional[StrictInt] = Field(default=None, description="Gets the number of compiled node configurations.", alias="nodeConfigurationCount")
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets or sets the provisioning state of the configuration.", alias="provisioningState")
    source: Optional[ContentSource] = None
    state: Optional[StrictStr] = Field(default=None, description="Gets or sets the state of the configuration.")
    __properties: ClassVar[List[str]] = ["creationTime", "description", "jobCount", "lastModifiedTime", "logVerbose", "nodeConfigurationCount", "parameters", "provisioningState", "source", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodeConfigurationCount": obj.get("nodeConfigurationCount"),
            "parameters": dict(
