...
class TestDscConfigurationProperties(unittest.TestCase):
    """DscConfigurationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DscConfigurationProperties:
        """Test DscConfigurationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DscConfigurationProperties`
        """
        model = DscConfigurationProperties()
        if include_optional:
            return DscConfigurationProperties(
    ...
    def testDscConfigurationProperties(self):
        """Test DscConfigurationProperties"""
