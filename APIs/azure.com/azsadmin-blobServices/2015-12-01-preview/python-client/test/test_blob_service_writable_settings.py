...
class TestBlobServiceWritableSettings(unittest.TestCase):
    """BlobServiceWritableSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlobServiceWritableSettings:
        """Test BlobServiceWritableSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlobServiceWritableSettings`
        """
        model = BlobServiceWritableSettings()
        if include_optional:
            return BlobServiceWritableSettings(
    ...
    def testBlobServiceWritableSettings(self):
        """Test BlobServiceWritableSettings"""
