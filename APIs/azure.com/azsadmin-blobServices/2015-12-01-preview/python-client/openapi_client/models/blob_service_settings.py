...
class BlobServiceSettings(BaseModel):
    """
    Blob service settings.
    """ # noqa: E501
    blob_svc_container_gc_interval: Optional[StrictInt] = Field(default=None, description="The interval, in seconds, of container garbage collection.", alias="blobSvcContainerGcInterval")
    blob_svc_shallow_gc_interval: Optional[StrictInt] = Field(default=None, description="The interval ,in seconds, of shallow garbage collection.", alias="blobSvcShallowGcInterval")
    blob_svc_stream_map_min_container_occupancy_percent: Optional[StrictInt] = Field(default=None, description="The minimal container occupancy percent for stream mapping.", alias="blobSvcStreamMapMinContainerOccupancyPercent")
    front_end_http_listen_port: Optional[StrictInt] = Field(default=None, description="The HTTP port of the storage service front end.", alias="frontEndHttpListenPort")
    front_end_https_listen_port: Optional[StrictInt] = Field(default=None, description="The HTTPs port of the storage service front end.", alias="frontEndHttpsListenPort")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        excluded_fields: Set[str] = set([
            "blob_svc_container_gc_interval",
            "blob_svc_shallow_gc_interval",
            "blob_svc_stream_map_min_container_occupancy_percent",
        ])
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blobSvcContainerGcInterval": obj.get("blobSvcContainerGcInterval"),
            "blobSvcShallowGcInterval": obj.get("blobSvcShallowGcInterval"),
            "blobSvcStreamMapMinContainerOccupancyPercent": obj.get("blobSvcStreamMapMinContainerOccupancyPercent"),
            "frontEndHttpListenPort": obj.get("frontEndHttpListenPort"),
            "frontEndHttpsListenPort": obj.get("frontEndHttpsListenPort"),
