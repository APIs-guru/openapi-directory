...
class BlobServicesListMetricDefinitions200ResponseValueInner(BaseModel):
    """
    Metric definition.
    """ # noqa: E501
    metric_availabilities: Optional[List[BlobServicesListMetricDefinitions200ResponseValueInnerMetricAvailabilitiesInner]] = Field(default=None, description="Metric availabilities.", alias="metricAvailabilities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metricAvailabilities": [BlobServicesListMetricDefinitions200ResponseValueInnerMetricAvailabilitiesInner.from_dict(_item) for _item in obj["metricAvailabilities"]] if obj.get("metricAvailabilities") is not None else None,
