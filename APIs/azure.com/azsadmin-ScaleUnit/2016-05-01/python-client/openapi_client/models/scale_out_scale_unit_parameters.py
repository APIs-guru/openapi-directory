...
class ScaleOutScaleUnitParameters(BaseModel):
    """
    ...
    computer_name: Optional[StrictStr] = Field(default=None, description="Computer name of the physical machine.", alias="computerName")
    __properties: ClassVar[List[str]] = ["bmcIpv4Address", "computerName"]
