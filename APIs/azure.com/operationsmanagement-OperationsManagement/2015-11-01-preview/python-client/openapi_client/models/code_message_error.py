...
class CodeMessageError(BaseModel):
    """
    The error body contract.
    """ # noqa: E501
    error: Optional[CodeMessageErrorError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": CodeMessageErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
