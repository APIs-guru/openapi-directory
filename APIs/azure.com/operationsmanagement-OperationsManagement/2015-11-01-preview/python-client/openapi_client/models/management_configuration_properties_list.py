...
class ManagementConfigurationPropertiesList(BaseModel):
    """
    the list of ManagementConfiguration response
    """ # noqa: E501
    value: Optional[List[ManagementConfiguration]] = Field(default=None, description="List of Management Configuration properties within the subscription.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ManagementConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
