...
class ManagementAssociationPropertiesList(BaseModel):
    """
    the list of ManagementAssociation response
    """ # noqa: E501
    value: Optional[List[ManagementAssociation]] = Field(default=None, description="List of Management Association properties within the subscription.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ManagementAssociation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
