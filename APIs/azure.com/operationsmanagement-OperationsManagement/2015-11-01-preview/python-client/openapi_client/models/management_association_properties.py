...
class ManagementAssociationProperties(BaseModel):
    """
    ManagementAssociation properties supported by the OperationsManagement resource provider.
    """ # noqa: E501
    application_id: StrictStr = Field(description="The applicationId of the appliance for this association.", alias="applicationId")
