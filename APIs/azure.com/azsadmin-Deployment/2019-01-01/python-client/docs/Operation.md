...
**name** | **str** | The name of the operation being performed on this particular object. This name should match the name that appears in RBAC or the event service. | [optional] 
**origin** | **str** | Origin for the operation. Eg. User, System | [optional] 
