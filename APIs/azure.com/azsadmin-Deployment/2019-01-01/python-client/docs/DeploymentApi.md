...
------------- | ------------- | -------------
[**operations_list**](DeploymentApi.md#operations_list) | **GET** /providers/Microsoft.Deployment.Admin/operations | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DeploymentApi->operations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DeploymentApi->operations_list: %s\n" % e)
```
