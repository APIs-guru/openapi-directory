...
class MetricSettings(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Name of a Diagnostic Metric category for a resource type this setting is applied to. To obtain the list of Diagnostic metric categories for a resource, first perform a GET diagnostic settings operation.")
    enabled: StrictBool = Field(description="a value indicating whether this category is enabled.")
    retention_policy: Optional[RetentionPolicy] = Field(default=None, alias="retentionPolicy")
    time_grain: Optional[StrictStr] = Field(default=None, description="the timegrain of the metric in ISO8601 format.", alias="timeGrain")
    __properties: ClassVar[List[str]] = ["category", "enabled", "retentionPolicy", "timeGrain"]
