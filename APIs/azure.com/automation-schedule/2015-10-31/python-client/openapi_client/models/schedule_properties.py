...
class ScheduleProperties(BaseModel):
    ...
    expiry_time_offset_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the expiry time's offset in minutes.", alias="expiryTimeOffsetMinutes")
    frequency: Optional[ScheduleFrequency] = None
    interval: Optional[Dict[str, Any]] = Field(default=None, description="Gets or sets the interval of the schedule.")
    is_enabled: Optional[StrictBool] = Field(default=False, description="Gets or sets a value indicating whether this schedule is enabled.", alias="isEnabled")
    ...
    next_run: Optional[datetime] = Field(default=None, description="Gets or sets the next run time of the schedule.", alias="nextRun")
    next_run_offset_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets or sets the next run time's offset in minutes.", alias="nextRunOffsetMinutes")
    start_time: Optional[datetime] = Field(default=None, description="Gets or sets the start time of the schedule.", alias="startTime")
    start_time_offset_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gets the start time's offset in minutes.", alias="startTimeOffsetMinutes")
    time_zone: Optional[StrictStr] = Field(default=None, description="Gets or sets the time zone of the schedule.", alias="timeZone")
    __properties: ClassVar[List[str]] = ["advancedSchedule", "creationTime", "description", "expiryTime", "expiryTimeOffsetMinutes", "frequency", "interval", "isEnabled", "lastModifiedTime", "nextRun", "nextRunOffsetMinutes", "startTime", "startTimeOffsetMinutes", "timeZone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expiryTimeOffsetMinutes": obj.get("expiryTimeOffsetMinutes"),
            ...
            "nextRunOffsetMinutes": obj.get("nextRunOffsetMinutes"),
            "startTime": obj.get("startTime"),
            "startTimeOffsetMinutes": obj.get("startTimeOffsetMinutes"),
