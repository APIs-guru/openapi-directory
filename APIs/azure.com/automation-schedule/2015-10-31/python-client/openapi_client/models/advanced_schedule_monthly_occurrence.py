...
class AdvancedScheduleMonthlyOccurrence(BaseModel):
    """
    The properties of the create advanced schedule monthly occurrence.
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Day of the occurrence. Must be one of monday, tuesday, wednesday, thursday, friday, saturday, sunday.")
    occurrence: Optional[StrictInt] = Field(default=None, description="Occurrence of the week within the month. Must be between 1 and 5")
