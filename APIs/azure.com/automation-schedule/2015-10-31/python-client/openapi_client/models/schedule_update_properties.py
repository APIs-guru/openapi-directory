...
class ScheduleUpdateProperties(BaseModel):
    """
    ...
    is_enabled: Optional[StrictBool] = Field(default=None, description="Gets or sets a value indicating whether this schedule is enabled.", alias="isEnabled")
    __properties: ClassVar[List[str]] = ["description", "isEnabled"]
