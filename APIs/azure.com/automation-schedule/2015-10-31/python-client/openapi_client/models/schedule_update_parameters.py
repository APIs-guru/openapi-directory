...
class ScheduleUpdateParameters(BaseModel):
    """
    The parameters supplied to the update schedule operation.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the Schedule.")
    properties: Optional[ScheduleUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": ScheduleUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
