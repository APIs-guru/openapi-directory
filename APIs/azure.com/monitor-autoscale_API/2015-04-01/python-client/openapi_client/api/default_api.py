...
class DefaultApi:
    ...
    def autoscale_settings_update(
        ...
        autoscale_setting_name: Annotated[StrictStr, Field(description="The autoscale setting name.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        autoscale_setting_resource: Annotated[AutoscaleSettingResourcePatch, Field(description="Parameters supplied to the operation.")],
        ...
        :type autoscale_setting_resource: AutoscaleSettingResourcePatch
        ...
        _param = self._autoscale_settings_update_serialize(
    ...
    @validate_call
    def autoscale_settings_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Azure subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        autoscale_setting_name: Annotated[StrictStr, Field(description="The autoscale setting name.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutoscaleSettingResource]:
        """autoscale_settings_update
    ...
    @validate_call
    def autoscale_settings_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Azure subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        autoscale_setting_name: Annotated[StrictStr, Field(description="The autoscale setting name.")],
    ...
    def _autoscale_settings_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        ...
        if autoscale_setting_name is not None:
            _path_params['autoscaleSettingName'] = autoscale_setting_name
        ...
        if autoscale_setting_resource is not None:
            _body_params = autoscale_setting_resource
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/microsoft.insights/autoscalesettings/{autoscaleSettingName}',
