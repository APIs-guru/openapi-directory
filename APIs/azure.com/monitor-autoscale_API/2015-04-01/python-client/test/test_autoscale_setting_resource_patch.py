...
class TestAutoscaleSettingResourcePatch(unittest.TestCase):
    """AutoscaleSettingResourcePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoscaleSettingResourcePatch:
        """Test AutoscaleSettingResourcePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoscaleSettingResourcePatch`
        """
        model = AutoscaleSettingResourcePatch()
        if include_optional:
            return AutoscaleSettingResourcePatch(
    ...
    def testAutoscaleSettingResourcePatch(self):
        """Test AutoscaleSettingResourcePatch"""
