...
class RecommendedElasticPoolListMetricsResult(BaseModel):
    """
    Represents the response to a list recommended elastic pool metrics request.
    """ # noqa: E501
    value: List[RecommendedElasticPoolMetric] = Field(description="The list of recommended elastic pools metrics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RecommendedElasticPoolMetric.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
