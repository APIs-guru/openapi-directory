...
class TestRecommendedElasticPoolListResult(unittest.TestCase):
    """RecommendedElasticPoolListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendedElasticPoolListResult:
        """Test RecommendedElasticPoolListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendedElasticPoolListResult`
        """
        model = RecommendedElasticPoolListResult()
        if include_optional:
            return RecommendedElasticPoolListResult(
                value = [
                    openapi_client.models.recommended_elastic_pool.RecommendedElasticPool(
    ...
    def testRecommendedElasticPoolListResult(self):
        """Test RecommendedElasticPoolListResult"""
