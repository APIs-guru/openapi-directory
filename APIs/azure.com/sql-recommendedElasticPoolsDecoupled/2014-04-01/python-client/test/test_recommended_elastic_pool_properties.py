...
class TestRecommendedElasticPoolProperties(unittest.TestCase):
    """RecommendedElasticPoolProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendedElasticPoolProperties:
        """Test RecommendedElasticPoolProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendedElasticPoolProperties`
        """
        model = RecommendedElasticPoolProperties()
        if include_optional:
            return RecommendedElasticPoolProperties(
    ...
    def testRecommendedElasticPoolProperties(self):
        """Test RecommendedElasticPoolProperties"""
