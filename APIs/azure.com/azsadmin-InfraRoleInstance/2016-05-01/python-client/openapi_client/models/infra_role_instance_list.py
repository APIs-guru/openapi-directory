...
class InfraRoleInstanceList(BaseModel):
    """
    ...
    value: Optional[List[InfraRoleInstance]] = Field(default=None, description="List of infrastructure role instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [InfraRoleInstance.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
