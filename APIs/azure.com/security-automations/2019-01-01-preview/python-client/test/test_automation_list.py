...
class TestAutomationList(unittest.TestCase):
    """AutomationList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationList:
        """Test AutomationList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationList`
        """
        model = AutomationList()
        if include_optional:
