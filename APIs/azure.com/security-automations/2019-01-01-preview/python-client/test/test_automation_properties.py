...
class TestAutomationProperties(unittest.TestCase):
    """AutomationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationProperties:
        """Test AutomationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationProperties`
        """
    ...
    def testAutomationProperties(self):
        """Test AutomationProperties"""
