...
class AutomationActionWorkspace(AutomationAction):
    ...
    """ # noqa: E501
    workspace_resource_id: Optional[StrictStr] = Field(default=None, description="The fully qualified Log Analytics Workspace Azure Resource ID.", alias="workspaceResourceId")
