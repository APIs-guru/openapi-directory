...
class AutomationActionEventHub(AutomationAction):
    ...
    """ # noqa: E501
    connection_string: Optional[StrictStr] = Field(default=None, description="The target Event Hub connection string (it will not be included in any response).", alias="connectionString")
    event_hub_resource_id: Optional[StrictStr] = Field(default=None, description="The target Event Hub Azure Resource ID.", alias="eventHubResourceId")
    sas_policy_name: Optional[StrictStr] = Field(default=None, description="The target Event Hub SAS policy name.", alias="sasPolicyName")
