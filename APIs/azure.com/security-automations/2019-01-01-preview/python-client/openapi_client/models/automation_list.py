...
class AutomationList(BaseModel):
    ...
    value: List[Automation] = Field(description="The list of security automations under the given scope.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Automation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
