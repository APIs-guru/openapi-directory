...
------------ | ------------- | ------------- | -------------
**dependency_action** | **str** | Possible values are &#39;satisfy&#39; (allowing dependent tasks to progress) and &#39;block&#39; (dependent tasks continue to wait). Batch does not yet support cancellation of dependent tasks. | [optional] 
