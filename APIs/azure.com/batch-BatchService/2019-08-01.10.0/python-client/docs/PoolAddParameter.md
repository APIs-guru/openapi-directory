...
**mount_configuration** | [**List[MountConfiguration]**](MountConfiguration.md) | Mount the storage using Azure fileshare, NFS, CIFS or Blobfuse based file system. | [optional] 
