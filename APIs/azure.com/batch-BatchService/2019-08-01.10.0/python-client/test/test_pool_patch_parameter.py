...
class TestPoolPatchParameter(unittest.TestCase):
    """PoolPatchParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoolPatchParameter:
        """Test PoolPatchParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoolPatchParameter`
        """
        model = PoolPatchParameter()
        if include_optional:
    ...
    def testPoolPatchParameter(self):
        """Test PoolPatchParameter"""
