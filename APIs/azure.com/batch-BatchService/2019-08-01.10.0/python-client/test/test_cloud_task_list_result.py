...
class TestCloudTaskListResult(unittest.TestCase):
    """CloudTaskListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudTaskListResult:
        """Test CloudTaskListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudTaskListResult`
        """
        model = CloudTaskListResult()
        if include_optional:
            return CloudTaskListResult(
                odata_next_link = '',
                value = [
                    openapi_client.models.an_azure_batch_task/.An Azure Batch Task.(
    ...
    def testCloudTaskListResult(self):
        """Test CloudTaskListResult"""
