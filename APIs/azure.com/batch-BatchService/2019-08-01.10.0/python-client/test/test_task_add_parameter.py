...
class TestTaskAddParameter(unittest.TestCase):
    """TaskAddParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskAddParameter:
        """Test TaskAddParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskAddParameter`
        """
