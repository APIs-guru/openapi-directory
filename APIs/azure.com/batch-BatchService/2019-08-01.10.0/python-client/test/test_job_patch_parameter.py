...
class TestJobPatchParameter(unittest.TestCase):
    """JobPatchParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPatchParameter:
        """Test JobPatchParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPatchParameter`
        """
    ...
    def testJobPatchParameter(self):
        """Test JobPatchParameter"""
