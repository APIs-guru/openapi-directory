...
class TestJobScheduleAddParameter(unittest.TestCase):
    """JobScheduleAddParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobScheduleAddParameter:
        """Test JobScheduleAddParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobScheduleAddParameter`
        """
        model = JobScheduleAddParameter()
        if include_optional:
            return JobScheduleAddParameter(
                display_name = '',
                id = '',
    ...
    def testJobScheduleAddParameter(self):
        """Test JobScheduleAddParameter"""
