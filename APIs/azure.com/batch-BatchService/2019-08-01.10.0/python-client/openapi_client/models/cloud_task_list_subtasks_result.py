...
class CloudTaskListSubtasksResult(BaseModel):
    """
    CloudTaskListSubtasksResult
    """ # noqa: E501
    value: Optional[List[SubtaskInformation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SubtaskInformation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
