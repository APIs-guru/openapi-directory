...
class JobScheduleStatistics(BaseModel):
    """
    JobScheduleStatistics
    """ # noqa: E501
    kernel_cpu_time: StrictStr = Field(alias="kernelCPUTime")
    last_update_time: datetime = Field(alias="lastUpdateTime")
    num_failed_tasks: StrictInt = Field(alias="numFailedTasks")
    num_succeeded_tasks: StrictInt = Field(alias="numSucceededTasks")
    ...
    wait_time: StrictStr = Field(description="This value is only reported in the Account lifetime statistics; it is not included in the Job statistics.", alias="waitTime")
