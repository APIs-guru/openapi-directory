...
class PoolAddParameter(BaseModel):
    """
    PoolAddParameter
    """ # noqa: E501
    ...
    id: StrictStr = Field(description="The ID can contain any combination of alphanumeric characters including hyphens and underscores, and cannot contain more than 64 characters. The ID is case-preserving and case-insensitive (that is, you may not have two Pool IDs within an Account that differ only by case).")
    ...
    mount_configuration: Optional[List[MountConfiguration]] = Field(default=None, description="Mount the storage using Azure fileshare, NFS, CIFS or Blobfuse based file system.", alias="mountConfiguration")
