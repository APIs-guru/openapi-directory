...
class JobSpecification(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="The name need not be unique and can contain any Unicode characters up to a maximum length of 1024.", alias="displayName")
    ...
    priority: Optional[StrictInt] = Field(default=None, description="Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. The default value is 0. This priority is used as the default for all Jobs under the Job Schedule. You can update a Job's priority after it has been created using by using the update Job API.")
    uses_task_dependencies: Optional[StrictBool] = Field(default=None, alias="usesTaskDependencies")
    __properties: ClassVar[List[str]] = ["commonEnvironmentSettings", "constraints", "displayName", "jobManagerTask", "jobPreparationTask", "jobReleaseTask", "metadata", "networkConfiguration", "onAllTasksComplete", "onTaskFailure", "poolInfo", "priority", "usesTaskDependencies"]
