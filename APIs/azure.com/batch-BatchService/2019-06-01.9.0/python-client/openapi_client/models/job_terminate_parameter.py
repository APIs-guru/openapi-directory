...
class JobTerminateParameter(BaseModel):
    """
    JobTerminateParameter
    """ # noqa: E501
    terminate_reason: Optional[StrictStr] = Field(default=None, alias="terminateReason")
    __properties: ClassVar[List[str]] = ["terminateReason"]
