...
class JobScheduleUpdateParameter(BaseModel):
    """
    JobScheduleUpdateParameter
    """ # noqa: E501
    job_specification: JobSpecification = Field(alias="jobSpecification")
    metadata: Optional[List[MetadataItem]] = Field(default=None, description="If you do not specify this element, it takes the default value of an empty list; in effect, any existing metadata is deleted.")
    schedule: Schedule
