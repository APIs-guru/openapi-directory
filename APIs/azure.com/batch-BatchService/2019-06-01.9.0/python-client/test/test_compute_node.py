    ...
    def make_instance(self, include_optional) -> ComputeNode:
        ...
        if include_optional:
            return ComputeNode(
                ...
                start_task_info = openapi_client.models.information_about_a_start_task_running_on_a_compute_node/.Information about a start Task running on a Compute Node.(
                    container_info = openapi_client.models.contains_information_about_the_container_which_a_task_is_executing/.Contains information about the container which a Task is executing.(
                        container_id = '', 
                        error = '', 
                        state = '', ), 
