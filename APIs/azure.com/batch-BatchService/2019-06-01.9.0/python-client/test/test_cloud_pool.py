...
class TestCloudPool(unittest.TestCase):
    """CloudPool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudPool:
        """Test CloudPool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudPool`
        """
        model = CloudPool()
        if include_optional:
            return CloudPool(
