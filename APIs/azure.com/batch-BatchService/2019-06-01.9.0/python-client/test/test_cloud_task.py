...
class TestCloudTask(unittest.TestCase):
    """CloudTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudTask:
        """Test CloudTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudTask`
        """
        model = CloudTask()
        if include_optional:
            return CloudTask(
                ...
                stats = openapi_client.models.resource_usage_statistics_for_a_task/.Resource usage statistics for a Task.(
                    kernel_cpu_time = '', 
