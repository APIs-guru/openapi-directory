...
[**account_list_supported_images**](AccountsApi.md#account_list_supported_images) | **GET** /supportedimages | Lists all Virtual Machine Images supported by the Azure Batch service.
...
# **account_list_supported_images**
> AccountListSupportedImagesResult account_list_supported_images(api_version, filter=filter, maxresults=maxresults, timeout=timeout, client_request_id=client_request_id, return_client_request_id=return_client_request_id, ocp_date=ocp_date)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AccountsApi(api_client)
    api_version = 'api_version_example' # str | Client API Version.
    filter = 'filter_example' # str | An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-support-images. (optional)
    ...
    try:
        # Lists all Virtual Machine Images supported by the Azure Batch service.
        api_response = api_instance.account_list_supported_images(api_version, filter=filter, maxresults=maxresults, timeout=timeout, client_request_id=client_request_id, return_client_request_id=return_client_request_id, ocp_date=ocp_date)
        print("The response of AccountsApi->account_list_supported_images:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountsApi->account_list_supported_images: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **api_version** | **str**| Client API Version. | 
 **filter** | **str**| An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-support-images. | [optional] 
