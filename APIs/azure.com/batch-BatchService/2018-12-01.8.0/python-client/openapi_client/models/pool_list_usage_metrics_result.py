...
class PoolListUsageMetricsResult(BaseModel):
    """
    PoolListUsageMetricsResult
    """ # noqa: E501
    odata_next_link: Optional[StrictStr] = Field(default=None, alias="odata.nextLink")
    value: Optional[List[PoolUsageMetrics]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PoolUsageMetrics.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
