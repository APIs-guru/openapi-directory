...
class PoolSpecification(BaseModel):
    ...
    application_package_references: Optional[List[ApplicationPackageReference]] = Field(default=None, description="Changes to application package references affect all new compute nodes joining the pool, but do not affect compute nodes that are already in the pool until they are rebooted or reimaged. There is a maximum of 10 application package references on any given pool.", alias="applicationPackageReferences")
    ...
    enable_inter_node_communication: Optional[StrictBool] = Field(default=None, description="Enabling inter-node communication limits the maximum size of the pool due to deployment restrictions on the nodes of the pool. This may result in the pool not reaching its desired size. The default value is false.", alias="enableInterNodeCommunication")
