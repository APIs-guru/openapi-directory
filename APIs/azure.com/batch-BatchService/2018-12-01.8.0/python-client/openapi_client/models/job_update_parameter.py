...
class JobUpdateParameter(BaseModel):
    """
    JobUpdateParameter
    """ # noqa: E501
    constraints: Optional[JobConstraints] = None
    metadata: Optional[List[MetadataItem]] = Field(default=None, description="If omitted, it takes the default value of an empty list; in effect, any existing metadata is deleted.")
    ...
    priority: Optional[StrictInt] = Field(default=None, description="Priority values can range from -1000 to 1000, with -1000 being the lowest priority and 1000 being the highest priority. If omitted, it is set to the default value 0.")
