...
class OutputFileDestination(BaseModel):
    ...
    """ # noqa: E501
    container: Optional[OutputFileBlobContainerDestination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "container": OutputFileBlobContainerDestination.from_dict(obj["container"]) if obj.get("container") is not None else None
        })
        return _obj
