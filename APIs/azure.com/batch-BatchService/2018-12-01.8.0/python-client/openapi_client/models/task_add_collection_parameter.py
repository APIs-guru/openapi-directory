...
class TaskAddCollectionParameter(BaseModel):
    """
    TaskAddCollectionParameter
    """ # noqa: E501
    value: Annotated[List[TaskAddParameter], Field(max_length=100)] = Field(description="The total serialized size of this collection must be less than 1MB. If it is greater than 1MB (for example if each task has 100's of resource files or environment variables), the request will fail with code 'RequestBodyTooLarge' and should be retried again with fewer tasks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TaskAddParameter.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
