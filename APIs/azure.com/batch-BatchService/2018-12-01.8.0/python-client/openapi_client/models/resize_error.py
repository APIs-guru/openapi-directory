...
class ResizeError(BaseModel):
    ...
    values: Optional[List[NameValuePair]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [NameValuePair.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
