...
class TestCloudJobScheduleListResult(unittest.TestCase):
    """CloudJobScheduleListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudJobScheduleListResult:
        """Test CloudJobScheduleListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudJobScheduleListResult`
        """
        model = CloudJobScheduleListResult()
        if include_optional:
            return CloudJobScheduleListResult(
                odata_next_link = '',
                value = [
                    openapi_client.models.a_job_schedule_that_allows_recurring_jobs_by_specifying_when_to_run_jobs_and_a_specification_used_to_create_each_job/.A job schedule that allows recurring jobs by specifying when to run jobs and a specification used to create each job.(
    ...
    def testCloudJobScheduleListResult(self):
        """Test CloudJobScheduleListResult"""
