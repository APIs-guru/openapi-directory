...
class TestCloudJobListResult(unittest.TestCase):
    """CloudJobListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudJobListResult:
        """Test CloudJobListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudJobListResult`
        """
        model = CloudJobListResult()
        if include_optional:
            return CloudJobListResult(
                odata_next_link = '',
                value = [
                    openapi_client.models.an_azure_batch_job/.An Azure Batch job.(
                        ...
                        display_name = '', 
                        e_tag = '', 
                        execution_info = openapi_client.models.contains_information_about_the_execution_of_a_job_in_the_azure_batch_service/.Contains information about the execution of a job in the Azure Batch service.(
                            end_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            pool_id = '', 
                            scheduling_error = openapi_client.models.an_error_encountered_by_the_batch_service_when_scheduling_a_job/.An error encountered by the Batch service when scheduling a job.(
                                category = 'usererror', 
                                code = '', 
                                details = [
                        ...
                        stats = openapi_client.models.resource_usage_statistics_for_a_job/.Resource usage statistics for a job.(
                            kernel_cpu_time = '', 
    ...
    def testCloudJobListResult(self):
        """Test CloudJobListResult"""
