...
class TestPoolAddParameter(unittest.TestCase):
    """PoolAddParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoolAddParameter:
        """Test PoolAddParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoolAddParameter`
        """
        model = PoolAddParameter()
        if include_optional:
