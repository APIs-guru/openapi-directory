...
class TestJobSchedulePatchParameter(unittest.TestCase):
    """JobSchedulePatchParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobSchedulePatchParameter:
        """Test JobSchedulePatchParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobSchedulePatchParameter`
        """
        model = JobSchedulePatchParameter()
        if include_optional:
    ...
    def testJobSchedulePatchParameter(self):
        """Test JobSchedulePatchParameter"""
