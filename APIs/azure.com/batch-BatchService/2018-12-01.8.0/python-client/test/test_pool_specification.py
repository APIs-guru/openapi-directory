...
class TestPoolSpecification(unittest.TestCase):
    """PoolSpecification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PoolSpecification:
        """Test PoolSpecification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PoolSpecification`
        """
    ...
    def testPoolSpecification(self):
        """Test PoolSpecification"""
