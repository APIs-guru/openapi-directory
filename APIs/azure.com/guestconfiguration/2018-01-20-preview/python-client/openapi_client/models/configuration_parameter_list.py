...
class ConfigurationParameterList(BaseModel):
    """
    Represents the list for configuration parameters.
    """ # noqa: E501
    value: Optional[List[ConfigurationParameter]] = Field(default=None, description="Represents the list for configuration parameters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConfigurationParameter.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
