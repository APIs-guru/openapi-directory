...
class ConfigurationParameter(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the configuration parameter.")
    value: Optional[StrictStr] = Field(default=None, description="Value of the configuration parameter.")
