...
class OperationsList200ResponseValueInnerProperties(BaseModel):
    """
    Provider, Resource, Operation and description values.
    """ # noqa: E501
    status_code: Optional[StrictStr] = Field(default=None, description="Service provider: Microsoft.GuestConfiguration", alias="statusCode")
