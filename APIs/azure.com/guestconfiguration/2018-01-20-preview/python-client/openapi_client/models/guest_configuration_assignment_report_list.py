...
class GuestConfigurationAssignmentReportList(BaseModel):
    """
    The response of the list guest configuration assignment report operation.
    """ # noqa: E501
    value: Optional[List[GuestConfigurationAssignmentReport]] = Field(default=None, description="List of reports for the guest configuration. Report contains information such as compliance status, reason and more.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GuestConfigurationAssignmentReport.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
