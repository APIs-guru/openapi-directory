...
class AssignmentInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["configuration", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": ConfigurationInfo.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "name": obj.get("name")
        })
        return _obj
