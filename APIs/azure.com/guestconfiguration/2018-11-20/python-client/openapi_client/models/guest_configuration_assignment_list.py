...
class GuestConfigurationAssignmentList(BaseModel):
    """
    The response of the list guest configuration assignment operation.
    """ # noqa: E501
    value: Optional[List[GuestConfigurationAssignment]] = Field(default=None, description="Result of the list guest configuration assignment operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GuestConfigurationAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
