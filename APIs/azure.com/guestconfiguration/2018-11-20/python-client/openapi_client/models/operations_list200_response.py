...
class OperationsList200Response(BaseModel):
    """
    The response model for the list of Automation operations
    """ # noqa: E501
    value: Optional[List[OperationsList200ResponseValueInner]] = Field(default=None, description="List of Automation operations supported by the Automation resource provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [OperationsList200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
