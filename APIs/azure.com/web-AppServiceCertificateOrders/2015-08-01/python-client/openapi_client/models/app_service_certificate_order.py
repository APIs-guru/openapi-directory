...
class AppServiceCertificateOrder(BaseModel):
    """
    SSL certificate purchase order.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="AppServiceCertificateOrder resource specific properties")
