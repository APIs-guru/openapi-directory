...
class RenewCertificateOrderRequest(BaseModel):
    """
    Class representing certificate renew request.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="RenewCertificateOrderRequest resource specific properties")
