...
class AppServiceCertificateOrderPatchResource(BaseModel):
    """
    ARM resource for a certificate order that is purchased through Azure.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="AppServiceCertificateOrderPatchResource resource specific properties")
