...
class SerialConsoleOperations(BaseModel):
    """
    Serial Console operations
    """ # noqa: E501
    value: Optional[List[SerialConsoleOperationsValueInner]] = Field(default=None, description="A list of Serial Console operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SerialConsoleOperationsValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
