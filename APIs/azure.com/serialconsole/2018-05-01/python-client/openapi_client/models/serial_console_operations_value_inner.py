...
class SerialConsoleOperationsValueInner(BaseModel):
    """
    SerialConsoleOperationsValueInner
    """ # noqa: E501
    display: Optional[SerialConsoleOperationsValueInnerDisplay] = None
    is_data_action: Optional[StrictStr] = Field(default=None, alias="isDataAction")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": SerialConsoleOperationsValueInnerDisplay.from_dict(obj["display"]) if obj.get("display") is not None else None,
