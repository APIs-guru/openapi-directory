...
class EnableSerialConsoleResult(BaseModel):
    """
    Returns whether or not Serial Console is disabled (enabled).
    """ # noqa: E501
    disabled: Optional[StrictBool] = Field(default=None, description="Whether or not Serial Console is disabled (enabled).")
