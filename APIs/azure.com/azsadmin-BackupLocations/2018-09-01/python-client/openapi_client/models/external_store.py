...
class ExternalStore(BaseModel):
    ...
    encryption_cert_base64: Optional[StrictStr] = Field(default=None, description="The base64 raw data for the backup encryption certificate.", alias="encryptionCertBase64")
    encryption_cert_thumbprint: Optional[StrictStr] = Field(default=None, description="The thumbprint of the encryption certificate.", alias="encryptionCertThumbprint")
    ...
    __properties: ClassVar[List[str]] = ["availableCapacity", "backupFrequencyInHours", "backupRetentionPeriodInDays", "encryptionCertBase64", "encryptionCertThumbprint", "isBackupSchedulerEnabled", "lastBackupTime", "nextBackupTime", "password", "path", "userName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "encryptionCertBase64": obj.get("encryptionCertBase64"),
