...
class OpenShiftManagedClusterProperties(BaseModel):
    ...
    fqdn: Optional[StrictStr] = Field(default=None, description="User-specified FQDN for OpenShift API server loadbalancer internal hostname.")
    ...
    public_hostname: Optional[StrictStr] = Field(default=None, description="Optional user-specified FQDN for OpenShift API server.", alias="publicHostname")
    ...
    __properties: ClassVar[List[str]] = ["agentPoolProfiles", "authProfile", "fqdn", "masterPoolProfile", "networkProfile", "openShiftVersion", "provisioningState", "publicHostname", "routerProfiles"]
