...
class HybridRunbookWorkerGroupsListResult(BaseModel):
    """
    ...
    value: Optional[List[HybridRunbookWorkerGroup]] = Field(default=None, description="Gets or sets a list of hybrid runbook worker groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [HybridRunbookWorkerGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
