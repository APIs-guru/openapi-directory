...
class RoleAssignmentListResult(BaseModel):
    ...
    value: Optional[List[RoleAssignment]] = Field(default=None, description="Role assignment list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RoleAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
