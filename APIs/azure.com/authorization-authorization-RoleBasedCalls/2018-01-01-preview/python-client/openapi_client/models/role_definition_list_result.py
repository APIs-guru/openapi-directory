...
class RoleDefinitionListResult(BaseModel):
    ...
    value: Optional[List[RoleDefinition]] = Field(default=None, description="Role definition list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RoleDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
