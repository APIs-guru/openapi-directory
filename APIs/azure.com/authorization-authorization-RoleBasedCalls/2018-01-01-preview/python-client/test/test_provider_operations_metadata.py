...
class TestProviderOperationsMetadata(unittest.TestCase):
    """ProviderOperationsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProviderOperationsMetadata:
        """Test ProviderOperationsMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProviderOperationsMetadata`
        """
    ...
    def testProviderOperationsMetadata(self):
        """Test ProviderOperationsMetadata"""
