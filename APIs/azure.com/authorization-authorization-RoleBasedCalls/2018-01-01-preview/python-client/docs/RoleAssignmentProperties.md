...
------------ | ------------- | ------------- | -------------
**can_delegate** | **bool** | The delgation flag used for creating a role assignment | [optional] 
**principal_id** | **str** | The principal ID assigned to the role. This maps to the ID inside the Active Directory. It can point to a user, service principal, or security group. | [optional] 
**role_definition_id** | **str** | The role definition ID used in the role assignment. | [optional] 
