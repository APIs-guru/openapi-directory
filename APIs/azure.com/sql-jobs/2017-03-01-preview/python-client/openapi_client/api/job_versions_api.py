...
class JobVersionsApi:
    ...
    def job_versions_get(
        ...
        _param = self._job_versions_get_serialize(
    ...
    @validate_call
    def job_versions_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    @validate_call
    def job_versions_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_versions_get_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/versions/{jobVersion}',
    ...
    def job_versions_list_by_job(
        ...
        _param = self._job_versions_list_by_job_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            job_agent_name=job_agent_name,
            job_name=job_name,
    ...
    @validate_call
    def job_versions_list_by_job_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JobVersionListResult]:
        """job_versions_list_by_job
    ...
    @validate_call
    def job_versions_list_by_job_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_versions_list_by_job_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
