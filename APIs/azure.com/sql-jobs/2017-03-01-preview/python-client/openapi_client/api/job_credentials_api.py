...
class JobCredentialsApi:
    ...
    @validate_call
    def job_credentials_create_or_update(
        self,
        ...
        parameters: Annotated[JobCredential, Field(description="The requested job credential state.")],
        ...
        _param = self._job_credentials_create_or_update_serialize(
    ...
    @validate_call
    def job_credentials_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    @validate_call
    def job_credentials_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_credentials_create_or_update_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/credentials/{credentialName}',
    ...
    def job_credentials_delete(
        ...
        _param = self._job_credentials_delete_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            job_agent_name=job_agent_name,
            credential_name=credential_name,
    ...
    @validate_call
    def job_credentials_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    @validate_call
    def job_credentials_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_credentials_delete_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
    ...
    def job_credentials_get(
        ...
        _param = self._job_credentials_get_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            job_agent_name=job_agent_name,
            credential_name=credential_name,
    ...
    @validate_call
    def job_credentials_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    @validate_call
    def job_credentials_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_credentials_get_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
    ...
    @validate_call
    def job_credentials_list_by_agent(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
        ...
        _param = self._job_credentials_list_by_agent_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            job_agent_name=job_agent_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def job_credentials_list_by_agent_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JobCredentialListResult]:
        """job_credentials_list_by_agent
    ...
    @validate_call
    def job_credentials_list_by_agent_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        job_agent_name: Annotated[StrictStr, Field(description="The name of the job agent.")],
    ...
    def _job_credentials_list_by_agent_serialize(
        self,
        resource_group_name,
        server_name,
        job_agent_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/credentials',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
