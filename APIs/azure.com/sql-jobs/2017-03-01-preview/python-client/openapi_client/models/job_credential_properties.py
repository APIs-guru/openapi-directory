...
class JobCredentialProperties(BaseModel):
    """
    Properties of a job credential.
    """ # noqa: E501
    password: StrictStr = Field(description="The credential password.")
    username: StrictStr = Field(description="The credential user name.")
