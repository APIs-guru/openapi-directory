# openapi_client.JobTargetExecutionsApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**job_target_executions_get**](JobTargetExecutionsApi.md#job_target_executions_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/executions/{jobExecutionId}/steps/{stepName}/targets/{targetId} | 
[**job_target_executions_list_by_job_execution**](JobTargetExecutionsApi.md#job_target_executions_list_by_job_execution) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/executions/{jobExecutionId}/targets | 
[**job_target_executions_list_by_step**](JobTargetExecutionsApi.md#job_target_executions_list_by_step) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}/executions/{jobExecutionId}/steps/{stepName}/targets | 


# **job_target_executions_get**
> JobExecution job_target_executions_get(resource_group_name, server_name, job_agent_name, job_name, job_execution_id, step_name, target_id, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.JobTargetExecutionsApi(api_client)
    ...
    try:
        api_response = api_instance.job_target_executions_get(resource_group_name, server_name, job_agent_name, job_name, job_execution_id, step_name, target_id, subscription_id, api_version)
        print("The response of JobTargetExecutionsApi->job_target_executions_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JobTargetExecutionsApi->job_target_executions_get: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.job_target_executions_list_by_job_execution(resource_group_name, server_name, job_agent_name, job_name, job_execution_id, subscription_id, api_version, create_time_min=create_time_min, create_time_max=create_time_max, end_time_min=end_time_min, end_time_max=end_time_max, is_active=is_active, skip=skip, top=top)
        print("The response of JobTargetExecutionsApi->job_target_executions_list_by_job_execution:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JobTargetExecutionsApi->job_target_executions_list_by_job_execution: %s\n" % e)
```
...
> JobExecutionListResult job_target_executions_list_by_step(resource_group_name, server_name, job_agent_name, job_name, job_execution_id, step_name, subscription_id, api_version, create_time_min=create_time_min, create_time_max=create_time_max, end_time_min=end_time_min, end_time_max=end_time_max, is_active=is_active, skip=skip, top=top)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.job_target_executions_list_by_step(resource_group_name, server_name, job_agent_name, job_name, job_execution_id, step_name, subscription_id, api_version, create_time_min=create_time_min, create_time_max=create_time_max, end_time_min=end_time_min, end_time_max=end_time_max, is_active=is_active, skip=skip, top=top)
        print("The response of JobTargetExecutionsApi->job_target_executions_list_by_step:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JobTargetExecutionsApi->job_target_executions_list_by_step: %s\n" % e)
```
