...
class ExpressRouteCircuitPeeringListResult(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCircuitPeering]] = Field(default=None, description="The peerings in an express route circuit.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCircuitPeering.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
