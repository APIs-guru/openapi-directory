...
class ExpressRouteCircuitPeeringConfig(BaseModel):
    ...
    advertised_public_prefixes_state: Optional[StrictStr] = Field(default=None, description="AdvertisedPublicPrefixState of the Peering resource. Possible values are 'NotConfigured', 'Configuring', 'Configured', and 'ValidationNeeded'.", alias="advertisedPublicPrefixesState")
