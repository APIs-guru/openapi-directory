...
class ExpressRouteCircuitPropertiesFormat(BaseModel):
    ...
    service_provider_provisioning_state: Optional[StrictStr] = Field(default=None, description="The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.", alias="serviceProviderProvisioningState")
