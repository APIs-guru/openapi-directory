...
class ExpressRouteCircuitPeeringPropertiesFormat(BaseModel):
    ...
    peer_asn: Optional[StrictInt] = Field(default=None, description="The peer ASN.", alias="peerASN")
    peering_type: Optional[StrictStr] = Field(default=None, description="The PeeringType. Possible values are: 'AzurePublicPeering', 'AzurePrivatePeering', and 'MicrosoftPeering'.", alias="peeringType")
    ...
    state: Optional[StrictStr] = Field(default=None, description="The state of peering. Possible values are: 'Disabled' and 'Enabled'")
