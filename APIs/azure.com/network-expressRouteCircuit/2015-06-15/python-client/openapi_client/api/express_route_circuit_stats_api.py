...
class ExpressRouteCircuitStatsApi:
    ...
    @validate_call
    def express_route_circuits_list_stats(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        circuit_name: Annotated[StrictStr, Field(description="The name of the loadBalancer.")],
        ...
        _param = self._express_route_circuits_list_stats_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressRouteCircuitsStatsListResult",
        }
    ...
    @validate_call
    def express_route_circuits_list_stats_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        circuit_name: Annotated[StrictStr, Field(description="The name of the loadBalancer.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressRouteCircuitsStatsListResult]:
        """express_route_circuits_list_stats
    ...
    @validate_call
    def express_route_circuits_list_stats_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        circuit_name: Annotated[StrictStr, Field(description="The name of the loadBalancer.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _express_route_circuits_list_stats_serialize(
        self,
        resource_group_name,
        circuit_name,
        api_version,
