...
class ExpressRouteCircuitPeeringPropertiesFormat(BaseModel):
    ...
    connections: Optional[List[ExpressRouteCircuitConnection]] = Field(default=None, description="The list of circuit connections associated with Azure Private Peering for this circuit.")
    express_route_connection: Optional[ExpressRouteCircuitPeeringPropertiesFormatExpressRouteConnection] = Field(default=None, alias="expressRouteConnection")
    gateway_manager_etag: Optional[StrictStr] = Field(default=None, description="The GatewayManager Etag.", alias="gatewayManagerEtag")
    ipv6_peering_config: Optional[Ipv6ExpressRouteCircuitPeeringConfig] = Field(default=None, alias="ipv6PeeringConfig")
    ...
    peered_connections: Optional[List[PeerExpressRouteCircuitConnection]] = Field(default=None, description="The list of peered circuit connections associated with Azure Private Peering for this circuit.", alias="peeredConnections")
    peering_type: Optional[ExpressRoutePeeringType] = Field(default=None, alias="peeringType")
    ...
    route_filter: Optional[ExpressRouteCircuitConnectionPropertiesFormatExpressRouteCircuitPeering] = Field(default=None, alias="routeFilter")
    ...
    state: Optional[ExpressRoutePeeringState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connections": [ExpressRouteCircuitConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,
            "expressRouteConnection": ExpressRouteCircuitPeeringPropertiesFormatExpressRouteConnection.from_dict(obj["expressRouteConnection"]) if obj.get("expressRouteConnection") is not None else None,
            "gatewayManagerEtag": obj.get("gatewayManagerEtag"),
            "ipv6PeeringConfig": Ipv6ExpressRouteCircuitPeeringConfig.from_dict(obj["ipv6PeeringConfig"]) if obj.get("ipv6PeeringConfig") is not None else None,
            ...
            "peeredConnections": [PeerExpressRouteCircuitConnection.from_dict(_item) for _item in obj["peeredConnections"]] if obj.get("peeredConnections") is not None else None,
            ...
            "routeFilter": ExpressRouteCircuitConnectionPropertiesFormatExpressRouteCircuitPeering.from_dict(obj["routeFilter"]) if obj.get("routeFilter") is not None else None,
