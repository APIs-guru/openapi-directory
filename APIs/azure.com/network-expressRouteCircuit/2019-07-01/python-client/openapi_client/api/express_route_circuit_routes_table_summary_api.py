...
class ExpressRouteCircuitRoutesTableSummaryApi:
    ...
    @validate_call
    def express_route_circuits_list_routes_table_summary(
        self,
        ...
        _param = self._express_route_circuits_list_routes_table_summary_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressRouteCircuitsRoutesTableSummaryListResult",
            '202': None,
        }
    ...
    @validate_call
    def express_route_circuits_list_routes_table_summary_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        circuit_name: Annotated[StrictStr, Field(description="The name of the express route circuit.")],
        peering_name: Annotated[StrictStr, Field(description="The name of the peering.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressRouteCircuitsRoutesTableSummaryListResult]:
        """express_route_circuits_list_routes_table_summary
    ...
    @validate_call
    def express_route_circuits_list_routes_table_summary_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        circuit_name: Annotated[StrictStr, Field(description="The name of the express route circuit.")],
        peering_name: Annotated[StrictStr, Field(description="The name of the peering.")],
    ...
    def _express_route_circuits_list_routes_table_summary_serialize(
        self,
        resource_group_name,
        circuit_name,
        peering_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTablesSummary/{devicePath}',
