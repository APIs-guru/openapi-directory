...
class ExpressRouteCircuitConnectionListResult(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCircuitConnection]] = Field(default=None, description="The global reach connection associated with Private Peering in an ExpressRoute Circuit.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCircuitConnection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
