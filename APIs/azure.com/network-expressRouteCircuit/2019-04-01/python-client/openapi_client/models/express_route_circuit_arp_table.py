...
class ExpressRouteCircuitArpTable(BaseModel):
    ...
    """ # noqa: E501
    age: Optional[StrictInt] = Field(default=None, description="Entry age in minutes.")
    interface: Optional[StrictStr] = Field(default=None, description="Interface address.")
