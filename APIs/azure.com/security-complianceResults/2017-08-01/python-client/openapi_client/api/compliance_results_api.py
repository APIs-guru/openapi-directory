...
class ComplianceResultsApi:
    ...
    def compliance_results_get(
        ...
        compliance_result_name: Annotated[StrictStr, Field(description="name of the desired assessment compliance result")],
        ...
        _param = self._compliance_results_get_serialize(
    ...
    @validate_call
    def compliance_results_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        resource_id: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        compliance_result_name: Annotated[StrictStr, Field(description="name of the desired assessment compliance result")],
    ...
    @validate_call
    def compliance_results_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        resource_id: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        compliance_result_name: Annotated[StrictStr, Field(description="name of the desired assessment compliance result")],
    ...
    def _compliance_results_get_serialize(
        self,
        api_version,
        resource_id,
        ...
        if compliance_result_name is not None:
            _path_params['complianceResultName'] = compliance_result_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{resourceId}/providers/Microsoft.Security/complianceResults/{complianceResultName}',
    ...
    def compliance_results_list(
        ...
        _param = self._compliance_results_list_serialize(
            api_version=api_version,
            scope=scope,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def compliance_results_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ComplianceResultList]:
        """compliance_results_list
    ...
    @validate_call
    def compliance_results_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
    ...
    def _compliance_results_list_serialize(
        self,
        api_version,
        scope,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{scope}/providers/Microsoft.Security/complianceResults',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
