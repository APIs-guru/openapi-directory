...
------------ | ------------- | ------------- | -------------
**principal_ids** | **object** | Array of user or group identities in Azure Active Directory. The roleDefinition will apply to each identity. | 
**resource_group** | **str** | RoleAssignment will be scope to this resourceGroup. If empty, it scopes to the subscription. | [optional] 
