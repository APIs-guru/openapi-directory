...
class BlueprintList(BaseModel):
    ...
    value: Optional[List[Blueprint]] = Field(default=None, description="List of blueprint definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Blueprint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
