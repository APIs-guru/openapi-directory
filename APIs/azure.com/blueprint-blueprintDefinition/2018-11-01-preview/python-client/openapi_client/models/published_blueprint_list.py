...
class PublishedBlueprintList(BaseModel):
    """
    ...
    value: Optional[List[PublishedBlueprint]] = Field(default=None, description="List of published blueprint definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PublishedBlueprint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
