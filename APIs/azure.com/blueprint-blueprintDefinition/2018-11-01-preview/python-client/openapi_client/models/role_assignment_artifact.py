...
class RoleAssignmentArtifact(BaseModel):
    ...
    kind: StrictStr = Field(description="Specifies the kind of blueprint artifact.")
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['template', 'roleAssignment', 'policyAssignment']):
            raise ValueError("must be one of enum values ('template', 'roleAssignment', 'policyAssignment')")
        return value
