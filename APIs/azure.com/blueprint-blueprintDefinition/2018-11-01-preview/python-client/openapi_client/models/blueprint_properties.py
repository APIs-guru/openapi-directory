...
class BlueprintProperties(BaseModel):
    ...
    """ # noqa: E501
    layout: Optional[Dict[str, Any]] = Field(default=None, description="Layout view of the blueprint definition for UI reference.")
    versions: Optional[Dict[str, Any]] = Field(default=None, description="Published versions of this blueprint definition.")
