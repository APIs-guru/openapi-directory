...
class PolicyAssignmentArtifactProperties(BaseModel):
    """
    ...
    policy_definition_id: StrictStr = Field(description="Azure resource ID of the policy definition.", alias="policyDefinitionId")
    resource_group: Optional[StrictStr] = Field(default=None, description="Name of the resource group placeholder to which the policy will be assigned.", alias="resourceGroup")
