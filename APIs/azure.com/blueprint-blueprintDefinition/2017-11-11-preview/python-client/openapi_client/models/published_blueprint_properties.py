...
class PublishedBlueprintProperties(BaseModel):
    ...
    """ # noqa: E501
    blueprint_name: Optional[StrictStr] = Field(default=None, description="Name of the Blueprint definition.", alias="blueprintName")
    ...
    parameters: Optional[Dict[str, ParameterDefinition]] = Field(default=None, description="A dictionary hold parameter name and it's metadata.")
    ...
    target_scope: Optional[StrictStr] = Field(default=None, description="The scope where this Blueprint can be applied.", alias="targetScope")
