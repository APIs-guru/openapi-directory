...
class TemplateArtifactProperties(BaseModel):
    """
    ...
    resource_group: Optional[StrictStr] = Field(default=None, description="If applicable, the name of the resource group placeholder to which the template will be deployed.", alias="resourceGroup")
    template: Dict[str, Any] = Field(description="The Azure Resource Manager template body.")
