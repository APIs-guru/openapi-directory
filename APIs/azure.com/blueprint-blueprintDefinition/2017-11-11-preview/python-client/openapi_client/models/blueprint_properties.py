...
class BlueprintProperties(BaseModel):
    """
    Schema for Blueprint properties.
    """ # noqa: E501
    layout: Optional[Dict[str, Any]] = Field(default=None, description="Layout view of the blueprint, for UI reference.")
    versions: Optional[Dict[str, Any]] = Field(default=None, description="Published versions of this blueprint.")
