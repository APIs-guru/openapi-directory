...
class CompliancesApi:
    ...
    def compliances_get(
        ...
        compliance_name: Annotated[StrictStr, Field(description="name of the Compliance")],
        ...
        _param = self._compliances_get_serialize(
    ...
    @validate_call
    def compliances_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        compliance_name: Annotated[StrictStr, Field(description="name of the Compliance")],
    ...
    @validate_call
    def compliances_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        compliance_name: Annotated[StrictStr, Field(description="name of the Compliance")],
    ...
    def _compliances_get_serialize(
        self,
        api_version,
        scope,
        compliance_name,
        ...
        if compliance_name is not None:
            _path_params['complianceName'] = compliance_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{scope}/providers/Microsoft.Security/compliances/{complianceName}',
    ...
    def compliances_list(
        ...
        _param = self._compliances_list_serialize(
            api_version=api_version,
            scope=scope,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def compliances_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
    ...
    @validate_call
    def compliances_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
    ...
    def _compliances_list_serialize(
        self,
        api_version,
        scope,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{scope}/providers/Microsoft.Security/compliances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
