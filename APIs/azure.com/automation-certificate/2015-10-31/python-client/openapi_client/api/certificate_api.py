...
class CertificateApi:
    ...
    def certificate_create_or_update(
        ...
        certificate_name: Annotated[StrictStr, Field(description="The parameters supplied to the create or update certificate operation.")],
        ...
        parameters: Annotated[CertificateCreateOrUpdateParameters, Field(description="The parameters supplied to the create or update certificate operation.")],
        ...
        :param certificate_name: The parameters supplied to the create or update certificate operation. (required)
    ...
    def _certificate_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/certificates/{certificateName}',
    ...
    def certificate_delete(
        ...
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        certificate_name: Annotated[StrictStr, Field(description="The name of certificate.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def certificate_list_by_automation_account(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        ...
        _param = self._certificate_list_by_automation_account_serialize(
            resource_group_name=resource_group_name,
            automation_account_name=automation_account_name,
            subscription_id=subscription_id,
            api_version=api_version,
    ...
    @validate_call
    def certificate_list_by_automation_account_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
    ...
    @validate_call
    def certificate_list_by_automation_account_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
    ...
    def _certificate_list_by_automation_account_serialize(
        self,
        resource_group_name,
        automation_account_name,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/certificates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def certificate_update(
        ...
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        certificate_name: Annotated[StrictStr, Field(description="The parameters supplied to the update certificate operation.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        parameters: Annotated[CertificateUpdateParameters, Field(description="The parameters supplied to the update certificate operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
