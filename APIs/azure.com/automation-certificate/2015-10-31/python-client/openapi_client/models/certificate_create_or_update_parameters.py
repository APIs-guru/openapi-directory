...
class CertificateCreateOrUpdateParameters(BaseModel):
    """
    The parameters supplied to the create or update or replace certificate operation.
    """ # noqa: E501
    name: StrictStr = Field(description="Gets or sets the name of the certificate.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": CertificateCreateOrUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
