...
class RecordSetProperties(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="provisioning State of the record set.", alias="provisioningState")
    target_resource: Optional[SubResource] = Field(default=None, alias="targetResource")
    __properties: ClassVar[List[str]] = ["AAAARecords", "ARecords", "CNAMERecord", "MXRecords", "NSRecords", "PTRRecords", "SOARecord", "SRVRecords", "TTL", "TXTRecords", "caaRecords", "fqdn", "metadata", "provisioningState", "targetResource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetResource": SubResource.from_dict(obj["targetResource"]) if obj.get("targetResource") is not None else None
        })
        return _obj
