...
class DnsResourceReferenceResult(BaseModel):
    """
    Represents the properties of the Dns Resource Reference Result.
    """ # noqa: E501
    properties: Optional[DnsResourceReferenceResultProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DnsResourceReferenceResultProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
