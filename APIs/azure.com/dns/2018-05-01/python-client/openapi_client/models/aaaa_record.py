...
class AaaaRecord(BaseModel):
    ...
    An AAAA record.
    """ # noqa: E501
    ipv6_address: Optional[StrictStr] = Field(default=None, description="The IPv6 address of this AAAA record.", alias="ipv6Address")
    __properties: ClassVar[List[str]] = ["ipv6Address"]
