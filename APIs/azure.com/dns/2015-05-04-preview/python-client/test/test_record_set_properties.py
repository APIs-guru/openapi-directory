...
class TestRecordSetProperties(unittest.TestCase):
    """RecordSetProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordSetProperties:
        """Test RecordSetProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordSetProperties`
        """
    ...
    def testRecordSetProperties(self):
        """Test RecordSetProperties"""
