...
class RecordSetsApi:
    ...
    def record_sets_create_or_update(
        ...
        record_type: Annotated[StrictStr, Field(description="The type of DNS record.")],
        relative_record_set_name: Annotated[StrictStr, Field(description="The name of the RecordSet, relative to the name of the zone.")],
        ...
        if_match: Annotated[Optional[StrictStr], Field(description="The etag of RecordSet.")] = None,
        ...
        :type zone_name: str
        :param record_type: The type of DNS record. (required)
        :type record_type: str
        :param relative_record_set_name: The name of the RecordSet, relative to the name of the zone. (required)
    ...
    def record_sets_list(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        zone_name: Annotated[StrictStr, Field(description="The name of the zone from which to enumerate RecordsSets.")],
        ...
        :param resource_group_name: The name of the resource group. The name is case insensitive. (required)
        :type resource_group_name: str
        :param zone_name: The name of the zone from which to enumerate RecordsSets. (required)
        :type zone_name: str
    ...
    @validate_call
    def record_sets_list_all(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        zone_name: Annotated[StrictStr, Field(description="The name of the zone from which to enumerate RecordSets.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        top: Annotated[Optional[StrictStr], Field(description="Query parameters. If null is passed returns the default number of zones.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="The filter to apply on the operation.")] = None,
        ...
        :param resource_group_name: The name of the resource group. The name is case insensitive. (required)
        :type resource_group_name: str
        :param zone_name: The name of the zone from which to enumerate RecordSets. (required)
        :type zone_name: str
        :param api_version: The API version to use for this operation. (required)
        :type api_version: str
        :param subscription_id: The ID of the target subscription. (required)
        ...
        _param = self._record_sets_list_all_serialize(
            resource_group_name=resource_group_name,
            zone_name=zone_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def record_sets_list_all_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        zone_name: Annotated[StrictStr, Field(description="The name of the zone from which to enumerate RecordSets.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    @validate_call
    def record_sets_list_all_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        zone_name: Annotated[StrictStr, Field(description="The name of the zone from which to enumerate RecordSets.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    def _record_sets_list_all_serialize(
        self,
        resource_group_name,
        zone_name,
        api_version,
