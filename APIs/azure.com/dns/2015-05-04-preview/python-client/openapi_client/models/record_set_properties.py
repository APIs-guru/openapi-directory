...
class RecordSetProperties(BaseModel):
    ...
    """ # noqa: E501
    aaaa_records: Optional[List[AaaaRecord]] = Field(default=None, description="Gets or sets the list of AAAA records in the RecordSet.", alias="AAAARecords")
    a_records: Optional[List[ARecord]] = Field(default=None, description="Gets or sets the list of A records in the RecordSet.", alias="ARecords")
    cname_record: Optional[CnameRecord] = Field(default=None, alias="CNAMERecord")
    mx_records: Optional[List[MxRecord]] = Field(default=None, description="Gets or sets the list of MX records in the RecordSet.", alias="MXRecords")
    ns_records: Optional[List[NsRecord]] = Field(default=None, description="Gets or sets the list of NS records in the RecordSet.", alias="NSRecords")
    ptr_records: Optional[List[PtrRecord]] = Field(default=None, description="Gets or sets the list of PTR records in the RecordSet.", alias="PTRRecords")
    soa_record: Optional[SoaRecord] = Field(default=None, alias="SOARecord")
    srv_records: Optional[List[SrvRecord]] = Field(default=None, description="Gets or sets the list of SRV records in the RecordSet.", alias="SRVRecords")
    ttl: Optional[StrictInt] = Field(default=None, description="Gets or sets the TTL of the records in the RecordSet.", alias="TTL")
    txt_records: Optional[List[TxtRecord]] = Field(default=None, description="Gets or sets the list of TXT records in the RecordSet.", alias="TXTRecords")
    __properties: ClassVar[List[str]] = ["AAAARecords", "ARecords", "CNAMERecord", "MXRecords", "NSRecords", "PTRRecords", "SOARecord", "SRVRecords", "TTL", "TXTRecords"]
