...
class TestRecordSetUpdateParameters(unittest.TestCase):
    """RecordSetUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordSetUpdateParameters:
        """Test RecordSetUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordSetUpdateParameters`
        """
        model = RecordSetUpdateParameters()
        if include_optional:
            return RecordSetUpdateParameters(
                record_set = openapi_client.models.record_set.RecordSet(
                    etag = '', 
                    id = '', 
                    name = '', 
    ...
    def testRecordSetUpdateParameters(self):
        """Test RecordSetUpdateParameters"""
