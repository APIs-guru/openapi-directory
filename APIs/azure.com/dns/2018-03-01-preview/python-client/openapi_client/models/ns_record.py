...
class NsRecord(BaseModel):
    ...
    An NS record.
    """ # noqa: E501
    nsdname: Optional[StrictStr] = Field(default=None, description="The name server name for this NS record.")
    __properties: ClassVar[List[str]] = ["nsdname"]
