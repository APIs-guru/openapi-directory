...
# **zones_delete**
> ZoneDeleteResult zones_delete(resource_group_name, zone_name, api_version, subscription_id, if_match=if_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.zones_delete(resource_group_name, zone_name, api_version, subscription_id, if_match=if_match)
...
[**ZoneDeleteResult**](ZoneDeleteResult.md)
