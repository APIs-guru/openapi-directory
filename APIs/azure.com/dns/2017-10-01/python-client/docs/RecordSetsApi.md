...
[**record_sets_list_all_by_dns_zone**](RecordSetsApi.md#record_sets_list_all_by_dns_zone) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/all | 
...
> RecordSetListResult record_sets_list_all_by_dns_zone(resource_group_name, zone_name, api_version, subscription_id, top=top, recordsetnamesuffix=recordsetnamesuffix)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.record_sets_list_all_by_dns_zone(resource_group_name, zone_name, api_version, subscription_id, top=top, recordsetnamesuffix=recordsetnamesuffix)
        print("The response of RecordSetsApi->record_sets_list_all_by_dns_zone:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecordSetsApi->record_sets_list_all_by_dns_zone: %s\n" % e)
```
