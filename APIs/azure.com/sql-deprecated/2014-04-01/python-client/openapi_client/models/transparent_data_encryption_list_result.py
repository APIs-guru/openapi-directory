...
class TransparentDataEncryptionListResult(BaseModel):
    """
    Represents the response to a list transparent data encryption configurations request.
    """ # noqa: E501
    value: Optional[List[TransparentDataEncryptionListResultValueInner]] = Field(default=None, description="The list of transparent data encryption configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TransparentDataEncryptionListResultValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
