...
class TransparentDataEncryptionListResultValueInner(BaseModel):
    """
    Represents a database transparent data encryption configuration.
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Resource location.")
    properties: Optional[TransparentDataEncryptionListResultValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": TransparentDataEncryptionListResultValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
