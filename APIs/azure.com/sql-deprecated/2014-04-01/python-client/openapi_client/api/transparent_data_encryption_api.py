...
class TransparentDataEncryptionApi:
    ...
    @validate_call
    def transparent_data_encryption_configurations_list_by_database(
        self,
        ...
        database_name: Annotated[StrictStr, Field(description="The name of the database for which the transparent data encryption applies.")],
        ...
        """(Deprecated) transparent_data_encryption_configurations_list_by_database
        ...
        :param database_name: The name of the database for which the transparent data encryption applies. (required)
        ...
        """ # noqa: E501
        warnings.warn("GET /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/transparentDataEncryption is deprecated.", DeprecationWarning)

        _param = self._transparent_data_encryption_configurations_list_by_database_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransparentDataEncryptionListResult",
        }
    ...
    @validate_call
    def transparent_data_encryption_configurations_list_by_database_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransparentDataEncryptionListResult]:
        """(Deprecated) transparent_data_encryption_configurations_list_by_database
    ...
    @validate_call
    def transparent_data_encryption_configurations_list_by_database_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
    ...
    def _transparent_data_encryption_configurations_list_by_database_serialize(
        self,
        api_version,
        subscription_id,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/transparentDataEncryption',
