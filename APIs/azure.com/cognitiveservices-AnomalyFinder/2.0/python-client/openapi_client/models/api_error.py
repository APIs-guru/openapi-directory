...
class APIError(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="A message explaining the error reported by the service.")
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['InvalidCustomInterval', 'BadArgument', 'InvalidGranularity', 'InvalidPeriod', 'InvalidModelArgument', 'InvalidSeries']):
            raise ValueError("must be one of enum values ('InvalidCustomInterval', 'BadArgument', 'InvalidGranularity', 'InvalidPeriod', 'InvalidModelArgument', 'InvalidSeries')")
        return value
