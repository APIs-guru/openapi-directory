...
class DocumentsApi:
    ...
    def documents_count(
        ...
        client_request_id: Annotated[Optional[StrictStr], Field(description="Tracking ID sent with the request to help with debugging.")] = None,
        ...
        _param = self._documents_count_serialize(
    ...
    @validate_call
    def documents_count_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        client_request_id: Annotated[Optional[StrictStr], Field(description="Tracking ID sent with the request to help with debugging.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def documents_count_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        client_request_id: Annotated[Optional[StrictStr], Field(description="Tracking ID sent with the request to help with debugging.")] = None,
        _request_timeout: Union[
    ...
    def _documents_count_serialize(
        self,
        api_version,
        client_request_id,
        _request_auth,
