...
class DocumentIndexResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[IndexingResult]] = Field(default=None, description="Gets the list of status information for each document in the indexing request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [IndexingResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
