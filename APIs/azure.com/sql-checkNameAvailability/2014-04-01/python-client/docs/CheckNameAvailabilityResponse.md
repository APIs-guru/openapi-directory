...
**message** | **str** | A message explaining why the name is unavailable. Will be null if the name is available. | [optional] [readonly] 
**name** | **str** | The name whose availability was checked. | [optional] [readonly] 
**reason** | **str** | The reason code explaining why the name is unavailable. Will be null if the name is available. | [optional] [readonly] 
