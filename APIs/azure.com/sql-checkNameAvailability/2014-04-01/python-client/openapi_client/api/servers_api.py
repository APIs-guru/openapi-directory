...
class ServersApi:
    ...
    def servers_check_name_availability(
        ...
        parameters: Annotated[CheckNameAvailabilityRequest, Field(description="The parameters to request for name availability.")],
        ...
        :type parameters: CheckNameAvailabilityRequest
    ...
    def _servers_check_name_availability_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Sql/checkNameAvailability',
