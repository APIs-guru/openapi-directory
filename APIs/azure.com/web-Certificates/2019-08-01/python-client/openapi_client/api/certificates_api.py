...
class CertificatesApi:
    ...
    @validate_call
    def certificates_list_by_resource_group(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the resource group to which the resource belongs.")],
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
        api_version: Annotated[StrictStr, Field(description="API Version")],
        ...
        _param = self._certificates_list_by_resource_group_serialize(
            resource_group_name=resource_group_name,
            subscription_id=subscription_id,
            api_version=api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def certificates_list_by_resource_group_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the resource group to which the resource belongs.")],
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
        api_version: Annotated[StrictStr, Field(description="API Version")],
    ...
    @validate_call
    def certificates_list_by_resource_group_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the resource group to which the resource belongs.")],
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
        api_version: Annotated[StrictStr, Field(description="API Version")],
    ...
    def _certificates_list_by_resource_group_serialize(
        self,
        resource_group_name,
        subscription_id,
        api_version,
    ...
    def certificates_update(
        ...
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
        api_version: Annotated[StrictStr, Field(description="API Version")],
        certificate_envelope: Annotated[CertificatePatchResource, Field(description="Details of certificate, if it exists already.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type api_version: str
        :param certificate_envelope: Details of certificate, if it exists already. (required)
        :type certificate_envelope: CertificatePatchResource
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._certificates_update_serialize(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=subscription_id,
            api_version=api_version,
    ...
    @validate_call
    def certificates_update_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the resource group to which the resource belongs.")],
        name: Annotated[StrictStr, Field(description="Name of the certificate.")],
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
    ...
    @validate_call
    def certificates_update_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the resource group to which the resource belongs.")],
        name: Annotated[StrictStr, Field(description="Name of the certificate.")],
        subscription_id: Annotated[StrictStr, Field(description="Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).")],
    ...
    def _certificates_update_serialize(
        self,
        resource_group_name,
        name,
        subscription_id,
