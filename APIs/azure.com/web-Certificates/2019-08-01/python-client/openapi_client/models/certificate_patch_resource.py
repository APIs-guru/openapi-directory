...
class CertificatePatchResource(BaseModel):
    """
    ARM resource for a certificate.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="CertificatePatchResource resource specific properties")
