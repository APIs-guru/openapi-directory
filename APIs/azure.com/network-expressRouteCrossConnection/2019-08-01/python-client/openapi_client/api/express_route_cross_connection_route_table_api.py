...
class ExpressRouteCrossConnectionRouteTableApi:
    ...
    @validate_call
    def express_route_cross_connections_list_routes_table(
        self,
        ...
        _param = self._express_route_cross_connections_list_routes_table_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressRouteCrossConnectionsListRoutesTable200Response",
            '202': None,
        }
    ...
    @validate_call
    def express_route_cross_connections_list_routes_table_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        cross_connection_name: Annotated[StrictStr, Field(description="The name of the ExpressRouteCrossConnection.")],
        peering_name: Annotated[StrictStr, Field(description="The name of the peering.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressRouteCrossConnectionsListRoutesTable200Response]:
        """express_route_cross_connections_list_routes_table
    ...
    @validate_call
    def express_route_cross_connections_list_routes_table_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        cross_connection_name: Annotated[StrictStr, Field(description="The name of the ExpressRouteCrossConnection.")],
        peering_name: Annotated[StrictStr, Field(description="The name of the peering.")],
    ...
    def _express_route_cross_connections_list_routes_table_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/routeTables/{devicePath}',
