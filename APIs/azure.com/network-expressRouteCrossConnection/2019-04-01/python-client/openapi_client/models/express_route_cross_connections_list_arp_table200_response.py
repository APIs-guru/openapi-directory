...
class ExpressRouteCrossConnectionsListArpTable200Response(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCrossConnectionsListArpTable200ResponseValueInner]] = Field(default=None, description="Gets list of the ARP table.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCrossConnectionsListArpTable200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
