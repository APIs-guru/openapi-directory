...
class ExpressRouteCrossConnectionsRoutesTableSummaryListResult(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCrossConnectionRoutesTableSummary]] = Field(default=None, description="A list of the routes table.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCrossConnectionRoutesTableSummary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
