...
class ExpressRouteCrossConnectionsListRoutesTable200Response(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCrossConnectionsListRoutesTable200ResponseValueInner]] = Field(default=None, description="The list of routes table.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCrossConnectionsListRoutesTable200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
