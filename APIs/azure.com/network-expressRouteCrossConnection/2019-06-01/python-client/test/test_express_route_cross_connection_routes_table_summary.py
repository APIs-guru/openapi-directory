...
class TestExpressRouteCrossConnectionRoutesTableSummary(unittest.TestCase):
    """ExpressRouteCrossConnectionRoutesTableSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpressRouteCrossConnectionRoutesTableSummary:
        """Test ExpressRouteCrossConnectionRoutesTableSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressRouteCrossConnectionRoutesTableSummary`
        """
        model = ExpressRouteCrossConnectionRoutesTableSummary()
        if include_optional:
            return ExpressRouteCrossConnectionRoutesTableSummary(
                asn = 56,
                neighbor = '',
    ...
    def testExpressRouteCrossConnectionRoutesTableSummary(self):
        """Test ExpressRouteCrossConnectionRoutesTableSummary"""
