...
class DeploymentPropertiesExtended(BaseModel):
    ...
    """ # noqa: E501
    correlation_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the correlation ID of the deployment.", alias="correlationId")
    dependencies: Optional[List[Dependency]] = Field(default=None, description="Gets the list of deployment dependencies.")
    mode: Optional[StrictStr] = Field(default=None, description="Gets or sets the deployment mode.")
    outputs: Optional[Dict[str, Any]] = Field(default=None, description="Gets or sets key/value pairs that represent deployment output.")
    ...
    providers: Optional[List[Provider]] = Field(default=None, description="Gets the list of resource providers needed for the deployment.")
    ...
    template: Optional[Dict[str, Any]] = Field(default=None, description="Gets or sets the template content. Use only one of Template or TemplateLink.")
    template_link: Optional[TemplateLink] = Field(default=None, alias="templateLink")
    timestamp: Optional[datetime] = Field(default=None, description="Gets or sets the timestamp of the template deployment.")
    __properties: ClassVar[List[str]] = ["correlationId", "dependencies", "mode", "outputs", "parameters", "parametersLink", "providers", "provisioningState", "template", "templateLink", "timestamp"]
