...
class DeploymentParametersDnsLabelPrefix(BaseModel):
    """
    DeploymentParametersDnsLabelPrefix
    """ # noqa: E501
    value: StrictStr = Field(description="Unique DNS Name for the Public IP used to access the Virtual Machine.")
