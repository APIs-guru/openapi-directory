...
class DeploymentsApi:
    ...
    @validate_call
    def virtual_machines_quick_create(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="The name of the resource group. The name is case insensitive.")],
        ...
        parameters: Annotated[Optional[Deployment], Field(description="Additional parameters supplied to the operation.")] = None,
        ...
        _param = self._virtual_machines_quick_create_serialize(
    ...
    @validate_call
    def virtual_machines_quick_create_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="The name of the resource group. The name is case insensitive.")],
        deployment_name: Annotated[StrictStr, Field(description="The name of the deployment.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    @validate_call
    def virtual_machines_quick_create_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(strict=True, description="The name of the resource group. The name is case insensitive.")],
        deployment_name: Annotated[StrictStr, Field(description="The name of the deployment.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _virtual_machines_quick_create_serialize(
        self,
        resource_group_name,
        deployment_name,
        api_version,
