...
------------ | ------------- | ------------- | -------------
**depends_on** | [**List[BasicDependency]**](BasicDependency.md) | Gets the list of dependencies. | [optional] 
**id** | **str** | Gets or sets the ID of the dependency. | [optional] 
**resource_name** | **str** | Gets or sets the dependency resource name. | [optional] 
**resource_type** | **str** | Gets or sets the dependency resource type. | [optional] 
