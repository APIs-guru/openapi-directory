...
class OperationsApi:
    ...
    def get_available_operations(
        ...
        _param = self._get_available_operations_serialize(
    ...
    @validate_call
    def get_available_operations_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
            None,
    ...
    def _get_available_operations_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.PowerBI/operations',
