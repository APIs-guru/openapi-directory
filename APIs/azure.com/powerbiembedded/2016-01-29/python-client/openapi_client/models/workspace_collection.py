...
class WorkspaceCollection(BaseModel):
    ...
    location: Optional[StrictStr] = Field(default=None, description="Azure location")
    name: Optional[StrictStr] = Field(default=None, description="Workspace collection name")
    properties: Optional[Dict[str, Any]] = Field(default=None, description="Properties")
