...
class Operation(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the operation being performed on this particular object. This name should match the action name that appears in RBAC / the event service.")
