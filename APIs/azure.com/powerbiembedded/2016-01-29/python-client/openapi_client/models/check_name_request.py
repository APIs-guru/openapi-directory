...
class CheckNameRequest(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Microsoft.PowerBI/workspaceCollections', description="Resource type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type") if obj.get("type") is not None else 'Microsoft.PowerBI/workspaceCollections'
        })
        return _obj
