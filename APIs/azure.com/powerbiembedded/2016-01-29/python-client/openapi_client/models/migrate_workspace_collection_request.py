...
class MigrateWorkspaceCollectionRequest(BaseModel):
    """
    MigrateWorkspaceCollectionRequest
    """ # noqa: E501
    resources: Optional[List[StrictStr]] = None
    target_resource_group: Optional[StrictStr] = Field(default=None, description="Name of the resource group the Power BI workspace collections will be migrated to.", alias="targetResourceGroup")
