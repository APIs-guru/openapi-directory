...
class WorkspaceCollectionAccessKeys(BaseModel):
    """
    WorkspaceCollectionAccessKeys
    """ # noqa: E501
    key1: Optional[StrictStr] = Field(default=None, description="Access key 1")
    key2: Optional[StrictStr] = Field(default=None, description="Access key 2")
