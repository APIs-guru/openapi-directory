...
class TestWorkspaceCollectionList(unittest.TestCase):
    """WorkspaceCollectionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCollectionList:
        """Test WorkspaceCollectionList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCollectionList`
        """
        model = WorkspaceCollectionList()
        if include_optional:
            return WorkspaceCollectionList(
                value = [
                    openapi_client.models.workspace_collection.WorkspaceCollection(
                        id = '', 
                        location = '', 
                        name = '', 
    ...
    def testWorkspaceCollectionList(self):
        """Test WorkspaceCollectionList"""
