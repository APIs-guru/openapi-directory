...
class TestResponseWithContinuationEnvironment(unittest.TestCase):
    """ResponseWithContinuationEnvironment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseWithContinuationEnvironment:
        """Test ResponseWithContinuationEnvironment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseWithContinuationEnvironment`
        """
        model = ResponseWithContinuationEnvironment()
        if include_optional:
    ...
    def testResponseWithContinuationEnvironment(self):
        """Test ResponseWithContinuationEnvironment"""
