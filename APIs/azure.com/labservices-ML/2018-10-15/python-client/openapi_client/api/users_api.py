...
class UsersApi:
    ...
    def users_create_or_update(
        ...
        user: Annotated[User, Field(description="The User registered to a lab")],
    ...
    def _users_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labaccounts/{labAccountName}/labs/{labName}/users/{userName}',
    ...
    def users_get(
        ...
        user_name: Annotated[StrictStr, Field(description="The name of the user.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        expand: Annotated[Optional[StrictStr], Field(description="Specify the $expand query. Example: 'properties($select=email)'")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def users_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseWithContinuationUser",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def users_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseWithContinuationUser]:
        """users_list
    ...
    def _users_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labaccounts/{labAccountName}/labs/{labName}/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def users_update(
        ...
        user_name: Annotated[StrictStr, Field(description="The name of the user.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        user: Annotated[UserFragment, Field(description="The User registered to a lab")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
