...
class OperationsApi:
    ...
    def operations_get(
        ...
        operation_name: Annotated[StrictStr, Field(description="The name of the operation.")],
        ...
        :param operation_name: The name of the operation. (required)
    ...
    def _operations_get_serialize(
        ...
        if operation_name is not None:
            _path_params['operationName'] = operation_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/locations/{locationName}/operations/{operationName}',
