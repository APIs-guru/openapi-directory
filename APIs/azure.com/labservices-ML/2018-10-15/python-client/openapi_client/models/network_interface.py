...
class NetworkInterface(BaseModel):
    ...
    username: Optional[StrictStr] = Field(default=None, description="Username of the VM")
    __properties: ClassVar[List[str]] = ["privateIpAddress", "rdpAuthority", "sshAuthority", "username"]
