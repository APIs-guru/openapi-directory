...
class VmStateDetails(BaseModel):
    """
    ...
    power_state: Optional[StrictStr] = Field(default=None, description="The power state of the reference virtual machine.", alias="powerState")
    ...
    __properties: ClassVar[List[str]] = ["lastKnownPowerState", "powerState", "rdpAuthority", "sshAuthority"]
