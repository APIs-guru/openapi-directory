...
class EnvironmentPropertiesFragment(BaseModel):
    ...
    resource_sets: Optional[ResourceSetFragment] = Field(default=None, alias="resourceSets")
    ...
    __properties: ClassVar[List[str]] = ["provisioningState", "resourceSets", "uniqueIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resourceSets": ResourceSetFragment.from_dict(obj["resourceSets"]) if obj.get("resourceSets") is not None else None,
