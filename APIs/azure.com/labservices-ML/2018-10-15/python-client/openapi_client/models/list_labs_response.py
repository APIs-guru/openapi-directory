...
class ListLabsResponse(BaseModel):
    """
    Lists the labs owned by a user
    """ # noqa: E501
    labs: Optional[List[LabDetails]] = Field(default=None, description="List of all the labs")
    __properties: ClassVar[List[str]] = ["labs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labs": [LabDetails.from_dict(_item) for _item in obj["labs"]] if obj.get("labs") is not None else None
        })
        return _obj
