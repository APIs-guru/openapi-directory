...
class EnvironmentSizeFragment(BaseModel):
    """
    ...
    vm_sizes: Optional[List[SizeInfoFragment]] = Field(default=None, description="Represents a set of compute sizes that can serve this given size type", alias="vmSizes")
    __properties: ClassVar[List[str]] = ["name", "vmSizes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "vmSizes": [SizeInfoFragment.from_dict(_item) for _item in obj["vmSizes"]] if obj.get("vmSizes") is not None else None
        })
        return _obj
