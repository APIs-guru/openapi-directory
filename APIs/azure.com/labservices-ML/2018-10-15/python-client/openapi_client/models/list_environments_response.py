...
class ListEnvironmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    environments: Optional[List[EnvironmentDetails]] = Field(default=None, description="List of all the environments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environments": [EnvironmentDetails.from_dict(_item) for _item in obj["environments"]] if obj.get("environments") is not None else None
        })
        return _obj
