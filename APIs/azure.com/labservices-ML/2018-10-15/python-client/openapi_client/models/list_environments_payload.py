...
class ListEnvironmentsPayload(BaseModel):
    """
    Represents the payload to list environments owned by a user
    """ # noqa: E501
    lab_id: Optional[StrictStr] = Field(default=None, description="The resource Id of the lab", alias="labId")
    __properties: ClassVar[List[str]] = ["labId"]
