...
class ActivityParameterValidationSet(BaseModel):
    """
    Definition of the activity parameter validation set.
    """ # noqa: E501
    member_value: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the activity parameter validation set member.", alias="memberValue")
    __properties: ClassVar[List[str]] = ["memberValue"]
