...
class TypeFieldListResult(BaseModel):
    """
    The response model for the list fields operation.
    """ # noqa: E501
    value: Optional[List[TypeField]] = Field(default=None, description="Gets or sets a list of fields.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TypeField.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
