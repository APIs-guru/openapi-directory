...
class PlatformImageProperties(BaseModel):
    """
    Properties of platform image.
    """ # noqa: E501
    data_disks: Optional[List[DataDisk]] = Field(default=None, description="Data disks used by the platform image.", alias="dataDisks")
    ...
    __properties: ClassVar[List[str]] = ["dataDisks", "details", "osDisk", "provisioningState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": ImageDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
