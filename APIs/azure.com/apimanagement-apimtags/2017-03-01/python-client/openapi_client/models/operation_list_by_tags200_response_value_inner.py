...
class OperationListByTags200ResponseValueInner(BaseModel):
    ...
    Contract details.
    """ # noqa: E501
    properties: Optional[OperationListByTags200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": OperationListByTags200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
