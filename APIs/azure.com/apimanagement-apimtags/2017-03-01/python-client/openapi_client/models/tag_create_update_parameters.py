...
class TagCreateUpdateParameters(BaseModel):
    """
    Parameters supplied to Create/Update Tag operations.
    """ # noqa: E501
    properties: Optional[TagContractProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TagContractProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
