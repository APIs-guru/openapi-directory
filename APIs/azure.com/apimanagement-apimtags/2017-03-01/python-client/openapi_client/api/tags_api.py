...
class TagsApi:
    ...
    def tag_create_or_update(
        ...
        parameters: Annotated[TagCreateUpdateParameters, Field(description="Create parameters.")],
        ...
        :type parameters: TagCreateUpdateParameters
    ...
    def tag_delete(
        ...
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        tag_id: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="Tag identifier. Must be unique in the current API Management service instance.")],
        if_match: Annotated[StrictStr, Field(description="ETag of the Tag Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
            None,
        ...
        :param tag_id: Tag identifier. Must be unique in the current API Management service instance. (required)
        :type tag_id: str
        :param if_match: ETag of the Tag Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update. (required)
        :type if_match: str
        :param api_version: Version of the API to be used with the client request. (required)
        :type api_version: str
        :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
    ...
    def tag_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[TagCreateUpdateParameters, Field(description="Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
