...
class OperationListByTags200ResponseValueInnerTag(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=160)]] = Field(default=None, description="Tag Name")
