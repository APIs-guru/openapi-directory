# openapi_client.OperationsByTagsApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**operation_list_by_tags**](OperationsByTagsApi.md#operation_list_by_tags) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags | 


# **operation_list_by_tags**
> OperationListByTags200Response operation_list_by_tags(resource_group_name, service_name, api_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.OperationsByTagsApi(api_client)
    ...
    try:
        api_response = api_instance.operation_list_by_tags(resource_group_name, service_name, api_id, api_version, subscription_id, filter=filter, top=top, skip=skip)
        print("The response of OperationsByTagsApi->operation_list_by_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationsByTagsApi->operation_list_by_tags: %s\n" % e)
```
