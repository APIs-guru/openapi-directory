...
class GitPatternRepository(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the repository")
    password: Optional[StrictStr] = Field(default=None, description="Password of git repository basic auth.")
    pattern: Optional[List[StrictStr]] = Field(default=None, description="Collection of pattern of the repository")
    ...
    __properties: ClassVar[List[str]] = ["hostKey", "hostKeyAlgorithm", "label", "name", "password", "pattern", "privateKey", "searchPaths", "strictHostKeyChecking", "uri", "username"]
