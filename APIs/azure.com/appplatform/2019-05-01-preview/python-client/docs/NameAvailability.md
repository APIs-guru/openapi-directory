...
------------ | ------------- | ------------- | -------------
**message** | **str** | Message why the name is not available | [optional] 
**name_available** | **bool** | Indicates whether the name is available | [optional] 
**reason** | **str** | Reason why the name is not available | [optional] 
