...
------------ | ------------- | ------------- | -------------
**mount_path** | **str** | Mount path of the persistent disk | [optional] 
**size_in_gb** | **int** | Size of the persistent disk in GB | [optional] 
**used_in_gb** | **int** | Size of the used persistent disk in GB | [optional] [readonly] 
