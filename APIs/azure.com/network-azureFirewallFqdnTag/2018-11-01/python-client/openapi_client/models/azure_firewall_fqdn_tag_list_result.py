...
class AzureFirewallFqdnTagListResult(BaseModel):
    """
    Response for ListAzureFirewallFqdnTags API service call.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of results.", alias="nextLink")
    value: Optional[List[AzureFirewallFqdnTag]] = Field(default=None, description="List of Azure Firewall FQDN Tags in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AzureFirewallFqdnTag.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
