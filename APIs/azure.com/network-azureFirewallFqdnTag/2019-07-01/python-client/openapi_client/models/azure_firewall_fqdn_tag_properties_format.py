...
class AzureFirewallFqdnTagPropertiesFormat(BaseModel):
    """
    Azure Firewall FQDN Tag Properties.
    """ # noqa: E501
    fqdn_tag_name: Optional[StrictStr] = Field(default=None, description="The name of this FQDN Tag.", alias="fqdnTagName")
    ...
    __properties: ClassVar[List[str]] = ["fqdnTagName", "provisioningState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fqdnTagName": obj.get("fqdnTagName"),
