...
[**projects_get_job_status**](ProjectsApi.md#projects_get_job_status) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.visualstudio/account/{rootResourceName}/project/{resourceName}/subContainers/{subContainerName}/status | Projects_GetJobStatus
[**projects_list_by_resource_group**](ProjectsApi.md#projects_list_by_resource_group) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.visualstudio/account/{rootResourceName}/project | Projects_ListByResourceGroup
...
# **projects_get_job_status**
> ProjectResource projects_get_job_status(resource_group_name, subscription_id, api_version, root_resource_name, resource_name, sub_container_name, operation, job_id=job_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    root_resource_name = 'root_resource_name_example' # str | Name of the Team Services account.
    resource_name = 'resource_name_example' # str | Name of the Team Services project.
    sub_container_name = 'sub_container_name_example' # str | This parameter should be set to the resourceName.
    operation = 'operation_example' # str | The operation type. The only supported value is 'put'.
    job_id = 'job_id_example' # str | The job identifier. (optional)

    try:
        # Projects_GetJobStatus
        api_response = api_instance.projects_get_job_status(resource_group_name, subscription_id, api_version, root_resource_name, resource_name, sub_container_name, operation, job_id=job_id)
        print("The response of ProjectsApi->projects_get_job_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->projects_get_job_status: %s\n" % e)
```
 ...
 **root_resource_name** | **str**| Name of the Team Services account. | 
 **resource_name** | **str**| Name of the Team Services project. | 
 **sub_container_name** | **str**| This parameter should be set to the resourceName. | 
 **operation** | **str**| The operation type. The only supported value is &#39;put&#39;. | 
 **job_id** | **str**| The job identifier. | [optional] 
...
> ProjectResourceListResult projects_list_by_resource_group(resource_group_name, subscription_id, api_version, root_resource_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Projects_ListByResourceGroup
        api_response = api_instance.projects_list_by_resource_group(resource_group_name, subscription_id, api_version, root_resource_name)
        print("The response of ProjectsApi->projects_list_by_resource_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->projects_list_by_resource_group: %s\n" % e)
```
