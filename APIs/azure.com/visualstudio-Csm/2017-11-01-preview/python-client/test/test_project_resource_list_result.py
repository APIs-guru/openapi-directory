...
class TestProjectResourceListResult(unittest.TestCase):
    """ProjectResourceListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResourceListResult:
        """Test ProjectResourceListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResourceListResult`
        """
        model = ProjectResourceListResult()
        if include_optional:
            return ProjectResourceListResult(
                value = [
                    openapi_client.models.project_resource.ProjectResource(
                        kind = 'project', 
                        properties = openapi_client.models.project_resource_properties.ProjectResourceProperties(
                            bootstrap_pipeline_template = openapi_client.models.pipeline_template.PipelineTemplate(
    ...
    def testProjectResourceListResult(self):
        """Test ProjectResourceListResult"""
