...
class ProjectResource(BaseModel):
    ...
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Kind of project resource")
    properties: Optional[ProjectResourceProperties] = None
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['project', 'bootstrappedProject']):
            raise ValueError("must be one of enum values ('project', 'bootstrappedProject')")
        return value
