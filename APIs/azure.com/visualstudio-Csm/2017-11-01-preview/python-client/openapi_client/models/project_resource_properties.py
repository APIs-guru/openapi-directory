...
class ProjectResourceProperties(BaseModel):
    ...
    """ # noqa: E501
    bootstrap_pipeline_template: Optional[PipelineTemplate] = Field(default=None, alias="bootstrapPipelineTemplate")
    ...
    __properties: ClassVar[List[str]] = ["bootstrapPipelineTemplate", "ownerUpn", "processTemplateId", "tfsUniqueIdentifier", "versionControlOption"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bootstrapPipelineTemplate": PipelineTemplate.from_dict(obj["bootstrapPipelineTemplate"]) if obj.get("bootstrapPipelineTemplate") is not None else None,
