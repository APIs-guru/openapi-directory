...
class ExtensionResourceListResult(BaseModel):
    """
    The response to an extension resource list GET request.
    """ # noqa: E501
    value: Optional[List[ExtensionResource]] = Field(default=None, description="Array of extension resource details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ExtensionResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
