...
class ProjectResourceUpdateParameters(BaseModel):
    """
    The parameters to update a project resource.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The custom tags to be set on the resource.")
