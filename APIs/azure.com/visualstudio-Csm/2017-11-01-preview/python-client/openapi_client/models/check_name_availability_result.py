...
class CheckNameAvailabilityResult(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The message describing the detailed reason.")
    ...
    __properties: ClassVar[List[str]] = ["message", "nameAvailable"]
