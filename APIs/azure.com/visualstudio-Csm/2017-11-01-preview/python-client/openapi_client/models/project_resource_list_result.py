...
class ProjectResourceListResult(BaseModel):
    """
    The response to a request to list Team Services project resources in a resource group/account.
    """ # noqa: E501
    value: Optional[List[ProjectResource]] = Field(default=None, description="List of project resource details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ProjectResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
