...
class EventsPerformanceCounterResult(EventsResultData):
    ...
    """ # noqa: E501
    performance_counter: Optional[EventsPerformanceCounterInfo] = Field(default=None, alias="performanceCounter")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "performanceCounter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of performance_counter
        if self.performance_counter:
            _dict['performanceCounter'] = self.performance_counter.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "performanceCounter": EventsPerformanceCounterInfo.from_dict(obj["performanceCounter"]) if obj.get("performanceCounter") is not None else None
        })
        return _obj
