...
class EventsCustomEventResult(EventsResultData):
    ...
    """ # noqa: E501
    custom_event: Optional[EventsCustomEventInfo] = Field(default=None, alias="customEvent")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "customEvent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customEvent": EventsCustomEventInfo.from_dict(obj["customEvent"]) if obj.get("customEvent") is not None else None
        })
        return _obj
