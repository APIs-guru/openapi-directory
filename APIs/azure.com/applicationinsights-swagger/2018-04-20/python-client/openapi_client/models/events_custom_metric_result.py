...
class EventsCustomMetricResult(EventsResultData):
    ...
    """ # noqa: E501
    custom_metric: Optional[EventsCustomMetricInfo] = Field(default=None, alias="customMetric")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "customMetric"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customMetric": EventsCustomMetricInfo.from_dict(obj["customMetric"]) if obj.get("customMetric") is not None else None
        })
        return _obj
