...
class EventsBrowserTimingResult(EventsResultData):
    ...
    """ # noqa: E501
    browser_timing: Optional[EventsBrowserTimingInfo] = Field(default=None, alias="browserTiming")
    client_performance: Optional[EventsClientPerformanceInfo] = Field(default=None, alias="clientPerformance")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "browserTiming", "clientPerformance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of browser_timing
        if self.browser_timing:
            _dict['browserTiming'] = self.browser_timing.to_dict()
        # override the default output from pydantic by calling `to_dict()` of client_performance
        if self.client_performance:
            _dict['clientPerformance'] = self.client_performance.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "browserTiming": EventsBrowserTimingInfo.from_dict(obj["browserTiming"]) if obj.get("browserTiming") is not None else None,
            "clientPerformance": EventsClientPerformanceInfo.from_dict(obj["clientPerformance"]) if obj.get("clientPerformance") is not None else None
        })
        return _obj
