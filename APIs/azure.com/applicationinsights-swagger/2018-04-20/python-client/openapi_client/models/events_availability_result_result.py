...
class EventsAvailabilityResultResult(EventsResultData):
    ...
    """ # noqa: E501
    availability_result: Optional[EventsAvailabilityResultInfo] = Field(default=None, alias="availabilityResult")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "availabilityResult"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of availability_result
        if self.availability_result:
            _dict['availabilityResult'] = self.availability_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availabilityResult": EventsAvailabilityResultInfo.from_dict(obj["availabilityResult"]) if obj.get("availabilityResult") is not None else None
        })
        return _obj
