...
class EventsDependencyResult(EventsResultData):
    ...
    A dependency result
    """ # noqa: E501
    dependency: Optional[EventsDependencyInfo] = None
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "dependency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dependency": EventsDependencyInfo.from_dict(obj["dependency"]) if obj.get("dependency") is not None else None
        })
        return _obj
