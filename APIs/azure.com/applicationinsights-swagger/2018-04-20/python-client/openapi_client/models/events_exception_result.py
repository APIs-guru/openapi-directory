...
class EventsExceptionResult(EventsResultData):
    ...
    An exception result
    """ # noqa: E501
    exception: Optional[EventsExceptionInfo] = None
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "exception"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exception": EventsExceptionInfo.from_dict(obj["exception"]) if obj.get("exception") is not None else None
        })
        return _obj
