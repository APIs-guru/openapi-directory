...
class EventsPageViewResult(EventsResultData):
    ...
    A page view result
    """ # noqa: E501
    page_view: Optional[EventsPageViewInfo] = Field(default=None, alias="pageView")
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "pageView"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of page_view
        if self.page_view:
            _dict['pageView'] = self.page_view.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageView": EventsPageViewInfo.from_dict(obj["pageView"]) if obj.get("pageView") is not None else None
        })
        return _obj
