...
class EventsRequestResult(EventsResultData):
    ...
    A request result
    """ # noqa: E501
    request: Optional[EventsRequestInfo] = None
    __properties: ClassVar[List[str]] = ["ai", "application", "client", "cloud", "count", "customDimensions", "customMeasurements", "id", "operation", "session", "timestamp", "type", "user", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": EventsRequestInfo.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
