...
class TestEventsResults(unittest.TestCase):
    """EventsResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsResults:
        """Test EventsResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsResults`
        """
        model = EventsResults()
        if include_optional:
            return EventsResults(
                ...
                odata_context = '',
                value = [
                    openapi_client.models.events_result_data.eventsResultData(
