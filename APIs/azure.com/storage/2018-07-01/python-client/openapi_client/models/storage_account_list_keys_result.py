...
class StorageAccountListKeysResult(BaseModel):
    """
    The response from the ListKeys operation.
    """ # noqa: E501
    keys: Optional[List[StorageAccountKey]] = Field(default=None, description="Gets the list of storage account keys and their properties for the specified storage account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [StorageAccountKey.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
