...
class StorageSkuListResult(BaseModel):
    """
    The response from the List Storage SKUs operation.
    """ # noqa: E501
    value: Optional[List[Sku]] = Field(default=None, description="Get the list result of storage SKUs and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Sku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
