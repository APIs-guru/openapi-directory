...
class TestManagementPolicyProperties(unittest.TestCase):
    """ManagementPolicyProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagementPolicyProperties:
        """Test ManagementPolicyProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagementPolicyProperties`
        """
        model = ManagementPolicyProperties()
        if include_optional:
            return ManagementPolicyProperties(
    ...
    def testManagementPolicyProperties(self):
        """Test ManagementPolicyProperties"""
