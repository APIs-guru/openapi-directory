...
class StorageAccountRegenerateKeyParameters(BaseModel):
    """
    The parameters used to regenerate the storage account key.
    """ # noqa: E501
    key_name: StrictStr = Field(description="The name of storage keys that want to be regenerated, possible values are key1, key2, kerb1, kerb2.", alias="keyName")
