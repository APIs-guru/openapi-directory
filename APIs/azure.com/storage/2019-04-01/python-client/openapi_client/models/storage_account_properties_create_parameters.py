...
class StorageAccountPropertiesCreateParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessTier", "azureFilesIdentityBasedAuthentication", "customDomain", "encryption", "isHnsEnabled", "largeFileSharesState", "networkAcls", "supportsHttpsTrafficOnly"]
