...
class StorageAccountPropertiesUpdateParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessTier", "azureFilesIdentityBasedAuthentication", "customDomain", "encryption", "largeFileSharesState", "networkAcls", "supportsHttpsTrafficOnly"]
