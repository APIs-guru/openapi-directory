...
class TestEncryptionService(unittest.TestCase):
    """EncryptionService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptionService:
        """Test EncryptionService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptionService`
        """
    ...
    def testEncryptionService(self):
        """Test EncryptionService"""
