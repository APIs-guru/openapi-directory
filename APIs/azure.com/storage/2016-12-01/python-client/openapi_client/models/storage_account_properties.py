...
class StorageAccountProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessTier", "creationTime", "customDomain", "encryption", "lastGeoFailoverTime", "primaryEndpoints", "primaryLocation", "provisioningState", "secondaryEndpoints", "secondaryLocation", "statusOfPrimary", "statusOfSecondary", "supportsHttpsTrafficOnly"]
