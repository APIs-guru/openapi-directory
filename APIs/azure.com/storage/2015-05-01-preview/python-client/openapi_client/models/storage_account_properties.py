...
class StorageAccountProperties(BaseModel):
    ...
    """ # noqa: E501
    account_type: Optional[StrictStr] = Field(default=None, description="Gets the type of the storage account.", alias="accountType")
    ...
    last_geo_failover_time: Optional[datetime] = Field(default=None, description="Gets the timestamp of the most recent instance of a failover to the secondary location. Only the most recent timestamp is retained. This element is not returned if there has never been a failover instance. Only available if the accountType is StandardGRS or StandardRAGRS.", alias="lastGeoFailoverTime")
    primary_endpoints: Optional[Endpoints] = Field(default=None, alias="primaryEndpoints")
    primary_location: Optional[StrictStr] = Field(default=None, description="Gets the location of the primary for the storage account.", alias="primaryLocation")
    ...
    secondary_location: Optional[StrictStr] = Field(default=None, description="Gets the location of the geo replicated secondary for the storage account. Only available if the accountType is StandardGRS or StandardRAGRS.", alias="secondaryLocation")
    ...
    status_of_secondary: Optional[StrictStr] = Field(default=None, description="Gets the status indicating whether the secondary location of the storage account is available or unavailable. Only available if the accountType is StandardGRS or StandardRAGRS.", alias="statusOfSecondary")
