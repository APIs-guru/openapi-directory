...
------------ | ------------- | ------------- | -------------
**account_type** | **str** | Gets or sets the account type. Note that StandardZRS and PremiumLRS accounts cannot be changed to other account types, and other account types cannot be changed to StandardZRS or PremiumLRS. | [optional] 
