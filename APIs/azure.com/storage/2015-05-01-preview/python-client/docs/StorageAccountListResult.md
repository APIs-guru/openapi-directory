...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Gets the link to the next set of results. Currently this will always be empty as the API does not support pagination. | [optional] 
**value** | [**List[StorageAccount]**](StorageAccount.md) | Gets the list of storage accounts and their properties. | [optional] 
