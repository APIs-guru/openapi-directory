...
------------ | ------------- | ------------- | -------------
**current_value** | **int** | Gets the current count of the allocated resources in the subscription. | [optional] 
**limit** | **int** | Gets the maximum count of the resources that can be allocated in the subscription. | [optional] 
**name** | [**UsageName**](UsageName.md) |  | [optional] 
**unit** | **str** | Gets the unit of measurement. | [optional] 
