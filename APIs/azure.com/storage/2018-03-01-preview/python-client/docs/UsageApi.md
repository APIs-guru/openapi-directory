...
------------- | ------------- | -------------
[**usages_list**](UsageApi.md#usages_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Storage/usages | 


# **usages_list**
> UsageListResult usages_list(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.usages_list(api_version, subscription_id)
