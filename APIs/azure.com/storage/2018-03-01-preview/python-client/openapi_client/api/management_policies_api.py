...
class ManagementPoliciesApi:
    ...
    @validate_call
    def storage_accounts_create_or_update_management_policies(
        self,
        ...
        management_policy_name: Annotated[StrictStr, Field(description="The name of the Storage Account Management Policy. It should always be 'default'")],
        properties: Annotated[ManagementPoliciesRulesSetParameter, Field(description="The data policy rules to set to a storage account.")],
        ...
        """storage_accounts_create_or_update_management_policies
        ...
        :param management_policy_name: The name of the Storage Account Management Policy. It should always be 'default' (required)
        :type management_policy_name: str
        :param properties: The data policy rules to set to a storage account. (required)
        :type properties: ManagementPoliciesRulesSetParameter
        ...
        _param = self._storage_accounts_create_or_update_management_policies_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StorageAccountManagementPolicies",
        }
    ...
    @validate_call
    def storage_accounts_create_or_update_management_policies_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StorageAccountManagementPolicies]:
        """storage_accounts_create_or_update_management_policies
    ...
    @validate_call
    def storage_accounts_create_or_update_management_policies_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    def _storage_accounts_create_or_update_management_policies_serialize(
        self,
        resource_group_name,
        account_name,
        api_version,
        ...
        if management_policy_name is not None:
            _path_params['managementPolicyName'] = management_policy_name
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/managementPolicies/{managementPolicyName}',
    ...
    @validate_call
    def storage_accounts_delete_management_policies(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        ...
        """storage_accounts_delete_management_policies
        ...
        _param = self._storage_accounts_delete_management_policies_serialize(
            resource_group_name=resource_group_name,
            account_name=account_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def storage_accounts_delete_management_policies_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    @validate_call
    def storage_accounts_delete_management_policies_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    def _storage_accounts_delete_management_policies_serialize(
        self,
        resource_group_name,
        account_name,
        api_version,
    ...
    @validate_call
    def storage_accounts_get_management_policies(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        ...
        """storage_accounts_get_management_policies
        ...
        _param = self._storage_accounts_get_management_policies_serialize(
            resource_group_name=resource_group_name,
            account_name=account_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def storage_accounts_get_management_policies_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    @validate_call
    def storage_accounts_get_management_policies_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group within the user's subscription. The name is case insensitive.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.")],
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
    ...
    def _storage_accounts_get_management_policies_serialize(
        self,
        resource_group_name,
        account_name,
        api_version,
