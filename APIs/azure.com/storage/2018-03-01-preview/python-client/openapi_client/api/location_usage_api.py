...
class LocationUsageApi:
    ...
    def usages_list_by_location(
        ...
        location: Annotated[StrictStr, Field(description="The location of the Azure Storage resource.")],
        ...
        _param = self._usages_list_by_location_serialize(
    ...
    @validate_call
    def usages_list_by_location_with_http_info(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        location: Annotated[StrictStr, Field(description="The location of the Azure Storage resource.")],
    ...
    @validate_call
    def usages_list_by_location_without_preload_content(
        self,
        api_version: Annotated[str, Field(min_length=1, strict=True, description="The API version to use for this operation.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        location: Annotated[StrictStr, Field(description="The location of the Azure Storage resource.")],
    ...
    def _usages_list_by_location_serialize(
        self,
        api_version,
        subscription_id,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Storage/locations/{location}/usages',
