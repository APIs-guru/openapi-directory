...
class StorageAccountListResult(BaseModel):
    """
    The response from the List Storage Accounts operation.
    """ # noqa: E501
    value: Optional[List[StorageAccount]] = Field(default=None, description="Gets the list of storage accounts and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [StorageAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
