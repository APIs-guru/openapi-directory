...
class StorageAccountUpdateParameters(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Optional. Indicates the type of storage account. Currently only StorageV2 value supported by server.")
    ...
    __properties: ClassVar[List[str]] = ["identity", "kind", "properties", "sku", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "properties": StorageAccountPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
