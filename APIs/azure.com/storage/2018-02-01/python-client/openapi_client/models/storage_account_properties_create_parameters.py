...
class StorageAccountPropertiesCreateParameters(BaseModel):
    ...
    is_hns_enabled: Optional[StrictBool] = Field(default=False, description="Account HierarchicalNamespace enabled if sets to true.", alias="isHnsEnabled")
    ...
    __properties: ClassVar[List[str]] = ["accessTier", "customDomain", "encryption", "isHnsEnabled", "networkAcls", "supportsHttpsTrafficOnly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isHnsEnabled": obj.get("isHnsEnabled") if obj.get("isHnsEnabled") is not None else False,
