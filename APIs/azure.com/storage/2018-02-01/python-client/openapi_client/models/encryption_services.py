...
class EncryptionServices(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["blob", "file", "queue", "table"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blob": EncryptionService.from_dict(obj["blob"]) if obj.get("blob") is not None else None,
            "file": EncryptionService.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "queue": EncryptionService.from_dict(obj["queue"]) if obj.get("queue") is not None else None,
            "table": EncryptionService.from_dict(obj["table"]) if obj.get("table") is not None else None
        })
        return _obj
