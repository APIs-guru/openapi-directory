...
class StorageAccountProperties(BaseModel):
    ...
    """ # noqa: E501
    account_type: Optional[StrictStr] = Field(default=None, description="The type of the storage account.", alias="accountType")
    creation_time: Optional[datetime] = Field(default=None, description="The creation date and time of the storage account in UTC.", alias="creationTime")
    custom_domain: Optional[CustomDomain] = Field(default=None, alias="customDomain")
    last_geo_failover_time: Optional[datetime] = Field(default=None, description="The timestamp of the most recent instance of a failover to the secondary location. Only the most recent timestamp is retained. This element is not returned if there has never been a failover instance. Only available if the accountType is Standard_GRS or Standard_RAGRS.", alias="lastGeoFailoverTime")
    primary_endpoints: Optional[Endpoints] = Field(default=None, alias="primaryEndpoints")
    primary_location: Optional[StrictStr] = Field(default=None, description="The location of the primary data center for the storage account.", alias="primaryLocation")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="The status of the storage account at the time the operation was called.", alias="provisioningState")
    secondary_endpoints: Optional[Endpoints] = Field(default=None, alias="secondaryEndpoints")
    secondary_location: Optional[StrictStr] = Field(default=None, description="The location of the geo-replicated secondary for the storage account. Only available if the accountType is Standard_GRS or Standard_RAGRS.", alias="secondaryLocation")
    status_of_primary: Optional[StrictStr] = Field(default=None, description="The status indicating whether the primary location of the storage account is available or unavailable.", alias="statusOfPrimary")
    status_of_secondary: Optional[StrictStr] = Field(default=None, description="The status indicating whether the secondary location of the storage account is available or unavailable. Only available if the SKU name is Standard_GRS or Standard_RAGRS.", alias="statusOfSecondary")
    __properties: ClassVar[List[str]] = ["accountType", "creationTime", "customDomain", "lastGeoFailoverTime", "primaryEndpoints", "primaryLocation", "provisioningState", "secondaryEndpoints", "secondaryLocation", "statusOfPrimary", "statusOfSecondary"]
