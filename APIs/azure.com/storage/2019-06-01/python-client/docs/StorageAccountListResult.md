...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. | [optional] [readonly] 
