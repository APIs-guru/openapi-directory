...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    expand = 'expand_example' # str | May be used to expand the properties within account's properties. By default, data is not included when fetching properties. Currently we only support geoReplicationStats and blobRestoreStatus. (optional)
 ...
 **api_version** | **str**| The API version to use for this operation. | 
 **subscription_id** | **str**| The ID of the target subscription. | 
 **expand** | **str**| May be used to expand the properties within account&#39;s properties. By default, data is not included when fetching properties. Currently we only support geoReplicationStats and blobRestoreStatus. | [optional] 
...
> StorageAccountListKeysResult storage_accounts_list_keys(resource_group_name, account_name, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    expand = 'expand_example' # str | Specifies type of the key to be listed. Possible value is kerb. (optional)

    try:
        api_response = api_instance.storage_accounts_list_keys(resource_group_name, account_name, api_version, subscription_id, expand=expand)
 ...
 **api_version** | **str**| The API version to use for this operation. | 
 **subscription_id** | **str**| The ID of the target subscription. | 
 **expand** | **str**| Specifies type of the key to be listed. Possible value is kerb. | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    regenerate_key = openapi_client.StorageAccountRegenerateKeyParameters() # StorageAccountRegenerateKeyParameters | Specifies name of the key which should be regenerated -- key1, key2, kerb1, kerb2.
...
> BlobRestoreStatus storage_accounts_restore_blob_ranges(resource_group_name, account_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The API version to use for this operation.
    subscription_id = 'subscription_id_example' # str | The ID of the target subscription.
    parameters = openapi_client.BlobRestoreParameters() # BlobRestoreParameters | The parameters to provide for restore blob ranges.

    try:
        api_response = api_instance.storage_accounts_restore_blob_ranges(resource_group_name, account_name, api_version, subscription_id, parameters)
        print("The response of StorageAccountsApi->storage_accounts_restore_blob_ranges:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StorageAccountsApi->storage_accounts_restore_blob_ranges: %s\n" % e)
```
...
> storage_accounts_revoke_user_delegation_keys(resource_group_name, account_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.storage_accounts_revoke_user_delegation_keys(resource_group_name, account_name, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling StorageAccountsApi->storage_accounts_revoke_user_delegation_keys: %s\n" % e)
```
