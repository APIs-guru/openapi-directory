...
class StorageAccountProperties(BaseModel):
    ...
    azure_files_identity_based_authentication: Optional[AzureFilesIdentityBasedAuthentication] = Field(default=None, alias="azureFilesIdentityBasedAuthentication")
    blob_restore_status: Optional[BlobRestoreStatus] = Field(default=None, alias="blobRestoreStatus")
    ...
    large_file_shares_state: Optional[StrictStr] = Field(default=None, description="Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.", alias="largeFileSharesState")
    ...
    private_endpoint_connections: Optional[List[PrivateEndpointConnection]] = Field(default=None, description="List of private endpoint connection associated with the specified storage account", alias="privateEndpointConnections")
    ...
    routing_preference: Optional[RoutingPreference] = Field(default=None, alias="routingPreference")
    ...
    @field_validator('large_file_shares_state')
    def large_file_shares_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of azure_files_identity_based_authentication
        if self.azure_files_identity_based_authentication:
            _dict['azureFilesIdentityBasedAuthentication'] = self.azure_files_identity_based_authentication.to_dict()
        # override the default output from pydantic by calling `to_dict()` of blob_restore_status
        if self.blob_restore_status:
            _dict['blobRestoreStatus'] = self.blob_restore_status.to_dict()
        ...
        if self.routing_preference:
            _dict['routingPreference'] = self.routing_preference.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "azureFilesIdentityBasedAuthentication": AzureFilesIdentityBasedAuthentication.from_dict(obj["azureFilesIdentityBasedAuthentication"]) if obj.get("azureFilesIdentityBasedAuthentication") is not None else None,
            "blobRestoreStatus": BlobRestoreStatus.from_dict(obj["blobRestoreStatus"]) if obj.get("blobRestoreStatus") is not None else None,
            ...
            "largeFileSharesState": obj.get("largeFileSharesState"),
            ...
            "routingPreference": RoutingPreference.from_dict(obj["routingPreference"]) if obj.get("routingPreference") is not None else None,
