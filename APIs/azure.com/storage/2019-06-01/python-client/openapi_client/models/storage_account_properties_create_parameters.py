...
class StorageAccountPropertiesCreateParameters(BaseModel):
    ...
    supports_https_traffic_only: Optional[StrictBool] = Field(default=None, description="Allows https traffic only to storage service if sets to true. The default value is true since API version 2019-04-01.", alias="supportsHttpsTrafficOnly")
    __properties: ClassVar[List[str]] = ["accessTier", "azureFilesIdentityBasedAuthentication", "customDomain", "encryption", "isHnsEnabled", "largeFileSharesState", "networkAcls", "routingPreference", "supportsHttpsTrafficOnly"]
