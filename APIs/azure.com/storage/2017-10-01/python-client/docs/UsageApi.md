...
------------- | ------------- | -------------
[**usage_list**](UsageApi.md#usage_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Storage/usages | 


# **usage_list**
> UsageListResult usage_list(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.usage_list(api_version, subscription_id)
...
|-------------|-------------|------------------|
**200** | OK -- current usage account and limit retrieved and returned successfully. |  -  |
