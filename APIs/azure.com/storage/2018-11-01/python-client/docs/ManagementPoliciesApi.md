...
> ManagementPolicy management_policies_create_or_update(resource_group_name, account_name, api_version, subscription_id, management_policy_name, properties)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    properties = openapi_client.ManagementPolicy() # ManagementPolicy | The ManagementPolicy set to a storage account.
...
> ManagementPolicy management_policies_get(resource_group_name, account_name, api_version, subscription_id, management_policy_name)
