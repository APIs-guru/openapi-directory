...
class TestEncryptionServices(unittest.TestCase):
    """EncryptionServices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncryptionServices:
        """Test EncryptionServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncryptionServices`
        """
        ...
        if include_optional:
            return EncryptionServices(
                ...
                file = openapi_client.models.encryption_service.EncryptionService(
                    enabled = True, 
                    last_enabled_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                queue = openapi_client.models.encryption_service.EncryptionService(
                    enabled = True, 
                    last_enabled_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                table = openapi_client.models.encryption_service.EncryptionService(
                    enabled = True, 
                    last_enabled_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
            )
        else:
    ...
    def testEncryptionServices(self):
        """Test EncryptionServices"""
