...
class Sku(BaseModel):
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Standard_LRS', 'Standard_GRS', 'Standard_RAGRS', 'Standard_ZRS', 'Premium_LRS', 'Premium_ZRS']):
            raise ValueError("must be one of enum values ('Standard_LRS', 'Standard_GRS', 'Standard_RAGRS', 'Standard_ZRS', 'Premium_LRS', 'Premium_ZRS')")
        return value
