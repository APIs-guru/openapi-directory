...
class ConsentLinkPayload(BaseModel):
    """
    Collection of consent links
    """ # noqa: E501
    value: Optional[List[ConsentLink]] = Field(default=None, description="Collection of resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConsentLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
