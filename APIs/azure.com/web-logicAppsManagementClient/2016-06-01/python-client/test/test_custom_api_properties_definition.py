...
class TestCustomApiPropertiesDefinition(unittest.TestCase):
    """CustomApiPropertiesDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomApiPropertiesDefinition:
        """Test CustomApiPropertiesDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomApiPropertiesDefinition`
        """
        model = CustomApiPropertiesDefinition()
        if include_optional:
    ...
    def testCustomApiPropertiesDefinition(self):
        """Test CustomApiPropertiesDefinition"""
