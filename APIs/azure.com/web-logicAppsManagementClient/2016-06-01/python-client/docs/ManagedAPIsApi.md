...
------------- | ------------- | -------------
[**managed_apis_get**](ManagedAPIsApi.md#managed_apis_get) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/managedApis/{apiName} | Gets managed API
[**managed_apis_list**](ManagedAPIsApi.md#managed_apis_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/managedApis | Lists managed APIs


# **managed_apis_get**
> ManagedApiDefinition managed_apis_get(subscription_id, location, api_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets managed API
        api_response = api_instance.managed_apis_get(subscription_id, location, api_name, api_version)
...
# **managed_apis_list**
> ManagedApiDefinitionCollection managed_apis_list(location, subscription_id, api_version)
