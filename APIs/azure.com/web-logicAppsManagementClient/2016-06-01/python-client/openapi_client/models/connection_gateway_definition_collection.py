...
class ConnectionGatewayDefinitionCollection(BaseModel):
    """
    A list of connection gateway definitions
    """ # noqa: E501
    value: Optional[List[ConnectionGatewayDefinition]] = Field(default=None, description="Collection of connection gateways")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConnectionGatewayDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
