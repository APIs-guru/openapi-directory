...
class ApiResourceMetadata(BaseModel):
    ...
    hide_key: Optional[StrictStr] = Field(default=None, description="Hide key", alias="hideKey")
    ...
    __properties: ClassVar[List[str]] = ["apiType", "brandColor", "connectionType", "hideKey", "source", "tags", "wsdlImportMethod", "wsdlService"]
