...
class CustomApiDefinitionCollection(BaseModel):
    """
    A list of custom API definitions
    """ # noqa: E501
    value: Optional[List[CustomApiDefinition]] = Field(default=None, description="Collection of custom APIs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CustomApiDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
