...
class ConsentLinkParameterDefinition(BaseModel):
    """
    ...
    parameter_name: Optional[StrictStr] = Field(default=None, description="Name of the parameter in the connection provider's OAuth settings", alias="parameterName")
    redirect_url: Optional[StrictStr] = Field(default=None, description="Name of the parameter in the connection provider's OAuth settings", alias="redirectUrl")
    tenant_id: Optional[StrictStr] = Field(default=None, description="The tenant id", alias="tenantId")
    __properties: ClassVar[List[str]] = ["objectId", "parameterName", "redirectUrl", "tenantId"]
