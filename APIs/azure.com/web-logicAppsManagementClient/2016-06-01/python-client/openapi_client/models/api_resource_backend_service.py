...
class ApiResourceBackendService(BaseModel):
    """
    The API backend service
    """ # noqa: E501
    service_url: Optional[StrictStr] = Field(default=None, description="The service URL", alias="serviceUrl")
    __properties: ClassVar[List[str]] = ["serviceUrl"]
