...
class WsdlDefinition(BaseModel):
    """
    The WSDL definition
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The WSDL content")
    import_method: Optional[WsdlImportMethod] = Field(default=None, alias="importMethod")
    service: Optional[WsdlService] = None
    url: Optional[StrictStr] = Field(default=None, description="The WSDL URL")
    __properties: ClassVar[List[str]] = ["content", "importMethod", "service", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "service": WsdlService.from_dict(obj["service"]) if obj.get("service") is not None else None,
            "url": obj.get("url")
        })
        return _obj
