...
class ManagedApiDefinitionCollection(BaseModel):
    """
    A list of managed API definitions
    """ # noqa: E501
    value: Optional[List[ManagedApiDefinition]] = Field(default=None, description="Collection of managed APIs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ManagedApiDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
