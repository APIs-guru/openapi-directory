...
class ListConsentLinksDefinition(BaseModel):
    """
    Request for a list of consent links
    """ # noqa: E501
    parameters: Optional[List[ConsentLinkParameterDefinition]] = Field(default=None, description="Collection of resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": [ConsentLinkParameterDefinition.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
