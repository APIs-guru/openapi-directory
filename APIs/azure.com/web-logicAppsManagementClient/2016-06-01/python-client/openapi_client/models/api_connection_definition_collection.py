...
class ApiConnectionDefinitionCollection(BaseModel):
    """
    A list of API connection definitions
    """ # noqa: E501
    value: Optional[List[ApiConnectionDefinition]] = Field(default=None, description="Collection of API connections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ApiConnectionDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
