...
class ConnectionGatewayInstallationDefinitionCollection(BaseModel):
    """
    A list of connection gateway installation definitions
    """ # noqa: E501
    value: Optional[List[ConnectionGatewayInstallationDefinition]] = Field(default=None, description="Collection of connection gateway installations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConnectionGatewayInstallationDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
