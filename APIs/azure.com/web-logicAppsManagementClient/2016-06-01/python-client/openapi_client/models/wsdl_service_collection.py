...
class WsdlServiceCollection(BaseModel):
    """
    A list of custom API WSDL interfaces
    """ # noqa: E501
    value: Optional[List[WsdlService]] = Field(default=None, description="Collection of WSDL interfaces")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [WsdlService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
