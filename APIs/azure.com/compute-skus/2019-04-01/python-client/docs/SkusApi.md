...
# **resource_skus_list**
> ResourceSkusResult resource_skus_list(api_version, subscription_id, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.resource_skus_list(api_version, subscription_id, filter=filter)
