...
------------ | ------------- | ------------- | -------------
**capabilities** | [**List[ResourceSkuCapabilities]**](ResourceSkuCapabilities.md) | A list of capabilities that are available for the SKU in the specified list of zones. | [optional] [readonly] 
