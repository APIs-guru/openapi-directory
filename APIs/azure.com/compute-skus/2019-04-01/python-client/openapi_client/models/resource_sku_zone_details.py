...
class ResourceSkuZoneDetails(BaseModel):
    """
    Describes The zonal capabilities of a SKU.
    """ # noqa: E501
    capabilities: Optional[List[ResourceSkuCapabilities]] = Field(default=None, description="A list of capabilities that are available for the SKU in the specified list of zones.")
    name: Optional[List[StrictStr]] = Field(default=None, description="The set of zones that the SKU is available in with the specified capabilities.")
