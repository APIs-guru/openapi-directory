...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    virtual_hub_parameters = openapi_client.P2sVpnGatewaysUpdateTagsRequest() # P2sVpnGatewaysUpdateTagsRequest | Parameters supplied to update VirtualHub tags.
 ...
 **virtual_hub_parameters** | [**P2sVpnGatewaysUpdateTagsRequest**](P2sVpnGatewaysUpdateTagsRequest.md)| Parameters supplied to update VirtualHub tags. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client API version.
    wan_parameters = openapi_client.P2sVpnGatewaysUpdateTagsRequest() # P2sVpnGatewaysUpdateTagsRequest | Parameters supplied to Update VirtualWAN tags.
 ...
 **api_version** | **str**| Client API version. | 
 **wan_parameters** | [**P2sVpnGatewaysUpdateTagsRequest**](P2sVpnGatewaysUpdateTagsRequest.md)| Parameters supplied to Update VirtualWAN tags. | 
