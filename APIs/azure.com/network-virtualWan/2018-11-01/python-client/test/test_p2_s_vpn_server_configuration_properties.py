...
class TestP2SVpnServerConfigurationProperties(unittest.TestCase):
    """P2SVpnServerConfigurationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> P2SVpnServerConfigurationProperties:
        """Test P2SVpnServerConfigurationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `P2SVpnServerConfigurationProperties`
        """
        model = P2SVpnServerConfigurationProperties()
        if include_optional:
            return P2SVpnServerConfigurationProperties(
                ...
                p2_s_vpn_server_config_vpn_client_revoked_certificates = [
                    openapi_client.models.p2_s_vpn_server_config_vpn_client_revoked_certificate.P2SVpnServerConfigVpnClientRevokedCertificate(
                        etag = '', 
                        name = '', 
                        properties = openapi_client.models.p2_s_vpn_server_config_vpn_client_revoked_certificate_properties_format.P2SVpnServerConfigVpnClientRevokedCertificatePropertiesFormat(
                            provisioning_state = '', 
                            thumbprint = '', ), )
                    ],
    ...
    def testP2SVpnServerConfigurationProperties(self):
        """Test P2SVpnServerConfigurationProperties"""
