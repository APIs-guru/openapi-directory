...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    vpn_site_parameters = openapi_client.VirtualHubsUpdateTagsRequest() # VirtualHubsUpdateTagsRequest | Parameters supplied to update VpnSite tags.
 ...
 **vpn_site_parameters** | [**VirtualHubsUpdateTagsRequest**](VirtualHubsUpdateTagsRequest.md)| Parameters supplied to update VpnSite tags. | 
