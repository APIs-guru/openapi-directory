...
class VpnSitesApi:
    ...
    def vpn_sites_update_tags(
        ...
        vpn_site_name: Annotated[StrictStr, Field(description="The name of the VpnSite being updated.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        vpn_site_parameters: Annotated[P2sVpnGatewaysUpdateTagsRequest, Field(description="Parameters supplied to update VpnSite tags.")],
        ...
        :type vpn_site_parameters: P2sVpnGatewaysUpdateTagsRequest
        ...
        _param = self._vpn_sites_update_tags_serialize(
    ...
    @validate_call
    def vpn_sites_update_tags_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The resource group name of the VpnSite.")],
        vpn_site_name: Annotated[StrictStr, Field(description="The name of the VpnSite being updated.")],
    ...
    @validate_call
    def vpn_sites_update_tags_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="The resource group name of the VpnSite.")],
        vpn_site_name: Annotated[StrictStr, Field(description="The name of the VpnSite being updated.")],
    ...
    def _vpn_sites_update_tags_serialize(
        self,
        subscription_id,
        resource_group_name,
        vpn_site_name,
