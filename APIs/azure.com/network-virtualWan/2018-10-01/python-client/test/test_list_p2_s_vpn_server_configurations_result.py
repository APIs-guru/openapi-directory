...
class TestListP2SVpnServerConfigurationsResult(unittest.TestCase):
    """ListP2SVpnServerConfigurationsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListP2SVpnServerConfigurationsResult:
        """Test ListP2SVpnServerConfigurationsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListP2SVpnServerConfigurationsResult`
        """
        model = ListP2SVpnServerConfigurationsResult()
        if include_optional:
    ...
    def testListP2SVpnServerConfigurationsResult(self):
        """Test ListP2SVpnServerConfigurationsResult"""
