...
class VpnGatewaysApi:
    ...
    def vpn_gateways_update_tags(
        ...
        vpn_gateway_parameters: Annotated[P2sVpnGatewaysUpdateTagsRequest, Field(description="Parameters supplied to update a virtual wan vpn gateway tags.")],
        ...
        :type vpn_gateway_parameters: P2sVpnGatewaysUpdateTagsRequest
