...
class ListVpnSitesResult(BaseModel):
    """
    ...
    value: Optional[List[VpnSite]] = Field(default=None, description="List of VpnSites.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VpnSite.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
