...
class TestListP2SVpnGatewaysResult(unittest.TestCase):
    """ListP2SVpnGatewaysResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListP2SVpnGatewaysResult:
        """Test ListP2SVpnGatewaysResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListP2SVpnGatewaysResult`
        """
        model = ListP2SVpnGatewaysResult()
        if include_optional:
            return ListP2SVpnGatewaysResult(
                next_link = '',
                value = [
                    openapi_client.models.p2_s_vpn_gateway.P2SVpnGateway(
                        etag = '', 
                        properties = openapi_client.models.p2_s_vpn_gateway_properties.P2SVpnGatewayProperties(
                            custom_routes = openapi_client.models.p2_s_vpn_gateway_properties_custom_routes.P2SVpnGatewayProperties_customRoutes(
                                address_prefixes = [
                                    ''
                                    ], ), 
                            ...
                            virtual_hub = openapi_client.models.hub_virtual_network_connection_properties_remote_virtual_network.HubVirtualNetworkConnectionProperties_remoteVirtualNetwork(
                                id = '', ), 
                            vpn_client_address_pool = openapi_client.models.p2_s_vpn_gateway_properties_custom_routes.P2SVpnGatewayProperties_customRoutes(), 
    ...
    def testListP2SVpnGatewaysResult(self):
        """Test ListP2SVpnGatewaysResult"""
