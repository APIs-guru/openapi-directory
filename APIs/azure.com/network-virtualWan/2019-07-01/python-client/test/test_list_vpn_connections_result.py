...
class TestListVpnConnectionsResult(unittest.TestCase):
    """ListVpnConnectionsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListVpnConnectionsResult:
        """Test ListVpnConnectionsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListVpnConnectionsResult`
        """
        model = ListVpnConnectionsResult()
        if include_optional:
    ...
    def testListVpnConnectionsResult(self):
        """Test ListVpnConnectionsResult"""
