...
class TestListVpnSiteLinksResult(unittest.TestCase):
    """ListVpnSiteLinksResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListVpnSiteLinksResult:
        """Test ListVpnSiteLinksResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListVpnSiteLinksResult`
        """
        model = ListVpnSiteLinksResult()
        if include_optional:
    ...
    def testListVpnSiteLinksResult(self):
        """Test ListVpnSiteLinksResult"""
