...
class VirtualHubRouteTable(BaseModel):
    """
    VirtualHub route table.
    """ # noqa: E501
    routes: Optional[List[VirtualHubRoute]] = Field(default=None, description="List of all routes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "routes": [VirtualHubRoute.from_dict(_item) for _item in obj["routes"]] if obj.get("routes") is not None else None
        })
        return _obj
