...
class VpnConnectionProperties(BaseModel):
    ...
    vpn_link_connections: Optional[List[VpnSiteLinkConnection]] = Field(default=None, description="List of all vpn site link connections to the gateway.", alias="vpnLinkConnections")
    __properties: ClassVar[List[str]] = ["connectionBandwidth", "connectionStatus", "egressBytesTransferred", "enableBgp", "enableInternetSecurity", "enableRateLimiting", "ingressBytesTransferred", "ipsecPolicies", "provisioningState", "remoteVpnSite", "routingWeight", "sharedKey", "useLocalAzureIpAddress", "usePolicyBasedTrafficSelectors", "vpnConnectionProtocolType", "vpnLinkConnections"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vpn_link_connections (list)
        _items = []
        if self.vpn_link_connections:
            for _item_vpn_link_connections in self.vpn_link_connections:
                if _item_vpn_link_connections:
                    _items.append(_item_vpn_link_connections.to_dict())
            _dict['vpnLinkConnections'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vpnLinkConnections": [VpnSiteLinkConnection.from_dict(_item) for _item in obj["vpnLinkConnections"]] if obj.get("vpnLinkConnections") is not None else None
        })
        return _obj
