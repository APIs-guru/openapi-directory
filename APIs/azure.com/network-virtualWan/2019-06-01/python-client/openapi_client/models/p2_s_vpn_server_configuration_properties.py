...
class P2SVpnServerConfigurationProperties(BaseModel):
    ...
    p2_s_vpn_gateways: Optional[List[HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork]] = Field(default=None, description="List of references to P2SVpnGateways.", alias="p2SVpnGateways")
