...
------------ | ------------- | ------------- | -------------
**output_blob_sas_url** | **str** | The sas-url to download the configurations for vpn-sites | [optional] 
**vpn_sites** | [**List[GetVpnSitesConfigurationRequestVpnSitesInner]**](GetVpnSitesConfigurationRequestVpnSitesInner.md) | List of resource-ids of the vpn-sites for which config is to be downloaded. | [optional] 
