...
class VpnSitesApi:
    ...
    def vpn_sites_update_tags(
        ...
        vpn_site_parameters: Annotated[VirtualHubsUpdateTagsRequest, Field(description="Parameters supplied to update VpnSite tags.")],
        ...
        :type vpn_site_parameters: VirtualHubsUpdateTagsRequest
