...
class VpnGatewayProperties(BaseModel):
    ...
    virtual_hub: Optional[GetVpnSitesConfigurationRequestVpnSitesInner] = Field(default=None, alias="virtualHub")
    __properties: ClassVar[List[str]] = ["bgpSettings", "connections", "policies", "provisioningState", "virtualHub"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "virtualHub": GetVpnSitesConfigurationRequestVpnSitesInner.from_dict(obj["virtualHub"]) if obj.get("virtualHub") is not None else None
        })
        return _obj
