...
class TestP2SVpnServerConfiguration(unittest.TestCase):
    """P2SVpnServerConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> P2SVpnServerConfiguration:
        """Test P2SVpnServerConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `P2SVpnServerConfiguration`
        """
        model = P2SVpnServerConfiguration()
        if include_optional:
    ...
    def testP2SVpnServerConfiguration(self):
        """Test P2SVpnServerConfiguration"""
