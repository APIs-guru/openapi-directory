...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    vpn_gateway_parameters = openapi_client.VirtualHubsUpdateTagsRequest() # VirtualHubsUpdateTagsRequest | Parameters supplied to update a virtual wan vpn gateway tags.
 ...
 **vpn_gateway_parameters** | [**VirtualHubsUpdateTagsRequest**](VirtualHubsUpdateTagsRequest.md)| Parameters supplied to update a virtual wan vpn gateway tags. | 
