...
class ListP2SVpnGatewaysResult(BaseModel):
    """
    ...
    value: Optional[List[P2SVpnGateway]] = Field(default=None, description="List of P2SVpnGateways.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [P2SVpnGateway.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
