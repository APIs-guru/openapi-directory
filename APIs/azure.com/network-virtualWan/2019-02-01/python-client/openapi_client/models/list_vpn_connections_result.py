...
class ListVpnConnectionsResult(BaseModel):
    """
    ...
    value: Optional[List[VpnConnection]] = Field(default=None, description="List of Vpn Connections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VpnConnection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
