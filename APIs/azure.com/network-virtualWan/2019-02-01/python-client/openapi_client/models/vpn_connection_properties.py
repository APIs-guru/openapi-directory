...
class VpnConnectionProperties(BaseModel):
    ...
    remote_vpn_site: Optional[HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork] = Field(default=None, alias="remoteVpnSite")
    ...
    vpn_connection_protocol_type: Optional[StrictStr] = Field(default=None, description="Gateway connection protocol. Possible values are: 'IKEv2', 'IKEv1'.", alias="vpnConnectionProtocolType")
    __properties: ClassVar[List[str]] = ["connectionBandwidth", "connectionStatus", "egressBytesTransferred", "enableBgp", "enableInternetSecurity", "enableRateLimiting", "ingressBytesTransferred", "ipsecPolicies", "provisioningState", "remoteVpnSite", "routingWeight", "sharedKey", "useLocalAzureIpAddress", "vpnConnectionProtocolType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remoteVpnSite": HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork.from_dict(obj["remoteVpnSite"]) if obj.get("remoteVpnSite") is not None else None,
