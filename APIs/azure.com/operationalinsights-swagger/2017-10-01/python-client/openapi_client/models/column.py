...
class Column(BaseModel):
    ...
    A column in a table.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of this column.")
    type: Optional[StrictStr] = Field(default=None, description="The data type of this column.")
