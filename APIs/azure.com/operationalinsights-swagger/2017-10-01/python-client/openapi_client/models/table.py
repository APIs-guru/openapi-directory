...
class Table(BaseModel):
    ...
    """ # noqa: E501
    columns: List[Column] = Field(description="The list of columns in this table.")
    name: StrictStr = Field(description="The name of the table.")
    rows: List[List[StrictStr]] = Field(description="The resulting rows from this query.")
    __properties: ClassVar[List[str]] = ["columns", "name", "rows"]
