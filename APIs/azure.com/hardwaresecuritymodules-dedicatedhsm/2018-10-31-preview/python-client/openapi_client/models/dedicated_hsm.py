...
class DedicatedHsm(BaseModel):
    """
    Resource information with extended details.
    """ # noqa: E501
    properties: DedicatedHsmProperties
    id: Optional[StrictStr] = Field(default=None, description="The Azure Resource Manager resource ID for the dedicated HSM.")
    location: StrictStr = Field(description="The supported Azure location where the dedicated HSM should be created.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the dedicated HSM.")
    sku: Optional[Sku] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Resource tags")
    type: Optional[StrictStr] = Field(default=None, description="The resource type of the dedicated HSM.")
    zones: Optional[List[StrictStr]] = Field(default=None, description="The Dedicated Hsm zones.")
    __properties: ClassVar[List[str]] = ["id", "location", "name", "sku", "tags", "type", "zones"]
