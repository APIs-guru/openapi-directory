...
class ResourceListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of dedicated HSM resources.", alias="nextLink")
    value: Optional[List[Resource]] = Field(default=None, description="The list of dedicated HSM resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Resource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
