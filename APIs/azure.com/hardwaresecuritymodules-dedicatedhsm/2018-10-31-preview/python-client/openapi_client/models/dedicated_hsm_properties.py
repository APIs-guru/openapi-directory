...
class DedicatedHsmProperties(BaseModel):
    """
    Properties of the dedicated hsm
    """ # noqa: E501
    network_profile: Optional[NetworkProfile] = Field(default=None, alias="networkProfile")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state.", alias="provisioningState")
    stamp_id: Optional[StrictStr] = Field(default=None, description="This field will be used when RP does not support Availability zones.", alias="stampId")
    status_message: Optional[StrictStr] = Field(default=None, description="Resource Status Message.", alias="statusMessage")
    __properties: ClassVar[List[str]] = ["networkProfile", "provisioningState", "stampId", "statusMessage"]
    ...
    def provisioning_state_validate_enum(cls, value):
        ...
        if value not in set(['Succeeded', 'Provisioning', 'Allocating', 'Connecting', 'Failed', 'CheckingQuota', 'Deleting']):
            raise ValueError("must be one of enum values ('Succeeded', 'Provisioning', 'Allocating', 'Connecting', 'Failed', 'CheckingQuota', 'Deleting')")
        return value
