...
class NetworkProfile(BaseModel):
    ...
    NetworkProfile
    """ # noqa: E501
    network_interfaces: Optional[List[NetworkInterface]] = Field(default=None, description="Specifies the list of resource Ids for the network interfaces associated with the dedicated HSM.", alias="networkInterfaces")
    subnet: Optional[ApiEntityReference] = None
    __properties: ClassVar[List[str]] = ["networkInterfaces", "subnet"]
