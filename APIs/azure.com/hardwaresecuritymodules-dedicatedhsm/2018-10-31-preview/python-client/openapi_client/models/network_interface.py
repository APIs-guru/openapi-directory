...
class NetworkInterface(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ARM resource id in the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/...")
    private_ip_address: Optional[StrictStr] = Field(default=None, description="Private Ip address of the interface", alias="privateIpAddress")
    __properties: ClassVar[List[str]] = ["id", "privateIpAddress"]
