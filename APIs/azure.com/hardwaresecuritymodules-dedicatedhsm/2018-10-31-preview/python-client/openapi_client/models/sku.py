...
class Sku(BaseModel):
    ...
    Sku
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="SKU of the dedicated HSM")
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['SafeNet Luna Network HSM A790']):
            raise ValueError("must be one of enum values ('SafeNet Luna Network HSM A790')")
        return value
