...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The URL to get the next set of dedicated HSM resources. | [optional] 
**value** | [**List[Resource]**](Resource.md) | The list of dedicated HSM resources. | [optional] 
