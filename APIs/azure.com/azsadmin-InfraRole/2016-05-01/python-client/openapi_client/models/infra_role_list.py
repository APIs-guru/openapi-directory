...
class InfraRoleList(BaseModel):
    ...
    value: Optional[List[InfraRole]] = Field(default=None, description="List of infrastructure roles.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [InfraRole.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
