...
class InfraRolesApi:
    ...
    def infra_roles_get(
        ...
        infra_role: Annotated[StrictStr, Field(description="Infrastructure role name.")],
        ...
        :type location: str
        :param infra_role: Infrastructure role name. (required)
        :type infra_role: str
        ...
        _param = self._infra_roles_get_serialize(
    ...
    @validate_call
    def infra_roles_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    @validate_call
    def infra_roles_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _infra_roles_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        if infra_role is not None:
            _path_params['infraRole'] = infra_role
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/infraRoles/{infraRole}',
    ...
    def infra_roles_list(
        ...
        _param = self._infra_roles_list_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            location=location,
            api_version=api_version,
    ...
    @validate_call
    def infra_roles_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    @validate_call
    def infra_roles_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        location: Annotated[StrictStr, Field(description="Location of the resource.")],
    ...
    def _infra_roles_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/infraRoles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
