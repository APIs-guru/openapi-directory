...
------------ | ------------- | ------------- | -------------
*InfraRoleApi* | [**infra_roles_restart**](docs/InfraRoleApi.md#infra_roles_restart) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/infraRoles/{infraRole}/Restart | 
*InfraRolesApi* | [**infra_roles_get**](docs/InfraRolesApi.md#infra_roles_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/infraRoles/{infraRole} | 
*InfraRolesApi* | [**infra_roles_list**](docs/InfraRolesApi.md#infra_roles_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/infraRoles | 


## Documentation For Models

 - [InfraRole](docs/InfraRole.md)
 - [InfraRoleList](docs/InfraRoleList.md)
 - [InfraRoleModel](docs/InfraRoleModel.md)
