...
class TestDashboardProperties(unittest.TestCase):
    """DashboardProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardProperties:
        """Test DashboardProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardProperties`
        """
    ...
    def testDashboardProperties(self):
        """Test DashboardProperties"""
