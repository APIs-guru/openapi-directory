...
class ResourceProviderOperation(BaseModel):
    ...
    is_data_action: Optional[StrictStr] = Field(default=None, description="Indicates whether the operation applies to data-plane.", alias="isDataAction")
    name: Optional[StrictStr] = Field(default=None, description="Operation name, in format of {provider}/{resource}/{operation}")
    __properties: ClassVar[List[str]] = ["display", "isDataAction", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": ResourceProviderOperationDisplay.from_dict(obj["display"]) if obj.get("display") is not None else None,
