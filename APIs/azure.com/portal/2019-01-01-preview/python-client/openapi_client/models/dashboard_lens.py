...
class DashboardLens(BaseModel):
    ...
    A dashboard lens.
    """ # noqa: E501
    metadata: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="The dashboard len's metadata.")
    order: StrictInt = Field(description="The lens order.")
    parts: Dict[str, DashboardParts] = Field(description="The dashboard parts.")
    __properties: ClassVar[List[str]] = ["metadata", "order", "parts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": obj.get("order"),
            "parts": dict(
                (_k, DashboardParts.from_dict(_v))
