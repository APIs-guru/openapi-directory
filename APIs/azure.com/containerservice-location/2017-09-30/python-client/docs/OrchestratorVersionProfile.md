...
------------ | ------------- | ------------- | -------------
**default** | **bool** | Installed by default if version is not specified. | 
**orchestrator_type** | **str** | Orchestrator type. | 
**orchestrator_version** | **str** | Orchestrator version (major, minor, patch). | 
**upgrades** | [**List[OrchestratorProfile]**](OrchestratorProfile.md) | The list of available upgrade versions. | 
