...
class ContainerServicesApi:
    ...
    @validate_call
    def container_services_list_orchestrators(
        self,
        ...
        resource_type: Annotated[Optional[StrictStr], Field(description="resource type for which the list of orchestrators needs to be returned")] = None,
        ...
        _param = self._container_services_list_orchestrators_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrchestratorVersionProfileListResult",
        }
    ...
    @validate_call
    def container_services_list_orchestrators_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="The name of a supported Azure region.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrchestratorVersionProfileListResult]:
        """Gets a list of supported orchestrators in the specified subscription.
    ...
    @validate_call
    def container_services_list_orchestrators_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        location: Annotated[StrictStr, Field(description="The name of a supported Azure region.")],
    ...
    def _container_services_list_orchestrators_serialize(
        self,
        api_version,
        subscription_id,
        location,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/locations/{location}/orchestrators',
