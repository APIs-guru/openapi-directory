...
class LoggerCollection(BaseModel):
    ...
    value: Optional[List[LoggerResponse]] = Field(default=None, description="Logger values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LoggerResponse.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
