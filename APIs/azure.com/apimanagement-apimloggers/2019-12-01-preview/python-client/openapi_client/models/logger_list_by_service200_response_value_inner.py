...
class LoggerListByService200ResponseValueInner(BaseModel):
    """
    Logger details.
    """ # noqa: E501
    properties: Optional[LoggerListByService200ResponseValueInnerProperties] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoggerListByService200ResponseValueInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoggerListByService200ResponseValueInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "properties": LoggerListByService200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
