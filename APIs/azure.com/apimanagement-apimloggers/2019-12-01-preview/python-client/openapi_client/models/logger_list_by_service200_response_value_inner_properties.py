...
class LoggerListByService200ResponseValueInnerProperties(BaseModel):
    """
    ...
    resource_id: Optional[StrictStr] = Field(default=None, description="Azure Resource Id of a log target (either Azure Event Hub resource or Azure Application Insights resource).", alias="resourceId")
    __properties: ClassVar[List[str]] = ["credentials", "description", "isBuffered", "loggerType", "resourceId"]
