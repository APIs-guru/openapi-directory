...
class LoggerUpdateRequestProperties(BaseModel):
    """
    Parameters supplied to the Update Logger operation.
    """ # noqa: E501
    credentials: Optional[Dict[str, StrictStr]] = Field(default=None, description="Logger credentials.")
    description: Optional[StrictStr] = Field(default=None, description="Logger description.")
    ...
    logger_type: Optional[StrictStr] = Field(default=None, description="Logger type.", alias="loggerType")
