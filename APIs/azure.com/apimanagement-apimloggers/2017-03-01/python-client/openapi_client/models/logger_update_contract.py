...
class LoggerUpdateContract(BaseModel):
    """
    Logger update contract.
    """ # noqa: E501
    properties: Optional[LoggerUpdateParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": LoggerUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
