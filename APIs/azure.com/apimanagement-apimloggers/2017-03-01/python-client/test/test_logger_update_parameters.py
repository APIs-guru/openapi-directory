...
class TestLoggerUpdateParameters(unittest.TestCase):
    """LoggerUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoggerUpdateParameters:
        """Test LoggerUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoggerUpdateParameters`
        """
        model = LoggerUpdateParameters()
        if include_optional:
            return LoggerUpdateParameters(
                credentials = {
                    'key' : ''
                    },
                description = '',
    ...
    def testLoggerUpdateParameters(self):
        """Test LoggerUpdateParameters"""
