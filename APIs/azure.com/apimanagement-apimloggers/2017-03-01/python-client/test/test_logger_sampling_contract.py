...
class TestLoggerSamplingContract(unittest.TestCase):
    """LoggerSamplingContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoggerSamplingContract:
        """Test LoggerSamplingContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoggerSamplingContract`
        """
        model = LoggerSamplingContract()
        if include_optional:
            return LoggerSamplingContract(
    ...
    def testLoggerSamplingContract(self):
        """Test LoggerSamplingContract"""
