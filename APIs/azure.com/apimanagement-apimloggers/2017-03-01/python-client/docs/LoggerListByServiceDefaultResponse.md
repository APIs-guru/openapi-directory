...
**details** | [**List[LoggerListByServiceDefaultResponseDetailsInner]**](LoggerListByServiceDefaultResponseDetailsInner.md) | The list of invalid fields send in request, in case of validation error. | [optional] 
