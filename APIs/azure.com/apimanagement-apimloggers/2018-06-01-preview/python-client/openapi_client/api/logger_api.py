...
class LoggerApi:
    ...
    def logger_create_or_update(
        ...
        logger_id: Annotated[str, Field(strict=True, max_length=256, description="Logger identifier. Must be unique in the API Management service instance.")],
        ...
        parameters: Annotated[LoggerGet200Response, Field(description="Create parameters.")],
        ...
        :param logger_id: Logger identifier. Must be unique in the API Management service instance. (required)
        :type logger_id: str
        ...
        :type parameters: LoggerGet200Response
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LoggerGet200Response",
            '201': "LoggerGet200Response",
        }
    ...
    def logger_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LoggerGet200Response]:
        """logger_create_or_update
    ...
    def _logger_create_or_update_serialize(
        ...
        if logger_id is not None:
            _path_params['loggerId'] = logger_id
    ...
    def logger_delete(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        force: Annotated[Optional[StrictBool], Field(description="Force deletion even if diagnostic is attached.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def logger_list_by_service(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LoggerListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def logger_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LoggerListByService200Response]:
        """logger_list_by_service
    ...
    def logger_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[LoggerUpdateRequest, Field(description="Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: LoggerUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
