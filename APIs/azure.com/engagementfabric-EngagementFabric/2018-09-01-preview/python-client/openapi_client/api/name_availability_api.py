...
class NameAvailabilityApi:
    ...
    def check_name_availability(
        ...
        parameters: Annotated[CheckNameAvailabilityParameter, Field(description="Parameter describing the name to be checked")],
    ...
    def _check_name_availability_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EngagementFabric/checkNameAvailability',
