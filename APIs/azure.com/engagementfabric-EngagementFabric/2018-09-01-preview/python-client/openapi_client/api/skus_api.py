...
class SkusApi:
    ...
    def s_kus_list(
        ...
        _param = self._s_kus_list_serialize(
    ...
    @validate_call
    def s_kus_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription ID")],
        api_version: Annotated[StrictStr, Field(description="API version")],
        _request_timeout: Union[
    ...
    def _s_kus_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.EngagementFabric/skus',
