...
class CheckNameAvailabilityResult(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="The message if name is unavailable")
    name_available: Optional[StrictBool] = Field(default=None, description="The name to be checked", alias="nameAvailable")
    reason: Optional[CheckNameUnavailableReason] = None
