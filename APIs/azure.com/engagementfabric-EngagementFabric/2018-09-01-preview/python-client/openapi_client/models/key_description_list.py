...
class KeyDescriptionList(BaseModel):
    """
    The list of the EngagementFabric account keys
    """ # noqa: E501
    value: Optional[List[KeyDescription]] = Field(default=None, description="Account keys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [KeyDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
