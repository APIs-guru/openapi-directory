...
class ChannelTypeDescriptionList(BaseModel):
    """
    List of the EngagementFabric channel descriptions
    """ # noqa: E501
    value: Optional[List[ChannelTypeDescription]] = Field(default=None, description="Channel descriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ChannelTypeDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
