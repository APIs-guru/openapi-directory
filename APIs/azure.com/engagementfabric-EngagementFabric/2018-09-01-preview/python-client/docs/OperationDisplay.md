...
------------ | ------------- | ------------- | -------------
**description** | **str** | The description of the EngagementFabric operation | [optional] [readonly] 
**operation** | **str** | The name of the EngagementFabric operation | [optional] [readonly] 
**provider** | **str** | The resource provider namespace of the EngagementFabric operation | [optional] [readonly] 
**resource** | **str** | The resource type of the EngagementFabric operation | [optional] [readonly] 
