...
class PricingList(BaseModel):
    ...
    """ # noqa: E501
    value: List[Pricing] = Field(description="List of pricing configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Pricing.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
