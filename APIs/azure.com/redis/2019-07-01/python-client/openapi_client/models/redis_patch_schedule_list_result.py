...
class RedisPatchScheduleListResult(BaseModel):
    """
    The response of list patch schedules Redis operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next page of results.", alias="nextLink")
    value: Optional[List[RedisPatchSchedule]] = Field(default=None, description="Results of the list patch schedules operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RedisPatchSchedule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
