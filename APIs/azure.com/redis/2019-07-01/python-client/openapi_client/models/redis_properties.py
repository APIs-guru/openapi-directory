...
class RedisProperties(BaseModel):
    ...
    instances: Optional[List[RedisInstanceDetails]] = Field(default=None, description="List of the Redis instances associated with the cache")
    ...
    __properties: ClassVar[List[str]] = ["sku", "staticIP", "subnetId", "enableNonSslPort", "minimumTlsVersion", "redisConfiguration", "replicasPerMaster", "shardCount", "tenantSettings"]
