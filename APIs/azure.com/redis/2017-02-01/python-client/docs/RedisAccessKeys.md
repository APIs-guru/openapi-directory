...
------------ | ------------- | ------------- | -------------
**primary_key** | **str** | The current primary key that clients can use to authenticate with Redis cache. | [optional] [readonly] 
**secondary_key** | **str** | The current secondary key that clients can use to authenticate with Redis cache. | [optional] [readonly] 
