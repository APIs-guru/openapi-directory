...
class ExportRDBParameters(BaseModel):
    """
    Parameters for Redis export operation.
    """ # noqa: E501
    container: StrictStr = Field(description="Container name to export to.")
    format: Optional[StrictStr] = Field(default=None, description="File format.")
    prefix: StrictStr = Field(description="Prefix to use for exported files.")
    __properties: ClassVar[List[str]] = ["container", "format", "prefix"]
