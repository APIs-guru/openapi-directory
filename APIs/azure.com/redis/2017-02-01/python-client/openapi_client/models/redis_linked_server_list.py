...
class RedisLinkedServerList(BaseModel):
    """
    List of linked server Ids of a Redis cache.
    """ # noqa: E501
    value: List[RedisLinkedServer] = Field(description="List of linked server Ids of a Redis cache.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RedisLinkedServer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
