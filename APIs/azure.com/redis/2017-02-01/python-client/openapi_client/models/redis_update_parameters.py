...
class RedisUpdateParameters(BaseModel):
    """
    Parameters supplied to the Update Redis operation.
    """ # noqa: E501
    properties: Optional[RedisUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": RedisUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
