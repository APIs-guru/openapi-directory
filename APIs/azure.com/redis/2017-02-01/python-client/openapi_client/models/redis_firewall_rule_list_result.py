...
class RedisFirewallRuleListResult(BaseModel):
    """
    The response of list firewall rules Redis operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next set of locations.", alias="nextLink")
    value: Optional[List[RedisFirewallRule]] = Field(default=None, description="Results of the list firewall rules operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RedisFirewallRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
