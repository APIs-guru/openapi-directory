...
class CheckNameAvailabilityParameters(BaseModel):
    ...
    type: StrictStr = Field(description="Resource type. The only legal value of this property for checking redis cache name availability is 'Microsoft.Cache/redis'.")
