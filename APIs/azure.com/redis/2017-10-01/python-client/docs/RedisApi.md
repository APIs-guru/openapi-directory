...
[**linked_server_create**](RedisApi.md#linked_server_create) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/linkedServers/{linkedServerName} | 
[**linked_server_delete**](RedisApi.md#linked_server_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/linkedServers/{linkedServerName} | 
[**linked_server_get**](RedisApi.md#linked_server_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/linkedServers/{linkedServerName} | 
[**linked_server_list**](RedisApi.md#linked_server_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/linkedServers | 
...
[**patch_schedules_list_by_redis_resource**](RedisApi.md#patch_schedules_list_by_redis_resource) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/patchSchedules | 
[**redis_check_name_availability**](RedisApi.md#redis_check_name_availability) | **POST** /subscriptions/{subscriptionId}/providers/Microsoft.Cache/CheckNameAvailability | 
...
[**redis_list_upgrade_notifications**](RedisApi.md#redis_list_upgrade_notifications) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/listUpgradeNotifications | 
...
> RedisLinkedServerWithProperties linked_server_create(resource_group_name, name, linked_server_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.linked_server_create(resource_group_name, name, linked_server_name, api_version, subscription_id, parameters)
        print("The response of RedisApi->linked_server_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->linked_server_create: %s\n" % e)
```
...
> linked_server_delete(resource_group_name, name, linked_server_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.linked_server_delete(resource_group_name, name, linked_server_name, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling RedisApi->linked_server_delete: %s\n" % e)
```
...
# **linked_server_get**
> RedisLinkedServerWithProperties linked_server_get(resource_group_name, name, linked_server_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.linked_server_get(resource_group_name, name, linked_server_name, api_version, subscription_id)
        print("The response of RedisApi->linked_server_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->linked_server_get: %s\n" % e)
```
...
# **linked_server_list**
> RedisLinkedServerWithPropertiesList linked_server_list(resource_group_name, name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.linked_server_list(resource_group_name, name, api_version, subscription_id)
        print("The response of RedisApi->linked_server_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->linked_server_list: %s\n" % e)
```
...
> RedisPatchSchedule patch_schedules_create_or_update(resource_group_name, name, default, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.patch_schedules_create_or_update(resource_group_name, name, default, api_version, subscription_id, parameters)
...
> patch_schedules_delete(resource_group_name, name, default, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.patch_schedules_delete(resource_group_name, name, default, api_version, subscription_id)
    except Exception as e:
...
# **patch_schedules_get**
> RedisPatchSchedule patch_schedules_get(resource_group_name, name, default, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.patch_schedules_get(resource_group_name, name, default, api_version, subscription_id)
...
> RedisPatchScheduleListResult patch_schedules_list_by_redis_resource(api_version, subscription_id, resource_group_name, cache_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.patch_schedules_list_by_redis_resource(api_version, subscription_id, resource_group_name, cache_name)
        print("The response of RedisApi->patch_schedules_list_by_redis_resource:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->patch_schedules_list_by_redis_resource: %s\n" % e)
```
...
> redis_check_name_availability(api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.CheckNameAvailabilityParameters() # CheckNameAvailabilityParameters | Parameters supplied to the CheckNameAvailability Redis operation. The only supported resource type is 'Microsoft.Cache/redis'

    try:
        api_instance.redis_check_name_availability(api_version, subscription_id, parameters)
    except Exception as e:
        print("Exception when calling RedisApi->redis_check_name_availability: %s\n" % e)
```
...
> NotificationListResponse redis_list_upgrade_notifications(resource_group_name, name, api_version, subscription_id, history)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    history = 3.4 # float | how many minutes in past to look for upgrade notifications

    try:
        api_response = api_instance.redis_list_upgrade_notifications(resource_group_name, name, api_version, subscription_id, history)
        print("The response of RedisApi->redis_list_upgrade_notifications:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->redis_list_upgrade_notifications: %s\n" % e)
```
