...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Link for next set. | [optional] [readonly] 
**value** | [**List[RedisLinkedServerWithProperties]**](RedisLinkedServerWithProperties.md) | List of linked servers (with properties) of a Redis cache. | [optional] 
