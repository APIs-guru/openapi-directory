...
class NotificationListResponse(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next set of notifications.", alias="nextLink")
    value: Optional[List[UpgradeNotification]] = Field(default=None, description="List of all notifications.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UpgradeNotification.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
