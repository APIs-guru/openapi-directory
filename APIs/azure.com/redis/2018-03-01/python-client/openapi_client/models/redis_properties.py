...
class RedisProperties(BaseModel):
    """
    ...
    linked_servers: Optional[List[RedisLinkedServer]] = Field(default=None, description="List of the linked servers associated with the cache", alias="linkedServers")
    ...
    __properties: ClassVar[List[str]] = ["sku", "staticIP", "subnetId", "enableNonSslPort", "minimumTlsVersion", "redisConfiguration", "shardCount", "tenantSettings"]
    ...
    def provisioning_state_validate_enum(cls, value):
        ...
        if value not in set(['Creating', 'Deleting', 'Disabled', 'Failed', 'Linking', 'Provisioning', 'RecoveringScaleFailure', 'Scaling', 'Succeeded', 'Unlinking', 'Unprovisioning', 'Updating']):
            raise ValueError("must be one of enum values ('Creating', 'Deleting', 'Disabled', 'Failed', 'Linking', 'Provisioning', 'RecoveringScaleFailure', 'Scaling', 'Succeeded', 'Unlinking', 'Unprovisioning', 'Updating')")
        return value
