...
redis_readable_properties_instance = RedisReadableProperties.from_json(json)
# print the JSON string representation of the object
print(RedisReadableProperties.to_json())

# convert the object into a dict
redis_readable_properties_dict = redis_readable_properties_instance.to_dict()
# create an instance of RedisReadableProperties from a dict
redis_readable_properties_from_dict = RedisReadableProperties.from_dict(redis_readable_properties_dict)
```
