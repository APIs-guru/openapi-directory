...
class RedisReadablePropertiesWithAccessKey(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["hostName", "port", "provisioningState", "sslPort", "enableNonSslPort", "redisConfiguration", "redisVersion", "shardCount", "sku", "staticIP", "subnet", "tenantSettings", "virtualNetwork"]
