...
class RedisListResult(BaseModel):
    """
    The response of list Redis operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next set of locations.", alias="nextLink")
    value: Optional[List[RedisResource]] = Field(default=None, description="List of Redis cache instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RedisResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
