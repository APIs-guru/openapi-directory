...
------------- | ------------- | -------------
[**firewall_rules_list**](RedisApi.md#firewall_rules_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/firewallRules | 
...
[**redis_firewall_rule_create_or_update**](RedisApi.md#redis_firewall_rule_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/firewallRules/{ruleName} | 
[**redis_firewall_rule_delete**](RedisApi.md#redis_firewall_rule_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/firewallRules/{ruleName} | 
[**redis_firewall_rule_get**](RedisApi.md#redis_firewall_rule_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/firewallRules/{ruleName} | 
...
# **firewall_rules_list**
> RedisFirewallRuleListResult firewall_rules_list(api_version, subscription_id, resource_group_name, cache_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.firewall_rules_list(api_version, subscription_id, resource_group_name, cache_name)
        print("The response of RedisApi->firewall_rules_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->firewall_rules_list: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully deleted the cache. |  -  |
**204** | Successfully deleted the cache. |  -  |
...
> RedisFirewallRule redis_firewall_rule_create_or_update(resource_group_name, cache_name, rule_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.redis_firewall_rule_create_or_update(resource_group_name, cache_name, rule_name, api_version, subscription_id, parameters)
        print("The response of RedisApi->redis_firewall_rule_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->redis_firewall_rule_create_or_update: %s\n" % e)
```
...
> redis_firewall_rule_delete(resource_group_name, cache_name, rule_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.redis_firewall_rule_delete(resource_group_name, cache_name, rule_name, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling RedisApi->redis_firewall_rule_delete: %s\n" % e)
```
...
> RedisFirewallRule redis_firewall_rule_get(resource_group_name, cache_name, rule_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.redis_firewall_rule_get(resource_group_name, cache_name, rule_name, api_version, subscription_id)
        print("The response of RedisApi->redis_firewall_rule_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RedisApi->redis_firewall_rule_get: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully found the cache |  -  |
