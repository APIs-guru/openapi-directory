...
------------ | ------------- | ------------- | -------------
**description** | **str** | Description for the operation. | [optional] 
**operation** | **str** | Type of operation: get, read, delete, etc. | [optional] 
**provider** | **str** | Service provider: Microsoft Resource Graph. | [optional] 
**resource** | **str** | Resource on which the operation is performed etc. | [optional] 
