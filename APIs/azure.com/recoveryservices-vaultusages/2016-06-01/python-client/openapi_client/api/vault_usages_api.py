...
class VaultUsagesApi:
    ...
    def usages_list_by_vaults(
        ...
        _param = self._usages_list_by_vaults_serialize(
    ...
    @validate_call
    def usages_list_by_vaults_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def usages_list_by_vaults_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _usages_list_by_vaults_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/usages',
