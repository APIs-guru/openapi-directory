...
class AlertModificationItem(BaseModel):
    """
    ...
    def modification_event_validate_enum(cls, value):
        ...
        if value not in set(['AlertCreated', 'StateChange', 'MonitorConditionChange']):
            raise ValueError("must be one of enum values ('AlertCreated', 'StateChange', 'MonitorConditionChange')")
        return value
