...
class AlertModificationProperties(BaseModel):
    """
    Properties of the alert modification item.
    """ # noqa: E501
    alert_id: Optional[StrictStr] = Field(default=None, description="Unique Id of the alert for which the history is being retrieved", alias="alertId")
    modifications: Optional[List[AlertModificationItem]] = Field(default=None, description="Modification details")
    __properties: ClassVar[List[str]] = ["alertId", "modifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modifications": [AlertModificationItem.from_dict(_item) for _item in obj["modifications"]] if obj.get("modifications") is not None else None
        })
        return _obj
