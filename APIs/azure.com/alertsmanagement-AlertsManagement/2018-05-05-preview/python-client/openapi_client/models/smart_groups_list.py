...
class SmartGroupsList(BaseModel):
    """
    List the alerts.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to fetch the next set of alerts.", alias="nextLink")
    value: Optional[List[SmartGroup]] = Field(default=None, description="List of alerts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SmartGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
