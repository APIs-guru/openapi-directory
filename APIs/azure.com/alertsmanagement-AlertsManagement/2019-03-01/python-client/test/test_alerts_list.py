                ...
                value = [
                    openapi_client.models.alert.alert(
                        properties = openapi_client.models.alert_properties.alertProperties(
                            context = openapi_client.models.alert_context.alertContext(), 
                            egress_config = openapi_client.models.egress_config.egressConfig(), 
                            essentials = openapi_client.models.essentials.essentials(
                                alert_rule = '', 
                                alert_state = 'New', 
