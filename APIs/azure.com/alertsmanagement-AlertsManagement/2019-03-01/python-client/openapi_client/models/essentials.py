...
class Essentials(BaseModel):
    ...
    monitor_condition: Optional[StrictStr] = Field(default=None, description="Can be 'Fired' or 'Resolved', which represents whether the underlying conditions have crossed the defined alert rule thresholds.", alias="monitorCondition")
    ...
    def monitor_service_validate_enum(cls, value):
        ...
        if value not in set(['Application Insights', 'ActivityLog Administrative', 'ActivityLog Security', 'ActivityLog Recommendation', 'ActivityLog Policy', 'ActivityLog Autoscale', 'Log Analytics', 'Nagios', 'Platform', 'SCOM', 'ServiceHealth', 'SmartDetector', 'VM Insights', 'Zabbix', 'Resource Health']):
            raise ValueError("must be one of enum values ('Application Insights', 'ActivityLog Administrative', 'ActivityLog Security', 'ActivityLog Recommendation', 'ActivityLog Policy', 'ActivityLog Autoscale', 'Log Analytics', 'Nagios', 'Platform', 'SCOM', 'ServiceHealth', 'SmartDetector', 'VM Insights', 'Zabbix', 'Resource Health')")
        return value
