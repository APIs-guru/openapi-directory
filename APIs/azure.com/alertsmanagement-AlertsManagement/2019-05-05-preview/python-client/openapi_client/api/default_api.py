...
class DefaultApi:
    ...
    def action_rules_create_update(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
    ...
    def _action_rules_create_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{actionRuleName}',
    ...
    @validate_call
    def action_rules_list_by_resource_group(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
        ...
        impacted_scope: Annotated[Optional[StrictStr], Field(description="filter by impacted/target scope (provide comma separated list for multiple scopes). The value should be an well constructed ARM id of the scope.")] = None,
        description: Annotated[Optional[StrictStr], Field(description="filter by alert rule description")] = None,
        alert_rule_id: Annotated[Optional[StrictStr], Field(description="filter by alert rule id")] = None,
        action_group: Annotated[Optional[StrictStr], Field(description="filter by action group configured as part of action rule")] = None,
        name: Annotated[Optional[StrictStr], Field(description="filter by action rule name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._action_rules_list_by_resource_group_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            api_version=api_version,
    ...
    @validate_call
    def action_rules_list_by_resource_group_with_http_info(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
    ...
    @validate_call
    def action_rules_list_by_resource_group_without_preload_content(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
    ...
    def _action_rules_list_by_resource_group_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
        ...
        if impacted_scope is not None:
            ...
            _query_params.append(('impactedScope', impacted_scope))
        ...
        if alert_rule_id is not None:
            ...
            _query_params.append(('alertRuleId', alert_rule_id))
            
        if action_group is not None:
            
            _query_params.append(('actionGroup', action_group))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def action_rules_list_by_subscription(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="Filter by target resource group name. Default value is select all.")] = None,
        ...
        _param = self._action_rules_list_by_subscription_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            target_resource_group=target_resource_group,
            target_resource_type=target_resource_type,
    ...
    @validate_call
    def action_rules_list_by_subscription_with_http_info(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="Filter by target resource group name. Default value is select all.")] = None,
    ...
    @validate_call
    def action_rules_list_by_subscription_without_preload_content(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="Filter by target resource group name. Default value is select all.")] = None,
    ...
    def _action_rules_list_by_subscription_serialize(
        self,
        subscription_id,
        api_version,
        target_resource_group,
    ...
    def action_rules_update(
        ...
        _param = self._action_rules_update_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            action_rule_name=action_rule_name,
            api_version=api_version,
    ...
    @validate_call
    def action_rules_update_with_http_info(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be updated")],
    ...
    @validate_call
    def action_rules_update_without_preload_content(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be updated")],
    ...
    def _action_rules_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        action_rule_name,
    ...
    def alerts_get_summary(
        self,
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        groupby: Annotated[StrictStr, Field(description="This parameter allows the result set to be grouped by input fields (Maximum 2 comma separated fields supported). For example, groupby=severity or groupby=severity,alertstate.")],
        api_version: Annotated[StrictStr, Field(description="client API version")],
    ...
    @validate_call
    def alerts_meta_data(
        self,
        api_version: Annotated[StrictStr, Field(description="client API version")],
        identifier: Annotated[StrictStr, Field(description="Identification of the information to be retrieved by API call.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._alerts_meta_data_serialize(
            api_version=api_version,
    ...
    @validate_call
    def alerts_meta_data_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="client API version")],
        identifier: Annotated[StrictStr, Field(description="Identification of the information to be retrieved by API call.")],
        _request_timeout: Union[
    ...
    @validate_call
    def alerts_meta_data_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="client API version")],
        identifier: Annotated[StrictStr, Field(description="Identification of the information to be retrieved by API call.")],
        _request_timeout: Union[
    ...
    def _alerts_meta_data_serialize(
        self,
        api_version,
        identifier,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.AlertsManagement/alertsMetaData',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
