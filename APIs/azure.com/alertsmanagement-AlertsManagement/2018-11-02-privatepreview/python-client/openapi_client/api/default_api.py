...
class DefaultApi:
    ...
    @validate_call
    def action_rules_create_update(
        self,
        ...
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be created/updated")],
        action_rule: Annotated[ActionRule, Field(description="action rule to be created/updated")],
        ...
        :param resource_group: Resource group name where the resource is created. (required)
        ...
        _param = self._action_rules_create_update_serialize(
    ...
    @validate_call
    def action_rules_create_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be created/updated")],
    ...
    @validate_call
    def action_rules_create_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be created/updated")],
    ...
    def _action_rules_create_update_serialize(
        self,
        subscription_id,
        resource_group,
        action_rule_name,
        ...
        if action_rule_name is not None:
            _path_params['actionRuleName'] = action_rule_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if action_rule is not None:
            _body_params = action_rule
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AlertsManagement/actionRules/{actionRuleName}',
    ...
    @validate_call
    def action_rules_delete(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._action_rules_delete_serialize(
            subscription_id=subscription_id,
            resource_group=resource_group,
            action_rule_name=action_rule_name,
            _request_auth=_request_auth,
    ...
    @validate_call
    def action_rules_delete_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be deleted")],
    ...
    @validate_call
    def action_rules_delete_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be deleted")],
    ...
    def _action_rules_delete_serialize(
        self,
        subscription_id,
        resource_group,
        action_rule_name,
    ...
    @validate_call
    def action_rules_get_all_resource_group(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        ...
        _param = self._action_rules_get_all_resource_group_serialize(
            subscription_id=subscription_id,
            resource_group=resource_group,
    ...
    @validate_call
    def action_rules_get_all_resource_group_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="filter by target resource group name")] = None,
    ...
    @validate_call
    def action_rules_get_all_resource_group_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="filter by target resource group name")] = None,
    ...
    def _action_rules_get_all_resource_group_serialize(
        self,
        subscription_id,
        resource_group,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AlertsManagement/actionRules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def action_rules_get_all_subscription(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="filter by target resource group name")] = None,
        target_resource_type: Annotated[Optional[StrictStr], Field(description="filter by target resource type")] = None,
        ...
        _param = self._action_rules_get_all_subscription_serialize(
            subscription_id=subscription_id,
            target_resource_group=target_resource_group,
            target_resource_type=target_resource_type,
            target_resource=target_resource,
    ...
    @validate_call
    def action_rules_get_all_subscription_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="filter by target resource group name")] = None,
        target_resource_type: Annotated[Optional[StrictStr], Field(description="filter by target resource type")] = None,
    ...
    @validate_call
    def action_rules_get_all_subscription_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        target_resource_group: Annotated[Optional[StrictStr], Field(description="filter by target resource group name")] = None,
        target_resource_type: Annotated[Optional[StrictStr], Field(description="filter by target resource type")] = None,
    ...
    def _action_rules_get_all_subscription_serialize(
        self,
        subscription_id,
        target_resource_group,
        target_resource_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/actionRules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def action_rules_get_by_name(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be fetched")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._action_rules_get_by_name_serialize(
            subscription_id=subscription_id,
            resource_group=resource_group,
            action_rule_name=action_rule_name,
            _request_auth=_request_auth,
    ...
    @validate_call
    def action_rules_get_by_name_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be fetched")],
    ...
    @validate_call
    def action_rules_get_by_name_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name of action rule that needs to be fetched")],
    ...
    def _action_rules_get_by_name_serialize(
        self,
        subscription_id,
        resource_group,
        action_rule_name,
    ...
    @validate_call
    def action_rules_patch(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be updated")],
        action_rule_patch: Annotated[PatchObject, Field(description="Parameters supplied to the operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type action_rule_patch: PatchObject
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._action_rules_patch_serialize(
            subscription_id=subscription_id,
            resource_group=resource_group,
            action_rule_name=action_rule_name,
            action_rule_patch=action_rule_patch,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def action_rules_patch_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be updated")],
    ...
    @validate_call
    def action_rules_patch_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="Resource group name where the resource is created.")],
        action_rule_name: Annotated[StrictStr, Field(description="The name that needs to be updated")],
    ...
    def _action_rules_patch_serialize(
        self,
        subscription_id,
        resource_group,
        action_rule_name,
        ...
        # process the form parameters
        # process the body parameter
        if action_rule_patch is not None:
            _body_params = action_rule_patch
