...
class AlertsSummaryByMonitorCondition(BaseModel):
    """
    Summary of the alerts by monitor condition
    """ # noqa: E501
    fired: Optional[StrictInt] = Field(default=None, description="Count of alerts with monitorCondition 'Fired'")
    resolved: Optional[StrictInt] = Field(default=None, description="Count of alerts with monitorCondition 'Resolved'")
    __properties: ClassVar[List[str]] = ["fired", "resolved"]
