...
class ActionRulesList(BaseModel):
    """
    List of action rules
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to fetch the next set of action rules", alias="nextLink")
    value: Optional[List[ActionRule]] = Field(default=None, description="List of action rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ActionRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
