...
class TestOperationalizationCluster(unittest.TestCase):
    """OperationalizationCluster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalizationCluster:
        """Test OperationalizationCluster
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalizationCluster`
        """
        model = OperationalizationCluster()
        if include_optional:
    ...
    def testOperationalizationCluster(self):
        """Test OperationalizationCluster"""
