...
class TestServiceAuthConfiguration(unittest.TestCase):
    """ServiceAuthConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAuthConfiguration:
        """Test ServiceAuthConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAuthConfiguration`
        """
    ...
    def testServiceAuthConfiguration(self):
        """Test ServiceAuthConfiguration"""
