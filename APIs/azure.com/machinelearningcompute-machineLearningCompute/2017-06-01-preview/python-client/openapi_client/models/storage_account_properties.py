...
class StorageAccountProperties(BaseModel):
    ...
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="ARM resource ID of the Azure Storage Account to store CLI specific files. If not provided one will be created. This cannot be changed once the cluster is created.", alias="resourceId")
