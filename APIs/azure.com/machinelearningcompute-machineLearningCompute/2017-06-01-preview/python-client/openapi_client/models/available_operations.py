...
class AvailableOperations(BaseModel):
    """
    Available operation list
    """ # noqa: E501
    value: Optional[List[ResourceOperation]] = Field(default=None, description="An array of available operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ResourceOperation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
