...
class ResourceOperation(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of this operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": ResourceOperationDisplay.from_dict(obj["display"]) if obj.get("display") is not None else None,
            "name": obj.get("name"),
