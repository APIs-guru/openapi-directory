...
class AsyncOperationStatus(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Read Only: The provisioning state of the cluster. Valid values are Unknown, Provisioning, Succeeded, and Failed.", alias="provisioningState")
    ...
    def provisioning_state_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'Updating', 'Creating', 'Succeeded', 'Failed']):
            raise ValueError("must be one of enum values ('Unknown', 'Updating', 'Creating', 'Succeeded', 'Failed')")
        return value
