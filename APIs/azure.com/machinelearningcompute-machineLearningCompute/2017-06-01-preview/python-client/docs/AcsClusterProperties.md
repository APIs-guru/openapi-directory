...
**agent_vm_size** | **str** | The Azure VM size of the agent VM nodes. This cannot be changed once the cluster is created. | [optional] [default to 'D2_v2']
**cluster_fqdn** | **str** | The FQDN of the cluster.  | [optional] [readonly] 
**orchestrator_properties** | [**KubernetesClusterProperties**](KubernetesClusterProperties.md) |  | 
**orchestrator_type** | **str** | Type of orchestrator. It cannot be changed once the cluster is created. | 
**system_services** | [**List[SystemServices]**](SystemServices.md) | The system services deployed to the cluster | [optional] 
