...
------------ | ------------- | ------------- | -------------
**cert** | **str** | The SSL cert data in PEM format encoded as base64 string | [optional] 
**key** | **str** | The SSL key data in PEM format encoded as base64 string. This is not returned in response of GET/PUT on the resource.. To see this please call listKeys API. | [optional] 
