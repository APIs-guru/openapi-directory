...
------------- | ------------- | -------------
[**operationalization_clusters_check_update**](OperationalizationClustersApi.md#operationalization_clusters_check_update) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningCompute/operationalizationClusters/{clusterName}/checkUpdate | 
...
[**operationalization_clusters_update_system**](OperationalizationClustersApi.md#operationalization_clusters_update_system) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningCompute/operationalizationClusters/{clusterName}/updateSystem | 


# **operationalization_clusters_check_update**
> CheckUpdateResponse operationalization_clusters_check_update(api_version, subscription_id, resource_group_name, cluster_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.operationalization_clusters_check_update(api_version, subscription_id, resource_group_name, cluster_name)
        print("The response of OperationalizationClustersApi->operationalization_clusters_check_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationalizationClustersApi->operationalization_clusters_check_update: %s\n" % e)
```
...
> operationalization_clusters_delete(api_version, subscription_id, resource_group_name, cluster_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.operationalization_clusters_delete(api_version, subscription_id, resource_group_name, cluster_name)
    except Exception as e:
...
> UpdateSystemResponse operationalization_clusters_update_system(api_version, subscription_id, resource_group_name, cluster_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.operationalization_clusters_update_system(api_version, subscription_id, resource_group_name, cluster_name)
        print("The response of OperationalizationClustersApi->operationalization_clusters_update_system:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OperationalizationClustersApi->operationalization_clusters_update_system: %s\n" % e)
```
