...
class TestPaginatedOperationalizationClustersList(unittest.TestCase):
    """PaginatedOperationalizationClustersList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedOperationalizationClustersList:
        """Test PaginatedOperationalizationClustersList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedOperationalizationClustersList`
        """
        model = PaginatedOperationalizationClustersList()
        if include_optional:
            return PaginatedOperationalizationClustersList(
                next_link = '',
                value = [
                    openapi_client.models.operationalization_cluster.OperationalizationCluster(
                        properties = openapi_client.models.operationalization_cluster_properties.OperationalizationClusterProperties(
    ...
    def testPaginatedOperationalizationClustersList(self):
        """Test PaginatedOperationalizationClustersList"""
