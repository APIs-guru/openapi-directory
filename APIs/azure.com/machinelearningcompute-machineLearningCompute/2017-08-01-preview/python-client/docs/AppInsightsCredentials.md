...
**instrumentation_key** | **str** | The AppInsights instrumentation key. This is not returned in response of GET/PUT on the resource. To see this please call listKeys API. | [optional] 
