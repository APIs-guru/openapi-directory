...
class CheckSystemServicesUpdatesAvailableResponse(BaseModel):
    """
    Information about updates available for system services in a cluster.
    """ # noqa: E501
    updates_available: Optional[StrictStr] = Field(default=None, description="Yes if updates are available for the system services, No if not.", alias="updatesAvailable")
    __properties: ClassVar[List[str]] = ["updatesAvailable"]

    @field_validator('updates_available')
    def updates_available_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updatesAvailable": obj.get("updatesAvailable")
        })
        return _obj
