...
class AppInsightsProperties(BaseModel):
    """
    Properties of App Insights.
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="ARM resource ID of the App Insights.", alias="resourceId")
