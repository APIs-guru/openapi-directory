...
class AcsClusterProperties(BaseModel):
    ...
    agent_vm_size: Optional[StrictStr] = Field(default='D3_v2', description="The Azure VM size of the agent VM nodes. This cannot be changed once the cluster is created. This list is non exhaustive; refer to https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes for the possible VM sizes.", alias="agentVmSize")
    cluster_fqdn: Optional[StrictStr] = Field(default=None, description="The FQDN of the cluster. ", alias="clusterFqdn")
    master_count: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = Field(default=None, description="The number of master nodes in the container service.", alias="masterCount")
    orchestrator_properties: Optional[KubernetesClusterProperties] = Field(default=None, alias="orchestratorProperties")
    ...
    system_services: Optional[List[SystemService]] = Field(default=None, description="The system services deployed to the cluster", alias="systemServices")
    __properties: ClassVar[List[str]] = ["agentCount", "agentVmSize", "clusterFqdn", "masterCount", "orchestratorProperties", "orchestratorType", "systemServices"]
    ...
    def orchestrator_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Kubernetes', 'None']):
            raise ValueError("must be one of enum values ('Kubernetes', 'None')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "agentVmSize": obj.get("agentVmSize") if obj.get("agentVmSize") is not None else 'D3_v2',
            "clusterFqdn": obj.get("clusterFqdn"),
            "masterCount": obj.get("masterCount"),
