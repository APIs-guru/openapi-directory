...
class KubernetesClusterProperties(BaseModel):
    ...
    """ # noqa: E501
    service_principal: Optional[ServicePrincipalProperties] = Field(default=None, alias="servicePrincipal")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "servicePrincipal": ServicePrincipalProperties.from_dict(obj["servicePrincipal"]) if obj.get("servicePrincipal") is not None else None
        })
        return _obj
