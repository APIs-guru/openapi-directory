...
class ServicePrincipalProperties(BaseModel):
    ...
    """ # noqa: E501
    client_id: StrictStr = Field(description="The service principal client ID", alias="clientId")
    secret: StrictStr = Field(description="The service principal secret. This is not returned in response of GET/PUT on the resource. To see this please call listKeys.")
