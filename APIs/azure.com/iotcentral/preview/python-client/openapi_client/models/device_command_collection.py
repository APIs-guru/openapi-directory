...
class DeviceCommandCollection(BaseModel):
    """
    DeviceCommandCollection
    """ # noqa: E501
    value: List[DeviceCommand] = Field(description="The collection of device command executions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DeviceCommand.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
