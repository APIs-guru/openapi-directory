...
class DeviceTemplateCollection(BaseModel):
    """
    DeviceTemplateCollection
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next page of device templates.", alias="nextLink")
    value: List[DeviceTemplate] = Field(description="The collection of device templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DeviceTemplate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
