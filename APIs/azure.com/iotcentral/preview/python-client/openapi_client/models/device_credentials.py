...
class DeviceCredentials(BaseModel):
    ...
    DeviceCredentials
    """ # noqa: E501
    scope_id: StrictStr = Field(description="Scope id for connecting to device provisioning service.", alias="scopeId")
    symmetric_key: SymmetricKey = Field(alias="symmetricKey")
    __properties: ClassVar[List[str]] = ["scopeId", "symmetricKey"]
