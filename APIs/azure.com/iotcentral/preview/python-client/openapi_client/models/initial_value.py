...
class InitialValue(BaseModel):
    ...
    value: Optional[Dict[str, Any]] = Field(default=None, description="The initial value of the capability.")
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "comment", "description", "displayName", "capability", "value"]
