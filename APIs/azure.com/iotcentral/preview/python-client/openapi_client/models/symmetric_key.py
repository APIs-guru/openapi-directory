...
class SymmetricKey(BaseModel):
    ...
    SymmetricKey
    """ # noqa: E501
    primary_key: StrictStr = Field(description="The primary key for the credential.", alias="primaryKey")
    secondary_key: StrictStr = Field(description="The secondary key for the credential.", alias="secondaryKey")
