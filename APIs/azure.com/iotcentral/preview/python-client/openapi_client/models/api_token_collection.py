...
class ApiTokenCollection(BaseModel):
    """
    ApiTokenCollection
    """ # noqa: E501
    value: List[ApiToken] = Field(description="The collection of api tokens.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ApiToken.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
