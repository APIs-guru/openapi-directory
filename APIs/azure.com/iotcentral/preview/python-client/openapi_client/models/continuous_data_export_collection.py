...
class ContinuousDataExportCollection(BaseModel):
    """
    ContinuousDataExportCollection
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next page of continuous data exports.", alias="nextLink")
    value: List[ContinuousDataExport] = Field(description="The collection of continuous data exports.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ContinuousDataExport.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
