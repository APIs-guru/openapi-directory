...
class Component(BaseModel):
    ...
    name: StrictStr = Field(description="The programmatic name of the named entity.")
    var_schema: Optional[Interface] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "comment", "description", "displayName", "name", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "schema": Interface.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
