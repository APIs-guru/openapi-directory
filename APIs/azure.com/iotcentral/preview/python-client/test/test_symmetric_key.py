...
class TestSymmetricKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SymmetricKey:
        """Test SymmetricKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SymmetricKey`
        """
        model = SymmetricKey()
        if include_optional:
            return SymmetricKey(
