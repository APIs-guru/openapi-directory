...
class OperationListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of IoT Central description objects.", alias="nextLink")
    value: Optional[List[Operation]] = Field(default=None, description="A list of operations supported by the Microsoft.IoTCentral resource provider.")
