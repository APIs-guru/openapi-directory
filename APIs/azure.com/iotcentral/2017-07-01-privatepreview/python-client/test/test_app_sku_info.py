...
class TestAppSkuInfo(unittest.TestCase):
    """AppSkuInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppSkuInfo:
        """Test AppSkuInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppSkuInfo`
        """
        model = AppSkuInfo()
        if include_optional:
            return AppSkuInfo(
