...
[**apps_check_subdomain_availability**](AppsApi.md#apps_check_subdomain_availability) | **POST** /subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/checkSubdomainAvailability | 
...
[**apps_list_templates**](AppsApi.md#apps_list_templates) | **POST** /subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/appTemplates | 
...
> AppAvailabilityInfo apps_check_name_availability(api_version, subscription_id, operation_inputs)
...
> AppAvailabilityInfo apps_check_subdomain_availability(api_version, subscription_id, operation_inputs)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | The version of the API.
    subscription_id = 'subscription_id_example' # str | The subscription identifier.
    operation_inputs = openapi_client.OperationInputs() # OperationInputs | Set the name parameter in the OperationInputs structure to the subdomain of the IoT Central application to check.

    try:
        api_response = api_instance.apps_check_subdomain_availability(api_version, subscription_id, operation_inputs)
        print("The response of AppsApi->apps_check_subdomain_availability:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AppsApi->apps_check_subdomain_availability: %s\n" % e)
```
 ...
 **api_version** | **str**| The version of the API. | 
 **subscription_id** | **str**| The subscription identifier. | 
 **operation_inputs** | [**OperationInputs**](OperationInputs.md)| Set the name parameter in the OperationInputs structure to the subdomain of the IoT Central application to check. | 
...
# **apps_list_templates**
> AppTemplatesResult apps_list_templates(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.apps_list_templates(api_version, subscription_id)
        print("The response of AppsApi->apps_list_templates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AppsApi->apps_list_templates: %s\n" % e)
```
