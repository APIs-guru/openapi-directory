...
class AppTemplatesResult(BaseModel):
    """
    A list of IoT Central Application Templates with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of IoT Central application templates.", alias="nextLink")
    value: Optional[List[AppTemplate]] = Field(default=None, description="A list of IoT Central Application Templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AppTemplate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
