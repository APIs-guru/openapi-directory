...
class TestAppListResult(unittest.TestCase):
    """AppListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppListResult:
        """Test AppListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppListResult`
        """
        model = AppListResult()
        if include_optional:
