...
class TestAppTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AppTemplate:
        """Test AppTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppTemplate`
        """
        model = AppTemplate()
        if include_optional:
            return AppTemplate(
