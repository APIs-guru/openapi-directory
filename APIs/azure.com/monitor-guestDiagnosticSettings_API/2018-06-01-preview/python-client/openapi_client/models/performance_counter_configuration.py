...
class PerformanceCounterConfiguration(BaseModel):
    """
    PerformanceCounterConfiguration
    """ # noqa: E501
    instance: Optional[StrictStr] = None
    name: StrictStr
    sampling_period: StrictStr = Field(alias="samplingPeriod")
    __properties: ClassVar[List[str]] = ["instance", "name", "samplingPeriod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "samplingPeriod": obj.get("samplingPeriod")
        })
        return _obj
