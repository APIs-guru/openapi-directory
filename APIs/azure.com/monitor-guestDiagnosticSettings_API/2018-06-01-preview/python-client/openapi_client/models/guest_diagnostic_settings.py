...
class GuestDiagnosticSettings(BaseModel):
    """
    Virtual machine diagnostic settings
    """ # noqa: E501
    data_sources: Optional[List[DataSource]] = Field(default=None, description="the array of data source object which are configured to collect and send data", alias="dataSources")
    os_type: Optional[StrictStr] = Field(default=None, description="Operating system type for the configuration", alias="osType")
    proxy_setting: Optional[StrictStr] = Field(default=None, alias="proxySetting")
    __properties: ClassVar[List[str]] = ["dataSources", "osType", "proxySetting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proxySetting": obj.get("proxySetting")
        })
        return _obj
