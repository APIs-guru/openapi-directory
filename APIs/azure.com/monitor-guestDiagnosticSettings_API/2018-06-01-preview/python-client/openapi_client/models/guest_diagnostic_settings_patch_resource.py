...
class GuestDiagnosticSettingsPatchResource(BaseModel):
    """
    An diagnostic settings object for the body of patch operations.
    """ # noqa: E501
    properties: Optional[GuestDiagnosticSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GuestDiagnosticSettings.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
