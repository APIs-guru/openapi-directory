...
class GuestDiagnosticSettingsList(BaseModel):
    """
    A list of guest diagnostic settings.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Provides the link to retrieve the next set of elements.", alias="nextLink")
    value: Optional[List[GuestDiagnosticSettingsResource]] = Field(default=None, description="The list of guest diagnostic settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [GuestDiagnosticSettingsResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
