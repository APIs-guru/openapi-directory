...
class ManagementLockOwner(BaseModel):
    """
    Lock owner properties.
    """ # noqa: E501
    application_id: Optional[StrictStr] = Field(default=None, description="The application ID of the lock owner.", alias="applicationId")
