...
class OperationsApi:
    ...
    @validate_call
    def authorization_operations_list(
        self,
        ...
        _param = self._authorization_operations_list_serialize(
    ...
    @validate_call
    def authorization_operations_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the operation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def authorization_operations_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the operation.")],
        _request_timeout: Union[
            None,
    ...
    def _authorization_operations_list_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Authorization/operations',
