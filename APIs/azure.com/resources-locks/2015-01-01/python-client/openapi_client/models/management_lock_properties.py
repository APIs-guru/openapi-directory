...
class ManagementLockProperties(BaseModel):
    ...
    """ # noqa: E501
    level: Optional[StrictStr] = Field(default=None, description="The lock level of the management lock.")
    notes: Optional[StrictStr] = Field(default=None, description="The notes of the management lock.")
    __properties: ClassVar[List[str]] = ["level", "notes"]
