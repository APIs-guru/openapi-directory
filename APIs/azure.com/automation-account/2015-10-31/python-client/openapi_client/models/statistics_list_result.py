...
class StatisticsListResult(BaseModel):
    """
    The response model for the list statistics operation.
    """ # noqa: E501
    value: Optional[List[Statistics]] = Field(default=None, description="Gets or sets a list of statistics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Statistics.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
