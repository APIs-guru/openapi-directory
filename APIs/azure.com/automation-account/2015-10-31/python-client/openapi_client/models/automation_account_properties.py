...
class AutomationAccountProperties(BaseModel):
    """
    ...
    state: Optional[StrictStr] = Field(default=None, description="Gets status of account.")
    __properties: ClassVar[List[str]] = ["creationTime", "description", "lastModifiedBy", "lastModifiedTime", "sku", "state"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['Ok', 'Unavailable', 'Suspended']):
            raise ValueError("must be one of enum values ('Ok', 'Unavailable', 'Suspended')")
        return value
