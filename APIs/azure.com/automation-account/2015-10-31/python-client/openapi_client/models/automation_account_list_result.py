...
class AutomationAccountListResult(BaseModel):
    """
    ...
    value: Optional[List[AutomationAccount]] = Field(default=None, description="Gets or sets list of accounts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AutomationAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
