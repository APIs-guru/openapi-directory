...
class ListKeysApi:
    ...
    @validate_call
    def keys_list_by_automation_account(
        self,
        ...
        _param = self._keys_list_by_automation_account_serialize(
    ...
    @validate_call
    def keys_list_by_automation_account_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
    ...
    @validate_call
    def keys_list_by_automation_account_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
    ...
    def _keys_list_by_automation_account_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/listKeys',
