...
class Display(BaseModel):
    ...
    operation: Optional[StrictStr] = Field(default=None, description="The localized, friendly name for the operation. Use the name as it will displayed to the user.")
    provider: Optional[StrictStr] = Field(default=None, description="The localized, friendly version of the resource provider name.")
