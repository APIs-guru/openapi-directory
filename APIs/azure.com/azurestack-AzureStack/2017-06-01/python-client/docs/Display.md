...
**operation** | **str** | The localized, friendly name for the operation. Use the name as it will displayed to the user. | [optional] 
**provider** | **str** | The localized, friendly version of the resource provider name. | [optional] 
