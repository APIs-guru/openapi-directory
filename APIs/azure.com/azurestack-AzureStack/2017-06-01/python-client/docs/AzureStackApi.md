# openapi_client.AzureStackApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**operations_list**](AzureStackApi.md#operations_list) | **GET** /providers/Microsoft.AzureStack/operations | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AzureStackApi(api_client)
    api_version = '2017-06-01' # str | Client API Version. (default to '2017-06-01')

    try:
        api_response = api_instance.operations_list(api_version)
        print("The response of AzureStackApi->operations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AzureStackApi->operations_list: %s\n" % e)
```
