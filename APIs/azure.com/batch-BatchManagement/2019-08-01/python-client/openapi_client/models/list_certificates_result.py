...
class ListCertificatesResult(BaseModel):
    ...
    value: Optional[List[Certificate]] = Field(default=None, description="The collection of returned certificates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Certificate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
