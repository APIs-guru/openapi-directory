...
------------ | ------------- | ------------- | -------------
**login_mode** | **str** | Specifies login mode for the user. The default value for VirtualMachineConfiguration pools is interactive mode and for CloudServiceConfiguration pools is batch mode. | [optional] 
