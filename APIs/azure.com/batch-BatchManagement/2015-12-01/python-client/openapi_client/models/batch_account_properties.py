...
class BatchAccountProperties(BaseModel):
    ...
    active_job_and_job_schedule_quota: StrictInt = Field(description="The active job and job schedule quota for this Batch account.", alias="activeJobAndJobScheduleQuota")
    auto_storage: Optional[AutoStorageProperties] = Field(default=None, alias="autoStorage")
    core_quota: StrictInt = Field(description="The core quota for this Batch account.", alias="coreQuota")
    pool_quota: StrictInt = Field(description="The pool quota for this Batch account.", alias="poolQuota")
    ...
    __properties: ClassVar[List[str]] = ["accountEndpoint", "activeJobAndJobScheduleQuota", "autoStorage", "coreQuota", "poolQuota", "provisioningState"]
