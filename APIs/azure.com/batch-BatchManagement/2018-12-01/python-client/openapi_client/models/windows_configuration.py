...
class WindowsConfiguration(BaseModel):
    ...
    """ # noqa: E501
    enable_automatic_updates: Optional[StrictBool] = Field(default=None, description="If omitted, the default value is true.", alias="enableAutomaticUpdates")
    __properties: ClassVar[List[str]] = ["enableAutomaticUpdates"]
