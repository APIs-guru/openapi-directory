...
class ListPoolsResult(BaseModel):
    """
    Values returned by the List operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The continuation token.", alias="nextLink")
    value: Optional[List[Pool]] = Field(default=None, description="The collection of returned pools.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Pool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
