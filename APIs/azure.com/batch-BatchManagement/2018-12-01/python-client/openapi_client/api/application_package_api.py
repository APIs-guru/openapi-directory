...
class ApplicationPackageApi:
    ...
    def application_package_activate(
        ...
        application_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the application. This must be unique within the account.")],
        version_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The version of the application.")],
        ...
        :param application_name: The name of the application. This must be unique within the account. (required)
    ...
    def _application_package_activate_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationName}/versions/{versionName}/activate',
    ...
    def application_package_create(
        ...
        api_version: Annotated[StrictStr, Field(description="The API version to be used with the HTTP request.")],
        subscription_id: Annotated[StrictStr, Field(description="The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)")],
        parameters: Annotated[Optional[ApplicationPackage], Field(description="The parameters for the request.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: ApplicationPackage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _application_package_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationName}/versions/{versionName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def application_package_list(
        ...
        _param = self._application_package_list_serialize(
            resource_group_name=resource_group_name,
            account_name=account_name,
            application_name=application_name,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListApplicationPackagesResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def application_package_list_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the Batch account.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the Batch account.")],
        application_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the application. This must be unique within the account.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListApplicationPackagesResult]:
        """application_package_list
    ...
    @validate_call
    def application_package_list_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the Batch account.")],
        account_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the Batch account.")],
        application_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="The name of the application. This must be unique within the account.")],
    ...
    def _application_package_list_serialize(
        self,
        resource_group_name,
        account_name,
        application_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationName}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
