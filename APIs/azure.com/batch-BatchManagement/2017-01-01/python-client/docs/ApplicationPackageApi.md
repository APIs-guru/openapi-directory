...
------------- | ------------- | -------------
[**application_package_activate**](ApplicationPackageApi.md#application_package_activate) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationId}/versions/{version}/activate | 
[**application_package_create**](ApplicationPackageApi.md#application_package_create) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationId}/versions/{version} | 
[**application_package_delete**](ApplicationPackageApi.md#application_package_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationId}/versions/{version} | 
[**application_package_get**](ApplicationPackageApi.md#application_package_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationId}/versions/{version} | 


# **application_package_activate**
> application_package_activate(resource_group_name, account_name, application_id, version, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    version = 'version_example' # str | The version of the application to activate.
    ...
    try:
        api_instance.application_package_activate(resource_group_name, account_name, application_id, version, api_version, subscription_id, parameters)
...
> ApplicationPackage application_package_create(resource_group_name, account_name, application_id, version, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    account_name = 'account_name_example' # str | The name of the Batch account.
    application_id = 'application_id_example' # str | The ID of the application.
    version = 'version_example' # str | The version of the application.
    api_version = 'api_version_example' # str | The API version to be used with the HTTP request.
    subscription_id = 'subscription_id_example' # str | A unique identifier of a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.

    try:
        api_response = api_instance.application_package_create(resource_group_name, account_name, application_id, version, api_version, subscription_id)
...
> application_package_delete(resource_group_name, account_name, application_id, version, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    account_name = 'account_name_example' # str | The name of the Batch account.
    application_id = 'application_id_example' # str | The ID of the application.
    version = 'version_example' # str | The version of the application to delete.
    api_version = 'api_version_example' # str | The API version to be used with the HTTP request.
    subscription_id = 'subscription_id_example' # str | A unique identifier of a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.

    try:
        api_instance.application_package_delete(resource_group_name, account_name, application_id, version, api_version, subscription_id)
    except Exception as e:
...
> ApplicationPackage application_package_get(resource_group_name, account_name, application_id, version, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.application_package_get(resource_group_name, account_name, application_id, version, api_version, subscription_id)
