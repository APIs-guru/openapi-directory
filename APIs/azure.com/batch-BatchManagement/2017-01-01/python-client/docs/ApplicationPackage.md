...
**storage_url** | **str** | The storage URL at which the application package is stored. | [optional] [readonly] 
**storage_url_expiry** | **datetime** | The UTC time at which the storage URL will expire. | [optional] [readonly] 
