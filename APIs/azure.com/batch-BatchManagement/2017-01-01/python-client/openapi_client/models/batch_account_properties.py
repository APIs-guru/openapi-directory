...
class BatchAccountProperties(BaseModel):
    ...
    """ # noqa: E501
    account_endpoint: Optional[StrictStr] = Field(default=None, description="The endpoint used by this account to interact with the Batch services.", alias="accountEndpoint")
    ...
    core_quota: Optional[StrictInt] = Field(default=None, alias="coreQuota")
    ...
    __properties: ClassVar[List[str]] = ["accountEndpoint", "activeJobAndJobScheduleQuota", "autoStorage", "coreQuota", "keyVaultReference", "poolAllocationMode", "poolQuota", "provisioningState"]
