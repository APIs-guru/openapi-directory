...
class TestClusterPropertiesUpdateParameters(unittest.TestCase):
    """ClusterPropertiesUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterPropertiesUpdateParameters:
        """Test ClusterPropertiesUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterPropertiesUpdateParameters`
        """
        model = ClusterPropertiesUpdateParameters()
        if include_optional:
            return ClusterPropertiesUpdateParameters(
                add_on_features = [
                    'RepairManager'
                    ],
    ...
    def testClusterPropertiesUpdateParameters(self):
        """Test ClusterPropertiesUpdateParameters"""
