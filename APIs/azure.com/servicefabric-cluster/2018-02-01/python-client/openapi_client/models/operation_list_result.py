...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[OperationResult]] = Field(default=None, description="List of Service Fabric operations supported by the Microsoft.ServiceFabric resource provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [OperationResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
