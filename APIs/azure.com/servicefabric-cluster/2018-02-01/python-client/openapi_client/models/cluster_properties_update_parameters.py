...
class ClusterPropertiesUpdateParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addOnFeatures", "certificate", "certificateCommonNames", "clientCertificateCommonNames", "clientCertificateThumbprints", "clusterCodeVersion", "fabricSettings", "nodeTypes", "reliabilityLevel", "reverseProxyCertificate", "upgradeDescription", "upgradeMode"]
