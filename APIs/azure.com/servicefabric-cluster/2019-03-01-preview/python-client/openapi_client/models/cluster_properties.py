...
class ClusterProperties(BaseModel):
    ...
    reverse_proxy_certificate_common_names: Optional[ServerCertificateCommonNames] = Field(default=None, alias="reverseProxyCertificateCommonNames")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of reverse_proxy_certificate_common_names
        if self.reverse_proxy_certificate_common_names:
            _dict['reverseProxyCertificateCommonNames'] = self.reverse_proxy_certificate_common_names.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reverseProxyCertificateCommonNames": ServerCertificateCommonNames.from_dict(obj["reverseProxyCertificateCommonNames"]) if obj.get("reverseProxyCertificateCommonNames") is not None else None,
