...
class SettingsParameterDescription(BaseModel):
    """
    Describes a parameter in fabric settings of the cluster.
    """ # noqa: E501
    name: StrictStr = Field(description="The parameter name of fabric setting.")
    value: StrictStr = Field(description="The parameter value of fabric setting.")
