...
class OperationsApi:
    ...
    def operations_list(
        self,
        api_version: Annotated[StrictStr, Field(description="The version of the Service Fabric resource provider API")],
        ...
        :param api_version: The version of the Service Fabric resource provider API (required)
