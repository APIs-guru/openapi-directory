...
class RegistryUsageListResult(BaseModel):
    """
    The result of a request to get container registry quota usages.
    """ # noqa: E501
    value: Optional[List[RegistryUsage]] = Field(default=None, description="The list of container registry quota usages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [RegistryUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
