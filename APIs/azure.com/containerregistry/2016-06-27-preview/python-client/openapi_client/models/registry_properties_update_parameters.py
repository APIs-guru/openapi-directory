...
class RegistryPropertiesUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    admin_user_enabled: Optional[StrictBool] = Field(default=None, description="The value that indicates whether the admin user is enabled. This value is false by default.", alias="adminUserEnabled")
