...
class RegistryCredentials(BaseModel):
    ...
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="The administrator password.")
    username: Optional[StrictStr] = Field(default=None, description="The administrator username.")
