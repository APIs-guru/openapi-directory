...
class EncryptionProperty(BaseModel):
    """
    EncryptionProperty
    """ # noqa: E501
    key_vault_properties: Optional[KeyVaultProperties] = Field(default=None, alias="keyVaultProperties")
    status: Optional[StrictStr] = Field(default=None, description="Indicates whether or not the encryption is enabled for container registry.")
    __properties: ClassVar[List[str]] = ["keyVaultProperties", "status"]
