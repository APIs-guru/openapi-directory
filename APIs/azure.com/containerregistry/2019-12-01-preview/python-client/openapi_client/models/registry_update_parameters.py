...
class RegistryUpdateParameters(BaseModel):
    """
    The parameters for updating a container registry.
    """ # noqa: E501
    identity: Optional[IdentityProperties] = None
    properties: Optional[RegistryPropertiesUpdateParameters] = None
    sku: Optional[Sku] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The tags for the container registry.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity": IdentityProperties.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
            "properties": RegistryPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
