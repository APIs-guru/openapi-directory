...
------------ | ------------- | ------------- | -------------
**identity** | **str** | The client id of the identity which will be used to access key vault. | [optional] 
**key_identifier** | **str** | Key vault uri to access the encryption key. | [optional] 
