...
------------ | ------------- | ------------- | -------------
**actions** | **List[str]** | The list of actions that trigger the webhook to post notifications. | [optional] 
...
**service_uri** | **str** | The service URI for the webhook to post notifications. | [optional] 
...
webhook_properties_update_parameters_instance = WebhookPropertiesUpdateParameters.from_json(json)
# print the JSON string representation of the object
print(WebhookPropertiesUpdateParameters.to_json())

# convert the object into a dict
webhook_properties_update_parameters_dict = webhook_properties_update_parameters_instance.to_dict()
# create an instance of WebhookPropertiesUpdateParameters from a dict
webhook_properties_update_parameters_from_dict = WebhookPropertiesUpdateParameters.from_dict(webhook_properties_update_parameters_dict)
```
