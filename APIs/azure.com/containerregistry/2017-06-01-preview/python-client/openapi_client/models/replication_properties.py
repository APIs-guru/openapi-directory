...
class ReplicationProperties(BaseModel):
    """
    The properties of a replication.
    """ # noqa: E501
    provisioning_state: Optional[StrictStr] = Field(default=None, description="The provisioning state of the replication at the time the operation was called.", alias="provisioningState")
    status: Optional[Status] = None
    __properties: ClassVar[List[str]] = ["provisioningState", "status"]
