...
class Event(BaseModel):
    ...
    """ # noqa: E501
    event_request_message: Optional[EventRequestMessage] = Field(default=None, alias="eventRequestMessage")
    event_response_message: Optional[EventResponseMessage] = Field(default=None, alias="eventResponseMessage")
