...
class AcrErrors(BaseModel):
    """
    Acr error response describing why the operation failed
    """ # noqa: E501
    errors: Optional[List[AcrErrorInfo]] = Field(default=None, description="Array of detailed error")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [AcrErrorInfo.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
