...
class TagAttributes(BaseModel):
    ...
    tag: Optional[TagAttributesBase] = None
    __properties: ClassVar[List[str]] = ["imageName", "registry", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": TagAttributesBase.from_dict(obj["tag"]) if obj.get("tag") is not None else None
        })
        return _obj
