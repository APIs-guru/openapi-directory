...
class ManifestList(BaseModel):
    ...
    """ # noqa: E501
    manifests: Optional[List[ManifestListAttributes]] = Field(default=None, description="List of V2 image layer information")
    media_type: Optional[StrictStr] = Field(default=None, description="Media type for this Manifest", alias="mediaType")
