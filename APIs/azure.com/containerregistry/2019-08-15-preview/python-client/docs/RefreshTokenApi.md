...
------------- | ------------- | -------------
[**refresh_tokens_get_from_exchange_0**](RefreshTokenApi.md#refresh_tokens_get_from_exchange_0) | **POST** /oauth2/exchange | 


# **refresh_tokens_get_from_exchange_0**
> RefreshToken refresh_tokens_get_from_exchange_0(grant_type, service, tenant=tenant, refresh_token=refresh_token, access_token=access_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.refresh_tokens_get_from_exchange_0(grant_type, service, tenant=tenant, refresh_token=refresh_token, access_token=access_token)
        print("The response of RefreshTokenApi->refresh_tokens_get_from_exchange_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RefreshTokenApi->refresh_tokens_get_from_exchange_0: %s\n" % e)
```
