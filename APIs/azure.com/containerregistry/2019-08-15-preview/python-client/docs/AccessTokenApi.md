...
------------- | ------------- | -------------
[**access_tokens_get_0**](AccessTokenApi.md#access_tokens_get_0) | **POST** /oauth2/token | 
[**access_tokens_get_from_login_0**](AccessTokenApi.md#access_tokens_get_from_login_0) | **GET** /oauth2/token | 


# **access_tokens_get_0**
> AccessToken access_tokens_get_0(grant_type, service, scope, refresh_token)
...
# **access_tokens_get_from_login_0**
> AccessToken access_tokens_get_from_login_0(service, scope)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.access_tokens_get_from_login_0(service, scope)
        print("The response of AccessTokenApi->access_tokens_get_from_login_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccessTokenApi->access_tokens_get_from_login_0: %s\n" % e)
```
