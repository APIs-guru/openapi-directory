...
------------- | ------------- | -------------
[**access_tokens_get**](AcrTokenApi.md#access_tokens_get) | **POST** /oauth2/token | 
[**access_tokens_get_from_login**](AcrTokenApi.md#access_tokens_get_from_login) | **GET** /oauth2/token | 
[**refresh_tokens_get_from_exchange**](AcrTokenApi.md#refresh_tokens_get_from_exchange) | **POST** /oauth2/exchange | 


# **access_tokens_get**
> AccessToken access_tokens_get(grant_type, service, scope, refresh_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.access_tokens_get(grant_type, service, scope, refresh_token)
        print("The response of AcrTokenApi->access_tokens_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrTokenApi->access_tokens_get: %s\n" % e)
```
...
> AccessToken access_tokens_get_from_login(service, scope)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.access_tokens_get_from_login(service, scope)
        print("The response of AcrTokenApi->access_tokens_get_from_login:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrTokenApi->access_tokens_get_from_login: %s\n" % e)
```
...
> RefreshToken refresh_tokens_get_from_exchange(grant_type, service, tenant=tenant, refresh_token=refresh_token, access_token=access_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.refresh_tokens_get_from_exchange(grant_type, service, tenant=tenant, refresh_token=refresh_token, access_token=access_token)
        print("The response of AcrTokenApi->refresh_tokens_get_from_exchange:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrTokenApi->refresh_tokens_get_from_exchange: %s\n" % e)
```
