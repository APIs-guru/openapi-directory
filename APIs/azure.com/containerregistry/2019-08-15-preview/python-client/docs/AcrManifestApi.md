# openapi_client.AcrManifestApi

All URIs are relative to *https://azure.local*

Method | HTTP request | Description
------------- | ------------- | -------------
[**manifests_get_attributes**](AcrManifestApi.md#manifests_get_attributes) | **GET** /acr/v1/{name}/_manifests/{reference} | 
[**manifests_get_list**](AcrManifestApi.md#manifests_get_list) | **GET** /acr/v1/{name}/_manifests | 
[**manifests_update_attributes**](AcrManifestApi.md#manifests_update_attributes) | **PATCH** /acr/v1/{name}/_manifests/{reference} | 


# **manifests_get_attributes**
> ManifestAttributes manifests_get_attributes(name, reference)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AcrManifestApi(api_client)
    ...
    try:
        api_response = api_instance.manifests_get_attributes(name, reference)
        print("The response of AcrManifestApi->manifests_get_attributes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrManifestApi->manifests_get_attributes: %s\n" % e)
```
...
[**ManifestAttributes**](ManifestAttributes.md)
...
# **manifests_get_list**
> AcrManifests manifests_get_list(name, last=last, n=n, orderby=orderby)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.manifests_get_list(name, last=last, n=n, orderby=orderby)
        print("The response of AcrManifestApi->manifests_get_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrManifestApi->manifests_get_list: %s\n" % e)
```
...
# **manifests_update_attributes**
> manifests_update_attributes(name, reference, value=value)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.manifests_update_attributes(name, reference, value=value)
    except Exception as e:
        print("Exception when calling AcrManifestApi->manifests_update_attributes: %s\n" % e)
```
