...
class TestV2Manifest(unittest.TestCase):
    """V2Manifest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2Manifest:
        """Test V2Manifest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2Manifest`
        """
        model = V2Manifest()
        if include_optional:
            return V2Manifest(
