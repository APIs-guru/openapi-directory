...
------------- | ------------- | -------------
[**get_acr_manifest_attributes**](AcrManifestApi.md#get_acr_manifest_attributes) | **GET** /acr/v1/{name}/_manifests/{reference} | 
[**get_acr_manifests**](AcrManifestApi.md#get_acr_manifests) | **GET** /acr/v1/{name}/_manifests | 
[**update_acr_manifest_attributes**](AcrManifestApi.md#update_acr_manifest_attributes) | **PATCH** /acr/v1/{name}/_manifests/{reference} | 


# **get_acr_manifest_attributes**
> AcrManifestAttributes get_acr_manifest_attributes(name, reference)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_acr_manifest_attributes(name, reference)
        print("The response of AcrManifestApi->get_acr_manifest_attributes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrManifestApi->get_acr_manifest_attributes: %s\n" % e)
```
...
# **get_acr_manifests**
> AcrManifests get_acr_manifests(name, last=last, n=n, orderby=orderby)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_acr_manifests(name, last=last, n=n, orderby=orderby)
        print("The response of AcrManifestApi->get_acr_manifests:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AcrManifestApi->get_acr_manifests: %s\n" % e)
```
...
# **update_acr_manifest_attributes**
> update_acr_manifest_attributes(name, reference, value=value)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.update_acr_manifest_attributes(name, reference, value=value)
    except Exception as e:
        print("Exception when calling AcrManifestApi->update_acr_manifest_attributes: %s\n" % e)
```
