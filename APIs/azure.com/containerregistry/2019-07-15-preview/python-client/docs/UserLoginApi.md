...
------------- | ------------- | -------------
[**get_acr_access_token_from_login_1**](UserLoginApi.md#get_acr_access_token_from_login_1) | **GET** /oauth2/token | 


# **get_acr_access_token_from_login_1**
> AccessToken get_acr_access_token_from_login_1(service, scope)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_acr_access_token_from_login_1(service, scope)
        print("The response of UserLoginApi->get_acr_access_token_from_login_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UserLoginApi->get_acr_access_token_from_login_1: %s\n" % e)
```
