...
------------- | ------------- | -------------
[**get_acr_access_token_0**](AccessTokenApi.md#get_acr_access_token_0) | **POST** /oauth2/token | 
[**get_acr_access_token_from_login_0**](AccessTokenApi.md#get_acr_access_token_from_login_0) | **GET** /oauth2/token | 


# **get_acr_access_token_0**
> AccessToken get_acr_access_token_0(grant_type, service, scope, refresh_token)
...
> AccessToken get_acr_access_token_from_login_0(service, scope)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_acr_access_token_from_login_0(service, scope)
        print("The response of AccessTokenApi->get_acr_access_token_from_login_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccessTokenApi->get_acr_access_token_from_login_0: %s\n" % e)
```
