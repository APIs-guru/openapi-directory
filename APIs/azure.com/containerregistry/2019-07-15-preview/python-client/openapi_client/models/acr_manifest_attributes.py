...
class AcrManifestAttributes(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manifest": AcrManifestAttributesBase.from_dict(obj["manifest"]) if obj.get("manifest") is not None else None,
