...
class ManifestAttributesManifestReferences(BaseModel):
    """
    Manifest attributes details
    """ # noqa: E501
    architecture: Optional[StrictStr] = Field(default=None, description="CPU architecture")
    digest: Optional[StrictStr] = Field(default=None, description="Manifest digest")
    os: Optional[StrictStr] = Field(default=None, description="Operating system")
    __properties: ClassVar[List[str]] = ["architecture", "digest", "os"]
