...
class AcrManifests(BaseModel):
    ...
    manifests: Optional[List[AcrManifestAttributesBase]] = Field(default=None, description="List of manifests")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manifests": [AcrManifestAttributesBase.from_dict(_item) for _item in obj["manifests"]] if obj.get("manifests") is not None else None,
