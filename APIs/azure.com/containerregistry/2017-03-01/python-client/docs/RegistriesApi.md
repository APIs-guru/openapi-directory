...
# **registries_create**
> Registry registries_create(api_version, subscription_id, resource_group_name, registry_name, registry_create_parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    registry_create_parameters = openapi_client.RegistryCreateParameters() # RegistryCreateParameters | The parameters for creating a container registry.

    try:
        api_response = api_instance.registries_create(api_version, subscription_id, resource_group_name, registry_name, registry_create_parameters)
 ...
 **registry_create_parameters** | [**RegistryCreateParameters**](RegistryCreateParameters.md)| The parameters for creating a container registry. | 
