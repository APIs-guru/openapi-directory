...
class ConsumerGroupProperties(BaseModel):
    """
    ...
    event_hub_path: Optional[StrictStr] = Field(default=None, description="The path of the Event Hub.", alias="eventHubPath")
    updated_at: Optional[datetime] = Field(default=None, description="The exact time the message was updated.", alias="updatedAt")
    user_metadata: Optional[StrictStr] = Field(default=None, description="The user metadata.", alias="userMetadata")
    __properties: ClassVar[List[str]] = ["createdAt", "eventHubPath", "updatedAt", "userMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventHubPath": obj.get("eventHubPath"),
