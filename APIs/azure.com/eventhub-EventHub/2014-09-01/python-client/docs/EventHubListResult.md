...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | Link to the next set of results. Not empty if Value contains incomplete list of EventHubs. | [optional] 
**value** | [**List[EventHubResource]**](EventHubResource.md) | Result of the List EventHubs operation. | [optional] 
