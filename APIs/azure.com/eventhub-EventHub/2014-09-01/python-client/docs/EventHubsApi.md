...
> SharedAccessAuthorizationRulePostResource event_hubs_post_authorization_rule(resource_group_name, namespace_name, event_hub_name, authorization_rule_name, api_version, subscription_id)
