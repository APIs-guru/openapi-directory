...
**provider** | **str** | Service provider: Microsoft.EventHub | [optional] [readonly] 
**resource** | **str** | Resource on which the operation is performed: Invoice, etc. | [optional] [readonly] 
