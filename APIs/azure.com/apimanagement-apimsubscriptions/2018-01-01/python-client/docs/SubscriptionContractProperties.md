...
json = "{}"
# create an instance of SubscriptionContractProperties from a JSON string
subscription_contract_properties_instance = SubscriptionContractProperties.from_json(json)
# print the JSON string representation of the object
print(SubscriptionContractProperties.to_json())

# convert the object into a dict
subscription_contract_properties_dict = subscription_contract_properties_instance.to_dict()
# create an instance of SubscriptionContractProperties from a dict
subscription_contract_properties_from_dict = SubscriptionContractProperties.from_dict(subscription_contract_properties_dict)
```
