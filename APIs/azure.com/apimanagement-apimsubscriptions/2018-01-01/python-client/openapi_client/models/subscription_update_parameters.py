...
class SubscriptionUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[SubscriptionUpdateParameterProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": SubscriptionUpdateParameterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
