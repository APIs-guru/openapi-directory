...
class SubscriptionUpdateParameterProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["displayName", "expirationDate", "primaryKey", "productId", "secondaryKey", "state", "stateComment", "userId"]
