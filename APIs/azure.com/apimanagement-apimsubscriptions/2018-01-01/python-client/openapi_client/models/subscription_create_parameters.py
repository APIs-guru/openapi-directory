...
class SubscriptionCreateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[SubscriptionCreateParameterProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": SubscriptionCreateParameterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
