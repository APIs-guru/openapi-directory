...
class SubscriptionsApi:
    ...
    def subscription_create_or_update(
        ...
        sid: Annotated[str, Field(strict=True, max_length=80, description="Subscription entity Identifier. The entity represents the association between a user and a product in API Management.")],
