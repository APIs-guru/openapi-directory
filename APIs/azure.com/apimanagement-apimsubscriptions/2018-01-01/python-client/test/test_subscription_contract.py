...
class TestSubscriptionContract(unittest.TestCase):
    """SubscriptionContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionContract:
        """Test SubscriptionContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionContract`
        """
        model = SubscriptionContract()
        if include_optional:
            return SubscriptionContract(
                properties = openapi_client.models.subscription_contract_properties.SubscriptionContractProperties(
    ...
    def testSubscriptionContract(self):
        """Test SubscriptionContract"""
