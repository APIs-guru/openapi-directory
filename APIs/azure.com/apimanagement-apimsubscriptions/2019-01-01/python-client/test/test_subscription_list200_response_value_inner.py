...
class TestSubscriptionList200ResponseValueInner(unittest.TestCase):
    """SubscriptionList200ResponseValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionList200ResponseValueInner:
        """Test SubscriptionList200ResponseValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionList200ResponseValueInner`
        """
        model = SubscriptionList200ResponseValueInner()
        if include_optional:
            return SubscriptionList200ResponseValueInner(
    ...
    def testSubscriptionList200ResponseValueInner(self):
        """Test SubscriptionList200ResponseValueInner"""
