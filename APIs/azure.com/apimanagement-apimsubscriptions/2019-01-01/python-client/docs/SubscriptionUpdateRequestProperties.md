...
**owner_id** | **str** | User identifier path: /users/{userId} | [optional] 
**primary_key** | **str** | Primary subscription key. | [optional] 
**scope** | **str** | Scope like /products/{productId} or /apis or /apis/{apiId} | [optional] 
...
subscription_update_request_properties_instance = SubscriptionUpdateRequestProperties.from_json(json)
# print the JSON string representation of the object
print(SubscriptionUpdateRequestProperties.to_json())

# convert the object into a dict
subscription_update_request_properties_dict = subscription_update_request_properties_instance.to_dict()
# create an instance of SubscriptionUpdateRequestProperties from a dict
subscription_update_request_properties_from_dict = SubscriptionUpdateRequestProperties.from_dict(subscription_update_request_properties_dict)
```
