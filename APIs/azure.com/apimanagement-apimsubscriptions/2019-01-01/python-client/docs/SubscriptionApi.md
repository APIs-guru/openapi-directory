...
> SubscriptionGet200Response subscription_create_or_update(resource_group_name, service_name, sid, api_version, subscription_id, parameters, notify=notify, if_match=if_match, app_type=app_type)
...
# **subscription_update**
> subscription_update(resource_group_name, service_name, sid, if_match, api_version, subscription_id, parameters, notify=notify, app_type=app_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.subscription_update(resource_group_name, service_name, sid, if_match, api_version, subscription_id, parameters, notify=notify, app_type=app_type)
    except Exception as e:
