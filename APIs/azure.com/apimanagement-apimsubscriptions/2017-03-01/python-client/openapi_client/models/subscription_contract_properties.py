...
class SubscriptionContractProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdDate", "endDate", "expirationDate", "name", "notificationDate", "primaryKey", "productId", "secondaryKey", "startDate", "state", "stateComment", "userId"]
