...
class TestSubscriptionContractProperties(unittest.TestCase):
    """SubscriptionContractProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionContractProperties:
        """Test SubscriptionContractProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionContractProperties`
        """
    ...
    def testSubscriptionContractProperties(self):
        """Test SubscriptionContractProperties"""
