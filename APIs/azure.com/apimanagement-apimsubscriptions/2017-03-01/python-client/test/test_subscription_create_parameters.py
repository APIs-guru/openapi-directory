...
class TestSubscriptionCreateParameters(unittest.TestCase):
    """SubscriptionCreateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionCreateParameters:
        """Test SubscriptionCreateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionCreateParameters`
        """
    ...
    def testSubscriptionCreateParameters(self):
        """Test SubscriptionCreateParameters"""
