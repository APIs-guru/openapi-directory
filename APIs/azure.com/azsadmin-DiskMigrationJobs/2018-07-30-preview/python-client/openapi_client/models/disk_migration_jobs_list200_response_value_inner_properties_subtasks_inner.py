...
class DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInner(BaseModel):
    """
    Disk migration child task.
    """ # noqa: E501
    migration_sub_task_id: Optional[StrictStr] = Field(default=None, description="The id of migration child task.", alias="migrationSubTaskId")
    properties: Optional[DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties] = None
    __properties: ClassVar[List[str]] = ["migrationSubTaskId", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "migrationSubTaskId": obj.get("migrationSubTaskId"),
            "properties": DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
