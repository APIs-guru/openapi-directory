...
# **triggers_get**
> TriggerResource triggers_get(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.triggers_get(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
