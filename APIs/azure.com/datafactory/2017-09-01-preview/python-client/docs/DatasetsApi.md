...
# **datasets_get**
> DatasetResource datasets_get(subscription_id, resource_group_name, factory_name, dataset_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.datasets_get(subscription_id, resource_group_name, factory_name, dataset_name, api_version)
