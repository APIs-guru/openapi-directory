...
class TestParameterSpecification(unittest.TestCase):
    """ParameterSpecification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParameterSpecification:
        """Test ParameterSpecification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParameterSpecification`
        """
    ...
    def testParameterSpecification(self):
        """Test ParameterSpecification"""
