...
class TriggerResource(BaseModel):
    """
    Trigger resource type.
    """ # noqa: E501
    properties: Dict[str, Dict[str, Any]] = Field(description="Azure data factory nested object which contains information about creating pipeline run")
