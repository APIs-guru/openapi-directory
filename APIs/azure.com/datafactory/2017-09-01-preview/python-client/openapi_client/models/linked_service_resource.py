...
class LinkedServiceResource(BaseModel):
    """
    Linked service resource type.
    """ # noqa: E501
    properties: Dict[str, Dict[str, Any]] = Field(description="The Azure Data Factory nested object which contains the information and credential which can be used to connect with related store or compute resource.")
    etag: Optional[StrictStr] = Field(default=None, description="Etag identifies change in the resource.")
