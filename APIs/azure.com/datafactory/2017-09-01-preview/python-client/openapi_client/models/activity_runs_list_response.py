...
class ActivityRunsListResponse(BaseModel):
    """
    ...
    value: List[ActivityRun] = Field(description="List of activity runs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ActivityRun.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
