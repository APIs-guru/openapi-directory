...
class IntegrationRuntimesRegenerateAuthKeyRequest(BaseModel):
    """
    Parameters to regenerate the authentication key.
    """ # noqa: E501
    key_name: Optional[StrictStr] = Field(default=None, description="The name of the authentication key to regenerate.", alias="keyName")
    ...
    def key_name_validate_enum(cls, value):
        ...
        if value not in set(['authKey1', 'authKey2']):
            raise ValueError("must be one of enum values ('authKey1', 'authKey2')")
        return value
