...
class IntegrationRuntimesRemoveNodeRequest(BaseModel):
    """
    Request to remove a node.
    """ # noqa: E501
    node_name: Optional[StrictStr] = Field(default=None, description="The name of the node to be removed.", alias="nodeName")
