...
class FactoryUpdateParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["identity", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity": FactoryIdentity.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
