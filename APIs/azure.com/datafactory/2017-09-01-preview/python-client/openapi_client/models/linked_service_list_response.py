...
class LinkedServiceListResponse(BaseModel):
    """
    ...
    value: List[LinkedServiceResource] = Field(description="List of linked services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LinkedServiceResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
