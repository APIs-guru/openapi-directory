...
class RerunTriggerResource(BaseModel):
    """
    RerunTrigger resource type.
    """ # noqa: E501
    properties: object = Field(description="Trigger that schedules pipeline reruns for all fixed time interval windows from a requested start time to requested end time.")
