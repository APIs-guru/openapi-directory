...
class DataFlowListResponse(BaseModel):
    ...
    value: List[DataFlowResource] = Field(description="List of data flows.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DataFlowResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
