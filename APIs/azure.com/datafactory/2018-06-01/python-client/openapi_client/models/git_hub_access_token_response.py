...
class GitHubAccessTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    git_hub_access_token: Optional[StrictStr] = Field(default=None, description="GitHub access token.", alias="gitHubAccessToken")
    __properties: ClassVar[List[str]] = ["gitHubAccessToken"]
