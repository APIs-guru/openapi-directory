...
class IntegrationRuntimeResource(BaseModel):
    """
    Integration runtime resource type.
    """ # noqa: E501
    properties: Dict[str, Dict[str, Any]] = Field(description="Azure Data Factory nested object which serves as a compute resource for activities.")
