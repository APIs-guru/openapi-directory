...
class IntegrationRuntimeNodesGetIpAddress200Response(BaseModel):
    """
    The IP address of self-hosted integration runtime node.
    """ # noqa: E501
    ip_address: Optional[StrictStr] = Field(default=None, description="The IP address of self-hosted integration runtime node.", alias="ipAddress")
