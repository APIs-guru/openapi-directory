...
class OperationMetricSpecification(BaseModel):
    ...
    dimensions: Optional[List[OperationMetricDimension]] = Field(default=None, description="Defines the metric dimension.")
    ...
    __properties: ClassVar[List[str]] = ["aggregationType", "availabilities", "dimensions", "displayDescription", "displayName", "enableRegionalMdmAccount", "name", "sourceMdmAccount", "sourceMdmNamespace", "unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dimensions": [OperationMetricDimension.from_dict(_item) for _item in obj["dimensions"]] if obj.get("dimensions") is not None else None,
