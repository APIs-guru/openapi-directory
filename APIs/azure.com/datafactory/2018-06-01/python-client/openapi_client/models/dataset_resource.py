...
class DatasetResource(BaseModel):
    ...
    """ # noqa: E501
    properties: Dict[str, Dict[str, Any]] = Field(description="The Azure Data Factory nested object which identifies data within different data stores, such as tables, files, folders, and documents.")
