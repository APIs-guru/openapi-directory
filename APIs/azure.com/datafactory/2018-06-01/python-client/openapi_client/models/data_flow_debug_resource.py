...
class DataFlowDebugResource(BaseModel):
    """
    Data flow debug resource.
    """ # noqa: E501
    properties: object = Field(description="Azure Data Factory nested object which contains a flow with data movements and transformations.")
