...
class PipelineRun(BaseModel):
    ...
    is_latest: Optional[StrictBool] = Field(default=None, description="Indicates if the recovered pipeline run is the latest in its group.", alias="isLatest")
    ...
    run_dimensions: Optional[Dict[str, StrictStr]] = Field(default=None, description="Run dimensions emitted by Pipeline run.", alias="runDimensions")
    run_end: Optional[datetime] = Field(default=None, description="The end time of a pipeline run in ISO8601 format.", alias="runEnd")
    run_group_id: Optional[StrictStr] = Field(default=None, description="Identifier that correlates all the recovery runs of a pipeline run.", alias="runGroupId")
    ...
    __properties: ClassVar[List[str]] = ["durationInMs", "invokedBy", "isLatest", "lastUpdated", "message", "parameters", "pipelineName", "runDimensions", "runEnd", "runGroupId", "runId", "runStart", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "runDimensions": obj.get("runDimensions"),
            "runEnd": obj.get("runEnd"),
            "runGroupId": obj.get("runGroupId"),
            "runId": obj.get("runId"),
