...
class PipelineListResponse(BaseModel):
    ...
    value: List[PipelineResource] = Field(description="List of pipelines.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PipelineResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
