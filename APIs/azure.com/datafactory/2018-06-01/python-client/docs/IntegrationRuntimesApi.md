...
[**integration_runtimes_remove_links**](IntegrationRuntimesApi.md#integration_runtimes_remove_links) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/removeLinks | 
...
> IntegrationRuntimeStatusResponse integration_runtimes_create_linked_integration_runtime(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, create_linked_integration_runtime_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    create_linked_integration_runtime_request = openapi_client.CreateLinkedIntegrationRuntimeRequest() # CreateLinkedIntegrationRuntimeRequest | The linked integration runtime properties.

    try:
        api_response = api_instance.integration_runtimes_create_linked_integration_runtime(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, create_linked_integration_runtime_request)
        print("The response of IntegrationRuntimesApi->integration_runtimes_create_linked_integration_runtime:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IntegrationRuntimesApi->integration_runtimes_create_linked_integration_runtime: %s\n" % e)
```
 ...
 **create_linked_integration_runtime_request** | [**CreateLinkedIntegrationRuntimeRequest**](CreateLinkedIntegrationRuntimeRequest.md)| The linked integration runtime properties. | 
...
> IntegrationRuntimeResource integration_runtimes_get(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, if_none_match=if_none_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    integration_runtime_name = 'integration_runtime_name_example' # str | The integration runtime name.
    api_version = 'api_version_example' # str | The API version.
    if_none_match = 'if_none_match_example' # str | ETag of the integration runtime entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. (optional)

    try:
        api_response = api_instance.integration_runtimes_get(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, if_none_match=if_none_match)
 ...
 **integration_runtime_name** | **str**| The integration runtime name. | 
 **api_version** | **str**| The API version. | 
 **if_none_match** | **str**| ETag of the integration runtime entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. | [optional] 
...
> integration_runtimes_remove_links(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, linked_integration_runtime_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    integration_runtime_name = 'integration_runtime_name_example' # str | The integration runtime name.
    api_version = 'api_version_example' # str | The API version.
    linked_integration_runtime_request = openapi_client.LinkedIntegrationRuntimeRequest() # LinkedIntegrationRuntimeRequest | The data factory name for the linked integration runtime.

    try:
        api_instance.integration_runtimes_remove_links(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, linked_integration_runtime_request)
    except Exception as e:
        print("Exception when calling IntegrationRuntimesApi->integration_runtimes_remove_links: %s\n" % e)
```
 ...
 **integration_runtime_name** | **str**| The integration runtime name. | 
 **api_version** | **str**| The API version. | 
 **linked_integration_runtime_request** | [**LinkedIntegrationRuntimeRequest**](LinkedIntegrationRuntimeRequest.md)| The data factory name for the linked integration runtime. | 
...
> IntegrationRuntimeResource integration_runtimes_update(subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, update_integration_runtime_request)
