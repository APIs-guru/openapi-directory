...
[**triggers_get_event_subscription_status**](TriggersApi.md#triggers_get_event_subscription_status) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/triggers/{triggerName}/getEventSubscriptionStatus | 
...
[**triggers_subscribe_to_events**](TriggersApi.md#triggers_subscribe_to_events) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/triggers/{triggerName}/subscribeToEvents | 
[**triggers_unsubscribe_from_events**](TriggersApi.md#triggers_unsubscribe_from_events) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/triggers/{triggerName}/unsubscribeFromEvents | 
...
> TriggerSubscriptionOperationStatus triggers_get_event_subscription_status(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.triggers_get_event_subscription_status(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
        print("The response of TriggersApi->triggers_get_event_subscription_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TriggersApi->triggers_get_event_subscription_status: %s\n" % e)
```
...
> TriggerSubscriptionOperationStatus triggers_subscribe_to_events(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.triggers_subscribe_to_events(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
        print("The response of TriggersApi->triggers_subscribe_to_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TriggersApi->triggers_subscribe_to_events: %s\n" % e)
```
...
> TriggerSubscriptionOperationStatus triggers_unsubscribe_from_events(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.triggers_unsubscribe_from_events(subscription_id, resource_group_name, factory_name, trigger_name, api_version)
        print("The response of TriggersApi->triggers_unsubscribe_from_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TriggersApi->triggers_unsubscribe_from_events: %s\n" % e)
```
