...
**operation** | **str** | The type of operation: get, read, delete, etc. | [optional] 
**provider** | **str** | The name of the provider. | [optional] 
**resource** | **str** | The name of the resource type on which the operation is performed. | [optional] 
