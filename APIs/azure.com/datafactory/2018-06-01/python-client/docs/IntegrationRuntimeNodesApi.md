...
[**integration_runtime_nodes_get**](IntegrationRuntimeNodesApi.md#integration_runtime_nodes_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/nodes/{nodeName} | 
...
> IntegrationRuntimeNodesGet200Response integration_runtime_nodes_get(subscription_id, resource_group_name, factory_name, integration_runtime_name, node_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.integration_runtime_nodes_get(subscription_id, resource_group_name, factory_name, integration_runtime_name, node_name, api_version)
        print("The response of IntegrationRuntimeNodesApi->integration_runtime_nodes_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IntegrationRuntimeNodesApi->integration_runtime_nodes_get: %s\n" % e)
```
...
> IntegrationRuntimeNodesGet200Response integration_runtime_nodes_update(subscription_id, resource_group_name, factory_name, integration_runtime_name, node_name, api_version, update_integration_runtime_node_request)
