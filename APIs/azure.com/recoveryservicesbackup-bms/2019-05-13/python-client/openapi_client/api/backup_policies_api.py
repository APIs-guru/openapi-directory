...
class BackupPoliciesApi:
    ...
    def backup_policies_list(
        ...
        _param = self._backup_policies_list_serialize(
    ...
    @validate_call
    def backup_policies_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def backup_policies_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _backup_policies_list_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
