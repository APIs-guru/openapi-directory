...
class ProtectedItemsApi:
    ...
    def protected_items_create_or_update(
        ...
        protected_item_name: Annotated[StrictStr, Field(description="Item name to be backed up.")],
        parameters: Annotated[ProtectedItemResource, Field(description="resource backed up item")],
        ...
        :type parameters: ProtectedItemResource
    ...
    def protected_items_delete(
        ...
        protected_item_name: Annotated[StrictStr, Field(description="Backed up item to be deleted.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def protected_items_get(
        ...
        fabric_name: Annotated[StrictStr, Field(description="Fabric name associated with the backed up item.")],
        container_name: Annotated[StrictStr, Field(description="Container name associated with the backed up item.")],
        protected_item_name: Annotated[StrictStr, Field(description="Backed up item name whose details are to be fetched.")],
