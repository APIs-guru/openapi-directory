...
class ProtectionPoliciesApi:
    ...
    def protection_policies_create_or_update(
        ...
        policy_name: Annotated[StrictStr, Field(description="Backup policy to be created.")],
        parameters: Annotated[ProtectionPolicyResource, Field(description="resource backup policy")],
        ...
        :type parameters: ProtectionPolicyResource
    ...
    def protection_policies_get(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        policy_name: Annotated[StrictStr, Field(description="Backup policy information to be fetched.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
