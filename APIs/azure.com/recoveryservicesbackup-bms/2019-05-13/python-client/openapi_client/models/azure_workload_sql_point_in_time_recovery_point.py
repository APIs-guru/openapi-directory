...
class AzureWorkloadSQLPointInTimeRecoveryPoint(AzureWorkloadSQLRecoveryPoint):
    ...
    __properties: ClassVar[List[str]] = ["extendedInfo", "recoveryPointTimeInUTC", "type", "objectType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extendedInfo": AzureWorkloadSQLRecoveryPointExtendedInfo.from_dict(obj["extendedInfo"]) if obj.get("extendedInfo") is not None else None,
