...
class ProtectionPolicyQueryObject(BaseModel):
    """
    Filters the list backup policies API.
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="Backup management type for the backup policy.", alias="backupManagementType")
    fabric_name: Optional[StrictStr] = Field(default=None, description="Fabric name for filter", alias="fabricName")
    workload_type: Optional[StrictStr] = Field(default=None, description="Workload type for the backup policy.", alias="workloadType")
    __properties: ClassVar[List[str]] = ["backupManagementType", "fabricName", "workloadType"]
