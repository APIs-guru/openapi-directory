...
class AzureWorkloadSAPHanaPointInTimeRecoveryPoint(AzureWorkloadPointInTimeRecoveryPoint):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["timeRanges", "recoveryPointTimeInUTC", "type", "objectType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureWorkloadSAPHanaPointInTimeRecoveryPoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureWorkloadSAPHanaPointInTimeRecoveryPoint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "timeRanges": [PointInTimeRange.from_dict(_item) for _item in obj["timeRanges"]] if obj.get("timeRanges") is not None else None,
            "recoveryPointTimeInUTC": obj.get("recoveryPointTimeInUTC"),
            "type": obj.get("type"),
