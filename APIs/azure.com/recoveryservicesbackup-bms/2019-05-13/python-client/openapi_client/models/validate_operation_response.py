...
class ValidateOperationResponse(BaseModel):
    ...
    """ # noqa: E501
    validation_results: Optional[List[ErrorDetail]] = Field(default=None, description="Gets the validation result", alias="validationResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationResults": [ErrorDetail.from_dict(_item) for _item in obj["validationResults"]] if obj.get("validationResults") is not None else None
        })
        return _obj
