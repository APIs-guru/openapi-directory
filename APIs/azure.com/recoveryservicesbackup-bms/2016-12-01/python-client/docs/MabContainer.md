...
**container_health_state** | **str** | Health state of mab container. | [optional] 
...
**mab_container_health_details** | [**List[MABContainerHealthDetails]**](MABContainerHealthDetails.md) | Health details on this mab container. | [optional] 
