# openapi_client.BackupOperationResultsApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**backup_operation_results_get**](BackupOperationResultsApi.md#backup_operation_results_get) | **GET** /Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupOperationResults/{operationId} | 


# **backup_operation_results_get**
> backup_operation_results_get(api_version, vault_name, resource_group_name, subscription_id, operation_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.BackupOperationResultsApi(api_client)
    ...
    operation_id = 'operation_id_example' # str | OperationID which represents the operation.

    try:
        api_instance.backup_operation_results_get(api_version, vault_name, resource_group_name, subscription_id, operation_id)
    except Exception as e:
        print("Exception when calling BackupOperationResultsApi->backup_operation_results_get: %s\n" % e)
```
