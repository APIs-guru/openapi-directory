...
class AzureVmWorkloadSAPAseDatabaseWorkloadItem(AzureVmWorkloadItem):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["isAutoProtectable", "parentName", "serverName", "subWorkloadItemCount", "subinquireditemcount", "backupManagementType", "friendlyName", "protectionState", "workloadItemType", "workloadType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureVmWorkloadSAPAseDatabaseWorkloadItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureVmWorkloadSAPAseDatabaseWorkloadItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subWorkloadItemCount": obj.get("subWorkloadItemCount"),
