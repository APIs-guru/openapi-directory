...
class BMSContainersInquiryQueryObject(BaseModel):
    """
    ...
    workload_type: Optional[StrictStr] = Field(default=None, description="Workload type for this container.", alias="workloadType")
    __properties: ClassVar[List[str]] = ["backupManagementType", "workloadType"]
