...
class OperationStatusJobsExtendedInfo(OperationStatusExtendedInfo):
    ...
    """ # noqa: E501
    failed_jobs_error: Optional[Dict[str, StrictStr]] = Field(default=None, description="Stores all the failed jobs along with the corresponding error codes.", alias="failedJobsError")
    job_ids: Optional[List[StrictStr]] = Field(default=None, description="IDs of the jobs created for the protected item.", alias="jobIds")
