...
class BMSRefreshContainersQueryObject(BaseModel):
    """
    The query filters that can be used with the refresh container API.
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="Backup management type for this container.", alias="backupManagementType")
