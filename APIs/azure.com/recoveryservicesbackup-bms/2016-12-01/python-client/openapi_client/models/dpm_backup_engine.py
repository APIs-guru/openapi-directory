...
class DpmBackupEngine(BackupEngineBase):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DpmBackupEngine from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DpmBackupEngine from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "azureBackupAgentVersion": obj.get("azureBackupAgentVersion"),
            "backupEngineId": obj.get("backupEngineId"),
            "backupEngineState": obj.get("backupEngineState"),
            ...
            "dpmVersion": obj.get("dpmVersion"),
            "extendedInfo": BackupEngineExtendedInfo.from_dict(obj["extendedInfo"]) if obj.get("extendedInfo") is not None else None,
            "friendlyName": obj.get("friendlyName"),
            "healthStatus": obj.get("healthStatus"),
            "isAzureBackupAgentUpgradeAvailable": obj.get("isAzureBackupAgentUpgradeAvailable"),
            "isDpmUpgradeAvailable": obj.get("isDpmUpgradeAvailable"),
