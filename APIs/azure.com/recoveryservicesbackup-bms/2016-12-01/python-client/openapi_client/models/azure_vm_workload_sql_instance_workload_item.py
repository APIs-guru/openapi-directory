...
class AzureVmWorkloadSQLInstanceWorkloadItem(AzureVmWorkloadItem):
    ...
    """ # noqa: E501
    data_directory_paths: Optional[List[SQLDataDirectory]] = Field(default=None, description="Data Directory Paths for default directories", alias="dataDirectoryPaths")
