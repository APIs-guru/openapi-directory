...
class AzureBackupServerContainer(DpmContainer):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["canReRegister", "containerId", "dpmAgentVersion", "dpmServers", "extendedInfo", "protectedItemCount", "protectionStatus", "upgradeAvailable", "backupManagementType", "containerType", "friendlyName", "healthStatus", "registrationStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dpmAgentVersion": obj.get("dpmAgentVersion"),
            "dpmServers": obj.get("dpmServers"),
            "extendedInfo": DPMContainerExtendedInfo.from_dict(obj["extendedInfo"]) if obj.get("extendedInfo") is not None else None,
