...
class BMSBackupEnginesQueryObject(BaseModel):
    """
    Query parameters to fetch list of backup engines.
    """ # noqa: E501
    backup_management_type: Optional[StrictStr] = Field(default=None, description="Backup management type for the backup engine.", alias="backupManagementType")
    expand: Optional[StrictStr] = Field(default=None, description="Attribute to add extended info.")
    friendly_name: Optional[StrictStr] = Field(default=None, description="Friendly name of the backup engine.", alias="friendlyName")
    __properties: ClassVar[List[str]] = ["backupManagementType", "expand", "friendlyName"]
