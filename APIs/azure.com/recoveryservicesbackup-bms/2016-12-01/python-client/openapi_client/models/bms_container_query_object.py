...
class BMSContainerQueryObject(BaseModel):
    ...
    backup_management_type: StrictStr = Field(description="Backup management type for this container.", alias="backupManagementType")
    container_type: Optional[StrictStr] = Field(default=None, description="Type of container for filter", alias="containerType")
    fabric_name: Optional[StrictStr] = Field(default=None, description="Fabric name for filter", alias="fabricName")
    friendly_name: Optional[StrictStr] = Field(default=None, description="Friendly name of this container.", alias="friendlyName")
    status: Optional[StrictStr] = Field(default=None, description="Status of registration of this container with the Recovery Services Vault.")
    __properties: ClassVar[List[str]] = ["backupEngineName", "backupManagementType", "containerType", "fabricName", "friendlyName", "status"]
