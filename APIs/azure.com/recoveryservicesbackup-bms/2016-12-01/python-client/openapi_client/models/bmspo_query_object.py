...
class BMSPOQueryObject(BaseModel):
    ...
    container_name: Optional[StrictStr] = Field(default=None, description="Full name of the container whose Protectable Objects should be returned.", alias="containerName")
    friendly_name: Optional[StrictStr] = Field(default=None, description="Friendly name.", alias="friendlyName")
    status: Optional[StrictStr] = Field(default=None, description="Backup status query parameter.")
    workload_type: Optional[StrictStr] = Field(default=None, description="Workload type", alias="workloadType")
    __properties: ClassVar[List[str]] = ["backupManagementType", "containerName", "friendlyName", "status", "workloadType"]
