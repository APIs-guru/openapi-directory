...
class IaasVMBackupRequest(BackupRequest):
    ...
    """ # noqa: E501
    recovery_point_expiry_time_in_utc: Optional[datetime] = Field(default=None, description="Backup copy will expire after the time specified (UTC).", alias="recoveryPointExpiryTimeInUTC")
