...
class GenericContainer(ProtectionContainer):
    ...
    """ # noqa: E501
    extended_information: Optional[GenericContainerExtendedInfo] = Field(default=None, alias="extendedInformation")
    fabric_name: Optional[StrictStr] = Field(default=None, description="Name of the container's fabric", alias="fabricName")
