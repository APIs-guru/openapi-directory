...
class BackupProtectionContainersApi:
    ...
    @validate_call
    def backup_protection_containers_list(
        self,
        ...
        _param = self._backup_protection_containers_list_serialize(
    ...
    @validate_call
    def backup_protection_containers_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def backup_protection_containers_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _backup_protection_containers_list_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
