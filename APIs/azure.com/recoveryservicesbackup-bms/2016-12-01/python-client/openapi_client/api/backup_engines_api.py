...
class BackupEnginesApi:
    ...
    def backup_engines_get(
        ...
        backup_engine_name: Annotated[StrictStr, Field(description="Name of the backup management server.")],
        ...
        _param = self._backup_engines_get_serialize(
    ...
    @validate_call
    def backup_engines_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BackupEngineBaseResource]:
        """backup_engines_get
    ...
    @validate_call
    def backup_engines_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _backup_engines_get_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        if backup_engine_name is not None:
            _path_params['backupEngineName'] = backup_engine_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupEngines/{backupEngineName}',
    ...
    def backup_engines_list(
        ...
        _param = self._backup_engines_list_serialize(
            api_version=api_version,
            vault_name=vault_name,
            resource_group_name=resource_group_name,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BackupEngineBaseResourceList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def backup_engines_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BackupEngineBaseResourceList]:
        """backup_engines_list
    ...
    @validate_call
    def backup_engines_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _backup_engines_list_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupEngines',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
