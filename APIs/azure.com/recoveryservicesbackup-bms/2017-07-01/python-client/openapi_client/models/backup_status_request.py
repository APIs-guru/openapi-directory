...
class BackupStatusRequest(BaseModel):
    ...
    """ # noqa: E501
    po_logical_name: Optional[StrictStr] = Field(default=None, description="Protectable Item Logical Name", alias="poLogicalName")
    resource_id: Optional[StrictStr] = Field(default=None, description="Entire ARM resource id of the resource", alias="resourceId")
    resource_type: Optional[StrictStr] = Field(default=None, description="Container Type - VM, SQLPaaS, DPM, AzureFileShare...", alias="resourceType")
    __properties: ClassVar[List[str]] = ["poLogicalName", "resourceId", "resourceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "poLogicalName": obj.get("poLogicalName"),
