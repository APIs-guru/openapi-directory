...
class ProtectionIntentQueryObject(BaseModel):
    """
    ...
    item_name: Optional[StrictStr] = Field(default=None, description="Item name of the intent", alias="itemName")
    item_type: Optional[StrictStr] = Field(default=None, description="Type of workload this item represents", alias="itemType")
    parent_name: Optional[StrictStr] = Field(default=None, description="Parent name of the intent", alias="parentName")
    __properties: ClassVar[List[str]] = ["backupManagementType", "itemName", "itemType", "parentName"]
    ...
    def item_type_validate_enum(cls, value):
        ...
        if value not in set(['Invalid', 'SQLInstance', 'SQLAvailabilityGroupContainer']):
            raise ValueError("must be one of enum values ('Invalid', 'SQLInstance', 'SQLAvailabilityGroupContainer')")
        return value
