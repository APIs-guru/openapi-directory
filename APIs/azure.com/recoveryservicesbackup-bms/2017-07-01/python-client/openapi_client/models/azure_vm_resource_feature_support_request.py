...
class AzureVMResourceFeatureSupportRequest(FeatureSupportRequest):
    ...
    """ # noqa: E501
    vm_size: Optional[StrictStr] = Field(default=None, description="Size of the resource: VM size(A/D series etc) in case of IaasVM", alias="vmSize")
    vm_sku: Optional[StrictStr] = Field(default=None, description="SKUs (Premium/Managed etc) in case of IaasVM", alias="vmSku")
