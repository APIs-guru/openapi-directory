...
class BackupManagementUsageList(BaseModel):
    """
    Backup management usage for vault.
    """ # noqa: E501
    value: Optional[List[BackupManagementUsage]] = Field(default=None, description="The list of backup management usages for the given vault.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BackupManagementUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
