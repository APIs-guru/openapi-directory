...
class PreValidateEnableBackupRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    properties: Optional[StrictStr] = Field(default=None, description="Configuration of VM if any needs to be validated like OS type etc")
    resource_id: Optional[StrictStr] = Field(default=None, description="ARM Virtual Machine Id", alias="resourceId")
    resource_type: Optional[StrictStr] = Field(default=None, description="ProtectedItem Type- VM, SqlDataBase, AzureFileShare etc", alias="resourceType")
    vault_id: Optional[StrictStr] = Field(default=None, description="ARM id of the Recovery Services Vault", alias="vaultId")
    __properties: ClassVar[List[str]] = ["properties", "resourceId", "resourceType", "vaultId"]
