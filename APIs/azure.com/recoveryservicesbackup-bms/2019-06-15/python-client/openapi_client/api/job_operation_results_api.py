...
class JobOperationResultsApi:
    ...
    def job_operation_results_get(
        ...
        job_name: Annotated[StrictStr, Field(description="Job name whose operation result has to be fetched.")],
        operation_id: Annotated[StrictStr, Field(description="OperationID which represents the operation whose result has to be fetched.")],
        ...
        :type job_name: str
        :param operation_id: OperationID which represents the operation whose result has to be fetched. (required)
