...
class AzureIaaSVMJob(Job):
    ...
    error_details: Optional[List[AzureIaaSVMErrorInfo]] = Field(default=None, description="Error details on execution of this job.", alias="errorDetails")
    extended_info: Optional[AzureIaaSVMJobExtendedInfo] = Field(default=None, alias="extendedInfo")
    virtual_machine_version: Optional[StrictStr] = Field(default=None, description="Specifies whether the backup item is a Classic or an Azure Resource Manager VM.", alias="virtualMachineVersion")
