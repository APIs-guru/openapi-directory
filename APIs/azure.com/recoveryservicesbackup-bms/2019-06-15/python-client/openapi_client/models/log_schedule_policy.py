...
class LogSchedulePolicy(SchedulePolicy):
    ...
    Log policy schedule.
    """ # noqa: E501
    schedule_frequency_in_mins: Optional[StrictInt] = Field(default=None, description="Frequency of the log schedule operation of this policy in minutes.", alias="scheduleFrequencyInMins")
