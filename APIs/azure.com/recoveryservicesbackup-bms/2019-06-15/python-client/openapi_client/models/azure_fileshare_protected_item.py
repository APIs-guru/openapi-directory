...
class AzureFileshareProtectedItem(ProtectedItem):
    ...
    """ # noqa: E501
    extended_info: Optional[AzureFileshareProtectedItemExtendedInfo] = Field(default=None, alias="extendedInfo")
    friendly_name: Optional[StrictStr] = Field(default=None, description="Friendly name of the fileshare represented by this backup item.", alias="friendlyName")
    health_status: Optional[StrictStr] = Field(default=None, description="backups running status for this backup item.", alias="healthStatus")
