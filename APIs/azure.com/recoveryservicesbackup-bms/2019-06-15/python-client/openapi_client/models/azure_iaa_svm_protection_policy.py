...
class AzureIaaSVMProtectionPolicy(ProtectionPolicy):
    ...
    """ # noqa: E501
    instant_rp_details: Optional[InstantRPAdditionalDetails] = Field(default=None, alias="instantRPDetails")
    instant_rp_retention_range_in_days: Optional[StrictInt] = Field(default=None, description="Instant RP retention policy range in days", alias="instantRpRetentionRangeInDays")
