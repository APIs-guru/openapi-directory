...
class TestSubProtectionPolicy(unittest.TestCase):
    """SubProtectionPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubProtectionPolicy:
        """Test SubProtectionPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubProtectionPolicy`
        """
    ...
    def testSubProtectionPolicy(self):
        """Test SubProtectionPolicy"""
