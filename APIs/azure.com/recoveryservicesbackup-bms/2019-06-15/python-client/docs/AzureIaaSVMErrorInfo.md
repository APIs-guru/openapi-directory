...
------------ | ------------- | ------------- | -------------
**error_code** | **int** | Error code. | [optional] [readonly] 
**error_string** | **str** | Localized error string. | [optional] [readonly] 
**error_title** | **str** | Title: Typically, the entity that the error pertains to. | [optional] [readonly] 
**recommendations** | **List[str]** | List of localized recommendations for above error code. | [optional] [readonly] 
