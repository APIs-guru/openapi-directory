...
------------ | ------------- | ------------- | -------------
**code** | **int** | Health Code | [optional] [readonly] 
**message** | **str** | Health Message | [optional] [readonly] 
**recommendations** | **List[str]** | Health Recommended Actions | [optional] [readonly] 
**title** | **str** | Health Title | [optional] [readonly] 
