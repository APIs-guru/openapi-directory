...
------------ | ------------- | ------------- | -------------
**backup_management_type** | **str** | This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types. | 
**protected_items_count** | **int** | Number of items associated with this policy. | [optional] 
