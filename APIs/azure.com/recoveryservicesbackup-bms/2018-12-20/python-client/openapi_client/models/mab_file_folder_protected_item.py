...
class MabFileFolderProtectedItem(ProtectedItem):
    ...
    deferred_delete_sync_time_in_utc: Optional[StrictInt] = Field(default=None, description="Sync time for deferred deletion in UTC", alias="deferredDeleteSyncTimeInUTC")
