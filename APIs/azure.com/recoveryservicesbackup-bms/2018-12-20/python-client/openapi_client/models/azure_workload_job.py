...
class AzureWorkloadJob(Job):
    ...
    error_details: Optional[List[AzureWorkloadErrorInfo]] = Field(default=None, description="Error details on execution of this job.", alias="errorDetails")
    extended_info: Optional[AzureWorkloadJobExtendedInfo] = Field(default=None, alias="extendedInfo")
    workload_type: Optional[StrictStr] = Field(default=None, description="Workload type of the job", alias="workloadType")
