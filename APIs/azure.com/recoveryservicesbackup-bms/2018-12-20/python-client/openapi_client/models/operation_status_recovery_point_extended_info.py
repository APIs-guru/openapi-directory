...
class OperationStatusRecoveryPointExtendedInfo(OperationStatusExtendedInfo):
    ...
    """ # noqa: E501
    deleted_backup_item_version: Optional[StrictStr] = Field(default=None, description="In case the share is in soft-deleted state, populate this field with deleted backup item", alias="deletedBackupItemVersion")
    updated_recovery_point: Optional[RecoveryPoint] = Field(default=None, alias="updatedRecoveryPoint")
