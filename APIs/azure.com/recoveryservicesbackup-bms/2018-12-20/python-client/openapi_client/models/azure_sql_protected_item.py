...
class AzureSqlProtectedItem(ProtectedItem):
    ...
    protected_item_data_id: Optional[StrictStr] = Field(default=None, description="Internal ID of a backup item. Used by Azure SQL Backup engine to contact Recovery Services.", alias="protectedItemDataId")
    protection_state: Optional[StrictStr] = Field(default=None, description="Backup state of the backed up item.", alias="protectionState")
