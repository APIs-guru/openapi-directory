...
class AADProperties(BaseModel):
    ...
    service_principal_client_id: Optional[StrictStr] = Field(default=None, alias="servicePrincipalClientId")
    service_principal_object_id: Optional[StrictStr] = Field(default=None, alias="servicePrincipalObjectId")
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    __properties: ClassVar[List[str]] = ["audience", "authority", "servicePrincipalClientId", "servicePrincipalObjectId", "tenantId"]
