...
class RecoveryPointsApi:
    ...
    @validate_call
    def recovery_points_get_access_token(
        self,
        ...
        protected_item_name: Annotated[StrictStr, Field(description="Name of the Protected Item.")],
        recovery_point_id: Annotated[StrictStr, Field(description="Recovery Point Id")],
        ...
        _param = self._recovery_points_get_access_token_serialize(
    ...
    @validate_call
    def recovery_points_get_access_token_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CrrAccessTokenResource]:
        """Returns the Access token for communication between BMS and Protection service
    ...
    @validate_call
    def recovery_points_get_access_token_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _recovery_points_get_access_token_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/accessToken',
