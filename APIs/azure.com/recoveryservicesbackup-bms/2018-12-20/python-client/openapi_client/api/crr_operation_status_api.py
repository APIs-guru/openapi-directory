...
class CrrOperationStatusApi:
    ...
    def crr_operation_status_get(
        ...
        _param = self._crr_operation_status_get_serialize(
    ...
    @validate_call
    def crr_operation_status_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        azure_region: Annotated[StrictStr, Field(description="Azure region to hit Api")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
    ...
    @validate_call
    def crr_operation_status_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        azure_region: Annotated[StrictStr, Field(description="Azure region to hit Api")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
    ...
    def _crr_operation_status_get_serialize(
        self,
        api_version,
        azure_region,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupCrrOperationsStatus/{operationId}',
