...
class BackupCrrJobsApi:
    ...
    def backup_crr_jobs_list(
        ...
        _param = self._backup_crr_jobs_list_serialize(
    ...
    @validate_call
    def backup_crr_jobs_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        azure_region: Annotated[StrictStr, Field(description="Azure region to hit Api")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
    ...
    @validate_call
    def backup_crr_jobs_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        azure_region: Annotated[StrictStr, Field(description="Azure region to hit Api")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
    ...
    def _backup_crr_jobs_list_serialize(
        self,
        api_version,
        azure_region,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupCrrJobs',
