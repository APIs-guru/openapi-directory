...
class TestProtectedItemResourceList(unittest.TestCase):
    """ProtectedItemResourceList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectedItemResourceList:
        """Test ProtectedItemResourceList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectedItemResourceList`
        """
        model = ProtectedItemResourceList()
        if include_optional:
            return ProtectedItemResourceList(
                value = [
                    openapi_client.models.protected_item_resource.ProtectedItemResource(
    ...
    def testProtectedItemResourceList(self):
        """Test ProtectedItemResourceList"""
