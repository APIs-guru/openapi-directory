...
class ApplicationInsightsComponentAvailableFeatures(BaseModel):
    """
    An Application Insights component available features.
    """ # noqa: E501
    result: Optional[List[ApplicationInsightsComponentFeature]] = Field(default=None, description="A list of Application Insights component feature.", alias="Result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Result": [ApplicationInsightsComponentFeature.from_dict(_item) for _item in obj["Result"]] if obj.get("Result") is not None else None
        })
        return _obj
