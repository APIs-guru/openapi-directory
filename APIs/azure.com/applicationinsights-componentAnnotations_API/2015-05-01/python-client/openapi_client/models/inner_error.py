...
class InnerError(BaseModel):
    ...
    Inner error
    """ # noqa: E501
    diagnosticcontext: Optional[StrictStr] = Field(default=None, description="Provides correlation for request")
    time: Optional[datetime] = Field(default=None, description="Request time")
    __properties: ClassVar[List[str]] = ["diagnosticcontext", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "diagnosticcontext": obj.get("diagnosticcontext"),
            "time": obj.get("time")
        })
        return _obj
