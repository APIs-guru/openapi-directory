...
class AnnotationsListResult(BaseModel):
    """
    Annotations list result.
    """ # noqa: E501
    value: Optional[List[Annotation]] = Field(default=None, description="An array of annotations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Annotation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
