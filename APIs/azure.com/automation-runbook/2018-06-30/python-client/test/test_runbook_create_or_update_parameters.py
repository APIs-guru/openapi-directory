...
class TestRunbookCreateOrUpdateParameters(unittest.TestCase):
    """RunbookCreateOrUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunbookCreateOrUpdateParameters:
        """Test RunbookCreateOrUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunbookCreateOrUpdateParameters`
        """
        model = RunbookCreateOrUpdateParameters()
        if include_optional:
            return RunbookCreateOrUpdateParameters(
                location = '',
                name = '',
                properties = openapi_client.models.runbook_create_or_update_properties.RunbookCreateOrUpdateProperties(
                    description = '', 
    ...
    def testRunbookCreateOrUpdateParameters(self):
        """Test RunbookCreateOrUpdateParameters"""
