...
class TestRunbookCreateOrUpdateProperties(unittest.TestCase):
    """RunbookCreateOrUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunbookCreateOrUpdateProperties:
        """Test RunbookCreateOrUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunbookCreateOrUpdateProperties`
        """
        model = RunbookCreateOrUpdateProperties()
        if include_optional:
            return RunbookCreateOrUpdateProperties(
                description = '',
    ...
    def testRunbookCreateOrUpdateProperties(self):
        """Test RunbookCreateOrUpdateProperties"""
