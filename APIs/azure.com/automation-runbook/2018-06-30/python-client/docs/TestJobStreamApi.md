...
> JobStream test_job_streams_get(subscription_id, resource_group_name, automation_account_name, runbook_name, job_stream_id, api_version)
...
> JobStreamListResult test_job_streams_list_by_test_job(subscription_id, resource_group_name, automation_account_name, runbook_name, api_version, filter=filter)
