...
class RunbookListResult(BaseModel):
    """
    ...
    value: Optional[List[Runbook]] = Field(default=None, description="Gets or sets a list of runbooks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Runbook.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
