...
class RunbookCreateOrUpdateDraftParameters(BaseModel):
    """
    The parameters supplied to the create or update runbook operation.
    """ # noqa: E501
    runbook_content: StrictStr = Field(description="Content of the Runbook.", alias="runbookContent")
    __properties: ClassVar[List[str]] = ["runbookContent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runbookContent": obj.get("runbookContent")
        })
        return _obj
