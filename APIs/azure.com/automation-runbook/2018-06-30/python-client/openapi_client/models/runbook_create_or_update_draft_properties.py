...
class RunbookCreateOrUpdateDraftProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "draft", "logActivityTrace", "logProgress", "logVerbose", "runbookType"]
