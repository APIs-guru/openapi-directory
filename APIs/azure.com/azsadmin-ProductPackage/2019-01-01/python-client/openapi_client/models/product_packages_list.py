...
class ProductPackagesList(BaseModel):
    """
    List of product packages.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Continuation Token.", alias="nextLink")
    value: Optional[List[ProductPackage]] = Field(default=None, description="List of product packages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ProductPackage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
