...
------------ | ------------- | ------------- | -------------
**post_parameter_key** | **str** | Post parameter key. | [optional] [readonly] 
**post_parameter_value** | **str** | Post parameter value. Client should use &#39;application/x-www-form-urlencoded&#39; encoding for this value. | [optional] [readonly] 
**url** | **str** | URL where the single sign-on request is to be made. | [optional] [readonly] 
