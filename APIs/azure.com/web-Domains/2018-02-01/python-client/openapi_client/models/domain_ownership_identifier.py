...
class DomainOwnershipIdentifier(BaseModel):
    """
    Domain ownership Identifier.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="DomainOwnershipIdentifier resource specific properties")
