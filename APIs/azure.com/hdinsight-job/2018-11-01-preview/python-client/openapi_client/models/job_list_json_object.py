...
class JobListJsonObject(BaseModel):
    """
    The List Job operation response.
    """ # noqa: E501
    detail: Optional[JobDetailRootJsonObject] = None
    id: Optional[StrictStr] = Field(default=None, description="The Id of the job.")
    __properties: ClassVar[List[str]] = ["detail", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": JobDetailRootJsonObject.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
            "id": obj.get("id")
        })
        return _obj
