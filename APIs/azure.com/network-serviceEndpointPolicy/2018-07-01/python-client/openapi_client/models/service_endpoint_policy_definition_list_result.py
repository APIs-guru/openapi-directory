...
class ServiceEndpointPolicyDefinitionListResult(BaseModel):
    """
    ...
    value: Optional[List[ServiceEndpointPolicyDefinition]] = Field(default=None, description="The service endpoint policy definition in a service endpoint policy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ServiceEndpointPolicyDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
