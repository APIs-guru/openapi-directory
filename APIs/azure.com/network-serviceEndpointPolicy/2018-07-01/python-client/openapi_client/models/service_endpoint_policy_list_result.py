...
class ServiceEndpointPolicyListResult(BaseModel):
    """
    ...
    value: Optional[List[ServiceEndpointPolicy]] = Field(default=None, description="A list of ServiceEndpointPolicy resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ServiceEndpointPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
