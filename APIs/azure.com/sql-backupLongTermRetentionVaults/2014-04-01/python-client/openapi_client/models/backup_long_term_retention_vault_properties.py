...
class BackupLongTermRetentionVaultProperties(BaseModel):
    """
    The properties of a backup long term retention vault.
    """ # noqa: E501
    recovery_services_vault_resource_id: StrictStr = Field(description="The azure recovery services vault resource id", alias="recoveryServicesVaultResourceId")
    __properties: ClassVar[List[str]] = ["recoveryServicesVaultResourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoveryServicesVaultResourceId": obj.get("recoveryServicesVaultResourceId")
        })
        return _obj
