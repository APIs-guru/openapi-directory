...
class BackupLongTermRetentionVaultListResult(BaseModel):
    """
    Represents the response to a list vaults request.
    """ # noqa: E501
    value: List[BackupLongTermRetentionVault] = Field(description="The list of vaults in the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BackupLongTermRetentionVault.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
