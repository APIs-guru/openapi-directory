...
class GCApi:
    ...
    @validate_call
    def farms_get_garbage_collection_state(
        self,
        ...
        _param = self._farms_get_garbage_collection_state_serialize(
    ...
    @validate_call
    def farms_get_garbage_collection_state_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        farm_id: Annotated[StrictStr, Field(description="Farm Id.")],
    ...
    @validate_call
    def farms_get_garbage_collection_state_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        farm_id: Annotated[StrictStr, Field(description="Farm Id.")],
    ...
    def _farms_get_garbage_collection_state_serialize(
        self,
        subscription_id,
        resource_group_name,
        farm_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/operationresults/{operationId}',
