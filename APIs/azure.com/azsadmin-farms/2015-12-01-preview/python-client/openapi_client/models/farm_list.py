...
class FarmList(BaseModel):
    ...
    value: Optional[List[Farm]] = Field(default=None, description="List of storage farms.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Farm.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
