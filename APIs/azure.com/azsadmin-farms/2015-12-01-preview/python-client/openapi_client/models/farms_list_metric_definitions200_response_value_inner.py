...
class FarmsListMetricDefinitions200ResponseValueInner(BaseModel):
    """
    Metric definition.
    """ # noqa: E501
    metric_availabilities: Optional[List[FarmsListMetricDefinitions200ResponseValueInnerMetricAvailabilitiesInner]] = Field(default=None, description="Metric availabilities.", alias="metricAvailabilities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metricAvailabilities": [FarmsListMetricDefinitions200ResponseValueInnerMetricAvailabilitiesInner.from_dict(_item) for _item in obj["metricAvailabilities"]] if obj.get("metricAvailabilities") is not None else None,
