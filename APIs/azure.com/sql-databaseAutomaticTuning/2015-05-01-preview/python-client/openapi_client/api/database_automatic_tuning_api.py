...
class DatabaseAutomaticTuningApi:
    ...
    @validate_call
    def database_automatic_tuning_get(
        self,
        ...
        _param = self._database_automatic_tuning_get_serialize(
    ...
    @validate_call
    def database_automatic_tuning_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatabaseAutomaticTuning]:
        """database_automatic_tuning_get
    ...
    @validate_call
    def database_automatic_tuning_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _database_automatic_tuning_get_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/automaticTuning/current',
    ...
    @validate_call
    def database_automatic_tuning_update(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        parameters: Annotated[DatabaseAutomaticTuning, Field(description="The requested automatic tuning resource state.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: DatabaseAutomaticTuning
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._database_automatic_tuning_update_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            database_name=database_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def database_automatic_tuning_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def database_automatic_tuning_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _database_automatic_tuning_update_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
