...
class ScaleUnitNodeList(BaseModel):
    """
    ...
    value: Optional[List[ScaleUnitNode]] = Field(default=None, description="List of scale unit nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ScaleUnitNode.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
