...
class FabricLocationsApi:
    ...
    def fabric_locations_get(
        ...
        fabric_location: Annotated[StrictStr, Field(description="Fabric location.")],
        ...
        :param fabric_location: Fabric location. (required)
        ...
        _param = self._fabric_locations_get_serialize(
    ...
    @validate_call
    def fabric_locations_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        fabric_location: Annotated[StrictStr, Field(description="Fabric location.")],
    ...
    @validate_call
    def fabric_locations_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        fabric_location: Annotated[StrictStr, Field(description="Fabric location.")],
    ...
    def _fabric_locations_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        fabric_location,
        ...
        if fabric_location is not None:
            _path_params['fabricLocation'] = fabric_location
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{fabricLocation}',
    ...
    def fabric_locations_list(
        ...
        _param = self._fabric_locations_list_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            api_version=api_version,
            filter=filter,
    ...
    @validate_call
    def fabric_locations_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        api_version: Annotated[StrictStr, Field(description="Client API Version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FabricLocationList]:
        """fabric_locations_list
    ...
    @validate_call
    def fabric_locations_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[StrictStr, Field(description="Name of the resource group.")],
        api_version: Annotated[StrictStr, Field(description="Client API Version.")],
    ...
    def _fabric_locations_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
