...
class CertificateApi:
    ...
    def certificate_create_or_update(
        ...
        parameters: Annotated[CertificateCreateOrUpdateRequest, Field(description="Create or Update parameters.")],
        ...
        :type parameters: CertificateCreateOrUpdateRequest
    ...
    def certificate_list_by_service(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CertificateListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def certificate_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CertificateListByService200Response]:
        """certificate_list_by_service
