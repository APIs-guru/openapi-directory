...
class CertificateCreateOrUpdateRequest(BaseModel):
    """
    Certificate create or update details.
    """ # noqa: E501
    properties: Optional[CertificateCreateOrUpdateRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": CertificateCreateOrUpdateRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
