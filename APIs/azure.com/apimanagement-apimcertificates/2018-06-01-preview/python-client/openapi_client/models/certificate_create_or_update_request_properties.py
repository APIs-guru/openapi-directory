...
class CertificateCreateOrUpdateRequestProperties(BaseModel):
    """
    Parameters supplied to the CreateOrUpdate certificate operation.
    """ # noqa: E501
    data: StrictStr = Field(description="Base 64 encoded certificate using the application/x-pkcs12 representation.")
    password: StrictStr = Field(description="Password for the Certificate")
    __properties: ClassVar[List[str]] = ["data", "password"]
