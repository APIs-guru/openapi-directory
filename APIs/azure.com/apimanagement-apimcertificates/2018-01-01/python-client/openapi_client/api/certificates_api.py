...
class CertificatesApi:
    ...
    @validate_call
    def certificate_create_or_update(
        self,
        ...
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
        ...
        parameters: Annotated[CertificateCreateOrUpdateParameters, Field(description="Create or Update parameters.")],
        ...
        _param = self._certificate_create_or_update_serialize(
    ...
    @validate_call
    def certificate_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def certificate_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
    ...
    def _certificate_create_or_update_serialize(
        self,
        resource_group_name,
        service_name,
        certificate_id,
    ...
    @validate_call
    def certificate_get_entity_tag(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
        ...
        _param = self._certificate_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            certificate_id=certificate_id,
            api_version=api_version,
    ...
    @validate_call
    def certificate_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def certificate_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        certificate_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the certificate entity. Must be unique in the current API Management service instance.")],
    ...
    def _certificate_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        certificate_id,
    ...
    @validate_call
    def certificate_list_by_service(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        ...
        _param = self._certificate_list_by_service_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def certificate_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    @validate_call
    def certificate_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _certificate_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
