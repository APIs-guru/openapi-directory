...
class GetBitLockerKeysResponse(BaseModel):
    """
    GetBitLockerKeys response
    """ # noqa: E501
    value: Optional[List[DriveBitLockerKey]] = Field(default=None, description="drive status")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DriveBitLockerKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
