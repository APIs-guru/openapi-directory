...
class ReturnAddress(BaseModel):
    ...
    email: StrictStr = Field(description="Email address of the recipient of the returned drives.")
    phone: StrictStr = Field(description="Phone number of the recipient of the returned drives.")
    ...
    state_or_province: Optional[StrictStr] = Field(default=None, description="The state or province to use when returning the drives.", alias="stateOrProvince")
    ...
    __properties: ClassVar[List[str]] = ["city", "countryOrRegion", "email", "phone", "postalCode", "recipientName", "stateOrProvince", "streetAddress1", "streetAddress2"]
