...
class ListJobsResponse(BaseModel):
    ...
    List jobs response
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="link to next batch of jobs", alias="nextLink")
    value: Optional[List[JobResponse]] = Field(default=None, description="Job list")
