...
class TestUpdateJobParametersProperties(unittest.TestCase):
    """UpdateJobParametersProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateJobParametersProperties:
        """Test UpdateJobParametersProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateJobParametersProperties`
        """
        model = UpdateJobParametersProperties()
        if include_optional:
            return UpdateJobParametersProperties(
    ...
    def testUpdateJobParametersProperties(self):
        """Test UpdateJobParametersProperties"""
