...
**operation** | **str** | The display name of the operation. | [optional] 
**provider** | **str** | The resource provider name to which the operation belongs. | [optional] 
**resource** | **str** | The name of the resource to which the operation belongs. | [optional] 
