...
class FailoverElasticPoolsApi:
    ...
    def elastic_pools_failover(
        ...
        elastic_pool_name: Annotated[StrictStr, Field(description="The name of the elastic pool to failover.")],
        ...
        _param = self._elastic_pools_failover_serialize(
    ...
    @validate_call
    def elastic_pools_failover_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: Annotated[StrictStr, Field(description="The name of the elastic pool to failover.")],
    ...
    @validate_call
    def elastic_pools_failover_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: Annotated[StrictStr, Field(description="The name of the elastic pool to failover.")],
    ...
    def _elastic_pools_failover_serialize(
        self,
        resource_group_name,
        server_name,
        elastic_pool_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/failover',
