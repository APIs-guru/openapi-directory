...
class OperationResultContract(BaseModel):
    ...
    Operation Result.
    """ # noqa: E501
    action_log: Optional[List[OperationResultLogItemContract]] = Field(default=None, description="This property if only provided as part of the TenantConfiguration_Validate operation. It contains the log the entities which will be updated/created/deleted as part of the TenantConfiguration_Deploy operation.", alias="actionLog")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionLog": [OperationResultLogItemContract.from_dict(_item) for _item in obj["actionLog"]] if obj.get("actionLog") is not None else None,
