...
> TenantConfigurationSyncStateContract tenant_configuration_get_sync_state(resource_group_name, service_name, api_version, subscription_id, configuration_name)
