...
tenant_configuration_sync_state_contract_instance = TenantConfigurationSyncStateContract.from_json(json)
# print the JSON string representation of the object
print(TenantConfigurationSyncStateContract.to_json())

# convert the object into a dict
tenant_configuration_sync_state_contract_dict = tenant_configuration_sync_state_contract_instance.to_dict()
# create an instance of TenantConfigurationSyncStateContract from a dict
tenant_configuration_sync_state_contract_from_dict = TenantConfigurationSyncStateContract.from_dict(tenant_configuration_sync_state_contract_dict)
```
