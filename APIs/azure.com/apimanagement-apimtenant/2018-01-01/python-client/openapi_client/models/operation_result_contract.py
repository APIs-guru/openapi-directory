...
class OperationResultContract(BaseModel):
    ...
    error: Optional[TenantAccessUpdateDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": TenantAccessUpdateDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "id": obj.get("id"),
