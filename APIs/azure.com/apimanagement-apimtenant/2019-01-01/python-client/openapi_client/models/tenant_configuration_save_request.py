...
class TenantConfigurationSaveRequest(BaseModel):
    """
    Save Tenant Configuration Contract details.
    """ # noqa: E501
    properties: Optional[TenantConfigurationSaveRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TenantConfigurationSaveRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
