...
class TenantAccessUpdateRequestProperties(BaseModel):
    """
    Tenant access information update parameters of the API Management service
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Determines whether direct access is enabled.")
