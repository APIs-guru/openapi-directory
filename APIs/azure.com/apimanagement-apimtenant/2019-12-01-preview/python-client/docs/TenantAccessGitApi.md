...
[**tenant_access_git_list_secrets**](TenantAccessGitApi.md#tenant_access_git_list_secrets) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/tenant/{accessName}/git/listSecrets | 
...
> TenantAccessGet200Response tenant_access_git_list_secrets(resource_group_name, service_name, api_version, subscription_id, access_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.tenant_access_git_list_secrets(resource_group_name, service_name, api_version, subscription_id, access_name)
        print("The response of TenantAccessGitApi->tenant_access_git_list_secrets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TenantAccessGitApi->tenant_access_git_list_secrets: %s\n" % e)
```
