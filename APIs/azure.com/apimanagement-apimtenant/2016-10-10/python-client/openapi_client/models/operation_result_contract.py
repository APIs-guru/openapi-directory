...
class OperationResultContract(BaseModel):
    """
    Operation Result.
    """ # noqa: E501
    error: Optional[TenantAccessUpdateDefaultResponse] = None
    ...
    __properties: ClassVar[List[str]] = ["error", "id", "resultInfo", "started", "status", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": TenantAccessUpdateDefaultResponse.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "id": obj.get("id"),
