...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BackupApi->operations_list:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BackupApi->operations_list: %s\n" % e)
...
------------ | ------------- | ------------- | -------------
*BackupApi* | [**operations_list**](docs/BackupApi.md#operations_list) | **GET** /providers/Microsoft.Backup.Admin/operations | 
