...
class ProxyApi:
    ...
    def check_name_availability_local(
        ...
        location: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The location in which uniqueness will be verified.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        check_name_availability: Annotated[CheckNameAvailabilityRequest, Field(description="Check Name Availability Request.")],
        ...
        :type check_name_availability: CheckNameAvailabilityRequest
        ...
        _param = self._check_name_availability_local_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CheckNameAvailabilityResponse",
        }
    ...
    @validate_call
    def check_name_availability_local_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription ID.")],
        location: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The location in which uniqueness will be verified.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckNameAvailabilityResponse]:
        """check_name_availability_local
    ...
    @validate_call
    def check_name_availability_local_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription ID.")],
        location: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The location in which uniqueness will be verified.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _check_name_availability_local_serialize(
        self,
        subscription_id,
        location,
        api_version,
        ...
        if check_name_availability is not None:
            _body_params = check_name_availability
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.MixedReality/locations/{location}/checkNameAvailability',
    ...
    def _operations_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.MixedReality/operations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
