...
class ComponentPurgeResponse(BaseModel):
    """
    Response containing operationId for a specific purge action.
    """ # noqa: E501
    operation_id: StrictStr = Field(description="Id to use when querying for status for a particular purge operation.", alias="operationId")
