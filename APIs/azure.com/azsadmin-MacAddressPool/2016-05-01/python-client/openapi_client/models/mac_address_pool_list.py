...
class MacAddressPoolList(BaseModel):
    """
    ...
    value: Optional[List[MacAddressPool]] = Field(default=None, description="List of MAC address pools.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MacAddressPool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
