...
class AvailableServiceAliasesResult(BaseModel):
    """
    ...
    value: Optional[List[AvailableServiceAlias]] = Field(default=None, description="An array of available service aliases.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AvailableServiceAlias.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
