...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[Operation]] = Field(default=None, description="List of Customer Insights operations supported by the Microsoft.CustomerInsights resource provider.")
