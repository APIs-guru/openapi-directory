...
class CrmConnectorEntities(BaseModel):
    """
    ...
    is_profile: Optional[StrictBool] = Field(default=None, description="Indicating whether this is profile.", alias="isProfile")
    logical_name: StrictStr = Field(description="The logical name.", alias="logicalName")
    __properties: ClassVar[List[str]] = ["displayName", "isProfile", "logicalName"]
