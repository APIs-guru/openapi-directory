...
**value** | [**List[Operation]**](Operation.md) | List of Customer Insights operations supported by the Microsoft.CustomerInsights resource provider. | [optional] [readonly] 
