...
**profile_property_references** | [**List[ParticipantProfilePropertyReference]**](ParticipantProfilePropertyReference.md) | The property references for the profile type. | [optional] [readonly] 
**related_profile_name** | **str** | The related profile. | [optional] [readonly] 
**related_profile_property_references** | [**List[ParticipantProfilePropertyReference]**](ParticipantProfilePropertyReference.md) | The property references for the related profile type. | [optional] [readonly] 
