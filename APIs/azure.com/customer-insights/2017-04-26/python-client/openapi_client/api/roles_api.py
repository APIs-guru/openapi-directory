...
class RolesApi:
    ...
    def roles_list_by_hub(
        ...
        _param = self._roles_list_by_hub_serialize(
    ...
    @validate_call
    def roles_list_by_hub_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        hub_name: Annotated[StrictStr, Field(description="The name of the hub.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    @validate_call
    def roles_list_by_hub_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        hub_name: Annotated[StrictStr, Field(description="The name of the hub.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _roles_list_by_hub_serialize(
        self,
        resource_group_name,
        hub_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/roles',
