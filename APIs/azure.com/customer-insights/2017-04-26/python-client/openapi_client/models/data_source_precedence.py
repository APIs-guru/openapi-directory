...
class DataSourcePrecedence(BaseModel):
    """
    ...
    precedence: Optional[StrictInt] = Field(default=None, description="the precedence value.")
    __properties: ClassVar[List[str]] = ["dataSource", "precedence"]
