...
class PredictionListResult(BaseModel):
    """
    ...
    value: Optional[List[PredictionResourceFormat]] = Field(default=None, description="Results of the list operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PredictionResourceFormat.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
