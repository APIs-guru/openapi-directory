...
class LinkDefinition(BaseModel):
    ...
    source_entity_type: StrictStr = Field(description="Type of source entity.", alias="sourceEntityType")
    source_entity_type_name: StrictStr = Field(description="Name of the source Entity Type.", alias="sourceEntityTypeName")
    target_entity_type: StrictStr = Field(description="Type of target entity.", alias="targetEntityType")
    target_entity_type_name: StrictStr = Field(description="Name of the target Entity Type.", alias="targetEntityTypeName")
    tenant_id: Optional[StrictStr] = Field(default=None, description="The hub name.", alias="tenantId")
    __properties: ClassVar[List[str]] = ["description", "displayName", "linkName", "mappings", "operationType", "participantPropertyReferences", "provisioningState", "referenceOnly", "sourceEntityType", "sourceEntityTypeName", "targetEntityType", "targetEntityTypeName", "tenantId"]
    ...
    def source_entity_type_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def target_entity_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['None', 'Profile', 'Interaction', 'Relationship']):
            raise ValueError("must be one of enum values ('None', 'Profile', 'Interaction', 'Relationship')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourceEntityType": obj.get("sourceEntityType"),
            "sourceEntityTypeName": obj.get("sourceEntityTypeName"),
            "targetEntityType": obj.get("targetEntityType"),
            "targetEntityTypeName": obj.get("targetEntityTypeName"),
