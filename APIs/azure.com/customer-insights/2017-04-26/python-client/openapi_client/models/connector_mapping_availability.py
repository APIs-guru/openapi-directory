...
class ConnectorMappingAvailability(BaseModel):
    """
    Connector mapping property availability.
    """ # noqa: E501
    frequency: Optional[StrictStr] = Field(default=None, description="The frequency to update.")
    interval: StrictInt = Field(description="The interval of the given frequency to use.")
