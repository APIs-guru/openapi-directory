...
class KpiGroupByMetadata(BaseModel):
    """
    The KPI GroupBy field metadata.
    """ # noqa: E501
    display_name: Optional[Dict[str, StrictStr]] = Field(default=None, description="The display name.", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "fieldName", "fieldType"]
