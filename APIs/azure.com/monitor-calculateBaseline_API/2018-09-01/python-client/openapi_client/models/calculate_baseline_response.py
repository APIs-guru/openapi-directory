...
class CalculateBaselineResponse(BaseModel):
    ...
    """ # noqa: E501
    baseline: List[Baseline] = Field(description="The baseline values for each sensitivity.")
    timestamps: Optional[List[datetime]] = Field(default=None, description="The array of timestamps of the baselines.")
    type: StrictStr = Field(description="The resource type of the baseline resource.")
    __properties: ClassVar[List[str]] = ["baseline", "timestamps", "type"]
