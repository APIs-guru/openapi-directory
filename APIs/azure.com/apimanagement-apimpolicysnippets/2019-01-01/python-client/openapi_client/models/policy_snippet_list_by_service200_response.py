...
class PolicySnippetListByService200Response(BaseModel):
    """
    The response of the list policy snippets operation.
    """ # noqa: E501
    value: Optional[List[PolicySnippetListByService200ResponseValueInner]] = Field(default=None, description="Policy snippet value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PolicySnippetListByService200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
