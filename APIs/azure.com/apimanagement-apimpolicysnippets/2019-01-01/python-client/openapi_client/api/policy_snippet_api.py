...
class PolicySnippetApi:
    ...
    @validate_call
    def policy_snippet_list_by_service(
        self,
        ...
        _param = self._policy_snippet_list_by_service_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PolicySnippetListByService200Response",
        }
    ...
    @validate_call
    def policy_snippet_list_by_service_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PolicySnippetListByService200Response]:
        """policy_snippet_list_by_service
    ...
    @validate_call
    def policy_snippet_list_by_service_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
    ...
    def _policy_snippet_list_by_service_serialize(
        self,
        resource_group_name,
        service_name,
        api_version,
