...
**meter_id** | **str** | Unique ID for the resource that was consumed, for example, the Resource ID. | [optional] 
...
**usage_end_time** | **datetime** | UTC end time for the usage category to which this usage aggregate belongs. | [optional] 
**usage_start_time** | **datetime** | UTC start time for the usage category to which this usage aggregate belongs. | [optional] 
