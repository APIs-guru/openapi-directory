...
class TestExtensionDefinition(unittest.TestCase):
    """ExtensionDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtensionDefinition:
        """Test ExtensionDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtensionDefinition`
        """
        ...
        if include_optional:
            return ExtensionDefinition(
                ...
                resource_access = openapi_client.models.resource_access_list.ResourceAccessList(
                    next_link = '', 
                    value = [
                        openapi_client.models.resource_access.ResourceAccess(
                            name = '', 
                            resource = '', )
                        ], ),
                uri = ''
    ...
    def testExtensionDefinition(self):
        """Test ExtensionDefinition"""
