...
class LinkedOperationRuleList(BaseModel):
    """
    ...
    value: Optional[List[LinkedOperationRule]] = Field(default=None, description="List of the linked operation rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LinkedOperationRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
