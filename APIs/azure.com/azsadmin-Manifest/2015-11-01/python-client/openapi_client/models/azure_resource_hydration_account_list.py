...
class AzureResourceHydrationAccountList(BaseModel):
    """
    ...
    value: Optional[List[AzureResourceHydrationAccount]] = Field(default=None, description="List of the resource hydration accounts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AzureResourceHydrationAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
