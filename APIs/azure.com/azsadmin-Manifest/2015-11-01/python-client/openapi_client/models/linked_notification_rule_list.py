...
class LinkedNotificationRuleList(BaseModel):
    """
    ...
    value: Optional[List[LinkedNotificationRule]] = Field(default=None, description="List of the linked notification rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LinkedNotificationRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
