...
class AuthorizationActionMappingList(BaseModel):
    """
    List of the read-only actions.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI to next page.", alias="nextLink")
    value: Optional[List[AuthorizationActionMapping]] = Field(default=None, description="List of the read-only actions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AuthorizationActionMapping.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
