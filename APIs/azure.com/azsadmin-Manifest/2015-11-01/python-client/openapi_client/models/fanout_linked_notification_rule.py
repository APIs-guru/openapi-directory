...
class FanoutLinkedNotificationRule(BaseModel):
    """
    The fan-out linked notification rule.
    """ # noqa: E501
    actions: Optional[List[StrictStr]] = Field(default=None, description="The list of actions.")
    endpoints: Optional[ResourceProviderEndpointList] = None
    __properties: ClassVar[List[str]] = ["actions", "endpoints"]
