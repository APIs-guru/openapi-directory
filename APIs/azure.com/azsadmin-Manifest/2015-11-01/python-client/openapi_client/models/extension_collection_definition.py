...
class ExtensionCollectionDefinition(BaseModel):
    """
    The manifest extension collection definition.
    """ # noqa: E501
    extensions: Optional[ExtensionList] = None
    version: Optional[StrictStr] = Field(default=None, description="The version of the format a.b[.c[.d]]. see System.Version documentation for more details.")
    __properties: ClassVar[List[str]] = ["extensions", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extensions": ExtensionList.from_dict(obj["extensions"]) if obj.get("extensions") is not None else None,
