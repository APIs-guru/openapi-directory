...
class ResourceProviderEndpointList(BaseModel):
    """
    ...
    value: Optional[List[ResourceProviderEndpoint]] = Field(default=None, description="List of the resource provider endpoints.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceProviderEndpoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
