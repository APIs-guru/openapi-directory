...
class SubscriptionDefinitionList(BaseModel):
    """
    ...
    value: Optional[List[SubscriptionDefinition]] = Field(default=None, description="An array of subscriptionDefinitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SubscriptionDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
