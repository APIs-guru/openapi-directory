...
class ExpressRouteConnectionList(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[ExpressRouteConnection]] = Field(default=None, description="The list of ExpressRoute connections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ExpressRouteConnection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
