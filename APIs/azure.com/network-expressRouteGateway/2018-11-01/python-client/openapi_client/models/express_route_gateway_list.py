...
class ExpressRouteGatewayList(BaseModel):
    """
    List of ExpressRoute gateways.
    """ # noqa: E501
    value: Optional[List[ExpressRouteGateway]] = Field(default=None, description="List of ExpressRoute gateways.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ExpressRouteGateway.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
