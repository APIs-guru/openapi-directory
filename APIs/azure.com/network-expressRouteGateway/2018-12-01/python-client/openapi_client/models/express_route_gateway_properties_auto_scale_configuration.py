...
class ExpressRouteGatewayPropertiesAutoScaleConfiguration(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bounds": ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds.from_dict(obj["bounds"]) if obj.get("bounds") is not None else None
        })
        return _obj
