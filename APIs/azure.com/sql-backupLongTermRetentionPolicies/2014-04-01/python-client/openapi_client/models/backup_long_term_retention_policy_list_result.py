...
class BackupLongTermRetentionPolicyListResult(BaseModel):
    """
    Represents the response to a list long-term retention policies request.
    """ # noqa: E501
    value: List[BackupLongTermRetentionPolicy] = Field(description="The list of long-term retention policies in the database.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BackupLongTermRetentionPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
