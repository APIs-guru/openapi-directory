...
class RouteFilterRuleListResult(BaseModel):
    """
    ...
    value: Optional[List[RouteFilterRule]] = Field(default=None, description="Gets a list of RouteFilterRules in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RouteFilterRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
