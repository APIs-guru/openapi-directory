...
class MediaGraphRtspSource(MediaGraphSource):
    ...
    RTSP source
    """ # noqa: E501
    credentials: Optional[MediaGraphUserCredentials] = None
    rtsp_url: StrictStr = Field(description="RTSP URL", alias="rtspUrl")
    __properties: ClassVar[List[str]] = ["@odata.type", "name"]
