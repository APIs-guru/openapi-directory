...
class TestReplicationLinkProperties(unittest.TestCase):
    """ReplicationLinkProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplicationLinkProperties:
        """Test ReplicationLinkProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplicationLinkProperties`
        """
    ...
    def testReplicationLinkProperties(self):
        """Test ReplicationLinkProperties"""
