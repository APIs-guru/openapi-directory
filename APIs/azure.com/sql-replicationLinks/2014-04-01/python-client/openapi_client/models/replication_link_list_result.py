...
class ReplicationLinkListResult(BaseModel):
    """
    Represents the response to a List database replication link request.
    """ # noqa: E501
    value: Optional[List[ReplicationLink]] = Field(default=None, description="The list of database replication links housed in the database.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ReplicationLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
