...
class ReplicationLink(BaseModel):
    """
    Represents a database replication link.
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Location of the server that contains this firewall rule.")
    properties: Optional[ReplicationLinkProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Type of resource this is.")
