# openapi_client.SoftwareUpdateConfigurationMachineRunApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**software_update_configuration_machine_runs_get_by_id**](SoftwareUpdateConfigurationMachineRunApi.md#software_update_configuration_machine_runs_get_by_id) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/softwareUpdateConfigurationMachineRuns/{softwareUpdateConfigurationMachineRunId} | 
[**software_update_configuration_machine_runs_list**](SoftwareUpdateConfigurationMachineRunApi.md#software_update_configuration_machine_runs_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/softwareUpdateConfigurationMachineRuns | 


# **software_update_configuration_machine_runs_get_by_id**
> SoftwareUpdateConfigurationMachineRun software_update_configuration_machine_runs_get_by_id(subscription_id, resource_group_name, automation_account_name, software_update_configuration_machine_run_id, api_version, client_request_id=client_request_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoftwareUpdateConfigurationMachineRunApi(api_client)
    ...
    software_update_configuration_machine_run_id = 'software_update_configuration_machine_run_id_example' # str | The Id of the software update configuration machine run.
    api_version = 'api_version_example' # str | Client Api Version.
    client_request_id = 'client_request_id_example' # str | Identifies this specific client request. (optional)

    try:
        api_response = api_instance.software_update_configuration_machine_runs_get_by_id(subscription_id, resource_group_name, automation_account_name, software_update_configuration_machine_run_id, api_version, client_request_id=client_request_id)
        print("The response of SoftwareUpdateConfigurationMachineRunApi->software_update_configuration_machine_runs_get_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoftwareUpdateConfigurationMachineRunApi->software_update_configuration_machine_runs_get_by_id: %s\n" % e)
```
...
> SoftwareUpdateConfigurationMachineRunListResult software_update_configuration_machine_runs_list(subscription_id, resource_group_name, automation_account_name, api_version, client_request_id=client_request_id, filter=filter, skip=skip, top=top)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.software_update_configuration_machine_runs_list(subscription_id, resource_group_name, automation_account_name, api_version, client_request_id=client_request_id, filter=filter, skip=skip, top=top)
        print("The response of SoftwareUpdateConfigurationMachineRunApi->software_update_configuration_machine_runs_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoftwareUpdateConfigurationMachineRunApi->software_update_configuration_machine_runs_list: %s\n" % e)
```
