...
class SoftwareUpdateConfigurationMachineRunListResult(BaseModel):
    """
    result of listing all software update configuration machine runs
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="link to next page of results.", alias="nextLink")
    value: Optional[List[SoftwareUpdateConfigurationMachineRun]] = Field(default=None, description="outer object returned when listing all software update configuration machine runs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SoftwareUpdateConfigurationMachineRun.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
