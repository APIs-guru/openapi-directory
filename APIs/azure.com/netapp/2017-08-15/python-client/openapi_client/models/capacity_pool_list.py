...
class CapacityPoolList(BaseModel):
    """
    List of capacity pool resources
    """ # noqa: E501
    value: Optional[List[CapacityPool]] = Field(default=None, description="List of Capacity pools")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [CapacityPool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
