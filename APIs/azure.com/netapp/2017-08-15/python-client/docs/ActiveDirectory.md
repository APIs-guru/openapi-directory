...
**d_ns** | **str** | Comma separated list of DNS server IP addresses for the Active Directory domain | [optional] 
...
**s_mb_server_name** | **str** | NetBIOS name of the SMB server. This name will be registered as a computer account in the AD and used to mount volumes | [optional] 
