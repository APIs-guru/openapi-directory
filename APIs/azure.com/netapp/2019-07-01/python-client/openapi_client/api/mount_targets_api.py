...
class MountTargetsApi:
    ...
    def mount_targets_list(
        ...
        _param = self._mount_targets_list_serialize(
    ...
    @validate_call
    def mount_targets_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the NetApp account")],
    ...
    @validate_call
    def mount_targets_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the NetApp account")],
    ...
    def _mount_targets_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        account_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/mountTargets',
