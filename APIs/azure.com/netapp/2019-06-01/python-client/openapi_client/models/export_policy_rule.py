...
class ExportPolicyRule(BaseModel):
    ...
    nfsv4: Optional[StrictBool] = Field(default=None, description="Deprecated: Will use the NFSv4.1 protocol, please use swagger version 2019-07-01 or later")
    ...
    __properties: ClassVar[List[str]] = ["allowedClients", "cifs", "nfsv3", "nfsv4", "ruleIndex", "unixReadOnly", "unixReadWrite"]
