...
class MountTargetList(BaseModel):
    """
    List of Mount Targets
    """ # noqa: E501
    value: Optional[List[MountTarget]] = Field(default=None, description="A list of Mount targets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MountTarget.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
