...
class VolumesRevertApi:
    ...
    def volumes_revert(
        ...
        body: Annotated[VolumeRevert, Field(description="Object for snapshot to revert supplied in the body of the operation.")],
        ...
        _param = self._volumes_revert_serialize(
    ...
    @validate_call
    def volumes_revert_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the NetApp account")],
    ...
    @validate_call
    def volumes_revert_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group.")],
        account_name: Annotated[StrictStr, Field(description="The name of the NetApp account")],
    ...
    def _volumes_revert_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/revert',
