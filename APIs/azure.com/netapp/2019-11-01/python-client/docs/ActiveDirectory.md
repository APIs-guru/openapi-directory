...
**dns** | **str** | Comma separated list of DNS server IP addresses (IPv4 only) for the Active Directory domain | [optional] 
...
**site** | **str** | The Active Directory site the service will limit Domain Controller discovery to | [optional] 
