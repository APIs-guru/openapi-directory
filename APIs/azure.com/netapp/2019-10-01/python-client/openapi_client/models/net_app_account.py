...
class NetAppAccount(BaseModel):
    ...
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Tags are a list of key-value pairs that describe the resource")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "properties": AccountProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags"),
            "type": obj.get("type")
        })
        return _obj
