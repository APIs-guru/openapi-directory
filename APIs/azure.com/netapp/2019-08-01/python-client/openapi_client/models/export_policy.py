...
class ExportPolicy(BaseModel):
    ...
    """ # noqa: E501
    rules: Optional[List[ExportPolicyRule]] = Field(default=None, description="Export policy rule")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [ExportPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
