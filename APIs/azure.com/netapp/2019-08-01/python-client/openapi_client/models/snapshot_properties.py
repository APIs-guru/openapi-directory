...
class SnapshotProperties(BaseModel):
    ...
    Snapshot properties
    """ # noqa: E501
    created: Optional[datetime] = Field(default=None, description="The creation date of the snapshot")
    file_system_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, description="UUID v4 used to identify the FileSystem", alias="fileSystemId")
    ...
    __properties: ClassVar[List[str]] = ["created", "fileSystemId", "provisioningState", "snapshotId"]
