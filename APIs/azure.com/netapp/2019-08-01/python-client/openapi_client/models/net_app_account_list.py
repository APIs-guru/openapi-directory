...
class NetAppAccountList(BaseModel):
    """
    List of NetApp account resources
    """ # noqa: E501
    value: Optional[List[NetAppAccount]] = Field(default=None, description="Multiple NetApp accounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [NetAppAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
