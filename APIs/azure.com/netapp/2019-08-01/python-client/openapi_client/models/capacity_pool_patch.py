...
class CapacityPoolPatch(BaseModel):
    """
    ...
    properties: Optional[PoolPatchProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "properties": PoolPatchProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags"),
            "type": obj.get("type")
        })
        return _obj
