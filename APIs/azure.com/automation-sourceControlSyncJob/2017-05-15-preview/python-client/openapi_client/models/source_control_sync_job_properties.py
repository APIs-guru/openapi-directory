...
class SourceControlSyncJobProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creationTime", "endTime", "provisioningState", "sourceControlSyncJobId", "startTime", "syncType"]
