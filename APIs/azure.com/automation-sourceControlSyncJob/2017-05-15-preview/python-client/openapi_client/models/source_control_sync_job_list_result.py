...
class SourceControlSyncJobListResult(BaseModel):
    """
    ...
    value: Optional[List[SourceControlSyncJob]] = Field(default=None, description="The list of source control sync jobs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SourceControlSyncJob.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
