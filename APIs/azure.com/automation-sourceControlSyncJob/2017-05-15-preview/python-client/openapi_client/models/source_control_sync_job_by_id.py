...
class SourceControlSyncJobById(BaseModel):
    """
    Definition of the source control sync job.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The id of the job.")
    properties: Optional[SourceControlSyncJobByIdProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "properties": SourceControlSyncJobByIdProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
