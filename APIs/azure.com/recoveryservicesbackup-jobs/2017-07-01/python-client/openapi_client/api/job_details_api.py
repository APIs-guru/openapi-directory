...
class JobDetailsApi:
    ...
    def job_details_get(
        ...
        job_name: Annotated[StrictStr, Field(description="Name of the job whose details are to be fetched.")],
        ...
        _param = self._job_details_get_serialize(
    ...
    @validate_call
    def job_details_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def job_details_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _job_details_get_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/{jobName}',
