...
class CacheUpdateRequestProperties(BaseModel):
    """
    Parameters supplied to the Update Cache operation.
    """ # noqa: E501
    connection_string: Optional[Annotated[str, Field(strict=True, max_length=300)]] = Field(default=None, description="Runtime connection string to cache", alias="connectionString")
