...
class CacheListByService200ResponseValueInnerProperties(BaseModel):
    """
    Properties of the Cache contract.
    """ # noqa: E501
    connection_string: Annotated[str, Field(strict=True, max_length=300)] = Field(description="Runtime connection string to cache", alias="connectionString")
    description: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = Field(default=None, description="Cache description")
    resource_id: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = Field(default=None, description="Original uri of entity in external system cache points to", alias="resourceId")
    __properties: ClassVar[List[str]] = ["connectionString", "description", "resourceId"]
