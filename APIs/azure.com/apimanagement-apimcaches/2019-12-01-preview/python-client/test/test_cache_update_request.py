...
class TestCacheUpdateRequest(unittest.TestCase):
    """CacheUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CacheUpdateRequest:
        """Test CacheUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CacheUpdateRequest`
        """
        model = CacheUpdateRequest()
        if include_optional:
            return CacheUpdateRequest(
                properties = openapi_client.models.cache_update_request_properties.Cache_Update_request_properties(
                    connection_string = '', 
                    description = '', 
                    resource_id = '', )
            )
    ...
    def testCacheUpdateRequest(self):
        """Test CacheUpdateRequest"""
