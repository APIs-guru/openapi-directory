...
class TestCacheListByServiceDefaultResponseError(unittest.TestCase):
    """CacheListByServiceDefaultResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CacheListByServiceDefaultResponseError:
        """Test CacheListByServiceDefaultResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CacheListByServiceDefaultResponseError`
        """
        model = CacheListByServiceDefaultResponseError()
        if include_optional:
            return CacheListByServiceDefaultResponseError(
                code = '',
                details = [
    ...
    def testCacheListByServiceDefaultResponseError(self):
        """Test CacheListByServiceDefaultResponseError"""
