...
class DirectLineChannelProperties(BaseModel):
    """
    The parameters to provide for the Direct Line channel.
    """ # noqa: E501
    sites: Optional[List[DirectLineSite]] = Field(default=None, description="The list of Direct Line sites")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sites": [DirectLineSite.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
