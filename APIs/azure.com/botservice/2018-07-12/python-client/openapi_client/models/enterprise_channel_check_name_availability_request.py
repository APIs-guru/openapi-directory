...
class EnterpriseChannelCheckNameAvailabilityRequest(BaseModel):
    """
    A request to Bot Service Management to check availability of an Enterprise Channel name.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the Enterprise Channel for which availability needs to be checked.")
