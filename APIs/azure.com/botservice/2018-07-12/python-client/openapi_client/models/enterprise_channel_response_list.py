...
class EnterpriseChannelResponseList(BaseModel):
    """
    The list of  bot service operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of bot service resources.", alias="nextLink")
    value: Optional[List[EnterpriseChannel]] = Field(default=None, description="The list of Enterprise Channels and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EnterpriseChannel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
