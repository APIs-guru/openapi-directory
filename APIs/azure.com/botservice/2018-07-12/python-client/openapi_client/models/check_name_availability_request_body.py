...
class CheckNameAvailabilityRequestBody(BaseModel):
    """
    The request body for a request to Bot Service Management to check availability of a bot name.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="the name of the bot for which availability needs to be checked.")
    type: Optional[StrictStr] = Field(default=None, description="the type of the bot for which availability needs to be checked")
