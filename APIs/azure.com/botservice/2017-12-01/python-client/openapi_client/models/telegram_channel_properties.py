...
class TelegramChannelProperties(BaseModel):
    """
    The parameters to provide for the Telegram channel.
    """ # noqa: E501
    access_token: StrictStr = Field(description="The Telegram access token. Value only returned through POST to the action Channel List API, otherwise empty.", alias="accessToken")
    ...
    __properties: ClassVar[List[str]] = ["accessToken", "isEnabled", "isValidated"]
