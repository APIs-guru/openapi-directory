...
class TestApiVersionSetEntityBase(unittest.TestCase):
    """ApiVersionSetEntityBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiVersionSetEntityBase:
        """Test ApiVersionSetEntityBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiVersionSetEntityBase`
        """
    ...
    def testApiVersionSetEntityBase(self):
        """Test ApiVersionSetEntityBase"""
