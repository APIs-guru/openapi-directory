...
class ApiVersionSetListByServiceDefaultResponse(BaseModel):
    """
    Error Body contract.
    """ # noqa: E501
    ...
    details: Optional[List[ApiVersionSetListByServiceDefaultResponseDetailsInner]] = Field(default=None, description="The list of invalid fields send in request, in case of validation error.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [ApiVersionSetListByServiceDefaultResponseDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
