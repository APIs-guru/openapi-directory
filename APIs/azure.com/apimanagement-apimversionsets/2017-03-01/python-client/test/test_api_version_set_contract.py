...
class TestApiVersionSetContract(unittest.TestCase):
    """ApiVersionSetContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiVersionSetContract:
        """Test ApiVersionSetContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiVersionSetContract`
        """
    ...
    def testApiVersionSetContract(self):
        """Test ApiVersionSetContract"""
