...
class ApiVersionSetUpdateParameters(BaseModel):
    """
    Parameters to update or create an Api Version Set Contract.
    """ # noqa: E501
    properties: Optional[ApiVersionSetUpdateParametersProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApiVersionSetUpdateParametersProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
