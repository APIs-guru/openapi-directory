...
------------ | ------------- | ------------- | -------------
**description** | **str** | Description of what this input is used for. | [optional] 
**id** | **str** | Identifier for the input. | 
**possible_values** | [**List[InputValue]**](InputValue.md) | Possible values that this input can take. | [optional] 
**type** | **str** | Data type of the input. | 
