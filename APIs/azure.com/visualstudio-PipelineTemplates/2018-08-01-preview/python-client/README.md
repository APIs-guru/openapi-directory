...
------------ | ------------- | ------------- | -------------
*PipelineTemplatesApi* | [**pipeline_templates_list**](docs/PipelineTemplatesApi.md#pipeline_templates_list) | **GET** /providers/microsoft.visualstudio/pipelineTemplates | PipelineTemplates_List
