...
class PipelineTemplateResourceListResult(BaseModel):
    """
    The response to pipeline template resource list GET request.
    """ # noqa: E501
    value: Optional[List[PipelineTemplate]] = Field(default=None, description="Array of resource details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PipelineTemplate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
