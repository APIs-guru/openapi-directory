...
class PipelineTemplate(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the pipeline which this template enables.")
    id: StrictStr = Field(description="Unique id of pipeline template.")
    inputs: Optional[List[InputDescriptor]] = Field(default=None, description="Inputs required by this template to create pipeline.")
