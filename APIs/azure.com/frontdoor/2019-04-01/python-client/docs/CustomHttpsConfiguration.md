...
------------ | ------------- | ------------- | -------------
**certificate_source** | **str** | Defines the source of the SSL certificate | [optional] 
...
**protocol_type** | **str** | Defines the TLS extension protocol that is used for secure delivery | [optional] 
