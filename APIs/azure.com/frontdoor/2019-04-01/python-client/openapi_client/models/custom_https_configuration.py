...
class CustomHttpsConfiguration(BaseModel):
    ...
    """ # noqa: E501
    certificate_source: Optional[StrictStr] = Field(default=None, description="Defines the source of the SSL certificate", alias="certificateSource")
    ...
    protocol_type: Optional[StrictStr] = Field(default=None, description="Defines the TLS extension protocol that is used for secure delivery", alias="protocolType")
    __properties: ClassVar[List[str]] = ["certificateSource", "frontDoorCertificateSourceParameters", "keyVaultCertificateSourceParameters", "protocolType"]
