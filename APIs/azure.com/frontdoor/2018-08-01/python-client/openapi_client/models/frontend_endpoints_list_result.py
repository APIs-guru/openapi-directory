...
class FrontendEndpointsListResult(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of frontend endpoints if there are any.", alias="nextLink")
    value: Optional[List[FrontendEndpoint]] = Field(default=None, description="List of Frontend endpoints within a Front Door.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FrontendEndpoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
