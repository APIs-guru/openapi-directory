...
class FrontDoorCertificateSourceParameters(BaseModel):
    """
    Parameters required for enabling SSL with Front Door-managed certificates
    """ # noqa: E501
    certificate_type: Optional[StrictStr] = Field(default=None, description="Defines the type of the certificate used for secure connections to a frontendEndpoint", alias="certificateType")
    __properties: ClassVar[List[str]] = ["certificateType"]
