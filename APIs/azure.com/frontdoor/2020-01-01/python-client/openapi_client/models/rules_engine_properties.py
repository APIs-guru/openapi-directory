...
class RulesEngineProperties(BaseModel):
    """
    ...
    rules: Optional[List[RulesEngineRule]] = Field(default=None, description="A list of rules that define a particular Rules Engine Configuration.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [RulesEngineRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
