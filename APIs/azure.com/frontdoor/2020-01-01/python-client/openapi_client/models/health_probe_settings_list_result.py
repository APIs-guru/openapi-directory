...
class HealthProbeSettingsListResult(BaseModel):
    """
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URL to get the next set of HealthProbeSettings objects if there are any.", alias="nextLink")
    value: Optional[List[HealthProbeSettingsModel]] = Field(default=None, description="List of HealthProbeSettings within a Front Door.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [HealthProbeSettingsModel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
