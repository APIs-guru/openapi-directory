...
class FrontDoorsApi:
    ...
    @validate_call
    def rules_engines_create_or_update(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
        rules_engine_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Rules Engine which is unique within the Front Door.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        rules_engine_parameters: Annotated[RulesEngine, Field(description="Rules Engine Configuration properties needed to create a new Rules Engine Configuration.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param front_door_name: Name of the Front Door which is globally unique. (required)
        :type front_door_name: str
        :param rules_engine_name: Name of the Rules Engine which is unique within the Front Door. (required)
        :type rules_engine_name: str
        :param api_version: Client API version. (required)
        :type api_version: str
        :param rules_engine_parameters: Rules Engine Configuration properties needed to create a new Rules Engine Configuration. (required)
        :type rules_engine_parameters: RulesEngine
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rules_engines_create_or_update_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
    ...
    @validate_call
    def rules_engines_create_or_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    @validate_call
    def rules_engines_create_or_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    def _rules_engines_create_or_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        front_door_name,
        ...
        if rules_engine_name is not None:
            _path_params['rulesEngineName'] = rules_engine_name
        # process the query parameters
        if api_version is not None:
        ...
        # process the form parameters
        # process the body parameter
        if rules_engine_parameters is not None:
            _body_params = rules_engine_parameters
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines/{rulesEngineName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rules_engines_delete(
        ...
        _param = self._rules_engines_delete_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
            rules_engine_name=rules_engine_name,
    ...
    @validate_call
    def rules_engines_delete_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    @validate_call
    def rules_engines_delete_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    def _rules_engines_delete_serialize(
        self,
        subscription_id,
        resource_group_name,
        front_door_name,
    ...
    def rules_engines_get(
        ...
        _param = self._rules_engines_get_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
            rules_engine_name=rules_engine_name,
    ...
    @validate_call
    def rules_engines_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    @validate_call
    def rules_engines_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    def _rules_engines_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        front_door_name,
    ...
    @validate_call
    def rules_engines_list_by_front_door(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
        ...
        _param = self._rules_engines_list_by_front_door_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
            api_version=api_version,
    ...
    @validate_call
    def rules_engines_list_by_front_door_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RulesEngineListResult]:
        """rules_engines_list_by_front_door
    ...
    @validate_call
    def rules_engines_list_by_front_door_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Name of the Resource group within the Azure subscription.")],
        front_door_name: Annotated[str, Field(min_length=5, strict=True, max_length=64, description="Name of the Front Door which is globally unique.")],
    ...
    def _rules_engines_list_by_front_door_serialize(
        self,
        subscription_id,
        resource_group_name,
        front_door_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
