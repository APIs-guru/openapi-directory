...
class CheckFrontDoorNameAvailabilityWithSubscriptionApi:
    ...
    def check_front_door_name_availability_with_subscription(
        ...
        _param = self._check_front_door_name_availability_with_subscription_serialize(
    ...
    @validate_call
    def check_front_door_name_availability_with_subscription_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        check_front_door_name_availability_input: Annotated[CheckNameAvailabilityInput, Field(description="Input to check.")],
    ...
    @validate_call
    def check_front_door_name_availability_with_subscription_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        check_front_door_name_availability_input: Annotated[CheckNameAvailabilityInput, Field(description="Input to check.")],
    ...
    def _check_front_door_name_availability_with_subscription_serialize(
        self,
        subscription_id,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Network/checkFrontDoorNameAvailability',
