...
------------ | ------------- | ------------- | -------------
**custom_domain_validated** | **bool** | Indicates whether the custom domain is valid or not. | [optional] [readonly] 
**message** | **str** | Error message describing why the custom domain is not valid. | [optional] [readonly] 
**reason** | **str** | The reason why the custom domain is not valid. | [optional] [readonly] 
