...
class RoutingRuleUpdateParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["acceptedProtocols", "enabledState", "frontendEndpoints", "patternsToMatch", "routeConfiguration"]
