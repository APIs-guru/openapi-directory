...
class QnASearchResultList(BaseModel):
    """
    Represents List of Question Answers.
    """ # noqa: E501
    answers: Optional[List[QnASearchResult]] = Field(default=None, description="Represents Search Result list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [QnASearchResult.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
