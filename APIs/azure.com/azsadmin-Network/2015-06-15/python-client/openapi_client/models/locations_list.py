...
class LocationsList(BaseModel):
    ...
    List of Locations
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI to the next page of locations.", alias="nextLink")
    value: Optional[List[Location]] = Field(default=None, description="Array of locations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Location.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
