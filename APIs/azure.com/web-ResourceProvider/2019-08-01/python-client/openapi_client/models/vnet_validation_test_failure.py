...
class VnetValidationTestFailure(BaseModel):
    """
    A class that describes a test that failed during NSG and UDR validation.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="VnetValidationTestFailure resource specific properties")
