...
[**list_billing_meters**](DefaultApi.md#list_billing_meters) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Web/billingMeters | Gets a list of meters for a given location.
...
# **list_billing_meters**
> BillingMeterCollection list_billing_meters(subscription_id, api_version, billing_location=billing_location, os_type=os_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    os_type = 'os_type_example' # str | App Service OS type meters used for (optional)

    try:
        # Gets a list of meters for a given location.
        api_response = api_instance.list_billing_meters(subscription_id, api_version, billing_location=billing_location, os_type=os_type)
        print("The response of DefaultApi->list_billing_meters:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->list_billing_meters: %s\n" % e)
```
 ...
 **os_type** | **str**| App Service OS type meters used for | [optional] 
...
# **list_geo_regions**
> GeoRegionCollection list_geo_regions(subscription_id, api_version, sku=sku, linux_workers_enabled=linux_workers_enabled, xenon_workers_enabled=xenon_workers_enabled, linux_dynamic_workers_enabled=linux_dynamic_workers_enabled)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    xenon_workers_enabled = True # bool | Specify <code>true</code> if you want to filter to only regions that support Xenon workers. (optional)
    linux_dynamic_workers_enabled = True # bool | Specify <code>true</code> if you want to filter to only regions that support Linux Consumption Workers. (optional)

    try:
        # Get a list of available geographical regions.
        api_response = api_instance.list_geo_regions(subscription_id, api_version, sku=sku, linux_workers_enabled=linux_workers_enabled, xenon_workers_enabled=xenon_workers_enabled, linux_dynamic_workers_enabled=linux_dynamic_workers_enabled)
 ...
 **xenon_workers_enabled** | **bool**| Specify &lt;code&gt;true&lt;/code&gt; if you want to filter to only regions that support Xenon workers. | [optional] 
 **linux_dynamic_workers_enabled** | **bool**| Specify &lt;code&gt;true&lt;/code&gt; if you want to filter to only regions that support Linux Consumption Workers. | [optional] 
