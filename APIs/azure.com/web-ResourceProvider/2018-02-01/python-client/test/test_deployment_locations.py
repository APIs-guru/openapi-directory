...
class TestDeploymentLocations(unittest.TestCase):
    """DeploymentLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentLocations:
        """Test DeploymentLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentLocations`
        """
        model = DeploymentLocations()
        if include_optional:
            return DeploymentLocations(
                hosting_environment_deployment_infos = [
                    openapi_client.models.hosting_environment_deployment_info.HostingEnvironmentDeploymentInfo(
                        location = '', 
                        name = '', )
                    ],
                hosting_environments = [
                    openapi_client.models.deployment_locations_hosting_environments_inner.DeploymentLocations_hostingEnvironments_inner(
                        allowed_multi_sizes = '', 
    ...
    def testDeploymentLocations(self):
        """Test DeploymentLocations"""
