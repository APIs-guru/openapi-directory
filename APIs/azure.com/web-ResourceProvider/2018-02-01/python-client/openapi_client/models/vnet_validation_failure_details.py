...
class VnetValidationFailureDetails(BaseModel):
    """
    A class that describes the reason for a validation failure.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="VnetValidationFailureDetails resource specific properties")
