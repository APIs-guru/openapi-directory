...
class ValidateResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Result of validation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ValidateResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None,
