...
class DeploymentLocationsHostingEnvironmentsInnerEnvironmentCapacitiesInner(BaseModel):
    """
    ...
    def worker_size_validate_enum(cls, value):
        ...
        if value not in set(['Default', 'Small', 'Medium', 'Large', 'D1', 'D2', 'D3']):
            raise ValueError("must be one of enum values ('Default', 'Small', 'Medium', 'Large', 'D1', 'D2', 'D3')")
        return value
