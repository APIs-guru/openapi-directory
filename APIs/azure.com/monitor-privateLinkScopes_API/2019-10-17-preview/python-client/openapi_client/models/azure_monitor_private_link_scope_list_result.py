...
class AzureMonitorPrivateLinkScopeListResult(BaseModel):
    """
    Describes the list of Azure Monitor PrivateLinkScope resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to get the next set of Azure Monitor PrivateLinkScope definitions if too many PrivateLinkScopes where returned in the result set.", alias="nextLink")
    value: List[AzureMonitorPrivateLinkScope] = Field(description="List of Azure Monitor PrivateLinkScope definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AzureMonitorPrivateLinkScope.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
