...
class CredentialListResult(BaseModel):
    ...
    value: Optional[List[Credential]] = Field(default=None, description="Gets or sets a list of credentials.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Credential.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
