...
class CredentialCreateOrUpdateParameters(BaseModel):
    """
    The parameters supplied to the create or update credential operation.
    """ # noqa: E501
    name: StrictStr = Field(description="Gets or sets the name of the credential.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": CredentialCreateOrUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
