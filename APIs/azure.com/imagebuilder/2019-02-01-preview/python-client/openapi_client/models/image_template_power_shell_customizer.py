...
class ImageTemplatePowerShellCustomizer(ImageTemplateCustomizer):
    ...
    script: Optional[StrictStr] = Field(default=None, description="The PowerShell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc")
