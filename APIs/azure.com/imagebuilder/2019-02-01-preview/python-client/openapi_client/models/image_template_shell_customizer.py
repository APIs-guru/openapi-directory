...
class ImageTemplateShellCustomizer(ImageTemplateCustomizer):
    ...
    """ # noqa: E501
    inline: Optional[List[StrictStr]] = Field(default=None, description="Array of shell commands to execute")
    script: Optional[StrictStr] = Field(default=None, description="The shell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc")
