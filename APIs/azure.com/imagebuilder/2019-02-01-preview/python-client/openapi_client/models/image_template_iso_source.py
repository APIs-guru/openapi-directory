...
class ImageTemplateIsoSource(ImageTemplateSource):
    ...
    source_uri: StrictStr = Field(description="URI to get the ISO image. This URI has to be accessible to the resource provider at the time of the image template creation.", alias="sourceURI")
