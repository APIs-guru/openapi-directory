...
class RunOutputProperties(BaseModel):
    ...
    artifact_uri: Optional[StrictStr] = Field(default=None, description="The location URI of the artifact.", alias="artifactUri")
    provisioning_state: Optional[ProvisioningState] = Field(default=None, alias="provisioningState")
    __properties: ClassVar[List[str]] = ["artifactId", "artifactUri", "provisioningState"]
