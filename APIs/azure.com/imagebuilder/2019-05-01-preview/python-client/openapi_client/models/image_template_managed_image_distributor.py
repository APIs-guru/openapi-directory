...
class ImageTemplateManagedImageDistributor(ImageTemplateDistributor):
    ...
    """ # noqa: E501
    image_id: StrictStr = Field(description="Resource Id of the Managed Disk Image", alias="imageId")
    location: StrictStr = Field(description="Azure location for the image, should match if image already exists")
