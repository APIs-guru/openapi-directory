...
class ImageTemplateUpdateParameters(BaseModel):
    """
    Parameters for updating an image template.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The user-specified tags associated with the image template.")
