...
class RunOutputProperties(BaseModel):
    """
    RunOutputProperties
    """ # noqa: E501
    artifact_id: Optional[StrictStr] = Field(default=None, description="The resource id of the artifact.", alias="artifactId")
    provisioning_state: Optional[ProvisioningState] = Field(default=None, alias="provisioningState")
    __properties: ClassVar[List[str]] = ["artifactId", "provisioningState"]
