...
class ConfigurationListResult(BaseModel):
    """
    A list of server configurations.
    """ # noqa: E501
    value: Optional[List[Configuration]] = Field(default=None, description="The list of server configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Configuration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
