...
class NameAvailability(BaseModel):
    ...
    name_available: Optional[StrictBool] = Field(default=None, description="Indicates whether the resource name is available.", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="Reason for name being unavailable.")
