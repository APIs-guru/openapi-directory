...
------------ | ------------- | ------------- | -------------
**name** | **str** | Name of the node configuration. | [optional] 
**properties** | [**DscNodeConfigurationCreateOrUpdateParametersProperties**](DscNodeConfigurationCreateOrUpdateParametersProperties.md) |  | [optional] 
