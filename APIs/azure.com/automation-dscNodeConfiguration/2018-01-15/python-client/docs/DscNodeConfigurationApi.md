...
> dsc_node_configuration_create_or_update(resource_group_name, automation_account_name, node_configuration_name, subscription_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.dsc_node_configuration_create_or_update(resource_group_name, automation_account_name, node_configuration_name, subscription_id, api_version, parameters)
...
> dsc_node_configuration_delete(subscription_id, resource_group_name, automation_account_name, node_configuration_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.dsc_node_configuration_delete(subscription_id, resource_group_name, automation_account_name, node_configuration_name, api_version)
    except Exception as e:
...
> DscNodeConfiguration dsc_node_configuration_get(subscription_id, resource_group_name, automation_account_name, node_configuration_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dsc_node_configuration_get(subscription_id, resource_group_name, automation_account_name, node_configuration_name, api_version)
...
> DscNodeConfigurationListResult dsc_node_configuration_list_by_automation_account(resource_group_name, automation_account_name, subscription_id, api_version, filter=filter, skip=skip, top=top, inlinecount=inlinecount)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dsc_node_configuration_list_by_automation_account(resource_group_name, automation_account_name, subscription_id, api_version, filter=filter, skip=skip, top=top, inlinecount=inlinecount)
