...
class DscNodeExtensionHandlerAssociationProperty(BaseModel):
    """
    The dsc extensionHandler property associated with the node
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the extension handler.")
    version: Optional[StrictStr] = Field(default=None, description="Gets or sets the version of the extension handler.")
