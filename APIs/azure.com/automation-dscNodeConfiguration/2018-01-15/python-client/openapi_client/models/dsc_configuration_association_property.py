...
class DscConfigurationAssociationProperty(BaseModel):
    """
    The Dsc configuration property associated with the entity.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the Dsc configuration.")
