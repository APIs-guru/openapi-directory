...
class UserSubscriptionsApi:
    ...
    @validate_call
    def user_subscriptions_list_by_users(
        self,
        ...
        _param = self._user_subscriptions_list_by_users_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserSubscriptionsListByUsers200Response",
        }
    ...
    @validate_call
    def user_subscriptions_list_by_users_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        uid: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="User identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserSubscriptionsListByUsers200Response]:
        """user_subscriptions_list_by_users
    ...
    @validate_call
    def user_subscriptions_list_by_users_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        uid: Annotated[str, Field(min_length=1, strict=True, max_length=256, description="User identifier. Must be unique in the current API Management service instance.")],
    ...
    def _user_subscriptions_list_by_users_serialize(
        self,
        resource_group_name,
        service_name,
        uid,
