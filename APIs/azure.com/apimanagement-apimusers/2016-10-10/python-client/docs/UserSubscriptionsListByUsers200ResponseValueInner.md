...
user_subscriptions_list_by_users200_response_value_inner_instance = UserSubscriptionsListByUsers200ResponseValueInner.from_json(json)
# print the JSON string representation of the object
print(UserSubscriptionsListByUsers200ResponseValueInner.to_json())

# convert the object into a dict
user_subscriptions_list_by_users200_response_value_inner_dict = user_subscriptions_list_by_users200_response_value_inner_instance.to_dict()
# create an instance of UserSubscriptionsListByUsers200ResponseValueInner from a dict
user_subscriptions_list_by_users200_response_value_inner_from_dict = UserSubscriptionsListByUsers200ResponseValueInner.from_dict(user_subscriptions_list_by_users200_response_value_inner_dict)
```
