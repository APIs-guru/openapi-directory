...
class UserCreateOrUpdateRequestProperties(BaseModel):
    ...
    """ # noqa: E501
    app_type: Optional[StrictStr] = Field(default=None, description="Determines the type of application which send the create user request. Default is legacy portal.", alias="appType")
    ...
    def app_type_validate_enum(cls, value):
        ...
        if value not in set(['portal', 'developerPortal']):
            raise ValueError("must be one of enum values ('portal', 'developerPortal')")
        return value
