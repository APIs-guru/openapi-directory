...
class UserGetSharedAccessTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[UserGetSharedAccessTokenRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UserGetSharedAccessTokenRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
