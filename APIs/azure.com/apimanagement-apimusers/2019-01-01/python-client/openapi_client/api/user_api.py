...
class UserApi:
    ...
    def user_create_or_update(
        ...
        notify: Annotated[Optional[StrictBool], Field(description="Send an Email notification to the User.")] = None,
    ...
    def user_list_by_service(
        ...
        expand_groups: Annotated[Optional[StrictBool], Field(description="Detailed Group in response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
