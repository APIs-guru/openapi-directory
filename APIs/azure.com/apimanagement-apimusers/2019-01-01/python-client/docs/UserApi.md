...
> UserGet200Response user_create_or_update(resource_group_name, service_name, user_id, api_version, subscription_id, parameters, notify=notify, if_match=if_match)
 ...
 **notify** | **bool**| Send an Email notification to the User. | [optional] 
...
# **user_delete**
> user_delete(resource_group_name, service_name, user_id, if_match, api_version, subscription_id, delete_subscriptions=delete_subscriptions, notify=notify, app_type=app_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.user_delete(resource_group_name, service_name, user_id, if_match, api_version, subscription_id, delete_subscriptions=delete_subscriptions, notify=notify, app_type=app_type)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    expand_groups = True # bool | Detailed Group in response. (optional)
 ...
 **expand_groups** | **bool**| Detailed Group in response. | [optional] 
