...
------------ | ------------- | ------------- | -------------
**allow_tracing** | **bool** | Determines whether tracing is enabled | [optional] 
...
**owner_id** | **str** | The user resource identifier of the subscription owner. The value is a valid relative URL in the format of /users/{userId} where {userId} is a user identifier. | [optional] 
...
user_subscription_list200_response_value_inner_properties_instance = UserSubscriptionList200ResponseValueInnerProperties.from_json(json)
# print the JSON string representation of the object
print(UserSubscriptionList200ResponseValueInnerProperties.to_json())

# convert the object into a dict
user_subscription_list200_response_value_inner_properties_dict = user_subscription_list200_response_value_inner_properties_instance.to_dict()
# create an instance of UserSubscriptionList200ResponseValueInnerProperties from a dict
user_subscription_list200_response_value_inner_properties_from_dict = UserSubscriptionList200ResponseValueInnerProperties.from_dict(user_subscription_list200_response_value_inner_properties_dict)
```
