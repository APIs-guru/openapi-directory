...
class UserConfirmationPasswordSendApi:
    ...
    @validate_call
    def user_confirmation_password_send(
        self,
        ...
        _param = self._user_confirmation_password_send_serialize(
    ...
    @validate_call
    def user_confirmation_password_send_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        user_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="User identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def user_confirmation_password_send_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        user_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="User identifier. Must be unique in the current API Management service instance.")],
    ...
    def _user_confirmation_password_send_serialize(
        self,
        resource_group_name,
        service_name,
        user_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/confirmations/password/send',
