...
class UserTokenApi:
    ...
    def user_get_shared_access_token(
        ...
        parameters: Annotated[UserGetSharedAccessTokenRequest, Field(description="Create Authorization Token parameters.")],
        ...
        :type parameters: UserGetSharedAccessTokenRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserGetSharedAccessToken200Response",
        }
    ...
    def user_get_shared_access_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserGetSharedAccessToken200Response]:
        """user_get_shared_access_token
    ...
    def _user_get_shared_access_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/token',
