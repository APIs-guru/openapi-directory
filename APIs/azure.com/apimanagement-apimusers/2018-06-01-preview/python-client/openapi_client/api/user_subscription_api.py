...
class UserSubscriptionApi:
    ...
    def user_subscription_list(
        ...
        _param = self._user_subscription_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserSubscriptionList200Response",
        }
    ...
    @validate_call
    def user_subscription_list_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        user_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="User identifier. Must be unique in the current API Management service instance.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserSubscriptionList200Response]:
        """user_subscription_list
    ...
    @validate_call
    def user_subscription_list_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        user_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="User identifier. Must be unique in the current API Management service instance.")],
    ...
    def _user_subscription_list_serialize(
        self,
        resource_group_name,
        service_name,
        user_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/subscriptions',
