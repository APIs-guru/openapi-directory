...
class UsersApi:
    ...
    def user_generate_sso_url(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserGenerateSsoUrl200Response",
        }
    ...
    def user_generate_sso_url_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserGenerateSsoUrl200Response]:
        """user_generate_sso_url
    ...
    def _user_generate_sso_url_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/generateSsoUrl',
