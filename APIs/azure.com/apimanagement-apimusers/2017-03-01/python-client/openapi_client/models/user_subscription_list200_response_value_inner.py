...
class UserSubscriptionList200ResponseValueInner(BaseModel):
    """
    Subscription details.
    """ # noqa: E501
    properties: Optional[UserSubscriptionList200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UserSubscriptionList200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
