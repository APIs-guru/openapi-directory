...
**ip_configurations** | [**List[NetworkInterfaceIPConfiguration]**](NetworkInterfaceIPConfiguration.md) | Gets or sets list of IPConfigurations of the network interface | [optional] 
