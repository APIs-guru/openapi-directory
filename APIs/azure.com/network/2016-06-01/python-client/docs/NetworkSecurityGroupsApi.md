...
> NetworkSecurityGroup network_security_groups_get(resource_group_name, network_security_group_name, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.network_security_groups_get(resource_group_name, network_security_group_name, api_version, subscription_id, expand=expand)
