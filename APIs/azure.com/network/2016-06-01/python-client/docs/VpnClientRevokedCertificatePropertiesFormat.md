...
------------ | ------------- | ------------- | -------------
**provisioning_state** | **str** | Gets provisioning state of the VPN client revoked certificate resource Updating/Deleting/Failed | [optional] 
**thumbprint** | **str** | Gets or sets the revoked Vpn client certificate thumbprint | [optional] 
