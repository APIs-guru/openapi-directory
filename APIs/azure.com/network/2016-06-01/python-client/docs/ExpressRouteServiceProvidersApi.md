# openapi_client.ExpressRouteServiceProvidersApi
...
> ExpressRouteServiceProviderListResult express_route_service_providers_list(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ExpressRouteServiceProvidersApi(api_client)
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.

    try:
        api_response = api_instance.express_route_service_providers_list(api_version, subscription_id)
        print("The response of ExpressRouteServiceProvidersApi->express_route_service_providers_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExpressRouteServiceProvidersApi->express_route_service_providers_list: %s\n" % e)
```
