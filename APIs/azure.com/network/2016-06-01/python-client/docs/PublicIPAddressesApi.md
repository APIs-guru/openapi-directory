...
> PublicIPAddress public_ip_addresses_get(resource_group_name, public_ip_address_name, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.public_ip_addresses_get(resource_group_name, public_ip_address_name, api_version, subscription_id, expand=expand)
