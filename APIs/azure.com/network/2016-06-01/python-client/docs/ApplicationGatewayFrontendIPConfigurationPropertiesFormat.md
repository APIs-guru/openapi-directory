...
**private_ip_allocation_method** | **str** | PrivateIP allocation method (Static/Dynamic) | [optional] 
**provisioning_state** | **str** | Provisioning state of the PublicIP resource Updating/Deleting/Failed | [optional] 
