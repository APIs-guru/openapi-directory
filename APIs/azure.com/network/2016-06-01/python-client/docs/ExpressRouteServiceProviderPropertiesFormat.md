...
------------ | ------------- | ------------- | -------------
**bandwidths_offered** | [**List[ExpressRouteServiceProviderBandwidthsOffered]**](ExpressRouteServiceProviderBandwidthsOffered.md) | Gets or bandwidths offered | [optional] 
**peering_locations** | **List[str]** | Gets or list of peering locations | [optional] 
