...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets provisioning state of the VirtualNetworkGateway resource Updating/Deleting/Failed", alias="provisioningState")
