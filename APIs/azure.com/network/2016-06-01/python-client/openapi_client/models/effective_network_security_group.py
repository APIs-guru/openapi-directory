...
class EffectiveNetworkSecurityGroup(BaseModel):
    ...
    effective_security_rules: Optional[List[EffectiveNetworkSecurityRule]] = Field(default=None, description="Gets collection of effective security rules", alias="effectiveSecurityRules")
    network_security_group: Optional[SubResource] = Field(default=None, alias="networkSecurityGroup")
    __properties: ClassVar[List[str]] = ["association", "effectiveSecurityRules", "networkSecurityGroup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "association": EffectiveNetworkSecurityGroupAssociation.from_dict(obj["association"]) if obj.get("association") is not None else None,
            "effectiveSecurityRules": [EffectiveNetworkSecurityRule.from_dict(_item) for _item in obj["effectiveSecurityRules"]] if obj.get("effectiveSecurityRules") is not None else None,
