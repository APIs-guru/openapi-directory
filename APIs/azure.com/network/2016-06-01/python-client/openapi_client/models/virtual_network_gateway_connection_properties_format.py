...
class VirtualNetworkGatewayConnectionPropertiesFormat(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets provisioning state of the VirtualNetworkGatewayConnection resource Updating/Deleting/Failed", alias="provisioningState")
    ...
    __properties: ClassVar[List[str]] = ["authorizationKey", "connectionStatus", "connectionType", "egressBytesTransferred", "enableBgp", "ingressBytesTransferred", "localNetworkGateway2", "peer", "provisioningState", "resourceGuid", "routingWeight", "sharedKey", "virtualNetworkGateway1", "virtualNetworkGateway2"]
