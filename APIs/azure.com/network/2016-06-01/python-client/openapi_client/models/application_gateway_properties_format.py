...
class ApplicationGatewayPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    authentication_certificates: Optional[List[ApplicationGatewayAuthenticationCertificate]] = Field(default=None, description="Authentication certificates of application gateway resource", alias="authenticationCertificates")
    backend_address_pools: Optional[List[ApplicationGatewayBackendAddressPool]] = Field(default=None, description="Backend address pool of application gateway resource", alias="backendAddressPools")
    backend_http_settings_collection: Optional[List[ApplicationGatewayBackendHttpSettings]] = Field(default=None, description="Backend http settings of application gateway resource", alias="backendHttpSettingsCollection")
    frontend_ip_configurations: Optional[List[ApplicationGatewayFrontendIPConfiguration]] = Field(default=None, description="Frontend IP addresses of application gateway resource", alias="frontendIPConfigurations")
    frontend_ports: Optional[List[ApplicationGatewayFrontendPort]] = Field(default=None, description="Frontend ports of application gateway resource", alias="frontendPorts")
    gateway_ip_configurations: Optional[List[ApplicationGatewayIPConfiguration]] = Field(default=None, description="Subnets of application gateway resource", alias="gatewayIPConfigurations")
    http_listeners: Optional[List[ApplicationGatewayHttpListener]] = Field(default=None, description="HTTP listeners of application gateway resource", alias="httpListeners")
    operational_state: Optional[StrictStr] = Field(default=None, description="Operational state of application gateway resource", alias="operationalState")
    probes: Optional[List[ApplicationGatewayProbe]] = Field(default=None, description="Probes of application gateway resource")
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of the ApplicationGateway resource Updating/Deleting/Failed", alias="provisioningState")
    request_routing_rules: Optional[List[ApplicationGatewayRequestRoutingRule]] = Field(default=None, description="Request routing rules of application gateway resource", alias="requestRoutingRules")
    resource_guid: Optional[StrictStr] = Field(default=None, description="Resource guid property of the ApplicationGateway resource", alias="resourceGuid")
    sku: Optional[ApplicationGatewaySku] = None
    ssl_certificates: Optional[List[ApplicationGatewaySslCertificate]] = Field(default=None, description="SSL certificates of application gateway resource", alias="sslCertificates")
    ssl_policy: Optional[ApplicationGatewaySslPolicy] = Field(default=None, alias="sslPolicy")
    url_path_maps: Optional[List[ApplicationGatewayUrlPathMap]] = Field(default=None, description="URL path map of application gateway resource", alias="urlPathMaps")
    __properties: ClassVar[List[str]] = ["authenticationCertificates", "backendAddressPools", "backendHttpSettingsCollection", "frontendIPConfigurations", "frontendPorts", "gatewayIPConfigurations", "httpListeners", "operationalState", "probes", "provisioningState", "requestRoutingRules", "resourceGuid", "sku", "sslCertificates", "sslPolicy", "urlPathMaps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authenticationCertificates": [ApplicationGatewayAuthenticationCertificate.from_dict(_item) for _item in obj["authenticationCertificates"]] if obj.get("authenticationCertificates") is not None else None,
