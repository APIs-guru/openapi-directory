...
class VirtualNetworkPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    virtual_network_peerings: Optional[List[VirtualNetworkPeering]] = Field(default=None, description="Gets or sets list of peerings in a VirtualNetwork", alias="VirtualNetworkPeerings")
    ...
    __properties: ClassVar[List[str]] = ["VirtualNetworkPeerings", "addressSpace", "dhcpOptions", "provisioningState", "resourceGuid", "subnets"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in virtual_network_peerings (list)
        _items = []
        if self.virtual_network_peerings:
            for _item_virtual_network_peerings in self.virtual_network_peerings:
                if _item_virtual_network_peerings:
                    _items.append(_item_virtual_network_peerings.to_dict())
            _dict['VirtualNetworkPeerings'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "VirtualNetworkPeerings": [VirtualNetworkPeering.from_dict(_item) for _item in obj["VirtualNetworkPeerings"]] if obj.get("VirtualNetworkPeerings") is not None else None,
