...
class EffectiveNetworkSecurityGroupAssociation(BaseModel):
    """
    Effective NetworkSecurityGroup association
    """ # noqa: E501
    network_interface: Optional[SubResource] = Field(default=None, alias="networkInterface")
    subnet: Optional[SubResource] = None
    __properties: ClassVar[List[str]] = ["networkInterface", "subnet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkInterface": SubResource.from_dict(obj["networkInterface"]) if obj.get("networkInterface") is not None else None,
