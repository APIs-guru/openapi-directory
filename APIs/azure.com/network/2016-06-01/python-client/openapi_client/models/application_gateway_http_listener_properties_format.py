...
class ApplicationGatewayHttpListenerPropertiesFormat(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of the http listener resource Updating/Deleting/Failed", alias="provisioningState")
    require_server_name_indication: Optional[StrictBool] = Field(default=None, description="RequireServerNameIndication of http listener ", alias="requireServerNameIndication")
