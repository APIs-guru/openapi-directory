...
class NetworkSecurityGroupPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    default_security_rules: Optional[List[SecurityRule]] = Field(default=None, description="Gets or default security rules of network security group", alias="defaultSecurityRules")
    network_interfaces: Optional[List[NetworkInterface]] = Field(default=None, description="Gets collection of references to Network Interfaces", alias="networkInterfaces")
...
NetworkSecurityGroupPropertiesFormat.model_rebuild(raise_errors=False)
