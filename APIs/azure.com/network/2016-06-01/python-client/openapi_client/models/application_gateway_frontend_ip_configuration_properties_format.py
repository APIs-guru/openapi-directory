...
class ApplicationGatewayFrontendIPConfigurationPropertiesFormat(BaseModel):
    ...
    private_ip_allocation_method: Optional[StrictStr] = Field(default=None, description="PrivateIP allocation method (Static/Dynamic)", alias="privateIPAllocationMethod")
