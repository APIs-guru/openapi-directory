...
class NetworkInterfaceListResult(BaseModel):
    ...
    value: Optional[List[NetworkInterface]] = Field(default=None, description="Gets or sets list of NetworkInterfaces in a resource group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [NetworkInterface.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
