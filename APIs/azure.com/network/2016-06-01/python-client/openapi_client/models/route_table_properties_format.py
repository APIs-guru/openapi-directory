...
class RouteTablePropertiesFormat(BaseModel):
    """
    Route Table resource
    """ # noqa: E501
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets provisioning state of the resource Updating/Deleting/Failed", alias="provisioningState")
    routes: Optional[List[Route]] = Field(default=None, description="Gets or sets Routes in a Route Table")
    subnets: Optional[List[Subnet]] = Field(default=None, description="Gets collection of references to subnets")
    __properties: ClassVar[List[str]] = ["provisioningState", "routes", "subnets"]
...
RouteTablePropertiesFormat.model_rebuild(raise_errors=False)
