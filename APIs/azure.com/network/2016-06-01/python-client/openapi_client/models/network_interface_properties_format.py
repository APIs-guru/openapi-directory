...
class NetworkInterfacePropertiesFormat(BaseModel):
    ...
    ip_configurations: Optional[List[NetworkInterfaceIPConfiguration]] = Field(default=None, description="Gets or sets list of IPConfigurations of the network interface", alias="ipConfigurations")
...
NetworkInterfacePropertiesFormat.model_rebuild(raise_errors=False)
