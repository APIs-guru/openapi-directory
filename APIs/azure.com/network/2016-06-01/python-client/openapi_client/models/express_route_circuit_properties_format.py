...
class ExpressRouteCircuitPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowClassicOperations", "authorizations", "circuitProvisioningState", "gatewayManagerEtag", "peerings", "provisioningState", "serviceKey", "serviceProviderNotes", "serviceProviderProperties", "serviceProviderProvisioningState"]
