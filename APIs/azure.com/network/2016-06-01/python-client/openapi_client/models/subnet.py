...
class Subnet(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the resource that is unique within a resource group. This name can be used to access the resource")
    properties: Optional[SubnetPropertiesFormat] = None
...
Subnet.model_rebuild(raise_errors=False)
