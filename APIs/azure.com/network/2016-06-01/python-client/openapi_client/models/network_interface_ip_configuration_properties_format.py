...
class NetworkInterfaceIPConfigurationPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    application_gateway_backend_address_pools: Optional[List[ApplicationGatewayBackendAddressPool]] = Field(default=None, description="Gets or sets the reference of ApplicationGatewayBackendAddressPool resource", alias="applicationGatewayBackendAddressPools")
    load_balancer_backend_address_pools: Optional[List[BackendAddressPool]] = Field(default=None, description="Gets or sets the reference of LoadBalancerBackendAddressPool resource", alias="loadBalancerBackendAddressPools")
    load_balancer_inbound_nat_rules: Optional[List[InboundNatRule]] = Field(default=None, description="Gets or sets list of references of LoadBalancerInboundNatRules", alias="loadBalancerInboundNatRules")
    primary: Optional[StrictBool] = Field(default=None, description="Gets whether this is a primary customer address on the NIC")
    private_ip_address: Optional[StrictStr] = Field(default=None, alias="privateIPAddress")
    private_ip_address_version: Optional[StrictStr] = Field(default=None, description="Gets or sets PrivateIP address version (IPv4/IPv6)", alias="privateIPAddressVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationGatewayBackendAddressPools": [ApplicationGatewayBackendAddressPool.from_dict(_item) for _item in obj["applicationGatewayBackendAddressPools"]] if obj.get("applicationGatewayBackendAddressPools") is not None else None,
            "loadBalancerBackendAddressPools": [BackendAddressPool.from_dict(_item) for _item in obj["loadBalancerBackendAddressPools"]] if obj.get("loadBalancerBackendAddressPools") is not None else None,
            "loadBalancerInboundNatRules": [InboundNatRule.from_dict(_item) for _item in obj["loadBalancerInboundNatRules"]] if obj.get("loadBalancerInboundNatRules") is not None else None,
...
NetworkInterfaceIPConfigurationPropertiesFormat.model_rebuild(raise_errors=False)
