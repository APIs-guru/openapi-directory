...
class SecurityRuleListResult(BaseModel):
    """
    ...
    value: Optional[List[SecurityRule]] = Field(default=None, description="Gets security rules in a network security group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SecurityRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
