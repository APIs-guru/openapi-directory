...
class ApplicationGatewayBackendHttpSettingsPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    authentication_certificates: Optional[List[SubResource]] = Field(default=None, description="Array of references to Application Gateway Authentication Certificates", alias="authenticationCertificates")
    cookie_based_affinity: Optional[StrictStr] = Field(default=None, description="Cookie affinity", alias="cookieBasedAffinity")
    ...
    request_timeout: Optional[StrictInt] = Field(default=None, description="Request timeout", alias="requestTimeout")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authenticationCertificates": [SubResource.from_dict(_item) for _item in obj["authenticationCertificates"]] if obj.get("authenticationCertificates") is not None else None,
