...
class UsagesApi:
    ...
    def usages_list(
        self,
        location: Annotated[str, Field(strict=True, description="The location upon which resource usage is queried.")],
        ...
        :param location: The location upon which resource usage is queried. (required)
        :type location: str
    ...
    def _usages_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/usages',
