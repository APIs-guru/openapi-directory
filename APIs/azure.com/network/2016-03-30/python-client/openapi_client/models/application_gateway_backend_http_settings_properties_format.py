...
class ApplicationGatewayBackendHttpSettingsPropertiesFormat(BaseModel):
    ...
    request_timeout: Optional[StrictInt] = Field(default=None, description="Gets or sets request timeout", alias="requestTimeout")
    __properties: ClassVar[List[str]] = ["cookieBasedAffinity", "port", "probe", "protocol", "provisioningState", "requestTimeout"]
