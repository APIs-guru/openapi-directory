...
class VpnClientConfiguration(BaseModel):
    ...
    """ # noqa: E501
    vpn_client_address_pool: Optional[AddressSpace] = Field(default=None, alias="vpnClientAddressPool")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vpnClientAddressPool": AddressSpace.from_dict(obj["vpnClientAddressPool"]) if obj.get("vpnClientAddressPool") is not None else None,
