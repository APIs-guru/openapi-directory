...
class PublicIPAddressPropertiesFormat(BaseModel):
    ...
    public_ip_address_version: Optional[StrictStr] = Field(default=None, description="Gets or sets PublicIP address version (IPv4/IPv6)", alias="publicIPAddressVersion")
    public_ip_allocation_method: Optional[StrictStr] = Field(default=None, description="Gets or sets PublicIP allocation method (Static/Dynamic)", alias="publicIPAllocationMethod")
...
PublicIPAddressPropertiesFormat.model_rebuild(raise_errors=False)
