...
class VirtualNetworkListResult(BaseModel):
    """
    ...
    value: Optional[List[VirtualNetwork]] = Field(default=None, description="Gets list of VirtualNetworks in a resource group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VirtualNetwork.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
