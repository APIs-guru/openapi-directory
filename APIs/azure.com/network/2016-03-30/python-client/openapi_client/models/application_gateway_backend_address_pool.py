...
class ApplicationGatewayBackendAddressPool(BaseModel):
    """
    ...
    properties: Optional[ApplicationGatewayBackendAddressPoolPropertiesFormat] = None
...
ApplicationGatewayBackendAddressPool.model_rebuild(raise_errors=False)
