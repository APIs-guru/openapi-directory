...
class ExpressRouteCircuitsArpTableListResult(BaseModel):
    """
    ...
    value: Optional[List[ExpressRouteCircuitArpTable]] = Field(default=None, description="Gets List of ArpTable")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ExpressRouteCircuitArpTable.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
