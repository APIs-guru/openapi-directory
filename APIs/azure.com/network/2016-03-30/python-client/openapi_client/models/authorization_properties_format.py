...
class AuthorizationPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    authorization_key: Optional[StrictStr] = Field(default=None, description="Gets or sets the authorization key", alias="authorizationKey")
    authorization_use_status: Optional[StrictStr] = Field(default=None, description="Gets or sets AuthorizationUseStatus", alias="authorizationUseStatus")
