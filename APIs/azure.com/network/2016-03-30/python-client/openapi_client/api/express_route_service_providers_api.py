...
class ExpressRouteServiceProvidersApi:
    ...
    @validate_call
    def express_route_service_providers_list(
        self,
        ...
        _param = self._express_route_service_providers_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressRouteServiceProviderListResult",
        }
    ...
    @validate_call
    def express_route_service_providers_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressRouteServiceProviderListResult]:
        """express_route_service_providers_list
    ...
    @validate_call
    def express_route_service_providers_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
    ...
    def _express_route_service_providers_list_serialize(
        self,
        api_version,
        subscription_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Network/expressRouteServiceProviders',
