...
class VirtualNetworkGatewaysApi:
    ...
    def virtual_network_gateways_create_or_update(
        ...
        parameters: Annotated[VirtualNetworkGateway, Field(description="Parameters supplied to the Begin Create or update Virtual Network Gateway operation through Network resource provider.")],
    ...
    def virtual_network_gateways_generatevpnclientpackage(
        ...
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[VpnClientParameters, Field(description="Parameters supplied to the Begin Generating  Virtual Network Gateway Vpn client package operation through Network resource provider.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def virtual_network_gateways_reset(
        ...
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[VirtualNetworkGateway, Field(description="Parameters supplied to the Begin Reset Virtual Network Gateway operation through Network resource provider.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
