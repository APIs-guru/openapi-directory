...
------------ | ------------- | ------------- | -------------
**localized_value** | **str** | Gets or sets a localized string describing the resource name. | [optional] 
**value** | **str** | Gets or sets a string describing the resource name. | [optional] 
