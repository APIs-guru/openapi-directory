...
**host_name** | **str** | Gets or sets the host name of http listener  | [optional] 
**protocol** | **str** | Gets or sets the protocol | [optional] 
**provisioning_state** | **str** | Gets or sets Provisioning state of the http listener resource Updating/Deleting/Failed | [optional] 
**require_server_name_indication** | **bool** | Gets or sets the requireServerNameIndication of http listener  | [optional] 
