...
**probes** | [**List[ApplicationGatewayProbe]**](ApplicationGatewayProbe.md) | Gets or sets probes of application gateway resource | [optional] 
...
**url_path_maps** | [**List[ApplicationGatewayUrlPathMap]**](ApplicationGatewayUrlPathMap.md) | Gets or sets URL path map of application gateway resource | [optional] 
