...
# **subnets_get**
> Subnet subnets_get(resource_group_name, virtual_network_name, subnet_name, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.subnets_get(resource_group_name, virtual_network_name, subnet_name, api_version, subscription_id, expand=expand)
