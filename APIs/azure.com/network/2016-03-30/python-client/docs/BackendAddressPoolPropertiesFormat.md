...
------------ | ------------- | ------------- | -------------
**backend_ip_configurations** | [**List[NetworkInterfaceIPConfiguration]**](NetworkInterfaceIPConfiguration.md) | Gets collection of references to IPs defined in NICs | [optional] 
**load_balancing_rules** | [**List[SubResource]**](SubResource.md) | Gets Load Balancing rules that use this Backend Address Pool | [optional] 
