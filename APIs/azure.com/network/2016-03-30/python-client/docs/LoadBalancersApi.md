...
# **load_balancers_get**
> LoadBalancer load_balancers_get(resource_group_name, load_balancer_name, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.load_balancers_get(resource_group_name, load_balancer_name, api_version, subscription_id, expand=expand)
