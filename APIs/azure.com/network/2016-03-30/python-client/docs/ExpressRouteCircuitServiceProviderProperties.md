...
------------ | ------------- | ------------- | -------------
**bandwidth_in_mbps** | **int** | Gets or sets BandwidthInMbps. | [optional] 
**peering_location** | **str** | Gets or sets peering location. | [optional] 
**service_provider_name** | **str** | Gets or sets serviceProviderName. | [optional] 
