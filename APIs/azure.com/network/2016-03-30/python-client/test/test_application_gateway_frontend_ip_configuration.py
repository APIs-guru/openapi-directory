...
class TestApplicationGatewayFrontendIPConfiguration(unittest.TestCase):
    """ApplicationGatewayFrontendIPConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationGatewayFrontendIPConfiguration:
        """Test ApplicationGatewayFrontendIPConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationGatewayFrontendIPConfiguration`
        """
        model = ApplicationGatewayFrontendIPConfiguration()
        if include_optional:
    ...
    def testApplicationGatewayFrontendIPConfiguration(self):
        """Test ApplicationGatewayFrontendIPConfiguration"""
