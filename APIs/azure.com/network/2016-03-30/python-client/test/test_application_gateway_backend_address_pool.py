...
class TestApplicationGatewayBackendAddressPool(unittest.TestCase):
    """ApplicationGatewayBackendAddressPool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationGatewayBackendAddressPool:
        """Test ApplicationGatewayBackendAddressPool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationGatewayBackendAddressPool`
        """
    ...
    def testApplicationGatewayBackendAddressPool(self):
        """Test ApplicationGatewayBackendAddressPool"""
