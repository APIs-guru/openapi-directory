...
class AddressSpace(BaseModel):
    ...
    """ # noqa: E501
    address_prefixes: Optional[List[StrictStr]] = Field(default=None, description="Gets or sets List of address blocks reserved for this virtual network in CIDR notation", alias="addressPrefixes")
