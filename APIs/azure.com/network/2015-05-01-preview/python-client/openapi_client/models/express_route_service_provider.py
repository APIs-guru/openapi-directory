...
class ExpressRouteServiceProvider(BaseModel):
    """
    ...
    properties: Optional[ExpressRouteServiceProviderPropertiesFormat] = None
    type: Optional[StrictStr] = Field(default=None, description="Gets or sets the type of the resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "properties": ExpressRouteServiceProviderPropertiesFormat.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
