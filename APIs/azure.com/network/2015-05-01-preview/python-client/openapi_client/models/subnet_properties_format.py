...
class SubnetPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    address_prefix: StrictStr = Field(description="Gets or sets Address prefix for the subnet.", alias="addressPrefix")
    ip_configurations: Optional[List[SubResource]] = Field(default=None, description="Gets array of references to the network interface IP configurations using subnet", alias="ipConfigurations")
    ...
    route_table: Optional[SubResource] = Field(default=None, alias="routeTable")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipConfigurations": [SubResource.from_dict(_item) for _item in obj["ipConfigurations"]] if obj.get("ipConfigurations") is not None else None,
            ...
            "routeTable": SubResource.from_dict(obj["routeTable"]) if obj.get("routeTable") is not None else None
        })
        return _obj
