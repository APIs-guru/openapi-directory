...
class ApplicationGatewayIPConfigurationPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Gets or sets Provisioning state of the application gateway subnet resource Updating/Deleting/Failed", alias="provisioningState")
