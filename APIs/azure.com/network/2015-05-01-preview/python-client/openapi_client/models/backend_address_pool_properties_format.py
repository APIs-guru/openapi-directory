...
class BackendAddressPoolPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    backend_ip_configurations: Optional[List[SubResource]] = Field(default=None, description="Gets collection of references to IPs defined in NICs", alias="backendIPConfigurations")
