...
class LoadBalancerListResult(BaseModel):
    """
    ...
    value: Optional[List[LoadBalancer]] = Field(default=None, description="Gets a list of LoadBalancers in a resource group")
