...
class FrontendIpConfigurationPropertiesFormat(BaseModel):
    ...
    private_ip_address: Optional[StrictStr] = Field(default=None, description="Gets or sets the IP address of the Load Balancer.This is only specified if a specific private IP address shall be allocated from the subnet specified in subnetRef", alias="privateIPAddress")
