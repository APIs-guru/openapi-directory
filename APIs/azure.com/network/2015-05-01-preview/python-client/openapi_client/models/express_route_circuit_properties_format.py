...
class ExpressRouteCircuitPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorizations", "circuitProvisioningState", "peerings", "provisioningState", "serviceKey", "serviceProviderNotes", "serviceProviderProperties", "serviceProviderProvisioningState"]
