...
class ApplicationGatewayPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backendAddressPools", "backendHttpSettingsCollection", "frontendIPConfigurations", "frontendPorts", "gatewayIPConfigurations", "httpListeners", "operationalState", "provisioningState", "requestRoutingRules", "resourceGuid", "sku", "sslCertificates"]
