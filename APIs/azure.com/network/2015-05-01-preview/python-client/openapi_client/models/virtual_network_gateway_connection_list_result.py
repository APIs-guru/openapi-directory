...
class VirtualNetworkGatewayConnectionListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets the URL to get the next set of results.", alias="nextLink")
    value: Optional[List[VirtualNetworkGatewayConnection]] = Field(default=None, description="Gets List of VirtualNetworkGatewayConnections that exists in a resource group")
