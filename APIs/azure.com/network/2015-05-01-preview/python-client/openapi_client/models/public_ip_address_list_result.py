...
class PublicIpAddressListResult(BaseModel):
    """
    ...
    value: Optional[List[PublicIpAddress]] = Field(default=None, description="Gets List of publicIP addresses that exists in a resource group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PublicIpAddress.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
