...
class ApplicationGatewayListResult(BaseModel):
    """
    ...
    value: Optional[List[ApplicationGateway]] = Field(default=None, description="Gets a list of ApplicationGateways in a resource group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ApplicationGateway.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
