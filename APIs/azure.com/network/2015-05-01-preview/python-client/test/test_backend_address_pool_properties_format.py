...
class TestBackendAddressPoolPropertiesFormat(unittest.TestCase):
    """BackendAddressPoolPropertiesFormat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackendAddressPoolPropertiesFormat:
        """Test BackendAddressPoolPropertiesFormat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackendAddressPoolPropertiesFormat`
        """
        model = BackendAddressPoolPropertiesFormat()
        if include_optional:
    ...
    def testBackendAddressPoolPropertiesFormat(self):
        """Test BackendAddressPoolPropertiesFormat"""
