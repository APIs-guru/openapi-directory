...
class TestDhcpOptions(unittest.TestCase):
    """DhcpOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DhcpOptions:
        """Test DhcpOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DhcpOptions`
        """
        model = DhcpOptions()
        if include_optional:
            return DhcpOptions(
