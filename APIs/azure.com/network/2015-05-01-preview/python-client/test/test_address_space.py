...
class TestAddressSpace(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddressSpace:
        """Test AddressSpace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressSpace`
        """
        model = AddressSpace()
        if include_optional:
            return AddressSpace(
