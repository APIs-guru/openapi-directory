...
class TestApplicationGatewayFrontendPort(unittest.TestCase):
    """ApplicationGatewayFrontendPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationGatewayFrontendPort:
        """Test ApplicationGatewayFrontendPort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationGatewayFrontendPort`
        """
        model = ApplicationGatewayFrontendPort()
        if include_optional:
    ...
    def testApplicationGatewayFrontendPort(self):
        """Test ApplicationGatewayFrontendPort"""
