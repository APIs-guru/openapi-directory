...
**network_interfaces** | [**List[SubResource]**](SubResource.md) | Gets collection of references to Network Interfaces | [optional] 
...
**subnets** | [**List[SubResource]**](SubResource.md) | Gets collection of references to subnets | [optional] 
