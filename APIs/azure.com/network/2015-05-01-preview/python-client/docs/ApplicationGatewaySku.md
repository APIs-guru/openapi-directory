...
------------ | ------------- | ------------- | -------------
**capacity** | **int** | Gets or sets capacity (instance count) of application gateway | [optional] 
**name** | **str** | Gets or sets name of application gateway SKU | [optional] 
**tier** | **str** | Gets or sets tier of application gateway | [optional] 
