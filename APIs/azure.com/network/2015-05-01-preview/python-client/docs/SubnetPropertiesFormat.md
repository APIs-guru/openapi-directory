...
**ip_configurations** | [**List[SubResource]**](SubResource.md) | Gets array of references to the network interface IP configurations using subnet | [optional] 
...
**route_table** | [**SubResource**](SubResource.md) |  | [optional] 
