...
# **route_tables_get**
> RouteTable route_tables_get(resource_group_name, route_table_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.route_tables_get(resource_group_name, route_table_name, api_version, subscription_id)
