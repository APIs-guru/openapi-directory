...
------------ | ------------- | ------------- | -------------
**advertised_public_prefixes** | **List[str]** | Gets or sets the reference of AdvertisedPublicPrefixes | [optional] 
**advertised_public_prefixes_state** | **str** | Gets or sets AdvertisedPublicPrefixState of the Peering resource  | [optional] 
**customer_asn** | **int** | Gets or Sets CustomerAsn of the peering. | [optional] 
**routing_registry_name** | **str** | Gets or Sets RoutingRegistryName of the config. | [optional] 
