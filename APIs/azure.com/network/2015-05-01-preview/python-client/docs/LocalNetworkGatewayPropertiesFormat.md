...
**local_network_address_space** | [**AddressSpace**](AddressSpace.md) |  | [optional] 
...
**resource_guid** | **str** | Gets or sets resource guid property of the LocalNetworkGateway resource | [optional] 
