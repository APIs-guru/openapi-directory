...
------------- | ------------- | -------------
[**event_hubs_list_by_namespace**](EventHubsApi.md#event_hubs_list_by_namespace) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/eventhubs | 


# **event_hubs_list_by_namespace**
> EventHubListResult event_hubs_list_by_namespace(resource_group_name, namespace_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.event_hubs_list_by_namespace(resource_group_name, namespace_name, api_version, subscription_id)
        print("The response of EventHubsApi->event_hubs_list_by_namespace:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventHubsApi->event_hubs_list_by_namespace: %s\n" % e)
```
