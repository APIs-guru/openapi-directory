...
class TestSBQueueProperties(unittest.TestCase):
    """SBQueueProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBQueueProperties:
        """Test SBQueueProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBQueueProperties`
        """
        model = SBQueueProperties()
        if include_optional:
            return SBQueueProperties(
    ...
    def testSBQueueProperties(self):
        """Test SBQueueProperties"""
