...
class TestSBTopicProperties(unittest.TestCase):
    """SBTopicProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBTopicProperties:
        """Test SBTopicProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBTopicProperties`
        """
    ...
    def testSBTopicProperties(self):
        """Test SBTopicProperties"""
