...
class TestSBSubscription(unittest.TestCase):
    """SBSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBSubscription:
        """Test SBSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBSubscription`
        """
