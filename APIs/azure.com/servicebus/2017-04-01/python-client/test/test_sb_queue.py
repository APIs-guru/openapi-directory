...
class TestSBQueue(unittest.TestCase):
    """SBQueue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBQueue:
        """Test SBQueue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBQueue`
        """
        model = SBQueue()
        if include_optional:
            return SBQueue(
