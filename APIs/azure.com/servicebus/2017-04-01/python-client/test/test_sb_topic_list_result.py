...
class TestSBTopicListResult(unittest.TestCase):
    """SBTopicListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBTopicListResult:
        """Test SBTopicListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBTopicListResult`
        """
        model = SBTopicListResult()
        if include_optional:
            return SBTopicListResult(
                next_link = '',
                value = [
                    openapi_client.models.sb_topic.SBTopic(
                        properties = openapi_client.models.sb_topic_properties.SBTopicProperties(
    ...
    def testSBTopicListResult(self):
        """Test SBTopicListResult"""
