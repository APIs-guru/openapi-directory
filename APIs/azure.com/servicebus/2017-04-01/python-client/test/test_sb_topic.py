...
class TestSBTopic(unittest.TestCase):
    """SBTopic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SBTopic:
        """Test SBTopic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SBTopic`
        """
        model = SBTopic()
        if include_optional:
            return SBTopic(
