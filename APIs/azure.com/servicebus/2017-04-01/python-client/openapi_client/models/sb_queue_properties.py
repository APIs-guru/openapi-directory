...
class SBQueueProperties(BaseModel):
    """
    ...
    auto_delete_on_idle: Optional[StrictStr] = Field(default=None, description="ISO 8061 timeSpan idle interval after which the queue is automatically deleted. The minimum duration is 5 minutes.", alias="autoDeleteOnIdle")
    ...
    default_message_time_to_live: Optional[StrictStr] = Field(default=None, description="ISO 8601 default message timespan to live value. This is the duration after which the message expires, starting from when the message is sent to Service Bus. This is the default value used when TimeToLive is not set on a message itself.", alias="defaultMessageTimeToLive")
    ...
    lock_duration: Optional[StrictStr] = Field(default=None, description="ISO 8601 timespan duration of a peek-lock; that is, the amount of time that the message is locked for other receivers. The maximum value for LockDuration is 5 minutes; the default value is 1 minute.", alias="lockDuration")
    max_delivery_count: Optional[StrictInt] = Field(default=None, description="The maximum delivery count. A message is automatically deadlettered after this number of deliveries. default value is 10.", alias="maxDeliveryCount")
    max_size_in_megabytes: Optional[StrictInt] = Field(default=None, description="The maximum size of the queue in megabytes, which is the size of memory allocated for the queue. Default is 1024.", alias="maxSizeInMegabytes")
