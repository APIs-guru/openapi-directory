...
class MigrationConfigProperties(BaseModel):
    """
    Single item in List or Get Migration Config operation
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="Properties required to the Create Migration Configuration")
