...
class ArmDisasterRecovery(BaseModel):
    """
    Single item in List or Get Alias(Disaster Recovery configuration) operation
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="Properties required to the Create Or Update Alias(Disaster Recovery configurations)")
