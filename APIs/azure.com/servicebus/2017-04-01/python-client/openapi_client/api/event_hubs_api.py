...
class EventHubsApi:
    ...
    @validate_call
    def event_hubs_list_by_namespace(
        self,
        ...
        _param = self._event_hubs_list_by_namespace_serialize(
    ...
    @validate_call
    def event_hubs_list_by_namespace_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def event_hubs_list_by_namespace_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _event_hubs_list_by_namespace_serialize(
        self,
        resource_group_name,
        namespace_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/eventhubs',
