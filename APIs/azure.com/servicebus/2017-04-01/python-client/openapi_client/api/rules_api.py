...
class RulesApi:
    ...
    def rules_create_or_update(
        ...
        parameters: Annotated[Rule, Field(description="Parameters supplied to create a rule.")],
        ...
        _param = self._rules_create_or_update_serialize(
    ...
    @validate_call
    def rules_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    @validate_call
    def rules_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    def _rules_create_or_update_serialize(
        self,
        resource_group_name,
        namespace_name,
        topic_name,
    ...
    def rules_delete(
        ...
        _param = self._rules_delete_serialize(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            topic_name=topic_name,
            subscription_name=subscription_name,
    ...
    @validate_call
    def rules_delete_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    @validate_call
    def rules_delete_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    @validate_call
    def rules_list_by_subscriptions(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
        ...
        _param = self._rules_list_by_subscriptions_serialize(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            topic_name=topic_name,
            subscription_name=subscription_name,
    ...
    @validate_call
    def rules_list_by_subscriptions_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    @validate_call
    def rules_list_by_subscriptions_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        topic_name: Annotated[str, Field(min_length=1, strict=True, description="The topic name.")],
    ...
    def _rules_list_by_subscriptions_serialize(
        self,
        resource_group_name,
        namespace_name,
        topic_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/subscriptions/{subscriptionName}/rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
