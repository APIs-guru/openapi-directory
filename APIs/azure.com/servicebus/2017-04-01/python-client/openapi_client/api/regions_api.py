...
class RegionsApi:
    ...
    def regions_list_by_sku(
        ...
        sku: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The sku type.")],
        ...
        _param = self._regions_list_by_sku_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PremiumMessagingRegionsListResult",
        }
    ...
    @validate_call
    def regions_list_by_sku_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        sku: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The sku type.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PremiumMessagingRegionsListResult]:
        """regions_list_by_sku
    ...
    @validate_call
    def regions_list_by_sku_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        sku: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The sku type.")],
    ...
    def _regions_list_by_sku_serialize(
        self,
        api_version,
        subscription_id,
        sku,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/sku/{sku}/regions',
