...
class NamespaceCreateOrUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    location: StrictStr = Field(description="Namespace location.")
    properties: Optional[NamespaceProperties] = None
    sku: Optional[Sku] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Namespace tags.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NamespaceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
