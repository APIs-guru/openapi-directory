...
class SubscriptionListResult(BaseModel):
    ...
    value: Optional[List[SubscriptionResource]] = Field(default=None, description="Result of the List Subscriptions operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SubscriptionResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
