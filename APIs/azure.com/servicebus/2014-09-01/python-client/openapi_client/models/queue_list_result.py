...
class QueueListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next set of results. Not empty if Value contains incomplete list of queues.", alias="nextLink")
    value: Optional[List[QueueResource]] = Field(default=None, description="Result of the List Queues operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [QueueResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
