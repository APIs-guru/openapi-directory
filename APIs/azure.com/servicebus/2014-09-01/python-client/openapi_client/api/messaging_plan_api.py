...
class MessagingPlanApi:
    ...
    @validate_call
    def messaging_plan_create_or_update(
        self,
        ...
        parameters: Annotated[MessagingPlan, Field(description="Parameters supplied to create a messaging plan.")],
        ...
        _param = self._messaging_plan_create_or_update_serialize(
    ...
    @validate_call
    def messaging_plan_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[StrictStr, Field(description="The namespace name.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def messaging_plan_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[StrictStr, Field(description="The namespace name.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _messaging_plan_create_or_update_serialize(
        self,
        resource_group_name,
        namespace_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/messagingplan',
    ...
    def messaging_plan_get(
        ...
        _param = self._messaging_plan_get_serialize(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def messaging_plan_get_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def messaging_plan_get_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of the Resource group within the Azure subscription.")],
        namespace_name: Annotated[str, Field(min_length=6, strict=True, max_length=50, description="The namespace name")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _messaging_plan_get_serialize(
        self,
        resource_group_name,
        namespace_name,
        api_version,
