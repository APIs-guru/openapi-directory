...
class TestQueueCreateOrUpdateParameters(unittest.TestCase):
    """QueueCreateOrUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueueCreateOrUpdateParameters:
        """Test QueueCreateOrUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueueCreateOrUpdateParameters`
        """
        model = QueueCreateOrUpdateParameters()
        if include_optional:
            return QueueCreateOrUpdateParameters(
                location = '',
                name = '',
    ...
    def testQueueCreateOrUpdateParameters(self):
        """Test QueueCreateOrUpdateParameters"""
