...
class TestTopicCreateOrUpdateParameters(unittest.TestCase):
    """TopicCreateOrUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopicCreateOrUpdateParameters:
        """Test TopicCreateOrUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopicCreateOrUpdateParameters`
        """
        model = TopicCreateOrUpdateParameters()
        if include_optional:
            return TopicCreateOrUpdateParameters(
                location = '',
                name = '',
    ...
    def testTopicCreateOrUpdateParameters(self):
        """Test TopicCreateOrUpdateParameters"""
