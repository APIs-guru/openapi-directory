...
class TestSubscriptionCreateOrUpdateParameters(unittest.TestCase):
    """SubscriptionCreateOrUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionCreateOrUpdateParameters:
        """Test SubscriptionCreateOrUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionCreateOrUpdateParameters`
        """
        model = SubscriptionCreateOrUpdateParameters()
        if include_optional:
            return SubscriptionCreateOrUpdateParameters(
                location = '',
    ...
    def testSubscriptionCreateOrUpdateParameters(self):
        """Test SubscriptionCreateOrUpdateParameters"""
