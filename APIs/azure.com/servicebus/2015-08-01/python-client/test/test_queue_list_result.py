...
class TestQueueListResult(unittest.TestCase):
    """QueueListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueueListResult:
        """Test QueueListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueueListResult`
        """
        model = QueueListResult()
        if include_optional:
            return QueueListResult(
                next_link = '',
                value = [
                    openapi_client.models.queue_resource.QueueResource(
