...
class TestTopicListResult(unittest.TestCase):
    """TopicListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopicListResult:
        """Test TopicListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopicListResult`
        """
        model = TopicListResult()
        if include_optional:
            return TopicListResult(
                next_link = '',
                value = [
                    openapi_client.models.topic_resource.TopicResource(
