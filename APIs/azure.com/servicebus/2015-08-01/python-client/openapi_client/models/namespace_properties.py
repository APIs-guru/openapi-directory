...
class NamespaceProperties(BaseModel):
    ...
    """ # noqa: E501
    create_acs_namespace: Optional[StrictBool] = Field(default=None, description="Indicates whether to create an ACS namespace.", alias="createACSNamespace")
    ...
    __properties: ClassVar[List[str]] = ["createACSNamespace", "createdAt", "enabled", "provisioningState", "serviceBusEndpoint", "status", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createACSNamespace": obj.get("createACSNamespace"),
