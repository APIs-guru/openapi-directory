...
**auto_delete_on_idle** | **str** | the TimeSpan idle interval after which the queue is automatically deleted. The minimum duration is 5 minutes. | [optional] 
...
**default_message_time_to_live** | **str** | The default message time to live value. This is the duration after which the message expires, starting from when the message is sent to Service Bus. This is the default value used when TimeToLive is not set on a message itself. | [optional] 
...
**enable_batched_operations** | **bool** | A value that indicates whether server-side batched operations are enabled. | [optional] 
...
**is_anonymous_accessible** | **bool** | A value that indicates whether the message is accessible anonymously. | [optional] 
**lock_duration** | **str** | The duration of a peek-lock; that is, the amount of time that the message is locked for other receivers. The maximum value for LockDuration is 5 minutes; the default value is 1 minute. | [optional] 
**max_delivery_count** | **int** | The maximum delivery count. A message is automatically deadlettered after this number of deliveries. | [optional] 
**max_size_in_megabytes** | **int** | The maximum size of the queue in megabytes, which is the size of memory allocated for the queue. | [optional] 
...
**support_ordering** | **bool** | A value that indicates whether the queue supports ordering. | [optional] 
...
queue_properties_instance = QueueProperties.from_json(json)
# print the JSON string representation of the object
print(QueueProperties.to_json())

# convert the object into a dict
queue_properties_dict = queue_properties_instance.to_dict()
# create an instance of QueueProperties from a dict
queue_properties_from_dict = QueueProperties.from_dict(queue_properties_dict)
```
