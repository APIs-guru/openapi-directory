...
class DatabaseAdvisorsApi:
    ...
    @validate_call
    def database_advisors_create_or_update(
        self,
        ...
        advisor_name: Annotated[StrictStr, Field(description="The name of the Database Advisor.")],
        ...
        _param = self._database_advisors_create_or_update_serialize(
    ...
    @validate_call
    def database_advisors_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def database_advisors_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _database_advisors_create_or_update_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/advisors/{advisorName}',
    ...
    def database_advisors_get(
        ...
        _param = self._database_advisors_get_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            database_name=database_name,
            advisor_name=advisor_name,
    ...
    @validate_call
    def database_advisors_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def database_advisors_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _database_advisors_get_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
    ...
    @validate_call
    def database_advisors_list_by_database(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _param = self._database_advisors_list_by_database_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            database_name=database_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def database_advisors_list_by_database_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def database_advisors_list_by_database_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _database_advisors_list_by_database_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/advisors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
