...
[**database_advisors_update**](DatabaseAdvisorsApi.md#database_advisors_update) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/advisors/{advisorName} | 
...
> List[Advisor] database_advisors_list_by_database(resource_group_name, server_name, database_name, subscription_id, api_version)
...
# **database_advisors_update**
> Advisor database_advisors_update(resource_group_name, server_name, database_name, advisor_name, subscription_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.database_advisors_update(resource_group_name, server_name, database_name, advisor_name, subscription_id, api_version, parameters)
        print("The response of DatabaseAdvisorsApi->database_advisors_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DatabaseAdvisorsApi->database_advisors_update: %s\n" % e)
```
