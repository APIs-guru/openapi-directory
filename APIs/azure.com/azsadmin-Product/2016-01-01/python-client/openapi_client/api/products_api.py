...
class ProductsApi:
    ...
    def products_download(
        ...
        _param = self._products_download_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductsDownload200Response",
            '202': "ProductsDownload200Response",
            '404': None,
        }
    ...
    @validate_call
    def products_download_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="The resource group the resource is located under.")],
        activation_name: Annotated[StrictStr, Field(description="Name of the activation.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductsDownload200Response]:
        """products_download
    ...
    @validate_call
    def products_download_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription.The subscription ID forms part of the URI for every service call.")],
        resource_group: Annotated[StrictStr, Field(description="The resource group the resource is located under.")],
        activation_name: Annotated[StrictStr, Field(description="Name of the activation.")],
    ...
    def _products_download_serialize(
        self,
        subscription_id,
        resource_group,
        activation_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products/{productName}/download',
    ...
    def _products_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products/{productName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def products_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductResourcesPage]:
        """products_list
    ...
    def _products_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
