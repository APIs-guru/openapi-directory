...
class SharesListMetrics200ResponseValueInner(BaseModel):
    """
    Metric information.
    """ # noqa: E501
    ...
    metric_values: Optional[List[SharesListMetrics200ResponseValueInnerMetricValuesInner]] = Field(default=None, description="List of metric values.", alias="metricValues")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricValues": [SharesListMetrics200ResponseValueInnerMetricValuesInner.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None,
