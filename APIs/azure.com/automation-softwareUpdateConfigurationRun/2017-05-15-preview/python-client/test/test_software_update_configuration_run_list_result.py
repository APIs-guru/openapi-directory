...
class TestSoftwareUpdateConfigurationRunListResult(unittest.TestCase):
    """SoftwareUpdateConfigurationRunListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareUpdateConfigurationRunListResult:
        """Test SoftwareUpdateConfigurationRunListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareUpdateConfigurationRunListResult`
        """
        ...
        if include_optional:
            return SoftwareUpdateConfigurationRunListResult(
                next_link = '',
                value = [
                    openapi_client.models.software_update_configuration_run.softwareUpdateConfigurationRun(
                        id = '', 
                        name = '', 
                        properties = openapi_client.models.software_update_configuration_run_properties.softwareUpdateConfigurationRunProperties(
                            computer_count = 56, 
                            configured_duration = '', 
                            created_by = '', 
    ...
    def testSoftwareUpdateConfigurationRunListResult(self):
        """Test SoftwareUpdateConfigurationRunListResult"""
