...
class SoftwareUpdateConfigurationRunListResult(BaseModel):
    """
    ...
    value: Optional[List[SoftwareUpdateConfigurationRun]] = Field(default=None, description="outer object returned when listing all software update configuration runs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SoftwareUpdateConfigurationRun.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
