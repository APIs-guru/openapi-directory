...
class ApplicationOperationResultList(BaseModel):
    """
    ...
    value: Optional[List[ApplicationOperationResult]] = Field(default=None, description="List of application operation results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ApplicationOperationResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
