...
class ActionGroup(BaseModel):
    ...
    """ # noqa: E501
    arm_role_receivers: Optional[List[ArmRoleReceiver]] = Field(default=None, description="The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.", alias="armRoleReceivers")
    ...
    __properties: ClassVar[List[str]] = ["armRoleReceivers", "automationRunbookReceivers", "azureAppPushReceivers", "azureFunctionReceivers", "emailReceivers", "enabled", "groupShortName", "itsmReceivers", "logicAppReceivers", "smsReceivers", "voiceReceivers", "webhookReceivers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in arm_role_receivers (list)
        _items = []
        if self.arm_role_receivers:
            for _item_arm_role_receivers in self.arm_role_receivers:
                if _item_arm_role_receivers:
                    _items.append(_item_arm_role_receivers.to_dict())
            _dict['armRoleReceivers'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "armRoleReceivers": [ArmRoleReceiver.from_dict(_item) for _item in obj["armRoleReceivers"]] if obj.get("armRoleReceivers") is not None else None,
