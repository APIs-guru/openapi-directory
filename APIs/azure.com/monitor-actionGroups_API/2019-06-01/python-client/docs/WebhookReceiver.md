...
------------ | ------------- | ------------- | -------------
**identifier_uri** | **str** | Indicates the identifier uri for aad auth. | [optional] 
**name** | **str** | The name of the webhook receiver. Names must be unique across all receivers within an action group. | 
**object_id** | **str** | Indicates the webhook app object Id for aad auth. | [optional] 
**service_uri** | **str** | The URI where webhooks should be sent. | 
**tenant_id** | **str** | Indicates the tenant id for aad auth. | [optional] 
**use_aad_auth** | **bool** | Indicates whether or not use AAD authentication. | [optional] [default to False]
