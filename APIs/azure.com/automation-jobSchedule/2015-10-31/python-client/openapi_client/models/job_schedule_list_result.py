...
class JobScheduleListResult(BaseModel):
    """
    ...
    value: Optional[List[JobSchedule]] = Field(default=None, description="Gets or sets a list of job schedules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [JobSchedule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
