...
class OpenidConnectProviderApi:
    ...
    def open_id_connect_provider_create_or_update(
        ...
        parameters: Annotated[OpenIdConnectProviderGet200Response, Field(description="Create parameters.")],
        ...
        :type parameters: OpenIdConnectProviderGet200Response
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OpenIdConnectProviderGet200Response",
            '201': "OpenIdConnectProviderGet200Response",
        }
    ...
    def open_id_connect_provider_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OpenIdConnectProviderGet200Response]:
        """open_id_connect_provider_create_or_update
    ...
    def open_id_connect_provider_list_by_service(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OpenIdConnectProviderListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def open_id_connect_provider_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OpenIdConnectProviderListByService200Response]:
        """open_id_connect_provider_list_by_service
    ...
    @validate_call
    def open_id_connect_provider_list_secrets(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        opid: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the OpenID Connect Provider.")],
        ...
        _param = self._open_id_connect_provider_list_secrets_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            opid=opid,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OpenIdConnectProviderListSecrets200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def open_id_connect_provider_list_secrets_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        opid: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the OpenID Connect Provider.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OpenIdConnectProviderListSecrets200Response]:
        """open_id_connect_provider_list_secrets
    ...
    @validate_call
    def open_id_connect_provider_list_secrets_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        opid: Annotated[str, Field(strict=True, max_length=256, description="Identifier of the OpenID Connect Provider.")],
    ...
    def _open_id_connect_provider_list_secrets_serialize(
        self,
        resource_group_name,
        service_name,
        opid,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}/listSecrets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def open_id_connect_provider_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[OpenIdConnectProviderUpdateRequest, Field(description="Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: OpenIdConnectProviderUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
