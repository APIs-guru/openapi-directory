...
class OpenIdConnectProviderListByService200ResponseValueInnerProperties(BaseModel):
    """
    OpenID Connect Providers Contract.
    """ # noqa: E501
    client_id: StrictStr = Field(description="Client ID of developer console which is the client application.", alias="clientId")
    ...
    display_name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="User-friendly OpenID Connect Provider name.", alias="displayName")
    metadata_endpoint: StrictStr = Field(description="Metadata endpoint URI.", alias="metadataEndpoint")
