...
class OpenIdConnectProviderListByService200ResponseValueInner(BaseModel):
    """
    OpenId Connect Provider details.
    """ # noqa: E501
    properties: Optional[OpenIdConnectProviderListByService200ResponseValueInnerProperties] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenIdConnectProviderListByService200ResponseValueInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenIdConnectProviderListByService200ResponseValueInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "properties": OpenIdConnectProviderListByService200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
