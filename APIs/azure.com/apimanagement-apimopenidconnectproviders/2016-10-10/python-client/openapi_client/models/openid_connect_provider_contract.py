...
class OpenidConnectProviderContract(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="OpenID Connect Provider identifier.")
    metadata_endpoint: StrictStr = Field(description="Metadata endpoint URI.", alias="metadataEndpoint")
    name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="User-friendly OpenID Connect Provider name.")
    __properties: ClassVar[List[str]] = ["clientId", "clientSecret", "description", "id", "metadataEndpoint", "name"]
