...
class OpenidConnectProviderUpdateContract(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="User-friendly OpenID Connect Provider name.")
    __properties: ClassVar[List[str]] = ["clientId", "clientSecret", "description", "metadataEndpoint", "name"]
