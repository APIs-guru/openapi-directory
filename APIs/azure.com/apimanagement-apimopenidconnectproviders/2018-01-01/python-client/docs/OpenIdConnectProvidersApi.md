...
> OpenidConnectProviderContract open_id_connect_provider_create_or_update(resource_group_name, service_name, opid, api_version, subscription_id, parameters, if_match=if_match)
