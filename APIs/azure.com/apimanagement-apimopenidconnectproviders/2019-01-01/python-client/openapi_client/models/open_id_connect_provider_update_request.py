...
class OpenIdConnectProviderUpdateRequest(BaseModel):
    """
    Parameters supplied to the Update OpenID Connect Provider operation.
    """ # noqa: E501
    properties: Optional[OpenIdConnectProviderUpdateRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": OpenIdConnectProviderUpdateRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
