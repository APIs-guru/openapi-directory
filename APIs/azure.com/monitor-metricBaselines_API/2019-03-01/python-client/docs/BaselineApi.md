...
------------- | ------------- | -------------
[**baselines_list**](BaselineApi.md#baselines_list) | **GET** /{resourceUri}/providers/microsoft.insights/metricBaselines | 


# **baselines_list**
> MetricBaselinesResponse baselines_list(resource_uri, api_version, metricnames=metricnames, metricnamespace=metricnamespace, timespan=timespan, interval=interval, aggregation=aggregation, sensitivities=sensitivities, filter=filter, result_type=result_type)
