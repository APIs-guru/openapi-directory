...
class MetricBaselinesResponse(BaseModel):
    """
    A list of metric baselines.
    """ # noqa: E501
    value: Optional[List[SingleMetricBaseline]] = Field(default=None, description="The list of metric baselines.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SingleMetricBaseline.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
