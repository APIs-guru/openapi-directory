...
class AzureMetricsDocument(BaseModel):
    """
    AzureMetricsDocument
    """ # noqa: E501
    data: AzureMetricsData
    time: StrictStr = Field(description="Gets or sets Time property (in ISO 8601 format)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AzureMetricsData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "time": obj.get("time")
        })
        return _obj
