...
class WebApplicationFirewallManagedRuleSetsApi:
    ...
    def managed_rule_sets_list(
        ...
        _param = self._managed_rule_sets_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagedRuleSetDefinitionList",
        }
    ...
    @validate_call
    def managed_rule_sets_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagedRuleSetDefinitionList]:
        """managed_rule_sets_list
    ...
    @validate_call
    def managed_rule_sets_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-04-02.")],
        _request_timeout: Union[
    ...
    def _managed_rule_sets_list_serialize(
        self,
        subscription_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Cdn/CdnWebApplicationFirewallManagedRuleSets',
