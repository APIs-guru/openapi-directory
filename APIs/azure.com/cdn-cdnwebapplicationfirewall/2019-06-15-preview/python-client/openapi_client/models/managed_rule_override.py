...
class ManagedRuleOverride(BaseModel):
    ...
    enabled_state: Optional[StrictStr] = Field(default=None, description="Describes if the managed rule is in enabled or disabled state. Defaults to Disabled if not specified.", alias="enabledState")
