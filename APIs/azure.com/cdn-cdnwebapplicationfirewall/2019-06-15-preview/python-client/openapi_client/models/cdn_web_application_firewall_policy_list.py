...
class CdnWebApplicationFirewallPolicyList(BaseModel):
    """
    ...
    value: Optional[List[CdnWebApplicationFirewallPolicy]] = Field(default=None, description="List of Azure CDN WebApplicationFirewallPolicies within a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CdnWebApplicationFirewallPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
