...
class CdnWebApplicationFirewallPolicy(BaseModel):
    """
    ...
    properties: Optional[CdnWebApplicationFirewallPolicyProperties] = None
    sku: object = Field(description="The pricing tier (defines a CDN provider, feature list and rate) of the CDN profile.")
