...
class CdnWebApplicationFirewallPolicyPatchParameters(BaseModel):
    """
    Properties required to update a CdnWebApplicationFirewallPolicy.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="CdnWebApplicationFirewallPolicy tags")
