...
class RateLimitRule(BaseModel):
    ...
    """ # noqa: E501
    rate_limit_duration_in_minutes: Annotated[int, Field(le=60, strict=True, ge=0)] = Field(description="Defines rate limit duration. Default is 1 minute.", alias="rateLimitDurationInMinutes")
    rate_limit_threshold: Annotated[int, Field(strict=True, ge=0)] = Field(description="Defines rate limit threshold.", alias="rateLimitThreshold")
    action: ActionType
