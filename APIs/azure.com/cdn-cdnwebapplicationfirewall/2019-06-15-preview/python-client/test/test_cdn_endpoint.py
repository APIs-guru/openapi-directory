...
class TestCdnEndpoint(unittest.TestCase):
    """CdnEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CdnEndpoint:
        """Test CdnEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CdnEndpoint`
        """
        model = CdnEndpoint()
        if include_optional:
            return CdnEndpoint(
