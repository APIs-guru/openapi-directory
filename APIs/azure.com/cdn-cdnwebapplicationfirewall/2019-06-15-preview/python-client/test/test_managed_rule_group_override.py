...
class TestManagedRuleGroupOverride(unittest.TestCase):
    """ManagedRuleGroupOverride unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedRuleGroupOverride:
        """Test ManagedRuleGroupOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedRuleGroupOverride`
        """
    ...
    def testManagedRuleGroupOverride(self):
        """Test ManagedRuleGroupOverride"""
