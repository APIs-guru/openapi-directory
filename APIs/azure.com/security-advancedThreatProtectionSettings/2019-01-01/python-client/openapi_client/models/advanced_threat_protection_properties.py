...
class AdvancedThreatProtectionProperties(BaseModel):
    """
    The Advanced Threat Protection settings.
    """ # noqa: E501
    is_enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether Advanced Threat Protection is enabled.", alias="isEnabled")
