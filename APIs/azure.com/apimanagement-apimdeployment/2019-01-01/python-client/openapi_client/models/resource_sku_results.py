...
class ResourceSkuResults(BaseModel):
    """
    The API Management service SKUs operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of API Management service Skus.", alias="nextLink")
    value: List[ResourceSkuResult] = Field(description="The list of skus available for the service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourceSkuResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
