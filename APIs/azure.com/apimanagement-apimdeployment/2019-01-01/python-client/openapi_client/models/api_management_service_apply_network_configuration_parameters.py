...
class ApiManagementServiceApplyNetworkConfigurationParameters(BaseModel):
    """
    Parameter supplied to the Apply Network configuration operation.
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Location of the Api Management service to update for a multi-region service. For a service deployed in a single region, this parameter is not required.")
