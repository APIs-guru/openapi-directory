...
class ApiManagementServiceUploadCertificateParameters(BaseModel):
    """
    ...
    certificate_password: StrictStr = Field(description="Certificate password.")
    type: StrictStr = Field(description="Hostname type.")
    __properties: ClassVar[List[str]] = ["certificate", "certificate_password", "type"]
