...
class ApiManagementServiceGetSsoTokenResult(BaseModel):
    """
    The response of the GetSsoToken operation.
    """ # noqa: E501
    redirect_uri: Optional[StrictStr] = Field(default=None, description="Redirect URL to the Publisher Portal containing the SSO token.", alias="redirectUri")
