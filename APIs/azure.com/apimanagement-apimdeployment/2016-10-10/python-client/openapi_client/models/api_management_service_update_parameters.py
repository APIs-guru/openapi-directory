...
class ApiManagementServiceUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[ApiManagementServiceProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApiManagementServiceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
