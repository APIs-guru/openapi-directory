...
**api_version_constraint** | [**ApiVersionConstraint**](ApiVersionConstraint.md) |  | [optional] 
...
**developer_portal_url** | **str** | DEveloper Portal endpoint URL of the API Management service. | [optional] [readonly] 
**disable_gateway** | **bool** | Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in master region. | [optional] [default to False]
...
json = "{}"
# create an instance of ApiManagementServiceBaseProperties from a JSON string
api_management_service_base_properties_instance = ApiManagementServiceBaseProperties.from_json(json)
# print the JSON string representation of the object
print(ApiManagementServiceBaseProperties.to_json())

# convert the object into a dict
api_management_service_base_properties_dict = api_management_service_base_properties_instance.to_dict()
# create an instance of ApiManagementServiceBaseProperties from a dict
api_management_service_base_properties_from_dict = ApiManagementServiceBaseProperties.from_dict(api_management_service_base_properties_dict)
```
