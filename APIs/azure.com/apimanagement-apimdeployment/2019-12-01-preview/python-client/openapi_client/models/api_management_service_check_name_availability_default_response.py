...
class ApiManagementServiceCheckNameAvailabilityDefaultResponse(BaseModel):
    """
    Error Response.
    """ # noqa: E501
    error: Optional[ApiManagementServiceCheckNameAvailabilityDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ApiManagementServiceCheckNameAvailabilityDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
