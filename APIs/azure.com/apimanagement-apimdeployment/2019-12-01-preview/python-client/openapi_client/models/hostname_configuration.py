...
class HostnameConfiguration(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Proxy', 'Portal', 'Management', 'Scm', 'DeveloperPortal']):
            raise ValueError("must be one of enum values ('Proxy', 'Portal', 'Management', 'Scm', 'DeveloperPortal')")
        return value
