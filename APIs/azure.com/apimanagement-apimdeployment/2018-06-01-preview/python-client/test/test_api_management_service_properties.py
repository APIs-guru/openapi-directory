...
class TestApiManagementServiceProperties(unittest.TestCase):
    """ApiManagementServiceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiManagementServiceProperties:
        """Test ApiManagementServiceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiManagementServiceProperties`
        """
        model = ApiManagementServiceProperties()
        if include_optional:
            return ApiManagementServiceProperties(
                publisher_email = '',
                publisher_name = '',
    ...
    def testApiManagementServiceProperties(self):
        """Test ApiManagementServiceProperties"""
