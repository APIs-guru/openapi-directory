...
class ApiManagementServiceUpdateProperties(BaseModel):
    """
    Properties of an API Management service resource description.
    """ # noqa: E501
    publisher_email: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Publisher email.", alias="publisherEmail")
    publisher_name: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Publisher name.", alias="publisherName")
