...
[**api_management_service_update_hostname**](ApiManagementServiceApi.md#api_management_service_update_hostname) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatehostname | 
[**api_management_service_upload_certificate**](ApiManagementServiceApi.md#api_management_service_upload_certificate) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatecertificate | 
...
> ApiManagementServiceResource api_management_service_update_hostname(resource_group_name, service_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_management_service_update_hostname(resource_group_name, service_name, api_version, subscription_id, parameters)
        print("The response of ApiManagementServiceApi->api_management_service_update_hostname:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiManagementServiceApi->api_management_service_update_hostname: %s\n" % e)
```
...
> CertificateInformation api_management_service_upload_certificate(resource_group_name, service_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_management_service_upload_certificate(resource_group_name, service_name, api_version, subscription_id, parameters)
        print("The response of ApiManagementServiceApi->api_management_service_upload_certificate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApiManagementServiceApi->api_management_service_upload_certificate: %s\n" % e)
```
