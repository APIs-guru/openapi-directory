...
class TypeFieldsApi:
    ...
    def fields_list_by_type(
        ...
        _param = self._fields_list_by_type_serialize(
    ...
    @validate_call
    def fields_list_by_type_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        module_name: Annotated[StrictStr, Field(description="The name of module.")],
    ...
    @validate_call
    def fields_list_by_type_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        module_name: Annotated[StrictStr, Field(description="The name of module.")],
    ...
    def _fields_list_by_type_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/modules/{moduleName}/types/{typeName}/fields',
