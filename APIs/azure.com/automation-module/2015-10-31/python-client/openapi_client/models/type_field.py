...
class TypeField(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Gets or sets the name of the field.")
    type: Optional[StrictStr] = Field(default=None, description="Gets or sets the type of the field.")
