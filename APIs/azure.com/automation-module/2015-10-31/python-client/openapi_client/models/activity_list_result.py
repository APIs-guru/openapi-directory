...
class ActivityListResult(BaseModel):
    """
    ...
    value: Optional[List[Activity]] = Field(default=None, description="Gets or sets a list of activities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Activity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
