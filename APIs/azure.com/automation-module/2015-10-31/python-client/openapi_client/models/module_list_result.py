...
class ModuleListResult(BaseModel):
    ...
    value: Optional[List[Module]] = Field(default=None, description="Gets or sets a list of modules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Module.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
