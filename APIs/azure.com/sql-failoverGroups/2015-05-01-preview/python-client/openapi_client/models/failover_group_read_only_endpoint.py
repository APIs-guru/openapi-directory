...
class FailoverGroupReadOnlyEndpoint(BaseModel):
    """
    Read-only endpoint of the failover group instance.
    """ # noqa: E501
    failover_policy: Optional[StrictStr] = Field(default=None, description="Failover policy of the read-only endpoint for the failover group.", alias="failoverPolicy")
    __properties: ClassVar[List[str]] = ["failoverPolicy"]
