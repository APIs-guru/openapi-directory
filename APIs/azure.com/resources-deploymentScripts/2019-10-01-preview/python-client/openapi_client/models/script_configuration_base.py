...
class ScriptConfigurationBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["arguments", "environmentVariables", "forceUpdateTag", "primaryScriptUri", "retentionInterval", "scriptContent", "supportingScriptUris", "timeout"]
