...
class ScriptLogsList(BaseModel):
    """
    Deployment script execution logs.
    """ # noqa: E501
    value: Optional[List[ScriptLog]] = Field(default=None, description="Deployment scripts logs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ScriptLog.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
