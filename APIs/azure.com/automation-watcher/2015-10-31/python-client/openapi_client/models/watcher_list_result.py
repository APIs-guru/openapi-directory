...
class WatcherListResult(BaseModel):
    ...
    value: Optional[List[Watcher]] = Field(default=None, description="Gets or sets a list of watchers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Watcher.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
