...
class JitNetworkAccessPoliciesListDefaultResponse(BaseModel):
    """
    Error response structure.
    """ # noqa: E501
    error: Optional[JitNetworkAccessPoliciesListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": JitNetworkAccessPoliciesListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
