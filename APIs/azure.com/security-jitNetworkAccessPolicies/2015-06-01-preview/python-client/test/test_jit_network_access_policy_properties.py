...
class TestJitNetworkAccessPolicyProperties(unittest.TestCase):
    """JitNetworkAccessPolicyProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JitNetworkAccessPolicyProperties:
        """Test JitNetworkAccessPolicyProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JitNetworkAccessPolicyProperties`
        """
        model = JitNetworkAccessPolicyProperties()
        if include_optional:
            return JitNetworkAccessPolicyProperties(
                provisioning_state = '',
                requests = [
    ...
    def testJitNetworkAccessPolicyProperties(self):
        """Test JitNetworkAccessPolicyProperties"""
