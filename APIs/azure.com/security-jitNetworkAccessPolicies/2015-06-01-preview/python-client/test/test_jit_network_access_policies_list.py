...
class TestJitNetworkAccessPoliciesList(unittest.TestCase):
    """JitNetworkAccessPoliciesList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JitNetworkAccessPoliciesList:
        """Test JitNetworkAccessPoliciesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JitNetworkAccessPoliciesList`
        """
        model = JitNetworkAccessPoliciesList()
        if include_optional:
            return JitNetworkAccessPoliciesList(
                next_link = '',
                value = [
                    openapi_client.models.jit_network_access_policy.JitNetworkAccessPolicy(
    ...
    def testJitNetworkAccessPoliciesList(self):
        """Test JitNetworkAccessPoliciesList"""
