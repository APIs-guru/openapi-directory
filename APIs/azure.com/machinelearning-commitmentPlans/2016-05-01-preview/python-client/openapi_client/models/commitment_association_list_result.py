...
class CommitmentAssociationListResult(BaseModel):
    """
    A page of commitment association resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="A URI to retrieve the next page of results.", alias="nextLink")
    value: Optional[List[CommitmentAssociation]] = Field(default=None, description="The set of results for this page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CommitmentAssociation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
