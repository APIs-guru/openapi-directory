...
class QueueServicesListMetrics200ResponseValueInner(BaseModel):
    """
    Metric information.
    """ # noqa: E501
    ...
    metric_values: Optional[List[QueueServicesListMetrics200ResponseValueInnerMetricValuesInner]] = Field(default=None, description="List of metric values.", alias="metricValues")
    name: Optional[QueueServicesListMetricDefinitions200ResponseValueInnerName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricValues": [QueueServicesListMetrics200ResponseValueInnerMetricValuesInner.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None,
            "name": QueueServicesListMetricDefinitions200ResponseValueInnerName.from_dict(obj["name"]) if obj.get("name") is not None else None,
