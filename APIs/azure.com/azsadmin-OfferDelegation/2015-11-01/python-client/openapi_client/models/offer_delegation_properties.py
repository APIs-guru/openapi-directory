...
class OfferDelegationProperties(BaseModel):
    """
    Properties for an offer delegation.
    """ # noqa: E501
    subscription_id: Optional[StrictStr] = Field(default=None, description="Identifier of the subscription receiving the delegated offer.", alias="subscriptionId")
