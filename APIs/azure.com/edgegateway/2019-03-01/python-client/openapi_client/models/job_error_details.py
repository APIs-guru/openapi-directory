...
class JobErrorDetails(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code intended for programmatic access.")
    error_details: Optional[List[JobErrorItem]] = Field(default=None, description="The error details.", alias="errorDetails")
    message: Optional[StrictStr] = Field(default=None, description="The message that describes the error in detail.")
