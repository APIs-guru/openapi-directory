...
------------ | ------------- | ------------- | -------------
*ResourcesApi* | [**resource_healths_get**](docs/ResourcesApi.md#resource_healths_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/serviceHealths/{serviceRegistrationId}/resourceHealths/{resourceRegistrationId} | 
*ResourcesApi* | [**resource_healths_list**](docs/ResourcesApi.md#resource_healths_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/serviceHealths/{serviceRegistrationId}/resourceHealths | 


## Documentation For Models

 - [ResourceHealth](docs/ResourceHealth.md)
 - [ResourceHealthList](docs/ResourceHealthList.md)
 - [ResourceHealthModel](docs/ResourceHealthModel.md)
 - [ResourceHealthModelAllOfAlertSummary](docs/ResourceHealthModelAllOfAlertSummary.md)
