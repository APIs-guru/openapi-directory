...
class ClientGroupsApi:
    ...
    def client_groups_get(
        ...
        client_group_name: Annotated[str, Field(min_length=3, strict=True, max_length=256, description="Client Group resource name.")],
        ...
        :param client_group_name: Client Group resource name. (required)
        ...
        _param = self._client_groups_get_serialize(
    ...
    @validate_call
    def client_groups_get_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    @validate_call
    def client_groups_get_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    def _client_groups_get_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
        ...
        if client_group_name is not None:
            _path_params['clientGroupName'] = client_group_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/features/serviceMap/clientGroups/{clientGroupName}',
    ...
    @validate_call
    def client_groups_get_members_count(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
        ...
        _param = self._client_groups_get_members_count_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            api_version=api_version,
    ...
    @validate_call
    def client_groups_get_members_count_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClientGroupMembersCount]:
        """client_groups_get_members_count
    ...
    @validate_call
    def client_groups_get_members_count_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    def _client_groups_get_members_count_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/features/serviceMap/clientGroups/{clientGroupName}/membersCount',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def client_groups_list_members(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
        ...
        _param = self._client_groups_list_members_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ClientGroupMembersCollection",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def client_groups_list_members_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClientGroupMembersCollection]:
        """client_groups_list_members
    ...
    @validate_call
    def client_groups_list_members_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    def _client_groups_list_members_serialize(
        self,
        subscription_id,
        resource_group_name,
        workspace_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/features/serviceMap/clientGroups/{clientGroupName}/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
