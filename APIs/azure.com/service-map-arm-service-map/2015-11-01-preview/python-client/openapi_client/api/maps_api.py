...
class MapsApi:
    ...
    def maps_generate(
        ...
        request: Annotated[MapRequest, Field(description="Request options.")],
        ...
        :param request: Request options. (required)
        ...
        _param = self._maps_generate_serialize(
    ...
    @validate_call
    def maps_generate_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    @validate_call
    def maps_generate_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure subscription identifier.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=64, description="Resource group name within the specified subscriptionId.")],
        workspace_name: Annotated[str, Field(min_length=3, strict=True, max_length=63, description="OMS workspace containing the resources of interest.")],
    ...
    def _maps_generate_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/features/serviceMap/generateMap',
