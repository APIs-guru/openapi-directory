...
class Connection(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[ConnectionProperties] = None
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['rel:connection', 'rel:acceptor']):
            raise ValueError("must be one of enum values ('rel:connection', 'rel:acceptor')")
        return value
