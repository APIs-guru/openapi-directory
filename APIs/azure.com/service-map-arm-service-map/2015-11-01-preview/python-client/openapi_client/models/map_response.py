...
class MapResponse(BaseModel):
    ...
    """ # noqa: E501
    end_time: datetime = Field(description="Map interval end time.", alias="endTime")
    map: Map
    start_time: datetime = Field(description="Map interval start time.", alias="startTime")
    __properties: ClassVar[List[str]] = ["endTime", "map", "startTime"]
