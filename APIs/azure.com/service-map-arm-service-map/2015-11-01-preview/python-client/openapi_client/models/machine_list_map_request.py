...
class MachineListMapRequest(MultipleMachinesMapRequest):
    """
    ...
    """ # noqa: E501
    machine_ids: List[StrictStr] = Field(description="a list of URIs of machine resources for which to generate the map.", alias="machineIds")
