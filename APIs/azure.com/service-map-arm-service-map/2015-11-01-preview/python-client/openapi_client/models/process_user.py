...
class ProcessUser(BaseModel):
    ...
    """ # noqa: E501
    user_domain: Optional[StrictStr] = Field(default=None, description="Domain name for the user.", alias="userDomain")
    user_name: Optional[StrictStr] = Field(default=None, description="User name under which the process is running.", alias="userName")
    __properties: ClassVar[List[str]] = ["userDomain", "userName"]
