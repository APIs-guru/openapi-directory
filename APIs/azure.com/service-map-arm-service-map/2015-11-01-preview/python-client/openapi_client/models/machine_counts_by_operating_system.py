...
class MachineCountsByOperatingSystem(BaseModel):
    """
    Machines by operating system.
    """ # noqa: E501
    linux: StrictInt = Field(description="Number of live Linux machines.")
    windows: StrictInt = Field(description="Number of live Windows machines.")
    __properties: ClassVar[List[str]] = ["linux", "windows"]
