...
class ProcessCollection(BaseModel):
    ...
    value: Optional[List[Process]] = Field(default=None, description="Collection of Process resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Process.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
