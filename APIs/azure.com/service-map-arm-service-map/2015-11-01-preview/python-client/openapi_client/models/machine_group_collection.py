...
class MachineGroupCollection(BaseModel):
    """
    ...
    value: Optional[List[MachineGroup]] = Field(default=None, description="Collection of Machine Group resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MachineGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
