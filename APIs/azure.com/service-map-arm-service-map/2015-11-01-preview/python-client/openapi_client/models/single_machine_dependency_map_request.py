...
class SingleMachineDependencyMapRequest(MapRequest):
    """
    ...
    """ # noqa: E501
    machine_id: StrictStr = Field(description="URI of machine resource for which to generate the map.", alias="machineId")
