...
class RecoveryServicesApi:
    ...
    @validate_call
    def recovery_services_check_name_availability(
        self,
        ...
        input: Annotated[CheckNameAvailabilityParameters, Field(description="Contains information about Resource type and Resource name")],
        ...
        :type input: CheckNameAvailabilityParameters
        ...
        _param = self._recovery_services_check_name_availability_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CheckNameAvailabilityResultResource",
        }
    ...
    @validate_call
    def recovery_services_check_name_availability_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckNameAvailabilityResultResource]:
        """API to check for resource name availability.  A name is available if no other resource exists that has the same SubscriptionId, Resource Name and Type  or if one or more such resources exist, each of these must be GC'd and their time of deletion be more than 24 Hours Ago
    ...
    @validate_call
    def recovery_services_check_name_availability_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _recovery_services_check_name_availability_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/locations/{location}/checkNameAvailability',
