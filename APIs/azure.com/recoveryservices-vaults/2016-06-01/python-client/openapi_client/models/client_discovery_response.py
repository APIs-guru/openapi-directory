...
class ClientDiscoveryResponse(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next chunk of the response", alias="nextLink")
    value: Optional[List[ClientDiscoveryValueForSingleApi]] = Field(default=None, description="List of available operations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ClientDiscoveryValueForSingleApi.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
