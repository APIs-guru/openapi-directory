...
class TestPatchVault(unittest.TestCase):
    """PatchVault unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchVault:
        """Test PatchVault
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchVault`
        """
        model = PatchVault()
        if include_optional:
            return PatchVault(
