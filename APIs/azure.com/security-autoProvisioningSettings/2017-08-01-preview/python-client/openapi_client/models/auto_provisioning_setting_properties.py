...
class AutoProvisioningSettingProperties(BaseModel):
    """
    describes properties of an auto provisioning setting
    """ # noqa: E501
    auto_provision: StrictStr = Field(description="Describes what kind of security agent provisioning action to take", alias="autoProvision")
    __properties: ClassVar[List[str]] = ["autoProvision"]

    @field_validator('auto_provision')
    def auto_provision_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autoProvision": obj.get("autoProvision")
        })
        return _obj
