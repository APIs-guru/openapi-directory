...
class AutoProvisioningSettingsListDefaultResponse(BaseModel):
    """
    Error response structure.
    """ # noqa: E501
    error: Optional[AutoProvisioningSettingsListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": AutoProvisioningSettingsListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
