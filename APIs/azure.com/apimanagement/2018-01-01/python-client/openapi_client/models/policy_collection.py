...
class PolicyCollection(BaseModel):
    ...
    value: Optional[List[PolicyContract]] = Field(default=None, description="Policy Contract value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicyContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
