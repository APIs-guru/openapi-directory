...
class RegionListResult(BaseModel):
    """
    ...
    value: Optional[List[RegionContract]] = Field(default=None, description="Lists of Regions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RegionContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
