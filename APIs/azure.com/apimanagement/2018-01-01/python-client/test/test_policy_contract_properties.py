...
class TestPolicyContractProperties(unittest.TestCase):
    """PolicyContractProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyContractProperties:
        """Test PolicyContractProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyContractProperties`
        """
    ...
    def testPolicyContractProperties(self):
        """Test PolicyContractProperties"""
