...
class RegionContract(BaseModel):
    ...
    Region profile.
    """ # noqa: E501
    is_master_region: StrictBool = Field(description="whether Region is the master region.", alias="isMasterRegion")
    name: StrictStr = Field(description="Region name.")
    __properties: ClassVar[List[str]] = ["isMasterRegion", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isMasterRegion": obj.get("isMasterRegion"),
            "name": obj.get("name")
        })
        return _obj
