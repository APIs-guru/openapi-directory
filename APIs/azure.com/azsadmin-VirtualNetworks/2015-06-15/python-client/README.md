...
------------ | ------------- | ------------- | -------------
*VirtualNetworksApi* | [**virtual_networks_list**](docs/VirtualNetworksApi.md#virtual_networks_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/adminVirtualNetworks | 


## Documentation For Models

 - [VirtualNetwork](docs/VirtualNetwork.md)
 - [VirtualNetworkConfigurationState](docs/VirtualNetworkConfigurationState.md)
 - [VirtualNetworkConfigurationStatus](docs/VirtualNetworkConfigurationStatus.md)
 - [VirtualNetworkProperties](docs/VirtualNetworkProperties.md)
 - [VirtualNetworksList](docs/VirtualNetworksList.md)
