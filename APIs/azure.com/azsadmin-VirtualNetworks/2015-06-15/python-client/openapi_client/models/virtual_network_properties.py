...
class VirtualNetworkProperties(BaseModel):
    ...
    """ # noqa: E501
    configuration_state: Optional[VirtualNetworkConfigurationState] = Field(default=None, alias="configurationState")
    ...
    __properties: ClassVar[List[str]] = ["provisioningState", "subscriptionId", "tenantResourceUri"]
