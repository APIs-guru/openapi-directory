...
class VirtualNetworkConfigurationStatus(BaseModel):
    """
    Virtual network configuration status.
    """ # noqa: E501
    last_updated_time: Optional[datetime] = Field(default=None, description="Last updated time for the configuration status.", alias="lastUpdatedTime")
    status: Optional[StrictStr] = Field(default=None, description="The virtual network configuration status.")
    __properties: ClassVar[List[str]] = ["lastUpdatedTime", "status"]
