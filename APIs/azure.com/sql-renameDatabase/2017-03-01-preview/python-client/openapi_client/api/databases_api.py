...
class DatabasesApi:
    ...
    def databases_rename(
        ...
        database_name: Annotated[StrictStr, Field(description="The name of the database to rename.")],
        ...
        parameters: Annotated[ResourceMoveDefinition, Field(description="The resource move definition for renaming this database.")],
        ...
        :type parameters: ResourceMoveDefinition
        ...
        _param = self._databases_rename_serialize(
    ...
    @validate_call
    def databases_rename_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database to rename.")],
    ...
    @validate_call
    def databases_rename_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database to rename.")],
    ...
    def _databases_rename_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/move',
