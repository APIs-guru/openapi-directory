...
class RegulatoryComplianceControlList(BaseModel):
    """
    ...
    value: List[RegulatoryComplianceControl] = Field(description="List of regulatory compliance controls")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RegulatoryComplianceControl.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
