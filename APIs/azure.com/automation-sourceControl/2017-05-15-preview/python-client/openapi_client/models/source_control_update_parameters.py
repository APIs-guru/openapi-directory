...
class SourceControlUpdateParameters(BaseModel):
    """
    The parameters supplied to the update source control operation.
    """ # noqa: E501
    properties: Optional[SourceControlUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": SourceControlUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
