...
class RunProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentConfiguration", "createTime", "customRegistries", "finishTime", "imageUpdateTrigger", "isArchiveEnabled", "lastUpdatedTime", "outputImages", "platform", "provisioningState", "runErrorMessage", "runId", "runType", "sourceRegistryAuth", "sourceTrigger", "startTime", "status", "task"]
