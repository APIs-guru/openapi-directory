...
class TestRunProperties(unittest.TestCase):
    """RunProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunProperties:
        """Test RunProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunProperties`
        """
        model = RunProperties()
        if include_optional:
