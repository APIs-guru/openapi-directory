...
class BuildTaskPropertiesUpdateParameters(BaseModel):
    """
    The properties for updating a build task.
    """ # noqa: E501
    alias: Optional[StrictStr] = Field(default=None, description="The alternative updatable name for a build task.")
    platform: Optional[PlatformProperties] = None
    source_repository: Optional[SourceRepositoryUpdateParameters] = Field(default=None, alias="sourceRepository")
    status: Optional[StrictStr] = Field(default=None, description="The current status of build task.")
    timeout: Optional[Annotated[int, Field(le=28800, strict=True, ge=300)]] = Field(default=None, description="Build timeout in seconds.")
    __properties: ClassVar[List[str]] = ["alias", "platform", "sourceRepository", "status", "timeout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourceRepository": SourceRepositoryUpdateParameters.from_dict(obj["sourceRepository"]) if obj.get("sourceRepository") is not None else None,
