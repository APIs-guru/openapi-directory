...
class BuildListResult(BaseModel):
    ...
    value: Optional[List[Build]] = Field(default=None, description="The collection value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Build.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
