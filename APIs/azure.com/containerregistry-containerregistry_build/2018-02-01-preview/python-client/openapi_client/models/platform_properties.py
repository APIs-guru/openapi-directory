...
class PlatformProperties(BaseModel):
    ...
    """ # noqa: E501
    cpu: Optional[StrictInt] = Field(default=None, description="The CPU configuration in terms of number of cores required for the build.")
    os_type: StrictStr = Field(description="The operating system type required for the build.", alias="osType")
    __properties: ClassVar[List[str]] = ["cpu", "osType"]
