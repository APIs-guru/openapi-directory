...
class TestBuildTaskProperties(unittest.TestCase):
    """BuildTaskProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildTaskProperties:
        """Test BuildTaskProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildTaskProperties`
        """
        model = BuildTaskProperties()
        if include_optional:
            return BuildTaskProperties(
                alias = '',
    ...
    def testBuildTaskProperties(self):
        """Test BuildTaskProperties"""
