...
class TestBuildTaskListResult(unittest.TestCase):
    """BuildTaskListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildTaskListResult:
        """Test BuildTaskListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildTaskListResult`
        """
        model = BuildTaskListResult()
        if include_optional:
            return BuildTaskListResult(
                next_link = '',
                value = [
                    openapi_client.models.build_task.BuildTask(
    ...
    def testBuildTaskListResult(self):
        """Test BuildTaskListResult"""
