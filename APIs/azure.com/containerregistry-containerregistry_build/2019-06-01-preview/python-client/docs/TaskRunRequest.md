...
------------ | ------------- | ------------- | -------------
**override_task_step_properties** | [**OverrideTaskStepProperties**](OverrideTaskStepProperties.md) |  | [optional] 
**task_id** | **str** | The resource ID of task against which run has to be queued. | 
