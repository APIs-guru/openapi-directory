...
class TaskRunRequest(RunRequest):
    ...
    """ # noqa: E501
    override_task_step_properties: Optional[OverrideTaskStepProperties] = Field(default=None, alias="overrideTaskStepProperties")
    task_id: StrictStr = Field(description="The resource ID of task against which run has to be queued.", alias="taskId")
