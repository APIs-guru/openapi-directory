...
class RegistriesApi:
    ...
    def _registries_get_build_source_upload_url_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/listBuildSourceUploadUrl',
    ...
    @validate_call
    def registries_schedule_run(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, description="The name of the resource group to which the container registry belongs.")],
        registry_name: Annotated[str, Field(min_length=5, strict=True, max_length=50, description="The name of the container registry.")],
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        run_request: Annotated[RunRequest, Field(description="The parameters of a run that needs to scheduled.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._registries_schedule_run_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            api_version=api_version,
    ...
    @validate_call
    def registries_schedule_run_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, description="The name of the resource group to which the container registry belongs.")],
        registry_name: Annotated[str, Field(min_length=5, strict=True, max_length=50, description="The name of the container registry.")],
    ...
    @validate_call
    def registries_schedule_run_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, description="The name of the resource group to which the container registry belongs.")],
        registry_name: Annotated[str, Field(min_length=5, strict=True, max_length=50, description="The name of the container registry.")],
    ...
    def _registries_schedule_run_serialize(
        self,
        subscription_id,
        resource_group_name,
        registry_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scheduleRun',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
