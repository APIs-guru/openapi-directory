...
------------- | ------------- | -------------
[**registries_get_build_source_upload_url**](RegistriesApi.md#registries_get_build_source_upload_url) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/listBuildSourceUploadUrl | 
[**registries_schedule_run**](RegistriesApi.md#registries_schedule_run) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scheduleRun | 
...
> Run registries_schedule_run(subscription_id, resource_group_name, registry_name, api_version, run_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    registry_name = 'registry_name_example' # str | The name of the container registry.
    api_version = 'api_version_example' # str | The client API version.
    run_request = openapi_client.RunRequest() # RunRequest | The parameters of a run that needs to scheduled.

    try:
        api_response = api_instance.registries_schedule_run(subscription_id, resource_group_name, registry_name, api_version, run_request)
        print("The response of RegistriesApi->registries_schedule_run:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RegistriesApi->registries_schedule_run: %s\n" % e)
```
 ...
 **registry_name** | **str**| The name of the container registry. | 
 **api_version** | **str**| The client API version. | 
 **run_request** | [**RunRequest**](RunRequest.md)| The parameters of a run that needs to scheduled. | 
...
**0** | Error response describing why the operation failed. If the registry/run doesn&#39;t exist, 404 (Not found) is returned. If any of the input parameters is wrong, 400(Bad Request) is returned. |  -  |
