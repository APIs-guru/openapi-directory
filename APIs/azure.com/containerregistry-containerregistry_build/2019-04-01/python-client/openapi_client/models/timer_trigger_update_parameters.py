...
class TimerTriggerUpdateParameters(BaseModel):
    """
    The properties for updating a timer trigger.
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the trigger.")
    schedule: Optional[StrictStr] = Field(default=None, description="The CRON expression for the task schedule")
    status: Optional[StrictStr] = Field(default='Enabled', description="The current status of trigger.")
    __properties: ClassVar[List[str]] = ["name", "schedule", "status"]
