...
class TriggerUpdateParameters(BaseModel):
    ...
    timer_triggers: Optional[List[TimerTriggerUpdateParameters]] = Field(default=None, description="The collection of timer triggers.", alias="timerTriggers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timerTriggers": [TimerTriggerUpdateParameters.from_dict(_item) for _item in obj["timerTriggers"]] if obj.get("timerTriggers") is not None else None
        })
        return _obj
