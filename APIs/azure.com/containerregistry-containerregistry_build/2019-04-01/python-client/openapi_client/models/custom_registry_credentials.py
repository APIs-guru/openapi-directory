...
class CustomRegistryCredentials(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "password": SecretObject.from_dict(obj["password"]) if obj.get("password") is not None else None,
            "userName": SecretObject.from_dict(obj["userName"]) if obj.get("userName") is not None else None
        })
        return _obj
