...
class CreateJobParameters(BaseModel):
    ...
    """ # noqa: E501
    degree_of_parallelism: Optional[StrictInt] = Field(default=1, description="the degree of parallelism used for this job. At most one of degreeOfParallelism and degreeOfParallelismPercent should be specified. If none, a default value of 1 will be used.", alias="degreeOfParallelism")
