...
class JobRecurrenceInformationListResult(BaseModel):
    """
    ...
    value: Optional[List[JobRecurrenceInformation]] = Field(default=None, description="the list of job recurrence information items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [JobRecurrenceInformation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
