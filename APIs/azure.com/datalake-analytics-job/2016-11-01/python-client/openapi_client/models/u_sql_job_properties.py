...
class USqlJobProperties(JobProperties):
    ...
    total_pause_time: Optional[StrictStr] = Field(default=None, description="the total time this job spent paused. This value should not be set by the user and will be ignored if it is.", alias="totalPauseTime")
