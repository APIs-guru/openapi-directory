...
class JobPipelineInformation(BaseModel):
    ...
    recurrences: Optional[List[StrictStr]] = Field(default=None, description="the list of recurrence identifiers representing each recurrence in this pipeline.")
    runs: Optional[List[JobPipelineRunInformation]] = Field(default=None, description="the list of run identifiers representing each run of this pipeline.")
