...
class JobPipelineInformationListResult(BaseModel):
    """
    ...
    value: Optional[List[JobPipelineInformation]] = Field(default=None, description="the list of job pipeline information items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [JobPipelineInformation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
