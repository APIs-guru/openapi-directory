...
------------ | ------------- | ------------- | -------------
**runtime_version** | **str** | the runtime version of the Data Lake Analytics engine to use for the specific type of job being run. | [optional] [readonly] 
**script** | **str** | the script to run. Please note that the maximum script size is 3 MB. | 
**type** | **str** | the job type of the current job (i.e. Hive or USql). | 
