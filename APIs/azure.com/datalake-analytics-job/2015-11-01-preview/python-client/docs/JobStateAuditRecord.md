...
------------ | ------------- | ------------- | -------------
**details** | **str** | Gets  the details of the audit log. | [optional] [readonly] 
**new_state** | **str** | Gets the new state the job is in. | [optional] [readonly] 
**requested_by_user** | **str** | Gets the user who requests the change. | [optional] [readonly] 
**time_stamp** | **datetime** | Gets the time stamp that the state change took place. | [optional] [readonly] 
