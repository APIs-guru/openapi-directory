...
------------ | ------------- | ------------- | -------------
**runtime_version** | **str** | Gets or sets the runtime version of the U-SQL engine to use | [optional] 
**script** | **str** | Gets or sets the U-SQL script to run | 
**type** | **str** | Gets or sets the job type of the current job (i.e. Hive or U-SQL). | 
