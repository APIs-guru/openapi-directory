...
class JobStatistics(BaseModel):
    ...
    """ # noqa: E501
    last_update_time_utc: Optional[datetime] = Field(default=None, description="Gets the last update time for the statistics.", alias="lastUpdateTimeUtc")
    stages: Optional[List[JobStatisticsVertexStage]] = Field(default=None, description="Gets the list of stages for the job.")
    __properties: ClassVar[List[str]] = ["lastUpdateTimeUtc", "stages"]
