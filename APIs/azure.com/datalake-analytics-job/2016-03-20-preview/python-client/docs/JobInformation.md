...
------------ | ------------- | ------------- | -------------
**degree_of_parallelism** | **int** | the degree of parallelism used for this job. This must be greater than 0. | [optional] 
...
**job_id** | **str** | the job&#39;s unique identifier (a GUID). | [optional] 
...
**submitter** | **str** | the user or account that submitted the job. | [optional] 
