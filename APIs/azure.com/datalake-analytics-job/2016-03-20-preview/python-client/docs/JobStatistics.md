...
------------ | ------------- | ------------- | -------------
**finalizing_time_utc** | **datetime** | the job finalizing start time. | [optional] [readonly] 
**last_update_time_utc** | **datetime** | the last update time for the statistics. | [optional] [readonly] 
**stages** | [**List[JobStatisticsVertexStage]**](JobStatisticsVertexStage.md) | the list of stages for the job. | [optional] [readonly] 
