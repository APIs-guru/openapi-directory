...
class JobInnerError(BaseModel):
    ...
    """ # noqa: E501
    component: Optional[StrictStr] = Field(default=None, description="the component that failed.")
    ...
    diagnostic_code: Optional[StrictInt] = Field(default=None, description="the diagnostic error code.", alias="diagnosticCode")
