...
class JobInformation(BaseModel):
    ...
    """ # noqa: E501
    degree_of_parallelism: Optional[StrictInt] = Field(default=None, description="the degree of parallelism used for this job. This must be greater than 0.", alias="degreeOfParallelism")
    ...
    __properties: ClassVar[List[str]] = ["degreeOfParallelism", "degreeOfParallelismPercent", "endTime", "errorMessage", "hierarchyQueueNode", "jobId", "logFilePatterns", "logFolder", "name", "priority", "properties", "result", "startTime", "state", "stateAuditRecords", "submitTime", "submitter", "type"]
