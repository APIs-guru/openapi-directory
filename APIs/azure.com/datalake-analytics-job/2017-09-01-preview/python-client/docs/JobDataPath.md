...
------------ | ------------- | ------------- | -------------
**command** | **str** | The command that this job data relates to. | [optional] [readonly] 
**job_id** | **str** | The ID of the job this data is for. | [optional] [readonly] 
**paths** | **List[str]** | The list of paths to all of the job data. | [optional] [readonly] 
