...
class PipelineApi:
    ...
    def pipeline_get(
        self,
        pipeline_identity: Annotated[StrictStr, Field(description="Pipeline ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        start_date_time: Annotated[Optional[datetime], Field(description="The start date for when to get the pipeline and aggregate its data. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
        end_date_time: Annotated[Optional[datetime], Field(description="The end date for when to get the pipeline and aggregate its data. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
        ...
        :param pipeline_identity: Pipeline ID. (required)
        ...
        _param = self._pipeline_get_serialize(
    ...
    @validate_call
    def pipeline_get_with_http_info(
        self,
        pipeline_identity: Annotated[StrictStr, Field(description="Pipeline ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        start_date_time: Annotated[Optional[datetime], Field(description="The start date for when to get the pipeline and aggregate its data. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JobPipelineInformation]:
        """pipeline_get
    ...
    @validate_call
    def pipeline_get_without_preload_content(
        self,
        pipeline_identity: Annotated[StrictStr, Field(description="Pipeline ID.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        start_date_time: Annotated[Optional[datetime], Field(description="The start date for when to get the pipeline and aggregate its data. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
    ...
    def _pipeline_get_serialize(
        ...
        if pipeline_identity is not None:
            _path_params['pipelineIdentity'] = pipeline_identity
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pipelines/{pipelineIdentity}',
    ...
    def pipeline_list(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        start_date_time: Annotated[Optional[datetime], Field(description="The start date for when to get the list of pipelines. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
        end_date_time: Annotated[Optional[datetime], Field(description="The end date for when to get the list of pipelines. The startDateTime and endDateTime can be no more than 30 days apart.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JobPipelineInformationListResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def pipeline_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JobPipelineInformationListResult]:
        """pipeline_list
