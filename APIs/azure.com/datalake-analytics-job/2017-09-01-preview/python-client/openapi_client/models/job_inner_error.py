...
class JobInnerError(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["component", "description", "details", "diagnosticCode", "errorId", "helpLink", "innerError", "internalDiagnostics", "message", "resolution", "severity", "source"]
...
JobInnerError.model_rebuild(raise_errors=False)
