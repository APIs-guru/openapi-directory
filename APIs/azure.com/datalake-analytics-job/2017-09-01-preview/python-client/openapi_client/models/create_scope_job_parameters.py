...
class CreateScopeJobParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["degreeOfParallelism", "degreeOfParallelismPercent", "logFilePatterns", "name", "priority", "related", "properties", "type"]
