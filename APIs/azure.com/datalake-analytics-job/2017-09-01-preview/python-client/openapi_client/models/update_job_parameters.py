...
class UpdateJobParameters(BaseModel):
    """
    ...
    """ # noqa: E501
    degree_of_parallelism: Optional[StrictInt] = Field(default=None, description="The degree of parallelism used for this job.", alias="degreeOfParallelism")
    ...
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The key-value pairs used to add additional metadata to the job information.")
    __properties: ClassVar[List[str]] = ["degreeOfParallelism", "degreeOfParallelismPercent", "priority", "tags"]
