...
class ResourceUsageStatistics(BaseModel):
    """
    The statistics information for resource usage.
    """ # noqa: E501
    average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average value.")
    maximum: Optional[StrictInt] = Field(default=None, description="The maximum value.")
    minimum: Optional[StrictInt] = Field(default=None, description="The minimum value.")
