...
class TestFileShareItem(unittest.TestCase):
    """FileShareItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileShareItem:
        """Test FileShareItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileShareItem`
        """
        model = FileShareItem()
        if include_optional:
