...
# **file_shares_list**
> FileShareItems file_shares_list(resource_group_name, account_name, api_version, subscription_id, skip_token=skip_token, maxpagesize=maxpagesize, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.file_shares_list(resource_group_name, account_name, api_version, subscription_id, skip_token=skip_token, maxpagesize=maxpagesize, filter=filter)
