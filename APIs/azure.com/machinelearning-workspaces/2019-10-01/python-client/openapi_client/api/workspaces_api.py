...
class WorkspacesApi:
    ...
    def workspaces_create_or_update(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group to which the machine learning workspace belongs.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
        ...
        :param resource_group_name: The name of the resource group to which the machine learning workspace belongs. (required)
        :type resource_group_name: str
        :param workspace_name: The name of the machine learning workspace. (required)
    ...
    def _workspaces_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}',
    ...
    def _workspaces_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearning/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _workspaces_list_by_resource_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def workspaces_list_workspace_keys(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
        ...
        _param = self._workspaces_list_workspace_keys_serialize(
            api_version=api_version,
            subscription_id=subscription_id,
            workspace_name=workspace_name,
            resource_group_name=resource_group_name,
    ...
    @validate_call
    def workspaces_list_workspace_keys_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkspaceKeysResponse]:
        """workspaces_list_workspace_keys
    ...
    @validate_call
    def workspaces_list_workspace_keys_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
    ...
    def _workspaces_list_workspace_keys_serialize(
        self,
        api_version,
        subscription_id,
        workspace_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}/listWorkspaceKeys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def workspaces_resync_storage_keys(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
        ...
        _param = self._workspaces_resync_storage_keys_serialize(
            api_version=api_version,
            subscription_id=subscription_id,
            workspace_name=workspace_name,
            resource_group_name=resource_group_name,
    ...
    @validate_call
    def workspaces_resync_storage_keys_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
    ...
    @validate_call
    def workspaces_resync_storage_keys_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        workspace_name: Annotated[StrictStr, Field(description="The name of the machine learning workspace.")],
    ...
    def _workspaces_resync_storage_keys_serialize(
        self,
        api_version,
        subscription_id,
        workspace_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}/resyncStorageKeys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
