...
class AssignmentJobCreatedResource(BaseModel):
    """
    Azure resource created from deployment job.
    """ # noqa: E501
    properties: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional properties in a dictionary.")
