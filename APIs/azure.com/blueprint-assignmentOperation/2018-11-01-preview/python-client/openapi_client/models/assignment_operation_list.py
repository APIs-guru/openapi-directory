...
class AssignmentOperationList(BaseModel):
    """
    List of AssignmentOperation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next page of results.", alias="nextLink")
    value: Optional[List[AssignmentOperation]] = Field(default=None, description="List of AssignmentOperation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AssignmentOperation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
