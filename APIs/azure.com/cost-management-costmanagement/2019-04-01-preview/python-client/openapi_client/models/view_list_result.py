...
class ViewListResult(BaseModel):
    ...
    value: Optional[List[View]] = Field(default=None, description="The list of views.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [View.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
