...
class QueryApi:
    ...
    def query_billing_account(
        ...
        parameters: Annotated[ReportDefinition, Field(description="Parameters supplied to the CreateOrUpdate Report operation.")],
        ...
        :type parameters: ReportDefinition
        ...
        _param = self._query_billing_account_serialize(
    ...
    @validate_call
    def query_billing_account_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-08-01-preview.")],
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        parameters: Annotated[ReportDefinition, Field(description="Parameters supplied to the CreateOrUpdate Report operation.")],
    ...
    @validate_call
    def query_billing_account_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-08-01-preview.")],
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        parameters: Annotated[ReportDefinition, Field(description="Parameters supplied to the CreateOrUpdate Report operation.")],
    ...
    def _query_billing_account_serialize(
        self,
        api_version,
        billing_account_id,
        parameters,
    ...
    def query_resource_group(
        ...
        _param = self._query_resource_group_serialize(
            api_version=api_version,
    ...
    @validate_call
    def query_resource_group_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-08-01-preview.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="Azure Resource Group Name.")],
    ...
    @validate_call
    def query_resource_group_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-08-01-preview.")],
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        resource_group_name: Annotated[StrictStr, Field(description="Azure Resource Group Name.")],
    ...
    def _query_resource_group_serialize(
        self,
        api_version,
        subscription_id,
        resource_group_name,
