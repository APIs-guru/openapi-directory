...
class ReportExecutionListResult(BaseModel):
    """
    Result of listing reports execution history of a report by name
    """ # noqa: E501
    value: Optional[List[ReportExecution]] = Field(default=None, description="The list of report executions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ReportExecution.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
