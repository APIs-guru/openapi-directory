...
class ConnectorDefinitionListResult(BaseModel):
    """
    Result of listing connector definitions. It contains a list of available connector definitions in the scope provided.
    """ # noqa: E501
    value: Optional[List[ConnectorDefinition]] = Field(default=None, description="The list of connector definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConnectorDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
