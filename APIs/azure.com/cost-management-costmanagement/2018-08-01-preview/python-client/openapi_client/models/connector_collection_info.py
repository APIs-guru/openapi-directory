...
class ConnectorCollectionInfo(BaseModel):
    ...
    last_run: Optional[datetime] = Field(default=None, description="Last time the data acquisition process completed (even if no new data was found)", alias="lastRun")
    ...
    __properties: ClassVar[List[str]] = ["error", "lastRun", "lastUpdated", "sourceLastUpdated"]
