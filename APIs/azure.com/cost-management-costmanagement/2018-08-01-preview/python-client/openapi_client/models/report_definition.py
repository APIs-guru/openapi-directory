...
class ReportDefinition(BaseModel):
    ...
    """ # noqa: E501
    dataset: Optional[ReportDataset] = None
    time_period: Optional[ReportTimePeriod] = Field(default=None, alias="timePeriod")
    ...
    def timeframe_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['WeekToDate', 'MonthToDate', 'Custom']):
            raise ValueError("must be one of enum values ('WeekToDate', 'MonthToDate', 'Custom')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataset": ReportDataset.from_dict(obj["dataset"]) if obj.get("dataset") is not None else None,
            "timePeriod": ReportTimePeriod.from_dict(obj["timePeriod"]) if obj.get("timePeriod") is not None else None,
