...
class TestConnectorCollectionInfo(unittest.TestCase):
    """ConnectorCollectionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectorCollectionInfo:
        """Test ConnectorCollectionInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorCollectionInfo`
        """
        model = ConnectorCollectionInfo()
        if include_optional:
            return ConnectorCollectionInfo(
    ...
    def testConnectorCollectionInfo(self):
        """Test ConnectorCollectionInfo"""
