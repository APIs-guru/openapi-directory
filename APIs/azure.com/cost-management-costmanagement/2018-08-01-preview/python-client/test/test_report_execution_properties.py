...
class TestReportExecutionProperties(unittest.TestCase):
    """ReportExecutionProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportExecutionProperties:
        """Test ReportExecutionProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportExecutionProperties`
        """
        model = ReportExecutionProperties()
        if include_optional:
            return ReportExecutionProperties(
    ...
    def testReportExecutionProperties(self):
        """Test ReportExecutionProperties"""
