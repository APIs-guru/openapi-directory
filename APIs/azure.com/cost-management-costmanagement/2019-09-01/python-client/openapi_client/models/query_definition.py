...
class QueryDefinition(BaseModel):
    ...
    def timeframe_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['WeekToDate', 'MonthToDate', 'YearToDate', 'TheLastWeek', 'TheLastMonth', 'TheLastYear', 'Custom']):
            raise ValueError("must be one of enum values ('WeekToDate', 'MonthToDate', 'YearToDate', 'TheLastWeek', 'TheLastMonth', 'TheLastYear', 'Custom')")
        return value
