...
class TestCommonExportProperties(unittest.TestCase):
    """CommonExportProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonExportProperties:
        """Test CommonExportProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonExportProperties`
        """
    ...
    def testCommonExportProperties(self):
        """Test CommonExportProperties"""
