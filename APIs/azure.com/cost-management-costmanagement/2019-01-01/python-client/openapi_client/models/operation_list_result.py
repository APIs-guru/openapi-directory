...
class OperationListResult(BaseModel):
    ...
    value: Optional[List[Operation]] = Field(default=None, description="List of cost management operations supported by the Microsoft.CostManagement resource provider.")
