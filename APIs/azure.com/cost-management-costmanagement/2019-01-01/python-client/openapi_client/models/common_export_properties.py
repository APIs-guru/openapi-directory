...
class CommonExportProperties(BaseModel):
    """
    The common properties of the export.
    """ # noqa: E501
    definition: QueryDefinition
    delivery_info: ExportDeliveryInfo = Field(alias="deliveryInfo")
    format: Optional[StrictStr] = Field(default=None, description="The format of the export being delivered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "definition": QueryDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
            "deliveryInfo": ExportDeliveryInfo.from_dict(obj["deliveryInfo"]) if obj.get("deliveryInfo") is not None else None,
