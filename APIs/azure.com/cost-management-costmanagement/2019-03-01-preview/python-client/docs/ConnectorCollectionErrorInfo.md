...
------------ | ------------- | ------------- | -------------
**error_code** | **str** | Short error code | [optional] [readonly] 
**error_inner_message** | **str** | External Provider error message | [optional] [readonly] 
**error_message** | **str** | Detailed error message | [optional] [readonly] 
**error_start_time** | **datetime** | Time the error started occurring (Last time error occurred in lastChecked) | [optional] [readonly] 
