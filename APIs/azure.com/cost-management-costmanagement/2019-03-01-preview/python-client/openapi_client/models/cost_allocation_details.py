...
class CostAllocationDetails(BaseModel):
    """
    Represents CostAllocation showback rule model
    """ # noqa: E501
    policy: Optional[StrictStr] = Field(default=None, description="Cost allocation policy.")
    ...
    def policy_validate_enum(cls, value):
        ...
        if value not in set(['Proportional', 'Evenly', 'Fixed']):
            raise ValueError("must be one of enum values ('Proportional', 'Evenly', 'Fixed')")
        return value
