...
class ShowbackRuleListResult(BaseModel):
    """
    Result of listing showback rules. It contains a list of available rules in the scope provided.
    """ # noqa: E501
    value: Optional[List[ShowbackRule]] = Field(default=None, description="The list of showback rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ShowbackRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
