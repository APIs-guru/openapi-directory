...
class ExternalBillingAccountProperties(BaseModel):
    """
    ...
    connector_id: Optional[StrictStr] = Field(default=None, description="Underlying ConnectorId", alias="connectorId")
    display_name: Optional[StrictStr] = Field(default=None, description="ExternalBillingAccount DisplayName", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["collectionInfo", "connectorId", "displayName", "providerBillingAccountId"]
