...
class TestExternalSubscriptionDefinition(unittest.TestCase):
    """ExternalSubscriptionDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalSubscriptionDefinition:
        """Test ExternalSubscriptionDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalSubscriptionDefinition`
        """
        model = ExternalSubscriptionDefinition()
        if include_optional:
    ...
    def testExternalSubscriptionDefinition(self):
        """Test ExternalSubscriptionDefinition"""
