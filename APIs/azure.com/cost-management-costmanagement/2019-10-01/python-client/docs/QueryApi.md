...
------------- | ------------- | -------------
[**query_usage**](QueryApi.md#query_usage) | **POST** /{scope}/providers/Microsoft.CostManagement/query | 


# **query_usage**
> QueryResult query_usage(scope, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.query_usage(scope, api_version, parameters)
        print("The response of QueryApi->query_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling QueryApi->query_usage: %s\n" % e)
```
