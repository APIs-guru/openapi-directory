...
class ExportExecutionListResult(BaseModel):
    """
    Result of listing exports execution history of a export by name
    """ # noqa: E501
    value: Optional[List[ExportExecution]] = Field(default=None, description="The list of export executions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ExportExecution.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
