...
class TestExportExecutionListResult(unittest.TestCase):
    """ExportExecutionListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportExecutionListResult:
        """Test ExportExecutionListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportExecutionListResult`
        """
        model = ExportExecutionListResult()
        if include_optional:
            return ExportExecutionListResult(
                value = [
                    openapi_client.models.export_execution.ExportExecution(
                        properties = openapi_client.models.export_execution_properties.ExportExecutionProperties(
                            ...
                            run_settings = openapi_client.models.common_export_properties.CommonExportProperties(
                                definition = openapi_client.models.query_definition.QueryDefinition(
                                    dataset = openapi_client.models.query_dataset.QueryDataset(
                                        ...
                                        sorting = [
                                            openapi_client.models.query_sorting_configuration.QuerySortingConfiguration(
                                                name = '', 
                                                query_sorting_direction = 'Ascending', )
                                            ], ), 
    ...
    def testExportExecutionListResult(self):
        """Test ExportExecutionListResult"""
