...
[**forecast_usage_by_managment_group**](ForecastApi.md#forecast_usage_by_managment_group) | **POST** /providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.CostManagement/Forecast | 
...
# **forecast_usage_by_managment_group**
> QueryResult forecast_usage_by_managment_group(api_version, management_group_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.forecast_usage_by_managment_group(api_version, management_group_id, parameters)
        print("The response of ForecastApi->forecast_usage_by_managment_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForecastApi->forecast_usage_by_managment_group: %s\n" % e)
```
