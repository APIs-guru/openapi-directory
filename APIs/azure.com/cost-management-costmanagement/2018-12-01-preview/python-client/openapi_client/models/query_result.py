...
class QueryResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[Query]] = Field(default=None, description="The list of usage data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Query.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
