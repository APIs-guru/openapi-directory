...
**provider** | **str** | Service provider: Microsoft.CostManagement. | [optional] [readonly] 
**resource** | **str** | Resource on which the operation is performed: Dimensions, Query. | [optional] [readonly] 
