...
------------- | ------------- | -------------
[**dimensions_list**](DimensionsApi.md#dimensions_list) | **GET** /{scope}/providers/Microsoft.CostManagement/dimensions | 


# **dimensions_list**
> DimensionsListResult dimensions_list(scope, api_version, filter=filter, expand=expand, skiptoken=skiptoken, top=top)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request. The current version is 2019-11-01.
 ...
 **api_version** | **str**| Version of the API to be used with the client request. The current version is 2019-11-01. | 
