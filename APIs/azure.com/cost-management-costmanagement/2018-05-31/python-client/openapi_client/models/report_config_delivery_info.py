...
class ReportConfigDeliveryInfo(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": ReportConfigDeliveryDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None
        })
        return _obj
