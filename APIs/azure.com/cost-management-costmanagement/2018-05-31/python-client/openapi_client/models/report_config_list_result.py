...
class ReportConfigListResult(BaseModel):
    """
    Result of listing report configs. It contains a list of available report configurations in the scope provided.
    """ # noqa: E501
    value: Optional[List[ReportConfig]] = Field(default=None, description="The list of report configs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ReportConfig.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
