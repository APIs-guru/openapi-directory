...
class ReportConfigProperties(BaseModel):
    """
    The properties of the report config.
    """ # noqa: E501
    definition: ReportConfigDefinition
    delivery_info: ReportConfigDeliveryInfo = Field(alias="deliveryInfo")
    format: Optional[StrictStr] = Field(default=None, description="The format of the report being delivered.")
    schedule: Optional[ReportConfigSchedule] = None
    __properties: ClassVar[List[str]] = ["definition", "deliveryInfo", "format", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "definition": ReportConfigDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
            "deliveryInfo": ReportConfigDeliveryInfo.from_dict(obj["deliveryInfo"]) if obj.get("deliveryInfo") is not None else None,
            "format": obj.get("format"),
            "schedule": ReportConfigSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
