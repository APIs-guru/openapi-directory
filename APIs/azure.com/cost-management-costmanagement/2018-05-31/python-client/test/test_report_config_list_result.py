...
class TestReportConfigListResult(unittest.TestCase):
    """ReportConfigListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportConfigListResult:
        """Test ReportConfigListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportConfigListResult`
        """
        model = ReportConfigListResult()
        if include_optional:
    ...
    def testReportConfigListResult(self):
        """Test ReportConfigListResult"""
