...
class TestReportConfigProperties(unittest.TestCase):
    """ReportConfigProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportConfigProperties:
        """Test ReportConfigProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportConfigProperties`
        """
        model = ReportConfigProperties()
        if include_optional:
    ...
    def testReportConfigProperties(self):
        """Test ReportConfigProperties"""
