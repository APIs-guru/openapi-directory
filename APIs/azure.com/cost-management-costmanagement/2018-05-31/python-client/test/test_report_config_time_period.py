...
class TestReportConfigTimePeriod(unittest.TestCase):
    """ReportConfigTimePeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportConfigTimePeriod:
        """Test ReportConfigTimePeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportConfigTimePeriod`
        """
    ...
    def testReportConfigTimePeriod(self):
        """Test ReportConfigTimePeriod"""
