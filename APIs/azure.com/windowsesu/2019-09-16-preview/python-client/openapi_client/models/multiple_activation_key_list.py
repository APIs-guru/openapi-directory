...
class MultipleActivationKeyList(BaseModel):
    """
    List of MAK keys.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to the next page of resources.", alias="nextLink")
    value: Optional[List[MultipleActivationKey]] = Field(default=None, description="List of MAK keys.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MultipleActivationKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
