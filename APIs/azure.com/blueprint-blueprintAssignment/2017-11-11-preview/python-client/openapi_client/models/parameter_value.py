...
class ParameterValue(BaseModel):
    ...
    """ # noqa: E501
    value: Dict[str, Any] = Field(description="actual value.")
    description: Optional[StrictStr] = Field(default=None, description="Optional property, just to establish ParameterValueBase as a BaseClass.")
