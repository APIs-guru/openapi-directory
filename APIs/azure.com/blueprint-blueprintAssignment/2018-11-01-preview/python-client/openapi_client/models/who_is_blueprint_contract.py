...
class WhoIsBlueprintContract(BaseModel):
    """
    Response schema for querying the Azure Blueprints service principal in the tenant.
    """ # noqa: E501
    object_id: Optional[StrictStr] = Field(default=None, description="AAD object Id of the Azure Blueprints service principal in the tenant.", alias="objectId")
