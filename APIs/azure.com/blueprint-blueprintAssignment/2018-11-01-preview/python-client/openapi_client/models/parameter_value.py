...
class ParameterValue(BaseModel):
    ...
    value: Optional[Dict[str, Any]] = Field(default=None, description="Parameter value as value type.")
    __properties: ClassVar[List[str]] = ["reference", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reference": SecretValueReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
            "value": obj.get("value")
        })
        return _obj
