...
class AssignmentProperties(BaseModel):
    ...
    """ # noqa: E501
    blueprint_id: Optional[StrictStr] = Field(default=None, description="ID of the published version of a blueprint definition.", alias="blueprintId")
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="State of the blueprint assignment.", alias="provisioningState")
