...
class AssignmentList(BaseModel):
    ...
    value: Optional[List[Assignment]] = Field(default=None, description="List of blueprint assignments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Assignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
