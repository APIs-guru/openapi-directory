...
# **backups_restore**
> backups_restore(subscription_id, location, resource_group_name, backup, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.backups_restore(subscription_id, location, resource_group_name, backup, api_version)
    except Exception as e:
