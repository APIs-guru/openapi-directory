...
class ServicesApi:
    ...
    def services_create_or_update(
        ...
        service_name: Annotated[StrictStr, Field(description="The name of the Search service to create or update.")],
        ...
        parameters: Annotated[SearchServiceCreateOrUpdateParameters, Field(description="The properties to set or update on the Search service.")],
        ...
        :param service_name: The name of the Search service to create or update. (required)
        ...
        :type parameters: SearchServiceCreateOrUpdateParameters
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchServiceResource",
            '201': "SearchServiceResource",
        }
    ...
    def services_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchServiceResource]:
        """services_create_or_update
    ...
    def _services_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{serviceName}',
    ...
    def services_delete(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group within the current subscription.")],
        service_name: Annotated[StrictStr, Field(description="The name of the Search service to delete.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        subscription_id: Annotated[StrictStr, Field(description="Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
            None,
        ...
        :param resource_group_name: The name of the resource group within the current subscription. (required)
        :type resource_group_name: str
        :param service_name: The name of the Search service to delete. (required)
        :type service_name: str
        :param api_version: Client Api Version. (required)
        :type api_version: str
        :param subscription_id: Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
    ...
    def services_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchServiceListResult]:
        """services_list
    ...
    def _services_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
