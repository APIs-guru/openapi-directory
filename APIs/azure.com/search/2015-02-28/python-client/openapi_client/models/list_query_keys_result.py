...
class ListQueryKeysResult(BaseModel):
    """
    Response containing the query API keys for a given Azure Search service.
    """ # noqa: E501
    value: Optional[List[QueryKey]] = Field(default=None, description="The query keys for the Azure Search service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [QueryKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
