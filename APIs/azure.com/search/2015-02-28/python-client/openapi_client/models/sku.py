...
class Sku(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The SKU of the Search service.")
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['free', 'standard', 'standard2']):
            raise ValueError("must be one of enum values ('free', 'standard', 'standard2')")
        return value
