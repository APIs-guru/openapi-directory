...
class SearchServiceListResult(BaseModel):
    """
    Response containing a list of Azure Search services for a given resource group.
    """ # noqa: E501
    value: Optional[List[SearchServiceResource]] = Field(default=None, description="The Search services in the resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SearchServiceResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
