...
class AdminKeyResult(BaseModel):
    ...
    """ # noqa: E501
    primary_key: Optional[StrictStr] = Field(default=None, description="The primary API key of the Search service.", alias="primaryKey")
    secondary_key: Optional[StrictStr] = Field(default=None, description="The secondary API key of the Search service.", alias="secondaryKey")
