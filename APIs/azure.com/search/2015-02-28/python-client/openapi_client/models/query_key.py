...
class QueryKey(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The value of the query API key.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the query API key; may be empty.")
