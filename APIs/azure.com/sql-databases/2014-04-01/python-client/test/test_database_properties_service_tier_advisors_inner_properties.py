...
class TestDatabasePropertiesServiceTierAdvisorsInnerProperties(unittest.TestCase):
    """DatabasePropertiesServiceTierAdvisorsInnerProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabasePropertiesServiceTierAdvisorsInnerProperties:
        """Test DatabasePropertiesServiceTierAdvisorsInnerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabasePropertiesServiceTierAdvisorsInnerProperties`
        """
        model = DatabasePropertiesServiceTierAdvisorsInnerProperties()
        if include_optional:
            return DatabasePropertiesServiceTierAdvisorsInnerProperties(
    ...
    def testDatabasePropertiesServiceTierAdvisorsInnerProperties(self):
        """Test DatabasePropertiesServiceTierAdvisorsInnerProperties"""
