...
class TestDatabasePropertiesServiceTierAdvisorsInner(unittest.TestCase):
    """DatabasePropertiesServiceTierAdvisorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabasePropertiesServiceTierAdvisorsInner:
        """Test DatabasePropertiesServiceTierAdvisorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabasePropertiesServiceTierAdvisorsInner`
        """
        model = DatabasePropertiesServiceTierAdvisorsInner()
        if include_optional:
            return DatabasePropertiesServiceTierAdvisorsInner(
    ...
    def testDatabasePropertiesServiceTierAdvisorsInner(self):
        """Test DatabasePropertiesServiceTierAdvisorsInner"""
