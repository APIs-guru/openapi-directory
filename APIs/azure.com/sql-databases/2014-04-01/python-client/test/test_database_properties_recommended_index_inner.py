...
class TestDatabasePropertiesRecommendedIndexInner(unittest.TestCase):
    """DatabasePropertiesRecommendedIndexInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabasePropertiesRecommendedIndexInner:
        """Test DatabasePropertiesRecommendedIndexInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabasePropertiesRecommendedIndexInner`
        """
        model = DatabasePropertiesRecommendedIndexInner()
        if include_optional:
            return DatabasePropertiesRecommendedIndexInner(
    ...
    def testDatabasePropertiesRecommendedIndexInner(self):
        """Test DatabasePropertiesRecommendedIndexInner"""
