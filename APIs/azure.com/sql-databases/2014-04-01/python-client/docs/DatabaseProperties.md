...
**recommended_index** | [**List[DatabasePropertiesRecommendedIndexInner]**](DatabasePropertiesRecommendedIndexInner.md) | The recommended indices for this database. | [optional] [readonly] 
...
**service_tier_advisors** | [**List[DatabasePropertiesServiceTierAdvisorsInner]**](DatabasePropertiesServiceTierAdvisorsInner.md) | The list of service tier advisors for this database. Expanded property | [optional] [readonly] 
...
**transparent_data_encryption** | [**List[DatabasePropertiesTransparentDataEncryptionInner]**](DatabasePropertiesTransparentDataEncryptionInner.md) | The transparent data encryption info for this database. | [optional] [readonly] 
