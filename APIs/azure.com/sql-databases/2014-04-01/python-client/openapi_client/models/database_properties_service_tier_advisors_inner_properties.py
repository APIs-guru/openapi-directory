...
class DatabasePropertiesServiceTierAdvisorsInnerProperties(BaseModel):
    """
    ...
    service_level_objective_usage_metrics: Optional[List[DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner]] = Field(default=None, description="Gets or sets serviceLevelObjectiveUsageMetrics for the service tier advisor.", alias="serviceLevelObjectiveUsageMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceLevelObjectiveUsageMetrics": [DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner.from_dict(_item) for _item in obj["serviceLevelObjectiveUsageMetrics"]] if obj.get("serviceLevelObjectiveUsageMetrics") is not None else None,
