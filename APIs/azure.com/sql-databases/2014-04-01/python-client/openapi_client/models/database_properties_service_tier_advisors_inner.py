...
class DatabasePropertiesServiceTierAdvisorsInner(BaseModel):
    """
    Represents a Service Tier Advisor.
    """ # noqa: E501
    properties: Optional[DatabasePropertiesServiceTierAdvisorsInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DatabasePropertiesServiceTierAdvisorsInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
