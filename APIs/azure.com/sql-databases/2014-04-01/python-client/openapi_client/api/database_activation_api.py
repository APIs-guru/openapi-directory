...
class DatabaseActivationApi:
    ...
    def databases_pause(
        ...
        database_name: Annotated[StrictStr, Field(description="The name of the data warehouse to pause.")],
        ...
        :param database_name: The name of the data warehouse to pause. (required)
    ...
    def databases_resume(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the data warehouse to resume.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param server_name: The name of the server. (required)
        :type server_name: str
        :param database_name: The name of the data warehouse to resume. (required)
        :type database_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
