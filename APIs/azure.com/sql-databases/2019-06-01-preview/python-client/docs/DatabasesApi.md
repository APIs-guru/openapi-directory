...
[**databases_failover**](DatabasesApi.md#databases_failover) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/failover | 
...
[**databases_list_inaccessible_by_server**](DatabasesApi.md#databases_list_inaccessible_by_server) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/inaccessibleDatabases | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DatabasesApi->databases_failover: %s\n" % e)
```
...
> DatabaseListResult databases_list_inaccessible_by_server(resource_group_name, server_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.databases_list_inaccessible_by_server(resource_group_name, server_name, subscription_id, api_version)
        print("The response of DatabasesApi->databases_list_inaccessible_by_server:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DatabasesApi->databases_list_inaccessible_by_server: %s\n" % e)
```
