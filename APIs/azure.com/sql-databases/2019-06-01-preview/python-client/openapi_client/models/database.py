...
class Database(BaseModel):
    ...
    A database resource.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Kind of database. This is metadata used for the Azure portal experience.")
    managed_by: Optional[StrictStr] = Field(default=None, description="Resource that manages the database.", alias="managedBy")
