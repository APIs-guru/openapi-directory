...
class DisasterRecoveryConfigurationListResult(BaseModel):
    """
    Represents the response to a List disaster recovery configuration request.
    """ # noqa: E501
    value: Optional[List[DisasterRecoveryConfiguration]] = Field(default=None, description="The list of disaster recovery configurations housed under the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DisasterRecoveryConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
