...
class MetricNamespaceCollection(BaseModel):
    """
    Represents collection of metric namespaces.
    """ # noqa: E501
    value: List[MetricNamespace] = Field(description="The values for the metric namespaces.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [MetricNamespace.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
