...
class PolicyAssignmentProperties(BaseModel):
    ...
    enforcement_mode: Optional[StrictStr] = Field(default=None, description="The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.", alias="enforcementMode")
    ...
    __properties: ClassVar[List[str]] = ["description", "displayName", "enforcementMode", "metadata", "notScopes", "parameters", "policyDefinitionId", "scope"]
    ...
    def enforcement_mode_validate_enum(cls, value):
        ...
        if value not in set(['Default', 'DoNotEnforce']):
            raise ValueError("must be one of enum values ('Default', 'DoNotEnforce')")
        return value
