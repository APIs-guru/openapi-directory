...
------------ | ------------- | ------------- | -------------
**id** | **str** | The ID of the policy assignment. | [optional] [readonly] 
**identity** | [**Identity**](Identity.md) |  | [optional] 
**location** | **str** | The location of the policy assignment. Only required when utilizing managed identity. | [optional] 
**name** | **str** | The name of the policy assignment. | [optional] [readonly] 
**properties** | [**PolicyAssignmentProperties**](PolicyAssignmentProperties.md) |  | [optional] 
**sku** | [**PolicySku**](PolicySku.md) |  | [optional] 
**type** | **str** | The type of the policy assignment. | [optional] [readonly] 
