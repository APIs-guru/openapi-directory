...
class PolicyAssignmentProperties(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="The policy assignment metadata. Metadata is an open ended object and is typically a collection of key value pairs.")
    not_scopes: Optional[List[StrictStr]] = Field(default=None, description="The policy's excluded scopes.", alias="notScopes")
    parameters: Optional[Dict[str, ParameterValuesValue]] = Field(default=None, description="The parameter values for the policy rule. The keys are the parameter names.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": dict(
                (_k, ParameterValuesValue.from_dict(_v))
