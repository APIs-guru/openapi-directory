...
[**script_execution_history_list**](ScriptExecutionHistoryApi.md#script_execution_history_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/scriptExecutionHistory | 
...
> ScriptActionExecutionHistoryList script_execution_history_list(subscription_id, resource_group_name, cluster_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.script_execution_history_list(subscription_id, resource_group_name, cluster_name, api_version)
        print("The response of ScriptExecutionHistoryApi->script_execution_history_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ScriptExecutionHistoryApi->script_execution_history_list: %s\n" % e)
```
