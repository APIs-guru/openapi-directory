...
[**script_actions_list_by_cluster**](ScriptActionsApi.md#script_actions_list_by_cluster) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/scriptActions | 
...
> ScriptActionsList script_actions_list_by_cluster(subscription_id, resource_group_name, cluster_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.script_actions_list_by_cluster(subscription_id, resource_group_name, cluster_name, api_version)
        print("The response of ScriptActionsApi->script_actions_list_by_cluster:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ScriptActionsApi->script_actions_list_by_cluster: %s\n" % e)
```
