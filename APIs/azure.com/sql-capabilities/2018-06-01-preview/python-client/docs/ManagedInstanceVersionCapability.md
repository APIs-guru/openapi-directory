...
**supported_instance_pool_editions** | [**List[InstancePoolEditionCapability]**](InstancePoolEditionCapability.md) | The list of supported instance pool editions. | [optional] [readonly] 
