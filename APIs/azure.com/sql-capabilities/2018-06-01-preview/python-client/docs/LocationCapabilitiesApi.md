...
> LocationCapabilities capabilities_list_by_location(location_name, subscription_id, api_version, include=include)
 ...
 **include** | **str**| If specified, restricts the response to only include the selected item. | [optional] 
