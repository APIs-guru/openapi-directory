...
class StorageCapability(BaseModel):
    ...
    storage_account_type: Optional[StrictStr] = Field(default=None, description="The storage account type for the database's backups.", alias="storageAccountType")
    __properties: ClassVar[List[str]] = ["reason", "status", "storageAccountType"]
