...
class LicenseTypeCapability(BaseModel):
    """
    The license type capability
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="License type identifier.")
    ...
    __properties: ClassVar[List[str]] = ["name", "reason", "status"]
