...
class MinCapacityCapability(BaseModel):
    """
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Min capacity value")
    __properties: ClassVar[List[str]] = ["reason", "status", "value"]
