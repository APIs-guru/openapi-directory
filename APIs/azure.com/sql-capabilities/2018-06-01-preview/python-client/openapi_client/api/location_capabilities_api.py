...
class LocationCapabilitiesApi:
    ...
    @validate_call
    def capabilities_list_by_location(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name whose capabilities are retrieved.")],
        ...
        include: Annotated[Optional[StrictStr], Field(description="If specified, restricts the response to only include the selected item.")] = None,
        ...
        _param = self._capabilities_list_by_location_serialize(
    ...
    @validate_call
    def capabilities_list_by_location_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name whose capabilities are retrieved.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocationCapabilities]:
        """capabilities_list_by_location
    ...
    @validate_call
    def capabilities_list_by_location_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name whose capabilities are retrieved.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
    ...
    def _capabilities_list_by_location_serialize(
        self,
        location_name,
        subscription_id,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Sql/locations/{locationName}/capabilities',
