...
**supported_service_level_objectives** | [**List[ServiceLevelObjectiveCapability]**](ServiceLevelObjectiveCapability.md) | The list of supported service objectives for the edition. | [optional] [readonly] 
