...
class EditionCapability(BaseModel):
    ...
    supported_service_level_objectives: Optional[List[ServiceLevelObjectiveCapability]] = Field(default=None, description="The list of supported service objectives for the edition.", alias="supportedServiceLevelObjectives")
    __properties: ClassVar[List[str]] = ["name", "reason", "status", "supportedServiceLevelObjectives"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportedServiceLevelObjectives": [ServiceLevelObjectiveCapability.from_dict(_item) for _item in obj["supportedServiceLevelObjectives"]] if obj.get("supportedServiceLevelObjectives") is not None else None
        })
        return _obj
