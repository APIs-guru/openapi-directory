...
class ElasticPoolPerDatabaseMinDtuCapability(BaseModel):
    """
    The minimum per-database DTU capability.
    """ # noqa: E501
    limit: Optional[StrictInt] = Field(default=None, description="The minimum DTUs per database.")
    ...
    __properties: ClassVar[List[str]] = ["limit", "reason", "status"]
