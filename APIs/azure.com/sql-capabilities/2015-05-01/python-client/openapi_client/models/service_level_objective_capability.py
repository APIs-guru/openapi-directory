...
class ServiceLevelObjectiveCapability(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "includedMaxSize", "name", "performanceLevel", "reason", "status", "supportedMaxSizes"]
