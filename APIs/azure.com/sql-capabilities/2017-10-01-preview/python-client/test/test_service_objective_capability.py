...
class TestServiceObjectiveCapability(unittest.TestCase):
    """ServiceObjectiveCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceObjectiveCapability:
        """Test ServiceObjectiveCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceObjectiveCapability`
        """
        model = ServiceObjectiveCapability()
        if include_optional:
            return ServiceObjectiveCapability(
                id = '',
    ...
    def testServiceObjectiveCapability(self):
        """Test ServiceObjectiveCapability"""
