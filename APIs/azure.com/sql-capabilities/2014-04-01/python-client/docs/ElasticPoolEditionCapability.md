...
**supported_elastic_pool_dtus** | [**List[ElasticPoolDtuCapability]**](ElasticPoolDtuCapability.md) | The list of supported elastic pool DTU levels for the edition. | [optional] [readonly] 
