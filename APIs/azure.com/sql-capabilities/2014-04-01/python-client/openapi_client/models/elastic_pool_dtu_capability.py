...
class ElasticPoolDtuCapability(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The maximum size of the database (see 'unit' for the units).")
    ...
    supported_per_database_max_dtus: Optional[List[ElasticPoolPerDatabaseMaxDtuCapability]] = Field(default=None, description="The list of supported max database DTUs.", alias="supportedPerDatabaseMaxDtus")
    supported_per_database_max_sizes: Optional[List[MaxSizeCapability]] = Field(default=None, description="The list of supported max database sizes.", alias="supportedPerDatabaseMaxSizes")
    __properties: ClassVar[List[str]] = ["includedMaxSize", "limit", "maxDatabaseCount", "status", "supportedMaxSizes", "supportedPerDatabaseMaxDtus", "supportedPerDatabaseMaxSizes"]
