...
class CapabilitiesApi:
    ...
    def capabilities_list_by_location(
        ...
        location_id: Annotated[StrictStr, Field(description="The location id whose capabilities are retrieved.")],
        ...
        :param location_id: The location id whose capabilities are retrieved. (required)
    ...
    def _capabilities_list_by_location_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Sql/locations/{locationId}/capabilities',
