...
class TestRecoveryServicesProviderProperties(unittest.TestCase):
    """RecoveryServicesProviderProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecoveryServicesProviderProperties:
        """Test RecoveryServicesProviderProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecoveryServicesProviderProperties`
        """
        model = RecoveryServicesProviderProperties()
        if include_optional:
            return RecoveryServicesProviderProperties(
                allowed_scenarios = [
                    ''
                    ],
                connection_status = '',
                ...
                identity_details = openapi_client.models.identity_information.IdentityInformation(
                    aad_authority = '', 
                    application_id = '', 
                    audience = '', 
    ...
    def testRecoveryServicesProviderProperties(self):
        """Test RecoveryServicesProviderProperties"""
