...
class TestUpdateRecoveryPlanInputProperties(unittest.TestCase):
    """UpdateRecoveryPlanInputProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRecoveryPlanInputProperties:
        """Test UpdateRecoveryPlanInputProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateRecoveryPlanInputProperties`
        """
        model = UpdateRecoveryPlanInputProperties()
        if include_optional:
            return UpdateRecoveryPlanInputProperties(
                groups = [
    ...
    def testUpdateRecoveryPlanInputProperties(self):
        """Test UpdateRecoveryPlanInputProperties"""
