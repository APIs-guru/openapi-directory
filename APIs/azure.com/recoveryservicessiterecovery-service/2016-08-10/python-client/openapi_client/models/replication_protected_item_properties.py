...
class ReplicationProtectedItemProperties(BaseModel):
    ...
    failover_health_errors: Optional[List[HealthError]] = Field(default=None, description="List of failover health errors.", alias="failoverHealthErrors")
    ...
    replication_health_errors: Optional[List[HealthError]] = Field(default=None, description="List of replication health errors.", alias="replicationHealthErrors")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in failover_health_errors (list)
        _items = []
        if self.failover_health_errors:
            for _item_failover_health_errors in self.failover_health_errors:
                if _item_failover_health_errors:
                    _items.append(_item_failover_health_errors.to_dict())
            _dict['failoverHealthErrors'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in replication_health_errors (list)
        _items = []
        if self.replication_health_errors:
            for _item_replication_health_errors in self.replication_health_errors:
                if _item_replication_health_errors:
                    _items.append(_item_replication_health_errors.to_dict())
            _dict['replicationHealthErrors'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failoverHealthErrors": [HealthError.from_dict(_item) for _item in obj["failoverHealthErrors"]] if obj.get("failoverHealthErrors") is not None else None,
            ...
            "replicationHealthErrors": [HealthError.from_dict(_item) for _item in obj["replicationHealthErrors"]] if obj.get("replicationHealthErrors") is not None else None,
