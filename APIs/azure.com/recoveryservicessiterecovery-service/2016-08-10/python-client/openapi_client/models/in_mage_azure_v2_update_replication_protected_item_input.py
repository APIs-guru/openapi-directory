...
class InMageAzureV2UpdateReplicationProtectedItemInput(UpdateReplicationProtectedItemProviderInput):
    ...
    """ # noqa: E501
    recovery_azure_v1_resource_group_id: Optional[StrictStr] = Field(default=None, description="The recovery Azure resource group Id for classic deployment.", alias="recoveryAzureV1ResourceGroupId")
    recovery_azure_v2_resource_group_id: Optional[StrictStr] = Field(default=None, description="The recovery Azure resource group Id for resource manager deployment.", alias="recoveryAzureV2ResourceGroupId")
