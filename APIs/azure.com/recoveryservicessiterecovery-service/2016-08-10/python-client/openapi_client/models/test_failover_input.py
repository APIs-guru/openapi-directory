...
class TestFailoverInput(BaseModel):
    """
    Input definition for planned failover.
    """ # noqa: E501
    properties: Optional[TestFailoverInputProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TestFailoverInputProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
