...
class VCenterCollection(BaseModel):
    """
    ...
    value: Optional[List[VCenter]] = Field(default=None, description="The vCenter details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VCenter.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
