...
class VCenterProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["discoveryStatus", "fabricArmResourceName", "friendlyName", "infrastructureId", "internalId", "ipAddress", "lastHeartbeat", "port", "processServerId", "runAsAccountId"]
