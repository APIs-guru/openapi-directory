...
class UpdateMobilityServiceRequestProperties(BaseModel):
    """
    The properties of an update mobility service request.
    """ # noqa: E501
    run_as_account_id: Optional[StrictStr] = Field(default=None, description="The CS run as account Id.", alias="runAsAccountId")
    __properties: ClassVar[List[str]] = ["runAsAccountId"]
