...
class ResourceHealthSummary(BaseModel):
    ...
    """ # noqa: E501
    issues: Optional[List[HealthErrorSummary]] = Field(default=None, description="The list of summary of health errors across the resources under the container.")
    resource_count: Optional[StrictInt] = Field(default=None, description="The count of total resources under the container.", alias="resourceCount")
    __properties: ClassVar[List[str]] = ["issues", "resourceCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issues": [HealthErrorSummary.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
