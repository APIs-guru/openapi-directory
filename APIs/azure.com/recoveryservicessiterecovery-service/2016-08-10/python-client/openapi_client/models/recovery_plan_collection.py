...
class RecoveryPlanCollection(BaseModel):
    """
    ...
    value: Optional[List[RecoveryPlan]] = Field(default=None, description="The list of recovery plans.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RecoveryPlan.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
