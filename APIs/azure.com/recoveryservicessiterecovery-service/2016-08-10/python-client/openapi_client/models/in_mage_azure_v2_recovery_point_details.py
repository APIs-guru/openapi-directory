...
class InMageAzureV2RecoveryPointDetails(ProviderSpecificRecoveryPointDetails):
    ...
    is_multi_vm_sync_point: Optional[StrictStr] = Field(default=None, description="A value indicating whether the recovery point is multi VM consistent.", alias="isMultiVmSyncPoint")
