...
class RecoveryServicesProviderProperties(BaseModel):
    ...
    identity_details: Optional[IdentityInformation] = Field(default=None, alias="identityDetails")
    ...
    provider_version_expiry_date: Optional[datetime] = Field(default=None, description="Expiry date if the version is deprecated.", alias="providerVersionExpiryDate")
    ...
    __properties: ClassVar[List[str]] = ["allowedScenarios", "connectionStatus", "draIdentifier", "fabricFriendlyName", "fabricType", "friendlyName", "healthErrorDetails", "identityDetails", "lastHeartBeat", "protectedItemCount", "providerVersion", "providerVersionExpiryDate", "providerVersionState", "serverVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of identity_details
        if self.identity_details:
            _dict['identityDetails'] = self.identity_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identityDetails": IdentityInformation.from_dict(obj["identityDetails"]) if obj.get("identityDetails") is not None else None,
