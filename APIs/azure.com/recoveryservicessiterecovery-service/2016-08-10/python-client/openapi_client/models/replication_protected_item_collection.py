...
class ReplicationProtectedItemCollection(BaseModel):
    """
    Replication protected item collection.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The value of next link.", alias="nextLink")
    value: Optional[List[ReplicationProtectedItem]] = Field(default=None, description="The Replication protected item details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ReplicationProtectedItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
