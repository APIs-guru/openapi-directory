...
class SwitchProtectionJobDetails(JobDetails):
    ...
    """ # noqa: E501
    new_replication_protected_item_id: Optional[StrictStr] = Field(default=None, description="ARM Id of the new replication protected item.", alias="newReplicationProtectedItemId")
