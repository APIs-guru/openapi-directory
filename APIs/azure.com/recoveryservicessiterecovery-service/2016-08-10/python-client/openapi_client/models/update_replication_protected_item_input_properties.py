...
class UpdateReplicationProtectedItemInputProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enableRDPOnTargetOption", "licenseType", "providerSpecificDetails", "recoveryAvailabilitySetId", "recoveryAzureVMName", "recoveryAzureVMSize", "selectedRecoveryAzureNetworkId", "vmNics"]
