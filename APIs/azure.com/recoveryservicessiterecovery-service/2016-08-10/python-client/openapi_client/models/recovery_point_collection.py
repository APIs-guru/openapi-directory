...
class RecoveryPointCollection(BaseModel):
    """
    ...
    value: Optional[List[RecoveryPoint]] = Field(default=None, description="The recovery point details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RecoveryPoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
