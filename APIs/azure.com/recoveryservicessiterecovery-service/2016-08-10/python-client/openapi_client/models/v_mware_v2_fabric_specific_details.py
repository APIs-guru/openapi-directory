...
class VMwareV2FabricSpecificDetails(FabricSpecificDetails):
    ...
    """ # noqa: E501
    rcm_service_endpoint: Optional[StrictStr] = Field(default=None, description="The endpoint for making requests to the RCM Service.", alias="rcmServiceEndpoint")
    srs_service_endpoint: Optional[StrictStr] = Field(default=None, description="The endpoint for making requests to the SRS Service.", alias="srsServiceEndpoint")
