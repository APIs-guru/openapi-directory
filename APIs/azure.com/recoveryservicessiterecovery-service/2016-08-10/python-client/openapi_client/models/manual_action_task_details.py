...
class ManualActionTaskDetails(TaskTypeDetails):
    ...
    """ # noqa: E501
    instructions: Optional[StrictStr] = Field(default=None, description="The instructions.")
    name: Optional[StrictStr] = Field(default=None, description="The name.")
    observation: Optional[StrictStr] = Field(default=None, description="The observation.")
