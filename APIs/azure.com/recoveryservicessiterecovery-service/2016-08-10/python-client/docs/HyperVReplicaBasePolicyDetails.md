...
hyper_v_replica_base_policy_details_instance = HyperVReplicaBasePolicyDetails.from_json(json)
# print the JSON string representation of the object
print(HyperVReplicaBasePolicyDetails.to_json())

# convert the object into a dict
hyper_v_replica_base_policy_details_dict = hyper_v_replica_base_policy_details_instance.to_dict()
# create an instance of HyperVReplicaBasePolicyDetails from a dict
hyper_v_replica_base_policy_details_from_dict = HyperVReplicaBasePolicyDetails.from_dict(hyper_v_replica_base_policy_details_dict)
```
