...
class TargetComputeSizesApi:
    ...
    @validate_call
    def target_compute_sizes_list_by_replication_protected_items(
        self,
        ...
        _param = self._target_compute_sizes_list_by_replication_protected_items_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TargetComputeSizeCollection",
        }
    ...
    @validate_call
    def target_compute_sizes_list_by_replication_protected_items_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TargetComputeSizeCollection]:
        """Gets the list of target compute sizes for the replication protected item.
    ...
    @validate_call
    def target_compute_sizes_list_by_replication_protected_items_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _target_compute_sizes_list_by_replication_protected_items_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/targetComputeSizes',
