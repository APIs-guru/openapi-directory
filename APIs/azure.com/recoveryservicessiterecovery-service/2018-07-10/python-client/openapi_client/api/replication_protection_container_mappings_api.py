...
class ReplicationProtectionContainerMappingsApi:
    ...
    @validate_call
    def replication_protection_container_mappings_update(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        protection_container_name: Annotated[StrictStr, Field(description="Protection container name.")],
        mapping_name: Annotated[StrictStr, Field(description="Protection container mapping name.")],
        update_input: Annotated[UpdateProtectionContainerMappingInput, Field(description="Mapping update input.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type update_input: UpdateProtectionContainerMappingInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._replication_protection_container_mappings_update_serialize(
            api_version=api_version,
            resource_name=resource_name,
            resource_group_name=resource_group_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def replication_protection_container_mappings_update_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def replication_protection_container_mappings_update_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _replication_protection_container_mappings_update_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
