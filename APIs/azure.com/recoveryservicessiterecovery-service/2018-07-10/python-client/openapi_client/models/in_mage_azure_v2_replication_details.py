...
class InMageAzureV2ReplicationDetails(ReplicationProviderSpecificSettings):
    ...
    protected_managed_disks: Optional[List[InMageAzureV2ManagedDiskDetails]] = Field(default=None, description="The list of protected managed disks.", alias="protectedManagedDisks")
