...
class NetworkProperties(BaseModel):
    ...
    network_type: Optional[StrictStr] = Field(default=None, description="The Network Type.", alias="networkType")
    subnets: Optional[List[Subnet]] = Field(default=None, description="The List of subnets.")
    __properties: ClassVar[List[str]] = ["fabricType", "friendlyName", "networkType", "subnets"]
