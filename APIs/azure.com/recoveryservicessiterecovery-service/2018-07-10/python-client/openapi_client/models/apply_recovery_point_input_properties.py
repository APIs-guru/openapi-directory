...
class ApplyRecoveryPointInputProperties(BaseModel):
    """
    Input properties to apply recovery point.
    """ # noqa: E501
    provider_specific_details: Optional[ApplyRecoveryPointProviderSpecificInput] = Field(default=None, alias="providerSpecificDetails")
    recovery_point_id: Optional[StrictStr] = Field(default=None, description="The recovery point Id.", alias="recoveryPointId")
    __properties: ClassVar[List[str]] = ["providerSpecificDetails", "recoveryPointId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providerSpecificDetails": ApplyRecoveryPointProviderSpecificInput.from_dict(obj["providerSpecificDetails"]) if obj.get("providerSpecificDetails") is not None else None,
