...
class VmNicUpdatesTaskDetails(TaskTypeDetails):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the Nic.")
    nic_id: Optional[StrictStr] = Field(default=None, description="Nic Id.", alias="nicId")
    vm_id: Optional[StrictStr] = Field(default=None, description="Virtual machine Id.", alias="vmId")
