...
class A2AContainerMappingInput(ReplicationProviderSpecificContainerMappingInput):
    ...
    """ # noqa: E501
    agent_auto_update_status: Optional[StrictStr] = Field(default=None, description="A value indicating whether the auto update is enabled.", alias="agentAutoUpdateStatus")
    automation_account_arm_id: Optional[StrictStr] = Field(default=None, description="The automation account arm id.", alias="automationAccountArmId")
    __properties: ClassVar[List[str]] = ["instanceType"]

    @field_validator('agent_auto_update_status')
    def agent_auto_update_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
