...
class ProtectionContainerMappingCollection(BaseModel):
    """
    Protection container mapping collection class.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to fetch rest of the data.", alias="nextLink")
    value: Optional[List[ProtectionContainerMapping]] = Field(default=None, description="List of container mappings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ProtectionContainerMapping.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
