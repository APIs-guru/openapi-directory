...
class A2AReplicationDetails(ReplicationProviderSpecificSettings):
    ...
    initial_primary_fabric_location: Optional[StrictStr] = Field(default=None, description="The initial primary fabric location.", alias="initialPrimaryFabricLocation")
    initial_recovery_fabric_location: Optional[StrictStr] = Field(default=None, description="The initial recovery fabric location.", alias="initialRecoveryFabricLocation")
    ...
    recovery_availability_zone: Optional[StrictStr] = Field(default=None, description="The recovery availability zone.", alias="recoveryAvailabilityZone")
    ...
    selected_tfo_azure_network_id: Optional[StrictStr] = Field(default=None, description="The test failover virtual network.", alias="selectedTfoAzureNetworkId")
    ...
    tfo_azure_vm_name: Optional[StrictStr] = Field(default=None, description="The test failover VM name.", alias="tfoAzureVMName")
    unprotected_disks: Optional[List[A2AUnprotectedDiskDetails]] = Field(default=None, description="The list of unprotected disks.", alias="unprotectedDisks")
    vm_encryption_type: Optional[StrictStr] = Field(default=None, description="The encryption type of the VM.", alias="vmEncryptionType")
    ...
    @field_validator('vm_encryption_type')
    def vm_encryption_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['NotEncrypted', 'OnePassEncrypted', 'TwoPassEncrypted']):
            raise ValueError("must be one of enum values ('NotEncrypted', 'OnePassEncrypted', 'TwoPassEncrypted')")
        return value
