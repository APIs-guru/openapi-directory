...
class MigrationItemProperties(BaseModel):
    ...
    recovery_services_provider_id: Optional[StrictStr] = Field(default=None, description="The recovery services provider ARM Id.", alias="recoveryServicesProviderId")
    ...
    __properties: ClassVar[List[str]] = ["allowedOperations", "currentJob", "health", "healthErrors", "machineName", "migrationState", "migrationStateDescription", "policyFriendlyName", "policyId", "providerSpecificDetails", "recoveryServicesProviderId", "testMigrateState", "testMigrateStateDescription"]
    ...
    def allowed_operations_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['DisableMigration', 'TestMigrate', 'TestMigrateCleanup', 'Migrate']):
                raise ValueError("each list item must be one of ('DisableMigration', 'TestMigrate', 'TestMigrateCleanup', 'Migrate')")
        return value
