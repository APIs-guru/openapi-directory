...
class FabricCreationInputProperties(BaseModel):
    """
    Properties of site details provided during the time of site creation
    """ # noqa: E501
    custom_details: Optional[FabricSpecificCreationInput] = Field(default=None, alias="customDetails")
    __properties: ClassVar[List[str]] = ["customDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customDetails": FabricSpecificCreationInput.from_dict(obj["customDetails"]) if obj.get("customDetails") is not None else None
        })
        return _obj
