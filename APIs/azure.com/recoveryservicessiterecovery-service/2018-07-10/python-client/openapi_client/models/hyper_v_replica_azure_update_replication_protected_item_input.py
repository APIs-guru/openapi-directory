...
class HyperVReplicaAzureUpdateReplicationProtectedItemInput(UpdateReplicationProtectedItemProviderInput):
    ...
    """ # noqa: E501
    disk_id_to_disk_encryption_map: Optional[Dict[str, StrictStr]] = Field(default=None, description="The dictionary of disk resource Id to disk encryption set ARM Id.", alias="diskIdToDiskEncryptionMap")
