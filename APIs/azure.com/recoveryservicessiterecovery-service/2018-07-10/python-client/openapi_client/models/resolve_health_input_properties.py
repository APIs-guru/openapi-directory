...
class ResolveHealthInputProperties(BaseModel):
    """
    Resolve health input properties.
    """ # noqa: E501
    health_errors: Optional[List[ResolveHealthError]] = Field(default=None, description="Health errors.", alias="healthErrors")
    __properties: ClassVar[List[str]] = ["healthErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "healthErrors": [ResolveHealthError.from_dict(_item) for _item in obj["healthErrors"]] if obj.get("healthErrors") is not None else None
        })
        return _obj
