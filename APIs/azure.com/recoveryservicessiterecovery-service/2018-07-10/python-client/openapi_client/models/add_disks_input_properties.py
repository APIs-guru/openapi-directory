...
class AddDisksInputProperties(BaseModel):
    """
    Add Disks input properties.
    """ # noqa: E501
    provider_specific_details: Optional[AddDisksProviderSpecificInput] = Field(default=None, alias="providerSpecificDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providerSpecificDetails": AddDisksProviderSpecificInput.from_dict(obj["providerSpecificDetails"]) if obj.get("providerSpecificDetails") is not None else None
        })
        return _obj
