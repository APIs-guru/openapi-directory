...
class ReplicationEligibilityResultsCollection(BaseModel):
    """
    Replication eligibility results collection response model.
    """ # noqa: E501
    value: Optional[List[ReplicationEligibilityResults]] = Field(default=None, description="The replication eligibility results details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ReplicationEligibilityResults.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
