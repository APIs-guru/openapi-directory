...
class RecoveryPlanTestFailoverCleanupInputProperties(BaseModel):
    """
    Recovery plan test failover cleanup input properties.
    """ # noqa: E501
    comments: Optional[StrictStr] = Field(default=None, description="The test failover cleanup comments.")
