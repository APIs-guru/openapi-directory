...
class A2ARemoveDisksInput(RemoveDisksProviderSpecificInput):
    ...
    """ # noqa: E501
    vm_disks_uris: Optional[List[StrictStr]] = Field(default=None, description="The list of vm disk vhd URIs.", alias="vmDisksUris")
    vm_managed_disks_ids: Optional[List[StrictStr]] = Field(default=None, description="The list of vm managed disk Ids.", alias="vmManagedDisksIds")
