...
class A2AProtectedManagedDiskDetails(BaseModel):
    ...
    failover_disk_name: Optional[StrictStr] = Field(default=None, description="The failover name for the managed disk.", alias="failoverDiskName")
    ...
    tfo_disk_name: Optional[StrictStr] = Field(default=None, description="The test failover name for the managed disk.", alias="tfoDiskName")
    __properties: ClassVar[List[str]] = ["allowedDiskLevelOperation", "dataPendingAtSourceAgentInMB", "dataPendingInStagingStorageAccountInMB", "dekKeyVaultArmId", "diskCapacityInBytes", "diskId", "diskName", "diskState", "diskType", "failoverDiskName", "isDiskEncrypted", "isDiskKeyEncrypted", "kekKeyVaultArmId", "keyIdentifier", "monitoringJobType", "monitoringPercentageCompletion", "primaryStagingAzureStorageAccountId", "recoveryDiskEncryptionSetId", "recoveryReplicaDiskAccountType", "recoveryReplicaDiskId", "recoveryResourceGroupId", "recoveryTargetDiskAccountType", "recoveryTargetDiskId", "resyncRequired", "secretIdentifier", "tfoDiskName"]
