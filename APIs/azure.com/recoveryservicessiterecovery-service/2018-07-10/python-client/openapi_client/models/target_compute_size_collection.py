...
class TargetComputeSizeCollection(BaseModel):
    """
    ...
    value: Optional[List[TargetComputeSize]] = Field(default=None, description="The list of target compute sizes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [TargetComputeSize.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
