...
------------- | ------------- | -------------
[**replication_recovery_services_providers_create**](ReplicationRecoveryServicesProvidersApi.md#replication_recovery_services_providers_create) | **PUT** /Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationRecoveryServicesProviders/{providerName} | Adds a recovery services provider.
...
# **replication_recovery_services_providers_create**
> RecoveryServicesProvider replication_recovery_services_providers_create(api_version, resource_name, resource_group_name, subscription_id, fabric_name, provider_name, add_provider_input)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    add_provider_input = openapi_client.AddRecoveryServicesProviderInput() # AddRecoveryServicesProviderInput | Add provider input.

    try:
        # Adds a recovery services provider.
        api_response = api_instance.replication_recovery_services_providers_create(api_version, resource_name, resource_group_name, subscription_id, fabric_name, provider_name, add_provider_input)
        print("The response of ReplicationRecoveryServicesProvidersApi->replication_recovery_services_providers_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReplicationRecoveryServicesProvidersApi->replication_recovery_services_providers_create: %s\n" % e)
```
 ...
 **add_provider_input** | [**AddRecoveryServicesProviderInput**](AddRecoveryServicesProviderInput.md)| Add provider input. | 
