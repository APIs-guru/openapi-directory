...
class TestRecoveryServicesProviderCollection(unittest.TestCase):
    """RecoveryServicesProviderCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecoveryServicesProviderCollection:
        """Test RecoveryServicesProviderCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecoveryServicesProviderCollection`
        """
        ...
        if include_optional:
            return RecoveryServicesProviderCollection(
                next_link = '',
                value = [
                    openapi_client.models.recovery_services_provider.RecoveryServicesProvider(
    ...
    def testRecoveryServicesProviderCollection(self):
        """Test RecoveryServicesProviderCollection"""
