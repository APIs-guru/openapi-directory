...
class ReplicationProtectableItemsApi:
    ...
    @validate_call
    def replication_protectable_items_get(
        self,
        ...
        protectable_item_name: Annotated[StrictStr, Field(description="Protectable item name.")],
        ...
        _param = self._replication_protectable_items_get_serialize(
    ...
    @validate_call
    def replication_protectable_items_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def replication_protectable_items_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _replication_protectable_items_get_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
        ...
        if protectable_item_name is not None:
            _path_params['protectableItemName'] = protectable_item_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectableItems/{protectableItemName}',
    ...
    @validate_call
    def replication_protectable_items_list_by_replication_protection_containers(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _param = self._replication_protectable_items_list_by_replication_protection_containers_serialize(
            api_version=api_version,
            resource_name=resource_name,
            resource_group_name=resource_group_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def replication_protectable_items_list_by_replication_protection_containers_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProtectableItemCollection]:
        """Gets the list of protectable items.
    ...
    @validate_call
    def replication_protectable_items_list_by_replication_protection_containers_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _replication_protectable_items_list_by_replication_protection_containers_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectableItems',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
