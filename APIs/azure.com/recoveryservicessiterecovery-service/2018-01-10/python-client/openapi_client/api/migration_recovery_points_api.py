...
class MigrationRecoveryPointsApi:
    ...
    @validate_call
    def migration_recovery_points_get(
        self,
        ...
        migration_recovery_point_name: Annotated[StrictStr, Field(description="The migration recovery point name.")],
        ...
        _param = self._migration_recovery_points_get_serialize(
    ...
    @validate_call
    def migration_recovery_points_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MigrationRecoveryPoint]:
        """Gets a recovery point for a migration item.
    ...
    @validate_call
    def migration_recovery_points_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _migration_recovery_points_get_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
        ...
        if migration_recovery_point_name is not None:
            _path_params['migrationRecoveryPointName'] = migration_recovery_point_name
    ...
    @validate_call
    def migration_recovery_points_list_by_replication_migration_items(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _param = self._migration_recovery_points_list_by_replication_migration_items_serialize(
            api_version=api_version,
            resource_name=resource_name,
            resource_group_name=resource_group_name,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MigrationRecoveryPointCollection",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def migration_recovery_points_list_by_replication_migration_items_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MigrationRecoveryPointCollection]:
        """Gets the recovery points for a migration item.
    ...
    @validate_call
    def migration_recovery_points_list_by_replication_migration_items_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        resource_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _migration_recovery_points_list_by_replication_migration_items_serialize(
        self,
        api_version,
        resource_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/migrationRecoveryPoints',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
