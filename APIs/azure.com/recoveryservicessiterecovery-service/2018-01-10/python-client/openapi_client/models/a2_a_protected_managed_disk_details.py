...
class A2AProtectedManagedDiskDetails(BaseModel):
    ...
    recovery_replica_disk_id: Optional[StrictStr] = Field(default=None, description="Recovery replica disk Arm Id.", alias="recoveryReplicaDiskId")
    recovery_resource_group_id: Optional[StrictStr] = Field(default=None, description="The recovery disk resource group Arm Id.", alias="recoveryResourceGroupId")
    ...
    recovery_target_disk_id: Optional[StrictStr] = Field(default=None, description="Recovery target disk Arm Id.", alias="recoveryTargetDiskId")
    ...
    __properties: ClassVar[List[str]] = ["dataPendingAtSourceAgentInMB", "dataPendingInStagingStorageAccountInMB", "dekKeyVaultArmId", "diskCapacityInBytes", "diskId", "diskName", "diskType", "isDiskEncrypted", "isDiskKeyEncrypted", "kekKeyVaultArmId", "keyIdentifier", "monitoringJobType", "monitoringPercentageCompletion", "primaryStagingAzureStorageAccountId", "recoveryReplicaDiskAccountType", "recoveryReplicaDiskId", "recoveryResourceGroupId", "recoveryTargetDiskAccountType", "recoveryTargetDiskId", "resyncRequired", "secretIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoveryReplicaDiskId": obj.get("recoveryReplicaDiskId"),
            ...
            "recoveryTargetDiskId": obj.get("recoveryTargetDiskId"),
