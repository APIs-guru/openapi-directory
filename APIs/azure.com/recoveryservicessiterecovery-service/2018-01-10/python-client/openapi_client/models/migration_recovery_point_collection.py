...
class MigrationRecoveryPointCollection(BaseModel):
    """
    ...
    value: Optional[List[MigrationRecoveryPoint]] = Field(default=None, description="The migration recovery point details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [MigrationRecoveryPoint.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
