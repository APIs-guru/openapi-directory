...
class VMwareCbtTestMigrateInput(TestMigrateProviderSpecificInput):
    ...
    """ # noqa: E501
    network_id: StrictStr = Field(description="The test network Id.", alias="networkId")
    recovery_point_id: StrictStr = Field(description="The recovery point Id.", alias="recoveryPointId")
