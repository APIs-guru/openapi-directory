...
class VirtualMachineTaskDetails(TaskTypeDetails):
    ...
    """ # noqa: E501
    job_task: Optional[JobEntity] = Field(default=None, alias="jobTask")
    skipped_reason: Optional[StrictStr] = Field(default=None, description="The skipped reason.", alias="skippedReason")
    skipped_reason_string: Optional[StrictStr] = Field(default=None, description="The skipped reason string.", alias="skippedReasonString")
