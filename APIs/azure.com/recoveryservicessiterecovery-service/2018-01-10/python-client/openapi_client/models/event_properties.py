...
class EventProperties(BaseModel):
    ...
    """ # noqa: E501
    affected_object_correlation_id: Optional[StrictStr] = Field(default=None, description="The affected object correlationId for the event.", alias="affectedObjectCorrelationId")
    ...
    __properties: ClassVar[List[str]] = ["affectedObjectCorrelationId", "affectedObjectFriendlyName", "description", "eventCode", "eventSpecificDetails", "eventType", "fabricId", "healthErrors", "providerSpecificDetails", "severity", "timeOfOccurrence"]
