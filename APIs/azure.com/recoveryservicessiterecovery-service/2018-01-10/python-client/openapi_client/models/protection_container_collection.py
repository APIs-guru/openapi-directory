...
class ProtectionContainerCollection(BaseModel):
    """
    ...
    value: Optional[List[ProtectionContainer]] = Field(default=None, description="The Protection Container details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ProtectionContainer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
