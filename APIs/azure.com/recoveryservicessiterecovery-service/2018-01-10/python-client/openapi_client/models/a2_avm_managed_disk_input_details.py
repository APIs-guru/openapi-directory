...
class A2AVmManagedDiskInputDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["diskId", "primaryStagingAzureStorageAccountId", "recoveryReplicaDiskAccountType", "recoveryResourceGroupId", "recoveryTargetDiskAccountType"]
