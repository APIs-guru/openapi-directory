...
class RecoveryServicesProviderCollection(BaseModel):
    """
    Collection of providers.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The value of next link.", alias="nextLink")
    value: Optional[List[RecoveryServicesProvider]] = Field(default=None, description="The Servers details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RecoveryServicesProvider.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
