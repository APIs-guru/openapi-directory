...
class AzureFabricSpecificDetails(FabricSpecificDetails):
    ...
    """ # noqa: E501
    container_ids: Optional[List[StrictStr]] = Field(default=None, description="The container Ids for the Azure fabric.", alias="containerIds")
    location: Optional[StrictStr] = Field(default=None, description="The Location for the Azure fabric.")
