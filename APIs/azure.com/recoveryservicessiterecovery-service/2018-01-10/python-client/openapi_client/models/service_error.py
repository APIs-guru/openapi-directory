...
class ServiceError(BaseModel):
    ...
    ASR error model
    """ # noqa: E501
    activity_id: Optional[StrictStr] = Field(default=None, description="Activity Id.", alias="activityId")
    ...
    __properties: ClassVar[List[str]] = ["activityId", "code", "message", "possibleCauses", "recommendedAction"]
