...
class ProtectableItemCollection(BaseModel):
    """
    ...
    value: Optional[List[ProtectableItem]] = Field(default=None, description="The Protectable item details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ProtectableItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
