...
class UpdateReplicationProtectedItemInputProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enableRdpOnTargetOption", "licenseType", "providerSpecificDetails", "recoveryAvailabilitySetId", "recoveryAzureVMName", "recoveryAzureVMSize", "selectedRecoveryAzureNetworkId", "selectedSourceNicId", "vmNics"]
