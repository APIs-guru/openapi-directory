...
class HealthError(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creationTimeUtc", "entityId", "errorCategory", "errorCode", "errorLevel", "errorMessage", "errorSource", "errorType", "innerHealthErrors", "possibleCauses", "recommendedAction", "recoveryProviderErrorMessage", "summaryMessage"]
