...
class CreateNetworkMappingInput(BaseModel):
    """
    Create network mappings input.
    """ # noqa: E501
    properties: Optional[CreateNetworkMappingInputProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": CreateNetworkMappingInputProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
