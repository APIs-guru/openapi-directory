...
class VMwareCbtMigrationDetails(MigrationProviderSpecificSettings):
    ...
    initial_seeding_progress_percentage: Optional[StrictInt] = Field(default=None, description="The initial seeding progress percentage.", alias="initialSeedingProgressPercentage")
    last_recovery_point_id: Optional[StrictStr] = Field(default=None, description="The last recovery point Id.", alias="lastRecoveryPointId")
    ...
    migration_progress_percentage: Optional[StrictInt] = Field(default=None, description="The migration progress percentage.", alias="migrationProgressPercentage")
    ...
    resync_state: Optional[StrictStr] = Field(default=None, description="The resync state.", alias="resyncState")
    ...
    @field_validator('resync_state')
    def resync_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['None', 'PreparedForResynchronization', 'StartedResynchronization']):
            raise ValueError("must be one of enum values ('None', 'PreparedForResynchronization', 'StartedResynchronization')")
        return value
