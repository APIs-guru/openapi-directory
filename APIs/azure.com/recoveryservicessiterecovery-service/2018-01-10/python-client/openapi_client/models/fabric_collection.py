...
class FabricCollection(BaseModel):
    ...
    value: Optional[List[Fabric]] = Field(default=None, description="The fabric details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Fabric.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
