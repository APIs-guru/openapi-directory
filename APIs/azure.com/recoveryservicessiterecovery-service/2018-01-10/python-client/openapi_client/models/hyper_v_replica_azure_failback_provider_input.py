...
class HyperVReplicaAzureFailbackProviderInput(ProviderSpecificFailoverInput):
    ...
    """ # noqa: E501
    data_sync_option: Optional[StrictStr] = Field(default=None, description="Data sync option.", alias="dataSyncOption")
    provider_id_for_alternate_recovery: Optional[StrictStr] = Field(default=None, description="Provider ID for alternate location", alias="providerIdForAlternateRecovery")
    recovery_vm_creation_option: Optional[StrictStr] = Field(default=None, description="ALR options to create alternate recovery.", alias="recoveryVmCreationOption")
