...
class InMageDisableProtectionProviderSpecificInput(DisableProtectionProviderSpecificInput):
    ...
    """ # noqa: E501
    replica_vm_deletion_status: Optional[StrictStr] = Field(default=None, description="A value indicating whether the replica VM should be destroyed or retained. Values from Delete and Retain.", alias="replicaVmDeletionStatus")
