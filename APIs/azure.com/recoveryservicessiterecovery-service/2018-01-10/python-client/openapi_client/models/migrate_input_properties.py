...
class MigrateInputProperties(BaseModel):
    """
    Migrate input properties.
    """ # noqa: E501
    provider_specific_details: MigrateProviderSpecificInput = Field(alias="providerSpecificDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providerSpecificDetails": MigrateProviderSpecificInput.from_dict(obj["providerSpecificDetails"]) if obj.get("providerSpecificDetails") is not None else None
        })
        return _obj
