...
class ApplyRecoveryPointInput(BaseModel):
    """
    Input to apply recovery point.
    """ # noqa: E501
    properties: Optional[ApplyRecoveryPointInputProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ApplyRecoveryPointInputProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
