...
class TestRecoveryPlan(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecoveryPlan:
        """Test RecoveryPlan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecoveryPlan`
        """
        model = RecoveryPlan()
        if include_optional:
            return RecoveryPlan(
