...
class DatabasePrincipalAssignmentListResult(BaseModel):
    """
    The list Kusto database principal assignments operation response.
    """ # noqa: E501
    value: Optional[List[DatabasePrincipalAssignment]] = Field(default=None, description="The list of Kusto database principal assignments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabasePrincipalAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
