...
class CheckNameResult(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name that was checked.")
    name_available: Optional[StrictBool] = Field(default=None, description="Specifies a Boolean value that indicates if the name is available.", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="Message providing the reason why the given name is invalid.")
    __properties: ClassVar[List[str]] = ["message", "name", "nameAvailable", "reason"]
