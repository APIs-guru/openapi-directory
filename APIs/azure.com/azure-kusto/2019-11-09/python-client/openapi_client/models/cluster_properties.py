...
class ClusterProperties(BaseModel):
    ...
    state_reason: Optional[StrictStr] = Field(default=None, description="The reason for the cluster's current state.", alias="stateReason")
    ...
    __properties: ClassVar[List[str]] = ["dataIngestionUri", "enableDiskEncryption", "enableStreamingIngest", "keyVaultProperties", "optimizedAutoscale", "provisioningState", "state", "stateReason", "trustedExternalTenants", "uri", "virtualNetworkConfiguration"]
