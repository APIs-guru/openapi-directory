...
class DataConnectionListResult(BaseModel):
    """
    The list Kusto data connections operation response.
    """ # noqa: E501
    value: Optional[List[DataConnection]] = Field(default=None, description="The list of Kusto data connections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DataConnection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
