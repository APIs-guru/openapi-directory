...
class DatabasePrincipalProperties(BaseModel):
    """
    A class representing database principal property.
    """ # noqa: E501
    principal_id: StrictStr = Field(description="The principal ID assigned to the database principal. It can be a user email, application ID, or security group name.", alias="principalId")
