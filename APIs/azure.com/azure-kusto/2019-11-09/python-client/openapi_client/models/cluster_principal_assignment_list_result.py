...
class ClusterPrincipalAssignmentListResult(BaseModel):
    """
    The list Kusto cluster principal assignments operation response.
    """ # noqa: E501
    value: Optional[List[ClusterPrincipalAssignment]] = Field(default=None, description="The list of Kusto cluster principal assignments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ClusterPrincipalAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
