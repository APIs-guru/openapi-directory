...
class FollowerDatabaseListResult(BaseModel):
    """
    The list Kusto database principals operation response.
    """ # noqa: E501
    value: Optional[List[FollowerDatabaseDefinition]] = Field(default=None, description="The list of follower database result.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [FollowerDatabaseDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
