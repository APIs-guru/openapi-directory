...
class AttachedDatabaseConfigurationListResult(BaseModel):
    """
    The list attached database configurations operation response.
    """ # noqa: E501
    value: Optional[List[AttachedDatabaseConfiguration]] = Field(default=None, description="The list of attached database configurations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AttachedDatabaseConfiguration.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
