...
class DatabasePrincipalListRequest(BaseModel):
    """
    The list Kusto database principals operation request.
    """ # noqa: E501
    value: Optional[List[DatabasePrincipal]] = Field(default=None, description="The list of Kusto database principals.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabasePrincipal.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
