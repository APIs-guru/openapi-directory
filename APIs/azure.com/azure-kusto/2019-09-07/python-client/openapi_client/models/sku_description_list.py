...
class SkuDescriptionList(BaseModel):
    """
    The list of the EngagementFabric SKU descriptions
    """ # noqa: E501
    value: Optional[List[SkuDescription]] = Field(default=None, description="SKU descriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SkuDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
