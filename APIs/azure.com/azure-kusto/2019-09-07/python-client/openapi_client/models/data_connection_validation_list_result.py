...
class DataConnectionValidationListResult(BaseModel):
    """
    The list Kusto data connection validation result.
    """ # noqa: E501
    value: Optional[List[DataConnectionValidationResult]] = Field(default=None, description="The list of Kusto data connection validation errors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DataConnectionValidationResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
