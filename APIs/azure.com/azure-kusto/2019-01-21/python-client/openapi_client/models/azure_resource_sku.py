...
class AzureResourceSku(BaseModel):
    """
    Azure resource SKU definition.
    """ # noqa: E501
    capacity: Optional[AzureCapacity] = None
    resource_type: Optional[StrictStr] = Field(default=None, description="Resource Namespace and Type.", alias="resourceType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": AzureCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "resourceType": obj.get("resourceType"),
            "sku": AzureSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None
        })
        return _obj
