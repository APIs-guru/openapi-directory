...
class ListResourceSkusResult(BaseModel):
    """
    List of available SKUs for an existing Kusto Cluster.
    """ # noqa: E501
    value: Optional[List[AzureResourceSku]] = Field(default=None, description="The collection of available SKUs for an existing resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AzureResourceSku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
