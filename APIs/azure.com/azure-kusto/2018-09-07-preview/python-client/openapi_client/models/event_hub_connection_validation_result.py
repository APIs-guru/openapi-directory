...
class EventHubConnectionValidationResult(BaseModel):
    """
    EventHubConnectionValidationResult
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="A message which indicates a problem in event hub connection validation.", alias="errorMessage")
