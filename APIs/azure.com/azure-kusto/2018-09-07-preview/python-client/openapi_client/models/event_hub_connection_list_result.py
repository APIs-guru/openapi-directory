...
class EventHubConnectionListResult(BaseModel):
    """
    The list Kusto event hub connections operation response.
    """ # noqa: E501
    value: Optional[List[EventHubConnection]] = Field(default=None, description="The list of Kusto event hub connections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [EventHubConnection.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
