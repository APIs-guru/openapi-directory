...
class ListSkusResult(BaseModel):
    """
    List of available SKUs for a new Kusto Cluster.
    """ # noqa: E501
    value: Optional[List[AzureSku]] = Field(default=None, description="The collection of available SKUs for new resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AzureSku.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
