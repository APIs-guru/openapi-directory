...
class ClusterProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataIngestionUri", "enableDiskEncryption", "enableStreamingIngest", "optimizedAutoscale", "provisioningState", "state", "trustedExternalTenants", "uri", "virtualNetworkConfiguration"]
