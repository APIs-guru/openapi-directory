...
class EventHubConnectionValidationListResult(BaseModel):
    """
    The list Kusto event hub connection validation result.
    """ # noqa: E501
    value: Optional[List[EventHubConnectionValidationResult]] = Field(default=None, description="The list of Kusto event hub connection validation errors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [EventHubConnectionValidationResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
