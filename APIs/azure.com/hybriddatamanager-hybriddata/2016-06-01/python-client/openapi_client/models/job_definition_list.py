...
class JobDefinitionList(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for the next set of job definitions.", alias="nextLink")
    value: Optional[List[JobDefinition]] = Field(default=None, description="List of job definitions.")
