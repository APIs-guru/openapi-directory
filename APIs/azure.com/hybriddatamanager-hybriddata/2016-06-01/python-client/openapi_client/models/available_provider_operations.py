...
class AvailableProviderOperations(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for the next set of operations.", alias="nextLink")
    value: Optional[List[AvailableProviderOperation]] = Field(default=None, description="List of operations.")
