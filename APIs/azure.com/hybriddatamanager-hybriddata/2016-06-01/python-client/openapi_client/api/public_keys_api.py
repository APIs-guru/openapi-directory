...
class PublicKeysApi:
    ...
    def public_keys_get(
        self,
        public_key_name: Annotated[StrictStr, Field(description="Name of the public key.")],
        ...
        :param public_key_name: Name of the public key. (required)
        ...
        _param = self._public_keys_get_serialize(
    ...
    @validate_call
    def public_keys_get_without_preload_content(
        self,
        public_key_name: Annotated[StrictStr, Field(description="Name of the public key.")],
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
    ...
    def _public_keys_get_serialize(
        self,
        public_key_name,
        subscription_id,
        resource_group_name,
        ...
        if public_key_name is not None:
            _path_params['publicKeyName'] = public_key_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/publicKeys/{publicKeyName}',
    ...
    @validate_call
    def public_keys_list_by_data_manager(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
        ...
        _param = self._public_keys_list_by_data_manager_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            data_manager_name=data_manager_name,
            api_version=api_version,
    ...
    @validate_call
    def public_keys_list_by_data_manager_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
    ...
    @validate_call
    def public_keys_list_by_data_manager_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
    ...
    def _public_keys_list_by_data_manager_serialize(
        self,
        subscription_id,
        resource_group_name,
        data_manager_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/publicKeys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
