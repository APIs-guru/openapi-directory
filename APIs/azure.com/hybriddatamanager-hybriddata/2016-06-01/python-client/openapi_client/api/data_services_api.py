...
class DataServicesApi:
    ...
    @validate_call
    def data_services_get(
        self,
        data_service_name: Annotated[StrictStr, Field(description="The name of the data service that is being queried.")],
        ...
        :param data_service_name: The name of the data service that is being queried. (required)
        ...
        _param = self._data_services_get_serialize(
    ...
    @validate_call
    def data_services_get_with_http_info(
        self,
        data_service_name: Annotated[StrictStr, Field(description="The name of the data service that is being queried.")],
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
    ...
    @validate_call
    def data_services_get_without_preload_content(
        self,
        data_service_name: Annotated[StrictStr, Field(description="The name of the data service that is being queried.")],
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
    ...
    def _data_services_get_serialize(
        self,
        data_service_name,
        subscription_id,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}',
    ...
    @validate_call
    def data_services_list_by_data_manager(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
        ...
        _param = self._data_services_list_by_data_manager_serialize(
            subscription_id=subscription_id,
            resource_group_name=resource_group_name,
            data_manager_name=data_manager_name,
            api_version=api_version,
    ...
    @validate_call
    def data_services_list_by_data_manager_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
    ...
    @validate_call
    def data_services_list_by_data_manager_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The Subscription Id")],
        resource_group_name: Annotated[StrictStr, Field(description="The Resource Group Name")],
        data_manager_name: Annotated[str, Field(min_length=3, strict=True, max_length=24, description="The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only")],
    ...
    def _data_services_list_by_data_manager_serialize(
        self,
        subscription_id,
        resource_group_name,
        data_manager_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
