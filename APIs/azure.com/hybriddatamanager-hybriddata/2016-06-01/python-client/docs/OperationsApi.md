...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.HybridData/operations | This method gets all the operations.


# **operations_list**
> AvailableProviderOperations operations_list(api_version)
