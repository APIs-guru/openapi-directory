...
class TestJobDefinitionProperties(unittest.TestCase):
    """JobDefinitionProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobDefinitionProperties:
        """Test JobDefinitionProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobDefinitionProperties`
        """
        model = JobDefinitionProperties()
        if include_optional:
            return JobDefinitionProperties(
                customer_secrets = [
    ...
    def testJobDefinitionProperties(self):
        """Test JobDefinitionProperties"""
