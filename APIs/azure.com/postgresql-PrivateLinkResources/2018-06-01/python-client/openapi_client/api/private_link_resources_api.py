...
class PrivateLinkResourcesApi:
    ...
    def _private_link_resources_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateLinkResources/{groupName}',
    ...
    @validate_call
    def private_link_resources_list_by_server(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
        ...
        _param = self._private_link_resources_list_by_server_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            subscription_id=subscription_id,
            api_version=api_version,
    ...
    @validate_call
    def private_link_resources_list_by_server_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
    ...
    @validate_call
    def private_link_resources_list_by_server_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="The name of the resource group. The name is case insensitive.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        subscription_id: Annotated[str, Field(min_length=1, strict=True, description="The ID of the target subscription.")],
    ...
    def _private_link_resources_list_by_server_serialize(
        self,
        resource_group_name,
        server_name,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateLinkResources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
