...
class RoleAssignmentPropertiesWithScope(BaseModel):
    ...
    """ # noqa: E501
    can_delegate: Optional[StrictBool] = Field(default=None, description="The Delegation flag for the role assignment", alias="canDelegate")
    ...
    __properties: ClassVar[List[str]] = ["canDelegate", "principalId", "principalType", "roleDefinitionId", "scope"]
