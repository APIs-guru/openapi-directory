...
class FeatureResult(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The resource ID of the feature.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the feature.")
    properties: Optional[FeatureProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="The resource type of the feature.")
