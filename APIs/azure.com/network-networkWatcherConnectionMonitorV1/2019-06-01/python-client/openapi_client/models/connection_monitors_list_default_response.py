...
class ConnectionMonitorsListDefaultResponse(BaseModel):
    """
    The error object.
    """ # noqa: E501
    error: Optional[ConnectionMonitorsListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ConnectionMonitorsListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
