...
class AudioAnalyzerPreset(Preset):
    ...
    """ # noqa: E501
    audio_language: Optional[StrictStr] = Field(default=None, description="The language for the audio payload in the input using the BCP-47 format of 'language tag-region' (e.g: 'en-US'). The list of supported languages are, 'en-US', 'en-GB', 'es-ES', 'es-MX', 'fr-FR', 'it-IT', 'ja-JP', 'pt-BR', 'zh-CN'.", alias="audioLanguage")
