...
class StandardEncoderPreset(Preset):
    ...
    """ # noqa: E501
    codecs: Optional[List[Codec]] = Field(default=None, description="The list of codecs to be used when encoding the input video.")
    filters: Optional[Filters] = None
    formats: Optional[List[Format]] = Field(default=None, description="The list of outputs to be produced by the encoder.")
