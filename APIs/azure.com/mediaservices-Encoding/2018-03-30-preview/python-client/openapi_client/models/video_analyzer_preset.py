...
class VideoAnalyzerPreset(AudioAnalyzerPreset):
    ...
    """ # noqa: E501
    audio_insights_only: Optional[StrictBool] = Field(default=None, description="Whether to only extract audio insights when processing a video file.", alias="audioInsightsOnly")
