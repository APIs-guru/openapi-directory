...
------------ | ------------- | ------------- | -------------
**codecs** | [**List[Codec]**](Codec.md) | The list of codecs to be used when encoding the input video. | 
**filters** | [**Filters**](Filters.md) |  | [optional] 
**formats** | [**List[Format]**](Format.md) | The list of outputs to be produced by the encoder. | 
