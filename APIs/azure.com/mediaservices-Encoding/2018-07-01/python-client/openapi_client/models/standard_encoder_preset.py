...
class StandardEncoderPreset(Preset):
    ...
    """ # noqa: E501
    codecs: List[Codec] = Field(description="The list of codecs to be used when encoding the input video.")
    filters: Optional[Filters] = None
    formats: List[Format] = Field(description="The list of outputs to be produced by the encoder.")
