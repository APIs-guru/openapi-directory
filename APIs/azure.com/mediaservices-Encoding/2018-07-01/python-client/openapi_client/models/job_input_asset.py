...
class JobInputAsset(JobInputClip):
    ...
    """ # noqa: E501
    asset_name: StrictStr = Field(description="The name of the input Asset.", alias="assetName")
    __properties: ClassVar[List[str]] = ["end", "files", "label", "start", "@odata.type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "end": ClipTime.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "files": obj.get("files"),
            "label": obj.get("label"),
            "start": ClipTime.from_dict(obj["start"]) if obj.get("start") is not None else None,
