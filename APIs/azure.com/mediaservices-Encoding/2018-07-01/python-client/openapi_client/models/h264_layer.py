...
class H264Layer(VideoLayer):
    ...
    level: Optional[StrictStr] = Field(default=None, description="We currently support Level up to 6.2. The value can be Auto, or a number that matches the H.264 profile. If not specified, the default is Auto, which lets the encoder choose the Level that is appropriate for this layer.")
    profile: Optional[StrictStr] = Field(default=None, description="We currently support Baseline, Main, High, High422, High444. Default is Auto.")
