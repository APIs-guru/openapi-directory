...
class JobOutputAsset(JobOutput):
    ...
    """ # noqa: E501
    asset_name: StrictStr = Field(description="The name of the output Asset.", alias="assetName")
    __properties: ClassVar[List[str]] = ["@odata.type", "error", "label", "progress", "state"]
