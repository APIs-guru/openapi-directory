...
class JobProperties(BaseModel):
    ...
    """ # noqa: E501
    correlation_data: Optional[Dict[str, StrictStr]] = Field(default=None, description="Customer provided key, value pairs that will be returned in Job and JobOutput state events.", alias="correlationData")
