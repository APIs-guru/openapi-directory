...
class VideoLayer(Layer):
    ...
    bitrate: StrictInt = Field(description="The average bitrate in bits per second at which to encode the input video when generating this layer. This is a required field.")
