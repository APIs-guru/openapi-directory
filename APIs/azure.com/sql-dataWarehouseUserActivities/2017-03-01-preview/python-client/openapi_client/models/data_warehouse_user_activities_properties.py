...
class DataWarehouseUserActivitiesProperties(BaseModel):
    """
    ...
    """ # noqa: E501
    active_queries_count: Optional[StrictInt] = Field(default=None, description="Count of running and suspended queries.", alias="activeQueriesCount")
    __properties: ClassVar[List[str]] = ["activeQueriesCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeQueriesCount": obj.get("activeQueriesCount")
        })
        return _obj
