...
class DataWarehouseUserActivitiesApi:
    ...
    @validate_call
    def data_warehouse_user_activities_get(
        self,
        ...
        data_warehouse_user_activity_name: Annotated[StrictStr, Field(description="The activity name of the data warehouse. ")],
        ...
        :param data_warehouse_user_activity_name: The activity name of the data warehouse.  (required)
        ...
        _param = self._data_warehouse_user_activities_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DataWarehouseUserActivities",
        }
    ...
    @validate_call
    def data_warehouse_user_activities_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataWarehouseUserActivities]:
        """data_warehouse_user_activities_get
    ...
    @validate_call
    def data_warehouse_user_activities_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _data_warehouse_user_activities_get_serialize(
        self,
        resource_group_name,
        server_name,
        database_name,
        ...
        if data_warehouse_user_activity_name is not None:
            _path_params['dataWarehouseUserActivityName'] = data_warehouse_user_activity_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/dataWarehouseUserActivities/{dataWarehouseUserActivityName}',
