...
> AgentRegistration agent_registration_information_get(resource_group_name, automation_account_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.agent_registration_information_get(resource_group_name, automation_account_name, subscription_id, api_version)
...
> AgentRegistration agent_registration_information_regenerate_key(resource_group_name, automation_account_name, subscription_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.agent_registration_information_regenerate_key(resource_group_name, automation_account_name, subscription_id, api_version, parameters)
