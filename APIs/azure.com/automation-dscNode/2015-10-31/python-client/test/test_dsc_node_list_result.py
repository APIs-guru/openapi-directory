...
class TestDscNodeListResult(unittest.TestCase):
    """DscNodeListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DscNodeListResult:
        """Test DscNodeListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DscNodeListResult`
        """
        model = DscNodeListResult()
        if include_optional:
            return DscNodeListResult(
                next_link = '',
                value = [
                    openapi_client.models.dsc_node.DscNode(
                        account_id = '', 
                        etag = '', 
                        extension_handler = [
    ...
    def testDscNodeListResult(self):
        """Test DscNodeListResult"""
