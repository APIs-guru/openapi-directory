...
class TestDscNodeReportListResult(unittest.TestCase):
    """DscNodeReportListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DscNodeReportListResult:
        """Test DscNodeReportListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DscNodeReportListResult`
        """
        model = DscNodeReportListResult()
        if include_optional:
            return DscNodeReportListResult(
                next_link = '',
                value = [
                    openapi_client.models.dsc_node_report.DscNodeReport(
    ...
    def testDscNodeReportListResult(self):
        """Test DscNodeReportListResult"""
