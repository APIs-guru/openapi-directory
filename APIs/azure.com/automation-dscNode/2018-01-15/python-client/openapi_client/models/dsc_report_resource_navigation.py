...
class DscReportResourceNavigation(BaseModel):
    """
    Navigation for DSC Report Resource.
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the ID of the resource to navigate to.", alias="resourceId")
