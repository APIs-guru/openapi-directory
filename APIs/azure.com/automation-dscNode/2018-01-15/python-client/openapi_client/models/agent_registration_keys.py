...
class AgentRegistrationKeys(BaseModel):
    """
    Definition of the agent registration keys.
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Gets or sets the primary key.")
    secondary: Optional[StrictStr] = Field(default=None, description="Gets or sets the secondary key.")
