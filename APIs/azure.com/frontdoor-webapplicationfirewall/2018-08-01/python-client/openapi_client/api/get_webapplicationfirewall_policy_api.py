...
class GetWebapplicationfirewallPolicyApi:
    ...
    def policies_get(
        ...
        policy_name: Annotated[str, Field(strict=True, max_length=128, description="The name of the resource group.")],
        ...
        :param policy_name: The name of the resource group. (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebApplicationFirewallPolicy",
        }
    ...
    def policies_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebApplicationFirewallPolicy]:
        """policies_get
    ...
    def _policies_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/FrontDoorWebApplicationFirewallPolicies/{policyName}',
