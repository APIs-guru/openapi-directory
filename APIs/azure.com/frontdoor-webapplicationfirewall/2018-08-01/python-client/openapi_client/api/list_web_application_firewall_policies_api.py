...
class ListWebApplicationFirewallPoliciesApi:
    ...
    def policies_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebApplicationFirewallPolicyListResult",
        }
    ...
    def policies_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebApplicationFirewallPolicyListResult]:
        """policies_list
    ...
    def _policies_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/FrontDoorWebApplicationFirewallPolicies',
