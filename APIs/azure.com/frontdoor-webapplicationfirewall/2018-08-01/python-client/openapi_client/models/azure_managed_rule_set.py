...
class AzureManagedRuleSet(ManagedRuleSet):
    ...
    """ # noqa: E501
    rule_group_overrides: Optional[List[AzureManagedOverrideRuleGroup]] = Field(default=None, description="List of azure managed provider override configuration (optional)", alias="ruleGroupOverrides")
