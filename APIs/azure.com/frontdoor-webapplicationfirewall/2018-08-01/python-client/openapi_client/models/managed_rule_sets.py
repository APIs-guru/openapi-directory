...
class ManagedRuleSets(BaseModel):
    """
    Defines ManagedRuleSets - array of managedRuleSet
    """ # noqa: E501
    rule_sets: Optional[List[ManagedRuleSet]] = Field(default=None, description="List of rules", alias="ruleSets")
    __properties: ClassVar[List[str]] = ["ruleSets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleSets": [ManagedRuleSet.from_dict(_item) for _item in obj["ruleSets"]] if obj.get("ruleSets") is not None else None
        })
        return _obj
