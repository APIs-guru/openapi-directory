...
class CustomRule(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Describes the name of the rule.")
    ...
    rate_limit_duration_in_minutes: Optional[Annotated[int, Field(le=5, strict=True, ge=0)]] = Field(default=None, description="Time window for resetting the rate limit count. Default is 1 minute.", alias="rateLimitDurationInMinutes")
    rate_limit_threshold: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of allowed requests per client within the time window.", alias="rateLimitThreshold")
    rule_type: StrictStr = Field(description="Describes type of rule.", alias="ruleType")
    __properties: ClassVar[List[str]] = ["action", "enabledState", "matchConditions", "name", "priority", "rateLimitDurationInMinutes", "rateLimitThreshold", "ruleType"]
