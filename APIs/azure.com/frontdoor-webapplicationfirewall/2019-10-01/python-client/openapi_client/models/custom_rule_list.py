...
class CustomRuleList(BaseModel):
    ...
    """ # noqa: E501
    rules: Optional[List[CustomRule]] = Field(default=None, description="List of rules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [CustomRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
