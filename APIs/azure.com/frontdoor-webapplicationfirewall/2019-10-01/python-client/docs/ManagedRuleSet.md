...
------------ | ------------- | ------------- | -------------
**exclusions** | [**List[ManagedRuleExclusion]**](ManagedRuleExclusion.md) | Describes the exclusions that are applied to all rules in the set. | [optional] 
**rule_group_overrides** | [**List[ManagedRuleGroupOverride]**](ManagedRuleGroupOverride.md) | Defines the rule group overrides to apply to the rule set. | [optional] 
