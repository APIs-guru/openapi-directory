...
class TestWebApplicationFirewallPolicyProperties(unittest.TestCase):
    """WebApplicationFirewallPolicyProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebApplicationFirewallPolicyProperties:
        """Test WebApplicationFirewallPolicyProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebApplicationFirewallPolicyProperties`
        """
        model = WebApplicationFirewallPolicyProperties()
        if include_optional:
            return WebApplicationFirewallPolicyProperties(
    ...
    def testWebApplicationFirewallPolicyProperties(self):
        """Test WebApplicationFirewallPolicyProperties"""
