...
class ExtendedErrorInfo(BaseModel):
    ...
    details: Optional[ExtendedErrorInfoList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": ExtendedErrorInfoList.from_dict(obj["details"]) if obj.get("details") is not None else None,
...
ExtendedErrorInfo.model_rebuild(raise_errors=False)
