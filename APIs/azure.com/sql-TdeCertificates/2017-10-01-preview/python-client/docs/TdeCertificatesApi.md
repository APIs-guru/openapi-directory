# openapi_client.TdeCertificatesApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**tde_certificates_create**](TdeCertificatesApi.md#tde_certificates_create) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/tdeCertificates | 


# **tde_certificates_create**
> tde_certificates_create(resource_group_name, server_name, subscription_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TdeCertificatesApi(api_client)
    ...
    try:
        api_instance.tde_certificates_create(resource_group_name, server_name, subscription_id, api_version, parameters)
    except Exception as e:
        print("Exception when calling TdeCertificatesApi->tde_certificates_create: %s\n" % e)
```
