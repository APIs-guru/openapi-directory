...
------------ | ------------- | ------------- | -------------
*AcquisitionsApi* | [**acquisitions_list**](docs/AcquisitionsApi.md#acquisitions_list) | **GET** /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/acquisitions | 


## Documentation For Models

 - [Acquisition](docs/Acquisition.md)
 - [AcquisitionProperties](docs/AcquisitionProperties.md)
