...
class AcquisitionsApi:
    ...
    def acquisitions_list(
        ...
        _param = self._acquisitions_list_serialize(
    ...
    @validate_call
    def acquisitions_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        farm_id: Annotated[StrictStr, Field(description="Farm Id.")],
    ...
    @validate_call
    def acquisitions_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription Id.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group name.")],
        farm_id: Annotated[StrictStr, Field(description="Farm Id.")],
    ...
    def _acquisitions_list_serialize(
        self,
        subscription_id,
        resource_group_name,
        farm_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/acquisitions',
