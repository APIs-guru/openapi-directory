...
class AcquisitionList(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[Acquisition]] = Field(default=None, description="List of acquisitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Acquisition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
