...
------------ | ------------- | ------------- | -------------
*AcquisitionsApi* | [**acquisitions_list**](docs/AcquisitionsApi.md#acquisitions_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Storage.Admin/locations/{location}/acquisitions | 


## Documentation For Models

 - [Acquisition](docs/Acquisition.md)
 - [AcquisitionList](docs/AcquisitionList.md)
 - [AcquisitionStatus](docs/AcquisitionStatus.md)
 - [AcquisitionsListDefaultResponse](docs/AcquisitionsListDefaultResponse.md)
