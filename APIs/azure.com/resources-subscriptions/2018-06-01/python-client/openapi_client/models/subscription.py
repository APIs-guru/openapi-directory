...
class Subscription(BaseModel):
    ...
    tenant_id: Optional[StrictStr] = Field(default=None, description="The subscription tenant ID.", alias="tenantId")
    __properties: ClassVar[List[str]] = ["authorizationSource", "displayName", "id", "state", "subscriptionId", "subscriptionPolicies", "tenantId"]
