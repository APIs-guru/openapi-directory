...
**managed_by_tenants** | [**List[ManagedByTenant]**](ManagedByTenant.md) | An array containing the tenants managing the subscription. | [optional] 
...
**tenant_id** | **str** | The subscription tenant ID. | [optional] [readonly] 
