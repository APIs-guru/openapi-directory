...
class Subscription(BaseModel):
    ...
    managed_by_tenants: Optional[List[ManagedByTenant]] = Field(default=None, description="An array containing the tenants managing the subscription.", alias="managedByTenants")
    ...
    __properties: ClassVar[List[str]] = ["authorizationSource", "displayName", "id", "managedByTenants", "state", "subscriptionId", "subscriptionPolicies", "tenantId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in managed_by_tenants (list)
        _items = []
        if self.managed_by_tenants:
            for _item_managed_by_tenants in self.managed_by_tenants:
                if _item_managed_by_tenants:
                    _items.append(_item_managed_by_tenants.to_dict())
            _dict['managedByTenants'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "managedByTenants": [ManagedByTenant.from_dict(_item) for _item in obj["managedByTenants"]] if obj.get("managedByTenants") is not None else None,
            "state": obj.get("state"),
