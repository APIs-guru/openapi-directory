...
class SecurityAssessmentPropertiesMetadata(BaseModel):
    """
    ...
    partner_data: Optional[SecurityAssessmentPropertiesMetadataPartnerData] = Field(default=None, alias="partnerData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partnerData": SecurityAssessmentPropertiesMetadataPartnerData.from_dict(obj["partnerData"]) if obj.get("partnerData") is not None else None,
