...
class AssessmentsApi:
    ...
    @validate_call
    def assessments_create_or_update(
        self,
        ...
        assessment: Annotated[SecurityAssessment, Field(description="Calculated assessment on a pre-defined assessment metadata")],
        ...
        :type assessment: SecurityAssessment
        ...
        _param = self._assessments_create_or_update_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SecurityAssessment",
            '201': "SecurityAssessment",
        }
    ...
    @validate_call
    def assessments_create_or_update_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        resource_id: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        assessment_name: Annotated[StrictStr, Field(description="The Assessment Key - Unique key for the assessment type")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SecurityAssessment]:
        """assessments_create_or_update
    ...
    @validate_call
    def assessments_create_or_update_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        resource_id: Annotated[StrictStr, Field(description="The identifier of the resource.")],
        assessment_name: Annotated[StrictStr, Field(description="The Assessment Key - Unique key for the assessment type")],
    ...
    def _assessments_create_or_update_serialize(
        self,
        api_version,
        resource_id,
        assessment_name,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/{resourceId}/providers/Microsoft.Security/assessments/{assessmentName}',
    ...
    def assessments_list(
        ...
        _param = self._assessments_list_serialize(
            api_version=api_version,
            scope=scope,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def assessments_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SecurityAssessmentList]:
        """assessments_list
    ...
    @validate_call
    def assessments_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="API version for the operation")],
        scope: Annotated[StrictStr, Field(description="Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).")],
        _request_timeout: Union[
    ...
    def _assessments_list_serialize(
        self,
        api_version,
        scope,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{scope}/providers/Microsoft.Security/assessments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
