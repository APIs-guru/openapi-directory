...
class SecurityAssessmentList(BaseModel):
    """
    ...
    value: Optional[List[SecurityAssessment]] = Field(default=None, description="Collection of security assessments in this page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SecurityAssessment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
