...
class TestAvailabilitySetListResult(unittest.TestCase):
    """AvailabilitySetListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilitySetListResult:
        """Test AvailabilitySetListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilitySetListResult`
        """
        model = AvailabilitySetListResult()
        if include_optional:
            return AvailabilitySetListResult(
                next_link = '',
                value = [
                    openapi_client.models.availability_set.AvailabilitySet(
    ...
    def testAvailabilitySetListResult(self):
        """Test AvailabilitySetListResult"""
