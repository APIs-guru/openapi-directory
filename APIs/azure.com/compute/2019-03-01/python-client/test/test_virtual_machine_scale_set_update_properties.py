...
class TestVirtualMachineScaleSetUpdateProperties(unittest.TestCase):
    """VirtualMachineScaleSetUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualMachineScaleSetUpdateProperties:
        """Test VirtualMachineScaleSetUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualMachineScaleSetUpdateProperties`
        """
        model = VirtualMachineScaleSetUpdateProperties()
        if include_optional:
            return VirtualMachineScaleSetUpdateProperties(
    ...
    def testVirtualMachineScaleSetUpdateProperties(self):
        """Test VirtualMachineScaleSetUpdateProperties"""
