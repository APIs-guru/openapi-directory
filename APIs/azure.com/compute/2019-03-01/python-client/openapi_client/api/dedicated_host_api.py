...
class DedicatedHostApi:
    ...
    @validate_call
    def dedicated_hosts_list_by_host_group(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        host_group_name: Annotated[StrictStr, Field(description="The name of the dedicated host group.")],
        ...
        _param = self._dedicated_hosts_list_by_host_group_serialize(
    ...
    @validate_call
    def dedicated_hosts_list_by_host_group_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        host_group_name: Annotated[StrictStr, Field(description="The name of the dedicated host group.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DedicatedHostListResult]:
        """dedicated_hosts_list_by_host_group
    ...
    @validate_call
    def dedicated_hosts_list_by_host_group_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        host_group_name: Annotated[StrictStr, Field(description="The name of the dedicated host group.")],
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
    ...
    def _dedicated_hosts_list_by_host_group_serialize(
        self,
        resource_group_name,
        host_group_name,
        api_version,
        ...
        if host_group_name is not None:
            _path_params['hostGroupName'] = host_group_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}/hosts',
