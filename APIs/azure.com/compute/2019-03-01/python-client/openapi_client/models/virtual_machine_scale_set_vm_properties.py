...
class VirtualMachineScaleSetVMProperties(BaseModel):
    """
    ...
    instance_view: Optional[VirtualMachineScaleSetVMInstanceView] = Field(default=None, alias="instanceView")
    latest_model_applied: Optional[StrictBool] = Field(default=None, description="Specifies whether the latest model has been applied to the virtual machine.", alias="latestModelApplied")
    ...
    model_definition_applied: Optional[StrictStr] = Field(default=None, description="Specifies whether the model applied to the virtual machine is the model of the virtual machine scale set or the customized model for the virtual machine.", alias="modelDefinitionApplied")
    network_profile: Optional[NetworkProfile] = Field(default=None, alias="networkProfile")
    network_profile_configuration: Optional[VirtualMachineScaleSetVMNetworkProfileConfiguration] = Field(default=None, alias="networkProfileConfiguration")
    os_profile: Optional[OSProfile] = Field(default=None, alias="osProfile")
    protection_policy: Optional[VirtualMachineScaleSetVMProtectionPolicy] = Field(default=None, alias="protectionPolicy")
    ...
    vm_id: Optional[StrictStr] = Field(default=None, description="Azure VM unique ID.", alias="vmId")
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "availabilitySet", "diagnosticsProfile", "hardwareProfile", "instanceView", "latestModelApplied", "licenseType", "modelDefinitionApplied", "networkProfile", "networkProfileConfiguration", "osProfile", "protectionPolicy", "provisioningState", "storageProfile", "vmId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of network_profile_configuration
        if self.network_profile_configuration:
            _dict['networkProfileConfiguration'] = self.network_profile_configuration.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instanceView": VirtualMachineScaleSetVMInstanceView.from_dict(obj["instanceView"]) if obj.get("instanceView") is not None else None,
            "latestModelApplied": obj.get("latestModelApplied"),
            "licenseType": obj.get("licenseType"),
            "modelDefinitionApplied": obj.get("modelDefinitionApplied"),
            "networkProfile": NetworkProfile.from_dict(obj["networkProfile"]) if obj.get("networkProfile") is not None else None,
            "networkProfileConfiguration": VirtualMachineScaleSetVMNetworkProfileConfiguration.from_dict(obj["networkProfileConfiguration"]) if obj.get("networkProfileConfiguration") is not None else None,
            "osProfile": OSProfile.from_dict(obj["osProfile"]) if obj.get("osProfile") is not None else None,
            "protectionPolicy": VirtualMachineScaleSetVMProtectionPolicy.from_dict(obj["protectionPolicy"]) if obj.get("protectionPolicy") is not None else None,
