...
class VirtualMachineScaleSetUpdateIPConfigurationProperties(BaseModel):
    """
    ...
    primary: Optional[StrictBool] = Field(default=None, description="Specifies the primary IP Configuration in case the network interface has more than one IP Configuration.")
    ...
    public_ip_address_configuration: Optional[VirtualMachineScaleSetUpdatePublicIPAddressConfiguration] = Field(default=None, alias="publicIPAddressConfiguration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicIPAddressConfiguration": VirtualMachineScaleSetUpdatePublicIPAddressConfiguration.from_dict(obj["publicIPAddressConfiguration"]) if obj.get("publicIPAddressConfiguration") is not None else None,
