...
class NetworkProfile(BaseModel):
    ...
    """ # noqa: E501
    network_interfaces: Optional[List[NetworkInterfaceReference]] = Field(default=None, description="Specifies the list of resource Ids for the network interfaces associated with the virtual machine.", alias="networkInterfaces")
    __properties: ClassVar[List[str]] = ["networkInterfaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkInterfaces": [NetworkInterfaceReference.from_dict(_item) for _item in obj["networkInterfaces"]] if obj.get("networkInterfaces") is not None else None
        })
        return _obj
