...
class VirtualMachineScaleSetUpdateProperties(BaseModel):
    """
    ...
    virtual_machine_profile: Optional[VirtualMachineScaleSetUpdateVMProfile] = Field(default=None, alias="virtualMachineProfile")
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "overprovision", "scaleInPolicy", "singlePlacementGroup", "upgradePolicy", "virtualMachineProfile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "virtualMachineProfile": VirtualMachineScaleSetUpdateVMProfile.from_dict(obj["virtualMachineProfile"]) if obj.get("virtualMachineProfile") is not None else None
        })
        return _obj
