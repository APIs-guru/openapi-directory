...
class UpgradePolicy(BaseModel):
    ...
    """ # noqa: E501
    automatic_os_upgrade_policy: Optional[AutomaticOSUpgradePolicy] = Field(default=None, alias="automaticOSUpgradePolicy")
    ...
    __properties: ClassVar[List[str]] = ["automaticOSUpgradePolicy", "mode", "rollingUpgradePolicy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of automatic_os_upgrade_policy
        if self.automatic_os_upgrade_policy:
            _dict['automaticOSUpgradePolicy'] = self.automatic_os_upgrade_policy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "automaticOSUpgradePolicy": AutomaticOSUpgradePolicy.from_dict(obj["automaticOSUpgradePolicy"]) if obj.get("automaticOSUpgradePolicy") is not None else None,
            "mode": obj.get("mode"),
