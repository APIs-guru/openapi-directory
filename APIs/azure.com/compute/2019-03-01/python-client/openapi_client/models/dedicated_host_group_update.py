...
class DedicatedHostGroupUpdate(BaseModel):
    """
    Specifies information about the dedicated host group that the dedicated host should be assigned to. Only tags may be updated.
    """ # noqa: E501
    properties: Optional[DedicatedHostGroupProperties] = None
    zones: Optional[List[StrictStr]] = Field(default=None, description="Availability Zone to use for this host group. Only single zone is supported. The zone can be assigned only during creation. If not provided, the group supports all zones in the region. If provided, enforces each host in the group to be in the same zone.")
