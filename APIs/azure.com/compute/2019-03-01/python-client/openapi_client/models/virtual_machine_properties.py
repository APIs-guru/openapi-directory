...
class VirtualMachineProperties(BaseModel):
    ...
    eviction_policy: Optional[StrictStr] = Field(default=None, description="Specifies the eviction policy for the low priority virtual machine. Only supported value is 'Deallocate'. <br><br>Minimum api-version: 2019-03-01", alias="evictionPolicy")
    ...
    priority: Optional[StrictStr] = Field(default=None, description="Specifies the priority for the virtual machine. <br><br>Minimum api-version: 2019-03-01")
