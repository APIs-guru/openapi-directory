...
class VirtualMachineScaleSetUpdateNetworkConfiguration(BaseModel):
    """
    Describes a virtual machine scale set network profile's network configurations.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The network configuration name.")
    properties: Optional[VirtualMachineScaleSetUpdateNetworkConfigurationProperties] = None
