...
> virtual_machines_power_off(resource_group_name, vm_name, api_version, subscription_id, skip_shutdown=skip_shutdown)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.virtual_machines_power_off(resource_group_name, vm_name, api_version, subscription_id, skip_shutdown=skip_shutdown)
    except Exception as e:
