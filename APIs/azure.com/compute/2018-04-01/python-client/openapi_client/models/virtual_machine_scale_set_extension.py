...
class VirtualMachineScaleSetExtension(BaseModel):
    """
    Describes a Virtual Machine Scale Set Extension.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the extension.")
    properties: Optional[VirtualMachineScaleSetExtensionProperties] = None
