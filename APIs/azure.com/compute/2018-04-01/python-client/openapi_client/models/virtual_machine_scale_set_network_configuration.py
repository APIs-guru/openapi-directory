...
class VirtualMachineScaleSetNetworkConfiguration(BaseModel):
    """
    Describes a virtual machine scale set network profile's network configurations.
    """ # noqa: E501
    name: StrictStr = Field(description="The network configuration name.")
    properties: Optional[VirtualMachineScaleSetNetworkConfigurationProperties] = None
