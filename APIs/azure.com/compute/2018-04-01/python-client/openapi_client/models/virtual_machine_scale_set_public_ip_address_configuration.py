...
class VirtualMachineScaleSetPublicIPAddressConfiguration(BaseModel):
    """
    Describes a virtual machines scale set IP Configuration's PublicIPAddress configuration
    """ # noqa: E501
    name: StrictStr = Field(description="The publicIP address configuration name.")
    properties: Optional[VirtualMachineScaleSetPublicIPAddressConfigurationProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": VirtualMachineScaleSetPublicIPAddressConfigurationProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
