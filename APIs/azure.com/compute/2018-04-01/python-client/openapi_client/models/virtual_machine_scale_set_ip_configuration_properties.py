...
class VirtualMachineScaleSetIPConfigurationProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationGatewayBackendAddressPools", "loadBalancerBackendAddressPools", "loadBalancerInboundNatPools", "primary", "privateIPAddressVersion", "publicIPAddressConfiguration", "subnet"]
