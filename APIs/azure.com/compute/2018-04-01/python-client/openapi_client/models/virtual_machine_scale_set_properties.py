...
class VirtualMachineScaleSetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["overprovision", "platformFaultDomainCount", "provisioningState", "proximityPlacementGroup", "singlePlacementGroup", "uniqueId", "upgradePolicy", "virtualMachineProfile", "zoneBalance"]
