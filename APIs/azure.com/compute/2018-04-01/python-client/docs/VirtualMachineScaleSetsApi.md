...
> virtual_machine_scale_sets_power_off(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.virtual_machine_scale_sets_power_off(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
    except Exception as e:
...
> virtual_machine_scale_sets_reimage(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.virtual_machine_scale_sets_reimage(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
    except Exception as e:
