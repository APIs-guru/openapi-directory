...
> availability_sets_delete(resource_group_name, availability_set_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.availability_sets_delete(resource_group_name, availability_set_name, api_version, subscription_id)
    except Exception as e:
...
> AvailabilitySetListResult availability_sets_list_by_subscription(api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.availability_sets_list_by_subscription(api_version, subscription_id, expand=expand)
        print("The response of AvailabilitySetsApi->availability_sets_list_by_subscription:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AvailabilitySetsApi->availability_sets_list_by_subscription: %s\n" % e)
```
...
> AvailabilitySet availability_sets_update(resource_group_name, availability_set_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.AvailabilitySetUpdate() # AvailabilitySetUpdate | Parameters supplied to the Update Availability Set operation.

    try:
        api_response = api_instance.availability_sets_update(resource_group_name, availability_set_name, api_version, subscription_id, parameters)
        print("The response of AvailabilitySetsApi->availability_sets_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AvailabilitySetsApi->availability_sets_update: %s\n" % e)
```
