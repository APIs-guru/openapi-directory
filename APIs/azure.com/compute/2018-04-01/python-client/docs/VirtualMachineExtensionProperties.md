...
**instance_view** | [**VirtualMachineExtensionInstanceView**](VirtualMachineExtensionInstanceView.md) |  | [optional] 
...
virtual_machine_extension_properties_instance = VirtualMachineExtensionProperties.from_json(json)
# print the JSON string representation of the object
print(VirtualMachineExtensionProperties.to_json())

# convert the object into a dict
virtual_machine_extension_properties_dict = virtual_machine_extension_properties_instance.to_dict()
# create an instance of VirtualMachineExtensionProperties from a dict
virtual_machine_extension_properties_from_dict = VirtualMachineExtensionProperties.from_dict(virtual_machine_extension_properties_dict)
```
