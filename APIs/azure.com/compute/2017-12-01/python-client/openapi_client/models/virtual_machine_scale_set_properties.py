...
class VirtualMachineScaleSetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["overprovision", "platformFaultDomainCount", "provisioningState", "singlePlacementGroup", "uniqueId", "upgradePolicy", "virtualMachineProfile", "zoneBalance"]
