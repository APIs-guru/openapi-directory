...
class WinRMConfiguration(BaseModel):
    """
    Describes Windows Remote Management configuration of the VM
    """ # noqa: E501
    listeners: Optional[List[WinRMListener]] = Field(default=None, description="The list of Windows Remote Management listeners")
    __properties: ClassVar[List[str]] = ["listeners"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listeners": [WinRMListener.from_dict(_item) for _item in obj["listeners"]] if obj.get("listeners") is not None else None
        })
        return _obj
