...
class VirtualMachineInstanceView(BaseModel):
    ...
    computer_name: Optional[StrictStr] = Field(default=None, description="The computer name assigned to the virtual machine.", alias="computerName")
    ...
    os_name: Optional[StrictStr] = Field(default=None, description="The Operating System running on the virtual machine.", alias="osName")
    os_version: Optional[StrictStr] = Field(default=None, description="The version of Operating System running on the virtual machine.", alias="osVersion")
    ...
    __properties: ClassVar[List[str]] = ["bootDiagnostics", "computerName", "disks", "extensions", "maintenanceRedeployStatus", "osName", "osVersion", "platformFaultDomain", "platformUpdateDomain", "rdpThumbPrint", "statuses", "vmAgent"]
