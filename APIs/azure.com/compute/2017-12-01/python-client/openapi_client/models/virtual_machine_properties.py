...
class VirtualMachineProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["availabilitySet", "diagnosticsProfile", "hardwareProfile", "instanceView", "licenseType", "networkProfile", "osProfile", "provisioningState", "storageProfile", "vmId"]
