...
class TestVirtualMachineUpdate(unittest.TestCase):
    """VirtualMachineUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualMachineUpdate:
        """Test VirtualMachineUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualMachineUpdate`
        """
    ...
    def testVirtualMachineUpdate(self):
        """Test VirtualMachineUpdate"""
