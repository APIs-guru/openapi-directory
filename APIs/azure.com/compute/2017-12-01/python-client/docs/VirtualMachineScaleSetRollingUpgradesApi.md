...
> OperationStatusResponse virtual_machine_scale_set_rolling_upgrades_cancel(resource_group_name, vm_scale_set_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_rolling_upgrades_cancel(resource_group_name, vm_scale_set_name, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetRollingUpgradesApi->virtual_machine_scale_set_rolling_upgrades_cancel:\n")
        pprint(api_response)
...
# **virtual_machine_scale_set_rolling_upgrades_start_os_upgrade**
> OperationStatusResponse virtual_machine_scale_set_rolling_upgrades_start_os_upgrade(resource_group_name, vm_scale_set_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_rolling_upgrades_start_os_upgrade(resource_group_name, vm_scale_set_name, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetRollingUpgradesApi->virtual_machine_scale_set_rolling_upgrades_start_os_upgrade:\n")
        pprint(api_response)
    except Exception as e:
