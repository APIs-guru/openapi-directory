...
> OperationStatusResponse virtual_machine_scale_sets_perform_maintenance(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_sets_perform_maintenance(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
        print("The response of VirtualMachineScaleSetsApi->virtual_machine_scale_sets_perform_maintenance:\n")
        pprint(api_response)
    except Exception as e:
...
> OperationStatusResponse virtual_machine_scale_sets_redeploy(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_sets_redeploy(resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=vm_instance_ids)
        print("The response of VirtualMachineScaleSetsApi->virtual_machine_scale_sets_redeploy:\n")
        pprint(api_response)
    except Exception as e:
