...
> OperationStatusResponse virtual_machine_scale_set_vms_perform_maintenance(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_vms_perform_maintenance(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetVMsApi->virtual_machine_scale_set_vms_perform_maintenance:\n")
        pprint(api_response)
    except Exception as e:
...
> OperationStatusResponse virtual_machine_scale_set_vms_redeploy(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_vms_redeploy(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetVMsApi->virtual_machine_scale_set_vms_redeploy:\n")
        pprint(api_response)
    except Exception as e:
...
> OperationStatusResponse virtual_machine_scale_set_vms_reimage_all(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_vms_reimage_all(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetVMsApi->virtual_machine_scale_set_vms_reimage_all:\n")
        pprint(api_response)
    except Exception as e:
