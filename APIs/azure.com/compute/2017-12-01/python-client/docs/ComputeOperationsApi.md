# openapi_client.ComputeOperationsApi
...
# **operations_list**
> ComputeOperationListResult operations_list(api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ComputeOperationsApi(api_client)
    api_version = 'api_version_example' # str | Client Api Version.

    try:
        api_response = api_instance.operations_list(api_version)
        print("The response of ComputeOperationsApi->operations_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComputeOperationsApi->operations_list: %s\n" % e)
```
