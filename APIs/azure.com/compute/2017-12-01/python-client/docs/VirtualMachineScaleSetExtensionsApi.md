...
> OperationStatusResponse virtual_machine_scale_set_extensions_delete(resource_group_name, vm_scale_set_name, vmss_extension_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_extensions_delete(resource_group_name, vm_scale_set_name, vmss_extension_name, api_version, subscription_id)
        print("The response of VirtualMachineScaleSetExtensionsApi->virtual_machine_scale_set_extensions_delete:\n")
        pprint(api_response)
    except Exception as e:
