...
> OperationStatusResponse virtual_machine_scale_sets_reimage(resource_group_name, vm_scale_set_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_sets_reimage(resource_group_name, vm_scale_set_name, api_version, subscription_id)
...
> OperationStatusResponse virtual_machine_scale_sets_reimage_all(resource_group_name, vm_scale_set_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_sets_reimage_all(resource_group_name, vm_scale_set_name, api_version, subscription_id)
