...
> OperationStatusResponse virtual_machines_convert_to_managed_disks(resource_group_name, vm_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machines_convert_to_managed_disks(resource_group_name, vm_name, api_version, subscription_id)
        print("The response of VirtualMachinesApi->virtual_machines_convert_to_managed_disks:\n")
        pprint(api_response)
    except Exception as e:
