...
> AvailabilitySetListResult availability_sets_list_by_subscription(api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.availability_sets_list_by_subscription(api_version, subscription_id)
