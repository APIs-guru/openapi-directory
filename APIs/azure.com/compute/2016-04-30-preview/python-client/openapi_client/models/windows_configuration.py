...
class WindowsConfiguration(BaseModel):
    ...
    enable_automatic_updates: Optional[StrictBool] = Field(default=None, description="Indicates whether virtual machine is enabled for automatic updates.", alias="enableAutomaticUpdates")
    ...
    time_zone: Optional[StrictStr] = Field(default=None, description="Specifies the time zone of the virtual machine. e.g. \"Pacific Standard Time\"", alias="timeZone")
