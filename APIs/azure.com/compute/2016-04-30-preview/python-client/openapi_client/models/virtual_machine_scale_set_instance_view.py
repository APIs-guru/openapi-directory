...
class VirtualMachineScaleSetInstanceView(BaseModel):
    """
    The instance view of a virtual machine scale set.
    """ # noqa: E501
    extensions: Optional[List[VirtualMachineScaleSetVMExtensionsSummary]] = Field(default=None, description="The extensions information.")
    statuses: Optional[List[InstanceViewStatus]] = Field(default=None, description="The resource status information.")
    virtual_machine: Optional[VirtualMachineScaleSetInstanceViewStatusesSummary] = Field(default=None, alias="virtualMachine")
    __properties: ClassVar[List[str]] = ["extensions", "statuses", "virtualMachine"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extensions": [VirtualMachineScaleSetVMExtensionsSummary.from_dict(_item) for _item in obj["extensions"]] if obj.get("extensions") is not None else None,
            "statuses": [InstanceViewStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None,
            "virtualMachine": VirtualMachineScaleSetInstanceViewStatusesSummary.from_dict(obj["virtualMachine"]) if obj.get("virtualMachine") is not None else None
        })
        return _obj
