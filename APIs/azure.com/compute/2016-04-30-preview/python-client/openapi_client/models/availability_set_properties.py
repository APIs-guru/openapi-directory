...
class AvailabilitySetProperties(BaseModel):
    ...
    """ # noqa: E501
    managed: Optional[StrictBool] = Field(default=None, description="If the availability set supports managed disks.")
    ...
    __properties: ClassVar[List[str]] = ["managed", "platformFaultDomainCount", "platformUpdateDomainCount", "statuses", "virtualMachines"]
