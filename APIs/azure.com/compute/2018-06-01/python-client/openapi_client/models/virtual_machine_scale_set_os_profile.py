...
class VirtualMachineScaleSetOSProfile(BaseModel):
    ...
    secrets: Optional[List[VaultSecretGroup]] = Field(default=None, description="Specifies set of certificates that should be installed onto the virtual machines in the scale set.")
