...
class VirtualMachineScaleSetVMProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "diagnosticsProfile", "evictionPolicy", "extensionProfile", "licenseType", "networkProfile", "osProfile", "priority", "storageProfile"]
