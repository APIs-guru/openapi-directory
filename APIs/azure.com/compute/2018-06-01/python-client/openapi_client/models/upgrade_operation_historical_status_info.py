...
class UpgradeOperationHistoricalStatusInfo(BaseModel):
    """
    Virtual Machine Scale Set OS Upgrade History operation response.
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Resource location")
    properties: Optional[UpgradeOperationHistoricalStatusInfoProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Resource type")
    __properties: ClassVar[List[str]] = ["location", "properties", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": UpgradeOperationHistoricalStatusInfoProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
