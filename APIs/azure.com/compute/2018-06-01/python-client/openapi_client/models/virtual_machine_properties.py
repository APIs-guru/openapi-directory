...
class VirtualMachineProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "availabilitySet", "diagnosticsProfile", "hardwareProfile", "instanceView", "licenseType", "networkProfile", "osProfile", "provisioningState", "proximityPlacementGroup", "storageProfile", "vmId"]
