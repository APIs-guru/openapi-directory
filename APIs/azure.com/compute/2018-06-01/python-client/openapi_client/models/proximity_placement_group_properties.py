...
class ProximityPlacementGroupProperties(BaseModel):
    ...
    """ # noqa: E501
    availability_sets: Optional[List[SubResource]] = Field(default=None, description="A list of references to all availability sets in the proximity placement group.", alias="availabilitySets")
    ...
    virtual_machine_scale_sets: Optional[List[SubResource]] = Field(default=None, description="A list of references to all virtual machine scale sets in the proximity placement group.", alias="virtualMachineScaleSets")
    virtual_machines: Optional[List[SubResource]] = Field(default=None, description="A list of references to all virtual machines in the proximity placement group.", alias="virtualMachines")
    __properties: ClassVar[List[str]] = ["availabilitySets", "proximityPlacementGroupType", "virtualMachineScaleSets", "virtualMachines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availabilitySets": [SubResource.from_dict(_item) for _item in obj["availabilitySets"]] if obj.get("availabilitySets") is not None else None,
            "proximityPlacementGroupType": obj.get("proximityPlacementGroupType"),
            "virtualMachineScaleSets": [SubResource.from_dict(_item) for _item in obj["virtualMachineScaleSets"]] if obj.get("virtualMachineScaleSets") is not None else None,
