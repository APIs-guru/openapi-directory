...
class VirtualMachineScaleSetVMProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "availabilitySet", "diagnosticsProfile", "hardwareProfile", "instanceView", "latestModelApplied", "licenseType", "networkProfile", "osProfile", "provisioningState", "storageProfile", "vmId"]
