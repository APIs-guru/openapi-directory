...
------------ | ------------- | ------------- | -------------
**network_interfaces** | [**List[NetworkInterfaceReference]**](NetworkInterfaceReference.md) | Specifies the list of resource Ids for the network interfaces associated with the virtual machine. | [optional] 
