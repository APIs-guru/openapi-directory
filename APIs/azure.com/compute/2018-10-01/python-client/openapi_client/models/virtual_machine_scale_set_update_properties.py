...
class VirtualMachineScaleSetUpdateProperties(BaseModel):
    ...
    """ # noqa: E501
    automatic_repairs_policy: Optional[AutomaticRepairsPolicy] = Field(default=None, alias="automaticRepairsPolicy")
    ...
    __properties: ClassVar[List[str]] = ["automaticRepairsPolicy", "doNotRunExtensionsOnOverprovisionedVMs", "overprovision", "proximityPlacementGroup", "singlePlacementGroup", "upgradePolicy", "virtualMachineProfile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of automatic_repairs_policy
        if self.automatic_repairs_policy:
            _dict['automaticRepairsPolicy'] = self.automatic_repairs_policy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "automaticRepairsPolicy": AutomaticRepairsPolicy.from_dict(obj["automaticRepairsPolicy"]) if obj.get("automaticRepairsPolicy") is not None else None,
