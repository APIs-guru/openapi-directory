...
class VirtualMachineScaleSetNetworkConfigurationProperties(BaseModel):
    """
    ...
    ip_configurations: List[VirtualMachineScaleSetIPConfiguration] = Field(description="Specifies the IP configurations of the network interface.", alias="ipConfigurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipConfigurations": [VirtualMachineScaleSetIPConfiguration.from_dict(_item) for _item in obj["ipConfigurations"]] if obj.get("ipConfigurations") is not None else None,
