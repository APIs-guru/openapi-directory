...
class VirtualMachineScaleSetNetworkConfigurationDnsSettings(BaseModel):
    """
    Describes a virtual machines scale sets network configuration's DNS settings.
    """ # noqa: E501
    dns_servers: Optional[List[StrictStr]] = Field(default=None, description="List of DNS servers IP addresses", alias="dnsServers")
