...
class ApiError(BaseModel):
    ...
    details: Optional[List[ApiErrorBase]] = Field(default=None, description="The Api error details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [ApiErrorBase.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
