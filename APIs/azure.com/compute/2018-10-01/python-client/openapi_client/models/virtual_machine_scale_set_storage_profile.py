...
class VirtualMachineScaleSetStorageProfile(BaseModel):
    """
    Describes a virtual machine scale set storage profile.
    """ # noqa: E501
    data_disks: Optional[List[VirtualMachineScaleSetDataDisk]] = Field(default=None, description="Specifies the parameters that are used to add data disks to the virtual machines in the scale set. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).", alias="dataDisks")
    image_reference: Optional[ImageReference] = Field(default=None, alias="imageReference")
    os_disk: Optional[VirtualMachineScaleSetOSDisk] = Field(default=None, alias="osDisk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "osDisk": VirtualMachineScaleSetOSDisk.from_dict(obj["osDisk"]) if obj.get("osDisk") is not None else None
        })
        return _obj
