...
class VirtualMachineScaleSetVMInstanceView(BaseModel):
    """
    The instance view of a virtual machine scale set VM.
    """ # noqa: E501
    boot_diagnostics: Optional[BootDiagnosticsInstanceView] = Field(default=None, alias="bootDiagnostics")
    disks: Optional[List[DiskInstanceView]] = Field(default=None, description="The disks information.")
    ...
    placement_group_id: Optional[StrictStr] = Field(default=None, description="The placement group in which the VM is running. If the VM is deallocated it will not have a placementGroupId.", alias="placementGroupId")
    platform_fault_domain: Optional[StrictInt] = Field(default=None, description="The Fault Domain count.", alias="platformFaultDomain")
    platform_update_domain: Optional[StrictInt] = Field(default=None, description="The Update Domain count.", alias="platformUpdateDomain")
    ...
    vm_health: Optional[VirtualMachineHealthStatus] = Field(default=None, alias="vmHealth")
    __properties: ClassVar[List[str]] = ["bootDiagnostics", "disks", "extensions", "maintenanceRedeployStatus", "placementGroupId", "platformFaultDomain", "platformUpdateDomain", "rdpThumbPrint", "statuses", "vmAgent", "vmHealth"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vm_health
        if self.vm_health:
            _dict['vmHealth'] = self.vm_health.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vmHealth": VirtualMachineHealthStatus.from_dict(obj["vmHealth"]) if obj.get("vmHealth") is not None else None
        })
        return _obj
