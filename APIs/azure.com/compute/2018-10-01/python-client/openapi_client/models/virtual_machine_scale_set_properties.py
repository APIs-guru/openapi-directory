...
class VirtualMachineScaleSetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["automaticRepairsPolicy", "doNotRunExtensionsOnOverprovisionedVMs", "overprovision", "platformFaultDomainCount", "provisioningState", "proximityPlacementGroup", "singlePlacementGroup", "uniqueId", "upgradePolicy", "virtualMachineProfile", "zoneBalance"]
