...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The uri to fetch the next page of Virtual Machine Scale Set Skus. Call ListNext() with this to fetch the next page of VMSS Skus. | [optional] 
**value** | [**List[VirtualMachineScaleSetSku]**](VirtualMachineScaleSetSku.md) | The list of skus available for the virtual machine scale set. | 
