...
json = "{}"
# create an instance of ThrottledRequestsInput from a JSON string
throttled_requests_input_instance = ThrottledRequestsInput.from_json(json)
# print the JSON string representation of the object
print(ThrottledRequestsInput.to_json())

# convert the object into a dict
throttled_requests_input_dict = throttled_requests_input_instance.to_dict()
# create an instance of ThrottledRequestsInput from a dict
throttled_requests_input_from_dict = ThrottledRequestsInput.from_dict(throttled_requests_input_dict)
```
