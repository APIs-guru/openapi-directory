...
# **images_delete**
> images_delete(resource_group_name, image_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.images_delete(resource_group_name, image_name, api_version, subscription_id)
    except Exception as e:
