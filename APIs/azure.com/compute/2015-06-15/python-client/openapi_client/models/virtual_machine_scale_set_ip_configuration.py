...
class VirtualMachineScaleSetIPConfiguration(BaseModel):
    """
    Describes a virtual machine scale set network profile's IP configuration.
    """ # noqa: E501
    name: StrictStr = Field(description="The IP configuration name.")
    properties: Optional[VirtualMachineScaleSetIPConfigurationProperties] = None
