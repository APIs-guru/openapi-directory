...
class VirtualMachineScaleSetVMProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["availabilitySet", "diagnosticsProfile", "hardwareProfile", "instanceView", "latestModelApplied", "licenseType", "networkProfile", "osProfile", "provisioningState", "storageProfile"]
