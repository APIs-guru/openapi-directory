...
class OSProfile(BaseModel):
    ...
    require_guest_provision_signal: Optional[StrictBool] = Field(default=None, description="Specifies whether the guest provision signal is required to infer provision success of the virtual machine.", alias="requireGuestProvisionSignal")
    ...
    __properties: ClassVar[List[str]] = ["adminPassword", "adminUsername", "allowExtensionOperations", "computerName", "customData", "linuxConfiguration", "requireGuestProvisionSignal", "secrets", "windowsConfiguration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requireGuestProvisionSignal": obj.get("requireGuestProvisionSignal"),
