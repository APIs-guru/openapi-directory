...
class VirtualMachineProperties(BaseModel):
    ...
    eviction_policy: Optional[EvictionPolicy] = Field(default=None, alias="evictionPolicy")
    ...
    virtual_machine_scale_set: Optional[SubResource] = Field(default=None, alias="virtualMachineScaleSet")
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "availabilitySet", "billingProfile", "diagnosticsProfile", "evictionPolicy", "hardwareProfile", "host", "instanceView", "licenseType", "networkProfile", "osProfile", "priority", "provisioningState", "proximityPlacementGroup", "storageProfile", "virtualMachineScaleSet", "vmId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of virtual_machine_scale_set
        if self.virtual_machine_scale_set:
            _dict['virtualMachineScaleSet'] = self.virtual_machine_scale_set.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "host": SubResource.from_dict(obj["host"]) if obj.get("host") is not None else None,
            ...
            "virtualMachineScaleSet": SubResource.from_dict(obj["virtualMachineScaleSet"]) if obj.get("virtualMachineScaleSet") is not None else None,
            "vmId": obj.get("vmId")
        })
        return _obj
