...
class VirtualMachineScaleSetUpdateVMProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billingProfile", "diagnosticsProfile", "extensionProfile", "licenseType", "networkProfile", "osProfile", "scheduledEventsProfile", "storageProfile"]
