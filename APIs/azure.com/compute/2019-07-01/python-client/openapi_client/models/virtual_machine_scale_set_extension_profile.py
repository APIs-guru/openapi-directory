...
class VirtualMachineScaleSetExtensionProfile(BaseModel):
    """
    Describes a virtual machine scale set extension profile.
    """ # noqa: E501
    extensions: Optional[List[VirtualMachineScaleSetExtension]] = Field(default=None, description="The virtual machine scale set child extension resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extensions": [VirtualMachineScaleSetExtension.from_dict(_item) for _item in obj["extensions"]] if obj.get("extensions") is not None else None
        })
        return _obj
