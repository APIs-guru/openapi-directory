...
class VirtualMachineScaleSetOSDisk(BaseModel):
    ...
    diff_disk_settings: Optional[DiffDiskSettings] = Field(default=None, alias="diffDiskSettings")
    disk_size_gb: Optional[StrictInt] = Field(default=None, description="Specifies the size of the operating system disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB", alias="diskSizeGB")
    ...
    vhd_containers: Optional[List[StrictStr]] = Field(default=None, description="Specifies the container urls that are used to store operating system disks for the scale set.", alias="vhdContainers")
    ...
    __properties: ClassVar[List[str]] = ["caching", "createOption", "diffDiskSettings", "diskSizeGB", "image", "managedDisk", "name", "osType", "vhdContainers", "writeAcceleratorEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of diff_disk_settings
        if self.diff_disk_settings:
            _dict['diffDiskSettings'] = self.diff_disk_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diffDiskSettings": DiffDiskSettings.from_dict(obj["diffDiskSettings"]) if obj.get("diffDiskSettings") is not None else None,
