...
class ComputeOperationListResult(BaseModel):
    """
    The List Compute Operation operation response.
    """ # noqa: E501
    value: Optional[List[ComputeOperationValue]] = Field(default=None, description="The list of compute operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ComputeOperationValue.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
