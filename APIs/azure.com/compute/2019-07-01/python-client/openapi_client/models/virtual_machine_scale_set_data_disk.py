...
class VirtualMachineScaleSetDataDisk(BaseModel):
    """
    Describes a virtual machine scale set data disk.
    """ # noqa: E501
    caching: Optional[Caching] = None
    create_option: CreateOption = Field(alias="createOption")
    disk_iops_read_write: Optional[StrictInt] = Field(default=None, description="Specifies the Read-Write IOPS for the managed disk. Should be used only when StorageAccountType is UltraSSD_LRS. If not specified, a default value would be assigned based on diskSizeGB.", alias="diskIOPSReadWrite")
    disk_m_bps_read_write: Optional[StrictInt] = Field(default=None, description="Specifies the bandwidth in MB per second for the managed disk. Should be used only when StorageAccountType is UltraSSD_LRS. If not specified, a default value would be assigned based on diskSizeGB.", alias="diskMBpsReadWrite")
    ...
    __properties: ClassVar[List[str]] = ["caching", "createOption", "diskIOPSReadWrite", "diskMBpsReadWrite", "diskSizeGB", "lun", "managedDisk", "name", "writeAcceleratorEnabled"]
