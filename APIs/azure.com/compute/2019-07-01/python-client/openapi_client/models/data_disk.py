...
class DataDisk(BaseModel):
    ...
    disk_iops_read_write: Optional[StrictInt] = Field(default=None, description="Specifies the Read-Write IOPS for the managed disk when StorageAccountType is UltraSSD_LRS. Returned only for VirtualMachine ScaleSet VM disks. Can be updated only via updates to the VirtualMachine Scale Set.", alias="diskIOPSReadWrite")
    disk_m_bps_read_write: Optional[StrictInt] = Field(default=None, description="Specifies the bandwidth in MB per second for the managed disk when StorageAccountType is UltraSSD_LRS. Returned only for VirtualMachine ScaleSet VM disks. Can be updated only via updates to the VirtualMachine Scale Set.", alias="diskMBpsReadWrite")
    ...
    to_be_detached: Optional[StrictBool] = Field(default=None, description="Specifies whether the data disk is in process of detachment from the VirtualMachine/VirtualMachineScaleset", alias="toBeDetached")
    ...
    __properties: ClassVar[List[str]] = ["caching", "createOption", "diskIOPSReadWrite", "diskMBpsReadWrite", "diskSizeGB", "image", "lun", "managedDisk", "name", "toBeDetached", "vhd", "writeAcceleratorEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "toBeDetached": obj.get("toBeDetached"),
