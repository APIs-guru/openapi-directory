...
class VirtualMachineScaleSetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "automaticRepairsPolicy", "doNotRunExtensionsOnOverprovisionedVMs", "overprovision", "platformFaultDomainCount", "provisioningState", "proximityPlacementGroup", "scaleInPolicy", "singlePlacementGroup", "uniqueId", "upgradePolicy", "virtualMachineProfile", "zoneBalance"]
