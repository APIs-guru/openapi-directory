...
class VirtualMachineInstanceView(BaseModel):
    ...
    hyper_v_generation: Optional[StrictStr] = Field(default=None, description="Specifies the HyperVGeneration Type associated with a resource", alias="hyperVGeneration")
    ...
    __properties: ClassVar[List[str]] = ["bootDiagnostics", "computerName", "disks", "extensions", "hyperVGeneration", "maintenanceRedeployStatus", "osName", "osVersion", "platformFaultDomain", "platformUpdateDomain", "rdpThumbPrint", "statuses", "vmAgent"]
