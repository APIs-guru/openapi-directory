...
class VirtualMachineExtensionInstanceView(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The virtual machine extension name.")
    statuses: Optional[List[InstanceViewStatus]] = Field(default=None, description="The resource status information.")
    substatuses: Optional[List[InstanceViewStatus]] = Field(default=None, description="The resource status information.")
    ...
    __properties: ClassVar[List[str]] = ["name", "statuses", "substatuses", "type", "typeHandlerVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in substatuses (list)
        _items = []
        if self.substatuses:
            for _item_substatuses in self.substatuses:
                if _item_substatuses:
                    _items.append(_item_substatuses.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "substatuses": [InstanceViewStatus.from_dict(_item) for _item in obj["substatuses"]] if obj.get("substatuses") is not None else None,
            "type": obj.get("type"),
