...
class VirtualMachineScaleSetUpdateProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additionalCapabilities", "automaticRepairsPolicy", "doNotRunExtensionsOnOverprovisionedVMs", "overprovision", "proximityPlacementGroup", "scaleInPolicy", "singlePlacementGroup", "upgradePolicy", "virtualMachineProfile"]
