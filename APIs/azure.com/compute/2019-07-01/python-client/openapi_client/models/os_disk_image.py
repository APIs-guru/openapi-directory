...
class OSDiskImage(BaseModel):
    ...
    """ # noqa: E501
    operating_system: StrictStr = Field(description="The operating system of the osDiskImage.", alias="operatingSystem")
    __properties: ClassVar[List[str]] = ["operatingSystem"]
