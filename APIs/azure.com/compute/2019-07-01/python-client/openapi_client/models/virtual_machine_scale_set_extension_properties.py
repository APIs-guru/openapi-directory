...
class VirtualMachineScaleSetExtensionProperties(BaseModel):
    """
    ...
    force_update_tag: Optional[StrictStr] = Field(default=None, description="If a value is provided and is different from the previous value, the extension handler will be forced to update even if the extension configuration has not changed.", alias="forceUpdateTag")
    ...
    provision_after_extensions: Optional[List[StrictStr]] = Field(default=None, description="Collection of extension names after which this extension needs to be provisioned.", alias="provisionAfterExtensions")
    ...
    __properties: ClassVar[List[str]] = ["autoUpgradeMinorVersion", "forceUpdateTag", "protectedSettings", "provisionAfterExtensions", "provisioningState", "publisher", "settings", "type", "typeHandlerVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "provisionAfterExtensions": obj.get("provisionAfterExtensions"),
