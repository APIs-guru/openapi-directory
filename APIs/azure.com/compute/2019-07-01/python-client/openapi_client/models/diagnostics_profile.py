...
class DiagnosticsProfile(BaseModel):
    """
    Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
    """ # noqa: E501
    boot_diagnostics: Optional[BootDiagnostics] = Field(default=None, alias="bootDiagnostics")
    __properties: ClassVar[List[str]] = ["bootDiagnostics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bootDiagnostics": BootDiagnostics.from_dict(obj["bootDiagnostics"]) if obj.get("bootDiagnostics") is not None else None
        })
        return _obj
