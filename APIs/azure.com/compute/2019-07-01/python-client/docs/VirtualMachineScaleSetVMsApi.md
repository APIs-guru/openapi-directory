...
> VirtualMachineScaleSetVM virtual_machine_scale_set_vms_get(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.virtual_machine_scale_set_vms_get(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, expand=expand)
...
> virtual_machine_scale_set_vms_power_off(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, skip_shutdown=skip_shutdown)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.virtual_machine_scale_set_vms_power_off(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, skip_shutdown=skip_shutdown)
    except Exception as e:
...
> virtual_machine_scale_set_vms_reimage(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, vm_scale_set_vm_reimage_input=vm_scale_set_vm_reimage_input)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    vm_scale_set_vm_reimage_input = openapi_client.VirtualMachineScaleSetVMReimageParameters() # VirtualMachineScaleSetVMReimageParameters | Parameters for the Reimaging Virtual machine in ScaleSet. (optional)

    try:
        api_instance.virtual_machine_scale_set_vms_reimage(resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, vm_scale_set_vm_reimage_input=vm_scale_set_vm_reimage_input)
    except Exception as e:
