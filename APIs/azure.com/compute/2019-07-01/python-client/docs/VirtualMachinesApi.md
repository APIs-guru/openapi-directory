...
> VirtualMachineListResult virtual_machines_list_all(api_version, subscription_id, status_only=status_only)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client Api Version.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    status_only = 'status_only_example' # str | statusOnly=true enables fetching run time status of all Virtual Machines in the subscription. (optional)

    try:
        api_response = api_instance.virtual_machines_list_all(api_version, subscription_id, status_only=status_only)
 ...
 **api_version** | **str**| Client Api Version. | 
 **subscription_id** | **str**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **status_only** | **str**| statusOnly&#x3D;true enables fetching run time status of all Virtual Machines in the subscription. | [optional] 
...
> virtual_machines_reapply(resource_group_name, vm_name, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.virtual_machines_reapply(resource_group_name, vm_name, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling VirtualMachinesApi->virtual_machines_reapply: %s\n" % e)
```
