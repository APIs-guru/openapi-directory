...
class TestAvailabilitySetUpdate(unittest.TestCase):
    """AvailabilitySetUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilitySetUpdate:
        """Test AvailabilitySetUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilitySetUpdate`
        """
        model = AvailabilitySetUpdate()
        if include_optional:
            return AvailabilitySetUpdate(
    ...
    def testAvailabilitySetUpdate(self):
        """Test AvailabilitySetUpdate"""
