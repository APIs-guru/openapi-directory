...
class TestVirtualMachineScaleSetNetworkConfiguration(unittest.TestCase):
    """VirtualMachineScaleSetNetworkConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualMachineScaleSetNetworkConfiguration:
        """Test VirtualMachineScaleSetNetworkConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualMachineScaleSetNetworkConfiguration`
        """
    ...
    def testVirtualMachineScaleSetNetworkConfiguration(self):
        """Test VirtualMachineScaleSetNetworkConfiguration"""
