...
class VirtualMachineScaleSetNetworkConfigurationProperties(BaseModel):
    ...
    """ # noqa: E501
    ip_configurations: List[VirtualMachineScaleSetIPConfiguration] = Field(description="The virtual machine scale set IP Configuration.", alias="ipConfigurations")
    primary: Optional[StrictBool] = Field(default=None, description="Whether this is a primary NIC on a virtual machine.")
    __properties: ClassVar[List[str]] = ["ipConfigurations", "primary"]
