...
class VirtualMachineScaleSetVMInstanceView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bootDiagnostics", "disks", "extensions", "placementGroupId", "platformFaultDomain", "platformUpdateDomain", "rdpThumbPrint", "statuses", "vmAgent", "vmHealth"]
