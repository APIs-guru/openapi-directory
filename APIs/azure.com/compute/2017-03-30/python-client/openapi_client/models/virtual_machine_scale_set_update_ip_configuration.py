...
class VirtualMachineScaleSetUpdateIPConfiguration(BaseModel):
    """
    Describes a virtual machine scale set network profile's IP configuration.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The IP configuration name.")
    properties: Optional[VirtualMachineScaleSetUpdateIPConfigurationProperties] = None
