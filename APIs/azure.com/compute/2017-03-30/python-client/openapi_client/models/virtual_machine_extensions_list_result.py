...
class VirtualMachineExtensionsListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[VirtualMachineExtension]] = Field(default=None, description="The list of extensions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VirtualMachineExtension.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
