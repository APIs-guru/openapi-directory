...
class VirtualMachineSizeListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[VirtualMachineSize]] = Field(default=None, description="The list of virtual machine sizes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VirtualMachineSize.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
