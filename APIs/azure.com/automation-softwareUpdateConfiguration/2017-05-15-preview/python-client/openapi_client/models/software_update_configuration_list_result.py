...
class SoftwareUpdateConfigurationListResult(BaseModel):
    """
    result of listing all software update configuration
    """ # noqa: E501
    value: Optional[List[SoftwareUpdateConfigurationCollectionItem]] = Field(default=None, description="outer object returned when listing all software update configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SoftwareUpdateConfigurationCollectionItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
