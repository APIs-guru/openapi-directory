...
class TestSoftwareUpdateConfigurationProperties(unittest.TestCase):
    """SoftwareUpdateConfigurationProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareUpdateConfigurationProperties:
        """Test SoftwareUpdateConfigurationProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareUpdateConfigurationProperties`
        """
        model = SoftwareUpdateConfigurationProperties()
        if include_optional:
            return SoftwareUpdateConfigurationProperties(
                created_by = '',
    ...
    def testSoftwareUpdateConfigurationProperties(self):
        """Test SoftwareUpdateConfigurationProperties"""
