...
class ManagementGroupProperties(BaseModel):
    ...
    """ # noqa: E501
    details: Optional[ManagementGroupDetailsProperties] = None
    ...
    __properties: ClassVar[List[str]] = ["details", "displayName", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": ManagementGroupDetailsProperties.from_dict(obj["details"]) if obj.get("details") is not None else None,
