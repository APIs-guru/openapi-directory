...
class TextLine(BaseModel):
    ...
    text: StrictStr = Field(description="The text content of the line.")
    words: List[TextWord] = Field(description="List of words in the text line.")
    __properties: ClassVar[List[str]] = ["boundingBox", "language", "text", "words"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "words": [TextWord.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
