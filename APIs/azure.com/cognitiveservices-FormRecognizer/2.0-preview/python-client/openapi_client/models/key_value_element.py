...
class KeyValueElement(BaseModel):
    ...
    elements: Optional[List[StrictStr]] = Field(default=None, description="When includeTextDetails is set to true, a list of references to the text elements constituting this key or value.")
    text: StrictStr = Field(description="The text content of the key or value.")
    __properties: ClassVar[List[str]] = ["boundingBox", "elements", "text"]
