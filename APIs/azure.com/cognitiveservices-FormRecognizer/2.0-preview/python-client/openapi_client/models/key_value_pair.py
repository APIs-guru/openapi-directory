...
class KeyValuePair(BaseModel):
    ...
    key: KeyValueElement
    label: Optional[StrictStr] = Field(default=None, description="A user defined label for the key/value pair entry.")
    value: KeyValueElement
    __properties: ClassVar[List[str]] = ["confidence", "key", "label", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key": KeyValueElement.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "label": obj.get("label"),
            "value": KeyValueElement.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
