...
class TestAnalyzeOperationResult(unittest.TestCase):
    """AnalyzeOperationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeOperationResult:
        """Test AnalyzeOperationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeOperationResult`
        """
        model = AnalyzeOperationResult()
        if include_optional:
            return AnalyzeOperationResult(
                analyze_result = openapi_client.models.analyze_result.AnalyzeResult(
                    document_results = [
    ...
    def testAnalyzeOperationResult(self):
        """Test AnalyzeOperationResult"""
