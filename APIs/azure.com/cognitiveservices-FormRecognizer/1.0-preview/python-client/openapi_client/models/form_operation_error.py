...
class FormOperationError(BaseModel):
    """
    Error reported during an operation.
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Message reported during the train operation.", alias="errorMessage")
