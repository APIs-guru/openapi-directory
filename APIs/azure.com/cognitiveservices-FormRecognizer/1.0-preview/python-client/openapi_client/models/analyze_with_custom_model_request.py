...
class AnalyzeWithCustomModelRequest(BaseModel):
    """
    AnalyzeWithCustomModelRequest
    """ # noqa: E501
    form_stream: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]] = Field(description="A pdf document or image (jpg,png) file to analyze.")
    __properties: ClassVar[List[str]] = ["form_stream"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "form_stream": obj.get("form_stream")
        })
        return _obj
