...
class ExtractedTable(BaseModel):
    ...
    """ # noqa: E501
    columns: Optional[List[ExtractedTableColumn]] = Field(default=None, description="List of columns contained in the table.")
    id: Optional[StrictStr] = Field(default=None, description="Table identifier.")
    __properties: ClassVar[List[str]] = ["columns", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [ExtractedTableColumn.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            "id": obj.get("id")
        })
        return _obj
