...
class TestModelResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelResult:
        """Test ModelResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelResult`
        """
        model = ModelResult()
        if include_optional:
            return ModelResult(
