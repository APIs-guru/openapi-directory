...
class Error(BaseModel):
    ...
    """ # noqa: E501
    code: ErrorCode
    details: Optional[List[Error]] = Field(default=None, description="An array of details about specific errors that led to this reported error.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [Error.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
