...
class UpdateQuestionsDTO(BaseModel):
    """
    PATCH Body schema for Update Kb which contains list of questions to be added and deleted
    """ # noqa: E501
    add: Optional[List[StrictStr]] = Field(default=None, description="List of questions to be added")
    delete: Optional[List[StrictStr]] = Field(default=None, description="List of questions to be deleted.")
