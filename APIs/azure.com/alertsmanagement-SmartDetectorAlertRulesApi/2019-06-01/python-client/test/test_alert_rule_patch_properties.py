...
class TestAlertRulePatchProperties(unittest.TestCase):
    """AlertRulePatchProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertRulePatchProperties:
        """Test AlertRulePatchProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertRulePatchProperties`
        """
        model = AlertRulePatchProperties()
        if include_optional:
            return AlertRulePatchProperties(
    ...
    def testAlertRulePatchProperties(self):
        """Test AlertRulePatchProperties"""
