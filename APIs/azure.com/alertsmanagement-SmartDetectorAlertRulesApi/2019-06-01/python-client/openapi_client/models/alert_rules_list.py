...
class AlertRulesList(BaseModel):
    ...
    value: Optional[List[AlertRule]] = Field(default=None, description="List of Smart Detector alert rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AlertRule.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
