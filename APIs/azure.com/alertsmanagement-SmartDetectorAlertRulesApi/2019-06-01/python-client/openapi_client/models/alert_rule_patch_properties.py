...
class AlertRulePatchProperties(BaseModel):
    """
    The alert rule properties.
    """ # noqa: E501
    action_groups: Optional[ActionGroupsInformation] = Field(default=None, alias="actionGroups")
    description: Optional[StrictStr] = Field(default=None, description="The alert rule description.")
    frequency: Optional[StrictStr] = Field(default=None, description="The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.")
    severity: Optional[StrictStr] = Field(default=None, description="The alert rule severity.")
    state: Optional[StrictStr] = Field(default=None, description="The alert rule state.")
    throttling: Optional[ThrottlingInformation] = None
    __properties: ClassVar[List[str]] = ["actionGroups", "description", "frequency", "severity", "state", "throttling"]
