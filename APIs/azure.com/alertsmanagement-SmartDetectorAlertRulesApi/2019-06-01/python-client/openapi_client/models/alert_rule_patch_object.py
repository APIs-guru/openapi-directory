...
class AlertRulePatchObject(BaseModel):
    """
    ...
    properties: Optional[AlertRulePatchProperties] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "properties", "tags", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "properties": AlertRulePatchProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags"),
            "type": obj.get("type")
        })
        return _obj
