...
class AlertRule(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[AlertRuleProperties] = None
    id: Optional[StrictStr] = Field(default=None, description="The resource ID.")
    location: Optional[StrictStr] = Field(default='global', description="The resource location.")
    name: Optional[StrictStr] = Field(default=None, description="The resource name.")
    tags: Optional[Dict[str, Any]] = Field(default=None, description="The resource tags.")
