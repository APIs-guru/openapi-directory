...
[**smart_detector_alert_rules_patch**](SmartDetectorAlertRulesApi.md#smart_detector_alert_rules_patch) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.alertsManagement/smartDetectorAlertRules/{alertRuleName} | 
...
> AlertRulesList smart_detector_alert_rules_list(subscription_id, api_version, expand_detector=expand_detector)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.smart_detector_alert_rules_list(subscription_id, api_version, expand_detector=expand_detector)
...
> AlertRulesList smart_detector_alert_rules_list_by_resource_group(subscription_id, resource_group_name, api_version, expand_detector=expand_detector)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.smart_detector_alert_rules_list_by_resource_group(subscription_id, resource_group_name, api_version, expand_detector=expand_detector)
...
> AlertRule smart_detector_alert_rules_patch(subscription_id, resource_group_name, alert_rule_name, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    alert_rule_name = 'alert_rule_name_example' # str | The name of the alert rule.
    api_version = 'api_version_example' # str | Client Api Version.
    parameters = openapi_client.AlertRulePatchObject() # AlertRulePatchObject | Parameters supplied to the operation.

    try:
        api_response = api_instance.smart_detector_alert_rules_patch(subscription_id, resource_group_name, alert_rule_name, api_version, parameters)
        print("The response of SmartDetectorAlertRulesApi->smart_detector_alert_rules_patch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmartDetectorAlertRulesApi->smart_detector_alert_rules_patch: %s\n" % e)
```
 ...
 **alert_rule_name** | **str**| The name of the alert rule. | 
 **api_version** | **str**| Client Api Version. | 
 **parameters** | [**AlertRulePatchObject**](AlertRulePatchObject.md)| Parameters supplied to the operation. | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successful request to patch Smart Detector alert rule. |  -  |
**0** | Error response describing why the operation failed. |  -  |
