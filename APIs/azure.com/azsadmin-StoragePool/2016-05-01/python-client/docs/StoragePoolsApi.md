# openapi_client.StoragePoolsApi

All URIs are relative to *https://adminmanagement.local.azurestack.external*

Method | HTTP request | Description
------------- | ------------- | -------------
[**storage_pools_get**](StoragePoolsApi.md#storage_pools_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools/{storagePool} | 
[**storage_pools_list**](StoragePoolsApi.md#storage_pools_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools | 


# **storage_pools_get**
> StoragePool storage_pools_get(subscription_id, resource_group_name, location, storage_sub_system, storage_pool, api_version)
...
# **storage_pools_list**
> StoragePoolList storage_pools_list(subscription_id, resource_group_name, location, storage_sub_system, api_version, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.storage_pools_list(subscription_id, resource_group_name, location, storage_sub_system, api_version, filter=filter)
