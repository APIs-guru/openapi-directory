...
class RestorableDroppedManagedDatabasesApi:
    ...
    @validate_call
    def restorable_dropped_managed_databases_get(
        self,
        ...
        _param = self._restorable_dropped_managed_databases_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestorableDroppedManagedDatabase",
        }
    ...
    @validate_call
    def restorable_dropped_managed_databases_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        restorable_dropped_database_id: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestorableDroppedManagedDatabase]:
        """restorable_dropped_managed_databases_get
    ...
    @validate_call
    def restorable_dropped_managed_databases_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        restorable_dropped_database_id: StrictStr,
    ...
    def _restorable_dropped_managed_databases_get_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/restorableDroppedDatabases/{restorableDroppedDatabaseId}',
    ...
    @validate_call
    def restorable_dropped_managed_databases_list_by_instance(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        ...
        _param = self._restorable_dropped_managed_databases_list_by_instance_serialize(
            resource_group_name=resource_group_name,
            managed_instance_name=managed_instance_name,
            subscription_id=subscription_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestorableDroppedManagedDatabaseListResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def restorable_dropped_managed_databases_list_by_instance_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestorableDroppedManagedDatabaseListResult]:
        """restorable_dropped_managed_databases_list_by_instance
    ...
    @validate_call
    def restorable_dropped_managed_databases_list_by_instance_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
    ...
    def _restorable_dropped_managed_databases_list_by_instance_serialize(
        self,
        resource_group_name,
        managed_instance_name,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/restorableDroppedDatabases',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
