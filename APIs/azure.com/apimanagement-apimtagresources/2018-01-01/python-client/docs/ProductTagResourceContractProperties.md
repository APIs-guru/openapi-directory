...
json = "{}"
# create an instance of ProductTagResourceContractProperties from a JSON string
product_tag_resource_contract_properties_instance = ProductTagResourceContractProperties.from_json(json)
# print the JSON string representation of the object
print(ProductTagResourceContractProperties.to_json())

# convert the object into a dict
product_tag_resource_contract_properties_dict = product_tag_resource_contract_properties_instance.to_dict()
# create an instance of ProductTagResourceContractProperties from a dict
product_tag_resource_contract_properties_from_dict = ProductTagResourceContractProperties.from_dict(product_tag_resource_contract_properties_dict)
```
