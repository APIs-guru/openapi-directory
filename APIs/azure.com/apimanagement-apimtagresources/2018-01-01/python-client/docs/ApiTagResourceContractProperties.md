...
**authentication_settings** | [**ApiTagResourceContractPropertiesAllOfAuthenticationSettings**](ApiTagResourceContractPropertiesAllOfAuthenticationSettings.md) |  | [optional] 
...
**subscription_key_parameter_names** | [**ApiTagResourceContractPropertiesAllOfSubscriptionKeyParameterNames**](ApiTagResourceContractPropertiesAllOfSubscriptionKeyParameterNames.md) |  | [optional] 
...
json = "{}"
# create an instance of ApiTagResourceContractProperties from a JSON string
api_tag_resource_contract_properties_instance = ApiTagResourceContractProperties.from_json(json)
# print the JSON string representation of the object
print(ApiTagResourceContractProperties.to_json())

# convert the object into a dict
api_tag_resource_contract_properties_dict = api_tag_resource_contract_properties_instance.to_dict()
# create an instance of ApiTagResourceContractProperties from a dict
api_tag_resource_contract_properties_from_dict = ApiTagResourceContractProperties.from_dict(api_tag_resource_contract_properties_dict)
```
