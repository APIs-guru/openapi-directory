...
class ApiTagResourceContractPropertiesAllOfAuthenticationSettingsOpenid(BaseModel):
    """
    API OAuth2 Authentication settings details.
    """ # noqa: E501
    bearer_token_sending_methods: Optional[List[StrictStr]] = Field(default=None, description="How to send token to the server.", alias="bearerTokenSendingMethods")
    openid_provider_id: Optional[StrictStr] = Field(default=None, description="OAuth authorization server identifier.", alias="openidProviderId")
    __properties: ClassVar[List[str]] = ["bearerTokenSendingMethods", "openidProviderId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "openidProviderId": obj.get("openidProviderId")
        })
        return _obj
