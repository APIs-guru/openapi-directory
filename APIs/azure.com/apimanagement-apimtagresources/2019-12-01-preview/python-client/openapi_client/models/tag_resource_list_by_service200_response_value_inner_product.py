...
class TagResourceListByService200ResponseValueInnerProduct(BaseModel):
    """
    Product profile.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the product in the form of /products/{productId}")
