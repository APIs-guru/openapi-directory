...
class RegistriesApi:
    ...
    @validate_call
    def registries_generate_credentials(
        self,
        ...
        generate_credentials_parameters: Annotated[GenerateCredentialsParameters, Field(description="The parameters for generating credentials.")],
        ...
        :type generate_credentials_parameters: GenerateCredentialsParameters
        ...
        _param = self._registries_generate_credentials_serialize(
    ...
    @validate_call
    def registries_generate_credentials_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, description="The name of the resource group to which the container registry belongs.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateCredentialsResult]:
        """registries_generate_credentials
    ...
    @validate_call
    def registries_generate_credentials_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The Microsoft Azure subscription ID.")],
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, description="The name of the resource group to which the container registry belongs.")],
    ...
    def _registries_generate_credentials_serialize(
        self,
        api_version,
        subscription_id,
        resource_group_name,
        ...
        if generate_credentials_parameters is not None:
            _body_params = generate_credentials_parameters
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/generateCredentials',
