...
class ScopeMapUpdateParameters(BaseModel):
    """
    The properties for updating the scope map.
    """ # noqa: E501
    properties: Optional[ScopeMapPropertiesUpdateParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ScopeMapPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
