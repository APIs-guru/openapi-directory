...
class TokenUpdateParameters(BaseModel):
    """
    The parameters for updating a token.
    """ # noqa: E501
    properties: Optional[TokenUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TokenUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
