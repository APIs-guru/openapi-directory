...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.StorSimple/operations | 


# **operations_list**
> AvailableProviderOperationList operations_list(api_version)
...
|-------------|-------------|------------------|
**200** | The collection of available provider operations. |  -  |
