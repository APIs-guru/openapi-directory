...
------------ | ------------- | ------------- | -------------
**code** | **str** | The error code intended for programmatic access. | 
**message** | **str** | The error message intended to describe the error in detail. | 
**recommendations** | **List[str]** | The recommended actions. | [optional] 
