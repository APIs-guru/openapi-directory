...
------------- | ------------- | -------------
[**jobs_cancel**](JobsApi.md#jobs_cancel) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/devices/{deviceName}/jobs/{jobName}/cancel | 
...
# **jobs_cancel**
> jobs_cancel(device_name, job_name, subscription_id, resource_group_name, manager_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    job_name = 'job_name_example' # str | The jobName.
    ...
    try:
        api_instance.jobs_cancel(device_name, job_name, subscription_id, resource_group_name, manager_name, api_version)
...
|-------------|-------------|------------------|
**202** | Accepted the request to cancel a deviceJob |  -  |
**204** | Successfully cancelled the deviceJob |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | The collection of jobs for the specified manager and device name. |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | The collection of device jobs on all devices under the specified manager. |  -  |
