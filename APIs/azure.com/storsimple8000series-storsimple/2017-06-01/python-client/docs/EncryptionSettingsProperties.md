...
------------ | ------------- | ------------- | -------------
**encryption_status** | **str** | The encryption status to indicates if encryption is enabled or not. | 
**key_rollover_status** | **str** | The key rollover status to indicates if key rollover is required or not. If secret&#39;s encryption has been upgraded, then it requires key rollover. | 
