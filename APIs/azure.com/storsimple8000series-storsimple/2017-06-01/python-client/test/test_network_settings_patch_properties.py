...
class TestNetworkSettingsPatchProperties(unittest.TestCase):
    """NetworkSettingsPatchProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkSettingsPatchProperties:
        """Test NetworkSettingsPatchProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkSettingsPatchProperties`
        """
        model = NetworkSettingsPatchProperties()
        if include_optional:
            return NetworkSettingsPatchProperties(
    ...
    def testNetworkSettingsPatchProperties(self):
        """Test NetworkSettingsPatchProperties"""
