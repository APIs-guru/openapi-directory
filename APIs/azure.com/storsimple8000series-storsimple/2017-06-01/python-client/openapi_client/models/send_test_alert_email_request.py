...
class SendTestAlertEmailRequest(BaseModel):
    """
    The request for sending test alert email
    """ # noqa: E501
    email_list: List[StrictStr] = Field(description="The list of email IDs to send the test alert email", alias="emailList")
