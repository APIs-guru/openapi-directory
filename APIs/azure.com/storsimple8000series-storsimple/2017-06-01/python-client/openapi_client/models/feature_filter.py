...
class FeatureFilter(BaseModel):
    ...
    """ # noqa: E501
    device_id: Optional[StrictStr] = Field(default=None, description="Specifies the device ID for which the features are required. Only 'Equality' operator is supported for this property.", alias="deviceId")
