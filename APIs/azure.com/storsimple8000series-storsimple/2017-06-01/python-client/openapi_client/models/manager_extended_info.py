...
class ManagerExtendedInfo(BaseModel):
    ...
    properties: Optional[ManagerExtendedInfoProperties] = None
    id: Optional[StrictStr] = Field(default=None, description="The path ID that uniquely identifies the object.")
    kind: Optional[StrictStr] = Field(default=None, description="The Kind of the object. Currently only Series8000 is supported")
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['Series8000']):
            raise ValueError("must be one of enum values ('Series8000')")
        return value
