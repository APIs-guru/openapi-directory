...
class MetricDimension(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The metric dimension name.")
    value: Optional[StrictStr] = Field(default=None, description="The metric dimension values.")
