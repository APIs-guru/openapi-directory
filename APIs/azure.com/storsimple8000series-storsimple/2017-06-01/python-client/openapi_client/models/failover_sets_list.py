...
class FailoverSetsList(BaseModel):
    """
    The list of failover sets.
    """ # noqa: E501
    value: Optional[List[FailoverSet]] = Field(default=None, description="The list of failover sets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [FailoverSet.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
