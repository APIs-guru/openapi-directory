...
class FailoverTargetsList(BaseModel):
    """
    The list of all devices in a resource and their eligibility status as a failover target device.
    """ # noqa: E501
    value: Optional[List[FailoverTarget]] = Field(default=None, description="The list of all the failover targets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [FailoverTarget.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
