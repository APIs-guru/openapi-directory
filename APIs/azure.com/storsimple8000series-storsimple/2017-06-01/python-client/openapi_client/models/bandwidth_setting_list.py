...
class BandwidthSettingList(BaseModel):
    """
    The collection of bandwidth setting entities.
    """ # noqa: E501
    value: List[BandwidthSetting] = Field(description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BandwidthSetting.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
