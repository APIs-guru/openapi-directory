...
class MetricList(BaseModel):
    ...
    The metric list.
    """ # noqa: E501
    value: Optional[List[Metrics]] = Field(default=None, description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Metrics.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
