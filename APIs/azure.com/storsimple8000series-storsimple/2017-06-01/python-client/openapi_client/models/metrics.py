...
class Metrics(BaseModel):
    ...
    end_time: Optional[datetime] = Field(default=None, description="The end time of the metric data.", alias="endTime")
    name: Optional[MetricName] = None
    primary_aggregation: Optional[StrictStr] = Field(default=None, description="The metric aggregation type.", alias="primaryAggregation")
    resource_id: Optional[StrictStr] = Field(default=None, description="The ID of metric source.", alias="resourceId")
    start_time: Optional[datetime] = Field(default=None, description="The start time of the metric data.", alias="startTime")
    time_grain: Optional[StrictStr] = Field(default=None, description="The time granularity of the metric data.", alias="timeGrain")
    type: Optional[StrictStr] = Field(default=None, description="The type of the metric data.")
    unit: Optional[StrictStr] = Field(default=None, description="The unit of the metric data.")
    values: Optional[List[MetricData]] = Field(default=None, description="The list of the metric data.")
