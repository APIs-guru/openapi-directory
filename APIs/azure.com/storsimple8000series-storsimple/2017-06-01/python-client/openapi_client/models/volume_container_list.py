...
class VolumeContainerList(BaseModel):
    """
    The collection of volume container entities.
    """ # noqa: E501
    value: List[VolumeContainer] = Field(description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VolumeContainer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
