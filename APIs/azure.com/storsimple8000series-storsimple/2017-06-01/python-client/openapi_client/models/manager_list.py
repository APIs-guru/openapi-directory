...
class ManagerList(BaseModel):
    ...
    """ # noqa: E501
    value: List[Manager] = Field(description="The list of StorSimple managers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Manager.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
