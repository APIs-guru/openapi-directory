...
class SecuritySettingsProperties(BaseModel):
    """
    The properties of security settings of a device.
    """ # noqa: E501
    chap_settings: ChapSettings = Field(alias="chapSettings")
    remote_management_settings: RemoteManagementSettings = Field(alias="remoteManagementSettings")
    __properties: ClassVar[List[str]] = ["chapSettings", "remoteManagementSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remoteManagementSettings": RemoteManagementSettings.from_dict(obj["remoteManagementSettings"]) if obj.get("remoteManagementSettings") is not None else None
        })
        return _obj
