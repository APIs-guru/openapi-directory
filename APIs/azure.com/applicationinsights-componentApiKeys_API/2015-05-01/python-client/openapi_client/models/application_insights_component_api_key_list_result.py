...
class ApplicationInsightsComponentAPIKeyListResult(BaseModel):
    """
    Describes the list of API Keys of an Application Insights Component.
    """ # noqa: E501
    value: List[ApplicationInsightsComponentAPIKey] = Field(description="List of API Key definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ApplicationInsightsComponentAPIKey.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
