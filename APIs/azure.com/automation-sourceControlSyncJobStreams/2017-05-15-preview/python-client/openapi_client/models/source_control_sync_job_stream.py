...
class SourceControlSyncJobStream(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "properties": SourceControlSyncJobStreamProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
