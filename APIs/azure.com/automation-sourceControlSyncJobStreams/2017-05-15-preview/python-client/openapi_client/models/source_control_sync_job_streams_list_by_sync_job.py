...
class SourceControlSyncJobStreamsListBySyncJob(BaseModel):
    """
    ...
    value: Optional[List[SourceControlSyncJobStream]] = Field(default=None, description="The list of source control sync job streams.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SourceControlSyncJobStream.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
