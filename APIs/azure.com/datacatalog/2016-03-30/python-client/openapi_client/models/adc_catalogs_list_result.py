...
class ADCCatalogsListResult(BaseModel):
    """
    The response from the List Azure Data Catalog operation.
    """ # noqa: E501
    value: Optional[List[ADCCatalog]] = Field(default=None, description="the list of Azure Data Catalogs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ADCCatalog.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
