...
class Principals(BaseModel):
    ...
    User principals.
    """ # noqa: E501
    object_id: Optional[StrictStr] = Field(default=None, description="Object Id for the user", alias="objectId")
    upn: Optional[StrictStr] = Field(default=None, description="UPN of the user.")
    __properties: ClassVar[List[str]] = ["objectId", "upn"]
