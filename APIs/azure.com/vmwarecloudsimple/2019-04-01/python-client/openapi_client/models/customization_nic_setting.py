...
class CustomizationNicSetting(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adapter", "macAddress"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of adapter
        if self.adapter:
            _dict['adapter'] = self.adapter.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adapter": CustomizationIPSettings.from_dict(obj["adapter"]) if obj.get("adapter") is not None else None,
