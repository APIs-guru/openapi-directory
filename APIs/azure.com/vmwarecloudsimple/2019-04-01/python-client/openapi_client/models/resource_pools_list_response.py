...
class ResourcePoolsListResponse(BaseModel):
    """
    List of resource pools response model
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next list of ResourcePoolsList", alias="nextLink")
    value: Optional[List[ResourcePool]] = Field(default=None, description="Results of the Resource pools list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ResourcePool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
