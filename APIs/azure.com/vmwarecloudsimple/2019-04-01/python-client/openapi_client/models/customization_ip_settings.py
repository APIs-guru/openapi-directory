...
class CustomizationIPSettings(BaseModel):
    """
    CustomizationIPSettings
    """ # noqa: E501
    gateway: Optional[List[StrictStr]] = Field(default=None, description="The list of gateways")
    ip: Optional[CustomizationIPAddress] = None
    subnet_mask: Optional[StrictStr] = Field(default=None, description="Adapter subnet mask", alias="subnetMask")
    __properties: ClassVar[List[str]] = ["gateway", "ip", "subnetMask"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": CustomizationIPAddress.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
