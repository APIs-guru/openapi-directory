...
class CustomizationPoliciesListResponse(BaseModel):
    """
    List of customization polices response model
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next list of the Customization policy", alias="nextLink")
    value: Optional[List[CustomizationPolicy]] = Field(default=None, description="List of the customization policies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CustomizationPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
