...
class VirtualMachineTemplateListResponse(BaseModel):
    """
    List of virtual machine templates
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next list of VirtualMachineTemplate", alias="nextLink")
    value: Optional[List[VirtualMachineTemplate]] = Field(default=None, description="Results of the VM template list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VirtualMachineTemplate.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
