...
class VirtualMachineListResponse(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for next list of VirtualMachines", alias="nextLink")
    value: Optional[List[VirtualMachine]] = Field(default=None, description="Results of the VirtualMachine list")
