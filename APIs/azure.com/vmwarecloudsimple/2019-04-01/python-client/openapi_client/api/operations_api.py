...
class OperationsApi:
    ...
    def _operations_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.VMwareCloudSimple/locations/{regionId}/operationResults/{operationId}',
    ...
    def operations_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AvailableOperationsListResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def operations_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AvailableOperationsListResponse]:
        """Implements list of available operations
    ...
    def _operations_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.VMwareCloudSimple/operations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
