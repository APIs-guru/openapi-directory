...
class TestVirtualMachineTemplateListResponse(unittest.TestCase):
    """VirtualMachineTemplateListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualMachineTemplateListResponse:
        """Test VirtualMachineTemplateListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualMachineTemplateListResponse`
        """
        model = VirtualMachineTemplateListResponse()
        if include_optional:
    ...
    def testVirtualMachineTemplateListResponse(self):
        """Test VirtualMachineTemplateListResponse"""
