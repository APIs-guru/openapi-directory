...
class TestVirtualMachineTemplateProperties(unittest.TestCase):
    """VirtualMachineTemplateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualMachineTemplateProperties:
        """Test VirtualMachineTemplateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualMachineTemplateProperties`
        """
        model = VirtualMachineTemplateProperties()
        if include_optional:
            return VirtualMachineTemplateProperties(
                amount_of_ram = 56,
                controllers = [
    ...
    def testVirtualMachineTemplateProperties(self):
        """Test VirtualMachineTemplateProperties"""
