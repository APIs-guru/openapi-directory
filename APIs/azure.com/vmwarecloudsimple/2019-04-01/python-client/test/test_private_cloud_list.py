...
class TestPrivateCloudList(unittest.TestCase):
    """PrivateCloudList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateCloudList:
        """Test PrivateCloudList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateCloudList`
        """
        model = PrivateCloudList()
        if include_optional:
