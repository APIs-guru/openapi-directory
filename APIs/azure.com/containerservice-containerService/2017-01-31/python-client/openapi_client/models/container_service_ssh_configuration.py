...
class ContainerServiceSshConfiguration(BaseModel):
    ...
    """ # noqa: E501
    public_keys: List[ContainerServiceSshPublicKey] = Field(description="the list of SSH public keys used to authenticate with Linux-based VMs.", alias="publicKeys")
