...
------------ | ------------- | ------------- | -------------
**code** | **str** | This represents the error code | 
**details** | [**List[ErrorModelDetailsInner]**](ErrorModelDetailsInner.md) | This gives details of the reason(s) for the error | [optional] 
**message** | **str** | This represents the error message | 
