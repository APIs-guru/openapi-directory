...
class TestRunDefinition(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RunDefinition:
        """Test RunDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunDefinition`
        """
        model = RunDefinition()
        if include_optional:
            return RunDefinition(
                configuration = openapi_client.models.run_configuration.RunConfiguration(
                    arguments = ["234"], 
                    communicator = 'None', 
                    data_references = {
...
RUN echo "Hello world!"', 
                    ...
                    tensorflow = openapi_client.models.tensorflow_configuration.TensorflowConfiguration(
                        ...
                        worker_count = 2, ), ),
                parent_run_id = 'myexperiment_155000000001_0',
                run_type = 'experiment',
                snapshot_id = ''
            )
        else:
