...
class IoTSpacesDescriptionListResult(BaseModel):
    """
    A list of IoTSpaces description objects with a next link.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of IoTSpaces description objects.", alias="nextLink")
    value: Optional[List[IoTSpacesDescription]] = Field(default=None, description="A list of IoTSpaces description objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IoTSpacesDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
