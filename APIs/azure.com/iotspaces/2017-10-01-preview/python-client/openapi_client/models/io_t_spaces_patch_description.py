...
class IoTSpacesPatchDescription(BaseModel):
    """
    The description of the IoTSpaces service.
    """ # noqa: E501
    properties: Optional[IoTSpacesProperties] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Instance tags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": IoTSpacesProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
