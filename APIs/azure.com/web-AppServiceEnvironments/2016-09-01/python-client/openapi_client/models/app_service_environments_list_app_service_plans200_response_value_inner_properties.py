...
class AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerProperties(BaseModel):
    ...
    """ # noqa: E501
    admin_site_name: Optional[StrictStr] = Field(default=None, description="App Service plan administration site.", alias="adminSiteName")
    ...
    hosting_environment_profile: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesHostingEnvironmentProfile] = Field(default=None, alias="hostingEnvironmentProfile")
    ...
    name: StrictStr = Field(description="Name for the App Service plan.")
    ...
    __properties: ClassVar[List[str]] = ["adminSiteName", "geoRegion", "hostingEnvironmentProfile", "isSpot", "maximumNumberOfWorkers", "name", "numberOfSites", "perSiteScaling", "provisioningState", "reserved", "resourceGroup", "spotExpirationTime", "status", "subscription", "targetWorkerCount", "targetWorkerSizeId", "workerTierName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adminSiteName": obj.get("adminSiteName"),
            "geoRegion": obj.get("geoRegion"),
            "hostingEnvironmentProfile": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesHostingEnvironmentProfile.from_dict(obj["hostingEnvironmentProfile"]) if obj.get("hostingEnvironmentProfile") is not None else None,
