...
class AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAutoHealRulesActions(BaseModel):
    """
    ...
    custom_action: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAutoHealRulesActionsCustomAction] = Field(default=None, alias="customAction")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customAction": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAutoHealRulesActionsCustomAction.from_dict(obj["customAction"]) if obj.get("customAction") is not None else None,
