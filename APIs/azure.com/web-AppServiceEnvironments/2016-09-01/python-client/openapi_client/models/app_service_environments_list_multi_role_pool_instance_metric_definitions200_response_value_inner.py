...
class AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInner(BaseModel):
    """
    Metadata for the metrics.
    """ # noqa: E501
    properties: Optional[AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
