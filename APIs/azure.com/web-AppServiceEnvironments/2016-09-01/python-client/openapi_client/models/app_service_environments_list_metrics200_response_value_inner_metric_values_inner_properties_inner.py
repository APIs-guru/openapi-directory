...
class AppServiceEnvironmentsListMetrics200ResponseValueInnerMetricValuesInnerPropertiesInner(BaseModel):
    """
    Resource metric property.
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Key for resource metric property.")
    value: Optional[StrictStr] = Field(default=None, description="Value of pair.")
