...
class AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInnerProperties(BaseModel):
    """
    ResourceMetricDefinition resource specific properties
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Resource ID.")
    metric_availabilities: Optional[List[AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInnerPropertiesMetricAvailabilitiesInner]] = Field(default=None, description="List of time grains supported for the metric together with retention period.", alias="metricAvailabilities")
    name: Optional[AppServiceEnvironmentsListMetrics200ResponseValueInnerName] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metricAvailabilities": [AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200ResponseValueInnerPropertiesMetricAvailabilitiesInner.from_dict(_item) for _item in obj["metricAvailabilities"]] if obj.get("metricAvailabilities") is not None else None,
            "name": AppServiceEnvironmentsListMetrics200ResponseValueInnerName.from_dict(obj["name"]) if obj.get("name") is not None else None,
