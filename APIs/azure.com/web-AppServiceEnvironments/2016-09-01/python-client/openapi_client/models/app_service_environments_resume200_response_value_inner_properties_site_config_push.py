...
class AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigPush(BaseModel):
    """
    Push settings for the App.
    """ # noqa: E501
    properties: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigPushProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigPushProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
