...
class WorkerPoolResource(BaseModel):
    """
    Worker pool of an App Service Environment ARM resource.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="Worker pool of an App Service Environment.")
    sku: Optional[object] = Field(default=None, description="Description of a SKU for a scalable resource.")
