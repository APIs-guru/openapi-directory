...
class AppServiceEnvironmentsResume200ResponseValueInnerProperties(BaseModel):
    """
    ...
    cloning_info: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo] = Field(default=None, alias="cloningInfo")
    ...
    host_name_ssl_states: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesHostNameSslStatesInner]] = Field(default=None, description="Hostname SSL states are used to manage the SSL bindings for app's hostnames.", alias="hostNameSslStates")
    ...
    site_config: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig] = Field(default=None, alias="siteConfig")
    slot_swap_status: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSlotSwapStatus] = Field(default=None, alias="slotSwapStatus")
    snapshot_info: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSnapshotInfo] = Field(default=None, alias="snapshotInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloningInfo": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.from_dict(obj["cloningInfo"]) if obj.get("cloningInfo") is not None else None,
            ...
            "hostNameSslStates": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesHostNameSslStatesInner.from_dict(_item) for _item in obj["hostNameSslStates"]] if obj.get("hostNameSslStates") is not None else None,
            ...
            "siteConfig": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig.from_dict(obj["siteConfig"]) if obj.get("siteConfig") is not None else None,
            "slotSwapStatus": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSlotSwapStatus.from_dict(obj["slotSwapStatus"]) if obj.get("slotSwapStatus") is not None else None,
            "snapshotInfo": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSnapshotInfo.from_dict(obj["snapshotInfo"]) if obj.get("snapshotInfo") is not None else None,
            "state": obj.get("state"),
