...
class AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    """
    ...
    api_definition: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigApiDefinition] = Field(default=None, alias="apiDefinition")
    app_command_line: Optional[StrictStr] = Field(default=None, description="App command line to launch.", alias="appCommandLine")
    app_settings: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAppSettingsInner]] = Field(default=None, description="Application settings.", alias="appSettings")
    ...
    auto_heal_rules: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAutoHealRules] = Field(default=None, alias="autoHealRules")
    auto_swap_slot_name: Optional[StrictStr] = Field(default=None, description="Auto-swap slot name.", alias="autoSwapSlotName")
    connection_strings: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner]] = Field(default=None, description="Connection strings.", alias="connectionStrings")
    cors: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigCors] = None
    ...
    experiments: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigExperiments] = None
    handler_mappings: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner]] = Field(default=None, description="Handler mappings.", alias="handlerMappings")
    ...
    ip_security_restrictions: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner]] = Field(default=None, description="IP security restrictions.", alias="ipSecurityRestrictions")
    ...
    limits: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigLimits] = None
    ...
    machine_key: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigMachineKey] = Field(default=None, alias="machineKey")
    ...
    push: Optional[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigPush] = None
    ...
    virtual_applications: Optional[List[AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner]] = Field(default=None, description="Virtual applications.", alias="virtualApplications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiDefinition": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigApiDefinition.from_dict(obj["apiDefinition"]) if obj.get("apiDefinition") is not None else None,
            "appCommandLine": obj.get("appCommandLine"),
            "appSettings": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAppSettingsInner.from_dict(_item) for _item in obj["appSettings"]] if obj.get("appSettings") is not None else None,
            "autoHealEnabled": obj.get("autoHealEnabled"),
            "autoHealRules": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigAutoHealRules.from_dict(obj["autoHealRules"]) if obj.get("autoHealRules") is not None else None,
            "autoSwapSlotName": obj.get("autoSwapSlotName"),
            "connectionStrings": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner.from_dict(_item) for _item in obj["connectionStrings"]] if obj.get("connectionStrings") is not None else None,
            "cors": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigCors.from_dict(obj["cors"]) if obj.get("cors") is not None else None,
            ...
            "experiments": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigExperiments.from_dict(obj["experiments"]) if obj.get("experiments") is not None else None,
            "handlerMappings": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner.from_dict(_item) for _item in obj["handlerMappings"]] if obj.get("handlerMappings") is not None else None,
            ...
            "ipSecurityRestrictions": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner.from_dict(_item) for _item in obj["ipSecurityRestrictions"]] if obj.get("ipSecurityRestrictions") is not None else None,
            "javaContainer": obj.get("javaContainer"),
            "javaContainerVersion": obj.get("javaContainerVersion"),
            "javaVersion": obj.get("javaVersion"),
            "limits": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            ...
            "machineKey": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigMachineKey.from_dict(obj["machineKey"]) if obj.get("machineKey") is not None else None,
            ...
            "push": AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigPush.from_dict(obj["push"]) if obj.get("push") is not None else None,
            ...
            "virtualApplications": [AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner.from_dict(_item) for _item in obj["virtualApplications"]] if obj.get("virtualApplications") is not None else None,
