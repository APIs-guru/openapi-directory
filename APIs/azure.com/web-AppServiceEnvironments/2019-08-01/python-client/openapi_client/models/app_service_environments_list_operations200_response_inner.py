...
class AppServiceEnvironmentsListOperations200ResponseInner(BaseModel):
    """
    An operation on a resource.
    """ # noqa: E501
    created_time: Optional[datetime] = Field(default=None, description="Time when operation has started.", alias="createdTime")
    errors: Optional[List[AppServiceEnvironmentsListOperations200ResponseInnerErrorsInner]] = Field(default=None, description="Any errors associate with the operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [AppServiceEnvironmentsListOperations200ResponseInnerErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
