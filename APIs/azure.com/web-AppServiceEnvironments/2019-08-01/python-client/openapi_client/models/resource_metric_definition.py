...
class ResourceMetricDefinition(BaseModel):
    """
    Metadata for the metrics.
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="ResourceMetricDefinition resource specific properties")
