...
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRules(BaseModel):
    """
    Rules that can be defined for auto-heal.
    """ # noqa: E501
    actions: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRulesActions] = None
    triggers: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggers] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRulesActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "triggers": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRulesTriggers.from_dict(obj["triggers"]) if obj.get("triggers") is not None else None
        })
        return _obj
