...
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    """
    ...
    api_definition: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigApiDefinition] = Field(default=None, alias="apiDefinition")
    api_management_config: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigApiManagementConfig] = Field(default=None, alias="apiManagementConfig")
    app_command_line: Optional[StrictStr] = Field(default=None, description="App command line to launch.", alias="appCommandLine")
    app_settings: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAppSettingsInner]] = Field(default=None, description="Application settings.", alias="appSettings")
    ...
    auto_heal_rules: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRules] = Field(default=None, alias="autoHealRules")
    auto_swap_slot_name: Optional[StrictStr] = Field(default=None, description="Auto-swap slot name.", alias="autoSwapSlotName")
    connection_strings: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner]] = Field(default=None, description="Connection strings.", alias="connectionStrings")
    cors: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigCors] = None
    ...
    experiments: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigExperiments] = None
    ftps_state: Optional[StrictStr] = Field(default=None, description="State of FTP / FTPS service", alias="ftpsState")
    handler_mappings: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner]] = Field(default=None, description="Handler mappings.", alias="handlerMappings")
    health_check_path: Optional[StrictStr] = Field(default=None, description="Health check path", alias="healthCheckPath")
    ...
    ip_security_restrictions: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner]] = Field(default=None, description="IP security restrictions for main.", alias="ipSecurityRestrictions")
    ...
    limits: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigLimits] = None
    ...
    machine_key: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigMachineKey] = Field(default=None, alias="machineKey")
    ...
    pre_warmed_instance_count: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=None, description="Number of preWarmed instances. This setting only applies to the Consumption and Elastic Plans", alias="preWarmedInstanceCount")
    publishing_username: Optional[StrictStr] = Field(default=None, description="Publishing user name.", alias="publishingUsername")
    push: Optional[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigPush] = None
    ...
    scm_ip_security_restrictions: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner]] = Field(default=None, description="IP security restrictions for scm.", alias="scmIpSecurityRestrictions")
    ...
    virtual_applications: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner]] = Field(default=None, description="Virtual applications.", alias="virtualApplications")
    ...
    def scm_type_validate_enum(cls, value):
        ...
        if value not in set(['None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO', 'VSTSRM']):
            raise ValueError("must be one of enum values ('None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO', 'VSTSRM')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of api_management_config
        if self.api_management_config:
            _dict['apiManagementConfig'] = self.api_management_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiDefinition": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigApiDefinition.from_dict(obj["apiDefinition"]) if obj.get("apiDefinition") is not None else None,
            "apiManagementConfig": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigApiManagementConfig.from_dict(obj["apiManagementConfig"]) if obj.get("apiManagementConfig") is not None else None,
            "appCommandLine": obj.get("appCommandLine"),
            "appSettings": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAppSettingsInner.from_dict(_item) for _item in obj["appSettings"]] if obj.get("appSettings") is not None else None,
            "autoHealEnabled": obj.get("autoHealEnabled"),
            "autoHealRules": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAutoHealRules.from_dict(obj["autoHealRules"]) if obj.get("autoHealRules") is not None else None,
            "autoSwapSlotName": obj.get("autoSwapSlotName"),
            "connectionStrings": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigConnectionStringsInner.from_dict(_item) for _item in obj["connectionStrings"]] if obj.get("connectionStrings") is not None else None,
            "cors": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigCors.from_dict(obj["cors"]) if obj.get("cors") is not None else None,
            ...
            "experiments": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigExperiments.from_dict(obj["experiments"]) if obj.get("experiments") is not None else None,
            "ftpsState": obj.get("ftpsState"),
            "handlerMappings": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigHandlerMappingsInner.from_dict(_item) for _item in obj["handlerMappings"]] if obj.get("handlerMappings") is not None else None,
            ...
            "ipSecurityRestrictions": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner.from_dict(_item) for _item in obj["ipSecurityRestrictions"]] if obj.get("ipSecurityRestrictions") is not None else None,
            "javaContainer": obj.get("javaContainer"),
            "javaContainerVersion": obj.get("javaContainerVersion"),
            "javaVersion": obj.get("javaVersion"),
            "limits": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            ...
            "machineKey": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigMachineKey.from_dict(obj["machineKey"]) if obj.get("machineKey") is not None else None,
            ...
            "preWarmedInstanceCount": obj.get("preWarmedInstanceCount"),
            "publishingUsername": obj.get("publishingUsername"),
            "push": AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigPush.from_dict(obj["push"]) if obj.get("push") is not None else None,
            ...
            "scmIpSecurityRestrictions": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigIpSecurityRestrictionsInner.from_dict(_item) for _item in obj["scmIpSecurityRestrictions"]] if obj.get("scmIpSecurityRestrictions") is not None else None,
            ...
            "virtualApplications": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigVirtualApplicationsInner.from_dict(_item) for _item in obj["virtualApplications"]] if obj.get("virtualApplications") is not None else None,
