...
class AppServiceEnvironmentsListAppServicePlans200Response(BaseModel):
    """
    Collection of App Service plans.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link to next page of resources.", alias="nextLink")
    value: List[AppServiceEnvironmentsListAppServicePlans200ResponseValueInner] = Field(description="Collection of resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AppServiceEnvironmentsListAppServicePlans200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
