...
class AppServiceEnvironmentsListMetrics200ResponseValueInner(BaseModel):
    """
    ...
    metric_values: Optional[List[AppServiceEnvironmentsListMetrics200ResponseValueInnerMetricValuesInner]] = Field(default=None, description="Metric values.", alias="metricValues")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metricValues": [AppServiceEnvironmentsListMetrics200ResponseValueInnerMetricValuesInner.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None,
