...
class AppServiceEnvironmentsListAppServicePlans200ResponseValueInner(BaseModel):
    """
    App Service plan.
    """ # noqa: E501
    properties: Optional[AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerProperties] = None
    sku: Optional[AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerSku] = None
    __properties: ClassVar[List[str]] = ["properties", "sku"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None
        })
        return _obj
