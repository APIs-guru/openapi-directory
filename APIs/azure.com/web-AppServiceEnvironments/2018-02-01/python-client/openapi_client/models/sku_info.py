...
class SkuInfo(BaseModel):
    ...
    """ # noqa: E501
    capacity: Optional[AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerSkuSkuCapacity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": AppServiceEnvironmentsListAppServicePlans200ResponseValueInnerSkuSkuCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
