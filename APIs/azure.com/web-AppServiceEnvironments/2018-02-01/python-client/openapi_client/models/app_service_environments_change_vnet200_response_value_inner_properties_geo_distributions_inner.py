...
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesGeoDistributionsInner(BaseModel):
    """
    A global distribution definition.
    """ # noqa: E501
    location: Optional[StrictStr] = Field(default=None, description="Location.")
    number_of_workers: Optional[StrictInt] = Field(default=None, description="NumberOfWorkers.", alias="numberOfWorkers")
    __properties: ClassVar[List[str]] = ["location", "numberOfWorkers"]
