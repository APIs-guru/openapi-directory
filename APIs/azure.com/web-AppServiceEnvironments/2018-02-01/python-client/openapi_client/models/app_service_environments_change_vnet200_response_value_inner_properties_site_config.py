...
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig(BaseModel):
    ...
    azure_storage_accounts: Optional[Dict[str, AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAzureStorageAccountsValue]] = Field(default=None, description="User-provided Azure storage accounts.", alias="azureStorageAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "azureStorageAccounts": dict(
                (_k, AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfigAzureStorageAccountsValue.from_dict(_v))
