...
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties(BaseModel):
    ...
    geo_distributions: Optional[List[AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesGeoDistributionsInner]] = Field(default=None, description="GeoDistributions for this site", alias="geoDistributions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geoDistributions": [AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesGeoDistributionsInner.from_dict(_item) for _item in obj["geoDistributions"]] if obj.get("geoDistributions") is not None else None,
