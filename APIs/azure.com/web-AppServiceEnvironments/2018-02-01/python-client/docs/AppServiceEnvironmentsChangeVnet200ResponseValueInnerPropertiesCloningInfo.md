...
app_service_environments_change_vnet200_response_value_inner_properties_cloning_info_instance = AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.from_json(json)
# print the JSON string representation of the object
print(AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.to_json())

# convert the object into a dict
app_service_environments_change_vnet200_response_value_inner_properties_cloning_info_dict = app_service_environments_change_vnet200_response_value_inner_properties_cloning_info_instance.to_dict()
# create an instance of AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo from a dict
app_service_environments_change_vnet200_response_value_inner_properties_cloning_info_from_dict = AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.from_dict(app_service_environments_change_vnet200_response_value_inner_properties_cloning_info_dict)
```
