...
class RemoteRenderingAccountPage(BaseModel):
    """
    ...
    value: Optional[List[RemoteRenderingAccount]] = Field(default=None, description="List of resources supported by the Resource Provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RemoteRenderingAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
