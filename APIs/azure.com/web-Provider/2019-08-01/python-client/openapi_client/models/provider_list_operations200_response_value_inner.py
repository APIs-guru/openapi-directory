...
class ProviderListOperations200ResponseValueInner(BaseModel):
    """
    Description of an operation available for Microsoft.Web resource provider.
    """ # noqa: E501
    display: Optional[ProviderListOperations200ResponseValueInnerDisplay] = None
    name: Optional[StrictStr] = None
    origin: Optional[StrictStr] = None
    properties: Optional[ProviderListOperations200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display": ProviderListOperations200ResponseValueInnerDisplay.from_dict(obj["display"]) if obj.get("display") is not None else None,
            "name": obj.get("name"),
            "origin": obj.get("origin"),
            "properties": ProviderListOperations200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
