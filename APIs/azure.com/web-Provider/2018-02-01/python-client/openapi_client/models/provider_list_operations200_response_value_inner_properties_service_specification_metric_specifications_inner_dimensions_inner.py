...
class ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInnerDimensionsInner(BaseModel):
    """
    ...
    internal_name: Optional[StrictStr] = Field(default=None, alias="internalName")
    name: Optional[StrictStr] = None
    to_be_exported_for_shoebox: Optional[StrictBool] = Field(default=None, alias="toBeExportedForShoebox")
