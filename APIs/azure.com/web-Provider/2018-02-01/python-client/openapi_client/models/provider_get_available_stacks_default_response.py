...
class ProviderGetAvailableStacksDefaultResponse(BaseModel):
    """
    App Service error response.
    """ # noqa: E501
    error: Optional[ProviderGetAvailableStacksDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ProviderGetAvailableStacksDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
