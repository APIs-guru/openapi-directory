...
class UpdateLocationList(BaseModel):
    """
    The list of update locations.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to get the next page of update locations.", alias="nextLink")
    value: Optional[List[UpdateLocation]] = Field(default=None, description="The list of update locations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UpdateLocation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
