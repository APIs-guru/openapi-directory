...
**details** | [**List[CloudErrorBody]**](CloudErrorBody.md) | Extra error information | [optional] 
**message** | **str** | A description of what caused the error | [optional] 
**target** | **str** | The target resource of the error message | [optional] 
