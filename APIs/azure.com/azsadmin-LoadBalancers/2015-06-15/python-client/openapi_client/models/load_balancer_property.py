...
class LoadBalancerProperty(BaseModel):
    """
    Properties of a load balancer.
    """ # noqa: E501
    public_ip_addresses: Optional[List[StrictStr]] = Field(default=None, description="List of public IP addresses.", alias="publicIpAddresses")
