...
class LoadBalancerList(BaseModel):
    ...
    value: Optional[List[LoadBalancer]] = Field(default=None, description="List of load balancers for this page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LoadBalancer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
