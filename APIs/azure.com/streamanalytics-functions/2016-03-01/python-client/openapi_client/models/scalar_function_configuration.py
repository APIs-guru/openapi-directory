...
class ScalarFunctionConfiguration(BaseModel):
    """
    Describes the configuration of the scalar function.
    """ # noqa: E501
    binding: Optional[FunctionBinding] = None
    inputs: Optional[List[FunctionInput]] = Field(default=None, description="A list of inputs describing the parameters of the function.")
    output: Optional[FunctionOutput] = None
    __properties: ClassVar[List[str]] = ["binding", "inputs", "output"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "binding": FunctionBinding.from_dict(obj["binding"]) if obj.get("binding") is not None else None,
            "inputs": [FunctionInput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
            "output": FunctionOutput.from_dict(obj["output"]) if obj.get("output") is not None else None
        })
        return _obj
