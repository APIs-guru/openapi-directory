...
# **metric_baseline_get**
> BaselineResponse metric_baseline_get(resource_uri, metric_name, api_version, timespan=timespan, interval=interval, aggregation=aggregation, sensitivities=sensitivities, result_type=result_type)
