...
class BaselineResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="the metric baseline Id.")
    name: Optional[LocalizableString] = None
    properties: Optional[BaselineProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="the resource type of the baseline resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": BaselineProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
