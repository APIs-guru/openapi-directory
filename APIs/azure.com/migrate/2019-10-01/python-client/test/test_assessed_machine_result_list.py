...
class TestAssessedMachineResultList(unittest.TestCase):
    """AssessedMachineResultList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssessedMachineResultList:
        """Test AssessedMachineResultList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssessedMachineResultList`
        """
        model = AssessedMachineResultList()
        if include_optional:
            return AssessedMachineResultList(
                next_link = '',
                value = [
                    openapi_client.models.assessed_machine.AssessedMachine(
                        e_tag = '', 
                        id = '', 
                        name = '', 
    ...
    def testAssessedMachineResultList(self):
        """Test AssessedMachineResultList"""
