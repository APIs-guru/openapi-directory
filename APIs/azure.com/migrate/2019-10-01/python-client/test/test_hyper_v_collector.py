...
class TestHyperVCollector(unittest.TestCase):
    """HyperVCollector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HyperVCollector:
        """Test HyperVCollector
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HyperVCollector`
        """
        model = HyperVCollector()
        if include_optional:
