...
class NetworkAdapter(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="User friendly name of the network adapter.", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "ipAddresses", "macAddress"]
