...
class AssessmentResultList(BaseModel):
    """
    List of assessments.
    """ # noqa: E501
    value: Optional[List[Assessment]] = Field(default=None, description="List of assessments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Assessment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
