...
class VMwareCollectorList(BaseModel):
    """
    List of VMware collectors.
    """ # noqa: E501
    value: Optional[List[VMwareCollector]] = Field(default=None, description="List of VMware collectors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VMwareCollector.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
