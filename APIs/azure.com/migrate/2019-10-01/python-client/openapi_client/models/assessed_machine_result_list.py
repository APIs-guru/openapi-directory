...
class AssessedMachineResultList(BaseModel):
    """
    List of assessed machines.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, alias="nextLink")
    value: Optional[List[AssessedMachine]] = Field(default=None, description="List of assessed machines.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AssessedMachine.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
