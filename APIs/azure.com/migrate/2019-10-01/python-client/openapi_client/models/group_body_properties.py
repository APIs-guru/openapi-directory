...
class GroupBodyProperties(BaseModel):
    """
    Body properties of group update.
    """ # noqa: E501
    machines: Optional[List[StrictStr]] = Field(default=None, description="List of machine names that are part of this group.")
    operation_type: Optional[StrictStr] = Field(default=None, description="Whether to add or remove the machines.", alias="operationType")
    __properties: ClassVar[List[str]] = ["machines", "operationType"]
