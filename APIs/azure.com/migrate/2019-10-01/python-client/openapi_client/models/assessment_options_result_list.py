...
class AssessmentOptionsResultList(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[AssessmentOptions]] = Field(default=None, description="List of operations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [AssessmentOptions.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
