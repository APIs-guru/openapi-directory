...
class AssessedDisk(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="User friendly name of the assessed disk.", alias="displayName")
    ...
    suitability_detail: Optional[StrictStr] = Field(default=None, description="If disk is suitable to be migrate but some conditions/checks were not considered while calculating suitability, this explains the details.", alias="suitabilityDetail")
    suitability_explanation: Optional[StrictStr] = Field(default=None, description="If disk is not suitable to be migrated, this explains the reasons and mitigation steps.", alias="suitabilityExplanation")
    __properties: ClassVar[List[str]] = ["displayName", "gigabytesForRecommendedDiskSize", "gigabytesProvisioned", "megabytesPerSecondOfRead", "megabytesPerSecondOfWrite", "monthlyStorageCost", "name", "numberOfReadOperationsPerSecond", "numberOfWriteOperationsPerSecond", "recommendedDiskSize", "recommendedDiskType", "suitability", "suitabilityDetail", "suitabilityExplanation"]
    ...
    def suitability_explanation_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'NotApplicable', 'DiskSizeGreaterThanSupported', 'NoSuitableDiskSizeForIops', 'NoSuitableDiskSizeForThroughput', 'NoDiskSizeFoundInSelectedLocation', 'NoDiskSizeFoundForSelectedRedundancy', 'InternalErrorOccurredForDiskEvaluation', 'NoEaPriceFoundForDiskSize']):
            raise ValueError("must be one of enum values ('Unknown', 'NotApplicable', 'DiskSizeGreaterThanSupported', 'NoSuitableDiskSizeForIops', 'NoSuitableDiskSizeForThroughput', 'NoDiskSizeFoundInSelectedLocation', 'NoDiskSizeFoundForSelectedRedundancy', 'InternalErrorOccurredForDiskEvaluation', 'NoEaPriceFoundForDiskSize')")
        return value
