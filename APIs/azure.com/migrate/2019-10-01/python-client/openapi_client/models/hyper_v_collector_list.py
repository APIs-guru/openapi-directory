...
class HyperVCollectorList(BaseModel):
    """
    List of Hyper-V collectors.
    """ # noqa: E501
    value: Optional[List[HyperVCollector]] = Field(default=None, description="List of Hyper-V collectors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [HyperVCollector.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
