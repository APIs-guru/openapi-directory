...
**id** | **str** | Path reference to this assessed machine. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/assessments/{assessmentName}/assessedMachines/{assessedMachineName} | [optional] [readonly] 
**name** | **str** | Name of the machine. | [optional] [readonly] 
**properties** | [**AssessedMachineProperties**](AssessedMachineProperties.md) |  | [optional] 
**type** | **str** | Type of the object &#x3D; [Microsoft.Migrate/assessmentProjects/groups/assessments/assessedMachines]. | [optional] [readonly] 
