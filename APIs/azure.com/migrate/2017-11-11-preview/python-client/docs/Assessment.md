...
**id** | **str** | Path reference to this assessment. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/projects/{projectName}/groups/{groupName}/assessment/{assessmentName} | [optional] [readonly] 
**name** | **str** | Unique name of an assessment. | [optional] [readonly] 
**properties** | [**AssessmentProperties**](AssessmentProperties.md) |  | 
**type** | **str** | Type of the object &#x3D; [Microsoft.Migrate/projects/groups/assessments]. | [optional] [readonly] 
