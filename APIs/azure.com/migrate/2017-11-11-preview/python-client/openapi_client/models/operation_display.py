...
class OperationDisplay(BaseModel):
    ...
    provider: Optional[StrictStr] = Field(default=None, description="Provider of the operation.")
    resource: Optional[StrictStr] = Field(default=None, description="Resource operated on by the operation.")
