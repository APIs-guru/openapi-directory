...
class AssessmentProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["azureHybridUseBenefit", "azureLocation", "azureOfferCode", "azurePricingTier", "azureStorageRedundancy", "createdTimestamp", "currency", "discountPercentage", "monthlyBandwidthCost", "monthlyComputeCost", "monthlyStorageCost", "numberOfMachines", "percentile", "pricesTimestamp", "scalingFactor", "stage", "status", "timeRange", "updatedTimestamp"]
    ...
    def azure_offer_code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Unknown', 'MSAZR0003P', 'MSAZR0044P', 'MSAZR0059P', 'MSAZR0060P', 'MSAZR0062P', 'MSAZR0063P', 'MSAZR0064P', 'MSAZR0029P', 'MSAZR0022P', 'MSAZR0023P', 'MSAZR0148P', 'MSAZR0025P', 'MSAZR0036P', 'MSAZR0120P', 'MSAZR0121P', 'MSAZR0122P', 'MSAZR0123P', 'MSAZR0124P', 'MSAZR0125P', 'MSAZR0126P', 'MSAZR0127P', 'MSAZR0128P', 'MSAZR0129P', 'MSAZR0130P', 'MSAZR0111P', 'MSAZR0144P', 'MSAZR0149P']):
    ...
    def currency_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Unknown', 'USD', 'DKK', 'CAD', 'IDR', 'JPY', 'KRW', 'NZD', 'NOK', 'RUB', 'SAR', 'ZAR', 'SEK', 'TRY', 'GBP', 'MXN', 'MYR', 'INR', 'HKD', 'BRL', 'TWD', 'EUR', 'CHF', 'ARS', 'AUD']):
            raise ValueError("must be one of enum values ('Unknown', 'USD', 'DKK', 'CAD', 'IDR', 'JPY', 'KRW', 'NZD', 'NOK', 'RUB', 'SAR', 'ZAR', 'SEK', 'TRY', 'GBP', 'MXN', 'MYR', 'INR', 'HKD', 'BRL', 'TWD', 'EUR', 'CHF', 'ARS', 'AUD')")
        return value
