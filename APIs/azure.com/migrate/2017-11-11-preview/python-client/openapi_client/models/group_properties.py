...
class GroupProperties(BaseModel):
    ...
    machines: List[StrictStr] = Field(description="List of machine names that are part of this group.")
    ...
    __properties: ClassVar[List[str]] = ["assessments", "createdTimestamp", "machines", "updatedTimestamp"]
