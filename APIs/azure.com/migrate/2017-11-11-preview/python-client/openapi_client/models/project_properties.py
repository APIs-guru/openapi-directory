...
class ProjectProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdTimestamp", "customerWorkspaceId", "discoveryStatus", "numberOfAssessments", "numberOfGroups", "numberOfMachines", "provisioningState", "updatedTimestamp"]
