                ...
                properties = openapi_client.models.assessed_machine_properties.AssessedMachineProperties(
                    ...
                    disks = {
                        'key' : openapi_client.models.assessed_disk.AssessedDisk(
                            ...
                            megabytes_per_second_of_read_data_points_expected = 56, 
                            megabytes_per_second_of_read_data_points_received = 56, 
                            megabytes_per_second_of_write = 1.337, 
                            megabytes_per_second_of_write_data_points_expected = 56, 
                            megabytes_per_second_of_write_data_points_received = 56, 
                            monthly_storage_cost = 1.337, 
                            name = '', 
                            number_of_read_operations_per_second = 1.337, 
                            number_of_read_operations_per_second_data_points_expected = 56, 
                            number_of_read_operations_per_second_data_points_received = 56, 
                            number_of_write_operations_per_second = 1.337, 
                            number_of_write_operations_per_second_data_points_expected = 56, 
                            number_of_write_operations_per_second_data_points_received = 56, 
                    ...
                    network_adapters = {
                        'key' : openapi_client.models.assessed_network_adapter.AssessedNetworkAdapter(
                            ...
                            megabytes_per_second_received_data_points_expected = 56, 
                            megabytes_per_second_transmitted = 1.337, 
                            megabytes_per_second_transmitted_data_points_expected = 56, 
                            megabytes_per_second_transmitted_data_points_received = 56, 
                    ...
                    percentage_cores_utilization_data_points_expected = 56, 
                    percentage_cores_utilization_data_points_received = 56, 
                    percentage_memory_utilization = 1.337, 
                    percentage_memory_utilization_data_points_expected = 56, 
                    percentage_memory_utilization_data_points_received = 56, 
