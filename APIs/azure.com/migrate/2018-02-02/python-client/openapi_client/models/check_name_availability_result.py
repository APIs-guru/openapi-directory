...
class CheckNameAvailabilityResult(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(default=None, description="Gets the reason that a project name could not be used. The Reason element is only returned if NameAvailable is false.")
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['Available', 'Invalid', 'AlreadyExists']):
            raise ValueError("must be one of enum values ('Available', 'Invalid', 'AlreadyExists')")
        return value
