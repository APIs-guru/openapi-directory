...
class GroupResultList(BaseModel):
    ...
    List of groups.
    """ # noqa: E501
    value: Optional[List[Group]] = Field(default=None, description="List of groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Group.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
