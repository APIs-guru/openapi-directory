...
class Disk(BaseModel):
    ...
    """ # noqa: E501
    gigabytes_allocated: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gigabytes of storage provisioned for this disk.", alias="gigabytesAllocated")
    ...
    __properties: ClassVar[List[str]] = ["gigabytesAllocated", "gigabytesConsumed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gigabytesAllocated": obj.get("gigabytesAllocated"),
