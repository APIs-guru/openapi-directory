...
class LargePersonGroup(BaseModel):
    """
    Large person group object.
    """ # noqa: E501
    large_person_group_id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="LargePersonGroupId of the target large person groups", alias="largePersonGroupId")
