...
class UpdateFaceRequest(BaseModel):
    ...
    """ # noqa: E501
    user_data: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="User-provided data attached to the face. The size limit is 1KB.", alias="userData")
