...
class LargeFaceList(BaseModel):
    """
    Large face list object.
    """ # noqa: E501
    large_face_list_id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="LargeFaceListId of the target large face list.", alias="largeFaceListId")
