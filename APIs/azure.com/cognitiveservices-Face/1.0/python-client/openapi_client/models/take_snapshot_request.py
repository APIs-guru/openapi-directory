...
class TakeSnapshotRequest(BaseModel):
    ...
    object_id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="User specified source object id to take snapshot from.", alias="objectId")
    type: StrictStr = Field(description="User specified type for the source object to take snapshot from. Currently FaceList, PersonGroup, LargeFaceList and LargePersonGroup are supported.")
    ...
    __properties: ClassVar[List[str]] = ["applyScope", "objectId", "type", "userData"]
