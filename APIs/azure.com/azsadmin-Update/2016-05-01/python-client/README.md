...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UpdatesApi->operations_list:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling UpdatesApi->operations_list: %s\n" % e)
...
------------ | ------------- | ------------- | -------------
*UpdatesApi* | [**operations_list**](docs/UpdatesApi.md#operations_list) | **GET** /providers/Microsoft.Update.Admin/operations | 
