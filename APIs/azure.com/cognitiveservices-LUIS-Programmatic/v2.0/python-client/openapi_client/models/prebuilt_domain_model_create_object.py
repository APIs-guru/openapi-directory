...
class PrebuiltDomainModelCreateObject(BaseModel):
    """
    ...
    model_name: Optional[StrictStr] = Field(default=None, description="The intent name or entity name.", alias="modelName")
    __properties: ClassVar[List[str]] = ["domainName", "modelName"]
