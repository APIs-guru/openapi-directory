...
class PrebuiltDomainCreateObject(BaseModel):
    """
    A prebuilt domain create object containing the name and culture of the domain.
    """ # noqa: E501
    culture: Optional[StrictStr] = Field(default=None, description="The culture of the new domain.")
    domain_name: Optional[StrictStr] = Field(default=None, description="The domain name.", alias="domainName")
    __properties: ClassVar[List[str]] = ["culture", "domainName"]
