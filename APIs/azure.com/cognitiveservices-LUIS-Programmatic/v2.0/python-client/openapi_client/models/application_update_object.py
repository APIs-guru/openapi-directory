...
class ApplicationUpdateObject(BaseModel):
    """
    Object model for updating the name or description of an application.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The application's new description.")
    name: Optional[StrictStr] = Field(default=None, description="The application's new name.")
