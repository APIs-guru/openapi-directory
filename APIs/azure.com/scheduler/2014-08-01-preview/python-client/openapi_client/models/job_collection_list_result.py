...
class JobCollectionListResult(BaseModel):
    """
    JobCollectionListResult
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the URL to get the next set of job collections.", alias="nextLink")
    value: Optional[List[JobCollectionDefinition]] = Field(default=None, description="Gets the job collections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [JobCollectionDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
