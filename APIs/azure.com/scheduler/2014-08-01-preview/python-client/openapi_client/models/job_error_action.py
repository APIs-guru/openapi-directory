...
class JobErrorAction(BaseModel):
    """
    JobErrorAction
    """ # noqa: E501
    ...
    type: Optional[StrictStr] = Field(default=None, description="Gets or sets the job error action type.")
    __properties: ClassVar[List[str]] = ["queueMessage", "request", "retryPolicy", "serviceBusQueueMessage", "serviceBusTopicMessage", "type"]
