...
class JobRecurrenceScheduleMonthlyOccurrence(BaseModel):
    """
    JobRecurrenceScheduleMonthlyOccurrence
    """ # noqa: E501
    occurrence: Optional[StrictInt] = Field(default=None, description="Gets or sets the occurrence. Must be between -5 and 5.", alias="Occurrence")
    day: Optional[StrictStr] = Field(default=None, description="Gets or sets the day. Must be one of monday, tuesday, wednesday, thursday, friday, saturday, sunday.")
    __properties: ClassVar[List[str]] = ["Occurrence", "day"]
