...
class StorageQueueMessage(BaseModel):
    """
    StorageQueueMessage
    """ # noqa: E501
    ...
    sas_token: Optional[StrictStr] = Field(default=None, description="Gets or sets the SAS key.", alias="sasToken")
    storage_account: Optional[StrictStr] = Field(default=None, description="Gets or sets the storage account name.", alias="storageAccount")
    __properties: ClassVar[List[str]] = ["message", "queueName", "sasToken", "storageAccount"]
