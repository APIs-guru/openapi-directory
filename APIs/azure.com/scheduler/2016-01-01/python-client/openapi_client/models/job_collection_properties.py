...
class JobCollectionProperties(BaseModel):
    """
    JobCollectionProperties
    """ # noqa: E501
    quota: Optional[JobCollectionQuota] = None
    sku: Optional[Sku] = None
    state: Optional[StrictStr] = Field(default=None, description="Gets or sets the state.")
    __properties: ClassVar[List[str]] = ["quota", "sku", "state"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['Enabled', 'Disabled', 'Suspended', 'Deleted']):
            raise ValueError("must be one of enum values ('Enabled', 'Disabled', 'Suspended', 'Deleted')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quota": JobCollectionQuota.from_dict(obj["quota"]) if obj.get("quota") is not None else None,
