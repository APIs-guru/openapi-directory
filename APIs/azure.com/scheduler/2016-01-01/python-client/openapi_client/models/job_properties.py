...
class JobProperties(BaseModel):
    ...
    start_time: Optional[datetime] = Field(default=None, description="Gets or sets the job start time.", alias="startTime")
    state: Optional[JobState] = None
    status: Optional[JobStatus] = None
    __properties: ClassVar[List[str]] = ["action", "recurrence", "startTime", "state", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": JobAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "recurrence": JobRecurrence.from_dict(obj["recurrence"]) if obj.get("recurrence") is not None else None,
