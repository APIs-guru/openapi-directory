...
class TestJobErrorAction(unittest.TestCase):
    """JobErrorAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobErrorAction:
        """Test JobErrorAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobErrorAction`
        """
        model = JobErrorAction()
        if include_optional:
