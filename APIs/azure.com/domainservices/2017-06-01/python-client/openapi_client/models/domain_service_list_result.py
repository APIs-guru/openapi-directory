...
class DomainServiceListResult(BaseModel):
    """
    ...
    value: Optional[List[DomainService]] = Field(default=None, description="the list of domain services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DomainService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
