...
class TestDomainServiceListResult(unittest.TestCase):
    """DomainServiceListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainServiceListResult:
        """Test DomainServiceListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainServiceListResult`
        """
        model = DomainServiceListResult()
        if include_optional:
            return DomainServiceListResult(
                next_link = '',
                value = [
                    openapi_client.models.domain_service.DomainService(
                        properties = openapi_client.models.domain_service_properties.DomainServiceProperties(
                            ...
                            provisioning_state = '', 
                            replica_sets = [
                                openapi_client.models.replica_set.ReplicaSet(
    ...
    def testDomainServiceListResult(self):
        """Test DomainServiceListResult"""
