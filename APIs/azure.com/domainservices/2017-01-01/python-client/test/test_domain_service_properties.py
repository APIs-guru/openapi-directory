...
class TestDomainServiceProperties(unittest.TestCase):
    """DomainServiceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainServiceProperties:
        """Test DomainServiceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainServiceProperties`
        """
        model = DomainServiceProperties()
        if include_optional:
            return DomainServiceProperties(
    ...
    def testDomainServiceProperties(self):
        """Test DomainServiceProperties"""
