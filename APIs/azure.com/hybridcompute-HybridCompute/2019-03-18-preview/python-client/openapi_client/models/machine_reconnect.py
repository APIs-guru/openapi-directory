...
class MachineReconnect(BaseModel):
    """
    Describes a hybrid machine reconnect.
    """ # noqa: E501
    properties: Optional[MachineReconnectProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": MachineReconnectProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
