...
class OSProfile(BaseModel):
    ...
    """ # noqa: E501
    computer_name: Optional[StrictStr] = Field(default=None, description="Specifies the host OS name of the hybrid machine.", alias="computerName")
    __properties: ClassVar[List[str]] = ["computerName"]
