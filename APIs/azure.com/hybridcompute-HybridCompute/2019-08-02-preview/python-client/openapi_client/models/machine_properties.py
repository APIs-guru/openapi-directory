...
class MachineProperties(BaseModel):
    ...
    extensions: Optional[List[MachineExtensionInstanceView]] = Field(default=None, description="Machine Extensions information")
    ...
    __properties: ClassVar[List[str]] = ["agentVersion", "clientPublicKey", "displayName", "errorDetails", "extensions", "lastStatusChange", "machineFqdn", "osName", "osProfile", "osVersion", "physicalLocation", "provisioningState", "status", "vmId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extensions": [MachineExtensionInstanceView.from_dict(_item) for _item in obj["extensions"]] if obj.get("extensions") is not None else None,
