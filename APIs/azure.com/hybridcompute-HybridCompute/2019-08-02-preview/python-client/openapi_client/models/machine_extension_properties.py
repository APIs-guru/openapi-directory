...
class MachineExtensionProperties(BaseModel):
    """
    ...
    instance_view: Optional[MachineExtensionInstanceView] = Field(default=None, alias="instanceView")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instanceView": MachineExtensionInstanceView.from_dict(obj["instanceView"]) if obj.get("instanceView") is not None else None,
