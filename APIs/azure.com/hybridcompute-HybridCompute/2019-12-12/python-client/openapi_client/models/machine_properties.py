...
class MachineProperties(BaseModel):
    ...
    os_profile: Optional[OSProfile] = Field(default=None, description="Specifies the operating system settings for the hybrid machine.", alias="osProfile")
    ...
    __properties: ClassVar[List[str]] = ["agentVersion", "clientPublicKey", "displayName", "errorDetails", "extensions", "lastStatusChange", "locationData", "machineFqdn", "osName", "osProfile", "osVersion", "provisioningState", "status", "vmId"]
