...
class OperationsListDefaultResponse(BaseModel):
    ...
    """ # noqa: E501
    additional_info: Optional[List[OperationsListDefaultResponseAdditionalInfoInner]] = Field(default=None, description="The error additional info.", alias="additionalInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalInfo": [OperationsListDefaultResponseAdditionalInfoInner.from_dict(_item) for _item in obj["additionalInfo"]] if obj.get("additionalInfo") is not None else None,
            "code": obj.get("code"),
