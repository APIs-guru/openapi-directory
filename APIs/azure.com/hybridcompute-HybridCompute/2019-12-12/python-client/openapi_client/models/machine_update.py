...
class MachineUpdate(BaseModel):
    ...
    """ # noqa: E501
    identity: Optional[object] = Field(default=None, description="Hybrid Compute Machine Managed Identity")
    properties: Optional[MachineUpdateProperties] = Field(default=None, description="Hybrid Compute Machine properties")
