...
------------ | ------------- | ------------- | -------------
*NodeCountInformationApi* | [**node_count_information_get**](docs/NodeCountInformationApi.md#node_count_information_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/nodecounts/{countType} | 


## Documentation For Models

 - [NodeCount](docs/NodeCount.md)
 - [NodeCountInformationGetDefaultResponse](docs/NodeCountInformationGetDefaultResponse.md)
 - [NodeCountProperties](docs/NodeCountProperties.md)
