...
class NodeCounts(BaseModel):
    ...
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, description="Gets the total number of records matching countType criteria.", alias="totalCount")
    value: Optional[List[NodeCount]] = Field(default=None, description="Gets an array of counts")
    __properties: ClassVar[List[str]] = ["totalCount", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [NodeCount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
