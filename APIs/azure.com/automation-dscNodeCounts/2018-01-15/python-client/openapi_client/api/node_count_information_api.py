...
class NodeCountInformationApi:
    ...
    @validate_call
    def node_count_information_get(
        self,
        ...
        count_type: Annotated[StrictStr, Field(description="The type of counts to retrieve")],
        ...
        :param count_type: The type of counts to retrieve (required)
        :type count_type: str
        ...
        _param = self._node_count_information_get_serialize(
    ...
    @validate_call
    def node_count_information_get_with_http_info(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        count_type: Annotated[StrictStr, Field(description="The type of counts to retrieve")],
    ...
    @validate_call
    def node_count_information_get_without_preload_content(
        self,
        resource_group_name: Annotated[str, Field(min_length=1, strict=True, max_length=90, description="Name of an Azure Resource group.")],
        automation_account_name: Annotated[StrictStr, Field(description="The name of the automation account.")],
        count_type: Annotated[StrictStr, Field(description="The type of counts to retrieve")],
    ...
    def _node_count_information_get_serialize(
        self,
        resource_group_name,
        ...
        if count_type is not None:
            _path_params['countType'] = count_type
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/nodecounts/{countType}',
