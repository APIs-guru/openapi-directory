...
class QuotaByCounterKeysApi:
    ...
    def quota_by_counter_keys_list_by_service(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QuotaByCounterKeysListByService200Response",
        }
    ...
    def quota_by_counter_keys_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QuotaByCounterKeysListByService200Response]:
        """quota_by_counter_keys_list_by_service
    ...
    def quota_by_counter_keys_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[QuotaByCounterKeysListByService200ResponseValueInnerValue, Field(description="The value of the quota counter to be applied to all quota counter periods.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
