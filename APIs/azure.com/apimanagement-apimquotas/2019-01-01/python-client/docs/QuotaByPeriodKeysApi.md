...
> QuotaByCounterKeysListByService200ResponseValueInner quota_by_period_keys_get(resource_group_name, service_name, quota_counter_key, quota_period_key, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.quota_by_period_keys_get(resource_group_name, service_name, quota_counter_key, quota_period_key, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Version of the API to be used with the client request.
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.QuotaByCounterKeysListByService200ResponseValueInnerValue() # QuotaByCounterKeysListByService200ResponseValueInnerValue | The value of the Quota counter to be applied on the specified period.
