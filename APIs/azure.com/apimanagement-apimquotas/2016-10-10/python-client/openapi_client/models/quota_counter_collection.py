...
class QuotaCounterCollection(BaseModel):
    """
    ...
    value: Optional[List[QuotaCounterContract]] = Field(default=None, description="Quota counter values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [QuotaCounterContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
