...
class QuotaByPeriodKeysApi:
    ...
    def quota_by_period_keys_get(
        ...
        quota_counter_key: Annotated[StrictStr, Field(description="Quota counter key identifier.")],
        ...
        :param quota_counter_key: Quota counter key identifier. (required)
    ...
    def _quota_by_period_keys_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}',
    ...
    def quota_by_period_keys_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[QuotaCounterValueContract, Field(description="The value of the Quota counter to be applied on the specified period.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: QuotaCounterValueContract
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
