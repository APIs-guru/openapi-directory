...
class QuotaByCounterKeysListByService200Response(BaseModel):
    """
    ...
    value: Optional[List[QuotaByCounterKeysListByService200ResponseValueInner]] = Field(default=None, description="Quota counter values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [QuotaByCounterKeysListByService200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
