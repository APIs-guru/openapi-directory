...
class DataSourceListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link (url) to the next page of datasources.", alias="nextLink")
    value: Optional[List[DataSource]] = Field(default=None, description="A list of datasources.")
