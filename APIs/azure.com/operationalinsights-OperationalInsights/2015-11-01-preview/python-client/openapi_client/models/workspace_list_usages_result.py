...
class WorkspaceListUsagesResult(BaseModel):
    """
    The list workspace usages operation response.
    """ # noqa: E501
    value: Optional[List[UsageMetric]] = Field(default=None, description="Gets or sets a list of usage metrics for a workspace.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [UsageMetric.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
