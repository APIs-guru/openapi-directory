...
class LinkedServiceListResult(BaseModel):
    """
    The list linked service operation response.
    """ # noqa: E501
    value: Optional[List[LinkedService]] = Field(default=None, description="Gets or sets a list of linked service instances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [LinkedService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
