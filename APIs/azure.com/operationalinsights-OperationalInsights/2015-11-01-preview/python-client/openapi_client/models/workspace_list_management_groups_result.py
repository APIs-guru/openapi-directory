...
class WorkspaceListManagementGroupsResult(BaseModel):
    """
    The list workspace management groups operation response.
    """ # noqa: E501
    value: Optional[List[ManagementGroup]] = Field(default=None, description="Gets or sets a list of management groups attached to the workspace.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ManagementGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
