...
class TestSearchGetSchemaResponse(unittest.TestCase):
    """SearchGetSchemaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchGetSchemaResponse:
        """Test SearchGetSchemaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchGetSchemaResponse`
        """
        ...
        if include_optional:
            return SearchGetSchemaResponse(
                metadata = openapi_client.models.search_metadata.SearchMetadata(
                    ...
                    total = 56, ),
                value = [
                    openapi_client.models.search_schema_value.SearchSchemaValue(
                        display_name = '', 
                        facet = True, 
                        indexed = True, 
                        name = '', 
    ...
    def testSearchGetSchemaResponse(self):
        """Test SearchGetSchemaResponse"""
