...
class SavedSearchesListResult(BaseModel):
    """
    The saved search list operation response.
    """ # noqa: E501
    metadata: Optional[SearchMetadata] = Field(default=None, alias="__metadata")
    value: Optional[List[SavedSearch]] = Field(default=None, description="The array of result values.")
    __properties: ClassVar[List[str]] = ["__metadata", "value"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.metadata:
            _dict['__metadata'] = self.metadata.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "__metadata": SearchMetadata.from_dict(obj["__metadata"]) if obj.get("__metadata") is not None else None,
            "value": [SavedSearch.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
