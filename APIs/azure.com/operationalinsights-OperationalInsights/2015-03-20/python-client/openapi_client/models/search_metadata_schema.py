...
class SearchMetadataSchema(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the metadata schema.")
    version: Optional[StrictInt] = Field(default=None, description="The version of the metadata schema.")
