...
class SearchSort(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the field the search query is sorted on.")
    order: Optional[StrictStr] = Field(default=None, description="The sort order of the search.")
