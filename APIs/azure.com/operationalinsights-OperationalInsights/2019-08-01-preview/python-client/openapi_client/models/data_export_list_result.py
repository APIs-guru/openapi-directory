...
class DataExportListResult(BaseModel):
    """
    Result of the request to list data exports.
    """ # noqa: E501
    value: Optional[List[DataExport]] = Field(default=None, description="List of data export instances within a workspace..")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DataExport.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
