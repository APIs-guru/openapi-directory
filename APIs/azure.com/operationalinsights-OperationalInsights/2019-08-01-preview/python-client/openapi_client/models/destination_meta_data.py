...
class DestinationMetaData(BaseModel):
    ...
    """ # noqa: E501
    event_hub_name: Optional[StrictStr] = Field(default=None, description="Optional. Allows to define an Event Hub name. Not applicable when destination is Storage Account.", alias="eventHubName")
    __properties: ClassVar[List[str]] = ["eventHubName"]
