...
class DiagnosticDetectorResponse(BaseModel):
    """
    Class representing Response from Diagnostic Detectors
    """ # noqa: E501
    properties: Optional[object] = Field(default=None, description="DiagnosticDetectorResponse resource specific properties")
