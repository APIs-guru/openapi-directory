...
> DiagnosticAnalysis diagnostics_get_site_analysis(resource_group_name, site_name, diagnostic_category, analysis_name, subscription_id, api_version)
...
> DiagnosticAnalysis diagnostics_get_site_analysis_slot(resource_group_name, site_name, diagnostic_category, analysis_name, slot, subscription_id, api_version)
...
> DiagnosticDetectorCollection diagnostics_get_site_detector(resource_group_name, site_name, diagnostic_category, detector_name, subscription_id, api_version)
...
> DiagnosticDetectorCollection diagnostics_get_site_detector_slot(resource_group_name, site_name, diagnostic_category, detector_name, slot, subscription_id, api_version)
