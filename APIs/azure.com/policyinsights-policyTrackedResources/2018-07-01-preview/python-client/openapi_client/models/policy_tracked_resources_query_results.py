...
class PolicyTrackedResourcesQueryResults(BaseModel):
    """
    Query results.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of results.", alias="nextLink")
    value: Optional[List[PolicyTrackedResource]] = Field(default=None, description="Query results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicyTrackedResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
