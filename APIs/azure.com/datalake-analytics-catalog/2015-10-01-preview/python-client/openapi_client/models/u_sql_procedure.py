...
class USqlProcedure(BaseModel):
    ...
    definition: Optional[StrictStr] = Field(default=None, description="the defined query of the procedure.")
    proc_name: Optional[StrictStr] = Field(default=None, description="the name of the procedure.", alias="procName")
    schema_name: Optional[StrictStr] = Field(default=None, description="the name of the schema associated with this procedure and database.", alias="schemaName")
