...
class USqlView(BaseModel):
    ...
    definition: Optional[StrictStr] = Field(default=None, description="the defined query of the view.")
    schema_name: Optional[StrictStr] = Field(default=None, description="the name of the schema associated with this view and database.", alias="schemaName")
    view_name: Optional[StrictStr] = Field(default=None, description="the name of the view.", alias="viewName")
