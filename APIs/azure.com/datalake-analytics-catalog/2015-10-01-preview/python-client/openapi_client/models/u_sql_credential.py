...
class USqlCredential(BaseModel):
    """
    A Data Lake Analytics catalog U-SQL credential item.
    """ # noqa: E501
    credential_name: Optional[StrictStr] = Field(default=None, description="the name of the credential.", alias="credentialName")
    database_name: Optional[StrictStr] = Field(default=None, description="the name of the database the credential is in.", alias="databaseName")
    identity: Optional[StrictStr] = Field(default=None, description="the name of the secret associated with the credential.")
    user_name: Optional[StrictStr] = Field(default=None, description="the user name associated with the credential.", alias="userName")
