...
class USqlDirectedColumn(BaseModel):
    """
    A Data Lake Analytics catalog U-SQL directed column item.
    """ # noqa: E501
    descending: Optional[StrictBool] = Field(default=None, description="the switch indicating if the index is descending or not.")
    name: Optional[StrictStr] = Field(default=None, description="the name of the index in the table.")
    __properties: ClassVar[List[str]] = ["descending", "name"]
