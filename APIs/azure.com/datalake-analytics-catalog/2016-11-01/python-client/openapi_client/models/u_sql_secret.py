...
class USqlSecret(BaseModel):
    """
    A Data Lake Analytics catalog U-SQL secret item.
    """ # noqa: E501
    creation_time: Optional[datetime] = Field(default=None, description="the creation time of the credential object. This is the only information returned about a secret from a GET.", alias="creationTime")
    database_name: Optional[StrictStr] = Field(default=None, description="the name of the database.", alias="databaseName")
    password: Optional[StrictStr] = Field(default=None, description="the password for the secret to pass in")
    secret_name: Optional[StrictStr] = Field(default=None, description="the name of the secret.", alias="secretName")
