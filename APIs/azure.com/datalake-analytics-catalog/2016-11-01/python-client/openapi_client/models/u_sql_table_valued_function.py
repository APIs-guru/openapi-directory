...
class USqlTableValuedFunction(BaseModel):
    """
    ...
    definition: Optional[StrictStr] = Field(default=None, description="the definition of the table valued function.")
    schema_name: Optional[StrictStr] = Field(default=None, description="the name of the schema associated with this database.", alias="schemaName")
    tvf_name: Optional[StrictStr] = Field(default=None, description="the name of the table valued function.", alias="tvfName")
