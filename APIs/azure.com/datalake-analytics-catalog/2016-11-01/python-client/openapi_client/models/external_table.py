...
class ExternalTable(BaseModel):
    ...
    """ # noqa: E501
    data_source: Optional[EntityId] = Field(default=None, alias="dataSource")
    table_name: Optional[StrictStr] = Field(default=None, description="the name of the table associated with this database and schema.", alias="tableName")
    __properties: ClassVar[List[str]] = ["dataSource", "tableName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataSource": EntityId.from_dict(obj["dataSource"]) if obj.get("dataSource") is not None else None,
