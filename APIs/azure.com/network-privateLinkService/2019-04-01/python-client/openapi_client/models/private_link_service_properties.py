...
class PrivateLinkServiceProperties(BaseModel):
    ...
    ip_configurations: Optional[List[PrivateLinkServiceIpConfiguration]] = Field(default=None, description="An array of references to the private link service IP configuration.", alias="ipConfigurations")
    ...
    network_interfaces: Optional[List[PrivateLinkServicePropertiesNetworkInterfacesInner]] = Field(default=None, description="Gets an array of references to the network interfaces created for this private link service.", alias="networkInterfaces")
