...
class PrivateLinkServiceIpConfiguration(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of private link service ip configuration.")
    properties: Optional[PrivateLinkServiceIpConfigurationProperties] = None
