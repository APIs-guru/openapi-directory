...
class AutoApprovedPrivateLinkServicesResult(BaseModel):
    """
    ...
    value: Optional[List[AutoApprovedPrivateLinkService]] = Field(default=None, description="An array of auto approved private link service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AutoApprovedPrivateLinkService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
