...
class PrivateEndpointConnectionProperties(BaseModel):
    ...
    """ # noqa: E501
    private_endpoint: Optional[PrivateEndpointConnectionPropertiesPrivateEndpoint] = Field(default=None, alias="privateEndpoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privateEndpoint": PrivateEndpointConnectionPropertiesPrivateEndpoint.from_dict(obj["privateEndpoint"]) if obj.get("privateEndpoint") is not None else None,
