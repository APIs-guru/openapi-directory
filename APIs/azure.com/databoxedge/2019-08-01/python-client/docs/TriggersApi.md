...
> TriggerList triggers_list_by_data_box_edge_device(device_name, subscription_id, resource_group_name, api_version, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    resource_group_name = 'resource_group_name_example' # str | The resource group name.
    api_version = 'api_version_example' # str | The API version.
    filter = 'filter_example' # str | Specify $filter='CustomContextTag eq <tag>' to filter on custom context tag property (optional)

    try:
        api_response = api_instance.triggers_list_by_data_box_edge_device(device_name, subscription_id, resource_group_name, api_version, filter=filter)
 ...
 **resource_group_name** | **str**| The resource group name. | 
 **api_version** | **str**| The API version. | 
 **filter** | **str**| Specify $filter&#x3D;&#39;CustomContextTag eq &lt;tag&gt;&#39; to filter on custom context tag property | [optional] 
