...
class DataBoxEdgeDevicePatch(BaseModel):
    """
    The Data Box Edge/Gateway device patch.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The tags attached to the Data Box Edge/Gateway resource.")
