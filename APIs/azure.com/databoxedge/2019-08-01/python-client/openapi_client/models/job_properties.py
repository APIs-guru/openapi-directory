...
class JobProperties(BaseModel):
    ...
    folder: Optional[StrictStr] = Field(default=None, description="If only subfolders need to be refreshed, then the subfolder path inside the share or container. (The path is empty if there are no subfolders.)")
    ...
    refreshed_entity_id: Optional[StrictStr] = Field(default=None, description="ARM ID of the entity that was refreshed.", alias="refreshedEntityId")
    ...
    __properties: ClassVar[List[str]] = ["currentStage", "downloadProgress", "errorManifestFile", "folder", "installProgress", "jobType", "refreshedEntityId", "totalRefreshErrors"]
    ...
    def job_type_validate_enum(cls, value):
        ...
        if value not in set(['Invalid', 'ScanForUpdates', 'DownloadUpdates', 'InstallUpdates', 'RefreshShare', 'RefreshContainer']):
            raise ValueError("must be one of enum values ('Invalid', 'ScanForUpdates', 'DownloadUpdates', 'InstallUpdates', 'RefreshShare', 'RefreshContainer')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refreshedEntityId": obj.get("refreshedEntityId"),
