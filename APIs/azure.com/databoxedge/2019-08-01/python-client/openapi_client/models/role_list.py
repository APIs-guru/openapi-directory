...
class RoleList(BaseModel):
    ...
    value: Optional[List[Role]] = Field(default=None, description="The Value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Role.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
