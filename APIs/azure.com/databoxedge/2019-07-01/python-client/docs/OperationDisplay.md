...
------------ | ------------- | ------------- | -------------
**description** | **str** | Description of the operation to be performed. | [optional] 
**operation** | **str** | Operation to be performed on the resource. | [optional] 
**provider** | **str** | Provider name. | [optional] 
**resource** | **str** | The type of resource in which the operation is performed. | [optional] 
