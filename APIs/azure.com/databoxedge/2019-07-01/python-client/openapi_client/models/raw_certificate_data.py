...
class RawCertificateData(BaseModel):
    """
    ...
    certificate: StrictStr = Field(description="The base64 encoded certificate raw data.")
    __properties: ClassVar[List[str]] = ["authenticationType", "certificate"]
