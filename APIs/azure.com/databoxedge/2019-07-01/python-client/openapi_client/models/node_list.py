...
class NodeList(BaseModel):
    ...
    Collection of Nodes.
    """ # noqa: E501
    value: Optional[List[Node]] = Field(default=None, description="The list of Nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Node.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
