...
class DataBoxEdgeDeviceProperties(BaseModel):
    ...
    node_count: Optional[StrictInt] = Field(default=None, description="The number of nodes in the cluster.", alias="nodeCount")
    ...
    __properties: ClassVar[List[str]] = ["configuredRoleTypes", "culture", "dataBoxEdgeDeviceStatus", "description", "deviceHcsVersion", "deviceLocalCapacity", "deviceModel", "deviceSoftwareVersion", "deviceType", "friendlyName", "modelDescription", "nodeCount", "serialNumber", "timeZone"]
    ...
    def data_box_edge_device_status_validate_enum(cls, value):
        ...
        if value not in set(['ReadyToSetup', 'Online', 'Offline', 'NeedsAttention', 'Disconnected', 'PartiallyDisconnected', 'Maintenance']):
            raise ValueError("must be one of enum values ('ReadyToSetup', 'Online', 'Offline', 'NeedsAttention', 'Disconnected', 'PartiallyDisconnected', 'Maintenance')")
        return value
