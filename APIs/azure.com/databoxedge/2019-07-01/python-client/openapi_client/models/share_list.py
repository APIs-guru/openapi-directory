...
class ShareList(BaseModel):
    ...
    value: Optional[List[Share]] = Field(default=None, description="The list of shares.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Share.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
