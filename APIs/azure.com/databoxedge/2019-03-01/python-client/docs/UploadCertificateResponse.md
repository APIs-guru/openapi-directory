...
------------ | ------------- | ------------- | -------------
**aad_authority** | **str** | Azure Active Directory tenant authority. | 
**aad_tenant_id** | **str** | Azure Active Directory tenant ID. | 
**auth_type** | **str** | Specifies authentication type. | [optional] 
**azure_management_endpoint_audience** | **str** | The azure management endpoint audience. | 
**resource_id** | **str** | The resource ID of the Data Box Edge/Gateway device. | 
**service_principal_client_id** | **str** | Azure Active Directory service principal client ID. | 
**service_principal_object_id** | **str** | Azure Active Directory service principal object ID. | 
