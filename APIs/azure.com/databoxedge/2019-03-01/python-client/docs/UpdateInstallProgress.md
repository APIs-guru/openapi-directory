...
------------ | ------------- | ------------- | -------------
**number_of_updates_installed** | **int** | Number of updates installed. | [optional] [readonly] 
**number_of_updates_to_install** | **int** | Number of updates to install. | [optional] [readonly] 
**percent_complete** | **int** | Percentage completed. | [optional] [readonly] 
