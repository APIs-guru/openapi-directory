...
class IdentityProviderListByService200ResponseValueInner(BaseModel):
    """
    Identity Provider details.
    """ # noqa: E501
    properties: Optional[IdentityProviderListByService200ResponseValueInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": IdentityProviderListByService200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
