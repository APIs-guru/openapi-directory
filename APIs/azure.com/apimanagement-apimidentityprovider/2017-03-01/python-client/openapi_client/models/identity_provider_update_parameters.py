...
class IdentityProviderUpdateParameters(BaseModel):
    """
    Parameters supplied to update Identity Provider
    """ # noqa: E501
    properties: Optional[IdentityProviderUpdateProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": IdentityProviderUpdateProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
