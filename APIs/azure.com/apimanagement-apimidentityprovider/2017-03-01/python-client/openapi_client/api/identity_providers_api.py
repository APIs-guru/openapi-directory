...
class IdentityProvidersApi:
    ...
    def identity_provider_update(
        ...
        if_match: Annotated[StrictStr, Field(description="The entity state (Etag) version of the identity provider configuration to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation.")],
        ...
        :param if_match: The entity state (Etag) version of the identity provider configuration to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation. (required)
        :type if_match: str
