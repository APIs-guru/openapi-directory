...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    if_match = 'if_match_example' # str | The entity state (Etag) version of the identity provider configuration to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation.
 ...
 **if_match** | **str**| The entity state (Etag) version of the identity provider configuration to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. | 
