...
> IdentityProviderContract identity_provider_create_or_update(resource_group_name, service_name, identity_provider_name, api_version, subscription_id, parameters, if_match=if_match)
