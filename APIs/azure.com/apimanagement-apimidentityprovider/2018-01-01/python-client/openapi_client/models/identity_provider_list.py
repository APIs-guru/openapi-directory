...
class IdentityProviderList(BaseModel):
    ...
    value: Optional[List[IdentityProviderContract]] = Field(default=None, description="Identity Provider configuration values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IdentityProviderContract.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
