...
class IdentityProviderContractProperties(BaseModel):
    """
    ...
    client_secret: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Client secret of the Application in external Identity Provider, used to authenticate login request. For example, it is App Secret for Facebook login, API Key for Google login, Public Key for Microsoft.", alias="clientSecret")
