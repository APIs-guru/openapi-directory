...
class RecoverableManagedDatabasesApi:
    ...
    @validate_call
    def recoverable_managed_databases_get(
        self,
        ...
        recoverable_database_name: StrictStr,
        ...
        _param = self._recoverable_managed_databases_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RecoverableManagedDatabase",
        }
    ...
    @validate_call
    def recoverable_managed_databases_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        recoverable_database_name: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RecoverableManagedDatabase]:
        """recoverable_managed_databases_get
    ...
    @validate_call
    def recoverable_managed_databases_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        recoverable_database_name: StrictStr,
    ...
    def _recoverable_managed_databases_get_serialize(
        self,
        resource_group_name,
        ...
        if recoverable_database_name is not None:
            _path_params['recoverableDatabaseName'] = recoverable_database_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/recoverableDatabases/{recoverableDatabaseName}',
    ...
    @validate_call
    def recoverable_managed_databases_list_by_instance(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        ...
        _param = self._recoverable_managed_databases_list_by_instance_serialize(
            resource_group_name=resource_group_name,
            managed_instance_name=managed_instance_name,
            subscription_id=subscription_id,
            api_version=api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RecoverableManagedDatabaseListResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def recoverable_managed_databases_list_by_instance_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RecoverableManagedDatabaseListResult]:
        """recoverable_managed_databases_list_by_instance
    ...
    @validate_call
    def recoverable_managed_databases_list_by_instance_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
    ...
    def _recoverable_managed_databases_list_by_instance_serialize(
        self,
        resource_group_name,
        managed_instance_name,
        subscription_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/recoverableDatabases',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
