...
**is_scheduled_for_deferred_delete** | **bool** | To check if backup item is scheduled for deferred delete | [optional] 
**protection_state** | **str** | Protection state of the backupengine | [optional] 
