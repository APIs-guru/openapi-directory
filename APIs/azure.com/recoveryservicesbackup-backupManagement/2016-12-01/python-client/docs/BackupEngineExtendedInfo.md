...
------------ | ------------- | ------------- | -------------
**available_disk_space** | **float** | Diskspace currently available in the backup engine. | [optional] 
...
**used_disk_space** | **float** | Diskspace used in the backup engine. | [optional] 
