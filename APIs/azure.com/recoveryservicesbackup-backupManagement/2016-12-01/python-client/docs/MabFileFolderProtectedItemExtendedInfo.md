...
------------ | ------------- | ------------- | -------------
**last_refreshed_at** | **datetime** | Last time when the agent data synced to service. | [optional] 
**oldest_recovery_point** | **datetime** | The oldest backup copy available. | [optional] 
**recovery_point_count** | **int** | Number of backup copies associated with the backup item. | [optional] 
