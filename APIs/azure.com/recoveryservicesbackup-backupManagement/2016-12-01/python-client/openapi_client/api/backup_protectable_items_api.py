...
class BackupProtectableItemsApi:
    ...
    @validate_call
    def backup_protectable_items_list(
        self,
        ...
        _param = self._backup_protectable_items_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WorkloadProtectableItemResourceList",
        }
    ...
    @validate_call
    def backup_protectable_items_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkloadProtectableItemResourceList]:
        """backup_protectable_items_list
    ...
    @validate_call
    def backup_protectable_items_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _backup_protectable_items_list_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupProtectableItems',
