...
class RestoresApi:
    ...
    def restores_trigger(
        ...
        protected_item_name: Annotated[StrictStr, Field(description="Backed up item to be restored.")],
        recovery_point_id: Annotated[StrictStr, Field(description="Recovery point ID which represents the backed up data to be restored.")],
        parameters: Annotated[RestoreRequestResource, Field(description="resource restore request")],
        ...
        :param recovery_point_id: Recovery point ID which represents the backed up data to be restored. (required)
        :type recovery_point_id: str
        :param parameters: resource restore request (required)
        :type parameters: RestoreRequestResource
