...
class ProtectionPolicyOperationStatusesApi:
    ...
    @validate_call
    def protection_policy_operation_statuses_get(
        self,
        ...
        policy_name: Annotated[StrictStr, Field(description="Backup policy name whose operation's status needs to be fetched.")],
        operation_id: Annotated[StrictStr, Field(description="Operation ID which represents an operation whose status needs to be fetched.")],
        ...
        :param operation_id: Operation ID which represents an operation whose status needs to be fetched. (required)
        ...
        _param = self._protection_policy_operation_statuses_get_serialize(
    ...
    @validate_call
    def protection_policy_operation_statuses_get_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    @validate_call
    def protection_policy_operation_statuses_get_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        vault_name: Annotated[StrictStr, Field(description="The name of the recovery services vault.")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group where the recovery services vault is present.")],
    ...
    def _protection_policy_operation_statuses_get_serialize(
        self,
        api_version,
        vault_name,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}/operations/{operationId}',
