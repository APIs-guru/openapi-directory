...
class ProtectionPolicy(BaseModel):
    ...
    """ # noqa: E501
    backup_management_type: StrictStr = Field(description="This property will be used as the discriminator for deciding the specific types in the polymorhpic chain of types.", alias="backupManagementType")
