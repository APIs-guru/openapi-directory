...
class AzureIaaSClassicComputeVMProtectedItem(AzureIaaSVMProtectedItem):
    ...
    """ # noqa: E501
    __properties: ClassVar[List[str]] = ["extendedInfo", "friendlyName", "healthDetails", "healthStatus", "lastBackupStatus", "lastBackupTime", "protectedItemDataId", "protectionState", "protectionStatus", "virtualMachineId", "backupManagementType", "containerName", "lastRecoveryPoint", "policyId", "protectedItemType", "sourceResourceId", "workloadType"]
