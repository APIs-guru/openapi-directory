...
class BackupScheduleGroupList(BaseModel):
    """
    The list response of backup schedule groups
    """ # noqa: E501
    value: List[BackupScheduleGroup] = Field(description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BackupScheduleGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
