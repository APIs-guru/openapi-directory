...
class ChapSettingsList(BaseModel):
    """
    Collection of Chap setting entities
    """ # noqa: E501
    value: List[ChapSettings] = Field(description="The chap settings entity collection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ChapSettings.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
