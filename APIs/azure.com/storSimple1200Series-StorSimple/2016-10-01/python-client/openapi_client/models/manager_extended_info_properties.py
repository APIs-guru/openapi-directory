...
class ManagerExtendedInfoProperties(BaseModel):
    ...
    """ # noqa: E501
    algorithm: StrictStr = Field(description="Represents the encryption algorithm used to encrypt the other keys. None - if EncryptionKey is saved in plain text format. AlgorithmName - if encryption is used")
    ...
    version: Optional[StrictStr] = Field(default=None, description="Represents the version of the ExtendedInfo object being persisted")
