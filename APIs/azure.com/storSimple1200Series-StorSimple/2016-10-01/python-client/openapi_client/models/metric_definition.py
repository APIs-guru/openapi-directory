...
class MetricDefinition(BaseModel):
    ...
    """ # noqa: E501
    dimensions: List[MetricDimension] = Field(description="The supported dimensions")
    metric_availabilities: List[MetricAvailablity] = Field(description="The available metric granularities", alias="metricAvailabilities")
    name: MetricName
    primary_aggregation_type: StrictStr = Field(description="The metric aggregation type", alias="primaryAggregationType")
    resource_id: StrictStr = Field(description="The metric source id", alias="resourceId")
    type: StrictStr = Field(description="The metric definition type")
    unit: StrictStr = Field(description="The metric unit")
    __properties: ClassVar[List[str]] = ["dimensions", "metricAvailabilities", "name", "primaryAggregationType", "resourceId", "type", "unit"]
