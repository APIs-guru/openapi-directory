...
class AlertErrorDetails(BaseModel):
    """
    ...
    occurences: Optional[StrictInt] = Field(default=None, description="Number of occurrences.")
    __properties: ClassVar[List[str]] = ["errorCode", "errorMessage", "occurences"]
