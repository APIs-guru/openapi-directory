...
class AvailableProviderOperations(BaseModel):
    """
    Class for set of operations used for discovery of available provider operations.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The NextLink.", alias="nextLink")
    value: List[AvailableProviderOperation] = Field(description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AvailableProviderOperation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
