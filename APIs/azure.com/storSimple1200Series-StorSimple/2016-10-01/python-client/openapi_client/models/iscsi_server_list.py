...
class ISCSIServerList(BaseModel):
    """
    Collection of Iscsi servers
    """ # noqa: E501
    value: List[ISCSIServer] = Field(description="The value.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ISCSIServer.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
