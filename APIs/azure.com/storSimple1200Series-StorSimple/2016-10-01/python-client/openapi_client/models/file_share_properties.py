...
class FileShareProperties(BaseModel):
    ...
    The File Share.
    """ # noqa: E501
    admin_user: StrictStr = Field(description="The user/group who will have full permission in this share. Active directory email address. Example: xyz@contoso.com or Contoso\\xyz.", alias="adminUser")
    data_policy: StrictStr = Field(description="The data policy", alias="dataPolicy")
    description: Optional[StrictStr] = Field(default=None, description="Description for file share")
    ...
    monitoring_status: StrictStr = Field(description="The monitoring status", alias="monitoringStatus")
    provisioned_capacity_in_bytes: StrictInt = Field(description="The total provisioned capacity in Bytes", alias="provisionedCapacityInBytes")
    share_status: StrictStr = Field(description="The Share Status", alias="shareStatus")
    ...
    __properties: ClassVar[List[str]] = ["adminUser", "dataPolicy", "description", "localUsedCapacityInBytes", "monitoringStatus", "provisionedCapacityInBytes", "shareStatus", "usedCapacityInBytes"]
