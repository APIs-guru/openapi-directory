...
class AlertProperties(BaseModel):
    ...
    Properties of alert
    """ # noqa: E501
    alert_type: StrictStr = Field(description="Type of the alert", alias="alertType")
    appeared_at_source_time: datetime = Field(description="UTC time at which the alert appeared on the source", alias="appearedAtSourceTime")
    appeared_at_time: datetime = Field(description="UTC time at which the alert appeared", alias="appearedAtTime")
    cleared_at_source_time: Optional[datetime] = Field(default=None, description="UTC time at which the alert was cleared on the source", alias="clearedAtSourceTime")
    cleared_at_time: Optional[datetime] = Field(default=None, description="UTC time at which the alert got cleared", alias="clearedAtTime")
    detailed_information: Optional[Dict[str, StrictStr]] = Field(default=None, description="Other information about the alert", alias="detailedInformation")
    error_details: Optional[AlertErrorDetails] = Field(default=None, alias="errorDetails")
    recommendation: Optional[StrictStr] = Field(default=None, description="Recommendation for acting on the alert")
    resolution_reason: Optional[StrictStr] = Field(default=None, description="Reason for resolving the alert", alias="resolutionReason")
    scope: StrictStr = Field(description="Device or Resource alert")
    severity: StrictStr = Field(description="Severity of the alert")
    source: AlertSource
    status: StrictStr = Field(description="Current status of the alert")
    title: StrictStr = Field(description="Title of the alert")
