...
class Error(BaseModel):
    ...
    message: Message
    values: Optional[List[Item]] = None
    __properties: ClassVar[List[str]] = ["errorCode", "message", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [Item.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
