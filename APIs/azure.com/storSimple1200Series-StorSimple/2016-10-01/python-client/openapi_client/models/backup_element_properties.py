...
class BackupElementProperties(BaseModel):
    """
    The backup element properties
    """ # noqa: E501
    data_policy: StrictStr = Field(description="The data policy of backed up endpoint.", alias="dataPolicy")
    endpoint_name: StrictStr = Field(description="The name of the endpoint.", alias="endpointName")
    size_in_bytes: StrictInt = Field(description="The size in bytes.", alias="sizeInBytes")
    __properties: ClassVar[List[str]] = ["dataPolicy", "endpointName", "sizeInBytes"]
