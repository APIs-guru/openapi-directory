...
class BackupFilter(BaseModel):
    ...
    """ # noqa: E501
    created_time: Optional[datetime] = Field(default=None, description="Gets or sets CreatedTime", alias="createdTime")
    initiated_by: Optional[StrictStr] = Field(default=None, description="Gets or sets InitiatedBy", alias="initiatedBy")
    __properties: ClassVar[List[str]] = ["createdTime", "initiatedBy"]
