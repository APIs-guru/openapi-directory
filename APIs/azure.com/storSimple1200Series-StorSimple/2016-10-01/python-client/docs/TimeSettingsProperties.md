...
------------ | ------------- | ------------- | -------------
**primary_time_server** | **str** | The primary Network Time Protocol (NTP) server name, like &#39;time.windows.com&#39;. | 
**secondary_time_server** | **str** | The secondary Network Time Protocol (NTP) server name, like &#39;time.contoso.com&#39;. It&#39;s optional. | [optional] 
