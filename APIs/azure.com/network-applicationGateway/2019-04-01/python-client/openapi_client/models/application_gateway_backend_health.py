...
class ApplicationGatewayBackendHealth(BaseModel):
    ...
    """ # noqa: E501
    backend_address_pools: Optional[List[ApplicationGatewayBackendHealthPool]] = Field(default=None, description="A list of ApplicationGatewayBackendHealthPool resources.", alias="backendAddressPools")
