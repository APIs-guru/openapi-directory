...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(BaseModel):
    ...
    private_endpoint_network_policies: Optional[StrictStr] = Field(default=None, description="Enable or Disable private end point on the subnet.", alias="privateEndpointNetworkPolicies")
    ...
    private_link_service_network_policies: Optional[StrictStr] = Field(default=None, description="Enable or Disable private link service on the subnet.", alias="privateLinkServiceNetworkPolicies")
