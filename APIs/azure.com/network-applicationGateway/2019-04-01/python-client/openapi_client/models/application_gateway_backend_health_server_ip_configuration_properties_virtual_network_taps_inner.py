...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesVirtualNetworkTapsInner(BaseModel):
    """
    ...
    properties: Optional[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesVirtualNetworkTapsInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etag": obj.get("etag"),
            "properties": ApplicationGatewayBackendHealthServerIpConfigurationPropertiesVirtualNetworkTapsInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
