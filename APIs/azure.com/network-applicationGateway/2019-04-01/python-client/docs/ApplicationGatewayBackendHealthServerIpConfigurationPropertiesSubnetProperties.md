...
**private_endpoint_network_policies** | **str** | Enable or Disable private end point on the subnet. | [optional] 
...
**private_link_service_network_policies** | **str** | Enable or Disable private link service on the subnet. | [optional] 
