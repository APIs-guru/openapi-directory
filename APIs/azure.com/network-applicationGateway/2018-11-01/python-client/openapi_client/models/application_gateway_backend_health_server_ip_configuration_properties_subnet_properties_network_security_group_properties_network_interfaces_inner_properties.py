...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerProperties(BaseModel):
    ...
    interface_endpoint: Optional[Items] = Field(default=None, alias="interfaceEndpoint")
    ...
    __properties: ClassVar[List[str]] = ["dnsSettings", "enableAcceleratedNetworking", "enableIPForwarding", "hostedWorkloads", "interfaceEndpoint", "ipConfigurations", "macAddress", "networkSecurityGroup", "primary", "provisioningState", "resourceGuid", "tapConfigurations", "virtualMachine"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of interface_endpoint
        if self.interface_endpoint:
            _dict['interfaceEndpoint'] = self.interface_endpoint.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interfaceEndpoint": Items.from_dict(obj["interfaceEndpoint"]) if obj.get("interfaceEndpoint") is not None else None,
