...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesRouteTableProperties(BaseModel):
    ...
    """ # noqa: E501
    disable_bgp_route_propagation: Optional[StrictBool] = Field(default=None, description="Whether to disable the routes learned by BGP on that route table. True means disable.", alias="disableBgpRoutePropagation")
