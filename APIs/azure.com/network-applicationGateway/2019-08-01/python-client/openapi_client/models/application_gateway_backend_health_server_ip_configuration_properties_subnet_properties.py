...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(BaseModel):
    ...
    delegations: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesDelegationsInner]] = Field(default=None, description="An array of references to the delegations on the subnet.")
    ...
    ip_configurations: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesIpConfigurationsInner]] = Field(default=None, description="An array of references to the network interface IP configurations using subnet.", alias="ipConfigurations")
    ...
    resource_navigation_links: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesResourceNavigationLinksInner]] = Field(default=None, description="An array of references to the external resources using subnet.", alias="resourceNavigationLinks")
    ...
    service_association_links: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesServiceAssociationLinksInner]] = Field(default=None, description="An array of references to services injecting into this subnet.", alias="serviceAssociationLinks")
