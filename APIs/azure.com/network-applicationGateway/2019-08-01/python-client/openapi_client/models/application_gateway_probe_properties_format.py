...
class ApplicationGatewayProbePropertiesFormat(BaseModel):
    ...
    port: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, description="Custom port which will be used for probing the backend servers. The valid value ranges from 1 to 65535. In case not set, port from http settings will be used. This property is valid for Standard_v2 and WAF_v2 only.")
    ...
    __properties: ClassVar[List[str]] = ["host", "interval", "match", "minServers", "path", "pickHostNameFromBackendHttpSettings", "port", "protocol", "provisioningState", "timeout", "unhealthyThreshold"]
