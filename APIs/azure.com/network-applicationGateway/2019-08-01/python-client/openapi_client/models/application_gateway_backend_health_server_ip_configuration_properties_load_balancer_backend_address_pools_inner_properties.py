...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesLoadBalancerBackendAddressPoolsInnerProperties(BaseModel):
    ...
    """ # noqa: E501
    backend_ip_configurations: Optional[List[DestinationNetworkInterfaceIPConfiguration]] = Field(default=None, description="An array of references to IP addresses defined in network interfaces.", alias="backendIPConfigurations")
    load_balancing_rules: Optional[List[Model0]] = Field(default=None, description="An array of references to load balancing rules that use this backend address pool.", alias="loadBalancingRules")
    outbound_rule: Optional[Model0] = Field(default=None, alias="outboundRule")
    outbound_rules: Optional[List[Model0]] = Field(default=None, description="An array of references to outbound rules that use this backend address pool.", alias="outboundRules")
