...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressPrefix", "addressPrefixes", "delegations", "interfaceEndpoints", "ipConfigurationProfiles", "ipConfigurations", "networkSecurityGroup", "provisioningState", "purpose", "resourceNavigationLinks", "routeTable", "serviceAssociationLinks", "serviceEndpointPolicies", "serviceEndpoints"]
