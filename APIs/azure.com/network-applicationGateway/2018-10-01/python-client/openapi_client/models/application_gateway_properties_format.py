...
class ApplicationGatewayPropertiesFormat(BaseModel):
    ...
    trusted_root_certificates: Optional[List[object]] = Field(default=None, description="Trusted Root certificates of the application gateway resource.", alias="trustedRootCertificates")
    ...
    __properties: ClassVar[List[str]] = ["authenticationCertificates", "autoscaleConfiguration", "backendAddressPools", "backendHttpSettingsCollection", "customErrorConfigurations", "enableFips", "enableHttp2", "frontendIPConfigurations", "frontendPorts", "gatewayIPConfigurations", "httpListeners", "operationalState", "probes", "provisioningState", "redirectConfigurations", "requestRoutingRules", "resourceGuid", "rewriteRuleSets", "sku", "sslCertificates", "sslPolicy", "trustedRootCertificates", "urlPathMaps", "webApplicationFirewallConfiguration"]
