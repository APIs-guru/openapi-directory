...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressPrefix", "ipConfigurations", "networkSecurityGroup", "provisioningState", "resourceNavigationLinks", "routeTable", "serviceEndpointPolicies", "serviceEndpoints"]
