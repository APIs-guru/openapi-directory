...
class ApplicationGatewayRedirectConfigurationPropertiesFormat(BaseModel):
    ...
    path_rules: Optional[List[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration]] = Field(default=None, description="Path rules specifying redirect configuration.", alias="pathRules")
    redirect_type: Optional[RedirectTypeEnum] = Field(default=None, alias="redirectType")
    request_routing_rules: Optional[List[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration]] = Field(default=None, description="Request routing specifying redirect configuration.", alias="requestRoutingRules")
    target_listener: Optional[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration] = Field(default=None, alias="targetListener")
    target_url: Optional[StrictStr] = Field(default=None, description="Url to redirect the request to.", alias="targetUrl")
    url_path_maps: Optional[List[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration]] = Field(default=None, description="Url path maps specifying default redirect configuration.", alias="urlPathMaps")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pathRules": [ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(_item) for _item in obj["pathRules"]] if obj.get("pathRules") is not None else None,
            "redirectType": obj.get("redirectType"),
            "requestRoutingRules": [ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(_item) for _item in obj["requestRoutingRules"]] if obj.get("requestRoutingRules") is not None else None,
            "targetListener": ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(obj["targetListener"]) if obj.get("targetListener") is not None else None,
            "targetUrl": obj.get("targetUrl"),
            "urlPathMaps": [ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(_item) for _item in obj["urlPathMaps"]] if obj.get("urlPathMaps") is not None else None
        })
        return _obj
