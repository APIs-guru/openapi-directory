...
class ApplicationGatewayHttpListenerPropertiesFormat(BaseModel):
    ...
    frontend_ip_configuration: Optional[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration] = Field(default=None, alias="frontendIPConfiguration")
    frontend_port: Optional[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration] = Field(default=None, alias="frontendPort")
    ...
    ssl_certificate: Optional[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration] = Field(default=None, alias="sslCertificate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frontendIPConfiguration": ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(obj["frontendIPConfiguration"]) if obj.get("frontendIPConfiguration") is not None else None,
            "frontendPort": ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(obj["frontendPort"]) if obj.get("frontendPort") is not None else None,
            "hostName": obj.get("hostName"),
            "protocol": obj.get("protocol"),
            "provisioningState": obj.get("provisioningState"),
            "requireServerNameIndication": obj.get("requireServerNameIndication"),
            "sslCertificate": ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.from_dict(obj["sslCertificate"]) if obj.get("sslCertificate") is not None else None
        })
        return _obj
