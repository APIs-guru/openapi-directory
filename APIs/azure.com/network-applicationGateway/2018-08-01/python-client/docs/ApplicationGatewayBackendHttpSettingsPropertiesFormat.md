...
**authentication_certificates** | [**List[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration]**](ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.md) | Array of references to application gateway authentication certificates. | [optional] 
...
**trusted_root_certificates** | [**List[ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration]**](ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.md) | Array of references to application gateway trusted root certificates. | [optional] 
