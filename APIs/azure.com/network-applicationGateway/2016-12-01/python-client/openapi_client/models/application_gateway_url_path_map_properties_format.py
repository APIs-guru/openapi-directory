...
class ApplicationGatewayUrlPathMapPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    default_backend_address_pool: Optional[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort] = Field(default=None, alias="defaultBackendAddressPool")
    default_backend_http_settings: Optional[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort] = Field(default=None, alias="defaultBackendHttpSettings")
    ...
    __properties: ClassVar[List[str]] = ["defaultBackendAddressPool", "defaultBackendHttpSettings", "pathRules", "provisioningState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultBackendAddressPool": ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.from_dict(obj["defaultBackendAddressPool"]) if obj.get("defaultBackendAddressPool") is not None else None,
            "defaultBackendHttpSettings": ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.from_dict(obj["defaultBackendHttpSettings"]) if obj.get("defaultBackendHttpSettings") is not None else None,
