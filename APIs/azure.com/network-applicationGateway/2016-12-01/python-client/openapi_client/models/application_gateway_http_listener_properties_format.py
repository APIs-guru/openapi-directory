...
class ApplicationGatewayHttpListenerPropertiesFormat(BaseModel):
    ...
    """ # noqa: E501
    frontend_ip_configuration: Optional[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort] = Field(default=None, alias="frontendIPConfiguration")
    frontend_port: Optional[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort] = Field(default=None, alias="frontendPort")
    ...
    ssl_certificate: Optional[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort] = Field(default=None, alias="sslCertificate")
    __properties: ClassVar[List[str]] = ["frontendIPConfiguration", "frontendPort", "hostName", "protocol", "provisioningState", "requireServerNameIndication", "sslCertificate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "frontendIPConfiguration": ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.from_dict(obj["frontendIPConfiguration"]) if obj.get("frontendIPConfiguration") is not None else None,
            "frontendPort": ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.from_dict(obj["frontendPort"]) if obj.get("frontendPort") is not None else None,
            "hostName": obj.get("hostName"),
            "protocol": obj.get("protocol"),
            "provisioningState": obj.get("provisioningState"),
            "requireServerNameIndication": obj.get("requireServerNameIndication"),
            "sslCertificate": ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.from_dict(obj["sslCertificate"]) if obj.get("sslCertificate") is not None else None
        })
        return _obj
