...
**backend_ip_configurations** | [**List[ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInner]**](ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInner.md) | Collection of references to IPs defined in network interfaces. | [optional] 
