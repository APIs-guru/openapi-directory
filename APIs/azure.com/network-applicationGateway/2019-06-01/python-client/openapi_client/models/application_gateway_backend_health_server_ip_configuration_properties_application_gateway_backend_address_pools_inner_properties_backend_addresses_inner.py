...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendAddressesInner(BaseModel):
    """
    Backend address of an application gateway.
    """ # noqa: E501
    fqdn: Optional[StrictStr] = Field(default=None, description="Fully qualified domain name (FQDN).")
    ip_address: Optional[StrictStr] = Field(default=None, description="IP address.", alias="ipAddress")
    __properties: ClassVar[List[str]] = ["fqdn", "ipAddress"]
