...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(BaseModel):
    ...
    private_endpoint_network_policies: Optional[StrictStr] = Field(default=None, description="Enable or Disable apply network policies on private end point in the subnet.", alias="privateEndpointNetworkPolicies")
    private_endpoints: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesPrivateEndpointsInner]] = Field(default=None, description="An array of references to private endpoints.", alias="privateEndpoints")
    private_link_service_network_policies: Optional[StrictStr] = Field(default=None, description="Enable or Disable apply network policies on private link service in the subnet.", alias="privateLinkServiceNetworkPolicies")
    ...
    __properties: ClassVar[List[str]] = ["addressPrefix", "addressPrefixes", "delegations", "ipConfigurationProfiles", "ipConfigurations", "natGateway", "networkSecurityGroup", "privateEndpointNetworkPolicies", "privateEndpoints", "privateLinkServiceNetworkPolicies", "provisioningState", "purpose", "resourceNavigationLinks", "routeTable", "serviceAssociationLinks", "serviceEndpointPolicies", "serviceEndpoints"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in private_endpoints (list)
        _items = []
        if self.private_endpoints:
            for _item_private_endpoints in self.private_endpoints:
                if _item_private_endpoints:
                    _items.append(_item_private_endpoints.to_dict())
            _dict['privateEndpoints'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privateEndpointNetworkPolicies": obj.get("privateEndpointNetworkPolicies"),
            "privateEndpoints": [ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesPrivateEndpointsInner.from_dict(_item) for _item in obj["privateEndpoints"]] if obj.get("privateEndpoints") is not None else None,
            "privateLinkServiceNetworkPolicies": obj.get("privateLinkServiceNetworkPolicies"),
