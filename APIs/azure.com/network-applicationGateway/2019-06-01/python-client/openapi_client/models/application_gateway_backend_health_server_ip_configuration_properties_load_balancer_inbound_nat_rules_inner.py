...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesLoadBalancerInboundNatRulesInner(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Gets name of the resource that is unique within the set of inbound NAT rules used by the load balancer. This name can be used to access the resource.")
