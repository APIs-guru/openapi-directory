...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesLoadBalancerBackendAddressPoolsInnerProperties(BaseModel):
    ...
    """ # noqa: E501
    backend_ip_configurations: Optional[List[DestinationNetworkInterfaceIPConfiguration]] = Field(default=None, description="Gets collection of references to IP addresses defined in network interfaces.", alias="backendIPConfigurations")
    ...
    outbound_rule: Optional[Model0] = Field(default=None, alias="outboundRule")
    outbound_rules: Optional[List[Model0]] = Field(default=None, description="Gets outbound rules that use this backend address pool.", alias="outboundRules")
    ...
    __properties: ClassVar[List[str]] = ["backendIPConfigurations", "loadBalancingRules", "outboundRule", "outboundRules", "provisioningState"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of outbound_rule
        if self.outbound_rule:
            _dict['outboundRule'] = self.outbound_rule.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outboundRule": Model0.from_dict(obj["outboundRule"]) if obj.get("outboundRule") is not None else None,
