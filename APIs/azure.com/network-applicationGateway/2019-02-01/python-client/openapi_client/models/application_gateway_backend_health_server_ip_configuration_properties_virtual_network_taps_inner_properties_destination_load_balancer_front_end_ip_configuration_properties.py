...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesVirtualNetworkTapsInnerPropertiesDestinationLoadBalancerFrontEndIPConfigurationProperties(BaseModel):
    ...
    """ # noqa: E501
    inbound_nat_pools: Optional[List[Model0]] = Field(default=None, description="Read only. Inbound pools URIs that use this frontend IP.", alias="inboundNatPools")
    inbound_nat_rules: Optional[List[Model0]] = Field(default=None, description="Read only. Inbound rules URIs that use this frontend IP.", alias="inboundNatRules")
    load_balancing_rules: Optional[List[Model0]] = Field(default=None, description="Gets load balancing rules URIs that use this frontend IP.", alias="loadBalancingRules")
    outbound_rules: Optional[List[Model0]] = Field(default=None, description="Read only. Outbound rules URIs that use this frontend IP.", alias="outboundRules")
    ...
    __properties: ClassVar[List[str]] = ["inboundNatPools", "inboundNatRules", "loadBalancingRules", "outboundRules", "privateIPAddress", "privateIPAllocationMethod", "provisioningState", "publicIPAddress", "publicIPPrefix", "subnet"]
