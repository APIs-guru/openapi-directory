...
class ApplicationGatewaysListAvailableServerVariablesDefaultResponse(BaseModel):
    """
    Common error representation.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Error code.")
    details: Optional[List[ApplicationGatewaysListAvailableServerVariablesDefaultResponseDetailsInner]] = Field(default=None, description="Error details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [ApplicationGatewaysListAvailableServerVariablesDefaultResponseDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
