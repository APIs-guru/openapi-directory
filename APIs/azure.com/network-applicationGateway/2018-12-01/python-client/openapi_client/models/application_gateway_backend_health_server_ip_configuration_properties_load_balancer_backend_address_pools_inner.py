...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesLoadBalancerBackendAddressPoolsInner(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Gets name of the resource that is unique within a resource group. This name can be used to access the resource.")
