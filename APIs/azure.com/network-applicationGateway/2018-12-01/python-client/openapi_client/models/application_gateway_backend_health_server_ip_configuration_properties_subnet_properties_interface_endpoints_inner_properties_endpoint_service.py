...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInnerPropertiesEndpointService(BaseModel):
    """
    Identifies the service being brought into the virtual network.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier of the service being referenced by the interface endpoint.")
