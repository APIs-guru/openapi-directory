...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dnsSettings", "idleTimeoutInMinutes", "ipAddress", "ipConfiguration", "ipTags", "provisioningState", "publicIPAddressVersion", "publicIPAllocationMethod", "resourceGuid"]
