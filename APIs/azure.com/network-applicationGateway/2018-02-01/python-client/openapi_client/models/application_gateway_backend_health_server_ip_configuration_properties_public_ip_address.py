...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddress(BaseModel):
    """
    ...
    properties: Optional[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties] = None
    sku: Optional[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressSku] = None
    ...
    __properties: ClassVar[List[str]] = ["etag", "properties", "sku", "zones"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etag": obj.get("etag"),
            "properties": ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "zones": obj.get("zones")
        })
        return _obj
