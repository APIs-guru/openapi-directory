...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerProperties(BaseModel):
    ...
    hosted_workloads: Optional[List[StrictStr]] = Field(default=None, description="A list of references to linked BareMetal resources.", alias="hostedWorkloads")
    ip_configurations: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesIpConfigurationsInner]] = Field(default=None, description="A list of IPConfigurations of the network interface.", alias="ipConfigurations")
    ...
    primary: Optional[StrictBool] = Field(default=None, description="Whether this is a primary network interface on a virtual machine.")
    private_endpoint: Optional[Items] = Field(default=None, alias="privateEndpoint")
    ...
    tap_configurations: Optional[List[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesTapConfigurationsInner]] = Field(default=None, description="A list of TapConfigurations of the network interface.", alias="tapConfigurations")
    virtual_machine: Optional[Model0] = Field(default=None, alias="virtualMachine")
    __properties: ClassVar[List[str]] = ["dnsSettings", "enableAcceleratedNetworking", "enableIPForwarding", "hostedWorkloads", "ipConfigurations", "macAddress", "networkSecurityGroup", "primary", "privateEndpoint", "provisioningState", "resourceGuid", "tapConfigurations", "virtualMachine"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of private_endpoint
        if self.private_endpoint:
            _dict['privateEndpoint'] = self.private_endpoint.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tap_configurations (list)
        _items = []
        if self.tap_configurations:
            for _item_tap_configurations in self.tap_configurations:
                if _item_tap_configurations:
                    _items.append(_item_tap_configurations.to_dict())
            _dict['tapConfigurations'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedWorkloads": obj.get("hostedWorkloads"),
            "ipConfigurations": [ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesIpConfigurationsInner.from_dict(_item) for _item in obj["ipConfigurations"]] if obj.get("ipConfigurations") is not None else None,
            ...
            "privateEndpoint": Items.from_dict(obj["privateEndpoint"]) if obj.get("privateEndpoint") is not None else None,
            ...
            "tapConfigurations": [ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesTapConfigurationsInner.from_dict(_item) for _item in obj["tapConfigurations"]] if obj.get("tapConfigurations") is not None else None,
