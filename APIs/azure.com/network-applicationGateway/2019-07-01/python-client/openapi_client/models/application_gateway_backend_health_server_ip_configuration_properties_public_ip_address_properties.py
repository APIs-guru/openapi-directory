...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties(BaseModel):
    ...
    """ # noqa: E501
    ddos_settings: Optional[ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressPropertiesDdosSettings] = Field(default=None, alias="ddosSettings")
    ...
    public_ip_address_version: Optional[PrivateIPAddressVersion] = Field(default=None, alias="publicIPAddressVersion")
    public_ip_allocation_method: Optional[PrivateIPAllocationMethod] = Field(default=None, alias="publicIPAllocationMethod")
    public_ip_prefix: Optional[Model0] = Field(default=None, alias="publicIPPrefix")
    resource_guid: Optional[StrictStr] = Field(default=None, description="The resource GUID property of the public IP address resource.", alias="resourceGuid")
    __properties: ClassVar[List[str]] = ["ddosSettings", "dnsSettings", "idleTimeoutInMinutes", "ipAddress", "ipConfiguration", "ipTags", "provisioningState", "publicIPAddressVersion", "publicIPAllocationMethod", "publicIPPrefix", "resourceGuid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ddos_settings
        if self.ddos_settings:
            _dict['ddosSettings'] = self.ddos_settings.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of public_ip_address_version
        if self.public_ip_address_version:
            _dict['publicIPAddressVersion'] = self.public_ip_address_version.to_dict()
        # override the default output from pydantic by calling `to_dict()` of public_ip_allocation_method
        if self.public_ip_allocation_method:
            _dict['publicIPAllocationMethod'] = self.public_ip_allocation_method.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ddosSettings": ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressPropertiesDdosSettings.from_dict(obj["ddosSettings"]) if obj.get("ddosSettings") is not None else None,
            ...
            "publicIPAddressVersion": PrivateIPAddressVersion.from_dict(obj["publicIPAddressVersion"]) if obj.get("publicIPAddressVersion") is not None else None,
            "publicIPAllocationMethod": PrivateIPAllocationMethod.from_dict(obj["publicIPAllocationMethod"]) if obj.get("publicIPAllocationMethod") is not None else None,
