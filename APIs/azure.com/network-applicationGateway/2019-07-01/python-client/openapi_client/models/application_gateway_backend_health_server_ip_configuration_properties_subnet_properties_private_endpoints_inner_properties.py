...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesPrivateEndpointsInnerProperties(BaseModel):
    ...
    network_interfaces: Optional[List[Items]] = Field(default=None, description="An array of references to the network interfaces created for this private endpoint.", alias="networkInterfaces")
