...
class ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInnerPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerProperties(BaseModel):
    """
    NetworkInterface properties. 
    """ # noqa: E501
    dns_settings: Optional[ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInnerPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesDnsSettings] = Field(default=None, alias="dnsSettings")
    ...
    ip_configurations: Optional[List[ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInnerPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner]] = Field(default=None, description="A list of IPConfigurations of the network interface.", alias="ipConfigurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dnsSettings": ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInnerPropertiesSubnetPropertiesNetworkSecurityGroupPropertiesNetworkInterfacesInnerPropertiesDnsSettings.from_dict(obj["dnsSettings"]) if obj.get("dnsSettings") is not None else None,
            "enableAcceleratedNetworking": obj.get("enableAcceleratedNetworking"),
            "enableIPForwarding": obj.get("enableIPForwarding"),
            "ipConfigurations": [ApplicationGatewayBackendAddressPoolPropertiesFormatBackendIPConfigurationsInnerPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner.from_dict(_item) for _item in obj["ipConfigurations"]] if obj.get("ipConfigurations") is not None else None,
