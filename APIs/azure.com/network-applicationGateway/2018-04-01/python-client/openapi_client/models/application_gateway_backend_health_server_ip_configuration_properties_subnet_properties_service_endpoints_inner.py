...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesServiceEndpointsInner(BaseModel):
    """
    ...
    service: Optional[StrictStr] = Field(default=None, description="The type of the endpoint service.")
    __properties: ClassVar[List[str]] = ["locations", "provisioningState", "service"]
