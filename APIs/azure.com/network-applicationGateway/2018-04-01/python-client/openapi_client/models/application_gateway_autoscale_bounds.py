...
class ApplicationGatewayAutoscaleBounds(BaseModel):
    """
    Application Gateway autoscale bounds on number of Application Gateway instance.
    """ # noqa: E501
    max: StrictInt = Field(description="Upper bound on number of Application Gateway instances.")
    min: StrictInt = Field(description="Lower bound on number of Application Gateway instances.")
