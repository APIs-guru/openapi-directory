...
class ApplicationGatewayPropertiesFormat(BaseModel):
    ...
    gateway_ip_configurations: Optional[List[object]] = Field(default=None, description="Gets or sets subnets of application gateway resource", alias="gatewayIPConfigurations")
    http_listeners: Optional[List[ApplicationGatewayHttpListener]] = Field(default=None, description="Http listeners of the application gateway resource.", alias="httpListeners")
    operational_state: Optional[StrictStr] = Field(default=None, description="Operational state of the application gateway resource. Possible values are: 'Stopped', 'Started', 'Running', and 'Stopping'.", alias="operationalState")
