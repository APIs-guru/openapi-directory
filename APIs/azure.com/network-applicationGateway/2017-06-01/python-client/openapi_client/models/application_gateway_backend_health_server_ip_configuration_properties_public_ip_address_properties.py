...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dnsSettings", "idleTimeoutInMinutes", "ipAddress", "ipConfiguration", "provisioningState", "publicIPAddressVersion", "publicIPAllocationMethod", "resourceGuid"]
