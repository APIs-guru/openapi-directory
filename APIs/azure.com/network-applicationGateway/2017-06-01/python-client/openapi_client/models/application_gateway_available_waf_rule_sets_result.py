...
class ApplicationGatewayAvailableWafRuleSetsResult(BaseModel):
    """
    Response for ApplicationGatewayAvailableWafRuleSets API service call.
    """ # noqa: E501
    value: Optional[List[object]] = Field(default=None, description="The list of application gateway rule sets.")
