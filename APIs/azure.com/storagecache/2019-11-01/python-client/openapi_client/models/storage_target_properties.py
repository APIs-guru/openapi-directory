...
class StorageTargetProperties(BaseModel):
    ...
    junctions: Optional[List[NamespaceJunction]] = Field(default=None, description="List of Cache namespace junctions to target for namespace associations.")
    ...
    target_type: Optional[StrictStr] = Field(default=None, description="Type of the Storage Target.", alias="targetType")
