...
------------ | ------------- | ------------- | -------------
**id** | **str** | Resource ID of the Storage Target. | [optional] [readonly] 
...
**type** | **str** | Type of the Storage Target; Microsoft.StorageCache/Cache/StorageTarget | [optional] [readonly] 
