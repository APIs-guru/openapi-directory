...
class UsageModelsResult(BaseModel):
    """
    A list of cache usage models.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of cache usage models.", alias="nextLink")
    value: Optional[List[UsageModel]] = Field(default=None, description="The list of usage models available for the subscription.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [UsageModel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
