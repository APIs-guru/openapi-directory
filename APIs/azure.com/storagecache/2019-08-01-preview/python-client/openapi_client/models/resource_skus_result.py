...
class ResourceSkusResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of cache Skus.", alias="nextLink")
    value: Optional[List[ResourceSku]] = Field(default=None, description="The list of skus available for the subscription.")
