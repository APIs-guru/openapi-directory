...
class StorageTargetsResult(BaseModel):
    """
    A list of storage targets.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The uri to fetch the next page of storage targets.", alias="nextLink")
    value: Optional[List[StorageTarget]] = Field(default=None, description="The list of storage targets defined for the cache.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [StorageTarget.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
