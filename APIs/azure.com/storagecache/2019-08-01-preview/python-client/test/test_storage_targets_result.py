...
class TestStorageTargetsResult(unittest.TestCase):
    """StorageTargetsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageTargetsResult:
        """Test StorageTargetsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageTargetsResult`
        """
        model = StorageTargetsResult()
        if include_optional:
            return StorageTargetsResult(
                next_link = '',
                value = [
                    openapi_client.models.storage_target.StorageTarget(
                        id = '', 
                        name = 'zBAMDTMv2D2y', 
    ...
    def testStorageTargetsResult(self):
        """Test StorageTargetsResult"""
