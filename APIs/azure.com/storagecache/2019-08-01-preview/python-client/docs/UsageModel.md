...
**model_name** | **str** | Non localized keyword naming this usage model. | [optional] 
**target_type** | **str** | The type of Storage Target to which this model is applicable (only nfs for now) | [optional] 
