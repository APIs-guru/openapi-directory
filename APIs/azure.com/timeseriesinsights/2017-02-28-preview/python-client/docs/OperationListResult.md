...
**value** | [**List[Operation]**](Operation.md) | List of Time Series Insights operations supported by the Microsoft.TimeSeriesInsights resource provider. | [optional] [readonly] 
