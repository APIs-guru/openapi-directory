...
class EventHubEventSourceCreationProperties(BaseModel):
    """
    Properties of the EventHub event source that are required on create or update requests.
    """ # noqa: E501
    shared_access_key: StrictStr = Field(description="The value of the shared access key that grants the Time Series Insights service read access to the event hub. This property is not shown in event source responses.", alias="sharedAccessKey")
