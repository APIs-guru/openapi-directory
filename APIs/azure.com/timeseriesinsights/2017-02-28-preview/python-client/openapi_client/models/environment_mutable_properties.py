...
class EnvironmentMutableProperties(BaseModel):
    """
    An object that represents a set of mutable environment resource properties.
    """ # noqa: E501
    data_retention_time: Optional[StrictStr] = Field(default=None, description="ISO8601 timespan specifying the minimum number of days the environment's events will be available for query.", alias="dataRetentionTime")
    __properties: ClassVar[List[str]] = ["dataRetentionTime"]
