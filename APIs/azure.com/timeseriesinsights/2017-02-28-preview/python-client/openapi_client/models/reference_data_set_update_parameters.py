...
class ReferenceDataSetUpdateParameters(BaseModel):
    """
    Parameters supplied to the Update Reference Data Set operation.
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-value pairs of additional properties for the reference data set.")
