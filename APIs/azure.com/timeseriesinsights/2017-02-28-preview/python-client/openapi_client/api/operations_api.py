...
class OperationsApi:
    ...
    def operations_list(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Current version is 2017-02-28-preview.")],
        ...
        :param api_version: Version of the API to be used with the client request. Current version is 2017-02-28-preview. (required)
    ...
    def _operations_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.TimeSeriesInsights/operations',
