...
json = "{}"
# create an instance of EventHubEventSourceCommonProperties from a JSON string
event_hub_event_source_common_properties_instance = EventHubEventSourceCommonProperties.from_json(json)
# print the JSON string representation of the object
print(EventHubEventSourceCommonProperties.to_json())

# convert the object into a dict
event_hub_event_source_common_properties_dict = event_hub_event_source_common_properties_instance.to_dict()
# create an instance of EventHubEventSourceCommonProperties from a dict
event_hub_event_source_common_properties_from_dict = EventHubEventSourceCommonProperties.from_dict(event_hub_event_source_common_properties_dict)
```
