...
------------- | ------------- | -------------
[**operations_list**](OperationsApi.md#operations_list) | **GET** /providers/Microsoft.TimeSeriesInsights/operations | 
...
|-------------|-------------|------------------|
**200** | Successfully listed the available operations. |  -  |
