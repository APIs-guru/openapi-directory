...
json = "{}"
# create an instance of IoTHubEventSourceResourceProperties from a JSON string
io_t_hub_event_source_resource_properties_instance = IoTHubEventSourceResourceProperties.from_json(json)
# print the JSON string representation of the object
print(IoTHubEventSourceResourceProperties.to_json())

# convert the object into a dict
io_t_hub_event_source_resource_properties_dict = io_t_hub_event_source_resource_properties_instance.to_dict()
# create an instance of IoTHubEventSourceResourceProperties from a dict
io_t_hub_event_source_resource_properties_from_dict = IoTHubEventSourceResourceProperties.from_dict(io_t_hub_event_source_resource_properties_dict)
```
