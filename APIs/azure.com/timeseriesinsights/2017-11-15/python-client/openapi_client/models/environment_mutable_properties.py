...
class EnvironmentMutableProperties(BaseModel):
    ...
    partition_key_properties: Optional[List[PartitionKeyProperty]] = Field(default=None, description="The list of event properties which will be used to partition data in the environment.", alias="partitionKeyProperties")
