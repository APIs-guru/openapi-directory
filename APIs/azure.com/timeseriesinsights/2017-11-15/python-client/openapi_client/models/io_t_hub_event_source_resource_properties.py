...
class IoTHubEventSourceResourceProperties(BaseModel):
    """
    Properties of the IoTHub event source resource.
    """ # noqa: E501
    consumer_group_name: StrictStr = Field(description="The name of the iot hub's consumer group that holds the partitions from which events will be read.", alias="consumerGroupName")
    iot_hub_name: StrictStr = Field(description="The name of the iot hub.", alias="iotHubName")
    key_name: StrictStr = Field(description="The name of the Shared Access Policy key that grants the Time Series Insights service access to the iot hub. This shared access policy key must grant 'service connect' permissions to the iot hub.", alias="keyName")
    ...
    __properties: ClassVar[List[str]] = ["consumerGroupName", "iotHubName", "keyName", "eventSourceResourceId", "timestampPropertyName", "creationTime", "provisioningState"]
