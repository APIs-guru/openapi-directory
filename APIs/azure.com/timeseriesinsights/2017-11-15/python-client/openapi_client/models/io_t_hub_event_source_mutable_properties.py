...
class IoTHubEventSourceMutableProperties(BaseModel):
    """
    An object that represents a set of mutable IoTHub event source resource properties.
    """ # noqa: E501
    shared_access_key: Optional[StrictStr] = Field(default=None, description="The value of the shared access key that grants the Time Series Insights service read access to the iot hub. This property is not shown in event source responses.", alias="sharedAccessKey")
