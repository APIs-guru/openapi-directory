...
class EnvironmentUpdateParameters(BaseModel):
    """
    Parameters supplied to the Update Environment operation.
    """ # noqa: E501
    properties: Optional[EnvironmentMutableProperties] = None
    sku: Optional[Sku] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-value pairs of additional properties for the environment.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": EnvironmentMutableProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
