...
class EventSourceListResponse(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[EventSourceResource]] = Field(default=None, description="Result of the List EventSources operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [EventSourceResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
