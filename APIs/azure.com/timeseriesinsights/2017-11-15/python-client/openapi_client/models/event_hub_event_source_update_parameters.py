...
class EventHubEventSourceUpdateParameters(BaseModel):
    """
    Parameters supplied to the Update Event Source operation to update an EventHub event source.
    """ # noqa: E501
    properties: Optional[EventHubEventSourceMutableProperties] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-value pairs of additional properties for the event source.")
