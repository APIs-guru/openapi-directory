...
class SearchInstancesResponsePage(BaseModel):
    """
    ...
    instances: Optional[SearchInstancesResponse] = None
    __properties: ClassVar[List[str]] = ["hierarchyNodes", "instances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instances": SearchInstancesResponse.from_dict(obj["instances"]) if obj.get("instances") is not None else None
        })
        return _obj
