...
class TimeSeriesHierarchyOrError(BaseModel):
    """
    ...
    hierarchy: Optional[TimeSeriesHierarchy] = None
    __properties: ClassVar[List[str]] = ["error", "hierarchy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hierarchy": TimeSeriesHierarchy.from_dict(obj["hierarchy"]) if obj.get("hierarchy") is not None else None
        })
        return _obj
