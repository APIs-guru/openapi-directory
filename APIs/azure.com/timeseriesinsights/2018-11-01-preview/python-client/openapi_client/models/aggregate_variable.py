...
class AggregateVariable(Variable):
    ...
    """ # noqa: E501
    aggregation: Optional[Tsx] = None
    __properties: ClassVar[List[str]] = ["filter", "kind", "aggregation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "aggregation": Tsx.from_dict(obj["aggregation"]) if obj.get("aggregation") is not None else None
        })
        return _obj
