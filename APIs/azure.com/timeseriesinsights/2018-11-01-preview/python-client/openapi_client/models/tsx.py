...
class Tsx(BaseModel):
    ...
    """ # noqa: E501
    tsx: StrictStr = Field(description="Time series expression (TSX) written as a single string. Examples: \"$event.Status.String='Good'\", \"avg($event.Temperature)\". Refer to the documentation on how to write time series expressions.")
    __properties: ClassVar[List[str]] = ["tsx"]
