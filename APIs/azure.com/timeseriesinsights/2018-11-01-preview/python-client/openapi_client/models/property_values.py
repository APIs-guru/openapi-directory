...
class PropertyValues(BaseModel):
    ...
    values: Optional[List[Dict[str, Any]]] = Field(default=None, description="Values of a single property corresponding to the timestamps. May contain nulls. Type of values matches the type of property.")
