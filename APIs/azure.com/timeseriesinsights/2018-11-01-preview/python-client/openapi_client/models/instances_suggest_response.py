...
class InstancesSuggestResponse(BaseModel):
    """
    Response of getting suggestions for search for time series instances.
    """ # noqa: E501
    suggestions: Optional[List[InstancesSearchStringSuggestion]] = Field(default=None, description="List of instance suggestions for searching time series models.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suggestions": [InstancesSearchStringSuggestion.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None
        })
        return _obj
