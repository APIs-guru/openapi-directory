...
class SearchHierarchyNodesResponse(BaseModel):
    """
    ...
    hit_count: Optional[StrictInt] = Field(default=None, description="Total number of hierarchy nodes which contains the instances matching the query based on the input.", alias="hitCount")
    hits: Optional[List[HierarchyHit]] = Field(default=None, description="The list of hierarchy nodes which contains the instances matching the query based on the input. May be empty.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hits": [HierarchyHit.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None
        })
        return _obj

from openapi_client.models.hierarchy_hit import HierarchyHit
# TODO: Rewrite to not use raise_errors
SearchHierarchyNodesResponse.model_rebuild(raise_errors=False)
