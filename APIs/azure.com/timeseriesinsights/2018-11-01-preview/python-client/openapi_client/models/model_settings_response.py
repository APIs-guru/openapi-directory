...
class ModelSettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    model_settings: Optional[TimeSeriesModelSettings] = Field(default=None, alias="modelSettings")
    __properties: ClassVar[List[str]] = ["modelSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modelSettings": TimeSeriesModelSettings.from_dict(obj["modelSettings"]) if obj.get("modelSettings") is not None else None
        })
        return _obj
