...
class InstancesSortParameter(BaseModel):
    ...
    def by_validate_enum(cls, value):
        ...
        if value not in set(['Rank', 'DisplayName']):
            raise ValueError("must be one of enum values ('Rank', 'DisplayName')")
        return value
