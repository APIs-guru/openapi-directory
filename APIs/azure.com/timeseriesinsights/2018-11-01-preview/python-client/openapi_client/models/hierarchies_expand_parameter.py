...
class HierarchiesExpandParameter(BaseModel):
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['UntilChildren', 'OneLevel']):
            raise ValueError("must be one of enum values ('UntilChildren', 'OneLevel')")
        return value
