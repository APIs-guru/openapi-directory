...
class InstanceOrError(BaseModel):
    """
    ...
    instance: Optional[TimeSeriesInstance] = None
    __properties: ClassVar[List[str]] = ["error", "instance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instance": TimeSeriesInstance.from_dict(obj["instance"]) if obj.get("instance") is not None else None
        })
        return _obj
