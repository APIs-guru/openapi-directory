...
class QueryApi:
    ...
    def query_execute(
        ...
        parameters: Annotated[QueryRequest, Field(description="Time series query request body.")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
    ...
    def _query_execute_serialize(
        ...
        if store_type is not None:
            ...
            _query_params.append(('storeType', store_type))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/timeseries/query',
    ...
    def query_get_availability(
        ...
        _param = self._query_get_availability_serialize(
            api_version=api_version,
            store_type=store_type,
            x_ms_client_request_id=x_ms_client_request_id,
            x_ms_client_session_id=x_ms_client_session_id,
    ...
    @validate_call
    def query_get_availability_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Currently supported version is \"2018-11-01-preview\".")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
        x_ms_client_request_id: Annotated[Optional[StrictStr], Field(description="Optional client request ID. Service records this value. Allows the service to trace operation across services, and allows the customer to contact support regarding a particular request.")] = None,
    ...
    @validate_call
    def query_get_availability_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Currently supported version is \"2018-11-01-preview\".")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
        x_ms_client_request_id: Annotated[Optional[StrictStr], Field(description="Optional client request ID. Service records this value. Allows the service to trace operation across services, and allows the customer to contact support regarding a particular request.")] = None,
    ...
    def _query_get_availability_serialize(
        self,
        api_version,
        store_type,
        x_ms_client_request_id,
    ...
    @validate_call
    def query_get_event_schema(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Currently supported version is \"2018-11-01-preview\".")],
        parameters: Annotated[GetEventSchemaRequest, Field(description="Parameters to get event schema.")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
        x_ms_client_request_id: Annotated[Optional[StrictStr], Field(description="Optional client request ID. Service records this value. Allows the service to trace operation across services, and allows the customer to contact support regarding a particular request.")] = None,
        x_ms_client_session_id: Annotated[Optional[StrictStr], Field(description="Optional client session ID. Service records this value. Allows the service to trace a group of related operations across services, and allows the customer to contact support regarding a particular group of requests.")] = None,
        _request_timeout: Union[
        ...
        :type parameters: GetEventSchemaRequest
        :param store_type: For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.
        :type store_type: str
        :param x_ms_client_request_id: Optional client request ID. Service records this value. Allows the service to trace operation across services, and allows the customer to contact support regarding a particular request.
        :type x_ms_client_request_id: str
        ...
        _param = self._query_get_event_schema_serialize(
            api_version=api_version,
            parameters=parameters,
            store_type=store_type,
            x_ms_client_request_id=x_ms_client_request_id,
    ...
    @validate_call
    def query_get_event_schema_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Currently supported version is \"2018-11-01-preview\".")],
        parameters: Annotated[GetEventSchemaRequest, Field(description="Parameters to get event schema.")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
    ...
    @validate_call
    def query_get_event_schema_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. Currently supported version is \"2018-11-01-preview\".")],
        parameters: Annotated[GetEventSchemaRequest, Field(description="Parameters to get event schema.")],
        store_type: Annotated[Optional[StrictStr], Field(description="For the environments with warm store enabled, the query can be executed either on the 'WarmStore' or 'ColdStore'. This parameter in the query defines which store the query should be executed on. If not defined, the query will be executed on the cold store.")] = None,
    ...
    def _query_get_event_schema_serialize(
        self,
        api_version,
        parameters,
        store_type,
