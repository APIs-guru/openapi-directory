...
class EventHubEventSourceCommonProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["eventSourceResourceId", "timestampPropertyName", "creationTime", "provisioningState"]
