...
class ReferenceDataSetListResponse(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[ReferenceDataSetResource]] = Field(default=None, description="Result of the List Reference Data Sets operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ReferenceDataSetResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
