...
class StandardEnvironmentCreationProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dataRetentionTime", "partitionKeyProperties", "storageLimitExceededBehavior"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandardEnvironmentCreationProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandardEnvironmentCreationProperties from a dict"""
        if obj is None:
            return None
