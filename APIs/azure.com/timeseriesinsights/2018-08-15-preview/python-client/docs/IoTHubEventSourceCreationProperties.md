...
------------ | ------------- | ------------- | -------------
**shared_access_key** | **str** | The value of the Shared Access Policy key that grants the Time Series Insights service read access to the iot hub. This property is not shown in event source responses. | 
...
json = "{}"
# create an instance of IoTHubEventSourceCreationProperties from a JSON string
io_t_hub_event_source_creation_properties_instance = IoTHubEventSourceCreationProperties.from_json(json)
# print the JSON string representation of the object
print(IoTHubEventSourceCreationProperties.to_json())

# convert the object into a dict
io_t_hub_event_source_creation_properties_dict = io_t_hub_event_source_creation_properties_instance.to_dict()
# create an instance of IoTHubEventSourceCreationProperties from a dict
io_t_hub_event_source_creation_properties_from_dict = IoTHubEventSourceCreationProperties.from_dict(io_t_hub_event_source_creation_properties_dict)
```
