...
standard_environment_creation_properties_instance = StandardEnvironmentCreationProperties.from_json(json)
# print the JSON string representation of the object
print(StandardEnvironmentCreationProperties.to_json())

# convert the object into a dict
standard_environment_creation_properties_dict = standard_environment_creation_properties_instance.to_dict()
# create an instance of StandardEnvironmentCreationProperties from a dict
standard_environment_creation_properties_from_dict = StandardEnvironmentCreationProperties.from_dict(standard_environment_creation_properties_dict)
```
