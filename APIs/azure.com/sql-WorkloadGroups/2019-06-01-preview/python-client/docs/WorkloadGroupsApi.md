# openapi_client.WorkloadGroupsApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**workload_groups_create_or_update**](WorkloadGroupsApi.md#workload_groups_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups/{workloadGroupName} | 
[**workload_groups_delete**](WorkloadGroupsApi.md#workload_groups_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups/{workloadGroupName} | 
[**workload_groups_get**](WorkloadGroupsApi.md#workload_groups_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups/{workloadGroupName} | 
[**workload_groups_list_by_database**](WorkloadGroupsApi.md#workload_groups_list_by_database) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups | 


# **workload_groups_create_or_update**
> WorkloadGroup workload_groups_create_or_update(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WorkloadGroupsApi(api_client)
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
    server_name = 'server_name_example' # str | The name of the server.
    database_name = 'database_name_example' # str | The name of the database.
    workload_group_name = 'workload_group_name_example' # str | The name of the workload group.
    subscription_id = 'subscription_id_example' # str | The subscription ID that identifies an Azure subscription.
    api_version = 'api_version_example' # str | The API version to use for the request.
    parameters = openapi_client.WorkloadGroup() # WorkloadGroup | The requested workload group state.

    try:
        api_response = api_instance.workload_groups_create_or_update(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version, parameters)
        print("The response of WorkloadGroupsApi->workload_groups_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkloadGroupsApi->workload_groups_create_or_update: %s\n" % e)
```
...
> workload_groups_delete(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    server_name = 'server_name_example' # str | The name of the server.
    database_name = 'database_name_example' # str | The name of the database.
    workload_group_name = 'workload_group_name_example' # str | The name of the workload group to delete.
    subscription_id = 'subscription_id_example' # str | The subscription ID that identifies an Azure subscription.
    api_version = 'api_version_example' # str | The API version to use for the request.

    try:
        api_instance.workload_groups_delete(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version)
    except Exception as e:
        print("Exception when calling WorkloadGroupsApi->workload_groups_delete: %s\n" % e)
```
...
# **workload_groups_get**
> WorkloadGroup workload_groups_get(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.workload_groups_get(resource_group_name, server_name, database_name, workload_group_name, subscription_id, api_version)
        print("The response of WorkloadGroupsApi->workload_groups_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkloadGroupsApi->workload_groups_get: %s\n" % e)
```
...
> WorkloadGroupListResult workload_groups_list_by_database(resource_group_name, server_name, database_name, subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.workload_groups_list_by_database(resource_group_name, server_name, database_name, subscription_id, api_version)
        print("The response of WorkloadGroupsApi->workload_groups_list_by_database:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkloadGroupsApi->workload_groups_list_by_database: %s\n" % e)
```
