...
class VirtualNetworkConnectionGatewayReference(BaseModel):
    """
    A reference to VirtualNetworkGateway or LocalNetworkGateway resource.
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of VirtualNetworkGateway or LocalNetworkGateway resource.")
