...
class VpnClientConfiguration(BaseModel):
    ...
    """ # noqa: E501
    aad_audience: Optional[StrictStr] = Field(default=None, description="The AADAudience property of the VirtualNetworkGateway resource for vpn client connection used for AAD authentication.", alias="aadAudience")
    aad_issuer: Optional[StrictStr] = Field(default=None, description="The AADIssuer property of the VirtualNetworkGateway resource for vpn client connection used for AAD authentication.", alias="aadIssuer")
    aad_tenant: Optional[StrictStr] = Field(default=None, description="The AADTenant property of the VirtualNetworkGateway resource for vpn client connection used for AAD authentication.", alias="aadTenant")
    ...
    vpn_client_ipsec_policies: Optional[List[IpsecPolicy]] = Field(default=None, description="VpnClientIpsecPolicies for virtual network gateway P2S client.", alias="vpnClientIpsecPolicies")
    ...
    __properties: ClassVar[List[str]] = ["aadAudience", "aadIssuer", "aadTenant", "radiusServerAddress", "radiusServerSecret", "vpnClientAddressPool", "vpnClientIpsecPolicies", "vpnClientProtocols", "vpnClientRevokedCertificates", "vpnClientRootCertificates"]
    ...
    def vpn_client_protocols_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['IkeV2', 'SSTP', 'OpenVPN']):
                raise ValueError("each list item must be one of ('IkeV2', 'SSTP', 'OpenVPN')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aadAudience": obj.get("aadAudience"),
            "aadIssuer": obj.get("aadIssuer"),
            "aadTenant": obj.get("aadTenant"),
            ...
            "vpnClientIpsecPolicies": [IpsecPolicy.from_dict(_item) for _item in obj["vpnClientIpsecPolicies"]] if obj.get("vpnClientIpsecPolicies") is not None else None,
