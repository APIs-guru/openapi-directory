...
> ConnectionSharedKey virtual_network_gateway_connections_get_shared_key(resource_group_name, virtual_network_gateway_connection_name, api_version, subscription_id)
...
> VirtualNetworkGatewayConnection virtual_network_gateway_connections_update_tags(resource_group_name, virtual_network_gateway_connection_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str | Client API version.
    subscription_id = 'subscription_id_example' # str | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    parameters = openapi_client.VirtualNetworkGatewayConnectionsUpdateTagsRequest() # VirtualNetworkGatewayConnectionsUpdateTagsRequest | Parameters supplied to update virtual network gateway connection tags.

    try:
        api_response = api_instance.virtual_network_gateway_connections_update_tags(resource_group_name, virtual_network_gateway_connection_name, api_version, subscription_id, parameters)
        print("The response of VirtualNetworkGatewayConnectionsApi->virtual_network_gateway_connections_update_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VirtualNetworkGatewayConnectionsApi->virtual_network_gateway_connections_update_tags: %s\n" % e)
```
