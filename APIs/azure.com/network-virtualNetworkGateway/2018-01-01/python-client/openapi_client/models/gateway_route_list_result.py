...
class GatewayRouteListResult(BaseModel):
    """
    List of virtual network gateway routes
    """ # noqa: E501
    value: Optional[List[GatewayRoute]] = Field(default=None, description="List of gateway routes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GatewayRoute.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
