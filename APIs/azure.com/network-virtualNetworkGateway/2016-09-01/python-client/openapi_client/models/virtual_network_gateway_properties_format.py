...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    gateway_type: StrictStr = Field(description="The type of this virtual network gateway. Possible values are: 'Vpn' and 'ExpressRoute'.", alias="gatewayType")
    ip_configurations: List[VirtualNetworkGatewayIPConfiguration] = Field(description="IP configurations for virtual network gateway.", alias="ipConfigurations")
    ...
    vpn_type: StrictStr = Field(description="The type of this virtual network gateway. Possible values are: 'PolicyBased' and 'RouteBased'.", alias="vpnType")
