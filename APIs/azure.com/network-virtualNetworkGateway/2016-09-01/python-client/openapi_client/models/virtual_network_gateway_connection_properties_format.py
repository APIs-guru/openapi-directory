...
class VirtualNetworkGatewayConnectionPropertiesFormat(BaseModel):
    ...
    peer: Optional[VirtualNetworkGatewayConnectionPropertiesFormatPeer] = None
    ...
    __properties: ClassVar[List[str]] = ["authorizationKey", "connectionStatus", "connectionType", "egressBytesTransferred", "enableBgp", "ingressBytesTransferred", "localNetworkGateway2", "peer", "provisioningState", "resourceGuid", "routingWeight", "sharedKey", "tunnelConnectionStatus", "virtualNetworkGateway1", "virtualNetworkGateway2"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "peer": VirtualNetworkGatewayConnectionPropertiesFormatPeer.from_dict(obj["peer"]) if obj.get("peer") is not None else None,
