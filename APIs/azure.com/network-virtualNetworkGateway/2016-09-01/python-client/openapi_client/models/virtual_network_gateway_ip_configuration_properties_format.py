...
class VirtualNetworkGatewayIPConfigurationPropertiesFormat(BaseModel):
    ...
    public_ip_address: VirtualNetworkGatewayConnectionPropertiesFormatPeer = Field(alias="publicIPAddress")
    subnet: VirtualNetworkGatewayConnectionPropertiesFormatPeer
