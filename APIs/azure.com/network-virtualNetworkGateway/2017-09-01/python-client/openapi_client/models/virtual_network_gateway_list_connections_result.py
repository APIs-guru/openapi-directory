...
class VirtualNetworkGatewayListConnectionsResult(BaseModel):
    """
    ...
    value: Optional[List[VirtualNetworkGatewayConnectionListEntity]] = Field(default=None, description="Gets a list of VirtualNetworkGatewayConnection resources that exists in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VirtualNetworkGatewayConnectionListEntity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
