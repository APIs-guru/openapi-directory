...
> VirtualNetworkGatewayConnectionListEntity virtual_network_gateway_connections_update_tags(resource_group_name, virtual_network_gateway_connection_name, api_version, subscription_id, parameters)
