...
class VpnClientConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["radiusServerAddress", "radiusServerSecret", "vpnClientAddressPool", "vpnClientIpsecPolicies", "vpnClientProtocols", "vpnClientRevokedCertificates", "vpnClientRootCertificates"]
