...
class VirtualNetworkGatewayConnectionPropertiesFormat(BaseModel):
    ...
    connection_type: Optional[StrictStr] = Field(default=None, description="Gateway connection type. Possible values are: 'IPsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.", alias="connectionType")
