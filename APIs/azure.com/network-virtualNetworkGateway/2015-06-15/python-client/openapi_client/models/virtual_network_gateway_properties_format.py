...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bgpSettings", "enableBgp", "gatewayDefaultSite", "gatewayType", "ipConfigurations", "provisioningState", "resourceGuid", "sku", "vpnClientConfiguration", "vpnType"]
