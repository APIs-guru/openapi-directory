...
class VirtualNetworkGatewayIPConfigurationPropertiesFormat(BaseModel):
    ...
    public_ip_address: Optional[VirtualNetworkGatewayConnectionPropertiesFormatPeer] = Field(default=None, alias="publicIPAddress")
    subnet: Optional[VirtualNetworkGatewayConnectionPropertiesFormatPeer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicIPAddress": VirtualNetworkGatewayConnectionPropertiesFormatPeer.from_dict(obj["publicIPAddress"]) if obj.get("publicIPAddress") is not None else None,
            "subnet": VirtualNetworkGatewayConnectionPropertiesFormatPeer.from_dict(obj["subnet"]) if obj.get("subnet") is not None else None
        })
        return _obj
