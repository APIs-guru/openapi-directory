...
------------ | ------------- | ------------- | -------------
**asn** | **int** | Gets or sets this BGP speaker&#39;s ASN | [optional] 
**bgp_peering_address** | **str** | Gets or sets the BGP peering address and BGP identifier of this BGP speaker | [optional] 
**peer_weight** | **int** | Gets or sets the weight added to routes learned from this BGP speaker | [optional] 
