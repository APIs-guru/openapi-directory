...
class TestLocalNetworkGateway(unittest.TestCase):
    """LocalNetworkGateway unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalNetworkGateway:
        """Test LocalNetworkGateway
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalNetworkGateway`
        """
    ...
    def testLocalNetworkGateway(self):
        """Test LocalNetworkGateway"""
