...
**resource_guid** | **str** | The resource GUID property of the virtual network gateway connection resource. | [optional] 
**routing_weight** | **int** | The routing weight. | [optional] 
**shared_key** | **str** | The IPSec shared key. | [optional] 
**traffic_selector_policies** | [**List[TrafficSelectorPolicy]**](TrafficSelectorPolicy.md) | The Traffic Selector Policies to be considered by this connection. | [optional] 
