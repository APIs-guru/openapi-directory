...
class VirtualNetworkGatewayListConnectionsResult(BaseModel):
    ...
    value: Optional[List[VirtualNetworkGatewayConnectionListEntity]] = Field(default=None, description="A list of VirtualNetworkGatewayConnection resources that exists in a resource group.")
