...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    resource_guid: Optional[StrictStr] = Field(default=None, description="The resource GUID property of the virtual network gateway resource.", alias="resourceGuid")
    ...
    vpn_gateway_generation: Optional[StrictStr] = Field(default=None, description="The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.", alias="vpnGatewayGeneration")
    vpn_type: Optional[StrictStr] = Field(default=None, description="The type of this virtual network gateway.", alias="vpnType")
    __properties: ClassVar[List[str]] = ["activeActive", "bgpSettings", "customRoutes", "enableBgp", "gatewayDefaultSite", "gatewayType", "ipConfigurations", "provisioningState", "resourceGuid", "sku", "vpnClientConfiguration", "vpnGatewayGeneration", "vpnType"]
    ...
    @field_validator('vpn_gateway_generation')
    def vpn_gateway_generation_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['None', 'Generation1', 'Generation2']):
            raise ValueError("must be one of enum values ('None', 'Generation1', 'Generation2')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vpnGatewayGeneration": obj.get("vpnGatewayGeneration"),
