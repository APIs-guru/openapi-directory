...
class VirtualNetworkGatewayConnectionListEntityPropertiesFormat(BaseModel):
    """
    VirtualNetworkGatewayConnection properties.
    """ # noqa: E501
    authorization_key: Optional[StrictStr] = Field(default=None, description="The authorizationKey.", alias="authorizationKey")
    connection_protocol: Optional[ConnectionProtocol] = Field(default=None, alias="connectionProtocol")
    connection_status: Optional[VirtualNetworkGatewayConnectionStatus] = Field(default=None, alias="connectionStatus")
    connection_type: VirtualNetworkGatewayConnectionType = Field(alias="connectionType")
    ...
    express_route_gateway_bypass: Optional[StrictBool] = Field(default=None, description="Bypass ExpressRoute Gateway for data forwarding.", alias="expressRouteGatewayBypass")
    ...
    local_network_gateway2: Optional[VirtualNetworkConnectionGatewayReference] = Field(default=None, alias="localNetworkGateway2")
    ...
    resource_guid: Optional[StrictStr] = Field(default=None, description="The resource GUID property of the virtual network gateway connection resource.", alias="resourceGuid")
    ...
    traffic_selector_policies: Optional[List[TrafficSelectorPolicy]] = Field(default=None, description="The Traffic Selector Policies to be considered by this connection.", alias="trafficSelectorPolicies")
    ...
    virtual_network_gateway1: VirtualNetworkConnectionGatewayReference = Field(alias="virtualNetworkGateway1")
    virtual_network_gateway2: Optional[VirtualNetworkConnectionGatewayReference] = Field(default=None, alias="virtualNetworkGateway2")
    __properties: ClassVar[List[str]] = ["authorizationKey", "connectionProtocol", "connectionStatus", "connectionType", "egressBytesTransferred", "enableBgp", "expressRouteGatewayBypass", "ingressBytesTransferred", "ipsecPolicies", "localNetworkGateway2", "peer", "provisioningState", "resourceGuid", "routingWeight", "sharedKey", "trafficSelectorPolicies", "tunnelConnectionStatus", "usePolicyBasedTrafficSelectors", "virtualNetworkGateway1", "virtualNetworkGateway2"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in traffic_selector_policies (list)
        _items = []
        if self.traffic_selector_policies:
            for _item_traffic_selector_policies in self.traffic_selector_policies:
                if _item_traffic_selector_policies:
                    _items.append(_item_traffic_selector_policies.to_dict())
            _dict['trafficSelectorPolicies'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectionProtocol": obj.get("connectionProtocol"),
            ...
            "expressRouteGatewayBypass": obj.get("expressRouteGatewayBypass"),
            ...
            "localNetworkGateway2": VirtualNetworkConnectionGatewayReference.from_dict(obj["localNetworkGateway2"]) if obj.get("localNetworkGateway2") is not None else None,
            ...
            "trafficSelectorPolicies": [TrafficSelectorPolicy.from_dict(_item) for _item in obj["trafficSelectorPolicies"]] if obj.get("trafficSelectorPolicies") is not None else None,
            ...
            "virtualNetworkGateway1": VirtualNetworkConnectionGatewayReference.from_dict(obj["virtualNetworkGateway1"]) if obj.get("virtualNetworkGateway1") is not None else None,
            "virtualNetworkGateway2": VirtualNetworkConnectionGatewayReference.from_dict(obj["virtualNetworkGateway2"]) if obj.get("virtualNetworkGateway2") is not None else None
        })
        return _obj
