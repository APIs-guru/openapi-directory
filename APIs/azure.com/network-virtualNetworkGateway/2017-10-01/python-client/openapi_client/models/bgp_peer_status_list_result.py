...
class BgpPeerStatusListResult(BaseModel):
    """
    Response for list BGP peer status API service call
    """ # noqa: E501
    value: Optional[List[BgpPeerStatus]] = Field(default=None, description="List of BGP peers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BgpPeerStatus.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
