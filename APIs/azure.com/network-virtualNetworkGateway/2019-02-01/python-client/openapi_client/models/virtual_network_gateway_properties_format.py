...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    custom_routes: Optional[LocalNetworkGatewayPropertiesFormatLocalNetworkAddressSpace] = Field(default=None, alias="customRoutes")
    ...
    gateway_default_site: Optional[VirtualNetworkGatewayConnectionListEntityPropertiesFormatPeer] = Field(default=None, alias="gatewayDefaultSite")
    ...
    __properties: ClassVar[List[str]] = ["activeActive", "bgpSettings", "customRoutes", "enableBgp", "gatewayDefaultSite", "gatewayType", "ipConfigurations", "provisioningState", "resourceGuid", "sku", "vpnClientConfiguration", "vpnType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customRoutes": LocalNetworkGatewayPropertiesFormatLocalNetworkAddressSpace.from_dict(obj["customRoutes"]) if obj.get("customRoutes") is not None else None,
            "enableBgp": obj.get("enableBgp"),
            "gatewayDefaultSite": VirtualNetworkGatewayConnectionListEntityPropertiesFormatPeer.from_dict(obj["gatewayDefaultSite"]) if obj.get("gatewayDefaultSite") is not None else None,
