...
class VirtualNetworkGatewaysApi:
    ...
    @validate_call
    def virtual_network_gateways_get_vpnclient_connection_health(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        ...
        _param = self._virtual_network_gateways_get_vpnclient_connection_health_serialize(
            resource_group_name=resource_group_name,
            virtual_network_gateway_name=virtual_network_gateway_name,
            api_version=api_version,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VpnClientConnectionHealthDetailListResult",
            '202': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def virtual_network_gateways_get_vpnclient_connection_health_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VpnClientConnectionHealthDetailListResult]:
        """virtual_network_gateways_get_vpnclient_connection_health
    ...
    @validate_call
    def virtual_network_gateways_get_vpnclient_connection_health_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _virtual_network_gateways_get_vpnclient_connection_health_serialize(
        self,
        resource_group_name,
        virtual_network_gateway_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/getVpnClientConnectionHealth',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def virtual_network_gateways_start_packet_capture(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[Optional[VpnPacketCaptureStartParameters], Field(description="Virtual network gateway packet capture parameters supplied to start packet capture on gateway.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: VpnPacketCaptureStartParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._virtual_network_gateways_start_packet_capture_serialize(
            resource_group_name=resource_group_name,
            virtual_network_gateway_name=virtual_network_gateway_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def virtual_network_gateways_start_packet_capture_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def virtual_network_gateways_start_packet_capture_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _virtual_network_gateways_start_packet_capture_serialize(
        self,
        resource_group_name,
        virtual_network_gateway_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/startPacketCapture',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def virtual_network_gateways_stop_packet_capture(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[VpnPacketCaptureStopParameters, Field(description="Virtual network gateway packet capture parameters supplied to stop packet capture on gateway.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: VpnPacketCaptureStopParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._virtual_network_gateways_stop_packet_capture_serialize(
            resource_group_name=resource_group_name,
            virtual_network_gateway_name=virtual_network_gateway_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def virtual_network_gateways_stop_packet_capture_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def virtual_network_gateways_stop_packet_capture_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        virtual_network_gateway_name: Annotated[StrictStr, Field(description="The name of the virtual network gateway.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _virtual_network_gateways_stop_packet_capture_serialize(
        self,
        resource_group_name,
        virtual_network_gateway_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/stopPacketCapture',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
