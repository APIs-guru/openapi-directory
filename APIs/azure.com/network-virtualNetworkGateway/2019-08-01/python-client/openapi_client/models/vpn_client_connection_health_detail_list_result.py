...
class VpnClientConnectionHealthDetailListResult(BaseModel):
    """
    List of virtual network gateway vpn client connection health.
    """ # noqa: E501
    value: Optional[List[VpnClientConnectionHealthDetail]] = Field(default=None, description="List of vpn client connection health.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [VpnClientConnectionHealthDetail.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
