...
class VirtualNetworkGatewayPropertiesFormat(BaseModel):
    ...
    enable_dns_forwarding: Optional[StrictBool] = Field(default=None, description="Whether dns forwarding is enabled or not.", alias="enableDnsForwarding")
    ...
    inbound_dns_forwarding_endpoint: Optional[StrictStr] = Field(default=None, description="The IP address allocated by the gateway to which dns requests can be sent.", alias="inboundDnsForwardingEndpoint")
    ...
    __properties: ClassVar[List[str]] = ["activeActive", "bgpSettings", "customRoutes", "enableBgp", "enableDnsForwarding", "gatewayDefaultSite", "gatewayType", "inboundDnsForwardingEndpoint", "ipConfigurations", "provisioningState", "resourceGuid", "sku", "vpnClientConfiguration", "vpnGatewayGeneration", "vpnType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enableDnsForwarding": obj.get("enableDnsForwarding"),
            ...
            "inboundDnsForwardingEndpoint": obj.get("inboundDnsForwardingEndpoint"),
