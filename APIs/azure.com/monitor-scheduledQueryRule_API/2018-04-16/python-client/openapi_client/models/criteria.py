...
class Criteria(BaseModel):
    ...
    """ # noqa: E501
    dimensions: Optional[List[Dimension]] = Field(default=None, description="List of Dimensions for creating metric")
    metric_name: StrictStr = Field(description="Name of the metric", alias="metricName")
    __properties: ClassVar[List[str]] = ["dimensions", "metricName"]
