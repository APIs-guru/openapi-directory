...
class LogSearchRuleResourceCollection(BaseModel):
    """
    Represents a collection of Log Search rule resources.
    """ # noqa: E501
    value: Optional[List[LogSearchRuleResource]] = Field(default=None, description="The values for the Log Search Rule resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [LogSearchRuleResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
