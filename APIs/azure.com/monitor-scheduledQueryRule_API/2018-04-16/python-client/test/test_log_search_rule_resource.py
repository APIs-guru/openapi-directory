...
class TestLogSearchRuleResource(unittest.TestCase):
    """LogSearchRuleResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogSearchRuleResource:
        """Test LogSearchRuleResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogSearchRuleResource`
        """
    ...
    def testLogSearchRuleResource(self):
        """Test LogSearchRuleResource"""
