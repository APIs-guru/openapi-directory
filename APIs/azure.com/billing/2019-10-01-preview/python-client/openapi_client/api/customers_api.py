...
class CustomersApi:
    ...
    def customers_get(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand enabledAzurePlans, resellers.")] = None,
    ...
    @validate_call
    def customers_list_by_billing_account(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter the list of customers.")] = None,
        ...
        _param = self._customers_list_by_billing_account_serialize(
            api_version=api_version,
            billing_account_name=billing_account_name,
            filter=filter,
            skiptoken=skiptoken,
    ...
    @validate_call
    def customers_list_by_billing_account_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter the list of customers.")] = None,
    ...
    @validate_call
    def customers_list_by_billing_account_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter the list of customers.")] = None,
    ...
    def _customers_list_by_billing_account_serialize(
        self,
        api_version,
        billing_account_name,
        filter,
    ...
    @validate_call
    def customers_list_by_billing_profile(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        ...
        _param = self._customers_list_by_billing_profile_serialize(
            api_version=api_version,
            billing_account_name=billing_account_name,
    ...
    @validate_call
    def customers_list_by_billing_profile_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
    ...
    @validate_call
    def customers_list_by_billing_profile_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
    ...
    def _customers_list_by_billing_profile_serialize(
        self,
        api_version,
        billing_account_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/customers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
