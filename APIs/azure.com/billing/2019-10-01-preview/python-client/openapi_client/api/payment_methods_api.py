...
class PaymentMethodsApi:
    ...
    @validate_call
    def payment_methods_list_by_billing_account(
        self,
        ...
        _param = self._payment_methods_list_by_billing_account_serialize(
    ...
    @validate_call
    def payment_methods_list_by_billing_account_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentMethodsListResult]:
        """payment_methods_list_by_billing_account
    ...
    @validate_call
    def payment_methods_list_by_billing_account_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        _request_timeout: Union[
    ...
    def _payment_methods_list_by_billing_account_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/paymentMethods',
    ...
    @validate_call
    def payment_methods_list_by_billing_profile(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        ...
        _param = self._payment_methods_list_by_billing_profile_serialize(
            billing_account_name=billing_account_name,
    ...
    @validate_call
    def payment_methods_list_by_billing_profile_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    @validate_call
    def payment_methods_list_by_billing_profile_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    def _payment_methods_list_by_billing_profile_serialize(
        self,
        billing_account_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/paymentMethods',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
