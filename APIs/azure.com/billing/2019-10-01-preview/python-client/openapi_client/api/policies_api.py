...
class PoliciesApi:
    ...
    @validate_call
    def policies_get_by_billing_profile(
        self,
        ...
        _param = self._policies_get_by_billing_profile_serialize(
    ...
    @validate_call
    def policies_get_by_billing_profile_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    @validate_call
    def policies_get_by_billing_profile_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    def _policies_get_by_billing_profile_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/policies/default',
    ...
    def policies_get_by_customer(
        ...
        _param = self._policies_get_by_customer_serialize(
            billing_account_name=billing_account_name,
    ...
    @validate_call
    def policies_get_by_customer_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        customer_name: Annotated[StrictStr, Field(description="Customer name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    @validate_call
    def policies_get_by_customer_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        customer_name: Annotated[StrictStr, Field(description="Customer name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
    ...
    def _policies_get_by_customer_serialize(
        self,
        billing_account_name,
        customer_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/policies/default',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def policies_update(
        ...
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        parameters: Annotated[Policy, Field(description="Parameters supplied to the update policy operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def policies_update_customer(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        customer_name: Annotated[StrictStr, Field(description="Customer name.")],
        parameters: Annotated[CustomerPolicy, Field(description="Parameters supplied to the update customer policy operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: CustomerPolicy
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._policies_update_customer_serialize(
            api_version=api_version,
            billing_account_name=billing_account_name,
            customer_name=customer_name,
            parameters=parameters,
    ...
    @validate_call
    def policies_update_customer_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        customer_name: Annotated[StrictStr, Field(description="Customer name.")],
    ...
    @validate_call
    def policies_update_customer_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2019-10-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="billing Account Id.")],
        customer_name: Annotated[StrictStr, Field(description="Customer name.")],
    ...
    def _policies_update_customer_serialize(
        self,
        api_version,
        billing_account_name,
        customer_name,
