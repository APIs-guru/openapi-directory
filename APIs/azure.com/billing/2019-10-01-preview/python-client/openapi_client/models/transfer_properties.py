...
class TransferProperties(BaseModel):
    ...
    billing_profile_id: Optional[StrictStr] = Field(default=None, description="Target billing profile Id.", alias="billingProfileId")
    ...
    __properties: ClassVar[List[str]] = ["billingAccountId", "billingProfileId", "canceledBy", "creationTime", "detailedTransferStatus", "expirationTime", "initiatorCustomerType", "initiatorEmailId", "invoiceSectionId", "lastModifiedTime", "recipientEmailId", "resellerId", "resellerName", "transferStatus"]
