...
class AcceptTransferProperties(BaseModel):
    """
    Request parameters to accept transfer.
    """ # noqa: E501
    product_details: Optional[List[ProductDetails]] = Field(default=None, description="Request parameters to accept transfer.", alias="productDetails")
    __properties: ClassVar[List[str]] = ["productDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "productDetails": [ProductDetails.from_dict(_item) for _item in obj["productDetails"]] if obj.get("productDetails") is not None else None
        })
        return _obj
