...
class UpdateAutoRenewRequest(BaseModel):
    ...
    """ # noqa: E501
    auto_renew: Optional[StrictStr] = Field(default=None, description="Request parameters to update auto renew policy a product.", alias="autoRenew")
    __properties: ClassVar[List[str]] = ["autoRenew"]

    @field_validator('auto_renew')
    def auto_renew_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
