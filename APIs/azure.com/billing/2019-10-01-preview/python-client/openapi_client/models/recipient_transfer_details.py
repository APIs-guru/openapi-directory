...
class RecipientTransferDetails(BaseModel):
    """
    Details of the transfer.
    """ # noqa: E501
    properties: Optional[RecipientTransferProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": RecipientTransferProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
