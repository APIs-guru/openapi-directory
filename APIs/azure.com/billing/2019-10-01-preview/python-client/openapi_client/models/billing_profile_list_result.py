...
class BillingProfileListResult(BaseModel):
    """
    ...
    value: Optional[List[BillingProfile]] = Field(default=None, description="The list of billing profiles.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [BillingProfile.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
