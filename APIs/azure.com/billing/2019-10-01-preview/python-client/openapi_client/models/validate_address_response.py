...
class ValidateAddressResponse(BaseModel):
    ...
    suggested_addresses: Optional[List[AddressDetails]] = Field(default=None, description="list of suggested addresses.", alias="suggestedAddresses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestedAddresses": [AddressDetails.from_dict(_item) for _item in obj["suggestedAddresses"]] if obj.get("suggestedAddresses") is not None else None,
