...
class RecipientTransferProperties(BaseModel):
    ...
    initiator_customer_type: Optional[StrictStr] = Field(default=None, description="Customer type of the initiator.", alias="initiatorCustomerType")
    ...
    reseller_id: Optional[StrictStr] = Field(default=None, description="Reseller Id for transfer.", alias="resellerId")
    reseller_name: Optional[StrictStr] = Field(default=None, description="Reseller name for transfer.", alias="resellerName")
    transfer_status: Optional[TransferStatus] = Field(default=None, alias="transferStatus")
    __properties: ClassVar[List[str]] = ["allowedProductType", "canceledBy", "creationTime", "detailedTransferStatus", "expirationTime", "initiatorCustomerType", "initiatorEmailId", "lastModifiedTime", "recipientEmailId", "resellerId", "resellerName", "transferStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "initiatorCustomerType": obj.get("initiatorCustomerType"),
