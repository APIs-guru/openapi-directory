...
class InstructionListResult(BaseModel):
    ...
    value: Optional[List[Instruction]] = Field(default=None, description="The list of instructions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Instruction.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
