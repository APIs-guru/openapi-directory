...
class ValidateTransferListResponse(BaseModel):
    """
    Result of transfer validation.
    """ # noqa: E501
    value: Optional[List[ValidateTransferResponse]] = Field(default=None, description="The list of transfer validation results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ValidateTransferResponse.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
