...
class BillingRoleAssignmentListResult(BaseModel):
    """
    Result of get list of role assignments
    """ # noqa: E501
    value: Optional[List[BillingRoleAssignment]] = Field(default=None, description="The list role assignments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BillingRoleAssignment.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
