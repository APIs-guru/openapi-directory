...
class BillingRoleAssignmentPayload(BaseModel):
    """
    The payload use to update role assignment on a scope
    """ # noqa: E501
    billing_role_definition_id: Optional[StrictStr] = Field(default=None, description="The role definition id", alias="billingRoleDefinitionId")
    ...
    __properties: ClassVar[List[str]] = ["billingRoleDefinitionId", "principalId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billingRoleDefinitionId": obj.get("billingRoleDefinitionId"),
